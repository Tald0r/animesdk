...
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_BUILDBRANCHDESC_OFFSET UNITYSDK_OFFSET(0xDEC9040)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_BUILDLEVELDESC_OFFSET UNITYSDK_OFFSET(0xDEC8970)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_CHANGEEXPAND_OFFSET UNITYSDK_OFFSET(0xDEC5C40)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_CLEANDYNAMICINFO_OFFSET UNITYSDK_OFFSET(0xDEC69E0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_GETARTIFACTDESC_OFFSET UNITYSDK_OFFSET(0xDEC6F10)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_GETCARDDESC_OFFSET UNITYSDK_OFFSET(0xDEC96F0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITBANGBOODREAMITEMVIEW_OFFSET UNITYSDK_OFFSET(0xDEC6F90)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITCOOPEQUIPVIEW_OFFSET UNITYSDK_OFFSET(0xDEC72F0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITITEMVIEW_OFFSET UNITYSDK_OFFSET(0xDEC6560)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITRELICVIEW_1_OFFSET UNITYSDK_OFFSET(0xDEC73D0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITRELICVIEW_2_OFFSET UNITYSDK_OFFSET(0xDEC77B0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITRELICVIEW_OFFSET UNITYSDK_OFFSET(0xDEC6D90)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INSERTBRANCHVIEW_OFFSET UNITYSDK_OFFSET(0xDEC8320)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INSERTLEVELVIEW_OFFSET UNITYSDK_OFFSET(0xDEC7E70)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INSERTRELICSKILLVIEW_OFFSET UNITYSDK_OFFSET(0xDEC7A20)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xDEC5B10)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0xDEC9880)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEC5F40)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDEC60C0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0xDEC97E0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEC5FE0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEC5900)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDEC5E90)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_REFRESHICONVIEW_OFFSET UNITYSDK_OFFSET(0xDEC6B90)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0xDEC6180)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_SETEXPAND_OFFSET UNITYSDK_OFFSET(0xDEC5CC0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDEC98F0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEC9980)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xDEC99F0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEC9A70)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEC9AF0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDEC9B50)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapInLevelItemRowWidgetController_TypeDefinitionIndex = 74900;

	class UIAbyssS2MapInLevelItemRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_22F360303C414CB0_3* _view; // 0x2D0
		::MoleMole::UIGeneralIconCardRarityWidgetController* _cardIcon; // 0x2D8
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* _cacheDyncmic; // 0x2E0
		...
		::Class_2_208CC9941471731A_53* _itemConfig; // 0x300
		::MoleMole::UIAbyssS2GeneralItemIconWidgetController* _iconWidget; // 0x308
		...
		::System::Void InitRelicView_1(::Class_3_8073069F10AF85F5* relicData)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_8073069F10AF85F5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITRELICVIEW_1_OFFSET))(this, relicData);
		}
		...
		::System::Void InsertLevelView(::Class_2_208CC9941471731A_213* levelConfig, ::System::Boolean divide, ::System::Boolean light, ::System::Boolean hideLevel, ::System::Boolean briefDesc)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_213*, ::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INSERTLEVELVIEW_OFFSET))(this, levelConfig, divide, light, hideLevel, briefDesc);
		}
		...
		::System::String* BuildLevelDesc(::Class_2_208CC9941471731A_213* levelConfig, ::MoleMole::GradientColor* gradientColor, ::System::Boolean light, ::System::Boolean hideLevel, ::System::Boolean briefDesc)
		{
			return ((::System::String*(*)(::PVOID, ::Class_2_208CC9941471731A_213*, ::MoleMole::GradientColor*, ::System::Boolean, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_BUILDLEVELDESC_OFFSET))(this, levelConfig, gradientColor, light, hideLevel, briefDesc);
		}
		...
		::System::String* GetArtifactDesc(::Class_2_E992BBDEABA30866* data, ::System::Boolean brief)
		{
			return ((::System::String*(*)(::PVOID, ::Class_2_E992BBDEABA30866*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_GETARTIFACTDESC_OFFSET))(this, data, brief);
		}
