...
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_BUILDBRANCHDESC_OFFSET UNITYSDK_OFFSET(0xD3ACAE0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_BUILDLEVELDESC_OFFSET UNITYSDK_OFFSET(0xD3AC400)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_CHANGEEXPAND_OFFSET UNITYSDK_OFFSET(0xD3A96E0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_CLEANDYNAMICINFO_OFFSET UNITYSDK_OFFSET(0xD3AA490)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_GETARTIFACTDESC_OFFSET UNITYSDK_OFFSET(0xD3AA9C0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_GETCARDDESC_OFFSET UNITYSDK_OFFSET(0xD3AD180)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITBANGBOODREAMITEMVIEW_OFFSET UNITYSDK_OFFSET(0xD3AAA40)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITCOOPEQUIPVIEW_OFFSET UNITYSDK_OFFSET(0xD3AADA0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITITEMVIEW_OFFSET UNITYSDK_OFFSET(0xD3AA010)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITRELICVIEW_1_OFFSET UNITYSDK_OFFSET(0xD3AAE70)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITRELICVIEW_2_OFFSET UNITYSDK_OFFSET(0xD3AB250)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INITRELICVIEW_OFFSET UNITYSDK_OFFSET(0xD3AA840)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INSERTBRANCHVIEW_OFFSET UNITYSDK_OFFSET(0xD3ABDB0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INSERTLEVELVIEW_OFFSET UNITYSDK_OFFSET(0xD3AB900)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INSERTRELICSKILLVIEW_OFFSET UNITYSDK_OFFSET(0xD3AB4C0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xD3A95B0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONCLICK_OFFSET UNITYSDK_OFFSET(0xD3AD310)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3A99F0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD3A9B70)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0xD3AD270)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3A9A90)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3A93A0)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD3A9940)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_REFRESHICONVIEW_OFFSET UNITYSDK_OFFSET(0xD3AA640)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_REFRESHINFO_OFFSET UNITYSDK_OFFSET(0xD3A9C30)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_SETEXPAND_OFFSET UNITYSDK_OFFSET(0xD3A9760)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3AD380)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3AD410)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD3AD480)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3AD500)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3AD580)
#define MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD3AD5E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2MapInLevelItemRowWidgetController_TypeDefinitionIndex = 67297;
	...
	public:
		...
		::Class_2_22F360303C414CB0_1* _view; // 0x2D0
		...
		::Class_2_208CC9941471731A_240* _itemConfig; // 0x300
		...
		::System::Void InsertLevelView(::Class_2_208CC9941471731A_620* levelConfig, ::System::Boolean divide, ::System::Boolean light, ::System::Boolean hideLevel, ::System::Boolean briefDesc)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_620*, ::System::Boolean, ::System::Boolean, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_INSERTLEVELVIEW_OFFSET))(this, levelConfig, divide, light, hideLevel, briefDesc);
		}
		...
		{
			return ((::System::String*(*)(::PVOID, ::Class_2_208CC9941471731A_620*, ::MoleMole::GradientColor*, ::System::Boolean, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIABYSSS2MAPINLEVELITEMROWWIDGETCONTROLLER_BUILDLEVELDESC_OFFSET))(this, levelConfig, gradientColor, light, hideLevel, briefDesc);
		}
