...
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA31F2E0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___C__DISPLAYCLASS13_0__ONPOSTREFRESHVIEW_B__0_OFFSET UNITYSDK_OFFSET(0xA31F2F0)
#define MOLEMOLE_UIBABELTOWERPAGE02CONTROLLER___C__DISPLAYCLASS13_0__ONPOSTREFRESHVIEW_B__1_OFFSET UNITYSDK_OFFSET(0xA31F320)

namespace MoleMole
{
	inline static constexpr unsigned int UIBabeltowerPage02Controller___c__DisplayClass13_0_TypeDefinitionIndex = 76864;
