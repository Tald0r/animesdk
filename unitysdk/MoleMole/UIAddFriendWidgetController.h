...
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONADDFRIENDGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0xBD924D0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD92160)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xBD920A0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBD922F0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONINPUTCHANGED_OFFSET UNITYSDK_OFFSET(0xBD93370)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONINPUTFIELDDESELECT_OFFSET UNITYSDK_OFFSET(0xBD931C0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONINPUTFIELDSELECT_OFFSET UNITYSDK_OFFSET(0xBD930D0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONRECEIVEADDFRIENDREQUESTLIST_OFFSET UNITYSDK_OFFSET(0xBD925E0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBD91DD0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD92200)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD913B0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_ONUPDATEREQUESTLIST_OFFSET UNITYSDK_OFFSET(0xBD92430)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_SETUPPARENTCONTROLLER_OFFSET UNITYSDK_OFFSET(0xBD923C0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER_UPDATEFRIENDLIST_OFFSET UNITYSDK_OFFSET(0xBD91F80)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBD93420)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0xBD93450)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_1_OFFSET UNITYSDK_OFFSET(0xBD934C0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_2_OFFSET UNITYSDK_OFFSET(0xBD93590)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_3_OFFSET UNITYSDK_OFFSET(0xBD935F0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_4_OFFSET UNITYSDK_OFFSET(0xBD93860)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_5_OFFSET UNITYSDK_OFFSET(0xBD938E0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__ONUIINIT_B__2_6_OFFSET UNITYSDK_OFFSET(0xBD93530)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER__UPDATEFRIENDLIST_B__11_0_OFFSET UNITYSDK_OFFSET(0xBD93960)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBD939C0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xBD93A30)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBD93A90)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBD93AC0)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBD93B30)
#define MOLEMOLE_UIADDFRIENDWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBD93BB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAddFriendWidgetController_TypeDefinitionIndex = 39528;
