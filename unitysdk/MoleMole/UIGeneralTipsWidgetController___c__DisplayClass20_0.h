...
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA99F690)
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS20_0__SETTEXT_B__0_OFFSET UNITYSDK_OFFSET(0xA99F6A0)
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS20_0__SETTEXT_B__1_OFFSET UNITYSDK_OFFSET(0xA99F760)
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS20_0__SETTEXT_B__2_OFFSET UNITYSDK_OFFSET(0xA99F930)
#define MOLEMOLE_UIGENERALTIPSWIDGETCONTROLLER___C__DISPLAYCLASS20_0__SETTEXT_B__3_OFFSET UNITYSDK_OFFSET(0xA99F900)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTipsWidgetController___c__DisplayClass20_0_TypeDefinitionIndex = 79465;
