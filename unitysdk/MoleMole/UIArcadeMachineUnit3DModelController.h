...
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_CREATETEXTUREFRAMESCREENPLAYDATA_OFFSET UNITYSDK_OFFSET(0xBF28810)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_CREATEVIDEOSCREENPLAYDATA_OFFSET UNITYSDK_OFFSET(0xBF294A0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_DELAYSWITCHNEARSCREEN_OFFSET UNITYSDK_OFFSET(0xBF29BD0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_GETARCADESCREENDISPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xBF28040)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_GETDATAINDEX_OFFSET UNITYSDK_OFFSET(0xBF280B0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_GETINITANGLEOFFSET_OFFSET UNITYSDK_OFFSET(0xBF282A0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_GETINITFORWARD_OFFSET UNITYSDK_OFFSET(0xBF28210)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_GETPOSITIONINDEX_OFFSET UNITYSDK_OFFSET(0xBF281A0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xBF27400)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_ISINNEARSCREENVIDEOSTATUS_OFFSET UNITYSDK_OFFSET(0xBF29CC0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_ISMATCHFARPOSTEXTUREFRAMETONEARPOSVIDEOTRANSITION_OFFSET UNITYSDK_OFFSET(0xBF29A40)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF27890)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF27930)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF27390)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_PLAYENTERGAMETITLEVIDEO_OFFSET UNITYSDK_OFFSET(0xBF29550)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_PLAYFARPOSTEXTUREFRAME_OFFSET UNITYSDK_OFFSET(0xBF284B0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_PLAYGLITCHBLENDTEXTUREFRAME_OFFSET UNITYSDK_OFFSET(0xBF28660)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_PLAYNEARPOSVIDEO_OFFSET UNITYSDK_OFFSET(0xBF29280)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_PLAYONSCREEN_OFFSET UNITYSDK_OFFSET(0xBF28B00)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_REFRESHCOMMONVIEW_OFFSET UNITYSDK_OFFSET(0xBF28400)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_REFRESHSCREENPLAY_OFFSET UNITYSDK_OFFSET(0xBF28DA0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_REGISTERMINIGAMEWORLD_OFFSET UNITYSDK_OFFSET(0xBF297E0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_SET3DSCREENSHOWENABLED_OFFSET UNITYSDK_OFFSET(0xBF27FD0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_SETCENTERSELECTED_OFFSET UNITYSDK_OFFSET(0xBF28390)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_SETPOSITIONINDEX_OFFSET UNITYSDK_OFFSET(0xBF28120)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_SETREFCONTROLLER_OFFSET UNITYSDK_OFFSET(0xBF28310)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_SHOWGAMERT_OFFSET UNITYSDK_OFFSET(0xBF29770)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_STARTARCADEGAME_OFFSET UNITYSDK_OFFSET(0xBF298C0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_STOPFARPOSTEXTUREFRAME_OFFSET UNITYSDK_OFFSET(0xBF28D20)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_STOPVIDEO_OFFSET UNITYSDK_OFFSET(0xBF28FE0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_SWITCHSCREENPOS_OFFSET UNITYSDK_OFFSET(0xBF288B0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_TICKFARPOSTEXTUREFRAMELOOPTIME_OFFSET UNITYSDK_OFFSET(0xBF27F30)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_TICKGLITCHBLEND_OFFSET UNITYSDK_OFFSET(0xBF27BC0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_TICKSCREENPLAYSTATETRANSITION_OFFSET UNITYSDK_OFFSET(0xBF27C50)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_TRYPLAYENTERGAMETITLEVIDEO_OFFSET UNITYSDK_OFFSET(0xBF295D0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_TRYPLAYFARPOSTEXTUREFRAME_OFFSET UNITYSDK_OFFSET(0xBF290F0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_TRYPLAYNEARPOSVIDEO_OFFSET UNITYSDK_OFFSET(0xBF29300)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_TRYSTOPFARPOSTEXTUREFRAME_OFFSET UNITYSDK_OFFSET(0xBF28F50)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_TRYSTOPVIDEO_OFFSET UNITYSDK_OFFSET(0xBF29060)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_UNREGISTERMINIGAMEWORLD_OFFSET UNITYSDK_OFFSET(0xBF29850)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBF279F0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBF29DC0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF29D40)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER__PLAYGLITCHBLENDTEXTUREFRAME_B__15_0_OFFSET UNITYSDK_OFFSET(0xBF29E20)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER__TRYPLAYENTERGAMETITLEVIDEO_B__25_0_OFFSET UNITYSDK_OFFSET(0xBF29EE0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER__TRYPLAYFARPOSTEXTUREFRAME_B__21_0_OFFSET UNITYSDK_OFFSET(0xBF29E30)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER__TRYPLAYNEARPOSVIDEO_B__23_0_OFFSET UNITYSDK_OFFSET(0xBF29E40)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF29F80)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF29FF0)
#define MOLEMOLE_UIARCADEMACHINEUNIT3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF2A000)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadeMachineUnit3DModelController_TypeDefinitionIndex = 57003;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIArcadeMachineUnit3DModelController_TypeDefinitionIndex)->GetStaticField(0x3D560);
		}
		static ::System::String** StaticGet_NO_GAME_TEXTURE_SHEET_KEY()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIArcadeMachineUnit3DModelController_TypeDefinitionIndex)->GetStaticField(0x3D568);
		}
		static ::System::Int32* StaticGet_ScreenMapPropertyID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIArcadeMachineUnit3DModelController_TypeDefinitionIndex)->GetStaticField(0xEF50);
		}
