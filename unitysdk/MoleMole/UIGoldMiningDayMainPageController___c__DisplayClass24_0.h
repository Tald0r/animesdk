...
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0xDFC7A40)
#define MOLEMOLE_UIGOLDMININGDAYMAINPAGECONTROLLER___C__DISPLAYCLASS24_0__SHOWINVITE_B__0_OFFSET UNITYSDK_OFFSET(0xDFC7A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIGoldMiningDayMainPageController___c__DisplayClass24_0_TypeDefinitionIndex = 58979;
