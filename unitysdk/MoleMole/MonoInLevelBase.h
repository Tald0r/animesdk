...
#define MOLEMOLE_MONOINLEVELBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x8C85D30)
#define MOLEMOLE_MONOINLEVELBASE_LOADSPRITEASYNC_OFFSET UNITYSDK_OFFSET(0x8C865A0)
#define MOLEMOLE_MONOINLEVELBASE_LOADSPRITE_OFFSET UNITYSDK_OFFSET(0x8C86230)
#define MOLEMOLE_MONOINLEVELBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x8C85DC0)
#define MOLEMOLE_MONOINLEVELBASE_SETUPIMAGESPRITE_1_OFFSET UNITYSDK_OFFSET(0x8C864F0)
#define MOLEMOLE_MONOINLEVELBASE_SETUPIMAGESPRITE_OFFSET UNITYSDK_OFFSET(0x8C85FA0)
#define MOLEMOLE_MONOINLEVELBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x8C866C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoInLevelBase_TypeDefinitionIndex = 42715;
