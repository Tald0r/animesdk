...
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_CAROUSELSCROLLVIEWIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x8C8DBC0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_CAROUSELSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x8C8DA90)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_DODESTROY_OFFSET UNITYSDK_OFFSET(0x8C8D260)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x8C8DEE0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_ONDRAG_OFFSET UNITYSDK_OFFSET(0x8C8DFA0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x8C8E050)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_REFRESHCAROUSELSETTING_OFFSET UNITYSDK_OFFSET(0x8C8D640)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_SETCAROUSELACTION_OFFSET UNITYSDK_OFFSET(0x8C8D5C0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_SETCAROUSELMOTIONSETTING_OFFSET UNITYSDK_OFFSET(0x8C8D4B0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_SETCAROUSELSETTING_OFFSET UNITYSDK_OFFSET(0x8C8D430)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_SETCAROUSELTIME_OFFSET UNITYSDK_OFFSET(0x8C8D530)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_STARTCAROUSEL_OFFSET UNITYSDK_OFFSET(0x8C8D6B0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_STARTMOTIONCAROUSEL_OFFSET UNITYSDK_OFFSET(0x8C8D850)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_STOPCAROUSEL_OFFSET UNITYSDK_OFFSET(0x8C8D8C0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_UPDATE_OFFSET UNITYSDK_OFFSET(0x8C8D1E0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL__CTOR_OFFSET UNITYSDK_OFFSET(0x8C8E100)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIScrollViewCarousel_TypeDefinitionIndex = 40786;
