...
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_CAROUSELSCROLLVIEWIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x8A854B0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_CAROUSELSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x8A85380)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_DODESTROY_OFFSET UNITYSDK_OFFSET(0x8A84B50)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x8A857D0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_ONDRAG_OFFSET UNITYSDK_OFFSET(0x8A85890)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x8A85940)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_REFRESHCAROUSELSETTING_OFFSET UNITYSDK_OFFSET(0x8A84F30)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_SETCAROUSELACTION_OFFSET UNITYSDK_OFFSET(0x8A84EB0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_SETCAROUSELMOTIONSETTING_OFFSET UNITYSDK_OFFSET(0x8A84DA0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_SETCAROUSELSETTING_OFFSET UNITYSDK_OFFSET(0x8A84D20)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_SETCAROUSELTIME_OFFSET UNITYSDK_OFFSET(0x8A84E20)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_STARTCAROUSEL_OFFSET UNITYSDK_OFFSET(0x8A84FA0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_STARTMOTIONCAROUSEL_OFFSET UNITYSDK_OFFSET(0x8A85140)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_STOPCAROUSEL_OFFSET UNITYSDK_OFFSET(0x8A851B0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL_UPDATE_OFFSET UNITYSDK_OFFSET(0x8A84AD0)
#define MOLEMOLE_MONOUISCROLLVIEWCAROUSEL__CTOR_OFFSET UNITYSDK_OFFSET(0x8A859F0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIScrollViewCarousel_TypeDefinitionIndex = 78956;
