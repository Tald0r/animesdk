...
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_STACKEDSWITCH_CLEAR_OFFSET UNITYSDK_OFFSET(0x6533480)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_STACKEDSWITCH_POP_1_OFFSET UNITYSDK_OFFSET(0x6533300)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_STACKEDSWITCH_POP_OFFSET UNITYSDK_OFFSET(0x6533060)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_STACKEDSWITCH_PUSH_OFFSET UNITYSDK_OFFSET(0x6532B30)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_STACKEDSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x6533560)

namespace MoleMole
{
	inline static constexpr unsigned int BigSceneMiscLogicSubSystem_StackedSwitch_TypeDefinitionIndex = 59898;
