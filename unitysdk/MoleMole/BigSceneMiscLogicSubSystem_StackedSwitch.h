...
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_STACKEDSWITCH_CLEAR_OFFSET UNITYSDK_OFFSET(0x81CD8F0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_STACKEDSWITCH_POP_1_OFFSET UNITYSDK_OFFSET(0x81CD770)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_STACKEDSWITCH_POP_OFFSET UNITYSDK_OFFSET(0x81CD4D0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_STACKEDSWITCH_PUSH_OFFSET UNITYSDK_OFFSET(0x81CCFB0)
#define MOLEMOLE_BIGSCENEMISCLOGICSUBSYSTEM_STACKEDSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x81CD9D0)

namespace MoleMole
{
	inline static constexpr unsigned int BigSceneMiscLogicSubSystem_StackedSwitch_TypeDefinitionIndex = 65442;
