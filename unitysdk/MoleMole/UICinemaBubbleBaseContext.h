...
#define MOLEMOLE_UICINEMABUBBLEBASECONTEXT_SETUPGRAPHCUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0xC0CBAF0)
#define MOLEMOLE_UICINEMABUBBLEBASECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xC0CBB90)

namespace MoleMole
{
	inline static constexpr unsigned int UICinemaBubbleBaseContext_TypeDefinitionIndex = 63409;

	class UICinemaBubbleBaseContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::String* onShowEventName; // 0x28
		::System::Action* onBeforePerClick; // 0x30
		::System::String* onClickEventName; // 0x38
		::System::Action* onMiss; // 0x40
		::System::Action_1<::System::String*>* graphEventDisatcher; // 0x48
		::System::String* bubbleTextKey; // 0x50
		::System::String* onMissEventName; // 0x58
		::System::Action_1<::System::Boolean>* onFinish; // 0x60
		::System::String* onSuccessEventName; // 0x68
