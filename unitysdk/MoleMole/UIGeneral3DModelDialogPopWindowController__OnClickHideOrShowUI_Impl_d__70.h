...
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER__ONCLICKHIDEORSHOWUI_IMPL_D__70_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3F3130)
#define MOLEMOLE_UIGENERAL3DMODELDIALOGPOPWINDOWCONTROLLER__ONCLICKHIDEORSHOWUI_IMPL_D__70_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneral3DModelDialogPopWindowController__OnClickHideOrShowUI_Impl_d__70_TypeDefinitionIndex = 40569;
