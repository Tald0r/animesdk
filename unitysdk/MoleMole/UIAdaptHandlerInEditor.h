...
#define MOLEMOLE_UIADAPTHANDLERINEDITOR__CTOR_OFFSET UNITYSDK_OFFSET(0xA5131C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAdaptHandlerInEditor_TypeDefinitionIndex = 43239;
