...
#define MOLEMOLE_UIDAILYQUESTREWARDLISTDIALOGPOPWINDOWCONTROLLER_DAILYQUESTREWARDROWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB2C41D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDailyQuestRewardListDialogPopWindowController_DailyQuestRewardRowContext_TypeDefinitionIndex = 69630;
