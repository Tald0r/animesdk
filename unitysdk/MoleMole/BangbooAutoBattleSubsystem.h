...
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_GET_NETWORKHANDLER_OFFSET UNITYSDK_OFFSET(0x9159EF0)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x9159F10)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x915A120)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x9159F70)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM_SET_NETWORKHANDLER_OFFSET UNITYSDK_OFFSET(0x9159F00)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x915A1A0)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x915A1C0)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x915A220)
#define MOLEMOLE_BANGBOOAUTOBATTLESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x915A280)

namespace MoleMole
{
	inline static constexpr unsigned int BangbooAutoBattleSubsystem_TypeDefinitionIndex = 59271;
