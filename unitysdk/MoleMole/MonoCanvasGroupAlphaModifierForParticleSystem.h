...
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM_METHOD_5_7F4D4B70081805B9_OFFSET UNITYSDK_OFFSET(0xB1A4DA0)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM_METHOD_5_EAD10B3E55E2C4C5_OFFSET UNITYSDK_OFFSET(0xB1A4300)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB1A4290)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM_RESET_OFFSET UNITYSDK_OFFSET(0xB1A4020)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM_SETPARTICLESYSTEMALPHA_OFFSET UNITYSDK_OFFSET(0xB1A4550)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0xB1A44E0)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0xB1A4D80)
#define MOLEMOLE_MONOCANVASGROUPALPHAMODIFIERFORPARTICLESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB1A4D60)

namespace MoleMole
{
	inline static constexpr unsigned int MonoCanvasGroupAlphaModifierForParticleSystem_TypeDefinitionIndex = 49927;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoCanvasGroupAlphaModifierForParticleSystem_TypeDefinitionIndex)->GetStaticField(0xEC70);
		}
