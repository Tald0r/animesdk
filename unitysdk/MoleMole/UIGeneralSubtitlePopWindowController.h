...
#define MOLEMOLE_UIGENERALSUBTITLEPOPWINDOWCONTROLLER_GET_ISIGNOREINPUT_OFFSET UNITYSDK_OFFSET(0x8C253F0)
#define MOLEMOLE_UIGENERALSUBTITLEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8C253E0)
#define MOLEMOLE_UIGENERALSUBTITLEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C25400)
#define MOLEMOLE_UIGENERALSUBTITLEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C254A0)
#define MOLEMOLE_UIGENERALSUBTITLEPOPWINDOWCONTROLLER_SHOWDIALOGID_OFFSET UNITYSDK_OFFSET(0x8C25530)
#define MOLEMOLE_UIGENERALSUBTITLEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8C25750)
#define MOLEMOLE_UIGENERALSUBTITLEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8C25760)
#define MOLEMOLE_UIGENERALSUBTITLEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8C257D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralSubtitlePopWindowController_TypeDefinitionIndex = 55899;
