...
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBD73A50)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER___C__DISPLAYCLASS27_0__SCHEDULEAUTOHIDE_B__0_OFFSET UNITYSDK_OFFSET(0xBD73A60)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER___C__DISPLAYCLASS27_0__SCHEDULEAUTOHIDE_B__1_OFFSET UNITYSDK_OFFSET(0xBD73B30)
#define MOLEMOLE_UIABINLEVELTIPSWIDGETCONTROLLER___C__DISPLAYCLASS27_0__SCHEDULEAUTOHIDE_B__2_OFFSET UNITYSDK_OFFSET(0xBD73C40)

namespace MoleMole
{
	inline static constexpr unsigned int UIABInLevelTipsWidgetController___c__DisplayClass27_0_TypeDefinitionIndex = 41977;
