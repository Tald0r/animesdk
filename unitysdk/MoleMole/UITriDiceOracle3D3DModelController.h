...
class Class_2_57BC05F83E55D2CA;
...
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_CAMERARENDERTYPE_OFFSET UNITYSDK_OFFSET(0xAAA5680)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_CAMERA_OFFSET UNITYSDK_OFFSET(0xAAA56D0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_CONTROLROOT_OFFSET UNITYSDK_OFFSET(0xAAA56B0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_MODELROOT_OFFSET UNITYSDK_OFFSET(0xAAA5690)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_SHOW3DSCENEENTITIES_OFFSET UNITYSDK_OFFSET(0xAAA56F0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xAAA5670)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_INITCAMERA_OFFSET UNITYSDK_OFFSET(0xAAA6220)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_INITMODELTRANS_OFFSET UNITYSDK_OFFSET(0xAAA5A30)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAAA5CC0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAAA5D60)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAAA5700)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAAA5C50)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_SHOWCAMERA_OFFSET UNITYSDK_OFFSET(0xAAA68A0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xAAA69C0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAAA6950)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAAA6A00)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAAA6A70)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAAA6A80)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAAA6A90)

namespace MoleMole
{
	inline static constexpr unsigned int UITriDiceOracle3D3DModelController_TypeDefinitionIndex = 47572;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITriDiceOracle3D3DModelController_TypeDefinitionIndex)->GetStaticField(0xEEE0);
		}
		...
		::Class_2_57BC05F83E55D2CA* _view; // 0x340
		::UnityEngine::NAPRenderPipeline0::RTHandle* _rt; // 0x348
		::UnityEngine::GameObject* ModelGameObject; // 0x350
		::MoleMole::Battle::Entity* ModelEntity; // 0x358
		::UnityEngine::GameObject* DiceGameObject; // 0x360
		::MoleMole::Battle::Entity* DiceEntity; // 0x368
