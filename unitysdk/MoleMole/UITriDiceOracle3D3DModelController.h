...
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_CAMERARENDERTYPE_OFFSET UNITYSDK_OFFSET(0x95A54C0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_CAMERA_OFFSET UNITYSDK_OFFSET(0x95A5510)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_CONTROLROOT_OFFSET UNITYSDK_OFFSET(0x95A54F0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_MODELROOT_OFFSET UNITYSDK_OFFSET(0x95A54D0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_SHOW3DSCENEENTITIES_OFFSET UNITYSDK_OFFSET(0x95A5530)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x95A54B0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_INITCAMERA_OFFSET UNITYSDK_OFFSET(0x95A6060)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_INITMODELTRANS_OFFSET UNITYSDK_OFFSET(0x95A5870)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95A5B00)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95A5BA0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95A5540)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95A5A90)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER_SHOWCAMERA_OFFSET UNITYSDK_OFFSET(0x95A66E0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x95A6800)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x95A6790)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95A6840)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95A68B0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95A68C0)
#define MOLEMOLE_UITRIDICEORACLE3D3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95A68D0)

namespace MoleMole
{
	inline static constexpr unsigned int UITriDiceOracle3D3DModelController_TypeDefinitionIndex = 81090;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UITriDiceOracle3D3DModelController_TypeDefinitionIndex)->GetStaticField(0xF5E0);
		}
