...
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_CLEANUP_OFFSET UNITYSDK_OFFSET(0xBA22030)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_CLEAN_OFFSET UNITYSDK_OFFSET(0xBA22B20)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_DRAWLINE_OFFSET UNITYSDK_OFFSET(0xBA22090)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GETCONFIGCOLLIDERPARAMS_OFFSET UNITYSDK_OFFSET(0xBA22EA0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_COLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0xBA22B00)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_CONFIGURABLECOLTYPE_OFFSET UNITYSDK_OFFSET(0xBA22AD0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_OWNERCOLLIDER_OFFSET UNITYSDK_OFFSET(0xBA22AE0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_OWNER_OFFSET UNITYSDK_OFFSET(0xBA22940)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_GET_ROOTGO_OFFSET UNITYSDK_OFFSET(0xBA22B10)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_2337B33FCDD17495_OFFSET UNITYSDK_OFFSET(0xBA223A0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0xBA228A0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_96080D6BFFAB381B_OFFSET UNITYSDK_OFFSET(0xBA230E0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0xBA22470)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_DD5D24B8E3D38A9A_OFFSET UNITYSDK_OFFSET(0xBA21DB0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0xBA22100)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0xBA224F0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SETUPCOLLIDER_OFFSET UNITYSDK_OFFSET(0xBA21D20)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SETUPINSTANCEDCOLLIDER_OFFSET UNITYSDK_OFFSET(0xBA21C60)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SETUPTIMEDRIVENCOLLIDER_OFFSET UNITYSDK_OFFSET(0xBA21BC0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SET_COLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0xBA22AF0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SET_CONFIGURABLECOLTYPE_OFFSET UNITYSDK_OFFSET(0xBA22AC0)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER_SET_OWNER_OFFSET UNITYSDK_OFFSET(0xBA22790)
#define MOLEMOLE_MONOCONFIGURABLECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xBA230C0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoConfigurableCollider_TypeDefinitionIndex = 66671;
	...
	public:
		...
		::Enum_3_E18DD7D3DEDDD336 Field_5_4; // 0x38
		...
		::System::Void Method_5_DD5D24B8E3D38A9A(::MoleMole::Config::ConfigTimeDrivenAttackCollider* a1, ::UnityEngine::LayerMask a2, ::MoleMole::LayerMaskStatic_Enum_3_C3BBA2B066959E6E a3)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::Config::ConfigTimeDrivenAttackCollider*, ::UnityEngine::LayerMask, ::MoleMole::LayerMaskStatic_Enum_3_C3BBA2B066959E6E))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOCONFIGURABLECOLLIDER_METHOD_5_DD5D24B8E3D38A9A_OFFSET))(this, a1, a2, a3);
		}
