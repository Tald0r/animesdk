...
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAAA86F0)
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAAA8870)
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAAA8790)
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAAA8B20)
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAAA8B30)
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAAA8BA0)
#define MOLEMOLE_UIVHSSTORETAGWIDERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAAA8C20)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreTagWiderWidgetController_TypeDefinitionIndex = 75444;

	class UIVHSStoreTagWiderWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8127D35606966C67_14* _view; // 0x2D0
