...
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_BINDENTITY_OFFSET UNITYSDK_OFFSET(0x993F250)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_GET_BOUNDENTITY_OFFSET UNITYSDK_OFFSET(0x993F230)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_GET_BOUNDWALLCOLLIDER_OFFSET UNITYSDK_OFFSET(0x993F240)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_GET_IGNORETAG_OFFSET UNITYSDK_OFFSET(0x993F210)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_METHOD_5_65585810E2458BA4_OFFSET UNITYSDK_OFFSET(0x993FB70)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_METHOD_5_8F9716FCC554E5F2_OFFSET UNITYSDK_OFFSET(0x993FB80)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x993F7E0)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x993F9B0)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_SET_IGNORETAG_OFFSET UNITYSDK_OFFSET(0x993F220)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR_UNBINDENTITY_OFFSET UNITYSDK_OFFSET(0x993F570)
#define MOLEMOLE_MONOWALLCOLLISIONIGNORESENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x993FB50)

namespace MoleMole
{
	inline static constexpr unsigned int MonoWallCollisionIgnoreSensor_TypeDefinitionIndex = 52206;
