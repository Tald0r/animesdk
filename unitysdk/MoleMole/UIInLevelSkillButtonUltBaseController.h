...
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_GET_BUTTONSKILLNAME_OFFSET UNITYSDK_OFFSET(0x8965150)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_GET_KEYBUTTONCODE_OFFSET UNITYSDK_OFFSET(0x8965160)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_ONHIDEULTBTN_OFFSET UNITYSDK_OFFSET(0x89652E0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_ONSHOWULTBTN_OFFSET UNITYSDK_OFFSET(0x89651F0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_SHOULDSKILLBUTTONHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x8965170)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x89653D0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER___BASE_SHOULDSKILLBUTTONHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x89653E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelSkillButtonUltBaseController_TypeDefinitionIndex = 64806;
