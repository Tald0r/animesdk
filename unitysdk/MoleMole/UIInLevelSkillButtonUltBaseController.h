...
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_GET_BUTTONSKILLNAME_OFFSET UNITYSDK_OFFSET(0x982FF20)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_GET_KEYBUTTONCODE_OFFSET UNITYSDK_OFFSET(0x982FF30)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_ONHIDEULTBTN_OFFSET UNITYSDK_OFFSET(0x98300B0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_ONSHOWULTBTN_OFFSET UNITYSDK_OFFSET(0x982FFC0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER_SHOULDSKILLBUTTONHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x982FF40)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x98301A0)
#define MOLEMOLE_UIINLEVELSKILLBUTTONULTBASECONTROLLER___BASE_SHOULDSKILLBUTTONHANDLEINPUT_OFFSET UNITYSDK_OFFSET(0x98301B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelSkillButtonUltBaseController_TypeDefinitionIndex = 77725;
