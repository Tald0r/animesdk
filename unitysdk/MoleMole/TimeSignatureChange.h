...
#define MOLEMOLE_TIMESIGNATURECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F3E810)

namespace MoleMole
{
	inline static constexpr unsigned int TimeSignatureChange_TypeDefinitionIndex = 60602;
