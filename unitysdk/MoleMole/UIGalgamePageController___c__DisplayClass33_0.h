...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD12B7F0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_0__PLAYSTORYNODE_B__0_OFFSET UNITYSDK_OFFSET(0xD12BB60)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_0__PLAYSTORYNODE_B__1_OFFSET UNITYSDK_OFFSET(0xD12BBA0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_0__PLAYSTORYNODE_B__2_OFFSET UNITYSDK_OFFSET(0xD12B800)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_0__PLAYSTORYNODE_B__3_OFFSET UNITYSDK_OFFSET(0xD12B8A0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_0__PLAYSTORYNODE_B__4_OFFSET UNITYSDK_OFFSET(0xD12B8C0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_0__PLAYSTORYNODE_B__5_OFFSET UNITYSDK_OFFSET(0xD12B9B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_0__PLAYSTORYNODE_B__6_OFFSET UNITYSDK_OFFSET(0xD12B9D0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS33_0__PLAYSTORYNODE_B__7_OFFSET UNITYSDK_OFFSET(0xD12BAC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass33_0_TypeDefinitionIndex = 58942;

	class UIGalgamePageController___c__DisplayClass33_0 : public ::System::Object
	{
	public:
		::MoleMole::GalGame::GalPlayStoryNode* galConfigNode; // 0x10
