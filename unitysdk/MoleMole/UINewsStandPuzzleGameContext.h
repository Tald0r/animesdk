...
#define MOLEMOLE_UINEWSSTANDPUZZLEGAMECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAB7AA70)

namespace MoleMole
{
	inline static constexpr unsigned int UINewsStandPuzzleGameContext_TypeDefinitionIndex = 53063;
