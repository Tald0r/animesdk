...
#define MOLEMOLE_UIFORBIDDENAREAINSIGHTLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAD14D00)
#define MOLEMOLE_UIFORBIDDENAREAINSIGHTLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__REFRESHLEVELTXTVIEW_B__10_OFFSET UNITYSDK_OFFSET(0xAD14D60)
#define MOLEMOLE_UIFORBIDDENAREAINSIGHTLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__REFRESHLEVELTXTVIEW_B__3_OFFSET UNITYSDK_OFFSET(0xAD14D10)
#define MOLEMOLE_UIFORBIDDENAREAINSIGHTLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__REFRESHLEVELTXTVIEW_B__7_OFFSET UNITYSDK_OFFSET(0xAD14E50)
#define MOLEMOLE_UIFORBIDDENAREAINSIGHTLEVELUPPOPWINDOWCONTROLLER___C__DISPLAYCLASS13_0__REFRESHLEVELTXTVIEW_G__ONPROGRESS_0_OFFSET UNITYSDK_OFFSET(0xAD14E70)

namespace MoleMole
{
	inline static constexpr unsigned int UIForbiddenAreaInsightLevelUpPopWindowController___c__DisplayClass13_0_TypeDefinitionIndex = 47096;
