...
#define MOLEMOLE_UIINTERKNOTOVERNIGHTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6CA17C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotOverNightContext_TypeDefinitionIndex = 38415;
