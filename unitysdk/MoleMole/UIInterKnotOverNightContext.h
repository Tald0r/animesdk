...
#define MOLEMOLE_UIINTERKNOTOVERNIGHTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6CAB850)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotOverNightContext_TypeDefinitionIndex = 71542;

	class UIInterKnotOverNightContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::MoleMole::UIBaseController* FromController; // 0x28
		::System::Action_1<::System::String*>* OnClose; // 0x30
		::Class_3_E342D954CB576697* FirstPost; // 0x38
