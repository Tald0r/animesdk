...
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER_GETBTN_OFFSET UNITYSDK_OFFSET(0x8910930)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x89112D0)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8910A50)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x89109A0)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8910BD0)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8910AF0)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8910890)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER_REFRESHBYDATA_OFFSET UNITYSDK_OFFSET(0x8910CB0)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8911340)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER___BASE_ONCLICKITEM_OFFSET UNITYSDK_OFFSET(0x8911350)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8911360)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x89113D0)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8911440)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x89114C0)
#define MOLEMOLE_UIGENERALBTNWITHICONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8911540)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBtnWithIconWidgetController_TypeDefinitionIndex = 79180;
