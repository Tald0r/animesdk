...
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_DOCLICK_OFFSET UNITYSDK_OFFSET(0xB28E220)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_GETTIMETEXT_OFFSET UNITYSDK_OFFSET(0xB28D7F0)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB28D6C0)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB28D730)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xB28E0D0)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB28DB90)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER_SETWEAKFOCUSANIM_OFFSET UNITYSDK_OFFSET(0xB28E310)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB28E4B0)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xB28E4C0)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xB28E530)
#define MOLEMOLE_UICOOPHISTORYTABWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB28E5A0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopHistoryTabWidgetController_TypeDefinitionIndex = 68375;
