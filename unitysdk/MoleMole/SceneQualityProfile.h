...
#define MOLEMOLE_SCENEQUALITYPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x7A9F6E0)
#define MOLEMOLE_SCENEQUALITYPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x7A9F860)
#define MOLEMOLE_SCENEQUALITYPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0x7A9F5D0)
#define MOLEMOLE_SCENEQUALITYPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x7A9F7C0)
#define MOLEMOLE_SCENEQUALITYPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0x7A9F5C0)
#define MOLEMOLE_SCENEQUALITYPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x7A9F9C0)
#define MOLEMOLE_SCENEQUALITYPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x7A9FA50)
#define MOLEMOLE_SCENEQUALITYPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x7A9FAC0)
#define MOLEMOLE_SCENEQUALITYPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x7A9FB30)

namespace MoleMole
{
	inline static constexpr unsigned int SceneQualityProfile_TypeDefinitionIndex = 38872;
