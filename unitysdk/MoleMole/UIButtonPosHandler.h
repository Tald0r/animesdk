...
#define MOLEMOLE_UIBUTTONPOSHANDLER_APPLYLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0xC0C6D80)
#define MOLEMOLE_UIBUTTONPOSHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC0C3910)
#define MOLEMOLE_UIBUTTONPOSHANDLER_CALCULATELAYOUT_OFFSET UNITYSDK_OFFSET(0xC0C3E70)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GETLAYOUTRESULT_1_OFFSET UNITYSDK_OFFSET(0xC0C5B70)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GETLAYOUTRESULT_OFFSET UNITYSDK_OFFSET(0xC0C7150)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GETPOSHANDLER_OFFSET UNITYSDK_OFFSET(0xC0C3630)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GET_BUTTONTYPE_OFFSET UNITYSDK_OFFSET(0xC0C3570)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GET_POSITIONTYPE_OFFSET UNITYSDK_OFFSET(0xC0C3590)
#define MOLEMOLE_UIBUTTONPOSHANDLER_GET_SCENETYPE_OFFSET UNITYSDK_OFFSET(0xC0C3580)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_09B8F368BEF6ADA5_1_OFFSET UNITYSDK_OFFSET(0xC0C9030)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_09B8F368BEF6ADA5_OFFSET UNITYSDK_OFFSET(0xC0C8C00)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_0B08B4F8E959C85E_OFFSET UNITYSDK_OFFSET(0xC0C50B0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_143E7CF2494EE4D6_1_OFFSET UNITYSDK_OFFSET(0xC0C8CC0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_143E7CF2494EE4D6_OFFSET UNITYSDK_OFFSET(0xC0C86F0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_1CCA9681CE0AE7A7_OFFSET UNITYSDK_OFFSET(0xC0C7780)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_293D61F1DB5EB198_1_OFFSET UNITYSDK_OFFSET(0xC0C5240)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_293D61F1DB5EB198_OFFSET UNITYSDK_OFFSET(0xC0C5490)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_30608A662F7FC43B_OFFSET UNITYSDK_OFFSET(0xC0C7D00)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_37D0382D0C30A2DC_OFFSET UNITYSDK_OFFSET(0xC0C7AC0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_5304726C363652C1_OFFSET UNITYSDK_OFFSET(0xC0C5920)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_568AE7A1499723FD_OFFSET UNITYSDK_OFFSET(0xC0C4910)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_5A19431060A597D2_OFFSET UNITYSDK_OFFSET(0xC0C80B0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_5B3FFFC789FC412E_1_OFFSET UNITYSDK_OFFSET(0xC0C8A60)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_5B3FFFC789FC412E_OFFSET UNITYSDK_OFFSET(0xC0C7B60)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_73B72C9D653C9B5E_1_OFFSET UNITYSDK_OFFSET(0xC0C7290)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_73B72C9D653C9B5E_OFFSET UNITYSDK_OFFSET(0xC0C7510)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_7CFF6EACC1D121C7_OFFSET UNITYSDK_OFFSET(0xC0C9150)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_B277D64CD33FB1C7_OFFSET UNITYSDK_OFFSET(0xC0C56E0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_C4CB00FCBB91C6C4_OFFSET UNITYSDK_OFFSET(0xC0C4AF0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0xC0C8CB0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_C7D596A81C8A10AA_OFFSET UNITYSDK_OFFSET(0xC0C8340)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_C8E7E15193FC5224_1_OFFSET UNITYSDK_OFFSET(0xC0C7280)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_C8E7E15193FC5224_OFFSET UNITYSDK_OFFSET(0xC0C7500)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xC0C90F0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_E1A38AE09BB51EC6_OFFSET UNITYSDK_OFFSET(0xC0C4A70)
#define MOLEMOLE_UIBUTTONPOSHANDLER_METHOD_6_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0xC0C90E0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC0C3BB0)
#define MOLEMOLE_UIBUTTONPOSHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC0C3A10)
#define MOLEMOLE_UIBUTTONPOSHANDLER_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0xC0C3D50)
#define MOLEMOLE_UIBUTTONPOSHANDLER_SETBUTTONTYPE_OFFSET UNITYSDK_OFFSET(0xC0C35A0)
#define MOLEMOLE_UIBUTTONPOSHANDLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC0C7870)
#define MOLEMOLE_UIBUTTONPOSHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC0C7850)
#define MOLEMOLE_UIBUTTONPOSHANDLER___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0xC0C7910)
#define MOLEMOLE_UIBUTTONPOSHANDLER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xC0C79A0)
#define MOLEMOLE_UIBUTTONPOSHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xC0C7A30)

namespace MoleMole
{
	inline static constexpr unsigned int UIButtonPosHandler_TypeDefinitionIndex = 55701;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MoleMole::UIButtonPosHandler*>**)Il2CppClass::FromTypeDefinitionIndex(UIButtonPosHandler_TypeDefinitionIndex)->GetStaticField(0x426A0);
		}
		static ::System::Single* StaticGet_Field_6_7()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIButtonPosHandler_TypeDefinitionIndex)->GetStaticField(0x107D0);
		}
		static ::UnityEngine::Vector2* StaticGet_Field_6_6()
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(UIButtonPosHandler_TypeDefinitionIndex)->GetStaticField(0x107D4);
		}
