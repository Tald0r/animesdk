...
#define MOLEMOLE_BATTLEEVALUTEBGCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8E9DDE0)

namespace MoleMole
{
	inline static constexpr unsigned int BattleEvaluteBgColor_TypeDefinitionIndex = 56558;
