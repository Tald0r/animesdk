...
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_CLEARCURVESANIMATEDTAG_OFFSET UNITYSDK_OFFSET(0x9452FF0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_CLEARCURVESOPENTAG_OFFSET UNITYSDK_OFFSET(0x94534E0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_GETANIMATIONTIME_OFFSET UNITYSDK_OFFSET(0x9453450)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_GETONEROWDATABYCOLUMNINDEX_OFFSET UNITYSDK_OFFSET(0x9455370)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_GETPERTALENTBYINDEX_OFFSET UNITYSDK_OFFSET(0x9453800)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_GETPERTALENTDATABYINDEX_OFFSET UNITYSDK_OFFSET(0x94559A0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_GETTALENTCOUNTBYCOLUMNINDEX_OFFSET UNITYSDK_OFFSET(0x9453210)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9450CD0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ISCANSHOWRESETBUTTON_OFFSET UNITYSDK_OFFSET(0x9454C10)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ISHAVEZEROTALENT_OFFSET UNITYSDK_OFFSET(0x9452390)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONADDTALENTEVENT_OFFSET UNITYSDK_OFFSET(0x9454FE0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONCREATEALLITEM_OFFSET UNITYSDK_OFFSET(0x9452680)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9450CE0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONOKBTN_OFFSET UNITYSDK_OFFSET(0x9453680)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONPERTALENTCLICK_OFFSET UNITYSDK_OFFSET(0x94539A0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONRESETBTN_OFFSET UNITYSDK_OFFSET(0x9453570)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONRESETTALENTEVENT_OFFSET UNITYSDK_OFFSET(0x94550A0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONTOGGLE_OFFSET UNITYSDK_OFFSET(0x9451D90)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9451FA0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9450E40)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x9452140)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_PLAYCURVEFILLANIMATION_OFFSET UNITYSDK_OFFSET(0x9453380)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_REFRESHBUTTON_OFFSET UNITYSDK_OFFSET(0x9453FF0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_REFRESHLINEMESH_OFFSET UNITYSDK_OFFSET(0x9453080)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_SETLINE_OFFSET UNITYSDK_OFFSET(0x9453110)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_SETNEXTTALENTINDEXBYPRETALENTIDLIST_OFFSET UNITYSDK_OFFSET(0x94557F0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_SETNEXTTALENTINDEX_OFFSET UNITYSDK_OFFSET(0x9455520)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_SETPANELDATA_OFFSET UNITYSDK_OFFSET(0x9451770)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_SHOWRESETBTN_OFFSET UNITYSDK_OFFSET(0x94522D0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_SORTPANELDATALIST_OFFSET UNITYSDK_OFFSET(0x9455750)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER_STOPANIMATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x9452030)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9455BF0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9455AB0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER__ONRESETBTN_B__32_0_OFFSET UNITYSDK_OFFSET(0x9455D20)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER__PLAYANIMATION_B__22_0_OFFSET UNITYSDK_OFFSET(0x9455C00)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER__PLAYANIMATION_B__22_1_OFFSET UNITYSDK_OFFSET(0x9455C90)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9455D50)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9455DC0)
#define MOLEMOLE_UIMINISCAPETALENTPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9455DD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMiniscapeTalentPageController_TypeDefinitionIndex = 54715;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UIMiniscapeTalentPageController_TypeDefinitionIndex)->GetStaticField(0xC460);
		}
		// static const ::System::String* _talentPageBg1; // 0x0
		// static const ::System::String* _talentPageBg2; // 0x0
		::System::Collections::Generic::List_1<::System::String*>* _talentPageBgList; // 0x2F8
		::Class_2_79AE422BA06F6D26_19* _view; // 0x300
		::Class_2_284357FC8741A11A* _model; // 0x308
		::MoleMole::UIMiniscapeTalentPiontWidgetController* _rightTalentTemplate; // 0x310
		::MoleMole::UIMiniscapeTalentPiontWidgetController* _rightTalentTemplateBg; // 0x318
		::UnityEngine::Coroutine* _animationCallBack; // 0x320
		::UnityEngine::Coroutine* _animationCallBackBg; // 0x328
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::MoleMole::UIMiniscapeTalentPageController_MiniscapeTalentOneRowData*>*>* _panelDataMap; // 0x330
		::System::Collections::Generic::List_1<::System::Int32>* _avatarList; // 0x338
		::MoleMole::UIMiniscapeTalentPiontWidgetController* _cacheTalentTemplate; // 0x340
		::System::UInt32 _currentAvatarId; // 0x348
		::System::UInt32 _currentTalentId; // 0x34C
