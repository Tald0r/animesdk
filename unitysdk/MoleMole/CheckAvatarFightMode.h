...
#define MOLEMOLE_CHECKAVATARFIGHTMODE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x6295F80)
#define MOLEMOLE_CHECKAVATARFIGHTMODE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x62960C0)
#define MOLEMOLE_CHECKAVATARFIGHTMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x62962B0)
#define MOLEMOLE_CHECKAVATARFIGHTMODE___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x62962F0)
#define MOLEMOLE_CHECKAVATARFIGHTMODE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x6296380)

namespace MoleMole
{
	inline static constexpr unsigned int CheckAvatarFightMode_TypeDefinitionIndex = 75289;
