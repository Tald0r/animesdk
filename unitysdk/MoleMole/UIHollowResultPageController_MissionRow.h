...
#define MOLEMOLE_UIHOLLOWRESULTPAGECONTROLLER_MISSIONROW__CTOR_OFFSET UNITYSDK_OFFSET(0x97FFA00)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowResultPageController_MissionRow_TypeDefinitionIndex = 61270;
