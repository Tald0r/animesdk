...
#define MOLEMOLE_UIADAPTDATA_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xB96DEC0)
#define MOLEMOLE_UIADAPTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB96DEB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAdaptData_TypeDefinitionIndex = 74697;
