...
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER_GETAREAICONPATH_OFFSET UNITYSDK_OFFSET(0x748C2D0)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER_GETSECTIONNAME_OFFSET UNITYSDK_OFFSET(0x748C150)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x748B730)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x748BFA0)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x748B8B0)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x748B7D0)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x748B510)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x748B990)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x748C090)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x748C550)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x748C560)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x748C5D0)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x748C640)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x748C6C0)
#define MOLEMOLE_UIPARTNERDATEMAPROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x748C740)

namespace MoleMole
{
	inline static constexpr unsigned int UIPartnerDateMapRowWidgetController_TypeDefinitionIndex = 61674;
	...
	public:
		...
		::Class_2_208CC9941471731A_406* _config; // 0x2D8
