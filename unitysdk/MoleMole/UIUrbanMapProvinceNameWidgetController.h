...
#define MOLEMOLE_UIURBANMAPPROVINCENAMEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3F3F90)
#define MOLEMOLE_UIURBANMAPPROVINCENAMEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3F4000)
#define MOLEMOLE_UIURBANMAPPROVINCENAMEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC3F4100)
#define MOLEMOLE_UIURBANMAPPROVINCENAMEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC3F4240)
#define MOLEMOLE_UIURBANMAPPROVINCENAMEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xC3F4270)
#define MOLEMOLE_UIURBANMAPPROVINCENAMEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC3F42E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapProvinceNameWidgetController_TypeDefinitionIndex = 55607;
