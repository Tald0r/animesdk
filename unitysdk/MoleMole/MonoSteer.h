...
#define MOLEMOLE_MONOSTEER_GETSTEER_OFFSET UNITYSDK_OFFSET(0x8F39690)
#define MOLEMOLE_MONOSTEER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F39990)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSteer_TypeDefinitionIndex = 76260;
