...
#define MOLEMOLE_UIINLEVEL_BIGBOSSLONGFIGHT_BATTLEINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D76F30)
#define MOLEMOLE_UIINLEVEL_BIGBOSSLONGFIGHT_BATTLEINFOWIDGETCONTROLLER__REFRESHREWARDS_OFFSET UNITYSDK_OFFSET(0x9D76A90)
#define MOLEMOLE_UIINLEVEL_BIGBOSSLONGFIGHT_BATTLEINFOWIDGETCONTROLLER___BASE__REFRESHREWARDS_OFFSET UNITYSDK_OFFSET(0x9D76F40)

namespace MoleMole
{
	inline static constexpr unsigned int UIInlevel_BigBossLongFight_BattleInfoWidgetController_TypeDefinitionIndex = 59180;
