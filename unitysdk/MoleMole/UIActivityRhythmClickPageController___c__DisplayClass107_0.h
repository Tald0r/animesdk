...
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS107_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB5E4D70)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS107_0__PLAYREACHRANKEFFECT_B__0_OFFSET UNITYSDK_OFFSET(0xB5E4D80)
#define MOLEMOLE_UIACTIVITYRHYTHMCLICKPAGECONTROLLER___C__DISPLAYCLASS107_0__PLAYREACHRANKEFFECT_B__1_OFFSET UNITYSDK_OFFSET(0xB5E4E20)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityRhythmClickPageController___c__DisplayClass107_0_TypeDefinitionIndex = 41471;
