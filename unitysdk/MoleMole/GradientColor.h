...
#define MOLEMOLE_GRADIENTCOLOR_GET_COLORBOTTOM_OFFSET UNITYSDK_OFFSET(0xD80D590)
#define MOLEMOLE_GRADIENTCOLOR_GET_COLORLEFT_OFFSET UNITYSDK_OFFSET(0xD80D670)
#define MOLEMOLE_GRADIENTCOLOR_GET_COLORRIGHT_OFFSET UNITYSDK_OFFSET(0xD80D750)
#define MOLEMOLE_GRADIENTCOLOR_GET_COLORTOP_OFFSET UNITYSDK_OFFSET(0xD80D3A0)
#define MOLEMOLE_GRADIENTCOLOR_GET_GRADIENTOFFSETHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xD80D900)
#define MOLEMOLE_GRADIENTCOLOR_GET_GRADIENTOFFSETVERTICAL_OFFSET UNITYSDK_OFFSET(0xD80D830)
#define MOLEMOLE_GRADIENTCOLOR_GET_IGNOREPRECOLOR_OFFSET UNITYSDK_OFFSET(0xD80D9D0)
#define MOLEMOLE_GRADIENTCOLOR_METHOD_7_151E25A63D14DDB0_OFFSET UNITYSDK_OFFSET(0xD80D480)
#define MOLEMOLE_GRADIENTCOLOR_METHOD_7_64484B20CD8E3ABE_OFFSET UNITYSDK_OFFSET(0xD80DC70)
#define MOLEMOLE_GRADIENTCOLOR_METHOD_7_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0xD80E220)
#define MOLEMOLE_GRADIENTCOLOR_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xD80DA60)
#define MOLEMOLE_GRADIENTCOLOR_SET_COLORBOTTOM_OFFSET UNITYSDK_OFFSET(0xD80D5A0)
#define MOLEMOLE_GRADIENTCOLOR_SET_COLORLEFT_OFFSET UNITYSDK_OFFSET(0xD80D680)
#define MOLEMOLE_GRADIENTCOLOR_SET_COLORRIGHT_OFFSET UNITYSDK_OFFSET(0xD80D760)
#define MOLEMOLE_GRADIENTCOLOR_SET_COLORTOP_OFFSET UNITYSDK_OFFSET(0xD80D3B0)
#define MOLEMOLE_GRADIENTCOLOR_SET_GRADIENTOFFSETHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xD80D910)
#define MOLEMOLE_GRADIENTCOLOR_SET_GRADIENTOFFSETVERTICAL_OFFSET UNITYSDK_OFFSET(0xD80D840)
#define MOLEMOLE_GRADIENTCOLOR_SET_IGNOREPRECOLOR_OFFSET UNITYSDK_OFFSET(0xD80D9E0)
#define MOLEMOLE_GRADIENTCOLOR_START_OFFSET UNITYSDK_OFFSET(0xD80E190)
#define MOLEMOLE_GRADIENTCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0xD80E3B0)
#define MOLEMOLE_GRADIENTCOLOR___BASE_START_OFFSET UNITYSDK_OFFSET(0xD80E440)

namespace MoleMole
{
	inline static constexpr unsigned int GradientColor_TypeDefinitionIndex = 66582;
	...
	public:
		...
		::System::Void Method_7_64484B20CD8E3ABE(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>* a1)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::UnityEngine::UIVertex>*))((::PBYTE)hIl2Cpp + MOLEMOLE_GRADIENTCOLOR_METHOD_7_64484B20CD8E3ABE_OFFSET))(this, a1);
		}
