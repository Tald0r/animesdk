...
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATEARTIFACTITEMROWV2_OFFSET UNITYSDK_OFFSET(0xA19D4E0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATEARTIFACTITEMROW_OFFSET UNITYSDK_OFFSET(0xA19D430)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATECARDROWV2_OFFSET UNITYSDK_OFFSET(0xA19D640)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATECARDROW_OFFSET UNITYSDK_OFFSET(0xA19D2D0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATEHOLLOWCHOICEITEMROW_OFFSET UNITYSDK_OFFSET(0xA19D590)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATERELICITEMROW_OFFSET UNITYSDK_OFFSET(0xA19D380)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0xA19D6F0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONTOGGLECHANGE_OFFSET UNITYSDK_OFFSET(0xA19CB20)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA19C4F0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA19C850)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_REFRESHTOGGLETEXT_OFFSET UNITYSDK_OFFSET(0xA19CF00)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_SCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0xA19CFD0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_SETTOGGLE_OFFSET UNITYSDK_OFFSET(0xA19C7B0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA19D810)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA19D870)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA19D880)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_SCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0xA19D890)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemOptionsDialogV2PopWindowController_TypeDefinitionIndex = 48238;
