...
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATEARTIFACTITEMROWV2_OFFSET UNITYSDK_OFFSET(0x9D2F950)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATEARTIFACTITEMROW_OFFSET UNITYSDK_OFFSET(0x9D2F8A0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATECARDROWV2_OFFSET UNITYSDK_OFFSET(0x9D2FAB0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATECARDROW_OFFSET UNITYSDK_OFFSET(0x9D2F740)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATEHOLLOWCHOICEITEMROW_OFFSET UNITYSDK_OFFSET(0x9D2FA00)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_CREATERELICITEMROW_OFFSET UNITYSDK_OFFSET(0x9D2F7F0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_GETTEMPLATEINDEXFROMDATA_OFFSET UNITYSDK_OFFSET(0x9D2FB60)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONTOGGLECHANGE_OFFSET UNITYSDK_OFFSET(0x9D2EFA0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D2E960)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9D2ECD0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_REFRESHTOGGLETEXT_OFFSET UNITYSDK_OFFSET(0x9D2F370)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_SCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0x9D2F430)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER_SETTOGGLE_OFFSET UNITYSDK_OFFSET(0x9D2EC20)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D2FC80)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D2FCE0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9D2FCF0)
#define MOLEMOLE_UIHOLLOWITEMOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_SCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0x9D2FD00)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowItemOptionsDialogV2PopWindowController_TypeDefinitionIndex = 64537;
	...
	{
	public:
		::MoleMole::UIGeneralToggleWidgetControllerWithModel* _toggleDetail; // 0x3E0
