...
#define MOLEMOLE_UIHANDBOOKTABBTNSTIPSWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7A69480)
#define MOLEMOLE_UIHANDBOOKTABBTNSTIPSWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7A694F0)
#define MOLEMOLE_UIHANDBOOKTABBTNSTIPSWIDGETCONTROLLER_SETTABTYPE_OFFSET UNITYSDK_OFFSET(0x7A692E0)
#define MOLEMOLE_UIHANDBOOKTABBTNSTIPSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7A695F0)
#define MOLEMOLE_UIHANDBOOKTABBTNSTIPSWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x7A69620)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookTabBtnsTipsWidgetController_TypeDefinitionIndex = 46400;
