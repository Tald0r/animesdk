...
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAB8A7F0)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAB8A860)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAB8ABF0)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAB8A960)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER_SETRECOMMEND_OFFSET UNITYSDK_OFFSET(0xAB8AB20)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAB8AD70)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAB8AD80)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xAB8ADF0)
#define MOLEMOLE_UIREPELPREPSELECTBUFFROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAB8AE60)

namespace MoleMole
{
	inline static constexpr unsigned int UIRepelPrepSelectBuffRowWidgetController_TypeDefinitionIndex = 64605;
