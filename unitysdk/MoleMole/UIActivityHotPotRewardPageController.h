...
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xBFA7800)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFA7810)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFA7880)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER_ONLIVEHOUSEGETREWARD_OFFSET UNITYSDK_OFFSET(0xBFA7C40)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFA7B80)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFA7940)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFA7ED0)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBFA7EE0)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFA7F50)
#define MOLEMOLE_UIACTIVITYHOTPOTREWARDPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFA7F60)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityHotPotRewardPageController_TypeDefinitionIndex = 47871;
