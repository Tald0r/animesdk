...
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ADDCOMPENTERBTN_OFFSET UNITYSDK_OFFSET(0x7543810)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_CLEARCOMPBTN_OFFSET UNITYSDK_OFFSET(0x7542B50)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x7541DB0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_LOADCUSTOMBACKGROUND_OFFSET UNITYSDK_OFFSET(0x7543200)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONACTIVITYCLOSE_OFFSET UNITYSDK_OFFSET(0x7546650)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONACTIVITYEND_OFFSET UNITYSDK_OFFSET(0x7544410)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONCLICKBACK_OFFSET UNITYSDK_OFFSET(0x7545E40)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONCLICKCOLLECT_OFFSET UNITYSDK_OFFSET(0x75461F0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONCLICKHARD_OFFSET UNITYSDK_OFFSET(0x7545640)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONCLICKLEVEL_OFFSET UNITYSDK_OFFSET(0x7546080)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONCLICKMAINCITY_OFFSET UNITYSDK_OFFSET(0x7545F30)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONCLICKNORMAL_OFFSET UNITYSDK_OFFSET(0x75453C0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONCLICKOK_OFFSET UNITYSDK_OFFSET(0x7546270)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7541DC0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONSELECTQUESTCHANGE_OFFSET UNITYSDK_OFFSET(0x75456D0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7543D60)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x75427B0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7541E60)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7542C70)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONVIRUSLEVELSTARTTIME_OFFSET UNITYSDK_OFFSET(0x7546840)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_ONVIRUSLEVELUPOPEN_OFFSET UNITYSDK_OFFSET(0x75467D0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x7543F20)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_RECORDTABCLICK_OFFSET UNITYSDK_OFFSET(0x7545450)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_REFRESHBACKGROUND_OFFSET UNITYSDK_OFFSET(0x75440E0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_REFRESHBOTTOMBTN_OFFSET UNITYSDK_OFFSET(0x75444C0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_REFRESHLEVELBTNNEW_OFFSET UNITYSDK_OFFSET(0x7545AA0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_REFRESHLEVELTYPE_OFFSET UNITYSDK_OFFSET(0x7544860)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_REFRESHOKBTN_OFFSET UNITYSDK_OFFSET(0x7545750)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_REFRESHREMAINTIMER_OFFSET UNITYSDK_OFFSET(0x75435E0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_REFRESHTABNEW_OFFSET UNITYSDK_OFFSET(0x7544F50)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_REFRESHTABTRACK_OFFSET UNITYSDK_OFFSET(0x7544D70)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_REFRESHTAB_OFFSET UNITYSDK_OFFSET(0x7544990)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_SELECTTAB_OFFSET UNITYSDK_OFFSET(0x7544B70)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_SETVIRUSSTATE_OFFSET UNITYSDK_OFFSET(0x75439F0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER_TRYCREATETEAMTRIALWIDGET_OFFSET UNITYSDK_OFFSET(0x75445A0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x75468C0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER__ONCLICKBACK_B__40_0_OFFSET UNITYSDK_OFFSET(0x75468F0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7546990)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7546A00)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7546A10)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7546A90)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7546AF0)
#define MOLEMOLE_UIVIRUSWIDGETCONTROLLER___BASE_PLAYFADEIN_OFFSET UNITYSDK_OFFSET(0x7546B60)

namespace MoleMole
{
	inline static constexpr unsigned int UIVirusWidgetController_TypeDefinitionIndex = 60533;

	class UIVirusWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_157* _view; // 0x2A0
		::MoleMole::UIVirusWidgetController_PageState _pageState; // 0x2A8
		::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 _levelType; // 0x2AC
		...
		::System::Void RefreshBackground(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 levelType)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSWIDGETCONTROLLER_REFRESHBACKGROUND_OFFSET))(this, levelType);
		}
		...
		::System::Void SetVirusState(::MoleMole::UIVirusWidgetController_PageState pageState, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 levelType, ::System::Int32 questID, ::System::Boolean selectTab)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::UIVirusWidgetController_PageState, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1, ::System::Int32, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSWIDGETCONTROLLER_SETVIRUSSTATE_OFFSET))(this, pageState, levelType, questID, selectTab);
		}

		::System::Void TryCreateTeamTrialWidget(::MoleMole::UIVirusWidgetController_PageState pageState, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 levelType)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::UIVirusWidgetController_PageState, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSWIDGETCONTROLLER_TRYCREATETEAMTRIALWIDGET_OFFSET))(this, pageState, levelType);
		}

		::System::Void RefreshLevelType(::MoleMole::UIVirusWidgetController_PageState pageState, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 levelType, ::System::Int32 questID, ::System::Boolean selectTab)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::UIVirusWidgetController_PageState, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1, ::System::Int32, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSWIDGETCONTROLLER_REFRESHLEVELTYPE_OFFSET))(this, pageState, levelType, questID, selectTab);
		}
		...
		::System::Void RecordTabClick(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 levelType)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSWIDGETCONTROLLER_RECORDTABCLICK_OFFSET))(this, levelType);
		}

		::System::Void SelectTab(::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1 levelType, ::System::Boolean withAni, ::System::Int32 questID)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_07824EC7A4EBA6CE_Enum_3_D1D49B5EF8F4C317_1, ::System::Boolean, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVIRUSWIDGETCONTROLLER_SELECTTAB_OFFSET))(this, levelType, withAni, questID);
		}
