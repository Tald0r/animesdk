...
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ADD_ONSELECTEMOJI_OFFSET UNITYSDK_OFFSET(0xADE3530)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_CLOSEWIDGET_OFFSET UNITYSDK_OFFSET(0xADE2EC0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xADE3510)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_INITWIDGET_OFFSET UNITYSDK_OFFSET(0xADE2C40)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONCLICKEMOJIGROUPITEM_OFFSET UNITYSDK_OFFSET(0xADE3280)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONCLICKEMOJIITEM_OFFSET UNITYSDK_OFFSET(0xADE3080)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADE2AC0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADE2B60)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADE2060)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADE2A10)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_REMOVE_ONSELECTEMOJI_OFFSET UNITYSDK_OFFSET(0xADE35A0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_SET_ISSHOW_OFFSET UNITYSDK_OFFSET(0xADE3520)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_SHOWWIDGET_OFFSET UNITYSDK_OFFSET(0xADE2CB0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER_UPDATEFAVEMOJI_OFFSET UNITYSDK_OFFSET(0xADE2780)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER__CLOSEWIDGET_B__9_0_OFFSET UNITYSDK_OFFSET(0xADE3640)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xADE3610)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xADE3650)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xADE36C0)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADE3740)
#define MOLEMOLE_UIFRIENDCHATEMOJIWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xADE37A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFriendChatEmojiWidgetController_TypeDefinitionIndex = 52684;
