...
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_BINDHIGHLIGHTFAIL_OFFSET UNITYSDK_OFFSET(0x747EC30)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_BINDHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x747EFF0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_CHANGESTATE_OFFSET UNITYSDK_OFFSET(0x747E960)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_CHECKBUTTONPROTECT_OFFSET UNITYSDK_OFFSET(0x7483F90)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_CHECKENDBYCONDITION_OFFSET UNITYSDK_OFFSET(0x7482E50)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_CLOSECIRCLEEFFECT_OFFSET UNITYSDK_OFFSET(0x747F2F0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_CONDITIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x7483980)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_DISABLERAYCAST_OFFSET UNITYSDK_OFFSET(0x747E870)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_DOTRIGGERNEXTSTEP_OFFSET UNITYSDK_OFFSET(0x7482B10)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ENDCURSTEPBYCONDITION_OFFSET UNITYSDK_OFFSET(0x7483030)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ENDNEWBIE_OFFSET UNITYSDK_OFFSET(0x747ED20)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_EXECCURNEWBIESTEP_OFFSET UNITYSDK_OFFSET(0x74826E0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_FINISHCURRENTNEWBIE_OFFSET UNITYSDK_OFFSET(0x7481680)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_FORCETRIGGERNEXTSTEP_OFFSET UNITYSDK_OFFSET(0x74816F0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_GETBINDTARGET_OFFSET UNITYSDK_OFFSET(0x747F800)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_GETRUNNINGGROUP_OFFSET UNITYSDK_OFFSET(0x7480290)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_GETSTEPINDEX_OFFSET UNITYSDK_OFFSET(0x7480300)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x747FAD0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_GET_CURNEWBIESTEP_OFFSET UNITYSDK_OFFSET(0x747E7B0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_GET_ISALLOWINPUTPASS_OFFSET UNITYSDK_OFFSET(0x747FAE0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_GET_SENDOPENPOPUPFORNEWBIE_OFFSET UNITYSDK_OFFSET(0x74826D0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0x747FE80)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x747FAC0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_GOCONSOLENEXTSTEP_OFFSET UNITYSDK_OFFSET(0x7482C70)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_GONEXTSTEP_OFFSET UNITYSDK_OFFSET(0x7482930)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_GUIROOTONBLACKEDGEALPHACHANGED_OFFSET UNITYSDK_OFFSET(0x74813E0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_HANDLECURNEWBIESTEP_OFFSET UNITYSDK_OFFSET(0x74839F0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_HANDLEFAIRY_OFFSET UNITYSDK_OFFSET(0x7483E20)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_HANDLEHIGHLIGHTGO_OFFSET UNITYSDK_OFFSET(0x7484420)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_HANDLEHIGHLIGHTSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x74849D0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_HANDLEHIGHLIGHTS_OFFSET UNITYSDK_OFFSET(0x7483C50)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_HANDLEHIGHLIGHT_1_OFFSET UNITYSDK_OFFSET(0x74840C0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_HANDLEHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x747F190)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_HANDLEHIGHTLIGHTGONONE_OFFSET UNITYSDK_OFFSET(0x7484960)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_HANDLEMASK_OFFSET UNITYSDK_OFFSET(0x747F4A0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_HASFAIRYEXCLUDECTRL_OFFSET UNITYSDK_OFFSET(0x7480370)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ISALLOWINPUTPASSBYACTION_OFFSET UNITYSDK_OFFSET(0x747FB60)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ISCONDITIONACHIEVE_OFFSET UNITYSDK_OFFSET(0x7482EE0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONCLICKGONEXT_OFFSET UNITYSDK_OFFSET(0x7482C00)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONCONSOLENEXT_OFFSET UNITYSDK_OFFSET(0x7482050)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7480450)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONFULLSCREENBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x7485650)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONHOOKWINDOWCLOSED_OFFSET UNITYSDK_OFFSET(0x7485700)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONINPUTACTIONPOSTUPDATE_OFFSET UNITYSDK_OFFSET(0x7481E30)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONINPUTACTIONPREUPDATE_OFFSET UNITYSDK_OFFSET(0x7481DB0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x7482250)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONNEWBIETRIGGER_OFFSET UNITYSDK_OFFSET(0x74807B0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x747E8F0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7480B20)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7481A40)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7480DA0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x74804F0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_OPENCIRCLEEFFECT_OFFSET UNITYSDK_OFFSET(0x747F3B0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_RESETGUIDEDATA_OFFSET UNITYSDK_OFFSET(0x7480C40)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_REVERSECURNEWBIESTEP_OFFSET UNITYSDK_OFFSET(0x7483160)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_REVERSEHIGHLIGHTS_OFFSET UNITYSDK_OFFSET(0x74853E0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_SENDENDNEWBIE_OFFSET UNITYSDK_OFFSET(0x74834C0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_SETCIRCLERATIO_OFFSET UNITYSDK_OFFSET(0x747F720)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_SETCURSTEP_OFFSET UNITYSDK_OFFSET(0x7483630)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x74814B0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_STARTNEWLOOP_OFFSET UNITYSDK_OFFSET(0x747E7C0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_TOPARAM_OFFSET UNITYSDK_OFFSET(0x7484330)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_TRIGGERCURNEWBIESTEP_OFFSET UNITYSDK_OFFSET(0x7483700)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_TRYGETTARGET_OFFSET UNITYSDK_OFFSET(0x747EA10)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x7482600)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7485920)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER__HANDLEHIGHLIGHT_OFFSET UNITYSDK_OFFSET(0x7484FE0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER__ONUIOPEN_B__31_0_OFFSET UNITYSDK_OFFSET(0x7485A30)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER__REVERSECURNEWBIESTEP_G__REVERSEMASKANDHIGHLIGHTS_70_0_OFFSET UNITYSDK_OFFSET(0x7485260)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER___BASE_GET_ISALLOWINPUTPASS_OFFSET UNITYSDK_OFFSET(0x7485AF0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER___BASE_GET_UICURSORHIDESTATE_OFFSET UNITYSDK_OFFSET(0x7485B00)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER___BASE_ISALLOWINPUTPASSBYACTION_OFFSET UNITYSDK_OFFSET(0x7485B10)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7485BA0)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x7485C10)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x7485C40)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7485C50)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7485C60)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7485C70)
#define MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0x7485CE0)

namespace MoleMole
{
	inline static constexpr unsigned int UINewbiePopWindowController_TypeDefinitionIndex = 39790;

	class UINewbiePopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		// static const ::System::Int32 NextDelay = 0x1F4; // 0x0
		::Class_1_87EC7A567DC0B76A<::MoleMole::UINewbiePopWindowController*>* _stateMachine; // 0x2F8
		::MoleMole::UIBaseController* _curHookWindow; // 0x300
		::System::Int32 _curNewbieGroupId; // 0x308
		::Struct_2_B136CFD8FB6B8F37 _conditionHandle; // 0x30C
		...
		::System::Void OnStateChange(::Class_0_16E4307DCC419505_212* last, ::Class_0_16E4307DCC419505_212* current)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_212*, ::Class_0_16E4307DCC419505_212*))((::PBYTE)hIl2Cpp + MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_ONSTATECHANGE_OFFSET))(this, last, current);
		}

		::System::Void ChangeState(::Class_0_16E4307DCC419505_213<::MoleMole::UINewbiePopWindowController*>* state)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_213<::MoleMole::UINewbiePopWindowController*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UINEWBIEPOPWINDOWCONTROLLER_CHANGESTATE_OFFSET))(this, state);
		}
