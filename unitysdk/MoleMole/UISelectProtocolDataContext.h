...
#define MOLEMOLE_UISELECTPROTOCOLDATACONTEXT_ADDPROTOCOLROWITEM_OFFSET UNITYSDK_OFFSET(0xD6C60E0)
#define MOLEMOLE_UISELECTPROTOCOLDATACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD6C61D0)

namespace MoleMole
{
	inline static constexpr unsigned int UISelectProtocolDataContext_TypeDefinitionIndex = 39118;
