...
#define MOLEMOLE_UISELECTPROTOCOLDATACONTEXT_ADDPROTOCOLROWITEM_OFFSET UNITYSDK_OFFSET(0xDF352C0)
#define MOLEMOLE_UISELECTPROTOCOLDATACONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xDF353B0)

namespace MoleMole
{
	inline static constexpr unsigned int UISelectProtocolDataContext_TypeDefinitionIndex = 41221;
