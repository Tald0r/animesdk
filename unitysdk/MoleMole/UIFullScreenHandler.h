...
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_03F1CD50928B7BED_OFFSET UNITYSDK_OFFSET(0xD058540)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_0B08B4F8E959C85E_OFFSET UNITYSDK_OFFSET(0xD059260)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_1AC45929DDC5B1CB_OFFSET UNITYSDK_OFFSET(0xD0581E0)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0xD0593E0)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xD059570)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0xD058D20)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_5E72916301E347E2_OFFSET UNITYSDK_OFFSET(0xD057AC0)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_77577333B4681208_OFFSET UNITYSDK_OFFSET(0xD057E70)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_937F8473216A3162_OFFSET UNITYSDK_OFFSET(0xD056DE0)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_9D4EC0959ED23C46_OFFSET UNITYSDK_OFFSET(0xD059120)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xD058CC0)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_E41B6A823556FEEA_OFFSET UNITYSDK_OFFSET(0xD058EC0)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_EF0714CC5ADE74A7_OFFSET UNITYSDK_OFFSET(0xD058B70)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_F530CA3FA28BEDE8_OFFSET UNITYSDK_OFFSET(0xD059450)
#define MOLEMOLE_UIFULLSCREENHANDLER_METHOD_6_F84C02269E33D54C_OFFSET UNITYSDK_OFFSET(0xD057F10)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONBEFORETRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0xD0574D0)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0xD0573B0)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD057130)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD056EB0)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0xD0571C0)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0xD057320)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xD056CC0)
#define MOLEMOLE_UIFULLSCREENHANDLER_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0xD057010)
#define MOLEMOLE_UIFULLSCREENHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD0575F0)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONBEFORETRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0xD057640)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0xD0576D0)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD057760)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD0577F0)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0xD057880)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0xD057910)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xD0579A0)
#define MOLEMOLE_UIFULLSCREENHANDLER___BASE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0xD057A30)

namespace MoleMole
{
	inline static constexpr unsigned int UIFullScreenHandler_TypeDefinitionIndex = 74025;
