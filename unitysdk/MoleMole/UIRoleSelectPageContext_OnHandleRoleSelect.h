...
#define MOLEMOLE_UIROLESELECTPAGECONTEXT_ONHANDLEROLESELECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x73BD470)
#define MOLEMOLE_UIROLESELECTPAGECONTEXT_ONHANDLEROLESELECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x73BD4A0)
#define MOLEMOLE_UIROLESELECTPAGECONTEXT_ONHANDLEROLESELECT_INVOKE_OFFSET UNITYSDK_OFFSET(0x73BCF70)
#define MOLEMOLE_UIROLESELECTPAGECONTEXT_ONHANDLEROLESELECT__CTOR_OFFSET UNITYSDK_OFFSET(0x73BCF60)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPageContext_OnHandleRoleSelect_TypeDefinitionIndex = 40290;
