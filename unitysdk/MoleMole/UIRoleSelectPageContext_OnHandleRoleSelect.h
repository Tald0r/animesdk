...
#define MOLEMOLE_UIROLESELECTPAGECONTEXT_ONHANDLEROLESELECT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAFB0ED0)
#define MOLEMOLE_UIROLESELECTPAGECONTEXT_ONHANDLEROLESELECT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAFB0F00)
#define MOLEMOLE_UIROLESELECTPAGECONTEXT_ONHANDLEROLESELECT_INVOKE_OFFSET UNITYSDK_OFFSET(0xAFB09D0)
#define MOLEMOLE_UIROLESELECTPAGECONTEXT_ONHANDLEROLESELECT__CTOR_OFFSET UNITYSDK_OFFSET(0xAFB09B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSelectPageContext_OnHandleRoleSelect_TypeDefinitionIndex = 63444;
