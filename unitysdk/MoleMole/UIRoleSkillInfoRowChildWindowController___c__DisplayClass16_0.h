...
#define MOLEMOLE_UIROLESKILLINFOROWCHILDWINDOWCONTROLLER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x73BD550)
#define MOLEMOLE_UIROLESKILLINFOROWCHILDWINDOWCONTROLLER___C__DISPLAYCLASS16_0__SHOWSKILLPASSIVEVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x73BD560)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleSkillInfoRowChildWindowController___c__DisplayClass16_0_TypeDefinitionIndex = 61630;

	class UIRoleSkillInfoRowChildWindowController___c__DisplayClass16_0 : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_671* template_; // 0x10
