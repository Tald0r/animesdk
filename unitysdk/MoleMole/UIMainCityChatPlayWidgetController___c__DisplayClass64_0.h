...
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8971C90)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_0__SHOWNARRATORSCREEN_B__10_OFFSET UNITYSDK_OFFSET(0x8972B70)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_0__SHOWNARRATORSCREEN_B__11_OFFSET UNITYSDK_OFFSET(0x8972BD0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_0__SHOWNARRATORSCREEN_B__1_OFFSET UNITYSDK_OFFSET(0x89725F0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_0__SHOWNARRATORSCREEN_B__2_OFFSET UNITYSDK_OFFSET(0x8972650)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_0__SHOWNARRATORSCREEN_B__3_OFFSET UNITYSDK_OFFSET(0x8972910)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_0__SHOWNARRATORSCREEN_B__6_OFFSET UNITYSDK_OFFSET(0x8972D40)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_0__SHOWNARRATORSCREEN_B__7_OFFSET UNITYSDK_OFFSET(0x89727A0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_0__SHOWNARRATORSCREEN_B__8_OFFSET UNITYSDK_OFFSET(0x89728B0)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_0__SHOWNARRATORSCREEN_B__9_OFFSET UNITYSDK_OFFSET(0x8972A20)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_0__SHOWNARRATORSCREEN_G__ONFINISH_4_OFFSET UNITYSDK_OFFSET(0x8972A80)
#define MOLEMOLE_UIMAINCITYCHATPLAYWIDGETCONTROLLER___C__DISPLAYCLASS64_0__SHOWNARRATORSCREEN_G__OPENNARRATORSCREEN_0_OFFSET UNITYSDK_OFFSET(0x8971CA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityChatPlayWidgetController___c__DisplayClass64_0_TypeDefinitionIndex = 69010;
	...
	public:
		...
		::UnityEngine::Events::UnityAction* __9__9; // 0x18
		::System::Action* onFadeInFinished; // 0x20
		::UnityEngine::Events::UnityAction* __9__8; // 0x28
