...
#define MOLEMOLE_SUIBIANTEMPLEMANAGEDETAILCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7F28130)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianTempleManageDetailContext_TypeDefinitionIndex = 66998;
