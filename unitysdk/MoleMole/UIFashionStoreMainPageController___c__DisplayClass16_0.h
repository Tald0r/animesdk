...
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8BF2260)
#define MOLEMOLE_UIFASHIONSTOREMAINPAGECONTROLLER___C__DISPLAYCLASS16_0__ONSUCCESSBUYINGPRODUCT_B__0_OFFSET UNITYSDK_OFFSET(0x8BF2270)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreMainPageController___c__DisplayClass16_0_TypeDefinitionIndex = 42143;
