...
#define MOLEMOLE_UIFORGEUPDETAILCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xD1222E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIForgeUPDetailContext_TypeDefinitionIndex = 57741;
