...
#define MOLEMOLE_UIFORGEUPDETAILCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA358310)

namespace MoleMole
{
	inline static constexpr unsigned int UIForgeUPDetailContext_TypeDefinitionIndex = 52239;
