...
#define MOLEMOLE_UIHOUSERHYTHMVIEWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D4CF30)

namespace MoleMole
{
	inline static constexpr unsigned int UIHouseRhythmViewContext_TypeDefinitionIndex = 69036;
