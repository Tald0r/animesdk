...
#define MOLEMOLE_GLOBALMAPRESPONSE_METHOD_5_0B63A0EF42BD601E_OFFSET UNITYSDK_OFFSET(0x7A6D0D0)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x7A6CF60)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x7A6CF00)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x7A6CFD0)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x7A6D040)
#define MOLEMOLE_GLOBALMAPRESPONSE_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x7A6CE90)
#define MOLEMOLE_GLOBALMAPRESPONSE_UPDATE_OFFSET UNITYSDK_OFFSET(0x7A6CD40)
#define MOLEMOLE_GLOBALMAPRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x7A6D0B0)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalMapResponse_TypeDefinitionIndex = 74489;
