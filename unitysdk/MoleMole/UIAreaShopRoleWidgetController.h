...
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0x989C8F0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x989D160)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x989D200)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x989C670)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x989C840)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_REFRESHHPRATIO_OFFSET UNITYSDK_OFFSET(0x989CCC0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x989D2E0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x989D310)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x989D380)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x989D400)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x989D460)

namespace MoleMole
{
	inline static constexpr unsigned int UIAreaShopRoleWidgetController_TypeDefinitionIndex = 38441;

	class UIAreaShopRoleWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D6BCF098B26738D7* _view; // 0x2A0
		::MoleMole::Battle::Entity* _cachedAvatarEntity; // 0x2A8
