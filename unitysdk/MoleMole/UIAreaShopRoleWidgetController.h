...
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0xC8F13B0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8F1C30)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8F1CD0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8F1130)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC8F1300)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER_REFRESHHPRATIO_OFFSET UNITYSDK_OFFSET(0xC8F1780)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC8F1DB0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC8F1DE0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC8F1E50)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC8F1ED0)
#define MOLEMOLE_UIAREASHOPROLEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC8F1F30)

namespace MoleMole
{
	inline static constexpr unsigned int UIAreaShopRoleWidgetController_TypeDefinitionIndex = 41093;
