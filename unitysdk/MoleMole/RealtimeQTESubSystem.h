...
#define MOLEMOLE_REALTIMEQTESUBSYSTEM_DESTROYREALTIMEQTE_OFFSET UNITYSDK_OFFSET(0x9943170)
#define MOLEMOLE_REALTIMEQTESUBSYSTEM_DESTROYTASK_OFFSET UNITYSDK_OFFSET(0x9942C20)
#define MOLEMOLE_REALTIMEQTESUBSYSTEM_GETTASKBYTAG_OFFSET UNITYSDK_OFFSET(0x9942950)
#define MOLEMOLE_REALTIMEQTESUBSYSTEM_ISTASKWORKING_OFFSET UNITYSDK_OFFSET(0x9942A70)
#define MOLEMOLE_REALTIMEQTESUBSYSTEM_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x9942DB0)
#define MOLEMOLE_REALTIMEQTESUBSYSTEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9942E10)
#define MOLEMOLE_REALTIMEQTESUBSYSTEM_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x9942E80)
#define MOLEMOLE_REALTIMEQTESUBSYSTEM_STARTREALTIMEQTE_OFFSET UNITYSDK_OFFSET(0x9943000)
#define MOLEMOLE_REALTIMEQTESUBSYSTEM_TICKTASK_OFFSET UNITYSDK_OFFSET(0x9942AF0)
#define MOLEMOLE_REALTIMEQTESUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x99431E0)
#define MOLEMOLE_REALTIMEQTESUBSYSTEM___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x99431F0)
#define MOLEMOLE_REALTIMEQTESUBSYSTEM___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9943250)
#define MOLEMOLE_REALTIMEQTESUBSYSTEM___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x99432B0)

namespace MoleMole
{
	inline static constexpr unsigned int RealtimeQTESubSystem_TypeDefinitionIndex = 69623;
