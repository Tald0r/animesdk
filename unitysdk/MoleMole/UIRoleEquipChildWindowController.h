...
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_CHANGEMATERIAL_OFFSET UNITYSDK_OFFSET(0x96F2220)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_CHANGESIGNATUREHANDLE_OFFSET UNITYSDK_OFFSET(0x96F4C00)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_GETROLEINFOEQUIPWIDGETGAMEPADNESTLIST_OFFSET UNITYSDK_OFFSET(0x96F0D40)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_GETWEAPONTOGGLEUNLOCK_OFFSET UNITYSDK_OFFSET(0x96F2450)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_GET_TRIGGERNEWBIEONSHOW_OFFSET UNITYSDK_OFFSET(0x96EF550)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x96EF540)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_HIDETOGGLECONSOLEKEY_OFFSET UNITYSDK_OFFSET(0x96F45B0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_INITANIMGROUP_OFFSET UNITYSDK_OFFSET(0x96EF5D0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x96EFAB0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_INITWEAPONVIDEOSCREEN_OFFSET UNITYSDK_OFFSET(0x96F23D0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ISTRAININGROOM_OFFSET UNITYSDK_OFFSET(0x96F4A30)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_NESTEDLISTSELECTITEMRECURSIVELY_OFFSET UNITYSDK_OFFSET(0x96F10D0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONCLICKEQUIPSLOTBTN_OFFSET UNITYSDK_OFFSET(0x96F5490)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONCLICKWEAPONBTN_OFFSET UNITYSDK_OFFSET(0x96F5300)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x96EFF20)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONEQUIPCHANGED_OFFSET UNITYSDK_OFFSET(0x96F0880)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x96F0960)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x96F06B0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x96EFA30)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x96EFFC0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_ONWEAPONTOGGLEHANDLE_OFFSET UNITYSDK_OFFSET(0x96F46D0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_PLAYAUTODRESSANIM_OFFSET UNITYSDK_OFFSET(0x96F5110)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_PROCESSUIAVATAR_OFFSET UNITYSDK_OFFSET(0x96F08F0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_REFRESHICONVIEW_OFFSET UNITYSDK_OFFSET(0x96F2720)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_REFRESHROLEINFOEQUIPWIDGETWITHWEAPONGAMEPADSELECTINFO_OFFSET UNITYSDK_OFFSET(0x96F12B0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x96F02D0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_RESETALLSLOTSELECTEDSTATE_OFFSET UNITYSDK_OFFSET(0x96F4F50)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_RESETROLEINFOEQUIPWIDGETWITHWEAPONGAMEPADENABLED_OFFSET UNITYSDK_OFFSET(0x96F0EF0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETAUTODRESSMODE_OFFSET UNITYSDK_OFFSET(0x96F1F50)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETAVATARDATA_OFFSET UNITYSDK_OFFSET(0x96F1910)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETBLOCKSELECTEDANIM_OFFSET UNITYSDK_OFFSET(0x96F1A20)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETBLOCKWEAPON_OFFSET UNITYSDK_OFFSET(0x96F1BD0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETCLICKEQUIPCALLBACK_OFFSET UNITYSDK_OFFSET(0x96F4EE0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETCLICKWEAPONCALLBACK_OFFSET UNITYSDK_OFFSET(0x96F4E70)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETEQUIPSLOTSELECTED_OFFSET UNITYSDK_OFFSET(0x96F1510)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETFORGEVIEW_OFFSET UNITYSDK_OFFSET(0x96F1D10)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETGAMEPADSELECTEQUIPCALLBACK_OFFSET UNITYSDK_OFFSET(0x96F4E00)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETGAMEPADSELECTWEAPONCALLBACK_OFFSET UNITYSDK_OFFSET(0x96F4D90)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETLVINFOVISIBLITY_OFFSET UNITYSDK_OFFSET(0x96F1FC0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETROLEINFOEQUIPWIDGETGAMEPADENABLED_OFFSET UNITYSDK_OFFSET(0x96F0CB0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETROLEINFOEQUIPWIDGETWITHWEAPONGAMEPADENABLED_OFFSET UNITYSDK_OFFSET(0x96F0E60)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETTOGGLESTATE_OFFSET UNITYSDK_OFFSET(0x96F25F0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SETWEAPONSLOTSELECTED_OFFSET UNITYSDK_OFFSET(0x96F1470)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER_SHOWTOGGLECONSOLEKEY_OFFSET UNITYSDK_OFFSET(0x96F4640)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x96F5A10)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER__ONUIOPEN_B__8_0_OFFSET UNITYSDK_OFFSET(0x96F5A90)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER__ONUIOPEN_B__8_1_OFFSET UNITYSDK_OFFSET(0x96F5AA0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER__PLAYAUTODRESSANIM_B__41_0_OFFSET UNITYSDK_OFFSET(0x96F5AB0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER___BASE_GET_TRIGGERNEWBIEONSHOW_OFFSET UNITYSDK_OFFSET(0x96F5BB0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x96F5BC0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER___BASE_ONGAMEPADMODULESELECTINDEX_OFFSET UNITYSDK_OFFSET(0x96F5C30)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x96F5CB0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x96F5CC0)
#define MOLEMOLE_UIROLEEQUIPCHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x96F5CD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleEquipChildWindowController_TypeDefinitionIndex = 54976;
	...
	public:
		...
		::Class_2_055450060950DB07_4* _view; // 0x300
