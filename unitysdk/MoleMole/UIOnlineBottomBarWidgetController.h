...
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_BUILDDATABINDING_OFFSET UNITYSDK_OFFSET(0x7395170)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x7394D90)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7394C10)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7394CB0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7394A60)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7394B60)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_REFRESHAIDINGVIEW_OFFSET UNITYSDK_OFFSET(0x73956F0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_REFRESHPROGRESS_OFFSET UNITYSDK_OFFSET(0x7395900)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_SETUPAVATARICON_OFFSET UNITYSDK_OFFSET(0x73953B0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER_SETUPENTITY_OFFSET UNITYSDK_OFFSET(0x7394E90)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER__BUILDDATABINDING_B__20_0_OFFSET UNITYSDK_OFFSET(0x7395D50)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7395CF0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7395BA0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_INITAUTODISPOSEDATABIND_OFFSET UNITYSDK_OFFSET(0x7396120)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7396180)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x73961F0)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7396270)
#define MOLEMOLE_UIONLINEBOTTOMBARWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x73962D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIOnlineBottomBarWidgetController_TypeDefinitionIndex = 47797;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIOnlineBottomBarWidgetController_TypeDefinitionIndex)->GetStaticField(0xDB40);
		}
		static ::System::Int32* StaticGet_StartColorShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIOnlineBottomBarWidgetController_TypeDefinitionIndex)->GetStaticField(0xDB44);
		}
		static ::System::Int32* StaticGet_PatternColorShaderParamID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIOnlineBottomBarWidgetController_TypeDefinitionIndex)->GetStaticField(0xDB48);
		}
