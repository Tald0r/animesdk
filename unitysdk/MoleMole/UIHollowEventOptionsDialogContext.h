...
#define MOLEMOLE_UIHOLLOWEVENTOPTIONSDIALOGCONTEXT_CONTAINSCHOICE_OFFSET UNITYSDK_OFFSET(0xBB26620)
#define MOLEMOLE_UIHOLLOWEVENTOPTIONSDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBB26860)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowEventOptionsDialogContext_TypeDefinitionIndex = 52057;
