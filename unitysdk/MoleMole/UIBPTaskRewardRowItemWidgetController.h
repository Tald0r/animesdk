...
#define MOLEMOLE_UIBPTASKREWARDROWITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF34D30)
#define MOLEMOLE_UIBPTASKREWARDROWITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF34DD0)
#define MOLEMOLE_UIBPTASKREWARDROWITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF34BE0)
#define MOLEMOLE_UIBPTASKREWARDROWITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF34C80)
#define MOLEMOLE_UIBPTASKREWARDROWITEMWIDGETCONTROLLER_REMOVETASKNEWDOTNOTIFICATION_OFFSET UNITYSDK_OFFSET(0xBF354C0)
#define MOLEMOLE_UIBPTASKREWARDROWITEMWIDGETCONTROLLER_SETBPREWARDITEMICON_OFFSET UNITYSDK_OFFSET(0xBF34EB0)
#define MOLEMOLE_UIBPTASKREWARDROWITEMWIDGETCONTROLLER_SETTASKNEWDOTNOTIFICATION_OFFSET UNITYSDK_OFFSET(0xBF35340)
#define MOLEMOLE_UIBPTASKREWARDROWITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBF35590)
#define MOLEMOLE_UIBPTASKREWARDROWITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBF355C0)
#define MOLEMOLE_UIBPTASKREWARDROWITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBF35630)
#define MOLEMOLE_UIBPTASKREWARDROWITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBF356B0)
#define MOLEMOLE_UIBPTASKREWARDROWITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBF35710)

namespace MoleMole
{
	inline static constexpr unsigned int UIBPTaskRewardRowItemWidgetController_TypeDefinitionIndex = 55571;
