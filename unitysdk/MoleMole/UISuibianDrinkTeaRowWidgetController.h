...
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_CLICKITEMBUTTON_OFFSET UNITYSDK_OFFSET(0x86996F0)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8698120)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ONITEMCHANGED_OFFSET UNITYSDK_OFFSET(0x8699D20)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x8699760)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8698360)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ONSUIBIANDRINKINGTEAADDTASKEVENT_OFFSET UNITYSDK_OFFSET(0x8699B70)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ONSUIBIANDRINKINGTEACHANGEORDERDATATOREFRESHITEMEVENT_OFFSET UNITYSDK_OFFSET(0x8699CB0)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ONSUIBIANDRINKINGTEATRACKORDERCHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x86998D0)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ONTRACKQUESTUPDATEEVENT_OFFSET UNITYSDK_OFFSET(0x8699B00)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8698280)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8697D00)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8698070)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_REFRESHPANEL_OFFSET UNITYSDK_OFFSET(0x8698540)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_SHOWPROGRESSSTATUS_OFFSET UNITYSDK_OFFSET(0x8698F70)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_SHOWSUBMITSTATUS_OFFSET UNITYSDK_OFFSET(0x8699460)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER_SHOWTASKTRACK_OFFSET UNITYSDK_OFFSET(0x8699260)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8699D90)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8699DA0)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x8699E10)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8699E80)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8699F00)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8699F80)
#define MOLEMOLE_UISUIBIANDRINKTEAROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8699FE0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianDrinkTeaRowWidgetController_TypeDefinitionIndex = 78526;

	class UISuibianDrinkTeaRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_107* _view; // 0x2D0
