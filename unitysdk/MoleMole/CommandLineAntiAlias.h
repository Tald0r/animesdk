...
#define MOLEMOLE_COMMANDLINEANTIALIAS_METHOD_2_0D1560B7509BDB7B_OFFSET UNITYSDK_OFFSET(0x8034250)
#define MOLEMOLE_COMMANDLINEANTIALIAS_METHOD_2_86159EFDFF90B13C_OFFSET UNITYSDK_OFFSET(0x8034390)
#define MOLEMOLE_COMMANDLINEANTIALIAS__CTOR_OFFSET UNITYSDK_OFFSET(0x8034350)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineAntiAlias_TypeDefinitionIndex = 54579;
