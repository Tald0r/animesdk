...
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER___C__DISPLAYCLASS44_0__CTOR_OFFSET UNITYSDK_OFFSET(0x7C67CD0)
#define MOLEMOLE_UIYOROZUYACHAPTERMAP3DMODELCONTROLLER___C__DISPLAYCLASS44_0__PLAYSTARTMAP_B__0_OFFSET UNITYSDK_OFFSET(0x7C67CE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIYorozuyaChapterMap3DModelController___c__DisplayClass44_0_TypeDefinitionIndex = 66764;
