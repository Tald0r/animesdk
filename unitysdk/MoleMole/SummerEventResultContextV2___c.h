...
#define MOLEMOLE_SUMMEREVENTRESULTCONTEXTV2___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x8A8D790)
#define MOLEMOLE_SUMMEREVENTRESULTCONTEXTV2___C__CTOR_OFFSET UNITYSDK_OFFSET(0x8A8D7D0)
#define MOLEMOLE_SUMMEREVENTRESULTCONTEXTV2___C__GET_ROWDATALIST_B__10_0_OFFSET UNITYSDK_OFFSET(0x8A8D7E0)

namespace MoleMole
{
	inline static constexpr unsigned int SummerEventResultContextV2___c_TypeDefinitionIndex = 41738;
	...
	public:
		...
		{
			return (::System::Func_2<::System::ValueTuple_2<::System::String*, ::System::String*>, ::MoleMole::UIHollowResultInfoRowNewWidgetController_RowData>**)Il2CppClass::FromTypeDefinitionIndex(SummerEventResultContextV2___c_TypeDefinitionIndex)->GetStaticField(0x2C920);
		}
		static ::MoleMole::SummerEventResultContextV2___c** StaticGet___9()
		{
			return (::MoleMole::SummerEventResultContextV2___c**)Il2CppClass::FromTypeDefinitionIndex(SummerEventResultContextV2___c_TypeDefinitionIndex)->GetStaticField(0x2C928);
		}
