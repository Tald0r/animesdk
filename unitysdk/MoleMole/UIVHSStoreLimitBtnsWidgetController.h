...
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ADDPRICE_OFFSET UNITYSDK_OFFSET(0x7BE0D00)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x7BE0620)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_GETSCORERATIO_OFFSET UNITYSDK_OFFSET(0x7BE0100)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x7BE11E0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_GET__HASDOACTION_OFFSET UNITYSDK_OFFSET(0x7BE12B0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_MINUSPRICE_OFFSET UNITYSDK_OFFSET(0x7BE0EA0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONCONTEXTCHANGE_OFFSET UNITYSDK_OFFSET(0x7BE0690)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7BDFF80)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONHASDOACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x7BE0BB0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7BE0020)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7BDFD00)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONVHSMODULEENERGYCHANGE_OFFSET UNITYSDK_OFFSET(0x7BE1110)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_ONVHSMODULERANDOMPLAYUPDATE_OFFSET UNITYSDK_OFFSET(0x7BE1040)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_REFRESHBUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x7BE0940)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_REFRESHHASDOACTION_OFFSET UNITYSDK_OFFSET(0x7BE0880)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x7BE11F0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_SET__HASDOACTION_OFFSET UNITYSDK_OFFSET(0x7BE0C20)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7BE12C0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7BE12F0)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7BE1360)
#define MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7BE13E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreLimitBtnsWidgetController_TypeDefinitionIndex = 42478;
	...
	public:
		...
		::Class_2_6D99A03C58ED2B6E_3* _activityRandomPlayTemplate; // 0x2B0
		...
		static ::System::Single GetScoreRatio(::System::Collections::Generic::IReadOnlyList_1<::Class_3_B6A6E344CE687278_10*>* optionRecordList, ::System::Int32 activityID)
		{
			return ((::System::Single(*)(::System::Collections::Generic::IReadOnlyList_1<::Class_3_B6A6E344CE687278_10*>*, ::System::Int32))((::PBYTE)hIl2Cpp + MOLEMOLE_UIVHSSTORELIMITBTNSWIDGETCONTROLLER_GETSCORERATIO_OFFSET))(optionRecordList, activityID);
		}
