...
#define MOLEMOLE_INTERKNOTPOSTHEIGHTDIC__CTOR_OFFSET UNITYSDK_OFFSET(0xA5F7B70)

namespace MoleMole
{
	inline static constexpr unsigned int InterknotPostHeightDic_TypeDefinitionIndex = 62503;
