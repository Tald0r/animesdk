...
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_CREATEITEM_OFFSET UNITYSDK_OFFSET(0x8087C00)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_GETADVANCEDOPTIONMATCHCOUNT_OFFSET UNITYSDK_OFFSET(0x8088330)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_GETFILTERITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x80889C0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_GETFILTEROPTIONSTATE_OFFSET UNITYSDK_OFFSET(0x8088610)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_GETOWNFILTERGROUPINDEX_OFFSET UNITYSDK_OFFSET(0x8086330)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x80845A0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x8084590)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_HIDEPOPUP_OFFSET UNITYSDK_OFFSET(0x80879D0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x8084670)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONCANCEL_OFFSET UNITYSDK_OFFSET(0x8088060)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONCLICKPOPUPBTN_OFFSET UNITYSDK_OFFSET(0x8087FB0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONCLICKPOPUP_OFFSET UNITYSDK_OFFSET(0x8087E70)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONCLICKRESET_OFFSET UNITYSDK_OFFSET(0x8087D20)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONCLOSEFILTER_OFFSET UNITYSDK_OFFSET(0x8088F50)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8086E00)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONGROUPITEMCLICK_OFFSET UNITYSDK_OFFSET(0x8088110)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8086EA0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x80870E0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONLANGUAGECHANGE_OFFSET UNITYSDK_OFFSET(0x8084CB0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONOPENFILTER_OFFSET UNITYSDK_OFFSET(0x8088DA0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONSORTINVERSECLICK_OFFSET UNITYSDK_OFFSET(0x8088CA0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONSORTOPTIONSELECTED_OFFSET UNITYSDK_OFFSET(0x8088BA0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8087040)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x80845B0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8084E60)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_REFRESHADVANCEDMATCHITEMSLANGUAGECONTENT_OFFSET UNITYSDK_OFFSET(0x8084D20)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8086660)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_SCROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0x80872E0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_SETFILTERSTATEANDREFRESH_OFFSET UNITYSDK_OFFSET(0x8088420)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER_SHOWPOPUP_OFFSET UNITYSDK_OFFSET(0x8087F30)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8089190)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8089100)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__HIDEPOPUP_B__34_0_OFFSET UNITYSDK_OFFSET(0x8089330)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__INITVIEW_B__26_0_OFFSET UNITYSDK_OFFSET(0x80892F0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__INITVIEW_B__26_1_OFFSET UNITYSDK_OFFSET(0x8089300)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__INITVIEW_B__26_2_OFFSET UNITYSDK_OFFSET(0x8089310)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER__INITVIEW_B__26_3_OFFSET UNITYSDK_OFFSET(0x8089320)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x80893F0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x8089460)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x80894C0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x80894F0)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x8089500)
#define MOLEMOLE_UIGENERALFILTERPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8089510)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralFilterPopWindowController_TypeDefinitionIndex = 76658;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralFilterPopWindowController_TypeDefinitionIndex)->GetStaticField(0x36D10);
		}
		static ::System::String** StaticGet_RESET_TEXT()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralFilterPopWindowController_TypeDefinitionIndex)->GetStaticField(0x36D18);
		}
		static ::System::String** StaticGet_CONFIRM_TEXT()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralFilterPopWindowController_TypeDefinitionIndex)->GetStaticField(0x36D20);
		}
		// static const ::System::String* BtnsPopupAniFadeOut; // 0x0
		::Class_2_79AE422BA06F6D26_227* _view; // 0x2F8
		::Class_0_16E4307DCC419505_407* _filterInstance; // 0x300
		...
		::Class_1_5FF6FCF71CF2DE2C* _sortWidgetData; // 0x320
		::Class_1_8BABEB2BC6365EFE* _sortOptionsDropDown; // 0x328
