...
#define MOLEMOLE_TWEENCUSTOMMOVE_AWAKE_OFFSET UNITYSDK_OFFSET(0x8F4D8F0)
#define MOLEMOLE_TWEENCUSTOMMOVE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x8F4E4C0)
#define MOLEMOLE_TWEENCUSTOMMOVE_METHOD_5_351060D64F7F438E_OFFSET UNITYSDK_OFFSET(0x8F4E920)
#define MOLEMOLE_TWEENCUSTOMMOVE_METHOD_5_3BBB9CF20E8D97ED_OFFSET UNITYSDK_OFFSET(0x8F4E810)
#define MOLEMOLE_TWEENCUSTOMMOVE_METHOD_5_508CA42E6BB02C17_OFFSET UNITYSDK_OFFSET(0x8F4DFC0)
#define MOLEMOLE_TWEENCUSTOMMOVE_METHOD_5_5A1B7BC579919FAB_OFFSET UNITYSDK_OFFSET(0x8F4DD00)
#define MOLEMOLE_TWEENCUSTOMMOVE_METHOD_5_6DC60149A270E0D4_1_OFFSET UNITYSDK_OFFSET(0x8F4E6F0)
#define MOLEMOLE_TWEENCUSTOMMOVE_METHOD_5_6DC60149A270E0D4_OFFSET UNITYSDK_OFFSET(0x8F4E6B0)
#define MOLEMOLE_TWEENCUSTOMMOVE_METHOD_5_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x8F4D960)
#define MOLEMOLE_TWEENCUSTOMMOVE_METHOD_5_E69F3DFB7CDFE412_OFFSET UNITYSDK_OFFSET(0x8F4E5E0)
#define MOLEMOLE_TWEENCUSTOMMOVE_METHOD_5_EBAF10BBA97B82DD_OFFSET UNITYSDK_OFFSET(0x8F4E730)
#define MOLEMOLE_TWEENCUSTOMMOVE_START_OFFSET UNITYSDK_OFFSET(0x8F4DB70)
#define MOLEMOLE_TWEENCUSTOMMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F4E680)

namespace MoleMole
{
	inline static constexpr unsigned int TweenCustomMove_TypeDefinitionIndex = 70240;
