...
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_CALCULATESECTIONUNLOCK_OFFSET UNITYSDK_OFFSET(0x790ABF0)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_FORCECLICKPOPINWORLDSTATE_OFFSET UNITYSDK_OFFSET(0x790B4A0)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GETBANNER_OFFSET UNITYSDK_OFFSET(0x790A3A0)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GETDEBUGINFO_OFFSET UNITYSDK_OFFSET(0x790AB70)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GETICONWIDGETNAME_OFFSET UNITYSDK_OFFSET(0x7905E20)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GETKEY_OFFSET UNITYSDK_OFFSET(0x7905EF0)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GETMAPICON_OFFSET UNITYSDK_OFFSET(0x790A590)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GETPOINTLOCKTYPE_OFFSET UNITYSDK_OFFSET(0x790B500)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GETTITLEICON_OFFSET UNITYSDK_OFFSET(0x7909D30)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GETTITLEKEY_OFFSET UNITYSDK_OFFSET(0x7904C00)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GETTITLETEXT_OFFSET UNITYSDK_OFFSET(0x7906E20)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GETTRACKCIRCLECOLOR_OFFSET UNITYSDK_OFFSET(0x790B070)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x7904440)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GET_GETAREAMAPPANELCONFIGID_INTERNAL_OFFSET UNITYSDK_OFFSET(0x790AB60)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_GET_GETAREAMAPPANELCONFIGID_OFFSET UNITYSDK_OFFSET(0x790AAE0)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_IGNOREHUDHIDE_OFFSET UNITYSDK_OFFSET(0x790B010)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_ISENABLE_OFFSET UNITYSDK_OFFSET(0x7905430)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_ISFINISH_OFFSET UNITYSDK_OFFSET(0x7906090)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_ISINWORLDSTATELOCK_OFFSET UNITYSDK_OFFSET(0x790AFB0)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_ISTRACKING_OFFSET UNITYSDK_OFFSET(0x7904500)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_ISUNLOCK_OFFSET UNITYSDK_OFFSET(0x79070C0)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_ONSHOWPANEL_OFFSET UNITYSDK_OFFSET(0x7904A00)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT_SHOWPANEL_OFFSET UNITYSDK_OFFSET(0x790A730)
#define MOLEMOLE_UIURBANMAPPOINTWIDGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x7904380)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapPointWidgetContext_TypeDefinitionIndex = 56983;

	class UIUrbanMapPointWidgetContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::Type* ViewModelType; // 0x28
		::Class_0_16E4307DCC419505_269* MapElement; // 0x30
		::MoleMole::UIUrbanMapPointGroupWidgetContext* FromGroupContext; // 0x38
		::System::Int32 In3dAreaId; // 0x40
		::System::Int32 _GetAreaMapPanelConfigId_Internal_k__BackingField; // 0x44
		::System::Int32 _infoPanelId; // 0x48
		::System::Boolean SectionUnlock; // 0x4C
