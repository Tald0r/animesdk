...
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xC291270)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC291280)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC291320)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC291AE0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC291620)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xC2919F0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC291B70)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC291B80)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xC291BF0)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC291C60)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC291C70)
#define MOLEMOLE_UIACTIVITYOPERATIONALPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xC291C80)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityOperationalPageController_TypeDefinitionIndex = 64868;

	class UIActivityOperationalPageController : public ::MoleMole::UIMainCityStorePageController
	{
	public:
		::Class_2_C832474F3EB70101_1* _view; // 0x308
