...
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_BINDDEFAULTOKBTN_OFFSET UNITYSDK_OFFSET(0x91477F0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_GET_HOTSWITCHROOTLAYERSTATE_OFFSET UNITYSDK_OFFSET(0x9146A80)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9146A70)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_INITHOLLOWITEM_OFFSET UNITYSDK_OFFSET(0x9146F90)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_INITSWITCHHOLLOWITEM_OFFSET UNITYSDK_OFFSET(0x9147960)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x9146DB0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9146BB0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9146D00)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9146C50)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9146A90)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9146B00)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_SETCLOSETRIGGEROKCLICK_OFFSET UNITYSDK_OFFSET(0x91480D0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER_SETOKCALLBACK_OFFSET UNITYSDK_OFFSET(0x9148140)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER__BINDDEFAULTOKBTN_B__15_0_OFFSET UNITYSDK_OFFSET(0x91481C0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER__BINDDEFAULTOKBTN_B__15_1_OFFSET UNITYSDK_OFFSET(0x9148240)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x91481B0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_MASKCLOSE_OFFSET UNITYSDK_OFFSET(0x9148470)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x91484E0)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0x9148550)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9148580)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9148590)
#define MOLEMOLE_UIHOLLOWTIPSDIALOGPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x91485A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowTipsDialogPopWindowController_TypeDefinitionIndex = 78593;

	class UIHollowTipsDialogPopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_185* _view; // 0x2F8
