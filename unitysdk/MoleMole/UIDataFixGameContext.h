...
#define MOLEMOLE_UIDATAFIXGAMECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA2712D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDataFixGameContext_TypeDefinitionIndex = 66593;
