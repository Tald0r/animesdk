...
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER_CHANGEEXPAND_OFFSET UNITYSDK_OFFSET(0xCFD8830)
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER_GET_MODEL_OFFSET UNITYSDK_OFFSET(0xCFD8770)
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER_ONBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xCFD83A0)
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFD8960)
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCFD8AE0)
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFD8A00)
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFD81C0)
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER_SETEXPAND_OFFSET UNITYSDK_OFFSET(0xCFD88F0)
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFD8CC0)
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFD8CD0)
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xCFD8D40)
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFD8DC0)
#define MOLEMOLE_UIRIDUSGOTBOOBUFFROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFD8E40)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooBuffRowWidgetController_TypeDefinitionIndex = 38342;
	...
	public:
		...
		::Class_2_208CC9941471731A_795* m_levelBuffCfg; // 0x2F0
