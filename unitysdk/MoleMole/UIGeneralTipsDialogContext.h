...
#define MOLEMOLE_UIGENERALTIPSDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8C48CF0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTipsDialogContext_TypeDefinitionIndex = 69739;

	class UIGeneralTipsDialogContext : public ::MoleMole::UIControllerContextBase
	{
	public:
		::System::String* replaceClickBtnText; // 0x28
		...
		::System::Collections::Generic::List_1<::System::Int32>* idList; // 0x58
