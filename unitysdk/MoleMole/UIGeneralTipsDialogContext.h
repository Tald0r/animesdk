...
#define MOLEMOLE_UIGENERALTIPSDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xB0FA140)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralTipsDialogContext_TypeDefinitionIndex = 73743;
