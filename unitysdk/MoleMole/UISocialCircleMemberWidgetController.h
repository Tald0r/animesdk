...
#define MOLEMOLE_UISOCIALCIRCLEMEMBERWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAAD9820)
#define MOLEMOLE_UISOCIALCIRCLEMEMBERWIDGETCONTROLLER_MANUALUPDATESOCIALCIRCLEMEMBERLISTHANDLE_OFFSET UNITYSDK_OFFSET(0xAAD9B70)
#define MOLEMOLE_UISOCIALCIRCLEMEMBERWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAAD9890)
#define MOLEMOLE_UISOCIALCIRCLEMEMBERWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAAD9C40)
#define MOLEMOLE_UISOCIALCIRCLEMEMBERWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAAD9990)
#define MOLEMOLE_UISOCIALCIRCLEMEMBERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAAD9CF0)
#define MOLEMOLE_UISOCIALCIRCLEMEMBERWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAAD9D20)
#define MOLEMOLE_UISOCIALCIRCLEMEMBERWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xAAD9D90)
#define MOLEMOLE_UISOCIALCIRCLEMEMBERWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAAD9DF0)

namespace MoleMole
{
	inline static constexpr unsigned int UISocialCircleMemberWidgetController_TypeDefinitionIndex = 60373;
