...
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDDC49A0)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYPOPWINDOWCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDDC49B0)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYPOPWINDOWCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDDC4A20)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDDC4B20)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDDC4D60)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYPOPWINDOWCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xDDC4D70)
#define MOLEMOLE_UIBOSSCHALLENGEHISTORYPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDDC4DE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBossChallengeHistoryPopWindowController_TypeDefinitionIndex = 41345;
