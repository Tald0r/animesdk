...
class Class_2_3F751654DB473886_6;
...
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ADJUSTPOS_OFFSET UNITYSDK_OFFSET(0x9C0AFE0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_BLINK_OFFSET UNITYSDK_OFFSET(0x9C0B3C0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_CENTER_OFFSET UNITYSDK_OFFSET(0x9C0ADA0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x9C0A780)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_FRONTRECTPOINTSWORLD_OFFSET UNITYSDK_OFFSET(0x9C0BD90)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_FRONTRECT_OFFSET UNITYSDK_OFFSET(0x9C0BC30)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_FULLINDEX_OFFSET UNITYSDK_OFFSET(0x9C0A870)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x9C0A860)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0x9C0AC10)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9C0A880)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9C0AA90)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9C0AB00)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9C0A920)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9C0AA20)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_PERFORM_OFFSET UNITYSDK_OFFSET(0x9C0B740)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_SETBRIGHTNESS_OFFSET UNITYSDK_OFFSET(0x9C0B160)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_SETSATURATION_OFFSET UNITYSDK_OFFSET(0x9C0B290)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9C0AB80)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9C0C060)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9C0BFF0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9C0C120)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9C0C190)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9C0C1A0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9C0C1B0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9C0C1C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessPieceResult3DModelController_TypeDefinitionIndex = 60771;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA6A0);
		}
		static ::System::Int32* StaticGet_MatScreenHueID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA6A4);
		}
		static ::System::Int32* StaticGet_MatOverallOpacity()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA6A8);
		}
		static ::System::Int32* StaticGet_MatScreenBrightID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA6AC);
		}
		static ::System::Int32* StaticGet_MatUVAnimationForSequenceToggleId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA6B0);
		}
		static ::System::Int32* StaticGet_MatCustomScreenMapSeq_STId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA6B4);
		}
		static ::System::Int32* StaticGet_MatScreenColorID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA6B8);
		}
		::Class_2_3F751654DB473886_6* _view; // 0x340
