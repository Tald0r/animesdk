...
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ADJUSTPOS_OFFSET UNITYSDK_OFFSET(0xBFCF4D0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_BLINK_OFFSET UNITYSDK_OFFSET(0xBFCF8B0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_CENTER_OFFSET UNITYSDK_OFFSET(0xBFCF290)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0xBFCEC70)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_FRONTRECTPOINTSWORLD_OFFSET UNITYSDK_OFFSET(0xBFD0280)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_FRONTRECT_OFFSET UNITYSDK_OFFSET(0xBFD0120)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_FULLINDEX_OFFSET UNITYSDK_OFFSET(0xBFCED60)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_GET_INDEX_OFFSET UNITYSDK_OFFSET(0xBFCED50)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_INIT_OFFSET UNITYSDK_OFFSET(0xBFCF100)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFCED70)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBFCEF80)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFCEFF0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFCEE10)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFCEF10)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_PERFORM_OFFSET UNITYSDK_OFFSET(0xBFCFC30)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_SETBRIGHTNESS_OFFSET UNITYSDK_OFFSET(0xBFCF650)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_SETSATURATION_OFFSET UNITYSDK_OFFSET(0xBFCF780)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xBFCF070)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBFD0550)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFD04E0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFD0610)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBFD0680)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFD0690)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFD06A0)
#define MOLEMOLE_UIHOLLOWCHESSPIECERESULT3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFD06B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessPieceResult3DModelController_TypeDefinitionIndex = 59517;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA220);
		}
		static ::System::Int32* StaticGet_MatScreenColorID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA224);
		}
		static ::System::Int32* StaticGet_MatSccSaturationID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA228);
		}
		static ::System::Int32* StaticGet_MatScreenBrightID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA22C);
		}
		static ::System::Int32* StaticGet_MatScreenHueID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA230);
		}
		static ::System::Int32* StaticGet_MatOverallOpacity()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA234);
		}
		static ::System::Int32* StaticGet_MatUVAnimationForSequenceToggleId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIHollowChessPieceResult3DModelController_TypeDefinitionIndex)->GetStaticField(0xA238);
		}
		::Class_2_3F751654DB473886_5* _view; // 0x340
		::Class_1_927FD65E44A20102* _textureSheetAnimation; // 0x348
		::System::Int16 _index; // 0x350
		::System::Int16 _fullIndex; // 0x352
		::UnityEngine::MeshRenderer* _meshRenderer; // 0x358
