...
#define MOLEMOLE_NAPINPUT_ATTITUDE_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x6B17800)
#define MOLEMOLE_NAPINPUT_ATTITUDE_METHOD_2_2E2C21D9BC20BA87_1_OFFSET UNITYSDK_OFFSET(0x6B17E40)
#define MOLEMOLE_NAPINPUT_ATTITUDE_METHOD_2_2E2C21D9BC20BA87_OFFSET UNITYSDK_OFFSET(0x6B17950)
#define MOLEMOLE_NAPINPUT_ATTITUDE_METHOD_2_9A938B5464DE9795_1_OFFSET UNITYSDK_OFFSET(0x6B17D90)
#define MOLEMOLE_NAPINPUT_ATTITUDE_METHOD_2_9A938B5464DE9795_OFFSET UNITYSDK_OFFSET(0x6B178A0)

namespace MoleMole::NAPInput
{
	inline static constexpr unsigned int Attitude_TypeDefinitionIndex = 43441;
