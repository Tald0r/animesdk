...
#define MOLEMOLE_NAPINPUT_ATTITUDE_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0xD4406C0)
#define MOLEMOLE_NAPINPUT_ATTITUDE_METHOD_2_2E2C21D9BC20BA87_1_OFFSET UNITYSDK_OFFSET(0xD440810)
#define MOLEMOLE_NAPINPUT_ATTITUDE_METHOD_2_2E2C21D9BC20BA87_OFFSET UNITYSDK_OFFSET(0xD440D60)
#define MOLEMOLE_NAPINPUT_ATTITUDE_METHOD_2_9A938B5464DE9795_1_OFFSET UNITYSDK_OFFSET(0xD4411A0)
#define MOLEMOLE_NAPINPUT_ATTITUDE_METHOD_2_9A938B5464DE9795_OFFSET UNITYSDK_OFFSET(0xD440760)

namespace MoleMole::NAPInput
{
	inline static constexpr unsigned int Attitude_TypeDefinitionIndex = 78292;
