...
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0x990B510)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS39_0__STARTPERFORMANCE_B__0_OFFSET UNITYSDK_OFFSET(0x990B520)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS39_0__STARTPERFORMANCE_B__1_OFFSET UNITYSDK_OFFSET(0x990B900)
#define MOLEMOLE_UITAPESGROUP3DMODELCONTROLLER___C__DISPLAYCLASS39_0__STARTPERFORMANCE_B__5_OFFSET UNITYSDK_OFFSET(0x990B9F0)

namespace MoleMole
{
	inline static constexpr unsigned int UITapesGroup3DModelController___c__DisplayClass39_0_TypeDefinitionIndex = 53115;
	...
	public:
		...
		::MoleMole::UITapesGroup3DModelController_ArchiveTapes* archiveTapes; // 0x28
