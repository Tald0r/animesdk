...
#define MOLEMOLE_GLOBALDISPATCHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC224440)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalDispatchData_TypeDefinitionIndex = 45075;
