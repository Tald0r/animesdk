...
#define MOLEMOLE_GLOBALDISPATCHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB83ABD0)

namespace MoleMole
{
	inline static constexpr unsigned int GlobalDispatchData_TypeDefinitionIndex = 56024;
