...
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_GAMEFINISH_OFFSET UNITYSDK_OFFSET(0xDDBA6F0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_GETBUBBLEWIDGET_OFFSET UNITYSDK_OFFSET(0xDDB8D40)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xDDB8000)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xDDBA2F0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDDB9010)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xDDB9B20)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xDDB9D90)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDDB9FE0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDDB9490)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONTIMEOUT_OFFSET UNITYSDK_OFFSET(0xDDBA560)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xDDB90B0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDDB92E0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDDB8010)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDDB87A0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_OPENBUBBLEROW_OFFSET UNITYSDK_OFFSET(0xDDB8EA0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_OPENTIMECOUNTDOWNUI_OFFSET UNITYSDK_OFFSET(0xDDB9740)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_RECORDGAMETIME_OFFSET UNITYSDK_OFFSET(0xDDBA940)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDDBAAA0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER__GAMEFINISH_B__31_0_OFFSET UNITYSDK_OFFSET(0xDDBAB00)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER__GAMEFINISH_B__31_1_OFFSET UNITYSDK_OFFSET(0xDDBAB80)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDDBAC90)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xDDBAD00)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xDDBAD10)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xDDBAD70)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDDBADA0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xDDBADB0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDDBADC0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDDBADD0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDDBADE0)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooCountGamePopWindowController_TypeDefinitionIndex = 45528;
	...
	public:
		...
		::Enum_3_0F5D0B7399907DA1 _result; // 0x328
