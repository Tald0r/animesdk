...
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_GAMEFINISH_OFFSET UNITYSDK_OFFSET(0xD0277A0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_GETBUBBLEWIDGET_OFFSET UNITYSDK_OFFSET(0xD025E00)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xD025110)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD0273A0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD0260D0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xD026BD0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xD026E40)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD027090)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD026540)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONTIMEOUT_OFFSET UNITYSDK_OFFSET(0xD027610)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD026170)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD0263A0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD025120)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD025860)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_OPENBUBBLEROW_OFFSET UNITYSDK_OFFSET(0xD025F60)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_OPENTIMECOUNTDOWNUI_OFFSET UNITYSDK_OFFSET(0xD0267F0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER_RECORDGAMETIME_OFFSET UNITYSDK_OFFSET(0xD0279F0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD027B50)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER__GAMEFINISH_B__31_0_OFFSET UNITYSDK_OFFSET(0xD027BB0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER__GAMEFINISH_B__31_1_OFFSET UNITYSDK_OFFSET(0xD027C30)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD027D40)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONFADEPLAYFINISH_OFFSET UNITYSDK_OFFSET(0xD027DB0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xD027DC0)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xD027E20)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD027E50)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xD027E60)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD027E70)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD027E80)
#define MOLEMOLE_UIBANGBOOCOUNTGAMEPOPWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD027E90)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangbooCountGamePopWindowController_TypeDefinitionIndex = 72483;

	class UIBangbooCountGamePopWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_79F6D62CE30E3F8E_174* _view; // 0x2F8
		::MoleMole::UIBangbooCountGameContext* _context; // 0x300
		::MoleMole::UIPhotoModePlayerMoveChildWindowController* _joystickCtrl; // 0x308
		::Class_2_096CDC88DB8402A1* _cameraControl; // 0x310
		::MoleMole::UIInLevelCountDownUIChildWindowController* _countDownController; // 0x318
		::System::String* _lastBGMSpecialState; // 0x320
		::Enum_3_0F5D0B7399907DA1_2 _result; // 0x328
		::MoleMole::UIMissionTipsRowWidgetController* _questTipsRowWidget; // 0x330
		::System::Int32 _mainCityGameUIConfigGameID; // 0x338
		::System::Single _gameStartTime; // 0x33C
		::MoleMole::UIGeneralKeyPanelWidgetController* _keyPanelWidgetCtrl_Up; // 0x340
		::MoleMole::UIGeneralKeyPanelWidgetController* _keyPanelWidgetCtrl_Down; // 0x348
		::MoleMole::UIGeneralKeyPanelWidgetController* _keyPanelWidgetCtrl_Left; // 0x350
		::MoleMole::UIGeneralKeyPanelWidgetController* _keyPanelWidgetCtrl_Right; // 0x358
		::MoleMole::UIGeneralNewsBubbleWidgetController* _widgetCtrl; // 0x360
