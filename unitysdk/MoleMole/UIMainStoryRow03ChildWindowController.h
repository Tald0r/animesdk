...
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_1_OFFSET UNITYSDK_OFFSET(0xA4130F0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0xA412F00)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_DOALPHAOFFSET_OFFSET UNITYSDK_OFFSET(0xA415160)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GETBATTLETEMPLATEID_OFFSET UNITYSDK_OFFSET(0xA412D70)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GETPERFORMSBEFORESUBID_OFFSET UNITYSDK_OFFSET(0xA413850)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GETSUBGOBYSUBID_OFFSET UNITYSDK_OFFSET(0xA414120)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_HASSUBITEM_OFFSET UNITYSDK_OFFSET(0xA415990)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_SELFSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xA4159A0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_TEMPLATEID_OFFSET UNITYSDK_OFFSET(0xA414110)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_TEMPLATE_OFFSET UNITYSDK_OFFSET(0xA415C40)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA411DA0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_INVOKE_OFFSET UNITYSDK_OFFSET(0xA412CA0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_OK_OFFSET UNITYSDK_OFFSET(0xA414340)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONBTNCLICK_OFFSET UNITYSDK_OFFSET(0xA412790)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA411DB0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONQUESTUPDATE_OFFSET UNITYSDK_OFFSET(0xA4159C0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0xA413A70)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA412410)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA412490)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA411E50)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA412360)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUNSELECT_OFFSET UNITYSDK_OFFSET(0xA413BB0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHCOMPLETEVIEW_OFFSET UNITYSDK_OFFSET(0xA413C90)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHINFOVIEW_OFFSET UNITYSDK_OFFSET(0xA413D20)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHSCROLLVIEWCONTENTACTIVE_OFFSET UNITYSDK_OFFSET(0xA414670)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xA414970)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_RESETCOLOR_OFFSET UNITYSDK_OFFSET(0xA414710)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_RESETHISTORY_OFFSET UNITYSDK_OFFSET(0xA413750)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SELECT_OFFSET UNITYSDK_OFFSET(0xA415230)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETALPHAOFFSET_OFFSET UNITYSDK_OFFSET(0xA415080)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETROOTSELECTED_OFFSET UNITYSDK_OFFSET(0xA414EB0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETSTAR_OFFSET UNITYSDK_OFFSET(0xA413EF0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETSUBITEM_OFFSET UNITYSDK_OFFSET(0xA412990)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SET_TEMPLATE_OFFSET UNITYSDK_OFFSET(0xA415C50)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0xA414FC0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_TRIGGERBTNCLICK_OFFSET UNITYSDK_OFFSET(0xA4125C0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__CREATESUBWIDGET_B__9_0_OFFSET UNITYSDK_OFFSET(0xA415D40)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__CREATESUBWIDGET_G__SETSELECTED_9_1_OFFSET UNITYSDK_OFFSET(0xA415EA0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA415C60)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__SETSUBITEM_B__23_0_OFFSET UNITYSDK_OFFSET(0xA415F30)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA415F60)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA415FD0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA415FE0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA415FF0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA416000)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryRow03ChildWindowController_TypeDefinitionIndex = 48326;

	class UIMainStoryRow03ChildWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::MonoUITableScrollV2* parentScrollView; // 0x2F8
		::Class_2_28BDF4B69EE93815_1* _view; // 0x300
		::System::Int32 _templateID; // 0x308
		::System::Boolean _selected; // 0x30C
		::System::Action_1<::System::Int32>* _clickFunc; // 0x310
		::System::Action* _callback; // 0x318
		::Class_2_208CC9941471731A_552* _template_k__BackingField; // 0x320
		::MoleMole::UIMainStoryRow03ChildWindowController_SelectImage* lastSelectItem; // 0x328
		::System::Int32 _curSubID; // 0x330
		::UIMainStoryParam* param; // 0x338
		::System::Boolean _hasSubItem; // 0x340
		::UnityEngine::Material* _selectMaterial; // 0x348
		::System::Collections::Generic::List_1<::MoleMole::UIMainStorySubitemRowChildWindowControllerV2*>* _subitems; // 0x350
		::System::Collections::Generic::List_1<::MoleMole::UIMainStorySubitemRowChildWindowControllerV2*>* selectHistory; // 0x358
		...
		::System::Void CreateSubWidget(::Class_2_208CC9941471731A_552* template_)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_552*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_OFFSET))(this, template_);
		}

		::System::Void CreateSubWidget_1(::Class_2_208CC9941471731A_552* template_, ::System::Action_2<::System::Int32, ::MoleMole::UIMainStorySubitemRowChildWindowControllerV2*>* subBtnCallback)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_552*, ::System::Action_2<::System::Int32, ::MoleMole::UIMainStorySubitemRowChildWindowControllerV2*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_1_OFFSET))(this, template_, subBtnCallback);
		}
		...
		::Class_2_208CC9941471731A_552* get_template()
		{
			return ((::Class_2_208CC9941471731A_552*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_TEMPLATE_OFFSET))(this);
		}

		::System::Void set_template(::Class_2_208CC9941471731A_552* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_552*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SET_TEMPLATE_OFFSET))(this, value);
		}
