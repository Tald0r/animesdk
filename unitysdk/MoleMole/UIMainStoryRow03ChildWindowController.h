...
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_1_OFFSET UNITYSDK_OFFSET(0x944B2B0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_OFFSET UNITYSDK_OFFSET(0x944B0C0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_DOALPHAOFFSET_OFFSET UNITYSDK_OFFSET(0x944D330)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GETBATTLETEMPLATEID_OFFSET UNITYSDK_OFFSET(0x944AF30)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GETPERFORMSBEFORESUBID_OFFSET UNITYSDK_OFFSET(0x944BA10)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GETSUBGOBYSUBID_OFFSET UNITYSDK_OFFSET(0x944C2E0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_HASSUBITEM_OFFSET UNITYSDK_OFFSET(0x944DB80)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_SELFSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x944DB90)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_TEMPLATEID_OFFSET UNITYSDK_OFFSET(0x944C2D0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_TEMPLATE_OFFSET UNITYSDK_OFFSET(0x944DE40)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9449F40)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x944AE60)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_OK_OFFSET UNITYSDK_OFFSET(0x944C500)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONBTNCLICK_OFFSET UNITYSDK_OFFSET(0x944A940)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9449F50)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONQUESTUPDATE_OFFSET UNITYSDK_OFFSET(0x944DBC0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONSELECT_OFFSET UNITYSDK_OFFSET(0x944BC30)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x944A5C0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x944A640)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9449FF0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x944A510)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_ONUNSELECT_OFFSET UNITYSDK_OFFSET(0x944BD70)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHCOMPLETEVIEW_OFFSET UNITYSDK_OFFSET(0x944BE50)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHINFOVIEW_OFFSET UNITYSDK_OFFSET(0x944BEE0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHSCROLLVIEWCONTENTACTIVE_OFFSET UNITYSDK_OFFSET(0x944C830)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x944CB40)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_RESETCOLOR_OFFSET UNITYSDK_OFFSET(0x944C8D0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_RESETHISTORY_OFFSET UNITYSDK_OFFSET(0x944B910)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SELECT_OFFSET UNITYSDK_OFFSET(0x944D410)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETALPHAOFFSET_OFFSET UNITYSDK_OFFSET(0x944D250)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETROOTSELECTED_OFFSET UNITYSDK_OFFSET(0x944D080)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETSTAR_OFFSET UNITYSDK_OFFSET(0x944C0B0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SETSUBITEM_OFFSET UNITYSDK_OFFSET(0x944AB40)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SET_TEMPLATE_OFFSET UNITYSDK_OFFSET(0x944DE50)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0x944D190)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_TRIGGERBTNCLICK_OFFSET UNITYSDK_OFFSET(0x944A770)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__CREATESUBWIDGET_B__9_0_OFFSET UNITYSDK_OFFSET(0x944DF50)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__CREATESUBWIDGET_G__SETSELECTED_9_1_OFFSET UNITYSDK_OFFSET(0x944E0B0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x944DE60)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER__SETSUBITEM_B__23_0_OFFSET UNITYSDK_OFFSET(0x944E140)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x944E180)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x944E1F0)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x944E200)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x944E210)
#define MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x944E220)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainStoryRow03ChildWindowController_TypeDefinitionIndex = 77809;

	class UIMainStoryRow03ChildWindowController : public ::MoleMole::UIWindowController
	{
	public:
		::MonoUITableScrollV2* parentScrollView; // 0x2F8
		::Class_2_28BDF4B69EE93815_2* _view; // 0x300
		...
		::Class_2_208CC9941471731A_569* _template_k__BackingField; // 0x320
		...
		::System::Void CreateSubWidget(::Class_2_208CC9941471731A_569* template_)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_569*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_OFFSET))(this, template_);
		}

		::System::Void CreateSubWidget_1(::Class_2_208CC9941471731A_569* template_, ::System::Action_2<::System::Int32, ::MoleMole::UIMainStorySubitemRowChildWindowControllerV2*>* subBtnCallback)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_569*, ::System::Action_2<::System::Int32, ::MoleMole::UIMainStorySubitemRowChildWindowControllerV2*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_CREATESUBWIDGET_1_OFFSET))(this, template_, subBtnCallback);
		}
		...
		::Class_2_208CC9941471731A_569* get_template()
		{
			return ((::Class_2_208CC9941471731A_569*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_GET_TEMPLATE_OFFSET))(this);
		}

		::System::Void set_template(::Class_2_208CC9941471731A_569* value)
		{
			return ((::System::Void(*)(::PVOID, ::Class_2_208CC9941471731A_569*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMAINSTORYROW03CHILDWINDOWCONTROLLER_SET_TEMPLATE_OFFSET))(this, value);
		}
