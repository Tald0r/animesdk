...
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___C__DISPLAYCLASS48_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD76DA70)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___C__DISPLAYCLASS48_0__INITVIDEOPLAYER_B__0_OFFSET UNITYSDK_OFFSET(0xD76DA80)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___C__DISPLAYCLASS48_0__INITVIDEOPLAYER_G__INVOKEPREPARED_1_OFFSET UNITYSDK_OFFSET(0xD76DD20)

namespace MoleMole
{
	inline static constexpr unsigned int UILoadingTransferPopWindowController___c__DisplayClass48_0_TypeDefinitionIndex = 41104;
