...
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___C__DISPLAYCLASS48_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC1255C0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___C__DISPLAYCLASS48_0__INITVIDEOPLAYER_B__0_OFFSET UNITYSDK_OFFSET(0xC1255D0)
#define MOLEMOLE_UILOADINGTRANSFERPOPWINDOWCONTROLLER___C__DISPLAYCLASS48_0__INITVIDEOPLAYER_G__INVOKEPREPARED_1_OFFSET UNITYSDK_OFFSET(0xC125870)

namespace MoleMole
{
	inline static constexpr unsigned int UILoadingTransferPopWindowController___c__DisplayClass48_0_TypeDefinitionIndex = 66950;
	...
	public:
		...
		::System::String* fakeLoadingVideoPath; // 0x20
		::System::Action_1<::MoleMole::MultipleVideoPlayerManager*>* onEnd; // 0x28
