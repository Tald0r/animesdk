...
#define MOLEMOLE_COMICIMGUITRANSFORMDATA_GET_SHOULDSETCONTAINERSIZE_OFFSET UNITYSDK_OFFSET(0x1AC90990)
#define MOLEMOLE_COMICIMGUITRANSFORMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC909D0)

namespace MoleMole
{
	inline static constexpr unsigned int ComicImgUITransformData_TypeDefinitionIndex = 29109;

	class ComicImgUITransformData : public ::System::Object
	{
	public:
		::UnityEngine::Vector2 imgAnchorPosition; // 0x10
