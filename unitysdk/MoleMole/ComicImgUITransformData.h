...
#define MOLEMOLE_COMICIMGUITRANSFORMDATA_GET_SHOULDSETCONTAINERSIZE_OFFSET UNITYSDK_OFFSET(0x1B2AC4C0)
#define MOLEMOLE_COMICIMGUITRANSFORMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2AC500)

namespace MoleMole
{
	inline static constexpr unsigned int ComicImgUITransformData_TypeDefinitionIndex = 30062;

	class ComicImgUITransformData : public ::System::Object
	{
	public:
		::UnityEngine::Vector2 anchorPosition; // 0x10
		::UnityEngine::Vector2 imgSizeDelta; // 0x18
		::UnityEngine::Vector2 anchorMin; // 0x20
		::UnityEngine::Vector2 anchorSize; // 0x28
		::UnityEngine::Vector2 anchorMax; // 0x30
		::UnityEngine::Vector2 pivot; // 0x38
