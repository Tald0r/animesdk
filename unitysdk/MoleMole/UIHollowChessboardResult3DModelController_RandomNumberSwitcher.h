...
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER_GENERATEDIFFERENTRANDOM_OFFSET UNITYSDK_OFFSET(0x892CC10)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER_GETRANDOMHUEANDSATURATIONGROUP_OFFSET UNITYSDK_OFFSET(0x892CE70)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER_SWITCHRANDOMNUMBER_OFFSET UNITYSDK_OFFSET(0x892CCB0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x892CF70)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboardResult3DModelController_RandomNumberSwitcher_TypeDefinitionIndex = 60478;
