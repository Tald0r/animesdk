...
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER_GENERATEDIFFERENTRANDOM_OFFSET UNITYSDK_OFFSET(0x8A2D640)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER_GETRANDOMHUEANDSATURATIONGROUP_OFFSET UNITYSDK_OFFSET(0x8A2D8A0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER_SWITCHRANDOMNUMBER_OFFSET UNITYSDK_OFFSET(0x8A2D6E0)
#define MOLEMOLE_UIHOLLOWCHESSBOARDRESULT3DMODELCONTROLLER_RANDOMNUMBERSWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x8A2D9A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowChessboardResult3DModelController_RandomNumberSwitcher_TypeDefinitionIndex = 42508;
