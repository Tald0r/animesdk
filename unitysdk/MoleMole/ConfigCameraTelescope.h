...
#define MOLEMOLE_CONFIGCAMERATELESCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0xB4800F0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigCameraTelescope_TypeDefinitionIndex = 65040;
