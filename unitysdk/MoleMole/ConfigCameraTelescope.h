...
#define MOLEMOLE_CONFIGCAMERATELESCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0xE82B990)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigCameraTelescope_TypeDefinitionIndex = 42853;
