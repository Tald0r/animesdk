...
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS348_0__CTOR_OFFSET UNITYSDK_OFFSET(0xAC43A20)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS348_0__SETUPBUBBLEAUDIOS_B__0_OFFSET UNITYSDK_OFFSET(0xAC43A30)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS348_0__SETUPBUBBLEAUDIOS_B__1_OFFSET UNITYSDK_OFFSET(0xAC43A60)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController___c__DisplayClass348_0_TypeDefinitionIndex = 62532;
