...
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS348_0__CTOR_OFFSET UNITYSDK_OFFSET(0x80685E0)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS348_0__SETUPBUBBLEAUDIOS_B__0_OFFSET UNITYSDK_OFFSET(0x80685F0)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS348_0__SETUPBUBBLEAUDIOS_B__1_OFFSET UNITYSDK_OFFSET(0x8068620)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController___c__DisplayClass348_0_TypeDefinitionIndex = 45643;
