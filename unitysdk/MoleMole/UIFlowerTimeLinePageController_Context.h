...
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_GET_FLOWERSHOP3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x8C34470)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_GET_FLOWERSTATES_OFFSET UNITYSDK_OFFSET(0x8C34490)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_GET_FLOWERTIMLINEINFORMDATA_OFFSET UNITYSDK_OFFSET(0x8C344B0)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_GET_HIDETAG_OFFSET UNITYSDK_OFFSET(0x8C344F0)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_GET_PARTNERID_OFFSET UNITYSDK_OFFSET(0x8C344D0)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_SET_FLOWERSHOP3DMODELCONTROLLER_OFFSET UNITYSDK_OFFSET(0x8C34480)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_SET_FLOWERSTATES_OFFSET UNITYSDK_OFFSET(0x8C344A0)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_SET_FLOWERTIMLINEINFORMDATA_OFFSET UNITYSDK_OFFSET(0x8C344C0)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_SET_HIDETAG_OFFSET UNITYSDK_OFFSET(0x8C34500)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT_SET_PARTNERID_OFFSET UNITYSDK_OFFSET(0x8C344E0)
#define MOLEMOLE_UIFLOWERTIMELINEPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8C34510)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerTimeLinePageController_Context_TypeDefinitionIndex = 70376;
	...
	public:
		...
		::System::Collections::Generic::IReadOnlyDictionary_2<::MoleMole::UI::FlowerShop::ESlotType, ::Class_2_D6FEE2A35B0F262A*>* _FlowerStates_k__BackingField; // 0x38
