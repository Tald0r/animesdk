...
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0xA479E90)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xA47A010)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0xA479DD0)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_SETSIZERATIOBYPROCESSOR_OFFSET UNITYSDK_OFFSET(0xA47A150)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_SETSIZERATIOBYSIZEDELTA_OFFSET UNITYSDK_OFFSET(0xA47A080)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xA47A240)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIExpandAndShrinkSelfConfig_TypeDefinitionIndex = 68722;
