...
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_AWAKE_OFFSET UNITYSDK_OFFSET(0x67C5BE0)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x67C5D60)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x67C5B20)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_SETSIZERATIOBYPROCESSOR_OFFSET UNITYSDK_OFFSET(0x67C5EA0)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG_SETSIZERATIOBYSIZEDELTA_OFFSET UNITYSDK_OFFSET(0x67C5DD0)
#define MOLEMOLE_MONOUIEXPANDANDSHRINKSELFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x67C5F90)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIExpandAndShrinkSelfConfig_TypeDefinitionIndex = 76670;
