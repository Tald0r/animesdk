...
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_CLICKITEMBUTTON_OFFSET UNITYSDK_OFFSET(0xC63AD10)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC639FB0)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONFLOWERSHOPTASKCHANGEEVENT_OFFSET UNITYSDK_OFFSET(0xC63ADE0)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xC63AC50)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC63A1F0)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC63A110)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC639C50)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC639F00)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER_REFRESHPANEL_OFFSET UNITYSDK_OFFSET(0xC63A380)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC63AE90)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xC63AEA0)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0xC63AF10)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xC63AF80)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xC63B000)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xC63B080)
#define MOLEMOLE_UIFLOWERSHOPTASKITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xC63B0E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerShopTaskItemWidgetController_TypeDefinitionIndex = 73046;
	...
	public:
		...
		::Class_2_208CC9941471731A_157* _data; // 0x2E0
