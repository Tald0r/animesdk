...
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AAD1E40)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_CALFRAMESCORE_OFFSET UNITYSDK_OFFSET(0x1AAD22A0)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_GET_PLAYING_OFFSET UNITYSDK_OFFSET(0x1AAD7680)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_INITLOADER_OFFSET UNITYSDK_OFFSET(0x1AAD1DF0)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_182EEF545C2FF83D_1_OFFSET UNITYSDK_OFFSET(0x1AAD7990)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_182EEF545C2FF83D_OFFSET UNITYSDK_OFFSET(0x1AAD77B0)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_1C4DCEC4A71E9244_OFFSET UNITYSDK_OFFSET(0x1AAD4D10)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_209DFC4EDEC189F6_OFFSET UNITYSDK_OFFSET(0x1AAD5330)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_5142135976679E32_OFFSET UNITYSDK_OFFSET(0x1AAD6A90)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_5587AE4B03E68C58_OFFSET UNITYSDK_OFFSET(0x1AAD3D30)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_5629BB85B25B861B_OFFSET UNITYSDK_OFFSET(0x1AAD7410)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_6BAAF7650CBC8983_OFFSET UNITYSDK_OFFSET(0x1AAD4710)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_8594010D6A57C9BB_OFFSET UNITYSDK_OFFSET(0x1AAD2B40)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_919B1950A07CB5AC_1_OFFSET UNITYSDK_OFFSET(0x1AAD78F0)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_919B1950A07CB5AC_OFFSET UNITYSDK_OFFSET(0x1AAD7850)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_9A433A8074D7736F_OFFSET UNITYSDK_OFFSET(0x1AAD4460)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_A73E7185E7C1427E_1_OFFSET UNITYSDK_OFFSET(0x1AAD72F0)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_A73E7185E7C1427E_OFFSET UNITYSDK_OFFSET(0x1AAD7380)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_D04E6CFC2E9B8E1A_OFFSET UNITYSDK_OFFSET(0x1AAD69D0)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0x1AAD4DF0)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_D76963A554A1D89D_OFFSET UNITYSDK_OFFSET(0x1AAD4E60)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_D93254806D9899AB_OFFSET UNITYSDK_OFFSET(0x1AAD7A30)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_F867677DC9D486C7_OFFSET UNITYSDK_OFFSET(0x1AAD5510)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AAD1F10)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_PLAY_OFFSET UNITYSDK_OFFSET(0x1AAD6220)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_STOPANIM_OFFSET UNITYSDK_OFFSET(0x1AAD4660)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_SWITCHUSERSNAMEUIBYPLATFORM_OFFSET UNITYSDK_OFFSET(0x1AAD74B0)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_UPDATEBLOCKBORDER_OFFSET UNITYSDK_OFFSET(0x1AAD3E70)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_UPDATESCALE_OFFSET UNITYSDK_OFFSET(0x1AAD2BA0)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_UPDATEVALUE_OFFSET UNITYSDK_OFFSET(0x1AAD2700)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AAD2410)
#define MOLEMOLE_UISNAKEENDINGANIMSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD7690)

namespace MoleMole
{
	inline static constexpr unsigned int UISnakeEndingAnimScript_TypeDefinitionIndex = 81636;
	...
	public:
		...
		::System::Void Method_5_D76963A554A1D89D(::MoleMole::UISnakeEndingAnimScript_Struct_2_AA4EE15A8D4DB005_6& a1, ::System::Int32 a2, ::System::Single a3, ::System::Single a4)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::UISnakeEndingAnimScript_Struct_2_AA4EE15A8D4DB005_6&, ::System::Int32, ::System::Single, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_UISNAKEENDINGANIMSCRIPT_METHOD_5_D76963A554A1D89D_OFFSET))(this, a1, a2, a3, a4);
		}
