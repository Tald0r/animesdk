...
#define MOLEMOLE_RESETDYNAMICTARGETVALUE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x6B1E170)
#define MOLEMOLE_RESETDYNAMICTARGETVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x6B1E410)
#define MOLEMOLE_RESETDYNAMICTARGETVALUE___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x6B1E450)

namespace MoleMole
{
	inline static constexpr unsigned int ResetDynamicTargetValue_TypeDefinitionIndex = 39650;
	...
	public:
		...
		::System::Boolean ResetInRangeTargetValue; // 0x62
