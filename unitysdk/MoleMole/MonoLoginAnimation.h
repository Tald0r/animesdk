...
#define MOLEMOLE_MONOLOGINANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x6B0D090)

namespace MoleMole
{
	inline static constexpr unsigned int MonoLoginAnimation_TypeDefinitionIndex = 59749;
