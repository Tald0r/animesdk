...
#define MOLEMOLE_UITRENDYSTOREPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xACD5330)

namespace MoleMole
{
	inline static constexpr unsigned int UITrendyStorePageController_Context_TypeDefinitionIndex = 38132;
