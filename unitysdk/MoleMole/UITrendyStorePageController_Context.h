...
#define MOLEMOLE_UITRENDYSTOREPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x86B3540)

namespace MoleMole
{
	inline static constexpr unsigned int UITrendyStorePageController_Context_TypeDefinitionIndex = 50858;
