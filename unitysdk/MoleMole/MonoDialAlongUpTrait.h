...
#define MOLEMOLE_MONODIALALONGUPTRAIT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xB5F56A0)
#define MOLEMOLE_MONODIALALONGUPTRAIT_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0xB5F5A00)
#define MOLEMOLE_MONODIALALONGUPTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0xB5F5CD0)
#define MOLEMOLE_MONODIALALONGUPTRAIT___BASE_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0xB5F5D20)

namespace MoleMole
{
	inline static constexpr unsigned int MonoDialAlongUpTrait_TypeDefinitionIndex = 48061;
