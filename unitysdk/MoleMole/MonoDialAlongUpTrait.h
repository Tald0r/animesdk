...
#define MOLEMOLE_MONODIALALONGUPTRAIT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x6B057E0)
#define MOLEMOLE_MONODIALALONGUPTRAIT_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x6B05B40)
#define MOLEMOLE_MONODIALALONGUPTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x6B05E10)
#define MOLEMOLE_MONODIALALONGUPTRAIT___BASE_ONDOUPDATE_OFFSET UNITYSDK_OFFSET(0x6B05EB0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoDialAlongUpTrait_TypeDefinitionIndex = 39090;
