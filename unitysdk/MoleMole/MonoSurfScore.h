...
#define MOLEMOLE_MONOSURFSCORE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xD817960)
#define MOLEMOLE_MONOSURFSCORE_METHOD_5_4155E433CDAD6311_OFFSET UNITYSDK_OFFSET(0xD817EC0)
#define MOLEMOLE_MONOSURFSCORE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0xD817A80)
#define MOLEMOLE_MONOSURFSCORE__CCTOR_OFFSET UNITYSDK_OFFSET(0xD8182F0)
#define MOLEMOLE_MONOSURFSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0xD8182D0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoSurfScore_TypeDefinitionIndex = 46102;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(MonoSurfScore_TypeDefinitionIndex)->GetStaticField(0x42540);
		}
