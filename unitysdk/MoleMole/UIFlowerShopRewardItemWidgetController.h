...
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC57290)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONGETREWARDBUTTON_OFFSET UNITYSDK_OFFSET(0xAC57A60)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC574D0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONTAKECOMMONREWARDEVENT_OFFSET UNITYSDK_OFFSET(0xAC57B50)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC573F0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC56F80)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC571E0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_REFRESHPANEL_OFFSET UNITYSDK_OFFSET(0xAC575B0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAC57BC0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAC57BD0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xAC57C40)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAC57CC0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAC57D40)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAC57DA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerShopRewardItemWidgetController_TypeDefinitionIndex = 58259;

	class UIFlowerShopRewardItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_A3D97EDF9C99B3C3_2* _view; // 0x2D0
		::Class_2_923BB6EA0D9B637B* _model; // 0x2D8
		::Class_2_208CC9941471731A_22* _tableInfo; // 0x2E0
