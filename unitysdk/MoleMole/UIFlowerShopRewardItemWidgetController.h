...
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x80796C0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONGETREWARDBUTTON_OFFSET UNITYSDK_OFFSET(0x8079E90)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x8079900)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONTAKECOMMONREWARDEVENT_OFFSET UNITYSDK_OFFSET(0x8079F80)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8079820)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x80793B0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8079610)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER_REFRESHPANEL_OFFSET UNITYSDK_OFFSET(0x80799E0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8079FF0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x807A000)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x807A070)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x807A0F0)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x807A170)
#define MOLEMOLE_UIFLOWERSHOPREWARDITEMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x807A1D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFlowerShopRewardItemWidgetController_TypeDefinitionIndex = 43928;

	class UIFlowerShopRewardItemWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_A3D97EDF9C99B3C3* _view; // 0x2D0
		::Class_2_923BB6EA0D9B637B* _model; // 0x2D8
		::Class_2_208CC9941471731A_265* _tableInfo; // 0x2E0
