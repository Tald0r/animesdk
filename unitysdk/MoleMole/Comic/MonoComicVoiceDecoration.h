...
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x916D800)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_EDITORAWAKE_OFFSET UNITYSDK_OFFSET(0x916EBE0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x916E7F0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x916E6D0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_INITINEDITOR_OFFSET UNITYSDK_OFFSET(0x916ED00)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x916D8D0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_METHOD_7_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x916E910)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_METHOD_7_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x916E5E0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_METHOD_7_479759059E440327_1_OFFSET UNITYSDK_OFFSET(0x916E3D0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_METHOD_7_479759059E440327_OFFSET UNITYSDK_OFFSET(0x916E4B0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_METHOD_7_5AE33E89D3D29F4D_OFFSET UNITYSDK_OFFSET(0x916DC90)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_METHOD_7_7CDD918CEB77C56B_OFFSET UNITYSDK_OFFSET(0x916D9F0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_METHOD_7_90D0DC11D34D7114_OFFSET UNITYSDK_OFFSET(0x916EA40)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_METHOD_7_9D9CF8F6C2342EE5_OFFSET UNITYSDK_OFFSET(0x916E030)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x916E140)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x916DE50)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_SIMULATEANIMPROGRESSFOROUTER_OFFSET UNITYSDK_OFFSET(0x916EB60)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x916DEC0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x916E270)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION__CTOR_OFFSET UNITYSDK_OFFSET(0x916EDA0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION___BASE_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x916EDC0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION___BASE_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x916EE20)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION___BASE_GETFADEOUTTIME_OFFSET UNITYSDK_OFFSET(0x916EE80)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x916EEE0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION___BASE_JUMPTOFINAL_OFFSET UNITYSDK_OFFSET(0x916EEF0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION___BASE_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x916EF50)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION___BASE_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x916EFB0)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x916F010)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION___BASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x916F020)
#define MOLEMOLE_COMIC_MONOCOMICVOICEDECORATION___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x916F080)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicVoiceDecoration_TypeDefinitionIndex = 72644;
