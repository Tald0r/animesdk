...
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x6298070)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GETBGNODESBYLOCATION_OFFSET UNITYSDK_OFFSET(0x629AB20)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GETIMGDECOROOT_OFFSET UNITYSDK_OFFSET(0x629C290)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GETIMGMOVEVECTORWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x629C1A0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GETIMGOBJBYPART_OFFSET UNITYSDK_OFFSET(0x629A290)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x6298050)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GET_SELFGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x6299FC0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_GET_SELFRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x629A0A0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_INITBYSTYLECONFIG_OFFSET UNITYSDK_OFFSET(0x6299670)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_ISPLAYINGANIMATION_OFFSET UNITYSDK_OFFSET(0x629ACA0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_20B279F6D0EB86A9_OFFSET UNITYSDK_OFFSET(0x629C6C0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_2D0434B81DC32083_OFFSET UNITYSDK_OFFSET(0x629C7D0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_3BCF0226A6CDC13B_OFFSET UNITYSDK_OFFSET(0x629B530)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_40CBD6FA418D8BFD_OFFSET UNITYSDK_OFFSET(0x629C330)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_41782CE468D1B24D_OFFSET UNITYSDK_OFFSET(0x6298E00)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_62DABBB79241EF26_OFFSET UNITYSDK_OFFSET(0x629C3E0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_84D0BB0CCF9E43EA_OFFSET UNITYSDK_OFFSET(0x62992A0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_8542E37E74FDE1B5_OFFSET UNITYSDK_OFFSET(0x629B090)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_9C2166EC68C0CC08_OFFSET UNITYSDK_OFFSET(0x6299700)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_METHOD_7_ED1605BD4E0F2236_OFFSET UNITYSDK_OFFSET(0x62994F0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x629A220)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_RECORDNODESFORCURTAIN_OFFSET UNITYSDK_OFFSET(0x629BAB0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_RESETCURTAINSTATETODEFAULT_OFFSET UNITYSDK_OFFSET(0x629BD90)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x62982F0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_RESET_OFFSET UNITYSDK_OFFSET(0x6299600)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_SAMESTYLE_OFFSET UNITYSDK_OFFSET(0x629A1A0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_SETIMAGELIST_OFFSET UNITYSDK_OFFSET(0x629A3F0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_SET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x6298060)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_SIMULATEANIMPROGRESSFOROUTER_OFFSET UNITYSDK_OFFSET(0x629C210)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_STARTCOMICANIMATION_OFFSET UNITYSDK_OFFSET(0x629AD10)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_STARTCURTAINANIMATION_OFFSET UNITYSDK_OFFSET(0x629BCC0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_TRIGGERWHENSPLITSCREENFINISH_OFFSET UNITYSDK_OFFSET(0x629B9D0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x62980E0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x629C590)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x629C5D0)
#define MOLEMOLE_COMIC_MONOCOMICIMGCOMPONENT___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x629C650)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicImgComponent_TypeDefinitionIndex = 75607;
