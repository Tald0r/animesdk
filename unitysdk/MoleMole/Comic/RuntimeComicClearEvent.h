...
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT_CLEAREVENTSWITHTAG_OFFSET UNITYSDK_OFFSET(0x9BB8910)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x9BB86A0)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x9BB8280)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x9BB8410)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x9BB8720)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9BB8C30)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT___BASE_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x9BB8CD0)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x9BB8D30)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT___BASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x9BB8DB0)
#define MOLEMOLE_COMIC_RUNTIMECOMICCLEAREVENT___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x9BB8E10)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int RuntimeComicClearEvent_TypeDefinitionIndex = 39983;
