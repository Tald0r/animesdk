...
class Class_1_BBB9A1002D39757B;
...
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x65409E0)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_INITSHAKEITEMLIST_OFFSET UNITYSDK_OFFSET(0x6540820)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x6540580)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x6540890)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x6540A70)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x6540C90)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x6540E00)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x6540E20)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x6540E80)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x6540F00)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x6540F70)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x6540FD0)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int RuntimeComicShakeEvent_TypeDefinitionIndex = 67610;
	...
	public:
		...
		::Class_1_BBB9A1002D39757B* Field_7_3; // 0x70
