...
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x81DB870)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_INITSHAKEITEMLIST_OFFSET UNITYSDK_OFFSET(0x81DB6B0)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x81DB410)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x81DB720)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x81DB900)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x81DBB20)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x81DBC90)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x81DBCB0)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x81DBD10)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x81DBD90)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x81DBE00)
#define MOLEMOLE_COMIC_RUNTIMECOMICSHAKEEVENT___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x81DBE60)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int RuntimeComicShakeEvent_TypeDefinitionIndex = 70356;
