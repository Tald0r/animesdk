...
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x80324F0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_EDITORAWAKE_OFFSET UNITYSDK_OFFSET(0x8033B40)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x80335C0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_GETPICRECTTRANS_OFFSET UNITYSDK_OFFSET(0x8033A50)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_INITINEDITOR_OFFSET UNITYSDK_OFFSET(0x8033C60)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x80325C0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_1290EA767C459179_OFFSET UNITYSDK_OFFSET(0x8033800)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x80334D0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_479759059E440327_1_OFFSET UNITYSDK_OFFSET(0x80332C0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_479759059E440327_OFFSET UNITYSDK_OFFSET(0x80333A0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_6AF96BBFE90AF125_OFFSET UNITYSDK_OFFSET(0x8032A00)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_90D0DC11D34D7114_OFFSET UNITYSDK_OFFSET(0x8033930)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_9D9CF8F6C2342EE5_OFFSET UNITYSDK_OFFSET(0x8032F20)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_METHOD_7_D0EE7726155A790C_OFFSET UNITYSDK_OFFSET(0x80326F0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_PLAYEXIT_OFFSET UNITYSDK_OFFSET(0x80336E0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x8033030)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x8032D40)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_SETWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x8032BC0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_SIMULATEANIMPROGRESSFOROUTER_OFFSET UNITYSDK_OFFSET(0x8033AC0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x8032DB0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x8033160)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION__CTOR_OFFSET UNITYSDK_OFFSET(0x8033D00)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x8033D20)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_GETFADEOUTTIME_OFFSET UNITYSDK_OFFSET(0x8033D80)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x8033DE0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_JUMPTOFINAL_OFFSET UNITYSDK_OFFSET(0x8033DF0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x8033E50)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_PLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x8033EB0)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x8033F10)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x8033F20)
#define MOLEMOLE_COMIC_MONOCOMICPICTUREDECORATION___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x8033F80)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicPictureDecoration_TypeDefinitionIndex = 51439;
