...
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_ADD_ONINITFINISH_OFFSET UNITYSDK_OFFSET(0x8028990)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_ADD_ONSHRINKFINISH_OFFSET UNITYSDK_OFFSET(0x8028A70)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_AWAKE_OFFSET UNITYSDK_OFFSET(0x8028B50)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_CLEARBUBBLERANGELIST_OFFSET UNITYSDK_OFFSET(0x8029FC0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x802BBE0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_FINISHTEXTPLAY_OFFSET UNITYSDK_OFFSET(0x802C5C0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x802BA90)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GETFADEOUTANIMTIME_OFFSET UNITYSDK_OFFSET(0x802C040)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GETHIDEINDEX_OFFSET UNITYSDK_OFFSET(0x802A6A0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GET_GO_OFFSET UNITYSDK_OFFSET(0x802A200)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GET_HIDEWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x802D0E0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GET_MOVEWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x802D0F0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GET_RECTTRAN_OFFSET UNITYSDK_OFFSET(0x802A0B0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_GET_SCROLLVIEWACTIVE_OFFSET UNITYSDK_OFFSET(0x802D100)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_INITIMGCONFIG_OFFSET UNITYSDK_OFFSET(0x802A2B0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_INITRANGEINFO_OFFSET UNITYSDK_OFFSET(0x802A210)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x8029400)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_ISAUTOFINISH_OFFSET UNITYSDK_OFFSET(0x8029F40)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_ISPLAYTEXT_OFFSET UNITYSDK_OFFSET(0x802C4F0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_JUMPTOFINALSTATE_OFFSET UNITYSDK_OFFSET(0x802CE30)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_0A33F82BD72BC622_OFFSET UNITYSDK_OFFSET(0x802B7F0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_0BDFAC56E6B704CB_OFFSET UNITYSDK_OFFSET(0x802E8D0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_185F640B532E227F_OFFSET UNITYSDK_OFFSET(0x802F250)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_1B9CC121BDC8766D_OFFSET UNITYSDK_OFFSET(0x8032020)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_218124418542E081_OFFSET UNITYSDK_OFFSET(0x802F5B0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_231675EAC57B4014_OFFSET UNITYSDK_OFFSET(0x802D4A0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_261DF843E298B71B_OFFSET UNITYSDK_OFFSET(0x802A520)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_27419209AD7EE29A_OFFSET UNITYSDK_OFFSET(0x8029D70)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_2BCDDB2C8831E231_OFFSET UNITYSDK_OFFSET(0x802AF30)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_36AC4BD395BFF6C6_OFFSET UNITYSDK_OFFSET(0x802FEB0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x8031FB0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_4755BFE651CF9635_OFFSET UNITYSDK_OFFSET(0x802A470)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_4DCC367494C5959D_OFFSET UNITYSDK_OFFSET(0x80308F0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_557F4AD98DF1B848_OFFSET UNITYSDK_OFFSET(0x80301B0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_6CAAEFBA0DFA82C0_OFFSET UNITYSDK_OFFSET(0x802B260)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_7FBAA229ED524F8E_OFFSET UNITYSDK_OFFSET(0x802A320)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_9B7C5FA7E1E012C7_OFFSET UNITYSDK_OFFSET(0x802DCB0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_9E0A3606DECE56CE_OFFSET UNITYSDK_OFFSET(0x802EA20)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_B7F8E0B4AF22DEA3_OFFSET UNITYSDK_OFFSET(0x802F3D0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_BE9FAB4996BD7E6F_OFFSET UNITYSDK_OFFSET(0x802E3E0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_C74E50CBD41F0264_1_OFFSET UNITYSDK_OFFSET(0x802F240)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_C74E50CBD41F0264_2_OFFSET UNITYSDK_OFFSET(0x8031E90)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x802CEA0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x802D060)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_CAAD3899EE103AC7_OFFSET UNITYSDK_OFFSET(0x8029650)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_DAAF2880478C42FF_OFFSET UNITYSDK_OFFSET(0x8031EA0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_EC188688BC2EC74F_OFFSET UNITYSDK_OFFSET(0x802ED10)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_EC9F8B8EC6EF4CAF_OFFSET UNITYSDK_OFFSET(0x802FA10)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_EF57A6A71C552C1B_OFFSET UNITYSDK_OFFSET(0x802EE70)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_METHOD_7_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x802D0D0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x802C190)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x802B6A0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_PLAYFADEOUTANIM_OFFSET UNITYSDK_OFFSET(0x802BC50)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_PLAYFOCUSANIM_OFFSET UNITYSDK_OFFSET(0x802CC60)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_PLAYLOSEFOCUSANIM_OFFSET UNITYSDK_OFFSET(0x802CD50)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_REMOVE_ONINITFINISH_OFFSET UNITYSDK_OFFSET(0x8028A00)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_REMOVE_ONSHRINKFINISH_OFFSET UNITYSDK_OFFSET(0x8028AE0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x802CEB0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SETHIDEINDEX_OFFSET UNITYSDK_OFFSET(0x802A630)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SETMOVEPARAMS_OFFSET UNITYSDK_OFFSET(0x802C9F0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SETPARENT_OFFSET UNITYSDK_OFFSET(0x802A0C0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SETVOICEPARAM_OFFSET UNITYSDK_OFFSET(0x802A5C0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SHOWARROW_OFFSET UNITYSDK_OFFSET(0x802B550)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SHOWBUBBLEWIDGET_OFFSET UNITYSDK_OFFSET(0x8029960)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_SIMULATEMOVEPROCESS_OFFSET UNITYSDK_OFFSET(0x802AD10)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x802B630)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x802A710)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x8029DF0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x802D180)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x802D110)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_ENDPLAY_OFFSET UNITYSDK_OFFSET(0x802D210)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_GETFADEINANIMTIME_OFFSET UNITYSDK_OFFSET(0x802D270)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0x802D2D0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_ISAUTOFINISH_OFFSET UNITYSDK_OFFSET(0x802D2E0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_PLAYFADEINANIM_OFFSET UNITYSDK_OFFSET(0x802D2F0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x802D350)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_STARTPLAY_OFFSET UNITYSDK_OFFSET(0x802D3D0)
#define MOLEMOLE_COMIC_MONOCOMICBUBBLE___BASE_UPDATETIME_OFFSET UNITYSDK_OFFSET(0x802D430)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int MonoComicBubble_TypeDefinitionIndex = 41248;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MoleMole::Comic::MonoComicBubble_Class_1_4F7EA480540242DA*>**)Il2CppClass::FromTypeDefinitionIndex(MonoComicBubble_TypeDefinitionIndex)->GetStaticField(0x31D90);
		}
