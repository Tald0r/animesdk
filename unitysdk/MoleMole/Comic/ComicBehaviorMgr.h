...
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_CLEARALLCACHE_OFFSET UNITYSDK_OFFSET(0x1AA01520)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_CREATEBUBBLE_OFFSET UNITYSDK_OFFSET(0x1AA01CE0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_CREATEDECORATIONNODE_OFFSET UNITYSDK_OFFSET(0x1AA02CF0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_CREATETEMPNODE_OFFSET UNITYSDK_OFFSET(0x1AA01450)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETBUBBLENODE_OFFSET UNITYSDK_OFFSET(0x1AA01D00)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETIMAGE01TRANS_OFFSET UNITYSDK_OFFSET(0x1AA00CB0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETSUBSPRITEROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AA00910)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETTEMPLATENODE_OFFSET UNITYSDK_OFFSET(0x1AA01300)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETTEMPLATEPARTIMG_OFFSET UNITYSDK_OFFSET(0x1AA00FC0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETTRANSNAMEDDFS_OFFSET UNITYSDK_OFFSET(0x1AA011C0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GET_ADAPTERTYPE_OFFSET UNITYSDK_OFFSET(0x1AA02DE0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GET_ARROWTARGETPOINTSPRITE_OFFSET UNITYSDK_OFFSET(0x1AA02DA0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GET_COMICIMGSTYLECONFIG_OFFSET UNITYSDK_OFFSET(0x1AA02CE0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A9FEC80)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_INITBUBBLE_OFFSET UNITYSDK_OFFSET(0x1AA01CF0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_INIT_OFFSET UNITYSDK_OFFSET(0x1A9FEDE0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_JUSTGETTEMPLATENODE_OFFSET UNITYSDK_OFFSET(0x1AA01460)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SETARROWTARGETPOINTPOS_OFFSET UNITYSDK_OFFSET(0x1AA02790)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SHOWARROWTARGETPOINTOFKEY_OFFSET UNITYSDK_OFFSET(0x1AA02A50)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SHOWBUBBLEGROUP_OFFSET UNITYSDK_OFFSET(0x1AA01780)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SHOWDECORATIONGROUP_OFFSET UNITYSDK_OFFSET(0x1AA01E10)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SHOWPICDECOGROUP_OFFSET UNITYSDK_OFFSET(0x1AA02190)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWICTHBUBBLERANGESHOWER_OFFSET UNITYSDK_OFFSET(0x1AA00EA0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHBUBBLESTATE_OFFSET UNITYSDK_OFFSET(0x1AA01B00)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHDECORATIONNODESTATE_OFFSET UNITYSDK_OFFSET(0x1AA02560)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHMASKSTATE_OFFSET UNITYSDK_OFFSET(0x1AA00CC0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHPICTUREDECORATIONNODESTATE_OFFSET UNITYSDK_OFFSET(0x1AA02740)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHVOICEDECORATIONNODESTATE_OFFSET UNITYSDK_OFFSET(0x1AA02510)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA02DF0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9FED60)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int ComicBehaviorMgr_TypeDefinitionIndex = 30066;
	...
	public:
		...
		{
			return (::UnityEngine::Sprite**)Il2CppClass::FromTypeDefinitionIndex(ComicBehaviorMgr_TypeDefinitionIndex)->GetStaticField(0x243D0);
		}
		static ::MoleMole::Comic::ComicBehaviorMgr** StaticGet_m_pInstance()
		{
			return (::MoleMole::Comic::ComicBehaviorMgr**)Il2CppClass::FromTypeDefinitionIndex(ComicBehaviorMgr_TypeDefinitionIndex)->GetStaticField(0x243D8);
		}
		...
		::UnityEngine::Transform* m_stTemplateRoot; // 0x18
		::UnityEngine::Transform* m_stImage01; // 0x20
		...
		::UnityEngine::Transform* m_stBubbleRoot; // 0x48
		::MoleMole::ComicImgStyleConfig* m_stStyleConfig; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::GameObject*>* m_stDecorationPrefabMap; // 0x58
