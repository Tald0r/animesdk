...
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_CLEARALLCACHE_OFFSET UNITYSDK_OFFSET(0x1A435E60)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_CREATEBUBBLE_OFFSET UNITYSDK_OFFSET(0x1A436620)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_CREATEDECORATIONNODE_OFFSET UNITYSDK_OFFSET(0x1A437630)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_CREATETEMPNODE_OFFSET UNITYSDK_OFFSET(0x1A435D90)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETBUBBLENODE_OFFSET UNITYSDK_OFFSET(0x1A436640)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETIMAGE01TRANS_OFFSET UNITYSDK_OFFSET(0x1A4355F0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETSUBSPRITEROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A435250)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETTEMPLATENODE_OFFSET UNITYSDK_OFFSET(0x1A435C40)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETTEMPLATEPARTIMG_OFFSET UNITYSDK_OFFSET(0x1A435900)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GETTRANSNAMEDDFS_OFFSET UNITYSDK_OFFSET(0x1A435B00)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GET_ADAPTERTYPE_OFFSET UNITYSDK_OFFSET(0x1A437720)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GET_ARROWTARGETPOINTSPRITE_OFFSET UNITYSDK_OFFSET(0x1A4376E0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GET_COMICIMGSTYLECONFIG_OFFSET UNITYSDK_OFFSET(0x1A437620)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A4335C0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_INITBUBBLE_OFFSET UNITYSDK_OFFSET(0x1A436630)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_INIT_OFFSET UNITYSDK_OFFSET(0x1A433720)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_JUSTGETTEMPLATENODE_OFFSET UNITYSDK_OFFSET(0x1A435DA0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SETARROWTARGETPOINTPOS_OFFSET UNITYSDK_OFFSET(0x1A4370D0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SHOWARROWTARGETPOINTOFKEY_OFFSET UNITYSDK_OFFSET(0x1A437390)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SHOWBUBBLEGROUP_OFFSET UNITYSDK_OFFSET(0x1A4360C0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SHOWDECORATIONGROUP_OFFSET UNITYSDK_OFFSET(0x1A436750)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SHOWPICDECOGROUP_OFFSET UNITYSDK_OFFSET(0x1A436AD0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWICTHBUBBLERANGESHOWER_OFFSET UNITYSDK_OFFSET(0x1A4357E0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHBUBBLESTATE_OFFSET UNITYSDK_OFFSET(0x1A436440)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHDECORATIONNODESTATE_OFFSET UNITYSDK_OFFSET(0x1A436EA0)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHMASKSTATE_OFFSET UNITYSDK_OFFSET(0x1A435600)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHPICTUREDECORATIONNODESTATE_OFFSET UNITYSDK_OFFSET(0x1A437080)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR_SWITCHVOICEDECORATIONNODESTATE_OFFSET UNITYSDK_OFFSET(0x1A436E50)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A437730)
#define MOLEMOLE_COMIC_COMICBEHAVIORMGR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4336A0)

namespace MoleMole::Comic
{
	inline static constexpr unsigned int ComicBehaviorMgr_TypeDefinitionIndex = 29113;
	...
	public:
		...
		{
			return (::MoleMole::Comic::ComicBehaviorMgr**)Il2CppClass::FromTypeDefinitionIndex(ComicBehaviorMgr_TypeDefinitionIndex)->GetStaticField(0x22AB0);
		}
		static ::UnityEngine::Sprite** StaticGet__arrowTargetPointSprite()
		{
			return (::UnityEngine::Sprite**)Il2CppClass::FromTypeDefinitionIndex(ComicBehaviorMgr_TypeDefinitionIndex)->GetStaticField(0x22AB8);
		}
		...
		::System::Type* m_stAdapterType; // 0x10
		::UnityEngine::Transform* m_stSubSpriteRoot; // 0x18
		::MoleMole::ComicImgStyleConfig* m_stStyleConfig; // 0x20
		::UnityEngine::Transform* m_stPicDecoRoot; // 0x28
		::UnityEngine::Transform* m_stBubbleRangeShower; // 0x30
		::UnityEngine::Transform* m_stATPRoot; // 0x38
		::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::GameObject*>* m_stDecorationPrefabMap; // 0x40
		::System::Func_4<::UnityEngine::Transform*, ::System::String*, ::UnityEngine::Timeline::BubbleEvent*, ::UnityEngine::Transform*>* m_fcCreateBubble; // 0x48
		::UnityEngine::Transform* m_stBubbleRoot; // 0x50
		::UnityEngine::Transform* m_stImage01; // 0x58
		::UnityEngine::Transform* m_stDecorationRoot; // 0x60
