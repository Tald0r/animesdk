...
#define MOLEMOLE_COMIC_UTIL_COMICIMGSTYLECONFIGEXTENSION_MATCHCOMICIMGPARTTYPE_OFFSET UNITYSDK_OFFSET(0x1A8663C0)
#define MOLEMOLE_COMIC_UTIL_COMICIMGSTYLECONFIGEXTENSION_TONAME_OFFSET UNITYSDK_OFFSET(0x1A866370)

namespace MoleMole::Comic::Util
{
	inline static constexpr unsigned int ComicImgStyleConfigExtension_TypeDefinitionIndex = 29125;
