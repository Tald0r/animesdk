...
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ADF7B60)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_INITDATA_OFFSET UNITYSDK_OFFSET(0x1ADF9080)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_METHOD_5_21886A8411E71157_OFFSET UNITYSDK_OFFSET(0x1ADF7BB0)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_REFRESH_OFFSET UNITYSDK_OFFSET(0x1ADF8C30)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETEXCLAMATIONMARK_OFFSET UNITYSDK_OFFSET(0x1ADF94D0)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETGLODMARK_OFFSET UNITYSDK_OFFSET(0x1ADF93E0)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETLOADER_OFFSET UNITYSDK_OFFSET(0x1ADF9030)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETNUM_OFFSET UNITYSDK_OFFSET(0x1ADF9730)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETPROPSPRITE_OFFSET UNITYSDK_OFFSET(0x1ADF91F0)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETRIGHTROOTACTIVE_OFFSET UNITYSDK_OFFSET(0x1ADF96D0)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_SETSYMBOL_OFFSET UNITYSDK_OFFSET(0x1ADF95B0)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ADF9840)
#define MOLEMOLE_UICPSCORETIPSCRIPTNEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADF9940)

namespace MoleMole
{
	inline static constexpr unsigned int UICpScoreTipScriptNew_TypeDefinitionIndex = 81437;
