...
#define MOLEMOLE_UIMECHBOOLISTWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA418680)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooListWidgetControllerContext_TypeDefinitionIndex = 56057;
