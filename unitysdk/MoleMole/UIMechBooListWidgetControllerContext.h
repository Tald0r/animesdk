...
#define MOLEMOLE_UIMECHBOOLISTWIDGETCONTROLLERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x94508D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMechBooListWidgetControllerContext_TypeDefinitionIndex = 69883;
