...
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__CTOR_OFFSET UNITYSDK_OFFSET(0x8C0D290)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__10_OFFSET UNITYSDK_OFFSET(0x8C0D830)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__4_OFFSET UNITYSDK_OFFSET(0x8C0D2A0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__5_OFFSET UNITYSDK_OFFSET(0x8C0D350)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__6_OFFSET UNITYSDK_OFFSET(0x8C0D9E0)
#define MOLEMOLE_UIGENERALLEVELUP02WIDGETCONTROLLER___C__DISPLAYCLASS11_2__REFRESHLEVELTXTVIEW_B__9_OFFSET UNITYSDK_OFFSET(0x8C0D790)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralLevelUp02WidgetController___c__DisplayClass11_2_TypeDefinitionIndex = 46304;
