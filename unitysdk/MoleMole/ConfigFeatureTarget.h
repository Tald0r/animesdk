...
#define MOLEMOLE_CONFIGFEATURETARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x8064820)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigFeatureTarget_TypeDefinitionIndex = 72351;
