...
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_GET_CURRENTLAYERINFOINDEX_OFFSET UNITYSDK_OFFSET(0x9C00020)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_GET_CURRENTZONELAYERINFO_OFFSET UNITYSDK_OFFSET(0x9C00010)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_GET_UNLOCKANIM_OFFSET UNITYSDK_OFFSET(0x9C01A20)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_MARKSELECTSTATUS_OFFSET UNITYSDK_OFFSET(0x9C008B0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9C001A0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0x9C00650)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x9C01800)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9C01AB0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9C00240)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9C003F0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9C00050)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9C000F0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_SETONACTIVECALLBACK_OFFSET UNITYSDK_OFFSET(0x9C01720)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_SETONCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0x9C00840)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_SETONUNLOCKCALLBACK_OFFSET UNITYSDK_OFFSET(0x9C01790)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_SETPARENTWINDOWFADEINDONEFUNC_OFFSET UNITYSDK_OFFSET(0x9C02F20)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__CLOSEALLSTATEOBJECTS_OFFSET UNITYSDK_OFFSET(0x9C023D0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__COLLECTSELECTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x9C00BD0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9C03200)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__GETDIGITSPRITE_OFFSET UNITYSDK_OFFSET(0x9C01600)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__ISINMODEA_OFFSET UNITYSDK_OFFSET(0x9C007D0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__TRYPLAYUNLOCKLAYERANIM_OFFSET UNITYSDK_OFFSET(0x9C02550)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__TRYSHOWTRACKICON_OFFSET UNITYSDK_OFFSET(0x9C02C10)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__UNLOCLAYERCOROUTINE_OFFSET UNITYSDK_OFFSET(0x9C02F90)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__UPDATESTATELAYERINFO_OFFSET UNITYSDK_OFFSET(0x9C00E80)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9C03260)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x9C032D0)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONSCROLLITEMRECYCLE_OFFSET UNITYSDK_OFFSET(0x9C03330)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9C03390)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x9C03410)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9C03480)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9C03500)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9C03560)
#define MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER___TRYSHOWTRACKICON_G___CHECKTRACK_45_0_OFFSET UNITYSDK_OFFSET(0x9C03030)

namespace MoleMole
{
	inline static constexpr unsigned int UIHadalZone_LayerItemRowV2WidgetController_TypeDefinitionIndex = 70363;
	...
	public:
		...
		::Class_1_5DA2E7556103D5A3_245* _zoneInfo; // 0x2D8
		...
		::System::Action_2<::System::Boolean, ::MoleMole::UIHadalZone_LayerItemRowV2WidgetController*>* _OnItemUnlockCallback; // 0x328
		::System::String* UNLOCK_ANIM; // 0x330
		::System::String* UNLOCK_ANIM_SPECIAL_LAYER; // 0x338
		::System::String* FADEIN_ANIM; // 0x340
		::Foundation::Coroutine::CoroutineHandle _corNextLayerUnlockHandle; // 0x348
		::System::Boolean _isTryPlayUnlock; // 0x34C
		::UnityEngine::Coroutine* _playUnlockAnimCor; // 0x350
		...
		::Class_1_5DA2E7556103D5A3_245* get_CurrentZoneLayerInfo()
		{
			return ((::Class_1_5DA2E7556103D5A3_245*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER_GET_CURRENTZONELAYERINFO_OFFSET))(this);
		}
		...
		::System::Void _UpdateStateLayerInfo(::Class_1_5DA2E7556103D5A3_245* infoTemplate, ::UnityEngine::GameObject* targetObject)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_5DA2E7556103D5A3_245*, ::UnityEngine::GameObject*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIHADALZONE_LAYERITEMROWV2WIDGETCONTROLLER__UPDATESTATELAYERINFO_OFFSET))(this, infoTemplate, targetObject);
		}
