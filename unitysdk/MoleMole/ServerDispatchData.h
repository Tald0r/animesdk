...
#define MOLEMOLE_SERVERDISPATCHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB3C1EE0)

namespace MoleMole
{
	inline static constexpr unsigned int ServerDispatchData_TypeDefinitionIndex = 42645;
