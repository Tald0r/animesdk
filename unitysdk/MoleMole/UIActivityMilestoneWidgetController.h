...
#define MOLEMOLE_UIACTIVITYMILESTONEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFF9EC0)
#define MOLEMOLE_UIACTIVITYMILESTONEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFF9F60)
#define MOLEMOLE_UIACTIVITYMILESTONEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFF9C10)
#define MOLEMOLE_UIACTIVITYMILESTONEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFF9CB0)
#define MOLEMOLE_UIACTIVITYMILESTONEWIDGETCONTROLLER_SHOWPANEL_OFFSET UNITYSDK_OFFSET(0xCFF9D70)
#define MOLEMOLE_UIACTIVITYMILESTONEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCFFA040)
#define MOLEMOLE_UIACTIVITYMILESTONEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCFFA070)
#define MOLEMOLE_UIACTIVITYMILESTONEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCFFA0E0)
#define MOLEMOLE_UIACTIVITYMILESTONEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCFFA160)
#define MOLEMOLE_UIACTIVITYMILESTONEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCFFA1C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityMilestoneWidgetController_TypeDefinitionIndex = 37713;
