...
#define MOLEMOLE_LISTKEYBINDINGTITLESETTINGENTRY_GET_SETTINGWIDGETTYPE_OFFSET UNITYSDK_OFFSET(0x67A99F0)
#define MOLEMOLE_LISTKEYBINDINGTITLESETTINGENTRY_GET__ISHIDEVERSIONCODE_OFFSET UNITYSDK_OFFSET(0x67A99E0)
#define MOLEMOLE_LISTKEYBINDINGTITLESETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x67A9A00)

namespace MoleMole
{
	inline static constexpr unsigned int ListKeyBindingTitleSettingEntry_TypeDefinitionIndex = 75295;
