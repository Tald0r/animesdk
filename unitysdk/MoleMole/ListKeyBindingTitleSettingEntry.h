...
#define MOLEMOLE_LISTKEYBINDINGTITLESETTINGENTRY_GET_SETTINGWIDGETTYPE_OFFSET UNITYSDK_OFFSET(0x75A72C0)
#define MOLEMOLE_LISTKEYBINDINGTITLESETTINGENTRY_GET__ISHIDEVERSIONCODE_OFFSET UNITYSDK_OFFSET(0x75A72B0)
#define MOLEMOLE_LISTKEYBINDINGTITLESETTINGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x75A72D0)

namespace MoleMole
{
	inline static constexpr unsigned int ListKeyBindingTitleSettingEntry_TypeDefinitionIndex = 59814;
