...
#define MOLEMOLE_ITEMICONTWEENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xF1B7D30)

namespace MoleMole
{
	inline static constexpr unsigned int ItemIconTweenConfig_TypeDefinitionIndex = 37550;
