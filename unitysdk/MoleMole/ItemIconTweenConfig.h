...
#define MOLEMOLE_ITEMICONTWEENCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB9935B0)

namespace MoleMole
{
	inline static constexpr unsigned int ItemIconTweenConfig_TypeDefinitionIndex = 68716;
