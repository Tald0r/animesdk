...
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYTIMELINEPLAYERTOSTAGE_D__142_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3AAB20)
#define MOLEMOLE_UIRIDUSGOTBOOPAGECONTROLLER__PLAYTIMELINEPLAYERTOSTAGE_D__142_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIRidusGotBooPageController__PlayTimelinePlayerToStage_d__142_TypeDefinitionIndex = 44108;
