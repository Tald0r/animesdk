...
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__TRYSHOWNEWEQUIPTIPSASYNC_D__26_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x37EE00)
#define MOLEMOLE_UIBANGBOOUAVLEVELPAGECONTROLLER__TRYSHOWNEWEQUIPTIPSASYNC_D__26_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIBangBooUAVLevelPageController__TryShowNewEquipTipsAsync_d__26_TypeDefinitionIndex = 43298;

	struct alignas(8) UIBangBooUAVLevelPageController__TryShowNewEquipTipsAsync_d__26
	{
		::System::Collections::Generic::Queue_1<::System::Int32>* _equipTipsPopQueue_5__2; // 0x10
