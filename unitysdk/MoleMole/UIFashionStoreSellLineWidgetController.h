...
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_CANCELSCROLLVIEWSELECT_OFFSET UNITYSDK_OFFSET(0xA356760)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_INITSELECTMANUALLY_OFFSET UNITYSDK_OFFSET(0xA356630)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_ISROW_OFFSET UNITYSDK_OFFSET(0xA3566E0)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA356170)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA3562F0)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA356210)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA356020)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3567E0)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER__ONSCROLLITEMUPDATE_B__5_0_OFFSET UNITYSDK_OFFSET(0xA3567F0)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA356860)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA3568D0)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA356950)
#define MOLEMOLE_UIFASHIONSTORESELLLINEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA3569D0)

namespace MoleMole
{
	inline static constexpr unsigned int UIFashionStoreSellLineWidgetController_TypeDefinitionIndex = 72071;

	class UIFashionStoreSellLineWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8B36B2DB492DBF9B_13* _view; // 0x2D0
