...
#define MOLEMOLE_SUIBIANTEMPLEUPGRADEDIALOGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8B7A950)

namespace MoleMole
{
	inline static constexpr unsigned int SuibianTempleUpgradeDialogContext_TypeDefinitionIndex = 62967;
