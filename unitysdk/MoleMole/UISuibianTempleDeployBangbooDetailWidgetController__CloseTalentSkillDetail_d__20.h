...
#define MOLEMOLE_UISUIBIANTEMPLEDEPLOYBANGBOODETAILWIDGETCONTROLLER__CLOSETALENTSKILLDETAIL_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x39B8B0)
#define MOLEMOLE_UISUIBIANTEMPLEDEPLOYBANGBOODETAILWIDGETCONTROLLER__CLOSETALENTSKILLDETAIL_D__20_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleDeployBangbooDetailWidgetController__CloseTalentSkillDetail_d__20_TypeDefinitionIndex = 50869;
