...
#define MOLEMOLE_UIWORKSHOPICONBTNWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA777890)
#define MOLEMOLE_UIWORKSHOPICONBTNWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA777A80)
#define MOLEMOLE_UIWORKSHOPICONBTNWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA777AA0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkshopIconBtnWidgetController_TypeDefinitionIndex = 62399;
