...
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS139_0__CTOR_OFFSET UNITYSDK_OFFSET(0x92B54A0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS139_0__PLAYMISSIONFADEOUT_B__0_OFFSET UNITYSDK_OFFSET(0x92B54B0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS139_0__PLAYMISSIONFADEOUT_B__1_OFFSET UNITYSDK_OFFSET(0x92B57B0)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS139_0__PLAYMISSIONFADEOUT_B__2_OFFSET UNITYSDK_OFFSET(0x92B5540)
#define MOLEMOLE_UIMISSIONTIPSCONTAINERWIDGETCONTROLLER___C__DISPLAYCLASS139_0__PLAYMISSIONFADEOUT_B__3_OFFSET UNITYSDK_OFFSET(0x92B5840)

namespace MoleMole
{
	inline static constexpr unsigned int UIMissionTipsContainerWidgetController___c__DisplayClass139_0_TypeDefinitionIndex = 75686;
