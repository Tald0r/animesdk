...
#define MOLEMOLE_MONOUIGRIDLAYOUTGROUPADAPTOR_DOINITLAYOUT_OFFSET UNITYSDK_OFFSET(0x7F1CD50)
#define MOLEMOLE_MONOUIGRIDLAYOUTGROUPADAPTOR_INITGRIDLAYOUTGROUP_OFFSET UNITYSDK_OFFSET(0x7F1CF30)
#define MOLEMOLE_MONOUIGRIDLAYOUTGROUPADAPTOR_ISCONTAINPLATFORMUIPARAMS_OFFSET UNITYSDK_OFFSET(0x7F1CC40)
#define MOLEMOLE_MONOUIGRIDLAYOUTGROUPADAPTOR_ISPLATFORMUIPARAMSEMPTY_OFFSET UNITYSDK_OFFSET(0x7F1CB80)
#define MOLEMOLE_MONOUIGRIDLAYOUTGROUPADAPTOR_RELOADDATAFROMJSON_OFFSET UNITYSDK_OFFSET(0x7F1D2C0)
#define MOLEMOLE_MONOUIGRIDLAYOUTGROUPADAPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x7F1D610)

namespace MoleMole
{
	inline static constexpr unsigned int MonoUIGridLayoutGroupAdaptor_TypeDefinitionIndex = 46353;
