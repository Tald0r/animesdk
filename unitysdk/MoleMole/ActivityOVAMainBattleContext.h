...
#define MOLEMOLE_ACTIVITYOVAMAINBATTLECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x67214D0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityOVAMainBattleContext_TypeDefinitionIndex = 56621;
