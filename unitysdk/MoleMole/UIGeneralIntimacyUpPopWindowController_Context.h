...
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT_GET_CURTRUSTLEVEL_OFFSET UNITYSDK_OFFSET(0x95FB520)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT_GET_MODTRUSTTYPE_OFFSET UNITYSDK_OFFSET(0x95FB560)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT_GET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x95FB540)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT_GET_PARTNERID_OFFSET UNITYSDK_OFFSET(0x95FB500)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT_PARTNERMODTRUSTTYPETOTYPE_OFFSET UNITYSDK_OFFSET(0x95FB5C0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT_SET_CURTRUSTLEVEL_OFFSET UNITYSDK_OFFSET(0x95FB530)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT_SET_MODTRUSTTYPE_OFFSET UNITYSDK_OFFSET(0x95FB570)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT_SET_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x95FB550)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT_SET_PARTNERID_OFFSET UNITYSDK_OFFSET(0x95FB510)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x95FB5A0)
#define MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x95FB580)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralIntimacyUpPopWindowController_Context_TypeDefinitionIndex = 39705;
	...
	public:
		...
		::System::Void _ctor_1(::Class_3_AE02BC8285203464_5* lastInfo, ::System::Action* onClose)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_AE02BC8285203464_5*, ::System::Action*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT__CTOR_1_OFFSET))(this, lastInfo, onClose);
		}
		...
		static ::MoleMole::UIGeneralIntimacyUpPopWindowController_Context_Type PartnerModTrustTypeToType(::Enum_3_DB663931210BBC27_14 partnerModTrustType)
		{
			return ((::MoleMole::UIGeneralIntimacyUpPopWindowController_Context_Type(*)(::Enum_3_DB663931210BBC27_14))((::PBYTE)hIl2Cpp + MOLEMOLE_UIGENERALINTIMACYUPPOPWINDOWCONTROLLER_CONTEXT_PARTNERMODTRUSTTYPETOTYPE_OFFSET))(partnerModTrustType);
		}
	};
}
