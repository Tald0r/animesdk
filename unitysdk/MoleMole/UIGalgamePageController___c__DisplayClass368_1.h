...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS368_1__CTOR_OFFSET UNITYSDK_OFFSET(0xA295250)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS368_1__SETAVATARNEW_B__3_OFFSET UNITYSDK_OFFSET(0xA295260)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass368_1_TypeDefinitionIndex = 54703;
