...
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER_APPLYCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0x806B8B0)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x806B810)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0x806B1B0)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x806C4E0)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x806AE20)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x806B0E0)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER_SHOWAVATARININDEX_1_OFFSET UNITYSDK_OFFSET(0x806B990)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER_SHOWAVATARININDEX_OFFSET UNITYSDK_OFFSET(0x806B600)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x806C570)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x806C810)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x806C880)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x806C890)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x806C8A0)
#define MOLEMOLE_UICOOPTEAM3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x806C8B0)

namespace MoleMole
{
	inline static constexpr unsigned int UICoopTeam3DModelController_TypeDefinitionIndex = 41716;
	...
	public:
		...
		::Class_2_B45E2E8C41ADEEB6* _view; // 0x348
