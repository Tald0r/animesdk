...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWNPCPUSHBACK_GETPUSHINTERVAL_OFFSET UNITYSDK_OFFSET(0x624E6C0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWNPCPUSHBACK_GETPUSHSTARTDELAY_OFFSET UNITYSDK_OFFSET(0x624E640)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWNPCPUSHBACK_GETSPRINGPUSHTRIGGERKEY_OFFSET UNITYSDK_OFFSET(0x624E740)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWNPCPUSHBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x624E7E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowNpcPushBack_TypeDefinitionIndex = 67645;
