...
#define MOLEMOLE_CONFIG_WEAPONMODEGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xEC57C40)
#define MOLEMOLE_CONFIG_WEAPONMODEGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xEC57D20)
#define MOLEMOLE_CONFIG_WEAPONMODEGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xEC57D30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int WeaponModeGamepadTriggerEffectEntry_TypeDefinitionIndex = 54318;
