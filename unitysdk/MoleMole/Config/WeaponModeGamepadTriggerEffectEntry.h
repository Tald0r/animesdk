...
#define MOLEMOLE_CONFIG_WEAPONMODEGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xF177550)
#define MOLEMOLE_CONFIG_WEAPONMODEGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xF177630)
#define MOLEMOLE_CONFIG_WEAPONMODEGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xF177640)

namespace MoleMole::Config
{
	inline static constexpr unsigned int WeaponModeGamepadTriggerEffectEntry_TypeDefinitionIndex = 41034;
