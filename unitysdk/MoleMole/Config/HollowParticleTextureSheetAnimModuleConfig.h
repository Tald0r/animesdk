...
#define MOLEMOLE_CONFIG_HOLLOWPARTICLETEXTURESHEETANIMMODULECONFIG_CREATEMODULE_OFFSET UNITYSDK_OFFSET(0xEC50220)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLETEXTURESHEETANIMMODULECONFIG_GETMODULEID_OFFSET UNITYSDK_OFFSET(0xEC503A0)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLETEXTURESHEETANIMMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xEC504A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowParticleTextureSheetAnimModuleConfig_TypeDefinitionIndex = 45384;
