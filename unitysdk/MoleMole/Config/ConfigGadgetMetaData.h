...
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xE2C52F0)
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0xE2C5280)
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA_METHOD_1_9B00DC6B301F3F39_OFFSET UNITYSDK_OFFSET(0xE2C5300)
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA_METHOD_1_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0xE2C52E0)
#define MOLEMOLE_CONFIG_CONFIGGADGETMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE2C5310)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGadgetMetaData_TypeDefinitionIndex = 54020;
