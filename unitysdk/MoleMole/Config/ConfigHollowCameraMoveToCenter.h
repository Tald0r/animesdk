...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCAMERAMOVETOCENTER__CTOR_OFFSET UNITYSDK_OFFSET(0x6552180)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowCameraMoveToCenter_TypeDefinitionIndex = 39505;
