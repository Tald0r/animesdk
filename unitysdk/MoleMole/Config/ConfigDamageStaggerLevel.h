...
#define MOLEMOLE_CONFIG_CONFIGDAMAGESTAGGERLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCAE3CC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDamageStaggerLevel_TypeDefinitionIndex = 74381;
