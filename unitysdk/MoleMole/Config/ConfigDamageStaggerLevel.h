...
#define MOLEMOLE_CONFIG_CONFIGDAMAGESTAGGERLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0x62B3010)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDamageStaggerLevel_TypeDefinitionIndex = 71880;
