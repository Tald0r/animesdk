...
#define MOLEMOLE_CONFIG_ANIMREPLICATIONTRAIT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x9CE7070)
#define MOLEMOLE_CONFIG_ANIMREPLICATIONTRAIT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x9CE6FC0)
#define MOLEMOLE_CONFIG_ANIMREPLICATIONTRAIT_METHOD_2_1D2F15E1636AC595_OFFSET UNITYSDK_OFFSET(0x9CE6D90)
#define MOLEMOLE_CONFIG_ANIMREPLICATIONTRAIT_METHOD_2_2C1CDBD449C1FB0D_OFFSET UNITYSDK_OFFSET(0x9CE7220)
#define MOLEMOLE_CONFIG_ANIMREPLICATIONTRAIT_METHOD_2_3A09D897EF162520_OFFSET UNITYSDK_OFFSET(0x9CE7400)
#define MOLEMOLE_CONFIG_ANIMREPLICATIONTRAIT_METHOD_2_969A80C882053A6C_OFFSET UNITYSDK_OFFSET(0x9CE7100)
#define MOLEMOLE_CONFIG_ANIMREPLICATIONTRAIT_METHOD_2_A042C46DE73C3043_OFFSET UNITYSDK_OFFSET(0x9CE6D80)
#define MOLEMOLE_CONFIG_ANIMREPLICATIONTRAIT_METHOD_2_B525722F60E6B94F_OFFSET UNITYSDK_OFFSET(0x9CE6E90)
#define MOLEMOLE_CONFIG_ANIMREPLICATIONTRAIT_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x9CE7040)
#define MOLEMOLE_CONFIG_ANIMREPLICATIONTRAIT_POSTBUILDENTITYCOMPONENT_OFFSET UNITYSDK_OFFSET(0x9CE7160)
#define MOLEMOLE_CONFIG_ANIMREPLICATIONTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x9CE7210)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimReplicationTrait_TypeDefinitionIndex = 49205;
