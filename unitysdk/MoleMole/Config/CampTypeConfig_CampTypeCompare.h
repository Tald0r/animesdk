...
#define MOLEMOLE_CONFIG_CAMPTYPECONFIG_CAMPTYPECOMPARE_EQUALS_OFFSET UNITYSDK_OFFSET(0x71A120)
#define MOLEMOLE_CONFIG_CAMPTYPECONFIG_CAMPTYPECOMPARE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x71A1A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CampTypeConfig_CampTypeCompare_TypeDefinitionIndex = 50260;
