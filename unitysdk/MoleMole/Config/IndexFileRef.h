...
#define MOLEMOLE_CONFIG_INDEXFILEREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC42E20)
#define MOLEMOLE_CONFIG_INDEXFILEREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0xEC42A40)
#define MOLEMOLE_CONFIG_INDEXFILEREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0xEC43080)
#define MOLEMOLE_CONFIG_INDEXFILEREF_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0xEC42AC0)
#define MOLEMOLE_CONFIG_INDEXFILEREF_METHOD_1_FE68BBC7DCCBEB6D_OFFSET UNITYSDK_OFFSET(0xEC42E80)
#define MOLEMOLE_CONFIG_INDEXFILEREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0xEC42630)
#define MOLEMOLE_CONFIG_INDEXFILEREF__CTOR_OFFSET UNITYSDK_OFFSET(0xEC43070)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexFileRef_TypeDefinitionIndex = 36737;
