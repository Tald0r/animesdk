...
#define MOLEMOLE_CONFIG_CONFIGSHOWGACHAPERFORMANCELIGHTSNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCD12D50)
#define MOLEMOLE_CONFIG_CONFIGSHOWGACHAPERFORMANCELIGHTSNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD12DE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigShowGachaPerformanceLightsNode_TypeDefinitionIndex = 62711;
