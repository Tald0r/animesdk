...
#define MOLEMOLE_CONFIG_CONFIGHOTPOTFORCEFIELDS_GETCONFIGBYKEY_OFFSET UNITYSDK_OFFSET(0xF2CF0F0)
#define MOLEMOLE_CONFIG_CONFIGHOTPOTFORCEFIELDS__CTOR_OFFSET UNITYSDK_OFFSET(0xF2CF210)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHotPotForceFields_TypeDefinitionIndex = 77752;
