...
#define MOLEMOLE_CONFIG_HOLLOWCAMERASIMPLEVALUECOMPAREPREDICATE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x8A0EEA0)
#define MOLEMOLE_CONFIG_HOLLOWCAMERASIMPLEVALUECOMPAREPREDICATE_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x8A0EFC0)
#define MOLEMOLE_CONFIG_HOLLOWCAMERASIMPLEVALUECOMPAREPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x8A0F0C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowCameraSimpleValueComparePredicate_TypeDefinitionIndex = 53625;
