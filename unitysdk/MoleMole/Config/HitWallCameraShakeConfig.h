...
#define MOLEMOLE_CONFIG_HITWALLCAMERASHAKECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xF171140)
#define MOLEMOLE_CONFIG_HITWALLCAMERASHAKECONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0xF171370)
#define MOLEMOLE_CONFIG_HITWALLCAMERASHAKECONFIG_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF1711A0)
#define MOLEMOLE_CONFIG_HITWALLCAMERASHAKECONFIG_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xF1713F0)
#define MOLEMOLE_CONFIG_HITWALLCAMERASHAKECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xF171780)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HitWallCameraShakeConfig_TypeDefinitionIndex = 48451;
