...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDSTARTLIGHTUPNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xC343360)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDSTARTLIGHTUPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC343440)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardStartLightUpNode_TypeDefinitionIndex = 49488;
