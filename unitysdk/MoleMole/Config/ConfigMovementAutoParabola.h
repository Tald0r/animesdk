...
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_CLONE_OFFSET UNITYSDK_OFFSET(0x84AACC0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x84AAC30)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x84AC540)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x84AAED0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x84AADA0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x84AC5A0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x84AAF50)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x84ACAA0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x84AC3E0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_PROCESSRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x84A9E80)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x84AA030)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA__CTOR_OFFSET UNITYSDK_OFFSET(0x84ACC50)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA___BASE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x84ACC60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMovementAutoParabola_TypeDefinitionIndex = 53577;

	class ConfigMovementAutoParabola : public ::MoleMole::Config::ConfigMovement
	{
	public:
		::MoleMole::Config::ConfigPosRot* TargetPosRot; // 0x38
		::System::Single MinAngle; // 0x40
		::System::Single ExpectTime; // 0x44
		::System::Single TargetRotLimitAngleRight; // 0x48
		::System::Single Accelerated; // 0x4C
		::System::Single ExpectSpeed; // 0x50
		::System::Single MinSpeed; // 0x54
		::System::Single MaxSpeed; // 0x58
		::UnityEngine::Vector3 DefaultOffset; // 0x5C
		::System::Single DefaultRotAngle; // 0x68
		::System::Single MaxAngle; // 0x6C
		::System::Single TargetRotLimitAngleLeft; // 0x70
		::System::Int32 ExpectAngle; // 0x74
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_F35B080B137ECC46*, ::Class_3_248DACE3BB3053DD*, ::System::Single, ::System::Single, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGMOVEMENTAUTOPARABOLA_PROCESSRIGIDBODY_OFFSET))(this, modelComponent, movementComponent, deltaTime, timeScale, instancedAbility);
		}
