...
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZEANDSECTION_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC22B930)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZEANDSECTION_PASS_OFFSET UNITYSDK_OFFSET(0xC22B740)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZEANDSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xC22B940)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraStoryDataActiveConditionByBodySizeAndSection_TypeDefinitionIndex = 43658;
