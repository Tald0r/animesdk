...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_CLONE_OFFSET UNITYSDK_OFFSET(0xACBFA00)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xACBF9B0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xACC00A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0xACBFC30)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xACBFB00)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xACC0100)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xACBFCB0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xACC02A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xACBFF40)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0xACBF830)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTANIMATORTRIGGERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xACC0450)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListAnimatorTriggerParam_TypeDefinitionIndex = 72882;
