...
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCB05DB0)
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCB05DC0)
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCB05FC0)
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCB06180)
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCB06140)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TagLibraryConfig_TagLibraryConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 41217;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::System::String*>*>*>**)Il2CppClass::FromTypeDefinitionIndex(TagLibraryConfig_TagLibraryConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x45DD0);
		}
