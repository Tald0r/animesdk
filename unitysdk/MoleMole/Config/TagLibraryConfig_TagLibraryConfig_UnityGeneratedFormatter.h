...
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xEC48C30)
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xEC48C40)
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xEC48E40)
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xEC49000)
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG_TAGLIBRARYCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xEC48FC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TagLibraryConfig_TagLibraryConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 52542;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::List_1<::System::String*>*>*>**)Il2CppClass::FromTypeDefinitionIndex(TagLibraryConfig_TagLibraryConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43400);
		}
