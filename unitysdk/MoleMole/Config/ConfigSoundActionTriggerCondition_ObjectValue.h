...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_OBJECTVALUE_EVALUATE_OFFSET UNITYSDK_OFFSET(0xC23CD40)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_OBJECTVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xC23D130)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundActionTriggerCondition_ObjectValue_TypeDefinitionIndex = 68845;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_0_16E4307DCC419505_148*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_OBJECTVALUE_EVALUATE_OFFSET))(this, a1);
		}
	};
}
