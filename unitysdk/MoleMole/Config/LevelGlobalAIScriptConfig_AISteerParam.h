...
#define MOLEMOLE_CONFIG_LEVELGLOBALAISCRIPTCONFIG_AISTEERPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x80633D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelGlobalAIScriptConfig_AISteerParam_TypeDefinitionIndex = 50506;
