...
#define MOLEMOLE_CONFIG_CONFIGWAITINLEVELPOPNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xB479E00)
#define MOLEMOLE_CONFIG_CONFIGWAITINLEVELPOPNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB479E90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigWaitInLevelPopNode_TypeDefinitionIndex = 42450;
