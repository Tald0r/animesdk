...
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CONFIGACTIVITYLIVEHOUSERHYTHM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCCFB6E0)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CONFIGACTIVITYLIVEHOUSERHYTHM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCCFB6F0)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CONFIGACTIVITYLIVEHOUSERHYTHM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCCFB8F0)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CONFIGACTIVITYLIVEHOUSERHYTHM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCCFBAB0)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CONFIGACTIVITYLIVEHOUSERHYTHM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCCFBA70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigActivityLiveHouseRhythm_ConfigActivityLiveHouseRhythm_UnityGeneratedFormatter_TypeDefinitionIndex = 77698;
