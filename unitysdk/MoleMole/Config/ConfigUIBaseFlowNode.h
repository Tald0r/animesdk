...
#define MOLEMOLE_CONFIG_CONFIGUIBASEFLOWNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x139A48B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIBaseFlowNode_TypeDefinitionIndex = 54708;
