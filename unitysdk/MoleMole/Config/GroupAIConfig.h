...
#define MOLEMOLE_CONFIG_GROUPAICONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x6253100)
#define MOLEMOLE_CONFIG_GROUPAICONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x6252B10)
#define MOLEMOLE_CONFIG_GROUPAICONFIG_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x6252B90)
#define MOLEMOLE_CONFIG_GROUPAICONFIG_METHOD_1_C68CB15A07D0E2EF_OFFSET UNITYSDK_OFFSET(0x6253160)
#define MOLEMOLE_CONFIG_GROUPAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6253460)

namespace MoleMole::Config
{
	inline static constexpr unsigned int GroupAIConfig_TypeDefinitionIndex = 41830;
