...
#define MOLEMOLE_CONFIG_GROUPAICONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xC240B70)
#define MOLEMOLE_CONFIG_GROUPAICONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0xC240580)
#define MOLEMOLE_CONFIG_GROUPAICONFIG_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0xC240600)
#define MOLEMOLE_CONFIG_GROUPAICONFIG_METHOD_1_C68CB15A07D0E2EF_OFFSET UNITYSDK_OFFSET(0xC240BD0)
#define MOLEMOLE_CONFIG_GROUPAICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC240ED0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int GroupAIConfig_TypeDefinitionIndex = 72800;
