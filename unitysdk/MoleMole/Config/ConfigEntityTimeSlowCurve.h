...
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWCURVE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x62486E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x62486F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityTimeSlowCurve_TypeDefinitionIndex = 49745;
