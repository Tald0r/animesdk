...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWPLAYER_CONFIGHOLLOWPLAYER_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x624E810)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWPLAYER_CONFIGHOLLOWPLAYER_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x624E820)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWPLAYER_CONFIGHOLLOWPLAYER_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x624EB10)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWPLAYER_CONFIGHOLLOWPLAYER_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x624ED60)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWPLAYER_CONFIGHOLLOWPLAYER_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x624ED20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowPlayer_ConfigHollowPlayer_UnityGeneratedFormatter_TypeDefinitionIndex = 70610;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigAutoMoveMode>**)Il2CppClass::FromTypeDefinitionIndex(ConfigHollowPlayer_ConfigHollowPlayer_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44840);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigMedalGuide>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigMedalGuide>**)Il2CppClass::FromTypeDefinitionIndex(ConfigHollowPlayer_ConfigHollowPlayer_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44848);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigHollowPlayerMove*>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigHollowPlayerMove*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigHollowPlayer_ConfigHollowPlayer_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44850);
		}
