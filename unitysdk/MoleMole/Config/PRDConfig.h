...
#define MOLEMOLE_CONFIG_PRDCONFIG_CALACPRD_OFFSET UNITYSDK_OFFSET(0x10AA8C00)
#define MOLEMOLE_CONFIG_PRDCONFIG_CFROMP_OFFSET UNITYSDK_OFFSET(0x10AA8D90)
#define MOLEMOLE_CONFIG_PRDCONFIG_PFROMC_OFFSET UNITYSDK_OFFSET(0x10AA90D0)
#define MOLEMOLE_CONFIG_PRDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x10AA9260)

namespace MoleMole::Config
{
	inline static constexpr unsigned int PRDConfig_TypeDefinitionIndex = 72912;
