...
#define MOLEMOLE_CONFIG_PRDCONFIG_CALACPRD_OFFSET UNITYSDK_OFFSET(0xE0C1D20)
#define MOLEMOLE_CONFIG_PRDCONFIG_CFROMP_OFFSET UNITYSDK_OFFSET(0xE0C1EB0)
#define MOLEMOLE_CONFIG_PRDCONFIG_PFROMC_OFFSET UNITYSDK_OFFSET(0xE0C21F0)
#define MOLEMOLE_CONFIG_PRDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE0C2380)

namespace MoleMole::Config
{
	inline static constexpr unsigned int PRDConfig_TypeDefinitionIndex = 55355;
