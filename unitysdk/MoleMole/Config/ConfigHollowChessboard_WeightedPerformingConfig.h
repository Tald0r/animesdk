...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_WEIGHTEDPERFORMINGCONFIG_CUSTOMADDFUNCTION_OFFSET UNITYSDK_OFFSET(0x13999510)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_WEIGHTEDPERFORMINGCONFIG_GETRANDOMPERFORMINGKEY_OFFSET UNITYSDK_OFFSET(0x13999590)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_WEIGHTEDPERFORMINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x139997D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_WeightedPerformingConfig_TypeDefinitionIndex = 59153;
