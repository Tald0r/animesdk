...
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAIBTREEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x9501280)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAIBTREEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x9500B10)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAIBTREEDATA_METHOD_1_C7F9ED430E054F62_OFFSET UNITYSDK_OFFSET(0x95012E0)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAIBTREEDATA_METHOD_1_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x9500B90)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAIBTREEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x95018C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelGlobalAIBTreeData_TypeDefinitionIndex = 45579;
