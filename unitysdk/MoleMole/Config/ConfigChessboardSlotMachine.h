...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDSLOTMACHINE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x9188670)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDSLOTMACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0x9188750)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardSlotMachine_TypeDefinitionIndex = 67656;
	...
	public:
		...
		::System::Int32 PieceAudioID; // 0x30
		::System::Int32 EndPieceAudioID; // 0x34
		::System::Single PieceDurationMax; // 0x38
		::System::Single RandomRange; // 0x3C
