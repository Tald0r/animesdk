...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDSLOTMACHINE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x13996340)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDSLOTMACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0x13996420)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardSlotMachine_TypeDefinitionIndex = 58761;

	class ConfigChessboardSlotMachine : public ::MoleMole::Config::ConfigUIBaseActionNode
	{
	public:
		::System::String* PieceEffectPath; // 0x18
		::UnityEngine::AnimationCurve* SpeedCurve; // 0x20
		::System::String* EndPieceEffectPath; // 0x28
		::System::Single PieceDurationMin; // 0x30
		::System::Single PieceDurationMax; // 0x34
