...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDCAMERA_GETCAMERASTRETCHV2_OFFSET UNITYSDK_OFFSET(0xEC42040)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xEC421D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboardCamera_TypeDefinitionIndex = 73548;
