...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDCAMERA_GETCAMERASTRETCHV2_OFFSET UNITYSDK_OFFSET(0xC348870)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xC348A00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboardCamera_TypeDefinitionIndex = 36873;
