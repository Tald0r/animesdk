...
#define MOLEMOLE_CONFIG_CONFIGCAPSULECOLLIDER_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x13F8D4A0)
#define MOLEMOLE_CONFIG_CONFIGCAPSULECOLLIDER_CLEAN_OFFSET UNITYSDK_OFFSET(0x13F8D6B0)
#define MOLEMOLE_CONFIG_CONFIGCAPSULECOLLIDER_DEALLOCATE_OFFSET UNITYSDK_OFFSET(0x13F8D550)
#define MOLEMOLE_CONFIG_CONFIGCAPSULECOLLIDER_GETCOLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0x13F8D7E0)
#define MOLEMOLE_CONFIG_CONFIGCAPSULECOLLIDER_GETLAYERMASK_OFFSET UNITYSDK_OFFSET(0x13F8D840)
#define MOLEMOLE_CONFIG_CONFIGCAPSULECOLLIDER_GETPREFABNAME_OFFSET UNITYSDK_OFFSET(0x13F8D740)
#define MOLEMOLE_CONFIG_CONFIGCAPSULECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x13F8D8F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCapsuleCollider_TypeDefinitionIndex = 40332;
