...
#define MOLEMOLE_CONFIG_CONFIGENTITYFILTERLOGIC_VALUEPASS_OFFSET UNITYSDK_OFFSET(0xEC29E70)
#define MOLEMOLE_CONFIG_CONFIGENTITYFILTERLOGIC__CTOR_OFFSET UNITYSDK_OFFSET(0xEC2A060)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityFilterLogic_TypeDefinitionIndex = 44653;
