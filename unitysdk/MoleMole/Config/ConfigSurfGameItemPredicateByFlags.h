...
#define MOLEMOLE_CONFIG_CONFIGSURFGAMEITEMPREDICATEBYFLAGS_PREDICATE_OFFSET UNITYSDK_OFFSET(0xF16E750)
#define MOLEMOLE_CONFIG_CONFIGSURFGAMEITEMPREDICATEBYFLAGS__CTOR_OFFSET UNITYSDK_OFFSET(0xF16E880)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSurfGameItemPredicateByFlags_TypeDefinitionIndex = 36511;
