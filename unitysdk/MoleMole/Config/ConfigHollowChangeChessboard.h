...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGECHESSBOARD_GET_DEFAULTKEY_OFFSET UNITYSDK_OFFSET(0xCD07210)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGECHESSBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xCD07250)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChangeChessboard_TypeDefinitionIndex = 55932;
