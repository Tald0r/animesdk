...
#define MOLEMOLE_CONFIG_OFFMODEGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xCDBF220)
#define MOLEMOLE_CONFIG_OFFMODEGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xCDBF2D0)
#define MOLEMOLE_CONFIG_OFFMODEGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xCDBF2E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int OffModeGamepadTriggerEffectEntry_TypeDefinitionIndex = 37717;
