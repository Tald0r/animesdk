...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_DELAYACTION___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE4346C0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_DELAYACTION___C__DISPLAYCLASS5_0__EXECUTEANDENDSCOPE_B__0_OFFSET UNITYSDK_OFFSET(0xE4346D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_DelayAction___c__DisplayClass5_0_TypeDefinitionIndex = 58220;

	class ConfigSoundAction_DelayAction___c__DisplayClass5_0 : public ::System::Object
	{
	public:
		::Class_0_16E4307DCC419505_168* context; // 0x10
