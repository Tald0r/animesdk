...
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_CLONE_OFFSET UNITYSDK_OFFSET(0x804D290)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x804D240)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x804D8A0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x804D4C0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x804D390)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x804D900)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x804D540)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x804DA90)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x804D740)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x804D0C0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTGAMEPLAYTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x804DC40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynmaicValueListGameplayTag_TypeDefinitionIndex = 64602;
