...
#define MOLEMOLE_CONFIG_CONFIGENTITYOLDCRTEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0xCD043B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityOldCRTEffects_TypeDefinitionIndex = 75414;
