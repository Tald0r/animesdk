...
#define MOLEMOLE_CONFIG_DYNAMICSTRING_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x15EBFDF0)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_FROMFLX_OFFSET UNITYSDK_OFFSET(0x15EBFA10)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_FROMJSON_OFFSET UNITYSDK_OFFSET(0x15EBFB40)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_GET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x15EBF9D0)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_GET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x15EBF9F0)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x15EBF9B0)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_SET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x15EBF9E0)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_SET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x15EBFA00)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x15EBF9C0)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_TOJSON_OFFSET UNITYSDK_OFFSET(0x15EBFCB0)
#define MOLEMOLE_CONFIG_DYNAMICSTRING__CCTOR_OFFSET UNITYSDK_OFFSET(0x15EC0090)
#define MOLEMOLE_CONFIG_DYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x15EC0080)

namespace MoleMole::Config
{
	inline static constexpr unsigned int DynamicString_TypeDefinitionIndex = 56994;
	...
	public:
		...
		{
			return (::MoleMole::Config::ReadonlyDynamicString**)Il2CppClass::FromTypeDefinitionIndex(DynamicString_TypeDefinitionIndex)->GetStaticField(0x31F20);
		}
