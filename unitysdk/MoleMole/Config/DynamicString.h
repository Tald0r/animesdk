...
#define MOLEMOLE_CONFIG_DYNAMICSTRING_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xE297D40)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_FROMFLX_OFFSET UNITYSDK_OFFSET(0xE297C10)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_FROMJSON_OFFSET UNITYSDK_OFFSET(0xE2D20A0)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_GET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0xE2D2060)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_GET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0xE2D2080)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0xE2D2040)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_SET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0xE2D2070)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_SET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0xE2D2090)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0xE2D2050)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_TOJSON_OFFSET UNITYSDK_OFFSET(0xE2D2210)
#define MOLEMOLE_CONFIG_DYNAMICSTRING__CCTOR_OFFSET UNITYSDK_OFFSET(0xE2D2350)
#define MOLEMOLE_CONFIG_DYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0xE297C00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int DynamicString_TypeDefinitionIndex = 51897;
	...
	public:
		...
		{
			return (::MoleMole::Config::ReadonlyDynamicString**)Il2CppClass::FromTypeDefinitionIndex(DynamicString_TypeDefinitionIndex)->GetStaticField(0x33D90);
		}
