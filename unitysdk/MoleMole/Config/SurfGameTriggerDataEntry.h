...
#define MOLEMOLE_CONFIG_SURFGAMETRIGGERDATAENTRY_ISVALID_OFFSET UNITYSDK_OFFSET(0x7079B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SurfGameTriggerDataEntry_TypeDefinitionIndex = 57280;
