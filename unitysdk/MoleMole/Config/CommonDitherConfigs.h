...
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xC22C480)
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xC22BD90)
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0xC22CD00)
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xC22CFB0)
#define MOLEMOLE_CONFIG_COMMONDITHERCONFIGS___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xC22CFC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CommonDitherConfigs_TypeDefinitionIndex = 51558;
