...
#define MOLEMOLE_CONFIG_CONFIGUIBASEACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD00260)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIBaseActionNode_TypeDefinitionIndex = 56602;
