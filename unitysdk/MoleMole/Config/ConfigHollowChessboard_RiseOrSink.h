...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x139993D0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x139993C0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK_RUN_OFFSET UNITYSDK_OFFSET(0x139991F0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK__CTOR_OFFSET UNITYSDK_OFFSET(0x13999490)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_RISEORSINK___BASE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x139994A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_RiseOrSink_TypeDefinitionIndex = 59097;
