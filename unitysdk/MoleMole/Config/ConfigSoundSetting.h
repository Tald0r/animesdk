...
#define MOLEMOLE_CONFIG_CONFIGSOUNDSETTING_GET_SYSTEMSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0xEC3A610)
#define MOLEMOLE_CONFIG_CONFIGSOUNDSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xEC3A620)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundSetting_TypeDefinitionIndex = 75367;
