...
#define MOLEMOLE_CONFIG_SCENEPERFORMCONFIG_SCENEPERFORMITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x15EC9A00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ScenePerformConfig_ScenePerformItem_TypeDefinitionIndex = 78782;
