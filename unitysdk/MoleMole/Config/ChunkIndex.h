...
#define MOLEMOLE_CONFIG_CHUNKINDEX_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xC341070)
#define MOLEMOLE_CONFIG_CHUNKINDEX_FROMFLX_OFFSET UNITYSDK_OFFSET(0xC340C70)
#define MOLEMOLE_CONFIG_CHUNKINDEX_METHOD_1_0CB3D614A4DB34A1_OFFSET UNITYSDK_OFFSET(0xC340CF0)
#define MOLEMOLE_CONFIG_CHUNKINDEX_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0xC341310)
#define MOLEMOLE_CONFIG_CHUNKINDEX_METHOD_1_8F38D1E0FC0C448C_OFFSET UNITYSDK_OFFSET(0xC3410D0)
#define MOLEMOLE_CONFIG_CHUNKINDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC340870)
#define MOLEMOLE_CONFIG_CHUNKINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xC341300)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ChunkIndex_TypeDefinitionIndex = 38190;
