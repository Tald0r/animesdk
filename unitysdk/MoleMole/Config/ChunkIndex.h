...
#define MOLEMOLE_CONFIG_CHUNKINDEX_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC3A760)
#define MOLEMOLE_CONFIG_CHUNKINDEX_FROMFLX_OFFSET UNITYSDK_OFFSET(0xEC3A360)
#define MOLEMOLE_CONFIG_CHUNKINDEX_METHOD_1_0CB3D614A4DB34A1_OFFSET UNITYSDK_OFFSET(0xEC3A3E0)
#define MOLEMOLE_CONFIG_CHUNKINDEX_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0xEC3AA00)
#define MOLEMOLE_CONFIG_CHUNKINDEX_METHOD_1_8F38D1E0FC0C448C_OFFSET UNITYSDK_OFFSET(0xEC3A7C0)
#define MOLEMOLE_CONFIG_CHUNKINDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0xEC39F60)
#define MOLEMOLE_CONFIG_CHUNKINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0xEC3A9F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ChunkIndex_TypeDefinitionIndex = 46404;
