...
#define MOLEMOLE_CONFIG_CONFIGSETCAMERASTATECOMMONNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCAF3690)
#define MOLEMOLE_CONFIG_CONFIGSETCAMERASTATECOMMONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCAF3720)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSetCameraStateCommonNode_TypeDefinitionIndex = 43184;

	class ConfigSetCameraStateCommonNode : public ::MoleMole::Config::ConfigUIBaseActionNode
	{
	public:
		::MoleMole::Config::Vector3UISpecialNum* Position; // 0x18
		::MoleMole::Config::AnimationCurveUISpecialNum* BlendCurvePositionZ; // 0x20
		::MoleMole::Config::BoolUISpecialNum* IsCut; // 0x28
		::MoleMole::Config::FloatUISpecialNum* FOV; // 0x30
		::MoleMole::Config::AnimationCurveUISpecialNum* BlendCurveRotationZ; // 0x38
		::MoleMole::Config::Vector3UISpecialNum* Rotation; // 0x40
		...
		::MoleMole::Config::AnimationCurveUISpecialNum* BlendCurveRotationY; // 0x78
