...
#define MOLEMOLE_CONFIG_ANIMATOREVENTMODIFYSKILLCDPAUSESTATEENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x84955F0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTMODIFYSKILLCDPAUSESTATEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x84956E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventModifySkillCdPauseStateEntry_TypeDefinitionIndex = 51655;
