...
#define MOLEMOLE_CONFIG_SCENEPERFORMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9198A40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ScenePerformConfig_TypeDefinitionIndex = 55543;
