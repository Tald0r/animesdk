...
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x139A6390)
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x139A5FB0)
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA_METHOD_1_25996F1180FB0C28_OFFSET UNITYSDK_OFFSET(0x139A63F0)
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x139A6030)
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x139A66A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneMapLayerRuntimeData_TypeDefinitionIndex = 61799;
