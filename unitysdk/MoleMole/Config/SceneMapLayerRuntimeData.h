...
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x9198720)
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x9198340)
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA_METHOD_1_25996F1180FB0C28_OFFSET UNITYSDK_OFFSET(0x9198780)
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x91983C0)
#define MOLEMOLE_CONFIG_SCENEMAPLAYERRUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9198A30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneMapLayerRuntimeData_TypeDefinitionIndex = 66894;
