...
#define MOLEMOLE_CONFIG_STAGEENTRYMODESCENE__CTOR_OFFSET UNITYSDK_OFFSET(0xCCAC670)

namespace MoleMole::Config
{
	inline static constexpr unsigned int StageEntryModeScene_TypeDefinitionIndex = 41005;
	...
	public:
		...
		::System::String* locationPointName; // 0x28
