...
#define MOLEMOLE_CONFIG_CONFIGFLOWERSHOPACTIVITYSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x6551800)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFlowerShopActivityScriptableObject_TypeDefinitionIndex = 52931;
