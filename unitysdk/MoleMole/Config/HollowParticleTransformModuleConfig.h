...
#define MOLEMOLE_CONFIG_HOLLOWPARTICLETRANSFORMMODULECONFIG_CREATEMODULE_OFFSET UNITYSDK_OFFSET(0xD7C63B0)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLETRANSFORMMODULECONFIG_GETMODULEID_OFFSET UNITYSDK_OFFSET(0xD7C64C0)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLETRANSFORMMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD7C65C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowParticleTransformModuleConfig_TypeDefinitionIndex = 54588;
