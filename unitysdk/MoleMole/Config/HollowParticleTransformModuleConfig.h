...
#define MOLEMOLE_CONFIG_HOLLOWPARTICLETRANSFORMMODULECONFIG_CREATEMODULE_OFFSET UNITYSDK_OFFSET(0xE4407D0)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLETRANSFORMMODULECONFIG_GETMODULEID_OFFSET UNITYSDK_OFFSET(0xE4408E0)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLETRANSFORMMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE4409E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowParticleTransformModuleConfig_TypeDefinitionIndex = 44021;
