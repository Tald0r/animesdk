...
#define MOLEMOLE_CONFIG_SKINPREVIEWDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC247640)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SkinPreviewData_TypeDefinitionIndex = 59870;
