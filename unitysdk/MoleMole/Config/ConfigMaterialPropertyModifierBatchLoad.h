...
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYMODIFIERBATCHLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0xE361FA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMaterialPropertyModifierBatchLoad_TypeDefinitionIndex = 60305;
