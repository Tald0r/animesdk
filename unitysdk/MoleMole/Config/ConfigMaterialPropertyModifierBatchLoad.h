...
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYMODIFIERBATCHLOAD__CTOR_OFFSET UNITYSDK_OFFSET(0xCD09AF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMaterialPropertyModifierBatchLoad_TypeDefinitionIndex = 45394;
