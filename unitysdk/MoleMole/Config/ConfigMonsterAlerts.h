...
#define MOLEMOLE_CONFIG_CONFIGMONSTERALERTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1399C8B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMonsterAlerts_TypeDefinitionIndex = 49251;
