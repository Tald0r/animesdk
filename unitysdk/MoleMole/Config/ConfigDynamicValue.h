...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUE_CLONE_OFFSET UNITYSDK_OFFSET(0xC231830)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUE_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xC231820)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xC231BA0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUE_FROMFLX_OFFSET UNITYSDK_OFFSET(0xC231A60)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUE_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xC2317C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUE_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xC231930)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUE_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xC231BB0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUE_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xC231AC0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUE_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xC231BC0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUE_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xC231AD0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUE__CCTOR_OFFSET UNITYSDK_OFFSET(0xC231D20)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xC231D10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValue_TypeDefinitionIndex = 73628;
	...
	public:
		...
		{
			return (::MoleMole::Config::ConfigDynamicValue**)Il2CppClass::FromTypeDefinitionIndex(ConfigDynamicValue_TypeDefinitionIndex)->GetStaticField(0x2F4B0);
		}
