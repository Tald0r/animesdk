...
#define MOLEMOLE_CONFIG_CONFIGPLAYATMOSPHEREPLUGINCHANGE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xB4764C0)
#define MOLEMOLE_CONFIG_CONFIGPLAYATMOSPHEREPLUGINCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xB4765A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayAtmospherePluginChange_TypeDefinitionIndex = 52317;
