...
#define MOLEMOLE_CONFIG_CONFIGPLAYATMOSPHEREPLUGINCHANGE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xE822210)
#define MOLEMOLE_CONFIG_CONFIGPLAYATMOSPHEREPLUGINCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0xE8222F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayAtmospherePluginChange_TypeDefinitionIndex = 58022;
