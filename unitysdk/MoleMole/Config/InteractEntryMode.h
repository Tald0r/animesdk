...
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0x141965F0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_CHECKVALUECONTENT_OFFSET UNITYSDK_OFFSET(0x14196650)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_GETEFFINTERACTRANGE_OFFSET UNITYSDK_OFFSET(0x14196580)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_GET_ACTIONLIST_OFFSET UNITYSDK_OFFSET(0x14196540)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_GET_ISSUPPORTREPEAT_OFFSET UNITYSDK_OFFSET(0x14196B70)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_GET_VALUELIST_OFFSET UNITYSDK_OFFSET(0x14196560)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_INITACTIONLIST_OFFSET UNITYSDK_OFFSET(0x141966B0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_INITVALUELIST_OFFSET UNITYSDK_OFFSET(0x141967F0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_SETACTION_OFFSET UNITYSDK_OFFSET(0x14196930)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x14196A50)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x14196B80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int InteractEntryMode_TypeDefinitionIndex = 42323;
