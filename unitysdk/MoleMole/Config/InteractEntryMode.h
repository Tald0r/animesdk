...
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0xBB03D00)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_CHECKVALUECONTENT_OFFSET UNITYSDK_OFFSET(0xBB03D60)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_GETEFFINTERACTRANGE_OFFSET UNITYSDK_OFFSET(0xBB03C90)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_GET_ACTIONLIST_OFFSET UNITYSDK_OFFSET(0xBB03C50)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_GET_ISSUPPORTREPEAT_OFFSET UNITYSDK_OFFSET(0xBB04280)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_GET_VALUELIST_OFFSET UNITYSDK_OFFSET(0xBB03C70)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_INITACTIONLIST_OFFSET UNITYSDK_OFFSET(0xBB03DC0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_INITVALUELIST_OFFSET UNITYSDK_OFFSET(0xBB03F00)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_SETACTION_OFFSET UNITYSDK_OFFSET(0xBB04040)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_SETVALUE_OFFSET UNITYSDK_OFFSET(0xBB04160)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE__CTOR_OFFSET UNITYSDK_OFFSET(0xBB04290)

namespace MoleMole::Config
{
	inline static constexpr unsigned int InteractEntryMode_TypeDefinitionIndex = 38626;
