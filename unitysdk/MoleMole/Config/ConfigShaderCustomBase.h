...
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE_GETSTATE_OFFSET UNITYSDK_OFFSET(0xE2CDDD0)
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE_GET_DURATIONBEFOREEXIT_OFFSET UNITYSDK_OFFSET(0xE2CDC60)
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xE2CDBF0)
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE_PROCESS_OFFSET UNITYSDK_OFFSET(0xE2CDC70)
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE_SAVEEVALUATE_1_OFFSET UNITYSDK_OFFSET(0xE2CDF00)
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE_SAVEEVALUATE_OFFSET UNITYSDK_OFFSET(0xE2CDE60)
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xE2CDFB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigShaderCustomBase_TypeDefinitionIndex = 65608;

	class ConfigShaderCustomBase : public ::System::Object
	{
	public:
		::System::Single OneTimeLoopDuration; // 0x10
		::System::Single EnterDuration; // 0x14
		::System::Single ExitDuration; // 0x18
		::System::Single KeepDuration; // 0x1C
		::System::Boolean IgnoreWorldTimeScaleCurve; // 0x20
