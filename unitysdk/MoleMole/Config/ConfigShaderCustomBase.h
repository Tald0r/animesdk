...
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE_GETSTATE_OFFSET UNITYSDK_OFFSET(0x15EBC1E0)
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE_GET_DURATIONBEFOREEXIT_OFFSET UNITYSDK_OFFSET(0x15EBC070)
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x15EBC000)
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE_PROCESS_OFFSET UNITYSDK_OFFSET(0x15EBC080)
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE_SAVEEVALUATE_1_OFFSET UNITYSDK_OFFSET(0x15EBC310)
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE_SAVEEVALUATE_OFFSET UNITYSDK_OFFSET(0x15EBC270)
#define MOLEMOLE_CONFIG_CONFIGSHADERCUSTOMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x15EBC3C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigShaderCustomBase_TypeDefinitionIndex = 54811;

	class ConfigShaderCustomBase : public ::System::Object
	{
	public:
		::System::Int32 Priority; // 0x10
		::System::Boolean IgnoreWorldTimeScaleCurve; // 0x14
