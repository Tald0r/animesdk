...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICACCESSORYBONEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x94FDC50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicAccessoryBoneData_TypeDefinitionIndex = 72317;
