...
namespace MoleMole::Config
{
	...
	public:
		...
		{
			return ((::System::Single(*)(::PVOID, ::System::Single, ::Class_3_C0D5B1A036ED00F0*, ::MoleMole::Battle::Entity*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_BUDDYTOWERDEFENSEPROPERTYPERCENTMODULE_EVALUATE_OFFSET))(this, selfToTargetDistance, targetDataComponent, selfEntity);
		}
	};
}
