...
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_CANUSELOCKTARGETFORMULTIPLAYER_OFFSET UNITYSDK_OFFSET(0x6FC3470)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_CHECKBATTLEAREA_OFFSET UNITYSDK_OFFSET(0x6FC7870)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_CHECKSWITCHLOCKLOCALAVATAR_OFFSET UNITYSDK_OFFSET(0x6FC7460)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x6FC77F0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_ENTERHANDLEFORCESPECIALCAMERALOCK_OFFSET UNITYSDK_OFFSET(0x6FC46E0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_EXITHANDLEFORCESPECIALCAMERALOCK_OFFSET UNITYSDK_OFFSET(0x6FC5370)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_GETENTITYINPUTROTSPEED_OFFSET UNITYSDK_OFFSET(0x6FC71D0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_GET_ISUPDATEONEFRAME_OFFSET UNITYSDK_OFFSET(0x6FC3350)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_ONINIT_OFFSET UNITYSDK_OFFSET(0x6FC3360)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x6FC5460)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x6FC34F0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x6FC4BC0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_PROCESSCAMRELOCK_OFFSET UNITYSDK_OFFSET(0x6FC47C0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_SETROOTMOTIONROTATIONMUTED_OFFSET UNITYSDK_OFFSET(0x6FC44E0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET_TICKLOCKTARGETROTATE_OFFSET UNITYSDK_OFFSET(0x6FC58C0)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x6FC7970)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x6FC7990)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET___BASE_ONINIT_OFFSET UNITYSDK_OFFSET(0x6FC7A10)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x6FC7A80)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x6FC7B20)
#define MOLEMOLE_CONFIG_ANIMATORZONELOCKTARGET___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x6FC7BB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneLockTarget_TypeDefinitionIndex = 60109;

	class AnimatorZoneLockTarget : public ::MoleMole::Config::AnimatorZone
	{
	public:
		::UnityEngine::AnimationCurve* curveRotateSpeed; // 0x50
		::System::String* SelfForwardAttachPoint; // 0x58
		::UnityEngine::AnimationCurve* CurveRotateSpeed; // 0x60
		::System::String* BackUpLockTargetID; // 0x68
		::System::String* CameraLockModeID; // 0x70
		::UnityEngine::AnimationCurve* AngleOffsetCurve; // 0x78
		::MoleMole::Config::ConfigPosRot* configPosRot; // 0x80
		::System::String* LockTargetID; // 0x88
		::MoleMole::Config::AnimatorZoneLockTarget_ZoneSteerType steerType; // 0x90
		::System::Boolean ForceReselectLockTarget; // 0x94
		::System::Boolean AllowRootMotionRotation; // 0x95
		::System::Boolean CamReLockWhenLockingSameTarget; // 0x96
		::System::Boolean MuteCamLock; // 0x97
		::MoleMole::Config::AnimatorZoneLockTarget_ForceSpecialCameraLockType ForceSpecialCameraLock; // 0x98
		::System::Single RotateSpeedRatio; // 0x9C
		::MoleMole::Config::AnimatorZoneLockTarget_SteerDirection steerDirectionType; // 0xA0
		::MoleMole::Config::AnimatorZoneLockTarget_TargetType LockTargetType; // 0xA4
		::System::Boolean NeedLockTargetOnZoneEnter; // 0xA8
		::System::Boolean UseJoystickSteerPreferred; // 0xA9
		::System::Boolean ForceIgnoreAISelectTarget; // 0xAA
		::System::Boolean enableTickConfigPosRot; // 0xAB
		::System::Boolean IgnoreJoystickSteerWhenRotSpeedZero; // 0xAC
		::System::Boolean MouseModeLockCameraRotation; // 0xAD
		::System::Boolean ApplyRotateSpeedZone; // 0xAE
