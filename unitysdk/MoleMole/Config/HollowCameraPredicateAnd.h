...
#define MOLEMOLE_CONFIG_HOLLOWCAMERAPREDICATEAND_EVALUATE_OFFSET UNITYSDK_OFFSET(0xCCA5FB0)
#define MOLEMOLE_CONFIG_HOLLOWCAMERAPREDICATEAND__CTOR_OFFSET UNITYSDK_OFFSET(0xCCA6160)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowCameraPredicateAnd_TypeDefinitionIndex = 49025;
