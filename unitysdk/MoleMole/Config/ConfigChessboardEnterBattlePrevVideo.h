...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDENTERBATTLEPREVVIDEO_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xE2B9DE0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDENTERBATTLEPREVVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0xE2B9EC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardEnterBattlePrevVideo_TypeDefinitionIndex = 54559;
