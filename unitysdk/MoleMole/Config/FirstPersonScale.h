...
#define MOLEMOLE_CONFIG_FIRSTPERSONSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0xBB03820)

namespace MoleMole::Config
{
	inline static constexpr unsigned int FirstPersonScale_TypeDefinitionIndex = 59050;
