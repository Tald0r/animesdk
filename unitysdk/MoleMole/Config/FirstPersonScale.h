...
#define MOLEMOLE_CONFIG_FIRSTPERSONSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x14196110)

namespace MoleMole::Config
{
	inline static constexpr unsigned int FirstPersonScale_TypeDefinitionIndex = 51521;
