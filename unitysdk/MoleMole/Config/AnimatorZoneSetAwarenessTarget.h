...
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET_ALLOWFOLLOWAWARENESSTARGETTOATTACKTARGET_OFFSET UNITYSDK_OFFSET(0x803E8F0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x803E3A0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET_DOAWARENESSLOCKPROCESS_OFFSET UNITYSDK_OFFSET(0x803E090)
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET_ISINAWARENESSLIST_OFFSET UNITYSDK_OFFSET(0x803E760)
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x803EB20)
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x803DFE0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x803E5E0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET_SETENTITYAWARENESSTARGET_OFFSET UNITYSDK_OFFSET(0x803E440)
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x803EDB0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x803EDC0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x803EE40)
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x803EEE0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETAWARENESSTARGET___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x803EF70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneSetAwarenessTarget_TypeDefinitionIndex = 79200;
