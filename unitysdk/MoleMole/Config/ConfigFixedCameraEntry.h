...
#define MOLEMOLE_CONFIG_CONFIGFIXEDCAMERAENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xACC5200)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFixedCameraEntry_TypeDefinitionIndex = 44537;
