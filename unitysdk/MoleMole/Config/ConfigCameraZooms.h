...
#define MOLEMOLE_CONFIG_CONFIGCAMERAZOOMS__CTOR_OFFSET UNITYSDK_OFFSET(0x804A170)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraZooms_TypeDefinitionIndex = 46759;
