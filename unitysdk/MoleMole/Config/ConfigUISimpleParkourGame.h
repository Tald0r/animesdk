...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_APPLYGLOBALCONFIG_OFFSET UNITYSDK_OFFSET(0xCDBC560)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_APPLYLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0xCDBC800)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_CREATEGAMEDATA_OFFSET UNITYSDK_OFFSET(0xCDBC290)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_ONENABLE_OFFSET UNITYSDK_OFFSET(0xCDBBDC0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_UPDATEPARENTREFERENCES_OFFSET UNITYSDK_OFFSET(0xCDBBF50)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME__CTOR_OFFSET UNITYSDK_OFFSET(0xCDBCA10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_TypeDefinitionIndex = 57774;
