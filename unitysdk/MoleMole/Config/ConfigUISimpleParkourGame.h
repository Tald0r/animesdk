...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_APPLYGLOBALCONFIG_OFFSET UNITYSDK_OFFSET(0xD0A15D0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_APPLYLEVELCONFIG_OFFSET UNITYSDK_OFFSET(0xD0A1850)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_CREATEGAMEDATA_OFFSET UNITYSDK_OFFSET(0xD0A1300)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD0A0E30)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_UPDATEPARENTREFERENCES_OFFSET UNITYSDK_OFFSET(0xD0A0FC0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME__CTOR_OFFSET UNITYSDK_OFFSET(0xD0A1A60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_TypeDefinitionIndex = 58198;
