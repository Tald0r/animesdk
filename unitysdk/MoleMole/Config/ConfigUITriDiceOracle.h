...
#define MOLEMOLE_CONFIG_CONFIGUITRIDICEORACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x8A0CA00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUITriDiceOracle_TypeDefinitionIndex = 76304;
