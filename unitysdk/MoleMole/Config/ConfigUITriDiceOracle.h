...
#define MOLEMOLE_CONFIG_CONFIGUITRIDICEORACLE__CTOR_OFFSET UNITYSDK_OFFSET(0x10AA56F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUITriDiceOracle_TypeDefinitionIndex = 64203;
