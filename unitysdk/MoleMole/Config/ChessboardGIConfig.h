...
#define MOLEMOLE_CONFIG_CHESSBOARDGICONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x139932E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ChessboardGIConfig_TypeDefinitionIndex = 74022;
