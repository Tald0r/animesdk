...
#define MOLEMOLE_CONFIG_ANIMATOREVENTENDLASERENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x89E78E0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTENDLASERENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x89E7980)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventEndLaserEntry_TypeDefinitionIndex = 69416;
