...
#define MOLEMOLE_CONFIG_CONFIGENTITYFXCOMICDOTEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0xCAE5BA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityFXComicDotEffects_TypeDefinitionIndex = 66625;
