...
#define MOLEMOLE_CONFIG_LEVELGLOBALAISCRIPTCONFIG_ONKEYCHANGE_OFFSET UNITYSDK_OFFSET(0xF171BD0)
#define MOLEMOLE_CONFIG_LEVELGLOBALAISCRIPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xF171C90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelGlobalAIScriptConfig_TypeDefinitionIndex = 50505;
