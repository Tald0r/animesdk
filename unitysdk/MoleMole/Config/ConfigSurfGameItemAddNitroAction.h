...
#define MOLEMOLE_CONFIG_CONFIGSURFGAMEITEMADDNITROACTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0xF16E640)
#define MOLEMOLE_CONFIG_CONFIGSURFGAMEITEMADDNITROACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xF16E740)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSurfGameItemAddNitroAction_TypeDefinitionIndex = 66755;
