...
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_CLONE_OFFSET UNITYSDK_OFFSET(0x139A2010)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x139A1FA0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x139A2430)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_FROMFLX_OFFSET UNITYSDK_OFFSET(0x139A2220)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x139A20F0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_GETROTATIONDIR_OFFSET UNITYSDK_OFFSET(0x139A1EF0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x139A24C0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x139A22A0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x139A2520)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x139A22D0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_RECORDPOSROTPARAM_OFFSET UNITYSDK_OFFSET(0x139A1C10)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x139A1BC0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION___BASE_GETROTATIONDIR_OFFSET UNITYSDK_OFFSET(0x139A2700)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION___BASE_RECORDPOSROTPARAM_OFFSET UNITYSDK_OFFSET(0x139A2730)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigRotationToTargetRotation_TypeDefinitionIndex = 49447;
	...
	public:
		...
		{
			return ((::UnityEngine::Vector3(*)(::PVOID, ::Class_3_F35B080B137ECC46*, ::Class_3_248DACE3BB3053DD*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION_GETROTATIONDIR_OFFSET))(this, modelComponent, movementComponent);
		}
		...
		::UnityEngine::Vector3 __base_GetRotationDir(::Class_3_F35B080B137ECC46* P0, ::Class_3_248DACE3BB3053DD* P1)
		{
			return ((::UnityEngine::Vector3(*)(::PVOID, ::Class_3_F35B080B137ECC46*, ::Class_3_248DACE3BB3053DD*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGROTATIONTOTARGETROTATION___BASE_GETROTATIONDIR_OFFSET))(this, P0, P1);
		}
