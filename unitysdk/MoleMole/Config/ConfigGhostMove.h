...
#define MOLEMOLE_CONFIG_CONFIGGHOSTMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x970AB50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGhostMove_TypeDefinitionIndex = 50314;
