...
#define MOLEMOLE_CONFIG_CONFIGGHOSTMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0xB0995B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGhostMove_TypeDefinitionIndex = 51848;
