...
#define MOLEMOLE_CONFIG_ANIMATOREVENTHANDLEANIMATORZONETAGSENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0xCD97810)
#define MOLEMOLE_CONFIG_ANIMATOREVENTHANDLEANIMATORZONETAGSENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xCD97900)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventHandleAnimatorZoneTagsEntry_TypeDefinitionIndex = 61803;
