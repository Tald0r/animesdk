...
#define MOLEMOLE_CONFIG_PHOTOCAMERAMODEOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0xF1757E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int PhotoCameraModeOverride_TypeDefinitionIndex = 75128;
