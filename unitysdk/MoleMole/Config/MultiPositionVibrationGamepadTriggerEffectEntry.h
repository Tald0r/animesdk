...
#define MOLEMOLE_CONFIG_MULTIPOSITIONVIBRATIONGAMEPADTRIGGEREFFECTENTRY_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xCB00600)
#define MOLEMOLE_CONFIG_MULTIPOSITIONVIBRATIONGAMEPADTRIGGEREFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xCB006C0)
#define MOLEMOLE_CONFIG_MULTIPOSITIONVIBRATIONGAMEPADTRIGGEREFFECTENTRY___BASE_ONPROCESS_OFFSET UNITYSDK_OFFSET(0xCB006D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MultiPositionVibrationGamepadTriggerEffectEntry_TypeDefinitionIndex = 68504;
