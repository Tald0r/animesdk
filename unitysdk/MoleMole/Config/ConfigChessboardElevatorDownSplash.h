...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDELEVATORDOWNSPLASH_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCDA78F0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDELEVATORDOWNSPLASH__CTOR_OFFSET UNITYSDK_OFFSET(0xCDA79D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardElevatorDownSplash_TypeDefinitionIndex = 36405;
