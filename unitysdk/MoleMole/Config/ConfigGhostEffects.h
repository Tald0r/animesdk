...
#define MOLEMOLE_CONFIG_CONFIGGHOSTEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x918A270)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGhostEffects_TypeDefinitionIndex = 65027;
