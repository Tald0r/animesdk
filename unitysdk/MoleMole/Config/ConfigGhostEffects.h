...
#define MOLEMOLE_CONFIG_CONFIGGHOSTEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x13997F30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGhostEffects_TypeDefinitionIndex = 42435;
