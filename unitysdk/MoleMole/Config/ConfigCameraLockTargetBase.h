...
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xB46C7E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE_FROMFLX_OFFSET UNITYSDK_OFFSET(0xB46C5A0)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE_METHOD_1_0BD393E566CD3D4A_OFFSET UNITYSDK_OFFSET(0xB46C620)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE_METHOD_1_A42B0141BE94FABE_OFFSET UNITYSDK_OFFSET(0xB46C840)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xB46CA30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraLockTargetBase_TypeDefinitionIndex = 56169;
