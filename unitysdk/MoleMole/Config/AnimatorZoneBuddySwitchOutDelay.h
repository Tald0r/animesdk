...
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHOUTDELAY_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xF2BC860)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHOUTDELAY_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xF2BCA00)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHOUTDELAY__CTOR_OFFSET UNITYSDK_OFFSET(0xF2BCB90)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHOUTDELAY___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xF2BCBA0)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHOUTDELAY___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xF2BCC30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneBuddySwitchOutDelay_TypeDefinitionIndex = 41964;
	...
	public:
		...
		::System::Boolean needOverrideMaxVanishDelay; // 0x59
		::System::Boolean muteVanish; // 0x5A
