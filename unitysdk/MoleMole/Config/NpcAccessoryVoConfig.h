...
#define MOLEMOLE_CONFIG_NPCACCESSORYVOCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xB47CF90)
#define MOLEMOLE_CONFIG_NPCACCESSORYVOCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0xB47CB60)
#define MOLEMOLE_CONFIG_NPCACCESSORYVOCONFIG_METHOD_1_1A0B790695E07CE5_OFFSET UNITYSDK_OFFSET(0xB47CFF0)
#define MOLEMOLE_CONFIG_NPCACCESSORYVOCONFIG_METHOD_1_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0xB47CBE0)
#define MOLEMOLE_CONFIG_NPCACCESSORYVOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB47D1E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int NpcAccessoryVoConfig_TypeDefinitionIndex = 75670;
