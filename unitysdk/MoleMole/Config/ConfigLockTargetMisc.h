...
#define MOLEMOLE_CONFIG_CONFIGLOCKTARGETMISC__CTOR_OFFSET UNITYSDK_OFFSET(0xEC2BF20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLockTargetMisc_TypeDefinitionIndex = 42791;
