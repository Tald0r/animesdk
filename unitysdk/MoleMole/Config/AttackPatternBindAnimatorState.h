...
#define MOLEMOLE_CONFIG_ATTACKPATTERNBINDANIMATORSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x6D49620)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AttackPatternBindAnimatorState_TypeDefinitionIndex = 63054;
