...
#define MOLEMOLE_CONFIG_CONFIGANIMATORFLOATPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x415150)
#define MOLEMOLE_CONFIG_CONFIGANIMATORFLOATPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x4150C0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORFLOATPARAM_METHOD_2_18055626D7B524E1_OFFSET UNITYSDK_OFFSET(0x4151B0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORFLOATPARAM_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x4151C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorFloatParam_TypeDefinitionIndex = 57332;
