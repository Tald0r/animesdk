...
#define MOLEMOLE_CONFIG_CONFIGMONSTERFUNCTIONTYPEARRAYFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0xEC2D0D0)
#define MOLEMOLE_CONFIG_CONFIGMONSTERFUNCTIONTYPEARRAYFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xEC2D420)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMonsterFunctionTypeArrayFilter_TypeDefinitionIndex = 63299;
