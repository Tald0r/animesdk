...
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_CHECK_OFFSET UNITYSDK_OFFSET(0x6D49B30)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_FINISH_OFFSET UNITYSDK_OFFSET(0x1417EA50)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_ONINTERACTINTERNAL_OFFSET UNITYSDK_OFFSET(0x6D49630)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1417E610)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET_PLAYBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x6D496F0)
#define MOLEMOLE_CONFIG_BEHAVIORBETWEENPLAYERANDTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x1417EAC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int BehaviorBetweenPlayerAndTarget_TypeDefinitionIndex = 54825;
