...
#define MOLEMOLE_CONFIG_RUNTIMEDYNAMICOBJECTSET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x3AA470)
#define MOLEMOLE_CONFIG_RUNTIMEDYNAMICOBJECTSET_FROMFLX_OFFSET UNITYSDK_OFFSET(0x3AA3E0)
#define MOLEMOLE_CONFIG_RUNTIMEDYNAMICOBJECTSET_METHOD_2_B9F93B03B69BDD87_OFFSET UNITYSDK_OFFSET(0x3AA4D0)
#define MOLEMOLE_CONFIG_RUNTIMEDYNAMICOBJECTSET_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x3AA4E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int RuntimeDynamicObjectSet_TypeDefinitionIndex = 59837;
