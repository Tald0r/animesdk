...
#define MOLEMOLE_CONFIG_RUNTIMEDYNAMICOBJECTSET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x539930)
#define MOLEMOLE_CONFIG_RUNTIMEDYNAMICOBJECTSET_FROMFLX_OFFSET UNITYSDK_OFFSET(0x5398A0)
#define MOLEMOLE_CONFIG_RUNTIMEDYNAMICOBJECTSET_METHOD_2_B9F93B03B69BDD87_OFFSET UNITYSDK_OFFSET(0x539990)
#define MOLEMOLE_CONFIG_RUNTIMEDYNAMICOBJECTSET_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x5399A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int RuntimeDynamicObjectSet_TypeDefinitionIndex = 47474;
