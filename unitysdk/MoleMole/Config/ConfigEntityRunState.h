...
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x62480B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityRunState_TypeDefinitionIndex = 78108;
