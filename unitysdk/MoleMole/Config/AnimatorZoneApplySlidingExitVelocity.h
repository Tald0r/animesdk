...
#define MOLEMOLE_CONFIG_ANIMATORZONEAPPLYSLIDINGEXITVELOCITY_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x6541DC0)
#define MOLEMOLE_CONFIG_ANIMATORZONEAPPLYSLIDINGEXITVELOCITY_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x6541E70)
#define MOLEMOLE_CONFIG_ANIMATORZONEAPPLYSLIDINGEXITVELOCITY__CTOR_OFFSET UNITYSDK_OFFSET(0x6541FC0)
#define MOLEMOLE_CONFIG_ANIMATORZONEAPPLYSLIDINGEXITVELOCITY___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x6541FD0)
#define MOLEMOLE_CONFIG_ANIMATORZONEAPPLYSLIDINGEXITVELOCITY___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x6542060)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneApplySlidingExitVelocity_TypeDefinitionIndex = 46064;
