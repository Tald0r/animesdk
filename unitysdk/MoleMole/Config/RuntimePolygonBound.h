...
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x3102F0)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_FROMFLX_OFFSET UNITYSDK_OFFSET(0x310260)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_METHOD_2_3338E25D676DBB67_OFFSET UNITYSDK_OFFSET(0x310380)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_METHOD_2_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0x3103E0)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_METHOD_2_5CC415752F05F246_OFFSET UNITYSDK_OFFSET(0x310450)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_METHOD_2_674524A234498963_OFFSET UNITYSDK_OFFSET(0x310390)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_METHOD_2_C1DAD850E2998E73_OFFSET UNITYSDK_OFFSET(0x3103C0)
#define MOLEMOLE_CONFIG_RUNTIMEPOLYGONBOUND_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x310350)

namespace MoleMole::Config
{
	inline static constexpr unsigned int RuntimePolygonBound_TypeDefinitionIndex = 78970;
