...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDSTOPSECONDARYSCREEN_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x84A4840)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDSTOPSECONDARYSCREEN__CTOR_OFFSET UNITYSDK_OFFSET(0x84A4920)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardStopSecondaryScreen_TypeDefinitionIndex = 74186;
