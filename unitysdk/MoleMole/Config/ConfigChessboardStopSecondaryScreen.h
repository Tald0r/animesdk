...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDSTOPSECONDARYSCREEN_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x94FC610)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDSTOPSECONDARYSCREEN__CTOR_OFFSET UNITYSDK_OFFSET(0x94FC6F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardStopSecondaryScreen_TypeDefinitionIndex = 42566;
