...
#define MOLEMOLE_CONFIG_ANIMATORZONEFORCENORMALCAMERALOCK_DOZONEENTER_OFFSET UNITYSDK_OFFSET(0xCCF0A00)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORCENORMALCAMERALOCK_DOZONEEXIT_OFFSET UNITYSDK_OFFSET(0xCCF0CE0)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORCENORMALCAMERALOCK_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xCCF0950)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORCENORMALCAMERALOCK_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xCCF0C20)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORCENORMALCAMERALOCK__CTOR_OFFSET UNITYSDK_OFFSET(0xCCF0F10)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORCENORMALCAMERALOCK___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xCCF0F20)
#define MOLEMOLE_CONFIG_ANIMATORZONEFORCENORMALCAMERALOCK___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xCCF0FB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneForceNormalCameraLock_TypeDefinitionIndex = 49287;
