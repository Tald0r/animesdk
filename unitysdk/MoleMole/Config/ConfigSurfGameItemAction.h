...
#define MOLEMOLE_CONFIG_CONFIGSURFGAMEITEMACTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0x14192A20)
#define MOLEMOLE_CONFIG_CONFIGSURFGAMEITEMACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x14192AA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSurfGameItemAction_TypeDefinitionIndex = 38350;
