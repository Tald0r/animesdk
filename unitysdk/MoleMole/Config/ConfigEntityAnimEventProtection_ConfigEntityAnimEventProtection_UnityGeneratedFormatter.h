...
#define MOLEMOLE_CONFIG_CONFIGENTITYANIMEVENTPROTECTION_CONFIGENTITYANIMEVENTPROTECTION_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x84A5EE0)
#define MOLEMOLE_CONFIG_CONFIGENTITYANIMEVENTPROTECTION_CONFIGENTITYANIMEVENTPROTECTION_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x84A5EF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYANIMEVENTPROTECTION_CONFIGENTITYANIMEVENTPROTECTION_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x84A6180)
#define MOLEMOLE_CONFIG_CONFIGENTITYANIMEVENTPROTECTION_CONFIGENTITYANIMEVENTPROTECTION_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x84A6390)
#define MOLEMOLE_CONFIG_CONFIGENTITYANIMEVENTPROTECTION_CONFIGENTITYANIMEVENTPROTECTION_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x84A6330)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityAnimEventProtection_ConfigEntityAnimEventProtection_UnityGeneratedFormatter_TypeDefinitionIndex = 54620;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(ConfigEntityAnimEventProtection_ConfigEntityAnimEventProtection_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3D1E0);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Int32>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(ConfigEntityAnimEventProtection_ConfigEntityAnimEventProtection_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3D1E8);
		}
		static ::Sirenix::Serialization::Serializer_1<::Il2CppArray<::System::String*>*>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::Il2CppArray<::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigEntityAnimEventProtection_ConfigEntityAnimEventProtection_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3D1F0);
		}
