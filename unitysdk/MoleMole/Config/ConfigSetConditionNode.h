...
#define MOLEMOLE_CONFIG_CONFIGSETCONDITIONNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x14191740)
#define MOLEMOLE_CONFIG_CONFIGSETCONDITIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x141917D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSetConditionNode_TypeDefinitionIndex = 62855;
