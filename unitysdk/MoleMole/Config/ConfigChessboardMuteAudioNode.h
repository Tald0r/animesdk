...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDMUTEAUDIONODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCC901F0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDMUTEAUDIONODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC902D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardMuteAudioNode_TypeDefinitionIndex = 43676;
