...
#define MOLEMOLE_CONFIG_INTERACTPLAYSOUND_ONINTERACTINTERNAL_OFFSET UNITYSDK_OFFSET(0xB0A2650)
#define MOLEMOLE_CONFIG_INTERACTPLAYSOUND_ONSTOP_OFFSET UNITYSDK_OFFSET(0xB0A25E0)
#define MOLEMOLE_CONFIG_INTERACTPLAYSOUND__CTOR_OFFSET UNITYSDK_OFFSET(0xB0A27F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int InteractPlaySound_TypeDefinitionIndex = 47154;
