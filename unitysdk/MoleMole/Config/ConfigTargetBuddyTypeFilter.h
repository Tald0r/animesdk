...
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYTYPEFILTER_COMPAREBUDDYTYPE_OFFSET UNITYSDK_OFFSET(0x14193130)
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYTYPEFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x14192FE0)
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYTYPEFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x141932B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTargetBuddyTypeFilter_TypeDefinitionIndex = 40255;
