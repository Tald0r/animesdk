...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x84A8B10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowInteractEffect_TypeDefinitionIndex = 52203;
