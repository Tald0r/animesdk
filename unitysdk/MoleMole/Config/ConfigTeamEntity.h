...
#define MOLEMOLE_CONFIG_CONFIGTEAMENTITY__CTOR_OFFSET UNITYSDK_OFFSET(0xE2D0700)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTeamEntity_TypeDefinitionIndex = 71818;
