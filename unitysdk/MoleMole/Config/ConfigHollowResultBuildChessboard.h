...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTBUILDCHESSBOARD_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x84A8B90)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTBUILDCHESSBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x84A8C20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowResultBuildChessboard_TypeDefinitionIndex = 38355;
