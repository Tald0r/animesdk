...
#define MOLEMOLE_CONFIG_UIACHIEVEMENTANIMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x139A6FC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int UIAchievementAnimConfig_TypeDefinitionIndex = 77970;
