...
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHFADEDURATIONOVERRIDE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x10A818F0)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHFADEDURATIONOVERRIDE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x10A81BD0)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHFADEDURATIONOVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x10A81E20)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHFADEDURATIONOVERRIDE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x10A81E40)
#define MOLEMOLE_CONFIG_ANIMATORZONEBUDDYSWITCHFADEDURATIONOVERRIDE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x10A81ED0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneBuddySwitchFadeDurationOverride_TypeDefinitionIndex = 66751;
