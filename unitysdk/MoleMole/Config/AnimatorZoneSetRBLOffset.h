...
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBLOFFSET_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0xB468990)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBLOFFSET_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xB4685C0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBLOFFSET_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xB4687A0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBLOFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0xB468A30)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBLOFFSET___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0xB468A40)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBLOFFSET___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xB468AC0)
#define MOLEMOLE_CONFIG_ANIMATORZONESETRBLOFFSET___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xB468B50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneSetRBLOffset_TypeDefinitionIndex = 49850;
