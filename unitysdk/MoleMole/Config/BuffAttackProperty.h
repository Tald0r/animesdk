...
#define MOLEMOLE_CONFIG_BUFFATTACKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x62ABDD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int BuffAttackProperty_TypeDefinitionIndex = 52197;
