...
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT_GET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x13FA2430)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT_GET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x13FA2450)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x13FA2410)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT_SET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x13FA2440)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT_SET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x13FA2460)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x13FA2420)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x13FA23D0)
#define MOLEMOLE_CONFIG_READONLYDYNAMICINT__CTOR_OFFSET UNITYSDK_OFFSET(0x13FA23A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ReadonlyDynamicInt_TypeDefinitionIndex = 67616;
