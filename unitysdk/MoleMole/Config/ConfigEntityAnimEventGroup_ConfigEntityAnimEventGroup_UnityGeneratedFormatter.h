...
#define MOLEMOLE_CONFIG_CONFIGENTITYANIMEVENTGROUP_CONFIGENTITYANIMEVENTGROUP_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x6550180)
#define MOLEMOLE_CONFIG_CONFIGENTITYANIMEVENTGROUP_CONFIGENTITYANIMEVENTGROUP_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x6550190)
#define MOLEMOLE_CONFIG_CONFIGENTITYANIMEVENTGROUP_CONFIGENTITYANIMEVENTGROUP_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x6550390)
#define MOLEMOLE_CONFIG_CONFIGENTITYANIMEVENTGROUP_CONFIGENTITYANIMEVENTGROUP_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x6550550)
#define MOLEMOLE_CONFIG_CONFIGENTITYANIMEVENTGROUP_CONFIGENTITYANIMEVENTGROUP_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x6550510)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityAnimEventGroup_ConfigEntityAnimEventGroup_UnityGeneratedFormatter_TypeDefinitionIndex = 72245;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigEntityAnimEventGroup_ConfigEntityAnimEventGroup_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43D70);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::String*>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigEntityAnimEventGroup_ConfigEntityAnimEventGroup_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43D78);
		}
