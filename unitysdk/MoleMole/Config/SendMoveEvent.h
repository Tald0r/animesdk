...
#define MOLEMOLE_CONFIG_SENDMOVEEVENT_ONINTERACTINTERNAL_OFFSET UNITYSDK_OFFSET(0xCD20D10)
#define MOLEMOLE_CONFIG_SENDMOVEEVENT_ONSTOP_OFFSET UNITYSDK_OFFSET(0xCD20CA0)
#define MOLEMOLE_CONFIG_SENDMOVEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD20DB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SendMoveEvent_TypeDefinitionIndex = 65529;
