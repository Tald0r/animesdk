...
#define MOLEMOLE_CONFIG_CONFIGINTERACTINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC2BB50)
#define MOLEMOLE_CONFIG_CONFIGINTERACTINFO_FROMFLX_OFFSET UNITYSDK_OFFSET(0xEC2B620)
#define MOLEMOLE_CONFIG_CONFIGINTERACTINFO_METHOD_1_723D4849983651D2_OFFSET UNITYSDK_OFFSET(0xEC2BBB0)
#define MOLEMOLE_CONFIG_CONFIGINTERACTINFO_METHOD_1_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0xEC2B6A0)
#define MOLEMOLE_CONFIG_CONFIGINTERACTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xEC2BF10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigInteractInfo_TypeDefinitionIndex = 62790;
