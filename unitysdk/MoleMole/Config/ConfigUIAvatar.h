...
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xCC9FCE0)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xCC9EC50)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0xCCA0AC0)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xCCA0D20)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xCCA0D30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIAvatar_TypeDefinitionIndex = 59391;
