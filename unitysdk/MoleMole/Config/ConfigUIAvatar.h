...
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xACCEAA0)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xACCDA10)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0xACCF870)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xACCFAD0)
#define MOLEMOLE_CONFIG_CONFIGUIAVATAR___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xACCFAE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIAvatar_TypeDefinitionIndex = 37426;
