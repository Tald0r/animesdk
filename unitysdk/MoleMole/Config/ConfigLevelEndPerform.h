...
#define MOLEMOLE_CONFIG_CONFIGLEVELENDPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x970B500)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelEndPerform_TypeDefinitionIndex = 62960;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::MoleMole::Config::LevelEndType, ::System::Collections::Generic::List_1<::MoleMole::Config::ConfigLevelEndCameraEffect*>*>* CameraVolumeEffect; // 0x28
		::System::Collections::Generic::List_1<::MoleMole::Config::MaterialPropertyType>* MuteMaterialProperties; // 0x30
		...
		::System::Single LevelResultPageDelayShowTime; // 0x44
