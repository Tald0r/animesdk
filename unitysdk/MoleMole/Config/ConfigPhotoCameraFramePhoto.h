...
#define MOLEMOLE_CONFIG_CONFIGPHOTOCAMERAFRAMEPHOTO__CTOR_OFFSET UNITYSDK_OFFSET(0xB09CCB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPhotoCameraFramePhoto_TypeDefinitionIndex = 76256;
