...
#define MOLEMOLE_CONFIG_CONFIGPHOTOCAMERAFRAMEPHOTO__CTOR_OFFSET UNITYSDK_OFFSET(0x970E2C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPhotoCameraFramePhoto_TypeDefinitionIndex = 71820;
