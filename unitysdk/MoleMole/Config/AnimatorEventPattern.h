...
#define MOLEMOLE_CONFIG_ANIMATOREVENTPATTERN_ONPATTERNNAMECHANGED_OFFSET UNITYSDK_OFFSET(0xE2B1090)
#define MOLEMOLE_CONFIG_ANIMATOREVENTPATTERN_ONREMOVETAG_OFFSET UNITYSDK_OFFSET(0xE2B1100)
#define MOLEMOLE_CONFIG_ANIMATOREVENTPATTERN__CTOR_OFFSET UNITYSDK_OFFSET(0xE2B1170)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventPattern_TypeDefinitionIndex = 79262;
