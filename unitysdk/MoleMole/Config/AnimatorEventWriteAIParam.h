...
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_0589B5E7626E6766_OFFSET UNITYSDK_OFFSET(0x6D3F3B0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_128774387667156B_OFFSET UNITYSDK_OFFSET(0x6D3F4E0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_6D71E792B81E5A0F_OFFSET UNITYSDK_OFFSET(0x6D3F1A0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_ABF27A10B1089912_OFFSET UNITYSDK_OFFSET(0x6D3F0B0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_DE8FDF9C87F3AA65_OFFSET UNITYSDK_OFFSET(0x6D3F460)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_ED5F2F1B855D8245_OFFSET UNITYSDK_OFFSET(0x6D3ECE0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_METHOD_2_FB6392A8F30862C7_OFFSET UNITYSDK_OFFSET(0x6D3F520)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM_TOSTRING_OFFSET UNITYSDK_OFFSET(0x6D3EBD0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTWRITEAIPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x6D3F3A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventWriteAIParam_TypeDefinitionIndex = 61580;
