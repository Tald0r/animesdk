...
#define MOLEMOLE_CONFIG_CONFIGAUTOBATTLEACCESSORYEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x13F8BF20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAutoBattleAccessoryEffect_TypeDefinitionIndex = 73176;
