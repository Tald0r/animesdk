...
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_CONFIGFOCUSCAMERA_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x84A7180)
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_CONFIGFOCUSCAMERA_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x84A7190)
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_CONFIGFOCUSCAMERA_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x84A7390)
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_CONFIGFOCUSCAMERA_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x84A7550)
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_CONFIGFOCUSCAMERA_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x84A7510)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFocusCamera_ConfigFocusCamera_UnityGeneratedFormatter_TypeDefinitionIndex = 67742;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Config::ConfigFocusCameraEntry*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigFocusCamera_ConfigFocusCamera_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3D208);
		}
