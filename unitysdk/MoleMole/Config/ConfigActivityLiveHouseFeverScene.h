...
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSEFEVERSCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x9B5C000)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigActivityLiveHouseFeverScene_TypeDefinitionIndex = 68544;
