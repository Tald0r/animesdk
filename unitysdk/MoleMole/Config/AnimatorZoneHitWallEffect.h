...
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0xE3466E0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT_GET_ISUPDATEONEFRAME_OFFSET UNITYSDK_OFFSET(0xE3466D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xE347560)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xE346780)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xE347460)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__CCTOR_OFFSET UNITYSDK_OFFSET(0xE3483E0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xE348330)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__HANDLEHITDATA_OFFSET UNITYSDK_OFFSET(0xE347120)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__PREPARE_OFFSET UNITYSDK_OFFSET(0xE346CA0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__PRINTRAY_OFFSET UNITYSDK_OFFSET(0xE3473A0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__TRYCREATERAYCHECK_OFFSET UNITYSDK_OFFSET(0xE346EC0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__TRYCREATESCRATCHEFFECTS_OFFSET UNITYSDK_OFFSET(0xE347CF0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT__TRYCREATETRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0xE347660)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0xE3484F0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0xE348570)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xE348610)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xE3486A0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT___TRYCREATESCRATCHEFFECTS_B__31_0_OFFSET UNITYSDK_OFFSET(0xE3484A0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHITWALLEFFECT___TRYCREATETRIGGEREFFECT_B__30_0_OFFSET UNITYSDK_OFFSET(0xE348450)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneHitWallEffect_TypeDefinitionIndex = 44460;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AnimatorZoneHitWallEffect_TypeDefinitionIndex)->GetStaticField(0xC100);
		}
		::System::String* StopAttachPoint; // 0x50
		::Class_3_F35B080B137ECC46* _characterModel; // 0x58
		::Class_2_2D77BF48CC4DE842* _zoneInfo; // 0x60
		::Class_3_475B169F337F3520* _hitWallComponent; // 0x68
		::System::Collections::Generic::List_1<::System::String*>* StartSpecialEffects; // 0x70
		::System::Collections::Generic::List_1<::System::String*>* ScratchSpecialEffects; // 0x78
		::System::Collections::Generic::List_1<::UnityEngine::RaycastHit>* _zoneHits; // 0x80
		...
		::MoleMole::Config::Vector3Range ScratchSpecialEffectsRange; // 0x9C
		::System::Int32 hitRayFrameUpdateInterval; // 0xB4
		::System::Boolean isEffectSide; // 0xB8
