...
#define MOLEMOLE_CONFIG_STREAMINGSTAGEENTRY_ALLOCATE_OFFSET UNITYSDK_OFFSET(0xEC57810)
#define MOLEMOLE_CONFIG_STREAMINGSTAGEENTRY_GET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0xEC57800)
#define MOLEMOLE_CONFIG_STREAMINGSTAGEENTRY_GET_STAGESCENEPATH_OFFSET UNITYSDK_OFFSET(0xEC577F0)
#define MOLEMOLE_CONFIG_STREAMINGSTAGEENTRY_LOADSTAGEENV_OFFSET UNITYSDK_OFFSET(0xEC578E0)
#define MOLEMOLE_CONFIG_STREAMINGSTAGEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xEC578D0)
#define MOLEMOLE_CONFIG_STREAMINGSTAGEENTRY___BASE_LOADSTAGEENV_OFFSET UNITYSDK_OFFSET(0xEC57C30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int StreamingStageEntry_TypeDefinitionIndex = 76132;
