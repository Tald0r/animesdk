...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RETARGETTOATTACHPOINT_EXECUTE_OFFSET UNITYSDK_OFFSET(0x13F9D7F0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RETARGETTOATTACHPOINT_ISMATCH_OFFSET UNITYSDK_OFFSET(0x13F9EEA0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RETARGETTOATTACHPOINT_RELOAD_OFFSET UNITYSDK_OFFSET(0x13F9D4D0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RETARGETTOATTACHPOINT_WALK_OFFSET UNITYSDK_OFFSET(0x13F9EF60)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RETARGETTOATTACHPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x13F9F0A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RETARGETTOATTACHPOINT___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x13F9F0B0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RETARGETTOATTACHPOINT___BASE_WALK_OFFSET UNITYSDK_OFFSET(0x13F9F0C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_RetargetToAttachPoint_TypeDefinitionIndex = 76188;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_168*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTION_RETARGETTOATTACHPOINT_EXECUTE_OFFSET))(this, context);
		}
