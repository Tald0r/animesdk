...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWOPENDIALOGANIMPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0xCD07FA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowOpenDialogAnimPreset_TypeDefinitionIndex = 59331;
