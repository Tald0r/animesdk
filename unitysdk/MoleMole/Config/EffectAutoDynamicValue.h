...
#define MOLEMOLE_CONFIG_EFFECTAUTODYNAMICVALUE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC3AE00)
#define MOLEMOLE_CONFIG_EFFECTAUTODYNAMICVALUE_FROMFLX_OFFSET UNITYSDK_OFFSET(0xEC3B220)
#define MOLEMOLE_CONFIG_EFFECTAUTODYNAMICVALUE_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC3AE60)
#define MOLEMOLE_CONFIG_EFFECTAUTODYNAMICVALUE_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xEC3B2A0)
#define MOLEMOLE_CONFIG_EFFECTAUTODYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC3BCF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EffectAutoDynamicValue_TypeDefinitionIndex = 57655;

	class EffectAutoDynamicValue : public ::System::Object
	{
	public:
		::MoleMole::Config::DynamicInt* EffectTarget; // 0x10
		...
		::MoleMole::Config::DynamicFloat* EffHoldTime; // 0x30
		::MoleMole::Config::DynamicFloat* EffFadeOutTime; // 0x38
