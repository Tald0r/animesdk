...
#define MOLEMOLE_CONFIG_EFFECTAUTODYNAMICVALUE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xCAF6C80)
#define MOLEMOLE_CONFIG_EFFECTAUTODYNAMICVALUE_FROMFLX_OFFSET UNITYSDK_OFFSET(0xCAF70A0)
#define MOLEMOLE_CONFIG_EFFECTAUTODYNAMICVALUE_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xCAF6CE0)
#define MOLEMOLE_CONFIG_EFFECTAUTODYNAMICVALUE_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xCAF7120)
#define MOLEMOLE_CONFIG_EFFECTAUTODYNAMICVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0xCAF7B70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EffectAutoDynamicValue_TypeDefinitionIndex = 41515;

	class EffectAutoDynamicValue : public ::System::Object
	{
	public:
		::MoleMole::Config::DynamicFloat* EffFadeOutTime; // 0x10
		::MoleMole::Config::DynamicFloat* EffHoldTime; // 0x18
		::MoleMole::Config::DynamicFloat* EffStartSizeY; // 0x20
		::MoleMole::Config::DynamicFloat* EffFadeInTime; // 0x28
		::MoleMole::Config::DynamicFloat* EffStartSizeX; // 0x30
