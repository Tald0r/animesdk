...
#define MOLEMOLE_CONFIG_CONFIGUIFONTSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0xCCA0D40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIFontSize_TypeDefinitionIndex = 62206;
