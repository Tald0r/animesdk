...
#define MOLEMOLE_CONFIG_ANIMATOREVENTLOCKTARGETENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0xCD97A50)
#define MOLEMOLE_CONFIG_ANIMATOREVENTLOCKTARGETENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xCD97AF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventLockTargetEntry_TypeDefinitionIndex = 49056;
