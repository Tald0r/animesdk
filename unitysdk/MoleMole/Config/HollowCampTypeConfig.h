...
#define MOLEMOLE_CONFIG_HOLLOWCAMPTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE827CD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowCampTypeConfig_TypeDefinitionIndex = 77882;
