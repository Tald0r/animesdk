...
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCELIGHTS__CTOR_OFFSET UNITYSDK_OFFSET(0x84A78B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGachaPerformanceLights_TypeDefinitionIndex = 56327;
