...
#define MOLEMOLE_CONFIG_CONFIGAXISYROTATENODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xF2C5590)
#define MOLEMOLE_CONFIG_CONFIGAXISYROTATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xF2C5620)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAxisYRotateNode_TypeDefinitionIndex = 40281;
