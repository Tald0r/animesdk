...
#define MOLEMOLE_CONFIG_CONFIGAXISYROTATENODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x13F8BFB0)
#define MOLEMOLE_CONFIG_CONFIGAXISYROTATENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x13F8C040)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAxisYRotateNode_TypeDefinitionIndex = 74775;

	class ConfigAxisYRotateNode : public ::MoleMole::Config::ConfigUIBaseActionNode
	{
	public:
		::System::String* RotateCurve; // 0x18
		::System::String* TargetGo; // 0x20
		::System::String* Duration; // 0x28
		::System::String* Angle; // 0x30
