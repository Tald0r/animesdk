...
#define MOLEMOLE_CONFIG_CONFIGSWITCHFLOWNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xC1DC4A0)
#define MOLEMOLE_CONFIG_CONFIGSWITCHFLOWNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC1DC5C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSwitchFlowNode_TypeDefinitionIndex = 39747;
