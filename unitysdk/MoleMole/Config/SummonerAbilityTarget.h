...
#define MOLEMOLE_CONFIG_SUMMONERABILITYTARGET_METHOD_2_18A031D539EABCC9_OFFSET UNITYSDK_OFFSET(0xCD21970)
#define MOLEMOLE_CONFIG_SUMMONERABILITYTARGET_METHOD_2_465938E37C53E919_OFFSET UNITYSDK_OFFSET(0xCD21AC0)
#define MOLEMOLE_CONFIG_SUMMONERABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xCD21D90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SummonerAbilityTarget_TypeDefinitionIndex = 48568;
