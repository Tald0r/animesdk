...
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15E9E950)
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15E9EDE0)
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY__CTOR_OFFSET UNITYSDK_OFFSET(0x15E9F2F0)
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15E9F520)
#define MOLEMOLE_CONFIG_ANIMATIONCURVELIBRARY___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15E9F530)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimationCurveLibrary_TypeDefinitionIndex = 75084;
