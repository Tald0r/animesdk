...
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAICOUNTERSTROKEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xC23C680)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAICOUNTERSTROKEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0xC23C160)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAICOUNTERSTROKEDATA_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0xC23C1E0)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAICOUNTERSTROKEDATA_METHOD_1_591F73C1C45E9D80_OFFSET UNITYSDK_OFFSET(0xC23C6E0)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAICOUNTERSTROKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC23C8C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelGlobalAICounterstrokeData_TypeDefinitionIndex = 53552;
