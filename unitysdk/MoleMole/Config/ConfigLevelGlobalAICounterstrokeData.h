...
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAICOUNTERSTROKEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x624F310)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAICOUNTERSTROKEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x624EDF0)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAICOUNTERSTROKEDATA_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x624EE70)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAICOUNTERSTROKEDATA_METHOD_1_591F73C1C45E9D80_OFFSET UNITYSDK_OFFSET(0x624F370)
#define MOLEMOLE_CONFIG_CONFIGLEVELGLOBALAICOUNTERSTROKEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x624F550)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelGlobalAICounterstrokeData_TypeDefinitionIndex = 76041;
