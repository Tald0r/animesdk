...
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC3BAD0)
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0xEC3B710)
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0xEC3B790)
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA_METHOD_1_9144040ECD391705_OFFSET UNITYSDK_OFFSET(0xEC3BB30)
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xEC3BCD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAttackCDUpdateData_TypeDefinitionIndex = 63080;
