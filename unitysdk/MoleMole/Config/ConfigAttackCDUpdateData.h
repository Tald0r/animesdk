...
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xC342400)
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0xC342040)
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0xC3420C0)
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA_METHOD_1_9144040ECD391705_OFFSET UNITYSDK_OFFSET(0xC342460)
#define MOLEMOLE_CONFIG_CONFIGATTACKCDUPDATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC342600)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAttackCDUpdateData_TypeDefinitionIndex = 58794;
