...
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_DEBUGLEVELEND_OFFSET UNITYSDK_OFFSET(0x81EF900)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_DUMP_OFFSET UNITYSDK_OFFSET(0x81EEE50)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_GETRATINGEFFECTPREFAB_OFFSET UNITYSDK_OFFSET(0x81EF760)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_GET_OPENLEVELRESULTPERFORM_OFFSET UNITYSDK_OFFSET(0x81EEE40)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_GET_PLAYTYPEMAP_OFFSET UNITYSDK_OFFSET(0x81EF120)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS__CTOR_OFFSET UNITYSDK_OFFSET(0x81EF9D0)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS__DEBUGLEVELEND_B__59_0_OFFSET UNITYSDK_OFFSET(0x81EFAD0)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS__OPENWINDOW_OFFSET UNITYSDK_OFFSET(0x81EF8A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelResultPerforms_TypeDefinitionIndex = 46267;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigLevelResultPerforms_TypeDefinitionIndex)->GetStaticField(0x44F10);
		}
