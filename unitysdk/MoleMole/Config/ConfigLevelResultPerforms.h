...
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_DEBUGLEVELEND_OFFSET UNITYSDK_OFFSET(0x6553D90)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_DUMP_OFFSET UNITYSDK_OFFSET(0x65532E0)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_GETRATINGEFFECTPREFAB_OFFSET UNITYSDK_OFFSET(0x6553BF0)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_GET_OPENLEVELRESULTPERFORM_OFFSET UNITYSDK_OFFSET(0x65532D0)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_GET_PLAYTYPEMAP_OFFSET UNITYSDK_OFFSET(0x65535B0)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS__CTOR_OFFSET UNITYSDK_OFFSET(0x6553E60)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS__DEBUGLEVELEND_B__59_0_OFFSET UNITYSDK_OFFSET(0x6553F60)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS__OPENWINDOW_OFFSET UNITYSDK_OFFSET(0x6553D30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelResultPerforms_TypeDefinitionIndex = 46847;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigLevelResultPerforms_TypeDefinitionIndex)->GetStaticField(0x43DE0);
		}
