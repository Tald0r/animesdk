...
#define MOLEMOLE_CONFIG_CONFIGENTITYLENSDIRTEFFECT_GETDIRTTEXTURE_OFFSET UNITYSDK_OFFSET(0xBAFAE90)
#define MOLEMOLE_CONFIG_CONFIGENTITYLENSDIRTEFFECT_GETENABLE_OFFSET UNITYSDK_OFFSET(0xBAFAF20)
#define MOLEMOLE_CONFIG_CONFIGENTITYLENSDIRTEFFECT_GETINTENSITY_OFFSET UNITYSDK_OFFSET(0xBAFAFB0)
#define MOLEMOLE_CONFIG_CONFIGENTITYLENSDIRTEFFECT_GET_DIRTTEXTURE_OFFSET UNITYSDK_OFFSET(0xBAFAC60)
#define MOLEMOLE_CONFIG_CONFIGENTITYLENSDIRTEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xBAFB050)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityLensDirtEffect_TypeDefinitionIndex = 60067;

	class ConfigEntityLensDirtEffect : public ::MoleMole::Config::ConfigEntityScreenEffectBase
	{
	public:
		::System::String* dirtTexturePath; // 0x40
		::MoleMole::Config::ScreenEffectFloat* intensity; // 0x48
		::UnityEngine::Texture2D* _dirtTexture; // 0x50
		::MoleMole::Config::ScreenEffectFieldHandleType dirtTextureHandleType; // 0x58
