...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTCONDITIONBYSUBSTATE_CREATECONDITION_OFFSET UNITYSDK_OFFSET(0xEC42370)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTCONDITIONBYSUBSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC42470)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowInteractConditionBySubState_TypeDefinitionIndex = 68896;
