...
#define MOLEMOLE_CONFIG_HITROTATIONOVERRIDEMAPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD1C3D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HitRotationOverrideMapItem_TypeDefinitionIndex = 55104;
