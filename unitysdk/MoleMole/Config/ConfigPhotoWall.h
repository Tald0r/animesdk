...
#define MOLEMOLE_CONFIG_CONFIGPHOTOWALL__CTOR_OFFSET UNITYSDK_OFFSET(0xCDAF770)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPhotoWall_TypeDefinitionIndex = 37358;
