...
#define MOLEMOLE_CONFIG_CONFIGVIEWOBJECTENTITYDITHER_GET_APPLYDITHERFADEOUTMAXDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x139A50E0)
#define MOLEMOLE_CONFIG_CONFIGVIEWOBJECTENTITYDITHER_GET_APPLYDITHERFADEOUTMAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x139A50D0)
#define MOLEMOLE_CONFIG_CONFIGVIEWOBJECTENTITYDITHER_GET_DISSOCIATEDENTITYDESTROYDELAY_OFFSET UNITYSDK_OFFSET(0x139A50F0)
#define MOLEMOLE_CONFIG_CONFIGVIEWOBJECTENTITYDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x139A5100)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigViewObjectEntityDither_TypeDefinitionIndex = 57337;
