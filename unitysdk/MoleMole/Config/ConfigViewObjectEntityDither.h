...
#define MOLEMOLE_CONFIG_CONFIGVIEWOBJECTENTITYDITHER_GET_APPLYDITHERFADEOUTMAXDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x9197460)
#define MOLEMOLE_CONFIG_CONFIGVIEWOBJECTENTITYDITHER_GET_APPLYDITHERFADEOUTMAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x9197450)
#define MOLEMOLE_CONFIG_CONFIGVIEWOBJECTENTITYDITHER_GET_DISSOCIATEDENTITYDESTROYDELAY_OFFSET UNITYSDK_OFFSET(0x9197470)
#define MOLEMOLE_CONFIG_CONFIGVIEWOBJECTENTITYDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x9197480)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigViewObjectEntityDither_TypeDefinitionIndex = 69236;
