...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xEC4C990)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xEC4C9A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xEC4CC60)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xEC4CE70)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_SETSWITCH_CONFIGSOUNDACTION_SETSWITCH_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xEC4CE30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_SetSwitch_ConfigSoundAction_SetSwitch_UnityGeneratedFormatter_TypeDefinitionIndex = 52295;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_SetSwitch_ConfigSoundAction_SetSwitch_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x42DF0);
		}
