...
#define MOLEMOLE_CONFIG_CONFIGCURVECTRLBASENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE357840)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCurveCtrlBaseNode_TypeDefinitionIndex = 77898;
