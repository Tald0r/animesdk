...
#define MOLEMOLE_CONFIG_CONFIGINDICATEDLIGHTS__CTOR_OFFSET UNITYSDK_OFFSET(0x9D07930)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigIndicatedLights_TypeDefinitionIndex = 75100;
