...
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_CLONE_OFFSET UNITYSDK_OFFSET(0xF16B260)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xF16B250)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xF16C360)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_FROMFLX_OFFSET UNITYSDK_OFFSET(0xF16B470)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xF16B340)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_GETROTATIONDIR_OFFSET UNITYSDK_OFFSET(0xF16A640)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_HANDLEFINALFORWARD_OFFSET UNITYSDK_OFFSET(0xF16AF90)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF16C3C0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xF16B4F0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF16C7F0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xF16C200)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_PROCESS_OFFSET UNITYSDK_OFFSET(0xF16A830)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_SETUP_OFFSET UNITYSDK_OFFSET(0xF16A6E0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY__CTOR_OFFSET UNITYSDK_OFFSET(0xF16A5F0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY___BASE_SETUP_OFFSET UNITYSDK_OFFSET(0xF16C9A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigRotationToVelocity_TypeDefinitionIndex = 78314;
	...
	public:
		...
		::System::Single RotationAngleLimit; // 0x3C
		::System::Single ScaleRatio; // 0x40
		::Enum_3_DBE85A55BA66609E_1 RotateType; // 0x44
