...
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_CLONE_OFFSET UNITYSDK_OFFSET(0xEC49BE0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xEC49BD0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC4ACE0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_FROMFLX_OFFSET UNITYSDK_OFFSET(0xEC49DF0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xEC49CC0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_GETROTATIONDIR_OFFSET UNITYSDK_OFFSET(0xEC48FC0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_HANDLEFINALFORWARD_OFFSET UNITYSDK_OFFSET(0xEC49910)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC4AD40)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xEC49E70)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC4B170)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xEC4AB80)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_PROCESS_OFFSET UNITYSDK_OFFSET(0xEC491B0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_SETUP_OFFSET UNITYSDK_OFFSET(0xEC49060)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY__CTOR_OFFSET UNITYSDK_OFFSET(0xEC48F70)
#define MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY___BASE_SETUP_OFFSET UNITYSDK_OFFSET(0xEC4B320)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigRotationToVelocity_TypeDefinitionIndex = 62314;
	...
	public:
		...
		::Enum_3_32134AA19ED34F5D TargetUpdateMode; // 0x38
		::System::Single RotateSpeed; // 0x3C
		::System::Boolean ReachLimitStop; // 0x40
		::System::Boolean ReachTargetStop; // 0x41
		::UnityEngine::Vector3 TargetDir; // 0x44
		...
		{
			return ((::UnityEngine::Vector3(*)(::PVOID, ::Class_3_F35B080B137ECC46*, ::Class_3_248DACE3BB3053DD*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_GETROTATIONDIR_OFFSET))(this, modelComponent, movementComponent);
		}
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_F35B080B137ECC46*, ::Class_3_248DACE3BB3053DD*, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGROTATIONTOVELOCITY_PROCESS_OFFSET))(this, modelComponent, movementComponent, deltaTime);
		}
