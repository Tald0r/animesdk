...
#define MOLEMOLE_CONFIG_HOTPOTFORCEFIELDCONFIG_GET_HASADDITIONALFORCEFIELD_OFFSET UNITYSDK_OFFSET(0xE2D9000)
#define MOLEMOLE_CONFIG_HOTPOTFORCEFIELDCONFIG_GET_HASNOISEFORCEFIELD_OFFSET UNITYSDK_OFFSET(0xE2D9090)
#define MOLEMOLE_CONFIG_HOTPOTFORCEFIELDCONFIG_GET_ISRING_OFFSET UNITYSDK_OFFSET(0xE2D8FF0)
#define MOLEMOLE_CONFIG_HOTPOTFORCEFIELDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE2D9120)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HotPotForceFieldConfig_TypeDefinitionIndex = 50498;
