...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_OFFSETPOSITION___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0xCDBB100)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_OFFSETPOSITION___C__DISPLAYCLASS8_0__EXECUTE_B__1_OFFSET UNITYSDK_OFFSET(0xCDBB110)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_OffsetPosition___c__DisplayClass8_0_TypeDefinitionIndex = 72541;
