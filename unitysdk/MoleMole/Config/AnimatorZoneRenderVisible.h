...
#define MOLEMOLE_CONFIG_ANIMATORZONERENDERVISIBLE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0xB091100)
#define MOLEMOLE_CONFIG_ANIMATORZONERENDERVISIBLE_FINDBYNAME_OFFSET UNITYSDK_OFFSET(0xB0906B0)
#define MOLEMOLE_CONFIG_ANIMATORZONERENDERVISIBLE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xB08FF70)
#define MOLEMOLE_CONFIG_ANIMATORZONERENDERVISIBLE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xB090990)
#define MOLEMOLE_CONFIG_ANIMATORZONERENDERVISIBLE_POPRENDERERVISIBLEBYZONE_OFFSET UNITYSDK_OFFSET(0xB090800)
#define MOLEMOLE_CONFIG_ANIMATORZONERENDERVISIBLE_PUSHRENDERERVISIBLEBYZONE_OFFSET UNITYSDK_OFFSET(0xB08FD30)
#define MOLEMOLE_CONFIG_ANIMATORZONERENDERVISIBLE__CTOR_OFFSET UNITYSDK_OFFSET(0xB091180)
#define MOLEMOLE_CONFIG_ANIMATORZONERENDERVISIBLE___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0xB0911E0)
#define MOLEMOLE_CONFIG_ANIMATORZONERENDERVISIBLE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xB091260)
#define MOLEMOLE_CONFIG_ANIMATORZONERENDERVISIBLE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xB0912F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneRenderVisible_TypeDefinitionIndex = 57308;
