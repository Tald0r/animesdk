...
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATES__CTOR_OFFSET UNITYSDK_OFFSET(0x9D02660)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityRunStates_TypeDefinitionIndex = 46780;
