...
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATES__CTOR_OFFSET UNITYSDK_OFFSET(0x804FC40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityRunStates_TypeDefinitionIndex = 47689;
