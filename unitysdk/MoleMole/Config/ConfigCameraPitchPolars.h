...
#define MOLEMOLE_CONFIG_CONFIGCAMERAPITCHPOLARS__CTOR_OFFSET UNITYSDK_OFFSET(0xACBA700)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraPitchPolars_TypeDefinitionIndex = 80307;
