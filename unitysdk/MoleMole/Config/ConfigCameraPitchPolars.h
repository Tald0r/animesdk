...
#define MOLEMOLE_CONFIG_CONFIGCAMERAPITCHPOLARS__CTOR_OFFSET UNITYSDK_OFFSET(0xCC8C800)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraPitchPolars_TypeDefinitionIndex = 40193;
