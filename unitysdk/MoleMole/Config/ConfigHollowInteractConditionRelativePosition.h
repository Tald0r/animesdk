...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTCONDITIONRELATIVEPOSITION_CREATECONDITION_OFFSET UNITYSDK_OFFSET(0xACC5E90)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWINTERACTCONDITIONRELATIVEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0xACC5F90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowInteractConditionRelativePosition_TypeDefinitionIndex = 78320;
