...
#define MOLEMOLE_CONFIG_ETHEREYESFIXCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x376970)
#define MOLEMOLE_CONFIG_ETHEREYESFIXCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x3768E0)
#define MOLEMOLE_CONFIG_ETHEREYESFIXCONFIG_METHOD_2_782A6BFBCB1628EC_OFFSET UNITYSDK_OFFSET(0x376A00)
#define MOLEMOLE_CONFIG_ETHEREYESFIXCONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x3769D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EtherEyesFixConfig_TypeDefinitionIndex = 70835;
