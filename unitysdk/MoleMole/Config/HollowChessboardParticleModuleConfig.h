...
#define MOLEMOLE_CONFIG_HOLLOWCHESSBOARDPARTICLEMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCCA6170)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowChessboardParticleModuleConfig_TypeDefinitionIndex = 69424;
