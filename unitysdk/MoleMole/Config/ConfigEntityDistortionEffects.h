...
#define MOLEMOLE_CONFIG_CONFIGENTITYDISTORTIONEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0xB471A80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityDistortionEffects_TypeDefinitionIndex = 68831;
