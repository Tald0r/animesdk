...
#define MOLEMOLE_CONFIG_STAGEENTRYMODEPREFAB__CTOR_OFFSET UNITYSDK_OFFSET(0x80640E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int StageEntryModePrefab_TypeDefinitionIndex = 58693;
	...
	public:
		...
		::UnityEngine::Vector2 MapEndAnchor; // 0x28
