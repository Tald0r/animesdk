...
#define MOLEMOLE_CONFIG_DYNAMICSTRING_DYNAMICSTRING_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x9712100)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_DYNAMICSTRING_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x9712110)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_DYNAMICSTRING_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x9712400)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_DYNAMICSTRING_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9712640)
#define MOLEMOLE_CONFIG_DYNAMICSTRING_DYNAMICSTRING_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9712600)

namespace MoleMole::Config
{
	inline static constexpr unsigned int DynamicString_DynamicString_UnityGeneratedFormatter_TypeDefinitionIndex = 56995;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(DynamicString_DynamicString_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2C490);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::String*>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(DynamicString_DynamicString_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2C498);
		}
