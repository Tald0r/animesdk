...
#define MOLEMOLE_CONFIG_ANIMATORZONECOLLISIONDETECTIONMODE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x13F833C0)
#define MOLEMOLE_CONFIG_ANIMATORZONECOLLISIONDETECTIONMODE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x13F834B0)
#define MOLEMOLE_CONFIG_ANIMATORZONECOLLISIONDETECTIONMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x13F835B0)
#define MOLEMOLE_CONFIG_ANIMATORZONECOLLISIONDETECTIONMODE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x13F835C0)
#define MOLEMOLE_CONFIG_ANIMATORZONECOLLISIONDETECTIONMODE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x13F83650)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneCollisionDetectionMode_TypeDefinitionIndex = 77509;
