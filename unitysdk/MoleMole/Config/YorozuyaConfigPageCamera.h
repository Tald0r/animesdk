...
#define MOLEMOLE_CONFIG_YOROZUYACONFIGPAGECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xEC491E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int YorozuyaConfigPageCamera_TypeDefinitionIndex = 40756;
