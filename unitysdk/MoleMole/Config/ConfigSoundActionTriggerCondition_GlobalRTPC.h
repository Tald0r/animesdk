...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC_EVALUATE_OFFSET UNITYSDK_OFFSET(0x81F1020)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC_METHOD_1_F76B7A1AB354B377_OFFSET UNITYSDK_OFFSET(0x81F13C0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC__CTOR_OFFSET UNITYSDK_OFFSET(0x81F14D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundActionTriggerCondition_GlobalRTPC_TypeDefinitionIndex = 47612;
	...
	public:
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_0_16E4307DCC419505_148*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTIONTRIGGERCONDITION_GLOBALRTPC_EVALUATE_OFFSET))(this, a1);
		}
