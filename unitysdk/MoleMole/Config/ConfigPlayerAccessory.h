...
#define MOLEMOLE_CONFIG_CONFIGPLAYERACCESSORY__CTOR_OFFSET UNITYSDK_OFFSET(0x14191510)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayerAccessory_TypeDefinitionIndex = 59549;
