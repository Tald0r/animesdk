...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_PIECECHANGESTRUCTCONFIGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x6552940)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_PieceChangeStructConfigGroup_TypeDefinitionIndex = 59154;
	...
	public:
		...
		::MoleMole::Config::ConfigHollowChessboard_PieceChangeStructConfig* SinkConfig; // 0x18
		::MoleMole::Config::ConfigHollowChessboard_PieceChangeStructConfig* RiseHollowOutConfig; // 0x20
		::MoleMole::Config::ConfigHollowChessboard_PieceChangeStructConfig* SinkHollowOutConfig; // 0x28
