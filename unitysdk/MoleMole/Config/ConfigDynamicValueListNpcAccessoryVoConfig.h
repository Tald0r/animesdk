...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_CLONE_OFFSET UNITYSDK_OFFSET(0xEC3D940)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xEC3D8F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC3DF30)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0xEC3DB70)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xEC3DA40)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC3DF90)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xEC3DBF0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC3E140)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xEC3DDD0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0xEC3D770)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xEC3E2F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListNpcAccessoryVoConfig_TypeDefinitionIndex = 48529;
