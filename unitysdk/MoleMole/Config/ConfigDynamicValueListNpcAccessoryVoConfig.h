...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_CLONE_OFFSET UNITYSDK_OFFSET(0xC344270)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xC344220)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xC344860)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0xC3444A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xC344370)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xC3448C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xC344520)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xC344A70)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xC344700)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0xC3440A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTNPCACCESSORYVOCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC344C20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListNpcAccessoryVoConfig_TypeDefinitionIndex = 55463;
