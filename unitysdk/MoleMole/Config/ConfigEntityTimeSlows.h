...
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS_BRIDGEONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x13997540)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS_BRIDGEONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x13997080)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS_GETVALUETYPEENUM_OFFSET UNITYSDK_OFFSET(0x13997390)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x139978B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS__CTOR_OFFSET UNITYSDK_OFFSET(0x13997A60)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS___BASE_BRIDGEONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x13997C50)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOWS___BASE_BRIDGEONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x13997CB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityTimeSlows_TypeDefinitionIndex = 70167;
