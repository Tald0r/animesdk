...
#define MOLEMOLE_CONFIG_CONFIGEROSIONBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x89F6970)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigErosionBuff_TypeDefinitionIndex = 42335;
