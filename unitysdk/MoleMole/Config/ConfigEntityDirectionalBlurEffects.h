...
#define MOLEMOLE_CONFIG_CONFIGENTITYDIRECTIONALBLUREFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0xBAF63D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityDirectionalBlurEffects_TypeDefinitionIndex = 80477;
