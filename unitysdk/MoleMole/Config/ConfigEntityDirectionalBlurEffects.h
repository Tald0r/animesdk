...
#define MOLEMOLE_CONFIG_CONFIGENTITYDIRECTIONALBLUREFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x14189A80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityDirectionalBlurEffects_TypeDefinitionIndex = 56024;
