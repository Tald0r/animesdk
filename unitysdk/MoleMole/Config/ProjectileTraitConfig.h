...
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x3FA150)
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x3FA0C0)
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_METHOD_2_03482897E56BA861_OFFSET UNITYSDK_OFFSET(0x3FA1B0)
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x3FA1C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ProjectileTraitConfig_TypeDefinitionIndex = 74313;
