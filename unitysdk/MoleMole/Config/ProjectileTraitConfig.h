...
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x3A1AC0)
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x3A1A30)
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_METHOD_2_03482897E56BA861_OFFSET UNITYSDK_OFFSET(0x3A1B50)
#define MOLEMOLE_CONFIG_PROJECTILETRAITCONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x3A1B20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ProjectileTraitConfig_TypeDefinitionIndex = 65777;
