...
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x10A8A590)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x10A89BF0)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM_METHOD_1_1408A0A93A07AC2C_OFFSET UNITYSDK_OFFSET(0x10A896D0)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM_METHOD_1_5DAF3CA1F13D8B5E_OFFSET UNITYSDK_OFFSET(0x10A8A5F0)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM_METHOD_1_8741A88D50268453_OFFSET UNITYSDK_OFFSET(0x10A89C70)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x10A8AA40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAbilityFragmentParam_TypeDefinitionIndex = 59987;
	...
	public:
		...
		::System::Void Method_1_1408A0A93A07AC2C(::Class_0_16E4307DCC419505_144* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_144*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENTPARAM_METHOD_1_1408A0A93A07AC2C_OFFSET))(this, a1);
		}
