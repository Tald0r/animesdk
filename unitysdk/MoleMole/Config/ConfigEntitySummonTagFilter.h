...
#define MOLEMOLE_CONFIG_CONFIGENTITYSUMMONTAGFILTER_MATCHSUMMONTAG_OFFSET UNITYSDK_OFFSET(0xE2C4D60)
#define MOLEMOLE_CONFIG_CONFIGENTITYSUMMONTAGFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0xE2C4C90)
#define MOLEMOLE_CONFIG_CONFIGENTITYSUMMONTAGFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xE2C5120)
#define MOLEMOLE_CONFIG_CONFIGENTITYSUMMONTAGFILTER__MATCHSUMMONTAG_G__CHECKISSAMESUMMONER_4_1_OFFSET UNITYSDK_OFFSET(0xE2C5160)
#define MOLEMOLE_CONFIG_CONFIGENTITYSUMMONTAGFILTER__MATCHSUMMONTAG_G__CHECKISSELFSUMMONER_4_2_OFFSET UNITYSDK_OFFSET(0xE2C5130)
#define MOLEMOLE_CONFIG_CONFIGENTITYSUMMONTAGFILTER__MATCHSUMMONTAG_G__CHECKSUMMONER_4_0_OFFSET UNITYSDK_OFFSET(0xE2C50A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntitySummonTagFilter_TypeDefinitionIndex = 61820;
