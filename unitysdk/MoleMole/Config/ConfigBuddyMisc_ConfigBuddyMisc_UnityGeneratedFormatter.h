...
#define MOLEMOLE_CONFIG_CONFIGBUDDYMISC_CONFIGBUDDYMISC_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xC342610)
#define MOLEMOLE_CONFIG_CONFIGBUDDYMISC_CONFIGBUDDYMISC_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xC342620)
#define MOLEMOLE_CONFIG_CONFIGBUDDYMISC_CONFIGBUDDYMISC_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xC342B00)
#define MOLEMOLE_CONFIG_CONFIGBUDDYMISC_CONFIGBUDDYMISC_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC342E30)
#define MOLEMOLE_CONFIG_CONFIGBUDDYMISC_CONFIGBUDDYMISC_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC342DF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigBuddyMisc_ConfigBuddyMisc_UnityGeneratedFormatter_TypeDefinitionIndex = 71500;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Battle::AnimatorParamControl*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigBuddyMisc_ConfigBuddyMisc_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x422F0);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigAvatarGround*>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigAvatarGround*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigBuddyMisc_ConfigBuddyMisc_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x422F8);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::BuddyOutlineConfig*>** StaticGet_CachedSerializer3()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::BuddyOutlineConfig*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigBuddyMisc_ConfigBuddyMisc_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x42300);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::Config::BuddyBehaviourType, ::MoleMole::Config::ConfigBuddyBehaviour>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigBuddyMisc_ConfigBuddyMisc_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x42308);
		}
