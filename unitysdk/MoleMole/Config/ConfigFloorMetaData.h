...
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xB099100)
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0xB098BE0)
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0xB098C60)
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA_METHOD_1_BF50AF6BCBDE0EBC_OFFSET UNITYSDK_OFFSET(0xB099160)
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xB0994A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFloorMetaData_TypeDefinitionIndex = 81011;
