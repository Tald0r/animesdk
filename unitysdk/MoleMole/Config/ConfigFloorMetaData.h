...
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x970A6A0)
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x970A180)
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x970A200)
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA_METHOD_1_BF50AF6BCBDE0EBC_OFFSET UNITYSDK_OFFSET(0x970A700)
#define MOLEMOLE_CONFIG_CONFIGFLOORMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x970AA40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFloorMetaData_TypeDefinitionIndex = 67793;
