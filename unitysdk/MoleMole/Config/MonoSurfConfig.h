...
#define MOLEMOLE_CONFIG_MONOSURFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xEC506F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MonoSurfConfig_TypeDefinitionIndex = 49045;
