...
#define MOLEMOLE_CONFIG_MONOSURFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xF171D10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MonoSurfConfig_TypeDefinitionIndex = 58442;
