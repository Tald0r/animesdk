...
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_ISINUPDATE_OFFSET UNITYSDK_OFFSET(0x14195FC0)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_ISPOSTEND_OFFSET UNITYSDK_OFFSET(0x14196070)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_ISPOSTSTART_OFFSET UNITYSDK_OFFSET(0x14195F20)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x14196100)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG__ONFRAMECHANGED_OFFSET UNITYSDK_OFFSET(0x14195E80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EffectTimeSegmentConfig_TypeDefinitionIndex = 65532;
