...
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_ISINUPDATE_OFFSET UNITYSDK_OFFSET(0xBB036D0)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_ISPOSTEND_OFFSET UNITYSDK_OFFSET(0xBB03780)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_ISPOSTSTART_OFFSET UNITYSDK_OFFSET(0xBB03630)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xBB03810)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG__ONFRAMECHANGED_OFFSET UNITYSDK_OFFSET(0xBB03590)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EffectTimeSegmentConfig_TypeDefinitionIndex = 42276;
