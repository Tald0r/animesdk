...
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_APPLYVALUESTOCOLLIDERCFG_OFFSET UNITYSDK_OFFSET(0xACB8D40)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_ATTACHPATTERNMETHODWITHGROUPID_OFFSET UNITYSDK_OFFSET(0xACB8BF0)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_ATTACHPATTERNMETHOD_OFFSET UNITYSDK_OFFSET(0xACB8B10)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_COLLIDERCFGFILTERGETTER_OFFSET UNITYSDK_OFFSET(0xACB8F20)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xACB8CD0)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xACB8E30)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0xACB8E90)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT__CTOR_OFFSET UNITYSDK_OFFSET(0xACB8A90)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT___BASE_ATTACHPATTERNMETHOD_OFFSET UNITYSDK_OFFSET(0xACB9030)
#define MOLEMOLE_CONFIG_BOXCOLLISIONCONTINUOUSDETECT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xACB9090)

namespace MoleMole::Config
{
	inline static constexpr unsigned int BoxCollisionContinuousDetect_TypeDefinitionIndex = 80582;
