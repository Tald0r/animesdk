...
#define MOLEMOLE_CONFIG_HOLLOWPARTICLESCREENCOLORMODULECONFIG_CREATEMODULE_OFFSET UNITYSDK_OFFSET(0xBB039C0)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLESCREENCOLORMODULECONFIG_GETMODULEID_OFFSET UNITYSDK_OFFSET(0xBB03AD0)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLESCREENCOLORMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xBB03BD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowParticleScreenColorModuleConfig_TypeDefinitionIndex = 39411;
