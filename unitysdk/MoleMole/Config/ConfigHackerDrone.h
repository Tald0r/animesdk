...
#define MOLEMOLE_CONFIG_CONFIGHACKERDRONE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x84A7AE0)
#define MOLEMOLE_CONFIG_CONFIGHACKERDRONE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x84A78E0)
#define MOLEMOLE_CONFIG_CONFIGHACKERDRONE__CTOR_OFFSET UNITYSDK_OFFSET(0x84A7DA0)
#define MOLEMOLE_CONFIG_CONFIGHACKERDRONE___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x84A7EB0)
#define MOLEMOLE_CONFIG_CONFIGHACKERDRONE___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x84A7EC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHackerDrone_TypeDefinitionIndex = 36453;
