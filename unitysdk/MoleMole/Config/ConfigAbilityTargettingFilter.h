...
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETTINGFILTER_MATCHENTITYWITHLIST_OFFSET UNITYSDK_OFFSET(0xB0945C0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETTINGFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0xB0936C0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETTINGFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB094690)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAbilityTargettingFilter_TypeDefinitionIndex = 73126;
