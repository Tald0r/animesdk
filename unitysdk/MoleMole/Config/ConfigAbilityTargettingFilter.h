...
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETTINGFILTER_MATCHENTITYWITHLIST_OFFSET UNITYSDK_OFFSET(0x9705B70)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETTINGFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x9704C60)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGETTINGFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9705C40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAbilityTargettingFilter_TypeDefinitionIndex = 50573;
