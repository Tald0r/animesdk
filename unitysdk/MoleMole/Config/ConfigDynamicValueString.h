...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING_CLONE_OFFSET UNITYSDK_OFFSET(0xCD00580)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xCD00530)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xCD00B90)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING_FROMFLX_OFFSET UNITYSDK_OFFSET(0xCD007B0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xCD00380)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xCD00680)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xCD00BF0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xCD00830)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xCD003E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xCD00D80)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xCD00A30)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0xCD002A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING__CTOR_OFFSET UNITYSDK_OFFSET(0xCD004E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUESTRING___BASE_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xCD00F30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueString_TypeDefinitionIndex = 43203;
