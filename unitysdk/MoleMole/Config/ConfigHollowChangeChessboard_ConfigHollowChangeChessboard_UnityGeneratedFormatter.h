...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGECHESSBOARD_CONFIGHOLLOWCHANGECHESSBOARD_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x80547E0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGECHESSBOARD_CONFIGHOLLOWCHANGECHESSBOARD_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x80547F0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGECHESSBOARD_CONFIGHOLLOWCHANGECHESSBOARD_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x80549F0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGECHESSBOARD_CONFIGHOLLOWCHANGECHESSBOARD_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8054BB0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGECHESSBOARD_CONFIGHOLLOWCHANGECHESSBOARD_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x8054B70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChangeChessboard_ConfigHollowChangeChessboard_UnityGeneratedFormatter_TypeDefinitionIndex = 55933;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::ProtoScript::DirectType, ::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigHollowChangeChessboard_ConfigHollowChangeChessboard_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x384B0);
		}
