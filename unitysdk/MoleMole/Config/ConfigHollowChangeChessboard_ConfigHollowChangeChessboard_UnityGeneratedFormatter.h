...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGECHESSBOARD_CONFIGHOLLOWCHANGECHESSBOARD_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x9D07250)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGECHESSBOARD_CONFIGHOLLOWCHANGECHESSBOARD_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x9D07260)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGECHESSBOARD_CONFIGHOLLOWCHANGECHESSBOARD_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x9D07460)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGECHESSBOARD_CONFIGHOLLOWCHANGECHESSBOARD_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9D07620)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGECHESSBOARD_CONFIGHOLLOWCHANGECHESSBOARD_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D075E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChangeChessboard_ConfigHollowChangeChessboard_UnityGeneratedFormatter_TypeDefinitionIndex = 68868;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::ProtoScript::DirectType, ::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigHollowChangeChessboard_ConfigHollowChangeChessboard_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3B0C0);
		}
