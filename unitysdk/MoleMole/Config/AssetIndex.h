...
#define MOLEMOLE_CONFIG_ASSETINDEX_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x80426F0)
#define MOLEMOLE_CONFIG_ASSETINDEX_FROMFLX_OFFSET UNITYSDK_OFFSET(0x80421A0)
#define MOLEMOLE_CONFIG_ASSETINDEX_METHOD_1_0CB3D614A4DB34A1_OFFSET UNITYSDK_OFFSET(0x8042220)
#define MOLEMOLE_CONFIG_ASSETINDEX_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x8042B00)
#define MOLEMOLE_CONFIG_ASSETINDEX_METHOD_1_207EA35309D0E29E_OFFSET UNITYSDK_OFFSET(0x8042B40)
#define MOLEMOLE_CONFIG_ASSETINDEX_METHOD_1_C68CB15A07D0E2EF_OFFSET UNITYSDK_OFFSET(0x8042750)
#define MOLEMOLE_CONFIG_ASSETINDEX_METHOD_1_E1ABFEC245988AD5_OFFSET UNITYSDK_OFFSET(0x8042A10)
#define MOLEMOLE_CONFIG_ASSETINDEX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8041BE0)
#define MOLEMOLE_CONFIG_ASSETINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x8042A00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AssetIndex_TypeDefinitionIndex = 51430;
