...
#define MOLEMOLE_CONFIG_CONFIGSTARTBLESSEFFECTNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xF2D8D20)
#define MOLEMOLE_CONFIG_CONFIGSTARTBLESSEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xF2D8E00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigStartBlessEffectNode_TypeDefinitionIndex = 43968;
