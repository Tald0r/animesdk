...
#define MOLEMOLE_CONFIG_CONFIGSTARTBLESSEFFECTNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x13F9F170)
#define MOLEMOLE_CONFIG_CONFIGSTARTBLESSEFFECTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x13F9F250)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigStartBlessEffectNode_TypeDefinitionIndex = 56312;
