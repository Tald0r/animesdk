...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_CLONE_OFFSET UNITYSDK_OFFSET(0xBAEFC60)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xBAEFC50)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xBAF0230)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_FROMFLX_OFFSET UNITYSDK_OFFSET(0xBAEFE90)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xBAEFAA0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xBAEFD60)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xBAF0290)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xBAEFF10)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xBAEFB00)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xBAF04C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xBAF00D0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0xBAEF9D0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT__CTOR_OFFSET UNITYSDK_OFFSET(0xBAEFC00)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEINT___BASE_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xBAF0670)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueInt_TypeDefinitionIndex = 70535;
