...
#define MOLEMOLE_CONFIG_PLAYERACCESSORYTABDATA_METHOD_1_E87E8159DBF445E8_OFFSET UNITYSDK_OFFSET(0xE0C2410)
#define MOLEMOLE_CONFIG_PLAYERACCESSORYTABDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE0C2400)

namespace MoleMole::Config
{
	inline static constexpr unsigned int PlayerAccessoryTabData_TypeDefinitionIndex = 70166;
