...
#define MOLEMOLE_CONFIG_CONFIGSURFVEHICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x8A0C3A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSurfVehicle_TypeDefinitionIndex = 75750;
