...
#define MOLEMOLE_CONFIG_PATTERNSHAPEBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x8063A60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int PatternShapeBox_TypeDefinitionIndex = 56589;
