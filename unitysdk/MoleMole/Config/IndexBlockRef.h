...
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x10AA8480)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0x10AA80C0)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x10AA8740)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_METHOD_1_1D8C60247E81BA7F_OFFSET UNITYSDK_OFFSET(0x10AA84E0)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x10AA8140)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x10AA7DA0)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF__CTOR_OFFSET UNITYSDK_OFFSET(0x10AA8730)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexBlockRef_TypeDefinitionIndex = 58823;
