...
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x8A0F470)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0x8A0F3F0)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0xE0C1520)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_METHOD_1_1D8C60247E81BA7F_OFFSET UNITYSDK_OFFSET(0xE0C12D0)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0xE0C1560)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8A0F0D0)
#define MOLEMOLE_CONFIG_INDEXBLOCKREF__CTOR_OFFSET UNITYSDK_OFFSET(0xE0C12C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexBlockRef_TypeDefinitionIndex = 43982;
