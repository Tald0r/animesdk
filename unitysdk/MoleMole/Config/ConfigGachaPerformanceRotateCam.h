...
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCEROTATECAM_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCD06FE0)
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCEROTATECAM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD07070)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGachaPerformanceRotateCam_TypeDefinitionIndex = 59531;
