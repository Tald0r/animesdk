...
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCEROTATECAM_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xE35F4C0)
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCEROTATECAM__CTOR_OFFSET UNITYSDK_OFFSET(0xE35F550)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGachaPerformanceRotateCam_TypeDefinitionIndex = 62946;
