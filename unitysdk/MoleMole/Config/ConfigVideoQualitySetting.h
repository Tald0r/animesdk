...
#define MOLEMOLE_CONFIG_CONFIGVIDEOQUALITYSETTING_ISMATCHED_OFFSET UNITYSDK_OFFSET(0xCDBD3D0)
#define MOLEMOLE_CONFIG_CONFIGVIDEOQUALITYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xCDBD4D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigVideoQualitySetting_TypeDefinitionIndex = 45337;
