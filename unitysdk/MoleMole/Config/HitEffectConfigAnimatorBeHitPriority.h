...
#define MOLEMOLE_CONFIG_HITEFFECTCONFIGANIMATORBEHITPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x8A0E060)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HitEffectConfigAnimatorBeHitPriority_TypeDefinitionIndex = 54240;
