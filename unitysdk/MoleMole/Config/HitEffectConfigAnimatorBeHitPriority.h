...
#define MOLEMOLE_CONFIG_HITEFFECTCONFIGANIMATORBEHITPRIORITY__CTOR_OFFSET UNITYSDK_OFFSET(0x10AA6D40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HitEffectConfigAnimatorBeHitPriority_TypeDefinitionIndex = 51038;
	...
	public:
		...
		::MoleMole::Config::AnimatorAirHitType attackFrameAirHitType; // 0x20
