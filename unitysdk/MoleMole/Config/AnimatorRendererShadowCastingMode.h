...
#define MOLEMOLE_CONFIG_ANIMATORRENDERERSHADOWCASTINGMODE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0xCD98CD0)
#define MOLEMOLE_CONFIG_ANIMATORRENDERERSHADOWCASTINGMODE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xCD980B0)
#define MOLEMOLE_CONFIG_ANIMATORRENDERERSHADOWCASTINGMODE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xCD98740)
#define MOLEMOLE_CONFIG_ANIMATORRENDERERSHADOWCASTINGMODE_POPRENDERERSHADOWCASTINGBYZONE_OFFSET UNITYSDK_OFFSET(0xCD985B0)
#define MOLEMOLE_CONFIG_ANIMATORRENDERERSHADOWCASTINGMODE_PUSHRENDERERSHADOWCASTINGBYZONE_OFFSET UNITYSDK_OFFSET(0xCD97E70)
#define MOLEMOLE_CONFIG_ANIMATORRENDERERSHADOWCASTINGMODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCD98D70)
#define MOLEMOLE_CONFIG_ANIMATORRENDERERSHADOWCASTINGMODE___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0xCD98DD0)
#define MOLEMOLE_CONFIG_ANIMATORRENDERERSHADOWCASTINGMODE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xCD98E50)
#define MOLEMOLE_CONFIG_ANIMATORRENDERERSHADOWCASTINGMODE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xCD98EE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorRendererShadowCastingMode_TypeDefinitionIndex = 42004;
