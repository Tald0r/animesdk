...
#define MOLEMOLE_CONFIG_HOLLOWPARTICLEINITIALMODULECONFIG_CREATEMODULE_OFFSET UNITYSDK_OFFSET(0xE440540)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLEINITIALMODULECONFIG_GETMODULEID_OFFSET UNITYSDK_OFFSET(0xE440650)
#define MOLEMOLE_CONFIG_HOLLOWPARTICLEINITIALMODULECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE440750)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowParticleInitialModuleConfig_TypeDefinitionIndex = 58209;
