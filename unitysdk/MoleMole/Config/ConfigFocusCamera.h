...
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_CLEAN_OFFSET UNITYSDK_OFFSET(0x9D06D50)
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x9D06B80)
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x9D06DE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFocusCamera_TypeDefinitionIndex = 69119;
	...
	public:
		...
		{
			return (::MoleMole::Config::ConfigFocusCamera**)Il2CppClass::FromTypeDefinitionIndex(ConfigFocusCamera_TypeDefinitionIndex)->GetStaticField(0x3B0B0);
		}
