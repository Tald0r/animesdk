...
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_CLEAN_OFFSET UNITYSDK_OFFSET(0x80542E0)
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x8054110)
#define MOLEMOLE_CONFIG_CONFIGFOCUSCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x8054370)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFocusCamera_TypeDefinitionIndex = 67741;
	...
	public:
		...
		{
			return (::MoleMole::Config::ConfigFocusCamera**)Il2CppClass::FromTypeDefinitionIndex(ConfigFocusCamera_TypeDefinitionIndex)->GetStaticField(0x384A0);
		}
