...
#define MOLEMOLE_CONFIG_BASEHOLLOWCAMERAPREDICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x9703400)

namespace MoleMole::Config
{
	inline static constexpr unsigned int BaseHollowCameraPredicate_TypeDefinitionIndex = 66433;
