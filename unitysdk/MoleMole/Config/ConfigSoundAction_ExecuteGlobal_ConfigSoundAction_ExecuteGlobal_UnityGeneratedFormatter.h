...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_EXECUTEGLOBAL_CONFIGSOUNDACTION_EXECUTEGLOBAL_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCD14010)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_EXECUTEGLOBAL_CONFIGSOUNDACTION_EXECUTEGLOBAL_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCD14020)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_EXECUTEGLOBAL_CONFIGSOUNDACTION_EXECUTEGLOBAL_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCD14220)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_EXECUTEGLOBAL_CONFIGSOUNDACTION_EXECUTEGLOBAL_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD143E0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_EXECUTEGLOBAL_CONFIGSOUNDACTION_EXECUTEGLOBAL_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD143A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_ExecuteGlobal_ConfigSoundAction_ExecuteGlobal_UnityGeneratedFormatter_TypeDefinitionIndex = 67720;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_ExecuteGlobal_ConfigSoundAction_ExecuteGlobal_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2F800);
		}
