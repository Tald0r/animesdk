...
#define MOLEMOLE_CONFIG_CONFIGDAMAGESTAGGERLEVEL_DAMAGESTAGGERLEVELITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9706A40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDamageStaggerLevel_DamageStaggerLevelItem_TypeDefinitionIndex = 71881;
	...
	public:
		...
		::System::Int32 damageStaggerLevel; // 0x18
