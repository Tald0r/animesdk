...
#define MOLEMOLE_CONFIG_CONFIGDAMAGESTAGGERLEVEL_DAMAGESTAGGERLEVELITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xB095490)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDamageStaggerLevel_DamageStaggerLevelItem_TypeDefinitionIndex = 74382;
