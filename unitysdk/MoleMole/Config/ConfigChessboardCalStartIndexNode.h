...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCALSTARTINDEXNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x84A4700)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCALSTARTINDEXNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x84A47E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardCalStartIndexNode_TypeDefinitionIndex = 51332;
