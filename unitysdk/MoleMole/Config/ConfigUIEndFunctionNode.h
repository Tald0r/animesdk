...
#define MOLEMOLE_CONFIG_CONFIGUIENDFUNCTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x950F390)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIEndFunctionNode_TypeDefinitionIndex = 41808;
