...
#define MOLEMOLE_CONFIG_CONFIGUIENDFUNCTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE437F10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIEndFunctionNode_TypeDefinitionIndex = 40697;
