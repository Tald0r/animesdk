...
#define MOLEMOLE_CONFIG_ANIMATORZONEADDBUDDYMOVEXZ_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x10A806B0)
#define MOLEMOLE_CONFIG_ANIMATORZONEADDBUDDYMOVEXZ_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x10A80750)
#define MOLEMOLE_CONFIG_ANIMATORZONEADDBUDDYMOVEXZ_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x10A80990)
#define MOLEMOLE_CONFIG_ANIMATORZONEADDBUDDYMOVEXZ__CTOR_OFFSET UNITYSDK_OFFSET(0x10A80AD0)
#define MOLEMOLE_CONFIG_ANIMATORZONEADDBUDDYMOVEXZ___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x10A80AE0)
#define MOLEMOLE_CONFIG_ANIMATORZONEADDBUDDYMOVEXZ___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x10A80B60)
#define MOLEMOLE_CONFIG_ANIMATORZONEADDBUDDYMOVEXZ___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x10A80BF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneAddBuddyMoveXZ_TypeDefinitionIndex = 71194;
