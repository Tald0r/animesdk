...
#define MOLEMOLE_CONFIG_AUDIORTPCCONVERT_AUDIORTPCCONVERT_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCC8A3E0)
#define MOLEMOLE_CONFIG_AUDIORTPCCONVERT_AUDIORTPCCONVERT_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCC8A3F0)
#define MOLEMOLE_CONFIG_AUDIORTPCCONVERT_AUDIORTPCCONVERT_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCC8A770)
#define MOLEMOLE_CONFIG_AUDIORTPCCONVERT_AUDIORTPCCONVERT_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCC8A9E0)
#define MOLEMOLE_CONFIG_AUDIORTPCCONVERT_AUDIORTPCCONVERT_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC8A9A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AudioRTPCConvert_AudioRTPCConvert_UnityGeneratedFormatter_TypeDefinitionIndex = 57128;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(AudioRTPCConvert_AudioRTPCConvert_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x36390);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::AudioRTPCConvert_ConvertType>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::AudioRTPCConvert_ConvertType>**)Il2CppClass::FromTypeDefinitionIndex(AudioRTPCConvert_AudioRTPCConvert_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x36398);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Single>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(AudioRTPCConvert_AudioRTPCConvert_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x363A0);
		}
