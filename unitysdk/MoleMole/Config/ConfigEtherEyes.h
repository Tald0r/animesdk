...
#define MOLEMOLE_CONFIG_CONFIGETHEREYES__CTOR_OFFSET UNITYSDK_OFFSET(0x89F6980)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEtherEyes_TypeDefinitionIndex = 46842;
