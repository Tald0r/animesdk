...
#define MOLEMOLE_CONFIG_CONFIGETHEREYES__CTOR_OFFSET UNITYSDK_OFFSET(0x10A8F5A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEtherEyes_TypeDefinitionIndex = 53905;
