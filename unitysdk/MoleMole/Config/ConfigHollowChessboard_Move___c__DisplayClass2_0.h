...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x13F94FB0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE___C__DISPLAYCLASS2_0__RUN_B__0_OFFSET UNITYSDK_OFFSET(0x13F94FC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_Move___c__DisplayClass2_0_TypeDefinitionIndex = 59103;
	...
	public:
		...
		::MoleMole::Config::ConfigHollowChessboard_Move* __4__this; // 0x18
