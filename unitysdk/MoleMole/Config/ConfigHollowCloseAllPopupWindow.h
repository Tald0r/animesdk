...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCLOSEALLPOPUPWINDOW_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCD07E70)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCLOSEALLPOPUPWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0xCD07F50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowCloseAllPopupWindow_TypeDefinitionIndex = 51416;
