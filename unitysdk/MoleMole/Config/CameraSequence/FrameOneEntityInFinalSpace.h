...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0xCDA0820)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0xCDA08B0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0xCDA0A90)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0xCDA0B70)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0xCDA0A30)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xCDA0B60)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE_ISLOOP_OFFSET UNITYSDK_OFFSET(0xCDA0B00)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE_METHOD_5_24B1E1DE85E3C92F_OFFSET UNITYSDK_OFFSET(0xCDA1550)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE_METHOD_5_2C57E01B5F9E414E_OFFSET UNITYSDK_OFFSET(0xCDA13B0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE_METHOD_5_4CD32A88D1373B75_OFFSET UNITYSDK_OFFSET(0xCDA0EA0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE_METHOD_5_67A0C6C4B5A4811F_OFFSET UNITYSDK_OFFSET(0xCDA1480)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE__CCTOR_OFFSET UNITYSDK_OFFSET(0xCDA12C0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE__CTOR_OFFSET UNITYSDK_OFFSET(0xCDA1270)

namespace MoleMole::Config::CameraSequence
{
	inline static constexpr unsigned int FrameOneEntityInFinalSpace_TypeDefinitionIndex = 71572;
	...
	public:
		...
		{
			return (::System::Func_5<::MoleMole::Config::CameraSequence::FrameOneEntityInFinalSpace*, ::System::Single, ::PipelineCamera::WorldBasicCameraData, ::PipelineCamera::CameraSequence::CameraSequenceContext*, ::PipelineCamera::WorldBasicCameraData>**)Il2CppClass::FromTypeDefinitionIndex(FrameOneEntityInFinalSpace_TypeDefinitionIndex)->GetStaticField(0x3E980);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_resampleEachTime()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOneEntityInFinalSpace_TypeDefinitionIndex)->GetStaticField(0xF880);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_EntityId()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOneEntityInFinalSpace_TypeDefinitionIndex)->GetStaticField(0xF888);
		}
		static ::Foundation::Unreal::FName* StaticGet_CachedId()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOneEntityInFinalSpace_TypeDefinitionIndex)->GetStaticField(0xF890);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_EntityWorld()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOneEntityInFinalSpace_TypeDefinitionIndex)->GetStaticField(0xF898);
		}
		...
		static ::PipelineCamera::WorldBasicCameraData Method_5_4CD32A88D1373B75(::MoleMole::Config::CameraSequence::FrameOneEntityInFinalSpace* a1, ::System::Single a2, ::PipelineCamera::WorldBasicCameraData a3, ::PipelineCamera::CameraSequence::CameraSequenceContext* a4)
		{
			return ((::PipelineCamera::WorldBasicCameraData(*)(::MoleMole::Config::CameraSequence::FrameOneEntityInFinalSpace*, ::System::Single, ::PipelineCamera::WorldBasicCameraData, ::PipelineCamera::CameraSequence::CameraSequenceContext*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CAMERASEQUENCE_FRAMEONEENTITYINFINALSPACE_METHOD_5_4CD32A88D1373B75_OFFSET))(a1, a2, a3, a4);
		}
