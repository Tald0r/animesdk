...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x81E5550)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_GETDATA_OFFSET UNITYSDK_OFFSET(0x81E5710)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x81E58C0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_METHOD_4_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0x81E5930)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_METHOD_4_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0x81E59A0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_METHOD_4_B56EBF9AD2EEE9E9_OFFSET UNITYSDK_OFFSET(0x81E5A60)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_SETPATH_OFFSET UNITYSDK_OFFSET(0x81E5490)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x81E58F0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x81E58D0)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int EntityLocationPolicy_External_TypeDefinitionIndex = 38208;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(EntityLocationPolicy_External_TypeDefinitionIndex)->GetStaticField(0x10F10);
		}
