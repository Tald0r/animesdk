...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x6549E90)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_GETDATA_OFFSET UNITYSDK_OFFSET(0x654A050)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x654A200)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_METHOD_4_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0x654A380)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_METHOD_4_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0x654A3F0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_METHOD_4_B56EBF9AD2EEE9E9_OFFSET UNITYSDK_OFFSET(0x654A270)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL_SETPATH_OFFSET UNITYSDK_OFFSET(0x6549DD0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x654A230)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_ENTITYLOCATIONPOLICY_EXTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x654A210)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int EntityLocationPolicy_External_TypeDefinitionIndex = 40292;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(EntityLocationPolicy_External_TypeDefinitionIndex)->GetStaticField(0x11250);
		}
