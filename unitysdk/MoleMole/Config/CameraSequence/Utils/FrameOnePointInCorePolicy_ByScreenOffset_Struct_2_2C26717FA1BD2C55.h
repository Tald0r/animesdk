...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYSCREENOFFSET_STRUCT_2_2C26717FA1BD2C55_METHOD_2_1B42B5B56F439BBC_OFFSET UNITYSDK_OFFSET(0x4D7080)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYSCREENOFFSET_STRUCT_2_2C26717FA1BD2C55__CTOR_OFFSET UNITYSDK_OFFSET(0x4D7070)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int FrameOnePointInCorePolicy_ByScreenOffset_Struct_2_2C26717FA1BD2C55_TypeDefinitionIndex = 72331;
