...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMETWOPOINTSINCOREPOLICY_LEVELSETTLEMENT_STRUCT_2_3FA97CC54A1F2DCC_COMPARE_OFFSET UNITYSDK_OFFSET(0x366750)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMETWOPOINTSINCOREPOLICY_LEVELSETTLEMENT_STRUCT_2_3FA97CC54A1F2DCC_GET_MAXPITCH_OFFSET UNITYSDK_OFFSET(0x319420)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMETWOPOINTSINCOREPOLICY_LEVELSETTLEMENT_STRUCT_2_3FA97CC54A1F2DCC_GET_MINPITCH_OFFSET UNITYSDK_OFFSET(0x319410)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMETWOPOINTSINCOREPOLICY_LEVELSETTLEMENT_STRUCT_2_3FA97CC54A1F2DCC__CTOR_OFFSET UNITYSDK_OFFSET(0x319320)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int FrameTwoPointsInCorePolicy_LevelSettlement_Struct_2_3FA97CC54A1F2DCC_TypeDefinitionIndex = 39523;
