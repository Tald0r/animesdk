...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0x81E5C30)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_GETDATA_OFFSET UNITYSDK_OFFSET(0x81E5DF0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0x81E6700)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_0B7DB58570700F2E_OFFSET UNITYSDK_OFFSET(0x81E6AA0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0x81E6C80)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0x81E6DD0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_834919B5E4C42716_OFFSET UNITYSDK_OFFSET(0x81E6810)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_83ED25F6A8C66D20_OFFSET UNITYSDK_OFFSET(0x81E69D0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_C1397965C8E8E75A_1_OFFSET UNITYSDK_OFFSET(0x81E6CF0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_METHOD_4_C1397965C8E8E75A_OFFSET UNITYSDK_OFFSET(0x81E68F0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF_SETPATH_OFFSET UNITYSDK_OFFSET(0x81E5B70)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF__CCTOR_OFFSET UNITYSDK_OFFSET(0x81E6750)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_FRAMEONEPOINTINCOREPOLICY_BYHSF__CTOR_OFFSET UNITYSDK_OFFSET(0x81E6710)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int FrameOnePointInCorePolicy_ByHSF_TypeDefinitionIndex = 79024;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByHSF_TypeDefinitionIndex)->GetStaticField(0x10F20);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_EntityHeight()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByHSF_TypeDefinitionIndex)->GetStaticField(0x10F28);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_heightRatio()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByHSF_TypeDefinitionIndex)->GetStaticField(0x10F30);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_screenOffset()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(FrameOnePointInCorePolicy_ByHSF_TypeDefinitionIndex)->GetStaticField(0x10F38);
		}
