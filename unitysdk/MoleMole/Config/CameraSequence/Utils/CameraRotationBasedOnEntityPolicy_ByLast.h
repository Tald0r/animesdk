...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0xCDA2350)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST_GETDATA_OFFSET UNITYSDK_OFFSET(0xCDA2510)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xCDA2C90)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST_METHOD_4_14818C3563DF6DE0_OFFSET UNITYSDK_OFFSET(0xCDA2DB0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST_METHOD_4_439B588EB4881570_OFFSET UNITYSDK_OFFSET(0xCDA3180)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST_METHOD_4_5A60CCF7370A1875_OFFSET UNITYSDK_OFFSET(0xCDA31F0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST_METHOD_4_8067ABEE1E847951_OFFSET UNITYSDK_OFFSET(0xCDA2780)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST_METHOD_4_8958B8FE55CDB36F_OFFSET UNITYSDK_OFFSET(0xCDA32B0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST_METHOD_4_C1397965C8E8E75A_1_OFFSET UNITYSDK_OFFSET(0xCDA2FC0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST_METHOD_4_C1397965C8E8E75A_2_OFFSET UNITYSDK_OFFSET(0xCDA30A0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST_METHOD_4_C1397965C8E8E75A_OFFSET UNITYSDK_OFFSET(0xCDA2EE0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST_SETPATH_OFFSET UNITYSDK_OFFSET(0xCDA2290)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST__CCTOR_OFFSET UNITYSDK_OFFSET(0xCDA2CC0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_UTILS_CAMERAROTATIONBASEDONENTITYPOLICY_BYLAST__CTOR_OFFSET UNITYSDK_OFFSET(0xCDA2CA0)

namespace MoleMole::Config::CameraSequence::Utils
{
	inline static constexpr unsigned int CameraRotationBasedOnEntityPolicy_ByLast_TypeDefinitionIndex = 60635;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraRotationBasedOnEntityPolicy_ByLast_TypeDefinitionIndex)->GetStaticField(0xF8B0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_pitch()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraRotationBasedOnEntityPolicy_ByLast_TypeDefinitionIndex)->GetStaticField(0xF8B8);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_LastCameraData()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraRotationBasedOnEntityPolicy_ByLast_TypeDefinitionIndex)->GetStaticField(0xF8C0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_roll()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraRotationBasedOnEntityPolicy_ByLast_TypeDefinitionIndex)->GetStaticField(0xF8C8);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_EntityRotation()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(CameraRotationBasedOnEntityPolicy_ByLast_TypeDefinitionIndex)->GetStaticField(0xF8D0);
		}
