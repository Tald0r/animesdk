...
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_BUILDRUNTIMEDATAPROVIDERDATAPATH_OFFSET UNITYSDK_OFFSET(0xCDA1630)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_COLLECTVARIABLE_OFFSET UNITYSDK_OFFSET(0xCDA16C0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_GETRATESCALE_OFFSET UNITYSDK_OFFSET(0xCDA18A0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_GETSEQUENCEDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0xCDA1980)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_GETSEQUENCELENGTH_OFFSET UNITYSDK_OFFSET(0xCDA1840)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_GET_ISCONTEXTDEPENDENT_OFFSET UNITYSDK_OFFSET(0xCDA1970)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_ISLOOP_OFFSET UNITYSDK_OFFSET(0xCDA1910)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_METHOD_5_0FAC3EB0A072AD38_OFFSET UNITYSDK_OFFSET(0xCDA20F0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME_METHOD_5_83ED25F6A8C66D20_OFFSET UNITYSDK_OFFSET(0xCDA21C0)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME__CCTOR_OFFSET UNITYSDK_OFFSET(0xCDA2070)
#define MOLEMOLE_CONFIG_CAMERASEQUENCE_HANDLECAMERAVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0xCDA2030)

namespace MoleMole::Config::CameraSequence
{
	inline static constexpr unsigned int HandleCameraVolume_TypeDefinitionIndex = 52400;
	...
	public:
		...
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(HandleCameraVolume_TypeDefinitionIndex)->GetStaticField(0xF8A0);
		}
		static ::Foundation::Unreal::FName* StaticGet___some_prefix_to_avoid_conflict_NearClipPlane()
		{
			return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(HandleCameraVolume_TypeDefinitionIndex)->GetStaticField(0xF8A8);
		}
