...
#define MOLEMOLE_CONFIG_SKINMDBDATAOFRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x6DFA070)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SkinMdbDataOfRenderer_TypeDefinitionIndex = 40168;
