...
#define MOLEMOLE_CONFIG_INDEXASSETREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x8062370)
#define MOLEMOLE_CONFIG_INDEXASSETREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0x8061FB0)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x8062630)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_297EA0FD117460C4_OFFSET UNITYSDK_OFFSET(0x80623D0)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_3FA063706A9B5149_OFFSET UNITYSDK_OFFSET(0x8042D50)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x8062030)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_A8C27B239C77A1A6_OFFSET UNITYSDK_OFFSET(0x8062670)
#define MOLEMOLE_CONFIG_INDEXASSETREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8061C90)
#define MOLEMOLE_CONFIG_INDEXASSETREF__CTOR_OFFSET UNITYSDK_OFFSET(0x8043520)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexAssetRef_TypeDefinitionIndex = 78929;
