...
#define MOLEMOLE_CONFIG_INDEXASSETREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x9D154B0)
#define MOLEMOLE_CONFIG_INDEXASSETREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0x9D150F0)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x9D15780)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_297EA0FD117460C4_OFFSET UNITYSDK_OFFSET(0x9D15510)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_3FA063706A9B5149_OFFSET UNITYSDK_OFFSET(0x9CF5710)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x9D15170)
#define MOLEMOLE_CONFIG_INDEXASSETREF_METHOD_1_A8C27B239C77A1A6_OFFSET UNITYSDK_OFFSET(0x9D157C0)
#define MOLEMOLE_CONFIG_INDEXASSETREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9D14DD0)
#define MOLEMOLE_CONFIG_INDEXASSETREF__CTOR_OFFSET UNITYSDK_OFFSET(0x9D15770)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexAssetRef_TypeDefinitionIndex = 55869;
