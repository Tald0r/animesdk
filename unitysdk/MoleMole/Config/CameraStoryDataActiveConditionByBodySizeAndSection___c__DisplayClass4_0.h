...
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZEANDSECTION___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB46AB00)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZEANDSECTION___C__DISPLAYCLASS4_0__PASS_B__0_OFFSET UNITYSDK_OFFSET(0xB46AB10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraStoryDataActiveConditionByBodySizeAndSection___c__DisplayClass4_0_TypeDefinitionIndex = 43660;
