...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE_CLONE_OFFSET UNITYSDK_OFFSET(0x804BB50)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x804BB40)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x804C120)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x804BD80)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0x804B980)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x804BC50)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x804C180)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x804BE00)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x804B9E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x804C2E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x804BFC0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x804B8A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x804BAF0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEDOUBLE___BASE_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0x804C490)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueDouble_TypeDefinitionIndex = 55919;
