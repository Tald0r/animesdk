...
#define MOLEMOLE_CONFIG_CAMERAMOVETIME__CTOR_OFFSET UNITYSDK_OFFSET(0x6548830)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraMoveTime_TypeDefinitionIndex = 37512;
