...
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_CLONE_OFFSET UNITYSDK_OFFSET(0x805AAD0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x805AA40)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x805B6B0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_FROMFLX_OFFSET UNITYSDK_OFFSET(0x805ACE0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x805ABB0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x805B710)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x805AD60)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x805BBC0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x805B550)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_PROCESSRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x805A910)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x805A6C0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x805BD70)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL___BASE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x805BD80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMovementSimpleSpherical_TypeDefinitionIndex = 66893;
	...
	public:
		...
		::System::Boolean KeepRelativePosition; // 0x4C
		::System::Boolean KeepCoordOnStart; // 0x4D
		::UnityEngine::Vector3 Acceleration; // 0x50
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_F35B080B137ECC46*, ::Class_3_248DACE3BB3053DD*, ::System::Single, ::System::Single, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLESPHERICAL_PROCESSRIGIDBODY_OFFSET))(this, modelComponent, movementComponent, deltaTime, timeScale, instancedAbility);
		}
