...
#define MOLEMOLE_CONFIG_HOLLOWCHESSBOARDPARTICLECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9D14D50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowChessboardParticleConfig_TypeDefinitionIndex = 59569;
