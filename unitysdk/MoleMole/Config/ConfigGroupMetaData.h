...
#define MOLEMOLE_CONFIG_CONFIGGROUPMETADATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xACC55B0)
#define MOLEMOLE_CONFIG_CONFIGGROUPMETADATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0xACC5370)
#define MOLEMOLE_CONFIG_CONFIGGROUPMETADATA_METHOD_1_0BD393E566CD3D4A_OFFSET UNITYSDK_OFFSET(0xACC53F0)
#define MOLEMOLE_CONFIG_CONFIGGROUPMETADATA_METHOD_1_F4FDF6DDB7D0ADBB_OFFSET UNITYSDK_OFFSET(0xACC5610)
#define MOLEMOLE_CONFIG_CONFIGGROUPMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xACC5840)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGroupMetaData_TypeDefinitionIndex = 59369;
