...
#define MOLEMOLE_CONFIG_CONFIGGROUPMETADATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xCC97620)
#define MOLEMOLE_CONFIG_CONFIGGROUPMETADATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0xCC973E0)
#define MOLEMOLE_CONFIG_CONFIGGROUPMETADATA_METHOD_1_0BD393E566CD3D4A_OFFSET UNITYSDK_OFFSET(0xCC97460)
#define MOLEMOLE_CONFIG_CONFIGGROUPMETADATA_METHOD_1_F4FDF6DDB7D0ADBB_OFFSET UNITYSDK_OFFSET(0xCC97680)
#define MOLEMOLE_CONFIG_CONFIGGROUPMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xCC978B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGroupMetaData_TypeDefinitionIndex = 43923;
