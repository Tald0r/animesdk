...
#define MOLEMOLE_CONFIG_CONFIGCITYHOLLOWMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x804AB20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCityHollowMap_TypeDefinitionIndex = 72792;
