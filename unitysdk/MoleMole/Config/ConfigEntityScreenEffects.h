...
#define MOLEMOLE_CONFIG_CONFIGENTITYSCREENEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x84A7080)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityScreenEffects_TypeDefinitionIndex = 48383;
