...
#define MOLEMOLE_CONFIG_SURFGAMEITEMDATAENTRY_ISVALID_OFFSET UNITYSDK_OFFSET(0x3AA530)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SurfGameItemDataEntry_TypeDefinitionIndex = 40884;
