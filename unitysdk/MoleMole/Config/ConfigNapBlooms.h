...
#define MOLEMOLE_CONFIG_CONFIGNAPBLOOMS__CTOR_OFFSET UNITYSDK_OFFSET(0x624F710)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigNapBlooms_TypeDefinitionIndex = 44348;
