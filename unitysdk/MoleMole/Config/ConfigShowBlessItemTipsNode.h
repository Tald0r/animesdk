...
#define MOLEMOLE_CONFIG_CONFIGSHOWBLESSITEMTIPSNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCDB8840)
#define MOLEMOLE_CONFIG_CONFIGSHOWBLESSITEMTIPSNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCDB8920)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigShowBlessItemTipsNode_TypeDefinitionIndex = 44902;
