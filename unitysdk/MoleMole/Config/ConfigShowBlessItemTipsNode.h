...
#define MOLEMOLE_CONFIG_CONFIGSHOWBLESSITEMTIPSNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xD09D8B0)
#define MOLEMOLE_CONFIG_CONFIGSHOWBLESSITEMTIPSNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xD09D990)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigShowBlessItemTipsNode_TypeDefinitionIndex = 55826;
