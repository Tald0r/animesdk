...
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCREATIONDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x3AA2D0)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCREATIONDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x3AA240)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCREATIONDATA_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x3AA340)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCREATIONDATA_METHOD_2_E4D020DE71A7D4FC_OFFSET UNITYSDK_OFFSET(0x3AA330)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTriggerCreationData_TypeDefinitionIndex = 50821;
