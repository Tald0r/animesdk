...
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCREATIONDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x5397E0)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCREATIONDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x539750)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCREATIONDATA_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x539840)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERCREATIONDATA_METHOD_2_E4D020DE71A7D4FC_OFFSET UNITYSDK_OFFSET(0x539870)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTriggerCreationData_TypeDefinitionIndex = 69837;
