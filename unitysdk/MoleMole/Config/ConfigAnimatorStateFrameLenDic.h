...
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATEFRAMELENDIC_CLEAR_OFFSET UNITYSDK_OFFSET(0x13F8BE30)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATEFRAMELENDIC__CTOR_OFFSET UNITYSDK_OFFSET(0x13F8BEF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorStateFrameLenDic_TypeDefinitionIndex = 54264;
