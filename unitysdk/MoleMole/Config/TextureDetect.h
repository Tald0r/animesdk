...
#define MOLEMOLE_CONFIG_TEXTUREDETECT_ATTACHPATTERNMETHOD_OFFSET UNITYSDK_OFFSET(0xCD21DA0)
#define MOLEMOLE_CONFIG_TEXTUREDETECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0xCD21E80)
#define MOLEMOLE_CONFIG_TEXTUREDETECT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD21F10)
#define MOLEMOLE_CONFIG_TEXTUREDETECT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xCD21F40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TextureDetect_TypeDefinitionIndex = 75840;
