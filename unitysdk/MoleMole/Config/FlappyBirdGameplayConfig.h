...
#define MOLEMOLE_CONFIG_FLAPPYBIRDGAMEPLAYCONFIG_CREATE_OFFSET UNITYSDK_OFFSET(0xC1DF2A0)
#define MOLEMOLE_CONFIG_FLAPPYBIRDGAMEPLAYCONFIG_GET_GAMEPLAYTYPE_OFFSET UNITYSDK_OFFSET(0xC1DF290)
#define MOLEMOLE_CONFIG_FLAPPYBIRDGAMEPLAYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC1DF340)

namespace MoleMole::Config
{
	inline static constexpr unsigned int FlappyBirdGameplayConfig_TypeDefinitionIndex = 62952;

	class FlappyBirdGameplayConfig : public ::System::Object
	{
	public:
		::System::Single LosePointSpeed; // 0x10
		::System::Single MaxSpeed; // 0x14
		::System::Single Gravity; // 0x18
		::System::Single NormalizedTargetRange; // 0x1C
		::System::Single GainPointSpeed; // 0x20
		::System::Single MinSpeed; // 0x24
		::System::Single InitialPoint; // 0x28
		::System::Single ClickAcceleration; // 0x2C
		...
		{
			return ((::Class_0_16E4307DCC419505_189*(*)(::PVOID, ::MoleMole::UIHollowWaterFlowWidgetController*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_FLAPPYBIRDGAMEPLAYCONFIG_CREATE_OFFSET))(this, controller);
		}
	};
}
