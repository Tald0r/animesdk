...
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYSETTINGS_CONFIGMATERIALPROPERTYSETTINGS_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x13F97280)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYSETTINGS_CONFIGMATERIALPROPERTYSETTINGS_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x13F97290)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYSETTINGS_CONFIGMATERIALPROPERTYSETTINGS_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x13F97550)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYSETTINGS_CONFIGMATERIALPROPERTYSETTINGS_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x13F97760)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYSETTINGS_CONFIGMATERIALPROPERTYSETTINGS_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x13F97720)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMaterialPropertySettings_ConfigMaterialPropertySettings_UnityGeneratedFormatter_TypeDefinitionIndex = 57264;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::Config::MaterialPropertyType, ::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigMaterialPropertySettings_ConfigMaterialPropertySettings_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3BEE0);
		}
