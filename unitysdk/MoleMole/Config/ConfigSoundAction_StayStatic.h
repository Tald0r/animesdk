...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_EXECUTE_OFFSET UNITYSDK_OFFSET(0x805EAE0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_ISMATCH_OFFSET UNITYSDK_OFFSET(0x805F160)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_WALK_OFFSET UNITYSDK_OFFSET(0x805F200)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC__CTOR_OFFSET UNITYSDK_OFFSET(0x805F340)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x805F350)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC___BASE_WALK_OFFSET UNITYSDK_OFFSET(0x805F360)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_StayStatic_TypeDefinitionIndex = 49950;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_168*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STAYSTATIC_EXECUTE_OFFSET))(this, context);
		}
