...
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_CONFIGCAMERASTORYDATAS_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x9705EF0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_CONFIGCAMERASTORYDATAS_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x9705F00)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_CONFIGCAMERASTORYDATAS_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x9706270)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_CONFIGCAMERASTORYDATAS_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x97064E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_CONFIGCAMERASTORYDATAS_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x97064A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraStoryDatas_ConfigCameraStoryDatas_UnityGeneratedFormatter_TypeDefinitionIndex = 56395;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::ConfigCameraStory*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigCameraStoryDatas_ConfigCameraStoryDatas_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2C2F8);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Cameras::DefaultFrameTwoShapeConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigCameraStoryDatas_ConfigCameraStoryDatas_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2C300);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Cameras::FixedCameraConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigCameraStoryDatas_ConfigCameraStoryDatas_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2C308);
		}
