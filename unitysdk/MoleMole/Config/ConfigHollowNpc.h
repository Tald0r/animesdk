...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWNPC__CTOR_OFFSET UNITYSDK_OFFSET(0xE360450)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowNpc_TypeDefinitionIndex = 50618;
