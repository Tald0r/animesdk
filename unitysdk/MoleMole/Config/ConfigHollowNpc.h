...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWNPC__CTOR_OFFSET UNITYSDK_OFFSET(0xCD07F70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowNpc_TypeDefinitionIndex = 61500;
