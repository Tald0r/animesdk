...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xF2D6C40)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xF2D6C50)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xF2D6E50)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xF2D7010)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xF2D6FD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_PostEvent_ConfigSoundAction_PostEvent_UnityGeneratedFormatter_TypeDefinitionIndex = 58241;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_PostEvent_ConfigSoundAction_PostEvent_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3EC80);
		}
