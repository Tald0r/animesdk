...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x13F9D090)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x13F9D0A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x13F9D2A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x13F9D460)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_POSTEVENT_CONFIGSOUNDACTION_POSTEVENT_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x13F9D420)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_PostEvent_ConfigSoundAction_PostEvent_UnityGeneratedFormatter_TypeDefinitionIndex = 45340;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_PostEvent_ConfigSoundAction_PostEvent_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3BF50);
		}
