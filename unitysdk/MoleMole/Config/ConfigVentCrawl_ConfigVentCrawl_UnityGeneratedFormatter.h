...
#define MOLEMOLE_CONFIG_CONFIGVENTCRAWL_CONFIGVENTCRAWL_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x8060780)
#define MOLEMOLE_CONFIG_CONFIGVENTCRAWL_CONFIGVENTCRAWL_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x8060790)
#define MOLEMOLE_CONFIG_CONFIGVENTCRAWL_CONFIGVENTCRAWL_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x8060990)
#define MOLEMOLE_CONFIG_CONFIGVENTCRAWL_CONFIGVENTCRAWL_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x8060B50)
#define MOLEMOLE_CONFIG_CONFIGVENTCRAWL_CONFIGVENTCRAWL_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x8060B10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigVentCrawl_ConfigVentCrawl_UnityGeneratedFormatter_TypeDefinitionIndex = 47064;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Battle::AnimatorParamControl*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigVentCrawl_ConfigVentCrawl_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x38510);
		}
