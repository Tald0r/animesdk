...
#define MOLEMOLE_CONFIG_CONFIGLOCKTARGETS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xEC2C320)
#define MOLEMOLE_CONFIG_CONFIGLOCKTARGETS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xEC2BF50)
#define MOLEMOLE_CONFIG_CONFIGLOCKTARGETS__CTOR_OFFSET UNITYSDK_OFFSET(0xEC2C6B0)
#define MOLEMOLE_CONFIG_CONFIGLOCKTARGETS___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xEC2C890)
#define MOLEMOLE_CONFIG_CONFIGLOCKTARGETS___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xEC2C8A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLockTargets_TypeDefinitionIndex = 50417;
