...
#define MOLEMOLE_CONFIG_CAMPTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC22B9C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CampTypeConfig_TypeDefinitionIndex = 38597;
