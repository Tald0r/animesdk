...
#define MOLEMOLE_CONFIG_CAMPTYPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x623E760)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CampTypeConfig_TypeDefinitionIndex = 50258;
