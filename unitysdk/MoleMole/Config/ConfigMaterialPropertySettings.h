...
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x624F6E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMaterialPropertySettings_TypeDefinitionIndex = 57263;
