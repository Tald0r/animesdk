...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM__CTOR_OFFSET UNITYSDK_OFFSET(0xC231110)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicAttachItem_TypeDefinitionIndex = 80861;
