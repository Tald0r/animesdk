...
#define MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x3C05E0)
#define MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x3C0550)
#define MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_METHOD_2_1F8314262457963A_OFFSET UNITYSDK_OFFSET(0x3C0640)
#define MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x3C0670)
#define MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_METHOD_2_D61A3BD754050C8F_OFFSET UNITYSDK_OFFSET(0x3C0540)
#define MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_METHOD_2_DFBF488726E6829A_OFFSET UNITYSDK_OFFSET(0x3C0660)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigBlackboardParam_TypeDefinitionIndex = 56609;
	...
	struct alignas(8) ConfigBlackboardParam
	{
		...
		::System::Void Method_2_D61A3BD754050C8F(::Class_0_16E4307DCC419505_144* a1)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_144*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGBLACKBOARDPARAM_METHOD_2_D61A3BD754050C8F_OFFSET))(this, a1);
		}
