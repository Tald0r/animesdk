...
#define MOLEMOLE_CONFIG_MOUSEINPUTMODIFIER_MAKEDEFAULT_OFFSET UNITYSDK_OFFSET(0xCD1D7A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MouseInputModifier_TypeDefinitionIndex = 66708;
