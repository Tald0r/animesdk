...
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCB05D80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TagLibraryConfig_TypeDefinitionIndex = 41216;
