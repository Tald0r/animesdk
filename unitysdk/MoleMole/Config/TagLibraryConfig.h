...
#define MOLEMOLE_CONFIG_TAGLIBRARYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xEC48C00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TagLibraryConfig_TypeDefinitionIndex = 52541;
