...
#define MOLEMOLE_CONFIG_FOOTPRINTCONFIGS_FOOTPRINTCONFIGS_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x13FA00E0)
#define MOLEMOLE_CONFIG_FOOTPRINTCONFIGS_FOOTPRINTCONFIGS_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x13FA00F0)
#define MOLEMOLE_CONFIG_FOOTPRINTCONFIGS_FOOTPRINTCONFIGS_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x13FA02F0)
#define MOLEMOLE_CONFIG_FOOTPRINTCONFIGS_FOOTPRINTCONFIGS_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x13FA04B0)
#define MOLEMOLE_CONFIG_FOOTPRINTCONFIGS_FOOTPRINTCONFIGS_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x13FA0470)

namespace MoleMole::Config
{
	inline static constexpr unsigned int FootPrintConfigs_FootPrintConfigs_UnityGeneratedFormatter_TypeDefinitionIndex = 54427;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::MoleMole::Config::FootPrintConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(FootPrintConfigs_FootPrintConfigs_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3BF60);
		}
