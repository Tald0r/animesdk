...
#define MOLEMOLE_CONFIG_CONFIGREALTIMEQTE__CTOR_OFFSET UNITYSDK_OFFSET(0x15EBBEC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigRealtimeQTE_TypeDefinitionIndex = 38845;
