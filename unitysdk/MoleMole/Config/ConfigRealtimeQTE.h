...
#define MOLEMOLE_CONFIG_CONFIGREALTIMEQTE__CTOR_OFFSET UNITYSDK_OFFSET(0xE2CDAB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigRealtimeQTE_TypeDefinitionIndex = 56797;
