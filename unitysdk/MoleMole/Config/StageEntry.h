...
#define MOLEMOLE_CONFIG_STAGEENTRY_AFTERSCENELOADED2_OFFSET UNITYSDK_OFFSET(0xCCAB880)
#define MOLEMOLE_CONFIG_STAGEENTRY_ALLOCATE_OFFSET UNITYSDK_OFFSET(0xCCAACE0)
#define MOLEMOLE_CONFIG_STAGEENTRY_CALCSTREAMINGSCENENAME_OFFSET UNITYSDK_OFFSET(0xCCAC140)
#define MOLEMOLE_CONFIG_STAGEENTRY_CALCSTREAMINGV2SCENENAME_OFFSET UNITYSDK_OFFSET(0xCCAC470)
#define MOLEMOLE_CONFIG_STAGEENTRY_GETREALSCENENAMEFORLOADING_OFFSET UNITYSDK_OFFSET(0xCCAB810)
#define MOLEMOLE_CONFIG_STAGEENTRY_GETSTAGELOCATIONNAME_OFFSET UNITYSDK_OFFSET(0xCCABD20)
#define MOLEMOLE_CONFIG_STAGEENTRY_GETSTREAMINGSCENENAME_OFFSET UNITYSDK_OFFSET(0xCCAC2E0)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_CUSTOMDATA_OFFSET UNITYSDK_OFFSET(0xCCAAC60)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_ENVPREFABPATH_OFFSET UNITYSDK_OFFSET(0xCCAACB0)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_SCENEASYNCOPTION_OFFSET UNITYSDK_OFFSET(0xCCAACC0)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_SKIPLOADSCENE_OFFSET UNITYSDK_OFFSET(0xCCAAAC0)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_STAGEAVATARCAMERAKEY_OFFSET UNITYSDK_OFFSET(0xCCAAC90)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0xCCAAC70)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_STAGESCENEPATH_OFFSET UNITYSDK_OFFSET(0xCCAAC80)
#define MOLEMOLE_CONFIG_STAGEENTRY_GET_STAGESCRIPTPATH_OFFSET UNITYSDK_OFFSET(0xCCAACA0)
#define MOLEMOLE_CONFIG_STAGEENTRY_LOADPERPSTAGE_OFFSET UNITYSDK_OFFSET(0xCCAB210)
#define MOLEMOLE_CONFIG_STAGEENTRY_LOADSTAGEENV_OFFSET UNITYSDK_OFFSET(0xCCABD90)
#define MOLEMOLE_CONFIG_STAGEENTRY_MODIFYMEMORYSETTINGSAFTERSCENELOAD_OFFSET UNITYSDK_OFFSET(0xCCAC0D0)
#define MOLEMOLE_CONFIG_STAGEENTRY_SETSKIPLOADSCENE_OFFSET UNITYSDK_OFFSET(0xCCAABD0)
#define MOLEMOLE_CONFIG_STAGEENTRY_UNLOADSTAGE_1_OFFSET UNITYSDK_OFFSET(0xCCAAF30)
#define MOLEMOLE_CONFIG_STAGEENTRY_UNLOADSTAGE_OFFSET UNITYSDK_OFFSET(0xCCAAD50)
#define MOLEMOLE_CONFIG_STAGEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xCCAC590)

namespace MoleMole::Config
{
	inline static constexpr unsigned int StageEntry_TypeDefinitionIndex = 63234;

	class StageEntry : public ::System::Object
	{
	public:
		::System::String* stageName; // 0x10
		::Foundation::AssetRequestHandle _lastKeptScene; // 0x18
		...
		::System::String* stageAvatarCamerakey; // 0x48
		::Foundation::AssetRequestHandle _sceneAsyncOption; // 0x50
		::Il2CppArray<::System::String*>* stageScriptPath; // 0x70
		...
		static ::MoleMole::Config::StageEntry* Allocate(::Class_2_208CC9941471731A_667* configTemplateExt)
		{
			return ((::MoleMole::Config::StageEntry*(*)(::Class_2_208CC9941471731A_667*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_STAGEENTRY_ALLOCATE_OFFSET))(configTemplateExt);
		}
