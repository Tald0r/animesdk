...
#define MOLEMOLE_CONFIG_CONFIGVENTCRAWL__CTOR_OFFSET UNITYSDK_OFFSET(0x8060750)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigVentCrawl_TypeDefinitionIndex = 47063;
