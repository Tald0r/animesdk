...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_OFFSETPOSITION___C__DISPLAYCLASS8_1__CTOR_OFFSET UNITYSDK_OFFSET(0xC23D3A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_OFFSETPOSITION___C__DISPLAYCLASS8_1__EXECUTE_B__0_OFFSET UNITYSDK_OFFSET(0xC23D3B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_OffsetPosition___c__DisplayClass8_1_TypeDefinitionIndex = 50676;
