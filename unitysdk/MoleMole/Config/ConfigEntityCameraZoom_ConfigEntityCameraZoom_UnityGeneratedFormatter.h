...
#define MOLEMOLE_CONFIG_CONFIGENTITYCAMERAZOOM_CONFIGENTITYCAMERAZOOM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xEC299A0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCAMERAZOOM_CONFIGENTITYCAMERAZOOM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xEC299B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCAMERAZOOM_CONFIGENTITYCAMERAZOOM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xEC29BB0)
#define MOLEMOLE_CONFIG_CONFIGENTITYCAMERAZOOM_CONFIGENTITYCAMERAZOOM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xEC29D70)
#define MOLEMOLE_CONFIG_CONFIGENTITYCAMERAZOOM_CONFIGENTITYCAMERAZOOM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xEC29D30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityCameraZoom_ConfigEntityCameraZoom_UnityGeneratedFormatter_TypeDefinitionIndex = 69754;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigEntityCameraZoom_ConfigEntityCameraZoom_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x432F0);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Boolean>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(ConfigEntityCameraZoom_ConfigEntityCameraZoom_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x432F8);
		}
