...
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xC1E2E20)
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0xC1E2470)
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0xC1E24F0)
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA_METHOD_1_E7B4A536DFAE42AC_OFFSET UNITYSDK_OFFSET(0xC1E2E80)
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC1E3210)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneMapStateRuntimeData_TypeDefinitionIndex = 47335;
