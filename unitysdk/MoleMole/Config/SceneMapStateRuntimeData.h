...
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x81F9680)
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x81F8CD0)
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x81F8D50)
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA_METHOD_1_E7B4A536DFAE42AC_OFFSET UNITYSDK_OFFSET(0x81F96E0)
#define MOLEMOLE_CONFIG_SCENEMAPSTATERUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x81F9A70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneMapStateRuntimeData_TypeDefinitionIndex = 50287;
