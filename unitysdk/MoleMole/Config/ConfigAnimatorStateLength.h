...
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_AVATARFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x654D9E0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_BUDDYFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x654DFE0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_FRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x654E8E0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_MAINCITYAVATARFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x654DCE0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_MONSTERFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x654DE60)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_SCENEOBJECTFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x654E160)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIAVATARFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x654DB60)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIBUDDYFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x654E460)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIMODELFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x654E760)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIMONSTERFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x654E2E0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIWEAPONFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x654E5E0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__CTOR_OFFSET UNITYSDK_OFFSET(0x654EA60)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_AVATARFRAMELENDICDATAS_B__3_0_OFFSET UNITYSDK_OFFSET(0x654EA90)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_BUDDYFRAMELENDICDATAS_B__19_0_OFFSET UNITYSDK_OFFSET(0x654EAD0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_FRAMELENDICDATAS_B__43_0_OFFSET UNITYSDK_OFFSET(0x654EB30)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_MAINCITYAVATARFRAMELENDICDATAS_B__11_0_OFFSET UNITYSDK_OFFSET(0x654EAB0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_MONSTERFRAMELENDICDATAS_B__15_0_OFFSET UNITYSDK_OFFSET(0x654EAC0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_SCENEOBJECTFRAMELENDICDATAS_B__23_0_OFFSET UNITYSDK_OFFSET(0x654EAE0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIAVATARFRAMELENDICDATAS_B__7_0_OFFSET UNITYSDK_OFFSET(0x654EAA0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIBUDDYFRAMELENDICDATAS_B__31_0_OFFSET UNITYSDK_OFFSET(0x654EB00)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIMODELFRAMELENDICDATAS_B__39_0_OFFSET UNITYSDK_OFFSET(0x654EB20)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIMONSTERFRAMELENDICDATAS_B__27_0_OFFSET UNITYSDK_OFFSET(0x654EAF0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIWEAPONFRAMELENDICDATAS_B__35_0_OFFSET UNITYSDK_OFFSET(0x654EB10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorStateLength_TypeDefinitionIndex = 59637;
