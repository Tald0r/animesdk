...
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_AVATARFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x81E9550)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_BUDDYFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x81E9B50)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_FRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x81EA450)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_MAINCITYAVATARFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x81E9850)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_MONSTERFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x81E99D0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_SCENEOBJECTFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x81E9CD0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIAVATARFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x81E96D0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIBUDDYFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x81E9FD0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIMODELFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x81EA2D0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIMONSTERFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x81E9E50)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH_GET_UIWEAPONFRAMELENDICDATAS_OFFSET UNITYSDK_OFFSET(0x81EA150)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__CTOR_OFFSET UNITYSDK_OFFSET(0x81EA5D0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_AVATARFRAMELENDICDATAS_B__3_0_OFFSET UNITYSDK_OFFSET(0x81EA600)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_BUDDYFRAMELENDICDATAS_B__19_0_OFFSET UNITYSDK_OFFSET(0x81EA640)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_FRAMELENDICDATAS_B__43_0_OFFSET UNITYSDK_OFFSET(0x81EA6A0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_MAINCITYAVATARFRAMELENDICDATAS_B__11_0_OFFSET UNITYSDK_OFFSET(0x81EA620)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_MONSTERFRAMELENDICDATAS_B__15_0_OFFSET UNITYSDK_OFFSET(0x81EA630)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_SCENEOBJECTFRAMELENDICDATAS_B__23_0_OFFSET UNITYSDK_OFFSET(0x81EA650)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIAVATARFRAMELENDICDATAS_B__7_0_OFFSET UNITYSDK_OFFSET(0x81EA610)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIBUDDYFRAMELENDICDATAS_B__31_0_OFFSET UNITYSDK_OFFSET(0x81EA670)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIMODELFRAMELENDICDATAS_B__39_0_OFFSET UNITYSDK_OFFSET(0x81EA690)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIMONSTERFRAMELENDICDATAS_B__27_0_OFFSET UNITYSDK_OFFSET(0x81EA660)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATELENGTH__GET_UIWEAPONFRAMELENDICDATAS_B__35_0_OFFSET UNITYSDK_OFFSET(0x81EA680)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorStateLength_TypeDefinitionIndex = 77320;
