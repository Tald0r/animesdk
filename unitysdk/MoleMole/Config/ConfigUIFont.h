...
#define MOLEMOLE_CONFIG_CONFIGUIFONT_AWAKE_OFFSET UNITYSDK_OFFSET(0xE36FA10)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GETALIGMENTPREF_OFFSET UNITYSDK_OFFSET(0xE36F8F0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GETFONTPATH_OFFSET UNITYSDK_OFFSET(0xE36F6B0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GETLANGUAGEFONTNAME_OFFSET UNITYSDK_OFFSET(0xE36F060)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GET_DEFAULTFONTSHADER_OFFSET UNITYSDK_OFFSET(0xE36E460)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_GET_ISDEFAULTFONTSHADERLOAD_OFFSET UNITYSDK_OFFSET(0xE36E5F0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_ISDECORATE_OFFSET UNITYSDK_OFFSET(0xE36E9B0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_ISFONTSHADER_OFFSET UNITYSDK_OFFSET(0xE36E660)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_ONKFONTALPHAADJUSTBYLUMINANCECHANGED_OFFSET UNITYSDK_OFFSET(0xE36FB70)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_SETKFONTALPHAADJUSTBYLUMINANCE_OFFSET UNITYSDK_OFFSET(0xE36FAE0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_SHOULDUSELIGHTFONT_OFFSET UNITYSDK_OFFSET(0xE36F7A0)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_TRYGETLANGUAGEFONTNAME_OFFSET UNITYSDK_OFFSET(0xE36F240)
#define MOLEMOLE_CONFIG_CONFIGUIFONT_TRYINITIALIZEDICTCACHE_OFFSET UNITYSDK_OFFSET(0xE36EA70)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__CCTOR_OFFSET UNITYSDK_OFFSET(0xE370400)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__CTOR_OFFSET UNITYSDK_OFFSET(0xE370120)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__TRYINITIALIZEDICTCACHE_G__ADDFONT_32_1_OFFSET UNITYSDK_OFFSET(0xE36FC40)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__TRYINITIALIZEDICTCACHE_G__REMOVEEXTENSIONNAME_32_2_OFFSET UNITYSDK_OFFSET(0xE370440)
#define MOLEMOLE_CONFIG_CONFIGUIFONT__TRYINITIALIZEDICTCACHE_G__TRYADDLANGUAGEFONT_32_0_OFFSET UNITYSDK_OFFSET(0xE36FFC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIFont_TypeDefinitionIndex = 57107;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ConfigUIFont_TypeDefinitionIndex)->GetStaticField(0xC1A0);
		}
