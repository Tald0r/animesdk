...
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDERUNSTATEPARAMS_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0xCADC3A0)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDERUNSTATEPARAMS_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xCADBD20)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDERUNSTATEPARAMS_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xCADC0F0)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDERUNSTATEPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0xCADC440)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDERUNSTATEPARAMS___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0xCADC450)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDERUNSTATEPARAMS___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xCADC4D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDERUNSTATEPARAMS___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xCADC560)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneOverrideRunStateParams_TypeDefinitionIndex = 52648;
