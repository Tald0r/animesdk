...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCREENOFFSETDATAS__CTOR_OFFSET UNITYSDK_OFFSET(0x89F2740)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScreenOffsetDatas_TypeDefinitionIndex = 77399;
