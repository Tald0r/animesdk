...
#define MOLEMOLE_CONFIG_CONFIGSYSTEMSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x9D13290)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSystemSetting_TypeDefinitionIndex = 77029;
