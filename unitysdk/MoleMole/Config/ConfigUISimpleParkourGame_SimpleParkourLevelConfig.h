...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_CALCULATETOTALNODECOUNT_OFFSET UNITYSDK_OFFSET(0xF2D96B0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_CALCULATETOTALSCORE_OFFSET UNITYSDK_OFFSET(0xF2D9380)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_GETGLOBALCONFIG_OFFSET UNITYSDK_OFFSET(0xF2D9900)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_GET_TOTALNODECOUNT_OFFSET UNITYSDK_OFFSET(0xF2D96A0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0xF2D9370)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xF2D9AD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_SimpleParkourLevelConfig_TypeDefinitionIndex = 58202;
