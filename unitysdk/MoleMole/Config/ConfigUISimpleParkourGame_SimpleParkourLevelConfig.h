...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_CALCULATETOTALNODECOUNT_OFFSET UNITYSDK_OFFSET(0x13F9FB00)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_CALCULATETOTALSCORE_OFFSET UNITYSDK_OFFSET(0x13F9F7D0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_GETGLOBALCONFIG_OFFSET UNITYSDK_OFFSET(0x13F9FD50)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_GET_TOTALNODECOUNT_OFFSET UNITYSDK_OFFSET(0x13F9FAF0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG_GET_TOTALSCORE_OFFSET UNITYSDK_OFFSET(0x13F9F7C0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SIMPLEPARKOURLEVELCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13F9FF20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_SimpleParkourLevelConfig_TypeDefinitionIndex = 57780;
