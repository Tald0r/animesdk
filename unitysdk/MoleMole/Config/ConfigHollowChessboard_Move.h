...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x13999090)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x13999080)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE_RUN_OFFSET UNITYSDK_OFFSET(0x13998EB0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x13999150)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_MOVE___BASE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0x13999180)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_Move_TypeDefinitionIndex = 59102;
