...
#define MOLEMOLE_CONFIG_REALTIMEQTETASKENTRYBASE_CREATEREALTIMEQTETASK_OFFSET UNITYSDK_OFFSET(0xE2DB9D0)
#define MOLEMOLE_CONFIG_REALTIMEQTETASKENTRYBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xE2DBA30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int RealtimeQTETaskEntryBase_TypeDefinitionIndex = 60314;
