...
#define MOLEMOLE_CONFIG_REALTIMEQTETASKENTRYBASE_CREATEREALTIMEQTETASK_OFFSET UNITYSDK_OFFSET(0x15EC9050)
#define MOLEMOLE_CONFIG_REALTIMEQTETASKENTRYBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x15EC90B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int RealtimeQTETaskEntryBase_TypeDefinitionIndex = 41742;
