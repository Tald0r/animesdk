...
#define MOLEMOLE_CONFIG_SCENEPEFORMANIMATORPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xE379830)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ScenePeformAnimatorParam_TypeDefinitionIndex = 61664;
	...
	public:
		...
		::MoleMole::Config::ANIM_CTRLER_PARAMS_TYPE ParamType; // 0x24
