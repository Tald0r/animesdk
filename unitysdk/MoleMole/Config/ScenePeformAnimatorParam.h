...
#define MOLEMOLE_CONFIG_SCENEPEFORMANIMATORPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD209D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ScenePeformAnimatorParam_TypeDefinitionIndex = 49785;
