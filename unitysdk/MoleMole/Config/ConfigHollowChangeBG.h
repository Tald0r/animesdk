...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGEBG_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x89F9290)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGEBG__CTOR_OFFSET UNITYSDK_OFFSET(0x89F9370)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChangeBG_TypeDefinitionIndex = 74012;
	...
	public:
		...
		::System::Boolean CloseNoiseEffect; // 0x28
		::System::Boolean needFadeOut; // 0x29
		::System::Boolean needFadeIn; // 0x2A
		::System::Int32 PerformResID; // 0x2C
		::System::Single FadeOutDuration; // 0x30
		::MoleMole::Config::ConfigHollowChangeBG_ChangeBGType ChangeType; // 0x34
