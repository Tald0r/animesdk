...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGEBG_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x10A91EF0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGEBG__CTOR_OFFSET UNITYSDK_OFFSET(0x10A91FD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChangeBG_TypeDefinitionIndex = 71956;
	...
	public:
		...
		::System::Boolean needFadeIn; // 0x29
		::System::Boolean CloseNoiseEffect; // 0x2A
		::System::Single FadeInDuration; // 0x2C
		::MoleMole::Config::ConfigHollowChangeBG_ChangeBGType ChangeType; // 0x30
		::System::Single TargetBright; // 0x34
