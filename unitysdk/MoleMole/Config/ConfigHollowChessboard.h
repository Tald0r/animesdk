...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETANIMLISTVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0xB918CC0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETCHESSBOARDPATHZDELTA_OFFSET UNITYSDK_OFFSET(0xB918DF0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETCHESSBOARDPATHZ_OFFSET UNITYSDK_OFFSET(0xB918D60)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETCONVEYERBELTCAMERAMOVECURVE_OFFSET UNITYSDK_OFFSET(0xB918A80)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETPUSHDISTANCECAMERAMOVECURVE_OFFSET UNITYSDK_OFFSET(0xB918990)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETSPRINGCAMERAMOVECURVE_OFFSET UNITYSDK_OFFSET(0xB918B70)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GET_CORETVOVERLAYEFFS_OFFSET UNITYSDK_OFFSET(0xB9185F0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GET_DEFAULTPATHLINKRES_OFFSET UNITYSDK_OFFSET(0xB918C60)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GET_NORMALTVOVERLAYEFFS_OFFSET UNITYSDK_OFFSET(0xB918280)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GET_TVSCC_OFFSET UNITYSDK_OFFSET(0xB918960)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_TESTFILTER_OFFSET UNITYSDK_OFFSET(0xB918F70)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xB919180)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_TypeDefinitionIndex = 79785;
