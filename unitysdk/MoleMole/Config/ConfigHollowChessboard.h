...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETANIMLISTVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0xCDAC670)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETCHESSBOARDPATHZDELTA_OFFSET UNITYSDK_OFFSET(0xCDAC7A0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETCHESSBOARDPATHZ_OFFSET UNITYSDK_OFFSET(0xCDAC710)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETCONVEYERBELTCAMERAMOVECURVE_OFFSET UNITYSDK_OFFSET(0xCDAC430)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETPUSHDISTANCECAMERAMOVECURVE_OFFSET UNITYSDK_OFFSET(0xCDAC340)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GETSPRINGCAMERAMOVECURVE_OFFSET UNITYSDK_OFFSET(0xCDAC520)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GET_CORETVOVERLAYEFFS_OFFSET UNITYSDK_OFFSET(0xCDABFA0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GET_DEFAULTPATHLINKRES_OFFSET UNITYSDK_OFFSET(0xCDAC610)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GET_NORMALTVOVERLAYEFFS_OFFSET UNITYSDK_OFFSET(0xCDABC30)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_GET_TVSCC_OFFSET UNITYSDK_OFFSET(0xCDAC310)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_TESTFILTER_OFFSET UNITYSDK_OFFSET(0xCDAC920)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0xCDACB30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_TypeDefinitionIndex = 59094;
