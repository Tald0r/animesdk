...
#define MOLEMOLE_CONFIG_CONFIGBUDDYMISC__CTOR_OFFSET UNITYSDK_OFFSET(0xBAEDD20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigBuddyMisc_TypeDefinitionIndex = 51618;
