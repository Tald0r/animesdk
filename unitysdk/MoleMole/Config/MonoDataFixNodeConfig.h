...
#define MOLEMOLE_CONFIG_MONODATAFIXNODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD7C94B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int MonoDataFixNodeConfig_TypeDefinitionIndex = 63324;
