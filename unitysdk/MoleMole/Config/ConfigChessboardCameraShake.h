...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCAMERASHAKE_GETSHAKETYPELISTVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0xCAE34A0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCAMERASHAKE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCAE33C0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCAMERASHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0xCAE3770)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardCameraShake_TypeDefinitionIndex = 43155;
