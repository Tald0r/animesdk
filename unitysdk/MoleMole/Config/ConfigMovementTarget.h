...
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_CHECKOVERLAP_OFFSET UNITYSDK_OFFSET(0xCD0B840)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_CLONE_OFFSET UNITYSDK_OFFSET(0xCD0C8B0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_FINDSUITABLEPOSANDAPPLYINSTANTMOVE_OFFSET UNITYSDK_OFFSET(0xCD0B350)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xCD0C810)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xCD0D530)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_FROMFLX_OFFSET UNITYSDK_OFFSET(0xCD0CAC0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_GETCORRECTIONENTITY_OFFSET UNITYSDK_OFFSET(0xCD0AEE0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_GETGROUNDPOS_OFFSET UNITYSDK_OFFSET(0xCD0B1E0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xCD0C990)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_INITMODELCOLLIDERPARAM_OFFSET UNITYSDK_OFFSET(0xCD0BEE0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xCD0D590)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xCD0CB40)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xCD0D9C0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xCD0D3D0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_PROCESSRIGIDBODY_OFFSET UNITYSDK_OFFSET(0xCD09CE0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_SELECTSUITABLEPOSBYCIRCLEMETHOD_OFFSET UNITYSDK_OFFSET(0xCD0C290)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0xCD0BAE0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xCD09C30)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTTARGET___BASE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0xCD0DB70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMovementTarget_TypeDefinitionIndex = 40789;
	...
	public:
		...
		::System::Boolean IsReached; // 0x6D
		::System::Boolean isCapsule; // 0x6E
		::Enum_3_32134AA19ED34F5D TargetUpdateMode; // 0x70
		::System::Single colliderRadius; // 0x74
		::Enum_3_F40B865AC61AB8D7 colliderType; // 0x78
		::UnityEngine::RaycastHit hitInfo; // 0x7C
