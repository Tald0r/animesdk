...
#define MOLEMOLE_CONFIG_HOLLOWPOPINTERACTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xACD53F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowPopInteractInfo_TypeDefinitionIndex = 44352;
