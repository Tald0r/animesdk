...
#define MOLEMOLE_CONFIG_HOLLOWINTERACTEFFECTIMPBASE_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0xB0A2240)
#define MOLEMOLE_CONFIG_HOLLOWINTERACTEFFECTIMPBASE_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0xB0A2250)
#define MOLEMOLE_CONFIG_HOLLOWINTERACTEFFECTIMPBASE_ONINTERACT_OFFSET UNITYSDK_OFFSET(0xB0A2260)
#define MOLEMOLE_CONFIG_HOLLOWINTERACTEFFECTIMPBASE_RESET_OFFSET UNITYSDK_OFFSET(0xB0A2460)
#define MOLEMOLE_CONFIG_HOLLOWINTERACTEFFECTIMPBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xB0A24D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowInteractEffectImpBase_TypeDefinitionIndex = 54163;
