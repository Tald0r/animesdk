...
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION_CAPSULEOVERLAPTEST_OFFSET UNITYSDK_OFFSET(0x96FE1B0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION_CHECKOVERLAPOTHER_OFFSET UNITYSDK_OFFSET(0x96FD890)
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x96FE110)
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION_INITCOLLIDERINFO_OFFSET UNITYSDK_OFFSET(0x96FC560)
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x96FD6D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x96FC2E0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x96FD560)
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION_SMALLVALUE_OFFSET UNITYSDK_OFFSET(0x96FE6D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x96FE790)
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x96FE7A0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION___BASE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x96FE820)
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x96FE8C0)
#define MOLEMOLE_CONFIG_ANIMATORZONEDITHERINCOLLISION___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x96FE950)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneDitherInCollision_TypeDefinitionIndex = 73053;
