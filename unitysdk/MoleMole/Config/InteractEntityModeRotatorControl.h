...
#define MOLEMOLE_CONFIG_INTERACTENTITYMODEROTATORCONTROL_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0xC1DF580)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODEROTATORCONTROL_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0xC1DF460)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODEROTATORCONTROL_GET_ISSUPPORTREPEAT_OFFSET UNITYSDK_OFFSET(0xC1DF6E0)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODEROTATORCONTROL_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC1DF650)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODEROTATORCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC1DF6F0)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODEROTATORCONTROL___BASE_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0xC1DF700)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODEROTATORCONTROL___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC1DF760)

namespace MoleMole::Config
{
	inline static constexpr unsigned int InteractEntityModeRotatorControl_TypeDefinitionIndex = 77999;

	class InteractEntityModeRotatorControl : public ::MoleMole::Config::InteractEntryMode
	{
	public:
		::System::String* RotatorAttachPointName; // 0x20
		::System::Single AngularSpeedRatio; // 0x28
