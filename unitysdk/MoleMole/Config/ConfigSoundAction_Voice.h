...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_VOICE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x10AA01C0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_VOICE_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x10AA0010)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_VOICE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x10AA0650)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_VOICE__CTOR_OFFSET UNITYSDK_OFFSET(0x10AA0740)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_VOICE___BASE_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0x10AA0750)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_VOICE___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x10AA0760)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_Voice_TypeDefinitionIndex = 48345;
	...
	public:
		...
		::System::String* voiceFemale; // 0x30
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_148*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTION_VOICE_EXECUTE_OFFSET))(this, context);
		}
