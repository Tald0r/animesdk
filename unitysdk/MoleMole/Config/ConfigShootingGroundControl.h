...
#define MOLEMOLE_CONFIG_CONFIGSHOOTINGGROUNDCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xCC9A920)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigShootingGroundControl_TypeDefinitionIndex = 44488;
