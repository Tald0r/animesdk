...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDTRIGGERITEMCOLLECT_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x94FC710)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDTRIGGERITEMCOLLECT__CTOR_OFFSET UNITYSDK_OFFSET(0x94FC7F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardTriggerItemCollect_TypeDefinitionIndex = 78455;
