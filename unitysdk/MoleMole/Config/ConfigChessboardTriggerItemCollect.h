...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDTRIGGERITEMCOLLECT_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x84A4940)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDTRIGGERITEMCOLLECT__CTOR_OFFSET UNITYSDK_OFFSET(0x84A4A20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardTriggerItemCollect_TypeDefinitionIndex = 51928;
