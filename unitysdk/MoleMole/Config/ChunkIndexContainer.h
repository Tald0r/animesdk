...
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x8047370)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_FROMFLX_OFFSET UNITYSDK_OFFSET(0x80470A0)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_METHOD_1_0FE9745CF0F506BA_OFFSET UNITYSDK_OFFSET(0x80475F0)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x80475B0)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_METHOD_1_157E312840A3BD00_OFFSET UNITYSDK_OFFSET(0x80473D0)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_METHOD_1_39F8E53C91EAFE69_OFFSET UNITYSDK_OFFSET(0x80476E0)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x8047120)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8046EA0)
#define MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x80475A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ChunkIndexContainer_TypeDefinitionIndex = 52165;
	...
	public:
		...
		static ::System::String* Method_1_0FE9745CF0F506BA(::Foundation::ResourceFileType a1)
		{
			return ((::System::String*(*)(::Foundation::ResourceFileType))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CHUNKINDEXCONTAINER_METHOD_1_0FE9745CF0F506BA_OFFSET))(a1);
		}
