...
#define MOLEMOLE_CONFIG_WAVECOLLISIONCONTINUOUSDETECT_ATTACHPATTERNMETHODWITHGROUPID_OFFSET UNITYSDK_OFFSET(0x91998D0)
#define MOLEMOLE_CONFIG_WAVECOLLISIONCONTINUOUSDETECT_ATTACHPATTERNMETHOD_OFFSET UNITYSDK_OFFSET(0x91997F0)
#define MOLEMOLE_CONFIG_WAVECOLLISIONCONTINUOUSDETECT_GETMORPHPARAM_OFFSET UNITYSDK_OFFSET(0x9199780)
#define MOLEMOLE_CONFIG_WAVECOLLISIONCONTINUOUSDETECT__CTOR_OFFSET UNITYSDK_OFFSET(0x91999B0)
#define MOLEMOLE_CONFIG_WAVECOLLISIONCONTINUOUSDETECT___BASE_ATTACHPATTERNMETHODWITHGROUPID_OFFSET UNITYSDK_OFFSET(0x9199A40)
#define MOLEMOLE_CONFIG_WAVECOLLISIONCONTINUOUSDETECT___BASE_ATTACHPATTERNMETHOD_OFFSET UNITYSDK_OFFSET(0x9199A30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int WaveCollisionContinuousDetect_TypeDefinitionIndex = 38532;
