...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWLEVELEND__CTOR_OFFSET UNITYSDK_OFFSET(0xB099C40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowLevelEnd_TypeDefinitionIndex = 66057;
	...
	public:
		...
		::System::String* timeSlowKey; // 0x28
		::System::String* cameraShakeKey; // 0x30
		::System::String* cameraZoomKey; // 0x38
		::System::String* onExitBattleGlitchKey; // 0x40
