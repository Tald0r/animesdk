...
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1418D9E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGachaPerformance_TypeDefinitionIndex = 36487;
