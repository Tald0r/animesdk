...
#define MOLEMOLE_CONFIG_ANIMATOREVENTDEBUGENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x13F81A60)
#define MOLEMOLE_CONFIG_ANIMATOREVENTDEBUGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x13F81B00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventDebugEntry_TypeDefinitionIndex = 58567;
