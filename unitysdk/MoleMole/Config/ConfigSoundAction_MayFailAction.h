...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_MAYFAILACTION_BEGINSCOPE_OFFSET UNITYSDK_OFFSET(0xCDBA4B0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_MAYFAILACTION_ENDSCOPE_OFFSET UNITYSDK_OFFSET(0xCDBA710)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_MAYFAILACTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0xCDBA980)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_MAYFAILACTION_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0xCDBA4A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_MAYFAILACTION_ISMATCH_OFFSET UNITYSDK_OFFSET(0xCDBAFA0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_MAYFAILACTION_SETSCOPEVALUE_OFFSET UNITYSDK_OFFSET(0xCDBAD10)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_MAYFAILACTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCDBB0E0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_MAYFAILACTION___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0xCDBB0F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_MayFailAction_TypeDefinitionIndex = 63150;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_168*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTION_MAYFAILACTION_EXECUTE_OFFSET))(this, context);
		}
