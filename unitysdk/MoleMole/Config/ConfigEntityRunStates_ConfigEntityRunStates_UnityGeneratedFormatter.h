...
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATES_CONFIGENTITYRUNSTATES_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x81EC140)
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATES_CONFIGENTITYRUNSTATES_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x81EC150)
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATES_CONFIGENTITYRUNSTATES_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x81EC350)
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATES_CONFIGENTITYRUNSTATES_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x81EC510)
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATES_CONFIGENTITYRUNSTATES_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x81EC4D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityRunStates_ConfigEntityRunStates_UnityGeneratedFormatter_TypeDefinitionIndex = 46781;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::Config::AnimMoveState, ::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigEntityRunStates_ConfigEntityRunStates_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44EB0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::ConfigEntityRunState*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigEntityRunStates_ConfigEntityRunStates_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x44EB8);
		}
