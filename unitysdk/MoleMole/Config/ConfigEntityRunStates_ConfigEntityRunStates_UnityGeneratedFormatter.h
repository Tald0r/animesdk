...
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATES_CONFIGENTITYRUNSTATES_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x65505D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATES_CONFIGENTITYRUNSTATES_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x65505E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATES_CONFIGENTITYRUNSTATES_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x65507E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATES_CONFIGENTITYRUNSTATES_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x65509A0)
#define MOLEMOLE_CONFIG_CONFIGENTITYRUNSTATES_CONFIGENTITYRUNSTATES_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x6550960)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityRunStates_ConfigEntityRunStates_UnityGeneratedFormatter_TypeDefinitionIndex = 47690;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::ConfigEntityRunState*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigEntityRunStates_ConfigEntityRunStates_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43D80);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::MoleMole::Config::AnimMoveState, ::System::String*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigEntityRunStates_ConfigEntityRunStates_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43D88);
		}
