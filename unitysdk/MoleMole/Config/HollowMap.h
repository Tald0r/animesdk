...
#define MOLEMOLE_CONFIG_HOLLOWMAP__CTOR_OFFSET UNITYSDK_OFFSET(0xCAFCEA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowMap_TypeDefinitionIndex = 44845;

	class HollowMap : public ::System::Object
	{
	public:
		::MoleMole::Config::ChapterGridNoiseConfig* noiseConfig; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Config::HollowPosConfig*>* map; // 0x18
