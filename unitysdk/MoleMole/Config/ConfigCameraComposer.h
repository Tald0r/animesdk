...
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_CLONE_OFFSET UNITYSDK_OFFSET(0xF2C65A0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xF2C62B0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_FROMFLX_OFFSET UNITYSDK_OFFSET(0xF2C5C20)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF2C6310)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xF2C5CA0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_LERP_OFFSET UNITYSDK_OFFSET(0xF2C66E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0xF2C65C0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0xF2C6650)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_ZERO_OFFSET UNITYSDK_OFFSET(0xF2C6530)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER__CCTOR_OFFSET UNITYSDK_OFFSET(0xF2C67F0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0xF2C67E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraComposer_TypeDefinitionIndex = 72239;
	...
	public:
		...
		{
			return (::MoleMole::Config::ConfigCameraComposer**)Il2CppClass::FromTypeDefinitionIndex(ConfigCameraComposer_TypeDefinitionIndex)->GetStaticField(0x38D80);
		}
