...
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_CLONE_OFFSET UNITYSDK_OFFSET(0x13F8CFC0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x13F8CCD0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_FROMFLX_OFFSET UNITYSDK_OFFSET(0x13F8C640)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x13F8CD30)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x13F8C6C0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_LERP_OFFSET UNITYSDK_OFFSET(0x13F8D100)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x13F8CFE0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x13F8D070)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER_ZERO_OFFSET UNITYSDK_OFFSET(0x13F8CF50)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER__CCTOR_OFFSET UNITYSDK_OFFSET(0x13F8D210)
#define MOLEMOLE_CONFIG_CONFIGCAMERACOMPOSER__CTOR_OFFSET UNITYSDK_OFFSET(0x13F8D200)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraComposer_TypeDefinitionIndex = 77323;
	...
	public:
		...
		{
			return (::MoleMole::Config::ConfigCameraComposer**)Il2CppClass::FromTypeDefinitionIndex(ConfigCameraComposer_TypeDefinitionIndex)->GetStaticField(0x294F0);
		}
		::System::Single ScreenX; // 0x10
		::System::Single BiasX; // 0x14
		::System::Single ScreenY; // 0x18
		::System::Single BiasY; // 0x1C
