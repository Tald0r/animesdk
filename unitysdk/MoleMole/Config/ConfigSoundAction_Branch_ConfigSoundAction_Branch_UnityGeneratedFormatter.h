...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH_CONFIGSOUNDACTION_BRANCH_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCC9AAA0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH_CONFIGSOUNDACTION_BRANCH_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCC9AAB0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH_CONFIGSOUNDACTION_BRANCH_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCC9AE20)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH_CONFIGSOUNDACTION_BRANCH_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCC9B090)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_BRANCH_CONFIGSOUNDACTION_BRANCH_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC9B050)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_Branch_ConfigSoundAction_Branch_UnityGeneratedFormatter_TypeDefinitionIndex = 52008;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_Branch_ConfigSoundAction_Branch_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x363F0);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigSoundActionGeneral*>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigSoundActionGeneral*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_Branch_ConfigSoundAction_Branch_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x363F8);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::ConfigSoundActionGeneral*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_Branch_ConfigSoundAction_Branch_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x36400);
		}
