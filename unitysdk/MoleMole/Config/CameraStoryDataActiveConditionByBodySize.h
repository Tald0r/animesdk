...
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xC340750)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZE_PASS_OFFSET UNITYSDK_OFFSET(0xC340630)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0xC340760)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraStoryDataActiveConditionByBodySize_TypeDefinitionIndex = 49380;
