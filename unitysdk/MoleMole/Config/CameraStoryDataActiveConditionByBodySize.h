...
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0xEC39E40)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZE_PASS_OFFSET UNITYSDK_OFFSET(0xEC39D20)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYBODYSIZE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC39E50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraStoryDataActiveConditionByBodySize_TypeDefinitionIndex = 48943;
