...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_CALCULATEBACKGROUNDRECT_OFFSET UNITYSDK_OFFSET(0xE3600F0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_CALCULATEFONTUVRECT_OFFSET UNITYSDK_OFFSET(0xE35FC40)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_CALCULATEICONUVRECT_OFFSET UNITYSDK_OFFSET(0xE35FE90)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_BACKGROUNDRESOLUTION_OFFSET UNITYSDK_OFFSET(0xE35FBA0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_BACKGROUNDTEXTUREPATH_OFFSET UNITYSDK_OFFSET(0xE35FB40)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_FONTRESOLUTION_OFFSET UNITYSDK_OFFSET(0xE35FB80)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_TEXTFONTTEXTUREPATH_OFFSET UNITYSDK_OFFSET(0xE35FB60)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_ONPARAMCHANGED_OFFSET UNITYSDK_OFFSET(0xE35FBC0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI__CTOR_OFFSET UNITYSDK_OFFSET(0xE360320)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboardScreenUI_TypeDefinitionIndex = 44604;
