...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_CALCULATEBACKGROUNDRECT_OFFSET UNITYSDK_OFFSET(0xCD07C10)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_CALCULATEFONTUVRECT_OFFSET UNITYSDK_OFFSET(0xCD07760)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_CALCULATEICONUVRECT_OFFSET UNITYSDK_OFFSET(0xCD079B0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_BACKGROUNDRESOLUTION_OFFSET UNITYSDK_OFFSET(0xCD076C0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_BACKGROUNDTEXTUREPATH_OFFSET UNITYSDK_OFFSET(0xCD07660)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_FONTRESOLUTION_OFFSET UNITYSDK_OFFSET(0xCD076A0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_GET_TEXTFONTTEXTUREPATH_OFFSET UNITYSDK_OFFSET(0xCD07680)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI_ONPARAMCHANGED_OFFSET UNITYSDK_OFFSET(0xCD076E0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARDSCREENUI__CTOR_OFFSET UNITYSDK_OFFSET(0xCD07E40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboardScreenUI_TypeDefinitionIndex = 45665;
