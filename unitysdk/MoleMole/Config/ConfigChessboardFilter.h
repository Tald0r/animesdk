...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xACBE0E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardFilter_TypeDefinitionIndex = 54056;
