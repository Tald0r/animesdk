...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC901E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardFilter_TypeDefinitionIndex = 41195;
