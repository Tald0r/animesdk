...
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_0CAA490423B456C6_OFFSET UNITYSDK_OFFSET(0xCDA33C0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_20599A32E5B0202C_OFFSET UNITYSDK_OFFSET(0xCDA4680)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_2C9AAEB4E287676D_OFFSET UNITYSDK_OFFSET(0xCDA4B90)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_391A84BCD9F51317_OFFSET UNITYSDK_OFFSET(0xCDA3C20)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_473360D382EBE9C6_OFFSET UNITYSDK_OFFSET(0xCDA4590)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_4A2C8AEE9BCA2A94_OFFSET UNITYSDK_OFFSET(0xCDA4F80)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_51D06F1E284FA008_1_OFFSET UNITYSDK_OFFSET(0xCDA5840)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_51D06F1E284FA008_OFFSET UNITYSDK_OFFSET(0xCDA5050)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_5B9D1016DF183D97_OFFSET UNITYSDK_OFFSET(0xCDA5580)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_616A5AF73B107529_OFFSET UNITYSDK_OFFSET(0xCDA3C90)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_65FECDA418990652_OFFSET UNITYSDK_OFFSET(0xCDA4810)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_BD2FE8436FCDD8B2_OFFSET UNITYSDK_OFFSET(0xCDA3A40)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_C48BED042BE91786_OFFSET UNITYSDK_OFFSET(0xCDA5290)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_D83985000E1AD3F1_OFFSET UNITYSDK_OFFSET(0xCDA5660)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_F179115F8A73AE42_1_OFFSET UNITYSDK_OFFSET(0xCDA51C0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_F179115F8A73AE42_OFFSET UNITYSDK_OFFSET(0xCDA4EB0)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET_METHOD_1_FCABC4212A3F7F6F_OFFSET UNITYSDK_OFFSET(0xCDA4290)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET__CCTOR_OFFSET UNITYSDK_OFFSET(0xCDA4280)
#define MOLEMOLE_CONFIG_CONFIGABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xCDA4270)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAbilityTarget_TypeDefinitionIndex = 56425;
	...
	public:
		...
		{
			return (::MoleMole::Config::ConfigAbilityTarget_Struct_2_9BE0823C1225EE82*)Il2CppClass::FromTypeDefinitionIndex(ConfigAbilityTarget_TypeDefinitionIndex)->GetStaticField(0x3E990);
		}
		static ::MoleMole::Config::ConfigAbilityTarget_Struct_2_D9676FC67296675D* StaticGet_entitySortComparer()
		{
			return (::MoleMole::Config::ConfigAbilityTarget_Struct_2_D9676FC67296675D*)Il2CppClass::FromTypeDefinitionIndex(ConfigAbilityTarget_TypeDefinitionIndex)->GetStaticField(0x3E9B0);
		}
		static ::MoleMole::Config::ConfigAbilityTarget_Struct_2_AB79962F241E0778* StaticGet_entityFeatureTargetSortComparer()
		{
			return (::MoleMole::Config::ConfigAbilityTarget_Struct_2_AB79962F241E0778*)Il2CppClass::FromTypeDefinitionIndex(ConfigAbilityTarget_TypeDefinitionIndex)->GetStaticField(0x3E9D0);
		}
