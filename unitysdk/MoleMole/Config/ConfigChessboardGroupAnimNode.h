...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDGROUPANIMNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xBAEDF20)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDGROUPANIMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xBAEDFC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardGroupAnimNode_TypeDefinitionIndex = 65780;
	...
	public:
		...
		::MoleMole::Config::IntUISpecialNum* CustomSoundEventID; // 0x38
