...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDGROUPANIMNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x14181640)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDGROUPANIMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x141816E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardGroupAnimNode_TypeDefinitionIndex = 73098;
	...
	public:
		...
		::MoleMole::Config::IntUISpecialNum* AnimType; // 0x20
		::MoleMole::Config::FloatUISpecialNum* FrequencyMin; // 0x28
		::MoleMole::Config::AnimationCurveUISpecialNum* FrequencyCurve; // 0x30
