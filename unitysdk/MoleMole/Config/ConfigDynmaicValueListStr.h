...
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_CLONE_OFFSET UNITYSDK_OFFSET(0xCDA8CD0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xCDA8C80)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xCDA92E0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_FROMFLX_OFFSET UNITYSDK_OFFSET(0xCDA8F00)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xCDA8DD0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xCDA9340)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xCDA8F80)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xCDA95A0)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xCDA9180)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0xCDA8B00)
#define MOLEMOLE_CONFIG_CONFIGDYNMAICVALUELISTSTR__CTOR_OFFSET UNITYSDK_OFFSET(0xCDA9750)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynmaicValueListStr_TypeDefinitionIndex = 48331;
