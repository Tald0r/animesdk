...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDPLAYSTARTPERFORM_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x6243BD0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDPLAYSTARTPERFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x6243CB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardPlayStartPerform_TypeDefinitionIndex = 77427;
	...
	public:
		...
		::System::Int32 AcceleratedShuttleSoundEventID; // 0x30
		::System::Boolean VideoAllowSkip; // 0x34
		::System::Int32 VideoAccelerationStartFrame; // 0x38
		::System::Int32 ShuttleSoundEventID; // 0x3C
		::MoleMole::Config::ScreenEffectType EffectType; // 0x40
		::System::Int32 VideoAllowSkipStartFrame; // 0x44
		::System::Int32 BackgroundSoundEventID; // 0x48
