...
#define MOLEMOLE_CONFIG_ANIMATORZONECENTERDITHER_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x62A1DE0)
#define MOLEMOLE_CONFIG_ANIMATORZONECENTERDITHER_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x62A1B90)
#define MOLEMOLE_CONFIG_ANIMATORZONECENTERDITHER_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x62A1CC0)
#define MOLEMOLE_CONFIG_ANIMATORZONECENTERDITHER__CTOR_OFFSET UNITYSDK_OFFSET(0x62A1E80)
#define MOLEMOLE_CONFIG_ANIMATORZONECENTERDITHER___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x62A1E90)
#define MOLEMOLE_CONFIG_ANIMATORZONECENTERDITHER___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x62A1F10)
#define MOLEMOLE_CONFIG_ANIMATORZONECENTERDITHER___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x62A1FA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneCenterDither_TypeDefinitionIndex = 72294;
	...
	public:
		...
		::System::Single CenterMinAlpha; // 0x5C
