...
#define MOLEMOLE_CONFIG_CONFIGMODIFYPLUGIN_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xEC2C940)
#define MOLEMOLE_CONFIG_CONFIGMODIFYPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0xEC2CA20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigModifyPlugin_TypeDefinitionIndex = 69318;
