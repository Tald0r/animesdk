...
#define MOLEMOLE_CONFIG_UICONFIGPHOTOCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xC1E46A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int UIConfigPhotoCamera_TypeDefinitionIndex = 39866;
