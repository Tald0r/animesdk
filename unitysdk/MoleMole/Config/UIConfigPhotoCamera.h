...
#define MOLEMOLE_CONFIG_UICONFIGPHOTOCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x81FAF80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int UIConfigPhotoCamera_TypeDefinitionIndex = 59012;
