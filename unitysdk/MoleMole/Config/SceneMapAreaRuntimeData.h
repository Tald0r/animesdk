...
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x13FA5A70)
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x13FA54E0)
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA_METHOD_1_C68CB15A07D0E2EF_OFFSET UNITYSDK_OFFSET(0x13FA5AD0)
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA_METHOD_1_DF413489329CBAF8_OFFSET UNITYSDK_OFFSET(0x13FA5560)
#define MOLEMOLE_CONFIG_SCENEMAPAREARUNTIMEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x13FA5E20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneMapAreaRuntimeData_TypeDefinitionIndex = 59731;
