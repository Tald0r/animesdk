...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTCONFIG_GET_HASGOODRANGE_OFFSET UNITYSDK_OFFSET(0xB0A03D0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTCONFIG_GET_HASPERFECTRANGE_OFFSET UNITYSDK_OFFSET(0xB0A03C0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTCONFIG_TOJUDGMENTCONFIG_OFFSET UNITYSDK_OFFSET(0xB0A03E0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB0A08E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_SerializableJudgmentConfig_TypeDefinitionIndex = 58199;
