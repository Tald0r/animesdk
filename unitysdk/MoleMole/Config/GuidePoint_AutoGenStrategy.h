...
#define MOLEMOLE_CONFIG_GUIDEPOINT_AUTOGENSTRATEGY_GET_INSERTSUBSECTIONLENGTH_OFFSET UNITYSDK_OFFSET(0x75ACC0)
#define MOLEMOLE_CONFIG_GUIDEPOINT_AUTOGENSTRATEGY_GET_SUBSECTIONBACKTRACEDISTANCE_OFFSET UNITYSDK_OFFSET(0x75ACC0)
#define MOLEMOLE_CONFIG_GUIDEPOINT_AUTOGENSTRATEGY_ISVALID_OFFSET UNITYSDK_OFFSET(0x75ACD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int GuidePoint_AutoGenStrategy_TypeDefinitionIndex = 41025;
