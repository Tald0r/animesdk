...
#define MOLEMOLE_CONFIG_CONFIGTRIGGERNPCNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCC9EA20)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERNPCNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC9EB00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTriggerNpcNode_TypeDefinitionIndex = 44605;

	class ConfigTriggerNpcNode : public ::MoleMole::Config::ConfigUIBaseActionNode
	{
	public:
		::MoleMole::Config::StringUISpecialNum* State; // 0x18
		::MoleMole::Config::StringUISpecialNum* SaveUIDKey; // 0x20
		::MoleMole::Config::ListIntUISpecialNum* PieceIndexList; // 0x28
		::MoleMole::Config::IntUISpecialNum* NPCID; // 0x30
		::MoleMole::Config::ListCellUISpecialNum* PieceCellList; // 0x38
		::MoleMole::Config::IntUISpecialNum* UID; // 0x40
