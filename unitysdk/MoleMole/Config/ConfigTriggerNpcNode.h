...
#define MOLEMOLE_CONFIG_CONFIGTRIGGERNPCNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xACCD7E0)
#define MOLEMOLE_CONFIG_CONFIGTRIGGERNPCNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xACCD8C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTriggerNpcNode_TypeDefinitionIndex = 64372;
	...
	public:
		...
		::MoleMole::Config::IntUISpecialNum* NPCID; // 0x20
		::MoleMole::Config::FloatUISpecialNum* Duration; // 0x28
		::MoleMole::Config::IntUISpecialNum* UID; // 0x30
		::MoleMole::Config::StringUISpecialNum* SaveUIDKey; // 0x38
		::MoleMole::Config::StringUISpecialNum* State; // 0x40
		::MoleMole::Config::ListCellUISpecialNum* PieceCellList; // 0x48
