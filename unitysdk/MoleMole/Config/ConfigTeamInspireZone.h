...
#define MOLEMOLE_CONFIG_CONFIGTEAMINSPIREZONE__CTOR_OFFSET UNITYSDK_OFFSET(0xF16E9F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTeamInspireZone_TypeDefinitionIndex = 37198;
