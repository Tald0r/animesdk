...
#define MOLEMOLE_CONFIG_CONFIGTEAMINSPIREZONE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC4D3A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTeamInspireZone_TypeDefinitionIndex = 66427;
