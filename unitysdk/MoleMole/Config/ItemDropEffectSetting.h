...
#define MOLEMOLE_CONFIG_ITEMDROPEFFECTSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x8063340)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ItemDropEffectSetting_TypeDefinitionIndex = 66666;
