...
#define MOLEMOLE_CONFIG_TIMELINEABILITYTARGET_METHOD_2_1808E1CF7A125519_OFFSET UNITYSDK_OFFSET(0x6DFA7B0)
#define MOLEMOLE_CONFIG_TIMELINEABILITYTARGET_METHOD_2_EA91F3C4015F35FB_OFFSET UNITYSDK_OFFSET(0x6DFA0B0)
#define MOLEMOLE_CONFIG_TIMELINEABILITYTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x6DFA830)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TimelineAbilityTarget_TypeDefinitionIndex = 40075;
