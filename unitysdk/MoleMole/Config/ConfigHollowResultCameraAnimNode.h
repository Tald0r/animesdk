...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTCAMERAANIMNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x13999FC0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTCAMERAANIMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1399A050)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowResultCameraAnimNode_TypeDefinitionIndex = 73675;
