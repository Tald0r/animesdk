...
#define MOLEMOLE_CONFIG_GAMEPADRUMBLEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xCCA5FA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int GamepadRumbleEntry_TypeDefinitionIndex = 41128;
