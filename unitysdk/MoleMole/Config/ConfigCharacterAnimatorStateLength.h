...
#define MOLEMOLE_CONFIG_CONFIGCHARACTERANIMATORSTATELENGTH_GET_BRANCHSTATELENGTHCONFIG_OFFSET UNITYSDK_OFFSET(0x89F43E0)
#define MOLEMOLE_CONFIG_CONFIGCHARACTERANIMATORSTATELENGTH__CTOR_OFFSET UNITYSDK_OFFSET(0x89F45D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCharacterAnimatorStateLength_TypeDefinitionIndex = 73388;
