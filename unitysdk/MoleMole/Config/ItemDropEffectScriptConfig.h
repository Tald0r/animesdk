...
#define MOLEMOLE_CONFIG_ITEMDROPEFFECTSCRIPTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCD1C3E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ItemDropEffectScriptConfig_TypeDefinitionIndex = 53219;
