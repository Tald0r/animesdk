...
#define MOLEMOLE_CONFIG_PATTERNSHAPEFAN__CTOR_OFFSET UNITYSDK_OFFSET(0xE2DB720)

namespace MoleMole::Config
{
	inline static constexpr unsigned int PatternShapeFan_TypeDefinitionIndex = 48393;
