...
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_GET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x10AA9B00)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_GET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x10AA9B20)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x10AA9AE0)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_SET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0x10AA9B10)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_SET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0x10AA9B30)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0x10AA9AF0)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x10AA9A90)
#define MOLEMOLE_CONFIG_READONLYDYNAMICSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x10AA9A60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ReadonlyDynamicString_TypeDefinitionIndex = 80094;

	class ReadonlyDynamicString : public ::MoleMole::Config::DynamicString
	{
	public:
		::System::String* _dynamicKey; // 0x28
		::System::String* _fixedValue; // 0x30
