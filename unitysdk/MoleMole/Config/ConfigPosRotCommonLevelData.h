...
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x8A04D70)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x8A04A20)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_0AFE2382BF92DEC7_OFFSET UNITYSDK_OFFSET(0x8A04DD0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_5253759692D6DAC1_OFFSET UNITYSDK_OFFSET(0x8A04AA0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_5C90773220FA8136_OFFSET UNITYSDK_OFFSET(0x8A04760)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_85C03D244F4D678F_OFFSET UNITYSDK_OFFSET(0x8A05310)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_88B60F3B95FAA4F1_OFFSET UNITYSDK_OFFSET(0x8A05060)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_929BE9BE915F0B43_OFFSET UNITYSDK_OFFSET(0x8A05260)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_A07BBB39DCAC48C7_OFFSET UNITYSDK_OFFSET(0x8A05100)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_B525722F60E6B94F_OFFSET UNITYSDK_OFFSET(0x8A048F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_C9158580CC3C5ACF_OFFSET UNITYSDK_OFFSET(0x8A047F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA_METHOD_2_F2962016E737497B_OFFSET UNITYSDK_OFFSET(0x8A05300)
#define MOLEMOLE_CONFIG_CONFIGPOSROTCOMMONLEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8A050F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotCommonLevelData_TypeDefinitionIndex = 36436;
