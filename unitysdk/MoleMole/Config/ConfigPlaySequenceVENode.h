...
#define MOLEMOLE_CONFIG_CONFIGPLAYSEQUENCEVENODE_GETALLVEKEY_OFFSET UNITYSDK_OFFSET(0xC23CBD0)
#define MOLEMOLE_CONFIG_CONFIGPLAYSEQUENCEVENODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xC23CB30)
#define MOLEMOLE_CONFIG_CONFIGPLAYSEQUENCEVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC23CC70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlaySequenceVENode_TypeDefinitionIndex = 69738;

	class ConfigPlaySequenceVENode : public ::MoleMole::Config::ConfigUIBaseActionNode
	{
	public:
		::System::Collections::Generic::List_1<::MoleMole::Config::VESequenceInfo*>* VESequenceInfoList; // 0x18
