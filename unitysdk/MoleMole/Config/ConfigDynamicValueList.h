...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST_CLONE_OFFSET UNITYSDK_OFFSET(0xF2C87F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xF2C87A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xF2C8F40)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST_FROMFLX_OFFSET UNITYSDK_OFFSET(0xF2C8A20)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xF2C8740)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xF2C88F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF2C8FA0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xF2C8AA0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF2C91B0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xF2C8DE0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0xF2C8400)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST__CTOR_OFFSET UNITYSDK_OFFSET(0xF2C9360)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELIST___BASE_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xF2C93B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueList_TypeDefinitionIndex = 79317;
