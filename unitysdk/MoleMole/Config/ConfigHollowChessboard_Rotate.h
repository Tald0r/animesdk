...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_ROTATE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0xEC2AD70)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_ROTATE_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0xEC2AD60)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_ROTATE_RUN_OFFSET UNITYSDK_OFFSET(0xEC2AB90)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_ROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC2AE30)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_ROTATE___BASE_GETSUPPORTEDDURATIONTYPE_OFFSET UNITYSDK_OFFSET(0xEC2AE90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_Rotate_TypeDefinitionIndex = 59138;
