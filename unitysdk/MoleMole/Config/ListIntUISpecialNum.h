...
#define MOLEMOLE_CONFIG_LISTINTUISPECIALNUM_GETVALUE_OFFSET UNITYSDK_OFFSET(0xB47CA10)
#define MOLEMOLE_CONFIG_LISTINTUISPECIALNUM__CTOR_OFFSET UNITYSDK_OFFSET(0xB47C9D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ListIntUISpecialNum_TypeDefinitionIndex = 55791;
