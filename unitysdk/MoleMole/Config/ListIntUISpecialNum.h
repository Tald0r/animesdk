...
#define MOLEMOLE_CONFIG_LISTINTUISPECIALNUM_GETVALUE_OFFSET UNITYSDK_OFFSET(0xE828370)
#define MOLEMOLE_CONFIG_LISTINTUISPECIALNUM__CTOR_OFFSET UNITYSDK_OFFSET(0xE828330)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ListIntUISpecialNum_TypeDefinitionIndex = 55006;
