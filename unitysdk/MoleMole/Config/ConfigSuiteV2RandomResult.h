...
#define MOLEMOLE_CONFIG_CONFIGSUITEV2RANDOMRESULT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x805FA80)
#define MOLEMOLE_CONFIG_CONFIGSUITEV2RANDOMRESULT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x805F6C0)
#define MOLEMOLE_CONFIG_CONFIGSUITEV2RANDOMRESULT_METHOD_1_46F5479027C46F32_OFFSET UNITYSDK_OFFSET(0x805FAE0)
#define MOLEMOLE_CONFIG_CONFIGSUITEV2RANDOMRESULT_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x805F740)
#define MOLEMOLE_CONFIG_CONFIGSUITEV2RANDOMRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x805FE10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSuiteV2RandomResult_TypeDefinitionIndex = 49009;
