...
#define MOLEMOLE_CONFIG_CONFIGSUITEV2RANDOMRESULT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x9D12BC0)
#define MOLEMOLE_CONFIG_CONFIGSUITEV2RANDOMRESULT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x9D12800)
#define MOLEMOLE_CONFIG_CONFIGSUITEV2RANDOMRESULT_METHOD_1_46F5479027C46F32_OFFSET UNITYSDK_OFFSET(0x9D12C20)
#define MOLEMOLE_CONFIG_CONFIGSUITEV2RANDOMRESULT_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x9D12880)
#define MOLEMOLE_CONFIG_CONFIGSUITEV2RANDOMRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D12F50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSuiteV2RandomResult_TypeDefinitionIndex = 66292;
