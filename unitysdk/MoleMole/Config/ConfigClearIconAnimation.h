...
#define MOLEMOLE_CONFIG_CONFIGCLEARICONANIMATION_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x9706840)
#define MOLEMOLE_CONFIG_CONFIGCLEARICONANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x9706920)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigClearIconAnimation_TypeDefinitionIndex = 45218;
