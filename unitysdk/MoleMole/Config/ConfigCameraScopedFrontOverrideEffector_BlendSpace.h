...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x15EA8160)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE_RESET_OFFSET UNITYSDK_OFFSET(0x15EA8200)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x15EA82D0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x15EA82E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE___BASE_RESET_OFFSET UNITYSDK_OFFSET(0x15EA8350)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_BlendSpace_TypeDefinitionIndex = 51461;
