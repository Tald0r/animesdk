...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xE2B9B80)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE_RESET_OFFSET UNITYSDK_OFFSET(0xE2B9C20)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE__CTOR_OFFSET UNITYSDK_OFFSET(0xE2B9CF0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xE2B9D00)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_BLENDSPACE___BASE_RESET_OFFSET UNITYSDK_OFFSET(0xE2B9D70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_BlendSpace_TypeDefinitionIndex = 67893;
