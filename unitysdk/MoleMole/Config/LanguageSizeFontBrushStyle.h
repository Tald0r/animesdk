...
#define MOLEMOLE_CONFIG_LANGUAGESIZEFONTBRUSHSTYLE_GET_BOLDNESS_OFFSET UNITYSDK_OFFSET(0x71A670)
#define MOLEMOLE_CONFIG_LANGUAGESIZEFONTBRUSHSTYLE_GET_SHARPNESS_OFFSET UNITYSDK_OFFSET(0x71A710)
#define MOLEMOLE_CONFIG_LANGUAGESIZEFONTBRUSHSTYLE_SET_BOLDNESS_OFFSET UNITYSDK_OFFSET(0x71A680)
#define MOLEMOLE_CONFIG_LANGUAGESIZEFONTBRUSHSTYLE_SET_SHARPNESS_OFFSET UNITYSDK_OFFSET(0x71A720)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LanguageSizeFontBrushStyle_TypeDefinitionIndex = 58230;
