...
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCESENDCMDWITHOUTPARAMSNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x624DFE0)
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCESENDCMDWITHOUTPARAMSNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x624E070)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGachaPerformanceSendCmdWithoutParamsNode_TypeDefinitionIndex = 76504;
