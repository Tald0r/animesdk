...
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_CLUEVIEW_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0xCB00460)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_CLUEVIEW_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0xCB003B0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_CLUEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xCB00560)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODE_CLUEVIEW___BASE_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0xCB00570)

namespace MoleMole::Config
{
	inline static constexpr unsigned int InteractEntryMode_ClueView_TypeDefinitionIndex = 49926;
