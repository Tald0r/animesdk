...
#define MOLEMOLE_CONFIG_LEVELGLOBALCOUNTERSTROKECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCDBF190)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelGlobalCounterstrokeConfig_TypeDefinitionIndex = 37906;
