...
#define MOLEMOLE_CONFIG_LEVELGLOBALCOUNTERSTROKECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD0A41E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelGlobalCounterstrokeConfig_TypeDefinitionIndex = 62247;
