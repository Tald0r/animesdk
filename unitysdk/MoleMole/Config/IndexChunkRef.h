...
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x9D15F90)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0x9D15BD0)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x9D161A0)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x9D15C50)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_METHOD_1_9144040ECD391705_OFFSET UNITYSDK_OFFSET(0x9D15FF0)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9D158B0)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF__CTOR_OFFSET UNITYSDK_OFFSET(0x9D16190)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexChunkRef_TypeDefinitionIndex = 72811;
