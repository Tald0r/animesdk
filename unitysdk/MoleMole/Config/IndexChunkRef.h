...
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x8062E40)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0x8062A80)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x8063050)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x8062B00)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_METHOD_1_9144040ECD391705_OFFSET UNITYSDK_OFFSET(0x8062EA0)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8062760)
#define MOLEMOLE_CONFIG_INDEXCHUNKREF__CTOR_OFFSET UNITYSDK_OFFSET(0x8063040)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexChunkRef_TypeDefinitionIndex = 71587;
