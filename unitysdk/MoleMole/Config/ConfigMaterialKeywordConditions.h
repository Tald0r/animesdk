...
#define MOLEMOLE_CONFIG_CONFIGMATERIALKEYWORDCONDITIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x13F97250)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMaterialKeywordConditions_TypeDefinitionIndex = 57505;
