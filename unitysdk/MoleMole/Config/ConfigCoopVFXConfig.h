...
#define MOLEMOLE_CONFIG_CONFIGCOOPVFXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCDA7E30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCoopVFXConfig_TypeDefinitionIndex = 69701;
