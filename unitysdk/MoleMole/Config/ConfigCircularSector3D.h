...
#define MOLEMOLE_CONFIG_CONFIGCIRCULARSECTOR3D_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x4D1650)
#define MOLEMOLE_CONFIG_CONFIGCIRCULARSECTOR3D_FROMFLX_OFFSET UNITYSDK_OFFSET(0x4D1590)
#define MOLEMOLE_CONFIG_CONFIGCIRCULARSECTOR3D_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x4D16B0)
#define MOLEMOLE_CONFIG_CONFIGCIRCULARSECTOR3D_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x4D1620)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCircularSector3D_TypeDefinitionIndex = 76250;
