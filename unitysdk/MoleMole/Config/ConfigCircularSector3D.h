...
#define MOLEMOLE_CONFIG_CONFIGCIRCULARSECTOR3D_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x75AA50)
#define MOLEMOLE_CONFIG_CONFIGCIRCULARSECTOR3D_FROMFLX_OFFSET UNITYSDK_OFFSET(0x75A990)
#define MOLEMOLE_CONFIG_CONFIGCIRCULARSECTOR3D_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x75AAB0)
#define MOLEMOLE_CONFIG_CONFIGCIRCULARSECTOR3D_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x75AA20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCircularSector3D_TypeDefinitionIndex = 43158;
