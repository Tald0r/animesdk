...
#define MOLEMOLE_CONFIG_CONFIGSIDESCROLLINGLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD09D9B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSideScrollingLevel_TypeDefinitionIndex = 53999;
