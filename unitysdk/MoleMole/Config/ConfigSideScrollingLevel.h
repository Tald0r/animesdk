...
#define MOLEMOLE_CONFIG_CONFIGSIDESCROLLINGLEVEL__CTOR_OFFSET UNITYSDK_OFFSET(0xCDB8940)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSideScrollingLevel_TypeDefinitionIndex = 70517;
