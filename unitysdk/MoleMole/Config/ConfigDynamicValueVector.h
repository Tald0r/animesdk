...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_CLONE_OFFSET UNITYSDK_OFFSET(0xEC29020)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xEC29010)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC295D0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_FROMFLX_OFFSET UNITYSDK_OFFSET(0xEC29250)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xEC28E40)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xEC29120)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC29630)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xEC292D0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xEC28EA0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC29790)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xEC29470)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0xEC28D50)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xEC28FC0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUEVECTOR___BASE_GETCONFIGDYNAMICVALUETYPE_OFFSET UNITYSDK_OFFSET(0xEC29940)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueVector_TypeDefinitionIndex = 37276;
