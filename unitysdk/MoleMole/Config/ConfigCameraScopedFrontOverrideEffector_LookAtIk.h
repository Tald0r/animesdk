...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xCAE3160)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK_RESET_OFFSET UNITYSDK_OFFSET(0xCAE3200)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK__CTOR_OFFSET UNITYSDK_OFFSET(0xCAE32D0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xCAE32E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK___BASE_RESET_OFFSET UNITYSDK_OFFSET(0xCAE3350)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_LookAtIk_TypeDefinitionIndex = 63550;
