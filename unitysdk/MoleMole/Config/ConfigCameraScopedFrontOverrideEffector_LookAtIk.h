...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x62B24B0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK_RESET_OFFSET UNITYSDK_OFFSET(0x62B2550)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK__CTOR_OFFSET UNITYSDK_OFFSET(0x62B2620)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x62B2630)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_LOOKATIK___BASE_RESET_OFFSET UNITYSDK_OFFSET(0x62B26A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_LookAtIk_TypeDefinitionIndex = 51787;
