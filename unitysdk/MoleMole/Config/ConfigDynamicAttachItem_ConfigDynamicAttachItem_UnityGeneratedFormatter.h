...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x10A8D3D0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x10A8D3E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x10A8D5E0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x10A8D7A0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x10A8D760)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicAttachItem_ConfigDynamicAttachItem_UnityGeneratedFormatter_TypeDefinitionIndex = 80862;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigDynamicAttachItem_ConfigDynamicAttachItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x468C0);
		}
