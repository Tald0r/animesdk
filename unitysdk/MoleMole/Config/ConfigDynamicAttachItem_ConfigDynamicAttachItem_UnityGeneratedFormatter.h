...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x89F47B0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x89F47C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x89F49C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x89F4B80)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICATTACHITEM_CONFIGDYNAMICATTACHITEM_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x89F4B40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicAttachItem_ConfigDynamicAttachItem_UnityGeneratedFormatter_TypeDefinitionIndex = 40748;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigDynamicAttachItem_ConfigDynamicAttachItem_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3FC80);
		}
