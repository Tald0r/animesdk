...
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x9CFA950)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x9CFA540)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT_METHOD_1_1A0B790695E07CE5_OFFSET UNITYSDK_OFFSET(0x9CFA9B0)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0x9CFA5C0)
#define MOLEMOLE_CONFIG_CONFIGABILITYFRAGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9CFABC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAbilityFragment_TypeDefinitionIndex = 52482;
