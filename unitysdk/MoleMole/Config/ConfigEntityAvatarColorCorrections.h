...
#define MOLEMOLE_CONFIG_CONFIGENTITYAVATARCOLORCORRECTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xC345A70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityAvatarColorCorrections_TypeDefinitionIndex = 46962;
