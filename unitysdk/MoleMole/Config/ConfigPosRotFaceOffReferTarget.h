...
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CALFACEOFFPOSROT_OFFSET UNITYSDK_OFFSET(0xCDB54A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CHOOSEENTITYORTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCDAFA80)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CHOOSEPOSROTTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xCDB3F00)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CHOOSESPECIALTRANSFORM_OFFSET UNITYSDK_OFFSET(0xCDB3910)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CLONE_OFFSET UNITYSDK_OFFSET(0xCDB68D0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xCDB67F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xCDB5E50)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_FROMFLX_OFFSET UNITYSDK_OFFSET(0xCDB6B00)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETABILITYTARGETOFFSETREFERENTITY_OFFSET UNITYSDK_OFFSET(0xCDB4130)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xCDB5B10)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0xCDB0850)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xCDB69D0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETSAVEPOINTPOSROT_OFFSET UNITYSDK_OFFSET(0xCDB5730)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0xCDB03F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xCDB59E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xCDB5EB0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xCDB6B80)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_ISREFERTARGETCAMERA_OFFSET UNITYSDK_OFFSET(0xCDAF890)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_ISSAVEPOINTOPTION_OFFSET UNITYSDK_OFFSET(0xCDB5970)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_ISSPECIALITEMOPTION_OFFSET UNITYSDK_OFFSET(0xCDB38A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xCDB6640)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xCDB81A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xCDB8300)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xCDB8310)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0xCDB8380)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETSAVEPOINTPOSROT_OFFSET UNITYSDK_OFFSET(0xCDB8480)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0xCDB8550)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xCDB8490)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_ISREFERTARGETCAMERA_OFFSET UNITYSDK_OFFSET(0xCDB8610)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_ISSAVEPOINTOPTION_OFFSET UNITYSDK_OFFSET(0xCDB86F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotFaceOffReferTarget_TypeDefinitionIndex = 53551;

	class ConfigPosRotFaceOffReferTarget : public ::MoleMole::Config::PosRotTargetOption
	{
	public:
		::MoleMole::Config::DynamicString* BackupNodePoint; // 0x10
		::MoleMole::Config::DynamicString* BackupAttachPoint; // 0x18
		::MoleMole::Config::DynamicString* BackupPointName; // 0x20
		::MoleMole::Config::DynamicString* AttachPoint; // 0x28
		...
		::MoleMole::Config::DynamicString* PointName; // 0x48
		...
		::System::Boolean IsUseAttachPointPos; // 0x59
		...
		{
			return ((::UnityEngine::Transform*(*)(::PVOID, ::MoleMole::Battle::Entity*, ::MoleMole::Config::AbilityTargetting, ::MoleMole::Config::DynamicString*, ::System::Boolean&, ::Struct_2_FC595D1A561D8C6F&, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CHOOSESPECIALTRANSFORM_OFFSET))(this, sourceEntity, referTarget, paramNodePoint, getLogicPos, logicPosRot, instancedAbility);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::AbilityTargetting, ::MoleMole::Config::AbilityTargetting, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::Struct_2_FA5F50563E60AFBA&, ::UnityEngine::Transform*&, ::System::Boolean&, ::System::Boolean&, ::Struct_2_FC595D1A561D8C6F&, ::Class_2_14986121AA61AD99*, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CHOOSEENTITYORTRANSFORM_OFFSET))(this, sourceEntity, referTarget, backupTarget, caster, other, targetEntity, targetTransform, useDefaultTarget, useLogicPos, logicPosRot, instancedAbility, forceUseBackUp);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::MoleMole::Battle::Entity*, ::Struct_2_FC595D1A561D8C6F&, ::System::Boolean&, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Battle::Entity*, ::MoleMole::Config::DynamicString*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETSAVEPOINTPOSROT_OFFSET))(this, sourceEntity, posRot, useBackUp, coordsOption, caster, relativeBaseSavePoint, instanceAbility);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::Struct_2_FA5F50563E60AFBA, ::Struct_2_FA5F50563E60AFBA, ::MoleMole::Config::ReferTargetCoordsOption, ::UnityEngine::Vector3&, ::UnityEngine::Quaternion&, ::UnityEngine::Transform*&, ::Struct_2_69EDF57FCDC7C5D3&, ::System::Boolean, ::MoleMole::Battle::Entity*, ::MoleMole::Battle::Entity*, ::UnityEngine::Transform*, ::Class_2_14986121AA61AD99*, ::MoleMole::Config::DynamicString*, ::MoleMole::Config::DynamicString*, ::System::Boolean, ::Struct_2_FC595D1A561D8C6F))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETENTITYPOSROTBYTARGET_OFFSET))(this, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15);
		}
		...
		{
			return ((::System::Boolean(*)(::PVOID, ::MoleMole::Battle::Entity*, ::Struct_2_FC595D1A561D8C6F&, ::System::Boolean&, ::MoleMole::Config::ReferTargetCoordsOption, ::MoleMole::Battle::Entity*, ::MoleMole::Config::DynamicString*, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETSAVEPOINTPOSROT_OFFSET))(this, P0, P1, P2, P3, P4, P5, P6);
		}
