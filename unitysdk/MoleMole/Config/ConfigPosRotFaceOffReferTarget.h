...
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CALFACEOFFPOSROT_OFFSET UNITYSDK_OFFSET(0xB921A30)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CHOOSEENTITYORTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB91C0C0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CHOOSEPOSROTTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xB9204B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CHOOSESPECIALTRANSFORM_OFFSET UNITYSDK_OFFSET(0xB91FEC0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_CLONE_OFFSET UNITYSDK_OFFSET(0xD09B940)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xD09B860)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xD09AEC0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_FROMFLX_OFFSET UNITYSDK_OFFSET(0xD09BB70)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETABILITYTARGETOFFSETREFERENTITY_OFFSET UNITYSDK_OFFSET(0xB9206E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xB9220A0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0xB91CE90)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xD09BA40)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETSAVEPOINTPOSROT_OFFSET UNITYSDK_OFFSET(0xB921CC0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0xB91CA30)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xB921F70)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xD09AF20)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xD09BBF0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_ISREFERTARGETCAMERA_OFFSET UNITYSDK_OFFSET(0xB91BED0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_ISSAVEPOINTOPTION_OFFSET UNITYSDK_OFFSET(0xB921F00)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_ISSPECIALITEMOPTION_OFFSET UNITYSDK_OFFSET(0xB91FE50)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xD09B6B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xD09D210)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xD09D370)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETATTACHPOINT_OFFSET UNITYSDK_OFFSET(0xD09D380)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETENTITYPOSROTBYTARGET_OFFSET UNITYSDK_OFFSET(0xD09D3F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETSAVEPOINTPOSROT_OFFSET UNITYSDK_OFFSET(0xD09D4F0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0xD09D5C0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_GETTARGETENTITY_OFFSET UNITYSDK_OFFSET(0xD09D500)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_ISREFERTARGETCAMERA_OFFSET UNITYSDK_OFFSET(0xD09D680)
#define MOLEMOLE_CONFIG_CONFIGPOSROTFACEOFFREFERTARGET___BASE_ISSAVEPOINTOPTION_OFFSET UNITYSDK_OFFSET(0xD09D760)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotFaceOffReferTarget_TypeDefinitionIndex = 57272;
	...
	public:
		...
		::MoleMole::Config::DynamicString* BackupAttachPoint; // 0x28
		::MoleMole::Config::DynamicString* BackupCustomKey; // 0x30
		::MoleMole::Config::DynamicString* CustomKey; // 0x38
		::MoleMole::Config::DynamicString* PointName; // 0x40
		::MoleMole::Config::DynamicString* BackupPointName; // 0x48
		::MoleMole::Config::AbilityTargetting BackupOffsetReferTarget; // 0x50
		::System::Single DistanceScopeMin; // 0x54
		::System::Single DistanceScopeMax; // 0x58
		::System::Boolean FeaturePointFirst; // 0x5C
		::System::Boolean IsUseAttachPointRotation; // 0x5D
		::System::Boolean IsUseAttachPointPos; // 0x5E
		::MoleMole::Config::AbilityTargetting OffsetReferTarget; // 0x60
