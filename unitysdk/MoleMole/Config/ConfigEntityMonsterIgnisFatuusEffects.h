...
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x9188810)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityMonsterIgnisFatuusEffects_TypeDefinitionIndex = 69392;
