...
#define MOLEMOLE_CONFIG_CONFIGANIMATORINTPARAM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x56A580)
#define MOLEMOLE_CONFIG_CONFIGANIMATORINTPARAM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x56A4F0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORINTPARAM_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x56A5F0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORINTPARAM_METHOD_2_F777B3BEDBE68D53_OFFSET UNITYSDK_OFFSET(0x56A5E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorIntParam_TypeDefinitionIndex = 68197;
