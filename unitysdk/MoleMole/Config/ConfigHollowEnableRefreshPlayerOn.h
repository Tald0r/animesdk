...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWENABLEREFRESHPLAYERON_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x624E540)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWENABLEREFRESHPLAYERON__CTOR_OFFSET UNITYSDK_OFFSET(0x624E620)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowEnableRefreshPlayerOn_TypeDefinitionIndex = 45445;
