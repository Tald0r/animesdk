...
#define MOLEMOLE_CONFIG_CONFIGHOUSERHYTHMSETTING_GET_SYSTEMSETTINGTYPE_OFFSET UNITYSDK_OFFSET(0xEC2B4A0)
#define MOLEMOLE_CONFIG_CONFIGHOUSERHYTHMSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xEC2B4B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHouseRhythmSetting_TypeDefinitionIndex = 66104;
