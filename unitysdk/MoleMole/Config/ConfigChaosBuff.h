...
#define MOLEMOLE_CONFIG_CONFIGCHAOSBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x94FC4C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChaosBuff_TypeDefinitionIndex = 65538;
