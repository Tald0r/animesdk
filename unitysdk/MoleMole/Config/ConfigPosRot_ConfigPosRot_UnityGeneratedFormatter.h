...
#define MOLEMOLE_CONFIG_CONFIGPOSROT_CONFIGPOSROT_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCD0DC50)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_CONFIGPOSROT_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCD0DC60)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_CONFIGPOSROT_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCD0E3C0)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_CONFIGPOSROT_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCD0E850)
#define MOLEMOLE_CONFIG_CONFIGPOSROT_CONFIGPOSROT_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCD0E810)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRot_ConfigPosRot_UnityGeneratedFormatter_TypeDefinitionIndex = 42628;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::PosRotTargetOption*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigPosRot_ConfigPosRot_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2F770);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ReferTargetCoordsOption>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ReferTargetCoordsOption>**)Il2CppClass::FromTypeDefinitionIndex(ConfigPosRot_ConfigPosRot_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2F778);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::OffsetGroup*>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::OffsetGroup*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigPosRot_ConfigPosRot_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2F780);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Single>** StaticGet_CachedSerializer4()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(ConfigPosRot_ConfigPosRot_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2F788);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Boolean>** StaticGet_CachedSerializer3()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(ConfigPosRot_ConfigPosRot_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2F790);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::Config::DynamicString*>** StaticGet_CachedSerializer5()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::DynamicString*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigPosRot_ConfigPosRot_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2F798);
		}
