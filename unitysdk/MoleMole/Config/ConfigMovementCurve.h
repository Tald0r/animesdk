...
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE_CLONE_OFFSET UNITYSDK_OFFSET(0x13F98720)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x13F98690)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x13F99660)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x13F98930)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x13F98800)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x13F996C0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x13F989B0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x13F99C70)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x13F99500)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE_PROCESSRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x13F97FA0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x13F97830)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x13F97800)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTCURVE___BASE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x13F99E20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMovementCurve_TypeDefinitionIndex = 78035;

	class ConfigMovementCurve : public ::MoleMole::Config::ConfigMovement
	{
	public:
		::UnityEngine::AnimationCurve* VelocityCurveY; // 0x38
