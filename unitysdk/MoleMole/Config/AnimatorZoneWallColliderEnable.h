...
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERENABLE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0xB0918A0)
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERENABLE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xB091380)
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERENABLE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xB091630)
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0xB091920)
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERENABLE___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0xB091930)
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERENABLE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xB0919B0)
#define MOLEMOLE_CONFIG_ANIMATORZONEWALLCOLLIDERENABLE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xB091A40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneWallColliderEnable_TypeDefinitionIndex = 67935;
