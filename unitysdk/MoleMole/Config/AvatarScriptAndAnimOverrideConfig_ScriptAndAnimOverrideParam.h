...
#define MOLEMOLE_CONFIG_AVATARSCRIPTANDANIMOVERRIDECONFIG_SCRIPTANDANIMOVERRIDEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9CF9070)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AvatarScriptAndAnimOverrideConfig_ScriptAndAnimOverrideParam_TypeDefinitionIndex = 71700;
