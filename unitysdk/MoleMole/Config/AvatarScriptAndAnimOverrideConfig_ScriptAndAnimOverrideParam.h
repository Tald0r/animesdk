...
#define MOLEMOLE_CONFIG_AVATARSCRIPTANDANIMOVERRIDECONFIG_SCRIPTANDANIMOVERRIDEPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x8046DA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AvatarScriptAndAnimOverrideConfig_ScriptAndAnimOverrideParam_TypeDefinitionIndex = 63182;
