...
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL_CONFIGSPECIALEFFECTHITWALL_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xB477C80)
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL_CONFIGSPECIALEFFECTHITWALL_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xB477C90)
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL_CONFIGSPECIALEFFECTHITWALL_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xB477E90)
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL_CONFIGSPECIALEFFECTHITWALL_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB478050)
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL_CONFIGSPECIALEFFECTHITWALL_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xB478010)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSpecialEffectHitWall_ConfigSpecialEffectHitWall_UnityGeneratedFormatter_TypeDefinitionIndex = 66764;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::DamageDecalData>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSpecialEffectHitWall_ConfigSpecialEffectHitWall_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x47730);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::CharacterDamageDecalType>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSpecialEffectHitWall_ConfigSpecialEffectHitWall_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x47738);
		}
