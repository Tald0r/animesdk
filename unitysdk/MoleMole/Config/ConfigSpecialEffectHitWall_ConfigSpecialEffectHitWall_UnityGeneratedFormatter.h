...
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL_CONFIGSPECIALEFFECTHITWALL_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xE8235B0)
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL_CONFIGSPECIALEFFECTHITWALL_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xE8235C0)
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL_CONFIGSPECIALEFFECTHITWALL_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xE8237C0)
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL_CONFIGSPECIALEFFECTHITWALL_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xE823980)
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL_CONFIGSPECIALEFFECTHITWALL_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xE823940)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSpecialEffectHitWall_ConfigSpecialEffectHitWall_UnityGeneratedFormatter_TypeDefinitionIndex = 36677;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::CharacterDamageDecalType>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSpecialEffectHitWall_ConfigSpecialEffectHitWall_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x413C0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::DamageDecalData>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSpecialEffectHitWall_ConfigSpecialEffectHitWall_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x413C8);
		}
