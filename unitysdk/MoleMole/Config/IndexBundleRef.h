...
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xCAFEE00)
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0xCAFE440)
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0xCAFF210)
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0xCAFE4C0)
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF_METHOD_1_4ECA99273B8D9FC8_OFFSET UNITYSDK_OFFSET(0xCAFEE60)
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0xCAFDC10)
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF__CTOR_OFFSET UNITYSDK_OFFSET(0xCAFF200)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexBundleRef_TypeDefinitionIndex = 60825;
