...
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xEC421E0)
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF_FROMFLX_OFFSET UNITYSDK_OFFSET(0xEC41820)
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0xEC425F0)
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0xEC418A0)
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF_METHOD_1_4ECA99273B8D9FC8_OFFSET UNITYSDK_OFFSET(0xEC42240)
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF_TOSTRING_OFFSET UNITYSDK_OFFSET(0xEC41000)
#define MOLEMOLE_CONFIG_INDEXBUNDLEREF__CTOR_OFFSET UNITYSDK_OFFSET(0xEC425E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndexBundleRef_TypeDefinitionIndex = 65122;
