...
#define MOLEMOLE_CONFIG_ANIMATOREVENTRAYCASTHITWALLEFFECTENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x62A0060)
#define MOLEMOLE_CONFIG_ANIMATOREVENTRAYCASTHITWALLEFFECTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x62A0100)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventRaycastHitWallEffectEntry_TypeDefinitionIndex = 37537;
