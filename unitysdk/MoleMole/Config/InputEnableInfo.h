...
#define MOLEMOLE_CONFIG_INPUTENABLEINFO_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x91979F0)
#define MOLEMOLE_CONFIG_INPUTENABLEINFO_FROMFLX_OFFSET UNITYSDK_OFFSET(0x9197D50)
#define MOLEMOLE_CONFIG_INPUTENABLEINFO_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x9197A50)
#define MOLEMOLE_CONFIG_INPUTENABLEINFO_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x9197DD0)
#define MOLEMOLE_CONFIG_INPUTENABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9198240)

namespace MoleMole::Config
{
	inline static constexpr unsigned int InputEnableInfo_TypeDefinitionIndex = 62212;
