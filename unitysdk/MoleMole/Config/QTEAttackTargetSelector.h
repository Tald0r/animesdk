...
#define MOLEMOLE_CONFIG_QTEATTACKTARGETSELECTOR_METHOD_2_FF36E2394D1E711C_OFFSET UNITYSDK_OFFSET(0xC1E0620)
#define MOLEMOLE_CONFIG_QTEATTACKTARGETSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0xC1E08F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int QTEAttackTargetSelector_TypeDefinitionIndex = 55653;
