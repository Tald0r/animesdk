...
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYEXCLUSIVITY_CONFIGMATERIALPROPERTYEXCLUSIVITY_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCC98320)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYEXCLUSIVITY_CONFIGMATERIALPROPERTYEXCLUSIVITY_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCC98330)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYEXCLUSIVITY_CONFIGMATERIALPROPERTYEXCLUSIVITY_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCC98530)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYEXCLUSIVITY_CONFIGMATERIALPROPERTYEXCLUSIVITY_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCC986F0)
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYEXCLUSIVITY_CONFIGMATERIALPROPERTYEXCLUSIVITY_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCC986B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMaterialPropertyExclusivity_ConfigMaterialPropertyExclusivity_UnityGeneratedFormatter_TypeDefinitionIndex = 61389;
