...
#define MOLEMOLE_CONFIG_CONFIGENTITYVIGNETTES__CTOR_OFFSET UNITYSDK_OFFSET(0xEC2A560)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityVignettes_TypeDefinitionIndex = 66648;
