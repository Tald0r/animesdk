...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWHACKERGAME__CTOR_OFFSET UNITYSDK_OFFSET(0xACC5DD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowHackerGame_TypeDefinitionIndex = 43414;
