...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWHACKERGAME__CTOR_OFFSET UNITYSDK_OFFSET(0xCC97E40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowHackerGame_TypeDefinitionIndex = 79000;
