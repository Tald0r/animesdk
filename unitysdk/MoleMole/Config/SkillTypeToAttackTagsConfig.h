...
#define MOLEMOLE_CONFIG_SKILLTYPETOATTACKTAGSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE446670)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SkillTypeToAttackTagsConfig_TypeDefinitionIndex = 52653;
