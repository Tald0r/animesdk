...
#define MOLEMOLE_CONFIG_CURVEMOVECOMPONENTCONFIG_GET_RUNTIMECONFIG_OFFSET UNITYSDK_OFFSET(0x80611A0)
#define MOLEMOLE_CONFIG_CURVEMOVECOMPONENTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x80612D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CurveMoveComponentConfig_TypeDefinitionIndex = 60443;
	...
	public:
		...
		::MoleMole::Battle::CurveMoveComponent_Config_MoveType moveType; // 0x34
		::System::Single speedDownAcceleration; // 0x38
		::System::Single time; // 0x3C
		::MoleMole::Battle::CurveMoveComponent_Config_SpeedMode speedMode; // 0x40
		::MoleMole::Battle::CurveMoveComponent_Config_LiftMode liftMode; // 0x44
