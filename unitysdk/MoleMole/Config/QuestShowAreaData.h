...
#define MOLEMOLE_CONFIG_QUESTSHOWAREADATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x50F150)
#define MOLEMOLE_CONFIG_QUESTSHOWAREADATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x50F0C0)
#define MOLEMOLE_CONFIG_QUESTSHOWAREADATA_METHOD_2_2A2B8F84DBD45997_OFFSET UNITYSDK_OFFSET(0x50F1B0)
#define MOLEMOLE_CONFIG_QUESTSHOWAREADATA_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x50F1C0)
#define MOLEMOLE_CONFIG_QUESTSHOWAREADATA_METHOD_2_D61A3BD754050C8F_OFFSET UNITYSDK_OFFSET(0x50F0B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int QuestShowAreaData_TypeDefinitionIndex = 38889;
	...
	struct alignas(8) QuestShowAreaData
	{
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_134*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_QUESTSHOWAREADATA_METHOD_2_D61A3BD754050C8F_OFFSET))(this, a1);
		}
