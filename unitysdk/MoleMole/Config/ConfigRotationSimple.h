...
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_CLONE_OFFSET UNITYSDK_OFFSET(0x9509EA0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x9509E90)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x950B200)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x950A0B0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x9509F80)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x950B260)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x950A130)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x950B7A0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x950B0A0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PROCESS_OFFSET UNITYSDK_OFFSET(0x9509650)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_SETUP_OFFSET UNITYSDK_OFFSET(0x95095A0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9509540)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE___BASE_SETUP_OFFSET UNITYSDK_OFFSET(0x950B950)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigRotationSimple_TypeDefinitionIndex = 48210;

	class ConfigRotationSimple : public ::MoleMole::Config::ConfigRotation
	{
	public:
		::UnityEngine::AnimationCurve* InitAngleVelocityCurveY; // 0x28
		::UnityEngine::AnimationCurve* AngleAccelerationCurveY; // 0x30
		::UnityEngine::AnimationCurve* AngleAccelerationCurveX; // 0x38
		::UnityEngine::AnimationCurve* AngleAccelerationCurveZ; // 0x40
		::UnityEngine::AnimationCurve* InitAngleVelocityCurveZ; // 0x48
		::UnityEngine::AnimationCurve* InitAngleVelocityCurveX; // 0x50
		::UnityEngine::Vector3 InitAngleVelocity; // 0x58
		::Enum_3_AF4D3A3041939147 CoordinateType; // 0x64
		::UnityEngine::Vector3 AngleAcceleration; // 0x68
		::System::Single ScaleRatio; // 0x74
		::System::Boolean UseCurve; // 0x78
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_F35B080B137ECC46*, ::Class_3_248DACE3BB3053DD*, ::System::Single))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PROCESS_OFFSET))(this, modelComponent, movementComponent, deltaTime);
		}
