...
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_CLONE_OFFSET UNITYSDK_OFFSET(0x84B2040)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x84B2030)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xE433DA0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x84B2250)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x84B2120)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xE433E00)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x84B22D0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xE434340)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xE433C40)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_PROCESS_OFFSET UNITYSDK_OFFSET(0x84B17F0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE_SETUP_OFFSET UNITYSDK_OFFSET(0x84B1740)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x84B16E0)
#define MOLEMOLE_CONFIG_CONFIGROTATIONSIMPLE___BASE_SETUP_OFFSET UNITYSDK_OFFSET(0xE4344F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigRotationSimple_TypeDefinitionIndex = 64160;

	class ConfigRotationSimple : public ::MoleMole::Config::ConfigRotation
	{
	public:
		::UnityEngine::AnimationCurve* AngleAccelerationCurveX; // 0x28
		::UnityEngine::AnimationCurve* InitAngleVelocityCurveX; // 0x30
		::UnityEngine::AnimationCurve* AngleAccelerationCurveZ; // 0x38
		::UnityEngine::AnimationCurve* InitAngleVelocityCurveY; // 0x40
		::UnityEngine::AnimationCurve* AngleAccelerationCurveY; // 0x48
		::UnityEngine::AnimationCurve* InitAngleVelocityCurveZ; // 0x50
		::System::Single ScaleRatio; // 0x58
		::Enum_3_AF4D3A3041939147 CoordinateType; // 0x5C
		::UnityEngine::Vector3 InitAngleVelocity; // 0x60
		::System::Boolean UseCurve; // 0x6C
