...
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCESHOWSKIPALLBTNNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xB9167F0)
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCESHOWSKIPALLBTNNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB916880)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGachaPerformanceShowSkipAllBtnNode_TypeDefinitionIndex = 61174;
