...
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCESHOWSKIPALLBTNNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCDAA1A0)
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCESHOWSKIPALLBTNNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCDAA230)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGachaPerformanceShowSkipAllBtnNode_TypeDefinitionIndex = 68724;
