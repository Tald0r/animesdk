...
#define MOLEMOLE_CONFIG_CLASSICALSTAGEENTRY_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x97047B0)
#define MOLEMOLE_CONFIG_CLASSICALSTAGEENTRY_GETMAPRANGE_OFFSET UNITYSDK_OFFSET(0x9704870)
#define MOLEMOLE_CONFIG_CLASSICALSTAGEENTRY_GETSTAGELOCATIONNAME_OFFSET UNITYSDK_OFFSET(0x9704A00)
#define MOLEMOLE_CONFIG_CLASSICALSTAGEENTRY_GET_ENVPREFABPATH_OFFSET UNITYSDK_OFFSET(0x9704790)
#define MOLEMOLE_CONFIG_CLASSICALSTAGEENTRY_GET_STAGEAVATARCAMERAKEY_OFFSET UNITYSDK_OFFSET(0x9704750)
#define MOLEMOLE_CONFIG_CLASSICALSTAGEENTRY_GET_STAGENAME_OFFSET UNITYSDK_OFFSET(0x9704710)
#define MOLEMOLE_CONFIG_CLASSICALSTAGEENTRY_GET_STAGESCENEPATH_OFFSET UNITYSDK_OFFSET(0x9704730)
#define MOLEMOLE_CONFIG_CLASSICALSTAGEENTRY_GET_STAGESCRIPTPATH_OFFSET UNITYSDK_OFFSET(0x9704770)
#define MOLEMOLE_CONFIG_CLASSICALSTAGEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x9704860)
#define MOLEMOLE_CONFIG_CLASSICALSTAGEENTRY___BASE_GETSTAGELOCATIONNAME_OFFSET UNITYSDK_OFFSET(0x9704A80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ClassicalStageEntry_TypeDefinitionIndex = 39517;

	class ClassicalStageEntry : public ::MoleMole::Config::StageEntry
	{
	public:
		::Class_2_208CC9941471731A_667* _configTemplateExt; // 0x80
		...
		{
			return ((::MoleMole::Config::StageEntry*(*)(::Class_2_208CC9941471731A_667*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CLASSICALSTAGEENTRY_ALLOCATE_OFFSET))(configTemplateExt);
		}
