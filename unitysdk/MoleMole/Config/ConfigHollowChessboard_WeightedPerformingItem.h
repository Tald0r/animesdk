...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_WEIGHTEDPERFORMINGITEM_GETPERFORMLISTVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x707960)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_WeightedPerformingItem_TypeDefinitionIndex = 59107;
