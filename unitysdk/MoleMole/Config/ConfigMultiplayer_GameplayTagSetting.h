...
#define MOLEMOLE_CONFIG_CONFIGMULTIPLAYER_GAMEPLAYTAGSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xCD0DC20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMultiplayer_GameplayTagSetting_TypeDefinitionIndex = 53477;
