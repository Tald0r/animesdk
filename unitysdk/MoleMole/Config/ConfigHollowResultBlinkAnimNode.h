...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTBLINKANIMNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x8054E10)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTBLINKANIMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x8054EA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowResultBlinkAnimNode_TypeDefinitionIndex = 66752;
