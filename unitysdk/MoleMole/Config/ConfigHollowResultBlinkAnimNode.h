...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTBLINKANIMNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x9D07880)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWRESULTBLINKANIMNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x9D07910)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowResultBlinkAnimNode_TypeDefinitionIndex = 37448;
