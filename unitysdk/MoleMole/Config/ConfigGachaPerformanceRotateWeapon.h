...
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCEROTATEWEAPON_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x6551DD0)
#define MOLEMOLE_CONFIG_CONFIGGACHAPERFORMANCEROTATEWEAPON__CTOR_OFFSET UNITYSDK_OFFSET(0x6551E60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGachaPerformanceRotateWeapon_TypeDefinitionIndex = 51809;
