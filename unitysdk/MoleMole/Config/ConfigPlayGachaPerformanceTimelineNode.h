...
#define MOLEMOLE_CONFIG_CONFIGPLAYGACHAPERFORMANCETIMELINENODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xEC42B10)
#define MOLEMOLE_CONFIG_CONFIGPLAYGACHAPERFORMANCETIMELINENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xEC42BA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayGachaPerformanceTimelineNode_TypeDefinitionIndex = 54865;
