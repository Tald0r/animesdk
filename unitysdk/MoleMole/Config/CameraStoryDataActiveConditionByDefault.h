...
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYDEFAULT_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x9B5ADF0)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYDEFAULT_PASS_OFFSET UNITYSDK_OFFSET(0x9B5AD70)
#define MOLEMOLE_CONFIG_CAMERASTORYDATAACTIVECONDITIONBYDEFAULT__CTOR_OFFSET UNITYSDK_OFFSET(0x9B5AE00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraStoryDataActiveConditionByDefault_TypeDefinitionIndex = 70042;
