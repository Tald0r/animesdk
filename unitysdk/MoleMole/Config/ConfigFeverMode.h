...
#define MOLEMOLE_CONFIG_CONFIGFEVERMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6551760)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFeverMode_TypeDefinitionIndex = 76620;
	...
	public:
		...
		::System::Single FeverReduceCDTime; // 0x20
		::System::Single FeverRatioWhenReduce; // 0x24
