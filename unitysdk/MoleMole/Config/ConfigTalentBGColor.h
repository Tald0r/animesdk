...
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR_METHOD_1_60983406819BC07A_OFFSET UNITYSDK_OFFSET(0x6250E30)
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR_METHOD_1_BE3185ABCAC4124D_OFFSET UNITYSDK_OFFSET(0x62511A0)
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR_METHOD_1_C4706E206E236330_OFFSET UNITYSDK_OFFSET(0x6250EB0)
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR_METHOD_1_FC021F44C9E0792B_OFFSET UNITYSDK_OFFSET(0x6251060)
#define MOLEMOLE_CONFIG_CONFIGTALENTBGCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6250DA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTalentBGColor_TypeDefinitionIndex = 55858;
