...
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTABILITYFRAGMENT_CLONE_OFFSET UNITYSDK_OFFSET(0x804C6C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTABILITYFRAGMENT_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x804C670)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTABILITYFRAGMENT_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x804CCB0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTABILITYFRAGMENT_FROMFLX_OFFSET UNITYSDK_OFFSET(0x804C8F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTABILITYFRAGMENT_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x804C7C0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTABILITYFRAGMENT_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x804CD10)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTABILITYFRAGMENT_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x804C970)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTABILITYFRAGMENT_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x804CEC0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTABILITYFRAGMENT_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x804CB50)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTABILITYFRAGMENT_TOUNIONVALUE_OFFSET UNITYSDK_OFFSET(0x804C4F0)
#define MOLEMOLE_CONFIG_CONFIGDYNAMICVALUELISTABILITYFRAGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x804D070)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDynamicValueListAbilityFragment_TypeDefinitionIndex = 66876;
