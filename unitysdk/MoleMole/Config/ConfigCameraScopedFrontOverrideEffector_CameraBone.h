...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CAMERABONE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x654EE20)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CAMERABONE_RESET_OFFSET UNITYSDK_OFFSET(0x654EEC0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CAMERABONE__CTOR_OFFSET UNITYSDK_OFFSET(0x654EFC0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CAMERABONE___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x654EFD0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CAMERABONE___BASE_RESET_OFFSET UNITYSDK_OFFSET(0x654F040)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_CameraBone_TypeDefinitionIndex = 73836;
