...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CAMERABONE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x81EA990)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CAMERABONE_RESET_OFFSET UNITYSDK_OFFSET(0x81EAA30)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CAMERABONE__CTOR_OFFSET UNITYSDK_OFFSET(0x81EAB30)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CAMERABONE___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0x81EAB40)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CAMERABONE___BASE_RESET_OFFSET UNITYSDK_OFFSET(0x81EABB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_CameraBone_TypeDefinitionIndex = 59391;
