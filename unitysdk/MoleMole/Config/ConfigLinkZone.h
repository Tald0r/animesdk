...
#define MOLEMOLE_CONFIG_CONFIGLINKZONE__CTOR_OFFSET UNITYSDK_OFFSET(0xB473120)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLinkZone_TypeDefinitionIndex = 59006;
