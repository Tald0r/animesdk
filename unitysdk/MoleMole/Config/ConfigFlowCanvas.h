...
#define MOLEMOLE_CONFIG_CONFIGFLOWCANVAS__CTOR_OFFSET UNITYSDK_OFFSET(0xACC5230)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFlowCanvas_TypeDefinitionIndex = 76343;
