...
#define MOLEMOLE_CONFIG_CONFIGFLOWCANVAS__CTOR_OFFSET UNITYSDK_OFFSET(0xCC972A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFlowCanvas_TypeDefinitionIndex = 71095;
