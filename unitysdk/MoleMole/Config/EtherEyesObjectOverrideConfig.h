...
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTOVERRIDECONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x3B70A0)
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTOVERRIDECONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x3B7010)
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTOVERRIDECONFIG_METHOD_2_B3B892B7B0ACCBE5_OFFSET UNITYSDK_OFFSET(0x3B7130)
#define MOLEMOLE_CONFIG_ETHEREYESOBJECTOVERRIDECONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x3B7100)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EtherEyesObjectOverrideConfig_TypeDefinitionIndex = 57481;
