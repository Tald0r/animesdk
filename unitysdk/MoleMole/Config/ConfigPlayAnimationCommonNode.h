...
#define MOLEMOLE_CONFIG_CONFIGPLAYANIMATIONCOMMONNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x6555180)
#define MOLEMOLE_CONFIG_CONFIGPLAYANIMATIONCOMMONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6555230)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayAnimationCommonNode_TypeDefinitionIndex = 45054;
