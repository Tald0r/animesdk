...
#define MOLEMOLE_CONFIG_CONFIGCHARACTERAIMMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x13F8D930)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCharacterAimMode_TypeDefinitionIndex = 78750;
