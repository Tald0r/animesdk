...
#define MOLEMOLE_CONFIG_INTERACTENTRYMODETREASURE_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0x10AA8830)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODETREASURE_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x10AA8780)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODETREASURE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x10AA88D0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODETREASURE__CTOR_OFFSET UNITYSDK_OFFSET(0x10AA8990)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODETREASURE___BASE_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0x10AA89A0)
#define MOLEMOLE_CONFIG_INTERACTENTRYMODETREASURE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x10AA8A00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int InteractEntryModeTreasure_TypeDefinitionIndex = 80989;
