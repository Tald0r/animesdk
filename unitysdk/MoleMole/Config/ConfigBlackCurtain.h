...
#define MOLEMOLE_CONFIG_CONFIGBLACKCURTAIN_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x13994F60)
#define MOLEMOLE_CONFIG_CONFIGBLACKCURTAIN_FROMFLX_OFFSET UNITYSDK_OFFSET(0x13993A80)
#define MOLEMOLE_CONFIG_CONFIGBLACKCURTAIN_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x13994FC0)
#define MOLEMOLE_CONFIG_CONFIGBLACKCURTAIN_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x13993B00)
#define MOLEMOLE_CONFIG_CONFIGBLACKCURTAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x13995940)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigBlackCurtain_TypeDefinitionIndex = 65543;

	class ConfigBlackCurtain : public ::System::Object
	{
	public:
		::System::String* ExcludeTargets; // 0x10
		::System::Boolean EnableStageEffect; // 0x18
		...
		::System::Boolean EnableMonster; // 0x1D
		::System::Boolean DisableShadowColorFadeByZ; // 0x1E
		::System::Boolean DisableReceiveShadows; // 0x1F
		::System::Boolean EnableStageMesh; // 0x20
		::System::Boolean EnableAvatar; // 0x21
		::System::Boolean EnableCaster; // 0x22
		::System::Boolean SuspendCurMatPropertyModifiers; // 0x23
		::System::Boolean DisableStageCollider; // 0x24
