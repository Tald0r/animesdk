...
#define MOLEMOLE_CONFIG_ANIMATORZONEHULLCOLLIDERENABLE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x94F1F70)
#define MOLEMOLE_CONFIG_ANIMATORZONEHULLCOLLIDERENABLE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x94F1820)
#define MOLEMOLE_CONFIG_ANIMATORZONEHULLCOLLIDERENABLE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x94F1BC0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHULLCOLLIDERENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x94F1FF0)
#define MOLEMOLE_CONFIG_ANIMATORZONEHULLCOLLIDERENABLE___BASE_CREATEZONEINFOINSTANCE_OFFSET UNITYSDK_OFFSET(0x94F2000)
#define MOLEMOLE_CONFIG_ANIMATORZONEHULLCOLLIDERENABLE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x94F2080)
#define MOLEMOLE_CONFIG_ANIMATORZONEHULLCOLLIDERENABLE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x94F2110)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneHullColliderEnable_TypeDefinitionIndex = 71200;
