...
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSACTIVE_OFFSET UNITYSDK_OFFSET(0xACC3400)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSBLURPOW2_OFFSET UNITYSDK_OFFSET(0xACC4CF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSBLURPOW_OFFSET UNITYSDK_OFFSET(0xACC4190)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSCOLOR2_OFFSET UNITYSDK_OFFSET(0xACC42D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSCOLORBLENDMODE_OFFSET UNITYSDK_OFFSET(0xACC3640)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSCOLORDISTORTIONINTENSITY2_OFFSET UNITYSDK_OFFSET(0xACC4D90)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSCOLORDISTORTIONINTENSITY_OFFSET UNITYSDK_OFFSET(0xACC4230)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSCOLORTEXTURE2_OFFSET UNITYSDK_OFFSET(0xACC45D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSCOLORTEXTUREUVSCALE2_OFFSET UNITYSDK_OFFSET(0xACC4660)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSCOLORTEXTUREUVSCALE_OFFSET UNITYSDK_OFFSET(0xACC3AF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSCOLORTEXTUREUVSPEED2_OFFSET UNITYSDK_OFFSET(0xACC4700)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSCOLORTEXTUREUVSPEED_OFFSET UNITYSDK_OFFSET(0xACC3B90)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSCOLORTEXTURE_OFFSET UNITYSDK_OFFSET(0xACC3A60)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSCOLOR_OFFSET UNITYSDK_OFFSET(0xACC3760)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSDEPTHMASKOFFSET_OFFSET UNITYSDK_OFFSET(0xACC35B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSDISAPPEAREND_OFFSET UNITYSDK_OFFSET(0xACC5010)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSDISAPPEARSTART_OFFSET UNITYSDK_OFFSET(0xACC4F70)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSDISTORTIONINTENSITY2_OFFSET UNITYSDK_OFFSET(0xACC4BB0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSDISTORTIONINTENSITY_OFFSET UNITYSDK_OFFSET(0xACC4050)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSDISTORTIONOFFSET2_OFFSET UNITYSDK_OFFSET(0xACC4C50)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSDISTORTIONOFFSET_OFFSET UNITYSDK_OFFSET(0xACC40F0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSDOWNSAMPLE_OFFSET UNITYSDK_OFFSET(0xACC3490)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSFADEIN_OFFSET UNITYSDK_OFFSET(0xACC50B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSFADEOUT_OFFSET UNITYSDK_OFFSET(0xACC5150)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSNOISETEXTURE2_OFFSET UNITYSDK_OFFSET(0xACC49E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSNOISETEXTUREUVSCALE2_OFFSET UNITYSDK_OFFSET(0xACC4A70)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSNOISETEXTUREUVSCALE_OFFSET UNITYSDK_OFFSET(0xACC3F10)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSNOISETEXTUREUVSPEED2_OFFSET UNITYSDK_OFFSET(0xACC4B10)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSNOISETEXTUREUVSPEED_OFFSET UNITYSDK_OFFSET(0xACC3FB0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSNOISETEXTURE_OFFSET UNITYSDK_OFFSET(0xACC3E80)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSSELFMASK_OFFSET UNITYSDK_OFFSET(0xACC3520)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSSOFTEDGEPOW_OFFSET UNITYSDK_OFFSET(0xACC4E30)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETMONSTERIGNISFATUUSSOFTEDGERANGE_OFFSET UNITYSDK_OFFSET(0xACC4ED0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GETUSEMONSTERIGNISFATUUSCOLORTEXTUREALPHA_OFFSET UNITYSDK_OFFSET(0xACC36D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GET_MONSTERIGNISFATUUSCOLORTEXTURE2_OFFSET UNITYSDK_OFFSET(0xACC4390)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GET_MONSTERIGNISFATUUSCOLORTEXTURE_OFFSET UNITYSDK_OFFSET(0xACC3820)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GET_MONSTERIGNISFATUUSNOISETEXTURE2_OFFSET UNITYSDK_OFFSET(0xACC47A0)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT_GET_MONSTERIGNISFATUUSNOISETEXTURE_OFFSET UNITYSDK_OFFSET(0xACC3C30)
#define MOLEMOLE_CONFIG_CONFIGENTITYMONSTERIGNISFATUUSEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xACC51F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityMonsterIgnisFatuusEffect_TypeDefinitionIndex = 72079;

	class ConfigEntityMonsterIgnisFatuusEffect : public ::MoleMole::Config::ConfigEntityScreenEffectBase
	{
	public:
		::System::String* monsterIgnisFatuusColorTexturePath; // 0x40
		::MoleMole::Config::ScreenEffectVector2* monsterIgnisFatuusColorTextureUVScale2; // 0x48
		::MoleMole::Config::ScreenEffectVector2* monsterIgnisFatuusNoiseTextureUVSpeed; // 0x50
		::UnityEngine::Texture2D* _monsterIgnisFatuusColorTexture; // 0x58
		::System::String* monsterIgnisFatuusColorTexture2Path; // 0x60
		::MoleMole::Config::ScreenEffectVector2* monsterIgnisFatuusColorTextureUVScale; // 0x68
		::UnityEngine::Texture2D* _monsterIgnisFatuusNoiseTexture2; // 0x70
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusDistortionOffset; // 0x78
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusDisappearStart; // 0x80
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusSoftEdgeRange; // 0x88
		::MoleMole::Config::ScreenEffectVector2* monsterIgnisFatuusColorTextureUVSpeed; // 0x90
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusBlurPow; // 0x98
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusDistortionOffset2; // 0xA0
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusColorDistortionIntensity; // 0xA8
		::System::String* monsterIgnisFatuusNoiseTexture2Path; // 0xB0
		::UnityEngine::Texture2D* _monsterIgnisFatuusNoiseTexture; // 0xB8
		::MoleMole::Config::ScreenEffectVector2* monsterIgnisFatuusNoiseTextureUVScale; // 0xC0
		::System::String* monsterIgnisFatuusNoiseTexturePath; // 0xC8
		::UnityEngine::Texture2D* _monsterIgnisFatuusColorTexture2; // 0xD0
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusBlurPow2; // 0xD8
		::MoleMole::Config::ScreenEffectVector2* monsterIgnisFatuusNoiseTextureUVSpeed2; // 0xE0
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusFadeIn; // 0xE8
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusFadeOut; // 0xF0
		::MoleMole::Config::ScreenEffectVector2* monsterIgnisFatuusColorTextureUVSpeed2; // 0xF8
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusColorDistortionIntensity2; // 0x100
		::MoleMole::Config::ScreenEffectColor* monsterIgnisFatuusColor; // 0x108
		::MoleMole::Config::ScreenEffectVector2* monsterIgnisFatuusNoiseTextureUVScale2; // 0x110
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusDisappearEnd; // 0x118
		::MoleMole::Config::ScreenEffectColor* monsterIgnisFatuusColor2; // 0x120
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusDistortionIntensity2; // 0x128
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusSoftEdgePow; // 0x130
		::MoleMole::Config::ScreenEffectFloat* monsterIgnisFatuusDistortionIntensity; // 0x138
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusDistortionIntensityHandleType; // 0x140
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusColorTextureUVSpeed2HandleType; // 0x144
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusColorDistortionIntensityHandleType; // 0x148
		::System::Boolean monsterIgnisFatuusSelfMask; // 0x14C
		::System::Boolean monsterIgnisFatuusActive; // 0x14D
		::System::Boolean useMonsterIgnisFatuusColorTextureAlpha; // 0x14E
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusColor2HandleType; // 0x150
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusBlurPow2HandleType; // 0x154
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusColorBlendModeHandleType; // 0x158
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusFadeInHandleType; // 0x15C
		::MoleMole::Config::ScreenEffectFieldHandleType useMonsterIgnisFatuusColorTextureAlphaHandleType; // 0x160
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusNoiseTextureHandleType; // 0x164
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusBlurPowHandleType; // 0x168
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusNoiseTextureUVScaleHandleType; // 0x16C
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusDepthMaskOffsetHandleType; // 0x170
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusDistortionOffset2HandleType; // 0x174
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusColorTextureHandleType; // 0x178
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusColorTexture2HandleType; // 0x17C
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusNoiseTextureUVScale2HandleType; // 0x180
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusDisappearStartHandleType; // 0x184
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusNoiseTexture2HandleType; // 0x188
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusActiveHandleType; // 0x18C
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusColorDistortionIntensity2HandleType; // 0x190
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusColorTextureUVSpeedHandleType; // 0x194
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusColorTextureUVScale2HandleType; // 0x198
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusDownSampleHandleType; // 0x19C
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusSelfMaskHandleType; // 0x1A0
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusDistortionIntensity2HandleType; // 0x1A4
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusSoftEdgePowHandleType; // 0x1A8
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusDisappearEndHandleType; // 0x1AC
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusColorHandleType; // 0x1B0
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusSoftEdgeRangeHandleType; // 0x1B4
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusDistortionOffsetHandleType; // 0x1B8
		::System::Single monsterIgnisFatuusDepthMaskOffset; // 0x1BC
		::UnityEngine::Rendering::Universal::BlendModes monsterIgnisFatuusColorBlendMode; // 0x1C0
		::System::Int32 monsterIgnisFatuusDownSample; // 0x1C4
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusFadeOutHandleType; // 0x1C8
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusColorTextureUVScaleHandleType; // 0x1CC
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusNoiseTextureUVSpeedHandleType; // 0x1D0
		::MoleMole::Config::ScreenEffectFieldHandleType monsterIgnisFatuusNoiseTextureUVSpeed2HandleType; // 0x1D4
