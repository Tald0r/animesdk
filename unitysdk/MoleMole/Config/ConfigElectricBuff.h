...
#define MOLEMOLE_CONFIG_CONFIGELECTRICBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xEC3E340)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigElectricBuff_TypeDefinitionIndex = 78685;
