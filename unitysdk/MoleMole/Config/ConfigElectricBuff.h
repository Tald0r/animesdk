...
#define MOLEMOLE_CONFIG_CONFIGELECTRICBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xC344C70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigElectricBuff_TypeDefinitionIndex = 38404;
