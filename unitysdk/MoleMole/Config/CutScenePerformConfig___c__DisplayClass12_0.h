...
#define MOLEMOLE_CONFIG_CUTSCENEPERFORMCONFIG___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB0A0FF0)
#define MOLEMOLE_CONFIG_CUTSCENEPERFORMCONFIG___C__DISPLAYCLASS12_0__MOLEMOLE_CONFIG_ISCENEPERFORMCONFIG_SETUP_B__0_OFFSET UNITYSDK_OFFSET(0xB0A1000)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CutScenePerformConfig___c__DisplayClass12_0_TypeDefinitionIndex = 52559;
	...
	public:
		...
		::Class_0_16E4307DCC419505_303* node; // 0x18
