...
#define MOLEMOLE_CONFIG_CONFIGCOOPVFXQUALITYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x89F4700)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCoopVFXQualitySetting_TypeDefinitionIndex = 51847;
