...
#define MOLEMOLE_CONFIG_CONFIGUIWEAPON_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x8A0D7B0)
#define MOLEMOLE_CONFIG_CONFIGUIWEAPON_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x8A0D400)
#define MOLEMOLE_CONFIG_CONFIGUIWEAPON__CTOR_OFFSET UNITYSDK_OFFSET(0x8A0DCA0)
#define MOLEMOLE_CONFIG_CONFIGUIWEAPON___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x8A0DE60)
#define MOLEMOLE_CONFIG_CONFIGUIWEAPON___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x8A0DE70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIWeapon_TypeDefinitionIndex = 79048;
