...
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA_CLONE_OFFSET UNITYSDK_OFFSET(0x10A997C0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x10A99730)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x10A9AF10)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x10A999D0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x10A998A0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x10A9AF70)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x10A99A50)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x10A9B430)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x10A9ADB0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA_PROCESSRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x10A98600)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x10A98910)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA__CTOR_OFFSET UNITYSDK_OFFSET(0x10A985E0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA___BASE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x10A9B5E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMovementParabola_TypeDefinitionIndex = 60108;
	...
	public:
		...
		::System::Single TargetRotLimitAngleLeft; // 0x40
		::System::Single t1; // 0x44
		::System::Single s2; // 0x48
		::System::Single TargetRotLimitAngleRight; // 0x4C
		::System::Single s1; // 0x50
		::System::Single DefaultRotAngle; // 0x54
		::System::Single h1; // 0x58
		::UnityEngine::Vector3 DefaultOffset; // 0x5C
		::System::Single t2; // 0x68
		::System::Single h2; // 0x6C
		::System::Single InitSpeed; // 0x70
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_F35B080B137ECC46*, ::Class_3_248DACE3BB3053DD*, ::System::Single, ::System::Single, ::Class_2_14986121AA61AD99*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGMOVEMENTPARABOLA_PROCESSRIGIDBODY_OFFSET))(this, modelComponent, movementComponent, deltaTime, timeScale, instancedAbility);
		}
