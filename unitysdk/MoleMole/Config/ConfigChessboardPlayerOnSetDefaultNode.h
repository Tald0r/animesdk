...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDPLAYERONSETDEFAULTNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCDA7C10)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDPLAYERONSETDEFAULTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCDA7CF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardPlayerOnSetDefaultNode_TypeDefinitionIndex = 75171;
