...
#define MOLEMOLE_CONFIG_CONFIGPLAYOVERWRITEGRIDSTATETEXTURECHANGE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x9D0E9C0)
#define MOLEMOLE_CONFIG_CONFIGPLAYOVERWRITEGRIDSTATETEXTURECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x9D0EAA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayOverwriteGridStateTextureChange_TypeDefinitionIndex = 76440;
