...
#define MOLEMOLE_CONFIG_CONFIGPLAYOVERWRITEGRIDSTATETEXTURECHANGE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x805BF70)
#define MOLEMOLE_CONFIG_CONFIGPLAYOVERWRITEGRIDSTATETEXTURECHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x805C050)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayOverwriteGridStateTextureChange_TypeDefinitionIndex = 39731;
