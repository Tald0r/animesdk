...
#define MOLEMOLE_CONFIG_CONFIGPARALLELANDFLOWNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xB09CB00)
#define MOLEMOLE_CONFIG_CONFIGPARALLELANDFLOWNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB09CC20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigParallelAndFlowNode_TypeDefinitionIndex = 72368;
