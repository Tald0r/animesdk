...
#define MOLEMOLE_CONFIG_CONFIGPARALLELANDFLOWNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x970E110)
#define MOLEMOLE_CONFIG_CONFIGPARALLELANDFLOWNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x970E230)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigParallelAndFlowNode_TypeDefinitionIndex = 36986;
