...
#define MOLEMOLE_CONFIG_CONFIGSTOPTIMELINECOMMONNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xF16E550)
#define MOLEMOLE_CONFIG_CONFIGSTOPTIMELINECOMMONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xF16E5E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigStopTimelineCommonNode_TypeDefinitionIndex = 65340;
