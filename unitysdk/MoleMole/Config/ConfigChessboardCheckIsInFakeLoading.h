...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCHECKISINFAKELOADING_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x10A8C920)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCHECKISINFAKELOADING__CTOR_OFFSET UNITYSDK_OFFSET(0x10A8CA00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardCheckIsInFakeLoading_TypeDefinitionIndex = 58418;
