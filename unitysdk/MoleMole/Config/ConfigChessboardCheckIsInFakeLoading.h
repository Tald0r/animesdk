...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCHECKISINFAKELOADING_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x89F4600)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCHECKISINFAKELOADING__CTOR_OFFSET UNITYSDK_OFFSET(0x89F46E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardCheckIsInFakeLoading_TypeDefinitionIndex = 59174;
