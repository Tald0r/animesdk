...
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT_GET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0xCD20990)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT_GET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0xCD209B0)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT_GET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0xCD20970)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT_SET_DYNAMICKEY_OFFSET UNITYSDK_OFFSET(0xCD209A0)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT_SET_FIXEDVALUE_OFFSET UNITYSDK_OFFSET(0xCD209C0)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT_SET_ISDYNAMIC_OFFSET UNITYSDK_OFFSET(0xCD20980)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xCD20920)
#define MOLEMOLE_CONFIG_READONLYDYNAMICFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD208E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ReadonlyDynamicFloat_TypeDefinitionIndex = 40375;
