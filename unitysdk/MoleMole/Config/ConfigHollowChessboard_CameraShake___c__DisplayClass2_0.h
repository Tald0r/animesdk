...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_CAMERASHAKE___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1418F190)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_CAMERASHAKE___C__DISPLAYCLASS2_0__RUN_B__0_OFFSET UNITYSDK_OFFSET(0x1418F1A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_CameraShake___c__DisplayClass2_0_TypeDefinitionIndex = 59114;
