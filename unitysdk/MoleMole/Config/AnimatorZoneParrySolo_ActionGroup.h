...
#define MOLEMOLE_CONFIG_ANIMATORZONEPARRYSOLO_ACTIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xCD9F1C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneParrySolo_ActionGroup_TypeDefinitionIndex = 37727;
	...
	public:
		...
		::MoleMole::Config::AnimatorZoneParrySolo_RotateType rotateType; // 0x20
