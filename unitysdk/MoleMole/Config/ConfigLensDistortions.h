...
#define MOLEMOLE_CONFIG_CONFIGLENSDISTORTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xCC98040)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLensDistortions_TypeDefinitionIndex = 62464;
