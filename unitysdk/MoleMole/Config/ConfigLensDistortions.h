...
#define MOLEMOLE_CONFIG_CONFIGLENSDISTORTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xACC5FD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLensDistortions_TypeDefinitionIndex = 45609;
