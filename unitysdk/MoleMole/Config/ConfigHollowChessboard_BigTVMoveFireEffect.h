...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVEFIREEFFECT_CREATERUNTIMEEFFECTLIST_OFFSET UNITYSDK_OFFSET(0x1418E910)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVEFIREEFFECT_GETGRIDEXISTLIST_OFFSET UNITYSDK_OFFSET(0x1418E550)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVEFIREEFFECT_GET_TOTALDURATION_OFFSET UNITYSDK_OFFSET(0x1418E060)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVEFIREEFFECT_RUN_OFFSET UNITYSDK_OFFSET(0x1418E070)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVEFIREEFFECT_TRYCREATECREATERUNTIMEEFFECTINFO_OFFSET UNITYSDK_OFFSET(0x1418EC50)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVEFIREEFFECT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1418F050)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVEFIREEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1418F040)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_BigTVMoveFireEffect_TypeDefinitionIndex = 59146;
	...
	public:
		...
		{
			return (::System::Lazy_1<::System::Collections::Generic::List_1<::MoleMole::Vector2Int>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigHollowChessboard_BigTVMoveFireEffect_TypeDefinitionIndex)->GetStaticField(0x34340);
		}
		...
		::System::Collections::Generic::List_1<::MoleMole::Config::ConfigHollowChessboard_BigTVMoveFireEffect_RuntimeEffectInfo>* CreateRuntimeEffectList(::Class_5_2169ABC757988FED* chessPiece, ::System::Collections::Generic::List_1<::MoleMole::HollowChessboard::HollowCell>* gridsFullIndex, ::ProtoScript::HollowGridLink moveDir)
		{
			return ((::System::Collections::Generic::List_1<::MoleMole::Config::ConfigHollowChessboard_BigTVMoveFireEffect_RuntimeEffectInfo>*(*)(::PVOID, ::Class_5_2169ABC757988FED*, ::System::Collections::Generic::List_1<::MoleMole::HollowChessboard::HollowCell>*, ::ProtoScript::HollowGridLink))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVEFIREEFFECT_CREATERUNTIMEEFFECTLIST_OFFSET))(this, chessPiece, gridsFullIndex, moveDir);
		}

		::System::Void TryCreateCreateRuntimeEffectInfo(::Class_5_2169ABC757988FED* chessPiece, ::Class_5_AF65C3A968E836D2* chessboard, ::System::Collections::Generic::List_1<::MoleMole::Config::ConfigHollowChessboard_BigTVMoveFireEffect_RuntimeEffectInfo>* inRuntimeEffectList, ::MoleMole::Config::ConfigHollowChessboard_BigTVMoveFireEffect_EffectInfo& effectInfo, ::MoleMole::HollowChessboard::HollowCell fullIndex, ::System::Boolean inIsRightSide, ::System::Boolean inIsMirror, ::System::Boolean inIsUpDir)
		{
			return ((::System::Void(*)(::PVOID, ::Class_5_2169ABC757988FED*, ::Class_5_AF65C3A968E836D2*, ::System::Collections::Generic::List_1<::MoleMole::Config::ConfigHollowChessboard_BigTVMoveFireEffect_RuntimeEffectInfo>*, ::MoleMole::Config::ConfigHollowChessboard_BigTVMoveFireEffect_EffectInfo&, ::MoleMole::HollowChessboard::HollowCell, ::System::Boolean, ::System::Boolean, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVEFIREEFFECT_TRYCREATECREATERUNTIMEEFFECTINFO_OFFSET))(this, chessPiece, chessboard, inRuntimeEffectList, effectInfo, fullIndex, inIsRightSide, inIsMirror, inIsUpDir);
		}

		::System::Boolean GetGridExistList(::Class_5_2169ABC757988FED* chessPiece, ::ProtoScript::HollowGridLink curMoveDir, ::System::Collections::Generic::List_1<::MoleMole::HollowChessboard::HollowCell>*& gridsExist)
		{
			return ((::System::Boolean(*)(::PVOID, ::Class_5_2169ABC757988FED*, ::ProtoScript::HollowGridLink, ::System::Collections::Generic::List_1<::MoleMole::HollowChessboard::HollowCell>*&))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVEFIREEFFECT_GETGRIDEXISTLIST_OFFSET))(this, chessPiece, curMoveDir, gridsExist);
		}
	};
}
