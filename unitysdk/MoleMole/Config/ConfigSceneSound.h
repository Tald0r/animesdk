...
#define MOLEMOLE_CONFIG_CONFIGSCENESOUND__CTOR_OFFSET UNITYSDK_OFFSET(0x139A2920)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSceneSound_TypeDefinitionIndex = 54120;
