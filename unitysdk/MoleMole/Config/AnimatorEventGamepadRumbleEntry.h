...
#define MOLEMOLE_CONFIG_ANIMATOREVENTGAMEPADRUMBLEENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x622B1B0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTGAMEPADRUMBLEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x622B250)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventGamepadRumbleEntry_TypeDefinitionIndex = 64802;
