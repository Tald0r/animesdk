...
#define MOLEMOLE_CONFIG_STIMULUSEVENTITEM_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x385380)
#define MOLEMOLE_CONFIG_STIMULUSEVENTITEM_FROMFLX_OFFSET UNITYSDK_OFFSET(0x3852F0)
#define MOLEMOLE_CONFIG_STIMULUSEVENTITEM_METHOD_2_1F4AF917A1653551_OFFSET UNITYSDK_OFFSET(0x3853E0)
#define MOLEMOLE_CONFIG_STIMULUSEVENTITEM_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x3853F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int StimulusEventItem_TypeDefinitionIndex = 41203;
