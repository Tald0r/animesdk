...
#define MOLEMOLE_CONFIG_CONFIGTELEPORTSELECTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0xCC9E9E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTeleportSelections_TypeDefinitionIndex = 68417;
