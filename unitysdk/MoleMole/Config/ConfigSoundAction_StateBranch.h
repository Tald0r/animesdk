...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH_EXECUTE_OFFSET UNITYSDK_OFFSET(0xCAF5BC0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0xCAF5BB0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH_ISMATCH_OFFSET UNITYSDK_OFFSET(0xCAF5F10)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH_WALK_OFFSET UNITYSDK_OFFSET(0xCAF6150)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH__CTOR_OFFSET UNITYSDK_OFFSET(0xCAF63C0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0xCAF63D0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH___BASE_WALK_OFFSET UNITYSDK_OFFSET(0xCAF63E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_StateBranch_TypeDefinitionIndex = 80759;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_148*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTION_STATEBRANCH_EXECUTE_OFFSET))(this, context);
		}
