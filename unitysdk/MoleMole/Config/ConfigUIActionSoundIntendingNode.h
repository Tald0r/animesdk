...
#define MOLEMOLE_CONFIG_CONFIGUIACTIONSOUNDINTENDINGNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xC1DCA30)
#define MOLEMOLE_CONFIG_CONFIGUIACTIONSOUNDINTENDINGNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC1DCAC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIActionSoundIntendingNode_TypeDefinitionIndex = 73655;
