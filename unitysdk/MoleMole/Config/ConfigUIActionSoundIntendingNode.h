...
#define MOLEMOLE_CONFIG_CONFIGUIACTIONSOUNDINTENDINGNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x81F2DD0)
#define MOLEMOLE_CONFIG_CONFIGUIACTIONSOUNDINTENDINGNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x81F2E60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIActionSoundIntendingNode_TypeDefinitionIndex = 77803;
