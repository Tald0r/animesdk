...
#define MOLEMOLE_CONFIG_ANIMATOREVENTCALLGRAPHEVENTWITHPARAMSENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x13F818C0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTCALLGRAPHEVENTWITHPARAMSENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x13F81960)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventCallGraphEventWithParamsEntry_TypeDefinitionIndex = 44274;
