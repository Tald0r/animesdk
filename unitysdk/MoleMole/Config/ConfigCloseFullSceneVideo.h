...
#define MOLEMOLE_CONFIG_CONFIGCLOSEFULLSCENEVIDEO_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCDA7D10)
#define MOLEMOLE_CONFIG_CONFIGCLOSEFULLSCENEVIDEO__CTOR_OFFSET UNITYSDK_OFFSET(0xCDA7DF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCloseFullSceneVideo_TypeDefinitionIndex = 64905;
