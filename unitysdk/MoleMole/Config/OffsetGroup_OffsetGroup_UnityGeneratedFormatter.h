...
#define MOLEMOLE_CONFIG_OFFSETGROUP_OFFSETGROUP_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xF173230)
#define MOLEMOLE_CONFIG_OFFSETGROUP_OFFSETGROUP_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xF173240)
#define MOLEMOLE_CONFIG_OFFSETGROUP_OFFSETGROUP_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xF173960)
#define MOLEMOLE_CONFIG_OFFSETGROUP_OFFSETGROUP_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xF173E10)
#define MOLEMOLE_CONFIG_OFFSETGROUP_OFFSETGROUP_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xF173DD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int OffsetGroup_OffsetGroup_UnityGeneratedFormatter_TypeDefinitionIndex = 73718;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(OffsetGroup_OffsetGroup_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x42350);
		}
		static ::Sirenix::Serialization::Serializer_1<::UnityEngine::Vector3>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(OffsetGroup_OffsetGroup_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x42358);
		}
