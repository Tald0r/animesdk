...
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTFOLLOWPARTICLE_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1399CA10)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTFOLLOWPARTICLE_PROCESSRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1399CB90)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTFOLLOWPARTICLE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x1399C8E0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTFOLLOWPARTICLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1399D020)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTFOLLOWPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1399D010)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTFOLLOWPARTICLE___BASE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0x1399D050)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMovementFollowParticle_TypeDefinitionIndex = 50901;
	...
	public:
		...
		{
			return (::MoleMole::Config::ConfigMovementFollowParticle**)Il2CppClass::FromTypeDefinitionIndex(ConfigMovementFollowParticle_TypeDefinitionIndex)->GetStaticField(0x3A2B0);
		}
