...
#define MOLEMOLE_CONFIG_INDICATORLIGHTSPRESET__CTOR_OFFSET UNITYSDK_OFFSET(0xF171B40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int IndicatorLightsPreset_TypeDefinitionIndex = 39697;
