...
#define MOLEMOLE_CONFIG_CONFIGDELAYEDACTIVATEATMOSPHEREANDFILTER_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xC231010)
#define MOLEMOLE_CONFIG_CONFIGDELAYEDACTIVATEATMOSPHEREANDFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC2310F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDelayedActivateAtmosphereAndFilter_TypeDefinitionIndex = 64689;
