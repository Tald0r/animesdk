...
#define MOLEMOLE_CONFIG_CONFIGDELAYEDACTIVATEATMOSPHEREANDFILTER_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x6243DA0)
#define MOLEMOLE_CONFIG_CONFIGDELAYEDACTIVATEATMOSPHEREANDFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x6243E80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDelayedActivateAtmosphereAndFilter_TypeDefinitionIndex = 37910;
