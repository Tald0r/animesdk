...
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_CLONE_OFFSET UNITYSDK_OFFSET(0x15EBB800)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0x15EBB7B0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x15EBB410)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_FROMFLX_OFFSET UNITYSDK_OFFSET(0x15EBBA10)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0x15EBB8E0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x15EBB100)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0x15EBB470)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0x15EBBA90)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0x15EBB600)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0x15EBBC90)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD__CTOR_OFFSET UNITYSDK_OFFSET(0x15EBBDF0)
#define MOLEMOLE_CONFIG_CONFIGPOSROTWORLD___BASE_GETTARGETENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x15EBBE00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPosRotWorld_TypeDefinitionIndex = 62765;
