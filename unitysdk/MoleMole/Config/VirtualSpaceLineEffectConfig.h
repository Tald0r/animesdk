...
#define MOLEMOLE_CONFIG_VIRTUALSPACELINEEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9715D80)

namespace MoleMole::Config
{
	inline static constexpr unsigned int VirtualSpaceLineEffectConfig_TypeDefinitionIndex = 56689;
