...
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDEBONEADJUSTPARAMS_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x10A85300)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDEBONEADJUSTPARAMS_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x10A85490)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDEBONEADJUSTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x10A85620)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDEBONEADJUSTPARAMS___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0x10A85640)
#define MOLEMOLE_CONFIG_ANIMATORZONEOVERRIDEBONEADJUSTPARAMS___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0x10A856D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneOverrideBoneAdjustParams_TypeDefinitionIndex = 77529;
