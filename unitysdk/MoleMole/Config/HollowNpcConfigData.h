...
#define MOLEMOLE_CONFIG_HOLLOWNPCCONFIGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xEC50190)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowNpcConfigData_TypeDefinitionIndex = 46958;
