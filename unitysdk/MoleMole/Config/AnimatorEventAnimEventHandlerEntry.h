...
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x622AAD0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY_GETHASH16_OFFSET UNITYSDK_OFFSET(0x622AB70)
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY_GET_ANIMEVENTHASH_OFFSET UNITYSDK_OFFSET(0x622AAB0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY_ONSERIALIZEDTORUNTIME_OFFSET UNITYSDK_OFFSET(0x622ABD0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY_SET_ANIMEVENTHASH_OFFSET UNITYSDK_OFFSET(0x622AAC0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x622AC90)
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY___BASE_ONSERIALIZEDTORUNTIME_OFFSET UNITYSDK_OFFSET(0x622ACC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventAnimEventHandlerEntry_TypeDefinitionIndex = 72527;
