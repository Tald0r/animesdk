...
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0xC217D40)
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY_GETHASH16_OFFSET UNITYSDK_OFFSET(0xC217DE0)
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY_GET_ANIMEVENTHASH_OFFSET UNITYSDK_OFFSET(0xC217D20)
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY_ONSERIALIZEDTORUNTIME_OFFSET UNITYSDK_OFFSET(0xC217E40)
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY_SET_ANIMEVENTHASH_OFFSET UNITYSDK_OFFSET(0xC217D30)
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xC217F00)
#define MOLEMOLE_CONFIG_ANIMATOREVENTANIMEVENTHANDLERENTRY___BASE_ONSERIALIZEDTORUNTIME_OFFSET UNITYSDK_OFFSET(0xC217F30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventAnimEventHandlerEntry_TypeDefinitionIndex = 67956;
