...
#define MOLEMOLE_CONFIG_CONFIGPLAYOVERLOADBARANIMATIONNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xF2D5220)
#define MOLEMOLE_CONFIG_CONFIGPLAYOVERLOADBARANIMATIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xF2D5300)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayOverloadBarAnimationNode_TypeDefinitionIndex = 65701;
