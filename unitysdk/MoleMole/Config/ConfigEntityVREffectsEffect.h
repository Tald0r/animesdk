...
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETBRIGHTNESS_OFFSET UNITYSDK_OFFSET(0xC235B60)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETCOLORB_OFFSET UNITYSDK_OFFSET(0xC2382E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETCOLORG_OFFSET UNITYSDK_OFFSET(0xC238190)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETCOLORR_OFFSET UNITYSDK_OFFSET(0xC238030)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETCOLORTINTEND_OFFSET UNITYSDK_OFFSET(0xC235EA0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETCOLORTINTFAR_OFFSET UNITYSDK_OFFSET(0xC235F40)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETCOLORTINTNEAR_OFFSET UNITYSDK_OFFSET(0xC235DE0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETCOLORTINTSTART_OFFSET UNITYSDK_OFFSET(0xC235D40)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETCONTRASTMIDDLEPOINT_OFFSET UNITYSDK_OFFSET(0xC235CA0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETCONTRAST_OFFSET UNITYSDK_OFFSET(0xC235C00)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETCUSTOMSCANDIRECTION_OFFSET UNITYSDK_OFFSET(0xC236300)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCECOLORIZATIONEFFECT_OFFSET UNITYSDK_OFFSET(0xC23A370)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCECOLORIZATIONOFFSETSPEED_OFFSET UNITYSDK_OFFSET(0xC23AF90)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCECOLORIZATIONTILING_OFFSET UNITYSDK_OFFSET(0xC23B050)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCECOLORIZETEXTURE_OFFSET UNITYSDK_OFFSET(0xC23A940)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCEDISTORTIONBLENDMODE_OFFSET UNITYSDK_OFFSET(0xC23B1B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCEDISTORTIONCOLOR_OFFSET UNITYSDK_OFFSET(0xC23B0F0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCEDISTORTIONEND_OFFSET UNITYSDK_OFFSET(0xC23AA70)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCEDISTORTIONFADERANGE_OFFSET UNITYSDK_OFFSET(0xC23AB10)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCEDISTORTIONHEIGHTEND_OFFSET UNITYSDK_OFFSET(0xC23AC50)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCEDISTORTIONHEIGHTFADERANGE_OFFSET UNITYSDK_OFFSET(0xC23ACF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCEDISTORTIONHEIGHTSTART_OFFSET UNITYSDK_OFFSET(0xC23ABB0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCEDISTORTIONINTENSITY_OFFSET UNITYSDK_OFFSET(0xC23AEF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCEDISTORTIONOFFSETSPEED_OFFSET UNITYSDK_OFFSET(0xC23AD90)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCEDISTORTIONSTART_OFFSET UNITYSDK_OFFSET(0xC23A9D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCEDISTORTIONTEXTURE_OFFSET UNITYSDK_OFFSET(0xC23A660)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETDISTANCEDISTORTIONTILING_OFFSET UNITYSDK_OFFSET(0xC23AE50)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETENABLEDISTANCEDISTORTIONCOLORIZATION_OFFSET UNITYSDK_OFFSET(0xC23A2D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETENABLE_OFFSET UNITYSDK_OFFSET(0xC235990)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETFADESOURCEIMAGE_OFFSET UNITYSDK_OFFSET(0xC2383A0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETGRIDBLENDSCANLINE_OFFSET UNITYSDK_OFFSET(0xC238A90)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETGRIDCOLOR_OFFSET UNITYSDK_OFFSET(0xC238B20)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETGRIDDISTANCE_OFFSET UNITYSDK_OFFSET(0xC238A00)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETGRIDON_OFFSET UNITYSDK_OFFSET(0xC238960)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETGRIDPOWER_OFFSET UNITYSDK_OFFSET(0xC238BE0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETGROUNDYPOS_OFFSET UNITYSDK_OFFSET(0xC238C70)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETHUE_OFFSET UNITYSDK_OFFSET(0xC235A20)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETKEEPINFRONTFORUBERPOST_OFFSET UNITYSDK_OFFSET(0xC236AC0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETLENSDISTORTIONCENTER_OFFSET UNITYSDK_OFFSET(0xC23A190)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETLENSDISTORTIONINTENSITY_OFFSET UNITYSDK_OFFSET(0xC239FB0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETLENSDISTORTIONSCALE_OFFSET UNITYSDK_OFFSET(0xC23A230)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETLENSDISTORTIONXMULTIPLIER_OFFSET UNITYSDK_OFFSET(0xC23A050)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETLENSDISTORTIONYMULTIPLIER_OFFSET UNITYSDK_OFFSET(0xC23A0F0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEBLENDSCANLINE_OFFSET UNITYSDK_OFFSET(0xC238EF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINECOLOR_OFFSET UNITYSDK_OFFSET(0xC239260)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEDEPTHTHRESHOLD_OFFSET UNITYSDK_OFFSET(0xC2390B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEDIFFOFFSET_OFFSET UNITYSDK_OFFSET(0xC239020)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEDISTORTIONINTENSITY_OFFSET UNITYSDK_OFFSET(0xC2399C0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEDISTORTIONOFFSET_OFFSET UNITYSDK_OFFSET(0xC239920)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEDISTORTIONTEXOFFSET_OFFSET UNITYSDK_OFFSET(0xC2397E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEDISTORTIONTEXTILING_OFFSET UNITYSDK_OFFSET(0xC239740)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEDISTORTIONTEX_OFFSET UNITYSDK_OFFSET(0xC2396B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEDISTORTIONUVSPEED_OFFSET UNITYSDK_OFFSET(0xC239880)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEDISTORTION_OFFSET UNITYSDK_OFFSET(0xC2393C0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEINUBERSHADER_OFFSET UNITYSDK_OFFSET(0xC239320)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINENORMALTHRESHOLDSCALE_OFFSET UNITYSDK_OFFSET(0xC2391D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINENORMALTHRESHOLD_OFFSET UNITYSDK_OFFSET(0xC239140)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEON_OFFSET UNITYSDK_OFFSET(0xC238E50)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETOUTLINEOPACITY_OFFSET UNITYSDK_OFFSET(0xC238F80)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETREVERSE_OFFSET UNITYSDK_OFFSET(0xC238580)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSATURATION_OFFSET UNITYSDK_OFFSET(0xC235AC0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANCOLOR0END_OFFSET UNITYSDK_OFFSET(0xC236E80)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANCOLOR0MODE_OFFSET UNITYSDK_OFFSET(0xC236F40)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANCOLOR0_OFFSET UNITYSDK_OFFSET(0xC236DC0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANCOLOR1END_OFFSET UNITYSDK_OFFSET(0xC237380)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANCOLOR1MODE_OFFSET UNITYSDK_OFFSET(0xC237440)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANCOLOR1_OFFSET UNITYSDK_OFFSET(0xC2372D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANCOLOR2END_OFFSET UNITYSDK_OFFSET(0xC237890)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANCOLOR2MODE_OFFSET UNITYSDK_OFFSET(0xC237950)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANCOLOR2_OFFSET UNITYSDK_OFFSET(0xC2377D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANCOLOR3END_OFFSET UNITYSDK_OFFSET(0xC237DA0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANCOLOR3MODE_OFFSET UNITYSDK_OFFSET(0xC237E60)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANCOLOR3_OFFSET UNITYSDK_OFFSET(0xC237CE0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANEND0SOFT_OFFSET UNITYSDK_OFFSET(0xC236D30)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANEND0_OFFSET UNITYSDK_OFFSET(0xC236C00)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANEND1SOFT_OFFSET UNITYSDK_OFFSET(0xC237240)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANEND1_OFFSET UNITYSDK_OFFSET(0xC237110)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANEND2SOFT_OFFSET UNITYSDK_OFFSET(0xC237740)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANEND2_OFFSET UNITYSDK_OFFSET(0xC237610)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANEND3SOFT_OFFSET UNITYSDK_OFFSET(0xC237C50)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANEND3_OFFSET UNITYSDK_OFFSET(0xC237B20)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANLINECONTRAST_OFFSET UNITYSDK_OFFSET(0xC236090)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANLINEDISTORTION_OFFSET UNITYSDK_OFFSET(0xC236130)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANLINEWIDTH_OFFSET UNITYSDK_OFFSET(0xC236000)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANMASKBASEY_OFFSET UNITYSDK_OFFSET(0xC236980)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANMASKINTENSITY0_OFFSET UNITYSDK_OFFSET(0xC236FD0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANMASKINTENSITY1_OFFSET UNITYSDK_OFFSET(0xC2374D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANMASKINTENSITY2_OFFSET UNITYSDK_OFFSET(0xC2379E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANMASKINTENSITY3_OFFSET UNITYSDK_OFFSET(0xC237EF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANMASKTEXCHANNEL_OFFSET UNITYSDK_OFFSET(0xC236710)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANMASKTEXOFFSET_OFFSET UNITYSDK_OFFSET(0xC236840)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANMASKTEXTILING_OFFSET UNITYSDK_OFFSET(0xC2367A0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANMASKTEXUVSPEED_OFFSET UNITYSDK_OFFSET(0xC2368E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANMASKTEX_OFFSET UNITYSDK_OFFSET(0xC236680)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANMASKTYPE_OFFSET UNITYSDK_OFFSET(0xC2363A0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANMASKYRANGE_OFFSET UNITYSDK_OFFSET(0xC236A20)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANSTART0SOFT_OFFSET UNITYSDK_OFFSET(0xC236CA0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANSTART0_OFFSET UNITYSDK_OFFSET(0xC236B60)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANSTART1SOFT_OFFSET UNITYSDK_OFFSET(0xC2371B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANSTART1_OFFSET UNITYSDK_OFFSET(0xC237070)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANSTART2SOFT_OFFSET UNITYSDK_OFFSET(0xC2376B0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANSTART2_OFFSET UNITYSDK_OFFSET(0xC237570)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANSTART3SOFT_OFFSET UNITYSDK_OFFSET(0xC237BC0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANSTART3_OFFSET UNITYSDK_OFFSET(0xC237A80)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCANTYPE_OFFSET UNITYSDK_OFFSET(0xC2361D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCREENSPACEGRIDSCALE_OFFSET UNITYSDK_OFFSET(0xC238D10)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSCREENSPACEGRIDWIDTH_OFFSET UNITYSDK_OFFSET(0xC238DB0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSLICEANGLE_OFFSET UNITYSDK_OFFSET(0xC2384E0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSLICECOLORAMODE_OFFSET UNITYSDK_OFFSET(0xC238780)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSLICECOLORA_OFFSET UNITYSDK_OFFSET(0xC2386C0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSLICECOLORBMODE_OFFSET UNITYSDK_OFFSET(0xC2388D0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSLICECOLORB_OFFSET UNITYSDK_OFFSET(0xC238810)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSLICEOFFSET_OFFSET UNITYSDK_OFFSET(0xC238620)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETSLICEWIDTH_OFFSET UNITYSDK_OFFSET(0xC238440)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETTEXTURESHEETCOLOR_OFFSET UNITYSDK_OFFSET(0xC239EF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETTEXTURESHEETINDEX_OFFSET UNITYSDK_OFFSET(0xC239E50)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETTEXTURESHEETON_OFFSET UNITYSDK_OFFSET(0xC239A60)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETTEXTURESHEETTEX_OFFSET UNITYSDK_OFFSET(0xC239D30)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETTEXTURESHEETXY_OFFSET UNITYSDK_OFFSET(0xC239DC0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETUSECUSTOMSCANDIRECTION_OFFSET UNITYSDK_OFFSET(0xC236260)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETUVOFFSETB_OFFSET UNITYSDK_OFFSET(0xC238240)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETUVOFFSETG_OFFSET UNITYSDK_OFFSET(0xC2380F0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GETUVOFFSETR_OFFSET UNITYSDK_OFFSET(0xC237F90)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GET_DISTANCECOLORIZETEXTURE_OFFSET UNITYSDK_OFFSET(0xC23A6F0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GET_DISTANCEDISTORTIONTEXTURE_OFFSET UNITYSDK_OFFSET(0xC23A410)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GET_OUTLINEDISTORTIONTEX_OFFSET UNITYSDK_OFFSET(0xC239460)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GET_SCANMASKTEX_OFFSET UNITYSDK_OFFSET(0xC236430)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT_GET_TEXTURESHEETTEX_OFFSET UNITYSDK_OFFSET(0xC239AF0)
#define MOLEMOLE_CONFIG_CONFIGENTITYVREFFECTSEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC23B240)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityVREffectsEffect_TypeDefinitionIndex = 74119;

	class ConfigEntityVREffectsEffect : public ::MoleMole::Config::ConfigEntityScreenEffectBase
	{
	public:
		::System::String* textureSheetTexPath; // 0x40
		::MoleMole::Config::ScreenEffectFloat* scanMaskIntensity3; // 0x48
		::MoleMole::Config::ScreenEffectFloat* textureSheetIndex; // 0x50
		::MoleMole::Config::ScreenEffectColor* colorG; // 0x58
		::MoleMole::Config::ScreenEffectFloat* colorTintEnd; // 0x60
		::MoleMole::Config::ScreenEffectFloat* lensDistortionScale; // 0x68
		::MoleMole::Config::ScreenEffectFloat* scanStart1; // 0x70
		::MoleMole::Config::ScreenEffectColor* scanColor1; // 0x78
		::MoleMole::Config::ScreenEffectFloat* distanceDistortionHeightStart; // 0x80
		::MoleMole::Config::ScreenEffectFloat* customScanDirection; // 0x88
		::MoleMole::Config::ScreenEffectColor* scanColor3End; // 0x90
		::MoleMole::Config::ScreenEffectFloat* scanStart2; // 0x98
		::MoleMole::Config::ScreenEffectVector2* outlineDistortionIntensity; // 0xA0
		::MoleMole::Config::ScreenEffectColor* textureSheetColor; // 0xA8
		::MoleMole::Config::ScreenEffectBool* outlineInUberShader; // 0xB0
		::MoleMole::Config::ScreenEffectColor* scanColor0; // 0xB8
		::MoleMole::Config::ScreenEffectColor* scanColor2End; // 0xC0
		::MoleMole::Config::ScreenEffectFloat* scanMaskBaseY; // 0xC8
		::MoleMole::Config::ScreenEffectFloat* distanceDistortionTiling; // 0xD0
		::MoleMole::Config::ScreenEffectVector2* outlineDistortionOffset; // 0xD8
		::MoleMole::Config::ScreenEffectFloat* distanceDistortionEnd; // 0xE0
		::MoleMole::Config::ScreenEffectFloat* lensDistortionYMultiplier; // 0xE8
		::MoleMole::Config::ScreenEffectFloat* fadeSourceImage; // 0xF0
		::MoleMole::Config::ScreenEffectFloat* contrast; // 0xF8
		::MoleMole::Config::ScreenEffectFloat* distanceDistortionFadeRange; // 0x100
		::MoleMole::Config::ScreenEffectVector2* scanMaskTexUVSpeed; // 0x108
		::MoleMole::Config::ScreenEffectColor* colorB; // 0x110
		::MoleMole::Config::ScreenEffectColor* distanceDistortionColor; // 0x118
		::MoleMole::Config::ScreenEffectVector3* distanceDistortionOffsetSpeed; // 0x120
		::UnityEngine::Texture2D* _textureSheetTex; // 0x128
		::System::String* distanceDistortionTexturePath; // 0x130
		::MoleMole::Config::ScreenEffectFloat* outlineOpacity; // 0x138
		::MoleMole::Config::ScreenEffectColor* gridColor; // 0x140
		::MoleMole::Config::ScreenEffectBool* gridOn; // 0x148
		::MoleMole::Config::ScreenEffectBool* outlineOn; // 0x150
		::MoleMole::Config::ScreenEffectColor* scanColor2; // 0x158
		::MoleMole::Config::ScreenEffectBool* keepInFrontForUberPost; // 0x160
		::MoleMole::Config::ScreenEffectFloat* saturation; // 0x168
		::MoleMole::Config::ScreenEffectFloat* scanEnd0; // 0x170
		::MoleMole::Config::ScreenEffectFloat* scanEnd3; // 0x178
		::MoleMole::Config::ScreenEffectFloat* screenSpaceGridScale; // 0x180
		::MoleMole::Config::ScreenEffectFloat* scanlineContrast; // 0x188
		::MoleMole::Config::ScreenEffectFloat* scanMaskIntensity1; // 0x190
		::MoleMole::Config::ScreenEffectVector2* scanMaskTexOffset; // 0x198
		::MoleMole::Config::ScreenEffectFloat* scanMaskIntensity2; // 0x1A0
		::MoleMole::Config::ScreenEffectFloat* sliceAngle; // 0x1A8
		::UnityEngine::Texture2D* _scanMaskTex; // 0x1B0
		::System::String* distanceColorizeTexturePath; // 0x1B8
		::MoleMole::Config::ScreenEffectBool* useCustomScanDirection; // 0x1C0
		::MoleMole::Config::ScreenEffectFloat* lensDistortionIntensity; // 0x1C8
		::MoleMole::Config::ScreenEffectFloat* scanEnd1; // 0x1D0
		::MoleMole::Config::ScreenEffectFloat* scanlineDistortion; // 0x1D8
		::MoleMole::Config::ScreenEffectFloat* distanceDistortionHeightFadeRange; // 0x1E0
		::MoleMole::Config::ScreenEffectFloat* scanStart3; // 0x1E8
		::MoleMole::Config::ScreenEffectFloat* contrastMiddlePoint; // 0x1F0
		::MoleMole::Config::ScreenEffectFloat* lensDistortionXMultiplier; // 0x1F8
		::MoleMole::Config::ScreenEffectColor* sliceColorA; // 0x200
		::MoleMole::Config::ScreenEffectFloat* distanceColorizationTiling; // 0x208
		::UnityEngine::Texture2D* _distanceDistortionTexture; // 0x210
		::MoleMole::Config::ScreenEffectFloat* scanStart0; // 0x218
		::MoleMole::Config::ScreenEffectBool* reverse; // 0x220
		::MoleMole::Config::ScreenEffectFloat* brightness; // 0x228
		::MoleMole::Config::ScreenEffectVector2* scanMaskTexTiling; // 0x230
		::MoleMole::Config::ScreenEffectVector2* uvOffsetR; // 0x238
		::MoleMole::Config::ScreenEffectColor* colorTintNear; // 0x240
		::MoleMole::Config::ScreenEffectVector2* lensDistortionCenter; // 0x248
		::MoleMole::Config::ScreenEffectFloat* screenSpaceGridWidth; // 0x250
		::MoleMole::Config::ScreenEffectColor* scanColor3; // 0x258
		::System::String* scanMaskTexPath; // 0x260
		::MoleMole::Config::ScreenEffectVector2* uvOffsetB; // 0x268
		::MoleMole::Config::ScreenEffectFloat* scanMaskIntensity0; // 0x270
		::MoleMole::Config::ScreenEffectFloat* colorTintStart; // 0x278
		::MoleMole::Config::ScreenEffectVector2* outlineDistortionTexOffset; // 0x280
		::UnityEngine::Texture2D* _outlineDistortionTex; // 0x288
		::MoleMole::Config::ScreenEffectColor* sliceColorB; // 0x290
		::MoleMole::Config::ScreenEffectFloat* distanceDistortionIntensity; // 0x298
		::MoleMole::Config::ScreenEffectFloat* groundYPos; // 0x2A0
		::MoleMole::Config::ScreenEffectFloat* distanceColorizationEffect; // 0x2A8
		::MoleMole::Config::ScreenEffectVector2* uvOffsetG; // 0x2B0
		::MoleMole::Config::ScreenEffectColor* scanColor1End; // 0x2B8
		::MoleMole::Config::ScreenEffectFloat* scanEnd2; // 0x2C0
		::MoleMole::Config::ScreenEffectFloat* distanceDistortionStart; // 0x2C8
		::MoleMole::Config::ScreenEffectBool* outlineDistortion; // 0x2D0
		::MoleMole::Config::ScreenEffectBool* enableDistanceDistortionColorization; // 0x2D8
		::System::String* outlineDistortionTexPath; // 0x2E0
		::MoleMole::Config::ScreenEffectFloat* hue; // 0x2E8
		::MoleMole::Config::ScreenEffectFloat* sliceWidth; // 0x2F0
		::MoleMole::Config::ScreenEffectVector3* distanceColorizationOffsetSpeed; // 0x2F8
		::MoleMole::Config::ScreenEffectVector2* outlineDistortionTexTiling; // 0x300
		::MoleMole::Config::ScreenEffectColor* colorR; // 0x308
		::MoleMole::Config::ScreenEffectFloat* sliceOffset; // 0x310
		::MoleMole::Config::ScreenEffectColor* colorTintFar; // 0x318
		::MoleMole::Config::ScreenEffectColor* scanColor0End; // 0x320
		::UnityEngine::Texture2D* _distanceColorizeTexture; // 0x328
		::MoleMole::Config::ScreenEffectVector2* outlineDistortionUVSpeed; // 0x330
		::MoleMole::Config::ScreenEffectFloat* scanMaskYRange; // 0x338
		::MoleMole::Config::ScreenEffectColor* outlineColor; // 0x340
		::MoleMole::Config::ScreenEffectFloat* distanceDistortionHeightEnd; // 0x348
		::MoleMole::Config::ScreenEffectFieldHandleType enableHandleType; // 0x350
		::MoleMole::Config::ScreenEffectFieldHandleType scanStart0SoftHandleType; // 0x354
		::MoleMole::Config::ScreenEffectFieldHandleType distanceDistortionHeightStartHandleType; // 0x358
		::MoleMole::Config::ScreenEffectFieldHandleType gridPowerHandleType; // 0x35C
		::MoleMole::Config::ScreenEffectFieldHandleType outlineDistortionTexHandleType; // 0x360
		::MoleMole::Config::ScreenEffectFieldHandleType scanStart1HandleType; // 0x364
		::MoleMole::Config::ScreenEffectFieldHandleType lensDistortionYMultiplierHandleType; // 0x368
		::MoleMole::Config::ScreenEffectFieldHandleType outlineDistortionTexTilingHandleType; // 0x36C
		::MoleMole::Config::ScreenEffectFieldHandleType scanTypeHandleType; // 0x370
		::UnityEngine::NAPRenderPipeline0::VREffects_NativeSRP_ColorBlendMethod scanColor0Mode; // 0x374
		::System::Single outlineNormalThresholdScale; // 0x378
		::System::Boolean enable; // 0x37C
		::System::Boolean outlineBlendScanLine; // 0x37D
		::System::Boolean gridBlendScanLine; // 0x37E
		::System::Boolean textureSheetOn; // 0x37F
		::MoleMole::Config::ScreenEffectFieldHandleType scanColor3ModeHandleType; // 0x380
		::MoleMole::Config::ScreenEffectFieldHandleType customScanDirectionHandleType; // 0x384
		::MoleMole::Config::ScreenEffectFieldHandleType fadeSourceImageHandleType; // 0x388
		::MoleMole::Config::ScreenEffectFieldHandleType scanStart1SoftHandleType; // 0x38C
		::MoleMole::Config::ScreenEffectFieldHandleType distanceDistortionHeightFadeRangeHandleType; // 0x390
		::MoleMole::Config::ScreenEffectFieldHandleType reverseHandleType; // 0x394
		::MoleMole::Config::ScreenEffectFieldHandleType scanStart3HandleType; // 0x398
		::MoleMole::Config::ScreenEffectFieldHandleType textureSheetIndexHandleType; // 0x39C
		::MoleMole::Config::ScreenEffectFieldHandleType scanStart0HandleType; // 0x3A0
		::MoleMole::Config::ScreenEffectFieldHandleType useCustomScanDirectionHandleType; // 0x3A4
		::MoleMole::Config::ScreenEffectFieldHandleType outlineColorHandleType; // 0x3A8
		::MoleMole::Config::ScreenEffectFieldHandleType scanlineWidthHandleType; // 0x3AC
		::UnityEngine::Vector2 textureSheetXY; // 0x3B0
		::UnityEngine::NAPRenderPipeline0::VREffects_NativeSRP_ColorBlendMethod sliceColorAMode; // 0x3B8
		::MoleMole::Config::ScreenEffectFieldHandleType colorTintEndHandleType; // 0x3BC
		::System::Single scanlineWidth; // 0x3C0
		::MoleMole::Config::ScreenEffectFieldHandleType outlineOnHandleType; // 0x3C4
		::MoleMole::Config::ScreenEffectFieldHandleType brightnessHandleType; // 0x3C8
		::MoleMole::Config::ScreenEffectFieldHandleType scanMaskTypeHandleType; // 0x3CC
		::MoleMole::Config::ScreenEffectFieldHandleType distanceDistortionColorHandleType; // 0x3D0
		::MoleMole::Config::ScreenEffectFieldHandleType sliceColorBHandleType; // 0x3D4
		::MoleMole::Config::ScreenEffectFieldHandleType screenSpaceGridScaleHandleType; // 0x3D8
		::MoleMole::Config::ScreenEffectFieldHandleType outlineDepthThresholdHandleType; // 0x3DC
		::MoleMole::Config::ScreenEffectFieldHandleType scanMaskIntensity3HandleType; // 0x3E0
		::MoleMole::Config::ScreenEffectFieldHandleType outlineDiffOffsetHandleType; // 0x3E4
		::MoleMole::Config::ScreenEffectFieldHandleType scanColor2ModeHandleType; // 0x3E8
		::UnityEngine::NAPRenderPipeline0::VREffects_NativeSRP_ColorBlendMethod scanColor3Mode; // 0x3EC
		::MoleMole::Config::ScreenEffectFieldHandleType scanStart2HandleType; // 0x3F0
		::MoleMole::Config::ScreenEffectFieldHandleType sliceColorAHandleType; // 0x3F4
		::System::Single scanEnd0Soft; // 0x3F8
		::MoleMole::Config::ScreenEffectFieldHandleType distanceDistortionBlendModeHandleType; // 0x3FC
		::MoleMole::Config::ScreenEffectFieldHandleType distanceDistortionFadeRangeHandleType; // 0x400
		::MoleMole::Config::ScreenEffectFieldHandleType distanceDistortionHeightEndHandleType; // 0x404
		::MoleMole::Config::ScreenEffectFieldHandleType lensDistortionIntensityHandleType; // 0x408
		::MoleMole::Config::ScreenEffectFieldHandleType scanMaskIntensity1HandleType; // 0x40C
		::MoleMole::Config::ScreenEffectFieldHandleType scanMaskTexUVSpeedHandleType; // 0x410
		::MoleMole::Config::ScreenEffectFieldHandleType scanEnd0HandleType; // 0x414
		::MoleMole::Config::ScreenEffectFieldHandleType outlineOpacityHandleType; // 0x418
		::MoleMole::Config::ScreenEffectFieldHandleType scanStart3SoftHandleType; // 0x41C
		::MoleMole::Config::ScreenEffectFieldHandleType uvOffsetRHandleType; // 0x420
		::MoleMole::Config::ScreenEffectFieldHandleType textureSheetColorHandleType; // 0x424
		::MoleMole::Config::ScreenEffectFieldHandleType distanceDistortionIntensityHandleType; // 0x428
		::MoleMole::Config::ScreenEffectFieldHandleType textureSheetXYHandleType; // 0x42C
		::System::Single scanEnd1Soft; // 0x430
		::MoleMole::Config::ScreenEffectFieldHandleType groundYPosHandleType; // 0x434
		::MoleMole::Config::ScreenEffectFieldHandleType outlineDistortionHandleType; // 0x438
		::MoleMole::Config::ScreenEffectFieldHandleType lensDistortionXMultiplierHandleType; // 0x43C
		::MoleMole::Config::ScreenEffectFieldHandleType saturationHandleType; // 0x440
		::System::Single scanEnd2Soft; // 0x444
		::MoleMole::Config::ScreenEffectFieldHandleType hueHandleType; // 0x448
		::System::Single gridDistance; // 0x44C
		::MoleMole::Config::ScreenEffectFieldHandleType distanceDistortionStartHandleType; // 0x450
		::System::Single outlineDepthThreshold; // 0x454
		::MoleMole::Config::ScreenEffectFieldHandleType distanceColorizationEffectHandleType; // 0x458
		::MoleMole::Config::ScreenEffectFieldHandleType distanceColorizeTextureHandleType; // 0x45C
		::MoleMole::Config::ScreenEffectFieldHandleType outlineBlendScanLineHandleType; // 0x460
		::UnityEngine::Rendering::Universal::ScanType scanType; // 0x464
		::MoleMole::Config::ScreenEffectFieldHandleType uvOffsetGHandleType; // 0x468
		::MoleMole::Config::ScreenEffectFieldHandleType scanEnd2SoftHandleType; // 0x46C
		::MoleMole::Config::ScreenEffectFieldHandleType outlineNormalThresholdScaleHandleType; // 0x470
		::MoleMole::Config::ScreenEffectFieldHandleType scanEnd1SoftHandleType; // 0x474
		::UnityEngine::NAPRenderPipeline0::VREffects_NativeSRP_ColorBlendMethod sliceColorBMode; // 0x478
		::MoleMole::Config::ScreenEffectFieldHandleType gridBlendScanLineHandleType; // 0x47C
		::MoleMole::Config::ScreenEffectFieldHandleType sliceAngleHandleType; // 0x480
		::MoleMole::Config::ScreenEffectFieldHandleType colorTintFarHandleType; // 0x484
		::MoleMole::Config::ScreenEffectFieldHandleType scanColor0HandleType; // 0x488
		::MoleMole::Config::ScreenEffectFieldHandleType scanEnd0SoftHandleType; // 0x48C
		::UnityEngine::Rendering::Universal::ChannelMapping scanMaskTexChannel; // 0x490
		::UnityEngine::NAPRenderPipeline0::VREffects_NativeSRP_ColorBlendMethod scanColor2Mode; // 0x494
		::MoleMole::Config::ScreenEffectFieldHandleType scanMaskTexChannelHandleType; // 0x498
		::MoleMole::Config::ScreenEffectFieldHandleType outlineDistortionUVSpeedHandleType; // 0x49C
		::MoleMole::Config::ScreenEffectFieldHandleType scanlineDistortionHandleType; // 0x4A0
		::MoleMole::Config::ScreenEffectFieldHandleType keepInFrontForUberPostHandleType; // 0x4A4
		::System::Single scanStart3Soft; // 0x4A8
		::MoleMole::Config::ScreenEffectFieldHandleType textureSheetOnHandleType; // 0x4AC
		::MoleMole::Config::ScreenEffectFieldHandleType distanceColorizationOffsetSpeedHandleType; // 0x4B0
		::MoleMole::Config::ScreenEffectFieldHandleType outlineDistortionIntensityHandleType; // 0x4B4
		::System::Single gridPower; // 0x4B8
		::MoleMole::Config::ScreenEffectFieldHandleType scanColor3EndHandleType; // 0x4BC
		::UnityEngine::Rendering::Universal::ScanMaskType scanMaskType; // 0x4C0
		::MoleMole::Config::ScreenEffectFieldHandleType outlineInUberShaderHandleType; // 0x4C4
		::MoleMole::Config::ScreenEffectFieldHandleType colorTintNearHandleType; // 0x4C8
		::MoleMole::Config::ScreenEffectFieldHandleType scanColor1HandleType; // 0x4CC
		::MoleMole::Config::ScreenEffectFieldHandleType sliceColorAModeHandleType; // 0x4D0
		::MoleMole::Config::ScreenEffectFieldHandleType scanMaskIntensity0HandleType; // 0x4D4
		::MoleMole::Config::ScreenEffectFieldHandleType outlineDistortionOffsetHandleType; // 0x4D8
		::MoleMole::Config::ScreenEffectFieldHandleType scanMaskTexTilingHandleType; // 0x4DC
		::MoleMole::Config::ScreenEffectFieldHandleType colorRHandleType; // 0x4E0
		::MoleMole::Config::ScreenEffectFieldHandleType outlineNormalThresholdHandleType; // 0x4E4
		::MoleMole::Config::ScreenEffectFieldHandleType screenSpaceGridWidthHandleType; // 0x4E8
		::MoleMole::Config::ScreenEffectFieldHandleType textureSheetTexHandleType; // 0x4EC
		::MoleMole::Config::ScreenEffectFieldHandleType lensDistortionScaleHandleType; // 0x4F0
		::System::Single scanEnd3Soft; // 0x4F4
		::MoleMole::Config::ScreenEffectFieldHandleType scanMaskIntensity2HandleType; // 0x4F8
		::MoleMole::Config::ScreenEffectFieldHandleType gridColorHandleType; // 0x4FC
		::MoleMole::Config::ScreenEffectFieldHandleType contrastMiddlePointHandleType; // 0x500
		::MoleMole::Config::ScreenEffectFieldHandleType scanStart2SoftHandleType; // 0x504
		::MoleMole::Config::ScreenEffectFieldHandleType scanColor1EndHandleType; // 0x508
		::MoleMole::Config::ScreenEffectFieldHandleType scanMaskBaseYHandleType; // 0x50C
		::UnityEngine::NAPRenderPipeline0::VREffects_NativeSRP_ColorBlendMethod scanColor1Mode; // 0x510
		::MoleMole::Config::ScreenEffectFieldHandleType scanMaskTexOffsetHandleType; // 0x514
		::MoleMole::Config::ScreenEffectFieldHandleType colorTintStartHandleType; // 0x518
		::MoleMole::Config::ScreenEffectFieldHandleType distanceDistortionTextureHandleType; // 0x51C
		::MoleMole::Config::ScreenEffectFieldHandleType distanceColorizationTilingHandleType; // 0x520
		::MoleMole::Config::ScreenEffectFieldHandleType scanEnd1HandleType; // 0x524
		::MoleMole::Config::ScreenEffectFieldHandleType scanColor2EndHandleType; // 0x528
		::System::Single scanStart0Soft; // 0x52C
		::UnityEngine::Rendering::Universal::DistanceDistortionBlendMode distanceDistortionBlendMode; // 0x530
		::System::Single outlineNormalThreshold; // 0x534
		::MoleMole::Config::ScreenEffectFieldHandleType scanMaskYRangeHandleType; // 0x538
		::MoleMole::Config::ScreenEffectFieldHandleType distanceDistortionTilingHandleType; // 0x53C
		::MoleMole::Config::ScreenEffectFieldHandleType scanEnd3SoftHandleType; // 0x540
		::MoleMole::Config::ScreenEffectFieldHandleType scanEnd3HandleType; // 0x544
		::MoleMole::Config::ScreenEffectFieldHandleType gridOnHandleType; // 0x548
		::MoleMole::Config::ScreenEffectFieldHandleType distanceDistortionOffsetSpeedHandleType; // 0x54C
		::MoleMole::Config::ScreenEffectFieldHandleType scanEnd2HandleType; // 0x550
		::MoleMole::Config::ScreenEffectFieldHandleType scanlineContrastHandleType; // 0x554
		::System::Single scanStart1Soft; // 0x558
		::MoleMole::Config::ScreenEffectFieldHandleType lensDistortionCenterHandleType; // 0x55C
		::MoleMole::Config::ScreenEffectFieldHandleType gridDistanceHandleType; // 0x560
		::MoleMole::Config::ScreenEffectFieldHandleType scanColor0EndHandleType; // 0x564
		::MoleMole::Config::ScreenEffectFieldHandleType colorBHandleType; // 0x568
		::MoleMole::Config::ScreenEffectFieldHandleType scanColor3HandleType; // 0x56C
		::MoleMole::Config::ScreenEffectFieldHandleType enableDistanceDistortionColorizationHandleType; // 0x570
		::MoleMole::Config::ScreenEffectFieldHandleType contrastHandleType; // 0x574
		::MoleMole::Config::ScreenEffectFieldHandleType outlineDistortionTexOffsetHandleType; // 0x578
		::MoleMole::Config::ScreenEffectFieldHandleType sliceColorBModeHandleType; // 0x57C
		::System::Single outlineDiffOffset; // 0x580
		::MoleMole::Config::ScreenEffectFieldHandleType scanMaskTexHandleType; // 0x584
		::System::Single scanStart2Soft; // 0x588
		::MoleMole::Config::ScreenEffectFieldHandleType sliceWidthHandleType; // 0x58C
		::MoleMole::Config::ScreenEffectFieldHandleType colorGHandleType; // 0x590
		::MoleMole::Config::ScreenEffectFieldHandleType scanColor0ModeHandleType; // 0x594
		::MoleMole::Config::ScreenEffectFieldHandleType sliceOffsetHandleType; // 0x598
		::MoleMole::Config::ScreenEffectFieldHandleType uvOffsetBHandleType; // 0x59C
		::MoleMole::Config::ScreenEffectFieldHandleType scanColor1ModeHandleType; // 0x5A0
		::MoleMole::Config::ScreenEffectFieldHandleType distanceDistortionEndHandleType; // 0x5A4
		::MoleMole::Config::ScreenEffectFieldHandleType scanColor2HandleType; // 0x5A8
