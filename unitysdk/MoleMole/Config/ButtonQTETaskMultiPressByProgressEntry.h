...
#define MOLEMOLE_CONFIG_BUTTONQTETASKMULTIPRESSBYPROGRESSENTRY_CREATEREALTIMEQTETASK_OFFSET UNITYSDK_OFFSET(0x1398F130)
#define MOLEMOLE_CONFIG_BUTTONQTETASKMULTIPRESSBYPROGRESSENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1398F2B0)
#define MOLEMOLE_CONFIG_BUTTONQTETASKMULTIPRESSBYPROGRESSENTRY___BASE_CREATEREALTIMEQTETASK_OFFSET UNITYSDK_OFFSET(0x1398F330)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ButtonQTETaskMultiPressByProgressEntry_TypeDefinitionIndex = 46761;
