...
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOW_GET_DURATION_OFFSET UNITYSDK_OFFSET(0xB916630)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOW_METHOD_2_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0xB9166C0)
#define MOLEMOLE_CONFIG_CONFIGENTITYTIMESLOW__CTOR_OFFSET UNITYSDK_OFFSET(0xB9166A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityTimeSlow_TypeDefinitionIndex = 77001;
