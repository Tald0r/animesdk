...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVECAMERASHAKE___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0xE2C58C0)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVECAMERASHAKE___C__DISPLAYCLASS1_0__RUN_B__0_OFFSET UNITYSDK_OFFSET(0xE2C58D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_BigTVMoveCameraShake___c__DisplayClass1_0_TypeDefinitionIndex = 79849;
