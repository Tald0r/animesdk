...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVECAMERASHAKE___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x15EB3E10)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_BIGTVMOVECAMERASHAKE___C__DISPLAYCLASS1_0__RUN_B__0_OFFSET UNITYSDK_OFFSET(0x15EB3E20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_BigTVMoveCameraShake___c__DisplayClass1_0_TypeDefinitionIndex = 59119;
