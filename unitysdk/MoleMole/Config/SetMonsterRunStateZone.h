...
#define MOLEMOLE_CONFIG_SETMONSTERRUNSTATEZONE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xCB03EA0)
#define MOLEMOLE_CONFIG_SETMONSTERRUNSTATEZONE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xCB03F90)
#define MOLEMOLE_CONFIG_SETMONSTERRUNSTATEZONE__CTOR_OFFSET UNITYSDK_OFFSET(0xCB04080)
#define MOLEMOLE_CONFIG_SETMONSTERRUNSTATEZONE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xCB04090)
#define MOLEMOLE_CONFIG_SETMONSTERRUNSTATEZONE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xCB04120)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SetMonsterRunStateZone_TypeDefinitionIndex = 59926;
