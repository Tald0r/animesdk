...
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITDATA_SPECIALHITEFFECTMAPITEM_MATCHANIMATORSTATE_OFFSET UNITYSDK_OFFSET(0x141929A0)
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITDATA_SPECIALHITEFFECTMAPITEM_MATCH_OFFSET UNITYSDK_OFFSET(0x141928A0)
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITDATA_SPECIALHITEFFECTMAPITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x14192A10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSpecialEffectHitData_SpecialHitEffectMapItem_TypeDefinitionIndex = 67495;
	...
	public:
		...
		::MoleMole::Config::AnimatorGroundHitType specialHitGroundHitType; // 0x14
		::MoleMole::Config::AnimatorGroundHitType attackFrameGroundHitType; // 0x18
		::MoleMole::Config::AnimatorAirHitType specialHitAirHitType; // 0x1C
		::MoleMole::Config::AnimatorHitEffect attackFrameHitEffect; // 0x20
		::MoleMole::Config::AnimatorHitEffect specialHitEffect; // 0x24
