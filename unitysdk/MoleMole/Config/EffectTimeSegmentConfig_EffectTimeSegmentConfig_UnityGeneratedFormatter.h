...
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCAF97B0)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCAF97C0)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCAF9DD0)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCAFA1B0)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCAFA170)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EffectTimeSegmentConfig_EffectTimeSegmentConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 42277;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(EffectTimeSegmentConfig_EffectTimeSegmentConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x45D30);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Boolean>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(EffectTimeSegmentConfig_EffectTimeSegmentConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x45D38);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Int32>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(EffectTimeSegmentConfig_EffectTimeSegmentConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x45D40);
		}
