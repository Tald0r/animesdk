...
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xEC3D900)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xEC3D910)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xEC3DF20)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xEC3E300)
#define MOLEMOLE_CONFIG_EFFECTTIMESEGMENTCONFIG_EFFECTTIMESEGMENTCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xEC3E2C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EffectTimeSegmentConfig_EffectTimeSegmentConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 65533;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(EffectTimeSegmentConfig_EffectTimeSegmentConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43350);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Single>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(EffectTimeSegmentConfig_EffectTimeSegmentConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43358);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Boolean>** StaticGet_CachedSerializer2()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(EffectTimeSegmentConfig_EffectTimeSegmentConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43360);
		}
