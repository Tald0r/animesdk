...
#define MOLEMOLE_CONFIG_CONFIGRESETOVERRIDEBUBBLESETTINGNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xBAFEC50)
#define MOLEMOLE_CONFIG_CONFIGRESETOVERRIDEBUBBLESETTINGNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xBAFED30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigResetOverrideBubbleSettingNode_TypeDefinitionIndex = 70801;
