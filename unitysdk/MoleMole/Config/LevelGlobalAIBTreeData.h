...
#define MOLEMOLE_CONFIG_LEVELGLOBALAIBTREEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBB042A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelGlobalAIBTreeData_TypeDefinitionIndex = 72299;
