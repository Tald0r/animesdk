...
#define MOLEMOLE_CONFIG_LEVELGLOBALAIBTREEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x14196B90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelGlobalAIBTreeData_TypeDefinitionIndex = 64632;
