...
#define MOLEMOLE_CONFIG_HITGROUNDWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0xCDBEC90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HitGroundWrap_TypeDefinitionIndex = 61971;
