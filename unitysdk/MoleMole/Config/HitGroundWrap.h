...
#define MOLEMOLE_CONFIG_HITGROUNDWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0xD0A3CE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HitGroundWrap_TypeDefinitionIndex = 60619;
