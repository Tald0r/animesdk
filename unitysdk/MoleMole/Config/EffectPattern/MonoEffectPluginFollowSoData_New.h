...
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xE825770)
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xE8259F0)
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW__CTOR_OFFSET UNITYSDK_OFFSET(0xE825CD0)

namespace MoleMole::Config::EffectPattern
{
	inline static constexpr unsigned int MonoEffectPluginFollowSoData_New_TypeDefinitionIndex = 76251;
