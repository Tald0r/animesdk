...
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_VALUEDICTWRAPPER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9512160)
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_VALUEDICTWRAPPER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x95123F0)
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_VALUEDICTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x95126F0)

namespace MoleMole::Config::EffectPattern
{
	inline static constexpr unsigned int MonoEffectPluginFollowSoData_New_ValueDictWrapper_TypeDefinitionIndex = 76645;
