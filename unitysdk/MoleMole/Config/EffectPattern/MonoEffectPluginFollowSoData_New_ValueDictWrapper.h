...
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_VALUEDICTWRAPPER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xE43AE60)
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_VALUEDICTWRAPPER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xE43B0F0)
#define MOLEMOLE_CONFIG_EFFECTPATTERN_MONOEFFECTPLUGINFOLLOWSODATA_NEW_VALUEDICTWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0xE43B3F0)

namespace MoleMole::Config::EffectPattern
{
	inline static constexpr unsigned int MonoEffectPluginFollowSoData_New_ValueDictWrapper_TypeDefinitionIndex = 76252;
