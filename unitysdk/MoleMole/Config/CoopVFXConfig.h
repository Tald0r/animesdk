...
#define MOLEMOLE_CONFIG_COOPVFXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x950FD90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CoopVFXConfig_TypeDefinitionIndex = 66446;
