...
#define MOLEMOLE_CONFIG_COOPVFXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE438910)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CoopVFXConfig_TypeDefinitionIndex = 45715;
