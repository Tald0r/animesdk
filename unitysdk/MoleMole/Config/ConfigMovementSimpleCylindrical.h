...
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL_CLONE_OFFSET UNITYSDK_OFFSET(0xF2D3E80)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xF2D3DF0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xF2D4A50)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL_FROMFLX_OFFSET UNITYSDK_OFFSET(0xF2D4090)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xF2D3F60)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF2D4AB0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xF2D4110)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF2D4F50)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xF2D48F0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL_PROCESSRIGIDBODY_OFFSET UNITYSDK_OFFSET(0xF2D3CC0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0xF2D3A80)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL__CTOR_OFFSET UNITYSDK_OFFSET(0xF2D5100)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLECYLINDRICAL___BASE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0xF2D5110)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMovementSimpleCylindrical_TypeDefinitionIndex = 68605;
	...
	public:
		...
		::System::Boolean KeepCoordOnStart; // 0x4C
		::System::Boolean KeepRelativePosition; // 0x4D
