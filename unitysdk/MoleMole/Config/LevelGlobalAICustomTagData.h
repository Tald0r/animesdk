...
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA_GET_CUSTOMKEYLIST_OFFSET UNITYSDK_OFFSET(0xD7C6970)
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA_READDATA_OFFSET UNITYSDK_OFFSET(0xD7C6910)
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA_VALIDATECUSTOMKEYLIST_OFFSET UNITYSDK_OFFSET(0xD7C6A20)
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD7C6CE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelGlobalAICustomTagData_TypeDefinitionIndex = 43562;
