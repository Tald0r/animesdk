...
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA_GET_CUSTOMKEYLIST_OFFSET UNITYSDK_OFFSET(0xE440D90)
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA_READDATA_OFFSET UNITYSDK_OFFSET(0xE440D30)
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA_VALIDATECUSTOMKEYLIST_OFFSET UNITYSDK_OFFSET(0xE440E40)
#define MOLEMOLE_CONFIG_LEVELGLOBALAICUSTOMTAGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xE441100)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LevelGlobalAICustomTagData_TypeDefinitionIndex = 50545;
