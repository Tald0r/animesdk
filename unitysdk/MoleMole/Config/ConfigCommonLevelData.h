...
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xC343A50)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0xC3437D0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_0F9C98D2F5805479_OFFSET UNITYSDK_OFFSET(0xC343E80)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_42E1B0366D8D72CF_OFFSET UNITYSDK_OFFSET(0xC343AB0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_5B0202969299569F_OFFSET UNITYSDK_OFFSET(0xC343850)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_5E08F2F6642B0101_OFFSET UNITYSDK_OFFSET(0xC343C40)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_5EBDB8BDCDAABB87_OFFSET UNITYSDK_OFFSET(0xC343CF0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_84DB1A1A4D6A2661_OFFSET UNITYSDK_OFFSET(0xC343FD0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_B525722F60E6B94F_OFFSET UNITYSDK_OFFSET(0xC3436A0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_B73F62522113F21F_OFFSET UNITYSDK_OFFSET(0xC343550)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA_METHOD_1_C9158580CC3C5ACF_OFFSET UNITYSDK_OFFSET(0xC3435A0)
#define MOLEMOLE_CONFIG_CONFIGCOMMONLEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xC343CE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCommonLevelData_TypeDefinitionIndex = 54862;
