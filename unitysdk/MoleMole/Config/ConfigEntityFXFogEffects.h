...
#define MOLEMOLE_CONFIG_CONFIGENTITYFXFOGEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0xBAFABA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntityFXFogEffects_TypeDefinitionIndex = 71368;
