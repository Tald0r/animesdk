...
#define MOLEMOLE_CONFIG_CONFIGLEVELENDTIMESLOWBYAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0xB473090)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelEndTimeSlowByAvatar_TypeDefinitionIndex = 57138;
