...
#define MOLEMOLE_CONFIG_CONFIGLEVELENDTIMESLOWBYAVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x9B62F60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelEndTimeSlowByAvatar_TypeDefinitionIndex = 54239;
