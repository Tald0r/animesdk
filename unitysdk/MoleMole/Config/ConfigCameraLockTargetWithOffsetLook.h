...
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETWITHOFFSETLOOK_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x94FAD60)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETWITHOFFSETLOOK_FROMFLX_OFFSET UNITYSDK_OFFSET(0x94F9F00)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETWITHOFFSETLOOK_METHOD_2_0578713EDB32B89E_OFFSET UNITYSDK_OFFSET(0x94F9F80)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETWITHOFFSETLOOK_METHOD_2_A00BA7031F286AAF_OFFSET UNITYSDK_OFFSET(0x94FADC0)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETWITHOFFSETLOOK__CTOR_OFFSET UNITYSDK_OFFSET(0x94FB240)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraLockTargetWithOffsetLook_TypeDefinitionIndex = 44036;
