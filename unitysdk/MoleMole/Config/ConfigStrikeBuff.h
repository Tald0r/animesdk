...
#define MOLEMOLE_CONFIG_CONFIGSTRIKEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x6250AD0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigStrikeBuff_TypeDefinitionIndex = 41380;
