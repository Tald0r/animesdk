...
#define MOLEMOLE_CONFIG_CONFIGSTRIKEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xC23E490)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigStrikeBuff_TypeDefinitionIndex = 58841;
