...
#define MOLEMOLE_CONFIG_VESEQUENCEINFO_GETALLVEKEY_OFFSET UNITYSDK_OFFSET(0xE82AE20)
#define MOLEMOLE_CONFIG_VESEQUENCEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xE82AEC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int VESequenceInfo_TypeDefinitionIndex = 38502;
