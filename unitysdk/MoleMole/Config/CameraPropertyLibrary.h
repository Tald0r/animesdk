...
#define MOLEMOLE_CONFIG_CAMERAPROPERTYLIBRARY__CTOR_OFFSET UNITYSDK_OFFSET(0x9181790)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraPropertyLibrary_TypeDefinitionIndex = 48883;
