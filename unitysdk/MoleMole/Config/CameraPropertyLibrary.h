...
#define MOLEMOLE_CONFIG_CAMERAPROPERTYLIBRARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1398F390)

namespace MoleMole::Config
{
	inline static constexpr unsigned int CameraPropertyLibrary_TypeDefinitionIndex = 67503;
