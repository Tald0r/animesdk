...
#define MOLEMOLE_CONFIG_CONFIGENTITYSKILLS__CTOR_OFFSET UNITYSDK_OFFSET(0xB916590)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigEntitySkills_TypeDefinitionIndex = 75498;
