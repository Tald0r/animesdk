...
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0xCB000F0)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION_CHECKVALUECONTENT_OFFSET UNITYSDK_OFFSET(0xCB00200)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0xCAFFDF0)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION_GET_DEFAULTDROP_OFFSET UNITYSDK_OFFSET(0xCAFFEA0)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION_GET_DEFAULTINTERACTANIMATION_OFFSET UNITYSDK_OFFSET(0xCAFFF60)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION_GET_DEFAULTINTERACTCHANGEMODEL_OFFSET UNITYSDK_OFFSET(0xCB00020)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION_GET_ISSUPPORTREPEAT_OFFSET UNITYSDK_OFFSET(0xCB000E0)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION_SET_DEFAULTDROP_OFFSET UNITYSDK_OFFSET(0xCAFFF50)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION_SET_DEFAULTINTERACTANIMATION_OFFSET UNITYSDK_OFFSET(0xCB00010)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION_SET_DEFAULTINTERACTCHANGEMODEL_OFFSET UNITYSDK_OFFSET(0xCB000D0)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0xCB002E0)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION___BASE_CHECKACTIONCONTENT_OFFSET UNITYSDK_OFFSET(0xCB002F0)
#define MOLEMOLE_CONFIG_INTERACTENTITYMODE_COLLECTION___BASE_CHECKVALUECONTENT_OFFSET UNITYSDK_OFFSET(0xCB00350)

namespace MoleMole::Config
{
	inline static constexpr unsigned int InteractEntityMode_Collection_TypeDefinitionIndex = 43849;
	...
	public:
		...
		::Il2CppArray<::System::String*>* dropItems; // 0x20
		::Il2CppArray<::MoleMole::AniamtorParamsSetting*>* InteractAnimations; // 0x28
		::Il2CppArray<::System::String*>* CollectedChangeModel; // 0x30
		::System::Single CD; // 0x38
		::System::Int32 MaxInteractCount; // 0x3C
		::System::Int32 overridePickType; // 0x40
