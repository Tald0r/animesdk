...
#define MOLEMOLE_CONFIG_CONFIGUISCRIPTABLEANIMATIONV2__CTOR_OFFSET UNITYSDK_OFFSET(0xE4383A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIScriptableAnimationV2_TypeDefinitionIndex = 60519;
