...
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE_CLONE_OFFSET UNITYSDK_OFFSET(0xCC99090)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xCC99040)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xCC99910)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE_FROMFLX_OFFSET UNITYSDK_OFFSET(0xCC992A0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xCC99170)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xCC99970)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xCC99320)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xCC99BA0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xCC997B0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE_PROCESSRIGIDBODY_OFFSET UNITYSDK_OFFSET(0xCC987B0)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0xCC98C00)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC98770)
#define MOLEMOLE_CONFIG_CONFIGMOVEMENTSIMPLE___BASE_SETUPLOGICMOVEMENT_OFFSET UNITYSDK_OFFSET(0xCC99D50)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMovementSimple_TypeDefinitionIndex = 65728;

	class ConfigMovementSimple : public ::MoleMole::Config::ConfigMovement
	{
	public:
		::UnityEngine::Vector3 Acceleration; // 0x38
		::UnityEngine::Vector3 InitVelocity; // 0x44
