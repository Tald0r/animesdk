...
#define MOLEMOLE_CONFIG_CONFIGSTOPSEQUENCEVENODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xCC9C210)
#define MOLEMOLE_CONFIG_CONFIGSTOPSEQUENCEVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xCC9C2F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigStopSequenceVENode_TypeDefinitionIndex = 48640;
