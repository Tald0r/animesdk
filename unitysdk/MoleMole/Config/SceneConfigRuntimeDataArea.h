...
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x4154A0)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x415410)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_METHOD_2_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x415590)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_METHOD_2_507A61720F3CF5FF_OFFSET UNITYSDK_OFFSET(0x415550)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_METHOD_2_674524A234498963_OFFSET UNITYSDK_OFFSET(0x415560)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_METHOD_2_C1DAD850E2998E73_OFFSET UNITYSDK_OFFSET(0x415500)
#define MOLEMOLE_CONFIG_SCENECONFIGRUNTIMEDATAAREA_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x415520)

namespace MoleMole::Config
{
	inline static constexpr unsigned int SceneConfigRuntimeDataArea_TypeDefinitionIndex = 78667;
