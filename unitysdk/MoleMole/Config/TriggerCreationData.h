...
#define MOLEMOLE_CONFIG_TRIGGERCREATIONDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x6DFB170)
#define MOLEMOLE_CONFIG_TRIGGERCREATIONDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0x6DFA840)
#define MOLEMOLE_CONFIG_TRIGGERCREATIONDATA_METHOD_1_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x6DFA8C0)
#define MOLEMOLE_CONFIG_TRIGGERCREATIONDATA_METHOD_1_814709AC4932320E_OFFSET UNITYSDK_OFFSET(0x6DFB1D0)
#define MOLEMOLE_CONFIG_TRIGGERCREATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6DFB600)

namespace MoleMole::Config
{
	inline static constexpr unsigned int TriggerCreationData_TypeDefinitionIndex = 77376;
