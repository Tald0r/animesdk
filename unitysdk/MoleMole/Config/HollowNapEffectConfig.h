...
#define MOLEMOLE_CONFIG_HOLLOWNAPEFFECTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xD0A41D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HollowNapEffectConfig_TypeDefinitionIndex = 80927;
