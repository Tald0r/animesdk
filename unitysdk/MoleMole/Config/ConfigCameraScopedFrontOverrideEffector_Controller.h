...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xC22F260)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER_RESET_OFFSET UNITYSDK_OFFSET(0xC22F300)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC22F3D0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xC22F3E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_CONTROLLER___BASE_RESET_OFFSET UNITYSDK_OFFSET(0xC22F450)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_Controller_TypeDefinitionIndex = 50455;
