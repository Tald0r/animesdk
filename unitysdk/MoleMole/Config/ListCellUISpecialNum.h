...
#define MOLEMOLE_CONFIG_LISTCELLUISPECIALNUM_GETVALUE_OFFSET UNITYSDK_OFFSET(0xE0C1BC0)
#define MOLEMOLE_CONFIG_LISTCELLUISPECIALNUM__CTOR_OFFSET UNITYSDK_OFFSET(0xE0C1B60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ListCellUISpecialNum_TypeDefinitionIndex = 52374;
