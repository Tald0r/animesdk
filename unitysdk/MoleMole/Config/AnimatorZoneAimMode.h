...
#define MOLEMOLE_CONFIG_ANIMATORZONEAIMMODE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xBAE06D0)
#define MOLEMOLE_CONFIG_ANIMATORZONEAIMMODE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xBAE0900)
#define MOLEMOLE_CONFIG_ANIMATORZONEAIMMODE__CTOR_OFFSET UNITYSDK_OFFSET(0xBAE0B40)
#define MOLEMOLE_CONFIG_ANIMATORZONEAIMMODE___BASE_ONZONEENTER_OFFSET UNITYSDK_OFFSET(0xBAE0B50)
#define MOLEMOLE_CONFIG_ANIMATORZONEAIMMODE___BASE_ONZONEEXIT_OFFSET UNITYSDK_OFFSET(0xBAE0BE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneAimMode_TypeDefinitionIndex = 41437;
