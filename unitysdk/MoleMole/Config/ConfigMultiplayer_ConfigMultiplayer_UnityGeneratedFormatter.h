...
#define MOLEMOLE_CONFIG_CONFIGMULTIPLAYER_CONFIGMULTIPLAYER_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1399D100)
#define MOLEMOLE_CONFIG_CONFIGMULTIPLAYER_CONFIGMULTIPLAYER_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1399D110)
#define MOLEMOLE_CONFIG_CONFIGMULTIPLAYER_CONFIGMULTIPLAYER_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1399D540)
#define MOLEMOLE_CONFIG_CONFIGMULTIPLAYER_CONFIGMULTIPLAYER_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1399D810)
#define MOLEMOLE_CONFIG_CONFIGMULTIPLAYER_CONFIGMULTIPLAYER_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1399D7D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMultiplayer_ConfigMultiplayer_UnityGeneratedFormatter_TypeDefinitionIndex = 53478;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::ConfigMultiplayer_GameplayTagSetting*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigMultiplayer_ConfigMultiplayer_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3A2C0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigMultiplayer_ConfigMultiplayer_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3A2C8);
		}
