...
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_CLONE_OFFSET UNITYSDK_OFFSET(0xC240EF0)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_FOREACHREFTYPEMEMBER_OFFSET UNITYSDK_OFFSET(0xC240EE0)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xC241290)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_FROMFLX_OFFSET UNITYSDK_OFFSET(0xC241100)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_GETHASHNUM_OFFSET UNITYSDK_OFFSET(0xC240FD0)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xC2412A0)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xC241160)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_PARSEFROMBINARY_OFFSET UNITYSDK_OFFSET(0xC2412B0)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL_PARSEFROMFLX_OFFSET UNITYSDK_OFFSET(0xC241170)
#define MOLEMOLE_CONFIG_HITDOWNSTATECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0xC241410)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HitDownStateControl_TypeDefinitionIndex = 73722;
