...
#define MOLEMOLE_CONFIG_CONFIGMISC_INTERACTROTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x6554740)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMisc_InteractRotate_TypeDefinitionIndex = 37974;
