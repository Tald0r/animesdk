...
#define MOLEMOLE_CONFIG_ANIMATOREVENTSENDBEHAVIORTREEEVENTENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0xCCEDA60)
#define MOLEMOLE_CONFIG_ANIMATOREVENTSENDBEHAVIORTREEEVENTENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0xCCEDB00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventSendBehaviorTreeEventEntry_TypeDefinitionIndex = 57479;
