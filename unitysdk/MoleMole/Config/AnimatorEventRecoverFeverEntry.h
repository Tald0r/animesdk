...
#define MOLEMOLE_CONFIG_ANIMATOREVENTRECOVERFEVERENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x9B51A50)
#define MOLEMOLE_CONFIG_ANIMATOREVENTRECOVERFEVERENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x9B51AF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventRecoverFeverEntry_TypeDefinitionIndex = 47272;
