...
#define MOLEMOLE_CONFIG_RENDERMATERIAL_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xF175900)
#define MOLEMOLE_CONFIG_RENDERMATERIAL_FROMFLX_OFFSET UNITYSDK_OFFSET(0xF175D00)
#define MOLEMOLE_CONFIG_RENDERMATERIAL_INTERNALFROMBINARY_OFFSET UNITYSDK_OFFSET(0xF175960)
#define MOLEMOLE_CONFIG_RENDERMATERIAL_INTERNALFROMFLX_OFFSET UNITYSDK_OFFSET(0xF175D80)
#define MOLEMOLE_CONFIG_RENDERMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0xF176280)

namespace MoleMole::Config
{
	inline static constexpr unsigned int RenderMaterial_TypeDefinitionIndex = 66740;
