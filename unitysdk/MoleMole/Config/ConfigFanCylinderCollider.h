...
#define MOLEMOLE_CONFIG_CONFIGFANCYLINDERCOLLIDER_ALLOCATE_OFFSET UNITYSDK_OFFSET(0xEC41330)
#define MOLEMOLE_CONFIG_CONFIGFANCYLINDERCOLLIDER_CLEAN_OFFSET UNITYSDK_OFFSET(0xEC41540)
#define MOLEMOLE_CONFIG_CONFIGFANCYLINDERCOLLIDER_DEALLOCATE_OFFSET UNITYSDK_OFFSET(0xEC413E0)
#define MOLEMOLE_CONFIG_CONFIGFANCYLINDERCOLLIDER_GETCOLLIDERTYPE_OFFSET UNITYSDK_OFFSET(0xEC415D0)
#define MOLEMOLE_CONFIG_CONFIGFANCYLINDERCOLLIDER_GETLAYERMASK_OFFSET UNITYSDK_OFFSET(0xEC416D0)
#define MOLEMOLE_CONFIG_CONFIGFANCYLINDERCOLLIDER_GETPREFABNAME_OFFSET UNITYSDK_OFFSET(0xEC41630)
#define MOLEMOLE_CONFIG_CONFIGFANCYLINDERCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0xEC41780)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigFanCylinderCollider_TypeDefinitionIndex = 44875;

	class ConfigFanCylinderCollider : public ::MoleMole::Config::ConfigTimeDrivenAttackCollider
	{
	public:
		::System::Int32 vertexNum; // 0x28
		::System::Single InvalidAngle; // 0x2C
		::System::Int32 angle; // 0x30
		::System::Int32 numberOfRays; // 0x34
