...
#define MOLEMOLE_CONFIG_LANGUAGEFONTSIZEADAPTIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x139A5F90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int LanguageFontSizeAdaptive_TypeDefinitionIndex = 37569;
