...
#define MOLEMOLE_CONFIG_CONFIGPLAYBGSEQUENCEVENODE_GETALLVEKEY_OFFSET UNITYSDK_OFFSET(0xC349210)
#define MOLEMOLE_CONFIG_CONFIGPLAYBGSEQUENCEVENODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xC349170)
#define MOLEMOLE_CONFIG_CONFIGPLAYBGSEQUENCEVENODE__CTOR_OFFSET UNITYSDK_OFFSET(0xC3492B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayBGSequenceVENode_TypeDefinitionIndex = 43700;

	class ConfigPlayBGSequenceVENode : public ::MoleMole::Config::ConfigUIBaseActionNode
	{
	public:
		::UnityEngine::AnimationCurve* AlphaCurve; // 0x18
		::System::String* ChangeVEEffectPath; // 0x20
		::System::String* SwitchStartEffectPath; // 0x28
		::System::Collections::Generic::List_1<::System::String*>* VEPool; // 0x30
		::System::String* SwitchEndEffectPath; // 0x38
