...
#define MOLEMOLE_CONFIG_HITWALLCAMERASHAKECONFIG_HITWALLCAMERASHAKECONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xEC40B10)
#define MOLEMOLE_CONFIG_HITWALLCAMERASHAKECONFIG_HITWALLCAMERASHAKECONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xEC40B20)
#define MOLEMOLE_CONFIG_HITWALLCAMERASHAKECONFIG_HITWALLCAMERASHAKECONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xEC40D20)
#define MOLEMOLE_CONFIG_HITWALLCAMERASHAKECONFIG_HITWALLCAMERASHAKECONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xEC40EE0)
#define MOLEMOLE_CONFIG_HITWALLCAMERASHAKECONFIG_HITWALLCAMERASHAKECONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xEC40EA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int HitWallCameraShakeConfig_HitWallCameraShakeConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 48452;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(HitWallCameraShakeConfig_HitWallCameraShakeConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x433D0);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Single>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(HitWallCameraShakeConfig_HitWallCameraShakeConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x433D8);
		}
