...
#define MOLEMOLE_CONFIG_CONFIGCAMERASTRETCHS__CTOR_OFFSET UNITYSDK_OFFSET(0xE357640)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraStretchs_TypeDefinitionIndex = 72446;
