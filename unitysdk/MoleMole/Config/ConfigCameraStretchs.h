...
#define MOLEMOLE_CONFIG_CONFIGCAMERASTRETCHS__CTOR_OFFSET UNITYSDK_OFFSET(0xCD00080)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraStretchs_TypeDefinitionIndex = 74976;
