...
#define MOLEMOLE_CONFIG_CONFIGSOUNDSETTING_CONFIGSOUNDSETTING_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCDBB290)
#define MOLEMOLE_CONFIG_CONFIGSOUNDSETTING_CONFIGSOUNDSETTING_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCDBB2A0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDSETTING_CONFIGSOUNDSETTING_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCDBB620)
#define MOLEMOLE_CONFIG_CONFIGSOUNDSETTING_CONFIGSOUNDSETTING_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCDBB890)
#define MOLEMOLE_CONFIG_CONFIGSOUNDSETTING_CONFIGSOUNDSETTING_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCDBB850)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundSetting_ConfigSoundSetting_UnityGeneratedFormatter_TypeDefinitionIndex = 75368;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::System::ValueTuple_2<::System::String*, ::System::Int32>>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundSetting_ConfigSoundSetting_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3EAC8);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundSetting_ConfigSoundSetting_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3EAD0);
		}
