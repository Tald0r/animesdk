...
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYCONFIGIDFILTER_COMPAREBUDDY_OFFSET UNITYSDK_OFFSET(0xE2D0570)
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYCONFIGIDFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0xE2D03E0)
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYCONFIGIDFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0xE2D06F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTargetBuddyConfigIdFilter_TypeDefinitionIndex = 76495;
