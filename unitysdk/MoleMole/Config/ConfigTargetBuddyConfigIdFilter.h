...
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYCONFIGIDFILTER_COMPAREBUDDY_OFFSET UNITYSDK_OFFSET(0x15EBE980)
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYCONFIGIDFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x15EBE7F0)
#define MOLEMOLE_CONFIG_CONFIGTARGETBUDDYCONFIGIDFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x15EBEB00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTargetBuddyConfigIdFilter_TypeDefinitionIndex = 76921;
