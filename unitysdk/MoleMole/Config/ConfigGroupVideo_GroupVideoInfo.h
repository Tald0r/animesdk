...
#define MOLEMOLE_CONFIG_CONFIGGROUPVIDEO_GROUPVIDEOINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xCC978C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigGroupVideo_GroupVideoInfo_TypeDefinitionIndex = 61653;
