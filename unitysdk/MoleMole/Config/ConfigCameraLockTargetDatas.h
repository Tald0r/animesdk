...
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xCC8C210)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xCC8BE40)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS__CTOR_OFFSET UNITYSDK_OFFSET(0xCC8C600)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xCC8C7E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xCC8C7F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraLockTargetDatas_TypeDefinitionIndex = 46030;
