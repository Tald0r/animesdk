...
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xACBA110)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xACB9D40)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS__CTOR_OFFSET UNITYSDK_OFFSET(0xACBA500)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xACBA6E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGETDATAS___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xACBA6F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraLockTargetDatas_TypeDefinitionIndex = 53522;
