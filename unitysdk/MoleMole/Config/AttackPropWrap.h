...
#define MOLEMOLE_CONFIG_ATTACKPROPWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0xCCF9850)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AttackPropWrap_TypeDefinitionIndex = 67522;

	class AttackPropWrap : public ::System::Object
	{
	public:
		::MoleMole::Config::DynamicInt* BackupFrameHalt; // 0x10
		::MoleMole::Config::DynamicInt* AttackerFrameHalt; // 0x18
		...
		::System::Collections::Generic::List_1<::MoleMole::Config::AttackTimeSlowConfig*>* timeSlowList; // 0x48
		::MoleMole::Config::DynamicInt* BackupGroundHitHeavyFrameHalt; // 0x50
