...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_ONGOING_EXECUTE_OFFSET UNITYSDK_OFFSET(0xE36C970)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_ONGOING_ISMATCH_OFFSET UNITYSDK_OFFSET(0xE36CC70)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_ONGOING_WALK_OFFSET UNITYSDK_OFFSET(0xE36CD50)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_ONGOING__CTOR_OFFSET UNITYSDK_OFFSET(0xE36CE90)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_ONGOING___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0xE36CEA0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_ONGOING___BASE_WALK_OFFSET UNITYSDK_OFFSET(0xE36CEB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_Ongoing_TypeDefinitionIndex = 41540;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_148*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTION_ONGOING_EXECUTE_OFFSET))(this, context);
		}
