...
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_CONFIGLEVELRESULTPERFORMEFFECT_ONSTARTFRAMEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x3F9D90)
#define MOLEMOLE_CONFIG_CONFIGLEVELRESULTPERFORMS_CONFIGLEVELRESULTPERFORMEFFECT_ONSTARTTIMEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x3F9E10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigLevelResultPerforms_ConfigLevelResultPerformEffect_TypeDefinitionIndex = 46849;
