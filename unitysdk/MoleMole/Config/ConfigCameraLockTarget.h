...
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xC22F010)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGET_FROMFLX_OFFSET UNITYSDK_OFFSET(0xC22EB40)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGET_METHOD_2_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0xC22EBC0)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGET_METHOD_2_591F73C1C45E9D80_OFFSET UNITYSDK_OFFSET(0xC22F070)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0xC22F250)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraLockTarget_TypeDefinitionIndex = 51089;
	...
	public:
		...
		::Enum_3_8252736F97D4CFA3 LockTargetDirection; // 0x20
