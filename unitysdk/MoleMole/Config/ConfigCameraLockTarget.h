...
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGET_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x6241DA0)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGET_FROMFLX_OFFSET UNITYSDK_OFFSET(0x62418E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGET_METHOD_2_4E5AC15A8307DCD8_OFFSET UNITYSDK_OFFSET(0x6241960)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGET_METHOD_2_591F73C1C45E9D80_OFFSET UNITYSDK_OFFSET(0x6241E00)
#define MOLEMOLE_CONFIG_CONFIGCAMERALOCKTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x6241FE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraLockTarget_TypeDefinitionIndex = 71997;
