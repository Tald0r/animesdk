...
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL__CTOR_OFFSET UNITYSDK_OFFSET(0xCC9C1E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSpecialEffectHitWall_TypeDefinitionIndex = 36676;
