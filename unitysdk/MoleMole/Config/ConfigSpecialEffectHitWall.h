...
#define MOLEMOLE_CONFIG_CONFIGSPECIALEFFECTHITWALL__CTOR_OFFSET UNITYSDK_OFFSET(0xACCAF70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSpecialEffectHitWall_TypeDefinitionIndex = 66763;
