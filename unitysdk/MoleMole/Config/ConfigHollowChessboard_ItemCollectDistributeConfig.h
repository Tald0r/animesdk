...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_ITEMCOLLECTDISTRIBUTECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x94FFD00)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_ItemCollectDistributeConfig_TypeDefinitionIndex = 79853;
