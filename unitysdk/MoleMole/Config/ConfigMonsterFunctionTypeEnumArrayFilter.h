...
#define MOLEMOLE_CONFIG_CONFIGMONSTERFUNCTIONTYPEENUMARRAYFILTER_VALUEPASS_OFFSET UNITYSDK_OFFSET(0x84A9BE0)
#define MOLEMOLE_CONFIG_CONFIGMONSTERFUNCTIONTYPEENUMARRAYFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x84A9E70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMonsterFunctionTypeEnumArrayFilter_TypeDefinitionIndex = 65680;
