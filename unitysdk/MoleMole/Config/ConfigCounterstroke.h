...
#define MOLEMOLE_CONFIG_CONFIGCOUNTERSTROKE__CTOR_OFFSET UNITYSDK_OFFSET(0x14182DC0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCounterstroke_TypeDefinitionIndex = 76815;
