...
#define MOLEMOLE_CONFIG_CONFIGSKINMDB__CTOR_OFFSET UNITYSDK_OFFSET(0x81F0FF0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSkinMdb_TypeDefinitionIndex = 40322;
