...
#define MOLEMOLE_CONFIG_CHESSBOARDTIMELINEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC340860)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ChessboardTimeLineElement_TypeDefinitionIndex = 39096;
