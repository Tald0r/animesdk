...
#define MOLEMOLE_CONFIG_CONFIGANIMATORZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x623FD70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorZone_TypeDefinitionIndex = 53172;
