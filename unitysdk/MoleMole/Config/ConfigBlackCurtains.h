...
#define MOLEMOLE_CONFIG_CONFIGBLACKCURTAINS__CTOR_OFFSET UNITYSDK_OFFSET(0x15EA7B90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigBlackCurtains_TypeDefinitionIndex = 38923;
