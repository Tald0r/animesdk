...
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x62A7300)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY___C__DISPLAYCLASS13_0__ONZONEENTER_B__3_OFFSET UNITYSDK_OFFSET(0x62A7310)
#define MOLEMOLE_CONFIG_ANIMATORZONELOOKIKINMAINCITY___C__DISPLAYCLASS13_0__ONZONEENTER_B__4_OFFSET UNITYSDK_OFFSET(0x62A74F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorZoneLookIKInMainCity___c__DisplayClass13_0_TypeDefinitionIndex = 47354;
