...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHESSBOARD_TVMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xB099870)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChessboard_TvMoveConfig_TypeDefinitionIndex = 79801;
	...
	public:
		...
		::UnityEngine::AnimationCurve* selfMoveCurve; // 0x18
		...
		::System::Single selfMoveDelay; // 0x30
		::System::Single eventModificationDelay; // 0x34
		::System::Single selfMoveDuration; // 0x38
