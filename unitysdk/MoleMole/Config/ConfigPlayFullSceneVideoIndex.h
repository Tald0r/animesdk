...
#define MOLEMOLE_CONFIG_CONFIGPLAYFULLSCENEVIDEOINDEX_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x15EBB000)
#define MOLEMOLE_CONFIG_CONFIGPLAYFULLSCENEVIDEOINDEX__CTOR_OFFSET UNITYSDK_OFFSET(0x15EBB0E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPlayFullSceneVideoIndex_TypeDefinitionIndex = 61961;
