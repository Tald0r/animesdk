...
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xF2C6820)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP_RESET_OFFSET UNITYSDK_OFFSET(0xF2C68C0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP__CTOR_OFFSET UNITYSDK_OFFSET(0xF2C6990)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP___BASE_APPLYOVERRIDECONFIG_OFFSET UNITYSDK_OFFSET(0xF2C69A0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASCOPEDFRONTOVERRIDEEFFECTOR_POSECLIP___BASE_RESET_OFFSET UNITYSDK_OFFSET(0xF2C6A10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraScopedFrontOverrideEffector_PoseClip_TypeDefinitionIndex = 65361;
