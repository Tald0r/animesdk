...
#define MOLEMOLE_CONFIG_CONFIGCAMERACUTSCENES_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x13995DC0)
#define MOLEMOLE_CONFIG_CONFIGCAMERACUTSCENES_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x13995A20)
#define MOLEMOLE_CONFIG_CONFIGCAMERACUTSCENES__CTOR_OFFSET UNITYSDK_OFFSET(0x13996040)
#define MOLEMOLE_CONFIG_CONFIGCAMERACUTSCENES___BASE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x13996150)
#define MOLEMOLE_CONFIG_CONFIGCAMERACUTSCENES___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x13996160)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraCutscenes_TypeDefinitionIndex = 74984;
