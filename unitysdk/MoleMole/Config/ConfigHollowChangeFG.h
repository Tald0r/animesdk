...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGEFG_CUSTOMADDFUNCTION_OFFSET UNITYSDK_OFFSET(0xBAFB600)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGEFG_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xBAFB520)
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCHANGEFG__CTOR_OFFSET UNITYSDK_OFFSET(0xBAFB690)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowChangeFG_TypeDefinitionIndex = 42013;
	...
	public:
		...
		::MoleMole::Vector2Int StartRelativePos; // 0x3C
		::MoleMole::Config::ConfigSetSection_Order ConfigOrder; // 0x44
		::MoleMole::Vector2Int ColRow; // 0x48
		::System::Boolean AutoFadeOut; // 0x50
		::System::Boolean UseSpecific; // 0x51
		::System::Boolean Enable; // 0x52
		::System::Boolean SelectAll; // 0x53
		::System::Single TotalDuration; // 0x54
		::System::Single FadeInDuration; // 0x58
