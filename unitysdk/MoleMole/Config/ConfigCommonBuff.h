...
#define MOLEMOLE_CONFIG_CONFIGCOMMONBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xC343540)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCommonBuff_TypeDefinitionIndex = 69363;
