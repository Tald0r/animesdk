...
#define MOLEMOLE_CONFIG_CONFIGCOMMONBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xEC3CC10)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCommonBuff_TypeDefinitionIndex = 76612;
