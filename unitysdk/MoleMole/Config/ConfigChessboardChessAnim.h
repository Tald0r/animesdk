...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCHESSANIM_CUSTOMADDFUNCTION_OFFSET UNITYSDK_OFFSET(0x804A7C0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCHESSANIM_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x804A6B0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCHESSANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x804A850)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardChessAnim_TypeDefinitionIndex = 39261;
	...
	public:
		...
		::System::Boolean UseCustomPivot; // 0x2C
		::System::Boolean UseSpecific; // 0x2D
