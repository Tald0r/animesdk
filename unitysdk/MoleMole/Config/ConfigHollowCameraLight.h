...
#define MOLEMOLE_CONFIG_CONFIGHOLLOWCAMERALIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x9D07210)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigHollowCameraLight_TypeDefinitionIndex = 65364;

	class ConfigHollowCameraLight : public ::System::Object
	{
	public:
		::System::Single lightRange; // 0x10
		::System::Single lightWidth; // 0x14
		::System::Single lightIntensity; // 0x18
		::System::Single lightDist; // 0x1C
