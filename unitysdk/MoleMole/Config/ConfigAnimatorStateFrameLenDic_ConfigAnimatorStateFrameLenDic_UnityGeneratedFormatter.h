...
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATEFRAMELENDIC_CONFIGANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x62B17C0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATEFRAMELENDIC_CONFIGANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x62B17D0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATEFRAMELENDIC_CONFIGANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x62B1B40)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATEFRAMELENDIC_CONFIGANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x62B1DB0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATEFRAMELENDIC_CONFIGANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x62B1D70)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorStateFrameLenDic_ConfigAnimatorStateFrameLenDic_UnityGeneratedFormatter_TypeDefinitionIndex = 54265;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigAnimatorStateFrameLenDic_ConfigAnimatorStateFrameLenDic_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x432C0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::HashSet_1<::MoleMole::Config::EntityType>*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigAnimatorStateFrameLenDic_ConfigAnimatorStateFrameLenDic_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x432C8);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::HashSet_1<::System::Int32>*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigAnimatorStateFrameLenDic_ConfigAnimatorStateFrameLenDic_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x432D0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::HashSet_1<::System::String*>*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigAnimatorStateFrameLenDic_ConfigAnimatorStateFrameLenDic_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x432D8);
		}
