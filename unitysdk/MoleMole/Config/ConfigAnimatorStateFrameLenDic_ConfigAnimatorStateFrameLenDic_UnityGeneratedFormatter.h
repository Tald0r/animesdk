...
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATEFRAMELENDIC_CONFIGANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCAE2470)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATEFRAMELENDIC_CONFIGANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCAE2480)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATEFRAMELENDIC_CONFIGANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCAE27F0)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATEFRAMELENDIC_CONFIGANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCAE2A60)
#define MOLEMOLE_CONFIG_CONFIGANIMATORSTATEFRAMELENDIC_CONFIGANIMATORSTATEFRAMELENDIC_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCAE2A20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimatorStateFrameLenDic_ConfigAnimatorStateFrameLenDic_UnityGeneratedFormatter_TypeDefinitionIndex = 81025;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Int32>*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigAnimatorStateFrameLenDic_ConfigAnimatorStateFrameLenDic_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x45CA0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::HashSet_1<::System::String*>*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigAnimatorStateFrameLenDic_ConfigAnimatorStateFrameLenDic_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x45CA8);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::HashSet_1<::System::Int32>*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigAnimatorStateFrameLenDic_ConfigAnimatorStateFrameLenDic_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x45CB0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::System::Collections::Generic::HashSet_1<::MoleMole::Config::EntityType>*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigAnimatorStateFrameLenDic_ConfigAnimatorStateFrameLenDic_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x45CB8);
		}
