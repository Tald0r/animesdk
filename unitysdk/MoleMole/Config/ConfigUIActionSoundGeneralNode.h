...
#define MOLEMOLE_CONFIG_CONFIGUIACTIONSOUNDGENERALNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x139A47E0)
#define MOLEMOLE_CONFIG_CONFIGUIACTIONSOUNDGENERALNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x139A4870)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIActionSoundGeneralNode_TypeDefinitionIndex = 72043;
