...
#define MOLEMOLE_CONFIG_CONFIGUIGACHACONFIGCONTAINER_ADDNEWGACHAKEY_OFFSET UNITYSDK_OFFSET(0xEC4D6B0)
#define MOLEMOLE_CONFIG_CONFIGUIGACHACONFIGCONTAINER_ADDROLECONFIG_OFFSET UNITYSDK_OFFSET(0xEC4D8A0)
#define MOLEMOLE_CONFIG_CONFIGUIGACHACONFIGCONTAINER_GETROLECONFIG_OFFSET UNITYSDK_OFFSET(0xEC4DAD0)
#define MOLEMOLE_CONFIG_CONFIGUIGACHACONFIGCONTAINER_GET_GACHAKEYS_OFFSET UNITYSDK_OFFSET(0xEC4D580)
#define MOLEMOLE_CONFIG_CONFIGUIGACHACONFIGCONTAINER_HASGACHAKEY_OFFSET UNITYSDK_OFFSET(0xEC4D5D0)
#define MOLEMOLE_CONFIG_CONFIGUIGACHACONFIGCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0xEC4DC60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIGachaConfigContainer_TypeDefinitionIndex = 74250;
