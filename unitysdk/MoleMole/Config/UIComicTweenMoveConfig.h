...
#define MOLEMOLE_CONFIG_UICOMICTWEENMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9D17920)

namespace MoleMole::Config
{
	inline static constexpr unsigned int UIComicTweenMoveConfig_TypeDefinitionIndex = 65324;
