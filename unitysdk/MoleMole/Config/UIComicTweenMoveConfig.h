...
#define MOLEMOLE_CONFIG_UICOMICTWEENMOVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x80647D0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int UIComicTweenMoveConfig_TypeDefinitionIndex = 76552;
