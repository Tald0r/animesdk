...
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CHECKEMOJIDATACHARACTERDATA_OFFSET UNITYSDK_OFFSET(0xEC3AA60)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CHECKEMOJIDATAEMOJITYPEDATA_OFFSET UNITYSDK_OFFSET(0xEC3ABD0)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CHECKEMOJIDATAEMOJITYPEPATHCOUNT_OFFSET UNITYSDK_OFFSET(0xEC3AEA0)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM__CTOR_OFFSET UNITYSDK_OFFSET(0xEC3B180)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigActivityLiveHouseRhythm_TypeDefinitionIndex = 64048;
