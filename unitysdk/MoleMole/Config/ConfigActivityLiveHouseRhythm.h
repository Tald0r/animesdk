...
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CHECKEMOJIDATACHARACTERDATA_OFFSET UNITYSDK_OFFSET(0xC341370)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CHECKEMOJIDATAEMOJITYPEDATA_OFFSET UNITYSDK_OFFSET(0xC3414E0)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM_CHECKEMOJIDATAEMOJITYPEPATHCOUNT_OFFSET UNITYSDK_OFFSET(0xC3417C0)
#define MOLEMOLE_CONFIG_CONFIGACTIVITYLIVEHOUSERHYTHM__CTOR_OFFSET UNITYSDK_OFFSET(0xC341AB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigActivityLiveHouseRhythm_TypeDefinitionIndex = 77697;
