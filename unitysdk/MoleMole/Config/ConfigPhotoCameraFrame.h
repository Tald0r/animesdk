...
#define MOLEMOLE_CONFIG_CONFIGPHOTOCAMERAFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x8A04640)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigPhotoCameraFrame_TypeDefinitionIndex = 59843;
