...
#define MOLEMOLE_CONFIG_CONFIGWAIT4CONDITION_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x8A0DF80)
#define MOLEMOLE_CONFIG_CONFIGWAIT4CONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x8A0E010)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigWait4Condition_TypeDefinitionIndex = 57691;
