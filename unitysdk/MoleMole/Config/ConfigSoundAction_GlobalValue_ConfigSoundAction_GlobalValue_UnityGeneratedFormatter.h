...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE_CONFIGSOUNDACTION_GLOBALVALUE_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xC1DB140)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE_CONFIGSOUNDACTION_GLOBALVALUE_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xC1DB150)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE_CONFIGSOUNDACTION_GLOBALVALUE_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xC1DB570)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE_CONFIGSOUNDACTION_GLOBALVALUE_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xC1DB830)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_GLOBALVALUE_CONFIGSOUNDACTION_GLOBALVALUE_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xC1DB7F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_GlobalValue_ConfigSoundAction_GlobalValue_UnityGeneratedFormatter_TypeDefinitionIndex = 68258;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_GlobalValue_ConfigSoundAction_GlobalValue_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43E20);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Int32>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_GlobalValue_ConfigSoundAction_GlobalValue_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43E28);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::MoleMole::Config::ConfigSoundAction_GlobalValue_BranchOperation*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigSoundAction_GlobalValue_ConfigSoundAction_GlobalValue_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x43E30);
		}
