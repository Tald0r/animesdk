...
#define MOLEMOLE_CONFIG_REACHIKCONFIG_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x415350)
#define MOLEMOLE_CONFIG_REACHIKCONFIG_FROMFLX_OFFSET UNITYSDK_OFFSET(0x4152C0)
#define MOLEMOLE_CONFIG_REACHIKCONFIG_METHOD_2_A7FD4B676C8A33C1_OFFSET UNITYSDK_OFFSET(0x4153E0)
#define MOLEMOLE_CONFIG_REACHIKCONFIG_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x4153B0)
#define MOLEMOLE_CONFIG_REACHIKCONFIG_METHOD_2_D61A3BD754050C8F_OFFSET UNITYSDK_OFFSET(0x4152B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ReachIKConfig_TypeDefinitionIndex = 73408;
	...
	struct alignas(8) ReachIKConfig
	{
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_144*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_REACHIKCONFIG_METHOD_2_D61A3BD754050C8F_OFFSET))(this, a1);
		}
