...
#define MOLEMOLE_CONFIG_ANIMATOREVENTSHADERCUSTOMENTRY_CREATEANIMATIONEVENT_OFFSET UNITYSDK_OFFSET(0x622BC00)
#define MOLEMOLE_CONFIG_ANIMATOREVENTSHADERCUSTOMENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x622BCA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AnimatorEventShaderCustomEntry_TypeDefinitionIndex = 58607;
