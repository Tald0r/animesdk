...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCHANGEMASKNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x13F8D9B0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDCHANGEMASKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x13F8DA90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardChangeMaskNode_TypeDefinitionIndex = 65126;
