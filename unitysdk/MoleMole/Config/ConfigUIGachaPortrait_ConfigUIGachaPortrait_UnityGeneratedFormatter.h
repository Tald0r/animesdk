...
#define MOLEMOLE_CONFIG_CONFIGUIGACHAPORTRAIT_CONFIGUIGACHAPORTRAIT_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xE437F50)
#define MOLEMOLE_CONFIG_CONFIGUIGACHAPORTRAIT_CONFIGUIGACHAPORTRAIT_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xE437F60)
#define MOLEMOLE_CONFIG_CONFIGUIGACHAPORTRAIT_CONFIGUIGACHAPORTRAIT_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xE438160)
#define MOLEMOLE_CONFIG_CONFIGUIGACHAPORTRAIT_CONFIGUIGACHAPORTRAIT_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xE438320)
#define MOLEMOLE_CONFIG_CONFIGUIGACHAPORTRAIT_CONFIGUIGACHAPORTRAIT_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xE4382E0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUIGachaPortrait_ConfigUIGachaPortrait_UnityGeneratedFormatter_TypeDefinitionIndex = 44733;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::ConfigUIGachaConfigContainer*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigUIGachaPortrait_ConfigUIGachaPortrait_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3D2A0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::Config::ConfigUIPortraitItem*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigUIGachaPortrait_ConfigUIGachaPortrait_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x3D2A8);
		}
