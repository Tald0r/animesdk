...
#define MOLEMOLE_CONFIG_UIANIMATIONCURVECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE82ADA0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int UIAnimationCurveConfig_TypeDefinitionIndex = 57378;
