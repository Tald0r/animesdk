...
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN_EXECUTE_OFFSET UNITYSDK_OFFSET(0xB09DF00)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0xB09DE60)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN_ISMATCH_OFFSET UNITYSDK_OFFSET(0xB09E0E0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN_WALK_OFFSET UNITYSDK_OFFSET(0xB09E180)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN__CTOR_OFFSET UNITYSDK_OFFSET(0xB09E2C0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN___BASE_GET_PARAMHINT_OFFSET UNITYSDK_OFFSET(0xB09E2D0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN___BASE_ISMATCH_OFFSET UNITYSDK_OFFSET(0xB09E2E0)
#define MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN___BASE_WALK_OFFSET UNITYSDK_OFFSET(0xB09E2F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigSoundAction_When_TypeDefinitionIndex = 70713;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_148*))((::PBYTE)hIl2Cpp + MOLEMOLE_CONFIG_CONFIGSOUNDACTION_WHEN_EXECUTE_OFFSET))(this, context);
		}
