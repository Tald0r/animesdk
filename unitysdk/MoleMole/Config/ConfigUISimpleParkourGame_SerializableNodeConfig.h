...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLENODECONFIG_GETNODECOUNT_OFFSET UNITYSDK_OFFSET(0xCDBCED0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLENODECONFIG_GETNODEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0xCDBCF30)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLENODECONFIG_GETTOTALSCORE_OFFSET UNITYSDK_OFFSET(0xCDBCDF0)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLENODECONFIG_TONODECONFIG_OFFSET UNITYSDK_OFFSET(0xCDBCC10)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLENODECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCDBD3C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_SerializableNodeConfig_TypeDefinitionIndex = 57779;
