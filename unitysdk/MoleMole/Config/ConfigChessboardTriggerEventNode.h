...
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDTRIGGEREVENTNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x13F8DBB0)
#define MOLEMOLE_CONFIG_CONFIGCHESSBOARDTRIGGEREVENTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x13F8DC90)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessboardTriggerEventNode_TypeDefinitionIndex = 74930;
