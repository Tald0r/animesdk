...
#define MOLEMOLE_CONFIG_CONFIGCHESSPIECEENTERBATTLEBROADCAST_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x9CFCC50)
#define MOLEMOLE_CONFIG_CONFIGCHESSPIECEENTERBATTLEBROADCAST__CTOR_OFFSET UNITYSDK_OFFSET(0x9CFCD30)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessPieceEnterBattleBroadcast_TypeDefinitionIndex = 39723;
	...
	public:
		...
		::System::Int32 DefaultAudioID; // 0x28
