...
#define MOLEMOLE_CONFIG_CONFIGCHESSPIECEENTERBATTLEBROADCAST_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0x804A210)
#define MOLEMOLE_CONFIG_CONFIGCHESSPIECEENTERBATTLEBROADCAST__CTOR_OFFSET UNITYSDK_OFFSET(0x804A2F0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigChessPieceEnterBattleBroadcast_TypeDefinitionIndex = 50249;
