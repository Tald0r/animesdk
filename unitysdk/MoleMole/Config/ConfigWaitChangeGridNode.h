...
#define MOLEMOLE_CONFIG_CONFIGWAITCHANGEGRIDNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xE8255C0)
#define MOLEMOLE_CONFIG_CONFIGWAITCHANGEGRIDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xE8256A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigWaitChangeGridNode_TypeDefinitionIndex = 64797;
