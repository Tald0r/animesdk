...
#define MOLEMOLE_CONFIG_CONFIGWAITCHANGEGRIDNODE_GETUIANIMATIONNODE_OFFSET UNITYSDK_OFFSET(0xB479D00)
#define MOLEMOLE_CONFIG_CONFIGWAITCHANGEGRIDNODE__CTOR_OFFSET UNITYSDK_OFFSET(0xB479DE0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigWaitChangeGridNode_TypeDefinitionIndex = 54314;
