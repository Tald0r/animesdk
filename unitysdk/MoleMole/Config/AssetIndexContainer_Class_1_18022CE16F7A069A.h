...
#define MOLEMOLE_CONFIG_ASSETINDEXCONTAINER_CLASS_1_18022CE16F7A069A__CTOR_OFFSET UNITYSDK_OFFSET(0x623C880)

namespace MoleMole::Config
{
	inline static constexpr unsigned int AssetIndexContainer_Class_1_18022CE16F7A069A_TypeDefinitionIndex = 40297;

	class AssetIndexContainer_Class_1_18022CE16F7A069A : public ::System::Object
	{
	public:
		::Il2CppArray<::MoleMole::Config::IndexBlockRef*>* Field_1_3; // 0x10
		...
		::MoleMole::Config::AssetIndexContainer_Class_1_18022CE16F7A069A_Class_1_A3D745FFB9FB9E8F* Field_1_5; // 0x30
