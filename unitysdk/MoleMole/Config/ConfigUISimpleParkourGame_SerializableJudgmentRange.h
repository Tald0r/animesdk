...
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTRANGE_TOJUDGMENTRANGE_OFFSET UNITYSDK_OFFSET(0x13F9F710)
#define MOLEMOLE_CONFIG_CONFIGUISIMPLEPARKOURGAME_SERIALIZABLEJUDGMENTRANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x13F9F700)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigUISimpleParkourGame_SerializableJudgmentRange_TypeDefinitionIndex = 57784;
