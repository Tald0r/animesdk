...
#define MOLEMOLE_CONFIG_UIELEMENTCOLORCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xCDC0C20)

namespace MoleMole::Config
{
	inline static constexpr unsigned int UIElementColorConfig_TypeDefinitionIndex = 58606;
