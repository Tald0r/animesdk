...
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIGINTERNAL_1_OFFSET UNITYSDK_OFFSET(0xE3539B0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIGINTERNAL_OFFSET UNITYSDK_OFFSET(0xE3535E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIGKEYS_OFFSET UNITYSDK_OFFSET(0xE353AA0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIG_1_OFFSET UNITYSDK_OFFSET(0xE353540)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIG_OFFSET UNITYSDK_OFFSET(0xE3531D0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETFIXEDCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0xE353310)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETFRAMETWOSHAPECONFIG_OFFSET UNITYSDK_OFFSET(0xE353420)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xE353B20)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS__CTOR_OFFSET UNITYSDK_OFFSET(0xE353D80)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xE354000)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraStoryDatas_TypeDefinitionIndex = 43137;
