...
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIGINTERNAL_1_OFFSET UNITYSDK_OFFSET(0xCCFC3F0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIGINTERNAL_OFFSET UNITYSDK_OFFSET(0xCCFC010)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIGKEYS_OFFSET UNITYSDK_OFFSET(0xCCFC4E0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIG_1_OFFSET UNITYSDK_OFFSET(0xCCFBF70)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETCONFIG_OFFSET UNITYSDK_OFFSET(0xCCFBC00)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETFIXEDCAMERACONFIG_OFFSET UNITYSDK_OFFSET(0xCCFBD40)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_GETFRAMETWOSHAPECONFIG_OFFSET UNITYSDK_OFFSET(0xCCFBE50)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xCCFC560)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS__CTOR_OFFSET UNITYSDK_OFFSET(0xCCFC7C0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS___BASE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xCCFCA40)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraStoryDatas_TypeDefinitionIndex = 56394;
