...
#define MOLEMOLE_CONFIG_CONFIGDEPTHOFFIELDEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x84A5D60)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigDepthOfFieldEffects_TypeDefinitionIndex = 76268;
