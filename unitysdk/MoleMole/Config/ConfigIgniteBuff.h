...
#define MOLEMOLE_CONFIG_CONFIGIGNITEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0xF2CF240)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigIgniteBuff_TypeDefinitionIndex = 72393;
