...
#define MOLEMOLE_CONFIG_CONFIGIGNITEBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x13F956A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigIgniteBuff_TypeDefinitionIndex = 78600;
