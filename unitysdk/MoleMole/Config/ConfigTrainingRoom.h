...
#define MOLEMOLE_CONFIG_CONFIGTRAININGROOM__CTOR_OFFSET UNITYSDK_OFFSET(0xE36E3A0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTrainingRoom_TypeDefinitionIndex = 70069;
