...
#define MOLEMOLE_CONFIG_CONFIGTRAININGROOM__CTOR_OFFSET UNITYSDK_OFFSET(0xCD15900)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigTrainingRoom_TypeDefinitionIndex = 70595;
