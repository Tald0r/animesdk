...
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9705EA0)
#define MOLEMOLE_CONFIG_CONFIGCAMERASTORYDATAS___C__DISPLAYCLASS9_0__GETCONFIGINTERNAL_B__0_OFFSET UNITYSDK_OFFSET(0x9705EB0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigCameraStoryDatas___c__DisplayClass9_0_TypeDefinitionIndex = 56396;
