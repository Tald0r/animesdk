...
#define MOLEMOLE_CONFIG_ETHEREYESINTERACTABLEVARIATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6252950)

namespace MoleMole::Config
{
	inline static constexpr unsigned int EtherEyesInteractableVariationConfig_TypeDefinitionIndex = 36820;

	class EtherEyesInteractableVariationConfig : public ::System::Object
	{
	public:
		::System::Single materialTilingFactor; // 0x10
		::System::Single normalParticleScaleFactor; // 0x14
		::System::Single particleAmountFactor; // 0x18
		::System::Single particleScaleFactor; // 0x1C
