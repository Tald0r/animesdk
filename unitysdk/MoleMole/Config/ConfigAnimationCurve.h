...
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x36B4F0)
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x36B460)
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x36B550)
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_METHOD_2_ADFCC0DC85F98B9C_OFFSET UNITYSDK_OFFSET(0x36B590)
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x36B560)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimationCurve_TypeDefinitionIndex = 49799;
