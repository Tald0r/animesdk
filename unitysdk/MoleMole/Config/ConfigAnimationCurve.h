...
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x707850)
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_FROMFLX_OFFSET UNITYSDK_OFFSET(0x7077C0)
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x7078B0)
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_METHOD_2_ADFCC0DC85F98B9C_OFFSET UNITYSDK_OFFSET(0x7078F0)
#define MOLEMOLE_CONFIG_CONFIGANIMATIONCURVE_METHOD_2_D4DA1493472613E6_OFFSET UNITYSDK_OFFSET(0x7078C0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigAnimationCurve_TypeDefinitionIndex = 58290;
