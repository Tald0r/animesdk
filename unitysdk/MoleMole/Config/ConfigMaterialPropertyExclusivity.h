...
#define MOLEMOLE_CONFIG_CONFIGMATERIALPROPERTYEXCLUSIVITY__CTOR_OFFSET UNITYSDK_OFFSET(0x624F6B0)

namespace MoleMole::Config
{
	inline static constexpr unsigned int ConfigMaterialPropertyExclusivity_TypeDefinitionIndex = 61388;
