...
#define MOLEMOLE_CONFIGUICOOPTEAM3D_CONFIGUICOOPTEAM3D_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x16BBC2E0)
#define MOLEMOLE_CONFIGUICOOPTEAM3D_CONFIGUICOOPTEAM3D_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x16BBC2F0)
#define MOLEMOLE_CONFIGUICOOPTEAM3D_CONFIGUICOOPTEAM3D_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x16BBC4F0)
#define MOLEMOLE_CONFIGUICOOPTEAM3D_CONFIGUICOOPTEAM3D_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16BBC6B0)
#define MOLEMOLE_CONFIGUICOOPTEAM3D_CONFIGUICOOPTEAM3D_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16BBC670)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUICoopTeam3D_ConfigUICoopTeam3D_UnityGeneratedFormatter_TypeDefinitionIndex = 74908;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::ConfigUICoopTeam3D_AvatarConfig*>*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigUICoopTeam3D_ConfigUICoopTeam3D_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x38688);
		}
