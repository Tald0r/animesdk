...
#define MOLEMOLE_UIABYSSS2DETAILROWWIDGETCONTROLLER_ADDSUBROW_OFFSET UNITYSDK_OFFSET(0x7F43C50)
#define MOLEMOLE_UIABYSSS2DETAILROWWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x7F43A20)
#define MOLEMOLE_UIABYSSS2DETAILROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F43D40)
#define MOLEMOLE_UIABYSSS2DETAILROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F43DE0)
#define MOLEMOLE_UIABYSSS2DETAILROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F43860)
#define MOLEMOLE_UIABYSSS2DETAILROWWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F43900)
#define MOLEMOLE_UIABYSSS2DETAILROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x7F43EC0)
#define MOLEMOLE_UIABYSSS2DETAILROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x7F43EF0)
#define MOLEMOLE_UIABYSSS2DETAILROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x7F43F60)
#define MOLEMOLE_UIABYSSS2DETAILROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x7F43FE0)
#define MOLEMOLE_UIABYSSS2DETAILROWWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x7F44040)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2DetailRowWidgetController_TypeDefinitionIndex = 37438;
