...
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xF0C78B0)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xF0C7A30)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_GETGRAPHICPROFILECONTEXTBYKEY_OFFSET UNITYSDK_OFFSET(0xF0C77A0)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xF0C7990)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE_GET_GRAPHICPROFILETYPE_OFFSET UNITYSDK_OFFSET(0xF0C7790)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0xF0C7B90)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE___BASE_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0xF0C7C20)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE___BASE_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0xF0C7C90)
#define MOLEMOLE_VOLUMETRICCLOUDPROFILE___BASE_GETGRAPHICPROFILEPROCESSOR_OFFSET UNITYSDK_OFFSET(0xF0C7D00)

namespace MoleMole
{
	inline static constexpr unsigned int VolumetricCloudProfile_TypeDefinitionIndex = 78957;
