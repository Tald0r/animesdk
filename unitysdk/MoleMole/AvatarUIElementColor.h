...
#define MOLEMOLE_AVATARUIELEMENTCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6531C20)

namespace MoleMole
{
	inline static constexpr unsigned int AvatarUIElementColor_TypeDefinitionIndex = 58525;
