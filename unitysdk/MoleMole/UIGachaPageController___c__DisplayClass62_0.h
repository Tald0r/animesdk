...
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS62_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD059E50)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS62_0__REFRESHSPECIALPANEL_B__2_OFFSET UNITYSDK_OFFSET(0xD059E60)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS62_0__REFRESHSPECIALPANEL_G__SHOULDWEAPONSHOWSP_0_OFFSET UNITYSDK_OFFSET(0xD05A630)
#define MOLEMOLE_UIGACHAPAGECONTROLLER___C__DISPLAYCLASS62_0__REFRESHSPECIALPANEL_G__TRYGETWEAPONGACHADEMOVIDEOPATH_1_OFFSET UNITYSDK_OFFSET(0xD05A410)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPageController___c__DisplayClass62_0_TypeDefinitionIndex = 39388;
	...
	public:
		...
		::Class_2_758D4E94CC1C6B2A* weaponConfig; // 0x20
