...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_BUILDRTWITHCUSTOMWH_OFFSET UNITYSDK_OFFSET(0xADF13D0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_BUILDRT_OFFSET UNITYSDK_OFFSET(0xADF1190)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0xADF1640)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_GET_COMMONLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0xADF0C30)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_GET_SELFLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0xADF0C70)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_GET_UNIT_OFFSET UNITYSDK_OFFSET(0xADF0C10)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_GET_USESELFLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0xADF0C50)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_MODIFYSELFLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0xADF0E60)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_SET_COMMONLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0xADF0C40)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_SET_SELFLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0xADF0C80)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_SET_UNIT_OFFSET UNITYSDK_OFFSET(0xADF0C20)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_SET_USESELFLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0xADF0C60)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_TRIGGEROVERRIDELIGHTSETTING_OFFSET UNITYSDK_OFFSET(0xADF0DE0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xADF0C90)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController_UIRoleInfo_TypeDefinitionIndex = 58899;
	...
	public:
		...
		::System::Boolean isUsingCustomWH; // 0x2C
		::System::Boolean _UseSelfLightSetting_k__BackingField; // 0x2D
