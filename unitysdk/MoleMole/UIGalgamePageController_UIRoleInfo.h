...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_BUILDRTWITHCUSTOMWH_OFFSET UNITYSDK_OFFSET(0x9D85900)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_BUILDRT_OFFSET UNITYSDK_OFFSET(0x9D856C0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_CLEAR_OFFSET UNITYSDK_OFFSET(0x9D85B70)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_GET_COMMONLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0x9D85160)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_GET_SELFLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0x9D851A0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_GET_UNIT_OFFSET UNITYSDK_OFFSET(0x9D85140)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_GET_USESELFLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0x9D85180)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_MODIFYSELFLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0x9D85390)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_SET_COMMONLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0x9D85170)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_SET_SELFLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0x9D851B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_SET_UNIT_OFFSET UNITYSDK_OFFSET(0x9D85150)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_SET_USESELFLIGHTSETTING_OFFSET UNITYSDK_OFFSET(0x9D85190)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO_TRIGGEROVERRIDELIGHTSETTING_OFFSET UNITYSDK_OFFSET(0x9D85310)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER_UIROLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9D851C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController_UIRoleInfo_TypeDefinitionIndex = 54654;

	class UIGalgamePageController_UIRoleInfo : public ::System::Object
	{
	public:
		::MoleMole::UIAvatarLightSetting* _commonLightSetting_k__BackingField; // 0x10
		::MoleMole::UIAvatarLightSetting* _SelfLightSetting_k__BackingField; // 0x18
		::Class_2_C2B4B123B5A9B78A* _unit_k__BackingField; // 0x20
		::System::Boolean isUsingCustomWH; // 0x28
		::System::Boolean _UseSelfLightSetting_k__BackingField; // 0x29
