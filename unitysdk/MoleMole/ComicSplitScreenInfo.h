...
#define MOLEMOLE_COMICSPLITSCREENINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B599CE0)

namespace MoleMole
{
	inline static constexpr unsigned int ComicSplitScreenInfo_TypeDefinitionIndex = 30046;
