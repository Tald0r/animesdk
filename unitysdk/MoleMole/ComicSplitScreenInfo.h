...
#define MOLEMOLE_COMICSPLITSCREENINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF86830)

namespace MoleMole
{
	inline static constexpr unsigned int ComicSplitScreenInfo_TypeDefinitionIndex = 29093;
