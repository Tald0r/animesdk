...
#define MOLEMOLE_SCALEDCONTENTSIZEFITTER_GETSIZEALONGAXIS_OFFSET UNITYSDK_OFFSET(0x7A9F490)
#define MOLEMOLE_SCALEDCONTENTSIZEFITTER_SETSCALEFACTOR_OFFSET UNITYSDK_OFFSET(0x7A9F510)
#define MOLEMOLE_SCALEDCONTENTSIZEFITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x7A9F590)
#define MOLEMOLE_SCALEDCONTENTSIZEFITTER___BASE_GETSIZEALONGAXIS_OFFSET UNITYSDK_OFFSET(0x7A9F5B0)

namespace MoleMole
{
	inline static constexpr unsigned int ScaledContentSizeFitter_TypeDefinitionIndex = 49337;
