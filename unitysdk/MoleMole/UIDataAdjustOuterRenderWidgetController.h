...
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER_BINDGAMEWIDGET_OFFSET UNITYSDK_OFFSET(0xA916660)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA916410)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA9164B0)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA916520)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA915A40)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA915CC0)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER_ONWIN_OFFSET UNITYSDK_OFFSET(0xA916750)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER_RESETVIEW_OFFSET UNITYSDK_OFFSET(0xA915D80)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9168F0)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER__ONUIINIT_B__3_0_OFFSET UNITYSDK_OFFSET(0xA916920)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA916950)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xA9169C0)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA9169D0)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA916A50)
#define MOLEMOLE_UIDATAADJUSTOUTERRENDERWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA916AB0)

namespace MoleMole
{
	inline static constexpr unsigned int UIDataAdjustOuterRenderWidgetController_TypeDefinitionIndex = 65719;

	class UIDataAdjustOuterRenderWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_72E2AB5ACACAD004* _view; // 0x2A0
		::Class_3_5F814DBCD2974AFB_2* _model; // 0x2A8
