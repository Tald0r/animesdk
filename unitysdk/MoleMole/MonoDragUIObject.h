...
namespace MoleMole { class MonoDragUIObject_Class_3_50D343C44D28BEFB_8; }
...
#define MOLEMOLE_MONODRAGUIOBJECT_GET_EXTRADATA_OFFSET UNITYSDK_OFFSET(0xC9DDD10)
#define MOLEMOLE_MONODRAGUIOBJECT_INIT_OFFSET UNITYSDK_OFFSET(0xC9DDDA0)
#define MOLEMOLE_MONODRAGUIOBJECT_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xC9DE430)
#define MOLEMOLE_MONODRAGUIOBJECT_ONDRAG_OFFSET UNITYSDK_OFFSET(0xC9DE9E0)
#define MOLEMOLE_MONODRAGUIOBJECT_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xC9DEB20)
#define MOLEMOLE_MONODRAGUIOBJECT_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0xC9DE960)
#define MOLEMOLE_MONODRAGUIOBJECT_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xC9DE4F0)
#define MOLEMOLE_MONODRAGUIOBJECT_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0xC9DE8F0)
#define MOLEMOLE_MONODRAGUIOBJECT_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xC9DE580)
#define MOLEMOLE_MONODRAGUIOBJECT_REGBEGINDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xC9DDE20)
#define MOLEMOLE_MONODRAGUIOBJECT_REGCLCIKCALLBACK_OFFSET UNITYSDK_OFFSET(0xC9DDF00)
#define MOLEMOLE_MONODRAGUIOBJECT_REGDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xC9DDE90)
#define MOLEMOLE_MONODRAGUIOBJECT_REGENDDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xC9DE260)
#define MOLEMOLE_MONODRAGUIOBJECT_REGLONGPRESSCALLBACK_OFFSET UNITYSDK_OFFSET(0xC9DE020)
#define MOLEMOLE_MONODRAGUIOBJECT_REGONBOUNDBACK_OFFSET UNITYSDK_OFFSET(0xC9DE140)
#define MOLEMOLE_MONODRAGUIOBJECT_REMOVECLCIKCALLBACK_OFFSET UNITYSDK_OFFSET(0xC9DDF70)
#define MOLEMOLE_MONODRAGUIOBJECT_REMOVEENDDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xC9DE2D0)
#define MOLEMOLE_MONODRAGUIOBJECT_REMOVELONGPRESSCALLBACK_OFFSET UNITYSDK_OFFSET(0xC9DE090)
#define MOLEMOLE_MONODRAGUIOBJECT_REMOVEONBOUNDBACK_OFFSET UNITYSDK_OFFSET(0xC9DE1B0)
#define MOLEMOLE_MONODRAGUIOBJECT_RESET_OFFSET UNITYSDK_OFFSET(0xC9DEBE0)
#define MOLEMOLE_MONODRAGUIOBJECT_SETDRAGSTATE_OFFSET UNITYSDK_OFFSET(0xC9DECE0)
#define MOLEMOLE_MONODRAGUIOBJECT_SETLOINGPRESSINTEVAL_OFFSET UNITYSDK_OFFSET(0xC9DDD20)
#define MOLEMOLE_MONODRAGUIOBJECT_UPDATE_OFFSET UNITYSDK_OFFSET(0xC9DE380)
#define MOLEMOLE_MONODRAGUIOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC9DED50)

namespace MoleMole
{
	inline static constexpr unsigned int MonoDragUIObject_TypeDefinitionIndex = 57321;
	...
	public:
		...
		::MoleMole::MonoDragUIObject_Class_3_50D343C44D28BEFB_8* Field_5_3; // 0x30
		::MoleMole::MonoDragUIObject_Class_3_50D343C44D28BEFB_9* Field_5_4; // 0x38
		...
		::System::Void RegClcikCallback(::MoleMole::MonoDragUIObject_Class_3_50D343C44D28BEFB_8* a1)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::MonoDragUIObject_Class_3_50D343C44D28BEFB_8*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONODRAGUIOBJECT_REGCLCIKCALLBACK_OFFSET))(this, a1);
		}

		::System::Void RemoveClcikCallback(::MoleMole::MonoDragUIObject_Class_3_50D343C44D28BEFB_8* a1)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::MonoDragUIObject_Class_3_50D343C44D28BEFB_8*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONODRAGUIOBJECT_REMOVECLCIKCALLBACK_OFFSET))(this, a1);
		}

		::System::Void RegLongPressCallBack(::MoleMole::MonoDragUIObject_Class_3_50D343C44D28BEFB_9* a1)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::MonoDragUIObject_Class_3_50D343C44D28BEFB_9*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONODRAGUIOBJECT_REGLONGPRESSCALLBACK_OFFSET))(this, a1);
		}

		::System::Void RemoveLongPressCallBack(::MoleMole::MonoDragUIObject_Class_3_50D343C44D28BEFB_9* a1)
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::MonoDragUIObject_Class_3_50D343C44D28BEFB_9*))((::PBYTE)hIl2Cpp + MOLEMOLE_MONODRAGUIOBJECT_REMOVELONGPRESSCALLBACK_OFFSET))(this, a1);
		}
