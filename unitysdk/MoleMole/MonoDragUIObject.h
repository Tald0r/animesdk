...
#define MOLEMOLE_MONODRAGUIOBJECT_GET_EXTRADATA_OFFSET UNITYSDK_OFFSET(0xBA235A0)
#define MOLEMOLE_MONODRAGUIOBJECT_INIT_OFFSET UNITYSDK_OFFSET(0xBA23630)
#define MOLEMOLE_MONODRAGUIOBJECT_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xBA23CC0)
#define MOLEMOLE_MONODRAGUIOBJECT_ONDRAG_OFFSET UNITYSDK_OFFSET(0xBA23FD0)
#define MOLEMOLE_MONODRAGUIOBJECT_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xBA24110)
#define MOLEMOLE_MONODRAGUIOBJECT_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0xBA23F50)
#define MOLEMOLE_MONODRAGUIOBJECT_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xBA23D80)
#define MOLEMOLE_MONODRAGUIOBJECT_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0xBA23EE0)
#define MOLEMOLE_MONODRAGUIOBJECT_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xBA23E10)
#define MOLEMOLE_MONODRAGUIOBJECT_REGBEGINDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xBA236B0)
#define MOLEMOLE_MONODRAGUIOBJECT_REGCLCIKCALLBACK_OFFSET UNITYSDK_OFFSET(0xBA23790)
#define MOLEMOLE_MONODRAGUIOBJECT_REGDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xBA23720)
#define MOLEMOLE_MONODRAGUIOBJECT_REGENDDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xBA23AF0)
#define MOLEMOLE_MONODRAGUIOBJECT_REGLONGPRESSCALLBACK_OFFSET UNITYSDK_OFFSET(0xBA238B0)
#define MOLEMOLE_MONODRAGUIOBJECT_REGONBOUNDBACK_OFFSET UNITYSDK_OFFSET(0xBA239D0)
#define MOLEMOLE_MONODRAGUIOBJECT_REMOVECLCIKCALLBACK_OFFSET UNITYSDK_OFFSET(0xBA23800)
#define MOLEMOLE_MONODRAGUIOBJECT_REMOVEENDDRAGCALLBACK_OFFSET UNITYSDK_OFFSET(0xBA23B60)
#define MOLEMOLE_MONODRAGUIOBJECT_REMOVELONGPRESSCALLBACK_OFFSET UNITYSDK_OFFSET(0xBA23920)
#define MOLEMOLE_MONODRAGUIOBJECT_REMOVEONBOUNDBACK_OFFSET UNITYSDK_OFFSET(0xBA23A40)
#define MOLEMOLE_MONODRAGUIOBJECT_RESET_OFFSET UNITYSDK_OFFSET(0xBA241D0)
#define MOLEMOLE_MONODRAGUIOBJECT_SETDRAGSTATE_OFFSET UNITYSDK_OFFSET(0xBA242D0)
#define MOLEMOLE_MONODRAGUIOBJECT_SETLOINGPRESSINTEVAL_OFFSET UNITYSDK_OFFSET(0xBA235B0)
#define MOLEMOLE_MONODRAGUIOBJECT_UPDATE_OFFSET UNITYSDK_OFFSET(0xBA23C10)
#define MOLEMOLE_MONODRAGUIOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xBA24340)

namespace MoleMole
{
	inline static constexpr unsigned int MonoDragUIObject_TypeDefinitionIndex = 67946;
