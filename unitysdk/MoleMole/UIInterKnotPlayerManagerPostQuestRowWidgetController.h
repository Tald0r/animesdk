...
#define MOLEMOLE_UIINTERKNOTPLAYERMANAGERPOSTQUESTROWWIDGETCONTROLLER_BIND_OFFSET UNITYSDK_OFFSET(0xAD908C0)
#define MOLEMOLE_UIINTERKNOTPLAYERMANAGERPOSTQUESTROWWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAD90750)
#define MOLEMOLE_UIINTERKNOTPLAYERMANAGERPOSTQUESTROWWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAD907C0)
#define MOLEMOLE_UIINTERKNOTPLAYERMANAGERPOSTQUESTROWWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAD90990)
#define MOLEMOLE_UIINTERKNOTPLAYERMANAGERPOSTQUESTROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAD90AC0)
#define MOLEMOLE_UIINTERKNOTPLAYERMANAGERPOSTQUESTROWWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xAD90AF0)
#define MOLEMOLE_UIINTERKNOTPLAYERMANAGERPOSTQUESTROWWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xAD90B60)

namespace MoleMole
{
	inline static constexpr unsigned int UIInterKnotPlayerManagerPostQuestRowWidgetController_TypeDefinitionIndex = 56491;
