...
#define MOLEMOLE_UICREATEROLENAMEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS18_0__CLOSEWINDOW_B__0_OFFSET UNITYSDK_OFFSET(0xD109260)
#define MOLEMOLE_UICREATEROLENAMEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS18_0__CLOSEWINDOW_B__1_OFFSET UNITYSDK_OFFSET(0xD109300)
#define MOLEMOLE_UICREATEROLENAMEDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD109250)

namespace MoleMole
{
	inline static constexpr unsigned int UICreateRoleNameDialogPopWindowController___c__DisplayClass18_0_TypeDefinitionIndex = 77816;
	...
	public:
		...
		::MoleMole::UICreateRoleNameDialogContext* context; // 0x20
		::System::String* cacheInput; // 0x28
