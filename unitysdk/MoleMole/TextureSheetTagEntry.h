...
#define MOLEMOLE_TEXTURESHEETTAGENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x8F3E800)

namespace MoleMole
{
	inline static constexpr unsigned int TextureSheetTagEntry_TypeDefinitionIndex = 43759;
