...
#define MOLEMOLE_UICOMICBUBBLEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD045D70)
#define MOLEMOLE_UICOMICBUBBLEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD045E10)
#define MOLEMOLE_UICOMICBUBBLEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD045C20)
#define MOLEMOLE_UICOMICBUBBLEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD045CC0)
#define MOLEMOLE_UICOMICBUBBLEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD045EF0)
#define MOLEMOLE_UICOMICBUBBLEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD045F20)
#define MOLEMOLE_UICOMICBUBBLEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD045F90)
#define MOLEMOLE_UICOMICBUBBLEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD046010)
#define MOLEMOLE_UICOMICBUBBLEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD046070)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicBubbleWidgetController_TypeDefinitionIndex = 72212;

	class UIComicBubbleWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_47* _view; // 0x2A0
