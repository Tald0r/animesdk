...
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x745F600)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___C__DISPLAYCLASS14_0__PLAYEXIT_B__0_OFFSET UNITYSDK_OFFSET(0x745F610)
#define MOLEMOLE_UILEVELRESULTPAGECONTROLLER___C__DISPLAYCLASS14_0__PLAYEXIT_B__1_OFFSET UNITYSDK_OFFSET(0x745F620)

namespace MoleMole
{
	inline static constexpr unsigned int UILevelResultPageController___c__DisplayClass14_0_TypeDefinitionIndex = 76304;
