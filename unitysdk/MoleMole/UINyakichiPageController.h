...
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xA22B4C0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONCLICKDROPDOWN_OFFSET UNITYSDK_OFFSET(0xA22F4D0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONCLICKINFOBTN_OFFSET UNITYSDK_OFFSET(0xA22CC90)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONCLICKSTATEBTN_OFFSET UNITYSDK_OFFSET(0xA22D6A0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA22B5C0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONDROPDOWNCHANGE_OFFSET UNITYSDK_OFFSET(0xA22FFD0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA22FC20)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA22CBA0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xA22F300)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONQUESTCLICK_OFFSET UNITYSDK_OFFSET(0xA22DF80)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA22C9D0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONTABCLICK_OFFSET UNITYSDK_OFFSET(0xA22D980)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONTAKEREWARD_OFFSET UNITYSDK_OFFSET(0xA22CEA0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA22C940)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA22B660)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_PLAYPROGRESSANIM_OFFSET UNITYSDK_OFFSET(0xA22D4C0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_PLAYTAKEREWARDANI_OFFSET UNITYSDK_OFFSET(0xA22F0B0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_SETCURRENTSTOREBYSTOREINDEX_OFFSET UNITYSDK_OFFSET(0xA22C210)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xA22B4D0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_SHOWPROGRESS_OFFSET UNITYSDK_OFFSET(0xA22F120)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_UPDATEGOLDENSTATE_OFFSET UNITYSDK_OFFSET(0xA22DB10)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_UPDATEGROUPUI_OFFSET UNITYSDK_OFFSET(0xA22D3A0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER_UPDATEQUESTUI_OFFSET UNITYSDK_OFFSET(0xA22E170)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA2300F0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA230060)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0xA230100)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA230150)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONGAMEPADMODULETRYOVERRIDENEXTSELECTINDEX_OFFSET UNITYSDK_OFFSET(0xA2301C0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xA230280)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONLAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0xA2302B0)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xA230310)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA230380)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA230390)
#define MOLEMOLE_UINYAKICHIPAGECONTROLLER___BASE_SETUIWINDOWSETTING_OFFSET UNITYSDK_OFFSET(0xA2303A0)

namespace MoleMole
{
	inline static constexpr unsigned int UINyakichiPageController_TypeDefinitionIndex = 42824;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UINyakichiPageController_TypeDefinitionIndex)->GetStaticField(0xF880);
		}
		::Class_2_60638234271CCDB8_40* _view; // 0x308
