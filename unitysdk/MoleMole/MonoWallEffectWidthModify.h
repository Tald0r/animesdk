...
#define MOLEMOLE_MONOWALLEFFECTWIDTHMODIFY_AWAKE_OFFSET UNITYSDK_OFFSET(0xB9A9DC0)
#define MOLEMOLE_MONOWALLEFFECTWIDTHMODIFY_INJECTIONWIDTHSCALE_OFFSET UNITYSDK_OFFSET(0xB9A9820)
#define MOLEMOLE_MONOWALLEFFECTWIDTHMODIFY_MODIFYEFFECTWIDTH_OFFSET UNITYSDK_OFFSET(0xB9A9880)
#define MOLEMOLE_MONOWALLEFFECTWIDTHMODIFY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xB9A9E30)
#define MOLEMOLE_MONOWALLEFFECTWIDTHMODIFY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB9A9D40)
#define MOLEMOLE_MONOWALLEFFECTWIDTHMODIFY__CCTOR_OFFSET UNITYSDK_OFFSET(0xB9AA0E0)
#define MOLEMOLE_MONOWALLEFFECTWIDTHMODIFY__CTOR_OFFSET UNITYSDK_OFFSET(0xB9AA040)

namespace MoleMole
{
	inline static constexpr unsigned int MonoWallEffectWidthModify_TypeDefinitionIndex = 70206;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoWallEffectWidthModify_TypeDefinitionIndex)->GetStaticField(0x10720);
		}
