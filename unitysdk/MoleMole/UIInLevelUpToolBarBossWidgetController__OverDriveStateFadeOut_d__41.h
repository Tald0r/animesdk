...
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER__OVERDRIVESTATEFADEOUT_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x359350)
#define MOLEMOLE_UIINLEVELUPTOOLBARBOSSWIDGETCONTROLLER__OVERDRIVESTATEFADEOUT_D__41_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIInLevelUpToolBarBossWidgetController__OverDriveStateFadeOut_d__41_TypeDefinitionIndex = 71772;
	...
	struct alignas(8) UIInLevelUpToolBarBossWidgetController__OverDriveStateFadeOut_d__41
	{
		...
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::Class_1_1F219549AE9B7C82_Enum_3_05F7423D39739F87> __u__2; // 0x28
