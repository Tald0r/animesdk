...
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9D86490)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9D865A0)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x9D86C20)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9D86820)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_ONSETGLOBALDATA_OFFSET UNITYSDK_OFFSET(0x9D86E30)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D86500)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER_SETGOTICON_OFFSET UNITYSDK_OFFSET(0x9D86A50)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D86F60)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0x9D86F70)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER___BASE_ONITEMSELECT_OFFSET UNITYSDK_OFFSET(0x9D86FE0)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x9D87050)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER___BASE_ONSETGLOBALDATA_OFFSET UNITYSDK_OFFSET(0x9D870D0)
#define MOLEMOLE_UIGENERALCLAIMITEMWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9D87140)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralClaimItemWidgetController_TypeDefinitionIndex = 62396;
