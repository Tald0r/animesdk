...
#define MOLEMOLE_COMMANDLINESCENEGLARE_METHOD_2_B0048AB04EB15F61_OFFSET UNITYSDK_OFFSET(0xC3314A0)
#define MOLEMOLE_COMMANDLINESCENEGLARE_METHOD_2_B1618326A96071B9_OFFSET UNITYSDK_OFFSET(0xC331360)
#define MOLEMOLE_COMMANDLINESCENEGLARE__CTOR_OFFSET UNITYSDK_OFFSET(0xC331460)

namespace MoleMole
{
	inline static constexpr unsigned int CommandLineSceneGlare_TypeDefinitionIndex = 46887;
