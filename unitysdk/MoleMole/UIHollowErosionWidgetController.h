...
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_GET_CURFOCUSCURSEID_OFFSET UNITYSDK_OFFSET(0xD5B3870)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_GET_CURFOCUSED_OFFSET UNITYSDK_OFFSET(0xD5B3650)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD5B3EA0)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_ONSCROLLVIEWSELECTHANDLE_OFFSET UNITYSDK_OFFSET(0xD5B38F0)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD5B3790)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD5B3F40)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD5B27F0)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD5B3C30)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_REFRESHCONFIGDATA_OFFSET UNITYSDK_OFFSET(0xD5B2B60)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_REFRESHPROGRESSTITLETEXT_OFFSET UNITYSDK_OFFSET(0xD5B3D00)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_REFRESHSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0xD5B3DF0)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_REFRESHVIEWONFOCUSCHANGE_OFFSET UNITYSDK_OFFSET(0xD5B2D60)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xD5B2DD0)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_TRYCANCELSELECTONLAYOUTCHANGETOCONSOLE_OFFSET UNITYSDK_OFFSET(0xD5B3B50)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER_TRYSELECTFIRSTITEMEXCEPTCONSOLELAYOUT_OFFSET UNITYSDK_OFFSET(0xD5B3A70)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD5B4020)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD5B40D0)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD5B4140)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD5B41B0)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD5B4230)
#define MOLEMOLE_UIHOLLOWEROSIONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD5B4290)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowErosionWidgetController_TypeDefinitionIndex = 47836;
