...
#define MOLEMOLE_ACTIVITYOVAGOMAINBATTLECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8E931D0)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityOVAGOMainBattleContext_TypeDefinitionIndex = 68654;
