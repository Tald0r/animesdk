...
#define MOLEMOLE_ACTIVITYOVAGOMAINBATTLECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x78E1560)

namespace MoleMole
{
	inline static constexpr unsigned int ActivityOVAGOMainBattleContext_TypeDefinitionIndex = 57728;
