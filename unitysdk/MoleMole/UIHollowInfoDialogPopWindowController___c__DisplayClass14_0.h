...
#define MOLEMOLE_UIHOLLOWINFODIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA197FE0)
#define MOLEMOLE_UIHOLLOWINFODIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__SAVEDUNGEON_B__0_OFFSET UNITYSDK_OFFSET(0xA19ACA0)
#define MOLEMOLE_UIHOLLOWINFODIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS14_0__SAVEDUNGEON_B__1_OFFSET UNITYSDK_OFFSET(0xA19AD70)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowInfoDialogPopWindowController___c__DisplayClass14_0_TypeDefinitionIndex = 73870;
