...
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_GET_ASYNCREADYREQUESTHANDLEDIC_OFFSET UNITYSDK_OFFSET(0x8F9C500)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_GET_PREASYNCREQUESTHANDLEDIC_OFFSET UNITYSDK_OFFSET(0x8F9C4E0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_GET_STATE_OFFSET UNITYSDK_OFFSET(0x8F9C4B0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_GET_TEXTUREREQUESTHANDLEDIC_OFFSET UNITYSDK_OFFSET(0x8F9C4C0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_063ADB01C44981A7_OFFSET UNITYSDK_OFFSET(0x8FA01F0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_14F96CE90F77CBB9_OFFSET UNITYSDK_OFFSET(0x8F9CEF0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_1659BCB6D1A9FC34_OFFSET UNITYSDK_OFFSET(0x8F9EA30)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_1F6790C3F844E7A6_OFFSET UNITYSDK_OFFSET(0x8FA0440)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_22F354CA4365F4FF_OFFSET UNITYSDK_OFFSET(0x8FA06E0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_273BA5221BE3BB68_OFFSET UNITYSDK_OFFSET(0x8F9E4D0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_3D2B77EBCAE390AB_OFFSET UNITYSDK_OFFSET(0x8F9D6B0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_42D74E8C949A6883_OFFSET UNITYSDK_OFFSET(0x8F9FA10)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x8FA0BE0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x8F9F9A0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_4D7DB0CF65D56E84_OFFSET UNITYSDK_OFFSET(0x8F9F820)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_6667C1084D90FE78_OFFSET UNITYSDK_OFFSET(0x8FA0D30)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_7A5EE891DA69F667_OFFSET UNITYSDK_OFFSET(0x8FA0950)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_82D8292DE05D59DD_OFFSET UNITYSDK_OFFSET(0x8F9DD60)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_968BB264969CFE33_OFFSET UNITYSDK_OFFSET(0x8F9D0C0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_A002848F130F70CA_OFFSET UNITYSDK_OFFSET(0x8F9F180)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_A3876DA4C9C97BC3_OFFSET UNITYSDK_OFFSET(0x8F9E850)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_A8F6F688241E6DBC_OFFSET UNITYSDK_OFFSET(0x8F9E3B0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_B8FA2BA3B5C0B3B5_OFFSET UNITYSDK_OFFSET(0x8F9D360)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x8FA0DD0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8FA0B70)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_E922D61320BAF84C_OFFSET UNITYSDK_OFFSET(0x8F9C770)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_METHOD_1_FF88AD7E425B49D4_OFFSET UNITYSDK_OFFSET(0x8FA08D0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_SET_ASYNCREADYREQUESTHANDLEDIC_OFFSET UNITYSDK_OFFSET(0x8F9C510)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_SET_PREASYNCREQUESTHANDLEDIC_OFFSET UNITYSDK_OFFSET(0x8F9C4F0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET_SET_TEXTUREREQUESTHANDLEDIC_OFFSET UNITYSDK_OFFSET(0x8F9C4D0)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET__CCTOR_OFFSET UNITYSDK_OFFSET(0x8F9C730)
#define MOLEMOLE_SCREENPLAYER_TEXTURESHEET__CTOR_OFFSET UNITYSDK_OFFSET(0x8F9C520)

namespace MoleMole
{
	inline static constexpr unsigned int ScreenPlayer_TextureSheet_TypeDefinitionIndex = 76212;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScreenPlayer_TextureSheet_TypeDefinitionIndex)->GetStaticField(0xF920);
		}
		::System::Collections::Generic::List_1<::Class_2_AA9239F66AD90F88_4*>* floats; // 0x10
		::System::Collections::Generic::List_1<::Class_2_AA9239F66AD90F88_5*>* vectors; // 0x18
		::System::Collections::Generic::List_1<::Class_2_AA9239F66AD90F88_7*>* matricies; // 0x20
		::System::Collections::Generic::List_1<::Class_2_AA9239F66AD90F88_3*>* textures; // 0x28
		::System::Collections::Generic::List_1<::Class_2_AA9239F66AD90F88_9*>* constantBuffers; // 0x30
		::System::Collections::Generic::List_1<::Class_2_AA9239F66AD90F88_9*>* computeBuffers; // 0x38
