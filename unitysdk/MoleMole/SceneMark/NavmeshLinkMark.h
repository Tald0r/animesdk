...
#define MOLEMOLE_SCENEMARK_NAVMESHLINKMARK__CTOR_OFFSET UNITYSDK_OFFSET(0xB9AFD20)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int NavmeshLinkMark_TypeDefinitionIndex = 61995;
