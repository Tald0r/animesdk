...
#define MOLEMOLE_SCENEMARK_NAVMESHLINKMARK__CTOR_OFFSET UNITYSDK_OFFSET(0xD81F710)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int NavmeshLinkMark_TypeDefinitionIndex = 65540;
