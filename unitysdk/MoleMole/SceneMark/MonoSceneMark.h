...
#define MOLEMOLE_SCENEMARK_MONOSCENEMARK__CTOR_OFFSET UNITYSDK_OFFSET(0xBD4CBC0)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int MonoSceneMark_TypeDefinitionIndex = 76472;
