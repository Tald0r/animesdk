...
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_ADDNODETOMAP_OFFSET UNITYSDK_OFFSET(0xC7D6FC0)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_BUILDMAP_OFFSET UNITYSDK_OFFSET(0xC7D6C90)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_COLLECTCHILD_OFFSET UNITYSDK_OFFSET(0xC7D74E0)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_COLLECTDATA_1_OFFSET UNITYSDK_OFFSET(0xC7D75A0)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_COLLECTDATA_OFFSET UNITYSDK_OFFSET(0xC7D6B60)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_COLLECTPRUNEDTREE_OFFSET UNITYSDK_OFFSET(0xC7D7370)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_COLLECTTREE_OFFSET UNITYSDK_OFFSET(0xC7D6C20)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_FINDNODEBYFULLNAME_1_OFFSET UNITYSDK_OFFSET(0xC7D7980)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_FINDNODEBYFULLNAME_OFFSET UNITYSDK_OFFSET(0xC7D78B0)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_FINDNODEBYSORTNAME_OFFSET UNITYSDK_OFFSET(0xC7D7A70)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT__CCTOR_OFFSET UNITYSDK_OFFSET(0xC7D7BB0)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT__CTOR_OFFSET UNITYSDK_OFFSET(0xC7D7B90)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int MonoSceneMarkRoot_TypeDefinitionIndex = 75110;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(MonoSceneMarkRoot_TypeDefinitionIndex)->GetStaticField(0x36FC0);
		}
