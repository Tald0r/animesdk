...
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_ADDNODETOMAP_OFFSET UNITYSDK_OFFSET(0x9944310)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_BUILDMAP_OFFSET UNITYSDK_OFFSET(0x9943FE0)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_COLLECTCHILD_OFFSET UNITYSDK_OFFSET(0x9944840)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_COLLECTDATA_1_OFFSET UNITYSDK_OFFSET(0x9944900)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_COLLECTDATA_OFFSET UNITYSDK_OFFSET(0x9943EB0)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_COLLECTPRUNEDTREE_OFFSET UNITYSDK_OFFSET(0x99446C0)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_COLLECTTREE_OFFSET UNITYSDK_OFFSET(0x9943F70)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_FINDNODEBYFULLNAME_1_OFFSET UNITYSDK_OFFSET(0x9944CE0)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_FINDNODEBYFULLNAME_OFFSET UNITYSDK_OFFSET(0x9944C10)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT_FINDNODEBYSORTNAME_OFFSET UNITYSDK_OFFSET(0x9944DD0)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT__CCTOR_OFFSET UNITYSDK_OFFSET(0x9944F10)
#define MOLEMOLE_SCENEMARK_MONOSCENEMARKROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x9944EF0)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int MonoSceneMarkRoot_TypeDefinitionIndex = 74710;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(MonoSceneMarkRoot_TypeDefinitionIndex)->GetStaticField(0x34660);
		}
