...
#define MOLEMOLE_SCENEMARK_DYNAMICOBJECT_MONOPREFABDYNAMICOBJECTLAYER_AWAKE_OFFSET UNITYSDK_OFFSET(0xC7D64C0)
#define MOLEMOLE_SCENEMARK_DYNAMICOBJECT_MONOPREFABDYNAMICOBJECTLAYER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xC7D6840)
#define MOLEMOLE_SCENEMARK_DYNAMICOBJECT_MONOPREFABDYNAMICOBJECTLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xC7D6AD0)

namespace MoleMole::SceneMark::DynamicObject
{
	inline static constexpr unsigned int MonoPrefabDynamicObjectLayer_TypeDefinitionIndex = 71940;
