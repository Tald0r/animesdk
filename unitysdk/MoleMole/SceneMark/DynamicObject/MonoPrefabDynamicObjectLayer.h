...
#define MOLEMOLE_SCENEMARK_DYNAMICOBJECT_MONOPREFABDYNAMICOBJECTLAYER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9943800)
#define MOLEMOLE_SCENEMARK_DYNAMICOBJECT_MONOPREFABDYNAMICOBJECTLAYER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9943B80)
#define MOLEMOLE_SCENEMARK_DYNAMICOBJECT_MONOPREFABDYNAMICOBJECTLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x9943E20)

namespace MoleMole::SceneMark::DynamicObject
{
	inline static constexpr unsigned int MonoPrefabDynamicObjectLayer_TypeDefinitionIndex = 75180;
