...
#define MOLEMOLE_SCENEMARK_SCENEMARKNODE_ADDCHILD_OFFSET UNITYSDK_OFFSET(0x9852F80)
#define MOLEMOLE_SCENEMARK_SCENEMARKNODE_COLLECTALLCHILDRENNAME_1_OFFSET UNITYSDK_OFFSET(0x98535A0)
#define MOLEMOLE_SCENEMARK_SCENEMARKNODE_COLLECTALLCHILDRENNAME_OFFSET UNITYSDK_OFFSET(0x98534E0)
#define MOLEMOLE_SCENEMARK_SCENEMARKNODE_GETMARKDATA_1_OFFSET UNITYSDK_OFFSET(0x9853370)
#define MOLEMOLE_SCENEMARK_SCENEMARKNODE_GETMARKDATA_OFFSET UNITYSDK_OFFSET(0x9853210)
#define MOLEMOLE_SCENEMARK_SCENEMARKNODE_GET_CHILDMAPITERATOR_OFFSET UNITYSDK_OFFSET(0x9852E30)
#define MOLEMOLE_SCENEMARK_SCENEMARKNODE_GET_FORWARD_OFFSET UNITYSDK_OFFSET(0x9853880)
#define MOLEMOLE_SCENEMARK_SCENEMARKNODE_GET_HASCHILDRENDATA_OFFSET UNITYSDK_OFFSET(0x9852DB0)
#define MOLEMOLE_SCENEMARK_SCENEMARKNODE_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x9853830)
#define MOLEMOLE_SCENEMARK_SCENEMARKNODE_GET_XZPOSITION_OFFSET UNITYSDK_OFFSET(0x9853760)
#define MOLEMOLE_SCENEMARK_SCENEMARKNODE_TRYGETCHILD_OFFSET UNITYSDK_OFFSET(0x98530D0)
#define MOLEMOLE_SCENEMARK_SCENEMARKNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x9852F40)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int SceneMarkNode_TypeDefinitionIndex = 47688;

	class SceneMarkNode : public ::System::Object
	{
	public:
		::UnityEngine::Transform* transform; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::SceneMark::SceneMarkNode*>* ChildrenMap; // 0x18
		::System::String* ParentName; // 0x20
		::Il2CppArray<::MoleMole::SceneMark::SceneMarkDataBase*>* MarkData; // 0x28
