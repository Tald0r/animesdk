...
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_COPYFROMMONO_1_OFFSET UNITYSDK_OFFSET(0x8F9B200)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_COPYFROMMONO_OFFSET UNITYSDK_OFFSET(0x8F9B0F0)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_GETOBJECTTAG_OFFSET UNITYSDK_OFFSET(0x8F9B300)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x8F9B380)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_RESETACTIVE_OFFSET UNITYSDK_OFFSET(0x8F9B460)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x8F9B3E0)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8F9B1F0)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x8F9B0E0)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int SerializeableDynamicObject_TypeDefinitionIndex = 36553;
