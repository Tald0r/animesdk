...
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_COPYFROMMONO_1_OFFSET UNITYSDK_OFFSET(0xC3275A0)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_COPYFROMMONO_OFFSET UNITYSDK_OFFSET(0xC327490)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_GETOBJECTTAG_OFFSET UNITYSDK_OFFSET(0xC3276A0)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_GETOBJECT_OFFSET UNITYSDK_OFFSET(0xC327720)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_RESETACTIVE_OFFSET UNITYSDK_OFFSET(0xC327800)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT_SETACTIVE_OFFSET UNITYSDK_OFFSET(0xC327780)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xC327590)
#define MOLEMOLE_SCENEMARK_SERIALIZEABLEDYNAMICOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xC327480)

namespace MoleMole::SceneMark
{
	inline static constexpr unsigned int SerializeableDynamicObject_TypeDefinitionIndex = 62368;
