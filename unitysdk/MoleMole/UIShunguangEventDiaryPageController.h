...
class Class_2_551D837CC9787B3E;
namespace MoleMole { class UIControlReference; }
namespace MoleMole { class UIControllerContextBase; }

#define MOLEMOLE_UISHUNGUANGEVENTDIARYPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0xBEAD280)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYPAGECONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBEAD290)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYPAGECONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBEAD300)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYPAGECONTROLLER_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBEAD5B0)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBEAD4E0)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBEAD400)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBEAD6D0)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYPAGECONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xBEAD6E0)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYPAGECONTROLLER___BASE_ONINPUTACTION_OFFSET UNITYSDK_OFFSET(0xBEAD750)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBEAD780)
#define MOLEMOLE_UISHUNGUANGEVENTDIARYPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBEAD790)

namespace MoleMole
{
	inline static constexpr unsigned int UIShunguangEventDiaryPageController_TypeDefinitionIndex = 72465;
	...
	public:
		...
		::Class_2_551D837CC9787B3E* get__viewModel()
		{
			return ((::Class_2_551D837CC9787B3E*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISHUNGUANGEVENTDIARYPAGECONTROLLER_GET__VIEWMODEL_OFFSET))(this);
		}
