...
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BINDEVENT_BUTTON_OFFSET UNITYSDK_OFFSET(0x9F03990)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BINDEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x9F041F0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BINDEVENT_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x9F03F10)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BINDEVENT_TABBUTTONGROUP_OFFSET UNITYSDK_OFFSET(0x9F03BC0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BUILDPARTNERDATA_OFFSET UNITYSDK_OFFSET(0x9F06950)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x9F03850)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_INITPARTNERCAMPDATA_OFFSET UNITYSDK_OFFSET(0x9F04BE0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_INITPARTNERDATA_OFFSET UNITYSDK_OFFSET(0x9F066B0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_INITWIDGET_OFFSET UNITYSDK_OFFSET(0x9F042A0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9F03860)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x9F05B20)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x9F05C70)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONSELECTCAMPTYPE_OFFSET UNITYSDK_OFFSET(0x9F06080)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9F05DC0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9F05A90)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9F03900)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9F04360)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONWORKBENCHDATAUPDATE_OFFSET UNITYSDK_OFFSET(0x9F06F20)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_SELECTEDCAMP_OFFSET UNITYSDK_OFFSET(0x9F062A0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_SELECTEDTRUSTDEGREEITEM_OFFSET UNITYSDK_OFFSET(0x9F06CA0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_TRYREADLASTPARTNERPOPUPS_OFFSET UNITYSDK_OFFSET(0x9F06DA0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__BINDEVENT_BUTTON_B__11_0_OFFSET UNITYSDK_OFFSET(0x9F070F0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9F06F90)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__ONUIOPEN_G__GETCAMPINDEX_6_1_OFFSET UNITYSDK_OFFSET(0x9F05720)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__ONUIOPEN_G__GETCAMPTYPEINDEX_6_0_OFFSET UNITYSDK_OFFSET(0x9F05630)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__ONUIOPEN_G__GETPARTNERINDEX_6_2_OFFSET UNITYSDK_OFFSET(0x9F058F0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9F071F0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x9F07260)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x9F072D0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x9F07340)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9F07350)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x9F07360)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9F07370)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchTrustDegreePageController_TypeDefinitionIndex = 80392;
