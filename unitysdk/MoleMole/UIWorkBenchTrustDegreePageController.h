...
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BINDEVENT_BUTTON_OFFSET UNITYSDK_OFFSET(0x65B96C0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BINDEVENT_NOTIFY_OFFSET UNITYSDK_OFFSET(0x65B9F00)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BINDEVENT_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x65B9C30)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BINDEVENT_TABBUTTONGROUP_OFFSET UNITYSDK_OFFSET(0x65B98E0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_BUILDPARTNERDATA_OFFSET UNITYSDK_OFFSET(0x65BC680)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_GET_WINDOWTYPE_OFFSET UNITYSDK_OFFSET(0x65B9580)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_INITPARTNERCAMPDATA_OFFSET UNITYSDK_OFFSET(0x65BA8F0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_INITPARTNERDATA_OFFSET UNITYSDK_OFFSET(0x65BC3E0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_INITWIDGET_OFFSET UNITYSDK_OFFSET(0x65B9FB0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x65B9590)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x65BB840)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x65BB990)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONSELECTCAMPTYPE_OFFSET UNITYSDK_OFFSET(0x65BBDA0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x65BBAE0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x65BB7B0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x65B9630)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x65BA070)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_ONWORKBENCHDATAUPDATE_OFFSET UNITYSDK_OFFSET(0x65BCC50)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_SELECTEDCAMP_OFFSET UNITYSDK_OFFSET(0x65BBFC0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_SELECTEDTRUSTDEGREEITEM_OFFSET UNITYSDK_OFFSET(0x65BC9D0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER_TRYREADLASTPARTNERPOPUPS_OFFSET UNITYSDK_OFFSET(0x65BCAD0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__BINDEVENT_BUTTON_B__11_0_OFFSET UNITYSDK_OFFSET(0x65BCE20)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x65BCCC0)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__ONUIOPEN_G__GETCAMPINDEX_6_1_OFFSET UNITYSDK_OFFSET(0x65BB440)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__ONUIOPEN_G__GETCAMPTYPEINDEX_6_0_OFFSET UNITYSDK_OFFSET(0x65BB350)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER__ONUIOPEN_G__GETPARTNERINDEX_6_2_OFFSET UNITYSDK_OFFSET(0x65BB610)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x65BCF20)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONGAMEPADMODULEFOCUS_OFFSET UNITYSDK_OFFSET(0x65BCF90)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONGAMEPADMODULELOSTFOCUS_OFFSET UNITYSDK_OFFSET(0x65BD000)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x65BD070)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x65BD080)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x65BD090)
#define MOLEMOLE_UIWORKBENCHTRUSTDEGREEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x65BD0A0)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkBenchTrustDegreePageController_TypeDefinitionIndex = 64162;

	class UIWorkBenchTrustDegreePageController : public ::MoleMole::UIWindowController
	{
	public:
		::Class_2_57F4F2E1F75850CE* _view; // 0x2F8
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::Class_2_6D99A03C58ED2B6E_2*>*>* _partnerCampConfigTemplateDatas; // 0x300
		::System::Collections::Generic::List_1<::MoleMole::UIWorkBenchTrustDegreePageController_PartnerCampTypeTemplateData*>* _campTypeData; // 0x308
		::System::Collections::Generic::List_1<::Class_2_CEF0D076577A9E4E*>* _partnerConfigTemplateDatas; // 0x310
		::MoleMole::UIWorkBenchTrustDegreeDetailsCardWidgetController* _detailsCardWidget; // 0x318
		::System::Int32 currentCampID; // 0x320
		::System::Int32 _delayReadRedPointCampID; // 0x324
		::System::Int32 _lastSelectIdx; // 0x328
