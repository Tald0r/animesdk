...
#define MOLEMOLE_UIWORKSHOP3DMODELCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6AE9730)
#define MOLEMOLE_UIWORKSHOP3DMODELCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6AE97D0)
#define MOLEMOLE_UIWORKSHOP3DMODELCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6AE9500)
#define MOLEMOLE_UIWORKSHOP3DMODELCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6AE96C0)
#define MOLEMOLE_UIWORKSHOP3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x6AE9860)
#define MOLEMOLE_UIWORKSHOP3DMODELCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x6AE98D0)
#define MOLEMOLE_UIWORKSHOP3DMODELCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6AE9940)
#define MOLEMOLE_UIWORKSHOP3DMODELCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6AE9950)
#define MOLEMOLE_UIWORKSHOP3DMODELCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x6AE9960)

namespace MoleMole
{
	inline static constexpr unsigned int UIWorkshop3DModelController_TypeDefinitionIndex = 57886;

	class UIWorkshop3DModelController : public ::MoleMole::UIBase3DModelController
	{
	public:
		::Class_2_56AF18CD74DA940A_10* _view; // 0x340
