...
#define MOLEMOLE_MONODESTRUCTIONOBJECT_GETBASETEMPLATE_OFFSET UNITYSDK_OFFSET(0xD0ED370)
#define MOLEMOLE_MONODESTRUCTIONOBJECT_GETSUBID_OFFSET UNITYSDK_OFFSET(0xD0ED0C0)
#define MOLEMOLE_MONODESTRUCTIONOBJECT_GETSUBTEMPLATE_OFFSET UNITYSDK_OFFSET(0xD0ED2E0)
#define MOLEMOLE_MONODESTRUCTIONOBJECT_METHOD_7_C7E9B8BFC4E12591_OFFSET UNITYSDK_OFFSET(0xD0ED210)
#define MOLEMOLE_MONODESTRUCTIONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0xD0ED400)

namespace MoleMole
{
	inline static constexpr unsigned int MonoDestructionObject_TypeDefinitionIndex = 53865;
	...
	public:
		...
		::Class_2_208CC9941471731A_1002* GetSubTemplate()
		{
			return ((::Class_2_208CC9941471731A_1002*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_MONODESTRUCTIONOBJECT_GETSUBTEMPLATE_OFFSET))(this);
		}
