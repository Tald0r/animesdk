...
#define MOLEMOLE_UIRIGIDBODY_ADDFORCE_OFFSET UNITYSDK_OFFSET(0xD6BC850)
#define MOLEMOLE_UIRIGIDBODY_AWAKE_OFFSET UNITYSDK_OFFSET(0xD6BFC80)
#define MOLEMOLE_UIRIGIDBODY_BEGINDRAGLOGIC_OFFSET UNITYSDK_OFFSET(0xD6BD510)
#define MOLEMOLE_UIRIGIDBODY_DRAGLOGIC_OFFSET UNITYSDK_OFFSET(0xD6BF1A0)
#define MOLEMOLE_UIRIGIDBODY_ENDDRAGLOGIC_OFFSET UNITYSDK_OFFSET(0xD6BCE20)
#define MOLEMOLE_UIRIGIDBODY_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0xD6C0570)
#define MOLEMOLE_UIRIGIDBODY_GETMASS_OFFSET UNITYSDK_OFFSET(0xD6BC8E0)
#define MOLEMOLE_UIRIGIDBODY_GET_DRAGING_OFFSET UNITYSDK_OFFSET(0xD6BC400)
#define MOLEMOLE_UIRIGIDBODY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xD6BFBB0)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_2DE8115E31073885_OFFSET UNITYSDK_OFFSET(0xD6BDBB0)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_3083E62D669EB1F6_OFFSET UNITYSDK_OFFSET(0xD6BF990)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_5C053D92769BEEB5_OFFSET UNITYSDK_OFFSET(0xD6BC6D0)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_61B2BEE1A537C4F9_OFFSET UNITYSDK_OFFSET(0xD6C0E90)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_832295EC279E5994_OFFSET UNITYSDK_OFFSET(0xD6C1CA0)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_CEA3E41971946EA7_OFFSET UNITYSDK_OFFSET(0xD6C1900)
#define MOLEMOLE_UIRIGIDBODY_METHOD_6_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xD6BFA70)
#define MOLEMOLE_UIRIGIDBODY_ONAPPLICATIONFOCUS_OFFSET UNITYSDK_OFFSET(0xD6BFB30)
#define MOLEMOLE_UIRIGIDBODY_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xD6BD2B0)
#define MOLEMOLE_UIRIGIDBODY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD6C1100)
#define MOLEMOLE_UIRIGIDBODY_ONDRAG_OFFSET UNITYSDK_OFFSET(0xD6BEF30)
#define MOLEMOLE_UIRIGIDBODY_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xD6BFC10)
#define MOLEMOLE_UIRIGIDBODY_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0xD6BC410)
#define MOLEMOLE_UIRIGIDBODY_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xD6BC960)
#define MOLEMOLE_UIRIGIDBODY_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xD6BCDA0)
#define MOLEMOLE_UIRIGIDBODY_RESETANGLE_OFFSET UNITYSDK_OFFSET(0xD6C12E0)
#define MOLEMOLE_UIRIGIDBODY_SETDRAGANCHOR_OFFSET UNITYSDK_OFFSET(0xD6BCBF0)
#define MOLEMOLE_UIRIGIDBODY_TRYTRIGGERCLICK_OFFSET UNITYSDK_OFFSET(0xD6BC490)
#define MOLEMOLE_UIRIGIDBODY__CTOR_OFFSET UNITYSDK_OFFSET(0xD6C1670)
#define MOLEMOLE_UIRIGIDBODY___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0xD6C17E0)
#define MOLEMOLE_UIRIGIDBODY___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD6C1870)

namespace MoleMole
{
	inline static constexpr unsigned int UIRigidbody_TypeDefinitionIndex = 40796;
