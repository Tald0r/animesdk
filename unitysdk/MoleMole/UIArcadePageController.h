...
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ADDBACKBTNACTION_OFFSET UNITYSDK_OFFSET(0xBFB5140)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERARCADEMACHINEPHASEFROMENTRANCE_OFFSET UNITYSDK_OFFSET(0xBFB7940)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERARCADEMACHINEPHASEFROMPLAYGAMENOANIM_OFFSET UNITYSDK_OFFSET(0xBFB7700)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERARCADEMACHINEPHASEFROMPLAYGAME_OFFSET UNITYSDK_OFFSET(0xBFB7600)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERARCADEMACHINEPHASEFROMSPINNINGTABLE_OFFSET UNITYSDK_OFFSET(0xBFB6C70)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERENTRANCEPHASEFROMSPINNINGTABLE_OFFSET UNITYSDK_OFFSET(0xBFB5CB0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERPLAYGAMEPHASEFROMARCADEMACHINENOANIM_OFFSET UNITYSDK_OFFSET(0xBFB7580)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERPLAYGAMEPHASEFROMARCADEMACHINE_OFFSET UNITYSDK_OFFSET(0xBFB7440)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERSPINNINGTABLEPHASEFROMARCADEMACHINE_OFFSET UNITYSDK_OFFSET(0xBFB6D80)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERSPINNINGTABLEPHASEFROMENTRANCEDIRECT_OFFSET UNITYSDK_OFFSET(0xBFB4970)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERSPINNINGTABLEPHASEFROMENTRANCE_OFFSET UNITYSDK_OFFSET(0xBFB6070)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GENARCADEGAMELIST_OFFSET UNITYSDK_OFFSET(0xBFBB350)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GETARCADECOMMONGAMEIDLIST_OFFSET UNITYSDK_OFFSET(0xBFB7EE0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GETCURARCADEPHASETYPE_OFFSET UNITYSDK_OFFSET(0xBFB5700)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GET_ARCADECONFIG_OFFSET UNITYSDK_OFFSET(0xBFB3350)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0xBFB3340)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GET_MULTIPLAYERSM_OFFSET UNITYSDK_OFFSET(0xBFB3360)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GET_VIEW_OFFSET UNITYSDK_OFFSET(0xBFB3330)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_INITARCADEGAMELIST_OFFSET UNITYSDK_OFFSET(0xBFB94F0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_INITENTRANCEPHASE_OFFSET UNITYSDK_OFFSET(0xBFB97C0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xBFB34E0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ISALLOWJUMPTOINVITETEAMROOM_OFFSET UNITYSDK_OFFSET(0xBFB9480)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ISALLOWSHOWINVITE_OFFSET UNITYSDK_OFFSET(0xBFB9350)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ISINMULTIPLAYERMODE_OFFSET UNITYSDK_OFFSET(0xBFB5690)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_JOINROOMCLEAR_OFFSET UNITYSDK_OFFSET(0xBFB4BB0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONARCADEEVENTTRIGGERHANDLE_OFFSET UNITYSDK_OFFSET(0xBFBADD0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONBACKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xBFB9AA0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONBATTLEABORT_OFFSET UNITYSDK_OFFSET(0xBFB9DB0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONBATTLEREADY_OFFSET UNITYSDK_OFFSET(0xBFBA310)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONBEKNICK_OFFSET UNITYSDK_OFFSET(0xBFB9C70)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFB3370)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xBFB4E00)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONROOMINFOSYNC_OFFSET UNITYSDK_OFFSET(0xBFBA060)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBFB4250)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBFB3900)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFB3980)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFB3410)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFB3B90)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_OPENORCLOSEGAMINGSELECTWIDGET_OFFSET UNITYSDK_OFFSET(0xBFB71D0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_OPENORCLOSEMENUWIDGET_OFFSET UNITYSDK_OFFSET(0xBFB9860)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_OPENORCLOSEPLAYWIDGET_OFFSET UNITYSDK_OFFSET(0xBFB8210)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_OPENORCLOSESINGLEPLAYERWIDGET_OFFSET UNITYSDK_OFFSET(0xBFB6A00)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_OPENORCLOSETEAMWIDGET_OFFSET UNITYSDK_OFFSET(0xBFB65E0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_PLAYARCADEMACHINEPHASEALLFADEIN_OFFSET UNITYSDK_OFFSET(0xBFB8BC0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_PLAYARCADEMACHINEPHASESPECIALFADEINPOST_OFFSET UNITYSDK_OFFSET(0xBFB8FF0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_PLAYARCADEMACHINEPHASESPECIALFADEINPRE_OFFSET UNITYSDK_OFFSET(0xBFB6850)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_PLAYSPINNINGTABLEPHASEALLFADEIN_OFFSET UNITYSDK_OFFSET(0xBFB8AD0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_REMOVEBACKBTNACTION_OFFSET UNITYSDK_OFFSET(0xBFB53B0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_SAMPLEARCADEMACHINEPHASEALLFADEIN_OFFSET UNITYSDK_OFFSET(0xBFB7790)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_SETARCADEMACHINEPHASEBOTTOMAREAACTIVE_OFFSET UNITYSDK_OFFSET(0xBFB8D70)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_SETBACKBTNACTIVE_OFFSET UNITYSDK_OFFSET(0xBFB50B0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_SETMINIGAMESTATE_OFFSET UNITYSDK_OFFSET(0xBFB5610)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_SHOWINVITE_OFFSET UNITYSDK_OFFSET(0xBFB9230)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYCREATEARCADEMACHINEPHASEWIDGET_OFFSET UNITYSDK_OFFSET(0xBFB6400)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYENTERGAMEPHASENOANIM_OFFSET UNITYSDK_OFFSET(0xBFB8900)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYENTERGAMEPHASE_OFFSET UNITYSDK_OFFSET(0xBFB8730)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYEXITGAMEPHASE_OFFSET UNITYSDK_OFFSET(0xBFB7F50)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYJOININVITETEAMROOM_OFFSET UNITYSDK_OFFSET(0xBFBA600)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYJOINROOM_OFFSET UNITYSDK_OFFSET(0xBFBABB0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYOPENACHIEVEMENTDIALOG_OFFSET UNITYSDK_OFFSET(0xBFB5770)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYOPENMAINRANKDIALOG_OFFSET UNITYSDK_OFFSET(0xBFB5940)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYSHOWPARTNERDATETIPS_OFFSET UNITYSDK_OFFSET(0xBFB3E70)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBFBB7D0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBFBB6D0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__ISALLOWSHOWINVITE_B__64_0_OFFSET UNITYSDK_OFFSET(0xBFBB860)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__ONBEKNICK_B__74_0_OFFSET UNITYSDK_OFFSET(0xBFBB870)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__ONSHOW_B__32_0_OFFSET UNITYSDK_OFFSET(0xBFBB810)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__TRYJOININVITETEAMROOM_B__79_0_OFFSET UNITYSDK_OFFSET(0xBFBBAB0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__TRYJOININVITETEAMROOM_B__79_2_OFFSET UNITYSDK_OFFSET(0xBFBBB00)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBFBBED0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xBFBBF40)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBFBBFA0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBFBC010)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBFBC020)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBFBC030)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBFBC040)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadePageController_TypeDefinitionIndex = 57166;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIArcadePageController_TypeDefinitionIndex)->GetStaticField(0xE0F0);
		}
		...
		::Enum_3_44AC5205CD588B1D _curArcadePhaseType; // 0x358
		::System::Boolean _isInMultiPlayerMode; // 0x35C
		::System::Int32 _gamePlayerMode; // 0x360
		::Class_2_208CC9941471731A_88* _arcadeConfig; // 0x368
		::Class_1_29B05041B716AB94* _multiplayerSM; // 0x370
		::System::Collections::Generic::Dictionary_2<::Enum_3_0A3761FE34514D6C_36, ::System::Boolean>* _rankGetResultDict; // 0x378
		...
		::Class_2_208CC9941471731A_88* get_ArcadeConfig()
		{
			return ((::Class_2_208CC9941471731A_88*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADEPAGECONTROLLER_GET_ARCADECONFIG_OFFSET))(this);
		}
