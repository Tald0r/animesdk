...
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ADDBACKBTNACTION_OFFSET UNITYSDK_OFFSET(0xBAE86D0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERARCADEMACHINEPHASEFROMENTRANCE_OFFSET UNITYSDK_OFFSET(0xBAEAED0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERARCADEMACHINEPHASEFROMPLAYGAMENOANIM_OFFSET UNITYSDK_OFFSET(0xBAEAC90)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERARCADEMACHINEPHASEFROMPLAYGAME_OFFSET UNITYSDK_OFFSET(0xBAEAB90)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERARCADEMACHINEPHASEFROMSPINNINGTABLE_OFFSET UNITYSDK_OFFSET(0xBAEA200)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERENTRANCEPHASEFROMSPINNINGTABLE_OFFSET UNITYSDK_OFFSET(0xBAE9240)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERPLAYGAMEPHASEFROMARCADEMACHINENOANIM_OFFSET UNITYSDK_OFFSET(0xBAEAB10)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERPLAYGAMEPHASEFROMARCADEMACHINE_OFFSET UNITYSDK_OFFSET(0xBAEA9D0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERSPINNINGTABLEPHASEFROMARCADEMACHINE_OFFSET UNITYSDK_OFFSET(0xBAEA310)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERSPINNINGTABLEPHASEFROMENTRANCEDIRECT_OFFSET UNITYSDK_OFFSET(0xBAE7F00)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ENTERSPINNINGTABLEPHASEFROMENTRANCE_OFFSET UNITYSDK_OFFSET(0xBAE9600)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GENARCADEGAMELIST_OFFSET UNITYSDK_OFFSET(0xBAEE8D0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GETARCADECOMMONGAMEIDLIST_OFFSET UNITYSDK_OFFSET(0xBAEB470)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GETCURARCADEPHASETYPE_OFFSET UNITYSDK_OFFSET(0xBAE8C90)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GET_ARCADECONFIG_OFFSET UNITYSDK_OFFSET(0xBAE68D0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET UNITYSDK_OFFSET(0xBAE68C0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GET_MULTIPLAYERSM_OFFSET UNITYSDK_OFFSET(0xBAE68E0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_GET_VIEW_OFFSET UNITYSDK_OFFSET(0xBAE68B0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_INITARCADEGAMELIST_OFFSET UNITYSDK_OFFSET(0xBAECA70)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_INITENTRANCEPHASE_OFFSET UNITYSDK_OFFSET(0xBAECD40)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xBAE6A60)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ISALLOWJUMPTOINVITETEAMROOM_OFFSET UNITYSDK_OFFSET(0xBAECA00)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ISALLOWSHOWINVITE_OFFSET UNITYSDK_OFFSET(0xBAEC8D0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ISINMULTIPLAYERMODE_OFFSET UNITYSDK_OFFSET(0xBAE8C20)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_JOINROOMCLEAR_OFFSET UNITYSDK_OFFSET(0xBAE8140)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONARCADEEVENTTRIGGERHANDLE_OFFSET UNITYSDK_OFFSET(0xBAEE350)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONBACKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0xBAED020)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONBATTLEABORT_OFFSET UNITYSDK_OFFSET(0xBAED330)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONBATTLEREADY_OFFSET UNITYSDK_OFFSET(0xBAED890)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONBEKNICK_OFFSET UNITYSDK_OFFSET(0xBAED1F0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBAE68F0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xBAE8390)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONROOMINFOSYNC_OFFSET UNITYSDK_OFFSET(0xBAED5E0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBAE77E0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBAE6E80)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBAE6F00)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBAE6990)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBAE7110)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_OPENORCLOSEGAMINGSELECTWIDGET_OFFSET UNITYSDK_OFFSET(0xBAEA760)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_OPENORCLOSEMENUWIDGET_OFFSET UNITYSDK_OFFSET(0xBAECDE0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_OPENORCLOSEPLAYWIDGET_OFFSET UNITYSDK_OFFSET(0xBAEB7A0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_OPENORCLOSESINGLEPLAYERWIDGET_OFFSET UNITYSDK_OFFSET(0xBAE9F90)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_OPENORCLOSETEAMWIDGET_OFFSET UNITYSDK_OFFSET(0xBAE9B70)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_PLAYARCADEMACHINEPHASEALLFADEIN_OFFSET UNITYSDK_OFFSET(0xBAEC150)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_PLAYARCADEMACHINEPHASESPECIALFADEINPOST_OFFSET UNITYSDK_OFFSET(0xBAEC570)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_PLAYARCADEMACHINEPHASESPECIALFADEINPRE_OFFSET UNITYSDK_OFFSET(0xBAE9DE0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_PLAYSPINNINGTABLEPHASEALLFADEIN_OFFSET UNITYSDK_OFFSET(0xBAEC060)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_REMOVEBACKBTNACTION_OFFSET UNITYSDK_OFFSET(0xBAE8940)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_SAMPLEARCADEMACHINEPHASEALLFADEIN_OFFSET UNITYSDK_OFFSET(0xBAEAD20)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_SETARCADEMACHINEPHASEBOTTOMAREAACTIVE_OFFSET UNITYSDK_OFFSET(0xBAEC300)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_SETBACKBTNACTIVE_OFFSET UNITYSDK_OFFSET(0xBAE8640)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_SETMINIGAMESTATE_OFFSET UNITYSDK_OFFSET(0xBAE8BA0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_SHOWINVITE_OFFSET UNITYSDK_OFFSET(0xBAEC7B0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYCREATEARCADEMACHINEPHASEWIDGET_OFFSET UNITYSDK_OFFSET(0xBAE9990)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYENTERGAMEPHASENOANIM_OFFSET UNITYSDK_OFFSET(0xBAEBE90)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYENTERGAMEPHASE_OFFSET UNITYSDK_OFFSET(0xBAEBCC0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYEXITGAMEPHASE_OFFSET UNITYSDK_OFFSET(0xBAEB4E0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYJOININVITETEAMROOM_OFFSET UNITYSDK_OFFSET(0xBAEDB80)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYJOINROOM_OFFSET UNITYSDK_OFFSET(0xBAEE130)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYOPENACHIEVEMENTDIALOG_OFFSET UNITYSDK_OFFSET(0xBAE8D00)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYOPENMAINRANKDIALOG_OFFSET UNITYSDK_OFFSET(0xBAE8ED0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER_TRYSHOWPARTNERDATETIPS_OFFSET UNITYSDK_OFFSET(0xBAE73F0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0xBAEED50)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBAEEC50)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__ISALLOWSHOWINVITE_B__64_0_OFFSET UNITYSDK_OFFSET(0xBAEEDE0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__ONBEKNICK_B__74_0_OFFSET UNITYSDK_OFFSET(0xBAEEDF0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__ONSHOW_B__32_0_OFFSET UNITYSDK_OFFSET(0xBAEED90)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__TRYJOININVITETEAMROOM_B__79_0_OFFSET UNITYSDK_OFFSET(0xBAEF030)
#define MOLEMOLE_UIARCADEPAGECONTROLLER__TRYJOININVITETEAMROOM_B__79_2_OFFSET UNITYSDK_OFFSET(0xBAEF080)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBAEF450)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xBAEF4C0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBAEF520)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xBAEF590)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBAEF5A0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBAEF5B0)
#define MOLEMOLE_UIARCADEPAGECONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBAEF5C0)

namespace MoleMole
{
	inline static constexpr unsigned int UIArcadePageController_TypeDefinitionIndex = 66629;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIArcadePageController_TypeDefinitionIndex)->GetStaticField(0xDA70);
		}
		::Class_2_9C4D889106D5C300* _view; // 0x308
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Single>* _datePartnerFairyTimeDict; // 0x310
		::Class_2_DD0812B7B232D3F6* _uiArcadeModel; // 0x318
		::System::Collections::Generic::List_1<::System::Int32>* _arcadeCommonGameIDList; // 0x320
		::MoleMole::UIArcadeShop3DModelController* _arcadeShop3DModelController; // 0x328
		::MoleMole::UIArcadeMenuChildWindowController* _menuWidget; // 0x330
		::MoleMole::UIArcadeGamingChildWindowController* _gamingSelectWidget; // 0x338
		::MoleMole::UIArcadeSinglePlayerChildWindowController* _singlePlayerWidget; // 0x340
		::MoleMole::UIArcadeTeamChildWindowController* _teamWidget; // 0x348
		::MoleMole::UIArcadeBasePlayChildWindowController* _playWidget; // 0x350
		::Enum_3_FF2373C2349A5978 _curArcadePhaseType; // 0x358
		::System::Boolean _isInMultiPlayerMode; // 0x35C
		::System::Int32 _gamePlayerMode; // 0x360
		::Class_2_208CC9941471731A_208* _arcadeConfig; // 0x368
		::Class_1_29B05041B716AB94* _multiplayerSM; // 0x370
		::System::Collections::Generic::Dictionary_2<::Enum_3_0A3761FE34514D6C_29, ::System::Boolean>* _rankGetResultDict; // 0x378
		::System::Collections::Generic::List_1<::System::ValueTuple_2<::MoleMole::UIBaseController*, ::System::Action*>>* _backBtnClickedActionList; // 0x380
		::System::Boolean _isShowingInvite; // 0x388
		...
		{
			return ((::Enum_3_205E43D40B9E7AEA(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADEPAGECONTROLLER_GET_MESSAGEMATCHPAGE_OFFSET))(this);
		}

		::Class_2_208CC9941471731A_208* get_ArcadeConfig()
		{
			return ((::Class_2_208CC9941471731A_208*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADEPAGECONTROLLER_GET_ARCADECONFIG_OFFSET))(this);
		}
		...
		::System::Void _OnShow_b__32_0(::Class_3_B46FF0A74020A4F6* roomInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_B46FF0A74020A4F6*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADEPAGECONTROLLER__ONSHOW_B__32_0_OFFSET))(this, roomInfo);
		}
		...
		::System::Void _TryJoinInviteTeamRoom_b__79_0(::Class_3_B46FF0A74020A4F6* roomInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_B46FF0A74020A4F6*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADEPAGECONTROLLER__TRYJOININVITETEAMROOM_B__79_0_OFFSET))(this, roomInfo);
		}

		::System::Void _TryJoinInviteTeamRoom_b__79_2(::Class_3_B46FF0A74020A4F6* roomInfo)
		{
			return ((::System::Void(*)(::PVOID, ::Class_3_B46FF0A74020A4F6*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIARCADEPAGECONTROLLER__TRYJOININVITETEAMROOM_B__79_2_OFFSET))(this, roomInfo);
		}
