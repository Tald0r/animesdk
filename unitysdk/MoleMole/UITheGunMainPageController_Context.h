...
#define MOLEMOLE_UITHEGUNMAINPAGECONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA75B7C0)

namespace MoleMole
{
	inline static constexpr unsigned int UITheGunMainPageController_Context_TypeDefinitionIndex = 68727;
