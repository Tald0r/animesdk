...
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER_BINDVIEWCALLBACK_OFFSET UNITYSDK_OFFSET(0x95D3270)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER_GETCONTROLBTN_OFFSET UNITYSDK_OFFSET(0x95F91E0)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95F8BB0)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x95F8C50)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95F8D90)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95F8A60)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95F8B00)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER_SETICONCOLOR_OFFSET UNITYSDK_OFFSET(0x95F8FC0)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER_SETICONIMAGE_OFFSET UNITYSDK_OFFSET(0x95F8F20)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER_SETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x95F8E90)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER_UNBINDVIEWCALLBACK_OFFSET UNITYSDK_OFFSET(0x95F90D0)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x95F9250)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95F9260)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0x95F92D0)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95F9350)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95F93D0)
#define MOLEMOLE_UIGENERALBTN03WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95F9430)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralBtn03WidgetController_TypeDefinitionIndex = 76137;

	class UIGeneralBtn03WidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_DE782794730406DC_2* _view; // 0x2D0
