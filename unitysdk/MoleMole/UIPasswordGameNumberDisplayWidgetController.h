...
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBE62A60)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBE62B00)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBE626D0)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBE62770)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER_SETCONTEXT_OFFSET UNITYSDK_OFFSET(0xBE62860)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xBE62BE0)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xBE62C10)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xBE62C80)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xBE62D00)
#define MOLEMOLE_UIPASSWORDGAMENUMBERDISPLAYWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xBE62D60)

namespace MoleMole
{
	inline static constexpr unsigned int UIPasswordGameNumberDisplayWidgetController_TypeDefinitionIndex = 78072;

	class UIPasswordGameNumberDisplayWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_D68EC59F0214DAC2_4* _view; // 0x2A0
