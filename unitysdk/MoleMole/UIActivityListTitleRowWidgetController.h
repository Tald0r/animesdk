...
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3C1DF0)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD3C1F70)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3C1E90)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3C1D50)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3C2510)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3C2520)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xD3C2590)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3C2610)
#define MOLEMOLE_UIACTIVITYLISTTITLEROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3C2690)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityListTitleRowWidgetController_TypeDefinitionIndex = 62249;

	class UIActivityListTitleRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_F914E35E759B2F13_1* _view; // 0x2D0
