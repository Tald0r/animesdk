...
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER__ONTABCHANGEREREGISTERINTERACTION_D__79_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3A2340)
#define MOLEMOLE_UIPLAYERACCESSORYPAGECONTROLLER__ONTABCHANGEREREGISTERINTERACTION_D__79_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIPlayerAccessoryPageController__OnTabChangeReregisterInteraction_d__79_TypeDefinitionIndex = 39882;
