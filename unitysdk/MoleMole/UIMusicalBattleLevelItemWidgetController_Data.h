...
#define MOLEMOLE_UIMUSICALBATTLELEVELITEMWIDGETCONTROLLER_DATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA840ED0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicalBattleLevelItemWidgetController_Data_TypeDefinitionIndex = 62493;

	class UIMusicalBattleLevelItemWidgetController_Data : public ::System::Object
	{
	public:
		::Class_0_16E4307DCC419505_103<::System::Int32>* CurSelectLevelIndex; // 0x10
		::Class_2_BB670ADEE63FFDEF_Struct_2_F7F069084F72D1BE LevelInfo; // 0x18
		::Class_0_16E4307DCC419505_102<::System::Boolean>* Focused; // 0x50
