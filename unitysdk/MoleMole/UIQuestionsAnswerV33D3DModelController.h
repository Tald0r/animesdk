...
#define MOLEMOLE_UIQUESTIONSANSWERV33D3DMODELCONTROLLER_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0xD00FA50)
#define MOLEMOLE_UIQUESTIONSANSWERV33D3DMODELCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD00FB20)
#define MOLEMOLE_UIQUESTIONSANSWERV33D3DMODELCONTROLLER___BASE_CREATEUIQUESTIONSANSWERSCREENWIDGETCONTROLLER_OFFSET UNITYSDK_OFFSET(0xD00FB80)

namespace MoleMole
{
	inline static constexpr unsigned int UIQuestionsAnswerV33D3DModelController_TypeDefinitionIndex = 76868;
