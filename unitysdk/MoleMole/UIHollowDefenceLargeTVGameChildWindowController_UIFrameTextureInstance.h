...
#define MOLEMOLE_UIHOLLOWDEFENCELARGETVGAMECHILDWINDOWCONTROLLER_UIFRAMETEXTUREINSTANCE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD5B17F0)
#define MOLEMOLE_UIHOLLOWDEFENCELARGETVGAMECHILDWINDOWCONTROLLER_UIFRAMETEXTUREINSTANCE_FLUSHCOROUTINE_OFFSET UNITYSDK_OFFSET(0xD5B13C0)
#define MOLEMOLE_UIHOLLOWDEFENCELARGETVGAMECHILDWINDOWCONTROLLER_UIFRAMETEXTUREINSTANCE_FLUSH_OFFSET UNITYSDK_OFFSET(0xD5B11B0)
#define MOLEMOLE_UIHOLLOWDEFENCELARGETVGAMECHILDWINDOWCONTROLLER_UIFRAMETEXTUREINSTANCE_GET_COLOR_OFFSET UNITYSDK_OFFSET(0xD5B1480)
#define MOLEMOLE_UIHOLLOWDEFENCELARGETVGAMECHILDWINDOWCONTROLLER_UIFRAMETEXTUREINSTANCE_GET_ENABLE_OFFSET UNITYSDK_OFFSET(0xD5B15F0)
#define MOLEMOLE_UIHOLLOWDEFENCELARGETVGAMECHILDWINDOWCONTROLLER_UIFRAMETEXTUREINSTANCE_SET_COLOR_OFFSET UNITYSDK_OFFSET(0xD5B14B0)
#define MOLEMOLE_UIHOLLOWDEFENCELARGETVGAMECHILDWINDOWCONTROLLER_UIFRAMETEXTUREINSTANCE_SET_ENABLE_OFFSET UNITYSDK_OFFSET(0xD5B1680)
#define MOLEMOLE_UIHOLLOWDEFENCELARGETVGAMECHILDWINDOWCONTROLLER_UIFRAMETEXTUREINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0xD5B1040)

namespace MoleMole
{
	inline static constexpr unsigned int UIHollowDefenceLargeTVGameChildWindowController_UIFrameTextureInstance_TypeDefinitionIndex = 51918;
	...
	public:
		...
		::Class_2_A8F5ABF31E066ED4* _image; // 0x18
		::Class_1_30D3D578039787FA* TSPlayer; // 0x20
