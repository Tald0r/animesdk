...
#define MOLEMOLE_UIGENERALHEADINFOWIDGETCONTROLLER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x9D893C0)
#define MOLEMOLE_UIGENERALHEADINFOWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9D88E00)
#define MOLEMOLE_UIGENERALHEADINFOWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9D88EA0)
#define MOLEMOLE_UIGENERALHEADINFOWIDGETCONTROLLER_SETDATAINNER_OFFSET UNITYSDK_OFFSET(0x9D890E0)
#define MOLEMOLE_UIGENERALHEADINFOWIDGETCONTROLLER_SETDATA_OFFSET UNITYSDK_OFFSET(0x9D88F80)
#define MOLEMOLE_UIGENERALHEADINFOWIDGETCONTROLLER_SETOVERRIDENAME_OFFSET UNITYSDK_OFFSET(0x9D894A0)
#define MOLEMOLE_UIGENERALHEADINFOWIDGETCONTROLLER__CCTOR_OFFSET UNITYSDK_OFFSET(0x9D89520)
#define MOLEMOLE_UIGENERALHEADINFOWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D89510)
#define MOLEMOLE_UIGENERALHEADINFOWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9D89620)
#define MOLEMOLE_UIGENERALHEADINFOWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9D89690)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralHeadInfoWidgetController_TypeDefinitionIndex = 39608;
	...
	public:
		...
		{
			return (::Il2CppArray<::Foundation::AssetPath>**)Il2CppClass::FromTypeDefinitionIndex(UIGeneralHeadInfoWidgetController_TypeDefinitionIndex)->GetStaticField(0x435E0);
		}
		::Class_2_00E0F6A4450214AA_1* _view; // 0x2D0
