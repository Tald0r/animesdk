...
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_INITTABUIVIEW_OFFSET UNITYSDK_OFFSET(0xDEDBC90)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONCLICKDETAILSICONBTN_OFFSET UNITYSDK_OFFSET(0xDEDCB60)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONCLICKTABLEROW_OFFSET UNITYSDK_OFFSET(0xDEDC740)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xDEDC150)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEDB9D0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDEDB590)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEDBA70)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEDB040)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDEDB0E0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_REFRESHREMAINTIMERTEXT_OFFSET UNITYSDK_OFFSET(0xDEDC650)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_REFRESHSHOWTABLE_OFFSET UNITYSDK_OFFSET(0xDEDB660)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_SHOWTABLEUIVIEWEMPTY_OFFSET UNITYSDK_OFFSET(0xDEDC030)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_SHOWTABLEUIVIEW_OFFSET UNITYSDK_OFFSET(0xDEDC400)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xDEDC390)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xDEDBBF0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDEDCBE0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER__ONCLICKTABLEROW_B__28_0_OFFSET UNITYSDK_OFFSET(0xDEDCD30)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER__REFRESHREMAINTIMERTEXT_B__27_0_OFFSET UNITYSDK_OFFSET(0xDEDCD00)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDEDCD40)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDEDCDB0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDEDCE20)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDEDCEA0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDEDCF00)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityGoldenWeekV2WidgetController_TypeDefinitionIndex = 38964;

	class UIActivityGoldenWeekV2WidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::MoleMole::UIActivityGoldenWeekV2WidgetController_Context* _context; // 0x2A0
		::Class_2_B7A68D43387CE5B2* _view; // 0x2A8
		::System::Collections::Generic::List_1<::Class_1_D375C91CCE5D3999*>* MissonDataList; // 0x2B0
		::System::Collections::Generic::List_1<::Class_1_1D6B384C0B7DC7C3*>* _taskLists; // 0x2B8
		::UnityEngine::UI::Extension::UITabButtonGroup* _TabGroup; // 0x2C0
		::MonoUITableScrollV2* _ScrollView; // 0x2C8
		::Class_1_D375C91CCE5D3999* _selectActivityData; // 0x2D0
		::System::Int32 _curTabIndex; // 0x2D8
		::System::Int32 _curSelectTabIndex; // 0x2DC
		::System::Boolean _showActivityEnd; // 0x2E0
		::Class_2_604149159BD159AA* _uiActivityModel; // 0x2E8
		::System::Boolean _refreshDirty; // 0x2F0
		::System::Boolean isPlayTabEffect; // 0x2F1
		::Foundation::Coroutine::CoroutineHandle changeHandle; // 0x2F4
		...
		::System::Void _OnClickTableRow_b__28_0(::Class_0_16E4307DCC419505_5* rspMsg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER__ONCLICKTABLEROW_B__28_0_OFFSET))(this, rspMsg);
		}
