...
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_INITTABUIVIEW_OFFSET UNITYSDK_OFFSET(0xD3BF260)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONCLICKDETAILSICONBTN_OFFSET UNITYSDK_OFFSET(0xD3C0150)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONCLICKTABLEROW_OFFSET UNITYSDK_OFFSET(0xD3BFD30)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xD3BF730)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3BEFA0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD3BEB60)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3BF040)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3BE610)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD3BE6B0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_REFRESHREMAINTIMERTEXT_OFFSET UNITYSDK_OFFSET(0xD3BFC40)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_REFRESHSHOWTABLE_OFFSET UNITYSDK_OFFSET(0xD3BEC30)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_SHOWTABLEUIVIEWEMPTY_OFFSET UNITYSDK_OFFSET(0xD3BF610)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_SHOWTABLEUIVIEW_OFFSET UNITYSDK_OFFSET(0xD3BF9E0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_UPDATEUI_OFFSET UNITYSDK_OFFSET(0xD3BF970)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD3BF1C0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD3C01D0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER__ONCLICKTABLEROW_B__28_0_OFFSET UNITYSDK_OFFSET(0xD3C0320)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER__REFRESHREMAINTIMERTEXT_B__27_0_OFFSET UNITYSDK_OFFSET(0xD3C02F0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD3C0330)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD3C03A0)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD3C0410)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD3C0490)
#define MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD3C04F0)

namespace MoleMole
{
	inline static constexpr unsigned int UIActivityGoldenWeekV2WidgetController_TypeDefinitionIndex = 78646;
	...
	public:
		...
		::System::Void _OnClickTableRow_b__28_0(::Class_0_16E4307DCC419505_7* rspMsg)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_7*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIACTIVITYGOLDENWEEKV2WIDGETCONTROLLER__ONCLICKTABLEROW_B__28_0_OFFSET))(this, rspMsg);
		}
