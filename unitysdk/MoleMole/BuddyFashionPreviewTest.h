...
#define MOLEMOLE_BUDDYFASHIONPREVIEWTEST_CREATEBUDDYPARTSASYNC_OFFSET UNITYSDK_OFFSET(0xB49BD90)
#define MOLEMOLE_BUDDYFASHIONPREVIEWTEST_METHOD_5_28C834B59E1D0120_OFFSET UNITYSDK_OFFSET(0xB49C190)
#define MOLEMOLE_BUDDYFASHIONPREVIEWTEST_METHOD_5_BF6E5505691D3871_OFFSET UNITYSDK_OFFSET(0xB49C330)
#define MOLEMOLE_BUDDYFASHIONPREVIEWTEST_PREVIEWFASHION_OFFSET UNITYSDK_OFFSET(0xB49BB50)
#define MOLEMOLE_BUDDYFASHIONPREVIEWTEST__CTOR_OFFSET UNITYSDK_OFFSET(0xB49C040)

namespace MoleMole
{
	inline static constexpr unsigned int BuddyFashionPreviewTest_TypeDefinitionIndex = 42583;
