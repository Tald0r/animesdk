...
#define MOLEMOLE_UIMAINCITYNAVIGATIONTELEPORTROWWIDGETCONTROLLER___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0x865C280)
#define MOLEMOLE_UIMAINCITYNAVIGATIONTELEPORTROWWIDGETCONTROLLER___C__DISPLAYCLASS19_0__DOTELEPORT_B__0_OFFSET UNITYSDK_OFFSET(0x865D780)
#define MOLEMOLE_UIMAINCITYNAVIGATIONTELEPORTROWWIDGETCONTROLLER___C__DISPLAYCLASS19_0__DOTELEPORT_B__1_OFFSET UNITYSDK_OFFSET(0x865D7C0)
#define MOLEMOLE_UIMAINCITYNAVIGATIONTELEPORTROWWIDGETCONTROLLER___C__DISPLAYCLASS19_0__DOTELEPORT_B__2_OFFSET UNITYSDK_OFFSET(0x865D890)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCityNavigationTeleportRowWidgetController___c__DisplayClass19_0_TypeDefinitionIndex = 44884;
