...
#define MOLEMOLE_MONOTEST_ECS_METHOD_5_765F31ECF6C53214_OFFSET UNITYSDK_OFFSET(0x8A819C0)
#define MOLEMOLE_MONOTEST_ECS_TEST_OFFSET UNITYSDK_OFFSET(0x8A81940)
#define MOLEMOLE_MONOTEST_ECS__CTOR_OFFSET UNITYSDK_OFFSET(0x8A819A0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoTest_ECS_TypeDefinitionIndex = 77178;
