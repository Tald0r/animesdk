...
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_GETHIDEINDEX_OFFSET UNITYSDK_OFFSET(0xADC2D60)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_GET_HIDEWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0xADC2A00)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_GET_MOVEWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0xADC2A20)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0xADC2B20)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_JUMPTOFINALSTATE_OFFSET UNITYSDK_OFFSET(0xADC30A0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_JUMPTOFINAL_OFFSET UNITYSDK_OFFSET(0xADC3110)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_MOLEMOLE_COMIC_ICOMICEVENTMOVEABLE_ISMOVING_OFFSET UNITYSDK_OFFSET(0xADC3170)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xADC2AB0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADC2A40)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0xADC2C10)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_SETHIDEINDEX_OFFSET UNITYSDK_OFFSET(0xADC2CD0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_SETMOVEPARAMS_OFFSET UNITYSDK_OFFSET(0xADC2FC0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_SET_HIDEWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0xADC2A10)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_SET_MOVEWHENSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0xADC2A30)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_SIMULATEMOVEPROCESS_OFFSET UNITYSDK_OFFSET(0xADC2EA0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER_UPDATEMOVE_OFFSET UNITYSDK_OFFSET(0xADC2DD0)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xADC3210)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER___BASE_INITWITHBASE_OFFSET UNITYSDK_OFFSET(0xADC3240)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0xADC3250)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xADC3260)
#define MOLEMOLE_UICOMICDECORATIONEVENTCONTROLLER___BASE_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0xADC3270)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicDecorationEventController_TypeDefinitionIndex = 78044;

	class UIComicDecorationEventController : public ::MoleMole::UIComicEventController
	{
	public:
		::System::Boolean _hideWhenSplitScreen_k__BackingField; // 0x2C8
		::System::Int32 hideWhenSplitScreenIndex; // 0x2CC
		::System::Boolean _moveWhenSplitScreen_k__BackingField; // 0x2D0
		::System::Boolean isMoving; // 0x2D1
		::UnityEngine::Vector2 sourcePosition; // 0x2D4
		::UnityEngine::Vector2 moveVector; // 0x2DC
		::System::Single moveDeltaTime; // 0x2E4
		::System::Single totalMoveTime; // 0x2E8
		::UnityEngine::AnimationCurve* moveCurve; // 0x2F0
