...
#define MOLEMOLE_UIAVATARLIGHTCHANGESETTINGS_ONCONFIGCHANGED_OFFSET UNITYSDK_OFFSET(0x3A7280)

namespace MoleMole
{
	inline static constexpr unsigned int UIAvatarLightChangeSettings_TypeDefinitionIndex = 66268;
