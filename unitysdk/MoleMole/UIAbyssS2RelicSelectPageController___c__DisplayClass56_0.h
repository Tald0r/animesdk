...
#define MOLEMOLE_UIABYSSS2RELICSELECTPAGECONTROLLER___C__DISPLAYCLASS56_0__CTOR_OFFSET UNITYSDK_OFFSET(0xC8CE9E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAbyssS2RelicSelectPageController___c__DisplayClass56_0_TypeDefinitionIndex = 46168;
