...
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER_GETCOMBINECARDCTRL_OFFSET UNITYSDK_OFFSET(0x8F0CA10)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONCOMBINECARDCREATE_OFFSET UNITYSDK_OFFSET(0x8F0C850)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8F0CAD0)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER_SCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0x8F0C780)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x8F0CEE0)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_GETCOMBINECARDCTRL_OFFSET UNITYSDK_OFFSET(0x8F0CF40)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_ONCOMBINECARDCREATE_OFFSET UNITYSDK_OFFSET(0x8F0CF50)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8F0CFC0)
#define MOLEMOLE_UIINLEVELHOLLOWCARDOPTIONSDIALOGV2POPWINDOWCONTROLLER___BASE_SCROLLWIDGETFUNC_OFFSET UNITYSDK_OFFSET(0x8F0CFD0)

namespace MoleMole
{
	inline static constexpr unsigned int UIInlevelHollowCardOptionsDialogV2PopWindowController_TypeDefinitionIndex = 62869;
