...
#define MOLEMOLE_UIPHOTOSTICKERCONTROLPOPWINDOWCONTROLLER_CONTEXT_GET_STICKERID_OFFSET UNITYSDK_OFFSET(0x8EF2F90)
#define MOLEMOLE_UIPHOTOSTICKERCONTROLPOPWINDOWCONTROLLER_CONTEXT_GET_STICKERINDEX_OFFSET UNITYSDK_OFFSET(0x8EF31D0)
#define MOLEMOLE_UIPHOTOSTICKERCONTROLPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8EF3420)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoStickerControlPopWindowController_Context_TypeDefinitionIndex = 78216;
