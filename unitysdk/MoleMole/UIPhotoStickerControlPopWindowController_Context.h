...
#define MOLEMOLE_UIPHOTOSTICKERCONTROLPOPWINDOWCONTROLLER_CONTEXT_GET_STICKERID_OFFSET UNITYSDK_OFFSET(0xA3DF1B0)
#define MOLEMOLE_UIPHOTOSTICKERCONTROLPOPWINDOWCONTROLLER_CONTEXT_GET_STICKERINDEX_OFFSET UNITYSDK_OFFSET(0xA3DF3F0)
#define MOLEMOLE_UIPHOTOSTICKERCONTROLPOPWINDOWCONTROLLER_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xA3DF630)

namespace MoleMole
{
	inline static constexpr unsigned int UIPhotoStickerControlPopWindowController_Context_TypeDefinitionIndex = 41099;
