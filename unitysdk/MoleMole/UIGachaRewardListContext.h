...
#define MOLEMOLE_UIGACHAREWARDLISTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xBFEDF30)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaRewardListContext_TypeDefinitionIndex = 62067;
