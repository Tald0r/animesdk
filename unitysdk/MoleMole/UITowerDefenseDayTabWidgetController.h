...
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xACD42F0)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xACD4390)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xACD41A0)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xACD4240)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_REFRESHENTRY_OFFSET UNITYSDK_OFFSET(0xACD4470)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_SETINDEX_OFFSET UNITYSDK_OFFSET(0xACD49D0)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_SETLOCKSTATE_OFFSET UNITYSDK_OFFSET(0xACD4960)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_SETSTATE_OFFSET UNITYSDK_OFFSET(0xACD48F0)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER_UPDATESTATE_OFFSET UNITYSDK_OFFSET(0xACD4760)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xACD50D0)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xACD5100)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xACD5170)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xACD51F0)
#define MOLEMOLE_UITOWERDEFENSEDAYTABWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xACD5250)

namespace MoleMole
{
	inline static constexpr unsigned int UITowerDefenseDayTabWidgetController_TypeDefinitionIndex = 61751;

	class UITowerDefenseDayTabWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_1CC0E2699D5FB1A6_7* _view; // 0x2A0
		::MoleMole::UITowerDefenseDayTabWidgetController_State state; // 0x2A8
		::System::Boolean isLock; // 0x2AC
