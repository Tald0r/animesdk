...
#define MOLEMOLE_DISABLEBLOOMBYANDROIDSDKVERSIONANDGPUPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1750A9D0)
#define MOLEMOLE_DISABLEBLOOMBYANDROIDSDKVERSIONANDGPUPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x1750AA60)
#define MOLEMOLE_DISABLEBLOOMBYANDROIDSDKVERSIONANDGPUPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1750AAC0)

namespace MoleMole
{
	inline static constexpr unsigned int DisableBloomByAndroidSDKVersionAndGPUPostProcessorProfile_TypeDefinitionIndex = 40160;
