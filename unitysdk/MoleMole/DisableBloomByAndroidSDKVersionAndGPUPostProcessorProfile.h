...
#define MOLEMOLE_DISABLEBLOOMBYANDROIDSDKVERSIONANDGPUPOSTPROCESSORPROFILE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x16BBD400)
#define MOLEMOLE_DISABLEBLOOMBYANDROIDSDKVERSIONANDGPUPOSTPROCESSORPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x16BBD490)
#define MOLEMOLE_DISABLEBLOOMBYANDROIDSDKVERSIONANDGPUPOSTPROCESSORPROFILE___BASE_GETPERFORMANCEPROFILEPOSTPROCESSOR_OFFSET UNITYSDK_OFFSET(0x16BBD4F0)

namespace MoleMole
{
	inline static constexpr unsigned int DisableBloomByAndroidSDKVersionAndGPUPostProcessorProfile_TypeDefinitionIndex = 40497;
