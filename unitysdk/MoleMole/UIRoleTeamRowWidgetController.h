...
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6F0EC0)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB6F1040)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6F0F60)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6F0E20)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB6F1100)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6F1110)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xB6F1180)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6F1200)
#define MOLEMOLE_UIROLETEAMROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xB6F1280)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleTeamRowWidgetController_TypeDefinitionIndex = 66521;

	class UIRoleTeamRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_8127D35606966C67_10* _view; // 0x2D0
