...
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS369_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBEE5B20)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS369_0__TRIGGERDECORATEEVENT_B__0_OFFSET UNITYSDK_OFFSET(0xBEE5B30)
#define MOLEMOLE_UICOMICPAGECONTROLLER___C__DISPLAYCLASS369_0__TRIGGERDECORATEEVENT_B__1_OFFSET UNITYSDK_OFFSET(0xBEE5B60)

namespace MoleMole
{
	inline static constexpr unsigned int UIComicPageController___c__DisplayClass369_0_TypeDefinitionIndex = 45640;
