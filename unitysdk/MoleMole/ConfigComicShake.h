...
#define MOLEMOLE_CONFIGCOMICSHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0x15ECA9F0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigComicShake_TypeDefinitionIndex = 69906;
