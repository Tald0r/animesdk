...
#define MOLEMOLE_CONFIGCOMICSHAKE__CTOR_OFFSET UNITYSDK_OFFSET(0xB5978B0)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigComicShake_TypeDefinitionIndex = 60240;
