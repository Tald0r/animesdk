...
#define MOLEMOLE_CONFIGUISTORECAMERA_KEYVALUEINFO_VIRCAMCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC1E8260)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigUIStoreCamera_KeyValueInfo_VirCamConfig_TypeDefinitionIndex = 58914;
