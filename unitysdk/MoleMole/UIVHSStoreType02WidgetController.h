...
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_GETPREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x95A8EE0)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x95A9510)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95A8AE0)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x95A8D90)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95A8E00)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95A8B80)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95A8CE0)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_SETCLICK_OFFSET UNITYSDK_OFFSET(0x95A94A0)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_SETINTERACTENABLE_OFFSET UNITYSDK_OFFSET(0x95A95A0)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_SETSELECTED_OFFSET UNITYSDK_OFFSET(0x95A9630)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_SETTAGID_OFFSET UNITYSDK_OFFSET(0x95A8F50)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_SETTAGLEVEL_OFFSET UNITYSDK_OFFSET(0x95A9190)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER_SETUNSELECTED_OFFSET UNITYSDK_OFFSET(0x95A96B0)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x95A9730)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER__ONUIINIT_B__1_0_OFFSET UNITYSDK_OFFSET(0x95A9760)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x95A9780)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER___BASE_ONUICLOSE_OFFSET UNITYSDK_OFFSET(0x95A97F0)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x95A9800)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x95A9880)
#define MOLEMOLE_UIVHSSTORETYPE02WIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x95A98E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIVHSStoreType02WidgetController_TypeDefinitionIndex = 73941;
