...
#define MOLEMOLE_VOLUMETRICCLOUDPROFILECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xEE6F9F0)

namespace MoleMole
{
	inline static constexpr unsigned int VolumetricCloudProfileContext_TypeDefinitionIndex = 55999;
