...
#define MOLEMOLE_UIGACHAREWARDLISTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0xD561DA0)
#define MOLEMOLE_UIGACHAREWARDLISTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__REFRESHMULTIPLEREWARDITEMS_B__0_OFFSET UNITYSDK_OFFSET(0xD561DB0)
#define MOLEMOLE_UIGACHAREWARDLISTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__REFRESHMULTIPLEREWARDITEMS_B__1_OFFSET UNITYSDK_OFFSET(0xD561DF0)
#define MOLEMOLE_UIGACHAREWARDLISTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__REFRESHMULTIPLEREWARDITEMS_B__3_OFFSET UNITYSDK_OFFSET(0xD562230)
#define MOLEMOLE_UIGACHAREWARDLISTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__REFRESHMULTIPLEREWARDITEMS_B__4_OFFSET UNITYSDK_OFFSET(0xD562370)
#define MOLEMOLE_UIGACHAREWARDLISTDIALOGPOPWINDOWCONTROLLER___C__DISPLAYCLASS23_0__REFRESHMULTIPLEREWARDITEMS_G__GETINTERVALBETWEENFADEINANDACTIVATE_2_OFFSET UNITYSDK_OFFSET(0xD562120)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaRewardListDialogPopWindowController___c__DisplayClass23_0_TypeDefinitionIndex = 68693;

	class UIGachaRewardListDialogPopWindowController___c__DisplayClass23_0 : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::Enum_3_D5E55949F51D9DD0, ::System::Single>* rarityToAnimInterval; // 0x10
		::MoleMole::UIGachaRewardListDialogPopWindowController* __4__this; // 0x18
		::System::Action* __9__4; // 0x20
		::System::Action* __9__3; // 0x28
		::UnityEngine::AnimationCurve* curve; // 0x30
		::MoleMole::ConfigUIGachaPage* config; // 0x38
		::System::Single totalTime; // 0x40
		::System::Int32 idx; // 0x44
		::System::Single firstItemAnimInterval; // 0x48
		::System::Single extraDelay; // 0x4C
