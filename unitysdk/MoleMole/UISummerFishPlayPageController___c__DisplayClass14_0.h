...
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER___C__DISPLAYCLASS14_0__CLOSEUI_B__0_OFFSET UNITYSDK_OFFSET(0xEE36660)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER___C__DISPLAYCLASS14_0__CLOSEUI_B__1_OFFSET UNITYSDK_OFFSET(0xEE368F0)
#define MOLEMOLE_UISUMMERFISHPLAYPAGECONTROLLER___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0xEE36650)

namespace MoleMole
{
	inline static constexpr unsigned int UISummerFishPlayPageController___c__DisplayClass14_0_TypeDefinitionIndex = 62772;
