...
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__CALCPATH_ASYNC_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3915D0)
#define MOLEMOLE_UIURBANMAPTRACKLINEWIDGETCONTEXT__CALCPATH_ASYNC_D__19_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapTrackLineWidgetContext__CalcPath_Async_d__19_TypeDefinitionIndex = 62891;
	...
	struct alignas(8) UIUrbanMapTrackLineWidgetContext__CalcPath_Async_d__19
	{
		...
		::System::Collections::Generic::List_1<::UnityEngine::Vector3>* paths; // 0x18
		::MoleMole::UIUrbanMapTrackLineWidgetContext* __4__this; // 0x20
