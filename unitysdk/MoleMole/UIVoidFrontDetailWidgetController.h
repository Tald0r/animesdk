...
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ISLEFTLIMIT_OFFSET UNITYSDK_OFFSET(0x8891740)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ISRIGHTLIMIT_OFFSET UNITYSDK_OFFSET(0x88917D0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONCLOSEBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x88903B0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x88915C0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONINFOBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x8890480)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONLEFTARROWBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x8890610)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONRIGHTARROWBTNCLICKHANDLE_OFFSET UNITYSDK_OFFSET(0x8890DC0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8891660)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x888FE20)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8890E60)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x8890F10)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_SETCLOSEACTION_OFFSET UNITYSDK_OFFSET(0x8890340)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_SETNODESTATE_OFFSET UNITYSDK_OFFSET(0x88907B0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_TRIGGERCLOSEBTN_OFFSET UNITYSDK_OFFSET(0x88913F0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER_UPDATEARROW_OFFSET UNITYSDK_OFFSET(0x8891050)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x88918A0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER__ONUIINIT_B__6_0_OFFSET UNITYSDK_OFFSET(0x88918D0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER__ONUIINIT_B__6_1_OFFSET UNITYSDK_OFFSET(0x88918E0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x88918F0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x8891960)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x88919E0)
#define MOLEMOLE_UIVOIDFRONTDETAILWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x8891A40)

namespace MoleMole
{
	inline static constexpr unsigned int UIVoidFrontDetailWidgetController_TypeDefinitionIndex = 43757;
	...
	public:
		...
		::Class_2_79AE422BA06F6D26_85* _view; // 0x2A0
