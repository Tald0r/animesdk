...
#define MOLEMOLE_CDN_DISPATCHDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6292F40)

namespace MoleMole
{
	inline static constexpr unsigned int CDN_DispatchData_TypeDefinitionIndex = 74187;
