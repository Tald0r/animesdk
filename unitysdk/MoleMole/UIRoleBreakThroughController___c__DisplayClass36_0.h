...
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x96EBF30)
#define MOLEMOLE_UIROLEBREAKTHROUGHCONTROLLER___C__DISPLAYCLASS36_0__REFRESHVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x96EBF40)

namespace MoleMole
{
	inline static constexpr unsigned int UIRoleBreakThroughController___c__DisplayClass36_0_TypeDefinitionIndex = 43136;

	class UIRoleBreakThroughController___c__DisplayClass36_0 : public ::System::Object
	{
	public:
		::Class_2_208CC9941471731A_216* advCurLvTempalte; // 0x10
		::MoleMole::UIRoleBreakThroughController* __4__this; // 0x18
		::Class_3_AE02BC8285203464_5* serverInfo; // 0x20
		::Class_2_208CC9941471731A_216* advNextLvTemplate; // 0x28
