...
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS52_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8A0FED0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS52_0__PLAYPICTURESTORYNODE_B__0_OFFSET UNITYSDK_OFFSET(0x8A0FEE0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS52_0__PLAYPICTURESTORYNODE_B__1_OFFSET UNITYSDK_OFFSET(0x8A0FF30)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS52_0__PLAYPICTURESTORYNODE_B__2_OFFSET UNITYSDK_OFFSET(0x8A0FF70)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS52_0__PLAYPICTURESTORYNODE_B__3_OFFSET UNITYSDK_OFFSET(0x8A102B0)
#define MOLEMOLE_UIGALGAMEPAGECONTROLLER___C__DISPLAYCLASS52_0__PLAYPICTURESTORYNODE_B__4_OFFSET UNITYSDK_OFFSET(0x8A0FF10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGalgamePageController___c__DisplayClass52_0_TypeDefinitionIndex = 54689;
	...
	public:
		...
		::Class_2_3ED3AB773B8AD4A7* textPlayNode; // 0x28
