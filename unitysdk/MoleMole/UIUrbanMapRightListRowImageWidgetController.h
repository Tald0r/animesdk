...
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWIMAGEWIDGETCONTROLLER_GET__VIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEE4BA80)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWIMAGEWIDGETCONTROLLER_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEE4BAF0)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWIMAGEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xEE4BBF0)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWIMAGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xEE4BDA0)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWIMAGEWIDGETCONTROLLER___BASE_ONCREATEVIEWMODEL_OFFSET UNITYSDK_OFFSET(0xEE4BDD0)
#define MOLEMOLE_UIURBANMAPRIGHTLISTROWIMAGEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xEE4BE40)

namespace MoleMole
{
	inline static constexpr unsigned int UIUrbanMapRightListRowImageWidgetController_TypeDefinitionIndex = 62294;
