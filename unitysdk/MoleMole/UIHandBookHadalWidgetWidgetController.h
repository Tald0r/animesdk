...
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCAEC3F0)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER_ONHIDE_OFFSET UNITYSDK_OFFSET(0xCAEC310)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER_ONSHOPBTNCLICK_OFFSET UNITYSDK_OFFSET(0xCAEC570)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCAEC0A0)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCAEC490)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCAEB5B0)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCAEB9B0)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xCAEC900)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER__ONUIINIT_B__2_0_OFFSET UNITYSDK_OFFSET(0xCAEC930)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER__ONUIINIT_B__2_1_OFFSET UNITYSDK_OFFSET(0xCAEC950)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER__ONUIINIT_B__2_2_OFFSET UNITYSDK_OFFSET(0xCAEC970)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER__ONUIINIT_B__2_3_OFFSET UNITYSDK_OFFSET(0xCAEC9A0)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER__ONUIINIT_B__2_4_OFFSET UNITYSDK_OFFSET(0xCAECA20)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xCAECAA0)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0xCAECB10)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xCAECB70)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xCAECBE0)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xCAECC60)
#define MOLEMOLE_UIHANDBOOKHADALWIDGETWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xCAECCC0)

namespace MoleMole
{
	inline static constexpr unsigned int UIHandBookHadalWidgetWidgetController_TypeDefinitionIndex = 71852;

	class UIHandBookHadalWidgetWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_40AE66977C898EB6* _view; // 0x2A0
		::Class_2_208CC9941471731A_187* _entry; // 0x2A8
