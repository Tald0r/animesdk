...
#define MOLEMOLE_EMPTYLAYOUTGROUP_GETCOLROW_OFFSET UNITYSDK_OFFSET(0xEC7AD20)
#define MOLEMOLE_EMPTYLAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xEC7AC60)
#define MOLEMOLE_EMPTYLAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0xEC7ACC0)
#define MOLEMOLE_EMPTYLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xEC7AD90)

namespace MoleMole
{
	inline static constexpr unsigned int EmptyLayoutGroup_TypeDefinitionIndex = 48555;
