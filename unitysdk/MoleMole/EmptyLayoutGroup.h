...
#define MOLEMOLE_EMPTYLAYOUTGROUP_GETCOLROW_OFFSET UNITYSDK_OFFSET(0xF198E00)
#define MOLEMOLE_EMPTYLAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xF198D40)
#define MOLEMOLE_EMPTYLAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0xF198DA0)
#define MOLEMOLE_EMPTYLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xF198E70)

namespace MoleMole
{
	inline static constexpr unsigned int EmptyLayoutGroup_TypeDefinitionIndex = 55518;
