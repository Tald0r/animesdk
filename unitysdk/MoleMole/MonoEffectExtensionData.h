...
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETBOOLDATA_OFFSET UNITYSDK_OFFSET(0xD0EDEF0)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETCOLORDATA_OFFSET UNITYSDK_OFFSET(0xD0EE110)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETFLOATDATA_OFFSET UNITYSDK_OFFSET(0xD0EDDD0)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETINTDATA_OFFSET UNITYSDK_OFFSET(0xD0EDCB0)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA_GETSTRINGDATA_OFFSET UNITYSDK_OFFSET(0xD0EE000)
#define MOLEMOLE_MONOEFFECTEXTENSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD0EE260)

namespace MoleMole
{
	inline static constexpr unsigned int MonoEffectExtensionData_TypeDefinitionIndex = 79674;
