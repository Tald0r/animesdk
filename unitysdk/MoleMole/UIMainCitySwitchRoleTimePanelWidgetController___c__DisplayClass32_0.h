...
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8ECA9D0)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___C__DISPLAYCLASS32_0__ONCLICKSENDTIME_B__0_OFFSET UNITYSDK_OFFSET(0x8ECA9E0)
#define MOLEMOLE_UIMAINCITYSWITCHROLETIMEPANELWIDGETCONTROLLER___C__DISPLAYCLASS32_0__ONCLICKSENDTIME_G__ONMODTIMERSP_1_OFFSET UNITYSDK_OFFSET(0x8ECAB20)

namespace MoleMole
{
	inline static constexpr unsigned int UIMainCitySwitchRoleTimePanelWidgetController___c__DisplayClass32_0_TypeDefinitionIndex = 67590;
