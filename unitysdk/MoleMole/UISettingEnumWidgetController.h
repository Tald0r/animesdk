...
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0xB6F3970)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xB6F2040)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6F1D80)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_ONDROPDOWNCHANGE_OFFSET UNITYSDK_OFFSET(0xB6F34E0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_ONDYNAMICTIPSCLOSE_OFFSET UNITYSDK_OFFSET(0xB6F37C0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_ONSETTINGONUIDISABLESTATECHANGED_OFFSET UNITYSDK_OFFSET(0xB6F38A0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6F21B0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB6F1E20)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_OPENDROPDOWNSELECT_OFFSET UNITYSDK_OFFSET(0xB6F2840)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_REFRESHNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0xB6F26B0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_REFRESHSETTINGONUIDISABLESTATE_OFFSET UNITYSDK_OFFSET(0xB6F2290)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0xB6F2470)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xB6F39E0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER__ONDROPDOWNCHANGE_B__10_0_OFFSET UNITYSDK_OFFSET(0xB6F3BB0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0xB6F3AD0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER__ONUIOPEN_B__2_1_OFFSET UNITYSDK_OFFSET(0xB6F3B40)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xB6F3D60)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xB6F3DD0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xB6F3CF0)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingEnumWidgetController_TypeDefinitionIndex = 61245;

	class UISettingEnumWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_4ADD0419C7E71A92_2* _view; // 0x2A0
		::MoleMole::UIGeneralDynamicTipsPopWindowController* _dropdownSelect; // 0x2A8
		::System::Collections::Generic::List_1<::Struct_2_037D21AC29ED1130>* dropList; // 0x2B0
		::System::Boolean _isSettingOnUIDisable; // 0x2B8
		::MoleMole::ESystemSettingType _settingType; // 0x2BC
		::Enum_3_543B6B88E17BAFE0 _settingContentType; // 0x2C0
		::System::Int32 _hintVersion; // 0x2C4
		::System::Int32 _parentLayer; // 0x2C8
		::System::Boolean _isFromLoginPage; // 0x2CC
		::System::Int32 maxHeight; // 0x2D0
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Int32>* _dropDownIndexMap; // 0x2D8
		...
		::Class_2_4ADD0419C7E71A92_2* GetView()
		{
			return ((::Class_2_4ADD0419C7E71A92_2*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_GETVIEW_OFFSET))(this);
		}
