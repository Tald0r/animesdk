...
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_GETVIEW_OFFSET UNITYSDK_OFFSET(0x9A0C540)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0x9A0ACB0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A0AA20)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_ONDROPDOWNCHANGE_OFFSET UNITYSDK_OFFSET(0x9A0C0B0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_ONDYNAMICTIPSCLOSE_OFFSET UNITYSDK_OFFSET(0x9A0C390)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_ONSETTINGONUIDISABLESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x9A0C470)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A0AE20)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9A0AAC0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_OPENDROPDOWNSELECT_OFFSET UNITYSDK_OFFSET(0x9A0B4A0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_REFRESHNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x9A0B310)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_REFRESHSETTINGONUIDISABLESTATE_OFFSET UNITYSDK_OFFSET(0x9A0AF00)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER_REFRESHVIEW_OFFSET UNITYSDK_OFFSET(0x9A0B0E0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9A0C5B0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER__ONDROPDOWNCHANGE_B__10_0_OFFSET UNITYSDK_OFFSET(0x9A0C710)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER__ONUIOPEN_B__2_0_OFFSET UNITYSDK_OFFSET(0x9A0C6A0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x9A0C8D0)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x9A0C940)
#define MOLEMOLE_UISETTINGENUMWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x9A0C860)

namespace MoleMole
{
	inline static constexpr unsigned int UISettingEnumWidgetController_TypeDefinitionIndex = 51191;
