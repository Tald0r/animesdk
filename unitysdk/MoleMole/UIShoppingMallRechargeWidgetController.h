...
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_GET_GOODS_OFFSET UNITYSDK_OFFSET(0xDF390B0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_GET_SHOPPINGMALLRECHARGEWIDGET_MODULE_OFFSET UNITYSDK_OFFSET(0xDF39030)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xDF39180)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONCLICKGOODS_OFFSET UNITYSDK_OFFSET(0xDF39B80)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF396A0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONCUSTOMERBTN_OFFSET UNITYSDK_OFFSET(0xDF39A60)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDF39740)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF39980)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF390D0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF395F0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0xDF39870)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_REGISTERONCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xDF39C00)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_SET_GOODS_OFFSET UNITYSDK_OFFSET(0xDF390C0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xDF39C70)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER__INITVIEW_B__14_0_OFFSET UNITYSDK_OFFSET(0xDF39D10)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xDF39D80)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xDF39DF0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xDF39E60)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xDF39EE0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xDF39F40)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallRechargeWidgetController_TypeDefinitionIndex = 74515;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_133*>* _Goods_k__BackingField; // 0x2B8
		...
		{
			return ((::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_133*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_GET_GOODS_OFFSET))(this);
		}

		::System::Void set_Goods(::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_133*>* value)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_133*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_SET_GOODS_OFFSET))(this, value);
		}
