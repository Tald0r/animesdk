...
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_GET_GOODS_OFFSET UNITYSDK_OFFSET(0xD6C9EA0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_GET_SHOPPINGMALLRECHARGEWIDGET_MODULE_OFFSET UNITYSDK_OFFSET(0xD6C9E20)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_INITVIEW_OFFSET UNITYSDK_OFFSET(0xD6C9F70)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONCLICKGOODS_OFFSET UNITYSDK_OFFSET(0xD6CA970)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD6CA490)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONCUSTOMERBTN_OFFSET UNITYSDK_OFFSET(0xD6CA850)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD6CA530)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD6CA770)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD6C9EC0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD6CA3E0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_REFRESHUI_OFFSET UNITYSDK_OFFSET(0xD6CA660)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_REGISTERONCLICKCALLBACK_OFFSET UNITYSDK_OFFSET(0xD6CA9F0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_SET_GOODS_OFFSET UNITYSDK_OFFSET(0xD6C9EB0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6CAA60)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER__INITVIEW_B__14_0_OFFSET UNITYSDK_OFFSET(0xD6CAB10)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xD6CAB80)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0xD6CABF0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xD6CAC60)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xD6CACE0)
#define MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xD6CAD40)

namespace MoleMole
{
	inline static constexpr unsigned int UIShoppingMallRechargeWidgetController_TypeDefinitionIndex = 42814;

	class UIShoppingMallRechargeWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_AE41256FA9D2870F* _view; // 0x2A0
		::MonoUITableScrollV2* _Goods_ScrollView; // 0x2A8
		::System::Action_1<::System::Int32>* _onClick; // 0x2B0
		::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_187*>* _Goods_k__BackingField; // 0x2B8
		...
		{
			return ((::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_187*>*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_GET_GOODS_OFFSET))(this);
		}

		::System::Void set_Goods(::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_187*>* value)
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_187*>*))((::PBYTE)hIl2Cpp + MOLEMOLE_UISHOPPINGMALLRECHARGEWIDGETCONTROLLER_SET_GOODS_OFFSET))(this, value);
		}
