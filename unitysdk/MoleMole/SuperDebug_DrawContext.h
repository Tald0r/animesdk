...
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT_APPENDLINE_OFFSET UNITYSDK_OFFSET(0x19F12890)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x19F12800)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT_DRAW_OFFSET UNITYSDK_OFFSET(0x19F12B20)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT_GET_OFFSET UNITYSDK_OFFSET(0x19F127A0)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT_WITHCOLOR_OFFSET UNITYSDK_OFFSET(0x19F12A90)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT_WITHWORLDPOS_OFFSET UNITYSDK_OFFSET(0x19F12A00)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F12B80)
#define MOLEMOLE_SUPERDEBUG_DRAWCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F12790)

namespace MoleMole
{
	inline static constexpr unsigned int SuperDebug_DrawContext_TypeDefinitionIndex = 8234;
	...
	public:
		...
		{
			return (::MoleMole::SuperDebug_DrawContext**)Il2CppClass::FromTypeDefinitionIndex(SuperDebug_DrawContext_TypeDefinitionIndex)->GetStaticField(0x7070);
		}
		::System::String* text; // 0x10
		::System::Nullable_1<::UnityEngine::Color> color; // 0x18
		::UnityEngine::Vector3 worldPos; // 0x2C
