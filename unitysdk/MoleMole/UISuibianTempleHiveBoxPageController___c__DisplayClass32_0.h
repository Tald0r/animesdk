...
#define MOLEMOLE_UISUIBIANTEMPLEHIVEBOXPAGECONTROLLER___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9364610)
#define MOLEMOLE_UISUIBIANTEMPLEHIVEBOXPAGECONTROLLER___C__DISPLAYCLASS32_0__ONITEMMULTICLICK_B__0_OFFSET UNITYSDK_OFFSET(0x93691B0)

namespace MoleMole
{
	inline static constexpr unsigned int UISuibianTempleHiveBoxPageController___c__DisplayClass32_0_TypeDefinitionIndex = 46567;

	class UISuibianTempleHiveBoxPageController___c__DisplayClass32_0 : public ::System::Object
	{
	public:
		::Class_3_C3F0E3B5AB5977AE_23* buddyGood; // 0x10
