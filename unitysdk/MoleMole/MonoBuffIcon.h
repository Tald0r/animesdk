...
#define MOLEMOLE_MONOBUFFICON_ENABLENUMBERTEXT_OFFSET UNITYSDK_OFFSET(0x6E38EC0)
#define MOLEMOLE_MONOBUFFICON_GETISMORE_OFFSET UNITYSDK_OFFSET(0x6E3A120)
#define MOLEMOLE_MONOBUFFICON_GET_BUFFID_OFFSET UNITYSDK_OFFSET(0x6E37F40)
#define MOLEMOLE_MONOBUFFICON_GET_BUFFNUMBER_OFFSET UNITYSDK_OFFSET(0x6E37F50)
#define MOLEMOLE_MONOBUFFICON_INTERRUPT_OFFSET UNITYSDK_OFFSET(0x6E3A0B0)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_06330CD58CB602B6_OFFSET UNITYSDK_OFFSET(0x6E3B850)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_20E8013D4AB67E17_OFFSET UNITYSDK_OFFSET(0x6E39310)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_2C1C2A8E63DB0F10_OFFSET UNITYSDK_OFFSET(0x6E3B2F0)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_6055A93732CC885D_OFFSET UNITYSDK_OFFSET(0x6E3AC30)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_61113270C4B9E4F4_OFFSET UNITYSDK_OFFSET(0x6E38B70)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_655DDB722F1FDE73_OFFSET UNITYSDK_OFFSET(0x6E39010)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_7849F7E288B51663_OFFSET UNITYSDK_OFFSET(0x6E3B3B0)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_7D9FB684EF17D12D_OFFSET UNITYSDK_OFFSET(0x6E39D80)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x6E3B7B0)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_97D83E4CB3B11935_OFFSET UNITYSDK_OFFSET(0x6E39ED0)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_98CD66A7F3C102A5_OFFSET UNITYSDK_OFFSET(0x6E3A570)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_C114A1F8E08B6F92_1_OFFSET UNITYSDK_OFFSET(0x6E3B840)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x6E3B830)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_F79D5EC57FBF426E_OFFSET UNITYSDK_OFFSET(0x6E397D0)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_F978A1D172468895_OFFSET UNITYSDK_OFFSET(0x6E3AD80)
#define MOLEMOLE_MONOBUFFICON_METHOD_6_FC5102551AF3CB1A_OFFSET UNITYSDK_OFFSET(0x6E3AB30)
#define MOLEMOLE_MONOBUFFICON_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6E3B170)
#define MOLEMOLE_MONOBUFFICON_ONREMOVE_OFFSET UNITYSDK_OFFSET(0x6E399A0)
#define MOLEMOLE_MONOBUFFICON_REFRESHNUMBER_OFFSET UNITYSDK_OFFSET(0x6E3B020)
#define MOLEMOLE_MONOBUFFICON_REPLACEBUFFIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x6E3A360)
#define MOLEMOLE_MONOBUFFICON_RESETNUMBER_OFFSET UNITYSDK_OFFSET(0x6E3B090)
#define MOLEMOLE_MONOBUFFICON_SETCUSTOMNUM_OFFSET UNITYSDK_OFFSET(0x6E3B100)
#define MOLEMOLE_MONOBUFFICON_SETUPMORESTATE_OFFSET UNITYSDK_OFFSET(0x6E396A0)
#define MOLEMOLE_MONOBUFFICON_SETUPVIEW_OFFSET UNITYSDK_OFFSET(0x6E37F60)
#define MOLEMOLE_MONOBUFFICON_SWITCHTOBUFF_OFFSET UNITYSDK_OFFSET(0x6E3A180)
#define MOLEMOLE_MONOBUFFICON_TICK_OFFSET UNITYSDK_OFFSET(0x6E3A7B0)
#define MOLEMOLE_MONOBUFFICON__CCTOR_OFFSET UNITYSDK_OFFSET(0x6E3B2A0)
#define MOLEMOLE_MONOBUFFICON__CTOR_OFFSET UNITYSDK_OFFSET(0x6E3B1F0)
#define MOLEMOLE_MONOBUFFICON___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6E3B2E0)

namespace MoleMole
{
	inline static constexpr unsigned int MonoBuffIcon_TypeDefinitionIndex = 62370;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoBuffIcon_TypeDefinitionIndex)->GetStaticField(0xA260);
		}
		static ::System::Int32* StaticGet_MULTIPLE_ROW_BUFF_ICON_MAX()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoBuffIcon_TypeDefinitionIndex)->GetStaticField(0xA264);
		}
		...
		::System::Void ReplaceBuffImmediate(::System::Int32 a1, ::System::Boolean a2)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::System::Boolean))((::PBYTE)hIl2Cpp + MOLEMOLE_MONOBUFFICON_REPLACEBUFFIMMEDIATE_OFFSET))(this, a1, a2);
		}
