...
#define MOLEMOLE_MONOINTERACTIONPOINT_AWAKE_OFFSET UNITYSDK_OFFSET(0xC3218B0)
#define MOLEMOLE_MONOINTERACTIONPOINT_DISTANCE2D_OFFSET UNITYSDK_OFFSET(0xC3216F0)
#define MOLEMOLE_MONOINTERACTIONPOINT_DISTANCESQ2D_OFFSET UNITYSDK_OFFSET(0xC320FE0)
#define MOLEMOLE_MONOINTERACTIONPOINT_GETINTERACTIONPOINTBYNAME_OFFSET UNITYSDK_OFFSET(0xC3207E0)
#define MOLEMOLE_MONOINTERACTIONPOINT_GETNEARESTINTERACTIONPOINT_OFFSET UNITYSDK_OFFSET(0xC320250)
#define MOLEMOLE_MONOINTERACTIONPOINT_GETPATHTOTARGETPOINT_OFFSET UNITYSDK_OFFSET(0xC320950)
#define MOLEMOLE_MONOINTERACTIONPOINT_GETREACHABLENEARESTINTERACTIONPOINT_OFFSET UNITYSDK_OFFSET(0xC320A40)
#define MOLEMOLE_MONOINTERACTIONPOINT_METHOD_5_93EFC2EFF979B1FC_OFFSET UNITYSDK_OFFSET(0xC321090)
#define MOLEMOLE_MONOINTERACTIONPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0xC321A90)

namespace MoleMole
{
	inline static constexpr unsigned int MonoInteractionPoint_TypeDefinitionIndex = 43674;
