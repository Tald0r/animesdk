...
#define MOLEMOLE_SETBOOLPARAMETER__RESETVALUE_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8F3E200)
#define MOLEMOLE_SETBOOLPARAMETER__RESETVALUE_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8F3E2B0)
#define MOLEMOLE_SETBOOLPARAMETER__RESETVALUE_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8F3E310)
#define MOLEMOLE_SETBOOLPARAMETER__RESETVALUE_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8F3E2C0)
#define MOLEMOLE_SETBOOLPARAMETER__RESETVALUE_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F3E1F0)
#define MOLEMOLE_SETBOOLPARAMETER__RESETVALUE_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0x8F3E1E0)

namespace MoleMole
{
	inline static constexpr unsigned int SetBoolParameter__ResetValue_d__11_TypeDefinitionIndex = 53060;
