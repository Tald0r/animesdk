...
#define MOLEMOLE_CONFIGTIMELINECAMERA_CAMERACURVEGROUP_GETCURVEDICT_OFFSET UNITYSDK_OFFSET(0xE0D4B90)
#define MOLEMOLE_CONFIGTIMELINECAMERA_CAMERACURVEGROUP_GETCURVE_OFFSET UNITYSDK_OFFSET(0xE0D4DF0)
#define MOLEMOLE_CONFIGTIMELINECAMERA_CAMERACURVEGROUP_SETCURVE_OFFSET UNITYSDK_OFFSET(0xE0D4EE0)
#define MOLEMOLE_CONFIGTIMELINECAMERA_CAMERACURVEGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xE0D5050)

namespace MoleMole
{
	inline static constexpr unsigned int ConfigTimelineCamera_CameraCurveGroup_TypeDefinitionIndex = 52507;
