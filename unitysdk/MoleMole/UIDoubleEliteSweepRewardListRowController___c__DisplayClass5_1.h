...
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER___C__DISPLAYCLASS5_1__CTOR_OFFSET UNITYSDK_OFFSET(0xA273140)
#define MOLEMOLE_UIDOUBLEELITESWEEPREWARDLISTROWCONTROLLER___C__DISPLAYCLASS5_1__ONSCROLLITEMUPDATE_B__0_OFFSET UNITYSDK_OFFSET(0xA273150)

namespace MoleMole
{
	inline static constexpr unsigned int UIDoubleEliteSweepRewardListRowController___c__DisplayClass5_1_TypeDefinitionIndex = 60550;

	class UIDoubleEliteSweepRewardListRowController___c__DisplayClass5_1 : public ::System::Object
	{
	public:
		::MoleMole::UIDoubleEliteSweepRewardListRowController___c__DisplayClass5_0* CS___8__locals1; // 0x10
		::MoleMole::UIItemIconBtnWidgetController* itemController; // 0x18
