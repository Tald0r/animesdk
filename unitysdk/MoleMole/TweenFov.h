...
#define MOLEMOLE_TWEENFOV_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xD390980)
#define MOLEMOLE_TWEENFOV_METHOD_7_F4409EB364C7E276_OFFSET UNITYSDK_OFFSET(0xD390A30)
#define MOLEMOLE_TWEENFOV_METHOD_7_FE1A1A30B3CE9C46_OFFSET UNITYSDK_OFFSET(0xD390B90)
#define MOLEMOLE_TWEENFOV_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xD390990)
#define MOLEMOLE_TWEENFOV__CTOR_OFFSET UNITYSDK_OFFSET(0xD390CC0)
#define MOLEMOLE_TWEENFOV___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xD390CE0)

namespace MoleMole
{
	inline static constexpr unsigned int TweenFov_TypeDefinitionIndex = 67858;
	...
	public:
		...
		::UnityEngine::Camera* Method_7_F4409EB364C7E276()
		{
			return ((::UnityEngine::Camera*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_TWEENFOV_METHOD_7_F4409EB364C7E276_OFFSET))(this);
		}
	};
}
