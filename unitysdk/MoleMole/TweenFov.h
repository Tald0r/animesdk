...
#define MOLEMOLE_TWEENFOV_GET_VALUE_OFFSET UNITYSDK_OFFSET(0xD471BC0)
#define MOLEMOLE_TWEENFOV_METHOD_7_F4409EB364C7E276_OFFSET UNITYSDK_OFFSET(0xD471C70)
#define MOLEMOLE_TWEENFOV_METHOD_7_FE1A1A30B3CE9C46_OFFSET UNITYSDK_OFFSET(0xD471DD0)
#define MOLEMOLE_TWEENFOV_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xD471BD0)
#define MOLEMOLE_TWEENFOV__CTOR_OFFSET UNITYSDK_OFFSET(0xD471F00)
#define MOLEMOLE_TWEENFOV___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0xD471F20)

namespace MoleMole
{
	inline static constexpr unsigned int TweenFov_TypeDefinitionIndex = 38585;
