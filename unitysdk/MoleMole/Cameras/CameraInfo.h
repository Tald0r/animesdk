...
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_CORRECTEDORIENTATION_OFFSET UNITYSDK_OFFSET(0x2D07D0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_CORRECTEDPOSITION_OFFSET UNITYSDK_OFFSET(0x2D0760)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_FINALORIENTATION_OFFSET UNITYSDK_OFFSET(0x2D07D0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_FINALPOSITION_OFFSET UNITYSDK_OFFSET(0x2D0760)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_ORIENTATIONCORRECTION_OFFSET UNITYSDK_OFFSET(0x2D07B0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_POSITIONCORRECTION_OFFSET UNITYSDK_OFFSET(0x2D0730)
#define MOLEMOLE_CAMERAS_CAMERAINFO_GET_RAWORIENTATION_OFFSET UNITYSDK_OFFSET(0x2D0790)
#define MOLEMOLE_CAMERAS_CAMERAINFO_METHOD_2_DB077F204DC28C2A_OFFSET UNITYSDK_OFFSET(0x2D08C0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_SET_ORIENTATIONCORRECTION_OFFSET UNITYSDK_OFFSET(0x2D07C0)
#define MOLEMOLE_CAMERAS_CAMERAINFO_SET_POSITIONCORRECTION_OFFSET UNITYSDK_OFFSET(0x2D0750)
#define MOLEMOLE_CAMERAS_CAMERAINFO_SET_RAWORIENTATION_OFFSET UNITYSDK_OFFSET(0x2D07A0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraInfo_TypeDefinitionIndex = 47906;
