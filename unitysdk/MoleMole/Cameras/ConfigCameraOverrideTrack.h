...
#define MOLEMOLE_CAMERAS_CONFIGCAMERAOVERRIDETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x6D33F50)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int ConfigCameraOverrideTrack_TypeDefinitionIndex = 72740;
