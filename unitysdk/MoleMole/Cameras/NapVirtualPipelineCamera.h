...
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_CANCELBLENDINGREQUEST_OFFSET UNITYSDK_OFFSET(0xB079880)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_CANCELBLENDING_OFFSET UNITYSDK_OFFSET(0xB0796F0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_CREATEDEFAULTCOLLISIONFILTER_OFFSET UNITYSDK_OFFSET(0xB079470)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_GETLASTCAMERADATA_OFFSET UNITYSDK_OFFSET(0xB078DA0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_GETLATESTCAMERADATA_OFFSET UNITYSDK_OFFSET(0xB078F20)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_GETSEQUENCEPLAYER_OFFSET UNITYSDK_OFFSET(0xB078420)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_GETSUCCESSOR_OFFSET UNITYSDK_OFFSET(0xB079AD0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_GET_FOLLOW_OFFSET UNITYSDK_OFFSET(0xB076290)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_GET_LOOKAT_OFFSET UNITYSDK_OFFSET(0xB0762B0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_GET_STATE_OFFSET UNITYSDK_OFFSET(0xB0762D0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_HANDLECAMERACOMMAND_OFFSET UNITYSDK_OFFSET(0xB078C70)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_INITCAMERADATA_OFFSET UNITYSDK_OFFSET(0xB0784B0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_INTERNALUPDATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0xB076B30)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_ISBLENDINGREQUIRED_OFFSET UNITYSDK_OFFSET(0xB079A70)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_ISBLENDING_OFFSET UNITYSDK_OFFSET(0xB079A10)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_METHOD_6_21D8228E44360CE8_OFFSET UNITYSDK_OFFSET(0xB07A570)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_METHOD_6_2AEFBD4752A5BFC4_OFFSET UNITYSDK_OFFSET(0xB079D20)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_METHOD_6_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xB0785A0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_METHOD_6_67EE00D0D5156D71_OFFSET UNITYSDK_OFFSET(0xB0776A0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_METHOD_6_9F909151486A4615_OFFSET UNITYSDK_OFFSET(0xB079D50)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_METHOD_6_C4D99CFCA628428A_OFFSET UNITYSDK_OFFSET(0xB07A0C0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_METHOD_6_FEED647D1A65D14D_OFFSET UNITYSDK_OFFSET(0xB07A600)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_METHOD_6_FF43F2BFE9E826AA_OFFSET UNITYSDK_OFFSET(0xB07A290)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB076900)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB076300)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_ONSTARTNEWGAME_OFFSET UNITYSDK_OFFSET(0xB0782D0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_ONSWITCHTONEWSTAGE_OFFSET UNITYSDK_OFFSET(0xB0783A0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0xB077C70)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_SET_FOLLOW_OFFSET UNITYSDK_OFFSET(0xB0762A0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_SET_LOOKAT_OFFSET UNITYSDK_OFFSET(0xB0762C0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA__CCTOR_OFFSET UNITYSDK_OFFSET(0xB0790C0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xB079B80)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xB079C70)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB079CC0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA___BASE_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0xB079CD0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int NapVirtualPipelineCamera_TypeDefinitionIndex = 77102;

	class NapVirtualPipelineCamera : public ::Cinemachine::CinemachineVirtualCameraBase
	{
	public:
		::PipelineCamera::ICameraController_1<::Class_0_16E4307DCC419505_632*>* Field_6_0; // 0x68
		::System::Boolean Field_6_1; // 0x70
		::Class_0_16E4307DCC419505_632* Field_6_2; // 0x78
		...
		::System::Void InitCameraData(::Class_0_16E4307DCC419505_632* a1, ::MoleMole::Cameras::NapVirtual3DActionCamera_1* a2)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_632*, ::MoleMole::Cameras::NapVirtual3DActionCamera_1*))((::PBYTE)hIl2Cpp + MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_INITCAMERADATA_OFFSET))(this, a1, a2);
		}
		...
		::Class_0_16E4307DCC419505_193* GetSuccessor()
		{
			return ((::Class_0_16E4307DCC419505_193*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_CAMERAS_NAPVIRTUALPIPELINECAMERA_GETSUCCESSOR_OFFSET))(this);
		}
