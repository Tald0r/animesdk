...
#define MOLEMOLE_CAMERAS_CAMERATRACKBLENDING_CAMERATRACKBLENDING_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0xCCEA080)
#define MOLEMOLE_CAMERAS_CAMERATRACKBLENDING_CAMERATRACKBLENDING_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0xCCEA090)
#define MOLEMOLE_CAMERAS_CAMERATRACKBLENDING_CAMERATRACKBLENDING_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0xCCEA290)
#define MOLEMOLE_CAMERAS_CAMERATRACKBLENDING_CAMERATRACKBLENDING_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0xCCEA450)
#define MOLEMOLE_CAMERAS_CAMERATRACKBLENDING_CAMERATRACKBLENDING_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0xCCEA410)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraTrackBlending_CameraTrackBlending_UnityGeneratedFormatter_TypeDefinitionIndex = 51034;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(CameraTrackBlending_CameraTrackBlending_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2F560);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Single>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(CameraTrackBlending_CameraTrackBlending_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x2F568);
		}
