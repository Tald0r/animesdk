...
#define MOLEMOLE_CAMERAS_TOPVIEWCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xE2AC6C0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int TopViewCameraConfig_TypeDefinitionIndex = 50497;
