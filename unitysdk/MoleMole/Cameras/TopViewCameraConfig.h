...
#define MOLEMOLE_CAMERAS_TOPVIEWCAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x15E9A870)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int TopViewCameraConfig_TypeDefinitionIndex = 42476;
