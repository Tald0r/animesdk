...
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_GET_CURRENTSPEED_OFFSET UNITYSDK_OFFSET(0x3431F0)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_34EFA4157E7AE41F_OFFSET UNITYSDK_OFFSET(0x3433C0)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_3735E71D7B6AFF5B_OFFSET UNITYSDK_OFFSET(0x343320)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_4F602D3B9C6B3EFC_OFFSET UNITYSDK_OFFSET(0x3432F0)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_705AF43C01ED360A_OFFSET UNITYSDK_OFFSET(0x343260)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x3433D0)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_D4CA10FD0FCC33BB_1_OFFSET UNITYSDK_OFFSET(0x343310)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_D4CA10FD0FCC33BB_OFFSET UNITYSDK_OFFSET(0x343300)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x343200)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VCameraAxisState_TypeDefinitionIndex = 62214;
