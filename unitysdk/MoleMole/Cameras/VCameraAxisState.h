...
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_GET_CURRENTSPEED_OFFSET UNITYSDK_OFFSET(0x3FA490)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_34EFA4157E7AE41F_OFFSET UNITYSDK_OFFSET(0x3FA610)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_3735E71D7B6AFF5B_OFFSET UNITYSDK_OFFSET(0x3FA630)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_4F602D3B9C6B3EFC_OFFSET UNITYSDK_OFFSET(0x3FA620)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_705AF43C01ED360A_OFFSET UNITYSDK_OFFSET(0x3FA580)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x3FA510)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_D4CA10FD0FCC33BB_1_OFFSET UNITYSDK_OFFSET(0x3FA6D0)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_D4CA10FD0FCC33BB_OFFSET UNITYSDK_OFFSET(0x3FA500)
#define MOLEMOLE_CAMERAS_VCAMERAAXISSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x3FA4A0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VCameraAxisState_TypeDefinitionIndex = 53915;
	...
	struct alignas(4) VCameraAxisState
	{
		...
		{
			return ((::System::Single(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_D4CA10FD0FCC33BB_OFFSET))(this);
		}
		...
		::System::Single Method_2_D4CA10FD0FCC33BB_1()
		{
			return ((::System::Single(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_CAMERAS_VCAMERAAXISSTATE_METHOD_2_D4CA10FD0FCC33BB_1_OFFSET))(this);
		}
	};
}
