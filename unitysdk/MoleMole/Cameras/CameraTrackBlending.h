...
#define MOLEMOLE_CAMERAS_CAMERATRACKBLENDING_GENERATEBLENDERBUILDER_OFFSET UNITYSDK_OFFSET(0xB076080)
#define MOLEMOLE_CAMERAS_CAMERATRACKBLENDING_GENERATEBLENDER_OFFSET UNITYSDK_OFFSET(0xB075F30)
#define MOLEMOLE_CAMERAS_CAMERATRACKBLENDING_GENERATECUTBUILDER_OFFSET UNITYSDK_OFFSET(0xB075D20)
#define MOLEMOLE_CAMERAS_CAMERATRACKBLENDING__CTOR_OFFSET UNITYSDK_OFFSET(0xB076260)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraTrackBlending_TypeDefinitionIndex = 79639;
