...
#define MOLEMOLE_CAMERAS_PLANECAMERACONFIG_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0xC320B60)
#define MOLEMOLE_CAMERAS_PLANECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC320BF0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int PlaneCameraConfig_TypeDefinitionIndex = 46995;
