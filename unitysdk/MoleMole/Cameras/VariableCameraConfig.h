...
#define MOLEMOLE_CAMERAS_VARIABLECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9BA8C10)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VariableCameraConfig_TypeDefinitionIndex = 72358;
