...
#define MOLEMOLE_CAMERAS_VARIABLECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xC3210C0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VariableCameraConfig_TypeDefinitionIndex = 41950;
