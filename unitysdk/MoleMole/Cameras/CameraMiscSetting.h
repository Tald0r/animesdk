...
#define MOLEMOLE_CAMERAS_CAMERAMISCSETTING_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xE2A6600)
#define MOLEMOLE_CAMERAS_CAMERAMISCSETTING_LERP_OFFSET UNITYSDK_OFFSET(0xE2A6490)
#define MOLEMOLE_CAMERAS_CAMERAMISCSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xE2A65F0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraMiscSetting_TypeDefinitionIndex = 50364;
