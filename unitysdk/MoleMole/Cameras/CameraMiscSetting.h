...
#define MOLEMOLE_CAMERAS_CAMERAMISCSETTING_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0xB49CBF0)
#define MOLEMOLE_CAMERAS_CAMERAMISCSETTING_LERP_OFFSET UNITYSDK_OFFSET(0xB49CA80)
#define MOLEMOLE_CAMERAS_CAMERAMISCSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0xB49CBE0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraMiscSetting_TypeDefinitionIndex = 65991;
