...
#define MOLEMOLE_CAMERAS_VCAMERASLAYOUTCALCULATOR_SETTLELAYOUT_1_OFFSET UNITYSDK_OFFSET(0xCAC7240)
#define MOLEMOLE_CAMERAS_VCAMERASLAYOUTCALCULATOR_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0xCAC7180)
#define MOLEMOLE_CAMERAS_VCAMERASLAYOUTCALCULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0xCAC7350)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VCamerasLayoutCalculator_TypeDefinitionIndex = 62447;
