...
#define MOLEMOLE_CAMERAS_VSIGNALSOURCEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x6BDD750)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VSignalSourceAsset_TypeDefinitionIndex = 46299;
