...
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_FORCEDESTROY_OFFSET UNITYSDK_OFFSET(0x6FBC4F0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_GET_CAMMODULESHOT_OFFSET UNITYSDK_OFFSET(0x6FBB300)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_GET_FOLLOW_OFFSET UNITYSDK_OFFSET(0x6FBB2A0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_GET_LOOKAT_OFFSET UNITYSDK_OFFSET(0x6FBB2C0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_GET_STATE_OFFSET UNITYSDK_OFFSET(0x6FBB2E0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_INITCAMERADATA_OFFSET UNITYSDK_OFFSET(0x6FBC730)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_INTERNALUPDATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x6FBB310)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_METHOD_6_04577AC5AE05B41B_OFFSET UNITYSDK_OFFSET(0x6FBBD20)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_METHOD_6_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x6FBCDE0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_METHOD_6_28F3459B67DFCFFF_OFFSET UNITYSDK_OFFSET(0x6FBBBE0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_METHOD_6_BD67A279F5B78C9A_OFFSET UNITYSDK_OFFSET(0x6FBBB20)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_METHOD_6_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x6FBBE90)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_METHOD_6_E7EF6BC52B28648C_OFFSET UNITYSDK_OFFSET(0x6FBC7E0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6FBC690)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x6FBC1E0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x6FBC170)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_ONSTARTNEWGAME_OFFSET UNITYSDK_OFFSET(0x6FBC940)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_ONSWITCHTONEWSTAGE_OFFSET UNITYSDK_OFFSET(0x6FBC9D0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0x6FBBEF0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_ONTRANSITIONTOOTHER_OFFSET UNITYSDK_OFFSET(0x6FBCAD0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_SET_FOLLOW_OFFSET UNITYSDK_OFFSET(0x6FBB2B0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_SET_LOOKAT_OFFSET UNITYSDK_OFFSET(0x6FBB2D0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x6FBCB80)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6FBCCE0)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x6FBCD30)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x6FBCD80)
#define MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA___BASE_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0x6FBCD90)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int NapVirtualCutSceneCamera_TypeDefinitionIndex = 50394;
	...
	public:
		...
		::MoleMole::CameraModuleAvatarDataConfigExt* Method_6_BD67A279F5B78C9A()
		{
			return ((::MoleMole::CameraModuleAvatarDataConfigExt*(*)(::PVOID))((::PBYTE)hIl2Cpp + MOLEMOLE_CAMERAS_NAPVIRTUALCUTSCENECAMERA_METHOD_6_BD67A279F5B78C9A_OFFSET))(this);
		}
