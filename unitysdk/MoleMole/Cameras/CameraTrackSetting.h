...
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9CD8410)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_ISNEARLYEQUAL_OFFSET UNITYSDK_OFFSET(0x9CD7E70)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_ISVALID_OFFSET UNITYSDK_OFFSET(0x9CD75F0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_LERP_OFFSET UNITYSDK_OFFSET(0x9CD7680)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__CCTOR_OFFSET UNITYSDK_OFFSET(0x9CD84F0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x9CD7DD0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__ISNEARLYEQUAL_G__NEARLYEQUAL_7_0_OFFSET UNITYSDK_OFFSET(0x9CD83E0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__LERP_G__LERP_6_0_OFFSET UNITYSDK_OFFSET(0x9CD7E10)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraTrackSetting_TypeDefinitionIndex = 70049;
	...
	public:
		...
		{
			return (::MoleMole::Cameras::CameraTrackSetting**)Il2CppClass::FromTypeDefinitionIndex(CameraTrackSetting_TypeDefinitionIndex)->GetStaticField(0x39F40);
		}
