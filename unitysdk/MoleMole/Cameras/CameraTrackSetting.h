...
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x8024560)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_ISNEARLYEQUAL_OFFSET UNITYSDK_OFFSET(0x8023FC0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_ISVALID_OFFSET UNITYSDK_OFFSET(0x8023740)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_LERP_OFFSET UNITYSDK_OFFSET(0x80237D0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__CCTOR_OFFSET UNITYSDK_OFFSET(0x8024640)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x8023F20)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__ISNEARLYEQUAL_G__NEARLYEQUAL_7_0_OFFSET UNITYSDK_OFFSET(0x8024530)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING__LERP_G__LERP_6_0_OFFSET UNITYSDK_OFFSET(0x8023F60)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraTrackSetting_TypeDefinitionIndex = 59633;
	...
	public:
		...
		{
			return (::MoleMole::Cameras::CameraTrackSetting**)Il2CppClass::FromTypeDefinitionIndex(CameraTrackSetting_TypeDefinitionIndex)->GetStaticField(0x30C60);
		}
