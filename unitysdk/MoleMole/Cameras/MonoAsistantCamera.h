...
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA_BUILDASSITANTCAMERA_OFFSET UNITYSDK_OFFSET(0xBAD6050)
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA_GET_ISRENDERTOTEXTURE_OFFSET UNITYSDK_OFFSET(0xBAD5F00)
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA_GET_TARGETRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0xBAD5FD0)
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA_SETSTATUS_OFFSET UNITYSDK_OFFSET(0xBAD5F20)
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA_SET_ISRENDERTOTEXTURE_OFFSET UNITYSDK_OFFSET(0xBAD5F10)
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA_TICKCAMERALOOKATANDFOLLOW_OFFSET UNITYSDK_OFFSET(0xBAD6100)
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0xBAD6160)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int MonoAsistantCamera_TypeDefinitionIndex = 58491;
