...
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA_BUILDASSITANTCAMERA_OFFSET UNITYSDK_OFFSET(0x6D34470)
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA_GET_ISRENDERTOTEXTURE_OFFSET UNITYSDK_OFFSET(0x6D34320)
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA_GET_TARGETRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x6D343F0)
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA_SETSTATUS_OFFSET UNITYSDK_OFFSET(0x6D34340)
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA_SET_ISRENDERTOTEXTURE_OFFSET UNITYSDK_OFFSET(0x6D34330)
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA_TICKCAMERALOOKATANDFOLLOW_OFFSET UNITYSDK_OFFSET(0x6D34520)
#define MOLEMOLE_CAMERAS_MONOASISTANTCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x6D34580)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int MonoAsistantCamera_TypeDefinitionIndex = 59801;
