...
#define MOLEMOLE_CAMERAS_SCOPEDOVERSHOULDERCAMERA_CLASS_1_D9A9D264D97CB293_METHOD_1_EFC710EBABFCE318_OFFSET UNITYSDK_OFFSET(0x84F0CF0)
#define MOLEMOLE_CAMERAS_SCOPEDOVERSHOULDERCAMERA_CLASS_1_D9A9D264D97CB293__CTOR_OFFSET UNITYSDK_OFFSET(0x84EE2F0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int ScopedOverShoulderCamera_Class_1_D9A9D264D97CB293_TypeDefinitionIndex = 60539;
