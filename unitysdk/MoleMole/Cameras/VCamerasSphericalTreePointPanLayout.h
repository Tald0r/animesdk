...
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_APPLYTOCAMERAS_OFFSET UNITYSDK_OFFSET(0x13F7E550)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_CALCMAXELVANGLE_OFFSET UNITYSDK_OFFSET(0x13F7D4F0)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_GET_CURRENTELEANGLE_OFFSET UNITYSDK_OFFSET(0x13F7D4E0)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_ROTATE_OFFSET UNITYSDK_OFFSET(0x13F7E320)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0x13F7D6F0)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_TRYGETAVALIABLEELEANGLE_OFFSET UNITYSDK_OFFSET(0x13F7D590)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x13F7E890)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT___BASE_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0x13F7E8B0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VCamerasSphericalTreePointPanLayout_TypeDefinitionIndex = 39412;
	...
	public:
		...
		::System::Single mmaxElvAngle; // 0x18
		::System::Single currentEleAngle; // 0x1C
		::System::Single initEleAngle; // 0x20
