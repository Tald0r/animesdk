...
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_APPLYTOCAMERAS_OFFSET UNITYSDK_OFFSET(0xF2B6B00)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_CALCMAXELVANGLE_OFFSET UNITYSDK_OFFSET(0xF2B5AA0)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_GET_CURRENTELEANGLE_OFFSET UNITYSDK_OFFSET(0xF2B5A90)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_ROTATE_OFFSET UNITYSDK_OFFSET(0xF2B68D0)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0xF2B5CA0)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT_TRYGETAVALIABLEELEANGLE_OFFSET UNITYSDK_OFFSET(0xF2B5B40)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0xF2B6E40)
#define MOLEMOLE_CAMERAS_VCAMERASSPHERICALTREEPOINTPANLAYOUT___BASE_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0xF2B6E60)
...
namespace MoleMole::Cameras
{
	...
	public:
		...
		::System::Single currentEleAngle; // 0x18
		::System::Single initEleAngle; // 0x1C
