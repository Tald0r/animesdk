...
#define MOLEMOLE_CAMERAS_TELESCOPECAMERACONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6BDD520)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int TelescopeCameraConfig_TypeDefinitionIndex = 58067;
