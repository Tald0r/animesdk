...
#define MOLEMOLE_CAMERAS_CAMERACONTROLFLAG_GET_POINTERDRAGDELTAMULTIPLATFORM_OFFSET UNITYSDK_OFFSET(0x30F260)
#define MOLEMOLE_CAMERAS_CAMERACONTROLFLAG_METHOD_2_3787E7B8A3FA157C_OFFSET UNITYSDK_OFFSET(0x30F270)
#define MOLEMOLE_CAMERAS_CAMERACONTROLFLAG_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x30F350)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraControlFlag_TypeDefinitionIndex = 74838;
