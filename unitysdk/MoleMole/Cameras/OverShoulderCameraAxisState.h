...
#define MOLEMOLE_CAMERAS_OVERSHOULDERCAMERAAXISSTATE_GET_MCURRENTSPEED_OFFSET UNITYSDK_OFFSET(0x2C4B30)
#define MOLEMOLE_CAMERAS_OVERSHOULDERCAMERAAXISSTATE_METHOD_2_7395EEBD9E4D21B1_OFFSET UNITYSDK_OFFSET(0x354880)
#define MOLEMOLE_CAMERAS_OVERSHOULDERCAMERAAXISSTATE_SET_MCURRENTSPEED_OFFSET UNITYSDK_OFFSET(0x2C4B40)
#define MOLEMOLE_CAMERAS_OVERSHOULDERCAMERAAXISSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x354860)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int OverShoulderCameraAxisState_TypeDefinitionIndex = 76584;
