...
#define MOLEMOLE_CAMERAS_SCOPEDOVERSHOULDERCAMERA_STRUCT_2_508A749D3039CB55_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x56A350)
#define MOLEMOLE_CAMERAS_SCOPEDOVERSHOULDERCAMERA_STRUCT_2_508A749D3039CB55_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int ScopedOverShoulderCamera_Struct_2_508A749D3039CB55_TypeDefinitionIndex = 60538;
	...
	struct alignas(8) ScopedOverShoulderCamera_Struct_2_508A749D3039CB55
	{
		...
		::Struct_2_52A902145F5BE513 Field_2_4; // 0x20
		::PipelineCamera::ScopedDelegateHandle Field_2_6; // 0xF8
		::MoleMole::Cameras::OverrideOverShoulderCameraConfig* Field_2_5; // 0x100
		::MoleMole::Cameras::ScopedOverShoulderCamera* Field_2_2; // 0x108
		::MoleMole::Cameras::OverShoulderCameraConfig* Field_2_3; // 0x110
