...
#define MOLEMOLE_CAMERAS_SCOPEDOVERSHOULDERCAMERA_STRUCT_2_508A749D3039CB55_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x71A0C0)
#define MOLEMOLE_CAMERAS_SCOPEDOVERSHOULDERCAMERA_STRUCT_2_508A749D3039CB55_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int ScopedOverShoulderCamera_Struct_2_508A749D3039CB55_TypeDefinitionIndex = 61547;
	...
	struct alignas(8) ScopedOverShoulderCamera_Struct_2_508A749D3039CB55
	{
		...
		::MoleMole::Cameras::OverrideOverShoulderCameraConfig* Field_2_5; // 0x20
		::Struct_2_52A902145F5BE513_1 Field_2_4; // 0x28
		::Cysharp::Threading::Tasks::UniTask_Awaiter Field_2_7; // 0x100
		::PipelineCamera::ScopedDelegateHandle Field_2_6; // 0x110
		::MoleMole::Cameras::OverShoulderCameraConfig* Field_2_3; // 0x118
