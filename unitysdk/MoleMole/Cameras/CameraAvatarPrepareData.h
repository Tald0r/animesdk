...
#define MOLEMOLE_CAMERAS_CAMERAAVATARPREPAREDATA_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x6534000)
#define MOLEMOLE_CAMERAS_CAMERAAVATARPREPAREDATA_METHOD_1_FF0E709C2B9D8A2E_OFFSET UNITYSDK_OFFSET(0x6534090)
#define MOLEMOLE_CAMERAS_CAMERAAVATARPREPAREDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6533FF0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraAvatarPrepareData_TypeDefinitionIndex = 55843;
