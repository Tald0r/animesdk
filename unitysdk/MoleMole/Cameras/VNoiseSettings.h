...
#define MOLEMOLE_CAMERAS_VNOISESETTINGS_GETCOMBINEDFILTERRESULTS_OFFSET UNITYSDK_OFFSET(0x6294B70)
#define MOLEMOLE_CAMERAS_VNOISESETTINGS_GETSIGNAL_OFFSET UNITYSDK_OFFSET(0x6294D20)
#define MOLEMOLE_CAMERAS_VNOISESETTINGS_GET_SIGNALDURATION_OFFSET UNITYSDK_OFFSET(0x6294D10)
#define MOLEMOLE_CAMERAS_VNOISESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x6294E70)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VNoiseSettings_TypeDefinitionIndex = 45562;
