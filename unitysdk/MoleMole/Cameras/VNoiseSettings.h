...
#define MOLEMOLE_CAMERAS_VNOISESETTINGS_GETCOMBINEDFILTERRESULTS_OFFSET UNITYSDK_OFFSET(0xCAC7370)
#define MOLEMOLE_CAMERAS_VNOISESETTINGS_GETSIGNAL_OFFSET UNITYSDK_OFFSET(0xCAC7520)
#define MOLEMOLE_CAMERAS_VNOISESETTINGS_GET_SIGNALDURATION_OFFSET UNITYSDK_OFFSET(0xCAC7510)
#define MOLEMOLE_CAMERAS_VNOISESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0xCAC7670)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VNoiseSettings_TypeDefinitionIndex = 43785;
