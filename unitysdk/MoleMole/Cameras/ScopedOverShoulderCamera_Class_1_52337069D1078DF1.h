...
#define MOLEMOLE_CAMERAS_SCOPEDOVERSHOULDERCAMERA_CLASS_1_52337069D1078DF1_METHOD_1_9C149172113ECE07_OFFSET UNITYSDK_OFFSET(0x84F0E80)
#define MOLEMOLE_CAMERAS_SCOPEDOVERSHOULDERCAMERA_CLASS_1_52337069D1078DF1_METHOD_1_A847BE0CBB220A4E_OFFSET UNITYSDK_OFFSET(0x84F1370)
#define MOLEMOLE_CAMERAS_SCOPEDOVERSHOULDERCAMERA_CLASS_1_52337069D1078DF1_METHOD_1_C36CFFA231F852E8_OFFSET UNITYSDK_OFFSET(0x84F13B0)
#define MOLEMOLE_CAMERAS_SCOPEDOVERSHOULDERCAMERA_CLASS_1_52337069D1078DF1_METHOD_1_ECB3E307F744BB30_OFFSET UNITYSDK_OFFSET(0x84F16F0)
#define MOLEMOLE_CAMERAS_SCOPEDOVERSHOULDERCAMERA_CLASS_1_52337069D1078DF1_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0x84F1D00)
#define MOLEMOLE_CAMERAS_SCOPEDOVERSHOULDERCAMERA_CLASS_1_52337069D1078DF1__CTOR_OFFSET UNITYSDK_OFFSET(0x84F0780)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int ScopedOverShoulderCamera_Class_1_52337069D1078DF1_TypeDefinitionIndex = 60540;

	class ScopedOverShoulderCamera_Class_1_52337069D1078DF1 : public ::System::Object
	{
	public:
		::System::Func_1<::System::Boolean>* Field_1_6; // 0x10
		::System::Action_2<::System::Single, ::PipelineCamera::WorldBasicCameraData>* Field_1_7; // 0x18
		::MoleMole::Cameras::CameraTrackBlending* Field_1_3; // 0x20
		::MoleMole::Cameras::ScopedOverShoulderCamera* Field_1_0; // 0x28
		::MoleMole::Cameras::OverShoulderCameraConfig* Field_1_1; // 0x30
		::Foundation::Variable_1<::UnityEngine::Vector3> Field_1_4; // 0x38
		::MoleMole::Cameras::OverrideOverShoulderCameraConfig* Field_1_2; // 0x58
