...
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_APPLYTOCAMERAS_OFFSET UNITYSDK_OFFSET(0xB07BC20)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_CALCMAXELVANGLE_OFFSET UNITYSDK_OFFSET(0xB07A940)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_GETENTITYCONFIGID_OFFSET UNITYSDK_OFFSET(0xB07AC40)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_GET_CURRENTELEANGLE_OFFSET UNITYSDK_OFFSET(0xB07A930)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_ROTATE_OFFSET UNITYSDK_OFFSET(0xB07B9F0)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0xB07AF90)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_TRYGETAVALIABLEELEANGLE_OFFSET UNITYSDK_OFFSET(0xB07AA00)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0xB07BF60)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT___BASE_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0xB07BF70)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VCameraSphericalAutoLayout_TypeDefinitionIndex = 69171;
	...
	public:
		...
		::System::Single currentEleAngle; // 0x20
		::System::Single initEleAngle; // 0x24
		::System::Single mmaxElvAngle; // 0x28
		::System::Single mRadius; // 0x2C
		::System::Boolean applyElvAngleCurve; // 0x30
