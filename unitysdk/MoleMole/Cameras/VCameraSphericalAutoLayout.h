...
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_APPLYTOCAMERAS_OFFSET UNITYSDK_OFFSET(0x96ECB80)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_CALCMAXELVANGLE_OFFSET UNITYSDK_OFFSET(0x96EB8A0)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_GETENTITYCONFIGID_OFFSET UNITYSDK_OFFSET(0x96EBBA0)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_GET_CURRENTELEANGLE_OFFSET UNITYSDK_OFFSET(0x96EB890)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_ROTATE_OFFSET UNITYSDK_OFFSET(0x96EC950)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0x96EBEF0)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT_TRYGETAVALIABLEELEANGLE_OFFSET UNITYSDK_OFFSET(0x96EB960)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x96ECEC0)
#define MOLEMOLE_CAMERAS_VCAMERASPHERICALAUTOLAYOUT___BASE_SETTLELAYOUT_OFFSET UNITYSDK_OFFSET(0x96ECEE0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VCameraSphericalAutoLayout_TypeDefinitionIndex = 67301;
	...
	public:
		...
		::System::Boolean applyElvAngleCurve; // 0x2C
