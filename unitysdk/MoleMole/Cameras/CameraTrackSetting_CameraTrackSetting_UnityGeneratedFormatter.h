...
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_CAMERATRACKSETTING_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x6293DE0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_CAMERATRACKSETTING_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x6293DF0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_CAMERATRACKSETTING_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x6294170)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_CAMERATRACKSETTING_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x62943E0)
#define MOLEMOLE_CAMERAS_CAMERATRACKSETTING_CAMERATRACKSETTING_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x62943A0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int CameraTrackSetting_CameraTrackSetting_UnityGeneratedFormatter_TypeDefinitionIndex = 59634;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::Il2CppArray<::MoleMole::CameraOrbit>*>**)Il2CppClass::FromTypeDefinitionIndex(CameraTrackSetting_CameraTrackSetting_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x430D0);
		}
		static ::Sirenix::Serialization::Serializer_1<::System::Single>** StaticGet_CachedSerializer1()
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(CameraTrackSetting_CameraTrackSetting_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x430D8);
		}
		static ::Sirenix::Serialization::Serializer_1<::Il2CppArray<::System::Single>*>** StaticGet_CachedSerializer3()
		{
			return (::Sirenix::Serialization::Serializer_1<::Il2CppArray<::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(CameraTrackSetting_CameraTrackSetting_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x430E0);
		}
		static ::Sirenix::Serialization::Serializer_1<::MoleMole::CameraOrbit>** StaticGet_CachedSerializer0()
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::CameraOrbit>**)Il2CppClass::FromTypeDefinitionIndex(CameraTrackSetting_CameraTrackSetting_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x430E8);
		}
