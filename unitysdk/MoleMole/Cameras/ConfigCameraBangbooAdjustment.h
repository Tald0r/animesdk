...
#define MOLEMOLE_CAMERAS_CONFIGCAMERABANGBOOADJUSTMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xC320A20)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int ConfigCameraBangbooAdjustment_TypeDefinitionIndex = 59317;
