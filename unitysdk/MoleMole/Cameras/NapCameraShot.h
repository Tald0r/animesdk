...
#define MOLEMOLE_CAMERAS_NAPCAMERASHOT_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0xCD91400)
#define MOLEMOLE_CAMERAS_NAPCAMERASHOT_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0xCD91630)
#define MOLEMOLE_CAMERAS_NAPCAMERASHOT__CTOR_OFFSET UNITYSDK_OFFSET(0xCD91F00)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int NapCameraShot_TypeDefinitionIndex = 53581;
