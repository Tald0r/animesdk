...
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_GET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x9B3D8E0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9B3DA20)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_SET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x9B3D970)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_TEST_OFFSET UNITYSDK_OFFSET(0x9B3E1D0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_TICK_OFFSET UNITYSDK_OFFSET(0x9B3E110)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0x9B3DCB0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_UPDATEPROP_1_OFFSET UNITYSDK_OFFSET(0x9B3DF30)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_UPDATEPROP_OFFSET UNITYSDK_OFFSET(0x9B3DDC0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS__CTOR_OFFSET UNITYSDK_OFFSET(0x9B3E330)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS__TEST_B__19_0_OFFSET UNITYSDK_OFFSET(0x9B3E3C0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS__TEST_B__19_1_OFFSET UNITYSDK_OFFSET(0x9B3E3D0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int AsistantCameraEffect_EffectIns_TypeDefinitionIndex = 41323;
