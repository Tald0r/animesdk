...
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_GET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0xB44C100)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_ONENABLE_OFFSET UNITYSDK_OFFSET(0xB44C240)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_SET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0xB44C190)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_TEST_OFFSET UNITYSDK_OFFSET(0xB44C9D0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_TICK_OFFSET UNITYSDK_OFFSET(0xB44C910)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0xB44C4C0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_UPDATEPROP_1_OFFSET UNITYSDK_OFFSET(0xB44C730)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS_UPDATEPROP_OFFSET UNITYSDK_OFFSET(0xB44C5D0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS__CTOR_OFFSET UNITYSDK_OFFSET(0xB44CB30)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS__TEST_B__19_0_OFFSET UNITYSDK_OFFSET(0xB44CBC0)
#define MOLEMOLE_CAMERAS_ASISTANTCAMERAEFFECT_EFFECTINS__TEST_B__19_1_OFFSET UNITYSDK_OFFSET(0xB44CBD0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int AsistantCameraEffect_EffectIns_TypeDefinitionIndex = 68447;
