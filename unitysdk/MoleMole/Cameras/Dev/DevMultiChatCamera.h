...
#define MOLEMOLE_CAMERAS_DEV_DEVMULTICHATCAMERA_SYNC_OFFSET UNITYSDK_OFFSET(0x84ECB30)
#define MOLEMOLE_CAMERAS_DEV_DEVMULTICHATCAMERA_UPDATE_OFFSET UNITYSDK_OFFSET(0x84ECAC0)
#define MOLEMOLE_CAMERAS_DEV_DEVMULTICHATCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x84ECF60)

namespace MoleMole::Cameras::Dev
{
	inline static constexpr unsigned int DevMultiChatCamera_TypeDefinitionIndex = 57928;
