...
#define MOLEMOLE_CAMERAS_DEV_DEVMULTICHATCAMERA_SYNC_OFFSET UNITYSDK_OFFSET(0x6218910)
#define MOLEMOLE_CAMERAS_DEV_DEVMULTICHATCAMERA_UPDATE_OFFSET UNITYSDK_OFFSET(0x62188A0)
#define MOLEMOLE_CAMERAS_DEV_DEVMULTICHATCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x6218D40)

namespace MoleMole::Cameras::Dev
{
	inline static constexpr unsigned int DevMultiChatCamera_TypeDefinitionIndex = 63068;
