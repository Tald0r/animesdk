...
#define MOLEMOLE_CAMERAS_VNOISEPARAMS_METHOD_2_45872D1C931761E1_OFFSET UNITYSDK_OFFSET(0x3A1580)
#define MOLEMOLE_CAMERAS_VNOISEPARAMS_METHOD_2_623160C745FC10C0_OFFSET UNITYSDK_OFFSET(0x3A14A0)

namespace MoleMole::Cameras
{
	inline static constexpr unsigned int VNoiseParams_TypeDefinitionIndex = 52180;
