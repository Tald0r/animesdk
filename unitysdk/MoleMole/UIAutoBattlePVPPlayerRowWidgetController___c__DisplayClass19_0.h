...
#define MOLEMOLE_UIAUTOBATTLEPVPPLAYERROWWIDGETCONTROLLER___C__DISPLAYCLASS19_0__BINDINVITEBTN_B__0_OFFSET UNITYSDK_OFFSET(0xA4CD8F0)
#define MOLEMOLE_UIAUTOBATTLEPVPPLAYERROWWIDGETCONTROLLER___C__DISPLAYCLASS19_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA4CD8E0)

namespace MoleMole
{
	inline static constexpr unsigned int UIAutoBattlePVPPlayerRowWidgetController___c__DisplayClass19_0_TypeDefinitionIndex = 74161;
