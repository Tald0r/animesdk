...
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_ADDWORLDPOS_OFFSET UNITYSDK_OFFSET(0x6B20570)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_AUTOADJUST_OFFSET UNITYSDK_OFFSET(0x6B1FF70)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_GETPOINTSINWORLD_OFFSET UNITYSDK_OFFSET(0x6B20370)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x6B1E850)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x6B1E870)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_ISPOINTINPOLYGON_OFFSET UNITYSDK_OFFSET(0x6B1F760)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_METHOD_5_4BFEBAF005497A7E_OFFSET UNITYSDK_OFFSET(0x6B20830)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_MODIFYWORLDPOSOFINDEX_OFFSET UNITYSDK_OFFSET(0x6B20430)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6B1FE00)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_POLYGONDESTROY_OFFSET UNITYSDK_OFFSET(0x6B1FD90)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_POLYGONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x6B1F870)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_POLYGONREIGSTER_OFFSET UNITYSDK_OFFSET(0x6B1F8E0)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_POLYGONUNREGISTER_OFFSET UNITYSDK_OFFSET(0x6B1FB60)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_PREPARERUNTIMEDATA_OFFSET UNITYSDK_OFFSET(0x6B1E880)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA_REMOVEATINDEX_OFFSET UNITYSDK_OFFSET(0x6B20660)
#define MOLEMOLE_SCENESOUNDPOLYGONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6B20740)

namespace MoleMole
{
	inline static constexpr unsigned int SceneSoundPolygonData_TypeDefinitionIndex = 64687;
