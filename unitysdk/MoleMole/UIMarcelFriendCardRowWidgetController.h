...
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER_ONCLICKINVITECALLBACK_OFFSET UNITYSDK_OFFSET(0xA418030)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA416A10)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA416B90)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER_ONSWITCHPLATFORMINFO_OFFSET UNITYSDK_OFFSET(0xA416720)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA416AB0)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA416530)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER_RESETARCADESTATE_OFFSET UNITYSDK_OFFSET(0xA416DE0)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER_SHOWINFO_OFFSET UNITYSDK_OFFSET(0xA416D50)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER_SHOWPLATFORMUI_OFFSET UNITYSDK_OFFSET(0xA4167F0)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER_SHOWUIVIEW_OFFSET UNITYSDK_OFFSET(0xA417860)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA418290)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER__ONCLICKINVITECALLBACK_B__13_0_OFFSET UNITYSDK_OFFSET(0xA4182B0)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER__SHOWUIVIEW_G__SETUPPLATFORMUI_11_0_OFFSET UNITYSDK_OFFSET(0xA417F90)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA4184B0)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER___BASE_ONSCROLLITEMUPDATE_OFFSET UNITYSDK_OFFSET(0xA418520)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA4185A0)
#define MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA418620)

namespace MoleMole
{
	inline static constexpr unsigned int UIMarcelFriendCardRowWidgetController_TypeDefinitionIndex = 68184;

	class UIMarcelFriendCardRowWidgetController : public ::MoleMole::ScrollViewItemWidgetController
	{
	public:
		::Class_2_79AE422BA06F6D26_74* _view; // 0x2D0
		...
		::System::Void _OnClickInviteCallback_b__13_0(::Class_0_16E4307DCC419505_5* _)
		{
			return ((::System::Void(*)(::PVOID, ::Class_0_16E4307DCC419505_5*))((::PBYTE)hIl2Cpp + MOLEMOLE_UIMARCELFRIENDCARDROWWIDGETCONTROLLER__ONCLICKINVITECALLBACK_B__13_0_OFFSET))(this, _);
		}
