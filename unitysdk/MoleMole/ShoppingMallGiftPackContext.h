...
#define MOLEMOLE_SHOPPINGMALLGIFTPACKCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x8FA0EF0)

namespace MoleMole
{
	inline static constexpr unsigned int ShoppingMallGiftPackContext_TypeDefinitionIndex = 71753;
	...
	public:
		...
		{
			return ((::System::Void(*)(::PVOID, ::System::Collections::Generic::List_1<::Class_0_16E4307DCC419505_187*>*, ::MoleMole::MonoGamepadRegion*, ::Class_2_60DDD9C206686F44*, ::System::Action_1<::System::Int32>*))((::PBYTE)hIl2Cpp + MOLEMOLE_SHOPPINGMALLGIFTPACKCONTEXT__CTOR_OFFSET))(this, goods, region, Down_DetailBtn, onClick);
		}
	};
}
