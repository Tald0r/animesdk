...
#define MOLEMOLE_UIGACHAPERFORMANCE3DMODELCONTROLLER___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0xA911140)
#define MOLEMOLE_UIGACHAPERFORMANCE3DMODELCONTROLLER___C__DISPLAYCLASS36_0__PLAYCLOSEUPTL_B__1_OFFSET UNITYSDK_OFFSET(0xA911150)
#define MOLEMOLE_UIGACHAPERFORMANCE3DMODELCONTROLLER___C__DISPLAYCLASS36_0__PLAYCLOSEUPTL_B__2_OFFSET UNITYSDK_OFFSET(0xA911C10)

namespace MoleMole
{
	inline static constexpr unsigned int UIGachaPerformance3DModelController___c__DisplayClass36_0_TypeDefinitionIndex = 40463;
	...
	public:
		...
		::System::Action_1<::UnityEngine::Playables::PlayableDirector*>* __9__2; // 0x20
