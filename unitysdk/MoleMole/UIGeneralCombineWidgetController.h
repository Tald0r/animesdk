...
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA297D90)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA2981F0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA2979C0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA297CE0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER_SETENABLE_OFFSET UNITYSDK_OFFSET(0xA297EA0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xA2982D0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xA2983D0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xA298440)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xA2984C0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xA298520)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralCombineWidgetController_TypeDefinitionIndex = 71666;

	class UIGeneralCombineWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_60* _view; // 0x2A0
