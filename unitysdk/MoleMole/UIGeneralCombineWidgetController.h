...
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x911E2B0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x911E710)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x911DEE0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x911E200)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER_SETENABLE_OFFSET UNITYSDK_OFFSET(0x911E3C0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x911E7F0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x911E8F0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x911E960)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x911E9E0)
#define MOLEMOLE_UIGENERALCOMBINEWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x911EA40)

namespace MoleMole
{
	inline static constexpr unsigned int UIGeneralCombineWidgetController_TypeDefinitionIndex = 48535;

	class UIGeneralCombineWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_60638234271CCDB8_64* _view; // 0x2A0
		::System::Collections::Generic::List_1<::UnityEngine::UI::MaskableGraphic*>* _maskableGraphicList; // 0x2A8
		::System::Collections::Generic::List_1<::UnityEngine::UI::OutlineEx*>* _outlineList; // 0x2B0
