...
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ACTIVATEBONUS_OFFSET UNITYSDK_OFFSET(0xAF85E30)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ACTIVATEFEVER_OFFSET UNITYSDK_OFFSET(0xAF85B70)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ADDTICK_OFFSET UNITYSDK_OFFSET(0xAF85D30)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_GETSCORERANKINFO_OFFSET UNITYSDK_OFFSET(0xAF85A30)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0xAF84570)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_INITSCORERANK_OFFSET UNITYSDK_OFFSET(0xAF84D70)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAF84A50)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF84600)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONSHOOTSCORECHANGE_OFFSET UNITYSDK_OFFSET(0xAF852D0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF846A0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF84100)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF843C0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_REFRESHSCORERANKINFO_OFFSET UNITYSDK_OFFSET(0xAF85440)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_REMOVETICK_OFFSET UNITYSDK_OFFSET(0xAF85EC0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_SETCOREPROGRESS_OFFSET UNITYSDK_OFFSET(0xAF85670)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_SETGLOW_OFFSET UNITYSDK_OFFSET(0xAF85C20)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0xAF85FC0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAF86090)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0xAF86360)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0xAF863D0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0xAF86450)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0xAF864B0)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelScoreActionWidgetController_TypeDefinitionIndex = 46112;

	class UIMusicBattleInLevelScoreActionWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_724B3079070B9259_7* _view; // 0x2A0
