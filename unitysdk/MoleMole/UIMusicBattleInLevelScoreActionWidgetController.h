...
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ACTIVATEBONUS_OFFSET UNITYSDK_OFFSET(0x92BC600)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ACTIVATEFEVER_OFFSET UNITYSDK_OFFSET(0x92BC340)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ADDTICK_OFFSET UNITYSDK_OFFSET(0x92BC500)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_GETSCORERANKINFO_OFFSET UNITYSDK_OFFSET(0x92BC200)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_INITDATA_OFFSET UNITYSDK_OFFSET(0x92BAD20)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_INITSCORERANK_OFFSET UNITYSDK_OFFSET(0x92BB530)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x92BB200)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x92BADB0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONSHOOTSCORECHANGE_OFFSET UNITYSDK_OFFSET(0x92BBAA0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x92BAE50)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x92BA8B0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x92BAB70)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_REFRESHSCORERANKINFO_OFFSET UNITYSDK_OFFSET(0x92BBC10)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_REMOVETICK_OFFSET UNITYSDK_OFFSET(0x92BC690)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_SETCOREPROGRESS_OFFSET UNITYSDK_OFFSET(0x92BBE40)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_SETGLOW_OFFSET UNITYSDK_OFFSET(0x92BC3F0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER_TICK_OFFSET UNITYSDK_OFFSET(0x92BC790)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x92BC860)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER___BASE_ONCREATEVIEW_OFFSET UNITYSDK_OFFSET(0x92BCB30)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x92BCBA0)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x92BCC20)
#define MOLEMOLE_UIMUSICBATTLEINLEVELSCOREACTIONWIDGETCONTROLLER___BASE_ONUIOPEN_OFFSET UNITYSDK_OFFSET(0x92BCC80)

namespace MoleMole
{
	inline static constexpr unsigned int UIMusicBattleInLevelScoreActionWidgetController_TypeDefinitionIndex = 60326;

	class UIMusicBattleInLevelScoreActionWidgetController : public ::MoleMole::UIWidgetController
	{
	public:
		::Class_2_724B3079070B9259_5* _view; // 0x2A0
		::Il2CppArray<::System::String*>* _scoreLoop; // 0x2A8
		::Il2CppArray<::System::String*>* _rankProgress; // 0x2B0
		::System::Int32 currentRankIndex; // 0x2B8
		::System::Single currentScoreProgress; // 0x2BC
		::System::Single scoreProgressDefaultWidth; // 0x2C0
		::UnityEngine::Vector2 scoreProgressDefaultAnchorMax; // 0x2C4
		::System::Collections::Generic::List_1<::System::String*>* scoreRankChangeAnimList; // 0x2D0
		::System::Boolean isPlayRankAnim; // 0x2D8
		::System::ValueTuple_3<::System::Int32, ::System::Int32, ::System::Int32> template_; // 0x2DC
		::System::Collections::Generic::List_1<::System::ValueTuple_2<::UnityEngine::Material*, ::Foundation::AssetRequestHandle>>* _scoreLoopList; // 0x2E8
		::System::Collections::Generic::List_1<::System::ValueTuple_2<::UnityEngine::Material*, ::Foundation::AssetRequestHandle>>* _rankProgressList; // 0x2F0
		::System::Single _updateMatTime; // 0x2F8
		::System::Single _feverTime; // 0x2FC
		::System::Boolean _isPlayingFever; // 0x300
		::System::Boolean _isPlayingBonus; // 0x301
		::System::Single _tickedFeverTime; // 0x304
		::System::Int32 _glowCount; // 0x308
