...
#define MOLEMOLE_GAMEPLAYTAG_EMPTY_OFFSET UNITYSDK_OFFSET(0x8F12DD0)
#define MOLEMOLE_GAMEPLAYTAG_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x35C530)
#define MOLEMOLE_GAMEPLAYTAG_EQUALS_OFFSET UNITYSDK_OFFSET(0x35C520)
#define MOLEMOLE_GAMEPLAYTAG_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x35C420)
#define MOLEMOLE_GAMEPLAYTAG_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define MOLEMOLE_GAMEPLAYTAG_GET_TAGNAME_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define MOLEMOLE_GAMEPLAYTAG_INTERNALGETHASHCODE_OFFSET UNITYSDK_OFFSET(0x35C510)
#define MOLEMOLE_GAMEPLAYTAG_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x35C1E0)
#define MOLEMOLE_GAMEPLAYTAG_MATCH_OFFSET UNITYSDK_OFFSET(0x35C2E0)
#define MOLEMOLE_GAMEPLAYTAG_NAMEMATCH_OFFSET UNITYSDK_OFFSET(0x35C300)
#define MOLEMOLE_GAMEPLAYTAG_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x8F13680)
#define MOLEMOLE_GAMEPLAYTAG_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x8F131E0)
#define MOLEMOLE_GAMEPLAYTAG_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x8F137B0)
#define MOLEMOLE_GAMEPLAYTAG_PURETAG_OFFSET UNITYSDK_OFFSET(0x35C260)
#define MOLEMOLE_GAMEPLAYTAG_SET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x2C6250)
#define MOLEMOLE_GAMEPLAYTAG_TOSTRING_OFFSET UNITYSDK_OFFSET(0x35C3B0)
#define MOLEMOLE_GAMEPLAYTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x324900)
#define MOLEMOLE_GAMEPLAYTAG___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x35C650)
#define MOLEMOLE_GAMEPLAYTAG___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x35C690)
#define MOLEMOLE_GAMEPLAYTAG___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x35C5F0)

namespace MoleMole
{
	inline static constexpr unsigned int GameplayTag_TypeDefinitionIndex = 67205;
