...
#define MOLEMOLE_ANIMATORBLENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x9CCAA30)

namespace MoleMole
{
	inline static constexpr unsigned int AnimatorBlendData_TypeDefinitionIndex = 79537;
