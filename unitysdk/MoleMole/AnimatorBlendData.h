...
#define MOLEMOLE_ANIMATORBLENDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8015CC0)

namespace MoleMole
{
	inline static constexpr unsigned int AnimatorBlendData_TypeDefinitionIndex = 78315;
