...
#define UISCROLLLINEFADER_CALCLIPRECT_OFFSET UNITYSDK_OFFSET(0x17CCD510)
#define UISCROLLLINEFADER_ENABLEUIVERTEXCOLORCALC_OFFSET UNITYSDK_OFFSET(0x17CCD380)
#define UISCROLLLINEFADER_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x17CCD7F0)
#define UISCROLLLINEFADER_SETLINECOLOR_OFFSET UNITYSDK_OFFSET(0x17CCDEA0)
#define UISCROLLLINEFADER_SET_OFFSET UNITYSDK_OFFSET(0x17CCD0E0)
#define UISCROLLLINEFADER_START_OFFSET UNITYSDK_OFFSET(0x17CCCDD0)
#define UISCROLLLINEFADER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17CCD6B0)
#define UISCROLLLINEFADER__CTOR_OFFSET UNITYSDK_OFFSET(0x17CCE170)

inline static constexpr unsigned int UIScrollLineFader_TypeDefinitionIndex = 38614;
