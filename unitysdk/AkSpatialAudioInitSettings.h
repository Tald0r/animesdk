...
#define AKSPATIALAUDIOINITSETTINGS_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B4000F0)
#define AKSPATIALAUDIOINITSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B400030)
#define AKSPATIALAUDIOINITSETTINGS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B400080)
#define AKSPATIALAUDIOINITSETTINGS_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1B3FFFC0)
#define AKSPATIALAUDIOINITSETTINGS_GET_BENABLEDIFFRACTIONONREFLECTION_OFFSET UNITYSDK_OFFSET(0x1B400B90)
#define AKSPATIALAUDIOINITSETTINGS_GET_BENABLEDIRECTPATHDIFFRACTION_OFFSET UNITYSDK_OFFSET(0x1B400C90)
#define AKSPATIALAUDIOINITSETTINGS_GET_BENABLETRANSMISSION_OFFSET UNITYSDK_OFFSET(0x1B400D90)
#define AKSPATIALAUDIOINITSETTINGS_GET_FDIFFRACTIONSHADOWATTENFACTOR_OFFSET UNITYSDK_OFFSET(0x1B400560)
#define AKSPATIALAUDIOINITSETTINGS_GET_FDIFFRACTIONSHADOWDEGREES_OFFSET UNITYSDK_OFFSET(0x1B400670)
#define AKSPATIALAUDIOINITSETTINGS_GET_FMAXPATHLENGTH_OFFSET UNITYSDK_OFFSET(0x1B400A90)
#define AKSPATIALAUDIOINITSETTINGS_GET_FMOVEMENTTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B400780)
#define AKSPATIALAUDIOINITSETTINGS_GET_UDIFFRACTIONFLAGS_OFFSET UNITYSDK_OFFSET(0x1B400450)
#define AKSPATIALAUDIOINITSETTINGS_GET_UMAXREFLECTIONORDER_OFFSET UNITYSDK_OFFSET(0x1B400980)
#define AKSPATIALAUDIOINITSETTINGS_GET_UMAXSOUNDPROPAGATIONDEPTH_OFFSET UNITYSDK_OFFSET(0x1B400350)
#define AKSPATIALAUDIOINITSETTINGS_GET_UNUMBEROFPRIMARYRAYS_OFFSET UNITYSDK_OFFSET(0x1B400880)
#define AKSPATIALAUDIOINITSETTINGS_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1B3FFFD0)
#define AKSPATIALAUDIOINITSETTINGS_SET_BENABLEDIFFRACTIONONREFLECTION_OFFSET UNITYSDK_OFFSET(0x1B400B10)
#define AKSPATIALAUDIOINITSETTINGS_SET_BENABLEDIRECTPATHDIFFRACTION_OFFSET UNITYSDK_OFFSET(0x1B400C10)
#define AKSPATIALAUDIOINITSETTINGS_SET_BENABLETRANSMISSION_OFFSET UNITYSDK_OFFSET(0x1B400D10)
#define AKSPATIALAUDIOINITSETTINGS_SET_FDIFFRACTIONSHADOWATTENFACTOR_OFFSET UNITYSDK_OFFSET(0x1B4004D0)
#define AKSPATIALAUDIOINITSETTINGS_SET_FDIFFRACTIONSHADOWDEGREES_OFFSET UNITYSDK_OFFSET(0x1B4005E0)
#define AKSPATIALAUDIOINITSETTINGS_SET_FMAXPATHLENGTH_OFFSET UNITYSDK_OFFSET(0x1B400A00)
#define AKSPATIALAUDIOINITSETTINGS_SET_FMOVEMENTTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B4006F0)
#define AKSPATIALAUDIOINITSETTINGS_SET_UDIFFRACTIONFLAGS_OFFSET UNITYSDK_OFFSET(0x1B4003D0)
#define AKSPATIALAUDIOINITSETTINGS_SET_UMAXREFLECTIONORDER_OFFSET UNITYSDK_OFFSET(0x1B400900)
#define AKSPATIALAUDIOINITSETTINGS_SET_UMAXSOUNDPROPAGATIONDEPTH_OFFSET UNITYSDK_OFFSET(0x1B4002D0)
#define AKSPATIALAUDIOINITSETTINGS_SET_UNUMBEROFPRIMARYRAYS_OFFSET UNITYSDK_OFFSET(0x1B400800)
#define AKSPATIALAUDIOINITSETTINGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B400250)
#define AKSPATIALAUDIOINITSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3FFFB0)

inline static constexpr unsigned int AkSpatialAudioInitSettings_TypeDefinitionIndex = 30936;
