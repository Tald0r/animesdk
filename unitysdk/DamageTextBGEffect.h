...
#define DAMAGETEXTBGEFFECT_DRAWMESHES_OFFSET UNITYSDK_OFFSET(0x183B3000)
#define DAMAGETEXTBGEFFECT_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x183B2DA0)
#define DAMAGETEXTBGEFFECT_INIT_OFFSET UNITYSDK_OFFSET(0x183B2FA0)
#define DAMAGETEXTBGEFFECT_REBUILDBLOCK_OFFSET UNITYSDK_OFFSET(0x183B3330)
#define DAMAGETEXTBGEFFECT_REFRESH_OFFSET UNITYSDK_OFFSET(0x183B3100)
#define DAMAGETEXTBGEFFECT_SHOWEFFECT_OFFSET UNITYSDK_OFFSET(0x183B35E0)
#define DAMAGETEXTBGEFFECT_UPDATETRANSFORM_OFFSET UNITYSDK_OFFSET(0x183B3240)
#define DAMAGETEXTBGEFFECT__CCTOR_OFFSET UNITYSDK_OFFSET(0x183B3920)
#define DAMAGETEXTBGEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x183B2EF0)

inline static constexpr unsigned int DamageTextBGEffect_TypeDefinitionIndex = 27998;
...
public:
	...
	{
		return (::DamageTextBGEffect**)Il2CppClass::FromTypeDefinitionIndex(DamageTextBGEffect_TypeDefinitionIndex)->GetStaticField(0x21940);
	}
	static ::System::Int32* StaticGet__ColorIndex()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DamageTextBGEffect_TypeDefinitionIndex)->GetStaticField(0x6200);
	}
	static ::System::Int32* StaticGet__StartTime()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DamageTextBGEffect_TypeDefinitionIndex)->GetStaticField(0x6204);
	}
	static ::System::Int32* StaticGet__UnityDamageTextTime()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DamageTextBGEffect_TypeDefinitionIndex)->GetStaticField(0x6208);
	}
	static ::System::Int32* StaticGet__Rotation()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DamageTextBGEffect_TypeDefinitionIndex)->GetStaticField(0x620C);
	}
	// static const ::System::Int32 MaxSize = 0x3E8; // 0x0
	::Il2CppArray<::UnityEngine::Matrix4x4>* matrices; // 0x10
	::UnityEngine::Mesh* mesh; // 0x18
	::UnityEngine::MaterialPropertyBlock* block; // 0x20
	...
	::Il2CppArray<::System::Single>* rotations; // 0x48
