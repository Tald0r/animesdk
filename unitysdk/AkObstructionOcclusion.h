...
#define AKOBSTRUCTIONOCCLUSION_CASTRAYS_OFFSET UNITYSDK_OFFSET(0x1AD715F0)
#define AKOBSTRUCTIONOCCLUSION_INITINTERVALSANDFADERATES_OFFSET UNITYSDK_OFFSET(0x1AD71290)
#define AKOBSTRUCTIONOCCLUSION_UPDATEOBSTRUCTIONOCCLUSIONVALUES_OFFSET UNITYSDK_OFFSET(0x1AD712D0)
#define AKOBSTRUCTIONOCCLUSION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AD719B0)
#define AKOBSTRUCTIONOCCLUSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD71CF0)

inline static constexpr unsigned int AkObstructionOcclusion_TypeDefinitionIndex = 30127;
