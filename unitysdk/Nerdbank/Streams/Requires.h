...
#define NERDBANK_STREAMS_REQUIRES_ARGUMENT_1_OFFSET UNITYSDK_OFFSET(0x19554760)
#define NERDBANK_STREAMS_REQUIRES_ARGUMENT_2_OFFSET UNITYSDK_OFFSET(0x195547E0)
#define NERDBANK_STREAMS_REQUIRES_ARGUMENT_3_OFFSET UNITYSDK_OFFSET(0x19554860)
#define NERDBANK_STREAMS_REQUIRES_ARGUMENT_OFFSET UNITYSDK_OFFSET(0x195546F0)
#define NERDBANK_STREAMS_REQUIRES_FAILRANGE_OFFSET UNITYSDK_OFFSET(0x19554650)
#define NERDBANK_STREAMS_REQUIRES_RANGE_OFFSET UNITYSDK_OFFSET(0x19554630)

namespace Nerdbank::Streams
{
	inline static constexpr unsigned int Requires_TypeDefinitionIndex = 26048;
