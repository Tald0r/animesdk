...
#define NERDBANK_STREAMS_REQUIRES_ARGUMENT_1_OFFSET UNITYSDK_OFFSET(0x19162610)
#define NERDBANK_STREAMS_REQUIRES_ARGUMENT_2_OFFSET UNITYSDK_OFFSET(0x19162690)
#define NERDBANK_STREAMS_REQUIRES_ARGUMENT_3_OFFSET UNITYSDK_OFFSET(0x19162710)
#define NERDBANK_STREAMS_REQUIRES_ARGUMENT_OFFSET UNITYSDK_OFFSET(0x191625A0)
#define NERDBANK_STREAMS_REQUIRES_FAILRANGE_OFFSET UNITYSDK_OFFSET(0x19162500)
#define NERDBANK_STREAMS_REQUIRES_RANGE_OFFSET UNITYSDK_OFFSET(0x191624E0)

namespace Nerdbank::Streams
{
	inline static constexpr unsigned int Requires_TypeDefinitionIndex = 26667;
