...
#define STRUCT_2_6D9F6D9B6BD853BD_METHOD_2_1F8314262457963A_OFFSET UNITYSDK_OFFSET(0x3183A0)
#define STRUCT_2_6D9F6D9B6BD853BD_METHOD_2_340237F7579E924C_OFFSET UNITYSDK_OFFSET(0x318390)
#define STRUCT_2_6D9F6D9B6BD853BD_METHOD_2_5489F9CD0AA85DE6_OFFSET UNITYSDK_OFFSET(0x318320)
#define STRUCT_2_6D9F6D9B6BD853BD_METHOD_2_C3B21C74C45D6F86_OFFSET UNITYSDK_OFFSET(0x318350)
#define STRUCT_2_6D9F6D9B6BD853BD_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x3182A0)
#define STRUCT_2_6D9F6D9B6BD853BD_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x3182E0)
#define STRUCT_2_6D9F6D9B6BD853BD__CCTOR_OFFSET UNITYSDK_OFFSET(0x6D15CF0)
#define STRUCT_2_6D9F6D9B6BD853BD__CTOR_OFFSET UNITYSDK_OFFSET(0x318220)

inline static constexpr unsigned int Struct_2_6D9F6D9B6BD853BD_TypeDefinitionIndex = 51051;

struct alignas(8) Struct_2_6D9F6D9B6BD853BD
{
	static ::Struct_2_6D9F6D9B6BD853BD* StaticGet_Field_2_5()
	{
		return (::Struct_2_6D9F6D9B6BD853BD*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_6D9F6D9B6BD853BD_TypeDefinitionIndex)->GetStaticField(0x10330);
	}
