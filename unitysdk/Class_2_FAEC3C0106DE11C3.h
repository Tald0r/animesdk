...
#define CLASS_2_FAEC3C0106DE11C3_METHOD_2_A5240ADEB2056B2C_OFFSET UNITYSDK_OFFSET(0x6AC8C00)
#define CLASS_2_FAEC3C0106DE11C3_METHOD_2_BC516BD7B592E51E_OFFSET UNITYSDK_OFFSET(0x6AC8AF0)
#define CLASS_2_FAEC3C0106DE11C3_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x6AC8BA0)
#define CLASS_2_FAEC3C0106DE11C3__CCTOR_OFFSET UNITYSDK_OFFSET(0x6AC8A70)
#define CLASS_2_FAEC3C0106DE11C3__CTOR_OFFSET UNITYSDK_OFFSET(0x6AC8AE0)

inline static constexpr unsigned int Class_2_FAEC3C0106DE11C3_TypeDefinitionIndex = 37012;

class Class_2_FAEC3C0106DE11C3 : public ::Class_1_B7E341C5F1A6F199
{
public:
	// static const ::System::UInt16 Field_2_4 = 0xC; // 0x0
	::MoleMole::Config::CharacterAliveState Field_2_1; // 0x20
	::MoleMole::Config::EntityType Field_2_3; // 0x24
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_FAEC3C0106DE11C3_METHOD_2_BC516BD7B592E51E_OFFSET))(this);
	}
