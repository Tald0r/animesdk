...
#define MIHOYO_SDK_SDKDELEGATE_HTTPREQUESTBYTHTTPDNSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x187052A0)
#define MIHOYO_SDK_SDKDELEGATE_HTTPREQUESTBYTHTTPDNSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187053B0)
#define MIHOYO_SDK_SDKDELEGATE_HTTPREQUESTBYTHTTPDNSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18704860)
#define MIHOYO_SDK_SDKDELEGATE_HTTPREQUESTBYTHTTPDNSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18704840)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_HttpRequestBytHttpDnsDelegate_TypeDefinitionIndex = 18328;
