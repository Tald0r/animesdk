...
#define MIHOYO_SDK_SDKDELEGATE_HTTPREQUESTBYTHTTPDNSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18286020)
#define MIHOYO_SDK_SDKDELEGATE_HTTPREQUESTBYTHTTPDNSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18286130)
#define MIHOYO_SDK_SDKDELEGATE_HTTPREQUESTBYTHTTPDNSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x182855F0)
#define MIHOYO_SDK_SDKDELEGATE_HTTPREQUESTBYTHTTPDNSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x182855E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_HttpRequestBytHttpDnsDelegate_TypeDefinitionIndex = 17821;
