...
#define MIHOYO_SDK_STATICICON_DELAYEDACTION_OFFSET UNITYSDK_OFFSET(0x19353770)
#define MIHOYO_SDK_STATICICON_GET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x19353150)
#define MIHOYO_SDK_STATICICON_GET_IMAGEURL_OFFSET UNITYSDK_OFFSET(0x19353170)
#define MIHOYO_SDK_STATICICON_GET_TOOLTIPTEXT_OFFSET UNITYSDK_OFFSET(0x19353130)
#define MIHOYO_SDK_STATICICON_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19353BC0)
#define MIHOYO_SDK_STATICICON_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19353BD0)
#define MIHOYO_SDK_STATICICON_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x19353840)
#define MIHOYO_SDK_STATICICON_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x19353A00)
#define MIHOYO_SDK_STATICICON_POINTERENTER_OFFSET UNITYSDK_OFFSET(0x193537D0)
#define MIHOYO_SDK_STATICICON_POINTEREXIT_OFFSET UNITYSDK_OFFSET(0x19353810)
#define MIHOYO_SDK_STATICICON_SET_IMAGEPATH_OFFSET UNITYSDK_OFFSET(0x19353160)
#define MIHOYO_SDK_STATICICON_SET_IMAGEURL_OFFSET UNITYSDK_OFFSET(0x19353180)
#define MIHOYO_SDK_STATICICON_SET_TOOLTIPTEXT_OFFSET UNITYSDK_OFFSET(0x19353140)
#define MIHOYO_SDK_STATICICON_START_OFFSET UNITYSDK_OFFSET(0x19353350)
#define MIHOYO_SDK_STATICICON_UPDATEIMAGETEXTURE_OFFSET UNITYSDK_OFFSET(0x19353BE0)
#define MIHOYO_SDK_STATICICON__CTOR_OFFSET UNITYSDK_OFFSET(0x19353CE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int StaticIcon_TypeDefinitionIndex = 18538;
