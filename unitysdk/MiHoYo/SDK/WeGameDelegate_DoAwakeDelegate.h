...
#define MIHOYO_SDK_WEGAMEDELEGATE_DOAWAKEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1821F390)
#define MIHOYO_SDK_WEGAMEDELEGATE_DOAWAKEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1821F3C0)
#define MIHOYO_SDK_WEGAMEDELEGATE_DOAWAKEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1821F0F0)
#define MIHOYO_SDK_WEGAMEDELEGATE_DOAWAKEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1821F0E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_DoAwakeDelegate_TypeDefinitionIndex = 17731;
