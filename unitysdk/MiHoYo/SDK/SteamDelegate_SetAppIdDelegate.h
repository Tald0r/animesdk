...
#define MIHOYO_SDK_STEAMDELEGATE_SETAPPIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18890420)
#define MIHOYO_SDK_STEAMDELEGATE_SETAPPIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18890470)
#define MIHOYO_SDK_STEAMDELEGATE_SETAPPIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18890120)
#define MIHOYO_SDK_STEAMDELEGATE_SETAPPIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18890110)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SteamDelegate_SetAppIdDelegate_TypeDefinitionIndex = 17710;
