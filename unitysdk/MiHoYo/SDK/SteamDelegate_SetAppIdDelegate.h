...
#define MIHOYO_SDK_STEAMDELEGATE_SETAPPIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18AAB900)
#define MIHOYO_SDK_STEAMDELEGATE_SETAPPIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18AAB950)
#define MIHOYO_SDK_STEAMDELEGATE_SETAPPIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18AAB610)
#define MIHOYO_SDK_STEAMDELEGATE_SETAPPIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAB5F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SteamDelegate_SetAppIdDelegate_TypeDefinitionIndex = 18217;
