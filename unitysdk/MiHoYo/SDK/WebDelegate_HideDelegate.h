...
#define MIHOYO_SDK_WEBDELEGATE_HIDEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A1FDE0)
#define MIHOYO_SDK_WEBDELEGATE_HIDEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A1FE10)
#define MIHOYO_SDK_WEBDELEGATE_HIDEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A1F8E0)
#define MIHOYO_SDK_WEBDELEGATE_HIDEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A1F8D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_HideDelegate_TypeDefinitionIndex = 17846;
