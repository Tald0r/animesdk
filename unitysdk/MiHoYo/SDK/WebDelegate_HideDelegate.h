...
#define MIHOYO_SDK_WEBDELEGATE_HIDEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18E4B6D0)
#define MIHOYO_SDK_WEBDELEGATE_HIDEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18E4B700)
#define MIHOYO_SDK_WEBDELEGATE_HIDEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18E4B1D0)
#define MIHOYO_SDK_WEBDELEGATE_HIDEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E4B1B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_HideDelegate_TypeDefinitionIndex = 18353;
