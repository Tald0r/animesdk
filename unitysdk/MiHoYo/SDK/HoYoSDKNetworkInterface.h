...
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_CHECKHTTPDNSPLUSENABLE_OFFSET UNITYSDK_OFFSET(0x1953AAE0)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_DICTIONARY2JSON_OFFSET UNITYSDK_OFFSET(0x1953AEA0)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1953A6E0)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_HTTPDNSHTTPREQUESTWITHCUSTOMHANDLER_OFFSET UNITYSDK_OFFSET(0x1953A860)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_HTTPREQUESTBYHTTPDNSPLUS_OFFSET UNITYSDK_OFFSET(0x1953ABA0)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_HTTPREQUESTBYTHTTPDNS_OFFSET UNITYSDK_OFFSET(0x1953A7F0)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_INITENV_OFFSET UNITYSDK_OFFSET(0x1953A760)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_ISHTTPDNSPLUSCONFIGVALID_OFFSET UNITYSDK_OFFSET(0x1953A9E0)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1953A750)
#define MIHOYO_SDK_HOYOSDKNETWORKINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1953A6D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoSDKNetworkInterface_TypeDefinitionIndex = 34393;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::HoYoSDKNetworkInterface**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKNetworkInterface_TypeDefinitionIndex)->GetStaticField(0x25E40);
		}
