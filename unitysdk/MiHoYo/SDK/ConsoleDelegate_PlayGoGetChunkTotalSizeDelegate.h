...
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKTOTALSIZEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BCA320)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKTOTALSIZEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BCA350)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKTOTALSIZEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BC9DE0)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOGETCHUNKTOTALSIZEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BC9DC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_PlayGoGetChunkTotalSizeDelegate_TypeDefinitionIndex = 18200;
