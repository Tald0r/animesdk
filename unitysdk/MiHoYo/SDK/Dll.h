...
#define MIHOYO_SDK_DLL_ADD_DLLDESTROYHANDLER_OFFSET UNITYSDK_OFFSET(0x19282E00)
#define MIHOYO_SDK_DLL_ADD_ONESC_OFFSET UNITYSDK_OFFSET(0x19282BC0)
#define MIHOYO_SDK_DLL_ADD_ONRETURN_OFFSET UNITYSDK_OFFSET(0x19282B00)
#define MIHOYO_SDK_DLL_ADD_ONTAB_OFFSET UNITYSDK_OFFSET(0x19282A40)
#define MIHOYO_SDK_DLL_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19282C80)
#define MIHOYO_SDK_DLL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x192831C0)
#define MIHOYO_SDK_DLL_REMOVE_DLLDESTROYHANDLER_OFFSET UNITYSDK_OFFSET(0x19282E80)
#define MIHOYO_SDK_DLL_REMOVE_ONESC_OFFSET UNITYSDK_OFFSET(0x19282C20)
#define MIHOYO_SDK_DLL_REMOVE_ONRETURN_OFFSET UNITYSDK_OFFSET(0x19282B60)
#define MIHOYO_SDK_DLL_REMOVE_ONTAB_OFFSET UNITYSDK_OFFSET(0x19282AA0)
#define MIHOYO_SDK_DLL_UPDATE_OFFSET UNITYSDK_OFFSET(0x19282F00)
#define MIHOYO_SDK_DLL__CTOR_OFFSET UNITYSDK_OFFSET(0x192831D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Dll_TypeDefinitionIndex = 17957;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Dll**)Il2CppClass::FromTypeDefinitionIndex(Dll_TypeDefinitionIndex)->GetStaticField(0xAC00);
		}
