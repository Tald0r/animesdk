...
#define MIHOYO_SDK_PSDELEGATE_PRODUCTSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17E984D0)
#define MIHOYO_SDK_PSDELEGATE_PRODUCTSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17E98530)
#define MIHOYO_SDK_PSDELEGATE_PRODUCTSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x17E98190)
#define MIHOYO_SDK_PSDELEGATE_PRODUCTSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17E98180)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ProductsCallback_TypeDefinitionIndex = 17755;
