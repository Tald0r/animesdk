...
#define MIHOYO_SDK_SDKDELEGATE_CHECKHTTPDNSPLUSENABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1847E070)
#define MIHOYO_SDK_SDKDELEGATE_CHECKHTTPDNSPLUSENABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1847E0A0)
#define MIHOYO_SDK_SDKDELEGATE_CHECKHTTPDNSPLUSENABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1847DDD0)
#define MIHOYO_SDK_SDKDELEGATE_CHECKHTTPDNSPLUSENABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1847DDB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_CheckHttpDnsPlusEnableDelegate_TypeDefinitionIndex = 18330;
