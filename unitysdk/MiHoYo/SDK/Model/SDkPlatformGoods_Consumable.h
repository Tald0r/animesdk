...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x847EC50)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_CYCLE_COUNT_OFFSET UNITYSDK_OFFSET(0x847ECD0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_PURCHASED_COUNT_OFFSET UNITYSDK_OFFSET(0x847ECB0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_RESET_MODE_OFFSET UNITYSDK_OFFSET(0x847EC90)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_RESET_UNTIL_OFFSET UNITYSDK_OFFSET(0x847EC70)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x847EC60)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_CYCLE_COUNT_OFFSET UNITYSDK_OFFSET(0x847ECE0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_PURCHASED_COUNT_OFFSET UNITYSDK_OFFSET(0x847ECC0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_RESET_MODE_OFFSET UNITYSDK_OFFSET(0x847ECA0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_RESET_UNTIL_OFFSET UNITYSDK_OFFSET(0x847EC80)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x847ECF0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x847F0A0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x847F0B0)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_Consumable_TypeDefinitionIndex = 45572;
