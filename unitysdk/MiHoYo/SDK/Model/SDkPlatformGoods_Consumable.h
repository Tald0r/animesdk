...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x94D7490)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_CYCLE_COUNT_OFFSET UNITYSDK_OFFSET(0x94D7510)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_PURCHASED_COUNT_OFFSET UNITYSDK_OFFSET(0x94D74F0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_RESET_MODE_OFFSET UNITYSDK_OFFSET(0x94D74D0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_GET_RESET_UNTIL_OFFSET UNITYSDK_OFFSET(0x94D74B0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x94D74A0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_CYCLE_COUNT_OFFSET UNITYSDK_OFFSET(0x94D7520)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_PURCHASED_COUNT_OFFSET UNITYSDK_OFFSET(0x94D7500)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_RESET_MODE_OFFSET UNITYSDK_OFFSET(0x94D74E0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_SET_RESET_UNTIL_OFFSET UNITYSDK_OFFSET(0x94D74C0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x94D7530)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x94D78E0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CONSUMABLE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x94D78F0)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_Consumable_TypeDefinitionIndex = 39347;
