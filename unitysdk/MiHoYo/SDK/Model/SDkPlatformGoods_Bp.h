...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_BP_GET_TYPE_OFFSET UNITYSDK_OFFSET(0xACA1E60)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_BP_SET_TYPE_OFFSET UNITYSDK_OFFSET(0xACA1E70)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_BP_TOSTRING_OFFSET UNITYSDK_OFFSET(0xACA1E80)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_BP__CTOR_OFFSET UNITYSDK_OFFSET(0xACA1F10)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_BP___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xACA1F20)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_Bp_TypeDefinitionIndex = 39345;
