...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_GET_BONUS_ONCE_ELIGIBLE_OFFSET UNITYSDK_OFFSET(0x9CC9EB0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_GET_COUNT_BONUS_OFFSET UNITYSDK_OFFSET(0x9CC9E90)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x9CC9E70)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_SET_BONUS_ONCE_ELIGIBLE_OFFSET UNITYSDK_OFFSET(0x9CC9EC0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_SET_COUNT_BONUS_OFFSET UNITYSDK_OFFSET(0x9CC9EA0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x9CC9E80)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9CC9ED0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY__CTOR_OFFSET UNITYSDK_OFFSET(0x9CC9FF0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9CCA000)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_VirtualCurrency_TypeDefinitionIndex = 39343;
