...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_GET_BONUS_ONCE_ELIGIBLE_OFFSET UNITYSDK_OFFSET(0x8015140)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_GET_COUNT_BONUS_OFFSET UNITYSDK_OFFSET(0x8015120)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x8015100)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_SET_BONUS_ONCE_ELIGIBLE_OFFSET UNITYSDK_OFFSET(0x8015150)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_SET_COUNT_BONUS_OFFSET UNITYSDK_OFFSET(0x8015130)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x8015110)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8015160)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY__CTOR_OFFSET UNITYSDK_OFFSET(0x8015280)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIRTUALCURRENCY___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8015290)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_VirtualCurrency_TypeDefinitionIndex = 45570;
