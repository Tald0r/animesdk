...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_CREATEFROMJSON_OFFSET UNITYSDK_OFFSET(0x95C3330)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_BP_OFFSET UNITYSDK_OFFSET(0x95C2DC0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_BUYTIMES_OFFSET UNITYSDK_OFFSET(0x95C31E0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_CONSUMABLE_OFFSET UNITYSDK_OFFSET(0x95C2E00)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_FIRSTPRESENTITEMID_OFFSET UNITYSDK_OFFSET(0x95C2FE0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_FIRSTPRESENTITEMNUM_OFFSET UNITYSDK_OFFSET(0x95C2FF0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_GOODS_DESC_OFFSET UNITYSDK_OFFSET(0x95C2C80)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_GOODS_ID_OFFSET UNITYSDK_OFFSET(0x95C2C40)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_GOODS_NAME_OFFSET UNITYSDK_OFFSET(0x95C2CA0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_GOODS_TYPE_OFFSET UNITYSDK_OFFSET(0x95C2C60)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_ISFIRSTCHARGE_OFFSET UNITYSDK_OFFSET(0x95C3060)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_ITEMID_OFFSET UNITYSDK_OFFSET(0x95C2E40)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_ITEMNUM_OFFSET UNITYSDK_OFFSET(0x95C2E50)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_ITEM_ID_OFFSET UNITYSDK_OFFSET(0x95C2D60)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_LAUNCH_END_TIME_OFFSET UNITYSDK_OFFSET(0x95C2CE0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_LAUNCH_START_TIME_OFFSET UNITYSDK_OFFSET(0x95C2CC0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_LEVEL_MIN_OFFSET UNITYSDK_OFFSET(0x95C2D80)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_MAXBUYTIMES_OFFSET UNITYSDK_OFFSET(0x95C3170)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_NEXTREFRESHTIME_OFFSET UNITYSDK_OFFSET(0x95C32C0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_OFFICIALGOODSID_OFFSET UNITYSDK_OFFSET(0x95C30E0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_OFFICIAL_GOODS_ID_OFFSET UNITYSDK_OFFSET(0x95C2C20)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PRESENTITEMID_OFFSET UNITYSDK_OFFSET(0x95C2F50)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PRESENTITEMNUM_OFFSET UNITYSDK_OFFSET(0x95C2F60)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PRICE_OFFSET UNITYSDK_OFFSET(0x95C2E20)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PURCHASE_ELIGIBLE_OFFSET UNITYSDK_OFFSET(0x95C2D00)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PURCHASE_INELIGIBLE_CODE_OFFSET UNITYSDK_OFFSET(0x95C2D20)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_PURCHASE_INELIGIBLE_REASON_OFFSET UNITYSDK_OFFSET(0x95C2D40)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_REFRESHTYPE_OFFSET UNITYSDK_OFFSET(0x95C3250)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_THIRDPARTYPRODUCTID_OFFSET UNITYSDK_OFFSET(0x95C3160)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_VIP_OFFSET UNITYSDK_OFFSET(0x95C2DE0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_GET_VIRTUAL_CURRENCY_OFFSET UNITYSDK_OFFSET(0x95C2DA0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_BP_OFFSET UNITYSDK_OFFSET(0x95C2DD0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_CONSUMABLE_OFFSET UNITYSDK_OFFSET(0x95C2E10)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_GOODS_DESC_OFFSET UNITYSDK_OFFSET(0x95C2C90)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_GOODS_ID_OFFSET UNITYSDK_OFFSET(0x95C2C50)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_GOODS_NAME_OFFSET UNITYSDK_OFFSET(0x95C2CB0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_GOODS_TYPE_OFFSET UNITYSDK_OFFSET(0x95C2C70)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_ITEM_ID_OFFSET UNITYSDK_OFFSET(0x95C2D70)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_LAUNCH_END_TIME_OFFSET UNITYSDK_OFFSET(0x95C2CF0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_LAUNCH_START_TIME_OFFSET UNITYSDK_OFFSET(0x95C2CD0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_LEVEL_MIN_OFFSET UNITYSDK_OFFSET(0x95C2D90)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_OFFICIAL_GOODS_ID_OFFSET UNITYSDK_OFFSET(0x95C2C30)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_PRICE_OFFSET UNITYSDK_OFFSET(0x95C2E30)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_PURCHASE_ELIGIBLE_OFFSET UNITYSDK_OFFSET(0x95C2D10)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_PURCHASE_INELIGIBLE_CODE_OFFSET UNITYSDK_OFFSET(0x95C2D30)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_PURCHASE_INELIGIBLE_REASON_OFFSET UNITYSDK_OFFSET(0x95C2D50)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_VIP_OFFSET UNITYSDK_OFFSET(0x95C2DF0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_SET_VIRTUAL_CURRENCY_OFFSET UNITYSDK_OFFSET(0x95C2DB0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x95C34D0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS__CTOR_OFFSET UNITYSDK_OFFSET(0x95C4370)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x95C4380)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_TypeDefinitionIndex = 45567;
