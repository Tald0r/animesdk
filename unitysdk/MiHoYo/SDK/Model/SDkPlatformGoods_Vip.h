...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP_GET_VALID_UNTIL_OFFSET UNITYSDK_OFFSET(0xC308210)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP_SET_VALID_UNTIL_OFFSET UNITYSDK_OFFSET(0xC308220)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC308230)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP__CTOR_OFFSET UNITYSDK_OFFSET(0xC3082C0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xC3082D0)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_Vip_TypeDefinitionIndex = 45568;
