...
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP_GET_VALID_UNTIL_OFFSET UNITYSDK_OFFSET(0x9B907B0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP_SET_VALID_UNTIL_OFFSET UNITYSDK_OFFSET(0x9B907C0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9B907D0)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP__CTOR_OFFSET UNITYSDK_OFFSET(0x9B90860)
#define MIHOYO_SDK_MODEL_SDKPLATFORMGOODS_VIP___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9B90870)

namespace MiHoYo::SDK::Model
{
	inline static constexpr unsigned int SDkPlatformGoods_Vip_TypeDefinitionIndex = 39346;
