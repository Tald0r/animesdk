...
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_ACCOUNTPLATINVOKERETURN_OFFSET UNITYSDK_OFFSET(0x19C8CAD0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_ACCOUNTPLATINVOKE_OFFSET UNITYSDK_OFFSET(0x19C8C660)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_ACTIONEXISTS_OFFSET UNITYSDK_OFFSET(0x19C8CED0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_CACHEACTIONINDEX_OFFSET UNITYSDK_OFFSET(0x19C8CDE0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_CONFIGSYNCWITHNATIVE_OFFSET UNITYSDK_OFFSET(0x19C8C3F0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_ENABLENATIVEHANDLE_OFFSET UNITYSDK_OFFSET(0x19C8B660)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKINTERNALCALLBACK_OFFSET UNITYSDK_OFFSET(0x19C8AA70)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKINTERNALNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x19C8AEA0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKINTERNALPLUGINUICALLBACK_OFFSET UNITYSDK_OFFSET(0x19C8AB80)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_CONFIGSYNC_OFFSET UNITYSDK_OFFSET(0x19C8C5A0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_INITGLOBALENV_OFFSET UNITYSDK_OFFSET(0x19C8D540)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_INVOKERETURN_OFFSET UNITYSDK_OFFSET(0x19C8D330)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C8D470)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_REGISTERNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x19C8B850)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_REGISTERPLUGINUI_OFFSET UNITYSDK_OFFSET(0x19C8D650)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_RELEASERESULT_OFFSET UNITYSDK_OFFSET(0x19C8D3F0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDK_STOP_OFFSET UNITYSDK_OFFSET(0x19C8BA70)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_INITNATIVEENV_OFFSET UNITYSDK_OFFSET(0x19C8B140)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19C8B3A0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_INVOKERETURN_OFFSET UNITYSDK_OFFSET(0x19C8CB50)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C8C770)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_NEEDHALFDELEGATE_OFFSET UNITYSDK_OFFSET(0x19C8D270)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_ONGETINVOKERESPONSE_OFFSET UNITYSDK_OFFSET(0x19C8D6E0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_ONGETNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x19C8D7E0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_PREHANDLEACTIONS_OFFSET UNITYSDK_OFFSET(0x19C8D8E0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_REGISTERINTERNALNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x19C8CDD0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_REGISTERNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x19C8B6C0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_REGISTERPLUGINUI_OFFSET UNITYSDK_OFFSET(0x19C8BAF0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_REMOVEACTIONINDEX_OFFSET UNITYSDK_OFFSET(0x19C8CE70)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_RUNONMAINTHREAD_OFFSET UNITYSDK_OFFSET(0x19C8B620)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_STOP_OFFSET UNITYSDK_OFFSET(0x19C8B8E0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C8DD50)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8AFA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatNative_TypeDefinitionIndex = 34372;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::AccountPlatNative**)Il2CppClass::FromTypeDefinitionIndex(AccountPlatNative_TypeDefinitionIndex)->GetStaticField(0x255F0);
		}
		static ::System::Collections::Generic::HashSet_1<::System::String*>** StaticGet_m_setHalfDelegate()
		{
			return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(AccountPlatNative_TypeDefinitionIndex)->GetStaticField(0x255F8);
		}
		static ::System::Boolean* StaticGet_sm_bIsOpenAccountPlat()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(AccountPlatNative_TypeDefinitionIndex)->GetStaticField(0x8160);
		}
		static ::System::Boolean* StaticGet_sm_bEnableNativeHandle()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(AccountPlatNative_TypeDefinitionIndex)->GetStaticField(0x8161);
		}
