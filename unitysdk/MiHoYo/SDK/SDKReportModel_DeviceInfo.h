...
#define MIHOYO_SDK_SDKREPORTMODEL_DEVICEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x189535A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKReportModel_DeviceInfo_TypeDefinitionIndex = 17952;
