...
#define MIHOYO_SDK_KIBANAPCBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A17A40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaPCBoxConfig_TypeDefinitionIndex = 17931;
