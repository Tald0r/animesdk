...
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_ANALYZERRESULTTOJSON_OFFSET UNITYSDK_OFFSET(0x19111C90)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_BUILDJSON_1_OFFSET UNITYSDK_OFFSET(0x19111AD0)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_BUILDJSON_OFFSET UNITYSDK_OFFSET(0x19111800)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_CREATEEMPTYNOTE_OFFSET UNITYSDK_OFFSET(0x19111A60)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER_FILLHEADERS_OFFSET UNITYSDK_OFFSET(0x19112450)
#define MIHOYO_SDK_SDKREPORT_ANALYZERRESULTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19112980)

namespace MiHoYo::SDK::SdkReport
{
	inline static constexpr unsigned int AnalyzerResultFormatter_TypeDefinitionIndex = 34863;
