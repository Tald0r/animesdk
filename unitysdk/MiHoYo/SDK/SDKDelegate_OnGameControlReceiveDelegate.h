...
#define MIHOYO_SDK_SDKDELEGATE_ONGAMECONTROLRECEIVEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1845A610)
#define MIHOYO_SDK_SDKDELEGATE_ONGAMECONTROLRECEIVEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1845A640)
#define MIHOYO_SDK_SDKDELEGATE_ONGAMECONTROLRECEIVEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1845A110)
#define MIHOYO_SDK_SDKDELEGATE_ONGAMECONTROLRECEIVEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1845A100)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_OnGameControlReceiveDelegate_TypeDefinitionIndex = 17820;
