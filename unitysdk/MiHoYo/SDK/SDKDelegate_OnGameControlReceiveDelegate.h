...
#define MIHOYO_SDK_SDKDELEGATE_ONGAMECONTROLRECEIVEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1894BB10)
#define MIHOYO_SDK_SDKDELEGATE_ONGAMECONTROLRECEIVEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1894BB40)
#define MIHOYO_SDK_SDKDELEGATE_ONGAMECONTROLRECEIVEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1894B610)
#define MIHOYO_SDK_SDKDELEGATE_ONGAMECONTROLRECEIVEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1894B5F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_OnGameControlReceiveDelegate_TypeDefinitionIndex = 18327;
