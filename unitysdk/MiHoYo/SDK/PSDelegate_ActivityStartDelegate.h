...
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYSTARTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A1B0B0)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYSTARTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A1B0E0)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYSTARTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A1AB70)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYSTARTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A1AB60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ActivityStartDelegate_TypeDefinitionIndex = 17775;
