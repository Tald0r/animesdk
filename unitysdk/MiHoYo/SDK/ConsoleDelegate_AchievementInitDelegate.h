...
#define MIHOYO_SDK_CONSOLEDELEGATE_ACHIEVEMENTINITDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C831A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_ACHIEVEMENTINITDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C831D0)
#define MIHOYO_SDK_CONSOLEDELEGATE_ACHIEVEMENTINITDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C7E430)
#define MIHOYO_SDK_CONSOLEDELEGATE_ACHIEVEMENTINITDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C83180)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_AchievementInitDelegate_TypeDefinitionIndex = 18170;
