...
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGERSTEAM_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x18C9EA50)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGERSTEAM_GETREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x18C9EEC0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGERSTEAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18C9EA00)

namespace MiHoYo::SDK::Windows::OS
{
	inline static constexpr unsigned int BindManagerSteam_TypeDefinitionIndex = 18874;
