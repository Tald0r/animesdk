...
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_BINDEMAIL_OFFSET UNITYSDK_OFFSET(0x188CAC50)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_BINDEXISTINGACCOUNT_OFFSET UNITYSDK_OFFSET(0x188C9160)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_CREATEANDBINDNEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x188C9790)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GENERATEACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x188C9040)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETACCOUNTPRIVACYPROTOCOLURL_OFFSET UNITYSDK_OFFSET(0x188CBEB0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETACCOUNTUSERAGREEMENTURL_OFFSET UNITYSDK_OFFSET(0x188CBBD0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETBINDINGWEBURL_OFFSET UNITYSDK_OFFSET(0x188C9A90)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETCAPTCHACODE_OFFSET UNITYSDK_OFFSET(0x188CA270)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETCHANNELNICKNAME_OFFSET UNITYSDK_OFFSET(0x188CB900)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GETREPORTTYPE_OFFSET UNITYSDK_OFFSET(0x188CCBE0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x188C84D0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_GET_RSAKEY_OFFSET UNITYSDK_OFFSET(0x188C8830)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_LOGINAFTERSUCCESSFULBINDING_OFFSET UNITYSDK_OFFSET(0x188C97E0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_LOGINBYEMAILCAPTCHA_OFFSET UNITYSDK_OFFSET(0x188CA5D0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_LOGREPORT_OFFSET UNITYSDK_OFFSET(0x188C8BC0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_ONCLOSEDIALOG_OFFSET UNITYSDK_OFFSET(0x188CB850)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_PERFORMBINDINGFLOW_OFFSET UNITYSDK_OFFSET(0x188CA550)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_QUERYWEBBINDINGRESULT_OFFSET UNITYSDK_OFFSET(0x188C9B80)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REACTIVATEACCOUNT_OFFSET UNITYSDK_OFFSET(0x188CAE10)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REMOVESPACES_OFFSET UNITYSDK_OFFSET(0x188CA510)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTBINDTHIRDPARTY_OFFSET UNITYSDK_OFFSET(0x188CC750)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTCREATEACTIONTICKET_OFFSET UNITYSDK_OFFSET(0x188C9AA0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTGETACTIONTICKETINFO_OFFSET UNITYSDK_OFFSET(0x188C9C00)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTLOGINBYACTIONTICKET_OFFSET UNITYSDK_OFFSET(0x188CBF50)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTREACTIVATEACCOUNT_OFFSET UNITYSDK_OFFSET(0x188CC310)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_REQUESTVERIFYCAPTCHA_OFFSET UNITYSDK_OFFSET(0x188CA740)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_RISKCHECK_OFFSET UNITYSDK_OFFSET(0x188CB260)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_SHOWACCOUNTPRIVACYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x188CBC60)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_SHOWACCOUNTUSERAGREEMENT_OFFSET UNITYSDK_OFFSET(0x188CB980)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_SHOWBINDSUCCESSDIALOG_OFFSET UNITYSDK_OFFSET(0x188C98A0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_SHOWWELCOMEDIALOG_OFFSET UNITYSDK_OFFSET(0x188C8E50)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_STARTACCOUNTBINDING_OFFSET UNITYSDK_OFFSET(0x188C8B20)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_STARTWEBBINDINGRESULTQUERYLOOP_OFFSET UNITYSDK_OFFSET(0x188CA070)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_STOPWEBBINDINGRESULTQUERYLOOP_OFFSET UNITYSDK_OFFSET(0x188CA1F0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER_UPDATEQRCODE_OFFSET UNITYSDK_OFFSET(0x188C95D0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_0_OFFSET UNITYSDK_OFFSET(0x188CCE90)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_1_OFFSET UNITYSDK_OFFSET(0x188CCF20)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_2_OFFSET UNITYSDK_OFFSET(0x188CD060)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_3_OFFSET UNITYSDK_OFFSET(0x188CD110)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__BINDEXISTINGACCOUNT_B__34_4_OFFSET UNITYSDK_OFFSET(0x188CD1B0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x188C88E0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__PERFORMBINDINGFLOW_B__44_0_OFFSET UNITYSDK_OFFSET(0x188CD930)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__QUERYWEBBINDINGRESULT_B__40_0_OFFSET UNITYSDK_OFFSET(0x188CD3E0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWBINDSUCCESSDIALOG_B__37_0_OFFSET UNITYSDK_OFFSET(0x188CD2C0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWBINDSUCCESSDIALOG_B__37_1_OFFSET UNITYSDK_OFFSET(0x188CD350)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWWELCOMEDIALOG_B__33_0_OFFSET UNITYSDK_OFFSET(0x188CCBF0)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWWELCOMEDIALOG_B__33_1_OFFSET UNITYSDK_OFFSET(0x188CCC80)
#define MIHOYO_SDK_WINDOWS_OS_BINDMANAGER__SHOWWELCOMEDIALOG_B__33_2_OFFSET UNITYSDK_OFFSET(0x188CCE00)

namespace MiHoYo::SDK::Windows::OS
{
	inline static constexpr unsigned int BindManager_TypeDefinitionIndex = 18865;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Windows::OS::BindManager**)Il2CppClass::FromTypeDefinitionIndex(BindManager_TypeDefinitionIndex)->GetStaticField(0xB0C0);
		}
		...
		::System::String* H5LOG_REPORT_MODULE; // 0x18
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _commonHeaders; // 0x38
		::MiHoYo::SDK::UI::OS::IWinBindingWelcomeDialog* _bindingWelcomeDialog; // 0x40
		::MiHoYo::SDK::UI::OS::IWinAccountBindingDialog* _accountBindingDialog; // 0x48
		::System::String* _userId; // 0x50
		::System::Action_1<::System::Boolean>* _processCompletedCallback; // 0x58
		::UnityEngine::Coroutine* _webBindingResultQueryCoroutine; // 0x60
		::System::String* _userEmail; // 0x68
		::System::String* _loginTicket; // 0x70
		::System::String* _sToken; // 0x78
		::MiHoYo::SDK::JSONObject* _captchaVerifyCombination; // 0x80
		::System::String* _webTicket; // 0x88
