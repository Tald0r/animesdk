...
#define MIHOYO_SDK_WEBDELEGATE_LOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1828FB40)
#define MIHOYO_SDK_WEBDELEGATE_LOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1828FB80)
#define MIHOYO_SDK_WEBDELEGATE_LOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1828F5C0)
#define MIHOYO_SDK_WEBDELEGATE_LOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1828F5B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_LoadDelegate_TypeDefinitionIndex = 17844;
