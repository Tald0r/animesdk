...
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONUNIWEBVIEWMESSAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19541220)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONUNIWEBVIEWMESSAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x195412A0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONUNIWEBVIEWMESSAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19540A40)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONUNIWEBVIEWMESSAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19540A20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKWebView_OnUniWebViewMessageDelegate_TypeDefinitionIndex = 34827;
