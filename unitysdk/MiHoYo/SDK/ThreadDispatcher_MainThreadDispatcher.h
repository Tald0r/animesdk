...
#define MIHOYO_SDK_THREADDISPATCHER_MAINTHREADDISPATCHER_DISPATCHTOMAINTHREAD_OFFSET UNITYSDK_OFFSET(0x186A4C30)
#define MIHOYO_SDK_THREADDISPATCHER_MAINTHREADDISPATCHER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x186A4F40)
#define MIHOYO_SDK_THREADDISPATCHER_MAINTHREADDISPATCHER_UPDATE_OFFSET UNITYSDK_OFFSET(0x186A4D00)
#define MIHOYO_SDK_THREADDISPATCHER_MAINTHREADDISPATCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x186A4BA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ThreadDispatcher_MainThreadDispatcher_TypeDefinitionIndex = 18554;
