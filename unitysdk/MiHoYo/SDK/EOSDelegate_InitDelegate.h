...
#define MIHOYO_SDK_EOSDELEGATE_INITDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A163E0)
#define MIHOYO_SDK_EOSDELEGATE_INITDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A16410)
#define MIHOYO_SDK_EOSDELEGATE_INITDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A15EA0)
#define MIHOYO_SDK_EOSDELEGATE_INITDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A15E90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_InitDelegate_TypeDefinitionIndex = 17734;
