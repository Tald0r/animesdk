...
#define MIHOYO_SDK_JSONSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x18C867D0)
#define MIHOYO_SDK_JSONSTRING_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18C86700)
#define MIHOYO_SDK_JSONSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x18C86A00)
#define MIHOYO_SDK_JSONSTRING_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x18C866F0)
#define MIHOYO_SDK_JSONSTRING_GET_TAG_OFFSET UNITYSDK_OFFSET(0x18C866E0)
#define MIHOYO_SDK_JSONSTRING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x18C86720)
#define MIHOYO_SDK_JSONSTRING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x18C86730)
#define MIHOYO_SDK_JSONSTRING_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x18C86740)
#define MIHOYO_SDK_JSONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x18C847B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int JSONString_TypeDefinitionIndex = 18659;
