...
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C83200)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C83240)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C7D8A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_CREATESESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C831E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_CreateSessionDelegate_TypeDefinitionIndex = 18160;
