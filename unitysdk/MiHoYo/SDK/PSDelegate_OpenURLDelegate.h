...
#define MIHOYO_SDK_PSDELEGATE_OPENURLDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BAA770)
#define MIHOYO_SDK_PSDELEGATE_OPENURLDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BAA7B0)
#define MIHOYO_SDK_PSDELEGATE_OPENURLDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BAA1D0)
#define MIHOYO_SDK_PSDELEGATE_OPENURLDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAA1C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_OpenURLDelegate_TypeDefinitionIndex = 17747;
