...
#define MIHOYO_SDK_SDKDELEGATE_ISEDITORDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x187946C0)
#define MIHOYO_SDK_SDKDELEGATE_ISEDITORDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187946F0)
#define MIHOYO_SDK_SDKDELEGATE_ISEDITORDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18794420)
#define MIHOYO_SDK_SDKDELEGATE_ISEDITORDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18794410)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_IsEditorDelegate_TypeDefinitionIndex = 17801;
