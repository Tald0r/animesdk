...
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL_GETNATIVETASKFALLBACKKEY_OFFSET UNITYSDK_OFFSET(0x180E67D0)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x180D9E50)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL_ISNATIVETASKSWITCHENABLE_OFFSET UNITYSDK_OFFSET(0x180E6B10)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL_LOADBOXCONFIG_OFFSET UNITYSDK_OFFSET(0x180E6B90)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL_ONSYNCDATATONATIVE_OFFSET UNITYSDK_OFFSET(0x180E6D60)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL_PACKPROTOCOLPARAMSFORNATIVE_OFFSET UNITYSDK_OFFSET(0x180E6E50)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL_RECORDNATIVEFALLBACKFLAG_OFFSET UNITYSDK_OFFSET(0x180E7830)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL_REMOVENATIVEFALLBACKFLAG_OFFSET UNITYSDK_OFFSET(0x180E78B0)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x180E6770)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL_SYNCCURENVCONFIGTONATIVE_OFFSET UNITYSDK_OFFSET(0x180E6D70)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL_TRYSHOWLAUNCHERPROTOCOLCOMPLIANCE_OFFSET UNITYSDK_OFFSET(0x180D9F30)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x180E78D0)
#define MIHOYO_SDK_PROTOCOLMANAGER_NATIVEPROTOCOL__CTOR_OFFSET UNITYSDK_OFFSET(0x180E6660)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ProtocolManager_NativeProtocol_TypeDefinitionIndex = 18055;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::ProtocolManager_NativeProtocol**)Il2CppClass::FromTypeDefinitionIndex(ProtocolManager_NativeProtocol_TypeDefinitionIndex)->GetStaticField(0xAB50);
		}
