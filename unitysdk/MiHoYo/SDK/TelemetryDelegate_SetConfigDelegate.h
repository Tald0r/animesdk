...
#define MIHOYO_SDK_TELEMETRYDELEGATE_SETCONFIGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18AA7130)
#define MIHOYO_SDK_TELEMETRYDELEGATE_SETCONFIGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18AA71D0)
#define MIHOYO_SDK_TELEMETRYDELEGATE_SETCONFIGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18AA6D40)
#define MIHOYO_SDK_TELEMETRYDELEGATE_SETCONFIGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA6D30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TelemetryDelegate_SetConfigDelegate_TypeDefinitionIndex = 17716;
