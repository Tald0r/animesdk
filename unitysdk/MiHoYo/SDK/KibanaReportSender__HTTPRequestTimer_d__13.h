...
#define MIHOYO_SDK_KIBANAREPORTSENDER__HTTPREQUESTTIMER_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19D54F00)
#define MIHOYO_SDK_KIBANAREPORTSENDER__HTTPREQUESTTIMER_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19D54F60)
#define MIHOYO_SDK_KIBANAREPORTSENDER__HTTPREQUESTTIMER_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19D54FC0)
#define MIHOYO_SDK_KIBANAREPORTSENDER__HTTPREQUESTTIMER_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19D54F70)
#define MIHOYO_SDK_KIBANAREPORTSENDER__HTTPREQUESTTIMER_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D54EF0)
#define MIHOYO_SDK_KIBANAREPORTSENDER__HTTPREQUESTTIMER_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x19D54EE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaReportSender__HTTPRequestTimer_d__13_TypeDefinitionIndex = 34814;
