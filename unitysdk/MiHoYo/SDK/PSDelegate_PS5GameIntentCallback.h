...
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C2A180)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C2A1B0)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C292B0)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C2A160)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_PS5GameIntentCallback_TypeDefinitionIndex = 18290;
