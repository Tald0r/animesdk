...
#define MIHOYO_SDK_WEBDELEGATE_SETWEBCOOKIESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17AE2AC0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBCOOKIESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17AE2AF0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBCOOKIESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17AE25C0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBCOOKIESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17AE25B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetWebCookiesDelegate_TypeDefinitionIndex = 17880;
