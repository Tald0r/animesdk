...
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKPROGRESSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x199C8180)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKPROGRESSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x199C8250)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKPROGRESSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x199C7D40)
#define MIHOYO_SDK_HOYOSDKNETWORKNATIVE_HOYONETWORKPROGRESSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199C6E50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoSDKNetworkNative_HoYoNetworkProgressCallback_TypeDefinitionIndex = 34407;
