...
#define MIHOYO_SDK_LOGINRECORDBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9FA50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int LoginRecordBoxConfig_TypeDefinitionIndex = 18451;
