...
#define MIHOYO_SDK_MIHOYOSDK___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF3270)
#define MIHOYO_SDK_MIHOYOSDK___C__DISPLAYCLASS20_0__INVOKE_B__0_OFFSET UNITYSDK_OFFSET(0x19AF3280)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDK___c__DisplayClass20_0_TypeDefinitionIndex = 33576;
