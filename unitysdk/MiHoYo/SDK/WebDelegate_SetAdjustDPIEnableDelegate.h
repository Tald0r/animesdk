...
#define MIHOYO_SDK_WEBDELEGATE_SETADJUSTDPIENABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C9A4D0)
#define MIHOYO_SDK_WEBDELEGATE_SETADJUSTDPIENABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C9A530)
#define MIHOYO_SDK_WEBDELEGATE_SETADJUSTDPIENABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C99EE0)
#define MIHOYO_SDK_WEBDELEGATE_SETADJUSTDPIENABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C99EC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetAdjustDPIEnableDelegate_TypeDefinitionIndex = 18381;
