...
#define MIHOYO_SDK_NOTICECOOKIEVALUEMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18A99A10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NoticeCookieValueModel_TypeDefinitionIndex = 17591;
