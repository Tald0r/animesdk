...
#define MIHOYO_SDK_PLUGINUI_PLUGINUIBINDSERVICE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x18A9F330)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIBINDSERVICE_ONCREATESERVICE_OFFSET UNITYSDK_OFFSET(0x18A9F410)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIBINDSERVICE_SHOWBINDMAILPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18AA0880)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIBINDSERVICE_SHOWGUESTBINDPHONEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18AA0410)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIBINDSERVICE_SHOWMHYBINDPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18A9FFA0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIBINDSERVICE_SHOWOVERSEABINDACCOUNTPOP_OFFSET UNITYSDK_OFFSET(0x18A9F5E0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIBINDSERVICE_SHOWOVERSEAGUESTBINDMAILPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18A9F960)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIBINDSERVICE_SHOWOVERSEAVERIFYPHONEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18AA0F30)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIBINDSERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18AA1730)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIBINDSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9F320)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int PluginUIBindService_TypeDefinitionIndex = 18769;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::PluginUIBindService**)Il2CppClass::FromTypeDefinitionIndex(PluginUIBindService_TypeDefinitionIndex)->GetStaticField(0x9190);
		}
