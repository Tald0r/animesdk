...
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_CLEARACTIONS_OFFSET UNITYSDK_OFFSET(0x188F6880)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_CLOSEALL_OFFSET UNITYSDK_OFFSET(0x188F6FB0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_CLOSEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x188F6F40)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x188F5EC0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_ISPLUGINUIVISIBLE_OFFSET UNITYSDK_OFFSET(0x188F6540)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_ISUSINGPLUGINUI_OFFSET UNITYSDK_OFFSET(0x188F6350)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_PAUSEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x188F5FB0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_PLUGINUIENABLE_OFFSET UNITYSDK_OFFSET(0x188F6480)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_POP_OFFSET UNITYSDK_OFFSET(0x188F7190)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_REGISTERPLUGINUI_OFFSET UNITYSDK_OFFSET(0x188F6050)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_RESUMEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x188F6000)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_SAVEACTIONS_OFFSET UNITYSDK_OFFSET(0x188F6610)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_SENDPLUGINUIMESSAGE_OFFSET UNITYSDK_OFFSET(0x188F6B20)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER_SENDPLUGINUINOTIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x188F6E10)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x188F72D0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x188F5D20)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int PluginUIManager_TypeDefinitionIndex = 18884;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::PluginUIManager**)Il2CppClass::FromTypeDefinitionIndex(PluginUIManager_TypeDefinitionIndex)->GetStaticField(0xAFA0);
		}
