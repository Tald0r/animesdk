...
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUILISTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFA7B0)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int MiHoYoSDKUIListItem_TypeDefinitionIndex = 34104;
