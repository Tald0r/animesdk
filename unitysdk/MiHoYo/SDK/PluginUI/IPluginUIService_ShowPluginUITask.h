...
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_SHOWPLUGINUITASK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BAAF00)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_SHOWPLUGINUITASK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BAAF40)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_SHOWPLUGINUITASK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BAA980)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_SHOWPLUGINUITASK__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAA970)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int IPluginUIService_ShowPluginUITask_TypeDefinitionIndex = 18776;
