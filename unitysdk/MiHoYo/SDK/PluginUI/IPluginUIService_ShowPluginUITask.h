...
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_SHOWPLUGINUITASK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C93630)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_SHOWPLUGINUITASK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C93670)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_SHOWPLUGINUITASK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C930B0)
#define MIHOYO_SDK_PLUGINUI_IPLUGINUISERVICE_SHOWPLUGINUITASK__CTOR_OFFSET UNITYSDK_OFFSET(0x18C93090)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int IPluginUIService_ShowPluginUITask_TypeDefinitionIndex = 19375;
