...
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x18945E40)
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE_ONCREATESERVICE_OFFSET UNITYSDK_OFFSET(0x18945F20)
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE_SHOWBINDMOBILEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18946C00)
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE_SHOWDEVICELOGINTIPSPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18946030)
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE_SHOWVERIFYMAILPLUGINUI_OFFSET UNITYSDK_OFFSET(0x189470E0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18947740)
#define MIHOYO_SDK_PLUGINUI_PLUGINUISAFESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x18945E30)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int PluginUISafeService_TypeDefinitionIndex = 19381;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::PluginUISafeService**)Il2CppClass::FromTypeDefinitionIndex(PluginUISafeService_TypeDefinitionIndex)->GetStaticField(0xAF40);
		}
