...
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ADDTIME_OFFSET UNITYSDK_OFFSET(0x17EFC150)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_BRIDGE2NATIVE_1_OFFSET UNITYSDK_OFFSET(0x17EFB9F0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_BRIDGE2NATIVE_2_OFFSET UNITYSDK_OFFSET(0x17EFAD30)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_BRIDGE2NATIVE_OFFSET UNITYSDK_OFFSET(0x17EFB7F0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x17EFA290)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_GETNATIVEUICOUNT_OFFSET UNITYSDK_OFFSET(0x17EFAB50)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_GETPLUGINUI_OFFSET UNITYSDK_OFFSET(0x17EFA9B0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_GETREGISTEREDPLUGINUINAMES_OFFSET UNITYSDK_OFFSET(0x17EFA6E0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ISREGISTEREDPLUGINUI_OFFSET UNITYSDK_OFFSET(0x17EFAB30)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ISUSINGPLUGINUI_OFFSET UNITYSDK_OFFSET(0x17EFA990)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_MANUALLYSHOWPLUGINUI_OFFSET UNITYSDK_OFFSET(0x17EFA910)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ONCLOSEUI_OFFSET UNITYSDK_OFFSET(0x17EFBE00)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ONNOTIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x17EFC020)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ONSHOWUI_OFFSET UNITYSDK_OFFSET(0x17EFBD00)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_ONUPDATEUI_OFFSET UNITYSDK_OFFSET(0x17EFBEF0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_PLUGINUICLEARACTIONS_OFFSET UNITYSDK_OFFSET(0x17EFB3F0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_PLUGINUICLOSE_OFFSET UNITYSDK_OFFSET(0x17EFB210)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_PLUGINUINOTIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x17EFB7B0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_PLUGINUISHOW_OFFSET UNITYSDK_OFFSET(0x17EFAB80)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_PLUGINUIUPDATEELEMENTS_OFFSET UNITYSDK_OFFSET(0x17EFB760)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_REGISTERPLUGINUI_1_OFFSET UNITYSDK_OFFSET(0x17EFA400)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER_REGISTERPLUGINUI_OFFSET UNITYSDK_OFFSET(0x17EFA3E0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17EFC1B0)
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUIMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x17EFA130)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int MiHoYoSDKUIManager_TypeDefinitionIndex = 34106;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::MiHoYoSDKUIManager**)Il2CppClass::FromTypeDefinitionIndex(MiHoYoSDKUIManager_TypeDefinitionIndex)->GetStaticField(0x24340);
		}
