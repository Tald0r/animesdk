...
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON_INSTANCE_OFFSET UNITYSDK_OFFSET(0x188073B0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x18807830)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON_ONSHOW_OFFSET UNITYSDK_OFFSET(0x18807510)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON_SHOW_OFFSET UNITYSDK_OFFSET(0x188075D0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON__CTOR_OFFSET UNITYSDK_OFFSET(0x18807490)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON__SHOW_B__4_0_OFFSET UNITYSDK_OFFSET(0x18807970)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON__SHOW_B__4_1_OFFSET UNITYSDK_OFFSET(0x188079B0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON__SHOW_B__4_2_OFFSET UNITYSDK_OFFSET(0x188079F0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKREALPERSON__SHOW_B__4_3_OFFSET UNITYSDK_OFFSET(0x18807A30)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int HoYoSDKRealPerson_TypeDefinitionIndex = 33995;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::HoYoSDKRealPerson**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKRealPerson_TypeDefinitionIndex)->GetStaticField(0x24720);
		}
