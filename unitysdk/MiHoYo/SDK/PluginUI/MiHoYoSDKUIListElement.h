...
#define MIHOYO_SDK_PLUGINUI_MIHOYOSDKUILISTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19AFA7A0)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int MiHoYoSDKUIListElement_TypeDefinitionIndex = 34105;
