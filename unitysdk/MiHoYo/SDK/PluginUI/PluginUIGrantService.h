...
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1820EE60)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE_ONCREATESERVICE_OFFSET UNITYSDK_OFFSET(0x1820EF40)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE_SHOWGRANTPHONEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1820F040)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE_SHOWOVERSEAGRANTMAILPLUGINUI_OFFSET UNITYSDK_OFFSET(0x1820F730)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE_SHOWOVERSEAGRANTPHONEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18210070)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x182109B0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIGRANTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1820EE50)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int PluginUIGrantService_TypeDefinitionIndex = 18772;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::PluginUIGrantService**)Il2CppClass::FromTypeDefinitionIndex(PluginUIGrantService_TypeDefinitionIndex)->GetStaticField(0xA5D0);
		}
