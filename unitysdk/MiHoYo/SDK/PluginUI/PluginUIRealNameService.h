...
#define MIHOYO_SDK_PLUGINUI_PLUGINUIREALNAMESERVICE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x18CE8530)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIREALNAMESERVICE_ONCREATESERVICE_OFFSET UNITYSDK_OFFSET(0x18CE8610)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIREALNAMESERVICE_SHOWGRANTMAILPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18CE9AF0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIREALNAMESERVICE_SHOWGRANTPHONEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18CE9270)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIREALNAMESERVICE_SHOWREALNAMEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18CE87A0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIREALNAMESERVICE_SHOWREALPERSONPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18CEA370)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIREALNAMESERVICE_SHOWSECONDREALNAMEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18CE8CE0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIREALNAMESERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18CEAAB0)
#define MIHOYO_SDK_PLUGINUI_PLUGINUIREALNAMESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE8520)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int PluginUIRealNameService_TypeDefinitionIndex = 19380;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::PluginUIRealNameService**)Il2CppClass::FromTypeDefinitionIndex(PluginUIRealNameService_TypeDefinitionIndex)->GetStaticField(0xB120);
		}
