...
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_CACHECOOKIE_OFFSET UNITYSDK_OFFSET(0x175F4FB0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_CLEARCOOKIES_OFFSET UNITYSDK_OFFSET(0x175F4D70)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_CLOSEWEB_OFFSET UNITYSDK_OFFSET(0x175F3210)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_EVALUATEJSSCRIPTS_OFFSET UNITYSDK_OFFSET(0x175F53F0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_GETWEBHANDLER_OFFSET UNITYSDK_OFFSET(0x175F0DC0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_HANDLECUSTOMNOTIFYMSG_OFFSET UNITYSDK_OFFSET(0x175F3810)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_INSTANCE_OFFSET UNITYSDK_OFFSET(0x175EE5C0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_LOADURL_OFFSET UNITYSDK_OFFSET(0x175EFF60)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_NOTIFYERROR_OFFSET UNITYSDK_OFFSET(0x175F35E0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONBEFOREBACK_OFFSET UNITYSDK_OFFSET(0x175F2DE0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONBEFORECLOSE_OFFSET UNITYSDK_OFFSET(0x175F3080)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONBEFOREDESTROY_OFFSET UNITYSDK_OFFSET(0x175F3570)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONBEFORENAVIGATIONMESSAGE_OFFSET UNITYSDK_OFFSET(0x175F27D0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x175EF690)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONGETBRIDGEMESSAGE_OFFSET UNITYSDK_OFFSET(0x175F2B10)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONGETUNIWEBVIEWMESSAGE_OFFSET UNITYSDK_OFFSET(0x175F2090)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONNATIVEREADY_OFFSET UNITYSDK_OFFSET(0x175F23D0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONNOTICECLOSE_OFFSET UNITYSDK_OFFSET(0x175F10B0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONNOTICEPAGEFINISH_OFFSET UNITYSDK_OFFSET(0x175F1290)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONPAGECLOSE_OFFSET UNITYSDK_OFFSET(0x175F1310)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONPAGEERROR_OFFSET UNITYSDK_OFFSET(0x175F1D30)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONPAGEFINISH_OFFSET UNITYSDK_OFFSET(0x175F0B10)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONRECEIVEMESSAGE_OFFSET UNITYSDK_OFFSET(0x175F37D0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_ONSHOW_OFFSET UNITYSDK_OFFSET(0x175EE9B0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_PROCCESSCACHEDEVENT_OFFSET UNITYSDK_OFFSET(0x175F41C0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_PROCCESSEVENT_OFFSET UNITYSDK_OFFSET(0x175F3AD0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_REMOVEWEB_OFFSET UNITYSDK_OFFSET(0x175F1930)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_SETCOOKIES_OFFSET UNITYSDK_OFFSET(0x175F23E0)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW_SHOW_OFFSET UNITYSDK_OFFSET(0x175EEA70)
#define MIHOYO_SDK_PLUGINUI_HOYOSDKWEBVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x175EE640)

namespace MiHoYo::SDK::PluginUI
{
	inline static constexpr unsigned int HoYoSDKWebView_TypeDefinitionIndex = 34998;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PluginUI::HoYoSDKWebView**)Il2CppClass::FromTypeDefinitionIndex(HoYoSDKWebView_TypeDefinitionIndex)->GetStaticField(0x26080);
		}
		// static const ::System::Int32 INVALIE_WEBVIEW_HANDLER = 0xFFFFFFFF; // 0x0
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::MiHoYo::SDK::MiHoYoSDKWebView*>* m_mapHandler2WebView; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::String*>* m_mapHandle2Scripts; // 0x20
		...
		::System::Collections::Generic::List_1<::System::String*>* m_listBridgeMessage; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::Dictionary_2<::System::String*, ::MiHoYo::SDK::PluginUI::HoYoSDKWebView_CookieInfo*>*>* m_mapHandle2Cookies; // 0x38
