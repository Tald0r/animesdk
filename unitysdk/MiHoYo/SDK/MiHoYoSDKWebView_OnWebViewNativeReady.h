...
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWNATIVEREADY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x185102D0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWNATIVEREADY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18510300)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWNATIVEREADY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1850FDD0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWNATIVEREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x1850FDB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKWebView_OnWebViewNativeReady_TypeDefinitionIndex = 34832;
