...
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWNATIVEREADY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17EF72B0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWNATIVEREADY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17EF72E0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWNATIVEREADY_INVOKE_OFFSET UNITYSDK_OFFSET(0x17EF6DB0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWNATIVEREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x17EF6DA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKWebView_OnWebViewNativeReady_TypeDefinitionIndex = 33830;
