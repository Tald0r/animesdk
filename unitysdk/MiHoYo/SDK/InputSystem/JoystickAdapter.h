...
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_GETKEYDOWN_OFFSET UNITYSDK_OFFSET(0x1B03F700)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_GETKEYUP_OFFSET UNITYSDK_OFFSET(0x1B03F8C0)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_GETKEY_OFFSET UNITYSDK_OFFSET(0x1B03F7E0)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B03CFB0)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_REGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x1B03F9A0)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B03F6C0)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B03F6B0)

namespace MiHoYo::SDK::InputSystem
{
	inline static constexpr unsigned int JoystickAdapter_TypeDefinitionIndex = 17552;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::InputSystem::JoystickAdapter**)Il2CppClass::FromTypeDefinitionIndex(JoystickAdapter_TypeDefinitionIndex)->GetStaticField(0x8EA0);
		}
