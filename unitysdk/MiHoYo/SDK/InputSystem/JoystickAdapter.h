...
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_GETKEYDOWN_OFFSET UNITYSDK_OFFSET(0x1B64F780)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_GETKEYUP_OFFSET UNITYSDK_OFFSET(0x1B64F940)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_GETKEY_OFFSET UNITYSDK_OFFSET(0x1B64F860)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B64D030)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_REGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x1B64FA20)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B64F740)
#define MIHOYO_SDK_INPUTSYSTEM_JOYSTICKADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B64F730)

namespace MiHoYo::SDK::InputSystem
{
	inline static constexpr unsigned int JoystickAdapter_TypeDefinitionIndex = 18052;
