...
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETIMECOMPOSITIONMODE_OFFSET UNITYSDK_OFFSET(0x1B03EB20)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETMOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B03E6A0)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETMOUSESCROLLDELTA_OFFSET UNITYSDK_OFFSET(0x1B03E8F0)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETSIMULATEMOUSEWITHTOUCHES_OFFSET UNITYSDK_OFFSET(0x1B03F1B0)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GETTOUCHCOUNT_OFFSET UNITYSDK_OFFSET(0x1B03EF80)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B03D3E0)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_REGISTERSERVICE_OFFSET UNITYSDK_OFFSET(0x1B040050)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_SETIMECOMPOSITIONMODE_OFFSET UNITYSDK_OFFSET(0x1B03ED50)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_SETSIMULATEMOUSEWITHTOUCHES_OFFSET UNITYSDK_OFFSET(0x1B03F3E0)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B040010)
#define MIHOYO_SDK_INPUTSYSTEM_PROPERTYADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B040000)

namespace MiHoYo::SDK::InputSystem
{
	inline static constexpr unsigned int PropertyAdapter_TypeDefinitionIndex = 17555;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::InputSystem::PropertyAdapter**)Il2CppClass::FromTypeDefinitionIndex(PropertyAdapter_TypeDefinitionIndex)->GetStaticField(0x8ED0);
		}
