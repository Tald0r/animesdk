...
#define MIHOYO_SDK_EOSDELEGATE_SETCMDLINEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18892880)
#define MIHOYO_SDK_EOSDELEGATE_SETCMDLINEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x188928B0)
#define MIHOYO_SDK_EOSDELEGATE_SETCMDLINEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18892340)
#define MIHOYO_SDK_EOSDELEGATE_SETCMDLINEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18892320)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_SetCmdLineDelegate_TypeDefinitionIndex = 18247;
