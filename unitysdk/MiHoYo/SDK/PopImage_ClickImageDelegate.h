...
#define MIHOYO_SDK_POPIMAGE_CLICKIMAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18AA1C80)
#define MIHOYO_SDK_POPIMAGE_CLICKIMAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18AA1CB0)
#define MIHOYO_SDK_POPIMAGE_CLICKIMAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18AA1780)
#define MIHOYO_SDK_POPIMAGE_CLICKIMAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA1770)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PopImage_ClickImageDelegate_TypeDefinitionIndex = 18269;
