...
#define MIHOYO_SDK_SDKDELEGATE_WEBEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BAE360)
#define MIHOYO_SDK_SDKDELEGATE_WEBEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BAE3A0)
#define MIHOYO_SDK_SDKDELEGATE_WEBEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BADDE0)
#define MIHOYO_SDK_SDKDELEGATE_WEBEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BADDD0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_WebEventDelegate_TypeDefinitionIndex = 17800;
