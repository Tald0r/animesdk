...
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A9EFE0)
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A9F020)
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A9EA60)
#define MIHOYO_SDK_PSDELEGATE_SHOWSYSMESSAGEDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9EA50)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ShowSysMessageDialogDelegate_TypeDefinitionIndex = 17768;
