...
#define MIHOYO_SDK_SECURITYTUNNEL_FILE_RANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0843C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_File_Range_TypeDefinitionIndex = 34666;
