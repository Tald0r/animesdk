...
#define MIHOYO_SDK_ACCOUNTPLATCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18B8B680)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatConfig_TypeDefinitionIndex = 17920;
