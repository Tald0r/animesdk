...
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS49_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1869DCA0)
#define MIHOYO_SDK_PROTOCOLMANAGER___C__DISPLAYCLASS49_0__SHOWTHIRDPRIVACY_B__0_OFFSET UNITYSDK_OFFSET(0x186A1DB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ProtocolManager___c__DisplayClass49_0_TypeDefinitionIndex = 18576;
