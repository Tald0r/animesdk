...
#define MIHOYO_SDK_EOSDELEGATE_ISEOSCHANNELDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x188922C0)
#define MIHOYO_SDK_EOSDELEGATE_ISEOSCHANNELDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x188922F0)
#define MIHOYO_SDK_EOSDELEGATE_ISEOSCHANNELDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18892020)
#define MIHOYO_SDK_EOSDELEGATE_ISEOSCHANNELDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18892000)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_IsEOSChannelDelegate_TypeDefinitionIndex = 18248;
