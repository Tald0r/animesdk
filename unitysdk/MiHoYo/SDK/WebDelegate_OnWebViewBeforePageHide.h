...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFOREPAGEHIDE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18E4C190)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFOREPAGEHIDE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18E4C1C0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFOREPAGEHIDE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18E4BC90)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWBEFOREPAGEHIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E4BC70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewBeforePageHide_TypeDefinitionIndex = 18348;
