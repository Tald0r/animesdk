...
#define MIHOYO_SDK_APMC_LOGBACK_LOGPROACTIVEUPLOADCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x190CA560)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int APMC_LOGBACK_LogProactiveUploadConfig_TypeDefinitionIndex = 33805;
