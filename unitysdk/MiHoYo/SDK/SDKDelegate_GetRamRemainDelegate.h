...
#define MIHOYO_SDK_SDKDELEGATE_GETRAMREMAINDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1845A0A0)
#define MIHOYO_SDK_SDKDELEGATE_GETRAMREMAINDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1845A0D0)
#define MIHOYO_SDK_SDKDELEGATE_GETRAMREMAINDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18459E00)
#define MIHOYO_SDK_SDKDELEGATE_GETRAMREMAINDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18459DF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetRamRemainDelegate_TypeDefinitionIndex = 17812;
