...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGECLOSE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18E4C6F0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGECLOSE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18E4C720)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGECLOSE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18E4C1F0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGECLOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E4C1D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewPageClose_TypeDefinitionIndex = 18347;
