...
#define MIHOYO_SDK_SDKDELEGATE_ISINSTACKTOPDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18286690)
#define MIHOYO_SDK_SDKDELEGATE_ISINSTACKTOPDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x182866C0)
#define MIHOYO_SDK_SDKDELEGATE_ISINSTACKTOPDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18286150)
#define MIHOYO_SDK_SDKDELEGATE_ISINSTACKTOPDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18286140)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_IsInStackTopDelegate_TypeDefinitionIndex = 17829;
