...
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BADD90)
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BADDC0)
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BAD850)
#define MIHOYO_SDK_SDKDELEGATE_LOADFILEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAD840)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_LoadFileDelegate_TypeDefinitionIndex = 17804;
