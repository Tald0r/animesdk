...
#define MIHOYO_SDK_EOSPARAMETERSMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1846F640)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSParametersModel_TypeDefinitionIndex = 18419;
