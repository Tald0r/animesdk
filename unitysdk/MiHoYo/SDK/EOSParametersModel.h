...
#define MIHOYO_SDK_EOSPARAMETERSMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x17E8A980)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSParametersModel_TypeDefinitionIndex = 17912;
