...
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_ENUMWINDOWS_OFFSET UNITYSDK_OFFSET(0x1953F360)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_GETPARENT_OFFSET UNITYSDK_OFFSET(0x1953F430)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_GETPROCESSWND_OFFSET UNITYSDK_OFFSET(0x1953F690)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_GETWINDOWTHREADPROCESSID_OFFSET UNITYSDK_OFFSET(0x1953F500)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_ISWINDOWVISIBLE_OFFSET UNITYSDK_OFFSET(0x1953F610)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKINIT_OFFSET UNITYSDK_OFFSET(0x1953EFC0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKLOGIN_OFFSET UNITYSDK_OFFSET(0x1953F110)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKLOGOUT_OFFSET UNITYSDK_OFFSET(0x1953F2E0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKPAY_OFFSET UNITYSDK_OFFSET(0x1953F1A0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKSTARTHEARTBEAT_OFFSET UNITYSDK_OFFSET(0x1953F250)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SDKUNINIT_OFFSET UNITYSDK_OFFSET(0x1953F090)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_SETLASTERROR_OFFSET UNITYSDK_OFFSET(0x1953F590)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_WINDOWPROCCESS_OFFSET UNITYSDK_OFFSET(0x1953EC80)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1953F960)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1953F950)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKBiliBiliInterface_TypeDefinitionIndex = 34586;
	...
	public:
		...
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(MiHoYoSDKBiliBiliInterface_TypeDefinitionIndex)->GetStaticField(0x8300);
		}
