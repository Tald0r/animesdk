...
#define MIHOYO_SDK_PSDELEGATE_UNLOCKTROPHYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B71AA0)
#define MIHOYO_SDK_PSDELEGATE_UNLOCKTROPHYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B71B10)
#define MIHOYO_SDK_PSDELEGATE_UNLOCKTROPHYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B71760)
#define MIHOYO_SDK_PSDELEGATE_UNLOCKTROPHYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B71740)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_UnlockTrophyDelegate_TypeDefinitionIndex = 18271;
