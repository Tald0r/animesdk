...
#define MIHOYO_SDK_WEBDELEGATE_SETURLQUERYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B78160)
#define MIHOYO_SDK_WEBDELEGATE_SETURLQUERYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B78190)
#define MIHOYO_SDK_WEBDELEGATE_SETURLQUERYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B77C60)
#define MIHOYO_SDK_WEBDELEGATE_SETURLQUERYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B77C40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetUrlQueryDelegate_TypeDefinitionIndex = 18386;
