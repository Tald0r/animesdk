...
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER_GETBYTES_OFFSET UNITYSDK_OFFSET(0x8AFC20)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER_GET_FIXEDLENGTH_OFFSET UNITYSDK_OFFSET(0x19783360)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x8AFB00)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER_GET_WANTSGENERATEDID_OFFSET UNITYSDK_OFFSET(0x8AFB20)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8AFC30)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x322430)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8AFBA0)
#define MIHOYO_SDK_SECURITYTUNNEL_PACKETHEADER__CTOR_OFFSET UNITYSDK_OFFSET(0x8AFB90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_PacketHeader_TypeDefinitionIndex = 33698;
