...
#define MIHOYO_SDK_WEBDELEGATE_SHOWGEETESTV4WEBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17AE3130)
#define MIHOYO_SDK_WEBDELEGATE_SHOWGEETESTV4WEBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17AE31A0)
#define MIHOYO_SDK_WEBDELEGATE_SHOWGEETESTV4WEBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17AE2B10)
#define MIHOYO_SDK_WEBDELEGATE_SHOWGEETESTV4WEBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17AE2B00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_ShowGeetestV4WebDelegate_TypeDefinitionIndex = 17881;
