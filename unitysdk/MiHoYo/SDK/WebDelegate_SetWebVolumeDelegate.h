...
#define MIHOYO_SDK_WEBDELEGATE_SETWEBVOLUMEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18E4D110)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBVOLUMEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18E4D160)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBVOLUMEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18E4CE20)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBVOLUMEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E4CE00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetWebVolumeDelegate_TypeDefinitionIndex = 18377;
