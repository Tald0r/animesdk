...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWNATIVEREADY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x186F60A0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWNATIVEREADY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x186F60D0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWNATIVEREADY_INVOKE_OFFSET UNITYSDK_OFFSET(0x186F5BA0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWNATIVEREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x186F5B90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewNativeReady_TypeDefinitionIndex = 17836;
