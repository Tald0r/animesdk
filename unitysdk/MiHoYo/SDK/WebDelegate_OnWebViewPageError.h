...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BB1090)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BB10C0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BB0B90)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB0B80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewPageError_TypeDefinitionIndex = 17839;
