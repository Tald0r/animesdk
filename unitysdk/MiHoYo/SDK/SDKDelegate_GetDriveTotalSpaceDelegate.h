...
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALSPACEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C95C30)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALSPACEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C95C60)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALSPACEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C956F0)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALSPACEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C956D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetDriveTotalSpaceDelegate_TypeDefinitionIndex = 18317;
