...
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALSPACEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BAD4F0)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALSPACEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BAD520)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALSPACEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BACFB0)
#define MIHOYO_SDK_SDKDELEGATE_GETDRIVETOTALSPACEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BACFA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetDriveTotalSpaceDelegate_TypeDefinitionIndex = 17810;
