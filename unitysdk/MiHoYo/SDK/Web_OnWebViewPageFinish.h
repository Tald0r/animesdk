...
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEFINISH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BE43E0)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEFINISH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BE4420)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEFINISH_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BE3E60)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE3E40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Web_OnWebViewPageFinish_TypeDefinitionIndex = 18736;
