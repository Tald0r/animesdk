...
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BAA840)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BAA870)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B98190)
#define MIHOYO_SDK_PSDELEGATE_PS5GAMEINTENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAA830)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_PS5GameIntentDelegate_TypeDefinitionIndex = 17784;
