...
#define MIHOYO_SDK_PSDELEGATE_DESTROYTROPHYCONTEXTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BD44C0)
#define MIHOYO_SDK_PSDELEGATE_DESTROYTROPHYCONTEXTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BD4510)
#define MIHOYO_SDK_PSDELEGATE_DESTROYTROPHYCONTEXTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BD41D0)
#define MIHOYO_SDK_PSDELEGATE_DESTROYTROPHYCONTEXTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BD41B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_DestroyTrophyContextDelegate_TypeDefinitionIndex = 18273;
