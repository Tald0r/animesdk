...
#define MIHOYO_SDK_PSDELEGATE_DESTROYTROPHYCONTEXTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A9E440)
#define MIHOYO_SDK_PSDELEGATE_DESTROYTROPHYCONTEXTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A9E490)
#define MIHOYO_SDK_PSDELEGATE_DESTROYTROPHYCONTEXTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A9E140)
#define MIHOYO_SDK_PSDELEGATE_DESTROYTROPHYCONTEXTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9E130)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_DestroyTrophyContextDelegate_TypeDefinitionIndex = 17766;
