...
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A084370)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A0843B0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A083DF0)
#define MIHOYO_SDK_REPORTERUTIL_REPORTERTIMER_TIMEOUTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A083DD0)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int ReporterTimer_TimeoutHandler_TypeDefinitionIndex = 34887;
