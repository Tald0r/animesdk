...
#define MIHOYO_SDK_REPORTERUTIL_PERFORMANCEREPORTER_AUTOREPORTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18E21E10)
#define MIHOYO_SDK_REPORTERUTIL_PERFORMANCEREPORTER_AUTOREPORTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18E21E50)
#define MIHOYO_SDK_REPORTERUTIL_PERFORMANCEREPORTER_AUTOREPORTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18E217F0)
#define MIHOYO_SDK_REPORTERUTIL_PERFORMANCEREPORTER_AUTOREPORTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E217E0)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int PerformanceReporter_AutoReportHandler_TypeDefinitionIndex = 33873;
