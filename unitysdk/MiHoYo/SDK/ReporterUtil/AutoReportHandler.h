...
#define MIHOYO_SDK_REPORTERUTIL_AUTOREPORTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190D4AD0)
#define MIHOYO_SDK_REPORTERUTIL_AUTOREPORTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190D4B10)
#define MIHOYO_SDK_REPORTERUTIL_AUTOREPORTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x190D44B0)
#define MIHOYO_SDK_REPORTERUTIL_AUTOREPORTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x190D44A0)

namespace MiHoYo::SDK::ReporterUtil
{
	inline static constexpr unsigned int AutoReportHandler_TypeDefinitionIndex = 33880;
