...
#define MIHOYO_SDK_SDKDELEGATE_SHOWTEXTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B76CA0)
#define MIHOYO_SDK_SDKDELEGATE_SHOWTEXTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B76CD0)
#define MIHOYO_SDK_SDKDELEGATE_SHOWTEXTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B767A0)
#define MIHOYO_SDK_SDKDELEGATE_SHOWTEXTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B76780)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_ShowTextDelegate_TypeDefinitionIndex = 18305;
