...
#define MIHOYO_SDK_SDKDELEGATE_SHOWTEXTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18795750)
#define MIHOYO_SDK_SDKDELEGATE_SHOWTEXTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18795780)
#define MIHOYO_SDK_SDKDELEGATE_SHOWTEXTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18795250)
#define MIHOYO_SDK_SDKDELEGATE_SHOWTEXTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18795240)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_ShowTextDelegate_TypeDefinitionIndex = 17798;
