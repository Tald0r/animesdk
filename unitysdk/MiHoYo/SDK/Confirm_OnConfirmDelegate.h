...
#define MIHOYO_SDK_CONFIRM_ONCONFIRMDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18873EB0)
#define MIHOYO_SDK_CONFIRM_ONCONFIRMDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18873F20)
#define MIHOYO_SDK_CONFIRM_ONCONFIRMDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18873AA0)
#define MIHOYO_SDK_CONFIRM_ONCONFIRMDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18873EA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Confirm_OnConfirmDelegate_TypeDefinitionIndex = 18247;
