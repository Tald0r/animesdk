...
#define MIHOYO_SDK_SDKREPORTMODEL_UPLOADCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18CED7D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKReportModel_UploadContent_TypeDefinitionIndex = 18462;
