...
#define MIHOYO_SDK_PSDELEGATE_HIDEPSSTOREICONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1847D100)
#define MIHOYO_SDK_PSDELEGATE_HIDEPSSTOREICONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1847D130)
#define MIHOYO_SDK_PSDELEGATE_HIDEPSSTOREICONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1847CE60)
#define MIHOYO_SDK_PSDELEGATE_HIDEPSSTOREICONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1847CE40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_HidePsStoreIconDelegate_TypeDefinitionIndex = 18270;
