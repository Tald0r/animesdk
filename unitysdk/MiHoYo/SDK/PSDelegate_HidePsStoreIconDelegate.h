...
#define MIHOYO_SDK_PSDELEGATE_HIDEPSSTOREICONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17E98140)
#define MIHOYO_SDK_PSDELEGATE_HIDEPSSTOREICONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17E98170)
#define MIHOYO_SDK_PSDELEGATE_HIDEPSSTOREICONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17E97EA0)
#define MIHOYO_SDK_PSDELEGATE_HIDEPSSTOREICONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17E97E90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_HidePsStoreIconDelegate_TypeDefinitionIndex = 17763;
