...
#define MIHOYO_SDK_NETUTIL___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18BA5560)
#define MIHOYO_SDK_NETUTIL___C__DISPLAYCLASS17_0__PERFORMHTTPREQUEST_B__0_OFFSET UNITYSDK_OFFSET(0x18BA5570)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetUtil___c__DisplayClass17_0_TypeDefinitionIndex = 18207;
