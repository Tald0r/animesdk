...
#define MIHOYO_SDK_KCPCLIENT_ONERRORDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A78B20)
#define MIHOYO_SDK_KCPCLIENT_ONERRORDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A78BA0)
#define MIHOYO_SDK_KCPCLIENT_ONERRORDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A77E20)
#define MIHOYO_SDK_KCPCLIENT_ONERRORDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A78B10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KCPClient_OnErrorDelegate_TypeDefinitionIndex = 33463;
