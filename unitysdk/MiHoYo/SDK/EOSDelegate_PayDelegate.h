...
#define MIHOYO_SDK_EOSDELEGATE_PAYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19283820)
#define MIHOYO_SDK_EOSDELEGATE_PAYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19283860)
#define MIHOYO_SDK_EOSDELEGATE_PAYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19283200)
#define MIHOYO_SDK_EOSDELEGATE_PAYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x192831F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_PayDelegate_TypeDefinitionIndex = 17738;
