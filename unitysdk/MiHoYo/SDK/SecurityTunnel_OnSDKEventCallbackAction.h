...
#define MIHOYO_SDK_SECURITYTUNNEL_ONSDKEVENTCALLBACKACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18DE1660)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSDKEVENTCALLBACKACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18DE16E0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSDKEVENTCALLBACKACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DE12E0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONSDKEVENTCALLBACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE12D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnSDKEventCallbackAction_TypeDefinitionIndex = 33710;
