...
#define MIHOYO_SDK_WEBVIEWRENDERMETHODBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x180F0DE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebViewRenderMethodBoxConfig_TypeDefinitionIndex = 17939;
