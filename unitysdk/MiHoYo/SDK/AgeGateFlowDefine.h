...
#define MIHOYO_SDK_AGEGATEFLOWDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD0580)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AgeGateFlowDefine_TypeDefinitionIndex = 18088;
