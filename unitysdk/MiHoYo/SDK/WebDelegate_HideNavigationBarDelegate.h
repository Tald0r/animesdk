...
#define MIHOYO_SDK_WEBDELEGATE_HIDENAVIGATIONBARDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BE4DF0)
#define MIHOYO_SDK_WEBDELEGATE_HIDENAVIGATIONBARDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BE4E90)
#define MIHOYO_SDK_WEBDELEGATE_HIDENAVIGATIONBARDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BE4760)
#define MIHOYO_SDK_WEBDELEGATE_HIDENAVIGATIONBARDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE4740)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_HideNavigationBarDelegate_TypeDefinitionIndex = 18357;
