...
#define MIHOYO_SDK_UGCINTERFACE__POSTBINARY_D__49_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19232D50)
#define MIHOYO_SDK_UGCINTERFACE__POSTBINARY_D__49_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19232DD0)
#define MIHOYO_SDK_UGCINTERFACE__POSTBINARY_D__49_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19232E30)
#define MIHOYO_SDK_UGCINTERFACE__POSTBINARY_D__49_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19232DE0)
#define MIHOYO_SDK_UGCINTERFACE__POSTBINARY_D__49_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19232D40)
#define MIHOYO_SDK_UGCINTERFACE__POSTBINARY_D__49__CTOR_OFFSET UNITYSDK_OFFSET(0x19232D30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UGCInterface__PostBinary_d__49_TypeDefinitionIndex = 34735;
