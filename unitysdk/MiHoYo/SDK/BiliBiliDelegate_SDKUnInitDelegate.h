...
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKUNINITDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18444260)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKUNINITDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18444290)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKUNINITDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18443FC0)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKUNINITDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18443FB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_SDKUnInitDelegate_TypeDefinitionIndex = 17640;
