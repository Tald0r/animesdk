...
#define MIHOYO_SDK_H5LOGFILTERCONFIG_ISREPORTENABLE_OFFSET UNITYSDK_OFFSET(0x18943D50)
#define MIHOYO_SDK_H5LOGFILTERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18943080)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int H5logFilterConfig_TypeDefinitionIndex = 17932;
