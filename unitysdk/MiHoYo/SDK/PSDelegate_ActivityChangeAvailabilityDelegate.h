...
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYCHANGEAVAILABILITYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18E463A0)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYCHANGEAVAILABILITYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18E463D0)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYCHANGEAVAILABILITYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18E45E60)
#define MIHOYO_SDK_PSDELEGATE_ACTIVITYCHANGEAVAILABILITYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18E45E40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ActivityChangeAvailabilityDelegate_TypeDefinitionIndex = 18285;
