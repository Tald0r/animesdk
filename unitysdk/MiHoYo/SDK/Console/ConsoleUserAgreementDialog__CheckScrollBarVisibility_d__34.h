...
#define MIHOYO_SDK_CONSOLE_CONSOLEUSERAGREEMENTDIALOG__CHECKSCROLLBARVISIBILITY_D__34_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18B905C0)
#define MIHOYO_SDK_CONSOLE_CONSOLEUSERAGREEMENTDIALOG__CHECKSCROLLBARVISIBILITY_D__34_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18B909E0)
#define MIHOYO_SDK_CONSOLE_CONSOLEUSERAGREEMENTDIALOG__CHECKSCROLLBARVISIBILITY_D__34_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18B90A40)
#define MIHOYO_SDK_CONSOLE_CONSOLEUSERAGREEMENTDIALOG__CHECKSCROLLBARVISIBILITY_D__34_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18B909F0)
#define MIHOYO_SDK_CONSOLE_CONSOLEUSERAGREEMENTDIALOG__CHECKSCROLLBARVISIBILITY_D__34_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18B905B0)
#define MIHOYO_SDK_CONSOLE_CONSOLEUSERAGREEMENTDIALOG__CHECKSCROLLBARVISIBILITY_D__34__CTOR_OFFSET UNITYSDK_OFFSET(0x18B905A0)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int ConsoleUserAgreementDialog__CheckScrollBarVisibility_d__34_TypeDefinitionIndex = 18646;
