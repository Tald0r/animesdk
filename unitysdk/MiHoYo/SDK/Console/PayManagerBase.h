...
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_CONVERTTOCONSOLEPRODUCT_OFFSET UNITYSDK_OFFSET(0x17AB9300)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_CREATEFAILPAYCALLBACK_OFFSET UNITYSDK_OFFSET(0x17AB7CE0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ENVCHANGED_OFFSET UNITYSDK_OFFSET(0x17AB5CC0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_GETCURRENTCONTRYCODE_OFFSET UNITYSDK_OFFSET(0x17AB91F0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_GETPRODUCTLIST_OFFSET UNITYSDK_OFFSET(0x17AB6010)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_GETPRODUCTS_1_OFFSET UNITYSDK_OFFSET(0x17AB6760)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_GETPRODUCTS_OFFSET UNITYSDK_OFFSET(0x17AB6BB0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x17AB5980)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONGETPRICETIER_OFFSET UNITYSDK_OFFSET(0x17AB8F20)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONGETPRODUCTLISTERROR_OFFSET UNITYSDK_OFFSET(0x17AB6320)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONGETPRODUCTLISTSUCCESS_OFFSET UNITYSDK_OFFSET(0x17AB7FE0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONPAYCALLBACKCANCEL_OFFSET UNITYSDK_OFFSET(0x17AB84D0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONPAYCALLBACKFAIL_OFFSET UNITYSDK_OFFSET(0x17AB7940)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONPAYCALLBACKSUCCESS_OFFSET UNITYSDK_OFFSET(0x17AB8A00)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONPRICETIERCALLBACK_OFFSET UNITYSDK_OFFSET(0x17AB9190)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_PAY_OFFSET UNITYSDK_OFFSET(0x17AB6DB0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_PREMIUMPAY_OFFSET UNITYSDK_OFFSET(0x17AB7CC0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_REFRESHPRODUCTSCACHE_OFFSET UNITYSDK_OFFSET(0x17AB5D50)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_REQUESTPRICETIER_OFFSET UNITYSDK_OFFSET(0x17AB5D60)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17AB9320)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int PayManagerBase_TypeDefinitionIndex = 18618;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Console::PayManagerBase**)Il2CppClass::FromTypeDefinitionIndex(PayManagerBase_TypeDefinitionIndex)->GetStaticField(0x9730);
		}
		static ::MiHoYo::SDK::ReportType* StaticGet_ConsoleReportType()
		{
			return (::MiHoYo::SDK::ReportType*)Il2CppClass::FromTypeDefinitionIndex(PayManagerBase_TypeDefinitionIndex)->GetStaticField(0x4440);
		}
		...
		::System::String* countryCode; // 0x60
		::System::String* productId; // 0x68
