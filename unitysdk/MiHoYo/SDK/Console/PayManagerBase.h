...
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_CONVERTTOCONSOLEPRODUCT_OFFSET UNITYSDK_OFFSET(0x176900B0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_CREATEFAILPAYCALLBACK_OFFSET UNITYSDK_OFFSET(0x1768EAA0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ENVCHANGED_OFFSET UNITYSDK_OFFSET(0x1768CA80)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_GETCURRENTCONTRYCODE_OFFSET UNITYSDK_OFFSET(0x1768FFA0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_GETPRODUCTLIST_OFFSET UNITYSDK_OFFSET(0x1768CDD0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_GETPRODUCTS_1_OFFSET UNITYSDK_OFFSET(0x1768D520)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_GETPRODUCTS_OFFSET UNITYSDK_OFFSET(0x1768D970)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1768C740)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONGETPRICETIER_OFFSET UNITYSDK_OFFSET(0x1768FCD0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONGETPRODUCTLISTERROR_OFFSET UNITYSDK_OFFSET(0x1768D0E0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONGETPRODUCTLISTSUCCESS_OFFSET UNITYSDK_OFFSET(0x1768EDA0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONPAYCALLBACKCANCEL_OFFSET UNITYSDK_OFFSET(0x1768F290)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONPAYCALLBACKFAIL_OFFSET UNITYSDK_OFFSET(0x1768E700)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONPAYCALLBACKSUCCESS_OFFSET UNITYSDK_OFFSET(0x1768F7B0)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_ONPRICETIERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1768FF40)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_PAY_OFFSET UNITYSDK_OFFSET(0x1768DB70)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_PREMIUMPAY_OFFSET UNITYSDK_OFFSET(0x1768EA80)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_REFRESHPRODUCTSCACHE_OFFSET UNITYSDK_OFFSET(0x1768CB10)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE_REQUESTPRICETIER_OFFSET UNITYSDK_OFFSET(0x1768CB20)
#define MIHOYO_SDK_CONSOLE_PAYMANAGERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x176900D0)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int PayManagerBase_TypeDefinitionIndex = 19217;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Console::PayManagerBase**)Il2CppClass::FromTypeDefinitionIndex(PayManagerBase_TypeDefinitionIndex)->GetStaticField(0x9790);
		}
		static ::MiHoYo::SDK::ReportType* StaticGet_ConsoleReportType()
		{
			return (::MiHoYo::SDK::ReportType*)Il2CppClass::FromTypeDefinitionIndex(PayManagerBase_TypeDefinitionIndex)->GetStaticField(0x4460);
		}
		...
		::MiHoYo::SDK::Console::ConsoleProduct purchasingProduct; // 0x40
		::System::String* countryCode; // 0x70
		::MiHoYo::SDK::JSONNode* gamePayInfo; // 0x78
		::Il2CppArray<::MiHoYo::SDK::Console::ConsoleProduct>* cacheProducts; // 0x80
