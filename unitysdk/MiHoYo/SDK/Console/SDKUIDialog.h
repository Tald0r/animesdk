...
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_FIREBUTTON_OFFSET UNITYSDK_OFFSET(0x181F9F30)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_FIREDROPDOWN_OFFSET UNITYSDK_OFFSET(0x181FA4A0)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_FIREINPUTFIELD_OFFSET UNITYSDK_OFFSET(0x181FA090)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_FIRESLIDER_OFFSET UNITYSDK_OFFSET(0x181FA370)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_FIRETOGGLE_OFFSET UNITYSDK_OFFSET(0x181FA1E0)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_FIRE_OFFSET UNITYSDK_OFFSET(0x181F9D50)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_GET_HIGHLIGHTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x181F8640)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_GET_ISFOCUSED_OFFSET UNITYSDK_OFFSET(0x181F97E0)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_INITDROPDOWNCONTROL_OFFSET UNITYSDK_OFFSET(0x181FA890)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_ONIMEDIALOGCLOSECALLBACK_OFFSET UNITYSDK_OFFSET(0x181FB270)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_ONIMEDIALOGCOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x181FB280)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_OPENIME_OFFSET UNITYSDK_OFFSET(0x181FA690)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_SETHIGHLIGHTOBJECT_OFFSET UNITYSDK_OFFSET(0x181F8660)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_SET_HIGHLIGHTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x181F8650)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_SET_ISFOCUSED_OFFSET UNITYSDK_OFFSET(0x181F97F0)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_UPDATEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x181F9BC0)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_UPDATEINPUTFIELD_OFFSET UNITYSDK_OFFSET(0x181F98C0)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_UPDATESLIDER_OFFSET UNITYSDK_OFFSET(0x181F9960)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x181F9800)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG__CCTOR_OFFSET UNITYSDK_OFFSET(0x181FB360)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x181FB340)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG__UPDATEDROPDOWN_B__27_1_OFFSET UNITYSDK_OFFSET(0x181FB3A0)
#define MIHOYO_SDK_CONSOLE_SDKUIDIALOG__UPDATEDROPDOWN_G__DEFOCUSED_27_0_OFFSET UNITYSDK_OFFSET(0x181FB220)

namespace MiHoYo::SDK::Console
{
	inline static constexpr unsigned int SDKUIDialog_TypeDefinitionIndex = 18609;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Console::SDKUIDropdownControl**)Il2CppClass::FromTypeDefinitionIndex(SDKUIDialog_TypeDefinitionIndex)->GetStaticField(0xA570);
		}
