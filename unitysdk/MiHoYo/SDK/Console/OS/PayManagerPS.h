...
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_CHECKCONSOLEPAY_OFFSET UNITYSDK_OFFSET(0x1873D780)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_CHECKPRICE_OFFSET UNITYSDK_OFFSET(0x1873DDC0)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_CHECKPURCHASE_OFFSET UNITYSDK_OFFSET(0x1873DE90)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_CHECKREGION_OFFSET UNITYSDK_OFFSET(0x1873D770)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_COMMERCECHECKOUTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1873FD10)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_DETECTPSPAY_OFFSET UNITYSDK_OFFSET(0x187400D0)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_GETGOODSPLATFORMPRODUCTS_OFFSET UNITYSDK_OFFSET(0x1873FB90)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_GETPURCHASEJSON_OFFSET UNITYSDK_OFFSET(0x1873E4C0)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_GETSAVEPURCHASEAMOUNT_OFFSET UNITYSDK_OFFSET(0x1873E320)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_LAUNCHCONSOLEPAY_OFFSET UNITYSDK_OFFSET(0x1873DBA0)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_LAUNCHPREMIUMPAY_OFFSET UNITYSDK_OFFSET(0x1873E110)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_LAUNCHPSPAY_OFFSET UNITYSDK_OFFSET(0x1873E190)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_ONCHECKPAY_OFFSET UNITYSDK_OFFSET(0x1873F630)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_PREMIUMCHECKOUTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1873FFC0)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_REQUESTCHECKPAY_OFFSET UNITYSDK_OFFSET(0x1873F100)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_SAVEPURCHASE_OFFSET UNITYSDK_OFFSET(0x1873F8E0)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS_TRYGETPRODUCTS_OFFSET UNITYSDK_OFFSET(0x1873DAF0)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS__COMMERCECHECKOUTCALLBACK_B__20_0_OFFSET UNITYSDK_OFFSET(0x18740DE0)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS__COMMERCECHECKOUTCALLBACK_B__20_1_OFFSET UNITYSDK_OFFSET(0x18740DF0)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS__COMMERCECHECKOUTCALLBACK_B__20_2_OFFSET UNITYSDK_OFFSET(0x18740E00)
#define MIHOYO_SDK_CONSOLE_OS_PAYMANAGERPS__CTOR_OFFSET UNITYSDK_OFFSET(0x1873D760)

namespace MiHoYo::SDK::Console::OS
{
	inline static constexpr unsigned int PayManagerPS_TypeDefinitionIndex = 18718;
