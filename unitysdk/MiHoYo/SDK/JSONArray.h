...
#define MIHOYO_SDK_JSONARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x182053D0)
#define MIHOYO_SDK_JSONARRAY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18204ED0)
#define MIHOYO_SDK_JSONARRAY_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x181EDDF0)
#define MIHOYO_SDK_JSONARRAY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x181F3BF0)
#define MIHOYO_SDK_JSONARRAY_GET_INLINE_OFFSET UNITYSDK_OFFSET(0x18204E90)
#define MIHOYO_SDK_JSONARRAY_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x18204EC0)
#define MIHOYO_SDK_JSONARRAY_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x182051F0)
#define MIHOYO_SDK_JSONARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x181F3B30)
#define MIHOYO_SDK_JSONARRAY_GET_TAG_OFFSET UNITYSDK_OFFSET(0x18204EB0)
#define MIHOYO_SDK_JSONARRAY_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x182055E0)
#define MIHOYO_SDK_JSONARRAY_REMOVE_OFFSET UNITYSDK_OFFSET(0x18205520)
#define MIHOYO_SDK_JSONARRAY_SET_INLINE_OFFSET UNITYSDK_OFFSET(0x18204EA0)
#define MIHOYO_SDK_JSONARRAY_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x18205280)
#define MIHOYO_SDK_JSONARRAY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x18204F70)
#define MIHOYO_SDK_JSONARRAY_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x18205640)
#define MIHOYO_SDK_JSONARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x182059B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int JSONArray_TypeDefinitionIndex = 18146;
