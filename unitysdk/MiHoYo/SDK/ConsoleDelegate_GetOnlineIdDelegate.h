...
#define MIHOYO_SDK_CONSOLEDELEGATE_GETONLINEIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1876C860)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETONLINEIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1876C890)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETONLINEIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1876C5C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETONLINEIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1876C5A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_GetOnlineIdDelegate_TypeDefinitionIndex = 18152;
