...
#define MIHOYO_SDK_WEBDELEGATE_SETBOUNCESENABLEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18220590)
#define MIHOYO_SDK_WEBDELEGATE_SETBOUNCESENABLEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x182205F0)
#define MIHOYO_SDK_WEBDELEGATE_SETBOUNCESENABLEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1821FFA0)
#define MIHOYO_SDK_WEBDELEGATE_SETBOUNCESENABLEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1821FF90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetBouncesEnabledDelegate_TypeDefinitionIndex = 17849;
