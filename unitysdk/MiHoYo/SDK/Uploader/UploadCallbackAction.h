...
#define MIHOYO_SDK_UPLOADER_UPLOADCALLBACKACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A7D230)
#define MIHOYO_SDK_UPLOADER_UPLOADCALLBACKACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A7D2D0)
#define MIHOYO_SDK_UPLOADER_UPLOADCALLBACKACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A7CE50)
#define MIHOYO_SDK_UPLOADER_UPLOADCALLBACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7CE40)

namespace MiHoYo::SDK::Uploader
{
	inline static constexpr unsigned int UploadCallbackAction_TypeDefinitionIndex = 33891;
