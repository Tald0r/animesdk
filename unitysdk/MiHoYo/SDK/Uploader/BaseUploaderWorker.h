...
#define MIHOYO_SDK_UPLOADER_BASEUPLOADERWORKER__CTOR_OFFSET UNITYSDK_OFFSET(0x199CEB10)

namespace MiHoYo::SDK::Uploader
{
	inline static constexpr unsigned int BaseUploaderWorker_TypeDefinitionIndex = 34890;
