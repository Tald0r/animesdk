...
#define MIHOYO_SDK_UPLOADER_NATIVEUPLOADERINTERFACE_ALIYUNINITUPLOADER_OFFSET UNITYSDK_OFFSET(0x19173D40)
#define MIHOYO_SDK_UPLOADER_NATIVEUPLOADERINTERFACE_ALIYUNUPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x19173EB0)
#define MIHOYO_SDK_UPLOADER_NATIVEUPLOADERINTERFACE_ALIYUNUPLOADFILE_OFFSET UNITYSDK_OFFSET(0x19173E40)
#define MIHOYO_SDK_UPLOADER_NATIVEUPLOADERINTERFACE_AWSINITUPLOADER_OFFSET UNITYSDK_OFFSET(0x19173F30)
#define MIHOYO_SDK_UPLOADER_NATIVEUPLOADERINTERFACE_AWSUPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x19173C50)
#define MIHOYO_SDK_UPLOADER_NATIVEUPLOADERINTERFACE_AWSUPLOADFILE_OFFSET UNITYSDK_OFFSET(0x19173CD0)
#define MIHOYO_SDK_UPLOADER_NATIVEUPLOADERINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19174030)

namespace MiHoYo::SDK::Uploader
{
	inline static constexpr unsigned int NativeUploaderInterface_TypeDefinitionIndex = 34892;
