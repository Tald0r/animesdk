...
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_ALIYUNINITUPLOADER_OFFSET UNITYSDK_OFFSET(0x18808900)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_ALIYUNUPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x18808DA0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_ALIYUNUPLOADFILE_OFFSET UNITYSDK_OFFSET(0x18808A70)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_AWSINITUPLOADER_OFFSET UNITYSDK_OFFSET(0x188090E0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_AWSUPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x18809240)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_AWSUPLOADFILE_OFFSET UNITYSDK_OFFSET(0x188091D0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_INITENV_OFFSET UNITYSDK_OFFSET(0x188092C0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_INITUPLOADER_OFFSET UNITYSDK_OFFSET(0x188089F0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADERINTRNALCALLBACK_OFFSET UNITYSDK_OFFSET(0x188086B0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADER_CREATEUPLOADERHANDLE_OFFSET UNITYSDK_OFFSET(0x188098D0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADER_INITUPLOADER_OFFSET UNITYSDK_OFFSET(0x18809540)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADER_UPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x188097C0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_MIHOYOUPLOADER_UPLOADFILE_OFFSET UNITYSDK_OFFSET(0x188096B0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_UPLOADBUFFER_OFFSET UNITYSDK_OFFSET(0x18808E20)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER_UPLOADFILE_OFFSET UNITYSDK_OFFSET(0x18808AE0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER__CCTOR_OFFSET UNITYSDK_OFFSET(0x188099A0)
#define MIHOYO_SDK_UPLOADER_DESKTOPUPLOADERWORKER__CTOR_OFFSET UNITYSDK_OFFSET(0x18809970)

namespace MiHoYo::SDK::Uploader
{
	inline static constexpr unsigned int DesktopUploaderWorker_TypeDefinitionIndex = 33889;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MiHoYo::SDK::Uploader::UploadCallbackAction*>**)Il2CppClass::FromTypeDefinitionIndex(DesktopUploaderWorker_TypeDefinitionIndex)->GetStaticField(0x24740);
		}
