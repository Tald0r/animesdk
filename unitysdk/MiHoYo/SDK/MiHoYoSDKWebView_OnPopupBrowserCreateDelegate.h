...
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONPOPUPBROWSERCREATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x195409D0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONPOPUPBROWSERCREATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19540A10)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONPOPUPBROWSERCREATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19540450)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONPOPUPBROWSERCREATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19540430)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKWebView_OnPopupBrowserCreateDelegate_TypeDefinitionIndex = 34835;
