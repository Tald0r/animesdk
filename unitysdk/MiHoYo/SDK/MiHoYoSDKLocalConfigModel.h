...
#define MIHOYO_SDK_MIHOYOSDKLOCALCONFIGMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19A937D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKLocalConfigModel_TypeDefinitionIndex = 33664;
