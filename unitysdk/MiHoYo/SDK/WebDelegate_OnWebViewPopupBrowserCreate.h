...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPOPUPBROWSERCREATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18796020)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPOPUPBROWSERCREATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18796050)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPOPUPBROWSERCREATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18795B20)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPOPUPBROWSERCREATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18795B10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewPopupBrowserCreate_TypeDefinitionIndex = 17843;
