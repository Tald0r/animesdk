...
#define MIHOYO_SDK_APMC_LOGBACK_ASTROLABE_LOGPLUGINSETUPLOADSEPERATECONFIG_OFFSET UNITYSDK_OFFSET(0x19C8A250)
#define MIHOYO_SDK_APMC_LOGBACK_ASTROLABE_NATIVE_DISABLECALLBACK_OFFSET UNITYSDK_OFFSET(0x19C8A1D0)
#define MIHOYO_SDK_APMC_LOGBACK_ASTROLABE_NATIVE_FLUSH_OFFSET UNITYSDK_OFFSET(0x19C8A7F0)
#define MIHOYO_SDK_APMC_LOGBACK_ASTROLABE_NATIVE_UPLOAD_OFFSET UNITYSDK_OFFSET(0x19C8A9D0)
#define MIHOYO_SDK_APMC_LOGBACK_ASTROLABE_NATIVE_WRITE_OFFSET UNITYSDK_OFFSET(0x19C8A530)
#define MIHOYO_SDK_APMC_LOGBACK_CONFIG_OFFSET UNITYSDK_OFFSET(0x19C89C50)
#define MIHOYO_SDK_APMC_LOGBACK_FLUSH_OFFSET UNITYSDK_OFFSET(0x19C8A6C0)
#define MIHOYO_SDK_APMC_LOGBACK_UPLOAD_OFFSET UNITYSDK_OFFSET(0x19C8A870)
#define MIHOYO_SDK_APMC_LOGBACK_WRITE_OFFSET UNITYSDK_OFFSET(0x19C8A2D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int APMC_LOGBACK_TypeDefinitionIndex = 34780;
