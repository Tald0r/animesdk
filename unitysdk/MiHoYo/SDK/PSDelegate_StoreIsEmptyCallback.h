...
#define MIHOYO_SDK_PSDELEGATE_STOREISEMPTYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1820EDC0)
#define MIHOYO_SDK_PSDELEGATE_STOREISEMPTYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1820EE30)
#define MIHOYO_SDK_PSDELEGATE_STOREISEMPTYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1820EA80)
#define MIHOYO_SDK_PSDELEGATE_STOREISEMPTYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1820EA70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_StoreIsEmptyCallback_TypeDefinitionIndex = 17753;
