...
#define MIHOYO_SDK_UI_BINDINGWELCOME_AWAKE_OFFSET UNITYSDK_OFFSET(0x188A9CD0)
#define MIHOYO_SDK_UI_BINDINGWELCOME_BINDEXISTINGACCOUNT_OFFSET UNITYSDK_OFFSET(0x188AAE00)
#define MIHOYO_SDK_UI_BINDINGWELCOME_CANCELCREATENEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x188AAE70)
#define MIHOYO_SDK_UI_BINDINGWELCOME_CLOSE_OFFSET UNITYSDK_OFFSET(0x188AAE80)
#define MIHOYO_SDK_UI_BINDINGWELCOME_CONFIRMCREATEANDBINDNEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x188AAE20)
#define MIHOYO_SDK_UI_BINDINGWELCOME_CREATEANDBINDNEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x188AAE60)
#define MIHOYO_SDK_UI_BINDINGWELCOME_HIDE_OFFSET UNITYSDK_OFFSET(0x188AAFD0)
#define MIHOYO_SDK_UI_BINDINGWELCOME_ONBINDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x188AADD0)
#define MIHOYO_SDK_UI_BINDINGWELCOME_ONSKIPORCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x188AAE40)
#define MIHOYO_SDK_UI_BINDINGWELCOME_SHOWBINDMODESELECTION_OFFSET UNITYSDK_OFFSET(0x188AA9E0)
#define MIHOYO_SDK_UI_BINDINGWELCOME_SHOWNEWACCOUNTPROMPT_OFFSET UNITYSDK_OFFSET(0x188AAB80)
#define MIHOYO_SDK_UI_BINDINGWELCOME_SHOW_OFFSET UNITYSDK_OFFSET(0x188AAEA0)
#define MIHOYO_SDK_UI_BINDINGWELCOME__CTOR_OFFSET UNITYSDK_OFFSET(0x188AB040)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int BindingWelcome_TypeDefinitionIndex = 18890;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::BindingWelcome**)Il2CppClass::FromTypeDefinitionIndex(BindingWelcome_TypeDefinitionIndex)->GetStaticField(0xA5B0);
		}
