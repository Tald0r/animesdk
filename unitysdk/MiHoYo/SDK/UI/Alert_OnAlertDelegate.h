...
#define MIHOYO_SDK_UI_ALERT_ONALERTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18788020)
#define MIHOYO_SDK_UI_ALERT_ONALERTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18788090)
#define MIHOYO_SDK_UI_ALERT_ONALERTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18787D30)
#define MIHOYO_SDK_UI_ALERT_ONALERTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18787D10)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int Alert_OnAlertDelegate_TypeDefinitionIndex = 18895;
