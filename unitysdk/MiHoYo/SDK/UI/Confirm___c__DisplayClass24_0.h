...
#define MIHOYO_SDK_UI_CONFIRM___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18A1DB50)
#define MIHOYO_SDK_UI_CONFIRM___C__DISPLAYCLASS24_0__SHOW_B__0_OFFSET UNITYSDK_OFFSET(0x18A1DB60)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int Confirm___c__DisplayClass24_0_TypeDefinitionIndex = 18376;
