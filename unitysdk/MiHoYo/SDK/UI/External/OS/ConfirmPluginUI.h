...
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_GET_ONCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x182190A0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_GET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x182190C0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_HIDEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x182194A0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_HIDE_OFFSET UNITYSDK_OFFSET(0x18219550)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_SET_ONCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x182190B0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_SET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x182190D0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_SHOWPLUGINUI_OFFSET UNITYSDK_OFFSET(0x182190E0)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI_SHOW_OFFSET UNITYSDK_OFFSET(0x18219540)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18219560)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI__SHOWPLUGINUI_B__8_0_OFFSET UNITYSDK_OFFSET(0x18219570)
#define MIHOYO_SDK_UI_EXTERNAL_OS_CONFIRMPLUGINUI__SHOWPLUGINUI_B__8_1_OFFSET UNITYSDK_OFFSET(0x18219590)

namespace MiHoYo::SDK::UI::External::OS
{
	inline static constexpr unsigned int ConfirmPluginUI_TypeDefinitionIndex = 18378;
