...
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_GET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18956730)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_GET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18956750)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_HIDEPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18956B30)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_HIDE_OFFSET UNITYSDK_OFFSET(0x18956C40)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_SET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18956740)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_SET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18956760)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_SHOWPLUGINUI_OFFSET UNITYSDK_OFFSET(0x18956770)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI_SHOW_OFFSET UNITYSDK_OFFSET(0x18956C30)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI__CTOR_OFFSET UNITYSDK_OFFSET(0x18956C50)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI__SHOWPLUGINUI_B__8_0_OFFSET UNITYSDK_OFFSET(0x18956C60)
#define MIHOYO_SDK_UI_EXTERNAL_OS_ALERTPLUGINUI__SHOWPLUGINUI_B__8_1_OFFSET UNITYSDK_OFFSET(0x18956C70)

namespace MiHoYo::SDK::UI::External::OS
{
	inline static constexpr unsigned int AlertPluginUI_TypeDefinitionIndex = 18377;
