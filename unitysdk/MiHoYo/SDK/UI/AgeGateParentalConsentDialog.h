...
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1894F420)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_CLEARINPUT_OFFSET UNITYSDK_OFFSET(0x189508A0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_CLOSEBTNCLIEKD_OFFSET UNITYSDK_OFFSET(0x18950CF0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_CONFIRMBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x18950AD0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_ENDEDIT_OFFSET UNITYSDK_OFFSET(0x18950D10)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_GET_ONCLOSEBTNCLIKED_OFFSET UNITYSDK_OFFSET(0x1894F3E0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_GET_ONENDEDIT_OFFSET UNITYSDK_OFFSET(0x1894F400)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_GET_ONNEXTBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1894F3A0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_GET_ONSHOWPARENTALCONTROLPROCESSBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1894F3C0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x18950A40)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_ONINPUT_OFFSET UNITYSDK_OFFSET(0x18950C80)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_SET_ONCLOSEBTNCLIKED_OFFSET UNITYSDK_OFFSET(0x1894F3F0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_SET_ONENDEDIT_OFFSET UNITYSDK_OFFSET(0x1894F410)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_SET_ONNEXTBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1894F3B0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_SET_ONSHOWPARENTALCONTROLPROCESSBUTTONPRESSED_OFFSET UNITYSDK_OFFSET(0x1894F3D0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x18950910)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_TIPSBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18950CD0)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x18950690)
#define MIHOYO_SDK_UI_AGEGATEPARENTALCONSENTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18950D30)

namespace MiHoYo::SDK::UI
{
	inline static constexpr unsigned int AgeGateParentalConsentDialog_TypeDefinitionIndex = 18880;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::AgeGateParentalConsentDialog**)Il2CppClass::FromTypeDefinitionIndex(AgeGateParentalConsentDialog_TypeDefinitionIndex)->GetStaticField(0x9F00);
		}
