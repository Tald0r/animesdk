...
#define MIHOYO_SDK_UI_INTERNAL_OS_TOAST_GET_ONTOASTCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1928E240)
#define MIHOYO_SDK_UI_INTERNAL_OS_TOAST_SHOW_OFFSET UNITYSDK_OFFSET(0x1928E250)
#define MIHOYO_SDK_UI_INTERNAL_OS_TOAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1928E2B0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int Toast_TypeDefinitionIndex = 18412;
