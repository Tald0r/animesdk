...
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG_GET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18AA74C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG_GET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18AA74E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x18AA7590)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG_SET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18AA74D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG_SET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18AA74F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x18AA7500)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA75F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ALERTDIALOG__SHOW_B__8_0_OFFSET UNITYSDK_OFFSET(0x18AA7600)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AlertDialog_TypeDefinitionIndex = 18409;
