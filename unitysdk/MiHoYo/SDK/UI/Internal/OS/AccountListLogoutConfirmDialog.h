...
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG_GET_ONACCOUNTLISTLOGOUTCANCEL_OFFSET UNITYSDK_OFFSET(0x188ABC30)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG_GET_ONACCOUNTLISTLOGOUTCONFIRM_OFFSET UNITYSDK_OFFSET(0x188ABC10)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x188ABD10)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG_SET_ONACCOUNTLISTLOGOUTCANCEL_OFFSET UNITYSDK_OFFSET(0x188ABC40)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG_SET_ONACCOUNTLISTLOGOUTCONFIRM_OFFSET UNITYSDK_OFFSET(0x188ABC20)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x188ABC50)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x188ABD80)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG__SHOW_B__8_0_OFFSET UNITYSDK_OFFSET(0x188ABD90)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTLOGOUTCONFIRMDIALOG__SHOW_B__8_1_OFFSET UNITYSDK_OFFSET(0x188ABDF0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AccountListLogoutConfirmDialog_TypeDefinitionIndex = 18925;
