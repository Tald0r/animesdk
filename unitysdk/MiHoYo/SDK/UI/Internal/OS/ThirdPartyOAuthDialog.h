...
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_GET_ONCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998B00)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_GET_ONRETRYBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998B20)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x18998B40)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_SET_ONCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998B10)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_SET_ONRETRYBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998B30)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x18998BB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG_UPDATESTATE_OFFSET UNITYSDK_OFFSET(0x18998C50)
#define MIHOYO_SDK_UI_INTERNAL_OS_THIRDPARTYOAUTHDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18998CF0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int ThirdPartyOAuthDialog_TypeDefinitionIndex = 18939;
