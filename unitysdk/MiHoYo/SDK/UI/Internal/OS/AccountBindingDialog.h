...
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_CLEARCAPTCHACODE_OFFSET UNITYSDK_OFFSET(0x18788AE0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_CLEARINPUTACCOUNT_OFFSET UNITYSDK_OFFSET(0x18788A80)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONBACKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x187886A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONBINDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18788740)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x187886C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONGETCAPTCHABTNCLICKED_OFFSET UNITYSDK_OFFSET(0x187886E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONQRREFRESHBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18788760)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONSHOWPRIVACYPROTOCOLCLICKED_OFFSET UNITYSDK_OFFSET(0x18788720)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_GET_ONSHOWUSERAGREEMENTCLICKED_OFFSET UNITYSDK_OFFSET(0x18788700)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x18788C60)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_INVALIDATEQRCODE_OFFSET UNITYSDK_OFFSET(0x187887E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_LOADINGQRCODE_OFFSET UNITYSDK_OFFSET(0x18788840)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SETQRIMAGE_OFFSET UNITYSDK_OFFSET(0x18788780)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONBACKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x187886B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONBINDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18788750)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x187886D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONGETCAPTCHABTNCLICKED_OFFSET UNITYSDK_OFFSET(0x187886F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONQRREFRESHBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18788770)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONSHOWPRIVACYPROTOCOLCLICKED_OFFSET UNITYSDK_OFFSET(0x18788730)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SET_ONSHOWUSERAGREEMENTCLICKED_OFFSET UNITYSDK_OFFSET(0x18788710)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x18788B40)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_STARTBINDRESULTQUERYCOROUTINE_OFFSET UNITYSDK_OFFSET(0x187888A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_STARTCAPTCHACOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x187889C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_STOPBINDRESULTQUERYCOROUTINE_OFFSET UNITYSDK_OFFSET(0x18788960)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG_STOPCAPTCHACOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x18788A20)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTBINDINGDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18788CD0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AccountBindingDialog_TypeDefinitionIndex = 18919;

	class AccountBindingDialog : public ::System::Object
	{
	public:
		::System::Action_1<::System::String*>* _OnBindBtnClicked_k__BackingField; // 0x10
		...
		::System::Action_1<::System::String*>* _OnGetCaptchaBtnClicked_k__BackingField; // 0x30
