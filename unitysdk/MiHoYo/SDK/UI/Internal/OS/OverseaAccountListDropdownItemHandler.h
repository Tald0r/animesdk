...
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1878C9C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER_GETKEY_OFFSET UNITYSDK_OFFSET(0x1878E6B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER_ONDELETEACCOUNT_OFFSET UNITYSDK_OFFSET(0x1878E6E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1878E620)
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER_PARSEACCOUNTINFO_OFFSET UNITYSDK_OFFSET(0x1878D8D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER_START_OFFSET UNITYSDK_OFFSET(0x1878D8C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_OVERSEAACCOUNTLISTDROPDOWNITEMHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1878E760)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int OverseaAccountListDropdownItemHandler_TypeDefinitionIndex = 18928;
