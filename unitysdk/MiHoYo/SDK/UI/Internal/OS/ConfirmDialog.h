...
#define MIHOYO_SDK_UI_INTERNAL_OS_CONFIRMDIALOG_GET_ONCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x186F1BF0)
#define MIHOYO_SDK_UI_INTERNAL_OS_CONFIRMDIALOG_GET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x186F1C10)
#define MIHOYO_SDK_UI_INTERNAL_OS_CONFIRMDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x186F1CD0)
#define MIHOYO_SDK_UI_INTERNAL_OS_CONFIRMDIALOG_SET_ONCANCELBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x186F1C00)
#define MIHOYO_SDK_UI_INTERNAL_OS_CONFIRMDIALOG_SET_ONCONFIRMBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x186F1C20)
#define MIHOYO_SDK_UI_INTERNAL_OS_CONFIRMDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x186F1C30)
#define MIHOYO_SDK_UI_INTERNAL_OS_CONFIRMDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x186F1D30)
#define MIHOYO_SDK_UI_INTERNAL_OS_CONFIRMDIALOG__SHOW_B__8_0_OFFSET UNITYSDK_OFFSET(0x186F1D40)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int ConfirmDialog_TypeDefinitionIndex = 18410;
