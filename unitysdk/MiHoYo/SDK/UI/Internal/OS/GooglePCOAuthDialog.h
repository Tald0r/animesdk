...
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18BE2880)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONBACKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18BE2920)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONCHECKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18BE28C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONMEETPROBLEMBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18BE2900)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONREAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18BE28E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_GET_ONSUBMITBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18BE28A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x18BE2B00)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_ONMEETPROBLEM_OFFSET UNITYSDK_OFFSET(0x18BE2B70)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SETSTATE_OFFSET UNITYSDK_OFFSET(0x18BE2940)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18BE2890)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONBACKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18BE2930)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONCHECKBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18BE28D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONMEETPROBLEMBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18BE2910)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONREAUTHBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18BE28F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SET_ONSUBMITBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x18BE28B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x18BE2A00)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE2D90)
#define MIHOYO_SDK_UI_INTERNAL_OS_GOOGLEPCOAUTHDIALOG__SHOW_B__25_0_OFFSET UNITYSDK_OFFSET(0x18BE2DA0)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int GooglePCOAuthDialog_TypeDefinitionIndex = 18926;
