...
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM_AWAKE_OFFSET UNITYSDK_OFFSET(0x18A1DC90)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM_CANCEL_OFFSET UNITYSDK_OFFSET(0x18A1EEE0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM_CONFIRM_OFFSET UNITYSDK_OFFSET(0x18A1EE70)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM_HIDE_OFFSET UNITYSDK_OFFSET(0x18A1EF00)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM_SHOW_OFFSET UNITYSDK_OFFSET(0x18A1ED40)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x18A1EAF0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLISTCONFIRM__CTOR_OFFSET UNITYSDK_OFFSET(0x18A1EF70)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AccountListConfirm_TypeDefinitionIndex = 18403;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::Internal::OS::AccountListConfirm**)Il2CppClass::FromTypeDefinitionIndex(AccountListConfirm_TypeDefinitionIndex)->GetStaticField(0xAA30);
		}
