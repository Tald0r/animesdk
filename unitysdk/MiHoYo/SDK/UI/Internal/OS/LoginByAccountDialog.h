...
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GETACCOUNTINPUT_OFFSET UNITYSDK_OFFSET(0x189985E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONAPPLELOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998500)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONBACKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x189985A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998580)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONFACEBOOKLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998520)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONFORGOTPASSWORDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x189984E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONGOOGLELOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998540)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONGUESTLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x189985C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x189984A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONREGISTERBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x189984C0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_GET_ONTWITTERLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998560)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x18998970)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x189989E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONAPPLELOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998510)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONBACKBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x189985B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONCLOSEBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998590)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONFACEBOOKLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998530)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONFORGOTPASSWORDBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x189984F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONGOOGLELOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998550)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONGUESTLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x189985D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x189984B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONREGISTERBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x189984D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SET_ONTWITTERLOGINBTNCLICKED_OFFSET UNITYSDK_OFFSET(0x18998570)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x189987B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_UPDATEACCOUNTINPUT_OFFSET UNITYSDK_OFFSET(0x18998650)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG_UPDATEPASSWORD_OFFSET UNITYSDK_OFFSET(0x18998700)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18998A70)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNTDIALOG__SHOW_B__43_0_OFFSET UNITYSDK_OFFSET(0x18998A80)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int LoginByAccountDialog_TypeDefinitionIndex = 18927;
	...
	public:
		...
		::System::Action* _OnGoogleLoginBtnClicked_k__BackingField; // 0x28
		...
		::System::Action* _OnCloseBtnClicked_k__BackingField; // 0x48
