...
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_AWAKE_OFFSET UNITYSDK_OFFSET(0x182195B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_CHECKACCOUNTLISTDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1821CEC0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_CLOSE_OFFSET UNITYSDK_OFFSET(0x1821D030)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_DELETEACCOUNT_OFFSET UNITYSDK_OFFSET(0x1821CB20)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_HIDE_OFFSET UNITYSDK_OFFSET(0x1821C9A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_LOADACCOUNTINFODATA_OFFSET UNITYSDK_OFFSET(0x1821A810)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_LOGINOTHERACCOUNT_OFFSET UNITYSDK_OFFSET(0x1821D0B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONACCOUNTSELECTED_OFFSET UNITYSDK_OFFSET(0x1821C100)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONCOLLAPSELIST_OFFSET UNITYSDK_OFFSET(0x1821C010)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONCONFIRMBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1821D050)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONDELETEBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1821CA10)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1821D0D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_ONNOTICEEXPANDDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1821BF40)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_SHOW_OFFSET UNITYSDK_OFFSET(0x1821B440)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_START_OFFSET UNITYSDK_OFFSET(0x1821A3A0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_UPDATEDISPLAYEDACCOUNTLIST_OFFSET UNITYSDK_OFFSET(0x1821BDF0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_UPDATEDROPDOWNTITLE_OFFSET UNITYSDK_OFFSET(0x1821B5D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1821A6F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1821D110)
#define MIHOYO_SDK_UI_INTERNAL_OS_ACCOUNTLIST__ONDELETEBUTTONCLICKED_B__50_0_OFFSET UNITYSDK_OFFSET(0x1821D190)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int AccountList_TypeDefinitionIndex = 18400;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::Internal::OS::AccountList**)Il2CppClass::FromTypeDefinitionIndex(AccountList_TypeDefinitionIndex)->GetStaticField(0xA600);
		}
