...
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_ACCOUNTINPUTCLEARBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1895AE90)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_AWAKE_OFFSET UNITYSDK_OFFSET(0x18956E70)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKAPPLEBUTTON_OFFSET UNITYSDK_OFFSET(0x1895ACB0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKCLOSEBUTTON_OFFSET UNITYSDK_OFFSET(0x1895AE30)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKFACEBOOKBUTTON_OFFSET UNITYSDK_OFFSET(0x1895AD70)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKFORGETPASSWORDBUTTON_OFFSET UNITYSDK_OFFSET(0x1895AE70)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKGOOGLEBUTTON_OFFSET UNITYSDK_OFFSET(0x1895AD10)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x1895A480)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKREGISTERBUTTON_OFFSET UNITYSDK_OFFSET(0x1895AE50)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_CLICKTWITTERBUTTON_OFFSET UNITYSDK_OFFSET(0x1895ADD0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_GUESTLOGIN_OFFSET UNITYSDK_OFFSET(0x1895AC50)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_HIDEPASSWORDDETAILBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1895B1B0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_HIDE_OFFSET UNITYSDK_OFFSET(0x1895A410)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_ONACCOUNTINPUTVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x1895B2D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_ONBACKBUTTONCLICKED_OFFSET UNITYSDK_OFFSET(0x1895AC30)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1895B5D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_ONPASSWORDINPUTVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x1895B350)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_PASSWORDINPUTCLEARBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1895AF00)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_SHOWPASSWORDDETAILBTNCLICK_OFFSET UNITYSDK_OFFSET(0x1895B090)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_SHOW_OFFSET UNITYSDK_OFFSET(0x1895A2E0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_START_OFFSET UNITYSDK_OFFSET(0x1895A9D0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_UPDATEBACKBTN_OFFSET UNITYSDK_OFFSET(0x1895AA40)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_UPDATEBOTTOMCONTENT_OFFSET UNITYSDK_OFFSET(0x189590F0)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1895A070)
#define MIHOYO_SDK_UI_INTERNAL_OS_LOGINBYACCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x1895B610)

namespace MiHoYo::SDK::UI::Internal::OS
{
	inline static constexpr unsigned int LoginByAccount_TypeDefinitionIndex = 18391;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::UI::Internal::OS::LoginByAccount**)Il2CppClass::FromTypeDefinitionIndex(LoginByAccount_TypeDefinitionIndex)->GetStaticField(0xABA0);
		}
