...
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_CLOSE_OFFSET UNITYSDK_OFFSET(0x19411E50)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19411E60)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_DOHTTPREQUEST_OFFSET UNITYSDK_OFFSET(0x19411FA0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_DOLOGGER_OFFSET UNITYSDK_OFFSET(0x19411EF0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GETRESPONSEHEADER_OFFSET UNITYSDK_OFFSET(0x19412570)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GETRESPONSESTREAM_OFFSET UNITYSDK_OFFSET(0x19411DD0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x194128B0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x194128D0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GET_ERRORCODE_OFFSET UNITYSDK_OFFSET(0x19412930)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GET_ERRORMSG_OFFSET UNITYSDK_OFFSET(0x19412950)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x19412910)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_GET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x194128F0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_NATIVEPTRTOBYTES_OFFSET UNITYSDK_OFFSET(0x19412850)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_SET_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x194128C0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_SET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x194128E0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_SET_ERRORCODE_OFFSET UNITYSDK_OFFSET(0x19412940)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_SET_ERRORMSG_OFFSET UNITYSDK_OFFSET(0x19412960)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_SET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x19412920)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE_SET_STATUSCODE_OFFSET UNITYSDK_OFFSET(0x19412900)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE__CTOR_OFFSET UNITYSDK_OFFSET(0x19411DC0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKHTTPWEBRESPONSE__DOHTTPREQUEST_B__4_0_OFFSET UNITYSDK_OFFSET(0x19412970)

namespace MiHoYo::SDK::HttpDns
{
	inline static constexpr unsigned int HoYoSDKHttpWebResponse_TypeDefinitionIndex = 34928;
