...
#define MIHOYO_SDK_HTTPDNS_HOYOSDKSERVICEPOINT_GET_CONNECTIONLIMIT_OFFSET UNITYSDK_OFFSET(0x175C1DF0)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKSERVICEPOINT_SET_CONNECTIONLIMIT_OFFSET UNITYSDK_OFFSET(0x175C1E00)
#define MIHOYO_SDK_HTTPDNS_HOYOSDKSERVICEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x175C1DE0)

namespace MiHoYo::SDK::HttpDns
{
	inline static constexpr unsigned int HoYoSDKServicePoint_TypeDefinitionIndex = 34933;
