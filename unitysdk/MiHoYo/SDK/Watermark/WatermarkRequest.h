...
#define MIHOYO_SDK_WATERMARK_WATERMARKREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAF0C0)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkRequest_TypeDefinitionIndex = 18510;
