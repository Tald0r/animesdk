...
#define MIHOYO_SDK_WATERMARK_WATERMARKTOKENTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1895C3E0)

namespace MiHoYo::SDK::Watermark
{
	inline static constexpr unsigned int WatermarkTokenType_TypeDefinitionIndex = 18508;
