...
#define MIHOYO_SDK_DLL_ONDESTROYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CDBFD0)
#define MIHOYO_SDK_DLL_ONDESTROYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CDC000)
#define MIHOYO_SDK_DLL_ONDESTROYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CDBD30)
#define MIHOYO_SDK_DLL_ONDESTROYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDBD10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Dll_OnDestroyDelegate_TypeDefinitionIndex = 18469;
