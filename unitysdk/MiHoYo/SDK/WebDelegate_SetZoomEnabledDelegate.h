...
#define MIHOYO_SDK_WEBDELEGATE_SETZOOMENABLEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BB2290)
#define MIHOYO_SDK_WEBDELEGATE_SETZOOMENABLEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BB22F0)
#define MIHOYO_SDK_WEBDELEGATE_SETZOOMENABLEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BB1CA0)
#define MIHOYO_SDK_WEBDELEGATE_SETZOOMENABLEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BB1C90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetZoomEnabledDelegate_TypeDefinitionIndex = 17848;
