...
#define MIHOYO_SDK_WEBDELEGATE_SETZOOMENABLEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C9AB50)
#define MIHOYO_SDK_WEBDELEGATE_SETZOOMENABLEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C9ABB0)
#define MIHOYO_SDK_WEBDELEGATE_SETZOOMENABLEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C9A560)
#define MIHOYO_SDK_WEBDELEGATE_SETZOOMENABLEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C9A540)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetZoomEnabledDelegate_TypeDefinitionIndex = 18355;
