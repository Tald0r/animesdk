...
#define MIHOYO_SDK_APMC_LOGBACK_LOGUPLOADED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18DA9D70)
#define MIHOYO_SDK_APMC_LOGBACK_LOGUPLOADED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18DA9DF0)
#define MIHOYO_SDK_APMC_LOGBACK_LOGUPLOADED_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DA99E0)
#define MIHOYO_SDK_APMC_LOGBACK_LOGUPLOADED__CTOR_OFFSET UNITYSDK_OFFSET(0x18DA99D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int APMC_LOGBACK_LogUploaded_TypeDefinitionIndex = 33802;
