...
#define MIHOYO_SDK_KCPCLIENT_ONTIMEOUTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A909E0)
#define MIHOYO_SDK_KCPCLIENT_ONTIMEOUTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A90A10)
#define MIHOYO_SDK_KCPCLIENT_ONTIMEOUTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A90740)
#define MIHOYO_SDK_KCPCLIENT_ONTIMEOUTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A90730)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KCPClient_OnTimeoutDelegate_TypeDefinitionIndex = 33462;
