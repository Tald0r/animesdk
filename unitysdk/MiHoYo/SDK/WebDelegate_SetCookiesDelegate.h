...
#define MIHOYO_SDK_WEBDELEGATE_SETCOOKIESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18956270)
#define MIHOYO_SDK_WEBDELEGATE_SETCOOKIESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x189562C0)
#define MIHOYO_SDK_WEBDELEGATE_SETCOOKIESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18955BC0)
#define MIHOYO_SDK_WEBDELEGATE_SETCOOKIESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18955BA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetCookiesDelegate_TypeDefinitionIndex = 18376;
