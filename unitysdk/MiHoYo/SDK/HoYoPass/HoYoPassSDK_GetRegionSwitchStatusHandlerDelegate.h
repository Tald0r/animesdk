...
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_GETREGIONSWITCHSTATUSHANDLERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17ABE700)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_GETREGIONSWITCHSTATUSHANDLERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17ABE730)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_GETREGIONSWITCHSTATUSHANDLERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17ABE460)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_GETREGIONSWITCHSTATUSHANDLERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17ABE450)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int HoYoPassSDK_GetRegionSwitchStatusHandlerDelegate_TypeDefinitionIndex = 18304;
