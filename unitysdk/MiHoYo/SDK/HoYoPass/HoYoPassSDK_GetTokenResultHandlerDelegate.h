...
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_GETTOKENRESULTHANDLERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18449FB0)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_GETTOKENRESULTHANDLERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1844A050)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_GETTOKENRESULTHANDLERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18449C20)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_GETTOKENRESULTHANDLERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18449C10)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int HoYoPassSDK_GetTokenResultHandlerDelegate_TypeDefinitionIndex = 18302;
