...
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_EVENTHANDLERDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C0BA70)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_EVENTHANDLERDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C0BB30)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_EVENTHANDLERDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C0B670)
#define MIHOYO_SDK_HOYOPASS_HOYOPASSSDK_EVENTHANDLERDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0B650)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int HoYoPassSDK_EventHandlerDelegate_TypeDefinitionIndex = 18808;
