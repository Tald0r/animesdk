...
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER_CLOSEWEBPAGE_OFFSET UNITYSDK_OFFSET(0x18984D20)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER_GETURL_OFFSET UNITYSDK_OFFSET(0x189844A0)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER_ONERRORCALLBACK_OFFSET UNITYSDK_OFFSET(0x18985340)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER_ONPAGECLOSED_OFFSET UNITYSDK_OFFSET(0x18984D90)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER_ONRESULTCALLBACK_OFFSET UNITYSDK_OFFSET(0x18984E70)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER_OPENWEBPAGE_OFFSET UNITYSDK_OFFSET(0x18983A70)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18985900)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x189858F0)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER__OPENWEBPAGE_B__7_0_OFFSET UNITYSDK_OFFSET(0x18985950)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER__OPENWEBPAGE_B__7_2_OFFSET UNITYSDK_OFFSET(0x189859A0)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER__OPENWEBPAGE_B__7_3_OFFSET UNITYSDK_OFFSET(0x189859B0)
#define MIHOYO_SDK_HOYOPASS_WEBPAGEMANAGER__OPENWEBPAGE_B__7_4_OFFSET UNITYSDK_OFFSET(0x189859C0)

namespace MiHoYo::SDK::HoYoPass
{
	inline static constexpr unsigned int WebPageManager_TypeDefinitionIndex = 18849;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::HoYoPass::WebPageManager**)Il2CppClass::FromTypeDefinitionIndex(WebPageManager_TypeDefinitionIndex)->GetStaticField(0xAD70);
		}
