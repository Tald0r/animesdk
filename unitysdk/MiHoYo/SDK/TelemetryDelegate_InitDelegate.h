...
#define MIHOYO_SDK_TELEMETRYDELEGATE_INITDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1845AF20)
#define MIHOYO_SDK_TELEMETRYDELEGATE_INITDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1845AF50)
#define MIHOYO_SDK_TELEMETRYDELEGATE_INITDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1845AC80)
#define MIHOYO_SDK_TELEMETRYDELEGATE_INITDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1845AC70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TelemetryDelegate_InitDelegate_TypeDefinitionIndex = 17715;
