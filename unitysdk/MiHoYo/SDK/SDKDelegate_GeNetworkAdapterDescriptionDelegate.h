...
#define MIHOYO_SDK_SDKDELEGATE_GENETWORKADAPTERDESCRIPTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18786DF0)
#define MIHOYO_SDK_SDKDELEGATE_GENETWORKADAPTERDESCRIPTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18786E20)
#define MIHOYO_SDK_SDKDELEGATE_GENETWORKADAPTERDESCRIPTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18786B50)
#define MIHOYO_SDK_SDKDELEGATE_GENETWORKADAPTERDESCRIPTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18786B30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GeNetworkAdapterDescriptionDelegate_TypeDefinitionIndex = 18321;
