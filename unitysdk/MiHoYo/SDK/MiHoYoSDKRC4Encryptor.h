...
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_BYTETOHEX_OFFSET UNITYSDK_OFFSET(0x175D0C50)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_DECRYPT_1_OFFSET UNITYSDK_OFFSET(0x175D0DA0)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_DECRYPT_2_OFFSET UNITYSDK_OFFSET(0x175D1040)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_DECRYPT_3_OFFSET UNITYSDK_OFFSET(0x175D0E50)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_DECRYPT_OFFSET UNITYSDK_OFFSET(0x175D0D90)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_ENCRYPT_1_OFFSET UNITYSDK_OFFSET(0x175D0820)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_ENCRYPT_2_OFFSET UNITYSDK_OFFSET(0x175D1030)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_ENCRYPT_3_OFFSET UNITYSDK_OFFSET(0x175D09C0)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_ENCRYPT_OFFSET UNITYSDK_OFFSET(0x175D0810)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_GETKEY_OFFSET UNITYSDK_OFFSET(0x175D1050)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_GET_ENCODERMODE_OFFSET UNITYSDK_OFFSET(0x175D0700)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_GET_ENCODING_OFFSET UNITYSDK_OFFSET(0x175D06E0)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_GET_KEY_OFFSET UNITYSDK_OFFSET(0x175D06C0)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_GET_RC4_OFFSET UNITYSDK_OFFSET(0x175D0720)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_HEXTOBYTE_OFFSET UNITYSDK_OFFSET(0x175D0E60)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_SET_ENCODERMODE_OFFSET UNITYSDK_OFFSET(0x175D0710)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_SET_ENCODING_OFFSET UNITYSDK_OFFSET(0x175D06F0)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_SET_KEY_OFFSET UNITYSDK_OFFSET(0x175D06D0)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR_SUBCONVERTTOBASE64_OFFSET UNITYSDK_OFFSET(0x175D1250)
#define MIHOYO_SDK_MIHOYOSDKRC4ENCRYPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x175D0610)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKRC4Encryptor_TypeDefinitionIndex = 34762;
