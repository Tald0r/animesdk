...
#define MIHOYO_SDK_ALERT___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18A8B550)
#define MIHOYO_SDK_ALERT___C__DISPLAYCLASS20_0__SHOWPLUGINUI_B__0_OFFSET UNITYSDK_OFFSET(0x18A8B560)
#define MIHOYO_SDK_ALERT___C__DISPLAYCLASS20_0__SHOWPLUGINUI_B__1_OFFSET UNITYSDK_OFFSET(0x18A8B5D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Alert___c__DisplayClass20_0_TypeDefinitionIndex = 18762;
