...
#define MIHOYO_SDK_EOSDELEGATE_QUERYEOSPRODUCTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C83DE0)
#define MIHOYO_SDK_EOSDELEGATE_QUERYEOSPRODUCTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C83E20)
#define MIHOYO_SDK_EOSDELEGATE_QUERYEOSPRODUCTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C83860)
#define MIHOYO_SDK_EOSDELEGATE_QUERYEOSPRODUCTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C83840)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_QueryEOSProductDelegate_TypeDefinitionIndex = 18243;
