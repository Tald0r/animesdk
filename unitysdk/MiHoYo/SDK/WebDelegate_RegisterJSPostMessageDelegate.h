...
#define MIHOYO_SDK_WEBDELEGATE_REGISTERJSPOSTMESSAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18955B50)
#define MIHOYO_SDK_WEBDELEGATE_REGISTERJSPOSTMESSAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18955B90)
#define MIHOYO_SDK_WEBDELEGATE_REGISTERJSPOSTMESSAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18955520)
#define MIHOYO_SDK_WEBDELEGATE_REGISTERJSPOSTMESSAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18955500)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_RegisterJSPostMessageDelegate_TypeDefinitionIndex = 18382;
