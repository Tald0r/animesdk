...
#define MIHOYO_SDK_TIMEDURATIONDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AA73A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TimeDurationDefine_TypeDefinitionIndex = 17632;
