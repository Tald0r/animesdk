...
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKPAYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1826D350)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKPAYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1826D390)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKPAYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1826CDB0)
#define MIHOYO_SDK_BILIBILIDELEGATE_SDKPAYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1826CDA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_SDKPayDelegate_TypeDefinitionIndex = 17642;
