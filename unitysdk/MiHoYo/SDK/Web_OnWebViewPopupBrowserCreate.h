...
#define MIHOYO_SDK_WEB_ONWEBVIEWPOPUPBROWSERCREATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18AAF450)
#define MIHOYO_SDK_WEB_ONWEBVIEWPOPUPBROWSERCREATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18AAF490)
#define MIHOYO_SDK_WEB_ONWEBVIEWPOPUPBROWSERCREATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18AAE0F0)
#define MIHOYO_SDK_WEB_ONWEBVIEWPOPUPBROWSERCREATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAF430)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Web_OnWebViewPopupBrowserCreate_TypeDefinitionIndex = 18743;
