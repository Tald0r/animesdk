...
#define MIHOYO_SDK_SECURITYTUNNEL_RESPONSECALLBACKACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x185163B0)
#define MIHOYO_SDK_SECURITYTUNNEL_RESPONSECALLBACKACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18516410)
#define MIHOYO_SDK_SECURITYTUNNEL_RESPONSECALLBACKACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x18516090)
#define MIHOYO_SDK_SECURITYTUNNEL_RESPONSECALLBACKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18516070)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_ResponseCallbackAction_TypeDefinitionIndex = 34682;
