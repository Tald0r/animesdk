...
#define MIHOYO_SDK_WEBDELEGATE_CLEARCOOKIESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1870FB50)
#define MIHOYO_SDK_WEBDELEGATE_CLEARCOOKIESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1870FB80)
#define MIHOYO_SDK_WEBDELEGATE_CLEARCOOKIESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1870F650)
#define MIHOYO_SDK_WEBDELEGATE_CLEARCOOKIESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1870F630)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_ClearCookiesDelegate_TypeDefinitionIndex = 18369;
