...
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C2A120)
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C2A150)
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C28650)
#define MIHOYO_SDK_PSDELEGATE_PS5FRIENDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C2A100)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_PS5FriendDelegate_TypeDefinitionIndex = 18279;
