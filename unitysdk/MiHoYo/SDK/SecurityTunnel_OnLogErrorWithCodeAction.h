...
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGERRORWITHCODEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18515FE0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGERRORWITHCODEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18516060)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGERRORWITHCODEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x18515C90)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGERRORWITHCODEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18515C70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnLogErrorWithCodeAction_TypeDefinitionIndex = 34692;
