...
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGERRORWITHCODEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17EFD310)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGERRORWITHCODEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17EFD390)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGERRORWITHCODEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x17EFCFC0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGERRORWITHCODEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x17EFCFB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnLogErrorWithCodeAction_TypeDefinitionIndex = 33719;
