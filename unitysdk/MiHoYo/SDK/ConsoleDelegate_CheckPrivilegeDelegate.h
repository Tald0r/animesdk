...
#define MIHOYO_SDK_CONSOLEDELEGATE_CHECKPRIVILEGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18982080)
#define MIHOYO_SDK_CONSOLEDELEGATE_CHECKPRIVILEGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x189820B0)
#define MIHOYO_SDK_CONSOLEDELEGATE_CHECKPRIVILEGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18981B40)
#define MIHOYO_SDK_CONSOLEDELEGATE_CHECKPRIVILEGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18981B20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_CheckPrivilegeDelegate_TypeDefinitionIndex = 18154;
