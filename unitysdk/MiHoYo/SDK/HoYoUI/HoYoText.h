...
#define MIHOYO_SDK_HOYOUI_HOYOTEXT_APPLYGLOBALSKIN_OFFSET UNITYSDK_OFFSET(0x1916CD90)
#define MIHOYO_SDK_HOYOUI_HOYOTEXT_APPLYLOCALSKIN_OFFSET UNITYSDK_OFFSET(0x1916D4A0)
#define MIHOYO_SDK_HOYOUI_HOYOTEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1916D640)
#define MIHOYO_SDK_HOYOUI_HOYOTEXT_GET_COLORS_OFFSET UNITYSDK_OFFSET(0x1916CD40)
#define MIHOYO_SDK_HOYOUI_HOYOTEXT_GET_UIMETA_OFFSET UNITYSDK_OFFSET(0x1916CD30)
#define MIHOYO_SDK_HOYOUI_HOYOTEXT_UPDATETEXTCOLOR_OFFSET UNITYSDK_OFFSET(0x1916D6A0)
#define MIHOYO_SDK_HOYOUI_HOYOTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1916D720)

namespace MiHoYo::SDK::HoYoUI
{
	inline static constexpr unsigned int HoYoText_TypeDefinitionIndex = 34948;
