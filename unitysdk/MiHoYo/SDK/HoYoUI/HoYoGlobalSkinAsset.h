...
#define MIHOYO_SDK_HOYOUI_HOYOGLOBALSKINASSET_GETCOLORORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1922C420)
#define MIHOYO_SDK_HOYOUI_HOYOGLOBALSKINASSET_PARSESKINCONFIGURATION_OFFSET UNITYSDK_OFFSET(0x1922C5A0)
#define MIHOYO_SDK_HOYOUI_HOYOGLOBALSKINASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1922C540)

namespace MiHoYo::SDK::HoYoUI
{
	inline static constexpr unsigned int HoYoGlobalSkinAsset_TypeDefinitionIndex = 34952;
