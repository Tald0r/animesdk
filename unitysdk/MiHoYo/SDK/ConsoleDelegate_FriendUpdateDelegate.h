...
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDUPDATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x188913D0)
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDUPDATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18891400)
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDUPDATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18891130)
#define MIHOYO_SDK_CONSOLEDELEGATE_FRIENDUPDATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18891110)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_FriendUpdateDelegate_TypeDefinitionIndex = 18157;
