...
#define MIHOYO_SDK_TELEMETRYDELEGATE_REPORTTOKIBANADELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C2DC00)
#define MIHOYO_SDK_TELEMETRYDELEGATE_REPORTTOKIBANADELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C2DC70)
#define MIHOYO_SDK_TELEMETRYDELEGATE_REPORTTOKIBANADELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C2D660)
#define MIHOYO_SDK_TELEMETRYDELEGATE_REPORTTOKIBANADELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C2D640)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TelemetryDelegate_ReportToKibanaDelegate_TypeDefinitionIndex = 18229;
