...
#define MIHOYO_SDK_TELEMETRYDELEGATE_REPORTTOKIBANADELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18764850)
#define MIHOYO_SDK_TELEMETRYDELEGATE_REPORTTOKIBANADELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187648C0)
#define MIHOYO_SDK_TELEMETRYDELEGATE_REPORTTOKIBANADELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x187642B0)
#define MIHOYO_SDK_TELEMETRYDELEGATE_REPORTTOKIBANADELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x187642A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TelemetryDelegate_ReportToKibanaDelegate_TypeDefinitionIndex = 17722;
