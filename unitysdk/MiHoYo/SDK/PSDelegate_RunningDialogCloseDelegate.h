...
#define MIHOYO_SDK_PSDELEGATE_RUNNINGDIALOGCLOSEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1820EA10)
#define MIHOYO_SDK_PSDELEGATE_RUNNINGDIALOGCLOSEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1820EA40)
#define MIHOYO_SDK_PSDELEGATE_RUNNINGDIALOGCLOSEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1820E770)
#define MIHOYO_SDK_PSDELEGATE_RUNNINGDIALOGCLOSEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1820E760)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_RunningDialogCloseDelegate_TypeDefinitionIndex = 17748;
