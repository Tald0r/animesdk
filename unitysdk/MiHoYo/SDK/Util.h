...
#define MIHOYO_SDK_UTIL_ADDTIME_OFFSET UNITYSDK_OFFSET(0x184801F0)
#define MIHOYO_SDK_UTIL_GENERATESEQUENCEARRAY_1_OFFSET UNITYSDK_OFFSET(0x1846D840)
#define MIHOYO_SDK_UTIL_GENERATESEQUENCEARRAY_OFFSET UNITYSDK_OFFSET(0x184805E0)
#define MIHOYO_SDK_UTIL_GETCURRENTTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x18480250)
#define MIHOYO_SDK_UTIL_GETDATETIME_OFFSET UNITYSDK_OFFSET(0x184803B0)
#define MIHOYO_SDK_UTIL_ISHOYODOMAIN_OFFSET UNITYSDK_OFFSET(0x1847FFD0)
#define MIHOYO_SDK_UTIL_ISVALIDEMAIL_OFFSET UNITYSDK_OFFSET(0x18480550)
#define MIHOYO_SDK_UTIL_MASKEMAIL_OFFSET UNITYSDK_OFFSET(0x18480650)
#define MIHOYO_SDK_UTIL_YMDTOUTCTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x184804B0)
#define MIHOYO_SDK_UTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x184808B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Util_TypeDefinitionIndex = 18720;
