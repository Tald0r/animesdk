...
#define MIHOYO_SDK_PSDELEGATE_CREATETROPHYCONTEXTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x186EFF80)
#define MIHOYO_SDK_PSDELEGATE_CREATETROPHYCONTEXTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x186EFFD0)
#define MIHOYO_SDK_PSDELEGATE_CREATETROPHYCONTEXTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x186EFC40)
#define MIHOYO_SDK_PSDELEGATE_CREATETROPHYCONTEXTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x186EFC30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_CreateTrophyContextDelegate_TypeDefinitionIndex = 17765;
