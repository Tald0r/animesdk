...
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18899970)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_MIHOYO_SDK_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18899B90)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_MIHOYO_SDK_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18899B20)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18899D30)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18899B80)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18899B30)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18899940)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25__CTOR_OFFSET UNITYSDK_OFFSET(0x188998A0)
#define MIHOYO_SDK_JSONOBJECT__GET_CHILDREN_D__25___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x18899960)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int JSONObject__get_Children_d__25_TypeDefinitionIndex = 18658;

	class JSONObject__get_Children_d__25 : public ::System::Object
	{
	public:
		::MiHoYo::SDK::JSONNode* __2__current; // 0x10
		::MiHoYo::SDK::JSONObject* __4__this; // 0x18
		::System::Collections::Generic::Dictionary_2_Enumerator<::System::String*, ::MiHoYo::SDK::JSONNode*> __s__1; // 0x20
