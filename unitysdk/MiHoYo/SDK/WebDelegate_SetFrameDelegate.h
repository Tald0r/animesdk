...
#define MIHOYO_SDK_WEBDELEGATE_SETFRAMEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x186F6CD0)
#define MIHOYO_SDK_WEBDELEGATE_SETFRAMEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x186F6D80)
#define MIHOYO_SDK_WEBDELEGATE_SETFRAMEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x186F6640)
#define MIHOYO_SDK_WEBDELEGATE_SETFRAMEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x186F6630)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetFrameDelegate_TypeDefinitionIndex = 17855;
