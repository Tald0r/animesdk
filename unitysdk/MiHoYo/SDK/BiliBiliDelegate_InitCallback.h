...
#define MIHOYO_SDK_BILIBILIDELEGATE_INITCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x186CDC90)
#define MIHOYO_SDK_BILIBILIDELEGATE_INITCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x186CDCF0)
#define MIHOYO_SDK_BILIBILIDELEGATE_INITCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x186CD730)
#define MIHOYO_SDK_BILIBILIDELEGATE_INITCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x186CD720)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_InitCallback_TypeDefinitionIndex = 17635;
