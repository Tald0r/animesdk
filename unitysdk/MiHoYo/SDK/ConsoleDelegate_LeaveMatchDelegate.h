...
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18784580)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187845C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18784000)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVEMATCHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18783FF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_LeaveMatchDelegate_TypeDefinitionIndex = 17693;
