...
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONENABLEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BE54B0)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONENABLEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BE5510)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONENABLEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BE4EC0)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONENABLEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE4EA0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetBackButtonEnabledDelegate_TypeDefinitionIndex = 18358;
