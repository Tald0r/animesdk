...
#define MIHOYO_SDK_CONSOLEDELEGATE_HASJOINSESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18939880)
#define MIHOYO_SDK_CONSOLEDELEGATE_HASJOINSESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x189398B0)
#define MIHOYO_SDK_CONSOLEDELEGATE_HASJOINSESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x189395E0)
#define MIHOYO_SDK_CONSOLEDELEGATE_HASJOINSESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x189395C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_HasJoinSessionDelegate_TypeDefinitionIndex = 18162;
