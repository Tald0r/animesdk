...
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWANIMATIONENABLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18764240)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWANIMATIONENABLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18764290)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWANIMATIONENABLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18763ED0)
#define MIHOYO_SDK_SDKDELEGATE_WEBVIEWANIMATIONENABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x18763EC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_WebViewAnimationEnable_TypeDefinitionIndex = 17825;
