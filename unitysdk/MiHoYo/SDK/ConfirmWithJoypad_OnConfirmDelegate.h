...
#define MIHOYO_SDK_CONFIRMWITHJOYPAD_ONCONFIRMDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CD4DE0)
#define MIHOYO_SDK_CONFIRMWITHJOYPAD_ONCONFIRMDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CD4E70)
#define MIHOYO_SDK_CONFIRMWITHJOYPAD_ONCONFIRMDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CD4940)
#define MIHOYO_SDK_CONFIRMWITHJOYPAD_ONCONFIRMDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD4DC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConfirmWithJoypad_OnConfirmDelegate_TypeDefinitionIndex = 18524;
