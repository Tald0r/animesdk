...
#define MIHOYO_SDK_WATERMARKDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAF0F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WatermarkDefine_TypeDefinitionIndex = 17633;
