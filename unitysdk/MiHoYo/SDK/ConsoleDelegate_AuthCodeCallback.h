...
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A9E3F0)
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A9E470)
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A9E060)
#define MIHOYO_SDK_CONSOLEDELEGATE_AUTHCODECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9E040)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_AuthCodeCallback_TypeDefinitionIndex = 18176;
