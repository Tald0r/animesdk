...
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPDATAUPLOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BAE960)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPDATAUPLOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BAE990)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPDATAUPLOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BAE460)
#define MIHOYO_SDK_TELEMETRYDELEGATE_STOPDATAUPLOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAE450)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TelemetryDelegate_StopDataUploadDelegate_TypeDefinitionIndex = 17718;
