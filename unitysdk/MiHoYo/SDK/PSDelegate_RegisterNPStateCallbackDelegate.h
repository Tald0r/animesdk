...
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A9E9F0)
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A9EA20)
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A9E4B0)
#define MIHOYO_SDK_PSDELEGATE_REGISTERNPSTATECALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9E4A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_RegisterNPStateCallbackDelegate_TypeDefinitionIndex = 17789;
