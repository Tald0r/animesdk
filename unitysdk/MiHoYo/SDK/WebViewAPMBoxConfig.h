...
#define MIHOYO_SDK_WEBVIEWAPMBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x189562D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebViewAPMBoxConfig_TypeDefinitionIndex = 18447;
