...
#define MIHOYO_SDK_BILIBILIDELEGATE_ANTIADDICTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17E82580)
#define MIHOYO_SDK_BILIBILIDELEGATE_ANTIADDICTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17E825E0)
#define MIHOYO_SDK_BILIBILIDELEGATE_ANTIADDICTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x17E82020)
#define MIHOYO_SDK_BILIBILIDELEGATE_ANTIADDICTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17E82010)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_AntiAddictionCallback_TypeDefinitionIndex = 17638;
