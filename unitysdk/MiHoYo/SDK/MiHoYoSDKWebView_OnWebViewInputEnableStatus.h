...
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWINPUTENABLESTATUS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18F3FC90)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWINPUTENABLESTATUS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18F3FCF0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWINPUTENABLESTATUS_INVOKE_OFFSET UNITYSDK_OFFSET(0x18F3F3A0)
#define MIHOYO_SDK_MIHOYOSDKWEBVIEW_ONWEBVIEWINPUTENABLESTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x18F3FC80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKWebView_OnWebViewInputEnableStatus_TypeDefinitionIndex = 33831;
