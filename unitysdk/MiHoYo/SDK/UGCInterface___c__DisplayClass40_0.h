...
#define MIHOYO_SDK_UGCINTERFACE___C__DISPLAYCLASS40_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19A95AD0)
#define MIHOYO_SDK_UGCINTERFACE___C__DISPLAYCLASS40_0__EXCHANGETOKEN_B__0_OFFSET UNITYSDK_OFFSET(0x19A95AE0)
#define MIHOYO_SDK_UGCINTERFACE___C__DISPLAYCLASS40_0__EXCHANGETOKEN_B__1_OFFSET UNITYSDK_OFFSET(0x19A95C30)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UGCInterface___c__DisplayClass40_0_TypeDefinitionIndex = 33759;
