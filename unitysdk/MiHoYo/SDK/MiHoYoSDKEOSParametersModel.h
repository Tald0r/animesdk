...
#define MIHOYO_SDK_MIHOYOSDKEOSPARAMETERSMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD56F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKEOSParametersModel_TypeDefinitionIndex = 34638;
