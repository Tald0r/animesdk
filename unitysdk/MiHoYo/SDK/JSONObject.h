...
#define MIHOYO_SDK_JSONOBJECT_ADD_OFFSET UNITYSDK_OFFSET(0x187764B0)
#define MIHOYO_SDK_JSONOBJECT_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x187761B0)
#define MIHOYO_SDK_JSONOBJECT_GETVALUEORDEFAULT_OFFSET UNITYSDK_OFFSET(0x18776A60)
#define MIHOYO_SDK_JSONOBJECT_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x18776B20)
#define MIHOYO_SDK_JSONOBJECT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x18776490)
#define MIHOYO_SDK_JSONOBJECT_GET_INLINE_OFFSET UNITYSDK_OFFSET(0x18776170)
#define MIHOYO_SDK_JSONOBJECT_GET_ISOBJECT_OFFSET UNITYSDK_OFFSET(0x187761A0)
#define MIHOYO_SDK_JSONOBJECT_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x18776250)
#define MIHOYO_SDK_JSONOBJECT_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1875D730)
#define MIHOYO_SDK_JSONOBJECT_GET_TAG_OFFSET UNITYSDK_OFFSET(0x18776190)
#define MIHOYO_SDK_JSONOBJECT_HASKEY_OFFSET UNITYSDK_OFFSET(0x187769E0)
#define MIHOYO_SDK_JSONOBJECT_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x18776830)
#define MIHOYO_SDK_JSONOBJECT_REMOVE_2_OFFSET UNITYSDK_OFFSET(0x187768C0)
#define MIHOYO_SDK_JSONOBJECT_REMOVE_OFFSET UNITYSDK_OFFSET(0x18776760)
#define MIHOYO_SDK_JSONOBJECT_SET_INLINE_OFFSET UNITYSDK_OFFSET(0x18776180)
#define MIHOYO_SDK_JSONOBJECT_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x187762C0)
#define MIHOYO_SDK_JSONOBJECT_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x18760E70)
#define MIHOYO_SDK_JSONOBJECT_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x18776B80)
#define MIHOYO_SDK_JSONOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18760DC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int JSONObject_TypeDefinitionIndex = 18656;
