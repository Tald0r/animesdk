...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERGAMEOVERLAYCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BCFA50)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERGAMEOVERLAYCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BCFA80)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERGAMEOVERLAYCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BCF550)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_REGISTERGAMEOVERLAYCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCF530)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_RegisterGameOverlayCallbackDelegate_TypeDefinitionIndex = 19003;
