...
#define MIHOYO_SDK_PC_OS_PURCHASEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18942D50)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int PurchaseData_TypeDefinitionIndex = 19032;
