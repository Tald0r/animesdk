...
#define MIHOYO_SDK_PC_OS_GOOGLEPLAYABTESTREQUESTPARAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18A9FF00)
#define MIHOYO_SDK_PC_OS_GOOGLEPLAYABTESTREQUESTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x18A9FEF0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int GooglePlayABTestRequestParam_TypeDefinitionIndex = 19054;
	...
	public:
		...
		::System::Collections::Generic::List_1<::System::String*>* ExperimentIdList; // 0x28
