...
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY_ENTERGOOGLENATIVE_OFFSET UNITYSDK_OFFSET(0x18E44A30)
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY_GETGOOGLEPLAYABTESTREQUESTMODEL_OFFSET UNITYSDK_OFFSET(0x18E43BB0)
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY_ONGOOGLEABTESTRESPONSE_OFFSET UNITYSDK_OFFSET(0x18E44CC0)
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY_PULLABTEST_OFFSET UNITYSDK_OFFSET(0x18E43860)
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY_REQUESTABTESTCONFIG_OFFSET UNITYSDK_OFFSET(0x18E43D40)
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY__CCTOR_OFFSET UNITYSDK_OFFSET(0x18E45350)
#define MIHOYO_SDK_PC_OS_ABTESTGOOGLEPLAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E44CB0)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int ABTestGooglePlay_TypeDefinitionIndex = 19055;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PC::OS::ABTestGooglePlay**)Il2CppClass::FromTypeDefinitionIndex(ABTestGooglePlay_TypeDefinitionIndex)->GetStaticField(0xA580);
		}
