...
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LOGINDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18942D00)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LOGINDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18942D40)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LOGINDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18942780)
#define MIHOYO_SDK_PC_OS_HOYOCHANNELDELEGATE_LOGINDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18942760)

namespace MiHoYo::SDK::PC::OS
{
	inline static constexpr unsigned int HoYoChannelDelegate_LoginDelegate_TypeDefinitionIndex = 18996;
