...
#define MIHOYO_SDK_KCPCLIENT_ONDISCONNETDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C8EE20)
#define MIHOYO_SDK_KCPCLIENT_ONDISCONNETDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C8EE50)
#define MIHOYO_SDK_KCPCLIENT_ONDISCONNETDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C8E920)
#define MIHOYO_SDK_KCPCLIENT_ONDISCONNETDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8E900)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KCPClient_OnDisconnetDelegate_TypeDefinitionIndex = 34415;
