...
#define MIHOYO_SDK_KCPCLIENT_ONDISCONNETDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19851E40)
#define MIHOYO_SDK_KCPCLIENT_ONDISCONNETDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19851E70)
#define MIHOYO_SDK_KCPCLIENT_ONDISCONNETDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19851940)
#define MIHOYO_SDK_KCPCLIENT_ONDISCONNETDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19851930)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KCPClient_OnDisconnetDelegate_TypeDefinitionIndex = 33461;
