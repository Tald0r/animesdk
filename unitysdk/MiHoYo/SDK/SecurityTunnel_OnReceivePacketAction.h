...
#define MIHOYO_SDK_SECURITYTUNNEL_ONRECEIVEPACKETACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A7BB30)
#define MIHOYO_SDK_SECURITYTUNNEL_ONRECEIVEPACKETACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A7BB60)
#define MIHOYO_SDK_SECURITYTUNNEL_ONRECEIVEPACKETACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A7B630)
#define MIHOYO_SDK_SECURITYTUNNEL_ONRECEIVEPACKETACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7B620)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnReceivePacketAction_TypeDefinitionIndex = 33708;
