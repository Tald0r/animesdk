...
#define MIHOYO_SDK_WEBDELEGATE_SETCURRENTWEBVIEWANIMATIONENABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x180EFBD0)
#define MIHOYO_SDK_WEBDELEGATE_SETCURRENTWEBVIEWANIMATIONENABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x180EFC30)
#define MIHOYO_SDK_WEBDELEGATE_SETCURRENTWEBVIEWANIMATIONENABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x180EF5E0)
#define MIHOYO_SDK_WEBDELEGATE_SETCURRENTWEBVIEWANIMATIONENABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x180EF5D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetCurrentWebviewAnimationEnableDelegate_TypeDefinitionIndex = 17854;
