...
#define MIHOYO_SDK_REGIONTRANSLATIONMANAGER__REQUESTREMOTETRANSLATION_D__19_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18996BD0)
#define MIHOYO_SDK_REGIONTRANSLATIONMANAGER__REQUESTREMOTETRANSLATION_D__19_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18996DC0)
#define MIHOYO_SDK_REGIONTRANSLATIONMANAGER__REQUESTREMOTETRANSLATION_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18996E20)
#define MIHOYO_SDK_REGIONTRANSLATIONMANAGER__REQUESTREMOTETRANSLATION_D__19_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18996DD0)
#define MIHOYO_SDK_REGIONTRANSLATIONMANAGER__REQUESTREMOTETRANSLATION_D__19_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18996BC0)
#define MIHOYO_SDK_REGIONTRANSLATIONMANAGER__REQUESTREMOTETRANSLATION_D__19__CTOR_OFFSET UNITYSDK_OFFSET(0x18996BB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int RegionTranslationManager__RequestRemoteTranslation_d__19_TypeDefinitionIndex = 18488;
