...
#define MIHOYO_SDK_WEBDELEGATE_SETNEWWINDOWTYPEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x180F0820)
#define MIHOYO_SDK_WEBDELEGATE_SETNEWWINDOWTYPEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x180F0880)
#define MIHOYO_SDK_WEBDELEGATE_SETNEWWINDOWTYPEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x180F02C0)
#define MIHOYO_SDK_WEBDELEGATE_SETNEWWINDOWTYPEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x180F02B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetNewWindowTypeDelegate_TypeDefinitionIndex = 17860;
