...
#define MIHOYO_SDK_SDKDELEGATE_LOADASSETDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x180E8A60)
#define MIHOYO_SDK_SDKDELEGATE_LOADASSETDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x180E8AA0)
#define MIHOYO_SDK_SDKDELEGATE_LOADASSETDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x180E84C0)
#define MIHOYO_SDK_SDKDELEGATE_LOADASSETDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x180E84B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_LoadAssetDelegate_TypeDefinitionIndex = 17805;
