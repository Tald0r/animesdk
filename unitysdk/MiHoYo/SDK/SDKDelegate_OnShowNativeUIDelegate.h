...
#define MIHOYO_SDK_SDKDELEGATE_ONSHOWNATIVEUIDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x182871D0)
#define MIHOYO_SDK_SDKDELEGATE_ONSHOWNATIVEUIDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18287210)
#define MIHOYO_SDK_SDKDELEGATE_ONSHOWNATIVEUIDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18286C50)
#define MIHOYO_SDK_SDKDELEGATE_ONSHOWNATIVEUIDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18286C40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_OnShowNativeUIDelegate_TypeDefinitionIndex = 17827;
