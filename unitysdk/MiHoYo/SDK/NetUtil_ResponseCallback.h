...
#define MIHOYO_SDK_NETUTIL_RESPONSECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A95DD0)
#define MIHOYO_SDK_NETUTIL_RESPONSECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A95E10)
#define MIHOYO_SDK_NETUTIL_RESPONSECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A95850)
#define MIHOYO_SDK_NETUTIL_RESPONSECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18A95840)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetUtil_ResponseCallback_TypeDefinitionIndex = 18197;
