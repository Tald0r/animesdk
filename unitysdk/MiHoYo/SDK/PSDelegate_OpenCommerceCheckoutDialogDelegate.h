...
#define MIHOYO_SDK_PSDELEGATE_OPENCOMMERCECHECKOUTDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B716A0)
#define MIHOYO_SDK_PSDELEGATE_OPENCOMMERCECHECKOUTDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B71730)
#define MIHOYO_SDK_PSDELEGATE_OPENCOMMERCECHECKOUTDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B71030)
#define MIHOYO_SDK_PSDELEGATE_OPENCOMMERCECHECKOUTDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B71010)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_OpenCommerceCheckoutDialogDelegate_TypeDefinitionIndex = 18265;
