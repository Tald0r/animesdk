...
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVESESSIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x180D1840)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVESESSIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x180D1870)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVESESSIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x180D1300)
#define MIHOYO_SDK_CONSOLEDELEGATE_LEAVESESSIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x180D12F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_LeaveSessionDelegate_TypeDefinitionIndex = 17663;
