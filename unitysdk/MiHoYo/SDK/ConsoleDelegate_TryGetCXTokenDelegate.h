...
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETCXTOKENDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C0B580)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETCXTOKENDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C0B630)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETCXTOKENDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C0AD80)
#define MIHOYO_SDK_CONSOLEDELEGATE_TRYGETCXTOKENDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0AD60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_TryGetCXTokenDelegate_TypeDefinitionIndex = 18205;
