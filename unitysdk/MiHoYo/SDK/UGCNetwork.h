...
#define MIHOYO_SDK_UGCNETWORK_GENERATERANDOMDELAYTIMEMS_OFFSET UNITYSDK_OFFSET(0x1960D9F0)
#define MIHOYO_SDK_UGCNETWORK_HTTPGETBINARY_OFFSET UNITYSDK_OFFSET(0x1960D590)
#define MIHOYO_SDK_UGCNETWORK_HTTPPOSTBINARY_OFFSET UNITYSDK_OFFSET(0x1960D800)
#define MIHOYO_SDK_UGCNETWORK_PERFORMHTTPREQUESTBINARY_OFFSET UNITYSDK_OFFSET(0x1960D750)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UGCNetwork_TypeDefinitionIndex = 33764;
