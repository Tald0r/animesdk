...
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_CLASS_3_BBFFA3EDA51FCB23_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A78FC0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_CLASS_3_BBFFA3EDA51FCB23_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A79030)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_CLASS_3_BBFFA3EDA51FCB23_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A78C80)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_CLASS_3_BBFFA3EDA51FCB23__CTOR_OFFSET UNITYSDK_OFFSET(0x19A78C70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKBiliBiliInterface_Class_3_BBFFA3EDA51FCB23_TypeDefinitionIndex = 33614;
