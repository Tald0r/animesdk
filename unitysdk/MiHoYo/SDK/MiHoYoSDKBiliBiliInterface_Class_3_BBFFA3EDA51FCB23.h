...
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_CLASS_3_BBFFA3EDA51FCB23_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A065610)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_CLASS_3_BBFFA3EDA51FCB23_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A065680)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_CLASS_3_BBFFA3EDA51FCB23_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A0652B0)
#define MIHOYO_SDK_MIHOYOSDKBILIBILIINTERFACE_CLASS_3_BBFFA3EDA51FCB23__CTOR_OFFSET UNITYSDK_OFFSET(0x1A065290)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKBiliBiliInterface_Class_3_BBFFA3EDA51FCB23_TypeDefinitionIndex = 34587;
