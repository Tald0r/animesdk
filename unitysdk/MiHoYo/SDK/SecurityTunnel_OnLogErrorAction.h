...
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGERRORACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1960CEB0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGERRORACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1960CEE0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGERRORACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1960C9B0)
#define MIHOYO_SDK_SECURITYTUNNEL_ONLOGERRORACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1960C9A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SecurityTunnel_OnLogErrorAction_TypeDefinitionIndex = 33718;
