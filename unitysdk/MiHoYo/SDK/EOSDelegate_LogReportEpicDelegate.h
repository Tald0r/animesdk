...
#define MIHOYO_SDK_EOSDELEGATE_LOGREPORTEPICDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18449B70)
#define MIHOYO_SDK_EOSDELEGATE_LOGREPORTEPICDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18449C00)
#define MIHOYO_SDK_EOSDELEGATE_LOGREPORTEPICDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x184497E0)
#define MIHOYO_SDK_EOSDELEGATE_LOGREPORTEPICDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x184497D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_LogReportEpicDelegate_TypeDefinitionIndex = 17742;
