...
#define MIHOYO_SDK_ALERTCOMPLIANCE_ONALERTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x180B8E80)
#define MIHOYO_SDK_ALERTCOMPLIANCE_ONALERTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x180B8EF0)
#define MIHOYO_SDK_ALERTCOMPLIANCE_ONALERTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x180B8B90)
#define MIHOYO_SDK_ALERTCOMPLIANCE_ONALERTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x180B8B80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AlertCompliance_OnAlertDelegate_TypeDefinitionIndex = 18008;
