...
#define MIHOYO_SDK_MIHOYOSDKGUESTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8EF40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKGuestModel_TypeDefinitionIndex = 34634;
