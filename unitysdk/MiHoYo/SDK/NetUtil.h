...
#define MIHOYO_SDK_NETUTIL_DOWNLOADDATAASBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x18CDC560)
#define MIHOYO_SDK_NETUTIL_GENERATERANDOMDELAYTIMEMS_OFFSET UNITYSDK_OFFSET(0x18CDDE30)
#define MIHOYO_SDK_NETUTIL_HTTPGETBINARY_OFFSET UNITYSDK_OFFSET(0x18CDDBC0)
#define MIHOYO_SDK_NETUTIL_HTTPGET_1_OFFSET UNITYSDK_OFFSET(0x18CDC920)
#define MIHOYO_SDK_NETUTIL_HTTPGET_OFFSET UNITYSDK_OFFSET(0x18CDC5C0)
#define MIHOYO_SDK_NETUTIL_HTTPPOSTFORM_1_OFFSET UNITYSDK_OFFSET(0x18CDD720)
#define MIHOYO_SDK_NETUTIL_HTTPPOSTFORM_OFFSET UNITYSDK_OFFSET(0x18CDD360)
#define MIHOYO_SDK_NETUTIL_HTTPPOSTJSON_1_OFFSET UNITYSDK_OFFSET(0x18CDCFF0)
#define MIHOYO_SDK_NETUTIL_HTTPPOSTJSON_OFFSET UNITYSDK_OFFSET(0x18CDCC80)
#define MIHOYO_SDK_NETUTIL_PERFORMHTTPREQUESTFORBINARYRESPONSE_OFFSET UNITYSDK_OFFSET(0x18CDDDA0)
#define MIHOYO_SDK_NETUTIL_PERFORMHTTPREQUESTINTERNAL_OFFSET UNITYSDK_OFFSET(0x18CDDAE0)
#define MIHOYO_SDK_NETUTIL_PERFORMHTTPREQUEST_1_OFFSET UNITYSDK_OFFSET(0x18CDCB10)
#define MIHOYO_SDK_NETUTIL_PERFORMHTTPREQUEST_OFFSET UNITYSDK_OFFSET(0x18CDC7B0)
#define MIHOYO_SDK_NETUTIL_REGISTERINTERCEPTOR_OFFSET UNITYSDK_OFFSET(0x18CDC3E0)
#define MIHOYO_SDK_NETUTIL_TRYHTTPREQUESTBYHTTPDNS_OFFSET UNITYSDK_OFFSET(0x18CDDE50)
#define MIHOYO_SDK_NETUTIL_UNREGISTERINTERCEPTOR_OFFSET UNITYSDK_OFFSET(0x18CDC4D0)
#define MIHOYO_SDK_NETUTIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x18CDE320)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetUtil_TypeDefinitionIndex = 18704;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::MiHoYo::SDK::INetworkInterceptor*>**)Il2CppClass::FromTypeDefinitionIndex(NetUtil_TypeDefinitionIndex)->GetStaticField(0xB0F0);
		}
