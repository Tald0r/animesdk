...
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATERECENTPLAYERSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1876D8C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATERECENTPLAYERSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1876D8F0)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATERECENTPLAYERSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1876D3C0)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATERECENTPLAYERSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1876D3A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_UpdateRecentPlayersDelegate_TypeDefinitionIndex = 18167;
