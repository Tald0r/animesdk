...
#define MIHOYO_SDK_PSDELEGATE_NOTIFYPREMIUMFEATUREDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C92830)
#define MIHOYO_SDK_PSDELEGATE_NOTIFYPREMIUMFEATUREDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C92880)
#define MIHOYO_SDK_PSDELEGATE_NOTIFYPREMIUMFEATUREDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C7C0D0)
#define MIHOYO_SDK_PSDELEGATE_NOTIFYPREMIUMFEATUREDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C92810)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_NotifyPremiumFeatureDelegate_TypeDefinitionIndex = 18293;
