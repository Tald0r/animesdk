...
#define MIHOYO_SDK_MMTMANAGER_GEETESTMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18E41FF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MmtManager_GeetestModel_TypeDefinitionIndex = 18559;
