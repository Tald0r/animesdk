...
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_ALIGN_OFFSET UNITYSDK_OFFSET(0x1827F380)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_BOTTOMLEFT_OFFSET UNITYSDK_OFFSET(0x1827F1A0)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_BOTTOMRIGHT_OFFSET UNITYSDK_OFFSET(0x1827F2E0)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_BOTTOM_OFFSET UNITYSDK_OFFSET(0x1827F240)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_CENTER_OFFSET UNITYSDK_OFFSET(0x1827F060)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_LEFT_OFFSET UNITYSDK_OFFSET(0x1827EFC0)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_RIGHT_OFFSET UNITYSDK_OFFSET(0x1827F100)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_SETALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1827ED40)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_SETSTRETCHHORIZONTALRECT_OFFSET UNITYSDK_OFFSET(0x1827F570)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_SETSTRETCHVERTICALRECT_OFFSET UNITYSDK_OFFSET(0x1827FA30)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_STRETCHFULL_OFFSET UNITYSDK_OFFSET(0x18280490)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_STRETCHHORIZONTALBOTTOM_OFFSET UNITYSDK_OFFSET(0x182800D0)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_STRETCHHORIZONTALCENTER_OFFSET UNITYSDK_OFFSET(0x1827FFE0)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_STRETCHHORIZONTALTOP_OFFSET UNITYSDK_OFFSET(0x1827FEF0)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_STRETCHVERTICALCENTER_OFFSET UNITYSDK_OFFSET(0x182802B0)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_STRETCHVERTICALLEFT_OFFSET UNITYSDK_OFFSET(0x182801C0)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_STRETCHVERTICALRIGHT_OFFSET UNITYSDK_OFFSET(0x182803A0)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_STRETCH_OFFSET UNITYSDK_OFFSET(0x18280840)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_TOPLEFT_OFFSET UNITYSDK_OFFSET(0x1827EDE0)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_TOPRIGHT_OFFSET UNITYSDK_OFFSET(0x1827EF20)
#define MIHOYO_SDK_MIHOYOSDKRECTTRANSFORM_TOP_OFFSET UNITYSDK_OFFSET(0x1827EE80)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKRectTransform_TypeDefinitionIndex = 18019;
