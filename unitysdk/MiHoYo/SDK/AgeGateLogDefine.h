...
#define MIHOYO_SDK_AGEGATELOGDEFINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1767B8F0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AgeGateLogDefine_TypeDefinitionIndex = 18090;
