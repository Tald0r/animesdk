...
#define MIHOYO_SDK_BROWSERWIN32HELPER_ENUMWINDOWSPROC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18E1B0E0)
#define MIHOYO_SDK_BROWSERWIN32HELPER_ENUMWINDOWSPROC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18E1B150)
#define MIHOYO_SDK_BROWSERWIN32HELPER_ENUMWINDOWSPROC_INVOKE_OFFSET UNITYSDK_OFFSET(0x18E1ADA0)
#define MIHOYO_SDK_BROWSERWIN32HELPER_ENUMWINDOWSPROC__CTOR_OFFSET UNITYSDK_OFFSET(0x18E1AD90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BrowserWin32Helper_EnumWindowsProc_TypeDefinitionIndex = 33841;
