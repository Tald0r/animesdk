...
#define MIHOYO_SDK_NATIVETASK_DOLOGGER_OFFSET UNITYSDK_OFFSET(0x18789AD0)
#define MIHOYO_SDK_NATIVETASK_ISNATIVETASKSWITCHENABLE_OFFSET UNITYSDK_OFFSET(0x18789B80)
#define MIHOYO_SDK_NATIVETASK_KIBANAREPORTEASY_OFFSET UNITYSDK_OFFSET(0x18789F30)
#define MIHOYO_SDK_NATIVETASK_NATIVEINVOKERETURN_OFFSET UNITYSDK_OFFSET(0x18789FE0)
#define MIHOYO_SDK_NATIVETASK_NATIVEINVOKE_OFFSET UNITYSDK_OFFSET(0x18789BB0)
#define MIHOYO_SDK_NATIVETASK_ONSYNCDATATONATIVE_OFFSET UNITYSDK_OFFSET(0x18789BA0)
#define MIHOYO_SDK_NATIVETASK_SYNCDATATONATIVE_OFFSET UNITYSDK_OFFSET(0x18789B90)
#define MIHOYO_SDK_NATIVETASK_USINGNATIVETASK_OFFSET UNITYSDK_OFFSET(0x18789810)
#define MIHOYO_SDK_NATIVETASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1878A2C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NativeTask_TypeDefinitionIndex = 18004;
