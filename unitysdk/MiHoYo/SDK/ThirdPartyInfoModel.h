...
#define MIHOYO_SDK_THIRDPARTYINFOMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18218C20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ThirdPartyInfoModel_TypeDefinitionIndex = 17885;
