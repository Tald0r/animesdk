...
#define MIHOYO_SDK_THIRDPARTYINFOMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18787D00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ThirdPartyInfoModel_TypeDefinitionIndex = 18392;
