...
#define MIHOYO_SDK_BASE_GOODSPLATFORM_CONST__CTOR_OFFSET UNITYSDK_OFFSET(0x18466C70)

namespace MiHoYo::SDK::Base::GoodsPlatform
{
	inline static constexpr unsigned int Const_TypeDefinitionIndex = 19074;
