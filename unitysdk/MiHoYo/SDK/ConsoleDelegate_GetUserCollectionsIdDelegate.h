...
#define MIHOYO_SDK_CONSOLEDELEGATE_GETUSERCOLLECTIONSIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18783140)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETUSERCOLLECTIONSIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18783180)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETUSERCOLLECTIONSIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18782BC0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETUSERCOLLECTIONSIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18782BB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_GetUserCollectionsIdDelegate_TypeDefinitionIndex = 17701;
