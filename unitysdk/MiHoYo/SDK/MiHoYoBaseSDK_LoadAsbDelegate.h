...
#define MIHOYO_SDK_MIHOYOBASESDK_LOADASBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x199CC240)
#define MIHOYO_SDK_MIHOYOBASESDK_LOADASBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x199CC270)
#define MIHOYO_SDK_MIHOYOBASESDK_LOADASBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x199CBD00)
#define MIHOYO_SDK_MIHOYOBASESDK_LOADASBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x199CBCE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoBaseSDK_LoadAsbDelegate_TypeDefinitionIndex = 34540;
