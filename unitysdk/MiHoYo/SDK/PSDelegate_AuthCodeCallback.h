...
#define MIHOYO_SDK_PSDELEGATE_AUTHCODECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CE6940)
#define MIHOYO_SDK_PSDELEGATE_AUTHCODECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CE69C0)
#define MIHOYO_SDK_PSDELEGATE_AUTHCODECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CE65B0)
#define MIHOYO_SDK_PSDELEGATE_AUTHCODECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18CD75B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_AuthCodeCallback_TypeDefinitionIndex = 18252;
