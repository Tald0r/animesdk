...
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCSHOWPAYMENTWINDOWDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1928E850)
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCSHOWPAYMENTWINDOWDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1928E890)
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCSHOWPAYMENTWINDOWDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1928E2D0)
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCSHOWPAYMENTWINDOWDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1928E2C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_AsyncShowPaymentWindowDelegate_TypeDefinitionIndex = 17727;
