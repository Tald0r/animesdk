...
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCSHOWPAYMENTWINDOWDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19355A60)
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCSHOWPAYMENTWINDOWDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19355AA0)
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCSHOWPAYMENTWINDOWDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x193554E0)
#define MIHOYO_SDK_WEGAMEDELEGATE_ASYNCSHOWPAYMENTWINDOWDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x193554C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WeGameDelegate_AsyncShowPaymentWindowDelegate_TypeDefinitionIndex = 18234;
