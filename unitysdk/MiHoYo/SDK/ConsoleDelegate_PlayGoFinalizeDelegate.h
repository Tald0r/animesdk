...
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOFINALIZEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17694680)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOFINALIZEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x176946B0)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOFINALIZEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x176943E0)
#define MIHOYO_SDK_CONSOLEDELEGATE_PLAYGOFINALIZEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x176943C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_PlayGoFinalizeDelegate_TypeDefinitionIndex = 18197;
