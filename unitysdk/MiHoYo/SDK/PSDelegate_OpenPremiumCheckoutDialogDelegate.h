...
#define MIHOYO_SDK_PSDELEGATE_OPENPREMIUMCHECKOUTDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18996AE0)
#define MIHOYO_SDK_PSDELEGATE_OPENPREMIUMCHECKOUTDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18996B10)
#define MIHOYO_SDK_PSDELEGATE_OPENPREMIUMCHECKOUTDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x189965E0)
#define MIHOYO_SDK_PSDELEGATE_OPENPREMIUMCHECKOUTDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x189965C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_OpenPremiumCheckoutDialogDelegate_TypeDefinitionIndex = 18294;
