...
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM_AWAKE_OFFSET UNITYSDK_OFFSET(0x189A2370)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM_CANCEL_OFFSET UNITYSDK_OFFSET(0x189A35C0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM_CONFIRM_OFFSET UNITYSDK_OFFSET(0x189A3550)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM_HIDE_OFFSET UNITYSDK_OFFSET(0x189A35E0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM_SHOW_OFFSET UNITYSDK_OFFSET(0x189A3420)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x189A31D0)
#define MIHOYO_SDK_WIN_OVERSEAACCOUNTLISTCONFIRM__CTOR_OFFSET UNITYSDK_OFFSET(0x189A3650)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaAccountListConfirm_TypeDefinitionIndex = 19526;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaAccountListConfirm**)Il2CppClass::FromTypeDefinitionIndex(OverseaAccountListConfirm_TypeDefinitionIndex)->GetStaticField(0xA0E0);
		}
