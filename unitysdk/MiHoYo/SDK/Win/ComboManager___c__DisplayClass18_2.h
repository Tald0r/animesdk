...
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS18_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1896CCF0)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS18_2__LOGIN_B__7_OFFSET UNITYSDK_OFFSET(0x1896CE30)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS18_2__LOGIN_B__8_OFFSET UNITYSDK_OFFSET(0x1896CD00)
#define MIHOYO_SDK_WIN_COMBOMANAGER___C__DISPLAYCLASS18_2__LOGIN_B__9_OFFSET UNITYSDK_OFFSET(0x1896CD60)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ComboManager___c__DisplayClass18_2_TypeDefinitionIndex = 19043;
