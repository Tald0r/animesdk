...
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x19356870)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_GETKEY_OFFSET UNITYSDK_OFFSET(0x19358180)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_ONDELETEACCOUNT_OFFSET UNITYSDK_OFFSET(0x193581B0)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x193580F0)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_PARSEACCOUNTINFO_OFFSET UNITYSDK_OFFSET(0x19357300)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER_START_OFFSET UNITYSDK_OFFSET(0x193572F0)
#define MIHOYO_SDK_WIN_ACCOUNTLISTDROPDOWNITEMHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19358230)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int AccountListDropdownItemHandler_TypeDefinitionIndex = 19520;
