...
#define MIHOYO_SDK_WIN_BINDBYMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x18C32500)
#define MIHOYO_SDK_WIN_BINDBYMAIL_BACK_OFFSET UNITYSDK_OFFSET(0x18C339C0)
#define MIHOYO_SDK_WIN_BINDBYMAIL_BIND_OFFSET UNITYSDK_OFFSET(0x18C33B70)
#define MIHOYO_SDK_WIN_BINDBYMAIL_CLOSE_OFFSET UNITYSDK_OFFSET(0x18C339E0)
#define MIHOYO_SDK_WIN_BINDBYMAIL_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x18C33B00)
#define MIHOYO_SDK_WIN_BINDBYMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x18C32490)
#define MIHOYO_SDK_WIN_BINDBYMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18C33E70)
#define MIHOYO_SDK_WIN_BINDBYMAIL_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x18C33DF0)
#define MIHOYO_SDK_WIN_BINDBYMAIL_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x18C33A00)
#define MIHOYO_SDK_WIN_BINDBYMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x18C32360)
#define MIHOYO_SDK_WIN_BINDBYMAIL_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x18C33A10)
#define MIHOYO_SDK_WIN_BINDBYMAIL_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x18C33790)
#define MIHOYO_SDK_WIN_BINDBYMAIL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x18C334A0)
#define MIHOYO_SDK_WIN_BINDBYMAIL_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x18C33B60)
#define MIHOYO_SDK_WIN_BINDBYMAIL__AWAKE_B__35_0_OFFSET UNITYSDK_OFFSET(0x18C33F30)
#define MIHOYO_SDK_WIN_BINDBYMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x18C33EB0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BindByMail_TypeDefinitionIndex = 19723;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::BindByMail**)Il2CppClass::FromTypeDefinitionIndex(BindByMail_TypeDefinitionIndex)->GetStaticField(0x9B70);
		}
