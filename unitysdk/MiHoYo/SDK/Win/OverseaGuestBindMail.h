...
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x18B837E0)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_BACK_OFFSET UNITYSDK_OFFSET(0x18B84790)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_BIND_OFFSET UNITYSDK_OFFSET(0x18B84840)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_CLOSE_OFFSET UNITYSDK_OFFSET(0x18B847B0)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_FORGETPASSWORD_OFFSET UNITYSDK_OFFSET(0x18B84AA0)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x18B83770)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18B84AC0)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_SETMAILINPUTTEXT_OFFSET UNITYSDK_OFFSET(0x18B847D0)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x18B83640)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x18B844F0)
#define MIHOYO_SDK_WIN_OVERSEAGUESTBINDMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x18B84B00)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaGuestBindMail_TypeDefinitionIndex = 19713;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaGuestBindMail**)Il2CppClass::FromTypeDefinitionIndex(OverseaGuestBindMail_TypeDefinitionIndex)->GetStaticField(0x9C20);
		}
