...
#define MIHOYO_SDK_WIN_WEGAMEMANAGER_WEGAMEEXITDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18AC1A10)
#define MIHOYO_SDK_WIN_WEGAMEMANAGER_WEGAMEEXITDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18AC1A60)
#define MIHOYO_SDK_WIN_WEGAMEMANAGER_WEGAMEEXITDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18AC1710)
#define MIHOYO_SDK_WIN_WEGAMEMANAGER_WEGAMEEXITDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AC1700)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int WeGameManager_WeGameExitDelegate_TypeDefinitionIndex = 19103;
