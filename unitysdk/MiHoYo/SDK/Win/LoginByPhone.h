...
#define MIHOYO_SDK_WIN_LOGINBYPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x192985F0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKACCOUNTLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x1929C7D0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKCLOSEBUTTON_OFFSET UNITYSDK_OFFSET(0x1929C180)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKCODEBUTTON_OFFSET UNITYSDK_OFFSET(0x1929C1C0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKGUESTBUTTON_OFFSET UNITYSDK_OFFSET(0x1929C650)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x1929C250)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKQRCODEBUTTON_OFFSET UNITYSDK_OFFSET(0x1929C1A0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKSAVERECORDTOGGLE_OFFSET UNITYSDK_OFFSET(0x1929CB10)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKTAPTAPBUTTON_OFFSET UNITYSDK_OFFSET(0x1929C7F0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKTOGGLE_OFFSET UNITYSDK_OFFSET(0x1929CAB0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKUSERAGREEMENTBUTTON_OFFSET UNITYSDK_OFFSET(0x1929C970)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_CLICKUSERPRIVACYBUTTON_OFFSET UNITYSDK_OFFSET(0x1929CA10)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1929C110)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x1929BDE0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1929CB70)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1929BCE0)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_PHONEINPUTVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x1929BE50)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1929C170)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_RESETVERIFYCODEBUTTON_OFFSET UNITYSDK_OFFSET(0x1929CC90)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x1929BD00)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1929C020)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_START_OFFSET UNITYSDK_OFFSET(0x1929BC70)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATEBOTTOMCONTENT_OFFSET UNITYSDK_OFFSET(0x1929A990)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATECODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x1929BE60)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATESAVERECORDTIPS_OFFSET UNITYSDK_OFFSET(0x1929AF50)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1929B640)
#define MIHOYO_SDK_WIN_LOGINBYPHONE_UPDATETOGGLESTATUS_OFFSET UNITYSDK_OFFSET(0x1929CC30)
#define MIHOYO_SDK_WIN_LOGINBYPHONE__AWAKE_B__43_0_OFFSET UNITYSDK_OFFSET(0x1929CD30)
#define MIHOYO_SDK_WIN_LOGINBYPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1929CCB0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginByPhone_TypeDefinitionIndex = 19159;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::LoginByPhone**)Il2CppClass::FromTypeDefinitionIndex(LoginByPhone_TypeDefinitionIndex)->GetStaticField(0x9FB0);
		}
