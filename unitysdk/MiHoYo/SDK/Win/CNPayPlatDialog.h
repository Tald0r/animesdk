...
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x18BE6DA0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_BACK_OFFSET UNITYSDK_OFFSET(0x18BED320)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_CLICKALIPAYBTN_OFFSET UNITYSDK_OFFSET(0x18BEC290)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_CLICKFOLDSWITCH_OFFSET UNITYSDK_OFFSET(0x18BECD70)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_CLICKWECHATPAYBTN_OFFSET UNITYSDK_OFFSET(0x18BEC800)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_DIALOGANIMATOREND_OFFSET UNITYSDK_OFFSET(0x18BE98C0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_FAILREFRESH_OFFSET UNITYSDK_OFFSET(0x18BE9C70)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_GET_CODELINKTYPE_OFFSET UNITYSDK_OFFSET(0x18BE6600)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x18BE6700)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18BEDAA0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_OVERDUEREFRESH_OFFSET UNITYSDK_OFFSET(0x18BE9E50)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_PAYSUCCESS_OFFSET UNITYSDK_OFFSET(0x18BED850)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_REFRESHGOODSINFO_OFFSET UNITYSDK_OFFSET(0x18BE68C0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SET_CODELINKTYPE_OFFSET UNITYSDK_OFFSET(0x18BE6610)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWNETWORKERROR_OFFSET UNITYSDK_OFFSET(0x18BEA640)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWPAYLOADING_OFFSET UNITYSDK_OFFSET(0x18BEA110)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWPAYPLATLIST_OFFSET UNITYSDK_OFFSET(0x18BEAB70)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWPAYSUCCESS_OFFSET UNITYSDK_OFFSET(0x18BEA870)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWQRCODEERROR_OFFSET UNITYSDK_OFFSET(0x18BEA4B0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWQRCODEOVERDUE_OFFSET UNITYSDK_OFFSET(0x18BEA320)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOWQRCODE_OFFSET UNITYSDK_OFFSET(0x18BEA200)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x18BE6620)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG_START_OFFSET UNITYSDK_OFFSET(0x18BE67F0)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG__BACK_B__118_0_OFFSET UNITYSDK_OFFSET(0x18BEDC50)
#define MIHOYO_SDK_WIN_CNPAYPLATDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BEDBC0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int CNPayPlatDialog_TypeDefinitionIndex = 19770;
