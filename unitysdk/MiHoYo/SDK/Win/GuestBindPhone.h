...
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x17AEC880)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_BINDMAIL_OFFSET UNITYSDK_OFFSET(0x17AEDF30)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_BIND_OFFSET UNITYSDK_OFFSET(0x17AEDBF0)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_CLOSE_OFFSET UNITYSDK_OFFSET(0x17AEDB50)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x17AEDB70)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x17AEB5C0)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17AEDF50)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x17AEDEB0)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x17AEDBD0)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x17AE8E20)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x17AE9D50)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x17AED920)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x17AED910)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x17AEDBE0)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE__AWAKE_B__34_0_OFFSET UNITYSDK_OFFSET(0x17AEE010)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x17AEDF90)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int GuestBindPhone_TypeDefinitionIndex = 19119;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::GuestBindPhone**)Il2CppClass::FromTypeDefinitionIndex(GuestBindPhone_TypeDefinitionIndex)->GetStaticField(0x9B10);
		}
