...
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x176C5EF0)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_BINDMAIL_OFFSET UNITYSDK_OFFSET(0x176C75A0)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_BIND_OFFSET UNITYSDK_OFFSET(0x176C7260)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_CLOSE_OFFSET UNITYSDK_OFFSET(0x176C71C0)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x176C71E0)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x176C4C20)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x176C75C0)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x176C7520)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x176C7240)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x176C2460)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x176C3390)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x176C6F90)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x176C6F80)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x176C7250)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE__AWAKE_B__34_0_OFFSET UNITYSDK_OFFSET(0x176C7680)
#define MIHOYO_SDK_WIN_GUESTBINDPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x176C7600)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int GuestBindPhone_TypeDefinitionIndex = 19717;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::GuestBindPhone**)Il2CppClass::FromTypeDefinitionIndex(GuestBindPhone_TypeDefinitionIndex)->GetStaticField(0x9C10);
		}
