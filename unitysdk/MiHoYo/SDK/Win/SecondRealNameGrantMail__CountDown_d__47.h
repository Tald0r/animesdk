...
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL__COUNTDOWN_D__47_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1929EBC0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL__COUNTDOWN_D__47_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1929ED80)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL__COUNTDOWN_D__47_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1929EDE0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL__COUNTDOWN_D__47_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1929ED90)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL__COUNTDOWN_D__47_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1929EBB0)
#define MIHOYO_SDK_WIN_SECONDREALNAMEGRANTMAIL__COUNTDOWN_D__47__CTOR_OFFSET UNITYSDK_OFFSET(0x1929EBA0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int SecondRealNameGrantMail__CountDown_d__47_TypeDefinitionIndex = 19143;
