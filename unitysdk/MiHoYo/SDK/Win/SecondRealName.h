...
#define MIHOYO_SDK_WIN_SECONDREALNAME_AWAKE_OFFSET UNITYSDK_OFFSET(0x18BFAF50)
#define MIHOYO_SDK_WIN_SECONDREALNAME_BACK_OFFSET UNITYSDK_OFFSET(0x18BFC5F0)
#define MIHOYO_SDK_WIN_SECONDREALNAME_CLICKBACKBUTTON_OFFSET UNITYSDK_OFFSET(0x18BFC160)
#define MIHOYO_SDK_WIN_SECONDREALNAME_GETALERTCONTENT_OFFSET UNITYSDK_OFFSET(0x18BFC320)
#define MIHOYO_SDK_WIN_SECONDREALNAME_GETIDENTITYINPUTTEXT_OFFSET UNITYSDK_OFFSET(0x18BFC6A0)
#define MIHOYO_SDK_WIN_SECONDREALNAME_GETNAMEINPUTTEXT_OFFSET UNITYSDK_OFFSET(0x18BFC680)
#define MIHOYO_SDK_WIN_SECONDREALNAME_HIDE_OFFSET UNITYSDK_OFFSET(0x18BFC610)
#define MIHOYO_SDK_WIN_SECONDREALNAME_MEETPROBLEM_OFFSET UNITYSDK_OFFSET(0x18BFC4A0)
#define MIHOYO_SDK_WIN_SECONDREALNAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18BFC970)
#define MIHOYO_SDK_WIN_SECONDREALNAME_SHOW_OFFSET UNITYSDK_OFFSET(0x18BFC010)
#define MIHOYO_SDK_WIN_SECONDREALNAME_SUBMIT_OFFSET UNITYSDK_OFFSET(0x18BFC6C0)
#define MIHOYO_SDK_WIN_SECONDREALNAME_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x18BFB9C0)
#define MIHOYO_SDK_WIN_SECONDREALNAME__CLICKBACKBUTTON_B__27_0_OFFSET UNITYSDK_OFFSET(0x18BFCA30)
#define MIHOYO_SDK_WIN_SECONDREALNAME__CLICKBACKBUTTON_B__27_1_OFFSET UNITYSDK_OFFSET(0x18BFCA50)
#define MIHOYO_SDK_WIN_SECONDREALNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x18BFC9B0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int SecondRealName_TypeDefinitionIndex = 19768;
