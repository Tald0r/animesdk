...
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x18A353B0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_BACK_OFFSET UNITYSDK_OFFSET(0x18A37D70)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKAMEXVENDOR_OFFSET UNITYSDK_OFFSET(0x18A37C00)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKECMCVENDOR_OFFSET UNITYSDK_OFFSET(0x18A37BF0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKJCBVENDOR_OFFSET UNITYSDK_OFFSET(0x18A37C10)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKPAYBUTTON_OFFSET UNITYSDK_OFFSET(0x18A37C30)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKPAYPALVENDOR_OFFSET UNITYSDK_OFFSET(0x18A37C20)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKPAYSUCCESSBUTTON_OFFSET UNITYSDK_OFFSET(0x18A37CE0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKPAYTYPEBUTTON_OFFSET UNITYSDK_OFFSET(0x18A37BD0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_CLICKVISAVENDOR_OFFSET UNITYSDK_OFFSET(0x18A37BE0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_HIDEBUYLOADING_OFFSET UNITYSDK_OFFSET(0x18A37B10)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x18A33630)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18A37E80)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_REFRESHPAYINFO_OFFSET UNITYSDK_OFFSET(0x18A337E0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_REFRESH_OFFSET UNITYSDK_OFFSET(0x18A37BC0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SETVENDORS_OFFSET UNITYSDK_OFFSET(0x18A37B00)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SHOWBUYLOADING_OFFSET UNITYSDK_OFFSET(0x18A37CB0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SHOWNETWORKERROR_OFFSET UNITYSDK_OFFSET(0x18A37B40)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SHOWPAYSUCCESS_OFFSET UNITYSDK_OFFSET(0x18A37CF0)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x18A33540)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_START_OFFSET UNITYSDK_OFFSET(0x18A33720)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x18A37790)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG__BACK_B__87_0_OFFSET UNITYSDK_OFFSET(0x18A37F50)
#define MIHOYO_SDK_WIN_OVERSEAPAYDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A37EC0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaPayDialog_TypeDefinitionIndex = 19174;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaPayDialog**)Il2CppClass::FromTypeDefinitionIndex(OverseaPayDialog_TypeDefinitionIndex)->GetStaticField(0xA6A0);
		}
