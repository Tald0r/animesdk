...
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_AWAKE_OFFSET UNITYSDK_OFFSET(0x18497B30)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_BACK_OFFSET UNITYSDK_OFFSET(0x1849A230)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_CLICKSAVERECORDTOGGLE_OFFSET UNITYSDK_OFFSET(0x1849A6D0)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1849A250)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_HIDE_OFFSET UNITYSDK_OFFSET(0x1849A1C0)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1849A730)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1849A040)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_REFRESH_OFFSET UNITYSDK_OFFSET(0x1849A270)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SETBUBBLETEXT_OFFSET UNITYSDK_OFFSET(0x1849A140)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SETSUPPORTEDSCANNINGAPPS_OFFSET UNITYSDK_OFFSET(0x1849A290)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOWLOGINSUCCESS_OFFSET UNITYSDK_OFFSET(0x1849A670)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOWNETWORKERROR_OFFSET UNITYSDK_OFFSET(0x1849A510)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOWQRCODELOADING_OFFSET UNITYSDK_OFFSET(0x1849A2A0)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOWQRCODEOVERDUE_OFFSET UNITYSDK_OFFSET(0x1849A460)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOWQRCODE_OFFSET UNITYSDK_OFFSET(0x1849A370)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOWSCANSUCCESS_OFFSET UNITYSDK_OFFSET(0x1849A5A0)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_SHOW_OFFSET UNITYSDK_OFFSET(0x1849A060)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_START_OFFSET UNITYSDK_OFFSET(0x1849A030)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_UPDATESAVERECORDTIPS_OFFSET UNITYSDK_OFFSET(0x18499A90)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x18499950)
#define MIHOYO_SDK_WIN_LOGINBYQRCODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1849A770)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginByQRCode_TypeDefinitionIndex = 19753;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::LoginByQRCode**)Il2CppClass::FromTypeDefinitionIndex(LoginByQRCode_TypeDefinitionIndex)->GetStaticField(0xA0A0);
		}
