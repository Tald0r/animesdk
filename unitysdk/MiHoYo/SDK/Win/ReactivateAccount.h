...
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_AWAKE_OFFSET UNITYSDK_OFFSET(0x188A4B10)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_CLOSE_OFFSET UNITYSDK_OFFSET(0x188A5430)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_HIDE_OFFSET UNITYSDK_OFFSET(0x188A53C0)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x188A5460)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_SHOW_OFFSET UNITYSDK_OFFSET(0x188A49E0)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_SUBMIT_OFFSET UNITYSDK_OFFSET(0x188A5450)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x188A51A0)
#define MIHOYO_SDK_WIN_REACTIVATEACCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x188A54A0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int ReactivateAccount_TypeDefinitionIndex = 19166;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::ReactivateAccount**)Il2CppClass::FromTypeDefinitionIndex(ReactivateAccount_TypeDefinitionIndex)->GetStaticField(0xA330);
		}
