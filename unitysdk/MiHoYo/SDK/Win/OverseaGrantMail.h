...
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x17AF8390)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_BACK_OFFSET UNITYSDK_OFFSET(0x17AF9EA0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_CLICTOTHERBUTTON_OFFSET UNITYSDK_OFFSET(0x17AFA2A0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x17AFA3A0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x17AF9E30)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17AFA400)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_QUESTION_OFFSET UNITYSDK_OFFSET(0x17AF9EC0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x17AFA0A0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x17AFA090)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x17AF9D40)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x17AFA2C0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_START_OFFSET UNITYSDK_OFFSET(0x17AF9A20)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_SUBMIT_OFFSET UNITYSDK_OFFSET(0x17AFA100)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x17AF98E0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x17AF95B0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x17AFA440)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaGrantMail_TypeDefinitionIndex = 19150;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaGrantMail**)Il2CppClass::FromTypeDefinitionIndex(OverseaGrantMail_TypeDefinitionIndex)->GetStaticField(0x9C30);
		}
