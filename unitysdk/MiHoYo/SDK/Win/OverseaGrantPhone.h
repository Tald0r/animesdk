...
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x18468360)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_BACK_OFFSET UNITYSDK_OFFSET(0x18469F40)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_CLICTOTHERBUTTON_OFFSET UNITYSDK_OFFSET(0x1846A340)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1846A450)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x18469ED0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1846A4B0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_QUESTION_OFFSET UNITYSDK_OFFSET(0x18469F60)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x1846A140)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1846A130)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x18469DF0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1846A360)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_START_OFFSET UNITYSDK_OFFSET(0x184699F0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_SUBMIT_OFFSET UNITYSDK_OFFSET(0x1846A1A0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x184698B0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x18469580)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1846A4F0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaGrantPhone_TypeDefinitionIndex = 19147;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaGrantPhone**)Il2CppClass::FromTypeDefinitionIndex(OverseaGrantPhone_TypeDefinitionIndex)->GetStaticField(0xA860);
		}
