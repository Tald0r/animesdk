...
#define MIHOYO_SDK_WIN_GRANTBINDPHONE__COUNTDOWN_D__38_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19297D50)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE__COUNTDOWN_D__38_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19297F20)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE__COUNTDOWN_D__38_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19297F80)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE__COUNTDOWN_D__38_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19297F30)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE__COUNTDOWN_D__38_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19297D40)
#define MIHOYO_SDK_WIN_GRANTBINDPHONE__COUNTDOWN_D__38__CTOR_OFFSET UNITYSDK_OFFSET(0x19297D30)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int GrantBindPhone__CountDown_d__38_TypeDefinitionIndex = 19132;
