...
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_AWAKE_OFFSET UNITYSDK_OFFSET(0x189A3960)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_BIND_OFFSET UNITYSDK_OFFSET(0x189A49B0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_CLOSE_OFFSET UNITYSDK_OFFSET(0x189A4820)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x189A4930)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_HIDE_OFFSET UNITYSDK_OFFSET(0x189A47B0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x189A4CF0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x189A4C70)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x189A4990)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_SHOW_OFFSET UNITYSDK_OFFSET(0x189A46D0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x189A4840)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x189A44A0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x189A49A0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND__AWAKE_B__25_0_OFFSET UNITYSDK_OFFSET(0x189A4DB0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND__CTOR_OFFSET UNITYSDK_OFFSET(0x189A4D30)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int SafeMobileBind_TypeDefinitionIndex = 19736;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::SafeMobileBind**)Il2CppClass::FromTypeDefinitionIndex(SafeMobileBind_TypeDefinitionIndex)->GetStaticField(0xB040);
		}
