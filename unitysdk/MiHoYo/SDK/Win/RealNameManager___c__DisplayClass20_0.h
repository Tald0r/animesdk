...
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS20_0__CTOR_OFFSET UNITYSDK_OFFSET(0x188A5520)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS20_0__SHOWSECONDREALNAMEPLUGINUI_B__0_OFFSET UNITYSDK_OFFSET(0x188A5530)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS20_0__SHOWSECONDREALNAMEPLUGINUI_B__1_OFFSET UNITYSDK_OFFSET(0x188A5560)
#define MIHOYO_SDK_WIN_REALNAMEMANAGER___C__DISPLAYCLASS20_0__SHOWSECONDREALNAMEPLUGINUI_B__2_OFFSET UNITYSDK_OFFSET(0x188A5580)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int RealNameManager___c__DisplayClass20_0_TypeDefinitionIndex = 18978;
