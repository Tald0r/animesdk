...
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1829EA30)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_BACK_OFFSET UNITYSDK_OFFSET(0x1829FFA0)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1829FF80)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x182A0040)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_HIDE_OFFSET UNITYSDK_OFFSET(0x1829FF10)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x182A0290)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x182A0260)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x182A00A0)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_SHOW_OFFSET UNITYSDK_OFFSET(0x1829FE30)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x1829FFC0)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_START_OFFSET UNITYSDK_OFFSET(0x1829FC60)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_SUBMIT_OFFSET UNITYSDK_OFFSET(0x182A00C0)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x1829FB20)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x182A00B0)
#define MIHOYO_SDK_WIN_OVERSEAVERIFYPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x182A02D0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaVerifyPhone_TypeDefinitionIndex = 19133;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::OverseaVerifyPhone**)Il2CppClass::FromTypeDefinitionIndex(OverseaVerifyPhone_TypeDefinitionIndex)->GetStaticField(0x9A60);
		}
