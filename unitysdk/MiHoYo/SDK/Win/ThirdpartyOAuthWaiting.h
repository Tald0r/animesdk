...
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_AWAKE_OFFSET UNITYSDK_OFFSET(0x17AFF1D0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_HIDE_OFFSET UNITYSDK_OFFSET(0x17B003B0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17B00290)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_SHOWFAILEDSTAGE_OFFSET UNITYSDK_OFFSET(0x17B00860)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_SHOWTIMEOUTSTAGE_OFFSET UNITYSDK_OFFSET(0x17B00420)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_SHOWWAITINGSTAGE_OFFSET UNITYSDK_OFFSET(0x17AFFCA0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING_SHOW_OFFSET UNITYSDK_OFFSET(0x17B002D0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__CTOR_OFFSET UNITYSDK_OFFSET(0x17B00CA0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWFAILEDSTAGE_B__29_0_OFFSET UNITYSDK_OFFSET(0x17B00DA0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWFAILEDSTAGE_B__29_1_OFFSET UNITYSDK_OFFSET(0x17B00DC0)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWTIMEOUTSTAGE_B__28_0_OFFSET UNITYSDK_OFFSET(0x17B00D60)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWTIMEOUTSTAGE_B__28_1_OFFSET UNITYSDK_OFFSET(0x17B00D80)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWWAITINGSTAGE_B__27_0_OFFSET UNITYSDK_OFFSET(0x17B00D20)
#define MIHOYO_SDK_WIN_THIRDPARTYOAUTHWAITING__SHOWWAITINGSTAGE_B__27_1_OFFSET UNITYSDK_OFFSET(0x17B00D40)
...
namespace MiHoYo::SDK::Win
{
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::ThirdpartyOAuthWaiting**)Il2CppClass::FromTypeDefinitionIndex(ThirdpartyOAuthWaiting_TypeDefinitionIndex)->GetStaticField(0x9CA0);
		}
		static ::MiHoYo::SDK::Win::OAuthType* StaticGet_AuthType()
		{
			return (::MiHoYo::SDK::Win::OAuthType*)Il2CppClass::FromTypeDefinitionIndex(ThirdpartyOAuthWaiting_TypeDefinitionIndex)->GetStaticField(0x4470);
		}
