...
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__COUNTDOWN_D__48_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18C399B0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__COUNTDOWN_D__48_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18C39BB0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__COUNTDOWN_D__48_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18C39C10)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__COUNTDOWN_D__48_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18C39BC0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__COUNTDOWN_D__48_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18C399A0)
#define MIHOYO_SDK_WIN_OVERSEAGRANTMAIL__COUNTDOWN_D__48__CTOR_OFFSET UNITYSDK_OFFSET(0x18C39990)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaGrantMail__CountDown_d__48_TypeDefinitionIndex = 19750;
