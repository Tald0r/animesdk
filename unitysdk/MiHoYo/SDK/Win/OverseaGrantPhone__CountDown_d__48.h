...
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE__COUNTDOWN_D__48_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18E5EC40)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE__COUNTDOWN_D__48_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18E5EE10)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE__COUNTDOWN_D__48_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18E5EE70)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE__COUNTDOWN_D__48_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18E5EE20)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE__COUNTDOWN_D__48_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18E5EC30)
#define MIHOYO_SDK_WIN_OVERSEAGRANTPHONE__COUNTDOWN_D__48__CTOR_OFFSET UNITYSDK_OFFSET(0x18E5EC20)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int OverseaGrantPhone__CountDown_d__48_TypeDefinitionIndex = 19747;
