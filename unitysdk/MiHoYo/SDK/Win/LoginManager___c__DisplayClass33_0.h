...
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS33_0__CTOR_OFFSET UNITYSDK_OFFSET(0x186FB780)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS33_0__SHOWPHONEMESSAGEVIEW_B__0_OFFSET UNITYSDK_OFFSET(0x186FB790)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS33_0__SHOWPHONEMESSAGEVIEW_B__1_OFFSET UNITYSDK_OFFSET(0x186FB7D0)
#define MIHOYO_SDK_WIN_LOGINMANAGER___C__DISPLAYCLASS33_0__SHOWPHONEMESSAGEVIEW_B__2_OFFSET UNITYSDK_OFFSET(0x186FB810)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginManager___c__DisplayClass33_0_TypeDefinitionIndex = 19065;
