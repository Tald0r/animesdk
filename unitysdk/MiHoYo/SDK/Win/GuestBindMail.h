...
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1879E800)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_BACK_OFFSET UNITYSDK_OFFSET(0x1879F820)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_BIND_OFFSET UNITYSDK_OFFSET(0x1879F860)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_CLOSE_OFFSET UNITYSDK_OFFSET(0x1879F840)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_FORGETPASSWORD_OFFSET UNITYSDK_OFFSET(0x1879FAC0)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_HIDE_OFFSET UNITYSDK_OFFSET(0x1879E720)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1879FB00)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_REGISTER_OFFSET UNITYSDK_OFFSET(0x1879FAE0)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_SETMAILINPUTTEXT_OFFSET UNITYSDK_OFFSET(0x1879E790)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_SHOW_OFFSET UNITYSDK_OFFSET(0x1879E5F0)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x1879F810)
#define MIHOYO_SDK_WIN_GUESTBINDMAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1879FB40)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int GuestBindMail_TypeDefinitionIndex = 19117;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::GuestBindMail**)Il2CppClass::FromTypeDefinitionIndex(GuestBindMail_TypeDefinitionIndex)->GetStaticField(0x9B00);
		}
