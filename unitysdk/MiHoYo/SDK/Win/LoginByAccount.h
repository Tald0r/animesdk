...
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_AWAKE_OFFSET UNITYSDK_OFFSET(0x17AEE020)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKBACKBUTTON_OFFSET UNITYSDK_OFFSET(0x17AF19C0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKCLOSEBUTTON_OFFSET UNITYSDK_OFFSET(0x17AF19E0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKFORGETPASSWORDBUTTON_OFFSET UNITYSDK_OFFSET(0x17AF1A20)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKLOGINBUTTON_OFFSET UNITYSDK_OFFSET(0x17AF1BE0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKPASSWORDCLEARBTN_OFFSET UNITYSDK_OFFSET(0x17AF2140)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKPASSWORDSHOWBTN_OFFSET UNITYSDK_OFFSET(0x17AF1FF0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKREGISTERBUTTON_OFFSET UNITYSDK_OFFSET(0x17AF1A00)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKSAVERECORDTOGGLE_OFFSET UNITYSDK_OFFSET(0x17AF1F30)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKTOGGLE_OFFSET UNITYSDK_OFFSET(0x17AF1B80)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKUSERAGREEMENTBUTTON_OFFSET UNITYSDK_OFFSET(0x17AF1A40)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_CLICKUSERPRIVACYBUTTON_OFFSET UNITYSDK_OFFSET(0x17AF1AE0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_DISABLEREGISTER_OFFSET UNITYSDK_OFFSET(0x17AF1360)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_HIDE_OFFSET UNITYSDK_OFFSET(0x17AF1950)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17AF2290)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_ONPASSWORDVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x17AF21B0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_SHOW_OFFSET UNITYSDK_OFFSET(0x17AF1870)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_START_OFFSET UNITYSDK_OFFSET(0x17AF1800)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_UPDATESAVERECORDTIPS_OFFSET UNITYSDK_OFFSET(0x17AF0C40)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x17AF04B0)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT_UPDATETOGGLESTATUS_OFFSET UNITYSDK_OFFSET(0x17AF1F90)
#define MIHOYO_SDK_WIN_LOGINBYACCOUNT__CTOR_OFFSET UNITYSDK_OFFSET(0x17AF2350)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int LoginByAccount_TypeDefinitionIndex = 19157;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::LoginByAccount**)Il2CppClass::FromTypeDefinitionIndex(LoginByAccount_TypeDefinitionIndex)->GetStaticField(0x95B0);
		}
