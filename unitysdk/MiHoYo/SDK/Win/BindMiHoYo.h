...
#define MIHOYO_SDK_WIN_BINDMIHOYO_AWAKE_OFFSET UNITYSDK_OFFSET(0x186F97B0)
#define MIHOYO_SDK_WIN_BINDMIHOYO_BACK_OFFSET UNITYSDK_OFFSET(0x186FAA00)
#define MIHOYO_SDK_WIN_BINDMIHOYO_BIND_OFFSET UNITYSDK_OFFSET(0x186FAB90)
#define MIHOYO_SDK_WIN_BINDMIHOYO_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x186FAB20)
#define MIHOYO_SDK_WIN_BINDMIHOYO_HIDE_OFFSET UNITYSDK_OFFSET(0x186F9740)
#define MIHOYO_SDK_WIN_BINDMIHOYO_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x186FADB0)
#define MIHOYO_SDK_WIN_BINDMIHOYO_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x186FAD00)
#define MIHOYO_SDK_WIN_BINDMIHOYO_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x186FAA20)
#define MIHOYO_SDK_WIN_BINDMIHOYO_SHOW_OFFSET UNITYSDK_OFFSET(0x186F9610)
#define MIHOYO_SDK_WIN_BINDMIHOYO_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x186FAA30)
#define MIHOYO_SDK_WIN_BINDMIHOYO_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x186FA7C0)
#define MIHOYO_SDK_WIN_BINDMIHOYO_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x186FA520)
#define MIHOYO_SDK_WIN_BINDMIHOYO_VALUECHANGEPHONEINPUT_OFFSET UNITYSDK_OFFSET(0x186FAB80)
#define MIHOYO_SDK_WIN_BINDMIHOYO__AWAKE_B__31_0_OFFSET UNITYSDK_OFFSET(0x186FAE70)
#define MIHOYO_SDK_WIN_BINDMIHOYO__CTOR_OFFSET UNITYSDK_OFFSET(0x186FADF0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int BindMiHoYo_TypeDefinitionIndex = 19122;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::Win::BindMiHoYo**)Il2CppClass::FromTypeDefinitionIndex(BindMiHoYo_TypeDefinitionIndex)->GetStaticField(0x9A80);
		}
