...
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND__COUNTDOWN_D__34_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18A3BDC0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND__COUNTDOWN_D__34_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18A3BF90)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND__COUNTDOWN_D__34_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18A3BFF0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND__COUNTDOWN_D__34_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18A3BFA0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND__COUNTDOWN_D__34_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18A3BDB0)
#define MIHOYO_SDK_WIN_SAFEMOBILEBIND__COUNTDOWN_D__34__CTOR_OFFSET UNITYSDK_OFFSET(0x18A3BDA0)

namespace MiHoYo::SDK::Win
{
	inline static constexpr unsigned int SafeMobileBind__CountDown_d__34_TypeDefinitionIndex = 19140;
