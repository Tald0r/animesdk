...
#define MIHOYO_SDK_MIHOYOSDKSERVER_ONCONNECTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19AF4420)
#define MIHOYO_SDK_MIHOYOSDKSERVER_ONCONNECTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19AF4480)
#define MIHOYO_SDK_MIHOYOSDKSERVER_ONCONNECTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19AF40E0)
#define MIHOYO_SDK_MIHOYOSDKSERVER_ONCONNECTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF40D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int MiHoYoSDKServer_OnConnectDelegate_TypeDefinitionIndex = 33629;
