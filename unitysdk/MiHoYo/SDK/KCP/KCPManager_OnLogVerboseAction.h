...
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGVERBOSEACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D55C20)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGVERBOSEACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D55C50)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGVERBOSEACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D55720)
#define MIHOYO_SDK_KCP_KCPMANAGER_ONLOGVERBOSEACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18D55700)

namespace MiHoYo::SDK::KCP
{
	inline static constexpr unsigned int KCPManager_OnLogVerboseAction_TypeDefinitionIndex = 34923;
