...
#define MIHOYO_SDK_CONSOLEDELEGATE_GETPSSTOREPRODUCTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x180D12A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETPSSTOREPRODUCTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x180D12E0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETPSSTOREPRODUCTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x180D0D20)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETPSSTOREPRODUCTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x180D0D10)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_GetPsStoreProductsDelegate_TypeDefinitionIndex = 17679;
