...
#define MIHOYO_SDK_PAYMENTCNBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18A1B660)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PaymentCNBoxConfig_TypeDefinitionIndex = 17933;
