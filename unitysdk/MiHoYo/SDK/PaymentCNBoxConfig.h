...
#define MIHOYO_SDK_PAYMENTCNBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18E46F20)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PaymentCNBoxConfig_TypeDefinitionIndex = 18443;
