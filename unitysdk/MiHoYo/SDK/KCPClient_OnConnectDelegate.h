...
#define MIHOYO_SDK_KCPCLIENT_ONCONNECTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x199C93C0)
#define MIHOYO_SDK_KCPCLIENT_ONCONNECTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x199C9420)
#define MIHOYO_SDK_KCPCLIENT_ONCONNECTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x199C8E60)
#define MIHOYO_SDK_KCPCLIENT_ONCONNECTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x199C8E40)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KCPClient_OnConnectDelegate_TypeDefinitionIndex = 34414;
