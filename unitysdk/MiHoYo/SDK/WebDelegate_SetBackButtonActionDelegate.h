...
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONACTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x187965F0)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONACTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18796630)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONACTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18796070)
#define MIHOYO_SDK_WEBDELEGATE_SETBACKBUTTONACTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18796060)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetBackButtonActionDelegate_TypeDefinitionIndex = 17853;
