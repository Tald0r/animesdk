...
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEBEFOREHIDE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18C987C0)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEBEFOREHIDE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18C987F0)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEBEFOREHIDE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18C982C0)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEBEFOREHIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C982A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Web_OnWebViewPageBeforeHide_TypeDefinitionIndex = 18739;
