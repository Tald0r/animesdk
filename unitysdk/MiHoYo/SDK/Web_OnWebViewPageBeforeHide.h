...
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEBEFOREHIDE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18BAFF70)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEBEFOREHIDE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18BAFFA0)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEBEFOREHIDE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18BAFA70)
#define MIHOYO_SDK_WEB_ONWEBVIEWPAGEBEFOREHIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BAFA60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int Web_OnWebViewPageBeforeHide_TypeDefinitionIndex = 18231;
