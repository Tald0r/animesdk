...
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATESTATISTICSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17ABE410)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATESTATISTICSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17ABE440)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATESTATISTICSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17ABDF10)
#define MIHOYO_SDK_CONSOLEDELEGATE_UPDATESTATISTICSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17ABDF00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_UpdateStatisticsDelegate_TypeDefinitionIndex = 17704;
