...
#define MIHOYO_SDK_WEBDELEGATE_SETWEBFEATUREDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18AAF4C0)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBFEATUREDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18AAF540)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBFEATUREDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18AAEA10)
#define MIHOYO_SDK_WEBDELEGATE_SETWEBFEATUREDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18AAF4A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetWebFeatureDelegate_TypeDefinitionIndex = 18383;
