...
#define MIHOYO_SDK_INPUTSYSTEMDELEGATE_DELEGATEGETKEYEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18788350)
#define MIHOYO_SDK_INPUTSYSTEMDELEGATE_DELEGATEGETKEYEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187883C0)
#define MIHOYO_SDK_INPUTSYSTEMDELEGATE_DELEGATEGETKEYEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x18788040)
#define MIHOYO_SDK_INPUTSYSTEMDELEGATE_DELEGATEGETKEYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18788030)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int InputSystemDelegate_DelegateGetKeyEvent_TypeDefinitionIndex = 17593;
