...
#define MIHOYO_SDK_WEBDELEGATE_SHOWDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x186F72A0)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x186F72D0)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x186F6DA0)
#define MIHOYO_SDK_WEBDELEGATE_SHOWDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x186F6D90)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_ShowDelegate_TypeDefinitionIndex = 17845;
