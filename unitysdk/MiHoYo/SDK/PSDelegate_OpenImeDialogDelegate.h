...
#define MIHOYO_SDK_PSDELEGATE_OPENIMEDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184526C0)
#define MIHOYO_SDK_PSDELEGATE_OPENIMEDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18452700)
#define MIHOYO_SDK_PSDELEGATE_OPENIMEDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x184520A0)
#define MIHOYO_SDK_PSDELEGATE_OPENIMEDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18452090)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_OpenImeDialogDelegate_TypeDefinitionIndex = 17761;
