...
#define MIHOYO_SDK_PSDELEGATE_OPENIMEDIALOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18943CC0)
#define MIHOYO_SDK_PSDELEGATE_OPENIMEDIALOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18943D00)
#define MIHOYO_SDK_PSDELEGATE_OPENIMEDIALOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18943690)
#define MIHOYO_SDK_PSDELEGATE_OPENIMEDIALOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18943670)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_OpenImeDialogDelegate_TypeDefinitionIndex = 18268;
