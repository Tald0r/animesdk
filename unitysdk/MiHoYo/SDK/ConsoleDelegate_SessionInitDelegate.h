...
#define MIHOYO_SDK_CONSOLEDELEGATE_SESSIONINITDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1868CBF0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SESSIONINITDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1868CC20)
#define MIHOYO_SDK_CONSOLEDELEGATE_SESSIONINITDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1868C950)
#define MIHOYO_SDK_CONSOLEDELEGATE_SESSIONINITDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1868C930)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_SessionInitDelegate_TypeDefinitionIndex = 18158;
