...
#define MIHOYO_SDK_FATIGUEREMINDMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x17E8A9C0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int FatigueRemindModel_TypeDefinitionIndex = 17892;
