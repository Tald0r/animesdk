...
#define MIHOYO_SDK_SDKDELEGATE_LOGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18705EA0)
#define MIHOYO_SDK_SDKDELEGATE_LOGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18705ED0)
#define MIHOYO_SDK_SDKDELEGATE_LOGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x187059A0)
#define MIHOYO_SDK_SDKDELEGATE_LOGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18705980)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_LogDelegate_TypeDefinitionIndex = 18306;
