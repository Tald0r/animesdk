...
#define MIHOYO_SDK_KIBANANETBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18BCA6B0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int KibanaNetBoxConfig_TypeDefinitionIndex = 18440;
