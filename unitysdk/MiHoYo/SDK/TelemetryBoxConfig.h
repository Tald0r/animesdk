...
#define MIHOYO_SDK_TELEMETRYBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x188FCC60)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int TelemetryBoxConfig_TypeDefinitionIndex = 17934;
