...
#define MIHOYO_SDK_HTTPDNSBOXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19286620)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HttpDnsBoxConfig_TypeDefinitionIndex = 17935;
