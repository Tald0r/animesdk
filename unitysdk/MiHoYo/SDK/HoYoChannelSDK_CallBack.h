...
#define MIHOYO_SDK_HOYOCHANNELSDK_CALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C8E660)
#define MIHOYO_SDK_HOYOCHANNELSDK_CALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C8E6C0)
#define MIHOYO_SDK_HOYOCHANNELSDK_CALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C8E320)
#define MIHOYO_SDK_HOYOCHANNELSDK_CALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8E300)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int HoYoChannelSDK_CallBack_TypeDefinitionIndex = 34808;
