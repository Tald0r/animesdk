...
#define MIHOYO_SDK_PSDELEGATE_CHECKPREMIUMDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1877D760)
#define MIHOYO_SDK_PSDELEGATE_CHECKPREMIUMDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1877D790)
#define MIHOYO_SDK_PSDELEGATE_CHECKPREMIUMDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1877D4C0)
#define MIHOYO_SDK_PSDELEGATE_CHECKPREMIUMDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1877D4A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_CheckPremiumDelegate_TypeDefinitionIndex = 18292;
