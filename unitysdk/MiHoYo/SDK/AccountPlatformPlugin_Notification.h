...
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGIN_NOTIFICATION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18671520)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGIN_NOTIFICATION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18671550)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGIN_NOTIFICATION_INVOKE_OFFSET UNITYSDK_OFFSET(0x18670FE0)
#define MIHOYO_SDK_ACCOUNTPLATFORMPLUGIN_NOTIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x18670FC0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatformPlugin_Notification_TypeDefinitionIndex = 18496;
