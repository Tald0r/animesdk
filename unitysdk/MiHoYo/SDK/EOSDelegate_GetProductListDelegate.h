...
#define MIHOYO_SDK_EOSDELEGATE_GETPRODUCTLISTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B664C0)
#define MIHOYO_SDK_EOSDELEGATE_GETPRODUCTLISTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B66500)
#define MIHOYO_SDK_EOSDELEGATE_GETPRODUCTLISTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B65E90)
#define MIHOYO_SDK_EOSDELEGATE_GETPRODUCTLISTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B65E70)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_GetProductListDelegate_TypeDefinitionIndex = 18242;
