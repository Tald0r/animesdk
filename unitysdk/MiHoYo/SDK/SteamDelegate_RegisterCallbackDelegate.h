...
#define MIHOYO_SDK_STEAMDELEGATE_REGISTERCALLBACKDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x180E8D60)
#define MIHOYO_SDK_STEAMDELEGATE_REGISTERCALLBACKDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x180E8D90)
#define MIHOYO_SDK_STEAMDELEGATE_REGISTERCALLBACKDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x180E8AC0)
#define MIHOYO_SDK_STEAMDELEGATE_REGISTERCALLBACKDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x180E8AB0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SteamDelegate_RegisterCallbackDelegate_TypeDefinitionIndex = 17709;
