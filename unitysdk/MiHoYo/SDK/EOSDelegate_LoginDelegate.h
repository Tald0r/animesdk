...
#define MIHOYO_SDK_EOSDELEGATE_LOGINDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B66A30)
#define MIHOYO_SDK_EOSDELEGATE_LOGINDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B66A60)
#define MIHOYO_SDK_EOSDELEGATE_LOGINDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B66530)
#define MIHOYO_SDK_EOSDELEGATE_LOGINDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B66510)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_LoginDelegate_TypeDefinitionIndex = 18244;
