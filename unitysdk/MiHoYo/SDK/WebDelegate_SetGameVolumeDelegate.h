...
#define MIHOYO_SDK_WEBDELEGATE_SETGAMEVOLUMEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17E9D6E0)
#define MIHOYO_SDK_WEBDELEGATE_SETGAMEVOLUMEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17E9D770)
#define MIHOYO_SDK_WEBDELEGATE_SETGAMEVOLUMEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17E9D360)
#define MIHOYO_SDK_WEBDELEGATE_SETGAMEVOLUMEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17E9D350)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_SetGameVolumeDelegate_TypeDefinitionIndex = 17871;
