...
#define MIHOYO_SDK_BILIBILIDELEGATE_LOGINCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18933D20)
#define MIHOYO_SDK_BILIBILIDELEGATE_LOGINCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18933D80)
#define MIHOYO_SDK_BILIBILIDELEGATE_LOGINCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x189337C0)
#define MIHOYO_SDK_BILIBILIDELEGATE_LOGINCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x189337A0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int BiliBiliDelegate_LoginCallback_TypeDefinitionIndex = 18136;
