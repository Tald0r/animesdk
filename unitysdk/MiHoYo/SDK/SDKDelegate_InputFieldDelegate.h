...
#define MIHOYO_SDK_SDKDELEGATE_INPUTFIELDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1847E5F0)
#define MIHOYO_SDK_SDKDELEGATE_INPUTFIELDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1847E620)
#define MIHOYO_SDK_SDKDELEGATE_INPUTFIELDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1847E0F0)
#define MIHOYO_SDK_SDKDELEGATE_INPUTFIELDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1847E0D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_InputFieldDelegate_TypeDefinitionIndex = 18304;
