...
#define MIHOYO_SDK_PSDELEGATE_GETUSERIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x188A6590)
#define MIHOYO_SDK_PSDELEGATE_GETUSERIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x188A65C0)
#define MIHOYO_SDK_PSDELEGATE_GETUSERIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x188A62F0)
#define MIHOYO_SDK_PSDELEGATE_GETUSERIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x188A62D0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_GetUserIdDelegate_TypeDefinitionIndex = 18259;
