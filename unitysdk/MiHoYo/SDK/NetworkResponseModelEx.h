...
#define MIHOYO_SDK_NETWORKRESPONSEMODELEX_TOJSONOBJECT_OFFSET UNITYSDK_OFFSET(0x18207D10)
#define MIHOYO_SDK_NETWORKRESPONSEMODELEX__CTOR_OFFSET UNITYSDK_OFFSET(0x18207FE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetworkResponseModelEx_TypeDefinitionIndex = 18192;
