...
#define MIHOYO_SDK_PROTOBUF_REFLECTION_DESCRIPTORPOOL_DESCRIPTORINTPAIR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x973CD0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_DESCRIPTORPOOL_DESCRIPTORINTPAIR_EQUALS_OFFSET UNITYSDK_OFFSET(0x571430)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_DESCRIPTORPOOL_DESCRIPTORINTPAIR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x571460)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_DESCRIPTORPOOL_DESCRIPTORINTPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x30F0B0)

namespace MiHoYo::SDK::Protobuf::Reflection
{
	inline static constexpr unsigned int DescriptorPool_DescriptorIntPair_TypeDefinitionIndex = 24726;
