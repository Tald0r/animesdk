...
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1AC815D0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_CREATEACCESSOR_OFFSET UNITYSDK_OFFSET(0x1AC81A20)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_CROSSLINK_OFFSET UNITYSDK_OFFSET(0x1AC81670)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GETFIELDTYPEFROMPROTOTYPE_OFFSET UNITYSDK_OFFSET(0x1AC81490)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ACCESSOR_OFFSET UNITYSDK_OFFSET(0x1AC81540)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_CONTAININGONEOF_OFFSET UNITYSDK_OFFSET(0x1AC81140)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_CONTAININGTYPE_OFFSET UNITYSDK_OFFSET(0x1AC81130)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_FIELDNUMBER_OFFSET UNITYSDK_OFFSET(0x1AC81500)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_FIELDTYPE_OFFSET UNITYSDK_OFFSET(0x1AC815C0)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ISMAP_OFFSET UNITYSDK_OFFSET(0x1AC81570)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_ISREPEATED_OFFSET UNITYSDK_OFFSET(0x1AC81550)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x1AC81150)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AC81520)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR_GET_PROTO_OFFSET UNITYSDK_OFFSET(0x1AC81160)
#define MIHOYO_SDK_PROTOBUF_REFLECTION_FIELDDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC81170)

namespace MiHoYo::SDK::Protobuf::Reflection
{
	inline static constexpr unsigned int FieldDescriptor_TypeDefinitionIndex = 24734;
	...
	public:
		...
		::MiHoYo::SDK::Protobuf::Reflection::MessageDescriptor* messageType; // 0x38
		::MiHoYo::SDK::Protobuf::Reflection::EnumDescriptor* enumType; // 0x40
		::MiHoYo::SDK::Protobuf::Reflection::IFieldAccessor* accessor; // 0x48
