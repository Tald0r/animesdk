...
#define MIHOYO_SDK_PS_SDKUIDIALOG_FIREBUTTON_OFFSET UNITYSDK_OFFSET(0x1888CE70)
#define MIHOYO_SDK_PS_SDKUIDIALOG_FIREINPUTFIELD_OFFSET UNITYSDK_OFFSET(0x1888CFD0)
#define MIHOYO_SDK_PS_SDKUIDIALOG_FIRESLIDER_OFFSET UNITYSDK_OFFSET(0x1888D2B0)
#define MIHOYO_SDK_PS_SDKUIDIALOG_FIRETOGGLE_OFFSET UNITYSDK_OFFSET(0x1888D120)
#define MIHOYO_SDK_PS_SDKUIDIALOG_FIRE_OFFSET UNITYSDK_OFFSET(0x1888CC90)
#define MIHOYO_SDK_PS_SDKUIDIALOG_GET_HIGHLIGHTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1888BD00)
#define MIHOYO_SDK_PS_SDKUIDIALOG_GET_ISFOCUSED_OFFSET UNITYSDK_OFFSET(0x1888C960)
#define MIHOYO_SDK_PS_SDKUIDIALOG_ONIMEDIALOGCLOSECALLBACK_OFFSET UNITYSDK_OFFSET(0x1888D590)
#define MIHOYO_SDK_PS_SDKUIDIALOG_ONIMEDIALOGCOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x1888D770)
#define MIHOYO_SDK_PS_SDKUIDIALOG_OPENIME_OFFSET UNITYSDK_OFFSET(0x1888D3E0)
#define MIHOYO_SDK_PS_SDKUIDIALOG_SETHIGHLIGHTOBJECT_OFFSET UNITYSDK_OFFSET(0x1888BD20)
#define MIHOYO_SDK_PS_SDKUIDIALOG_SET_HIGHLIGHTEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1888BD10)
#define MIHOYO_SDK_PS_SDKUIDIALOG_SET_ISFOCUSED_OFFSET UNITYSDK_OFFSET(0x1888C970)
#define MIHOYO_SDK_PS_SDKUIDIALOG_UPDATEINPUTFIELD_OFFSET UNITYSDK_OFFSET(0x1888CA30)
#define MIHOYO_SDK_PS_SDKUIDIALOG_UPDATESLIDER_OFFSET UNITYSDK_OFFSET(0x1888CAD0)
#define MIHOYO_SDK_PS_SDKUIDIALOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x1888C980)
#define MIHOYO_SDK_PS_SDKUIDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1888DA20)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int SDKUIDialog_TypeDefinitionIndex = 18563;
