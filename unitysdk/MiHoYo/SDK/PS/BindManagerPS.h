...
#define MIHOYO_SDK_PS_BINDMANAGERPS_CANCELBINDING_OFFSET UNITYSDK_OFFSET(0x18CE3BF0)
#define MIHOYO_SDK_PS_BINDMANAGERPS_ENVCHANGED_OFFSET UNITYSDK_OFFSET(0x18CE3930)
#define MIHOYO_SDK_PS_BINDMANAGERPS_EXTRACTFIRSTNONPSTHIRDPARTYNAME_OFFSET UNITYSDK_OFFSET(0x18CE4590)
#define MIHOYO_SDK_PS_BINDMANAGERPS_EXTRACTSNOYACCOUNTNAME_OFFSET UNITYSDK_OFFSET(0x18CE4900)
#define MIHOYO_SDK_PS_BINDMANAGERPS_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18CE3760)
#define MIHOYO_SDK_PS_BINDMANAGERPS_LOGREPORT_OFFSET UNITYSDK_OFFSET(0x18CE4190)
#define MIHOYO_SDK_PS_BINDMANAGERPS_SHOWBINDINGDIALOG_OFFSET UNITYSDK_OFFSET(0x18CE39D0)
#define MIHOYO_SDK_PS_BINDMANAGERPS_SHOWBINDSUCCESSDIALOG_OFFSET UNITYSDK_OFFSET(0x18CE4000)
#define MIHOYO_SDK_PS_BINDMANAGERPS_SHOWREACTIVATEDIALOG_OFFSET UNITYSDK_OFFSET(0x18CE4450)
#define MIHOYO_SDK_PS_BINDMANAGERPS_STARTACCOUNTBINDING_OFFSET UNITYSDK_OFFSET(0x18CE39C0)
#define MIHOYO_SDK_PS_BINDMANAGERPS_STARTWEBBINDINGRESULTQUERYLOOP_OFFSET UNITYSDK_OFFSET(0x18CE3E20)
#define MIHOYO_SDK_PS_BINDMANAGERPS_STOPWEBBINDINGRESULTQUERYLOOP_OFFSET UNITYSDK_OFFSET(0x18CE3D50)
#define MIHOYO_SDK_PS_BINDMANAGERPS_UPDATEACCESSTOKEN_OFFSET UNITYSDK_OFFSET(0x18CE4C10)
#define MIHOYO_SDK_PS_BINDMANAGERPS__CTOR_OFFSET UNITYSDK_OFFSET(0x18CE4D20)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWBINDINGDIALOG_B__18_0_OFFSET UNITYSDK_OFFSET(0x18CE4D30)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWBINDINGDIALOG_B__18_1_OFFSET UNITYSDK_OFFSET(0x18CE4DF0)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWBINDINGDIALOG_B__18_2_OFFSET UNITYSDK_OFFSET(0x18CE4EA0)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWBINDINGDIALOG_B__18_3_OFFSET UNITYSDK_OFFSET(0x18CE4F60)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWBINDSUCCESSDIALOG_B__19_0_OFFSET UNITYSDK_OFFSET(0x18CE5000)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWREACTIVATEDIALOG_B__20_0_OFFSET UNITYSDK_OFFSET(0x18CE5140)
#define MIHOYO_SDK_PS_BINDMANAGERPS__SHOWREACTIVATEDIALOG_B__20_1_OFFSET UNITYSDK_OFFSET(0x18CE51F0)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int BindManagerPS_TypeDefinitionIndex = 19127;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PS::BindManagerPS**)Il2CppClass::FromTypeDefinitionIndex(BindManagerPS_TypeDefinitionIndex)->GetStaticField(0xB100);
		}
