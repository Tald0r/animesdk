...
#define MIHOYO_SDK_PS_SDKUIRECT_CONTAINS_OFFSET UNITYSDK_OFFSET(0x823130)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_BOTTOM_OFFSET UNITYSDK_OFFSET(0x823090)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x8230E0)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x2F60A0)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_MIDX_OFFSET UNITYSDK_OFFSET(0x8230A0)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_MIDY_OFFSET UNITYSDK_OFFSET(0x8230C0)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x42FB10)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_TOP_OFFSET UNITYSDK_OFFSET(0x2F60C0)
#define MIHOYO_SDK_PS_SDKUIRECT_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x18E458A0)
#define MIHOYO_SDK_PS_SDKUIRECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x870B30)
#define MIHOYO_SDK_PS_SDKUIRECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x870B20)
#define MIHOYO_SDK_PS_SDKUIRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x42F920)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int SDKUIRect_TypeDefinitionIndex = 19163;
