...
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x1888A6F0)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_BINDEXISTINGACCOUNT_OFFSET UNITYSDK_OFFSET(0x1888B850)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_CANCELDIALOG_OFFSET UNITYSDK_OFFSET(0x1888B880)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_CONFIRMDIALOG_OFFSET UNITYSDK_OFFSET(0x1888B8A0)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_CREATEANDBINDNEWACCOUNT_OFFSET UNITYSDK_OFFSET(0x1888B870)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_HIDE_OFFSET UNITYSDK_OFFSET(0x1888A680)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1888B460)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1888B430)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_SHOWBINDMODESELECTION_OFFSET UNITYSDK_OFFSET(0x1888B190)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_SHOWNEWACCOUNTPROMPT_OFFSET UNITYSDK_OFFSET(0x1888B4A0)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG_SHOW_OFFSET UNITYSDK_OFFSET(0x1888A550)
#define MIHOYO_SDK_PS_PSWELCOMEDIALOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1888B8C0)

namespace MiHoYo::SDK::PS
{
	inline static constexpr unsigned int PSWelcomeDialog_TypeDefinitionIndex = 18577;
	...
	public:
		...
		{
			return (::MiHoYo::SDK::PS::PSWelcomeDialog**)Il2CppClass::FromTypeDefinitionIndex(PSWelcomeDialog_TypeDefinitionIndex)->GetStaticField(0xA100);
		}
