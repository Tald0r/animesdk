...
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17AE0690)
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17AE06C0)
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17AE03F0)
#define MIHOYO_SDK_SDKDELEGATE_GETDEVICEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17AE03E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetDeviceDelegate_TypeDefinitionIndex = 17792;
