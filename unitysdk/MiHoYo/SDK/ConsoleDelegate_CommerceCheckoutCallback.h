...
#define MIHOYO_SDK_CONSOLEDELEGATE_COMMERCECHECKOUTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18891070)
#define MIHOYO_SDK_CONSOLEDELEGATE_COMMERCECHECKOUTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18891100)
#define MIHOYO_SDK_CONSOLEDELEGATE_COMMERCECHECKOUTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18890D20)
#define MIHOYO_SDK_CONSOLEDELEGATE_COMMERCECHECKOUTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18890D00)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_CommerceCheckoutCallback_TypeDefinitionIndex = 18180;
