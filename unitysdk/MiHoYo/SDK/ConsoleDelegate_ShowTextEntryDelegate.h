...
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWTEXTENTRYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CDB760)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWTEXTENTRYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CDB7A0)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWTEXTENTRYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CDB130)
#define MIHOYO_SDK_CONSOLEDELEGATE_SHOWTEXTENTRYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDB110)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_ShowTextEntryDelegate_TypeDefinitionIndex = 18184;
