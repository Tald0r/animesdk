...
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEFINISH_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x186F65F0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEFINISH_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x186F6620)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEFINISH_INVOKE_OFFSET UNITYSDK_OFFSET(0x186F60F0)
#define MIHOYO_SDK_WEBDELEGATE_ONWEBVIEWPAGEFINISH__CTOR_OFFSET UNITYSDK_OFFSET(0x186F60E0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_OnWebViewPageFinish_TypeDefinitionIndex = 17838;
