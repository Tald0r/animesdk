...
#define MIHOYO_SDK_CONSOLEDELEGATE_STOREISEMPTYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18B9F240)
#define MIHOYO_SDK_CONSOLEDELEGATE_STOREISEMPTYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18B9F2B0)
#define MIHOYO_SDK_CONSOLEDELEGATE_STOREISEMPTYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18B9EF00)
#define MIHOYO_SDK_CONSOLEDELEGATE_STOREISEMPTYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18B9EEF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_StoreIsEmptyCallback_TypeDefinitionIndex = 17648;
