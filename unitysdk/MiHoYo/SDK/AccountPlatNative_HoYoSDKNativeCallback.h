...
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNATIVECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190CA8C0)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNATIVECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190CA920)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNATIVECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x190CA580)
#define MIHOYO_SDK_ACCOUNTPLATNATIVE_HOYOSDKNATIVECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x190CA570)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AccountPlatNative_HoYoSDKNativeCallback_TypeDefinitionIndex = 33421;
