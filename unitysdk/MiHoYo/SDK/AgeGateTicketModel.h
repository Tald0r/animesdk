...
#define MIHOYO_SDK_AGEGATETICKETMODEL_AGEGATEFLOWTYPETOSTRING_OFFSET UNITYSDK_OFFSET(0x18671740)
#define MIHOYO_SDK_AGEGATETICKETMODEL_EXPIRETIMETOTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x18671790)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_BIRTHDAY_OFFSET UNITYSDK_OFFSET(0x18671600)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x18671640)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_COUNTRY_OFFSET UNITYSDK_OFFSET(0x186715A0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_EXPIRETIME_OFFSET UNITYSDK_OFFSET(0x18671620)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_PARENTEMAIL_OFFSET UNITYSDK_OFFSET(0x186715C0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x18671660)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_TICKETID_OFFSET UNITYSDK_OFFSET(0x18671580)
#define MIHOYO_SDK_AGEGATETICKETMODEL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x186715E0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_BIRTHDAY_OFFSET UNITYSDK_OFFSET(0x18671610)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x18671650)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_COUNTRY_OFFSET UNITYSDK_OFFSET(0x186715B0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_EXPIRETIME_OFFSET UNITYSDK_OFFSET(0x18671630)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_PARENTEMAIL_OFFSET UNITYSDK_OFFSET(0x186715D0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x18671670)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_TICKETID_OFFSET UNITYSDK_OFFSET(0x18671590)
#define MIHOYO_SDK_AGEGATETICKETMODEL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x186715F0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_TOLOGSTRING_OFFSET UNITYSDK_OFFSET(0x18671B20)
#define MIHOYO_SDK_AGEGATETICKETMODEL_TOSTRING_OFFSET UNITYSDK_OFFSET(0x186717A0)
#define MIHOYO_SDK_AGEGATETICKETMODEL_USERTICKETSTATUSTOSTRING_OFFSET UNITYSDK_OFFSET(0x186716F0)
#define MIHOYO_SDK_AGEGATETICKETMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x18671680)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int AgeGateTicketModel_TypeDefinitionIndex = 18096;
