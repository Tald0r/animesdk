...
#define MIHOYO_SDK_UIELEMENT_GETUIMANAGER_OFFSET UNITYSDK_OFFSET(0x1895BB80)
#define MIHOYO_SDK_UIELEMENT_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x1895BB60)
#define MIHOYO_SDK_UIELEMENT_GET_PREFABNAME_OFFSET UNITYSDK_OFFSET(0x1895BB40)
#define MIHOYO_SDK_UIELEMENT_ISINGLOBALUISTACKTOP_OFFSET UNITYSDK_OFFSET(0x1895C080)
#define MIHOYO_SDK_UIELEMENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1895C110)
#define MIHOYO_SDK_UIELEMENT_SET_MANAGER_OFFSET UNITYSDK_OFFSET(0x1895BB70)
#define MIHOYO_SDK_UIELEMENT_SET_PREFABNAME_OFFSET UNITYSDK_OFFSET(0x1895BB50)
#define MIHOYO_SDK_UIELEMENT_TABACTIVE_OFFSET UNITYSDK_OFFSET(0x1895A250)
#define MIHOYO_SDK_UIELEMENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1895BB90)
#define MIHOYO_SDK_UIELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18942FE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int UIElement_TypeDefinitionIndex = 18237;
