...
#define MIHOYO_SDK_LANGUAGEMANAGER__REQUESTLANGUAGE_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1844C620)
#define MIHOYO_SDK_LANGUAGEMANAGER__REQUESTLANGUAGE_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1844C790)
#define MIHOYO_SDK_LANGUAGEMANAGER__REQUESTLANGUAGE_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1844C7F0)
#define MIHOYO_SDK_LANGUAGEMANAGER__REQUESTLANGUAGE_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1844C7A0)
#define MIHOYO_SDK_LANGUAGEMANAGER__REQUESTLANGUAGE_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1844C610)
#define MIHOYO_SDK_LANGUAGEMANAGER__REQUESTLANGUAGE_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0x1844C600)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int LanguageManager__RequestLanguage_d__24_TypeDefinitionIndex = 18090;
