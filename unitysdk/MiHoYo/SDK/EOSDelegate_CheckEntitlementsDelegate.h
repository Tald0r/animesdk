...
#define MIHOYO_SDK_EOSDELEGATE_CHECKENTITLEMENTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18A15E50)
#define MIHOYO_SDK_EOSDELEGATE_CHECKENTITLEMENTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18A15E80)
#define MIHOYO_SDK_EOSDELEGATE_CHECKENTITLEMENTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18A15950)
#define MIHOYO_SDK_EOSDELEGATE_CHECKENTITLEMENTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A15940)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int EOSDelegate_CheckEntitlementsDelegate_TypeDefinitionIndex = 17739;
