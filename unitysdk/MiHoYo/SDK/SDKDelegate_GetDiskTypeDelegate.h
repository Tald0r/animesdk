...
#define MIHOYO_SDK_SDKDELEGATE_GETDISKTYPEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18763E80)
#define MIHOYO_SDK_SDKDELEGATE_GETDISKTYPEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18763EB0)
#define MIHOYO_SDK_SDKDELEGATE_GETDISKTYPEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18763940)
#define MIHOYO_SDK_SDKDELEGATE_GETDISKTYPEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18763930)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int SDKDelegate_GetDiskTypeDelegate_TypeDefinitionIndex = 17824;
