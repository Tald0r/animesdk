...
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17E9DA30)
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17E9DA60)
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17E9D790)
#define MIHOYO_SDK_WEBDELEGATE_UPDATEJOYPADCONTROLDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17E9D780)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int WebDelegate_UpdateJoypadControlDelegate_TypeDefinitionIndex = 17873;
