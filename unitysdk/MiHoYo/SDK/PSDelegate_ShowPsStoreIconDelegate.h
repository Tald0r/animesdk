...
#define MIHOYO_SDK_PSDELEGATE_SHOWPSSTOREICONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17ACAEA0)
#define MIHOYO_SDK_PSDELEGATE_SHOWPSSTOREICONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17ACAED0)
#define MIHOYO_SDK_PSDELEGATE_SHOWPSSTOREICONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17ACA9A0)
#define MIHOYO_SDK_PSDELEGATE_SHOWPSSTOREICONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17ACA990)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int PSDelegate_ShowPsStoreIconDelegate_TypeDefinitionIndex = 17762;
