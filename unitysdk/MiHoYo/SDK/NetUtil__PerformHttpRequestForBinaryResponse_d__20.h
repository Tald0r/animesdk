...
#define MIHOYO_SDK_NETUTIL__PERFORMHTTPREQUESTFORBINARYRESPONSE_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18777000)
#define MIHOYO_SDK_NETUTIL__PERFORMHTTPREQUESTFORBINARYRESPONSE_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18777DA0)
#define MIHOYO_SDK_NETUTIL__PERFORMHTTPREQUESTFORBINARYRESPONSE_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18777E00)
#define MIHOYO_SDK_NETUTIL__PERFORMHTTPREQUESTFORBINARYRESPONSE_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18777DB0)
#define MIHOYO_SDK_NETUTIL__PERFORMHTTPREQUESTFORBINARYRESPONSE_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18776FF0)
#define MIHOYO_SDK_NETUTIL__PERFORMHTTPREQUESTFORBINARYRESPONSE_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0x18776FE0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int NetUtil__PerformHttpRequestForBinaryResponse_d__20_TypeDefinitionIndex = 18718;
