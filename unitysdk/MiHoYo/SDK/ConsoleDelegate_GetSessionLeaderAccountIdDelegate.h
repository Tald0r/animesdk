...
#define MIHOYO_SDK_CONSOLEDELEGATE_GETSESSIONLEADERACCOUNTIDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18CDB0B0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETSESSIONLEADERACCOUNTIDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18CDB0E0)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETSESSIONLEADERACCOUNTIDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x18CDAE10)
#define MIHOYO_SDK_CONSOLEDELEGATE_GETSESSIONLEADERACCOUNTIDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18CDADF0)

namespace MiHoYo::SDK
{
	inline static constexpr unsigned int ConsoleDelegate_GetSessionLeaderAccountIdDelegate_TypeDefinitionIndex = 18186;
