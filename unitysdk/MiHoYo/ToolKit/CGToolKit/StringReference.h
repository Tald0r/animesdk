...
#define MIHOYO_TOOLKIT_CGTOOLKIT_STRINGREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x6D31B10)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int StringReference_TypeDefinitionIndex = 39687;
