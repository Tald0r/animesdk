...
#define MIHOYO_TOOLKIT_CGTOOLKIT_INTREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xBAD3440)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int IntReference_TypeDefinitionIndex = 52350;
