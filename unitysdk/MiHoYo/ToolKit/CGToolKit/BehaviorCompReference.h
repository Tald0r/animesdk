...
#define MIHOYO_TOOLKIT_CGTOOLKIT_BEHAVIORCOMPREFERENCE_GETRENDERCOMPREFERENCES_OFFSET UNITYSDK_OFFSET(0x6D31090)
#define MIHOYO_TOOLKIT_CGTOOLKIT_BEHAVIORCOMPREFERENCE_SETCOMPREFERENCE_OFFSET UNITYSDK_OFFSET(0x6D31490)
#define MIHOYO_TOOLKIT_CGTOOLKIT_BEHAVIORCOMPREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x6D30FF0)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int BehaviorCompReference_TypeDefinitionIndex = 66463;
