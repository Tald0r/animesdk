...
#define MIHOYO_TOOLKIT_CGTOOLKIT_BEHAVIORCOMPREFERENCE_GETRENDERCOMPREFERENCES_OFFSET UNITYSDK_OFFSET(0xBAD2C60)
#define MIHOYO_TOOLKIT_CGTOOLKIT_BEHAVIORCOMPREFERENCE_SETCOMPREFERENCE_OFFSET UNITYSDK_OFFSET(0xBAD3060)
#define MIHOYO_TOOLKIT_CGTOOLKIT_BEHAVIORCOMPREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xBAD2BC0)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int BehaviorCompReference_TypeDefinitionIndex = 71701;
