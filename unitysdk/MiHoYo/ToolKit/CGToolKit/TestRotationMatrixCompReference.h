...
#define MIHOYO_TOOLKIT_CGTOOLKIT_TESTROTATIONMATRIXCOMPREFERENCE_GETRENDERCOMPREFERENCES_OFFSET UNITYSDK_OFFSET(0x6FA23B0)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TESTROTATIONMATRIXCOMPREFERENCE_SETCOMPREFERENCE_OFFSET UNITYSDK_OFFSET(0x6FA25E0)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TESTROTATIONMATRIXCOMPREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x6FA23A0)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int TestRotationMatrixCompReference_TypeDefinitionIndex = 45325;
