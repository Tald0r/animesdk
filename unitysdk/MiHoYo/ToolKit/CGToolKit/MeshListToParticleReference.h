...
#define MIHOYO_TOOLKIT_CGTOOLKIT_MESHLISTTOPARTICLEREFERENCE_RECOVERREFERENCE_OFFSET UNITYSDK_OFFSET(0x6D31920)
#define MIHOYO_TOOLKIT_CGTOOLKIT_MESHLISTTOPARTICLEREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x6D31880)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int MeshListToParticleReference_TypeDefinitionIndex = 38992;
