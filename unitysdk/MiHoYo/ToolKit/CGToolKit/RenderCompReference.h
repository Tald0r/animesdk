...
#define MIHOYO_TOOLKIT_CGTOOLKIT_RENDERCOMPREFERENCE_GETRENDERCOMPREFERENCES_OFFSET UNITYSDK_OFFSET(0xB8E3D30)
#define MIHOYO_TOOLKIT_CGTOOLKIT_RENDERCOMPREFERENCE_SETMATERIALREFERENCE_OFFSET UNITYSDK_OFFSET(0xB8E4140)
#define MIHOYO_TOOLKIT_CGTOOLKIT_RENDERCOMPREFERENCE_SETRENDERCOMPREFERENCE_OFFSET UNITYSDK_OFFSET(0xB8E3D90)
#define MIHOYO_TOOLKIT_CGTOOLKIT_RENDERCOMPREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0xB8E3C00)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int RenderCompReference_TypeDefinitionIndex = 40035;
