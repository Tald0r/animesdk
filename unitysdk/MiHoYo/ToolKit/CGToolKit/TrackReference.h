...
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE_RECORDTRACKREFERENCE_OFFSET UNITYSDK_OFFSET(0x81C9B30)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE_SETTRACKREFERENCEBYTYPE_OFFSET UNITYSDK_OFFSET(0x81C9C20)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE_SETTRACKREFERENCE_OFFSET UNITYSDK_OFFSET(0x81C9D10)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x81C9A30)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int TrackReference_TypeDefinitionIndex = 63507;
