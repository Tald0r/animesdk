...
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE_RECORDTRACKREFERENCE_OFFSET UNITYSDK_OFFSET(0x6531370)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE_SETTRACKREFERENCEBYTYPE_OFFSET UNITYSDK_OFFSET(0x6531460)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE_SETTRACKREFERENCE_OFFSET UNITYSDK_OFFSET(0x6531550)
#define MIHOYO_TOOLKIT_CGTOOLKIT_TRACKREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x6531270)

namespace MiHoYo::ToolKit::CGToolKit
{
	inline static constexpr unsigned int TrackReference_TypeDefinitionIndex = 67698;
