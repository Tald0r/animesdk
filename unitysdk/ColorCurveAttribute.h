...
#define COLORCURVEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16D773F0)
#define COLORCURVEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D773B0)

inline static constexpr unsigned int ColorCurveAttribute_TypeDefinitionIndex = 28070;

class ColorCurveAttribute : public ::UnityEngine::PropertyAttribute
{
public:
	::System::String* masterPropertyName; // 0x10
	...
	::System::String* satVsSat; // 0x40
	::System::String* hueVsHue; // 0x48
