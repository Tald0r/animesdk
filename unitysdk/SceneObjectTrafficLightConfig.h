...
#define SCENEOBJECTTRAFFICLIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16C5B090)

inline static constexpr unsigned int SceneObjectTrafficLightConfig_TypeDefinitionIndex = 43530;
