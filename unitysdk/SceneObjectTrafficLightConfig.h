...
#define SCENEOBJECTTRAFFICLIGHTCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0xAEA4E50)

inline static constexpr unsigned int SceneObjectTrafficLightConfig_TypeDefinitionIndex = 60601;
