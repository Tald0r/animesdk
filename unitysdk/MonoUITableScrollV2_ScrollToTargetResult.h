...
#define MONOUITABLESCROLLV2_SCROLLTOTARGETRESULT_CREATE_OFFSET UNITYSDK_OFFSET(0xA09D1F0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETRESULT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3798A0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETRESULT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3798B0)

inline static constexpr unsigned int MonoUITableScrollV2_ScrollToTargetResult_TypeDefinitionIndex = 43830;
