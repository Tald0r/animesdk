...
#define MONOUIDAMAGETMPEFFECT_ANIMATETEXT_OFFSET UNITYSDK_OFFSET(0x93A6030)
#define MONOUIDAMAGETMPEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0x93A47B0)
#define MONOUIDAMAGETMPEFFECT_CLEARCOROUTINE_OFFSET UNITYSDK_OFFSET(0x93A4D60)
#define MONOUIDAMAGETMPEFFECT_DOUPDATEANIMATION_OFFSET UNITYSDK_OFFSET(0x93A6150)
#define MONOUIDAMAGETMPEFFECT_GETCHARACTERFADEININTERVAL_OFFSET UNITYSDK_OFFSET(0x93A5B60)
#define MONOUIDAMAGETMPEFFECT_GETCHARACTERFADEOUTINTERVAL_OFFSET UNITYSDK_OFFSET(0x93A5BD0)
#define MONOUIDAMAGETMPEFFECT_GETDAMAGETEXTLENGTH_OFFSET UNITYSDK_OFFSET(0x93A5D00)
#define MONOUIDAMAGETMPEFFECT_GETTEXTSCALE_OFFSET UNITYSDK_OFFSET(0x93A5C40)
#define MONOUIDAMAGETMPEFFECT_GETTEXTSHOWTIME_OFFSET UNITYSDK_OFFSET(0x93A5AA0)
#define MONOUIDAMAGETMPEFFECT_GET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0x93A47A0)
#define MONOUIDAMAGETMPEFFECT_GET_ISPLAYINGANIM_OFFSET UNITYSDK_OFFSET(0x93A4790)
#define MONOUIDAMAGETMPEFFECT_INITDATA_OFFSET UNITYSDK_OFFSET(0x93A4890)
#define MONOUIDAMAGETMPEFFECT_MANUALUPDATEANIMATION_OFFSET UNITYSDK_OFFSET(0x93A60D0)
#define MONOUIDAMAGETMPEFFECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x93A4C10)
#define MONOUIDAMAGETMPEFFECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x93A4E50)
#define MONOUIDAMAGETMPEFFECT_ONPAUSEGAMESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x93A4FA0)
#define MONOUIDAMAGETMPEFFECT_PLAYDAMAGEJUMPANIM_OFFSET UNITYSDK_OFFSET(0x93A5D70)
#define MONOUIDAMAGETMPEFFECT_REFRESHCOMBINEDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x93A5010)
#define MONOUIDAMAGETMPEFFECT_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x93A6F00)
#define MONOUIDAMAGETMPEFFECT_SETDAMAGETEXTCOMBINE_OFFSET UNITYSDK_OFFSET(0x93A51C0)
#define MONOUIDAMAGETMPEFFECT_SETDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x93A5450)
#define MONOUIDAMAGETMPEFFECT_SETFONTMATERIAL_OFFSET UNITYSDK_OFFSET(0x93A5350)
#define MONOUIDAMAGETMPEFFECT_UPDATETRSMATRIX_OFFSET UNITYSDK_OFFSET(0x93A6F90)
#define MONOUIDAMAGETMPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x93A7100)

inline static constexpr unsigned int MonoUIDamageTMPEffect_TypeDefinitionIndex = 76594;
