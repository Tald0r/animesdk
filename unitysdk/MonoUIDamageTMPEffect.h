...
#define MONOUIDAMAGETMPEFFECT_ANIMATETEXT_OFFSET UNITYSDK_OFFSET(0x9554F00)
#define MONOUIDAMAGETMPEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0x9553680)
#define MONOUIDAMAGETMPEFFECT_CLEARCOROUTINE_OFFSET UNITYSDK_OFFSET(0x9553C30)
#define MONOUIDAMAGETMPEFFECT_DOUPDATEANIMATION_OFFSET UNITYSDK_OFFSET(0x9555020)
#define MONOUIDAMAGETMPEFFECT_GETCHARACTERFADEININTERVAL_OFFSET UNITYSDK_OFFSET(0x9554A30)
#define MONOUIDAMAGETMPEFFECT_GETCHARACTERFADEOUTINTERVAL_OFFSET UNITYSDK_OFFSET(0x9554AA0)
#define MONOUIDAMAGETMPEFFECT_GETDAMAGETEXTLENGTH_OFFSET UNITYSDK_OFFSET(0x9554BD0)
#define MONOUIDAMAGETMPEFFECT_GETTEXTSCALE_OFFSET UNITYSDK_OFFSET(0x9554B10)
#define MONOUIDAMAGETMPEFFECT_GETTEXTSHOWTIME_OFFSET UNITYSDK_OFFSET(0x9554970)
#define MONOUIDAMAGETMPEFFECT_GET_ISPAUSE_OFFSET UNITYSDK_OFFSET(0x9553670)
#define MONOUIDAMAGETMPEFFECT_GET_ISPLAYINGANIM_OFFSET UNITYSDK_OFFSET(0x9553660)
#define MONOUIDAMAGETMPEFFECT_INITDATA_OFFSET UNITYSDK_OFFSET(0x9553760)
#define MONOUIDAMAGETMPEFFECT_MANUALUPDATEANIMATION_OFFSET UNITYSDK_OFFSET(0x9554FA0)
#define MONOUIDAMAGETMPEFFECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9553AE0)
#define MONOUIDAMAGETMPEFFECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9553D20)
#define MONOUIDAMAGETMPEFFECT_ONPAUSEGAMESTATECHANGED_OFFSET UNITYSDK_OFFSET(0x9553E70)
#define MONOUIDAMAGETMPEFFECT_PLAYDAMAGEJUMPANIM_OFFSET UNITYSDK_OFFSET(0x9554C40)
#define MONOUIDAMAGETMPEFFECT_REFRESHCOMBINEDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x9553EE0)
#define MONOUIDAMAGETMPEFFECT_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x9555DD0)
#define MONOUIDAMAGETMPEFFECT_SETDAMAGETEXTCOMBINE_OFFSET UNITYSDK_OFFSET(0x9554090)
#define MONOUIDAMAGETMPEFFECT_SETDAMAGETEXT_OFFSET UNITYSDK_OFFSET(0x9554320)
#define MONOUIDAMAGETMPEFFECT_SETFONTMATERIAL_OFFSET UNITYSDK_OFFSET(0x9554220)
#define MONOUIDAMAGETMPEFFECT_UPDATETRSMATRIX_OFFSET UNITYSDK_OFFSET(0x9555E60)
#define MONOUIDAMAGETMPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x9555FD0)

inline static constexpr unsigned int MonoUIDamageTMPEffect_TypeDefinitionIndex = 70605;
