...
#define MONOUITABLESCROLLV2_SELECTALIGNSCROLLPARAM_GET_SELECTALIGNCURVE_OFFSET UNITYSDK_OFFSET(0x9730CF0)
#define MONOUITABLESCROLLV2_SELECTALIGNSCROLLPARAM_RESET_OFFSET UNITYSDK_OFFSET(0x9730DB0)
#define MONOUITABLESCROLLV2_SELECTALIGNSCROLLPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x9730E40)

inline static constexpr unsigned int MonoUITableScrollV2_SelectAlignScrollParam_TypeDefinitionIndex = 64448;
