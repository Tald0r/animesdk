...
#define MONOUITABLESCROLLV2_SELECTALIGNSCROLLPARAM_GET_SELECTALIGNCURVE_OFFSET UNITYSDK_OFFSET(0xA09D640)
#define MONOUITABLESCROLLV2_SELECTALIGNSCROLLPARAM_RESET_OFFSET UNITYSDK_OFFSET(0xA09D700)
#define MONOUITABLESCROLLV2_SELECTALIGNSCROLLPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA09D790)

inline static constexpr unsigned int MonoUITableScrollV2_SelectAlignScrollParam_TypeDefinitionIndex = 43816;
