...
#define AMLEGIKEXT_APPLYPLAYERMOTION_OFFSET UNITYSDK_OFFSET(0x7978620)
#define AMLEGIKEXT_CALCFOOTBINDVECTORS_OFFSET UNITYSDK_OFFSET(0x7977E00)
#define AMLEGIKEXT_CALCULATEFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x797F700)
#define AMLEGIKEXT_CALCULATEIKHIPDELTA_OFFSET UNITYSDK_OFFSET(0x7979370)
#define AMLEGIKEXT_CALCULATEPELVISTARGET_OFFSET UNITYSDK_OFFSET(0x7980410)
#define AMLEGIKEXT_CALCULATEPREDICTFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x7979BD0)
#define AMLEGIKEXT_CROSSCHECK_OFFSET UNITYSDK_OFFSET(0x797B4E0)
#define AMLEGIKEXT_DEBUGFOCUSEDFOOT_OFFSET UNITYSDK_OFFSET(0x79785B0)
#define AMLEGIKEXT_DOCALCULATETARGET_OFFSET UNITYSDK_OFFSET(0x797E7E0)
#define AMLEGIKEXT_FINALIZEFOOTIK_OFFSET UNITYSDK_OFFSET(0x797FEB0)
#define AMLEGIKEXT_GETDELTAFROMRIGIDBODYTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x797CFE0)
#define AMLEGIKEXT_GETFOOTSHAPE_OFFSET UNITYSDK_OFFSET(0x797D1F0)
#define AMLEGIKEXT_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0x797CE10)
#define AMLEGIKEXT_GETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x7976640)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x7976140)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x7976120)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x79761A0)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x7976180)
#define AMLEGIKEXT_GET_CURRENTFOOTLOCKEDPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x7976160)
#define AMLEGIKEXT_GET_CURRENTPELVISANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x79760C0)
#define AMLEGIKEXT_GET_CURRENTPELVISANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x7976100)
#define AMLEGIKEXT_GET_CURRENTTOEPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x79761C0)
#define AMLEGIKEXT_GET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x79768A0)
#define AMLEGIKEXT_GET_ENABLEDEBUGONOFFGROUNDHEIGHT_OFFSET UNITYSDK_OFFSET(0x79768C0)
#define AMLEGIKEXT_GET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x7976840)
#define AMLEGIKEXT_GET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x79767E0)
#define AMLEGIKEXT_GET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x79767C0)
#define AMLEGIKEXT_GET_ENABLELOCKFOOTREAL_OFFSET UNITYSDK_OFFSET(0x7976470)
#define AMLEGIKEXT_GET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x7976800)
#define AMLEGIKEXT_GET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x79767A0)
#define AMLEGIKEXT_GET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x79768E0)
#define AMLEGIKEXT_GET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x7976820)
#define AMLEGIKEXT_GET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x7976900)
#define AMLEGIKEXT_GET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x7976880)
#define AMLEGIKEXT_GET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x7976860)
#define AMLEGIKEXT_GET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x7976940)
#define AMLEGIKEXT_GET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x7976920)
#define AMLEGIKEXT_GET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x7976080)
#define AMLEGIKEXT_GET_HIPHITCOLLIDER_OFFSET UNITYSDK_OFFSET(0x797F6F0)
#define AMLEGIKEXT_GET_HIPHITPOINT_OFFSET UNITYSDK_OFFSET(0x797F6C0)
#define AMLEGIKEXT_GET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x7976060)
#define AMLEGIKEXT_GET_LASTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x79762A0)
#define AMLEGIKEXT_GET_LASTFOOTONGROUNDWEIGHT_OFFSET UNITYSDK_OFFSET(0x7976300)
#define AMLEGIKEXT_GET_LASTHITNORMALGLOBAL_OFFSET UNITYSDK_OFFSET(0x7976280)
#define AMLEGIKEXT_GET_LASTHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x7976260)
#define AMLEGIKEXT_GET_LASTORDINARYHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x7976220)
#define AMLEGIKEXT_GET_LASTPIKHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x7976240)
#define AMLEGIKEXT_GET_LASTTARGETPELVISPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x79761E0)
#define AMLEGIKEXT_GET_LASTTARGETPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x79762C0)
#define AMLEGIKEXT_GET_LASTTARGETROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x79762E0)
#define AMLEGIKEXT_HIPHEIGHTLIFTINGDELTABYMINDIST_OFFSET UNITYSDK_OFFSET(0x797C570)
#define AMLEGIKEXT_INITIALIZEFOOTLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x7978390)
#define AMLEGIKEXT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x7976960)
#define AMLEGIKEXT_ISFOOTMOVING_OFFSET UNITYSDK_OFFSET(0x797C800)
#define AMLEGIKEXT_ISINPIKSTATE_OFFSET UNITYSDK_OFFSET(0x797B0E0)
#define AMLEGIKEXT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7981940)
#define AMLEGIKEXT_LOCKFOOT_OFFSET UNITYSDK_OFFSET(0x797B720)
#define AMLEGIKEXT_ONANIMATORIKEXEC_OFFSET UNITYSDK_OFFSET(0x7981350)
#define AMLEGIKEXT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x7980CC0)
#define AMLEGIKEXT_ONFOOTPLANT_OFFSET UNITYSDK_OFFSET(0x79809A0)
#define AMLEGIKEXT_ORDINARYIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x797D2A0)
#define AMLEGIKEXT_PREDICTDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x797B040)
#define AMLEGIKEXT_PREDICTFOOT_OFFSET UNITYSDK_OFFSET(0x797A4C0)
#define AMLEGIKEXT_PREDICTIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x797D680)
#define AMLEGIKEXT_PREPARE_OFFSET UNITYSDK_OFFSET(0x7978830)
#define AMLEGIKEXT_PREPROCESSANIMPOS_OFFSET UNITYSDK_OFFSET(0x797C0E0)
#define AMLEGIKEXT_PREPROCESSPREDICTIONIK_OFFSET UNITYSDK_OFFSET(0x797B3C0)
#define AMLEGIKEXT_RESETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x7976710)
#define AMLEGIKEXT_SETFOOTCONTROLPARAM_OFFSET UNITYSDK_OFFSET(0x797FC50)
#define AMLEGIKEXT_SETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x79764F0)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x7976150)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x7976130)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x79761B0)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x7976190)
#define AMLEGIKEXT_SET_CURRENTFOOTLOCKEDPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x7976170)
#define AMLEGIKEXT_SET_CURRENTPELVISANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x79760E0)
#define AMLEGIKEXT_SET_CURRENTPELVISANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x7976110)
#define AMLEGIKEXT_SET_CURRENTTOEPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x79761D0)
#define AMLEGIKEXT_SET_DISABLEDAMPING_OFFSET UNITYSDK_OFFSET(0x7976320)
#define AMLEGIKEXT_SET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x79768B0)
#define AMLEGIKEXT_SET_ENABLEDEBUGONOFFGROUNDHEIGHT_OFFSET UNITYSDK_OFFSET(0x79768D0)
#define AMLEGIKEXT_SET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x7976850)
#define AMLEGIKEXT_SET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x79767F0)
#define AMLEGIKEXT_SET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x79767D0)
#define AMLEGIKEXT_SET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x7976810)
#define AMLEGIKEXT_SET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x79767B0)
#define AMLEGIKEXT_SET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x79768F0)
#define AMLEGIKEXT_SET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x7976830)
#define AMLEGIKEXT_SET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x7976910)
#define AMLEGIKEXT_SET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x7976890)
#define AMLEGIKEXT_SET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x7976870)
#define AMLEGIKEXT_SET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x7976950)
#define AMLEGIKEXT_SET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x7976930)
#define AMLEGIKEXT_SET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x79760A0)
#define AMLEGIKEXT_SET_HIPHITCOLLIDER_OFFSET UNITYSDK_OFFSET(0x797F6E0)
#define AMLEGIKEXT_SET_HIPHITPOINT_OFFSET UNITYSDK_OFFSET(0x797F6A0)
#define AMLEGIKEXT_SET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x7976070)
#define AMLEGIKEXT_SET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x7976330)
#define AMLEGIKEXT_SET_LASTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x79762B0)
#define AMLEGIKEXT_SET_LASTFOOTONGROUNDWEIGHT_OFFSET UNITYSDK_OFFSET(0x7976310)
#define AMLEGIKEXT_SET_LASTHITNORMALGLOBAL_OFFSET UNITYSDK_OFFSET(0x7976290)
#define AMLEGIKEXT_SET_LASTHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x7976270)
#define AMLEGIKEXT_SET_LASTORDINARYHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x7976230)
#define AMLEGIKEXT_SET_LASTPIKHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x7976250)
#define AMLEGIKEXT_SET_LASTTARGETPELVISPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x7976200)
#define AMLEGIKEXT_SET_LASTTARGETPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x79762D0)
#define AMLEGIKEXT_SET_LASTTARGETROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x79762F0)
#define AMLEGIKEXT_START_OFFSET UNITYSDK_OFFSET(0x7980B50)
#define AMLEGIKEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0x7980E30)
#define AMLEGIKEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x79819C0)

inline static constexpr unsigned int AMLegIKExt_TypeDefinitionIndex = 42122;
