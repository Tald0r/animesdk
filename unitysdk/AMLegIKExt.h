...
#define AMLEGIKEXT_APPLYPLAYERMOTION_OFFSET UNITYSDK_OFFSET(0x986DDA0)
#define AMLEGIKEXT_CALCFOOTBINDVECTORS_OFFSET UNITYSDK_OFFSET(0x986D580)
#define AMLEGIKEXT_CALCULATEFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x9874E80)
#define AMLEGIKEXT_CALCULATEIKHIPDELTA_OFFSET UNITYSDK_OFFSET(0x986EAF0)
#define AMLEGIKEXT_CALCULATEPELVISTARGET_OFFSET UNITYSDK_OFFSET(0x9875B90)
#define AMLEGIKEXT_CALCULATEPREDICTFOOTTARGET_OFFSET UNITYSDK_OFFSET(0x986F350)
#define AMLEGIKEXT_CROSSCHECK_OFFSET UNITYSDK_OFFSET(0x9870C60)
#define AMLEGIKEXT_DEBUGFOCUSEDFOOT_OFFSET UNITYSDK_OFFSET(0x986DD30)
#define AMLEGIKEXT_DOCALCULATETARGET_OFFSET UNITYSDK_OFFSET(0x9873F60)
#define AMLEGIKEXT_FINALIZEFOOTIK_OFFSET UNITYSDK_OFFSET(0x9875630)
#define AMLEGIKEXT_GETDELTAFROMRIGIDBODYTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9872760)
#define AMLEGIKEXT_GETFOOTSHAPE_OFFSET UNITYSDK_OFFSET(0x9872970)
#define AMLEGIKEXT_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0x9872590)
#define AMLEGIKEXT_GETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x986BDD0)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B8D0)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x986B8B0)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B930)
#define AMLEGIKEXT_GET_CURRENTFOOTANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x986B910)
#define AMLEGIKEXT_GET_CURRENTFOOTLOCKEDPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B8F0)
#define AMLEGIKEXT_GET_CURRENTPELVISANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x986B850)
#define AMLEGIKEXT_GET_CURRENTPELVISANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x986B890)
#define AMLEGIKEXT_GET_CURRENTTOEPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B950)
#define AMLEGIKEXT_GET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x986C020)
#define AMLEGIKEXT_GET_ENABLEDEBUGONOFFGROUNDHEIGHT_OFFSET UNITYSDK_OFFSET(0x986C040)
#define AMLEGIKEXT_GET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x986BFC0)
#define AMLEGIKEXT_GET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x986BF60)
#define AMLEGIKEXT_GET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x986BF40)
#define AMLEGIKEXT_GET_ENABLELOCKFOOTREAL_OFFSET UNITYSDK_OFFSET(0x986BC00)
#define AMLEGIKEXT_GET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x986BF80)
#define AMLEGIKEXT_GET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x986BF20)
#define AMLEGIKEXT_GET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x986C060)
#define AMLEGIKEXT_GET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x986BFA0)
#define AMLEGIKEXT_GET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x986C080)
#define AMLEGIKEXT_GET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x986C000)
#define AMLEGIKEXT_GET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x986BFE0)
#define AMLEGIKEXT_GET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x986C0C0)
#define AMLEGIKEXT_GET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x986C0A0)
#define AMLEGIKEXT_GET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x986B810)
#define AMLEGIKEXT_GET_HIPHITCOLLIDER_OFFSET UNITYSDK_OFFSET(0x9874E70)
#define AMLEGIKEXT_GET_HIPHITPOINT_OFFSET UNITYSDK_OFFSET(0x9874E40)
#define AMLEGIKEXT_GET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x986B7F0)
#define AMLEGIKEXT_GET_LASTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986BA30)
#define AMLEGIKEXT_GET_LASTFOOTONGROUNDWEIGHT_OFFSET UNITYSDK_OFFSET(0x986BA90)
#define AMLEGIKEXT_GET_LASTHITNORMALGLOBAL_OFFSET UNITYSDK_OFFSET(0x986BA10)
#define AMLEGIKEXT_GET_LASTHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B9F0)
#define AMLEGIKEXT_GET_LASTORDINARYHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B9B0)
#define AMLEGIKEXT_GET_LASTPIKHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B9D0)
#define AMLEGIKEXT_GET_LASTTARGETPELVISPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x986B970)
#define AMLEGIKEXT_GET_LASTTARGETPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986BA50)
#define AMLEGIKEXT_GET_LASTTARGETROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x986BA70)
#define AMLEGIKEXT_HIPHEIGHTLIFTINGDELTABYMINDIST_OFFSET UNITYSDK_OFFSET(0x9871CF0)
#define AMLEGIKEXT_INITIALIZEFOOTLOCKSTATE_OFFSET UNITYSDK_OFFSET(0x986DB10)
#define AMLEGIKEXT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x986C0E0)
#define AMLEGIKEXT_ISFOOTMOVING_OFFSET UNITYSDK_OFFSET(0x9871F80)
#define AMLEGIKEXT_ISINPIKSTATE_OFFSET UNITYSDK_OFFSET(0x9870860)
#define AMLEGIKEXT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x98770B0)
#define AMLEGIKEXT_LOCKFOOT_OFFSET UNITYSDK_OFFSET(0x9870EA0)
#define AMLEGIKEXT_ONANIMATORIKEXEC_OFFSET UNITYSDK_OFFSET(0x9876AD0)
#define AMLEGIKEXT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9876440)
#define AMLEGIKEXT_ONFOOTPLANT_OFFSET UNITYSDK_OFFSET(0x9876120)
#define AMLEGIKEXT_ORDINARYIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x9872A20)
#define AMLEGIKEXT_PREDICTDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x98707C0)
#define AMLEGIKEXT_PREDICTFOOT_OFFSET UNITYSDK_OFFSET(0x986FC40)
#define AMLEGIKEXT_PREDICTIKHITGROUND_OFFSET UNITYSDK_OFFSET(0x9872E00)
#define AMLEGIKEXT_PREPARE_OFFSET UNITYSDK_OFFSET(0x986DFB0)
#define AMLEGIKEXT_PREPROCESSANIMPOS_OFFSET UNITYSDK_OFFSET(0x9871860)
#define AMLEGIKEXT_PREPROCESSPREDICTIONIK_OFFSET UNITYSDK_OFFSET(0x9870B40)
#define AMLEGIKEXT_RESETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x986BE90)
#define AMLEGIKEXT_SETFOOTCONTROLPARAM_OFFSET UNITYSDK_OFFSET(0x98753D0)
#define AMLEGIKEXT_SETSTATEDEPENDPARAMS_OFFSET UNITYSDK_OFFSET(0x986BC80)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B8E0)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x986B8C0)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B940)
#define AMLEGIKEXT_SET_CURRENTFOOTANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x986B920)
#define AMLEGIKEXT_SET_CURRENTFOOTLOCKEDPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B900)
#define AMLEGIKEXT_SET_CURRENTPELVISANIMPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x986B870)
#define AMLEGIKEXT_SET_CURRENTPELVISANIMROTLOCAL_OFFSET UNITYSDK_OFFSET(0x986B8A0)
#define AMLEGIKEXT_SET_CURRENTTOEPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B960)
#define AMLEGIKEXT_SET_DISABLEDAMPING_OFFSET UNITYSDK_OFFSET(0x986BAB0)
#define AMLEGIKEXT_SET_ENABLEANIMDEBUG_OFFSET UNITYSDK_OFFSET(0x986C030)
#define AMLEGIKEXT_SET_ENABLEDEBUGONOFFGROUNDHEIGHT_OFFSET UNITYSDK_OFFSET(0x986C050)
#define AMLEGIKEXT_SET_ENABLEFINALHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x986BFD0)
#define AMLEGIKEXT_SET_ENABLEFOOTMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x986BF70)
#define AMLEGIKEXT_SET_ENABLELOCKFOOTDEBUG_OFFSET UNITYSDK_OFFSET(0x986BF50)
#define AMLEGIKEXT_SET_ENABLEORDINARYHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x986BF90)
#define AMLEGIKEXT_SET_ENABLEPELVISDEBUG_OFFSET UNITYSDK_OFFSET(0x986BF30)
#define AMLEGIKEXT_SET_ENABLEPIKDRAWDEBUG_OFFSET UNITYSDK_OFFSET(0x986C070)
#define AMLEGIKEXT_SET_ENABLEPIKHITGROUNDDEBUG_OFFSET UNITYSDK_OFFSET(0x986BFB0)
#define AMLEGIKEXT_SET_ENABLEPREDICTIVEMOVINGDEBUG_OFFSET UNITYSDK_OFFSET(0x986C090)
#define AMLEGIKEXT_SET_ENABLERAYCASTDEBUG_OFFSET UNITYSDK_OFFSET(0x986C010)
#define AMLEGIKEXT_SET_ENABLETARGETDEBUG_OFFSET UNITYSDK_OFFSET(0x986BFF0)
#define AMLEGIKEXT_SET_FOOTINDEXTOWATCH_OFFSET UNITYSDK_OFFSET(0x986C0D0)
#define AMLEGIKEXT_SET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x986C0B0)
#define AMLEGIKEXT_SET_HIPDELTA_OFFSET UNITYSDK_OFFSET(0x986B830)
#define AMLEGIKEXT_SET_HIPHITCOLLIDER_OFFSET UNITYSDK_OFFSET(0x9874E60)
#define AMLEGIKEXT_SET_HIPHITPOINT_OFFSET UNITYSDK_OFFSET(0x9874E20)
#define AMLEGIKEXT_SET_IKWEIGHT_OFFSET UNITYSDK_OFFSET(0x986B800)
#define AMLEGIKEXT_SET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x986BAC0)
#define AMLEGIKEXT_SET_LASTANIMPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986BA40)
#define AMLEGIKEXT_SET_LASTFOOTONGROUNDWEIGHT_OFFSET UNITYSDK_OFFSET(0x986BAA0)
#define AMLEGIKEXT_SET_LASTHITNORMALGLOBAL_OFFSET UNITYSDK_OFFSET(0x986BA20)
#define AMLEGIKEXT_SET_LASTHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986BA00)
#define AMLEGIKEXT_SET_LASTORDINARYHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B9C0)
#define AMLEGIKEXT_SET_LASTPIKHITPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986B9E0)
#define AMLEGIKEXT_SET_LASTTARGETPELVISPOSLOCAL_OFFSET UNITYSDK_OFFSET(0x986B990)
#define AMLEGIKEXT_SET_LASTTARGETPOSGLOBAL_OFFSET UNITYSDK_OFFSET(0x986BA60)
#define AMLEGIKEXT_SET_LASTTARGETROTGLOBAL_OFFSET UNITYSDK_OFFSET(0x986BA80)
#define AMLEGIKEXT_START_OFFSET UNITYSDK_OFFSET(0x98762D0)
#define AMLEGIKEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0x98765B0)
#define AMLEGIKEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9877130)

inline static constexpr unsigned int AMLegIKExt_TypeDefinitionIndex = 38663;
