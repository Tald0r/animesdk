...
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER__SWITCHCAMERA_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x35DA70)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER__SWITCHCAMERA_D__11_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

inline static constexpr unsigned int ConfigCameraSphericalCoordinateSwitcher__SwitchCamera_d__11_TypeDefinitionIndex = 78824;
