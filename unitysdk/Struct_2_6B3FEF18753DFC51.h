...
#define STRUCT_2_6B3FEF18753DFC51_METHOD_2_B3725C8DD86BB06D_OFFSET UNITYSDK_OFFSET(0x56EBC0)
#define STRUCT_2_6B3FEF18753DFC51_METHOD_2_CADC6C4AB8366DDC_OFFSET UNITYSDK_OFFSET(0x56EBD0)
#define STRUCT_2_6B3FEF18753DFC51_METHOD_2_CC4D685A21CDBA98_OFFSET UNITYSDK_OFFSET(0x56EB10)
#define STRUCT_2_6B3FEF18753DFC51_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x314B50)
#define STRUCT_2_6B3FEF18753DFC51__CCTOR_OFFSET UNITYSDK_OFFSET(0xF38E3C0)
#define STRUCT_2_6B3FEF18753DFC51__CTOR_OFFSET UNITYSDK_OFFSET(0x2EC7B0)

inline static constexpr unsigned int Struct_2_6B3FEF18753DFC51_TypeDefinitionIndex = 75337;

struct alignas(8) Struct_2_6B3FEF18753DFC51
{
	static ::Struct_2_6B3FEF18753DFC51* StaticGet_Field_2_1()
	{
		return (::Struct_2_6B3FEF18753DFC51*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_6B3FEF18753DFC51_TypeDefinitionIndex)->GetStaticField(0xD280);
	}
