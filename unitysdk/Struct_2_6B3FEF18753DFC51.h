...
#define STRUCT_2_6B3FEF18753DFC51_METHOD_2_B3725C8DD86BB06D_OFFSET UNITYSDK_OFFSET(0x333890)
#define STRUCT_2_6B3FEF18753DFC51_METHOD_2_CADC6C4AB8366DDC_OFFSET UNITYSDK_OFFSET(0x333950)
#define STRUCT_2_6B3FEF18753DFC51_METHOD_2_CC4D685A21CDBA98_OFFSET UNITYSDK_OFFSET(0x3338A0)
#define STRUCT_2_6B3FEF18753DFC51_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x2C3A90)
#define STRUCT_2_6B3FEF18753DFC51__CCTOR_OFFSET UNITYSDK_OFFSET(0x7B50840)
#define STRUCT_2_6B3FEF18753DFC51__CTOR_OFFSET UNITYSDK_OFFSET(0x2FB050)

inline static constexpr unsigned int Struct_2_6B3FEF18753DFC51_TypeDefinitionIndex = 74470;

struct alignas(8) Struct_2_6B3FEF18753DFC51
{
	static ::Struct_2_6B3FEF18753DFC51* StaticGet_Field_2_1()
	{
		return (::Struct_2_6B3FEF18753DFC51*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_6B3FEF18753DFC51_TypeDefinitionIndex)->GetStaticField(0xFD70);
	}
