...
#define AGENTLINKMOVER__PARABOLA_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7FAE850)
#define AGENTLINKMOVER__PARABOLA_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x7FAEAC0)
#define AGENTLINKMOVER__PARABOLA_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x7FAEB20)
#define AGENTLINKMOVER__PARABOLA_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x7FAEAD0)
#define AGENTLINKMOVER__PARABOLA_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7FAE840)
#define AGENTLINKMOVER__PARABOLA_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x7FAE830)

inline static constexpr unsigned int AgentLinkMover__Parabola_d__4_TypeDefinitionIndex = 47401;
...
public:
	...
	::UnityEngine::Vector3 _startPos_5__2; // 0x24
