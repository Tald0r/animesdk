...
#define CLASS_3_D6BE13BFAB99CA8A_STRUCT_2_DE74B3B1CBD75BFA_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x36ECA0)
#define CLASS_3_D6BE13BFAB99CA8A_STRUCT_2_DE74B3B1CBD75BFA_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

inline static constexpr unsigned int Class_3_D6BE13BFAB99CA8A_Struct_2_DE74B3B1CBD75BFA_TypeDefinitionIndex = 76940;

struct alignas(8) Class_3_D6BE13BFAB99CA8A_Struct_2_DE74B3B1CBD75BFA
{
	::Class_3_D6BE13BFAB99CA8A* Field_2_3; // 0x10
	::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder Field_2_1; // 0x18
	::MoleMole::HollowChessboard::RenderDataHandle Field_2_2; // 0x28
