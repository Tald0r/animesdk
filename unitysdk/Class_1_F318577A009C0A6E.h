...
#define CLASS_1_F318577A009C0A6E_METHOD_1_1E13A8A5C0FF7D62_OFFSET UNITYSDK_OFFSET(0xB344C50)
#define CLASS_1_F318577A009C0A6E_METHOD_1_3E9CD81E66CB28FD_OFFSET UNITYSDK_OFFSET(0xB3465A0)
#define CLASS_1_F318577A009C0A6E_METHOD_1_413F493333BF3391_OFFSET UNITYSDK_OFFSET(0xB345D50)
#define CLASS_1_F318577A009C0A6E_METHOD_1_43E6D08197AA9CDD_OFFSET UNITYSDK_OFFSET(0xB345160)
#define CLASS_1_F318577A009C0A6E_METHOD_1_4B8E7FCFC2DC04FB_OFFSET UNITYSDK_OFFSET(0xB3444A0)
#define CLASS_1_F318577A009C0A6E_METHOD_1_4F9929DB42A2989B_1_OFFSET UNITYSDK_OFFSET(0xB3456A0)
#define CLASS_1_F318577A009C0A6E_METHOD_1_4F9929DB42A2989B_OFFSET UNITYSDK_OFFSET(0xB3446D0)
#define CLASS_1_F318577A009C0A6E_METHOD_1_5B0743536553688C_OFFSET UNITYSDK_OFFSET(0xB3452F0)
#define CLASS_1_F318577A009C0A6E_METHOD_1_5CF270C2E7C8B828_OFFSET UNITYSDK_OFFSET(0xB345970)
#define CLASS_1_F318577A009C0A6E_METHOD_1_80B35FDAEB7143D4_OFFSET UNITYSDK_OFFSET(0xB345FD0)
#define CLASS_1_F318577A009C0A6E_METHOD_1_9628185997A5A39F_OFFSET UNITYSDK_OFFSET(0xB345300)
#define CLASS_1_F318577A009C0A6E_METHOD_1_9CA5A80F6B5B9E01_OFFSET UNITYSDK_OFFSET(0xB345960)
#define CLASS_1_F318577A009C0A6E_METHOD_1_A8EBB58952AD6E9F_OFFSET UNITYSDK_OFFSET(0xB344A50)
#define CLASS_1_F318577A009C0A6E_METHOD_1_AC6A5C5C2E0664AA_OFFSET UNITYSDK_OFFSET(0xB345D60)
#define CLASS_1_F318577A009C0A6E_METHOD_1_AC762F67FADB2CA3_OFFSET UNITYSDK_OFFSET(0xB346AA0)
#define CLASS_1_F318577A009C0A6E_METHOD_1_C32CC33BF0371575_OFFSET UNITYSDK_OFFSET(0xB3449B0)
#define CLASS_1_F318577A009C0A6E_METHOD_1_D37FAD0A6AA04B25_OFFSET UNITYSDK_OFFSET(0xB3446B0)
#define CLASS_1_F318577A009C0A6E_METHOD_1_E4B4A3F40157A79A_OFFSET UNITYSDK_OFFSET(0xB346AB0)
#define CLASS_1_F318577A009C0A6E_METHOD_1_E95A4606AAD9C63C_OFFSET UNITYSDK_OFFSET(0xB344FA0)
#define CLASS_1_F318577A009C0A6E__CTOR_OFFSET UNITYSDK_OFFSET(0xB344490)

inline static constexpr unsigned int Class_1_F318577A009C0A6E_TypeDefinitionIndex = 40015;

class Class_1_F318577A009C0A6E : public ::System::Object
{
public:
	// static const ::System::Boolean Field_1_0; // 0x0
	::MoleMole::MonoPhotoWallEdge* Field_1_8; // 0x10
	::Foundation::AssetPath Field_1_2; // 0x18
	::UnityEngine::GameObject* Field_1_6; // 0x28
	::Foundation::AssetPath Field_1_1; // 0x30
	::System::Action_2<::Foundation::AssetPath, ::UnityEngine::GameObject*>* Field_1_4; // 0x40
	::Foundation::AssetPath Field_1_3; // 0x48
	::UnityEngine::Rendering::Universal::Internal::OutlineObjectRenderer* Field_1_7; // 0x58
