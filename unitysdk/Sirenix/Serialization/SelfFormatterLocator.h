...
#define SIRENIX_SERIALIZATION_SELFFORMATTERLOCATOR_TRYGETFORMATTER_OFFSET UNITYSDK_OFFSET(0x1ACB2F90)
#define SIRENIX_SERIALIZATION_SELFFORMATTERLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACB31F0)
