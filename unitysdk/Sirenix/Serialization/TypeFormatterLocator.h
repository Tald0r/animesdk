...
#define SIRENIX_SERIALIZATION_TYPEFORMATTERLOCATOR_TRYGETFORMATTER_OFFSET UNITYSDK_OFFSET(0x1ACB57C0)
#define SIRENIX_SERIALIZATION_TYPEFORMATTERLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACB5860)
