...
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B71A5B0)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_TYPE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B71A8C0)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_TYPE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B71A850)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B71A930)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B71A8B0)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B71A860)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B71A570)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71A550)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B71A590)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1B71A5A0)
...
namespace Sirenix::Serialization
{
	...
	public:
		...
		::System::Collections::Generic::HashSet_1_Enumerator<::System::Type*> __7__wrap1; // 0x30
