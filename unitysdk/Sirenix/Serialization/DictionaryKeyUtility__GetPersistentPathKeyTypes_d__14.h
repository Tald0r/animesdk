...
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B102AD0)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_TYPE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B102DE0)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_TYPE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B102D70)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B102E50)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B102DD0)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B102D80)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B102A90)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1B102A70)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B102AB0)
#define SIRENIX_SERIALIZATION_DICTIONARYKEYUTILITY__GETPERSISTENTPATHKEYTYPES_D__14___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1B102AC0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int DictionaryKeyUtility__GetPersistentPathKeyTypes_d__14_TypeDefinitionIndex = 7428;
