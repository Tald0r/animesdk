...
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GETEXTERNALOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1A7061D0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GETEXTERNALOBJECT_2_OFFSET UNITYSDK_OFFSET(0x1A7064B0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GETEXTERNALOBJECT_OFFSET UNITYSDK_OFFSET(0x1A7060F0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GETINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A7060B0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_BINDER_OFFSET UNITYSDK_OFFSET(0x1A703490)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1A6FCD80)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_FORMATTERCONVERTER_OFFSET UNITYSDK_OFFSET(0x1A706010)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_GUIDREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1A705FC0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_INDEXREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1A705FE0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_STREAMINGCONTEXT_OFFSET UNITYSDK_OFFSET(0x1A706000)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_GET_STRINGREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1A705FA0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_REGISTERINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A706030)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_RESET_OFFSET UNITYSDK_OFFSET(0x1A705F20)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_BINDER_OFFSET UNITYSDK_OFFSET(0x1A705F90)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1A706020)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_GUIDREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1A705FD0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_INDEXREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1A705FF0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SET_STRINGREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1A705FB0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONCLAIMED_OFFSET UNITYSDK_OFFSET(0x1A7067C0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONFREED_OFFSET UNITYSDK_OFFSET(0x1A706750)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A705EC0)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A705F00)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A705D80)
#define SIRENIX_SERIALIZATION_DESERIALIZATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A705D40)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int DeserializationContext_TypeDefinitionIndex = 7365;
	...
	public:
		...
		::Sirenix::Serialization::IExternalStringReferenceResolver* _StringReferenceResolver_k__BackingField; // 0x20
		::System::Collections::Generic::List_1<::System::Object*>* internalIdReferenceMap; // 0x28
		::Sirenix::Serialization::IExternalIndexReferenceResolver* _IndexReferenceResolver_k__BackingField; // 0x30
		::System::Runtime::Serialization::StreamingContext streamingContext; // 0x38
		::Sirenix::Serialization::IExternalGuidReferenceResolver* _GuidReferenceResolver_k__BackingField; // 0x48
		::System::Runtime::Serialization::IFormatterConverter* formatterConverter; // 0x50
