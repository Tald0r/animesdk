...
#define SIRENIX_SERIALIZATION_BASEDATAWRITER_FLUSHTOSTREAM_OFFSET UNITYSDK_OFFSET(0x1AE27950)
#define SIRENIX_SERIALIZATION_BASEDATAWRITER_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1AE26F20)
#define SIRENIX_SERIALIZATION_BASEDATAWRITER_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x1AE27860)
#define SIRENIX_SERIALIZATION_BASEDATAWRITER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1AE27980)
#define SIRENIX_SERIALIZATION_BASEDATAWRITER_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1AE27940)
#define SIRENIX_SERIALIZATION_BASEDATAWRITER_SET_STREAM_OFFSET UNITYSDK_OFFSET(0x1AE27870)
#define SIRENIX_SERIALIZATION_BASEDATAWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE277F0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int BaseDataWriter_TypeDefinitionIndex = 7278;
