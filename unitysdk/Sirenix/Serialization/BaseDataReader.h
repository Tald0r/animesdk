...
#define SIRENIX_SERIALIZATION_BASEDATAREADER_ENTERNODE_OFFSET UNITYSDK_OFFSET(0x1B738FD0)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1B738F60)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_CURRENTNODEDEPTH_OFFSET UNITYSDK_OFFSET(0x1B738E30)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_CURRENTNODEID_OFFSET UNITYSDK_OFFSET(0x1B738DB0)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_CURRENTNODENAME_OFFSET UNITYSDK_OFFSET(0x1B738E40)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x1B738EC0)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1B739940)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1B738FC0)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_SET_STREAM_OFFSET UNITYSDK_OFFSET(0x1B738ED0)
#define SIRENIX_SERIALIZATION_BASEDATAREADER_SKIPENTRY_OFFSET UNITYSDK_OFFSET(0x1B739000)
#define SIRENIX_SERIALIZATION_BASEDATAREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B738D40)
