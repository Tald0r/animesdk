...
#define SIRENIX_SERIALIZATION_DEBUGCONTEXT_GET_ERRORHANDLINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1B6729E0)
#define SIRENIX_SERIALIZATION_DEBUGCONTEXT_GET_LOGGER_OFFSET UNITYSDK_OFFSET(0x1B672810)
#define SIRENIX_SERIALIZATION_DEBUGCONTEXT_GET_LOGGINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1B6729C0)
#define SIRENIX_SERIALIZATION_DEBUGCONTEXT_LOGERROR_OFFSET UNITYSDK_OFFSET(0x1B672AD0)
#define SIRENIX_SERIALIZATION_DEBUGCONTEXT_LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1B672BD0)
#define SIRENIX_SERIALIZATION_DEBUGCONTEXT_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1B672A00)
#define SIRENIX_SERIALIZATION_DEBUGCONTEXT_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x1B672D60)
#define SIRENIX_SERIALIZATION_DEBUGCONTEXT_SET_ERRORHANDLINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1B6729F0)
#define SIRENIX_SERIALIZATION_DEBUGCONTEXT_SET_LOGGER_OFFSET UNITYSDK_OFFSET(0x1B672910)
#define SIRENIX_SERIALIZATION_DEBUGCONTEXT_SET_LOGGINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1B6729D0)
#define SIRENIX_SERIALIZATION_DEBUGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B672E30)
