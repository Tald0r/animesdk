...
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_APPLYDICTIONARYMODIFICATIONS_OFFSET UNITYSDK_OFFSET(0x1A70B4E0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_APPLYLISTLENGTH_OFFSET UNITYSDK_OFFSET(0x1A70A360)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_APPLYVALUE_OFFSET UNITYSDK_OFFSET(0x1A70A250)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_APPLY_OFFSET UNITYSDK_OFFSET(0x1A70A170)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_GETINSTANCEFROMPATH_OFFSET UNITYSDK_OFFSET(0x1A70BB80)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_GETINSTANCEOFSTEP_OFFSET UNITYSDK_OFFSET(0x1A70C2E0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_REPLACEALLREFERENCESINGRAPH_OFFSET UNITYSDK_OFFSET(0x1A70BD00)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_SETINSTANCETOPATH_1_OFFSET UNITYSDK_OFFSET(0x1A70D3D0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_SETINSTANCETOPATH_OFFSET UNITYSDK_OFFSET(0x1A70BC60)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_TRYSETINSTANCEOFSTEP_OFFSET UNITYSDK_OFFSET(0x1A70D4E0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A70EA50)
...
namespace Sirenix::Serialization
{
	...
	public:
		...
		::Il2CppArray<::System::Object*>* DictionaryKeysRemoved; // 0x18
		::System::Object* ModifiedValue; // 0x20
