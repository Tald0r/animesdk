...
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_APPLYDICTIONARYMODIFICATIONS_OFFSET UNITYSDK_OFFSET(0x1A18CDB0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_APPLYLISTLENGTH_OFFSET UNITYSDK_OFFSET(0x1A18BC30)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_APPLYVALUE_OFFSET UNITYSDK_OFFSET(0x1A18BB20)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_APPLY_OFFSET UNITYSDK_OFFSET(0x1A18BA40)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_GETINSTANCEFROMPATH_OFFSET UNITYSDK_OFFSET(0x1A18D450)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_GETINSTANCEOFSTEP_OFFSET UNITYSDK_OFFSET(0x1A18DBB0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_REPLACEALLREFERENCESINGRAPH_OFFSET UNITYSDK_OFFSET(0x1A18D5D0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_SETINSTANCETOPATH_1_OFFSET UNITYSDK_OFFSET(0x1A18ECA0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_SETINSTANCETOPATH_OFFSET UNITYSDK_OFFSET(0x1A18D530)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION_TRYSETINSTANCEOFSTEP_OFFSET UNITYSDK_OFFSET(0x1A18EDB0)
#define SIRENIX_SERIALIZATION_PREFABMODIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A190320)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int PrefabModification_TypeDefinitionIndex = 7381;
	...
	public:
		...
		::Il2CppArray<::System::Object*>* DictionaryKeysRemoved; // 0x28
		::System::Collections::Generic::List_1<::System::String*>* ReferencePaths; // 0x30
