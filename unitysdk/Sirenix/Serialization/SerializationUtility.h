...
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_CREATECOPY_OFFSET UNITYSDK_OFFSET(0x1AA43280)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_CREATEREADER_OFFSET UNITYSDK_OFFSET(0x1AA40D30)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_CREATEWRITER_OFFSET UNITYSDK_OFFSET(0x1AA40BA0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_1_OFFSET UNITYSDK_OFFSET(0x1AA42440)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_2_OFFSET UNITYSDK_OFFSET(0x1AA42690)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_3_OFFSET UNITYSDK_OFFSET(0x1AA42AE0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_4_OFFSET UNITYSDK_OFFSET(0x1AA42DE0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_5_OFFSET UNITYSDK_OFFSET(0x1AA43020)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_OFFSET UNITYSDK_OFFSET(0x1AA423A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_GETCACHEDREADER_OFFSET UNITYSDK_OFFSET(0x1AA41140)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_GETCACHEDWRITER_OFFSET UNITYSDK_OFFSET(0x1AA40EC0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_1_OFFSET UNITYSDK_OFFSET(0x1AA414A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_2_OFFSET UNITYSDK_OFFSET(0x1AA417A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_3_OFFSET UNITYSDK_OFFSET(0x1AA41A20)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_4_OFFSET UNITYSDK_OFFSET(0x1AA41CB0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_5_OFFSET UNITYSDK_OFFSET(0x1AA42020)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_OFFSET UNITYSDK_OFFSET(0x1AA41340)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int SerializationUtility_TypeDefinitionIndex = 7398;
