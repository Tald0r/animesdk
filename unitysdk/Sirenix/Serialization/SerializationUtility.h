...
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_CREATECOPY_OFFSET UNITYSDK_OFFSET(0x1B056ED0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_CREATEREADER_OFFSET UNITYSDK_OFFSET(0x1B054980)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_CREATEWRITER_OFFSET UNITYSDK_OFFSET(0x1B0547F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_1_OFFSET UNITYSDK_OFFSET(0x1B056090)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_2_OFFSET UNITYSDK_OFFSET(0x1B0562E0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_3_OFFSET UNITYSDK_OFFSET(0x1B056730)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_4_OFFSET UNITYSDK_OFFSET(0x1B056A30)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_5_OFFSET UNITYSDK_OFFSET(0x1B056C70)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_DESERIALIZEVALUEWEAK_OFFSET UNITYSDK_OFFSET(0x1B055FF0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_GETCACHEDREADER_OFFSET UNITYSDK_OFFSET(0x1B054D90)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_GETCACHEDWRITER_OFFSET UNITYSDK_OFFSET(0x1B054B10)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_1_OFFSET UNITYSDK_OFFSET(0x1B0550F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_2_OFFSET UNITYSDK_OFFSET(0x1B0553F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_3_OFFSET UNITYSDK_OFFSET(0x1B055670)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_4_OFFSET UNITYSDK_OFFSET(0x1B055900)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_5_OFFSET UNITYSDK_OFFSET(0x1B055C70)
#define SIRENIX_SERIALIZATION_SERIALIZATIONUTILITY_SERIALIZEVALUEWEAK_OFFSET UNITYSDK_OFFSET(0x1B054F90)
