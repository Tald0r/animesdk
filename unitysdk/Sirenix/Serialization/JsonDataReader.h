...
#define SIRENIX_SERIALIZATION_JSONDATAREADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B4CBB20)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_ENTERARRAY_OFFSET UNITYSDK_OFFSET(0x1B4CC760)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_ENTERNODE_OFFSET UNITYSDK_OFFSET(0x1B4CBC40)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_EXITARRAY_OFFSET UNITYSDK_OFFSET(0x1B4CCAC0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_EXITNODE_OFFSET UNITYSDK_OFFSET(0x1B4CC5F0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_GETDATADUMP_OFFSET UNITYSDK_OFFSET(0x1B4CED40)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x1B4CBA60)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_MARKENTRYCONSUMED_OFFSET UNITYSDK_OFFSET(0x1B4CCD00)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_PEEKENTRY_1_OFFSET UNITYSDK_OFFSET(0x1B4CC490)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_PEEKENTRY_OFFSET UNITYSDK_OFFSET(0x1B4CBB40)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1B4CEC60)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READANYINTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B4CCE30)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1B4CCBE0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READBYTE_OFFSET UNITYSDK_OFFSET(0x1B4CDF10)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READCHAR_OFFSET UNITYSDK_OFFSET(0x1B4CD5A0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READDECIMAL_OFFSET UNITYSDK_OFFSET(0x1B4CE4D0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B4CE9B0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READEXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1B4CD1B0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READEXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1B4CD4B0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READEXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B4CD0B0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READGUID_OFFSET UNITYSDK_OFFSET(0x1B4CD7E0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READINT16_OFFSET UNITYSDK_OFFSET(0x1B4CDDF0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READINT32_OFFSET UNITYSDK_OFFSET(0x1B4CC4D0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READINT64_OFFSET UNITYSDK_OFFSET(0x1B4CDB90)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B4CCD30)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READNULL_OFFSET UNITYSDK_OFFSET(0x1B4CEC10)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READSBYTE_OFFSET UNITYSDK_OFFSET(0x1B4CDA70)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READSINGLE_OFFSET UNITYSDK_OFFSET(0x1B4CE750)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1B4CD6D0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READTONEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1B4CC4B0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READUINT16_OFFSET UNITYSDK_OFFSET(0x1B4CE290)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READUINT32_OFFSET UNITYSDK_OFFSET(0x1B4CE3B0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_READUINT64_OFFSET UNITYSDK_OFFSET(0x1B4CE030)
#define SIRENIX_SERIALIZATION_JSONDATAREADER_SET_STREAM_OFFSET UNITYSDK_OFFSET(0x1B4CBA70)
#define SIRENIX_SERIALIZATION_JSONDATAREADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4CB0F0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CB0E0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_0_OFFSET UNITYSDK_OFFSET(0x1B4CEF20)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_10_OFFSET UNITYSDK_OFFSET(0x1B4CF0A0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_11_OFFSET UNITYSDK_OFFSET(0x1B4CF0C0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_12_OFFSET UNITYSDK_OFFSET(0x1B4CF0F0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_13_OFFSET UNITYSDK_OFFSET(0x1B4CF120)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_1_OFFSET UNITYSDK_OFFSET(0x1B4CEF40)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_2_OFFSET UNITYSDK_OFFSET(0x1B4CEF60)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_3_OFFSET UNITYSDK_OFFSET(0x1B4CEF80)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_4_OFFSET UNITYSDK_OFFSET(0x1B4CEFA0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_5_OFFSET UNITYSDK_OFFSET(0x1B4CEFD0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_6_OFFSET UNITYSDK_OFFSET(0x1B4CEFF0)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_7_OFFSET UNITYSDK_OFFSET(0x1B4CF010)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_8_OFFSET UNITYSDK_OFFSET(0x1B4CF030)
#define SIRENIX_SERIALIZATION_JSONDATAREADER___CTOR_B__7_9_OFFSET UNITYSDK_OFFSET(0x1B4CF060)
...
namespace Sirenix::Serialization
{
	...
	{
	public:
		::System::String* peekedEntryContent; // 0x38
		::Sirenix::Serialization::JsonTextReader* reader; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Delegate*>* primitiveArrayReaders; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Type*>* seenTypes; // 0x50
