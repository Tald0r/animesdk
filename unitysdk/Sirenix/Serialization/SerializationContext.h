...
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_BINDER_OFFSET UNITYSDK_OFFSET(0x1B440870)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1B4440C0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_FORMATTERCONVERTER_OFFSET UNITYSDK_OFFSET(0x1B444050)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_GUIDREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1B4440A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_INDEXREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1B444060)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_STREAMINGCONTEXT_OFFSET UNITYSDK_OFFSET(0x1B444040)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_STRINGREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1B444080)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_RESETINTERNALREFERENCES_OFFSET UNITYSDK_OFFSET(0x1B444830)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x1B443F90)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SET_BINDER_OFFSET UNITYSDK_OFFSET(0x1B444030)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1B444110)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SET_GUIDREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1B4440B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SET_INDEXREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1B444070)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SET_STRINGREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1B444090)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONCLAIMED_OFFSET UNITYSDK_OFFSET(0x1B444940)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONFREED_OFFSET UNITYSDK_OFFSET(0x1B4448A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_TRYGETINTERNALREFERENCEID_OFFSET UNITYSDK_OFFSET(0x1B444120)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_TRYREGISTEREXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1B444510)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_TRYREGISTEREXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1B4446A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_TRYREGISTEREXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B4442D0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_TRYREGISTERINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B4441C0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B443F30)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B443F70)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B443D70)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4411F0)
...
namespace Sirenix::Serialization
{
	...
	public:
		...
		::Sirenix::Serialization::IExternalIndexReferenceResolver* _IndexReferenceResolver_k__BackingField; // 0x18
		...
		::System::Collections::Generic::Dictionary_2<::System::Object*, ::System::Int32>* internalReferenceIdMap; // 0x30
