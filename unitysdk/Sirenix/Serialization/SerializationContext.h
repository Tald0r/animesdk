...
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_BINDER_OFFSET UNITYSDK_OFFSET(0x1AE26F80)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1AE2A7E0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_FORMATTERCONVERTER_OFFSET UNITYSDK_OFFSET(0x1AE2A770)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_GUIDREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1AE2A7C0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_INDEXREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1AE2A780)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_STREAMINGCONTEXT_OFFSET UNITYSDK_OFFSET(0x1AE2A760)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_GET_STRINGREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1AE2A7A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_RESETINTERNALREFERENCES_OFFSET UNITYSDK_OFFSET(0x1AE2AF50)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_RESETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x1AE2A6B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SET_BINDER_OFFSET UNITYSDK_OFFSET(0x1AE2A750)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x1AE2A830)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SET_GUIDREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1AE2A7D0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SET_INDEXREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1AE2A790)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SET_STRINGREFERENCERESOLVER_OFFSET UNITYSDK_OFFSET(0x1AE2A7B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONCLAIMED_OFFSET UNITYSDK_OFFSET(0x1AE2B060)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONFREED_OFFSET UNITYSDK_OFFSET(0x1AE2AFC0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_TRYGETINTERNALREFERENCEID_OFFSET UNITYSDK_OFFSET(0x1AE2A840)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_TRYREGISTEREXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1AE2AC30)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_TRYREGISTEREXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1AE2ADC0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_TRYREGISTEREXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AE2A9F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT_TRYREGISTERINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AE2A8E0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE2A650)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AE2A690)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AE2A490)
#define SIRENIX_SERIALIZATION_SERIALIZATIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE27900)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int SerializationContext_TypeDefinitionIndex = 7394;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::Object*, ::System::Int32>* internalReferenceIdMap; // 0x28
		::Sirenix::Serialization::TwoWaySerializationBinder* binder; // 0x30
		::Sirenix::Serialization::SerializationConfig* config; // 0x38
