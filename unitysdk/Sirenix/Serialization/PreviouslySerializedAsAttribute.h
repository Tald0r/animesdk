...
#define SIRENIX_SERIALIZATION_PREVIOUSLYSERIALIZEDASATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AE2A460)
#define SIRENIX_SERIALIZATION_PREVIOUSLYSERIALIZEDASATTRIBUTE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1AE2A470)
#define SIRENIX_SERIALIZATION_PREVIOUSLYSERIALIZEDASATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE2A480)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int PreviouslySerializedAsAttribute_TypeDefinitionIndex = 7383;
