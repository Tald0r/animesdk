...
#define SIRENIX_SERIALIZATION_PREVIOUSLYSERIALIZEDASATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B443D40)
#define SIRENIX_SERIALIZATION_PREVIOUSLYSERIALIZEDASATTRIBUTE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B443D50)
#define SIRENIX_SERIALIZATION_PREVIOUSLYSERIALIZEDASATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B443D60)
