...
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1ACC2D20)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_GETKEYFROMPATHSTRING_OFFSET UNITYSDK_OFFSET(0x1ACC2E70)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_GETPATHSTRINGFROMKEY_OFFSET UNITYSDK_OFFSET(0x1ACC3060)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_GET_PROVIDERID_OFFSET UNITYSDK_OFFSET(0x1ACC2CE0)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACC32B0)
