...
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A717D20)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_GETKEYFROMPATHSTRING_OFFSET UNITYSDK_OFFSET(0x1A717E70)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_GETPATHSTRINGFROMKEY_OFFSET UNITYSDK_OFFSET(0x1A718060)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER_GET_PROVIDERID_OFFSET UNITYSDK_OFFSET(0x1A717CE0)
#define SIRENIX_SERIALIZATION_VECTOR4DICTIONARYKEYPATHPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7182B0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int Vector4DictionaryKeyPathProvider_TypeDefinitionIndex = 7434;
