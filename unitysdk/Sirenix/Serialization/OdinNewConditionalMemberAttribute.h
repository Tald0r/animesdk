...
#define SIRENIX_SERIALIZATION_ODINNEWCONDITIONALMEMBERATTRIBUTE_GET_FULLCONDITIONSTATEMENT_OFFSET UNITYSDK_OFFSET(0x1B71A9A0)
#define SIRENIX_SERIALIZATION_ODINNEWCONDITIONALMEMBERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71A9B0)
