...
#define SIRENIX_SERIALIZATION_CUSTOMGENERICFORMATTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEB5D80)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int CustomGenericFormatterAttribute_TypeDefinitionIndex = 7360;
