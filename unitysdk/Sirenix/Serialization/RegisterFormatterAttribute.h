...
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE_GET_FORMATTERTYPE_OFFSET UNITYSDK_OFFSET(0x1B4CF4D0)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1B4CF4F0)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE_SET_FORMATTERTYPE_OFFSET UNITYSDK_OFFSET(0x1B4CF4E0)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1B4CF500)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4CF510)
