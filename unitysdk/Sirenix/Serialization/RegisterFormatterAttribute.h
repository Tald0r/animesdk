...
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE_GET_FORMATTERTYPE_OFFSET UNITYSDK_OFFSET(0x1AEBB400)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1AEBB420)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE_SET_FORMATTERTYPE_OFFSET UNITYSDK_OFFSET(0x1AEBB410)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1AEBB430)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEBB440)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int RegisterFormatterAttribute_TypeDefinitionIndex = 7389;
