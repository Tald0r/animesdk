...
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER_READFIELDACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ACB2F10)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER_READFIELDACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ACB2F70)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER_READFIELDACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ACB2BD0)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER_READFIELDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACB2BB0)
