...
#define SIRENIX_SERIALIZATION_TWOWAYSERIALIZATIONBINDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6E7E50)
#define SIRENIX_SERIALIZATION_TWOWAYSERIALIZATIONBINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E7E40)
