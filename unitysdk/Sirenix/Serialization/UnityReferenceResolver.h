...
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_CANREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AE2AA20)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_GETREFERENCEDUNITYOBJECTS_OFFSET UNITYSDK_OFFSET(0x1AE2BCD0)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_RESET_OFFSET UNITYSDK_OFFSET(0x1AE2BD20)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_SETREFERENCEDUNITYOBJECTS_OFFSET UNITYSDK_OFFSET(0x1AE2BAE0)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONCLAIMED_OFFSET UNITYSDK_OFFSET(0x1AE2BE20)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONFREED_OFFSET UNITYSDK_OFFSET(0x1AE2BDA0)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_TRYRESOLVEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AE2BCE0)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE2BA00)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE2B8E0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int UnityReferenceResolver_TypeDefinitionIndex = 7471;
