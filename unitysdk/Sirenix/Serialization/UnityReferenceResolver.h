...
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_CANREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B444300)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_GETREFERENCEDUNITYOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B4455B0)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_RESET_OFFSET UNITYSDK_OFFSET(0x1B445600)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_SETREFERENCEDUNITYOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B4453C0)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONCLAIMED_OFFSET UNITYSDK_OFFSET(0x1B445700)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_SIRENIX_SERIALIZATION_UTILITIES_ICACHENOTIFICATIONRECEIVER_ONFREED_OFFSET UNITYSDK_OFFSET(0x1B445680)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER_TRYRESOLVEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B4455C0)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4452E0)
#define SIRENIX_SERIALIZATION_UNITYREFERENCERESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4451C0)
