...
#define SIRENIX_SERIALIZATION_INT64SERIALIZER_READVALUE_OFFSET UNITYSDK_OFFSET(0x1AEB6A50)
#define SIRENIX_SERIALIZATION_INT64SERIALIZER_WRITEVALUE_OFFSET UNITYSDK_OFFSET(0x1AEB6F10)
#define SIRENIX_SERIALIZATION_INT64SERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEB6FD0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int Int64Serializer_TypeDefinitionIndex = 7410;
