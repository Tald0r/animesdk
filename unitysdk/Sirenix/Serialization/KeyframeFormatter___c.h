...
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE2A010)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE2A050)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_0_OFFSET UNITYSDK_OFFSET(0x1AE2A060)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_1_OFFSET UNITYSDK_OFFSET(0x1AE2A0E0)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_2_OFFSET UNITYSDK_OFFSET(0x1AE2A160)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_3_OFFSET UNITYSDK_OFFSET(0x1AE2A1E0)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_4_OFFSET UNITYSDK_OFFSET(0x1AE2A260)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_5_OFFSET UNITYSDK_OFFSET(0x1AE2A2D0)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_6_OFFSET UNITYSDK_OFFSET(0x1AE2A350)
#define SIRENIX_SERIALIZATION_KEYFRAMEFORMATTER___C___CCTOR_B__6_7_OFFSET UNITYSDK_OFFSET(0x1AE2A3D0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int KeyframeFormatter___c_TypeDefinitionIndex = 7448;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::KeyframeFormatter___c**)Il2CppClass::FromTypeDefinitionIndex(KeyframeFormatter___c_TypeDefinitionIndex)->GetStaticField(0x6040);
		}
