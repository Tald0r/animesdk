...
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AE279F0)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_GET_SERIALIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x1AE279B0)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1AE27A10)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AE27A00)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_SIRENIX_SERIALIZATION_IFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AE279E0)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE27A20)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int CoroutineFormatter_TypeDefinitionIndex = 7441;
