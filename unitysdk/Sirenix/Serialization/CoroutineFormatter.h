...
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4412E0)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_GET_SERIALIZEDTYPE_OFFSET UNITYSDK_OFFSET(0x1B4412A0)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1B441300)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4412F0)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER_SIRENIX_SERIALIZATION_IFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4412D0)
#define SIRENIX_SERIALIZATION_COROUTINEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B441310)
