...
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1AEBC310)
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER_GETKEYFROMPATHSTRING_OFFSET UNITYSDK_OFFSET(0x1AEBC3A0)
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER_GETPATHSTRINGFROMKEY_OFFSET UNITYSDK_OFFSET(0x1AEBC480)
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER_GET_PROVIDERID_OFFSET UNITYSDK_OFFSET(0x1AEBC2D0)
#define SIRENIX_SERIALIZATION_VECTOR2DICTIONARYKEYPATHPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEBC5E0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int Vector2DictionaryKeyPathProvider_TypeDefinitionIndex = 7432;
