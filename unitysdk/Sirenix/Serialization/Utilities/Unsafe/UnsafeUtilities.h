...
#define SIRENIX_SERIALIZATION_UTILITIES_UNSAFE_UNSAFEUTILITIES_MEMORYCOPY_1_OFFSET UNITYSDK_OFFSET(0x1B750970)
#define SIRENIX_SERIALIZATION_UTILITIES_UNSAFE_UNSAFEUTILITIES_MEMORYCOPY_OFFSET UNITYSDK_OFFSET(0x1B7508B0)
#define SIRENIX_SERIALIZATION_UTILITIES_UNSAFE_UNSAFEUTILITIES_STRINGFROMBYTES_OFFSET UNITYSDK_OFFSET(0x1B74FE80)
#define SIRENIX_SERIALIZATION_UTILITIES_UNSAFE_UNSAFEUTILITIES_STRINGTOBYTES_OFFSET UNITYSDK_OFFSET(0x1B7503C0)
