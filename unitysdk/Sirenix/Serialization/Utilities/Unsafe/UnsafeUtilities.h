...
#define SIRENIX_SERIALIZATION_UTILITIES_UNSAFE_UNSAFEUTILITIES_MEMORYCOPY_1_OFFSET UNITYSDK_OFFSET(0x1B133F50)
#define SIRENIX_SERIALIZATION_UTILITIES_UNSAFE_UNSAFEUTILITIES_MEMORYCOPY_OFFSET UNITYSDK_OFFSET(0x1B133E90)
#define SIRENIX_SERIALIZATION_UTILITIES_UNSAFE_UNSAFEUTILITIES_STRINGFROMBYTES_OFFSET UNITYSDK_OFFSET(0x1B133460)
#define SIRENIX_SERIALIZATION_UTILITIES_UNSAFE_UNSAFEUTILITIES_STRINGTOBYTES_OFFSET UNITYSDK_OFFSET(0x1B1339A0)

namespace Sirenix::Serialization::Utilities::Unsafe
{
	inline static constexpr unsigned int UnsafeUtilities_TypeDefinitionIndex = 7525;
