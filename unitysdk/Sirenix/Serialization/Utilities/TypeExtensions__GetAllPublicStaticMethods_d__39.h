...
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A706AB0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_METHODINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A706DA0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_METHODINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A706D30)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A706E20)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A706D90)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A706D40)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A706AA0)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLPUBLICSTATICMETHODS_D__39__CTOR_OFFSET UNITYSDK_OFFSET(0x1A706A80)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int TypeExtensions__GetAllPublicStaticMethods_d__39_TypeDefinitionIndex = 7489;
	...
	public:
		...
		::System::Type* _currentType_5__3; // 0x20
