...
#define SIRENIX_SERIALIZATION_UTILITIES_STRINGEXTENSIONS_ISNULLORWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1B1333E0)
#define SIRENIX_SERIALIZATION_UTILITIES_STRINGEXTENSIONS_TOTITLECASE_OFFSET UNITYSDK_OFFSET(0x1B133250)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int StringExtensions_TypeDefinitionIndex = 7486;
