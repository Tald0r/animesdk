...
#define SIRENIX_SERIALIZATION_UTILITIES_STRINGEXTENSIONS_ISNULLORWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1B74FE00)
#define SIRENIX_SERIALIZATION_UTILITIES_STRINGEXTENSIONS_TOTITLECASE_OFFSET UNITYSDK_OFFSET(0x1B74FC70)
