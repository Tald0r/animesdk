...
#define SIRENIX_SERIALIZATION_UTILITIES_EMITUTILITIES_CREATEWEAKINSTANCEFIELDGETTER_OFFSET UNITYSDK_OFFSET(0x1B62ED90)
#define SIRENIX_SERIALIZATION_UTILITIES_EMITUTILITIES_CREATEWEAKINSTANCEFIELDSETTER_OFFSET UNITYSDK_OFFSET(0x1B62EF00)
#define SIRENIX_SERIALIZATION_UTILITIES_EMITUTILITIES_CREATEWEAKINSTANCEPROPERTYGETTER_OFFSET UNITYSDK_OFFSET(0x1B62F070)
#define SIRENIX_SERIALIZATION_UTILITIES_EMITUTILITIES_CREATEWEAKINSTANCEPROPERTYSETTER_OFFSET UNITYSDK_OFFSET(0x1B62F2B0)
#define SIRENIX_SERIALIZATION_UTILITIES_EMITUTILITIES_GET_CANEMIT_OFFSET UNITYSDK_OFFSET(0x1B62ED80)
