...
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B079D50)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_MEMBERINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B079F90)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_MEMBERINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B079F20)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B07A010)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B079F80)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B079F30)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B079D40)
#define SIRENIX_SERIALIZATION_UTILITIES_TYPEEXTENSIONS__GETALLFIELDSANDPROPERTIES_D__55__CTOR_OFFSET UNITYSDK_OFFSET(0x1B079D20)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int TypeExtensions__GetAllFieldsAndProperties_d__55_TypeDefinitionIndex = 7490;
