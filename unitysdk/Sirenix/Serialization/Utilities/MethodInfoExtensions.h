...
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_DEALIASMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0D6CB0)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_GETFULLNAME_1_OFFSET UNITYSDK_OFFSET(0x1B0D67C0)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_GETFULLNAME_OFFSET UNITYSDK_OFFSET(0x1B0D6800)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_GETPARAMSNAMES_OFFSET UNITYSDK_OFFSET(0x1B0D69B0)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_ISALIASMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0D6C60)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_ISEXTENSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0D68F0)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int MethodInfoExtensions_TypeDefinitionIndex = 7482;
