...
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_DEALIASMETHOD_OFFSET UNITYSDK_OFFSET(0x1B6E88D0)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_GETFULLNAME_1_OFFSET UNITYSDK_OFFSET(0x1B6E83E0)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_GETFULLNAME_OFFSET UNITYSDK_OFFSET(0x1B6E8420)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_GETPARAMSNAMES_OFFSET UNITYSDK_OFFSET(0x1B6E85D0)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_ISALIASMETHOD_OFFSET UNITYSDK_OFFSET(0x1B6E8880)
#define SIRENIX_SERIALIZATION_UTILITIES_METHODINFOEXTENSIONS_ISEXTENSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1B6E8510)
