...
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUEGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A717C30)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUEGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A717C60)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUEGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A70F350)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7166B0)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int WeakValueGetter_TypeDefinitionIndex = 7495;
