...
#define SIRENIX_SERIALIZATION_UTILITIES_PROPERTYINFOEXTENSIONS_DEALIASPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B71B1F0)
#define SIRENIX_SERIALIZATION_UTILITIES_PROPERTYINFOEXTENSIONS_ISALIASPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B71B1A0)
#define SIRENIX_SERIALIZATION_UTILITIES_PROPERTYINFOEXTENSIONS_ISAUTOPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B71AFB0)
