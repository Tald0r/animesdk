...
#define SIRENIX_SERIALIZATION_UTILITIES_PROPERTYINFOEXTENSIONS_DEALIASPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B103710)
#define SIRENIX_SERIALIZATION_UTILITIES_PROPERTYINFOEXTENSIONS_ISALIASPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B1036C0)
#define SIRENIX_SERIALIZATION_UTILITIES_PROPERTYINFOEXTENSIONS_ISAUTOPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B1034D0)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int PropertyInfoExtensions_TypeDefinitionIndex = 7485;
