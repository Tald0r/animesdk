...
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A717C80)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A717CC0)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A714690)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7166C0)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int WeakValueSetter_TypeDefinitionIndex = 7496;
