...
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ACC2C80)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ACC2CC0)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ACBF690)
#define SIRENIX_SERIALIZATION_UTILITIES_WEAKVALUESETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACC16C0)
