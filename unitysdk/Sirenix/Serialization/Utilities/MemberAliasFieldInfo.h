...
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GETCUSTOMATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1B079C50)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B079C20)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1B079CB0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_ALIASEDFIELD_OFFSET UNITYSDK_OFFSET(0x1B079AB0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B079BF0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1B079B30)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_FIELDHANDLE_OFFSET UNITYSDK_OFFSET(0x1B079BC0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_FIELDTYPE_OFFSET UNITYSDK_OFFSET(0x1B079B90)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_METADATATOKEN_OFFSET UNITYSDK_OFFSET(0x1B079AF0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_MODULE_OFFSET UNITYSDK_OFFSET(0x1B079AC0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B079B20)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1B079B60)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1B079C80)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1B079CE0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B079A60)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B079A10)

namespace Sirenix::Serialization::Utilities
{
	inline static constexpr unsigned int MemberAliasFieldInfo_TypeDefinitionIndex = 7520;
