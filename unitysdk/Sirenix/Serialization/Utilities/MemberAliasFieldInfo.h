...
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GETCUSTOMATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1B687990)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B687960)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1B6879F0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_ALIASEDFIELD_OFFSET UNITYSDK_OFFSET(0x1B6877F0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B687930)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1B687870)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_FIELDHANDLE_OFFSET UNITYSDK_OFFSET(0x1B687900)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_FIELDTYPE_OFFSET UNITYSDK_OFFSET(0x1B6878D0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_METADATATOKEN_OFFSET UNITYSDK_OFFSET(0x1B687830)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_MODULE_OFFSET UNITYSDK_OFFSET(0x1B687800)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B687860)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_GET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1B6878A0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1B6879C0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1B687A20)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6877A0)
#define SIRENIX_SERIALIZATION_UTILITIES_MEMBERALIASFIELDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B687750)
