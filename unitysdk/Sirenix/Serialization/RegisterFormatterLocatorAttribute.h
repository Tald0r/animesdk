...
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE_GET_FORMATTERLOCATORTYPE_OFFSET UNITYSDK_OFFSET(0x1B71A9D0)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1B71A9F0)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE_SET_FORMATTERLOCATORTYPE_OFFSET UNITYSDK_OFFSET(0x1B71A9E0)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1B71AA00)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71AA10)
