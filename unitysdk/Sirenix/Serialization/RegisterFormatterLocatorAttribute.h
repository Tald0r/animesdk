...
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE_GET_FORMATTERLOCATORTYPE_OFFSET UNITYSDK_OFFSET(0x1B102EF0)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1B102F10)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE_SET_FORMATTERLOCATORTYPE_OFFSET UNITYSDK_OFFSET(0x1B102F00)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE_SET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1B102F20)
#define SIRENIX_SERIALIZATION_REGISTERFORMATTERLOCATORATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B102F30)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int RegisterFormatterLocatorAttribute_TypeDefinitionIndex = 7390;
