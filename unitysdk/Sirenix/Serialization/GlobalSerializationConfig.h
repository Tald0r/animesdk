...
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_BUILDSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1B14DE00)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_EDITORSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1B14DDE0)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_ERRORHANDLINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1B14DE40)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_LOGGER_OFFSET UNITYSDK_OFFSET(0x1B14DDB0)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_LOGGINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1B14DE20)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_ONINSPECTORGUI_OFFSET UNITYSDK_OFFSET(0x1B14DE60)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_BUILDSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1B14DE10)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_EDITORSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1B14DDF0)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_ERRORHANDLINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1B14DE50)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_LOGGINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1B14DE30)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B14E300)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14E2C0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int GlobalSerializationConfig_TypeDefinitionIndex = 6493;
	...
	public:
		...
		{
			return (::Il2CppArray<::Sirenix::Serialization::DataFormat>**)Il2CppClass::FromTypeDefinitionIndex(GlobalSerializationConfig_TypeDefinitionIndex)->GetStaticField(0x5A10);
		}
