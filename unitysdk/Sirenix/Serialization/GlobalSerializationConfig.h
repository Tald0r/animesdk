...
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_BUILDSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1B76D850)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_EDITORSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1B76D830)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_ERRORHANDLINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1B76D890)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_LOGGER_OFFSET UNITYSDK_OFFSET(0x1B76D800)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_GET_LOGGINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1B76D870)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_ONINSPECTORGUI_OFFSET UNITYSDK_OFFSET(0x1B76D8B0)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_BUILDSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1B76D860)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_EDITORSERIALIZATIONFORMAT_OFFSET UNITYSDK_OFFSET(0x1B76D840)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_ERRORHANDLINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1B76D8A0)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG_SET_LOGGINGPOLICY_OFFSET UNITYSDK_OFFSET(0x1B76D880)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B76DD50)
#define SIRENIX_SERIALIZATION_GLOBALSERIALIZATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76DD10)
