...
#define SIRENIX_SERIALIZATION_COLORBLOCKFORMATTERLOCATOR_TRYGETFORMATTER_OFFSET UNITYSDK_OFFSET(0x1ACB0DE0)
#define SIRENIX_SERIALIZATION_COLORBLOCKFORMATTERLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACB0F90)
