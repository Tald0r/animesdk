...
#define SIRENIX_SERIALIZATION_COLORBLOCKFORMATTERLOCATOR_TRYGETFORMATTER_OFFSET UNITYSDK_OFFSET(0x1A705B80)
#define SIRENIX_SERIALIZATION_COLORBLOCKFORMATTERLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A705D30)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int ColorBlockFormatterLocator_TypeDefinitionIndex = 7438;
