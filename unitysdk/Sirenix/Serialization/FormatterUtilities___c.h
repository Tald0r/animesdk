...
#define SIRENIX_SERIALIZATION_FORMATTERUTILITIES___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B4413D0)
#define SIRENIX_SERIALIZATION_FORMATTERUTILITIES___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1B441400)
#define SIRENIX_SERIALIZATION_FORMATTERUTILITIES___C__FINDSERIALIZABLEMEMBERSMAP_B__15_0_OFFSET UNITYSDK_OFFSET(0x1B441410)
#define SIRENIX_SERIALIZATION_FORMATTERUTILITIES___C__FINDSERIALIZABLEMEMBERSMAP_B__15_1_OFFSET UNITYSDK_OFFSET(0x1B441440)
#define SIRENIX_SERIALIZATION_FORMATTERUTILITIES___C__FINDSERIALIZABLEMEMBERS_B__16_0_OFFSET UNITYSDK_OFFSET(0x1B441450)
