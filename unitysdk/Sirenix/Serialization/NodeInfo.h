...
#define SIRENIX_SERIALIZATION_NODEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x9A8C40)
#define SIRENIX_SERIALIZATION_NODEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9A8C50)
#define SIRENIX_SERIALIZATION_NODEINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B62D9D0)
#define SIRENIX_SERIALIZATION_NODEINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B62DA90)
#define SIRENIX_SERIALIZATION_NODEINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B62DE10)
#define SIRENIX_SERIALIZATION_NODEINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9A8BC0)
#define SIRENIX_SERIALIZATION_NODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8BA0)
