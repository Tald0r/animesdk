...
#define SIRENIX_SERIALIZATION_NODEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x976330)
#define SIRENIX_SERIALIZATION_NODEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x976340)
#define SIRENIX_SERIALIZATION_NODEINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B021770)
#define SIRENIX_SERIALIZATION_NODEINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B021830)
#define SIRENIX_SERIALIZATION_NODEINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B021BB0)
#define SIRENIX_SERIALIZATION_NODEINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9762B0)
#define SIRENIX_SERIALIZATION_NODEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x976290)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int NodeInfo_TypeDefinitionIndex = 7379;

	struct alignas(8) NodeInfo
	{
		static ::Sirenix::Serialization::NodeInfo* StaticGet_Empty()
		{
			return (::Sirenix::Serialization::NodeInfo*)Il2CppClass::FromTypeDefinitionIndex(NodeInfo_TypeDefinitionIndex)->GetStaticField(0x6060);
		}
