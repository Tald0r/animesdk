...
#define SIRENIX_SERIALIZATION_VERSIONFORMATTER_GETUNINITIALIZEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1B0583D0)
#define SIRENIX_SERIALIZATION_VERSIONFORMATTER_READ_OFFSET UNITYSDK_OFFSET(0x1B0583E0)
#define SIRENIX_SERIALIZATION_VERSIONFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1B058700)
#define SIRENIX_SERIALIZATION_VERSIONFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0589C0)
