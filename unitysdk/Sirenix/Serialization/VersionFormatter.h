...
#define SIRENIX_SERIALIZATION_VERSIONFORMATTER_GETUNINITIALIZEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1AA44780)
#define SIRENIX_SERIALIZATION_VERSIONFORMATTER_READ_OFFSET UNITYSDK_OFFSET(0x1AA44790)
#define SIRENIX_SERIALIZATION_VERSIONFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1AA44AB0)
#define SIRENIX_SERIALIZATION_VERSIONFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA44D70)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int VersionFormatter_TypeDefinitionIndex = 7353;
