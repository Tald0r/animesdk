...
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_CLEARNODES_OFFSET UNITYSDK_OFFSET(0x1B441070)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_EXPANDNAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x1B440C40)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_EXPANDNODES_OFFSET UNITYSDK_OFFSET(0x1B440D70)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_GET_BINDER_OFFSET UNITYSDK_OFFSET(0x1B440640)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_GET_CURRENTNODE_OFFSET UNITYSDK_OFFSET(0x1B440A60)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_GET_ISINARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1B440A00)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_GET_NODEDEPTH_OFFSET UNITYSDK_OFFSET(0x1B440A50)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_POPARRAY_OFFSET UNITYSDK_OFFSET(0x1B440FB0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_POPNODE_OFFSET UNITYSDK_OFFSET(0x1B440F00)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_PUSHARRAY_OFFSET UNITYSDK_OFFSET(0x1B440DA0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_PUSHNODE_OFFSET UNITYSDK_OFFSET(0x1B440AF0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_SET_BINDER_OFFSET UNITYSDK_OFFSET(0x1B4408C0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4410A0)
