...
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_CLEARNODES_OFFSET UNITYSDK_OFFSET(0x1AE27780)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_EXPANDNAMEBUFFER_OFFSET UNITYSDK_OFFSET(0x1AE27350)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_EXPANDNODES_OFFSET UNITYSDK_OFFSET(0x1AE27480)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_GET_BINDER_OFFSET UNITYSDK_OFFSET(0x1AE26D50)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_GET_CURRENTNODE_OFFSET UNITYSDK_OFFSET(0x1AE27170)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_GET_ISINARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1AE27110)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_GET_NODEDEPTH_OFFSET UNITYSDK_OFFSET(0x1AE27160)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_POPARRAY_OFFSET UNITYSDK_OFFSET(0x1AE276C0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_POPNODE_OFFSET UNITYSDK_OFFSET(0x1AE27610)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_PUSHARRAY_OFFSET UNITYSDK_OFFSET(0x1AE274B0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_PUSHNODE_OFFSET UNITYSDK_OFFSET(0x1AE27200)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER_SET_BINDER_OFFSET UNITYSDK_OFFSET(0x1AE26FD0)
#define SIRENIX_SERIALIZATION_BASEDATAREADERWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE277B0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int BaseDataReaderWriter_TypeDefinitionIndex = 7277;
