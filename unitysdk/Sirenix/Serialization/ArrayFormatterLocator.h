...
#define SIRENIX_SERIALIZATION_ARRAYFORMATTERLOCATOR_TRYGETFORMATTER_OFFSET UNITYSDK_OFFSET(0x1B72B2A0)
#define SIRENIX_SERIALIZATION_ARRAYFORMATTERLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B72B9A0)
