...
#define SIRENIX_SERIALIZATION_TYPEFORMATTER_GETUNINITIALIZEDOBJECT_OFFSET UNITYSDK_OFFSET(0x1B123600)
#define SIRENIX_SERIALIZATION_TYPEFORMATTER_READ_OFFSET UNITYSDK_OFFSET(0x1B123120)
#define SIRENIX_SERIALIZATION_TYPEFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1B1233F0)
#define SIRENIX_SERIALIZATION_TYPEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B123610)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int TypeFormatter_TypeDefinitionIndex = 7352;
