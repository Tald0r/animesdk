...
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B103A70)
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER_GETKEYFROMPATHSTRING_OFFSET UNITYSDK_OFFSET(0x1B103B60)
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER_GETPATHSTRINGFROMKEY_OFFSET UNITYSDK_OFFSET(0x1B103CC0)
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER_GET_PROVIDERID_OFFSET UNITYSDK_OFFSET(0x1B103A30)
#define SIRENIX_SERIALIZATION_VECTOR3DICTIONARYKEYPATHPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B103EA0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int Vector3DictionaryKeyPathProvider_TypeDefinitionIndex = 7433;
