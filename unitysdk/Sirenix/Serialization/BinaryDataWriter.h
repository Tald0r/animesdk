...
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_BEGINARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1A791640)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_BEGINREFERENCENODE_OFFSET UNITYSDK_OFFSET(0x1A791820)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_BEGINSTRUCTNODE_OFFSET UNITYSDK_OFFSET(0x1A792670)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7928F0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_ENDARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1A7929D0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_ENDNODE_OFFSET UNITYSDK_OFFSET(0x1A792AD0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_ENSUREBUFFERSPACE_OFFSET UNITYSDK_OFFSET(0x1A79E510)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_FLUSHTOSTREAM_OFFSET UNITYSDK_OFFSET(0x1A792960)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_GETDATADUMP_OFFSET UNITYSDK_OFFSET(0x1A79D510)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1A79D480)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_TRYENSUREBUFFERSPACE_OFFSET UNITYSDK_OFFSET(0x1A79E5D0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_16_DECIMAL_OFFSET UNITYSDK_OFFSET(0x1A79E2B0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_16_GUID_OFFSET UNITYSDK_OFFSET(0x1A79E3E0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_2_CHAR_OFFSET UNITYSDK_OFFSET(0x1A79DD30)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_2_INT16_OFFSET UNITYSDK_OFFSET(0x1A79DD90)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_2_UINT16_OFFSET UNITYSDK_OFFSET(0x1A79DDF0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_4_FLOAT32_OFFSET UNITYSDK_OFFSET(0x1A79DF30)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_4_INT32_OFFSET UNITYSDK_OFFSET(0x1A79DE50)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_4_UINT32_OFFSET UNITYSDK_OFFSET(0x1A79DEC0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_8_FLOAT64_OFFSET UNITYSDK_OFFSET(0x1A79E1C0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_8_INT64_OFFSET UNITYSDK_OFFSET(0x1A79E000)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_UNSAFE_WRITETOBUFFER_8_UINT64_OFFSET UNITYSDK_OFFSET(0x1A79E0E0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1A799080)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1A7993C0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITECHAR_OFFSET UNITYSDK_OFFSET(0x1A799700)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEDECIMAL_OFFSET UNITYSDK_OFFSET(0x1A799AB0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A799DB0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEEXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1A79A800)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEEXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1A79ABB0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEEXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A79A500)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x1A79A200)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0x1A79BEE0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0x1A79AE30)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0x1A79B1E0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A79B7F0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITENULL_OFFSET UNITYSDK_OFFSET(0x1A79B5E0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_BOOL_OFFSET UNITYSDK_OFFSET(0x1A793450)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_BYTE_OFFSET UNITYSDK_OFFSET(0x1A792BF0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_CHAR_OFFSET UNITYSDK_OFFSET(0x1A793A10)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_DECIMAL_OFFSET UNITYSDK_OFFSET(0x1A796F70)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_DOUBLE_OFFSET UNITYSDK_OFFSET(0x1A797FE0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_FLOAT_OFFSET UNITYSDK_OFFSET(0x1A7977E0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_GUID_OFFSET UNITYSDK_OFFSET(0x1A7987F0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_INT_OFFSET UNITYSDK_OFFSET(0x1A794910)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_LONG_OFFSET UNITYSDK_OFFSET(0x1A795080)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_SBYTE_OFFSET UNITYSDK_OFFSET(0x1A792E90)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_SHORT_OFFSET UNITYSDK_OFFSET(0x1A794190)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_UINT_OFFSET UNITYSDK_OFFSET(0x1A796000)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_ULONG_OFFSET UNITYSDK_OFFSET(0x1A796770)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEPRIMITIVEARRAY_USHORT_OFFSET UNITYSDK_OFFSET(0x1A795880)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITESBYTE_OFFSET UNITYSDK_OFFSET(0x1A79BBA0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITESINGLE_OFFSET UNITYSDK_OFFSET(0x1A79C290)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITESTRINGFAST_OFFSET UNITYSDK_OFFSET(0x1A791BD0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1A79C700)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITETYPE_OFFSET UNITYSDK_OFFSET(0x1A79D6F0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0x1A79D0D0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0x1A79C920)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0x1A79CCD0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A79E660)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7914D0)
#define SIRENIX_SERIALIZATION_BINARYDATAWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7913A0)
...
namespace Sirenix::Serialization
{
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Action_2<::Sirenix::Serialization::BinaryDataWriter*, ::System::Object*>*>**)Il2CppClass::FromTypeDefinitionIndex(BinaryDataWriter_TypeDefinitionIndex)->GetStaticField(0x6438);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Delegate*>** StaticGet_PrimitiveGetBytesMethods()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Delegate*>**)Il2CppClass::FromTypeDefinitionIndex(BinaryDataWriter_TypeDefinitionIndex)->GetStaticField(0x6440);
		}
		::Il2CppArray<::System::Byte>* buffer; // 0x38
		::Il2CppArray<::System::Byte>* small_buffer; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Int32>* types; // 0x48
