...
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ACA7250)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_ENTERARRAY_OFFSET UNITYSDK_OFFSET(0x1ACA7CA0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_ENTERNODE_OFFSET UNITYSDK_OFFSET(0x1ACA8030)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_EXITARRAY_OFFSET UNITYSDK_OFFSET(0x1ACA8EA0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_EXITNODE_OFFSET UNITYSDK_OFFSET(0x1ACA90D0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_GETDATADUMP_OFFSET UNITYSDK_OFFSET(0x1ACAC670)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_HASBUFFERDATA_OFFSET UNITYSDK_OFFSET(0x1ACAF5D0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_INTERNSMALLSTRING_OFFSET UNITYSDK_OFFSET(0x1ACACDF0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_MARKENTRYCONTENTCONSUMED_OFFSET UNITYSDK_OFFSET(0x1ACAE740)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_PEEKENTRY_1_OFFSET UNITYSDK_OFFSET(0x1ACAE7C0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_PEEKENTRY_OFFSET UNITYSDK_OFFSET(0x1ACA7260)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1ACAC5B0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1ACA9350)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READBYTE_OFFSET UNITYSDK_OFFSET(0x1ACA9B60)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READCHAR_OFFSET UNITYSDK_OFFSET(0x1ACAA770)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READDECIMAL_OFFSET UNITYSDK_OFFSET(0x1ACAB750)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READDOUBLE_OFFSET UNITYSDK_OFFSET(0x1ACAB2D0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READENTIRESTREAMTOBUFFER_OFFSET UNITYSDK_OFFSET(0x1ACAF600)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READEXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1ACAC080)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READEXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1ACAC1F0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READEXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1ACABCC0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READGUID_OFFSET UNITYSDK_OFFSET(0x1ACABFB0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READINT16_OFFSET UNITYSDK_OFFSET(0x1ACAA1F0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READINT32_OFFSET UNITYSDK_OFFSET(0x1ACAA430)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READINT64_OFFSET UNITYSDK_OFFSET(0x1ACA95A0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1ACAC370)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READNULL_OFFSET UNITYSDK_OFFSET(0x1ACAC2C0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READSBYTE_OFFSET UNITYSDK_OFFSET(0x1ACA9480)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READSINGLE_OFFSET UNITYSDK_OFFSET(0x1ACAAAD0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READSTRINGVALUEFAST_OFFSET UNITYSDK_OFFSET(0x1ACACB90)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READSTRINGVALUETOBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1ACAD290)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READSTRINGVALUETOBUFFER_OFFSET UNITYSDK_OFFSET(0x1ACAD0C0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READSTRINGVALUE_1_OFFSET UNITYSDK_OFFSET(0x1ACACE50)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READSTRINGVALUE_OFFSET UNITYSDK_OFFSET(0x1ACAC800)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1ACAC4E0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READTONEXTENTRY_OFFSET UNITYSDK_OFFSET(0x1ACAE7E0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READTYPEENTRY_OFFSET UNITYSDK_OFFSET(0x1ACADA50)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READUINT16_OFFSET UNITYSDK_OFFSET(0x1ACAA310)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READUINT32_OFFSET UNITYSDK_OFFSET(0x1ACAA530)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_READUINT64_OFFSET UNITYSDK_OFFSET(0x1ACA9C80)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_SKIPBUFFER_OFFSET UNITYSDK_OFFSET(0x1ACADA30)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_SKIPPEEKEDENTRYCONTENT_OFFSET UNITYSDK_OFFSET(0x1ACAD580)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_SKIPSTRINGVALUE_OFFSET UNITYSDK_OFFSET(0x1ACAD430)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_16_DECIMAL_OFFSET UNITYSDK_OFFSET(0x1ACAF190)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_16_GUID_OFFSET UNITYSDK_OFFSET(0x1ACAF3B0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_1_BYTE_OFFSET UNITYSDK_OFFSET(0x1ACAE810)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_1_SBYTE_OFFSET UNITYSDK_OFFSET(0x1ACAE880)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_2_CHAR_OFFSET UNITYSDK_OFFSET(0x1ACAEA70)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_2_INT16_OFFSET UNITYSDK_OFFSET(0x1ACAE8F0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_2_UINT16_OFFSET UNITYSDK_OFFSET(0x1ACAE9B0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_4_FLOAT32_OFFSET UNITYSDK_OFFSET(0x1ACAECB0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_4_INT32_OFFSET UNITYSDK_OFFSET(0x1ACAEB30)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_4_UINT32_OFFSET UNITYSDK_OFFSET(0x1ACAEBF0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_8_FLOAT64_OFFSET UNITYSDK_OFFSET(0x1ACAF040)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_8_INT64_OFFSET UNITYSDK_OFFSET(0x1ACAEDA0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER_UNSAFE_READ_8_UINT64_OFFSET UNITYSDK_OFFSET(0x1ACAEEF0)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ACAF840)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ACA7120)
#define SIRENIX_SERIALIZATION_BINARYDATAREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA7010)
