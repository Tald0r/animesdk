...
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_BEGINARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1A709020)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_BEGINREFERENCENODE_OFFSET UNITYSDK_OFFSET(0x1A7090D0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_BEGINSTRUCTNODE_OFFSET UNITYSDK_OFFSET(0x1A709350)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A709590)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_ENDARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1A7095A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_ENDNODE_OFFSET UNITYSDK_OFFSET(0x1A709620)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_FLUSHTOSTREAM_OFFSET UNITYSDK_OFFSET(0x1A70A4A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_GETDATADUMP_OFFSET UNITYSDK_OFFSET(0x1A70A4B0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_GET_NODES_OFFSET UNITYSDK_OFFSET(0x1A708200)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_GET_STREAM_OFFSET UNITYSDK_OFFSET(0x1A708F80)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1A7096C0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_SET_NODES_OFFSET UNITYSDK_OFFSET(0x1A708250)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_SET_STREAM_OFFSET UNITYSDK_OFFSET(0x1A708FD0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1A7096F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1A709780)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITECHAR_OFFSET UNITYSDK_OFFSET(0x1A709830)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEDECIMAL_OFFSET UNITYSDK_OFFSET(0x1A709910)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A709A80)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEEXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1A709BD0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEEXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1A709C60)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEEXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A709B30)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x1A709D10)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0x1A709DB0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0x1A709E90)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0x1A709F40)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A709FF0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITENULL_OFFSET UNITYSDK_OFFSET(0x1A70A0A0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITESBYTE_OFFSET UNITYSDK_OFFSET(0x1A70A120)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITESINGLE_OFFSET UNITYSDK_OFFSET(0x1A7099D0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1A70A200)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0x1A70A290)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0x1A70A340)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0x1A70A3F0)
#define SIRENIX_SERIALIZATION_SERIALIZATIONNODEDATAWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7082C0)

namespace Sirenix::Serialization
{
	inline static constexpr unsigned int SerializationNodeDataWriter_TypeDefinitionIndex = 7294;
