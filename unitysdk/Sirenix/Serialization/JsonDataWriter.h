...
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_BEGINARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1B052E50)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_BEGINREFERENCENODE_OFFSET UNITYSDK_OFFSET(0x1B052190)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_BEGINSTRUCTNODE_OFFSET UNITYSDK_OFFSET(0x1B0529B0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_BUFFER_WRITESTRING_WITHESCAPE_OFFSET UNITYSDK_OFFSET(0x1B053610)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_CREATEBYTETOHEXLOOKUP_OFFSET UNITYSDK_OFFSET(0x1B054610)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B054070)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_ENDARRAYNODE_OFFSET UNITYSDK_OFFSET(0x1B052F50)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_ENDNODE_OFFSET UNITYSDK_OFFSET(0x1B052A30)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_ENSUREBUFFERSPACE_OFFSET UNITYSDK_OFFSET(0x1B052D50)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_FLUSHTOSTREAM_OFFSET UNITYSDK_OFFSET(0x1B052120)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_GETDATADUMP_OFFSET UNITYSDK_OFFSET(0x1B054110)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_MARKJUSTSTARTED_OFFSET UNITYSDK_OFFSET(0x1B052110)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_PREPARENEWSERIALIZATIONSESSION_OFFSET UNITYSDK_OFFSET(0x1B054080)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_STARTNEWLINE_OFFSET UNITYSDK_OFFSET(0x1B052AB0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1B052FB0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEBYTE_OFFSET UNITYSDK_OFFSET(0x1B052FE0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITECHAR_OFFSET UNITYSDK_OFFSET(0x1B0530A0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEDECIMAL_OFFSET UNITYSDK_OFFSET(0x1B0533A0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B053400)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEENTRY_1_OFFSET UNITYSDK_OFFSET(0x1B054310)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEENTRY_OFFSET UNITYSDK_OFFSET(0x1B052260)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEEXTERNALREFERENCE_1_OFFSET UNITYSDK_OFFSET(0x1B053F10)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEEXTERNALREFERENCE_2_OFFSET UNITYSDK_OFFSET(0x1B053F80)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEEXTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B053E90)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x1B053DF0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0x1B053550)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0x1B052500)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0x1B052EF0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEINTERNALREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B053470)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITENULL_OFFSET UNITYSDK_OFFSET(0x1B053460)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITESBYTE_OFFSET UNITYSDK_OFFSET(0x1B0534F0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITESINGLE_OFFSET UNITYSDK_OFFSET(0x1B0535B0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x1B053120)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITETYPEENTRY_OFFSET UNITYSDK_OFFSET(0x1B052560)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0x1B054010)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0x1B053E30)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0x1B053040)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B054760)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0513A0)
#define SIRENIX_SERIALIZATION_JSONDATAWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B051390)
...
namespace Sirenix::Serialization
{
	...
	public:
		...
		::System::Boolean justStarted; // 0x54
		::System::Boolean FormatAsReadable; // 0x55
		::System::Boolean EnableTypeOptimization; // 0x56
		::System::Boolean forceNoSeparatorNextLine; // 0x57
