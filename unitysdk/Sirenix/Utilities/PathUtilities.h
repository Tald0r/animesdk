...
#define SIRENIX_UTILITIES_PATHUTILITIES_CANMAKERELATIVE_OFFSET UNITYSDK_OFFSET(0x1AEC7E50)
#define SIRENIX_UTILITIES_PATHUTILITIES_COMBINE_OFFSET UNITYSDK_OFFSET(0x1AEC84E0)
#define SIRENIX_UTILITIES_PATHUTILITIES_FINDPARENTDIRECTORYWITHNAME_OFFSET UNITYSDK_OFFSET(0x1AEC7D40)
#define SIRENIX_UTILITIES_PATHUTILITIES_GETDIRECTORYNAME_OFFSET UNITYSDK_OFFSET(0x1AEC7A70)
#define SIRENIX_UTILITIES_PATHUTILITIES_HASSUBDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1AEC7AB0)
#define SIRENIX_UTILITIES_PATHUTILITIES_MAKERELATIVE_OFFSET UNITYSDK_OFFSET(0x1AEC8020)
#define SIRENIX_UTILITIES_PATHUTILITIES_TRYMAKERELATIVE_OFFSET UNITYSDK_OFFSET(0x1AEC84A0)
