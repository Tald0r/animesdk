...
#define SIRENIX_UTILITIES_SIRENIXBUILDNAMEATTRIBUTE_GET_BUILDNAME_OFFSET UNITYSDK_OFFSET(0x1A8F1D10)
#define SIRENIX_UTILITIES_SIRENIXBUILDNAMEATTRIBUTE_SET_BUILDNAME_OFFSET UNITYSDK_OFFSET(0x1A8F1D20)
#define SIRENIX_UTILITIES_SIRENIXBUILDNAMEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8F1D30)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int SirenixBuildNameAttribute_TypeDefinitionIndex = 6460;
