...
#define SIRENIX_UTILITIES_SIRENIXBUILDNAMEATTRIBUTE_GET_BUILDNAME_OFFSET UNITYSDK_OFFSET(0x1AECB0C0)
#define SIRENIX_UTILITIES_SIRENIXBUILDNAMEATTRIBUTE_SET_BUILDNAME_OFFSET UNITYSDK_OFFSET(0x1AECB0D0)
#define SIRENIX_UTILITIES_SIRENIXBUILDNAMEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECB0E0)
