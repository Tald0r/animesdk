...
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_ASSETPATHWITHASSETSPREFIX_OFFSET UNITYSDK_OFFSET(0x1AEC42A0)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_ASSETPATHWITHOUTASSETSPREFIX_OFFSET UNITYSDK_OFFSET(0x1AEC42F0)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x1AEC4150)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_FULLPATH_OFFSET UNITYSDK_OFFSET(0x1AEC4110)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_ISINRESOURCESFOLDER_OFFSET UNITYSDK_OFFSET(0x1AEC4400)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_RESOURCESPATH_OFFSET UNITYSDK_OFFSET(0x1AEC4350)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_USEASSET_OFFSET UNITYSDK_OFFSET(0x1AEC4440)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_SET_USEASSET_OFFSET UNITYSDK_OFFSET(0x1AEC4450)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEC44D0)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEC4490)
