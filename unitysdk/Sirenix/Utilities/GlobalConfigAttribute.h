...
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_ASSETPATHWITHASSETSPREFIX_OFFSET UNITYSDK_OFFSET(0x1A8EAED0)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_ASSETPATHWITHOUTASSETSPREFIX_OFFSET UNITYSDK_OFFSET(0x1A8EAF20)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x1A8EAD80)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_FULLPATH_OFFSET UNITYSDK_OFFSET(0x1A8EAD40)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_ISINRESOURCESFOLDER_OFFSET UNITYSDK_OFFSET(0x1A8EB030)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_RESOURCESPATH_OFFSET UNITYSDK_OFFSET(0x1A8EAF80)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_GET_USEASSET_OFFSET UNITYSDK_OFFSET(0x1A8EB070)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE_SET_USEASSET_OFFSET UNITYSDK_OFFSET(0x1A8EB080)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8EB100)
#define SIRENIX_UTILITIES_GLOBALCONFIGATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8EB0C0)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int GlobalConfigAttribute_TypeDefinitionIndex = 6441;
