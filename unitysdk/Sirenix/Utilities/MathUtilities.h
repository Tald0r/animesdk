...
#define SIRENIX_UTILITIES_MATHUTILITIES_ABS_OFFSET UNITYSDK_OFFSET(0x1A8ECA30)
#define SIRENIX_UTILITIES_MATHUTILITIES_BOUNCEEASEINFASTOUT_OFFSET UNITYSDK_OFFSET(0x1A8EC690)
#define SIRENIX_UTILITIES_MATHUTILITIES_BOUNCE_OFFSET UNITYSDK_OFFSET(0x1A8EC860)
#define SIRENIX_UTILITIES_MATHUTILITIES_CLAMPWRAPANGLE_OFFSET UNITYSDK_OFFSET(0x1A8EDAD0)
#define SIRENIX_UTILITIES_MATHUTILITIES_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x1A8ECCD0)
#define SIRENIX_UTILITIES_MATHUTILITIES_CLAMP_OFFSET UNITYSDK_OFFSET(0x1A8ECC50)
#define SIRENIX_UTILITIES_MATHUTILITIES_COMPUTEBYTEARRAYHASH_OFFSET UNITYSDK_OFFSET(0x1A8ECD30)
#define SIRENIX_UTILITIES_MATHUTILITIES_DISCARDLEASTSIGNIFICANTDECIMAL_OFFSET UNITYSDK_OFFSET(0x1A8ED970)
#define SIRENIX_UTILITIES_MATHUTILITIES_EASEINELASTIC_OFFSET UNITYSDK_OFFSET(0x1A8EC890)
#define SIRENIX_UTILITIES_MATHUTILITIES_EASEINOUT_OFFSET UNITYSDK_OFFSET(0x1A8ECBF0)
#define SIRENIX_UTILITIES_MATHUTILITIES_EASEOUTELASTIC_OFFSET UNITYSDK_OFFSET(0x1A8ECAB0)
#define SIRENIX_UTILITIES_MATHUTILITIES_FRACT_1_OFFSET UNITYSDK_OFFSET(0x1A8EC540)
#define SIRENIX_UTILITIES_MATHUTILITIES_FRACT_2_OFFSET UNITYSDK_OFFSET(0x1A8EC5D0)
#define SIRENIX_UTILITIES_MATHUTILITIES_FRACT_OFFSET UNITYSDK_OFFSET(0x1A8EC500)
#define SIRENIX_UTILITIES_MATHUTILITIES_GETNUMBEROFDECIMALSFORMINIMUMDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1A8EDA90)
#define SIRENIX_UTILITIES_MATHUTILITIES_HERMITE01_OFFSET UNITYSDK_OFFSET(0x1A8EC6D0)
#define SIRENIX_UTILITIES_MATHUTILITIES_HERMITE_OFFSET UNITYSDK_OFFSET(0x1A8EC3C0)
#define SIRENIX_UTILITIES_MATHUTILITIES_INFINITELINEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1A8ED2D0)
#define SIRENIX_UTILITIES_MATHUTILITIES_INTERPOLATEPOINTS_OFFSET UNITYSDK_OFFSET(0x1A8ECE20)
#define SIRENIX_UTILITIES_MATHUTILITIES_LERPUNCLAMPED_1_OFFSET UNITYSDK_OFFSET(0x1A8EC820)
#define SIRENIX_UTILITIES_MATHUTILITIES_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1A8EC7E0)
#define SIRENIX_UTILITIES_MATHUTILITIES_LINEARSTEP_OFFSET UNITYSDK_OFFSET(0x1A8ED650)
#define SIRENIX_UTILITIES_MATHUTILITIES_LINEDISTTOPLANE_OFFSET UNITYSDK_OFFSET(0x1A8ED3F0)
#define SIRENIX_UTILITIES_MATHUTILITIES_LINEINTERSECTSLINE_OFFSET UNITYSDK_OFFSET(0x1A8ED140)
#define SIRENIX_UTILITIES_MATHUTILITIES_POINTDISTANCETOLINE_OFFSET UNITYSDK_OFFSET(0x1A8EC350)
#define SIRENIX_UTILITIES_MATHUTILITIES_POW_OFFSET UNITYSDK_OFFSET(0x1A8EC9C0)
#define SIRENIX_UTILITIES_MATHUTILITIES_RAYDISTTOPLANE_OFFSET UNITYSDK_OFFSET(0x1A8ED480)
#define SIRENIX_UTILITIES_MATHUTILITIES_ROTATEPOINT_1_OFFSET UNITYSDK_OFFSET(0x1A8ED570)
#define SIRENIX_UTILITIES_MATHUTILITIES_ROTATEPOINT_OFFSET UNITYSDK_OFFSET(0x1A8ED4F0)
#define SIRENIX_UTILITIES_MATHUTILITIES_ROUNDBASEDONMINIMUMDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1A8ED7E0)
#define SIRENIX_UTILITIES_MATHUTILITIES_SIGN_OFFSET UNITYSDK_OFFSET(0x1A8ECA60)
#define SIRENIX_UTILITIES_MATHUTILITIES_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x1A8ED610)
#define SIRENIX_UTILITIES_MATHUTILITIES_STACKHERMITE01_OFFSET UNITYSDK_OFFSET(0x1A8EC710)
#define SIRENIX_UTILITIES_MATHUTILITIES_STACKHERMITE_OFFSET UNITYSDK_OFFSET(0x1A8EC400)
#define SIRENIX_UTILITIES_MATHUTILITIES_WRAP_1_OFFSET UNITYSDK_OFFSET(0x1A8ED710)
#define SIRENIX_UTILITIES_MATHUTILITIES_WRAP_2_OFFSET UNITYSDK_OFFSET(0x1A8ED790)
#define SIRENIX_UTILITIES_MATHUTILITIES_WRAP_OFFSET UNITYSDK_OFFSET(0x1A8ED680)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int MathUtilities_TypeDefinitionIndex = 6449;
