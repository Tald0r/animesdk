...
#define SIRENIX_UTILITIES_MATHUTILITIES_ABS_OFFSET UNITYSDK_OFFSET(0x1AEC5E00)
#define SIRENIX_UTILITIES_MATHUTILITIES_BOUNCEEASEINFASTOUT_OFFSET UNITYSDK_OFFSET(0x1AEC5A60)
#define SIRENIX_UTILITIES_MATHUTILITIES_BOUNCE_OFFSET UNITYSDK_OFFSET(0x1AEC5C30)
#define SIRENIX_UTILITIES_MATHUTILITIES_CLAMPWRAPANGLE_OFFSET UNITYSDK_OFFSET(0x1AEC6EA0)
#define SIRENIX_UTILITIES_MATHUTILITIES_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x1AEC60A0)
#define SIRENIX_UTILITIES_MATHUTILITIES_CLAMP_OFFSET UNITYSDK_OFFSET(0x1AEC6020)
#define SIRENIX_UTILITIES_MATHUTILITIES_COMPUTEBYTEARRAYHASH_OFFSET UNITYSDK_OFFSET(0x1AEC6100)
#define SIRENIX_UTILITIES_MATHUTILITIES_DISCARDLEASTSIGNIFICANTDECIMAL_OFFSET UNITYSDK_OFFSET(0x1AEC6D40)
#define SIRENIX_UTILITIES_MATHUTILITIES_EASEINELASTIC_OFFSET UNITYSDK_OFFSET(0x1AEC5C60)
#define SIRENIX_UTILITIES_MATHUTILITIES_EASEINOUT_OFFSET UNITYSDK_OFFSET(0x1AEC5FC0)
#define SIRENIX_UTILITIES_MATHUTILITIES_EASEOUTELASTIC_OFFSET UNITYSDK_OFFSET(0x1AEC5E80)
#define SIRENIX_UTILITIES_MATHUTILITIES_FRACT_1_OFFSET UNITYSDK_OFFSET(0x1AEC5910)
#define SIRENIX_UTILITIES_MATHUTILITIES_FRACT_2_OFFSET UNITYSDK_OFFSET(0x1AEC59A0)
#define SIRENIX_UTILITIES_MATHUTILITIES_FRACT_OFFSET UNITYSDK_OFFSET(0x1AEC58D0)
#define SIRENIX_UTILITIES_MATHUTILITIES_GETNUMBEROFDECIMALSFORMINIMUMDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1AEC6E60)
#define SIRENIX_UTILITIES_MATHUTILITIES_HERMITE01_OFFSET UNITYSDK_OFFSET(0x1AEC5AA0)
#define SIRENIX_UTILITIES_MATHUTILITIES_HERMITE_OFFSET UNITYSDK_OFFSET(0x1AEC5790)
#define SIRENIX_UTILITIES_MATHUTILITIES_INFINITELINEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1AEC66A0)
#define SIRENIX_UTILITIES_MATHUTILITIES_INTERPOLATEPOINTS_OFFSET UNITYSDK_OFFSET(0x1AEC61F0)
#define SIRENIX_UTILITIES_MATHUTILITIES_LERPUNCLAMPED_1_OFFSET UNITYSDK_OFFSET(0x1AEC5BF0)
#define SIRENIX_UTILITIES_MATHUTILITIES_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1AEC5BB0)
#define SIRENIX_UTILITIES_MATHUTILITIES_LINEARSTEP_OFFSET UNITYSDK_OFFSET(0x1AEC6A20)
#define SIRENIX_UTILITIES_MATHUTILITIES_LINEDISTTOPLANE_OFFSET UNITYSDK_OFFSET(0x1AEC67C0)
#define SIRENIX_UTILITIES_MATHUTILITIES_LINEINTERSECTSLINE_OFFSET UNITYSDK_OFFSET(0x1AEC6510)
#define SIRENIX_UTILITIES_MATHUTILITIES_POINTDISTANCETOLINE_OFFSET UNITYSDK_OFFSET(0x1AEC5720)
#define SIRENIX_UTILITIES_MATHUTILITIES_POW_OFFSET UNITYSDK_OFFSET(0x1AEC5D90)
#define SIRENIX_UTILITIES_MATHUTILITIES_RAYDISTTOPLANE_OFFSET UNITYSDK_OFFSET(0x1AEC6850)
#define SIRENIX_UTILITIES_MATHUTILITIES_ROTATEPOINT_1_OFFSET UNITYSDK_OFFSET(0x1AEC6940)
#define SIRENIX_UTILITIES_MATHUTILITIES_ROTATEPOINT_OFFSET UNITYSDK_OFFSET(0x1AEC68C0)
#define SIRENIX_UTILITIES_MATHUTILITIES_ROUNDBASEDONMINIMUMDIFFERENCE_OFFSET UNITYSDK_OFFSET(0x1AEC6BB0)
#define SIRENIX_UTILITIES_MATHUTILITIES_SIGN_OFFSET UNITYSDK_OFFSET(0x1AEC5E30)
#define SIRENIX_UTILITIES_MATHUTILITIES_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x1AEC69E0)
#define SIRENIX_UTILITIES_MATHUTILITIES_STACKHERMITE01_OFFSET UNITYSDK_OFFSET(0x1AEC5AE0)
#define SIRENIX_UTILITIES_MATHUTILITIES_STACKHERMITE_OFFSET UNITYSDK_OFFSET(0x1AEC57D0)
#define SIRENIX_UTILITIES_MATHUTILITIES_WRAP_1_OFFSET UNITYSDK_OFFSET(0x1AEC6AE0)
#define SIRENIX_UTILITIES_MATHUTILITIES_WRAP_2_OFFSET UNITYSDK_OFFSET(0x1AEC6B60)
#define SIRENIX_UTILITIES_MATHUTILITIES_WRAP_OFFSET UNITYSDK_OFFSET(0x1AEC6A50)
