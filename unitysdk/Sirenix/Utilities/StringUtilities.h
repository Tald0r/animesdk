...
#define SIRENIX_UTILITIES_STRINGUTILITIES_FASTENDSWITH_OFFSET UNITYSDK_OFFSET(0x1AECB860)
#define SIRENIX_UTILITIES_STRINGUTILITIES_NICIFYBYTESIZE_OFFSET UNITYSDK_OFFSET(0x1AECB5B0)
#define SIRENIX_UTILITIES_STRINGUTILITIES_NUMBERAWARESTRINGCOMPARE_OFFSET UNITYSDK_OFFSET(0x1AECB940)
