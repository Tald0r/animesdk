...
#define SIRENIX_UTILITIES_STRINGUTILITIES_FASTENDSWITH_OFFSET UNITYSDK_OFFSET(0x1A8F24B0)
#define SIRENIX_UTILITIES_STRINGUTILITIES_NICIFYBYTESIZE_OFFSET UNITYSDK_OFFSET(0x1A8F2200)
#define SIRENIX_UTILITIES_STRINGUTILITIES_NUMBERAWARESTRINGCOMPARE_OFFSET UNITYSDK_OFFSET(0x1A8F2590)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int StringUtilities_TypeDefinitionIndex = 6464;
