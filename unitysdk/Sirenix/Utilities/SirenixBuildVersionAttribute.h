...
#define SIRENIX_UTILITIES_SIRENIXBUILDVERSIONATTRIBUTE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1A8F1D40)
#define SIRENIX_UTILITIES_SIRENIXBUILDVERSIONATTRIBUTE_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1A8F1D50)
#define SIRENIX_UTILITIES_SIRENIXBUILDVERSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8F1D60)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int SirenixBuildVersionAttribute_TypeDefinitionIndex = 6461;
