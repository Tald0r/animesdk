...
#define SIRENIX_UTILITIES_SIRENIXBUILDVERSIONATTRIBUTE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AECB0F0)
#define SIRENIX_UTILITIES_SIRENIXBUILDVERSIONATTRIBUTE_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AECB100)
#define SIRENIX_UTILITIES_SIRENIXBUILDVERSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECB110)
