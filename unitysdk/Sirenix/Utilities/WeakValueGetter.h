...
#define SIRENIX_UTILITIES_WEAKVALUEGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AECD600)
#define SIRENIX_UTILITIES_WEAKVALUEGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AECD630)
#define SIRENIX_UTILITIES_WEAKVALUEGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AECD2C0)
#define SIRENIX_UTILITIES_WEAKVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECD2A0)
