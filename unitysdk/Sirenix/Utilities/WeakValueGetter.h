...
#define SIRENIX_UTILITIES_WEAKVALUEGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A8F4230)
#define SIRENIX_UTILITIES_WEAKVALUEGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A8F4260)
#define SIRENIX_UTILITIES_WEAKVALUEGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A8F3F00)
#define SIRENIX_UTILITIES_WEAKVALUEGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8F3EF0)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int WeakValueGetter_TypeDefinitionIndex = 6430;
