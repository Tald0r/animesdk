...
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ADDMAX_OFFSET UNITYSDK_OFFSET(0x1A8EFFA0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ADDMIN_OFFSET UNITYSDK_OFFSET(0x1A8EFEE0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ADDPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1A8EFDF0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ADDPOSITION_OFFSET UNITYSDK_OFFSET(0x1A8EFDD0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ADDXMAX_OFFSET UNITYSDK_OFFSET(0x1A8F00A0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ADDXMIN_OFFSET UNITYSDK_OFFSET(0x1A8F0020)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ADDX_OFFSET UNITYSDK_OFFSET(0x1A8EFE20)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ADDYMAX_OFFSET UNITYSDK_OFFSET(0x1A8F01B0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ADDYMIN_OFFSET UNITYSDK_OFFSET(0x1A8F0130)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ADDY_OFFSET UNITYSDK_OFFSET(0x1A8EFE70)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ALIGNBOTTOM_OFFSET UNITYSDK_OFFSET(0x1A8EF6E0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ALIGNCENTERXY_1_OFFSET UNITYSDK_OFFSET(0x1A8EFAB0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ALIGNCENTERXY_OFFSET UNITYSDK_OFFSET(0x1A8EFA70)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ALIGNCENTERX_OFFSET UNITYSDK_OFFSET(0x1A8EFA00)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ALIGNCENTERY_OFFSET UNITYSDK_OFFSET(0x1A8EFA30)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ALIGNCENTER_1_OFFSET UNITYSDK_OFFSET(0x1A8EF910)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ALIGNCENTER_OFFSET UNITYSDK_OFFSET(0x1A8EF8E0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ALIGNLEFT_OFFSET UNITYSDK_OFFSET(0x1A8EF8D0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ALIGNMIDDLE_OFFSET UNITYSDK_OFFSET(0x1A8EF9C0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ALIGNRIGHT_1_OFFSET UNITYSDK_OFFSET(0x1A8EF950)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ALIGNRIGHT_OFFSET UNITYSDK_OFFSET(0x1A8EF6C0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_ALIGNTOP_OFFSET UNITYSDK_OFFSET(0x1A8EF9B0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_EXPANDTO_OFFSET UNITYSDK_OFFSET(0x1A8F0290)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_EXPAND_1_OFFSET UNITYSDK_OFFSET(0x1A8EFB20)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_EXPAND_2_OFFSET UNITYSDK_OFFSET(0x1A8EFB50)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_EXPAND_OFFSET UNITYSDK_OFFSET(0x1A8EFAF0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_HORIZONTALPADDING_1_OFFSET UNITYSDK_OFFSET(0x1A8EF7A0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_HORIZONTALPADDING_OFFSET UNITYSDK_OFFSET(0x1A8EF770)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_MAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A8F0270)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_MAXWIDTH_OFFSET UNITYSDK_OFFSET(0x1A8F0230)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A8F0250)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x1A8F0210)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_PADDING_1_OFFSET UNITYSDK_OFFSET(0x1A8EF860)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_PADDING_2_OFFSET UNITYSDK_OFFSET(0x1A8EF890)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_PADDING_OFFSET UNITYSDK_OFFSET(0x1A8EF830)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_RESETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A8EFDB0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETCENTERX_OFFSET UNITYSDK_OFFSET(0x1A8EFCE0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETCENTERY_OFFSET UNITYSDK_OFFSET(0x1A8EFD10)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETCENTER_1_OFFSET UNITYSDK_OFFSET(0x1A8EFD60)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETCENTER_OFFSET UNITYSDK_OFFSET(0x1A8EFD40)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A8EF720)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETMAX_OFFSET UNITYSDK_OFFSET(0x1A8EFF80)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETMIN_OFFSET UNITYSDK_OFFSET(0x1A8EFEB0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A8EFD90)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETSIZE_1_OFFSET UNITYSDK_OFFSET(0x1A8EF750)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETSIZE_OFFSET UNITYSDK_OFFSET(0x1A8EF730)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETWIDTH_OFFSET UNITYSDK_OFFSET(0x1A8EF710)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETXMAX_OFFSET UNITYSDK_OFFSET(0x1A8F0080)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETXMIN_OFFSET UNITYSDK_OFFSET(0x1A8F0000)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETX_OFFSET UNITYSDK_OFFSET(0x1A8EFE10)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETYMAX_OFFSET UNITYSDK_OFFSET(0x1A8F0190)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETYMIN_OFFSET UNITYSDK_OFFSET(0x1A8F0100)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SETY_OFFSET UNITYSDK_OFFSET(0x1A8EFE60)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SPLITGRID_OFFSET UNITYSDK_OFFSET(0x1A8EFC10)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SPLITTABLEGRID_OFFSET UNITYSDK_OFFSET(0x1A8EFC80)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SPLITVERTICAL_OFFSET UNITYSDK_OFFSET(0x1A8EFBD0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SPLIT_OFFSET UNITYSDK_OFFSET(0x1A8EFB90)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SUBMAX_OFFSET UNITYSDK_OFFSET(0x1A8EFFD0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SUBMIN_OFFSET UNITYSDK_OFFSET(0x1A8EFF20)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SUBXMAX_OFFSET UNITYSDK_OFFSET(0x1A8F00D0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SUBXMIN_OFFSET UNITYSDK_OFFSET(0x1A8F0050)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SUBX_OFFSET UNITYSDK_OFFSET(0x1A8EFE40)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SUBYMAX_OFFSET UNITYSDK_OFFSET(0x1A8F01E0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SUBYMIN_OFFSET UNITYSDK_OFFSET(0x1A8F0160)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_SUBY_OFFSET UNITYSDK_OFFSET(0x1A8EFE90)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_TAKEFROMBOTTOM_OFFSET UNITYSDK_OFFSET(0x1A8EF650)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_TAKEFROMDIR_OFFSET UNITYSDK_OFFSET(0x1A8EF270)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_TAKEFROMLEFT_OFFSET UNITYSDK_OFFSET(0x1A8EF4F0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_TAKEFROMRIGHT_OFFSET UNITYSDK_OFFSET(0x1A8EF560)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_TAKEFROMTOP_OFFSET UNITYSDK_OFFSET(0x1A8EF5D0)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_VERTICALPADDING_1_OFFSET UNITYSDK_OFFSET(0x1A8EF800)
#define SIRENIX_UTILITIES_RECTEXTENSIONS_VERTICALPADDING_OFFSET UNITYSDK_OFFSET(0x1A8EF7D0)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int RectExtensions_TypeDefinitionIndex = 6425;
