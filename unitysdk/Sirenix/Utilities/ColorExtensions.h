...
#define SIRENIX_UTILITIES_COLOREXTENSIONS_LERP_OFFSET UNITYSDK_OFFSET(0x1AEC2230)
#define SIRENIX_UTILITIES_COLOREXTENSIONS_MOVETOWARDS_OFFSET UNITYSDK_OFFSET(0x1AEC2300)
#define SIRENIX_UTILITIES_COLOREXTENSIONS_NORMALIZERGB_OFFSET UNITYSDK_OFFSET(0x1AEC2AF0)
#define SIRENIX_UTILITIES_COLOREXTENSIONS_POW_OFFSET UNITYSDK_OFFSET(0x1AEC2A80)
#define SIRENIX_UTILITIES_COLOREXTENSIONS_TOCSHARPCOLOR_OFFSET UNITYSDK_OFFSET(0x1AEC27A0)
#define SIRENIX_UTILITIES_COLOREXTENSIONS_TRIMFLOAT_OFFSET UNITYSDK_OFFSET(0x1AEC2980)
#define SIRENIX_UTILITIES_COLOREXTENSIONS_TRYPARSESTRING_OFFSET UNITYSDK_OFFSET(0x1AEC2350)
#define SIRENIX_UTILITIES_COLOREXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEC2B90)
