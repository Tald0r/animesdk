...
#define SIRENIX_UTILITIES_UNSAFE_UNSAFEUTILITIES_MEMORYCOPY_OFFSET UNITYSDK_OFFSET(0x1A8F3BE0)
#define SIRENIX_UTILITIES_UNSAFE_UNSAFEUTILITIES_STRINGFROMBYTES_OFFSET UNITYSDK_OFFSET(0x1A8F3210)
#define SIRENIX_UTILITIES_UNSAFE_UNSAFEUTILITIES_STRINGTOBYTES_OFFSET UNITYSDK_OFFSET(0x1A8F36F0)

namespace Sirenix::Utilities::Unsafe
{
	inline static constexpr unsigned int UnsafeUtilities_TypeDefinitionIndex = 6466;
