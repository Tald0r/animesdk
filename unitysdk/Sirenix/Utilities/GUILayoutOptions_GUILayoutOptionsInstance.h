...
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_CLONE_OFFSET UNITYSDK_OFFSET(0x1A8EA190)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_CREATEOPTIONSARARY_OFFSET UNITYSDK_OFFSET(0x1A8EA250)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A8EAC90)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_EXPANDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A8EAB10)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_EXPANDWIDTH_OFFSET UNITYSDK_OFFSET(0x1A8EABD0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_GETCACHEDOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A8E9FE0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A8EACD0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1A8EA7A0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_MAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A8EA850)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_MAXWIDTH_OFFSET UNITYSDK_OFFSET(0x1A8EA900)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A8EA9B0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x1A8EAA60)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A8EA6D0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_SETVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A8E9F00)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A8E9AC0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_WIDTH_OFFSET UNITYSDK_OFFSET(0x1A8EA6F0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8E9A00)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int GUILayoutOptions_GUILayoutOptionsInstance_TypeDefinitionIndex = 6439;
