...
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_CLONE_OFFSET UNITYSDK_OFFSET(0x1AEC3560)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_CREATEOPTIONSARARY_OFFSET UNITYSDK_OFFSET(0x1AEC3620)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AEC4060)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_EXPANDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1AEC3EE0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_EXPANDWIDTH_OFFSET UNITYSDK_OFFSET(0x1AEC3FA0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_GETCACHEDOPTIONS_OFFSET UNITYSDK_OFFSET(0x1AEC33C0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AEC40A0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1AEC3B70)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_MAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x1AEC3C20)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_MAXWIDTH_OFFSET UNITYSDK_OFFSET(0x1AEC3CD0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1AEC3D80)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x1AEC3E30)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AEC3AA0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_SETVALUE_1_OFFSET UNITYSDK_OFFSET(0x1AEC32E0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1AEC2EA0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE_WIDTH_OFFSET UNITYSDK_OFFSET(0x1AEC3AC0)
#define SIRENIX_UTILITIES_GUILAYOUTOPTIONS_GUILAYOUTOPTIONSINSTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEC2DE0)
