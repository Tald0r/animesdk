...
#define SIRENIX_UTILITIES_UNITYVERSION_ENSURELOADED_OFFSET UNITYSDK_OFFSET(0x1A8F3170)
#define SIRENIX_UTILITIES_UNITYVERSION_ISVERSIONORGREATER_OFFSET UNITYSDK_OFFSET(0x1A8F3180)
#define SIRENIX_UTILITIES_UNITYVERSION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8F2D70)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int UnityVersion_TypeDefinitionIndex = 6465;
