...
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GETBASEDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A8EE110)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GETCUSTOMATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1A8EE170)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GETCUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A8EE140)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GETMETHODIMPLEMENTATIONFLAGS_OFFSET UNITYSDK_OFFSET(0x1A8EE1A0)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GETPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A8EE1D0)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GET_ALIASEDMETHOD_OFFSET UNITYSDK_OFFSET(0x1A8EDFD0)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A8EE040)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GET_DECLARINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A8EE0A0)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GET_METHODHANDLE_OFFSET UNITYSDK_OFFSET(0x1A8EE010)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A8EE0D0)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A8EE0E0)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GET_RETURNTYPECUSTOMATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A8EDFE0)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1A8EE070)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A8EE200)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1A8EE240)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A8EDF80)
#define SIRENIX_UTILITIES_MEMBERALIASMETHODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8EDF30)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int MemberAliasMethodInfo_TypeDefinitionIndex = 6451;
