...
#define SIRENIX_UTILITIES_STRINGEXTENSIONS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1AEC4460)
#define SIRENIX_UTILITIES_STRINGEXTENSIONS_ISNULLORWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1AECB530)
#define SIRENIX_UTILITIES_STRINGEXTENSIONS_SPLITPASCALCASE_OFFSET UNITYSDK_OFFSET(0x1AECB330)
#define SIRENIX_UTILITIES_STRINGEXTENSIONS_TOTITLECASE_OFFSET UNITYSDK_OFFSET(0x1AECB1A0)
