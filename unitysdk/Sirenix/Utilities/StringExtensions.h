...
#define SIRENIX_UTILITIES_STRINGEXTENSIONS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A8EB090)
#define SIRENIX_UTILITIES_STRINGEXTENSIONS_ISNULLORWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A8F2180)
#define SIRENIX_UTILITIES_STRINGEXTENSIONS_SPLITPASCALCASE_OFFSET UNITYSDK_OFFSET(0x1A8F1F80)
#define SIRENIX_UTILITIES_STRINGEXTENSIONS_TOTITLECASE_OFFSET UNITYSDK_OFFSET(0x1A8F1DF0)

namespace Sirenix::Utilities
{
	inline static constexpr unsigned int StringExtensions_TypeDefinitionIndex = 6426;
