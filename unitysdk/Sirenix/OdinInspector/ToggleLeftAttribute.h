...
#define SIRENIX_ODININSPECTOR_TOGGLELEFTATTRIBUTE_GET_EXPANDCLICKABLEAREA_OFFSET UNITYSDK_OFFSET(0x1B116D20)
#define SIRENIX_ODININSPECTOR_TOGGLELEFTATTRIBUTE_SET_EXPANDCLICKABLEAREA_OFFSET UNITYSDK_OFFSET(0x1B116D30)
#define SIRENIX_ODININSPECTOR_TOGGLELEFTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B116D40)
