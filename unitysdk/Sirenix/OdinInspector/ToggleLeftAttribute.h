...
#define SIRENIX_ODININSPECTOR_TOGGLELEFTATTRIBUTE_GET_EXPANDCLICKABLEAREA_OFFSET UNITYSDK_OFFSET(0x1AB0ABF0)
#define SIRENIX_ODININSPECTOR_TOGGLELEFTATTRIBUTE_SET_EXPANDCLICKABLEAREA_OFFSET UNITYSDK_OFFSET(0x1AB0AC00)
#define SIRENIX_ODININSPECTOR_TOGGLELEFTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0AC10)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int ToggleLeftAttribute_TypeDefinitionIndex = 7237;
