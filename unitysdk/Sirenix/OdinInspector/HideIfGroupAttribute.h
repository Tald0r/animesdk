...
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1B114970)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_GET_ANIMATE_OFFSET UNITYSDK_OFFSET(0x1B114790)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1B1147D0)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1B1147B0)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_SET_ANIMATE_OFFSET UNITYSDK_OFFSET(0x1B1147A0)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1B114800)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE_SET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1B1147F0)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1148F0)
#define SIRENIX_ODININSPECTOR_HIDEIFGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B114810)
