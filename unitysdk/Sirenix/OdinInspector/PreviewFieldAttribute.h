...
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE_GET_ALIGNMENTHASVALUE_OFFSET UNITYSDK_OFFSET(0x1AB092F0)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE_GET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1AB092D0)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE_SET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1AB092E0)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB09310)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB09320)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AB09330)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB09300)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int PreviewFieldAttribute_TypeDefinitionIndex = 7202;
