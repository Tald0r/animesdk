...
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE_GET_ALIGNMENTHASVALUE_OFFSET UNITYSDK_OFFSET(0x1B115410)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE_GET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1B1153F0)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE_SET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1B115400)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B115430)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B115440)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B115450)
#define SIRENIX_ODININSPECTOR_PREVIEWFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B115420)
...
namespace Sirenix::OdinInspector
{
	...
	public:
		...
		::Sirenix::OdinInspector::ObjectFieldAlignment alignment; // 0x14
