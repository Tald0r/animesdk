...
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPNAPATTRIBUTE_GET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1AA3B4A0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPNAPATTRIBUTE_SET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1AA3B4B0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPNAPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA3B490)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPNAPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA3B480)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int FoldoutGroupNapAttribute_TypeDefinitionIndex = 7995;
