...
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPNAPATTRIBUTE_GET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1A48DE70)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPNAPATTRIBUTE_SET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1A48DE80)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPNAPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A48DE60)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPNAPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A48DE50)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int FoldoutGroupNapAttribute_TypeDefinitionIndex = 7873;
