...
#define SIRENIX_ODININSPECTOR_CUSTOMVALUEDRAWERATTRIBUTE_GET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1B114210)
#define SIRENIX_ODININSPECTOR_CUSTOMVALUEDRAWERATTRIBUTE_SET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1B114220)
#define SIRENIX_ODININSPECTOR_CUSTOMVALUEDRAWERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B114230)
