...
#define SIRENIX_ODININSPECTOR_GRADIENTDRAWERSETTINGATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F134D0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int GradientDrawerSettingAttribute_TypeDefinitionIndex = 8094;

	class GradientDrawerSettingAttribute : public ::System::Attribute
	{
	public:
		::System::String* BefText; // 0x10
