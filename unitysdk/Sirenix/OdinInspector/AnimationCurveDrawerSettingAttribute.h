...
#define SIRENIX_ODININSPECTOR_ANIMATIONCURVEDRAWERSETTINGATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0FAD10)
#define SIRENIX_ODININSPECTOR_ANIMATIONCURVEDRAWERSETTINGATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0FACC0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int AnimationCurveDrawerSettingAttribute_TypeDefinitionIndex = 8165;
	...
	public:
		...
		::System::Single ValueAxisMaxVal; // 0x30
		::System::Single ValueAxisMinVal; // 0x34
		::System::Single TimeAxisMinVal; // 0x38
		::System::Boolean ValueAxisIsInf; // 0x3C
		::System::Boolean TimeAxisIsInf; // 0x3D
