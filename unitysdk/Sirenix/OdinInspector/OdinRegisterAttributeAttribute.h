...
#define SIRENIX_ODININSPECTOR_ODINREGISTERATTRIBUTEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1152E0)
#define SIRENIX_ODININSPECTOR_ODINREGISTERATTRIBUTEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1152C0)
...
namespace Sirenix::OdinInspector
{
	...
	{
	public:
		::System::String* Categories; // 0x10
		::System::Type* AttributeType; // 0x18
		::System::String* Description; // 0x20
		::System::String* DocumentationUrl; // 0x28
