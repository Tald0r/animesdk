...
#define SIRENIX_ODININSPECTOR_ODINREGISTERATTRIBUTEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB091B0)
#define SIRENIX_ODININSPECTOR_ODINREGISTERATTRIBUTEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB09190)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int OdinRegisterAttributeAttribute_TypeDefinitionIndex = 7260;
