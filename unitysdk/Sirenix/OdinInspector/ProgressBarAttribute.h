...
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_GET_BACKGROUNDCOLORMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1154C0)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_GET_COLORMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1154A0)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x1B115680)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_GET_CUSTOMVALUESTRINGMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1154E0)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_GET_DRAWVALUELABELHASVALUE_OFFSET UNITYSDK_OFFSET(0x1B115620)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_GET_DRAWVALUELABEL_OFFSET UNITYSDK_OFFSET(0x1B115600)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_GET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1B115480)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_GET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1B115460)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_GET_VALUELABELALIGNMENTHASVALUE_OFFSET UNITYSDK_OFFSET(0x1B115660)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_GET_VALUELABELALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1B115640)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_SET_BACKGROUNDCOLORMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1154D0)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_SET_COLORMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1154B0)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_SET_CUSTOMVALUESTRINGMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1154F0)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_SET_DRAWVALUELABELHASVALUE_OFFSET UNITYSDK_OFFSET(0x1B115630)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_SET_DRAWVALUELABEL_OFFSET UNITYSDK_OFFSET(0x1B115610)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_SET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1B115490)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_SET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1B115470)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_SET_VALUELABELALIGNMENTHASVALUE_OFFSET UNITYSDK_OFFSET(0x1B115670)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE_SET_VALUELABELALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1B115650)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B115540)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B115580)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B1155C0)
#define SIRENIX_ODININSPECTOR_PROGRESSBARATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B115500)
...
namespace Sirenix::OdinInspector
{
	...
	{
	public:
		::System::String* CustomValueStringGetter; // 0x10
		::System::String* BackgroundColorGetter; // 0x18
		::System::String* ColorGetter; // 0x20
		::System::String* MaxGetter; // 0x28
		::System::String* MinGetter; // 0x30
		::System::Single B; // 0x38
		::System::Single G; // 0x3C
		::System::Double Min; // 0x40
		::System::Single R; // 0x48
		::UnityEngine::TextAlignment valueLabelAlignment; // 0x4C
		::System::Int32 Height; // 0x50
		::System::Boolean _DrawValueLabelHasValue_k__BackingField; // 0x54
		::System::Boolean drawValueLabel; // 0x55
		::System::Boolean _ValueLabelAlignmentHasValue_k__BackingField; // 0x56
