...
#define SIRENIX_ODININSPECTOR_TITLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0A790)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int TitleAttribute_TypeDefinitionIndex = 7233;
