...
#define SIRENIX_ODININSPECTOR_TITLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1168C0)
...
namespace Sirenix::OdinInspector
{
	...
	public:
		...
		::System::Boolean Bold; // 0x20
		::System::Boolean HorizontalLine; // 0x21
		::Sirenix::OdinInspector::TitleSizes TitleSize; // 0x24
		::Sirenix::OdinInspector::TitleAlignments TitleAlignment; // 0x28
