...
#define SIRENIX_ODININSPECTOR_CUSTOMCONTEXTMENUNAPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19393B30)
...
namespace Sirenix::OdinInspector
{
	...
	public:
		...
		::System::String* VisibleMethod; // 0x18
		::System::String* MenuItem; // 0x20
