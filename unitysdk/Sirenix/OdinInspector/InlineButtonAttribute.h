...
#define SIRENIX_ODININSPECTOR_INLINEBUTTONATTRIBUTE_GET_MEMBERMETHOD_OFFSET UNITYSDK_OFFSET(0x1AB08CF0)
#define SIRENIX_ODININSPECTOR_INLINEBUTTONATTRIBUTE_SET_MEMBERMETHOD_OFFSET UNITYSDK_OFFSET(0x1AB08D00)
#define SIRENIX_ODININSPECTOR_INLINEBUTTONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB08D10)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int InlineButtonAttribute_TypeDefinitionIndex = 7185;
