...
#define SIRENIX_ODININSPECTOR_VERTICALGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1AB0B200)
#define SIRENIX_ODININSPECTOR_VERTICALGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB0B160)
#define SIRENIX_ODININSPECTOR_VERTICALGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0B0F0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int VerticalGroupAttribute_TypeDefinitionIndex = 7248;
