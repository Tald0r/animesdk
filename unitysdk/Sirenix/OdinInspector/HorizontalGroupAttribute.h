...
#define SIRENIX_ODININSPECTOR_HORIZONTALGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1AB08BD0)
#define SIRENIX_ODININSPECTOR_HORIZONTALGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB08B00)
#define SIRENIX_ODININSPECTOR_HORIZONTALGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB08A50)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int HorizontalGroupAttribute_TypeDefinitionIndex = 7181;
	...
	public:
		...
		::System::Single MarginRight; // 0x3C
		::System::Single MaxWidth; // 0x40
		::System::Single LabelWidth; // 0x44
		::System::Single PaddingRight; // 0x48
		::System::Single MarginLeft; // 0x4C
		::System::Single MinWidth; // 0x50
