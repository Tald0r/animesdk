...
#define SIRENIX_ODININSPECTOR_DISABLEIFATTRIBUTE_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1B1142B0)
#define SIRENIX_ODININSPECTOR_DISABLEIFATTRIBUTE_SET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1B1142C0)
#define SIRENIX_ODININSPECTOR_DISABLEIFATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1142E0)
#define SIRENIX_ODININSPECTOR_DISABLEIFATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1142D0)
