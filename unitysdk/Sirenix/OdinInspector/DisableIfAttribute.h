...
#define SIRENIX_ODININSPECTOR_DISABLEIFATTRIBUTE_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1AB08230)
#define SIRENIX_ODININSPECTOR_DISABLEIFATTRIBUTE_SET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1AB08240)
#define SIRENIX_ODININSPECTOR_DISABLEIFATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB08260)
#define SIRENIX_ODININSPECTOR_DISABLEIFATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB08250)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int DisableIfAttribute_TypeDefinitionIndex = 7142;
