...
#define SIRENIX_ODININSPECTOR_TYPEFILTERATTRIBUTE_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1B1170D0)
#define SIRENIX_ODININSPECTOR_TYPEFILTERATTRIBUTE_SET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1B1170E0)
#define SIRENIX_ODININSPECTOR_TYPEFILTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1170F0)
