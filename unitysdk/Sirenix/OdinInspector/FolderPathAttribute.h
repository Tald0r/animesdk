...
#define SIRENIX_ODININSPECTOR_FOLDERPATHATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB08410)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int FolderPathAttribute_TypeDefinitionIndex = 7162;
