...
#define SIRENIX_ODININSPECTOR_INLINEBUTTONNAPATTRIBUTE_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x1A4AE070)
#define SIRENIX_ODININSPECTOR_INLINEBUTTONNAPATTRIBUTE_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0x1A4AE060)
#define SIRENIX_ODININSPECTOR_INLINEBUTTONNAPATTRIBUTE_GET_LABEL_OFFSET UNITYSDK_OFFSET(0x1A4AE080)
#define SIRENIX_ODININSPECTOR_INLINEBUTTONNAPATTRIBUTE_GET_SHOWIF_OFFSET UNITYSDK_OFFSET(0x1A4AE0C0)
#define SIRENIX_ODININSPECTOR_INLINEBUTTONNAPATTRIBUTE_GET_TOOLTIP_OFFSET UNITYSDK_OFFSET(0x1A4AE0A0)
#define SIRENIX_ODININSPECTOR_INLINEBUTTONNAPATTRIBUTE_SET_LABEL_OFFSET UNITYSDK_OFFSET(0x1A4AE090)
#define SIRENIX_ODININSPECTOR_INLINEBUTTONNAPATTRIBUTE_SET_SHOWIF_OFFSET UNITYSDK_OFFSET(0x1A4AE0D0)
#define SIRENIX_ODININSPECTOR_INLINEBUTTONNAPATTRIBUTE_SET_TOOLTIP_OFFSET UNITYSDK_OFFSET(0x1A4AE0B0)
#define SIRENIX_ODININSPECTOR_INLINEBUTTONNAPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4AE0F0)
#define SIRENIX_ODININSPECTOR_INLINEBUTTONNAPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4AE0E0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int InlineButtonNapAttribute_TypeDefinitionIndex = 7798;
