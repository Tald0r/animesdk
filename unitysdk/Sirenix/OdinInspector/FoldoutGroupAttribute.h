...
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1AB085F0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_DEFAULTEXPANDGETTER_OFFSET UNITYSDK_OFFSET(0x1AB08460)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_EXPANDED_OFFSET UNITYSDK_OFFSET(0x1AB08420)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1AB08440)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_ONEXPANDCHANGED_OFFSET UNITYSDK_OFFSET(0x1AB08470)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_SET_EXPANDED_OFFSET UNITYSDK_OFFSET(0x1AB08430)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_SET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1AB08450)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_SET_ONEXPANDCHANGED_OFFSET UNITYSDK_OFFSET(0x1AB08480)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB08500)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB08570)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB08490)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int FoldoutGroupAttribute_TypeDefinitionIndex = 7163;
	...
	public:
		...
		::System::Boolean _HasDefinedExpanded_k__BackingField; // 0x41
