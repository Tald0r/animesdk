...
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1B114670)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_DEFAULTEXPANDGETTER_OFFSET UNITYSDK_OFFSET(0x1B1144E0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_EXPANDED_OFFSET UNITYSDK_OFFSET(0x1B1144A0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1B1144C0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_GET_ONEXPANDCHANGED_OFFSET UNITYSDK_OFFSET(0x1B1144F0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_SET_EXPANDED_OFFSET UNITYSDK_OFFSET(0x1B1144B0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_SET_HASDEFINEDEXPANDED_OFFSET UNITYSDK_OFFSET(0x1B1144D0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE_SET_ONEXPANDCHANGED_OFFSET UNITYSDK_OFFSET(0x1B114500)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B114580)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B1145F0)
#define SIRENIX_ODININSPECTOR_FOLDOUTGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B114510)
