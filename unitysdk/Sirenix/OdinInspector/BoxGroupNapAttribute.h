...
#define SIRENIX_ODININSPECTOR_BOXGROUPNAPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ABBA190)
#define SIRENIX_ODININSPECTOR_BOXGROUPNAPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABB9BA0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int BoxGroupNapAttribute_TypeDefinitionIndex = 7753;
