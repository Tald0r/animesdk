...
#define SIRENIX_ODININSPECTOR_REQUIREDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB09880)
#define SIRENIX_ODININSPECTOR_REQUIREDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB09890)
#define SIRENIX_ODININSPECTOR_REQUIREDATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AB098A0)
#define SIRENIX_ODININSPECTOR_REQUIREDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB09870)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int RequiredAttribute_TypeDefinitionIndex = 7211;
