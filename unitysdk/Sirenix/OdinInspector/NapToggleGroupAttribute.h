...
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1ABBA3E0)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE_GET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1ABBA3C0)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE_GET_TOGGLEMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1ABBA3B0)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE_SET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1ABBA3D0)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ABBA2B0)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1ABBA330)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABBA230)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE___BASE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1ABBA4E0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int NapToggleGroupAttribute_TypeDefinitionIndex = 8111;
