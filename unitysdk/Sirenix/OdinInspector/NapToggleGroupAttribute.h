...
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1AEE72D0)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE_GET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1AEE72B0)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE_GET_TOGGLEMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1AEE72A0)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE_SET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1AEE72C0)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEE71A0)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AEE7220)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEE7120)
#define SIRENIX_ODININSPECTOR_NAPTOGGLEGROUPATTRIBUTE___BASE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1AEE73D0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int NapToggleGroupAttribute_TypeDefinitionIndex = 8136;
