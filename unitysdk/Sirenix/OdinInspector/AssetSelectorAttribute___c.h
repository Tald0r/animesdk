...
#define SIRENIX_ODININSPECTOR_ASSETSELECTORATTRIBUTE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B113C00)
#define SIRENIX_ODININSPECTOR_ASSETSELECTORATTRIBUTE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1B113C40)
#define SIRENIX_ODININSPECTOR_ASSETSELECTORATTRIBUTE___C__SET_PATHS_B__12_0_OFFSET UNITYSDK_OFFSET(0x1B113C50)
