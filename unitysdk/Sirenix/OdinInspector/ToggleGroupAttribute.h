...
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1B116C80)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_GET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1B116C60)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_GET_TOGGLEMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1B116C50)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_SET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1B116C70)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B116B50)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B116BD0)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B116AD0)
