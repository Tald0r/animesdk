...
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1AB0AB50)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_GET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1AB0AB30)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_GET_TOGGLEMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1AB0AB20)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE_SET_TITLESTRINGMEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1AB0AB40)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB0AA20)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB0AAA0)
#define SIRENIX_ODININSPECTOR_TOGGLEGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0A9A0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int ToggleGroupAttribute_TypeDefinitionIndex = 7236;
