...
#define SIRENIX_ODININSPECTOR_PROPERTYRANGEATTRIBUTE_GET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB097A0)
#define SIRENIX_ODININSPECTOR_PROPERTYRANGEATTRIBUTE_GET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB09780)
#define SIRENIX_ODININSPECTOR_PROPERTYRANGEATTRIBUTE_SET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB097B0)
#define SIRENIX_ODININSPECTOR_PROPERTYRANGEATTRIBUTE_SET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB09790)
#define SIRENIX_ODININSPECTOR_PROPERTYRANGEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB097F0)
#define SIRENIX_ODININSPECTOR_PROPERTYRANGEATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB09800)
#define SIRENIX_ODININSPECTOR_PROPERTYRANGEATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AB09810)
#define SIRENIX_ODININSPECTOR_PROPERTYRANGEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB097C0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int PropertyRangeAttribute_TypeDefinitionIndex = 7207;
