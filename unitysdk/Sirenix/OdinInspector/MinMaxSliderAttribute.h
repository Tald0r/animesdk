...
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_GET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB090D0)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_GET_MINMAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB090F0)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_GET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB090B0)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_SET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB090E0)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_SET_MINMAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB09100)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_SET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1AB090C0)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB09120)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB09130)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AB09140)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1AB09150)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB09110)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int MinMaxSliderAttribute_TypeDefinitionIndex = 7192;
