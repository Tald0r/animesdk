...
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_GET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1B115200)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_GET_MINMAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1B115220)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_GET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1151E0)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_SET_MAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1B115210)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_SET_MINMAXMEMBER_OFFSET UNITYSDK_OFFSET(0x1B115230)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE_SET_MINMEMBER_OFFSET UNITYSDK_OFFSET(0x1B1151F0)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B115250)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B115260)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B115270)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B115280)
#define SIRENIX_ODININSPECTOR_MINMAXSLIDERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B115240)
