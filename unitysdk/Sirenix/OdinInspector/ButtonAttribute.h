...
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE_GET_DRAWRESULTISSET_OFFSET UNITYSDK_OFFSET(0x1B113F40)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE_GET_DRAWRESULT_OFFSET UNITYSDK_OFFSET(0x1B113F30)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE_SET_DRAWRESULT_OFFSET UNITYSDK_OFFSET(0x1B113F20)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_10_OFFSET UNITYSDK_OFFSET(0x1B1140A0)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_11_OFFSET UNITYSDK_OFFSET(0x1B1140C0)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_12_OFFSET UNITYSDK_OFFSET(0x1B1140E0)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_13_OFFSET UNITYSDK_OFFSET(0x1B114100)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B113F80)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B113FA0)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B113FC0)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B113FE0)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1B114000)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1B114020)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1B114040)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_8_OFFSET UNITYSDK_OFFSET(0x1B114060)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_9_OFFSET UNITYSDK_OFFSET(0x1B114080)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B113F50)
...
namespace Sirenix::OdinInspector
{
	...
	public:
		...
		::System::Boolean drawResultIsSet; // 0x22
		::System::Boolean drawResult; // 0x23
		::System::Int32 ButtonHeight; // 0x24
		::Sirenix::OdinInspector::ButtonStyle Style; // 0x28
		::System::Boolean DisplayParameters; // 0x2C
