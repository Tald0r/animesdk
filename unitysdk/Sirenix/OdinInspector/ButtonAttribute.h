...
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE_GET_DRAWRESULTISSET_OFFSET UNITYSDK_OFFSET(0x1AB07EC0)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE_GET_DRAWRESULT_OFFSET UNITYSDK_OFFSET(0x1AB07EB0)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE_SET_DRAWRESULT_OFFSET UNITYSDK_OFFSET(0x1AB07EA0)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_10_OFFSET UNITYSDK_OFFSET(0x1AB08020)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_11_OFFSET UNITYSDK_OFFSET(0x1AB08040)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_12_OFFSET UNITYSDK_OFFSET(0x1AB08060)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_13_OFFSET UNITYSDK_OFFSET(0x1AB08080)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB07F00)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB07F20)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AB07F40)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1AB07F60)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1AB07F80)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1AB07FA0)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1AB07FC0)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_8_OFFSET UNITYSDK_OFFSET(0x1AB07FE0)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_9_OFFSET UNITYSDK_OFFSET(0x1AB08000)
#define SIRENIX_ODININSPECTOR_BUTTONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB07ED0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int ButtonAttribute_TypeDefinitionIndex = 7128;
	...
	public:
		...
		::Sirenix::OdinInspector::ButtonStyle Style; // 0x20
		::System::Boolean Expanded; // 0x24
		::System::Boolean drawResultIsSet; // 0x25
		::System::Boolean DisplayParameters; // 0x26
		::System::Boolean drawResult; // 0x27
		::System::Int32 ButtonHeight; // 0x28
		::System::Boolean FloatButton; // 0x2C
