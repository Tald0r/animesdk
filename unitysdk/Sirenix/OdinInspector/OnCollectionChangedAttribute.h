...
#define SIRENIX_ODININSPECTOR_ONCOLLECTIONCHANGEDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB091E0)
#define SIRENIX_ODININSPECTOR_ONCOLLECTIONCHANGEDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB091F0)
#define SIRENIX_ODININSPECTOR_ONCOLLECTIONCHANGEDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB091D0)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int OnCollectionChangedAttribute_TypeDefinitionIndex = 7195;
