...
#define SIRENIX_ODININSPECTOR_ONCOLLECTIONCHANGEDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B115310)
#define SIRENIX_ODININSPECTOR_ONCOLLECTIONCHANGEDATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B115320)
#define SIRENIX_ODININSPECTOR_ONCOLLECTIONCHANGEDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B115300)
