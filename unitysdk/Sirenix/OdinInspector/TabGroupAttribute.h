...
#define SIRENIX_ODININSPECTOR_TABGROUPATTRIBUTE_COMBINEVALUESWITH_OFFSET UNITYSDK_OFFSET(0x1AB09F00)
#define SIRENIX_ODININSPECTOR_TABGROUPATTRIBUTE_SIRENIX_ODININSPECTOR_INTERNAL_ISUBGROUPPROVIDERATTRIBUTE_GETSUBGROUPATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AB0A0E0)
#define SIRENIX_ODININSPECTOR_TABGROUPATTRIBUTE_SIRENIX_ODININSPECTOR_INTERNAL_ISUBGROUPPROVIDERATTRIBUTE_REPATHMEMBERATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1AB0A450)
#define SIRENIX_ODININSPECTOR_TABGROUPATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB09DC0)
#define SIRENIX_ODININSPECTOR_TABGROUPATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB09ED0)
#define SIRENIX_ODININSPECTOR_TABGROUPATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB09D60)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int TabGroupAttribute_TypeDefinitionIndex = 7226;
	...
	public:
		...
		::System::String* TabName; // 0x38
		::System::String* TabId; // 0x40
		::System::Collections::Generic::List_1<::Sirenix::OdinInspector::TabGroupAttribute*>* Tabs; // 0x48
		::Sirenix::OdinInspector::TabLayouting TabLayouting; // 0x50
		::Sirenix::OdinInspector::SdfIconType Icon; // 0x54
