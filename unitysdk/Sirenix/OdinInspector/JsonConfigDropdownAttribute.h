...
#define SIRENIX_ODININSPECTOR_JSONCONFIGDROPDOWNATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB43A50)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int JsonConfigDropdownAttribute_TypeDefinitionIndex = 8185;
