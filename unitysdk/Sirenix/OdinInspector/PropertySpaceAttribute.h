...
#define SIRENIX_ODININSPECTOR_PROPERTYSPACEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB09830)
#define SIRENIX_ODININSPECTOR_PROPERTYSPACEATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB09840)
#define SIRENIX_ODININSPECTOR_PROPERTYSPACEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB09820)

namespace Sirenix::OdinInspector
{
	inline static constexpr unsigned int PropertySpaceAttribute_TypeDefinitionIndex = 7208;
