...
#define AKCALLBACKMANAGER_BGMCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B005210)
#define AKCALLBACKMANAGER_BGMCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B005270)
#define AKCALLBACKMANAGER_BGMCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B004EF0)
#define AKCALLBACKMANAGER_BGMCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B004EE0)

inline static constexpr unsigned int AkCallbackManager_BGMCallback_TypeDefinitionIndex = 30021;
