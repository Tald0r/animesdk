...
#define NAPGRADIENTCOLORKEY_COMPARETO_OFFSET UNITYSDK_OFFSET(0x2C4E20)
#define NAPGRADIENTCOLORKEY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x5E1E490)
#define NAPGRADIENTCOLORKEY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2C4E00)
#define NAPGRADIENTCOLORKEY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2C4E00)
#define NAPGRADIENTCOLORKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x2C4DF0)

inline static constexpr unsigned int NapGradientColorKey_TypeDefinitionIndex = 39963;
