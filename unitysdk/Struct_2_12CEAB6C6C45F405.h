...
#define STRUCT_2_12CEAB6C6C45F405_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x35E7F0)
#define STRUCT_2_12CEAB6C6C45F405_EQUALS_OFFSET UNITYSDK_OFFSET(0x35E7E0)
#define STRUCT_2_12CEAB6C6C45F405_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x35E820)
#define STRUCT_2_12CEAB6C6C45F405_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x35E800)
#define STRUCT_2_12CEAB6C6C45F405_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x35EB90)
#define STRUCT_2_12CEAB6C6C45F405_METHOD_2_57A8E11FECF10345_1_OFFSET UNITYSDK_OFFSET(0x90FE110)
#define STRUCT_2_12CEAB6C6C45F405_METHOD_2_57A8E11FECF10345_OFFSET UNITYSDK_OFFSET(0x90FE000)
#define STRUCT_2_12CEAB6C6C45F405_METHOD_2_602A336CBD30C930_OFFSET UNITYSDK_OFFSET(0x35EA20)
#define STRUCT_2_12CEAB6C6C45F405_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x35EA60)
#define STRUCT_2_12CEAB6C6C45F405_METHOD_2_729BCE8F15EB95E6_OFFSET UNITYSDK_OFFSET(0x35EA50)
#define STRUCT_2_12CEAB6C6C45F405_METHOD_2_95780ED94B90ED36_1_OFFSET UNITYSDK_OFFSET(0x35E9C0)
#define STRUCT_2_12CEAB6C6C45F405_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x35E8B0)
#define STRUCT_2_12CEAB6C6C45F405_METHOD_2_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x35E930)
#define STRUCT_2_12CEAB6C6C45F405_METHOD_2_CCC6A3002C391211_OFFSET UNITYSDK_OFFSET(0x35EAC0)
#define STRUCT_2_12CEAB6C6C45F405_METHOD_2_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0x35E8A0)
#define STRUCT_2_12CEAB6C6C45F405_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x35E830)
#define STRUCT_2_12CEAB6C6C45F405_TOSTRING_OFFSET UNITYSDK_OFFSET(0x35E810)
#define STRUCT_2_12CEAB6C6C45F405__CCTOR_OFFSET UNITYSDK_OFFSET(0x90FDFF0)
#define STRUCT_2_12CEAB6C6C45F405__CTOR_OFFSET UNITYSDK_OFFSET(0x35E7D0)

inline static constexpr unsigned int Struct_2_12CEAB6C6C45F405_TypeDefinitionIndex = 67461;

struct alignas(8) Struct_2_12CEAB6C6C45F405
{
	static ::Struct_2_12CEAB6C6C45F405* StaticGet_Field_2_0()
	{
		return (::Struct_2_12CEAB6C6C45F405*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_12CEAB6C6C45F405_TypeDefinitionIndex)->GetStaticField(0x395C0);
	}
