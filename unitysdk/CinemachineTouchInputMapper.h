...
#define CINEMACHINETOUCHINPUTMAPPER_GETINPUTAXIS_OFFSET UNITYSDK_OFFSET(0x1B63BE10)
#define CINEMACHINETOUCHINPUTMAPPER_START_OFFSET UNITYSDK_OFFSET(0x1B63BD90)
#define CINEMACHINETOUCHINPUTMAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B63BEF0)

inline static constexpr unsigned int CinemachineTouchInputMapper_TypeDefinitionIndex = 31918;
