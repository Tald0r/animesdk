...
#define STATETREEGAMEPLAY_STATETREESTARTPROCESSOR_EXECUTE_OFFSET UNITYSDK_OFFSET(0x16C3D290)
#define STATETREEGAMEPLAY_STATETREESTARTPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3D3F0)

namespace StateTreeGameplay
{
	inline static constexpr unsigned int StateTreeStartProcessor_TypeDefinitionIndex = 60515;

	class StateTreeStartProcessor : public ::System::Object
	{
	public:
		::System::Void _ctor()
		{
			return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + STATETREEGAMEPLAY_STATETREESTARTPROCESSOR__CTOR_OFFSET))(this);
		}
