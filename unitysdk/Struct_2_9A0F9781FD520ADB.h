...
#define STRUCT_2_9A0F9781FD520ADB_DISPOSE_OFFSET UNITYSDK_OFFSET(0x321830)
#define STRUCT_2_9A0F9781FD520ADB_EQUALS_OFFSET UNITYSDK_OFFSET(0x321840)
#define STRUCT_2_9A0F9781FD520ADB_METHOD_2_21ABDCFF83CD1A02_OFFSET UNITYSDK_OFFSET(0x321A40)
#define STRUCT_2_9A0F9781FD520ADB_METHOD_2_3D78D2E0F9F95F07_OFFSET UNITYSDK_OFFSET(0x321A20)
#define STRUCT_2_9A0F9781FD520ADB_METHOD_2_65CF685B19AB5EC4_OFFSET UNITYSDK_OFFSET(0x321A50)
#define STRUCT_2_9A0F9781FD520ADB_METHOD_2_C11DE5214A4C6B74_OFFSET UNITYSDK_OFFSET(0x321A00)
#define STRUCT_2_9A0F9781FD520ADB_METHOD_2_CD728708FDF638DC_OFFSET UNITYSDK_OFFSET(0x7337BA0)
#define STRUCT_2_9A0F9781FD520ADB_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x3219F0)
#define STRUCT_2_9A0F9781FD520ADB_METHOD_2_FE1E81E9A40258E2_1_OFFSET UNITYSDK_OFFSET(0x73375F0)
#define STRUCT_2_9A0F9781FD520ADB_METHOD_2_FE1E81E9A40258E2_OFFSET UNITYSDK_OFFSET(0x7337380)
#define STRUCT_2_9A0F9781FD520ADB__CCTOR_OFFSET UNITYSDK_OFFSET(0x7337210)
#define STRUCT_2_9A0F9781FD520ADB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x321820)
#define STRUCT_2_9A0F9781FD520ADB__CTOR_OFFSET UNITYSDK_OFFSET(0x321770)

inline static constexpr unsigned int Struct_2_9A0F9781FD520ADB_TypeDefinitionIndex = 60680;

struct alignas(8) Struct_2_9A0F9781FD520ADB
{
	static ::System::Collections::Generic::HashSet_1<::System::UInt32>** StaticGet_Field_2_3()
	{
		return (::System::Collections::Generic::HashSet_1<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_9A0F9781FD520ADB_TypeDefinitionIndex)->GetStaticField(0x37680);
	}
	static ::Struct_2_9A0F9781FD520ADB* StaticGet_Field_2_0()
	{
		return (::Struct_2_9A0F9781FD520ADB*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_9A0F9781FD520ADB_TypeDefinitionIndex)->GetStaticField(0x37688);
	}
	static ::System::UInt32* StaticGet_Field_2_4()
	{
		return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_9A0F9781FD520ADB_TypeDefinitionIndex)->GetStaticField(0xDE70);
	}
