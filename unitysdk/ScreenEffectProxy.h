...
#define SCREENEFFECTPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x15ABF9F0)
#define SCREENEFFECTPROXY_COPYVALUEFROM_OFFSET UNITYSDK_OFFSET(0x15ABFD80)
#define SCREENEFFECTPROXY_SETVALUETO_OFFSET UNITYSDK_OFFSET(0x15ABFFB0)
#define SCREENEFFECTPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x15ABFF40)
#define SCREENEFFECTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC01F0)

inline static constexpr unsigned int ScreenEffectProxy_TypeDefinitionIndex = 68953;
