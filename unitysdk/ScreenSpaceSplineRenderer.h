...
#define SCREENSPACESPLINERENDERER_CALCULATEARRAYSIZES_OFFSET UNITYSDK_OFFSET(0xD85F100)
#define SCREENSPACESPLINERENDERER_CALCULATEBEZIERPOINT_OFFSET UNITYSDK_OFFSET(0xD85ED60)
#define SCREENSPACESPLINERENDERER_CALCULATEBEZIERTANGENT_OFFSET UNITYSDK_OFFSET(0xD85EEE0)
#define SCREENSPACESPLINERENDERER_GENERATESPLINEMESH_OFFSET UNITYSDK_OFFSET(0xD85D6B0)
#define SCREENSPACESPLINERENDERER_GETPROJECTEDWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0xD85EBD0)
#define SCREENSPACESPLINERENDERER_INIT_OFFSET UNITYSDK_OFFSET(0xD85E830)
#define SCREENSPACESPLINERENDERER_ONBEGINCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0xD85D630)
#define SCREENSPACESPLINERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD85D5C0)
#define SCREENSPACESPLINERENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD85D460)
#define SCREENSPACESPLINERENDERER_REGISTERRENDERING_OFFSET UNITYSDK_OFFSET(0xD85D4D0)
#define SCREENSPACESPLINERENDERER_SETUPTARGETS_OFFSET UNITYSDK_OFFSET(0xD85E7B0)
#define SCREENSPACESPLINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0xD85F1F0)

inline static constexpr unsigned int ScreenSpaceSplineRenderer_TypeDefinitionIndex = 59117;
