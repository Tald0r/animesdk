...
#define SCREENSPACESPLINERENDERER_CALCULATEARRAYSIZES_OFFSET UNITYSDK_OFFSET(0x17CCC550)
#define SCREENSPACESPLINERENDERER_CALCULATEBEZIERPOINT_OFFSET UNITYSDK_OFFSET(0x17CCC1B0)
#define SCREENSPACESPLINERENDERER_CALCULATEBEZIERTANGENT_OFFSET UNITYSDK_OFFSET(0x17CCC330)
#define SCREENSPACESPLINERENDERER_GENERATESPLINEMESH_OFFSET UNITYSDK_OFFSET(0x17CCAB00)
#define SCREENSPACESPLINERENDERER_GETPROJECTEDWORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x17CCC020)
#define SCREENSPACESPLINERENDERER_INIT_OFFSET UNITYSDK_OFFSET(0x17CCBC80)
#define SCREENSPACESPLINERENDERER_ONBEGINCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x17CCAA80)
#define SCREENSPACESPLINERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17CCAA10)
#define SCREENSPACESPLINERENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17CCA8B0)
#define SCREENSPACESPLINERENDERER_REGISTERRENDERING_OFFSET UNITYSDK_OFFSET(0x17CCA920)
#define SCREENSPACESPLINERENDERER_SETUPTARGETS_OFFSET UNITYSDK_OFFSET(0x17CCBC00)
#define SCREENSPACESPLINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x17CCC640)

inline static constexpr unsigned int ScreenSpaceSplineRenderer_TypeDefinitionIndex = 37279;
