...
#define MONOUIBTNSCALEANIM_AWAKE_OFFSET UNITYSDK_OFFSET(0x88A1EB0)
#define MONOUIBTNSCALEANIM_GETFIXSCALE_OFFSET UNITYSDK_OFFSET(0x88A2740)
#define MONOUIBTNSCALEANIM_INIT_OFFSET UNITYSDK_OFFSET(0x88A3190)
#define MONOUIBTNSCALEANIM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x88A3370)
#define MONOUIBTNSCALEANIM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x88A30A0)
#define MONOUIBTNSCALEANIM_RELOADCONFIG_OFFSET UNITYSDK_OFFSET(0x88A1FF0)
#define MONOUIBTNSCALEANIM_RESETSTATE_OFFSET UNITYSDK_OFFSET(0x88A2950)
#define MONOUIBTNSCALEANIM_STARTANIM_OFFSET UNITYSDK_OFFSET(0x88A27C0)
#define MONOUIBTNSCALEANIM_STOPANIM_OFFSET UNITYSDK_OFFSET(0x88A3040)
#define MONOUIBTNSCALEANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0x88A3120)
#define MONOUIBTNSCALEANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x88A3410)
#define MONOUIBTNSCALEANIM__STARTANIM_OFFSET UNITYSDK_OFFSET(0x88A29C0)
#define MONOUIBTNSCALEANIM___STARTANIM_B__40_0_OFFSET UNITYSDK_OFFSET(0x88A3470)
#define MONOUIBTNSCALEANIM___STARTANIM_B__40_1_OFFSET UNITYSDK_OFFSET(0x88A3800)

inline static constexpr unsigned int MonoUIBtnScaleAnim_TypeDefinitionIndex = 67695;
