...
#define MONOUIBTNSCALEANIM_AWAKE_OFFSET UNITYSDK_OFFSET(0x9A46090)
#define MONOUIBTNSCALEANIM_GETFIXSCALE_OFFSET UNITYSDK_OFFSET(0x9A46920)
#define MONOUIBTNSCALEANIM_INIT_OFFSET UNITYSDK_OFFSET(0x9A47370)
#define MONOUIBTNSCALEANIM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9A47550)
#define MONOUIBTNSCALEANIM_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9A47280)
#define MONOUIBTNSCALEANIM_RELOADCONFIG_OFFSET UNITYSDK_OFFSET(0x9A461D0)
#define MONOUIBTNSCALEANIM_RESETSTATE_OFFSET UNITYSDK_OFFSET(0x9A46B30)
#define MONOUIBTNSCALEANIM_STARTANIM_OFFSET UNITYSDK_OFFSET(0x9A469A0)
#define MONOUIBTNSCALEANIM_STOPANIM_OFFSET UNITYSDK_OFFSET(0x9A47220)
#define MONOUIBTNSCALEANIM_UPDATE_OFFSET UNITYSDK_OFFSET(0x9A47300)
#define MONOUIBTNSCALEANIM__CTOR_OFFSET UNITYSDK_OFFSET(0x9A475F0)
#define MONOUIBTNSCALEANIM__STARTANIM_OFFSET UNITYSDK_OFFSET(0x9A46BA0)
#define MONOUIBTNSCALEANIM___STARTANIM_B__40_0_OFFSET UNITYSDK_OFFSET(0x9A47650)
#define MONOUIBTNSCALEANIM___STARTANIM_B__40_1_OFFSET UNITYSDK_OFFSET(0x9A479E0)

inline static constexpr unsigned int MonoUIBtnScaleAnim_TypeDefinitionIndex = 69361;
