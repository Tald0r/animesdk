...
#define PVSMANAGER_PVSLEVELDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x2CA8F0)

inline static constexpr unsigned int PVSManager_PVSLevelData_TypeDefinitionIndex = 34285;
