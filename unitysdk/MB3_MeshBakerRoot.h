...
#define MB3_MESHBAKERROOT_DOCOMBINEDVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A6514E0)
#define MB3_MESHBAKERROOT_GETOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1A6514C0)
#define MB3_MESHBAKERROOT_PURGENULLSFROMOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1A6514D0)
#define MB3_MESHBAKERROOT_VALIDATETEXTUREBAKERGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A651B50)
#define MB3_MESHBAKERROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A652990)

inline static constexpr unsigned int MB3_MeshBakerRoot_TypeDefinitionIndex = 81201;
