...
#define MB3_MESHBAKERROOT_DOCOMBINEDVALIDATE_OFFSET UNITYSDK_OFFSET(0x1ABFC790)
#define MB3_MESHBAKERROOT_GETOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1ABFC770)
#define MB3_MESHBAKERROOT_PURGENULLSFROMOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1ABFC780)
#define MB3_MESHBAKERROOT_VALIDATETEXTUREBAKERGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1ABFCE00)
#define MB3_MESHBAKERROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABFDC40)

inline static constexpr unsigned int MB3_MeshBakerRoot_TypeDefinitionIndex = 83242;
