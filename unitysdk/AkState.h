...
#define AKSTATE_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1B4291F0)
#define AKSTATE_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B4290A0)
#define AKSTATE_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1B4290C0)
#define AKSTATE_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1B429050)
#define AKSTATE_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1B429020)
#define AKSTATE_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1B429030)
#define AKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B429330)

inline static constexpr unsigned int AkState_TypeDefinitionIndex = 31097;
