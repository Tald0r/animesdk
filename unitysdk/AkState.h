...
#define AKSTATE_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1AE07F30)
#define AKSTATE_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1AE07DE0)
#define AKSTATE_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1AE07E00)
#define AKSTATE_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1AE07D90)
#define AKSTATE_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1AE07D60)
#define AKSTATE_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1AE07D70)
#define AKSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE08070)

inline static constexpr unsigned int AkState_TypeDefinitionIndex = 30144;
