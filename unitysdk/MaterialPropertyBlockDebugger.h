...
#define MATERIALPROPERTYBLOCKDEBUGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11B20450)
#define MATERIALPROPERTYBLOCKDEBUGGER_REFRESH_OFFSET UNITYSDK_OFFSET(0x11B1FEA0)
#define MATERIALPROPERTYBLOCKDEBUGGER_RELEASECONTENTS_OFFSET UNITYSDK_OFFSET(0x11B20270)
#define MATERIALPROPERTYBLOCKDEBUGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x11B204C0)

inline static constexpr unsigned int MaterialPropertyBlockDebugger_TypeDefinitionIndex = 84220;
