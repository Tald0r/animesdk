...
#define GRIDBOUNDSSEARCH_FINDBINARY_OFFSET UNITYSDK_OFFSET(0x92452E0)
#define GRIDBOUNDSSEARCH_FINDENDCOLBINARY_OFFSET UNITYSDK_OFFSET(0x9245870)
#define GRIDBOUNDSSEARCH_FINDENDROWBINARY_OFFSET UNITYSDK_OFFSET(0x9245610)
#define GRIDBOUNDSSEARCH_FINDPOINTSINBOUNDSBRUTEFORCE_OFFSET UNITYSDK_OFFSET(0x9244F70)
#define GRIDBOUNDSSEARCH_FINDPOINTSINBOUNDSOPTIMIZED_OFFSET UNITYSDK_OFFSET(0x92459A0)
#define GRIDBOUNDSSEARCH_FINDPOINTSINBOUNDSRECURSIVE_OFFSET UNITYSDK_OFFSET(0x9245C00)
#define GRIDBOUNDSSEARCH_FINDPOINTSINBOUNDSSMART_OFFSET UNITYSDK_OFFSET(0x92465A0)
#define GRIDBOUNDSSEARCH_FINDPOINTSINBOUNDS_OFFSET UNITYSDK_OFFSET(0x9244C10)
#define GRIDBOUNDSSEARCH_FINDSTARTCOLBINARY_OFFSET UNITYSDK_OFFSET(0x9245740)
#define GRIDBOUNDSSEARCH_FINDSTARTROWBINARY_OFFSET UNITYSDK_OFFSET(0x92454E0)
#define GRIDBOUNDSSEARCH_GETINTERSECTIONBOUNDS_OFFSET UNITYSDK_OFFSET(0x9246850)
#define GRIDBOUNDSSEARCH_GETSUBGRIDBOUNDS_OFFSET UNITYSDK_OFFSET(0x9246350)
#define GRIDBOUNDSSEARCH_SEARCHRECURSIVE_OFFSET UNITYSDK_OFFSET(0x9245D50)

inline static constexpr unsigned int GridBoundsSearch_TypeDefinitionIndex = 61175;
