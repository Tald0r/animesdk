...
#define UNREALTYPES_OBJECTPROPERTYBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20C670)

namespace UnrealTypes
{
	inline static constexpr unsigned int ObjectPropertyBase_TypeDefinitionIndex = 24772;
