...
#define UNREALTYPES_UINT64PROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A214400)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt64PropertyParams_TypeDefinitionIndex = 24737;
