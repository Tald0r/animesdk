...
#define UNREALTYPES_INT8PROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20C570)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int8PropertyParams_TypeDefinitionIndex = 24730;
