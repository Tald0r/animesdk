...
#define UNREALTYPES_STRUCTPROPERTY_COPYVALUESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A211B50)
#define UNREALTYPES_STRUCTPROPERTY_GET_MINALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1A211AE0)
#define UNREALTYPES_STRUCTPROPERTY_GET_STRUCTHANDLE_OFFSET UNITYSDK_OFFSET(0x1A211A40)
#define UNREALTYPES_STRUCTPROPERTY_LINKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A211B10)
#define UNREALTYPES_STRUCTPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A204690)
#define UNREALTYPES_STRUCTPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A211B00)

namespace UnrealTypes
{
	inline static constexpr unsigned int StructProperty_TypeDefinitionIndex = 24779;
