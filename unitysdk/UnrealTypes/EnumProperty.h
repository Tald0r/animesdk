...
#define UNREALTYPES_ENUMPROPERTY_ADDCPPPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A204D30)
#define UNREALTYPES_ENUMPROPERTY_GETPROPERTYVALUEINCONTAINER_1_OFFSET UNITYSDK_OFFSET(0x1A204E50)
#define UNREALTYPES_ENUMPROPERTY_GETPROPERTYVALUEINCONTAINER_OFFSET UNITYSDK_OFFSET(0x1A204DF0)
#define UNREALTYPES_ENUMPROPERTY_GET_MINALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1A204C00)
#define UNREALTYPES_ENUMPROPERTY_LINKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A204DA0)
#define UNREALTYPES_ENUMPROPERTY_SETENUM_OFFSET UNITYSDK_OFFSET(0x1A204DE0)
#define UNREALTYPES_ENUMPROPERTY_SETPROPERTYVALUEINCONTAINER_1_OFFSET UNITYSDK_OFFSET(0x1A204ED0)
#define UNREALTYPES_ENUMPROPERTY_SETPROPERTYVALUEINCONTAINER_OFFSET UNITYSDK_OFFSET(0x1A204E90)
#define UNREALTYPES_ENUMPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2046C0)
#define UNREALTYPES_ENUMPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A204C40)

namespace UnrealTypes
{
	inline static constexpr unsigned int EnumProperty_TypeDefinitionIndex = 24778;
