...
#define UNREALTYPES_UINT32PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A214370)
#define UNREALTYPES_UINT32PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A214380)
#define UNREALTYPES_UINT32PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A2143A0)
#define UNREALTYPES_UINT32PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A214390)
#define UNREALTYPES_UINT32PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2045A0)
#define UNREALTYPES_UINT32PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A212300)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt32Property_TypeDefinitionIndex = 24767;
