...
#define UNREALTYPES_FIELD_ADDCPPPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A20BD00)
#define UNREALTYPES_FIELD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A20BCC0)
#define UNREALTYPES_FIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20BC40)

namespace UnrealTypes
{
	inline static constexpr unsigned int Field_TypeDefinitionIndex = 24722;
