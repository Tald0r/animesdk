...
#define UNREALTYPES_DOUBLEPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A204630)
#define UNREALTYPES_DOUBLEPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2046F0)

namespace UnrealTypes
{
	inline static constexpr unsigned int DoubleProperty_TypeDefinitionIndex = 24770;
