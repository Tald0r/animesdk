...
#define UNREALTYPES_FGUID_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2EC7B0)
#define UNREALTYPES_FGUID_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2EC7C0)
#define UNREALTYPES_FGUID_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x91B620)
#define UNREALTYPES_FGUID_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define UNREALTYPES_FGUID_EQUALS_OFFSET UNITYSDK_OFFSET(0x91B580)
#define UNREALTYPES_FGUID_GETTYPEHASH_OFFSET UNITYSDK_OFFSET(0x1A205940)
#define UNREALTYPES_FGUID_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x91B4E0)
#define UNREALTYPES_FGUID_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x91B5C0)
#define UNREALTYPES_FGUID_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x91B630)
#define UNREALTYPES_FGUID_HEXDIGIT_OFFSET UNITYSDK_OFFSET(0x1A205830)
#define UNREALTYPES_FGUID_HEXNUMBER_OFFSET UNITYSDK_OFFSET(0x1A205600)
#define UNREALTYPES_FGUID_ISHEXDIGIT_OFFSET UNITYSDK_OFFSET(0x1A2055E0)
#define UNREALTYPES_FGUID_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2EC7C0)
#define UNREALTYPES_FGUID_NEWGUID_OFFSET UNITYSDK_OFFSET(0x1A205860)
#define UNREALTYPES_FGUID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A2052D0)
#define UNREALTYPES_FGUID_PARSE_OFFSET UNITYSDK_OFFSET(0x1A204FB0)
#define UNREALTYPES_FGUID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x91B5B0)
#define UNREALTYPES_FGUID_UNREALTYPES_ISTRUCT_UNREALTYPES_FGUID__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2EC7B0)
#define UNREALTYPES_FGUID__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A205AB0)
#define UNREALTYPES_FGUID__CTOR_OFFSET UNITYSDK_OFFSET(0x91B500)

namespace UnrealTypes
{
	inline static constexpr unsigned int FGuid_TypeDefinitionIndex = 24679;

	struct alignas(4) FGuid
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FGuid_TypeDefinitionIndex)->GetStaticField(0x1E090);
		}
