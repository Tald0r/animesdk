...
#define UNREALTYPES_PROPERTYBAG_FINDPROPERTYDESCBYID_OFFSET UNITYSDK_OFFSET(0x1A20EB20)
#define UNREALTYPES_PROPERTYBAG_GETORCREATEFROMDESCS_OFFSET UNITYSDK_OFFSET(0x1A20CA10)
#define UNREALTYPES_PROPERTYBAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20DAB0)

namespace UnrealTypes
{
	inline static constexpr unsigned int PropertyBag_TypeDefinitionIndex = 24806;
