...
#define UNREALTYPES_STRUCT_ADDCPPPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A20EAF0)
#define UNREALTYPES_STRUCT_BIND_OFFSET UNITYSDK_OFFSET(0x1A20EB10)
#define UNREALTYPES_STRUCT_FINDPROPERTYBYNAME_OFFSET UNITYSDK_OFFSET(0x1A2119B0)
#define UNREALTYPES_STRUCT_GET_FULLNAME_OFFSET UNITYSDK_OFFSET(0x1A202F40)
#define UNREALTYPES_STRUCT_GET_INHERITANCESUPER_OFFSET UNITYSDK_OFFSET(0x1A211380)
#define UNREALTYPES_STRUCT_GET_STRUCTURESIZE_OFFSET UNITYSDK_OFFSET(0x1A207D40)
#define UNREALTYPES_STRUCT_ISCHILDOF_1_OFFSET UNITYSDK_OFFSET(0x1A211880)
#define UNREALTYPES_STRUCT_ISCHILDOF_OFFSET UNITYSDK_OFFSET(0x1A211850)
#define UNREALTYPES_STRUCT_LINK_OFFSET UNITYSDK_OFFSET(0x1A211390)
#define UNREALTYPES_STRUCT_STATICLINK_OFFSET UNITYSDK_OFFSET(0x1A203990)
#define UNREALTYPES_STRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A202A00)

namespace UnrealTypes
{
	inline static constexpr unsigned int Struct_TypeDefinitionIndex = 24705;
	...
	public:
		...
		::System::Int32 MinAlignment; // 0x68
