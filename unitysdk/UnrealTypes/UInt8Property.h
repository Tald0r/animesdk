...
#define UNREALTYPES_UINT8PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A214410)
#define UNREALTYPES_UINT8PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A214420)
#define UNREALTYPES_UINT8PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A214440)
#define UNREALTYPES_UINT8PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A214430)
#define UNREALTYPES_UINT8PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A204540)
#define UNREALTYPES_UINT8PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2122D0)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt8Property_TypeDefinitionIndex = 24765;
