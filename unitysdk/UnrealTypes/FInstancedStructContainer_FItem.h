...
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_FITEM_GET_ENDOFFSET_OFFSET UNITYSDK_OFFSET(0x91C530)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_FITEM_GET_MINALIGNMENT_OFFSET UNITYSDK_OFFSET(0x91C420)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_FITEM_GET_STRUCTURESIZE_OFFSET UNITYSDK_OFFSET(0x91C300)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_FITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3C30)

namespace UnrealTypes
{
	inline static constexpr unsigned int FInstancedStructContainer_FItem_TypeDefinitionIndex = 24787;
