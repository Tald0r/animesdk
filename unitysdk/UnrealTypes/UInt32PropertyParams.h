...
#define UNREALTYPES_UINT32PROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2143B0)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt32PropertyParams_TypeDefinitionIndex = 24736;
