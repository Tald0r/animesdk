...
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x973420)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x973440)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x39CD20)

namespace UnrealTypes
{
	inline static constexpr unsigned int FInstancedStructContainer_Enumerator_TypeDefinitionIndex = 23990;
