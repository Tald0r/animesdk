...
#define UNREALTYPES_DOUBLEPROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A204720)

namespace UnrealTypes
{
	inline static constexpr unsigned int DoublePropertyParams_TypeDefinitionIndex = 24739;
