...
#define UNREALTYPES_INT32PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A20C460)
#define UNREALTYPES_INT32PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A20C470)
#define UNREALTYPES_INT32PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A20C490)
#define UNREALTYPES_INT32PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A20C480)
#define UNREALTYPES_INT32PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2044E0)
#define UNREALTYPES_INT32PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20C430)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int32Property_TypeDefinitionIndex = 24763;
