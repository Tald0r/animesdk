...
#define UNREALTYPES_INT8PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A20C530)
#define UNREALTYPES_INT8PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A20C540)
#define UNREALTYPES_INT8PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A20C560)
#define UNREALTYPES_INT8PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A20C550)
#define UNREALTYPES_INT8PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A204480)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int8Property_TypeDefinitionIndex = 24761;
