...
#define UNREALTYPES_UNMANAGEDPROPERTY_GETPROPERTYVALUEPTRINCONTAINER_OFFSET UNITYSDK_OFFSET(0x1A214630)
#define UNREALTYPES_UNMANAGEDPROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A214470)
#define UNREALTYPES_UNMANAGEDPROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A2144E0)
#define UNREALTYPES_UNMANAGEDPROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A2145C0)
#define UNREALTYPES_UNMANAGEDPROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A214550)
#define UNREALTYPES_UNMANAGEDPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A214460)
#define UNREALTYPES_UNMANAGEDPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A214450)

namespace UnrealTypes
{
	inline static constexpr unsigned int UnmanagedProperty_TypeDefinitionIndex = 24759;
