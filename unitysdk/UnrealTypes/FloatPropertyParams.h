...
#define UNREALTYPES_FLOATPROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A202380)

namespace UnrealTypes
{
	inline static constexpr unsigned int FloatPropertyParams_TypeDefinitionIndex = 24738;
