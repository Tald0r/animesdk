...
#define UNREALTYPES_INT16PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A20C3E0)
#define UNREALTYPES_INT16PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A20C3F0)
#define UNREALTYPES_INT16PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A20C410)
#define UNREALTYPES_INT16PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A20C400)
#define UNREALTYPES_INT16PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2044B0)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int16Property_TypeDefinitionIndex = 24762;
