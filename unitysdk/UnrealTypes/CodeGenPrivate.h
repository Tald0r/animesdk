...
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTCLASS_OFFSET UNITYSDK_OFFSET(0x1A2039A0)
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTENUM_OFFSET UNITYSDK_OFFSET(0x1A202C30)
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A203930)
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A203C70)
#define UNREALTYPES_CODEGENPRIVATE_CONSTRUCTSCRIPTSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A201830)

namespace UnrealTypes
{
	inline static constexpr unsigned int CodeGenPrivate_TypeDefinitionIndex = 24750;
