...
#define UNREALTYPES_UINT16PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A214320)
#define UNREALTYPES_UINT16PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A214330)
#define UNREALTYPES_UINT16PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A214350)
#define UNREALTYPES_UINT16PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A214340)
#define UNREALTYPES_UINT16PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A204570)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt16Property_TypeDefinitionIndex = 24766;
