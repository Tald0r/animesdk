...
#define UNREALTYPES_SCRIPTARRAYHELPER_GETRAWPTR_OFFSET UNITYSDK_OFFSET(0x91CF20)
#define UNREALTYPES_SCRIPTARRAYHELPER_GET_NUM_OFFSET UNITYSDK_OFFSET(0x91CF10)
#define UNREALTYPES_SCRIPTARRAYHELPER_ISVALIDINDEX_OFFSET UNITYSDK_OFFSET(0x91CEF0)
#define UNREALTYPES_SCRIPTARRAYHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x91CEE0)

namespace UnrealTypes
{
	inline static constexpr unsigned int ScriptArrayHelper_TypeDefinitionIndex = 24781;
