...
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x1A20AEB0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20AE90)

namespace UnrealTypes
{
	inline static constexpr unsigned int FPropertyBagContainerTypes_StructOpsTypeTraits_TypeDefinitionIndex = 24795;
