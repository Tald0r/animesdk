...
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x91C980)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x91C940)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_CREATE_OFFSET UNITYSDK_OFFSET(0x1A20B350)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x91C920)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x91C8C0)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x91C9C0)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISCLASSTYPE_OFFSET UNITYSDK_OFFSET(0x91C8A0)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISCOMPATIBLETYPE_OFFSET UNITYSDK_OFFSET(0x91C8B0)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISFLOATNUMERICTYPE_OFFSET UNITYSDK_OFFSET(0x91C880)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISNUMERICTYPE_OFFSET UNITYSDK_OFFSET(0x91C840)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x91C890)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_ISUNSIGNEDNUMERICTYPE_OFFSET UNITYSDK_OFFSET(0x91C860)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x91C940)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC_UNREALTYPES_ISTRUCT_UNREALTYPES_FPROPERTYBAGPROPERTYDESC__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x91C980)
#define UNREALTYPES_FPROPERTYBAGPROPERTYDESC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A20B620)

namespace UnrealTypes
{
	inline static constexpr unsigned int FPropertyBagPropertyDesc_TypeDefinitionIndex = 24798;

	struct alignas(4) FPropertyBagPropertyDesc
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FPropertyBagPropertyDesc_TypeDefinitionIndex)->GetStaticField(0x1E180);
		}
