...
#define UNREALTYPES_OBJECTPROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A202C20)

namespace UnrealTypes
{
	inline static constexpr unsigned int ObjectPropertyParams_TypeDefinitionIndex = 24742;
