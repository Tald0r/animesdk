...
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_ADD_OFFSET UNITYSDK_OFFSET(0x91C660)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x91C7D0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x55D7C0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_CREATE_OFFSET UNITYSDK_OFFSET(0x1A20AD00)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x91C7C0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_EQUALS_OFFSET UNITYSDK_OFFSET(0x91C700)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_GETTYPEHASH_OFFSET UNITYSDK_OFFSET(0x1A20AB20)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x91C680)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_GET_NUM_OFFSET UNITYSDK_OFFSET(0x5477B0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x91C760)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x91C7E0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x55D7C0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A20AC30)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES_UNREALTYPES_ISTRUCT_UNREALTYPES_FPROPERTYBAGCONTAINERTYPES__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x91C7D0)
#define UNREALTYPES_FPROPERTYBAGCONTAINERTYPES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A20AE50)

namespace UnrealTypes
{
	inline static constexpr unsigned int FPropertyBagContainerTypes_TypeDefinitionIndex = 24794;

	struct alignas(1) FPropertyBagContainerTypes
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FPropertyBagContainerTypes_TypeDefinitionIndex)->GetStaticField(0x1E120);
		}
