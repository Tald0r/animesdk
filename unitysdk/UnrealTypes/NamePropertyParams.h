...
#define UNREALTYPES_NAMEPROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A201810)

namespace UnrealTypes
{
	inline static constexpr unsigned int NamePropertyParams_TypeDefinitionIndex = 24741;
