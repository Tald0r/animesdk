...
#define UNREALTYPES_BOOLPROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A202990)

namespace UnrealTypes
{
	inline static constexpr unsigned int BoolPropertyParams_TypeDefinitionIndex = 24740;
