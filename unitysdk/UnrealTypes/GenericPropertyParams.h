...
#define UNREALTYPES_GENERICPROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A204730)

namespace UnrealTypes
{
	inline static constexpr unsigned int GenericPropertyParams_TypeDefinitionIndex = 24729;
