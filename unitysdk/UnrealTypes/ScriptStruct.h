...
#define UNREALTYPES_SCRIPTSTRUCT_CLEARSCRIPTSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A207930)
#define UNREALTYPES_SCRIPTSTRUCT_COPYSCRIPTSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A207530)
#define UNREALTYPES_SCRIPTSTRUCT_DESTROYSTRUCT_OFFSET UNITYSDK_OFFSET(0x1A207200)
#define UNREALTYPES_SCRIPTSTRUCT_GET_STRUCTHANDLE_OFFSET UNITYSDK_OFFSET(0x1A2074E0)
#define UNREALTYPES_SCRIPTSTRUCT_INITIALIZESTRUCT_OFFSET UNITYSDK_OFFSET(0x1A207D50)
#define UNREALTYPES_SCRIPTSTRUCT_PREPARECPPSTRUCTOPS_OFFSET UNITYSDK_OFFSET(0x1A202F70)
#define UNREALTYPES_SCRIPTSTRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A202F30)

namespace UnrealTypes
{
	inline static constexpr unsigned int ScriptStruct_TypeDefinitionIndex = 24715;
