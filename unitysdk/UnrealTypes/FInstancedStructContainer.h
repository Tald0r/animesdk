...
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_APPEND_1_OFFSET UNITYSDK_OFFSET(0x91C110)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_APPEND_2_OFFSET UNITYSDK_OFFSET(0x91C120)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_APPEND_OFFSET UNITYSDK_OFFSET(0x91C100)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_ASSIGN_OFFSET UNITYSDK_OFFSET(0x91C150)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_CLEAR_OFFSET UNITYSDK_OFFSET(0x91C0C0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x91C020)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x91BF10)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x91BEF0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x91C080)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_EQUALS_OFFSET UNITYSDK_OFFSET(0x393E00)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x91C1F0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GETITEMSTRIDE_OFFSET UNITYSDK_OFFSET(0x1A20A890)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GETITEM_OFFSET UNITYSDK_OFFSET(0x91C1A0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x2F6540)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x91C1B0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x91C210)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x91C270)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_INSERTAT_OFFSET UNITYSDK_OFFSET(0x91C0D0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_ISVALIDINDEX_OFFSET UNITYSDK_OFFSET(0x91BED0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x91C030)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x91BF60)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A208900)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_RESERVEBYTES_OFFSET UNITYSDK_OFFSET(0x91C180)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_RESET_OFFSET UNITYSDK_OFFSET(0x91C040)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_SETNUM_OFFSET UNITYSDK_OFFSET(0x91C190)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER_UNREALTYPES_ISTRUCT_UNREALTYPES_FINSTANCEDSTRUCTCONTAINER__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x91C020)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A20A9A0)
#define UNREALTYPES_FINSTANCEDSTRUCTCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x91BEE0)

namespace UnrealTypes
{
	inline static constexpr unsigned int FInstancedStructContainer_TypeDefinitionIndex = 24786;

	struct alignas(8) FInstancedStructContainer
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FInstancedStructContainer_TypeDefinitionIndex)->GetStaticField(0x1E0F0);
		}
