...
#define UNREALTYPES_UINT64PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A2143C0)
#define UNREALTYPES_UINT64PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A2143D0)
#define UNREALTYPES_UINT64PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A2143F0)
#define UNREALTYPES_UINT64PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A2143E0)
#define UNREALTYPES_UINT64PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2045D0)
#define UNREALTYPES_UINT64PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A212330)

namespace UnrealTypes
{
	inline static constexpr unsigned int UInt64Property_TypeDefinitionIndex = 24768;
