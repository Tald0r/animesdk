...
#define UNREALTYPES_STRUCTUTILSPRIVATE_CALCPROPERTYDESCARRAYHASH_OFFSET UNITYSDK_OFFSET(0x1A20D9E0)
#define UNREALTYPES_STRUCTUTILSPRIVATE_CALCPROPERTYDESCHASH_OFFSET UNITYSDK_OFFSET(0x1A211D70)
#define UNREALTYPES_STRUCTUTILSPRIVATE_CANCASTTO_OFFSET UNITYSDK_OFFSET(0x1A20B2C0)
#define UNREALTYPES_STRUCTUTILSPRIVATE_COPYMATCHINGVALUESBYID_1_OFFSET UNITYSDK_OFFSET(0x1A205E30)
#define UNREALTYPES_STRUCTUTILSPRIVATE_COPYMATCHINGVALUESBYID_OFFSET UNITYSDK_OFFSET(0x1A2139F0)
#define UNREALTYPES_STRUCTUTILSPRIVATE_CREATEPROPERTYFROMDESC_OFFSET UNITYSDK_OFFSET(0x1A20DC90)
#define UNREALTYPES_STRUCTUTILSPRIVATE_GETOBJECTHASH_OFFSET UNITYSDK_OFFSET(0x1A211B70)
#define UNREALTYPES_STRUCTUTILSPRIVATE_GETPROPERTYASDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A212A70)
#define UNREALTYPES_STRUCTUTILSPRIVATE_GETPROPERTYASINT64_OFFSET UNITYSDK_OFFSET(0x1A212360)
#define UNREALTYPES_STRUCTUTILSPRIVATE_GETPROPERTYASUINT64_OFFSET UNITYSDK_OFFSET(0x1A2126D0)
#define UNREALTYPES_STRUCTUTILSPRIVATE_REMOVEPROPERTYBYNAME_OFFSET UNITYSDK_OFFSET(0x1A20DBC0)
#define UNREALTYPES_STRUCTUTILSPRIVATE_SETPROPERTYFROMDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A213590)
#define UNREALTYPES_STRUCTUTILSPRIVATE_SETPROPERTYFROMINT64_OFFSET UNITYSDK_OFFSET(0x1A212E50)
#define UNREALTYPES_STRUCTUTILSPRIVATE_SETPROPERTYFROMUINT64_OFFSET UNITYSDK_OFFSET(0x1A2131D0)

namespace UnrealTypes
{
	inline static constexpr unsigned int StructUtilsPrivate_TypeDefinitionIndex = 24807;
