...
#define UNREALTYPES_FPROPERTYHANDLE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x91CAF0)
#define UNREALTYPES_FPROPERTYHANDLE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNREALTYPES_FPROPERTYHANDLE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x8EE290)
#define UNREALTYPES_FPROPERTYHANDLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define UNREALTYPES_FPROPERTYHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x32E7F0)
#define UNREALTYPES_FPROPERTYHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x91CA90)
#define UNREALTYPES_FPROPERTYHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNREALTYPES_FPROPERTYHANDLE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x37DF50)
#define UNREALTYPES_FPROPERTYHANDLE_GET_REF_OFFSET UNITYSDK_OFFSET(0x91CA20)
#define UNREALTYPES_FPROPERTYHANDLE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x91CB90)
#define UNREALTYPES_FPROPERTYHANDLE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x91CBF0)
#define UNREALTYPES_FPROPERTYHANDLE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNREALTYPES_FPROPERTYHANDLE_RESET_OFFSET UNITYSDK_OFFSET(0x91CB40)
#define UNREALTYPES_FPROPERTYHANDLE_UNREALTYPES_ISTRUCT_UNREALTYPES_FPROPERTYHANDLE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x91CAF0)
#define UNREALTYPES_FPROPERTYHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A20B960)
#define UNREALTYPES_FPROPERTYHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x302300)

namespace UnrealTypes
{
	inline static constexpr unsigned int FPropertyHandle_TypeDefinitionIndex = 24673;

	struct alignas(4) FPropertyHandle
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(FPropertyHandle_TypeDefinitionIndex)->GetStaticField(0x1E1A0);
		}
		static ::UnrealTypes::FPropertyHandle* StaticGet_Invalid()
		{
			return (::UnrealTypes::FPropertyHandle*)Il2CppClass::FromTypeDefinitionIndex(FPropertyHandle_TypeDefinitionIndex)->GetStaticField(0x4770);
		}
