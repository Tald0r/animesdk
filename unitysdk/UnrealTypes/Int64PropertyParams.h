...
#define UNREALTYPES_INT64PROPERTYPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20C520)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int64PropertyParams_TypeDefinitionIndex = 24733;
