...
#define UNREALTYPES_INT64PROPERTY_GETSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A20C4E0)
#define UNREALTYPES_INT64PROPERTY_GETUNSIGNEDINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A20C4F0)
#define UNREALTYPES_INT64PROPERTY_SETINTPROPERTYVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A20C510)
#define UNREALTYPES_INT64PROPERTY_SETINTPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1A20C500)
#define UNREALTYPES_INT64PROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A204510)
#define UNREALTYPES_INT64PROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20C4B0)

namespace UnrealTypes
{
	inline static constexpr unsigned int Int64Property_TypeDefinitionIndex = 24764;
