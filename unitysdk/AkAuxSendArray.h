...
#define AKAUXSENDARRAY_ADD_1_OFFSET UNITYSDK_OFFSET(0x1B004670)
#define AKAUXSENDARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x1B004460)
#define AKAUXSENDARRAY_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1B004A10)
#define AKAUXSENDARRAY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1B004740)
#define AKAUXSENDARRAY_COUNT_OFFSET UNITYSDK_OFFSET(0x1B004ED0)
#define AKAUXSENDARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B0043A0)
#define AKAUXSENDARRAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B0043D0)
#define AKAUXSENDARRAY_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x1B004EC0)
#define AKAUXSENDARRAY_GETOBJECTPTR_OFFSET UNITYSDK_OFFSET(0x1B004370)
#define AKAUXSENDARRAY_GETVALUES_OFFSET UNITYSDK_OFFSET(0x1B004CE0)
#define AKAUXSENDARRAY_GET_ISFULL_OFFSET UNITYSDK_OFFSET(0x1B004380)
#define AKAUXSENDARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B0042E0)
#define AKAUXSENDARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x1B004450)
#define AKAUXSENDARRAY_SETVALUES_OFFSET UNITYSDK_OFFSET(0x1B004B00)
#define AKAUXSENDARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B004240)

inline static constexpr unsigned int AkAuxSendArray_TypeDefinitionIndex = 30052;
