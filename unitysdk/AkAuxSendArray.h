...
#define AKAUXSENDARRAY_ADD_1_OFFSET UNITYSDK_OFFSET(0x1B6167F0)
#define AKAUXSENDARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x1B6165E0)
#define AKAUXSENDARRAY_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1B616B90)
#define AKAUXSENDARRAY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1B6168C0)
#define AKAUXSENDARRAY_COUNT_OFFSET UNITYSDK_OFFSET(0x1B617050)
#define AKAUXSENDARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B616520)
#define AKAUXSENDARRAY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B616550)
#define AKAUXSENDARRAY_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x1B617040)
#define AKAUXSENDARRAY_GETOBJECTPTR_OFFSET UNITYSDK_OFFSET(0x1B6164F0)
#define AKAUXSENDARRAY_GETVALUES_OFFSET UNITYSDK_OFFSET(0x1B616E60)
#define AKAUXSENDARRAY_GET_ISFULL_OFFSET UNITYSDK_OFFSET(0x1B616500)
#define AKAUXSENDARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B616460)
#define AKAUXSENDARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x1B6165D0)
#define AKAUXSENDARRAY_SETVALUES_OFFSET UNITYSDK_OFFSET(0x1B616C80)
#define AKAUXSENDARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6163C0)

inline static constexpr unsigned int AkAuxSendArray_TypeDefinitionIndex = 31005;
