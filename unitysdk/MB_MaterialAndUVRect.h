...
#define MB_MATERIALANDUVRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B5F88E0)
#define MB_MATERIALANDUVRECT_GETENCAPSULATINGRECT_OFFSET UNITYSDK_OFFSET(0x1B5F8AB0)
#define MB_MATERIALANDUVRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B5F8710)
#define MB_MATERIALANDUVRECT_GETMATERIALTILINGRECT_OFFSET UNITYSDK_OFFSET(0x1B5F8AD0)
#define MB_MATERIALANDUVRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F86B0)

inline static constexpr unsigned int MB_MaterialAndUVRect_TypeDefinitionIndex = 83226;
