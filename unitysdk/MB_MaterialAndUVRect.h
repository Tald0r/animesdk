...
#define MB_MATERIALANDUVRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AFE9AA0)
#define MB_MATERIALANDUVRECT_GETENCAPSULATINGRECT_OFFSET UNITYSDK_OFFSET(0x1AFE9C70)
#define MB_MATERIALANDUVRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AFE98D0)
#define MB_MATERIALANDUVRECT_GETMATERIALTILINGRECT_OFFSET UNITYSDK_OFFSET(0x1AFE9C90)
#define MB_MATERIALANDUVRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE9870)

inline static constexpr unsigned int MB_MaterialAndUVRect_TypeDefinitionIndex = 81185;
