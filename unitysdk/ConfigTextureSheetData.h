...
#define CONFIGTEXTURESHEETDATA_CHECKHOLLOWTEXTURELOOP_OFFSET UNITYSDK_OFFSET(0x84FF110)
#define CONFIGTEXTURESHEETDATA_CREATEANDRELOADTEXTURESHEETS_OFFSET UNITYSDK_OFFSET(0x84FE4A0)
#define CONFIGTEXTURESHEETDATA_GETBATTLETEXTURESHEETDATA_OFFSET UNITYSDK_OFFSET(0x84FED30)
#define CONFIGTEXTURESHEETDATA_GETBLENDTEXTURESHEET_1_OFFSET UNITYSDK_OFFSET(0x84FE7F0)
#define CONFIGTEXTURESHEETDATA_GETBLENDTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x84FE660)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETASSETS_OFFSET UNITYSDK_OFFSET(0x84FEA50)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETBYALL_OFFSET UNITYSDK_OFFSET(0x84FF730)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETBYCOMBINELIBRARY_OFFSET UNITYSDK_OFFSET(0x84FE500)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETCONFIGPATH_OFFSET UNITYSDK_OFFSET(0x84FECD0)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETDATA_1_OFFSET UNITYSDK_OFFSET(0x84F45A0)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETDATA_OFFSET UNITYSDK_OFFSET(0x84FF3B0)
#define CONFIGTEXTURESHEETDATA_GETTEXTURESHEETGROUPDATA_OFFSET UNITYSDK_OFFSET(0x84FEB90)
#define CONFIGTEXTURESHEETDATA_ISCONTAINTARGETTEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x84FE370)
#define CONFIGTEXTURESHEETDATA_RELEASEALLTEXTURESHEETPLAYER_OFFSET UNITYSDK_OFFSET(0x84FFBC0)
#define CONFIGTEXTURESHEETDATA_RELOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0x84FBAD0)
#define CONFIGTEXTURESHEETDATA_RELOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x84FC0E0)
#define CONFIGTEXTURESHEETDATA_RELOADTEXTURESHEETFROMFILE_OFFSET UNITYSDK_OFFSET(0x84FBBE0)
#define CONFIGTEXTURESHEETDATA_TRYRANDOMTEXTURESHEETKEY_OFFSET UNITYSDK_OFFSET(0x84FE860)
#define CONFIGTEXTURESHEETDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x84FFC20)

inline static constexpr unsigned int ConfigTextureSheetData_TypeDefinitionIndex = 54478;
...
public:
	...
	{
		return (::MoleMole::ConfigTextureSheet**)Il2CppClass::FromTypeDefinitionIndex(ConfigTextureSheetData_TypeDefinitionIndex)->GetStaticField(0x373F0);
	}
	static ::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::TextureSheetData*>** StaticGet_combineTexutreSheets()
	{
		return (::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::TextureSheetData*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigTextureSheetData_TypeDefinitionIndex)->GetStaticField(0x373F8);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::MoleMole::TextureSheetType, ::MoleMole::ConfigTextureSheet*>**)Il2CppClass::FromTypeDefinitionIndex(ConfigTextureSheetData_TypeDefinitionIndex)->GetStaticField(0x37400);
	}
