...
#define AKRTPCTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B5A6A70)
#define AKRTPCTRACK_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B5A6C20)
#define AKRTPCTRACK_SETPLAYABLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B5A6B50)
#define AKRTPCTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A6CF0)

inline static constexpr unsigned int AkRTPCTrack_TypeDefinitionIndex = 31084;
