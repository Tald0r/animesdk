...
#define MONOUIDAMAGETMPEFFECT__ANIMATETEXT_D__62_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xEE703B0)
#define MONOUIDAMAGETMPEFFECT__ANIMATETEXT_D__62_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xEE70450)
#define MONOUIDAMAGETMPEFFECT__ANIMATETEXT_D__62_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xEE704B0)
#define MONOUIDAMAGETMPEFFECT__ANIMATETEXT_D__62_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xEE70460)
#define MONOUIDAMAGETMPEFFECT__ANIMATETEXT_D__62_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xEE703A0)
#define MONOUIDAMAGETMPEFFECT__ANIMATETEXT_D__62__CTOR_OFFSET UNITYSDK_OFFSET(0xEE70390)

inline static constexpr unsigned int MonoUIDamageTMPEffect__AnimateText_d__62_TypeDefinitionIndex = 76595;
