...
#define AKLOGGER_ERRORLOGGERINTEROPDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5792F0)
#define AKLOGGER_ERRORLOGGERINTEROPDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B579320)
#define AKLOGGER_ERRORLOGGERINTEROPDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B578DF0)
#define AKLOGGER_ERRORLOGGERINTEROPDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B578DD0)

inline static constexpr unsigned int AkLogger_ErrorLoggerInteropDelegate_TypeDefinitionIndex = 30992;
