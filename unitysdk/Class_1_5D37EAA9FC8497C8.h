...
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_0484478C7EF74149_OFFSET UNITYSDK_OFFSET(0x74295B0)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_08F218FCDB10584E_OFFSET UNITYSDK_OFFSET(0x7429520)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_19836C3DFF78AEA8_OFFSET UNITYSDK_OFFSET(0x74299F0)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_1B755A11F4BDF2F3_OFFSET UNITYSDK_OFFSET(0x742B030)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_3312C770B48AFB0C_1_OFFSET UNITYSDK_OFFSET(0x742B290)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_3312C770B48AFB0C_OFFSET UNITYSDK_OFFSET(0x742B140)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_426567B005B72855_OFFSET UNITYSDK_OFFSET(0x7429870)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_72B10B92292CAA60_OFFSET UNITYSDK_OFFSET(0x7427D30)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_76FE1E95213400E0_OFFSET UNITYSDK_OFFSET(0x7427FD0)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_A310601681D30145_OFFSET UNITYSDK_OFFSET(0x742A020)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_B4B2D012FE378634_OFFSET UNITYSDK_OFFSET(0x74283C0)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_CAAF86BB8A51D5D1_OFFSET UNITYSDK_OFFSET(0x7428470)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_DA3E18D8879EEDCE_OFFSET UNITYSDK_OFFSET(0x7428380)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_DE973A2760D546FC_OFFSET UNITYSDK_OFFSET(0x742B040)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_E00F457EF22B93EF_OFFSET UNITYSDK_OFFSET(0x742A500)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_E49226E55BF3741F_OFFSET UNITYSDK_OFFSET(0x7429470)
#define CLASS_1_5D37EAA9FC8497C8_METHOD_1_FCB6D39E44D2E20B_OFFSET UNITYSDK_OFFSET(0x74296F0)

inline static constexpr unsigned int Class_1_5D37EAA9FC8497C8_TypeDefinitionIndex = 54827;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5D37EAA9FC8497C8_TypeDefinitionIndex)->GetStaticField(0x305A0);
	}
	static ::Il2CppArray<::UnityEngine::Collider*>** StaticGet_Field_1_3()
	{
		return (::Il2CppArray<::UnityEngine::Collider*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_5D37EAA9FC8497C8_TypeDefinitionIndex)->GetStaticField(0x305A8);
	}
