...
#define CLASS_1_E16B0ED9C6ECEA5F_METHOD_1_18B783781170954B_OFFSET UNITYSDK_OFFSET(0x6FF3930)
#define CLASS_1_E16B0ED9C6ECEA5F_METHOD_1_2091F34306E68C88_OFFSET UNITYSDK_OFFSET(0x6FF36F0)
#define CLASS_1_E16B0ED9C6ECEA5F_METHOD_1_458DAEAB6170C584_OFFSET UNITYSDK_OFFSET(0x6FF3B30)
#define CLASS_1_E16B0ED9C6ECEA5F_METHOD_1_A3A75093075464DC_OFFSET UNITYSDK_OFFSET(0x6FF3CD0)
#define CLASS_1_E16B0ED9C6ECEA5F_METHOD_1_E03D4451E6D18478_OFFSET UNITYSDK_OFFSET(0x6FF3AC0)
#define CLASS_1_E16B0ED9C6ECEA5F__CTOR_OFFSET UNITYSDK_OFFSET(0x6FF36E0)

inline static constexpr unsigned int Class_1_E16B0ED9C6ECEA5F_TypeDefinitionIndex = 45843;

class Class_1_E16B0ED9C6ECEA5F : public ::System::Object
{
public:
	::FlowCanvas::ValueInput_1<::System::String*>* Field_1_1; // 0x10
	::FlowCanvas::ValueInput_1<::System::Int32>* Field_1_7; // 0x18
	::FlowCanvas::ValueInput_1<::MoleMole::Config::WeatherType>* Field_1_4; // 0x20
	::FlowCanvas::ValueInput_1<::System::Boolean>* Field_1_2; // 0x28
	::FlowCanvas::ValueInput_1<::System::String*>* Field_1_5; // 0x30
	::FlowCanvas::ValueInput_1<::MoleMole::Config::TimePeriodType>* Field_1_3; // 0x38
	::FlowCanvas::ValueInput_1<::System::String*>* Field_1_0; // 0x40
