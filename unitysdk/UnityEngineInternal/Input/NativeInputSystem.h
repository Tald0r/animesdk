...
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_ALLOCATEDEVICEID_OFFSET UNITYSDK_OFFSET(0x1B76B440)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_GET_CURRENTTIMEOFFSETTOREALTIMESINCESTARTUP_OFFSET UNITYSDK_OFFSET(0x1B76B430)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_GET_CURRENTTIME_OFFSET UNITYSDK_OFFSET(0x1B76B420)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_GET_ONDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1B76AE20)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_IOCTL_OFFSET UNITYSDK_OFFSET(0x1B76B460)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_NOTIFYBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1B76AEB0)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_NOTIFYDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1B76B300)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_NOTIFYUPDATE_OFFSET UNITYSDK_OFFSET(0x1B76AF40)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_QUEUEINPUTEVENT_OFFSET UNITYSDK_OFFSET(0x1B76B450)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_SETPOLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1B76B470)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_SET_HASDEVICEDISCOVEREDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B76AE90)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_SET_ONDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1B76AE50)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_SHOULDRUNUPDATE_OFFSET UNITYSDK_OFFSET(0x1B76B390)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B76B480)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B76AEA0)
#define UNITYENGINEINTERNAL_INPUT_NATIVEINPUTSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B76B490)

namespace UnityEngineInternal::Input
{
	inline static constexpr unsigned int NativeInputSystem_TypeDefinitionIndex = 24321;
	...
	public:
		...
		{
			return (::System::Action_2<::System::Int32, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NativeInputSystem_TypeDefinitionIndex)->GetStaticField(0x1DD40);
		}
		static ::UnityEngineInternal::Input::NativeUpdateCallback** StaticGet_onUpdate()
		{
			return (::UnityEngineInternal::Input::NativeUpdateCallback**)Il2CppClass::FromTypeDefinitionIndex(NativeInputSystem_TypeDefinitionIndex)->GetStaticField(0x1DD48);
		}
		static ::System::Func_2<::UnityEngineInternal::Input::NativeInputUpdateType, ::System::Boolean>** StaticGet_onShouldRunUpdate()
		{
			return (::System::Func_2<::UnityEngineInternal::Input::NativeInputUpdateType, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(NativeInputSystem_TypeDefinitionIndex)->GetStaticField(0x1DD50);
		}
		static ::System::Action_1<::UnityEngineInternal::Input::NativeInputUpdateType>** StaticGet_onBeforeUpdate()
		{
			return (::System::Action_1<::UnityEngineInternal::Input::NativeInputUpdateType>**)Il2CppClass::FromTypeDefinitionIndex(NativeInputSystem_TypeDefinitionIndex)->GetStaticField(0x1DD58);
		}
