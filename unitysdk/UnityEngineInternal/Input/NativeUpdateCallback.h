...
#define UNITYENGINEINTERNAL_INPUT_NATIVEUPDATECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B14CC90)
#define UNITYENGINEINTERNAL_INPUT_NATIVEUPDATECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B14CCF0)
#define UNITYENGINEINTERNAL_INPUT_NATIVEUPDATECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B14C790)
#define UNITYENGINEINTERNAL_INPUT_NATIVEUPDATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14CC80)

namespace UnityEngineInternal::Input
{
	inline static constexpr unsigned int NativeUpdateCallback_TypeDefinitionIndex = 23633;
