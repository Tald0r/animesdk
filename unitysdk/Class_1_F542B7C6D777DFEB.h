...
#define CLASS_1_F542B7C6D777DFEB_METHOD_1_9D55495002E88820_OFFSET UNITYSDK_OFFSET(0x762CAD0)
#define CLASS_1_F542B7C6D777DFEB_METHOD_1_B3ADE91382BF0B05_OFFSET UNITYSDK_OFFSET(0x762C940)
#define CLASS_1_F542B7C6D777DFEB_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x762C950)
#define CLASS_1_F542B7C6D777DFEB_METHOD_1_C81277B215275574_OFFSET UNITYSDK_OFFSET(0x762C930)
#define CLASS_1_F542B7C6D777DFEB_METHOD_1_D58849E1895DD394_OFFSET UNITYSDK_OFFSET(0x762C960)
#define CLASS_1_F542B7C6D777DFEB_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x762C920)
#define CLASS_1_F542B7C6D777DFEB_METHOD_1_F1D40B323FAD3DCE_OFFSET UNITYSDK_OFFSET(0x762CAC0)
#define CLASS_1_F542B7C6D777DFEB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x762C890)
#define CLASS_1_F542B7C6D777DFEB__CTOR_OFFSET UNITYSDK_OFFSET(0x762C810)

inline static constexpr unsigned int Class_1_F542B7C6D777DFEB_TypeDefinitionIndex = 66450;

class Class_1_F542B7C6D777DFEB : public ::System::Object
{
public:
	::System::String* Field_1_8; // 0x10
	::MoleMole::ConfigNewbie_TargetPath* Field_1_3; // 0x18
	::MoleMole::UIBaseController* Field_1_10; // 0x20
	::UnityEngine::UI::Extension::UIButtonBase* Field_1_5; // 0x28
	::MoleMole::UIBaseController* Field_1_2; // 0x30
