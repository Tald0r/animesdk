...
#define MONOUIFOCUS_GET_ANIM_OFFSET UNITYSDK_OFFSET(0xA097B10)
#define MONOUIFOCUS_GET_SELECTABLE_OFFSET UNITYSDK_OFFSET(0xA097AF0)
#define MONOUIFOCUS_SET_ANIM_OFFSET UNITYSDK_OFFSET(0xA097B20)
#define MONOUIFOCUS_SET_SELECTABLE_OFFSET UNITYSDK_OFFSET(0xA097B00)
#define MONOUIFOCUS__CTOR_OFFSET UNITYSDK_OFFSET(0xA097B30)

inline static constexpr unsigned int MonoUIFocus_TypeDefinitionIndex = 64094;
