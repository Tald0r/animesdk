...
#define STRUCT_2_172EDDF213DEFCC4_METHOD_2_4E5F0C484BC1A4CD_1_OFFSET UNITYSDK_OFFSET(0x308F00)
#define STRUCT_2_172EDDF213DEFCC4_METHOD_2_4E5F0C484BC1A4CD_OFFSET UNITYSDK_OFFSET(0x308EC0)
#define STRUCT_2_172EDDF213DEFCC4_METHOD_2_5592BFCA1EE165A2_OFFSET UNITYSDK_OFFSET(0x308F90)
#define STRUCT_2_172EDDF213DEFCC4_METHOD_2_5863465EEDEDEEC5_OFFSET UNITYSDK_OFFSET(0x65BE780)
#define STRUCT_2_172EDDF213DEFCC4_METHOD_2_A079105B6C727B32_OFFSET UNITYSDK_OFFSET(0x65BE670)
#define STRUCT_2_172EDDF213DEFCC4_METHOD_2_BFBBE8A6FE167A6A_OFFSET UNITYSDK_OFFSET(0x308F40)
#define STRUCT_2_172EDDF213DEFCC4_METHOD_2_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x308F70)
#define STRUCT_2_172EDDF213DEFCC4__CCTOR_OFFSET UNITYSDK_OFFSET(0x65BE200)
#define STRUCT_2_172EDDF213DEFCC4__CTOR_OFFSET UNITYSDK_OFFSET(0x308EB0)

inline static constexpr unsigned int Struct_2_172EDDF213DEFCC4_TypeDefinitionIndex = 62256;

struct alignas(8) Struct_2_172EDDF213DEFCC4
{
	static ::Struct_2_172EDDF213DEFCC4* StaticGet_Field_2_3()
	{
		return (::Struct_2_172EDDF213DEFCC4*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_172EDDF213DEFCC4_TypeDefinitionIndex)->GetStaticField(0xE450);
	}
