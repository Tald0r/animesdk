...
#define TRAFFICLIGHTWALLCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1388DEA0)

inline static constexpr unsigned int TrafficLightWallConfig_TypeDefinitionIndex = 69549;
