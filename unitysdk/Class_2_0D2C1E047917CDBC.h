...
#define CLASS_2_0D2C1E047917CDBC_METHOD_2_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x9797FF0)
#define CLASS_2_0D2C1E047917CDBC_METHOD_2_41F8B8ACD2DFAAFE_OFFSET UNITYSDK_OFFSET(0x9797F80)
#define CLASS_2_0D2C1E047917CDBC_METHOD_2_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x9797F20)
#define CLASS_2_0D2C1E047917CDBC_METHOD_2_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x9797FE0)
#define CLASS_2_0D2C1E047917CDBC_METHOD_2_BC516BD7B592E51E_OFFSET UNITYSDK_OFFSET(0x9798080)
#define CLASS_2_0D2C1E047917CDBC_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9798220)
#define CLASS_2_0D2C1E047917CDBC_METHOD_2_DDAE910B2F26C187_OFFSET UNITYSDK_OFFSET(0x9798130)
#define CLASS_2_0D2C1E047917CDBC__CCTOR_OFFSET UNITYSDK_OFFSET(0x9798000)
#define CLASS_2_0D2C1E047917CDBC__CTOR_OFFSET UNITYSDK_OFFSET(0x9798070)

inline static constexpr unsigned int Class_2_0D2C1E047917CDBC_TypeDefinitionIndex = 37869;
...
public:
	...
	::MoleMole::Config::BuffGroupName Field_2_3; // 0x38
	::Enum_3_A25A0C2001E5EE26 Field_2_8; // 0x3C
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_0D2C1E047917CDBC_METHOD_2_BC516BD7B592E51E_OFFSET))(this);
	}
