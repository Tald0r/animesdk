...
#define CLASS_1_6C587B1DA6AB62AC_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x80FC030)
#define CLASS_1_6C587B1DA6AB62AC_FROMFLX_OFFSET UNITYSDK_OFFSET(0x80FC620)
#define CLASS_1_6C587B1DA6AB62AC_METHOD_1_0578713EDB32B89E_OFFSET UNITYSDK_OFFSET(0x80FC6A0)
#define CLASS_1_6C587B1DA6AB62AC_METHOD_1_6064CE8C10DDEFF7_OFFSET UNITYSDK_OFFSET(0x80FC090)
#define CLASS_1_6C587B1DA6AB62AC__CTOR_OFFSET UNITYSDK_OFFSET(0x80FD760)

inline static constexpr unsigned int Class_1_6C587B1DA6AB62AC_TypeDefinitionIndex = 73664;

class Class_1_6C587B1DA6AB62AC : public ::System::Object
{
public:
	::MoleMole::Config::DynamicInt* Field_1_6; // 0x10
	...
	::MoleMole::Config::DynamicInt* Field_1_2; // 0x30
	::MoleMole::Config::DynamicString* Field_1_3; // 0x38
	::MoleMole::Config::DynamicFloat* Field_1_5; // 0x40
	::MoleMole::Config::DynamicInt* Field_1_8; // 0x48
	::Class_1_4ED21A115C97704D* Field_1_9; // 0x50
