...
#define MB3_TEXTUREBAKER_ONCOMBINEDTEXTURESCOROUTINEFAIL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A94B6E0)
#define MB3_TEXTUREBAKER_ONCOMBINEDTEXTURESCOROUTINEFAIL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A94B710)
#define MB3_TEXTUREBAKER_ONCOMBINEDTEXTURESCOROUTINEFAIL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A94B3C0)
#define MB3_TEXTUREBAKER_ONCOMBINEDTEXTURESCOROUTINEFAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A94B6D0)

inline static constexpr unsigned int MB3_TextureBaker_OnCombinedTexturesCoroutineFail_TypeDefinitionIndex = 81208;
