...
#define MB3_TEXTUREBAKER_ONCOMBINEDTEXTURESCOROUTINEFAIL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AF2C2F0)
#define MB3_TEXTUREBAKER_ONCOMBINEDTEXTURESCOROUTINEFAIL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AF2C320)
#define MB3_TEXTUREBAKER_ONCOMBINEDTEXTURESCOROUTINEFAIL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AF2BFC0)
#define MB3_TEXTUREBAKER_ONCOMBINEDTEXTURESCOROUTINEFAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF2C2D0)

inline static constexpr unsigned int MB3_TextureBaker_OnCombinedTexturesCoroutineFail_TypeDefinitionIndex = 83249;
