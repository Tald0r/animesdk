...
#define LINELIGHTING_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B0E2380)
#define LINELIGHTING_COLLECTLINPOS_OFFSET UNITYSDK_OFFSET(0x1B0E2900)
#define LINELIGHTING_DOSETLINERENDERER_OFFSET UNITYSDK_OFFSET(0x1B0E2670)
#define LINELIGHTING_FORCEUPDATEWITHPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1B0E28B0)
#define LINELIGHTING_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0E2880)
#define LINELIGHTING_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B0E1EC0)
#define LINELIGHTING_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1B0E1DC0)
#define LINELIGHTING_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0x1B0E1DB0)
#define LINELIGHTING_RESETPARAM_OFFSET UNITYSDK_OFFSET(0x1B0E2B70)
#define LINELIGHTING_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1B0E2480)
#define LINELIGHTING_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B0E2450)
#define LINELIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E2C40)

inline static constexpr unsigned int LineLighting_TypeDefinitionIndex = 31601;
