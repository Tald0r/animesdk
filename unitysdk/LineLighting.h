...
#define LINELIGHTING_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B6F2F90)
#define LINELIGHTING_COLLECTLINPOS_OFFSET UNITYSDK_OFFSET(0x1B6F3510)
#define LINELIGHTING_DOSETLINERENDERER_OFFSET UNITYSDK_OFFSET(0x1B6F3280)
#define LINELIGHTING_FORCEUPDATEWITHPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1B6F34C0)
#define LINELIGHTING_FORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B6F3490)
#define LINELIGHTING_GETENDPOSITION_OFFSET UNITYSDK_OFFSET(0x1B6F2AD0)
#define LINELIGHTING_GETSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0x1B6F29D0)
#define LINELIGHTING_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0x1B6F29C0)
#define LINELIGHTING_RESETPARAM_OFFSET UNITYSDK_OFFSET(0x1B6F3780)
#define LINELIGHTING_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1B6F3090)
#define LINELIGHTING_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B6F3060)
#define LINELIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F3850)

inline static constexpr unsigned int LineLighting_TypeDefinitionIndex = 32555;
