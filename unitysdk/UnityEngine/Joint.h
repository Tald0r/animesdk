...
#define UNITYENGINE_JOINT_GET_CONNECTEDBODY_OFFSET UNITYSDK_OFFSET(0x1ACF9940)
#define UNITYENGINE_JOINT_SET_CONNECTEDANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACF9960)
#define UNITYENGINE_JOINT_SET_CONNECTEDANCHOR_OFFSET UNITYSDK_OFFSET(0x1ACF9950)
#define UNITYENGINE_JOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACF9970)
