...
#define UNITYENGINE_JOINT_GET_CONNECTEDBODY_OFFSET UNITYSDK_OFFSET(0x1A755C80)
#define UNITYENGINE_JOINT_SET_CONNECTEDANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A755CA0)
#define UNITYENGINE_JOINT_SET_CONNECTEDANCHOR_OFFSET UNITYSDK_OFFSET(0x1A755C90)
#define UNITYENGINE_JOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A755CB0)

namespace UnityEngine
{
	inline static constexpr unsigned int Joint_TypeDefinitionIndex = 7667;
