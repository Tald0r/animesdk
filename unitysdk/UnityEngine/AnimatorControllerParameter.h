...
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B751E20)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B751EE0)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_DEFAULTBOOL_OFFSET UNITYSDK_OFFSET(0x1B751E10)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_DEFAULTFLOAT_OFFSET UNITYSDK_OFFSET(0x1B751DF0)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_DEFAULTINT_OFFSET UNITYSDK_OFFSET(0x1B751E00)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_NAMEHASH_OFFSET UNITYSDK_OFFSET(0x1B751DD0)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B751DC0)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B751DE0)
#define UNITYENGINE_ANIMATORCONTROLLERPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B751F70)
