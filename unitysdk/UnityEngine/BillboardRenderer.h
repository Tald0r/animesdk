...
#define UNITYENGINE_BILLBOARDRENDERER_GET_BILLBOARD_OFFSET UNITYSDK_OFFSET(0x1994F290)
#define UNITYENGINE_BILLBOARDRENDERER_SET_BILLBOARD_OFFSET UNITYSDK_OFFSET(0x1994F2A0)
#define UNITYENGINE_BILLBOARDRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1994F2B0)
