...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1A3EDB50)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_DISPOSE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A3EDC10)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A3EDC20)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A3EDD20)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_GETCAPTUREPIXELFORMAT_OFFSET UNITYSDK_OFFSET(0x1A3EDA70)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_GETDATALENGTH_OFFSET UNITYSDK_OFFSET(0x1A3EDA50)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_GETHASLOCATIONDATA_OFFSET UNITYSDK_OFFSET(0x1A3EDA60)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_GET_DATALENGTH_OFFSET UNITYSDK_OFFSET(0x1A3EDA10)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_SET_DATALENGTH_OFFSET UNITYSDK_OFFSET(0x1A3EDA20)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_SET_HASLOCATIONDATA_OFFSET UNITYSDK_OFFSET(0x1A3EDA30)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME_SET_PIXELFORMAT_OFFSET UNITYSDK_OFFSET(0x1A3EDA40)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTUREFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3EDA80)
