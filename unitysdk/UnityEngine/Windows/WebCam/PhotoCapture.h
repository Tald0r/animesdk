...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_DISPOSETHREADED_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A04ED10)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_DISPOSE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A04EC80)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A04EC20)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A04EC90)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_INVOKEONCAPTUREDPHOTOTODISKDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A04E9F0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_INVOKEONCAPTUREDPHOTOTOMEMORYDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A04EAE0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_INVOKEONCREATEDRESOURCEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A04E790)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_INVOKEONPHOTOMODESTARTEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A04E810)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_INVOKEONPHOTOMODESTOPPEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A04E900)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_MAKECAPTURERESULT_OFFSET UNITYSDK_OFFSET(0x1A04E720)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A04ED20)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04E800)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_TypeDefinitionIndex = 5459;
	...
	public:
		...
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(PhotoCapture_TypeDefinitionIndex)->GetStaticField(0x2EB0);
		}
