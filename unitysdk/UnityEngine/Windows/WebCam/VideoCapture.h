...
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_DISPOSETHREADED_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A439D50)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_DISPOSE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A439CC0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A439C60)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A439CD0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONCREATEDVIDEOCAPTURERESOURCEDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A439820)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONSTARTEDRECORDINGVIDEOTODISKDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A439A80)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONSTOPPEDRECORDINGVIDEOTODISKDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A439B70)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONVIDEOMODESTARTEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A4398A0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONVIDEOMODESTOPPEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A439990)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_MAKECAPTURERESULT_OFFSET UNITYSDK_OFFSET(0x1A4397B0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A439D60)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A439890)
