...
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_DISPOSETHREADED_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19E55670)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_DISPOSE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19E555E0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E55580)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19E555F0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONCREATEDVIDEOCAPTURERESOURCEDELEGATE_OFFSET UNITYSDK_OFFSET(0x19E55140)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONSTARTEDRECORDINGVIDEOTODISKDELEGATE_OFFSET UNITYSDK_OFFSET(0x19E553A0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONSTOPPEDRECORDINGVIDEOTODISKDELEGATE_OFFSET UNITYSDK_OFFSET(0x19E55490)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONVIDEOMODESTARTEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x19E551C0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_INVOKEONVIDEOMODESTOPPEDDELEGATE_OFFSET UNITYSDK_OFFSET(0x19E552B0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_MAKECAPTURERESULT_OFFSET UNITYSDK_OFFSET(0x19E550D0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E55680)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E551B0)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int VideoCapture_TypeDefinitionIndex = 5468;
	...
	public:
		...
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(VideoCapture_TypeDefinitionIndex)->GetStaticField(0x2E90);
		}
