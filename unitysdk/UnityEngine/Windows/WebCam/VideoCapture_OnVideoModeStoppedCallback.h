...
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONVIDEOMODESTOPPEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x199694D0)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONVIDEOMODESTOPPEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19969540)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONVIDEOMODESTOPPEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19969110)
#define UNITYENGINE_WINDOWS_WEBCAM_VIDEOCAPTURE_ONVIDEOMODESTOPPEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19969100)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int VideoCapture_OnVideoModeStoppedCallback_TypeDefinitionIndex = 5473;
