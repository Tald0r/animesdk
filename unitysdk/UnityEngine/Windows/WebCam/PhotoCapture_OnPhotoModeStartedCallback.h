...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A1AA060)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A1AA0D0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1A9CA0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONPHOTOMODESTARTEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A9C80)
