...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTOMEMORYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A120C10)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTOMEMORYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A120C90)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTOMEMORYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A120800)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTOMEMORYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1207F0)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_OnCapturedToMemoryCallback_TypeDefinitionIndex = 5466;
