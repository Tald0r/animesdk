...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTURERESOURCECREATEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D21670)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTURERESOURCECREATEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D216A0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTURERESOURCECREATEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D21170)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTURERESOURCECREATEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19D21160)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_OnCaptureResourceCreatedCallback_TypeDefinitionIndex = 5462;
