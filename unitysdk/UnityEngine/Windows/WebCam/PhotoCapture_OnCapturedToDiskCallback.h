...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A28CD40)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A28CDB0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A28C980)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A28C960)
