...
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D01B80)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D01BF0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D017C0)
#define UNITYENGINE_WINDOWS_WEBCAM_PHOTOCAPTURE_ONCAPTUREDTODISKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19D017B0)

namespace UnityEngine::Windows::WebCam
{
	inline static constexpr unsigned int PhotoCapture_OnCapturedToDiskCallback_TypeDefinitionIndex = 5465;
