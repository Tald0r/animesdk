...
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONERRORHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1981A4C0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONERRORHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1981A520)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONERRORHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19819F60)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONERRORHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19819F50)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int DictationRecognizer_DictationErrorHandler_TypeDefinitionIndex = 5451;
