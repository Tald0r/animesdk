...
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_PHRASERECOGNIZEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19DE4760)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_PHRASERECOGNIZEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19DE47D0)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_PHRASERECOGNIZEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DE42A0)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_PHRASERECOGNIZEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE4290)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int PhraseRecognizer_PhraseRecognizedDelegate_TypeDefinitionIndex = 5446;
