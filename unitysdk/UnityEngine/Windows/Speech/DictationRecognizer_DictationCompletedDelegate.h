...
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONCOMPLETEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19BD3FA0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONCOMPLETEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19BD4010)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONCOMPLETEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19BD3CB0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONCOMPLETEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BD3CA0)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int DictationRecognizer_DictationCompletedDelegate_TypeDefinitionIndex = 5450;
