...
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRESULTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19969070)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRESULTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x199690F0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRESULTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19968AE0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRESULTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19969060)

namespace UnityEngine::Windows::Speech
{
	inline static constexpr unsigned int DictationRecognizer_DictationResultDelegate_TypeDefinitionIndex = 5449;
