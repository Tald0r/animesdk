...
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_DESTROYTHREADED_OFFSET UNITYSDK_OFFSET(0x1A439440)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1A439430)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A439510)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A439460)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_INVOKEPHRASERECOGNIZEDEVENT_OFFSET UNITYSDK_OFFSET(0x1A439570)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER_MARSHALSEMANTICMEANING_OFFSET UNITYSDK_OFFSET(0x1A4395E0)
#define UNITYENGINE_WINDOWS_SPEECH_PHRASERECOGNIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A439450)
