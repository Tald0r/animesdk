...
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_CREATE_OFFSET UNITYSDK_OFFSET(0x19EA87D0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DESTROYTHREADED_OFFSET UNITYSDK_OFFSET(0x19EA87F0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DESTROY_OFFSET UNITYSDK_OFFSET(0x19EA87E0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRECOGNIZER_INVOKECOMPLETEDEVENT_OFFSET UNITYSDK_OFFSET(0x19EA8EE0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRECOGNIZER_INVOKEERROREVENT_OFFSET UNITYSDK_OFFSET(0x19EA8EF0)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRECOGNIZER_INVOKEHYPOTHESISGENERATEDEVENT_OFFSET UNITYSDK_OFFSET(0x19EA8960)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DICTATIONRECOGNIZER_INVOKERESULTGENERATEDEVENT_OFFSET UNITYSDK_OFFSET(0x19EA8970)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19EA8900)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19EA8850)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19EA8830)
#define UNITYENGINE_WINDOWS_SPEECH_DICTATIONRECOGNIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA8800)
