...
#define UNITYENGINE_GUILAYOUTUTILITY_LAYOUTCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3F900)

namespace UnityEngine
{
	inline static constexpr unsigned int GUILayoutUtility_LayoutCache_TypeDefinitionIndex = 6364;
