...
#define UNITYENGINE_YOGA_MEASUREFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18939E50)
#define UNITYENGINE_YOGA_MEASUREFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18939F30)
#define UNITYENGINE_YOGA_MEASUREFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x189397A0)
#define UNITYENGINE_YOGA_MEASUREFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x18937880)

namespace UnityEngine::Yoga
{
	inline static constexpr unsigned int MeasureFunction_TypeDefinitionIndex = 23730;
