...
#define UNITYENGINE_YOGA_YOGANODE_BASELINEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1893A220)
#define UNITYENGINE_YOGA_YOGANODE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1893A590)
#define UNITYENGINE_YOGA_YOGANODE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1893A610)
#define UNITYENGINE_YOGA_YOGANODE_GET_ISBASELINEDEFINED_OFFSET UNITYSDK_OFFSET(0x1893A600)
#define UNITYENGINE_YOGA_YOGANODE_GET_ISMEASUREDEFINED_OFFSET UNITYSDK_OFFSET(0x189377A0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTHEIGHT_OFFSET UNITYSDK_OFFSET(0x18934AF0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTPADDINGBOTTOM_OFFSET UNITYSDK_OFFSET(0x18938100)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTPADDINGLEFT_OFFSET UNITYSDK_OFFSET(0x189380B0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTPADDINGRIGHT_OFFSET UNITYSDK_OFFSET(0x189380E0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTPADDINGTOP_OFFSET UNITYSDK_OFFSET(0x189380C0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTWIDTH_OFFSET UNITYSDK_OFFSET(0x18934AE0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTX_OFFSET UNITYSDK_OFFSET(0x18934AC0)
#define UNITYENGINE_YOGA_YOGANODE_GET_LAYOUTY_OFFSET UNITYSDK_OFFSET(0x18934AD0)
#define UNITYENGINE_YOGA_YOGANODE_MEASUREINTERNAL_OFFSET UNITYSDK_OFFSET(0x1893A0D0)
#define UNITYENGINE_YOGA_YOGANODE_SETMEASUREFUNCTION_OFFSET UNITYSDK_OFFSET(0x18937890)
#define UNITYENGINE_YOGA_YOGANODE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1893A800)
#define UNITYENGINE_YOGA_YOGANODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18936BB0)

namespace UnityEngine::Yoga
{
	inline static constexpr unsigned int YogaNode_TypeDefinitionIndex = 23736;
