...
#define UNITYENGINE_YOGA_NATIVE_YGCONFIGFREEINTERNAL_OFFSET UNITYSDK_OFFSET(0x18E91F80)
#define UNITYENGINE_YOGA_NATIVE_YGCONFIGFREE_OFFSET UNITYSDK_OFFSET(0x18E91F70)
#define UNITYENGINE_YOGA_NATIVE_YGCONFIGGETDEFAULT_OFFSET UNITYSDK_OFFSET(0x18E91F50)
#define UNITYENGINE_YOGA_NATIVE_YGCONFIGNEW_OFFSET UNITYSDK_OFFSET(0x18E91F60)
#define UNITYENGINE_YOGA_NATIVE_YGNODEBASELINEINVOKE_OFFSET UNITYSDK_OFFSET(0x18E92120)
#define UNITYENGINE_YOGA_NATIVE_YGNODEFREEINTERNAL_OFFSET UNITYSDK_OFFSET(0x18E91F30)
#define UNITYENGINE_YOGA_NATIVE_YGNODEFREE_OFFSET UNITYSDK_OFFSET(0x18E91F20)
#define UNITYENGINE_YOGA_NATIVE_YGNODELAYOUTGETHEIGHT_OFFSET UNITYSDK_OFFSET(0x18E92280)
#define UNITYENGINE_YOGA_NATIVE_YGNODELAYOUTGETLEFT_OFFSET UNITYSDK_OFFSET(0x18E92250)
#define UNITYENGINE_YOGA_NATIVE_YGNODELAYOUTGETPADDING_OFFSET UNITYSDK_OFFSET(0x18E92290)
#define UNITYENGINE_YOGA_NATIVE_YGNODELAYOUTGETTOP_OFFSET UNITYSDK_OFFSET(0x18E92260)
#define UNITYENGINE_YOGA_NATIVE_YGNODELAYOUTGETWIDTH_OFFSET UNITYSDK_OFFSET(0x18E92270)
#define UNITYENGINE_YOGA_NATIVE_YGNODEMEASUREINVOKE_OFFSET UNITYSDK_OFFSET(0x18E91FB0)
#define UNITYENGINE_YOGA_NATIVE_YGNODENEWWITHCONFIG_OFFSET UNITYSDK_OFFSET(0x18E91F10)
#define UNITYENGINE_YOGA_NATIVE_YGNODEREMOVEMEASUREFUNC_OFFSET UNITYSDK_OFFSET(0x18E91FA0)
#define UNITYENGINE_YOGA_NATIVE_YGNODESETMEASUREFUNC_OFFSET UNITYSDK_OFFSET(0x18E91F90)
#define UNITYENGINE_YOGA_NATIVE_YGSETMANAGEDOBJECT_OFFSET UNITYSDK_OFFSET(0x18E91F40)

namespace UnityEngine::Yoga
{
	inline static constexpr unsigned int Native_TypeDefinitionIndex = 24418;
