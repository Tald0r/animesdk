...
#define UNITYENGINE_YOGA_MEASUREOUTPUT_MAKE_OFFSET UNITYSDK_OFFSET(0x18937B90)
#define UNITYENGINE_YOGA_MEASUREOUTPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x18939F60)

namespace UnityEngine::Yoga
{
	inline static constexpr unsigned int MeasureOutput_TypeDefinitionIndex = 23731;
