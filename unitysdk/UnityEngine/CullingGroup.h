...
#define UNITYENGINE_CULLINGGROUP_DISPOSEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AA3B7A0)
#define UNITYENGINE_CULLINGGROUP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AA3B7B0)
#define UNITYENGINE_CULLINGGROUP_FINALIZERFAILURE_OFFSET UNITYSDK_OFFSET(0x1AA3B790)
#define UNITYENGINE_CULLINGGROUP_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AA3B720)
#define UNITYENGINE_CULLINGGROUP_GET_TARGETCAMERA_OFFSET UNITYSDK_OFFSET(0x1AA3B7D0)
#define UNITYENGINE_CULLINGGROUP_INIT_OFFSET UNITYSDK_OFFSET(0x1AA3B710)
#define UNITYENGINE_CULLINGGROUP_QUERYINDICES_1_OFFSET UNITYSDK_OFFSET(0x1AA3B840)
#define UNITYENGINE_CULLINGGROUP_QUERYINDICES_OFFSET UNITYSDK_OFFSET(0x1AA3B810)
#define UNITYENGINE_CULLINGGROUP_SENDEVENTS_OFFSET UNITYSDK_OFFSET(0x1AA3B8B0)
#define UNITYENGINE_CULLINGGROUP_SETBOUNDINGDISTANCES_OFFSET UNITYSDK_OFFSET(0x1AA3B850)
#define UNITYENGINE_CULLINGGROUP_SETBOUNDINGSPHERECOUNT_OFFSET UNITYSDK_OFFSET(0x1AA3B800)
#define UNITYENGINE_CULLINGGROUP_SETBOUNDINGSPHERES_OFFSET UNITYSDK_OFFSET(0x1AA3B7F0)
#define UNITYENGINE_CULLINGGROUP_SETDISTANCEREFERENCEPOINT_INTERNALVECTOR3_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AA3B870)
#define UNITYENGINE_CULLINGGROUP_SETDISTANCEREFERENCEPOINT_INTERNALVECTOR3_OFFSET UNITYSDK_OFFSET(0x1AA3B860)
#define UNITYENGINE_CULLINGGROUP_SETDISTANCEREFERENCEPOINT_OFFSET UNITYSDK_OFFSET(0x1AA3B880)
#define UNITYENGINE_CULLINGGROUP_SET_TARGETCAMERA_OFFSET UNITYSDK_OFFSET(0x1AA3B7E0)
#define UNITYENGINE_CULLINGGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA3B6F0)
