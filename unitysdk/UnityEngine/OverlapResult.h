...
#define UNITYENGINE_OVERLAPRESULT_GET_COLLIDERTAG_OFFSET UNITYSDK_OFFSET(0x2D38E0)

namespace UnityEngine
{
	inline static constexpr unsigned int OverlapResult_TypeDefinitionIndex = 7658;
