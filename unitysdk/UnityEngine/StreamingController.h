...
#define UNITYENGINE_STREAMINGCONTROLLER_CANCELPRELOADING_OFFSET UNITYSDK_OFFSET(0x1B776450)
#define UNITYENGINE_STREAMINGCONTROLLER_GET_STREAMINGMIPMAPBIAS_OFFSET UNITYSDK_OFFSET(0x1B776420)
#define UNITYENGINE_STREAMINGCONTROLLER_ISPRELOADING_OFFSET UNITYSDK_OFFSET(0x1B776460)
#define UNITYENGINE_STREAMINGCONTROLLER_SETPRELOADING_OFFSET UNITYSDK_OFFSET(0x1B776440)
#define UNITYENGINE_STREAMINGCONTROLLER_SET_STREAMINGMIPMAPBIAS_OFFSET UNITYSDK_OFFSET(0x1B776430)
#define UNITYENGINE_STREAMINGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B776470)

namespace UnityEngine
{
	inline static constexpr unsigned int StreamingController_TypeDefinitionIndex = 24410;
