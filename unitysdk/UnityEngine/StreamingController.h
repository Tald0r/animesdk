...
#define UNITYENGINE_STREAMINGCONTROLLER_CANCELPRELOADING_OFFSET UNITYSDK_OFFSET(0x1B157300)
#define UNITYENGINE_STREAMINGCONTROLLER_GET_STREAMINGMIPMAPBIAS_OFFSET UNITYSDK_OFFSET(0x1B1572D0)
#define UNITYENGINE_STREAMINGCONTROLLER_ISPRELOADING_OFFSET UNITYSDK_OFFSET(0x1B157310)
#define UNITYENGINE_STREAMINGCONTROLLER_SETPRELOADING_OFFSET UNITYSDK_OFFSET(0x1B1572F0)
#define UNITYENGINE_STREAMINGCONTROLLER_SET_STREAMINGMIPMAPBIAS_OFFSET UNITYSDK_OFFSET(0x1B1572E0)
#define UNITYENGINE_STREAMINGCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B157320)

namespace UnityEngine
{
	inline static constexpr unsigned int StreamingController_TypeDefinitionIndex = 23727;
