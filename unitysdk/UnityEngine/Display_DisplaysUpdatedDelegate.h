...
#define UNITYENGINE_DISPLAY_DISPLAYSUPDATEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1994F690)
#define UNITYENGINE_DISPLAY_DISPLAYSUPDATEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1994F6C0)
#define UNITYENGINE_DISPLAY_DISPLAYSUPDATEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1994F3F0)
#define UNITYENGINE_DISPLAY_DISPLAYSUPDATEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1994F3E0)
