...
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_ADDSOURCE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B762CA0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_ADDSOURCE_OFFSET UNITYSDK_OFFSET(0x1B762C90)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GETSOURCECOUNTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B762BE0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GETSOURCEINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B762E80)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GETSOURCEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B762E40)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GETSOURCES_OFFSET UNITYSDK_OFFSET(0x1B762BF0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GETSOURCE_OFFSET UNITYSDK_OFFSET(0x1B762DF0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_CONSTRAINTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B762B90)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_LOCKED_OFFSET UNITYSDK_OFFSET(0x1B762BB0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_SOURCECOUNT_OFFSET UNITYSDK_OFFSET(0x1B762BD0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_TRANSLATIONATREST_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B762AC0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_TRANSLATIONATREST_OFFSET UNITYSDK_OFFSET(0x1B762A70)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_TRANSLATIONAXIS_OFFSET UNITYSDK_OFFSET(0x1B762B70)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_TRANSLATIONOFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B762B40)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_TRANSLATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1B762AF0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x1B762A50)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B762A40)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_REMOVESOURCEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B762DE0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_REMOVESOURCE_OFFSET UNITYSDK_OFFSET(0x1B762CB0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SETSOURCEINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B762EE0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SETSOURCEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B762ED0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SETSOURCESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B762C80)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SETSOURCES_OFFSET UNITYSDK_OFFSET(0x1B762C00)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SETSOURCE_OFFSET UNITYSDK_OFFSET(0x1B762E90)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_CONSTRAINTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B762BA0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_LOCKED_OFFSET UNITYSDK_OFFSET(0x1B762BC0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_TRANSLATIONATREST_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B762AE0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_TRANSLATIONATREST_OFFSET UNITYSDK_OFFSET(0x1B762AD0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_TRANSLATIONAXIS_OFFSET UNITYSDK_OFFSET(0x1B762B80)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_TRANSLATIONOFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B762B60)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_TRANSLATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1B762B50)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_SET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x1B762A60)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT_VALIDATESOURCEINDEX_OFFSET UNITYSDK_OFFSET(0x1B762CE0)
#define UNITYENGINE_ANIMATIONS_POSITIONCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B762A10)
