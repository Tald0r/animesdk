...
#define UNITYENGINE_ANIMATIONS_PROPERTYSCENEHANDLE_CHECKISVALID_OFFSET UNITYSDK_OFFSET(0x9BDDD0)
#define UNITYENGINE_ANIMATIONS_PROPERTYSCENEHANDLE_GETFLOATINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B771C30)
#define UNITYENGINE_ANIMATIONS_PROPERTYSCENEHANDLE_GETFLOATINTERNAL_OFFSET UNITYSDK_OFFSET(0x9BDE50)
#define UNITYENGINE_ANIMATIONS_PROPERTYSCENEHANDLE_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x9BDDE0)
#define UNITYENGINE_ANIMATIONS_PROPERTYSCENEHANDLE_GET_CREATEDBYNATIVE_OFFSET UNITYSDK_OFFSET(0x34A5E0)
#define UNITYENGINE_ANIMATIONS_PROPERTYSCENEHANDLE_GET_HASHANDLEINDEX_OFFSET UNITYSDK_OFFSET(0x99C870)
#define UNITYENGINE_ANIMATIONS_PROPERTYSCENEHANDLE_HASVALIDTRANSFORM_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B771C20)
#define UNITYENGINE_ANIMATIONS_PROPERTYSCENEHANDLE_HASVALIDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9BDE40)
#define UNITYENGINE_ANIMATIONS_PROPERTYSCENEHANDLE_ISVALIDINTERNAL_OFFSET UNITYSDK_OFFSET(0x9BDD80)
#define UNITYENGINE_ANIMATIONS_PROPERTYSCENEHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x9BDD00)
