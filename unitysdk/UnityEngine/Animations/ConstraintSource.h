...
#define UNITYENGINE_ANIMATIONS_CONSTRAINTSOURCE_GET_SOURCETRANSFORM_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_ANIMATIONS_CONSTRAINTSOURCE_SET_SOURCETRANSFORM_OFFSET UNITYSDK_OFFSET(0x2C3980)

namespace UnityEngine::Animations
{
	inline static constexpr unsigned int ConstraintSource_TypeDefinitionIndex = 6606;
