...
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_BINDSCENEPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x1B135350)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_BINDSCENEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B135320)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_BINDSCENETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B1352E0)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_BINDSTREAMPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x1B135280)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_BINDSTREAMPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B135230)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_BINDSTREAMTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B1351D0)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_INTERNALBINDSCENEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B135390)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_INTERNALBINDSCENETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B135310)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_INTERNALBINDSTREAMPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B1352D0)
#define UNITYENGINE_ANIMATIONS_ANIMATORJOBEXTENSIONS_INTERNALBINDSTREAMTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B135220)

namespace UnityEngine::Animations
{
	inline static constexpr unsigned int AnimatorJobExtensions_TypeDefinitionIndex = 6604;
