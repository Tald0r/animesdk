...
#define UNITYENGINE_ANIMAGERIGASSET_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B7720D0)
#define UNITYENGINE_ANIMAGERIGASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7720A0)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimageRigAsset_TypeDefinitionIndex = 37111;
