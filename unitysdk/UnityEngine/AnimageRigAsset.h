...
#define UNITYENGINE_ANIMAGERIGASSET_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B153200)
#define UNITYENGINE_ANIMAGERIGASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1531D0)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimageRigAsset_TypeDefinitionIndex = 36091;
