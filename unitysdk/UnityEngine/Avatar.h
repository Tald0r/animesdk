...
#define UNITYENGINE_AVATAR_GETAXISLENGTH_OFFSET UNITYSDK_OFFSET(0x1B75CE20)
#define UNITYENGINE_AVATAR_GETBONEPATHS_OFFSET UNITYSDK_OFFSET(0x1B75CEF0)
#define UNITYENGINE_AVATAR_GETPOSTROTATION_OFFSET UNITYSDK_OFFSET(0x1B75CE60)
#define UNITYENGINE_AVATAR_GETSKELETONPOSITION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B75CF50)
#define UNITYENGINE_AVATAR_GETSKELETONPOSITION_OFFSET UNITYSDK_OFFSET(0x1B75CF00)
#define UNITYENGINE_AVATAR_GET_ISHUMAN_OFFSET UNITYSDK_OFFSET(0x1B75CE10)
#define UNITYENGINE_AVATAR_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B75CE00)
#define UNITYENGINE_AVATAR_INTERNAL_GETAXISLENGTH_OFFSET UNITYSDK_OFFSET(0x1B75CE50)
#define UNITYENGINE_AVATAR_INTERNAL_GETPOSTROTATION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B75CEE0)
#define UNITYENGINE_AVATAR_INTERNAL_GETPOSTROTATION_OFFSET UNITYSDK_OFFSET(0x1B75CEA0)
#define UNITYENGINE_AVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75CDE0)
