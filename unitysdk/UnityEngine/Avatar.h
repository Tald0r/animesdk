...
#define UNITYENGINE_AVATAR_GETAXISLENGTH_OFFSET UNITYSDK_OFFSET(0x1B140040)
#define UNITYENGINE_AVATAR_GETBONEPATHS_OFFSET UNITYSDK_OFFSET(0x1B140110)
#define UNITYENGINE_AVATAR_GETPOSTROTATION_OFFSET UNITYSDK_OFFSET(0x1B140080)
#define UNITYENGINE_AVATAR_GETSKELETONPOSITION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B140170)
#define UNITYENGINE_AVATAR_GETSKELETONPOSITION_OFFSET UNITYSDK_OFFSET(0x1B140120)
#define UNITYENGINE_AVATAR_GET_ISHUMAN_OFFSET UNITYSDK_OFFSET(0x1B140030)
#define UNITYENGINE_AVATAR_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B140020)
#define UNITYENGINE_AVATAR_INTERNAL_GETAXISLENGTH_OFFSET UNITYSDK_OFFSET(0x1B140070)
#define UNITYENGINE_AVATAR_INTERNAL_GETPOSTROTATION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B140100)
#define UNITYENGINE_AVATAR_INTERNAL_GETPOSTROTATION_OFFSET UNITYSDK_OFFSET(0x1B1400C0)
#define UNITYENGINE_AVATAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B140000)

namespace UnityEngine
{
	inline static constexpr unsigned int Avatar_TypeDefinitionIndex = 6549;
