...
#define UNITYENGINE_LODGROUP_FORCELODGROUPUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6898A0)
#define UNITYENGINE_LODGROUP_FORCELOD_OFFSET UNITYSDK_OFFSET(0x1A689850)
#define UNITYENGINE_LODGROUP_GETCONFIGDISABLECULLED_OFFSET UNITYSDK_OFFSET(0x1A6898B0)
#define UNITYENGINE_LODGROUP_GETCONFIGREGARDLOD0ASLOD1_OFFSET UNITYSDK_OFFSET(0x1A6898D0)
#define UNITYENGINE_LODGROUP_GETLODSNONALLOC_OFFSET UNITYSDK_OFFSET(0x1A689820)
#define UNITYENGINE_LODGROUP_GETLODS_OFFSET UNITYSDK_OFFSET(0x1A689810)
#define UNITYENGINE_LODGROUP_GET_ANIMATECROSSFADING_OFFSET UNITYSDK_OFFSET(0x1A689780)
#define UNITYENGINE_LODGROUP_GET_CROSSFADEANIMATIONDURATION_OFFSET UNITYSDK_OFFSET(0x1A689870)
#define UNITYENGINE_LODGROUP_GET_DISABLECULLED_OFFSET UNITYSDK_OFFSET(0x1A6897C0)
#define UNITYENGINE_LODGROUP_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A6897A0)
#define UNITYENGINE_LODGROUP_GET_FADEMODE_OFFSET UNITYSDK_OFFSET(0x1A689760)
#define UNITYENGINE_LODGROUP_GET_LOCALREFERENCEPOINT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A6896A0)
#define UNITYENGINE_LODGROUP_GET_LOCALREFERENCEPOINT_OFFSET UNITYSDK_OFFSET(0x1A689650)
#define UNITYENGINE_LODGROUP_GET_LODCOUNT_OFFSET UNITYSDK_OFFSET(0x1A6896F0)
#define UNITYENGINE_LODGROUP_GET_NOCULLEDUSEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A689720)
#define UNITYENGINE_LODGROUP_GET_REGARDLOD0ASLOD1_OFFSET UNITYSDK_OFFSET(0x1A6897E0)
#define UNITYENGINE_LODGROUP_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1A6896D0)
#define UNITYENGINE_LODGROUP_GET_STARTLOD_OFFSET UNITYSDK_OFFSET(0x1A689740)
#define UNITYENGINE_LODGROUP_GET_USEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A689700)
#define UNITYENGINE_LODGROUP_RECALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A689800)
#define UNITYENGINE_LODGROUP_SETCONFIGDISABLECULLED_OFFSET UNITYSDK_OFFSET(0x1A6898C0)
#define UNITYENGINE_LODGROUP_SETCONFIGREGARDLOD0ASLOD1_OFFSET UNITYSDK_OFFSET(0x1A6898E0)
#define UNITYENGINE_LODGROUP_SETLODGROUPUPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1A689890)
#define UNITYENGINE_LODGROUP_SETLODS_1_OFFSET UNITYSDK_OFFSET(0x1A689840)
#define UNITYENGINE_LODGROUP_SETLODS_OFFSET UNITYSDK_OFFSET(0x1A689830)
#define UNITYENGINE_LODGROUP_SETVALIDLODLEVELMASK_OFFSET UNITYSDK_OFFSET(0x1A689860)
#define UNITYENGINE_LODGROUP_SET_ANIMATECROSSFADING_OFFSET UNITYSDK_OFFSET(0x1A689790)
#define UNITYENGINE_LODGROUP_SET_CROSSFADEANIMATIONDURATION_OFFSET UNITYSDK_OFFSET(0x1A689880)
#define UNITYENGINE_LODGROUP_SET_DISABLECULLED_OFFSET UNITYSDK_OFFSET(0x1A6897D0)
#define UNITYENGINE_LODGROUP_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A6897B0)
#define UNITYENGINE_LODGROUP_SET_FADEMODE_OFFSET UNITYSDK_OFFSET(0x1A689770)
#define UNITYENGINE_LODGROUP_SET_LOCALREFERENCEPOINT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A6896C0)
#define UNITYENGINE_LODGROUP_SET_LOCALREFERENCEPOINT_OFFSET UNITYSDK_OFFSET(0x1A6896B0)
#define UNITYENGINE_LODGROUP_SET_NOCULLEDUSEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A689730)
#define UNITYENGINE_LODGROUP_SET_REGARDLOD0ASLOD1_OFFSET UNITYSDK_OFFSET(0x1A6897F0)
#define UNITYENGINE_LODGROUP_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1A6896E0)
#define UNITYENGINE_LODGROUP_SET_STARTLOD_OFFSET UNITYSDK_OFFSET(0x1A689750)
#define UNITYENGINE_LODGROUP_SET_USEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A689710)
#define UNITYENGINE_LODGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6898F0)
