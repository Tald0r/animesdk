...
#define UNITYENGINE_SHADER_CHECKPROPERTYINDEX_OFFSET UNITYSDK_OFFSET(0x19CEFE40)
#define UNITYENGINE_SHADER_CLEANUPPSO_OFFSET UNITYSDK_OFFSET(0x19CEE9B0)
#define UNITYENGINE_SHADER_DEBUGSRPCOMPATIBILITY_OFFSET UNITYSDK_OFFSET(0x19CEE9C0)
#define UNITYENGINE_SHADER_DISABLEKEYWORD_OFFSET UNITYSDK_OFFSET(0x19CEE8E0)
#define UNITYENGINE_SHADER_DUMPSHADERVARIANTS_OFFSET UNITYSDK_OFFSET(0x19CEE9A0)
#define UNITYENGINE_SHADER_ENABLEKEYWORD_OFFSET UNITYSDK_OFFSET(0x19CEE8D0)
#define UNITYENGINE_SHADER_ENABLEPUSHSHADERCOMPILEINFOTOSERVER_OFFSET UNITYSDK_OFFSET(0x19CEED20)
#define UNITYENGINE_SHADER_ENABLESRPCOMPATIBILITYERRORMESSAGE_OFFSET UNITYSDK_OFFSET(0x19CEED10)
#define UNITYENGINE_SHADER_EXTRACTGLOBALFLOATARRAYIMPL_OFFSET UNITYSDK_OFFSET(0x19CEECA0)
#define UNITYENGINE_SHADER_EXTRACTGLOBALFLOATARRAY_OFFSET UNITYSDK_OFFSET(0x19CEF000)
#define UNITYENGINE_SHADER_EXTRACTGLOBALMATRIXARRAYIMPL_OFFSET UNITYSDK_OFFSET(0x19CEECC0)
#define UNITYENGINE_SHADER_EXTRACTGLOBALMATRIXARRAY_OFFSET UNITYSDK_OFFSET(0x19CEF200)
#define UNITYENGINE_SHADER_EXTRACTGLOBALVECTORARRAYIMPL_OFFSET UNITYSDK_OFFSET(0x19CEECB0)
#define UNITYENGINE_SHADER_EXTRACTGLOBALVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x19CEF100)
#define UNITYENGINE_SHADER_FINDBUILTIN_OFFSET UNITYSDK_OFFSET(0x19CEE850)
#define UNITYENGINE_SHADER_FINDPASSTAGVALUE_OFFSET UNITYSDK_OFFSET(0x19CEEA00)
#define UNITYENGINE_SHADER_FINDPROPERTYINDEX_OFFSET UNITYSDK_OFFSET(0x19CEFED0)
#define UNITYENGINE_SHADER_FIND_OFFSET UNITYSDK_OFFSET(0x19CEE840)
#define UNITYENGINE_SHADER_GETAUTOHIBERNATION_OFFSET UNITYSDK_OFFSET(0x19CEE980)
#define UNITYENGINE_SHADER_GETDEPENDENCY_OFFSET UNITYSDK_OFFSET(0x19CEE9D0)
#define UNITYENGINE_SHADER_GETGLOBALCOLOR_1_OFFSET UNITYSDK_OFFSET(0x19CEFA70)
#define UNITYENGINE_SHADER_GETGLOBALCOLOR_OFFSET UNITYSDK_OFFSET(0x19CEFA30)
#define UNITYENGINE_SHADER_GETGLOBALFLOATARRAYCOUNTIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEC70)
#define UNITYENGINE_SHADER_GETGLOBALFLOATARRAYIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEC40)
#define UNITYENGINE_SHADER_GETGLOBALFLOATARRAY_1_OFFSET UNITYSDK_OFFSET(0x19CEFBD0)
#define UNITYENGINE_SHADER_GETGLOBALFLOATARRAY_2_OFFSET UNITYSDK_OFFSET(0x19CEFCC0)
#define UNITYENGINE_SHADER_GETGLOBALFLOATARRAY_3_OFFSET UNITYSDK_OFFSET(0x19CEFCE0)
#define UNITYENGINE_SHADER_GETGLOBALFLOATARRAY_OFFSET UNITYSDK_OFFSET(0x19CEFBA0)
#define UNITYENGINE_SHADER_GETGLOBALFLOATIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEB40)
#define UNITYENGINE_SHADER_GETGLOBALFLOAT_1_OFFSET UNITYSDK_OFFSET(0x19CEF970)
#define UNITYENGINE_SHADER_GETGLOBALFLOAT_OFFSET UNITYSDK_OFFSET(0x19CEF950)
#define UNITYENGINE_SHADER_GETGLOBALINT_1_OFFSET UNITYSDK_OFFSET(0x19CEF9A0)
#define UNITYENGINE_SHADER_GETGLOBALINT_OFFSET UNITYSDK_OFFSET(0x19CEF980)
#define UNITYENGINE_SHADER_GETGLOBALMATRIXARRAYCOUNTIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEC90)
#define UNITYENGINE_SHADER_GETGLOBALMATRIXARRAYIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEC60)
#define UNITYENGINE_SHADER_GETGLOBALMATRIXARRAY_1_OFFSET UNITYSDK_OFFSET(0x19CEFC90)
#define UNITYENGINE_SHADER_GETGLOBALMATRIXARRAY_2_OFFSET UNITYSDK_OFFSET(0x19CEFD20)
#define UNITYENGINE_SHADER_GETGLOBALMATRIXARRAY_3_OFFSET UNITYSDK_OFFSET(0x19CEFD40)
#define UNITYENGINE_SHADER_GETGLOBALMATRIXARRAY_OFFSET UNITYSDK_OFFSET(0x19CEFC60)
#define UNITYENGINE_SHADER_GETGLOBALMATRIXIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19CEEBF0)
#define UNITYENGINE_SHADER_GETGLOBALMATRIXIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEB90)
#define UNITYENGINE_SHADER_GETGLOBALMATRIX_1_OFFSET UNITYSDK_OFFSET(0x19CEFB10)
#define UNITYENGINE_SHADER_GETGLOBALMATRIX_OFFSET UNITYSDK_OFFSET(0x19CEFAA0)
#define UNITYENGINE_SHADER_GETGLOBALTEXTUREIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEC00)
#define UNITYENGINE_SHADER_GETGLOBALTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x19CEFB90)
#define UNITYENGINE_SHADER_GETGLOBALTEXTURE_OFFSET UNITYSDK_OFFSET(0x19CEFB70)
#define UNITYENGINE_SHADER_GETGLOBALVECTORARRAYCOUNTIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEC80)
#define UNITYENGINE_SHADER_GETGLOBALVECTORARRAYIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEC50)
#define UNITYENGINE_SHADER_GETGLOBALVECTORARRAY_1_OFFSET UNITYSDK_OFFSET(0x19CEFC30)
#define UNITYENGINE_SHADER_GETGLOBALVECTORARRAY_2_OFFSET UNITYSDK_OFFSET(0x19CEFCF0)
#define UNITYENGINE_SHADER_GETGLOBALVECTORARRAY_3_OFFSET UNITYSDK_OFFSET(0x19CEFD10)
#define UNITYENGINE_SHADER_GETGLOBALVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x19CEFC00)
#define UNITYENGINE_SHADER_GETGLOBALVECTORIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19CEEB80)
#define UNITYENGINE_SHADER_GETGLOBALVECTORIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEB50)
#define UNITYENGINE_SHADER_GETGLOBALVECTOR_1_OFFSET UNITYSDK_OFFSET(0x19CEFA00)
#define UNITYENGINE_SHADER_GETGLOBALVECTOR_OFFSET UNITYSDK_OFFSET(0x19CEF9C0)
#define UNITYENGINE_SHADER_GETPROPERTYATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x19CF01B0)
#define UNITYENGINE_SHADER_GETPROPERTYATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19CEFDC0)
#define UNITYENGINE_SHADER_GETPROPERTYCOUNT_OFFSET UNITYSDK_OFFSET(0x19CEFEC0)
#define UNITYENGINE_SHADER_GETPROPERTYDEFAULTFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x19CF0240)
#define UNITYENGINE_SHADER_GETPROPERTYDEFAULTVALUE_INJECTED_OFFSET UNITYSDK_OFFSET(0x19CEFE10)
#define UNITYENGINE_SHADER_GETPROPERTYDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x19CEFDD0)
#define UNITYENGINE_SHADER_GETPROPERTYDEFAULTVECTORVALUE_OFFSET UNITYSDK_OFFSET(0x19CF0400)
#define UNITYENGINE_SHADER_GETPROPERTYDESCRIPTION_1_OFFSET UNITYSDK_OFFSET(0x19CF0090)
#define UNITYENGINE_SHADER_GETPROPERTYDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19CEFDA0)
#define UNITYENGINE_SHADER_GETPROPERTYFLAGS_1_OFFSET UNITYSDK_OFFSET(0x19CF0120)
#define UNITYENGINE_SHADER_GETPROPERTYFLAGS_OFFSET UNITYSDK_OFFSET(0x19CEFDB0)
#define UNITYENGINE_SHADER_GETPROPERTYNAMEID_1_OFFSET UNITYSDK_OFFSET(0x19CEFF70)
#define UNITYENGINE_SHADER_GETPROPERTYNAMEID_OFFSET UNITYSDK_OFFSET(0x19CEFD80)
#define UNITYENGINE_SHADER_GETPROPERTYNAME_1_OFFSET UNITYSDK_OFFSET(0x19CEFEE0)
#define UNITYENGINE_SHADER_GETPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x19CEFD70)
#define UNITYENGINE_SHADER_GETPROPERTYRANGELIMITS_OFFSET UNITYSDK_OFFSET(0x19CF0590)
#define UNITYENGINE_SHADER_GETPROPERTYTEXTUREDEFAULTNAME_1_OFFSET UNITYSDK_OFFSET(0x19CF08C0)
#define UNITYENGINE_SHADER_GETPROPERTYTEXTUREDEFAULTNAME_OFFSET UNITYSDK_OFFSET(0x19CEFE30)
#define UNITYENGINE_SHADER_GETPROPERTYTEXTUREDIMENSION_1_OFFSET UNITYSDK_OFFSET(0x19CF0750)
#define UNITYENGINE_SHADER_GETPROPERTYTEXTUREDIMENSION_OFFSET UNITYSDK_OFFSET(0x19CEFE20)
#define UNITYENGINE_SHADER_GETPROPERTYTYPE_1_OFFSET UNITYSDK_OFFSET(0x19CF0000)
#define UNITYENGINE_SHADER_GETPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x19CEFD90)
#define UNITYENGINE_SHADER_GET_DISABLEBATCHING_OFFSET UNITYSDK_OFFSET(0x19CEE910)
#define UNITYENGINE_SHADER_GET_GLOBALMAXIMUMLOD_OFFSET UNITYSDK_OFFSET(0x19CEE880)
#define UNITYENGINE_SHADER_GET_GLOBALRENDERPIPELINE_OFFSET UNITYSDK_OFFSET(0x19CEE8B0)
#define UNITYENGINE_SHADER_GET_GLOBALSHADERHARDWARETIER_OFFSET UNITYSDK_OFFSET(0x19CEE7E0)
#define UNITYENGINE_SHADER_GET_ISSUPPORTED_OFFSET UNITYSDK_OFFSET(0x19CEE8A0)
#define UNITYENGINE_SHADER_GET_MAXIMUMLOD_OFFSET UNITYSDK_OFFSET(0x19CEE860)
#define UNITYENGINE_SHADER_GET_PASSCOUNT_OFFSET UNITYSDK_OFFSET(0x19CEE9F0)
#define UNITYENGINE_SHADER_GET_RENDERQUEUE_OFFSET UNITYSDK_OFFSET(0x19CEE900)
#define UNITYENGINE_SHADER_GET_SUPPORTASYNCCREATE_OFFSET UNITYSDK_OFFSET(0x19CEECF0)
#define UNITYENGINE_SHADER_HIBERNATEALLSHADERS_OFFSET UNITYSDK_OFFSET(0x19CEE970)
#define UNITYENGINE_SHADER_IDTOPROPERTY_OFFSET UNITYSDK_OFFSET(0x19CEE950)
#define UNITYENGINE_SHADER_IDTOTAG_OFFSET UNITYSDK_OFFSET(0x19CEE940)
#define UNITYENGINE_SHADER_INTERNAL_CALLONSHADERCOMPILE_OFFSET UNITYSDK_OFFSET(0x19CEECD0)
#define UNITYENGINE_SHADER_INTERNAL_FINDPASSTAGVALUE_OFFSET UNITYSDK_OFFSET(0x19CEEA90)
#define UNITYENGINE_SHADER_ISKEYWORDENABLED_OFFSET UNITYSDK_OFFSET(0x19CEE8F0)
#define UNITYENGINE_SHADER_KEYWORDTOID_OFFSET UNITYSDK_OFFSET(0x19CEE960)
#define UNITYENGINE_SHADER_PROPERTYTOID_OFFSET UNITYSDK_OFFSET(0x19CEBA60)
#define UNITYENGINE_SHADER_SETAUTOHIBERNATION_OFFSET UNITYSDK_OFFSET(0x19CEE990)
#define UNITYENGINE_SHADER_SETFORCESRPCOMPATIBILITY_OFFSET UNITYSDK_OFFSET(0x19CEE9E0)
#define UNITYENGINE_SHADER_SETGLOBALBUFFERIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEB10)
#define UNITYENGINE_SHADER_SETGLOBALBUFFER_1_OFFSET UNITYSDK_OFFSET(0x19CEF560)
#define UNITYENGINE_SHADER_SETGLOBALBUFFER_OFFSET UNITYSDK_OFFSET(0x19CEF530)
#define UNITYENGINE_SHADER_SETGLOBALCOLOR_1_OFFSET UNITYSDK_OFFSET(0x19CEF400)
#define UNITYENGINE_SHADER_SETGLOBALCOLOR_OFFSET UNITYSDK_OFFSET(0x19CEF3D0)
#define UNITYENGINE_SHADER_SETGLOBALCONSTANTBUFFERIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEB20)
#define UNITYENGINE_SHADER_SETGLOBALCONSTANTBUFFER_OFFSET UNITYSDK_OFFSET(0x19CEF570)
#define UNITYENGINE_SHADER_SETGLOBALFLOATARRAYIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEC10)
#define UNITYENGINE_SHADER_SETGLOBALFLOATARRAY_1_OFFSET UNITYSDK_OFFSET(0x19CEF5C0)
#define UNITYENGINE_SHADER_SETGLOBALFLOATARRAY_2_OFFSET UNITYSDK_OFFSET(0x19CEF630)
#define UNITYENGINE_SHADER_SETGLOBALFLOATARRAY_3_OFFSET UNITYSDK_OFFSET(0x19CEF6A0)
#define UNITYENGINE_SHADER_SETGLOBALFLOATARRAY_4_OFFSET UNITYSDK_OFFSET(0x19CEF6D0)
#define UNITYENGINE_SHADER_SETGLOBALFLOATARRAY_OFFSET UNITYSDK_OFFSET(0x19CEED30)
#define UNITYENGINE_SHADER_SETGLOBALFLOATIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEAA0)
#define UNITYENGINE_SHADER_SETGLOBALFLOAT_1_OFFSET UNITYSDK_OFFSET(0x19CEF330)
#define UNITYENGINE_SHADER_SETGLOBALFLOAT_OFFSET UNITYSDK_OFFSET(0x19CEF300)
#define UNITYENGINE_SHADER_SETGLOBALINT_1_OFFSET UNITYSDK_OFFSET(0x19CEF370)
#define UNITYENGINE_SHADER_SETGLOBALINT_OFFSET UNITYSDK_OFFSET(0x19CEF340)
#define UNITYENGINE_SHADER_SETGLOBALMATRIXARRAYIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEC30)
#define UNITYENGINE_SHADER_SETGLOBALMATRIXARRAY_1_OFFSET UNITYSDK_OFFSET(0x19CEF820)
#define UNITYENGINE_SHADER_SETGLOBALMATRIXARRAY_2_OFFSET UNITYSDK_OFFSET(0x19CEF890)
#define UNITYENGINE_SHADER_SETGLOBALMATRIXARRAY_3_OFFSET UNITYSDK_OFFSET(0x19CEF900)
#define UNITYENGINE_SHADER_SETGLOBALMATRIXARRAY_4_OFFSET UNITYSDK_OFFSET(0x19CEF930)
#define UNITYENGINE_SHADER_SETGLOBALMATRIXARRAY_OFFSET UNITYSDK_OFFSET(0x19CEEF10)
#define UNITYENGINE_SHADER_SETGLOBALMATRIXIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19CEEAE0)
#define UNITYENGINE_SHADER_SETGLOBALMATRIXIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEAD0)
#define UNITYENGINE_SHADER_SETGLOBALMATRIX_1_OFFSET UNITYSDK_OFFSET(0x19CEF470)
#define UNITYENGINE_SHADER_SETGLOBALMATRIX_OFFSET UNITYSDK_OFFSET(0x19CEF420)
#define UNITYENGINE_SHADER_SETGLOBALRAYTRACINGACCELERATIONSTRUCTUREIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEB30)
#define UNITYENGINE_SHADER_SETGLOBALRAYTRACINGACCELERATIONSTRUCTURE_1_OFFSET UNITYSDK_OFFSET(0x19CEF5B0)
#define UNITYENGINE_SHADER_SETGLOBALRAYTRACINGACCELERATIONSTRUCTURE_OFFSET UNITYSDK_OFFSET(0x19CEF580)
#define UNITYENGINE_SHADER_SETGLOBALRENDERTEXTUREIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEB00)
#define UNITYENGINE_SHADER_SETGLOBALTEXTUREIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEAF0)
#define UNITYENGINE_SHADER_SETGLOBALTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x19CEF4E0)
#define UNITYENGINE_SHADER_SETGLOBALTEXTURE_2_OFFSET UNITYSDK_OFFSET(0x19CEF4F0)
#define UNITYENGINE_SHADER_SETGLOBALTEXTURE_3_OFFSET UNITYSDK_OFFSET(0x19CEF520)
#define UNITYENGINE_SHADER_SETGLOBALTEXTURE_OFFSET UNITYSDK_OFFSET(0x19CEF4B0)
#define UNITYENGINE_SHADER_SETGLOBALVECTORARRAYIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEC20)
#define UNITYENGINE_SHADER_SETGLOBALVECTORARRAY_1_OFFSET UNITYSDK_OFFSET(0x19CEF6F0)
#define UNITYENGINE_SHADER_SETGLOBALVECTORARRAY_2_OFFSET UNITYSDK_OFFSET(0x19CEF760)
#define UNITYENGINE_SHADER_SETGLOBALVECTORARRAY_3_OFFSET UNITYSDK_OFFSET(0x19CEF7D0)
#define UNITYENGINE_SHADER_SETGLOBALVECTORARRAY_4_OFFSET UNITYSDK_OFFSET(0x19CEF800)
#define UNITYENGINE_SHADER_SETGLOBALVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x19CEEE20)
#define UNITYENGINE_SHADER_SETGLOBALVECTORIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19CEEAC0)
#define UNITYENGINE_SHADER_SETGLOBALVECTORIMPL_OFFSET UNITYSDK_OFFSET(0x19CEEAB0)
#define UNITYENGINE_SHADER_SETGLOBALVECTOR_1_OFFSET UNITYSDK_OFFSET(0x19CEF3B0)
#define UNITYENGINE_SHADER_SETGLOBALVECTOR_OFFSET UNITYSDK_OFFSET(0x19CEF380)
#define UNITYENGINE_SHADER_SET_GLOBALMAXIMUMLOD_OFFSET UNITYSDK_OFFSET(0x19CEE890)
#define UNITYENGINE_SHADER_SET_GLOBALRENDERPIPELINE_OFFSET UNITYSDK_OFFSET(0x19CEE8C0)
#define UNITYENGINE_SHADER_SET_GLOBALSHADERHARDWARETIER_OFFSET UNITYSDK_OFFSET(0x19CEE810)
#define UNITYENGINE_SHADER_SET_MAXIMUMLOD_OFFSET UNITYSDK_OFFSET(0x19CEE870)
#define UNITYENGINE_SHADER_SET_SUPPORTASYNCCREATE_OFFSET UNITYSDK_OFFSET(0x19CEED00)
#define UNITYENGINE_SHADER_TAGTOID_OFFSET UNITYSDK_OFFSET(0x19CEE930)
#define UNITYENGINE_SHADER_WARMUPALLSHADERS_OFFSET UNITYSDK_OFFSET(0x19CEE920)
#define UNITYENGINE_SHADER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CEFD50)
