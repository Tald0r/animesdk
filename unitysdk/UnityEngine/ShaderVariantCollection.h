...
#define UNITYENGINE_SHADERVARIANTCOLLECTION_ADDVARIANT_OFFSET UNITYSDK_OFFSET(0x1A40BC40)
#define UNITYENGINE_SHADERVARIANTCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1A40BCD0)
#define UNITYENGINE_SHADERVARIANTCOLLECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A40BC70)
#define UNITYENGINE_SHADERVARIANTCOLLECTION_CONTAINSVARIANT_OFFSET UNITYSDK_OFFSET(0x1A40BC60)
#define UNITYENGINE_SHADERVARIANTCOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A40BD30)
#define UNITYENGINE_SHADERVARIANTCOLLECTION_GET_ISWARMEDUP_OFFSET UNITYSDK_OFFSET(0x1A40BC30)
#define UNITYENGINE_SHADERVARIANTCOLLECTION_GET_SHADERCOUNT_OFFSET UNITYSDK_OFFSET(0x1A40BC10)
#define UNITYENGINE_SHADERVARIANTCOLLECTION_GET_VARIANTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A40BC20)
#define UNITYENGINE_SHADERVARIANTCOLLECTION_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1A40BC90)
#define UNITYENGINE_SHADERVARIANTCOLLECTION_REMOVEVARIANT_OFFSET UNITYSDK_OFFSET(0x1A40BC50)
#define UNITYENGINE_SHADERVARIANTCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A40BD00)
#define UNITYENGINE_SHADERVARIANTCOLLECTION_WARMUP_OFFSET UNITYSDK_OFFSET(0x1A40BC80)
#define UNITYENGINE_SHADERVARIANTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A40BCA0)
