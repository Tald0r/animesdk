...
#define UNITYENGINE_SUBLAYEREXTENSIONS_TOTAG_OFFSET UNITYSDK_OFFSET(0x17CCE200)

namespace UnityEngine
{
	inline static constexpr unsigned int SubLayerExtensions_TypeDefinitionIndex = 45256;
