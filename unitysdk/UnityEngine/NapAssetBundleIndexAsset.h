...
#define UNITYENGINE_NAPASSETBUNDLEINDEXASSET_GETALLASSETHASH_OFFSET UNITYSDK_OFFSET(0x1B756EE0)
#define UNITYENGINE_NAPASSETBUNDLEINDEXASSET_GETALLBUNDLEID_OFFSET UNITYSDK_OFFSET(0x1B756EF0)
#define UNITYENGINE_NAPASSETBUNDLEINDEXASSET_GETBUNDLEIDFROMASSETHASH_OFFSET UNITYSDK_OFFSET(0x1B756EC0)
#define UNITYENGINE_NAPASSETBUNDLEINDEXASSET_GETBUNDLEINFO_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B756EB0)
#define UNITYENGINE_NAPASSETBUNDLEINDEXASSET_GETBUNDLEINFO_OFFSET UNITYSDK_OFFSET(0x1B756E60)
#define UNITYENGINE_NAPASSETBUNDLEINDEXASSET_GETCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B756ED0)
#define UNITYENGINE_NAPASSETBUNDLEINDEXASSET_SETENABLEBUNDLEINDEXMEMORYOPT_OFFSET UNITYSDK_OFFSET(0x1B756F20)
#define UNITYENGINE_NAPASSETBUNDLEINDEXASSET_SETNEXT_OFFSET UNITYSDK_OFFSET(0x1B756F00)
#define UNITYENGINE_NAPASSETBUNDLEINDEXASSET_SETRESOURCEFILETYPE_OFFSET UNITYSDK_OFFSET(0x1B756F10)
#define UNITYENGINE_NAPASSETBUNDLEINDEXASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B756E40)
