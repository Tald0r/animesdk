...
#define UNITYENGINE_SQLITE3_BACKUPFINISH_OFFSET UNITYSDK_OFFSET(0x19D00C40)
#define UNITYENGINE_SQLITE3_BACKUPINIT_OFFSET UNITYSDK_OFFSET(0x19D00C20)
#define UNITYENGINE_SQLITE3_BACKUPSTEP_OFFSET UNITYSDK_OFFSET(0x19D00C30)
#define UNITYENGINE_SQLITE3_BINDBLOB_OFFSET UNITYSDK_OFFSET(0x19D00990)
#define UNITYENGINE_SQLITE3_BINDDOUBLE_OFFSET UNITYSDK_OFFSET(0x19D00970)
#define UNITYENGINE_SQLITE3_BINDINT64_OFFSET UNITYSDK_OFFSET(0x19D00960)
#define UNITYENGINE_SQLITE3_BINDINT_OFFSET UNITYSDK_OFFSET(0x19D00950)
#define UNITYENGINE_SQLITE3_BINDNULL_OFFSET UNITYSDK_OFFSET(0x19D00940)
#define UNITYENGINE_SQLITE3_BINDPARAMETERINDEX_OFFSET UNITYSDK_OFFSET(0x19D00930)
#define UNITYENGINE_SQLITE3_BINDTEXT_OFFSET UNITYSDK_OFFSET(0x19D00980)
#define UNITYENGINE_SQLITE3_BUSYTIMEOUT_OFFSET UNITYSDK_OFFSET(0x19D007D0)
#define UNITYENGINE_SQLITE3_CHANGES_OFFSET UNITYSDK_OFFSET(0x19D007E0)
#define UNITYENGINE_SQLITE3_CLOSE2_OFFSET UNITYSDK_OFFSET(0x19D007C0)
#define UNITYENGINE_SQLITE3_CLOSE_OFFSET UNITYSDK_OFFSET(0x19D007B0)
#define UNITYENGINE_SQLITE3_COLUMNBLOB_OFFSET UNITYSDK_OFFSET(0x19D00AC0)
#define UNITYENGINE_SQLITE3_COLUMNBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x19D00B90)
#define UNITYENGINE_SQLITE3_COLUMNBYTES_OFFSET UNITYSDK_OFFSET(0x19D00AD0)
#define UNITYENGINE_SQLITE3_COLUMNCOUNT_OFFSET UNITYSDK_OFFSET(0x19D009A0)
#define UNITYENGINE_SQLITE3_COLUMNDOUBLE_OFFSET UNITYSDK_OFFSET(0x19D00AA0)
#define UNITYENGINE_SQLITE3_COLUMNINT64_OFFSET UNITYSDK_OFFSET(0x19D00A90)
#define UNITYENGINE_SQLITE3_COLUMNINT_OFFSET UNITYSDK_OFFSET(0x19D00A80)
#define UNITYENGINE_SQLITE3_COLUMNNAME16INTERNAL_OFFSET UNITYSDK_OFFSET(0x19D009B0)
#define UNITYENGINE_SQLITE3_COLUMNNAME16_OFFSET UNITYSDK_OFFSET(0x19D009C0)
#define UNITYENGINE_SQLITE3_COLUMNSTRING_OFFSET UNITYSDK_OFFSET(0x19D00AE0)
#define UNITYENGINE_SQLITE3_COLUMNTEXT16_OFFSET UNITYSDK_OFFSET(0x19D00AB0)
#define UNITYENGINE_SQLITE3_COLUMNTYPE_OFFSET UNITYSDK_OFFSET(0x19D00A70)
#define UNITYENGINE_SQLITE3_ENABLELOADEXTENSION_OFFSET UNITYSDK_OFFSET(0x19D007A0)
#define UNITYENGINE_SQLITE3_ERRMSG_OFFSET UNITYSDK_OFFSET(0x19D00870)
#define UNITYENGINE_SQLITE3_EXTENDEDERRCODE_OFFSET UNITYSDK_OFFSET(0x19D00C00)
#define UNITYENGINE_SQLITE3_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19D00850)
#define UNITYENGINE_SQLITE3_GETERRMSG_OFFSET UNITYSDK_OFFSET(0x19D00880)
#define UNITYENGINE_SQLITE3_GETRESULT_OFFSET UNITYSDK_OFFSET(0x19D00BF0)
#define UNITYENGINE_SQLITE3_LASTINSERTROWID_OFFSET UNITYSDK_OFFSET(0x19D00860)
#define UNITYENGINE_SQLITE3_LIBVERSIONNUMBER_OFFSET UNITYSDK_OFFSET(0x19D00C10)
#define UNITYENGINE_SQLITE3_OPEN_1_OFFSET UNITYSDK_OFFSET(0x19D00720)
#define UNITYENGINE_SQLITE3_OPEN_2_OFFSET UNITYSDK_OFFSET(0x19D00760)
#define UNITYENGINE_SQLITE3_OPEN_OFFSET UNITYSDK_OFFSET(0x19D00710)
#define UNITYENGINE_SQLITE3_OPEN_V2_OFFSET UNITYSDK_OFFSET(0x19D00750)
#define UNITYENGINE_SQLITE3_PREPARE2_OFFSET UNITYSDK_OFFSET(0x19D00800)
#define UNITYENGINE_SQLITE3_PREPARE_V2_OFFSET UNITYSDK_OFFSET(0x19D007F0)
#define UNITYENGINE_SQLITE3_RESET_OFFSET UNITYSDK_OFFSET(0x19D00840)
#define UNITYENGINE_SQLITE3_STEP_OFFSET UNITYSDK_OFFSET(0x19D00830)
#define UNITYENGINE_SQLITE3__CTOR_OFFSET UNITYSDK_OFFSET(0x19D00C50)

namespace UnityEngine
{
	inline static constexpr unsigned int SQLite3_TypeDefinitionIndex = 5388;
