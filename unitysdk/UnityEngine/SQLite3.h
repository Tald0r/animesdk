...
#define UNITYENGINE_SQLITE3_BACKUPFINISH_OFFSET UNITYSDK_OFFSET(0x1A28BDF0)
#define UNITYENGINE_SQLITE3_BACKUPINIT_OFFSET UNITYSDK_OFFSET(0x1A28BDD0)
#define UNITYENGINE_SQLITE3_BACKUPSTEP_OFFSET UNITYSDK_OFFSET(0x1A28BDE0)
#define UNITYENGINE_SQLITE3_BINDBLOB_OFFSET UNITYSDK_OFFSET(0x1A28BB40)
#define UNITYENGINE_SQLITE3_BINDDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A28BB20)
#define UNITYENGINE_SQLITE3_BINDINT64_OFFSET UNITYSDK_OFFSET(0x1A28BB10)
#define UNITYENGINE_SQLITE3_BINDINT_OFFSET UNITYSDK_OFFSET(0x1A28BB00)
#define UNITYENGINE_SQLITE3_BINDNULL_OFFSET UNITYSDK_OFFSET(0x1A28BAF0)
#define UNITYENGINE_SQLITE3_BINDPARAMETERINDEX_OFFSET UNITYSDK_OFFSET(0x1A28BAE0)
#define UNITYENGINE_SQLITE3_BINDTEXT_OFFSET UNITYSDK_OFFSET(0x1A28BB30)
#define UNITYENGINE_SQLITE3_BUSYTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A28B980)
#define UNITYENGINE_SQLITE3_CHANGES_OFFSET UNITYSDK_OFFSET(0x1A28B990)
#define UNITYENGINE_SQLITE3_CLOSE2_OFFSET UNITYSDK_OFFSET(0x1A28B970)
#define UNITYENGINE_SQLITE3_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A28B960)
#define UNITYENGINE_SQLITE3_COLUMNBLOB_OFFSET UNITYSDK_OFFSET(0x1A28BC70)
#define UNITYENGINE_SQLITE3_COLUMNBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1A28BD40)
#define UNITYENGINE_SQLITE3_COLUMNBYTES_OFFSET UNITYSDK_OFFSET(0x1A28BC80)
#define UNITYENGINE_SQLITE3_COLUMNCOUNT_OFFSET UNITYSDK_OFFSET(0x1A28BB50)
#define UNITYENGINE_SQLITE3_COLUMNDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A28BC50)
#define UNITYENGINE_SQLITE3_COLUMNINT64_OFFSET UNITYSDK_OFFSET(0x1A28BC40)
#define UNITYENGINE_SQLITE3_COLUMNINT_OFFSET UNITYSDK_OFFSET(0x1A28BC30)
#define UNITYENGINE_SQLITE3_COLUMNNAME16INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A28BB60)
#define UNITYENGINE_SQLITE3_COLUMNNAME16_OFFSET UNITYSDK_OFFSET(0x1A28BB70)
#define UNITYENGINE_SQLITE3_COLUMNSTRING_OFFSET UNITYSDK_OFFSET(0x1A28BC90)
#define UNITYENGINE_SQLITE3_COLUMNTEXT16_OFFSET UNITYSDK_OFFSET(0x1A28BC60)
#define UNITYENGINE_SQLITE3_COLUMNTYPE_OFFSET UNITYSDK_OFFSET(0x1A28BC20)
#define UNITYENGINE_SQLITE3_ENABLELOADEXTENSION_OFFSET UNITYSDK_OFFSET(0x1A28B950)
#define UNITYENGINE_SQLITE3_ERRMSG_OFFSET UNITYSDK_OFFSET(0x1A28BA20)
#define UNITYENGINE_SQLITE3_EXTENDEDERRCODE_OFFSET UNITYSDK_OFFSET(0x1A28BDB0)
#define UNITYENGINE_SQLITE3_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A28BA00)
#define UNITYENGINE_SQLITE3_GETERRMSG_OFFSET UNITYSDK_OFFSET(0x1A28BA30)
#define UNITYENGINE_SQLITE3_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1A28BDA0)
#define UNITYENGINE_SQLITE3_LASTINSERTROWID_OFFSET UNITYSDK_OFFSET(0x1A28BA10)
#define UNITYENGINE_SQLITE3_LIBVERSIONNUMBER_OFFSET UNITYSDK_OFFSET(0x1A28BDC0)
#define UNITYENGINE_SQLITE3_OPEN_1_OFFSET UNITYSDK_OFFSET(0x1A28B8D0)
#define UNITYENGINE_SQLITE3_OPEN_2_OFFSET UNITYSDK_OFFSET(0x1A28B910)
#define UNITYENGINE_SQLITE3_OPEN_OFFSET UNITYSDK_OFFSET(0x1A28B8C0)
#define UNITYENGINE_SQLITE3_OPEN_V2_OFFSET UNITYSDK_OFFSET(0x1A28B900)
#define UNITYENGINE_SQLITE3_PREPARE2_OFFSET UNITYSDK_OFFSET(0x1A28B9B0)
#define UNITYENGINE_SQLITE3_PREPARE_V2_OFFSET UNITYSDK_OFFSET(0x1A28B9A0)
#define UNITYENGINE_SQLITE3_RESET_OFFSET UNITYSDK_OFFSET(0x1A28B9F0)
#define UNITYENGINE_SQLITE3_STEP_OFFSET UNITYSDK_OFFSET(0x1A28B9E0)
#define UNITYENGINE_SQLITE3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A28BE00)
