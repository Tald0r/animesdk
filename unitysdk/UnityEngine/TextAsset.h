...
#define UNITYENGINE_TEXTASSET_CASTTOSCRIPTINGSTRING_OFFSET UNITYSDK_OFFSET(0x1A36EA70)
#define UNITYENGINE_TEXTASSET_GETRAWDATABYTELENGTH_OFFSET UNITYSDK_OFFSET(0x1A36EA60)
#define UNITYENGINE_TEXTASSET_GETRAWDATAPTR_OFFSET UNITYSDK_OFFSET(0x1A36EA50)
#define UNITYENGINE_TEXTASSET_GET_BYTES_OFFSET UNITYSDK_OFFSET(0x1A36E940)
#define UNITYENGINE_TEXTASSET_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x1A361E00)
#define UNITYENGINE_TEXTASSET_INTERNAL_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A36EA40)
#define UNITYENGINE_TEXTASSET_SETBYTES_OFFSET UNITYSDK_OFFSET(0x1A36E950)
#define UNITYENGINE_TEXTASSET_SETTEXT_OFFSET UNITYSDK_OFFSET(0x1A36E930)
#define UNITYENGINE_TEXTASSET_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A36E960)
#define UNITYENGINE_TEXTASSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A36EA00)
#define UNITYENGINE_TEXTASSET__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A36E9B0)
#define UNITYENGINE_TEXTASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A36E970)
