...
#define UNITYENGINE_PROFILING_EXPERIMENTAL_DEBUGSCREENCAPTURE_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x379D90)
#define UNITYENGINE_PROFILING_EXPERIMENTAL_DEBUGSCREENCAPTURE_SET_IMAGEFORMAT_OFFSET UNITYSDK_OFFSET(0x3197D0)
#define UNITYENGINE_PROFILING_EXPERIMENTAL_DEBUGSCREENCAPTURE_SET_RAWIMAGEDATAREFERENCE_OFFSET UNITYSDK_OFFSET(0x2FB050)
#define UNITYENGINE_PROFILING_EXPERIMENTAL_DEBUGSCREENCAPTURE_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x34CE60)

namespace UnityEngine::Profiling::Experimental
{
	inline static constexpr unsigned int DebugScreenCapture_TypeDefinitionIndex = 5433;
