...
#define UNITYENGINE_PROFILING_PROFILER_ENDTHREADPROFILING_OFFSET UNITYSDK_OFFSET(0x19E4F430)
#define UNITYENGINE_PROFILING_PROFILER_GETMONOHEAPSIZELONG_OFFSET UNITYSDK_OFFSET(0x19E4F450)
#define UNITYENGINE_PROFILING_PROFILER_GETMONOUSEDSIZELONG_OFFSET UNITYSDK_OFFSET(0x19E4F460)
#define UNITYENGINE_PROFILING_PROFILER_GETNAPASSETMEMSTATS_OFFSET UNITYSDK_OFFSET(0x19E4F510)
#define UNITYENGINE_PROFILING_PROFILER_GETNAPENGINESTATS_OFFSET UNITYSDK_OFFSET(0x19E4F500)
#define UNITYENGINE_PROFILING_PROFILER_GETRUNTIMEMEMORYSIZELONG_OFFSET UNITYSDK_OFFSET(0x19E4F440)
#define UNITYENGINE_PROFILING_PROFILER_GETSYSTEMMEMORYUSEDANDTOTALLONGSIZE_1_OFFSET UNITYSDK_OFFSET(0x19E4F480)
#define UNITYENGINE_PROFILING_PROFILER_GETSYSTEMMEMORYUSEDANDTOTALLONGSIZE_OFFSET UNITYSDK_OFFSET(0x19E4F470)
#define UNITYENGINE_PROFILING_PROFILER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E4F520)
#define UNITYENGINE_PROFILING_PROFILER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E4F420)

namespace UnityEngine::Profiling
{
	inline static constexpr unsigned int Profiler_TypeDefinitionIndex = 5429;
