...
#define UNITYENGINE_PROFILING_PROFILER_ENDTHREADPROFILING_OFFSET UNITYSDK_OFFSET(0x1A433B00)
#define UNITYENGINE_PROFILING_PROFILER_GETMONOHEAPSIZELONG_OFFSET UNITYSDK_OFFSET(0x1A433B20)
#define UNITYENGINE_PROFILING_PROFILER_GETMONOUSEDSIZELONG_OFFSET UNITYSDK_OFFSET(0x1A433B30)
#define UNITYENGINE_PROFILING_PROFILER_GETNAPASSETMEMSTATS_OFFSET UNITYSDK_OFFSET(0x1A433BE0)
#define UNITYENGINE_PROFILING_PROFILER_GETNAPENGINESTATS_OFFSET UNITYSDK_OFFSET(0x1A433BD0)
#define UNITYENGINE_PROFILING_PROFILER_GETOBJECTMEMORYSIZE_OFFSET UNITYSDK_OFFSET(0x1A433BF0)
#define UNITYENGINE_PROFILING_PROFILER_GETRUNTIMEMEMORYSIZELONG_OFFSET UNITYSDK_OFFSET(0x1A433B10)
#define UNITYENGINE_PROFILING_PROFILER_GETSYSTEMMEMORYUSEDANDTOTALLONGSIZE_1_OFFSET UNITYSDK_OFFSET(0x1A433B50)
#define UNITYENGINE_PROFILING_PROFILER_GETSYSTEMMEMORYUSEDANDTOTALLONGSIZE_OFFSET UNITYSDK_OFFSET(0x1A433B40)
#define UNITYENGINE_PROFILING_PROFILER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A433C00)
#define UNITYENGINE_PROFILING_PROFILER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A433AF0)
...
namespace UnityEngine::Profiling
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Profiler_TypeDefinitionIndex)->GetStaticField(0x2E70);
		}
		static ::System::Int32* StaticGet_MainThreadID()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Profiler_TypeDefinitionIndex)->GetStaticField(0x2E74);
		}
