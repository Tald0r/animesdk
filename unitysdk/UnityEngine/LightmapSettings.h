...
#define UNITYENGINE_LIGHTMAPSETTINGS_CHECKLIGHTMAPSANDAREADIRECT_OFFSET UNITYSDK_OFFSET(0x19E8FAD0)
#define UNITYENGINE_LIGHTMAPSETTINGS_GETKODAMAASSETPATH_OFFSET UNITYSDK_OFFSET(0x19E8FAB0)
#define UNITYENGINE_LIGHTMAPSETTINGS_GET_ENABLEKODAMALIGHTINGV2_OFFSET UNITYSDK_OFFSET(0x19E8FB00)
#define UNITYENGINE_LIGHTMAPSETTINGS_GET_KODAMABINDATA_OFFSET UNITYSDK_OFFSET(0x19E8FA50)
#define UNITYENGINE_LIGHTMAPSETTINGS_GET_LIGHTMAPS_OFFSET UNITYSDK_OFFSET(0x19E8FA10)
#define UNITYENGINE_LIGHTMAPSETTINGS_GET_LIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x19E8FA30)
#define UNITYENGINE_LIGHTMAPSETTINGS_ISKODAMALIGHTINGV2_OFFSET UNITYSDK_OFFSET(0x19E8FAF0)
#define UNITYENGINE_LIGHTMAPSETTINGS_ISUSINGLIGHTSKYOC_OFFSET UNITYSDK_OFFSET(0x19E8FAE0)
#define UNITYENGINE_LIGHTMAPSETTINGS_LIGHTMAPAREADIRTEXTUREBYINDEX_OFFSET UNITYSDK_OFFSET(0x19E8FA90)
#define UNITYENGINE_LIGHTMAPSETTINGS_LIGHTMAPLIGHTCOLORTEXTUREBYINDEX_OFFSET UNITYSDK_OFFSET(0x19E8FA80)
#define UNITYENGINE_LIGHTMAPSETTINGS_LIGHTMAPSLENGTH_OFFSET UNITYSDK_OFFSET(0x19E8FA70)
#define UNITYENGINE_LIGHTMAPSETTINGS_SETCURRENTKODAMARENDER_OFFSET UNITYSDK_OFFSET(0x19E8FAA0)
#define UNITYENGINE_LIGHTMAPSETTINGS_SETKODAMARENDER_OFFSET UNITYSDK_OFFSET(0x19E8FAC0)
#define UNITYENGINE_LIGHTMAPSETTINGS_SET_KODAMABINDATA_OFFSET UNITYSDK_OFFSET(0x19E8FA60)
#define UNITYENGINE_LIGHTMAPSETTINGS_SET_LIGHTMAPS_OFFSET UNITYSDK_OFFSET(0x19E8FA20)
#define UNITYENGINE_LIGHTMAPSETTINGS_SET_LIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x19E8FA40)
#define UNITYENGINE_LIGHTMAPSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19E8F9F0)
