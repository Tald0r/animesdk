...
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x189D7640)
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x189D7E10)
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS_RELEASETEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x189D7EA0)
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x189D7590)
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x189D7F80)

namespace UnityEngine::NAPRenderPipeline
{
	inline static constexpr unsigned int CopyCharacterColorPass_TypeDefinitionIndex = 29209;
