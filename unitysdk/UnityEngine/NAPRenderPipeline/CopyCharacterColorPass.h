...
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x18381560)
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x18381D30)
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS_RELEASETEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x18381DC0)
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x183814B0)
#define UNITYENGINE_NAPRENDERPIPELINE_COPYCHARACTERCOLORPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x18381EA0)

namespace UnityEngine::NAPRenderPipeline
{
	inline static constexpr unsigned int CopyCharacterColorPass_TypeDefinitionIndex = 28268;
