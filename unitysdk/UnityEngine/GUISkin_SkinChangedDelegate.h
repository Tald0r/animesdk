...
#define UNITYENGINE_GUISKIN_SKINCHANGEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C44550)
#define UNITYENGINE_GUISKIN_SKINCHANGEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C44580)
#define UNITYENGINE_GUISKIN_SKINCHANGEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C441B0)
#define UNITYENGINE_GUISKIN_SKINCHANGEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C44540)

namespace UnityEngine
{
	inline static constexpr unsigned int GUISkin_SkinChangedDelegate_TypeDefinitionIndex = 6367;
