...
#define UNITYENGINE_UIELEMENTS_CURSOR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x870FF0)
#define UNITYENGINE_UIELEMENTS_CURSOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x870FE0)
#define UNITYENGINE_UIELEMENTS_CURSOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8710C0)
#define UNITYENGINE_UIELEMENTS_CURSOR_GET_DEFAULTCURSORID_OFFSET UNITYSDK_OFFSET(0x302AD0)
#define UNITYENGINE_UIELEMENTS_CURSOR_GET_HOTSPOT_OFFSET UNITYSDK_OFFSET(0x272280)
#define UNITYENGINE_UIELEMENTS_CURSOR_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_UIELEMENTS_CURSOR_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18E70020)
#define UNITYENGINE_UIELEMENTS_CURSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8710D0)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int Cursor_TypeDefinitionIndex = 24421;
