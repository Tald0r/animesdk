...
#define UNITYENGINE_UIELEMENTS_MOUSECAPTUREDISPATCHINGSTRATEGY_CANDISPATCHEVENT_OFFSET UNITYSDK_OFFSET(0x18E7C1E0)
#define UNITYENGINE_UIELEMENTS_MOUSECAPTUREDISPATCHINGSTRATEGY_DISPATCHEVENT_OFFSET UNITYSDK_OFFSET(0x18E7C250)
#define UNITYENGINE_UIELEMENTS_MOUSECAPTUREDISPATCHINGSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E74280)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int MouseCaptureDispatchingStrategy_TypeDefinitionIndex = 24512;
