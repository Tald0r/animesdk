...
#define UNITYENGINE_UIELEMENTS_COMMANDEVENTDISPATCHINGSTRATEGY_CANDISPATCHEVENT_OFFSET UNITYSDK_OFFSET(0x18E6DFD0)
#define UNITYENGINE_UIELEMENTS_COMMANDEVENTDISPATCHINGSTRATEGY_DISPATCHEVENT_OFFSET UNITYSDK_OFFSET(0x18E6E010)
#define UNITYENGINE_UIELEMENTS_COMMANDEVENTDISPATCHINGSTRATEGY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E6F7A0)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int CommandEventDispatchingStrategy_TypeDefinitionIndex = 24474;
