...
#define UNITYENGINE_UIELEMENTS_STYLEVALUEHANDLE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x2C3E30)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int StyleValueHandle_TypeDefinitionIndex = 23905;
