...
#define UNITYENGINE_UIELEMENTS_STYLESHEET_CUSTOMSTARTSWITH_OFFSET UNITYSDK_OFFSET(0x1892D880)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_GET_COMPLEXSELECTORS_OFFSET UNITYSDK_OFFSET(0x1892D850)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_GET_RULES_OFFSET UNITYSDK_OFFSET(0x1892D030)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1892D870)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_READASSETREFERENCE_OFFSET UNITYSDK_OFFSET(0x1892E150)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_READCOLOR_OFFSET UNITYSDK_OFFSET(0x1892DC80)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_READDIMENSION_OFFSET UNITYSDK_OFFSET(0x1892DAD0)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_READENUM_OFFSET UNITYSDK_OFFSET(0x1892DE80)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_READFLOAT_OFFSET UNITYSDK_OFFSET(0x1892D930)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_READFUNCTIONNAME_OFFSET UNITYSDK_OFFSET(0x1892E250)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_READFUNCTION_OFFSET UNITYSDK_OFFSET(0x1892E240)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_READKEYWORD_OFFSET UNITYSDK_OFFSET(0x1892D920)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_READRESOURCEPATH_OFFSET UNITYSDK_OFFSET(0x1892E060)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_READSCALABLEIMAGE_OFFSET UNITYSDK_OFFSET(0x1892E3E0)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_READSTRING_OFFSET UNITYSDK_OFFSET(0x1892DD90)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_READVARIABLE_OFFSET UNITYSDK_OFFSET(0x1892DF70)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_SETUPREFERENCES_OFFSET UNITYSDK_OFFSET(0x1892D050)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_SET_COMPLEXSELECTORS_OFFSET UNITYSDK_OFFSET(0x1892D860)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_SET_RULES_OFFSET UNITYSDK_OFFSET(0x1892D040)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_TRYREADASSETREFERENCE_OFFSET UNITYSDK_OFFSET(0x1892E1C0)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_TRYREADCOLOR_OFFSET UNITYSDK_OFFSET(0x1892DD10)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_TRYREADDIMENSION_OFFSET UNITYSDK_OFFSET(0x1892DB90)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_TRYREADENUM_OFFSET UNITYSDK_OFFSET(0x1892DEF0)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_TRYREADFLOAT_OFFSET UNITYSDK_OFFSET(0x1892D9F0)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_TRYREADRESOURCEPATH_OFFSET UNITYSDK_OFFSET(0x1892E0D0)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_TRYREADSTRING_OFFSET UNITYSDK_OFFSET(0x1892DE00)
#define UNITYENGINE_UIELEMENTS_STYLESHEET_TRYREADVARIABLE_OFFSET UNITYSDK_OFFSET(0x1892DFE0)
#define UNITYENGINE_UIELEMENTS_STYLESHEET__CCTOR_OFFSET UNITYSDK_OFFSET(0x1892E4A0)
#define UNITYENGINE_UIELEMENTS_STYLESHEET__CTOR_OFFSET UNITYSDK_OFFSET(0x1892E470)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int StyleSheet_TypeDefinitionIndex = 23902;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(StyleSheet_TypeDefinitionIndex)->GetStaticField(0x1D6D0);
		}
