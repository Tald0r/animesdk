...
#define UNITYENGINE_UIELEMENTS_VISUALTREEUPDATER_UPDATERARRAY_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x18E90E70)
#define UNITYENGINE_UIELEMENTS_VISUALTREEUPDATER_UPDATERARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18E90E30)
#define UNITYENGINE_UIELEMENTS_VISUALTREEUPDATER_UPDATERARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x18E90EB0)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int VisualTreeUpdater_UpdaterArray_TypeDefinitionIndex = 24466;
