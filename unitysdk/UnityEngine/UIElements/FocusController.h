...
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_ABOUTTOGRABFOCUS_OFFSET UNITYSDK_OFFSET(0x1891D9A0)
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_ABOUTTORELEASEFOCUS_OFFSET UNITYSDK_OFFSET(0x1891D5B0)
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_DOFOCUSCHANGE_OFFSET UNITYSDK_OFFSET(0x18915A70)
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_GETLEAFFOCUSEDELEMENT_OFFSET UNITYSDK_OFFSET(0x18916230)
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_GET_FOCUSRING_OFFSET UNITYSDK_OFFSET(0x1891D580)
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_GET_IMGUIKEYBOARDCONTROL_OFFSET UNITYSDK_OFFSET(0x1891E370)
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_GRABFOCUS_OFFSET UNITYSDK_OFFSET(0x1891DB30)
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_RELEASEFOCUS_OFFSET UNITYSDK_OFFSET(0x1891D810)
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_SET_IMGUIKEYBOARDCONTROL_OFFSET UNITYSDK_OFFSET(0x1891E380)
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_SWITCHFOCUSONEVENT_OFFSET UNITYSDK_OFFSET(0x1891E0D0)
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_SWITCHFOCUS_1_OFFSET UNITYSDK_OFFSET(0x1891DD80)
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_SWITCHFOCUS_OFFSET UNITYSDK_OFFSET(0x1891DCC0)
#define UNITYENGINE_UIELEMENTS_FOCUSCONTROLLER_SYNCIMGUIFOCUS_OFFSET UNITYSDK_OFFSET(0x1891E390)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int FocusController_TypeDefinitionIndex = 23748;
