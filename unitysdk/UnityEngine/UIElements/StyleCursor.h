...
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x844F20)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x844E30)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x844F30)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_GET_KEYWORD_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x844DE0)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1892C1B0)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x844F70)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int StyleCursor_TypeDefinitionIndex = 23883;
