...
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8719A0)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x8718B0)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8719B0)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_GET_KEYWORD_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x871860)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18E84140)
#define UNITYENGINE_UIELEMENTS_STYLECURSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8719F0)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int StyleCursor_TypeDefinitionIndex = 24566;
