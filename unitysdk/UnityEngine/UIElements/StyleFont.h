...
#define UNITYENGINE_UIELEMENTS_STYLEFONT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x871CC0)
#define UNITYENGINE_UIELEMENTS_STYLEFONT_EQUALS_OFFSET UNITYSDK_OFFSET(0x871C10)
#define UNITYENGINE_UIELEMENTS_STYLEFONT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x871CD0)
#define UNITYENGINE_UIELEMENTS_STYLEFONT_GET_KEYWORD_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_UIELEMENTS_STYLEFONT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x871C00)
#define UNITYENGINE_UIELEMENTS_STYLEFONT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x18E846C0)
#define UNITYENGINE_UIELEMENTS_STYLEFONT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x871D50)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int StyleFont_TypeDefinitionIndex = 24569;
