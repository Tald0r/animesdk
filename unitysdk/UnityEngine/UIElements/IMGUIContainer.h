...
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18E7B5A0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18E7B550)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_DOIMGUIREPAINT_OFFSET UNITYSDK_OFFSET(0x18E79E20)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_DOMEASURE_OFFSET UNITYSDK_OFFSET(0x18E7AFD0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_DOONGUI_OFFSET UNITYSDK_OFFSET(0x18E78280)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_EXECUTEDEFAULTACTION_OFFSET UNITYSDK_OFFSET(0x18E7AD70)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GETCURRENTTRANSFORMANDCLIP_OFFSET UNITYSDK_OFFSET(0x18E7AA20)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_CACHE_OFFSET UNITYSDK_OFFSET(0x18E77330)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_CANGRABFOCUS_OFFSET UNITYSDK_OFFSET(0x18E77460)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_CONTEXTTYPE_OFFSET UNITYSDK_OFFSET(0x18E77430)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_FOCUSONLYIFHASFOCUSABLECONTROLS_OFFSET UNITYSDK_OFFSET(0x18E77450)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_GUISTATE_OFFSET UNITYSDK_OFFSET(0x18E77200)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_LASTWORLDCLIP_OFFSET UNITYSDK_OFFSET(0x18E77310)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_LAYOUTMEASUREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x18E773D0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_LAYOUTMEASUREDWIDTH_OFFSET UNITYSDK_OFFSET(0x18E77370)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_GET_ONGUIHANDLER_OFFSET UNITYSDK_OFFSET(0x18E77140)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x18E79DB0)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_HANDLEIMGUIEVENT_1_OFFSET UNITYSDK_OFFSET(0x18E7A930)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_HANDLEIMGUIEVENT_2_OFFSET UNITYSDK_OFFSET(0x18E7A310)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_HANDLEIMGUIEVENT_OFFSET UNITYSDK_OFFSET(0x18E7A840)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_MARKDIRTYLAYOUT_OFFSET UNITYSDK_OFFSET(0x18E79D70)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_ONGENERATEVISUALCONTENT_OFFSET UNITYSDK_OFFSET(0x18E77E00)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_RESTOREGLOBALS_OFFSET UNITYSDK_OFFSET(0x18E78100)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_SAVEGLOBALS_OFFSET UNITYSDK_OFFSET(0x18E77F50)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_SENDEVENTTOIMGUI_OFFSET UNITYSDK_OFFSET(0x18E6E280)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_SET_CONTEXTTYPE_OFFSET UNITYSDK_OFFSET(0x18E77440)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_SET_LASTWORLDCLIP_OFFSET UNITYSDK_OFFSET(0x18E77320)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER_SET_ONGUIHANDLER_OFFSET UNITYSDK_OFFSET(0x18E77150)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18E7B610)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18E77560)
#define UNITYENGINE_UIELEMENTS_IMGUICONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x18E77550)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int IMGUIContainer_TypeDefinitionIndex = 24433;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(IMGUIContainer_TypeDefinitionIndex)->GetStaticField(0x1DDC0);
		}
