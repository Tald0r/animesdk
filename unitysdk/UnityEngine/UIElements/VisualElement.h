...
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_ADDTOCLASSLIST_OFFSET UNITYSDK_OFFSET(0x18E77B50)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_ASSIGNMEASUREFUNCTION_OFFSET UNITYSDK_OFFSET(0x18E8F6E0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_COMPUTEAAALIGNEDBOUND_OFFSET UNITYSDK_OFFSET(0x18E7A1E0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_CONTAINSPOINT_OFFSET UNITYSDK_OFFSET(0x18E8F560)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_DOMEASURE_OFFSET UNITYSDK_OFFSET(0x18E8F830)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_EXECUTEDEFAULTACTION_OFFSET UNITYSDK_OFFSET(0x18E8EBA0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_FOCUS_OFFSET UNITYSDK_OFFSET(0x18E8F290)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_BOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x18E8CBF0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_CANGRABFOCUS_OFFSET UNITYSDK_OFFSET(0x18E77480)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_COMPUTEDSTYLE_OFFSET UNITYSDK_OFFSET(0x18E8E990)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_CONTENTCONTAINER_OFFSET UNITYSDK_OFFSET(0x18E8FFE0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ELEMENTPANEL_OFFSET UNITYSDK_OFFSET(0x18E8FFD0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ENABLEDINHIERARCHY_OFFSET UNITYSDK_OFFSET(0x18E7E920)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ENABLEDSELF_OFFSET UNITYSDK_OFFSET(0x18E8F3C0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_FOCUSCONTROLLER_OFFSET UNITYSDK_OFFSET(0x18E76B60)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_GENERATEVISUALCONTENT_OFFSET UNITYSDK_OFFSET(0x18E8F540)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_HIERARCHY_OFFSET UNITYSDK_OFFSET(0x18E8FFB0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_INHERITEDSTYLE_OFFSET UNITYSDK_OFFSET(0x18E6F800)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISCOMPOSITEROOT_OFFSET UNITYSDK_OFFSET(0x18E8C890)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISLAYOUTMANUAL_OFFSET UNITYSDK_OFFSET(0x18E8C9F0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISWORLDCLIPDIRTY_OFFSET UNITYSDK_OFFSET(0x18E8DD60)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISWORLDTRANSFORMDIRTY_OFFSET UNITYSDK_OFFSET(0x18E8D720)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_ISWORLDTRANSFORMINVERSEDIRTY_OFFSET UNITYSDK_OFFSET(0x18E8D740)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x18E7AC00)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18E8E8E0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_PANEL_OFFSET UNITYSDK_OFFSET(0x18E79720)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x18E8C8A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_PICKINGMODE_OFFSET UNITYSDK_OFFSET(0x18E8E8D0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_PSEUDOSTATES_OFFSET UNITYSDK_OFFSET(0x18E8E860)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_RECT_OFFSET UNITYSDK_OFFSET(0x18E8D580)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_RESOLVEDSTYLE_OFFSET UNITYSDK_OFFSET(0x18E7E6C0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_SPECIFIEDSTYLE_OFFSET UNITYSDK_OFFSET(0x18E6F7D0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x18E8C930)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_VISIBLE_OFFSET UNITYSDK_OFFSET(0x18E7E8C0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x18E7E7A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDBOUND_OFFSET UNITYSDK_OFFSET(0x18E7B280)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDCLIPMINUSGROUP_OFFSET UNITYSDK_OFFSET(0x18E8E180)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDCLIP_OFFSET UNITYSDK_OFFSET(0x18E7A1A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDTRANSFORMINVERSE_OFFSET UNITYSDK_OFFSET(0x18E8DC40)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_WORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18E7A2B0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_GET_YOGANODE_OFFSET UNITYSDK_OFFSET(0x18E8E970)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_INCREMENTVERSION_OFFSET UNITYSDK_OFFSET(0x18E6BB70)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_MEASURE_OFFSET UNITYSDK_OFFSET(0x18E8F840)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_MULTIPLYMATRIX44POINT2_OFFSET UNITYSDK_OFFSET(0x18E8CBA0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_PROPAGATEENABLEDTOCHILDREN_OFFSET UNITYSDK_OFFSET(0x18E8F440)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_REMOVEFROMCLASSLIST_OFFSET UNITYSDK_OFFSET(0x18E8F3E0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_REMOVEMEASUREFUNCTION_OFFSET UNITYSDK_OFFSET(0x18E8F760)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_RETARGETELEMENT_OFFSET UNITYSDK_OFFSET(0x18E75FF0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x18E756E0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SETENABLEDFROMHIERARCHY_OFFSET UNITYSDK_OFFSET(0x18E8F2E0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SETENABLED_OFFSET UNITYSDK_OFFSET(0x18E8E9C0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_COMPUTEDSTYLE_OFFSET UNITYSDK_OFFSET(0x18E8E9A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_ENABLEDSELF_OFFSET UNITYSDK_OFFSET(0x18E8F3D0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_GENERATEVISUALCONTENT_OFFSET UNITYSDK_OFFSET(0x18E8F550)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_HIERARCHY_OFFSET UNITYSDK_OFFSET(0x18E8FFC0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_ISWORLDCLIPDIRTY_OFFSET UNITYSDK_OFFSET(0x18E8DD70)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_ISWORLDTRANSFORMDIRTY_OFFSET UNITYSDK_OFFSET(0x18E8D730)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_ISWORLDTRANSFORMINVERSEDIRTY_OFFSET UNITYSDK_OFFSET(0x18E8D750)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x18E8E8F0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_PSEUDOSTATES_OFFSET UNITYSDK_OFFSET(0x18E8E870)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_RENDERHINTS_OFFSET UNITYSDK_OFFSET(0x18E8C8B0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_REQUIREMEASUREFUNCTION_OFFSET UNITYSDK_OFFSET(0x18E77D00)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SET_YOGANODE_OFFSET UNITYSDK_OFFSET(0x18E8E980)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SHOULDCLIP_OFFSET UNITYSDK_OFFSET(0x18E7E7F0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_SUBSTRACTBORDERPADDING_OFFSET UNITYSDK_OFFSET(0x18E8E1C0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18E8FAE0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_TRANSFORMALIGNEDRECT_OFFSET UNITYSDK_OFFSET(0x18E8CA40)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_BORDERBOTTOMWIDTH_OFFSET UNITYSDK_OFFSET(0x18E8E750)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_BORDERLEFTWIDTH_OFFSET UNITYSDK_OFFSET(0x18E8E660)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_BORDERRIGHTWIDTH_OFFSET UNITYSDK_OFFSET(0x18E8E700)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_BORDERTOPWIDTH_OFFSET UNITYSDK_OFFSET(0x18E8E6B0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_DISPLAY_OFFSET UNITYSDK_OFFSET(0x18E7E6D0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_PADDINGBOTTOM_OFFSET UNITYSDK_OFFSET(0x18E8E830)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_PADDINGLEFT_OFFSET UNITYSDK_OFFSET(0x18E8E7A0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_PADDINGRIGHT_OFFSET UNITYSDK_OFFSET(0x18E8E800)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_PADDINGTOP_OFFSET UNITYSDK_OFFSET(0x18E8E7D0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_IRESOLVEDSTYLE_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x18E8F4F0)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UNITYENGINE_UIELEMENTS_ITRANSFORM_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x18E8C940)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATEBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x18E8CC30)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATECURSORSTYLE_OFFSET UNITYSDK_OFFSET(0x18E8EF10)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATEWORLDBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x18E8D380)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATEWORLDCLIP_OFFSET UNITYSDK_OFFSET(0x18E8DD80)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18E8D760)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT__ASSIGNMEASUREFUNCTION_B__206_0_OFFSET UNITYSDK_OFFSET(0x18E90190)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x18E90060)
#define UNITYENGINE_UIELEMENTS_VISUALELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18E77800)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int VisualElement_TypeDefinitionIndex = 24459;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x1DF30);
		}
		static ::System::Collections::Generic::List_1<::System::String*>** StaticGet_s_EmptyClassList()
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x1DF38);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>** StaticGet_s_EmptyList()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElement*>**)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x1DF40);
		}
		static ::UnityEngine::Rect* StaticGet_s_InfiniteRect()
		{
			return (::UnityEngine::Rect*)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x4730);
		}
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(VisualElement_TypeDefinitionIndex)->GetStaticField(0x4744);
		}
