...
#define UNITYENGINE_UIELEMENTS_STYLESELECTOR_GET_PARTS_OFFSET UNITYSDK_OFFSET(0x18E83D50)
#define UNITYENGINE_UIELEMENTS_STYLESELECTOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18E83F90)
#define UNITYENGINE_UIELEMENTS_STYLESELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18E84D60)

namespace UnityEngine::UIElements
{
	inline static constexpr unsigned int StyleSelector_TypeDefinitionIndex = 24580;
