...
#define UNITYENGINE_AI_NAVMESH_ADDLINKINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD8FCB0)
#define UNITYENGINE_AI_NAVMESH_ADDLINKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD8FCA0)
#define UNITYENGINE_AI_NAVMESH_ADDLINK_OFFSET UNITYSDK_OFFSET(0x1AD8FC40)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD8FAE0)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATATRANSFORMEDINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD8FC30)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATATRANSFORMEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD8FBC0)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATA_1_OFFSET UNITYSDK_OFFSET(0x1AD8FAF0)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x1AD8FA10)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATHFILTERINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD8FD70)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATHFILTERINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD8FD60)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATHINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD8F940)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD8F930)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATH_1_OFFSET UNITYSDK_OFFSET(0x1AD8FCD0)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATH_OFFSET UNITYSDK_OFFSET(0x1AD8F8A0)
#define UNITYENGINE_AI_NAVMESH_CALCULATETRIANGULATION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD8FA00)
#define UNITYENGINE_AI_NAVMESH_CALCULATETRIANGULATION_OFFSET UNITYSDK_OFFSET(0x1AD8F9C0)
#define UNITYENGINE_AI_NAVMESH_FINDCLOSESTEDGE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD8F960)
#define UNITYENGINE_AI_NAVMESH_FINDCLOSESTEDGE_OFFSET UNITYSDK_OFFSET(0x1AD8F950)
#define UNITYENGINE_AI_NAVMESH_GETAREACOST_OFFSET UNITYSDK_OFFSET(0x1AD8F9A0)
#define UNITYENGINE_AI_NAVMESH_GETAREAFROMNAME_OFFSET UNITYSDK_OFFSET(0x1AD8F9B0)
#define UNITYENGINE_AI_NAVMESH_GETSETTINGSBYID_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD8FDE0)
#define UNITYENGINE_AI_NAVMESH_GETSETTINGSBYID_OFFSET UNITYSDK_OFFSET(0x1AD8FD80)
#define UNITYENGINE_AI_NAVMESH_INTERNALSETLINKOWNER_OFFSET UNITYSDK_OFFSET(0x1AD8FC20)
#define UNITYENGINE_AI_NAVMESH_INTERNALSETOWNER_OFFSET UNITYSDK_OFFSET(0x1AD8FC10)
#define UNITYENGINE_AI_NAVMESH_INTERNAL_CALLONNAVMESHPREUPDATE_OFFSET UNITYSDK_OFFSET(0x1AD8F5C0)
#define UNITYENGINE_AI_NAVMESH_ISVALIDLINKHANDLE_OFFSET UNITYSDK_OFFSET(0x1AD8FC00)
#define UNITYENGINE_AI_NAVMESH_ISVALIDNAVMESHDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x1AD8FBF0)
#define UNITYENGINE_AI_NAVMESH_RAYCAST_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD8F890)
#define UNITYENGINE_AI_NAVMESH_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1AD8F880)
#define UNITYENGINE_AI_NAVMESH_REMOVELINKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD8FCC0)
#define UNITYENGINE_AI_NAVMESH_REMOVENAVMESHDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD8FBE0)
#define UNITYENGINE_AI_NAVMESH_REMOVENAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x1AD8FBD0)
#define UNITYENGINE_AI_NAVMESH_SAMPLEPOSITION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD8F980)
#define UNITYENGINE_AI_NAVMESH_SAMPLEPOSITION_OFFSET UNITYSDK_OFFSET(0x1AD8F970)
#define UNITYENGINE_AI_NAVMESH_SETAREACOST_OFFSET UNITYSDK_OFFSET(0x1AD8F990)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMesh_TypeDefinitionIndex = 23613;
	...
	public:
		...
		{
			return (::UnityEngine::AI::NavMesh_OnNavMeshPreUpdate**)Il2CppClass::FromTypeDefinitionIndex(NavMesh_TypeDefinitionIndex)->GetStaticField(0x1D580);
		}
