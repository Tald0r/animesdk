...
#define UNITYENGINE_AI_NAVMESH_ADDLINKINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3981F0)
#define UNITYENGINE_AI_NAVMESH_ADDLINKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B3981E0)
#define UNITYENGINE_AI_NAVMESH_ADDLINK_OFFSET UNITYSDK_OFFSET(0x1B398180)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B398020)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATATRANSFORMEDINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B398170)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATATRANSFORMEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B398100)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATA_1_OFFSET UNITYSDK_OFFSET(0x1B398030)
#define UNITYENGINE_AI_NAVMESH_ADDNAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x1B397F50)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATHFILTERINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B3982B0)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATHFILTERINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B3982A0)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATHINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B397E80)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B397E70)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATH_1_OFFSET UNITYSDK_OFFSET(0x1B398210)
#define UNITYENGINE_AI_NAVMESH_CALCULATEPATH_OFFSET UNITYSDK_OFFSET(0x1B397DE0)
#define UNITYENGINE_AI_NAVMESH_CALCULATETRIANGULATION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B397F40)
#define UNITYENGINE_AI_NAVMESH_CALCULATETRIANGULATION_OFFSET UNITYSDK_OFFSET(0x1B397F00)
#define UNITYENGINE_AI_NAVMESH_FINDCLOSESTEDGE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B397EA0)
#define UNITYENGINE_AI_NAVMESH_FINDCLOSESTEDGE_OFFSET UNITYSDK_OFFSET(0x1B397E90)
#define UNITYENGINE_AI_NAVMESH_GETAREACOST_OFFSET UNITYSDK_OFFSET(0x1B397EE0)
#define UNITYENGINE_AI_NAVMESH_GETAREAFROMNAME_OFFSET UNITYSDK_OFFSET(0x1B397EF0)
#define UNITYENGINE_AI_NAVMESH_GETSETTINGSBYID_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B398320)
#define UNITYENGINE_AI_NAVMESH_GETSETTINGSBYID_OFFSET UNITYSDK_OFFSET(0x1B3982C0)
#define UNITYENGINE_AI_NAVMESH_INTERNALSETLINKOWNER_OFFSET UNITYSDK_OFFSET(0x1B398160)
#define UNITYENGINE_AI_NAVMESH_INTERNALSETOWNER_OFFSET UNITYSDK_OFFSET(0x1B398150)
#define UNITYENGINE_AI_NAVMESH_INTERNAL_CALLONNAVMESHPREUPDATE_OFFSET UNITYSDK_OFFSET(0x1B397B00)
#define UNITYENGINE_AI_NAVMESH_ISVALIDLINKHANDLE_OFFSET UNITYSDK_OFFSET(0x1B398140)
#define UNITYENGINE_AI_NAVMESH_ISVALIDNAVMESHDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x1B398130)
#define UNITYENGINE_AI_NAVMESH_RAYCAST_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B397DD0)
#define UNITYENGINE_AI_NAVMESH_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1B397DC0)
#define UNITYENGINE_AI_NAVMESH_REMOVELINKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B398200)
#define UNITYENGINE_AI_NAVMESH_REMOVENAVMESHDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B398120)
#define UNITYENGINE_AI_NAVMESH_REMOVENAVMESHDATA_OFFSET UNITYSDK_OFFSET(0x1B398110)
#define UNITYENGINE_AI_NAVMESH_SAMPLEPOSITION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B397EC0)
#define UNITYENGINE_AI_NAVMESH_SAMPLEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B397EB0)
#define UNITYENGINE_AI_NAVMESH_SETAREACOST_OFFSET UNITYSDK_OFFSET(0x1B397ED0)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMesh_TypeDefinitionIndex = 24296;
	...
	public:
		...
		{
			return (::UnityEngine::AI::NavMesh_OnNavMeshPreUpdate**)Il2CppClass::FromTypeDefinitionIndex(NavMesh_TypeDefinitionIndex)->GetStaticField(0x1DD30);
		}
