...
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x993D60)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0x5C5650)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x993C20)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_GET_SOURCEOBJECT_OFFSET UNITYSDK_OFFSET(0x993C50)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x3EAF60)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_INTERNALGETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B399130)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_INTERNALGETOBJECT_OFFSET UNITYSDK_OFFSET(0x1B399010)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_SET_AREA_OFFSET UNITYSDK_OFFSET(0x7E21F0)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_SET_SHAPE_OFFSET UNITYSDK_OFFSET(0x7EA310)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x993C40)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_SET_SOURCEOBJECT_OFFSET UNITYSDK_OFFSET(0x993C60)
#define UNITYENGINE_AI_NAVMESHBUILDSOURCE_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x3EAB30)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMeshBuildSource_TypeDefinitionIndex = 24303;
