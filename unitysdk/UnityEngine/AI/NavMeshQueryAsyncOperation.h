...
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATION_CANCEL_OFFSET UNITYSDK_OFFSET(0x1B39A510)
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATION_GETCORNERSNONALLOC_OFFSET UNITYSDK_OFFSET(0x1B39A450)
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATION_GETNATIVECORNERS_OFFSET UNITYSDK_OFFSET(0x1B39A500)
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATION_GET_CORNERCOUNT_OFFSET UNITYSDK_OFFSET(0x1B39A440)
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATION_GET_STATUSNUM_OFFSET UNITYSDK_OFFSET(0x1B39A430)
#define UNITYENGINE_AI_NAVMESHQUERYASYNCOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B39A520)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMeshQueryAsyncOperation_TypeDefinitionIndex = 24299;
