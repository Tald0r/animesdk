...
#define UNITYENGINE_AI_NAVMESHMODIFIER_AFFECTSAGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1AFBC760)
#define UNITYENGINE_AI_NAVMESHMODIFIER_GET_ACTIVEMODIFIERS_OFFSET UNITYSDK_OFFSET(0x1AFBC580)
#define UNITYENGINE_AI_NAVMESHMODIFIER_GET_AREA_OFFSET UNITYSDK_OFFSET(0x1AFBC540)
#define UNITYENGINE_AI_NAVMESHMODIFIER_GET_IGNOREFROMBUILD_OFFSET UNITYSDK_OFFSET(0x1AFBC560)
#define UNITYENGINE_AI_NAVMESHMODIFIER_GET_OVERRIDEAREA_OFFSET UNITYSDK_OFFSET(0x1AFBC520)
#define UNITYENGINE_AI_NAVMESHMODIFIER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AFBC6D0)
#define UNITYENGINE_AI_NAVMESHMODIFIER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AFBC5E0)
#define UNITYENGINE_AI_NAVMESHMODIFIER_SET_AREA_OFFSET UNITYSDK_OFFSET(0x1AFBC550)
#define UNITYENGINE_AI_NAVMESHMODIFIER_SET_IGNOREFROMBUILD_OFFSET UNITYSDK_OFFSET(0x1AFBC570)
#define UNITYENGINE_AI_NAVMESHMODIFIER_SET_OVERRIDEAREA_OFFSET UNITYSDK_OFFSET(0x1AFBC530)
#define UNITYENGINE_AI_NAVMESHMODIFIER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFBC840)
#define UNITYENGINE_AI_NAVMESHMODIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFBC7B0)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMeshModifier_TypeDefinitionIndex = 34234;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::AI::NavMeshModifier*>**)Il2CppClass::FromTypeDefinitionIndex(NavMeshModifier_TypeDefinitionIndex)->GetStaticField(0x248C0);
		}
