...
#define UNITYENGINE_AI_NAVMESHQUERYFILTER_GET_AGENTTYPEID_OFFSET UNITYSDK_OFFSET(0x2C50B0)
#define UNITYENGINE_AI_NAVMESHQUERYFILTER_GET_AREAMASK_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define UNITYENGINE_AI_NAVMESHQUERYFILTER_GET_COSTS_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_AI_NAVMESHQUERYFILTER_SETAREACOST_OFFSET UNITYSDK_OFFSET(0x9641C0)
#define UNITYENGINE_AI_NAVMESHQUERYFILTER_SET_AREAMASK_OFFSET UNITYSDK_OFFSET(0x2C6250)
#define UNITYENGINE_AI_NAVMESHQUERYFILTER_SET_COSTS_OFFSET UNITYSDK_OFFSET(0x2C3980)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMeshQueryFilter_TypeDefinitionIndex = 23612;
