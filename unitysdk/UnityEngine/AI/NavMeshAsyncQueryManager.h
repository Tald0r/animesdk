...
#define UNITYENGINE_AI_NAVMESHASYNCQUERYMANAGER_CALCULATEPATHASYNC_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD90850)
#define UNITYENGINE_AI_NAVMESHASYNCQUERYMANAGER_CALCULATEPATHASYNC_OFFSET UNITYSDK_OFFSET(0x1AD90840)
#define UNITYENGINE_AI_NAVMESHASYNCQUERYMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AD90860)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMeshAsyncQueryManager_TypeDefinitionIndex = 23617;
