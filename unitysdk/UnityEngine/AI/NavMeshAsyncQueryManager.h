...
#define UNITYENGINE_AI_NAVMESHASYNCQUERYMANAGER_CALCULATEPATHASYNC_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B398DA0)
#define UNITYENGINE_AI_NAVMESHASYNCQUERYMANAGER_CALCULATEPATHASYNC_OFFSET UNITYSDK_OFFSET(0x1B398D90)
#define UNITYENGINE_AI_NAVMESHASYNCQUERYMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B398DB0)

namespace UnityEngine::AI
{
	inline static constexpr unsigned int NavMeshAsyncQueryManager_TypeDefinitionIndex = 24300;
