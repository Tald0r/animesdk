...
#define UNITYENGINE_KODAMAREALTIMELIGHT_GET_INTENSITYMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x19BC5BF0)
#define UNITYENGINE_KODAMAREALTIMELIGHT_SET_INTENSITYMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x19BC5C00)
#define UNITYENGINE_KODAMAREALTIMELIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC5C10)
