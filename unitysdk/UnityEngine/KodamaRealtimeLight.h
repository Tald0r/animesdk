...
#define UNITYENGINE_KODAMAREALTIMELIGHT_GET_INTENSITYMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1A273D80)
#define UNITYENGINE_KODAMAREALTIMELIGHT_SET_INTENSITYMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1A273D90)
#define UNITYENGINE_KODAMAREALTIMELIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A273DA0)
