...
#define UNITYENGINE_PARTICLECOLLISIONEVENT_GET_INTERSECTION_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define UNITYENGINE_PARTICLECOLLISIONEVENT_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x2D0730)
#define UNITYENGINE_PARTICLECOLLISIONEVENT_GET_VELOCITY_OFFSET UNITYSDK_OFFSET(0x2F8FA0)

namespace UnityEngine
{
	inline static constexpr unsigned int ParticleCollisionEvent_TypeDefinitionIndex = 23716;
