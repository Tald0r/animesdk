...
#define UNITYENGINE_PARTICLECOLLISIONEVENT_GET_INTERSECTION_OFFSET UNITYSDK_OFFSET(0x2EA460)
#define UNITYENGINE_PARTICLECOLLISIONEVENT_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x2F89F0)
#define UNITYENGINE_PARTICLECOLLISIONEVENT_GET_VELOCITY_OFFSET UNITYSDK_OFFSET(0x32FB90)

namespace UnityEngine
{
	inline static constexpr unsigned int ParticleCollisionEvent_TypeDefinitionIndex = 24399;
