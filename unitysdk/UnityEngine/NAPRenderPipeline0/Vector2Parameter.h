...
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR2PARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CFAEC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR2PARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x19CFAEA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR2PARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CFAED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR2PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CFAE80)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Vector2Parameter_TypeDefinitionIndex = 6046;
