...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERQUEUERANGE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E16DB0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapRenderQueueRange_TypeDefinitionIndex = 5841;
