...
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19E170F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_SET_INLINESAMPLER_OFFSET UNITYSDK_OFFSET(0x19E170E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19E17100)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_SET_SAMPLER_OFFSET UNITYSDK_OFFSET(0x19E170D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19E17110)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E16F70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ProfilingSampler_TypeDefinitionIndex = 5964;
