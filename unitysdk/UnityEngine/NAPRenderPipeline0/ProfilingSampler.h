...
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A3E6990)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_SET_INLINESAMPLER_OFFSET UNITYSDK_OFFSET(0x1A3E6980)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A3E69A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER_SET_SAMPLER_OFFSET UNITYSDK_OFFSET(0x1A3E6970)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3E69B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E6810)
