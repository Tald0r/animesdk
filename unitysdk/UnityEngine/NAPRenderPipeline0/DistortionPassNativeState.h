...
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_AFTERCULLSETUP_OFFSET UNITYSDK_OFFSET(0x1995A2E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_CREATENATIVE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1995A320)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1995A220)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1995A310)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1995A2F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1995A2D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1995A250)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1995A2C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1995A1F0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DistortionPassNativeState_TypeDefinitionIndex = 5725;
