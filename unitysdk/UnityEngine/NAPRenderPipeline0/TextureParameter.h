...
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19E4CCA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_INNERREFRESH_OFFSET UNITYSDK_OFFSET(0x19E4CBF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_ISNULLTEX_OFFSET UNITYSDK_OFFSET(0x19E4CF40)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19E4CE30)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_SETTO_OFFSET UNITYSDK_OFFSET(0x19E4CEB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19E4CCB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E4CB50)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TextureParameter_TypeDefinitionIndex = 6049;
