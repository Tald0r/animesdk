...
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A431370)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_INNERREFRESH_OFFSET UNITYSDK_OFFSET(0x1A4312C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_ISNULLTEX_OFFSET UNITYSDK_OFFSET(0x1A431610)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A431500)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_SETTO_OFFSET UNITYSDK_OFFSET(0x1A431580)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A431380)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTUREPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A431220)
