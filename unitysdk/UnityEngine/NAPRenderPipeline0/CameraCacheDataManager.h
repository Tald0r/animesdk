...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1A2FDB50)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER_GETCACHCEDATA_OFFSET UNITYSDK_OFFSET(0x1A2FDD40)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A2FD940)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER_TRIMINVALIDDATA_OFFSET UNITYSDK_OFFSET(0x1A2FDE80)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2FDA70)
