...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x19D17580)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER_GETCACHCEDATA_OFFSET UNITYSDK_OFFSET(0x19D17770)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19D17370)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER_TRIMINVALIDDATA_OFFSET UNITYSDK_OFFSET(0x19D178B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATAMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D174A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CameraCacheDataManager_TypeDefinitionIndex = 6005;
