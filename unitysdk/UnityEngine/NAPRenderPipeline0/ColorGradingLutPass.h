...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A11A3C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_GENERATECOLORGRADINGLUT_OFFSET UNITYSDK_OFFSET(0x1A11A8A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A11B1A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11A2D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ColorGradingLutPass_TypeDefinitionIndex = 5806;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(ColorGradingLutPass_TypeDefinitionIndex)->GetStaticField(0x2E30);
		}
