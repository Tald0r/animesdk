...
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_CREATE_OFFSET UNITYSDK_OFFSET(0x19E47D60)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_DESTROY_OFFSET UNITYSDK_OFFSET(0x19E47F60)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_GETINSTANCEHANDLE_OFFSET UNITYSDK_OFFSET(0x19E48000)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_CREATENATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x19E47CF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_DESTROYNATIVEOBJECT_OFFSET UNITYSDK_OFFSET(0x19E47D00)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x19E47D10)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_SETSETTINGS_OFFSET UNITYSDK_OFFSET(0x19E47D20)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_SETSHADERFEATUREMAPPINGS_OFFSET UNITYSDK_OFFSET(0x19E47D50)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_UPDATEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x19E47D40)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_INTERNAL_UPDATETARGETS_OFFSET UNITYSDK_OFFSET(0x19E47D30)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_SETSHADERFEATUREMAPPINGS_OFFSET UNITYSDK_OFFSET(0x19E48550)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_UPDATEPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x19E48250)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_UPDATESETTINGS_OFFSET UNITYSDK_OFFSET(0x19E483D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS_UPDATETARGETS_OFFSET UNITYSDK_OFFSET(0x19E480C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWBINDINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E487D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PerObjectShadowBindings_TypeDefinitionIndex = 6113;
	...
	public:
		...
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(PerObjectShadowBindings_TypeDefinitionIndex)->GetStaticField(0x2E50);
		}
