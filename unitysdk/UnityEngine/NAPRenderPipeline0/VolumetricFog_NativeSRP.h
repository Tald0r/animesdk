...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOG_NATIVESRP_CHECKVISIABLE_OFFSET UNITYSDK_OFFSET(0x1A40A8E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOG_NATIVESRP_DRAWLOCALVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1A40A460)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOG_NATIVESRP_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A40AB30)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOG_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A40AB80)
