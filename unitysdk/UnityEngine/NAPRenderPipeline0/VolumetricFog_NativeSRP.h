...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOG_NATIVESRP_CHECKVISIABLE_OFFSET UNITYSDK_OFFSET(0x19E41B70)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOG_NATIVESRP_DRAWLOCALVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x19E416F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOG_NATIVESRP_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x19E41DC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOG_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19E41E10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFog_NativeSRP_TypeDefinitionIndex = 5995;
