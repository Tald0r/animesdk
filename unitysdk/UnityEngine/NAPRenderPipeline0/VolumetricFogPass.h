...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19CFC520)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19CFCF50)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_SETLOCALRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x19CFB960)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x19CFC4B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19CFB8B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFogPass_TypeDefinitionIndex = 5834;
