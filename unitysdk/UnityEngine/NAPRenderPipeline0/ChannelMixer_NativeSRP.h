...
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A2820F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A281BF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A281D40)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A281FF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A281D50)
