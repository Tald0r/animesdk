...
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19CF6F50)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19CF6A50)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19CF6BA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CF6E50)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHANNELMIXER_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF6BB0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ChannelMixer_NativeSRP_TypeDefinitionIndex = 6074;
