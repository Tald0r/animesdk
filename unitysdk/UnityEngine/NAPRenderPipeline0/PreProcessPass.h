...
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A1A1A60)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_GETDYNAMICSCREENSIZE_OFFSET UNITYSDK_OFFSET(0x1A1A19C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A1960)
