...
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19BBE6E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x19BBEAF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19BBE6D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19BBED60)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_GETTEXTUREFORMAT_OFFSET UNITYSDK_OFFSET(0x19BBE760)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_GETTEXTURE_OFFSET UNITYSDK_OFFSET(0x19BBE7A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x19BBE5C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_RELEASE_OFFSET UNITYSDK_OFFSET(0x19BBE6F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x19BBE6C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x19BBE5D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBE5E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TextureCurve_TypeDefinitionIndex = 6066;
