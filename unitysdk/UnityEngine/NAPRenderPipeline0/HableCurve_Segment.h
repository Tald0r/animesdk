...
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_SEGMENT_EVAL_OFFSET UNITYSDK_OFFSET(0x19E9A7F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_SEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19E9A850)
