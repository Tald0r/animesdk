...
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_NATIVEIMPL_EXECUTE_IMPL_OFFSET UNITYSDK_OFFSET(0x19E16EC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E16ED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_NATIVEIMPL_PREPROCESSPASSGETFROMNATIVE_OFFSET UNITYSDK_OFFSET(0x19E16EE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19E16E60)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PreProcessPass_NativeImpl_TypeDefinitionIndex = 5711;
