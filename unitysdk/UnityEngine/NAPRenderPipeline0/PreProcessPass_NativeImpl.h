...
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_NATIVEIMPL_EXECUTE_IMPL_OFFSET UNITYSDK_OFFSET(0x1A3E6760)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A3E6770)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_NATIVEIMPL_PREPROCESSPASSGETFROMNATIVE_OFFSET UNITYSDK_OFFSET(0x1A3E6780)
#define UNITYENGINE_NAPRENDERPIPELINE0_PREPROCESSPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E6700)
