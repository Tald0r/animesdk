...
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1995A780)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1995A7B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1995A700)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FrameEstimateInfoPass_NativeImpl_TypeDefinitionIndex = 5775;
