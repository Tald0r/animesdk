...
#define UNITYENGINE_NAPRENDERPIPELINE0_BLUENOISESAMPLER_NESTED__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A691350)
#define UNITYENGINE_NAPRENDERPIPELINE0_BLUENOISESAMPLER_NESTED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6913A0)
