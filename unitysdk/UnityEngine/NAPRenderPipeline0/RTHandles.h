...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_ALLOC_1_OFFSET UNITYSDK_OFFSET(0x19F4B9A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_ALLOC_2_OFFSET UNITYSDK_OFFSET(0x19F4BB30)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_ALLOC_OFFSET UNITYSDK_OFFSET(0x19F4B800)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F4B780)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19F4BC70)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_RELEASE_OFFSET UNITYSDK_OFFSET(0x19F4BD10)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_SETHARDWAREDYNAMICRESOLUTIONSTATE_OFFSET UNITYSDK_OFFSET(0x19F4BE10)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F4BE90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTHandles_TypeDefinitionIndex = 6006;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RTHandleSystem**)Il2CppClass::FromTypeDefinitionIndex(RTHandles_TypeDefinitionIndex)->GetStaticField(0x5470);
		}
