...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_ALLOC_1_OFFSET UNITYSDK_OFFSET(0x1A528770)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_ALLOC_2_OFFSET UNITYSDK_OFFSET(0x1A528900)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_ALLOC_OFFSET UNITYSDK_OFFSET(0x1A5285D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A528550)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A528A40)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A528AE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES_SETHARDWAREDYNAMICRESOLUTIONSTATE_OFFSET UNITYSDK_OFFSET(0x1A528BE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A528C60)
