...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYMANAGERBINDINGS_INTERNAL_ADDTOMANAGER_OFFSET UNITYSDK_OFFSET(0x1A628130)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYMANAGERBINDINGS_INTERNAL_PREPAREAFTERCULLING_OFFSET UNITYSDK_OFFSET(0x1A628100)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYMANAGERBINDINGS_INTERNAL_PREPAREAFTERLIGHTLOOP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A628120)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYMANAGERBINDINGS_INTERNAL_PREPAREAFTERLIGHTLOOP_OFFSET UNITYSDK_OFFSET(0x1A628110)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYMANAGERBINDINGS_INTERNAL_REMOVEFROMMANAGER_OFFSET UNITYSDK_OFFSET(0x1A628140)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYMANAGERBINDINGS_INTERNAL_SETCOMPUTESHADER_OFFSET UNITYSDK_OFFSET(0x1A628150)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERENTITYMANAGERBINDINGS_INTERNAL_UPDATEPERFRAME_OFFSET UNITYSDK_OFFSET(0x1A6280F0)
