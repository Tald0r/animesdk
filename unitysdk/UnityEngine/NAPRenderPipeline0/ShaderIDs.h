...
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADERIDS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19961E90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ShaderIDs_TypeDefinitionIndex = 5798;
	...
	public:
		...
		static ::System::Int32* StaticGet__PerObjectShadowResolveIndex()
		{
