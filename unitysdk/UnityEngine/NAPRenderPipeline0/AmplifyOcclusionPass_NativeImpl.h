...
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A040BD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A040C00)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1A040BA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSIONPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A040B20)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int AmplifyOcclusionPass_NativeImpl_TypeDefinitionIndex = 5723;
