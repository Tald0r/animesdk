...
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION_APPLYSCALE_OFFSET UNITYSDK_OFFSET(0x19F37CB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION_GETDYNAMICRESOLUTION_1_OFFSET UNITYSDK_OFFSET(0x19F38120)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION_GETDYNAMICRESOLUTION_OFFSET UNITYSDK_OFFSET(0x19F380C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION_GETDYNAMICSCREENSIZE_OFFSET UNITYSDK_OFFSET(0x19F381D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19F38270)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DynamicResolution_TypeDefinitionIndex = 6015;
