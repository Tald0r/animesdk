...
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION_APPLYSCALE_OFFSET UNITYSDK_OFFSET(0x1A52FBB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION_GETDYNAMICRESOLUTION_1_OFFSET UNITYSDK_OFFSET(0x1A530020)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION_GETDYNAMICRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1A52FFC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION_GETDYNAMICSCREENSIZE_OFFSET UNITYSDK_OFFSET(0x1A5300D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DYNAMICRESOLUTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A530170)
