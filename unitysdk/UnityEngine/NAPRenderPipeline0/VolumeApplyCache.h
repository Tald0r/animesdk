...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_ADDTOCHECK_OFFSET UNITYSDK_OFFSET(0x931DD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_BEGINCHECK_OFFSET UNITYSDK_OFFSET(0x931DC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_CHECKISCACHED_OFFSET UNITYSDK_OFFSET(0x931E30)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_GETCURRENT_OFFSET UNITYSDK_OFFSET(0x931E40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x931D50)
