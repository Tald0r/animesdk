...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_ADDTOCHECK_OFFSET UNITYSDK_OFFSET(0x906970)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_BEGINCHECK_OFFSET UNITYSDK_OFFSET(0x906960)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_CHECKISCACHED_OFFSET UNITYSDK_OFFSET(0x9069D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_GETCURRENT_OFFSET UNITYSDK_OFFSET(0x9069E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEAPPLYCACHE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9068F0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeApplyCache_TypeDefinitionIndex = 6059;
