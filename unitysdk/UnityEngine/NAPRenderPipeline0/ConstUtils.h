...
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSTUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3E5FA0)
...
namespace UnityEngine::NAPRenderPipeline0
{
	...
	public:
		...
		{
			return (::UnityEngine::Vector2*)Il2CppClass::FromTypeDefinitionIndex(ConstUtils_TypeDefinitionIndex)->GetStaticField(0x2370);
		}
