...
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSTUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E16700)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ConstUtils_TypeDefinitionIndex = 5838;
