...
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A11A170)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A11A180)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11A280)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ClampedFloatParameter_TypeDefinitionIndex = 6043;
