...
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A6913B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A6913C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6914C0)
