...
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A364AB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A364B30)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A364AF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A364A90)
