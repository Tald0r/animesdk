...
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19DDA130)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19DDA1B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19DDA170)
#define UNITYENGINE_NAPRENDERPIPELINE0_CONSOLEVARIABLEFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDA110)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ConsoleVariableFloat_TypeDefinitionIndex = 5686;
