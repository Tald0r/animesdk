...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOVERLAYPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x19DDA2F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOVERLAYPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x19DDA3A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOVERLAYPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19DDA380)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOVERLAYPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19DDA370)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOVERLAYPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19DDA300)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOVERLAYPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDA2D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DrawOverlayPassNativeState_TypeDefinitionIndex = 5731;
