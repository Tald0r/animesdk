...
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19F37650)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19F37100)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19F37130)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F37550)
#define UNITYENGINE_NAPRENDERPIPELINE0_AMPLIFYOCCLUSION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F37140)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int AmplifyOcclusion_NativeSRP_TypeDefinitionIndex = 5807;
