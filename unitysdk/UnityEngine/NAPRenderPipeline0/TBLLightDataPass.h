...
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19DDCB70)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DDCEF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDCAE0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TBLLightDataPass_TypeDefinitionIndex = 5836;
