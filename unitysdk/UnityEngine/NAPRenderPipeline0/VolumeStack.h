...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19CFB7D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x19CFB790)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK_RELOAD_OFFSET UNITYSDK_OFFSET(0x19CFB2D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19CFB2C0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeStack_TypeDefinitionIndex = 6057;
