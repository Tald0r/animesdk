...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A286980)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A286940)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK_RELOAD_OFFSET UNITYSDK_OFFSET(0x1A286480)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMESTACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A286470)
