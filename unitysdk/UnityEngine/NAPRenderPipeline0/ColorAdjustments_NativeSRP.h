...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19CF7EA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19CF76D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19CF7910)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CF7DA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF7920)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ColorAdjustments_NativeSRP_TypeDefinitionIndex = 6075;
