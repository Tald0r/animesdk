...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A283040)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A282870)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A282AB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A282F40)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORADJUSTMENTS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A282AC0)
