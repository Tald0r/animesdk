...
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19E1AD00)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVEPARAMETER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19E1AC80)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19E1AD10)
#define UNITYENGINE_NAPRENDERPIPELINE0_TEXTURECURVEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E1ABE0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TextureCurveParameter_TypeDefinitionIndex = 6067;
