...
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19EA6180)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19EA5C00)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19EA5E30)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EA6080)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA5E40)
