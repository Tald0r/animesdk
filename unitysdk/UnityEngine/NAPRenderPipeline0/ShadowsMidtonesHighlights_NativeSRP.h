...
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19966340)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19965DC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19965FF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19966240)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHADOWSMIDTONESHIGHLIGHTS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19966000)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ShadowsMidtonesHighlights_NativeSRP_TypeDefinitionIndex = 6076;
