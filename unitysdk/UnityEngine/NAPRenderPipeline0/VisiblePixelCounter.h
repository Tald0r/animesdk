...
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_CLEARALLGROUPS_OFFSET UNITYSDK_OFFSET(0x19663F40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_GET_TOTALPIXELS_OFFSET UNITYSDK_OFFSET(0x19663B20)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19663B30)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_ISGROUPINVALID_OFFSET UNITYSDK_OFFSET(0x19663FA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_READASYNCREADBACKCALLBACK_OFFSET UNITYSDK_OFFSET(0x19664C70)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_SETRENDERERGROUP_OFFSET UNITYSDK_OFFSET(0x19663FF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_SETUPSHADERRESOURCES_OFFSET UNITYSDK_OFFSET(0x19663EE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_TESTGPUVALIDATIONERROR_OFFSET UNITYSDK_OFFSET(0x19663CF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_UPDATE_OFFSET UNITYSDK_OFFSET(0x196642E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19663BB0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VisiblePixelCounter_TypeDefinitionIndex = 29255;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::VisiblePixelCounter**)Il2CppClass::FromTypeDefinitionIndex(VisiblePixelCounter_TypeDefinitionIndex)->GetStaticField(0x234C0);
		}
		// static const ::System::Int32 kReadbackSlotCount = 0x10; // 0x0
		// static const ::System::Int32 kMaxRendererGroupCount = 0xF; // 0x0
		::Il2CppArray<::System::Int32>* m_RenderGroupAges; // 0x10
		...
		::Il2CppArray<::Il2CppArray<::UnityEngine::Renderer*>*>* m_RendererGroups; // 0x28
		...
		::System::Int32 kVisiblePixelCounterRT; // 0x50
		::UnityEngine::Vector2 SideIgnoreRatio; // 0x54
		::System::Int32 kNameInputRT; // 0x5C
		::System::Int32 kNameTestBindBuffer; // 0x60
		::System::Int32 m_ValidRenderGroupCount; // 0x64
		::System::Int32 UnmarkedPixelCount; // 0x68
		::System::Int32 kNameInputValidRange; // 0x6C
		::System::Int32 kNameOutPixelCounts; // 0x70
		::System::Int32 kNameTestID; // 0x74
		::System::Int32 kNameRepeatCountStepXY; // 0x78
		::System::Boolean ResultIsValid; // 0x7C
		::System::Int32 m_TotalPixels; // 0x80
