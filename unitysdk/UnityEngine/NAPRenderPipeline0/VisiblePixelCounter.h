...
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_CLEARALLGROUPS_OFFSET UNITYSDK_OFFSET(0x1923F140)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_GET_TOTALPIXELS_OFFSET UNITYSDK_OFFSET(0x1923ED20)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1923ED30)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_ISGROUPINVALID_OFFSET UNITYSDK_OFFSET(0x1923F1A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_READASYNCREADBACKCALLBACK_OFFSET UNITYSDK_OFFSET(0x1923FE70)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_SETRENDERERGROUP_OFFSET UNITYSDK_OFFSET(0x1923F1F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_SETUPSHADERRESOURCES_OFFSET UNITYSDK_OFFSET(0x1923F0E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_TESTGPUVALIDATIONERROR_OFFSET UNITYSDK_OFFSET(0x1923EEF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1923F4E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VISIBLEPIXELCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1923EDB0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VisiblePixelCounter_TypeDefinitionIndex = 28314;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::VisiblePixelCounter**)Il2CppClass::FromTypeDefinitionIndex(VisiblePixelCounter_TypeDefinitionIndex)->GetStaticField(0x21B70);
		}
		...
		::UnityEngine::ComputeShader* m_CountCS; // 0x18
		::Il2CppArray<::System::Int32>* m_RenderGroupAges; // 0x20
		...
		::System::Collections::Generic::Stack_1<::UnityEngine::NAPRenderPipeline0::VisiblePixelCounter_RequestTask*>* m_FreeReadbackBuffers; // 0x40
		::Il2CppArray<::System::Int32>* VisiblePixelCounts; // 0x48
		::System::Int32 kNameInputValidRange; // 0x50
		::System::Int32 kNameTestID; // 0x54
		::System::Int32 kVisiblePixelCounterRT; // 0x58
		::System::Boolean ResultIsValid; // 0x5C
		::System::Int32 UnmarkedPixelCount; // 0x60
		::UnityEngine::Vector2 SideIgnoreRatio; // 0x64
		::System::Int32 kNameTestBindBuffer; // 0x6C
		::System::Int32 kNameInputRT; // 0x70
		::System::Int32 m_TotalPixels; // 0x74
		::System::Int32 m_ValidRenderGroupCount; // 0x78
		::System::Int32 kNameRepeatCountStepXY; // 0x7C
		::System::Int32 kNameOutPixelCounts; // 0x80
