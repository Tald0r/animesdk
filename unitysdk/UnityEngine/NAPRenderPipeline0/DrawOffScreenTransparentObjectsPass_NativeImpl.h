...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOFFSCREENTRANSPARENTOBJECTSPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E16A00)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOFFSCREENTRANSPARENTOBJECTSPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19E16A30)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOFFSCREENTRANSPARENTOBJECTSPASS_NATIVEIMPL_SETUP_1_OFFSET UNITYSDK_OFFSET(0x19E16970)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOFFSCREENTRANSPARENTOBJECTSPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x19E168F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOFFSCREENTRANSPARENTOBJECTSPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19E16840)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DrawOffScreenTransparentObjectsPass_NativeImpl_TypeDefinitionIndex = 5769;
