...
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_COMBINEHASH_OFFSET UNITYSDK_OFFSET(0x19808F80)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_LERPINPLACE_1_OFFSET UNITYSDK_OFFSET(0x19808F00)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_LERPINPLACE_2_OFFSET UNITYSDK_OFFSET(0x19808F50)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_LERPINPLACE_3_OFFSET UNITYSDK_OFFSET(0x19808F60)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_LERPINPLACE_OFFSET UNITYSDK_OFFSET(0x19808E90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int InterpolateUtils_TypeDefinitionIndex = 5979;
