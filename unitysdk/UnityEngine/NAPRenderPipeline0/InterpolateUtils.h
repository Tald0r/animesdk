...
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_COMBINEHASH_OFFSET UNITYSDK_OFFSET(0x19CE14D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_LERPINPLACE_1_OFFSET UNITYSDK_OFFSET(0x19CE1450)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_LERPINPLACE_2_OFFSET UNITYSDK_OFFSET(0x19CE14A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_LERPINPLACE_3_OFFSET UNITYSDK_OFFSET(0x19CE14B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTERPOLATEUTILS_LERPINPLACE_OFFSET UNITYSDK_OFFSET(0x19CE13E0)
