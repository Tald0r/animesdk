...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_GBUFFEREVENTCALLBACKWITHCMDBUFFER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1995C210)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_GBUFFEREVENTCALLBACKWITHCMDBUFFER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1995C2D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_GBUFFEREVENTCALLBACKWITHCMDBUFFER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1995BE90)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_GBUFFEREVENTCALLBACKWITHCMDBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1995BE80)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderPassCallbacks_GBufferEventCallbackWithCmdBuffer_TypeDefinitionIndex = 5691;
