...
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A4BEAE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A4BEB10)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BEA60)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SSRPass_NativeImpl_TypeDefinitionIndex = 5761;
