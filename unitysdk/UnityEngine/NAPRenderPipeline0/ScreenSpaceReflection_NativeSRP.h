...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A4BEF30)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A4BEDF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A4BEE20)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4BEE30)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEREFLECTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BEB40)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpaceReflection_NativeSRP_TypeDefinitionIndex = 6085;
