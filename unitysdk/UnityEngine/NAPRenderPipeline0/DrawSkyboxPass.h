...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASS_DRAWSKYBOX_OFFSET UNITYSDK_OFFSET(0x19C39380)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASS_PREPARESKYPARAMS_OFFSET UNITYSDK_OFFSET(0x19C39A50)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASS_PREPARESKYSHPARAMS_OFFSET UNITYSDK_OFFSET(0x19C3A080)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3A680)
