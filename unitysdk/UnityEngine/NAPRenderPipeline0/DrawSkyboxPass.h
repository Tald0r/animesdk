...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASS_DRAWSKYBOX_OFFSET UNITYSDK_OFFSET(0x197CA820)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASS_PREPARESKYPARAMS_OFFSET UNITYSDK_OFFSET(0x197CAEF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASS_PREPARESKYSHPARAMS_OFFSET UNITYSDK_OFFSET(0x197CB520)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWSKYBOXPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x197CBB20)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DrawSkyboxPass_TypeDefinitionIndex = 5818;
