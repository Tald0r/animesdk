...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19F4F0C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19F4F0F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x19F4F040)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19F4EFC0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFogPass_NativeImpl_TypeDefinitionIndex = 5765;
