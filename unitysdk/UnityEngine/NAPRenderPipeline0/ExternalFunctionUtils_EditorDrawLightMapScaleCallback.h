...
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19CF8BC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19CF8C40)
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19CF8640)
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF8630)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ExternalFunctionUtils_EditorDrawLightMapScaleCallback_TypeDefinitionIndex = 6027;
