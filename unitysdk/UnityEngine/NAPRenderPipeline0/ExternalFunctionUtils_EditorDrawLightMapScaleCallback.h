...
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A283D70)
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A283DF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A2837F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_EXTERNALFUNCTIONUTILS_EDITORDRAWLIGHTMAPSCALECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2837D0)
