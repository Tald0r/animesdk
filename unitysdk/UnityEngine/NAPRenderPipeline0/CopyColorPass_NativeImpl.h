...
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL_EXECUTECOPYCOLORPASS_OFFSET UNITYSDK_OFFSET(0x197FD880)
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x197FD890)
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x197FD970)
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL_RELEASETEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x197FD960)
#define UNITYENGINE_NAPRENDERPIPELINE0_COPYCOLORPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x197FD820)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CopyColorPass_NativeImpl_TypeDefinitionIndex = 5724;
