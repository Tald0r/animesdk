...
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19BBCD50)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x19BBCD20)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBCC70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GaussianBlurPass_NativeImpl_TypeDefinitionIndex = 5740;
