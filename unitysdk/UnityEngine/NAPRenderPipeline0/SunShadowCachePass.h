...
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_CLEANUP_OFFSET UNITYSDK_OFFSET(0x17950FC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x17950F10)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x17950F70)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_SETUPCULLINGPARAMETERS_OFFSET UNITYSDK_OFFSET(0x17950EC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x17950E70)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x17950DF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x17951000)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SunShadowCachePass_TypeDefinitionIndex = 28309;
