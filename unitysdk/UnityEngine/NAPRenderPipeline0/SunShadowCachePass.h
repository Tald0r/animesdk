...
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_CLEANUP_OFFSET UNITYSDK_OFFSET(0x17778690)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x177785E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x17778640)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_SETUPCULLINGPARAMETERS_OFFSET UNITYSDK_OFFSET(0x17778590)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x17778540)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x177784C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SUNSHADOWCACHEPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x177786D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SunShadowCachePass_TypeDefinitionIndex = 29250;
