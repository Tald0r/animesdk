...
#define UNITYENGINE_NAPRENDERPIPELINE0_SSGIPASS_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19EA1020)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSGIPASS_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x19EA12A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSGIPASS_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA1940)
