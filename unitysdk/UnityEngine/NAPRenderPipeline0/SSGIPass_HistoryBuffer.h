...
#define UNITYENGINE_NAPRENDERPIPELINE0_SSGIPASS_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x199611D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSGIPASS_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x19961450)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSGIPASS_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19961AF0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SSGIPass_HistoryBuffer_TypeDefinitionIndex = 5814;
