...
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_CREATE_1_OFFSET UNITYSDK_OFFSET(0x19F49AE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_CREATE_2_OFFSET UNITYSDK_OFFSET(0x19F49C10)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_CREATE_OFFSET UNITYSDK_OFFSET(0x19F49970)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x19F49950)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_ISTEMPBUFFEREXIST_OFFSET UNITYSDK_OFFSET(0x19F498F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_RELEASETEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x19F49840)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19F495B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19F49690)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19F49770)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F494B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GlobalBufferManager_GlobalRTWrap_TypeDefinitionIndex = 6013;
	...
	public:
		...
		::UnityEngine::NAPRenderPipeline0::RenderTextureDescAction* globalRtDescActions; // 0x48
		::System::Boolean lossyCompressionOverride; // 0x50
		::System::Boolean lossyCompression; // 0x51
		::System::UInt32 lifetimeId; // 0x54
		::System::Boolean enableDynamicCache; // 0x58
