...
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1A5267F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1A526940)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_CREATE_OFFSET UNITYSDK_OFFSET(0x1A526660)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A526640)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_ISTEMPBUFFEREXIST_OFFSET UNITYSDK_OFFSET(0x1A5265E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP_RELEASETEMPBUFFER_OFFSET UNITYSDK_OFFSET(0x1A526530)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A526290)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A526370)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A526450)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALBUFFERMANAGER_GLOBALRTWRAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A526180)
