...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_GET_PROFILEREF_OFFSET UNITYSDK_OFFSET(0x1A52B8F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_GET_PROFILE_OFFSET UNITYSDK_OFFSET(0x1A52B610)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_HASINSTANTIATEDPROFILE_OFFSET UNITYSDK_OFFSET(0x1A52B970)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A52BA80)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A52B9E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_SET_PROFILE_OFFSET UNITYSDK_OFFSET(0x1A52B8E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_UPDATELAYER_OFFSET UNITYSDK_OFFSET(0x1A52BBB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A52BB10)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A52BC60)
