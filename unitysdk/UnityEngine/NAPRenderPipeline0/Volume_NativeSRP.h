...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_GET_PROFILEREF_OFFSET UNITYSDK_OFFSET(0x19F4EB20)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_GET_PROFILE_OFFSET UNITYSDK_OFFSET(0x19F4E840)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_HASINSTANTIATEDPROFILE_OFFSET UNITYSDK_OFFSET(0x19F4EBA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19F4ECB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19F4EC10)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_SET_PROFILE_OFFSET UNITYSDK_OFFSET(0x19F4EB10)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_UPDATELAYER_OFFSET UNITYSDK_OFFSET(0x19F4EDE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP_UPDATE_OFFSET UNITYSDK_OFFSET(0x19F4ED40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUME_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19F4EE90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Volume_NativeSRP_TypeDefinitionIndex = 6063;
