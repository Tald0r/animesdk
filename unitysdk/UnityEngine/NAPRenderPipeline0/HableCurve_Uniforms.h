...
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_UNIFORMS_GET_CURVE_OFFSET UNITYSDK_OFFSET(0x19F393B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_UNIFORMS_GET_MIDSEGMENTA_OFFSET UNITYSDK_OFFSET(0x19F394B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_UNIFORMS_GET_MIDSEGMENTB_OFFSET UNITYSDK_OFFSET(0x19F39510)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_UNIFORMS_GET_SHOSEGMENTA_OFFSET UNITYSDK_OFFSET(0x19F39570)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_UNIFORMS_GET_SHOSEGMENTB_OFFSET UNITYSDK_OFFSET(0x19F395D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_UNIFORMS_GET_TOESEGMENTA_OFFSET UNITYSDK_OFFSET(0x19F393F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_UNIFORMS_GET_TOESEGMENTB_OFFSET UNITYSDK_OFFSET(0x19F39450)
#define UNITYENGINE_NAPRENDERPIPELINE0_HABLECURVE_UNIFORMS__CTOR_OFFSET UNITYSDK_OFFSET(0x19F393A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int HableCurve_Uniforms_TypeDefinitionIndex = 5951;
