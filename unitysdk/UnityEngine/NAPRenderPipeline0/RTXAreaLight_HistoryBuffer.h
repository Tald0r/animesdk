...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER_RELEASEWHENCHANGED_OFFSET UNITYSDK_OFFSET(0x19F3A870)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19F3A670)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x19F3A8F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F3AC60)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTXAreaLight_HistoryBuffer_TypeDefinitionIndex = 5796;
