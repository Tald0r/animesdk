...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER_RELEASEWHENCHANGED_OFFSET UNITYSDK_OFFSET(0x1A532770)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A532570)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1A5327F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A532B60)
