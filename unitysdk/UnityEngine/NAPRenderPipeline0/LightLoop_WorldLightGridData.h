...
#define UNITYENGINE_NAPRENDERPIPELINE0_LIGHTLOOP_WORLDLIGHTGRIDDATA_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1A403FD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIGHTLOOP_WORLDLIGHTGRIDDATA_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A403C80)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIGHTLOOP_WORLDLIGHTGRIDDATA_RESIZE_OFFSET UNITYSDK_OFFSET(0x1A403D40)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIGHTLOOP_WORLDLIGHTGRIDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4041B0)
