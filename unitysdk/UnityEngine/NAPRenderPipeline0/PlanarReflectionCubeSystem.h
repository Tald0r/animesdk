...
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETBLENDCUBEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x19F4A700)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETCUBEDATA_OFFSET UNITYSDK_OFFSET(0x19F4A8F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETPOINTNDFINBOUNDS_OFFSET UNITYSDK_OFFSET(0x19F4A570)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETPROXYMATERIAL_OFFSET UNITYSDK_OFFSET(0x19F4AD70)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETPROXYMESHES_OFFSET UNITYSDK_OFFSET(0x19F4AE80)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19F4A490)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_ISPLANARREFLECTIONCUBECORRECTEDENABLE_OFFSET UNITYSDK_OFFSET(0x19F4AF00)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19F4A530)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PlanarReflectionCubeSystem_TypeDefinitionIndex = 6001;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::PlanarReflectionCubeSystem**)Il2CppClass::FromTypeDefinitionIndex(PlanarReflectionCubeSystem_TypeDefinitionIndex)->GetStaticField(0x5460);
		}
