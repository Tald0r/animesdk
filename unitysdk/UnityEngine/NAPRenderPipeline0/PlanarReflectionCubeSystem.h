...
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETBLENDCUBEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1A5274E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETCUBEDATA_OFFSET UNITYSDK_OFFSET(0x1A5276D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETPOINTNDFINBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A527350)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETPROXYMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A527B50)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GETPROXYMESHES_OFFSET UNITYSDK_OFFSET(0x1A527C60)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A527270)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM_ISPLANARREFLECTIONCUBECORRECTEDENABLE_OFFSET UNITYSDK_OFFSET(0x1A527CE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PLANARREFLECTIONCUBESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A527310)
