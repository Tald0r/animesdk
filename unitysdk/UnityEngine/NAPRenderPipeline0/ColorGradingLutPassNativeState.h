...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x19C39100)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x19C391B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19C391C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C39190)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19C39180)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19C39110)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_GETLIFTGAMMAGAINSETTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x19C39220)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_SETLIFTGAMMAGAINSETTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x19C39210)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C390E0)
