...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x197CA5A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x197CA650)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x197CA660)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x197CA630)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x197CA620)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x197CA5B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_GETLIFTGAMMAGAINSETTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x197CA6C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE_SETLIFTGAMMAGAINSETTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x197CA6B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x197CA580)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ColorGradingLutPassNativeState_TypeDefinitionIndex = 5714;
