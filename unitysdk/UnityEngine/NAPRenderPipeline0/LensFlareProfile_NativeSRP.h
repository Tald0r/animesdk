...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_CHECK_OFFSET UNITYSDK_OFFSET(0x1B0CC770)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B0CCAD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_GET_PACKEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1B0CCBF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_GET_PARAMDIRTY_OFFSET UNITYSDK_OFFSET(0x1B0CC750)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0CD010)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0CD000)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B0CD020)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_SET_PARAMDIRTY_OFFSET UNITYSDK_OFFSET(0x1B0CC760)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0CD030)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensFlareProfile_NativeSRP_TypeDefinitionIndex = 23506;
