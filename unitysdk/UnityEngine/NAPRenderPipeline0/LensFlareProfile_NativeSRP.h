...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_CHECK_OFFSET UNITYSDK_OFFSET(0x1B6DA840)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B6DABA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_GET_PACKEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1B6DACC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_GET_PARAMDIRTY_OFFSET UNITYSDK_OFFSET(0x1B6DA820)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6DB0E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6DB0D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B6DB0F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP_SET_PARAMDIRTY_OFFSET UNITYSDK_OFFSET(0x1B6DA830)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREPROFILE_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6DB100)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensFlareProfile_NativeSRP_TypeDefinitionIndex = 24189;
