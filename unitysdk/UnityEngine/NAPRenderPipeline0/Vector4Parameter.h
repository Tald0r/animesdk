...
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR4PARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CFB1B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR4PARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x19CFB140)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR4PARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CFB1C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR4PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF9FD0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Vector4Parameter_TypeDefinitionIndex = 6048;
