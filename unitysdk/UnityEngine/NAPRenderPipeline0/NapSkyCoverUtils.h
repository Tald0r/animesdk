...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS_GETSKYCOVERTIMEPARAMS_OFFSET UNITYSDK_OFFSET(0x19E16E30)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS_SETDRAWPARAMS_INJECTED_OFFSET UNITYSDK_OFFSET(0x19E16E20)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS_SETDRAWPARAMS_OFFSET UNITYSDK_OFFSET(0x19E16E10)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS_SETSKYCOVERTIMEPARAMS_OFFSET UNITYSDK_OFFSET(0x19E16E40)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x19E16E50)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapSkyCoverUtils_TypeDefinitionIndex = 5704;
