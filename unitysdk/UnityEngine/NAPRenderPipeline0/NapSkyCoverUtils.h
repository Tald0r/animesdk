...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS_GETSKYCOVERTIMEPARAMS_OFFSET UNITYSDK_OFFSET(0x1A3E66D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS_SETDRAWPARAMS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A3E66C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS_SETDRAWPARAMS_OFFSET UNITYSDK_OFFSET(0x1A3E66B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS_SETSKYCOVERTIMEPARAMS_OFFSET UNITYSDK_OFFSET(0x1A3E66E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSKYCOVERUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E66F0)
