...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_DRAWOPAQUEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A402F80)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_DRAWPARTICLEDECAL_OFFSET UNITYSDK_OFFSET(0x1A402F70)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A402F40)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1A402F10)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A402970)
