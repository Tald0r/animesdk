...
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_DRAWOPAQUEOBJECTS_OFFSET UNITYSDK_OFFSET(0x19E3A220)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_DRAWPARTICLEDECAL_OFFSET UNITYSDK_OFFSET(0x19E3A210)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E3A1E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x19E3A1B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DRAWOPAQUEOBJECTSPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19E39C10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DrawOpaqueObjectsPass_NativeImpl_TypeDefinitionIndex = 5728;
