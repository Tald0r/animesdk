...
#define UNITYENGINE_NAPRENDERPIPELINE0_OFFSCREENPARTICLEUPDATEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x17BEEF60)
#define UNITYENGINE_NAPRENDERPIPELINE0_OFFSCREENPARTICLEUPDATEPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x17BEEF10)
#define UNITYENGINE_NAPRENDERPIPELINE0_OFFSCREENPARTICLEUPDATEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x17BEEEB0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int OffscreenParticleUpdatePass_TypeDefinitionIndex = 28308;
