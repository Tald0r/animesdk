...
#define UNITYENGINE_NAPRENDERPIPELINE0_OFFSCREENPARTICLEUPDATEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x182D7600)
#define UNITYENGINE_NAPRENDERPIPELINE0_OFFSCREENPARTICLEUPDATEPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x182D75B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_OFFSCREENPARTICLEUPDATEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x182D7550)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int OffscreenParticleUpdatePass_TypeDefinitionIndex = 29249;
