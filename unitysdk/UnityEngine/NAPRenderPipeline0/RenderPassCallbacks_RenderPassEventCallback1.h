...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK1_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19BCEE60)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK1_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19BCEF20)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK1_INVOKE_OFFSET UNITYSDK_OFFSET(0x19BCEAE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK1__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCEAD0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderPassCallbacks_RenderPassEventCallback1_TypeDefinitionIndex = 5692;
