...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEBOUNDS_NATIVESRP_CLOSESTPOINT_OFFSET UNITYSDK_OFFSET(0x1A04BD20)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEBOUNDS_NATIVESRP_START_OFFSET UNITYSDK_OFFSET(0x1A04BCE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEBOUNDS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04BE40)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeBounds_NativeSRP_TypeDefinitionIndex = 6060;
