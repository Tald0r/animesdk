...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEBOUNDS_NATIVESRP_CLOSESTPOINT_OFFSET UNITYSDK_OFFSET(0x1A62C220)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEBOUNDS_NATIVESRP_START_OFFSET UNITYSDK_OFFSET(0x1A62C1E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEBOUNDS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62C340)
