...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GETLENSFLARETEXTURE_OFFSET UNITYSDK_OFFSET(0x1B0CC5E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B0CC5F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_EDGEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B0CC620)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_FALLOFF_OFFSET UNITYSDK_OFFSET(0x1B0CC610)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_INTENSITYVARIATION_OFFSET UNITYSDK_OFFSET(0x1B0CC600)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_LOCALINTENSITY_OFFSET UNITYSDK_OFFSET(0x1B0CC5D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_SDFROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1B0CC640)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_GET_SIDECOUNT_OFFSET UNITYSDK_OFFSET(0x1B0CC630)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_REFRESHTEXTUREID_OFFSET UNITYSDK_OFFSET(0x1B0CC650)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B0CC530)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_EDGEOFFSET_OFFSET UNITYSDK_OFFSET(0x1B0CC570)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_FALLOFF_OFFSET UNITYSDK_OFFSET(0x1B0CC550)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_INTENSITYVARIATION_OFFSET UNITYSDK_OFFSET(0x1B0CC540)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_LOCALINTENSITY_OFFSET UNITYSDK_OFFSET(0x1B0CC520)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_SDFROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1B0CC590)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP_SET_SIDECOUNT_OFFSET UNITYSDK_OFFSET(0x1B0CC5B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLAREDATAELEMENTSRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0CC070)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensFlareDataElementSRP_TypeDefinitionIndex = 23498;
