...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_WORLDLIGHTGRIDDATA_CLEANUP_OFFSET UNITYSDK_OFFSET(0x19C3BB50)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXAREALIGHT_WORLDLIGHTGRIDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3BA90)
