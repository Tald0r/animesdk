...
#define UNITYENGINE_NAPRENDERPIPELINE0_OPAQUEPOSTPROCESSPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x19E3B720)
#define UNITYENGINE_NAPRENDERPIPELINE0_OPAQUEPOSTPROCESSPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x19E3B7C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_OPAQUEPOSTPROCESSPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E3B7A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_OPAQUEPOSTPROCESSPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E3B7E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_OPAQUEPOSTPROCESSPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19E3B730)
#define UNITYENGINE_NAPRENDERPIPELINE0_OPAQUEPOSTPROCESSPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x19E3B7D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_OPAQUEPOSTPROCESSPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E3B700)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int OpaquePostProcessPassNativeState_TypeDefinitionIndex = 5746;
