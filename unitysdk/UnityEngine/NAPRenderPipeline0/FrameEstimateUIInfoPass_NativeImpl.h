...
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E47A00)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19E47A30)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEUIINFOPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19E47980)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FrameEstimateUIInfoPass_NativeImpl_TypeDefinitionIndex = 5777;
