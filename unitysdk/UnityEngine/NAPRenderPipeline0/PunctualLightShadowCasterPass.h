...
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_CONVERTTOATLASMATRIX_OFFSET UNITYSDK_OFFSET(0x19E19B40)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_EXECUTECACHED_OFFSET UNITYSDK_OFFSET(0x19E18350)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E17300)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_FINISHDYNAMICREQ_OFFSET UNITYSDK_OFFSET(0x19E19D30)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_SETTILEVIEWPORT_OFFSET UNITYSDK_OFFSET(0x19E19AD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS_SETUPCACHED_OFFSET UNITYSDK_OFFSET(0x19E173F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PUNCTUALLIGHTSHADOWCASTERPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19E17120)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PunctualLightShadowCasterPass_TypeDefinitionIndex = 5802;
