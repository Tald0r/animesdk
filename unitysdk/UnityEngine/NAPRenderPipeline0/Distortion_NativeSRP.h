...
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19BC7B30)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19BC76E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19BC7760)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19BC7A30)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC7770)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Distortion_NativeSRP_TypeDefinitionIndex = 6089;
