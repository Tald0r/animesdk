...
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_ADDCOLLECTTEXTURETRANSITION_OFFSET UNITYSDK_OFFSET(0x8FC830)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_ADDTEXTURETRANSITION_OFFSET UNITYSDK_OFFSET(0x8FC7A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_APPLYDYNAMICSCALE_OFFSET UNITYSDK_OFFSET(0x8FDAB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_BEGINSAMPLE_OFFSET UNITYSDK_OFFSET(0x8FDA10)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_BLIT_1_OFFSET UNITYSDK_OFFSET(0x8FD880)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_BLIT_OFFSET UNITYSDK_OFFSET(0x8FD710)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_CLEARRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x8FD5A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DISPATCHCOMPUTE_1_OFFSET UNITYSDK_OFFSET(0x8FDDC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DISPATCHCOMPUTE_OFFSET UNITYSDK_OFFSET(0x8FDD50)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DRAWMESHINSTANCEDINDIRECT_OFFSET UNITYSDK_OFFSET(0x8FDE70)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DRAWMESHINSTANCED_OFFSET UNITYSDK_OFFSET(0x8FCAE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DRAWMESH_OFFSET UNITYSDK_OFFSET(0x8FCB80)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DRAWPROCEDURAL_1_OFFSET UNITYSDK_OFFSET(0x8FCD00)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DRAWPROCEDURAL_OFFSET UNITYSDK_OFFSET(0x8FCC40)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_ENDSAMPLE_OFFSET UNITYSDK_OFFSET(0x8FDA60)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_EXECUTEDLSSG_OFFSET UNITYSDK_OFFSET(0x8FDF80)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_EXECUTEDLSS_OFFSET UNITYSDK_OFFSET(0x8FDF10)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_EXECUTEFSR_OFFSET UNITYSDK_OFFSET(0x8FDFF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_EXECUTEMETALFXUPSCALE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_GETTEMPORARYRTWITHDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x8FCDE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_ISVALID_OFFSET UNITYSDK_OFFSET(0x8FC710)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_RECREATESWAPCHAIN_OFFSET UNITYSDK_OFFSET(0x8FE060)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_RELEASETEMPORARYRT_OFFSET UNITYSDK_OFFSET(0x8FCE50)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETCOMPUTEBUFFERPARAM_OFFSET UNITYSDK_OFFSET(0x8FDCE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETCOMPUTEFLOATPARAM_OFFSET UNITYSDK_OFFSET(0x8FDB40)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETCOMPUTEINTPARAM_OFFSET UNITYSDK_OFFSET(0x8FDAF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETCOMPUTETEXTUREPARAM_OFFSET UNITYSDK_OFFSET(0x8FDC00)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETCOMPUTEVECTORPARAM_OFFSET UNITYSDK_OFFSET(0x8FDB90)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALBUFFER_OFFSET UNITYSDK_OFFSET(0x8FDE20)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALCOLOR_OFFSET UNITYSDK_OFFSET(0x8FC960)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALFLOAT_OFFSET UNITYSDK_OFFSET(0x8FC8B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALMATRIX_OFFSET UNITYSDK_OFFSET(0x8FC9C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALTEXTURE_OFFSET UNITYSDK_OFFSET(0x8FC730)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x8FCA30)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALVECTOR_OFFSET UNITYSDK_OFFSET(0x8FC900)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETINTSHADERKEYWORD_OFFSET UNITYSDK_OFFSET(0x8FCA80)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETRENDERTARGETCOLORANDDEPTH_OFFSET UNITYSDK_OFFSET(0x8FD2C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETRENDERTARGETCOLOR_1_OFFSET UNITYSDK_OFFSET(0x8FD0D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETRENDERTARGETCOLOR_OFFSET UNITYSDK_OFFSET(0x8FCF20)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETRENDERTARGETMRT_OFFSET UNITYSDK_OFFSET(0x8FD540)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETRENDERTARGETWITHBINDING_OFFSET UNITYSDK_OFFSET(0x8FCEA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETVIEWPORT_OFFSET UNITYSDK_OFFSET(0x8FD6B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETVIEWPROJECTIONMATRICES_OFFSET UNITYSDK_OFFSET(0x8FD610)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x8FC700)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CommandBufferWrapper_TypeDefinitionIndex = 5982;
