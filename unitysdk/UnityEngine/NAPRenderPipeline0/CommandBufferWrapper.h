...
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_ADDCOLLECTTEXTURETRANSITION_OFFSET UNITYSDK_OFFSET(0x925E50)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_ADDTEXTURETRANSITION_OFFSET UNITYSDK_OFFSET(0x925DC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_APPLYDYNAMICSCALE_OFFSET UNITYSDK_OFFSET(0x9270D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_BEGINSAMPLE_OFFSET UNITYSDK_OFFSET(0x927030)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_BLIT_1_OFFSET UNITYSDK_OFFSET(0x926EA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_BLIT_OFFSET UNITYSDK_OFFSET(0x926D30)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_CLEARRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x926BC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DISPATCHCOMPUTE_1_OFFSET UNITYSDK_OFFSET(0x9273E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DISPATCHCOMPUTE_OFFSET UNITYSDK_OFFSET(0x927370)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DRAWMESHINSTANCEDINDIRECT_OFFSET UNITYSDK_OFFSET(0x927490)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DRAWMESHINSTANCED_OFFSET UNITYSDK_OFFSET(0x926100)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DRAWMESH_OFFSET UNITYSDK_OFFSET(0x9261A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DRAWPROCEDURAL_1_OFFSET UNITYSDK_OFFSET(0x926320)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_DRAWPROCEDURAL_OFFSET UNITYSDK_OFFSET(0x926260)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_ENDSAMPLE_OFFSET UNITYSDK_OFFSET(0x927080)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_EXECUTEDLSSG_OFFSET UNITYSDK_OFFSET(0x9275A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_EXECUTEDLSS_OFFSET UNITYSDK_OFFSET(0x927530)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_EXECUTEFSRFRAMEGEN_OFFSET UNITYSDK_OFFSET(0x927680)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_EXECUTEFSR_OFFSET UNITYSDK_OFFSET(0x927610)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_EXECUTEMETALFXUPSCALE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_GETTEMPORARYRTWITHDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x926400)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_ISVALID_OFFSET UNITYSDK_OFFSET(0x925D30)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_RECREATESWAPCHAIN_OFFSET UNITYSDK_OFFSET(0x9276F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_RELEASETEMPORARYRT_OFFSET UNITYSDK_OFFSET(0x926470)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETCOMPUTEBUFFERPARAM_OFFSET UNITYSDK_OFFSET(0x927300)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETCOMPUTEFLOATPARAM_OFFSET UNITYSDK_OFFSET(0x927160)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETCOMPUTEINTPARAM_OFFSET UNITYSDK_OFFSET(0x927110)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETCOMPUTETEXTUREPARAM_OFFSET UNITYSDK_OFFSET(0x927220)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETCOMPUTEVECTORPARAM_OFFSET UNITYSDK_OFFSET(0x9271B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALBUFFER_OFFSET UNITYSDK_OFFSET(0x927440)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALCOLOR_OFFSET UNITYSDK_OFFSET(0x925F80)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALFLOAT_OFFSET UNITYSDK_OFFSET(0x925ED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALMATRIX_OFFSET UNITYSDK_OFFSET(0x925FE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALTEXTURE_OFFSET UNITYSDK_OFFSET(0x925D50)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x926050)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETGLOBALVECTOR_OFFSET UNITYSDK_OFFSET(0x925F20)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETINTSHADERKEYWORD_OFFSET UNITYSDK_OFFSET(0x9260A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETRENDERTARGETCOLORANDDEPTH_OFFSET UNITYSDK_OFFSET(0x9268E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETRENDERTARGETCOLOR_1_OFFSET UNITYSDK_OFFSET(0x9266F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETRENDERTARGETCOLOR_OFFSET UNITYSDK_OFFSET(0x926540)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETRENDERTARGETMRT_OFFSET UNITYSDK_OFFSET(0x926B60)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETRENDERTARGETWITHBINDING_OFFSET UNITYSDK_OFFSET(0x9264C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETVIEWPORT_OFFSET UNITYSDK_OFFSET(0x926CD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER_SETVIEWPROJECTIONMATRICES_OFFSET UNITYSDK_OFFSET(0x926C30)
#define UNITYENGINE_NAPRENDERPIPELINE0_COMMANDBUFFERWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x925D20)
