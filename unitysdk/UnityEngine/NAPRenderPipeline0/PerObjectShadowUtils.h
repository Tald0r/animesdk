...
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWUTILS_GETAXISWITHLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x151A2110)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWUTILS_REFRESHAXISWITHLIGHTDIRECTION_OFFSET UNITYSDK_OFFSET(0x151A1EB0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PerObjectShadowUtils_TypeDefinitionIndex = 29253;
