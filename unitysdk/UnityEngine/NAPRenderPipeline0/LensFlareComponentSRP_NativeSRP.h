...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B0CBC40)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_GET_LENSFLAREDATA_OFFSET UNITYSDK_OFFSET(0x1B0CBB10)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B0CBBB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_SET_LENSFLAREDATA_OFFSET UNITYSDK_OFFSET(0x1B0CBB20)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0CBE00)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensFlareComponentSRP_NativeSRP_TypeDefinitionIndex = 23505;
