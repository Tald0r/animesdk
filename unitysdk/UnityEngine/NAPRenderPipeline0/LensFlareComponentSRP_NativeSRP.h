...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B6D9D10)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_GET_LENSFLAREDATA_OFFSET UNITYSDK_OFFSET(0x1B6D9BE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B6D9C80)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP_SET_LENSFLAREDATA_OFFSET UNITYSDK_OFFSET(0x1B6D9BF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSFLARECOMPONENTSRP_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6D9ED0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensFlareComponentSRP_NativeSRP_TypeDefinitionIndex = 24188;
