...
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1A4BDC30)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A4BDCB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BDBD0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PresentFrozenTexturePass_TypeDefinitionIndex = 5828;
