...
#define UNITYENGINE_NAPRENDERPIPELINE0_LAYERMASKPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19808FC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LAYERMASKPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19808FD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LAYERMASKPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19808FA0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LayerMaskParameter_TypeDefinitionIndex = 6036;
