...
#define UNITYENGINE_NAPRENDERPIPELINE0_LAYERMASKPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CE1510)
#define UNITYENGINE_NAPRENDERPIPELINE0_LAYERMASKPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CE1520)
#define UNITYENGINE_NAPRENDERPIPELINE0_LAYERMASKPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE14F0)
