...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCRIPTORDYNAMICRESOLUTIONEXT_GETDYNAMICRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1A3670A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCRIPTORDYNAMICRESOLUTIONEXT_GETDYNAMICSCREENSIZE_OFFSET UNITYSDK_OFFSET(0x1A367200)
