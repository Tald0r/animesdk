...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_GET_DATANUM_OFFSET UNITYSDK_OFFSET(0x1A534200)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_GET_DISPATCHARGS_OFFSET UNITYSDK_OFFSET(0x1A5342A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_GET_DISPATCHIDX_OFFSET UNITYSDK_OFFSET(0x1A534260)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_GET_GROUPSUMS_OFFSET UNITYSDK_OFFSET(0x1A534240)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_GET_SCANGROUPPAYLOAD_OFFSET UNITYSDK_OFFSET(0x1A534280)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_GET_SWAPDATA_OFFSET UNITYSDK_OFFSET(0x1A534220)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_INIT_OFFSET UNITYSDK_OFFSET(0x1A533EB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A5333A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SET_DATANUM_OFFSET UNITYSDK_OFFSET(0x1A534210)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SET_DISPATCHARGS_OFFSET UNITYSDK_OFFSET(0x1A5342B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SET_DISPATCHIDX_OFFSET UNITYSDK_OFFSET(0x1A534270)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SET_GROUPSUMS_OFFSET UNITYSDK_OFFSET(0x1A534250)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SET_SCANGROUPPAYLOAD_OFFSET UNITYSDK_OFFSET(0x1A534290)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SET_SWAPDATA_OFFSET UNITYSDK_OFFSET(0x1A534230)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS_SWAPDATA_OFFSET UNITYSDK_OFFSET(0x1A5342C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_RADIXSORTBUFFERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5341F0)
