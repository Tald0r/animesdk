...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x197C9780)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x197C9330)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x197C9350)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x197C9680)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x197C9360)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Caustics_NativeSRP_TypeDefinitionIndex = 6090;
