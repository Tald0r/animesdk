...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19C38A10)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19C385C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19C385E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C38910)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAUSTICS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19C385F0)
