...
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_CREATENATIVE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1995A8D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1995A810)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1995A8C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1995A8A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1995A8F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1995A830)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1995A8E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLURPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1995A7E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GaussianBlurPassNativeState_TypeDefinitionIndex = 5739;
