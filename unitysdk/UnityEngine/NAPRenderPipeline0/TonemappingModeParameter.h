...
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPINGMODEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BF3C0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TonemappingModeParameter_TypeDefinitionIndex = 6051;
