...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A048BD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A04BA80)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS_GETRENDERTARGETRESOURCE_OFFSET UNITYSDK_OFFSET(0x1A048010)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x1A047FF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTIONSPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A047D10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpacePlanarReflectionsPass_TypeDefinitionIndex = 5829;
