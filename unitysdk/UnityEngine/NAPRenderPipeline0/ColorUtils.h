...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_CIEXYTOLMS_OFFSET UNITYSDK_OFFSET(0x1A1A11E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_COLORBALANCETOLMSCOEFFS_OFFSET UNITYSDK_OFFSET(0x1A1A1260)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_PREPARESPLITTONING_OFFSET UNITYSDK_OFFSET(0x1A1A1350)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_STANDARDILLUMINANTY_OFFSET UNITYSDK_OFFSET(0x1A1A11B0)
