...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_CIEXYTOLMS_OFFSET UNITYSDK_OFFSET(0x19BBCAD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_COLORBALANCETOLMSCOEFFS_OFFSET UNITYSDK_OFFSET(0x19BBCB50)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_PREPARESPLITTONING_OFFSET UNITYSDK_OFFSET(0x19BBCC40)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORUTILS_STANDARDILLUMINANTY_OFFSET UNITYSDK_OFFSET(0x19BBCAA0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ColorUtils_TypeDefinitionIndex = 5977;
