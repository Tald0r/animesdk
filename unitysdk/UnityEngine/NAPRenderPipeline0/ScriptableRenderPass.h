...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_AFTERCULLSETUP_OFFSET UNITYSDK_OFFSET(0x1A408EF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_BLIT_1_OFFSET UNITYSDK_OFFSET(0x1A409370)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_BLIT_CLEARCOLOR_OFFSET UNITYSDK_OFFSET(0x1A409130)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_BLIT_OFFSET UNITYSDK_OFFSET(0x1A408F20)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CANCELCONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0x1A408EB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CHECKSRPHELPERPASSESPROPERLYSYNCED_OFFSET UNITYSDK_OFFSET(0x1A409BF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURECLEAR_OFFSET UNITYSDK_OFFSET(0x1A408EC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURETARGET_1_OFFSET UNITYSDK_OFFSET(0x1A408D80)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0x1A408D20)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1A408EE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_1_OFFSET UNITYSDK_OFFSET(0x1A4037A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_2_OFFSET UNITYSDK_OFFSET(0x1A4094B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_3_OFFSET UNITYSDK_OFFSET(0x1A409950)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A406630)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_EXECUTEONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1A408F10)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A408C60)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A408F00)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_CLEARCOLOR_OFFSET UNITYSDK_OFFSET(0x1A408C10)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_CLEARFLAG_OFFSET UNITYSDK_OFFSET(0x1A408BF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_COLORATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x1A408B70)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_COLORATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1A408B80)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_DEPTHATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1A408BD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_OVERRIDECAMERATARGET_OFFSET UNITYSDK_OFFSET(0x1A408C30)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_RENDERPASSEVENT_OFFSET UNITYSDK_OFFSET(0x1A408B50)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A409A50)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SETCANRUNONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1A409BE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SETSIGNALONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1A409B80)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SETUPFORSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1A409A80)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_EYEINDEX_OFFSET UNITYSDK_OFFSET(0x1A408C20)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_ISBLITRENDERPASS_OFFSET UNITYSDK_OFFSET(0x1A408C50)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_OVERRIDECAMERATARGET_OFFSET UNITYSDK_OFFSET(0x1A408C40)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_RENDERPASSEVENT_OFFSET UNITYSDK_OFFSET(0x1A408B60)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SHOULDEXECUTEONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x1A409B20)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_WAITSIGNALONMAIN_OFFSET UNITYSDK_OFFSET(0x1A409B40)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A409C00)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4029F0)
