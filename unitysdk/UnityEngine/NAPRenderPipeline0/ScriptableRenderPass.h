...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_AFTERCULLSETUP_OFFSET UNITYSDK_OFFSET(0x19E40180)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_BLIT_1_OFFSET UNITYSDK_OFFSET(0x19E40600)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_BLIT_CLEARCOLOR_OFFSET UNITYSDK_OFFSET(0x19E403C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_BLIT_OFFSET UNITYSDK_OFFSET(0x19E401B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CANCELCONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0x19E40140)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CHECKSRPHELPERPASSESPROPERLYSYNCED_OFFSET UNITYSDK_OFFSET(0x19E40E80)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURECLEAR_OFFSET UNITYSDK_OFFSET(0x19E40150)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURETARGET_1_OFFSET UNITYSDK_OFFSET(0x19E40010)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0x19E3FFB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x19E40170)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_1_OFFSET UNITYSDK_OFFSET(0x19E3AA40)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_2_OFFSET UNITYSDK_OFFSET(0x19E40740)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_3_OFFSET UNITYSDK_OFFSET(0x19E40BE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_CREATEDRAWINGSETTINGS_OFFSET UNITYSDK_OFFSET(0x19E3D8D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_EXECUTEONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x19E401A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19E3FEF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19E40190)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_CLEARCOLOR_OFFSET UNITYSDK_OFFSET(0x19E3FEA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_CLEARFLAG_OFFSET UNITYSDK_OFFSET(0x19E3FE80)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_COLORATTACHMENTS_OFFSET UNITYSDK_OFFSET(0x19E3FE00)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_COLORATTACHMENT_OFFSET UNITYSDK_OFFSET(0x19E3FE10)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_DEPTHATTACHMENT_OFFSET UNITYSDK_OFFSET(0x19E3FE60)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_OVERRIDECAMERATARGET_OFFSET UNITYSDK_OFFSET(0x19E3FEC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_GET_RENDERPASSEVENT_OFFSET UNITYSDK_OFFSET(0x19E3FDE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x19E40CE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SETCANRUNONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x19E40E70)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SETSIGNALONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x19E40E10)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SETUPFORSRPHELPER_OFFSET UNITYSDK_OFFSET(0x19E40D10)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_EYEINDEX_OFFSET UNITYSDK_OFFSET(0x19E3FEB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_ISBLITRENDERPASS_OFFSET UNITYSDK_OFFSET(0x19E3FEE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_OVERRIDECAMERATARGET_OFFSET UNITYSDK_OFFSET(0x19E3FED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SET_RENDERPASSEVENT_OFFSET UNITYSDK_OFFSET(0x19E3FDF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_SHOULDEXECUTEONSRPHELPER_OFFSET UNITYSDK_OFFSET(0x19E40DB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS_WAITSIGNALONMAIN_OFFSET UNITYSDK_OFFSET(0x19E40DD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E40E90)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCRIPTABLERENDERPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19E39C90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScriptableRenderPass_TypeDefinitionIndex = 5945;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ScriptableRenderPass_TypeDefinitionIndex)->GetStaticField(0x2850);
		}
		static ::UnityEngine::Rendering::RenderTargetIdentifier* StaticGet_DefaultRTI1()
		{
			return (::UnityEngine::Rendering::RenderTargetIdentifier*)Il2CppClass::FromTypeDefinitionIndex(ScriptableRenderPass_TypeDefinitionIndex)->GetStaticField(0x2858);
		}
