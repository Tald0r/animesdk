...
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A11BD30)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A11B480)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISLUTOVERRIDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1A11B340)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A11B500)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISUBERCOLORCORRECTIONACTIVE_OFFSET UNITYSDK_OFFSET(0x1A11B420)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A11BC30)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11B510)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FXColorCorrection_NativeSRP_TypeDefinitionIndex = 6073;
