...
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A692F70)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A6926C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISLUTOVERRIDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1A692580)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A692740)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP_ISUBERCOLORCORRECTIONACTIVE_OFFSET UNITYSDK_OFFSET(0x1A692660)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A692E70)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXCOLORCORRECTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A692750)
