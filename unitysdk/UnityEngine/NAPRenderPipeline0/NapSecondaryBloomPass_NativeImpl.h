...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E3B6A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19E3B6D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19E3B610)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapSecondaryBloomPass_NativeImpl_TypeDefinitionIndex = 5745;
