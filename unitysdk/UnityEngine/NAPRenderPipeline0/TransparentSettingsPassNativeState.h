...
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x19D1F890)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x19D1F930)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D1F910)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19D1F950)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19D1F8A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x19D1F940)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D1F870)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TransparentSettingsPassNativeState_TypeDefinitionIndex = 5750;
