...
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19CF8F80)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19CF8C60)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19CF8C90)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CF8E80)
#define UNITYENGINE_NAPRENDERPIPELINE0_GAUSSIANBLUR_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF8CA0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GaussianBlur_NativeSRP_TypeDefinitionIndex = 6091;
