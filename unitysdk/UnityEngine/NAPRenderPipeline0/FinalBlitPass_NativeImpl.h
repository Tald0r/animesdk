...
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A403A40)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1A403A10)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A403990)
