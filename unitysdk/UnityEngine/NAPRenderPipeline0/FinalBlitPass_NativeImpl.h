...
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E3ACE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x19E3ACB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19E3AC30)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FinalBlitPass_NativeImpl_TypeDefinitionIndex = 5736;
