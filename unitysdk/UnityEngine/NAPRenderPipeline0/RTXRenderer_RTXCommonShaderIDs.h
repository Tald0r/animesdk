...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXRENDERER_RTXCOMMONSHADERIDS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E1A690)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXRENDERER_RTXCOMMONSHADERIDS__CTOR_OFFSET UNITYSDK_OFFSET(0x19E19ED0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTXRenderer_RTXCommonShaderIDs_TypeDefinitionIndex = 5781;
