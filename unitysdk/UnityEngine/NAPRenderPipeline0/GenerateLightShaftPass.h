...
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19F38490)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19F39330)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19F383B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GenerateLightShaftPass_TypeDefinitionIndex = 5824;
