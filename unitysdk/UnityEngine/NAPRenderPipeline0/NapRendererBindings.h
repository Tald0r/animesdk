...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x1A42C5C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETFLOATARRAY_OFFSET UNITYSDK_OFFSET(0x1A42C5F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x1A42C590)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETMATRIX_OFFSET UNITYSDK_OFFSET(0x1A42C5B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETTEXTUREOFFSET_OFFSET UNITYSDK_OFFSET(0x1A42C610)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETTEXTURESCALE_OFFSET UNITYSDK_OFFSET(0x1A42C600)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A42C5D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x1A42C5E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x1A42C5A0)
