...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x19E47C90)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETFLOATARRAY_OFFSET UNITYSDK_OFFSET(0x19E47CC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x19E47C60)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETMATRIX_OFFSET UNITYSDK_OFFSET(0x19E47C80)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETTEXTUREOFFSET_OFFSET UNITYSDK_OFFSET(0x19E47CE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETTEXTURESCALE_OFFSET UNITYSDK_OFFSET(0x19E47CD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x19E47CA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x19E47CB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERERBINDINGS_INTERNAL_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x19E47C70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapRendererBindings_TypeDefinitionIndex = 6111;
