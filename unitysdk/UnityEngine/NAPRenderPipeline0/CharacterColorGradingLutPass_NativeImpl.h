...
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19CF7540)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19CF7410)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL_SETUPAFTERVOLUMEUPDATE_OFFSET UNITYSDK_OFFSET(0x19CF7570)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19CF7450)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF7490)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CharacterColorGradingLutPass_NativeImpl_TypeDefinitionIndex = 5719;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::CharacterColorGradingLutPass_NativeImpl**)Il2CppClass::FromTypeDefinitionIndex(CharacterColorGradingLutPass_NativeImpl_TypeDefinitionIndex)->GetStaticField(0x5380);
		}
