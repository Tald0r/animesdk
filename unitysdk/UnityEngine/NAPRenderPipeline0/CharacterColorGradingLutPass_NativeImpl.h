...
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A2826E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A2825B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL_SETUPAFTERVOLUMEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A282710)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A2825F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERCOLORGRADINGLUTPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A282630)
