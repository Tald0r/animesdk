...
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_CALCDIRTYFLAG_OFFSET UNITYSDK_OFFSET(0x1995ADF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_ENABLEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1995AD90)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1995B090)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_GETCONSTANTBUFFER_OFFSET UNITYSDK_OFFSET(0x1995AD00)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_ISVALID_OFFSET UNITYSDK_OFFSET(0x1995ADE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1995ADC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1995AD40)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1995AAA0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int MaterialWrapper_TypeDefinitionIndex = 5986;
