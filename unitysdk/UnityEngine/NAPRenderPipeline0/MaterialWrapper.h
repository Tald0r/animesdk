...
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_CALCDIRTYFLAG_OFFSET UNITYSDK_OFFSET(0x19E9AC50)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_ENABLEKEYWORD_OFFSET UNITYSDK_OFFSET(0x19E9ABF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_FLUSH_OFFSET UNITYSDK_OFFSET(0x19E9AEF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_GETCONSTANTBUFFER_OFFSET UNITYSDK_OFFSET(0x19E9AB60)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_ISVALID_OFFSET UNITYSDK_OFFSET(0x19E9AC40)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19E9AC20)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x19E9ABA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MATERIALWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E9A900)
