...
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x8ED8E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8ED890)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE_INITPROFILINGSCOPE_OFFSET UNITYSDK_OFFSET(0x8ED930)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E9B5C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8ED780)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x8ED680)
