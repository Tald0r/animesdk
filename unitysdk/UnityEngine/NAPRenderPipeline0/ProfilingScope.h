...
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x8C0E40)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8C0DF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE_INITPROFILINGSCOPE_OFFSET UNITYSDK_OFFSET(0x8C0E90)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1995B760)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8C0CE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PROFILINGSCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x8C0BE0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ProfilingScope_TypeDefinitionIndex = 5965;

	struct alignas(8) ProfilingScope
	{
		static ::System::Boolean* StaticGet_Enabled()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ProfilingScope_TypeDefinitionIndex)->GetStaticField(0x2AF0);
		}
