...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x19E3B540)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x19E3B5E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E3B5C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E3B5F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19E3B550)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19E3B600)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E3B520)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapSecondaryBloomPassNativeState_TypeDefinitionIndex = 5744;
