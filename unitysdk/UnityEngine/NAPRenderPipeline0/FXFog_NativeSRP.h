...
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOG_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1995A6B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOG_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1995A6F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOG_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1995A330)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FXFog_NativeSRP_TypeDefinitionIndex = 6100;
