...
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSDIRT_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19E3AD20)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSDIRT_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19E3AD80)
#define UNITYENGINE_NAPRENDERPIPELINE0_LENSDIRT_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19E3AD90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LensDirt_NativeSRP_TypeDefinitionIndex = 6095;
