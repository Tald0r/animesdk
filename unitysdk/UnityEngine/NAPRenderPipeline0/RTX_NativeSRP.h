...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTX_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x197CDA50)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTX_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x197CD910)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTX_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x197CD940)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTX_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x197CD950)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTX_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x197CD530)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTX_NativeSRP_TypeDefinitionIndex = 6086;
	...
	public:
		...
		::UnityEngine::NAPRenderPipeline0::TextureParameter* lut; // 0x98
		::UnityEngine::NAPRenderPipeline0::TextureParameter* roughnessLut; // 0xA0
		::UnityEngine::NAPRenderPipeline0::TextureParameter* multiBounceAlbedoLut; // 0xA8
