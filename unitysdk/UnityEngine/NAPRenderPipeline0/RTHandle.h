...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GETSCALEDSIZE_OFFSET UNITYSDK_OFFSET(0x1A5283C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_NAMEID_OFFSET UNITYSDK_OFFSET(0x1A527ED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_REFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x1A527E60)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_RTHANDLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A527E80)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_RT_OFFSET UNITYSDK_OFFSET(0x1A527EC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_SCALEFACTOR_OFFSET UNITYSDK_OFFSET(0x1A527E20)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_USESCALING_OFFSET UNITYSDK_OFFSET(0x1A527E40)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A527F20)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1A527FB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A527F00)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A528290)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SETRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A527FE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A528230)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SET_REFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x1A527E70)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SET_SCALEFACTOR_OFFSET UNITYSDK_OFFSET(0x1A527E30)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SET_USESCALING_OFFSET UNITYSDK_OFFSET(0x1A527E50)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A527EF0)
