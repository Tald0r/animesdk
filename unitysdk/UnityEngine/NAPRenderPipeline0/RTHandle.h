...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GETSCALEDSIZE_OFFSET UNITYSDK_OFFSET(0x19F4B5F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_NAMEID_OFFSET UNITYSDK_OFFSET(0x19F4B100)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_REFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x19F4B090)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_RTHANDLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19F4B0B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_RT_OFFSET UNITYSDK_OFFSET(0x19F4B0F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_SCALEFACTOR_OFFSET UNITYSDK_OFFSET(0x19F4B050)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_GET_USESCALING_OFFSET UNITYSDK_OFFSET(0x19F4B070)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x19F4B150)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x19F4B1E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19F4B130)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_RELEASE_OFFSET UNITYSDK_OFFSET(0x19F4B4C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SETRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x19F4B210)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x19F4B460)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SET_REFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x19F4B0A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SET_SCALEFACTOR_OFFSET UNITYSDK_OFFSET(0x19F4B060)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE_SET_USESCALING_OFFSET UNITYSDK_OFFSET(0x19F4B080)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F4B120)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTHandle_TypeDefinitionIndex = 5941;
