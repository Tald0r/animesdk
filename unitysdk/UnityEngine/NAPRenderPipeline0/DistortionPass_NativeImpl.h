...
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL_AFTERCULLSETUP_OFFSET UNITYSDK_OFFSET(0x1A621800)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A621730)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A621760)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1A621700)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A621660)
