...
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL_AFTERCULLSETUP_OFFSET UNITYSDK_OFFSET(0x1A0412C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A0411F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A041220)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x1A0411C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_DISTORTIONPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A041120)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int DistortionPass_NativeImpl_TypeDefinitionIndex = 5726;
