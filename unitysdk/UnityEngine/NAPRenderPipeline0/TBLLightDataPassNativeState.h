...
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1A11EE10)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1A11EEB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A11EE90)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A11EED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A11EE20)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1A11EEC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TBLLIGHTDATAPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11EDF0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TBLLightDataPassNativeState_TypeDefinitionIndex = 5770;
