...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_ANTIALIASINGUSETEMPORAL_OFFSET UNITYSDK_OFFSET(0x8F2F70)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETGPUPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x8F3050)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETNONJITTEREDPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x8F3020)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETPREVIOUSVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x8F2F90)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETPRIVOUSPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x8F2FF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x8F2FC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x510400)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GET_ISPREVIEWCAMERA_OFFSET UNITYSDK_OFFSET(0x8F2F60)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_SCREENTOVIEWPORTPOINT_OFFSET UNITYSDK_OFFSET(0x8F3200)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_SETUPCAMERAVIEWDATA_OFFSET UNITYSDK_OFFSET(0x8F30F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_WORLDTOSCREENPOINT_OFFSET UNITYSDK_OFFSET(0x8F31D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_WORLDTOVIEWPORTPOINT_OFFSET UNITYSDK_OFFSET(0x8F3230)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CameraData_TypeDefinitionIndex = 5937;
