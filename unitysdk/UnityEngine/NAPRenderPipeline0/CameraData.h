...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_ANTIALIASINGUSETEMPORAL_OFFSET UNITYSDK_OFFSET(0x91E120)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETGPUPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x91E200)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETNONJITTEREDPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x91E1D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETPREVIOUSVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x91E140)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETPRIVOUSPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x91E1A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x91E170)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GETVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x5481E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_GET_ISPREVIEWCAMERA_OFFSET UNITYSDK_OFFSET(0x91E110)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_SCREENTOVIEWPORTPOINT_OFFSET UNITYSDK_OFFSET(0x91E3B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_SETUPCAMERAVIEWDATA_OFFSET UNITYSDK_OFFSET(0x91E2A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_WORLDTOSCREENPOINT_OFFSET UNITYSDK_OFFSET(0x91E380)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERADATA_WORLDTOVIEWPORTPOINT_OFFSET UNITYSDK_OFFSET(0x91E3E0)
