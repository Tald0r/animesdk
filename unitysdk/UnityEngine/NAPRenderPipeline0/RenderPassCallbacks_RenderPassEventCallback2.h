...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK2_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19E3FCF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK2_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19E3FDB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK2_INVOKE_OFFSET UNITYSDK_OFFSET(0x19E3F970)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSEVENTCALLBACK2__CTOR_OFFSET UNITYSDK_OFFSET(0x19E3F960)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderPassCallbacks_RenderPassEventCallback2_TypeDefinitionIndex = 5693;
