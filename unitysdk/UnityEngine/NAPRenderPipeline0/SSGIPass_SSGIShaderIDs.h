...
#define UNITYENGINE_NAPRENDERPIPELINE0_SSGIPASS_SSGISHADERIDS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CEB950)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSGIPASS_SSGISHADERIDS__CTOR_OFFSET UNITYSDK_OFFSET(0x19CEB940)
