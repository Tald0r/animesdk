...
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1995B3D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_INNERREFRESH_OFFSET UNITYSDK_OFFSET(0x1995B320)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_ISNULLTEX_OFFSET UNITYSDK_OFFSET(0x1995B4B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1995B3E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1995B280)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NoInterpTextureParameter_TypeDefinitionIndex = 6050;
