...
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19E9B230)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_INNERREFRESH_OFFSET UNITYSDK_OFFSET(0x19E9B180)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_ISNULLTEX_OFFSET UNITYSDK_OFFSET(0x19E9B310)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19E9B240)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPTEXTUREPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E9B0E0)
