...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTION_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19961D50)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTION_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19961D70)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACEPLANARREFLECTION_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19961BE0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpacePlanarReflection_NativeSRP_TypeDefinitionIndex = 6098;
