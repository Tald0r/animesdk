...
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1A041310)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1A0413B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A041390)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A0413C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A041320)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A0413D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FRAMEESTIMATEINFOPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0412F0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FrameEstimateInfoPassNativeState_TypeDefinitionIndex = 5774;
