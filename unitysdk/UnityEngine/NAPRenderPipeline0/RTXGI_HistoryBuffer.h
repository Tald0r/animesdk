...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_HISTORYBUFFER_RELEASEWHENCHANGED_OFFSET UNITYSDK_OFFSET(0x19F3AF10)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19F3AC70)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x19F3B720)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F3C260)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTXGI_HistoryBuffer_TypeDefinitionIndex = 5792;
