...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_HISTORYBUFFER_RELEASEWHENCHANGED_OFFSET UNITYSDK_OFFSET(0x1A532E10)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A532B70)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1A533620)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXGI_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A534160)
