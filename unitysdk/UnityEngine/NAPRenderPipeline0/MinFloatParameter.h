...
#define UNITYENGINE_NAPRENDERPIPELINE0_MINFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19E16C30)
#define UNITYENGINE_NAPRENDERPIPELINE0_MINFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19E16C40)
#define UNITYENGINE_NAPRENDERPIPELINE0_MINFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E16D20)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int MinFloatParameter_TypeDefinitionIndex = 6041;
