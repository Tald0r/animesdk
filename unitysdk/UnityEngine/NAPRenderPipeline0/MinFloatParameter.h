...
#define UNITYENGINE_NAPRENDERPIPELINE0_MINFLOATPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A3E64D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MINFLOATPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A3E64E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MINFLOATPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E65C0)
