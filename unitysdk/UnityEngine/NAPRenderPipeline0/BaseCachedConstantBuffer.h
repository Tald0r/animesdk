...
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19CD5C00)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19CD5B60)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19CD5AF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_GETGPUBUFFER_OFFSET UNITYSDK_OFFSET(0x19CD5940)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_GETNAMEID_OFFSET UNITYSDK_OFFSET(0x19CD5960)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_GETSIZE_OFFSET UNITYSDK_OFFSET(0x19CD5950)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_UPLOADIFDIRTY_OFFSET UNITYSDK_OFFSET(0x19CD5970)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CD5C50)
