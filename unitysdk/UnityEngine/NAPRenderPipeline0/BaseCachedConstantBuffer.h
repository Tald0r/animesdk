...
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x197FD7C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x197FD720)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x197FD6B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_GETGPUBUFFER_OFFSET UNITYSDK_OFFSET(0x197FD500)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_GETNAMEID_OFFSET UNITYSDK_OFFSET(0x197FD520)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_GETSIZE_OFFSET UNITYSDK_OFFSET(0x197FD510)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER_UPLOADIFDIRTY_OFFSET UNITYSDK_OFFSET(0x197FD530)
#define UNITYENGINE_NAPRENDERPIPELINE0_BASECACHEDCONSTANTBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x197FD810)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int BaseCachedConstantBuffer_TypeDefinitionIndex = 5984;
