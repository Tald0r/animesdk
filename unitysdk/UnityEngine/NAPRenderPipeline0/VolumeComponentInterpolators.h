...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENTINTERPOLATORS_REGISTERINTERPOLATORFUNCTION_OFFSET UNITYSDK_OFFSET(0x19E16100)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENTINTERPOLATORS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E1ADE0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeComponentInterpolators_TypeDefinitionIndex = 6053;
