...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENTINTERPOLATORS_REGISTERINTERPOLATORFUNCTION_OFFSET UNITYSDK_OFFSET(0x1A3E59A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENTINTERPOLATORS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3EA700)
