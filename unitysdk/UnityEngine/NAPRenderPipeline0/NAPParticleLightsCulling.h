...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_AFTERRENDERERINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A628090)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_AFTERRENDERERING_OFFSET UNITYSDK_OFFSET(0x1A628050)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_DOCULLINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A628030)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_DOCULLING_OFFSET UNITYSDK_OFFSET(0x1A627F80)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_GETLIGHTSNUMAFTERCULLING_OFFSET UNITYSDK_OFFSET(0x1A628040)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_INITIALIZEPOSTCULLLIGHTDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A6280D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_INITIALIZEPOSTCULLLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1A6280A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6280E0)
