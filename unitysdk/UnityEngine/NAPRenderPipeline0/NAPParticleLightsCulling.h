...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_AFTERRENDERERINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A047B90)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_AFTERRENDERERING_OFFSET UNITYSDK_OFFSET(0x1A047B50)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_DOCULLINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A047B30)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_DOCULLING_OFFSET UNITYSDK_OFFSET(0x1A047A80)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_GETLIGHTSNUMAFTERCULLING_OFFSET UNITYSDK_OFFSET(0x1A047B40)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_INITIALIZEPOSTCULLLIGHTDATAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A047BD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING_INITIALIZEPOSTCULLLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1A047BA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPPARTICLELIGHTSCULLING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A047BE0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NAPParticleLightsCulling_TypeDefinitionIndex = 5697;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::ParticleLightsCullingOptions*)Il2CppClass::FromTypeDefinitionIndex(NAPParticleLightsCulling_TypeDefinitionIndex)->GetStaticField(0x2EA0);
		}
		static ::System::Int32* StaticGet_s_MainCameraLightsNumAfterCulling()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NAPParticleLightsCulling_TypeDefinitionIndex)->GetStaticField(0x2EA4);
		}
