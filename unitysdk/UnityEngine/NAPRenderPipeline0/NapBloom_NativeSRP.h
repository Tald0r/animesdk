...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19CFA100)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISACTIVEFORHDR_OFFSET UNITYSDK_OFFSET(0x19CF97C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19CF9770)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISSECONDARYGLAREACTIVE_OFFSET UNITYSDK_OFFSET(0x19CF9810)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19CF9840)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CFA000)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF9850)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapBloom_NativeSRP_TypeDefinitionIndex = 6096;
