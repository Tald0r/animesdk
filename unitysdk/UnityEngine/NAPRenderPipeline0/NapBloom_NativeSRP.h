...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A2852B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISACTIVEFORHDR_OFFSET UNITYSDK_OFFSET(0x1A284970)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A284920)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISSECONDARYGLAREACTIVE_OFFSET UNITYSDK_OFFSET(0x1A2849C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A2849F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2851B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOM_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A284A00)
