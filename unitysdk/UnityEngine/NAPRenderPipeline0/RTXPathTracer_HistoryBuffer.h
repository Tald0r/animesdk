...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXPATHTRACER_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19E48810)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXPATHTRACER_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x19E48970)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXPATHTRACER_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E48C90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTXPathTracer_HistoryBuffer_TypeDefinitionIndex = 5787;
