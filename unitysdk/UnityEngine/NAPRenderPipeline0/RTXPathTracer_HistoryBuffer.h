...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXPATHTRACER_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A42D140)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXPATHTRACER_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1A42D2A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTXPATHTRACER_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A42D5C0)
