...
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR3PARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CFB030)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR3PARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x19CFAFD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR3PARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CFB050)
#define UNITYENGINE_NAPRENDERPIPELINE0_VECTOR3PARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CFAF90)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Vector3Parameter_TypeDefinitionIndex = 6047;
