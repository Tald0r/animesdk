...
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A4BD820)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A4BDBA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PEROBJECTSHADOWPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BD770)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PerObjectShadowPass_NativeImpl_TypeDefinitionIndex = 5779;
