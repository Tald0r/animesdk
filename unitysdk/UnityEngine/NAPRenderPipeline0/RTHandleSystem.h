...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOCAUTOSIZEDRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x19D1DD00)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_1_OFFSET UNITYSDK_OFFSET(0x19D1D950)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_2_OFFSET UNITYSDK_OFFSET(0x19D1E410)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_3_OFFSET UNITYSDK_OFFSET(0x19D1E580)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_OFFSET UNITYSDK_OFFSET(0x19D1D3C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_DEMANDRESIZE_OFFSET UNITYSDK_OFFSET(0x19D1D0F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19D1C340)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D1C330)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_GETMAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x19D1CB80)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_GETMAXWIDTH_OFFSET UNITYSDK_OFFSET(0x19D1CB70)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_GET_RTHANDLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19D1C170)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19D1C6C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_RELEASE_OFFSET UNITYSDK_OFFSET(0x19D1C850)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_REMOVE_OFFSET UNITYSDK_OFFSET(0x19D1C8D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_RESIZE_OFFSET UNITYSDK_OFFSET(0x19D1CB90)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_SETHARDWAREDYNAMICRESOLUTIONSTATE_OFFSET UNITYSDK_OFFSET(0x19D1CE90)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_SETREFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x19D1C930)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_SWITCHRESIZEMODE_OFFSET UNITYSDK_OFFSET(0x19D1CFC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x19D1C190)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RTHandleSystem_TypeDefinitionIndex = 6003;
