...
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOCAUTOSIZEDRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A304340)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_1_OFFSET UNITYSDK_OFFSET(0x1A303F90)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_2_OFFSET UNITYSDK_OFFSET(0x1A304A50)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_3_OFFSET UNITYSDK_OFFSET(0x1A304BC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_ALLOC_OFFSET UNITYSDK_OFFSET(0x1A303A00)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_DEMANDRESIZE_OFFSET UNITYSDK_OFFSET(0x1A303730)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A302990)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A302980)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_GETMAXHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A3031D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_GETMAXWIDTH_OFFSET UNITYSDK_OFFSET(0x1A3031C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_GET_RTHANDLEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A3027C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A302D10)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A302EA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A302F20)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_RESIZE_OFFSET UNITYSDK_OFFSET(0x1A3031E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_SETHARDWAREDYNAMICRESOLUTIONSTATE_OFFSET UNITYSDK_OFFSET(0x1A3034E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_SETREFERENCESIZE_OFFSET UNITYSDK_OFFSET(0x1A302F80)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM_SWITCHRESIZEMODE_OFFSET UNITYSDK_OFFSET(0x1A303610)
#define UNITYENGINE_NAPRENDERPIPELINE0_RTHANDLESYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3027E0)
