...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A42E2D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A430D40)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_GETFRUSTUMCUBE_OFFSET UNITYSDK_OFFSET(0x1A42D7E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_ISHALFRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1A42E210)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_SETLOCALRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1A42DEC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x1A430DE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A430DF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A42D6E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS__EXECUTE_G__SETTEXTURETRANSITIONFORRESOLVESHADOWS_19_0_OFFSET UNITYSDK_OFFSET(0x1A430B50)
