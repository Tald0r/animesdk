...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E499A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19E4C670)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_GETFRUSTUMCUBE_OFFSET UNITYSDK_OFFSET(0x19E48EB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_ISHALFRESOLUTION_OFFSET UNITYSDK_OFFSET(0x19E498E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_SETLOCALRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x19E49590)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x19E4C710)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E4C720)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19E48DB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCREENSPACESHADOWRESOLVEPASS__EXECUTE_G__SETTEXTURETRANSITIONFORRESOLVESHADOWS_19_0_OFFSET UNITYSDK_OFFSET(0x19E4C480)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScreenSpaceShadowResolvePass_TypeDefinitionIndex = 5831;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(ScreenSpaceShadowResolvePass_TypeDefinitionIndex)->GetStaticField(0x56A0);
		}
		static ::System::String** StaticGet_Keyword__HALFRES_SHADOW()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ScreenSpaceShadowResolvePass_TypeDefinitionIndex)->GetStaticField(0x56A8);
		}
