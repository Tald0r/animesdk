...
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_ENSUREINTERNALOBJECTS_OFFSET UNITYSDK_OFFSET(0x19E9A7C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_GETMATERIALWITHINDEX_OFFSET UNITYSDK_OFFSET(0x19E9A780)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x19E9A770)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_SETCOMPUTESHADERS_OFFSET UNITYSDK_OFFSET(0x19E9A7A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_SETMATERIALS_OFFSET UNITYSDK_OFFSET(0x19E9A760)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_SETMESHES_OFFSET UNITYSDK_OFFSET(0x19E9A7B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_SETTEXTURES_OFFSET UNITYSDK_OFFSET(0x19E9A790)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_SETUPBLUENOISE16LTEX_OFFSET UNITYSDK_OFFSET(0x19E9A7D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x19E9A7E0)
