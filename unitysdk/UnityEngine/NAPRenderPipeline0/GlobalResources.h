...
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_ENSUREINTERNALOBJECTS_OFFSET UNITYSDK_OFFSET(0x1995A960)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_GETMATERIALWITHINDEX_OFFSET UNITYSDK_OFFSET(0x1995A920)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1995A910)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_SETCOMPUTESHADERS_OFFSET UNITYSDK_OFFSET(0x1995A940)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_SETMATERIALS_OFFSET UNITYSDK_OFFSET(0x1995A900)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_SETMESHES_OFFSET UNITYSDK_OFFSET(0x1995A950)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_SETTEXTURES_OFFSET UNITYSDK_OFFSET(0x1995A930)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES_SETUPBLUENOISE16LTEX_OFFSET UNITYSDK_OFFSET(0x1995A970)
#define UNITYENGINE_NAPRENDERPIPELINE0_GLOBALRESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1995A980)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GlobalResources_TypeDefinitionIndex = 5701;
