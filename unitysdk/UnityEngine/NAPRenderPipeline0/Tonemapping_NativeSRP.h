...
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A11F2A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A11EEE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A11EF00)
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A11F1A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11EF10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int Tonemapping_NativeSRP_TypeDefinitionIndex = 6070;
