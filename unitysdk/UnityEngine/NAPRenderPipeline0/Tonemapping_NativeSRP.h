...
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A6964C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A696100)
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A696120)
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6963C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_TONEMAPPING_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A696130)
