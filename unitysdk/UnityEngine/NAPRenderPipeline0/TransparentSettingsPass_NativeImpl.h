...
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19BBEE30)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x19BBEE00)
#define UNITYENGINE_NAPRENDERPIPELINE0_TRANSPARENTSETTINGSPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBED70)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int TransparentSettingsPass_NativeImpl_TypeDefinitionIndex = 5751;
