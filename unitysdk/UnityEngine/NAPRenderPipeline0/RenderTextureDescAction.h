...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A4BE670)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A4BE6C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A4BE330)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTEXTUREDESCACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BE320)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderTextureDescAction_TypeDefinitionIndex = 5910;
