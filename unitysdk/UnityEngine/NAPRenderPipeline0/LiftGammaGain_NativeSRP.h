...
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A11CFC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A11CB40)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A11CD70)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A11CEC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LIFTGAMMAGAIN_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11CD80)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LiftGammaGain_NativeSRP_TypeDefinitionIndex = 6069;
