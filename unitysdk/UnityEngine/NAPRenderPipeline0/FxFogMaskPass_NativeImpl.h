...
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A11C960)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A11C990)
#define UNITYENGINE_NAPRENDERPIPELINE0_FXFOGMASKPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11C8E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FxFogMaskPass_NativeImpl_TypeDefinitionIndex = 5738;
