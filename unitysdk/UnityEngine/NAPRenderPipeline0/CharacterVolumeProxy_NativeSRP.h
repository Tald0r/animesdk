...
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERVOLUMEPROXY_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19E161A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERVOLUMEPROXY_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19E16000)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERVOLUMEPROXY_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19E15EE0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CharacterVolumeProxy_NativeSRP_TypeDefinitionIndex = 6071;
