...
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERVOLUMEPROXY_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A3E5A40)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERVOLUMEPROXY_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A3E58A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CHARACTERVOLUMEPROXY_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E5780)
