...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATA_CLEANUP_OFFSET UNITYSDK_OFFSET(0x19E39AF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATA_ISANYSHADERCOMPILEDBEFORE_OFFSET UNITYSDK_OFFSET(0x19E39B30)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATA_UPDATESHADERCOMPILESTAMP_OFFSET UNITYSDK_OFFSET(0x19E39B20)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19E39B40)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CameraCacheData_TypeDefinitionIndex = 5953;
