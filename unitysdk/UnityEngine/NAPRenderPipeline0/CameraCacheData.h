...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATA_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1A402850)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATA_ISANYSHADERCOMPILEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1A402890)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATA_UPDATESHADERCOMPILESTAMP_OFFSET UNITYSDK_OFFSET(0x1A402880)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAMERACACHEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4028A0)
