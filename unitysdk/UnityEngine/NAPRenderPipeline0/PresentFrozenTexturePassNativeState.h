...
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1AA40060)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1AA40100)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AA400E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1AA40120)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AA40070)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1AA40110)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA40040)
