...
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1A4BDFA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1A4BE040)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A4BE020)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A4BE060)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A4BDFB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1A4BE050)
#define UNITYENGINE_NAPRENDERPIPELINE0_PRESENTFROZENTEXTUREPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BDF80)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int PresentFrozenTexturePassNativeState_TypeDefinitionIndex = 5748;
