...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_GETANDCLEARDRITY_OFFSET UNITYSDK_OFFSET(0x19CED3F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_GET_OVERRIDESTATE_OFFSET UNITYSDK_OFFSET(0x19CED2A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19CED3D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19CED3C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19CED3E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x19CED360)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_SET_OVERRIDESTATE_OFFSET UNITYSDK_OFFSET(0x19CED2B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19CED460)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CED450)
