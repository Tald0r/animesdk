...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_GETANDCLEARDRITY_OFFSET UNITYSDK_OFFSET(0x198148D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_GET_OVERRIDESTATE_OFFSET UNITYSDK_OFFSET(0x19814780)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x198148B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x198148A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_RELEASE_OFFSET UNITYSDK_OFFSET(0x198148C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x19814840)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER_SET_OVERRIDESTATE_OFFSET UNITYSDK_OFFSET(0x19814790)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19814940)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19814930)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeParameter_TypeDefinitionIndex = 6029;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(VolumeParameter_TypeDefinitionIndex)->GetStaticField(0x2950);
		}
