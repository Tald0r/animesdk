...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_ADD_OFFSET UNITYSDK_OFFSET(0x1A62C4D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_GETCOMPONENTLISTHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A62CA40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A62C990)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_HASSUBCLASSOF_OFFSET UNITYSDK_OFFSET(0x1A62C840)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_HAS_OFFSET UNITYSDK_OFFSET(0x1A62C5D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A62C3C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A62C710)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_RESET_OFFSET UNITYSDK_OFFSET(0x1A62C4C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62CB20)
