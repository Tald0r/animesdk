...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_ADD_OFFSET UNITYSDK_OFFSET(0x1A04BFD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_GETCOMPONENTLISTHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A04C550)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A04C4A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_HASSUBCLASSOF_OFFSET UNITYSDK_OFFSET(0x1A04C340)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_HAS_OFFSET UNITYSDK_OFFSET(0x1A04C0D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A04BEC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A04C210)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP_RESET_OFFSET UNITYSDK_OFFSET(0x1A04BFC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEPROFILE_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04C630)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeProfile_NativeSRP_TypeDefinitionIndex = 6061;
