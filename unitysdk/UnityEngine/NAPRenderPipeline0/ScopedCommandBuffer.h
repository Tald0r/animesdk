...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x197CB340)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER_GET_1_OFFSET UNITYSDK_OFFSET(0x197CAC70)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER_GET_OFFSET UNITYSDK_OFFSET(0x197CE410)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER__CCTOR_OFFSET UNITYSDK_OFFSET(0x197CE150)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x197CE3D0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ScopedCommandBuffer_TypeDefinitionIndex = 6017;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScopedCommandBuffer_TypeDefinitionIndex)->GetStaticField(0x25C0);
		}
