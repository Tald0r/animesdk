...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C39EA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER_GET_1_OFFSET UNITYSDK_OFFSET(0x19C397D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER_GET_OFFSET UNITYSDK_OFFSET(0x19C3DEB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C3DBF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCOPEDCOMMANDBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3DE70)
