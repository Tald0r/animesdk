...
#define UNITYENGINE_NAPRENDERPIPELINE0_BOOLPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A6211E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_BOOLPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A6211F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_BOOLPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6211C0)
