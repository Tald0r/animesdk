...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_ADDVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1A1A6110)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1A1A4080)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DENOISE_OFFSET UNITYSDK_OFFSET(0x1A1A57D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWFAKEPUNCTUALLIGHTVOLUMETRICFOGEXTRA_OFFSET UNITYSDK_OFFSET(0x1A1A4C80)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWFAKEPUNCTUALLIGHTVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1A1A4C90)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWPOSTLIGHTEFFECTFOREFFECT_OFFSET UNITYSDK_OFFSET(0x1A1A4100)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWPOSTLIGHTEFFECTFOROPAQUEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A1A4110)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWPUNCTUALLIGHTVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1A1A4120)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1A1A4130)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_GETLIGHTATTENUATION_OFFSET UNITYSDK_OFFSET(0x1A1A3CC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_GETVOLUMETRICFOGCONFIG_OFFSET UNITYSDK_OFFSET(0x1A1A3670)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_GET_USEREVERTMODE_OFFSET UNITYSDK_OFFSET(0x1A1A3900)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_HASVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1A1A3920)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_REMOVEVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1A1A6190)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_SETUPFAKEPUNCTUALLIGHTVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1A1A4860)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_SET_USEREVERTMODE_OFFSET UNITYSDK_OFFSET(0x1A1A3910)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A36D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE___CTOR_B__3_0_OFFSET UNITYSDK_OFFSET(0x1A1A6210)
