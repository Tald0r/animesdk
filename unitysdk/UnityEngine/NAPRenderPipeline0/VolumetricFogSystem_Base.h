...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_ADDVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x19BC19F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_CLEANUP_OFFSET UNITYSDK_OFFSET(0x19BBF960)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DENOISE_OFFSET UNITYSDK_OFFSET(0x19BC10B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWFAKEPUNCTUALLIGHTVOLUMETRICFOGEXTRA_OFFSET UNITYSDK_OFFSET(0x19BC0560)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWFAKEPUNCTUALLIGHTVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x19BC0570)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWPOSTLIGHTEFFECTFOREFFECT_OFFSET UNITYSDK_OFFSET(0x19BBF9E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWPOSTLIGHTEFFECTFOROPAQUEOBJECT_OFFSET UNITYSDK_OFFSET(0x19BBF9F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWPUNCTUALLIGHTVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x19BBFA00)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_DRAWVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x19BBFA10)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_GETLIGHTATTENUATION_OFFSET UNITYSDK_OFFSET(0x19BBF5A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_GETVOLUMETRICFOGCONFIG_OFFSET UNITYSDK_OFFSET(0x19BBEF50)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_GET_USEREVERTMODE_OFFSET UNITYSDK_OFFSET(0x19BBF1E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_HASVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x19BBF200)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_REMOVEVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x19BC1A70)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_SETUPFAKEPUNCTUALLIGHTVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x19BC0140)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE_SET_USEREVERTMODE_OFFSET UNITYSDK_OFFSET(0x19BBF1F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BBEFB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGSYSTEM_BASE___CTOR_B__3_0_OFFSET UNITYSDK_OFFSET(0x19BC1AF0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFogSystem_Base_TypeDefinitionIndex = 5996;
