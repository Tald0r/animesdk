...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CALCULATEOBLIQUEMATRIX_OFFSET UNITYSDK_OFFSET(0x1AA3D690)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CALCULATEREFLECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1AA3DB10)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CAMERASPACEPLANE_OFFSET UNITYSDK_OFFSET(0x1AA3D340)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CLEAREXTRALIGHTDATACACHE_OFFSET UNITYSDK_OFFSET(0x1AA3E780)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CLEARRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1AA3EF20)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_DESTROY_OFFSET UNITYSDK_OFFSET(0x1AA3DE80)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_FIXUPDEPTHSLICE_OFFSET UNITYSDK_OFFSET(0x1AA3EDB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_FREEZETHISCAMERA_OFFSET UNITYSDK_OFFSET(0x1AA3F390)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETEXTRALIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1AA3E880)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETFROZENRTID_OFFSET UNITYSDK_OFFSET(0x1AA3F290)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETRENDERTARGETAUTONAME_1_OFFSET UNITYSDK_OFFSET(0x1AA3E090)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETRENDERTARGETAUTONAME_OFFSET UNITYSDK_OFFSET(0x1AA3DF90)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_ISCAMERAPROJECTIONMATRIXFLIPPED_OFFSET UNITYSDK_OFFSET(0x1AA3DC70)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_LUMINANCE_OFFSET UNITYSDK_OFFSET(0x1AA3E490)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_PREPARELIFTGAMMAGAIN_OFFSET UNITYSDK_OFFSET(0x1AA3E4C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_PREPARESHADOWSMIDTONESHIGHLIGHTS_OFFSET UNITYSDK_OFFSET(0x1AA3E2D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SAFERELEASE_OFFSET UNITYSDK_OFFSET(0x1AA3DF30)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x1AA3DE40)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1AA3DE00)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETRENDERTARGET_1_OFFSET UNITYSDK_OFFSET(0x1AA3EF90)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETRENDERTARGET_2_OFFSET UNITYSDK_OFFSET(0x1AA3F0C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1AA3EDC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SGN_OFFSET UNITYSDK_OFFSET(0x1AA3D310)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_TOCOLOR_OFFSET UNITYSDK_OFFSET(0x1AA3D300)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA3F630)
