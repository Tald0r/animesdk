...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CALCULATEOBLIQUEMATRIX_OFFSET UNITYSDK_OFFSET(0x1A4BB5D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CALCULATEREFLECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1A4BBA50)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CAMERASPACEPLANE_OFFSET UNITYSDK_OFFSET(0x1A4BB280)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CLEAREXTRALIGHTDATACACHE_OFFSET UNITYSDK_OFFSET(0x1A4BC6C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_CLEARRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1A4BCE60)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_DESTROY_OFFSET UNITYSDK_OFFSET(0x1A4BBDC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_FIXUPDEPTHSLICE_OFFSET UNITYSDK_OFFSET(0x1A4BCCF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_FREEZETHISCAMERA_OFFSET UNITYSDK_OFFSET(0x1A4BD2D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETEXTRALIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1A4BC7C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETFROZENRTID_OFFSET UNITYSDK_OFFSET(0x1A4BD1D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETRENDERTARGETAUTONAME_1_OFFSET UNITYSDK_OFFSET(0x1A4BBFD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_GETRENDERTARGETAUTONAME_OFFSET UNITYSDK_OFFSET(0x1A4BBED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_ISCAMERAPROJECTIONMATRIXFLIPPED_OFFSET UNITYSDK_OFFSET(0x1A4BBBB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_LUMINANCE_OFFSET UNITYSDK_OFFSET(0x1A4BC3D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_PREPARELIFTGAMMAGAIN_OFFSET UNITYSDK_OFFSET(0x1A4BC400)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_PREPARESHADOWSMIDTONESHIGHLIGHTS_OFFSET UNITYSDK_OFFSET(0x1A4BC210)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SAFERELEASE_OFFSET UNITYSDK_OFFSET(0x1A4BBE70)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x1A4BBD80)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1A4BBD40)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETRENDERTARGET_1_OFFSET UNITYSDK_OFFSET(0x1A4BCED0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETRENDERTARGET_2_OFFSET UNITYSDK_OFFSET(0x1A4BD000)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1A4BCD00)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_SGN_OFFSET UNITYSDK_OFFSET(0x1A4BB250)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS_TOCOLOR_OFFSET UNITYSDK_OFFSET(0x1A4BB240)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPRENDERINGUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4BD570)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NAPRenderingUtils_TypeDefinitionIndex = 5980;
	...
	public:
		...
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(NAPRenderingUtils_TypeDefinitionIndex)->GetStaticField(0x53D0);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Light*, ::UnityEngine::NAPRenderPipeline0::NativeAdditionalLightData_NativeSRP*>**)Il2CppClass::FromTypeDefinitionIndex(NAPRenderingUtils_TypeDefinitionIndex)->GetStaticField(0x53D8);
		}
