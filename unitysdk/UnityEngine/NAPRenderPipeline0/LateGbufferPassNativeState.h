...
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_CREATENATIVE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A11CB00)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1A11CA40)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1A11CAF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A11CAD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A11CB20)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A11CA60)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A11CB30)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x1A11CB10)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11CA10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LateGbufferPassNativeState_TypeDefinitionIndex = 5708;
