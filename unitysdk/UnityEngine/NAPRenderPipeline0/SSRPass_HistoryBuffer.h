...
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19BCF260)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x19BCF330)
#define UNITYENGINE_NAPRENDERPIPELINE0_SSRPASS_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCF770)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SSRPass_HistoryBuffer_TypeDefinitionIndex = 5816;
