...
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19CECAB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19CECAD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19CEBB50)
