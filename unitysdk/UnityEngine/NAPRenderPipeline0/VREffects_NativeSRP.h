...
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19813FA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19813FC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VREFFECTS_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19813040)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VREffects_NativeSRP_TypeDefinitionIndex = 6101;
