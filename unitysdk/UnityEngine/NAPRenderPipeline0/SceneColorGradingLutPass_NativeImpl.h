...
#define UNITYENGINE_NAPRENDERPIPELINE0_SCENECOLORGRADINGLUTPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A047CE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SCENECOLORGRADINGLUTPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A047C60)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int SceneColorGradingLutPass_NativeImpl_TypeDefinitionIndex = 5717;
