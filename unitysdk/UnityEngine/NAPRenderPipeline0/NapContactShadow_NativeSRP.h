...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19DDACD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19DDA960)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19DDA990)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DDABD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPCONTACTSHADOW_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDA9A0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapContactShadow_NativeSRP_TypeDefinitionIndex = 6099;
