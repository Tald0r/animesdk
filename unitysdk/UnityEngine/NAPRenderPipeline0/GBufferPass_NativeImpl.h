...
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E47B20)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19E47B50)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x19E47AF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_GBUFFERPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19E47A60)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GBufferPass_NativeImpl_TypeDefinitionIndex = 5753;
