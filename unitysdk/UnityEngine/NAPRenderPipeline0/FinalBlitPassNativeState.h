...
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x19E16A80)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x19E16B20)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E16B00)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E16B40)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19E16A90)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE_SETUP_OFFSET UNITYSDK_OFFSET(0x19E16B30)
#define UNITYENGINE_NAPRENDERPIPELINE0_FINALBLITPASSNATIVESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E16A60)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FinalBlitPassNativeState_TypeDefinitionIndex = 5735;
