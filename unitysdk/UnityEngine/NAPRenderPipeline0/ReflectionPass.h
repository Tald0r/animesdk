...
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A4067C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A4057A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_RENDERPLANARREFLECTIONCUBECORRECTED_OFFSET UNITYSDK_OFFSET(0x1A405830)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x1A405770)
#define UNITYENGINE_NAPRENDERPIPELINE0_REFLECTIONPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A405630)
