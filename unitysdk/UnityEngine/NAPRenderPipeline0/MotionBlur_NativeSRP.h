...
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A2796C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A279200)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A279280)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2795C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A279290)
