...
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19BCCF60)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19BCCAA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19BCCB20)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19BCCE60)
#define UNITYENGINE_NAPRENDERPIPELINE0_MOTIONBLUR_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCCB30)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int MotionBlur_NativeSRP_TypeDefinitionIndex = 6082;
