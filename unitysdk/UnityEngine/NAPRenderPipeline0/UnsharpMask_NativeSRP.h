...
#define UNITYENGINE_NAPRENDERPIPELINE0_UNSHARPMASK_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19BCF960)
#define UNITYENGINE_NAPRENDERPIPELINE0_UNSHARPMASK_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19BCF9E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_UNSHARPMASK_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCF780)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int UnsharpMask_NativeSRP_TypeDefinitionIndex = 6104;
