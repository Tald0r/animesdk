...
#define UNITYENGINE_NAPRENDERPIPELINE0_UNSHARPMASK_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A27C100)
#define UNITYENGINE_NAPRENDERPIPELINE0_UNSHARPMASK_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A27C180)
#define UNITYENGINE_NAPRENDERPIPELINE0_UNSHARPMASK_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A27BF20)
