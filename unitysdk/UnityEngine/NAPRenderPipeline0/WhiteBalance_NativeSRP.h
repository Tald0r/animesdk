...
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19DE05D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19DE02C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19DE0310)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DE04D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x19DE0320)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int WhiteBalance_NativeSRP_TypeDefinitionIndex = 6078;
