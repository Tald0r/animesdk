...
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP_INTERPOLATEVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A36AF30)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A36AC20)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A36AC70)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A36AE30)
#define UNITYENGINE_NAPRENDERPIPELINE0_WHITEBALANCE_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A36AC80)
