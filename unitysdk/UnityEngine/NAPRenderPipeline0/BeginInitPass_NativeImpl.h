...
#define UNITYENGINE_NAPRENDERPIPELINE0_BEGININITPASS_NATIVEIMPL_BEGININITPASSGETFROMNATIVE_OFFSET UNITYSDK_OFFSET(0x1A11A040)
#define UNITYENGINE_NAPRENDERPIPELINE0_BEGININITPASS_NATIVEIMPL_EXECUTE_IMPL_OFFSET UNITYSDK_OFFSET(0x1A11A020)
#define UNITYENGINE_NAPRENDERPIPELINE0_BEGININITPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A11A030)
#define UNITYENGINE_NAPRENDERPIPELINE0_BEGININITPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A119FC0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int BeginInitPass_NativeImpl_TypeDefinitionIndex = 5707;
