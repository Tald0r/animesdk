...
#define UNITYENGINE_NAPRENDERPIPELINE0_INTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CF95B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x19CF9670)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CF95C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF76B0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int IntParameter_TypeDefinitionIndex = 6037;
