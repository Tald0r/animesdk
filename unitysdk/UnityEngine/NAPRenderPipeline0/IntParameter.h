...
#define UNITYENGINE_NAPRENDERPIPELINE0_INTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A284760)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1A284820)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A284770)
#define UNITYENGINE_NAPRENDERPIPELINE0_INTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A282850)
