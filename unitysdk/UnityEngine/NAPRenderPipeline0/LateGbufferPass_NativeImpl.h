...
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x197CC830)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x197CC860)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASS_NATIVEIMPL_SETUP_OFFSET UNITYSDK_OFFSET(0x197CC800)
#define UNITYENGINE_NAPRENDERPIPELINE0_LATEGBUFFERPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x197CC770)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int LateGbufferPass_NativeImpl_TypeDefinitionIndex = 5709;
