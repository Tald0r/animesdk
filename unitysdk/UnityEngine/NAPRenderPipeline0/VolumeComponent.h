...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A27CF10)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1A27C250)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A27C190)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A27C270)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A27CFE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A27C720)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A27C290)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_OVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A27C9B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A27CFF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SETALLOVERRIDESTO_1_OFFSET UNITYSDK_OFFSET(0x1A27CC10)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SETALLOVERRIDESTO_OFFSET UNITYSDK_OFFSET(0x1A27CC00)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1A27C260)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A27C1A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A27C280)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A274140)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT__ONENABLE_B__15_2_OFFSET UNITYSDK_OFFSET(0x1A27D090)
