...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19BD0760)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x19BCFAB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19BCF9F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x19BCFAD0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19BD0830)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19BCFF70)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19BCFAF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_OVERRIDE_OFFSET UNITYSDK_OFFSET(0x19BD0200)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_RELEASE_OFFSET UNITYSDK_OFFSET(0x19BD0840)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SETALLOVERRIDESTO_1_OFFSET UNITYSDK_OFFSET(0x19BD0460)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SETALLOVERRIDESTO_OFFSET UNITYSDK_OFFSET(0x19BD0450)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x19BCFAC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19BCFA00)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x19BCFAE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC79E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMECOMPONENT__ONENABLE_B__15_2_OFFSET UNITYSDK_OFFSET(0x19BD08E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeComponent_TypeDefinitionIndex = 6054;
