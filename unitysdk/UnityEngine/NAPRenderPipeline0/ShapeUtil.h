...
#define UNITYENGINE_NAPRENDERPIPELINE0_SHAPEUTIL_GENERATESPHERE_OFFSET UNITYSDK_OFFSET(0x1A305450)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHAPEUTIL_GENERATESPOTSHAPE_OFFSET UNITYSDK_OFFSET(0x1A3053F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHAPEUTIL_REGENERATESPOTSHAPE_OFFSET UNITYSDK_OFFSET(0x1A304EB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_SHAPEUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A305B80)
