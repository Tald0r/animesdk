...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x916B10)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x32E7F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_GET_ID_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x916A80)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_INIT_OFFSET UNITYSDK_OFFSET(0x916A60)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A1A2C80)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A1A2C90)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_SET_ID_OFFSET UNITYSDK_OFFSET(0x302300)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1A2CA0)
...
namespace UnityEngine::NAPRenderPipeline0
{
	...
	struct alignas(4) RenderTargetHandle
	{
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderTargetHandle*)Il2CppClass::FromTypeDefinitionIndex(RenderTargetHandle_TypeDefinitionIndex)->GetStaticField(0x22E0);
		}
