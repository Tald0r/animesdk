...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8E8B10)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3275B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_GET_ID_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x8E8A80)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_INIT_OFFSET UNITYSDK_OFFSET(0x8E8A60)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19BBE560)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19BBE570)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE_SET_ID_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERTARGETHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19BBE580)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderTargetHandle_TypeDefinitionIndex = 5935;
