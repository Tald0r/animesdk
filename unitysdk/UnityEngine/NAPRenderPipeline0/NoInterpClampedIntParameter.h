...
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPCLAMPEDINTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19BCD440)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPCLAMPEDINTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19BCD450)
#define UNITYENGINE_NAPRENDERPIPELINE0_NOINTERPCLAMPEDINTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCD500)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NoInterpClampedIntParameter_TypeDefinitionIndex = 6039;
