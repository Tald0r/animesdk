...
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASS_NOTNATIVE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1923E050)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASS_NOTNATIVE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1923EC70)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASS_NOTNATIVE_SETCOMPUTEPARAMS_OFFSET UNITYSDK_OFFSET(0x1923E6D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASS_NOTNATIVE_SETUP_OFFSET UNITYSDK_OFFSET(0x1923DD40)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASS_NOTNATIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1923DCA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CAPSULEAOPASS_NOTNATIVE___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1923ED10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int CapsuleAOPass_NotNative_TypeDefinitionIndex = 28307;
	...
	public:
		...
		::System::Single ShadowSharpness; // 0xB8
		::System::Int32 kernel; // 0xBC
		::UnityEngine::Rendering::RenderTargetIdentifier targetHandle; // 0xC0
		::System::Single LuminanceBlend; // 0xE8
		::System::Single ShadowIntensity; // 0xEC
		::System::Single AmbientIntensity; // 0xF0
		::UnityEngine::RenderTextureDescriptor desc; // 0xF4
		::System::Int32 width; // 0x12C
		::System::Int32 height; // 0x130
