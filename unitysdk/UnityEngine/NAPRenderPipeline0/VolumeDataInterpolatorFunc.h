...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEDATAINTERPOLATORFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x198146F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEDATAINTERPOLATORFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19814770)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEDATAINTERPOLATORFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x19813FE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEDATAINTERPOLATORFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x19813FD0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeDataInterpolatorFunc_TypeDefinitionIndex = 6052;
