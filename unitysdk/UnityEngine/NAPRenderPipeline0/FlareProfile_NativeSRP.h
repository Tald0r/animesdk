...
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_CHECK_OFFSET UNITYSDK_OFFSET(0x1A525A40)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A525DA0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_GET_PACKEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1A525EC0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_GET_PARAMDIRTY_OFFSET UNITYSDK_OFFSET(0x1A525A30)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A526080)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A526070)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A526090)
