...
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A041460)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS_NATIVEIMPL_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1A041490)
#define UNITYENGINE_NAPRENDERPIPELINE0_GENERATELIGHTSHAFTPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0413E0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int GenerateLightShaftPass_NativeImpl_TypeDefinitionIndex = 5742;
