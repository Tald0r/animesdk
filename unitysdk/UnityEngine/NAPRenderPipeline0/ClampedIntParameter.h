...
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDINTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A282750)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDINTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A282760)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDINTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A282810)
