...
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDINTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CF75B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDINTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19CF75C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_CLAMPEDINTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19CF7670)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ClampedIntParameter_TypeDefinitionIndex = 6038;
