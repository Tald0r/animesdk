...
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSGETDUMMYGPUDATASIZE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19BCF200)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSGETDUMMYGPUDATASIZE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19BCF230)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSGETDUMMYGPUDATASIZE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19BCEF60)
#define UNITYENGINE_NAPRENDERPIPELINE0_RENDERPASSCALLBACKS_RENDERPASSGETDUMMYGPUDATASIZE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BCEF50)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int RenderPassCallbacks_RenderPassGetDummyGPUDataSize_TypeDefinitionIndex = 5694;
