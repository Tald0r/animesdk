...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPBLOOMQUALITYPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11ED10)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapBloomQualityParameter_TypeDefinitionIndex = 6093;
