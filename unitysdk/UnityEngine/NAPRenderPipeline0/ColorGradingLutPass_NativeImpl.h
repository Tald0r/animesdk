...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19F48370)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL_GETLIFTGAMMAGAINSETTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x19F48360)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL_SETLIFTGAMMAGAINSETTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x19F482B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x19F48230)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int ColorGradingLutPass_NativeImpl_TypeDefinitionIndex = 5715;
