...
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A525040)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL_GETLIFTGAMMAGAINSETTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1A525030)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL_SETLIFTGAMMAGAINSETTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1A524F80)
#define UNITYENGINE_NAPRENDERPIPELINE0_COLORGRADINGLUTPASS_NATIVEIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A524F00)
