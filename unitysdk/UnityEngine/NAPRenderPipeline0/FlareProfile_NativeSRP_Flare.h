...
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE_PACK2VECTOR4_OFFSET UNITYSDK_OFFSET(0x1A3022B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE_PACKVECTOR2_1_OFFSET UNITYSDK_OFFSET(0x1A302200)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE_PACKVECTOR2_OFFSET UNITYSDK_OFFSET(0x1A302160)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A302510)
