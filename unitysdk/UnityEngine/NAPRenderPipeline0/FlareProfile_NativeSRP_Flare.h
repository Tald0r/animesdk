...
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE_PACK2VECTOR4_OFFSET UNITYSDK_OFFSET(0x19D1BC60)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE_PACKVECTOR2_1_OFFSET UNITYSDK_OFFSET(0x19D1BBB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE_PACKVECTOR2_OFFSET UNITYSDK_OFFSET(0x19D1BB10)
#define UNITYENGINE_NAPRENDERPIPELINE0_FLAREPROFILE_NATIVESRP_FLARE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D1BEC0)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int FlareProfile_NativeSRP_Flare_TypeDefinitionIndex = 5688;
