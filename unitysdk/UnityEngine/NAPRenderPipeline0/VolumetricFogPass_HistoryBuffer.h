...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19E4CF70)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x19E4CFF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMETRICFOGPASS_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E4D370)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumetricFogPass_HistoryBuffer_TypeDefinitionIndex = 5835;
