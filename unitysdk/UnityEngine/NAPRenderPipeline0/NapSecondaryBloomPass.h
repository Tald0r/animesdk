...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19CE1710)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19CE28B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_NAPSECONDARYBLOOMPASSBLUR_OFFSET UNITYSDK_OFFSET(0x19CE24C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19CE1670)
