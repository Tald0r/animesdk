...
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x198091C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1980A360)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS_NAPSECONDARYBLOOMPASSBLUR_OFFSET UNITYSDK_OFFSET(0x19809F70)
#define UNITYENGINE_NAPRENDERPIPELINE0_NAPSECONDARYBLOOMPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19809120)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int NapSecondaryBloomPass_TypeDefinitionIndex = 5826;
