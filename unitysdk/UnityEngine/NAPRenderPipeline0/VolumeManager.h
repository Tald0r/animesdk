...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_CREATESTACK_OFFSET UNITYSDK_OFFSET(0x1A367EF0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_GETINTERPOLATEDVOLUMESTACKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A367C90)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_GET_BASECOMPONENTTYPES_OFFSET UNITYSDK_OFFSET(0x1A367CE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_GET_GLOBALPROFILE_OFFSET UNITYSDK_OFFSET(0x1A3698A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A3678A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_GRABVOLUMES_OFFSET UNITYSDK_OFFSET(0x1A369C40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0x1A368450)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_REBUILDINTERPOLATEDVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x1A369FB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_REGISTERDEFAULTPROFILE_OFFSET UNITYSDK_OFFSET(0x1A3698B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x1A367F90)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_RELOADBASETYPES_OFFSET UNITYSDK_OFFSET(0x1A367D40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_REPLACEDATA_OFFSET UNITYSDK_OFFSET(0x1A3685E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_SETLAYERDIRTY_OFFSET UNITYSDK_OFFSET(0x1A368160)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_SORTBYPRIORITY_OFFSET UNITYSDK_OFFSET(0x1A36A760)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1A3682A0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_UPDATEVOLUMELAYER_OFFSET UNITYSDK_OFFSET(0x1A368420)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1A368B20)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A368A40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A36A8B0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A367990)
...
namespace UnityEngine::NAPRenderPipeline0
{
	...
	public:
		...
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(VolumeManager_TypeDefinitionIndex)->GetStaticField(0x5560);
		}
		static ::Il2CppArray<::System::Type*>** StaticGet_VolumeComponentTypes()
		{
			return (::Il2CppArray<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(VolumeManager_TypeDefinitionIndex)->GetStaticField(0x5568);
		}
		static ::UnityEngine::NAPRenderPipeline0::VolumeManager** StaticGet_s_Instance()
		{
			return (::UnityEngine::NAPRenderPipeline0::VolumeManager**)Il2CppClass::FromTypeDefinitionIndex(VolumeManager_TypeDefinitionIndex)->GetStaticField(0x5570);
		}
