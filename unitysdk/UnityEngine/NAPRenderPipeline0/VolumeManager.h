...
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_CREATESTACK_OFFSET UNITYSDK_OFFSET(0x19DDD580)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_GETINTERPOLATEDVOLUMESTACKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x19DDD320)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_GET_BASECOMPONENTTYPES_OFFSET UNITYSDK_OFFSET(0x19DDD370)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_GET_GLOBALPROFILE_OFFSET UNITYSDK_OFFSET(0x19DDEF40)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19DDCF30)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_GRABVOLUMES_OFFSET UNITYSDK_OFFSET(0x19DDF2E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_OVERRIDEDATA_OFFSET UNITYSDK_OFFSET(0x19DDDAE0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_REBUILDINTERPOLATEDVOLUMEDATA_OFFSET UNITYSDK_OFFSET(0x19DDF650)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_REGISTERDEFAULTPROFILE_OFFSET UNITYSDK_OFFSET(0x19DDEF50)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x19DDD620)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_RELOADBASETYPES_OFFSET UNITYSDK_OFFSET(0x19DDD3D0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_REPLACEDATA_OFFSET UNITYSDK_OFFSET(0x19DDDC80)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_SETLAYERDIRTY_OFFSET UNITYSDK_OFFSET(0x19DDD7F0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_SORTBYPRIORITY_OFFSET UNITYSDK_OFFSET(0x19DDFE00)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x19DDD930)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_UPDATEVOLUMELAYER_OFFSET UNITYSDK_OFFSET(0x19DDDAB0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x19DDE1C0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19DDE0E0)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19DDFF50)
#define UNITYENGINE_NAPRENDERPIPELINE0_VOLUMEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DDD020)

namespace UnityEngine::NAPRenderPipeline0
{
	inline static constexpr unsigned int VolumeManager_TypeDefinitionIndex = 6065;
	...
	public:
		...
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(VolumeManager_TypeDefinitionIndex)->GetStaticField(0x5520);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SampleCheckBaseTypes()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(VolumeManager_TypeDefinitionIndex)->GetStaticField(0x5528);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SampleTraverseVolumes()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(VolumeManager_TypeDefinitionIndex)->GetStaticField(0x5530);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SampleVolumeManagerUpdate()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(VolumeManager_TypeDefinitionIndex)->GetStaticField(0x5538);
		}
		static ::UnityEngine::NAPRenderPipeline0::VolumeManager** StaticGet_s_Instance()
		{
			return (::UnityEngine::NAPRenderPipeline0::VolumeManager**)Il2CppClass::FromTypeDefinitionIndex(VolumeManager_TypeDefinitionIndex)->GetStaticField(0x5540);
		}
		static ::Il2CppArray<::System::Type*>** StaticGet_VolumeComponentTypes()
		{
			return (::Il2CppArray<::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(VolumeManager_TypeDefinitionIndex)->GetStaticField(0x5548);
		}
