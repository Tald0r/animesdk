...
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A52DAC0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A52DB40)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A52D3C0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A52D3A0)
