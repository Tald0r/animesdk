...
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19F35BC0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19F35C40)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19F354E0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING_REQUESTLIGHTSDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F354D0)

namespace UnityEngine::Experimental::GlobalIllumination
{
	inline static constexpr unsigned int Lightmapping_RequestLightsDelegate_TypeDefinitionIndex = 6290;
