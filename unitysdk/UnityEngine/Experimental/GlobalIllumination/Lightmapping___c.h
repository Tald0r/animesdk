...
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA3C880)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA3C8B0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING___C___CCTOR_B__7_0_OFFSET UNITYSDK_OFFSET(0x1AA3C8C0)
