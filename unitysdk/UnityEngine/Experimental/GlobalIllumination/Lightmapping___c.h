...
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4BA7D0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BA800)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPING___C___CCTOR_B__7_0_OFFSET UNITYSDK_OFFSET(0x1A4BA810)

namespace UnityEngine::Experimental::GlobalIllumination
{
	inline static constexpr unsigned int Lightmapping___c_TypeDefinitionIndex = 6291;
	...
	public:
		...
		{
			return (::UnityEngine::Experimental::GlobalIllumination::Lightmapping___c**)Il2CppClass::FromTypeDefinitionIndex(Lightmapping___c_TypeDefinitionIndex)->GetStaticField(0x5300);
		}
