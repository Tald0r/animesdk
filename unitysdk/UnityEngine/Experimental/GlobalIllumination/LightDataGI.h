...
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTDATAGI_INITNOBAKE_OFFSET UNITYSDK_OFFSET(0x8FAE40)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTDATAGI_INIT_1_OFFSET UNITYSDK_OFFSET(0x8FAC90)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTDATAGI_INIT_2_OFFSET UNITYSDK_OFFSET(0x8FAD00)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTDATAGI_INIT_3_OFFSET UNITYSDK_OFFSET(0x8FAD70)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTDATAGI_INIT_4_OFFSET UNITYSDK_OFFSET(0x8FADD0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTDATAGI_INIT_OFFSET UNITYSDK_OFFSET(0x8FABC0)

namespace UnityEngine::Experimental::GlobalIllumination
{
	inline static constexpr unsigned int LightDataGI_TypeDefinitionIndex = 6287;
