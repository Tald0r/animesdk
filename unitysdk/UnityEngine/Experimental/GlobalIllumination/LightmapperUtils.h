...
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACTINDIRECT_OFFSET UNITYSDK_OFFSET(0x197C7900)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACTINNERCONE_OFFSET UNITYSDK_OFFSET(0x197C7A80)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_1_OFFSET UNITYSDK_OFFSET(0x197C7F40)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_2_OFFSET UNITYSDK_OFFSET(0x197C82E0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_3_OFFSET UNITYSDK_OFFSET(0x197C8710)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_4_OFFSET UNITYSDK_OFFSET(0x197C8AF0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_OFFSET UNITYSDK_OFFSET(0x197C7AD0)

namespace UnityEngine::Experimental::GlobalIllumination
{
	inline static constexpr unsigned int LightmapperUtils_TypeDefinitionIndex = 6288;
