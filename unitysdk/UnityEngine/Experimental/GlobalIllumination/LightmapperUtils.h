...
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACTINDIRECT_OFFSET UNITYSDK_OFFSET(0x19C36B90)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACTINNERCONE_OFFSET UNITYSDK_OFFSET(0x19C36D10)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_1_OFFSET UNITYSDK_OFFSET(0x19C371D0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_2_OFFSET UNITYSDK_OFFSET(0x19C37570)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_3_OFFSET UNITYSDK_OFFSET(0x19C379A0)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_4_OFFSET UNITYSDK_OFFSET(0x19C37D80)
#define UNITYENGINE_EXPERIMENTAL_GLOBALILLUMINATION_LIGHTMAPPERUTILS_EXTRACT_OFFSET UNITYSDK_OFFSET(0x19C36D60)
