...
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9648C0)
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_EQUALS_OFFSET UNITYSDK_OFFSET(0x387830)
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7B3E80)
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_ISNULL_OFFSET UNITYSDK_OFFSET(0x2C3A90)
#define UNITYENGINE_EXPERIMENTAL_AI_POLYGONID_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AD92B10)

namespace UnityEngine::Experimental::AI
{
	inline static constexpr unsigned int PolygonId_TypeDefinitionIndex = 23624;
