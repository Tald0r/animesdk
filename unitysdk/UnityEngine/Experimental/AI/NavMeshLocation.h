...
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHLOCATION_GET_POLYGON_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHLOCATION_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x510540)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x9644C0)

namespace UnityEngine::Experimental::AI
{
	inline static constexpr unsigned int NavMeshLocation_TypeDefinitionIndex = 23625;
