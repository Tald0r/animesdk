...
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHLOCATION_GET_POLYGON_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHLOCATION_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x558D50)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHLOCATION__CTOR_OFFSET UNITYSDK_OFFSET(0x994420)

namespace UnityEngine::Experimental::AI
{
	inline static constexpr unsigned int NavMeshLocation_TypeDefinitionIndex = 24308;
