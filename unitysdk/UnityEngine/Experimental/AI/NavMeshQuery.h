...
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_BEGINFINDPATH_1_OFFSET UNITYSDK_OFFSET(0x1B39AA20)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_BEGINFINDPATH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B39AAA0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_BEGINFINDPATH_OFFSET UNITYSDK_OFFSET(0x994490)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_CREATELOCATION_OFFSET UNITYSDK_OFFSET(0x994580)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_CREATE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B39A9B0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_CREATE_OFFSET UNITYSDK_OFFSET(0x1B39A960)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B39A9A0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x994470)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ENDFINDPATH_1_OFFSET UNITYSDK_OFFSET(0x1B39AA60)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ENDFINDPATH_OFFSET UNITYSDK_OFFSET(0x994500)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETCLOSESTPOINTONPOLY_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B39AB60)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETCLOSESTPOINTONPOLY_OFFSET UNITYSDK_OFFSET(0x1B39AB40)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPATHRESULT_1_OFFSET UNITYSDK_OFFSET(0x1B39AA90)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPATHRESULT_OFFSET UNITYSDK_OFFSET(0x994510)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPOLYGONTYPE_1_OFFSET UNITYSDK_OFFSET(0x9947D0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPOLYGONTYPE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B39AFA0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPOLYGONTYPE_OFFSET UNITYSDK_OFFSET(0x1B39AF80)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPORTALPOINTS_1_OFFSET UNITYSDK_OFFSET(0x9946B0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPORTALPOINTS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B39AD50)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_GETPORTALPOINTS_OFFSET UNITYSDK_OFFSET(0x1B39AD20)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ISVALIDPOLYGON_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B39AAD0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ISVALIDPOLYGON_OFFSET UNITYSDK_OFFSET(0x1B39AAB0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ISVALIDPTR_OFFSET UNITYSDK_OFFSET(0x1B39AAE0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ISVALID_1_OFFSET UNITYSDK_OFFSET(0x994560)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_ISVALID_OFFSET UNITYSDK_OFFSET(0x994530)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_MAPLOCATION_1_OFFSET UNITYSDK_OFFSET(0x994620)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_MAPLOCATION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B39AC80)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_MAPLOCATION_OFFSET UNITYSDK_OFFSET(0x1B39AC10)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_POLYGONLOCALTOWORLDMATRIX_1_OFFSET UNITYSDK_OFFSET(0x9946F0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_POLYGONLOCALTOWORLDMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B39AE10)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_POLYGONLOCALTOWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0x1B39ADA0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_POLYGONWORLDTOLOCALMATRIX_1_OFFSET UNITYSDK_OFFSET(0x994760)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_POLYGONWORLDTOLOCALMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B39AF00)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_POLYGONWORLDTOLOCALMATRIX_OFFSET UNITYSDK_OFFSET(0x1B39AE90)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_UPDATEFINDPATH_1_OFFSET UNITYSDK_OFFSET(0x1B39AA40)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY_UPDATEFINDPATH_OFFSET UNITYSDK_OFFSET(0x9944F0)
#define UNITYENGINE_EXPERIMENTAL_AI_NAVMESHQUERY__CTOR_OFFSET UNITYSDK_OFFSET(0x994440)

namespace UnityEngine::Experimental::AI
{
	inline static constexpr unsigned int NavMeshQuery_TypeDefinitionIndex = 24312;
