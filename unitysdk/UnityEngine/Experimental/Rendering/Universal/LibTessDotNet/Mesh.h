...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_ADDEDGEVERTEX_OFFSET UNITYSDK_OFFSET(0x182D6B00)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_CHECK_OFFSET UNITYSDK_OFFSET(0x182D7440)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_CONNECT_OFFSET UNITYSDK_OFFSET(0x182D6D70)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_DELETE_OFFSET UNITYSDK_OFFSET(0x182D6980)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_MAKEEDGE_OFFSET UNITYSDK_OFFSET(0x182D67E0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_MERGECONVEXFACES_OFFSET UNITYSDK_OFFSET(0x182D7060)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_ONFREE_OFFSET UNITYSDK_OFFSET(0x182D6690)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_RESET_OFFSET UNITYSDK_OFFSET(0x182D6640)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_SPLICE_OFFSET UNITYSDK_OFFSET(0x182D6860)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_SPLITEDGE_OFFSET UNITYSDK_OFFSET(0x182D6BB0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH_ZAPFACE_OFFSET UNITYSDK_OFFSET(0x182D6EA0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH__CTOR_OFFSET UNITYSDK_OFFSET(0x182D6520)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_UNIVERSAL_LIBTESSDOTNET_MESH___BASE_ONFREE_OFFSET UNITYSDK_OFFSET(0x182D7540)

namespace UnityEngine::Experimental::Rendering::Universal::LibTessDotNet
{
	inline static constexpr unsigned int Mesh_TypeDefinitionIndex = 29220;
	...
	{
	public:
		::UnityEngine::Experimental::Rendering::Universal::LibTessDotNet::MeshUtils_Vertex* _vHead; // 0x10
