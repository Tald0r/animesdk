...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE_CREATE_INJECTED_OFFSET UNITYSDK_OFFSET(0x197C8FF0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE_CREATE_OFFSET UNITYSDK_OFFSET(0x197C8FA0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE_DESTROY_OFFSET UNITYSDK_OFFSET(0x197C8F60)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x197C8EE0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x197C8F10)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x197C8ED0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197C8FB0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RAYTRACINGACCELERATIONSTRUCTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x197C8F70)

namespace UnityEngine::Experimental::Rendering
{
	inline static constexpr unsigned int RayTracingAccelerationStructure_TypeDefinitionIndex = 6315;
