...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHLOGINDENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x81DB60)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHLOGINDENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x81DAC0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHLOGINDENT__CTOR_OFFSET UNITYSDK_OFFSET(0x81DAB0)

namespace UnityEngine::Experimental::Rendering::RenderGraphModule
{
	inline static constexpr unsigned int RenderGraphLogIndent_TypeDefinitionIndex = 9502;
