...
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x2D38E0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_ISVALID_OFFSET UNITYSDK_OFFSET(0x7EDF40)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x184231C0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_SET_HANDLE_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x2D38F0)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x2C6250)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7EDF30)
#define UNITYENGINE_EXPERIMENTAL_RENDERING_RENDERGRAPHMODULE_RENDERGRAPHMUTABLERESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x7EDF20)

namespace UnityEngine::Experimental::Rendering::RenderGraphModule
{
	inline static constexpr unsigned int RenderGraphMutableResource_TypeDefinitionIndex = 9507;
