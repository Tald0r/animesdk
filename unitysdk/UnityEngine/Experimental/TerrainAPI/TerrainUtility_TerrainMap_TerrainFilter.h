...
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_TERRAINFILTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B033490)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_TERRAINFILTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0334C0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_TERRAINFILTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B031CA0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINUTILITY_TERRAINMAP_TERRAINFILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0307F0)

namespace UnityEngine::Experimental::TerrainAPI
{
	inline static constexpr unsigned int TerrainUtility_TerrainMap_TerrainFilter_TypeDefinitionIndex = 29451;
