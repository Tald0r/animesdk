...
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINCALLBACKS_TEXTURECHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B640240)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINCALLBACKS_TEXTURECHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6402F0)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINCALLBACKS_TEXTURECHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B63F930)
#define UNITYENGINE_EXPERIMENTAL_TERRAINAPI_TERRAINCALLBACKS_TEXTURECHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B640220)

namespace UnityEngine::Experimental::TerrainAPI
{
	inline static constexpr unsigned int TerrainCallbacks_TextureChangedCallback_TypeDefinitionIndex = 30401;
