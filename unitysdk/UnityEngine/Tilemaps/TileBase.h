...
#define UNITYENGINE_TILEMAPS_TILEBASE_GETTILEANIMATIONDATANOREF_OFFSET UNITYSDK_OFFSET(0x1B765580)
#define UNITYENGINE_TILEMAPS_TILEBASE_GETTILEANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0x1B765570)
#define UNITYENGINE_TILEMAPS_TILEBASE_GETTILEDATANOREF_OFFSET UNITYSDK_OFFSET(0x1B7654A0)
#define UNITYENGINE_TILEMAPS_TILEBASE_GETTILEDATA_OFFSET UNITYSDK_OFFSET(0x1B765490)
#define UNITYENGINE_TILEMAPS_TILEBASE_REFRESHTILE_OFFSET UNITYSDK_OFFSET(0x1B765450)
#define UNITYENGINE_TILEMAPS_TILEBASE_STARTUP_OFFSET UNITYSDK_OFFSET(0x1B7655E0)
#define UNITYENGINE_TILEMAPS_TILEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B765420)

namespace UnityEngine::Tilemaps
{
	inline static constexpr unsigned int TileBase_TypeDefinitionIndex = 82484;
