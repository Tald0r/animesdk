...
#define UNITYENGINE_TILEMAPS_TILEMAP_REFRESHTILE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B7655F0)
#define UNITYENGINE_TILEMAPS_TILEMAP_REFRESHTILE_OFFSET UNITYSDK_OFFSET(0x1B7651A0)
#define UNITYENGINE_TILEMAPS_TILEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B765600)

namespace UnityEngine::Tilemaps
{
	inline static constexpr unsigned int Tilemap_TypeDefinitionIndex = 82485;
