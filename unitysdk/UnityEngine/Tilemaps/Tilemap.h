...
#define UNITYENGINE_TILEMAPS_TILEMAP_REFRESHTILE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B1475C0)
#define UNITYENGINE_TILEMAPS_TILEMAP_REFRESHTILE_OFFSET UNITYSDK_OFFSET(0x1B147170)
#define UNITYENGINE_TILEMAPS_TILEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1475D0)

namespace UnityEngine::Tilemaps
{
	inline static constexpr unsigned int Tilemap_TypeDefinitionIndex = 80443;
