...
#define UNITYENGINE_RENDERING_BITARRAY256_BITAND_OFFSET UNITYSDK_OFFSET(0x7EF390)
#define UNITYENGINE_RENDERING_BITARRAY256_BITNOT_OFFSET UNITYSDK_OFFSET(0x7EF3B0)
#define UNITYENGINE_RENDERING_BITARRAY256_BITOR_OFFSET UNITYSDK_OFFSET(0x7EF3A0)
#define UNITYENGINE_RENDERING_BITARRAY256_EQUALS_OFFSET UNITYSDK_OFFSET(0x7EF3C0)
#define UNITYENGINE_RENDERING_BITARRAY256_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7EF3D0)
#define UNITYENGINE_RENDERING_BITARRAY256_GET_ALLFALSE_OFFSET UNITYSDK_OFFSET(0x7EF150)
#define UNITYENGINE_RENDERING_BITARRAY256_GET_ALLTRUE_OFFSET UNITYSDK_OFFSET(0x7EF200)
#define UNITYENGINE_RENDERING_BITARRAY256_GET_CAPACITY_OFFSET UNITYSDK_OFFSET(0x3B7B80)
#define UNITYENGINE_RENDERING_BITARRAY256_GET_HUMANIZEDDATA_OFFSET UNITYSDK_OFFSET(0x7EF2B0)
#define UNITYENGINE_RENDERING_BITARRAY256_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x7EF2C0)
#define UNITYENGINE_RENDERING_BITARRAY256_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x1842BD30)
#define UNITYENGINE_RENDERING_BITARRAY256_OP_BITWISEOR_OFFSET UNITYSDK_OFFSET(0x1842BC80)
#define UNITYENGINE_RENDERING_BITARRAY256_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1842C2D0)
#define UNITYENGINE_RENDERING_BITARRAY256_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1842C370)
#define UNITYENGINE_RENDERING_BITARRAY256_OP_ONESCOMPLEMENT_OFFSET UNITYSDK_OFFSET(0x1842BBF0)
#define UNITYENGINE_RENDERING_BITARRAY256_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x7EF2D0)
#define UNITYENGINE_RENDERING_BITARRAY256__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3B7D60)
#define UNITYENGINE_RENDERING_BITARRAY256__CTOR_OFFSET UNITYSDK_OFFSET(0x38AAB0)
#define UNITYENGINE_RENDERING_BITARRAY256___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7EF4B0)
#define UNITYENGINE_RENDERING_BITARRAY256___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7EF520)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int BitArray256_TypeDefinitionIndex = 9578;
