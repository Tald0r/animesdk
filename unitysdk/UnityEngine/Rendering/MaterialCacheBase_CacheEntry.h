...
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_CACHEENTRY_CLEAR_OFFSET UNITYSDK_OFFSET(0x18385090)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_CACHEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x18385130)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int MaterialCacheBase_CacheEntry_TypeDefinitionIndex = 28325;
