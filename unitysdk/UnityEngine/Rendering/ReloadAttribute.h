...
#define UNITYENGINE_RENDERING_RELOADATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18A45E80)
#define UNITYENGINE_RENDERING_RELOADATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x18A45ED0)
#define UNITYENGINE_RENDERING_RELOADATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A45E70)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ReloadAttribute_TypeDefinitionIndex = 9588;
