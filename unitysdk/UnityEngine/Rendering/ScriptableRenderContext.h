...
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_AUTOPROFILECAMERA_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3740)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_AUTOPROFILECAMERA_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA350)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_AUTOPROFILECAMERA_OFFSET UNITYSDK_OFFSET(0x8FA350)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINRENDERPASS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19DE3440)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINRENDERPASS_OFFSET UNITYSDK_OFFSET(0x8FA360)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINRENDERQUERY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3620)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINRENDERQUERY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA2A0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINRENDERQUERY_OFFSET UNITYSDK_OFFSET(0x8FA2A0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINSUBPASS_1_OFFSET UNITYSDK_OFFSET(0x8FA3E0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINSUBPASS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19DE3450)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BEGINSUBPASS_OFFSET UNITYSDK_OFFSET(0x8FA3A0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BUILDRAYTRACINGACCELERATIONSTRUCTURE_1_OFFSET UNITYSDK_OFFSET(0x8FA2F0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BUILDRAYTRACINGACCELERATIONSTRUCTURE_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE36C0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BUILDRAYTRACINGACCELERATIONSTRUCTURE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA2F0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_BUILDRAYTRACINGACCELERATIONSTRUCTURE_OFFSET UNITYSDK_OFFSET(0x8FA6B0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_CREATEGPUFENCE_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3700)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_CREATEGPUFENCE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA330)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_CREATEGRAPHICSFENCE_OFFSET UNITYSDK_OFFSET(0x8FA6E0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_CULL_OFFSET UNITYSDK_OFFSET(0x8FA670)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWHIZDEBUGRENDERERS_OFFSET UNITYSDK_OFFSET(0x8FA4B0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWRENDERERS_1_OFFSET UNITYSDK_OFFSET(0x8FA470)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWRENDERERS_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3540)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWRENDERERS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA230)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWRENDERERS_OFFSET UNITYSDK_OFFSET(0x8FA440)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWSHADOWS_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3560)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWSHADOWS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA240)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_DRAWSHADOWS_OFFSET UNITYSDK_OFFSET(0x8FA240)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDRENDERPASS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19DE3470)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDRENDERPASS_OFFSET UNITYSDK_OFFSET(0x8FA430)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDRENDERQUERY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3640)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDRENDERQUERY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA2B0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDRENDERQUERY_OFFSET UNITYSDK_OFFSET(0x8FA2B0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDSUBPASS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19DE3460)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_ENDSUBPASS_OFFSET UNITYSDK_OFFSET(0x8FA420)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8FA8B0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EQUALS_OFFSET UNITYSDK_OFFSET(0x8FA860)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTEANDCLEARCOMMANDBUFFER_OFFSET UNITYSDK_OFFSET(0x8FA570)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTECOMMANDBUFFER_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3580)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTECOMMANDBUFFER_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA250)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTECOMMANDBUFFER_OFFSET UNITYSDK_OFFSET(0x8FA4F0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTESRPCMDBUFFER_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE35A0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTESRPCMDBUFFER_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA260)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_EXECUTESRPCMDBUFFER_OFFSET UNITYSDK_OFFSET(0x8FA5F0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETCAMERA_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3520)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETCAMERA_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA220)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETCAMERA_OFFSET UNITYSDK_OFFSET(0x8FA220)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETNUMBEROFCAMERAS_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3500)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETNUMBEROFCAMERAS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA210)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_GETNUMBEROFCAMERAS_OFFSET UNITYSDK_OFFSET(0x8FA210)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_HZBCULLINGREADBACK_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3600)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_HZBCULLINGREADBACK_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA290)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_HZBCULLINGREADBACK_OFFSET UNITYSDK_OFFSET(0x8FA290)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_INITIALIZESORTSETTINGS_OFFSET UNITYSDK_OFFSET(0x19DE34C0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_INTERNAL_CULL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE34A0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_INTERNAL_CULL_OFFSET UNITYSDK_OFFSET(0x19DE3480)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_INVOKEONRENDEROBJECTCALLBACK_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE35E0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_INVOKEONRENDEROBJECTCALLBACK_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA280)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_INVOKEONRENDEROBJECTCALLBACK_OFFSET UNITYSDK_OFFSET(0x8FA280)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_PREPAREFORBUILDRAYTRACINGACCELERATIONSTRUCTURE_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE36A0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_PREPAREFORBUILDRAYTRACINGACCELERATIONSTRUCTURE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA2E0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_PREPAREFORBUILDRAYTRACINGACCELERATIONSTRUCTURE_OFFSET UNITYSDK_OFFSET(0x8FA2E0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_RAYTRACINGACCELERATIONSTRUCTURECULLINSTANCES_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3680)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_RAYTRACINGACCELERATIONSTRUCTURECULLINSTANCES_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA2D0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_RAYTRACINGACCELERATIONSTRUCTURECULLINSTANCES_OFFSET UNITYSDK_OFFSET(0x8FA2D0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETTARGETQUEUETYPE_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE36E0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETTARGETQUEUETYPE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA320)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETTARGETQUEUETYPE_OFFSET UNITYSDK_OFFSET(0x8FA320)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETUPCAMERAPROPERTIES_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE35C0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETUPCAMERAPROPERTIES_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA270)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETUPCAMERAPROPERTIES_OFFSET UNITYSDK_OFFSET(0x8FA270)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SETUPSUNSHADOWCULLINGPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19DE34B0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SUBMIT_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE34E0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SUBMIT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA200)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_SUBMIT_OFFSET UNITYSDK_OFFSET(0x8FA200)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_UPDATEKODAMALIGHTING_BAKEDONLY_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3660)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_UPDATEKODAMALIGHTING_BAKEDONLY_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA2C0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_UPDATEKODAMALIGHTING_BAKEDONLY_OFFSET UNITYSDK_OFFSET(0x8FA2C0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_WAITONASYNCGRAPHICSFENCE_1_OFFSET UNITYSDK_OFFSET(0x8FA810)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_WAITONASYNCGRAPHICSFENCE_2_OFFSET UNITYSDK_OFFSET(0x8FA840)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_WAITONASYNCGRAPHICSFENCE_OFFSET UNITYSDK_OFFSET(0x8FA7E0)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_WAITONGPUFENCE_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19DE3720)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT_WAITONGPUFENCE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x8FA340)
#define UNITYENGINE_RENDERING_SCRIPTABLERENDERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x2C3980)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ScriptableRenderContext_TypeDefinitionIndex = 6226;
