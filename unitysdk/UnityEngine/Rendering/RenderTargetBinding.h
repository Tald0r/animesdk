...
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_GET_COLORLOADACTIONS_OFFSET UNITYSDK_OFFSET(0x652A70)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_GET_COLORRENDERTARGETS_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_GET_COLORSTOREACTIONS_OFFSET UNITYSDK_OFFSET(0x6B0470)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_GET_DEPTHLOADACTION_OFFSET UNITYSDK_OFFSET(0x7E34F0)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_GET_DEPTHRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x547FD0)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_GET_DEPTHSTOREACTION_OFFSET UNITYSDK_OFFSET(0x7E3500)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_GET_DYNAMICCACHECOUNT_OFFSET UNITYSDK_OFFSET(0x7E3480)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_GET_DYNAMICCACHERTS_OFFSET UNITYSDK_OFFSET(0x318750)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_GET_DYNAMICMEMORYPOLICY_OFFSET UNITYSDK_OFFSET(0x318730)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_SET_COLORLOADACTIONS_OFFSET UNITYSDK_OFFSET(0x8E2980)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_SET_COLORRENDERTARGETS_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_SET_COLORSTOREACTIONS_OFFSET UNITYSDK_OFFSET(0x7E34E0)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_SET_DEPTHLOADACTION_OFFSET UNITYSDK_OFFSET(0x7E2200)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_SET_DEPTHRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x8E2960)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_SET_DEPTHSTOREACTION_OFFSET UNITYSDK_OFFSET(0x7E3510)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_SET_DYNAMICCACHECOUNT_OFFSET UNITYSDK_OFFSET(0x7E3490)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_SET_DYNAMICCACHERTS_OFFSET UNITYSDK_OFFSET(0x318740)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING_SET_DYNAMICMEMORYPOLICY_OFFSET UNITYSDK_OFFSET(0x3186E0)
#define UNITYENGINE_RENDERING_RENDERTARGETBINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x8E2990)
