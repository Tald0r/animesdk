...
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_CONFIGURECLEAR_OFFSET UNITYSDK_OFFSET(0x91FA80)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_CONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0x91FA30)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x91FB10)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x91FAA0)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x91FBD0)
