...
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_CONFIGURECLEAR_OFFSET UNITYSDK_OFFSET(0x8F53B0)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_CONFIGURETARGET_OFFSET UNITYSDK_OFFSET(0x8F5360)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8F5440)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x8F53D0)
#define UNITYENGINE_RENDERING_ATTACHMENTDESCRIPTOR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F5500)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int AttachmentDescriptor_TypeDefinitionIndex = 6195;
