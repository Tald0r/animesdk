...
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER_RELEASERT_OFFSET UNITYSDK_OFFSET(0x1839A5D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1839A350)
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1839A680)
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER_RELOCATERT_OFFSET UNITYSDK_OFFSET(0x1839A8C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_RTXAOPASS_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1839ABE0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int RTXAOPass_HistoryBuffer_TypeDefinitionIndex = 28740;

	class RTXAOPass_HistoryBuffer : public ::System::Object
	{
	public:
		::UnityEngine::RenderTexture* normalRT; // 0x10
		::UnityEngine::RenderTexture* hisRT; // 0x18
		::UnityEngine::RenderTexture* depthRT; // 0x20
