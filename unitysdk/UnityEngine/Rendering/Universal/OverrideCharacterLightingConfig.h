...
#define UNITYENGINE_RENDERING_UNIVERSAL_OVERRIDECHARACTERLIGHTINGCONFIG_DOLERP_OFFSET UNITYSDK_OFFSET(0x17968630)
#define UNITYENGINE_RENDERING_UNIVERSAL_OVERRIDECHARACTERLIGHTINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x179686F0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int OverrideCharacterLightingConfig_TypeDefinitionIndex = 28523;
