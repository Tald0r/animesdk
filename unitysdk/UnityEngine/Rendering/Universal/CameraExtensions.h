...
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_ADDCAMERATOSTACK_OFFSET UNITYSDK_OFFSET(0x18656060)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_CLEARCAMERASTACK_OFFSET UNITYSDK_OFFSET(0x186566B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_FREEZETHECAMERA_OFFSET UNITYSDK_OFFSET(0x18656FD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_GETCAMERARENDERTYPE_OFFSET UNITYSDK_OFFSET(0x18655B30)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_GETCAMERASTACKCOUNT_OFFSET UNITYSDK_OFFSET(0x18656120)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_GETCAMERASTACK_OFFSET UNITYSDK_OFFSET(0x18656190)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_GETRENDERTOFINALTARGET_OFFSET UNITYSDK_OFFSET(0x186563E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_GETUNIVERSALADDITIONALCAMERADATA_OFFSET UNITYSDK_OFFSET(0x186558F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_INSERTCAMERATOSTACK_OFFSET UNITYSDK_OFFSET(0x186561F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_REMOVECAMERAFROMSTACK_OFFSET UNITYSDK_OFFSET(0x18655BF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETANTIALIASINGQUALITY_OFFSET UNITYSDK_OFFSET(0x18656D10)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETANTIALIASING_OFFSET UNITYSDK_OFFSET(0x18656CB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETAPPLYLUTAFTEREVERYTHING_OFFSET UNITYSDK_OFFSET(0x18656A60)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETBLACKCANVAS_OFFSET UNITYSDK_OFFSET(0x18656740)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETCAMERARENDERTYPE_OFFSET UNITYSDK_OFFSET(0x18655B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETCOLORBUFFERUSEALPHA_OFFSET UNITYSDK_OFFSET(0x18656C50)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETDEPTHTEXTURE_OFFSET UNITYSDK_OFFSET(0x186565F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETDLSSMODE_OFFSET UNITYSDK_OFFSET(0x18656D70)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x186564D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETFRAMEGENMODE_OFFSET UNITYSDK_OFFSET(0x18656DD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETFRAMEGENNUM_OFFSET UNITYSDK_OFFSET(0x18656E30)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETFSRFRAMEGENMODE_OFFSET UNITYSDK_OFFSET(0x18656E90)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETFSRSHARPENSTRENGTH_OFFSET UNITYSDK_OFFSET(0x18656EF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETHAS3DMODELS_OFFSET UNITYSDK_OFFSET(0x18656BF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETHIDDENRENDERLAYERON_OFFSET UNITYSDK_OFFSET(0x18656820)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETNORMALTEXTURE_OFFSET UNITYSDK_OFFSET(0x18656650)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETOPAQUETEXTURE_OFFSET UNITYSDK_OFFSET(0x18656590)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETPOSTPROCESSING_OFFSET UNITYSDK_OFFSET(0x186562C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETRENDERSHADOW_OFFSET UNITYSDK_OFFSET(0x18656530)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETRENDERTOFINALTARGET_OFFSET UNITYSDK_OFFSET(0x18656380)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETRENDERVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x18656AC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETRENDERWATER_OFFSET UNITYSDK_OFFSET(0x18656B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETTAASHARPENSTRENGTH_OFFSET UNITYSDK_OFFSET(0x18656F60)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETUIFXEXTRAALPHAWEIGHT_OFFSET UNITYSDK_OFFSET(0x18656B20)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETVOLUMELAYERMASK_OFFSET UNITYSDK_OFFSET(0x18656320)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_TRIMEMPTYCAMERAFROMSTACK_OFFSET UNITYSDK_OFFSET(0x186568D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_UNFREEZETHECAMERA_OFFSET UNITYSDK_OFFSET(0x18657040)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int CameraExtensions_TypeDefinitionIndex = 29725;
