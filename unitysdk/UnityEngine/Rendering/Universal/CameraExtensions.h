...
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_ADDCAMERATOSTACK_OFFSET UNITYSDK_OFFSET(0x18034370)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_CLEARCAMERASTACK_OFFSET UNITYSDK_OFFSET(0x180349C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_FREEZETHECAMERA_OFFSET UNITYSDK_OFFSET(0x180352E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_GETCAMERARENDERTYPE_OFFSET UNITYSDK_OFFSET(0x18033E40)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_GETCAMERASTACKCOUNT_OFFSET UNITYSDK_OFFSET(0x18034430)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_GETCAMERASTACK_OFFSET UNITYSDK_OFFSET(0x180344A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_GETRENDERTOFINALTARGET_OFFSET UNITYSDK_OFFSET(0x180346F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_GETUNIVERSALADDITIONALCAMERADATA_OFFSET UNITYSDK_OFFSET(0x18033C00)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_INSERTCAMERATOSTACK_OFFSET UNITYSDK_OFFSET(0x18034500)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_REMOVECAMERAFROMSTACK_OFFSET UNITYSDK_OFFSET(0x18033F00)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETANTIALIASINGQUALITY_OFFSET UNITYSDK_OFFSET(0x18035020)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETANTIALIASING_OFFSET UNITYSDK_OFFSET(0x18034FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETAPPLYLUTAFTEREVERYTHING_OFFSET UNITYSDK_OFFSET(0x18034D70)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETBLACKCANVAS_OFFSET UNITYSDK_OFFSET(0x18034A50)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETCAMERARENDERTYPE_OFFSET UNITYSDK_OFFSET(0x18033EA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETCOLORBUFFERUSEALPHA_OFFSET UNITYSDK_OFFSET(0x18034F60)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETDEPTHTEXTURE_OFFSET UNITYSDK_OFFSET(0x18034900)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETDLSSMODE_OFFSET UNITYSDK_OFFSET(0x18035080)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x180347E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETFRAMEGENMODE_OFFSET UNITYSDK_OFFSET(0x180350E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETFRAMEGENNUM_OFFSET UNITYSDK_OFFSET(0x18035140)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETFSRFRAMEGENMODE_OFFSET UNITYSDK_OFFSET(0x180351A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETFSRSHARPENSTRENGTH_OFFSET UNITYSDK_OFFSET(0x18035200)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETHAS3DMODELS_OFFSET UNITYSDK_OFFSET(0x18034F00)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETHIDDENRENDERLAYERON_OFFSET UNITYSDK_OFFSET(0x18034B30)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETNORMALTEXTURE_OFFSET UNITYSDK_OFFSET(0x18034960)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETOPAQUETEXTURE_OFFSET UNITYSDK_OFFSET(0x180348A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETPOSTPROCESSING_OFFSET UNITYSDK_OFFSET(0x180345D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETRENDERSHADOW_OFFSET UNITYSDK_OFFSET(0x18034840)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETRENDERTOFINALTARGET_OFFSET UNITYSDK_OFFSET(0x18034690)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETRENDERVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x18034DD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETRENDERWATER_OFFSET UNITYSDK_OFFSET(0x18034EA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETTAASHARPENSTRENGTH_OFFSET UNITYSDK_OFFSET(0x18035270)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETUIFXEXTRAALPHAWEIGHT_OFFSET UNITYSDK_OFFSET(0x18034E30)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_SETVOLUMELAYERMASK_OFFSET UNITYSDK_OFFSET(0x18034630)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_TRIMEMPTYCAMERAFROMSTACK_OFFSET UNITYSDK_OFFSET(0x18034BE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CAMERAEXTENSIONS_UNFREEZETHECAMERA_OFFSET UNITYSDK_OFFSET(0x18035350)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int CameraExtensions_TypeDefinitionIndex = 28779;
