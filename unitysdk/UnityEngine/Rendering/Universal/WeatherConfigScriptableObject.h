...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPENABLE_OFFSET UNITYSDK_OFFSET(0x196F56B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPPARAMS_OFFSET UNITYSDK_OFFSET(0x196F56F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x196F56D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPYOFFSET_OFFSET UNITYSDK_OFFSET(0x196F5710)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPENABLE_OFFSET UNITYSDK_OFFSET(0x196F56C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPPARAMS_OFFSET UNITYSDK_OFFSET(0x196F5700)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x196F56E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPYOFFSET_OFFSET UNITYSDK_OFFSET(0x196F5720)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x196F5730)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherConfigScriptableObject_TypeDefinitionIndex = 28525;
