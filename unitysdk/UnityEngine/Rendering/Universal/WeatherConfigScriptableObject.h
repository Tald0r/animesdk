...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPENABLE_OFFSET UNITYSDK_OFFSET(0x19B72050)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPPARAMS_OFFSET UNITYSDK_OFFSET(0x19B72090)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x19B72070)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_GET_LOCALRAINHEIGHTMAPYOFFSET_OFFSET UNITYSDK_OFFSET(0x19B720B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPENABLE_OFFSET UNITYSDK_OFFSET(0x19B72060)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPPARAMS_OFFSET UNITYSDK_OFFSET(0x19B720A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPTEXTURE_OFFSET UNITYSDK_OFFSET(0x19B72080)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT_SET_LOCALRAINHEIGHTMAPYOFFSET_OFFSET UNITYSDK_OFFSET(0x19B720C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19B720D0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherConfigScriptableObject_TypeDefinitionIndex = 29468;
