...
#define UNITYENGINE_RENDERING_UNIVERSAL_MOTIONBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x18B4AA90)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MotionBlur_TypeDefinitionIndex = 29610;
