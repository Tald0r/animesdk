...
#define UNITYENGINE_RENDERING_UNIVERSAL_FILMGRAINLOOKUPPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1391DB90)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FilmGrainLookupParameter_TypeDefinitionIndex = 28653;
