...
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_ADDMIRROR_OFFSET UNITYSDK_OFFSET(0x185CE6D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_ADDPROBE_OFFSET UNITYSDK_OFFSET(0x185D1BF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_GETMIRRORLISTFORLAYER_OFFSET UNITYSDK_OFFSET(0x185CEF20)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_GETREFLECTIONCUBEARRAY_OFFSET UNITYSDK_OFFSET(0x185D15D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_GETREFLECTIONLIST_OFFSET UNITYSDK_OFFSET(0x185D1B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_GETSUPPORTCUBEMAPARRAY_OFFSET UNITYSDK_OFFSET(0x185D1560)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x185D14A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_REFRESHTEXTURECACHEARRAY_OFFSET UNITYSDK_OFFSET(0x185D1B30)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_RELEASEPLANERREFLECTION_OFFSET UNITYSDK_OFFSET(0x185CEAC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_REMOVEMIRROR_OFFSET UNITYSDK_OFFSET(0x185CE930)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_REMOVEPROBE_OFFSET UNITYSDK_OFFSET(0x185D1DE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_RENDERPLANERREFLECTION_OFFSET UNITYSDK_OFFSET(0x185CF110)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM_SETREFRESHFLAG_OFFSET UNITYSDK_OFFSET(0x185D1AF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x185D2090)
#define UNITYENGINE_RENDERING_UNIVERSAL_DEFERREDREFLECTIONSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x185D1260)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int DeferredReflectionSystem_TypeDefinitionIndex = 28379;
	...
	public:
		...
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(DeferredReflectionSystem_TypeDefinitionIndex)->GetStaticField(0x21D30);
		}
		static ::UnityEngine::Rendering::Universal::DeferredReflectionSystem** StaticGet_m_Instance()
		{
			return (::UnityEngine::Rendering::Universal::DeferredReflectionSystem**)Il2CppClass::FromTypeDefinitionIndex(DeferredReflectionSystem_TypeDefinitionIndex)->GetStaticField(0x21D38);
		}
		...
		::System::Boolean needRefresh; // 0x2C
		::System::Boolean m_SupportCubeMapArray; // 0x2D
