...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTEXTENSION_CALCULATELIGHTMATRIX_OFFSET UNITYSDK_OFFSET(0x18662280)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTEXTENSION_SETAVATARLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x18662140)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTEXTENSION_SETAVATARLIGHTMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x186621E0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LightExtension_TypeDefinitionIndex = 29505;
