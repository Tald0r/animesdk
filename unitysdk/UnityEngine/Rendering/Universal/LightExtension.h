...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTEXTENSION_CALCULATELIGHTMATRIX_OFFSET UNITYSDK_OFFSET(0x18040200)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTEXTENSION_SETAVATARLIGHTCOLOR_OFFSET UNITYSDK_OFFSET(0x180400C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTEXTENSION_SETAVATARLIGHTMULTIPLIER_OFFSET UNITYSDK_OFFSET(0x18040160)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LightExtension_TypeDefinitionIndex = 28562;
