...
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERPASSNAMES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1891C380)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ShaderPassNames_TypeDefinitionIndex = 29373;
