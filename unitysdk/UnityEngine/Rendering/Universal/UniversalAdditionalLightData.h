...
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_AWAKE_OFFSET UNITYSDK_OFFSET(0x17B92AD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_CLEAROPTIMIZABLELIGHT_OFFSET UNITYSDK_OFFSET(0x17B93BA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GETFOGPARAMS_OFFSET UNITYSDK_OFFSET(0x17B948A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GETHASHFORLIGHT_OFFSET UNITYSDK_OFFSET(0x17B93A00)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GETSPOTBOUNDINGSPHERERADIUSANDCENTER_OFFSET UNITYSDK_OFFSET(0x17B931E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_ADDLIGHTMODE_OFFSET UNITYSDK_OFFSET(0x17B92600)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_ISDYNAMICLIGHT_OFFSET UNITYSDK_OFFSET(0x17B925E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_ISHIZCULLINGVALID_OFFSET UNITYSDK_OFFSET(0x17B929C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_LIGHTC_OFFSET UNITYSDK_OFFSET(0x17B926E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_LIGHTRANGE_OFFSET UNITYSDK_OFFSET(0x17B92950)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_LODNEEDFORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x17B94EA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_OLDSHADOWTYPE_OFFSET UNITYSDK_OFFSET(0x17B92920)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_USAGE_OFFSET UNITYSDK_OFFSET(0x17B92930)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_USESLOWATTENUATION_OFFSET UNITYSDK_OFFSET(0x17B92980)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_USEZEROATTENUATION_OFFSET UNITYSDK_OFFSET(0x17B929A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_VOLUMETRICFOG_SHADOWINTENSITY_OFFSET UNITYSDK_OFFSET(0x17B925F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_INITIALIZEV1_2EXTENSION_OFFSET UNITYSDK_OFFSET(0x17B93170)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_LODNEEDCOMMONUPDATE_OFFSET UNITYSDK_OFFSET(0x17B94DC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_LODNEEDFORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x17B94E30)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17B93740)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17B92C40)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_REGISTEROPTIMIZABLELIGHT_OFFSET UNITYSDK_OFFSET(0x17B93E40)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SETHALFLAMBERTANDLIGHTOCCLUDERVALUE_OFFSET UNITYSDK_OFFSET(0x17B93300)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SETLIGHTENABLED_OFFSET UNITYSDK_OFFSET(0x17B928C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SETLIGHTSHADOWSTRENGTH_OFFSET UNITYSDK_OFFSET(0x17B927F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SETLIGHTSHADOWTYPE_OFFSET UNITYSDK_OFFSET(0x17B92860)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SETLIGHTWITHQUALITYCONFIG_OFFSET UNITYSDK_OFFSET(0x17B94EC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SET_ADDLIGHTMODE_OFFSET UNITYSDK_OFFSET(0x17B92610)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SET_LODNEEDFORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x17B94EB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SET_USAGE_OFFSET UNITYSDK_OFFSET(0x17B92940)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SET_USESLOWATTENUATION_OFFSET UNITYSDK_OFFSET(0x17B92990)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SET_USEZEROATTENUATION_OFFSET UNITYSDK_OFFSET(0x17B929B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_START_OFFSET UNITYSDK_OFFSET(0x17B92A20)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_UPDATEDYNAMICLIGHT_OFFSET UNITYSDK_OFFSET(0x17B94910)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x17B957F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17B95600)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA___BASE_GETFOGPARAMS_OFFSET UNITYSDK_OFFSET(0x17B959C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int UniversalAdditionalLightData_TypeDefinitionIndex = 28781;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Queue_1<::System::Collections::Generic::List_1<::UnityEngine::Rendering::VisibleLight>*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x21040);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int64, ::System::Collections::Generic::List_1<::UnityEngine::Rendering::VisibleLight>*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x21048);
		}
		...
		{
			return (::System::Collections::Generic::List_1<::System::ValueTuple_2<::UnityEngine::Rendering::Universal::UniversalAdditionalLightData*, ::System::Boolean>>**)Il2CppClass::FromTypeDefinitionIndex(UniversalAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x21050);
		}
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::LightOcclusionMask*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x21058);
		}
		static ::System::Int32* StaticGet_toonLightCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UniversalAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x5880);
		}
