...
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_AWAKE_OFFSET UNITYSDK_OFFSET(0x1782E700)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_CLEAROPTIMIZABLELIGHT_OFFSET UNITYSDK_OFFSET(0x1782EFE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GETFOGPARAMS_OFFSET UNITYSDK_OFFSET(0x1782FCE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GETHASHFORLIGHT_OFFSET UNITYSDK_OFFSET(0x1782EE40)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GETSPOTBOUNDINGSPHERERADIUSANDCENTER_OFFSET UNITYSDK_OFFSET(0x1782E8E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_ADDLIGHTMODE_OFFSET UNITYSDK_OFFSET(0x1782E230)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_ISDYNAMICLIGHT_OFFSET UNITYSDK_OFFSET(0x1782E210)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_ISHIZCULLINGVALID_OFFSET UNITYSDK_OFFSET(0x1782E5F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_LIGHTC_OFFSET UNITYSDK_OFFSET(0x1782E310)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_LIGHTRANGE_OFFSET UNITYSDK_OFFSET(0x1782E580)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_LODNEEDFORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x178302E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_OLDSHADOWTYPE_OFFSET UNITYSDK_OFFSET(0x1782E550)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_USAGE_OFFSET UNITYSDK_OFFSET(0x1782E560)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_USESLOWATTENUATION_OFFSET UNITYSDK_OFFSET(0x1782E5B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_USEZEROATTENUATION_OFFSET UNITYSDK_OFFSET(0x1782E5D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_GET_VOLUMETRICFOG_SHADOWINTENSITY_OFFSET UNITYSDK_OFFSET(0x1782E220)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_INITIALIZEV1_2EXTENSION_OFFSET UNITYSDK_OFFSET(0x1782E870)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_LODNEEDCOMMONUPDATE_OFFSET UNITYSDK_OFFSET(0x17830200)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_LODNEEDFORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x17830270)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1782DDF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1782D820)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1782E150)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1782E1B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1782DE90)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1782D8C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_REGISTEROPTIMIZABLELIGHT_OFFSET UNITYSDK_OFFSET(0x1782F280)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SETHALFLAMBERTANDLIGHTOCCLUDERVALUE_OFFSET UNITYSDK_OFFSET(0x1782EA00)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SETLIGHTENABLED_OFFSET UNITYSDK_OFFSET(0x1782E4F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SETLIGHTSHADOWSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1782E420)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SETLIGHTSHADOWTYPE_OFFSET UNITYSDK_OFFSET(0x1782E490)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SETLIGHTWITHQUALITYCONFIG_OFFSET UNITYSDK_OFFSET(0x17830300)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SET_ADDLIGHTMODE_OFFSET UNITYSDK_OFFSET(0x1782E240)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SET_LODNEEDFORCEUPDATE_OFFSET UNITYSDK_OFFSET(0x178302F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SET_USAGE_OFFSET UNITYSDK_OFFSET(0x1782E570)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SET_USESLOWATTENUATION_OFFSET UNITYSDK_OFFSET(0x1782E5C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_SET_USEZEROATTENUATION_OFFSET UNITYSDK_OFFSET(0x1782E5E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_START_OFFSET UNITYSDK_OFFSET(0x1782E650)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA_UPDATEDYNAMICLIGHT_OFFSET UNITYSDK_OFFSET(0x1782FD50)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x17830C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17830A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALADDITIONALLIGHTDATA___BASE_GETFOGPARAMS_OFFSET UNITYSDK_OFFSET(0x17830E00)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int UniversalAdditionalLightData_TypeDefinitionIndex = 29727;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int64, ::System::Collections::Generic::List_1<::UnityEngine::Rendering::VisibleLight>*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x226B0);
		}
		...
		{
			return (::System::Collections::Generic::List_1<::System::ValueTuple_2<::UnityEngine::Rendering::Universal::UniversalAdditionalLightData*, ::System::Boolean>>**)Il2CppClass::FromTypeDefinitionIndex(UniversalAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x226B8);
		}
		...
		{
			return (::System::Collections::Generic::Queue_1<::System::Collections::Generic::List_1<::UnityEngine::Rendering::VisibleLight>*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x226C0);
		}
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::LightOcclusionMask*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x226C8);
		}
		static ::System::Int32* StaticGet_toonLightCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UniversalAdditionalLightData_TypeDefinitionIndex)->GetStaticField(0x5960);
		}
