...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_ADDTOLIST_OFFSET UNITYSDK_OFFSET(0x185D2630)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_CHECKGROUPVISIBLE_OFFSET UNITYSDK_OFFSET(0x185D29F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_EXTENDBOUND_OFFSET UNITYSDK_OFFSET(0x185D28F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x185D29D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_RESETBOUNDBOX_OFFSET UNITYSDK_OFFSET(0x185D22A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x185D29E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x185D2230)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GROUPDATA__RESETBOUNDBOX_G__EXTENTSIZE_4_0_OFFSET UNITYSDK_OFFSET(0x185D2580)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassProxy_GroupData_TypeDefinitionIndex = 28767;
