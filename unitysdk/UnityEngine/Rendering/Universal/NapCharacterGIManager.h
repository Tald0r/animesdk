...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1933EB10)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIMANAGER_ISVALIDGI_OFFSET UNITYSDK_OFFSET(0x1933E4A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIMANAGER_PREPAREGPUSAMPLECONTEXT_OFFSET UNITYSDK_OFFSET(0x1933E130)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIMANAGER_SETDUMMYBUFFERS_OFFSET UNITYSDK_OFFSET(0x1933DEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIMANAGER_SETGLOBALBUFFERS_OFFSET UNITYSDK_OFFSET(0x1933E990)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIMANAGER_SETUPEMPTYGI_OFFSET UNITYSDK_OFFSET(0x1933E7E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIMANAGER_SETUPVALIDGI_OFFSET UNITYSDK_OFFSET(0x1933E520)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1933EC80)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1933EC70)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCharacterGIManager_TypeDefinitionIndex = 28589;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::NapCharacterGI**)Il2CppClass::FromTypeDefinitionIndex(NapCharacterGIManager_TypeDefinitionIndex)->GetStaticField(0x21BB0);
		}
		static ::UnityEngine::Rendering::Universal::NapCharacterGIManager** StaticGet_instance()
		{
			return (::UnityEngine::Rendering::Universal::NapCharacterGIManager**)Il2CppClass::FromTypeDefinitionIndex(NapCharacterGIManager_TypeDefinitionIndex)->GetStaticField(0x21BB8);
		}
		static ::System::Int32* StaticGet_lastWeatherIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NapCharacterGIManager_TypeDefinitionIndex)->GetStaticField(0x64E0);
		}
