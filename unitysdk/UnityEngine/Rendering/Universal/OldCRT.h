...
#define UNITYENGINE_RENDERING_UNIVERSAL_OLDCRT_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x17968410)
#define UNITYENGINE_RENDERING_UNIVERSAL_OLDCRT_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x17968490)
#define UNITYENGINE_RENDERING_UNIVERSAL_OLDCRT__CTOR_OFFSET UNITYSDK_OFFSET(0x179684D0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int OldCRT_TypeDefinitionIndex = 28678;
