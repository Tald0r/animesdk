...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_AUTOGETBOUNDS_OFFSET UNITYSDK_OFFSET(0x18F118E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_CALCULATEAABB_OFFSET UNITYSDK_OFFSET(0x18F137F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_CALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x18F14290)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_CHECKINTERSECTION_OFFSET UNITYSDK_OFFSET(0x18F13700)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_CONSTRAINBOUNDSTOPLANE_OFFSET UNITYSDK_OFFSET(0x18F13240)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_GETBOUNDSCORNERS_OFFSET UNITYSDK_OFFSET(0x18F14030)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_GETTOPMOSTPARENT_OFFSET UNITYSDK_OFFSET(0x18F13620)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x18F146F0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LightUtils_TypeDefinitionIndex = 29504;
