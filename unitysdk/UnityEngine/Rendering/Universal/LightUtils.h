...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_AUTOGETBOUNDS_OFFSET UNITYSDK_OFFSET(0x18B4E860)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_CALCULATEAABB_OFFSET UNITYSDK_OFFSET(0x18B50770)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_CALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x18B51210)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_CHECKINTERSECTION_OFFSET UNITYSDK_OFFSET(0x18B50680)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_CONSTRAINBOUNDSTOPLANE_OFFSET UNITYSDK_OFFSET(0x18B501C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_GETBOUNDSCORNERS_OFFSET UNITYSDK_OFFSET(0x18B50FB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS_GETTOPMOSTPARENT_OFFSET UNITYSDK_OFFSET(0x18B505A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x18B51670)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LightUtils_TypeDefinitionIndex = 28561;
