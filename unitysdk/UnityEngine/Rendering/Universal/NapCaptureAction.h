...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTUREACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x196F1E90)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTUREACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x196F1F80)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTUREACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x196F0FF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTUREACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x196F0FE0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCaptureAction_TypeDefinitionIndex = 28721;
