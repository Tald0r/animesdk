...
#define UNITYENGINE_RENDERING_UNIVERSAL_LOOPSUBDIVISIONDATAHOLDER_APPLYSETTINGS_OFFSET UNITYSDK_OFFSET(0x186627D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LOOPSUBDIVISIONDATAHOLDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18662780)
#define UNITYENGINE_RENDERING_UNIVERSAL_LOOPSUBDIVISIONDATAHOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18662990)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LoopSubdivisionDataHolder_TypeDefinitionIndex = 29507;
