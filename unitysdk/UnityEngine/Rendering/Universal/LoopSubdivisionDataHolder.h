...
#define UNITYENGINE_RENDERING_UNIVERSAL_LOOPSUBDIVISIONDATAHOLDER_APPLYSETTINGS_OFFSET UNITYSDK_OFFSET(0x18040750)
#define UNITYENGINE_RENDERING_UNIVERSAL_LOOPSUBDIVISIONDATAHOLDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18040700)
#define UNITYENGINE_RENDERING_UNIVERSAL_LOOPSUBDIVISIONDATAHOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18040910)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LoopSubdivisionDataHolder_TypeDefinitionIndex = 28564;
