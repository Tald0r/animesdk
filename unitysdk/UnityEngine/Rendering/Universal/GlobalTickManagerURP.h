...
#define UNITYENGINE_RENDERING_UNIVERSAL_GLOBALTICKMANAGERURP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x196E5830)
#define UNITYENGINE_RENDERING_UNIVERSAL_GLOBALTICKMANAGERURP_ONCREATE_OFFSET UNITYSDK_OFFSET(0x196E58C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GLOBALTICKMANAGERURP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x196E5250)
#define UNITYENGINE_RENDERING_UNIVERSAL_GLOBALTICKMANAGERURP_REGISTERMONORENDERENTITY_OFFSET UNITYSDK_OFFSET(0x196E5690)
#define UNITYENGINE_RENDERING_UNIVERSAL_GLOBALTICKMANAGERURP_UNREGISTERMONORENDERENTITY_OFFSET UNITYSDK_OFFSET(0x196E5760)
#define UNITYENGINE_RENDERING_UNIVERSAL_GLOBALTICKMANAGERURP__CTOR_OFFSET UNITYSDK_OFFSET(0x196E5900)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GlobalTickManagerURP_TypeDefinitionIndex = 28592;

	class GlobalTickManagerURP : public ::Foundation::SingletonDisposable_1<::UnityEngine::Rendering::Universal::GlobalTickManagerURP*>
	{
	public:
		::System::Collections::Generic::HashSet_1<::MonoRenderEntity*>* _delayRemoveMonoRenderEntitySet; // 0x10
		::System::Collections::Generic::HashSet_1<::MonoRenderEntity*>* _delayAddMonoRenderEntitySet; // 0x18
		::System::Collections::Generic::HashSet_1<::MonoRenderEntity*>* _monoRenderEntitySet; // 0x20
