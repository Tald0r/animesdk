...
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_GET_CACHEDSHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x189EF580)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_GET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x189EF840)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_GET_SUPPORTPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x189EF560)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_INIT_OFFSET UNITYSDK_OFFSET(0x189EF9D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x189EFB90)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_SET_SUPPORTPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x189EF570)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x189EFBE0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MonoPerObjectShadowMaterial_TypeDefinitionIndex = 29541;
