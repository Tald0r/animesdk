...
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_GET_CACHEDSHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x18398F10)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_GET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x183991D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_GET_SUPPORTPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x18398EF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_INIT_OFFSET UNITYSDK_OFFSET(0x18399360)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_ONRELEASE_OFFSET UNITYSDK_OFFSET(0x18399520)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL_SET_SUPPORTPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x18398F00)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOPEROBJECTSHADOWMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18399570)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MonoPerObjectShadowMaterial_TypeDefinitionIndex = 28598;
