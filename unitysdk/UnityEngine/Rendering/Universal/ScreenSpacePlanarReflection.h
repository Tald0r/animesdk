...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEPLANARREFLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1742B620)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEPLANARREFLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1742B380)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScreenSpacePlanarReflection_TypeDefinitionIndex = 29639;
	...
	public:
		...
		{
			return (::UnityEngine::LayerMask*)Il2CppClass::FromTypeDefinitionIndex(ScreenSpacePlanarReflection_TypeDefinitionIndex)->GetStaticField(0x6730);
		}
