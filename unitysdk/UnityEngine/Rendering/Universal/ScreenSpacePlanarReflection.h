...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEPLANARREFLECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x16DC2DE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEPLANARREFLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x16DC2B40)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScreenSpacePlanarReflection_TypeDefinitionIndex = 28696;
	...
	public:
		...
		{
			return (::UnityEngine::LayerMask*)Il2CppClass::FromTypeDefinitionIndex(ScreenSpacePlanarReflection_TypeDefinitionIndex)->GetStaticField(0x62D0);
		}
