...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONMANAGER_WATERINTERACTIVERENDERITEM_REFRESHBOUNDANDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x17C18840)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONMANAGER_WATERINTERACTIVERENDERITEM_TRANSFORMLOCALBOUNDSTOWORLDAABB_OPTIMIZED_OFFSET UNITYSDK_OFFSET(0x17C185D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONMANAGER_WATERINTERACTIVERENDERITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17C184C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONMANAGER_WATERINTERACTIVERENDERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x17C184B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterInteractionManager_WaterInteractiveRenderItem_TypeDefinitionIndex = 28626;
