...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONMANAGER_WATERINTERACTIVERENDERITEM_REFRESHBOUNDANDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18301450)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONMANAGER_WATERINTERACTIVERENDERITEM_TRANSFORMLOCALBOUNDSTOWORLDAABB_OPTIMIZED_OFFSET UNITYSDK_OFFSET(0x183011E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONMANAGER_WATERINTERACTIVERENDERITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x183010D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONMANAGER_WATERINTERACTIVERENDERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x183010C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterInteractionManager_WaterInteractiveRenderItem_TypeDefinitionIndex = 29569;
