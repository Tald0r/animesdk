...
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_GET_INITPOSITION_OFFSET UNITYSDK_OFFSET(0x196F23B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_GET_INITROTATION_OFFSET UNITYSDK_OFFSET(0x196F23D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x196F2870)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x196F23E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_RESETPOSANDROT_OFFSET UNITYSDK_OFFSET(0x196F2930)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_SETINITPOSROT_OFFSET UNITYSDK_OFFSET(0x196F26C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT_UPDATE_OFFSET UNITYSDK_OFFSET(0x196F29D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OCEANFLOATOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x196F2AE0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int OceanFloatObject_TypeDefinitionIndex = 28471;
