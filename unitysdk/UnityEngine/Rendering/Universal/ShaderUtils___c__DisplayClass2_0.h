...
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x18B4F610)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS___C__DISPLAYCLASS2_0__GETENUMFROMPATH_B__0_OFFSET UNITYSDK_OFFSET(0x18B4F620)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ShaderUtils___c__DisplayClass2_0_TypeDefinitionIndex = 29701;
