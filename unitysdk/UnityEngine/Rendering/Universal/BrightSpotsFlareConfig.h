...
#define UNITYENGINE_RENDERING_UNIVERSAL_BRIGHTSPOTSFLARECONFIG_GETCONFIGFORCAMERA_OFFSET UNITYSDK_OFFSET(0x17778960)
#define UNITYENGINE_RENDERING_UNIVERSAL_BRIGHTSPOTSFLARECONFIG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x177788B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_BRIGHTSPOTSFLARECONFIG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x177786E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_BRIGHTSPOTSFLARECONFIG__CCTOR_OFFSET UNITYSDK_OFFSET(0x17778C10)
#define UNITYENGINE_RENDERING_UNIVERSAL_BRIGHTSPOTSFLARECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17778BE0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int BrightSpotsFlareConfig_TypeDefinitionIndex = 29314;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::BrightSpotsFlareConfig*>**)Il2CppClass::FromTypeDefinitionIndex(BrightSpotsFlareConfig_TypeDefinitionIndex)->GetStaticField(0x21DB0);
		}
