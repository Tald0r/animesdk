...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCANMASKTYPEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19255D80)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScanMaskTypeParameter_TypeDefinitionIndex = 28422;
