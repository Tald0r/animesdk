...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSCULLINGCONFIG_GET_CULLINGDISTANCE_OFFSET UNITYSDK_OFFSET(0x17952280)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSCULLINGCONFIG_SET_CULLINGDISTANCE_OFFSET UNITYSDK_OFFSET(0x17952290)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSCULLINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x179522A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassCullingConfig_TypeDefinitionIndex = 28770;
