...
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATOR_CHECKISFREEDRT_OFFSET UNITYSDK_OFFSET(0x19257660)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATOR_CLEARUSEOFRTONINSTANCE_OFFSET UNITYSDK_OFFSET(0x192560A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x192576B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATOR_INIT_OFFSET UNITYSDK_OFFSET(0x192568C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19255FD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19255ED0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATOR_ONPRERENDERTHIS_OFFSET UNITYSDK_OFFSET(0x19256350)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATOR_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19256050)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x19257760)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19257740)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int VideoMipGenerator_TypeDefinitionIndex = 28442;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(VideoMipGenerator_TypeDefinitionIndex)->GetStaticField(0x6AC0);
		}
		static ::System::Int32* StaticGet__FrameIsVideo()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(VideoMipGenerator_TypeDefinitionIndex)->GetStaticField(0x6AC4);
		}
		static ::System::Int32* StaticGet__MipScreenMap()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(VideoMipGenerator_TypeDefinitionIndex)->GetStaticField(0x6AC8);
		}
