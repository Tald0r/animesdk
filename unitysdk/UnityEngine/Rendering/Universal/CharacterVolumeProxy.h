...
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERVOLUMEPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x189E6CC0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int CharacterVolumeProxy_TypeDefinitionIndex = 29580;
