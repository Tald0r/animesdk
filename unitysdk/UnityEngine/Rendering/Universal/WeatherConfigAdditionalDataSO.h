...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO_BINDTEMPWEATHERLIST_OFFSET UNITYSDK_OFFSET(0x1933F720)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO_GETCURRENTWEATHERADDITIONALDATA_OFFSET UNITYSDK_OFFSET(0x1933FF50)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO_SYNWEATHERADDITIONALDATA_OFFSET UNITYSDK_OFFSET(0x1933FFD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO__CTOR_OFFSET UNITYSDK_OFFSET(0x19340220)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherConfigAdditionalDataSO_TypeDefinitionIndex = 28490;
