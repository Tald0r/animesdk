...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO_BINDTEMPWEATHERLIST_OFFSET UNITYSDK_OFFSET(0x197F2CE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO_GETCURRENTWEATHERADDITIONALDATA_OFFSET UNITYSDK_OFFSET(0x197F3510)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO_SYNWEATHERADDITIONALDATA_OFFSET UNITYSDK_OFFSET(0x197F3590)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERCONFIGADDITIONALDATASO__CTOR_OFFSET UNITYSDK_OFFSET(0x197F37E0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherConfigAdditionalDataSO_TypeDefinitionIndex = 29433;
