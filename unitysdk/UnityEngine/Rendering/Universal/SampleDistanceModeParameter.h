...
#define UNITYENGINE_RENDERING_UNIVERSAL_SAMPLEDISTANCEMODEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x183BFC00)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SampleDistanceModeParameter_TypeDefinitionIndex = 28686;
