...
#define UNITYENGINE_RENDERING_UNIVERSAL_CAUSTICS__CTOR_OFFSET UNITYSDK_OFFSET(0x197D65B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int Caustics_TypeDefinitionIndex = 29576;
