...
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_ADDGAUSSIANBLURPASS_1_OFFSET UNITYSDK_OFFSET(0x16FA23C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_ADDGAUSSIANBLURPASS_OFFSET UNITYSDK_OFFSET(0x16FA3DF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_COMPUTE1DGAUSSIANFILTERKERNEL_OFFSET UNITYSDK_OFFSET(0x16FA3910)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_GETBLURRADIUS_OFFSET UNITYSDK_OFFSET(0x16FA3670)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_GETCLAMPEDKERNELRADIUS_OFFSET UNITYSDK_OFFSET(0x16FA37A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_GETINTEGERKERNELRADIUS_OFFSET UNITYSDK_OFFSET(0x16FA3810)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_GETSAMPLECOUNTMAX_OFFSET UNITYSDK_OFFSET(0x16FA36E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_NORMALDISTRIBUTIONUNSCALED_OFFSET UNITYSDK_OFFSET(0x16FA3550)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM__CCTOR_OFFSET UNITYSDK_OFFSET(0x16FA4250)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int PostProcessWeightedSampleSum_TypeDefinitionIndex = 28774;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector2>**)Il2CppClass::FromTypeDefinitionIndex(PostProcessWeightedSampleSum_TypeDefinitionIndex)->GetStaticField(0x22720);
		}
		static ::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::UnityEngine::Vector4>** StaticGet_PackedSampleOffset()
		{
			return (::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(PostProcessWeightedSampleSum_TypeDefinitionIndex)->GetStaticField(0x22728);
		}
		static ::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::UnityEngine::Vector4>** StaticGet_SampleWeights()
		{
			return (::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(PostProcessWeightedSampleSum_TypeDefinitionIndex)->GetStaticField(0x22730);
		}
