...
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_ADDGAUSSIANBLURPASS_1_OFFSET UNITYSDK_OFFSET(0x176745D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_ADDGAUSSIANBLURPASS_OFFSET UNITYSDK_OFFSET(0x176760B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_COMPUTE1DGAUSSIANFILTERKERNEL_OFFSET UNITYSDK_OFFSET(0x17675BD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_GETBLURRADIUS_OFFSET UNITYSDK_OFFSET(0x17675930)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_GETCLAMPEDKERNELRADIUS_OFFSET UNITYSDK_OFFSET(0x17675A60)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_GETINTEGERKERNELRADIUS_OFFSET UNITYSDK_OFFSET(0x17675AD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_GETSAMPLECOUNTMAX_OFFSET UNITYSDK_OFFSET(0x176759A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM_NORMALDISTRIBUTIONUNSCALED_OFFSET UNITYSDK_OFFSET(0x17675810)
#define UNITYENGINE_RENDERING_UNIVERSAL_POSTPROCESSWEIGHTEDSAMPLESUM__CCTOR_OFFSET UNITYSDK_OFFSET(0x17676510)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int PostProcessWeightedSampleSum_TypeDefinitionIndex = 29720;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector2>**)Il2CppClass::FromTypeDefinitionIndex(PostProcessWeightedSampleSum_TypeDefinitionIndex)->GetStaticField(0x238D0);
		}
		static ::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::UnityEngine::Vector4>** StaticGet_PackedSampleOffset()
		{
			return (::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(PostProcessWeightedSampleSum_TypeDefinitionIndex)->GetStaticField(0x238D8);
		}
		static ::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::UnityEngine::Vector4>** StaticGet_SampleWeights()
		{
			return (::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::UnityEngine::Vector4>**)Il2CppClass::FromTypeDefinitionIndex(PostProcessWeightedSampleSum_TypeDefinitionIndex)->GetStaticField(0x238E0);
		}
