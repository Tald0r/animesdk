...
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x19B6F6C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19B6F880)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19B6FC40)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B6FCE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6F610)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS___BASE_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x19B6FCF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19B6FD00)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SplineOutlinePass_TypeDefinitionIndex = 29687;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(SplineOutlinePass_TypeDefinitionIndex)->GetStaticField(0x7890);
		}
