...
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x196F2D20)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x196F2EE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x196F32A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x196F3340)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x196F2C70)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS___BASE_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x196F3350)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPLINEOUTLINEPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x196F3360)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SplineOutlinePass_TypeDefinitionIndex = 28741;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(SplineOutlinePass_TypeDefinitionIndex)->GetStaticField(0x7080);
		}
