...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERRIPPLETRIGGER_GETCUSTOMRIPPLEDATA_OFFSET UNITYSDK_OFFSET(0x1A2F7360)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERRIPPLETRIGGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A2F72E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERRIPPLETRIGGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A2F71F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERRIPPLETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F75D0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterRippleTrigger_TypeDefinitionIndex = 29424;
