...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA_APPLYLOD_OFFSET UNITYSDK_OFFSET(0x19FAF340)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA_CALCULATEMATERIALLODSTATUS_OFFSET UNITYSDK_OFFSET(0x19FAF1D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA_FORCELOD_OFFSET UNITYSDK_OFFSET(0x19FAF630)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19FAF020)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA___BASE_APPLYLOD_OFFSET UNITYSDK_OFFSET(0x19FAF760)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA___BASE_CALCULATEMATERIALLODSTATUS_OFFSET UNITYSDK_OFFSET(0x19FAF770)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA___BASE_FORCELOD_OFFSET UNITYSDK_OFFSET(0x19FAF840)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int MatCharacterSimplifyLodData_TypeDefinitionIndex = 28973;
