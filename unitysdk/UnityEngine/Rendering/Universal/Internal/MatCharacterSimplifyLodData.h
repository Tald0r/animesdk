...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA_APPLYLOD_OFFSET UNITYSDK_OFFSET(0x1A2EA9B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA_CALCULATEMATERIALLODSTATUS_OFFSET UNITYSDK_OFFSET(0x1A2EA840)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA_FORCELOD_OFFSET UNITYSDK_OFFSET(0x1A2EACA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2EA690)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA___BASE_APPLYLOD_OFFSET UNITYSDK_OFFSET(0x1A2EADD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA___BASE_CALCULATEMATERIALLODSTATUS_OFFSET UNITYSDK_OFFSET(0x1A2EADE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATCHARACTERSIMPLIFYLODDATA___BASE_FORCELOD_OFFSET UNITYSDK_OFFSET(0x1A2EAEB0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int MatCharacterSimplifyLodData_TypeDefinitionIndex = 29924;
