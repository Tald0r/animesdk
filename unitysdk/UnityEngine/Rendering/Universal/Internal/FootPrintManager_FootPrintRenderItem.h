...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM_CHECKTIMEOVER_OFFSET UNITYSDK_OFFSET(0x7EEFB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM_GET_LOCALTOWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0x5BDA30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM_REFRESHALPHAANDMIRROR_OFFSET UNITYSDK_OFFSET(0x7EF030)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM_REFRESHLIFETIME_OFFSET UNITYSDK_OFFSET(0x7EEFC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7EEE80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x7EEE20)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintManager_FootPrintRenderItem_TypeDefinitionIndex = 29969;
