...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM_CHECKTIMEOVER_OFFSET UNITYSDK_OFFSET(0x7BBE20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM_GET_LOCALTOWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0x53B160)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM_REFRESHALPHAANDMIRROR_OFFSET UNITYSDK_OFFSET(0x7BBEA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM_REFRESHLIFETIME_OFFSET UNITYSDK_OFFSET(0x7BBE30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7BBCF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_FOOTPRINTRENDERITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x7BBC90)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintManager_FootPrintRenderItem_TypeDefinitionIndex = 29018;
