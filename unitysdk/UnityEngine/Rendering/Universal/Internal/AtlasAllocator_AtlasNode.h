...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ATLASALLOCATOR_ATLASNODE_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x16DA19F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ATLASALLOCATOR_ATLASNODE_RELEASE_OFFSET UNITYSDK_OFFSET(0x16DA1D00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ATLASALLOCATOR_ATLASNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA1950)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int AtlasAllocator_AtlasNode_TypeDefinitionIndex = 29067;
