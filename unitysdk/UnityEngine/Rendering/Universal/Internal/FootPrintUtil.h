...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GENERATEQUADMESH_OFFSET UNITYSDK_OFFSET(0x17B733A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GETCHILD_OFFSET UNITYSDK_OFFSET(0x17B72E90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GETFOOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x17B730A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GETORTHOPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x17B73190)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GETWHEELTRANSFORM_OFFSET UNITYSDK_OFFSET(0x17B73130)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GET_S_FOOTPRINTQUADMESH_OFFSET UNITYSDK_OFFSET(0x17B73780)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintUtil_TypeDefinitionIndex = 29021;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(FootPrintUtil_TypeDefinitionIndex)->GetStaticField(0x21290);
		}
