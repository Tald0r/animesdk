...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GENERATEQUADMESH_OFFSET UNITYSDK_OFFSET(0x17809C60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GETCHILD_OFFSET UNITYSDK_OFFSET(0x17809750)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GETFOOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x17809960)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GETORTHOPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x17809A50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GETWHEELTRANSFORM_OFFSET UNITYSDK_OFFSET(0x178099F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTUTIL_GET_S_FOOTPRINTQUADMESH_OFFSET UNITYSDK_OFFSET(0x1780A040)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintUtil_TypeDefinitionIndex = 29972;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(FootPrintUtil_TypeDefinitionIndex)->GetStaticField(0x22910);
		}
