...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_CREATETEMPTARGET3_OFFSET UNITYSDK_OFFSET(0x8EF0F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_DISPOSECONTEXT_OFFSET UNITYSDK_OFFSET(0x8EF0C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_GETCURRENTSOURCE_OFFSET UNITYSDK_OFFSET(0x8EEE00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_GETDESTINATION_OFFSET UNITYSDK_OFFSET(0x8EF280)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_GETSOURCE_OFFSET UNITYSDK_OFFSET(0x8EEE80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_INITCONTEXT_OFFSET UNITYSDK_OFFSET(0x8EEDB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_RELEASERENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x8EEF40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_SETTAARESULT_OFFSET UNITYSDK_OFFSET(0x8EF1D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_POSTPROCESSCONTEXT_SWAP_OFFSET UNITYSDK_OFFSET(0x8EF120)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PostProcessPass_PostProcessContext_TypeDefinitionIndex = 29996;
