...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_ADDLIGHTMAP_OFFSET UNITYSDK_OFFSET(0x19336420)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_BINDANDTRIGGERLIGHTPROBE_OFFSET UNITYSDK_OFFSET(0x19337D80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_BINDLIGHTMAPDATA_OFFSET UNITYSDK_OFFSET(0x193366D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_BINDLIGHTPROBEDATA_OFFSET UNITYSDK_OFFSET(0x193389B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_BINDLIGHTPROBEREFERENCE_OFFSET UNITYSDK_OFFSET(0x19338060)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_BINDREFLECTIONPROBEDATA_OFFSET UNITYSDK_OFFSET(0x193377B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_DOTETRAHEDRALIZE_OFFSET UNITYSDK_OFFSET(0x19338020)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_DYNAMICGETANDBINDREFLECTIONPROBEDATA_OFFSET UNITYSDK_OFFSET(0x19336D90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_SAVELIGHTPROBEDATA_OFFSET UNITYSDK_OFFSET(0x19338650)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_SETLIGHTPROBEDATAOFFSET_OFFSET UNITYSDK_OFFSET(0x193381A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_UNBINDANDTRIGGERLIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x193383D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_UNBINDLIGHTMAP_OFFSET UNITYSDK_OFFSET(0x193365E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_UNLOADASSET_OFFSET UNITYSDK_OFFSET(0x19336CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19338B70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19338B60)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapLightMapHelper_TypeDefinitionIndex = 28909;
	...
	public:
		...
		{
			return (::UnityEngine::LightProbes**)Il2CppClass::FromTypeDefinitionIndex(NapLightMapHelper_TypeDefinitionIndex)->GetStaticField(0x21B80);
		}
