...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_ADDLIGHTMAP_OFFSET UNITYSDK_OFFSET(0x197E99F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_BINDANDTRIGGERLIGHTPROBE_OFFSET UNITYSDK_OFFSET(0x197EB350)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_BINDLIGHTMAPDATA_OFFSET UNITYSDK_OFFSET(0x197E9CA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_BINDLIGHTPROBEDATA_OFFSET UNITYSDK_OFFSET(0x197EBF80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_BINDLIGHTPROBEREFERENCE_OFFSET UNITYSDK_OFFSET(0x197EB630)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_BINDREFLECTIONPROBEDATA_OFFSET UNITYSDK_OFFSET(0x197EAD80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_DOTETRAHEDRALIZE_OFFSET UNITYSDK_OFFSET(0x197EB5F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_DYNAMICGETANDBINDREFLECTIONPROBEDATA_OFFSET UNITYSDK_OFFSET(0x197EA360)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_SAVELIGHTPROBEDATA_OFFSET UNITYSDK_OFFSET(0x197EBC20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_SETLIGHTPROBEDATAOFFSET_OFFSET UNITYSDK_OFFSET(0x197EB770)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_UNBINDANDTRIGGERLIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x197EB9A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_UNBINDLIGHTMAP_OFFSET UNITYSDK_OFFSET(0x197E9BB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER_UNLOADASSET_OFFSET UNITYSDK_OFFSET(0x197EA2C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x197EC140)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x197EC130)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapLightMapHelper_TypeDefinitionIndex = 29859;
	...
	public:
		...
		{
			return (::UnityEngine::LightProbes**)Il2CppClass::FromTypeDefinitionIndex(NapLightMapHelper_TypeDefinitionIndex)->GetStaticField(0x234D0);
		}
