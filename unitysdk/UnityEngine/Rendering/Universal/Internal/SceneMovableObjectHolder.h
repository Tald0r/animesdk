...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEMOVABLEOBJECTHOLDER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19FB32D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEMOVABLEOBJECTHOLDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19FB31F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEMOVABLEOBJECTHOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FB3420)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int SceneMovableObjectHolder_TypeDefinitionIndex = 28886;
