...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEMOVABLEOBJECTHOLDER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A2EDC10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEMOVABLEOBJECTHOLDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A2EDB30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEMOVABLEOBJECTHOLDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2EDD60)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int SceneMovableObjectHolder_TypeDefinitionIndex = 29836;
