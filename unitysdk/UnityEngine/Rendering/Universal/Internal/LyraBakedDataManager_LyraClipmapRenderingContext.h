...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18B3D140)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_GETCOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0x18B3D540)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_INITED_OFFSET UNITYSDK_OFFSET(0x18B3D4B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_REALLOCATERESOURCESIFNEEDED_OFFSET UNITYSDK_OFFSET(0x18B3DA60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELEASEALLOCATEDCOMPUTEBUFFERS_OFFSET UNITYSDK_OFFSET(0x18B3D810)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELEASERT_OFFSET UNITYSDK_OFFSET(0x18B3DFF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELEASE_OFFSET UNITYSDK_OFFSET(0x18B3D1B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x18B3D9F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RESETALLOCATEDCOMPUTEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x18B3D4F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3CEA0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_LyraClipmapRenderingContext_TypeDefinitionIndex = 29937;

	class LyraBakedDataManager_LyraClipmapRenderingContext : public ::System::Object
	{
	public:
		::UnityEngine::RenderTexture* m_ClipmapTexture; // 0x10
		::UnityEngine::Texture2D* m_AlbedoLutTex; // 0x18
		::UnityEngine::RenderTexture* m_CompressedClipmapTexture; // 0x20
		::UnityEngine::RenderTexture* m_EmissionClipmapTexture; // 0x28
		::System::Collections::Generic::HashSet_1<::LyraSector::LyraSectorCoord>* m_ChangedSectorCoord; // 0x30
		::UnityEngine::Rendering::Universal::Internal::LyraBakedDataManager_SceneVoxelVisualizer* m_Visualizer; // 0x38
		::Il2CppArray<::UnityEngine::Vector3Int>* m_LastPartialUpdateOriginInPages; // 0x40
		::System::Collections::Generic::List_1<::Il2CppArray<::UnityEngine::ComputeBuffer*>*>* m_AllocatedBuffers; // 0x48
		::Il2CppArray<::UnityEngine::Vector3Int>* m_FullUpdateOriginInPages; // 0x50
		::Il2CppArray<::UnityEngine::Vector4>* m_WorldToUVAddAndMul; // 0x58
		::Il2CppArray<::UnityEngine::Vector4>* m_CenterAndExtent; // 0x60
		::System::Int32 m_NumPropagatedSteps; // 0x68
		::System::Int32 m_DirtyClipmapToRefresh; // 0x6C
		::System::Boolean m_Enabled; // 0x70
		::System::Boolean m_Inited; // 0x71
		::System::Boolean m_IsForDistanceField; // 0x72
		::System::UInt32 m_ComputeBufferSize; // 0x74
