...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x185D4860)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_GETCOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0x185D4C60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_INITED_OFFSET UNITYSDK_OFFSET(0x185D4BD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_REALLOCATERESOURCESIFNEEDED_OFFSET UNITYSDK_OFFSET(0x185D5180)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELEASEALLOCATEDCOMPUTEBUFFERS_OFFSET UNITYSDK_OFFSET(0x185D4F30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELEASERT_OFFSET UNITYSDK_OFFSET(0x185D5710)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELEASE_OFFSET UNITYSDK_OFFSET(0x185D48D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x185D5110)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT_RESETALLOCATEDCOMPUTEBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x185D4C10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_LYRACLIPMAPRENDERINGCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x185D45C0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_LyraClipmapRenderingContext_TypeDefinitionIndex = 28986;
	...
	public:
		...
		::Il2CppArray<::UnityEngine::Vector3Int>* m_LastPartialUpdateOriginInPages; // 0x28
		::UnityEngine::Rendering::Universal::Internal::LyraBakedDataManager_SceneVoxelVisualizer* m_Visualizer; // 0x30
		...
		::Il2CppArray<::UnityEngine::Vector4>* m_WorldToUVAddAndMul; // 0x50
		::UnityEngine::RenderTexture* m_EmissionClipmapTexture; // 0x58
		::Il2CppArray<::UnityEngine::Vector4>* m_CenterAndExtent; // 0x60
		::System::Int32 m_NumPropagatedSteps; // 0x68
		::System::Boolean m_Inited; // 0x6C
		::System::Boolean m_IsForDistanceField; // 0x6D
		::System::Boolean m_Enabled; // 0x6E
		::System::UInt32 m_ComputeBufferSize; // 0x70
