...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ETHEREYEINTERACTABLEINFO_GET_ENABLEPASS_OFFSET UNITYSDK_OFFSET(0x183BA0E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ETHEREYEINTERACTABLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x183BA110)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int EtherEyeInteractableInfo_TypeDefinitionIndex = 29008;
