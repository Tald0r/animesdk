...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_ADDTONPCFOOTPRINTQUEUE_OFFSET UNITYSDK_OFFSET(0x196E7480)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_CLEARCACHEDDATA_OFFSET UNITYSDK_OFFSET(0x196E5FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_CLEARTARGETHOLDER_OFFSET UNITYSDK_OFFSET(0x196E6F30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_DRAWFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x196E86C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_DUMPFOOTPRINTPASSMASK_OFFSET UNITYSDK_OFFSET(0x196E7DE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x196E5ED0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_NEEDDRAWFOOTPRINTPASS_OFFSET UNITYSDK_OFFSET(0x196E84F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_TICKNPCFOOTPRINTDATA_OFFSET UNITYSDK_OFFSET(0x196E75C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_TRYBINDFOOTPRINTSPAWNER_OFFSET UNITYSDK_OFFSET(0x196E9D90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_TRYBINDWHEELPRINTSPAWNER_OFFSET UNITYSDK_OFFSET(0x196E9650)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_TRYSPAWNCOMMONFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x196E7AA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_TRYSPAWNMAINCHARACTERFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x196E7980)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x196EA920)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x196E5CE0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintManager_TypeDefinitionIndex = 29014;
	...
	public:
		...
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x20AA0);
		}
		static ::UnityEngine::Rendering::Universal::Internal::FootPrintManager** StaticGet__instance()
		{
			return (::UnityEngine::Rendering::Universal::Internal::FootPrintManager**)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x20AA8);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_Sampler_TrySpawnMainCharacterFootPrint()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x20AB0);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_Sampler_UpdateFootPrintDrawData()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x20AB8);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_Sampler_TrySpawnNPCFootPrint()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x20AC0);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_Sampler_TryBindNPCFootPrint()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x20AC8);
		}
		static ::System::Boolean* StaticGet_enableNPCFootPrint()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x56A0);
		}
		static ::System::Boolean* StaticGet_s_EnableDebugLog()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x56A1);
		}
		static ::System::Int32* StaticGet__FootParams()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x56A4);
		}
		...
		::Il2CppArray<::UnityEngine::MaterialPropertyBlock*>* m_MaterialPropertyBlockForNPC; // 0x10
		::Il2CppArray<::UnityEngine::Rendering::Universal::Internal::FootPrintManager_CachedFootPrintRenderItem>* m_CandidateNPCFootPrintCpuDates; // 0x18
		...
		::System::Collections::Generic::Dictionary_2<::UnityEngine::GameObject*, ::UnityEngine::Rendering::Universal::Internal::FootPrintSpawner*>* cachedWheelPrintData; // 0x30
		::Il2CppArray<::UnityEngine::Vector4>* m_FootParamsForNPC; // 0x38
		::Il2CppArray<::UnityEngine::Matrix4x4>* m_LocalToWorldMatrixArrayForNPC; // 0x40
