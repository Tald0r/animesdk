...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_ADDTONPCFOOTPRINTQUEUE_OFFSET UNITYSDK_OFFSET(0x19B63E10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_CLEARCACHEDDATA_OFFSET UNITYSDK_OFFSET(0x19B62960)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_CLEARTARGETHOLDER_OFFSET UNITYSDK_OFFSET(0x19B638D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_DRAWFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x19B65050)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_DUMPFOOTPRINTPASSMASK_OFFSET UNITYSDK_OFFSET(0x19B64770)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19B62870)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_NEEDDRAWFOOTPRINTPASS_OFFSET UNITYSDK_OFFSET(0x19B64E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_TICKNPCFOOTPRINTDATA_OFFSET UNITYSDK_OFFSET(0x19B63F50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_TRYBINDFOOTPRINTSPAWNER_OFFSET UNITYSDK_OFFSET(0x19B66720)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_TRYBINDWHEELPRINTSPAWNER_OFFSET UNITYSDK_OFFSET(0x19B65FE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_TRYSPAWNCOMMONFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x19B64430)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER_TRYSPAWNMAINCHARACTERFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x19B64310)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B672B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B62680)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintManager_TypeDefinitionIndex = 29965;
	...
	public:
		...
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x22110);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_Sampler_TrySpawnNPCFootPrint()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x22118);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_Sampler_LateUpdateFootPrintDrawData()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x22120);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_Sampler_TrySpawnMainCharacterFootPrint()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x22128);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_Sampler_TryBindNPCFootPrint()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x22130);
		}
		static ::UnityEngine::Rendering::Universal::Internal::FootPrintManager** StaticGet__instance()
		{
			return (::UnityEngine::Rendering::Universal::Internal::FootPrintManager**)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x22138);
		}
		static ::System::Int32* StaticGet__FootParams()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x5780);
		}
		static ::System::Boolean* StaticGet_s_EnableDebugLog()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x5784);
		}
		static ::System::Boolean* StaticGet_enableNPCFootPrint()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(FootPrintManager_TypeDefinitionIndex)->GetStaticField(0x5785);
		}
		...
		::System::Collections::Generic::Dictionary_2<::UnityEngine::GameObject*, ::UnityEngine::Rendering::Universal::Internal::FootPrintSpawner*>* cachedWheelPrintData; // 0x10
		::System::Collections::Generic::Dictionary_2<::UnityEngine::GameObject*, ::UnityEngine::Rendering::Universal::Internal::FootPrintManager_FootPrintArray*>* cachedFootPrintData; // 0x18
		::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::Internal::FootPrintSpawner*>* FootPrintSpawners; // 0x20
		::Il2CppArray<::UnityEngine::Vector4>* m_FootParamsForNPC; // 0x28
		...
		::Il2CppArray<::UnityEngine::Matrix4x4>* m_LocalToWorldMatrixArrayForNPC; // 0x38
		::Il2CppArray<::UnityEngine::MaterialPropertyBlock*>* m_MaterialPropertyBlockForNPC; // 0x40
		::System::Collections::Generic::Queue_1<::UnityEngine::Rendering::Universal::Internal::FootPrintManager_FootPrintRenderItem>* m_NPCFootPrintCpuDates; // 0x48
