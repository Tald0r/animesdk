...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_GENERATE_OFFSET UNITYSDK_OFFSET(0x17B6F200)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17B71A20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x17B71C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17B6F1B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_TRYFINDINTERSECTION_OFFSET UNITYSDK_OFFSET(0x17B71AF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x17B726A0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int CustomLineRenderGuideLine_TypeDefinitionIndex = 29064;
