...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_GENERATE_OFFSET UNITYSDK_OFFSET(0x17805AB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x178082D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x178084E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17805A60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE_TRYFINDINTERSECTION_OFFSET UNITYSDK_OFFSET(0x178083A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_CUSTOMLINERENDERGUIDELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x17808F50)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int CustomLineRenderGuideLine_TypeDefinitionIndex = 30017;
