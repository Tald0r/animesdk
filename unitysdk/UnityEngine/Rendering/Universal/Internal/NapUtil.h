...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ASFLOAT_OFFSET UNITYSDK_OFFSET(0x16F6C360)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ASUINT_OFFSET UNITYSDK_OFFSET(0x16F6C3A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_BATCHNULLCHECK_OFFSET UNITYSDK_OFFSET(0x16F6BD00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_BLITQUAD_OFFSET UNITYSDK_OFFSET(0x16F6B570)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_COMPUTELINEARDISTANCEFADE_OFFSET UNITYSDK_OFFSET(0x16F6B450)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_COMPUTEPIXELCOORDTOWORLDSPACEVIEWDIRECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x16F6B850)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_DIVROUNDUP_OFFSET UNITYSDK_OFFSET(0x16F6B360)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ENCODEBYTETOFLOAT_OFFSET UNITYSDK_OFFSET(0x16F6C270)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ENCODEFLOATARRAYTOVECTOR4_OFFSET UNITYSDK_OFFSET(0x16F6BD90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_EXTRACTBYTEFROMFLOAT_OFFSET UNITYSDK_OFFSET(0x16F6C2F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_GETBLITMATERIAL_OFFSET UNITYSDK_OFFSET(0x16F6B740)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_GETSCALEANDBIASFORLINEARDISTANCEFADE_OFFSET UNITYSDK_OFFSET(0x16F6B3C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_GET_MAXUINTASFLOAT_OFFSET UNITYSDK_OFFSET(0x16F6B3B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_PROJECTIONMATRIXASPECT_OFFSET UNITYSDK_OFFSET(0x16F6B800)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6C3F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL__ENCODEFLOATARRAYTOVECTOR4_G__ENCODEFLOATTOUINT8_14_0_OFFSET UNITYSDK_OFFSET(0x16F6C1D0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapUtil_TypeDefinitionIndex = 29000;
	...
	public:
		...
		{
			return (::UnityEngine::MaterialPropertyBlock**)Il2CppClass::FromTypeDefinitionIndex(NapUtil_TypeDefinitionIndex)->GetStaticField(0x226F0);
		}
