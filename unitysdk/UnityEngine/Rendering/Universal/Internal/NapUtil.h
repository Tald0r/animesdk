...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ASFLOAT_OFFSET UNITYSDK_OFFSET(0x17640640)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ASUINT_OFFSET UNITYSDK_OFFSET(0x17640680)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_BATCHNULLCHECK_OFFSET UNITYSDK_OFFSET(0x1763FFE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_BLITQUAD_OFFSET UNITYSDK_OFFSET(0x1763F850)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_COMPUTELINEARDISTANCEFADE_OFFSET UNITYSDK_OFFSET(0x1763F730)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_COMPUTEPIXELCOORDTOWORLDSPACEVIEWDIRECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1763FB30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_DIVROUNDUP_OFFSET UNITYSDK_OFFSET(0x1763F640)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ENCODEBYTETOFLOAT_OFFSET UNITYSDK_OFFSET(0x17640550)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_ENCODEFLOATARRAYTOVECTOR4_OFFSET UNITYSDK_OFFSET(0x17640070)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_EXTRACTBYTEFROMFLOAT_OFFSET UNITYSDK_OFFSET(0x176405D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_GETBLITMATERIAL_OFFSET UNITYSDK_OFFSET(0x1763FA20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_GETSCALEANDBIASFORLINEARDISTANCEFADE_OFFSET UNITYSDK_OFFSET(0x1763F6A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_GET_MAXUINTASFLOAT_OFFSET UNITYSDK_OFFSET(0x1763F690)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL_PROJECTIONMATRIXASPECT_OFFSET UNITYSDK_OFFSET(0x1763FAE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x176406D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPUTIL__ENCODEFLOATARRAYTOVECTOR4_G__ENCODEFLOATTOUINT8_14_0_OFFSET UNITYSDK_OFFSET(0x176404B0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapUtil_TypeDefinitionIndex = 29951;
	...
	public:
		...
		{
			return (::UnityEngine::MaterialPropertyBlock**)Il2CppClass::FromTypeDefinitionIndex(NapUtil_TypeDefinitionIndex)->GetStaticField(0x238A0);
		}
