...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_TEXTURESCALEBIAS_COMPARETO_OFFSET UNITYSDK_OFFSET(0x18B3C8D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_TEXTURESCALEBIAS_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x18B3CA30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_TEXTURESCALEBIAS__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3CA90)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_TextureScaleBias_TypeDefinitionIndex = 29824;
