...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_TEXTURESCALEBIAS_COMPARETO_OFFSET UNITYSDK_OFFSET(0x185D3FF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_TEXTURESCALEBIAS_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x185D4150)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_TEXTURESCALEBIAS__CTOR_OFFSET UNITYSDK_OFFSET(0x185D41B0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_TextureScaleBias_TypeDefinitionIndex = 28874;
