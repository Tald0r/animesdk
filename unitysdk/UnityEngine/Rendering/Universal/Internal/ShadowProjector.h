...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_BINDPATH_OFFSET UNITYSDK_OFFSET(0x19339B60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_DRAWPROJECTOR_OFFSET UNITYSDK_OFFSET(0x1933AC20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_GETFULLPATH_OFFSET UNITYSDK_OFFSET(0x1933A370)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_NEEDBINDPATH_OFFSET UNITYSDK_OFFSET(0x1933A4E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1933A2F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1933A6F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1933A1F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_PATHAUTOBIND_OFFSET UNITYSDK_OFFSET(0x19339BE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_PATHAUTOGENERATOR_OFFSET UNITYSDK_OFFSET(0x19339910)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_RECORDPATH_OFFSET UNITYSDK_OFFSET(0x193398A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_REGISTER_OFFSET UNITYSDK_OFFSET(0x19339F90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_SETUPRENDERINGDATA_OFFSET UNITYSDK_OFFSET(0x1933BDA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1933A0C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_UPDATESLICEDATA_OFFSET UNITYSDK_OFFSET(0x1933BE40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1933C000)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1933BF80)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int ShadowProjector_TypeDefinitionIndex = 28887;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::Internal::ShadowProjector*>**)Il2CppClass::FromTypeDefinitionIndex(ShadowProjector_TypeDefinitionIndex)->GetStaticField(0x21BA0);
		}
		static ::UnityEngine::Material** StaticGet_s_ShadowProjectorMaterial()
		{
			return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(ShadowProjector_TypeDefinitionIndex)->GetStaticField(0x21BA8);
		}
		static ::System::Int32* StaticGet__ShadowTempBuffer()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ShadowProjector_TypeDefinitionIndex)->GetStaticField(0x64D0);
		}
