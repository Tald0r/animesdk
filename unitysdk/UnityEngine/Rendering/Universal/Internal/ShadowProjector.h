...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_BINDPATH_OFFSET UNITYSDK_OFFSET(0x197ED130)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_DRAWPROJECTOR_OFFSET UNITYSDK_OFFSET(0x197EE1E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_GETFULLPATH_OFFSET UNITYSDK_OFFSET(0x197ED940)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_NEEDBINDPATH_OFFSET UNITYSDK_OFFSET(0x197EDAB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x197ED8C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x197EDCC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x197ED7C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_PATHAUTOBIND_OFFSET UNITYSDK_OFFSET(0x197ED1B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_PATHAUTOGENERATOR_OFFSET UNITYSDK_OFFSET(0x197ECEE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_RECORDPATH_OFFSET UNITYSDK_OFFSET(0x197ECE70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_REGISTER_OFFSET UNITYSDK_OFFSET(0x197ED560)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_SETUPRENDERINGDATA_OFFSET UNITYSDK_OFFSET(0x197EF360)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x197ED690)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR_UPDATESLICEDATA_OFFSET UNITYSDK_OFFSET(0x197EF400)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x197EF5C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x197EF540)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int ShadowProjector_TypeDefinitionIndex = 29837;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::Internal::ShadowProjector*>**)Il2CppClass::FromTypeDefinitionIndex(ShadowProjector_TypeDefinitionIndex)->GetStaticField(0x234F0);
		}
		static ::UnityEngine::Material** StaticGet_s_ShadowProjectorMaterial()
		{
			return (::UnityEngine::Material**)Il2CppClass::FromTypeDefinitionIndex(ShadowProjector_TypeDefinitionIndex)->GetStaticField(0x234F8);
		}
		static ::System::Int32* StaticGet__ShadowTempBuffer()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ShadowProjector_TypeDefinitionIndex)->GetStaticField(0x6930);
		}
