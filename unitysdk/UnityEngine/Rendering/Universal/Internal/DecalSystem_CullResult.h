...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_CLEAR_OFFSET UNITYSDK_OFFSET(0x183B9C90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x183B9FA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183B9EB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x183B9B00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_GET_REQUESTS_OFFSET UNITYSDK_OFFSET(0x183B9AF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x183BA060)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_CullResult_TypeDefinitionIndex = 28869;
