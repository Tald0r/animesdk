...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_GETLAYERMASKFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x197EC750)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_GET_RENDERLAYERMASK_OFFSET UNITYSDK_OFFSET(0x197EC7D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x197EC880)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x197EC8E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x197EC820)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_REGISTERPOSTLIGHT_OFFSET UNITYSDK_OFFSET(0x197EC4F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_UNREGISTERPOSTLIGHT_OFFSET UNITYSDK_OFFSET(0x197EC620)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT__CCTOR_OFFSET UNITYSDK_OFFSET(0x197ECE10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x197ECDB0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PostLight_TypeDefinitionIndex = 29828;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::Internal::PostLight*>**)Il2CppClass::FromTypeDefinitionIndex(PostLight_TypeDefinitionIndex)->GetStaticField(0x234E0);
		}
