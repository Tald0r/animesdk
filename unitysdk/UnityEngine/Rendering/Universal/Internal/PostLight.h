...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_GETLAYERMASKFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x19339180)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_GET_RENDERLAYERMASK_OFFSET UNITYSDK_OFFSET(0x19339200)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x193392B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x19339310)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19339250)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_REGISTERPOSTLIGHT_OFFSET UNITYSDK_OFFSET(0x19338F20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT_UNREGISTERPOSTLIGHT_OFFSET UNITYSDK_OFFSET(0x19339050)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT__CCTOR_OFFSET UNITYSDK_OFFSET(0x19339840)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTLIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x193397E0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PostLight_TypeDefinitionIndex = 28878;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::Internal::PostLight*>**)Il2CppClass::FromTypeDefinitionIndex(PostLight_TypeDefinitionIndex)->GetStaticField(0x21B90);
		}
