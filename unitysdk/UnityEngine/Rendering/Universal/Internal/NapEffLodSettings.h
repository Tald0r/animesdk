...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19245D30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19245960)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_REFRESHVALUE_OFFSET UNITYSDK_OFFSET(0x19245B00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x19245C50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19245D90)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapEffLodSettings_TypeDefinitionIndex = 28963;
