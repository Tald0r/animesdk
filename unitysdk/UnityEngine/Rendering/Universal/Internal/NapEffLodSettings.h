...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1966A410)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1966A040)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_REFRESHVALUE_OFFSET UNITYSDK_OFFSET(0x1966A1E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x1966A330)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPEFFLODSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1966A470)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapEffLodSettings_TypeDefinitionIndex = 29914;
