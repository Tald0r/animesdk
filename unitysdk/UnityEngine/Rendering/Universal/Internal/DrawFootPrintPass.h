...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1777AB00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1777ADB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1777AD40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1777AA60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS___BASE_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1777B300)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWFOOTPRINTPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1777B310)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DrawFootPrintPass_TypeDefinitionIndex = 29961;
