...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_CLEAR_OFFSET UNITYSDK_OFFSET(0x18B4A2D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18B4A5B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18B4A4C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18B4A140)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x18B4A670)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_CullRequest_TypeDefinitionIndex = 28871;
