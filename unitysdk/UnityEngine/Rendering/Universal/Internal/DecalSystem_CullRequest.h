...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_CLEAR_OFFSET UNITYSDK_OFFSET(0x18F0D3D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x18F0D6B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18F0D5C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18F0D250)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x18F0D770)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_CullRequest_TypeDefinitionIndex = 29821;
