...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETINT_OFFSET UNITYSDK_OFFSET(0x18397820)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x18397980)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x18397890)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x18397AF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x18397A70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18397810)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_GlobalSetter_TypeDefinitionIndex = 28998;
