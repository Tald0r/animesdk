...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETINT_OFFSET UNITYSDK_OFFSET(0x189EDEA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x189EE000)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x189EDF10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x189EE170)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x189EE0F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_GLOBALSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x189EDE90)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_GlobalSetter_TypeDefinitionIndex = 29949;
