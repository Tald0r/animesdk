...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_BLITCHARACTERGHOST_OFFSET UNITYSDK_OFFSET(0x1740E350)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_BLITDSTDISCARDCONTENT_OFFSET UNITYSDK_OFFSET(0x174154A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_BLURUI_OFFSET UNITYSDK_OFFSET(0x1740ED70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_CLEANUP_OFFSET UNITYSDK_OFFSET(0x174062D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x17409990)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DOBOKEHDEPTHOFFIELD_OFFSET UNITYSDK_OFFSET(0x17413C80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DODAMAGETEXTSYSTEMDRAW_OFFSET UNITYSDK_OFFSET(0x1740D100)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DODEPTHOFFILEDFORCG_OFFSET UNITYSDK_OFFSET(0x174120F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DOGAUSSIANDEPTHOFFIELD_OFFSET UNITYSDK_OFFSET(0x17412BA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DOPOSTLIGHTFORCG_OFFSET UNITYSDK_OFFSET(0x174112E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DOPVFARCLIPFOREDITOR_OFFSET UNITYSDK_OFFSET(0x17411270)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DOPVUICAPTUREFOREDITOR_OFFSET UNITYSDK_OFFSET(0x17411D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWCHARACTEROUTLINEFXFORCG_OFFSET UNITYSDK_OFFSET(0x17410160)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWDEBUGVIEWTOOLSFOREDITOR_OFFSET UNITYSDK_OFFSET(0x17410F10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWFULLRESFXAFTERALL_OFFSET UNITYSDK_OFFSET(0x1740FCF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWFX2DFOG_OFFSET UNITYSDK_OFFSET(0x1740C9E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWHIZDEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x1740E640)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWMODULATEFORCG_OFFSET UNITYSDK_OFFSET(0x17410870)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWPOSTLIGHTEFFECTFOREFFECT_OFFSET UNITYSDK_OFFSET(0x17411930)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWSCENEFARTRANSPARENTOBJECT_OFFSET UNITYSDK_OFFSET(0x1740D940)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWTRANSPARENTMASKPASSFORCG_OFFSET UNITYSDK_OFFSET(0x17410440)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_EXECUTEPROCESSLENSFLARE_OFFSET UNITYSDK_OFFSET(0x1740E4C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x17409FD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x17415AB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_GETCOCPARAMS_OFFSET UNITYSDK_OFFSET(0x174148C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_GETMAXBOKEHRADIUSINPIXELS_OFFSET UNITYSDK_OFFSET(0x17415440)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_GETRTXPATHTRACERENABLED_OFFSET UNITYSDK_OFFSET(0x1740E200)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_GETSTEREOCOMPATIBLEDESCRIPTOR_1_OFFSET UNITYSDK_OFFSET(0x17414A90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_GETSTEREOCOMPATIBLEDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x174155D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_OUTPUTLENSFLARELAYERFORCG_OFFSET UNITYSDK_OFFSET(0x17410F70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_OUTPUTPARTICLELAYERFORCG_OFFSET UNITYSDK_OFFSET(0x174105D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_PREPAREBOKEHKERNEL_OFFSET UNITYSDK_OFFSET(0x17414BF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_PREPAREDOFRESOURCE_OFFSET UNITYSDK_OFFSET(0x17415800)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_PREVIEWPATHTRACERFOREDITOR_OFFSET UNITYSDK_OFFSET(0x17410EB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_PREVIEWSCENEVIEWLIGHTSHAFTFOREDITOR_OFFSET UNITYSDK_OFFSET(0x17410CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_PROCESSOFFSCREENPARTICLES_OFFSET UNITYSDK_OFFSET(0x1740DA80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_SETPREVIEWCAMERALAYERMASKFOREDITOR_OFFSET UNITYSDK_OFFSET(0x17411CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x17403710)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_TRYBLITVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x1740D430)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_TRYDRAWRAINDEPTHFORCG_OFFSET UNITYSDK_OFFSET(0x1740FFD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_TRYDRAWRAINDROPANDRAINSPLASHFORCG_OFFSET UNITYSDK_OFFSET(0x17410C20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x173F9800)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS___BASE_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x17415B60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x17415B70)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DrawTransparentObjectsPass_TypeDefinitionIndex = 29956;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DrawTransparentObjectsPass_TypeDefinitionIndex)->GetStaticField(0x78B0);
		}
		::System::Collections::Generic::List_1<::UnityEngine::Rendering::ShaderTagId>* m_FarTransparentShaderTagIdList; // 0xA8
		::UnityEngine::NAPRenderPipeline0::MaterialWrapper* bokehDepthOfField; // 0xB0
		::Il2CppArray<::UnityEngine::Rendering::RenderTargetIdentifier>* m_MRT3; // 0xB8
		::System::String* m_ProfilerTag; // 0xC0
		::Il2CppArray<::UnityEngine::Vector4>* m_BokehKernel; // 0xC8
		...
		::UnityEngine::NAPRenderPipeline0::MaterialWrapper* gaussianDepthOfFieldMaterial; // 0xE8
		::UnityEngine::Rendering::Universal::DepthOfField* m_DepthOfField; // 0xF0
		::System::Collections::Generic::List_1<::UnityEngine::Rendering::ShaderTagId>* m_TransparentShaderTagIdList; // 0xF8
		::UnityEngine::Matrix4x4 m_DamageTextProjMatrix; // 0x100
		::System::Boolean m_PlanarReflectedFxInRtx; // 0x140
		::System::Boolean m_JustSetRenderTarget; // 0x141
		::System::Boolean m_OffScreenUI; // 0x142
		::System::Boolean m_OutlineBeforeTransparent; // 0x143
		::UnityEngine::NAPRenderPipeline0::RenderTargetHandle m_ActiveDepthAttachment; // 0x144
		::UnityEngine::Rendering::FilteringSettings m_FilteringSettingsForModulateCGFront; // 0x148
		::UnityEngine::Experimental::Rendering::GraphicsFormat m_DofCoCFormat; // 0x164
		::UnityEngine::Rendering::FilteringSettings m_FilterSettingForNonUI2DParticle; // 0x168
		::System::Int32 m_lastScreenWidth; // 0x184
		::UnityEngine::Rendering::FilteringSettings m_FilteringSettingsForAll; // 0x188
		::UnityEngine::NAPRenderPipeline0::RenderTargetHandle m_ActiveColorAttachment; // 0x1A4
		::System::Boolean m_UseNativeDeferred; // 0x1A8
		::System::Boolean m_isInitDamageTextProjMatrix; // 0x1A9
		::System::Boolean m_UseFullResOffScreenParticlePass; // 0x1AA
		::System::Int32 m_lastScreenHeight; // 0x1AC
		::UnityEngine::Experimental::Rendering::GraphicsFormat m_DefaultHDRFormat; // 0x1B0
		::UnityEngine::Rendering::RenderTargetIdentifier m_DepthIdentifier; // 0x1B8
		::UnityEngine::RenderTextureDescriptor m_Descriptor; // 0x1E0
		::UnityEngine::Rendering::FilteringSettings m_FilteringSettingsForTop; // 0x218
		::UnityEngine::Rendering::FilteringSettings m_FilteringSettings; // 0x234
		::UnityEngine::Matrix4x4 cameraViewMatrix; // 0x250
		::UnityEngine::Rendering::FilteringSettings m_FilterForFarFullResTransparent; // 0x290
		::UnityEngine::Matrix4x4 cameraProjMatrix; // 0x2AC
		::UnityEngine::Rendering::RenderStateBlock m_RenderStateBlock; // 0x2EC
		::System::Boolean m_DrawParticleDecalAndOnTransparentPass; // 0x358
		::System::Boolean m_OutlineProcessPassActiveHear; // 0x359
		::System::Boolean m_UIBlurRendered; // 0x35A
		::System::Boolean m_SubPassDeferred; // 0x35B
		::System::Int32 m_BokehHash; // 0x35C
		::UnityEngine::NAPRenderPipeline0::RenderTargetHandle m_CameraColorAttachment; // 0x360
		::UnityEngine::Rendering::FilteringSettings m_FilteringSettingsForModulateCGBack; // 0x364
