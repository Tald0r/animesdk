...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_BLITCHARACTERGHOST_OFFSET UNITYSDK_OFFSET(0x16DA7E40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_BLITDSTDISCARDCONTENT_OFFSET UNITYSDK_OFFSET(0x16DAEBB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_BLURUI_OFFSET UNITYSDK_OFFSET(0x16DA8860)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_CLEANUP_OFFSET UNITYSDK_OFFSET(0x16D9FD00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x16DA33E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DOBOKEHDEPTHOFFIELD_OFFSET UNITYSDK_OFFSET(0x16DAD390)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DODAMAGETEXTSYSTEMDRAW_OFFSET UNITYSDK_OFFSET(0x16DA6BA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DODEPTHOFFILEDFORCG_OFFSET UNITYSDK_OFFSET(0x16DABC60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DOGAUSSIANDEPTHOFFIELD_OFFSET UNITYSDK_OFFSET(0x16DAC2B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DOPOSTLIGHTFORCG_OFFSET UNITYSDK_OFFSET(0x16DAAE50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DOPVFARCLIPFOREDITOR_OFFSET UNITYSDK_OFFSET(0x16DAADE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DOPVUICAPTUREFOREDITOR_OFFSET UNITYSDK_OFFSET(0x16DAB8C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWCHARACTEROUTLINEFXFORCG_OFFSET UNITYSDK_OFFSET(0x16DA9C70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWDEBUGVIEWTOOLSFOREDITOR_OFFSET UNITYSDK_OFFSET(0x16DAAA80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWFULLRESFXAFTERALL_OFFSET UNITYSDK_OFFSET(0x16DA9800)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWFX2DFOG_OFFSET UNITYSDK_OFFSET(0x16DA6760)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWHIZDEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x16DA8130)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWMODULATEFORCG_OFFSET UNITYSDK_OFFSET(0x16DAA380)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWPOSTLIGHTEFFECTFOREFFECT_OFFSET UNITYSDK_OFFSET(0x16DAB4A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWSCENEFARTRANSPARENTOBJECT_OFFSET UNITYSDK_OFFSET(0x16DA7430)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DRAWTRANSPARENTMASKPASSFORCG_OFFSET UNITYSDK_OFFSET(0x16DA9F50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_EXECUTEPROCESSLENSFLARE_OFFSET UNITYSDK_OFFSET(0x16DA7FB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x16DA3940)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x16DAF1C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_GETCOCPARAMS_OFFSET UNITYSDK_OFFSET(0x16DADFD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_GETMAXBOKEHRADIUSINPIXELS_OFFSET UNITYSDK_OFFSET(0x16DAEB50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_GETRTXPATHTRACERENABLED_OFFSET UNITYSDK_OFFSET(0x16DA7CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_GETSTEREOCOMPATIBLEDESCRIPTOR_1_OFFSET UNITYSDK_OFFSET(0x16DAE1A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_GETSTEREOCOMPATIBLEDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x16DAECE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_OUTPUTLENSFLARELAYERFORCG_OFFSET UNITYSDK_OFFSET(0x16DAAAE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_OUTPUTPARTICLELAYERFORCG_OFFSET UNITYSDK_OFFSET(0x16DAA0E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_PREPAREBOKEHKERNEL_OFFSET UNITYSDK_OFFSET(0x16DAE300)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_PREPAREDOFRESOURCE_OFFSET UNITYSDK_OFFSET(0x16DAEF10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_PREVIEWPATHTRACERFOREDITOR_OFFSET UNITYSDK_OFFSET(0x16DAAA20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_PREVIEWSCENEVIEWLIGHTSHAFTFOREDITOR_OFFSET UNITYSDK_OFFSET(0x16DAA800)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_PROCESSOFFSCREENPARTICLES_OFFSET UNITYSDK_OFFSET(0x16DA7570)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_SETPREVIEWCAMERALAYERMASKFOREDITOR_OFFSET UNITYSDK_OFFSET(0x16DAB860)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x16D9D370)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_TRYBLITVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x16DA6ED0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_TRYDRAWRAINDEPTHFORCG_OFFSET UNITYSDK_OFFSET(0x16DA9AE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_TRYDRAWRAINDROPANDRAINSPLASHFORCG_OFFSET UNITYSDK_OFFSET(0x16DAA730)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x16D92460)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS___BASE_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x16DAF270)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x16DAF280)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DrawTransparentObjectsPass_TypeDefinitionIndex = 29005;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DrawTransparentObjectsPass_TypeDefinitionIndex)->GetStaticField(0x70C0);
		}
		::System::Collections::Generic::List_1<::UnityEngine::Rendering::ShaderTagId>* m_TransparentShaderTagIdList; // 0xA8
		::UnityEngine::NAPRenderPipeline0::MaterialWrapper* gaussianDepthOfFieldMaterial; // 0xB0
		::UnityEngine::NAPRenderPipeline0::ProfilingSampler* m_ProfilingSampler; // 0xB8
		::System::Collections::Generic::List_1<::UnityEngine::Rendering::ShaderTagId>* m_FarTransparentShaderTagIdList; // 0xC0
		::Il2CppArray<::UnityEngine::Rendering::RenderTargetIdentifier>* m_MRT3; // 0xC8
		::UnityEngine::Rendering::Universal::DepthOfField* m_DepthOfField; // 0xD0
		::UnityEngine::NAPRenderPipeline0::MaterialWrapper* bokehDepthOfField; // 0xD8
		::Il2CppArray<::UnityEngine::Vector4>* m_BokehKernel; // 0xE0
		::System::String* m_ProfilerTag; // 0xE8
		::System::Collections::Generic::List_1<::UnityEngine::Rendering::ShaderTagId>* m_TopTransparentShaderTagIdList; // 0xF0
		::System::Collections::Generic::List_1<::UnityEngine::Rendering::ShaderTagId>* m_WriteTransparentMaskTagIdList; // 0xF8
		::System::Boolean m_OffScreenUI; // 0x100
		::System::Boolean m_UIBlurRendered; // 0x101
		::System::Boolean m_OutlineProcessPassActiveHear; // 0x102
		::System::Boolean m_JustSetRenderTarget; // 0x103
		::System::Boolean m_SubPassDeferred; // 0x104
		::System::Boolean m_UseNativeDeferred; // 0x105
		::System::Boolean m_isInitDamageTextProjMatrix; // 0x106
		::UnityEngine::Matrix4x4 m_DamageTextProjMatrix; // 0x108
		::UnityEngine::NAPRenderPipeline0::RenderTargetHandle m_CameraColorAttachment; // 0x148
		::System::Int32 m_BokehHash; // 0x14C
		::UnityEngine::Experimental::Rendering::GraphicsFormat m_DefaultHDRFormat; // 0x150
		::UnityEngine::Experimental::Rendering::GraphicsFormat m_DofCoCFormat; // 0x154
		::UnityEngine::Rendering::FilteringSettings m_FilterForFarFullResTransparent; // 0x158
		::System::Int32 m_lastScreenWidth; // 0x174
		::UnityEngine::NAPRenderPipeline0::RenderTargetHandle m_ActiveColorAttachment; // 0x178
		::UnityEngine::NAPRenderPipeline0::RenderTargetHandle m_ActiveDepthAttachment; // 0x17C
		::UnityEngine::Rendering::FilteringSettings m_FilteringSettingsForModulateCGFront; // 0x180
		::UnityEngine::Matrix4x4 cameraViewMatrix; // 0x19C
		::System::Boolean m_OutlineBeforeTransparent; // 0x1DC
		::System::Boolean m_PlanarReflectedFxInRtx; // 0x1DD
		::System::Boolean m_DrawParticleDecalAndOnTransparentPass; // 0x1DE
		::System::Boolean m_UseFullResOffScreenParticlePass; // 0x1DF
		::System::Int32 m_lastScreenHeight; // 0x1E0
		::UnityEngine::Rendering::FilteringSettings m_FilterSettingForNonUI2DParticle; // 0x1E4
		::UnityEngine::Rendering::RenderTargetIdentifier m_DepthIdentifier; // 0x200
		::UnityEngine::Rendering::FilteringSettings m_FilteringSettingsForModulateCGBack; // 0x228
		::UnityEngine::Rendering::FilteringSettings m_FilteringSettings; // 0x244
		::UnityEngine::Matrix4x4 cameraProjMatrix; // 0x260
		::UnityEngine::Rendering::RenderStateBlock m_RenderStateBlock; // 0x2A0
		::UnityEngine::Rendering::FilteringSettings m_FilteringSettingsForTop; // 0x30C
		::UnityEngine::Rendering::FilteringSettings m_FilteringSettingsForAll; // 0x328
		::UnityEngine::RenderTextureDescriptor m_Descriptor; // 0x344
		...
		::System::Void DoDepthOfFiledForCG(::UnityEngine::NAPRenderPipeline0::CameraData& cameraData, ::UnityEngine::Rendering::CommandBuffer* cmdWrapper, ::UnityEngine::Rect pixelRect)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::NAPRenderPipeline0::CameraData&, ::UnityEngine::Rendering::CommandBuffer*, ::UnityEngine::Rect))((::PBYTE)hIl2Cpp + UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DRAWTRANSPARENTOBJECTSPASS_DODEPTHOFFILEDFORCG_OFFSET))(this, cameraData, cmdWrapper, pixelRect);
		}
