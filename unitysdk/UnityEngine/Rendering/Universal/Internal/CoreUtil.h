...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COREUTIL_GETEXTRALIGHTDATA_OFFSET UNITYSDK_OFFSET(0x18B49B10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COREUTIL_TRYGETEXTRAREFLECTIONPROBEDATA_OFFSET UNITYSDK_OFFSET(0x18B49C10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COREUTIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x18B4A010)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COREUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x18B4A000)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int CoreUtil_TypeDefinitionIndex = 28847;
	...
	public:
		...
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(CoreUtil_TypeDefinitionIndex)->GetStaticField(0x21A40);
		}
		static ::System::Type** StaticGet_s_TypeUniversalAdditionalCameraData()
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(CoreUtil_TypeDefinitionIndex)->GetStaticField(0x21A48);
		}
		static ::System::Type** StaticGet_TypeDeferredReflectionProbe()
		{
			return (::System::Type**)Il2CppClass::FromTypeDefinitionIndex(CoreUtil_TypeDefinitionIndex)->GetStaticField(0x21A50);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::ReflectionProbe*, ::UnityEngine::Rendering::Universal::DeferredReflectionProbe*>**)Il2CppClass::FromTypeDefinitionIndex(CoreUtil_TypeDefinitionIndex)->GetStaticField(0x21A58);
		}
