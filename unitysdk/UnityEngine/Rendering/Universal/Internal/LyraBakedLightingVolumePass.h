...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDLIGHTINGVOLUMEPASS_CLEANUP_OFFSET UNITYSDK_OFFSET(0x17B750D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDLIGHTINGVOLUMEPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x17B75070)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDLIGHTINGVOLUMEPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x17B74D20)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedLightingVolumePass_TypeDefinitionIndex = 29027;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::ProfilingSampler**)Il2CppClass::FromTypeDefinitionIndex(LyraBakedLightingVolumePass_TypeDefinitionIndex)->GetStaticField(0x212A0);
		}
		...
		::UnityEngine::RenderTexture* m_bakedLightingVolume; // 0xA8
		::Il2CppArray<::UnityEngine::Vector4>* m_BLVWorldToVolume; // 0xB0
		::Il2CppArray<::UnityEngine::Vector4>* m_BLVVolumeToWorld; // 0xB8
		::UnityEngine::RenderTexture* m_bakedLightingVolumeDir; // 0xC0
		::Il2CppArray<::UnityEngine::Vector4>* m_BLVShift; // 0xC8
