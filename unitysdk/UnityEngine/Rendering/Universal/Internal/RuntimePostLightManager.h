...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_RUNTIMEPOSTLIGHTMANAGER_DRAWRUNTIMEPOSTAO_OFFSET UNITYSDK_OFFSET(0x185D6610)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_RUNTIMEPOSTLIGHTMANAGER_DRAWRUNTIMEPOSTLIGHT_OFFSET UNITYSDK_OFFSET(0x185D62D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_RUNTIMEPOSTLIGHTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x185D6910)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int RuntimePostLightManager_TypeDefinitionIndex = 28885;
