...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_RUNTIMEPOSTLIGHTMANAGER_DRAWRUNTIMEPOSTAO_OFFSET UNITYSDK_OFFSET(0x18B3EEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_RUNTIMEPOSTLIGHTMANAGER_DRAWRUNTIMEPOSTLIGHT_OFFSET UNITYSDK_OFFSET(0x18B3EBB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_RUNTIMEPOSTLIGHTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3F1F0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int RuntimePostLightManager_TypeDefinitionIndex = 29835;
