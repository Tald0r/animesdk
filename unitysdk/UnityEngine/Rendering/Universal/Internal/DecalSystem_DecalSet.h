...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_ADDDECAL_OFFSET UNITYSDK_OFFSET(0x187BD9C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_ASSIGNCURRENTBATCHES_OFFSET UNITYSDK_OFFSET(0x187BEC60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_BEGINCULL_OFFSET UNITYSDK_OFFSET(0x187BE770)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_CREATEDRAWDATA_OFFSET UNITYSDK_OFFSET(0x187BEED0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_ENDCULL_OFFSET UNITYSDK_OFFSET(0x187BF830)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_GETDECALPROJECTBOUNDINGSPHERE_OFFSET UNITYSDK_OFFSET(0x187BCEC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x187BFF00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_GET_DRAWORDER_OFFSET UNITYSDK_OFFSET(0x187BFFA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_GET_KEYMATERIAL_OFFSET UNITYSDK_OFFSET(0x187BFEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_INITIALIZEMATERIALVALUES_OFFSET UNITYSDK_OFFSET(0x187BCAF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_ISDRAWN_OFFSET UNITYSDK_OFFSET(0x187BEE20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_MOVECACHEDDATA_OFFSET UNITYSDK_OFFSET(0x187BE220)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_NEEDRENDERDECAL_OFFSET UNITYSDK_OFFSET(0x187BF9D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_QUERYCULLRESULTS_OFFSET UNITYSDK_OFFSET(0x187BEAC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_REFRESHDRAWORDER_OFFSET UNITYSDK_OFFSET(0x187BFF10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_REMOVEDECAL_OFFSET UNITYSDK_OFFSET(0x187BE6B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_RENDERDECAL_OFFSET UNITYSDK_OFFSET(0x187BFA80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_SETCULLRESULT_OFFSET UNITYSDK_OFFSET(0x187BFFB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET_UPDATECACHEDDATA_OFFSET UNITYSDK_OFFSET(0x187BD240)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET__CCTOR_OFFSET UNITYSDK_OFFSET(0x187C0070)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALSET__CTOR_OFFSET UNITYSDK_OFFSET(0x187BCB80)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_DecalSet_TypeDefinitionIndex = 28875;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(DecalSystem_DecalSet_TypeDefinitionIndex)->GetStaticField(0x6D80);
		}
		::Il2CppArray<::UnityEngine::Matrix4x4>* m_CachedDecalToWorld; // 0x10
		::Il2CppArray<::System::Boolean>* m_CachedAnimationToggle; // 0x18
		::System::Collections::Generic::List_1<::Il2CppArray<::UnityEngine::Vector4>*>* m_ExtraParams; // 0x20
		::UnityEngine::Rendering::Universal::Internal::DecalSystem_TextureScaleBias* m_Mask; // 0x28
		::Il2CppArray<::UnityEngine::Rendering::Universal::Internal::DecalSystem_DecalHandle*>* m_Handles; // 0x30
		::Il2CppArray<::UnityEngine::Vector4>* m_CachedUVScaleBias; // 0x38
		::Il2CppArray<::System::Int32>* m_ResultIndices; // 0x40
		::UnityEngine::Rendering::Universal::Internal::DecalSystem_TextureScaleBias* m_Diffuse; // 0x48
		::Il2CppArray<::System::Int32>* m_CachedLayerMask; // 0x50
		::Il2CppArray<::UnityEngine::BoundingSphere>* m_BoundingSpheres; // 0x58
		::UnityEngine::Material* m_Material; // 0x60
		::Il2CppArray<::UnityEngine::Vector2>* m_CachedDrawDistances; // 0x68
		::System::Collections::Generic::List_1<::Il2CppArray<::UnityEngine::Matrix4x4>*>* m_NormalToWorld; // 0x70
		::Il2CppArray<::System::Single>* m_CachedEmissionIntensity; // 0x78
		::Il2CppArray<::UnityEngine::Vector4>* m_CachedExtraParams; // 0x80
		::Il2CppArray<::UnityEngine::Matrix4x4>* m_CachedNormalToWorld; // 0x88
		::UnityEngine::MaterialPropertyBlock* m_PropertyBlock; // 0x90
		::UnityEngine::Rendering::Universal::Internal::DecalSystem_TextureScaleBias* m_Normal; // 0x98
		::System::Collections::Generic::List_1<::Il2CppArray<::UnityEngine::Matrix4x4>*>* m_DecalToWorld; // 0xA0
		::System::Int32 m_DecalsCount; // 0xA8
		::System::Int32 _DrawOrder; // 0xAC
		::UnityEngine::Vector2Int MinMaxSiblingIndex; // 0xB0
		::System::Int32 m_InstanceCount; // 0xB8
		::System::Int32 m_NumResults; // 0xBC
