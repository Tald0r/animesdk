...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DEBUGUTIL_LOGERROR_1_OFFSET UNITYSDK_OFFSET(0x16DA3320)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DEBUGUTIL_LOGERROR_OFFSET UNITYSDK_OFFSET(0x16DA3280)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DEBUGUTIL_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x16DA3120)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DEBUGUTIL_LOG_OFFSET UNITYSDK_OFFSET(0x16DA31D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DEBUGUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x16DA33D0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DebugUtil_TypeDefinitionIndex = 28854;
