...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTCONFIGSCRIPTABLEOBJECT_CONVERTMATCHNAMETOLOWCASE_OFFSET UNITYSDK_OFFSET(0x17BF04F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTCONFIGSCRIPTABLEOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17BF0730)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTCONFIGSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x17BF0890)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintConfigScriptableObject_TypeDefinitionIndex = 29011;
