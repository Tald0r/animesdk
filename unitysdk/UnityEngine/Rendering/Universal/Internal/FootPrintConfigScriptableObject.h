...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTCONFIGSCRIPTABLEOBJECT_CONVERTMATCHNAMETOLOWCASE_OFFSET UNITYSDK_OFFSET(0x182D8B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTCONFIGSCRIPTABLEOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x182D8DD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTCONFIGSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x182D8F30)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintConfigScriptableObject_TypeDefinitionIndex = 29962;
