...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_URPFILEUTIL_GETACTIVESCENELIGHTFOLDER_OFFSET UNITYSDK_OFFSET(0x19FB34A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_URPFILEUTIL_GETSCENEFOLDER_OFFSET UNITYSDK_OFFSET(0x19FB3440)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_URPFILEUTIL_GETTARGETSCENELIGHTFOLDER_OFFSET UNITYSDK_OFFSET(0x19FB3650)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int URPFileUtil_TypeDefinitionIndex = 28950;
