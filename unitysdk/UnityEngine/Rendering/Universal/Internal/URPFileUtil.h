...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_URPFILEUTIL_GETACTIVESCENELIGHTFOLDER_OFFSET UNITYSDK_OFFSET(0x1A2EDDE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_URPFILEUTIL_GETSCENEFOLDER_OFFSET UNITYSDK_OFFSET(0x1A2EDD80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_URPFILEUTIL_GETTARGETSCENELIGHTFOLDER_OFFSET UNITYSDK_OFFSET(0x1A2EDF90)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int URPFileUtil_TypeDefinitionIndex = 29901;
