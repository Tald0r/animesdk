...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_CLEARINIDIRECTARGS_OFFSET UNITYSDK_OFFSET(0x17B74200)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x17B74090)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_INITIFNEEDED_OFFSET UNITYSDK_OFFSET(0x17B740A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_SETBUFFERPARAMS_OFFSET UNITYSDK_OFFSET(0x17B74350)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_SETCOORDTOWORLDPOSOFFSETANDSCALE_OFFSET UNITYSDK_OFFSET(0x17B744D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x17B74550)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x17B74060)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_SceneVoxelVisualizer_TypeDefinitionIndex = 28977;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderTargetHandle*)Il2CppClass::FromTypeDefinitionIndex(LyraBakedDataManager_SceneVoxelVisualizer_TypeDefinitionIndex)->GetStaticField(0x5A70);
		}
