...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_CLEARINIDIRECTARGS_OFFSET UNITYSDK_OFFSET(0x1780AA40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1780A8D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_INITIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1780A8E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_SETBUFFERPARAMS_OFFSET UNITYSDK_OFFSET(0x1780AB90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_SETCOORDTOWORLDPOSOFFSETANDSCALE_OFFSET UNITYSDK_OFFSET(0x1780AD10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x1780AD90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_SCENEVOXELVISUALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1780A890)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_SceneVoxelVisualizer_TypeDefinitionIndex = 29928;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::RenderTargetHandle*)Il2CppClass::FromTypeDefinitionIndex(LyraBakedDataManager_SceneVoxelVisualizer_TypeDefinitionIndex)->GetStaticField(0x5B50);
		}
		::UnityEngine::ComputeBuffer* m_VisualizationIndirectDrawBuffer; // 0x10
		::Il2CppArray<::UnityEngine::Vector4>* m_SceneVoxelCoordToWorldPosOffsetAndScale; // 0x18
