...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1966AED0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1966AA70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1966A490)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONRENDERERCHANGEDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1966B6A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_REFRESHVALUE_OFFSET UNITYSDK_OFFSET(0x1966B330)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x1966B480)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1966C250)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1966C1B0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapMaterialLodSettings_TypeDefinitionIndex = 29925;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterialLodSettings_TypeDefinitionIndex)->GetStaticField(0x23BF0);
		}
