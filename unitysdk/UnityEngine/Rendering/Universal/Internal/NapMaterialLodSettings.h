...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x192467F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19246390)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19245DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_ONRENDERERCHANGEDMATERIALS_OFFSET UNITYSDK_OFFSET(0x19246FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_REFRESHVALUE_OFFSET UNITYSDK_OFFSET(0x19246C50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x19246DA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19247B70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPMATERIALLODSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19247AD0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapMaterialLodSettings_TypeDefinitionIndex = 28974;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterialLodSettings_TypeDefinitionIndex)->GetStaticField(0x22150);
		}
