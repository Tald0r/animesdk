...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_APPLYLOD_1_OFFSET UNITYSDK_OFFSET(0x17B75940)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_APPLYLOD_2_OFFSET UNITYSDK_OFFSET(0x17B756D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_APPLYLOD_OFFSET UNITYSDK_OFFSET(0x17B757F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_CALCULATEMATERIALLODSTATUS_OFFSET UNITYSDK_OFFSET(0x17B75300)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_FORCELOD_1_OFFSET UNITYSDK_OFFSET(0x17B75B20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_FORCELOD_OFFSET UNITYSDK_OFFSET(0x17B759E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_GET_M_LODDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x17B752A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_GET_M_LODDISTANCE_OFFSET UNITYSDK_OFFSET(0x17B75230)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_RECALCULATELODDISTANCE_OFFSET UNITYSDK_OFFSET(0x17B752B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_SET_M_LODDISTANCE_OFFSET UNITYSDK_OFFSET(0x17B75240)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_UPDATEMATERIALLODSTATUS_OFFSET UNITYSDK_OFFSET(0x17B75390)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_UPDATEMATERIALLOD_OFFSET UNITYSDK_OFFSET(0x17B75470)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17B75BD0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int MatLodBaseData_TypeDefinitionIndex = 28969;
