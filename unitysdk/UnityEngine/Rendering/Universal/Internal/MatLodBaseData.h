...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_APPLYLOD_1_OFFSET UNITYSDK_OFFSET(0x1780C180)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_APPLYLOD_2_OFFSET UNITYSDK_OFFSET(0x1780BF10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_APPLYLOD_OFFSET UNITYSDK_OFFSET(0x1780C030)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_CALCULATEMATERIALLODSTATUS_OFFSET UNITYSDK_OFFSET(0x1780BB40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_FORCELOD_1_OFFSET UNITYSDK_OFFSET(0x1780C360)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_FORCELOD_OFFSET UNITYSDK_OFFSET(0x1780C220)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_GET_M_LODDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x1780BAE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_GET_M_LODDISTANCE_OFFSET UNITYSDK_OFFSET(0x1780BA70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_RECALCULATELODDISTANCE_OFFSET UNITYSDK_OFFSET(0x1780BAF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_SET_M_LODDISTANCE_OFFSET UNITYSDK_OFFSET(0x1780BA80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_UPDATEMATERIALLODSTATUS_OFFSET UNITYSDK_OFFSET(0x1780BBD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA_UPDATEMATERIALLOD_OFFSET UNITYSDK_OFFSET(0x1780BCB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MATLODBASEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1780C410)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int MatLodBaseData_TypeDefinitionIndex = 29920;
