...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_BAKEBOXDATA_OFFSET UNITYSDK_OFFSET(0x17415B80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_GETNPCFOOTSIZE_OFFSET UNITYSDK_OFFSET(0x17416E30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_GETPRESETSPAWNERWITHNAME_OFFSET UNITYSDK_OFFSET(0x174165A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_GETPRESETWHEELSPAWNERWITHNAME_OFFSET UNITYSDK_OFFSET(0x17416300)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_GET_DYNAMICRADIUS_OFFSET UNITYSDK_OFFSET(0x174179D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_INSIDEVOLUME_OFFSET UNITYSDK_OFFSET(0x17415F70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17417370)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x17418180)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17417490)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_REFRESHPROJECTIONMATRIXANDFOOTPRINTRT_ST_OFFSET UNITYSDK_OFFSET(0x174179E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_REMOVESUBVOLUME_OFFSET UNITYSDK_OFFSET(0x17416270)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_SAVECOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x17415C50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x17417030)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x17418680)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintGroundProxy_TypeDefinitionIndex = 29964;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::Internal::FootPrintGroundProxy**)Il2CppClass::FromTypeDefinitionIndex(FootPrintGroundProxy_TypeDefinitionIndex)->GetStaticField(0x22100);
		}
