...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_BAKEBOXDATA_OFFSET UNITYSDK_OFFSET(0x16DAF290)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_GETNPCFOOTSIZE_OFFSET UNITYSDK_OFFSET(0x16DB0540)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_GETPRESETSPAWNERWITHNAME_OFFSET UNITYSDK_OFFSET(0x16DAFCB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_GETPRESETWHEELSPAWNERWITHNAME_OFFSET UNITYSDK_OFFSET(0x16DAFA10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_GET_DYNAMICRADIUS_OFFSET UNITYSDK_OFFSET(0x16DB10E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_INSIDEVOLUME_OFFSET UNITYSDK_OFFSET(0x16DAF680)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16DB0A80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x16DB1890)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16DB0BA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_REFRESHPROJECTIONMATRIXANDFOOTPRINTRT_ST_OFFSET UNITYSDK_OFFSET(0x16DB10F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_REMOVESUBVOLUME_OFFSET UNITYSDK_OFFSET(0x16DAF980)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_SAVECOLLIDERDATA_OFFSET UNITYSDK_OFFSET(0x16DAF360)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x16DB0740)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTGROUNDPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x16DB1D90)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintGroundProxy_TypeDefinitionIndex = 29013;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::Internal::FootPrintGroundProxy**)Il2CppClass::FromTypeDefinitionIndex(FootPrintGroundProxy_TypeDefinitionIndex)->GetStaticField(0x20A90);
		}
