...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LOGHELPER_COMBINELOGINFO_1_OFFSET UNITYSDK_OFFSET(0x19669810)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LOGHELPER_COMBINELOGINFO_OFFSET UNITYSDK_OFFSET(0x19669750)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LOGHELPER_LOGERROR_OFFSET UNITYSDK_OFFSET(0x19669BF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LOGHELPER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x19669BA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LOGHELPER_LOG_1_OFFSET UNITYSDK_OFFSET(0x19669B50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LOGHELPER_LOG_OFFSET UNITYSDK_OFFSET(0x19669B00)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LogHelper_TypeDefinitionIndex = 29902;
