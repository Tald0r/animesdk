...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_MACH25OBJECTINSTANCING_MACH25SCENEOBJINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6AED0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int Mach25ObjectInstancing_Mach25SceneObjInfo_TypeDefinitionIndex = 28895;
