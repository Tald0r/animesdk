...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19247F40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19247D20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x19247FA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x19248170)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapShadowLodProxy_TypeDefinitionIndex = 28975;
