...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1966C620)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1966C400)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY_UPDATELODINFO_OFFSET UNITYSDK_OFFSET(0x1966C680)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPSHADOWLODPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1966C850)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapShadowLodProxy_TypeDefinitionIndex = 29926;
