...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_FSR3PERSISTENTDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0x18915E30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_FSR3PERSISTENTDATA_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x18915E70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_FSR3PERSISTENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18915EE0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PostProcessPass_FSR3PersistentData_TypeDefinitionIndex = 29999;
