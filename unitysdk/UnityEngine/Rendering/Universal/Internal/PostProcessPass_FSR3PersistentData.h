...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_FSR3PERSISTENTDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0x183BA1A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_FSR3PERSISTENTDATA_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x183BA1E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_FSR3PERSISTENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x183BA250)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PostProcessPass_FSR3PersistentData_TypeDefinitionIndex = 29046;
