...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_CLEAR_OFFSET UNITYSDK_OFFSET(0x1763D840)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1763D7B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1763D700)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_GET_NUMRESULTS_OFFSET UNITYSDK_OFFSET(0x1763D6E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_GET_RESULTINDICES_OFFSET UNITYSDK_OFFSET(0x1763D6F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET_QUERYINDICES_OFFSET UNITYSDK_OFFSET(0x1763D890)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLRESULT_SET__CTOR_OFFSET UNITYSDK_OFFSET(0x1763D930)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_CullResult_Set_TypeDefinitionIndex = 29820;
