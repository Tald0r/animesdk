...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_CALCULATECENTER_OFFSET UNITYSDK_OFFSET(0x81D480)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_CALCULATEEXTENT_OFFSET UNITYSDK_OFFSET(0x81D520)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_CALCULATESIZE_OFFSET UNITYSDK_OFFSET(0x81D5C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_EXPAND_1_OFFSET UNITYSDK_OFFSET(0x81D660)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_EXPAND_OFFSET UNITYSDK_OFFSET(0x81D650)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_INIT_OFFSET UNITYSDK_OFFSET(0x81D410)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_INTERSECT_OFFSET UNITYSDK_OFFSET(0x81D700)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_ISVALID_OFFSET UNITYSDK_OFFSET(0x81D6F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB_OVERLAP_OFFSET UNITYSDK_OFFSET(0x81D790)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB__CTOR_1_OFFSET UNITYSDK_OFFSET(0x81D370)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB__CTOR_2_OFFSET UNITYSDK_OFFSET(0x81D390)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB__CTOR_3_OFFSET UNITYSDK_OFFSET(0x81D3D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MINMAXAABB__CTOR_OFFSET UNITYSDK_OFFSET(0x3889A0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_MinMaxAABB_TypeDefinitionIndex = 29946;
