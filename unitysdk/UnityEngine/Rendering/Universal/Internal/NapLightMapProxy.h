...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16F6B270)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPPROXY_SETLIGHTMAPDATA_OFFSET UNITYSDK_OFFSET(0x16F6B0C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x16F6B2C0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapLightMapProxy_TypeDefinitionIndex = 28910;
