...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER_DRAWBOIDMESH_OFFSET UNITYSDK_OFFSET(0x1777EC10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER_PREPAREBOIDBUFFER_OFFSET UNITYSDK_OFFSET(0x1777E7F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x1777E690)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1777E740)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1777EEB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1777EEA0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int GpuBoidRendererManager_TypeDefinitionIndex = 29909;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::GpuBoidManager*>**)Il2CppClass::FromTypeDefinitionIndex(GpuBoidRendererManager_TypeDefinitionIndex)->GetStaticField(0x22140);
		}
