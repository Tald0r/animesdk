...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER_DRAWBOIDMESH_OFFSET UNITYSDK_OFFSET(0x17956EF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER_PREPAREBOIDBUFFER_OFFSET UNITYSDK_OFFSET(0x17956AD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x17956970)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x17956A20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17957190)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_GPUBOIDRENDERERMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x17957180)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int GpuBoidRendererManager_TypeDefinitionIndex = 28958;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::GpuBoidManager*>**)Il2CppClass::FromTypeDefinitionIndex(GpuBoidRendererManager_TypeDefinitionIndex)->GetStaticField(0x20AD0);
		}
