...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR_OFFPREVIEWCOMBINE_OFFSET UNITYSDK_OFFSET(0x182D7CE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR_OFFPREVIEW_OFFSET UNITYSDK_OFFSET(0x182D7BF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x182D7AD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x182D79A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR_PREVIEWBAKE_OFFSET UNITYSDK_OFFSET(0x182D7B70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR_PREVIEWCOMBINE_OFFSET UNITYSDK_OFFSET(0x182D7C70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_COMBINEDDECALPROJECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x182D7D50)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int CombinedDecalProjector_TypeDefinitionIndex = 29805;
