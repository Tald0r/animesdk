...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETINT_OFFSET UNITYSDK_OFFSET(0x18397B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x18397C70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x18397C00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x18397D60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x18397CE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18397B80)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_MaterialPropertyBlockSetter_TypeDefinitionIndex = 28999;
