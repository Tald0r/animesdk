...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETINT_OFFSET UNITYSDK_OFFSET(0x189EE210)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x189EE2F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x189EE280)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x189EE3E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x189EE360)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_MATERIALPROPERTYBLOCKSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x189EE200)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_MaterialPropertyBlockSetter_TypeDefinitionIndex = 29950;
