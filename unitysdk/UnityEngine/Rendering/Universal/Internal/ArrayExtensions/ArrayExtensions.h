...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_ARRAYEXTENSIONS_ARRAYEXTENSIONS_FOREACH_OFFSET UNITYSDK_OFFSET(0x196E5B20)

namespace UnityEngine::Rendering::Universal::Internal::ArrayExtensions
{
	inline static constexpr unsigned int ArrayExtensions_TypeDefinitionIndex = 29071;
