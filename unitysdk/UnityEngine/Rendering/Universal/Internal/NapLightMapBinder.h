...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19B6B1B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19B6AFA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER_SETLIGHTMAPDATA_OFFSET UNITYSDK_OFFSET(0x19B6AE00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B6B2F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6B2D0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapLightMapBinder_TypeDefinitionIndex = 29850;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NapLightMapBinder_TypeDefinitionIndex)->GetStaticField(0x64C0);
		}
