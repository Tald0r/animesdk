...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x196EE820)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x196EE610)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER_SETLIGHTMAPDATA_OFFSET UNITYSDK_OFFSET(0x196EE470)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x196EE960)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPBINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x196EE940)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapLightMapBinder_TypeDefinitionIndex = 28900;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NapLightMapBinder_TypeDefinitionIndex)->GetStaticField(0x6070);
		}
