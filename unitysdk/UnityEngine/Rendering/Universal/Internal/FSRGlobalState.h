...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FSRGLOBALSTATE_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x19B62620)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FSRGLOBALSTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B62670)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FSRGLOBALSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19B62660)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FSRGlobalState_TypeDefinitionIndex = 29799;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::FSRContext*)Il2CppClass::FromTypeDefinitionIndex(FSRGlobalState_TypeDefinitionIndex)->GetStaticField(0x61A0);
		}
