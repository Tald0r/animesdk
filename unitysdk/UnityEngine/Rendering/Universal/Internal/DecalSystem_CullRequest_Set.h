...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_CLEAR_OFFSET UNITYSDK_OFFSET(0x1865DA40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1865D900)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1865D8B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_GET_CULLINGGROUP_OFFSET UNITYSDK_OFFSET(0x1865D8A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1865DB20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET__CTOR_OFFSET UNITYSDK_OFFSET(0x1865DB80)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_CullRequest_Set_TypeDefinitionIndex = 29822;
