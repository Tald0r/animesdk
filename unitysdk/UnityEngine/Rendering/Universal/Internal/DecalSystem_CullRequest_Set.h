...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_CLEAR_OFFSET UNITYSDK_OFFSET(0x1803BC80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1803BB40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1803BAF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_GET_CULLINGGROUP_OFFSET UNITYSDK_OFFSET(0x1803BAE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1803BD60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_CULLREQUEST_SET__CTOR_OFFSET UNITYSDK_OFFSET(0x1803BDC0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_CullRequest_Set_TypeDefinitionIndex = 28872;
