...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x185D3FA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_DECALSYSTEM_DECALHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x185D3F50)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int DecalSystem_DecalHandle_TypeDefinitionIndex = 28873;
