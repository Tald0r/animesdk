...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_VISIBLELIGHTEXTENSIONMETHODS_GETFORWARD_OFFSET UNITYSDK_OFFSET(0x17820C90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_VISIBLELIGHTEXTENSIONMETHODS_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x17820B80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_VISIBLELIGHTEXTENSIONMETHODS_GETRIGHT_OFFSET UNITYSDK_OFFSET(0x17820EB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_VISIBLELIGHTEXTENSIONMETHODS_GETUP_OFFSET UNITYSDK_OFFSET(0x17820DA0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int VisibleLightExtensionMethods_TypeDefinitionIndex = 29846;
