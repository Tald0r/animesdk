...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_WATERINTERACTIONPASS_ALLOCATERESOURCE_OFFSET UNITYSDK_OFFSET(0x187C76E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_WATERINTERACTIONPASS_CHECKALLOCATETEXTURE_OFFSET UNITYSDK_OFFSET(0x187CD3A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_WATERINTERACTIONPASS_CLEANUP_1_OFFSET UNITYSDK_OFFSET(0x187CD310)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_WATERINTERACTIONPASS_CLEANUP_OFFSET UNITYSDK_OFFSET(0x187CD250)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_WATERINTERACTIONPASS_CLEARRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x187C7A50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_WATERINTERACTIONPASS_DRAWINTERACTIVEOBJECTTODEPTH_OFFSET UNITYSDK_OFFSET(0x187C7BB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_WATERINTERACTIONPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x187C80E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_WATERINTERACTIONPASS_MARKDEPTHTEXTUREDIRTY_OFFSET UNITYSDK_OFFSET(0x187C74B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_WATERINTERACTIONPASS_RESETHEIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x187C7610)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_WATERINTERACTIONPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x187C7B50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_WATERINTERACTIONPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x187CD6F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_WATERINTERACTIONPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x187C7530)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int WaterInteractionPass_TypeDefinitionIndex = 29060;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(WaterInteractionPass_TypeDefinitionIndex)->GetStaticField(0x223B0);
		}
		static ::System::Boolean* StaticGet_s_DepthTextureDirty()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(WaterInteractionPass_TypeDefinitionIndex)->GetStaticField(0x6DA0);
		}
		...
		::UnityEngine::ComputeShader* m_SetupWaterHeightCS; // 0xB0
		::System::String* m_ProfilerTag; // 0xB8
		::UnityEngine::RenderTexture* m_TempWaterHeightMap; // 0xC0
		::UnityEngine::MaterialPropertyBlock* dynamicObjectProperty; // 0xC8
		::UnityEngine::Rendering::Universal::Internal::WaterInteractionPass_WaterDepthHistoryBuffer* m_DepthHistory; // 0xD0
		::UnityEngine::RenderTexture* m_CurrentWaterHeightMap; // 0xD8
		::UnityEngine::RenderTexture* m_PreviousWaterHeightMap; // 0xE0
		::UnityEngine::MaterialPropertyBlock* staticObjectProperty; // 0xE8
		::UnityEngine::Rendering::Universal::Internal::WaterInteractionPass_GlobalHistoryBufferDatas* m_HistoryBufferDatas; // 0xF0
		::UnityEngine::RenderTexture* m_DynamicDepthTexture; // 0xF8
		::UnityEngine::RenderTexture* m_PrePreviousWaterHeightMap; // 0x100
		::UnityEngine::ComputeShader* m_WaterInteractCS; // 0x108
		::UnityEngine::RenderTexture* m_StaticDepthTexture; // 0x110
		::UnityEngine::RenderTexture* m_WaterInteractionObjectDepthTexture; // 0x118
		::System::Single m_TimeUpdate; // 0x120
		::System::Boolean bAllocated; // 0x124
		::System::Boolean m_StaticBoundaryInitialized; // 0x125
		::System::Boolean m_IsFirstFrame; // 0x126
