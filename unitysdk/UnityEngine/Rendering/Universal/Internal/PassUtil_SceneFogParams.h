...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_PASSUTIL_SCENEFOGPARAMS_FLUSH_OFFSET UNITYSDK_OFFSET(0x904DE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_PASSUTIL_SCENEFOGPARAMS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FB3150)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PassUtil_SceneFogParams_TypeDefinitionIndex = 29041;

	struct alignas(4) PassUtil_SceneFogParams
	{
		static ::UnityEngine::Matrix4x4* StaticGet__SceneFogParamsPart1()
		{
			return (::UnityEngine::Matrix4x4*)Il2CppClass::FromTypeDefinitionIndex(PassUtil_SceneFogParams_TypeDefinitionIndex)->GetStaticField(0x6F50);
		}
		static ::UnityEngine::Matrix4x4* StaticGet__SceneFogParamsPart3()
		{
			return (::UnityEngine::Matrix4x4*)Il2CppClass::FromTypeDefinitionIndex(PassUtil_SceneFogParams_TypeDefinitionIndex)->GetStaticField(0x6F90);
		}
		static ::UnityEngine::Matrix4x4* StaticGet__SceneFogParamsPart2()
		{
			return (::UnityEngine::Matrix4x4*)Il2CppClass::FromTypeDefinitionIndex(PassUtil_SceneFogParams_TypeDefinitionIndex)->GetStaticField(0x6FD0);
		}
