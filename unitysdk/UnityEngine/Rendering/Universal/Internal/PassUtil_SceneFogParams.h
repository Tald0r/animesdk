...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_PASSUTIL_SCENEFOGPARAMS_FLUSH_OFFSET UNITYSDK_OFFSET(0x91F860)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_PASSUTIL_SCENEFOGPARAMS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2EDA90)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PassUtil_SceneFogParams_TypeDefinitionIndex = 29992;

	struct alignas(4) PassUtil_SceneFogParams
	{
		static ::UnityEngine::Matrix4x4* StaticGet__SceneFogParamsPart2()
		{
			return (::UnityEngine::Matrix4x4*)Il2CppClass::FromTypeDefinitionIndex(PassUtil_SceneFogParams_TypeDefinitionIndex)->GetStaticField(0x7760);
		}
		static ::UnityEngine::Matrix4x4* StaticGet__SceneFogParamsPart3()
		{
			return (::UnityEngine::Matrix4x4*)Il2CppClass::FromTypeDefinitionIndex(PassUtil_SceneFogParams_TypeDefinitionIndex)->GetStaticField(0x77A0);
		}
		static ::UnityEngine::Matrix4x4* StaticGet__SceneFogParamsPart1()
		{
			return (::UnityEngine::Matrix4x4*)Il2CppClass::FromTypeDefinitionIndex(PassUtil_SceneFogParams_TypeDefinitionIndex)->GetStaticField(0x77E0);
		}
