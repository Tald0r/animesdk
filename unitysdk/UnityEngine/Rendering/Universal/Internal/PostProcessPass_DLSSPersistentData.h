...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_DLSSPERSISTENTDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0x17783E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_DLSSPERSISTENTDATA_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x17783F40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_DLSSPERSISTENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x177840E0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PostProcessPass_DLSSPersistentData_TypeDefinitionIndex = 29998;
