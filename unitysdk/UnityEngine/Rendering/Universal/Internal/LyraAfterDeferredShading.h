...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRAAFTERDEFERREDSHADING_EXECUTE_OFFSET UNITYSDK_OFFSET(0x17B73960)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRAAFTERDEFERREDSHADING_SETUP_OFFSET UNITYSDK_OFFSET(0x17B73900)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRAAFTERDEFERREDSHADING__CTOR_OFFSET UNITYSDK_OFFSET(0x17B73870)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraAfterDeferredShading_TypeDefinitionIndex = 29023;
