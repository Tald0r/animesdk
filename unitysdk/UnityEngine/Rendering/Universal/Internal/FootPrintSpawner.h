...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_CLEARFOOTPRINTDATA_OFFSET UNITYSDK_OFFSET(0x17953960)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_GENERATEWHEELMESH_OFFSET UNITYSDK_OFFSET(0x17955690)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_GET_INSTANCEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x17953600)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_GET_MATERIALPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x17953610)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_INITWHEELDATA_OFFSET UNITYSDK_OFFSET(0x17953DC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17953BE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x17954520)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17953AF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x17953D30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_REMOVEWHEELDATA_OFFSET UNITYSDK_OFFSET(0x179539B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_RESETWHEELDATAARRAY_OFFSET UNITYSDK_OFFSET(0x17955580)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_SETREADYTOSPAWN_OFFSET UNITYSDK_OFFSET(0x17953630)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_SET_MATERIALPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x17953620)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_SPAWN_OFFSET UNITYSDK_OFFSET(0x17954040)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_TICKFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x17954A70)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_TICKWHEELPRINT_OFFSET UNITYSDK_OFFSET(0x17955210)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x17956810)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintSpawner_TypeDefinitionIndex = 29020;
