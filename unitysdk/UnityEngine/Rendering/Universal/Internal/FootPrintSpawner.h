...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_CLEARFOOTPRINTDATA_OFFSET UNITYSDK_OFFSET(0x1777B680)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_GENERATEWHEELMESH_OFFSET UNITYSDK_OFFSET(0x1777D3B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_GET_INSTANCEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1777B320)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_GET_MATERIALPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1777B330)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_INITWHEELDATA_OFFSET UNITYSDK_OFFSET(0x1777BAE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1777B900)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1777C240)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1777B810)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1777BA50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_REMOVEWHEELDATA_OFFSET UNITYSDK_OFFSET(0x1777B6D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_RESETWHEELDATAARRAY_OFFSET UNITYSDK_OFFSET(0x1777D2A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_SETREADYTOSPAWN_OFFSET UNITYSDK_OFFSET(0x1777B350)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_SET_MATERIALPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x1777B340)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_SPAWN_OFFSET UNITYSDK_OFFSET(0x1777BD60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_TICKFOOTPRINT_OFFSET UNITYSDK_OFFSET(0x1777C790)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER_TICKWHEELPRINT_OFFSET UNITYSDK_OFFSET(0x1777CF30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FOOTPRINTSPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1777E530)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FootPrintSpawner_TypeDefinitionIndex = 29971;
