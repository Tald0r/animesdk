...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETINT_OFFSET UNITYSDK_OFFSET(0x16DBE930)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x16DBEAD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x16DBE9A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x16DBEC80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x16DBEC00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DBCFE0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_ComputeShaderSetter_TypeDefinitionIndex = 28997;
