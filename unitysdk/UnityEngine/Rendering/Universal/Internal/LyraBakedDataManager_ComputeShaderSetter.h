...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETINT_OFFSET UNITYSDK_OFFSET(0x17425220)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x174253C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x17425290)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x17425570)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x174254F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_LYRABAKEDDATAMANAGER_COMPUTESHADERSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x174238D0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int LyraBakedDataManager_ComputeShaderSetter_TypeDefinitionIndex = 29948;
