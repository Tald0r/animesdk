...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ADDTEXTURE_OFFSET UNITYSDK_OFFSET(0x1803F850)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ALLOCATETEXTUREWITHOUTBLIT_1_OFFSET UNITYSDK_OFFSET(0x1803F210)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ALLOCATETEXTUREWITHOUTBLIT_OFFSET UNITYSDK_OFFSET(0x1803F0C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ALLOCATETEXTURE_OFFSET UNITYSDK_OFFSET(0x1803ED30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_BLIT2DTEXTURE_OFFSET UNITYSDK_OFFSET(0x1803E850)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_BLITTEXTURE_OFFSET UNITYSDK_OFFSET(0x1803EBB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_CLEARTARGET_OFFSET UNITYSDK_OFFSET(0x1803E4E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_GETTEXTUREMIPMAPCOUNT_OFFSET UNITYSDK_OFFSET(0x1803E270)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_GET_ATLASTEXTURE_OFFSET UNITYSDK_OFFSET(0x1803DE00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_IS2D_OFFSET UNITYSDK_OFFSET(0x1803E7B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ISCACHED_OFFSET UNITYSDK_OFFSET(0x1803F3D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_MARKGPUTEXTUREINVALID_OFFSET UNITYSDK_OFFSET(0x1803EB50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_MARKGPUTEXTUREVALID_OFFSET UNITYSDK_OFFSET(0x1803EAE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_NEEDSUPDATE_OFFSET UNITYSDK_OFFSET(0x1803F550)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_RELEASE_OFFSET UNITYSDK_OFFSET(0x1803E320)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_RESETALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1803E3B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_UPDATETEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1803FCA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_UPDATETEXTURE_OFFSET UNITYSDK_OFFSET(0x1803F9C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1803FDC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1803DE10)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int Texture2DAtlas_TypeDefinitionIndex = 29068;
	...
	public:
		...
		{
			return (::UnityEngine::Vector4*)Il2CppClass::FromTypeDefinitionIndex(Texture2DAtlas_TypeDefinitionIndex)->GetStaticField(0x6ED0);
		}
		static ::System::Int32* StaticGet_maxMipLevelPadding()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Texture2DAtlas_TypeDefinitionIndex)->GetStaticField(0x6EE0);
		}
		::UnityEngine::Rendering::Universal::Internal::AtlasAllocator* m_AtlasAllocator; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::Vector4>* m_AllocationCache; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::UInt32>* m_IsGPUTextureUpToDate; // 0x20
		::UnityEngine::RenderTexture* m_AtlasTexture; // 0x28
		::System::Int32 m_Height; // 0x30
		::System::Boolean m_UseMipMaps; // 0x34
