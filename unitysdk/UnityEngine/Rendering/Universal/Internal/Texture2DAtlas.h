...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ADDTEXTURE_OFFSET UNITYSDK_OFFSET(0x186618D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ALLOCATETEXTUREWITHOUTBLIT_1_OFFSET UNITYSDK_OFFSET(0x18661290)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ALLOCATETEXTUREWITHOUTBLIT_OFFSET UNITYSDK_OFFSET(0x18661140)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ALLOCATETEXTURE_OFFSET UNITYSDK_OFFSET(0x18660DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_BLIT2DTEXTURE_OFFSET UNITYSDK_OFFSET(0x186608D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_BLITTEXTURE_OFFSET UNITYSDK_OFFSET(0x18660C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_CLEARTARGET_OFFSET UNITYSDK_OFFSET(0x18660560)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_GETTEXTUREMIPMAPCOUNT_OFFSET UNITYSDK_OFFSET(0x186602F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_GET_ATLASTEXTURE_OFFSET UNITYSDK_OFFSET(0x1865FE80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_IS2D_OFFSET UNITYSDK_OFFSET(0x18660830)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_ISCACHED_OFFSET UNITYSDK_OFFSET(0x18661450)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_MARKGPUTEXTUREINVALID_OFFSET UNITYSDK_OFFSET(0x18660BD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_MARKGPUTEXTUREVALID_OFFSET UNITYSDK_OFFSET(0x18660B60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_NEEDSUPDATE_OFFSET UNITYSDK_OFFSET(0x186615D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_RELEASE_OFFSET UNITYSDK_OFFSET(0x186603A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_RESETALLOCATOR_OFFSET UNITYSDK_OFFSET(0x18660430)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_UPDATETEXTURE_1_OFFSET UNITYSDK_OFFSET(0x18661D20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS_UPDATETEXTURE_OFFSET UNITYSDK_OFFSET(0x18661A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS__CCTOR_OFFSET UNITYSDK_OFFSET(0x18661E40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_TEXTURE2DATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1865FE90)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int Texture2DAtlas_TypeDefinitionIndex = 30021;
	...
	public:
		...
		{
			return (::UnityEngine::Vector4*)Il2CppClass::FromTypeDefinitionIndex(Texture2DAtlas_TypeDefinitionIndex)->GetStaticField(0x7620);
		}
		static ::System::Int32* StaticGet_maxMipLevelPadding()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Texture2DAtlas_TypeDefinitionIndex)->GetStaticField(0x7630);
		}
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::UInt32>* m_IsGPUTextureUpToDate; // 0x28
