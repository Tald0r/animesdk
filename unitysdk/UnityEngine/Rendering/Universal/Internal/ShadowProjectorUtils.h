...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETBOUNDSBACKCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x182DD640)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETCORNERSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x182DC040)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETENCAPSULATEDBOUNDSINSPACE_1_OFFSET UNITYSDK_OFFSET(0x182DC3A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETENCAPSULATEDBOUNDSINSPACE_OFFSET UNITYSDK_OFFSET(0x182DC210)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETOBJECTBOUNDSINWORLDSPACE_OFFSET UNITYSDK_OFFSET(0x182DBD20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETSHADOWVIEWTOCLIPMATRIX_OFFSET UNITYSDK_OFFSET(0x182DD6F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETWORLDTOSHADOWVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x182DD320)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_MAKEMAX_OFFSET UNITYSDK_OFFSET(0x182DD2B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_MAKEMIN_OFFSET UNITYSDK_OFFSET(0x182DD240)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_UPDATESLICEDATA_BEFORECULLING_OFFSET UNITYSDK_OFFSET(0x182DDCE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_UPDATESLICEDATA_PREPARERESOLVEDATA_OFFSET UNITYSDK_OFFSET(0x182DD830)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_UPDATESLICEDATA_RETRIEVESCENEDATA_OFFSET UNITYSDK_OFFSET(0x182DDC30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x182DE300)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x182DE2F0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int ShadowProjectorUtils_TypeDefinitionIndex = 29840;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(ShadowProjectorUtils_TypeDefinitionIndex)->GetStaticField(0x23CA0);
		}
		static ::Il2CppArray<::UnityEngine::Plane>** StaticGet_globalCameraFrustumPlanes()
		{
			return (::Il2CppArray<::UnityEngine::Plane>**)Il2CppClass::FromTypeDefinitionIndex(ShadowProjectorUtils_TypeDefinitionIndex)->GetStaticField(0x23CA8);
		}
