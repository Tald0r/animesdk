...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETBOUNDSBACKCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x17BF52D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETCORNERSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x17BF3CD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETENCAPSULATEDBOUNDSINSPACE_1_OFFSET UNITYSDK_OFFSET(0x17BF4030)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETENCAPSULATEDBOUNDSINSPACE_OFFSET UNITYSDK_OFFSET(0x17BF3EA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETOBJECTBOUNDSINWORLDSPACE_OFFSET UNITYSDK_OFFSET(0x17BF39B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETSHADOWVIEWTOCLIPMATRIX_OFFSET UNITYSDK_OFFSET(0x17BF5380)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_GETWORLDTOSHADOWVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x17BF4FB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_MAKEMAX_OFFSET UNITYSDK_OFFSET(0x17BF4F40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_MAKEMIN_OFFSET UNITYSDK_OFFSET(0x17BF4ED0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_UPDATESLICEDATA_BEFORECULLING_OFFSET UNITYSDK_OFFSET(0x17BF5970)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_UPDATESLICEDATA_PREPARERESOLVEDATA_OFFSET UNITYSDK_OFFSET(0x17BF54C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS_UPDATESLICEDATA_RETRIEVESCENEDATA_OFFSET UNITYSDK_OFFSET(0x17BF58C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x17BF5F90)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SHADOWPROJECTORUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x17BF5F80)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int ShadowProjectorUtils_TypeDefinitionIndex = 28890;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Plane>**)Il2CppClass::FromTypeDefinitionIndex(ShadowProjectorUtils_TypeDefinitionIndex)->GetStaticField(0x22260);
		}
		static ::Il2CppArray<::UnityEngine::Vector3>** StaticGet_globalTempCubeCorners()
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(ShadowProjectorUtils_TypeDefinitionIndex)->GetStaticField(0x22268);
		}
