...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_COPYFIELDS_OFFSET UNITYSDK_OFFSET(0x19B6BB60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_COPY_1_OFFSET UNITYSDK_OFFSET(0x19B6B810)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_COPY_OFFSET UNITYSDK_OFFSET(0x19B6B3B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_INTERNALCOPY_1_OFFSET UNITYSDK_OFFSET(0x19B6B910)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_INTERNALCOPY_OFFSET UNITYSDK_OFFSET(0x19B6B4B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_ISPRIMITIVE_OFFSET UNITYSDK_OFFSET(0x19B6B310)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_RECURSIVECOPYBASETYPEPRIVATEFIELDS_OFFSET UNITYSDK_OFFSET(0x19B6BE60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B6C030)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int ObjectExtensions_TypeDefinitionIndex = 29841;
	...
	public:
		...
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(ObjectExtensions_TypeDefinitionIndex)->GetStaticField(0x22F80);
		}
