...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_COPYFIELDS_OFFSET UNITYSDK_OFFSET(0x196EF1D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_COPY_1_OFFSET UNITYSDK_OFFSET(0x196EEE80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_COPY_OFFSET UNITYSDK_OFFSET(0x196EEA20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_INTERNALCOPY_1_OFFSET UNITYSDK_OFFSET(0x196EEF80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_INTERNALCOPY_OFFSET UNITYSDK_OFFSET(0x196EEB20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_ISPRIMITIVE_OFFSET UNITYSDK_OFFSET(0x196EE980)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS_RECURSIVECOPYBASETYPEPRIVATEFIELDS_OFFSET UNITYSDK_OFFSET(0x196EF4D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_OBJECTEXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x196EF6A0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int ObjectExtensions_TypeDefinitionIndex = 28891;
	...
	public:
		...
		{
			return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(ObjectExtensions_TypeDefinitionIndex)->GetStaticField(0x21640);
		}
