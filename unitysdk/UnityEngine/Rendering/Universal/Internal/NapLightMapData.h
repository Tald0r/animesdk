...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_GETLOADEDSCENE_OFFSET UNITYSDK_OFFSET(0x18398960)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x18398A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x18398A00)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18398770)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_REGISTERDYNAMICLOADEDTEXTURE_OFFSET UNITYSDK_OFFSET(0x18398620)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18398A80)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapLightMapData_TypeDefinitionIndex = 28907;
