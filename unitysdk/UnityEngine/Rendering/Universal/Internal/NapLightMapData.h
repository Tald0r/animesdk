...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_GETLOADEDSCENE_OFFSET UNITYSDK_OFFSET(0x189EEFE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x189EF0C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x189EF080)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x189EEDF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA_REGISTERDYNAMICLOADEDTEXTURE_OFFSET UNITYSDK_OFFSET(0x189EECA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_NAPLIGHTMAPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x189EF100)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int NapLightMapData_TypeDefinitionIndex = 29857;
