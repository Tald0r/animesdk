...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTFLICKFREQUENCY_OFFSET UNITYSDK_OFFSET(0x3281B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTINTENSITY_OFFSET UNITYSDK_OFFSET(0x79E810)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTUREOVERLAY_OFFSET UNITYSDK_OFFSET(0x2FC120)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTUREOVERLAY_ST_OFFSET UNITYSDK_OFFSET(0x79E800)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0x2C6220)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTURE_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTURE_ST_OFFSET UNITYSDK_OFFSET(0x510240)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_ISDIRTTEXTUREVALID_OFFSET UNITYSDK_OFFSET(0x79E820)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x79E840)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x79E830)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PostProcessPass_LensDirtParams_TypeDefinitionIndex = 29047;
