...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTFLICKFREQUENCY_OFFSET UNITYSDK_OFFSET(0x35A630)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTINTENSITY_OFFSET UNITYSDK_OFFSET(0x7D6540)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTUREOVERLAY_OFFSET UNITYSDK_OFFSET(0x2F2E20)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTUREOVERLAY_ST_OFFSET UNITYSDK_OFFSET(0x7D6530)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTURESIZE_OFFSET UNITYSDK_OFFSET(0x302AC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTURE_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_DIRTTEXTURE_ST_OFFSET UNITYSDK_OFFSET(0x547860)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS_GET_ISDIRTTEXTUREVALID_OFFSET UNITYSDK_OFFSET(0x7D6550)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7D6570)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_POSTPROCESSPASS_LENSDIRTPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x7D6560)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int PostProcessPass_LensDirtParams_TypeDefinitionIndex = 30000;
