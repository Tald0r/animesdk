...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x18D23280)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_CLEARSCENEPROXYPOOL_OFFSET UNITYSDK_OFFSET(0x18D21100)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_GET_CODECONTROLEDEMISSIONINTENSITY_OFFSET UNITYSDK_OFFSET(0x18D21340)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_INITVALUE_OFFSET UNITYSDK_OFFSET(0x18D233F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_LERP_OFFSET UNITYSDK_OFFSET(0x18D21410)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_LIGHTTRIGGERTYPETOMASK_OFFSET UNITYSDK_OFFSET(0x18D22EB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18D22280)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_ONLIGHTTRIGGERDISABLE_OFFSET UNITYSDK_OFFSET(0x18D224F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_ONLIGHTTRIGGERENABLE_OFFSET UNITYSDK_OFFSET(0x18D22060)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_ONWEATHERTRIGGERDESTROY_OFFSET UNITYSDK_OFFSET(0x18D22840)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_ONWITHERTRIGGERENABLE_OFFSET UNITYSDK_OFFSET(0x18D22B30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_PLAYALLANIM_OFFSET UNITYSDK_OFFSET(0x18D25700)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_PLAYANIMATION_OFFSET UNITYSDK_OFFSET(0x18D22F10)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x18D254A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_REBINDCHILD_OFFSET UNITYSDK_OFFSET(0x18D22BD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_REGISTERANIMATIONCURVE_OFFSET UNITYSDK_OFFSET(0x18D25190)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_REGISTERTOSCENEPROXYMATERIALPOOL_OFFSET UNITYSDK_OFFSET(0x18D20B80)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_SETLIGHTTRIGGERTYPE_OFFSET UNITYSDK_OFFSET(0x18D22CD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_SET_CODECONTROLEDEMISSIONINTENSITY_OFFSET UNITYSDK_OFFSET(0x18D21350)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_SHOWORHIDEWEATHERTRIGGER_OFFSET UNITYSDK_OFFSET(0x18D23170)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_START_OFFSET UNITYSDK_OFFSET(0x18D22010)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_STOPANIMIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x18D228E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_STOPANIM_OFFSET UNITYSDK_OFFSET(0x18D25A60)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_TRIGGERLIGHTOFF_OFFSET UNITYSDK_OFFSET(0x18D25C40)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_TRIGGERLIGHTON_OFFSET UNITYSDK_OFFSET(0x18D25BC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_TRIGGERLIGHT_OFFSET UNITYSDK_OFFSET(0x18D25370)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_TRIGGERSPARK_OFFSET UNITYSDK_OFFSET(0x18D24E50)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY_UPDATEBUILDINGBOTLIGHT_OFFSET UNITYSDK_OFFSET(0x18D24970)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY__CCTOR_OFFSET UNITYSDK_OFFSET(0x18D25DC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_SCENEOBJECTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x18D25CD0)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int SceneObjectProxy_TypeDefinitionIndex = 29894;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Rendering::Universal::Internal::SceneObjectProxy*>**)Il2CppClass::FromTypeDefinitionIndex(SceneObjectProxy_TypeDefinitionIndex)->GetStaticField(0x23DA0);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Material*, ::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::Material*>*>**)Il2CppClass::FromTypeDefinitionIndex(SceneObjectProxy_TypeDefinitionIndex)->GetStaticField(0x23DA8);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Rendering::Universal::Internal::SceneObjectProxy*, ::UnityEngine::Rendering::Universal::Internal::SceneObjectProxy_LightAnimation*>**)Il2CppClass::FromTypeDefinitionIndex(SceneObjectProxy_TypeDefinitionIndex)->GetStaticField(0x23DB0);
		}
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::ObjectPool_1<::UnityEngine::Rendering::Universal::Internal::SceneObjectProxy_LightAnimation*>**)Il2CppClass::FromTypeDefinitionIndex(SceneObjectProxy_TypeDefinitionIndex)->GetStaticField(0x23DB8);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Material*>** StaticGet_s_NewCreatedMaterialForPool()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(SceneObjectProxy_TypeDefinitionIndex)->GetStaticField(0x23DC0);
		}
		static ::System::Boolean* StaticGet_canUsePool()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SceneObjectProxy_TypeDefinitionIndex)->GetStaticField(0x74E0);
		}
