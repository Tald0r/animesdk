...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED_AFMESETFRAMEINFO_OFFSET UNITYSDK_OFFSET(0x19669610)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED_EXECUTE_OFFSET UNITYSDK_OFFSET(0x196696F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED_MFRCSETINPUTTEXTURES_OFFSET UNITYSDK_OFFSET(0x19669680)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x19669560)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FrameEstimateInfoPass_Managed_TypeDefinitionIndex = 29973;
