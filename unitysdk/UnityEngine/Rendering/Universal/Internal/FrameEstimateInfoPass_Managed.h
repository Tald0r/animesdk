...
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED_AFMESETFRAMEINFO_OFFSET UNITYSDK_OFFSET(0x19244EC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19244FA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED_MFRCSETINPUTTEXTURES_OFFSET UNITYSDK_OFFSET(0x19244F30)
#define UNITYENGINE_RENDERING_UNIVERSAL_INTERNAL_FRAMEESTIMATEINFOPASS_MANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x19244E10)

namespace UnityEngine::Rendering::Universal::Internal
{
	inline static constexpr unsigned int FrameEstimateInfoPass_Managed_TypeDefinitionIndex = 29022;
