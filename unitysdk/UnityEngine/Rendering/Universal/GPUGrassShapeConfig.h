...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_CLEARINSTANCEMATERIAL_OFFSET UNITYSDK_OFFSET(0x196E5010)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_GETCURRENTMESH_OFFSET UNITYSDK_OFFSET(0x196E51D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_GET_MATERIALFORLOD1_OFFSET UNITYSDK_OFFSET(0x196E4E70)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_GET_MATERIALFORLOD2_OFFSET UNITYSDK_OFFSET(0x196E4F40)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_GET_MATERIALWITHDITHERON_OFFSET UNITYSDK_OFFSET(0x196E4D60)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG_INITLOD_OFFSET UNITYSDK_OFFSET(0x196E50B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSSHAPECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x196E5240)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassShapeConfig_TypeDefinitionIndex = 28769;
