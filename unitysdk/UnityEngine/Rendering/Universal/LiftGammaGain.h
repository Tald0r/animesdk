...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIFTGAMMAGAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x196EFCC0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LiftGammaGain_TypeDefinitionIndex = 28659;
