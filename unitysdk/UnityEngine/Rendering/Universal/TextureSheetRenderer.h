...
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_CLEAR_OFFSET UNITYSDK_OFFSET(0x16FA8230)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x16FA71B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_GET_M_SHEETCONFIG_OFFSET UNITYSDK_OFFSET(0x16FA5BE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_IGNORESETFXCONFIGS_OFFSET UNITYSDK_OFFSET(0x16FA71C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16FA6A30)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16FA6C80)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16FA5C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_PAUSE_OFFSET UNITYSDK_OFFSET(0x16FA7090)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_PLAY_OFFSET UNITYSDK_OFFSET(0x16FA6490)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_REFRESHORDER_OFFSET UNITYSDK_OFFSET(0x16FA6D40)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_RESUME_OFFSET UNITYSDK_OFFSET(0x16FA70E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_SETFXCONFIGS_OFFSET UNITYSDK_OFFSET(0x16FA72D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_SETORDER_OFFSET UNITYSDK_OFFSET(0x16FA6CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_SETSPRITERENDER_OFFSET UNITYSDK_OFFSET(0x16FA5DF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_SETTEXTUREANDTILES_OFFSET UNITYSDK_OFFSET(0x16FA6E20)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_STOP_OFFSET UNITYSDK_OFFSET(0x16FA7130)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_TICK_OFFSET UNITYSDK_OFFSET(0x16FA6560)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16FA6510)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA8390)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int TextureSheetRenderer_TypeDefinitionIndex = 28437;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(TextureSheetRenderer_TypeDefinitionIndex)->GetStaticField(0x22740);
		}
