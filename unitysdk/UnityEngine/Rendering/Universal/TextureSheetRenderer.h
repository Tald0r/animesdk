...
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1767A630)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_GET_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x176795B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_GET_M_SHEETCONFIG_OFFSET UNITYSDK_OFFSET(0x17677FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_IGNORESETFXCONFIGS_OFFSET UNITYSDK_OFFSET(0x176795C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17678E10)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17679060)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17678010)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_PAUSE_OFFSET UNITYSDK_OFFSET(0x17679490)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_PLAY_OFFSET UNITYSDK_OFFSET(0x17678870)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_REFRESHORDER_OFFSET UNITYSDK_OFFSET(0x17679120)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_RESUME_OFFSET UNITYSDK_OFFSET(0x176794E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_SETFXCONFIGS_OFFSET UNITYSDK_OFFSET(0x176796D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_SETORDER_OFFSET UNITYSDK_OFFSET(0x176790D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_SETSPRITERENDER_OFFSET UNITYSDK_OFFSET(0x176781D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_SETTEXTUREANDTILES_OFFSET UNITYSDK_OFFSET(0x17679200)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_STOP_OFFSET UNITYSDK_OFFSET(0x17679530)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_TICK_OFFSET UNITYSDK_OFFSET(0x17678940)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER_UPDATE_OFFSET UNITYSDK_OFFSET(0x176788F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1767A790)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int TextureSheetRenderer_TypeDefinitionIndex = 29380;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(TextureSheetRenderer_TypeDefinitionIndex)->GetStaticField(0x238F0);
		}
