...
#define UNITYENGINE_RENDERING_UNIVERSAL_MONSTERIGNISFATUUS__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6D0A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MonsterIgnisFatuus_TypeDefinitionIndex = 29609;
