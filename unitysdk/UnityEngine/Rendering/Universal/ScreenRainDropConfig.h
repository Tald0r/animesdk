...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENRAINDROPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17969280)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScreenRainDropConfig_TypeDefinitionIndex = 28512;
