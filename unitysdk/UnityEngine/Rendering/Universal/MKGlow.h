...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETALLOWCOMPUTESHADERS_OFFSET UNITYSDK_OFFSET(0x17B865D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETALLOWGEOMETRYSHADERS_OFFSET UNITYSDK_OFFSET(0x17B86590)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETALLOWGLARE_OFFSET UNITYSDK_OFFSET(0x17B875C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETALLOWLENSFLARE_OFFSET UNITYSDK_OFFSET(0x17B86E20)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETALLOWLENSSURFACE_OFFSET UNITYSDK_OFFSET(0x17B86C20)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETANAMORPHICRATIO_OFFSET UNITYSDK_OFFSET(0x17B869E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETANTIFLICKERMODE_OFFSET UNITYSDK_OFFSET(0x17B868F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETBLOOMING_OFFSET UNITYSDK_OFFSET(0x17B86A90)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETBLOOMINTENSITY_OFFSET UNITYSDK_OFFSET(0x17B86BB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETBLOOMSCATTERING_OFFSET UNITYSDK_OFFSET(0x17B86B50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETBLOOMTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x17B86AF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETDEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x17B86850)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLAREANGLE_OFFSET UNITYSDK_OFFSET(0x17B876F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLAREBLEND_OFFSET UNITYSDK_OFFSET(0x17B87620)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLAREDISTANCEFADE_OFFSET UNITYSDK_OFFSET(0x17B877B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLAREINTENSITY_OFFSET UNITYSDK_OFFSET(0x17B87680)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE0ANGLE_OFFSET UNITYSDK_OFFSET(0x17B87A80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE0INTENSITY_OFFSET UNITYSDK_OFFSET(0x17B87AE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE0OFFSET_OFFSET UNITYSDK_OFFSET(0x17B87B50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE0SCATTERING_OFFSET UNITYSDK_OFFSET(0x17B87A20)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE1ANGLE_OFFSET UNITYSDK_OFFSET(0x17B87DE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE1INTENSITY_OFFSET UNITYSDK_OFFSET(0x17B87E40)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE1OFFSET_OFFSET UNITYSDK_OFFSET(0x17B87EB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE1SCATTERING_OFFSET UNITYSDK_OFFSET(0x17B87D80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE2ANGLE_OFFSET UNITYSDK_OFFSET(0x17B88140)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE2INTENSITY_OFFSET UNITYSDK_OFFSET(0x17B881A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE2OFFSET_OFFSET UNITYSDK_OFFSET(0x17B88210)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE2SCATTERING_OFFSET UNITYSDK_OFFSET(0x17B880E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE3ANGLE_OFFSET UNITYSDK_OFFSET(0x17B884A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE3INTENSITY_OFFSET UNITYSDK_OFFSET(0x17B88500)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE3OFFSET_OFFSET UNITYSDK_OFFSET(0x17B88570)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE3SCATTERING_OFFSET UNITYSDK_OFFSET(0x17B88440)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESCATTERING_OFFSET UNITYSDK_OFFSET(0x17B87970)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESTREAKS_OFFSET UNITYSDK_OFFSET(0x17B87810)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESTYLE_OFFSET UNITYSDK_OFFSET(0x17B879D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x17B87750)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLARECHROMATICABERRATION_OFFSET UNITYSDK_OFFSET(0x17B870C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLARECOLORRAMP_OFFSET UNITYSDK_OFFSET(0x17B87060)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREGHOSTCOUNT_OFFSET UNITYSDK_OFFSET(0x17B87120)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREGHOSTDISPERSAL_OFFSET UNITYSDK_OFFSET(0x17B87170)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREGHOSTFADE_OFFSET UNITYSDK_OFFSET(0x17B86ED0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREGHOSTINTENSITY_OFFSET UNITYSDK_OFFSET(0x17B86F30)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREHALOFADE_OFFSET UNITYSDK_OFFSET(0x17B871D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREHALOINTENSITY_OFFSET UNITYSDK_OFFSET(0x17B87230)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREHALOSIZE_OFFSET UNITYSDK_OFFSET(0x17B872A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLARESCATTERING_OFFSET UNITYSDK_OFFSET(0x17B87000)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLARESTYLE_OFFSET UNITYSDK_OFFSET(0x17B86E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLARETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x17B86FA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSSURFACEDIFFRACTIONINTENSITY_OFFSET UNITYSDK_OFFSET(0x17B86DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSSURFACEDIFFRACTIONTEXTURE_OFFSET UNITYSDK_OFFSET(0x17B86D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSSURFACEDIRTINTENSITY_OFFSET UNITYSDK_OFFSET(0x17B86CE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSSURFACEDIRTTEXTURE_OFFSET UNITYSDK_OFFSET(0x17B86C80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLUMASCALE_OFFSET UNITYSDK_OFFSET(0x17B86A30)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x17B86660)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETQUALITY_OFFSET UNITYSDK_OFFSET(0x17B868A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETRENDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x17B86800)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETRESOURCES_OFFSET UNITYSDK_OFFSET(0x17B86610)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETSELECTIVERENDERLAYERMASK_OFFSET UNITYSDK_OFFSET(0x17B86990)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETWORKFLOW_OFFSET UNITYSDK_OFFSET(0x17B86940)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x17B862A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x17B86550)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE0ANGLE_OFFSET UNITYSDK_OFFSET(0x17B87C20)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE0INTENSITY_OFFSET UNITYSDK_OFFSET(0x17B87C90)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE0OFFSET_OFFSET UNITYSDK_OFFSET(0x17B87D10)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE0SCATTERING_OFFSET UNITYSDK_OFFSET(0x17B87BB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE1ANGLE_OFFSET UNITYSDK_OFFSET(0x17B87F80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE1INTENSITY_OFFSET UNITYSDK_OFFSET(0x17B87FF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE1OFFSET_OFFSET UNITYSDK_OFFSET(0x17B88070)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE1SCATTERING_OFFSET UNITYSDK_OFFSET(0x17B87F10)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE2ANGLE_OFFSET UNITYSDK_OFFSET(0x17B882E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE2INTENSITY_OFFSET UNITYSDK_OFFSET(0x17B88350)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE2OFFSET_OFFSET UNITYSDK_OFFSET(0x17B883D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE2SCATTERING_OFFSET UNITYSDK_OFFSET(0x17B88270)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE3ANGLE_OFFSET UNITYSDK_OFFSET(0x17B88640)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE3INTENSITY_OFFSET UNITYSDK_OFFSET(0x17B886B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE3OFFSET_OFFSET UNITYSDK_OFFSET(0x17B88730)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE3SCATTERING_OFFSET UNITYSDK_OFFSET(0x17B885D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESTREAKS_OFFSET UNITYSDK_OFFSET(0x17B87870)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETLENSFLAREGHOSTCOUNT_OFFSET UNITYSDK_OFFSET(0x17B87370)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETLENSFLAREGHOSTDISPERSAL_OFFSET UNITYSDK_OFFSET(0x17B87470)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETLENSFLAREGHOSTFADE_OFFSET UNITYSDK_OFFSET(0x17B87300)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETLENSFLAREHALOFADE_OFFSET UNITYSDK_OFFSET(0x17B874E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETLENSFLAREHALOSIZE_OFFSET UNITYSDK_OFFSET(0x17B87550)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x17B887A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_TypeDefinitionIndex = 28567;
