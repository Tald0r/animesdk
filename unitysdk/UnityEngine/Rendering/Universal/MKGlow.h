...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETALLOWCOMPUTESHADERS_OFFSET UNITYSDK_OFFSET(0x178217D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETALLOWGEOMETRYSHADERS_OFFSET UNITYSDK_OFFSET(0x17821790)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETALLOWGLARE_OFFSET UNITYSDK_OFFSET(0x178227C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETALLOWLENSFLARE_OFFSET UNITYSDK_OFFSET(0x17822020)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETALLOWLENSSURFACE_OFFSET UNITYSDK_OFFSET(0x17821E20)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETANAMORPHICRATIO_OFFSET UNITYSDK_OFFSET(0x17821BE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETANTIFLICKERMODE_OFFSET UNITYSDK_OFFSET(0x17821AF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETBLOOMING_OFFSET UNITYSDK_OFFSET(0x17821C90)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETBLOOMINTENSITY_OFFSET UNITYSDK_OFFSET(0x17821DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETBLOOMSCATTERING_OFFSET UNITYSDK_OFFSET(0x17821D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETBLOOMTHRESHOLD_OFFSET UNITYSDK_OFFSET(0x17821CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETDEBUGVIEW_OFFSET UNITYSDK_OFFSET(0x17821A50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLAREANGLE_OFFSET UNITYSDK_OFFSET(0x178228F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLAREBLEND_OFFSET UNITYSDK_OFFSET(0x17822820)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLAREDISTANCEFADE_OFFSET UNITYSDK_OFFSET(0x178229B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLAREINTENSITY_OFFSET UNITYSDK_OFFSET(0x17822880)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE0ANGLE_OFFSET UNITYSDK_OFFSET(0x17822C80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE0INTENSITY_OFFSET UNITYSDK_OFFSET(0x17822CE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE0OFFSET_OFFSET UNITYSDK_OFFSET(0x17822D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE0SCATTERING_OFFSET UNITYSDK_OFFSET(0x17822C20)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE1ANGLE_OFFSET UNITYSDK_OFFSET(0x17822FE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE1INTENSITY_OFFSET UNITYSDK_OFFSET(0x17823040)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE1OFFSET_OFFSET UNITYSDK_OFFSET(0x178230B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE1SCATTERING_OFFSET UNITYSDK_OFFSET(0x17822F80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE2ANGLE_OFFSET UNITYSDK_OFFSET(0x17823340)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE2INTENSITY_OFFSET UNITYSDK_OFFSET(0x178233A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE2OFFSET_OFFSET UNITYSDK_OFFSET(0x17823410)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE2SCATTERING_OFFSET UNITYSDK_OFFSET(0x178232E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE3ANGLE_OFFSET UNITYSDK_OFFSET(0x178236A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE3INTENSITY_OFFSET UNITYSDK_OFFSET(0x17823700)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE3OFFSET_OFFSET UNITYSDK_OFFSET(0x17823770)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESAMPLE3SCATTERING_OFFSET UNITYSDK_OFFSET(0x17823640)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESCATTERING_OFFSET UNITYSDK_OFFSET(0x17822B70)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESTREAKS_OFFSET UNITYSDK_OFFSET(0x17822A10)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARESTYLE_OFFSET UNITYSDK_OFFSET(0x17822BD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETGLARETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x17822950)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLARECHROMATICABERRATION_OFFSET UNITYSDK_OFFSET(0x178222C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLARECOLORRAMP_OFFSET UNITYSDK_OFFSET(0x17822260)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREGHOSTCOUNT_OFFSET UNITYSDK_OFFSET(0x17822320)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREGHOSTDISPERSAL_OFFSET UNITYSDK_OFFSET(0x17822370)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREGHOSTFADE_OFFSET UNITYSDK_OFFSET(0x178220D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREGHOSTINTENSITY_OFFSET UNITYSDK_OFFSET(0x17822130)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREHALOFADE_OFFSET UNITYSDK_OFFSET(0x178223D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREHALOINTENSITY_OFFSET UNITYSDK_OFFSET(0x17822430)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLAREHALOSIZE_OFFSET UNITYSDK_OFFSET(0x178224A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLARESCATTERING_OFFSET UNITYSDK_OFFSET(0x17822200)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLARESTYLE_OFFSET UNITYSDK_OFFSET(0x17822080)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSFLARETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x178221A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSSURFACEDIFFRACTIONINTENSITY_OFFSET UNITYSDK_OFFSET(0x17821FB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSSURFACEDIFFRACTIONTEXTURE_OFFSET UNITYSDK_OFFSET(0x17821F50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSSURFACEDIRTINTENSITY_OFFSET UNITYSDK_OFFSET(0x17821EE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLENSSURFACEDIRTTEXTURE_OFFSET UNITYSDK_OFFSET(0x17821E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETLUMASCALE_OFFSET UNITYSDK_OFFSET(0x17821C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x17821860)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETQUALITY_OFFSET UNITYSDK_OFFSET(0x17821AA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETRENDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x17821A00)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETRESOURCES_OFFSET UNITYSDK_OFFSET(0x17821810)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETSELECTIVERENDERLAYERMASK_OFFSET UNITYSDK_OFFSET(0x17821B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_GETWORKFLOW_OFFSET UNITYSDK_OFFSET(0x17821B40)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x178214A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x17821750)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE0ANGLE_OFFSET UNITYSDK_OFFSET(0x17822E20)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE0INTENSITY_OFFSET UNITYSDK_OFFSET(0x17822E90)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE0OFFSET_OFFSET UNITYSDK_OFFSET(0x17822F10)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE0SCATTERING_OFFSET UNITYSDK_OFFSET(0x17822DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE1ANGLE_OFFSET UNITYSDK_OFFSET(0x17823180)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE1INTENSITY_OFFSET UNITYSDK_OFFSET(0x178231F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE1OFFSET_OFFSET UNITYSDK_OFFSET(0x17823270)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE1SCATTERING_OFFSET UNITYSDK_OFFSET(0x17823110)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE2ANGLE_OFFSET UNITYSDK_OFFSET(0x178234E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE2INTENSITY_OFFSET UNITYSDK_OFFSET(0x17823550)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE2OFFSET_OFFSET UNITYSDK_OFFSET(0x178235D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE2SCATTERING_OFFSET UNITYSDK_OFFSET(0x17823470)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE3ANGLE_OFFSET UNITYSDK_OFFSET(0x17823840)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE3INTENSITY_OFFSET UNITYSDK_OFFSET(0x178238B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE3OFFSET_OFFSET UNITYSDK_OFFSET(0x17823930)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESAMPLE3SCATTERING_OFFSET UNITYSDK_OFFSET(0x178237D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETGLARESTREAKS_OFFSET UNITYSDK_OFFSET(0x17822A70)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETLENSFLAREGHOSTCOUNT_OFFSET UNITYSDK_OFFSET(0x17822570)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETLENSFLAREGHOSTDISPERSAL_OFFSET UNITYSDK_OFFSET(0x17822670)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETLENSFLAREGHOSTFADE_OFFSET UNITYSDK_OFFSET(0x17822500)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETLENSFLAREHALOFADE_OFFSET UNITYSDK_OFFSET(0x178226E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_SETLENSFLAREHALOSIZE_OFFSET UNITYSDK_OFFSET(0x17822750)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x178239A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_TypeDefinitionIndex = 29510;
