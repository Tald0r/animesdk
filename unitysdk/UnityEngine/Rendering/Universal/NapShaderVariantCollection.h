...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPSHADERVARIANTCOLLECTION_ADDSHADERVARIANT_OFFSET UNITYSDK_OFFSET(0x183BD9B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPSHADERVARIANTCOLLECTION_CLEANUP_OFFSET UNITYSDK_OFFSET(0x183BD8B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPSHADERVARIANTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x183BDB10)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapShaderVariantCollection_TypeDefinitionIndex = 28631;
