...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPSHADERVARIANTCOLLECTION_ADDSHADERVARIANT_OFFSET UNITYSDK_OFFSET(0x18919640)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPSHADERVARIANTCOLLECTION_CLEANUP_OFFSET UNITYSDK_OFFSET(0x18919540)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPSHADERVARIANTCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x189197A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapShaderVariantCollection_TypeDefinitionIndex = 29574;
