...
#define UNITYENGINE_RENDERING_UNIVERSAL_FOGMASKCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F62650)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FogMaskConfig_TypeDefinitionIndex = 28506;
