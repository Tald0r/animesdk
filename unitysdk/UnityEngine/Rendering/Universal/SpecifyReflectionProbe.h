...
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x189FB650)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x189FB470)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE_UPDATE_OFFSET UNITYSDK_OFFSET(0x189FB150)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE__CTOR_OFFSET UNITYSDK_OFFSET(0x189FB7E0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SpecifyReflectionProbe_TypeDefinitionIndex = 29376;
