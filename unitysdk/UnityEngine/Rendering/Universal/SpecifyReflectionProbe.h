...
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x183A5300)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x183A5120)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE_UPDATE_OFFSET UNITYSDK_OFFSET(0x183A4E00)
#define UNITYENGINE_RENDERING_UNIVERSAL_SPECIFYREFLECTIONPROBE__CTOR_OFFSET UNITYSDK_OFFSET(0x183A5490)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SpecifyReflectionProbe_TypeDefinitionIndex = 28433;
