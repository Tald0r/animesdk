...
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x183BCAF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_GETMATRIX_OFFSET UNITYSDK_OFFSET(0x183BCDD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_GETTEXTURE_OFFSET UNITYSDK_OFFSET(0x183BCF70)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_GETVECTOR_OFFSET UNITYSDK_OFFSET(0x183BCC60)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_GET_OFFSET UNITYSDK_OFFSET(0x183BA800)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASCOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0x183BC9A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASCONSTANTBUFFER_OFFSET UNITYSDK_OFFSET(0x183BC850)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASFLOATPROPERTY_OFFSET UNITYSDK_OFFSET(0x183BBB70)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASMATRIXPROPERTY_OFFSET UNITYSDK_OFFSET(0x183BC5B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x183BBE10)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASPROPERTY_OFFSET UNITYSDK_OFFSET(0x183BBAF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASTEXTUREPROPERTY_OFFSET UNITYSDK_OFFSET(0x183BC700)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASVECTORPROPERTY_OFFSET UNITYSDK_OFFSET(0x183BBCC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_RELEASE_OFFSET UNITYSDK_OFFSET(0x183BB9F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x183BD0F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x183BD0E0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MaterialPropertyBlockContent_TypeDefinitionIndex = 28400;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyBlockContent_TypeDefinitionIndex)->GetStaticField(0x21960);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_starts()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyBlockContent_TypeDefinitionIndex)->GetStaticField(0x21968);
		}
