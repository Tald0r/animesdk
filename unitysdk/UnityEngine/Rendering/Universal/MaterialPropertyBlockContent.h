...
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x18918780)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_GETMATRIX_OFFSET UNITYSDK_OFFSET(0x18918A60)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_GETTEXTURE_OFFSET UNITYSDK_OFFSET(0x18918C00)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_GETVECTOR_OFFSET UNITYSDK_OFFSET(0x189188F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_GET_OFFSET UNITYSDK_OFFSET(0x18916490)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASCOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0x18918630)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASCONSTANTBUFFER_OFFSET UNITYSDK_OFFSET(0x189184E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASFLOATPROPERTY_OFFSET UNITYSDK_OFFSET(0x18917800)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASMATRIXPROPERTY_OFFSET UNITYSDK_OFFSET(0x18918240)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x18917AA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASPROPERTY_OFFSET UNITYSDK_OFFSET(0x18917780)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASTEXTUREPROPERTY_OFFSET UNITYSDK_OFFSET(0x18918390)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_HASVECTORPROPERTY_OFFSET UNITYSDK_OFFSET(0x18917950)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT_RELEASE_OFFSET UNITYSDK_OFFSET(0x18917680)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x18918D80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MATERIALPROPERTYBLOCKCONTENT__CTOR_OFFSET UNITYSDK_OFFSET(0x18918D70)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MaterialPropertyBlockContent_TypeDefinitionIndex = 29343;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyBlockContent_TypeDefinitionIndex)->GetStaticField(0x232B0);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_ids()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MaterialPropertyBlockContent_TypeDefinitionIndex)->GetStaticField(0x232B8);
		}
