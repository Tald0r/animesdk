...
#define UNITYENGINE_RENDERING_UNIVERSAL_UNITYENVIRONMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17B925B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int UnityEnvironment_TypeDefinitionIndex = 28458;
