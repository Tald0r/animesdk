...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x182E1930)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS_ISCHARACTERGHOSTACTIVE_OFFSET UNITYSDK_OFFSET(0x182E1DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x182E1980)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS_LAYERCONFIGTOVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x182E19C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENEFFECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x182E1E30)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScreenEffects_TypeDefinitionIndex = 29633;
