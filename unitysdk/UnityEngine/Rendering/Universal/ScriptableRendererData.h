...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_GET_ISINVALIDATED_OFFSET UNITYSDK_OFFSET(0x17677CE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_GET_RENDERERFEATURES_OFFSET UNITYSDK_OFFSET(0x17677D00)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_INTERNALCREATERENDERER_OFFSET UNITYSDK_OFFSET(0x17677D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17677E30)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x17677DD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x17677D10)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA_SET_ISINVALIDATED_OFFSET UNITYSDK_OFFSET(0x17677CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17677E90)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScriptableRendererData_TypeDefinitionIndex = 29696;
