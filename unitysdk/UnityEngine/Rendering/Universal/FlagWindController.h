...
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAGWINDCONTROLLER_APPLYWIND_OFFSET UNITYSDK_OFFSET(0x19B23340)
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAGWINDCONTROLLER_GET_WINDDIRECTIONWS_OFFSET UNITYSDK_OFFSET(0x19B230C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAGWINDCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19B23A00)
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAGWINDCONTROLLER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19B23570)
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAGWINDCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19B230F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAGWINDCONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19B232F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAGWINDCONTROLLER_SET_WINDDIRECTIONWS_OFFSET UNITYSDK_OFFSET(0x19B230E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAGWINDCONTROLLER_UPDATELOCALWINDDIRECTION_OFFSET UNITYSDK_OFFSET(0x19B231D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAGWINDCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B23A60)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FlagWindController_TypeDefinitionIndex = 28528;
