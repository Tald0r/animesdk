...
#define UNITYENGINE_RENDERING_UNIVERSAL_DIRECTIONALBLUR_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x18036C70)
#define UNITYENGINE_RENDERING_UNIVERSAL_DIRECTIONALBLUR_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x18036D30)
#define UNITYENGINE_RENDERING_UNIVERSAL_DIRECTIONALBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x18036D70)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int DirectionalBlur_TypeDefinitionIndex = 28649;
