...
#define UNITYENGINE_RENDERING_UNIVERSAL_DIRECTIONALBLUR_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x18658A30)
#define UNITYENGINE_RENDERING_UNIVERSAL_DIRECTIONALBLUR_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x18658AF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_DIRECTIONALBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x18658B30)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int DirectionalBlur_TypeDefinitionIndex = 29592;
