...
#define UNITYENGINE_RENDERING_UNIVERSAL_MESHLODLIGHTMAPHELPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19B6CF80)
#define UNITYENGINE_RENDERING_UNIVERSAL_MESHLODLIGHTMAPHELPER_REBINDLIGHTMAPINFO_OFFSET UNITYSDK_OFFSET(0x19B6CFD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MESHLODLIGHTMAPHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6D080)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MeshLodLightmapHelper_TypeDefinitionIndex = 29346;
