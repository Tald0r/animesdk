...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_RESOURCESPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x18D2C460)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_RESOURCESPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x18D2C470)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_RESOURCESPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D2C480)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_ResourcesParameter_TypeDefinitionIndex = 29511;
