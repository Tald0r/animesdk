...
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_AWAKE_OFFSET UNITYSDK_OFFSET(0x19EE13C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_DRAWSOURCEACTOR_OFFSET UNITYSDK_OFFSET(0x19EE4FF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_GETPLANEPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x19EE51A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19EE1410)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19EE2B50)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19EE03E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19EE02C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x19EE0630)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x19EE0690)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x19EE0480)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x19EE0360)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_REFRESHWINDACTORS_OFFSET UNITYSDK_OFFSET(0x19EE06F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_SETUPCOMMANDBUFFER_OFFSET UNITYSDK_OFFSET(0x19EE3900)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_SIMULATEFLUID_OFFSET UNITYSDK_OFFSET(0x19EE3840)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID_UPDATE_OFFSET UNITYSDK_OFFSET(0x19EE2CB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EE6280)
#define UNITYENGINE_RENDERING_UNIVERSAL_ZZZFLUID__CTOR_OFFSET UNITYSDK_OFFSET(0x19EE6060)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ZzzFluid_TypeDefinitionIndex = 29745;
	...
	public:
		...
		{
			return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(ZzzFluid_TypeDefinitionIndex)->GetStaticField(0x23C50);
		}
		static ::UnityEngine::RenderTextureFormat* StaticGet_DefaultRTFormat()
		{
			return (::UnityEngine::RenderTextureFormat*)Il2CppClass::FromTypeDefinitionIndex(ZzzFluid_TypeDefinitionIndex)->GetStaticField(0x7370);
		}
