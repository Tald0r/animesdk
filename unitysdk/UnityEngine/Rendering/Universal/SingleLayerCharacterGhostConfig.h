...
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLELAYERCHARACTERGHOSTCONFIG_TOVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x8A22E0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SingleLayerCharacterGhostConfig_TypeDefinitionIndex = 28691;
