...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIBAKESETTINGS_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x19FB5DF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIBAKESETTINGS_ISVALID_OFFSET UNITYSDK_OFFSET(0x19FB5E90)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIBAKESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19FB5E70)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCharacterGIBakeSettings_TypeDefinitionIndex = 28585;
