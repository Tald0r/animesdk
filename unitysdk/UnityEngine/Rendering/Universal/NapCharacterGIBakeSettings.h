...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIBAKESETTINGS_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x1A2F0980)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIBAKESETTINGS_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A2F0A20)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIBAKESETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F0A00)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCharacterGIBakeSettings_TypeDefinitionIndex = 29528;
