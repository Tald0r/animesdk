...
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_CLEARRAMPTEXTURE_OFFSET UNITYSDK_OFFSET(0x17B92450)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_DEFAULTABSORPTIONGRAD_OFFSET UNITYSDK_OFFSET(0x17B91540)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_DEFAULTSCATTERGRAD_OFFSET UNITYSDK_OFFSET(0x17B91700)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_GENERATERAMPTEXTURE_OFFSET UNITYSDK_OFFSET(0x17B91BE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_GET_LEFTCUBE_OFFSET UNITYSDK_OFFSET(0x17B91460)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_GET_LERPVALUE_OFFSET UNITYSDK_OFFSET(0x17B914A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_GET_RIGHTCUBE_OFFSET UNITYSDK_OFFSET(0x17B91480)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_REFRESHRAMPTEXTURE_OFFSET UNITYSDK_OFFSET(0x17B91C40)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_SETUPWAVES_OFFSET UNITYSDK_OFFSET(0x17B91890)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_SET_LEFTCUBE_OFFSET UNITYSDK_OFFSET(0x17B91470)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_SET_LERPVALUE_OFFSET UNITYSDK_OFFSET(0x17B914B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_SET_RIGHTCUBE_OFFSET UNITYSDK_OFFSET(0x17B91490)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER__CTOR_OFFSET UNITYSDK_OFFSET(0x17B914C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SingleWeatherConfigWater_TypeDefinitionIndex = 28348;
