...
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_CLEARRAMPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1782D690)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_DEFAULTABSORPTIONGRAD_OFFSET UNITYSDK_OFFSET(0x1782C780)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_DEFAULTSCATTERGRAD_OFFSET UNITYSDK_OFFSET(0x1782C940)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_GENERATERAMPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1782CE20)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_GET_LEFTCUBE_OFFSET UNITYSDK_OFFSET(0x1782C6A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_GET_LERPVALUE_OFFSET UNITYSDK_OFFSET(0x1782C6E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_GET_RIGHTCUBE_OFFSET UNITYSDK_OFFSET(0x1782C6C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_REFRESHRAMPTEXTURE_OFFSET UNITYSDK_OFFSET(0x1782CE80)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_SETUPWAVES_OFFSET UNITYSDK_OFFSET(0x1782CAD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_SET_LEFTCUBE_OFFSET UNITYSDK_OFFSET(0x1782C6B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_SET_LERPVALUE_OFFSET UNITYSDK_OFFSET(0x1782C6F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER_SET_RIGHTCUBE_OFFSET UNITYSDK_OFFSET(0x1782C6D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SINGLEWEATHERCONFIGWATER__CTOR_OFFSET UNITYSDK_OFFSET(0x1782C700)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SingleWeatherConfigWater_TypeDefinitionIndex = 29289;
