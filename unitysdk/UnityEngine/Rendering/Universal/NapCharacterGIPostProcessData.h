...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIPOSTPROCESSDATA_MARKTEXTURECURVEASDIRTY_OFFSET UNITYSDK_OFFSET(0x18040FD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGIPOSTPROCESSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18041170)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCharacterGIPostProcessData_TypeDefinitionIndex = 28588;
