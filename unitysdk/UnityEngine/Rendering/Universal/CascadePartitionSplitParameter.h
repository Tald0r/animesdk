...
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_GET_MAX_OFFSET UNITYSDK_OFFSET(0x18D1AD00)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_GET_MIN_OFFSET UNITYSDK_OFFSET(0x18D1ACA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_GET_REPRESENTATIONDISTANCE_OFFSET UNITYSDK_OFFSET(0x18D1AD70)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x18D1AD90)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_INIT_OFFSET UNITYSDK_OFFSET(0x18D1B140)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_SETFINALVALUE_OFFSET UNITYSDK_OFFSET(0x18D1AFD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x18D1ADA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CASCADEPARTITIONSPLITPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D1B110)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int CascadePartitionSplitParameter_TypeDefinitionIndex = 29608;
