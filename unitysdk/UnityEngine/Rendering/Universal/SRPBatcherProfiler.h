...
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_AWAKE_OFFSET UNITYSDK_OFFSET(0x187CE220)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_ONGUI_OFFSET UNITYSDK_OFFSET(0x187CED40)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_RAZCOUNTERS_OFFSET UNITYSDK_OFFSET(0x187CE800)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_RESETSTATS_OFFSET UNITYSDK_OFFSET(0x187CE730)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_TOGGLESTATS_OFFSET UNITYSDK_OFFSET(0x187CE880)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_UPDATE_OFFSET UNITYSDK_OFFSET(0x187CE8D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER__CTOR_OFFSET UNITYSDK_OFFSET(0x187CF100)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SRPBatcherProfiler_TypeDefinitionIndex = 28425;
