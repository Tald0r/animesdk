...
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_AWAKE_OFFSET UNITYSDK_OFFSET(0x18D2D070)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_ONGUI_OFFSET UNITYSDK_OFFSET(0x18D2DB90)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_RAZCOUNTERS_OFFSET UNITYSDK_OFFSET(0x18D2D650)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_RESETSTATS_OFFSET UNITYSDK_OFFSET(0x18D2D580)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_TOGGLESTATS_OFFSET UNITYSDK_OFFSET(0x18D2D6D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18D2D720)
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D2DF50)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SRPBatcherProfiler_TypeDefinitionIndex = 29368;
