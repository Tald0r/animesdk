...
#define UNITYENGINE_RENDERING_UNIVERSAL_VISUALENVIRONMENTE_WEATHERCONFIGOVERRIDEDATA_GETISVALID_OFFSET UNITYSDK_OFFSET(0x183D6680)
#define UNITYENGINE_RENDERING_UNIVERSAL_VISUALENVIRONMENTE_WEATHERCONFIGOVERRIDEDATA_SETISVALID_OFFSET UNITYSDK_OFFSET(0x183D6630)
#define UNITYENGINE_RENDERING_UNIVERSAL_VISUALENVIRONMENTE_WEATHERCONFIGOVERRIDEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x183D66C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int VisualEnvironmentE_WeatherConfigOverrideData_TypeDefinitionIndex = 28456;
