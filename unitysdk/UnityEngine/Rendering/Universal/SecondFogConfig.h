...
#define UNITYENGINE_RENDERING_UNIVERSAL_SECONDFOGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19FB6240)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SecondFogConfig_TypeDefinitionIndex = 28505;
