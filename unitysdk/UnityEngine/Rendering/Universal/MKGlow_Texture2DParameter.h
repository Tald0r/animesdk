...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x196F0540)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x196F04C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x196F0550)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x196F0560)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_Texture2DParameter_TypeDefinitionIndex = 28570;
