...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19B6CED0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x19B6CE50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19B6CEE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_TEXTURE2DPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6CEF0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_Texture2DParameter_TypeDefinitionIndex = 29513;
