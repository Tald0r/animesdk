...
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINEEDITORRESOURCES_SHADERRESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x16DC4090)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int UniversalRenderPipelineEditorResources_ShaderResources_TypeDefinitionIndex = 28370;
