...
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORLOOKUP_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x17B6C2E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORLOOKUP_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x17B6C4F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORLOOKUP_VALIDATELUT_OFFSET UNITYSDK_OFFSET(0x17B6C440)
#define UNITYENGINE_RENDERING_UNIVERSAL_COLORLOOKUP__CTOR_OFFSET UNITYSDK_OFFSET(0x17B6C530)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ColorLookup_TypeDefinitionIndex = 28642;
