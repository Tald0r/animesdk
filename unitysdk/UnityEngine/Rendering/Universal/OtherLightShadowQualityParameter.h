...
#define UNITYENGINE_RENDERING_UNIVERSAL_OTHERLIGHTSHADOWQUALITYPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x185E6660)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int OtherLightShadowQualityParameter_TypeDefinitionIndex = 28662;
