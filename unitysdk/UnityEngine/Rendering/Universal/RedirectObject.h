...
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT_GETGAMEOBJECTVALUE_OFFSET UNITYSDK_OFFSET(0x16FA5700)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT_GETPATH_OFFSET UNITYSDK_OFFSET(0x16FA54F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x16FA5440)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT_LOAD_OFFSET UNITYSDK_OFFSET(0x16FA5380)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT_SAVE_OFFSET UNITYSDK_OFFSET(0x16FA5110)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x16FA5160)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16FA5890)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int RedirectObject_TypeDefinitionIndex = 28616;
