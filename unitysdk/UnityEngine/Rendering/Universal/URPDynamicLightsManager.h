...
#define UNITYENGINE_RENDERING_UNIVERSAL_URPDYNAMICLIGHTSMANAGER_GET_S_INSTANCE_OFFSET UNITYSDK_OFFSET(0x183A58D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_URPDYNAMICLIGHTSMANAGER_REFRESHDYNAMICLIGHT_OFFSET UNITYSDK_OFFSET(0x183A5A80)
#define UNITYENGINE_RENDERING_UNIVERSAL_URPDYNAMICLIGHTSMANAGER_REGISTERDYNAMICLIGHT_OFFSET UNITYSDK_OFFSET(0x183A5C20)
#define UNITYENGINE_RENDERING_UNIVERSAL_URPDYNAMICLIGHTSMANAGER_UNREGISTERDYNAMICLIGHT_OFFSET UNITYSDK_OFFSET(0x183A5CD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_URPDYNAMICLIGHTSMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x183A5D60)
#define UNITYENGINE_RENDERING_UNIVERSAL_URPDYNAMICLIGHTSMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x183A5810)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int URPDynamicLightsManager_TypeDefinitionIndex = 28579;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::URPDynamicLightsManager**)Il2CppClass::FromTypeDefinitionIndex(URPDynamicLightsManager_TypeDefinitionIndex)->GetStaticField(0x218A0);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_RefreshAllDynamicLight()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(URPDynamicLightsManager_TypeDefinitionIndex)->GetStaticField(0x218A8);
		}
