...
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x197DD0A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x197DD040)
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x197DD0B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197DCEB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_GRADIENTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x197DCE10)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FXColorCorrection_GradientParameter_TypeDefinitionIndex = 29349;
