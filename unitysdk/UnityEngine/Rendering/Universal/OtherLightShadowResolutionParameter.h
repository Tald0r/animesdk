...
#define UNITYENGINE_RENDERING_UNIVERSAL_OTHERLIGHTSHADOWRESOLUTIONPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x197F2320)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int OtherLightShadowResolutionParameter_TypeDefinitionIndex = 29604;
