...
#define UNITYENGINE_RENDERING_UNIVERSAL_OTHERLIGHTSHADOWRESOLUTIONPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1933ED60)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int OtherLightShadowResolutionParameter_TypeDefinitionIndex = 28661;
