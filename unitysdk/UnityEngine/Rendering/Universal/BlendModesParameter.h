...
#define UNITYENGINE_RENDERING_UNIVERSAL_BLENDMODESPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3EE00)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int BlendModesParameter_TypeDefinitionIndex = 28694;
