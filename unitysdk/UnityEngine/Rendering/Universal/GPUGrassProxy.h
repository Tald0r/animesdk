...
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_CHECKBUFFERVALID_OFFSET UNITYSDK_OFFSET(0x18B426F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_CHECKINDIRECTDRAWDATA_OFFSET UNITYSDK_OFFSET(0x18B45D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_CHECKISVISIBLE_OFFSET UNITYSDK_OFFSET(0x18B435A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWGPUGRASSFORSOFTEDGE_OFFSET UNITYSDK_OFFSET(0x18B45B10)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWGPUGRASSSHADOW_OFFSET UNITYSDK_OFFSET(0x18B44F90)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWGPUGRASS_OFFSET UNITYSDK_OFFSET(0x18B45820)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWMESHWITHINDIRECTDRAW_OFFSET UNITYSDK_OFFSET(0x18B46580)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_DRAWWITHBATCH_OFFSET UNITYSDK_OFFSET(0x18B45180)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GETGROUPBASEDATA_OFFSET UNITYSDK_OFFSET(0x18B40800)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_GET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x18B42B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18B43A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18B42BB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_PREPAREGPUDRAWDATA_OFFSET UNITYSDK_OFFSET(0x18B44550)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_PREPAREGROUPDATAFORCUSTOMGRASS_OFFSET UNITYSDK_OFFSET(0x18B42220)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_PREPAREGROUPDATAFORMASKGRASS_OFFSET UNITYSDK_OFFSET(0x18B41D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_PREPAREGROUPDATA_OFFSET UNITYSDK_OFFSET(0x18B40930)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_REFRESHBOUNDINGBOX_OFFSET UNITYSDK_OFFSET(0x18B40FD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_RESETGROUPDATA_OFFSET UNITYSDK_OFFSET(0x18B417A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_REVERTDISABLEEDIT_OFFSET UNITYSDK_OFFSET(0x18B42750)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_SET_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x18B42BA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_SYNCCACHEDDATARENDERDATATOINSTANCEDATA_OFFSET UNITYSDK_OFFSET(0x18B42C70)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_UPDATETEXTURESTREAMINGFAKER_OFFSET UNITYSDK_OFFSET(0x18B43FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x18B43D60)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY__CCTOR_OFFSET UNITYSDK_OFFSET(0x18B46A80)
#define UNITYENGINE_RENDERING_UNIVERSAL_GPUGRASSPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x18B46890)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int GPUGrassProxy_TypeDefinitionIndex = 28766;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Matrix4x4>**)Il2CppClass::FromTypeDefinitionIndex(GPUGrassProxy_TypeDefinitionIndex)->GetStaticField(0x21EE0);
		}
		static ::Il2CppArray<::UnityEngine::Matrix4x4>** StaticGet_m_GPUGrassParams()
		{
			return (::Il2CppArray<::UnityEngine::Matrix4x4>**)Il2CppClass::FromTypeDefinitionIndex(GPUGrassProxy_TypeDefinitionIndex)->GetStaticField(0x21EE8);
		}
		static ::System::Int32* StaticGet__GPUGrassParams()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(GPUGrassProxy_TypeDefinitionIndex)->GetStaticField(0x6610);
		}
		static ::System::Int32* StaticGet__GrassInstanceBuffer()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(GPUGrassProxy_TypeDefinitionIndex)->GetStaticField(0x6614);
		}
		static ::System::Int64* StaticGet_sumGrassMeshCount()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(GPUGrassProxy_TypeDefinitionIndex)->GetStaticField(0x6618);
		}
