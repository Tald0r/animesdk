...
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_DOCHARACTERGHOST_OFFSET UNITYSDK_OFFSET(0x18035960)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x180357C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x180369C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_GETCHARACTERGHOSTTEXTURE_OFFSET UNITYSDK_OFFSET(0x18036AA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_ISPASSREADY_OFFSET UNITYSDK_OFFSET(0x180354A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_SETUPCHARACTERGHOST_OFFSET UNITYSDK_OFFSET(0x180368C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x18035770)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x180356E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x18036C60)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int CharacterGhostPass_TypeDefinitionIndex = 28710;
