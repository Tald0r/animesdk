...
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_DOCHARACTERGHOST_OFFSET UNITYSDK_OFFSET(0x18657650)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x186574B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x18658780)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_GETCHARACTERGHOSTTEXTURE_OFFSET UNITYSDK_OFFSET(0x18658860)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_ISPASSREADY_OFFSET UNITYSDK_OFFSET(0x18657190)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_SETUPCHARACTERGHOST_OFFSET UNITYSDK_OFFSET(0x18658680)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x18657460)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x186573D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CHARACTERGHOSTPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x18658A20)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int CharacterGhostPass_TypeDefinitionIndex = 29656;
