...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_GETLAYERRANGE_1_OFFSET UNITYSDK_OFFSET(0x19B6EB70)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_GETLAYERRANGE_OFFSET UNITYSDK_OFFSET(0x19B6EA40)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_INDEX2DTOINDEX_OFFSET UNITYSDK_OFFSET(0x19B6EC90)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_INDEXTOINDEX2D_OFFSET UNITYSDK_OFFSET(0x19B6EC30)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_RECALCULATEBASICPARAMS_OFFSET UNITYSDK_OFFSET(0x19B6E940)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI__CTOR_OFFSET UNITYSDK_OFFSET(0x19B6ECF0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCharacterGI_TypeDefinitionIndex = 29527;
