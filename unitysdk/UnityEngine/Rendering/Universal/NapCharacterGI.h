...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_GETLAYERRANGE_1_OFFSET UNITYSDK_OFFSET(0x196F21D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_GETLAYERRANGE_OFFSET UNITYSDK_OFFSET(0x196F20A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_INDEX2DTOINDEX_OFFSET UNITYSDK_OFFSET(0x196F22F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_INDEXTOINDEX2D_OFFSET UNITYSDK_OFFSET(0x196F2290)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI_RECALCULATEBASICPARAMS_OFFSET UNITYSDK_OFFSET(0x196F1FA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCHARACTERGI__CTOR_OFFSET UNITYSDK_OFFSET(0x196F2350)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCharacterGI_TypeDefinitionIndex = 28584;
