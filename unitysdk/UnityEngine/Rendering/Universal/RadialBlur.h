...
#define UNITYENGINE_RENDERING_UNIVERSAL_RADIALBLUR_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19B28DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_RADIALBLUR_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19B28E50)
#define UNITYENGINE_RENDERING_UNIVERSAL_RADIALBLUR__CTOR_OFFSET UNITYSDK_OFFSET(0x19B28E90)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int RadialBlur_TypeDefinitionIndex = 28684;
