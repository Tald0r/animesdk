...
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x19B29680)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x19B295B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_ITEMPIVOTCENTER_OFFSET UNITYSDK_OFFSET(0x19B295D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_LOOP_OFFSET UNITYSDK_OFFSET(0x19B295F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x19B295C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x19B295E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_STARTFRAME_OFFSET UNITYSDK_OFFSET(0x19B295A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_TEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x19B29580)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_TILES_OFFSET UNITYSDK_OFFSET(0x19B29590)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_INIT_OFFSET UNITYSDK_OFFSET(0x19B29450)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_REBUILD_OFFSET UNITYSDK_OFFSET(0x19B29600)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B296C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int TextureSheetConfig_TypeDefinitionIndex = 28435;
