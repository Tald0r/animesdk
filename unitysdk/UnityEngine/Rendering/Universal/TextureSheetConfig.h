...
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x19EDC560)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_ENDFRAME_OFFSET UNITYSDK_OFFSET(0x19EDC490)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_ITEMPIVOTCENTER_OFFSET UNITYSDK_OFFSET(0x19EDC4B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_LOOP_OFFSET UNITYSDK_OFFSET(0x19EDC4D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x19EDC4A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x19EDC4C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_STARTFRAME_OFFSET UNITYSDK_OFFSET(0x19EDC480)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_TEXTURESHEET_OFFSET UNITYSDK_OFFSET(0x19EDC460)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_GET_TILES_OFFSET UNITYSDK_OFFSET(0x19EDC470)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_INIT_OFFSET UNITYSDK_OFFSET(0x19EDC330)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG_REBUILD_OFFSET UNITYSDK_OFFSET(0x19EDC4E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_TEXTURESHEETCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19EDC5A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int TextureSheetConfig_TypeDefinitionIndex = 29378;
