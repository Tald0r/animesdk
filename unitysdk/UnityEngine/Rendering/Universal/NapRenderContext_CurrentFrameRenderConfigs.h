...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPRENDERCONTEXT_CURRENTFRAMERENDERCONFIGS_INITIALIZECONFIGS_OFFSET UNITYSDK_OFFSET(0x19676300)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPRENDERCONTEXT_CURRENTFRAMERENDERCONFIGS__CTOR_OFFSET UNITYSDK_OFFSET(0x196765E0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapRenderContext_CurrentFrameRenderConfigs_TypeDefinitionIndex = 29479;

	class NapRenderContext_CurrentFrameRenderConfigs : public ::System::Object
	{
	public:
		::UnityEngine::Rendering::Universal::CharacterIgnisFatuus* characterIgnisFatuus; // 0x10
		::UnityEngine::Rendering::Universal::UniversalRenderPipelineAsset* globalSettings; // 0x18
		::UnityEngine::Rendering::Universal::NapBloom* napBloom; // 0x20
		::UnityEngine::Rendering::Universal::MKGlow* mkGlow; // 0x28
		...
		::UnityEngine::Rendering::Universal::AmplifyOcclusion* amplifyOcclusion; // 0x48
		::UnityEngine::Rendering::Universal::FXColorCorrection* fxColorCorrection; // 0x50
		::UnityEngine::Rendering::Universal::FXFog* fxFog; // 0x58
		::UnityEngine::Rendering::Universal::ScreenEffects* screenEffects; // 0x60
		::UnityEngine::Rendering::Universal::MonsterIgnisFatuus* monsterIgnisFatuus; // 0x68
		::WeatherConfig* weatherConfig; // 0x70
