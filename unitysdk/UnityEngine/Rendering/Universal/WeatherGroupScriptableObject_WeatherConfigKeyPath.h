...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_WEATHERCONFIGKEYPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x187D3C10)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherGroupScriptableObject_WeatherConfigKeyPath_TypeDefinitionIndex = 28527;
