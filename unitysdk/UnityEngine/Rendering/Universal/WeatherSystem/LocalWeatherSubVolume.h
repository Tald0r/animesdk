...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_LOCALWEATHERSUBVOLUME_CHECKCAMERAINSUBVOLUME_OFFSET UNITYSDK_OFFSET(0x16DC42E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_LOCALWEATHERSUBVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x16DC43B0)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int LocalWeatherSubVolume_TypeDefinitionIndex = 28804;
