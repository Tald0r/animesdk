...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_LOCALWEATHERSUBVOLUME_CHECKCAMERAINSUBVOLUME_OFFSET UNITYSDK_OFFSET(0x1742CB70)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_LOCALWEATHERSUBVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1742CC40)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int LocalWeatherSubVolume_TypeDefinitionIndex = 29750;
