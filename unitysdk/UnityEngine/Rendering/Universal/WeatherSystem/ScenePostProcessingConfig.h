...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENEPOSTPROCESSINGCONFIG_DOLERP_OFFSET UNITYSDK_OFFSET(0x1742DA40)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENEPOSTPROCESSINGCONFIG_GETTEXTUREFORMAT_OFFSET UNITYSDK_OFFSET(0x1742D9D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_SCENEPOSTPROCESSINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1742E000)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int ScenePostProcessingConfig_TypeDefinitionIndex = 29786;
