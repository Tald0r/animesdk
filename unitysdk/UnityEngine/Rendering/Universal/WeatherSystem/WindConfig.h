...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WINDCONFIG_DOLERP_OFFSET UNITYSDK_OFFSET(0x19FBCF20)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WINDCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19FBD0F0)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int WindConfig_TypeDefinitionIndex = 28832;
