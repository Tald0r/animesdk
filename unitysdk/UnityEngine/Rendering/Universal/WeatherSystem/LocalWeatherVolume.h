...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_LOCALWEATHERVOLUME_GETVALIDLOCALVOLUMECONTEXT_OFFSET UNITYSDK_OFFSET(0x18301C80)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_LOCALWEATHERVOLUME_GET_CAMERAISINVOLUME_OFFSET UNITYSDK_OFFSET(0x18301A50)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_LOCALWEATHERVOLUME_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x18301A60)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_LOCALWEATHERVOLUME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18301BD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_LOCALWEATHERVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18301B40)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_LOCALWEATHERVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18301A70)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_LOCALWEATHERVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x18302550)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int LocalWeatherVolume_TypeDefinitionIndex = 29751;
