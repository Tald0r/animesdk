...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x183B2550)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x183B23E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION_UPDATETRANSITION_OFFSET UNITYSDK_OFFSET(0x183B25A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x183B2C20)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x183B2CC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x183B2CD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION___BASE_UPDATETRANSITION_OFFSET UNITYSDK_OFFSET(0x183B2CE0)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int WeatherMaterialTransition_TypeDefinitionIndex = 28809;
