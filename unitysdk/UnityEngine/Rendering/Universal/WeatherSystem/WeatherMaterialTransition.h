...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18A08870)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18A08700)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION_UPDATETRANSITION_OFFSET UNITYSDK_OFFSET(0x18A088C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x18A08F40)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18A08FE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18A08FF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERMATERIALTRANSITION___BASE_UPDATETRANSITION_OFFSET UNITYSDK_OFFSET(0x18A09000)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int WeatherMaterialTransition_TypeDefinitionIndex = 29758;
