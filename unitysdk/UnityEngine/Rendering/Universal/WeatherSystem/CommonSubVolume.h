...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME_CHECKINSUBVOLUME_OFFSET UNITYSDK_OFFSET(0x18A07670)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18A07450)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18A075B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x18A077B0)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int CommonSubVolume_TypeDefinitionIndex = 29795;
