...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME_CHECKINSUBVOLUME_OFFSET UNITYSDK_OFFSET(0x183B1350)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x183B1130)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x183B1290)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_COMMONSUBVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x183B1490)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int CommonSubVolume_TypeDefinitionIndex = 28846;
