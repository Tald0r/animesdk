...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONBASEMONO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18045510)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONBASEMONO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18045470)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONBASEMONO_UPDATETRANSITION_OFFSET UNITYSDK_OFFSET(0x18045400)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONBASEMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x180455B0)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int WeatherTransitionBaseMono_TypeDefinitionIndex = 28843;
