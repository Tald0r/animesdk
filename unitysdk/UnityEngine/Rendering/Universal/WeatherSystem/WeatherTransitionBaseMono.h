...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONBASEMONO_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x186675A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONBASEMONO_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18667500)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONBASEMONO_UPDATETRANSITION_OFFSET UNITYSDK_OFFSET(0x18667490)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONBASEMONO__CTOR_OFFSET UNITYSDK_OFFSET(0x18667640)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int WeatherTransitionBaseMono_TypeDefinitionIndex = 29792;
