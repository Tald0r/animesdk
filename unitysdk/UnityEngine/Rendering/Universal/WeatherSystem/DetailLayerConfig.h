...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_DETAILLAYERCONFIG_DOLERP_OFFSET UNITYSDK_OFFSET(0x187D3C20)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_DETAILLAYERCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x187D3F10)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int DetailLayerConfig_TypeDefinitionIndex = 28827;
