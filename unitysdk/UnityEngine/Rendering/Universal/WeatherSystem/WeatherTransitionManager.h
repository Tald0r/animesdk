...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER_CLEANUPNULLREFERENCES_OFFSET UNITYSDK_OFFSET(0x18B53770)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER_GETREGISTEREDCOUNT_OFFSET UNITYSDK_OFFSET(0x18B53E70)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18B53220)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x18B535D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x18B53960)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER_UPDATEWEATHERTRANSITION_OFFSET UNITYSDK_OFFSET(0x18B53AC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18B53FB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_WEATHERTRANSITIONMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B53510)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int WeatherTransitionManager_TypeDefinitionIndex = 28844;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::WeatherSystem::WeatherTransitionManager**)Il2CppClass::FromTypeDefinitionIndex(WeatherTransitionManager_TypeDefinitionIndex)->GetStaticField(0x21F70);
		}
		static ::System::Object** StaticGet__lock()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(WeatherTransitionManager_TypeDefinitionIndex)->GetStaticField(0x21F78);
		}
