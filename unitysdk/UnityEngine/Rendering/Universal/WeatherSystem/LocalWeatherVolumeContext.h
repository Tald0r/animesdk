...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERSYSTEM_LOCALWEATHERVOLUMECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x18667480)

namespace UnityEngine::Rendering::Universal::WeatherSystem
{
	inline static constexpr unsigned int LocalWeatherVolumeContext_TypeDefinitionIndex = 29752;
