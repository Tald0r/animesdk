...
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_CLEARCOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0x19FB3E00)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_CLEARRWTEXTURE3DFLOAT_OFFSET UNITYSDK_OFFSET(0x19FB4430)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_CLEARRWTEXTURE3D_OFFSET UNITYSDK_OFFSET(0x19FB4080)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_DISPATCHCOMPUTE_1_OFFSET UNITYSDK_OFFSET(0x19FB4980)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_DISPATCHCOMPUTE_OFFSET UNITYSDK_OFFSET(0x19FB4860)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_GET_CLEARCS_OFFSET UNITYSDK_OFFSET(0x19FB3D80)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_SET_CLEARCS_OFFSET UNITYSDK_OFFSET(0x19FB3DC0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LyraUtils_TypeDefinitionIndex = 28566;
	...
	public:
		...
		{
			return (::UnityEngine::ComputeShader**)Il2CppClass::FromTypeDefinitionIndex(LyraUtils_TypeDefinitionIndex)->GetStaticField(0x22570);
		}
