...
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_CLEARCOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0x1A2EE740)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_CLEARRWTEXTURE3DFLOAT_OFFSET UNITYSDK_OFFSET(0x1A2EED70)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_CLEARRWTEXTURE3D_OFFSET UNITYSDK_OFFSET(0x1A2EE9C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_DISPATCHCOMPUTE_1_OFFSET UNITYSDK_OFFSET(0x1A2EF2C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_DISPATCHCOMPUTE_OFFSET UNITYSDK_OFFSET(0x1A2EF1A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_GET_CLEARCS_OFFSET UNITYSDK_OFFSET(0x1A2EE6C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LYRAUTILS_SET_CLEARCS_OFFSET UNITYSDK_OFFSET(0x1A2EE700)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LyraUtils_TypeDefinitionIndex = 29509;
	...
	public:
		...
		{
			return (::UnityEngine::ComputeShader**)Il2CppClass::FromTypeDefinitionIndex(LyraUtils_TypeDefinitionIndex)->GetStaticField(0x23FA0);
		}
