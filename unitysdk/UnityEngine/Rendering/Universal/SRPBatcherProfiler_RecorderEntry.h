...
#define UNITYENGINE_RENDERING_UNIVERSAL_SRPBATCHERPROFILER_RECORDERENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x19B29440)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SRPBatcherProfiler_RecorderEntry_TypeDefinitionIndex = 28426;
