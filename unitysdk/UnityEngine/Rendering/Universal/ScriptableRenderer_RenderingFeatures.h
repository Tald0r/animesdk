...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERER_RENDERINGFEATURES_GET_CAMERASTACKING_OFFSET UNITYSDK_OFFSET(0x17BFB140)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERER_RENDERINGFEATURES_SET_CAMERASTACKING_OFFSET UNITYSDK_OFFSET(0x17BFB150)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCRIPTABLERENDERER_RENDERINGFEATURES__CTOR_OFFSET UNITYSDK_OFFSET(0x17BFB160)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScriptableRenderer_RenderingFeatures_TypeDefinitionIndex = 28748;
