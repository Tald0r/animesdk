...
#define UNITYENGINE_RENDERING_UNIVERSAL_SSRQUALITYPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x17969910)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int SsrQualityParameter_TypeDefinitionIndex = 28699;
