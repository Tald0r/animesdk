...
#define UNITYENGINE_RENDERING_UNIVERSAL_COMICDOTTYPEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x183B89E0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ComicDotTypeParameter_TypeDefinitionIndex = 28413;
