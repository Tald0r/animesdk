...
#define UNITYENGINE_RENDERING_UNIVERSAL_AMPLIFYOCCLUSIONPASS_NOTNATIVE_HISTORYBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x18B32A90)
#define UNITYENGINE_RENDERING_UNIVERSAL_AMPLIFYOCCLUSIONPASS_NOTNATIVE_HISTORYBUFFER_RELOCATEIFNEEDED_OFFSET UNITYSDK_OFFSET(0x18B32B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_AMPLIFYOCCLUSIONPASS_NOTNATIVE_HISTORYBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B33070)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int AmplifyOcclusionPass_NotNative_HistoryBuffer_TypeDefinitionIndex = 29659;
