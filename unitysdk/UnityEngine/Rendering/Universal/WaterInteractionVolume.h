...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x17830E90)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_GET_WATERHEIGHT_OFFSET UNITYSDK_OFFSET(0x17830F60)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17831300)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17831190)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17831020)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x17831370)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_REGISTERTOMANAGER_OFFSET UNITYSDK_OFFSET(0x17831070)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_UNREGISTERFROMMANAGER_OFFSET UNITYSDK_OFFSET(0x178311E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_UPDATEMANAGER_OFFSET UNITYSDK_OFFSET(0x178313C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x17831490)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterInteractionVolume_TypeDefinitionIndex = 29416;
