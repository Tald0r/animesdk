...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x17B95A50)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_GET_WATERHEIGHT_OFFSET UNITYSDK_OFFSET(0x17B95B20)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x17B95EC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17B95D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17B95BE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x17B95F30)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_REGISTERTOMANAGER_OFFSET UNITYSDK_OFFSET(0x17B95C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_UNREGISTERFROMMANAGER_OFFSET UNITYSDK_OFFSET(0x17B95DA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME_UPDATEMANAGER_OFFSET UNITYSDK_OFFSET(0x17B95F80)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIONVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x17B96050)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterInteractionVolume_TypeDefinitionIndex = 28473;
