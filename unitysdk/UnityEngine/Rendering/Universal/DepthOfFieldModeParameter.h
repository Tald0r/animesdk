...
#define UNITYENGINE_RENDERING_UNIVERSAL_DEPTHOFFIELDMODEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x18390700)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int DepthOfFieldModeParameter_TypeDefinitionIndex = 28647;
