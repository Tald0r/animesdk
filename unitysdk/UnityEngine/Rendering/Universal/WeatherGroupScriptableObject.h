...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_GETWEATHERBYKEYWITHDEFAULTSET_OFFSET UNITYSDK_OFFSET(0x18666450)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_GETWEATHERBYKEYWITHOUTDEFAULTSET_OFFSET UNITYSDK_OFFSET(0x18665C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_GETWEATHERBYKEY_OFFSET UNITYSDK_OFFSET(0x18665E20)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ISKEYEXISTS_OFFSET UNITYSDK_OFFSET(0x18665CA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ONCLEARCACHE_OFFSET UNITYSDK_OFFSET(0x18666AF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18666B40)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x186664C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18666780)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18666B90)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherGroupScriptableObject_TypeDefinitionIndex = 29469;
