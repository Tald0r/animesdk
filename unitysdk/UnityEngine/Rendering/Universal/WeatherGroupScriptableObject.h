...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_GETWEATHERBYKEYWITHDEFAULTSET_OFFSET UNITYSDK_OFFSET(0x180443D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_GETWEATHERBYKEYWITHOUTDEFAULTSET_OFFSET UNITYSDK_OFFSET(0x18043BB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_GETWEATHERBYKEY_OFFSET UNITYSDK_OFFSET(0x18043DA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ISKEYEXISTS_OFFSET UNITYSDK_OFFSET(0x18043C20)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ONCLEARCACHE_OFFSET UNITYSDK_OFFSET(0x18044A70)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18044AC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ONDISPOSE_OFFSET UNITYSDK_OFFSET(0x18044440)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18044700)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERGROUPSCRIPTABLEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x18044B10)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherGroupScriptableObject_TypeDefinitionIndex = 28526;
