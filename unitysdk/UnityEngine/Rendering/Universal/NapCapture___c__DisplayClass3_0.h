...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTURE___C__DISPLAYCLASS3_0__CAPTURE_B__0_OFFSET UNITYSDK_OFFSET(0x19B27180)
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPTURE___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19B27170)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCapture___c__DisplayClass3_0_TypeDefinitionIndex = 28725;
	...
	public:
		...
		::System::Action* finishedAction; // 0x28
		::UnityEngine::Rendering::Universal::NapCapture* __4__this; // 0x30
		::UnityEngine::Rendering::Universal::UniversalAdditionalCameraData* cameraData; // 0x38
		::System::Boolean srgb; // 0x40
		::System::Int32 downSample; // 0x44
		::System::Single blurRadius; // 0x48
		::System::Int32 propertyID; // 0x4C
