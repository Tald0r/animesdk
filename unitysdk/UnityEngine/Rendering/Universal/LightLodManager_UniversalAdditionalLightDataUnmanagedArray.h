...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x7D3080)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_CREATECONSTLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1766FB60)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_CREATEMUTABLELIGHTDATA_OFFSET UNITYSDK_OFFSET(0x1766FF80)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7D30A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_GET_DYNAMICLIGHTCOUNT_OFFSET UNITYSDK_OFFSET(0x7D3060)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_INITALLOCATE_OFFSET UNITYSDK_OFFSET(0x7D3070)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_REMOVEATSWAPBACK_OFFSET UNITYSDK_OFFSET(0x7D3090)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LightLodManager_UniversalAdditionalLightDataUnmanagedArray_TypeDefinitionIndex = 29496;
