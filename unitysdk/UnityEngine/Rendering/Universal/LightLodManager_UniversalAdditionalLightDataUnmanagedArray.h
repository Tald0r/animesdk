...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_ADD_OFFSET UNITYSDK_OFFSET(0x795750)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_CREATECONSTLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x16F9DFE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_CREATEMUTABLELIGHTDATA_OFFSET UNITYSDK_OFFSET(0x16F9E400)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x795770)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_GET_DYNAMICLIGHTCOUNT_OFFSET UNITYSDK_OFFSET(0x795730)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_INITALLOCATE_OFFSET UNITYSDK_OFFSET(0x795740)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTLODMANAGER_UNIVERSALADDITIONALLIGHTDATAUNMANAGEDARRAY_REMOVEATSWAPBACK_OFFSET UNITYSDK_OFFSET(0x795760)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LightLodManager_UniversalAdditionalLightDataUnmanagedArray_TypeDefinitionIndex = 28553;
