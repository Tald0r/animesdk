...
#define UNITYENGINE_RENDERING_UNIVERSAL_CULLING__CTOR_OFFSET UNITYSDK_OFFSET(0x196E2870)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int Culling_TypeDefinitionIndex = 28643;
