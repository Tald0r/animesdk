...
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x17968E60)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_CORRECTID_OFFSET UNITYSDK_OFFSET(0x17968820)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_GENERATEID_OFFSET UNITYSDK_OFFSET(0x17968EF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_GET_ID_OFFSET UNITYSDK_OFFSET(0x179687C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_GET_OFFSET UNITYSDK_OFFSET(0x17968890)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17968DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_TRYADDTHIS_1_OFFSET UNITYSDK_OFFSET(0x17968D10)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_TRYADDTHIS_OFFSET UNITYSDK_OFFSET(0x17968AE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x179690A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17969080)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int RedirectComponent_TypeDefinitionIndex = 28619;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::UnityEngine::MonoBehaviour*>*>**)Il2CppClass::FromTypeDefinitionIndex(RedirectComponent_TypeDefinitionIndex)->GetStaticField(0x210A0);
		}
