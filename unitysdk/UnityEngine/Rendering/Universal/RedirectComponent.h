...
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x17790EA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_CORRECTID_OFFSET UNITYSDK_OFFSET(0x17790860)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_GENERATEID_OFFSET UNITYSDK_OFFSET(0x17790F30)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_GET_ID_OFFSET UNITYSDK_OFFSET(0x17790800)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_GET_OFFSET UNITYSDK_OFFSET(0x177908D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17790DF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_TRYADDTHIS_1_OFFSET UNITYSDK_OFFSET(0x17790D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT_TRYADDTHIS_OFFSET UNITYSDK_OFFSET(0x17790B20)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x177910E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_REDIRECTCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x177910C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int RedirectComponent_TypeDefinitionIndex = 29562;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Collections::Generic::List_1<::UnityEngine::MonoBehaviour*>*>**)Il2CppClass::FromTypeDefinitionIndex(RedirectComponent_TypeDefinitionIndex)->GetStaticField(0x22710);
		}
