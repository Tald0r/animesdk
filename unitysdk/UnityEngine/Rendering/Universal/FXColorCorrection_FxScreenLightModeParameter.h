...
#define UNITYENGINE_RENDERING_UNIVERSAL_FXCOLORCORRECTION_FXSCREENLIGHTMODEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x187BC6D0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FXColorCorrection_FxScreenLightModeParameter_TypeDefinitionIndex = 28408;
