...
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAREPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x18F03710)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FlareProfile_TypeDefinitionIndex = 29597;
