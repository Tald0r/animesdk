...
#define UNITYENGINE_RENDERING_UNIVERSAL_FLAREPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B407F0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FlareProfile_TypeDefinitionIndex = 28654;
