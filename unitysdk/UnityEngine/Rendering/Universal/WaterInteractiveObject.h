...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_COLLECTRENDERERS_OFFSET UNITYSDK_OFFSET(0x19EDE970)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19EDF690)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19EDF5E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19EDF320)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19EDE7B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19EDF240)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERINTERACTIVEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19EDFD50)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterInteractiveObject_TypeDefinitionIndex = 29419;
