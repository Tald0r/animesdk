...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ANTIFLICKERMODEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1795DDA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ANTIFLICKERMODEPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1795DD20)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ANTIFLICKERMODEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1795DDB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_ANTIFLICKERMODEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1795DDC0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_AntiFlickerModeParameter_TypeDefinitionIndex = 28573;
