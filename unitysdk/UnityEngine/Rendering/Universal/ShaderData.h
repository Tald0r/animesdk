...
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_DISPOSEBUFFER_OFFSET UNITYSDK_OFFSET(0x18B4F3E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18B4F0E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_GETLIGHTDATABUFFER_OFFSET UNITYSDK_OFFSET(0x18B4F480)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_GETLIGHTINDICESBUFFER_OFFSET UNITYSDK_OFFSET(0x18B4F4E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_GETSHADOWDATABUFFER_OFFSET UNITYSDK_OFFSET(0x18B4F540)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_GETSHADOWINDICESBUFFER_OFFSET UNITYSDK_OFFSET(0x18B4F5A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18B4F070)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x18B4F600)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x18B4F060)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ShaderData_TypeDefinitionIndex = 29698;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::ShaderData**)Il2CppClass::FromTypeDefinitionIndex(ShaderData_TypeDefinitionIndex)->GetStaticField(0x237B0);
		}
		::UnityEngine::ComputeBuffer* m_ShadowDataBuffer; // 0x10
		::UnityEngine::ComputeBuffer* m_ShadowIndicesBuffer; // 0x18
		::UnityEngine::ComputeBuffer* m_LightIndicesBuffer; // 0x20
