...
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_DISPOSEBUFFER_OFFSET UNITYSDK_OFFSET(0x185E6B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x185E6890)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_GETLIGHTDATABUFFER_OFFSET UNITYSDK_OFFSET(0x185E6C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_GETLIGHTINDICESBUFFER_OFFSET UNITYSDK_OFFSET(0x185E6C90)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_GETSHADOWDATABUFFER_OFFSET UNITYSDK_OFFSET(0x185E6CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_GETSHADOWINDICESBUFFER_OFFSET UNITYSDK_OFFSET(0x185E6D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x185E6820)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x185E6DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x185E6810)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ShaderData_TypeDefinitionIndex = 28752;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::Universal::ShaderData**)Il2CppClass::FromTypeDefinitionIndex(ShaderData_TypeDefinitionIndex)->GetStaticField(0x21E60);
		}
