...
#define UNITYENGINE_RENDERING_UNIVERSAL_PANINIPROJECTION_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19B27E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_PANINIPROJECTION_ISTILECOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x19B27EE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_PANINIPROJECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19B27F20)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int PaniniProjection_TypeDefinitionIndex = 28679;
