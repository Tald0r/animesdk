...
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_ADD_ONWILLRENDERCAMERA_OFFSET UNITYSDK_OFFSET(0x183C0BE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_AFMEENABLEOFFSCREENUI_OFFSET UNITYSDK_OFFSET(0x183D5C60)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_AREPOSTPROCESSESENABLED_OFFSET UNITYSDK_OFFSET(0x183D2EB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_CHECKHISTORYDATA_OFFSET UNITYSDK_OFFSET(0x183D03E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_CLEARNAPTIME_OFFSET UNITYSDK_OFFSET(0x183D5060)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_CREATEPEROBJECTSHADOWCONFIG_OFFSET UNITYSDK_OFFSET(0x183C47A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_CREATERENDERTEXTUREDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x183C7E40)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183C5EA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GETBLITMATERIAL_OFFSET UNITYSDK_OFFSET(0x183D5870)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GETCAMERAPROFILERTAG_OFFSET UNITYSDK_OFFSET(0x183CDB40)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GETGPUQUERYRESULT_OFFSET UNITYSDK_OFFSET(0x183D0A20)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GETINTERPOLATEDVOLUMESTACKCOMPONENT_OFFSET UNITYSDK_OFFSET(0x183CDEA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GETMAINLIGHTINDEXWITHLOCALSHADOWCACHE_OFFSET UNITYSDK_OFFSET(0x183D4910)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GETPEROBJECTLIGHTFLAGS_OFFSET UNITYSDK_OFFSET(0x183D3B20)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x183C0FA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_ENABLEGPUQUERY_OFFSET UNITYSDK_OFFSET(0x183C0DA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MAINLIGHTOBJECT_OFFSET UNITYSDK_OFFSET(0x183C0AE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MAXRENDERSCALE_OFFSET UNITYSDK_OFFSET(0x183C0AC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MAXSCRIPTABLERENDERERS_OFFSET UNITYSDK_OFFSET(0x183C0AD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MAXSHADOWBIAS_OFFSET UNITYSDK_OFFSET(0x183C0A80)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MAXSHADOWKERNEL_OFFSET UNITYSDK_OFFSET(0x183C0AA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MINRENDERSCALE_OFFSET UNITYSDK_OFFSET(0x183C0AB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_MINSHADOWKERNEL_OFFSET UNITYSDK_OFFSET(0x183C0A90)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_GET_S_PUNCTUALSHADOWATLASSIZESCALE_OFFSET UNITYSDK_OFFSET(0x183C0DC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITDAMAGETEXTSYSTEM_OFFSET UNITYSDK_OFFSET(0x183C44D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZEADDITIONALCAMERADATA_OFFSET UNITYSDK_OFFSET(0x183D0BF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZECAMERADATA_OFFSET UNITYSDK_OFFSET(0x183CC7D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZELIGHTDATA_OFFSET UNITYSDK_OFFSET(0x183D32E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZENAPRENDERPIPELINE_OFFSET UNITYSDK_OFFSET(0x183C3C80)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZEPOSTCULLLIGHTDATA_OFFSET UNITYSDK_OFFSET(0x183D4C30)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZEPOSTCULLRENDERINGDATA_NATIVED_OFFSET UNITYSDK_OFFSET(0x183D0090)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZEPOSTCULLRENDERINGDATA_OFFSET UNITYSDK_OFFSET(0x183D3B60)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZEPOSTPROCESSINGDATA_OFFSET UNITYSDK_OFFSET(0x183D3AB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZERENDERINGDATA_OFFSET UNITYSDK_OFFSET(0x183CE160)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZESHADOWDATA_OFFSET UNITYSDK_OFFSET(0x183D33F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INITIALIZESTACKEDCAMERADATA_OFFSET UNITYSDK_OFFSET(0x183D2730)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_INIT_OFFSET UNITYSDK_OFFSET(0x183C4760)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_ISGAMECAMERA_OFFSET UNITYSDK_OFFSET(0x183C9E60)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_ISMULTIPASSSTEREOENABLED_OFFSET UNITYSDK_OFFSET(0x183D5D60)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_ISSTEREOENABLED_OFFSET UNITYSDK_OFFSET(0x183CDF70)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_MARKCAMERAFINALTARGET_OFFSET UNITYSDK_OFFSET(0x183C9B40)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_OVERRIDECAMERADATAWITHRENDERINGDATA_OFFSET UNITYSDK_OFFSET(0x183D3290)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_QUERYMAINLIGHTSLOW_OFFSET UNITYSDK_OFFSET(0x183D2EF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_REFRESHOPTOPTIONS_OFFSET UNITYSDK_OFFSET(0x183C45C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_REGISTERDECALSIMPLE_OFFSET UNITYSDK_OFFSET(0x183D58B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_REGISTERVOLUMETYPES_OFFSET UNITYSDK_OFFSET(0x183C1930)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_REMOVE_ONWILLRENDERCAMERA_OFFSET UNITYSDK_OFFSET(0x183C0CC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_RENDERCAMERASTACK_OFFSET UNITYSDK_OFFSET(0x183C9F30)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_RENDERCUSTOMSINGLECAMERA_OFFSET UNITYSDK_OFFSET(0x183CC240)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_RENDERSINGLECAMERA_1_OFFSET UNITYSDK_OFFSET(0x183CC890)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_RENDERSINGLECAMERA_OFFSET UNITYSDK_OFFSET(0x183CBA70)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_RENDER_OFFSET UNITYSDK_OFFSET(0x183C65E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_RESETDECALSIMPLERENDERQUEUE_OFFSET UNITYSDK_OFFSET(0x183D5B90)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SETSUPPORTEDRENDERINGFEATURES_OFFSET UNITYSDK_OFFSET(0x183C4490)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SETUPNAPTIME_OFFSET UNITYSDK_OFFSET(0x183D50D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SETUPPERFRAMECONSTANTS_OFFSET UNITYSDK_OFFSET(0x183C8820)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SETUPPERFRAMESHADERCONSTANTS_OFFSET UNITYSDK_OFFSET(0x183C8DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SETUPPERFRAMESHADERKEYWORDS_OFFSET UNITYSDK_OFFSET(0x183C9830)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SETUPSHADERFEATUREMAPPINGS_OFFSET UNITYSDK_OFFSET(0x183C5B80)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SET_ENABLEGPUQUERY_OFFSET UNITYSDK_OFFSET(0x183C0DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SET_MAINLIGHTOBJECT_OFFSET UNITYSDK_OFFSET(0x183C0B80)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SET_S_PUNCTUALSHADOWATLASSIZESCALE_OFFSET UNITYSDK_OFFSET(0x183C1020)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SORTCAMERAS_OFFSET UNITYSDK_OFFSET(0x183C9A70)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_SORTOTHERLIGHT_OFFSET UNITYSDK_OFFSET(0x183D4DF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_TRIMUNUSEDCAMERAPROFILINGSAMPLERS_OFFSET UNITYSDK_OFFSET(0x183C8470)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_TRYSCHEDULESRPHELPER_OFFSET UNITYSDK_OFFSET(0x183CFFE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_UNREGISTERDECALSIMPLE_OFFSET UNITYSDK_OFFSET(0x183D59A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_UPDATECAMERASHADERCOMPILERSTAMPS_OFFSET UNITYSDK_OFFSET(0x183C9940)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE_UPDATEVOLUMEFRAMEWORK_OFFSET UNITYSDK_OFFSET(0x183CC430)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE__CCTOR_OFFSET UNITYSDK_OFFSET(0x183C1200)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x183C3600)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE__MARKCAMERAFINALTARGET_G__GETORADDADDITIONALCAMERADATA_45_1_OFFSET UNITYSDK_OFFSET(0x183CBD60)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE__MARKCAMERAFINALTARGET_G__MARKUIBLURSTATES_45_0_OFFSET UNITYSDK_OFFSET(0x183CBEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_UNIVERSALRENDERPIPELINE___BASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183D5E50)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int UniversalRenderPipeline_TypeDefinitionIndex = 28785;
	...
	public:
		...
		{
			return (::System::Action_1<::UnityEngine::Camera*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x21980);
		}
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::System::Collections::Generic::KeyValuePair_2<::System::Single, ::System::Int32>>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x21988);
		}
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::NAPRenderPipeline0::NativeAdditionalLightData_NativeSRP*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x21990);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SampleInitializeCameraData()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x21998);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SampleRenderSingleCamera()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x219A0);
		}
		static ::UnityEngine::Rendering::Unversal::SRPHelperExecuteContext** StaticGet_helperExecuteContext()
		{
			return (::UnityEngine::Rendering::Unversal::SRPHelperExecuteContext**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x219A8);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Camera*>** StaticGet_s_CamerasToDeleteFromSamplerCache()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Camera*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x219B0);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int64, ::UnityEngine::Rendering::Universal::UniversalRenderPipeline_TempLightData>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x219B8);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::Material*>** StaticGet_s_DecalSimpleMaterialPool()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x219C0);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::Light*>** StaticGet_CachedMainLight()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::Light*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x219C8);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Camera*, ::UnityEngine::Profiling::CustomSampler*>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x219D0);
		}
		static ::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::System::Int32>** StaticGet_CachedVisibleLightData()
		{
			return (::UnityEngine::NAPRenderPipeline0::DynamicArray_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x219D8);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SampleUpdateVolumeFramework()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x219E0);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SampleGetMainLightIndexWithLocalShadowCache()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x219E8);
		}
		static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_SamplePerObjectShadowUpdateTargets()
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x219F0);
		}
		static ::UnityEngine::Experimental::GlobalIllumination::Lightmapping_RequestLightsDelegate** StaticGet_lightsDelegate()
		{
			return (::UnityEngine::Experimental::GlobalIllumination::Lightmapping_RequestLightsDelegate**)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x219F8);
		}
		static ::System::Int64* StaticGet_lastToonLightErrorTime()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x6270);
		}
		static ::UnityEngine::Vector4* StaticGet__napTime()
		{
			return (::UnityEngine::Vector4*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x6278);
		}
		static ::System::Boolean* StaticGet_s_LastUseNativePerObjectShadow()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x6288);
		}
		static ::System::Boolean* StaticGet_requiresSRGBConversion()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x6289);
		}
		static ::System::Boolean* StaticGet_s_UseNativePerObjectShadowInitialized()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x628A);
		}
		static ::System::Boolean* StaticGet_showOverdrawInfo()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x628B);
		}
		static ::UnityEngine::Vector4* StaticGet__napTimeFaster()
		{
			return (::UnityEngine::Vector4*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x628C);
		}
		static ::System::Single* StaticGet_s_QueryResult()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x629C);
		}
		static ::System::Int32* StaticGet_LaunchSRPHelperStage()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x62A0);
		}
		static ::System::Int32* StaticGet_s_DecalSimpleRenderQueue()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x62A4);
		}
		static ::System::Int64* StaticGet_preFrameCount()
		{
			return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(UniversalRenderPipeline_TypeDefinitionIndex)->GetStaticField(0x62A8);
		}
