...
#define UNITYENGINE_RENDERING_UNIVERSAL_DOWNSAMPLEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x17803300)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int DownSampleParameter_TypeDefinitionIndex = 29628;
