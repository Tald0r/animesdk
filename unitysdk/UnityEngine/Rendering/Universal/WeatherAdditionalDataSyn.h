...
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERADDITIONALDATASYN_DOSYNWEATHERADDITIONALDATA_OFFSET UNITYSDK_OFFSET(0x1A2F76C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERADDITIONALDATASYN_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A2F7610)
#define UNITYENGINE_RENDERING_UNIVERSAL_WEATHERADDITIONALDATASYN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F7820)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WeatherAdditionalDataSyn_TypeDefinitionIndex = 29432;
