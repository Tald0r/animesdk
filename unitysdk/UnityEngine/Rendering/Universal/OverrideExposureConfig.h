...
#define UNITYENGINE_RENDERING_UNIVERSAL_OVERRIDEEXPOSURECONFIG_DOLERP_OFFSET UNITYSDK_OFFSET(0x17BF91D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_OVERRIDEEXPOSURECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17BF9290)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int OverrideExposureConfig_TypeDefinitionIndex = 28522;
