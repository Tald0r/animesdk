...
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_BEGINOPERATE_1_OFFSET UNITYSDK_OFFSET(0x1966DBF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_BEGINOPERATE_OFFSET UNITYSDK_OFFSET(0x1966D1B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_ENDOPERATE_1_OFFSET UNITYSDK_OFFSET(0x1966DD90)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_ENDOPERATE_OFFSET UNITYSDK_OFFSET(0x1966DA20)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_FILTER_OFFSET UNITYSDK_OFFSET(0x1966DF30)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_GET_WORLDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1966D180)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1966DAB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_SET_WORLDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1966D1A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1966E390)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MonoCharacterGIMask_TypeDefinitionIndex = 29525;
