...
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_BEGINOPERATE_1_OFFSET UNITYSDK_OFFSET(0x19249510)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_BEGINOPERATE_OFFSET UNITYSDK_OFFSET(0x19248AD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_ENDOPERATE_1_OFFSET UNITYSDK_OFFSET(0x192496B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_ENDOPERATE_OFFSET UNITYSDK_OFFSET(0x19249340)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_FILTER_OFFSET UNITYSDK_OFFSET(0x19249850)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_GET_WORLDBOUNDS_OFFSET UNITYSDK_OFFSET(0x19248AA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_RAYCAST_OFFSET UNITYSDK_OFFSET(0x192493D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK_SET_WORLDBOUNDS_OFFSET UNITYSDK_OFFSET(0x19248AC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONOCHARACTERGIMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x19249CB0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MonoCharacterGIMask_TypeDefinitionIndex = 28582;
