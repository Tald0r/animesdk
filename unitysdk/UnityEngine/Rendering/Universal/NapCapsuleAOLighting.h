...
#define UNITYENGINE_RENDERING_UNIVERSAL_NAPCAPSULEAOLIGHTING__CTOR_OFFSET UNITYSDK_OFFSET(0x19B27110)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int NapCapsuleAOLighting_TypeDefinitionIndex = 28675;
