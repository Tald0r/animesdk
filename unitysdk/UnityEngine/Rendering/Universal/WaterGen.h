...
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_CLEANOCEANMATERIAL_OFFSET UNITYSDK_OFFSET(0x185E7440)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_CLEANUPMATERIALS_OFFSET UNITYSDK_OFFSET(0x185E8380)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_CLEANUP_OFFSET UNITYSDK_OFFSET(0x185E83F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_CREATEQUADMESH_OFFSET UNITYSDK_OFFSET(0x185E7C10)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_DRAWSTATICWATER_OFFSET UNITYSDK_OFFSET(0x185E75D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_DRAWUNDERWATERDEPTH_OFFSET UNITYSDK_OFFSET(0x185E7FE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_DRAWWATER_OFFSET UNITYSDK_OFFSET(0x185E79D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GETWATERMESHSTATSREF_OFFSET UNITYSDK_OFFSET(0x185D9620)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_ENABLEDEBUGCENTER_OFFSET UNITYSDK_OFFSET(0x185E7370)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_ENABLEFRUSTUMCULL_OFFSET UNITYSDK_OFFSET(0x185E7350)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x185D9470)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_MESHSTATS_OFFSET UNITYSDK_OFFSET(0x185E6E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_NEEDBAKEDMESH_OFFSET UNITYSDK_OFFSET(0x185E73B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_PIVOT_OFFSET UNITYSDK_OFFSET(0x185E73D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_PREVIEWBAKEDMESH_OFFSET UNITYSDK_OFFSET(0x185E7390)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_STATICWATERLOWMESH_OFFSET UNITYSDK_OFFSET(0x185E75B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_STATICWATERMESH_OFFSET UNITYSDK_OFFSET(0x185E7590)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_WATERGENON_OFFSET UNITYSDK_OFFSET(0x185DA450)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_WATERGENQUALITYLEVEL_OFFSET UNITYSDK_OFFSET(0x185E09A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_WATERMATERIALFARLOD_OFFSET UNITYSDK_OFFSET(0x185DBD60)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_WATERMATERIALNEARLOD_OFFSET UNITYSDK_OFFSET(0x185DC060)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_GET_WATERMATERIALNORMALLOD_OFFSET UNITYSDK_OFFSET(0x185DBA60)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_INIT_OFFSET UNITYSDK_OFFSET(0x185E7310)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_LOADSTATICWATERMESH_OFFSET UNITYSDK_OFFSET(0x185E6FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_ENABLEDEBUGCENTER_OFFSET UNITYSDK_OFFSET(0x185E7380)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_ENABLEFRUSTUMCULL_OFFSET UNITYSDK_OFFSET(0x185E7360)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_MESHSTATS_OFFSET UNITYSDK_OFFSET(0x185E6EB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_NEEDBAKEDMESH_OFFSET UNITYSDK_OFFSET(0x185E73C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_PREVIEWBAKEDMESH_OFFSET UNITYSDK_OFFSET(0x185E73A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_STATICWATERLOWMESH_OFFSET UNITYSDK_OFFSET(0x185E75C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_SET_STATICWATERMESH_OFFSET UNITYSDK_OFFSET(0x185E75A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_UNLOADSTATICWATERMESH_OFFSET UNITYSDK_OFFSET(0x185E71D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN_UPDATE_OFFSET UNITYSDK_OFFSET(0x185E0410)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN__CCTOR_OFFSET UNITYSDK_OFFSET(0x185E8490)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN__CTOR_OFFSET UNITYSDK_OFFSET(0x185E6EE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN__LOADSTATICWATERMESH_B__14_0_OFFSET UNITYSDK_OFFSET(0x185E85B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_WATERGEN__LOADSTATICWATERMESH_B__14_1_OFFSET UNITYSDK_OFFSET(0x185E85E0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int WaterGen_TypeDefinitionIndex = 28621;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(WaterGen_TypeDefinitionIndex)->GetStaticField(0x21E30);
		}
		static ::UnityEngine::Rendering::Universal::WaterGen** StaticGet_m_Instance()
		{
			return (::UnityEngine::Rendering::Universal::WaterGen**)Il2CppClass::FromTypeDefinitionIndex(WaterGen_TypeDefinitionIndex)->GetStaticField(0x21E38);
		}
		static ::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Boolean>** StaticGet_ShowWaterMeshStats()
		{
			return (::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(WaterGen_TypeDefinitionIndex)->GetStaticField(0x21E40);
		}
		static ::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Single>** StaticGet_WaterGenNodeEvalC()
		{
			return (::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(WaterGen_TypeDefinitionIndex)->GetStaticField(0x21E48);
		}
		static ::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Boolean>** StaticGet_EnableRTXGI()
		{
			return (::UnityEngine::NAPRenderPipeline0::ConsoleVariableT_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(WaterGen_TypeDefinitionIndex)->GetStaticField(0x21E50);
		}
		...
		::Foundation::AssetRequestHandle m_StaticMeshAssetHandle; // 0x80
		::UnityEngine::Material* m_WaterMaterialNormalLOD; // 0xA0
		::UnityEngine::Material* m_WaterMaterialNearLOD; // 0xA8
		::UnityEngine::Material* m_WaterMaterialFarLOD; // 0xB0
		::UnityEngine::Mesh* m_staticWaterMesh; // 0xB8
		::UnityEngine::Mesh* depthQuadMesh; // 0xC0
		::UnityEngine::Vector3 DebugCenter; // 0xC8
		::UnityEngine::Rendering::Universal::EWaterGenQuality m_LastWaterGenQualityLevel; // 0xD4
		::System::Boolean m_NeedBakedMesh; // 0xD8
		::System::Boolean m_EnableDebugCenter; // 0xD9
		::System::Boolean m_EnableFrustumCull; // 0xDA
		::System::Boolean m_PreviewBakedMesh; // 0xDB
		::UnityEngine::Matrix4x4 depthQuadWorldMatrix; // 0xDC
