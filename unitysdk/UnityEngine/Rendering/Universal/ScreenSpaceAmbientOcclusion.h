...
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_BILATERALUPSAMPLE_OFFSET UNITYSDK_OFFSET(0x17791430)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_BLURSHARPNESS_OFFSET UNITYSDK_OFFSET(0x17791390)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_DEBUGMODE_OFFSET UNITYSDK_OFFSET(0x17791490)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_DENOISERRADIUS_OFFSET UNITYSDK_OFFSET(0x177913F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_DENOISE_OFFSET UNITYSDK_OFFSET(0x177913D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_DIRECTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x17791470)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_DIRECTLIGHTINGSTRENGTH_OFFSET UNITYSDK_OFFSET(0x177912F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_FULLRESOLUTION_OFFSET UNITYSDK_OFFSET(0x17791330)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_GHOSTINGREDUCTION_OFFSET UNITYSDK_OFFSET(0x17791370)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_INTENSITY_OFFSET UNITYSDK_OFFSET(0x177912D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_MAXIMUMRADIUSINPIXELS_OFFSET UNITYSDK_OFFSET(0x17791450)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x17791310)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_SAMPLECOUNT_OFFSET UNITYSDK_OFFSET(0x177913B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_STEPCOUNT_OFFSET UNITYSDK_OFFSET(0x17791410)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_GET_TEMPORALACCUMULATION_OFFSET UNITYSDK_OFFSET(0x17791350)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x177914B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SCREENSPACEAMBIENTOCCLUSION__CTOR_OFFSET UNITYSDK_OFFSET(0x17791520)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ScreenSpaceAmbientOcclusion_TypeDefinitionIndex = 29359;
