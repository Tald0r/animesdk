...
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19B224E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19B22F90)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS_GET_MAT_OFFSET UNITYSDK_OFFSET(0x19B223F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B23070)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19B22420)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19B230B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ExtraMotionVectorPass_TypeDefinitionIndex = 28718;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ExtraMotionVectorPass_TypeDefinitionIndex)->GetStaticField(0x6AF0);
		}
