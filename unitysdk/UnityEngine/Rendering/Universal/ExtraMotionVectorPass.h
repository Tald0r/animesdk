...
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19ED3B30)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19ED45E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS_GET_MAT_OFFSET UNITYSDK_OFFSET(0x19ED3A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19ED46C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19ED3A70)
#define UNITYENGINE_RENDERING_UNIVERSAL_EXTRAMOTIONVECTORPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19ED4700)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ExtraMotionVectorPass_TypeDefinitionIndex = 29664;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ExtraMotionVectorPass_TypeDefinitionIndex)->GetStaticField(0x7240);
		}
