...
#define UNITYENGINE_RENDERING_UNIVERSAL_MONORENDERENTITYWRAPPER_GETNAPRENDERENTITY_OFFSET UNITYSDK_OFFSET(0x18918DF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONORENDERENTITYWRAPPER_GETNAPRENDERER_OFFSET UNITYSDK_OFFSET(0x18919070)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONORENDERENTITYWRAPPER_INIT_OFFSET UNITYSDK_OFFSET(0x18918E50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONORENDERENTITYWRAPPER_SETHEADBONE_OFFSET UNITYSDK_OFFSET(0x18919000)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONORENDERENTITYWRAPPER_SETMIDDLEPOINT_OFFSET UNITYSDK_OFFSET(0x18918F90)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONORENDERENTITYWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x18919170)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MonoRenderEntityWrapper_TypeDefinitionIndex = 29543;
