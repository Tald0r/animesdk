...
#define UNITYENGINE_RENDERING_UNIVERSAL_LAYERSHADOWCULLINGDISTANCES_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x18661E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_LAYERSHADOWCULLINGDISTANCES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18661EF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LAYERSHADOWCULLINGDISTANCES__CTOR_OFFSET UNITYSDK_OFFSET(0x18661EC0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LayerShadowCullingDistances_TypeDefinitionIndex = 29297;
