...
#define UNITYENGINE_RENDERING_UNIVERSAL_LAYERSHADOWCULLINGDISTANCES_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1803FE00)
#define UNITYENGINE_RENDERING_UNIVERSAL_LAYERSHADOWCULLINGDISTANCES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1803FE70)
#define UNITYENGINE_RENDERING_UNIVERSAL_LAYERSHADOWCULLINGDISTANCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1803FE40)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LayerShadowCullingDistances_TypeDefinitionIndex = 28356;
