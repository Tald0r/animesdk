...
#define UNITYENGINE_RENDERING_UNIVERSAL_STATICENVIRONMENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17BFB170)
#define UNITYENGINE_RENDERING_UNIVERSAL_STATICENVIRONMENT_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x17BFB810)
#define UNITYENGINE_RENDERING_UNIVERSAL_STATICENVIRONMENT_REFRESH_OFFSET UNITYSDK_OFFSET(0x17BFB5D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_STATICENVIRONMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17BFB850)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int StaticEnvironment_TypeDefinitionIndex = 28703;
