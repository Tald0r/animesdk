...
#define UNITYENGINE_RENDERING_UNIVERSAL_STATICENVIRONMENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x182E37B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_STATICENVIRONMENT_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x182E3E50)
#define UNITYENGINE_RENDERING_UNIVERSAL_STATICENVIRONMENT_REFRESH_OFFSET UNITYSDK_OFFSET(0x182E3C10)
#define UNITYENGINE_RENDERING_UNIVERSAL_STATICENVIRONMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x182E3E90)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int StaticEnvironment_TypeDefinitionIndex = 29646;
