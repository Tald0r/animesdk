...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19FB5160)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19FB54E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS_GETASPECT_OFFSET UNITYSDK_OFFSET(0x19FB4CF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS_GETCAMERAHEIGHT_OFFSET UNITYSDK_OFFSET(0x19FB4C60)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS_GETCAMERAWIDTH_OFFSET UNITYSDK_OFFSET(0x19FB4C10)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS_GETOVERWRITEDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19FB4E30)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS_GETOVERWRITEDIMENSION_OFFSET UNITYSDK_OFFSET(0x19FB4E70)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS_GETOVERWRITEVOLUMEDEPTH_OFFSET UNITYSDK_OFFSET(0x19FB4EC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS_GETSTEREOENABLED_OFFSET UNITYSDK_OFFSET(0x19FB4CB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS_GETTARGETTEXTURE_OFFSET UNITYSDK_OFFSET(0x19FB4F10)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS_GETWORLDTOCAMERAMATRIX_OFFSET UNITYSDK_OFFSET(0x19FB4D50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x19FB5040)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x19FB4FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLAREPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x19FB5560)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlarePass_TypeDefinitionIndex = 28720;
