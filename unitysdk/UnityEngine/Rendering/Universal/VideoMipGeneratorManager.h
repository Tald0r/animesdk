...
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATORMANAGER_CLEARUSEOFRT_OFFSET UNITYSDK_OFFSET(0x18932350)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATORMANAGER_ONPRERENDERPROXYLIST_OFFSET UNITYSDK_OFFSET(0x1892BF60)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATORMANAGER_REGISTERPROXY_OFFSET UNITYSDK_OFFSET(0x189320B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATORMANAGER_UNREGISTERPROXY_OFFSET UNITYSDK_OFFSET(0x18932190)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATORMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x189327B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATORMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x189327A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int VideoMipGeneratorManager_TypeDefinitionIndex = 29386;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::UnityEngine::Rendering::Universal::VideoMipGenerator*>**)Il2CppClass::FromTypeDefinitionIndex(VideoMipGeneratorManager_TypeDefinitionIndex)->GetStaticField(0x23460);
		}
