...
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATORMANAGER_CLEARUSEOFRT_OFFSET UNITYSDK_OFFSET(0x183D6100)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATORMANAGER_ONPRERENDERPROXYLIST_OFFSET UNITYSDK_OFFSET(0x183CFE10)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATORMANAGER_REGISTERPROXY_OFFSET UNITYSDK_OFFSET(0x183D5E60)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATORMANAGER_UNREGISTERPROXY_OFFSET UNITYSDK_OFFSET(0x183D5F40)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATORMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x183D6560)
#define UNITYENGINE_RENDERING_UNIVERSAL_VIDEOMIPGENERATORMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x183D6550)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int VideoMipGeneratorManager_TypeDefinitionIndex = 28443;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::UnityEngine::Rendering::Universal::VideoMipGenerator*>**)Il2CppClass::FromTypeDefinitionIndex(VideoMipGeneratorManager_TypeDefinitionIndex)->GetStaticField(0x21B10);
		}
