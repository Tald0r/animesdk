...
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_CLEARCACHEDSHADERCONFIGS_OFFSET UNITYSDK_OFFSET(0x196E3420)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x196E3030)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GETALLSHADERCONFIGS_OFFSET UNITYSDK_OFFSET(0x196E3810)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GETSHADERCONFIG_OFFSET UNITYSDK_OFFSET(0x196E34C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GET_DEFAULTSTENCILSTATE_OFFSET UNITYSDK_OFFSET(0x196E31B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GET_OPAQUELAYERMASK_OFFSET UNITYSDK_OFFSET(0x196E3090)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GET_SHADOWTRANSPARENTRECEIVE_OFFSET UNITYSDK_OFFSET(0x196E3240)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GET_TRANSPARENTLAYERMASK_OFFSET UNITYSDK_OFFSET(0x196E3120)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_LOGALLSHADERCONFIGS_OFFSET UNITYSDK_OFFSET(0x196E3860)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x196E32D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_SET_DEFAULTSTENCILSTATE_OFFSET UNITYSDK_OFFSET(0x196E31C0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_SET_OPAQUELAYERMASK_OFFSET UNITYSDK_OFFSET(0x196E30A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_SET_SHADOWTRANSPARENTRECEIVE_OFFSET UNITYSDK_OFFSET(0x196E3250)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_SET_TRANSPARENTLAYERMASK_OFFSET UNITYSDK_OFFSET(0x196E3130)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x196E3D60)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x196E3E20)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ForwardRendererData_TypeDefinitionIndex = 28383;
