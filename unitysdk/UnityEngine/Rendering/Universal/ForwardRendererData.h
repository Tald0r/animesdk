...
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_CLEARCACHEDSHADERCONFIGS_OFFSET UNITYSDK_OFFSET(0x19B5FD60)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x19B5F970)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GETALLSHADERCONFIGS_OFFSET UNITYSDK_OFFSET(0x19B60150)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GETSHADERCONFIG_OFFSET UNITYSDK_OFFSET(0x19B5FE00)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GET_DEFAULTSTENCILSTATE_OFFSET UNITYSDK_OFFSET(0x19B5FAF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GET_OPAQUELAYERMASK_OFFSET UNITYSDK_OFFSET(0x19B5F9D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GET_SHADOWTRANSPARENTRECEIVE_OFFSET UNITYSDK_OFFSET(0x19B5FB80)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_GET_TRANSPARENTLAYERMASK_OFFSET UNITYSDK_OFFSET(0x19B5FA60)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_LOGALLSHADERCONFIGS_OFFSET UNITYSDK_OFFSET(0x19B601A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19B5FC10)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_SET_DEFAULTSTENCILSTATE_OFFSET UNITYSDK_OFFSET(0x19B5FB00)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_SET_OPAQUELAYERMASK_OFFSET UNITYSDK_OFFSET(0x19B5F9E0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_SET_SHADOWTRANSPARENTRECEIVE_OFFSET UNITYSDK_OFFSET(0x19B5FB90)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA_SET_TRANSPARENTLAYERMASK_OFFSET UNITYSDK_OFFSET(0x19B5FA70)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19B606A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FORWARDRENDERERDATA___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19B60760)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ForwardRendererData_TypeDefinitionIndex = 29326;
