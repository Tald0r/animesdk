...
#define UNITYENGINE_RENDERING_UNIVERSAL_FLUIDSIMPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x18914E70)
#define UNITYENGINE_RENDERING_UNIVERSAL_FLUIDSIMPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x18914DB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FLUIDSIMPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x18914D40)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FluidSimPass_TypeDefinitionIndex = 29665;
