...
#define UNITYENGINE_RENDERING_UNIVERSAL_FLUIDSIMPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x183B9360)
#define UNITYENGINE_RENDERING_UNIVERSAL_FLUIDSIMPASS_SETUP_OFFSET UNITYSDK_OFFSET(0x183B92A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_FLUIDSIMPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x183B9230)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int FluidSimPass_TypeDefinitionIndex = 28719;
