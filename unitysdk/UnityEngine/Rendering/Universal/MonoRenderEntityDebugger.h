...
#define UNITYENGINE_RENDERING_UNIVERSAL_MONORENDERENTITYDEBUGGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19B26550)
#define UNITYENGINE_RENDERING_UNIVERSAL_MONORENDERENTITYDEBUGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B267B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MonoRenderEntityDebugger_TypeDefinitionIndex = 28599;
