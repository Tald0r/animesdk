...
#define UNITYENGINE_RENDERING_UNIVERSAL_CUBELIGHTBAKEONLY_INITPROXYCONFIGS_OFFSET UNITYSDK_OFFSET(0x1391D8D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_CUBELIGHTBAKEONLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1391DB30)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int CubeLightBakeOnly_TypeDefinitionIndex = 28373;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Rendering::Universal::CubeLightBakeOnly_LightProxyConfig>**)Il2CppClass::FromTypeDefinitionIndex(CubeLightBakeOnly_TypeDefinitionIndex)->GetStaticField(0x22530);
		}
