...
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOGSYSTEM_GETVOLUMETRICFOGBLITORDER_OFFSET UNITYSDK_OFFSET(0x18F15060)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOGSYSTEM_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18F150F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOGSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18F15150)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int VolumetricFogSystem_TypeDefinitionIndex = 29407;
