...
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOGSYSTEM_GETVOLUMETRICFOGBLITORDER_OFFSET UNITYSDK_OFFSET(0x18B51F90)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOGSYSTEM_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18B52020)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOGSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x18B52080)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int VolumetricFogSystem_TypeDefinitionIndex = 28464;
