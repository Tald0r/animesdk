...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_MINMAXRANGEPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1795DEE0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_MINMAXRANGEPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x1795DE50)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_MINMAXRANGEPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1795DEF0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_MINMAXRANGEPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1795DF00)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_MinMaxRangeParameter_TypeDefinitionIndex = 28576;
