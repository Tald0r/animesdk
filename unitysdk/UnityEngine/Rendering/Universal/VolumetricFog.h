...
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x182FDC60)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_DRAWLOCALVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x182FDCC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_GENERATEFOGMESH_OFFSET UNITYSDK_OFFSET(0x182FF680)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_GETCUBEVERTEXINDEX_OFFSET UNITYSDK_OFFSET(0x18300930)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x18300890)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x182FEA90)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x183009B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x182FE650)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x182FEBD0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x18301090)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG___BASE_DRAWLOCALVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x183010B0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int VolumetricFog_TypeDefinitionIndex = 29403;
