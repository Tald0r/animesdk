...
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_AWAKE_OFFSET UNITYSDK_OFFSET(0x17C15050)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_DRAWLOCALVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x17C150B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_GENERATEFOGMESH_OFFSET UNITYSDK_OFFSET(0x17C16A70)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_GETCUBEVERTEXINDEX_OFFSET UNITYSDK_OFFSET(0x17C17D20)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17C17C80)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17C15E80)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x17C17DA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17C15A40)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG_UPDATE_OFFSET UNITYSDK_OFFSET(0x17C15FC0)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG__CTOR_OFFSET UNITYSDK_OFFSET(0x17C18480)
#define UNITYENGINE_RENDERING_UNIVERSAL_VOLUMETRICFOG___BASE_DRAWLOCALVOLUMETRICFOG_OFFSET UNITYSDK_OFFSET(0x17C184A0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int VolumetricFog_TypeDefinitionIndex = 28460;
