...
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS_GETENUMFROMPATH_OFFSET UNITYSDK_OFFSET(0x1742B860)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS_GETSHADERPATH_OFFSET UNITYSDK_OFFSET(0x1742B7A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS_ISLWSHADER_OFFSET UNITYSDK_OFFSET(0x1742B950)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS_SETKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x1742BA90)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS_SETKEYWORD_2_OFFSET UNITYSDK_OFFSET(0x1742BB10)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS_SETKEYWORD_OFFSET UNITYSDK_OFFSET(0x1742BA30)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1742BB90)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ShaderUtils_TypeDefinitionIndex = 29700;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ShaderUtils_TypeDefinitionIndex)->GetStaticField(0x24070);
		}
