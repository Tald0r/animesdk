...
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS_GETENUMFROMPATH_OFFSET UNITYSDK_OFFSET(0x16DC3020)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS_GETSHADERPATH_OFFSET UNITYSDK_OFFSET(0x16DC2F60)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS_ISLWSHADER_OFFSET UNITYSDK_OFFSET(0x16DC3110)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS_SETKEYWORD_1_OFFSET UNITYSDK_OFFSET(0x16DC3250)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS_SETKEYWORD_2_OFFSET UNITYSDK_OFFSET(0x16DC32D0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS_SETKEYWORD_OFFSET UNITYSDK_OFFSET(0x16DC31F0)
#define UNITYENGINE_RENDERING_UNIVERSAL_SHADERUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x16DC3350)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int ShaderUtils_TypeDefinitionIndex = 28754;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ShaderUtils_TypeDefinitionIndex)->GetStaticField(0x22640);
		}
