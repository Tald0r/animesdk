...
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTFILTER_CULL_OFFSET UNITYSDK_OFFSET(0x874E10)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTFILTER_GETLIGHTATINDEX_OFFSET UNITYSDK_OFFSET(0x874EB0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTFILTER_GETVALUE_OFFSET UNITYSDK_OFFSET(0x874EA0)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTFILTER_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x874E40)
#define UNITYENGINE_RENDERING_UNIVERSAL_LIGHTFILTER_TILELIGHTS_OFFSET UNITYSDK_OFFSET(0x874E00)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int LightFilter_TypeDefinitionIndex = 29557;
