...
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LAYERMASKPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x16DC27A0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LAYERMASKPARAMETER_INTERP_OFFSET UNITYSDK_OFFSET(0x16DC2720)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LAYERMASKPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x16DC27B0)
#define UNITYENGINE_RENDERING_UNIVERSAL_MKGLOW_LAYERMASKPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DC27C0)

namespace UnityEngine::Rendering::Universal
{
	inline static constexpr unsigned int MKGlow_LayerMaskParameter_TypeDefinitionIndex = 28575;
