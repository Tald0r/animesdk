...
#define UNITYENGINE_RENDERING_DEBUGUI_VALUE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x18A44730)
#define UNITYENGINE_RENDERING_DEBUGUI_VALUE_GET_GETTER_OFFSET UNITYSDK_OFFSET(0x18A44710)
#define UNITYENGINE_RENDERING_DEBUGUI_VALUE_SET_GETTER_OFFSET UNITYSDK_OFFSET(0x18A44720)
#define UNITYENGINE_RENDERING_DEBUGUI_VALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A447B0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_Value_TypeDefinitionIndex = 9561;
