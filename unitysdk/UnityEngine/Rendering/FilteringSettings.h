...
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9257A0)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_EQUALS_OFFSET UNITYSDK_OFFSET(0x925760)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x925820)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_GET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x2EC6E0)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_GET_RENDERINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x2F6540)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_EXCLUDEMOTIONVECTOROBJECTS_OFFSET UNITYSDK_OFFSET(0x925750)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x3028C0)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_NAPDRAWSET_OFFSET UNITYSDK_OFFSET(0x39A7D0)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_RENDERINGLAYERMASK_OFFSET UNITYSDK_OFFSET(0x302AB0)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS_SET_RENDERQUEUERANGE_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define UNITYENGINE_RENDERING_FILTERINGSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x9256C0)
