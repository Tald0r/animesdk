...
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_CLEANCACHEREGULARLY_OFFSET UNITYSDK_OFFSET(0x18EFF7A0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_CLEARALL_OFFSET UNITYSDK_OFFSET(0x18EFF9A0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GETRENDERERMATERIALWITHCACHE_OFFSET UNITYSDK_OFFSET(0x18EFF820)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GETRENDERERSHAREDMATERIALWITHCACHE_OFFSET UNITYSDK_OFFSET(0x18EFF880)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GET_ENABLECACHE_OFFSET UNITYSDK_OFFSET(0x18EFF470)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18EFF4D0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_RELEASEMATERIALLIST_OFFSET UNITYSDK_OFFSET(0x18EFF8E0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_RELEASESHAREDMATERIALLIST_OFFSET UNITYSDK_OFFSET(0x18EFF940)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18EFFA10)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x18EFF5C0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int RendererMaterialCache_TypeDefinitionIndex = 29270;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::RendererMaterialCache**)Il2CppClass::FromTypeDefinitionIndex(RendererMaterialCache_TypeDefinitionIndex)->GetStaticField(0x22FC0);
		}
		static ::System::Boolean* StaticGet_enableCacheConfig()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(RendererMaterialCache_TypeDefinitionIndex)->GetStaticField(0x64E0);
		}
