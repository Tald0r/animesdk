...
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_CLEANCACHEREGULARLY_OFFSET UNITYSDK_OFFSET(0x18B3EB50)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_CLEARALL_OFFSET UNITYSDK_OFFSET(0x18B3ED50)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GETRENDERERMATERIALWITHCACHE_OFFSET UNITYSDK_OFFSET(0x18B3EBD0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GETRENDERERSHAREDMATERIALWITHCACHE_OFFSET UNITYSDK_OFFSET(0x18B3EC30)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GET_ENABLECACHE_OFFSET UNITYSDK_OFFSET(0x18B3E820)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x18B3E880)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_RELEASEMATERIALLIST_OFFSET UNITYSDK_OFFSET(0x18B3EC90)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE_RELEASESHAREDMATERIALLIST_OFFSET UNITYSDK_OFFSET(0x18B3ECF0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18B3EDC0)
#define UNITYENGINE_RENDERING_RENDERERMATERIALCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x18B3E970)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int RendererMaterialCache_TypeDefinitionIndex = 28329;
	...
	public:
		...
		{
			return (::UnityEngine::Rendering::RendererMaterialCache**)Il2CppClass::FromTypeDefinitionIndex(RendererMaterialCache_TypeDefinitionIndex)->GetStaticField(0x21680);
		}
