...
#define UNITYENGINE_RENDERING_DEBUGUI_ENUMFIELD_GET_CURRENTINDEX_OFFSET UNITYSDK_OFFSET(0x18A427B0)
#define UNITYENGINE_RENDERING_DEBUGUI_ENUMFIELD_GET_GETINDEX_OFFSET UNITYSDK_OFFSET(0x18A42770)
#define UNITYENGINE_RENDERING_DEBUGUI_ENUMFIELD_GET_SETINDEX_OFFSET UNITYSDK_OFFSET(0x18A42790)
#define UNITYENGINE_RENDERING_DEBUGUI_ENUMFIELD_INITINDEXES_OFFSET UNITYSDK_OFFSET(0x18A42D20)
#define UNITYENGINE_RENDERING_DEBUGUI_ENUMFIELD_INITQUICKSEPARATORS_OFFSET UNITYSDK_OFFSET(0x18A42E60)
#define UNITYENGINE_RENDERING_DEBUGUI_ENUMFIELD_SET_AUTOENUM_OFFSET UNITYSDK_OFFSET(0x18A42890)
#define UNITYENGINE_RENDERING_DEBUGUI_ENUMFIELD_SET_CURRENTINDEX_OFFSET UNITYSDK_OFFSET(0x18A42800)
#define UNITYENGINE_RENDERING_DEBUGUI_ENUMFIELD_SET_GETINDEX_OFFSET UNITYSDK_OFFSET(0x18A42780)
#define UNITYENGINE_RENDERING_DEBUGUI_ENUMFIELD_SET_SETINDEX_OFFSET UNITYSDK_OFFSET(0x18A427A0)
#define UNITYENGINE_RENDERING_DEBUGUI_ENUMFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x18A43120)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_EnumField_TypeDefinitionIndex = 9545;
	...
	public:
		...
		::Il2CppArray<::UnityEngine::GUIContent*>* enumNames; // 0x78
