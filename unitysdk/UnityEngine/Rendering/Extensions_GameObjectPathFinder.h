...
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDGAMEOBJECTBYPATH_OFFSET UNITYSDK_OFFSET(0x17801E70)
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDINCHILDREN_OFFSET UNITYSDK_OFFSET(0x17802580)
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDINROOTS_OFFSET UNITYSDK_OFFSET(0x178024B0)
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDROOTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x17801AA0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int Extensions_GameObjectPathFinder_TypeDefinitionIndex = 29261;
