...
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDGAMEOBJECTBYPATH_OFFSET UNITYSDK_OFFSET(0x17B6B870)
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDINCHILDREN_OFFSET UNITYSDK_OFFSET(0x17B6BF80)
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDINROOTS_OFFSET UNITYSDK_OFFSET(0x17B6BEB0)
#define UNITYENGINE_RENDERING_EXTENSIONS_GAMEOBJECTPATHFINDER_FINDROOTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x17B6B4A0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int Extensions_GameObjectPathFinder_TypeDefinitionIndex = 28320;
