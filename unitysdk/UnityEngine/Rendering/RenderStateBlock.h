...
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x91EA60)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_EQUALS_OFFSET UNITYSDK_OFFSET(0x91E880)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x91EA70)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_GET_BLENDSTATE_OFFSET UNITYSDK_OFFSET(0x652A40)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_GET_MASK_OFFSET UNITYSDK_OFFSET(0x91E870)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_SET_BLENDSTATE_OFFSET UNITYSDK_OFFSET(0x91E810)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_SET_DEPTHSTATE_OFFSET UNITYSDK_OFFSET(0x91E840)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_SET_MASK_OFFSET UNITYSDK_OFFSET(0x7E2280)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_SET_STENCILREFERENCE_OFFSET UNITYSDK_OFFSET(0x91E860)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK_SET_STENCILSTATE_OFFSET UNITYSDK_OFFSET(0x91E850)
#define UNITYENGINE_RENDERING_RENDERSTATEBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x91E790)
