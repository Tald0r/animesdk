...
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9346D0)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_EQUALS_OFFSET UNITYSDK_OFFSET(0x934600)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9346E0)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_SET_DRAWLAYERMASK_OFFSET UNITYSDK_OFFSET(0x934590)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_SET_SPLITDATA_OFFSET UNITYSDK_OFFSET(0x934580)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x9345A0)
