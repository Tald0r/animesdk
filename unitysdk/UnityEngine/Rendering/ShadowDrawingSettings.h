...
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x90A4D0)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_EQUALS_OFFSET UNITYSDK_OFFSET(0x90A400)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x90A4E0)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_SET_DRAWLAYERMASK_OFFSET UNITYSDK_OFFSET(0x90A390)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS_SET_SPLITDATA_OFFSET UNITYSDK_OFFSET(0x90A380)
#define UNITYENGINE_RENDERING_SHADOWDRAWINGSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x90A3A0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ShadowDrawingSettings_TypeDefinitionIndex = 6228;
