...
#define UNITYENGINE_RENDERING_LODPARAMETERS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x925930)
#define UNITYENGINE_RENDERING_LODPARAMETERS_EQUALS_OFFSET UNITYSDK_OFFSET(0x925870)
#define UNITYENGINE_RENDERING_LODPARAMETERS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x925A50)
#define UNITYENGINE_RENDERING_LODPARAMETERS_SET_CAMERAPIXELHEIGHT_OFFSET UNITYSDK_OFFSET(0x318710)
#define UNITYENGINE_RENDERING_LODPARAMETERS_SET_CAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x33F2F0)
#define UNITYENGINE_RENDERING_LODPARAMETERS_SET_FIELDOFVIEW_OFFSET UNITYSDK_OFFSET(0x33F1F0)
#define UNITYENGINE_RENDERING_LODPARAMETERS_SET_ISORTHOGRAPHIC_OFFSET UNITYSDK_OFFSET(0x925860)
#define UNITYENGINE_RENDERING_LODPARAMETERS_SET_ORTHOSIZE_OFFSET UNITYSDK_OFFSET(0x351EA0)
