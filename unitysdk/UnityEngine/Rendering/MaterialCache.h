...
#define UNITYENGINE_RENDERING_MATERIALCACHE_GETMATERIALS_OFFSET UNITYSDK_OFFSET(0x19322F60)
#define UNITYENGINE_RENDERING_MATERIALCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x19322F00)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int MaterialCache_TypeDefinitionIndex = 28327;
