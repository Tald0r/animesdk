...
#define UNITYENGINE_RENDERING_VISIBLELIGHT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8D0CE0)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_EQUALS_OFFSET UNITYSDK_OFFSET(0x8D0C70)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8D0DA0)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GET_FINALCOLOR_OFFSET UNITYSDK_OFFSET(0x547840)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GET_LIGHTTYPE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GET_LIGHT_OFFSET UNITYSDK_OFFSET(0x8D0BC0)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GET_LOCALTOWORLDMATRIX_OFFSET UNITYSDK_OFFSET(0x8D0C20)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x8D0C50)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_GET_SPOTANGLE_OFFSET UNITYSDK_OFFSET(0x32A0B0)
#define UNITYENGINE_RENDERING_VISIBLELIGHT_SET_RANGE_OFFSET UNITYSDK_OFFSET(0x8D0C60)
