...
#define UNITYENGINE_RENDERING_DEBUGUI_FLOATFIELD_VALIDATEVALUE_OFFSET UNITYSDK_OFFSET(0x1843E090)
#define UNITYENGINE_RENDERING_DEBUGUI_FLOATFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1843E140)
#define UNITYENGINE_RENDERING_DEBUGUI_FLOATFIELD___BASE_VALIDATEVALUE_OFFSET UNITYSDK_OFFSET(0x1843E160)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_FloatField_TypeDefinitionIndex = 9542;
