...
#define UNITYENGINE_RENDERING_DEBUGUI_FLOATFIELD_VALIDATEVALUE_OFFSET UNITYSDK_OFFSET(0x18A43280)
#define UNITYENGINE_RENDERING_DEBUGUI_FLOATFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x18A43330)
#define UNITYENGINE_RENDERING_DEBUGUI_FLOATFIELD___BASE_VALIDATEVALUE_OFFSET UNITYSDK_OFFSET(0x18A43350)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_FloatField_TypeDefinitionIndex = 9544;
