...
#define UNITYENGINE_RENDERING_DEBUGUI_INTFIELD_VALIDATEVALUE_OFFSET UNITYSDK_OFFSET(0x18A438F0)
#define UNITYENGINE_RENDERING_DEBUGUI_INTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x18A43990)
#define UNITYENGINE_RENDERING_DEBUGUI_INTFIELD___BASE_VALIDATEVALUE_OFFSET UNITYSDK_OFFSET(0x18A439A0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_IntField_TypeDefinitionIndex = 9542;
