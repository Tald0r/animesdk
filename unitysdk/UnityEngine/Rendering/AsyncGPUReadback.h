...
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_1_OFFSET UNITYSDK_OFFSET(0x1A306370)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_2_OFFSET UNITYSDK_OFFSET(0x1A306410)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_COMPUTEBUFFER_1_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A3064B0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_COMPUTEBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1A306330)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_COMPUTEBUFFER_2_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A3064C0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_COMPUTEBUFFER_2_OFFSET UNITYSDK_OFFSET(0x1A3063D0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_TEXTURE_1_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A3064D0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_INTERNAL_TEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1A306470)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_REQUEST_OFFSET UNITYSDK_OFFSET(0x1A3062D0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACK_SETUPSCRIPTINGREQUEST_OFFSET UNITYSDK_OFFSET(0x1A3062C0)
