...
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GETDATARAW_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A36D890)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GETDATARAW_OFFSET UNITYSDK_OFFSET(0x921F40)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GETLAYERCOUNT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A36D840)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GETLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x921F10)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GETLAYERDATASIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A36D850)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GETLAYERDATASIZE_OFFSET UNITYSDK_OFFSET(0x921F20)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GET_DONE_OFFSET UNITYSDK_OFFSET(0x921EF0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GET_HASERROR_OFFSET UNITYSDK_OFFSET(0x921F00)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GET_LAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x921F10)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_GET_LAYERDATASIZE_OFFSET UNITYSDK_OFFSET(0x921F20)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_HASERROR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A36D830)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_HASERROR_OFFSET UNITYSDK_OFFSET(0x921F00)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_ISDONE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A36D820)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_ISDONE_OFFSET UNITYSDK_OFFSET(0x921EF0)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_SETSCRIPTINGCALLBACK_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A36D870)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_SETSCRIPTINGCALLBACK_OFFSET UNITYSDK_OFFSET(0x921F30)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_WAITFORCOMPLETION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A36D790)
#define UNITYENGINE_RENDERING_ASYNCGPUREADBACKREQUEST_WAITFORCOMPLETION_OFFSET UNITYSDK_OFFSET(0x921EE0)
