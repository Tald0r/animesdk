...
#define UNITYENGINE_RENDERING_XRUTILS_DRAWOCCLUSIONMESH_OFFSET UNITYSDK_OFFSET(0x18442BD0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int XRUtils_TypeDefinitionIndex = 9590;
