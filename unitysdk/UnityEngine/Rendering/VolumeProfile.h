...
#define UNITYENGINE_RENDERING_VOLUMEPROFILE__CCTOR_OFFSET UNITYSDK_OFFSET(0x18442820)
#define UNITYENGINE_RENDERING_VOLUMEPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x184428A0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int VolumeProfile_TypeDefinitionIndex = 9593;
