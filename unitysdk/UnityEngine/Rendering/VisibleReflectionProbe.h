...
#define UNITYENGINE_RENDERING_VISIBLEREFLECTIONPROBE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x91EC20)
#define UNITYENGINE_RENDERING_VISIBLEREFLECTIONPROBE_EQUALS_OFFSET UNITYSDK_OFFSET(0x91EBE0)
#define UNITYENGINE_RENDERING_VISIBLEREFLECTIONPROBE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x91ECA0)
