...
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_ADDUSINGCOUNT_OFFSET UNITYSDK_OFFSET(0x16D89000)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_CLEARALL_OFFSET UNITYSDK_OFFSET(0x16D89780)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_CLEARNOTUSING_OFFSET UNITYSDK_OFFSET(0x16D892B0)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_GET_OFFSET UNITYSDK_OFFSET(0x16D88C40)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_REDUCEUSINGCOUNT_OFFSET UNITYSDK_OFFSET(0x16D891E0)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE_RELEASE_OFFSET UNITYSDK_OFFSET(0x16D890B0)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x16D89A20)
#define UNITYENGINE_RENDERING_MATERIALCACHEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16D88AA0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int MaterialCacheBase_TypeDefinitionIndex = 28324;
	...
	public:
		...
		{
			return (::UnityEngine::NAPRenderPipeline0::ObjectPool_1<::UnityEngine::Rendering::MaterialCacheBase_CacheEntry*>**)Il2CppClass::FromTypeDefinitionIndex(MaterialCacheBase_TypeDefinitionIndex)->GetStaticField(0x225B0);
		}
