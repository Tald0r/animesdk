...
#define UNITYENGINE_RENDERING_VOLUMEBOUNDS__CTOR_OFFSET UNITYSDK_OFFSET(0x184427A0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int VolumeBounds_TypeDefinitionIndex = 9592;
