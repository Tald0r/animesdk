...
#define UNITYENGINE_RENDERING_LENSFLAREPROFILE__CTOR_OFFSET UNITYSDK_OFFSET(0x19ED3910)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int LensFlareProfile_TypeDefinitionIndex = 29278;
