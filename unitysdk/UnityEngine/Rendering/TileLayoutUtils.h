...
#define UNITYENGINE_RENDERING_TILELAYOUTUTILS_TRYLAYOUTBYCOL_OFFSET UNITYSDK_OFFSET(0x184426C0)
#define UNITYENGINE_RENDERING_TILELAYOUTUTILS_TRYLAYOUTBYROW_OFFSET UNITYSDK_OFFSET(0x18442610)
#define UNITYENGINE_RENDERING_TILELAYOUTUTILS_TRYLAYOUTBYTILES_OFFSET UNITYSDK_OFFSET(0x184424E0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int TileLayoutUtils_TypeDefinitionIndex = 9589;
