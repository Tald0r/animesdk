...
#define UNITYENGINE_RENDERING_CORECAMERAVALUES_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8C1620)
#define UNITYENGINE_RENDERING_CORECAMERAVALUES_EQUALS_OFFSET UNITYSDK_OFFSET(0x8C1600)
#define UNITYENGINE_RENDERING_CORECAMERAVALUES_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8C1680)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int CoreCameraValues_TypeDefinitionIndex = 6197;
