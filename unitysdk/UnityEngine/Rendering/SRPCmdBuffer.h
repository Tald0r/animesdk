...
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_ADDCOLLECTTEXTUREBARRIER_IMPL_OFFSET UNITYSDK_OFFSET(0x19EA7410)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_ADDCOLLECTTEXTURETRANSITION_OFFSET UNITYSDK_OFFSET(0x19EA7E80)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_ADDTEXTUREBARRIER_IMPL_OFFSET UNITYSDK_OFFSET(0x19EA7400)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_ADDTEXTURETRANSITION_OFFSET UNITYSDK_OFFSET(0x19EA7E70)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_APPLYDYNAMICRESOLUTION_OFFSET UNITYSDK_OFFSET(0x19EA7B30)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_BEGINSAMPLE_OFFSET UNITYSDK_OFFSET(0x19EA7420)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_BLIT_IDENTIFIER_INJECTED_OFFSET UNITYSDK_OFFSET(0x19EA72E0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_BLIT_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x19EA7290)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_BLIT_OFFSET UNITYSDK_OFFSET(0x19EA7DE0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_CLEARRENDERTARGET_INJECTED_OFFSET UNITYSDK_OFFSET(0x19EA7340)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_CLEARRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x19EA7330)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DISPATCHCOMPUTE_1_OFFSET UNITYSDK_OFFSET(0x19EA7D80)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DISPATCHCOMPUTE_OFFSET UNITYSDK_OFFSET(0x19EA7D70)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19EA7CD0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19EA7CF0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DRAWMESHINSTANCEDINDIRECT_OFFSET UNITYSDK_OFFSET(0x19EA7DD0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DRAWMESHINSTANCED_OFFSET UNITYSDK_OFFSET(0x19EA7DB0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DRAWMESH_OFFSET UNITYSDK_OFFSET(0x19EA7D90)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DRAWPROCEDURAL_OFFSET UNITYSDK_OFFSET(0x19EA7DA0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_ENDSAMPLE_OFFSET UNITYSDK_OFFSET(0x19EA7430)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_EXECUTEDLSSG_OFFSET UNITYSDK_OFFSET(0x19EA7030)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_EXECUTEDLSS_OFFSET UNITYSDK_OFFSET(0x19EA6FD0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_EXECUTEFSRFRAMEGEN_OFFSET UNITYSDK_OFFSET(0x19EA7170)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_EXECUTEFSR_OFFSET UNITYSDK_OFFSET(0x19EA7110)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19EA7C60)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_GETTEMPORARYRTWITHDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19EA7310)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INITSRPCMDBUFFER_OFFSET UNITYSDK_OFFSET(0x19EA71B0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_APPLYDYNAMICRESOLUTION_OFFSET UNITYSDK_OFFSET(0x19EA7440)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_DISPATCHCOMPUTEINDIRECT_OFFSET UNITYSDK_OFFSET(0x19EA7240)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_DISPATCHCOMPUTE_OFFSET UNITYSDK_OFFSET(0x19EA7230)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_DRAWMESHINSTANCEDINDIRECT_OFFSET UNITYSDK_OFFSET(0x19EA7280)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_DRAWMESHINSTANCED_OFFSET UNITYSDK_OFFSET(0x19EA7270)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_DRAWMESH_OFFSET UNITYSDK_OFFSET(0x19EA7250)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_DRAWPROCEDURAL_OFFSET UNITYSDK_OFFSET(0x19EA7260)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEDLSSG_INJECTED_OFFSET UNITYSDK_OFFSET(0x19EA7020)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEDLSSG_OFFSET UNITYSDK_OFFSET(0x19EA7010)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEDLSS_INJECTED_OFFSET UNITYSDK_OFFSET(0x19EA6FC0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEDLSS_OFFSET UNITYSDK_OFFSET(0x19EA6FB0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEFSRFRAMEGEN_INJECTED_OFFSET UNITYSDK_OFFSET(0x19EA7160)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEFSRFRAMEGEN_OFFSET UNITYSDK_OFFSET(0x19EA7150)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEFSR_INJECTED_OFFSET UNITYSDK_OFFSET(0x19EA7100)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEFSR_OFFSET UNITYSDK_OFFSET(0x19EA70F0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_RECREATESWAPCHAIN_INJECTED_OFFSET UNITYSDK_OFFSET(0x19EA7080)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_RECREATESWAPCHAIN_OFFSET UNITYSDK_OFFSET(0x19EA7070)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_SETCOMPUTETEXTUREPARAM_OFFSET UNITYSDK_OFFSET(0x19EA7210)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_RECREATESWAPCHAIN_OFFSET UNITYSDK_OFFSET(0x19EA7090)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_RELEASESRPCMDBUFFER_OFFSET UNITYSDK_OFFSET(0x19EA71C0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_RELEASETEMPORARYRT_OFFSET UNITYSDK_OFFSET(0x19EA7320)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETCOMPUTEBUFFERPARAM_OFFSET UNITYSDK_OFFSET(0x19EA7220)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETCOMPUTEFLOATPARAM_OFFSET UNITYSDK_OFFSET(0x19EA71D0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETCOMPUTEINTPARAM_OFFSET UNITYSDK_OFFSET(0x19EA71E0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETCOMPUTETEXTUREPARAM_OFFSET UNITYSDK_OFFSET(0x19EA7D60)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETCOMPUTEVECTORPARAM_INJECTED_OFFSET UNITYSDK_OFFSET(0x19EA7200)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETCOMPUTEVECTORPARAM_OFFSET UNITYSDK_OFFSET(0x19EA71F0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALBUFFER_OFFSET UNITYSDK_OFFSET(0x19EA73F0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x19EA7390)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALCOLOR_OFFSET UNITYSDK_OFFSET(0x19EA7380)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALFLOAT_OFFSET UNITYSDK_OFFSET(0x19EA7350)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALMATRIX_OFFSET UNITYSDK_OFFSET(0x19EA73A0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALTEXTURE_IMPL_OFFSET UNITYSDK_OFFSET(0x19EA73E0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALTEXTURE_OFFSET UNITYSDK_OFFSET(0x19EA7E60)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x19EA73D0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALVECTOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x19EA7370)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALVECTOR_OFFSET UNITYSDK_OFFSET(0x19EA7360)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETINTSHADERKEYWORD_OFFSET UNITYSDK_OFFSET(0x19EA73B0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGETCOLORDEPTH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19EA75E0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGETMULTI_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19EA7750)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGETSINGLE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19EA74F0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGET_1_OFFSET UNITYSDK_OFFSET(0x19EA7500)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGET_2_OFFSET UNITYSDK_OFFSET(0x19EA75F0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGET_3_OFFSET UNITYSDK_OFFSET(0x19EA7760)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x19EA7450)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETVIEWPORT_INJECTED_OFFSET UNITYSDK_OFFSET(0x19EA7300)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETVIEWPORT_OFFSET UNITYSDK_OFFSET(0x19EA72F0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETVIEWPROJECTIONMATRICES_OFFSET UNITYSDK_OFFSET(0x19EA73C0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19EA7C50)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA7D40)
