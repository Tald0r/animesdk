...
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_ADDCOLLECTTEXTUREBARRIER_IMPL_OFFSET UNITYSDK_OFFSET(0x19967570)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_ADDCOLLECTTEXTURETRANSITION_OFFSET UNITYSDK_OFFSET(0x19967FE0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_ADDTEXTUREBARRIER_IMPL_OFFSET UNITYSDK_OFFSET(0x19967560)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_ADDTEXTURETRANSITION_OFFSET UNITYSDK_OFFSET(0x19967FD0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_APPLYDYNAMICRESOLUTION_OFFSET UNITYSDK_OFFSET(0x19967C90)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_BEGINSAMPLE_OFFSET UNITYSDK_OFFSET(0x19967580)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_BLIT_IDENTIFIER_INJECTED_OFFSET UNITYSDK_OFFSET(0x19967440)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_BLIT_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x199673F0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_BLIT_OFFSET UNITYSDK_OFFSET(0x19967F40)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_CLEARRENDERTARGET_INJECTED_OFFSET UNITYSDK_OFFSET(0x199674A0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_CLEARRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x19967490)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DISPATCHCOMPUTE_1_OFFSET UNITYSDK_OFFSET(0x19967EE0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DISPATCHCOMPUTE_OFFSET UNITYSDK_OFFSET(0x19967ED0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19967E30)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19967E50)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DRAWMESHINSTANCEDINDIRECT_OFFSET UNITYSDK_OFFSET(0x19967F30)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DRAWMESHINSTANCED_OFFSET UNITYSDK_OFFSET(0x19967F10)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DRAWMESH_OFFSET UNITYSDK_OFFSET(0x19967EF0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_DRAWPROCEDURAL_OFFSET UNITYSDK_OFFSET(0x19967F00)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_ENDSAMPLE_OFFSET UNITYSDK_OFFSET(0x19967590)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_EXECUTEDLSSG_OFFSET UNITYSDK_OFFSET(0x199671F0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_EXECUTEDLSS_OFFSET UNITYSDK_OFFSET(0x19967190)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_EXECUTEFSR_OFFSET UNITYSDK_OFFSET(0x199672D0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19967DC0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_GETTEMPORARYRTWITHDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x19967470)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INITSRPCMDBUFFER_OFFSET UNITYSDK_OFFSET(0x19967310)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_APPLYDYNAMICRESOLUTION_OFFSET UNITYSDK_OFFSET(0x199675A0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_DISPATCHCOMPUTEINDIRECT_OFFSET UNITYSDK_OFFSET(0x199673A0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_DISPATCHCOMPUTE_OFFSET UNITYSDK_OFFSET(0x19967390)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_DRAWMESHINSTANCEDINDIRECT_OFFSET UNITYSDK_OFFSET(0x199673E0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_DRAWMESHINSTANCED_OFFSET UNITYSDK_OFFSET(0x199673D0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_DRAWMESH_OFFSET UNITYSDK_OFFSET(0x199673B0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_DRAWPROCEDURAL_OFFSET UNITYSDK_OFFSET(0x199673C0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEDLSSG_INJECTED_OFFSET UNITYSDK_OFFSET(0x199671E0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEDLSSG_OFFSET UNITYSDK_OFFSET(0x199671D0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEDLSS_INJECTED_OFFSET UNITYSDK_OFFSET(0x19967180)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEDLSS_OFFSET UNITYSDK_OFFSET(0x19967170)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEFSR_INJECTED_OFFSET UNITYSDK_OFFSET(0x199672C0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_EXECUTEFSR_OFFSET UNITYSDK_OFFSET(0x199672B0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_RECREATESWAPCHAIN_INJECTED_OFFSET UNITYSDK_OFFSET(0x19967240)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_RECREATESWAPCHAIN_OFFSET UNITYSDK_OFFSET(0x19967230)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_INTERNAL_SETCOMPUTETEXTUREPARAM_OFFSET UNITYSDK_OFFSET(0x19967370)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_RECREATESWAPCHAIN_OFFSET UNITYSDK_OFFSET(0x19967250)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_RELEASESRPCMDBUFFER_OFFSET UNITYSDK_OFFSET(0x19967320)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_RELEASETEMPORARYRT_OFFSET UNITYSDK_OFFSET(0x19967480)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETCOMPUTEBUFFERPARAM_OFFSET UNITYSDK_OFFSET(0x19967380)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETCOMPUTEFLOATPARAM_OFFSET UNITYSDK_OFFSET(0x19967330)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETCOMPUTEINTPARAM_OFFSET UNITYSDK_OFFSET(0x19967340)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETCOMPUTETEXTUREPARAM_OFFSET UNITYSDK_OFFSET(0x19967EC0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETCOMPUTEVECTORPARAM_INJECTED_OFFSET UNITYSDK_OFFSET(0x19967360)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETCOMPUTEVECTORPARAM_OFFSET UNITYSDK_OFFSET(0x19967350)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALBUFFER_OFFSET UNITYSDK_OFFSET(0x19967550)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x199674F0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALCOLOR_OFFSET UNITYSDK_OFFSET(0x199674E0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALFLOAT_OFFSET UNITYSDK_OFFSET(0x199674B0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALMATRIX_OFFSET UNITYSDK_OFFSET(0x19967500)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALTEXTURE_IMPL_OFFSET UNITYSDK_OFFSET(0x19967540)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALTEXTURE_OFFSET UNITYSDK_OFFSET(0x19967FC0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x19967530)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALVECTOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x199674D0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETGLOBALVECTOR_OFFSET UNITYSDK_OFFSET(0x199674C0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETINTSHADERKEYWORD_OFFSET UNITYSDK_OFFSET(0x19967510)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGETCOLORDEPTH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19967740)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGETMULTI_INTERNAL_OFFSET UNITYSDK_OFFSET(0x199678B0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGETSINGLE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x19967650)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGET_1_OFFSET UNITYSDK_OFFSET(0x19967660)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGET_2_OFFSET UNITYSDK_OFFSET(0x19967750)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGET_3_OFFSET UNITYSDK_OFFSET(0x199678C0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x199675B0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETVIEWPORT_INJECTED_OFFSET UNITYSDK_OFFSET(0x19967460)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETVIEWPORT_OFFSET UNITYSDK_OFFSET(0x19967450)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SETVIEWPROJECTIONMATRICES_OFFSET UNITYSDK_OFFSET(0x19967520)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19967DB0)
#define UNITYENGINE_RENDERING_SRPCMDBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19967EA0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int SRPCmdBuffer_TypeDefinitionIndex = 6131;
