...
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAASPECTRATIO_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C240)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x92AA60)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C200)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFAR_OFFSET UNITYSDK_OFFSET(0x92AA40)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFOV_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C220)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFOV_OFFSET UNITYSDK_OFFSET(0x92AA50)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFWD_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C1C0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAFWD_OFFSET UNITYSDK_OFFSET(0x92AA00)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAMOTIONINCLUDED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C280)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAMOTIONINCLUDED_OFFSET UNITYSDK_OFFSET(0x92AA80)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERANEAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C1E0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERANEAR_OFFSET UNITYSDK_OFFSET(0x92AA30)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAPOS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C160)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAPOS_OFFSET UNITYSDK_OFFSET(0x92A970)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERARIGHT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C1A0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERARIGHT_OFFSET UNITYSDK_OFFSET(0x92A9D0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAUP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C180)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAUP_OFFSET UNITYSDK_OFFSET(0x92A9A0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAVIEWTOCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C080)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CAMERAVIEWTOCLIP_OFFSET UNITYSDK_OFFSET(0x92A830)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CLIPTOCAMERAVIEW_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C0A0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CLIPTOCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0x92A870)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CLIPTOPREVCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C0C0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_CLIPTOPREVCLIP_OFFSET UNITYSDK_OFFSET(0x92A8B0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_DEPTHINVERTED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C260)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_DEPTHINVERTED_OFFSET UNITYSDK_OFFSET(0x92AA70)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_JITTEROFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C110)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_JITTEROFFSET_OFFSET UNITYSDK_OFFSET(0x92A930)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MINRELATIVELINEARDEPTHOBJECTSEPARATION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C2E0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MINRELATIVELINEARDEPTHOBJECTSEPARATION_OFFSET UNITYSDK_OFFSET(0x92AAB0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MOTIONVECTORSDILATED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C2C0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MOTIONVECTORSDILATED_OFFSET UNITYSDK_OFFSET(0x92AAA0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MVECSCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C140)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_MVECSCALE_OFFSET UNITYSDK_OFFSET(0x92A950)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_PREVCLIPTOCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C0E0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_PREVCLIPTOCLIP_OFFSET UNITYSDK_OFFSET(0x92A8F0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_RESET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C2A0)
#define UNITYENGINE_RENDERING_DLSSCONSTANTS_SET_RESET_OFFSET UNITYSDK_OFFSET(0x92AA90)
