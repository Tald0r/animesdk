...
#define UNITYENGINE_RENDERING_EXTENSIONS_EDITORDESTROY_OFFSET UNITYSDK_OFFSET(0x19ED3000)
#define UNITYENGINE_RENDERING_EXTENSIONS_FINDGAMEOBJECTBYPATH_OFFSET UNITYSDK_OFFSET(0x19ED30C0)
#define UNITYENGINE_RENDERING_EXTENSIONS_FINDINALLCHILDREN_OFFSET UNITYSDK_OFFSET(0x19ED3200)
#define UNITYENGINE_RENDERING_EXTENSIONS_FINDROOTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x19ED3160)
#define UNITYENGINE_RENDERING_EXTENSIONS_GETFULLPATH_OFFSET UNITYSDK_OFFSET(0x19ED2E10)
#define UNITYENGINE_RENDERING_EXTENSIONS_GETSHADERCONFIG_OFFSET UNITYSDK_OFFSET(0x19ED2380)
#define UNITYENGINE_RENDERING_EXTENSIONS_GETSHADERFEATURE_OFFSET UNITYSDK_OFFSET(0x19ED26F0)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETCOLOREXT_1_OFFSET UNITYSDK_OFFSET(0x19ED2850)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETCOLOREXT_OFFSET UNITYSDK_OFFSET(0x19ED2790)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETFLOATEXT_1_OFFSET UNITYSDK_OFFSET(0x19ED2CA0)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETFLOATEXT_OFFSET UNITYSDK_OFFSET(0x19ED2BF0)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETPROPERTYBLOCKEXT_1_OFFSET UNITYSDK_OFFSET(0x19ED22D0)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETPROPERTYBLOCKEXT_OFFSET UNITYSDK_OFFSET(0x19ED2210)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETVECTOREXT_1_OFFSET UNITYSDK_OFFSET(0x19ED2A80)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETVECTOREXT_OFFSET UNITYSDK_OFFSET(0x19ED29C0)
#define UNITYENGINE_RENDERING_EXTENSIONS_SUPPORTFEATURE_OFFSET UNITYSDK_OFFSET(0x19ED2640)
#define UNITYENGINE_RENDERING_EXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19ED3800)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int Extensions_TypeDefinitionIndex = 29260;
	...
	public:
		...
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(Extensions_TypeDefinitionIndex)->GetStaticField(0x23C40);
		}
		static ::System::Boolean* StaticGet_optimizeFind()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Extensions_TypeDefinitionIndex)->GetStaticField(0x7230);
		}
