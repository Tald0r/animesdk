...
#define UNITYENGINE_RENDERING_EXTENSIONS_EDITORDESTROY_OFFSET UNITYSDK_OFFSET(0x19B219B0)
#define UNITYENGINE_RENDERING_EXTENSIONS_FINDGAMEOBJECTBYPATH_OFFSET UNITYSDK_OFFSET(0x19B21A70)
#define UNITYENGINE_RENDERING_EXTENSIONS_FINDINALLCHILDREN_OFFSET UNITYSDK_OFFSET(0x19B21BB0)
#define UNITYENGINE_RENDERING_EXTENSIONS_FINDROOTGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x19B21B10)
#define UNITYENGINE_RENDERING_EXTENSIONS_GETFULLPATH_OFFSET UNITYSDK_OFFSET(0x19B217C0)
#define UNITYENGINE_RENDERING_EXTENSIONS_GETSHADERCONFIG_OFFSET UNITYSDK_OFFSET(0x19B20D30)
#define UNITYENGINE_RENDERING_EXTENSIONS_GETSHADERFEATURE_OFFSET UNITYSDK_OFFSET(0x19B210A0)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETCOLOREXT_1_OFFSET UNITYSDK_OFFSET(0x19B21200)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETCOLOREXT_OFFSET UNITYSDK_OFFSET(0x19B21140)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETFLOATEXT_1_OFFSET UNITYSDK_OFFSET(0x19B21650)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETFLOATEXT_OFFSET UNITYSDK_OFFSET(0x19B215A0)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETPROPERTYBLOCKEXT_1_OFFSET UNITYSDK_OFFSET(0x19B20C80)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETPROPERTYBLOCKEXT_OFFSET UNITYSDK_OFFSET(0x19B20BC0)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETVECTOREXT_1_OFFSET UNITYSDK_OFFSET(0x19B21430)
#define UNITYENGINE_RENDERING_EXTENSIONS_SETVECTOREXT_OFFSET UNITYSDK_OFFSET(0x19B21370)
#define UNITYENGINE_RENDERING_EXTENSIONS_SUPPORTFEATURE_OFFSET UNITYSDK_OFFSET(0x19B20FF0)
#define UNITYENGINE_RENDERING_EXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B221B0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int Extensions_TypeDefinitionIndex = 28319;
	...
	public:
		...
		{
			return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(Extensions_TypeDefinitionIndex)->GetStaticField(0x221F0);
		}
		static ::System::Boolean* StaticGet_optimizeFind()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Extensions_TypeDefinitionIndex)->GetStaticField(0x6AE0);
		}
