...
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_ADDAMBIENTLIGHT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A27EA40)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_ADDAMBIENTLIGHT_OFFSET UNITYSDK_OFFSET(0x91DBA0)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_ADDDIRECTIONALLIGHTINTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A27EAA0)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_ADDDIRECTIONALLIGHTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A27EA90)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_ADDDIRECTIONALLIGHT_OFFSET UNITYSDK_OFFSET(0x91DBD0)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x91DCF0)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_EQUALS_OFFSET UNITYSDK_OFFSET(0x91DC40)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x91DC30)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x91DC20)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A27F410)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A27F1B0)
#define UNITYENGINE_RENDERING_SPHERICALHARMONICSL2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A27F3A0)
