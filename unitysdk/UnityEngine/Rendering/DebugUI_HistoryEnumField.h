...
#define UNITYENGINE_RENDERING_DEBUGUI_HISTORYENUMFIELD_GETHISTORYVALUE_OFFSET UNITYSDK_OFFSET(0x1843E630)
#define UNITYENGINE_RENDERING_DEBUGUI_HISTORYENUMFIELD_GET_HISTORYDEPTH_OFFSET UNITYSDK_OFFSET(0x1843E5D0)
#define UNITYENGINE_RENDERING_DEBUGUI_HISTORYENUMFIELD_GET_HISTORYINDEXGETTER_OFFSET UNITYSDK_OFFSET(0x1843E5B0)
#define UNITYENGINE_RENDERING_DEBUGUI_HISTORYENUMFIELD_SET_HISTORYINDEXGETTER_OFFSET UNITYSDK_OFFSET(0x1843E5C0)
#define UNITYENGINE_RENDERING_DEBUGUI_HISTORYENUMFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x1843E6E0)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int DebugUI_HistoryEnumField_TypeDefinitionIndex = 9545;
