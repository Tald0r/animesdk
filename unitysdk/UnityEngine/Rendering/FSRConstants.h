...
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAASPECTRATIO_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C4C0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x92ACF0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C480)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFAR_OFFSET UNITYSDK_OFFSET(0x92ACD0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFOV_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C4A0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFOV_OFFSET UNITYSDK_OFFSET(0x92ACE0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFWD_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C440)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFWD_OFFSET UNITYSDK_OFFSET(0x92AC90)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAMOTIONINCLUDED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C520)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAMOTIONINCLUDED_OFFSET UNITYSDK_OFFSET(0x92AD20)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERANEAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C460)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERANEAR_OFFSET UNITYSDK_OFFSET(0x92ACC0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAPOS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C3E0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAPOS_OFFSET UNITYSDK_OFFSET(0x92AC00)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERARIGHT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C420)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERARIGHT_OFFSET UNITYSDK_OFFSET(0x92AC60)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAUP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C400)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAUP_OFFSET UNITYSDK_OFFSET(0x92AC30)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAVIEWTOCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C300)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAVIEWTOCLIP_OFFSET UNITYSDK_OFFSET(0x92AAC0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CLIPTOCAMERAVIEW_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C320)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CLIPTOCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0x92AB00)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CLIPTOPREVCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C340)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CLIPTOPREVCLIP_OFFSET UNITYSDK_OFFSET(0x92AB40)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_DELTATIME_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C4E0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x92AD00)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_DEPTHINVERTED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C500)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_DEPTHINVERTED_OFFSET UNITYSDK_OFFSET(0x92AD10)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_JITTEROFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C390)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_JITTEROFFSET_OFFSET UNITYSDK_OFFSET(0x92ABC0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_MOTIONVECTORSDILATED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C560)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_MOTIONVECTORSDILATED_OFFSET UNITYSDK_OFFSET(0x92AD40)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_MVECSCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C3C0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_MVECSCALE_OFFSET UNITYSDK_OFFSET(0x92ABE0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_PREVCLIPTOCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C360)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_PREVCLIPTOCLIP_OFFSET UNITYSDK_OFFSET(0x92AB80)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_RESET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52C540)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_RESET_OFFSET UNITYSDK_OFFSET(0x92AD30)
