...
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAASPECTRATIO_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F6D0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAASPECTRATIO_OFFSET UNITYSDK_OFFSET(0x901420)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F690)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFAR_OFFSET UNITYSDK_OFFSET(0x901400)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFOV_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F6B0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFOV_OFFSET UNITYSDK_OFFSET(0x901410)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFWD_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F650)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAFWD_OFFSET UNITYSDK_OFFSET(0x9013C0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAMOTIONINCLUDED_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F730)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAMOTIONINCLUDED_OFFSET UNITYSDK_OFFSET(0x901450)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERANEAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F670)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERANEAR_OFFSET UNITYSDK_OFFSET(0x9013F0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAPOS_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F5F0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAPOS_OFFSET UNITYSDK_OFFSET(0x901330)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERARIGHT_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F630)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERARIGHT_OFFSET UNITYSDK_OFFSET(0x901390)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAUP_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F610)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAUP_OFFSET UNITYSDK_OFFSET(0x901360)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAVIEWTOCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F510)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CAMERAVIEWTOCLIP_OFFSET UNITYSDK_OFFSET(0x9011F0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CLIPTOCAMERAVIEW_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F530)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CLIPTOCAMERAVIEW_OFFSET UNITYSDK_OFFSET(0x901230)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CLIPTOPREVCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F550)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_CLIPTOPREVCLIP_OFFSET UNITYSDK_OFFSET(0x901270)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_DELTATIME_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F6F0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x901430)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_DEPTHINVERTED_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F710)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_DEPTHINVERTED_OFFSET UNITYSDK_OFFSET(0x901440)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_JITTEROFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F5A0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_JITTEROFFSET_OFFSET UNITYSDK_OFFSET(0x9012F0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_MOTIONVECTORSDILATED_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F770)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_MOTIONVECTORSDILATED_OFFSET UNITYSDK_OFFSET(0x901470)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_MVECSCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F5D0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_MVECSCALE_OFFSET UNITYSDK_OFFSET(0x901310)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_PREVCLIPTOCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F570)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_PREVCLIPTOCLIP_OFFSET UNITYSDK_OFFSET(0x9012B0)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_RESET_INJECTED_OFFSET UNITYSDK_OFFSET(0x19F4F750)
#define UNITYENGINE_RENDERING_FSRCONSTANTS_SET_RESET_OFFSET UNITYSDK_OFFSET(0x901460)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int FSRConstants_TypeDefinitionIndex = 6134;
