...
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x91DAF0)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_EQUALS_OFFSET UNITYSDK_OFFSET(0x91DAB0)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GETCULLINGPLANE_OFFSET UNITYSDK_OFFSET(0x91DA90)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x91DB70)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GETLAYERCULLINGDISTANCE_OFFSET UNITYSDK_OFFSET(0x91DA80)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GET_CULLINGOPTIONS_OFFSET UNITYSDK_OFFSET(0x91DA60)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GET_CULLINGPLANECOUNT_OFFSET UNITYSDK_OFFSET(0x91DA30)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_GET_MAXIMUMVISIBLELIGHTS_OFFSET UNITYSDK_OFFSET(0x91DA10)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SETLOCALSHADOWCACHESETTING_OFFSET UNITYSDK_OFFSET(0x91D990)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SET_CULLINGMASK_OFFSET UNITYSDK_OFFSET(0x91DA40)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SET_CULLINGOPTIONS_OFFSET UNITYSDK_OFFSET(0x91DA70)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SET_MAXIMUMVISIBLELIGHTS_OFFSET UNITYSDK_OFFSET(0x91DA20)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS_SET_SHADOWDISTANCE_OFFSET UNITYSDK_OFFSET(0x91DA50)
#define UNITYENGINE_RENDERING_SCRIPTABLECULLINGPARAMETERS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A27E9C0)
