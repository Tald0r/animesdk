...
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTEPOINTSHADOWMATRICESANDCULLINGPRIMITIVES_1_OFFSET UNITYSDK_OFFSET(0x8F34E0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTEPOINTSHADOWMATRICESANDCULLINGPRIMITIVES_OFFSET UNITYSDK_OFFSET(0x19CFFA10)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTESPOTSHADOWMATRICESANDCULLINGPRIMITIVES_1_OFFSET UNITYSDK_OFFSET(0x8F34D0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTESPOTSHADOWMATRICESANDCULLINGPRIMITIVES_OFFSET UNITYSDK_OFFSET(0x19CFFA00)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8F3550)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_EQUALS_OFFSET UNITYSDK_OFFSET(0x8F34F0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3A3B30)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLEINCURRENTCAM_1_OFFSET UNITYSDK_OFFSET(0x19CFFA50)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLEINCURRENTCAM_OFFSET UNITYSDK_OFFSET(0x19CFFA30)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLE_1_OFFSET UNITYSDK_OFFSET(0x19CFFA40)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLE_OFFSET UNITYSDK_OFFSET(0x19CFFA20)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETSHADOWCASTERBOUNDS_1_OFFSET UNITYSDK_OFFSET(0x8F34C0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETSHADOWCASTERBOUNDS_OFFSET UNITYSDK_OFFSET(0x19CFF9F0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_LOCALSHADOWCACHEDYNAMICUPDATEREQUESTS_OFFSET UNITYSDK_OFFSET(0x8F3460)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_LOCALSHADOWCACHESHADOWEDLIGHTS_OFFSET UNITYSDK_OFFSET(0x8F3490)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_LOCALSHADOWCACHESTATICUPDATEREQUESTS_OFFSET UNITYSDK_OFFSET(0x8F3430)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_VISIBLELIGHTS_OFFSET UNITYSDK_OFFSET(0x8F3400)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int CullingResults_TypeDefinitionIndex = 6207;
