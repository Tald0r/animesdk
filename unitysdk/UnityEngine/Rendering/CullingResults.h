...
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTEPOINTSHADOWMATRICESANDCULLINGPRIMITIVES_1_OFFSET UNITYSDK_OFFSET(0x91E690)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTEPOINTSHADOWMATRICESANDCULLINGPRIMITIVES_OFFSET UNITYSDK_OFFSET(0x1A28ABC0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTESPOTSHADOWMATRICESANDCULLINGPRIMITIVES_1_OFFSET UNITYSDK_OFFSET(0x91E680)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_COMPUTESPOTSHADOWMATRICESANDCULLINGPRIMITIVES_OFFSET UNITYSDK_OFFSET(0x1A28ABB0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x91E700)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_EQUALS_OFFSET UNITYSDK_OFFSET(0x91E6A0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3CA700)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLEINCURRENTCAM_1_OFFSET UNITYSDK_OFFSET(0x1A28AC00)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLEINCURRENTCAM_OFFSET UNITYSDK_OFFSET(0x1A28ABE0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLE_1_OFFSET UNITYSDK_OFFSET(0x1A28ABF0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETRENDERVISIBLE_OFFSET UNITYSDK_OFFSET(0x1A28ABD0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETSHADOWCASTERBOUNDS_1_OFFSET UNITYSDK_OFFSET(0x91E670)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GETSHADOWCASTERBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A28ABA0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_LOCALSHADOWCACHEDYNAMICUPDATEREQUESTS_OFFSET UNITYSDK_OFFSET(0x91E610)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_LOCALSHADOWCACHESHADOWEDLIGHTS_OFFSET UNITYSDK_OFFSET(0x91E640)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_LOCALSHADOWCACHESTATICUPDATEREQUESTS_OFFSET UNITYSDK_OFFSET(0x91E5E0)
#define UNITYENGINE_RENDERING_CULLINGRESULTS_GET_VISIBLELIGHTS_OFFSET UNITYSDK_OFFSET(0x91E5B0)
