...
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8EE310)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x8EE2D0)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_GETCULLINGPLANE_OFFSET UNITYSDK_OFFSET(0x8EE2B0)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8EE390)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_GET_CULLINGPLANECOUNT_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_SET_SHADOWCASCADEBLENDCULLINGFACTOR_OFFSET UNITYSDK_OFFSET(0x8EE2A0)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EA8300)
