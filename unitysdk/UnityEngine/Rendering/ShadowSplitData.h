...
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8C1870)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x8C1830)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_GETCULLINGPLANE_OFFSET UNITYSDK_OFFSET(0x8C1810)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8C18F0)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_GET_CULLINGPLANECOUNT_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA_SET_SHADOWCASCADEBLENDCULLINGFACTOR_OFFSET UNITYSDK_OFFSET(0x8C1800)
#define UNITYENGINE_RENDERING_SHADOWSPLITDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x19968460)

namespace UnityEngine::Rendering
{
	inline static constexpr unsigned int ShadowSplitData_TypeDefinitionIndex = 6229;

	struct alignas(4) ShadowSplitData
	{
		static ::System::Int32* StaticGet_maximumCullingPlaneCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ShadowSplitData_TypeDefinitionIndex)->GetStaticField(0x2BD0);
		}
