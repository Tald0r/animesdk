...
#define UNITYENGINE_COLLIDER_CLOSESTPOINTONBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A755490)
#define UNITYENGINE_COLLIDER_CLOSESTPOINT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A755270)
#define UNITYENGINE_COLLIDER_CLOSESTPOINT_OFFSET UNITYSDK_OFFSET(0x1A755220)
#define UNITYENGINE_COLLIDER_GET_ATTACHEDRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1A7551B0)
#define UNITYENGINE_COLLIDER_GET_BOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A7552D0)
#define UNITYENGINE_COLLIDER_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1A755280)
#define UNITYENGINE_COLLIDER_GET_CONTACTOFFSET_OFFSET UNITYSDK_OFFSET(0x1A7551E0)
#define UNITYENGINE_COLLIDER_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A755190)
#define UNITYENGINE_COLLIDER_GET_HASMODIFIABLECONTACTS_OFFSET UNITYSDK_OFFSET(0x1A7552E0)
#define UNITYENGINE_COLLIDER_GET_ISIGNOREIK_OFFSET UNITYSDK_OFFSET(0x1A755510)
#define UNITYENGINE_COLLIDER_GET_ISIGNOREMDB_OFFSET UNITYSDK_OFFSET(0x1A755530)
#define UNITYENGINE_COLLIDER_GET_ISSCENEQUERY_OFFSET UNITYSDK_OFFSET(0x1A755200)
#define UNITYENGINE_COLLIDER_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A7551C0)
#define UNITYENGINE_COLLIDER_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A755320)
#define UNITYENGINE_COLLIDER_GET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A755300)
#define UNITYENGINE_COLLIDER_INTERNAL_CLOSESTPOINTONBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A755480)
#define UNITYENGINE_COLLIDER_INTERNAL_CLOSESTPOINTONBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A755470)
#define UNITYENGINE_COLLIDER_ISDELAYDELETED_OFFSET UNITYSDK_OFFSET(0x1A755500)
#define UNITYENGINE_COLLIDER_RAYCAST_1_OFFSET UNITYSDK_OFFSET(0x1A7553C0)
#define UNITYENGINE_COLLIDER_RAYCAST_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A7553B0)
#define UNITYENGINE_COLLIDER_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1A755340)
#define UNITYENGINE_COLLIDER_SET_CONTACTOFFSET_OFFSET UNITYSDK_OFFSET(0x1A7551F0)
#define UNITYENGINE_COLLIDER_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A7551A0)
#define UNITYENGINE_COLLIDER_SET_HASMODIFIABLECONTACTS_OFFSET UNITYSDK_OFFSET(0x1A7552F0)
#define UNITYENGINE_COLLIDER_SET_ISIGNOREIK_OFFSET UNITYSDK_OFFSET(0x1A755520)
#define UNITYENGINE_COLLIDER_SET_ISIGNOREMDB_OFFSET UNITYSDK_OFFSET(0x1A755540)
#define UNITYENGINE_COLLIDER_SET_ISSCENEQUERY_OFFSET UNITYSDK_OFFSET(0x1A755210)
#define UNITYENGINE_COLLIDER_SET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A7551D0)
#define UNITYENGINE_COLLIDER_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A755330)
#define UNITYENGINE_COLLIDER_SET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A755310)
#define UNITYENGINE_COLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A754D60)

namespace UnityEngine
{
	inline static constexpr unsigned int Collider_TypeDefinitionIndex = 7661;
