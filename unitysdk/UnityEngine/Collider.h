...
#define UNITYENGINE_COLLIDER_CLOSESTPOINTONBOUNDS_OFFSET UNITYSDK_OFFSET(0x1ACF9150)
#define UNITYENGINE_COLLIDER_CLOSESTPOINT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACF8F30)
#define UNITYENGINE_COLLIDER_CLOSESTPOINT_OFFSET UNITYSDK_OFFSET(0x1ACF8EE0)
#define UNITYENGINE_COLLIDER_GET_ATTACHEDRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1ACF8E70)
#define UNITYENGINE_COLLIDER_GET_BOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACF8F90)
#define UNITYENGINE_COLLIDER_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1ACF8F40)
#define UNITYENGINE_COLLIDER_GET_CONTACTOFFSET_OFFSET UNITYSDK_OFFSET(0x1ACF8EA0)
#define UNITYENGINE_COLLIDER_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1ACF8E50)
#define UNITYENGINE_COLLIDER_GET_HASMODIFIABLECONTACTS_OFFSET UNITYSDK_OFFSET(0x1ACF8FA0)
#define UNITYENGINE_COLLIDER_GET_ISIGNOREIK_OFFSET UNITYSDK_OFFSET(0x1ACF91D0)
#define UNITYENGINE_COLLIDER_GET_ISIGNOREMDB_OFFSET UNITYSDK_OFFSET(0x1ACF91F0)
#define UNITYENGINE_COLLIDER_GET_ISSCENEQUERY_OFFSET UNITYSDK_OFFSET(0x1ACF8EC0)
#define UNITYENGINE_COLLIDER_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1ACF8E80)
#define UNITYENGINE_COLLIDER_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1ACF8FE0)
#define UNITYENGINE_COLLIDER_GET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1ACF8FC0)
#define UNITYENGINE_COLLIDER_INTERNAL_CLOSESTPOINTONBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACF9140)
#define UNITYENGINE_COLLIDER_INTERNAL_CLOSESTPOINTONBOUNDS_OFFSET UNITYSDK_OFFSET(0x1ACF9130)
#define UNITYENGINE_COLLIDER_ISDELAYDELETED_OFFSET UNITYSDK_OFFSET(0x1ACF91C0)
#define UNITYENGINE_COLLIDER_RAYCAST_1_OFFSET UNITYSDK_OFFSET(0x1ACF9080)
#define UNITYENGINE_COLLIDER_RAYCAST_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACF9070)
#define UNITYENGINE_COLLIDER_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1ACF9000)
#define UNITYENGINE_COLLIDER_SET_CONTACTOFFSET_OFFSET UNITYSDK_OFFSET(0x1ACF8EB0)
#define UNITYENGINE_COLLIDER_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1ACF8E60)
#define UNITYENGINE_COLLIDER_SET_HASMODIFIABLECONTACTS_OFFSET UNITYSDK_OFFSET(0x1ACF8FB0)
#define UNITYENGINE_COLLIDER_SET_ISIGNOREIK_OFFSET UNITYSDK_OFFSET(0x1ACF91E0)
#define UNITYENGINE_COLLIDER_SET_ISIGNOREMDB_OFFSET UNITYSDK_OFFSET(0x1ACF9200)
#define UNITYENGINE_COLLIDER_SET_ISSCENEQUERY_OFFSET UNITYSDK_OFFSET(0x1ACF8ED0)
#define UNITYENGINE_COLLIDER_SET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1ACF8E90)
#define UNITYENGINE_COLLIDER_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1ACF8FF0)
#define UNITYENGINE_COLLIDER_SET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1ACF8FD0)
#define UNITYENGINE_COLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACF8A20)
