...
#define UNITYENGINE_ANIMAGECOMPONENT_GETANIMATOROUTPUTBONELOCALX_OFFSET UNITYSDK_OFFSET(0x1B153120)
#define UNITYENGINE_ANIMAGECOMPONENT_GETANIMATOROUTPUTBONEX_OFFSET UNITYSDK_OFFSET(0x1B153110)
#define UNITYENGINE_ANIMAGECOMPONENT_GETBONEREFX_OFFSET UNITYSDK_OFFSET(0x1B1530F0)
#define UNITYENGINE_ANIMAGECOMPONENT_GETLASTFRAMEINPUTBONEX_OFFSET UNITYSDK_OFFSET(0x1B153100)
#define UNITYENGINE_ANIMAGECOMPONENT_RECORDDEBUGLINE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B153140)
#define UNITYENGINE_ANIMAGECOMPONENT_RECORDDEBUGLINE_OFFSET UNITYSDK_OFFSET(0x1B153130)
#define UNITYENGINE_ANIMAGECOMPONENT_RECORDDEBUGSPHERE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B153160)
#define UNITYENGINE_ANIMAGECOMPONENT_RECORDDEBUGSPHERE_OFFSET UNITYSDK_OFFSET(0x1B153150)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMFLOAT_OFFSET UNITYSDK_OFFSET(0x1B153020)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMINT_OFFSET UNITYSDK_OFFSET(0x1B153030)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMPOSQUATWITHSCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B1530E0)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMPOSQUATWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1B1530D0)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMPOSQUAT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B1530C0)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMPOSQUAT_OFFSET UNITYSDK_OFFSET(0x1B1530B0)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMVECTOR2_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B153060)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMVECTOR2_OFFSET UNITYSDK_OFFSET(0x1B153040)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMVECTOR3_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B153080)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMVECTOR3_OFFSET UNITYSDK_OFFSET(0x1B153070)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMVECTOR4_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B1530A0)
#define UNITYENGINE_ANIMAGECOMPONENT_SETCONTROLPARAMVECTOR4_OFFSET UNITYSDK_OFFSET(0x1B153090)
#define UNITYENGINE_ANIMAGECOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B153170)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimageComponent_TypeDefinitionIndex = 36094;
