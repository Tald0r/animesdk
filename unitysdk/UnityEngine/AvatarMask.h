...
#define UNITYENGINE_AVATARMASK_ADDTRANSFORMPATH_1_OFFSET UNITYSDK_OFFSET(0x1B771620)
#define UNITYENGINE_AVATARMASK_ADDTRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1B771610)
#define UNITYENGINE_AVATARMASK_APPLYMASKROTATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B771600)
#define UNITYENGINE_AVATARMASK_APPLYMASKTRANSFORMCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7715A0)
#define UNITYENGINE_AVATARMASK_APPLYMASKTRANSLATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7715D0)
#define UNITYENGINE_AVATARMASK_COPY_OFFSET UNITYSDK_OFFSET(0x1B771780)
#define UNITYENGINE_AVATARMASK_GETACL2PRECISIONSCALER_OFFSET UNITYSDK_OFFSET(0x1B771670)
#define UNITYENGINE_AVATARMASK_GETHUMANOIDBODYPARTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B771520)
#define UNITYENGINE_AVATARMASK_GETNODEROTATIONCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7716D0)
#define UNITYENGINE_AVATARMASK_GETNODETRANSFORMCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B771690)
#define UNITYENGINE_AVATARMASK_GETNODETRANSLATIONCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7716B0)
#define UNITYENGINE_AVATARMASK_GETTRANSFORMACTIVE_OFFSET UNITYSDK_OFFSET(0x1B771710)
#define UNITYENGINE_AVATARMASK_GETTRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1B771650)
#define UNITYENGINE_AVATARMASK_GETTRANSFORMWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B7716F0)
#define UNITYENGINE_AVATARMASK_GET_HASFEETIK_OFFSET UNITYSDK_OFFSET(0x1B771770)
#define UNITYENGINE_AVATARMASK_GET_HUMANOIDBODYPARTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B771510)
#define UNITYENGINE_AVATARMASK_GET_ISACLMASK2_OFFSET UNITYSDK_OFFSET(0x1B771540)
#define UNITYENGINE_AVATARMASK_GET_MASKROTATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7715E0)
#define UNITYENGINE_AVATARMASK_GET_MASKTRANSFORMCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B771580)
#define UNITYENGINE_AVATARMASK_GET_MASKTRANSLATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7715B0)
#define UNITYENGINE_AVATARMASK_GET_TRANSFORMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B771560)
#define UNITYENGINE_AVATARMASK_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B771500)
#define UNITYENGINE_AVATARMASK_REMOVETRANSFORMPATH_1_OFFSET UNITYSDK_OFFSET(0x1B771640)
#define UNITYENGINE_AVATARMASK_REMOVETRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1B771630)
#define UNITYENGINE_AVATARMASK_SETACL2PRECISIONSCALER_OFFSET UNITYSDK_OFFSET(0x1B771680)
#define UNITYENGINE_AVATARMASK_SETHUMANOIDBODYPARTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B771530)
#define UNITYENGINE_AVATARMASK_SETNODEROTATIONCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7716E0)
#define UNITYENGINE_AVATARMASK_SETNODETRANSFORMCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7716A0)
#define UNITYENGINE_AVATARMASK_SETNODETRANSLATIONCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7716C0)
#define UNITYENGINE_AVATARMASK_SETTRANSFORMACTIVE_OFFSET UNITYSDK_OFFSET(0x1B771730)
#define UNITYENGINE_AVATARMASK_SETTRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1B771660)
#define UNITYENGINE_AVATARMASK_SETTRANSFORMWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B771700)
#define UNITYENGINE_AVATARMASK_SET_ISACLMASK2_OFFSET UNITYSDK_OFFSET(0x1B771550)
#define UNITYENGINE_AVATARMASK_SET_MASKROTATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7715F0)
#define UNITYENGINE_AVATARMASK_SET_MASKTRANSFORMCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B771590)
#define UNITYENGINE_AVATARMASK_SET_MASKTRANSLATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7715C0)
#define UNITYENGINE_AVATARMASK_SET_TRANSFORMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B771570)
#define UNITYENGINE_AVATARMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7714D0)
