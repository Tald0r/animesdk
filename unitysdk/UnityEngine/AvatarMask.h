...
#define UNITYENGINE_AVATARMASK_ADDTRANSFORMPATH_1_OFFSET UNITYSDK_OFFSET(0x1B152670)
#define UNITYENGINE_AVATARMASK_ADDTRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1B152660)
#define UNITYENGINE_AVATARMASK_APPLYMASKROTATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B152650)
#define UNITYENGINE_AVATARMASK_APPLYMASKTRANSFORMCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B1525F0)
#define UNITYENGINE_AVATARMASK_APPLYMASKTRANSLATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B152620)
#define UNITYENGINE_AVATARMASK_COPY_OFFSET UNITYSDK_OFFSET(0x1B1527D0)
#define UNITYENGINE_AVATARMASK_GETACL2PRECISIONSCALER_OFFSET UNITYSDK_OFFSET(0x1B1526C0)
#define UNITYENGINE_AVATARMASK_GETHUMANOIDBODYPARTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B152570)
#define UNITYENGINE_AVATARMASK_GETNODEROTATIONCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B152720)
#define UNITYENGINE_AVATARMASK_GETNODETRANSFORMCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B1526E0)
#define UNITYENGINE_AVATARMASK_GETNODETRANSLATIONCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B152700)
#define UNITYENGINE_AVATARMASK_GETTRANSFORMACTIVE_OFFSET UNITYSDK_OFFSET(0x1B152760)
#define UNITYENGINE_AVATARMASK_GETTRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1B1526A0)
#define UNITYENGINE_AVATARMASK_GETTRANSFORMWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B152740)
#define UNITYENGINE_AVATARMASK_GET_HASFEETIK_OFFSET UNITYSDK_OFFSET(0x1B1527C0)
#define UNITYENGINE_AVATARMASK_GET_HUMANOIDBODYPARTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B152560)
#define UNITYENGINE_AVATARMASK_GET_ISACLMASK2_OFFSET UNITYSDK_OFFSET(0x1B152590)
#define UNITYENGINE_AVATARMASK_GET_MASKROTATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B152630)
#define UNITYENGINE_AVATARMASK_GET_MASKTRANSFORMCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B1525D0)
#define UNITYENGINE_AVATARMASK_GET_MASKTRANSLATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B152600)
#define UNITYENGINE_AVATARMASK_GET_TRANSFORMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B1525B0)
#define UNITYENGINE_AVATARMASK_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B152550)
#define UNITYENGINE_AVATARMASK_REMOVETRANSFORMPATH_1_OFFSET UNITYSDK_OFFSET(0x1B152690)
#define UNITYENGINE_AVATARMASK_REMOVETRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1B152680)
#define UNITYENGINE_AVATARMASK_SETACL2PRECISIONSCALER_OFFSET UNITYSDK_OFFSET(0x1B1526D0)
#define UNITYENGINE_AVATARMASK_SETHUMANOIDBODYPARTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B152580)
#define UNITYENGINE_AVATARMASK_SETNODEROTATIONCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B152730)
#define UNITYENGINE_AVATARMASK_SETNODETRANSFORMCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B1526F0)
#define UNITYENGINE_AVATARMASK_SETNODETRANSLATIONCOMPORESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B152710)
#define UNITYENGINE_AVATARMASK_SETTRANSFORMACTIVE_OFFSET UNITYSDK_OFFSET(0x1B152780)
#define UNITYENGINE_AVATARMASK_SETTRANSFORMPATH_OFFSET UNITYSDK_OFFSET(0x1B1526B0)
#define UNITYENGINE_AVATARMASK_SETTRANSFORMWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B152750)
#define UNITYENGINE_AVATARMASK_SET_ISACLMASK2_OFFSET UNITYSDK_OFFSET(0x1B1525A0)
#define UNITYENGINE_AVATARMASK_SET_MASKROTATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B152640)
#define UNITYENGINE_AVATARMASK_SET_MASKTRANSFORMCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B1525E0)
#define UNITYENGINE_AVATARMASK_SET_MASKTRANSLATIONCOMPRESSQUALITY_OFFSET UNITYSDK_OFFSET(0x1B152610)
#define UNITYENGINE_AVATARMASK_SET_TRANSFORMCOUNT_OFFSET UNITYSDK_OFFSET(0x1B1525C0)
#define UNITYENGINE_AVATARMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B152520)

namespace UnityEngine
{
	inline static constexpr unsigned int AvatarMask_TypeDefinitionIndex = 6555;
