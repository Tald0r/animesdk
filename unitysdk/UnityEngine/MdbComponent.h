...
#define UNITYENGINE_MDBCOMPONENT_BLENDTOANIMPOSEPERCLOTH_OFFSET UNITYSDK_OFFSET(0x1B146D40)
#define UNITYENGINE_MDBCOMPONENT_BLENDTOANIMPOSESECONDS_OFFSET UNITYSDK_OFFSET(0x1B146D20)
#define UNITYENGINE_MDBCOMPONENT_BLENDTOSIMPOSEPERCLOTH_OFFSET UNITYSDK_OFFSET(0x1B146D50)
#define UNITYENGINE_MDBCOMPONENT_BLENDTOSIMPOSESECONDS_OFFSET UNITYSDK_OFFSET(0x1B146D30)
#define UNITYENGINE_MDBCOMPONENT_CREATEMVDACTORSERVER_OFFSET UNITYSDK_OFFSET(0x1B146CA0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADBONENAMES_OFFSET UNITYSDK_OFFSET(0x1B146FA0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADBONEPARENTS_OFFSET UNITYSDK_OFFSET(0x1B146FB0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADBONEPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1B146FC0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADBONEROTATIONS_OFFSET UNITYSDK_OFFSET(0x1B146FD0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADCTXPARTICLESBONENAME_OFFSET UNITYSDK_OFFSET(0x1B146EB0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMCLOTHSKINCOLLIDERSPHEREPOS_OFFSET UNITYSDK_OFFSET(0x1B146F10)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMCLOTHSKINCOLLIDERSPHERERADIUS_OFFSET UNITYSDK_OFFSET(0x1B146F20)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMPARTICLESANIMPOSEPOS_OFFSET UNITYSDK_OFFSET(0x1B146EF0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMPARTICLESANIMPOSEROT_OFFSET UNITYSDK_OFFSET(0x1B146F00)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMPARTICLESSIMPOSENORM_OFFSET UNITYSDK_OFFSET(0x1B146EC0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMPARTICLESSIMPOSEPOS_OFFSET UNITYSDK_OFFSET(0x1B146ED0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMPARTICLESSIMPOSEROT_OFFSET UNITYSDK_OFFSET(0x1B146EE0)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMWINDDATA_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B146F90)
#define UNITYENGINE_MDBCOMPONENT_DOWNLOADSIMWINDDATA_OFFSET UNITYSDK_OFFSET(0x1B146F30)
#define UNITYENGINE_MDBCOMPONENT_GETBYTEDATAVER_OFFSET UNITYSDK_OFFSET(0x1B146FE0)
#define UNITYENGINE_MDBCOMPONENT_GETCLOTHBLENDRATE_OFFSET UNITYSDK_OFFSET(0x1B146D10)
#define UNITYENGINE_MDBCOMPONENT_GETCLOTHINITSTATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B146D60)
#define UNITYENGINE_MDBCOMPONENT_GETCLOTHINITSTATE_OFFSET UNITYSDK_OFFSET(0x1B146D70)
#define UNITYENGINE_MDBCOMPONENT_GETCLOTHNUM_OFFSET UNITYSDK_OFFSET(0x1B146BD0)
#define UNITYENGINE_MDBCOMPONENT_GETCLOTHSTATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B146DA0)
#define UNITYENGINE_MDBCOMPONENT_GETCLOTHSTATE_OFFSET UNITYSDK_OFFSET(0x1B146DB0)
#define UNITYENGINE_MDBCOMPONENT_GETMANUALSTEPENABLE_OFFSET UNITYSDK_OFFSET(0x1B146C40)
#define UNITYENGINE_MDBCOMPONENT_GETMDBCLOTHES_OFFSET UNITYSDK_OFFSET(0x1B146B10)
#define UNITYENGINE_MDBCOMPONENT_GETMDBENABLE_OFFSET UNITYSDK_OFFSET(0x1B146C20)
#define UNITYENGINE_MDBCOMPONENT_GETSTEPUNITYBONEENABLE_OFFSET UNITYSDK_OFFSET(0x1B146C70)
#define UNITYENGINE_MDBCOMPONENT_GETSTIFFEXPONENTRATE_OFFSET UNITYSDK_OFFSET(0x1B146CF0)
#define UNITYENGINE_MDBCOMPONENT_GETTIMESLOWRATE_OFFSET UNITYSDK_OFFSET(0x1B146CD0)
#define UNITYENGINE_MDBCOMPONENT_GET_BLEND2ANIMPOSESECONDS_OFFSET UNITYSDK_OFFSET(0x1B147010)
#define UNITYENGINE_MDBCOMPONENT_GET_BLEND2SIMPOSESECONDS_OFFSET UNITYSDK_OFFSET(0x1B147030)
#define UNITYENGINE_MDBCOMPONENT_GET_ENVIRONMENTLODVALUE_OFFSET UNITYSDK_OFFSET(0x1B146B50)
#define UNITYENGINE_MDBCOMPONENT_GET_FORCEUSEAVATARPOSITIONENABLE_OFFSET UNITYSDK_OFFSET(0x1B146B70)
#define UNITYENGINE_MDBCOMPONENT_GET_ISMDBUSESKELETONSCALE_OFFSET UNITYSDK_OFFSET(0x1B146BB0)
#define UNITYENGINE_MDBCOMPONENT_GET_LAYERINDEX_OFFSET UNITYSDK_OFFSET(0x1B146FF0)
#define UNITYENGINE_MDBCOMPONENT_GET_MDBCLOTHES_OFFSET UNITYSDK_OFFSET(0x1B146AF0)
#define UNITYENGINE_MDBCOMPONENT_GET_MDBCLOTHFLAGS_OFFSET UNITYSDK_OFFSET(0x1B146B30)
#define UNITYENGINE_MDBCOMPONENT_GET_MDBHUMAN_OFFSET UNITYSDK_OFFSET(0x1B146AD0)
#define UNITYENGINE_MDBCOMPONENT_GET_SIMBYREFPOSESETUNITSCALE_OFFSET UNITYSDK_OFFSET(0x1B146B90)
#define UNITYENGINE_MDBCOMPONENT_GET_STATEHASHBLENDANIM_OFFSET UNITYSDK_OFFSET(0x1B147070)
#define UNITYENGINE_MDBCOMPONENT_GET_STATEHASHTRANSITEPARAM_OFFSET UNITYSDK_OFFSET(0x1B1470D0)
#define UNITYENGINE_MDBCOMPONENT_GET_STATELISTBLENDANIM_OFFSET UNITYSDK_OFFSET(0x1B147050)
#define UNITYENGINE_MDBCOMPONENT_GET_STATELISTTRANSITEPARAM_OFFSET UNITYSDK_OFFSET(0x1B1470B0)
#define UNITYENGINE_MDBCOMPONENT_GET_TRANSITEPARAMSECONDS_OFFSET UNITYSDK_OFFSET(0x1B147090)
#define UNITYENGINE_MDBCOMPONENT_ISCOLWITHSCENE_OFFSET UNITYSDK_OFFSET(0x1B146E80)
#define UNITYENGINE_MDBCOMPONENT_MANUALSTEP_OFFSET UNITYSDK_OFFSET(0x1B146C50)
#define UNITYENGINE_MDBCOMPONENT_REBINDMDB_OFFSET UNITYSDK_OFFSET(0x1B146BE0)
#define UNITYENGINE_MDBCOMPONENT_REFRESHSTATEHASH_OFFSET UNITYSDK_OFFSET(0x1B1470F0)
#define UNITYENGINE_MDBCOMPONENT_RELOADHUMANDATA_OFFSET UNITYSDK_OFFSET(0x1B146BF0)
#define UNITYENGINE_MDBCOMPONENT_RELOADSINGLECLOTHDATA_OFFSET UNITYSDK_OFFSET(0x1B146C00)
#define UNITYENGINE_MDBCOMPONENT_SETBLENDRATE_OFFSET UNITYSDK_OFFSET(0x1B146D00)
#define UNITYENGINE_MDBCOMPONENT_SETCLOTHLAYER_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B146DE0)
#define UNITYENGINE_MDBCOMPONENT_SETCLOTHLAYER_OFFSET UNITYSDK_OFFSET(0x1B146DF0)
#define UNITYENGINE_MDBCOMPONENT_SETCLOTHSTATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B146D80)
#define UNITYENGINE_MDBCOMPONENT_SETCLOTHSTATE_OFFSET UNITYSDK_OFFSET(0x1B146D90)
#define UNITYENGINE_MDBCOMPONENT_SETCLOTHSUPPLYANIM_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B146E00)
#define UNITYENGINE_MDBCOMPONENT_SETCLOTHSUPPLYANIM_OFFSET UNITYSDK_OFFSET(0x1B146E10)
#define UNITYENGINE_MDBCOMPONENT_SETCOLWITHSCENE_OFFSET UNITYSDK_OFFSET(0x1B146E70)
#define UNITYENGINE_MDBCOMPONENT_SETMANUALSTEPENABLE_OFFSET UNITYSDK_OFFSET(0x1B146C30)
#define UNITYENGINE_MDBCOMPONENT_SETMDBCLOTHES_OFFSET UNITYSDK_OFFSET(0x1B146B20)
#define UNITYENGINE_MDBCOMPONENT_SETMDBENABLE_OFFSET UNITYSDK_OFFSET(0x1B146C10)
#define UNITYENGINE_MDBCOMPONENT_SETMDBLODDISTS_OFFSET UNITYSDK_OFFSET(0x1B146CB0)
#define UNITYENGINE_MDBCOMPONENT_SETMDBLOGENABLED_OFFSET UNITYSDK_OFFSET(0x1B146C90)
#define UNITYENGINE_MDBCOMPONENT_SETQUERYSCENE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B146E90)
#define UNITYENGINE_MDBCOMPONENT_SETQUERYSCENE_OFFSET UNITYSDK_OFFSET(0x1B146EA0)
#define UNITYENGINE_MDBCOMPONENT_SETSTEPUNITYBONEENABLE_OFFSET UNITYSDK_OFFSET(0x1B146C60)
#define UNITYENGINE_MDBCOMPONENT_SETSTIFFEXPONENTRATE_OFFSET UNITYSDK_OFFSET(0x1B146CE0)
#define UNITYENGINE_MDBCOMPONENT_SETTELEPORTUP_OFFSET UNITYSDK_OFFSET(0x1B146E40)
#define UNITYENGINE_MDBCOMPONENT_SETTIMESLOWRATE_OFFSET UNITYSDK_OFFSET(0x1B146CC0)
#define UNITYENGINE_MDBCOMPONENT_SETTRANSPORT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B146E60)
#define UNITYENGINE_MDBCOMPONENT_SETTRANSPORT_OFFSET UNITYSDK_OFFSET(0x1B146E50)
#define UNITYENGINE_MDBCOMPONENT_SET_BLEND2ANIMPOSESECONDS_OFFSET UNITYSDK_OFFSET(0x1B147020)
#define UNITYENGINE_MDBCOMPONENT_SET_BLEND2SIMPOSESECONDS_OFFSET UNITYSDK_OFFSET(0x1B147040)
#define UNITYENGINE_MDBCOMPONENT_SET_ENVIRONMENTLODVALUE_OFFSET UNITYSDK_OFFSET(0x1B146B60)
#define UNITYENGINE_MDBCOMPONENT_SET_FORCEUSEAVATARPOSITIONENABLE_OFFSET UNITYSDK_OFFSET(0x1B146B80)
#define UNITYENGINE_MDBCOMPONENT_SET_ISMDBUSESKELETONSCALE_OFFSET UNITYSDK_OFFSET(0x1B146BC0)
#define UNITYENGINE_MDBCOMPONENT_SET_LAYERINDEX_OFFSET UNITYSDK_OFFSET(0x1B147000)
#define UNITYENGINE_MDBCOMPONENT_SET_MDBCLOTHES_OFFSET UNITYSDK_OFFSET(0x1B146B00)
#define UNITYENGINE_MDBCOMPONENT_SET_MDBCLOTHFLAGS_OFFSET UNITYSDK_OFFSET(0x1B146B40)
#define UNITYENGINE_MDBCOMPONENT_SET_MDBHUMAN_OFFSET UNITYSDK_OFFSET(0x1B146AE0)
#define UNITYENGINE_MDBCOMPONENT_SET_SIMBYREFPOSESETUNITSCALE_OFFSET UNITYSDK_OFFSET(0x1B146BA0)
#define UNITYENGINE_MDBCOMPONENT_SET_STATEHASHBLENDANIM_OFFSET UNITYSDK_OFFSET(0x1B147080)
#define UNITYENGINE_MDBCOMPONENT_SET_STATEHASHTRANSITEPARAM_OFFSET UNITYSDK_OFFSET(0x1B1470E0)
#define UNITYENGINE_MDBCOMPONENT_SET_STATELISTBLENDANIM_OFFSET UNITYSDK_OFFSET(0x1B147060)
#define UNITYENGINE_MDBCOMPONENT_SET_STATELISTTRANSITEPARAM_OFFSET UNITYSDK_OFFSET(0x1B1470C0)
#define UNITYENGINE_MDBCOMPONENT_SET_TRANSITEPARAMSECONDS_OFFSET UNITYSDK_OFFSET(0x1B1470A0)
#define UNITYENGINE_MDBCOMPONENT_TELEPORT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B146E30)
#define UNITYENGINE_MDBCOMPONENT_TELEPORT_OFFSET UNITYSDK_OFFSET(0x1B146E20)
#define UNITYENGINE_MDBCOMPONENT_TRANSITECLOTHSTATESECONDS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B146DC0)
#define UNITYENGINE_MDBCOMPONENT_TRANSITECLOTHSTATESECONDS_OFFSET UNITYSDK_OFFSET(0x1B146DD0)
#define UNITYENGINE_MDBCOMPONENT_UNITYBONESTEP_OFFSET UNITYSDK_OFFSET(0x1B146C80)
#define UNITYENGINE_MDBCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B147100)

namespace UnityEngine
{
	inline static constexpr unsigned int MdbComponent_TypeDefinitionIndex = 36101;
