...
#define UNITYENGINE_PBDDEFORMASSET_CALCULATEROTATIONDATA_OFFSET UNITYSDK_OFFSET(0x1B0DD860)
#define UNITYENGINE_PBDDEFORMASSET_CREATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B0DD740)
#define UNITYENGINE_PBDDEFORMASSET_GENERATERIGIDBODYLINKDATA_OFFSET UNITYSDK_OFFSET(0x1B0DD800)
#define UNITYENGINE_PBDDEFORMASSET_GENERATESKELETONPARTICLESKINDATA_OFFSET UNITYSDK_OFFSET(0x1B0DD830)
#define UNITYENGINE_PBDDEFORMASSET_GENERATESKINNINGDATA_OFFSET UNITYSDK_OFFSET(0x1B0DD820)
#define UNITYENGINE_PBDDEFORMASSET_GENERATESOFTBODYSKINNINGDATA_OFFSET UNITYSDK_OFFSET(0x1B0DD7B0)
#define UNITYENGINE_PBDDEFORMASSET_GENERATEUNIFORMPARTICLES_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B0DD900)
#define UNITYENGINE_PBDDEFORMASSET_GENERATEUNIFORMPARTICLES_OFFSET UNITYSDK_OFFSET(0x1B0DD870)
#define UNITYENGINE_PBDDEFORMASSET_GETBONETARGETMESHES_OFFSET UNITYSDK_OFFSET(0x1B0DD840)
#define UNITYENGINE_PBDDEFORMASSET_GETTETRATARGETMESHES_OFFSET UNITYSDK_OFFSET(0x1B0DD7D0)
#define UNITYENGINE_PBDDEFORMASSET_GETVERTEXTETRACOUNT_OFFSET UNITYSDK_OFFSET(0x1B0DD7C0)
#define UNITYENGINE_PBDDEFORMASSET_GET_DISTANCECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B0DD660)
#define UNITYENGINE_PBDDEFORMASSET_GET_FIXCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B0DD680)
#define UNITYENGINE_PBDDEFORMASSET_GET_JOINTCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B0DD6C0)
#define UNITYENGINE_PBDDEFORMASSET_GET_LINKEDRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1B0DD6E0)
#define UNITYENGINE_PBDDEFORMASSET_GET_PARTICLES_OFFSET UNITYSDK_OFFSET(0x1B0DD640)
#define UNITYENGINE_PBDDEFORMASSET_GET_VOLUMECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B0DD6A0)
#define UNITYENGINE_PBDDEFORMASSET_IMPORTFROMJSON_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B0DD7A0)
#define UNITYENGINE_PBDDEFORMASSET_IMPORTFROMJSON_OFFSET UNITYSDK_OFFSET(0x1B0DD790)
#define UNITYENGINE_PBDDEFORMASSET_NEEDUPDATERIGIDBODYLINKDATA_OFFSET UNITYSDK_OFFSET(0x1B0DD810)
#define UNITYENGINE_PBDDEFORMASSET_NEEDUPDATETETRASKINNINGDATA_OFFSET UNITYSDK_OFFSET(0x1B0DD7F0)
#define UNITYENGINE_PBDDEFORMASSET_REMOVEBONETARGETMESH_OFFSET UNITYSDK_OFFSET(0x1B0DD850)
#define UNITYENGINE_PBDDEFORMASSET_REMOVETETRATARGETMESH_OFFSET UNITYSDK_OFFSET(0x1B0DD7E0)
#define UNITYENGINE_PBDDEFORMASSET_SET_DISTANCECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B0DD670)
#define UNITYENGINE_PBDDEFORMASSET_SET_FIXCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B0DD690)
#define UNITYENGINE_PBDDEFORMASSET_SET_JOINTCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B0DD6D0)
#define UNITYENGINE_PBDDEFORMASSET_SET_LINKEDRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1B0DD6F0)
#define UNITYENGINE_PBDDEFORMASSET_SET_PARTICLES_OFFSET UNITYSDK_OFFSET(0x1B0DD650)
#define UNITYENGINE_PBDDEFORMASSET_SET_VOLUMECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B0DD6B0)
#define UNITYENGINE_PBDDEFORMASSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0DD750)
#define UNITYENGINE_PBDDEFORMASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0DD700)

namespace UnityEngine
{
	inline static constexpr unsigned int PBDDeformAsset_TypeDefinitionIndex = 23649;
