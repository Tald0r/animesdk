...
#define UNITYENGINE_PBDDEFORMASSET_CALCULATEROTATIONDATA_OFFSET UNITYSDK_OFFSET(0x1B6EE400)
#define UNITYENGINE_PBDDEFORMASSET_CREATE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B6EE2E0)
#define UNITYENGINE_PBDDEFORMASSET_GENERATERIGIDBODYLINKDATA_OFFSET UNITYSDK_OFFSET(0x1B6EE3A0)
#define UNITYENGINE_PBDDEFORMASSET_GENERATESKELETONPARTICLESKINDATA_OFFSET UNITYSDK_OFFSET(0x1B6EE3D0)
#define UNITYENGINE_PBDDEFORMASSET_GENERATESKINNINGDATA_OFFSET UNITYSDK_OFFSET(0x1B6EE3C0)
#define UNITYENGINE_PBDDEFORMASSET_GENERATESOFTBODYSKINNINGDATA_OFFSET UNITYSDK_OFFSET(0x1B6EE350)
#define UNITYENGINE_PBDDEFORMASSET_GENERATEUNIFORMPARTICLES_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B6EE4A0)
#define UNITYENGINE_PBDDEFORMASSET_GENERATEUNIFORMPARTICLES_OFFSET UNITYSDK_OFFSET(0x1B6EE410)
#define UNITYENGINE_PBDDEFORMASSET_GETBONETARGETMESHES_OFFSET UNITYSDK_OFFSET(0x1B6EE3E0)
#define UNITYENGINE_PBDDEFORMASSET_GETTETRATARGETMESHES_OFFSET UNITYSDK_OFFSET(0x1B6EE370)
#define UNITYENGINE_PBDDEFORMASSET_GETVERTEXTETRACOUNT_OFFSET UNITYSDK_OFFSET(0x1B6EE360)
#define UNITYENGINE_PBDDEFORMASSET_GET_DISTANCECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B6EE200)
#define UNITYENGINE_PBDDEFORMASSET_GET_FIXCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B6EE220)
#define UNITYENGINE_PBDDEFORMASSET_GET_JOINTCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B6EE260)
#define UNITYENGINE_PBDDEFORMASSET_GET_LINKEDRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1B6EE280)
#define UNITYENGINE_PBDDEFORMASSET_GET_PARTICLES_OFFSET UNITYSDK_OFFSET(0x1B6EE1E0)
#define UNITYENGINE_PBDDEFORMASSET_GET_VOLUMECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B6EE240)
#define UNITYENGINE_PBDDEFORMASSET_IMPORTFROMJSON_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B6EE340)
#define UNITYENGINE_PBDDEFORMASSET_IMPORTFROMJSON_OFFSET UNITYSDK_OFFSET(0x1B6EE330)
#define UNITYENGINE_PBDDEFORMASSET_NEEDUPDATERIGIDBODYLINKDATA_OFFSET UNITYSDK_OFFSET(0x1B6EE3B0)
#define UNITYENGINE_PBDDEFORMASSET_NEEDUPDATETETRASKINNINGDATA_OFFSET UNITYSDK_OFFSET(0x1B6EE390)
#define UNITYENGINE_PBDDEFORMASSET_REMOVEBONETARGETMESH_OFFSET UNITYSDK_OFFSET(0x1B6EE3F0)
#define UNITYENGINE_PBDDEFORMASSET_REMOVETETRATARGETMESH_OFFSET UNITYSDK_OFFSET(0x1B6EE380)
#define UNITYENGINE_PBDDEFORMASSET_SET_DISTANCECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B6EE210)
#define UNITYENGINE_PBDDEFORMASSET_SET_FIXCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B6EE230)
#define UNITYENGINE_PBDDEFORMASSET_SET_JOINTCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B6EE270)
#define UNITYENGINE_PBDDEFORMASSET_SET_LINKEDRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1B6EE290)
#define UNITYENGINE_PBDDEFORMASSET_SET_PARTICLES_OFFSET UNITYSDK_OFFSET(0x1B6EE1F0)
#define UNITYENGINE_PBDDEFORMASSET_SET_VOLUMECONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1B6EE250)
#define UNITYENGINE_PBDDEFORMASSET__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6EE2F0)
#define UNITYENGINE_PBDDEFORMASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EE2A0)

namespace UnityEngine
{
	inline static constexpr unsigned int PBDDeformAsset_TypeDefinitionIndex = 24332;
