...
#define UNITYENGINE_RECTTRANSFORM_REAPPLYDRIVENPROPERTIES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A4BFC80)
#define UNITYENGINE_RECTTRANSFORM_REAPPLYDRIVENPROPERTIES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A4BFCB0)
#define UNITYENGINE_RECTTRANSFORM_REAPPLYDRIVENPROPERTIES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A4BF780)
#define UNITYENGINE_RECTTRANSFORM_REAPPLYDRIVENPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BF770)

namespace UnityEngine
{
	inline static constexpr unsigned int RectTransform_ReapplyDrivenProperties_TypeDefinitionIndex = 5409;
