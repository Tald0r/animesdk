...
#define UNITYENGINE_COMPUTEBUFFER_COPYCOUNT_OFFSET UNITYSDK_OFFSET(0x19C35D60)
#define UNITYENGINE_COMPUTEBUFFER_DESTROYBUFFER_OFFSET UNITYSDK_OFFSET(0x19C34E40)
#define UNITYENGINE_COMPUTEBUFFER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19C34D40)
#define UNITYENGINE_COMPUTEBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C34DF0)
#define UNITYENGINE_COMPUTEBUFFER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19C34C50)
#define UNITYENGINE_COMPUTEBUFFER_GETBUFFERID_OFFSET UNITYSDK_OFFSET(0x19C35D70)
#define UNITYENGINE_COMPUTEBUFFER_GETDATA_1_OFFSET UNITYSDK_OFFSET(0x19C35A10)
#define UNITYENGINE_COMPUTEBUFFER_GETDATA_OFFSET UNITYSDK_OFFSET(0x19C357A0)
#define UNITYENGINE_COMPUTEBUFFER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19C35050)
#define UNITYENGINE_COMPUTEBUFFER_GET_STRIDE_OFFSET UNITYSDK_OFFSET(0x19C35060)
#define UNITYENGINE_COMPUTEBUFFER_INITBUFFER_OFFSET UNITYSDK_OFFSET(0x19C34E50)
#define UNITYENGINE_COMPUTEBUFFER_INTERNALGETDATA_OFFSET UNITYSDK_OFFSET(0x19C35A00)
#define UNITYENGINE_COMPUTEBUFFER_INTERNALSETDATA_OFFSET UNITYSDK_OFFSET(0x19C352D0)
#define UNITYENGINE_COMPUTEBUFFER_INTERNALSETNATIVEDATA_OFFSET UNITYSDK_OFFSET(0x19C35790)
#define UNITYENGINE_COMPUTEBUFFER_ISVALID_OFFSET UNITYSDK_OFFSET(0x19C35040)
#define UNITYENGINE_COMPUTEBUFFER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19C34FF0)
#define UNITYENGINE_COMPUTEBUFFER_SETCOUNTERVALUE_OFFSET UNITYSDK_OFFSET(0x19C35D50)
#define UNITYENGINE_COMPUTEBUFFER_SETDATA_1_OFFSET UNITYSDK_OFFSET(0x19C352E0)
#define UNITYENGINE_COMPUTEBUFFER_SETDATA_2_OFFSET UNITYSDK_OFFSET(0x19C35470)
#define UNITYENGINE_COMPUTEBUFFER_SETDATA_OFFSET UNITYSDK_OFFSET(0x19C35070)
#define UNITYENGINE_COMPUTEBUFFER_SETNAME_OFFSET UNITYSDK_OFFSET(0x19C35D40)
#define UNITYENGINE_COMPUTEBUFFER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19C35D30)
#define UNITYENGINE_COMPUTEBUFFER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C34EB0)
#define UNITYENGINE_COMPUTEBUFFER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19C34ED0)
#define UNITYENGINE_COMPUTEBUFFER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19C34EF0)
#define UNITYENGINE_COMPUTEBUFFER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19C34E90)
#define UNITYENGINE_COMPUTEBUFFER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19C34F20)
#define UNITYENGINE_COMPUTEBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C34E60)
