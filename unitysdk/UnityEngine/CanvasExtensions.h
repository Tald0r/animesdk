...
#define UNITYENGINE_CANVASEXTENSIONS_SAFESETWORLDCAMERA_OFFSET UNITYSDK_OFFSET(0x16C5E040)

namespace UnityEngine
{
	inline static constexpr unsigned int CanvasExtensions_TypeDefinitionIndex = 38227;
