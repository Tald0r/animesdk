...
#define UNITYENGINE_REMOTECONFIGSETTINGS_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B75BC30)
#define UNITYENGINE_REMOTECONFIGSETTINGS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B75BC70)
#define UNITYENGINE_REMOTECONFIGSETTINGS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B75BBB0)
#define UNITYENGINE_REMOTECONFIGSETTINGS_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B75BC60)
#define UNITYENGINE_REMOTECONFIGSETTINGS_REMOTECONFIGSETTINGSUPDATED_OFFSET UNITYSDK_OFFSET(0x1B75BCD0)
#define UNITYENGINE_REMOTECONFIGSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75BBA0)

namespace UnityEngine
{
	inline static constexpr unsigned int RemoteConfigSettings_TypeDefinitionIndex = 82493;
