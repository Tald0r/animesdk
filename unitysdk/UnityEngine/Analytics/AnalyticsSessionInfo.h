...
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_CALLIDENTITYTOKENCHANGED_OFFSET UNITYSDK_OFFSET(0x1B13E720)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_CALLSESSIONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1B13E2F0)

namespace UnityEngine::Analytics
{
	inline static constexpr unsigned int AnalyticsSessionInfo_TypeDefinitionIndex = 80456;
	...
	public:
		...
		{
			return (::UnityEngine::Analytics::AnalyticsSessionInfo_SessionStateChanged**)Il2CppClass::FromTypeDefinitionIndex(AnalyticsSessionInfo_TypeDefinitionIndex)->GetStaticField(0x45120);
		}
		static ::UnityEngine::Analytics::AnalyticsSessionInfo_IdentityTokenChanged** StaticGet_identityTokenChanged()
		{
			return (::UnityEngine::Analytics::AnalyticsSessionInfo_IdentityTokenChanged**)Il2CppClass::FromTypeDefinitionIndex(AnalyticsSessionInfo_TypeDefinitionIndex)->GetStaticField(0x45128);
		}
