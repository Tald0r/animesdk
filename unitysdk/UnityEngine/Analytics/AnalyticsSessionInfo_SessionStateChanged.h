...
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B75BAB0)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B75BB80)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B75B110)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75BA90)

namespace UnityEngine::Analytics
{
	inline static constexpr unsigned int AnalyticsSessionInfo_SessionStateChanged_TypeDefinitionIndex = 82499;
