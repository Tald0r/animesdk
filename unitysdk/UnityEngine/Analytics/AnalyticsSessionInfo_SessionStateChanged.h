...
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B13ECE0)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B13EDB0)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B13E360)
#define UNITYENGINE_ANALYTICS_ANALYTICSSESSIONINFO_SESSIONSTATECHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B13ECD0)

namespace UnityEngine::Analytics
{
	inline static constexpr unsigned int AnalyticsSessionInfo_SessionStateChanged_TypeDefinitionIndex = 80457;
