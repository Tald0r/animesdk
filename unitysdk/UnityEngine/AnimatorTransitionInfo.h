...
#define UNITYENGINE_ANIMATORTRANSITIONINFO_GET_ANYSTATE_OFFSET UNITYSDK_OFFSET(0x2F2060)
#define UNITYENGINE_ANIMATORTRANSITIONINFO_GET_DURATIONUNIT_OFFSET UNITYSDK_OFFSET(0x9B4CC0)
#define UNITYENGINE_ANIMATORTRANSITIONINFO_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x2EB560)
#define UNITYENGINE_ANIMATORTRANSITIONINFO_GET_LISTENTRANSITION_OFFSET UNITYSDK_OFFSET(0x322CF0)
#define UNITYENGINE_ANIMATORTRANSITIONINFO_GET_NAMEHASH_OFFSET UNITYSDK_OFFSET(0x2EC6E0)
#define UNITYENGINE_ANIMATORTRANSITIONINFO_GET_NORMALIZEDTIME_OFFSET UNITYSDK_OFFSET(0x3456B0)
#define UNITYENGINE_ANIMATORTRANSITIONINFO_GET_USERNAMEHASH_OFFSET UNITYSDK_OFFSET(0x302230)
#define UNITYENGINE_ANIMATORTRANSITIONINFO_ISUSERNAME_OFFSET UNITYSDK_OFFSET(0x9B4CA0)
