...
#define UNITYENGINE_COLLISION2D_GETCONTACTS_1_OFFSET UNITYSDK_OFFSET(0x1B0775B0)
#define UNITYENGINE_COLLISION2D_GETCONTACTS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B076E20)
#define UNITYENGINE_COLLISION2D_GETCONTACTS_OFFSET UNITYSDK_OFFSET(0x1B077520)
#define UNITYENGINE_COLLISION2D_GETCONTACT_OFFSET UNITYSDK_OFFSET(0x1B077410)
#define UNITYENGINE_COLLISION2D_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1B076E30)
#define UNITYENGINE_COLLISION2D_GET_CONTACTCOUNT_OFFSET UNITYSDK_OFFSET(0x1B077400)
#define UNITYENGINE_COLLISION2D_GET_CONTACTS_OFFSET UNITYSDK_OFFSET(0x1B077390)
#define UNITYENGINE_COLLISION2D_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1B077380)
#define UNITYENGINE_COLLISION2D_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B0771D0)
#define UNITYENGINE_COLLISION2D_GET_OTHERCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1B076ED0)
#define UNITYENGINE_COLLISION2D_GET_OTHERRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1B076FD0)
#define UNITYENGINE_COLLISION2D_GET_RELATIVEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B077370)
#define UNITYENGINE_COLLISION2D_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1B076F70)
#define UNITYENGINE_COLLISION2D_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B077030)
#define UNITYENGINE_COLLISION2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1B077650)
