...
#define UNITYENGINE_RAY_GETPOINT_OFFSET UNITYSDK_OFFSET(0x8E99F0)
#define UNITYENGINE_RAY_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x2D0730)
#define UNITYENGINE_RAY_GET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define UNITYENGINE_RAY_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x8E9960)
#define UNITYENGINE_RAY_SET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x2C4D20)
#define UNITYENGINE_RAY_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8E9A30)
#define UNITYENGINE_RAY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8E9A20)
#define UNITYENGINE_RAY__CTOR_OFFSET UNITYSDK_OFFSET(0x8E98C0)
