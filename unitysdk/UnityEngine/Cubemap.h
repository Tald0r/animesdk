...
#define UNITYENGINE_CUBEMAP_APPLYIMPL_OFFSET UNITYSDK_OFFSET(0x19C35E40)
#define UNITYENGINE_CUBEMAP_APPLY_1_OFFSET UNITYSDK_OFFSET(0x19C36670)
#define UNITYENGINE_CUBEMAP_APPLY_2_OFFSET UNITYSDK_OFFSET(0x19C366F0)
#define UNITYENGINE_CUBEMAP_APPLY_OFFSET UNITYSDK_OFFSET(0x19C365F0)
#define UNITYENGINE_CUBEMAP_CLEARREQUESTEDMIPMAPLEVEL_OFFSET UNITYSDK_OFFSET(0x19C36000)
#define UNITYENGINE_CUBEMAP_CREATEEXTERNALTEXTURE_OFFSET UNITYSDK_OFFSET(0x19C36400)
#define UNITYENGINE_CUBEMAP_GETPIXELIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19C35EE0)
#define UNITYENGINE_CUBEMAP_GETPIXELIMPL_OFFSET UNITYSDK_OFFSET(0x19C35E90)
#define UNITYENGINE_CUBEMAP_GETPIXELS_1_OFFSET UNITYSDK_OFFSET(0x19C35F20)
#define UNITYENGINE_CUBEMAP_GETPIXELS_OFFSET UNITYSDK_OFFSET(0x19C35F10)
#define UNITYENGINE_CUBEMAP_GETPIXEL_OFFSET UNITYSDK_OFFSET(0x19C36550)
#define UNITYENGINE_CUBEMAP_GET_DESIREDMIPMAPLEVEL_OFFSET UNITYSDK_OFFSET(0x19C35FD0)
#define UNITYENGINE_CUBEMAP_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x19C35D80)
#define UNITYENGINE_CUBEMAP_GET_ISREADABLE_OFFSET UNITYSDK_OFFSET(0x19C35E60)
#define UNITYENGINE_CUBEMAP_GET_LOADALLMIPS_OFFSET UNITYSDK_OFFSET(0x19C35FB0)
#define UNITYENGINE_CUBEMAP_GET_LOADEDMIPMAPLEVEL_OFFSET UNITYSDK_OFFSET(0x19C35FF0)
#define UNITYENGINE_CUBEMAP_GET_LOADINGMIPMAPLEVEL_OFFSET UNITYSDK_OFFSET(0x19C35FE0)
#define UNITYENGINE_CUBEMAP_GET_REQUESTEDMIPMAPLEVEL_OFFSET UNITYSDK_OFFSET(0x19C35F90)
#define UNITYENGINE_CUBEMAP_GET_STREAMINGMIPMAPSPRIORITY_OFFSET UNITYSDK_OFFSET(0x19C35F80)
#define UNITYENGINE_CUBEMAP_GET_STREAMINGMIPMAPS_OFFSET UNITYSDK_OFFSET(0x19C35F70)
#define UNITYENGINE_CUBEMAP_INTERNAL_CREATEIMPL_OFFSET UNITYSDK_OFFSET(0x19C35D90)
#define UNITYENGINE_CUBEMAP_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x19C35DA0)
#define UNITYENGINE_CUBEMAP_ISREQUESTEDMIPMAPLEVELLOADED_OFFSET UNITYSDK_OFFSET(0x19C36010)
#define UNITYENGINE_CUBEMAP_SETPIXELDATAIMPLARRAY_OFFSET UNITYSDK_OFFSET(0x19C35F40)
#define UNITYENGINE_CUBEMAP_SETPIXELDATAIMPL_OFFSET UNITYSDK_OFFSET(0x19C35F50)
#define UNITYENGINE_CUBEMAP_SETPIXELIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x19C35E80)
#define UNITYENGINE_CUBEMAP_SETPIXELIMPL_OFFSET UNITYSDK_OFFSET(0x19C35E70)
#define UNITYENGINE_CUBEMAP_SETPIXELS_1_OFFSET UNITYSDK_OFFSET(0x19C35F60)
#define UNITYENGINE_CUBEMAP_SETPIXELS_OFFSET UNITYSDK_OFFSET(0x19C35F30)
#define UNITYENGINE_CUBEMAP_SETPIXEL_OFFSET UNITYSDK_OFFSET(0x19C364B0)
#define UNITYENGINE_CUBEMAP_SET_LOADALLMIPS_OFFSET UNITYSDK_OFFSET(0x19C35FC0)
#define UNITYENGINE_CUBEMAP_SET_REQUESTEDMIPMAPLEVEL_OFFSET UNITYSDK_OFFSET(0x19C35FA0)
#define UNITYENGINE_CUBEMAP_SMOOTHEDGES_1_OFFSET UNITYSDK_OFFSET(0x19C35F00)
#define UNITYENGINE_CUBEMAP_SMOOTHEDGES_OFFSET UNITYSDK_OFFSET(0x19C35EF0)
#define UNITYENGINE_CUBEMAP_UPDATEEXTERNALTEXTURE_OFFSET UNITYSDK_OFFSET(0x19C35E50)
#define UNITYENGINE_CUBEMAP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C36050)
#define UNITYENGINE_CUBEMAP__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19C36160)
#define UNITYENGINE_CUBEMAP__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19C362A0)
#define UNITYENGINE_CUBEMAP__CTOR_4_OFFSET UNITYSDK_OFFSET(0x19C36180)
#define UNITYENGINE_CUBEMAP__CTOR_5_OFFSET UNITYSDK_OFFSET(0x19C36390)
#define UNITYENGINE_CUBEMAP__CTOR_6_OFFSET UNITYSDK_OFFSET(0x19C363C0)
#define UNITYENGINE_CUBEMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x19C36020)
