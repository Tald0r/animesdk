...
#define UNITYENGINE_ASSETBUNDLE_LOADALLASSETS_1_OFFSET UNITYSDK_OFFSET(0x1B13B720)
#define UNITYENGINE_ASSETBUNDLE_LOADALLASSETS_OFFSET UNITYSDK_OFFSET(0x1B13B680)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETASYNCHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B13B650)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETASYNC_OFFSET UNITYSDK_OFFSET(0x1B13B5D0)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B13B5C0)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETINSTANCECACHE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B13B660)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETINSTANCECACHE_OFFSET UNITYSDK_OFFSET(0x1B13B670)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETWITHSUBASSETS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B13B7A0)
#define UNITYENGINE_ASSETBUNDLE_LOADASSET_1_OFFSET UNITYSDK_OFFSET(0x1B13B540)
#define UNITYENGINE_ASSETBUNDLE_LOADASSET_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B13B530)
#define UNITYENGINE_ASSETBUNDLE_LOADASSET_OFFSET UNITYSDK_OFFSET(0x1B13B440)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILEASYNCHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B13B3A0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0x1B13B3B0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILEHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B13B3D0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILE_1_OFFSET UNITYSDK_OFFSET(0x1B13B410)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B13B3C0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x1B13B3F0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMMEMORYASYNC_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B13B420)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMMEMORYASYNC_OFFSET UNITYSDK_OFFSET(0x1B13B430)
#define UNITYENGINE_ASSETBUNDLE_RESOURCEPATHHASH_OFFSET UNITYSDK_OFFSET(0x1B13B3E0)
#define UNITYENGINE_ASSETBUNDLE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1B13B7B0)
#define UNITYENGINE_ASSETBUNDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B13B380)

namespace UnityEngine
{
	inline static constexpr unsigned int AssetBundle_TypeDefinitionIndex = 7586;
