...
#define UNITYENGINE_ASSETBUNDLE_LOADALLASSETS_1_OFFSET UNITYSDK_OFFSET(0x1B756CF0)
#define UNITYENGINE_ASSETBUNDLE_LOADALLASSETS_OFFSET UNITYSDK_OFFSET(0x1B756C50)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETASYNCHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B756C20)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETASYNC_OFFSET UNITYSDK_OFFSET(0x1B756BA0)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B756B90)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETINSTANCECACHE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B756C30)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETINSTANCECACHE_OFFSET UNITYSDK_OFFSET(0x1B756C40)
#define UNITYENGINE_ASSETBUNDLE_LOADASSETWITHSUBASSETS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B756D70)
#define UNITYENGINE_ASSETBUNDLE_LOADASSET_1_OFFSET UNITYSDK_OFFSET(0x1B756B10)
#define UNITYENGINE_ASSETBUNDLE_LOADASSET_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B756B00)
#define UNITYENGINE_ASSETBUNDLE_LOADASSET_OFFSET UNITYSDK_OFFSET(0x1B756A10)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILEASYNCHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B756970)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0x1B756980)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILEHASH_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B7569A0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILE_1_OFFSET UNITYSDK_OFFSET(0x1B7569E0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B756990)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x1B7569C0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMMEMORYASYNC_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1B7569F0)
#define UNITYENGINE_ASSETBUNDLE_LOADFROMMEMORYASYNC_OFFSET UNITYSDK_OFFSET(0x1B756A00)
#define UNITYENGINE_ASSETBUNDLE_RESOURCEPATHHASH_OFFSET UNITYSDK_OFFSET(0x1B7569B0)
#define UNITYENGINE_ASSETBUNDLE_SET_ENABLEBLKOPENFILECACHE_OFFSET UNITYSDK_OFFSET(0x1B756D90)
#define UNITYENGINE_ASSETBUNDLE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1B756D80)
#define UNITYENGINE_ASSETBUNDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B756950)
