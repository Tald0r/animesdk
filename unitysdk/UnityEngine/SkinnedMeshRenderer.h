...
#define UNITYENGINE_SKINNEDMESHRENDERER_ALIGNLODMESH_OFFSET UNITYSDK_OFFSET(0x1A62DF20)
#define UNITYENGINE_SKINNEDMESHRENDERER_BAKEMESH_OFFSET UNITYSDK_OFFSET(0x1A62DD50)
#define UNITYENGINE_SKINNEDMESHRENDERER_CLEARCACHEDMESHDATA_OFFSET UNITYSDK_OFFSET(0x1A62DF50)
#define UNITYENGINE_SKINNEDMESHRENDERER_DRAWCACHEDMESH_1_OFFSET UNITYSDK_OFFSET(0x1A62E010)
#define UNITYENGINE_SKINNEDMESHRENDERER_DRAWCACHEDMESH_2_OFFSET UNITYSDK_OFFSET(0x1A62E0A0)
#define UNITYENGINE_SKINNEDMESHRENDERER_DRAWCACHEDMESH_3_OFFSET UNITYSDK_OFFSET(0x1A62E000)
#define UNITYENGINE_SKINNEDMESHRENDERER_DRAWCACHEDMESH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A62E170)
#define UNITYENGINE_SKINNEDMESHRENDERER_DRAWCACHEDMESH_OFFSET UNITYSDK_OFFSET(0x1A62DF70)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETBLENDSHAPEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1A62DD30)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETCACHEDMESH_OFFSET UNITYSDK_OFFSET(0x1A62DF30)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETISLOOPSUBDIVISIONALLOWED_OFFSET UNITYSDK_OFFSET(0x1A62DDF0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETLOCALAABB_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A62DDB0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETLOCALAABB_OFFSET UNITYSDK_OFFSET(0x1A62DD60)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETLOOPSUBDIVSETTINGS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A62DE80)
#define UNITYENGINE_SKINNEDMESHRENDERER_GETLOOPSUBDIVSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A62DE20)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_BONES_OFFSET UNITYSDK_OFFSET(0x1A62DCC0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_ENABLECOMPACTCOMPUTESKINNINGOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A62DC40)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_FORCEMATRIXRECALCULATIONPERRENDER_OFFSET UNITYSDK_OFFSET(0x1A62DC60)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A62DE90)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_QUALITY_OFFSET UNITYSDK_OFFSET(0x1A62DC00)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x1A62DCA0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_SHAREDMESH_OFFSET UNITYSDK_OFFSET(0x1A62DCE0)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_SKINNEDMOTIONVECTORS_OFFSET UNITYSDK_OFFSET(0x1A62DD00)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_SORTINGFUDGE_OFFSET UNITYSDK_OFFSET(0x1A62DC80)
#define UNITYENGINE_SKINNEDMESHRENDERER_GET_UPDATEWHENOFFSCREEN_OFFSET UNITYSDK_OFFSET(0x1A62DC20)
#define UNITYENGINE_SKINNEDMESHRENDERER_GLOBALOVERRIDEENABLECOMPACTCOMPUTESKINNINGOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A62DF10)
#define UNITYENGINE_SKINNEDMESHRENDERER_RELEASEALLCACHEDMESH_OFFSET UNITYSDK_OFFSET(0x1A62DF60)
#define UNITYENGINE_SKINNEDMESHRENDERER_RELEASECACHEDMESH_OFFSET UNITYSDK_OFFSET(0x1A62DF40)
#define UNITYENGINE_SKINNEDMESHRENDERER_RESETMOTIONVECTORSTATE_OFFSET UNITYSDK_OFFSET(0x1A62DD20)
#define UNITYENGINE_SKINNEDMESHRENDERER_SETBLENDSHAPEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1A62DD40)
#define UNITYENGINE_SKINNEDMESHRENDERER_SETISLOOPSUBDIVISIONALLOWED_OFFSET UNITYSDK_OFFSET(0x1A62DDE0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SETLOCALAABB_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A62DDD0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SETLOCALAABB_OFFSET UNITYSDK_OFFSET(0x1A62DDC0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SETLOOPSUBDIVSETTINGS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A62DE10)
#define UNITYENGINE_SKINNEDMESHRENDERER_SETLOOPSUBDIVSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A62DE00)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_BONES_OFFSET UNITYSDK_OFFSET(0x1A62DCD0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_ENABLECOMPACTCOMPUTESKINNINGOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A62DC50)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_FORCEMATRIXRECALCULATIONPERRENDER_OFFSET UNITYSDK_OFFSET(0x1A62DC70)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A62DEE0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_QUALITY_OFFSET UNITYSDK_OFFSET(0x1A62DC10)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_ROOTBONE_OFFSET UNITYSDK_OFFSET(0x1A62DCB0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_SHAREDMESH_OFFSET UNITYSDK_OFFSET(0x1A62DCF0)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_SKINNEDMOTIONVECTORS_OFFSET UNITYSDK_OFFSET(0x1A62DD10)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_SORTINGFUDGE_OFFSET UNITYSDK_OFFSET(0x1A62DC90)
#define UNITYENGINE_SKINNEDMESHRENDERER_SET_UPDATEWHENOFFSCREEN_OFFSET UNITYSDK_OFFSET(0x1A62DC30)
#define UNITYENGINE_SKINNEDMESHRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62E180)
