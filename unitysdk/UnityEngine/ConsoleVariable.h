...
#define UNITYENGINE_CONSOLEVARIABLE_GETCONSOLEVARIABLEID_OFFSET UNITYSDK_OFFSET(0x1A520E60)
#define UNITYENGINE_CONSOLEVARIABLE_GETCONSOLEVARIABLE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A520EC0)
#define UNITYENGINE_CONSOLEVARIABLE_GETCONSOLEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A520E90)
#define UNITYENGINE_CONSOLEVARIABLE_NEWCONSOLEVARIABLEFROMSCRIPT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A520EE0)
#define UNITYENGINE_CONSOLEVARIABLE_NEWCONSOLEVARIABLEFROMSCRIPT_OFFSET UNITYSDK_OFFSET(0x1A520ED0)
#define UNITYENGINE_CONSOLEVARIABLE_SETCONSOLEVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x1A520E70)
#define UNITYENGINE_CONSOLEVARIABLE_SETCONSOLEVARIABLE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A520E80)
#define UNITYENGINE_CONSOLEVARIABLE_SETCONSOLEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A520E30)
#define UNITYENGINE_CONSOLEVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A520EF0)
