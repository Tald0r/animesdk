...
#define UNITYENGINE_MATERIALCOMMANDMANAGER_DISABLEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1A2FD7A0)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_ENABLEKEYWORD_OFFSET UNITYSDK_OFFSET(0x1A2FD790)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_GETCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2FD7F0)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_GETCOLOR_OFFSET UNITYSDK_OFFSET(0x1A2FD7B0)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_GETTEXTUREOFFSET_OFFSET UNITYSDK_OFFSET(0x1A2FD8A0)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_GETTEXTURESCALEANDOFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2FD860)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_GETTEXTURESCALEANDOFFSET_OFFSET UNITYSDK_OFFSET(0x1A2FD820)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_GETTEXTURESCALE_OFFSET UNITYSDK_OFFSET(0x1A2FD870)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_GETTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A2FD800)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_ISKEYWORDENABLED_OFFSET UNITYSDK_OFFSET(0x1A2FD810)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_SETCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2FD710)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x1A2FD700)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x1A2FD6D0)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_SETTEXTUREBYID_OFFSET UNITYSDK_OFFSET(0x1A2FD720)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_SETTEXTUREOFFSET_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2FD750)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_SETTEXTUREOFFSET_OFFSET UNITYSDK_OFFSET(0x1A2FD730)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_SETTEXTURESCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2FD780)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_SETTEXTURESCALE_OFFSET UNITYSDK_OFFSET(0x1A2FD760)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_SETVECTOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2FD6F0)
#define UNITYENGINE_MATERIALCOMMANDMANAGER_SETVECTOR_OFFSET UNITYSDK_OFFSET(0x1A2FD6E0)
