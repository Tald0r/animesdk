...
#define UNITYENGINE_ASSERTIONS_ASSERTIONMESSAGEUTIL_BOOLEANFAILUREMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A3E1A40)
#define UNITYENGINE_ASSERTIONS_ASSERTIONMESSAGEUTIL_GETEQUALITYMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A3E13F0)
#define UNITYENGINE_ASSERTIONS_ASSERTIONMESSAGEUTIL_GETMESSAGE_1_OFFSET UNITYSDK_OFFSET(0x1A3E10C0)
#define UNITYENGINE_ASSERTIONS_ASSERTIONMESSAGEUTIL_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A3E0EE0)
#define UNITYENGINE_ASSERTIONS_ASSERTIONMESSAGEUTIL_NULLFAILUREMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A3E1790)
#define UNITYENGINE_ASSERTIONS_ASSERTIONMESSAGEUTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E1AA0)
