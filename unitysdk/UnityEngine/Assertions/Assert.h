...
#define UNITYENGINE_ASSERTIONS_ASSERT_AREEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1A429A00)
#define UNITYENGINE_ASSERTIONS_ASSERT_AREEQUAL_OFFSET UNITYSDK_OFFSET(0x1A429710)
#define UNITYENGINE_ASSERTIONS_ASSERT_FAIL_OFFSET UNITYSDK_OFFSET(0x1A429380)
#define UNITYENGINE_ASSERTIONS_ASSERT_ISFALSE_1_OFFSET UNITYSDK_OFFSET(0x1A429690)
#define UNITYENGINE_ASSERTIONS_ASSERT_ISFALSE_OFFSET UNITYSDK_OFFSET(0x1A4295F0)
#define UNITYENGINE_ASSERTIONS_ASSERT_ISNOTNULL_OFFSET UNITYSDK_OFFSET(0x1A4298C0)
#define UNITYENGINE_ASSERTIONS_ASSERT_ISTRUE_1_OFFSET UNITYSDK_OFFSET(0x1A429570)
#define UNITYENGINE_ASSERTIONS_ASSERT_ISTRUE_OFFSET UNITYSDK_OFFSET(0x1A4294D0)
#define UNITYENGINE_ASSERTIONS_ASSERT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A429A90)
