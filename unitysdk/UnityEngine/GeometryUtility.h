...
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEBOUNDSUNSAFE_OFFSET UNITYSDK_OFFSET(0x1A5214D0)
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A521360)
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEFRUSTUMPLANES_1_OFFSET UNITYSDK_OFFSET(0x1A5210F0)
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEFRUSTUMPLANES_2_OFFSET UNITYSDK_OFFSET(0x1A521270)
#define UNITYENGINE_GEOMETRYUTILITY_CALCULATEFRUSTUMPLANES_OFFSET UNITYSDK_OFFSET(0x1A520F60)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_CALCULATEBOUNDSUNSAFE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A521680)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_CALCULATEBOUNDSUNSAFE_OFFSET UNITYSDK_OFFSET(0x1A5215F0)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_CALCULATEBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A521670)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_CALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A521480)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_EXTRACTPLANES_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A521660)
#define UNITYENGINE_GEOMETRYUTILITY_INTERNAL_EXTRACTPLANES_OFFSET UNITYSDK_OFFSET(0x1A521350)
#define UNITYENGINE_GEOMETRYUTILITY_TESTPLANESAABB_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A521650)
#define UNITYENGINE_GEOMETRYUTILITY_TESTPLANESAABB_OFFSET UNITYSDK_OFFSET(0x1A521640)
#define UNITYENGINE_GEOMETRYUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A521690)
