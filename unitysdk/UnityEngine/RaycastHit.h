...
#define UNITYENGINE_RAYCASTHIT_CALCULATERAYCASTTEXCOORD_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A7611C0)
#define UNITYENGINE_RAYCASTHIT_CALCULATERAYCASTTEXCOORD_OFFSET UNITYSDK_OFFSET(0x1A761180)
#define UNITYENGINE_RAYCASTHIT_COLLIDERFROMINSTANCEID_1_OFFSET UNITYSDK_OFFSET(0x1A761B50)
#define UNITYENGINE_RAYCASTHIT_COLLIDERFROMINSTANCEID_OFFSET UNITYSDK_OFFSET(0x93E540)
#define UNITYENGINE_RAYCASTHIT_GET_BARYCENTRICCOORDINATE_OFFSET UNITYSDK_OFFSET(0x93E320)
#define UNITYENGINE_RAYCASTHIT_GET_COLLIDERTAG_OFFSET UNITYSDK_OFFSET(0x391470)
#define UNITYENGINE_RAYCASTHIT_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x93E2B0)
#define UNITYENGINE_RAYCASTHIT_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x8FF150)
#define UNITYENGINE_RAYCASTHIT_GET_INSTANCEID_OFFSET UNITYSDK_OFFSET(0x2FD450)
#define UNITYENGINE_RAYCASTHIT_GET_LIGHTMAPCOORD_OFFSET UNITYSDK_OFFSET(0x93E530)
#define UNITYENGINE_RAYCASTHIT_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x2D0730)
#define UNITYENGINE_RAYCASTHIT_GET_POINT_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define UNITYENGINE_RAYCASTHIT_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0x93E520)
#define UNITYENGINE_RAYCASTHIT_GET_TEXTURECOORD1_OFFSET UNITYSDK_OFFSET(0x93E440)
#define UNITYENGINE_RAYCASTHIT_GET_TEXTURECOORD2_OFFSET UNITYSDK_OFFSET(0x93E440)
#define UNITYENGINE_RAYCASTHIT_GET_TEXTURECOORD_OFFSET UNITYSDK_OFFSET(0x93E370)
#define UNITYENGINE_RAYCASTHIT_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x93E510)
#define UNITYENGINE_RAYCASTHIT_GET_TRIANGLEINDEX_OFFSET UNITYSDK_OFFSET(0x359050)
#define UNITYENGINE_RAYCASTHIT_SET_BARYCENTRICCOORDINATE_OFFSET UNITYSDK_OFFSET(0x93E350)
#define UNITYENGINE_RAYCASTHIT_SET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x93E360)
#define UNITYENGINE_RAYCASTHIT_SET_NORMAL_OFFSET UNITYSDK_OFFSET(0x2D0750)
#define UNITYENGINE_RAYCASTHIT_SET_POINT_OFFSET UNITYSDK_OFFSET(0x2C4D20)

namespace UnityEngine
{
	inline static constexpr unsigned int RaycastHit_TypeDefinitionIndex = 7659;
