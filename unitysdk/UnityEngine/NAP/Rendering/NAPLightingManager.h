...
#define UNITYENGINE_NAP_RENDERING_NAPLIGHTINGMANAGER_INTERNAL_PREPARELIGHTINGDATA_OFFSET UNITYSDK_OFFSET(0x1A273DC0)
#define UNITYENGINE_NAP_RENDERING_NAPLIGHTINGMANAGER_PREPARELIGHTINGDATA_OFFSET UNITYSDK_OFFSET(0x1A273DD0)
#define UNITYENGINE_NAP_RENDERING_NAPLIGHTINGMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A273E30)
