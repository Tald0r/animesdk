...
#define UNITYENGINE_NAP_RENDERING_NAPLIGHTINGMANAGER_INTERNAL_PREPARELIGHTINGDATA_OFFSET UNITYSDK_OFFSET(0x19BC5C30)
#define UNITYENGINE_NAP_RENDERING_NAPLIGHTINGMANAGER_PREPARELIGHTINGDATA_OFFSET UNITYSDK_OFFSET(0x19BC5C40)
#define UNITYENGINE_NAP_RENDERING_NAPLIGHTINGMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19BC5CA0)

namespace UnityEngine::NAP::Rendering
{
	inline static constexpr unsigned int NAPLightingManager_TypeDefinitionIndex = 6118;
