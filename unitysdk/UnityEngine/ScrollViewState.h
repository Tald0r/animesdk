...
#define UNITYENGINE_SCROLLVIEWSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C46420)

namespace UnityEngine
{
	inline static constexpr unsigned int ScrollViewState_TypeDefinitionIndex = 6381;
