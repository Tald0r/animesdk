...
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS_CREATE_OFFSET UNITYSDK_OFFSET(0x1B1469D0)
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B146A00)
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B1469E0)
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS_INVOKEONANIMATORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1B146A10)
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1469A0)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimatorFixedUpdateProcess_TypeDefinitionIndex = 6542;
