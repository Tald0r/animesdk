...
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS_CREATE_OFFSET UNITYSDK_OFFSET(0x1B764A00)
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B764A30)
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B764A10)
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS_INVOKEONANIMATORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1B764A40)
#define UNITYENGINE_ANIMATORFIXEDUPDATEPROCESS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7649D0)
