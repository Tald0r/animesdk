...
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_BUTTONSTATE_GET_BUTTON_OFFSET UNITYSDK_OFFSET(0x1A9F4560)
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_BUTTONSTATE_GET_EVENTDATA_OFFSET UNITYSDK_OFFSET(0x1A9F4540)
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_BUTTONSTATE_SET_BUTTON_OFFSET UNITYSDK_OFFSET(0x1A9F4570)
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_BUTTONSTATE_SET_EVENTDATA_OFFSET UNITYSDK_OFFSET(0x1A9F4550)
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_BUTTONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9F4580)

namespace UnityEngine::EventSystems
{
	inline static constexpr unsigned int PointerInputModule_ButtonState_TypeDefinitionIndex = 8529;
