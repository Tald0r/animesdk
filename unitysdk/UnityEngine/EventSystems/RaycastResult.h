...
#define UNITYENGINE_EVENTSYSTEMS_RAYCASTRESULT_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_EVENTSYSTEMS_RAYCASTRESULT_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x978000)
#define UNITYENGINE_EVENTSYSTEMS_RAYCASTRESULT_SET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define UNITYENGINE_EVENTSYSTEMS_RAYCASTRESULT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x978010)
#define UNITYENGINE_EVENTSYSTEMS_RAYCASTRESULT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x978020)

namespace UnityEngine::EventSystems
{
	inline static constexpr unsigned int RaycastResult_TypeDefinitionIndex = 8525;
