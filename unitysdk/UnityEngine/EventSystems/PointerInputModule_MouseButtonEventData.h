...
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_MOUSEBUTTONEVENTDATA_PRESSEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x1B3E2500)
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_MOUSEBUTTONEVENTDATA_RELEASEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x1B3E2550)
#define UNITYENGINE_EVENTSYSTEMS_POINTERINPUTMODULE_MOUSEBUTTONEVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E25A0)

namespace UnityEngine::EventSystems
{
	inline static constexpr unsigned int PointerInputModule_MouseButtonEventData_TypeDefinitionIndex = 8531;
