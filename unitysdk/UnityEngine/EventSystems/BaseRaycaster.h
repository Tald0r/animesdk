...
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_GET_CANVAS_OFFSET UNITYSDK_OFFSET(0x1B571340)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1B571350)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_GET_RENDERORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B571370)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_GET_ROOTRAYCASTER_OFFSET UNITYSDK_OFFSET(0x1B571380)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_GET_SORTORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B571360)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1B571B10)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B571A80)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B5719E0)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1B571B80)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_RAYCASTONE_OFFSET UNITYSDK_OFFSET(0x1B5712F0)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B571510)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B571BF0)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER___BASE_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1B571C10)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B571CA0)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B571D30)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER___BASE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1B571DC0)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B571E50)

namespace UnityEngine::EventSystems
{
	inline static constexpr unsigned int BaseRaycaster_TypeDefinitionIndex = 8538;
