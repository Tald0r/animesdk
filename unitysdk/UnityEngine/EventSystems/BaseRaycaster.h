...
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_GET_CANVAS_OFFSET UNITYSDK_OFFSET(0x1AF4D570)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1AF4D580)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_GET_RENDERORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1AF4D5A0)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_GET_ROOTRAYCASTER_OFFSET UNITYSDK_OFFSET(0x1AF4D5B0)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_GET_SORTORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1AF4D590)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF4DD40)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AF4DCB0)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AF4DC10)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF4DDB0)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_RAYCASTONE_OFFSET UNITYSDK_OFFSET(0x1AF4D520)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AF4D740)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4DE20)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER___BASE_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF4DE40)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AF4DED0)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AF4DF60)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER___BASE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF4DFF0)
#define UNITYENGINE_EVENTSYSTEMS_BASERAYCASTER___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AF4E080)

namespace UnityEngine::EventSystems
{
	inline static constexpr unsigned int BaseRaycaster_TypeDefinitionIndex = 8527;
