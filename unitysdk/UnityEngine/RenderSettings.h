...
#define UNITYENGINE_RENDERSETTINGS_GET_AMBIENTEQUATORCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x19D1FAA0)
#define UNITYENGINE_RENDERSETTINGS_GET_AMBIENTEQUATORCOLOR_OFFSET UNITYSDK_OFFSET(0x19D1FA70)
#define UNITYENGINE_RENDERSETTINGS_GET_AMBIENTGROUNDCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x19D1FB00)
#define UNITYENGINE_RENDERSETTINGS_GET_AMBIENTGROUNDCOLOR_OFFSET UNITYSDK_OFFSET(0x19D1FAD0)
#define UNITYENGINE_RENDERSETTINGS_GET_AMBIENTMODE_OFFSET UNITYSDK_OFFSET(0x19D1F9F0)
#define UNITYENGINE_RENDERSETTINGS_GET_AMBIENTPROBE_INJECTED_OFFSET UNITYSDK_OFFSET(0x19D1FC10)
#define UNITYENGINE_RENDERSETTINGS_GET_AMBIENTPROBE_OFFSET UNITYSDK_OFFSET(0x19D1FB80)
#define UNITYENGINE_RENDERSETTINGS_GET_AMBIENTSKYCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x19D1FA40)
#define UNITYENGINE_RENDERSETTINGS_GET_AMBIENTSKYCOLOR_OFFSET UNITYSDK_OFFSET(0x19D1FA10)
#define UNITYENGINE_RENDERSETTINGS_GET_REFLECTIONINTENSITY_OFFSET UNITYSDK_OFFSET(0x19D1FC50)
#define UNITYENGINE_RENDERSETTINGS_GET_SKYBOX_OFFSET UNITYSDK_OFFSET(0x19D1FB60)
#define UNITYENGINE_RENDERSETTINGS_SET_AMBIENTEQUATORCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x19D1FAC0)
#define UNITYENGINE_RENDERSETTINGS_SET_AMBIENTEQUATORCOLOR_OFFSET UNITYSDK_OFFSET(0x19D1FAB0)
#define UNITYENGINE_RENDERSETTINGS_SET_AMBIENTGROUNDCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x19D1FB20)
#define UNITYENGINE_RENDERSETTINGS_SET_AMBIENTGROUNDCOLOR_OFFSET UNITYSDK_OFFSET(0x19D1FB10)
#define UNITYENGINE_RENDERSETTINGS_SET_AMBIENTINTENSITY_OFFSET UNITYSDK_OFFSET(0x19D1FB30)
#define UNITYENGINE_RENDERSETTINGS_SET_AMBIENTLIGHT_INJECTED_OFFSET UNITYSDK_OFFSET(0x19D1FB50)
#define UNITYENGINE_RENDERSETTINGS_SET_AMBIENTLIGHT_OFFSET UNITYSDK_OFFSET(0x19D1FB40)
#define UNITYENGINE_RENDERSETTINGS_SET_AMBIENTMODE_OFFSET UNITYSDK_OFFSET(0x19D1FA00)
#define UNITYENGINE_RENDERSETTINGS_SET_AMBIENTPROBE_INJECTED_OFFSET UNITYSDK_OFFSET(0x19D1FC30)
#define UNITYENGINE_RENDERSETTINGS_SET_AMBIENTPROBE_OFFSET UNITYSDK_OFFSET(0x19D1FC20)
#define UNITYENGINE_RENDERSETTINGS_SET_AMBIENTSKYCOLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x19D1FA60)
#define UNITYENGINE_RENDERSETTINGS_SET_AMBIENTSKYCOLOR_OFFSET UNITYSDK_OFFSET(0x19D1FA50)
#define UNITYENGINE_RENDERSETTINGS_SET_CUSTOMREFLECTION_OFFSET UNITYSDK_OFFSET(0x19D1FC40)
#define UNITYENGINE_RENDERSETTINGS_SET_DEFAULTREFLECTIONMODE_OFFSET UNITYSDK_OFFSET(0x19D1FC70)
#define UNITYENGINE_RENDERSETTINGS_SET_REFLECTIONINTENSITY_OFFSET UNITYSDK_OFFSET(0x19D1FC60)
#define UNITYENGINE_RENDERSETTINGS_SET_SKYBOX_OFFSET UNITYSDK_OFFSET(0x19D1FB70)
#define UNITYENGINE_RENDERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19D1F9D0)
