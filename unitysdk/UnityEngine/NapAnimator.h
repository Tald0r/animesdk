...
#define UNITYENGINE_NAPANIMATOR_ADDANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0x1B767200)
#define UNITYENGINE_NAPANIMATOR_BATCHSAMPLECURVETHREADSAFE_OFFSET UNITYSDK_OFFSET(0x1B767280)
#define UNITYENGINE_NAPANIMATOR_BATCHSAMPLENAPANIMATIONTHREADSAFE_OFFSET UNITYSDK_OFFSET(0x1B767270)
#define UNITYENGINE_NAPANIMATOR_GETBONEPARENTINDICES_1_OFFSET UNITYSDK_OFFSET(0x1B767240)
#define UNITYENGINE_NAPANIMATOR_GETBONEPARENTINDICES_OFFSET UNITYSDK_OFFSET(0x1B767220)
#define UNITYENGINE_NAPANIMATOR_GETBONESNUM_OFFSET UNITYSDK_OFFSET(0x1B767210)
#define UNITYENGINE_NAPANIMATOR_GETGENERICCURVEIDS_OFFSET UNITYSDK_OFFSET(0x1B767260)
#define UNITYENGINE_NAPANIMATOR_GETGENERICCURVENUM_OFFSET UNITYSDK_OFFSET(0x1B767250)
#define UNITYENGINE_NAPANIMATOR_GET_AVATAR_OFFSET UNITYSDK_OFFSET(0x1B7671E0)
#define UNITYENGINE_NAPANIMATOR_SET_AVATAR_OFFSET UNITYSDK_OFFSET(0x1B7671F0)
#define UNITYENGINE_NAPANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B767290)
