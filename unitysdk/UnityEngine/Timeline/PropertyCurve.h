...
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_ADDKEY_OFFSET UNITYSDK_OFFSET(0x1A74A6C0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_DELETEKEYVALUE_OFFSET UNITYSDK_OFFSET(0x1A74A240)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_GETKEYTIMES_OFFSET UNITYSDK_OFFSET(0x1A74A710)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_GETKEYVALUE_OFFSET UNITYSDK_OFFSET(0x1A74A090)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_GETLASTKEYVALUE_OFFSET UNITYSDK_OFFSET(0x1A74A130)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_HASKEYATTIME_OFFSET UNITYSDK_OFFSET(0x1A74A3A0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_ISFIRSTKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1A74A1F0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_REMOVEKEY_OFFSET UNITYSDK_OFFSET(0x1A74A4E0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A749F70)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A749F30)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PropertyCurve_TypeDefinitionIndex = 29261;
