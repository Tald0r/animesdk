...
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_ADDKEY_OFFSET UNITYSDK_OFFSET(0x1ACEE3D0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_DELETEKEYVALUE_OFFSET UNITYSDK_OFFSET(0x1ACEDF50)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_GETKEYTIMES_OFFSET UNITYSDK_OFFSET(0x1ACEE420)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_GETKEYVALUE_OFFSET UNITYSDK_OFFSET(0x1ACEDDA0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_GETLASTKEYVALUE_OFFSET UNITYSDK_OFFSET(0x1ACEDE40)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_HASKEYATTIME_OFFSET UNITYSDK_OFFSET(0x1ACEE0B0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_ISFIRSTKEYFRAME_OFFSET UNITYSDK_OFFSET(0x1ACEDF00)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE_REMOVEKEY_OFFSET UNITYSDK_OFFSET(0x1ACEE1F0)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ACEDC80)
#define UNITYENGINE_TIMELINE_PROPERTYCURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACEDC40)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PropertyCurve_TypeDefinitionIndex = 30214;
