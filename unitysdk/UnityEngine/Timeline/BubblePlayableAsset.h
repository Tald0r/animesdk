...
#define UNITYENGINE_TIMELINE_BUBBLEPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1A730570)
#define UNITYENGINE_TIMELINE_BUBBLEPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1A730650)
#define UNITYENGINE_TIMELINE_BUBBLEPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A730660)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BubblePlayableAsset_TypeDefinitionIndex = 29271;
