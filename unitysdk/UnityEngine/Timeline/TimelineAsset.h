...
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ADDSUBTRACKSRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1AC7A820)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ADDTRACKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AC7AC30)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ADJUSTCHILDTRACK_OFFSET UNITYSDK_OFFSET(0x1AC7E7A0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ADJUSTTRACK_OFFSET UNITYSDK_OFFSET(0x1AC7E640)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ALLOCATETRACK_OFFSET UNITYSDK_OFFSET(0x1AC7DA50)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CALCULATEDURATION_OFFSET UNITYSDK_OFFSET(0x1AC784B0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CHECKCLIPISMPBSUBANICLIP_OFFSET UNITYSDK_OFFSET(0x1AC7CF00)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CLEARTRACKS_OFFSET UNITYSDK_OFFSET(0x1AC7B0A0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CREATEMARKERTRACK_OFFSET UNITYSDK_OFFSET(0x1AC7D410)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1AC7BA00)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CREATETRACK_OFFSET UNITYSDK_OFFSET(0x1AC7D540)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_DELETECLIP_OFFSET UNITYSDK_OFFSET(0x1AC7DDF0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_DELETERECORDEDANIMATION_1_OFFSET UNITYSDK_OFFSET(0x1AC7E1E0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_DELETERECORDEDANIMATION_OFFSET UNITYSDK_OFFSET(0x1AC7E410)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_DELETETRACK_OFFSET UNITYSDK_OFFSET(0x1AC7B390)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_FINDPARENTGROUPTRACK_OFFSET UNITYSDK_OFFSET(0x1AC7E850)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GATHERPROPERTIESFORMPB_OFFSET UNITYSDK_OFFSET(0x1AC7C8A0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GATHERPROPERTIES_1_OFFSET UNITYSDK_OFFSET(0x1AC7C010)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GATHERPROPERTIES_2_OFFSET UNITYSDK_OFFSET(0x1AC7C410)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AC7BD10)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETALLOUTPUTTRACKBYGUID_OFFSET UNITYSDK_OFFSET(0x1AC7A770)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETALLTRACKS_OFFSET UNITYSDK_OFFSET(0x1AC7B380)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETEXTRADATA_OFFSET UNITYSDK_OFFSET(0x1AC799D0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETOUTPUTTRACKDIC_OFFSET UNITYSDK_OFFSET(0x1AC7A060)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETOUTPUTTRACKS_OFFSET UNITYSDK_OFFSET(0x1AC79B30)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETOUTPUTTRACK_1_OFFSET UNITYSDK_OFFSET(0x1AC79A70)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETOUTPUTTRACK_OFFSET UNITYSDK_OFFSET(0x1AC79A20)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETROOTTRACKS_OFFSET UNITYSDK_OFFSET(0x1AC79010)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETROOTTRACK_OFFSET UNITYSDK_OFFSET(0x1AC799E0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETVALIDFRAMERATE_OFFSET UNITYSDK_OFFSET(0x1AC79960)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1AC78BA0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_DURATIONMODE_OFFSET UNITYSDK_OFFSET(0x1AC78B20)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1AC78490)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_EDITORSETTINGS_OFFSET UNITYSDK_OFFSET(0x1AC78480)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_FIXEDDURATION_OFFSET UNITYSDK_OFFSET(0x1AC789E0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_FLATTENEDTRACKS_OFFSET UNITYSDK_OFFSET(0x1AC79EB0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_ISDFS_OFFSET UNITYSDK_OFFSET(0x1AC78460)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_MARKERTRACK_OFFSET UNITYSDK_OFFSET(0x1AC7AC10)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_OUTPUTS_OFFSET UNITYSDK_OFFSET(0x1AC78B40)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_OUTPUTTRACKCOUNT_OFFSET UNITYSDK_OFFSET(0x1AC79100)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_ROOTTRACKCOUNT_OFFSET UNITYSDK_OFFSET(0x1AC795D0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_TRACKOBJECTS_OFFSET UNITYSDK_OFFSET(0x1AC7AC20)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_INVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AC7ACB0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_MOVELASTTRACKBEFORE_OFFSET UNITYSDK_OFFSET(0x1AC7ECC0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AC798B0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_REMOVETRACK_OFFSET UNITYSDK_OFFSET(0x1AC7AF70)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SAVEEXTRADATA_OFFSET UNITYSDK_OFFSET(0x1AC799C0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SET_DURATIONMODE_OFFSET UNITYSDK_OFFSET(0x1AC78B30)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SET_FIXEDDURATION_OFFSET UNITYSDK_OFFSET(0x1AC78B10)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SORTCHILDTRACK_OFFSET UNITYSDK_OFFSET(0x1AC7EA30)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SORTOUTPUTTRACKGUIDS_OFFSET UNITYSDK_OFFSET(0x1AC79B50)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SORTSUBTRACKBYNAME_OFFSET UNITYSDK_OFFSET(0x1AC7ACD0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SORTTRACKS_OFFSET UNITYSDK_OFFSET(0x1AC7AE50)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AC7BB90)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AC7BB80)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UPDATEOUTPUTTRACKCACHE_OFFSET UNITYSDK_OFFSET(0x1AC79130)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UPDATEOUTPUTTRACKDICCACHE_OFFSET UNITYSDK_OFFSET(0x1AC7A080)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UPDATEROOTTRACKCACHE_OFFSET UNITYSDK_OFFSET(0x1AC79600)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UPGRADETOLATESTVERSION_OFFSET UNITYSDK_OFFSET(0x1AC78450)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC7EFE0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET___INTERNALAWAKE_OFFSET UNITYSDK_OFFSET(0x1AC7BBB0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineAsset_TypeDefinitionIndex = 30187;
