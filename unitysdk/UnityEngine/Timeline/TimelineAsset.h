...
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ADDSUBTRACKSRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1A6CF5D0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ADDTRACKINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A6CF9E0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ADJUSTCHILDTRACK_OFFSET UNITYSDK_OFFSET(0x1A6D3550)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ADJUSTTRACK_OFFSET UNITYSDK_OFFSET(0x1A6D33F0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ALLOCATETRACK_OFFSET UNITYSDK_OFFSET(0x1A6D2800)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CALCULATEDURATION_OFFSET UNITYSDK_OFFSET(0x1A6CD260)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CHECKCLIPISMPBSUBANICLIP_OFFSET UNITYSDK_OFFSET(0x1A6D1CB0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CLEARTRACKS_OFFSET UNITYSDK_OFFSET(0x1A6CFE50)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CREATEMARKERTRACK_OFFSET UNITYSDK_OFFSET(0x1A6D21C0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1A6D07B0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_CREATETRACK_OFFSET UNITYSDK_OFFSET(0x1A6D22F0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_DELETECLIP_OFFSET UNITYSDK_OFFSET(0x1A6D2BA0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_DELETERECORDEDANIMATION_1_OFFSET UNITYSDK_OFFSET(0x1A6D2F90)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_DELETERECORDEDANIMATION_OFFSET UNITYSDK_OFFSET(0x1A6D31C0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_DELETETRACK_OFFSET UNITYSDK_OFFSET(0x1A6D0140)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_FINDPARENTGROUPTRACK_OFFSET UNITYSDK_OFFSET(0x1A6D3600)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GATHERPROPERTIESFORMPB_OFFSET UNITYSDK_OFFSET(0x1A6D1650)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GATHERPROPERTIES_1_OFFSET UNITYSDK_OFFSET(0x1A6D0DC0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GATHERPROPERTIES_2_OFFSET UNITYSDK_OFFSET(0x1A6D11C0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A6D0AC0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETALLOUTPUTTRACKBYGUID_OFFSET UNITYSDK_OFFSET(0x1A6CF520)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETALLTRACKS_OFFSET UNITYSDK_OFFSET(0x1A6D0130)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETEXTRADATA_OFFSET UNITYSDK_OFFSET(0x1A6CE780)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETOUTPUTTRACKDIC_OFFSET UNITYSDK_OFFSET(0x1A6CEE10)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETOUTPUTTRACKS_OFFSET UNITYSDK_OFFSET(0x1A6CE8E0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETOUTPUTTRACK_1_OFFSET UNITYSDK_OFFSET(0x1A6CE820)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETOUTPUTTRACK_OFFSET UNITYSDK_OFFSET(0x1A6CE7D0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETROOTTRACKS_OFFSET UNITYSDK_OFFSET(0x1A6CDDC0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETROOTTRACK_OFFSET UNITYSDK_OFFSET(0x1A6CE790)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GETVALIDFRAMERATE_OFFSET UNITYSDK_OFFSET(0x1A6CE710)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1A6CD950)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_DURATIONMODE_OFFSET UNITYSDK_OFFSET(0x1A6CD8D0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1A6CD240)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_EDITORSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A6CD230)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_FIXEDDURATION_OFFSET UNITYSDK_OFFSET(0x1A6CD790)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_FLATTENEDTRACKS_OFFSET UNITYSDK_OFFSET(0x1A6CEC60)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_ISDFS_OFFSET UNITYSDK_OFFSET(0x1A6CD210)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_MARKERTRACK_OFFSET UNITYSDK_OFFSET(0x1A6CF9C0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_OUTPUTS_OFFSET UNITYSDK_OFFSET(0x1A6CD8F0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_OUTPUTTRACKCOUNT_OFFSET UNITYSDK_OFFSET(0x1A6CDEB0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_ROOTTRACKCOUNT_OFFSET UNITYSDK_OFFSET(0x1A6CE380)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_GET_TRACKOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A6CF9D0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_INVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A6CFA60)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_MOVELASTTRACKBEFORE_OFFSET UNITYSDK_OFFSET(0x1A6D3A80)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A6CE660)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_REMOVETRACK_OFFSET UNITYSDK_OFFSET(0x1A6CFD20)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SAVEEXTRADATA_OFFSET UNITYSDK_OFFSET(0x1A6CE770)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SET_DURATIONMODE_OFFSET UNITYSDK_OFFSET(0x1A6CD8E0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SET_FIXEDDURATION_OFFSET UNITYSDK_OFFSET(0x1A6CD8C0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SORTCHILDTRACK_OFFSET UNITYSDK_OFFSET(0x1A6D37F0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SORTOUTPUTTRACKGUIDS_OFFSET UNITYSDK_OFFSET(0x1A6CE900)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SORTSUBTRACKBYNAME_OFFSET UNITYSDK_OFFSET(0x1A6CFA80)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_SORTTRACKS_OFFSET UNITYSDK_OFFSET(0x1A6CFC00)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A6D0940)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A6D0930)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UPDATEOUTPUTTRACKCACHE_OFFSET UNITYSDK_OFFSET(0x1A6CDEE0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UPDATEOUTPUTTRACKDICCACHE_OFFSET UNITYSDK_OFFSET(0x1A6CEE30)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UPDATEROOTTRACKCACHE_OFFSET UNITYSDK_OFFSET(0x1A6CE3B0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET_UPGRADETOLATESTVERSION_OFFSET UNITYSDK_OFFSET(0x1A6CD200)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6D3DA0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET___INTERNALAWAKE_OFFSET UNITYSDK_OFFSET(0x1A6D0960)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineAsset_TypeDefinitionIndex = 29234;
