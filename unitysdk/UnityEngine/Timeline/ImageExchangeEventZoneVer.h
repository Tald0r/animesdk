...
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1B18BF20)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1B18BEE0)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1B18BEA0)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER_ONSPRITECHANGE_OFFSET UNITYSDK_OFFSET(0x1B18BE70)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER_SETSPRITEBYPATH_OFFSET UNITYSDK_OFFSET(0x1B18BE90)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER_SHOWANIMINFO_OFFSET UNITYSDK_OFFSET(0x1B18BE80)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENTZONEVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B18BF30)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImageExchangeEventZoneVer_TypeDefinitionIndex = 30247;
