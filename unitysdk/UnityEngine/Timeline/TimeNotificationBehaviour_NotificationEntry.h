...
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_NOTIFICATIONENTRY_GET_PREWARM_OFFSET UNITYSDK_OFFSET(0x95F3E0)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_NOTIFICATIONENTRY_GET_TRIGGERINEDITOR_OFFSET UNITYSDK_OFFSET(0x95F3D0)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_NOTIFICATIONENTRY_GET_TRIGGERONCEWITHPAUSE_OFFSET UNITYSDK_OFFSET(0x95F400)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_NOTIFICATIONENTRY_GET_TRIGGERONCE_OFFSET UNITYSDK_OFFSET(0x95F3F0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimeNotificationBehaviour_NotificationEntry_TypeDefinitionIndex = 29368;
