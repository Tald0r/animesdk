...
#define UNITYENGINE_TIMELINE_KEYEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC95660)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int KeyEventBase_TypeDefinitionIndex = 29298;
