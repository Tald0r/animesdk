...
#define UNITYENGINE_TIMELINE_BASEPLAYABLEASSET_ASSETONCOPIED_OFFSET UNITYSDK_OFFSET(0x1B40B6B0)
#define UNITYENGINE_TIMELINE_BASEPLAYABLEASSET_ASSETONCREATED_OFFSET UNITYSDK_OFFSET(0x1B40B6A0)
#define UNITYENGINE_TIMELINE_BASEPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B40B650)
#define UNITYENGINE_TIMELINE_BASEPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40B6C0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BasePlayableAsset_TypeDefinitionIndex = 30344;
