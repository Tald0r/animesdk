...
#define UNITYENGINE_TIMELINE_BASEPLAYABLEASSET_ASSETONCOPIED_OFFSET UNITYSDK_OFFSET(0x1ADEAF20)
#define UNITYENGINE_TIMELINE_BASEPLAYABLEASSET_ASSETONCREATED_OFFSET UNITYSDK_OFFSET(0x1ADEAF10)
#define UNITYENGINE_TIMELINE_BASEPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1ADEAEC0)
#define UNITYENGINE_TIMELINE_BASEPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADEAF30)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BasePlayableAsset_TypeDefinitionIndex = 29391;
