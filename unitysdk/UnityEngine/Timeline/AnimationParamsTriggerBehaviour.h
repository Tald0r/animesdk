...
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1AEDBD50)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1AEDB880)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1AEDBBA0)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEDBDB0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AnimationParamsTriggerBehaviour_TypeDefinitionIndex = 29212;
