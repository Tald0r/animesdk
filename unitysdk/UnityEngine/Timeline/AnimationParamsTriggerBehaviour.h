...
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B4FF530)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B4FF060)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B4FF380)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4FF590)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AnimationParamsTriggerBehaviour_TypeDefinitionIndex = 30165;
