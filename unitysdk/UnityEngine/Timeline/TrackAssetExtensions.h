...
#define UNITYENGINE_TIMELINE_TRACKASSETEXTENSIONS_GETGROUP_OFFSET UNITYSDK_OFFSET(0x1AFCBED0)
#define UNITYENGINE_TIMELINE_TRACKASSETEXTENSIONS_SETGROUP_OFFSET UNITYSDK_OFFSET(0x1AFCBF70)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TrackAssetExtensions_TypeDefinitionIndex = 29348;
