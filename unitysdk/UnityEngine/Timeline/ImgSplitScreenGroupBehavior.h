...
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_COMINIT_OFFSET UNITYSDK_OFFSET(0x1A6CC060)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_CREATE_OFFSET UNITYSDK_OFFSET(0x1A6C9BB0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_GETBELONGPOS_OFFSET UNITYSDK_OFFSET(0x1A6CBE90)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_GETIFHIDEINSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x1A6CCAE0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_GETSELFCOMICGROUPTRACK_OFFSET UNITYSDK_OFFSET(0x1A6CCCD0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_HANDLESPLITANIM_OFFSET UNITYSDK_OFFSET(0x1A6CA0C0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_IMAGEEXCHANGE_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1A6CCAD0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A6C9CF0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_INITPARTOFFSETMAP_OFFSET UNITYSDK_OFFSET(0x1A6C9D10)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_PICTUREDECORATIONCOM_INIT_OFFSET UNITYSDK_OFFSET(0x1A6CCD10)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_PICTUREDECORATIONCOM_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1A6CCD20)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1A6CC480)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_SPLITIMGCOM_INIT_OFFSET UNITYSDK_OFFSET(0x1A6CC260)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_SPLITIMGCOM_RESET_OFFSET UNITYSDK_OFFSET(0x1A6CCA60)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_SPLITIMGCOM_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1A6CBE10)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_TAGSNEEDCLEAR_OFFSET UNITYSDK_OFFSET(0x1A6CC2D0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_VOICEDECORATIONCOM_INIT_OFFSET UNITYSDK_OFFSET(0x1A6CCCE0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_VOICEDECORATIONCOM_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1A6CCD00)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_VOICEDECORATIONCOM_TOFINISHSTATE_OFFSET UNITYSDK_OFFSET(0x1A6CCCF0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6CCDD0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6CCD30)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR__INITPARTOFFSETMAP_G__RECORDMAP_16_0_OFFSET UNITYSDK_OFFSET(0x1A6CB6B0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImgSplitScreenGroupBehavior_TypeDefinitionIndex = 29309;
	...
	public:
		...
		{
			return (::UnityEngine::Timeline::ComicGroupTrack**)Il2CppClass::FromTypeDefinitionIndex(ImgSplitScreenGroupBehavior_TypeDefinitionIndex)->GetStaticField(0x22950);
		}
		static ::System::Boolean* StaticGet_MUTE_BEHABIOUR()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ImgSplitScreenGroupBehavior_TypeDefinitionIndex)->GetStaticField(0x7660);
		}
		...
		::UnityEngine::Timeline::ImgSplitScreenGroupPlayableAsset* m_stData; // 0x10
