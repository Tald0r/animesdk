...
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_COMINIT_OFFSET UNITYSDK_OFFSET(0x1AC772B0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_CREATE_OFFSET UNITYSDK_OFFSET(0x1AC74E10)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_GETBELONGPOS_OFFSET UNITYSDK_OFFSET(0x1AC770E0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_GETIFHIDEINSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x1AC77D30)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_GETSELFCOMICGROUPTRACK_OFFSET UNITYSDK_OFFSET(0x1AC77F20)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_HANDLESPLITANIM_OFFSET UNITYSDK_OFFSET(0x1AC75320)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_IMAGEEXCHANGE_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1AC77D20)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AC74F50)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_INITPARTOFFSETMAP_OFFSET UNITYSDK_OFFSET(0x1AC74F70)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_PICTUREDECORATIONCOM_INIT_OFFSET UNITYSDK_OFFSET(0x1AC77F60)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_PICTUREDECORATIONCOM_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1AC77F70)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1AC776D0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_SPLITIMGCOM_INIT_OFFSET UNITYSDK_OFFSET(0x1AC774B0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_SPLITIMGCOM_RESET_OFFSET UNITYSDK_OFFSET(0x1AC77CB0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_SPLITIMGCOM_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1AC77060)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_TAGSNEEDCLEAR_OFFSET UNITYSDK_OFFSET(0x1AC77520)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_VOICEDECORATIONCOM_INIT_OFFSET UNITYSDK_OFFSET(0x1AC77F30)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_VOICEDECORATIONCOM_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1AC77F50)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR_VOICEDECORATIONCOM_TOFINISHSTATE_OFFSET UNITYSDK_OFFSET(0x1AC77F40)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC78020)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC77F80)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR__INITPARTOFFSETMAP_G__RECORDMAP_16_0_OFFSET UNITYSDK_OFFSET(0x1AC76910)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImgSplitScreenGroupBehavior_TypeDefinitionIndex = 30262;
	...
	public:
		...
		{
			return (::UnityEngine::Timeline::ComicGroupTrack**)Il2CppClass::FromTypeDefinitionIndex(ImgSplitScreenGroupBehavior_TypeDefinitionIndex)->GetStaticField(0x24270);
		}
		static ::System::Boolean* StaticGet_MUTE_BEHABIOUR()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ImgSplitScreenGroupBehavior_TypeDefinitionIndex)->GetStaticField(0x7990);
		}
		...
		::System::Collections::Generic::List_1<::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Vector2>*>* m_mapPartOffset; // 0x28
