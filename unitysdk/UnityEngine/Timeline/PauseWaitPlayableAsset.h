...
#define UNITYENGINE_TIMELINE_PAUSEWAITPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1ADEBED0)
#define UNITYENGINE_TIMELINE_PAUSEWAITPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1ADEBFB0)
#define UNITYENGINE_TIMELINE_PAUSEWAITPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADEBFC0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PauseWaitPlayableAsset_TypeDefinitionIndex = 29307;
