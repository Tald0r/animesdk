...
#define UNITYENGINE_TIMELINE_PAUSEWAITPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B40C680)
#define UNITYENGINE_TIMELINE_PAUSEWAITPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B40C750)
#define UNITYENGINE_TIMELINE_PAUSEWAITPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40C760)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PauseWaitPlayableAsset_TypeDefinitionIndex = 30260;
