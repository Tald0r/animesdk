...
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1ADEC1A0)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1ADEC160)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1ADEC120)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_ONSPRITECHANGE_OFFSET UNITYSDK_OFFSET(0x1ADEC030)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_ONSTARTPOSCHANGE_OFFSET UNITYSDK_OFFSET(0x1ADEC020)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_SETSPRITEBYPATH_OFFSET UNITYSDK_OFFSET(0x1ADEC110)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADEC1B0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int VoiceDecorateEvent_TypeDefinitionIndex = 29296;
