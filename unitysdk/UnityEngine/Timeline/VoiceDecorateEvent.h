...
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1B40C940)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1B40C900)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1B40C8C0)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_ONSPRITECHANGE_OFFSET UNITYSDK_OFFSET(0x1B40C7D0)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_ONSTARTPOSCHANGE_OFFSET UNITYSDK_OFFSET(0x1B40C7C0)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT_SETSPRITEBYPATH_OFFSET UNITYSDK_OFFSET(0x1B40C8B0)
#define UNITYENGINE_TIMELINE_VOICEDECORATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40C950)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int VoiceDecorateEvent_TypeDefinitionIndex = 30249;
