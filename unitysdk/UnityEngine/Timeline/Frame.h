...
#define UNITYENGINE_TIMELINE_FRAME_ADDPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B128DD0)
#define UNITYENGINE_TIMELINE_FRAME_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1B128D90)
#define UNITYENGINE_TIMELINE_FRAME_GET_TIME_OFFSET UNITYSDK_OFFSET(0x1B128D70)
#define UNITYENGINE_TIMELINE_FRAME_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B128DC0)
#define UNITYENGINE_TIMELINE_FRAME_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1B128DA0)
#define UNITYENGINE_TIMELINE_FRAME_SET_TIME_OFFSET UNITYSDK_OFFSET(0x1B128D80)
#define UNITYENGINE_TIMELINE_FRAME_UNITYENGINE_TIMELINE_IFRAME_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B128DB0)
#define UNITYENGINE_TIMELINE_FRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B128E50)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int Frame_TypeDefinitionIndex = 29257;

	class Frame : public ::System::Object
	{
	public:
		::UnityEngine::Timeline::TrackAsset* _parent_k__BackingField; // 0x10
		::System::Collections::Generic::HashSet_1<::System::String*>* propertyNames; // 0x18
