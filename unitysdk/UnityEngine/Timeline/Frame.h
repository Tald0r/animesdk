...
#define UNITYENGINE_TIMELINE_FRAME_ADDPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B740140)
#define UNITYENGINE_TIMELINE_FRAME_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1B740100)
#define UNITYENGINE_TIMELINE_FRAME_GET_TIME_OFFSET UNITYSDK_OFFSET(0x1B7400E0)
#define UNITYENGINE_TIMELINE_FRAME_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B740130)
#define UNITYENGINE_TIMELINE_FRAME_SET_PARENT_OFFSET UNITYSDK_OFFSET(0x1B740110)
#define UNITYENGINE_TIMELINE_FRAME_SET_TIME_OFFSET UNITYSDK_OFFSET(0x1B7400F0)
#define UNITYENGINE_TIMELINE_FRAME_UNITYENGINE_TIMELINE_IFRAME_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B740120)
#define UNITYENGINE_TIMELINE_FRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7401C0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int Frame_TypeDefinitionIndex = 30210;
