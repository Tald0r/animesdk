...
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GETTRACKDEFAULTNAME_OFFSET UNITYSDK_OFFSET(0x1B59AF40)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_AUTOPLAYCONTROLTRACK_OFFSET UNITYSDK_OFFSET(0x1B59B5B0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_MAININFO_OFFSET UNITYSDK_OFFSET(0x1B59B4A0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_MAINTRACK_OFFSET UNITYSDK_OFFSET(0x1B59B3E0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_REALEND_OFFSET UNITYSDK_OFFSET(0x1B59B390)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_REALSTART_OFFSET UNITYSDK_OFFSET(0x1B59B300)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_SPLITSCREENCLIPS_OFFSET UNITYSDK_OFFSET(0x1B59B5F0)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK_GET_TRIGGERTRACK_OFFSET UNITYSDK_OFFSET(0x1B59B560)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B59B800)
#define UNITYENGINE_TIMELINE_COMICGROUPTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B59B740)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ComicGroupTrack_TypeDefinitionIndex = 30229;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(ComicGroupTrack_TypeDefinitionIndex)->GetStaticField(0x24690);
		}
		static ::System::Int32* StaticGet_s_ComicTrackDefaultCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ComicGroupTrack_TypeDefinitionIndex)->GetStaticField(0x7AA0);
		}
