...
#define UNITYENGINE_TIMELINE_IMAGETRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1AC7EB20)
#define UNITYENGINE_TIMELINE_IMAGETRACK_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AC7EBF0)
#define UNITYENGINE_TIMELINE_IMAGETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC7EC00)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImageTrack_TypeDefinitionIndex = 29354;
