...
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_CREATEPLAYABLE_1_OFFSET UNITYSDK_OFFSET(0x1B2A2CC0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B2A2BB0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B2A33F0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GETCURANIDATA_OFFSET UNITYSDK_OFFSET(0x1B2A25B0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GETCURPOS_OFFSET UNITYSDK_OFFSET(0x1B2A2580)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GETCURROT_OFFSET UNITYSDK_OFFSET(0x1B2A25A0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_APPLIEDOFFSETMODE_OFFSET UNITYSDK_OFFSET(0x1B2A2990)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_APPLYFOOTIK_OFFSET UNITYSDK_OFFSET(0x1B2A27F0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B2A3290)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B2A29B0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1B2A2AE0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_EULERANGLES_OFFSET UNITYSDK_OFFSET(0x1B2A2760)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_HASROOTTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B2A2830)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_LOOP_OFFSET UNITYSDK_OFFSET(0x1B2A2810)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_MATCHTARGETFIELDS_OFFSET UNITYSDK_OFFSET(0x1B2A27B0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_OUTPUTS_OFFSET UNITYSDK_OFFSET(0x1B2A2B50)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B2A2550)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_REMOVESTARTOFFSET_OFFSET UNITYSDK_OFFSET(0x1B2A27D0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1B2A2620)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_GET_USETRACKMATCHFIELDS_OFFSET UNITYSDK_OFFSET(0x1B2A2790)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_HASROOTTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B2A28D0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_ONUPGRADEFROMVERSION_OFFSET UNITYSDK_OFFSET(0x1B2A3620)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_RESETOFFSETS_OFFSET UNITYSDK_OFFSET(0x1B2A33C0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_SET_APPLIEDOFFSETMODE_OFFSET UNITYSDK_OFFSET(0x1B2A29A0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_SET_APPLYFOOTIK_OFFSET UNITYSDK_OFFSET(0x1B2A2800)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_SET_CLIP_OFFSET UNITYSDK_OFFSET(0x1B2A29C0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_SET_EULERANGLES_OFFSET UNITYSDK_OFFSET(0x1B2A2780)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_SET_LOOP_OFFSET UNITYSDK_OFFSET(0x1B2A2820)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_SET_MATCHTARGETFIELDS_OFFSET UNITYSDK_OFFSET(0x1B2A27C0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B2A2570)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_SET_REMOVESTARTOFFSET_OFFSET UNITYSDK_OFFSET(0x1B2A27E0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1B2A2680)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_SET_USETRACKMATCHFIELDS_OFFSET UNITYSDK_OFFSET(0x1B2A27A0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_SHOULDAPPLYOFFSET_OFFSET UNITYSDK_OFFSET(0x1B2A3250)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_SHOULDAPPLYSCALEREMOVE_OFFSET UNITYSDK_OFFSET(0x1B2A3230)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B2A3500)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B2A34D0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B2A37B0)
#define UNITYENGINE_TIMELINE_ANIMATIONPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2A3720)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AnimationPlayableAsset_TypeDefinitionIndex = 30168;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AnimationPlayableAsset_TypeDefinitionIndex)->GetStaticField(0x7A20);
		}
