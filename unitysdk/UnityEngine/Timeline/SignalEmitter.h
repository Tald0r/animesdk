...
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1AEDCB20)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_GET_EMITONCE_OFFSET UNITYSDK_OFFSET(0x1AEDCB00)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_GET_RETROACTIVE_OFFSET UNITYSDK_OFFSET(0x1AEDCAE0)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_SET_ASSET_OFFSET UNITYSDK_OFFSET(0x1AEDCB30)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_SET_EMITONCE_OFFSET UNITYSDK_OFFSET(0x1AEDCB10)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_SET_RETROACTIVE_OFFSET UNITYSDK_OFFSET(0x1AEDCAF0)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_UNITYENGINE_PLAYABLES_INOTIFICATION_GET_ID_OFFSET UNITYSDK_OFFSET(0x1AEDCB40)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER_UNITYENGINE_TIMELINE_INOTIFICATIONOPTIONPROVIDER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1AEDCC20)
#define UNITYENGINE_TIMELINE_SIGNALEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEDCC40)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int SignalEmitter_TypeDefinitionIndex = 29345;
