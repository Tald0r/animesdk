...
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AB5BA10)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AB5C090)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AB5BFF0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AB5C110)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AB5C060)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AB5C010)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AB5B700)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB5B6E0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1AB5B960)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1AB5B8B0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineAsset__get_outputs_d__31_TypeDefinitionIndex = 29240;

	class TimelineAsset__get_outputs_d__31 : public ::System::Object
	{
	public:
		::System::Collections::Generic::IEnumerator_1<::UnityEngine::Timeline::TrackAsset*>* __7__wrap1; // 0x10
