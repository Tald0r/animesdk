...
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B18C410)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B18CA90)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_PLAYABLES_PLAYABLEBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B18C9F0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B18CB10)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B18CA60)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B18CA10)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B18C100)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31__CTOR_OFFSET UNITYSDK_OFFSET(0x1B18C0E0)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B18C360)
#define UNITYENGINE_TIMELINE_TIMELINEASSET__GET_OUTPUTS_D__31___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1B18C2B0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineAsset__get_outputs_d__31_TypeDefinitionIndex = 30193;
