...
#define UNITYENGINE_TIMELINE_ANIMATIONPREVIEWUPDATECALLBACK_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1B4FFAD0)
#define UNITYENGINE_TIMELINE_ANIMATIONPREVIEWUPDATECALLBACK_FETCHPREVIEWCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1B4FFCC0)
#define UNITYENGINE_TIMELINE_ANIMATIONPREVIEWUPDATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4FF9F0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AnimationPreviewUpdateCallback_TypeDefinitionIndex = 30173;
