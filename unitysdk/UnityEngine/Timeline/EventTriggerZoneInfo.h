...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERZONEINFO_INITTIMELINEASSETCTX_OFFSET UNITYSDK_OFFSET(0x1B5D67A0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERZONEINFO_ONCAMERASHAKEEVENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1B5D6780)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERZONEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D67B0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerZoneInfo_TypeDefinitionIndex = 30241;
