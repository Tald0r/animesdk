...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERZONEINFO_INITTIMELINEASSETCTX_OFFSET UNITYSDK_OFFSET(0x1AFCAC80)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERZONEINFO_ONCAMERASHAKEEVENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1AFCAC60)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERZONEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFCAC90)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerZoneInfo_TypeDefinitionIndex = 29288;
