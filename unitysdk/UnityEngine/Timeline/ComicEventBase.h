...
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1AB5AA20)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1AB5AA10)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1AB5A9D0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GET_HASMARKERINFO_OFFSET UNITYSDK_OFFSET(0x1AB5A680)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GET_ISEDIT_OFFSET UNITYSDK_OFFSET(0x1AB5A670)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1AB5A6F0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_ONISEDITCHANGE_OFFSET UNITYSDK_OFFSET(0x1AB5A660)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_ONTAGDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1AB5A740)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1AB5A730)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_TAGSSHOWIF_OFFSET UNITYSDK_OFFSET(0x1AB5A9C0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB5AA30)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ComicEventBase_TypeDefinitionIndex = 29290;
