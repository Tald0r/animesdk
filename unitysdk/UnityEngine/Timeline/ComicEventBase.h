...
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1B18B400)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1B18B3F0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1B18B3B0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GET_HASMARKERINFO_OFFSET UNITYSDK_OFFSET(0x1B18B060)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GET_ISEDIT_OFFSET UNITYSDK_OFFSET(0x1B18B050)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1B18B0D0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_ONISEDITCHANGE_OFFSET UNITYSDK_OFFSET(0x1B18B040)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_ONTAGDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1B18B120)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1B18B110)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE_TAGSSHOWIF_OFFSET UNITYSDK_OFFSET(0x1B18B3A0)
#define UNITYENGINE_TIMELINE_COMICEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B18B410)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ComicEventBase_TypeDefinitionIndex = 30243;
