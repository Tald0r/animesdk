...
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMTRACK_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1A6C9220)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1A6C93D0)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C94A0)

namespace UnityEngine::Timeline::CutScene::ArrayLightSystem
{
	inline static constexpr unsigned int ArrayLightSystemTrack_TypeDefinitionIndex = 29424;
