...
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_CLEARSUBTRACKS_OFFSET UNITYSDK_OFFSET(0x1B2AFF10)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_COLLECTLIGHT_OFFSET UNITYSDK_OFFSET(0x1B2AFE30)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_GET_BASELIGHT_OFFSET UNITYSDK_OFFSET(0x1B2AFCC0)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1B2AFDA0)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1B2AFD00)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B2AFD90)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_SETINFINITECLIP_OFFSET UNITYSDK_OFFSET(0x1B2AFF20)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2AFF40)

namespace UnityEngine::Timeline::CutScene::ArrayLightSystem
{
	inline static constexpr unsigned int ArrayLightSystemBehavior_TypeDefinitionIndex = 30373;
