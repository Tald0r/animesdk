...
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_CLEARSUBTRACKS_OFFSET UNITYSDK_OFFSET(0x1AC943F0)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_COLLECTLIGHT_OFFSET UNITYSDK_OFFSET(0x1AC94310)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_GET_BASELIGHT_OFFSET UNITYSDK_OFFSET(0x1AC941A0)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1AC94280)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_ONPLAY_OFFSET UNITYSDK_OFFSET(0x1AC941E0)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1AC94270)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR_SETINFINITECLIP_OFFSET UNITYSDK_OFFSET(0x1AC94400)
#define UNITYENGINE_TIMELINE_CUTSCENE_ARRAYLIGHTSYSTEM_ARRAYLIGHTSYSTEMBEHAVIOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC94420)

namespace UnityEngine::Timeline::CutScene::ArrayLightSystem
{
	inline static constexpr unsigned int ArrayLightSystemBehavior_TypeDefinitionIndex = 29420;
