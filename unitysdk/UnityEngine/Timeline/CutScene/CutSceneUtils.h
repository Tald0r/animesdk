...
#define UNITYENGINE_TIMELINE_CUTSCENE_CUTSCENEUTILS_CHECKKFRAMEFIELDTYPE_OFFSET UNITYSDK_OFFSET(0x1AB57A30)
#define UNITYENGINE_TIMELINE_CUTSCENE_CUTSCENEUTILS_FORCEREFRESHMATERIAL_OFFSET UNITYSDK_OFFSET(0x1AB5AD00)
#define UNITYENGINE_TIMELINE_CUTSCENE_CUTSCENEUTILS_GETCHILDLEVEL_OFFSET UNITYSDK_OFFSET(0x1AB5AA90)
#define UNITYENGINE_TIMELINE_CUTSCENE_CUTSCENEUTILS_GETVALUEFROMFRAMES_OFFSET UNITYSDK_OFFSET(0x1AB57830)
#define UNITYENGINE_TIMELINE_CUTSCENE_CUTSCENEUTILS_TOSTRINGRELATEDPATH_OFFSET UNITYSDK_OFFSET(0x1AB5AD10)
#define UNITYENGINE_TIMELINE_CUTSCENE_CUTSCENEUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB5B070)
#define UNITYENGINE_TIMELINE_CUTSCENE_CUTSCENEUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB5B060)

namespace UnityEngine::Timeline::CutScene
{
	inline static constexpr unsigned int CutSceneUtils_TypeDefinitionIndex = 29419;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Timeline::KFrameFieldType>**)Il2CppClass::FromTypeDefinitionIndex(CutSceneUtils_TypeDefinitionIndex)->GetStaticField(0x227C0);
		}
		static ::System::Collections::Generic::Dictionary_2<::UnityEngine::Material*, ::System::Single>** StaticGet_lastMaterialRefreshTime()
		{
			return (::System::Collections::Generic::Dictionary_2<::UnityEngine::Material*, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(CutSceneUtils_TypeDefinitionIndex)->GetStaticField(0x227C8);
		}
		static ::System::Action_1<::UnityEngine::Material*>** StaticGet_m_fcMakeAvatarMatKeywordChange()
		{
			return (::System::Action_1<::UnityEngine::Material*>**)Il2CppClass::FromTypeDefinitionIndex(CutSceneUtils_TypeDefinitionIndex)->GetStaticField(0x227D0);
		}
		static ::UnityEngine::AnimationCurve** StaticGet__curve()
		{
			return (::UnityEngine::AnimationCurve**)Il2CppClass::FromTypeDefinitionIndex(CutSceneUtils_TypeDefinitionIndex)->GetStaticField(0x227D8);
		}
		static ::System::Single* StaticGet_mixDeltaTime()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(CutSceneUtils_TypeDefinitionIndex)->GetStaticField(0x75A0);
		}
