...
#define UNITYENGINE_TIMELINE_TIMELINEUNDO_PUSHDESTROYUNDO_OFFSET UNITYSDK_OFFSET(0x1ACD40A0)
#define UNITYENGINE_TIMELINE_TIMELINEUNDO_PUSHUNDO_OFFSET UNITYSDK_OFFSET(0x1ACD4150)
#define UNITYENGINE_TIMELINE_TIMELINEUNDO_REGISTERCREATEDOBJECTUNDO_OFFSET UNITYSDK_OFFSET(0x1ACD4160)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineUndo_TypeDefinitionIndex = 30362;
