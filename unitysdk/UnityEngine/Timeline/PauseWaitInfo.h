...
#define UNITYENGINE_TIMELINE_PAUSEWAITINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEDCAC0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PauseWaitInfo_TypeDefinitionIndex = 29306;
