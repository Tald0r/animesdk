...
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1B59D610)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_GET_FIRSTTYPE_OFFSET UNITYSDK_OFFSET(0x1B59CD10)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_GET_ISNULLTYPE_OFFSET UNITYSDK_OFFSET(0x1B59D790)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_HASRELATIVECOMP_OFFSET UNITYSDK_OFFSET(0x1B59D330)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISASSIGNABLEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1B59D030)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISASSIGNABLEFROMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B59D1B0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISASSIGNABLEFROM_OFFSET UNITYSDK_OFFSET(0x1B59CF20)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISINSTANCEOFTYPE_OFFSET UNITYSDK_OFFSET(0x1B59D4D0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B59CE00)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B59CE80)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B59CD80)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TrackBindingTypeAttribute_TypeDefinitionIndex = 30330;
