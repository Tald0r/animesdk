...
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_GETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1AF8A1A0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_GET_FIRSTTYPE_OFFSET UNITYSDK_OFFSET(0x1AF89880)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_GET_ISNULLTYPE_OFFSET UNITYSDK_OFFSET(0x1AF8A330)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_HASRELATIVECOMP_OFFSET UNITYSDK_OFFSET(0x1AF89EC0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISASSIGNABLEFROMCOMP_OFFSET UNITYSDK_OFFSET(0x1AF89BA0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISASSIGNABLEFROMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AF89D30)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISASSIGNABLEFROM_OFFSET UNITYSDK_OFFSET(0x1AF89A90)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE_ISINSTANCEOFTYPE_OFFSET UNITYSDK_OFFSET(0x1AF8A060)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AF89970)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AF899F0)
#define UNITYENGINE_TIMELINE_TRACKBINDINGTYPEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF898F0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TrackBindingTypeAttribute_TypeDefinitionIndex = 29377;
