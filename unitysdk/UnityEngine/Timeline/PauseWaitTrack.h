...
#define UNITYENGINE_TIMELINE_PAUSEWAITTRACK_CANMOVEBYUSERINTIMELINE_OFFSET UNITYSDK_OFFSET(0x1B5D6B60)
#define UNITYENGINE_TIMELINE_PAUSEWAITTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1B5D6B70)
#define UNITYENGINE_TIMELINE_PAUSEWAITTRACK_ONDELETECLIP_OFFSET UNITYSDK_OFFSET(0x1B5D6BC0)
#define UNITYENGINE_TIMELINE_PAUSEWAITTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D6BD0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PauseWaitTrack_TypeDefinitionIndex = 30261;
