...
#define UNITYENGINE_TIMELINE_PAUSEWAITTRACK_CANMOVEBYUSERINTIMELINE_OFFSET UNITYSDK_OFFSET(0x1AFCB040)
#define UNITYENGINE_TIMELINE_PAUSEWAITTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1AFCB050)
#define UNITYENGINE_TIMELINE_PAUSEWAITTRACK_ONDELETECLIP_OFFSET UNITYSDK_OFFSET(0x1AFCB0A0)
#define UNITYENGINE_TIMELINE_PAUSEWAITTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFCB0B0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PauseWaitTrack_TypeDefinitionIndex = 29308;
