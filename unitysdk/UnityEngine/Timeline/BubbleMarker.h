...
#define UNITYENGINE_TIMELINE_BUBBLEMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B3C2770)
#define UNITYENGINE_TIMELINE_BUBBLEMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1B3C2790)
#define UNITYENGINE_TIMELINE_BUBBLEMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1B3C2780)
#define UNITYENGINE_TIMELINE_BUBBLEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C27A0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BubbleMarker_TypeDefinitionIndex = 30222;
