...
#define UNITYENGINE_TIMELINE_BUBBLEMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1ADADC30)
#define UNITYENGINE_TIMELINE_BUBBLEMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1ADADC50)
#define UNITYENGINE_TIMELINE_BUBBLEMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1ADADC40)
#define UNITYENGINE_TIMELINE_BUBBLEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADADC60)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BubbleMarker_TypeDefinitionIndex = 29269;
