...
#define UNITYENGINE_TIMELINE_SPLITSCREENEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1AFCBD60)
#define UNITYENGINE_TIMELINE_SPLITSCREENEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFCBDA0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int SplitScreenEvent_TypeDefinitionIndex = 29299;
