...
#define UNITYENGINE_TIMELINE_SPLITSCREENEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1B5D7880)
#define UNITYENGINE_TIMELINE_SPLITSCREENEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D78C0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int SplitScreenEvent_TypeDefinitionIndex = 30252;
