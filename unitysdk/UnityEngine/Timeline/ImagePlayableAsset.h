...
#define UNITYENGINE_TIMELINE_IMAGEPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B18BFA0)
#define UNITYENGINE_TIMELINE_IMAGEPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1B18C070)
#define UNITYENGINE_TIMELINE_IMAGEPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B18C080)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImagePlayableAsset_TypeDefinitionIndex = 30306;
