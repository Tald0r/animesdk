...
#define UNITYENGINE_TIMELINE_IMAGEPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1AB5B590)
#define UNITYENGINE_TIMELINE_IMAGEPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1AB5B670)
#define UNITYENGINE_TIMELINE_IMAGEPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB5B680)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImagePlayableAsset_TypeDefinitionIndex = 29353;
