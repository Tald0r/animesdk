...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_DRAWASEPARATIONLINE_OFFSET UNITYSDK_OFFSET(0x1A445550)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A445620)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1A445640)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET__FRAME_OFFSET UNITYSDK_OFFSET(0x1A4455C0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET__JUSTDRAWASEPARATIONLINE_OFFSET UNITYSDK_OFFSET(0x1A445530)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET__TIME_OFFSET UNITYSDK_OFFSET(0x1A445560)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1A445630)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A445650)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_SET__FRAME_OFFSET UNITYSDK_OFFSET(0x1A4455D0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_SET__JUSTDRAWASEPARATIONLINE_OFFSET UNITYSDK_OFFSET(0x1A445540)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_SET__TIME_OFFSET UNITYSDK_OFFSET(0x1A445570)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A445670)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerMarker_TypeDefinitionIndex = 29280;
