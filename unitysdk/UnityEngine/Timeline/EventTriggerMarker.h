...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_DRAWASEPARATIONLINE_OFFSET UNITYSDK_OFFSET(0x1AA10B50)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1AA10C20)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1AA10C40)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET__FRAME_OFFSET UNITYSDK_OFFSET(0x1AA10BC0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET__JUSTDRAWASEPARATIONLINE_OFFSET UNITYSDK_OFFSET(0x1AA10B30)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_GET__TIME_OFFSET UNITYSDK_OFFSET(0x1AA10B60)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1AA10C30)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AA10C50)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_SET__FRAME_OFFSET UNITYSDK_OFFSET(0x1AA10BD0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_SET__JUSTDRAWASEPARATIONLINE_OFFSET UNITYSDK_OFFSET(0x1AA10B40)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER_SET__TIME_OFFSET UNITYSDK_OFFSET(0x1AA10B70)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA10C70)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerMarker_TypeDefinitionIndex = 30233;
