...
#define UNITYENGINE_TIMELINE_COMICSHAKEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B59B850)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ComicShakeEvent_TypeDefinitionIndex = 30255;
