...
#define UNITYENGINE_TIMELINE_MULTISHOWCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1A445DA0)
#define UNITYENGINE_TIMELINE_MULTISHOWCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1A445D80)
#define UNITYENGINE_TIMELINE_MULTISHOWCLIP_GET_CLIPTYPE_OFFSET UNITYSDK_OFFSET(0x1A445D90)
#define UNITYENGINE_TIMELINE_MULTISHOWCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A445DF0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int MultiShowClip_TypeDefinitionIndex = 29389;
