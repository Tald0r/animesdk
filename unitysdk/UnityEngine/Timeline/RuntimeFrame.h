...
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_EVALUATEAT_OFFSET UNITYSDK_OFFSET(0x1B129070)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_GET_INTERVALEND_OFFSET UNITYSDK_OFFSET(0x1B129050)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_GET_INTERVALSTART_OFFSET UNITYSDK_OFFSET(0x1B129040)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_SET_ENABLE_OFFSET UNITYSDK_OFFSET(0x1B129060)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B129080)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int RuntimeFrame_TypeDefinitionIndex = 29335;
