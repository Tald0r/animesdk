...
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_EVALUATEAT_OFFSET UNITYSDK_OFFSET(0x1B7403E0)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_GET_INTERVALEND_OFFSET UNITYSDK_OFFSET(0x1B7403C0)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_GET_INTERVALSTART_OFFSET UNITYSDK_OFFSET(0x1B7403B0)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME_SET_ENABLE_OFFSET UNITYSDK_OFFSET(0x1B7403D0)
#define UNITYENGINE_TIMELINE_RUNTIMEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7403F0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int RuntimeFrame_TypeDefinitionIndex = 30288;
