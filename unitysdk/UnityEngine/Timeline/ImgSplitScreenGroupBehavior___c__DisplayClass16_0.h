...
{
	inline static constexpr unsigned int ImgSplitScreenGroupBehavior___c__DisplayClass16_0_TypeDefinitionIndex = 30264;

	struct alignas(8) ImgSplitScreenGroupBehavior___c__DisplayClass16_0
	{
		::UnityEngine::Timeline::ComicGroupTrack* groupTrack; // 0x10
		::UnityEngine::Timeline::ImgSplitScreenGroupBehavior* __4__this; // 0x18
