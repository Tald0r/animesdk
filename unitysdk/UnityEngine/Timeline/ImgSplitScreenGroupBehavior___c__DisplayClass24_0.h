...
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5000F0)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR___C__DISPLAYCLASS24_0__HANDLESPLITANIM_B__0_OFFSET UNITYSDK_OFFSET(0x1B500100)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR___C__DISPLAYCLASS24_0__HANDLESPLITANIM_B__1_OFFSET UNITYSDK_OFFSET(0x1B5001A0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImgSplitScreenGroupBehavior___c__DisplayClass24_0_TypeDefinitionIndex = 30267;
