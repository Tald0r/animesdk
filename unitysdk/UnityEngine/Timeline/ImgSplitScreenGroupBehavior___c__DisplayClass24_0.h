...
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEDC930)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR___C__DISPLAYCLASS24_0__HANDLESPLITANIM_B__0_OFFSET UNITYSDK_OFFSET(0x1AEDC940)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPBEHAVIOR___C__DISPLAYCLASS24_0__HANDLESPLITANIM_B__1_OFFSET UNITYSDK_OFFSET(0x1AEDC9E0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImgSplitScreenGroupBehavior___c__DisplayClass24_0_TypeDefinitionIndex = 29314;
