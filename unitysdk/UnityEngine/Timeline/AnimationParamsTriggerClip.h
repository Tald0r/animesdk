...
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERCLIP_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1AEDBDD0)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERCLIP_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1AEDBDC0)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERCLIP_INITANIMATIONCOMP_OFFSET UNITYSDK_OFFSET(0x1AEDBEB0)
#define UNITYENGINE_TIMELINE_ANIMATIONPARAMSTRIGGERCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEDBEC0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int AnimationParamsTriggerClip_TypeDefinitionIndex = 29213;
