...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1A73ED30)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1A73ECC0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A73EFD0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerBehaviour_TypeDefinitionIndex = 29279;
