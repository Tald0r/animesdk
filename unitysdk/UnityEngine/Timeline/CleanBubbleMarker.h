...
#define UNITYENGINE_TIMELINE_CLEANBUBBLEMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1ACE2960)
#define UNITYENGINE_TIMELINE_CLEANBUBBLEMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1ACE2970)
#define UNITYENGINE_TIMELINE_CLEANBUBBLEMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1ACE2950)
#define UNITYENGINE_TIMELINE_CLEANBUBBLEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACE2980)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int CleanBubbleMarker_TypeDefinitionIndex = 30226;
