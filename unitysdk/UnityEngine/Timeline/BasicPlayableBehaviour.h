...
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1B40B810)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1B40B720)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_GET_OUTPUTS_OFFSET UNITYSDK_OFFSET(0x1B40B760)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B40B7E0)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B40B7D0)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1B40B790)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_ONGRAPHSTOP_OFFSET UNITYSDK_OFFSET(0x1B40B7A0)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_ONPLAYABLECREATE_OFFSET UNITYSDK_OFFSET(0x1B40B7B0)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B40B7C0)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x1B40B7F0)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B40B800)
#define UNITYENGINE_TIMELINE_BASICPLAYABLEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40B6F0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BasicPlayableBehaviour_TypeDefinitionIndex = 30313;
