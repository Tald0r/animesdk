...
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_CREATE_OFFSET UNITYSDK_OFFSET(0x1B2B11E0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_GET_NEWUPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1B2B1440)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_GET_PARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0x1B2B1420)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_GET_UNFIXUPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1B2B1460)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B2B13E0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1B2B1CD0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B2B1CC0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x1B2B1590)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SETRANDOMSEED_OFFSET UNITYSDK_OFFSET(0x1B2B1480)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SET_NEWUPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1B2B1450)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SET_PARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0x1B2B1430)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SET_UNFIXUPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1B2B1470)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1B2B1BF0)
#define UNITYENGINE_TIMELINE_PARTICLECONTROLPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2B1CE0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ParticleControlPlayable_TypeDefinitionIndex = 30317;
	...
	public:
		...
		::System::Single m_SystemTime; // 0x20
		::System::Boolean _unFixUpdateMode_k__BackingField; // 0x24
		::System::Boolean _newUpdateMode_k__BackingField; // 0x25
