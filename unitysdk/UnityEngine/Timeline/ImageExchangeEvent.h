...
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1B740330)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1B7402F0)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1B7402B0)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT_ONSPRITECHANGE_OFFSET UNITYSDK_OFFSET(0x1B740280)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT_SETSPRITEBYPATH_OFFSET UNITYSDK_OFFSET(0x1B7402A0)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT_SHOWANIMINFO_OFFSET UNITYSDK_OFFSET(0x1B740290)
#define UNITYENGINE_TIMELINE_IMAGEEXCHANGEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B740340)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImageExchangeEvent_TypeDefinitionIndex = 30246;
