...
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1ACD3FE0)
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1ACD3FF0)
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1ACD3FD0)
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACD4000)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ProtectTimeMarker_TypeDefinitionIndex = 30347;
