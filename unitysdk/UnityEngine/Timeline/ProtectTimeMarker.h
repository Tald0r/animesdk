...
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A7308A0)
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1A7308B0)
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1A730890)
#define UNITYENGINE_TIMELINE_PROTECTTIMEMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7308C0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ProtectTimeMarker_TypeDefinitionIndex = 29394;
