...
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B1290A0)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1B1290E0)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_LOADSCENE_OFFSET UNITYSDK_OFFSET(0x1B129100)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1B1290D0)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B1290F0)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1290B0)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_SETSCENEACTIVE_OFFSET UNITYSDK_OFFSET(0x1B129120)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_SWITCHCURRENTSCENE_OFFSET UNITYSDK_OFFSET(0x1B1290C0)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_SWITCHSCENE_OFFSET UNITYSDK_OFFSET(0x1B129110)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1292E0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int SceneSwitchMarker_TypeDefinitionIndex = 29304;
