...
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B740410)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1B740450)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_LOADSCENE_OFFSET UNITYSDK_OFFSET(0x1B740470)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1B740440)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B740460)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_ONINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B740420)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_SETSCENEACTIVE_OFFSET UNITYSDK_OFFSET(0x1B740490)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_SWITCHCURRENTSCENE_OFFSET UNITYSDK_OFFSET(0x1B740430)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER_SWITCHSCENE_OFFSET UNITYSDK_OFFSET(0x1B740480)
#define UNITYENGINE_TIMELINE_SCENESWITCHMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B740650)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int SceneSwitchMarker_TypeDefinitionIndex = 30257;
