...
#define UNITYENGINE_TIMELINE_DECORATEEVENTBASE_CREATEONEDECORATIONEVENT_OFFSET UNITYSDK_OFFSET(0x1A6C95D0)
#define UNITYENGINE_TIMELINE_DECORATEEVENTBASE_LOADSPRITE_OFFSET UNITYSDK_OFFSET(0x1A6C94D0)
#define UNITYENGINE_TIMELINE_DECORATEEVENTBASE_SHOWANIMINFO_OFFSET UNITYSDK_OFFSET(0x1A6C9B30)
#define UNITYENGINE_TIMELINE_DECORATEEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6C9B40)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int DecorateEventBase_TypeDefinitionIndex = 29292;
