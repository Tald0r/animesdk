...
#define UNITYENGINE_TIMELINE_DECORATEEVENTBASE_CREATEONEDECORATIONEVENT_OFFSET UNITYSDK_OFFSET(0x1AC74830)
#define UNITYENGINE_TIMELINE_DECORATEEVENTBASE_LOADSPRITE_OFFSET UNITYSDK_OFFSET(0x1AC74730)
#define UNITYENGINE_TIMELINE_DECORATEEVENTBASE_SHOWANIMINFO_OFFSET UNITYSDK_OFFSET(0x1AC74D90)
#define UNITYENGINE_TIMELINE_DECORATEEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC74DA0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int DecorateEventBase_TypeDefinitionIndex = 30245;
