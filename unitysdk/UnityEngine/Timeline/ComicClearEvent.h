...
#define UNITYENGINE_TIMELINE_COMICCLEAREVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1ADEB230)
#define UNITYENGINE_TIMELINE_COMICCLEAREVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1ADEB1F0)
#define UNITYENGINE_TIMELINE_COMICCLEAREVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1ADEB1B0)
#define UNITYENGINE_TIMELINE_COMICCLEAREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADEB240)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ComicClearEvent_TypeDefinitionIndex = 29301;
