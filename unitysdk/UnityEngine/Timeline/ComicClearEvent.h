...
#define UNITYENGINE_TIMELINE_COMICCLEAREVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1B40B9C0)
#define UNITYENGINE_TIMELINE_COMICCLEAREVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1B40B980)
#define UNITYENGINE_TIMELINE_COMICCLEAREVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1B40B940)
#define UNITYENGINE_TIMELINE_COMICCLEAREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B40B9D0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ComicClearEvent_TypeDefinitionIndex = 30254;
