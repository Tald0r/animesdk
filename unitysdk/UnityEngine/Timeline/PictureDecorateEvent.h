...
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1AC7F180)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1AC7F140)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1AC7F100)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETSIZE_OFFSET UNITYSDK_OFFSET(0x1AC7EE50)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_GETSPRITE_OFFSET UNITYSDK_OFFSET(0x1AC7EE30)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_ONSPRITECHANGE_OFFSET UNITYSDK_OFFSET(0x1AC7F010)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT_SETSPRITEBYPATH_OFFSET UNITYSDK_OFFSET(0x1AC7F0F0)
#define UNITYENGINE_TIMELINE_PICTUREDECORATEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC7F190)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int PictureDecorateEvent_TypeDefinitionIndex = 29295;
