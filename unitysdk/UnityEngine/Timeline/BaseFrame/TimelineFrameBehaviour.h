...
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_CHECKISRECORDER_OFFSET UNITYSDK_OFFSET(0x1ADAD740)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1ADAC9C0)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1ADACEA0)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1ADAD900)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x1ADAC850)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1ADAD010)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADADBB0)

namespace UnityEngine::Timeline::BaseFrame
{
	inline static constexpr unsigned int TimelineFrameBehaviour_TypeDefinitionIndex = 29440;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::Timeline::TimeLinePlayableBehaviour*>* initBehaviours; // 0x18
		::System::Collections::Generic::List_1<::UnityEngine::Timeline::PropertyCurve*>* frameInfos; // 0x20
