...
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_CHECKISRECORDER_OFFSET UNITYSDK_OFFSET(0x1B3C2280)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_INITDATA_OFFSET UNITYSDK_OFFSET(0x1B3C1500)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_ONBEHAVIOURPLAY_OFFSET UNITYSDK_OFFSET(0x1B3C19E0)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1B3C2440)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_PREPAREDATA_OFFSET UNITYSDK_OFFSET(0x1B3C1390)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1B3C1B50)
#define UNITYENGINE_TIMELINE_BASEFRAME_TIMELINEFRAMEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C26F0)

namespace UnityEngine::Timeline::BaseFrame
{
	inline static constexpr unsigned int TimelineFrameBehaviour_TypeDefinitionIndex = 30393;
	...
	public:
		...
		::System::Collections::Generic::List_1<::MoleMole::Timeline::TimeLinePlayableBehaviour*>* initBehaviours; // 0x28
