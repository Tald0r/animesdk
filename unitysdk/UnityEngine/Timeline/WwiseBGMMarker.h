...
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B740720)
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1B740730)
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1B740710)
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B740740)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int WwiseBGMMarker_TypeDefinitionIndex = 30367;
