...
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1B1293B0)
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1B1293C0)
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1B1293A0)
#define UNITYENGINE_TIMELINE_WWISEBGMMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1293D0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int WwiseBGMMarker_TypeDefinitionIndex = 29414;
