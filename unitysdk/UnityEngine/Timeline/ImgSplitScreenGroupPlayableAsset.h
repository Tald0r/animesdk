...
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPPLAYABLEASSET_ADDONESPRITE_OFFSET UNITYSDK_OFFSET(0x1AC78090)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1AC78040)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1AC78030)
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC780A0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImgSplitScreenGroupPlayableAsset_TypeDefinitionIndex = 30268;
