...
#define UNITYENGINE_TIMELINE_BUBBLETRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1AB5A5E0)
#define UNITYENGINE_TIMELINE_BUBBLETRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB5A630)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BubbleTrack_TypeDefinitionIndex = 29272;
