...
#define UNITYENGINE_TIMELINE_COMIC_MAININFOPLAYABLEASSET_DIALOGUETEXTSTRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEDC690)

namespace UnityEngine::Timeline::Comic
{
	inline static constexpr unsigned int MainInfoPlayableAsset_DialogueTextStruct_TypeDefinitionIndex = 29426;
