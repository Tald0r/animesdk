...
#define UNITYENGINE_TIMELINE_COMIC_DATASPLITTER_DATASPLITTERBASE_CLEARIMP_OFFSET UNITYSDK_OFFSET(0x1ADEB170)
#define UNITYENGINE_TIMELINE_COMIC_DATASPLITTER_DATASPLITTERBASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1ADEB160)
#define UNITYENGINE_TIMELINE_COMIC_DATASPLITTER_DATASPLITTERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADEB180)

namespace UnityEngine::Timeline::Comic::DataSplitter
{
	inline static constexpr unsigned int DataSplitterBase_TypeDefinitionIndex = 29428;
