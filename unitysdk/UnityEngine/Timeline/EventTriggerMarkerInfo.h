...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_CONTAINKEY_OFFSET UNITYSDK_OFFSET(0x1ADADFB0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_EXISTKEYEVENT_OFFSET UNITYSDK_OFFSET(0x1ADADD00)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_GET_GETDECORATEEVENTBASES_OFFSET UNITYSDK_OFFSET(0x1ADADE00)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_GET_GETKEYEVENTBASES_OFFSET UNITYSDK_OFFSET(0x1ADADCC0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_GET_GETLOGICEVENTBASES_OFFSET UNITYSDK_OFFSET(0x1ADADE40)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONADDEVENTVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1ADAE100)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONDECORATEEVENTBASEVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1ADAE110)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONKEYEVENTBASESVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1ADAE0D0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONLOGICEVENTBASEVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1ADAE140)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONMARKEREVENTBASESVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1ADAE170)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_SETREF_OFFSET UNITYSDK_OFFSET(0x1ADAE1A0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_TRAVERSEEVENTS_OFFSET UNITYSDK_OFFSET(0x1ADADE80)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_TRAVERSEKEYS_OFFSET UNITYSDK_OFFSET(0x1ADADF20)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADAE230)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerMarkerInfo_TypeDefinitionIndex = 29281;
