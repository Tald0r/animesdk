...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_CONTAINKEY_OFFSET UNITYSDK_OFFSET(0x1B3C2AF0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_EXISTKEYEVENT_OFFSET UNITYSDK_OFFSET(0x1B3C2840)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_GET_GETDECORATEEVENTBASES_OFFSET UNITYSDK_OFFSET(0x1B3C2940)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_GET_GETKEYEVENTBASES_OFFSET UNITYSDK_OFFSET(0x1B3C2800)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_GET_GETLOGICEVENTBASES_OFFSET UNITYSDK_OFFSET(0x1B3C2980)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONADDEVENTVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1B3C2C40)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONDECORATEEVENTBASEVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1B3C2C50)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONKEYEVENTBASESVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1B3C2C10)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONLOGICEVENTBASEVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1B3C2C80)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_ONMARKEREVENTBASESVALUEDROPDOWN_OFFSET UNITYSDK_OFFSET(0x1B3C2CB0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_SETREF_OFFSET UNITYSDK_OFFSET(0x1B3C2CE0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_TRAVERSEEVENTS_OFFSET UNITYSDK_OFFSET(0x1B3C29C0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO_TRAVERSEKEYS_OFFSET UNITYSDK_OFFSET(0x1B3C2A60)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERMARKERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C2D70)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerMarkerInfo_TypeDefinitionIndex = 30234;
