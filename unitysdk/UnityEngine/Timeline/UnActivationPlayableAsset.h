...
#define UNITYENGINE_TIMELINE_UNACTIVATIONPLAYABLEASSET_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1ACD41A0)
#define UNITYENGINE_TIMELINE_UNACTIVATIONPLAYABLEASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1ACD4190)
#define UNITYENGINE_TIMELINE_UNACTIVATIONPLAYABLEASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACD4230)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int UnActivationPlayableAsset_TypeDefinitionIndex = 30278;
