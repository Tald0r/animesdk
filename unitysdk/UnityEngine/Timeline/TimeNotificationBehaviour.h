...
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_ADDNOTIFICATION_1_OFFSET UNITYSDK_OFFSET(0x1ADAE620)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_ADDNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1ADAE5C0)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_CANRESTORENOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1ADAF7D0)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_CREATE_OFFSET UNITYSDK_OFFSET(0x1ADAE4C0)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_ONBEHAVIOURPAUSE_OFFSET UNITYSDK_OFFSET(0x1ADAE890)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_ONGRAPHSTART_OFFSET UNITYSDK_OFFSET(0x1ADAE680)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x1ADAEC50)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_RESTORE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1ADAF800)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_SET_TIMESOURCE_OFFSET UNITYSDK_OFFSET(0x1ADAE4B0)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_SORTNOTIFICATIONS_OFFSET UNITYSDK_OFFSET(0x1ADAE780)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_SYNCDURATIONWITHEXTERNALSOURCE_OFFSET UNITYSDK_OFFSET(0x1ADAF250)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_TRIGGERNOTIFICATIONSINRANGE_OFFSET UNITYSDK_OFFSET(0x1ADAF390)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR_TRIGGER_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1ADAEB60)
#define UNITYENGINE_TIMELINE_TIMENOTIFICATIONBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADAF810)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimeNotificationBehaviour_TypeDefinitionIndex = 29367;
