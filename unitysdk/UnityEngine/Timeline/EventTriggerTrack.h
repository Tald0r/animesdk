...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_CANMOVEBYUSERINTIMELINE_OFFSET UNITYSDK_OFFSET(0x1ACE2E20)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1ACE2E30)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_ONCREATEMARKER_OFFSET UNITYSDK_OFFSET(0x1ACE2E80)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_ONDELETECLIP_OFFSET UNITYSDK_OFFSET(0x1ACE2E90)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_ONDELETEMARKER_OFFSET UNITYSDK_OFFSET(0x1ACE2EA0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACE2EB0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerTrack_TypeDefinitionIndex = 30242;
