...
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_CANMOVEBYUSERINTIMELINE_OFFSET UNITYSDK_OFFSET(0x1A73F0F0)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1A73F100)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_ONCREATEMARKER_OFFSET UNITYSDK_OFFSET(0x1A73F150)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_ONDELETECLIP_OFFSET UNITYSDK_OFFSET(0x1A73F160)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK_ONDELETEMARKER_OFFSET UNITYSDK_OFFSET(0x1A73F170)
#define UNITYENGINE_TIMELINE_EVENTTRIGGERTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A73F180)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int EventTriggerTrack_TypeDefinitionIndex = 29289;
