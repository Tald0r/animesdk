...
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1A4450D0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETARROWOUTLENRATE_OFFSET UNITYSDK_OFFSET(0x1A444FB0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETARROWOUTLEN_OFFSET UNITYSDK_OFFSET(0x1A444F60)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETARROWTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A445010)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1A445090)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1A445050)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A444E80)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1A444EA0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETSHOWARROW_OFFSET UNITYSDK_OFFSET(0x1A444F20)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETARROWOUTLENRATE_OFFSET UNITYSDK_OFFSET(0x1A444F80)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETARROWOUTLEN_OFFSET UNITYSDK_OFFSET(0x1A444F40)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETARROWTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A444FE0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETROTATION_OFFSET UNITYSDK_OFFSET(0x1A444ED0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4450E0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BubbleEvent_TypeDefinitionIndex = 29297;
