...
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_EDITORICONISUNITYINNER_OFFSET UNITYSDK_OFFSET(0x1AA106D0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETARROWOUTLENRATE_OFFSET UNITYSDK_OFFSET(0x1AA105B0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETARROWOUTLEN_OFFSET UNITYSDK_OFFSET(0x1AA10560)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETARROWTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AA10610)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETEDITORICONPATH_OFFSET UNITYSDK_OFFSET(0x1AA10690)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETEDITORSHOWNAME_OFFSET UNITYSDK_OFFSET(0x1AA10650)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AA10480)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1AA104A0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_GETSHOWARROW_OFFSET UNITYSDK_OFFSET(0x1AA10520)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETARROWOUTLENRATE_OFFSET UNITYSDK_OFFSET(0x1AA10580)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETARROWOUTLEN_OFFSET UNITYSDK_OFFSET(0x1AA10540)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETARROWTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AA105E0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT_SETROTATION_OFFSET UNITYSDK_OFFSET(0x1AA104D0)
#define UNITYENGINE_TIMELINE_BUBBLEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA106E0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int BubbleEvent_TypeDefinitionIndex = 30250;
