...
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_AFTERCREATEPLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0x1ACE4F80)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_CLEAR_OFFSET UNITYSDK_OFFSET(0x1ACE4340)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1ACE65D0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETFRAMETYPES_OFFSET UNITYSDK_OFFSET(0x1ACE4430)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETFRAME_OFFSET UNITYSDK_OFFSET(0x1ACE5170)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYINFOS_1_OFFSET UNITYSDK_OFFSET(0x1ACE59C0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYINFOS_OFFSET UNITYSDK_OFFSET(0x1ACE5330)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYNAME_1_OFFSET UNITYSDK_OFFSET(0x1ACE85C0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1ACE80C0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETREALPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1ACE6A00)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_EDITORFRAMETYPES_OFFSET UNITYSDK_OFFSET(0x1ACE4040)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_FRAMES_OFFSET UNITYSDK_OFFSET(0x1ACE3510)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_FRAMETYPES_OFFSET UNITYSDK_OFFSET(0x1ACE34F0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_ISFRAMETRACK_OFFSET UNITYSDK_OFFSET(0x1ACE3500)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_TRACKNAME_OFFSET UNITYSDK_OFFSET(0x1ACE3DA0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_HASH_OFFSET UNITYSDK_OFFSET(0x1ACE3D30)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_INITFRAMEINFOS_OFFSET UNITYSDK_OFFSET(0x1ACE4F70)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_INITPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1ACE69F0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ACE8650)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_RECORDERALTERPROPERTYINFOS_OFFSET UNITYSDK_OFFSET(0x1ACE6EF0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_RECORDERUNKFRAMEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1ACE7AD0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_REFRESHFRAMESANDPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1ACE3570)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_REFRESHVALUE_OFFSET UNITYSDK_OFFSET(0x1ACE4850)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_REVERTATTR_OFFSET UNITYSDK_OFFSET(0x1ACE83F0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETCURVEVALUE_OFFSET UNITYSDK_OFFSET(0x1ACE7AE0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETFRAMEINFOPROPERTY_OFFSET UNITYSDK_OFFSET(0x1ACE6B20)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETINITVALUE_OFFSET UNITYSDK_OFFSET(0x1ACE81D0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETPROPERTYSHOWTIME_OFFSET UNITYSDK_OFFSET(0x1ACE5230)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETVOLUMETYPE_OFFSET UNITYSDK_OFFSET(0x1ACE5080)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_UNKFRAMEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1ACE7AC0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ACE8A20)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACE8740)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME__RECORDERALTERPROPERTYINFOS_G__RECORDERINFOS_43_0_OFFSET UNITYSDK_OFFSET(0x1ACE7070)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineFrame_TypeDefinitionIndex = 30215;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::Il2CppArray<::System::Reflection::FieldInfo*>*>**)Il2CppClass::FromTypeDefinitionIndex(TimelineFrame_TypeDefinitionIndex)->GetStaticField(0x241F0);
		}
		static ::System::Action_4<::UnityEngine::AnimationClip*, ::System::Single, ::System::String*, ::System::Single>** StaticGet_RecordKFrame()
		{
			return (::System::Action_4<::UnityEngine::AnimationClip*, ::System::Single, ::System::String*, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(TimelineFrame_TypeDefinitionIndex)->GetStaticField(0x241F8);
		}
