...
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_AFTERCREATEPLAYABLEGRAPH_OFFSET UNITYSDK_OFFSET(0x1A741240)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A740610)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1A7428C0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETFRAMETYPES_OFFSET UNITYSDK_OFFSET(0x1A740700)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETFRAME_OFFSET UNITYSDK_OFFSET(0x1A741430)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYINFOS_1_OFFSET UNITYSDK_OFFSET(0x1A741C90)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYINFOS_OFFSET UNITYSDK_OFFSET(0x1A7415F0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYNAME_1_OFFSET UNITYSDK_OFFSET(0x1A7448B0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1A7443B0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GETREALPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1A742CF0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_EDITORFRAMETYPES_OFFSET UNITYSDK_OFFSET(0x1A740310)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_FRAMES_OFFSET UNITYSDK_OFFSET(0x1A73F7E0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_FRAMETYPES_OFFSET UNITYSDK_OFFSET(0x1A73F7C0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_ISFRAMETRACK_OFFSET UNITYSDK_OFFSET(0x1A73F7D0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_GET_TRACKNAME_OFFSET UNITYSDK_OFFSET(0x1A740070)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_HASH_OFFSET UNITYSDK_OFFSET(0x1A740000)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_INITFRAMEINFOS_OFFSET UNITYSDK_OFFSET(0x1A741230)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_INITPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A742CE0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A744940)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_RECORDERALTERPROPERTYINFOS_OFFSET UNITYSDK_OFFSET(0x1A7431E0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_RECORDERUNKFRAMEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A743DC0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_REFRESHFRAMESANDPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1A73F840)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_REFRESHVALUE_OFFSET UNITYSDK_OFFSET(0x1A740B10)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_REVERTATTR_OFFSET UNITYSDK_OFFSET(0x1A7446E0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETCURVEVALUE_OFFSET UNITYSDK_OFFSET(0x1A743DD0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETFRAMEINFOPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A742E10)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETINITVALUE_OFFSET UNITYSDK_OFFSET(0x1A7444C0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETPROPERTYSHOWTIME_OFFSET UNITYSDK_OFFSET(0x1A7414F0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_SETVOLUMETYPE_OFFSET UNITYSDK_OFFSET(0x1A741340)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME_UNKFRAMEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A743DB0)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A744D10)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A744A30)
#define UNITYENGINE_TIMELINE_TIMELINEFRAME__RECORDERALTERPROPERTYINFOS_G__RECORDERINFOS_43_0_OFFSET UNITYSDK_OFFSET(0x1A743360)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int TimelineFrame_TypeDefinitionIndex = 29262;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::Il2CppArray<::System::Reflection::FieldInfo*>*>**)Il2CppClass::FromTypeDefinitionIndex(TimelineFrame_TypeDefinitionIndex)->GetStaticField(0x228D0);
		}
		static ::System::Action_4<::UnityEngine::AnimationClip*, ::System::Single, ::System::String*, ::System::Single>** StaticGet_RecordKFrame()
		{
			return (::System::Action_4<::UnityEngine::AnimationClip*, ::System::Single, ::System::String*, ::System::Single>**)Il2CppClass::FromTypeDefinitionIndex(TimelineFrame_TypeDefinitionIndex)->GetStaticField(0x228D8);
		}
