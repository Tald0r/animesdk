...
#define UNITYENGINE_TIMELINE_IMGSPLITSCREENGROUPPLAYABLEASSET_SPRITEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFCACA0)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int ImgSplitScreenGroupPlayableAsset_SpriteItem_TypeDefinitionIndex = 29316;
