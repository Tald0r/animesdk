...
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A730B30)
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1A730B40)
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1A730B20)
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A730B50)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int WwiseAudioMarker_TypeDefinitionIndex = 29411;
