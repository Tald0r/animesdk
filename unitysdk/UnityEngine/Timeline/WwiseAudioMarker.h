...
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER_GETDATA_OFFSET UNITYSDK_OFFSET(0x1ACD4270)
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x1ACD4280)
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER_NOTIFY_OFFSET UNITYSDK_OFFSET(0x1ACD4260)
#define UNITYENGINE_TIMELINE_WWISEAUDIOMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACD4290)

namespace UnityEngine::Timeline
{
	inline static constexpr unsigned int WwiseAudioMarker_TypeDefinitionIndex = 30364;
