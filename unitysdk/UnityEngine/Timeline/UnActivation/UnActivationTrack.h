...
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_CANCOMPILECLIPS_OFFSET UNITYSDK_OFFSET(0x1B18CC10)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1B18CC80)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B18CE80)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_GET_POSTPLAYBACKSTATE_OFFSET UNITYSDK_OFFSET(0x1B18CC30)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1B18CFF0)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_SET_POSTPLAYBACKSTATE_OFFSET UNITYSDK_OFFSET(0x1B18CC40)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_UPDATETRACKMODE_OFFSET UNITYSDK_OFFSET(0x1B18CC60)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B18D040)

namespace UnityEngine::Timeline::UnActivation
{
	inline static constexpr unsigned int UnActivationTrack_TypeDefinitionIndex = 30370;
