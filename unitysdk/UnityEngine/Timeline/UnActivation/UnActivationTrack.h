...
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_CANCOMPILECLIPS_OFFSET UNITYSDK_OFFSET(0x1AB5C210)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_CREATETRACKMIXER_OFFSET UNITYSDK_OFFSET(0x1AB5C280)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_GATHERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AB5C480)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_GET_POSTPLAYBACKSTATE_OFFSET UNITYSDK_OFFSET(0x1AB5C230)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_ONCREATECLIP_OFFSET UNITYSDK_OFFSET(0x1AB5C5F0)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_SET_POSTPLAYBACKSTATE_OFFSET UNITYSDK_OFFSET(0x1AB5C240)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK_UPDATETRACKMODE_OFFSET UNITYSDK_OFFSET(0x1AB5C260)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONTRACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB5C640)

namespace UnityEngine::Timeline::UnActivation
{
	inline static constexpr unsigned int UnActivationTrack_TypeDefinitionIndex = 29417;
