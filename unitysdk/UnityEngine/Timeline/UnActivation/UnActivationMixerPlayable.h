...
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONMIXERPLAYABLE_CREATE_OFFSET UNITYSDK_OFFSET(0x1A747630)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONMIXERPLAYABLE_GET_POSTPLAYBACKSTATE_OFFSET UNITYSDK_OFFSET(0x1A7476C0)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONMIXERPLAYABLE_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1A7476E0)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONMIXERPLAYABLE_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1A747850)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONMIXERPLAYABLE_RECOVERSTATE_OFFSET UNITYSDK_OFFSET(0x1A7477D0)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONMIXERPLAYABLE_SET_POSTPLAYBACKSTATE_OFFSET UNITYSDK_OFFSET(0x1A7476D0)
#define UNITYENGINE_TIMELINE_UNACTIVATION_UNACTIVATIONMIXERPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A747B30)

namespace UnityEngine::Timeline::UnActivation
{
	inline static constexpr unsigned int UnActivationMixerPlayable_TypeDefinitionIndex = 29416;
