...
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_ADD_SCENELOADED_OFFSET UNITYSDK_OFFSET(0x1A1A7F50)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_ADD_SCENEUNLOADED_OFFSET UNITYSDK_OFFSET(0x1A1A8090)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_DATABASEDATA_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A1A7C30)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_DATABASEDATA_OFFSET UNITYSDK_OFFSET(0x1A1A7C40)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_GETACTIVESCENE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1A7CE0)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_GETACTIVESCENE_OFFSET UNITYSDK_OFFSET(0x1A1A7CA0)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_GETALLSCENES_OFFSET UNITYSDK_OFFSET(0x1A1A81D0)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_GETSCENEAT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1A7E10)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_GETSCENEAT_OFFSET UNITYSDK_OFFSET(0x1A1A7DD0)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_GETSCENEBYNAME_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1A7DC0)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_GETSCENEBYNAME_OFFSET UNITYSDK_OFFSET(0x1A1A7D80)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_GETSCENEBYPATH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1A7D70)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_GETSCENEBYPATH_OFFSET UNITYSDK_OFFSET(0x1A1A7D30)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_GET_SCENECOUNT_OFFSET UNITYSDK_OFFSET(0x1A1A7C90)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_INTERNAL_ACTIVESCENECHANGED_OFFSET UNITYSDK_OFFSET(0x1A1A87D0)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_INTERNAL_SCENELOADED_OFFSET UNITYSDK_OFFSET(0x1A1A8650)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_INTERNAL_SCENEUNLOADED_OFFSET UNITYSDK_OFFSET(0x1A1A8710)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_LOADSCENEASYNCNAMEINDEXINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A1A7E20)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_LOADSCENEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A1A8570)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_LOADSCENEASYNC_OFFSET UNITYSDK_OFFSET(0x1A1A84F0)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_LOADSCENE_1_OFFSET UNITYSDK_OFFSET(0x1A1A8450)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_LOADSCENE_OFFSET UNITYSDK_OFFSET(0x1A1A8390)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_MOVEGAMEOBJECTTOSCENE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1A7F40)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_MOVEGAMEOBJECTTOSCENE_OFFSET UNITYSDK_OFFSET(0x1A1A7F00)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_REMOVE_SCENELOADED_OFFSET UNITYSDK_OFFSET(0x1A1A7FF0)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_REMOVE_SCENEUNLOADED_OFFSET UNITYSDK_OFFSET(0x1A1A8130)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_RESETSCENEDATA_OFFSET UNITYSDK_OFFSET(0x1A1A7C20)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_SETACTIVESCENE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1A7D20)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_SETACTIVESCENE_OFFSET UNITYSDK_OFFSET(0x1A1A7CF0)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_UNLOADSCENEASYNC_OFFSET UNITYSDK_OFFSET(0x1A1A85E0)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER_UNLOADSCENENAMEINDEXINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A1A7E80)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1A88A0)
#define UNITYENGINE_SCENEMANAGEMENT_SCENEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A8890)
...
namespace UnityEngine::SceneManagement
{
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(SceneManager_TypeDefinitionIndex)->GetStaticField(0x2310);
		}
