...
#define UNITYENGINE_PHYSICS_BAKEMESH_OFFSET UNITYSDK_OFFSET(0x1AD03150)
#define UNITYENGINE_PHYSICS_BOXCASTNONALLOC_1_OFFSET UNITYSDK_OFFSET(0x1AD02B80)
#define UNITYENGINE_PHYSICS_BOXCASTNONALLOC_2_OFFSET UNITYSDK_OFFSET(0x1AD02CF0)
#define UNITYENGINE_PHYSICS_BOXCASTNONALLOC_OFFSET UNITYSDK_OFFSET(0x1AD027F0)
#define UNITYENGINE_PHYSICS_BOXCAST_OFFSET UNITYSDK_OFFSET(0x1ACFE000)
#define UNITYENGINE_PHYSICS_CAPSULECASTNONALLOC_1_OFFSET UNITYSDK_OFFSET(0x1AD01CB0)
#define UNITYENGINE_PHYSICS_CAPSULECASTNONALLOC_OFFSET UNITYSDK_OFFSET(0x1AD01920)
#define UNITYENGINE_PHYSICS_CAPSULECAST_1_OFFSET UNITYSDK_OFFSET(0x1ACFD7C0)
#define UNITYENGINE_PHYSICS_CAPSULECAST_OFFSET UNITYSDK_OFFSET(0x1ACFD3B0)
#define UNITYENGINE_PHYSICS_CHECKSPHERE_1_OFFSET UNITYSDK_OFFSET(0x1AD01880)
#define UNITYENGINE_PHYSICS_CHECKSPHERE_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD016F0)
#define UNITYENGINE_PHYSICS_CHECKSPHERE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD01650)
#define UNITYENGINE_PHYSICS_CHECKSPHERE_OFFSET UNITYSDK_OFFSET(0x1AD01700)
#define UNITYENGINE_PHYSICS_CLOSESTPOINT_OFFSET UNITYSDK_OFFSET(0x1AD01280)
#define UNITYENGINE_PHYSICS_COLLIDERAPPLYCOLLISIONS_OFFSET UNITYSDK_OFFSET(0x1ACFA080)
#define UNITYENGINE_PHYSICS_COLLIDERAPPLYCOLLISIONWITHLAYERNODIRTY_OFFSET UNITYSDK_OFFSET(0x1ACFA060)
#define UNITYENGINE_PHYSICS_COLLIDERAPPLYCOLLISIONWITHLAYER_OFFSET UNITYSDK_OFFSET(0x1ACFA050)
#define UNITYENGINE_PHYSICS_COLLIDERIGNORECOLLISIONWITHLAYER_OFFSET UNITYSDK_OFFSET(0x1ACFA200)
#define UNITYENGINE_PHYSICS_COMPUTEPENETRATION_OFFSET UNITYSDK_OFFSET(0x1AD01010)
#define UNITYENGINE_PHYSICS_GETIGNORECOLLISION_OFFSET UNITYSDK_OFFSET(0x1ACFA220)
#define UNITYENGINE_PHYSICS_GETIGNORELAYERCOLLISION_OFFSET UNITYSDK_OFFSET(0x1ACFA040)
#define UNITYENGINE_PHYSICS_GET_DEFAULTPHYSICSSCENE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACF9FB0)
#define UNITYENGINE_PHYSICS_GET_DEFAULTPHYSICSSCENE_OFFSET UNITYSDK_OFFSET(0x1ACF9F40)
#define UNITYENGINE_PHYSICS_GET_FIXEDFRAMECOUNTER_OFFSET UNITYSDK_OFFSET(0x1AD00F60)
#define UNITYENGINE_PHYSICS_GET_GRAVITY_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACF9ED0)
#define UNITYENGINE_PHYSICS_GET_GRAVITY_OFFSET UNITYSDK_OFFSET(0x1ACF9E60)
#define UNITYENGINE_PHYSICS_GET_INTERPOLATEPHYSICSANIMATORSNAPTOFRAMERATE_OFFSET UNITYSDK_OFFSET(0x1ACF9F00)
#define UNITYENGINE_PHYSICS_GET_INTERPOLATEPHYSICSANIMATOR_OFFSET UNITYSDK_OFFSET(0x1ACF9EE0)
#define UNITYENGINE_PHYSICS_GET_PHYSICSSTEPFRAMESKIP_OFFSET UNITYSDK_OFFSET(0x1AD00F00)
#define UNITYENGINE_PHYSICS_GET_SKIPINTERPOLATEPASSIFALREADYEVALUATEDINFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1ACF9F20)
#define UNITYENGINE_PHYSICS_IGNORECOLLISION_1_OFFSET UNITYSDK_OFFSET(0x1ACF9FD0)
#define UNITYENGINE_PHYSICS_IGNORECOLLISION_OFFSET UNITYSDK_OFFSET(0x1ACF9FC0)
#define UNITYENGINE_PHYSICS_INTERNAL_RAYCASTALL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1ACFE4D0)
#define UNITYENGINE_PHYSICS_INTERNAL_RAYCASTALL_OFFSET UNITYSDK_OFFSET(0x1ACFE420)
#define UNITYENGINE_PHYSICS_INVOKEBEFOREPHYSICSFIXEDUPDATECALLBACK_OFFSET UNITYSDK_OFFSET(0x1ACF9DE0)
#define UNITYENGINE_PHYSICS_INVOKEEARLYUPDATEBEFOREPHYSICSRESETINTERPOLATIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AD03160)
#define UNITYENGINE_PHYSICS_LINECAST_1_OFFSET UNITYSDK_OFFSET(0x1ACFCEC0)
#define UNITYENGINE_PHYSICS_LINECAST_2_OFFSET UNITYSDK_OFFSET(0x1ACFCF70)
#define UNITYENGINE_PHYSICS_LINECAST_3_OFFSET UNITYSDK_OFFSET(0x1ACFD210)
#define UNITYENGINE_PHYSICS_LINECAST_4_OFFSET UNITYSDK_OFFSET(0x1ACFD2E0)
#define UNITYENGINE_PHYSICS_LINECAST_OFFSET UNITYSDK_OFFSET(0x1ACFCC20)
#define UNITYENGINE_PHYSICS_MARKCOLLISIONSDIRTYWITHLAYER_OFFSET UNITYSDK_OFFSET(0x1ACFA070)
#define UNITYENGINE_PHYSICS_NAMETOTAG_OFFSET UNITYSDK_OFFSET(0x1AD03140)
#define UNITYENGINE_PHYSICS_ONSCENECONTACTMODIFY_OFFSET UNITYSDK_OFFSET(0x1ACF9CA0)
#define UNITYENGINE_PHYSICS_OVERLAPBOXNONALLOC_1_OFFSET UNITYSDK_OFFSET(0x1AD026F0)
#define UNITYENGINE_PHYSICS_OVERLAPBOXNONALLOC_OFFSET UNITYSDK_OFFSET(0x1AD024E0)
#define UNITYENGINE_PHYSICS_OVERLAPCAPSULENONALLOC_1_OFFSET UNITYSDK_OFFSET(0x1AD03050)
#define UNITYENGINE_PHYSICS_OVERLAPCAPSULENONALLOC_OFFSET UNITYSDK_OFFSET(0x1AD02E60)
#define UNITYENGINE_PHYSICS_OVERLAPSPHERENONALLOC_1_OFFSET UNITYSDK_OFFSET(0x1AD015B0)
#define UNITYENGINE_PHYSICS_OVERLAPSPHERENONALLOC_OFFSET UNITYSDK_OFFSET(0x1AD01400)
#define UNITYENGINE_PHYSICS_OVERLAPSPHERE_1_OFFSET UNITYSDK_OFFSET(0x1AD00D60)
#define UNITYENGINE_PHYSICS_OVERLAPSPHERE_2_OFFSET UNITYSDK_OFFSET(0x1AD00E00)
#define UNITYENGINE_PHYSICS_OVERLAPSPHERE_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD00BD0)
#define UNITYENGINE_PHYSICS_OVERLAPSPHERE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD00B30)
#define UNITYENGINE_PHYSICS_OVERLAPSPHERE_OFFSET UNITYSDK_OFFSET(0x1AD00BE0)
#define UNITYENGINE_PHYSICS_QUERY_CLOSESTPOINT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD01270)
#define UNITYENGINE_PHYSICS_QUERY_CLOSESTPOINT_OFFSET UNITYSDK_OFFSET(0x1AD011D0)
#define UNITYENGINE_PHYSICS_QUERY_COMPUTEPENETRATION_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD01000)
#define UNITYENGINE_PHYSICS_QUERY_COMPUTEPENETRATION_OFFSET UNITYSDK_OFFSET(0x1AD00F80)
#define UNITYENGINE_PHYSICS_QUERY_SPHERECASTALL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD00770)
#define UNITYENGINE_PHYSICS_QUERY_SPHERECASTALL_OFFSET UNITYSDK_OFFSET(0x1AD006A0)
#define UNITYENGINE_PHYSICS_RAYCASTALL_1_OFFSET UNITYSDK_OFFSET(0x1ACFE7A0)
#define UNITYENGINE_PHYSICS_RAYCASTALL_2_OFFSET UNITYSDK_OFFSET(0x1ACFEA70)
#define UNITYENGINE_PHYSICS_RAYCASTALL_3_OFFSET UNITYSDK_OFFSET(0x1ACFEB50)
#define UNITYENGINE_PHYSICS_RAYCASTALL_4_OFFSET UNITYSDK_OFFSET(0x1ACFEC30)
#define UNITYENGINE_PHYSICS_RAYCASTALL_5_OFFSET UNITYSDK_OFFSET(0x1ACFECF0)
#define UNITYENGINE_PHYSICS_RAYCASTALL_6_OFFSET UNITYSDK_OFFSET(0x1ACFEDE0)
#define UNITYENGINE_PHYSICS_RAYCASTALL_7_OFFSET UNITYSDK_OFFSET(0x1ACFEEB0)
#define UNITYENGINE_PHYSICS_RAYCASTALL_8_OFFSET UNITYSDK_OFFSET(0x1ACFEF80)
#define UNITYENGINE_PHYSICS_RAYCASTALL_OFFSET UNITYSDK_OFFSET(0x1ACFE4E0)
#define UNITYENGINE_PHYSICS_RAYCASTNONALLOC_1_OFFSET UNITYSDK_OFFSET(0x1ACFF4B0)
#define UNITYENGINE_PHYSICS_RAYCASTNONALLOC_2_OFFSET UNITYSDK_OFFSET(0x1ACFF740)
#define UNITYENGINE_PHYSICS_RAYCASTNONALLOC_3_OFFSET UNITYSDK_OFFSET(0x1ACFF9D0)
#define UNITYENGINE_PHYSICS_RAYCASTNONALLOC_4_OFFSET UNITYSDK_OFFSET(0x1ACFFC50)
#define UNITYENGINE_PHYSICS_RAYCASTNONALLOC_5_OFFSET UNITYSDK_OFFSET(0x1ACFFEF0)
#define UNITYENGINE_PHYSICS_RAYCASTNONALLOC_6_OFFSET UNITYSDK_OFFSET(0x1AD00190)
#define UNITYENGINE_PHYSICS_RAYCASTNONALLOC_7_OFFSET UNITYSDK_OFFSET(0x1AD00420)
#define UNITYENGINE_PHYSICS_RAYCASTNONALLOC_OFFSET UNITYSDK_OFFSET(0x1ACFF050)
#define UNITYENGINE_PHYSICS_RAYCAST_10_OFFSET UNITYSDK_OFFSET(0x1ACFBBD0)
#define UNITYENGINE_PHYSICS_RAYCAST_11_OFFSET UNITYSDK_OFFSET(0x1ACFBE10)
#define UNITYENGINE_PHYSICS_RAYCAST_12_OFFSET UNITYSDK_OFFSET(0x1ACFC030)
#define UNITYENGINE_PHYSICS_RAYCAST_13_OFFSET UNITYSDK_OFFSET(0x1ACFC250)
#define UNITYENGINE_PHYSICS_RAYCAST_14_OFFSET UNITYSDK_OFFSET(0x1ACFC460)
#define UNITYENGINE_PHYSICS_RAYCAST_15_OFFSET UNITYSDK_OFFSET(0x1ACFC6B0)
#define UNITYENGINE_PHYSICS_RAYCAST_16_OFFSET UNITYSDK_OFFSET(0x1ACFC790)
#define UNITYENGINE_PHYSICS_RAYCAST_17_OFFSET UNITYSDK_OFFSET(0x1ACFC9E0)
#define UNITYENGINE_PHYSICS_RAYCAST_1_OFFSET UNITYSDK_OFFSET(0x1ACFA5D0)
#define UNITYENGINE_PHYSICS_RAYCAST_2_OFFSET UNITYSDK_OFFSET(0x1ACFA7F0)
#define UNITYENGINE_PHYSICS_RAYCAST_3_OFFSET UNITYSDK_OFFSET(0x1ACFAA10)
#define UNITYENGINE_PHYSICS_RAYCAST_4_OFFSET UNITYSDK_OFFSET(0x1ACFAC20)
#define UNITYENGINE_PHYSICS_RAYCAST_5_OFFSET UNITYSDK_OFFSET(0x1ACFB020)
#define UNITYENGINE_PHYSICS_RAYCAST_6_OFFSET UNITYSDK_OFFSET(0x1ACFB280)
#define UNITYENGINE_PHYSICS_RAYCAST_7_OFFSET UNITYSDK_OFFSET(0x1ACFB4E0)
#define UNITYENGINE_PHYSICS_RAYCAST_8_OFFSET UNITYSDK_OFFSET(0x1ACFB740)
#define UNITYENGINE_PHYSICS_RAYCAST_9_OFFSET UNITYSDK_OFFSET(0x1ACFB990)
#define UNITYENGINE_PHYSICS_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1ACFA230)
#define UNITYENGINE_PHYSICS_SETLOCKSCENE_INTERNAL_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AD00EF0)
#define UNITYENGINE_PHYSICS_SETLOCKSCENE_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD00E90)
#define UNITYENGINE_PHYSICS_SETPHYSICSTHREADINGMODE_OFFSET UNITYSDK_OFFSET(0x1ACFA210)
#define UNITYENGINE_PHYSICS_SET_DETAILEDINTERPOLATIONFORFRAMESKIP_OFFSET UNITYSDK_OFFSET(0x1AD00F30)
#define UNITYENGINE_PHYSICS_SET_ENABLEMOVESMOOTHINTERPOLATION_OFFSET UNITYSDK_OFFSET(0x1AD00F40)
#define UNITYENGINE_PHYSICS_SET_EVENOUTVELOCITYFORFRAMESKIP_OFFSET UNITYSDK_OFFSET(0x1AD00F20)
#define UNITYENGINE_PHYSICS_SET_INTERPOLATEPHYSICSANIMATORSNAPTOFRAMERATE_OFFSET UNITYSDK_OFFSET(0x1ACF9F10)
#define UNITYENGINE_PHYSICS_SET_INTERPOLATEPHYSICSANIMATOR_OFFSET UNITYSDK_OFFSET(0x1ACF9EF0)
#define UNITYENGINE_PHYSICS_SET_INTERPOLATIONOFFSETFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1AD00F50)
#define UNITYENGINE_PHYSICS_SET_PHYSICSSTEPFRAMESKIP_OFFSET UNITYSDK_OFFSET(0x1AD00F10)
#define UNITYENGINE_PHYSICS_SET_SKIPINTERPOLATEPASSIFALREADYEVALUATEDINFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1ACF9F30)
#define UNITYENGINE_PHYSICS_SPHERECASTALL_1_OFFSET UNITYSDK_OFFSET(0x1AD00A20)
#define UNITYENGINE_PHYSICS_SPHERECASTALL_OFFSET UNITYSDK_OFFSET(0x1AD00780)
#define UNITYENGINE_PHYSICS_SPHERECASTNONALLOC_1_OFFSET UNITYSDK_OFFSET(0x1AD02130)
#define UNITYENGINE_PHYSICS_SPHERECASTNONALLOC_2_OFFSET UNITYSDK_OFFSET(0x1AD02240)
#define UNITYENGINE_PHYSICS_SPHERECASTNONALLOC_3_OFFSET UNITYSDK_OFFSET(0x1AD02370)
#define UNITYENGINE_PHYSICS_SPHERECASTNONALLOC_OFFSET UNITYSDK_OFFSET(0x1AD01E10)
#define UNITYENGINE_PHYSICS_SPHERECAST_1_OFFSET UNITYSDK_OFFSET(0x1ACFDCA0)
#define UNITYENGINE_PHYSICS_SPHERECAST_2_OFFSET UNITYSDK_OFFSET(0x1ACFDDC0)
#define UNITYENGINE_PHYSICS_SPHERECAST_3_OFFSET UNITYSDK_OFFSET(0x1ACFDED0)
#define UNITYENGINE_PHYSICS_SPHERECAST_OFFSET UNITYSDK_OFFSET(0x1ACFD920)
#define UNITYENGINE_PHYSICS_SYNCTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AD00F70)
#define UNITYENGINE_PHYSICS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ACF9D60)
#define UNITYENGINE_PHYSICS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD031E0)
...
namespace UnityEngine
{
	...
	public:
		...
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(Physics_TypeDefinitionIndex)->GetStaticField(0x6630);
		}
		...
		{
			return (::System::Action_2<::UnityEngine::PhysicsScene, ::Unity::Collections::NativeArray_1<::UnityEngine::ModifiableContactPair>>**)Il2CppClass::FromTypeDefinitionIndex(Physics_TypeDefinitionIndex)->GetStaticField(0x6638);
		}
