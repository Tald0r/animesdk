...
#define UNITYENGINE_TEXTURE3D_APPLYIMPL_OFFSET UNITYSDK_OFFSET(0x197D9880)
#define UNITYENGINE_TEXTURE3D_APPLY_1_OFFSET UNITYSDK_OFFSET(0x197D9D20)
#define UNITYENGINE_TEXTURE3D_APPLY_2_OFFSET UNITYSDK_OFFSET(0x197D9DA0)
#define UNITYENGINE_TEXTURE3D_APPLY_OFFSET UNITYSDK_OFFSET(0x197D9CA0)
#define UNITYENGINE_TEXTURE3D_GETPIXELBILINEARIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x197D97B0)
#define UNITYENGINE_TEXTURE3D_GETPIXELBILINEARIMPL_OFFSET UNITYSDK_OFFSET(0x197D9760)
#define UNITYENGINE_TEXTURE3D_GETPIXELBILINEAR_1_OFFSET UNITYSDK_OFFSET(0x197DA170)
#define UNITYENGINE_TEXTURE3D_GETPIXELBILINEAR_OFFSET UNITYSDK_OFFSET(0x197DA0B0)
#define UNITYENGINE_TEXTURE3D_GETPIXELIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x197D9750)
#define UNITYENGINE_TEXTURE3D_GETPIXELIMPL_OFFSET UNITYSDK_OFFSET(0x197D9700)
#define UNITYENGINE_TEXTURE3D_GETPIXELS32_1_OFFSET UNITYSDK_OFFSET(0x197D98C0)
#define UNITYENGINE_TEXTURE3D_GETPIXELS32_OFFSET UNITYSDK_OFFSET(0x197D98B0)
#define UNITYENGINE_TEXTURE3D_GETPIXELS_1_OFFSET UNITYSDK_OFFSET(0x197D98A0)
#define UNITYENGINE_TEXTURE3D_GETPIXELS_OFFSET UNITYSDK_OFFSET(0x197D9890)
#define UNITYENGINE_TEXTURE3D_GETPIXEL_1_OFFSET UNITYSDK_OFFSET(0x197DA000)
#define UNITYENGINE_TEXTURE3D_GETPIXEL_OFFSET UNITYSDK_OFFSET(0x197D9F50)
#define UNITYENGINE_TEXTURE3D_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x197D96B0)
#define UNITYENGINE_TEXTURE3D_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x197D96C0)
#define UNITYENGINE_TEXTURE3D_GET_ISREADABLE_OFFSET UNITYSDK_OFFSET(0x197D96D0)
#define UNITYENGINE_TEXTURE3D_INTERNAL_CREATEIMPL_OFFSET UNITYSDK_OFFSET(0x197D97C0)
#define UNITYENGINE_TEXTURE3D_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x197D97D0)
#define UNITYENGINE_TEXTURE3D_SETPIXELDATAIMPLARRAY_OFFSET UNITYSDK_OFFSET(0x197D9910)
#define UNITYENGINE_TEXTURE3D_SETPIXELDATAIMPL_OFFSET UNITYSDK_OFFSET(0x197D9920)
#define UNITYENGINE_TEXTURE3D_SETPIXELIMPL_INJECTED_OFFSET UNITYSDK_OFFSET(0x197D96F0)
#define UNITYENGINE_TEXTURE3D_SETPIXELIMPL_OFFSET UNITYSDK_OFFSET(0x197D96E0)
#define UNITYENGINE_TEXTURE3D_SETPIXELS32_1_OFFSET UNITYSDK_OFFSET(0x197D9900)
#define UNITYENGINE_TEXTURE3D_SETPIXELS32_OFFSET UNITYSDK_OFFSET(0x197D98F0)
#define UNITYENGINE_TEXTURE3D_SETPIXELS_1_OFFSET UNITYSDK_OFFSET(0x197D98E0)
#define UNITYENGINE_TEXTURE3D_SETPIXELS_OFFSET UNITYSDK_OFFSET(0x197D98D0)
#define UNITYENGINE_TEXTURE3D_SETPIXEL_1_OFFSET UNITYSDK_OFFSET(0x197D9EB0)
#define UNITYENGINE_TEXTURE3D_SETPIXEL_OFFSET UNITYSDK_OFFSET(0x197D9E10)
#define UNITYENGINE_TEXTURE3D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x197D99B0)
#define UNITYENGINE_TEXTURE3D__CTOR_2_OFFSET UNITYSDK_OFFSET(0x197D9A20)
#define UNITYENGINE_TEXTURE3D__CTOR_3_OFFSET UNITYSDK_OFFSET(0x197D9B20)
#define UNITYENGINE_TEXTURE3D__CTOR_4_OFFSET UNITYSDK_OFFSET(0x197D9C60)
#define UNITYENGINE_TEXTURE3D__CTOR_OFFSET UNITYSDK_OFFSET(0x197D9930)

namespace UnityEngine
{
	inline static constexpr unsigned int Texture3D_TypeDefinitionIndex = 5271;
