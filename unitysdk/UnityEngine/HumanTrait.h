...
#define UNITYENGINE_HUMANTRAIT_GETBONEINDEXFROMMONO_OFFSET UNITYSDK_OFFSET(0x1B768CF0)
#define UNITYENGINE_HUMANTRAIT_GET_MUSCLECOUNT_OFFSET UNITYSDK_OFFSET(0x1B768CE0)
#define UNITYENGINE_HUMANTRAIT_GET_MUSCLENAME_OFFSET UNITYSDK_OFFSET(0x1B768D00)
#define UNITYENGINE_HUMANTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B768D10)
