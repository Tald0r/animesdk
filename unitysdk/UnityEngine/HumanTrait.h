...
#define UNITYENGINE_HUMANTRAIT_GETBONEINDEXFROMMONO_OFFSET UNITYSDK_OFFSET(0x1B14ACA0)
#define UNITYENGINE_HUMANTRAIT_GET_MUSCLECOUNT_OFFSET UNITYSDK_OFFSET(0x1B14AC90)
#define UNITYENGINE_HUMANTRAIT_GET_MUSCLENAME_OFFSET UNITYSDK_OFFSET(0x1B14ACB0)
#define UNITYENGINE_HUMANTRAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14ACC0)

namespace UnityEngine
{
	inline static constexpr unsigned int HumanTrait_TypeDefinitionIndex = 6558;
