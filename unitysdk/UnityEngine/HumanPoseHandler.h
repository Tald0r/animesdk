...
#define UNITYENGINE_HUMANPOSEHANDLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B6235E0)
#define UNITYENGINE_HUMANPOSEHANDLER_GETHUMANPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B623860)
#define UNITYENGINE_HUMANPOSEHANDLER_GETHUMANPOSE_OFFSET UNITYSDK_OFFSET(0x1B6235D0)
#define UNITYENGINE_HUMANPOSEHANDLER_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B6235B0)
#define UNITYENGINE_HUMANPOSEHANDLER_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B6235C0)
#define UNITYENGINE_HUMANPOSEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B623640)
