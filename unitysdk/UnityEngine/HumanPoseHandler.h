...
#define UNITYENGINE_HUMANPOSEHANDLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B0151B0)
#define UNITYENGINE_HUMANPOSEHANDLER_GETHUMANPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B015430)
#define UNITYENGINE_HUMANPOSEHANDLER_GETHUMANPOSE_OFFSET UNITYSDK_OFFSET(0x1B0151A0)
#define UNITYENGINE_HUMANPOSEHANDLER_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B015180)
#define UNITYENGINE_HUMANPOSEHANDLER_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B015190)
#define UNITYENGINE_HUMANPOSEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B015210)

namespace UnityEngine
{
	inline static constexpr unsigned int HumanPoseHandler_TypeDefinitionIndex = 6557;
