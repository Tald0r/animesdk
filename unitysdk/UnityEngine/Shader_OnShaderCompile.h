...
#define UNITYENGINE_SHADER_ONSHADERCOMPILE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C47870)
#define UNITYENGINE_SHADER_ONSHADERCOMPILE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C478A0)
#define UNITYENGINE_SHADER_ONSHADERCOMPILE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C47370)
#define UNITYENGINE_SHADER_ONSHADERCOMPILE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C47350)
