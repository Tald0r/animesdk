...
#define UNITYENGINE_LOGGER_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1A52DCE0)
#define UNITYENGINE_LOGGER_GET_FILTERLOGTYPE_OFFSET UNITYSDK_OFFSET(0x1A52DC90)
#define UNITYENGINE_LOGGER_GET_LOGENABLED_OFFSET UNITYSDK_OFFSET(0x1A52DC70)
#define UNITYENGINE_LOGGER_GET_LOGHANDLER_OFFSET UNITYSDK_OFFSET(0x1A52DC50)
#define UNITYENGINE_LOGGER_ISLOGTYPEALLOWED_OFFSET UNITYSDK_OFFSET(0x1A52DCB0)
#define UNITYENGINE_LOGGER_LOGERROR_OFFSET UNITYSDK_OFFSET(0x1A52E360)
#define UNITYENGINE_LOGGER_LOGEXCEPTION_1_OFFSET UNITYSDK_OFFSET(0x1A52E650)
#define UNITYENGINE_LOGGER_LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A52E580)
#define UNITYENGINE_LOGGER_LOGFORMAT_1_OFFSET UNITYSDK_OFFSET(0x1A52E810)
#define UNITYENGINE_LOGGER_LOGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A52E720)
#define UNITYENGINE_LOGGER_LOG_1_OFFSET UNITYSDK_OFFSET(0x1A52DF70)
#define UNITYENGINE_LOGGER_LOG_2_OFFSET UNITYSDK_OFFSET(0x1A52E110)
#define UNITYENGINE_LOGGER_LOG_OFFSET UNITYSDK_OFFSET(0x1A52DDE0)
#define UNITYENGINE_LOGGER_SET_FILTERLOGTYPE_OFFSET UNITYSDK_OFFSET(0x1A52DCA0)
#define UNITYENGINE_LOGGER_SET_LOGENABLED_OFFSET UNITYSDK_OFFSET(0x1A52DC80)
#define UNITYENGINE_LOGGER_SET_LOGHANDLER_OFFSET UNITYSDK_OFFSET(0x1A52DC60)
#define UNITYENGINE_LOGGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A52DC40)
#define UNITYENGINE_LOGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A52DC30)
