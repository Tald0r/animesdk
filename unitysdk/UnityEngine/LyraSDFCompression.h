...
#define UNITYENGINE_LYRASDFCOMPRESSION_DECOMPRESSBLOCKS_OFFSET UNITYSDK_OFFSET(0x1A4026A0)
#define UNITYENGINE_LYRASDFCOMPRESSION_DECOMPRESSBLOCSKWITHCHECK_OFFSET UNITYSDK_OFFSET(0x1A4026B0)
#define UNITYENGINE_LYRASDFCOMPRESSION_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A402690)
