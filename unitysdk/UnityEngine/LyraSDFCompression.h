...
#define UNITYENGINE_LYRASDFCOMPRESSION_DECOMPRESSBLOCKS_OFFSET UNITYSDK_OFFSET(0x19E39940)
#define UNITYENGINE_LYRASDFCOMPRESSION_DECOMPRESSBLOCSKWITHCHECK_OFFSET UNITYSDK_OFFSET(0x19E39950)
#define UNITYENGINE_LYRASDFCOMPRESSION_PREPARE_OFFSET UNITYSDK_OFFSET(0x19E39930)

namespace UnityEngine
{
	inline static constexpr unsigned int LyraSDFCompression_TypeDefinitionIndex = 5403;
