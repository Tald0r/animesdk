...
#define UNITYENGINE_PING_DESTROYPING_OFFSET UNITYSDK_OFFSET(0x19EA6BE0)
#define UNITYENGINE_PING_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19EA6B60)
#define UNITYENGINE_PING_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x19EA6C20)
#define UNITYENGINE_PING_GET_TIME_OFFSET UNITYSDK_OFFSET(0x19EA6C50)
#define UNITYENGINE_PING_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x19EA6B50)
#define UNITYENGINE_PING_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x19EA6C10)
#define UNITYENGINE_PING_INTERNAL_ISDONE_OFFSET UNITYSDK_OFFSET(0x19EA6C40)
#define UNITYENGINE_PING__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA6B30)
