...
#define UNITYENGINE_PING_DESTROYPING_OFFSET UNITYSDK_OFFSET(0x19966DA0)
#define UNITYENGINE_PING_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19966D20)
#define UNITYENGINE_PING_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x19966DE0)
#define UNITYENGINE_PING_GET_TIME_OFFSET UNITYSDK_OFFSET(0x19966E10)
#define UNITYENGINE_PING_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x19966D10)
#define UNITYENGINE_PING_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x19966DD0)
#define UNITYENGINE_PING_INTERNAL_ISDONE_OFFSET UNITYSDK_OFFSET(0x19966E00)
#define UNITYENGINE_PING__CTOR_OFFSET UNITYSDK_OFFSET(0x19966CF0)

namespace UnityEngine
{
	inline static constexpr unsigned int Ping_TypeDefinitionIndex = 5306;
