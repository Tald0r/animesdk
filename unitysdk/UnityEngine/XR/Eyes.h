...
#define UNITYENGINE_XR_EYES_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x978290)
#define UNITYENGINE_XR_EYES_EQUALS_OFFSET UNITYSDK_OFFSET(0x9782D0)
#define UNITYENGINE_XR_EYES_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9782B0)
#define UNITYENGINE_XR_EYES_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_XR_EYES_GET_FEATUREINDEX_OFFSET UNITYSDK_OFFSET(0x2C6230)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int Eyes_TypeDefinitionIndex = 23963;
