...
#define UNITYENGINE_XR_EYES_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9AB7F0)
#define UNITYENGINE_XR_EYES_EQUALS_OFFSET UNITYSDK_OFFSET(0x9AB830)
#define UNITYENGINE_XR_EYES_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9AB810)
#define UNITYENGINE_XR_EYES_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_XR_EYES_GET_FEATUREINDEX_OFFSET UNITYSDK_OFFSET(0x2EC6E0)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int Eyes_TypeDefinitionIndex = 24646;
