...
#define UNITYENGINE_XR_HASHCODEHELPER_COMBINE_OFFSET UNITYSDK_OFFSET(0x1B698900)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int HashCodeHelper_TypeDefinitionIndex = 24657;
