...
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x19F6DEF0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_BATTERYLEVEL_OFFSET UNITYSDK_OFFSET(0x19F6DE50)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x19F6DE30)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x19F6DE10)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x19F6DD30)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_GRIP_OFFSET UNITYSDK_OFFSET(0x19F6DD10)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_JOYSTICKCLICKED_OFFSET UNITYSDK_OFFSET(0x19F6DDB0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_JOYSTICK_OFFSET UNITYSDK_OFFSET(0x19F6DCD0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_MENU_OFFSET UNITYSDK_OFFSET(0x19F6DD50)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_POINTERPOSITION_OFFSET UNITYSDK_OFFSET(0x19F6DEB0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_POINTERROTATION_OFFSET UNITYSDK_OFFSET(0x19F6DED0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_SOURCELOSSMITIGATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x19F6DE90)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_SOURCELOSSRISK_OFFSET UNITYSDK_OFFSET(0x19F6DE70)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_TOUCHPADCLICKED_OFFSET UNITYSDK_OFFSET(0x19F6DDD0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_TOUCHPADTOUCHED_OFFSET UNITYSDK_OFFSET(0x19F6DDF0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_TOUCHPAD_OFFSET UNITYSDK_OFFSET(0x19F6DCF0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x19F6DD90)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x19F6DD70)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_BATTERYLEVEL_OFFSET UNITYSDK_OFFSET(0x19F6DE60)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x19F6DE40)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x19F6DE20)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x19F6DD40)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_GRIP_OFFSET UNITYSDK_OFFSET(0x19F6DD20)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_JOYSTICKCLICKED_OFFSET UNITYSDK_OFFSET(0x19F6DDC0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_JOYSTICK_OFFSET UNITYSDK_OFFSET(0x19F6DCE0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_MENU_OFFSET UNITYSDK_OFFSET(0x19F6DD60)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_POINTERPOSITION_OFFSET UNITYSDK_OFFSET(0x19F6DEC0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_POINTERROTATION_OFFSET UNITYSDK_OFFSET(0x19F6DEE0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_SOURCELOSSMITIGATIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x19F6DEA0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_SOURCELOSSRISK_OFFSET UNITYSDK_OFFSET(0x19F6DE80)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_TOUCHPADCLICKED_OFFSET UNITYSDK_OFFSET(0x19F6DDE0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_TOUCHPADTOUCHED_OFFSET UNITYSDK_OFFSET(0x19F6DE00)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_TOUCHPAD_OFFSET UNITYSDK_OFFSET(0x19F6DD00)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x19F6DDA0)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x19F6DD80)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRSPATIALCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6E120)

namespace UnityEngine::XR::WindowsMR::Input
{
	inline static constexpr unsigned int WMRSpatialController_TypeDefinitionIndex = 27406;
	...
	public:
		...
		::UnityEngine::InputSystem::Controls::ButtonControl* _menu_k__BackingField; // 0x190
		...
		::UnityEngine::InputSystem::Controls::ButtonControl* _joystickClicked_k__BackingField; // 0x1B0
		::UnityEngine::InputSystem::Controls::AxisControl* _grip_k__BackingField; // 0x1B8
		::UnityEngine::InputSystem::Controls::Vector3Control* _sourceLossMitigationDirection_k__BackingField; // 0x1C0
		...
		::UnityEngine::InputSystem::Controls::Vector3Control* _pointerPosition_k__BackingField; // 0x1E0
		::UnityEngine::InputSystem::Controls::QuaternionControl* _pointerRotation_k__BackingField; // 0x1E8
		::UnityEngine::InputSystem::Controls::Vector2Control* _joystick_k__BackingField; // 0x1F0
