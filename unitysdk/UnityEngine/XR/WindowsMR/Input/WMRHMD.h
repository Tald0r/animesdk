...
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRHMD_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1A101C50)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRHMD_GET_USERPRESENCE_OFFSET UNITYSDK_OFFSET(0x1A101C30)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRHMD_SET_USERPRESENCE_OFFSET UNITYSDK_OFFSET(0x1A101C40)
#define UNITYENGINE_XR_WINDOWSMR_INPUT_WMRHMD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A101CA0)

namespace UnityEngine::XR::WindowsMR::Input
{
	inline static constexpr unsigned int WMRHMD_TypeDefinitionIndex = 27404;
