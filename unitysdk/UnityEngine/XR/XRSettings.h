...
#define UNITYENGINE_XR_XRSETTINGS_GET_DEVICEEYETEXTUREDIMENSION_OFFSET UNITYSDK_OFFSET(0x1B767BB0)
#define UNITYENGINE_XR_XRSETTINGS_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1B767AE0)
#define UNITYENGINE_XR_XRSETTINGS_GET_EYETEXTUREDESC_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B767BA0)
#define UNITYENGINE_XR_XRSETTINGS_GET_EYETEXTUREDESC_OFFSET UNITYSDK_OFFSET(0x1B767B40)
#define UNITYENGINE_XR_XRSETTINGS_GET_EYETEXTUREHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B767B30)
#define UNITYENGINE_XR_XRSETTINGS_GET_EYETEXTURERESOLUTIONSCALE_OFFSET UNITYSDK_OFFSET(0x1B767B00)
#define UNITYENGINE_XR_XRSETTINGS_GET_EYETEXTUREWIDTH_OFFSET UNITYSDK_OFFSET(0x1B767B20)
#define UNITYENGINE_XR_XRSETTINGS_GET_ISDEVICEACTIVE_OFFSET UNITYSDK_OFFSET(0x1B767AF0)
#define UNITYENGINE_XR_XRSETTINGS_GET_LOADEDDEVICENAME_OFFSET UNITYSDK_OFFSET(0x1B767BE0)
#define UNITYENGINE_XR_XRSETTINGS_GET_RENDERVIEWPORTSCALEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B767BD0)
#define UNITYENGINE_XR_XRSETTINGS_GET_RENDERVIEWPORTSCALE_OFFSET UNITYSDK_OFFSET(0x1B767BC0)
#define UNITYENGINE_XR_XRSETTINGS_GET_STEREORENDERINGMODE_OFFSET UNITYSDK_OFFSET(0x1B767C00)
#define UNITYENGINE_XR_XRSETTINGS_GET_SUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1B767BF0)
#define UNITYENGINE_XR_XRSETTINGS_SET_EYETEXTURERESOLUTIONSCALE_OFFSET UNITYSDK_OFFSET(0x1B767B10)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int XRSettings_TypeDefinitionIndex = 8551;
