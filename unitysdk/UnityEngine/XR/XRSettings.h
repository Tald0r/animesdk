...
#define UNITYENGINE_XR_XRSETTINGS_GET_DEVICEEYETEXTUREDIMENSION_OFFSET UNITYSDK_OFFSET(0x1B149B70)
#define UNITYENGINE_XR_XRSETTINGS_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1B149AA0)
#define UNITYENGINE_XR_XRSETTINGS_GET_EYETEXTUREDESC_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B149B60)
#define UNITYENGINE_XR_XRSETTINGS_GET_EYETEXTUREDESC_OFFSET UNITYSDK_OFFSET(0x1B149B00)
#define UNITYENGINE_XR_XRSETTINGS_GET_EYETEXTUREHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B149AF0)
#define UNITYENGINE_XR_XRSETTINGS_GET_EYETEXTURERESOLUTIONSCALE_OFFSET UNITYSDK_OFFSET(0x1B149AC0)
#define UNITYENGINE_XR_XRSETTINGS_GET_EYETEXTUREWIDTH_OFFSET UNITYSDK_OFFSET(0x1B149AE0)
#define UNITYENGINE_XR_XRSETTINGS_GET_ISDEVICEACTIVE_OFFSET UNITYSDK_OFFSET(0x1B149AB0)
#define UNITYENGINE_XR_XRSETTINGS_GET_LOADEDDEVICENAME_OFFSET UNITYSDK_OFFSET(0x1B149BA0)
#define UNITYENGINE_XR_XRSETTINGS_GET_RENDERVIEWPORTSCALEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B149B90)
#define UNITYENGINE_XR_XRSETTINGS_GET_RENDERVIEWPORTSCALE_OFFSET UNITYSDK_OFFSET(0x1B149B80)
#define UNITYENGINE_XR_XRSETTINGS_GET_STEREORENDERINGMODE_OFFSET UNITYSDK_OFFSET(0x1B149BC0)
#define UNITYENGINE_XR_XRSETTINGS_GET_SUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1B149BB0)
#define UNITYENGINE_XR_XRSETTINGS_SET_EYETEXTURERESOLUTIONSCALE_OFFSET UNITYSDK_OFFSET(0x1B149AD0)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int XRSettings_TypeDefinitionIndex = 8540;
