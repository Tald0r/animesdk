...
#define UNITYENGINE_XR_BONE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x978290)
#define UNITYENGINE_XR_BONE_EQUALS_OFFSET UNITYSDK_OFFSET(0x978230)
#define UNITYENGINE_XR_BONE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9782B0)
#define UNITYENGINE_XR_BONE_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_XR_BONE_GET_FEATUREINDEX_OFFSET UNITYSDK_OFFSET(0x2C6230)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int Bone_TypeDefinitionIndex = 23964;
