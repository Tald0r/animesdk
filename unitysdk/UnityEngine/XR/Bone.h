...
#define UNITYENGINE_XR_BONE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9AB7F0)
#define UNITYENGINE_XR_BONE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9AB790)
#define UNITYENGINE_XR_BONE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9AB810)
#define UNITYENGINE_XR_BONE_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_XR_BONE_GET_FEATUREINDEX_OFFSET UNITYSDK_OFFSET(0x2EC6E0)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int Bone_TypeDefinitionIndex = 24647;
