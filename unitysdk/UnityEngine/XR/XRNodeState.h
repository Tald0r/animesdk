...
#define UNITYENGINE_XR_XRNODESTATE_SET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x302300)
#define UNITYENGINE_XR_XRNODESTATE_SET_TRACKED_OFFSET UNITYSDK_OFFSET(0x9ABEC0)
#define UNITYENGINE_XR_XRNODESTATE_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x89D100)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int XRNodeState_TypeDefinitionIndex = 24638;
