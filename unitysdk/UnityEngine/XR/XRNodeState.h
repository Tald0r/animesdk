...
#define UNITYENGINE_XR_XRNODESTATE_SET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define UNITYENGINE_XR_XRNODESTATE_SET_TRACKED_OFFSET UNITYSDK_OFFSET(0x978960)
#define UNITYENGINE_XR_XRNODESTATE_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x8767C0)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int XRNodeState_TypeDefinitionIndex = 23955;
