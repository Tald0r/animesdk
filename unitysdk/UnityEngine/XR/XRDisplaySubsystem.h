...
#define UNITYENGINE_XR_XRDISPLAYSUBSYSTEM_INVOKEDISPLAYFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1B6992B0)
#define UNITYENGINE_XR_XRDISPLAYSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B699310)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int XRDisplaySubsystem_TypeDefinitionIndex = 24649;
	...
	public:
		...
		{
			return (::System::Action_1<::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(XRDisplaySubsystem_TypeDefinitionIndex)->GetStaticField(0x1DFC0);
		}
