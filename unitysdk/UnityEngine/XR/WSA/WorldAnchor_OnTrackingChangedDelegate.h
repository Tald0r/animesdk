...
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B767960)
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B7679C0)
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B767350)
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B767940)

namespace UnityEngine::XR::WSA
{
	inline static constexpr unsigned int WorldAnchor_OnTrackingChangedDelegate_TypeDefinitionIndex = 8555;
