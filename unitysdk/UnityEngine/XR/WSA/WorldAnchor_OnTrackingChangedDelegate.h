...
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B149920)
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B149980)
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B149320)
#define UNITYENGINE_XR_WSA_WORLDANCHOR_ONTRACKINGCHANGEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B149910)

namespace UnityEngine::XR::WSA
{
	inline static constexpr unsigned int WorldAnchor_OnTrackingChangedDelegate_TypeDefinitionIndex = 8544;
