...
#define UNITYENGINE_XR_MESHGENERATIONRESULT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9786B0)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_EQUALS_OFFSET UNITYSDK_OFFSET(0x978630)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9786F0)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x391490)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_GET_MESHCOLLIDER_OFFSET UNITYSDK_OFFSET(0x2C6220)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_GET_MESHID_OFFSET UNITYSDK_OFFSET(0x2CA610)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_GET_MESH_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x3840D0)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int MeshGenerationResult_TypeDefinitionIndex = 23975;
