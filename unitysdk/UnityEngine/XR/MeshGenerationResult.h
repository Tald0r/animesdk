...
#define UNITYENGINE_XR_MESHGENERATIONRESULT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9ABC10)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9ABB90)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9ABC50)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_GET_ATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x53B9F0)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_GET_MESHCOLLIDER_OFFSET UNITYSDK_OFFSET(0x302AC0)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_GET_MESHID_OFFSET UNITYSDK_OFFSET(0x2EC7C0)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_GET_MESH_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define UNITYENGINE_XR_MESHGENERATIONRESULT_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x4C0E40)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int MeshGenerationResult_TypeDefinitionIndex = 24658;
