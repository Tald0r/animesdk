...
#define UNITYENGINE_XR_INPUTFEATUREUSAGE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9ABA80)
#define UNITYENGINE_XR_INPUTFEATUREUSAGE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9ABA00)
#define UNITYENGINE_XR_INPUTFEATUREUSAGE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9ABAD0)
#define UNITYENGINE_XR_INPUTFEATUREUSAGE_GET_INTERNALTYPE_OFFSET UNITYSDK_OFFSET(0x2EC6E0)
#define UNITYENGINE_XR_INPUTFEATUREUSAGE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x223870)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int InputFeatureUsage_TypeDefinitionIndex = 24643;
