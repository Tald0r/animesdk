...
#define UNITYENGINE_XR_XRINPUTSUBSYSTEM_INVOKEBOUNDARYCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x1B699400)
#define UNITYENGINE_XR_XRINPUTSUBSYSTEM_INVOKETRACKINGORIGINUPDATEDEVENT_OFFSET UNITYSDK_OFFSET(0x1B699350)
#define UNITYENGINE_XR_XRINPUTSUBSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6994B0)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int XRInputSubsystem_TypeDefinitionIndex = 24653;
