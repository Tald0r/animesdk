...
#define UNITYENGINE_XR_INPUTDEVICE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9AB9A0)
#define UNITYENGINE_XR_INPUTDEVICE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9AB920)
#define UNITYENGINE_XR_INPUTDEVICE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9AB9D0)
#define UNITYENGINE_XR_INPUTDEVICE_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x9AB900)
#define UNITYENGINE_XR_INPUTDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x9AB8F0)

namespace UnityEngine::XR
{
	inline static constexpr unsigned int InputDevice_TypeDefinitionIndex = 24644;
