...
#define UNITYENGINE_CONTACTPOINT_GETCOLLIDERBYINSTANCEID_OFFSET UNITYSDK_OFFSET(0x1A755C00)
#define UNITYENGINE_CONTACTPOINT_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x2D0730)
#define UNITYENGINE_CONTACTPOINT_GET_OTHERCOLLIDER_OFFSET UNITYSDK_OFFSET(0x93C7B0)
#define UNITYENGINE_CONTACTPOINT_GET_POINT_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define UNITYENGINE_CONTACTPOINT_GET_SEPARATION_OFFSET UNITYSDK_OFFSET(0x3FA490)
#define UNITYENGINE_CONTACTPOINT_GET_THISCOLLIDER_OFFSET UNITYSDK_OFFSET(0x93C7A0)

namespace UnityEngine
{
	inline static constexpr unsigned int ContactPoint_TypeDefinitionIndex = 7668;
