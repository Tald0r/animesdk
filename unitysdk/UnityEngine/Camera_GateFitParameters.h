...
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_GET_ASPECT_OFFSET UNITYSDK_OFFSET(0x2C4B10)
#define UNITYENGINE_CAMERA_GATEFITPARAMETERS_GET_MODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
