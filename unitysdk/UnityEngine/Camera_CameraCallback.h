...
#define UNITYENGINE_CAMERA_CAMERACALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19F35400)
#define UNITYENGINE_CAMERA_CAMERACALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19F35430)
#define UNITYENGINE_CAMERA_CAMERACALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19F34F00)
#define UNITYENGINE_CAMERA_CAMERACALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19F34EF0)
