...
#define UNITYENGINE_TEXTMESH_GET_FONTSIZE_OFFSET UNITYSDK_OFFSET(0x1B039600)
#define UNITYENGINE_TEXTMESH_GET_FONT_OFFSET UNITYSDK_OFFSET(0x1B0395E0)
#define UNITYENGINE_TEXTMESH_SET_COLOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B039630)
#define UNITYENGINE_TEXTMESH_SET_COLOR_OFFSET UNITYSDK_OFFSET(0x1B039620)
#define UNITYENGINE_TEXTMESH_SET_FONTSIZE_OFFSET UNITYSDK_OFFSET(0x1B039610)
#define UNITYENGINE_TEXTMESH_SET_FONT_OFFSET UNITYSDK_OFFSET(0x1B0395F0)
#define UNITYENGINE_TEXTMESH_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x1B0395D0)
#define UNITYENGINE_TEXTMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B039640)

namespace UnityEngine
{
	inline static constexpr unsigned int TextMesh_TypeDefinitionIndex = 6337;
