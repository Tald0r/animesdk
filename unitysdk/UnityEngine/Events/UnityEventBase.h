...
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_ADDCALL_OFFSET UNITYSDK_OFFSET(0x1A4BA590)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1A4BA550)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_DIRTYPERSISTENTCALLS_OFFSET UNITYSDK_OFFSET(0x1A4B9980)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_FINDMETHOD_1_OFFSET UNITYSDK_OFFSET(0x1A4B9C60)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_FINDMETHOD_OFFSET UNITYSDK_OFFSET(0x1A4B99E0)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_GETPERSISTENTEVENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A4BA310)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_GETPERSISTENTMETHODNAME_OFFSET UNITYSDK_OFFSET(0x1A4BA3C0)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_GETPERSISTENTTARGET_OFFSET UNITYSDK_OFFSET(0x1A4BA340)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_GETVALIDMETHODINFO_OFFSET UNITYSDK_OFFSET(0x1A4BA070)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A4BA670)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_PREPAREINVOKE_OFFSET UNITYSDK_OFFSET(0x1A4BA620)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_REBUILDPERSISTENTCALLSIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1A4BA440)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_REMOVEALLLISTENERS_OFFSET UNITYSDK_OFFSET(0x1A4BA5D0)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1A4BA5B0)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_SETPERSISTENTLISTENERSTATE_OFFSET UNITYSDK_OFFSET(0x1A4BA480)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A4BA750)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A4B9920)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A4B9910)
#define UNITYENGINE_EVENTS_UNITYEVENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B9860)

namespace UnityEngine::Events
{
	inline static constexpr unsigned int UnityEventBase_TypeDefinitionIndex = 5490;
