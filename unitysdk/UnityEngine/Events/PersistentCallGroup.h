...
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_ADDLISTENER_1_OFFSET UNITYSDK_OFFSET(0x1A2FA110)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1A2FA090)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A2FA1F0)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_GETLISTENERS_OFFSET UNITYSDK_OFFSET(0x1A2FA080)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_GETLISTENER_OFFSET UNITYSDK_OFFSET(0x1A2FA020)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A2FA000)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A2FA9F0)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_REGISTERBOOLPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1A2FA5B0)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_REGISTEREVENTPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1A2FA230)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_REGISTERFLOATPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1A2FA470)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_REGISTERINTPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1A2FA3D0)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_REGISTEROBJECTPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1A2FA330)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_REGISTERSTRINGPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1A2FA510)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_REGISTERVOIDPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1A2FA2B0)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_REMOVELISTENERS_OFFSET UNITYSDK_OFFSET(0x1A2FA6D0)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1A2FA170)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP_UNREGISTERPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1A2FA650)
#define UNITYENGINE_EVENTS_PERSISTENTCALLGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2F9F80)
