...
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GETOBJECTCALL_OFFSET UNITYSDK_OFFSET(0x1A3E49A0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GETRUNTIMECALL_OFFSET UNITYSDK_OFFSET(0x1A3E4650)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1A3E45A0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_CALLSTATE_OFFSET UNITYSDK_OFFSET(0x1A3E45B0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_METHODNAME_OFFSET UNITYSDK_OFFSET(0x1A3E4570)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1A3E4580)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1A3E4560)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A3E45D0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_REGISTERPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1A3E5190)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_SET_CALLSTATE_OFFSET UNITYSDK_OFFSET(0x1A3E45C0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1A3E4590)
#define UNITYENGINE_EVENTS_PERSISTENTCALL_UNREGISTERPERSISTENTLISTENER_OFFSET UNITYSDK_OFFSET(0x1A3E51A0)
#define UNITYENGINE_EVENTS_PERSISTENTCALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E51C0)
