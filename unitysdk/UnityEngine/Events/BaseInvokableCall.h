...
#define UNITYENGINE_EVENTS_BASEINVOKABLECALL_ALLOWINVOKE_OFFSET UNITYSDK_OFFSET(0x1A19C260)
#define UNITYENGINE_EVENTS_BASEINVOKABLECALL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A19C1C0)
#define UNITYENGINE_EVENTS_BASEINVOKABLECALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A19C1B0)
