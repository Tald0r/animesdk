...
#define UNITYENGINE_EVENTS_BASEINVOKABLECALL_ALLOWINVOKE_OFFSET UNITYSDK_OFFSET(0x19BB7B50)
#define UNITYENGINE_EVENTS_BASEINVOKABLECALL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19BB7AB0)
#define UNITYENGINE_EVENTS_BASEINVOKABLECALL__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB7AA0)

namespace UnityEngine::Events
{
	inline static constexpr unsigned int BaseInvokableCall_TypeDefinitionIndex = 5479;
