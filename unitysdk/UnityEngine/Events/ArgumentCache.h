...
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_BOOLARGUMENT_OFFSET UNITYSDK_OFFSET(0x1994F810)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_FLOATARGUMENT_OFFSET UNITYSDK_OFFSET(0x1994F7D0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_INTARGUMENT_OFFSET UNITYSDK_OFFSET(0x1994F7B0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_STRINGARGUMENT_OFFSET UNITYSDK_OFFSET(0x1994F7F0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_UNITYOBJECTARGUMENTASSEMBLYTYPENAME_OFFSET UNITYSDK_OFFSET(0x1994F7A0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_UNITYOBJECTARGUMENT_OFFSET UNITYSDK_OFFSET(0x1994F6F0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1994F9B0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1994F9A0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_BOOLARGUMENT_OFFSET UNITYSDK_OFFSET(0x1994F820)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_FLOATARGUMENT_OFFSET UNITYSDK_OFFSET(0x1994F7E0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_INTARGUMENT_OFFSET UNITYSDK_OFFSET(0x1994F7C0)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_STRINGARGUMENT_OFFSET UNITYSDK_OFFSET(0x1994F800)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_UNITYOBJECTARGUMENT_OFFSET UNITYSDK_OFFSET(0x1994F700)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_TIDYASSEMBLYTYPENAME_OFFSET UNITYSDK_OFFSET(0x1994F830)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1994F9C0)

namespace UnityEngine::Events
{
	inline static constexpr unsigned int ArgumentCache_TypeDefinitionIndex = 5478;
