...
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_BOOLARGUMENT_OFFSET UNITYSDK_OFFSET(0x19E8F670)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_FLOATARGUMENT_OFFSET UNITYSDK_OFFSET(0x19E8F630)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_INTARGUMENT_OFFSET UNITYSDK_OFFSET(0x19E8F610)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_STRINGARGUMENT_OFFSET UNITYSDK_OFFSET(0x19E8F650)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_UNITYOBJECTARGUMENTASSEMBLYTYPENAME_OFFSET UNITYSDK_OFFSET(0x19E8F600)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_GET_UNITYOBJECTARGUMENT_OFFSET UNITYSDK_OFFSET(0x19E8F550)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19E8F810)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19E8F800)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_BOOLARGUMENT_OFFSET UNITYSDK_OFFSET(0x19E8F680)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_FLOATARGUMENT_OFFSET UNITYSDK_OFFSET(0x19E8F640)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_INTARGUMENT_OFFSET UNITYSDK_OFFSET(0x19E8F620)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_STRINGARGUMENT_OFFSET UNITYSDK_OFFSET(0x19E8F660)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_SET_UNITYOBJECTARGUMENT_OFFSET UNITYSDK_OFFSET(0x19E8F560)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE_TIDYASSEMBLYTYPENAME_OFFSET UNITYSDK_OFFSET(0x19E8F690)
#define UNITYENGINE_EVENTS_ARGUMENTCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E8F820)
