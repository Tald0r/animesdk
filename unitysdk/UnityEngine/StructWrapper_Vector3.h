...
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x91B460)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x91B460)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x91B400)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x91B480)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x91B460)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3_UNREALTYPES_ISTRUCT_UNITYENGINE_VECTOR3__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define UNITYENGINE_STRUCTWRAPPER_VECTOR3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2025C0)

namespace UnityEngine
{
	inline static constexpr unsigned int StructWrapper_Vector3_TypeDefinitionIndex = 24663;

	struct alignas(1) StructWrapper_Vector3
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StructWrapper_Vector3_TypeDefinitionIndex)->GetStaticField(0x1E050);
		}
