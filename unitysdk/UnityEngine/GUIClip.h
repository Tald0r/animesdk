...
#define UNITYENGINE_GUICLIP_CLIPTOWINDOW_OFFSET UNITYSDK_OFFSET(0x1A1F0890)
#define UNITYENGINE_GUICLIP_CLIPTOWINDOW_VECTOR2_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1F0830)
#define UNITYENGINE_GUICLIP_CLIPTOWINDOW_VECTOR2_OFFSET UNITYSDK_OFFSET(0x1A1F0800)
#define UNITYENGINE_GUICLIP_GETMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1F0840)
#define UNITYENGINE_GUICLIP_GETMATRIX_OFFSET UNITYSDK_OFFSET(0x1A1E8770)
#define UNITYENGINE_GUICLIP_GET_TOPMOSTRECT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1F07A0)
#define UNITYENGINE_GUICLIP_GET_TOPMOSTRECT_OFFSET UNITYSDK_OFFSET(0x1A1F0770)
#define UNITYENGINE_GUICLIP_GET_VISIBLERECT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1F0760)
#define UNITYENGINE_GUICLIP_GET_VISIBLERECT_OFFSET UNITYSDK_OFFSET(0x1A1EB580)
#define UNITYENGINE_GUICLIP_INTERNAL_GETCOUNT_OFFSET UNITYSDK_OFFSET(0x1A1F07F0)
#define UNITYENGINE_GUICLIP_INTERNAL_POPPARENTCLIP_OFFSET UNITYSDK_OFFSET(0x1A1F0880)
#define UNITYENGINE_GUICLIP_INTERNAL_POP_OFFSET UNITYSDK_OFFSET(0x1A1ED680)
#define UNITYENGINE_GUICLIP_INTERNAL_PUSHPARENTCLIP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1F0870)
#define UNITYENGINE_GUICLIP_INTERNAL_PUSHPARENTCLIP_OFFSET UNITYSDK_OFFSET(0x1A1F0860)
#define UNITYENGINE_GUICLIP_INTERNAL_PUSH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1F07E0)
#define UNITYENGINE_GUICLIP_INTERNAL_PUSH_OFFSET UNITYSDK_OFFSET(0x1A1F07B0)
#define UNITYENGINE_GUICLIP_POP_OFFSET UNITYSDK_OFFSET(0x1A1EF020)
#define UNITYENGINE_GUICLIP_PUSH_OFFSET UNITYSDK_OFFSET(0x1A1ED5D0)
#define UNITYENGINE_GUICLIP_SETMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1F0850)
#define UNITYENGINE_GUICLIP_SETMATRIX_OFFSET UNITYSDK_OFFSET(0x1A1E8810)
#define UNITYENGINE_GUICLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F08C0)
