...
#define UNITYENGINE_LOOPSUBDIVGLOBALSETTINGS_GET_INJECTED_OFFSET UNITYSDK_OFFSET(0x19E8FB40)
#define UNITYENGINE_LOOPSUBDIVGLOBALSETTINGS_GET_OFFSET UNITYSDK_OFFSET(0x19E8FB10)
#define UNITYENGINE_LOOPSUBDIVGLOBALSETTINGS_SET_INJECTED_OFFSET UNITYSDK_OFFSET(0x19E8FB60)
#define UNITYENGINE_LOOPSUBDIVGLOBALSETTINGS_SET_OFFSET UNITYSDK_OFFSET(0x19E8FB50)
