...
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_APPLYOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1B75ABC0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GETCLIP_OFFSET UNITYSDK_OFFSET(0x1B75AA20)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GETORIGINALCLIP_OFFSET UNITYSDK_OFFSET(0x1B75AA60)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GETOVERRIDECLIP_OFFSET UNITYSDK_OFFSET(0x1B75AA70)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GETOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1B75AA90)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GET_CLIPS_OFFSET UNITYSDK_OFFSET(0x1B75AE40)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1B75AA10)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B75A9D0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GET_OVERRIDESCOUNT_OFFSET UNITYSDK_OFFSET(0x1B75AA80)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GET_RUNTIMEANIMATORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1B75A9B0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B75A960)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_INTERNAL_GETCLIPBYNAME_OFFSET UNITYSDK_OFFSET(0x1B75A9E0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_INTERNAL_SETCLIPBYNAME_OFFSET UNITYSDK_OFFSET(0x1B75AA00)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONINVALIDATEOVERRIDECONTROLLER_OFFSET UNITYSDK_OFFSET(0x1B75B050)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_PERFORMOVERRIDECLIPLISTCLEANUP_OFFSET UNITYSDK_OFFSET(0x1B75B040)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_SENDNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1B75AA50)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_SETCLIP_OFFSET UNITYSDK_OFFSET(0x1B75AA40)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_SET_CLIPS_OFFSET UNITYSDK_OFFSET(0x1B75AFC0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1B75AA30)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B75A9F0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_SET_RUNTIMEANIMATORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1B75A9C0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B75A970)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75A920)
