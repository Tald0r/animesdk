...
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_APPLYOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1B13DE10)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GETCLIP_OFFSET UNITYSDK_OFFSET(0x1B13DC70)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GETORIGINALCLIP_OFFSET UNITYSDK_OFFSET(0x1B13DCB0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GETOVERRIDECLIP_OFFSET UNITYSDK_OFFSET(0x1B13DCC0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GETOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1B13DCE0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GET_CLIPS_OFFSET UNITYSDK_OFFSET(0x1B13E090)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1B13DC60)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B13DC20)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GET_OVERRIDESCOUNT_OFFSET UNITYSDK_OFFSET(0x1B13DCD0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_GET_RUNTIMEANIMATORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1B13DC00)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B13DBB0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_INTERNAL_GETCLIPBYNAME_OFFSET UNITYSDK_OFFSET(0x1B13DC30)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_INTERNAL_SETCLIPBYNAME_OFFSET UNITYSDK_OFFSET(0x1B13DC50)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_ONINVALIDATEOVERRIDECONTROLLER_OFFSET UNITYSDK_OFFSET(0x1B13E2A0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_PERFORMOVERRIDECLIPLISTCLEANUP_OFFSET UNITYSDK_OFFSET(0x1B13E290)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_SENDNOTIFICATION_OFFSET UNITYSDK_OFFSET(0x1B13DCA0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_SETCLIP_OFFSET UNITYSDK_OFFSET(0x1B13DC90)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_SET_CLIPS_OFFSET UNITYSDK_OFFSET(0x1B13E210)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1B13DC80)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B13DC40)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER_SET_RUNTIMEANIMATORCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1B13DC10)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B13DBC0)
#define UNITYENGINE_ANIMATOROVERRIDECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B13DB70)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimatorOverrideController_TypeDefinitionIndex = 6546;
