...
#define UNITYENGINE_AUDIOCLIP_ADD_M_PCMREADERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AF620D0)
#define UNITYENGINE_AUDIOCLIP_ADD_M_PCMSETPOSITIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AF62150)
#define UNITYENGINE_AUDIOCLIP_CONSTRUCT_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1AF61A00)
#define UNITYENGINE_AUDIOCLIP_CREATEUSERSOUND_OFFSET UNITYSDK_OFFSET(0x1AF61A20)
#define UNITYENGINE_AUDIOCLIP_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1AF61DE0)
#define UNITYENGINE_AUDIOCLIP_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1AF62070)
#define UNITYENGINE_AUDIOCLIP_CREATE_3_OFFSET UNITYSDK_OFFSET(0x1AF61DC0)
#define UNITYENGINE_AUDIOCLIP_CREATE_4_OFFSET UNITYSDK_OFFSET(0x1AF620A0)
#define UNITYENGINE_AUDIOCLIP_CREATE_5_OFFSET UNITYSDK_OFFSET(0x1AF61E10)
#define UNITYENGINE_AUDIOCLIP_CREATE_OFFSET UNITYSDK_OFFSET(0x1AF61DA0)
#define UNITYENGINE_AUDIOCLIP_GETDATA_1_OFFSET UNITYSDK_OFFSET(0x1AF61AE0)
#define UNITYENGINE_AUDIOCLIP_GETDATA_OFFSET UNITYSDK_OFFSET(0x1AF619E0)
#define UNITYENGINE_AUDIOCLIP_GETNAME_OFFSET UNITYSDK_OFFSET(0x1AF61A10)
#define UNITYENGINE_AUDIOCLIP_GET_AMBISONIC_OFFSET UNITYSDK_OFFSET(0x1AF61AB0)
#define UNITYENGINE_AUDIOCLIP_GET_CHANNELS_OFFSET UNITYSDK_OFFSET(0x1AF61A40)
#define UNITYENGINE_AUDIOCLIP_GET_FREQUENCY_OFFSET UNITYSDK_OFFSET(0x1AF61A50)
#define UNITYENGINE_AUDIOCLIP_GET_ISREADYTOPLAY_OFFSET UNITYSDK_OFFSET(0x1AF61A60)
#define UNITYENGINE_AUDIOCLIP_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1AF605B0)
#define UNITYENGINE_AUDIOCLIP_GET_LOADINBACKGROUND_OFFSET UNITYSDK_OFFSET(0x1AF61AC0)
#define UNITYENGINE_AUDIOCLIP_GET_LOADSTATE_OFFSET UNITYSDK_OFFSET(0x1AF61AD0)
#define UNITYENGINE_AUDIOCLIP_GET_LOADTYPE_OFFSET UNITYSDK_OFFSET(0x1AF61A70)
#define UNITYENGINE_AUDIOCLIP_GET_PRELOADAUDIODATA_OFFSET UNITYSDK_OFFSET(0x1AF61AA0)
#define UNITYENGINE_AUDIOCLIP_GET_SAMPLES_OFFSET UNITYSDK_OFFSET(0x1AF61A30)
#define UNITYENGINE_AUDIOCLIP_INVOKEPCMREADERCALLBACK_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1AF622D0)
#define UNITYENGINE_AUDIOCLIP_INVOKEPCMSETPOSITIONCALLBACK_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1AF627E0)
#define UNITYENGINE_AUDIOCLIP_LOADAUDIODATA_OFFSET UNITYSDK_OFFSET(0x1AF61A80)
#define UNITYENGINE_AUDIOCLIP_REMOVE_M_PCMREADERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AF621D0)
#define UNITYENGINE_AUDIOCLIP_REMOVE_M_PCMSETPOSITIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AF62250)
#define UNITYENGINE_AUDIOCLIP_SETDATA_1_OFFSET UNITYSDK_OFFSET(0x1AF61C10)
#define UNITYENGINE_AUDIOCLIP_SETDATA_OFFSET UNITYSDK_OFFSET(0x1AF619F0)
#define UNITYENGINE_AUDIOCLIP_UNLOADAUDIODATA_OFFSET UNITYSDK_OFFSET(0x1AF61A90)
#define UNITYENGINE_AUDIOCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF619C0)

namespace UnityEngine
{
	inline static constexpr unsigned int AudioClip_TypeDefinitionIndex = 9613;
