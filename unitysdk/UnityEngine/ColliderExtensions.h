...
#define UNITYENGINE_COLLIDEREXTENSIONS_CONTAINCAMTRANSPARENTTAG_OFFSET UNITYSDK_OFFSET(0xC4CF040)
#define UNITYENGINE_COLLIDEREXTENSIONS_SETUPCOLLIDERPHYSICALMATERIAL_OFFSET UNITYSDK_OFFSET(0xC4CF120)

namespace UnityEngine
{
	inline static constexpr unsigned int ColliderExtensions_TypeDefinitionIndex = 75274;
