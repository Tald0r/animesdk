...
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B75C130)
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B75C160)
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B75BD90)
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B75C110)

namespace UnityEngine
{
	inline static constexpr unsigned int RemoteSettings_UpdatedEventHandler_TypeDefinitionIndex = 82492;
