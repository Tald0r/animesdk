...
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B13F350)
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B13F380)
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B13EFC0)
#define UNITYENGINE_REMOTESETTINGS_UPDATEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B13F340)

namespace UnityEngine
{
	inline static constexpr unsigned int RemoteSettings_UpdatedEventHandler_TypeDefinitionIndex = 80450;
