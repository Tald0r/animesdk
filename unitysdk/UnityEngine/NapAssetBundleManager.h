...
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_CLEARALLNAPBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1B756F40)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_CLEARNAPBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1B756F50)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETALLLOADEDBLOCKPATHS_OFFSET UNITYSDK_OFFSET(0x1B756FC0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETALLLOADEDBUNDLEHASHES_OFFSET UNITYSDK_OFFSET(0x1B756FD0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETLOADEDBUNDLE_OFFSET UNITYSDK_OFFSET(0x1B756F70)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETLOGGINGCOSTTIME_OFFSET UNITYSDK_OFFSET(0x1B757030)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_GETLOGGINGSUPPORT_OFFSET UNITYSDK_OFFSET(0x1B757010)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_ISASSETLOADDONE_OFFSET UNITYSDK_OFFSET(0x1B756F90)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_LOADASSETASYNC_OFFSET UNITYSDK_OFFSET(0x1B756F80)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_LOADASSET_OFFSET UNITYSDK_OFFSET(0x1B756F60)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SETENABLEDELAYUNLOAD_OFFSET UNITYSDK_OFFSET(0x1B756FF0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SETLOGGINGCOSTTIME_OFFSET UNITYSDK_OFFSET(0x1B757020)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SETLOGGINGSUPPORT_OFFSET UNITYSDK_OFFSET(0x1B757000)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SETNAPASSETBUNDLEINDEXASSET_OFFSET UNITYSDK_OFFSET(0x1B756F30)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_SYNCLOAD_OFFSET UNITYSDK_OFFSET(0x1B756FB0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_UNLOADASSET_OFFSET UNITYSDK_OFFSET(0x1B756FA0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B756FE0)
#define UNITYENGINE_NAPASSETBUNDLEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B757040)
