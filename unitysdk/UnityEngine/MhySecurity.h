...
#define UNITYENGINE_MHYSECURITY_DECRYPTBUFFER_OFFSET UNITYSDK_OFFSET(0x1B156EA0)

namespace UnityEngine
{
	inline static constexpr unsigned int MhySecurity_TypeDefinitionIndex = 36104;
