...
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_ENABLED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE3E860)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x9734C0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_MESHRENDERER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE3E940)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_MESHRENDERER_OFFSET UNITYSDK_OFFSET(0x973530)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_RADIUS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE3E8E0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x973500)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_SHAPETYPE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE3E8A0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_SHAPETYPE_OFFSET UNITYSDK_OFFSET(0x9734E0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_SKINNEDMESHRENDERER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE3E980)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_GET_SKINNEDMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x973550)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_ENABLED_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE3E880)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x9734D0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_MESHRENDERER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE3E960)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_MESHRENDERER_OFFSET UNITYSDK_OFFSET(0x973540)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_MESH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE3E920)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_MESH_OFFSET UNITYSDK_OFFSET(0x973520)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_RADIUS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE3E900)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x973510)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_SCALE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE3E9C0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x973570)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_SHAPETYPE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE3E8C0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_SHAPETYPE_OFFSET UNITYSDK_OFFSET(0x9734F0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_SKINNEDMESHRENDERER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AE3E9A0)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE_SET_SKINNEDMESHRENDERER_OFFSET UNITYSDK_OFFSET(0x973560)
#define UNITYENGINE_PARTICLESYSTEM_SHAPEMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x3074E0)

namespace UnityEngine
{
	inline static constexpr unsigned int ParticleSystem_ShapeModule_TypeDefinitionIndex = 24345;
