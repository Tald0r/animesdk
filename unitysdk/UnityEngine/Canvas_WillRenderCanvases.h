...
#define UNITYENGINE_CANVAS_WILLRENDERCANVASES_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0711E0)
#define UNITYENGINE_CANVAS_WILLRENDERCANVASES_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B071210)
#define UNITYENGINE_CANVAS_WILLRENDERCANVASES_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B070F10)
#define UNITYENGINE_CANVAS_WILLRENDERCANVASES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0711D0)

namespace UnityEngine
{
	inline static constexpr unsigned int Canvas_WillRenderCanvases_TypeDefinitionIndex = 7678;
