...
#define UNITYENGINE_BILLBOARDASSET_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x19E12A40)
#define UNITYENGINE_BILLBOARDASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x19E12A10)
