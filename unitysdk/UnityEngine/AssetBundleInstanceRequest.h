...
#define UNITYENGINE_ASSETBUNDLEINSTANCEREQUEST_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1B756DC0)
#define UNITYENGINE_ASSETBUNDLEINSTANCEREQUEST_SYNC_OFFSET UNITYSDK_OFFSET(0x1B756DD0)
#define UNITYENGINE_ASSETBUNDLEINSTANCEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B756DE0)
