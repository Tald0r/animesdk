...
#define UNITYENGINE_ASSETBUNDLEINSTANCEREQUEST_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1B13B7E0)
#define UNITYENGINE_ASSETBUNDLEINSTANCEREQUEST_SYNC_OFFSET UNITYSDK_OFFSET(0x1B13B7F0)
#define UNITYENGINE_ASSETBUNDLEINSTANCEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B13B800)

namespace UnityEngine
{
	inline static constexpr unsigned int AssetBundleInstanceRequest_TypeDefinitionIndex = 7588;
