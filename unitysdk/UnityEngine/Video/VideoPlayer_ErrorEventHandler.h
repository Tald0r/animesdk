...
#define UNITYENGINE_VIDEO_VIDEOPLAYER_ERROREVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6A9880)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_ERROREVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6A98C0)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_ERROREVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6A8C80)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_ERROREVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A9860)

namespace UnityEngine::Video
{
	inline static constexpr unsigned int VideoPlayer_ErrorEventHandler_TypeDefinitionIndex = 24627;
