...
#define UNITYENGINE_VIDEO_VIDEOPLAYER_FRAMEREADYEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6A9950)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_FRAMEREADYEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6A99B0)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_FRAMEREADYEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6A8650)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_FRAMEREADYEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A9930)

namespace UnityEngine::Video
{
	inline static constexpr unsigned int VideoPlayer_FrameReadyEventHandler_TypeDefinitionIndex = 24628;
