...
#define UNITYENGINE_VIDEO_VIDEOPLAYER_TIMEEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B09BBA0)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_TIMEEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B09BC00)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_TIMEEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B09B460)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_TIMEEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09BB90)

namespace UnityEngine::Video
{
	inline static constexpr unsigned int VideoPlayer_TimeEventHandler_TypeDefinitionIndex = 23946;
