...
#define UNITYENGINE_VIDEO_VIDEOPLAYER_EVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6A98F0)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_EVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6A9920)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_EVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6A8120)
#define UNITYENGINE_VIDEO_VIDEOPLAYER_EVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6A98D0)

namespace UnityEngine::Video
{
	inline static constexpr unsigned int VideoPlayer_EventHandler_TypeDefinitionIndex = 24626;
