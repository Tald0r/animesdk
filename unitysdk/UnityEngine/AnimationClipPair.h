...
#define UNITYENGINE_ANIMATIONCLIPPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B11BCB0)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimationClipPair_TypeDefinitionIndex = 6545;
