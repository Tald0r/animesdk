...
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_APPLYITEMTHREADINTERNAL_OFFSET UNITYSDK_OFFSET(0x19E39990)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_APPLYITEMTHREAD_OFFSET UNITYSDK_OFFSET(0x19E39AE0)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x19E39960)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x19E39970)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E39A70)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19E399C0)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_RELEASE_OFFSET UNITYSDK_OFFSET(0x19E39A40)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_SYNCJOBSINTERNAL_OFFSET UNITYSDK_OFFSET(0x19E39980)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E399A0)

namespace UnityEngine::NAPBatch
{
	inline static constexpr unsigned int MaterialBatchApplier_TypeDefinitionIndex = 6117;
