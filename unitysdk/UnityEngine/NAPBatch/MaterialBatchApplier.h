...
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_APPLYITEMTHREADINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A4026F0)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_APPLYITEMTHREAD_OFFSET UNITYSDK_OFFSET(0x1A402840)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_CREATENATIVE_OFFSET UNITYSDK_OFFSET(0x1A4026C0)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_DESTROYNATIVE_OFFSET UNITYSDK_OFFSET(0x1A4026D0)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A4027D0)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A402720)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A4027A0)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER_SYNCJOBSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A4026E0)
#define UNITYENGINE_NAPBATCH_MATERIALBATCHAPPLIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A402700)
