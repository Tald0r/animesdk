...
#define UNITYENGINE_PROPERTYNAMEUTILS_PROPERTYNAMEFROMSTRING_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A1A64A0)
#define UNITYENGINE_PROPERTYNAMEUTILS_PROPERTYNAMEFROMSTRING_OFFSET UNITYSDK_OFFSET(0x1A1A6480)
#define UNITYENGINE_PROPERTYNAMEUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1A64B0)
