...
#define UNITYENGINE_TEXTURESTREAMINGSYSTEM_SETSCREENMAPSTPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1A4C05F0)
#define UNITYENGINE_TEXTURESTREAMINGSYSTEM_SETSCREENMAPTEXTUREPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1A4C05E0)
#define UNITYENGINE_TEXTURESTREAMINGSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4C0600)

namespace UnityEngine
{
	inline static constexpr unsigned int TextureStreamingSystem_TypeDefinitionIndex = 5421;
