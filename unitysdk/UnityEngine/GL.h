...
#define UNITYENGINE_GL_BEGIN_OFFSET UNITYSDK_OFFSET(0x1A3E56D0)
#define UNITYENGINE_GL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A3E5710)
#define UNITYENGINE_GL_COLOR_OFFSET UNITYSDK_OFFSET(0x1A3E54F0)
#define UNITYENGINE_GL_END_OFFSET UNITYSDK_OFFSET(0x1A3E56E0)
#define UNITYENGINE_GL_GETGPUPROJECTIONMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A3E5630)
#define UNITYENGINE_GL_GETGPUPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1A3E55D0)
#define UNITYENGINE_GL_GLCLEAR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A3E5700)
#define UNITYENGINE_GL_GLCLEAR_OFFSET UNITYSDK_OFFSET(0x1A3E56F0)
#define UNITYENGINE_GL_GLISSUEPLUGINEVENT_OFFSET UNITYSDK_OFFSET(0x1A3E5640)
#define UNITYENGINE_GL_IMMEDIATECOLOR_OFFSET UNITYSDK_OFFSET(0x1A3E54E0)
#define UNITYENGINE_GL_ISSUEPLUGINEVENT_OFFSET UNITYSDK_OFFSET(0x1A3E5650)
#define UNITYENGINE_GL_LOADIDENTITY_OFFSET UNITYSDK_OFFSET(0x1A3E55A0)
#define UNITYENGINE_GL_LOADPROJECTIONMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A3E55C0)
#define UNITYENGINE_GL_LOADPROJECTIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1A3E55B0)
#define UNITYENGINE_GL_POPMATRIX_OFFSET UNITYSDK_OFFSET(0x1A3E5590)
#define UNITYENGINE_GL_PUSHMATRIX_OFFSET UNITYSDK_OFFSET(0x1A3E5580)
#define UNITYENGINE_GL_SETVIEWMATRIX_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A3E5530)
#define UNITYENGINE_GL_SETVIEWMATRIX_OFFSET UNITYSDK_OFFSET(0x1A3E5520)
#define UNITYENGINE_GL_SET_INVERTCULLING_OFFSET UNITYSDK_OFFSET(0x1A3E5510)
#define UNITYENGINE_GL_SET_MODELVIEW_OFFSET UNITYSDK_OFFSET(0x1A3E5540)
#define UNITYENGINE_GL_VERTEX3_OFFSET UNITYSDK_OFFSET(0x1A3E54B0)
#define UNITYENGINE_GL_VERTEX_OFFSET UNITYSDK_OFFSET(0x1A3E54C0)
#define UNITYENGINE_GL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E5740)
