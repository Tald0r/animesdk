...
#define UNITYENGINE_LAYERMASK_GETMASK_OFFSET UNITYSDK_OFFSET(0x19F44A30)
#define UNITYENGINE_LAYERMASK_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_LAYERMASK_LAYERTONAME_OFFSET UNITYSDK_OFFSET(0x19F44A10)
#define UNITYENGINE_LAYERMASK_NAMETOLAYER_OFFSET UNITYSDK_OFFSET(0x19F44A20)
#define UNITYENGINE_LAYERMASK_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x19F449E0)
#define UNITYENGINE_LAYERMASK_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19F449D0)
#define UNITYENGINE_LAYERMASK_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x2D3600)

namespace UnityEngine
{
	inline static constexpr unsigned int LayerMask_TypeDefinitionIndex = 5347;
