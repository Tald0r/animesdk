...
#define UNITYENGINE_GRAPHICS_BLIT_1_OFFSET UNITYSDK_OFFSET(0x1A2FC8C0)
#define UNITYENGINE_GRAPHICS_BLIT_OFFSET UNITYSDK_OFFSET(0x1A2FC870)
#define UNITYENGINE_GRAPHICS_CHECKLOADACTIONVALID_OFFSET UNITYSDK_OFFSET(0x1A2FB130)
#define UNITYENGINE_GRAPHICS_CHECKSTOREACTIONVALID_OFFSET UNITYSDK_OFFSET(0x1A2FB1E0)
#define UNITYENGINE_GRAPHICS_COPYTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1A2FB930)
#define UNITYENGINE_GRAPHICS_COPYTEXTURE_2_OFFSET UNITYSDK_OFFSET(0x1A2FB980)
#define UNITYENGINE_GRAPHICS_COPYTEXTURE_3_OFFSET UNITYSDK_OFFSET(0x1A2FB9D0)
#define UNITYENGINE_GRAPHICS_COPYTEXTURE_FULL_OFFSET UNITYSDK_OFFSET(0x1A2FADF0)
#define UNITYENGINE_GRAPHICS_COPYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A2FB8F0)
#define UNITYENGINE_GRAPHICS_COPYTEXTURE_REGION_OFFSET UNITYSDK_OFFSET(0x1A2FAE20)
#define UNITYENGINE_GRAPHICS_COPYTEXTURE_SLICE_ALLMIPS_OFFSET UNITYSDK_OFFSET(0x1A2FAE00)
#define UNITYENGINE_GRAPHICS_COPYTEXTURE_SLICE_OFFSET UNITYSDK_OFFSET(0x1A2FAE10)
#define UNITYENGINE_GRAPHICS_DRAWMESHINSTANCEDINDIRECT_1_OFFSET UNITYSDK_OFFSET(0x1A2FCC10)
#define UNITYENGINE_GRAPHICS_DRAWMESHINSTANCEDINDIRECT_OFFSET UNITYSDK_OFFSET(0x1A2FC360)
#define UNITYENGINE_GRAPHICS_DRAWMESHNOW_1_OFFSET UNITYSDK_OFFSET(0x1A2FBDE0)
#define UNITYENGINE_GRAPHICS_DRAWMESHNOW_2_OFFSET UNITYSDK_OFFSET(0x1A2FBF90)
#define UNITYENGINE_GRAPHICS_DRAWMESHNOW_3_OFFSET UNITYSDK_OFFSET(0x1A2FC010)
#define UNITYENGINE_GRAPHICS_DRAWMESHNOW_OFFSET UNITYSDK_OFFSET(0x1A2FBC50)
#define UNITYENGINE_GRAPHICS_DRAWMESH_1_OFFSET UNITYSDK_OFFSET(0x1A2FC920)
#define UNITYENGINE_GRAPHICS_DRAWMESH_2_OFFSET UNITYSDK_OFFSET(0x1A2FCAD0)
#define UNITYENGINE_GRAPHICS_DRAWMESH_OFFSET UNITYSDK_OFFSET(0x1A2FC0A0)
#define UNITYENGINE_GRAPHICS_DRAWPROCEDURALNOW_OFFSET UNITYSDK_OFFSET(0x1A2FC830)
#define UNITYENGINE_GRAPHICS_DRAWTEXTUREIMPL_OFFSET UNITYSDK_OFFSET(0x1A2FBA20)
#define UNITYENGINE_GRAPHICS_DRAWTEXTURE_1_OFFSET UNITYSDK_OFFSET(0x1A2FCCF0)
#define UNITYENGINE_GRAPHICS_DRAWTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A2FBB10)
#define UNITYENGINE_GRAPHICS_ENABLEEXECUTEASYNC_OFFSET UNITYSDK_OFFSET(0x1A2FB050)
#define UNITYENGINE_GRAPHICS_ENABLEMETALHEAPOPT_OFFSET UNITYSDK_OFFSET(0x1A2FB110)
#define UNITYENGINE_GRAPHICS_ENABLEMETALSHADERMEMOPT_OFFSET UNITYSDK_OFFSET(0x1A2FB080)
#define UNITYENGINE_GRAPHICS_ENABLEPERIODICFREEBUFFERTRIMMING_OFFSET UNITYSDK_OFFSET(0x1A2FB0E0)
#define UNITYENGINE_GRAPHICS_ENABLEPSOWARMUP_OFFSET UNITYSDK_OFFSET(0x1A2FB0C0)
#define UNITYENGINE_GRAPHICS_ENABLESHADERWARMUPBYJOB_OFFSET UNITYSDK_OFFSET(0x1A2FB0D0)
#define UNITYENGINE_GRAPHICS_ENABLESRPINSTANCING_OFFSET UNITYSDK_OFFSET(0x1A2FB090)
#define UNITYENGINE_GRAPHICS_EXECUTECOMMANDBUFFERASYNC_OFFSET UNITYSDK_OFFSET(0x1A2FAFE0)
#define UNITYENGINE_GRAPHICS_EXECUTECOMMANDBUFFER_OFFSET UNITYSDK_OFFSET(0x1A2FAFD0)
#define UNITYENGINE_GRAPHICS_GETDRAWSTATSSETPASSCALLS_OFFSET UNITYSDK_OFFSET(0x1A2FAFF0)
#define UNITYENGINE_GRAPHICS_GETDRAWSTATSTRIANGLES_OFFSET UNITYSDK_OFFSET(0x1A2FB010)
#define UNITYENGINE_GRAPHICS_GETDRAWSTATSVERTICES_OFFSET UNITYSDK_OFFSET(0x1A2FB000)
#define UNITYENGINE_GRAPHICS_GETLIFETIMEIDFROMNAMEID_OFFSET UNITYSDK_OFFSET(0x1A2FB100)
#define UNITYENGINE_GRAPHICS_GETLIFETIMEIDFROMNAME_OFFSET UNITYSDK_OFFSET(0x1A2FB0F0)
#define UNITYENGINE_GRAPHICS_GETPRESERVEFRAMEBUFFERALPHA_OFFSET UNITYSDK_OFFSET(0x1A2FACE0)
#define UNITYENGINE_GRAPHICS_GETSHADERCOMPILESTAMP_OFFSET UNITYSDK_OFFSET(0x1A2FB060)
#define UNITYENGINE_GRAPHICS_GET_ACTIVETIER_OFFSET UNITYSDK_OFFSET(0x1A2FACC0)
#define UNITYENGINE_GRAPHICS_GET_PRESERVEFRAMEBUFFERALPHA_OFFSET UNITYSDK_OFFSET(0x1A2FACF0)
#define UNITYENGINE_GRAPHICS_GET_USEDRAWSTATSBETWEENPASS_OFFSET UNITYSDK_OFFSET(0x1A2FB020)
#define UNITYENGINE_GRAPHICS_INITIALIZENAPPVSHANDLES_OFFSET UNITYSDK_OFFSET(0x1A2FB040)
#define UNITYENGINE_GRAPHICS_INTERNAL_BLITMATERIAL5_OFFSET UNITYSDK_OFFSET(0x1A2FAFC0)
#define UNITYENGINE_GRAPHICS_INTERNAL_DRAWMESHINSTANCEDINDIRECT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2FAFA0)
#define UNITYENGINE_GRAPHICS_INTERNAL_DRAWMESHINSTANCEDINDIRECT_OFFSET UNITYSDK_OFFSET(0x1A2FAF50)
#define UNITYENGINE_GRAPHICS_INTERNAL_DRAWMESHNOW1_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2FAE80)
#define UNITYENGINE_GRAPHICS_INTERNAL_DRAWMESHNOW1_OFFSET UNITYSDK_OFFSET(0x1A2FAE30)
#define UNITYENGINE_GRAPHICS_INTERNAL_DRAWMESHNOW2_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2FAED0)
#define UNITYENGINE_GRAPHICS_INTERNAL_DRAWMESHNOW2_OFFSET UNITYSDK_OFFSET(0x1A2FAE90)
#define UNITYENGINE_GRAPHICS_INTERNAL_DRAWMESH_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2FAF40)
#define UNITYENGINE_GRAPHICS_INTERNAL_DRAWMESH_OFFSET UNITYSDK_OFFSET(0x1A2FAEF0)
#define UNITYENGINE_GRAPHICS_INTERNAL_DRAWPROCEDURALNOW_OFFSET UNITYSDK_OFFSET(0x1A2FAFB0)
#define UNITYENGINE_GRAPHICS_INTERNAL_DRAWTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A2FAEE0)
#define UNITYENGINE_GRAPHICS_INTERNAL_GETMAXDRAWMESHINSTANCECOUNT_OFFSET UNITYSDK_OFFSET(0x1A2FACB0)
#define UNITYENGINE_GRAPHICS_INTERNAL_SETMRTFULLSETUP_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2FADE0)
#define UNITYENGINE_GRAPHICS_INTERNAL_SETMRTFULLSETUP_OFFSET UNITYSDK_OFFSET(0x1A2FAD90)
#define UNITYENGINE_GRAPHICS_INTERNAL_SETNULLRT_OFFSET UNITYSDK_OFFSET(0x1A2FAD20)
#define UNITYENGINE_GRAPHICS_INTERNAL_SETRTSIMPLE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2FAD80)
#define UNITYENGINE_GRAPHICS_INTERNAL_SETRTSIMPLE_OFFSET UNITYSDK_OFFSET(0x1A2FAD30)
#define UNITYENGINE_GRAPHICS_ISENABLEDYNAMICCACHE_OFFSET UNITYSDK_OFFSET(0x1A2FB0B0)
#define UNITYENGINE_GRAPHICS_ISPIPELINCACHEVALID_OFFSET UNITYSDK_OFFSET(0x1A2FB0A0)
#define UNITYENGINE_GRAPHICS_SETENABLEFORCEMETALTEXTURESWAPPABLE_OFFSET UNITYSDK_OFFSET(0x1A2FB120)
#define UNITYENGINE_GRAPHICS_SETGPUMEMOPTPARAMS_OFFSET UNITYSDK_OFFSET(0x1A2FB070)
#define UNITYENGINE_GRAPHICS_SETRENDERTARGETIMPL_1_OFFSET UNITYSDK_OFFSET(0x1A2FB5D0)
#define UNITYENGINE_GRAPHICS_SETRENDERTARGETIMPL_2_OFFSET UNITYSDK_OFFSET(0x1A2FB670)
#define UNITYENGINE_GRAPHICS_SETRENDERTARGETIMPL_OFFSET UNITYSDK_OFFSET(0x1A2FB290)
#define UNITYENGINE_GRAPHICS_SETRENDERTARGET_1_OFFSET UNITYSDK_OFFSET(0x1A2FB860)
#define UNITYENGINE_GRAPHICS_SETRENDERTARGET_2_OFFSET UNITYSDK_OFFSET(0x1A2FCE50)
#define UNITYENGINE_GRAPHICS_SETRENDERTARGET_3_OFFSET UNITYSDK_OFFSET(0x1A2FCEA0)
#define UNITYENGINE_GRAPHICS_SETRENDERTARGET_OFFSET UNITYSDK_OFFSET(0x1A2FB810)
#define UNITYENGINE_GRAPHICS_SET_ACTIVETIER_OFFSET UNITYSDK_OFFSET(0x1A2FACD0)
#define UNITYENGINE_GRAPHICS_SET_USEDRAWSTATSBETWEENPASS_OFFSET UNITYSDK_OFFSET(0x1A2FB030)
#define UNITYENGINE_GRAPHICS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2FCF00)
#define UNITYENGINE_GRAPHICS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2FCEF0)
