...
#define UNITYENGINE_GUI_SCOPE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A1F0680)
#define UNITYENGINE_GUI_SCOPE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A1F0460)
#define UNITYENGINE_GUI_SCOPE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A1F04F0)
#define UNITYENGINE_GUI_SCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F06D0)
