...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_CONTAINS_OFFSET UNITYSDK_OFFSET(0x19082130)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_DISABLE_OFFSET UNITYSDK_OFFSET(0x19081FD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_ENABLE_OFFSET UNITYSDK_OFFSET(0x19081E20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDACTIONMAP_1_OFFSET UNITYSDK_OFFSET(0x19081870)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDACTIONMAP_OFFSET UNITYSDK_OFFSET(0x19081570)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDACTION_1_OFFSET UNITYSDK_OFFSET(0x190819F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDACTION_OFFSET UNITYSDK_OFFSET(0x19080CF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDBINDING_OFFSET UNITYSDK_OFFSET(0x19081490)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDCONTROLSCHEMEINDEX_OFFSET UNITYSDK_OFFSET(0x19081AC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FINDCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x19081BC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_FROMJSON_OFFSET UNITYSDK_OFFSET(0x190812A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x190821F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_ACTIONMAPS_OFFSET UNITYSDK_OFFSET(0x190806C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x19080780)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x19080720)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_CONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x190806F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x190809A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x19080570)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19080C60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_ISUSABLEWITHDEVICE_OFFSET UNITYSDK_OFFSET(0x19081CB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_LOADFROMJSON_OFFSET UNITYSDK_OFFSET(0x19081190)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_MARKASDIRTY_OFFSET UNITYSDK_OFFSET(0x19082290)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x190822A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_RERESOLVEIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x19080930)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_SET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x190807C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_SET_DEVICES_OFFSET UNITYSDK_OFFSET(0x19080A40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19082240)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET_TOJSON_OFFSET UNITYSDK_OFFSET(0x190810F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x190822E0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionAsset_TypeDefinitionIndex = 28355;
