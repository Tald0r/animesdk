...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_GET_OFFSET UNITYSDK_OFFSET(0x8499E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_INDEXOF_OFFSET UNITYSDK_OFFSET(0x849830)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_REMOVE_OFFSET UNITYSDK_OFFSET(0x8498D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_SET_OFFSET UNITYSDK_OFFSET(0x849A20)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionMap_DeviceArray_TypeDefinitionIndex = 27422;
