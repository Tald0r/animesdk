...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_GET_OFFSET UNITYSDK_OFFSET(0x878330)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_INDEXOF_OFFSET UNITYSDK_OFFSET(0x878180)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_REMOVE_OFFSET UNITYSDK_OFFSET(0x878220)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DEVICEARRAY_SET_OFFSET UNITYSDK_OFFSET(0x878370)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionMap_DeviceArray_TypeDefinitionIndex = 28362;
