...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1979A420)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_INPUTBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1979A6B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_INPUTBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1979A5C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1979A740)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1979A650)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1979A600)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1979A410)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1979A3F0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionAsset__get_bindings_d__8_TypeDefinitionIndex = 27418;
	...
	public:
		...
		::UnityEngine::InputSystem::InputBinding __2__current; // 0x20
		::System::Int32 _numBindings_5__5; // 0x78
		::System::Int32 _numActionMaps_5__2; // 0x7C
		::System::Int32 _n_5__6; // 0x80
		::System::Int32 __l__initialThreadId; // 0x84
		::System::Int32 __1__state; // 0x88
		::System::Int32 _i_5__3; // 0x8C
