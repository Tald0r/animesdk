...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19C0AD70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_INPUTBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19C0B000)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_INPUTBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C0AF10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19C0B080)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C0AFA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19C0AF50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C0AD60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GET_BINDINGS_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x19C0AD40)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionAsset__get_bindings_d__8_TypeDefinitionIndex = 28358;
	...
	public:
		...
		::System::Int32 _n_5__6; // 0x84
		::System::Int32 _numBindings_5__5; // 0x88
