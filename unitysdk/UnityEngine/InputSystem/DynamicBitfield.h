...
#define UNITYENGINE_INPUTSYSTEM_DYNAMICBITFIELD_BITCOUNTTOULONGCOUNT_OFFSET UNITYSDK_OFFSET(0x1AAC56D0)
#define UNITYENGINE_INPUTSYSTEM_DYNAMICBITFIELD_CLEARBIT_OFFSET UNITYSDK_OFFSET(0x94CE10)
#define UNITYENGINE_INPUTSYSTEM_DYNAMICBITFIELD_SETBIT_OFFSET UNITYSDK_OFFSET(0x94CD90)
#define UNITYENGINE_INPUTSYSTEM_DYNAMICBITFIELD_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x94CD40)
#define UNITYENGINE_INPUTSYSTEM_DYNAMICBITFIELD_TESTBIT_OFFSET UNITYSDK_OFFSET(0x94CDE0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int DynamicBitfield_TypeDefinitionIndex = 28537;
