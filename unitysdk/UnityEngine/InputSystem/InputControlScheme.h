...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x935490)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_EQUALS_OFFSET UNITYSDK_OFFSET(0x935460)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x935500)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_GET_BINDINGGROUP_OFFSET UNITYSDK_OFFSET(0x272280)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_GET_DEVICEREQUIREMENTS_OFFSET UNITYSDK_OFFSET(0x9353A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_GET_NAME_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A69E070)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A69E0A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SETNAMEANDBINDINGGROUP_OFFSET UNITYSDK_OFFSET(0x9353E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SET_BINDINGGROUP_OFFSET UNITYSDK_OFFSET(0x302310)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SUPPORTSDEVICE_OFFSET UNITYSDK_OFFSET(0x935450)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x935640)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME__CTOR_OFFSET UNITYSDK_OFFSET(0x9353D0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlScheme_TypeDefinitionIndex = 28412;
