...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GETENUMERATOR_D__31_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19F712B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GETENUMERATOR_D__31_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_INPUTACTION__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F713C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GETENUMERATOR_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F71420)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GETENUMERATOR_D__31_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19F713D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GETENUMERATOR_D__31_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F712A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONASSET__GETENUMERATOR_D__31__CTOR_OFFSET UNITYSDK_OFFSET(0x19F71290)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionAsset__GetEnumerator_d__31_TypeDefinitionIndex = 27419;
	...
	public:
		...
		::System::Int32 _actionCount_5__4; // 0x3C
