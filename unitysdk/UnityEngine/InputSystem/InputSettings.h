...
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_BACKGROUNDBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1B1A1BA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_BUTTONRELEASETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B1A1A80)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_COMPENSATEFORSCREENORIENTATION_OFFSET UNITYSDK_OFFSET(0x1B1A1980)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTBUTTONPRESSPOINT_OFFSET UNITYSDK_OFFSET(0x1B1A1A30)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTDEADZONEMAX_OFFSET UNITYSDK_OFFSET(0x1B1A1A00)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTDEADZONEMIN_OFFSET UNITYSDK_OFFSET(0x1B1A19D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTHOLDTIME_OFFSET UNITYSDK_OFFSET(0x1B1A1B10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTSLOWTAPTIME_OFFSET UNITYSDK_OFFSET(0x1B1A1AE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTTAPTIME_OFFSET UNITYSDK_OFFSET(0x1B1A1AB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DISABLEREDUNDANTEVENTSMERGING_OFFSET UNITYSDK_OFFSET(0x1B1A1D60)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_EDITORINPUTBEHAVIORINPLAYMODE_OFFSET UNITYSDK_OFFSET(0x1B1A1BC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_FILTERNOISEONCURRENT_OFFSET UNITYSDK_OFFSET(0x1B1A19B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_MAXEVENTBYTESPERUPDATE_OFFSET UNITYSDK_OFFSET(0x1B1A1BE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_MAXQUEUEDEVENTSPERUPDATE_OFFSET UNITYSDK_OFFSET(0x1B1A1C00)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_MULTITAPDELAYTIME_OFFSET UNITYSDK_OFFSET(0x1B1A1B70)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_SUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1B1A1C20)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_TAPRADIUS_OFFSET UNITYSDK_OFFSET(0x1B1A1B40)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1B1A17E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_ISFEATUREENABLED_OFFSET UNITYSDK_OFFSET(0x1B1A2010)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x1B1A1800)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SETINTERNALFEATUREFLAG_OFFSET UNITYSDK_OFFSET(0x1B1A1D90)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_BACKGROUNDBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1B1A1BB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_BUTTONRELEASETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B1A1A90)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_COMPENSATEFORSCREENORIENTATION_OFFSET UNITYSDK_OFFSET(0x1B1A1990)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTBUTTONPRESSPOINT_OFFSET UNITYSDK_OFFSET(0x1B1A1A40)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTDEADZONEMAX_OFFSET UNITYSDK_OFFSET(0x1B1A1A10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTDEADZONEMIN_OFFSET UNITYSDK_OFFSET(0x1B1A19E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTHOLDTIME_OFFSET UNITYSDK_OFFSET(0x1B1A1B20)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTSLOWTAPTIME_OFFSET UNITYSDK_OFFSET(0x1B1A1AF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTTAPTIME_OFFSET UNITYSDK_OFFSET(0x1B1A1AC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DISABLEREDUNDANTEVENTSMERGING_OFFSET UNITYSDK_OFFSET(0x1B1A1D70)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_EDITORINPUTBEHAVIORINPLAYMODE_OFFSET UNITYSDK_OFFSET(0x1B1A1BD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_FILTERNOISEONCURRENT_OFFSET UNITYSDK_OFFSET(0x1B1A19C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_MAXEVENTBYTESPERUPDATE_OFFSET UNITYSDK_OFFSET(0x1B1A1BF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_MAXQUEUEDEVENTSPERUPDATE_OFFSET UNITYSDK_OFFSET(0x1B1A1C10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_MULTITAPDELAYTIME_OFFSET UNITYSDK_OFFSET(0x1B1A1B80)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_SUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1B1A1C50)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_TAPRADIUS_OFFSET UNITYSDK_OFFSET(0x1B1A1B50)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1B1A17F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A20E0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputSettings_TypeDefinitionIndex = 28517;
