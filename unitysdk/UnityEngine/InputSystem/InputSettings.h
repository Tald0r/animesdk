...
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_BACKGROUNDBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AB81DF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_BUTTONRELEASETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1AB81CD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_COMPENSATEFORSCREENORIENTATION_OFFSET UNITYSDK_OFFSET(0x1AB81BD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTBUTTONPRESSPOINT_OFFSET UNITYSDK_OFFSET(0x1AB81C80)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTDEADZONEMAX_OFFSET UNITYSDK_OFFSET(0x1AB81C50)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTDEADZONEMIN_OFFSET UNITYSDK_OFFSET(0x1AB81C20)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTHOLDTIME_OFFSET UNITYSDK_OFFSET(0x1AB81D60)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTSLOWTAPTIME_OFFSET UNITYSDK_OFFSET(0x1AB81D30)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DEFAULTTAPTIME_OFFSET UNITYSDK_OFFSET(0x1AB81D00)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_DISABLEREDUNDANTEVENTSMERGING_OFFSET UNITYSDK_OFFSET(0x1AB81FB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_EDITORINPUTBEHAVIORINPLAYMODE_OFFSET UNITYSDK_OFFSET(0x1AB81E10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_FILTERNOISEONCURRENT_OFFSET UNITYSDK_OFFSET(0x1AB81C00)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_MAXEVENTBYTESPERUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB81E30)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_MAXQUEUEDEVENTSPERUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB81E50)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_MULTITAPDELAYTIME_OFFSET UNITYSDK_OFFSET(0x1AB81DC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_SUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1AB81E70)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_TAPRADIUS_OFFSET UNITYSDK_OFFSET(0x1AB81D90)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_GET_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1AB81A30)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_ISFEATUREENABLED_OFFSET UNITYSDK_OFFSET(0x1AB82260)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x1AB81A50)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SETINTERNALFEATUREFLAG_OFFSET UNITYSDK_OFFSET(0x1AB81FE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_BACKGROUNDBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AB81E00)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_BUTTONRELEASETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1AB81CE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_COMPENSATEFORSCREENORIENTATION_OFFSET UNITYSDK_OFFSET(0x1AB81BE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTBUTTONPRESSPOINT_OFFSET UNITYSDK_OFFSET(0x1AB81C90)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTDEADZONEMAX_OFFSET UNITYSDK_OFFSET(0x1AB81C60)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTDEADZONEMIN_OFFSET UNITYSDK_OFFSET(0x1AB81C30)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTHOLDTIME_OFFSET UNITYSDK_OFFSET(0x1AB81D70)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTSLOWTAPTIME_OFFSET UNITYSDK_OFFSET(0x1AB81D40)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DEFAULTTAPTIME_OFFSET UNITYSDK_OFFSET(0x1AB81D10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_DISABLEREDUNDANTEVENTSMERGING_OFFSET UNITYSDK_OFFSET(0x1AB81FC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_EDITORINPUTBEHAVIORINPLAYMODE_OFFSET UNITYSDK_OFFSET(0x1AB81E20)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_FILTERNOISEONCURRENT_OFFSET UNITYSDK_OFFSET(0x1AB81C10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_MAXEVENTBYTESPERUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB81E40)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_MAXQUEUEDEVENTSPERUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB81E60)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_MULTITAPDELAYTIME_OFFSET UNITYSDK_OFFSET(0x1AB81DD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_SUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1AB81EA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_TAPRADIUS_OFFSET UNITYSDK_OFFSET(0x1AB81DA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS_SET_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x1AB81A40)
#define UNITYENGINE_INPUTSYSTEM_INPUTSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB82330)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputSettings_TypeDefinitionIndex = 27577;
