...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DEVICECONFIGURATIONEVENT_CREATE_OFFSET UNITYSDK_OFFSET(0x1979D4B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DEVICECONFIGURATIONEVENT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x8B09F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DEVICECONFIGURATIONEVENT_TOEVENTPTR_OFFSET UNITYSDK_OFFSET(0x84A400)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int DeviceConfigurationEvent_TypeDefinitionIndex = 27788;
