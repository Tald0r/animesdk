...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x92E070)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x92E0C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x92E0D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x92E050)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventBuffer_Enumerator_TypeDefinitionIndex = 28738;
