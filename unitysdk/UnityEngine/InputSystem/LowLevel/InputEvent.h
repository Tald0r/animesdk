...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_EQUALS_OFFSET UNITYSDK_OFFSET(0x18CCC1F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_GETNEXTINMEMORYCHECKED_OFFSET UNITYSDK_OFFSET(0x18CCC130)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_GETNEXTINMEMORY_OFFSET UNITYSDK_OFFSET(0x18CCC110)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x863A40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x863A20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_GET_HANDLED_OFFSET UNITYSDK_OFFSET(0x8628F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_GET_INTERNALTIME_OFFSET UNITYSDK_OFFSET(0x322CC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_GET_SIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x54CE80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_GET_TIME_OFFSET UNITYSDK_OFFSET(0x863A60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_SET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x863A50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_SET_EVENTID_OFFSET UNITYSDK_OFFSET(0x863A30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_SET_HANDLED_OFFSET UNITYSDK_OFFSET(0x863B00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_SET_INTERNALTIME_OFFSET UNITYSDK_OFFSET(0x322D00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_SET_SIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x8639A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_SET_TIME_OFFSET UNITYSDK_OFFSET(0x863A70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x302300)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x863B20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x863A80)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEvent_TypeDefinitionIndex = 28736;
