...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_GET_STATEFORMAT_OFFSET UNITYSDK_OFFSET(0x2CB090)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_GET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x34CDD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_SET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_SET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x2CB170)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_SET_STATEFORMAT_OFFSET UNITYSDK_OFFSET(0x3197D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DEVICEINFO_SET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x34CE60)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventTrace_DeviceInfo_TypeDefinitionIndex = 27810;
