...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_FROM_OFFSET UNITYSDK_OFFSET(0x1A0ABC80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_GETEVENTSIZEWITHVALUESIZE_OFFSET UNITYSDK_OFFSET(0x1A0ABC70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_GET_BINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x908180)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_GET_CONTROLINDEX_OFFSET UNITYSDK_OFFSET(0x908100)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_GET_INTERACTIONINDEX_OFFSET UNITYSDK_OFFSET(0x908200)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x2F4190)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x908040)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_GET_STATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F2160)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9082A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A0AB9C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_GET_VALUEDATA_OFFSET UNITYSDK_OFFSET(0x908070)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_GET_VALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x908080)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_SET_BINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x908190)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_SET_CONTROLINDEX_OFFSET UNITYSDK_OFFSET(0x908110)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_SET_INTERACTIONINDEX_OFFSET UNITYSDK_OFFSET(0x908220)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_SET_PHASE_OFFSET UNITYSDK_OFFSET(0x908060)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x908050)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_SET_STATEINDEX_OFFSET UNITYSDK_OFFSET(0x908090)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ACTIONEVENT_TOEVENTPTR_OFFSET UNITYSDK_OFFSET(0x878D50)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int ActionEvent_TypeDefinitionIndex = 28724;
