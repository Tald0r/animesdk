...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROMDEFAULTSTATEFOR_OFFSET UNITYSDK_OFFSET(0x1A0FE930)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROMUNCHECKED_OFFSET UNITYSDK_OFFSET(0x1A0F8240)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROM_1_OFFSET UNITYSDK_OFFSET(0x1A0FE690)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROM_2_OFFSET UNITYSDK_OFFSET(0x1A0FE6C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_FROM_OFFSET UNITYSDK_OFFSET(0x1A0FE5D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_GET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x9098E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_GET_STATE_OFFSET UNITYSDK_OFFSET(0x9098F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x909900)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_STATEEVENT_TOEVENTPTR_OFFSET UNITYSDK_OFFSET(0x84A400)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int StateEvent_TypeDefinitionIndex = 27811;
