...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_ADDRECORD_OFFSET UNITYSDK_OFFSET(0x1A0AD2E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_ALLOCATERECORD_OFFSET UNITYSDK_OFFSET(0x1A0AD3C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x1A0ADC50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A0AD2C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_DESTROY_OFFSET UNITYSDK_OFFSET(0x1A0ADC20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A0AD250)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A0AD190)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A0ADB80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GETRECORDUNCHECKED_OFFSET UNITYSDK_OFFSET(0x1A0ADF00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GETRECORD_OFFSET UNITYSDK_OFFSET(0x1A0ACB50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GET_BYTESPERRECORD_OFFSET UNITYSDK_OFFSET(0x1A0ADEA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GET_CONTROLS_OFFSET UNITYSDK_OFFSET(0x1A0ACA30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A0AC7C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GET_EXTRAMEMORYPERRECORD_OFFSET UNITYSDK_OFFSET(0x1A0AC890)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GET_HISTORYDEPTH_OFFSET UNITYSDK_OFFSET(0x1A0AC7E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A0ACA50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GET_ONRECORDADDED_OFFSET UNITYSDK_OFFSET(0x1A0ACD40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GET_ONSHOULDRECORDSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1A0ACD60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GET_UPDATEMASK_OFFSET UNITYSDK_OFFSET(0x1A0AC940)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1A0AC7D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x1A0ADF50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORDINDEXTOUSERINDEX_OFFSET UNITYSDK_OFFSET(0x1A0ADEE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORDSTATECHANGE_1_OFFSET UNITYSDK_OFFSET(0x1A0AD870)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORDSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1A0AD730)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_SET_EXTRAMEMORYPERRECORD_OFFSET UNITYSDK_OFFSET(0x1A0AC8A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_SET_HISTORYDEPTH_OFFSET UNITYSDK_OFFSET(0x1A0AC7F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A0ACC40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_SET_ONRECORDADDED_OFFSET UNITYSDK_OFFSET(0x1A0ACD50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_SET_ONSHOULDRECORDSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1A0ACD70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_SET_UPDATEMASK_OFFSET UNITYSDK_OFFSET(0x1A0AC9B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_STARTRECORDING_OFFSET UNITYSDK_OFFSET(0x1A0AD450)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_STOPRECORDING_OFFSET UNITYSDK_OFFSET(0x1A0AD5C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A0ADBD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYCONTROLSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1A0AE000)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYTIMEREXPIRED_OFFSET UNITYSDK_OFFSET(0x1A0AE130)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_USERINDEXTORECORDINDEX_OFFSET UNITYSDK_OFFSET(0x1A0ACB40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A0ACE10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A0ACFB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A0AD0C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0ACD80)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputStateHistory_TypeDefinitionIndex = 28775;
	...
	public:
		...
		::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputStateHistory_Record>* _onRecordAdded_k__BackingField; // 0x18
		::System::Func_4<::UnityEngine::InputSystem::InputControl*, ::System::Double, ::UnityEngine::InputSystem::LowLevel::InputEventPtr, ::System::Boolean>* _onShouldRecordStateChange_k__BackingField; // 0x20
		::System::Int32 m_HeadIndex; // 0x28
		::System::Int32 m_StateSizeInBytes; // 0x2C
		::System::Int32 m_ControlCount; // 0x30
		::System::Boolean m_AddNewControls; // 0x34
		::System::Nullable_1<::UnityEngine::InputSystem::LowLevel::InputUpdateType> m_UpdateMask; // 0x38
		::System::Int32 m_RecordCount; // 0x40
		::System::UInt32 m_CurrentVersion; // 0x44
