...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSCREENSTATE_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x878D70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSCREENSTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1909F780)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSCREENSTATE_GET_PRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0x878D50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSCREENSTATE_GET_TOUCHES_OFFSET UNITYSDK_OFFSET(0x878D60)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int TouchscreenState_TypeDefinitionIndex = 28721;
