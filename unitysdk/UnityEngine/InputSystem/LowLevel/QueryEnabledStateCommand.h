...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYENABLEDSTATECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1AB0CF90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYENABLEDSTATECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x958AA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYENABLEDSTATECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AB0CF70)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryEnabledStateCommand_TypeDefinitionIndex = 27741;
