...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATE_UPDATESTEPCOUNT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x2D38E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATE_UPDATESTEPCOUNT_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x8F86E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATE_UPDATESTEPCOUNT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x8F86F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATE_UPDATESTEPCOUNT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x2D38F0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputUpdate_UpdateStepCount_TypeDefinitionIndex = 27821;
