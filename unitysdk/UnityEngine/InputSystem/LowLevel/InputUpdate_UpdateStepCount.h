...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATE_UPDATESTEPCOUNT_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x302230)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATE_UPDATESTEPCOUNT_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x92CBE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATE_UPDATESTEPCOUNT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x92CBF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATE_UPDATESTEPCOUNT_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x302120)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputUpdate_UpdateStepCount_TypeDefinitionIndex = 28761;
