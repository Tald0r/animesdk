...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYDIMENSIONSCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1B1A25A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYDIMENSIONSCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x98E230)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYDIMENSIONSCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1B1A2580)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryDimensionsCommand_TypeDefinitionIndex = 28680;
