...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x94FF30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_EQUALS_OFFSET UNITYSDK_OFFSET(0x94FEE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_FROMINPUTEVENTPTR_OFFSET UNITYSDK_OFFSET(0x1AB2F890)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_FROM_OFFSET UNITYSDK_OFFSET(0x1AB2F880)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GET_DATA_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x94FBF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GET_HANDLED_OFFSET UNITYSDK_OFFSET(0x94FA80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GET_ID_OFFSET UNITYSDK_OFFSET(0x94FB20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GET_INTERNALTIME_OFFSET UNITYSDK_OFFSET(0x94FD30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GET_SIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x94FBD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GET_STATEFORMAT_OFFSET UNITYSDK_OFFSET(0x94FDD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GET_STATEOFFSET_OFFSET UNITYSDK_OFFSET(0x94FE60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GET_STATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x94FE50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GET_TIME_OFFSET UNITYSDK_OFFSET(0x94FC80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x94FBC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_GET_VALID_OFFSET UNITYSDK_OFFSET(0x301E20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_NEXT_OFFSET UNITYSDK_OFFSET(0x94FE70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AB2F850)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1AB2F780)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AB2F870)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AB2F860)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_SET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x94FC10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_SET_HANDLED_OFFSET UNITYSDK_OFFSET(0x94FAA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_SET_ID_OFFSET UNITYSDK_OFFSET(0x94FB40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_SET_INTERNALTIME_OFFSET UNITYSDK_OFFSET(0x94FD50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_SET_TIME_OFFSET UNITYSDK_OFFSET(0x94FCA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_TOPOINTER_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x94FEA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTPTR__CTOR_OFFSET UNITYSDK_OFFSET(0x3074E0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventPtr_TypeDefinitionIndex = 28742;
