...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_ALLOCATEDEVICEID_OFFSET UNITYSDK_OFFSET(0x1A6A0750)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_DEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x1A6A07E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_CURRENTTIMEFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6A0FE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_CURRENTTIMEOFFSETTOREALTIMESINCESTARTUP_OFFSET UNITYSDK_OFFSET(0x1A6A1030)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_CURRENTTIME_OFFSET UNITYSDK_OFFSET(0x1A6A0FB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ISINBATCHMODE_OFFSET UNITYSDK_OFFSET(0x1A6A1170)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ISPLAYERFOCUSED_OFFSET UNITYSDK_OFFSET(0x1A6A0F50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6A0920)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1A6A0B00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONPLAYERFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1A6A0D60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONSHOULDRUNUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6A0A10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1A6A0BB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6A0870)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A6A0F60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_RUNINBACKGROUND_OFFSET UNITYSDK_OFFSET(0x1A6A1070)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_SCREENORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A6A1160)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_SCREENSIZE_OFFSET UNITYSDK_OFFSET(0x1A6A1130)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_UNSCALEDGAMETIME_OFFSET UNITYSDK_OFFSET(0x1A6A1060)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1A6A10D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_ONSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1A6A1080)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_ONWANTSTOSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1A6A10A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_QUEUEEVENT_OFFSET UNITYSDK_OFFSET(0x1A6A07B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_REGISTERANALYTICSEVENT_OFFSET UNITYSDK_OFFSET(0x1A6A1180)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SENDANALYTICSEVENT_OFFSET UNITYSDK_OFFSET(0x1A6A1190)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6A0930)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1A6A0B50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONPLAYERFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1A6A0D70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONSHOULDRUNUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6A0A20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1A6A0BC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6A0880)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A6A0F70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A6A0780)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A6A11B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6A11A0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int NativeInputRuntime_TypeDefinitionIndex = 28763;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::LowLevel::NativeInputRuntime**)Il2CppClass::FromTypeDefinitionIndex(NativeInputRuntime_TypeDefinitionIndex)->GetStaticField(0x21900);
		}
		::System::Action* m_ShutdownMethod; // 0x10
		::System::Action_1<::System::Boolean>* m_FocusChangedMethod; // 0x18
		...
		::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate* m_OnUpdate; // 0x30
