...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_ALLOCATEDEVICEID_OFFSET UNITYSDK_OFFSET(0x1A0FDB10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_DEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x1A0FDBA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_CURRENTTIMEFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0FE3A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_CURRENTTIMEOFFSETTOREALTIMESINCESTARTUP_OFFSET UNITYSDK_OFFSET(0x1A0FE3F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_CURRENTTIME_OFFSET UNITYSDK_OFFSET(0x1A0FE370)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ISINBATCHMODE_OFFSET UNITYSDK_OFFSET(0x1A0FE530)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ISPLAYERFOCUSED_OFFSET UNITYSDK_OFFSET(0x1A0FE310)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0FDCE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1A0FDEC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONPLAYERFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1A0FE120)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONSHOULDRUNUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0FDDD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1A0FDF70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0FDC30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A0FE320)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_RUNINBACKGROUND_OFFSET UNITYSDK_OFFSET(0x1A0FE430)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_SCREENORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A0FE520)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_SCREENSIZE_OFFSET UNITYSDK_OFFSET(0x1A0FE4F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_GET_UNSCALEDGAMETIME_OFFSET UNITYSDK_OFFSET(0x1A0FE420)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1A0FE490)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_ONSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1A0FE440)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_ONWANTSTOSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1A0FE460)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_QUEUEEVENT_OFFSET UNITYSDK_OFFSET(0x1A0FDB70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_REGISTERANALYTICSEVENT_OFFSET UNITYSDK_OFFSET(0x1A0FE540)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SENDANALYTICSEVENT_OFFSET UNITYSDK_OFFSET(0x1A0FE550)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0FDCF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x1A0FDF10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONPLAYERFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1A0FE130)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONSHOULDRUNUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0FDDE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1A0FDF80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0FDC40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_SET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A0FE330)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A0FDB40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0FE570)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_NATIVEINPUTRUNTIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0FE560)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int NativeInputRuntime_TypeDefinitionIndex = 27823;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::LowLevel::NativeInputRuntime**)Il2CppClass::FromTypeDefinitionIndex(NativeInputRuntime_TypeDefinitionIndex)->GetStaticField(0x202A0);
		}
		::UnityEngine::InputSystem::LowLevel::InputUpdateDelegate* m_OnUpdate; // 0x10
		::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputUpdateType>* m_OnBeforeUpdate; // 0x18
