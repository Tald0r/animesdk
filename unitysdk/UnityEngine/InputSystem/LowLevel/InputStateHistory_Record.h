...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x878C80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_COPYFROM_OFFSET UNITYSDK_OFFSET(0x878C60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x878C90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_EQUALS_OFFSET UNITYSDK_OFFSET(0x393E00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7DC6F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GETUNSAFEEXTRAMEMORYPTRUNCHECKED_OFFSET UNITYSDK_OFFSET(0x878C50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GETUNSAFEEXTRAMEMORYPTR_OFFSET UNITYSDK_OFFSET(0x878C20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GETUNSAFEMEMORYPTRUNCHECKED_OFFSET UNITYSDK_OFFSET(0x7DC620)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GETUNSAFEMEMORYPTR_OFFSET UNITYSDK_OFFSET(0x878BC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0x878A00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_HEADER_OFFSET UNITYSDK_OFFSET(0x7DC2E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x878980)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_NEXT_OFFSET UNITYSDK_OFFSET(0x878A80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_OWNER_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_PREVIOUS_OFFSET UNITYSDK_OFFSET(0x878B00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_RECORDINDEX_OFFSET UNITYSDK_OFFSET(0x313B90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_TIME_OFFSET UNITYSDK_OFFSET(0x8789C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_VALID_OFFSET UNITYSDK_OFFSET(0x7DC310)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x2F6540)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x878B80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x878D00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEHISTORY_RECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x7DC4F0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputStateHistory_Record_TypeDefinitionIndex = 28780;
