...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ADVANCETONEXTEVENT_OFFSET UNITYSDK_OFFSET(0x9084A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_ALLOCATEEVENT_OFFSET UNITYSDK_OFFSET(0x908440)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_APPENDEVENT_OFFSET UNITYSDK_OFFSET(0x9083A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_CLONE_OFFSET UNITYSDK_OFFSET(0x9085F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_CONTAINS_OFFSET UNITYSDK_OFFSET(0x908450)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9085A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x908540)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_GET_BUFFERPTR_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_GET_CAPACITYINBYTES_OFFSET UNITYSDK_OFFSET(0x908350)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_GET_DATA_OFFSET UNITYSDK_OFFSET(0x2EC7C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_GET_EVENTCOUNT_OFFSET UNITYSDK_OFFSET(0x3186C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_GET_SIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x908480)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x908540)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x908690)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x908370)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x908360)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventBuffer_TypeDefinitionIndex = 28737;
