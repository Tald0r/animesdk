...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_MOUSESTATE_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x9027C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_MOUSESTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x19F6B420)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_MOUSESTATE_WITHBUTTON_OFFSET UNITYSDK_OFFSET(0x902770)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int MouseState_TypeDefinitionIndex = 27770;
