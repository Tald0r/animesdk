...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_APPLYDEVICEMAPPING_OFFSET UNITYSDK_OFFSET(0x1AACA1A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AAC8EC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_FINISHED_OFFSET UNITYSDK_OFFSET(0x1AAC9C60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_GET_CREATEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1AAC8E70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_GET_FINISHED_OFFSET UNITYSDK_OFFSET(0x1AAC8E10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_GET_PAUSED_OFFSET UNITYSDK_OFFSET(0x1AAC8E30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AAC8E50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_GET_TRACE_OFFSET UNITYSDK_OFFSET(0x1AAC8E00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AAC94D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_ONBEGINFRAME_OFFSET UNITYSDK_OFFSET(0x1AAC9F10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1AAC9430)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x1AAC9420)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_PLAYALLEVENTSACCORDINGTOTIMESTAMPS_OFFSET UNITYSDK_OFFSET(0x1AAC9CF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_PLAYALLEVENTS_OFFSET UNITYSDK_OFFSET(0x1AAC9B40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_PLAYALLFRAMESONEBYONE_OFFSET UNITYSDK_OFFSET(0x1AAC9AC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_PLAYONEEVENT_OFFSET UNITYSDK_OFFSET(0x1AAC9440)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_QUEUEEVENT_OFFSET UNITYSDK_OFFSET(0x1AAC97D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_REWIND_OFFSET UNITYSDK_OFFSET(0x1AAC9AA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_SET_FINISHED_OFFSET UNITYSDK_OFFSET(0x1AAC8E20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_SET_PAUSED_OFFSET UNITYSDK_OFFSET(0x1AAC8E40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AAC8E60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_WITHALLDEVICESMAPPEDTONEWINSTANCES_OFFSET UNITYSDK_OFFSET(0x1AAC9410)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_WITHDEVICEMAPPEDFROMTO_1_OFFSET UNITYSDK_OFFSET(0x1AAC9350)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER_WITHDEVICEMAPPEDFROMTO_OFFSET UNITYSDK_OFFSET(0x1AAC92A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAYCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAC8140)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventTrace_ReplayController_TypeDefinitionIndex = 28747;

	class InputEventTrace_ReplayController : public ::System::Object
	{
	public:
		::System::Action_1<::UnityEngine::InputSystem::LowLevel::InputEventPtr>* m_OnEvent; // 0x10
		...
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputDevice*> m_CreatedDevices; // 0x30
		::System::Collections::Generic::List_1<::UnityEngine::InputSystem::LowLevel::InputEventPtr>* m_AllEventsByTime; // 0x48
		::UnityEngine::InputSystem::LowLevel::InputEventTrace_Enumerator* m_Enumerator; // 0x50
		::System::Action* m_OnFinished; // 0x58
		::UnityEngine::InputSystem::LowLevel::InputEventTrace* m_EventTrace; // 0x60
		::System::Double m_StartTimeAsPerFirstEvent; // 0x68
		...
		::System::Boolean m_CreateNewDevices; // 0x84
		::System::Boolean _paused_k__BackingField; // 0x85
		::System::Boolean _finished_k__BackingField; // 0x86
