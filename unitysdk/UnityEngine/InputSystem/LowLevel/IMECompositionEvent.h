...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONEVENT_CREATE_OFFSET UNITYSDK_OFFSET(0x19ABD7A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONEVENT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x8D5E40)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int IMECompositionEvent_TypeDefinitionIndex = 27792;
