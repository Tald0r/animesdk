...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYCANRUNINBACKGROUND_CREATE_OFFSET UNITYSDK_OFFSET(0x1AB2FA70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYCANRUNINBACKGROUND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x94FF90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYCANRUNINBACKGROUND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AB2FA50)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryCanRunInBackground_TypeDefinitionIndex = 28679;
