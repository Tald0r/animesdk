...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DEVICEREMOVEEVENT_CREATE_OFFSET UNITYSDK_OFFSET(0x1A0FDA50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DEVICEREMOVEEVENT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9098C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DEVICEREMOVEEVENT_TOEVENTPTR_OFFSET UNITYSDK_OFFSET(0x84A400)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int DeviceRemoveEvent_TypeDefinitionIndex = 27789;
