...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEIMECOMPOSITIONCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x18682990)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEIMECOMPOSITIONCOMMAND_GET_IMEENABLED_OFFSET UNITYSDK_OFFSET(0x5F25C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEIMECOMPOSITIONCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x8386D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEIMECOMPOSITIONCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x18682960)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int EnableIMECompositionCommand_TypeDefinitionIndex = 27732;
