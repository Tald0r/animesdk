...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x19ECBD70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x8FF0D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19ECBCE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_READLAYOUTNAME_OFFSET UNITYSDK_OFFSET(0x84A3C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_WRITELAYOUTNAME_OFFSET UNITYSDK_OFFSET(0x8FF0A0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryKeyboardLayoutCommand_TypeDefinitionIndex = 27744;
