...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4CB330)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x929AC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A4CB2A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_READLAYOUTNAME_OFFSET UNITYSDK_OFFSET(0x878D10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYBOARDLAYOUTCOMMAND_WRITELAYOUTNAME_OFFSET UNITYSDK_OFFSET(0x929A90)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryKeyboardLayoutCommand_TypeDefinitionIndex = 28684;
