...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AC3C920)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AC3C9B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AC3C5D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTUPDATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC3C5B0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputUpdateDelegate_TypeDefinitionIndex = 28754;
