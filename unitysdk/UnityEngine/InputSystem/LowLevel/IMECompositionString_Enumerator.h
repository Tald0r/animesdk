...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONSTRING_ENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONSTRING_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8B0CD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONSTRING_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8B0C90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONSTRING_ENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8B0CC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONSTRING_ENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8B0CE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IMECOMPOSITIONSTRING_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8B0C60)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int IMECompositionString_Enumerator_TypeDefinitionIndex = 27794;
