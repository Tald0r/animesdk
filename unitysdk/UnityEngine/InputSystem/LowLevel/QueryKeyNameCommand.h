...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYNAMECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1A3EA2B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYNAMECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x913030)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYNAMECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A3EA260)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYNAMECOMMAND_READKEYNAME_OFFSET UNITYSDK_OFFSET(0x913000)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryKeyNameCommand_TypeDefinitionIndex = 27742;
