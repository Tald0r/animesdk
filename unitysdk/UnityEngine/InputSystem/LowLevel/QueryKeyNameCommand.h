...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYNAMECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1A9AE900)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYNAMECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x93F6B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYNAMECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A9AE8B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYKEYNAMECOMMAND_READKEYNAME_OFFSET UNITYSDK_OFFSET(0x93F680)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryKeyNameCommand_TypeDefinitionIndex = 28682;
