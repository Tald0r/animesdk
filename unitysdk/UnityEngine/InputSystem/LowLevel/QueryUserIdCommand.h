...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYUSERIDCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1909F750)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYUSERIDCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x878D40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYUSERIDCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1909F700)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYUSERIDCOMMAND_READID_OFFSET UNITYSDK_OFFSET(0x878D10)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryUserIdCommand_TypeDefinitionIndex = 28691;
