...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TEXTEVENT_CREATE_1_OFFSET UNITYSDK_OFFSET(0x19F76DC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TEXTEVENT_CREATE_OFFSET UNITYSDK_OFFSET(0x19F76D40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TEXTEVENT_FROM_OFFSET UNITYSDK_OFFSET(0x19F76C80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TEXTEVENT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x903820)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int TextEvent_TypeDefinitionIndex = 27813;
