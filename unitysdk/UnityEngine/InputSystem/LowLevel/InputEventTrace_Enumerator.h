...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B154970)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B154AE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B154990)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B154AB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B154AF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B154950)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventTrace_Enumerator_TypeDefinitionIndex = 28745;
