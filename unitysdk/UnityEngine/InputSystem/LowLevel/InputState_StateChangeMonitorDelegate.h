...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_STATECHANGEMONITORDELEGATE_NOTIFYCONTROLSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x18C01710)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_STATECHANGEMONITORDELEGATE_NOTIFYTIMEREXPIRED_OFFSET UNITYSDK_OFFSET(0x18C01790)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_STATECHANGEMONITORDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18C01810)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputState_StateChangeMonitorDelegate_TypeDefinitionIndex = 27831;
