...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEDEVICECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1A57BFF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEDEVICECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x92E040)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_ENABLEDEVICECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A57BFD0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int EnableDeviceCommand_TypeDefinitionIndex = 28671;
