...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_ALLOCATEALL_OFFSET UNITYSDK_OFFSET(0x8CED20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_COMPUTESIZEOFSINGLESTATEBUFFER_OFFSET UNITYSDK_OFFSET(0x19C10AE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_FREEALL_OFFSET UNITYSDK_OFFSET(0x8CEE40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_GETBACKBUFFERFORDEVICE_OFFSET UNITYSDK_OFFSET(0x19C10950)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_GETDOUBLEBUFFERSFOR_OFFSET UNITYSDK_OFFSET(0x8CECA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_GETFRONTBUFFERFORDEVICE_OFFSET UNITYSDK_OFFSET(0x19C10930)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_MIGRATEALL_OFFSET UNITYSDK_OFFSET(0x8CEF10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_MIGRATEDOUBLEBUFFER_OFFSET UNITYSDK_OFFSET(0x19C10E60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_MIGRATESINGLEBUFFER_OFFSET UNITYSDK_OFFSET(0x19C11000)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_NEXTDEVICEOFFSET_OFFSET UNITYSDK_OFFSET(0x19C11100)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_SETUPDEVICETOBUFFERMAPPINGS_OFFSET UNITYSDK_OFFSET(0x19C10BA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_SWITCHTO_OFFSET UNITYSDK_OFFSET(0x19C10970)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputStateBuffers_TypeDefinitionIndex = 28773;

	struct alignas(8) InputStateBuffers
	{
		static ::System::Void** StaticGet_s_ResetMaskBuffer()
		{
			return (::System::Void**)Il2CppClass::FromTypeDefinitionIndex(InputStateBuffers_TypeDefinitionIndex)->GetStaticField(0x4B40);
		}
		static ::System::Void** StaticGet_s_DefaultStateBuffer()
		{
			return (::System::Void**)Il2CppClass::FromTypeDefinitionIndex(InputStateBuffers_TypeDefinitionIndex)->GetStaticField(0x4B48);
		}
		static ::System::Void** StaticGet_s_NoiseMaskBuffer()
		{
			return (::System::Void**)Il2CppClass::FromTypeDefinitionIndex(InputStateBuffers_TypeDefinitionIndex)->GetStaticField(0x4B50);
		}
		static ::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers* StaticGet_s_CurrentBuffers()
		{
			return (::UnityEngine::InputSystem::LowLevel::InputStateBuffers_DoubleBuffers*)Il2CppClass::FromTypeDefinitionIndex(InputStateBuffers_TypeDefinitionIndex)->GetStaticField(0x4B58);
		}
