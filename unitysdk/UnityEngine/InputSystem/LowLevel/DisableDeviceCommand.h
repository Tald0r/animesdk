...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DISABLEDEVICECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1AB0CD90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DISABLEDEVICECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x958A90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DISABLEDEVICECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AB0CD70)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int DisableDeviceCommand_TypeDefinitionIndex = 27730;
