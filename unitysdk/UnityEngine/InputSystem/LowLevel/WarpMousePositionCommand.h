...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_WARPMOUSEPOSITIONCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4CB3C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_WARPMOUSEPOSITIONCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x929AD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_WARPMOUSEPOSITIONCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A4CB3A0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int WarpMousePositionCommand_TypeDefinitionIndex = 28697;
