...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_POINTERSTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x95B6C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_POINTERSTATE_GET_KFORMAT_OFFSET UNITYSDK_OFFSET(0x1AB827B0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int PointerState_TypeDefinitionIndex = 27773;
