...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETSAMPLINGFREQUENCYCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1AB82820)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETSAMPLINGFREQUENCYCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x95B6E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETSAMPLINGFREQUENCYCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AB82800)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int SetSamplingFrequencyCommand_TypeDefinitionIndex = 27756;
