...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ADD_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1A50D190)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x1A50EC70)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A50EB40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DISABLE_OFFSET UNITYSDK_OFFSET(0x1A50E720)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A50ED00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ENABLE_OFFSET UNITYSDK_OFFSET(0x1A50EB60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A50DBC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GETNEXTEVENT_OFFSET UNITYSDK_OFFSET(0x1A50EAD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_ALLOCATEDSIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1A50D100)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x1A50CFD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_DEVICEINFOS_OFFSET UNITYSDK_OFFSET(0x1A50D140)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A50CFF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_EVENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A50D0E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_FRAMEMARKEREVENT_OFFSET UNITYSDK_OFFSET(0x1A50CFC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_KFILEFORMAT_OFFSET UNITYSDK_OFFSET(0x1A50DBB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_MAXSIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1A50D130)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_M_EVENTBUFFERHEAD_OFFSET UNITYSDK_OFFSET(0x1A50EAC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_M_EVENTBUFFERTAIL_OFFSET UNITYSDK_OFFSET(0x1A50ECA0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_M_EVENTBUFFER_OFFSET UNITYSDK_OFFSET(0x1A50D120)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_ONFILTEREVENT_OFFSET UNITYSDK_OFFSET(0x1A50D170)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_RECORDFRAMEMARKERS_OFFSET UNITYSDK_OFFSET(0x1A50D000)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_GET_TOTALEVENTSIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1A50D0F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_LOADFROM_1_OFFSET UNITYSDK_OFFSET(0x1A50E5B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_LOADFROM_OFFSET UNITYSDK_OFFSET(0x1A50E450)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A50EDB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_ONINPUTEVENT_OFFSET UNITYSDK_OFFSET(0x1A50EE80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_READFROM_1_OFFSET UNITYSDK_OFFSET(0x1A50DD50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_READFROM_OFFSET UNITYSDK_OFFSET(0x1A50DC10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A50ED60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REMOVE_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1A50D1E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_REPLAY_OFFSET UNITYSDK_OFFSET(0x1A50E680)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_RESIZE_OFFSET UNITYSDK_OFFSET(0x1A50E840)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x1A50CFE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SET_M_EVENTBUFFERHEAD_OFFSET UNITYSDK_OFFSET(0x1A50E430)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SET_M_EVENTBUFFERTAIL_OFFSET UNITYSDK_OFFSET(0x1A50E440)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SET_M_EVENTBUFFER_OFFSET UNITYSDK_OFFSET(0x1A50E420)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SET_ONFILTEREVENT_OFFSET UNITYSDK_OFFSET(0x1A50D180)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SET_RECORDFRAMEMARKERS_OFFSET UNITYSDK_OFFSET(0x1A50D010)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A50ECB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_WRITETO_1_OFFSET UNITYSDK_OFFSET(0x1A50D490)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE_WRITETO_OFFSET UNITYSDK_OFFSET(0x1A50D350)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A50F3D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A50D300)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTTRACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A50D230)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventTrace_TypeDefinitionIndex = 27804;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(InputEventTrace_TypeDefinitionIndex)->GetStaticField(0x4CA0);
		}
