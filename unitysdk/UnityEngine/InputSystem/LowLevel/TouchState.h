...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_BEGANINSAMEFRAME_OFFSET UNITYSDK_OFFSET(0x9028B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x9028D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x19F6B490)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISINDIRECTTOUCH_OFFSET UNITYSDK_OFFSET(0x902850)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISINPROGRESS_OFFSET UNITYSDK_OFFSET(0x9027F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISNONEENDEDORCANCELED_OFFSET UNITYSDK_OFFSET(0x9027D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISORPHANEDPRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0x902830)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISPRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0x902810)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISTAPPRESS_OFFSET UNITYSDK_OFFSET(0x902870)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISTAPRELEASE_OFFSET UNITYSDK_OFFSET(0x902890)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISTAP_OFFSET UNITYSDK_OFFSET(0x902870)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x2D86F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_BEGANINSAMEFRAME_OFFSET UNITYSDK_OFFSET(0x9028C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISINDIRECTTOUCH_OFFSET UNITYSDK_OFFSET(0x902860)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISORPHANEDPRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0x902840)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISPRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0x902820)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISTAPPRESS_OFFSET UNITYSDK_OFFSET(0x902880)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISTAPRELEASE_OFFSET UNITYSDK_OFFSET(0x9028A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISTAP_OFFSET UNITYSDK_OFFSET(0x902880)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_PHASE_OFFSET UNITYSDK_OFFSET(0x2D8700)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9028E0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int TouchState_TypeDefinitionIndex = 27780;
