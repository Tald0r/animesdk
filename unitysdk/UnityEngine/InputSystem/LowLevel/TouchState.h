...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_BEGANINSAMEFRAME_OFFSET UNITYSDK_OFFSET(0x92E240)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x92E260)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1A57C2D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISINDIRECTTOUCH_OFFSET UNITYSDK_OFFSET(0x92E1E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISINPROGRESS_OFFSET UNITYSDK_OFFSET(0x92E180)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISNONEENDEDORCANCELED_OFFSET UNITYSDK_OFFSET(0x92E160)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISORPHANEDPRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0x92E1C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISPRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0x92E1A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISTAPPRESS_OFFSET UNITYSDK_OFFSET(0x92E200)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISTAPRELEASE_OFFSET UNITYSDK_OFFSET(0x92E220)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_ISTAP_OFFSET UNITYSDK_OFFSET(0x92E200)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x322CF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_BEGANINSAMEFRAME_OFFSET UNITYSDK_OFFSET(0x92E250)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISINDIRECTTOUCH_OFFSET UNITYSDK_OFFSET(0x92E1F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISORPHANEDPRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0x92E1D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISPRIMARYTOUCH_OFFSET UNITYSDK_OFFSET(0x92E1B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISTAPPRESS_OFFSET UNITYSDK_OFFSET(0x92E210)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISTAPRELEASE_OFFSET UNITYSDK_OFFSET(0x92E230)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_ISTAP_OFFSET UNITYSDK_OFFSET(0x92E210)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_SET_PHASE_OFFSET UNITYSDK_OFFSET(0x322CE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_TOUCHSTATE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x92E270)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int TouchState_TypeDefinitionIndex = 28720;
