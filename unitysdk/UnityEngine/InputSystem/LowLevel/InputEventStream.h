...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_ADVANCE_OFFSET UNITYSDK_OFFSET(0x912EE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_CLEANUPAFTEREXCEPTION_OFFSET UNITYSDK_OFFSET(0x912E60)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x912D90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_GET_CURRENTEVENTPTR_OFFSET UNITYSDK_OFFSET(0x912D10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_GET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x912CE0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_GET_NUMBYTESRETAINEDINBUFFER_OFFSET UNITYSDK_OFFSET(0x912D30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_GET_NUMEVENTSRETAINEDINBUFFER_OFFSET UNITYSDK_OFFSET(0x912D00)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_GET_REMAININGEVENTCOUNT_OFFSET UNITYSDK_OFFSET(0x912CF0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_PEEK_OFFSET UNITYSDK_OFFSET(0x912FB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x912ED0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x912D40)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventStream_TypeDefinitionIndex = 27803;
