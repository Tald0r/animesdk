...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_ADVANCE_OFFSET UNITYSDK_OFFSET(0x93F560)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_CLEANUPAFTEREXCEPTION_OFFSET UNITYSDK_OFFSET(0x93F4E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_CLOSE_OFFSET UNITYSDK_OFFSET(0x93F410)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_GET_CURRENTEVENTPTR_OFFSET UNITYSDK_OFFSET(0x93F390)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_GET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x93F360)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_GET_NUMBYTESRETAINEDINBUFFER_OFFSET UNITYSDK_OFFSET(0x93F3B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_GET_NUMEVENTSRETAINEDINBUFFER_OFFSET UNITYSDK_OFFSET(0x93F380)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_GET_REMAININGEVENTCOUNT_OFFSET UNITYSDK_OFFSET(0x93F370)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_PEEK_OFFSET UNITYSDK_OFFSET(0x93F630)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x93F550)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTEVENTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x93F3C0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputEventStream_TypeDefinitionIndex = 28743;
