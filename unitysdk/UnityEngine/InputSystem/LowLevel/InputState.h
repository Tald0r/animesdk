...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ADDCHANGEMONITORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1AD3AD20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ADDCHANGEMONITOR_1_OFFSET UNITYSDK_OFFSET(0x1AD3AB80)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ADDCHANGEMONITOR_OFFSET UNITYSDK_OFFSET(0x1AD3AA20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ADD_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x1AD3A4B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_CHANGE_OFFSET UNITYSDK_OFFSET(0x1AD3A5D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_GET_CURRENTTIME_OFFSET UNITYSDK_OFFSET(0x1AD3A460)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_GET_CURRENTUPDATETYPE_OFFSET UNITYSDK_OFFSET(0x1AD3A440)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_GET_UPDATECOUNT_OFFSET UNITYSDK_OFFSET(0x1AD3A450)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ISINTEGERFORMAT_OFFSET UNITYSDK_OFFSET(0x1AD3A850)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_REMOVECHANGEMONITORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1AD3AE30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_REMOVECHANGEMONITOR_OFFSET UNITYSDK_OFFSET(0x1AD3AC30)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_REMOVE_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x1AD3A540)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputState_TypeDefinitionIndex = 28770;
