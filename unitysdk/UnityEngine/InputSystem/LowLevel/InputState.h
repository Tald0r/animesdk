...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ADDCHANGEMONITORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A78ABC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ADDCHANGEMONITOR_1_OFFSET UNITYSDK_OFFSET(0x1A78AA20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ADDCHANGEMONITOR_OFFSET UNITYSDK_OFFSET(0x1A78A8C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ADD_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A78A350)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_CHANGE_OFFSET UNITYSDK_OFFSET(0x1A78A470)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_GET_CURRENTTIME_OFFSET UNITYSDK_OFFSET(0x1A78A300)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_GET_CURRENTUPDATETYPE_OFFSET UNITYSDK_OFFSET(0x1A78A2E0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_GET_UPDATECOUNT_OFFSET UNITYSDK_OFFSET(0x1A78A2F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_ISINTEGERFORMAT_OFFSET UNITYSDK_OFFSET(0x1A78A6F0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_REMOVECHANGEMONITORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A78ACD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_REMOVECHANGEMONITOR_OFFSET UNITYSDK_OFFSET(0x1A78AAD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATE_REMOVE_ONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A78A3E0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputState_TypeDefinitionIndex = 27830;
