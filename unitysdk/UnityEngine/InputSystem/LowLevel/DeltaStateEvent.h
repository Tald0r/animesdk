...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DELTASTATEEVENT_FROMUNCHECKED_OFFSET UNITYSDK_OFFSET(0x1B154690)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DELTASTATEEVENT_FROM_1_OFFSET UNITYSDK_OFFSET(0x1B1546A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DELTASTATEEVENT_FROM_OFFSET UNITYSDK_OFFSET(0x1B1545D0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DELTASTATEEVENT_GET_DELTASTATESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x98CAB0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DELTASTATEEVENT_GET_DELTASTATE_OFFSET UNITYSDK_OFFSET(0x98CAC0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DELTASTATEEVENT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x98CAD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_DELTASTATEEVENT_TOEVENTPTR_OFFSET UNITYSDK_OFFSET(0x878D50)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int DeltaStateEvent_TypeDefinitionIndex = 28726;
