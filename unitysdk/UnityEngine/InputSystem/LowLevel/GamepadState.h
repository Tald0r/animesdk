...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_GAMEPADSTATE_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x8F8640)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_GAMEPADSTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x19DA7A40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_GAMEPADSTATE_WITHBUTTON_OFFSET UNITYSDK_OFFSET(0x8F8660)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_GAMEPADSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F8650)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int GamepadState_TypeDefinitionIndex = 27758;
