...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICECOMMAND_ALLOCATENATIVE_OFFSET UNITYSDK_OFFSET(0x19EC9750)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICECOMMAND_GET_PAYLOADPTR_OFFSET UNITYSDK_OFFSET(0x8FF090)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICECOMMAND_GET_PAYLOADSIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x8FF080)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x2FB060)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICECOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3730)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputDeviceCommand_TypeDefinitionIndex = 27738;
