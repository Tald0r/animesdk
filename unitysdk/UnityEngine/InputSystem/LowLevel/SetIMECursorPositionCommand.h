...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETIMECURSORPOSITIONCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x19D9E2B0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETIMECURSORPOSITIONCOMMAND_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETIMECURSORPOSITIONCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x8F87A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_SETIMECURSORPOSITIONCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19DA83F0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int SetIMECursorPositionCommand_TypeDefinitionIndex = 27755;
