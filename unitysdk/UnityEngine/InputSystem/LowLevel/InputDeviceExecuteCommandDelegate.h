...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICEEXECUTECOMMANDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A55E6C0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICEEXECUTECOMMANDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A55E730)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICEEXECUTECOMMANDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A55E370)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTDEVICEEXECUTECOMMANDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A55E350)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputDeviceExecuteCommandDelegate_TypeDefinitionIndex = 28677;
