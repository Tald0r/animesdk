...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_DOUBLEBUFFERS_GETBACKBUFFER_OFFSET UNITYSDK_OFFSET(0x9087A0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_DOUBLEBUFFERS_GETFRONTBUFFER_OFFSET UNITYSDK_OFFSET(0x908790)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_DOUBLEBUFFERS_GET_VALID_OFFSET UNITYSDK_OFFSET(0x301E20)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_DOUBLEBUFFERS_SETBACKBUFFER_OFFSET UNITYSDK_OFFSET(0x908770)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_DOUBLEBUFFERS_SETFRONTBUFFER_OFFSET UNITYSDK_OFFSET(0x908760)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_INPUTSTATEBUFFERS_DOUBLEBUFFERS_SWAPBUFFERS_OFFSET UNITYSDK_OFFSET(0x9087C0)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int InputStateBuffers_DoubleBuffers_TypeDefinitionIndex = 28774;
