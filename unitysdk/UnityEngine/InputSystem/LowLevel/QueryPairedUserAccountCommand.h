...
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1A55EBD0)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_GET_ID_OFFSET UNITYSDK_OFFSET(0x92CC10)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_GET_NAME_OFFSET UNITYSDK_OFFSET(0x92CC50)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x92CC90)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A55E960)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_SET_ID_OFFSET UNITYSDK_OFFSET(0x92CC40)
#define UNITYENGINE_INPUTSYSTEM_LOWLEVEL_QUERYPAIREDUSERACCOUNTCOMMAND_SET_NAME_OFFSET UNITYSDK_OFFSET(0x92CC80)

namespace UnityEngine::InputSystem::LowLevel
{
	inline static constexpr unsigned int QueryPairedUserAccountCommand_TypeDefinitionIndex = 28686;
