...
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIONEVENT_GET_ACTIONID_OFFSET UNITYSDK_OFFSET(0x1B1A25F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIONEVENT_GET_ACTIONNAME_OFFSET UNITYSDK_OFFSET(0x1B1A2600)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIONEVENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1A2620)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIONEVENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B1A2840)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A2610)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int PlayerInput_ActionEvent_TypeDefinitionIndex = 28528;
