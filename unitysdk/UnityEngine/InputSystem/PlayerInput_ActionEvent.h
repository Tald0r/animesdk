...
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIONEVENT_GET_ACTIONID_OFFSET UNITYSDK_OFFSET(0x1AB82840)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIONEVENT_GET_ACTIONNAME_OFFSET UNITYSDK_OFFSET(0x1AB82850)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIONEVENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB82870)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIONEVENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB82A90)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIONEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB82860)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int PlayerInput_ActionEvent_TypeDefinitionIndex = 27588;
