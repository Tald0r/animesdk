...
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A3E5CB0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_DISABLE_OFFSET UNITYSDK_OFFSET(0x1A3E5E10)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A3E5AC0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_ENABLE_OFFSET UNITYSDK_OFFSET(0x1A3E5DF0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_FINDACTION_OFFSET UNITYSDK_OFFSET(0x1A3E5EA0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_FINDBINDING_OFFSET UNITYSDK_OFFSET(0x1A3E5EC0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A3E5D50)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1A3E5820)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x1A3E5B10)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x1A3E5E30)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_CONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x1A3E5C70)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1A3E5BD0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_GAMEPADSCHEME_OFFSET UNITYSDK_OFFSET(0x1A3E6020)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_JOYSTICKSCHEME_OFFSET UNITYSDK_OFFSET(0x1A3E6160)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_KEYBOARDMOUSESCHEME_OFFSET UNITYSDK_OFFSET(0x1A3E5F40)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_PLAYER_OFFSET UNITYSDK_OFFSET(0x1A3E5F20)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_TOUCHSCHEME_OFFSET UNITYSDK_OFFSET(0x1A3E60C0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_UI_OFFSET UNITYSDK_OFFSET(0x1A3E5F30)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_GET_XRSCHEME_OFFSET UNITYSDK_OFFSET(0x1A3E6200)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_SET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x1A3E5B60)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_SET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1A3E5C30)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A3E5DA0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E5830)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int DefaultInputActions_TypeDefinitionIndex = 27581;

	class DefaultInputActions : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::InputAction* m_UI_ScrollWheel; // 0x10
		::UnityEngine::InputSystem::InputActionMap* m_UI; // 0x18
		::UnityEngine::InputSystem::InputAction* m_UI_TrackedDevicePosition; // 0x20
		::UnityEngine::InputSystem::InputAction* m_UI_MiddleClick; // 0x28
		::UnityEngine::InputSystem::InputAction* m_UI_RightClick; // 0x30
		::UnityEngine::InputSystem::InputAction* m_UI_Point; // 0x38
		::UnityEngine::InputSystem::InputAction* m_UI_Cancel; // 0x40
		::UnityEngine::InputSystem::InputAction* m_UI_Navigate; // 0x48
		::UnityEngine::InputSystem::InputAction* m_UI_Click; // 0x50
		::UnityEngine::InputSystem::DefaultInputActions_IUIActions* m_UIActionsCallbackInterface; // 0x58
		::UnityEngine::InputSystem::InputAction* m_UI_Submit; // 0x60
		::UnityEngine::InputSystem::InputActionMap* m_Player; // 0x68
		...
		::UnityEngine::InputSystem::DefaultInputActions_IPlayerActions* m_PlayerActionsCallbackInterface; // 0x90
		::UnityEngine::InputSystem::InputAction* m_Player_Look; // 0x98
		::System::Int32 m_TouchSchemeIndex; // 0xA0
		::System::Int32 m_JoystickSchemeIndex; // 0xA4
