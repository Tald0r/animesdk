...
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_ONSCREENDEVICEINFO_ADDCONTROL_OFFSET UNITYSDK_OFFSET(0x909930)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_ONSCREENDEVICEINFO_DESTROY_OFFSET UNITYSDK_OFFSET(0x909990)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENCONTROL_ONSCREENDEVICEINFO_REMOVECONTROL_OFFSET UNITYSDK_OFFSET(0x909970)

namespace UnityEngine::InputSystem::OnScreen
{
	inline static constexpr unsigned int OnScreenControl_OnScreenDeviceInfo_TypeDefinitionIndex = 27670;
