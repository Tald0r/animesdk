...
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON_GET_CONTROLPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A58C290)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1A58C280)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1A58C270)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON_SET_CONTROLPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A58C2A0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1A58C2B0)

namespace UnityEngine::InputSystem::OnScreen
{
	inline static constexpr unsigned int OnScreenButton_TypeDefinitionIndex = 27668;
