...
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON_GET_CONTROLPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AB2FAB0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1AB2FAA0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1AB2FA90)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON_SET_CONTROLPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AB2FAC0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB2FAD0)

namespace UnityEngine::InputSystem::OnScreen
{
	inline static constexpr unsigned int OnScreenButton_TypeDefinitionIndex = 28608;
