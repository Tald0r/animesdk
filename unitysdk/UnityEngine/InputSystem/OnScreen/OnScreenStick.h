...
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_GET_CONTROLPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A9AEEC0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_GET_MOVEMENTRANGE_OFFSET UNITYSDK_OFFSET(0x1A9AEEA0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1A9AEB00)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1A9AE970)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1A9AEDD0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_SET_CONTROLPATHINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A9AEED0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_SET_MOVEMENTRANGE_OFFSET UNITYSDK_OFFSET(0x1A9AEEB0)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK_START_OFFSET UNITYSDK_OFFSET(0x1A9AEE40)
#define UNITYENGINE_INPUTSYSTEM_ONSCREEN_ONSCREENSTICK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9AEEE0)

namespace UnityEngine::InputSystem::OnScreen
{
	inline static constexpr unsigned int OnScreenStick_TypeDefinitionIndex = 28611;
