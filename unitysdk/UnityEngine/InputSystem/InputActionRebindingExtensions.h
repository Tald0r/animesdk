...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_ADDBINDINGOVERRIDEJSONTO_OFFSET UNITYSDK_OFFSET(0x1A585920)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDESONMATCHINGCONTROLS_1_OFFSET UNITYSDK_OFFSET(0x1A585340)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDESONMATCHINGCONTROLS_OFFSET UNITYSDK_OFFSET(0x1A585050)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1A584770)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_1_OFFSET UNITYSDK_OFFSET(0x1A583790)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_2_OFFSET UNITYSDK_OFFSET(0x1A5839D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_3_OFFSET UNITYSDK_OFFSET(0x1A583C50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_4_OFFSET UNITYSDK_OFFSET(0x1A583870)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_5_OFFSET UNITYSDK_OFFSET(0x1A583AD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_APPLYBINDINGOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A583670)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_DEFERBINDINGRESOLUTION_OFFSET UNITYSDK_OFFSET(0x1A584590)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGDISPLAYSTRING_1_OFFSET UNITYSDK_OFFSET(0x1A582D30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGDISPLAYSTRING_2_OFFSET UNITYSDK_OFFSET(0x1A582F50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGDISPLAYSTRING_3_OFFSET UNITYSDK_OFFSET(0x1A583000)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGDISPLAYSTRING_OFFSET UNITYSDK_OFFSET(0x1A582950)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGFORCONTROL_OFFSET UNITYSDK_OFFSET(0x1A5825D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGINDEXFORCONTROL_OFFSET UNITYSDK_OFFSET(0x1A582770)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGINDEX_1_OFFSET UNITYSDK_OFFSET(0x1A582340)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGINDEX_2_OFFSET UNITYSDK_OFFSET(0x1A582430)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_GETBINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x1A582220)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_LOADBINDINGOVERRIDESFROMJSONINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A586120)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_LOADBINDINGOVERRIDESFROMJSON_1_OFFSET UNITYSDK_OFFSET(0x1A586420)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_LOADBINDINGOVERRIDESFROMJSON_OFFSET UNITYSDK_OFFSET(0x1A585FE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_PERFORMINTERACTIVEREBINDING_OFFSET UNITYSDK_OFFSET(0x1A586580)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEALLBINDINGOVERRIDES_1_OFFSET UNITYSDK_OFFSET(0x1A5845E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEALLBINDINGOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1A584020)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEBINDINGOVERRIDES_OFFSET UNITYSDK_OFFSET(0x1A584BA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEBINDINGOVERRIDE_1_OFFSET UNITYSDK_OFFSET(0x1A583DF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEBINDINGOVERRIDE_2_OFFSET UNITYSDK_OFFSET(0x1A583F60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_REMOVEBINDINGOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A583D00)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_SAVEBINDINGOVERRIDESASJSON_1_OFFSET UNITYSDK_OFFSET(0x1A585B60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREBINDINGEXTENSIONS_SAVEBINDINGOVERRIDESASJSON_OFFSET UNITYSDK_OFFSET(0x1A585430)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionRebindingExtensions_TypeDefinitionIndex = 28374;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::InputActionRebindingExtensions_DeferBindingResolutionWrapper**)Il2CppClass::FromTypeDefinitionIndex(InputActionRebindingExtensions_TypeDefinitionIndex)->GetStaticField(0x21690);
		}
