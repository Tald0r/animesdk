...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDACTIONMAP_1_OFFSET UNITYSDK_OFFSET(0x19F61BC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDACTIONMAP_OFFSET UNITYSDK_OFFSET(0x19F619F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDACTION_OFFSET UNITYSDK_OFFSET(0x19F62180)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x19F63120)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_1_OFFSET UNITYSDK_OFFSET(0x19F63020)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_2_OFFSET UNITYSDK_OFFSET(0x19F62F20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_3_OFFSET UNITYSDK_OFFSET(0x19F63320)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_4_OFFSET UNITYSDK_OFFSET(0x19F63530)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_5_OFFSET UNITYSDK_OFFSET(0x19F63760)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_6_OFFSET UNITYSDK_OFFSET(0x19F63420)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_OFFSET UNITYSDK_OFFSET(0x19F62840)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDCOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x19F63960)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDCONTROLSCHEME_1_OFFSET UNITYSDK_OFFSET(0x19F64B70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x19F64930)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDINGWITHGROUP_OFFSET UNITYSDK_OFFSET(0x19F64210)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDINGWITHID_1_OFFSET UNITYSDK_OFFSET(0x19F64120)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDINGWITHID_OFFSET UNITYSDK_OFFSET(0x19F64050)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDINGWITHPATH_OFFSET UNITYSDK_OFFSET(0x19F642E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDING_1_OFFSET UNITYSDK_OFFSET(0x19F63BC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDING_2_OFFSET UNITYSDK_OFFSET(0x19F63F80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDING_3_OFFSET UNITYSDK_OFFSET(0x19F63C20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDING_OFFSET UNITYSDK_OFFSET(0x19F63B10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGECOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x19F643A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ORWITHOPTIONALDEVICE_OFFSET UNITYSDK_OFFSET(0x19F65270)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ORWITHREQUIREDDEVICE_OFFSET UNITYSDK_OFFSET(0x19F651C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_REMOVEACTIONMAP_1_OFFSET UNITYSDK_OFFSET(0x19F62040)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_REMOVEACTIONMAP_OFFSET UNITYSDK_OFFSET(0x19F61E50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_REMOVEACTION_1_OFFSET UNITYSDK_OFFSET(0x19F62DF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_REMOVEACTION_OFFSET UNITYSDK_OFFSET(0x19F628B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_REMOVECONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x19F64D20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_RENAME_OFFSET UNITYSDK_OFFSET(0x19F64620)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_WITHBINDINGGROUP_OFFSET UNITYSDK_OFFSET(0x19F64EC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_WITHDEVICE_OFFSET UNITYSDK_OFFSET(0x19F64F90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_WITHOPTIONALDEVICE_OFFSET UNITYSDK_OFFSET(0x19F65110)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_WITHREQUIREDDEVICE_OFFSET UNITYSDK_OFFSET(0x19F65060)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionSetupExtensions_TypeDefinitionIndex = 27442;
