...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDACTIONMAP_1_OFFSET UNITYSDK_OFFSET(0x1A572A30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDACTIONMAP_OFFSET UNITYSDK_OFFSET(0x1A572860)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDACTION_OFFSET UNITYSDK_OFFSET(0x1A572FF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDINGINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A573F90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_1_OFFSET UNITYSDK_OFFSET(0x1A573E90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_2_OFFSET UNITYSDK_OFFSET(0x1A573D90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_3_OFFSET UNITYSDK_OFFSET(0x1A574190)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_4_OFFSET UNITYSDK_OFFSET(0x1A5743A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_5_OFFSET UNITYSDK_OFFSET(0x1A5745D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_6_OFFSET UNITYSDK_OFFSET(0x1A574290)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDBINDING_OFFSET UNITYSDK_OFFSET(0x1A5736B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDCOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x1A5747D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDCONTROLSCHEME_1_OFFSET UNITYSDK_OFFSET(0x1A5759E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ADDCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x1A5757A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDINGWITHGROUP_OFFSET UNITYSDK_OFFSET(0x1A575080)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDINGWITHID_1_OFFSET UNITYSDK_OFFSET(0x1A574F90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDINGWITHID_OFFSET UNITYSDK_OFFSET(0x1A574EC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDINGWITHPATH_OFFSET UNITYSDK_OFFSET(0x1A575150)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDING_1_OFFSET UNITYSDK_OFFSET(0x1A574A30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDING_2_OFFSET UNITYSDK_OFFSET(0x1A574DF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDING_3_OFFSET UNITYSDK_OFFSET(0x1A574A90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGEBINDING_OFFSET UNITYSDK_OFFSET(0x1A574980)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CHANGECOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x1A575210)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ORWITHOPTIONALDEVICE_OFFSET UNITYSDK_OFFSET(0x1A5760E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_ORWITHREQUIREDDEVICE_OFFSET UNITYSDK_OFFSET(0x1A576030)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_REMOVEACTIONMAP_1_OFFSET UNITYSDK_OFFSET(0x1A572EB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_REMOVEACTIONMAP_OFFSET UNITYSDK_OFFSET(0x1A572CC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_REMOVEACTION_1_OFFSET UNITYSDK_OFFSET(0x1A573C60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_REMOVEACTION_OFFSET UNITYSDK_OFFSET(0x1A573720)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_REMOVECONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x1A575B90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_RENAME_OFFSET UNITYSDK_OFFSET(0x1A575490)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_WITHBINDINGGROUP_OFFSET UNITYSDK_OFFSET(0x1A575D30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_WITHDEVICE_OFFSET UNITYSDK_OFFSET(0x1A575E00)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_WITHOPTIONALDEVICE_OFFSET UNITYSDK_OFFSET(0x1A575F80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_WITHREQUIREDDEVICE_OFFSET UNITYSDK_OFFSET(0x1A575ED0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionSetupExtensions_TypeDefinitionIndex = 28382;
