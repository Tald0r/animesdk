...
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x19EC7A80)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_ABUTTON_OFFSET UNITYSDK_OFFSET(0x19EC7790)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_ALL_OFFSET UNITYSDK_OFFSET(0x19EC7A50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_BBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC77A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_BUTTONEAST_OFFSET UNITYSDK_OFFSET(0x19EC7610)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_BUTTONNORTH_OFFSET UNITYSDK_OFFSET(0x19EC75D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_BUTTONSOUTH_OFFSET UNITYSDK_OFFSET(0x19EC75F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_BUTTONWEST_OFFSET UNITYSDK_OFFSET(0x19EC75B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_CIRCLEBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC77F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_CROSSBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC7800)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19EC7A30)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_DPAD_OFFSET UNITYSDK_OFFSET(0x19EC76B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19EC7810)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_LEFTSHOULDER_OFFSET UNITYSDK_OFFSET(0x19EC76D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_LEFTSTICKBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC7630)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_LEFTSTICK_OFFSET UNITYSDK_OFFSET(0x19EC7710)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_LEFTTRIGGER_OFFSET UNITYSDK_OFFSET(0x19EC7750)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_RIGHTSHOULDER_OFFSET UNITYSDK_OFFSET(0x19EC76F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_RIGHTSTICKBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC7650)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_RIGHTSTICK_OFFSET UNITYSDK_OFFSET(0x19EC7730)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_RIGHTTRIGGER_OFFSET UNITYSDK_OFFSET(0x19EC7770)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_SELECTBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC7690)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_SQUAREBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC77E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_STARTBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC7670)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_TRIANGLEBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC77D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_XBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC77B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_GET_YBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC77C0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_MAKECURRENT_OFFSET UNITYSDK_OFFSET(0x19EC7C70)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_ONADDED_OFFSET UNITYSDK_OFFSET(0x19EC7C80)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x19EC7CE0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x19EC7E40)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x19EC7F60)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x19EC7F50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x19EC7F70)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_BUTTONEAST_OFFSET UNITYSDK_OFFSET(0x19EC7620)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_BUTTONNORTH_OFFSET UNITYSDK_OFFSET(0x19EC75E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_BUTTONSOUTH_OFFSET UNITYSDK_OFFSET(0x19EC7600)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_BUTTONWEST_OFFSET UNITYSDK_OFFSET(0x19EC75C0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19EC7A40)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_DPAD_OFFSET UNITYSDK_OFFSET(0x19EC76C0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_LEFTSHOULDER_OFFSET UNITYSDK_OFFSET(0x19EC76E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_LEFTSTICKBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC7640)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_LEFTSTICK_OFFSET UNITYSDK_OFFSET(0x19EC7720)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_LEFTTRIGGER_OFFSET UNITYSDK_OFFSET(0x19EC7760)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_RIGHTSHOULDER_OFFSET UNITYSDK_OFFSET(0x19EC7700)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_RIGHTSTICKBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC7660)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_RIGHTSTICK_OFFSET UNITYSDK_OFFSET(0x19EC7740)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_RIGHTTRIGGER_OFFSET UNITYSDK_OFFSET(0x19EC7780)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_SELECTBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC76A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD_SET_STARTBUTTON_OFFSET UNITYSDK_OFFSET(0x19EC7680)
#define UNITYENGINE_INPUTSYSTEM_GAMEPAD__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC8070)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int Gamepad_TypeDefinitionIndex = 27513;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::Gamepad**)Il2CppClass::FromTypeDefinitionIndex(Gamepad_TypeDefinitionIndex)->GetStaticField(0x1FEC0);
		}
		static ::Il2CppArray<::UnityEngine::InputSystem::Gamepad*>** StaticGet_s_Gamepads()
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::Gamepad*>**)Il2CppClass::FromTypeDefinitionIndex(Gamepad_TypeDefinitionIndex)->GetStaticField(0x1FEC8);
		}
		static ::System::Int32* StaticGet_s_GamepadCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Gamepad_TypeDefinitionIndex)->GetStaticField(0x4C40);
		}
		::UnityEngine::InputSystem::Controls::ButtonControl* _startButton_k__BackingField; // 0x158
		::UnityEngine::InputSystem::Controls::StickControl* _leftStick_k__BackingField; // 0x160
		::UnityEngine::InputSystem::Controls::ButtonControl* _rightTrigger_k__BackingField; // 0x168
		::UnityEngine::InputSystem::Controls::ButtonControl* _leftTrigger_k__BackingField; // 0x170
		::UnityEngine::InputSystem::Controls::StickControl* _rightStick_k__BackingField; // 0x178
		::UnityEngine::InputSystem::Controls::ButtonControl* _rightShoulder_k__BackingField; // 0x180
		::UnityEngine::InputSystem::Controls::ButtonControl* _buttonSouth_k__BackingField; // 0x188
		...
		::UnityEngine::InputSystem::Controls::ButtonControl* _rightStickButton_k__BackingField; // 0x1A0
		::UnityEngine::InputSystem::Controls::DpadControl* _dpad_k__BackingField; // 0x1A8
		::UnityEngine::InputSystem::Controls::ButtonControl* _leftShoulder_k__BackingField; // 0x1B0
		::UnityEngine::InputSystem::Controls::ButtonControl* _buttonEast_k__BackingField; // 0x1B8
		::UnityEngine::InputSystem::Controls::ButtonControl* _buttonNorth_k__BackingField; // 0x1C0
		::UnityEngine::InputSystem::Controls::ButtonControl* _selectButton_k__BackingField; // 0x1C8
