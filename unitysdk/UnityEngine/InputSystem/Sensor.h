...
#define UNITYENGINE_INPUTSYSTEM_SENSOR_GET_SAMPLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A0FF010)
#define UNITYENGINE_INPUTSYSTEM_SENSOR_SET_SAMPLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A0FF0B0)
#define UNITYENGINE_INPUTSYSTEM_SENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0FEB40)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int Sensor_TypeDefinitionIndex = 27550;
