...
#define UNITYENGINE_INPUTSYSTEM_SENSOR_GET_SAMPLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A6A1C50)
#define UNITYENGINE_INPUTSYSTEM_SENSOR_SET_SAMPLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A6A1CF0)
#define UNITYENGINE_INPUTSYSTEM_SENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6A1780)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int Sensor_TypeDefinitionIndex = 28490;
