...
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_DEVICEREGAINEDEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6916E0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int PlayerInput_DeviceRegainedEvent_TypeDefinitionIndex = 27590;
