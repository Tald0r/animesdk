...
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDAVAILABLEDEVICESMATCHINGDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x18BF6970)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDAVAILABLEDEVICESTHATARENOWRECOGNIZED_OFFSET UNITYSDK_OFFSET(0x18BF45B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x18BF8AA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_1_OFFSET UNITYSDK_OFFSET(0x18BF8FD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_2_OFFSET UNITYSDK_OFFSET(0x18BF8010)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_3_OFFSET UNITYSDK_OFFSET(0x18BF7950)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_4_OFFSET UNITYSDK_OFFSET(0x18BF9C00)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_5_OFFSET UNITYSDK_OFFSET(0x18BF9C50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_6_OFFSET UNITYSDK_OFFSET(0x18BF9E60)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDDEVICE_OFFSET UNITYSDK_OFFSET(0x18BF8EC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDSTATECHANGEMONITORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18BE9B00)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADDSTATECHANGEMONITOR_OFFSET UNITYSDK_OFFSET(0x18BE7750)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONAFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x18BF4BF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x18BE79D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x18BF43A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONDEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x18BF44E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONDEVICESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x18BF4440)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONEVENT_OFFSET UNITYSDK_OFFSET(0x18BF4AF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONFINDCONTROLLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x18BF4580)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONLAYOUTCHANGE_OFFSET UNITYSDK_OFFSET(0x18BF4A50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ADD_ONSETTINGSCHANGE_OFFSET UNITYSDK_OFFSET(0x18BF4C30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_APPLYSETTINGS_OFFSET UNITYSDK_OFFSET(0x18BF3C70)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ASSIGNUNIQUEDEVICEID_OFFSET UNITYSDK_OFFSET(0x18BF9250)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_DESTROY_OFFSET UNITYSDK_OFFSET(0x18BFCAA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_DOESLAYOUTEXIST_OFFSET UNITYSDK_OFFSET(0x18BF5240)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ENABLEORDISABLEDEVICE_OFFSET UNITYSDK_OFFSET(0x18BF97E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_FINDORREGISTERDEVICELAYOUTFORTYPE_OFFSET UNITYSDK_OFFSET(0x18BF85C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_FIRESTATECHANGENOTIFICATIONS_OFFSET UNITYSDK_OFFSET(0x18BFFCB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_FLIPBUFFERSFORDEVICEIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x18BFFFF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_FLUSHDISCONNECTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x18BFA080)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GETDEVICE_OFFSET UNITYSDK_OFFSET(0x18BFAD00)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GETUNSUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x18BFADE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_COMPOSITES_OFFSET UNITYSDK_OFFSET(0x18BF3980)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_DEFAULTUPDATETYPE_OFFSET UNITYSDK_OFFSET(0x18BF4280)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x18BF3940)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_GAMEHASFOCUS_OFFSET UNITYSDK_OFFSET(0x18BF4C90)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_GAMEISPLAYING_OFFSET UNITYSDK_OFFSET(0x18BF4C80)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_GAMESHOULDGETINPUTREGARDLESSOFFOCUS_OFFSET UNITYSDK_OFFSET(0x18BF4CA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_INTERACTIONS_OFFSET UNITYSDK_OFFSET(0x18BF3970)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_ISPROCESSINGEVENTS_OFFSET UNITYSDK_OFFSET(0x18BF4C70)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_METRICS_OFFSET UNITYSDK_OFFSET(0x18BF3990)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x18BF42D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_PROCESSORS_OFFSET UNITYSDK_OFFSET(0x18BF3960)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x18BF3AE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_GET_UPDATEMASK_OFFSET UNITYSDK_OFFSET(0x18BF3F50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INITIALIZEDATA_OFFSET UNITYSDK_OFFSET(0x18BFB2C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INITIALIZEDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x18BFD1B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INITIALIZEDEVICESTATE_OFFSET UNITYSDK_OFFSET(0x18BF93C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x18BFB150)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INSTALLBEFOREUPDATEHOOKIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x18BF4B90)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INSTALLGLOBALS_OFFSET UNITYSDK_OFFSET(0x18BFC950)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INSTALLRUNTIME_OFFSET UNITYSDK_OFFSET(0x18BFC420)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_INVOKEAFTERUPDATECALLBACK_OFFSET UNITYSDK_OFFSET(0x18BFF780)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ISCONTROLORCHILDUSINGLAYOUTRECURSIVE_OFFSET UNITYSDK_OFFSET(0x18BF63F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ISCONTROLUSINGLAYOUT_OFFSET UNITYSDK_OFFSET(0x18BF6310)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ISDEVICELAYOUTMARKEDASSUPPORTEDINSETTINGS_OFFSET UNITYSDK_OFFSET(0x18BF8640)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_LISTCONTROLLAYOUTS_OFFSET UNITYSDK_OFFSET(0x18BF8790)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_MAKEDEVICENAMEUNIQUE_OFFSET UNITYSDK_OFFSET(0x18BF90F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_NOTIFYUSAGECHANGED_OFFSET UNITYSDK_OFFSET(0x18BF8A30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x18BFD900)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ONFOCUSCHANGED_OFFSET UNITYSDK_OFFSET(0x18BFDB90)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ONNATIVEDEVICEDISCOVERED_OFFSET UNITYSDK_OFFSET(0x18BFD330)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x18BFE070)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_PERFORMLAYOUTPOSTREGISTRATION_OFFSET UNITYSDK_OFFSET(0x18BF5390)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_PROCESSSTATECHANGEMONITORS_OFFSET UNITYSDK_OFFSET(0x18BFF830)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_PROCESSSTATECHANGEMONITORTIMEOUTS_OFFSET UNITYSDK_OFFSET(0x18BFF4B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_QUEUEEVENT_1_OFFSET UNITYSDK_OFFSET(0x18BFB040)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_QUEUEEVENT_OFFSET UNITYSDK_OFFSET(0x18BFAFE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REALLOCATESTATEBUFFERS_OFFSET UNITYSDK_OFFSET(0x18BF3F80)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RECREATEDEVICESUSINGLAYOUTWITHINFERIORMATCH_OFFSET UNITYSDK_OFFSET(0x18BF6680)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RECREATEDEVICESUSINGLAYOUT_OFFSET UNITYSDK_OFFSET(0x18BF6060)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RECREATEDEVICE_OFFSET UNITYSDK_OFFSET(0x18BF64B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUTBUILDER_OFFSET UNITYSDK_OFFSET(0x18BF5E70)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUTMATCHER_1_OFFSET UNITYSDK_OFFSET(0x18BF6E00)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUTMATCHER_OFFSET UNITYSDK_OFFSET(0x18BF5D90)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUT_1_OFFSET UNITYSDK_OFFSET(0x18BF5930)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REGISTERCONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x18BF4CD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVECONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x18BF8190)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVEDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x18BF8CE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVEDEVICE_OFFSET UNITYSDK_OFFSET(0x18BF72B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVESTATECHANGEMONITORS_OFFSET UNITYSDK_OFFSET(0x18BF9F50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVESTATECHANGEMONITORTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18BE9B50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVESTATECHANGEMONITOR_OFFSET UNITYSDK_OFFSET(0x18BE78A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONAFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x18BF4C10)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x18BE7AC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x18BF43F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONDEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x18BF4530)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONDEVICESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x18BF4490)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONEVENT_OFFSET UNITYSDK_OFFSET(0x18BF4B40)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONFINDCONTROLLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x18BF4A00)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONLAYOUTCHANGE_OFFSET UNITYSDK_OFFSET(0x18BF4AA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_REMOVE_ONSETTINGSCHANGE_OFFSET UNITYSDK_OFFSET(0x18BF4C50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RESETCONTROLPATHSRECURSIVE_OFFSET UNITYSDK_OFFSET(0x18BFD130)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RESETDEVICE_OFFSET UNITYSDK_OFFSET(0x18BFA0B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_RESTOREDEVICESAFTERDOMAINRELOADIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x18BFD750)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SETDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x18BF87F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x18BF42E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x18BF3AF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SET_UPDATEMASK_OFFSET UNITYSDK_OFFSET(0x18BF3F60)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SHOULDRUNDEVICEINBACKGROUND_OFFSET UNITYSDK_OFFSET(0x18BF9720)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_SHOULDRUNUPDATE_OFFSET UNITYSDK_OFFSET(0x18BFE050)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYFINDMATCHINGCONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x18BF6F30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYGETDEVICEBYID_OFFSET UNITYSDK_OFFSET(0x18BF7F80)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYGETDEVICE_1_OFFSET UNITYSDK_OFFSET(0x18BFAD90)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYGETDEVICE_OFFSET UNITYSDK_OFFSET(0x18BFAB50)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYLOADCONTROLLAYOUT_1_OFFSET UNITYSDK_OFFSET(0x18BF8590)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYLOADCONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x18BF83C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_TRYMATCHDISCONNECTEDDEVICE_OFFSET UNITYSDK_OFFSET(0x18BFD760)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UNINSTALLGLOBALS_OFFSET UNITYSDK_OFFSET(0x18BFCD10)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UPDATESTATE_1_OFFSET UNITYSDK_OFFSET(0x18BFA960)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UPDATESTATE_OFFSET UNITYSDK_OFFSET(0x18BFF7A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x18BFB110)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x18BFB0A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_WARNABOUTDEVICESFAILINGTORECREATEAFTERDOMAINRELOAD_OFFSET UNITYSDK_OFFSET(0x18BFD8F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_WRITESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x18C00060)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x18C000F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__TRYFINDMATCHINGCONTROLLAYOUT_B__72_0_OFFSET UNITYSDK_OFFSET(0x18C00100)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputManager_TypeDefinitionIndex = 27568;

	class InputManager : public ::System::Object
	{
	public:
		::Il2CppArray<::UnityEngine::InputSystem::InputDevice*>* m_DisconnectedDevices; // 0x10
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::UnityEngine::InputSystem::LowLevel::InputEventPtr, ::UnityEngine::InputSystem::InputDevice*>*> m_EventListeners; // 0x18
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::UnityEngine::InputSystem::LowLevel::InputDeviceCommandDelegate*> m_DeviceCommandCallbacks; // 0x68
		::Il2CppArray<::UnityEngine::InputSystem::InputDevice*>* m_Devices; // 0xB8
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::UnityEngine::InputSystem::InputDevice*, ::UnityEngine::InputSystem::InputDeviceChange>*> m_DeviceChangeListeners; // 0xC0
		::UnityEngine::InputSystem::Layouts::InputControlLayout_Collection m_Layouts; // 0x110
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputManager_StateChangeMonitorTimeout> m_StateChangeMonitorTimeouts; // 0x150
		::UnityEngine::InputSystem::LowLevel::InputDeviceExecuteCommandDelegate* m_DeviceFindExecuteCommandDelegate; // 0x188
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action*> m_SettingsChangedListeners; // 0x190
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action*> m_BeforeUpdateListeners; // 0x1E0
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::System::String*, ::UnityEngine::InputSystem::InputControlLayoutChange>*> m_LayoutChangeListeners; // 0x230
		::Il2CppArray<::UnityEngine::InputSystem::InputManager_AvailableDevice>* m_AvailableDevices; // 0x280
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::UnityEngine::InputSystem::Layouts::InputDeviceFindControlLayoutDelegate*> m_DeviceFindLayoutCallbacks; // 0x288
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action*> m_AfterUpdateListeners; // 0x2D8
		::UnityEngine::InputSystem::Utilities::TypeTable m_Composites; // 0x328
		::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::UnityEngine::InputSystem::InputDevice*, ::UnityEngine::InputSystem::LowLevel::InputEventPtr>*> m_DeviceStateChangeListeners; // 0x330
		::UnityEngine::InputSystem::InputSettings* m_Settings; // 0x380
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::UnityEngine::InputSystem::InputDevice*>* m_DevicesById; // 0x388
		::UnityEngine::InputSystem::Utilities::TypeTable m_Processors; // 0x390
		::Il2CppArray<::UnityEngine::InputSystem::InputManager_StateChangeMonitorsForDevice>* m_StateChangeMonitors; // 0x398
		::UnityEngine::InputSystem::Utilities::TypeTable m_Interactions; // 0x3A0
		::UnityEngine::InputSystem::LowLevel::IInputRuntime* m_Runtime; // 0x3A8
		::System::Single m_PollingFrequency; // 0x3B0
		::UnityEngine::InputSystem::LowLevel::InputMetrics m_Metrics; // 0x3B8
		::System::Int32 m_DisconnectedDevicesCount; // 0x3F0
		::System::Int32 m_LayoutRegistrationVersion; // 0x3F4
		::UnityEngine::InputSystem::LowLevel::InputUpdateType m_CurrentUpdate; // 0x3F8
		::System::Int32 m_DeviceFindExecuteCommandDeviceId; // 0x3FC
		::UnityEngine::InputSystem::LowLevel::InputUpdateType m_UpdateMask; // 0x400
		::System::Boolean m_HasFocus; // 0x404
		::System::Boolean m_HaveDevicesWithStateCallbackReceivers; // 0x405
		::System::Boolean m_NativeBeforeUpdateHooked; // 0x406
		::System::Int32 m_DevicesCount; // 0x408
		::System::Int32 m_AvailableDeviceCount; // 0x40C
		::UnityEngine::InputSystem::LowLevel::InputStateBuffers m_StateBuffers; // 0x410
