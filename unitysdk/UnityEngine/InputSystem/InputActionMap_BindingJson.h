...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_BINDINGJSON_FROMBINDING_OFFSET UNITYSDK_OFFSET(0x1AB81950)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_BINDINGJSON_TOBINDING_OFFSET UNITYSDK_OFFSET(0x95B560)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionMap_BindingJson_TypeDefinitionIndex = 27425;
