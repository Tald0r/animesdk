...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_BINDINGJSON_FROMBINDING_OFFSET UNITYSDK_OFFSET(0x1B1A1700)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_BINDINGJSON_TOBINDING_OFFSET UNITYSDK_OFFSET(0x98E0C0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionMap_BindingJson_TypeDefinitionIndex = 28365;
