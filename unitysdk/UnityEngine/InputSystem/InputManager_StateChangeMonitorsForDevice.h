...
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_ADD_OFFSET UNITYSDK_OFFSET(0x8F8450)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_CLEAR_OFFSET UNITYSDK_OFFSET(0x8F8470)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_COMPACTARRAYS_OFFSET UNITYSDK_OFFSET(0x8F84B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x2FD450)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x8F84C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER_STATECHANGEMONITORSFORDEVICE_REMOVE_OFFSET UNITYSDK_OFFSET(0x8F8460)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputManager_StateChangeMonitorsForDevice_TypeDefinitionIndex = 27572;
