...
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SUBSCRIBER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B1A1770)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SUBSCRIBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1A17D0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputRemoting_Subscriber_TypeDefinitionIndex = 28473;
