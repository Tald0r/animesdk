...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19F75FF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19F76230)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F76120)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19F762C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F761B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19F76160)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F75FE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH__PARSE_D__33__CTOR_OFFSET UNITYSDK_OFFSET(0x19F75FC0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlPath__Parse_d__33_TypeDefinitionIndex = 27510;
