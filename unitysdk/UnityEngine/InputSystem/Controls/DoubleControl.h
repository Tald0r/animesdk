...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DOUBLECONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x1AB0BA80)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DOUBLECONTROL_WRITEVALUEINTOSTATE_OFFSET UNITYSDK_OFFSET(0x1AB0BA90)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DOUBLECONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0BA30)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int DoubleControl_TypeDefinitionIndex = 27898;
