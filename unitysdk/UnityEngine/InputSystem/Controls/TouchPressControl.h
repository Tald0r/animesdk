...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_TOUCHPRESSCONTROL_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x19AB0140)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_TOUCHPRESSCONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x19AB0240)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_TOUCHPRESSCONTROL_WRITEVALUEINTOSTATE_OFFSET UNITYSDK_OFFSET(0x19AB0290)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_TOUCHPRESSCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB02E0)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int TouchPressControl_TypeDefinitionIndex = 27908;
