...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_INTEGERCONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x19F60120)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_INTEGERCONTROL_WRITEVALUEINTOSTATE_OFFSET UNITYSDK_OFFSET(0x19F60130)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_INTEGERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19F600D0)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int IntegerControl_TypeDefinitionIndex = 27902;
