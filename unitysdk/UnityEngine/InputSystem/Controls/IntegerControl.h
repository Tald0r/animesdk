...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_INTEGERCONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x1A570F90)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_INTEGERCONTROL_WRITEVALUEINTOSTATE_OFFSET UNITYSDK_OFFSET(0x1A570FA0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_INTEGERCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A570F40)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int IntegerControl_TypeDefinitionIndex = 28842;
