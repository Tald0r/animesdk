...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1A9A9C10)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL_GET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x1A9A9BF0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x1A9A9D30)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL_SET_COMPONENT_OFFSET UNITYSDK_OFFSET(0x1A9A9C00)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_DPADAXISCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A9E10)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int DpadControl_DpadAxisControl_TypeDefinitionIndex = 28840;
