...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1AC39CF0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_GET_DOWN_OFFSET UNITYSDK_OFFSET(0x1AC39C10)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_GET_LEFT_OFFSET UNITYSDK_OFFSET(0x1AC39C30)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_GET_RIGHT_OFFSET UNITYSDK_OFFSET(0x1AC39C50)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_GET_UP_OFFSET UNITYSDK_OFFSET(0x1AC39BF0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_MAKEDPADVECTOR_1_OFFSET UNITYSDK_OFFSET(0x1AC3A1F0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_MAKEDPADVECTOR_OFFSET UNITYSDK_OFFSET(0x1AC3A0F0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x1AC39DF0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_SET_DOWN_OFFSET UNITYSDK_OFFSET(0x1AC39C20)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_SET_LEFT_OFFSET UNITYSDK_OFFSET(0x1AC39C40)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_SET_RIGHT_OFFSET UNITYSDK_OFFSET(0x1AC39C60)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_SET_UP_OFFSET UNITYSDK_OFFSET(0x1AC39C00)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL_WRITEVALUEINTOSTATE_OFFSET UNITYSDK_OFFSET(0x1AC3A1A0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_DPADCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC39C70)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int DpadControl_TypeDefinitionIndex = 28839;
