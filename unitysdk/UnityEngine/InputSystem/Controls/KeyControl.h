...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_KEYCONTROL_GET_KEYCODE_OFFSET UNITYSDK_OFFSET(0x18BE2CD0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_KEYCONTROL_GET_SCANCODE_OFFSET UNITYSDK_OFFSET(0x18BE2CF0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_KEYCONTROL_REFRESHCONFIGURATION_OFFSET UNITYSDK_OFFSET(0x18BE2D30)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_KEYCONTROL_SET_KEYCODE_OFFSET UNITYSDK_OFFSET(0x18BE2CE0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_KEYCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE2EB0)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int KeyControl_TypeDefinitionIndex = 27903;
