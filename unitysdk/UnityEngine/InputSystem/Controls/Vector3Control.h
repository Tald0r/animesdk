...
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_VECTOR3CONTROL_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x19EC3CC0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_VECTOR3CONTROL_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x19EC3AB0)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_VECTOR3CONTROL_GET_X_OFFSET UNITYSDK_OFFSET(0x19EC3A00)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_VECTOR3CONTROL_GET_Y_OFFSET UNITYSDK_OFFSET(0x19EC3A20)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_VECTOR3CONTROL_GET_Z_OFFSET UNITYSDK_OFFSET(0x19EC3A40)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_VECTOR3CONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x19EC3B40)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_VECTOR3CONTROL_SET_X_OFFSET UNITYSDK_OFFSET(0x19EC3A10)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_VECTOR3CONTROL_SET_Y_OFFSET UNITYSDK_OFFSET(0x19EC3A30)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_VECTOR3CONTROL_SET_Z_OFFSET UNITYSDK_OFFSET(0x19EC3A50)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_VECTOR3CONTROL_WRITEVALUEINTOSTATE_OFFSET UNITYSDK_OFFSET(0x19EC3C10)
#define UNITYENGINE_INPUTSYSTEM_CONTROLS_VECTOR3CONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC3A60)

namespace UnityEngine::InputSystem::Controls
{
	inline static constexpr unsigned int Vector3Control_TypeDefinitionIndex = 27910;
