...
#define UNITYENGINE_INPUTSYSTEM_XINPUT_XINPUTCONTROLLERWINDOWS__CTOR_OFFSET UNITYSDK_OFFSET(0x19F7FB10)

namespace UnityEngine::InputSystem::XInput
{
	inline static constexpr unsigned int XInputControllerWindows_TypeDefinitionIndex = 27632;
