...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_CLEANSLASHES_OFFSET UNITYSDK_OFFSET(0x18BF1C90)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_COMBINE_OFFSET UNITYSDK_OFFSET(0x18BF1CC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_CONTROLLAYOUTMATCHESPATHCOMPONENT_OFFSET UNITYSDK_OFFSET(0x18BF2ED0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_FINDCONTROLLAYOUTRECURSIVE_1_OFFSET UNITYSDK_OFFSET(0x18BF2CB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_FINDCONTROLLAYOUTRECURSIVE_OFFSET UNITYSDK_OFFSET(0x18BF2AF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_MATCHESPREFIX_OFFSET UNITYSDK_OFFSET(0x18BF3430)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_MATCHESRECURSIVE_OFFSET UNITYSDK_OFFSET(0x18BF33C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_MATCHES_OFFSET UNITYSDK_OFFSET(0x18BF2430)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_MATCHPATHCOMPONENT_OFFSET UNITYSDK_OFFSET(0x18BF3550)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSE_OFFSET UNITYSDK_OFFSET(0x18BF38E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHCOMPONENTCANYIELDMULTIPLEMATCHES_OFFSET UNITYSDK_OFFSET(0x18BF3840)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_STRINGMATCHES_OFFSET UNITYSDK_OFFSET(0x18BF30B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TOHUMANREADABLESTRING_1_OFFSET UNITYSDK_OFFSET(0x18BF1DA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TOHUMANREADABLESTRING_OFFSET UNITYSDK_OFFSET(0x18BF1D70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYFINDCHILD_OFFSET UNITYSDK_OFFSET(0x18BF3370)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYFINDCONTROLS_1_OFFSET UNITYSDK_OFFSET(0x18BF3340)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYFINDCONTROLS_OFFSET UNITYSDK_OFFSET(0x18BF3230)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYFINDCONTROL_OFFSET UNITYSDK_OFFSET(0x18BE6170)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYGETCONTROLLAYOUT_OFFSET UNITYSDK_OFFSET(0x18BF2820)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYGETDEVICELAYOUT_OFFSET UNITYSDK_OFFSET(0x18BF26B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_TRYGETDEVICEUSAGES_OFFSET UNITYSDK_OFFSET(0x18BF2530)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlPath_TypeDefinitionIndex = 27503;
