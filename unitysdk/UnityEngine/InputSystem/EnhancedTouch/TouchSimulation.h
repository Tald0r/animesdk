...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ADDPOINTER_OFFSET UNITYSDK_OFFSET(0x19EC5DB0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_DESTROY_OFFSET UNITYSDK_OFFSET(0x19EC5C90)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_DISABLE_OFFSET UNITYSDK_OFFSET(0x19EC5BB0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ENABLE_OFFSET UNITYSDK_OFFSET(0x19EC5990)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19EC5950)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_GET_SIMULATEDTOUCHSCREEN_OFFSET UNITYSDK_OFFSET(0x19EC5930)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_INSTALLSTATECHANGEMONITORS_OFFSET UNITYSDK_OFFSET(0x19EC7560)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x19EC6E40)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19EC73A0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19EC6EE0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONEVENT_OFFSET UNITYSDK_OFFSET(0x19EC6660)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_ONSOURCECONTROLCHANGEDVALUE_OFFSET UNITYSDK_OFFSET(0x19EC7570)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_REMOVEPOINTER_OFFSET UNITYSDK_OFFSET(0x19EC5FA0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_SET_SIMULATEDTOUCHSCREEN_OFFSET UNITYSDK_OFFSET(0x19EC5940)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_UNINSTALLSTATECHANGEMONITORS_OFFSET UNITYSDK_OFFSET(0x19EC7580)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYCONTROLSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x19EC7540)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYTIMEREXPIRED_OFFSET UNITYSDK_OFFSET(0x19EC7550)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION_UPDATETOUCH_OFFSET UNITYSDK_OFFSET(0x19EC6260)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHSIMULATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC7590)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int TouchSimulation_TypeDefinitionIndex = 27703;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation**)Il2CppClass::FromTypeDefinitionIndex(TouchSimulation_TypeDefinitionIndex)->GetStaticField(0x1FEA0);
		}
