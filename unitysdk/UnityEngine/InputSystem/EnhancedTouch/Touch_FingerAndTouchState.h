...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_ADDFINGERS_OFFSET UNITYSDK_OFFSET(0x901C90)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_DESTROY_OFFSET UNITYSDK_OFFSET(0x901CB0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_REMOVEFINGERS_OFFSET UNITYSDK_OFFSET(0x901CA0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_UPDATEACTIVEFINGERS_OFFSET UNITYSDK_OFFSET(0x901CC0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_UPDATEACTIVETOUCHES_OFFSET UNITYSDK_OFFSET(0x901CD0)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int Touch_FingerAndTouchState_TypeDefinitionIndex = 27698;
