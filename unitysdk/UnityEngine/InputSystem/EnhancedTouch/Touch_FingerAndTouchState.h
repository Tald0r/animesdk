...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_ADDFINGERS_OFFSET UNITYSDK_OFFSET(0x92D620)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_DESTROY_OFFSET UNITYSDK_OFFSET(0x92D640)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_REMOVEFINGERS_OFFSET UNITYSDK_OFFSET(0x92D630)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_UPDATEACTIVEFINGERS_OFFSET UNITYSDK_OFFSET(0x92D650)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCH_FINGERANDTOUCHSTATE_UPDATEACTIVETOUCHES_OFFSET UNITYSDK_OFFSET(0x92D660)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int Touch_FingerAndTouchState_TypeDefinitionIndex = 28638;
