...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_ENHANCEDTOUCHSUPPORT_CHECKENABLED_OFFSET UNITYSDK_OFFSET(0x1A5813E0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_ENHANCEDTOUCHSUPPORT_DISABLE_OFFSET UNITYSDK_OFFSET(0x1A580DA0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_ENHANCEDTOUCHSUPPORT_ENABLE_OFFSET UNITYSDK_OFFSET(0x1A5809B0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_ENHANCEDTOUCHSUPPORT_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A580980)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_ENHANCEDTOUCHSUPPORT_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1A581260)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_ENHANCEDTOUCHSUPPORT_ONSETTINGSCHANGE_OFFSET UNITYSDK_OFFSET(0x1A581340)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_ENHANCEDTOUCHSUPPORT_RESET_OFFSET UNITYSDK_OFFSET(0x1A5811B0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_ENHANCEDTOUCHSUPPORT_SETUPSTATE_OFFSET UNITYSDK_OFFSET(0x1A580B00)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_ENHANCEDTOUCHSUPPORT_TEARDOWNSTATE_OFFSET UNITYSDK_OFFSET(0x1A580F40)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int EnhancedTouchSupport_TypeDefinitionIndex = 28634;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(EnhancedTouchSupport_TypeDefinitionIndex)->GetStaticField(0x4C30);
		}
		static ::UnityEngine::InputSystem::InputSettings_UpdateMode* StaticGet_s_UpdateMode()
		{
			return (::UnityEngine::InputSystem::InputSettings_UpdateMode*)Il2CppClass::FromTypeDefinitionIndex(EnhancedTouchSupport_TypeDefinitionIndex)->GetStaticField(0x4C34);
		}
