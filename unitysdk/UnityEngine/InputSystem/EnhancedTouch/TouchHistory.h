...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x98DEA0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x98DE10)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x302AD0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x98DE80)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x98DE10)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_TOUCHHISTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x98DDB0)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int TouchHistory_TypeDefinitionIndex = 28641;
