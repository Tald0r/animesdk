...
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_FINDTOUCH_OFFSET UNITYSDK_OFFSET(0x1865F660)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GETTOUCHHISTORY_OFFSET UNITYSDK_OFFSET(0x1865F9D0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_CURRENTTOUCH_OFFSET UNITYSDK_OFFSET(0x1865ECB0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1865EC40)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1865EC50)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_LASTTOUCH_OFFSET UNITYSDK_OFFSET(0x1865EEF0)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_SCREENPOSITION_OFFSET UNITYSDK_OFFSET(0x1865EE20)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_SCREEN_OFFSET UNITYSDK_OFFSET(0x1865EC30)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_GET_TOUCHHISTORY_OFFSET UNITYSDK_OFFSET(0x1865EF50)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_ONTOUCHRECORDED_OFFSET UNITYSDK_OFFSET(0x1865F380)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER_SHOULDRECORDTOUCH_OFFSET UNITYSDK_OFFSET(0x1865F330)
#define UNITYENGINE_INPUTSYSTEM_ENHANCEDTOUCH_FINGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1865EF90)

namespace UnityEngine::InputSystem::EnhancedTouch
{
	inline static constexpr unsigned int Finger_TypeDefinitionIndex = 27695;
