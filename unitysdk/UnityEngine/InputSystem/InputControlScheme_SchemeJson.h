...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SCHEMEJSON_TOJSON_1_OFFSET UNITYSDK_OFFSET(0x1979AAC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SCHEMEJSON_TOJSON_OFFSET UNITYSDK_OFFSET(0x1979A970)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SCHEMEJSON_TOSCHEMES_OFFSET UNITYSDK_OFFSET(0x1979AC20)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SCHEMEJSON_TOSCHEME_OFFSET UNITYSDK_OFFSET(0x8AFEB0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlScheme_SchemeJson_TypeDefinitionIndex = 27479;
