...
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GETPENPOINTERID_OFFSET UNITYSDK_OFFSET(0x1A78BE70)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GETTOUCHPOINTERID_OFFSET UNITYSDK_OFFSET(0x1A78C130)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0x1A78B1E0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x1A78B200)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_POINTERTYPE_OFFSET UNITYSDK_OFFSET(0x1A78B240)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_TOUCHID_OFFSET UNITYSDK_OFFSET(0x1A78B220)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_TRACKEDDEVICEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A78B2C0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_TRACKEDDEVICEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A78B280)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_GET_UITOOLKITPOINTERID_OFFSET UNITYSDK_OFFSET(0x1A78B260)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_MAKEPOINTERIDFORTOUCH_OFFSET UNITYSDK_OFFSET(0x1A78BD40)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_READDEVICESTATE_OFFSET UNITYSDK_OFFSET(0x1A78BD60)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_CONTROL_OFFSET UNITYSDK_OFFSET(0x1A78B1F0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_DEVICE_OFFSET UNITYSDK_OFFSET(0x1A78B210)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_POINTERTYPE_OFFSET UNITYSDK_OFFSET(0x1A78B250)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_TOUCHID_OFFSET UNITYSDK_OFFSET(0x1A78B230)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_TRACKEDDEVICEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A78B2D0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_TRACKEDDEVICEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A78B2A0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_SET_UITOOLKITPOINTERID_OFFSET UNITYSDK_OFFSET(0x1A78B270)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A78B2E0)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA_TOUCHIDFROMPOINTERID_OFFSET UNITYSDK_OFFSET(0x1A78BD50)
#define UNITYENGINE_INPUTSYSTEM_UI_EXTENDEDPOINTEREVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A78B1D0)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int ExtendedPointerEventData_TypeDefinitionIndex = 27650;
	...
	public:
		...
		::UnityEngine::InputSystem::UI::UIPointerType _pointerType_k__BackingField; // 0x140
		::UnityEngine::Quaternion _trackedDeviceOrientation_k__BackingField; // 0x144
		::System::Int32 _uiToolkitPointerId_k__BackingField; // 0x154
