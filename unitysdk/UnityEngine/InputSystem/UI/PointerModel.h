...
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_COPYTOUCHORPENSTATEFROM_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_ALTITUDEANGLE_OFFSET UNITYSDK_OFFSET(0x878FE0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_AZIMUTHANGLE_OFFSET UNITYSDK_OFFSET(0x878FB0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_POINTERTYPE_OFFSET UNITYSDK_OFFSET(0x878DA0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_PRESSURE_OFFSET UNITYSDK_OFFSET(0x878F80)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x879040)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_SCREENPOSITION_OFFSET UNITYSDK_OFFSET(0x878DD0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_SCROLLDELTA_OFFSET UNITYSDK_OFFSET(0x878F20)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_TWIST_OFFSET UNITYSDK_OFFSET(0x879010)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_WORLDORIENTATION_OFFSET UNITYSDK_OFFSET(0x878EC0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_GET_WORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x878E30)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_ONFRAMEFINISHED_OFFSET UNITYSDK_OFFSET(0x8791A0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_ALTITUDEANGLE_OFFSET UNITYSDK_OFFSET(0x878FF0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_AZIMUTHANGLE_OFFSET UNITYSDK_OFFSET(0x878FC0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_PRESSURE_OFFSET UNITYSDK_OFFSET(0x878F90)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x879050)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_SCREENPOSITION_OFFSET UNITYSDK_OFFSET(0x878DE0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_SCROLLDELTA_OFFSET UNITYSDK_OFFSET(0x878F30)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_TWIST_OFFSET UNITYSDK_OFFSET(0x879020)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_WORLDORIENTATION_OFFSET UNITYSDK_OFFSET(0x878ED0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_SET_WORLDPOSITION_OFFSET UNITYSDK_OFFSET(0x878E50)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL__CTOR_OFFSET UNITYSDK_OFFSET(0x8790A0)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int PointerModel_TypeDefinitionIndex = 28597;
