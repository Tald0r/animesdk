...
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_GET_BLOCKINGMASK_OFFSET UNITYSDK_OFFSET(0x186839A0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_GET_CANVAS_OFFSET UNITYSDK_OFFSET(0x186838D0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_GET_CHECKFOR2DOCCLUSION_OFFSET UNITYSDK_OFFSET(0x186839E0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_GET_CHECKFOR3DOCCLUSION_OFFSET UNITYSDK_OFFSET(0x186839C0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_GET_EVENTCAMERA_OFFSET UNITYSDK_OFFSET(0x18683780)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_GET_IGNOREREVERSEDGRAPHICS_OFFSET UNITYSDK_OFFSET(0x18683A00)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_GET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x18683A20)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18683B50)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18683A40)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_PERFORMRAYCAST_OFFSET UNITYSDK_OFFSET(0x18683CF0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCAST_OFFSET UNITYSDK_OFFSET(0x18683C70)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYINTERSECTSRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18684E00)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_SET_BLOCKINGMASK_OFFSET UNITYSDK_OFFSET(0x186839B0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_SET_CHECKFOR2DOCCLUSION_OFFSET UNITYSDK_OFFSET(0x186839F0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_SET_CHECKFOR3DOCCLUSION_OFFSET UNITYSDK_OFFSET(0x186839D0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_SET_IGNOREREVERSEDGRAPHICS_OFFSET UNITYSDK_OFFSET(0x18683A10)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_SET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x18683A30)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_SORTEDRAYCASTGRAPHICS_OFFSET UNITYSDK_OFFSET(0x186848A0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18685340)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x186852C0)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int TrackedDeviceRaycaster_TypeDefinitionIndex = 27659;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::InputSystem::UI::TrackedDeviceRaycaster_RaycastHitData>**)Il2CppClass::FromTypeDefinitionIndex(TrackedDeviceRaycaster_TypeDefinitionIndex)->GetStaticField(0x1FFF0);
		}
		...
		{
			return (::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::UI::TrackedDeviceRaycaster*>*)Il2CppClass::FromTypeDefinitionIndex(TrackedDeviceRaycaster_TypeDefinitionIndex)->GetStaticField(0x1FFF8);
		}
