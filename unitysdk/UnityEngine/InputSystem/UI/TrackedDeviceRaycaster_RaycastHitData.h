...
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x8FF150)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA_GET_GRAPHIC_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA_GET_SCREENPOSITION_OFFSET UNITYSDK_OFFSET(0x38EE70)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA_GET_WORLDHITPOSITION_OFFSET UNITYSDK_OFFSET(0x510540)
#define UNITYENGINE_INPUTSYSTEM_UI_TRACKEDDEVICERAYCASTER_RAYCASTHITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x8FF110)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int TrackedDeviceRaycaster_RaycastHitData_TypeDefinitionIndex = 27660;
