...
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_COPYPRESSSTATEFROM_OFFSET UNITYSDK_OFFSET(0x93F850)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_COPYPRESSSTATETO_OFFSET UNITYSDK_OFFSET(0x93F780)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_CLICKEDONSAMEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x93F740)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_IGNORENEXTCLICK_OFFSET UNITYSDK_OFFSET(0x93F720)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x306AA0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_PRESSTIME_OFFSET UNITYSDK_OFFSET(0x2F60E0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_WASPRESSEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x93F760)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_WASRELEASEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x93F770)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_ONENDFRAME_OFFSET UNITYSDK_OFFSET(0x93F900)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_CLICKEDONSAMEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x93F750)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_IGNORENEXTCLICK_OFFSET UNITYSDK_OFFSET(0x93F730)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x93F6E0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_PRESSTIME_OFFSET UNITYSDK_OFFSET(0x2F60F0)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int PointerModel_ButtonState_TypeDefinitionIndex = 28598;
