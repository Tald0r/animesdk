...
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_COPYPRESSSTATEFROM_OFFSET UNITYSDK_OFFSET(0x9131D0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_COPYPRESSSTATETO_OFFSET UNITYSDK_OFFSET(0x913100)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_CLICKEDONSAMEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x9130C0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_IGNORENEXTCLICK_OFFSET UNITYSDK_OFFSET(0x9130A0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x2D71A0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_PRESSTIME_OFFSET UNITYSDK_OFFSET(0x2C4B30)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_WASPRESSEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x9130E0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_GET_WASRELEASEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x9130F0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_ONENDFRAME_OFFSET UNITYSDK_OFFSET(0x913280)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_CLICKEDONSAMEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x9130D0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_IGNORENEXTCLICK_OFFSET UNITYSDK_OFFSET(0x9130B0)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x913060)
#define UNITYENGINE_INPUTSYSTEM_UI_POINTERMODEL_BUTTONSTATE_SET_PRESSTIME_OFFSET UNITYSDK_OFFSET(0x2C4B40)

namespace UnityEngine::InputSystem::UI
{
	inline static constexpr unsigned int PointerModel_ButtonState_TypeDefinitionIndex = 27658;
