...
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_BIND_OFFSET UNITYSDK_OFFSET(0x1A55EC30)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONCHANGEUSAGES_OFFSET UNITYSDK_OFFSET(0x1A55F450)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A55EF40)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A55F2F0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONNEWDEVICE_OFFSET UNITYSDK_OFFSET(0x1A55F410)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONNEWEVENTS_OFFSET UNITYSDK_OFFSET(0x1A55F430)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONNEWLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A55F420)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONREMOVEDEVICE_OFFSET UNITYSDK_OFFSET(0x1A55F440)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONSTARTSENDING_OFFSET UNITYSDK_OFFSET(0x1A55F460)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_ONSTOPSENDING_OFFSET UNITYSDK_OFFSET(0x1A55F470)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_SENDTOSUBSCRIBERS_OFFSET UNITYSDK_OFFSET(0x1A55F180)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A55EFD0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_SYSTEM_IOBSERVER_UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_MESSAGE__ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1A55F5E0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_SYSTEM_IOBSERVER_UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_MESSAGE__ONERROR_OFFSET UNITYSDK_OFFSET(0x1A55F5D0)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION_SYSTEM_IOBSERVER_UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_MESSAGE__ONNEXT_OFFSET UNITYSDK_OFFSET(0x1A55F480)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A55F620)
#define UNITYENGINE_INPUTSYSTEM_REMOTEINPUTPLAYERCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A55F5F0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int RemoteInputPlayerConnection_TypeDefinitionIndex = 28488;
	...
	public:
		...
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(RemoteInputPlayerConnection_TypeDefinitionIndex)->GetStaticField(0x4CA0);
		}
		static ::System::Guid* StaticGet_kStartSendingMsg()
		{
			return (::System::Guid*)Il2CppClass::FromTypeDefinitionIndex(RemoteInputPlayerConnection_TypeDefinitionIndex)->GetStaticField(0x4CB0);
		}
