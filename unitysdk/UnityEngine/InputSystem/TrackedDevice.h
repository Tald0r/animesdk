...
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1A691A70)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_GET_DEVICEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A691A30)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_GET_DEVICEROTATION_OFFSET UNITYSDK_OFFSET(0x1A691A50)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_GET_ISTRACKED_OFFSET UNITYSDK_OFFSET(0x1A691A10)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_GET_TRACKINGSTATE_OFFSET UNITYSDK_OFFSET(0x1A6919F0)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_SET_DEVICEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A691A40)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_SET_DEVICEROTATION_OFFSET UNITYSDK_OFFSET(0x1A691A60)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_SET_ISTRACKED_OFFSET UNITYSDK_OFFSET(0x1A691A20)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE_SET_TRACKINGSTATE_OFFSET UNITYSDK_OFFSET(0x1A691A00)
#define UNITYENGINE_INPUTSYSTEM_TRACKEDDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A691B20)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int TrackedDevice_TypeDefinitionIndex = 27565;
	...
	public:
		...
		::UnityEngine::InputSystem::Controls::QuaternionControl* _deviceRotation_k__BackingField; // 0x160
		::UnityEngine::InputSystem::Controls::ButtonControl* _isTracked_k__BackingField; // 0x168
