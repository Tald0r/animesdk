...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREFERENCE_CREATE_OFFSET UNITYSDK_OFFSET(0x1A690620)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREFERENCE_GETDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1A690000)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREFERENCE_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x1A68FA20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREFERENCE_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1A68FA10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREFERENCE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A690550)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREFERENCE_SETINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A68FBF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREFERENCE_SET_1_OFFSET UNITYSDK_OFFSET(0x1A68FDC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREFERENCE_SET_OFFSET UNITYSDK_OFFSET(0x1A68FAE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREFERENCE_TODISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1A6903E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREFERENCE_TOINPUTACTION_OFFSET UNITYSDK_OFFSET(0x1A690680)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREFERENCE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A690050)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A690740)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionReference_TypeDefinitionIndex = 27441;
