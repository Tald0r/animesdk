...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x19F6E2D0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_GET_LEFTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x19F6E270)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_GET_PLAYSTATIONBUTTON_OFFSET UNITYSDK_OFFSET(0x19F6E2B0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_GET_RIGHTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x19F6E290)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_SET_LEFTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x19F6E280)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_SET_PLAYSTATIONBUTTON_OFFSET UNITYSDK_OFFSET(0x19F6E2C0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID_SET_RIGHTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x19F6E2A0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK3GAMEPADHID__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6E4E0)

namespace UnityEngine::InputSystem::DualShock
{
	inline static constexpr unsigned int DualShock3GamepadHID_TypeDefinitionIndex = 27711;
