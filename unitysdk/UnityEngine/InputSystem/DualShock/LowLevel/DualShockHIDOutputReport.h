...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSHOCKHIDOUTPUTREPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x19AB04B0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSHOCKHIDOUTPUTREPORT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x8D52E0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSHOCKHIDOUTPUTREPORT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19AB0390)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSHOCKHIDOUTPUTREPORT_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x8D5350)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSHOCKHIDOUTPUTREPORT_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x8D52F0)

namespace UnityEngine::InputSystem::DualShock::LowLevel
{
	inline static constexpr unsigned int DualShockHIDOutputReport_TypeDefinitionIndex = 27723;
