...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDBLUETOOTHOUTPUTREPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x19D9B480)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDBLUETOOTHOUTPUTREPORT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x8D52E0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDBLUETOOTHOUTPUTREPORT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19D9B460)

namespace UnityEngine::InputSystem::DualShock::LowLevel
{
	inline static constexpr unsigned int DualSenseHIDBluetoothOutputReport_TypeDefinitionIndex = 27718;
