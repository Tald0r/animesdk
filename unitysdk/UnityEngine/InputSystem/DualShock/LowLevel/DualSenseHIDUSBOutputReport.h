...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDUSBOUTPUTREPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x1A3E6300)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDUSBOUTPUTREPORT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x8D52E0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_LOWLEVEL_DUALSENSEHIDUSBOUTPUTREPORT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A3E62E0)

namespace UnityEngine::InputSystem::DualShock::LowLevel
{
	inline static constexpr unsigned int DualSenseHIDUSBOutputReport_TypeDefinitionIndex = 27717;
