...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x18656D70)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_GET_LEFTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x18656D10)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_GET_PLAYSTATIONBUTTON_OFFSET UNITYSDK_OFFSET(0x18656D50)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_GET_RIGHTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x18656D30)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_MERGEFORWARDINNER_OFFSET UNITYSDK_OFFSET(0x18657420)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_MERGEFORWARD_1_OFFSET UNITYSDK_OFFSET(0x18657370)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_MERGEFORWARD_2_OFFSET UNITYSDK_OFFSET(0x186573C0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_MERGEFORWARD_OFFSET UNITYSDK_OFFSET(0x18657320)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x18656EB0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_PREPROCESSEVENTINNER_OFFSET UNITYSDK_OFFSET(0x186575E0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x186570B0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x18657210)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_SETLIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x18657260)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_SETMOTORSPEEDSANDLIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x18656F00)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x186572C0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_SET_LEFTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x18656D20)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_SET_PLAYSTATIONBUTTON_OFFSET UNITYSDK_OFFSET(0x18656D60)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_SET_RIGHTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x18656D40)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IEVENTMERGER_MERGEFORWARD_OFFSET UNITYSDK_OFFSET(0x18657410)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IEVENTPREPROCESSOR_PREPROCESSEVENT_OFFSET UNITYSDK_OFFSET(0x186575D0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSENSEGAMEPADHID__CTOR_OFFSET UNITYSDK_OFFSET(0x186577B0)

namespace UnityEngine::InputSystem::DualShock
{
	inline static constexpr unsigned int DualSenseGamepadHID_TypeDefinitionIndex = 27705;
	...
	public:
		...
		::System::Byte outputSequenceId; // 0x240
		::System::Nullable_1<::System::Single> m_HighFrequenceyMotorSpeed; // 0x244
		::System::Nullable_1<::UnityEngine::Color> m_LightBarColor; // 0x24C
