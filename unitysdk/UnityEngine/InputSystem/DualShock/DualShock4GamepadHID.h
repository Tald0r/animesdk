...
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1A57F390)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_GET_LEFTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x1A57F330)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_GET_PLAYSTATIONBUTTON_OFFSET UNITYSDK_OFFSET(0x1A57F370)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_GET_RIGHTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x1A57F350)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1A57F4C0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x1A57F540)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1A57F5F0)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_SETLIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1A57F810)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_SETMOTORSPEEDSANDLIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1A57FA10)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x1A57F910)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_SET_LEFTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x1A57F340)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_SET_PLAYSTATIONBUTTON_OFFSET UNITYSDK_OFFSET(0x1A57F380)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID_SET_RIGHTTRIGGERBUTTON_OFFSET UNITYSDK_OFFSET(0x1A57F360)
#define UNITYENGINE_INPUTSYSTEM_DUALSHOCK_DUALSHOCK4GAMEPADHID__CTOR_OFFSET UNITYSDK_OFFSET(0x1A57FBD0)

namespace UnityEngine::InputSystem::DualShock
{
	inline static constexpr unsigned int DualShock4GamepadHID_TypeDefinitionIndex = 28650;
