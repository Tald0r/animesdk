...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x91FB80)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x91FB10)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x91FA50)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GET_HASMISSINGOPTIONALDEVICES_OFFSET UNITYSDK_OFFSET(0x3866C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GET_HASMISSINGREQUIREDDEVICES_OFFSET UNITYSDK_OFFSET(0x3219F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GET_ISSUCCESSFULMATCH_OFFSET UNITYSDK_OFFSET(0x91FA40)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x91FA70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x2C4B10)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x91FB10)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlScheme_MatchResult_TypeDefinitionIndex = 27473;
