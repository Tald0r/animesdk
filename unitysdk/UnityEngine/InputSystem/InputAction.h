...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_ADD_CANCELED_OFFSET UNITYSDK_OFFSET(0x19ECA260)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_ADD_PERFORMED_OFFSET UNITYSDK_OFFSET(0x19ECA300)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_ADD_STARTED_OFFSET UNITYSDK_OFFSET(0x19ECA1C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_BINDINGINDEXONACTIONTOBINDINGINDEXONMAP_OFFSET UNITYSDK_OFFSET(0x19ECB190)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_BINDINGINDEXONMAPTOBINDINGINDEXONACTION_OFFSET UNITYSDK_OFFSET(0x19ECB340)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_CLONE_OFFSET UNITYSDK_OFFSET(0x19ECAB20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_CREATEINTERNALACTIONMAPFORSINGLETONACTION_OFFSET UNITYSDK_OFFSET(0x19ECB020)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_DISABLE_OFFSET UNITYSDK_OFFSET(0x19ECAA50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19ECA620)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_ENABLE_OFFSET UNITYSDK_OFFSET(0x19ECA920)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_FINDEFFECTIVEBINDINGMASK_OFFSET UNITYSDK_OFFSET(0x19ECB0B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GENERATEID_OFFSET UNITYSDK_OFFSET(0x19ECAFF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GETORCREATEACTIONMAP_OFFSET UNITYSDK_OFFSET(0x19EC9F40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GETTIMEOUTCOMPLETIONPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x19ECAE70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_ACTIONMAP_OFFSET UNITYSDK_OFFSET(0x19EC9C90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_ACTIVECONTROL_OFFSET UNITYSDK_OFFSET(0x19ECA480)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x19EC9CD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x19EC9F70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_CONTROLS_OFFSET UNITYSDK_OFFSET(0x19EC9FD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x19ECA0A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x19ECA170)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_EXPECTEDCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x19EC9C50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_IDDONTGENERATE_OFFSET UNITYSDK_OFFSET(0x19EC9C10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_ID_OFFSET UNITYSDK_OFFSET(0x19EC9B70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_INPROGRESS_OFFSET UNITYSDK_OFFSET(0x19ECA110)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_INTERACTIONS_OFFSET UNITYSDK_OFFSET(0x19EC9C80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_ISSINGLETONACTION_OFFSET UNITYSDK_OFFSET(0x19EC9CB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19EC9B50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x19ECA050)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_PROCESSORS_OFFSET UNITYSDK_OFFSET(0x19EC9C70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_TRIGGERED_OFFSET UNITYSDK_OFFSET(0x19ECA3A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19EC9B60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_GET_WANTSINITIALSTATECHECK_OFFSET UNITYSDK_OFFSET(0x19ECA520)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_ISPRESSED_OFFSET UNITYSDK_OFFSET(0x19ECAD20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_MAKESUREIDISINPLACE_OFFSET UNITYSDK_OFFSET(0x19EC9BD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x19ECAC20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_REMOVE_CANCELED_OFFSET UNITYSDK_OFFSET(0x19ECA2B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_REMOVE_PERFORMED_OFFSET UNITYSDK_OFFSET(0x19ECA350)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_REMOVE_STARTED_OFFSET UNITYSDK_OFFSET(0x19ECA210)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_RESET_OFFSET UNITYSDK_OFFSET(0x19ECACA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_SET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x19EC9D10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_SET_EXPECTEDCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x19EC9C60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_SET_WANTSINITIALSTATECHECK_OFFSET UNITYSDK_OFFSET(0x19ECA530)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x19ECAC10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19ECA640)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_WASPERFORMEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x19ECA410)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_WASPRESSEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x19ECAD90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION_WASRELEASEDTHISFRAME_OFFSET UNITYSDK_OFFSET(0x19ECAE00)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19ECA550)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19ECA540)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputAction_TypeDefinitionIndex = 27412;
