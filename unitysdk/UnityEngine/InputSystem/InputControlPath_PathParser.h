...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER_GET_ISATEND_OFFSET UNITYSDK_OFFSET(0x838650)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER_MOVETONEXTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x8386A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER_PARSECOMPONENTPART_OFFSET UNITYSDK_OFFSET(0x8386B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x838660)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlPath_PathParser_TypeDefinitionIndex = 27508;
