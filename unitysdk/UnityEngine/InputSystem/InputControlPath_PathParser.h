...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER_GET_ISATEND_OFFSET UNITYSDK_OFFSET(0x863910)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER_MOVETONEXTCOMPONENT_OFFSET UNITYSDK_OFFSET(0x863960)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER_PARSECOMPONENTPART_OFFSET UNITYSDK_OFFSET(0x863970)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PATHPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x863920)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlPath_PathParser_TypeDefinitionIndex = 28448;
