...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B153F30)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_INPUTCONTROL__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B154260)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_INPUTCONTROL__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B1541F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B154310)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B154250)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B154200)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B153EE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43__CTOR_OFFSET UNITYSDK_OFFSET(0x1B153EC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B153F10)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlExtensions__GetAllButtonPresses_d__43_TypeDefinitionIndex = 28439;
	...
	public:
		...
		::UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr; // 0x88
		::System::Single magnitude; // 0x90
		::System::Int32 __1__state; // 0x94
		::System::Single __3__magnitude; // 0x98
		::System::Int32 __l__initialThreadId; // 0x9C
		::System::Boolean __3__buttonControlsOnly; // 0xA0
		::System::Boolean buttonControlsOnly; // 0xA1
		::UnityEngine::InputSystem::LowLevel::InputEventPtr __3__eventPtr; // 0xA8
