...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AB0C380)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_INPUTCONTROL__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AB0C6B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_INPUTCONTROL__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AB0C640)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AB0C760)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AB0C6A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AB0C650)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AB0C330)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0C310)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS__GETALLBUTTONPRESSES_D__43___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1AB0C360)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlExtensions__GetAllButtonPresses_d__43_TypeDefinitionIndex = 27499;

	class InputControlExtensions__GetAllButtonPresses_d__43 : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::InputControlExtensions_InputEventControlEnumerator __7__wrap1; // 0x10
		::UnityEngine::InputSystem::InputControl* __2__current; // 0x80
		::System::Single magnitude; // 0x88
		::System::Single __3__magnitude; // 0x8C
		::System::Int32 __l__initialThreadId; // 0x90
		::UnityEngine::InputSystem::LowLevel::InputEventPtr eventPtr; // 0x98
		::UnityEngine::InputSystem::LowLevel::InputEventPtr __3__eventPtr; // 0xA0
		::System::Int32 __1__state; // 0xA8
		::System::Boolean __3__buttonControlsOnly; // 0xAC
		::System::Boolean buttonControlsOnly; // 0xAD
