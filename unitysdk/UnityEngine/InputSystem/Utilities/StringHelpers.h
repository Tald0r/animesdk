...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_CHARACTERSEPARATEDLISTSHAVEATLEASTONECOMMONELEMENT_OFFSET UNITYSDK_OFFSET(0x1A100580)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1A100040)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A0FAD40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_COUNTOCCURRENCES_OFFSET UNITYSDK_OFFSET(0x1A100470)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_ESCAPE_OFFSET UNITYSDK_OFFSET(0x1A0FFB40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_EXPANDTEMPLATESTRING_OFFSET UNITYSDK_OFFSET(0x1A101010)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_FROMNICIFIEDMEMORYSIZE_OFFSET UNITYSDK_OFFSET(0x1A100300)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_GETPLURAL_OFFSET UNITYSDK_OFFSET(0x1A100070)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_INVARIANTEQUALSIGNORECASE_OFFSET UNITYSDK_OFFSET(0x1A100FE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_ISPRINTABLE_OFFSET UNITYSDK_OFFSET(0x1A100E90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_NICIFYMEMORYSIZE_OFFSET UNITYSDK_OFFSET(0x1A1001C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_PARSEINT_OFFSET UNITYSDK_OFFSET(0x1A100AF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_READSTRINGFROMBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1A100D60)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_READSTRINGFROMBUFFER_OFFSET UNITYSDK_OFFSET(0x1A100D40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_SPLIT_OFFSET UNITYSDK_OFFSET(0x1A100520)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_TOKENIZE_OFFSET UNITYSDK_OFFSET(0x1A1004C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_UNESCAPE_OFFSET UNITYSDK_OFFSET(0x1A0FFDB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_WITHALLWHITESPACESTRIPPED_OFFSET UNITYSDK_OFFSET(0x1A100EC0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_WRITESTRINGTOBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1A100BB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS_WRITESTRINGTOBUFFER_OFFSET UNITYSDK_OFFSET(0x1A100B90)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int StringHelpers_TypeDefinitionIndex = 27970;
