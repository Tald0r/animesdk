...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_COMPARETO_OFFSET UNITYSDK_OFFSET(0x902C90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_COMPARE_OFFSET UNITYSDK_OFFSET(0x19F6C490)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x902AE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x902BE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_EQUALS_3_OFFSET UNITYSDK_OFFSET(0x902C20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x902AD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x902E40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x2C50C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x902F00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x2C50B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x19F6C790)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_EQUALITY_2_OFFSET UNITYSDK_OFFSET(0x19F6C870)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19F6C710)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19F6C940)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x19F6C800)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_INEQUALITY_2_OFFSET UNITYSDK_OFFSET(0x19F6C8D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19F6C750)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_STARTSWITH_OFFSET UNITYSDK_OFFSET(0x902CD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_SUBSTR_OFFSET UNITYSDK_OFFSET(0x902DE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x902E10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x315C50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__CTOR_2_OFFSET UNITYSDK_OFFSET(0x902AA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x902A80)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int Substring_TypeDefinitionIndex = 27973;
