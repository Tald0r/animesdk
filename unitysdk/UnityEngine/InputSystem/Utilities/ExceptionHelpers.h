...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_EXCEPTIONHELPERS_ISEXCEPTIONINDICATINGBUGINCODE_OFFSET UNITYSDK_OFFSET(0x1A511470)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int ExceptionHelpers_TypeDefinitionIndex = 27931;
