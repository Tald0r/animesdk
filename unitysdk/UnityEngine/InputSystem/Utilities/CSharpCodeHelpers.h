...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_CSHARPCODEHELPERS_ISEMPTYORPROPERIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A58FA80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_CSHARPCODEHELPERS_ISEMPTYORPROPERNAMESPACENAME_OFFSET UNITYSDK_OFFSET(0x1A58FAA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_CSHARPCODEHELPERS_ISPROPERIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A58F950)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_CSHARPCODEHELPERS_MAKEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A58FB80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_CSHARPCODEHELPERS_MAKETYPENAME_OFFSET UNITYSDK_OFFSET(0x1A58FE60)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int CSharpCodeHelpers_TypeDefinitionIndex = 28865;
