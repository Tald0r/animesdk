...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9029B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x902950)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9029A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x902A00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x902910)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int InputActionTrace_Enumerator_TypeDefinitionIndex = 27920;
