...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x92E340)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x92E2E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x92E330)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x92E390)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x92E2A0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int InputActionTrace_Enumerator_TypeDefinitionIndex = 28860;
