...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A0B1680)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x908D70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x908D20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x908E00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A0AFA20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A0B0B40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1A0B0B70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1A0B1300)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1A0B0A90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x1A0B0B10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x1A0B1340)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_7_OFFSET UNITYSDK_OFFSET(0x1A0B1370)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A0B0D10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A0B24C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x908B20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x908C90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_TOINTEGER_OFFSET UNITYSDK_OFFSET(0x908C20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x908D10)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int JsonParser_JsonValue_TypeDefinitionIndex = 28880;
