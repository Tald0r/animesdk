...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_ALIGNTOMULTIPLEOF_1_OFFSET UNITYSDK_OFFSET(0x18C0BF30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_ALIGNTOMULTIPLEOF_2_OFFSET UNITYSDK_OFFSET(0x18C0BF70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_ALIGNTOMULTIPLEOF_OFFSET UNITYSDK_OFFSET(0x18C0BF10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x18C0BF90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_INTTONORMALIZEDFLOAT_OFFSET UNITYSDK_OFFSET(0x18C0C030)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_NORMALIZEDFLOATTOINT_OFFSET UNITYSDK_OFFSET(0x18C0C070)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_NORMALIZEDFLOATTOUINT_OFFSET UNITYSDK_OFFSET(0x18C0C100)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_UINTTONORMALIZEDFLOAT_OFFSET UNITYSDK_OFFSET(0x18C0C0B0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int NumberHelpers_TypeDefinitionIndex = 27949;
