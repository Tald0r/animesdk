...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_ALIGNTOMULTIPLEOF_1_OFFSET UNITYSDK_OFFSET(0x190A9210)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_ALIGNTOMULTIPLEOF_2_OFFSET UNITYSDK_OFFSET(0x190A9250)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_ALIGNTOMULTIPLEOF_OFFSET UNITYSDK_OFFSET(0x190A91F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x190A9270)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_INTTONORMALIZEDFLOAT_OFFSET UNITYSDK_OFFSET(0x190A9310)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_NORMALIZEDFLOATTOINT_OFFSET UNITYSDK_OFFSET(0x190A9350)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_NORMALIZEDFLOATTOUINT_OFFSET UNITYSDK_OFFSET(0x190A93E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NUMBERHELPERS_UINTTONORMALIZEDFLOAT_OFFSET UNITYSDK_OFFSET(0x190A9390)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int NumberHelpers_TypeDefinitionIndex = 28889;
