...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A3EC710)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A3EC950)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3EC8E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A3EC9D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3EC940)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A3EC8F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A3EC700)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__SPLIT_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3EC6E0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int StringHelpers__Split_d__9_TypeDefinitionIndex = 27972;

	class StringHelpers__Split_d__9 : public ::System::Object
	{
	public:
		::System::String* __2__current; // 0x10
		::System::Func_2<::System::Char, ::System::Boolean>* __3__predicate; // 0x18
		::System::Func_2<::System::Char, ::System::Boolean>* predicate; // 0x20
