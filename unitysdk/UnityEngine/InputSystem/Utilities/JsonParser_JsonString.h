...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x92FA20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x92F9F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x92FA90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A590870)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A5908D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A5908A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x92F9E0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int JsonParser_JsonString_TypeDefinitionIndex = 28879;
