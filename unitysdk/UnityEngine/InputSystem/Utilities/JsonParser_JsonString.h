...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x904090)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x904060)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x904100)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19F7FA80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19F7FAE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19F7FAB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_JSONPARSER_JSONSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x904050)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int JsonParser_JsonString_TypeDefinitionIndex = 27939;
