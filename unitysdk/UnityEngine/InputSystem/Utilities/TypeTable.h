...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_ADDTYPEREGISTRATION_OFFSET UNITYSDK_OFFSET(0x98E370)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_FINDNAMEFORTYPE_OFFSET UNITYSDK_OFFSET(0x98E350)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_GET_INTERNEDNAMES_OFFSET UNITYSDK_OFFSET(0x98E280)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x98E270)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x98E2D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_LOOKUPTYPEREGISTRATION_OFFSET UNITYSDK_OFFSET(0x98E380)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int TypeTable_TypeDefinitionIndex = 28915;
