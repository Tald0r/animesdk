...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_ADDTYPEREGISTRATION_OFFSET UNITYSDK_OFFSET(0x95B810)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_FINDNAMEFORTYPE_OFFSET UNITYSDK_OFFSET(0x95B7F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_GET_INTERNEDNAMES_OFFSET UNITYSDK_OFFSET(0x95B720)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x95B710)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x95B770)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPETABLE_LOOKUPTYPEREGISTRATION_OFFSET UNITYSDK_OFFSET(0x95B820)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int TypeTable_TypeDefinitionIndex = 27975;
