...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x904030)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_EQUALS_OFFSET UNITYSDK_OFFSET(0x3275B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_FROMINT32_OFFSET UNITYSDK_OFFSET(0x19F7F600)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19F7F5F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x19F76BA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19F7F2B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19F7E600)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_TOINT32_OFFSET UNITYSDK_OFFSET(0x19F7F610)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x904020)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x903FF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC__CTOR_2_OFFSET UNITYSDK_OFFSET(0x904010)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3600)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int FourCC_TypeDefinitionIndex = 27932;
