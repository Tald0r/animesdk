...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x92F9C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_EQUALS_OFFSET UNITYSDK_OFFSET(0x32E7F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_FROMINT32_OFFSET UNITYSDK_OFFSET(0x1A5903F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A5903E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A587990)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A5900A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A58F3F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_TOINT32_OFFSET UNITYSDK_OFFSET(0x1A590400)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x92F9B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x92F980)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC__CTOR_2_OFFSET UNITYSDK_OFFSET(0x92F9A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FOURCC__CTOR_OFFSET UNITYSDK_OFFSET(0x302300)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int FourCC_TypeDefinitionIndex = 28872;
