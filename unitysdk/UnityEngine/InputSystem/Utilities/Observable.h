...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_OBSERVABLE_FORDEVICE_OFFSET UNITYSDK_OFFSET(0x19DA9B90)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int Observable_TypeDefinitionIndex = 27952;
