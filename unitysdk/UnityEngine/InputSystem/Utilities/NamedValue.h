...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_APPLYTOOBJECT_OFFSET UNITYSDK_OFFSET(0x8F8AE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x8F8850)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8F8990)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8F8920)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F8A30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x510240)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19DA9320)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19DA9390)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_PARSEMULTIPLE_OFFSET UNITYSDK_OFFSET(0x19DA4BC0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_PARSEPARAMETER_OFFSET UNITYSDK_OFFSET(0x19DA9400)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_PARSE_OFFSET UNITYSDK_OFFSET(0x19DA9800)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x8F8840)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEDVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8F8890)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int NamedValue_TypeDefinitionIndex = 27948;
