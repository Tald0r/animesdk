...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_MEMORYHELPERS_BITREGION_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x96D360)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_MEMORYHELPERS_BITREGION_OVERLAP_OFFSET UNITYSDK_OFFSET(0x96D380)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_MEMORYHELPERS_BITREGION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x96D370)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_MEMORYHELPERS_BITREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3C30)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int MemoryHelpers_BitRegion_TypeDefinitionIndex = 28883;
