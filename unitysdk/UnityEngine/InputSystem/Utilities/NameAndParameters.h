...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x547860)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_PARSEMULTIPLE_1_OFFSET UNITYSDK_OFFSET(0x1AD3C5E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_PARSEMULTIPLE_OFFSET UNITYSDK_OFFSET(0x1AD37950)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_PARSENAMEANDPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1AD3C700)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_PARSENAME_OFFSET UNITYSDK_OFFSET(0x1AD3CAA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_PARSE_OFFSET UNITYSDK_OFFSET(0x1AD36B20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_SET_NAME_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x92CD40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x96D3E0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int NameAndParameters_TypeDefinitionIndex = 28886;
