...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x510240)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_PARSEMULTIPLE_1_OFFSET UNITYSDK_OFFSET(0x1A78C490)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_PARSEMULTIPLE_OFFSET UNITYSDK_OFFSET(0x1A7877C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_PARSENAMEANDPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A78C5B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_PARSENAME_OFFSET UNITYSDK_OFFSET(0x1A78C950)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_PARSE_OFFSET UNITYSDK_OFFSET(0x1A786990)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_SET_NAME_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x8F8840)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_NAMEANDPARAMETERS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x93F810)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int NameAndParameters_TypeDefinitionIndex = 27946;
