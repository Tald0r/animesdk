...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPEHELPERS_GETGENERICTYPEARGUMENTFROMHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1A50C1C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPEHELPERS_GETNICETYPENAME_OFFSET UNITYSDK_OFFSET(0x1A5117A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPEHELPERS_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1A511700)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPEHELPERS_ISINT_OFFSET UNITYSDK_OFFSET(0x1A5116F0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int TypeHelpers_TypeDefinitionIndex = 27974;
