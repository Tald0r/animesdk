...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPEHELPERS_GETGENERICTYPEARGUMENTFROMHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1AAC5B20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPEHELPERS_GETNICETYPENAME_OFFSET UNITYSDK_OFFSET(0x1AACB140)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPEHELPERS_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1AACB0A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_TYPEHELPERS_ISINT_OFFSET UNITYSDK_OFFSET(0x1AACB090)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int TypeHelpers_TypeDefinitionIndex = 28914;
