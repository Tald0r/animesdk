...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A3EBE20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_DISPOSEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A3EBF20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A3EC480)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A3EBEB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A3EC400)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1A3EAC60)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A3EAC80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_HOOKONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A3EB3A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A3EC520)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_RECORDACTION_OFFSET UNITYSDK_OFFSET(0x1A3EB990)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_SUBSCRIBETOALL_OFFSET UNITYSDK_OFFSET(0x1A3EB220)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_SUBSCRIBETO_1_OFFSET UNITYSDK_OFFSET(0x1A3EB0B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_SUBSCRIBETO_OFFSET UNITYSDK_OFFSET(0x1A3EAD10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A3EC4A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3EC040)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_UNHOOKONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A3EB8E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_UNSUBSCRIBEFROMALL_OFFSET UNITYSDK_OFFSET(0x1A3EB7B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_UNSUBSCRIBEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A3EB660)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_UNSUBSCRIBEFROM_OFFSET UNITYSDK_OFFSET(0x1A3EB490)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3EACA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A3EAF00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3EAC90)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int InputActionTrace_TypeDefinitionIndex = 27918;

	class InputActionTrace : public ::System::Object
	{
	public:
		::System::Action_1<::UnityEngine::InputSystem::InputAction_CallbackContext>* m_CallbackDelegate; // 0x10
		::System::Action_2<::System::Object*, ::UnityEngine::InputSystem::InputActionChange>* m_ActionChangeDelegate; // 0x18
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputAction*> m_SubscribedActions; // 0x20
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputActionState*> m_ActionMapStateClones; // 0x38
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputActionState*> m_ActionMapStates; // 0x50
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputActionMap*> m_SubscribedActionMaps; // 0x68
