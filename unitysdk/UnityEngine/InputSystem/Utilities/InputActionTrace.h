...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A9B0470)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_DISPOSEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A9B0570)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A9B0AD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A9B0500)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A9B0A50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x1A9AF2B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A9AF2D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_HOOKONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A9AF9F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A9B0B70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_RECORDACTION_OFFSET UNITYSDK_OFFSET(0x1A9AFFE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_SUBSCRIBETOALL_OFFSET UNITYSDK_OFFSET(0x1A9AF870)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_SUBSCRIBETO_1_OFFSET UNITYSDK_OFFSET(0x1A9AF700)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_SUBSCRIBETO_OFFSET UNITYSDK_OFFSET(0x1A9AF360)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A9B0AF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A9B0690)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_UNHOOKONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A9AFF30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_UNSUBSCRIBEFROMALL_OFFSET UNITYSDK_OFFSET(0x1A9AFE00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_UNSUBSCRIBEFROM_1_OFFSET UNITYSDK_OFFSET(0x1A9AFCB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_UNSUBSCRIBEFROM_OFFSET UNITYSDK_OFFSET(0x1A9AFAE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9AF2F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A9AF550)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9AF2E0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int InputActionTrace_TypeDefinitionIndex = 28858;
	...
	public:
		...
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputActionState*> m_ActionMapStates; // 0x28
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputActionMap*> m_SubscribedActionMaps; // 0x40
		::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::InputActionState*> m_ActionMapStateClones; // 0x58
