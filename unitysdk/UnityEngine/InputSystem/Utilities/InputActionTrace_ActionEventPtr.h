...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x955030)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0x955070)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x955160)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_INTERACTION_OFFSET UNITYSDK_OFFSET(0x9550C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_PHASE_OFFSET UNITYSDK_OFFSET(0x955060)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x955150)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_TIME_OFFSET UNITYSDK_OFFSET(0x955120)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_GET_VALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x955190)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x9551A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_READVALUE_OFFSET UNITYSDK_OFFSET(0x9551B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_INPUTACTIONTRACE_ACTIONEVENTPTR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9551C0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int InputActionTrace_ActionEventPtr_TypeDefinitionIndex = 28859;
