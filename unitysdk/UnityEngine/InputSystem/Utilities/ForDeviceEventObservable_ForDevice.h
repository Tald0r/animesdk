...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FORDEVICEEVENTOBSERVABLE_FORDEVICE_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1AACAE90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FORDEVICEEVENTOBSERVABLE_FORDEVICE_ONERROR_OFFSET UNITYSDK_OFFSET(0x1AACAEA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FORDEVICEEVENTOBSERVABLE_FORDEVICE_ONNEXT_OFFSET UNITYSDK_OFFSET(0x1AACAED0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FORDEVICEEVENTOBSERVABLE_FORDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AACAE80)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int ForDeviceEventObservable_ForDevice_TypeDefinitionIndex = 28891;
