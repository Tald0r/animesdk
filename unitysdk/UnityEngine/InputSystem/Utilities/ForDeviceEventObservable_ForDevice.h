...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FORDEVICEEVENTOBSERVABLE_FORDEVICE_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1A5114F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FORDEVICEEVENTOBSERVABLE_FORDEVICE_ONERROR_OFFSET UNITYSDK_OFFSET(0x1A511500)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FORDEVICEEVENTOBSERVABLE_FORDEVICE_ONNEXT_OFFSET UNITYSDK_OFFSET(0x1A511530)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_FORDEVICEEVENTOBSERVABLE_FORDEVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5114E0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int ForDeviceEventObservable_ForDevice_TypeDefinitionIndex = 27951;
	...
	public:
		...
		::System::IObserver_1<::UnityEngine::InputSystem::LowLevel::InputEventPtr>* m_Observer; // 0x20
