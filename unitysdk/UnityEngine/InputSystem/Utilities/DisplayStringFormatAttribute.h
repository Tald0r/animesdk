...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_DISPLAYSTRINGFORMATATTRIBUTE_GET_FORMATSTRING_OFFSET UNITYSDK_OFFSET(0x1A3EAC30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_DISPLAYSTRINGFORMATATTRIBUTE_SET_FORMATSTRING_OFFSET UNITYSDK_OFFSET(0x1A3EAC40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_DISPLAYSTRINGFORMATATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3EAC50)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int DisplayStringFormatAttribute_TypeDefinitionIndex = 27930;
