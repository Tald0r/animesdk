...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x927660)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9276C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x927680)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1A694880)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMBYTE_OFFSET UNITYSDK_OFFSET(0x1A6948C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMCHAR_OFFSET UNITYSDK_OFFSET(0x1A6948A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A6949E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMINT16_OFFSET UNITYSDK_OFFSET(0x1A694900)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMINT32_OFFSET UNITYSDK_OFFSET(0x1A694940)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMINT64_OFFSET UNITYSDK_OFFSET(0x1A694980)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMOBJECT_OFFSET UNITYSDK_OFFSET(0x1A6938B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMSBYTE_OFFSET UNITYSDK_OFFSET(0x1A6948E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMSINGLE_OFFSET UNITYSDK_OFFSET(0x1A6949C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMSTRING_OFFSET UNITYSDK_OFFSET(0x1A6940E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMUINT16_OFFSET UNITYSDK_OFFSET(0x1A694920)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMUINT32_OFFSET UNITYSDK_OFFSET(0x1A694960)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMUINT64_OFFSET UNITYSDK_OFFSET(0x1A6949A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9276D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_GETTYPECODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x33C9B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A693CD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_10_OFFSET UNITYSDK_OFFSET(0x1A693660)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_11_OFFSET UNITYSDK_OFFSET(0x1A693750)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A693160)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1A6931F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1A693280)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1A693320)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x1A694840)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x1A6933C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_7_OFFSET UNITYSDK_OFFSET(0x1A694860)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_8_OFFSET UNITYSDK_OFFSET(0x1A693460)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_9_OFFSET UNITYSDK_OFFSET(0x1A693540)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A6930E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A693D10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x927700)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOBYTE_OFFSET UNITYSDK_OFFSET(0x927710)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOCHAR_OFFSET UNITYSDK_OFFSET(0x927780)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TODATETIME_OFFSET UNITYSDK_OFFSET(0x9277E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TODECIMAL_OFFSET UNITYSDK_OFFSET(0x927830)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x927930)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOINT16_OFFSET UNITYSDK_OFFSET(0x927A00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOINT32_OFFSET UNITYSDK_OFFSET(0x927A80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOINT64_OFFSET UNITYSDK_OFFSET(0x927B00)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOOBJECT_OFFSET UNITYSDK_OFFSET(0x927F10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOSBYTE_OFFSET UNITYSDK_OFFSET(0x927710)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOSINGLE_OFFSET UNITYSDK_OFFSET(0x927B80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x9276F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9276F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOTYPE_OFFSET UNITYSDK_OFFSET(0x927C80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOUINT16_OFFSET UNITYSDK_OFFSET(0x927CD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOUINT32_OFFSET UNITYSDK_OFFSET(0x927D90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOUINT64_OFFSET UNITYSDK_OFFSET(0x927E50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_10_OFFSET UNITYSDK_OFFSET(0x927620)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_11_OFFSET UNITYSDK_OFFSET(0x927640)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x927500)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x927520)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x927540)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x927560)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x927580)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x9275A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x9275C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_8_OFFSET UNITYSDK_OFFSET(0x9275E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_9_OFFSET UNITYSDK_OFFSET(0x927600)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x9274E0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int PrimitiveValue_TypeDefinitionIndex = 27963;
