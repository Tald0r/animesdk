...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_CONVERTTO_OFFSET UNITYSDK_OFFSET(0x955430)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x955490)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_EQUALS_OFFSET UNITYSDK_OFFSET(0x955450)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1AC3FB70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMBYTE_OFFSET UNITYSDK_OFFSET(0x1AC3FBB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMCHAR_OFFSET UNITYSDK_OFFSET(0x1AC3FB90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMDOUBLE_OFFSET UNITYSDK_OFFSET(0x1AC3FCD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMINT16_OFFSET UNITYSDK_OFFSET(0x1AC3FBF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMINT32_OFFSET UNITYSDK_OFFSET(0x1AC3FC30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMINT64_OFFSET UNITYSDK_OFFSET(0x1AC3FC70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMOBJECT_OFFSET UNITYSDK_OFFSET(0x1AC3EBA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMSBYTE_OFFSET UNITYSDK_OFFSET(0x1AC3FBD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMSINGLE_OFFSET UNITYSDK_OFFSET(0x1AC3FCB0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMSTRING_OFFSET UNITYSDK_OFFSET(0x1AC3F3D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMUINT16_OFFSET UNITYSDK_OFFSET(0x1AC3FC10)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMUINT32_OFFSET UNITYSDK_OFFSET(0x1AC3FC50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_FROMUINT64_OFFSET UNITYSDK_OFFSET(0x1AC3FC90)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9554A0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_GETTYPECODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x315FD0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AC3EFC0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_10_OFFSET UNITYSDK_OFFSET(0x1AC3E950)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_11_OFFSET UNITYSDK_OFFSET(0x1AC3EA40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1AC3E450)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1AC3E4E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1AC3E570)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1AC3E610)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_5_OFFSET UNITYSDK_OFFSET(0x1AC3FB30)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_6_OFFSET UNITYSDK_OFFSET(0x1AC3E6B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_7_OFFSET UNITYSDK_OFFSET(0x1AC3FB50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_8_OFFSET UNITYSDK_OFFSET(0x1AC3E750)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_9_OFFSET UNITYSDK_OFFSET(0x1AC3E830)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AC3E3D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AC3F000)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOBOOLEAN_OFFSET UNITYSDK_OFFSET(0x9554D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOBYTE_OFFSET UNITYSDK_OFFSET(0x9554E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOCHAR_OFFSET UNITYSDK_OFFSET(0x955550)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TODATETIME_OFFSET UNITYSDK_OFFSET(0x9555B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TODECIMAL_OFFSET UNITYSDK_OFFSET(0x955600)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x955700)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOINT16_OFFSET UNITYSDK_OFFSET(0x9557D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOINT32_OFFSET UNITYSDK_OFFSET(0x955850)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOINT64_OFFSET UNITYSDK_OFFSET(0x9558D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOOBJECT_OFFSET UNITYSDK_OFFSET(0x955CE0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOSBYTE_OFFSET UNITYSDK_OFFSET(0x9554E0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOSINGLE_OFFSET UNITYSDK_OFFSET(0x955950)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x9554C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9554C0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOTYPE_OFFSET UNITYSDK_OFFSET(0x955A50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOUINT16_OFFSET UNITYSDK_OFFSET(0x955AA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOUINT32_OFFSET UNITYSDK_OFFSET(0x955B60)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE_TOUINT64_OFFSET UNITYSDK_OFFSET(0x955C20)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_10_OFFSET UNITYSDK_OFFSET(0x9553F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_11_OFFSET UNITYSDK_OFFSET(0x955410)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9552D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9552F0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x955310)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_4_OFFSET UNITYSDK_OFFSET(0x955330)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_5_OFFSET UNITYSDK_OFFSET(0x955350)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_6_OFFSET UNITYSDK_OFFSET(0x955370)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_7_OFFSET UNITYSDK_OFFSET(0x955390)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_8_OFFSET UNITYSDK_OFFSET(0x9553B0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_9_OFFSET UNITYSDK_OFFSET(0x9553D0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_PRIMITIVEVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x9552B0)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int PrimitiveValue_TypeDefinitionIndex = 28903;
