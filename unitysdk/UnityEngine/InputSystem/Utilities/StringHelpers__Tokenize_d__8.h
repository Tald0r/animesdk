...
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A3ECA80)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A3ECDF0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_UTILITIES_SUBSTRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3ECD40)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A3ECE70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3ECDA0)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A3ECD50)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A3ECA70)
#define UNITYENGINE_INPUTSYSTEM_UTILITIES_STRINGHELPERS__TOKENIZE_D__8__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3ECA50)

namespace UnityEngine::InputSystem::Utilities
{
	inline static constexpr unsigned int StringHelpers__Tokenize_d__8_TypeDefinitionIndex = 27971;
	...
	public:
		...
		::System::Int32 _endPos_5__3; // 0x34
