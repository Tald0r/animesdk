...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_ERASE_OFFSET UNITYSDK_OFFSET(0x908DA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_GET_BINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x908670)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_GET_BINDING_OFFSET UNITYSDK_OFFSET(0x9086B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_GET_VALID_OFFSET UNITYSDK_OFFSET(0x908640)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_INSERTPARTBINDING_OFFSET UNITYSDK_OFFSET(0x908DB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_ITERATECOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x908D60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_ITERATEPARTBINDING_OFFSET UNITYSDK_OFFSET(0x908D80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_ITERATE_OFFSET UNITYSDK_OFFSET(0x908C40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_NEXTBINDING_OFFSET UNITYSDK_OFFSET(0x908850)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_NEXTCOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x908BC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_NEXTPARTBINDING_OFFSET UNITYSDK_OFFSET(0x908A80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_PREVIOUSBINDING_OFFSET UNITYSDK_OFFSET(0x908960)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_PREVIOUSCOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x908C00)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_PREVIOUSPARTBINDING_OFFSET UNITYSDK_OFFSET(0x908B20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_TO_OFFSET UNITYSDK_OFFSET(0x9087F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_TRIGGERING_OFFSET UNITYSDK_OFFSET(0x9087D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHGROUPS_OFFSET UNITYSDK_OFFSET(0x908730)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHGROUP_OFFSET UNITYSDK_OFFSET(0x908710)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x908770)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHINTERACTION_OFFSET UNITYSDK_OFFSET(0x908750)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHNAME_OFFSET UNITYSDK_OFFSET(0x9086D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHPATH_OFFSET UNITYSDK_OFFSET(0x9086F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHPROCESSORS_OFFSET UNITYSDK_OFFSET(0x9087B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHPROCESSOR_OFFSET UNITYSDK_OFFSET(0x908790)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX__CTOR_OFFSET UNITYSDK_OFFSET(0x3A2AD0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionSetupExtensions_BindingSyntax_TypeDefinitionIndex = 27443;
