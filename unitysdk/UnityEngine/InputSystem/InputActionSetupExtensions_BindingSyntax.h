...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_ERASE_OFFSET UNITYSDK_OFFSET(0x934F70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_GET_BINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x934840)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_GET_BINDING_OFFSET UNITYSDK_OFFSET(0x934880)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_GET_VALID_OFFSET UNITYSDK_OFFSET(0x934810)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_INSERTPARTBINDING_OFFSET UNITYSDK_OFFSET(0x934F80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_ITERATECOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x934F30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_ITERATEPARTBINDING_OFFSET UNITYSDK_OFFSET(0x934F50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_ITERATE_OFFSET UNITYSDK_OFFSET(0x934E10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_NEXTBINDING_OFFSET UNITYSDK_OFFSET(0x934A20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_NEXTCOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x934D90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_NEXTPARTBINDING_OFFSET UNITYSDK_OFFSET(0x934C50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_PREVIOUSBINDING_OFFSET UNITYSDK_OFFSET(0x934B30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_PREVIOUSCOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x934DD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_PREVIOUSPARTBINDING_OFFSET UNITYSDK_OFFSET(0x934CF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_TO_OFFSET UNITYSDK_OFFSET(0x9349C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_TRIGGERING_OFFSET UNITYSDK_OFFSET(0x9349A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHGROUPS_OFFSET UNITYSDK_OFFSET(0x934900)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHGROUP_OFFSET UNITYSDK_OFFSET(0x9348E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x934940)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHINTERACTION_OFFSET UNITYSDK_OFFSET(0x934920)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHNAME_OFFSET UNITYSDK_OFFSET(0x9348A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHPATH_OFFSET UNITYSDK_OFFSET(0x9348C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHPROCESSORS_OFFSET UNITYSDK_OFFSET(0x934980)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX_WITHPROCESSOR_OFFSET UNITYSDK_OFFSET(0x934960)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_BINDINGSYNTAX__CTOR_OFFSET UNITYSDK_OFFSET(0x716210)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionSetupExtensions_BindingSyntax_TypeDefinitionIndex = 28383;
