...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_COMPOSITESYNTAX_GET_BINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x9297F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_COMPOSITESYNTAX_WITH_OFFSET UNITYSDK_OFFSET(0x929830)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_COMPOSITESYNTAX__CTOR_OFFSET UNITYSDK_OFFSET(0x929820)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionSetupExtensions_CompositeSyntax_TypeDefinitionIndex = 28384;
