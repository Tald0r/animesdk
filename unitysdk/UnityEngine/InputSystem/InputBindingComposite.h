...
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE_CALLFINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1A587B60)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1A587B40)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1A587B50)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE_GETDISPLAYFORMATSTRING_OFFSET UNITYSDK_OFFSET(0x1A587DB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE_GETEXPECTEDCONTROLLAYOUTNAME_OFFSET UNITYSDK_OFFSET(0x1A587C30)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE_GETPARTNAMES_OFFSET UNITYSDK_OFFSET(0x1A587D50)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1A587B70)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A587E50)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputBindingComposite_TypeDefinitionIndex = 27464;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::Utilities::TypeTable*)Il2CppClass::FromTypeDefinitionIndex(InputBindingComposite_TypeDefinitionIndex)->GetStaticField(0x204B0);
		}
