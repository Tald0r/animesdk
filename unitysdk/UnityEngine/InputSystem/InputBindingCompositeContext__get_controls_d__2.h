...
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT__GET_CONTROLS_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A5764B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT__GET_CONTROLS_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_PARTBINDING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A576670)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT__GET_CONTROLS_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_PARTBINDING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A5765C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT__GET_CONTROLS_D__2_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A5766F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT__GET_CONTROLS_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A576620)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT__GET_CONTROLS_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A5765D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT__GET_CONTROLS_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A5764A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT__GET_CONTROLS_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A576480)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputBindingCompositeContext__get_controls_d__2_TypeDefinitionIndex = 28410;
	...
	public:
		...
		::System::Int32 _controlStartIndex_5__5; // 0x5C
		::System::Int32 __l__initialThreadId; // 0x60
		::System::Int32 _totalBindingCount_5__2; // 0x64
