...
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDREPORTDATA_FINDORADDREPORT_OFFSET UNITYSDK_OFFSET(0x18681BF0)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HIDParser_HIDReportData_TypeDefinitionIndex = 27688;
