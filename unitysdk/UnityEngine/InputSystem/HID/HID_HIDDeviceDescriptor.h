...
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTOR_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1A4C8C40)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTOR_TOJSON_OFFSET UNITYSDK_OFFSET(0x929790)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HID_HIDDeviceDescriptor_TypeDefinitionIndex = 28620;
