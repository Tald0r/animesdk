...
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_ADDCHILDCONTROLS_OFFSET UNITYSDK_OFFSET(0x862DF0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEAXISNORMALIZATIONPARAMETERS_OFFSET UNITYSDK_OFFSET(0x862CC0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x862D30)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x862A50)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEFORMAT_OFFSET UNITYSDK_OFFSET(0x862C00)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINELAYOUT_OFFSET UNITYSDK_OFFSET(0x862B40)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINENAME_OFFSET UNITYSDK_OFFSET(0x862A40)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x862CB0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEPROCESSORS_OFFSET UNITYSDK_OFFSET(0x862CD0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEUSAGES_OFFSET UNITYSDK_OFFSET(0x862CA0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_HASNULLSTATE_OFFSET UNITYSDK_OFFSET(0x862880)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_HASPREFERREDSTATE_OFFSET UNITYSDK_OFFSET(0x862890)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x8628A0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x8628D0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISNONLINEAR_OFFSET UNITYSDK_OFFSET(0x8628B0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISRELATIVE_OFFSET UNITYSDK_OFFSET(0x8628C0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISSIGNED_OFFSET UNITYSDK_OFFSET(0x8628F0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISWRAPPING_OFFSET UNITYSDK_OFFSET(0x8628E0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_MAXFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x862990)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_MINFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x862900)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_ISUSABLEELEMENT_OFFSET UNITYSDK_OFFSET(0x862A60)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_IS_OFFSET UNITYSDK_OFFSET(0x862A30)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HID_HIDElementDescriptor_TypeDefinitionIndex = 28618;
