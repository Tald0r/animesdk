...
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_ADDCHILDCONTROLS_OFFSET UNITYSDK_OFFSET(0x837B30)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEAXISNORMALIZATIONPARAMETERS_OFFSET UNITYSDK_OFFSET(0x837A00)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x837A70)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x837770)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEFORMAT_OFFSET UNITYSDK_OFFSET(0x837920)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINELAYOUT_OFFSET UNITYSDK_OFFSET(0x837860)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINENAME_OFFSET UNITYSDK_OFFSET(0x837760)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x8379F0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEPROCESSORS_OFFSET UNITYSDK_OFFSET(0x837A10)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_DETERMINEUSAGES_OFFSET UNITYSDK_OFFSET(0x8379E0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_HASNULLSTATE_OFFSET UNITYSDK_OFFSET(0x8375A0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_HASPREFERREDSTATE_OFFSET UNITYSDK_OFFSET(0x8375B0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x8375C0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISCONSTANT_OFFSET UNITYSDK_OFFSET(0x8375F0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISNONLINEAR_OFFSET UNITYSDK_OFFSET(0x8375D0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISRELATIVE_OFFSET UNITYSDK_OFFSET(0x8375E0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISSIGNED_OFFSET UNITYSDK_OFFSET(0x837610)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_ISWRAPPING_OFFSET UNITYSDK_OFFSET(0x837600)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_MAXFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x8376B0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_GET_MINFLOATVALUE_OFFSET UNITYSDK_OFFSET(0x837620)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_ISUSABLEELEMENT_OFFSET UNITYSDK_OFFSET(0x837780)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDELEMENTDESCRIPTOR_IS_OFFSET UNITYSDK_OFFSET(0x837750)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HID_HIDElementDescriptor_TypeDefinitionIndex = 27678;
