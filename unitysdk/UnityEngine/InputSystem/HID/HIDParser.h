...
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_PARSEREPORTDESCRIPTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB80310)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_PARSEREPORTDESCRIPTOR_OFFSET UNITYSDK_OFFSET(0x1AB80290)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_READDATA_OFFSET UNITYSDK_OFFSET(0x1AB81840)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HIDParser_TypeDefinitionIndex = 27687;
