...
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATELOCAL_GETUSAGE_OFFSET UNITYSDK_OFFSET(0x8D5420)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATELOCAL_RESET_OFFSET UNITYSDK_OFFSET(0x19AB0500)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATELOCAL_SETUSAGE_OFFSET UNITYSDK_OFFSET(0x8D5410)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HIDParser_HIDItemStateLocal_TypeDefinitionIndex = 27690;
