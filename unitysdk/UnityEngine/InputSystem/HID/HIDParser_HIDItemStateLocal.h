...
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATELOCAL_GETUSAGE_OFFSET UNITYSDK_OFFSET(0x907920)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATELOCAL_RESET_OFFSET UNITYSDK_OFFSET(0x1A09EB10)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATELOCAL_SETUSAGE_OFFSET UNITYSDK_OFFSET(0x907910)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HIDParser_HIDItemStateLocal_TypeDefinitionIndex = 28630;
