...
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATEGLOBAL_GETPHYSICALMAX_OFFSET UNITYSDK_OFFSET(0x8F7AD0)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATEGLOBAL_GETPHYSICALMIN_OFFSET UNITYSDK_OFFSET(0x8F7AA0)
#define UNITYENGINE_INPUTSYSTEM_HID_HIDPARSER_HIDITEMSTATEGLOBAL_GETUSAGEPAGE_OFFSET UNITYSDK_OFFSET(0x8F7A70)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HIDParser_HIDItemStateGlobal_TypeDefinitionIndex = 27691;
