...
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER_ADDELEMENT_1_OFFSET UNITYSDK_OFFSET(0x901DC0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER_ADDELEMENT_OFFSET UNITYSDK_OFFSET(0x901D90)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER_FINISH_OFFSET UNITYSDK_OFFSET(0x901E60)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER_STARTREPORT_OFFSET UNITYSDK_OFFSET(0x901D40)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER_WITHLOGICALMINMAX_OFFSET UNITYSDK_OFFSET(0x901E40)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER_WITHPHYSICALMINMAX_OFFSET UNITYSDK_OFFSET(0x901E20)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x901D20)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x901D00)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HID_HIDDeviceDescriptorBuilder_TypeDefinitionIndex = 27681;
