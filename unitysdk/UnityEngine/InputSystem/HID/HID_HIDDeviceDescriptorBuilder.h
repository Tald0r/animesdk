...
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER_ADDELEMENT_1_OFFSET UNITYSDK_OFFSET(0x92D750)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER_ADDELEMENT_OFFSET UNITYSDK_OFFSET(0x92D720)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER_FINISH_OFFSET UNITYSDK_OFFSET(0x92D7F0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER_STARTREPORT_OFFSET UNITYSDK_OFFSET(0x92D6D0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER_WITHLOGICALMINMAX_OFFSET UNITYSDK_OFFSET(0x92D7D0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER_WITHPHYSICALMINMAX_OFFSET UNITYSDK_OFFSET(0x92D7B0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x92D6B0)
#define UNITYENGINE_INPUTSYSTEM_HID_HID_HIDDEVICEDESCRIPTORBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x92D690)

namespace UnityEngine::InputSystem::HID
{
	inline static constexpr unsigned int HID_HIDDeviceDescriptorBuilder_TypeDefinitionIndex = 28621;
