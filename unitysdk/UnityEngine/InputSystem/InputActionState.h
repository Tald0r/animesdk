...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ADDTOGLOBALLIST_OFFSET UNITYSDK_OFFSET(0x18BE5380)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CALLACTIONLISTENERS_OFFSET UNITYSDK_OFFSET(0x18BEA4C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CANUSEDEVICE_OFFSET UNITYSDK_OFFSET(0x18BE5EE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CHANGEPHASEOFACTIONINTERNAL_OFFSET UNITYSDK_OFFSET(0x18BEA270)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CHANGEPHASEOFACTION_OFFSET UNITYSDK_OFFSET(0x18BE6DF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CHANGEPHASEOFINTERACTION_OFFSET UNITYSDK_OFFSET(0x18BE9C20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CLAIMDATAFROM_OFFSET UNITYSDK_OFFSET(0x18BE52A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CLONE_OFFSET UNITYSDK_OFFSET(0x18BE5930)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_COMPACTGLOBALLIST_OFFSET UNITYSDK_OFFSET(0x18BEB870)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_COMPUTEMAGNITUDE_1_OFFSET UNITYSDK_OFFSET(0x18BE93D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_COMPUTEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x18BE8E40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DEFERREDRESOLUTIONOFBINDINGS_OFFSET UNITYSDK_OFFSET(0x18BEC730)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DESTROYALLACTIONMAPSTATES_OFFSET UNITYSDK_OFFSET(0x18BEBAE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DESTROY_OFFSET UNITYSDK_OFFSET(0x18BE54A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLEALLACTIONS_1_OFFSET UNITYSDK_OFFSET(0x18BEC980)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLEALLACTIONS_OFFSET UNITYSDK_OFFSET(0x18BE73D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLECONTROLS_1_OFFSET UNITYSDK_OFFSET(0x18BE75F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLECONTROLS_2_OFFSET UNITYSDK_OFFSET(0x18BE56A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLECONTROLS_OFFSET UNITYSDK_OFFSET(0x18BE7510)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLESINGLEACTION_OFFSET UNITYSDK_OFFSET(0x18BE7560)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18BE4E90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLEALLACTIONS_OFFSET UNITYSDK_OFFSET(0x18BE7090)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLECONTROLS_1_OFFSET UNITYSDK_OFFSET(0x18BE7300)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLECONTROLS_2_OFFSET UNITYSDK_OFFSET(0x18BE6550)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLECONTROLS_OFFSET UNITYSDK_OFFSET(0x18BE7220)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLESINGLEACTION_OFFSET UNITYSDK_OFFSET(0x18BE7270)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_EVALUATECOMPOSITEPARTMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x18BEADE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FETCHACTIONSTATE_OFFSET UNITYSDK_OFFSET(0x18BE7010)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FETCHMAPINDICES_OFFSET UNITYSDK_OFFSET(0x18BE7040)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x18BE5400)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FINDALLENABLEDACTIONS_OFFSET UNITYSDK_OFFSET(0x18BEBC30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FINISHBINDINGCOMPOSITESETUPS_OFFSET UNITYSDK_OFFSET(0x18BE6230)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETACTIONBINDINGSTARTINDEXANDCOUNT_OFFSET UNITYSDK_OFFSET(0x18BE6D10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETACTIONORNONESTRING_OFFSET UNITYSDK_OFFSET(0x18BEA650)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETACTIONORNULL_1_OFFSET UNITYSDK_OFFSET(0x18BEA6A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETACTIONORNULL_OFFSET UNITYSDK_OFFSET(0x18BEA760)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETBINDINGINDEXINMAP_OFFSET UNITYSDK_OFFSET(0x18BEA8C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETBINDINGINDEXINSTATE_OFFSET UNITYSDK_OFFSET(0x18BEA900)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETBINDINGSTATE_OFFSET UNITYSDK_OFFSET(0x18BEA930)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETBINDING_OFFSET UNITYSDK_OFFSET(0x18BEA950)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETCONTROL_OFFSET UNITYSDK_OFFSET(0x18BEA820)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETINTERACTIONORNULL_OFFSET UNITYSDK_OFFSET(0x18BEA870)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETVALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x18BEAA20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x18BEAB10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_ACTIONSTATES_OFFSET UNITYSDK_OFFSET(0x18BE50F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_BINDINGSTATES_OFFSET UNITYSDK_OFFSET(0x18BE5100)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_CONTROLINDEXTOBINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x18BE5120)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_ENABLEDCONTROLS_OFFSET UNITYSDK_OFFSET(0x18BE5130)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_INTERACTIONSTATES_OFFSET UNITYSDK_OFFSET(0x18BE5110)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_ISPROCESSINGCONTROLSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x18BE5140)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_MAPINDICES_OFFSET UNITYSDK_OFFSET(0x18BE50E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALACTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x18BE50A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALBINDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x18BE50B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALCOMPOSITECOUNT_OFFSET UNITYSDK_OFFSET(0x18BE5080)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALCONTROLCOUNT_OFFSET UNITYSDK_OFFSET(0x18BE50D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALINTERACTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x18BE50C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALMAPCOUNT_OFFSET UNITYSDK_OFFSET(0x18BE5090)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_HASENABLEDACTIONS_OFFSET UNITYSDK_OFFSET(0x18BE61C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_HOOKONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x18BE66C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x18BE5150)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISACTIONBOUNDTOCONTROLFROMDEVICE_OFFSET UNITYSDK_OFFSET(0x18BE6A20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISACTUATED_OFFSET UNITYSDK_OFFSET(0x18BE9730)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISCONFLICTINGINPUT_OFFSET UNITYSDK_OFFSET(0x18BE8870)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISCONTROLENABLED_OFFSET UNITYSDK_OFFSET(0x18BE76C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISUSINGDEVICE_OFFSET UNITYSDK_OFFSET(0x18BE5CF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_NOTIFYLISTENERSOFACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x18BE67F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ONBEFOREINITIALUPDATE_OFFSET UNITYSDK_OFFSET(0x18BE7AE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x18BEC140)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_PROCESSCONTROLSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x18BE7DD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_PROCESSDEFAULTINTERACTION_OFFSET UNITYSDK_OFFSET(0x18BE8E90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_PROCESSINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x18BE8680)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_PROCESSTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18BE8390)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READCOMPOSITEPARTVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x18BEB170)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READCOMPOSITEPARTVALUE_OFFSET UNITYSDK_OFFSET(0x18BEAF10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READVALUEASBUTTON_OFFSET UNITYSDK_OFFSET(0x18BEB550)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x18BEB3A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READVALUE_OFFSET UNITYSDK_OFFSET(0x18BEAC00)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_REMOVEMAPFROMGLOBALLIST_OFFSET UNITYSDK_OFFSET(0x18BE5820)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETACTIONSTATESDRIVENBY_OFFSET UNITYSDK_OFFSET(0x18BE6870)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETACTIONSTATE_OFFSET UNITYSDK_OFFSET(0x18BE6B10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETGLOBALS_OFFSET UNITYSDK_OFFSET(0x18BEB9B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETINTERACTIONSTATEANDCANCELIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x18BE6D40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETINTERACTIONSTATE_OFFSET UNITYSDK_OFFSET(0x18BE9540)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESTOREACTIONSTATES_OFFSET UNITYSDK_OFFSET(0x18BE62F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SAVEANDRESETSTATE_OFFSET UNITYSDK_OFFSET(0x18BEB620)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SETCONTROLENABLED_OFFSET UNITYSDK_OFFSET(0x18BE7870)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SETINITIALSTATECHECKPENDING_OFFSET UNITYSDK_OFFSET(0x18BE7700)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SETTOTALTIMEOUTCOMPLETIONTIME_OFFSET UNITYSDK_OFFSET(0x18BE97E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SHOULDIGNOREINPUTONCOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x18BE8660)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SPLITUPMAPANDCONTROLANDBINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x18BE8340)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_STARTTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18BE9820)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_STOPTIMEOUT_OFFSET UNITYSDK_OFFSET(0x18BE9A30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x18BE5CE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_TOCOMBINEDMAPANDCONTROLANDBINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x18BE76E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNHOOKONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x18BE7A50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYCONTROLSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x18BE8300)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYTIMEREXPIRED_OFFSET UNITYSDK_OFFSET(0x18BE8360)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE5CD0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionState_TypeDefinitionIndex = 27447;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::InputActionState_GlobalState*)Il2CppClass::FromTypeDefinitionIndex(InputActionState_TypeDefinitionIndex)->GetStaticField(0x1FF20);
		}
		// static const ::System::Int32 kInvalidIndex = 0xFFFFFFFF; // 0x0
		::System::Action* m_OnBeforeUpdateDelegate; // 0x10
		::Il2CppArray<::UnityEngine::InputSystem::InputBindingComposite*>* composites; // 0x18
		...
		::System::Boolean m_OnAfterUpdateHooked; // 0x48
		::System::Boolean m_OnBeforeUpdateHooked; // 0x49
		::System::Boolean m_InProcessControlStateChange; // 0x4A
