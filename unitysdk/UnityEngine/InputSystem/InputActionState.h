...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ADDTOGLOBALLIST_OFFSET UNITYSDK_OFFSET(0x190827B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CALLACTIONLISTENERS_OFFSET UNITYSDK_OFFSET(0x190878F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CANUSEDEVICE_OFFSET UNITYSDK_OFFSET(0x19083310)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CHANGEPHASEOFACTIONINTERNAL_OFFSET UNITYSDK_OFFSET(0x190876A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CHANGEPHASEOFACTION_OFFSET UNITYSDK_OFFSET(0x19084220)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CHANGEPHASEOFINTERACTION_OFFSET UNITYSDK_OFFSET(0x19087050)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CLAIMDATAFROM_OFFSET UNITYSDK_OFFSET(0x190826D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_CLONE_OFFSET UNITYSDK_OFFSET(0x19082D60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_COMPACTGLOBALLIST_OFFSET UNITYSDK_OFFSET(0x19088CA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_COMPUTEMAGNITUDE_1_OFFSET UNITYSDK_OFFSET(0x19086800)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_COMPUTEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x19086270)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DEFERREDRESOLUTIONOFBINDINGS_OFFSET UNITYSDK_OFFSET(0x19089B60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DESTROYALLACTIONMAPSTATES_OFFSET UNITYSDK_OFFSET(0x19088F10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DESTROY_OFFSET UNITYSDK_OFFSET(0x190828D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLEALLACTIONS_1_OFFSET UNITYSDK_OFFSET(0x19089DB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLEALLACTIONS_OFFSET UNITYSDK_OFFSET(0x19084800)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLECONTROLS_1_OFFSET UNITYSDK_OFFSET(0x19084A20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLECONTROLS_2_OFFSET UNITYSDK_OFFSET(0x19082AD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLECONTROLS_OFFSET UNITYSDK_OFFSET(0x19084940)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISABLESINGLEACTION_OFFSET UNITYSDK_OFFSET(0x19084990)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x190822D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLEALLACTIONS_OFFSET UNITYSDK_OFFSET(0x190844C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLECONTROLS_1_OFFSET UNITYSDK_OFFSET(0x19084730)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLECONTROLS_2_OFFSET UNITYSDK_OFFSET(0x19083980)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLECONTROLS_OFFSET UNITYSDK_OFFSET(0x19084650)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ENABLESINGLEACTION_OFFSET UNITYSDK_OFFSET(0x190846A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_EVALUATECOMPOSITEPARTMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x19088210)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FETCHACTIONSTATE_OFFSET UNITYSDK_OFFSET(0x19084440)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FETCHMAPINDICES_OFFSET UNITYSDK_OFFSET(0x19084470)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19082830)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FINDALLENABLEDACTIONS_OFFSET UNITYSDK_OFFSET(0x19089060)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_FINISHBINDINGCOMPOSITESETUPS_OFFSET UNITYSDK_OFFSET(0x19083660)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETACTIONBINDINGSTARTINDEXANDCOUNT_OFFSET UNITYSDK_OFFSET(0x19084140)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETACTIONORNONESTRING_OFFSET UNITYSDK_OFFSET(0x19087A80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETACTIONORNULL_1_OFFSET UNITYSDK_OFFSET(0x19087AD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETACTIONORNULL_OFFSET UNITYSDK_OFFSET(0x19087B90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETBINDINGINDEXINMAP_OFFSET UNITYSDK_OFFSET(0x19087CF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETBINDINGINDEXINSTATE_OFFSET UNITYSDK_OFFSET(0x19087D30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETBINDINGSTATE_OFFSET UNITYSDK_OFFSET(0x19087D60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETBINDING_OFFSET UNITYSDK_OFFSET(0x19087D80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETCONTROL_OFFSET UNITYSDK_OFFSET(0x19087C50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETINTERACTIONORNULL_OFFSET UNITYSDK_OFFSET(0x19087CA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETVALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x19087E50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x19087F40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_ACTIONSTATES_OFFSET UNITYSDK_OFFSET(0x19082530)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_BINDINGSTATES_OFFSET UNITYSDK_OFFSET(0x19082540)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_CONTROLINDEXTOBINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x19082560)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_ENABLEDCONTROLS_OFFSET UNITYSDK_OFFSET(0x19082570)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_INTERACTIONSTATES_OFFSET UNITYSDK_OFFSET(0x19082550)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_ISPROCESSINGCONTROLSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x19082580)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_MAPINDICES_OFFSET UNITYSDK_OFFSET(0x19082520)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALACTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x190824E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALBINDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x190824F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALCOMPOSITECOUNT_OFFSET UNITYSDK_OFFSET(0x190824C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALCONTROLCOUNT_OFFSET UNITYSDK_OFFSET(0x19082510)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALINTERACTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x19082500)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_GET_TOTALMAPCOUNT_OFFSET UNITYSDK_OFFSET(0x190824D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_HASENABLEDACTIONS_OFFSET UNITYSDK_OFFSET(0x190835F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_HOOKONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x19083AF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19082590)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISACTIONBOUNDTOCONTROLFROMDEVICE_OFFSET UNITYSDK_OFFSET(0x19083E50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISACTUATED_OFFSET UNITYSDK_OFFSET(0x19086B60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISCONFLICTINGINPUT_OFFSET UNITYSDK_OFFSET(0x19085CA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISCONTROLENABLED_OFFSET UNITYSDK_OFFSET(0x19084AF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ISUSINGDEVICE_OFFSET UNITYSDK_OFFSET(0x19083120)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_NOTIFYLISTENERSOFACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x19083C20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ONBEFOREINITIALUPDATE_OFFSET UNITYSDK_OFFSET(0x19084F10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x19089570)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_PROCESSCONTROLSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x19085200)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_PROCESSDEFAULTINTERACTION_OFFSET UNITYSDK_OFFSET(0x190862C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_PROCESSINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x19085AB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_PROCESSTIMEOUT_OFFSET UNITYSDK_OFFSET(0x190857C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READCOMPOSITEPARTVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x190885A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READCOMPOSITEPARTVALUE_OFFSET UNITYSDK_OFFSET(0x19088340)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READVALUEASBUTTON_OFFSET UNITYSDK_OFFSET(0x19088980)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x190887D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_READVALUE_OFFSET UNITYSDK_OFFSET(0x19088030)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_REMOVEMAPFROMGLOBALLIST_OFFSET UNITYSDK_OFFSET(0x19082C50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETACTIONSTATESDRIVENBY_OFFSET UNITYSDK_OFFSET(0x19083CA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETACTIONSTATE_OFFSET UNITYSDK_OFFSET(0x19083F40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETGLOBALS_OFFSET UNITYSDK_OFFSET(0x19088DE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETINTERACTIONSTATEANDCANCELIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x19084170)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESETINTERACTIONSTATE_OFFSET UNITYSDK_OFFSET(0x19086970)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_RESTOREACTIONSTATES_OFFSET UNITYSDK_OFFSET(0x19083720)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SAVEANDRESETSTATE_OFFSET UNITYSDK_OFFSET(0x19088A50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SETCONTROLENABLED_OFFSET UNITYSDK_OFFSET(0x19084CA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SETINITIALSTATECHECKPENDING_OFFSET UNITYSDK_OFFSET(0x19084B30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SETTOTALTIMEOUTCOMPLETIONTIME_OFFSET UNITYSDK_OFFSET(0x19086C10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SHOULDIGNOREINPUTONCOMPOSITEBINDING_OFFSET UNITYSDK_OFFSET(0x19085A90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SPLITUPMAPANDCONTROLANDBINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x19085770)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_STARTTIMEOUT_OFFSET UNITYSDK_OFFSET(0x19086C50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_STOPTIMEOUT_OFFSET UNITYSDK_OFFSET(0x19086E60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x19083110)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_TOCOMBINEDMAPANDCONTROLANDBINDINGINDEX_OFFSET UNITYSDK_OFFSET(0x19084B10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNHOOKONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x19084E80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYCONTROLSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x19085730)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECHANGEMONITOR_NOTIFYTIMEREXPIRED_OFFSET UNITYSDK_OFFSET(0x19085790)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19083100)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionState_TypeDefinitionIndex = 28387;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::InputActionState_GlobalState*)Il2CppClass::FromTypeDefinitionIndex(InputActionState_TypeDefinitionIndex)->GetStaticField(0x21580);
		}
		// static const ::System::Int32 kInvalidIndex = 0xFFFFFFFF; // 0x0
		::Il2CppArray<::UnityEngine::InputSystem::InputActionMap*>* maps; // 0x10
		::Il2CppArray<::UnityEngine::InputSystem::InputControl*>* controls; // 0x18
		::Il2CppArray<::UnityEngine::InputSystem::IInputInteraction*>* interactions; // 0x20
		::System::Action* m_OnBeforeUpdateDelegate; // 0x28
		::Il2CppArray<::UnityEngine::InputSystem::InputBindingComposite*>* composites; // 0x30
		::Il2CppArray<::UnityEngine::InputSystem::InputProcessor*>* processors; // 0x38
		::System::Action* m_OnAfterUpdateDelegate; // 0x40
		::System::Boolean m_OnBeforeUpdateHooked; // 0x48
		::System::Boolean m_InProcessControlStateChange; // 0x49
		::System::Boolean m_OnAfterUpdateHooked; // 0x4A
		::System::Int32 totalProcessorCount; // 0x4C
