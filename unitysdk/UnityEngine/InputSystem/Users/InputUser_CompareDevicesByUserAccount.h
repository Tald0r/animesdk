...
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_COMPAREDEVICESBYUSERACCOUNT_COMPARE_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define UNITYENGINE_INPUTSYSTEM_USERS_INPUTUSER_COMPAREDEVICESBYUSERACCOUNT_GETUSERACCOUNTHANDLEFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1A58F930)

namespace UnityEngine::InputSystem::Users
{
	inline static constexpr unsigned int InputUser_CompareDevicesByUserAccount_TypeDefinitionIndex = 28580;
