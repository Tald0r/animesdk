...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x94FA20)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_EQUALS_OFFSET UNITYSDK_OFFSET(0x94FA10)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_FROMDEVICEDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1AB2EB70)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x40BA50)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_GETNUMPROPERTIESIN_OFFSET UNITYSDK_OFFSET(0x1AB2EAC0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x314B50)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_GET_PATTERNS_OFFSET UNITYSDK_OFFSET(0x94F760)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_MATCHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x94F9C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_MATCHSINGLEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1AB2EA00)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AB2F040)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AB2F060)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x94FA00)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHDEVICECLASS_OFFSET UNITYSDK_OFFSET(0x94F820)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHINTERFACE_OFFSET UNITYSDK_OFFSET(0x94F7C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHMANUFACTURER_OFFSET UNITYSDK_OFFSET(0x94F880)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHPRODUCT_OFFSET UNITYSDK_OFFSET(0x94F8E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHVERSION_OFFSET UNITYSDK_OFFSET(0x94F940)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITH_OFFSET UNITYSDK_OFFSET(0x94F9A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB2F0D0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputDeviceMatcher_TypeDefinitionIndex = 28827;

	struct alignas(8) InputDeviceMatcher
	{
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kDeviceClassKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x21B90);
		}
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kManufacturerKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x21BA0);
		}
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kProductKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x21BB0);
		}
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kVersionKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x21BC0);
		}
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kInterfaceKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x21BD0);
		}
