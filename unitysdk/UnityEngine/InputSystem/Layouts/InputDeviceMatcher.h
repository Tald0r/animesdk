...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9225C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_EQUALS_OFFSET UNITYSDK_OFFSET(0x9225B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_FROMDEVICEDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A58B350)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x759F20)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_GETNUMPROPERTIESIN_OFFSET UNITYSDK_OFFSET(0x1A58B2A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x2C3A90)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_GET_PATTERNS_OFFSET UNITYSDK_OFFSET(0x922300)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_MATCHPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x922560)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_MATCHSINGLEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A58B1E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A58B820)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A58B840)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9225A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHDEVICECLASS_OFFSET UNITYSDK_OFFSET(0x9223C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHINTERFACE_OFFSET UNITYSDK_OFFSET(0x922360)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHMANUFACTURER_OFFSET UNITYSDK_OFFSET(0x922420)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHPRODUCT_OFFSET UNITYSDK_OFFSET(0x922480)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITHVERSION_OFFSET UNITYSDK_OFFSET(0x9224E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_WITH_OFFSET UNITYSDK_OFFSET(0x922540)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A58B8B0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputDeviceMatcher_TypeDefinitionIndex = 27887;

	struct alignas(8) InputDeviceMatcher
	{
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kVersionKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x20530);
		}
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kProductKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x20540);
		}
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kManufacturerKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x20550);
		}
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kDeviceClassKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x20560);
		}
		static ::UnityEngine::InputSystem::Utilities::InternedString* StaticGet_kInterfaceKey()
		{
			return (::UnityEngine::InputSystem::Utilities::InternedString*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceMatcher_TypeDefinitionIndex)->GetStaticField(0x20570);
		}
