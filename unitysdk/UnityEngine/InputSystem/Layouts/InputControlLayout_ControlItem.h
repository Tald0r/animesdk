...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ALIASES_OFFSET UNITYSDK_OFFSET(0x93EF30)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ARRAYSIZE_OFFSET UNITYSDK_OFFSET(0x93F010)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_BIT_OFFSET UNITYSDK_OFFSET(0x93EFB0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_DEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x93F030)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x318730)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_DONTRESET_OFFSET UNITYSDK_OFFSET(0x93F120)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x8CF0F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x93EFF0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x93F180)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISFIRSTDEFINEDINTHISLAYOUT_OFFSET UNITYSDK_OFFSET(0x93F150)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISMODIFYINGEXISTINGCONTROL_OFFSET UNITYSDK_OFFSET(0x93F090)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISNOISY_OFFSET UNITYSDK_OFFSET(0x93F0C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISSYNTHETIC_OFFSET UNITYSDK_OFFSET(0x93F0F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x394D30)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x93F070)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0x93F050)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2EC7C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x93EF90)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x93EF50)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_PROCESSORS_OFFSET UNITYSDK_OFFSET(0x93EF70)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_SHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x580230)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_SIZEINBITS_OFFSET UNITYSDK_OFFSET(0x93EFD0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_USAGES_OFFSET UNITYSDK_OFFSET(0x92D130)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_USESTATEFROM_OFFSET UNITYSDK_OFFSET(0x318750)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_VARIANTS_OFFSET UNITYSDK_OFFSET(0x449110)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_MERGE_OFFSET UNITYSDK_OFFSET(0x93F190)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ALIASES_OFFSET UNITYSDK_OFFSET(0x93EF40)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ARRAYSIZE_OFFSET UNITYSDK_OFFSET(0x93F020)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_BIT_OFFSET UNITYSDK_OFFSET(0x93EFC0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_DEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x93F040)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x3186E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_DONTRESET_OFFSET UNITYSDK_OFFSET(0x93F130)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x8CF100)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_FORMAT_OFFSET UNITYSDK_OFFSET(0x93F000)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISFIRSTDEFINEDINTHISLAYOUT_OFFSET UNITYSDK_OFFSET(0x93F160)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISMODIFYINGEXISTINGCONTROL_OFFSET UNITYSDK_OFFSET(0x93F0A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISNOISY_OFFSET UNITYSDK_OFFSET(0x93F0D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISSYNTHETIC_OFFSET UNITYSDK_OFFSET(0x93F100)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x3BE200)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x93F080)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_MINVALUE_OFFSET UNITYSDK_OFFSET(0x93F060)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_NAME_OFFSET UNITYSDK_OFFSET(0x2EC7B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x93EFA0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x93EF60)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_PROCESSORS_OFFSET UNITYSDK_OFFSET(0x93EF80)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_SHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x93EF10)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_SIZEINBITS_OFFSET UNITYSDK_OFFSET(0x93EFE0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_USAGES_OFFSET UNITYSDK_OFFSET(0x93EF20)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_USESTATEFROM_OFFSET UNITYSDK_OFFSET(0x318740)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_VARIANTS_OFFSET UNITYSDK_OFFSET(0x4490A0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_ControlItem_TypeDefinitionIndex = 28803;
