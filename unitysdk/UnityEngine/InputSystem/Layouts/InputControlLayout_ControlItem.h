...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ALIASES_OFFSET UNITYSDK_OFFSET(0x9128B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ARRAYSIZE_OFFSET UNITYSDK_OFFSET(0x912990)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_BIT_OFFSET UNITYSDK_OFFSET(0x912930)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_DEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x9129B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x379DB0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_DONTRESET_OFFSET UNITYSDK_OFFSET(0x912AA0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x8A9080)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x912970)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x912B00)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISFIRSTDEFINEDINTHISLAYOUT_OFFSET UNITYSDK_OFFSET(0x912AD0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISMODIFYINGEXISTINGCONTROL_OFFSET UNITYSDK_OFFSET(0x912A10)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISNOISY_OFFSET UNITYSDK_OFFSET(0x912A40)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_ISSYNTHETIC_OFFSET UNITYSDK_OFFSET(0x912A70)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x44C6D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x9129F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0x9129D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2CA610)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x912910)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x9128D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_PROCESSORS_OFFSET UNITYSDK_OFFSET(0x9128F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_SHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x53A5B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_SIZEINBITS_OFFSET UNITYSDK_OFFSET(0x912950)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_USAGES_OFFSET UNITYSDK_OFFSET(0x9017B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_USESTATEFROM_OFFSET UNITYSDK_OFFSET(0x2F7FC0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_GET_VARIANTS_OFFSET UNITYSDK_OFFSET(0x44C6F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_MERGE_OFFSET UNITYSDK_OFFSET(0x912B10)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ALIASES_OFFSET UNITYSDK_OFFSET(0x9128C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ARRAYSIZE_OFFSET UNITYSDK_OFFSET(0x9129A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_BIT_OFFSET UNITYSDK_OFFSET(0x912940)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_DEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x9129C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x379D80)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_DONTRESET_OFFSET UNITYSDK_OFFSET(0x912AB0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x8A9090)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_FORMAT_OFFSET UNITYSDK_OFFSET(0x912980)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISFIRSTDEFINEDINTHISLAYOUT_OFFSET UNITYSDK_OFFSET(0x912AE0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISMODIFYINGEXISTINGCONTROL_OFFSET UNITYSDK_OFFSET(0x912A20)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISNOISY_OFFSET UNITYSDK_OFFSET(0x912A50)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_ISSYNTHETIC_OFFSET UNITYSDK_OFFSET(0x912A80)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x44C5D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x912A00)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_MINVALUE_OFFSET UNITYSDK_OFFSET(0x9129E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_NAME_OFFSET UNITYSDK_OFFSET(0x2FB050)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x912920)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_PARAMETERS_OFFSET UNITYSDK_OFFSET(0x9128E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_PROCESSORS_OFFSET UNITYSDK_OFFSET(0x912900)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_SHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8EBAB0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_SIZEINBITS_OFFSET UNITYSDK_OFFSET(0x912960)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_USAGES_OFFSET UNITYSDK_OFFSET(0x9128A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_USESTATEFROM_OFFSET UNITYSDK_OFFSET(0x2F9000)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEM_SET_VARIANTS_OFFSET UNITYSDK_OFFSET(0x44C6E0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_ControlItem_TypeDefinitionIndex = 27863;
