...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_MATCHERJSON_FROMMATCHER_OFFSET UNITYSDK_OFFSET(0x19DA76C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_MATCHERJSON_TOMATCHER_OFFSET UNITYSDK_OFFSET(0x8F8630)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputDeviceMatcher_MatcherJson_TypeDefinitionIndex = 27888;
