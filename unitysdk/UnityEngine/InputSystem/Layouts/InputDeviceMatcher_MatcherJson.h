...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_MATCHERJSON_FROMMATCHER_OFFSET UNITYSDK_OFFSET(0x1A55DEB0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEMATCHER_MATCHERJSON_TOMATCHER_OFFSET UNITYSDK_OFFSET(0x92CB30)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputDeviceMatcher_MatcherJson_TypeDefinitionIndex = 28828;
