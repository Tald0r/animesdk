...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEMJSON_FROMCONTROLITEMS_OFFSET UNITYSDK_OFFSET(0x18C00930)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEMJSON_TOLAYOUT_OFFSET UNITYSDK_OFFSET(0x18C00140)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEMJSON__CTOR_OFFSET UNITYSDK_OFFSET(0x18C00130)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_ControlItemJson_TypeDefinitionIndex = 27872;
