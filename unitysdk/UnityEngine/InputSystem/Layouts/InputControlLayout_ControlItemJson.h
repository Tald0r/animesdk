...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEMJSON_FROMCONTROLITEMS_OFFSET UNITYSDK_OFFSET(0x1909DC10)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEMJSON_TOLAYOUT_OFFSET UNITYSDK_OFFSET(0x1909D430)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_CONTROLITEMJSON__CTOR_OFFSET UNITYSDK_OFFSET(0x1909D420)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_ControlItemJson_TypeDefinitionIndex = 28812;
