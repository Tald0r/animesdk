...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_ADDMATCHER_OFFSET UNITYSDK_OFFSET(0x96D2A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x96CDF0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_COMPUTEDISTANCEININHERITANCEHIERARCHY_OFFSET UNITYSDK_OFFSET(0x96D000)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_FINDLAYOUTTHATINTRODUCESCONTROL_OFFSET UNITYSDK_OFFSET(0x96D030)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_GETBASELAYOUTNAME_OFFSET UNITYSDK_OFFSET(0x96CED0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_GETBASELAYOUTS_OFFSET UNITYSDK_OFFSET(0x96D170)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_GETCONTROLTYPEFORLAYOUT_OFFSET UNITYSDK_OFFSET(0x96D050)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_GETROOTLAYOUTNAME_OFFSET UNITYSDK_OFFSET(0x96CF50)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_HASLAYOUT_OFFSET UNITYSDK_OFFSET(0x96CE70)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_ISBASEDON_OFFSET UNITYSDK_OFFSET(0x96D200)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_ISGENERATEDLAYOUT_OFFSET UNITYSDK_OFFSET(0x96D100)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_TRYFINDLAYOUTFORTYPE_OFFSET UNITYSDK_OFFSET(0x96CE00)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_TRYFINDMATCHINGLAYOUT_OFFSET UNITYSDK_OFFSET(0x96CE20)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_TRYLOADLAYOUTINTERNAL_OFFSET UNITYSDK_OFFSET(0x96CE90)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_TRYLOADLAYOUT_OFFSET UNITYSDK_OFFSET(0x96CEB0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION_VALUETYPEISASSIGNABLEFROM_OFFSET UNITYSDK_OFFSET(0x96D070)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_Collection_TypeDefinitionIndex = 28814;
