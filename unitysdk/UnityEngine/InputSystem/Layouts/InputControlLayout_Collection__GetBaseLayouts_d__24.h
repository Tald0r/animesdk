...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AC3C0D0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_UTILITIES_INTERNEDSTRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AC3C230)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_UTILITIES_INTERNEDSTRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC3C1A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AC3C300)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC3C200)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AC3C1B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AC3C0C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC3C0A0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_Collection__GetBaseLayouts_d__24_TypeDefinitionIndex = 28817;

	class InputControlLayout_Collection__GetBaseLayouts_d__24 : public ::System::Object
	{
	public:
		::UnityEngine::InputSystem::Utilities::InternedString layout; // 0x10
		...
		::System::Boolean includeSelf; // 0xC4
		::System::Boolean __3__includeSelf; // 0xC5
