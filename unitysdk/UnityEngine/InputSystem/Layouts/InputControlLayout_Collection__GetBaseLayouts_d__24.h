...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A690E00)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_INPUTSYSTEM_UTILITIES_INTERNEDSTRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A690F70)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_INPUTSYSTEM_UTILITIES_INTERNEDSTRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A690EE0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A691030)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A690F40)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A690EF0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A690DF0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_COLLECTION__GETBASELAYOUTS_D__24__CTOR_OFFSET UNITYSDK_OFFSET(0x1A690DD0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_Collection__GetBaseLayouts_d__24_TypeDefinitionIndex = 27877;
	...
	public:
		...
		::UnityEngine::InputSystem::Utilities::InternedString __3__layout; // 0x50
		::UnityEngine::InputSystem::Utilities::InternedString layout; // 0x60
		::UnityEngine::InputSystem::Layouts::InputControlLayout_Collection __4__this; // 0x70
		::UnityEngine::InputSystem::Utilities::InternedString __2__current; // 0xB0
		::System::Boolean includeSelf; // 0xC0
		::System::Boolean __3__includeSelf; // 0xC1
