...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEFINDCONTROLLAYOUTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A9AE310)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEFINDCONTROLLAYOUTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A9AE380)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEFINDCONTROLLAYOUTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A9ADF80)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEFINDCONTROLLAYOUTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9ADF60)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputDeviceFindControlLayoutDelegate_TypeDefinitionIndex = 28801;
