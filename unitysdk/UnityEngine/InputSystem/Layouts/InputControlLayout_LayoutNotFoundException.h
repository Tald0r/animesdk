...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_LAYOUTNOTFOUNDEXCEPTION_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x1AB2DF00)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_LAYOUTNOTFOUNDEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB2DF70)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_LAYOUTNOTFOUNDEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB2DFE0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_LAYOUTNOTFOUNDEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AB2E080)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_LAYOUTNOTFOUNDEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1AB2E0F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTCONTROLLAYOUT_LAYOUTNOTFOUNDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB2DF10)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputControlLayout_LayoutNotFoundException_TypeDefinitionIndex = 28818;
