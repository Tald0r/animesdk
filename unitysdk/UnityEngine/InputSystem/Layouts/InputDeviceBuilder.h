...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_ADDCHILDCONTROLIFMISSING_OFFSET UNITYSDK_OFFSET(0x907F10)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_ADDCHILDCONTROLS_OFFSET UNITYSDK_OFFSET(0x907DE0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_ADDCHILDCONTROL_OFFSET UNITYSDK_OFFSET(0x907E10)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_ADDPARENTDISPLAYNAMERECURSIVE_OFFSET UNITYSDK_OFFSET(0x1A0AB510)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_ADDPROCESSORS_OFFSET UNITYSDK_OFFSET(0x1A0AAB20)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_APPLYUSESTATEFROM_OFFSET UNITYSDK_OFFSET(0x1A0A9A50)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_CHILDCONTROLOVERRIDEPATH_OFFSET UNITYSDK_OFFSET(0x907EC0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_COMPUTESTATELAYOUT_OFFSET UNITYSDK_OFFSET(0x1A0A9160)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x907BC0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_FINALIZECONTROLHIERARCHYRECURSIVE_OFFSET UNITYSDK_OFFSET(0x908030)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_FINALIZECONTROLHIERARCHY_OFFSET UNITYSDK_OFFSET(0x908020)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_FINDORLOADLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A0A80F0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_FINISH_OFFSET UNITYSDK_OFFSET(0x907B10)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A0AB950)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_INSERTCHILDCONTROLOVERRIDE_OFFSET UNITYSDK_OFFSET(0x907EB0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_INSERTCHILDCONTROL_OFFSET UNITYSDK_OFFSET(0x907FE0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_INSTANTIATELAYOUT_1_OFFSET UNITYSDK_OFFSET(0x907DA0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_INSTANTIATELAYOUT_OFFSET UNITYSDK_OFFSET(0x907CE0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_REF_OFFSET UNITYSDK_OFFSET(0x1A0AB990)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_RESET_OFFSET UNITYSDK_OFFSET(0x907C40)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_SETDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x908010)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_SETFORMAT_OFFSET UNITYSDK_OFFSET(0x1A0AAAB0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_SETUP_OFFSET UNITYSDK_OFFSET(0x907AB0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_SHIFTCHILDINDICESINHIERARCHYONEUP_OFFSET UNITYSDK_OFFSET(0x1A0AB1A0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputDeviceBuilder_TypeDefinitionIndex = 28823;

	struct alignas(8) InputDeviceBuilder
	{
		static ::UnityEngine::InputSystem::Layouts::InputDeviceBuilder* StaticGet_s_Instance()
		{
			return (::UnityEngine::InputSystem::Layouts::InputDeviceBuilder*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceBuilder_TypeDefinitionIndex)->GetStaticField(0x216C0);
		}
		static ::System::Int32* StaticGet_s_InstanceRef()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceBuilder_TypeDefinitionIndex)->GetStaticField(0x4C40);
		}
