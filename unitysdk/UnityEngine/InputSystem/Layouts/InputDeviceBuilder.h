...
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_ADDCHILDCONTROLIFMISSING_OFFSET UNITYSDK_OFFSET(0x8D5A10)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_ADDCHILDCONTROLS_OFFSET UNITYSDK_OFFSET(0x8D58E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_ADDCHILDCONTROL_OFFSET UNITYSDK_OFFSET(0x8D5910)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_ADDPARENTDISPLAYNAMERECURSIVE_OFFSET UNITYSDK_OFFSET(0x19ABCF60)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_ADDPROCESSORS_OFFSET UNITYSDK_OFFSET(0x19ABC570)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_APPLYUSESTATEFROM_OFFSET UNITYSDK_OFFSET(0x19ABB4A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_CHILDCONTROLOVERRIDEPATH_OFFSET UNITYSDK_OFFSET(0x8D59C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_COMPUTESTATELAYOUT_OFFSET UNITYSDK_OFFSET(0x19ABABA0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D56C0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_FINALIZECONTROLHIERARCHYRECURSIVE_OFFSET UNITYSDK_OFFSET(0x8D5B30)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_FINALIZECONTROLHIERARCHY_OFFSET UNITYSDK_OFFSET(0x8D5B20)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_FINDORLOADLAYOUT_OFFSET UNITYSDK_OFFSET(0x19AB9B30)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_FINISH_OFFSET UNITYSDK_OFFSET(0x8D5610)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x19ABD3A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_INSERTCHILDCONTROLOVERRIDE_OFFSET UNITYSDK_OFFSET(0x8D59B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_INSERTCHILDCONTROL_OFFSET UNITYSDK_OFFSET(0x8D5AE0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_INSTANTIATELAYOUT_1_OFFSET UNITYSDK_OFFSET(0x8D58A0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_INSTANTIATELAYOUT_OFFSET UNITYSDK_OFFSET(0x8D57E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_REF_OFFSET UNITYSDK_OFFSET(0x19ABD3E0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_RESET_OFFSET UNITYSDK_OFFSET(0x8D5740)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_SETDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8D5B10)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_SETFORMAT_OFFSET UNITYSDK_OFFSET(0x19ABC500)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_SETUP_OFFSET UNITYSDK_OFFSET(0x8D55B0)
#define UNITYENGINE_INPUTSYSTEM_LAYOUTS_INPUTDEVICEBUILDER_SHIFTCHILDINDICESINHIERARCHYONEUP_OFFSET UNITYSDK_OFFSET(0x19ABCBF0)

namespace UnityEngine::InputSystem::Layouts
{
	inline static constexpr unsigned int InputDeviceBuilder_TypeDefinitionIndex = 27883;

	struct alignas(8) InputDeviceBuilder
	{
		static ::UnityEngine::InputSystem::Layouts::InputDeviceBuilder* StaticGet_s_Instance()
		{
			return (::UnityEngine::InputSystem::Layouts::InputDeviceBuilder*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceBuilder_TypeDefinitionIndex)->GetStaticField(0x20060);
		}
		static ::System::Int32* StaticGet_s_InstanceRef()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(InputDeviceBuilder_TypeDefinitionIndex)->GetStaticField(0x4C90);
		}
