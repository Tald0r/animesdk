...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0x92DEB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x92DEF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_ISOPTIONAL_OFFSET UNITYSDK_OFFSET(0x92DF90)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_REQUIREMENTINDEX_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_MATCHRESULT_MATCH_GET_REQUIREMENT_OFFSET UNITYSDK_OFFSET(0x92DF50)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlScheme_MatchResult_Match_TypeDefinitionIndex = 28415;
