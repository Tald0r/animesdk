...
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x18C9F3C0)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_GET_ATTITUDE_OFFSET UNITYSDK_OFFSET(0x18C9F260)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18C9F280)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_MAKECURRENT_OFFSET UNITYSDK_OFFSET(0x18C9F300)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x18C9F340)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_SET_ATTITUDE_OFFSET UNITYSDK_OFFSET(0x18C9F270)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18C9F2C0)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18C9F410)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int AttitudeSensor_TypeDefinitionIndex = 28494;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::AttitudeSensor**)Il2CppClass::FromTypeDefinitionIndex(AttitudeSensor_TypeDefinitionIndex)->GetStaticField(0x21B30);
		}
