...
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x186568A0)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_GET_ATTITUDE_OFFSET UNITYSDK_OFFSET(0x18656740)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18656760)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_MAKECURRENT_OFFSET UNITYSDK_OFFSET(0x186567E0)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x18656820)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_SET_ATTITUDE_OFFSET UNITYSDK_OFFSET(0x18656750)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x186567A0)
#define UNITYENGINE_INPUTSYSTEM_ATTITUDESENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x186568F0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int AttitudeSensor_TypeDefinitionIndex = 27554;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::AttitudeSensor**)Il2CppClass::FromTypeDefinitionIndex(AttitudeSensor_TypeDefinitionIndex)->GetStaticField(0x204D0);
		}
