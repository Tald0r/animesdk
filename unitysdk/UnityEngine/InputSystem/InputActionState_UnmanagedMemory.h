...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x8F80F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_CLONE_OFFSET UNITYSDK_OFFSET(0x8F8410)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_COPYDATAFROM_OFFSET UNITYSDK_OFFSET(0x8F8290)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F8240)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_GET_ISALLOCATED_OFFSET UNITYSDK_OFFSET(0x2D41A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSTATE_UNMANAGEDMEMORY_GET_SIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x8F80A0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionState_UnmanagedMemory_TypeDefinitionIndex = 27455;
