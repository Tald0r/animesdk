...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_FINISH_OFFSET UNITYSDK_OFFSET(0x92F000)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_ISNOISY_OFFSET UNITYSDK_OFFSET(0x92EF10)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_SET_DEVICE_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHCHILDREN_OFFSET UNITYSDK_OFFSET(0x92EEB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHCONTROLALIAS_OFFSET UNITYSDK_OFFSET(0x92EF70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHCONTROLUSAGE_OFFSET UNITYSDK_OFFSET(0x92EF40)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x92EDE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHLAYOUT_OFFSET UNITYSDK_OFFSET(0x92EE80)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHNAME_OFFSET UNITYSDK_OFFSET(0x92EDA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHSHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x92EE30)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHSTATEBLOCK_OFFSET UNITYSDK_OFFSET(0x92EEE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHSTATEOFFSETTOCONTROLINDEXMAP_OFFSET UNITYSDK_OFFSET(0x92EFD0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlExtensions_DeviceBuilder_TypeDefinitionIndex = 28438;
