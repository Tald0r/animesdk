...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_FINISH_OFFSET UNITYSDK_OFFSET(0x903670)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_ISNOISY_OFFSET UNITYSDK_OFFSET(0x903580)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_SET_DEVICE_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHCHILDREN_OFFSET UNITYSDK_OFFSET(0x903520)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHCONTROLALIAS_OFFSET UNITYSDK_OFFSET(0x9035E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHCONTROLUSAGE_OFFSET UNITYSDK_OFFSET(0x9035B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x903450)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHLAYOUT_OFFSET UNITYSDK_OFFSET(0x9034F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHNAME_OFFSET UNITYSDK_OFFSET(0x903410)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHSHORTDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x9034A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHSTATEBLOCK_OFFSET UNITYSDK_OFFSET(0x903550)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_DEVICEBUILDER_WITHSTATEOFFSETTOCONTROLINDEXMAP_OFFSET UNITYSDK_OFFSET(0x903640)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlExtensions_DeviceBuilder_TypeDefinitionIndex = 27498;
