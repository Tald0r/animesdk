...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_COMPAREPATHELEMENTTOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3E8540)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x912660)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_ISDOUBLEWILDCARD_OFFSET UNITYSDK_OFFSET(0x9126E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_ISWILDCARD_OFFSET UNITYSDK_OFFSET(0x912690)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x902E10)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x912630)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_USAGES_OFFSET UNITYSDK_OFFSET(0x912620)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_MATCHES_OFFSET UNITYSDK_OFFSET(0x912770)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_TOHUMANREADABLESTRING_1_OFFSET UNITYSDK_OFFSET(0x1A3E8100)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_TOHUMANREADABLESTRING_OFFSET UNITYSDK_OFFSET(0x912760)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlPath_ParsedPathComponent_TypeDefinitionIndex = 27506;
