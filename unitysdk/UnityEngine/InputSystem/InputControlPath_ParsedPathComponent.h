...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_COMPAREPATHELEMENTTOSTRING_OFFSET UNITYSDK_OFFSET(0x1A9ACB70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x93ECD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_ISDOUBLEWILDCARD_OFFSET UNITYSDK_OFFSET(0x93ED50)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_ISWILDCARD_OFFSET UNITYSDK_OFFSET(0x93ED00)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_LAYOUT_OFFSET UNITYSDK_OFFSET(0x92E7A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x93ECA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_GET_USAGES_OFFSET UNITYSDK_OFFSET(0x93EC90)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_MATCHES_OFFSET UNITYSDK_OFFSET(0x93EDE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_TOHUMANREADABLESTRING_1_OFFSET UNITYSDK_OFFSET(0x1A9AC730)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLPATH_PARSEDPATHCOMPONENT_TOHUMANREADABLESTRING_OFFSET UNITYSDK_OFFSET(0x93EDD0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlPath_ParsedPathComponent_TypeDefinitionIndex = 28446;
