...
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A5761C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A576380)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A576310)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A576400)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A576370)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A576320)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A5761B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12__CTOR_OFFSET UNITYSDK_OFFSET(0x1A576190)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputBindingComposite__GetPartNames_d__12_TypeDefinitionIndex = 28405;
	...
	public:
		...
		::Il2CppArray<::System::Reflection::FieldInfo*>* __7__wrap1; // 0x20
