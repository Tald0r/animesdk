...
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19F65350)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19F65510)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F654A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19F65590)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19F65500)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19F654B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F65340)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITE__GETPARTNAMES_D__12__CTOR_OFFSET UNITYSDK_OFFSET(0x19F65320)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputBindingComposite__GetPartNames_d__12_TypeDefinitionIndex = 27465;
