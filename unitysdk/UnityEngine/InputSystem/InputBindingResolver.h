...
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_ADDACTIONMAP_OFFSET UNITYSDK_OFFSET(0x8788B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_ASSIGNCOMPOSITEPARTINDEX_OFFSET UNITYSDK_OFFSET(0x1908EE90)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x878850)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_GET_TOTALACTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x318700)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_GET_TOTALBINDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x53B9E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_GET_TOTALCONTROLCOUNT_OFFSET UNITYSDK_OFFSET(0x35B6A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_GET_TOTALMAPCOUNT_OFFSET UNITYSDK_OFFSET(0x2F2E30)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_INSTANTIATEBINDINGCOMPOSITE_OFFSET UNITYSDK_OFFSET(0x1908EC40)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_RESOLVEINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x878900)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_RESOLVEPROCESSORS_OFFSET UNITYSDK_OFFSET(0x878910)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_STARTWITHARRAYSFROM_OFFSET UNITYSDK_OFFSET(0x8788A0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputBindingResolver_TypeDefinitionIndex = 28411;
