...
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_ADDACTIONMAP_OFFSET UNITYSDK_OFFSET(0x849F60)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_ASSIGNCOMPOSITEPARTINDEX_OFFSET UNITYSDK_OFFSET(0x18BF1A60)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x849F00)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_GET_TOTALACTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x31D8E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_GET_TOTALBINDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x3913A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_GET_TOTALCONTROLCOUNT_OFFSET UNITYSDK_OFFSET(0x2FC180)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_GET_TOTALMAPCOUNT_OFFSET UNITYSDK_OFFSET(0x2FD450)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_INSTANTIATEBINDINGCOMPOSITE_OFFSET UNITYSDK_OFFSET(0x18BF1810)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_RESOLVEINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x849FB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_RESOLVEPROCESSORS_OFFSET UNITYSDK_OFFSET(0x849FC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGRESOLVER_STARTWITHARRAYSFROM_OFFSET UNITYSDK_OFFSET(0x849F50)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputBindingResolver_TypeDefinitionIndex = 27471;
