...
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_NEWEVENTSMSG_CREATERESETEVENT_OFFSET UNITYSDK_OFFSET(0x1AAC5E40)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_NEWEVENTSMSG_CREATESTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1AAC6060)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_NEWEVENTSMSG_CREATE_OFFSET UNITYSDK_OFFSET(0x1AAC5F50)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_NEWEVENTSMSG_PROCESS_OFFSET UNITYSDK_OFFSET(0x1AAC6180)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputRemoting_NewEventsMsg_TypeDefinitionIndex = 28483;
