...
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_NEWEVENTSMSG_CREATERESETEVENT_OFFSET UNITYSDK_OFFSET(0x1A50C4E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_NEWEVENTSMSG_CREATESTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1A50C700)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_NEWEVENTSMSG_CREATE_OFFSET UNITYSDK_OFFSET(0x1A50C5F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_NEWEVENTSMSG_PROCESS_OFFSET UNITYSDK_OFFSET(0x1A50C820)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputRemoting_NewEventsMsg_TypeDefinitionIndex = 27543;
