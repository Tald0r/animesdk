...
#define UNITYENGINE_INPUTSYSTEM_MOUSE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1A0AE390)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_GET_BACKBUTTON_OFFSET UNITYSDK_OFFSET(0x1A0AE250)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_GET_CLICKCOUNT_OFFSET UNITYSDK_OFFSET(0x1A0AE290)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A0AE2B0)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_GET_FORWARDBUTTON_OFFSET UNITYSDK_OFFSET(0x1A0AE270)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_GET_LEFTBUTTON_OFFSET UNITYSDK_OFFSET(0x1A0AE1F0)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_GET_MIDDLEBUTTON_OFFSET UNITYSDK_OFFSET(0x1A0AE210)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_GET_RIGHTBUTTON_OFFSET UNITYSDK_OFFSET(0x1A0AE230)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_GET_SCROLL_OFFSET UNITYSDK_OFFSET(0x1A0AE1D0)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_MAKECURRENT_OFFSET UNITYSDK_OFFSET(0x1A0AE2D0)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_ONADDED_OFFSET UNITYSDK_OFFSET(0x1A0AE2F0)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0AE4A0)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1A0AE320)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1A0AE500)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_SET_BACKBUTTON_OFFSET UNITYSDK_OFFSET(0x1A0AE260)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_SET_CLICKCOUNT_OFFSET UNITYSDK_OFFSET(0x1A0AE2A0)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A0AE2C0)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_SET_FORWARDBUTTON_OFFSET UNITYSDK_OFFSET(0x1A0AE280)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_SET_LEFTBUTTON_OFFSET UNITYSDK_OFFSET(0x1A0AE200)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_SET_MIDDLEBUTTON_OFFSET UNITYSDK_OFFSET(0x1A0AE220)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_SET_RIGHTBUTTON_OFFSET UNITYSDK_OFFSET(0x1A0AE240)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_SET_SCROLL_OFFSET UNITYSDK_OFFSET(0x1A0AE1E0)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1A0AE580)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1A0AE5E0)
#define UNITYENGINE_INPUTSYSTEM_MOUSE_WARPCURSORPOSITION_OFFSET UNITYSDK_OFFSET(0x1A0AE360)
#define UNITYENGINE_INPUTSYSTEM_MOUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0AE660)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int Mouse_TypeDefinitionIndex = 28460;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::Mouse**)Il2CppClass::FromTypeDefinitionIndex(Mouse_TypeDefinitionIndex)->GetStaticField(0x21D60);
		}
		static ::UnityEngine::InputSystem::Mouse** StaticGet_s_PlatformMouseDevice()
		{
			return (::UnityEngine::InputSystem::Mouse**)Il2CppClass::FromTypeDefinitionIndex(Mouse_TypeDefinitionIndex)->GetStaticField(0x21D68);
		}
		::UnityEngine::InputSystem::Controls::IntegerControl* _clickCount_k__BackingField; // 0x180
		::UnityEngine::InputSystem::Controls::ButtonControl* _middleButton_k__BackingField; // 0x188
		::UnityEngine::InputSystem::Controls::ButtonControl* _backButton_k__BackingField; // 0x190
		::UnityEngine::InputSystem::Controls::Vector2Control* _scroll_k__BackingField; // 0x198
		::UnityEngine::InputSystem::Controls::ButtonControl* _rightButton_k__BackingField; // 0x1A0
