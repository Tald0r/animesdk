...
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES_GET_FREQUENCYHZ_OFFSET UNITYSDK_OFFSET(0x2D38E0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES_GET_MAXBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES_GET_NUMCHANNELS_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES_SET_FREQUENCYHZ_OFFSET UNITYSDK_OFFSET(0x2D38F0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES_SET_MAXBUFFERSIZE_OFFSET UNITYSDK_OFFSET(0x2C6250)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES_SET_NUMCHANNELS_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_HAPTICCAPABILITIES__CTOR_OFFSET UNITYSDK_OFFSET(0x2CA8F0)

namespace UnityEngine::InputSystem::XR::Haptics
{
	inline static constexpr unsigned int HapticCapabilities_TypeDefinitionIndex = 27621;
