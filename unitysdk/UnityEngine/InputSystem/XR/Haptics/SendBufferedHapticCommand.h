...
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_SENDBUFFEREDHAPTICCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1AC3FD70)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_SENDBUFFEREDHAPTICCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x955D20)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_SENDBUFFEREDHAPTICCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AC3FD50)

namespace UnityEngine::InputSystem::XR::Haptics
{
	inline static constexpr unsigned int SendBufferedHapticCommand_TypeDefinitionIndex = 28563;
