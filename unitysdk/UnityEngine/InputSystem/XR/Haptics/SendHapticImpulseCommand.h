...
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_SENDHAPTICIMPULSECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1A58D050)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_SENDHAPTICIMPULSECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x922BD0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_SENDHAPTICIMPULSECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A58D030)

namespace UnityEngine::InputSystem::XR::Haptics
{
	inline static constexpr unsigned int SendHapticImpulseCommand_TypeDefinitionIndex = 27625;
