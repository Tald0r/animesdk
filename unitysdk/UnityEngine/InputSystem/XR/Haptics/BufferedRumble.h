...
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_BUFFEREDRUMBLE_ENQUEUERUMBLE_OFFSET UNITYSDK_OFFSET(0x838B50)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_BUFFEREDRUMBLE_GET_CAPABILITIES_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_BUFFEREDRUMBLE_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_BUFFEREDRUMBLE_SET_CAPABILITIES_OFFSET UNITYSDK_OFFSET(0x2C4D20)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_BUFFEREDRUMBLE_SET_DEVICE_OFFSET UNITYSDK_OFFSET(0x2D26A0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_BUFFEREDRUMBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x838B40)

namespace UnityEngine::InputSystem::XR::Haptics
{
	inline static constexpr unsigned int BufferedRumble_TypeDefinitionIndex = 27618;
