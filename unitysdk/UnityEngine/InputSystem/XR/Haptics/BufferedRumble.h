...
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_BUFFEREDRUMBLE_ENQUEUERUMBLE_OFFSET UNITYSDK_OFFSET(0x863E40)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_BUFFEREDRUMBLE_GET_CAPABILITIES_OFFSET UNITYSDK_OFFSET(0x2EA460)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_BUFFEREDRUMBLE_GET_DEVICE_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_BUFFEREDRUMBLE_SET_CAPABILITIES_OFFSET UNITYSDK_OFFSET(0x2EA450)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_BUFFEREDRUMBLE_SET_DEVICE_OFFSET UNITYSDK_OFFSET(0x3123A0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_BUFFEREDRUMBLE__CTOR_OFFSET UNITYSDK_OFFSET(0x863E30)

namespace UnityEngine::InputSystem::XR::Haptics
{
	inline static constexpr unsigned int BufferedRumble_TypeDefinitionIndex = 28558;
