...
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETHAPTICCAPABILITIESCOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x1AC3FD30)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETHAPTICCAPABILITIESCOMMAND_GET_CAPABILITIES_OFFSET UNITYSDK_OFFSET(0x955D00)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETHAPTICCAPABILITIESCOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x955CF0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETHAPTICCAPABILITIESCOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1AC3FCF0)

namespace UnityEngine::InputSystem::XR::Haptics
{
	inline static constexpr unsigned int GetHapticCapabilitiesCommand_TypeDefinitionIndex = 28562;
