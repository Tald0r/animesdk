...
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETCURRENTHAPTICSTATECOMMAND_CREATE_OFFSET UNITYSDK_OFFSET(0x19DA9C50)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETCURRENTHAPTICSTATECOMMAND_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETCURRENTHAPTICSTATECOMMAND_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x8F8AF0)
#define UNITYENGINE_INPUTSYSTEM_XR_HAPTICS_GETCURRENTHAPTICSTATECOMMAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19DA9C20)

namespace UnityEngine::InputSystem::XR::Haptics
{
	inline static constexpr unsigned int GetCurrentHapticStateCommand_TypeDefinitionIndex = 27620;
