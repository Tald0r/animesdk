...
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1A1013A0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_FIXATIONPOINT_OFFSET UNITYSDK_OFFSET(0x1A101340)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_LEFTEYEOPENAMOUNT_OFFSET UNITYSDK_OFFSET(0x1A101360)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_LEFTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A1012C0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_LEFTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x1A1012E0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_RIGHTEYEOPENAMOUNT_OFFSET UNITYSDK_OFFSET(0x1A101380)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_RIGHTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A101300)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_GET_RIGHTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x1A101320)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_READUNPROCESSEDVALUEFROMSTATE_OFFSET UNITYSDK_OFFSET(0x1A1014A0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_FIXATIONPOINT_OFFSET UNITYSDK_OFFSET(0x1A101350)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_LEFTEYEOPENAMOUNT_OFFSET UNITYSDK_OFFSET(0x1A101370)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_LEFTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A1012D0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_LEFTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x1A1012F0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_RIGHTEYEOPENAMOUNT_OFFSET UNITYSDK_OFFSET(0x1A101390)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_RIGHTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A101310)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_SET_RIGHTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x1A101330)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL_WRITEVALUEINTOSTATE_OFFSET UNITYSDK_OFFSET(0x1A101890)
#define UNITYENGINE_INPUTSYSTEM_XR_EYESCONTROL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A101BB0)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int EyesControl_TypeDefinitionIndex = 27616;
	...
	public:
		...
		::UnityEngine::InputSystem::Controls::AxisControl* _rightEyeOpenAmount_k__BackingField; // 0xF8
		::UnityEngine::InputSystem::Controls::QuaternionControl* _leftEyeRotation_k__BackingField; // 0x100
		::UnityEngine::InputSystem::Controls::Vector3Control* _fixationPoint_k__BackingField; // 0x108
		::UnityEngine::InputSystem::Controls::Vector3Control* _rightEyePosition_k__BackingField; // 0x110
		::UnityEngine::InputSystem::Controls::QuaternionControl* _rightEyeRotation_k__BackingField; // 0x118
		::UnityEngine::InputSystem::Controls::Vector3Control* _leftEyePosition_k__BackingField; // 0x120
