...
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_GET_FIXATIONPOINT_OFFSET UNITYSDK_OFFSET(0x863DB0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_GET_LEFTEYEOPENAMOUNT_OFFSET UNITYSDK_OFFSET(0x863DE0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_GET_LEFTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x2EA460)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_GET_LEFTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x35A5F0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_GET_RIGHTEYEOPENAMOUNT_OFFSET UNITYSDK_OFFSET(0x863E00)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_GET_RIGHTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x863D70)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_GET_RIGHTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x7D6530)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_SET_FIXATIONPOINT_OFFSET UNITYSDK_OFFSET(0x863DD0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_SET_LEFTEYEOPENAMOUNT_OFFSET UNITYSDK_OFFSET(0x863DF0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_SET_LEFTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x2EA450)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_SET_LEFTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x863D60)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_SET_RIGHTEYEOPENAMOUNT_OFFSET UNITYSDK_OFFSET(0x7E21D0)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_SET_RIGHTEYEPOSITION_OFFSET UNITYSDK_OFFSET(0x863D90)
#define UNITYENGINE_INPUTSYSTEM_XR_EYES_SET_RIGHTEYEROTATION_OFFSET UNITYSDK_OFFSET(0x863DA0)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int Eyes_TypeDefinitionIndex = 28554;
