...
#define UNITYENGINE_INPUTSYSTEM_XR_XRDEVICEDESCRIPTOR_FROMJSON_OFFSET UNITYSDK_OFFSET(0x18CCE6A0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRDEVICEDESCRIPTOR_TOJSON_OFFSET UNITYSDK_OFFSET(0x18CCE690)
#define UNITYENGINE_INPUTSYSTEM_XR_XRDEVICEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCE6E0)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int XRDeviceDescriptor_TypeDefinitionIndex = 28552;
