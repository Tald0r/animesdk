...
#define UNITYENGINE_INPUTSYSTEM_XR_POSESTATE_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x909B10)
#define UNITYENGINE_INPUTSYSTEM_XR_POSESTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x909B20)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int PoseState_TypeDefinitionIndex = 27598;
