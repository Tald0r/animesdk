...
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_GET_PARENTBONEINDEX_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x3101C0)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x44C6D0)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_SET_PARENTBONEINDEX_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x3101F0)
#define UNITYENGINE_INPUTSYSTEM_XR_BONE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x44C5D0)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int Bone_TypeDefinitionIndex = 27613;
