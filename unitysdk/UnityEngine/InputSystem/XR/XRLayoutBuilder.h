...
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x18CCF040)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_CONVERTPOTENTIALALIASTONAME_OFFSET UNITYSDK_OFFSET(0x18CCECD0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_GETPARENTCONTROLNAME_OFFSET UNITYSDK_OFFSET(0x18CCEE60)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_GETSIZEOFFEATURE_OFFSET UNITYSDK_OFFSET(0x18CCE6F0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_ISPOSECONTROL_OFFSET UNITYSDK_OFFSET(0x18CCEEA0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_ISSUBCONTROL_OFFSET UNITYSDK_OFFSET(0x18CCEE30)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_ONFINDLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x18CCE950)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_SANITIZESTRING_OFFSET UNITYSDK_OFFSET(0x18CCE770)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x18CD03E0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18CCECC0)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int XRLayoutBuilder_TypeDefinitionIndex = 28546;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::XR::FeatureType>**)Il2CppClass::FromTypeDefinitionIndex(XRLayoutBuilder_TypeDefinitionIndex)->GetStaticField(0x21B40);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_poseSubControlNames()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(XRLayoutBuilder_TypeDefinitionIndex)->GetStaticField(0x21B48);
		}
