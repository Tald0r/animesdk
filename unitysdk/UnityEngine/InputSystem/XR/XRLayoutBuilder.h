...
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x18686530)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_CONVERTPOTENTIALALIASTONAME_OFFSET UNITYSDK_OFFSET(0x186861C0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_GETPARENTCONTROLNAME_OFFSET UNITYSDK_OFFSET(0x18686350)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_GETSIZEOFFEATURE_OFFSET UNITYSDK_OFFSET(0x18685BE0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_ISPOSECONTROL_OFFSET UNITYSDK_OFFSET(0x18686390)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_ISSUBCONTROL_OFFSET UNITYSDK_OFFSET(0x18686320)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_ONFINDLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x18685E40)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER_SANITIZESTRING_OFFSET UNITYSDK_OFFSET(0x18685C60)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x186878D0)
#define UNITYENGINE_INPUTSYSTEM_XR_XRLAYOUTBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x186861B0)

namespace UnityEngine::InputSystem::XR
{
	inline static constexpr unsigned int XRLayoutBuilder_TypeDefinitionIndex = 27606;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::XR::FeatureType>**)Il2CppClass::FromTypeDefinitionIndex(XRLayoutBuilder_TypeDefinitionIndex)->GetStaticField(0x204E0);
		}
		static ::Il2CppArray<::System::String*>** StaticGet_poseSubControlNames()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(XRLayoutBuilder_TypeDefinitionIndex)->GetStaticField(0x204E8);
		}
		::System::String* interfaceName; // 0x10
		::UnityEngine::InputSystem::XR::XRDeviceDescriptor* descriptor; // 0x18
		::System::String* parentLayout; // 0x20
