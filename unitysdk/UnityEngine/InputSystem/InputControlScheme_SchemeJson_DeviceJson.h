...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SCHEMEJSON_DEVICEJSON_FROM_OFFSET UNITYSDK_OFFSET(0x1AC3BCD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SCHEMEJSON_DEVICEJSON_TODEVICEENTRY_OFFSET UNITYSDK_OFFSET(0x954FB0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlScheme_SchemeJson_DeviceJson_TypeDefinitionIndex = 28420;
