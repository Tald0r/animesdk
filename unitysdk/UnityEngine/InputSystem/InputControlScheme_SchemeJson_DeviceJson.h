...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SCHEMEJSON_DEVICEJSON_FROM_OFFSET UNITYSDK_OFFSET(0x1A6909F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_SCHEMEJSON_DEVICEJSON_TODEVICEENTRY_OFFSET UNITYSDK_OFFSET(0x9271E0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlScheme_SchemeJson_DeviceJson_TypeDefinitionIndex = 27480;
