...
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEBACKBUTTON_OFFSET UNITYSDK_OFFSET(0x1A699860)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSECLICKCOUNT_OFFSET UNITYSDK_OFFSET(0x1A699EA0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEDELTAX_OFFSET UNITYSDK_OFFSET(0x1A69A370)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEDELTAY_OFFSET UNITYSDK_OFFSET(0x1A69A500)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEDELTA_OFFSET UNITYSDK_OFFSET(0x1A698B20)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEFORWARDBUTTON_OFFSET UNITYSDK_OFFSET(0x1A699670)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSELEFTBUTTON_OFFSET UNITYSDK_OFFSET(0x1A698FD0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEMIDDLEBUTTON_OFFSET UNITYSDK_OFFSET(0x1A699450)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEPOINTERID_OFFSET UNITYSDK_OFFSET(0x1A699D50)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEPOSITIONX_OFFSET UNITYSDK_OFFSET(0x1A699FF0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEPOSITIONY_OFFSET UNITYSDK_OFFSET(0x1A69A1B0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A698990)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEPRESSURE_OFFSET UNITYSDK_OFFSET(0x1A699A50)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSEPRESS_OFFSET UNITYSDK_OFFSET(0x1A698DF0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSERADIUSX_OFFSET UNITYSDK_OFFSET(0x1A69A9F0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSERADIUSY_OFFSET UNITYSDK_OFFSET(0x1A69AB80)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSERADIUS_OFFSET UNITYSDK_OFFSET(0x1A699BE0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSERIGHTBUTTON_OFFSET UNITYSDK_OFFSET(0x1A699210)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSESCROLLX_OFFSET UNITYSDK_OFFSET(0x1A69A690)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSESCROLLY_OFFSET UNITYSDK_OFFSET(0x1A69A840)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_INITIALIZE_CTRLMOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x1A698C90)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_MERGEFORWARD_OFFSET UNITYSDK_OFFSET(0x1A69AF10)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1A69AD10)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1A69AD70)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IEVENTMERGER_MERGEFORWARD_OFFSET UNITYSDK_OFFSET(0x1A69AFB0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1A69AEA0)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1A69AF00)
#define UNITYENGINE_INPUTSYSTEM_FASTMOUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A697F30)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int FastMouse_TypeDefinitionIndex = 28465;
