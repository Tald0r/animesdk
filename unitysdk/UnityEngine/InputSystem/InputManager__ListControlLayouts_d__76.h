...
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A555300)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A555C90)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A555C20)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A555D30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A555C80)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A555C30)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A555270)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76__CTOR_OFFSET UNITYSDK_OFFSET(0x1A555250)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1A5552A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1A5552B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76___M__FINALLY3_OFFSET UNITYSDK_OFFSET(0x1A5552C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76___M__FINALLY4_OFFSET UNITYSDK_OFFSET(0x1A5552D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76___M__FINALLY5_OFFSET UNITYSDK_OFFSET(0x1A5552E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTMANAGER__LISTCONTROLLAYOUTS_D__76___M__FINALLY6_OFFSET UNITYSDK_OFFSET(0x1A5552F0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputManager__ListControlLayouts_d__76_TypeDefinitionIndex = 28515;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2_Enumerator<::UnityEngine::InputSystem::Utilities::InternedString, ::System::String*> __7__wrap3; // 0x20
		::System::Collections::Generic::Dictionary_2_Enumerator<::UnityEngine::InputSystem::Utilities::InternedString, ::System::Type*> __7__wrap2; // 0x50
		::System::String* basedOn; // 0x80
		::UnityEngine::InputSystem::InputManager* __4__this; // 0x88
		::System::Collections::Generic::Dictionary_2_Enumerator<::UnityEngine::InputSystem::Utilities::InternedString, ::System::Func_1<::UnityEngine::InputSystem::Layouts::InputControlLayout*>*> __7__wrap4; // 0x90
		::System::String* __3__basedOn; // 0xC0
		::System::String* __2__current; // 0xC8
		::System::Int32 __l__initialThreadId; // 0xD0
		::System::Int32 __1__state; // 0xD4
