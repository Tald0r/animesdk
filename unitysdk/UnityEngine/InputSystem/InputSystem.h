...
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADDDEVICEUSAGE_1_OFFSET UNITYSDK_OFFSET(0x1A5796E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADDDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x1A579660)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADDDEVICE_1_OFFSET UNITYSDK_OFFSET(0x1A5786B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADDDEVICE_2_OFFSET UNITYSDK_OFFSET(0x1A578830)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADDDEVICE_OFFSET UNITYSDK_OFFSET(0x1A5785C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A57AC10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONAFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x1A57A710)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A57A490)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1A577BE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONDEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x1A577F40)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONFINDLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1A5782A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONLAYOUTCHANGE_OFFSET UNITYSDK_OFFSET(0x1A576890)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONSETTINGSCHANGE_OFFSET UNITYSDK_OFFSET(0x1A57AB30)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_DISABLEALLENABLEDACTIONS_OFFSET UNITYSDK_OFFSET(0x1A57B180)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_DISABLEDEVICE_OFFSET UNITYSDK_OFFSET(0x1A578E40)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ENABLEDEVICE_OFFSET UNITYSDK_OFFSET(0x1A578DE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_FINDCONTROLS_OFFSET UNITYSDK_OFFSET(0x1A5799A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_FINDCONTROL_OFFSET UNITYSDK_OFFSET(0x1A579840)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_FLUSHDISCONNECTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1A578940)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GETDEVICEBYID_OFFSET UNITYSDK_OFFSET(0x1A578C70)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GETDEVICE_1_OFFSET UNITYSDK_OFFSET(0x1A578A10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GETDEVICE_OFFSET UNITYSDK_OFFSET(0x1A5789B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GETNAMEOFBASELAYOUT_OFFSET UNITYSDK_OFFSET(0x1A577350)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GETUNSUPPORTEDDEVICES_1_OFFSET UNITYSDK_OFFSET(0x1A578D80)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GETUNSUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1A578CD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1A577B00)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_DISCONNECTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x1A577B70)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_ISPROCESSINGEVENTS_OFFSET UNITYSDK_OFFSET(0x1A579A20)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_METRICS_OFFSET UNITYSDK_OFFSET(0x1A57B370)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_ONANYBUTTONPRESS_OFFSET UNITYSDK_OFFSET(0x1A579AA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1A579A80)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A578500)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_REMOTING_OFFSET UNITYSDK_OFFSET(0x1A57B2B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1A57A440)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1A57B2E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_INITIALIZEINPLAYER_OFFSET UNITYSDK_OFFSET(0x1A57B400)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ISFIRSTLAYOUTBASEDONSECOND_OFFSET UNITYSDK_OFFSET(0x1A5774A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LISTENABLEDACTIONS_1_OFFSET UNITYSDK_OFFSET(0x1A57B240)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LISTENABLEDACTIONS_OFFSET UNITYSDK_OFFSET(0x1A57B190)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LISTINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x1A57AF10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LISTLAYOUTSBASEDON_OFFSET UNITYSDK_OFFSET(0x1A577150)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LISTLAYOUTS_OFFSET UNITYSDK_OFFSET(0x1A5770A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LISTPROCESSORS_OFFSET UNITYSDK_OFFSET(0x1A577AA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LOADLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A577270)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1A579080)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_PERFORMDEFAULTPLUGININITIALIZATION_OFFSET UNITYSDK_OFFSET(0x1A57B790)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_QUEUECONFIGCHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x1A579DB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_QUEUEEVENT_OFFSET UNITYSDK_OFFSET(0x1A579C90)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_QUEUETEXTEVENT_OFFSET UNITYSDK_OFFSET(0x1A579FE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERBINDINGCOMPOSITE_OFFSET UNITYSDK_OFFSET(0x1A57AF70)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A57AD10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERLAYOUTBUILDER_OFFSET UNITYSDK_OFFSET(0x1A576E20)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERLAYOUTMATCHER_OFFSET UNITYSDK_OFFSET(0x1A576DC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERLAYOUTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A576D50)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERLAYOUT_1_OFFSET UNITYSDK_OFFSET(0x1A576C70)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A576B10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1A577650)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVEDEVICEUSAGE_1_OFFSET UNITYSDK_OFFSET(0x1A5797D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVEDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x1A579750)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVEDEVICE_OFFSET UNITYSDK_OFFSET(0x1A5788E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVELAYOUT_OFFSET UNITYSDK_OFFSET(0x1A576FC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A57AC90)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONAFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x1A57A820)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A57A600)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1A577D90)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONDEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x1A5780F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONFINDLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x1A5783C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONLAYOUTCHANGE_OFFSET UNITYSDK_OFFSET(0x1A5769D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONSETTINGSCHANGE_OFFSET UNITYSDK_OFFSET(0x1A57ABA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_RESETDEVICE_OFFSET UNITYSDK_OFFSET(0x1A578F90)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x1A5793B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1A579210)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_RUNINITIALIZEINPLAYER_OFFSET UNITYSDK_OFFSET(0x1A57B720)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_RUNINITIALUPDATE_OFFSET UNITYSDK_OFFSET(0x1A57B7F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_SETDEVICEUSAGE_1_OFFSET UNITYSDK_OFFSET(0x1A5795F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_SETDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x1A579550)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_SET_ONEVENT_OFFSET UNITYSDK_OFFSET(0x1A579A90)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_SET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x1A578560)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1A57A930)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_TRYFINDMATCHINGLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A577020)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_TRYGETBINDINGCOMPOSITE_OFFSET UNITYSDK_OFFSET(0x1A57B0C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_TRYGETINTERACTION_OFFSET UNITYSDK_OFFSET(0x1A57AE50)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_TRYGETPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1A5779E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_TRYRESETDEVICE_OFFSET UNITYSDK_OFFSET(0x1A578FF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_TRYSYNCDEVICE_OFFSET UNITYSDK_OFFSET(0x1A578EB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1A57A2D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A57A220)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A57B3F0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputSystem_TypeDefinitionIndex = 28423;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::InputManager**)Il2CppClass::FromTypeDefinitionIndex(InputSystem_TypeDefinitionIndex)->GetStaticField(0x21B20);
		}
		static ::UnityEngine::InputSystem::InputRemoting** StaticGet_s_Remote()
		{
			return (::UnityEngine::InputSystem::InputRemoting**)Il2CppClass::FromTypeDefinitionIndex(InputSystem_TypeDefinitionIndex)->GetStaticField(0x21B28);
		}
