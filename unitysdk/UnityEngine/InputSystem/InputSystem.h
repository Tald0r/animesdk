...
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADDDEVICEUSAGE_1_OFFSET UNITYSDK_OFFSET(0x19F68870)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADDDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x19F687F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADDDEVICE_1_OFFSET UNITYSDK_OFFSET(0x19F67840)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADDDEVICE_2_OFFSET UNITYSDK_OFFSET(0x19F679C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADDDEVICE_OFFSET UNITYSDK_OFFSET(0x19F67750)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x19F69DB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONAFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x19F698B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x19F69630)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x19F66D70)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONDEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x19F670D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONFINDLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x19F67430)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONLAYOUTCHANGE_OFFSET UNITYSDK_OFFSET(0x19F65A20)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ADD_ONSETTINGSCHANGE_OFFSET UNITYSDK_OFFSET(0x19F69CD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_DISABLEALLENABLEDACTIONS_OFFSET UNITYSDK_OFFSET(0x19F6A340)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_DISABLEDEVICE_OFFSET UNITYSDK_OFFSET(0x19F67FD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ENABLEDEVICE_OFFSET UNITYSDK_OFFSET(0x19F67F70)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_FINDCONTROLS_OFFSET UNITYSDK_OFFSET(0x19F68B30)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_FINDCONTROL_OFFSET UNITYSDK_OFFSET(0x19F689D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_FLUSHDISCONNECTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x19F67AD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GETDEVICEBYID_OFFSET UNITYSDK_OFFSET(0x19F67E00)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GETDEVICE_1_OFFSET UNITYSDK_OFFSET(0x19F67BA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GETDEVICE_OFFSET UNITYSDK_OFFSET(0x19F67B40)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GETNAMEOFBASELAYOUT_OFFSET UNITYSDK_OFFSET(0x19F664D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GETUNSUPPORTEDDEVICES_1_OFFSET UNITYSDK_OFFSET(0x19F67F10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GETUNSUPPORTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x19F67E60)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x19F66C90)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_DISCONNECTEDDEVICES_OFFSET UNITYSDK_OFFSET(0x19F66D00)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_ISPROCESSINGEVENTS_OFFSET UNITYSDK_OFFSET(0x19F68BB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_METRICS_OFFSET UNITYSDK_OFFSET(0x19F6A530)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_ONANYBUTTONPRESS_OFFSET UNITYSDK_OFFSET(0x19F68C30)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_ONEVENT_OFFSET UNITYSDK_OFFSET(0x19F68C10)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x19F67690)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_REMOTING_OFFSET UNITYSDK_OFFSET(0x19F6A470)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x19F695D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x19F6A4A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_INITIALIZEINPLAYER_OFFSET UNITYSDK_OFFSET(0x19F6A5C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_ISFIRSTLAYOUTBASEDONSECOND_OFFSET UNITYSDK_OFFSET(0x19F66620)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LISTENABLEDACTIONS_1_OFFSET UNITYSDK_OFFSET(0x19F6A400)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LISTENABLEDACTIONS_OFFSET UNITYSDK_OFFSET(0x19F6A350)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LISTINTERACTIONS_OFFSET UNITYSDK_OFFSET(0x19F6A0C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LISTLAYOUTSBASEDON_OFFSET UNITYSDK_OFFSET(0x19F662D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LISTLAYOUTS_OFFSET UNITYSDK_OFFSET(0x19F66230)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LISTPROCESSORS_OFFSET UNITYSDK_OFFSET(0x19F66C20)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_LOADLAYOUT_OFFSET UNITYSDK_OFFSET(0x19F663F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x19F68210)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_PERFORMDEFAULTPLUGININITIALIZATION_OFFSET UNITYSDK_OFFSET(0x19F6A950)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_QUEUECONFIGCHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x19F68F40)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_QUEUEEVENT_OFFSET UNITYSDK_OFFSET(0x19F68E20)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_QUEUETEXTEVENT_OFFSET UNITYSDK_OFFSET(0x19F69170)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERBINDINGCOMPOSITE_OFFSET UNITYSDK_OFFSET(0x19F6A130)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERINTERACTION_OFFSET UNITYSDK_OFFSET(0x19F69EB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERLAYOUTBUILDER_OFFSET UNITYSDK_OFFSET(0x19F65FB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERLAYOUTMATCHER_OFFSET UNITYSDK_OFFSET(0x19F65F50)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERLAYOUTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x19F65EE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERLAYOUT_1_OFFSET UNITYSDK_OFFSET(0x19F65E00)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERLAYOUT_OFFSET UNITYSDK_OFFSET(0x19F65CA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REGISTERPROCESSOR_OFFSET UNITYSDK_OFFSET(0x19F667D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVEDEVICEUSAGE_1_OFFSET UNITYSDK_OFFSET(0x19F68960)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVEDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x19F688E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVEDEVICE_OFFSET UNITYSDK_OFFSET(0x19F67A70)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVELAYOUT_OFFSET UNITYSDK_OFFSET(0x19F66150)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONACTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x19F69E30)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONAFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x19F699C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONBEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x19F697A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x19F66F20)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONDEVICECOMMAND_OFFSET UNITYSDK_OFFSET(0x19F67280)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONFINDLAYOUTFORDEVICE_OFFSET UNITYSDK_OFFSET(0x19F67550)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONLAYOUTCHANGE_OFFSET UNITYSDK_OFFSET(0x19F65B60)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_REMOVE_ONSETTINGSCHANGE_OFFSET UNITYSDK_OFFSET(0x19F69D40)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_RESETDEVICE_OFFSET UNITYSDK_OFFSET(0x19F68120)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x19F68540)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x19F683A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_RUNINITIALIZEINPLAYER_OFFSET UNITYSDK_OFFSET(0x19F6A8E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_RUNINITIALUPDATE_OFFSET UNITYSDK_OFFSET(0x19F6A9B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_SETDEVICEUSAGE_1_OFFSET UNITYSDK_OFFSET(0x19F68780)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_SETDEVICEUSAGE_OFFSET UNITYSDK_OFFSET(0x19F686E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_SET_ONEVENT_OFFSET UNITYSDK_OFFSET(0x19F68C20)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_SET_POLLINGFREQUENCY_OFFSET UNITYSDK_OFFSET(0x19F676F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_SET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x19F69AD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_TRYFINDMATCHINGLAYOUT_OFFSET UNITYSDK_OFFSET(0x19F661B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_TRYGETBINDINGCOMPOSITE_OFFSET UNITYSDK_OFFSET(0x19F6A280)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_TRYGETINTERACTION_OFFSET UNITYSDK_OFFSET(0x19F6A000)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_TRYGETPROCESSOR_OFFSET UNITYSDK_OFFSET(0x19F66B60)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_TRYRESETDEVICE_OFFSET UNITYSDK_OFFSET(0x19F68180)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_TRYSYNCDEVICE_OFFSET UNITYSDK_OFFSET(0x19F68040)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x19F69460)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x19F693B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTSYSTEM__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F6A5B0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputSystem_TypeDefinitionIndex = 27483;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::InputManager**)Il2CppClass::FromTypeDefinitionIndex(InputSystem_TypeDefinitionIndex)->GetStaticField(0x204C0);
		}
		static ::UnityEngine::InputSystem::InputRemoting** StaticGet_s_Remote()
		{
			return (::UnityEngine::InputSystem::InputRemoting**)Il2CppClass::FromTypeDefinitionIndex(InputSystem_TypeDefinitionIndex)->GetStaticField(0x204C8);
		}
