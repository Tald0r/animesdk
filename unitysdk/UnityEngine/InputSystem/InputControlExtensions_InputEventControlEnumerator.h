...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_CHECKCURRENT_OFFSET UNITYSDK_OFFSET(0x93F1A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_CHECKDEFAULT_OFFSET UNITYSDK_OFFSET(0x93F170)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x93F1F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x746650)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x93F1D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x93F1E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x746650)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x93F160)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlExtensions_InputEventControlEnumerator_TypeDefinitionIndex = 27496;
