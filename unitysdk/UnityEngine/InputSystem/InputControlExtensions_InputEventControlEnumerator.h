...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_CHECKCURRENT_OFFSET UNITYSDK_OFFSET(0x96CD70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_CHECKDEFAULT_OFFSET UNITYSDK_OFFSET(0x96CD40)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x96CDC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x652A70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x96CDA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x96CDB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x652A70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLEXTENSIONS_INPUTEVENTCONTROLENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x96CD30)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlExtensions_InputEventControlEnumerator_TypeDefinitionIndex = 28436;
