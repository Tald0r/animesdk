...
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIVATEINPUT_OFFSET UNITYSDK_OFFSET(0x18C04160)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ADD_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x18C04AE0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ADD_ONCONTROLSCHANGED_OFFSET UNITYSDK_OFFSET(0x18C04DE0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ADD_ONDEVICELOST_OFFSET UNITYSDK_OFFSET(0x18C04BE0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ADD_ONDEVICEREGAINED_OFFSET UNITYSDK_OFFSET(0x18C04CE0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ASSIGNPLAYERINDEX_OFFSET UNITYSDK_OFFSET(0x18C083E0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ASSIGNUSERANDDEVICES_OFFSET UNITYSDK_OFFSET(0x18C032A0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_CACHEMESSAGENAMES_OFFSET UNITYSDK_OFFSET(0x18C07520)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_CLEARCACHES_OFFSET UNITYSDK_OFFSET(0x18C03290)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_DEACTIVATEINPUT_OFFSET UNITYSDK_OFFSET(0x18C059C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_DEBUGLOGACTION_OFFSET UNITYSDK_OFFSET(0x18C09530)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_DOINSTANTIATE_OFFSET UNITYSDK_OFFSET(0x18C06BA0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_FINDFIRSTPAIREDTODEVICE_OFFSET UNITYSDK_OFFSET(0x18C06660)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GETPLAYERBYINDEX_OFFSET UNITYSDK_OFFSET(0x18C06520)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ACTIONEVENTS_OFFSET UNITYSDK_OFFSET(0x18C04870)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ACTIONS_OFFSET UNITYSDK_OFFSET(0x18C02520)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x18C024F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ALL_OFFSET UNITYSDK_OFFSET(0x18C054D0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_CAMERA_OFFSET UNITYSDK_OFFSET(0x18C04EE0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_CONTROLSCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x18C04A70)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_CURRENTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x18C04740)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_CURRENTCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x18C04260)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEFAULTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x18C047F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEFAULTCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x18C04380)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEVICELOSTEVENT_OFFSET UNITYSDK_OFFSET(0x18C04990)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEVICEREGAINEDEVENT_OFFSET UNITYSDK_OFFSET(0x18C04A00)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x18C05290)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_HASMISSINGREQUIREDDEVICES_OFFSET UNITYSDK_OFFSET(0x18C053C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_INPUTISACTIVE_OFFSET UNITYSDK_OFFSET(0x18C024E0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ISSINGLEPLAYER_OFFSET UNITYSDK_OFFSET(0x18C05550)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_NEVERAUTOSWITCHCONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x18C043A0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_NOTIFICATIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x18C04810)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_PLAYERINDEX_OFFSET UNITYSDK_OFFSET(0x18C02500)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_SPLITSCREENINDEX_OFFSET UNITYSDK_OFFSET(0x18C02510)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_UIINPUTMODULE_OFFSET UNITYSDK_OFFSET(0x18C04F00)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_USER_OFFSET UNITYSDK_OFFSET(0x18C05280)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_HANDLECONTROLSCHANGED_OFFSET UNITYSDK_OFFSET(0x18C08EC0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_HANDLEDEVICELOST_OFFSET UNITYSDK_OFFSET(0x18C095B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_HANDLEDEVICEREGAINED_OFFSET UNITYSDK_OFFSET(0x18C09690)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_HAVEBINDINGFORDEVICE_OFFSET UNITYSDK_OFFSET(0x18C080F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_INITIALIZEACTIONS_OFFSET UNITYSDK_OFFSET(0x18C02570)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_INSTALLONACTIONTRIGGEREDHOOK_OFFSET UNITYSDK_OFFSET(0x18C072E0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_INSTANTIATE_1_OFFSET UNITYSDK_OFFSET(0x18C070F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x18C069F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x18C07BD0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x18C0A550)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18C08FF0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x18C08600)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONPREFILTERUNPAIREDDEVICEUSED_OFFSET UNITYSDK_OFFSET(0x18C09950)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONUNPAIREDDEVICEUSED_OFFSET UNITYSDK_OFFSET(0x18C09B10)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONUSERCHANGE_OFFSET UNITYSDK_OFFSET(0x18C09770)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_PASSIVATEINPUT_OFFSET UNITYSDK_OFFSET(0x18C05A00)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_REMOVE_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x18C04B60)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_REMOVE_ONCONTROLSCHANGED_OFFSET UNITYSDK_OFFSET(0x18C04E60)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_REMOVE_ONDEVICELOST_OFFSET UNITYSDK_OFFSET(0x18C04C60)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_REMOVE_ONDEVICEREGAINED_OFFSET UNITYSDK_OFFSET(0x18C04D60)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_ACTIONEVENTS_OFFSET UNITYSDK_OFFSET(0x18C04910)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_ACTIONS_OFFSET UNITYSDK_OFFSET(0x18C02D30)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_CAMERA_OFFSET UNITYSDK_OFFSET(0x18C04EF0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_CURRENTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x18C04750)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_DEFAULTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x18C04800)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_DEFAULTCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x18C04390)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_NEVERAUTOSWITCHCONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x18C043B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_NOTIFICATIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x18C04820)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_UIINPUTMODULE_OFFSET UNITYSDK_OFFSET(0x18C04F10)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_STARTLISTENINGFORDEVICECHANGES_OFFSET UNITYSDK_OFFSET(0x18C08E20)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_STARTLISTENINGFORUNPAIREDDEVICEACTIVITY_OFFSET UNITYSDK_OFFSET(0x18C044C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_STOPLISTENINGFORDEVICECHANGES_OFFSET UNITYSDK_OFFSET(0x18C08FA0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_STOPLISTENINGFORUNPAIREDDEVICEACTIVITY_OFFSET UNITYSDK_OFFSET(0x18C04670)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SWITCHCONTROLSCHEMEINTERNAL_OFFSET UNITYSDK_OFFSET(0x18C05C80)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SWITCHCURRENTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x18C05690)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SWITCHCURRENTCONTROLSCHEME_1_OFFSET UNITYSDK_OFFSET(0x18C06430)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SWITCHCURRENTCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x18C05A40)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_TRYTOACTIVATECONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x18C07DA0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_UNASSIGNUSERANDDEVICES_OFFSET UNITYSDK_OFFSET(0x18C08200)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_UNINITIALIZEACTIONS_OFFSET UNITYSDK_OFFSET(0x18C02FE0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_UNINSTALLONACTIONTRIGGEREDHOOK_OFFSET UNITYSDK_OFFSET(0x18C079F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT__CCTOR_OFFSET UNITYSDK_OFFSET(0x18C0A6D0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x18C0A6A0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int PlayerInput_TypeDefinitionIndex = 27587;
	...
	public:
		...
		{
			return (::System::Action_3<::UnityEngine::InputSystem::Users::InputUser, ::UnityEngine::InputSystem::Users::InputUserChange, ::UnityEngine::InputSystem::InputDevice*>**)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x206C0);
		}
		static ::System::String** StaticGet_s_InitControlScheme()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x206C8);
		}
		static ::Il2CppArray<::UnityEngine::InputSystem::PlayerInput*>** StaticGet_s_AllActivePlayers()
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::PlayerInput*>**)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x206D0);
		}
		static ::Il2CppArray<::UnityEngine::InputSystem::InputDevice*>** StaticGet_s_InitPairWithDevices()
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::InputDevice*>**)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x206D8);
		}
		static ::System::Int32* StaticGet_s_InitPairWithDevicesCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D50);
		}
		static ::System::Boolean* StaticGet_s_DestroyIfDeviceSetupUnsuccessful()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D54);
		}
		static ::System::Int32* StaticGet_s_InitSplitScreenIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D58);
		}
		static ::System::Int32* StaticGet_s_AllActivePlayersCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D5C);
		}
		static ::System::Int32* StaticGet_s_InitPlayerIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D60);
		}
