...
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ACTIVATEINPUT_OFFSET UNITYSDK_OFFSET(0x190A1440)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ADD_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x190A1DC0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ADD_ONCONTROLSCHANGED_OFFSET UNITYSDK_OFFSET(0x190A20C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ADD_ONDEVICELOST_OFFSET UNITYSDK_OFFSET(0x190A1EC0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ADD_ONDEVICEREGAINED_OFFSET UNITYSDK_OFFSET(0x190A1FC0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ASSIGNPLAYERINDEX_OFFSET UNITYSDK_OFFSET(0x190A56C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ASSIGNUSERANDDEVICES_OFFSET UNITYSDK_OFFSET(0x190A0580)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_CACHEMESSAGENAMES_OFFSET UNITYSDK_OFFSET(0x190A4800)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_CLEARCACHES_OFFSET UNITYSDK_OFFSET(0x190A0570)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_DEACTIVATEINPUT_OFFSET UNITYSDK_OFFSET(0x190A2CA0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_DEBUGLOGACTION_OFFSET UNITYSDK_OFFSET(0x190A6810)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_DOINSTANTIATE_OFFSET UNITYSDK_OFFSET(0x190A3E80)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_FINDFIRSTPAIREDTODEVICE_OFFSET UNITYSDK_OFFSET(0x190A3940)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GETPLAYERBYINDEX_OFFSET UNITYSDK_OFFSET(0x190A3800)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ACTIONEVENTS_OFFSET UNITYSDK_OFFSET(0x190A1B50)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ACTIONS_OFFSET UNITYSDK_OFFSET(0x1909F800)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1909F7D0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ALL_OFFSET UNITYSDK_OFFSET(0x190A27B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_CAMERA_OFFSET UNITYSDK_OFFSET(0x190A21C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_CONTROLSCHANGEDEVENT_OFFSET UNITYSDK_OFFSET(0x190A1D50)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_CURRENTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x190A1A20)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_CURRENTCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x190A1540)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEFAULTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x190A1AD0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEFAULTCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x190A1660)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEVICELOSTEVENT_OFFSET UNITYSDK_OFFSET(0x190A1C70)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEVICEREGAINEDEVENT_OFFSET UNITYSDK_OFFSET(0x190A1CE0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x190A2570)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_HASMISSINGREQUIREDDEVICES_OFFSET UNITYSDK_OFFSET(0x190A26A0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_INPUTISACTIVE_OFFSET UNITYSDK_OFFSET(0x1909F7C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_ISSINGLEPLAYER_OFFSET UNITYSDK_OFFSET(0x190A2830)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_NEVERAUTOSWITCHCONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x190A1680)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_NOTIFICATIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x190A1AF0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_PLAYERINDEX_OFFSET UNITYSDK_OFFSET(0x1909F7E0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_SPLITSCREENINDEX_OFFSET UNITYSDK_OFFSET(0x1909F7F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_UIINPUTMODULE_OFFSET UNITYSDK_OFFSET(0x190A21E0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_GET_USER_OFFSET UNITYSDK_OFFSET(0x190A2560)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_HANDLECONTROLSCHANGED_OFFSET UNITYSDK_OFFSET(0x190A61A0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_HANDLEDEVICELOST_OFFSET UNITYSDK_OFFSET(0x190A6890)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_HANDLEDEVICEREGAINED_OFFSET UNITYSDK_OFFSET(0x190A6970)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_HAVEBINDINGFORDEVICE_OFFSET UNITYSDK_OFFSET(0x190A53D0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_INITIALIZEACTIONS_OFFSET UNITYSDK_OFFSET(0x1909F850)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_INSTALLONACTIONTRIGGEREDHOOK_OFFSET UNITYSDK_OFFSET(0x190A45C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_INSTANTIATE_1_OFFSET UNITYSDK_OFFSET(0x190A43D0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_INSTANTIATE_OFFSET UNITYSDK_OFFSET(0x190A3CD0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x190A4EB0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x190A7830)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x190A62D0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x190A58E0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONPREFILTERUNPAIREDDEVICEUSED_OFFSET UNITYSDK_OFFSET(0x190A6C30)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONUNPAIREDDEVICEUSED_OFFSET UNITYSDK_OFFSET(0x190A6DF0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_ONUSERCHANGE_OFFSET UNITYSDK_OFFSET(0x190A6A50)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_PASSIVATEINPUT_OFFSET UNITYSDK_OFFSET(0x190A2CE0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_REMOVE_ONACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x190A1E40)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_REMOVE_ONCONTROLSCHANGED_OFFSET UNITYSDK_OFFSET(0x190A2140)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_REMOVE_ONDEVICELOST_OFFSET UNITYSDK_OFFSET(0x190A1F40)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_REMOVE_ONDEVICEREGAINED_OFFSET UNITYSDK_OFFSET(0x190A2040)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_ACTIONEVENTS_OFFSET UNITYSDK_OFFSET(0x190A1BF0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_ACTIONS_OFFSET UNITYSDK_OFFSET(0x190A0010)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_CAMERA_OFFSET UNITYSDK_OFFSET(0x190A21D0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_CURRENTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x190A1A30)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_DEFAULTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x190A1AE0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_DEFAULTCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x190A1670)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_NEVERAUTOSWITCHCONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x190A1690)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_NOTIFICATIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x190A1B00)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SET_UIINPUTMODULE_OFFSET UNITYSDK_OFFSET(0x190A21F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_STARTLISTENINGFORDEVICECHANGES_OFFSET UNITYSDK_OFFSET(0x190A6100)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_STARTLISTENINGFORUNPAIREDDEVICEACTIVITY_OFFSET UNITYSDK_OFFSET(0x190A17A0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_STOPLISTENINGFORDEVICECHANGES_OFFSET UNITYSDK_OFFSET(0x190A6280)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_STOPLISTENINGFORUNPAIREDDEVICEACTIVITY_OFFSET UNITYSDK_OFFSET(0x190A1950)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SWITCHCONTROLSCHEMEINTERNAL_OFFSET UNITYSDK_OFFSET(0x190A2F60)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SWITCHCURRENTACTIONMAP_OFFSET UNITYSDK_OFFSET(0x190A2970)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SWITCHCURRENTCONTROLSCHEME_1_OFFSET UNITYSDK_OFFSET(0x190A3710)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_SWITCHCURRENTCONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x190A2D20)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_TRYTOACTIVATECONTROLSCHEME_OFFSET UNITYSDK_OFFSET(0x190A5080)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_UNASSIGNUSERANDDEVICES_OFFSET UNITYSDK_OFFSET(0x190A54E0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_UNINITIALIZEACTIONS_OFFSET UNITYSDK_OFFSET(0x190A02C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT_UNINSTALLONACTIONTRIGGEREDHOOK_OFFSET UNITYSDK_OFFSET(0x190A4CD0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT__CCTOR_OFFSET UNITYSDK_OFFSET(0x190A79B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x190A7980)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int PlayerInput_TypeDefinitionIndex = 28527;
	...
	public:
		...
		{
			return (::System::Action_3<::UnityEngine::InputSystem::Users::InputUser, ::UnityEngine::InputSystem::Users::InputUserChange, ::UnityEngine::InputSystem::InputDevice*>**)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x21D20);
		}
		static ::System::String** StaticGet_s_InitControlScheme()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x21D28);
		}
		static ::Il2CppArray<::UnityEngine::InputSystem::PlayerInput*>** StaticGet_s_AllActivePlayers()
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::PlayerInput*>**)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x21D30);
		}
		static ::Il2CppArray<::UnityEngine::InputSystem::InputDevice*>** StaticGet_s_InitPairWithDevices()
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::InputDevice*>**)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x21D38);
		}
		static ::System::Int32* StaticGet_s_InitPlayerIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D10);
		}
		static ::System::Int32* StaticGet_s_InitSplitScreenIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D14);
		}
		static ::System::Int32* StaticGet_s_AllActivePlayersCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D18);
		}
		static ::System::Int32* StaticGet_s_InitPairWithDevicesCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D1C);
		}
		static ::System::Boolean* StaticGet_s_DestroyIfDeviceSetupUnsuccessful()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(PlayerInput_TypeDefinitionIndex)->GetStaticField(0x4D20);
		}
