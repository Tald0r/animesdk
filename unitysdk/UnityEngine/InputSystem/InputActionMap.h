...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ADD_ACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x19AB0DE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_CLEARACTIONLOOKUPTABLE_OFFSET UNITYSDK_OFFSET(0x19AB1350)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_CLEARCACHEDACTIONDATA_OFFSET UNITYSDK_OFFSET(0x19AB2730)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_CLONE_OFFSET UNITYSDK_OFFSET(0x19AB1830)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_CONTAINS_OFFSET UNITYSDK_OFFSET(0x19AB1A70)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DISABLE_OFFSET UNITYSDK_OFFSET(0x19AB1800)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19AB0EA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ENABLE_OFFSET UNITYSDK_OFFSET(0x19AB1780)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDACTIONINDEX_1_OFFSET UNITYSDK_OFFSET(0x19AB13C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDACTIONINDEX_OFFSET UNITYSDK_OFFSET(0x19AB0EC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDACTION_1_OFFSET UNITYSDK_OFFSET(0x19AB1550)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDACTION_OFFSET UNITYSDK_OFFSET(0x19AB0D10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDBINDINGRELATIVETOMAP_OFFSET UNITYSDK_OFFSET(0x19AB3A20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDBINDING_OFFSET UNITYSDK_OFFSET(0x19AB38D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FROMJSON_OFFSET UNITYSDK_OFFSET(0x19AB3AA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GENERATEID_OFFSET UNITYSDK_OFFSET(0x19AB0740)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GETBINDINGSFORSINGLEACTION_OFFSET UNITYSDK_OFFSET(0x19AB1D60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GETCONTROLSFORSINGLEACTION_OFFSET UNITYSDK_OFFSET(0x19AB26E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19AB1BC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ACTIONS_OFFSET UNITYSDK_OFFSET(0x19AB07C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x19AB06D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x19AB0940)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x19AB07F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_CONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x19AB0890)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x19AB0B10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x19AB07B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_IDDONTGENERATE_OFFSET UNITYSDK_OFFSET(0x19AB0770)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ID_OFFSET UNITYSDK_OFFSET(0x19AB06E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19AB0C20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19AB06C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ISUSABLEWITHDEVICE_OFFSET UNITYSDK_OFFSET(0x19AB15B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_LAZYRESOLVEBINDINGS_OFFSET UNITYSDK_OFFSET(0x19AB0AD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19AB3C90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19AB3C80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_REMOVE_ACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x19AB0E30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_RESOLVEBINDINGSIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x19AB17E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_RESOLVEBINDINGS_OFFSET UNITYSDK_OFFSET(0x19AB2750)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SETUPACTIONLOOKUPTABLE_OFFSET UNITYSDK_OFFSET(0x19AB1140)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SETUPPERACTIONCONTROLANDBINDINGARRAYS_OFFSET UNITYSDK_OFFSET(0x19AB1DB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x19AB0990)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SET_DEVICES_OFFSET UNITYSDK_OFFSET(0x19AB0BB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19AB1C90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x19AB1A60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_TOJSON_1_OFFSET UNITYSDK_OFFSET(0x19AB3BB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_TOJSON_OFFSET UNITYSDK_OFFSET(0x19AB3B20)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19AB1AA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_UNITYENGINE_INPUTSYSTEM_IINPUTACTIONCOLLECTION2_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x19AB0820)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19AB0E90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x19AB0E80)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionMap_TypeDefinitionIndex = 27421;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(InputActionMap_TypeDefinitionIndex)->GetStaticField(0x4CC0);
		}
