...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ADD_ACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1A09F3F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_CLEARACTIONLOOKUPTABLE_OFFSET UNITYSDK_OFFSET(0x1A09F960)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_CLEARCACHEDACTIONDATA_OFFSET UNITYSDK_OFFSET(0x1A0A0D40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_CLONE_OFFSET UNITYSDK_OFFSET(0x1A09FE40)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A0A0080)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DISABLE_OFFSET UNITYSDK_OFFSET(0x1A09FE10)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A09F4B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ENABLE_OFFSET UNITYSDK_OFFSET(0x1A09FD90)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDACTIONINDEX_1_OFFSET UNITYSDK_OFFSET(0x1A09F9D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDACTIONINDEX_OFFSET UNITYSDK_OFFSET(0x1A09F4D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDACTION_1_OFFSET UNITYSDK_OFFSET(0x1A09FB60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDACTION_OFFSET UNITYSDK_OFFSET(0x1A09F320)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDBINDINGRELATIVETOMAP_OFFSET UNITYSDK_OFFSET(0x1A0A2010)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FINDBINDING_OFFSET UNITYSDK_OFFSET(0x1A0A1EC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1A0A2090)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GENERATEID_OFFSET UNITYSDK_OFFSET(0x1A09ED50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GETBINDINGSFORSINGLEACTION_OFFSET UNITYSDK_OFFSET(0x1A0A0370)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GETCONTROLSFORSINGLEACTION_OFFSET UNITYSDK_OFFSET(0x1A0A0CF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A0A01D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ACTIONS_OFFSET UNITYSDK_OFFSET(0x1A09EDD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1A09ECE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x1A09EF50)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x1A09EE00)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_CONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x1A09EEA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1A09F120)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1A09EDC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_IDDONTGENERATE_OFFSET UNITYSDK_OFFSET(0x1A09ED80)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A09ECF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A09F230)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A09ECD0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ISUSABLEWITHDEVICE_OFFSET UNITYSDK_OFFSET(0x1A09FBC0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_LAZYRESOLVEBINDINGS_OFFSET UNITYSDK_OFFSET(0x1A09F0E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A0A2280)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A0A2270)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_REMOVE_ACTIONTRIGGERED_OFFSET UNITYSDK_OFFSET(0x1A09F440)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_RESOLVEBINDINGSIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1A09FDF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_RESOLVEBINDINGS_OFFSET UNITYSDK_OFFSET(0x1A0A0D60)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SETUPACTIONLOOKUPTABLE_OFFSET UNITYSDK_OFFSET(0x1A09F750)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SETUPPERACTIONCONTROLANDBINDINGARRAYS_OFFSET UNITYSDK_OFFSET(0x1A0A03C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x1A09EFA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SET_DEVICES_OFFSET UNITYSDK_OFFSET(0x1A09F1C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A0A02A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_SYSTEM_ICLONEABLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1A0A0070)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_TOJSON_1_OFFSET UNITYSDK_OFFSET(0x1A0A21A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_TOJSON_OFFSET UNITYSDK_OFFSET(0x1A0A2110)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0A00B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP_UNITYENGINE_INPUTSYSTEM_IINPUTACTIONCOLLECTION2_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x1A09EE30)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A09F4A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A09F490)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionMap_TypeDefinitionIndex = 28361;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(InputActionMap_TypeDefinitionIndex)->GetStaticField(0x4C70);
		}
