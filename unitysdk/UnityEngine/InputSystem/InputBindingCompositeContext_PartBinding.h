...
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_PARTBINDING_GET_CONTROL_OFFSET UNITYSDK_OFFSET(0x272280)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_PARTBINDING_GET_PART_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_PARTBINDING_SET_CONTROL_OFFSET UNITYSDK_OFFSET(0x302310)
#define UNITYENGINE_INPUTSYSTEM_INPUTBINDINGCOMPOSITECONTEXT_PARTBINDING_SET_PART_OFFSET UNITYSDK_OFFSET(0x302300)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputBindingCompositeContext_PartBinding_TypeDefinitionIndex = 28408;
