...
#define UNITYENGINE_INPUTSYSTEM_ACCELEROMETER_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1AAC0860)
#define UNITYENGINE_INPUTSYSTEM_ACCELEROMETER_GET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1AAC0700)
#define UNITYENGINE_INPUTSYSTEM_ACCELEROMETER_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AAC0720)
#define UNITYENGINE_INPUTSYSTEM_ACCELEROMETER_MAKECURRENT_OFFSET UNITYSDK_OFFSET(0x1AAC07A0)
#define UNITYENGINE_INPUTSYSTEM_ACCELEROMETER_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1AAC07E0)
#define UNITYENGINE_INPUTSYSTEM_ACCELEROMETER_SET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1AAC0710)
#define UNITYENGINE_INPUTSYSTEM_ACCELEROMETER_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AAC0760)
#define UNITYENGINE_INPUTSYSTEM_ACCELEROMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAC08B0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int Accelerometer_TypeDefinitionIndex = 28491;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::Accelerometer**)Il2CppClass::FromTypeDefinitionIndex(Accelerometer_TypeDefinitionIndex)->GetStaticField(0x21890);
		}
