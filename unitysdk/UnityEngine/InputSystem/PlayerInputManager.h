...
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_ADD_ONPLAYERJOINED_OFFSET UNITYSDK_OFFSET(0x197A2B70)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_ADD_ONPLAYERLEFT_OFFSET UNITYSDK_OFFSET(0x197A2C70)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_CHECKIFPLAYERCANJOIN_OFFSET UNITYSDK_OFFSET(0x197A2E90)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_DISABLEJOINING_OFFSET UNITYSDK_OFFSET(0x197A26A0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_ENABLEJOINING_OFFSET UNITYSDK_OFFSET(0x197A27A0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_FIXEDNUMBEROFSPLITSCREENS_OFFSET UNITYSDK_OFFSET(0x197A25B0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x197A2D90)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_JOINACTION_OFFSET UNITYSDK_OFFSET(0x197A29C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_JOINBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x197A2650)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_JOININGENABLED_OFFSET UNITYSDK_OFFSET(0x197A2640)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_MAINTAINASPECTRATIOINSPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x197A25A0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_MAXPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x197A2630)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_MESSAGES_OFFSET UNITYSDK_OFFSET(0x197A3760)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_NOTIFICATIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x197A2A70)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_PLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x197A25D0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_PLAYERJOINEDEVENT_OFFSET UNITYSDK_OFFSET(0x197A2A90)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_PLAYERLEFTEVENT_OFFSET UNITYSDK_OFFSET(0x197A2B00)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_PLAYERPREFAB_OFFSET UNITYSDK_OFFSET(0x197A2D70)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_SPLITSCREENAREA_OFFSET UNITYSDK_OFFSET(0x197A25C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_GET_SPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x197A1B00)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_ISDEVICEUSABLEWITHPLAYERACTIONS_OFFSET UNITYSDK_OFFSET(0x197A38C0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_JOINPLAYERFROMACTIONIFNOTALREADYJOINED_OFFSET UNITYSDK_OFFSET(0x197A3510)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_JOINPLAYERFROMACTION_OFFSET UNITYSDK_OFFSET(0x197A3390)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_JOINPLAYERFROMUI_OFFSET UNITYSDK_OFFSET(0x197A2E20)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_JOINPLAYER_1_OFFSET UNITYSDK_OFFSET(0x197A36E0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_JOINPLAYER_OFFSET UNITYSDK_OFFSET(0x197A3490)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_NOTIFYPLAYERJOINED_OFFSET UNITYSDK_OFFSET(0x197A44A0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_NOTIFYPLAYERLEFT_OFFSET UNITYSDK_OFFSET(0x197A46D0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x197A4590)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x197A3DB0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_ONUNPAIREDDEVICEUSED_OFFSET UNITYSDK_OFFSET(0x197A37F0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_REMOVE_ONPLAYERJOINED_OFFSET UNITYSDK_OFFSET(0x197A2BF0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_REMOVE_ONPLAYERLEFT_OFFSET UNITYSDK_OFFSET(0x197A2CF0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x197A2DD0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_SET_JOINACTION_OFFSET UNITYSDK_OFFSET(0x197A29E0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_SET_JOINBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x197A2660)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_SET_NOTIFICATIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x197A2A80)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_SET_PLAYERPREFAB_OFFSET UNITYSDK_OFFSET(0x197A2D80)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_SET_SPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x197A1B10)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_UPDATESPLITSCREEN_OFFSET UNITYSDK_OFFSET(0x197A1DA0)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER_VALIDATEINPUTACTIONASSET_OFFSET UNITYSDK_OFFSET(0x197A2E10)
#define UNITYENGINE_INPUTSYSTEM_PLAYERINPUTMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x197A47C0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int PlayerInputManager_TypeDefinitionIndex = 27592;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::PlayerInputManager**)Il2CppClass::FromTypeDefinitionIndex(PlayerInputManager_TypeDefinitionIndex)->GetStaticField(0x206E0);
		}
