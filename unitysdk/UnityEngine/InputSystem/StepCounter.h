...
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1AB30220)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AB300E0)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_GET_STEPCOUNTER_OFFSET UNITYSDK_OFFSET(0x1AB300C0)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_MAKECURRENT_OFFSET UNITYSDK_OFFSET(0x1AB30160)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1AB301A0)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AB30120)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER_SET_STEPCOUNTER_OFFSET UNITYSDK_OFFSET(0x1AB300D0)
#define UNITYENGINE_INPUTSYSTEM_STEPCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB30270)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int StepCounter_TypeDefinitionIndex = 28502;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::StepCounter**)Il2CppClass::FromTypeDefinitionIndex(StepCounter_TypeDefinitionIndex)->GetStaticField(0x21C20);
		}
