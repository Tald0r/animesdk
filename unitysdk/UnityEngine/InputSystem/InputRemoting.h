...
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_BUILDLAYOUTNAMESPACE_OFFSET UNITYSDK_OFFSET(0x1A0FD6D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_FINDLOCALDEVICEID_OFFSET UNITYSDK_OFFSET(0x1A0FD770)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_FINDORCREATESENDERRECORD_OFFSET UNITYSDK_OFFSET(0x1A0FD670)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_GET_MANAGER_OFFSET UNITYSDK_OFFSET(0x1A0FD880)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_GET_SENDING_OFFSET UNITYSDK_OFFSET(0x1A0FBC20)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_REMOVEREMOTEDEVICES_OFFSET UNITYSDK_OFFSET(0x1A0FD890)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDALLDEVICES_OFFSET UNITYSDK_OFFSET(0x1A0FCC00)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDALLGENERATEDLAYOUTS_OFFSET UNITYSDK_OFFSET(0x1A0FCA50)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDDEVICECHANGE_OFFSET UNITYSDK_OFFSET(0x1A0FD320)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDDEVICE_OFFSET UNITYSDK_OFFSET(0x1A0FCFA0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x1A0FD280)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDINITIALMESSAGES_OFFSET UNITYSDK_OFFSET(0x1A0FBE50)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDLAYOUTCHANGE_OFFSET UNITYSDK_OFFSET(0x1A0FD570)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SENDLAYOUT_OFFSET UNITYSDK_OFFSET(0x1A0FCDE0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SEND_OFFSET UNITYSDK_OFFSET(0x1A0FCE40)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SET_SENDING_OFFSET UNITYSDK_OFFSET(0x1A0FBC30)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_STARTSENDING_OFFSET UNITYSDK_OFFSET(0x1A0FBC90)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_STOPSENDING_OFFSET UNITYSDK_OFFSET(0x1A0FBE70)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SUBSCRIBE_OFFSET UNITYSDK_OFFSET(0x1A0FC9C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SYSTEM_IOBSERVER_UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_MESSAGE__ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1A0FC9B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SYSTEM_IOBSERVER_UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_MESSAGE__ONERROR_OFFSET UNITYSDK_OFFSET(0x1A0FC9A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_SYSTEM_IOBSERVER_UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_MESSAGE__ONNEXT_OFFSET UNITYSDK_OFFSET(0x1A0FC010)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING_TRYGETDEVICEBYREMOTEID_OFFSET UNITYSDK_OFFSET(0x1A0FD7F0)
#define UNITYENGINE_INPUTSYSTEM_INPUTREMOTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0FBC40)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputRemoting_TypeDefinitionIndex = 27527;

	class InputRemoting : public ::System::Object
	{
	public:
		::Il2CppArray<::UnityEngine::InputSystem::InputRemoting_RemoteSender>* m_Senders; // 0x10
		::Il2CppArray<::UnityEngine::InputSystem::InputRemoting_Subscriber*>* m_Subscribers; // 0x18
		::UnityEngine::InputSystem::InputManager* m_LocalManager; // 0x20
