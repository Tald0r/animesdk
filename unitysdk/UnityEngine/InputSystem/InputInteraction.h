...
#define UNITYENGINE_INPUTSYSTEM_INPUTINTERACTION_GETDISPLAYNAME_1_OFFSET UNITYSDK_OFFSET(0x1A0FB5B0)
#define UNITYENGINE_INPUTSYSTEM_INPUTINTERACTION_GETDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1A0FB520)
#define UNITYENGINE_INPUTSYSTEM_INPUTINTERACTION_GETVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1A0FB490)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputInteraction_TypeDefinitionIndex = 27411;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::Utilities::TypeTable*)Il2CppClass::FromTypeDefinitionIndex(InputInteraction_TypeDefinitionIndex)->GetStaticField(0x20280);
		}
