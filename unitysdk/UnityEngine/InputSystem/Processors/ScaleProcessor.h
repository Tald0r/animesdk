...
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_SCALEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x19ECBFE0)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_SCALEPROCESSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19ECBFF0)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_SCALEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19ECC070)

namespace UnityEngine::InputSystem::Processors
{
	inline static constexpr unsigned int ScaleProcessor_TypeDefinitionIndex = 27856;
