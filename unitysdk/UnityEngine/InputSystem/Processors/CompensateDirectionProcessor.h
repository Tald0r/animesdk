...
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_COMPENSATEDIRECTIONPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x1A58C2D0)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_COMPENSATEDIRECTIONPROCESSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A58C550)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_COMPENSATEDIRECTIONPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A58C590)

namespace UnityEngine::InputSystem::Processors
{
	inline static constexpr unsigned int CompensateDirectionProcessor_TypeDefinitionIndex = 27848;
