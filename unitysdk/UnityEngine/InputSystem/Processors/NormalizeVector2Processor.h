...
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_NORMALIZEVECTOR2PROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x1AB2FFE0)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_NORMALIZEVECTOR2PROCESSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AB30060)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_NORMALIZEVECTOR2PROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB300A0)

namespace UnityEngine::InputSystem::Processors
{
	inline static constexpr unsigned int NormalizeVector2Processor_TypeDefinitionIndex = 28794;
