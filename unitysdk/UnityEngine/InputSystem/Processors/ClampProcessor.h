...
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_CLAMPPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x1A0FEF20)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_CLAMPPROCESSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0FEF40)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_CLAMPPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0FEFF0)

namespace UnityEngine::InputSystem::Processors
{
	inline static constexpr unsigned int ClampProcessor_TypeDefinitionIndex = 27847;
