...
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_STICKDEADZONEPROCESSOR_GETDEADZONEADJUSTEDVALUE_OFFSET UNITYSDK_OFFSET(0x1A57CA20)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_STICKDEADZONEPROCESSOR_GET_MAXORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1A57C900)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_STICKDEADZONEPROCESSOR_GET_MINORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1A57C890)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_STICKDEADZONEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x1A57C970)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_STICKDEADZONEPROCESSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A57CB90)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_STICKDEADZONEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A57CD30)

namespace UnityEngine::InputSystem::Processors
{
	inline static constexpr unsigned int StickDeadzoneProcessor_TypeDefinitionIndex = 28799;
