...
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_STICKDEADZONEPROCESSOR_GETDEADZONEADJUSTEDVALUE_OFFSET UNITYSDK_OFFSET(0x19F6BC00)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_STICKDEADZONEPROCESSOR_GET_MAXORDEFAULT_OFFSET UNITYSDK_OFFSET(0x19F6BAD0)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_STICKDEADZONEPROCESSOR_GET_MINORDEFAULT_OFFSET UNITYSDK_OFFSET(0x19F6BA50)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_STICKDEADZONEPROCESSOR_PROCESS_OFFSET UNITYSDK_OFFSET(0x19F6BB50)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_STICKDEADZONEPROCESSOR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19F6BD70)
#define UNITYENGINE_INPUTSYSTEM_PROCESSORS_STICKDEADZONEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19F6BF10)

namespace UnityEngine::InputSystem::Processors
{
	inline static constexpr unsigned int StickDeadzoneProcessor_TypeDefinitionIndex = 27859;
