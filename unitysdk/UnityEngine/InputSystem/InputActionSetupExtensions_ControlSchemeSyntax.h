...
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CONTROLSCHEMESYNTAX_ADDDEVICEENTRY_OFFSET UNITYSDK_OFFSET(0x98C800)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CONTROLSCHEMESYNTAX_DONE_OFFSET UNITYSDK_OFFSET(0x98C7E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CONTROLSCHEMESYNTAX_ORWITHOPTIONALDEVICE_OFFSET UNITYSDK_OFFSET(0x98C7A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CONTROLSCHEMESYNTAX_ORWITHREQUIREDDEVICE_OFFSET UNITYSDK_OFFSET(0x98C760)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CONTROLSCHEMESYNTAX_WITHBINDINGGROUP_OFFSET UNITYSDK_OFFSET(0x98C6C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CONTROLSCHEMESYNTAX_WITHOPTIONALDEVICE_OFFSET UNITYSDK_OFFSET(0x98C720)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CONTROLSCHEMESYNTAX_WITHREQUIREDDEVICE_OFFSET UNITYSDK_OFFSET(0x98C6E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CONTROLSCHEMESYNTAX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x98C680)
#define UNITYENGINE_INPUTSYSTEM_INPUTACTIONSETUPEXTENSIONS_CONTROLSCHEMESYNTAX__CTOR_OFFSET UNITYSDK_OFFSET(0x98C660)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputActionSetupExtensions_ControlSchemeSyntax_TypeDefinitionIndex = 28385;
