...
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1B153080)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1B153240)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_GET_VALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1B153070)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1B153060)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x1B153260)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_READVALUE_OFFSET UNITYSDK_OFFSET(0x1B153150)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B153330)

namespace UnityEngine::InputSystem::Composites
{
	inline static constexpr unsigned int TwoModifiersComposite_TypeDefinitionIndex = 28922;
