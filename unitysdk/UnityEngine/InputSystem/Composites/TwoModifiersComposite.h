...
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1AB0B4D0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1AB0B690)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_GET_VALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x1AB0B4C0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x1AB0B4B0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x1AB0B6B0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE_READVALUE_OFFSET UNITYSDK_OFFSET(0x1AB0B5A0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_TWOMODIFIERSCOMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB0B780)

namespace UnityEngine::InputSystem::Composites
{
	inline static constexpr unsigned int TwoModifiersComposite_TypeDefinitionIndex = 27982;
