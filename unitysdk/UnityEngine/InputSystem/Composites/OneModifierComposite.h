...
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_DETERMINEVALUETYPEANDSIZE_OFFSET UNITYSDK_OFFSET(0x18BE27C0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x18BE2680)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x18BE27A0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_GET_VALUESIZEINBYTES_OFFSET UNITYSDK_OFFSET(0x18BE2670)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x18BE2660)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_READVALUEASOBJECT_OFFSET UNITYSDK_OFFSET(0x18BE2C40)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE_READVALUE_OFFSET UNITYSDK_OFFSET(0x18BE2700)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_ONEMODIFIERCOMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x18BE2CC0)

namespace UnityEngine::InputSystem::Composites
{
	inline static constexpr unsigned int OneModifierComposite_TypeDefinitionIndex = 27981;
