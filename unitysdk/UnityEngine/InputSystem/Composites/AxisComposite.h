...
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_AXISCOMPOSITE_EVALUATEMAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1A3E5500)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_AXISCOMPOSITE_GET_MIDPOINT_OFFSET UNITYSDK_OFFSET(0x1A3E53C0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_AXISCOMPOSITE_READVALUE_OFFSET UNITYSDK_OFFSET(0x1A3E53E0)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_AXISCOMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E55A0)

namespace UnityEngine::InputSystem::Composites
{
	inline static constexpr unsigned int AxisComposite_TypeDefinitionIndex = 27977;

	class AxisComposite : public ::UnityEngine::InputSystem::InputBindingComposite_1<::System::Single>
	{
	public:
		::UnityEngine::InputSystem::Composites::AxisComposite_WhichSideWins whichSideWins; // 0x10
		::System::Single maxValue; // 0x14
		::System::Int32 positive; // 0x18
		::System::Single minValue; // 0x1C
		::System::Int32 negative; // 0x20
