...
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_VECTOR3COMPOSITE_READVALUE_OFFSET UNITYSDK_OFFSET(0x19D9AF90)
#define UNITYENGINE_INPUTSYSTEM_COMPOSITES_VECTOR3COMPOSITE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D9B440)

namespace UnityEngine::InputSystem::Composites
{
	inline static constexpr unsigned int Vector3Composite_TypeDefinitionIndex = 27985;
