...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8FEF40)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_EQUALS_OFFSET UNITYSDK_OFFSET(0x8FEEB0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8FEF50)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_GET_CONTROLPATH_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_GET_ISAND_OFFSET UNITYSDK_OFFSET(0x8FEE70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_GET_ISOPTIONAL_OFFSET UNITYSDK_OFFSET(0x8A1C50)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_GET_ISOR_OFFSET UNITYSDK_OFFSET(0x8A1C70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19ECBA70)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19ECBB00)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_SET_CONTROLPATH_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_SET_ISAND_OFFSET UNITYSDK_OFFSET(0x8FEE80)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_SET_ISOPTIONAL_OFFSET UNITYSDK_OFFSET(0x8A1C60)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_SET_ISOR_OFFSET UNITYSDK_OFFSET(0x8A1C80)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8FEEA0)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlScheme_DeviceRequirement_TypeDefinitionIndex = 27477;
