...
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x929930)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9298A0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x929940)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_GET_CONTROLPATH_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_GET_ISAND_OFFSET UNITYSDK_OFFSET(0x929860)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_GET_ISOPTIONAL_OFFSET UNITYSDK_OFFSET(0x8CCCF0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_GET_ISOR_OFFSET UNITYSDK_OFFSET(0x8CCD10)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A4CB030)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A4CB0C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_SET_CONTROLPATH_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_SET_ISAND_OFFSET UNITYSDK_OFFSET(0x929870)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_SET_ISOPTIONAL_OFFSET UNITYSDK_OFFSET(0x8CCD00)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_SET_ISOR_OFFSET UNITYSDK_OFFSET(0x8CCD20)
#define UNITYENGINE_INPUTSYSTEM_INPUTCONTROLSCHEME_DEVICEREQUIREMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x929890)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputControlScheme_DeviceRequirement_TypeDefinitionIndex = 28417;
