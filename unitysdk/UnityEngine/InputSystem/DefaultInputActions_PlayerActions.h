...
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_PLAYERACTIONS_DISABLE_OFFSET UNITYSDK_OFFSET(0x921870)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_PLAYERACTIONS_ENABLE_OFFSET UNITYSDK_OFFSET(0x9217F0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_PLAYERACTIONS_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x9218C0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_PLAYERACTIONS_GET_FIRE_OFFSET UNITYSDK_OFFSET(0x9217B0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_PLAYERACTIONS_GET_LOOK_OFFSET UNITYSDK_OFFSET(0x921790)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_PLAYERACTIONS_GET_MOVE_OFFSET UNITYSDK_OFFSET(0x921770)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_PLAYERACTIONS_GET_OFFSET UNITYSDK_OFFSET(0x9217D0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_PLAYERACTIONS_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A584610)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_PLAYERACTIONS_SETCALLBACKS_OFFSET UNITYSDK_OFFSET(0x9218F0)
#define UNITYENGINE_INPUTSYSTEM_DEFAULTINPUTACTIONS_PLAYERACTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x2C3980)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int DefaultInputActions_PlayerActions_TypeDefinitionIndex = 27582;
