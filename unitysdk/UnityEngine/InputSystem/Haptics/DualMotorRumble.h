...
#define UNITYENGINE_INPUTSYSTEM_HAPTICS_DUALMOTORRUMBLE_GET_HIGHFREQUENCYMOTORSPEED_OFFSET UNITYSDK_OFFSET(0x2F60C0)
#define UNITYENGINE_INPUTSYSTEM_HAPTICS_DUALMOTORRUMBLE_GET_ISRUMBLING_OFFSET UNITYSDK_OFFSET(0x9547D0)
#define UNITYENGINE_INPUTSYSTEM_HAPTICS_DUALMOTORRUMBLE_GET_LOWFREQUENCYMOTORSPEED_OFFSET UNITYSDK_OFFSET(0x2F60A0)
#define UNITYENGINE_INPUTSYSTEM_HAPTICS_DUALMOTORRUMBLE_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x954840)
#define UNITYENGINE_INPUTSYSTEM_HAPTICS_DUALMOTORRUMBLE_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x954860)
#define UNITYENGINE_INPUTSYSTEM_HAPTICS_DUALMOTORRUMBLE_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x954850)
#define UNITYENGINE_INPUTSYSTEM_HAPTICS_DUALMOTORRUMBLE_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x954870)
#define UNITYENGINE_INPUTSYSTEM_HAPTICS_DUALMOTORRUMBLE_SET_HIGHFREQUENCYMOTORSPEED_OFFSET UNITYSDK_OFFSET(0x2F60D0)
#define UNITYENGINE_INPUTSYSTEM_HAPTICS_DUALMOTORRUMBLE_SET_LOWFREQUENCYMOTORSPEED_OFFSET UNITYSDK_OFFSET(0x2F60B0)

namespace UnityEngine::InputSystem::Haptics
{
	inline static constexpr unsigned int DualMotorRumble_TypeDefinitionIndex = 28667;
