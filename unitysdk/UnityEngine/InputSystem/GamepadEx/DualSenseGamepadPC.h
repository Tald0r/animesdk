...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ADDDEVICETOLIST_OFFSET UNITYSDK_OFFSET(0x1ABC1A80)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_CONVERACCEL_OFFSET UNITYSDK_OFFSET(0x1ABC3C90)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_CONVERGYRO2RADPERSECOND_OFFSET UNITYSDK_OFFSET(0x1ABC3C00)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_CUSTOMMERGESENSOR_OFFSET UNITYSDK_OFFSET(0x1ABC36C0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1ABC1F30)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GETBYSLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1ABC16E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1ABC1330)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_ALL_OFFSET UNITYSDK_OFFSET(0x1ABC1390)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1ABC1370)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_LIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1ABC1410)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1ABC1350)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_PS5USERID_OFFSET UNITYSDK_OFFSET(0x1ABC1650)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_GET_SLOTINDEX_OFFSET UNITYSDK_OFFSET(0x1ABC1580)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_MERGEFORWARDINNER_OFFSET UNITYSDK_OFFSET(0x1ABC42F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_MERGESENSOR_OFFSET UNITYSDK_OFFSET(0x1ABC4370)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ONADDED_OFFSET UNITYSDK_OFFSET(0x1ABC19F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABC4520)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1ABC1C80)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1ABC4560)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1ABC2150)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_PREPROCESSEVENTINNER_OFFSET UNITYSDK_OFFSET(0x1ABC3E00)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_PS4COLORIDTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1ABC14D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_REMOVEDEVICEFROMLIST_OFFSET UNITYSDK_OFFSET(0x1ABC1CF0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x1ABC2610)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1ABC28F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SETLIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1ABC2D20)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x1ABC33F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SETTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x1ABC3000)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1ABC1340)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1ABC1380)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_SET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1ABC1360)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_GETSTATEOFFSETFOREVENT_OFFSET UNITYSDK_OFFSET(0x1ABC4780)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABC46D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1ABC4730)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC_UPDATEPADSETTINGSIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1ABC1610)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABC4820)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC47E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1ABC4870)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_MERGEFORWARDINNER_OFFSET UNITYSDK_OFFSET(0x1ABC4880)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_ONADDED_OFFSET UNITYSDK_OFFSET(0x1ABC4890)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1ABC48F0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_PAUSEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1ABC4930)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_PREPROCESSEVENTINNER_OFFSET UNITYSDK_OFFSET(0x1ABC4980)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_RESETHAPTICS_OFFSET UNITYSDK_OFFSET(0x1ABC4990)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_RESUMEHAPTICS_OFFSET UNITYSDK_OFFSET(0x1ABC49E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_SETLIGHTBARCOLOR_OFFSET UNITYSDK_OFFSET(0x1ABC4A30)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEGAMEPADPC___BASE_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x1ABC4A90)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int DualSenseGamepadPC_TypeDefinitionIndex = 36895;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::InputSystem::GamepadEx::DualSenseGamepadPC*>**)Il2CppClass::FromTypeDefinitionIndex(DualSenseGamepadPC_TypeDefinitionIndex)->GetStaticField(0x26DF0);
		}
		static ::System::Boolean* StaticGet_UseOld_Haptics_Motor_LightBarColor()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(DualSenseGamepadPC_TypeDefinitionIndex)->GetStaticField(0x8E10);
		}
		...
		::System::Int32 m_DefaultColorId; // 0x288
		::System::Nullable_1<::UnityEngine::Color> m_LightBarColor; // 0x28C
		::System::Nullable_1<::System::Single> m_LargeMotor; // 0x2A0
		::System::Int32 m_SlotId; // 0x2A8
		::System::Nullable_1<::System::Single> m_SmallMotor; // 0x2AC
		::System::Int32 _lastFrameCount; // 0x2B4
