...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_CONVERACCEL_OFFSET UNITYSDK_OFFSET(0x1A5F8210)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_CONVERGYRO2RADPERSECOND_OFFSET UNITYSDK_OFFSET(0x1A5F8180)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_CUSTOMMERGESENSOR_OFFSET UNITYSDK_OFFSET(0x1A5F7B50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1A5F7AA0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1A5F7A20)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1A5F7A60)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ATTITUDEV2_OFFSET UNITYSDK_OFFSET(0x1A5F7A80)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A5F7A40)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1A5F82A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1A5F82E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1A5F7A30)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1A5F7A70)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ATTITUDEV2_OFFSET UNITYSDK_OFFSET(0x1A5F7A90)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A5F7A50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_GETSTATEOFFSETFOREVENT_OFFSET UNITYSDK_OFFSET(0x1A5F84B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1A5F8400)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1A5F8460)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F8510)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC___BASE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1A5F8540)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int DualShock4GamepadPC_TypeDefinitionIndex = 35873;
	...
	public:
		...
		::UnityEngine::Quaternion _AttitudeV2_k__BackingField; // 0x28C
		::System::Int32 _angularVelocityV2; // 0x29C
