...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_CONVERACCEL_OFFSET UNITYSDK_OFFSET(0x1ABC5810)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_CONVERGYRO2RADPERSECOND_OFFSET UNITYSDK_OFFSET(0x1ABC5780)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_CUSTOMMERGESENSOR_OFFSET UNITYSDK_OFFSET(0x1ABC5150)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1ABC50A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1ABC5020)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1ABC5060)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ATTITUDEV2_OFFSET UNITYSDK_OFFSET(0x1ABC5080)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_GET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1ABC5040)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABC58A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1ABC58E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1ABC5030)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1ABC5070)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ATTITUDEV2_OFFSET UNITYSDK_OFFSET(0x1ABC5090)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_SET_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1ABC5050)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_GETSTATEOFFSETFOREVENT_OFFSET UNITYSDK_OFFSET(0x1ABC5AB0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONNEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABC5A00)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC_UNITYENGINE_INPUTSYSTEM_LOWLEVEL_IINPUTSTATECALLBACKRECEIVER_ONSTATEEVENT_OFFSET UNITYSDK_OFFSET(0x1ABC5A60)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC5B10)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSHOCK4GAMEPADPC___BASE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1ABC5B40)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int DualShock4GamepadPC_TypeDefinitionIndex = 36893;
