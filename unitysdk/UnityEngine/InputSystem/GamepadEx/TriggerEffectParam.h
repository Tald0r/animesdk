...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_TRIGGEREFFECTPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x1A5F9F80)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_TRIGGEREFFECTPARAM_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x924ED0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_TRIGGEREFFECTPARAM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A5F9F20)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_TRIGGEREFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x924EE0)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int TriggerEffectParam_TypeDefinitionIndex = 35889;
