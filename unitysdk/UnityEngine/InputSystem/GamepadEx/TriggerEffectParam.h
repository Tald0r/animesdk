...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_TRIGGEREFFECTPARAM_CREATE_OFFSET UNITYSDK_OFFSET(0x1ABC75A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_TRIGGEREFFECTPARAM_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x953800)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_TRIGGEREFFECTPARAM_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1ABC7540)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_TRIGGEREFFECTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x953810)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int TriggerEffectParam_TypeDefinitionIndex = 36909;
