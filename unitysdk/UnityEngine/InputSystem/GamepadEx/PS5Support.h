...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5SUPPORT_INITIALIZATION_OFFSET UNITYSDK_OFFSET(0x1A5F9960)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5SUPPORT_INITIALIZEINPLAYER_OFFSET UNITYSDK_OFFSET(0x1A5F97D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5SUPPORT_RUNINITIALIZEINPLAYER_OFFSET UNITYSDK_OFFSET(0x1A5F9850)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5SUPPORT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5F9700)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int PS5Support_TypeDefinitionIndex = 35893;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(PS5Support_TypeDefinitionIndex)->GetStaticField(0x8AE0);
		}
