...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x953380)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1ABC6270)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0ID_OFFSET UNITYSDK_OFFSET(0x953480)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0PRESSED_OFFSET UNITYSDK_OFFSET(0x9533E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0X_OFFSET UNITYSDK_OFFSET(0x953490)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0Y_OFFSET UNITYSDK_OFFSET(0x953530)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1ID_OFFSET UNITYSDK_OFFSET(0x953670)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1PRESSED_OFFSET UNITYSDK_OFFSET(0x9535D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1X_OFFSET UNITYSDK_OFFSET(0x953680)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1Y_OFFSET UNITYSDK_OFFSET(0x953720)

namespace UnityEngine::InputSystem::GamepadEx::LowLevel
{
	inline static constexpr unsigned int DualSenseHIDInputReportV2_TypeDefinitionIndex = 36914;
