...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_FORMAT_1_OFFSET UNITYSDK_OFFSET(0x924A50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_FORMAT_OFFSET UNITYSDK_OFFSET(0x1A5F8C60)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0ID_OFFSET UNITYSDK_OFFSET(0x924B50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0PRESSED_OFFSET UNITYSDK_OFFSET(0x924AB0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0X_OFFSET UNITYSDK_OFFSET(0x924B60)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH0Y_OFFSET UNITYSDK_OFFSET(0x924C00)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1ID_OFFSET UNITYSDK_OFFSET(0x924D40)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1PRESSED_OFFSET UNITYSDK_OFFSET(0x924CA0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1X_OFFSET UNITYSDK_OFFSET(0x924D50)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_LOWLEVEL_DUALSENSEHIDINPUTREPORTV2_GET_TOUCH1Y_OFFSET UNITYSDK_OFFSET(0x924DF0)

namespace UnityEngine::InputSystem::GamepadEx::LowLevel
{
	inline static constexpr unsigned int DualSenseHIDInputReportV2_TypeDefinitionIndex = 35894;
