...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ABC74A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ABC7530)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ABC5CB0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC7480)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int ProcessGyroInput_TypeDefinitionIndex = 36911;
