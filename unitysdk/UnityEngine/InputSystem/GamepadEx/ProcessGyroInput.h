...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A5F9E80)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A5F9F10)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A5F86B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PROCESSGYROINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F9E70)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int ProcessGyroInput_TypeDefinitionIndex = 35891;
