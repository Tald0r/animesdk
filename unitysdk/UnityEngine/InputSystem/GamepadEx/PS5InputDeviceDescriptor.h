...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5INPUTDEVICEDESCRIPTOR_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1A5F4AB0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5INPUTDEVICEDESCRIPTOR_TOJSON_OFFSET UNITYSDK_OFFSET(0x1A5F96A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5INPUTDEVICEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5F96F0)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int PS5InputDeviceDescriptor_TypeDefinitionIndex = 35890;
