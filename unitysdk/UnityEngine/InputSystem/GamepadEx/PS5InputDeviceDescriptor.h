...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5INPUTDEVICEDESCRIPTOR_FROMJSON_OFFSET UNITYSDK_OFFSET(0x1ABC20E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5INPUTDEVICEDESCRIPTOR_TOJSON_OFFSET UNITYSDK_OFFSET(0x1ABC6CB0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_PS5INPUTDEVICEDESCRIPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC6D00)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int PS5InputDeviceDescriptor_TypeDefinitionIndex = 36910;
