...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x1A5F4DA0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x8D52E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A5F7840)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_RESETCOLOR_OFFSET UNITYSDK_OFFSET(0x9249B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x924870)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x9246B0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETTRIGGEREFFECT_1_OFFSET UNITYSDK_OFFSET(0x924800)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x9247C0)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int DualSenseHIDOutputReport_TypeDefinitionIndex = 35879;
