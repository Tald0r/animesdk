...
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_CREATE_OFFSET UNITYSDK_OFFSET(0x1ABC23D0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_GET_TYPESTATIC_OFFSET UNITYSDK_OFFSET(0x9077E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1ABC4E40)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_RESETCOLOR_OFFSET UNITYSDK_OFFSET(0x9532E0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x9531A0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETMOTORSPEEDS_OFFSET UNITYSDK_OFFSET(0x952FE0)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETTRIGGEREFFECT_1_OFFSET UNITYSDK_OFFSET(0x953130)
#define UNITYENGINE_INPUTSYSTEM_GAMEPADEX_DUALSENSEHIDOUTPUTREPORT_SETTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x9530F0)

namespace UnityEngine::InputSystem::GamepadEx
{
	inline static constexpr unsigned int DualSenseHIDOutputReport_TypeDefinitionIndex = 36899;
