...
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B1543E0)
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISENDEDORCANCELED_OFFSET UNITYSDK_OFFSET(0x1B1543D0)
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISINPROGRESS_OFFSET UNITYSDK_OFFSET(0x1B1543C0)
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISMODIFIERKEY_OFFSET UNITYSDK_OFFSET(0x1B154400)
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISTEXTINPUTKEY_OFFSET UNITYSDK_OFFSET(0x1B154410)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputExtensions_TypeDefinitionIndex = 28506;
