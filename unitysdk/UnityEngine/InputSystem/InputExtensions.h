...
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1AB0C830)
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISENDEDORCANCELED_OFFSET UNITYSDK_OFFSET(0x1AB0C820)
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISINPROGRESS_OFFSET UNITYSDK_OFFSET(0x1AB0C810)
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISMODIFIERKEY_OFFSET UNITYSDK_OFFSET(0x1AB0C850)
#define UNITYENGINE_INPUTSYSTEM_INPUTEXTENSIONS_ISTEXTINPUTKEY_OFFSET UNITYSDK_OFFSET(0x1AB0C860)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int InputExtensions_TypeDefinitionIndex = 27566;
