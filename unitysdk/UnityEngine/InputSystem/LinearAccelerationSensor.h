...
#define UNITYENGINE_INPUTSYSTEM_LINEARACCELERATIONSENSOR_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1AC3C530)
#define UNITYENGINE_INPUTSYSTEM_LINEARACCELERATIONSENSOR_GET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1AC3C3D0)
#define UNITYENGINE_INPUTSYSTEM_LINEARACCELERATIONSENSOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC3C3F0)
#define UNITYENGINE_INPUTSYSTEM_LINEARACCELERATIONSENSOR_MAKECURRENT_OFFSET UNITYSDK_OFFSET(0x1AC3C470)
#define UNITYENGINE_INPUTSYSTEM_LINEARACCELERATIONSENSOR_ONREMOVED_OFFSET UNITYSDK_OFFSET(0x1AC3C4B0)
#define UNITYENGINE_INPUTSYSTEM_LINEARACCELERATIONSENSOR_SET_ACCELERATION_OFFSET UNITYSDK_OFFSET(0x1AC3C3E0)
#define UNITYENGINE_INPUTSYSTEM_LINEARACCELERATIONSENSOR_SET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC3C430)
#define UNITYENGINE_INPUTSYSTEM_LINEARACCELERATIONSENSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC3C580)

namespace UnityEngine::InputSystem
{
	inline static constexpr unsigned int LinearAccelerationSensor_TypeDefinitionIndex = 28495;
	...
	public:
		...
		{
			return (::UnityEngine::InputSystem::LinearAccelerationSensor**)Il2CppClass::FromTypeDefinitionIndex(LinearAccelerationSensor_TypeDefinitionIndex)->GetStaticField(0x21940);
		}
