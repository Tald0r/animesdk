...
#define UNITYENGINE_COMPONENTEXTENSIONS_FINDCHILDCONTAINSNAME_1_OFFSET UNITYSDK_OFFSET(0x1817F3E0)
#define UNITYENGINE_COMPONENTEXTENSIONS_FINDCHILDCONTAINSNAME_OFFSET UNITYSDK_OFFSET(0x1817EF80)
#define UNITYENGINE_COMPONENTEXTENSIONS_FINDCHILDWITHNAME_1_OFFSET UNITYSDK_OFFSET(0x1817EB30)
#define UNITYENGINE_COMPONENTEXTENSIONS_FINDCHILDWITHNAME_OFFSET UNITYSDK_OFFSET(0x1817E6D0)
#define UNITYENGINE_COMPONENTEXTENSIONS_POSTORDERTRAVERSETRANSFORMEARLYRETURN_OFFSET UNITYSDK_OFFSET(0x1817FBA0)
#define UNITYENGINE_COMPONENTEXTENSIONS_POSTORDERTRAVERSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1817F850)
#define UNITYENGINE_COMPONENTEXTENSIONS_PREORDERTRAVERSETRANSFORMEARLYRETURN_OFFSET UNITYSDK_OFFSET(0x181802D0)
#define UNITYENGINE_COMPONENTEXTENSIONS_PREORDERTRAVERSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1817FF80)
#define UNITYENGINE_COMPONENTEXTENSIONS_SAFEFIND_OFFSET UNITYSDK_OFFSET(0x1817E4F0)

namespace UnityEngine
{
	inline static constexpr unsigned int ComponentExtensions_TypeDefinitionIndex = 51488;
