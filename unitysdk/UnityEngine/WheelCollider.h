...
#define UNITYENGINE_WHEELCOLLIDER_GETWORLDPOSE_OFFSET UNITYSDK_OFFSET(0x1B776580)
#define UNITYENGINE_WHEELCOLLIDER_SET_MOTORTORQUE_OFFSET UNITYSDK_OFFSET(0x1B776560)
#define UNITYENGINE_WHEELCOLLIDER_SET_STEERANGLE_OFFSET UNITYSDK_OFFSET(0x1B776570)
#define UNITYENGINE_WHEELCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B776590)

namespace UnityEngine
{
	inline static constexpr unsigned int WheelCollider_TypeDefinitionIndex = 30428;
