...
#define UNITYENGINE_WHEELCOLLIDER_GETWORLDPOSE_OFFSET UNITYSDK_OFFSET(0x1B157430)
#define UNITYENGINE_WHEELCOLLIDER_SET_MOTORTORQUE_OFFSET UNITYSDK_OFFSET(0x1B157410)
#define UNITYENGINE_WHEELCOLLIDER_SET_STEERANGLE_OFFSET UNITYSDK_OFFSET(0x1B157420)
#define UNITYENGINE_WHEELCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B157440)

namespace UnityEngine
{
	inline static constexpr unsigned int WheelCollider_TypeDefinitionIndex = 29475;
