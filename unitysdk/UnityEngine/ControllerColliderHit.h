...
#define UNITYENGINE_CONTROLLERCOLLIDERHIT_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1ACF98F0)
#define UNITYENGINE_CONTROLLERCOLLIDERHIT_GET_POINT_OFFSET UNITYSDK_OFFSET(0x1ACF9910)
#define UNITYENGINE_CONTROLLERCOLLIDERHIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACF9930)
