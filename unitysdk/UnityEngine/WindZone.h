...
#define UNITYENGINE_WINDZONE_GET_WINDMAIN_OFFSET UNITYSDK_OFFSET(0x1B7765C0)
#define UNITYENGINE_WINDZONE_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1B7765B0)
#define UNITYENGINE_WINDZONE_SET_WINDMAIN_OFFSET UNITYSDK_OFFSET(0x1B7765D0)
#define UNITYENGINE_WINDZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7765E0)

namespace UnityEngine
{
	inline static constexpr unsigned int WindZone_TypeDefinitionIndex = 24632;
