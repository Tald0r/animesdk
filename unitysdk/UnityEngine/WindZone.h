...
#define UNITYENGINE_WINDZONE_GET_WINDMAIN_OFFSET UNITYSDK_OFFSET(0x1B157470)
#define UNITYENGINE_WINDZONE_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1B157460)
#define UNITYENGINE_WINDZONE_SET_WINDMAIN_OFFSET UNITYSDK_OFFSET(0x1B157480)
#define UNITYENGINE_WINDZONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B157490)

namespace UnityEngine
{
	inline static constexpr unsigned int WindZone_TypeDefinitionIndex = 23949;
