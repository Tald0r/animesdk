...
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERSCRIPT_CREATE_OFFSET UNITYSDK_OFFSET(0x1B47FCF0)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERSCRIPT_INTERNALCREATESCRIPT_OFFSET UNITYSDK_OFFSET(0x1B47FD00)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B47FD20)
