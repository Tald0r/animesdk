...
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERSCRIPT_CREATE_OFFSET UNITYSDK_OFFSET(0x1AE66820)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERSCRIPT_INTERNALCREATESCRIPT_OFFSET UNITYSDK_OFFSET(0x1AE66830)
#define UNITYENGINE_NETWORKING_DOWNLOADHANDLERSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE66850)

namespace UnityEngine::Networking
{
	inline static constexpr unsigned int DownloadHandlerScript_TypeDefinitionIndex = 6625;
