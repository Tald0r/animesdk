...
#define UNITYENGINE_NETWORKING_UNITYWEBREQUESTASYNCOPERATION_GET_WEBREQUEST_OFFSET UNITYSDK_OFFSET(0x1AE6A440)
#define UNITYENGINE_NETWORKING_UNITYWEBREQUESTASYNCOPERATION_SET_WEBREQUEST_OFFSET UNITYSDK_OFFSET(0x1AE6A450)
#define UNITYENGINE_NETWORKING_UNITYWEBREQUESTASYNCOPERATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE6A460)

namespace UnityEngine::Networking
{
	inline static constexpr unsigned int UnityWebRequestAsyncOperation_TypeDefinitionIndex = 6618;
