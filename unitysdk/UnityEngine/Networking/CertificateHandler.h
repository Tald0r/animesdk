...
#define UNITYENGINE_NETWORKING_CERTIFICATEHANDLER_CREATE_OFFSET UNITYSDK_OFFSET(0x1B47F640)
#define UNITYENGINE_NETWORKING_CERTIFICATEHANDLER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B47F700)
#define UNITYENGINE_NETWORKING_CERTIFICATEHANDLER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B47F680)
#define UNITYENGINE_NETWORKING_CERTIFICATEHANDLER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B47F650)
#define UNITYENGINE_NETWORKING_CERTIFICATEHANDLER_VALIDATECERTIFICATENATIVE_OFFSET UNITYSDK_OFFSET(0x1B47F740)
#define UNITYENGINE_NETWORKING_CERTIFICATEHANDLER_VALIDATECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1B47F730)
#define UNITYENGINE_NETWORKING_CERTIFICATEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B47F660)
