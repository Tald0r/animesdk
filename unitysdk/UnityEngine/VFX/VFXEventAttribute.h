...
#define UNITYENGINE_VFX_VFXEVENTATTRIBUTE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B150D90)
#define UNITYENGINE_VFX_VFXEVENTATTRIBUTE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B150D00)
#define UNITYENGINE_VFX_VFXEVENTATTRIBUTE_INTERNAL_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B150CF0)
#define UNITYENGINE_VFX_VFXEVENTATTRIBUTE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B150CB0)
#define UNITYENGINE_VFX_VFXEVENTATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B150C90)
#define UNITYENGINE_VFX_VFXEVENTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B150C80)

namespace UnityEngine::VFX
{
	inline static constexpr unsigned int VFXEventAttribute_TypeDefinitionIndex = 80460;
