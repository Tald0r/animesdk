...
#define UNITYENGINE_UI_GRAPHICCAST_ISRAYCASTLOCATIONVALID_OFFSET UNITYSDK_OFFSET(0x1853C200)
#define UNITYENGINE_UI_GRAPHICCAST_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1853C180)
#define UNITYENGINE_UI_GRAPHICCAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1853C790)
#define UNITYENGINE_UI_GRAPHICCAST___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1853C840)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int GraphicCast_TypeDefinitionIndex = 74756;
