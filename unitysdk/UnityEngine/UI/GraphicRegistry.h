...
#define UNITYENGINE_UI_GRAPHICREGISTRY_CLEARALLRAYCASTTARGETCACHEDATA_OFFSET UNITYSDK_OFFSET(0x1A9F76D0)
#define UNITYENGINE_UI_GRAPHICREGISTRY_GETALLRAYCASTTARGETGRAPHICS_OFFSET UNITYSDK_OFFSET(0x1A9F1270)
#define UNITYENGINE_UI_GRAPHICREGISTRY_GETGRAPHICSFORCANVAS_OFFSET UNITYSDK_OFFSET(0x1A9F8D10)
#define UNITYENGINE_UI_GRAPHICREGISTRY_GETRAYCASTTARGETCACHEDATA_OFFSET UNITYSDK_OFFSET(0x1A9F05A0)
#define UNITYENGINE_UI_GRAPHICREGISTRY_GETRAYCASTTARGETGRAPHICSFORCANVAS_OFFSET UNITYSDK_OFFSET(0x1A9F8E20)
#define UNITYENGINE_UI_GRAPHICREGISTRY_GET_ENABLECACHERAYCASTTARGET_OFFSET UNITYSDK_OFFSET(0x1A9F6B80)
#define UNITYENGINE_UI_GRAPHICREGISTRY_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A9F6C10)
#define UNITYENGINE_UI_GRAPHICREGISTRY_REFRESHALLRAYCASTTARGETCACHEDATA_OFFSET UNITYSDK_OFFSET(0x1A9F6C60)
#define UNITYENGINE_UI_GRAPHICREGISTRY_REFRESHRAYCASTGRAPHICCACHEDATA_OFFSET UNITYSDK_OFFSET(0x1A9F8BA0)
#define UNITYENGINE_UI_GRAPHICREGISTRY_REFRESHRAYCASTGRAPHICFORCANVAS_OFFSET UNITYSDK_OFFSET(0x1A9F85C0)
#define UNITYENGINE_UI_GRAPHICREGISTRY_REGISTERGRAPHICFORCANVAS_OFFSET UNITYSDK_OFFSET(0x1A9F7B00)
#define UNITYENGINE_UI_GRAPHICREGISTRY_REGISTERGRAPHIC_OFFSET UNITYSDK_OFFSET(0x1A9F7DB0)
#define UNITYENGINE_UI_GRAPHICREGISTRY_SET_ENABLECACHERAYCASTTARGET_OFFSET UNITYSDK_OFFSET(0x1A9EE2D0)
#define UNITYENGINE_UI_GRAPHICREGISTRY_TRYADDRAYCASTTARGETGRAPHICCACHEDATA_OFFSET UNITYSDK_OFFSET(0x1A9F7F30)
#define UNITYENGINE_UI_GRAPHICREGISTRY_UNREGISTERGRAPHICFORCANVAS_OFFSET UNITYSDK_OFFSET(0x1A9F8170)
#define UNITYENGINE_UI_GRAPHICREGISTRY_UNREGISTERGRAPHIC_OFFSET UNITYSDK_OFFSET(0x1A9F8470)
#define UNITYENGINE_UI_GRAPHICREGISTRY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9F8F30)
#define UNITYENGINE_UI_GRAPHICREGISTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9F7830)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int GraphicRegistry_TypeDefinitionIndex = 8356;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::UI::Graphic*>**)Il2CppClass::FromTypeDefinitionIndex(GraphicRegistry_TypeDefinitionIndex)->GetStaticField(0x7730);
		}
		static ::UnityEngine::UI::GraphicRegistry** StaticGet_s_Instance()
		{
			return (::UnityEngine::UI::GraphicRegistry**)Il2CppClass::FromTypeDefinitionIndex(GraphicRegistry_TypeDefinitionIndex)->GetStaticField(0x7738);
		}
