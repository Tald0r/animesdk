...
#define UNITYENGINE_UI_GRAPHICREGISTRY_CLEARALLRAYCASTTARGETCACHEDATA_OFFSET UNITYSDK_OFFSET(0x1A421880)
#define UNITYENGINE_UI_GRAPHICREGISTRY_GETALLRAYCASTTARGETGRAPHICS_OFFSET UNITYSDK_OFFSET(0x1A41B420)
#define UNITYENGINE_UI_GRAPHICREGISTRY_GETGRAPHICSFORCANVAS_OFFSET UNITYSDK_OFFSET(0x1A422EC0)
#define UNITYENGINE_UI_GRAPHICREGISTRY_GETRAYCASTTARGETCACHEDATA_OFFSET UNITYSDK_OFFSET(0x1A41A750)
#define UNITYENGINE_UI_GRAPHICREGISTRY_GETRAYCASTTARGETGRAPHICSFORCANVAS_OFFSET UNITYSDK_OFFSET(0x1A422FD0)
#define UNITYENGINE_UI_GRAPHICREGISTRY_GET_ENABLECACHERAYCASTTARGET_OFFSET UNITYSDK_OFFSET(0x1A420D20)
#define UNITYENGINE_UI_GRAPHICREGISTRY_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A420DB0)
#define UNITYENGINE_UI_GRAPHICREGISTRY_REFRESHALLRAYCASTTARGETCACHEDATA_OFFSET UNITYSDK_OFFSET(0x1A420E00)
#define UNITYENGINE_UI_GRAPHICREGISTRY_REFRESHRAYCASTGRAPHICCACHEDATA_OFFSET UNITYSDK_OFFSET(0x1A422D50)
#define UNITYENGINE_UI_GRAPHICREGISTRY_REFRESHRAYCASTGRAPHICFORCANVAS_OFFSET UNITYSDK_OFFSET(0x1A422770)
#define UNITYENGINE_UI_GRAPHICREGISTRY_REGISTERGRAPHICFORCANVAS_OFFSET UNITYSDK_OFFSET(0x1A421CB0)
#define UNITYENGINE_UI_GRAPHICREGISTRY_REGISTERGRAPHIC_OFFSET UNITYSDK_OFFSET(0x1A421F60)
#define UNITYENGINE_UI_GRAPHICREGISTRY_SET_ENABLECACHERAYCASTTARGET_OFFSET UNITYSDK_OFFSET(0x1A418480)
#define UNITYENGINE_UI_GRAPHICREGISTRY_TRYADDRAYCASTTARGETGRAPHICCACHEDATA_OFFSET UNITYSDK_OFFSET(0x1A4220E0)
#define UNITYENGINE_UI_GRAPHICREGISTRY_UNREGISTERGRAPHICFORCANVAS_OFFSET UNITYSDK_OFFSET(0x1A422320)
#define UNITYENGINE_UI_GRAPHICREGISTRY_UNREGISTERGRAPHIC_OFFSET UNITYSDK_OFFSET(0x1A422620)
#define UNITYENGINE_UI_GRAPHICREGISTRY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4230E0)
#define UNITYENGINE_UI_GRAPHICREGISTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4219E0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int GraphicRegistry_TypeDefinitionIndex = 8346;
	...
	public:
		...
		{
			return (::UnityEngine::UI::GraphicRegistry**)Il2CppClass::FromTypeDefinitionIndex(GraphicRegistry_TypeDefinitionIndex)->GetStaticField(0x76F0);
		}
		static ::System::Collections::Generic::List_1<::UnityEngine::UI::Graphic*>** StaticGet_s_EmptyList()
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::UI::Graphic*>**)Il2CppClass::FromTypeDefinitionIndex(GraphicRegistry_TypeDefinitionIndex)->GetStaticField(0x76F8);
		}
