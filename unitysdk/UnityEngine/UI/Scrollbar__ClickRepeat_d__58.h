...
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A7F9190)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7F9500)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7F9560)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A7F9510)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7F9180)
#define UNITYENGINE_UI_SCROLLBAR__CLICKREPEAT_D__58__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7F9170)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int Scrollbar__ClickRepeat_d__58_TypeDefinitionIndex = 8417;
