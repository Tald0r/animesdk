...
#define UNITYENGINE_UI_MESHMODIFIERREGISTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD72D0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int MeshModifierRegistry_TypeDefinitionIndex = 8463;
