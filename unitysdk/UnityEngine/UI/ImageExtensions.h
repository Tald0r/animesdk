...
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x182135F0)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETCOLOR_1_OFFSET UNITYSDK_OFFSET(0x18213DC0)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETCOLOR_OFFSET UNITYSDK_OFFSET(0x18213BE0)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETENABLED_OFFSET UNITYSDK_OFFSET(0x18214190)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETFILLAMOUNT_OFFSET UNITYSDK_OFFSET(0x18213980)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETMATERIAL_OFFSET UNITYSDK_OFFSET(0x18213FC0)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SETFILLAMOUNTCOMPAREPRE_OFFSET UNITYSDK_OFFSET(0x182137F0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ImageExtensions_TypeDefinitionIndex = 54295;
