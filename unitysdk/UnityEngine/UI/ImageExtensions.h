...
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1A8A6A80)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETCOLOR_1_OFFSET UNITYSDK_OFFSET(0x1A8A7250)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETCOLOR_OFFSET UNITYSDK_OFFSET(0x1A8A7070)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETENABLED_OFFSET UNITYSDK_OFFSET(0x1A8A7620)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETFILLAMOUNT_OFFSET UNITYSDK_OFFSET(0x1A8A6E10)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SAFESETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A8A7450)
#define UNITYENGINE_UI_IMAGEEXTENSIONS_SETFILLAMOUNTCOMPAREPRE_OFFSET UNITYSDK_OFFSET(0x1A8A6C80)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ImageExtensions_TypeDefinitionIndex = 40407;
