...
#define UNITYENGINE_UI_BUTTON__ONFINISHSUBMIT_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A463480)
#define UNITYENGINE_UI_BUTTON__ONFINISHSUBMIT_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A4635B0)
#define UNITYENGINE_UI_BUTTON__ONFINISHSUBMIT_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A463610)
#define UNITYENGINE_UI_BUTTON__ONFINISHSUBMIT_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A4635C0)
#define UNITYENGINE_UI_BUTTON__ONFINISHSUBMIT_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A463470)
#define UNITYENGINE_UI_BUTTON__ONFINISHSUBMIT_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x1A463460)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int Button__OnFinishSubmit_d__9_TypeDefinitionIndex = 8329;
