...
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYINTERSECTIONALLCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AF51C70)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYINTERSECTIONALLCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AF51D20)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYINTERSECTIONALLCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AF517C0)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYINTERSECTIONALLCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF517B0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ReflectionMethodsCache_GetRayIntersectionAllCallback_TypeDefinitionIndex = 8458;
