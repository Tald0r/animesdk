...
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_MOVECONTENT_OFFSET UNITYSDK_OFFSET(0x10BB1770)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x10BB0FF0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONDRAG_OFFSET UNITYSDK_OFFSET(0x10BB10C0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x10BB1190)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x10BB0F60)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_RESETPOS_OFFSET UNITYSDK_OFFSET(0x10BB12B0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_SETCONTENTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x10BB1400)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x10BB1C60)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x10BB1DB0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x10BB1DC0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x10BB1DD0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x10BB1E80)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_SETCONTENTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x10BB1E90)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int ScrollRectEx_TypeDefinitionIndex = 67916;
