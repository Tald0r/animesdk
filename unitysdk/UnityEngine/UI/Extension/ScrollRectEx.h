...
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_MOVECONTENT_OFFSET UNITYSDK_OFFSET(0x18DF4EE0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x18DF4760)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONDRAG_OFFSET UNITYSDK_OFFSET(0x18DF4830)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x18DF4900)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x18DF46D0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_RESETPOS_OFFSET UNITYSDK_OFFSET(0x18DF4A20)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX_SETCONTENTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x18DF4B70)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF53D0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x18DF5520)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x18DF5530)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x18DF5540)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x18DF55F0)
#define UNITYENGINE_UI_EXTENSION_SCROLLRECTEX___BASE_SETCONTENTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x18DF5600)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int ScrollRectEx_TypeDefinitionIndex = 40346;
