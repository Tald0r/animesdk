...
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXTICONUTILS_GENERATOR_ADDICON_OFFSET UNITYSDK_OFFSET(0x1534E4F0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXTICONUTILS_GENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1534E610)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgTextIconUtils_Generator_TypeDefinitionIndex = 55878;

	class UIImgTextIconUtils_Generator : public ::Class_1_2203E1F22CACEF25_Class_1_E23FBD37533CCEFB
	{
	public:
		::System::Void _ctor()
		{
