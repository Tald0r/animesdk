...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG_GETVALUE_OFFSET UNITYSDK_OFFSET(0x191A3AE0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG_SETVALUE_OFFSET UNITYSDK_OFFSET(0x191A3A40)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG_SIMULATE_OFFSET UNITYSDK_OFFSET(0x191A3BD0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0x191A38A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x191A3CE0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x191A3D30)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_LocalPosZ_ByTwoPointDrag_TypeDefinitionIndex = 57216;
