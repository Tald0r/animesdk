...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG_GETVALUE_OFFSET UNITYSDK_OFFSET(0x13891E90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG_SETVALUE_OFFSET UNITYSDK_OFFSET(0x13891DF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG_SIMULATE_OFFSET UNITYSDK_OFFSET(0x13891F80)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG__CTOR_OFFSET UNITYSDK_OFFSET(0x13891C50)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x13892090)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYTWOPOINTDRAG___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x138920F0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_LocalPosZ_ByTwoPointDrag_TypeDefinitionIndex = 70638;
