...
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_GETLINECOEFFICIENTS_OFFSET UNITYSDK_OFFSET(0x19C25E10)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_GET_ANGLE_OFFSET UNITYSDK_OFFSET(0x19C25690)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_INTERSECTION_OFFSET UNITYSDK_OFFSET(0x19C25B70)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_LERP_OFFSET UNITYSDK_OFFSET(0x19C25750)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_NORMALIZEINRECT_OFFSET UNITYSDK_OFFSET(0x19C25FE0)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_POINTONLINEPOSITION_OFFSET UNITYSDK_OFFSET(0x19C25EC0)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_SET_ANGLE_OFFSET UNITYSDK_OFFSET(0x19C256A0)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C256B0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int MindscapeLine_TypeDefinitionIndex = 44127;
	...
	public:
		...
		::System::Single _t; // 0x20
		::System::Single _Angle_k__BackingField; // 0x24
