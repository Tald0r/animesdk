...
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_GETLINECOEFFICIENTS_OFFSET UNITYSDK_OFFSET(0xC4D2C00)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_GET_ANGLE_OFFSET UNITYSDK_OFFSET(0xC4D2480)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_INTERSECTION_OFFSET UNITYSDK_OFFSET(0xC4D2960)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_LERP_OFFSET UNITYSDK_OFFSET(0xC4D2540)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_NORMALIZEINRECT_OFFSET UNITYSDK_OFFSET(0xC4D2DD0)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_POINTONLINEPOSITION_OFFSET UNITYSDK_OFFSET(0xC4D2CB0)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE_SET_ANGLE_OFFSET UNITYSDK_OFFSET(0xC4D2490)
#define UNITYENGINE_UI_EXTENSION_MINDSCAPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0xC4D24A0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int MindscapeLine_TypeDefinitionIndex = 71626;
