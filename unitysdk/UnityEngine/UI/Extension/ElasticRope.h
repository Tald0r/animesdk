...
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_CALCULATEPOINTS_OFFSET UNITYSDK_OFFSET(0x1AF77D80)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_CUBICBEZIER_OFFSET UNITYSDK_OFFSET(0x1AF77C50)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_GET_CAPVERTICES_OFFSET UNITYSDK_OFFSET(0x1AF77BE0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AF77290)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_GET_POINTSPERSEGMENT_OFFSET UNITYSDK_OFFSET(0x1AF77B70)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_GET_STARTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AF777A0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_GET_TARGETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AF77980)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1AF77AB0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF79A10)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AF79940)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1AF788F0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1AF79640)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF79890)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_SET_CAPVERTICES_OFFSET UNITYSDK_OFFSET(0x1AF77BF0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_SET_POINTSPERSEGMENT_OFFSET UNITYSDK_OFFSET(0x1AF77B80)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_SET_STARTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AF777B0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_SET_TARGETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AF77990)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1AF77AC0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AF79AC0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF79C50)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AF79CA0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE___BASE_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF79CD0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AF79DA0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1AF79E40)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1AF7A020)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE___BASE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF7A030)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int ElasticRope_TypeDefinitionIndex = 8481;
