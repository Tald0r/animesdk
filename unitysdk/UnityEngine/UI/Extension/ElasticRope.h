...
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_CALCULATEPOINTS_OFFSET UNITYSDK_OFFSET(0x1AB240F0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_CUBICBEZIER_OFFSET UNITYSDK_OFFSET(0x1AB23FC0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_GET_CAPVERTICES_OFFSET UNITYSDK_OFFSET(0x1AB23F50)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AB23600)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_GET_POINTSPERSEGMENT_OFFSET UNITYSDK_OFFSET(0x1AB23EE0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_GET_STARTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AB23B10)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_GET_TARGETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AB23CF0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1AB23E20)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AB25D80)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AB25CB0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1AB24C60)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1AB259B0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1AB25C00)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_SET_CAPVERTICES_OFFSET UNITYSDK_OFFSET(0x1AB23F60)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_SET_POINTSPERSEGMENT_OFFSET UNITYSDK_OFFSET(0x1AB23EF0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_SET_STARTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AB23B20)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_SET_TARGETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AB23D00)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1AB23E30)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AB25E30)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB25FC0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AB26010)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE___BASE_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AB26040)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AB26110)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1AB261B0)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1AB26390)
#define UNITYENGINE_UI_EXTENSION_ELASTICROPE___BASE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1AB263A0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int ElasticRope_TypeDefinitionIndex = 8471;
