...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x196FBB90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x196FBCF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x196FBC70)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY__CTOR_OFFSET UNITYSDK_OFFSET(0x196FBA90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x196FBDD0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x196FBDE0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x196FBE40)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_LocalPosZ_ByScrollY_TypeDefinitionIndex = 67805;
