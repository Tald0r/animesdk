...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x15681DF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x15681F50)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x15681ED0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY__CTOR_OFFSET UNITYSDK_OFFSET(0x15681CF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x15682030)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x15682040)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSZ_BYSCROLLY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x15682090)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_LocalPosZ_ByScrollY_TypeDefinitionIndex = 75862;
