...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ENDDRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1534D9C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ENDDRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1534DA20)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ENDDRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1534D210)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ENDDRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1534D1F0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_EndDragCallback_TypeDefinitionIndex = 45341;
