...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ENDDRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18181290)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ENDDRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x181812F0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ENDDRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18180AE0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ENDDRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18180AD0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_EndDragCallback_TypeDefinitionIndex = 50482;
