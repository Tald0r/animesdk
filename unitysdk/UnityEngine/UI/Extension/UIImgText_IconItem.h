...
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ICONITEM_GET_IMAGE_OFFSET UNITYSDK_OFFSET(0x45D120)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ICONITEM_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x45D0E0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ICONITEM_REFRESHITEMRECTBYSCALE_OFFSET UNITYSDK_OFFSET(0x45D380)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ICONITEM_SETITEMSIZE_OFFSET UNITYSDK_OFFSET(0x45D2C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ICONITEM_SETSPRITE_OFFSET UNITYSDK_OFFSET(0x45D160)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ICONITEM_SETTEXT_OFFSET UNITYSDK_OFFSET(0x45D210)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgText_IconItem_TypeDefinitionIndex = 47260;
