...
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_CLEAN_OFFSET UNITYSDK_OFFSET(0x17CD1260)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_GET_ISEND_OFFSET UNITYSDK_OFFSET(0x17CD0950)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_HIDETIME_OFFSET UNITYSDK_OFFSET(0x17CD2FE0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17CD11F0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17CD0A40)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_REMOVEENDCALL_OFFSET UNITYSDK_OFFSET(0x17CD1640)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETALLCOLOR_OFFSET UNITYSDK_OFFSET(0x17CD2CE0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETICONACTIVE_OFFSET UNITYSDK_OFFSET(0x17CD35A0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETICONSHOWTYPE_OFFSET UNITYSDK_OFFSET(0x17CD30B0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMECOLOR_OFFSET UNITYSDK_OFFSET(0x17CD2F20)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMECOUNTUP_OFFSET UNITYSDK_OFFSET(0x17CD1930)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMEDESCOLOR_OFFSET UNITYSDK_OFFSET(0x17CD2E60)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMEOUT_OFFSET UNITYSDK_OFFSET(0x17CD18B0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMESHOWTYPE_OFFSET UNITYSDK_OFFSET(0x17CD2C70)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMESTAMPCOUNTDOWN_1_OFFSET UNITYSDK_OFFSET(0x17CD1820)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMESTAMPCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x17CD16B0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIMEUPDATETYPE_OFFSET UNITYSDK_OFFSET(0x17CD2C00)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIME_1_OFFSET UNITYSDK_OFFSET(0x17CD1B90)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTIME_OFFSET UNITYSDK_OFFSET(0x17CD1B10)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTITLEACTIVE_OFFSET UNITYSDK_OFFSET(0x17CD36B0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTITLE_1_OFFSET UNITYSDK_OFFSET(0x17CD38B0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_SETTITLE_OFFSET UNITYSDK_OFFSET(0x17CD37A0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_STOPTIMESTAMPCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x17CD14F0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_DEFAULT_OFFSET UNITYSDK_OFFSET(0x17CD2770)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_HOURMINUTESECOND_OFFSET UNITYSDK_OFFSET(0x17CD2050)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_HOURMINUTE_OFFSET UNITYSDK_OFFSET(0x17CD1ED0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_MINUTESECOND_OFFSET UNITYSDK_OFFSET(0x17CD2390)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_ONLYDAY_OFFSET UNITYSDK_OFFSET(0x17CD2610)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_TIMESHOW_ONLYONE_OFFSET UNITYSDK_OFFSET(0x17CD1C90)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_UPDATETICK_OFFSET UNITYSDK_OFFSET(0x17CD0B20)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_UPDATE_OFFSET UNITYSDK_OFFSET(0x17CD0AB0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x17CD3B40)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITimeWidget_TypeDefinitionIndex = 46261;
	...
	public:
		...
		::Class_1_1405E77D2B372893* _loadProxyBase; // 0x88
