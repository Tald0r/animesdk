...
#define UNITYENGINE_UI_EXTENSION_UIFORCEPIXELPERFECT_FORCEPIXELPERFECTPOS_OFFSET UNITYSDK_OFFSET(0x16C5E360)
#define UNITYENGINE_UI_EXTENSION_UIFORCEPIXELPERFECT_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x16C5EA70)
#define UNITYENGINE_UI_EXTENSION_UIFORCEPIXELPERFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x16C5E2E0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIForcePixelPerfect_TypeDefinitionIndex = 61757;
