...
#define UNITYENGINE_UI_EXTENSION_UIFORCEPIXELPERFECT_FORCEPIXELPERFECTPOS_OFFSET UNITYSDK_OFFSET(0xAEA7890)
#define UNITYENGINE_UI_EXTENSION_UIFORCEPIXELPERFECT_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xAEA7FA0)
#define UNITYENGINE_UI_EXTENSION_UIFORCEPIXELPERFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xAEA7810)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIForcePixelPerfect_TypeDefinitionIndex = 80741;
