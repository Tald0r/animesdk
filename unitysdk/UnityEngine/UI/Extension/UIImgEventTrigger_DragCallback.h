...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18DF5DD0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18DF5E30)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DF5620)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF5610)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_DragCallback_TypeDefinitionIndex = 50481;
