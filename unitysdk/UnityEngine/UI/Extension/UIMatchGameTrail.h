...
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_CLEANUP_OFFSET UNITYSDK_OFFSET(0x1AF7B500)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_CONVERTWORLDPOSTOLOCALPOS_OFFSET UNITYSDK_OFFSET(0x1AF7A820)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_GETMODIFIEDMATERIALPOST_OFFSET UNITYSDK_OFFSET(0x1AF7BA20)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1AF7B920)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AF7A100)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_GET_SOURCEPOSITION_OFFSET UNITYSDK_OFFSET(0x1AF7A550)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AF7B590)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1AF7B640)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_PACKTARGETPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1AF7B0A0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SETSOURCEPOSITION_OFFSET UNITYSDK_OFFSET(0x1AF7AC50)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SETTARGETPOSITIONS_1_OFFSET UNITYSDK_OFFSET(0x1AF7AF60)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SETTARGETPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1AF7ACF0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SETTARGETPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1AF7AED0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SETTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AF7AE20)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SETWIDTH_OFFSET UNITYSDK_OFFSET(0x1AF7BB50)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SET_TARGETCOUNT_OFFSET UNITYSDK_OFFSET(0x1AF7A560)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SET_TRANSITIONEND_OFFSET UNITYSDK_OFFSET(0x1AF7A750)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL_SET_TRANSITIONSTART_OFFSET UNITYSDK_OFFSET(0x1AF7A680)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AF7BBB0)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF7B040)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL___BASE_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1AF7BC40)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AF7BC10)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AF7BC50)
#define UNITYENGINE_UI_EXTENSION_UIMATCHGAMETRAIL___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1AF7BC60)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIMatchGameTrail_TypeDefinitionIndex = 8484;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMatchGameTrail_TypeDefinitionIndex)->GetStaticField(0x3B00);
		}
		static ::System::Int32* StaticGet_TargetPositionsPropId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMatchGameTrail_TypeDefinitionIndex)->GetStaticField(0x3B04);
		}
		static ::System::Int32* StaticGet_PackedParam1PropId()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMatchGameTrail_TypeDefinitionIndex)->GetStaticField(0x3B08);
		}
