...
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GETPREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x57AAF0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GET_FONTTEXTUREDIRTY_OFFSET UNITYSDK_OFFSET(0x57AAD0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GET_PIXELSPERUNIT_OFFSET UNITYSDK_OFFSET(0x2FD570)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x2C4AF0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_SET_FONTTEXTUREDIRTY_OFFSET UNITYSDK_OFFSET(0x57AAE0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_SET_PIXELSPERUNIT_OFFSET UNITYSDK_OFFSET(0x2FD580)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_SET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x2C4B00)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x2CB170)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UILocalizationText_PreferredCache_TypeDefinitionIndex = 60555;
