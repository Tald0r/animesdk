...
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GETPREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x599170)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GET_FONTTEXTUREDIRTY_OFFSET UNITYSDK_OFFSET(0x599150)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GET_PIXELSPERUNIT_OFFSET UNITYSDK_OFFSET(0x2F2F50)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x2F60A0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x272280)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_SET_FONTTEXTUREDIRTY_OFFSET UNITYSDK_OFFSET(0x599160)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_SET_PIXELSPERUNIT_OFFSET UNITYSDK_OFFSET(0x2F2F60)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_SET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x2F60B0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_PREFERREDCACHE_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x302310)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UILocalizationText_PreferredCache_TypeDefinitionIndex = 71653;
