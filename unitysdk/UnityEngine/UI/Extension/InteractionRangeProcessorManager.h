...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_ADDHANDLE_OFFSET UNITYSDK_OFFSET(0x15681590)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_DISPOSEALL_OFFSET UNITYSDK_OFFSET(0x15680D00)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_FORCESIMULATETWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0x15681170)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_GETRESOURCE_OFFSET UNITYSDK_OFFSET(0x15681B40)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_HANDLEEVENTDATA_1_OFFSET UNITYSDK_OFFSET(0x15680B10)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_HANDLEEVENTDATA_OFFSET UNITYSDK_OFFSET(0x156808E0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_ISALLPROCESSORSNOTCLAMPING_OFFSET UNITYSDK_OFFSET(0x156819D0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_KILL_OFFSET UNITYSDK_OFFSET(0x15680EE0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_REFRESHINTERACTSTATE_OFFSET UNITYSDK_OFFSET(0x15681410)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_REFRESHPROCESSERBYPLATFORM_OFFSET UNITYSDK_OFFSET(0x15681680)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_REMOVEHANDLE_OFFSET UNITYSDK_OFFSET(0x15681020)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_TICK_OFFSET UNITYSDK_OFFSET(0x15680770)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_WAITUNTILALLCLAMPFINISH_OFFSET UNITYSDK_OFFSET(0x15681900)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x15681C50)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorManager_TypeDefinitionIndex = 55325;
