...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_ADDHANDLE_OFFSET UNITYSDK_OFFSET(0x196FB330)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_DISPOSEALL_OFFSET UNITYSDK_OFFSET(0x196FAA90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_FORCESIMULATETWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0x196FAF00)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_GETRESOURCE_OFFSET UNITYSDK_OFFSET(0x196FB8E0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_HANDLEEVENTDATA_1_OFFSET UNITYSDK_OFFSET(0x196FA8A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_HANDLEEVENTDATA_OFFSET UNITYSDK_OFFSET(0x196FA670)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_ISALLPROCESSORSNOTCLAMPING_OFFSET UNITYSDK_OFFSET(0x196FB770)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_KILL_OFFSET UNITYSDK_OFFSET(0x196FAC70)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_REFRESHINTERACTSTATE_OFFSET UNITYSDK_OFFSET(0x196FB1A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_REFRESHPROCESSERBYPLATFORM_OFFSET UNITYSDK_OFFSET(0x196FB420)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_REMOVEHANDLE_OFFSET UNITYSDK_OFFSET(0x196FADB0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_TICK_OFFSET UNITYSDK_OFFSET(0x196FA500)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER_WAITUNTILALLCLAMPFINISH_OFFSET UNITYSDK_OFFSET(0x196FB6A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x196FB9F0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorManager_TypeDefinitionIndex = 73271;
