...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_APPLYDELTA_OFFSET UNITYSDK_OFFSET(0x18211F40)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x18212000)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_CLAMP_OFFSET UNITYSDK_OFFSET(0x18211B90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x182122D0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_GOTOVAL_OFFSET UNITYSDK_OFFSET(0x18211D30)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_INITPARAM_OFFSET UNITYSDK_OFFSET(0x18211770)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_MOCKRANGEEXCFG_OFFSET UNITYSDK_OFFSET(0x18211940)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT_SETCENTERVAL_OFFSET UNITYSDK_OFFSET(0x182118C0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x18212340)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT___BASE_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x182123B0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT___BASE_CLAMP_OFFSET UNITYSDK_OFFSET(0x18212430)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT___BASE_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x18212490)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorFloat_TypeDefinitionIndex = 55141;
