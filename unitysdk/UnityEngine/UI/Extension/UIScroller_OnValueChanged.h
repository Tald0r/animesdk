...
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONVALUECHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1827D4C0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONVALUECHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1827D510)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONVALUECHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1827D160)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONVALUECHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1827D140)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIScroller_OnValueChanged_TypeDefinitionIndex = 46236;
