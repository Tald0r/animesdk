...
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONVALUECHANGED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1816CF80)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONVALUECHANGED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1816CFD0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONVALUECHANGED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1816CC30)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONVALUECHANGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1816CC20)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIScroller_OnValueChanged_TypeDefinitionIndex = 43518;
