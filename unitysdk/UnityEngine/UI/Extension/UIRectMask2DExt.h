...
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT_DOADD_OFFSET UNITYSDK_OFFSET(0x16EBC460)
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT_EXAMINE_OFFSET UNITYSDK_OFFSET(0x16EBC900)
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT_GET_SOFTNESSFORLINE_OFFSET UNITYSDK_OFFSET(0x16EBC3D0)
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT_SET_SOFTNESSFORLINE_OFFSET UNITYSDK_OFFSET(0x16EBC3E0)
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EBCD40)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIRectMask2DExt_TypeDefinitionIndex = 44240;
