...
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT_DOADD_OFFSET UNITYSDK_OFFSET(0x1B474550)
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT_EXAMINE_OFFSET UNITYSDK_OFFSET(0x1B4749F0)
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT_GET_SOFTNESSFORLINE_OFFSET UNITYSDK_OFFSET(0x1B4744C0)
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT_SET_SOFTNESSFORLINE_OFFSET UNITYSDK_OFFSET(0x1B4744D0)
#define UNITYENGINE_UI_EXTENSION_UIRECTMASK2DEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B474E30)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIRectMask2DExt_TypeDefinitionIndex = 56111;
