...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPARAMFLOAT_COPYSOURCE_OFFSET UNITYSDK_OFFSET(0x181806C0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPARAMFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x181807B0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeParamFloat_TypeDefinitionIndex = 78209;
