...
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_ADDBUTTONCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x13896470)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_AWAKE_OFFSET UNITYSDK_OFFSET(0x13893620)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_BINDNOTIFICATIONNODE_1_OFFSET UNITYSDK_OFFSET(0x13895B70)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0x13895A50)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_DOCLICK_OFFSET UNITYSDK_OFFSET(0x13893D60)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_ENABLEBADGE_OFFSET UNITYSDK_OFFSET(0x13896AB0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_GET_ISSELECT_OFFSET UNITYSDK_OFFSET(0x13893610)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_HANDLEPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x13893810)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x13894270)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_HANDLEPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x13894570)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_HANDLEPOINTERUP_OFFSET UNITYSDK_OFFSET(0x13893A40)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_INIT_1_OFFSET UNITYSDK_OFFSET(0x13893780)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_INIT_OFFSET UNITYSDK_OFFSET(0x138936F0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_PLAYCLICKSOUND_OFFSET UNITYSDK_OFFSET(0x13894800)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_PRECHECKCLICK_OFFSET UNITYSDK_OFFSET(0x13894D80)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_REMOVEBUTTONCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x13896510)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETASSETLOADPROXY_OFFSET UNITYSDK_OFFSET(0x138945E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETCLICKCHECKSELECTED_OFFSET UNITYSDK_OFFSET(0x13895E50)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETCLICKPRECHECK_OFFSET UNITYSDK_OFFSET(0x13894C80)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETEMPTY_OFFSET UNITYSDK_OFFSET(0x13894E30)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETFINISH_OFFSET UNITYSDK_OFFSET(0x13894EC0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETFORCETRIGGER_OFFSET UNITYSDK_OFFSET(0x13896400)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETICON_1_OFFSET UNITYSDK_OFFSET(0x138959C0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETICON_OFFSET UNITYSDK_OFFSET(0x138958B0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETNORMALTRIGGER_OFFSET UNITYSDK_OFFSET(0x13894A30)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETREDPOINT_1_OFFSET UNITYSDK_OFFSET(0x13896960)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETREDPOINT_OFFSET UNITYSDK_OFFSET(0x138965B0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETSELECTEDANIM_OFFSET UNITYSDK_OFFSET(0x13894F50)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETSELECTED_OFFSET UNITYSDK_OFFSET(0x13894650)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABLOCK_1_OFFSET UNITYSDK_OFFSET(0x13895FD0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABLOCK_OFFSET UNITYSDK_OFFSET(0x13895EC0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABNAMEBYTEXTKEY_1_OFFSET UNITYSDK_OFFSET(0x13896300)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABNAMEBYTEXTKEY_OFFSET UNITYSDK_OFFSET(0x13896200)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABNAME_OFFSET UNITYSDK_OFFSET(0x13895C00)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON_SETTABSELECTED_OFFSET UNITYSDK_OFFSET(0x13894C10)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON__CCTOR_OFFSET UNITYSDK_OFFSET(0x13896E50)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x13896DC0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x13896E70)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTON___BASE_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x13896F00)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITabButton_TypeDefinitionIndex = 73350;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UITabButton_TypeDefinitionIndex)->GetStaticField(0x44350);
		}
		...
		::System::Void BindNotificationNode_1(::Class_1_79526D80B8F6897C* node)
		{
			return ((::System::Void(*)(::PVOID, ::Class_1_79526D80B8F6897C*))((::PBYTE)hIl2Cpp + UNITYENGINE_UI_EXTENSION_UITABBUTTON_BINDNOTIFICATIONNODE_1_OFFSET))(this, node);
		}
