...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONTOUCHTYPECHANGECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xAEAC150)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONTOUCHTYPECHANGECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xAEAC180)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONTOUCHTYPECHANGECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0xAEA9540)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONTOUCHTYPECHANGECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0xAEAC130)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_OnTouchTypeChangeCallback_TypeDefinitionIndex = 45338;
