...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18DF63F0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18DF6450)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DF5E50)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF5E40)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_TwoPointDragCallback_TypeDefinitionIndex = 50471;
