...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__TWEENPOSITION_D__150_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15AC67F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__TWEENPOSITION_D__150_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15AC6EF0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__TWEENPOSITION_D__150_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15AC6F50)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__TWEENPOSITION_D__150_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15AC6F00)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__TWEENPOSITION_D__150_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15AC67E0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__TWEENPOSITION_D__150__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC67D0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView__TweenPosition_d__150_TypeDefinitionIndex = 81247;
	...
	public:
		...
		::System::Single end; // 0x20
		::System::Int32 __1__state; // 0x24
		::System::Single time; // 0x28
		::System::Int32 lineIndex; // 0x2C
