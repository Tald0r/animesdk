...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__TWEENPOSITION_D__150_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x15F63520)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__TWEENPOSITION_D__150_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15F63C20)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__TWEENPOSITION_D__150_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x15F63C80)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__TWEENPOSITION_D__150_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x15F63C30)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__TWEENPOSITION_D__150_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x15F63510)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__TWEENPOSITION_D__150__CTOR_OFFSET UNITYSDK_OFFSET(0x15F63500)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView__TweenPosition_d__150_TypeDefinitionIndex = 38198;
