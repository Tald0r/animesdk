...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0xFB14D20)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xFB14C50)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0xFB14BD0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT_JUDGEBYPOINT_OFFSET UNITYSDK_OFFSET(0xFB14DE0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0xFB15050)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT___BASE_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0xFB150D0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xFB15160)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_TWOPOINTDRAGFLOAT___BASE_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0xFB151F0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_TwoPointDragFloat_TypeDefinitionIndex = 68161;
