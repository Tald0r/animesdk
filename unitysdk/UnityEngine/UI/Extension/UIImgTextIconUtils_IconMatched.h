...
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXTICONUTILS_ICONMATCHED_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x599090)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXTICONUTILS_ICONMATCHED_GETNAMESTRING_OFFSET UNITYSDK_OFFSET(0x599080)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgTextIconUtils_IconMatched_TypeDefinitionIndex = 55880;
