...
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP___C__DISPLAYCLASS40_1__ADDLOCKTAB_B__2_OFFSET UNITYSDK_OFFSET(0x16EBCD70)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP___C__DISPLAYCLASS40_1__CTOR_OFFSET UNITYSDK_OFFSET(0x16EBCD60)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITabButtonGroup___c__DisplayClass40_1_TypeDefinitionIndex = 70750;
