...
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x16C67E00)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x16C6A4C0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x16C6A520)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_CALCULATEOFFSET_OFFSET UNITYSDK_OFFSET(0x16C684B0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ENSURELAYOUTHASREBUILT_OFFSET UNITYSDK_OFFSET(0x16C68160)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x16C6A720)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x16C6A6B0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x16C69A60)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x16C6A5D0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x16C6A5A0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x16C6A5E0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x16C6A5B0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x16C6A580)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_M_CONTENT_OFFSET UNITYSDK_OFFSET(0x16C67570)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_M_DRAGGING_OFFSET UNITYSDK_OFFSET(0x16C675B0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_M_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x16C67590)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_NORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x16C69A50)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x16C6A5C0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x16C6A590)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_VELOCITY_OFFSET UNITYSDK_OFFSET(0x16C675D0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GRAPHICUPDATECOMPLETE_OFFSET UNITYSDK_OFFSET(0x16C67DA0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x16C68030)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16C68E00)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_LAYOUTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x16C67D40)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x16C686C0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16C6ACB0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16C67F50)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x16C68900)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16C67EC0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x16C68880)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x16C68630)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0x16C699E0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x16C6A350)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x16C68210)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_REBUILD_OFFSET UNITYSDK_OFFSET(0x16C677C0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_RUBBERDELTA_OFFSET UNITYSDK_OFFSET(0x16C68BC0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETCONTENTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x16C68C90)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETDIRTYCACHING_OFFSET UNITYSDK_OFFSET(0x16C6AC10)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x16C6A430)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x16C6A5F0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x16C6A650)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x16C69DC0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_M_CONTENT_OFFSET UNITYSDK_OFFSET(0x16C67580)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_M_DRAGGING_OFFSET UNITYSDK_OFFSET(0x16C675C0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_M_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x16C675A0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_NORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0x16C69D40)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_VELOCITY_OFFSET UNITYSDK_OFFSET(0x16C67650)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_UNITYENGINE_UI_ICANVASELEMENT_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x16C6AD40)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_UPDATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x16C67840)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_UPDATEPREVDATA_OFFSET UNITYSDK_OFFSET(0x16C67BF0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x16C67730)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x16C6ADB0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x16C6AE40)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16C6AED0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16C6AF60)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16C6AFF0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x16C6B080)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIScroller_TypeDefinitionIndex = 43514;
