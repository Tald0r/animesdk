...
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0xAEB1360)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xAEB3A20)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0xAEB3A80)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_CALCULATEOFFSET_OFFSET UNITYSDK_OFFSET(0xAEB1A10)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ENSURELAYOUTHASREBUILT_OFFSET UNITYSDK_OFFSET(0xAEB16C0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0xAEB3C80)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GETCOLROW_OFFSET UNITYSDK_OFFSET(0xAEB3C10)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0xAEB2FC0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0xAEB3B30)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0xAEB3B00)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0xAEB3B40)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0xAEB3B10)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0xAEB3AE0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_M_CONTENT_OFFSET UNITYSDK_OFFSET(0xAEB0AD0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_M_DRAGGING_OFFSET UNITYSDK_OFFSET(0xAEB0B10)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_M_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xAEB0AF0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_NORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0xAEB2FB0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0xAEB3B20)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0xAEB3AF0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GET_VELOCITY_OFFSET UNITYSDK_OFFSET(0xAEB0B30)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_GRAPHICUPDATECOMPLETE_OFFSET UNITYSDK_OFFSET(0xAEB1300)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xAEB1590)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAEB2360)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_LAYOUTCOMPLETE_OFFSET UNITYSDK_OFFSET(0xAEB12A0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xAEB1C20)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAEB4210)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAEB14B0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xAEB1E60)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAEB1420)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xAEB1DE0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0xAEB1B90)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0xAEB2F40)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xAEB38B0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xAEB1770)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_REBUILD_OFFSET UNITYSDK_OFFSET(0xAEB0D20)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_RUBBERDELTA_OFFSET UNITYSDK_OFFSET(0xAEB2120)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETCONTENTANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0xAEB21F0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETDIRTYCACHING_OFFSET UNITYSDK_OFFSET(0xAEB4170)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETDIRTY_OFFSET UNITYSDK_OFFSET(0xAEB3990)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0xAEB3B50)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0xAEB3BB0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SETNORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0xAEB3320)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_M_CONTENT_OFFSET UNITYSDK_OFFSET(0xAEB0AE0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_M_DRAGGING_OFFSET UNITYSDK_OFFSET(0xAEB0B20)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_M_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0xAEB0B00)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_NORMALIZEDPOSITION_OFFSET UNITYSDK_OFFSET(0xAEB32A0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_SET_VELOCITY_OFFSET UNITYSDK_OFFSET(0xAEB0BB0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_UNITYENGINE_UI_ICANVASELEMENT_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0xAEB42A0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_UPDATEBOUNDS_OFFSET UNITYSDK_OFFSET(0xAEB0DA0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER_UPDATEPREVDATA_OFFSET UNITYSDK_OFFSET(0xAEB1150)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAEB0C90)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0xAEB4310)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ISACTIVE_OFFSET UNITYSDK_OFFSET(0xAEB43A0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAEB4430)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xAEB44C0)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xAEB4550)
#define UNITYENGINE_UI_EXTENSION_UISCROLLER___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0xAEB45E0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIScroller_TypeDefinitionIndex = 46232;
