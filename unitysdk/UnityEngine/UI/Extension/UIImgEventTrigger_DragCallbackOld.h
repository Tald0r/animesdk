...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACKOLD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C2D6B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACKOLD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C2D710)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACKOLD_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C2D150)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_DRAGCALLBACKOLD__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2D140)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_DragCallbackOld_TypeDefinitionIndex = 50468;
