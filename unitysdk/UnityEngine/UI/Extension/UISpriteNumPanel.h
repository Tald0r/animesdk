...
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_CALLPLAYACTION_OFFSET UNITYSDK_OFFSET(0xAEB4C90)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_CALLSTOPACTION_OFFSET UNITYSDK_OFFSET(0xAEB4D00)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_INITACTION_OFFSET UNITYSDK_OFFSET(0xAEB4C10)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_REFRESH_OFFSET UNITYSDK_OFFSET(0xAEB4670)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_SETCOLOR_OFFSET UNITYSDK_OFFSET(0xAEB4FA0)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_SETNUM_OFFSET UNITYSDK_OFFSET(0xAEB4D70)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_UPDATE_OFFSET UNITYSDK_OFFSET(0xAEB5150)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0xAEB5310)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UISpriteNumPanel_TypeDefinitionIndex = 69115;
