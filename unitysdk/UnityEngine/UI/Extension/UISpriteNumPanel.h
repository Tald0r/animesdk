...
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_CALLPLAYACTION_OFFSET UNITYSDK_OFFSET(0x16C6B730)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_CALLSTOPACTION_OFFSET UNITYSDK_OFFSET(0x16C6B7A0)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_INITACTION_OFFSET UNITYSDK_OFFSET(0x16C6B6B0)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_REFRESH_OFFSET UNITYSDK_OFFSET(0x16C6B110)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_SETCOLOR_OFFSET UNITYSDK_OFFSET(0x16C6BA40)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_SETNUM_OFFSET UNITYSDK_OFFSET(0x16C6B810)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL_UPDATE_OFFSET UNITYSDK_OFFSET(0x16C6BBF0)
#define UNITYENGINE_UI_EXTENSION_UISPRITENUMPANEL__CTOR_OFFSET UNITYSDK_OFFSET(0x16C6BDB0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UISpriteNumPanel_TypeDefinitionIndex = 78718;
