...
#define UNITYENGINE_UI_EXTENSION_UISLIDER_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1A556F30)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A5568B0)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_GETRATIO_OFFSET UNITYSDK_OFFSET(0x1A556CE0)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_GET_ISINT_OFFSET UNITYSDK_OFFSET(0x1A5564B0)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_GET_MAXVAL_OFFSET UNITYSDK_OFFSET(0x1A556590)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_GET_MINVAL_OFFSET UNITYSDK_OFFSET(0x1A556680)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_GET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0x1A556770)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x1A5567E0)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A5567D0)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A5575E0)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A557550)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A557460)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_ONSLIDERVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A557110)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_REMOVEALLLISTENERS_OFFSET UNITYSDK_OFFSET(0x1A557060)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1A556FB0)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_SETINITVAL_OFFSET UNITYSDK_OFFSET(0x1A556A00)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_SETRATIO_OFFSET UNITYSDK_OFFSET(0x1A556D70)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_SETVAL_OFFSET UNITYSDK_OFFSET(0x1A556E00)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_SET_ISINT_OFFSET UNITYSDK_OFFSET(0x1A5564C0)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_SET_MAXVAL_OFFSET UNITYSDK_OFFSET(0x1A5565A0)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_SET_MINVAL_OFFSET UNITYSDK_OFFSET(0x1A556690)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_SET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0x1A5567A0)
#define UNITYENGINE_UI_EXTENSION_UISLIDER_TRIGGERSOUND_OFFSET UNITYSDK_OFFSET(0x1A5571D0)
#define UNITYENGINE_UI_EXTENSION_UISLIDER__AWAKE_B__24_0_OFFSET UNITYSDK_OFFSET(0x1A557710)
#define UNITYENGINE_UI_EXTENSION_UISLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A557670)
#define UNITYENGINE_UI_EXTENSION_UISLIDER___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A557750)
#define UNITYENGINE_UI_EXTENSION_UISLIDER___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A557760)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UISlider_TypeDefinitionIndex = 70148;
