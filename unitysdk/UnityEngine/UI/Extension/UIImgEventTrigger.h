...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xAEA8030)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_FORCESIMULATETWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0xAEAB680)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_GETCURRENTTOUCHTYPE_OFFSET UNITYSDK_OFFSET(0xAEA8590)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_GET_CURCONTROLSINGLEPOINT_OFFSET UNITYSDK_OFFSET(0xAEA8020)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_GET_CURRENTTOUCHTYPE_OFFSET UNITYSDK_OFFSET(0xAEA9B60)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_INITINTERACTIONPROCESSORS_OFFSET UNITYSDK_OFFSET(0xAEA81F0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ISDRAGRECEIVER_OFFSET UNITYSDK_OFFSET(0xAEA9E90)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ISSCROLLRECEIVER_OFFSET UNITYSDK_OFFSET(0xAEA9D50)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ISTWOPOINTDRAGRECEIVER_OFFSET UNITYSDK_OFFSET(0xAEA9DF0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_KILL_OFFSET UNITYSDK_OFFSET(0xAEAB600)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAEA82A0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xAEA8E50)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xAEA8DD0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONDRAG_OFFSET UNITYSDK_OFFSET(0xAEA8720)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONDROP_OFFSET UNITYSDK_OFFSET(0xAEA9090)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xAEA8F70)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xAEA9140)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0xAEA97E0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0xAEA9860)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xAEA98E0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xAEA9B70)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REFRESHCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0xAEA94B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REFRESHPROCESSERBYPLATFORM_OFFSET UNITYSDK_OFFSET(0xAEA9F30)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_CHANGEFOV_SCROLLY_OFFSET UNITYSDK_OFFSET(0xAEAA510)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_FOV_TWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0xAEAAD00)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_MOVECAMY_DRAGY_OFFSET UNITYSDK_OFFSET(0xAEAB350)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_MOVEZPOS_SCROLLY_OFFSET UNITYSDK_OFFSET(0xAEAA080)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_MOVEZPOS_TWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0xAEAA9B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_ROTATEY_DRAGX_OFFSET UNITYSDK_OFFSET(0xAEAB0C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_WAITALLCLAMPFINISH_OFFSET UNITYSDK_OFFSET(0xAEA9FB0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xAEAB710)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xAEAB7D0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONDRAG_OFFSET UNITYSDK_OFFSET(0xAEAB870)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONDROP_OFFSET UNITYSDK_OFFSET(0xAEAB910)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xAEAB9B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xAEABA50)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0xAEABAF0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0xAEABB90)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xAEABC30)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xAEABCD0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_TypeDefinitionIndex = 45332;
