...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x16C5EB00)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_FORCESIMULATETWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0x16C62130)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_GETCURRENTTOUCHTYPE_OFFSET UNITYSDK_OFFSET(0x16C5F060)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_GET_CURCONTROLSINGLEPOINT_OFFSET UNITYSDK_OFFSET(0x16C5EAF0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_GET_CURRENTTOUCHTYPE_OFFSET UNITYSDK_OFFSET(0x16C60630)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_INITINTERACTIONPROCESSORS_OFFSET UNITYSDK_OFFSET(0x16C5ECC0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ISDRAGRECEIVER_OFFSET UNITYSDK_OFFSET(0x16C60960)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ISSCROLLRECEIVER_OFFSET UNITYSDK_OFFSET(0x16C60820)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ISTWOPOINTDRAGRECEIVER_OFFSET UNITYSDK_OFFSET(0x16C608C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_KILL_OFFSET UNITYSDK_OFFSET(0x16C620B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16C5ED70)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x16C5F920)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16C5F8A0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x16C5F1F0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONDROP_OFFSET UNITYSDK_OFFSET(0x16C5FB60)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x16C5FA40)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x16C5FC10)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x16C602B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x16C60330)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x16C603B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x16C60640)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REFRESHCONTROLTYPE_OFFSET UNITYSDK_OFFSET(0x16C5FF80)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REFRESHPROCESSERBYPLATFORM_OFFSET UNITYSDK_OFFSET(0x16C60A00)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_CHANGEFOV_SCROLLY_OFFSET UNITYSDK_OFFSET(0x16C60FD0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_FOV_TWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0x16C617C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_MOVECAMY_DRAGY_OFFSET UNITYSDK_OFFSET(0x16C61E00)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_MOVEZPOS_SCROLLY_OFFSET UNITYSDK_OFFSET(0x16C60B40)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_MOVEZPOS_TWOPOINTDRAG_OFFSET UNITYSDK_OFFSET(0x16C61470)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_REG_ROTATEY_DRAGX_OFFSET UNITYSDK_OFFSET(0x16C61B70)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_WAITALLCLAMPFINISH_OFFSET UNITYSDK_OFFSET(0x16C60A80)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x16C621C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x16C62280)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x16C62320)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONDROP_OFFSET UNITYSDK_OFFSET(0x16C623C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x16C62460)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x16C62500)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x16C625A0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x16C62640)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x16C626E0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER___BASE_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x16C62780)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_TypeDefinitionIndex = 50466;
