...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x13891990)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x13891B00)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x13891A70)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY__CTOR_OFFSET UNITYSDK_OFFSET(0x13891890)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x13891B80)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x13891B90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x13891BF0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_Fov_ByScrollY_TypeDefinitionIndex = 57808;
