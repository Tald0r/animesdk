...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x191A35F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x191A3760)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x191A36D0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY__CTOR_OFFSET UNITYSDK_OFFSET(0x191A34F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x191A37E0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x191A37F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_FOV_BYSCROLLY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x191A3840)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_Fov_ByScrollY_TypeDefinitionIndex = 64790;
