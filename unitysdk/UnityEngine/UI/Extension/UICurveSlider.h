...
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER_ISVALID_OFFSET UNITYSDK_OFFSET(0x15AC5530)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER_REFRESHHANDLE_OFFSET UNITYSDK_OFFSET(0x15AC5930)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x15AC5870)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC5C80)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x15AC5D20)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UICurveSlider_TypeDefinitionIndex = 39167;
