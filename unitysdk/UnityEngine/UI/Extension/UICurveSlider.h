...
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER_ISVALID_OFFSET UNITYSDK_OFFSET(0x15F62260)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER_REFRESHHANDLE_OFFSET UNITYSDK_OFFSET(0x15F62660)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x15F625A0)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F629B0)
#define UNITYENGINE_UI_EXTENSION_UICURVESLIDER___BASE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x15F62A50)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UICurveSlider_TypeDefinitionIndex = 75267;
