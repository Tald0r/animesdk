...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F64320)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F64380)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED_INVOKE_OFFSET UNITYSDK_OFFSET(0x15F636C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED__CTOR_OFFSET UNITYSDK_OFFSET(0x15F64310)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_OnSnapCompleted_TypeDefinitionIndex = 38203;
