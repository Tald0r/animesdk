...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15AC7620)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15AC7680)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED_INVOKE_OFFSET UNITYSDK_OFFSET(0x15AC6990)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONSNAPCOMPLETED__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC7600)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_OnSnapCompleted_TypeDefinitionIndex = 81250;
