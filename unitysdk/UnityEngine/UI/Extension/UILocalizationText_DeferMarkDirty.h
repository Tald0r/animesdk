...
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_DEFERMARKDIRTY_FLUSHALLREQUEST_OFFSET UNITYSDK_OFFSET(0x181820F0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_DEFERMARKDIRTY_REMOVEDEFERMARKDIRTYREQUEST_OFFSET UNITYSDK_OFFSET(0x18182160)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_DEFERMARKDIRTY_REQUIREDEFERMARKDIRTY_OFFSET UNITYSDK_OFFSET(0x18181ED0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONTEXT_DEFERMARKDIRTY__CCTOR_OFFSET UNITYSDK_OFFSET(0x18182260)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UILocalizationText_DeferMarkDirty_TypeDefinitionIndex = 60557;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::UnityEngine::UI::Extension::UILocalizationText*>**)Il2CppClass::FromTypeDefinitionIndex(UILocalizationText_DeferMarkDirty_TypeDefinitionIndex)->GetStaticField(0x39520);
		}
		static ::Foundation::Coroutine::CoroutineHandle* StaticGet__deferHandle()
		{
			return (::Foundation::Coroutine::CoroutineHandle*)Il2CppClass::FromTypeDefinitionIndex(UILocalizationText_DeferMarkDirty_TypeDefinitionIndex)->GetStaticField(0xE3C0);
		}
