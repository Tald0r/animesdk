...
#define UNITYENGINE_UI_EXTENSION_UIHOTFIXTEXT_TRYREBUILDADJUSTEDTEXT_OFFSET UNITYSDK_OFFSET(0x15AC6700)
#define UNITYENGINE_UI_EXTENSION_UIHOTFIXTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC6770)
#define UNITYENGINE_UI_EXTENSION_UIHOTFIXTEXT___BASE_TRYREBUILDADJUSTEDTEXT_OFFSET UNITYSDK_OFFSET(0x15AC67C0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIHotfixText_TypeDefinitionIndex = 47607;
