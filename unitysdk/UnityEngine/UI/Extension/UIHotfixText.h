...
#define UNITYENGINE_UI_EXTENSION_UIHOTFIXTEXT_TRYREBUILDADJUSTEDTEXT_OFFSET UNITYSDK_OFFSET(0x15F63430)
#define UNITYENGINE_UI_EXTENSION_UIHOTFIXTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x15F634A0)
#define UNITYENGINE_UI_EXTENSION_UIHOTFIXTEXT___BASE_TRYREBUILDADJUSTEDTEXT_OFFSET UNITYSDK_OFFSET(0x15F634F0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIHotfixText_TypeDefinitionIndex = 65990;
