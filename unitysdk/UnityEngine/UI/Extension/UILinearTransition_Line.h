...
#define UNITYENGINE_UI_EXTENSION_UILINEARTRANSITION_LINE_GETLINECOEFFICIENTS_OFFSET UNITYSDK_OFFSET(0x9452C0)
#define UNITYENGINE_UI_EXTENSION_UILINEARTRANSITION_LINE_INTERSECTION_OFFSET UNITYSDK_OFFSET(0x1A8A65C0)
#define UNITYENGINE_UI_EXTENSION_UILINEARTRANSITION_LINE_NORMALIZEINRECT_OFFSET UNITYSDK_OFFSET(0x945370)
#define UNITYENGINE_UI_EXTENSION_UILINEARTRANSITION_LINE__CTOR_OFFSET UNITYSDK_OFFSET(0x945270)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UILinearTransition_Line_TypeDefinitionIndex = 63743;
