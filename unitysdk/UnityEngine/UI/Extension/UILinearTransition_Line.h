...
#define UNITYENGINE_UI_EXTENSION_UILINEARTRANSITION_LINE_GETLINECOEFFICIENTS_OFFSET UNITYSDK_OFFSET(0x7D52A0)
#define UNITYENGINE_UI_EXTENSION_UILINEARTRANSITION_LINE_INTERSECTION_OFFSET UNITYSDK_OFFSET(0x18213130)
#define UNITYENGINE_UI_EXTENSION_UILINEARTRANSITION_LINE_NORMALIZEINRECT_OFFSET UNITYSDK_OFFSET(0x7D5350)
#define UNITYENGINE_UI_EXTENSION_UILINEARTRANSITION_LINE__CTOR_OFFSET UNITYSDK_OFFSET(0x7D5250)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UILinearTransition_Line_TypeDefinitionIndex = 56970;
