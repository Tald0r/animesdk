...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_APPLYEVENTDATA_1_OFFSET UNITYSDK_OFFSET(0xD8618B0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0xD861830)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_CANINTERACT_1_OFFSET UNITYSDK_OFFSET(0xD8614D0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xD861420)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_CANRUNINCURRENTPLATFORM_OFFSET UNITYSDK_OFFSET(0xD8612B0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_CLAMP_OFFSET UNITYSDK_OFFSET(0xD861560)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD861170)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_GETDELTA_1_OFFSET UNITYSDK_OFFSET(0xD860FE0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_GETDELTA_OFFSET UNITYSDK_OFFSET(0xD860EF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0xD8617B0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_GET_ISCLAMPING_OFFSET UNITYSDK_OFFSET(0xD860AF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_HANDLEEVENTDATA_1_OFFSET UNITYSDK_OFFSET(0xD8616C0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_HANDLEEVENTDATA_OFFSET UNITYSDK_OFFSET(0xD8615C0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_ISINTERACTING_OFFSET UNITYSDK_OFFSET(0xD861350)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_REFRESHINTERACTSTATE_OFFSET UNITYSDK_OFFSET(0xD860B00)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_REFRESHSENSITIVITY_OFFSET UNITYSDK_OFFSET(0xD860C90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETENABLED_OFFSET UNITYSDK_OFFSET(0xD8613B0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETINTERACTSTATE_OFFSET UNITYSDK_OFFSET(0xD860C20)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETQUANTIZATIONTYPE_OFFSET UNITYSDK_OFFSET(0xD860DC0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETREVERSERATIO_OFFSET UNITYSDK_OFFSET(0xD860E70)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETRUNINCURRENTPLATFORMFUNC_OFFSET UNITYSDK_OFFSET(0xD861240)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE__CTOR_OFFSET UNITYSDK_OFFSET(0xD861940)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorBase_TypeDefinitionIndex = 74819;

	class InteractionRangeProcessorBase : public ::System::Object
	{
	public:
		::UnityEngine::Camera* m_cam; // 0x10
		::System::Func_2<::UnityEngine::EventSystems::PointerEventData*, ::System::Boolean>* m_canInteractFunc; // 0x18
		::System::Func_1<::System::Boolean>* m_canRunInCurrentPlatform; // 0x20
		::UnityEngine::AnimationCurve* m_clampCurve; // 0x28
		::UnityEngine::AnimationCurve* m_dampCurve; // 0x30
		::DG::Tweening::Tween* m_objResetTween; // 0x38
		::UnityEngine::UI::Extension::InteractionSegment m_beginInteractSeg; // 0x40
		::System::Boolean m_isInteracting; // 0x44
		::System::Boolean m_isClamping; // 0x45
		::System::Boolean m_enabled; // 0x46
		::System::Single m_clampDuration; // 0x48
		::System::Single m_pcSensitivity; // 0x4C
		::System::Single m_reverseRatio; // 0x50
		::System::Single m_mobileSensitivity; // 0x54
		...
		::UnityEngine::UI::Extension::Quantization m_quantizationType; // 0x64
