...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_APPLYEVENTDATA_1_OFFSET UNITYSDK_OFFSET(0x17CCF1A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x17CCF120)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_CANINTERACT_1_OFFSET UNITYSDK_OFFSET(0x17CCEDC0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x17CCED10)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_CANRUNINCURRENTPLATFORM_OFFSET UNITYSDK_OFFSET(0x17CCEBA0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_CLAMP_OFFSET UNITYSDK_OFFSET(0x17CCEE50)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x17CCEA60)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_GETDELTA_1_OFFSET UNITYSDK_OFFSET(0x17CCE8D0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_GETDELTA_OFFSET UNITYSDK_OFFSET(0x17CCE7E0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x17CCF0A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_GET_ISCLAMPING_OFFSET UNITYSDK_OFFSET(0x17CCE3E0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_HANDLEEVENTDATA_1_OFFSET UNITYSDK_OFFSET(0x17CCEFB0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_HANDLEEVENTDATA_OFFSET UNITYSDK_OFFSET(0x17CCEEB0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_ISINTERACTING_OFFSET UNITYSDK_OFFSET(0x17CCEC40)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_REFRESHINTERACTSTATE_OFFSET UNITYSDK_OFFSET(0x17CCE3F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_REFRESHSENSITIVITY_OFFSET UNITYSDK_OFFSET(0x17CCE580)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETENABLED_OFFSET UNITYSDK_OFFSET(0x17CCECA0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETINTERACTSTATE_OFFSET UNITYSDK_OFFSET(0x17CCE510)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETQUANTIZATIONTYPE_OFFSET UNITYSDK_OFFSET(0x17CCE6B0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETREVERSERATIO_OFFSET UNITYSDK_OFFSET(0x17CCE760)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE_SETRUNINCURRENTPLATFORMFUNC_OFFSET UNITYSDK_OFFSET(0x17CCEB30)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17CCF230)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorBase_TypeDefinitionIndex = 38500;

	class InteractionRangeProcessorBase : public ::System::Object
	{
	public:
		::UnityEngine::AnimationCurve* m_dampCurve; // 0x10
		::UnityEngine::AnimationCurve* m_clampCurve; // 0x18
		::UnityEngine::Camera* m_cam; // 0x20
		::DG::Tweening::Tween* m_objResetTween; // 0x28
		::System::Func_1<::System::Boolean>* m_canRunInCurrentPlatform; // 0x30
		...
		::System::Single m_consoleSensitivity; // 0x44
		::System::Boolean m_isClamping; // 0x48
		::System::Boolean m_enabled; // 0x49
		::System::Boolean m_isInteracting; // 0x4A
		::UnityEngine::UI::Extension::Quantization m_quantizationType; // 0x4C
		::System::Single m_mobileSensitivity; // 0x50
		::UnityEngine::UI::Extension::InteractionSegment m_beginInteractSeg; // 0x54
		::UnityEngine::UI::Extension::InteractionSegment m_endInteractSeg; // 0x58
		::System::Single m_clampDuration; // 0x5C
		::System::Single m_sensitivity; // 0x60
