...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_ATTACHTOTABLEVIEW_OFFSET UNITYSDK_OFFSET(0x1664D560)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1664D170)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x1664CF80)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1664CFA0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_RELEASECACHE_OFFSET UNITYSDK_OFFSET(0x1664D830)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_SETSTATEACTIVE_OFFSET UNITYSDK_OFFSET(0x1664D040)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_SET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x1664CF90)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_SET_STATE_OFFSET UNITYSDK_OFFSET(0x1664CFB0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_START_OFFSET UNITYSDK_OFFSET(0x1664D260)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x1664D890)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableViewCell_TypeDefinitionIndex = 50906;
