...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_ATTACHTOTABLEVIEW_OFFSET UNITYSDK_OFFSET(0x1853B7A0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1853B3B0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_GET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x1853B1C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1853B1E0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_RELEASECACHE_OFFSET UNITYSDK_OFFSET(0x1853BA70)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_SETSTATEACTIVE_OFFSET UNITYSDK_OFFSET(0x1853B280)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_SET_ASSETPATH_OFFSET UNITYSDK_OFFSET(0x1853B1D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_SET_STATE_OFFSET UNITYSDK_OFFSET(0x1853B1F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL_START_OFFSET UNITYSDK_OFFSET(0x1853B4A0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEWCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x1853BAD0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableViewCell_TypeDefinitionIndex = 58078;
