...
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ADDBUTTONCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x19C28AE0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_AFTERPRESSEDUPANIM_OFFSET UNITYSDK_OFFSET(0x19C27E70)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_AWAKE_OFFSET UNITYSDK_OFFSET(0x19C28F50)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_CLEARPOINTERSTATE_OFFSET UNITYSDK_OFFSET(0x19C26F70)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_DEALBUTTONEXCLICK_OFFSET UNITYSDK_OFFSET(0x19C29290)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ENABLE_OFFSET UNITYSDK_OFFSET(0x19C284E0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_GETLONGPRESSTIME_OFFSET UNITYSDK_OFFSET(0x19C297F0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_GET_BUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x19C260E0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x19C276E0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x19C276D0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_HANDLEPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x19C26550)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_HANDLEPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x19C26100)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x19C26D10)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_HANDLEPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x19C27030)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_HANDLEPOINTERUP_OFFSET UNITYSDK_OFFSET(0x19C26620)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_HASONPOINTERDOWNACTION_OFFSET UNITYSDK_OFFSET(0x19C27BB0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_HASONPOINTERENTERACTION_OFFSET UNITYSDK_OFFSET(0x19C27CB0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_HASONPOINTEREXITACTION_OFFSET UNITYSDK_OFFSET(0x19C27D30)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_HASONPOINTERUPACTION_OFFSET UNITYSDK_OFFSET(0x19C27C30)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19C29920)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19C29890)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x19C27330)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C27DB0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19C28310)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ONDRAG_OFFSET UNITYSDK_OFFSET(0x19C273F0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ONDROP_OFFSET UNITYSDK_OFFSET(0x19C272A0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19C289B0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x19C274B0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x19C29B60)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19C28D30)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_PLAYCLICKSOUND_OFFSET UNITYSDK_OFFSET(0x19C29550)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_PREPARECLICKSOUND_OFFSET UNITYSDK_OFFSET(0x19C29370)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x19C26490)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_REMOVEBUTTONCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x19C28BD0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_REMOVECLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x19C28C80)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_RESETTRIGGER_OFFSET UNITYSDK_OFFSET(0x19C287F0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_SELECT_OFFSET UNITYSDK_OFFSET(0x19C27F30)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_SETLONGPRESSTRIGGERTIMEOVERRIDE_OFFSET UNITYSDK_OFFSET(0x19C28220)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_SETNORMALIFINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x19C27A00)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_SETNORMAL_OFFSET UNITYSDK_OFFSET(0x19C278E0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_SETPRESSED_OFFSET UNITYSDK_OFFSET(0x19C277B0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_SETSELECTSTATE_OFFSET UNITYSDK_OFFSET(0x19C28110)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_SETSELECT_OFFSET UNITYSDK_OFFSET(0x19C27A80)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_SET_BUTTONSTATE_OFFSET UNITYSDK_OFFSET(0x19C260F0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_SIRENIX_SERIALIZATION_ISUPPORTSPREFABSERIALIZATION_GET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0x19C27570)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_SIRENIX_SERIALIZATION_ISUPPORTSPREFABSERIALIZATION_SET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0x19C27620)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_START_OFFSET UNITYSDK_OFFSET(0x19C290E0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_STOPLONGPRESS_OFFSET UNITYSDK_OFFSET(0x19C282A0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_TRIGGERPRESSEDUP_OFFSET UNITYSDK_OFFSET(0x19C268E0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_TRYINVOKEONPOINTERDOWNACTION_OFFSET UNITYSDK_OFFSET(0x19C263D0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_TRYINVOKEONPOINTERENTERACTION_OFFSET UNITYSDK_OFFSET(0x19C26EB0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_TRYINVOKEONPOINTEREXITACTION_OFFSET UNITYSDK_OFFSET(0x19C271E0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_TRYINVOKEONPOINTERUPACTION_OFFSET UNITYSDK_OFFSET(0x19C26820)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX_UPDATELONGPRESSSTATE_OFFSET UNITYSDK_OFFSET(0x19C28DB0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__CTOR_OFFSET UNITYSDK_OFFSET(0x19C29D60)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__RESETTRIGGER_G__CHECKRESET_100_0_OFFSET UNITYSDK_OFFSET(0x19C299B0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x19C2A090)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX___BASE_HANDLEPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x19C2A120)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX___BASE_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x19C2A190)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX___BASE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x19C2A200)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C2A210)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19C2A2A0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX___BASE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x19C2A2B0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19C2A2C0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX___BASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x19C2A2D0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX___BASE_SELECT_OFFSET UNITYSDK_OFFSET(0x19C2A2E0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX___BASE_START_OFFSET UNITYSDK_OFFSET(0x19C2A2F0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX___BASE_TRIGGERPRESSEDUP_OFFSET UNITYSDK_OFFSET(0x19C2A380)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIButtonEx_TypeDefinitionIndex = 53635;
