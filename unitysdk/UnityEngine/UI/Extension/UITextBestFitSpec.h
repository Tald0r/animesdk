...
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_COMPARETO_OFFSET UNITYSDK_OFFSET(0x6700C0)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_DEFAULTSIZESAVED_OFFSET UNITYSDK_OFFSET(0x670040)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_GETADAPTEDORDEFAULT_OFFSET UNITYSDK_OFFSET(0x10BB3E50)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_GETPERFERSIZE_OFFSET UNITYSDK_OFFSET(0x66FF20)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_GET_ADAPTEDMAXSIZE_OFFSET UNITYSDK_OFFSET(0x2F6540)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_GET_ADAPTEDMINSIZE_OFFSET UNITYSDK_OFFSET(0x2EC6E0)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_GET_DEFAULTMAXSIZE_OFFSET UNITYSDK_OFFSET(0x302230)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_GET_DEFAULTMINSIZE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_RESETADAPTEDSIZE_OFFSET UNITYSDK_OFFSET(0x66FFD0)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_SETADAPTEDSIZE_OFFSET UNITYSDK_OFFSET(0x66FF30)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_SET_ADAPTEDMAXSIZE_OFFSET UNITYSDK_OFFSET(0x302AB0)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_SET_ADAPTEDMINSIZE_OFFSET UNITYSDK_OFFSET(0x3028C0)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_SET_DEFAULTMAXSIZE_OFFSET UNITYSDK_OFFSET(0x302120)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_SET_DEFAULTMINSIZE_OFFSET UNITYSDK_OFFSET(0x302300)
#define UNITYENGINE_UI_EXTENSION_UITEXTBESTFITSPEC_TRYSAVEDEFAULTSIZE_OFFSET UNITYSDK_OFFSET(0x6700B0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITextBestFitSpec_TypeDefinitionIndex = 63532;
