...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x18212680)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX_GETVALUE_OFFSET UNITYSDK_OFFSET(0x18212900)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX_SETVALUE_OFFSET UNITYSDK_OFFSET(0x182126F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX__CTOR_OFFSET UNITYSDK_OFFSET(0x18212510)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x18212A00)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x18212A10)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEY_BYDELTAX___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x18212A60)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_RotateY_ByDeltaX_TypeDefinitionIndex = 61580;
