...
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0x16EB5C90)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_CLEARSAVEDVERTPOS_OFFSET UNITYSDK_OFFSET(0x16EB6C50)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_CREATEIMAGE_OFFSET UNITYSDK_OFFSET(0x16EB7F10)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_CREATEKEY_OFFSET UNITYSDK_OFFSET(0x16EB8270)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_DOCOMMONREFRESHKEYPANEL_OFFSET UNITYSDK_OFFSET(0x16EB6460)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_GETFITSCALE_1_OFFSET UNITYSDK_OFFSET(0x16EB9F00)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_GETFITSCALE_OFFSET UNITYSDK_OFFSET(0x16EB7DD0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_GETIMGHEIGHT_OFFSET UNITYSDK_OFFSET(0x16EBA030)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_GETORCREATEICONITEM_OFFSET UNITYSDK_OFFSET(0x16EB8470)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_GETRICHTAGREQUIREINFO_OFFSET UNITYSDK_OFFSET(0x16EB60F0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_GETSTANDFONTSIZE_OFFSET UNITYSDK_OFFSET(0x16EB5B10)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_GET_ENABLEREGISTERINPUTDEVICECHANGENOTIFY_OFFSET UNITYSDK_OFFSET(0x16EB4E20)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x16EB57C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_GET__ISAWAKED_OFFSET UNITYSDK_OFFSET(0x16EB4E30)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_INTERNALSETTEXT_OFFSET UNITYSDK_OFFSET(0x16EB4F30)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x16EB4E40)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_LOADSPRITE_OFFSET UNITYSDK_OFFSET(0x16EB65C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ONAPPLYFONTSIZECONFIG_OFFSET UNITYSDK_OFFSET(0x16EBA0B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16EB5EB0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16EB5BC0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ONINPUTDEVICECHANGED_OFFSET UNITYSDK_OFFSET(0x16EB63F0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ONKEYBINDINGUPDATED_OFFSET UNITYSDK_OFFSET(0x16EB61D0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ONLOCALIZATIONCHANGE_OFFSET UNITYSDK_OFFSET(0x16EBA130)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x16EB6EC0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ONREFRESHKEYPANEL_OFFSET UNITYSDK_OFFSET(0x16EB6380)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_ONUILAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x16EB6240)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_REFRESHIMGPOS_OFFSET UNITYSDK_OFFSET(0x16EB4FB0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_SAVEVERTPOS_OFFSET UNITYSDK_OFFSET(0x16EB6CE0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_SETIMGANCHORBYTRANS_OFFSET UNITYSDK_OFFSET(0x16EB6B80)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_SETTEXTFUNC_OFFSET UNITYSDK_OFFSET(0x16EBA290)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_SETTEXT_OFFSET UNITYSDK_OFFSET(0x16EB5660)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x16EB5840)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_SHOWALLIMAGE_OFFSET UNITYSDK_OFFSET(0x16EB6D70)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_TRYREBUILDADJUSTEDTEXT_OFFSET UNITYSDK_OFFSET(0x16EBA3E0)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_UNITYENGINE_UI_EXTENSION_IIMGICONLOADER_LOADNEXTICON_OFFSET UNITYSDK_OFFSET(0x16EB8C70)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT_WAITFORREBUILDOVER_OFFSET UNITYSDK_OFFSET(0x16EB5720)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x16EBA540)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x16EBA660)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_GETRICHTAGREQUIREINFO_OFFSET UNITYSDK_OFFSET(0x16EBA680)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x16EBA670)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_ONAPPLYFONTSIZECONFIG_OFFSET UNITYSDK_OFFSET(0x16EBA700)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16EBA770)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16EBA780)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_ONINPUTDEVICECHANGED_OFFSET UNITYSDK_OFFSET(0x16EBA790)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_ONKEYBINDINGUPDATED_OFFSET UNITYSDK_OFFSET(0x16EBA800)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_ONLOCALIZATIONCHANGE_OFFSET UNITYSDK_OFFSET(0x16EBA870)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x16EBA880)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_ONREFRESHKEYPANEL_OFFSET UNITYSDK_OFFSET(0x16EBA890)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_ONUILAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x16EBA900)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_SETTEXTFUNC_OFFSET UNITYSDK_OFFSET(0x16EBA920)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x16EBA910)
#define UNITYENGINE_UI_EXTENSION_UIIMGTEXT___BASE_TRYREBUILDADJUSTEDTEXT_OFFSET UNITYSDK_OFFSET(0x16EBA930)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgText_TypeDefinitionIndex = 65026;
