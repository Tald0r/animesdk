...
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONIMAGE_AWAKE_OFFSET UNITYSDK_OFFSET(0x196FD8C0)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONIMAGE_UPDATEIMAGE_1_OFFSET UNITYSDK_OFFSET(0x196FDA10)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONIMAGE_UPDATEIMAGE_OFFSET UNITYSDK_OFFSET(0x196FD990)
#define UNITYENGINE_UI_EXTENSION_UILOCALIZATIONIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x196FDBF0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UILocalizationImage_TypeDefinitionIndex = 54144;
