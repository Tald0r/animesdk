...
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19C2A3F0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C2A7B0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C2A810)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19C2A7C0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C2A3E0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONEX__AFTERPRESSEDUPANIM_D__77__CTOR_OFFSET UNITYSDK_OFFSET(0x19C27F20)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIButtonEx__AfterPressedUpAnim_d__77_TypeDefinitionIndex = 53637;
