...
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1_GET_USECUSTOMRECTTRANSFORMSPACE_OFFSET UNITYSDK_OFFSET(0x16EB2F30)
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x16EB3140)
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1_START_OFFSET UNITYSDK_OFFSET(0x16EB2FC0)
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1__CTOR_OFFSET UNITYSDK_OFFSET(0x16EB2F40)
#define UNITYENGINE_UI_EXTENSION_NORMALIZEDPOSITIONASUV1___BASE_START_OFFSET UNITYSDK_OFFSET(0x16EB3B20)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int NormalizedPositionAsUV1_TypeDefinitionIndex = 66139;
