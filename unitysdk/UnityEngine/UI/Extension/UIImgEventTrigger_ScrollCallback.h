...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_SCROLLCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A555F90)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_SCROLLCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A555FC0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_SCROLLCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A555A90)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_SCROLLCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A555A80)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_ScrollCallback_TypeDefinitionIndex = 50475;
