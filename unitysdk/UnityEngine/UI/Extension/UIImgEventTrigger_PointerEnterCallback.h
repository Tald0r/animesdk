...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16C40E80)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16C40EB0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x16C40980)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16C40970)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_PointerEnterCallback_TypeDefinitionIndex = 50483;
