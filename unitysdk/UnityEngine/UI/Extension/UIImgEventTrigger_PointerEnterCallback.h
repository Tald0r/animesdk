...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ABBA800)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ABBA830)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ABBA300)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_POINTERENTERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABBA2E0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_PointerEnterCallback_TypeDefinitionIndex = 45348;
