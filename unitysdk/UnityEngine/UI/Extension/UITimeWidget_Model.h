...
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_MODEL_GET_ISEND_OFFSET UNITYSDK_OFFSET(0xD8663B0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_MODEL_ONCREATEPROPERTY_OFFSET UNITYSDK_OFFSET(0xD8663D0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_MODEL_SET_ISEND_OFFSET UNITYSDK_OFFSET(0xD8663C0)
#define UNITYENGINE_UI_EXTENSION_UITIMEWIDGET_MODEL__CTOR_OFFSET UNITYSDK_OFFSET(0xD866330)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITimeWidget_Model_TypeDefinitionIndex = 64955;

	class UITimeWidget_Model : public ::Class_1_F57C3EEEB03201AF
	{
	public:
		::Class_0_16E4307DCC41950C_13<::System::Boolean>* _IsEnd_k__BackingField; // 0x60
