...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_APPLYDELTA_OFFSET UNITYSDK_OFFSET(0x15AC4C20)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x15AC4CE0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_CLAMPANGLE_OFFSET UNITYSDK_OFFSET(0x15AC4330)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_CLAMP_OFFSET UNITYSDK_OFFSET(0x15AC4740)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x15AC52F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_GOTOVAL_OFFSET UNITYSDK_OFFSET(0x15AC4A10)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_NORMALIZEANGLE180_OFFSET UNITYSDK_OFFSET(0x15AC4280)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_NORMALIZEANGLE_OFFSET UNITYSDK_OFFSET(0x15AC41F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_SETCENTERVAL_OFFSET UNITYSDK_OFFSET(0x15AC4170)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC5360)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE___BASE_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x15AC53D0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE___BASE_CLAMP_OFFSET UNITYSDK_OFFSET(0x15AC5450)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE___BASE_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x15AC54B0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorEulerAngle_TypeDefinitionIndex = 76634;
