...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_APPLYDELTA_OFFSET UNITYSDK_OFFSET(0x15F61950)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x15F61A10)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_CLAMPANGLE_OFFSET UNITYSDK_OFFSET(0x15F61060)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_CLAMP_OFFSET UNITYSDK_OFFSET(0x15F61470)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x15F62020)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_GOTOVAL_OFFSET UNITYSDK_OFFSET(0x15F61740)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_NORMALIZEANGLE180_OFFSET UNITYSDK_OFFSET(0x15F60FB0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_NORMALIZEANGLE_OFFSET UNITYSDK_OFFSET(0x15F60F20)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE_SETCENTERVAL_OFFSET UNITYSDK_OFFSET(0x15F60EA0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x15F62090)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE___BASE_APPLYEVENTDATA_OFFSET UNITYSDK_OFFSET(0x15F62100)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE___BASE_CLAMP_OFFSET UNITYSDK_OFFSET(0x15F62180)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOREULERANGLE___BASE_GETTOTALSIZE_OFFSET UNITYSDK_OFFSET(0x15F621E0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorEulerAngle_TypeDefinitionIndex = 74515;
