...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER__WAITUNTILALLCLAMPFINISH_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x458160)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORMANAGER__WAITUNTILALLCLAMPFINISH_D__11_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorManager__WaitUntilAllClampFinish_d__11_TypeDefinitionIndex = 73272;
