...
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x16C3EE40)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_CHECKCOLDDOWN_OFFSET UNITYSDK_OFFSET(0x16C3F8A0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_CHECKPROTECT_OFFSET UNITYSDK_OFFSET(0x16C40460)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_GET_CANINTERACTFORMONOINPUTKEY_OFFSET UNITYSDK_OFFSET(0x16C3E5D0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_GET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x16C3E5B0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_HANDLEPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x16C40380)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x16C403F0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ISINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x16C3F270)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_MAYINTERACT_OFFSET UNITYSDK_OFFSET(0x16C3F0F0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x16C3E5F0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONDRAG_OFFSET UNITYSDK_OFFSET(0x16C3E8F0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16C3EED0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x16C3EB40)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x16C3EDC0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x16C3FDA0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x16C3FAE0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x16C3FE60)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x16C3FFB0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x16C3FC60)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONRAWPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x16C401E0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONRAWPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x16C40100)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONRAWPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x16C402A0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONRAWPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x16C40310)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_ONRAWPOINTERUP_OFFSET UNITYSDK_OFFSET(0x16C40170)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_PASSCLICKPRECHECK_OFFSET UNITYSDK_OFFSET(0x16C40670)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_SETCANTCLICKWHENHASDRAGED_OFFSET UNITYSDK_OFFSET(0x16C3E870)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_SETCLICKPRECHECK_OFFSET UNITYSDK_OFFSET(0x16C3FBF0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_SETGAMEPADMODULELOSTFOCUSSTATE_OFFSET UNITYSDK_OFFSET(0x16C3EFB0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_SETPOINTERDOWNINNER_OFFSET UNITYSDK_OFFSET(0x16C3F490)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_SETPOINTERUPINNER_OFFSET UNITYSDK_OFFSET(0x16C3F640)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_SET_CANINTERACTFORMONOINPUTKEY_OFFSET UNITYSDK_OFFSET(0x16C3E5E0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_SET_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x16C3E5C0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_SIMULATEPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x16C3F6B0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_SIMULATEPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x16C3F330)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_SIMULATEPOINTERUP_OFFSET UNITYSDK_OFFSET(0x16C3F500)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE_TRIGGERPRESSEDUP_OFFSET UNITYSDK_OFFSET(0x16C40610)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x16C40720)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x16C407B0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE___BASE_ISINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x16C407C0)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16C40870)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE___BASE_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x16C40880)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE___BASE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x16C40930)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE___BASE_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x16C40940)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE___BASE_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x16C40950)
#define UNITYENGINE_UI_EXTENSION_UIBUTTONBASE___BASE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x16C40960)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIButtonBase_TypeDefinitionIndex = 76958;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(UIButtonBase_TypeDefinitionIndex)->GetStaticField(0xFF50);
		}
