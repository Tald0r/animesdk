...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xD861F70)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY_GETVALUE_OFFSET UNITYSDK_OFFSET(0xD8621F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY_SETVALUE_OFFSET UNITYSDK_OFFSET(0xD861FE0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY__CTOR_OFFSET UNITYSDK_OFFSET(0xD861E00)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0xD8622F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0xD8623A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0xD8623F0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_RotateX_ByDeltaY_TypeDefinitionIndex = 42212;
