...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x17CCF870)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x17CCFAF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x17CCF8E0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY__CTOR_OFFSET UNITYSDK_OFFSET(0x17CCF700)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x17CCFBF0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x17CCFCA0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_ROTATEX_BYDELTAY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x17CCFD00)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_RotateX_ByDeltaY_TypeDefinitionIndex = 67543;
