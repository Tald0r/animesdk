...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ACTIVEDRAG_OFFSET UNITYSDK_OFFSET(0xD618290)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDCELL_OFFSET UNITYSDK_OFFSET(0xD61ADC0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDDATAAT_1_OFFSET UNITYSDK_OFFSET(0xD615FB0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDDATAAT_OFFSET UNITYSDK_OFFSET(0xD615ED0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDDATA_1_OFFSET UNITYSDK_OFFSET(0xD615E00)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDDATA_OFFSET UNITYSDK_OFFSET(0xD615C70)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0xD619420)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATEACTIVECELLSASYNC_OFFSET UNITYSDK_OFFSET(0xD61D320)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATEACTIVECELLS_OFFSET UNITYSDK_OFFSET(0xD61CE20)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATECELLOFFSETS_OFFSET UNITYSDK_OFFSET(0xD61B780)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATECELLSIZES_OFFSET UNITYSDK_OFFSET(0xD61B920)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATECONTAINERSIZE_OFFSET UNITYSDK_OFFSET(0xD61C400)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATECURRENTACTIVECELLRANGE_OFFSET UNITYSDK_OFFSET(0xD61D000)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATESCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0xD61A380)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CHECKDATASTATE_OFFSET UNITYSDK_OFFSET(0xD618730)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CLEARDELAY_OFFSET UNITYSDK_OFFSET(0xD617D90)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CLEAR_OFFSET UNITYSDK_OFFSET(0xD617820)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_DEQUEUEORCREATECELL_OFFSET UNITYSDK_OFFSET(0xD61A840)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_EXPANDLINESIZE_OFFSET UNITYSDK_OFFSET(0xD61B670)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETCELLAT_OFFSET UNITYSDK_OFFSET(0xD6164B0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETCELL_OFFSET UNITYSDK_OFFSET(0xD617720)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETCONTAINERSIZE_OFFSET UNITYSDK_OFFSET(0xD61DD10)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETDATAAT_OFFSET UNITYSDK_OFFSET(0xD616BC0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETDATAINDEXBYCELL_OFFSET UNITYSDK_OFFSET(0xD617650)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETDATAINDEX_OFFSET UNITYSDK_OFFSET(0xD617040)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETDATA_OFFSET UNITYSDK_OFFSET(0xD616AB0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETLINEINDEXATPOSITION_1_OFFSET UNITYSDK_OFFSET(0xD61D7E0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETLINEINDEXATPOSITION_OFFSET UNITYSDK_OFFSET(0xD61A210)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETONETABLEVIEWCELL_OFFSET UNITYSDK_OFFSET(0xD61AA70)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_AXISRECTS_OFFSET UNITYSDK_OFFSET(0xD61A300)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0xD615B10)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_ISCALCULATE_OFFSET UNITYSDK_OFFSET(0xD615840)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_MAXPERLINE_OFFSET UNITYSDK_OFFSET(0xD6157B0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_PADDING_OFFSET UNITYSDK_OFFSET(0xD61A7A0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_SCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0xD615860)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_SCROLLRECTSIZE_OFFSET UNITYSDK_OFFSET(0xD615A00)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_SELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0xD615BE0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_SELECTEDITEM_OFFSET UNITYSDK_OFFSET(0xD615B30)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_HANDLECLICK_OFFSET UNITYSDK_OFFSET(0xD6192A0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_HANDLEPRESS_OFFSET UNITYSDK_OFFSET(0xD6191C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ISDISABLED_OFFSET UNITYSDK_OFFSET(0xD6187E0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ISSELECTED_OFFSET UNITYSDK_OFFSET(0xD618630)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_JUMPTO_1_OFFSET UNITYSDK_OFFSET(0xD6185A0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_JUMPTO_OFFSET UNITYSDK_OFFSET(0xD6184D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_LINEAR_OFFSET UNITYSDK_OFFSET(0xD61DC50)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD61DDA0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD61A0C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD61A050)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xD618E30)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0xD618C40)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0xD619130)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0xD61D490)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_RECYCLECELL_OFFSET UNITYSDK_OFFSET(0xD616940)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_REFRESHPOSITION_OFFSET UNITYSDK_OFFSET(0xD61DB60)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_REFRESH_OFFSET UNITYSDK_OFFSET(0xD618300)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_RELEASECACHES_OFFSET UNITYSDK_OFFSET(0xD618090)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_REMOVEDATAAT_OFFSET UNITYSDK_OFFSET(0xD6166B0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_REMOVEDATA_OFFSET UNITYSDK_OFFSET(0xD6165A0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_RESIZEARRAY_OFFSET UNITYSDK_OFFSET(0xD61B410)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETCELLPOSITION_OFFSET UNITYSDK_OFFSET(0xD61AFA0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETDATAAT_1_OFFSET UNITYSDK_OFFSET(0xD6162F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETDATAAT_OFFSET UNITYSDK_OFFSET(0xD616200)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETDISABLEAT_1_OFFSET UNITYSDK_OFFSET(0xD616CE0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETDISABLEAT_OFFSET UNITYSDK_OFFSET(0xD616C60)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSELECTAT_1_OFFSET UNITYSDK_OFFSET(0xD6171D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSELECTAT_OFFSET UNITYSDK_OFFSET(0xD6172C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSELECT_1_OFFSET UNITYSDK_OFFSET(0xD616FA0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSELECT_OFFSET UNITYSDK_OFFSET(0xD616EB0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSTATE_1_OFFSET UNITYSDK_OFFSET(0xD616DC0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSTATE_OFFSET UNITYSDK_OFFSET(0xD618A90)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SET_ISCALCULATE_OFFSET UNITYSDK_OFFSET(0xD615850)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SET_MAXPERLINE_OFFSET UNITYSDK_OFFSET(0xD6157C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SET_SCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0xD615870)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYCALCULATEACTIVECELLS_OFFSET UNITYSDK_OFFSET(0xD61CCF0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYJUMPTO_OFFSET UNITYSDK_OFFSET(0xD61D6F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYSHOULDKEEPPOSITION_OFFSET UNITYSDK_OFFSET(0xD61D3C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYSTARTSNAP_OFFSET UNITYSDK_OFFSET(0xD618F10)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYSTOPCALCULATEACTIVECELLS_OFFSET UNITYSDK_OFFSET(0xD617B90)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYSTOPSNAP_OFFSET UNITYSDK_OFFSET(0xD617CA0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TWEENPOSITION_OFFSET UNITYSDK_OFFSET(0xD61A6B0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_UPDATEACTIVECELLSTATES_OFFSET UNITYSDK_OFFSET(0xD6188E0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_UPDATESELECTION_OFFSET UNITYSDK_OFFSET(0xD617340)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0xD61D8D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0xD61DE30)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0xD61E1F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0xD61E200)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xD61E210)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0xD61E220)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xD61E230)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0xD61E2B0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0xD61E340)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_TypeDefinitionIndex = 81242;
