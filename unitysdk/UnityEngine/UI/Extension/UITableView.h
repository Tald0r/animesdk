...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ACTIVEDRAG_OFFSET UNITYSDK_OFFSET(0x1A55A2D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDCELL_OFFSET UNITYSDK_OFFSET(0x1A55CE10)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDDATAAT_1_OFFSET UNITYSDK_OFFSET(0x1A557FF0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDDATAAT_OFFSET UNITYSDK_OFFSET(0x1A557F10)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDDATA_1_OFFSET UNITYSDK_OFFSET(0x1A557E40)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ADDDATA_OFFSET UNITYSDK_OFFSET(0x1A557CB0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A55B460)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATEACTIVECELLSASYNC_OFFSET UNITYSDK_OFFSET(0x1A55F380)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATEACTIVECELLS_OFFSET UNITYSDK_OFFSET(0x1A55EE80)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATECELLOFFSETS_OFFSET UNITYSDK_OFFSET(0x1A55D7D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATECELLSIZES_OFFSET UNITYSDK_OFFSET(0x1A55D970)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATECONTAINERSIZE_OFFSET UNITYSDK_OFFSET(0x1A55E460)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATECURRENTACTIVECELLRANGE_OFFSET UNITYSDK_OFFSET(0x1A55F060)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CALCULATESCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0x1A55C3D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CHECKDATASTATE_OFFSET UNITYSDK_OFFSET(0x1A55A770)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CLEARDELAY_OFFSET UNITYSDK_OFFSET(0x1A559DD0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A559860)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_DEQUEUEORCREATECELL_OFFSET UNITYSDK_OFFSET(0x1A55C890)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_EXPANDLINESIZE_OFFSET UNITYSDK_OFFSET(0x1A55D6C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETCELLAT_OFFSET UNITYSDK_OFFSET(0x1A5584F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETCELL_OFFSET UNITYSDK_OFFSET(0x1A559760)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETCONTAINERSIZE_OFFSET UNITYSDK_OFFSET(0x1A55FD70)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETDATAAT_OFFSET UNITYSDK_OFFSET(0x1A558C00)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETDATAINDEXBYCELL_OFFSET UNITYSDK_OFFSET(0x1A559690)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETDATAINDEX_OFFSET UNITYSDK_OFFSET(0x1A559080)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETDATA_OFFSET UNITYSDK_OFFSET(0x1A558AF0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETLINEINDEXATPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1A55F840)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETLINEINDEXATPOSITION_OFFSET UNITYSDK_OFFSET(0x1A55C260)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GETONETABLEVIEWCELL_OFFSET UNITYSDK_OFFSET(0x1A55CAC0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_AXISRECTS_OFFSET UNITYSDK_OFFSET(0x1A55C350)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0x1A557B50)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_ISCALCULATE_OFFSET UNITYSDK_OFFSET(0x1A557880)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_MAXPERLINE_OFFSET UNITYSDK_OFFSET(0x1A5577F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x1A55C7F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_SCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0x1A5578A0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_SCROLLRECTSIZE_OFFSET UNITYSDK_OFFSET(0x1A557A40)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_SELECTEDINDEX_OFFSET UNITYSDK_OFFSET(0x1A557C20)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_GET_SELECTEDITEM_OFFSET UNITYSDK_OFFSET(0x1A557B70)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_HANDLECLICK_OFFSET UNITYSDK_OFFSET(0x1A55B2E0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_HANDLEPRESS_OFFSET UNITYSDK_OFFSET(0x1A55B200)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ISDISABLED_OFFSET UNITYSDK_OFFSET(0x1A55A820)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ISSELECTED_OFFSET UNITYSDK_OFFSET(0x1A55A670)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_JUMPTO_1_OFFSET UNITYSDK_OFFSET(0x1A55A5E0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_JUMPTO_OFFSET UNITYSDK_OFFSET(0x1A55A510)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_LINEAR_OFFSET UNITYSDK_OFFSET(0x1A55FCB0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A55FE00)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A55C110)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A55C0A0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1A55AE70)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x1A55AC80)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x1A55B170)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A55F4F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_RECYCLECELL_OFFSET UNITYSDK_OFFSET(0x1A558980)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_REFRESHPOSITION_OFFSET UNITYSDK_OFFSET(0x1A55FBC0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A55A340)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_RELEASECACHES_OFFSET UNITYSDK_OFFSET(0x1A55A0D0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_REMOVEDATAAT_OFFSET UNITYSDK_OFFSET(0x1A5586F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_REMOVEDATA_OFFSET UNITYSDK_OFFSET(0x1A5585E0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_RESIZEARRAY_OFFSET UNITYSDK_OFFSET(0x1A55D460)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETCELLPOSITION_OFFSET UNITYSDK_OFFSET(0x1A55CFF0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETDATAAT_1_OFFSET UNITYSDK_OFFSET(0x1A558330)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETDATAAT_OFFSET UNITYSDK_OFFSET(0x1A558240)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETDISABLEAT_1_OFFSET UNITYSDK_OFFSET(0x1A558D20)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETDISABLEAT_OFFSET UNITYSDK_OFFSET(0x1A558CA0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSELECTAT_1_OFFSET UNITYSDK_OFFSET(0x1A559210)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSELECTAT_OFFSET UNITYSDK_OFFSET(0x1A559300)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSELECT_1_OFFSET UNITYSDK_OFFSET(0x1A558FE0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSELECT_OFFSET UNITYSDK_OFFSET(0x1A558EF0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSTATE_1_OFFSET UNITYSDK_OFFSET(0x1A558E00)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1A55AAD0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SET_ISCALCULATE_OFFSET UNITYSDK_OFFSET(0x1A557890)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SET_MAXPERLINE_OFFSET UNITYSDK_OFFSET(0x1A557800)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_SET_SCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0x1A5578B0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYCALCULATEACTIVECELLS_OFFSET UNITYSDK_OFFSET(0x1A55ED50)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYJUMPTO_OFFSET UNITYSDK_OFFSET(0x1A55F750)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYSHOULDKEEPPOSITION_OFFSET UNITYSDK_OFFSET(0x1A55F420)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYSTARTSNAP_OFFSET UNITYSDK_OFFSET(0x1A55AF50)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYSTOPCALCULATEACTIVECELLS_OFFSET UNITYSDK_OFFSET(0x1A559BD0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TRYSTOPSNAP_OFFSET UNITYSDK_OFFSET(0x1A559CE0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_TWEENPOSITION_OFFSET UNITYSDK_OFFSET(0x1A55C700)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_UPDATEACTIVECELLSTATES_OFFSET UNITYSDK_OFFSET(0x1A55A920)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_UPDATESELECTION_OFFSET UNITYSDK_OFFSET(0x1A559380)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A55F930)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1A55FE90)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A560250)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A560260)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A560270)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A560280)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1A560290)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONINITIALIZEPOTENTIALDRAG_OFFSET UNITYSDK_OFFSET(0x1A560310)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW___BASE_ONPOSITIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A5603A0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_TypeDefinitionIndex = 38191;
