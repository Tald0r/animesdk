...
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_CLEANMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0x1ABBAB30)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_GETMODIFIEDMATERIALPOST_OFFSET UNITYSDK_OFFSET(0x1ABBAEC0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1ABBAD00)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_GET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1ABBA840)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_MODIFIERSORTORDER_OFFSET UNITYSDK_OFFSET(0x1ABBAE60)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ABBAC70)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ABBAAC0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1ABBA950)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_SET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1ABBA850)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABBAFE0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABBAFC0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ABBB020)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ABBB0B0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIMouseToMaterial_TypeDefinitionIndex = 39365;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMouseToMaterial_TypeDefinitionIndex)->GetStaticField(0x11720);
		}
