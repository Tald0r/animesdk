...
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_CLEANMATERIALCACHE_OFFSET UNITYSDK_OFFSET(0x16C411B0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_GETMODIFIEDMATERIALPOST_OFFSET UNITYSDK_OFFSET(0x16C41540)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x16C41380)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_GET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x16C40EC0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_MODIFIERSORTORDER_OFFSET UNITYSDK_OFFSET(0x16C414E0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16C412F0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16C41140)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x16C40FD0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL_SET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x16C40ED0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x16C41660)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x16C41640)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x16C416A0)
#define UNITYENGINE_UI_EXTENSION_UIMOUSETOMATERIAL___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16C41730)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIMouseToMaterial_TypeDefinitionIndex = 43023;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(UIMouseToMaterial_TypeDefinitionIndex)->GetStaticField(0xFF60);
		}
