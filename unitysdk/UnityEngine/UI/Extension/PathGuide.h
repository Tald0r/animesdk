...
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_CLEARPATHPOINTS_OFFSET UNITYSDK_OFFSET(0x1A41F300)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GETMODIFIEDMATERIALPOST_OFFSET UNITYSDK_OFFSET(0x1A4203B0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A4202B0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GETPATHPOINT_OFFSET UNITYSDK_OFFSET(0x1A41F090)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_ENDCULLDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A41F5E0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A41EA20)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A41ED90)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_PATHGUIDEMESH_OFFSET UNITYSDK_OFFSET(0x1A41EF10)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A41E990)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_QUADSIZE_OFFSET UNITYSDK_OFFSET(0x1A41F370)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_SPACING_OFFSET UNITYSDK_OFFSET(0x1A41F440)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_STARTCULLDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A41F510)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1A41EC60)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A420A70)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A420B60)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1A41F6B0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SETPATHPOINTSDIRTY_OFFSET UNITYSDK_OFFSET(0x1A41F040)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SETPATHPOINTS_OFFSET UNITYSDK_OFFSET(0x1A41F1E0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SETPATHPOINT_OFFSET UNITYSDK_OFFSET(0x1A41F110)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_ENDCULLDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A41F5F0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A41EDA0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_PATHGUIDEMESH_OFFSET UNITYSDK_OFFSET(0x1A41EF20)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_QUADSIZE_OFFSET UNITYSDK_OFFSET(0x1A41F380)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_SPACING_OFFSET UNITYSDK_OFFSET(0x1A41F450)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_STARTCULLDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A41F520)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1A41EC70)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A420BB0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A41E9A0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A420C40)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A420C10)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A420C50)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A420C60)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1A420D00)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A420D10)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int PathGuide_TypeDefinitionIndex = 8472;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PathGuide_TypeDefinitionIndex)->GetStaticField(0x3B30);
		}
		static ::System::Int32* StaticGet_QuadCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PathGuide_TypeDefinitionIndex)->GetStaticField(0x3B34);
		}
		static ::System::Int32* StaticGet_TransformData2Array()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PathGuide_TypeDefinitionIndex)->GetStaticField(0x3B38);
		}
