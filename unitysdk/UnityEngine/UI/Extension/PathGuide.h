...
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_CLEARPATHPOINTS_OFFSET UNITYSDK_OFFSET(0x1A9F5160)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GETMODIFIEDMATERIALPOST_OFFSET UNITYSDK_OFFSET(0x1A9F6210)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A9F6110)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GETPATHPOINT_OFFSET UNITYSDK_OFFSET(0x1A9F4EF0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_ENDCULLDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A9F5440)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A9F4880)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A9F4BF0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_PATHGUIDEMESH_OFFSET UNITYSDK_OFFSET(0x1A9F4D70)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A9F47F0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_QUADSIZE_OFFSET UNITYSDK_OFFSET(0x1A9F51D0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_SPACING_OFFSET UNITYSDK_OFFSET(0x1A9F52A0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_STARTCULLDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A9F5370)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1A9F4AC0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A9F68D0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A9F69C0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1A9F5510)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SETPATHPOINTSDIRTY_OFFSET UNITYSDK_OFFSET(0x1A9F4EA0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SETPATHPOINTS_OFFSET UNITYSDK_OFFSET(0x1A9F5040)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SETPATHPOINT_OFFSET UNITYSDK_OFFSET(0x1A9F4F70)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_ENDCULLDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A9F5450)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A9F4C00)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_PATHGUIDEMESH_OFFSET UNITYSDK_OFFSET(0x1A9F4D80)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_QUADSIZE_OFFSET UNITYSDK_OFFSET(0x1A9F51E0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_SPACING_OFFSET UNITYSDK_OFFSET(0x1A9F52B0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_STARTCULLDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A9F5380)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE_SET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1A9F4AD0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9F6A10)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9F4800)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_GETMODIFIEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A9F6AA0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A9F6A70)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A9F6AB0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A9F6AC0)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1A9F6B60)
#define UNITYENGINE_UI_EXTENSION_PATHGUIDE___BASE_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A9F6B70)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int PathGuide_TypeDefinitionIndex = 8482;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PathGuide_TypeDefinitionIndex)->GetStaticField(0x3B50);
		}
		static ::System::Int32* StaticGet_QuadCount()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PathGuide_TypeDefinitionIndex)->GetStaticField(0x3B54);
		}
		static ::System::Int32* StaticGet_TransformData1Array()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(PathGuide_TypeDefinitionIndex)->GetStaticField(0x3B58);
		}
