...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1826FA20)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1826FBA0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1826FA90)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX__CTOR_OFFSET UNITYSDK_OFFSET(0x1826F920)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1826FC30)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1826FC40)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1826FC90)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_WorldPositionX_DragX_TypeDefinitionIndex = 79286;
