...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1815F4F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1815F670)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1815F560)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX__CTOR_OFFSET UNITYSDK_OFFSET(0x1815F3F0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x1815F700)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1815F710)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_WORLDPOSITIONX_DRAGX___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1815F770)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_WorldPositionX_DragX_TypeDefinitionIndex = 50002;
