...
#define UNITYENGINE_UI_EXTENSION_RADARCHART_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B73E0A0)
#define UNITYENGINE_UI_EXTENSION_RADARCHART_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1B73EC60)
#define UNITYENGINE_UI_EXTENSION_RADARCHART_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B73EBE0)
#define UNITYENGINE_UI_EXTENSION_RADARCHART_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1B73E2F0)
#define UNITYENGINE_UI_EXTENSION_RADARCHART_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1B73EAE0)
#define UNITYENGINE_UI_EXTENSION_RADARCHART_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1B73EB30)
#define UNITYENGINE_UI_EXTENSION_RADARCHART_SETRADARDATA_OFFSET UNITYSDK_OFFSET(0x1B73DFE0)
#define UNITYENGINE_UI_EXTENSION_RADARCHART_SET_RADARDATAARRAY_OFFSET UNITYSDK_OFFSET(0x1B73DF80)
#define UNITYENGINE_UI_EXTENSION_RADARCHART__CTOR_OFFSET UNITYSDK_OFFSET(0x1B73E080)
#define UNITYENGINE_UI_EXTENSION_RADARCHART___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B73ED10)
#define UNITYENGINE_UI_EXTENSION_RADARCHART___BASE_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1B73ED40)
#define UNITYENGINE_UI_EXTENSION_RADARCHART___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B73EE10)
#define UNITYENGINE_UI_EXTENSION_RADARCHART___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1B73EEB0)
#define UNITYENGINE_UI_EXTENSION_RADARCHART___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1B73EEC0)
#define UNITYENGINE_UI_EXTENSION_RADARCHART___BASE_ONTRANSFORMPARENTCHANGED_OFFSET UNITYSDK_OFFSET(0x1B73EED0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int RadarChart_TypeDefinitionIndex = 8483;
