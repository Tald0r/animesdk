...
#define UNITYENGINE_UI_EXTENSION_UICUSTOMCORNER_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x15AC5FE0)
#define UNITYENGINE_UI_EXTENSION_UICUSTOMCORNER_START_OFFSET UNITYSDK_OFFSET(0x15AC5E60)
#define UNITYENGINE_UI_EXTENSION_UICUSTOMCORNER__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC5DE0)
#define UNITYENGINE_UI_EXTENSION_UICUSTOMCORNER___BASE_START_OFFSET UNITYSDK_OFFSET(0x15AC6670)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UICustomCorner_TypeDefinitionIndex = 63019;
