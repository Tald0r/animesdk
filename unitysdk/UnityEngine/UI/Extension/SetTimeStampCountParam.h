...
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_GET_ENDCALL_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x306AA0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x272280)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x6A85000)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x6A84F50)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_SET_ENDCALL_OFFSET UNITYSDK_OFFSET(0x3123A0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x30FC20)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_SET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x302310)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int SetTimeStampCountParam_TypeDefinitionIndex = 67283;
