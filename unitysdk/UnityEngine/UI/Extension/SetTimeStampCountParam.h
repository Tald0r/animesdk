...
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_GET_ENDCALL_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_GET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x2D71A0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x16EB3DB0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x16EB3D00)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_SET_ENDCALL_OFFSET UNITYSDK_OFFSET(0x2D26A0)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_SET_ISENABLE_OFFSET UNITYSDK_OFFSET(0x2D4930)
#define UNITYENGINE_UI_EXTENSION_SETTIMESTAMPCOUNTPARAM_SET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x2CB170)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int SetTimeStampCountParam_TypeDefinitionIndex = 70501;
