...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTENDDRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17CD0880)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTENDDRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17CD08B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTENDDRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x17CD0380)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTENDDRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17CD0370)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_TwoPointEndDragCallback_TypeDefinitionIndex = 50474;
