...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x17CCF410)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x17CCF500)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x17CCF480)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY__CTOR_OFFSET UNITYSDK_OFFSET(0x17CCF2A0)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY___BASE_CANINTERACT_OFFSET UNITYSDK_OFFSET(0x17CCF590)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY___BASE_GETVALUE_OFFSET UNITYSDK_OFFSET(0x17CCF640)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSOR_LOCALPOSITIONY_DRAGY___BASE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x17CCF6A0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessor_LocalPositionY_DragY_TypeDefinitionIndex = 50353;
