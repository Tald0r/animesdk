...
#define UNITYENGINE_UI_EXTENSION_RUBYSTRING_PAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x2CAD00)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int RubyString_Pair_TypeDefinitionIndex = 55304;
