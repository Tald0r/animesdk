...
#define UNITYENGINE_UI_EXTENSION_RUBYSTRING_GET_BASESTRING_OFFSET UNITYSDK_OFFSET(0x17CD0250)
#define UNITYENGINE_UI_EXTENSION_RUBYSTRING_GET_DATA_OFFSET UNITYSDK_OFFSET(0x17CD0260)
#define UNITYENGINE_UI_EXTENSION_RUBYSTRING_GET_RAWSTRING_OFFSET UNITYSDK_OFFSET(0x17CD0240)
#define UNITYENGINE_UI_EXTENSION_RUBYSTRING_PARSE_OFFSET UNITYSDK_OFFSET(0x17CCFD60)
#define UNITYENGINE_UI_EXTENSION_RUBYSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17CD0270)
#define UNITYENGINE_UI_EXTENSION_RUBYSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x17CD02D0)
#define UNITYENGINE_UI_EXTENSION_RUBYSTRING___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17CD0330)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int RubyString_TypeDefinitionIndex = 55303;

	class RubyString : public ::System::Object
	{
	public:
		::System::String* baseString; // 0x10
		::System::String* rawString; // 0x18
