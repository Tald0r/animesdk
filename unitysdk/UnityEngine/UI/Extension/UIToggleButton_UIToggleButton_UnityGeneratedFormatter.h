...
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_UITOGGLEBUTTON_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x16EBDD20)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_UITOGGLEBUTTON_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x16EBDD30)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_UITOGGLEBUTTON_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x16EBDF30)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_UITOGGLEBUTTON_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x16EBE0F0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_UITOGGLEBUTTON_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16EBE0B0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIToggleButton_UIToggleButton_UnityGeneratedFormatter_TypeDefinitionIndex = 77076;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::MoleMole::Config::ConfigSoundActionGeneral*>**)Il2CppClass::FromTypeDefinitionIndex(UIToggleButton_UIToggleButton_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x37060);
		}
