...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15AC75B0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15AC75F0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x15AC6F80)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC6F60)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_OnCellEvent_TypeDefinitionIndex = 81246;
