...
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLEVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x15F642C0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLEVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x15F64300)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLEVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x15F63CA0)
#define UNITYENGINE_UI_EXTENSION_UITABLEVIEW_ONCELLEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x15F63C90)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITableView_OnCellEvent_TypeDefinitionIndex = 38194;
