...
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_ADDBUTTONCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x1534FD80)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_ADDCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x1534F860)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_AWAKE_OFFSET UNITYSDK_OFFSET(0x15350290)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_DEALBUTTONEXCLICK_OFFSET UNITYSDK_OFFSET(0x15350670)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_DOSTATETRANSITION_OFFSET UNITYSDK_OFFSET(0x1534F9C0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_GET_ISON_OFFSET UNITYSDK_OFFSET(0x1534F070)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_GET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0x1534F1E0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x1534F250)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1534F240)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_HANDLEPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x15350D20)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_HANDLEPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x15350B70)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x15350D90)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_HANDLEPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x15350E20)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_HANDLEPOINTERUP_OFFSET UNITYSDK_OFFSET(0x15350C00)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15350F40)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x15350EB0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_PLAYTOGGLESOUND_OFFSET UNITYSDK_OFFSET(0x15350720)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_REFRESHSTATE_1_OFFSET UNITYSDK_OFFSET(0x1534FAB0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x1534F150)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_REGISTERSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1534F6E0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_REMOVEBUTTONCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x1534FE70)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_REMOVECLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x1534F5C0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_REMOVESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1534F7A0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_RESETTRIGGER_OFFSET UNITYSDK_OFFSET(0x1534FF20)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_SET_ISON_OFFSET UNITYSDK_OFFSET(0x1534F080)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_SET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0x1534F210)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_START_OFFSET UNITYSDK_OFFSET(0x15350470)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_SWALLOWBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x15350AE0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_SWALLOWCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x1534F320)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x15350FD0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON__RESETTRIGGER_G__CHECKRESET_31_0_OFFSET UNITYSDK_OFFSET(0x153500E0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x15351070)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON___BASE_DOSTATETRANSITION_OFFSET UNITYSDK_OFFSET(0x15351100)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON___BASE_HANDLEPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x15351110)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON___BASE_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x15351180)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON___BASE_START_OFFSET UNITYSDK_OFFSET(0x153511F0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIToggleButton_TypeDefinitionIndex = 73008;
