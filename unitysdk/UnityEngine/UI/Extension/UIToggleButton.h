...
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_ADDBUTTONCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x18183630)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_ADDCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x18183110)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_AWAKE_OFFSET UNITYSDK_OFFSET(0x18183B40)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_DEALBUTTONEXCLICK_OFFSET UNITYSDK_OFFSET(0x18183F20)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_DOSTATETRANSITION_OFFSET UNITYSDK_OFFSET(0x18183270)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_GET_ISON_OFFSET UNITYSDK_OFFSET(0x18182920)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_GET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0x18182A90)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x18182B00)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x18182AF0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_HANDLEPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x181845E0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_HANDLEPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x18184430)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x18184650)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_HANDLEPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x181846E0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_HANDLEPOINTERUP_OFFSET UNITYSDK_OFFSET(0x181844C0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x18184800)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x18184770)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_PLAYTOGGLESOUND_OFFSET UNITYSDK_OFFSET(0x18183FD0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_REFRESHSTATE_1_OFFSET UNITYSDK_OFFSET(0x18183360)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0x18182A00)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_REGISTERSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x18182F90)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_REMOVEBUTTONCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x18183720)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_REMOVECLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x18182E70)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_REMOVESTATECHANGE_OFFSET UNITYSDK_OFFSET(0x18183050)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_RESETTRIGGER_OFFSET UNITYSDK_OFFSET(0x181837D0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_SET_ISON_OFFSET UNITYSDK_OFFSET(0x18182930)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_SET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0x18182AC0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_START_OFFSET UNITYSDK_OFFSET(0x18183D20)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_SWALLOWBUTTONCLICK_OFFSET UNITYSDK_OFFSET(0x181843A0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON_SWALLOWCLICKLISTENER_OFFSET UNITYSDK_OFFSET(0x18182BD0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x18184890)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON__RESETTRIGGER_G__CHECKRESET_31_0_OFFSET UNITYSDK_OFFSET(0x18183990)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x18184930)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON___BASE_DOSTATETRANSITION_OFFSET UNITYSDK_OFFSET(0x181849C0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON___BASE_HANDLEPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x181849D0)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON___BASE_HANDLEPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x18184A40)
#define UNITYENGINE_UI_EXTENSION_UITOGGLEBUTTON___BASE_START_OFFSET UNITYSDK_OFFSET(0x18184AB0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIToggleButton_TypeDefinitionIndex = 77074;
