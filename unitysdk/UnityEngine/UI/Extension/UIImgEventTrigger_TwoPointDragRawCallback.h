...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGRAWCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x10BB3130)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGRAWCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x10BB31E0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGRAWCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x10BB2D30)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_TWOPOINTDRAGRAWCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x10BB2D10)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_TwoPointDragRawCallback_TypeDefinitionIndex = 45335;
