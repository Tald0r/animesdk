...
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_BEGINDRAGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16EB4860)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_BEGINDRAGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16EB48C0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_BEGINDRAGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x16EB40B0)
#define UNITYENGINE_UI_EXTENSION_UIIMGEVENTTRIGGER_BEGINDRAGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16EB40A0)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UIImgEventTrigger_BeginDragCallback_TypeDefinitionIndex = 50484;
