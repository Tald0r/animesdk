...
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1853AC10)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT___C__DISPLAYCLASS3_0__GOTOVAL_B__0_OFFSET UNITYSDK_OFFSET(0x1853AC20)
#define UNITYENGINE_UI_EXTENSION_INTERACTIONRANGEPROCESSORFLOAT___C__DISPLAYCLASS3_0__GOTOVAL_B__1_OFFSET UNITYSDK_OFFSET(0x1853AC90)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int InteractionRangeProcessorFloat___c__DisplayClass3_0_TypeDefinitionIndex = 55142;
