...
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ADDLOCKTAB_OFFSET UNITYSDK_OFFSET(0xF4BB630)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ADDTAB_1_OFFSET UNITYSDK_OFFSET(0xF4BBAF0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ADDTAB_2_OFFSET UNITYSDK_OFFSET(0xF4BBB90)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ADDTAB_OFFSET UNITYSDK_OFFSET(0xF4BB410)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_AWAKE_OFFSET UNITYSDK_OFFSET(0xF4B8F90)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_BINDNOTIFICATIONNODE_1_OFFSET UNITYSDK_OFFSET(0xF4B9B50)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_BINDNOTIFICATIONNODE_OFFSET UNITYSDK_OFFSET(0xF4B9A30)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CHANGEENDTABINDEX_OFFSET UNITYSDK_OFFSET(0xF4BA7E0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CHANGETWOTABINDEX_OFFSET UNITYSDK_OFFSET(0xF4BAC00)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CLEARSELECTTAB_OFFSET UNITYSDK_OFFSET(0xF4BC330)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CLEARTABS_OFFSET UNITYSDK_OFFSET(0xF4BB330)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_CLICKTAB_OFFSET UNITYSDK_OFFSET(0xF4B9210)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_COLLECTUITABLEBUTTON_OFFSET UNITYSDK_OFFSET(0xF4BD090)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GETENABLETABBUTTONCOUNT_OFFSET UNITYSDK_OFFSET(0xF4BCB00)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GETORDEREDENABLEDTABS_OFFSET UNITYSDK_OFFSET(0xF4BD530)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_CURPOSINDEX_OFFSET UNITYSDK_OFFSET(0xF4B8BD0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_CURSELECTKEY_OFFSET UNITYSDK_OFFSET(0xF4B8BC0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0xF4B8BE0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xF4BB090)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_ORDEREDKEYS_OFFSET UNITYSDK_OFFSET(0xF4B8C00)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0xF4B8EC0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xF4B8EB0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_GET_TABBUTTONCOUNT_OFFSET UNITYSDK_OFFSET(0xF4B8E80)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_HIDEALLTABS_OFFSET UNITYSDK_OFFSET(0xF4BC990)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ISCANCLICKLOGIC_OFFSET UNITYSDK_OFFSET(0xF4BBE20)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ONCLICKTAB_OFFSET UNITYSDK_OFFSET(0xF4BD480)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0xF4B9190)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_PLAYCLICKSOUND_OFFSET UNITYSDK_OFFSET(0xF4BCCD0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_REGISTERCLICK_OFFSET UNITYSDK_OFFSET(0xF4BD2B0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_RESIZE_OFFSET UNITYSDK_OFFSET(0xF4BD6D0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SAFESETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0xF4BA2D0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SELECTANDCALLMETHOD_OFFSET UNITYSDK_OFFSET(0xF4BBED0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SELECTTAB_OFFSET UNITYSDK_OFFSET(0xF4BBF90)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETASSETLOADPROXY_OFFSET UNITYSDK_OFFSET(0xF4BB190)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETBUTTONACTIVE_OFFSET UNITYSDK_OFFSET(0xF4B9400)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETCANCLICKLOGIC_OFFSET UNITYSDK_OFFSET(0xF4BBDB0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETCLICKPRECHECK_OFFSET UNITYSDK_OFFSET(0xF4BD320)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETENABLE_OFFSET UNITYSDK_OFFSET(0xF4BC490)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETSELECTEDIMAGEBYKEY_OFFSET UNITYSDK_OFFSET(0xF4BC790)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETSELECTEDIMAGE_OFFSET UNITYSDK_OFFSET(0xF4BC590)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABCOUNT_OFFSET UNITYSDK_OFFSET(0xF4BA3D0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABICON_OFFSET UNITYSDK_OFFSET(0xF4B98B0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABLOCKBYMETHOD_OFFSET UNITYSDK_OFFSET(0xF4B9F50)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABLOCK_OFFSET UNITYSDK_OFFSET(0xF4BA1D0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABNAMEBYMETHOD_OFFSET UNITYSDK_OFFSET(0xF4B9520)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABNAME_OFFSET UNITYSDK_OFFSET(0xF4B97A0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABNOTIFICATIONNODEBYMETHOD_OFFSET UNITYSDK_OFFSET(0xF4B9CD0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SET_INTERACTABLE_OFFSET UNITYSDK_OFFSET(0xF4B8BF0)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SHOWBUTTONBYCOUNT_OFFSET UNITYSDK_OFFSET(0xF4B9350)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP__ADDLOCKTAB_G__WRAPCALLBACK_40_0_OFFSET UNITYSDK_OFFSET(0xF4BB880)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0xF4BDF50)
#define UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP__GETORDEREDENABLEDTABS_B__69_0_OFFSET UNITYSDK_OFFSET(0xF4BE000)

namespace UnityEngine::UI::Extension
{
	inline static constexpr unsigned int UITabButtonGroup_TypeDefinitionIndex = 70748;
	...
	public:
		...
		::System::Void BindNotificationNode_1(::System::Int32 index, ::Class_1_79526D80B8F6897C* node)
		{
			return ((::System::Void(*)(::PVOID, ::System::Int32, ::Class_1_79526D80B8F6897C*))((::PBYTE)hIl2Cpp + UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_BINDNOTIFICATIONNODE_1_OFFSET))(this, index, node);
		}

		::System::Void SetTabNotificationNodeByMethod(::System::Func_2<::System::Int32, ::Class_1_79526D80B8F6897C*>* notificationNodeMethod)
		{
			return ((::System::Void(*)(::PVOID, ::System::Func_2<::System::Int32, ::Class_1_79526D80B8F6897C*>*))((::PBYTE)hIl2Cpp + UNITYENGINE_UI_EXTENSION_UITABBUTTONGROUP_SETTABNOTIFICATIONNODEBYMETHOD_OFFSET))(this, notificationNodeMethod);
		}
