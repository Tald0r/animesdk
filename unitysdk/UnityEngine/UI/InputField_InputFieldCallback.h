...
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19EC1F50)
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19EC1F80)
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19EC1A50)
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC1A40)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int InputField_InputFieldCallback_TypeDefinitionIndex = 8358;
