...
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A463B40)
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A463B70)
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A463640)
#define UNITYENGINE_UI_INPUTFIELD_INPUTFIELDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A463620)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int InputField_InputFieldCallback_TypeDefinitionIndex = 8368;
