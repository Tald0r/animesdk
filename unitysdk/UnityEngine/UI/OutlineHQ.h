...
#define UNITYENGINE_UI_OUTLINEHQ_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1A4C1210)
#define UNITYENGINE_UI_OUTLINEHQ__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4C1180)
#define UNITYENGINE_UI_OUTLINEHQ___BASE_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1A4C1600)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int OutlineHQ_TypeDefinitionIndex = 78368;
