...
#define UNITYENGINE_UI_OUTLINEHQ_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xD5D7C30)
#define UNITYENGINE_UI_OUTLINEHQ__CTOR_OFFSET UNITYSDK_OFFSET(0xD5D7BA0)
#define UNITYENGINE_UI_OUTLINEHQ___BASE_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xD5D8020)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int OutlineHQ_TypeDefinitionIndex = 67940;
