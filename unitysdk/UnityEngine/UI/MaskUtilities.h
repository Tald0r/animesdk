...
#define UNITYENGINE_UI_MASKUTILITIES_FINDROOTSORTOVERRIDECANVAS_OFFSET UNITYSDK_OFFSET(0x1AC509E0)
#define UNITYENGINE_UI_MASKUTILITIES_GETRECTMASKFORCLIPPABLE_OFFSET UNITYSDK_OFFSET(0x1AC52060)
#define UNITYENGINE_UI_MASKUTILITIES_GETRECTMASKSFORCLIP_OFFSET UNITYSDK_OFFSET(0x1AC52560)
#define UNITYENGINE_UI_MASKUTILITIES_GETSMOOTHMASK_OFFSET UNITYSDK_OFFSET(0x1AC51970)
#define UNITYENGINE_UI_MASKUTILITIES_GETSTENCILDEPTH_OFFSET UNITYSDK_OFFSET(0x1AC50BD0)
#define UNITYENGINE_UI_MASKUTILITIES_ISDESCENDANTORSELF_OFFSET UNITYSDK_OFFSET(0x1AC51DD0)
#define UNITYENGINE_UI_MASKUTILITIES_NOTIFY2DMASKSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1AC51380)
#define UNITYENGINE_UI_MASKUTILITIES_NOTIFYSMOOTHMASKCHANGED_OFFSET UNITYSDK_OFFSET(0x1AC51730)
#define UNITYENGINE_UI_MASKUTILITIES_NOTIFYSTENCILSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1AC4F4B0)
#define UNITYENGINE_UI_MASKUTILITIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC528F0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int MaskUtilities_TypeDefinitionIndex = 8407;
