...
#define UNITYENGINE_UI_LAYOUTGROUP_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1AE21360)
#define UNITYENGINE_UI_LAYOUTGROUP_DELAYEDSETDIRTY_OFFSET UNITYSDK_OFFSET(0x1AE23350)
#define UNITYENGINE_UI_LAYOUTGROUP_GETALIGNMENTONAXIS_OFFSET UNITYSDK_OFFSET(0x1AE222C0)
#define UNITYENGINE_UI_LAYOUTGROUP_GETCHILDALONGAXISWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1AE22DE0)
#define UNITYENGINE_UI_LAYOUTGROUP_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x1AE21CB0)
#define UNITYENGINE_UI_LAYOUTGROUP_GETSTARTOFFSET_OFFSET UNITYSDK_OFFSET(0x1AE22070)
#define UNITYENGINE_UI_LAYOUTGROUP_GETTOTALFLEXIBLESIZE_OFFSET UNITYSDK_OFFSET(0x1AE21AA0)
#define UNITYENGINE_UI_LAYOUTGROUP_GETTOTALMINSIZE_OFFSET UNITYSDK_OFFSET(0x1AE21880)
#define UNITYENGINE_UI_LAYOUTGROUP_GETTOTALPREFERREDSIZE_OFFSET UNITYSDK_OFFSET(0x1AE21990)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_CHILDALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1AE211B0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x1AE21C30)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x1AE21A40)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_ISROOTLAYOUTGROUP_OFFSET UNITYSDK_OFFSET(0x1AE230A0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1AE21CA0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1AE21B50)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x1AE21820)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_BOTTOM_OFFSET UNITYSDK_OFFSET(0x1AE20FD0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_LEFT_OFFSET UNITYSDK_OFFSET(0x1AE21070)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x1AE20D10)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_RIGHT_OFFSET UNITYSDK_OFFSET(0x1AE21110)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_TOP_OFFSET UNITYSDK_OFFSET(0x1AE20DD0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1AE21BC0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x1AE21930)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_RECTCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AE21350)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AE21240)
#define UNITYENGINE_UI_LAYOUTGROUP_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AE22020)
#define UNITYENGINE_UI_LAYOUTGROUP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AE21E50)
#define UNITYENGINE_UI_LAYOUTGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AE21DE0)
#define UNITYENGINE_UI_LAYOUTGROUP_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1AE21EF0)
#define UNITYENGINE_UI_LAYOUTGROUP_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1AE21FB0)
#define UNITYENGINE_UI_LAYOUTGROUP_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1AE23270)
#define UNITYENGINE_UI_LAYOUTGROUP_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x1AE23300)
#define UNITYENGINE_UI_LAYOUTGROUP_SETCHILDALONGAXISWITHSCALE_1_OFFSET UNITYSDK_OFFSET(0x1AE22990)
#define UNITYENGINE_UI_LAYOUTGROUP_SETCHILDALONGAXISWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1AE22520)
#define UNITYENGINE_UI_LAYOUTGROUP_SETCHILDALONGAXIS_1_OFFSET UNITYSDK_OFFSET(0x1AE22870)
#define UNITYENGINE_UI_LAYOUTGROUP_SETCHILDALONGAXIS_OFFSET UNITYSDK_OFFSET(0x1AE22450)
#define UNITYENGINE_UI_LAYOUTGROUP_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1AE20E70)
#define UNITYENGINE_UI_LAYOUTGROUP_SETLAYOUTINPUTFORAXIS_OFFSET UNITYSDK_OFFSET(0x1AE22350)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_CHILDALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1AE211C0)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_BOTTOM_OFFSET UNITYSDK_OFFSET(0x1AE20FF0)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_LEFT_OFFSET UNITYSDK_OFFSET(0x1AE21090)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_OFFSET UNITYSDK_OFFSET(0x1AE20D20)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_RIGHT_OFFSET UNITYSDK_OFFSET(0x1AE21130)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_TOP_OFFSET UNITYSDK_OFFSET(0x1AE20DF0)
#define UNITYENGINE_UI_LAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE21D00)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AE233D0)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AE23460)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AE234F0)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1AE23580)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1AE23610)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1AE236A0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int LayoutGroup_TypeDefinitionIndex = 8385;
