...
#define UNITYENGINE_UI_LAYOUTGROUP_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1B43AC40)
#define UNITYENGINE_UI_LAYOUTGROUP_DELAYEDSETDIRTY_OFFSET UNITYSDK_OFFSET(0x1B43CC30)
#define UNITYENGINE_UI_LAYOUTGROUP_GETALIGNMENTONAXIS_OFFSET UNITYSDK_OFFSET(0x1B43BBA0)
#define UNITYENGINE_UI_LAYOUTGROUP_GETCHILDALONGAXISWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1B43C6C0)
#define UNITYENGINE_UI_LAYOUTGROUP_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x1B43B590)
#define UNITYENGINE_UI_LAYOUTGROUP_GETSTARTOFFSET_OFFSET UNITYSDK_OFFSET(0x1B43B950)
#define UNITYENGINE_UI_LAYOUTGROUP_GETTOTALFLEXIBLESIZE_OFFSET UNITYSDK_OFFSET(0x1B43B380)
#define UNITYENGINE_UI_LAYOUTGROUP_GETTOTALMINSIZE_OFFSET UNITYSDK_OFFSET(0x1B43B160)
#define UNITYENGINE_UI_LAYOUTGROUP_GETTOTALPREFERREDSIZE_OFFSET UNITYSDK_OFFSET(0x1B43B270)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_CHILDALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1B43AA90)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B43B510)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x1B43B320)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_ISROOTLAYOUTGROUP_OFFSET UNITYSDK_OFFSET(0x1B43C980)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B43B580)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B43B430)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x1B43B100)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_BOTTOM_OFFSET UNITYSDK_OFFSET(0x1B43A8B0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_LEFT_OFFSET UNITYSDK_OFFSET(0x1B43A950)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x1B43A5F0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_RIGHT_OFFSET UNITYSDK_OFFSET(0x1B43A9F0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PADDING_TOP_OFFSET UNITYSDK_OFFSET(0x1B43A6B0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B43B4A0)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x1B43B210)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_RECTCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B43AC30)
#define UNITYENGINE_UI_LAYOUTGROUP_GET_RECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B43AB20)
#define UNITYENGINE_UI_LAYOUTGROUP_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B43B900)
#define UNITYENGINE_UI_LAYOUTGROUP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B43B730)
#define UNITYENGINE_UI_LAYOUTGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B43B6C0)
#define UNITYENGINE_UI_LAYOUTGROUP_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B43B7D0)
#define UNITYENGINE_UI_LAYOUTGROUP_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1B43B890)
#define UNITYENGINE_UI_LAYOUTGROUP_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1B43CB50)
#define UNITYENGINE_UI_LAYOUTGROUP_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x1B43CBE0)
#define UNITYENGINE_UI_LAYOUTGROUP_SETCHILDALONGAXISWITHSCALE_1_OFFSET UNITYSDK_OFFSET(0x1B43C270)
#define UNITYENGINE_UI_LAYOUTGROUP_SETCHILDALONGAXISWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1B43BE00)
#define UNITYENGINE_UI_LAYOUTGROUP_SETCHILDALONGAXIS_1_OFFSET UNITYSDK_OFFSET(0x1B43C150)
#define UNITYENGINE_UI_LAYOUTGROUP_SETCHILDALONGAXIS_OFFSET UNITYSDK_OFFSET(0x1B43BD30)
#define UNITYENGINE_UI_LAYOUTGROUP_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1B43A750)
#define UNITYENGINE_UI_LAYOUTGROUP_SETLAYOUTINPUTFORAXIS_OFFSET UNITYSDK_OFFSET(0x1B43BC30)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_CHILDALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1B43AAA0)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_BOTTOM_OFFSET UNITYSDK_OFFSET(0x1B43A8D0)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_LEFT_OFFSET UNITYSDK_OFFSET(0x1B43A970)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_OFFSET UNITYSDK_OFFSET(0x1B43A600)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_RIGHT_OFFSET UNITYSDK_OFFSET(0x1B43AA10)
#define UNITYENGINE_UI_LAYOUTGROUP_SET_PADDING_TOP_OFFSET UNITYSDK_OFFSET(0x1B43A6D0)
#define UNITYENGINE_UI_LAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B43B5E0)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B43CCB0)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B43CD40)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B43CDD0)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B43CE60)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1B43CEF0)
#define UNITYENGINE_UI_LAYOUTGROUP___BASE_ONRECTTRANSFORMDIMENSIONSCHANGE_OFFSET UNITYSDK_OFFSET(0x1B43CF80)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int LayoutGroup_TypeDefinitionIndex = 8395;
