...
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_ANCHORALLOWEDOUTSIDEPARENT_OFFSET UNITYSDK_OFFSET(0x16C6F470)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_ANCHOREDTOLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x16C6F950)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_CALRECTWITHCURRENTANCHORS_OFFSET UNITYSDK_OFFSET(0x16C6D550)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_CALSIZEWITHCURRENTANCHORS_OFFSET UNITYSDK_OFFSET(0x16C6D130)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_FINDROOTCANVAS_OFFSET UNITYSDK_OFFSET(0x16C6C180)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x16C6C8F0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETMINMAXBYWORLD_OFFSET UNITYSDK_OFFSET(0x16C6BEA0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETRECTREFERENCECORNER_OFFSET UNITYSDK_OFFSET(0x16C6DE60)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETSELFEDGEBYPOINT_OFFSET UNITYSDK_OFFSET(0x16C6C660)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETSELFEDGE_1_OFFSET UNITYSDK_OFFSET(0x16C6C310)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETSELFEDGE_OFFSET UNITYSDK_OFFSET(0x16C6C010)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_LOCALPOSITIONTOANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0x16C6F600)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETANCHORSMART_1_OFFSET UNITYSDK_OFFSET(0x16C6F390)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETANCHORSMART_2_OFFSET UNITYSDK_OFFSET(0x16C6E230)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETANCHORSMART_OFFSET UNITYSDK_OFFSET(0x16C6E170)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETPIVOTSMART_1_OFFSET UNITYSDK_OFFSET(0x16C6DC00)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETPIVOTSMART_OFFSET UNITYSDK_OFFSET(0x16C6DB50)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETSIZEANDPOSITIONWITHCURRENTANCHORSBYPOINT_OFFSET UNITYSDK_OFFSET(0x16C6D8F0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETSIZEANDPOSITIONWITHCURRENTANCHORS_OFFSET UNITYSDK_OFFSET(0x16C6D690)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SHOULDDOINTSNAPPING_OFFSET UNITYSDK_OFFSET(0x16C6F4E0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS__CALSIZEWITHCURRENTANCHORS_G__GETPARENTSIZE_7_0_OFFSET UNITYSDK_OFFSET(0x16C6D490)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x16C6FD10)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int RectTransformExtensions_TypeDefinitionIndex = 74211;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(RectTransformExtensions_TypeDefinitionIndex)->GetStaticField(0x33100);
		}
