...
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_ANCHORALLOWEDOUTSIDEPARENT_OFFSET UNITYSDK_OFFSET(0xAEB89D0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_ANCHOREDTOLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0xAEB8EB0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_CALRECTWITHCURRENTANCHORS_OFFSET UNITYSDK_OFFSET(0xAEB6AB0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_CALSIZEWITHCURRENTANCHORS_OFFSET UNITYSDK_OFFSET(0xAEB6690)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_FINDROOTCANVAS_OFFSET UNITYSDK_OFFSET(0xAEB56E0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0xAEB5E50)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETMINMAXBYWORLD_OFFSET UNITYSDK_OFFSET(0xAEB5400)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETRECTREFERENCECORNER_OFFSET UNITYSDK_OFFSET(0xAEB73C0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETSELFEDGEBYPOINT_OFFSET UNITYSDK_OFFSET(0xAEB5BC0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETSELFEDGE_1_OFFSET UNITYSDK_OFFSET(0xAEB5870)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_GETSELFEDGE_OFFSET UNITYSDK_OFFSET(0xAEB5570)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_LOCALPOSITIONTOANCHOREDPOSITION_OFFSET UNITYSDK_OFFSET(0xAEB8B60)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETANCHORSMART_1_OFFSET UNITYSDK_OFFSET(0xAEB88F0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETANCHORSMART_2_OFFSET UNITYSDK_OFFSET(0xAEB7790)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETANCHORSMART_OFFSET UNITYSDK_OFFSET(0xAEB76D0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETPIVOTSMART_1_OFFSET UNITYSDK_OFFSET(0xAEB7160)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETPIVOTSMART_OFFSET UNITYSDK_OFFSET(0xAEB70B0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETSIZEANDPOSITIONWITHCURRENTANCHORSBYPOINT_OFFSET UNITYSDK_OFFSET(0xAEB6E50)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SETSIZEANDPOSITIONWITHCURRENTANCHORS_OFFSET UNITYSDK_OFFSET(0xAEB6BF0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS_SHOULDDOINTSNAPPING_OFFSET UNITYSDK_OFFSET(0xAEB8A40)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS__CALSIZEWITHCURRENTANCHORS_G__GETPARENTSIZE_7_0_OFFSET UNITYSDK_OFFSET(0xAEB69F0)
#define UNITYENGINE_UI_RECTTRANSFORMEXTENSIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0xAEB9270)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int RectTransformExtensions_TypeDefinitionIndex = 48025;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(RectTransformExtensions_TypeDefinitionIndex)->GetStaticField(0x35180);
		}
