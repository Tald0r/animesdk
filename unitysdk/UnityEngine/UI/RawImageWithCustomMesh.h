...
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_GETMESH_OFFSET UNITYSDK_OFFSET(0x1A8CC1F0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A8CBFA0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1A8CC360)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_GET_UVRECT_OFFSET UNITYSDK_OFFSET(0x1A8CC4A0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A8CC950)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_REBUILD_OFFSET UNITYSDK_OFFSET(0x1A8CC820)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_SETMESH_OFFSET UNITYSDK_OFFSET(0x1A8CC240)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_SETNATIVESIZE_OFFSET UNITYSDK_OFFSET(0x1A8CC530)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_SET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1A8CC370)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_SET_UVRECT_OFFSET UNITYSDK_OFFSET(0x1A8CC4B0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8CBF70)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A8CC9A0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A8CC9D0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH___BASE_REBUILD_OFFSET UNITYSDK_OFFSET(0x1A8CCA70)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH___BASE_SETNATIVESIZE_OFFSET UNITYSDK_OFFSET(0x1A8CCA80)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int RawImageWithCustomMesh_TypeDefinitionIndex = 8407;
