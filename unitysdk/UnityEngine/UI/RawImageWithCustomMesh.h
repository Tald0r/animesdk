...
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_GETMESH_OFFSET UNITYSDK_OFFSET(0x1AE95E60)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AE95C10)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1AE95FD0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_GET_UVRECT_OFFSET UNITYSDK_OFFSET(0x1AE96110)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AE965C0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_REBUILD_OFFSET UNITYSDK_OFFSET(0x1AE96490)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_SETMESH_OFFSET UNITYSDK_OFFSET(0x1AE95EB0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_SETNATIVESIZE_OFFSET UNITYSDK_OFFSET(0x1AE961A0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_SET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1AE95FE0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH_SET_UVRECT_OFFSET UNITYSDK_OFFSET(0x1AE96120)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE95BE0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AE96610)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AE96640)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH___BASE_REBUILD_OFFSET UNITYSDK_OFFSET(0x1AE966E0)
#define UNITYENGINE_UI_RAWIMAGEWITHCUSTOMMESH___BASE_SETNATIVESIZE_OFFSET UNITYSDK_OFFSET(0x1AE966F0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int RawImageWithCustomMesh_TypeDefinitionIndex = 8417;
