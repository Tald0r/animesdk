...
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A4240B0)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A424450)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A4244B0)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A424460)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A4240A0)
#define UNITYENGINE_UI_INPUTFIELD__MOUSEDRAGOUTSIDERECT_D__185__CTOR_OFFSET UNITYSDK_OFFSET(0x1A424090)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int InputField__MouseDragOutsideRect_d__185_TypeDefinitionIndex = 8363;
