...
#define UNITYENGINE_UI_CUSTOMUIVECTOR2EQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A9F45B0)
#define UNITYENGINE_UI_CUSTOMUIVECTOR2EQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A9F4670)
#define UNITYENGINE_UI_CUSTOMUIVECTOR2EQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9F46F0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int CustomUIVector2EqualityComparer_TypeDefinitionIndex = 8433;
