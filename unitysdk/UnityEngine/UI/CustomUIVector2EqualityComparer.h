...
#define UNITYENGINE_UI_CUSTOMUIVECTOR2EQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A41E750)
#define UNITYENGINE_UI_CUSTOMUIVECTOR2EQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A41E810)
#define UNITYENGINE_UI_CUSTOMUIVECTOR2EQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A41E890)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int CustomUIVector2EqualityComparer_TypeDefinitionIndex = 8423;
