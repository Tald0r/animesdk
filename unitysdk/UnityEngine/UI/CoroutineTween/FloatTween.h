...
#define UNITYENGINE_UI_COROUTINETWEEN_FLOATTWEEN_ADDONCHANGEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x998890)
#define UNITYENGINE_UI_COROUTINETWEEN_FLOATTWEEN_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x2EB560)
#define UNITYENGINE_UI_COROUTINETWEEN_FLOATTWEEN_GET_IGNORETIMESCALE_OFFSET UNITYSDK_OFFSET(0x3032B0)
#define UNITYENGINE_UI_COROUTINETWEEN_FLOATTWEEN_SET_DURATION_OFFSET UNITYSDK_OFFSET(0x33F1F0)
#define UNITYENGINE_UI_COROUTINETWEEN_FLOATTWEEN_SET_IGNORETIMESCALE_OFFSET UNITYSDK_OFFSET(0x895500)
#define UNITYENGINE_UI_COROUTINETWEEN_FLOATTWEEN_SET_STARTVALUE_OFFSET UNITYSDK_OFFSET(0x2F60F0)
#define UNITYENGINE_UI_COROUTINETWEEN_FLOATTWEEN_SET_TARGETVALUE_OFFSET UNITYSDK_OFFSET(0x351EB0)
#define UNITYENGINE_UI_COROUTINETWEEN_FLOATTWEEN_TWEENVALUE_OFFSET UNITYSDK_OFFSET(0x998880)
#define UNITYENGINE_UI_COROUTINETWEEN_FLOATTWEEN_VALIDTARGET_OFFSET UNITYSDK_OFFSET(0x9988A0)

namespace UnityEngine::UI::CoroutineTween
{
	inline static constexpr unsigned int FloatTween_TypeDefinitionIndex = 8490;
