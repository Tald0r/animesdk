...
#define UNITYENGINE_UI_RAWIMAGE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1ADBA450)
#define UNITYENGINE_UI_RAWIMAGE_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1ADBA6A0)
#define UNITYENGINE_UI_RAWIMAGE_GET_UVRECT_OFFSET UNITYSDK_OFFSET(0x1ADBA7E0)
#define UNITYENGINE_UI_RAWIMAGE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1ADBAF20)
#define UNITYENGINE_UI_RAWIMAGE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1ADBAB60)
#define UNITYENGINE_UI_RAWIMAGE_SETNATIVESIZE_OFFSET UNITYSDK_OFFSET(0x1ADBA870)
#define UNITYENGINE_UI_RAWIMAGE_SET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1ADBA6B0)
#define UNITYENGINE_UI_RAWIMAGE_SET_UVRECT_OFFSET UNITYSDK_OFFSET(0x1ADBA7F0)
#define UNITYENGINE_UI_RAWIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADBA420)
#define UNITYENGINE_UI_RAWIMAGE___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1ADBAF70)
#define UNITYENGINE_UI_RAWIMAGE___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1ADBAFA0)
#define UNITYENGINE_UI_RAWIMAGE___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1ADBB040)
#define UNITYENGINE_UI_RAWIMAGE___BASE_SETNATIVESIZE_OFFSET UNITYSDK_OFFSET(0x1ADBB050)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int RawImage_TypeDefinitionIndex = 8406;
