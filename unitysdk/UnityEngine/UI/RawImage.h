...
#define UNITYENGINE_UI_RAWIMAGE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B3CF000)
#define UNITYENGINE_UI_RAWIMAGE_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1B3CF250)
#define UNITYENGINE_UI_RAWIMAGE_GET_UVRECT_OFFSET UNITYSDK_OFFSET(0x1B3CF390)
#define UNITYENGINE_UI_RAWIMAGE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B3CFAD0)
#define UNITYENGINE_UI_RAWIMAGE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1B3CF710)
#define UNITYENGINE_UI_RAWIMAGE_SETNATIVESIZE_OFFSET UNITYSDK_OFFSET(0x1B3CF420)
#define UNITYENGINE_UI_RAWIMAGE_SET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1B3CF260)
#define UNITYENGINE_UI_RAWIMAGE_SET_UVRECT_OFFSET UNITYSDK_OFFSET(0x1B3CF3A0)
#define UNITYENGINE_UI_RAWIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3CEFD0)
#define UNITYENGINE_UI_RAWIMAGE___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B3CFB20)
#define UNITYENGINE_UI_RAWIMAGE___BASE_ONDIDAPPLYANIMATIONPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B3CFB50)
#define UNITYENGINE_UI_RAWIMAGE___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1B3CFBF0)
#define UNITYENGINE_UI_RAWIMAGE___BASE_SETNATIVESIZE_OFFSET UNITYSDK_OFFSET(0x1B3CFC00)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int RawImage_TypeDefinitionIndex = 8416;
