...
#define UNITYENGINE_UI_GRAPHICRAYCASTER_GET_BLOCKINGOBJECTS_OFFSET UNITYSDK_OFFSET(0x1ADCE2A0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_GET_CANVAS_OFFSET UNITYSDK_OFFSET(0x1ADCE0D0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_GET_EVENTCAMERA_OFFSET UNITYSDK_OFFSET(0x1ADD1EA0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_GET_IGNOREREVERSEDGRAPHICS_OFFSET UNITYSDK_OFFSET(0x1ADCE280)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_GET_RENDERORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1ADCE1E0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_GET_SORTORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1ADCE040)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_RAYCASTFAST_OFFSET UNITYSDK_OFFSET(0x1ADD1680)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_RAYCASTONE_OFFSET UNITYSDK_OFFSET(0x1ADCFF00)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_RAYCASTTESTGRAPHICCACHED_OFFSET UNITYSDK_OFFSET(0x1ADD2090)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_RAYCAST_1_OFFSET UNITYSDK_OFFSET(0x1ADCF760)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1ADCE340)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_SET_BLOCKINGOBJECTS_OFFSET UNITYSDK_OFFSET(0x1ADCE2B0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_SET_IGNOREREVERSEDGRAPHICS_OFFSET UNITYSDK_OFFSET(0x1ADCE290)
#define UNITYENGINE_UI_GRAPHICRAYCASTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ADD2890)
#define UNITYENGINE_UI_GRAPHICRAYCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADCE2C0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER___BASE_GET_CANVAS_OFFSET UNITYSDK_OFFSET(0x1ADD28F0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER___BASE_GET_RENDERORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1ADD2900)
#define UNITYENGINE_UI_GRAPHICRAYCASTER___BASE_GET_SORTORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1ADD2910)
#define UNITYENGINE_UI_GRAPHICRAYCASTER___BASE_RAYCASTONE_OFFSET UNITYSDK_OFFSET(0x1ADD2920)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int GraphicRaycaster_TypeDefinitionIndex = 8343;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::UnityEngine::UI::Graphic*>**)Il2CppClass::FromTypeDefinitionIndex(GraphicRaycaster_TypeDefinitionIndex)->GetStaticField(0x75D0);
		}
