...
#define UNITYENGINE_UI_GRAPHICRAYCASTER_GET_BLOCKINGOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B3E2E60)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_GET_CANVAS_OFFSET UNITYSDK_OFFSET(0x1B3E2C90)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_GET_EVENTCAMERA_OFFSET UNITYSDK_OFFSET(0x1B3E6A70)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_GET_IGNOREREVERSEDGRAPHICS_OFFSET UNITYSDK_OFFSET(0x1B3E2E40)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_GET_RENDERORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B3E2DA0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_GET_SORTORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B3E2C00)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_RAYCASTFAST_OFFSET UNITYSDK_OFFSET(0x1B3E6250)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_RAYCASTONE_OFFSET UNITYSDK_OFFSET(0x1B3E4AD0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_RAYCASTTESTGRAPHICCACHED_OFFSET UNITYSDK_OFFSET(0x1B3E6C60)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_RAYCAST_1_OFFSET UNITYSDK_OFFSET(0x1B3E4320)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_RAYCAST_OFFSET UNITYSDK_OFFSET(0x1B3E2F00)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_SET_BLOCKINGOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B3E2E70)
#define UNITYENGINE_UI_GRAPHICRAYCASTER_SET_IGNOREREVERSEDGRAPHICS_OFFSET UNITYSDK_OFFSET(0x1B3E2E50)
#define UNITYENGINE_UI_GRAPHICRAYCASTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B3E7460)
#define UNITYENGINE_UI_GRAPHICRAYCASTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3E2E80)
#define UNITYENGINE_UI_GRAPHICRAYCASTER___BASE_GET_CANVAS_OFFSET UNITYSDK_OFFSET(0x1B3E74C0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER___BASE_GET_RENDERORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B3E74D0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER___BASE_GET_SORTORDERPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B3E74E0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER___BASE_RAYCASTONE_OFFSET UNITYSDK_OFFSET(0x1B3E74F0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int GraphicRaycaster_TypeDefinitionIndex = 8353;
