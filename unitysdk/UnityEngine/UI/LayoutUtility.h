...
#define UNITYENGINE_UI_LAYOUTUTILITY_GETFLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A235F20)
#define UNITYENGINE_UI_LAYOUTUTILITY_GETFLEXIBLESIZE_OFFSET UNITYSDK_OFFSET(0x1A235D80)
#define UNITYENGINE_UI_LAYOUTUTILITY_GETFLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x1A235DE0)
#define UNITYENGINE_UI_LAYOUTUTILITY_GETLAYOUTPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x1A236060)
#define UNITYENGINE_UI_LAYOUTUTILITY_GETLAYOUTPROPERTY_2_OFFSET UNITYSDK_OFFSET(0x1A236170)
#define UNITYENGINE_UI_LAYOUTUTILITY_GETLAYOUTPROPERTY_3_OFFSET UNITYSDK_OFFSET(0x1A236560)
#define UNITYENGINE_UI_LAYOUTUTILITY_GETLAYOUTPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A236100)
#define UNITYENGINE_UI_LAYOUTUTILITY_GETMINHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A234E40)
#define UNITYENGINE_UI_LAYOUTUTILITY_GETMINSIZE_OFFSET UNITYSDK_OFFSET(0x1A234AC0)
#define UNITYENGINE_UI_LAYOUTUTILITY_GETMINWIDTH_OFFSET UNITYSDK_OFFSET(0x1A234B20)
#define UNITYENGINE_UI_LAYOUTUTILITY_GETPREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A2357A0)
#define UNITYENGINE_UI_LAYOUTUTILITY_GETPREFERREDSIZE_OFFSET UNITYSDK_OFFSET(0x1A235160)
#define UNITYENGINE_UI_LAYOUTUTILITY_GETPREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x1A2351C0)
#define UNITYENGINE_UI_LAYOUTUTILITY__GETLAYOUTPROPERTY_G__PROCESSLAYOUTELEMENT_12_1_OFFSET UNITYSDK_OFFSET(0x1A236930)
#define UNITYENGINE_UI_LAYOUTUTILITY__GETLAYOUTPROPERTY_G__PROCESSLAYOUTLIMITER_12_0_OFFSET UNITYSDK_OFFSET(0x1A236A50)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int LayoutUtility_TypeDefinitionIndex = 8392;
