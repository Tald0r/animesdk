...
#define UNITYENGINE_UI_BUTTONEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x15AC3A80)
#define UNITYENGINE_UI_BUTTONEXTENSIONS_SAFESETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x15AC3C50)
#define UNITYENGINE_UI_BUTTONEXTENSIONS_SAFESETNORMALCOLOR_OFFSET UNITYSDK_OFFSET(0x15AC3E20)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ButtonExtensions_TypeDefinitionIndex = 56903;
