...
#define UNITYENGINE_UI_BUTTONEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x15F607B0)
#define UNITYENGINE_UI_BUTTONEXTENSIONS_SAFESETINTERACTABLE_OFFSET UNITYSDK_OFFSET(0x15F60980)
#define UNITYENGINE_UI_BUTTONEXTENSIONS_SAFESETNORMALCOLOR_OFFSET UNITYSDK_OFFSET(0x15F60B50)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ButtonExtensions_TypeDefinitionIndex = 51776;
