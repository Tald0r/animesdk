...
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1A4651F0)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x1A465240)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1A465290)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x1A4652E0)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4651D0)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP___BASE_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1A465330)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int VerticalLayoutGroup_TypeDefinitionIndex = 8405;
