...
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x19EC3600)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x19EC3650)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x19EC36A0)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x19EC36F0)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x19EC35E0)
#define UNITYENGINE_UI_VERTICALLAYOUTGROUP___BASE_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x19EC3740)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int VerticalLayoutGroup_TypeDefinitionIndex = 8395;
