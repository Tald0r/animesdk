...
#define UNITYENGINE_UI_TEXTITALICADOBESTYLE_GET_LASTPOPULATETEXTHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A8A7920)
#define UNITYENGINE_UI_TEXTITALICADOBESTYLE_GET_LASTPOPULATETEXTWIDTH_OFFSET UNITYSDK_OFFSET(0x1A8A77F0)
#define UNITYENGINE_UI_TEXTITALICADOBESTYLE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1A8A7A50)
#define UNITYENGINE_UI_TEXTITALICADOBESTYLE_REBUILD_OFFSET UNITYSDK_OFFSET(0x1A8A88C0)
#define UNITYENGINE_UI_TEXTITALICADOBESTYLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8A8980)
#define UNITYENGINE_UI_TEXTITALICADOBESTYLE___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x1A8A89D0)
#define UNITYENGINE_UI_TEXTITALICADOBESTYLE___BASE_REBUILD_OFFSET UNITYSDK_OFFSET(0x1A8A89E0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int TextItalicAdobeStyle_TypeDefinitionIndex = 39776;
