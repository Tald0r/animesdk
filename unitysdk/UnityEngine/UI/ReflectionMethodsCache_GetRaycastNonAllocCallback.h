...
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYCASTNONALLOCCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5E7030)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYCASTNONALLOCCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5E70F0)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYCASTNONALLOCCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5E6B00)
#define UNITYENGINE_UI_REFLECTIONMETHODSCACHE_GETRAYCASTNONALLOCCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5E6AE0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ReflectionMethodsCache_GetRaycastNonAllocCallback_TypeDefinitionIndex = 8466;
