...
#define UNITYENGINE_UI_LAYOUTREBUILDER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B5720C0)
#define UNITYENGINE_UI_LAYOUTREBUILDER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B574C30)
#define UNITYENGINE_UI_LAYOUTREBUILDER_FINDROOTLAYOUTWITHANCHOR_OFFSET UNITYSDK_OFFSET(0x1B573360)
#define UNITYENGINE_UI_LAYOUTREBUILDER_FINDROOTLAYOUTWITHOUTANCHOR_OFFSET UNITYSDK_OFFSET(0x1B5745A0)
#define UNITYENGINE_UI_LAYOUTREBUILDER_FORCEREBUILDLAYOUTIMMEDIATEV2_OFFSET UNITYSDK_OFFSET(0x1B573020)
#define UNITYENGINE_UI_LAYOUTREBUILDER_FORCEREBUILDLAYOUTIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1B572A10)
#define UNITYENGINE_UI_LAYOUTREBUILDER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B574BF0)
#define UNITYENGINE_UI_LAYOUTREBUILDER_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B572860)
#define UNITYENGINE_UI_LAYOUTREBUILDER_GRAPHICUPDATECOMPLETE_OFFSET UNITYSDK_OFFSET(0x1B574BB0)
#define UNITYENGINE_UI_LAYOUTREBUILDER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B572060)
#define UNITYENGINE_UI_LAYOUTREBUILDER_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x1B572870)
#define UNITYENGINE_UI_LAYOUTREBUILDER_LAYOUTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1B574B20)
#define UNITYENGINE_UI_LAYOUTREBUILDER_MARKLAYOUTFORREBUILD_OFFSET UNITYSDK_OFFSET(0x1B5722A0)
#define UNITYENGINE_UI_LAYOUTREBUILDER_MARKLAYOUTROOTFORREBUILD_OFFSET UNITYSDK_OFFSET(0x1B573D50)
#define UNITYENGINE_UI_LAYOUTREBUILDER_PERFORMLAYOUTCALCULATION_OFFSET UNITYSDK_OFFSET(0x1B573400)
#define UNITYENGINE_UI_LAYOUTREBUILDER_PERFORMLAYOUTCONTROL_OFFSET UNITYSDK_OFFSET(0x1B573750)
#define UNITYENGINE_UI_LAYOUTREBUILDER_REAPPLYDRIVENPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B572240)
#define UNITYENGINE_UI_LAYOUTREBUILDER_REBUILDLAYOUTIMMEDIATEIFNEED_OFFSET UNITYSDK_OFFSET(0x1B573F30)
#define UNITYENGINE_UI_LAYOUTREBUILDER_REBUILD_OFFSET UNITYSDK_OFFSET(0x1B572B50)
#define UNITYENGINE_UI_LAYOUTREBUILDER_STRIPDISABLEDBEHAVIOURSFROMLIST_OFFSET UNITYSDK_OFFSET(0x1B572910)
#define UNITYENGINE_UI_LAYOUTREBUILDER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B574CD0)
#define UNITYENGINE_UI_LAYOUTREBUILDER_VALIDCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1B573AF0)
#define UNITYENGINE_UI_LAYOUTREBUILDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B572110)
#define UNITYENGINE_UI_LAYOUTREBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B574DD0)
#define UNITYENGINE_UI_LAYOUTREBUILDER__FINDROOTLAYOUTWITHANCHOR_G__INNER_18_0_OFFSET UNITYSDK_OFFSET(0x1B5741E0)
#define UNITYENGINE_UI_LAYOUTREBUILDER__FINDROOTLAYOUTWITHOUTANCHOR_G__FINDROOT_19_0_OFFSET UNITYSDK_OFFSET(0x1B574840)
#define UNITYENGINE_UI_LAYOUTREBUILDER___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B574DE0)
#define UNITYENGINE_UI_LAYOUTREBUILDER___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B574DF0)
#define UNITYENGINE_UI_LAYOUTREBUILDER___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B574E00)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int LayoutRebuilder_TypeDefinitionIndex = 8397;
