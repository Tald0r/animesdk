...
#define UNITYENGINE_UI_LAYOUTREBUILDER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AF4E2F0)
#define UNITYENGINE_UI_LAYOUTREBUILDER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AF50E60)
#define UNITYENGINE_UI_LAYOUTREBUILDER_FINDROOTLAYOUTWITHANCHOR_OFFSET UNITYSDK_OFFSET(0x1AF4F590)
#define UNITYENGINE_UI_LAYOUTREBUILDER_FINDROOTLAYOUTWITHOUTANCHOR_OFFSET UNITYSDK_OFFSET(0x1AF507D0)
#define UNITYENGINE_UI_LAYOUTREBUILDER_FORCEREBUILDLAYOUTIMMEDIATEV2_OFFSET UNITYSDK_OFFSET(0x1AF4F250)
#define UNITYENGINE_UI_LAYOUTREBUILDER_FORCEREBUILDLAYOUTIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1AF4EC40)
#define UNITYENGINE_UI_LAYOUTREBUILDER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AF50E20)
#define UNITYENGINE_UI_LAYOUTREBUILDER_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AF4EA90)
#define UNITYENGINE_UI_LAYOUTREBUILDER_GRAPHICUPDATECOMPLETE_OFFSET UNITYSDK_OFFSET(0x1AF50DE0)
#define UNITYENGINE_UI_LAYOUTREBUILDER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AF4E290)
#define UNITYENGINE_UI_LAYOUTREBUILDER_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x1AF4EAA0)
#define UNITYENGINE_UI_LAYOUTREBUILDER_LAYOUTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1AF50D50)
#define UNITYENGINE_UI_LAYOUTREBUILDER_MARKLAYOUTFORREBUILD_OFFSET UNITYSDK_OFFSET(0x1AF4E4D0)
#define UNITYENGINE_UI_LAYOUTREBUILDER_MARKLAYOUTROOTFORREBUILD_OFFSET UNITYSDK_OFFSET(0x1AF4FF80)
#define UNITYENGINE_UI_LAYOUTREBUILDER_PERFORMLAYOUTCALCULATION_OFFSET UNITYSDK_OFFSET(0x1AF4F630)
#define UNITYENGINE_UI_LAYOUTREBUILDER_PERFORMLAYOUTCONTROL_OFFSET UNITYSDK_OFFSET(0x1AF4F980)
#define UNITYENGINE_UI_LAYOUTREBUILDER_REAPPLYDRIVENPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AF4E470)
#define UNITYENGINE_UI_LAYOUTREBUILDER_REBUILDLAYOUTIMMEDIATEIFNEED_OFFSET UNITYSDK_OFFSET(0x1AF50160)
#define UNITYENGINE_UI_LAYOUTREBUILDER_REBUILD_OFFSET UNITYSDK_OFFSET(0x1AF4ED80)
#define UNITYENGINE_UI_LAYOUTREBUILDER_STRIPDISABLEDBEHAVIOURSFROMLIST_OFFSET UNITYSDK_OFFSET(0x1AF4EB40)
#define UNITYENGINE_UI_LAYOUTREBUILDER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AF50F00)
#define UNITYENGINE_UI_LAYOUTREBUILDER_VALIDCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1AF4FD20)
#define UNITYENGINE_UI_LAYOUTREBUILDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AF4E340)
#define UNITYENGINE_UI_LAYOUTREBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF51000)
#define UNITYENGINE_UI_LAYOUTREBUILDER__FINDROOTLAYOUTWITHANCHOR_G__INNER_18_0_OFFSET UNITYSDK_OFFSET(0x1AF50410)
#define UNITYENGINE_UI_LAYOUTREBUILDER__FINDROOTLAYOUTWITHOUTANCHOR_G__FINDROOT_19_0_OFFSET UNITYSDK_OFFSET(0x1AF50A70)
#define UNITYENGINE_UI_LAYOUTREBUILDER___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AF51010)
#define UNITYENGINE_UI_LAYOUTREBUILDER___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AF51020)
#define UNITYENGINE_UI_LAYOUTREBUILDER___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AF51030)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int LayoutRebuilder_TypeDefinitionIndex = 8387;
	...
	public:
		...
		{
			return (::UnityEngine::UI::ObjectPool_1<::UnityEngine::UI::LayoutRebuilder*>**)Il2CppClass::FromTypeDefinitionIndex(LayoutRebuilder_TypeDefinitionIndex)->GetStaticField(0x7630);
		}
