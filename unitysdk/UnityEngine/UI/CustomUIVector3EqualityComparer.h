...
#define UNITYENGINE_UI_CUSTOMUIVECTOR3EQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AB23440)
#define UNITYENGINE_UI_CUSTOMUIVECTOR3EQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AB23550)
#define UNITYENGINE_UI_CUSTOMUIVECTOR3EQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB235F0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int CustomUIVector3EqualityComparer_TypeDefinitionIndex = 8422;
