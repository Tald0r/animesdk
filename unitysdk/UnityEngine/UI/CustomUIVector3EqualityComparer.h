...
#define UNITYENGINE_UI_CUSTOMUIVECTOR3EQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AF770D0)
#define UNITYENGINE_UI_CUSTOMUIVECTOR3EQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AF771E0)
#define UNITYENGINE_UI_CUSTOMUIVECTOR3EQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF77280)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int CustomUIVector3EqualityComparer_TypeDefinitionIndex = 8432;
