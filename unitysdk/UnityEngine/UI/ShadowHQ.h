...
#define UNITYENGINE_UI_SHADOWHQ_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xF4BE190)
#define UNITYENGINE_UI_SHADOWHQ__CTOR_OFFSET UNITYSDK_OFFSET(0xF4BE100)
#define UNITYENGINE_UI_SHADOWHQ___BASE_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0xF4BE4B0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ShadowHQ_TypeDefinitionIndex = 65707;
