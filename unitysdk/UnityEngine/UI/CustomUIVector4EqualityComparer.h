...
#define UNITYENGINE_UI_CUSTOMUIVECTOR4EQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A7F35D0)
#define UNITYENGINE_UI_CUSTOMUIVECTOR4EQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A7F3720)
#define UNITYENGINE_UI_CUSTOMUIVECTOR4EQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7F37E0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int CustomUIVector4EqualityComparer_TypeDefinitionIndex = 8421;
