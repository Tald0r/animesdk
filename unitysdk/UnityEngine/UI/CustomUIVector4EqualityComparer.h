...
#define UNITYENGINE_UI_CUSTOMUIVECTOR4EQUALITYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ADD2510)
#define UNITYENGINE_UI_CUSTOMUIVECTOR4EQUALITYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ADD2660)
#define UNITYENGINE_UI_CUSTOMUIVECTOR4EQUALITYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADD2720)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int CustomUIVector4EqualityComparer_TypeDefinitionIndex = 8431;
