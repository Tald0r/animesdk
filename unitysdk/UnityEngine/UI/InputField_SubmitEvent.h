...
#define UNITYENGINE_UI_INPUTFIELD_SUBMITEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A424B80)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int InputField_SubmitEvent_TypeDefinitionIndex = 8359;
