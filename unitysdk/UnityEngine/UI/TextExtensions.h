...
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFEGETTEXT_OFFSET UNITYSDK_OFFSET(0x1816DFB0)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1816DC20)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETCOLOR_OFFSET UNITYSDK_OFFSET(0x1816E5E0)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETTEXTWITHELLIPSIS_OFFSET UNITYSDK_OFFSET(0x1816E190)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETTEXT_OFFSET UNITYSDK_OFFSET(0x1816DDD0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int TextExtensions_TypeDefinitionIndex = 66480;
