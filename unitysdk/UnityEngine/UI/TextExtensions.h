...
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFEGETTEXT_OFFSET UNITYSDK_OFFSET(0x1827E4F0)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x1827E160)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETCOLOR_OFFSET UNITYSDK_OFFSET(0x1827EB20)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETTEXTWITHELLIPSIS_OFFSET UNITYSDK_OFFSET(0x1827E6D0)
#define UNITYENGINE_UI_TEXTEXTENSIONS_SAFESETTEXT_OFFSET UNITYSDK_OFFSET(0x1827E310)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int TextExtensions_TypeDefinitionIndex = 74036;
