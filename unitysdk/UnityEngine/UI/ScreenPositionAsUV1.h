...
#define UNITYENGINE_UI_SCREENPOSITIONASUV1_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1816D8A0)
#define UNITYENGINE_UI_SCREENPOSITIONASUV1__CTOR_OFFSET UNITYSDK_OFFSET(0x1816D820)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int ScreenPositionAsUV1_TypeDefinitionIndex = 74364;
