...
#define UNITYENGINE_UI_GRAPHICRAYCASTER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B696870)
#define UNITYENGINE_UI_GRAPHICRAYCASTER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6968A0)
#define UNITYENGINE_UI_GRAPHICRAYCASTER___C__RAYCASTFAST_B__26_0_OFFSET UNITYSDK_OFFSET(0x1B696900)
#define UNITYENGINE_UI_GRAPHICRAYCASTER___C__RAYCAST_B__25_0_OFFSET UNITYSDK_OFFSET(0x1B6968B0)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int GraphicRaycaster___c_TypeDefinitionIndex = 8355;
	...
	public:
		...
		{
			return (::System::Comparison_1<::UnityEngine::UI::Graphic*>**)Il2CppClass::FromTypeDefinitionIndex(GraphicRaycaster___c_TypeDefinitionIndex)->GetStaticField(0x7450);
		}
		static ::UnityEngine::UI::GraphicRaycaster___c** StaticGet___9()
		{
			return (::UnityEngine::UI::GraphicRaycaster___c**)Il2CppClass::FromTypeDefinitionIndex(GraphicRaycaster___c_TypeDefinitionIndex)->GetStaticField(0x7458);
		}
