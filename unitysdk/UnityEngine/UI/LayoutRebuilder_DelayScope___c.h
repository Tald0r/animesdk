...
#define UNITYENGINE_UI_LAYOUTREBUILDER_DELAYSCOPE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ADBA3C0)
#define UNITYENGINE_UI_LAYOUTREBUILDER_DELAYSCOPE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADBA400)
#define UNITYENGINE_UI_LAYOUTREBUILDER_DELAYSCOPE___C___CCTOR_B__7_0_OFFSET UNITYSDK_OFFSET(0x1ADBA410)

namespace UnityEngine::UI
{
	inline static constexpr unsigned int LayoutRebuilder_DelayScope___c_TypeDefinitionIndex = 8389;
	...
	public:
		...
		{
			return (::UnityEngine::UI::LayoutRebuilder_DelayScope___c**)Il2CppClass::FromTypeDefinitionIndex(LayoutRebuilder_DelayScope___c_TypeDefinitionIndex)->GetStaticField(0x7540);
		}
