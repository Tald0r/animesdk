...
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_CLOSESCOPE_OFFSET UNITYSDK_OFFSET(0x1A1F04B0)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_GET_HANDLESCROLLWHEEL_OFFSET UNITYSDK_OFFSET(0x1A1F3A40)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_GET_SCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0x1A1F3A20)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_SET_HANDLESCROLLWHEEL_OFFSET UNITYSDK_OFFSET(0x1A1F3A50)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_SET_SCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0x1A1F3A30)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1F3A60)
