...
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_CLOSESCOPE_OFFSET UNITYSDK_OFFSET(0x19C377E0)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_GET_HANDLESCROLLWHEEL_OFFSET UNITYSDK_OFFSET(0x19C3AD60)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_GET_SCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0x19C3AD40)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_SET_HANDLESCROLLWHEEL_OFFSET UNITYSDK_OFFSET(0x19C3AD70)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE_SET_SCROLLPOSITION_OFFSET UNITYSDK_OFFSET(0x19C3AD50)
#define UNITYENGINE_GUILAYOUT_SCROLLVIEWSCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C3AD80)

namespace UnityEngine
{
	inline static constexpr unsigned int GUILayout_ScrollViewScope_TypeDefinitionIndex = 6360;
