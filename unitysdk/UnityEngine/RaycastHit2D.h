...
#define UNITYENGINE_RAYCASTHIT2D_COMPARETO_OFFSET UNITYSDK_OFFSET(0x982AA0)
#define UNITYENGINE_RAYCASTHIT2D_GET_CENTROID_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_RAYCASTHIT2D_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x9829E0)
#define UNITYENGINE_RAYCASTHIT2D_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x36DB20)
#define UNITYENGINE_RAYCASTHIT2D_GET_FRACTION_OFFSET UNITYSDK_OFFSET(0x929B40)
#define UNITYENGINE_RAYCASTHIT2D_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define UNITYENGINE_RAYCASTHIT2D_GET_POINT_OFFSET UNITYSDK_OFFSET(0x272280)
#define UNITYENGINE_RAYCASTHIT2D_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0x982A80)
#define UNITYENGINE_RAYCASTHIT2D_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x982A90)
#define UNITYENGINE_RAYCASTHIT2D_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B07BA20)
#define UNITYENGINE_RAYCASTHIT2D_SET_CENTROID_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define UNITYENGINE_RAYCASTHIT2D_SET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x4499A0)
#define UNITYENGINE_RAYCASTHIT2D_SET_FRACTION_OFFSET UNITYSDK_OFFSET(0x96B0C0)
#define UNITYENGINE_RAYCASTHIT2D_SET_NORMAL_OFFSET UNITYSDK_OFFSET(0x3123A0)
#define UNITYENGINE_RAYCASTHIT2D_SET_POINT_OFFSET UNITYSDK_OFFSET(0x302310)
