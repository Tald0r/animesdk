...
#define UNITYENGINE_RAYCASTHIT2D_COMPARETO_OFFSET UNITYSDK_OFFSET(0x9529A0)
#define UNITYENGINE_RAYCASTHIT2D_GET_CENTROID_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define UNITYENGINE_RAYCASTHIT2D_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x9528E0)
#define UNITYENGINE_RAYCASTHIT2D_GET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x308880)
#define UNITYENGINE_RAYCASTHIT2D_GET_FRACTION_OFFSET UNITYSDK_OFFSET(0x8FF150)
#define UNITYENGINE_RAYCASTHIT2D_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define UNITYENGINE_RAYCASTHIT2D_GET_POINT_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define UNITYENGINE_RAYCASTHIT2D_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0x952980)
#define UNITYENGINE_RAYCASTHIT2D_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x952990)
#define UNITYENGINE_RAYCASTHIT2D_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AA94D10)
#define UNITYENGINE_RAYCASTHIT2D_SET_CENTROID_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define UNITYENGINE_RAYCASTHIT2D_SET_DISTANCE_OFFSET UNITYSDK_OFFSET(0x308890)
#define UNITYENGINE_RAYCASTHIT2D_SET_FRACTION_OFFSET UNITYSDK_OFFSET(0x93E360)
#define UNITYENGINE_RAYCASTHIT2D_SET_NORMAL_OFFSET UNITYSDK_OFFSET(0x2D26A0)
#define UNITYENGINE_RAYCASTHIT2D_SET_POINT_OFFSET UNITYSDK_OFFSET(0x2CB170)

namespace UnityEngine
{
	inline static constexpr unsigned int RaycastHit2D_TypeDefinitionIndex = 7628;
