...
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A04CF80)
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A04CFF0)
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A04CC40)
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04CC30)
