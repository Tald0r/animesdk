...
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A62D480)
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A62D4F0)
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A62D140)
#define UNITYENGINE_QUALITYSETTINGS_ONPARTICLESLEVELCHANGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62D120)
