...
#define UNITYENGINE_GUI_WINDOWFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C37A20)
#define UNITYENGINE_GUI_WINDOWFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C37A70)
#define UNITYENGINE_GUI_WINDOWFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C37250)
#define UNITYENGINE_GUI_WINDOWFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19C37A10)

namespace UnityEngine
{
	inline static constexpr unsigned int GUI_WindowFunction_TypeDefinitionIndex = 6351;
