...
#define UNITYENGINE_ANIMAGEGRAPHASSET_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1B772090)
#define UNITYENGINE_ANIMAGEGRAPHASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B772060)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimageGraphAsset_TypeDefinitionIndex = 37110;
