...
#define UNITYENGINE_MATCHTARGETWEIGHTMASK__CTOR_OFFSET UNITYSDK_OFFSET(0x33FDB0)

namespace UnityEngine
{
	inline static constexpr unsigned int MatchTargetWeightMask_TypeDefinitionIndex = 6540;
