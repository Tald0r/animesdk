...
#define UNITYENGINE_ANIMATORHOOK_INVOKE_ONHOOKANIMATORSETBOOL_OFFSET UNITYSDK_OFFSET(0x1B14AB90)
#define UNITYENGINE_ANIMATORHOOK_INVOKE_ONHOOKANIMATORSETTRIGGER_OFFSET UNITYSDK_OFFSET(0x1B14AC10)
#define UNITYENGINE_ANIMATORHOOK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14AC80)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimatorHook_TypeDefinitionIndex = 6525;
	...
	public:
		...
		{
			return (::System::Action_2<::UnityEngine::Animator*, ::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(AnimatorHook_TypeDefinitionIndex)->GetStaticField(0x5A40);
		}
		static ::System::Action_3<::UnityEngine::Animator*, ::System::Int32, ::System::Boolean>** StaticGet_onHookSetBool()
		{
			return (::System::Action_3<::UnityEngine::Animator*, ::System::Int32, ::System::Boolean>**)Il2CppClass::FromTypeDefinitionIndex(AnimatorHook_TypeDefinitionIndex)->GetStaticField(0x5A48);
		}
