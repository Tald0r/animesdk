...
#define UNITYENGINE_OBJECTINSTANCECACHE_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1B757090)
#define UNITYENGINE_OBJECTINSTANCECACHE_INSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1B757080)
#define UNITYENGINE_OBJECTINSTANCECACHE_LOADTEMPLATEASYNC_OFFSET UNITYSDK_OFFSET(0x1B757060)
#define UNITYENGINE_OBJECTINSTANCECACHE_LOADTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1B757070)
#define UNITYENGINE_OBJECTINSTANCECACHE_SET_USESWAPPABLE_OFFSET UNITYSDK_OFFSET(0x1B7570A0)
#define UNITYENGINE_OBJECTINSTANCECACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7570B0)
