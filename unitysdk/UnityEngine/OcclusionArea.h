...
#define UNITYENGINE_OCCLUSIONAREA_GET_CENTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x19CFD0B0)
#define UNITYENGINE_OCCLUSIONAREA_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x19CFD060)
#define UNITYENGINE_OCCLUSIONAREA_GET_SIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x19CFD130)
#define UNITYENGINE_OCCLUSIONAREA_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x19CFD0E0)
#define UNITYENGINE_OCCLUSIONAREA_SET_CENTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x19CFD0D0)
#define UNITYENGINE_OCCLUSIONAREA_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x19CFD0C0)
#define UNITYENGINE_OCCLUSIONAREA_SET_SIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x19CFD150)
#define UNITYENGINE_OCCLUSIONAREA_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x19CFD140)
#define UNITYENGINE_OCCLUSIONAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x19CFD160)

namespace UnityEngine
{
	inline static constexpr unsigned int OcclusionArea_TypeDefinitionIndex = 5203;
