...
#define UNITYENGINE_OCCLUSIONAREA_GET_CENTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A288260)
#define UNITYENGINE_OCCLUSIONAREA_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x1A288210)
#define UNITYENGINE_OCCLUSIONAREA_GET_SIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A2882E0)
#define UNITYENGINE_OCCLUSIONAREA_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1A288290)
#define UNITYENGINE_OCCLUSIONAREA_SET_CENTER_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A288280)
#define UNITYENGINE_OCCLUSIONAREA_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x1A288270)
#define UNITYENGINE_OCCLUSIONAREA_SET_SIZE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A288300)
#define UNITYENGINE_OCCLUSIONAREA_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x1A2882F0)
#define UNITYENGINE_OCCLUSIONAREA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A288310)
