...
#define UNITYENGINE_MATERIALBATCHAPPLIERHOOK_INVOKE_ONHOOKMATERIALBATCHAPPLIERAPPLYITEMTHREADEXT_OFFSET UNITYSDK_OFFSET(0x1A6899E0)
#define UNITYENGINE_MATERIALBATCHAPPLIERHOOK_INVOKE_ONHOOKMATERIALBATCHAPPLIERAPPLYITEMTHREAD_OFFSET UNITYSDK_OFFSET(0x1A689950)
#define UNITYENGINE_MATERIALBATCHAPPLIERHOOK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A689A70)
