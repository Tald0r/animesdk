...
#define UNITYENGINE_TRANSFORMEXTENSIONS_ADDCHILDFROMPREFAB_OFFSET UNITYSDK_OFFSET(0xC4D15F0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_GETDEEPFROMROOT_OFFSET UNITYSDK_OFFSET(0xC4D0AE0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_GETPATHUNTIL_OFFSET UNITYSDK_OFFSET(0xC4D2050)
#define UNITYENGINE_TRANSFORMEXTENSIONS_GETPATH_OFFSET UNITYSDK_OFFSET(0xC4D1F10)
#define UNITYENGINE_TRANSFORMEXTENSIONS_GETRELATIVEPATH_OFFSET UNITYSDK_OFFSET(0xC4CFFF0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFECREATENODE_OFFSET UNITYSDK_OFFSET(0xC4D11C0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEDESTROY_OFFSET UNITYSDK_OFFSET(0xC4D1D50)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDALLCHILDTRANSWITHNAMERECURSIVELYINNER_OFFSET UNITYSDK_OFFSET(0xC4D0860)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDALLCHILDTRANSWITHNAMERECURSIVELY_OFFSET UNITYSDK_OFFSET(0xC4D0610)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDALLCHILDTRANSWITHNAME_OFFSET UNITYSDK_OFFSET(0xC4D0310)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDCHILDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xC4CF350)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDCHILDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC4CF4D0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDCHILD_1_OFFSET UNITYSDK_OFFSET(0xC4CFD00)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDCHILD_OFFSET UNITYSDK_OFFSET(0xC4CFB70)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDDEEPCHILDTRANSFORM_OFFSET UNITYSDK_OFFSET(0xC4CF630)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDORCREATECHILDWITHINDEX_OFFSET UNITYSDK_OFFSET(0xC4D0D00)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEGETCHILDCOUNTWITHNAME_OFFSET UNITYSDK_OFFSET(0xC4D0F40)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEGETCHILD_OFFSET UNITYSDK_OFFSET(0xC4D1720)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0xC4B02E0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFESETALLCHILDACTIVEWITHNAME_OFFSET UNITYSDK_OFFSET(0xC4D1840)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFESETALLCHILDACTIVE_OFFSET UNITYSDK_OFFSET(0xC4D1B40)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFESETLOCALSCALE01_OFFSET UNITYSDK_OFFSET(0xC4D1320)

namespace UnityEngine
{
	inline static constexpr unsigned int TransformExtensions_TypeDefinitionIndex = 59467;
