...
#define UNITYENGINE_TRANSFORMEXTENSIONS_ADDCHILDFROMPREFAB_OFFSET UNITYSDK_OFFSET(0x19C24800)
#define UNITYENGINE_TRANSFORMEXTENSIONS_GETDEEPFROMROOT_OFFSET UNITYSDK_OFFSET(0x19C23FC0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_GETPATHUNTIL_OFFSET UNITYSDK_OFFSET(0x19C25260)
#define UNITYENGINE_TRANSFORMEXTENSIONS_GETPATH_OFFSET UNITYSDK_OFFSET(0x19C25120)
#define UNITYENGINE_TRANSFORMEXTENSIONS_GETRELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x19C234D0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFECREATENODE_OFFSET UNITYSDK_OFFSET(0x19C246A0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEDESTROY_OFFSET UNITYSDK_OFFSET(0x19C24F60)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDALLCHILDTRANSWITHNAMERECURSIVELYINNER_OFFSET UNITYSDK_OFFSET(0x19C23D40)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDALLCHILDTRANSWITHNAMERECURSIVELY_OFFSET UNITYSDK_OFFSET(0x19C23AF0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDALLCHILDTRANSWITHNAME_OFFSET UNITYSDK_OFFSET(0x19C237F0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDCHILDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x19C22830)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDCHILDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19C229B0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDCHILD_1_OFFSET UNITYSDK_OFFSET(0x19C231E0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDCHILD_OFFSET UNITYSDK_OFFSET(0x19C23050)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDDEEPCHILDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19C22B10)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEFINDORCREATECHILDWITHINDEX_OFFSET UNITYSDK_OFFSET(0x19C241E0)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEGETCHILDCOUNTWITHNAME_OFFSET UNITYSDK_OFFSET(0x19C24420)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFEGETCHILD_OFFSET UNITYSDK_OFFSET(0x19C24930)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFESETACTIVE_OFFSET UNITYSDK_OFFSET(0x19C1BB70)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFESETALLCHILDACTIVEWITHNAME_OFFSET UNITYSDK_OFFSET(0x19C24A50)
#define UNITYENGINE_TRANSFORMEXTENSIONS_SAFESETALLCHILDACTIVE_OFFSET UNITYSDK_OFFSET(0x19C24D50)

namespace UnityEngine
{
	inline static constexpr unsigned int TransformExtensions_TypeDefinitionIndex = 77855;
