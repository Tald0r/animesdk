...
#define UNITYENGINE_ONANIMATORFIXEDUPDATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B7338F0)
#define UNITYENGINE_ONANIMATORFIXEDUPDATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B733920)
#define UNITYENGINE_ONANIMATORFIXEDUPDATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B733580)
#define UNITYENGINE_ONANIMATORFIXEDUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B733560)
