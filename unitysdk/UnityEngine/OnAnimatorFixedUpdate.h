...
#define UNITYENGINE_ONANIMATORFIXEDUPDATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B11C560)
#define UNITYENGINE_ONANIMATORFIXEDUPDATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B11C590)
#define UNITYENGINE_ONANIMATORFIXEDUPDATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B11C1F0)
#define UNITYENGINE_ONANIMATORFIXEDUPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B11C1E0)

namespace UnityEngine
{
	inline static constexpr unsigned int OnAnimatorFixedUpdate_TypeDefinitionIndex = 6541;
