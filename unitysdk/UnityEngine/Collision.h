...
#define UNITYENGINE_COLLISION_GETCONTACTS_1_OFFSET UNITYSDK_OFFSET(0x1ACF9590)
#define UNITYENGINE_COLLISION_GETCONTACTS_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1ACF9210)
#define UNITYENGINE_COLLISION_GETCONTACTS_OFFSET UNITYSDK_OFFSET(0x1ACF9500)
#define UNITYENGINE_COLLISION_GETCONTACT_OFFSET UNITYSDK_OFFSET(0x1ACF93F0)
#define UNITYENGINE_COLLISION_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1ACF9630)
#define UNITYENGINE_COLLISION_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1ACF9260)
#define UNITYENGINE_COLLISION_GET_CONTACTCOUNT_OFFSET UNITYSDK_OFFSET(0x1ACF9390)
#define UNITYENGINE_COLLISION_GET_CONTACTS_OFFSET UNITYSDK_OFFSET(0x1ACF93A0)
#define UNITYENGINE_COLLISION_GET_FRICTIONFORCESUM_OFFSET UNITYSDK_OFFSET(0x1ACF97D0)
#define UNITYENGINE_COLLISION_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1ACF9300)
#define UNITYENGINE_COLLISION_GET_IMPACTFORCESUM_OFFSET UNITYSDK_OFFSET(0x1ACF97B0)
#define UNITYENGINE_COLLISION_GET_IMPULSE_OFFSET UNITYSDK_OFFSET(0x1ACF9790)
#define UNITYENGINE_COLLISION_GET_OTHER_OFFSET UNITYSDK_OFFSET(0x1ACF97F0)
#define UNITYENGINE_COLLISION_GET_RELATIVEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1ACF9230)
#define UNITYENGINE_COLLISION_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1ACF9250)
#define UNITYENGINE_COLLISION_GET_SELFCOLLIDER_OFFSET UNITYSDK_OFFSET(0x1ACF9220)
#define UNITYENGINE_COLLISION_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1ACF9270)
#define UNITYENGINE_COLLISION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACF9870)
