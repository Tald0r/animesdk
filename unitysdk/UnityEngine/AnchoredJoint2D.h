...
#define UNITYENGINE_ANCHOREDJOINT2D_GET_ANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AA8DF40)
#define UNITYENGINE_ANCHOREDJOINT2D_GET_ANCHOR_OFFSET UNITYSDK_OFFSET(0x1AA8DF10)
#define UNITYENGINE_ANCHOREDJOINT2D_GET_CONNECTEDANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AA8DFB0)
#define UNITYENGINE_ANCHOREDJOINT2D_GET_CONNECTEDANCHOR_OFFSET UNITYSDK_OFFSET(0x1AA8DF80)
#define UNITYENGINE_ANCHOREDJOINT2D_SET_ANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AA8DF70)
#define UNITYENGINE_ANCHOREDJOINT2D_SET_ANCHOR_OFFSET UNITYSDK_OFFSET(0x1AA8DF50)
#define UNITYENGINE_ANCHOREDJOINT2D_SET_CONNECTEDANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AA8DFE0)
#define UNITYENGINE_ANCHOREDJOINT2D_SET_CONNECTEDANCHOR_OFFSET UNITYSDK_OFFSET(0x1AA8DFC0)
#define UNITYENGINE_ANCHOREDJOINT2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA8DFF0)

namespace UnityEngine
{
	inline static constexpr unsigned int AnchoredJoint2D_TypeDefinitionIndex = 7637;
