...
#define UNITYENGINE_ANCHOREDJOINT2D_GET_ANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B0747B0)
#define UNITYENGINE_ANCHOREDJOINT2D_GET_ANCHOR_OFFSET UNITYSDK_OFFSET(0x1B074780)
#define UNITYENGINE_ANCHOREDJOINT2D_GET_CONNECTEDANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B074820)
#define UNITYENGINE_ANCHOREDJOINT2D_GET_CONNECTEDANCHOR_OFFSET UNITYSDK_OFFSET(0x1B0747F0)
#define UNITYENGINE_ANCHOREDJOINT2D_SET_ANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B0747E0)
#define UNITYENGINE_ANCHOREDJOINT2D_SET_ANCHOR_OFFSET UNITYSDK_OFFSET(0x1B0747C0)
#define UNITYENGINE_ANCHOREDJOINT2D_SET_CONNECTEDANCHOR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B074850)
#define UNITYENGINE_ANCHOREDJOINT2D_SET_CONNECTEDANCHOR_OFFSET UNITYSDK_OFFSET(0x1B074830)
#define UNITYENGINE_ANCHOREDJOINT2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1B074860)
