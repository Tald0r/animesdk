...
#define UNITYENGINE_ANIMATIONCLIP_ADDEVENTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B4D09D0)
#define UNITYENGINE_ANIMATIONCLIP_ADDEVENT_OFFSET UNITYSDK_OFFSET(0x1B4D0950)
#define UNITYENGINE_ANIMATIONCLIP_CLEARCURVES_OFFSET UNITYSDK_OFFSET(0x1B4D0800)
#define UNITYENGINE_ANIMATIONCLIP_ENSUREQUATERNIONCONTINUITY_OFFSET UNITYSDK_OFFSET(0x1B4D07F0)
#define UNITYENGINE_ANIMATIONCLIP_GETACLDATABASELRUSIZE_OFFSET UNITYSDK_OFFSET(0x1B4D0AC0)
#define UNITYENGINE_ANIMATIONCLIP_GETEVENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B4D0A50)
#define UNITYENGINE_ANIMATIONCLIP_GETRUNTIMETOTALACLDATABASEBYTES_OFFSET UNITYSDK_OFFSET(0x1B4D0940)
#define UNITYENGINE_ANIMATIONCLIP_GETSTREAMINCLIPINFOS_OFFSET UNITYSDK_OFFSET(0x1B4D0930)
#define UNITYENGINE_ANIMATIONCLIP_GETSTREAMINDATABASEINEDITOR_OFFSET UNITYSDK_OFFSET(0x1B4D0AA0)
#define UNITYENGINE_ANIMATIONCLIP_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1B4D08D0)
#define UNITYENGINE_ANIMATIONCLIP_GET_ENABLEACLDATABASESWEEP_OFFSET UNITYSDK_OFFSET(0x1B4D0AE0)
#define UNITYENGINE_ANIMATIONCLIP_GET_ENABLEDATABASESTREAMFASTPATH_OFFSET UNITYSDK_OFFSET(0x1B4D0B00)
#define UNITYENGINE_ANIMATIONCLIP_GET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1B4D09E0)
#define UNITYENGINE_ANIMATIONCLIP_GET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0x1B4D07B0)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASGENERICROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B4D08E0)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASMOTIONCURVES_OFFSET UNITYSDK_OFFSET(0x1B4D0900)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASMOTIONFLOATCURVES_OFFSET UNITYSDK_OFFSET(0x1B4D08F0)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASROOTCURVES_OFFSET UNITYSDK_OFFSET(0x1B4D0910)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x1B4D0920)
#define UNITYENGINE_ANIMATIONCLIP_GET_HUMANMOTION_OFFSET UNITYSDK_OFFSET(0x1B4D08C0)
#define UNITYENGINE_ANIMATIONCLIP_GET_LEGACY_OFFSET UNITYSDK_OFFSET(0x1B4D08A0)
#define UNITYENGINE_ANIMATIONCLIP_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B4D0770)
#define UNITYENGINE_ANIMATIONCLIP_GET_LOCALBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4D0870)
#define UNITYENGINE_ANIMATIONCLIP_GET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B4D0820)
#define UNITYENGINE_ANIMATIONCLIP_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1B4D0790)
#define UNITYENGINE_ANIMATIONCLIP_GET_STOPTIME_OFFSET UNITYSDK_OFFSET(0x1B4D07A0)
#define UNITYENGINE_ANIMATIONCLIP_GET_TOTALSIZE_OFFSET UNITYSDK_OFFSET(0x1B4D0780)
#define UNITYENGINE_ANIMATIONCLIP_GET_WRAPMODE_OFFSET UNITYSDK_OFFSET(0x1B4D0750)
#define UNITYENGINE_ANIMATIONCLIP_INTERNAL_CREATEANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0x1B4D0700)
#define UNITYENGINE_ANIMATIONCLIP_PRINTANIMATIONCLIPINLRU_OFFSET UNITYSDK_OFFSET(0x1B4D0AD0)
#define UNITYENGINE_ANIMATIONCLIP_SAMPLEANIMATION_1_OFFSET UNITYSDK_OFFSET(0x1B4D0760)
#define UNITYENGINE_ANIMATIONCLIP_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x1B4D0710)
#define UNITYENGINE_ANIMATIONCLIP_SETACLDATABASELRUSIZE_OFFSET UNITYSDK_OFFSET(0x1B4D0AB0)
#define UNITYENGINE_ANIMATIONCLIP_SETCURVEFORTRANSFORMBATCHED_OFFSET UNITYSDK_OFFSET(0x1B4D07E0)
#define UNITYENGINE_ANIMATIONCLIP_SETCURVE_OFFSET UNITYSDK_OFFSET(0x1B4D07D0)
#define UNITYENGINE_ANIMATIONCLIP_SETEVENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1B4D0A70)
#define UNITYENGINE_ANIMATIONCLIP_SET_ENABLEACLDATABASESWEEP_OFFSET UNITYSDK_OFFSET(0x1B4D0AF0)
#define UNITYENGINE_ANIMATIONCLIP_SET_ENABLEDATABASESTREAMFASTPATH_OFFSET UNITYSDK_OFFSET(0x1B4D0B10)
#define UNITYENGINE_ANIMATIONCLIP_SET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1B4D0A60)
#define UNITYENGINE_ANIMATIONCLIP_SET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0x1B4D07C0)
#define UNITYENGINE_ANIMATIONCLIP_SET_LEGACY_OFFSET UNITYSDK_OFFSET(0x1B4D08B0)
#define UNITYENGINE_ANIMATIONCLIP_SET_LOCALBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B4D0890)
#define UNITYENGINE_ANIMATIONCLIP_SET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B4D0880)
#define UNITYENGINE_ANIMATIONCLIP_SET_WRAPMODE_OFFSET UNITYSDK_OFFSET(0x1B4D0810)
#define UNITYENGINE_ANIMATIONCLIP_STREAMINACLDATABASE_OFFSET UNITYSDK_OFFSET(0x1B4D0A80)
#define UNITYENGINE_ANIMATIONCLIP_STREAMOUTACLDATABASE_OFFSET UNITYSDK_OFFSET(0x1B4D0A90)
#define UNITYENGINE_ANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D06D0)
