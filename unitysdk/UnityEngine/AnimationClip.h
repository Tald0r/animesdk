...
#define UNITYENGINE_ANIMATIONCLIP_ADDEVENTINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AEBC900)
#define UNITYENGINE_ANIMATIONCLIP_ADDEVENT_OFFSET UNITYSDK_OFFSET(0x1AEBC880)
#define UNITYENGINE_ANIMATIONCLIP_CLEARCURVES_OFFSET UNITYSDK_OFFSET(0x1AEBC730)
#define UNITYENGINE_ANIMATIONCLIP_ENSUREQUATERNIONCONTINUITY_OFFSET UNITYSDK_OFFSET(0x1AEBC720)
#define UNITYENGINE_ANIMATIONCLIP_GETACLDATABASELRUSIZE_OFFSET UNITYSDK_OFFSET(0x1AEBC9F0)
#define UNITYENGINE_ANIMATIONCLIP_GETEVENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AEBC980)
#define UNITYENGINE_ANIMATIONCLIP_GETRUNTIMETOTALACLDATABASEBYTES_OFFSET UNITYSDK_OFFSET(0x1AEBC870)
#define UNITYENGINE_ANIMATIONCLIP_GETSTREAMINCLIPINFOS_OFFSET UNITYSDK_OFFSET(0x1AEBC860)
#define UNITYENGINE_ANIMATIONCLIP_GETSTREAMINDATABASEINEDITOR_OFFSET UNITYSDK_OFFSET(0x1AEBC9D0)
#define UNITYENGINE_ANIMATIONCLIP_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1AEBC800)
#define UNITYENGINE_ANIMATIONCLIP_GET_ENABLEACLDATABASESWEEP_OFFSET UNITYSDK_OFFSET(0x1AEBCA10)
#define UNITYENGINE_ANIMATIONCLIP_GET_ENABLEDATABASESTREAMFASTPATH_OFFSET UNITYSDK_OFFSET(0x1AEBCA30)
#define UNITYENGINE_ANIMATIONCLIP_GET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1AEBC910)
#define UNITYENGINE_ANIMATIONCLIP_GET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0x1AEBC6E0)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASGENERICROOTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AEBC810)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASMOTIONCURVES_OFFSET UNITYSDK_OFFSET(0x1AEBC830)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASMOTIONFLOATCURVES_OFFSET UNITYSDK_OFFSET(0x1AEBC820)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASROOTCURVES_OFFSET UNITYSDK_OFFSET(0x1AEBC840)
#define UNITYENGINE_ANIMATIONCLIP_GET_HASROOTMOTION_OFFSET UNITYSDK_OFFSET(0x1AEBC850)
#define UNITYENGINE_ANIMATIONCLIP_GET_HUMANMOTION_OFFSET UNITYSDK_OFFSET(0x1AEBC7F0)
#define UNITYENGINE_ANIMATIONCLIP_GET_LEGACY_OFFSET UNITYSDK_OFFSET(0x1AEBC7D0)
#define UNITYENGINE_ANIMATIONCLIP_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1AEBC6A0)
#define UNITYENGINE_ANIMATIONCLIP_GET_LOCALBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AEBC7A0)
#define UNITYENGINE_ANIMATIONCLIP_GET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AEBC750)
#define UNITYENGINE_ANIMATIONCLIP_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1AEBC6C0)
#define UNITYENGINE_ANIMATIONCLIP_GET_STOPTIME_OFFSET UNITYSDK_OFFSET(0x1AEBC6D0)
#define UNITYENGINE_ANIMATIONCLIP_GET_TOTALSIZE_OFFSET UNITYSDK_OFFSET(0x1AEBC6B0)
#define UNITYENGINE_ANIMATIONCLIP_GET_WRAPMODE_OFFSET UNITYSDK_OFFSET(0x1AEBC680)
#define UNITYENGINE_ANIMATIONCLIP_INTERNAL_CREATEANIMATIONCLIP_OFFSET UNITYSDK_OFFSET(0x1AEBC630)
#define UNITYENGINE_ANIMATIONCLIP_PRINTANIMATIONCLIPINLRU_OFFSET UNITYSDK_OFFSET(0x1AEBCA00)
#define UNITYENGINE_ANIMATIONCLIP_SAMPLEANIMATION_1_OFFSET UNITYSDK_OFFSET(0x1AEBC690)
#define UNITYENGINE_ANIMATIONCLIP_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x1AEBC640)
#define UNITYENGINE_ANIMATIONCLIP_SETACLDATABASELRUSIZE_OFFSET UNITYSDK_OFFSET(0x1AEBC9E0)
#define UNITYENGINE_ANIMATIONCLIP_SETCURVEFORTRANSFORMBATCHED_OFFSET UNITYSDK_OFFSET(0x1AEBC710)
#define UNITYENGINE_ANIMATIONCLIP_SETCURVE_OFFSET UNITYSDK_OFFSET(0x1AEBC700)
#define UNITYENGINE_ANIMATIONCLIP_SETEVENTSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AEBC9A0)
#define UNITYENGINE_ANIMATIONCLIP_SET_ENABLEACLDATABASESWEEP_OFFSET UNITYSDK_OFFSET(0x1AEBCA20)
#define UNITYENGINE_ANIMATIONCLIP_SET_ENABLEDATABASESTREAMFASTPATH_OFFSET UNITYSDK_OFFSET(0x1AEBCA40)
#define UNITYENGINE_ANIMATIONCLIP_SET_EVENTS_OFFSET UNITYSDK_OFFSET(0x1AEBC990)
#define UNITYENGINE_ANIMATIONCLIP_SET_FRAMERATE_OFFSET UNITYSDK_OFFSET(0x1AEBC6F0)
#define UNITYENGINE_ANIMATIONCLIP_SET_LEGACY_OFFSET UNITYSDK_OFFSET(0x1AEBC7E0)
#define UNITYENGINE_ANIMATIONCLIP_SET_LOCALBOUNDS_INJECTED_OFFSET UNITYSDK_OFFSET(0x1AEBC7C0)
#define UNITYENGINE_ANIMATIONCLIP_SET_LOCALBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AEBC7B0)
#define UNITYENGINE_ANIMATIONCLIP_SET_WRAPMODE_OFFSET UNITYSDK_OFFSET(0x1AEBC740)
#define UNITYENGINE_ANIMATIONCLIP_STREAMINACLDATABASE_OFFSET UNITYSDK_OFFSET(0x1AEBC9B0)
#define UNITYENGINE_ANIMATIONCLIP_STREAMOUTACLDATABASE_OFFSET UNITYSDK_OFFSET(0x1AEBC9C0)
#define UNITYENGINE_ANIMATIONCLIP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEBC600)

namespace UnityEngine
{
	inline static constexpr unsigned int AnimationClip_TypeDefinitionIndex = 6523;
