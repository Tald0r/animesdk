...
#define UNITYENGINE_CONTACTPOINT2D_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x982000)
#define UNITYENGINE_CONTACTPOINT2D_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x982200)
#define UNITYENGINE_CONTACTPOINT2D_GET_NORMALIMPULSE_OFFSET UNITYSDK_OFFSET(0x929B40)
#define UNITYENGINE_CONTACTPOINT2D_GET_NORMAL_OFFSET UNITYSDK_OFFSET(0x272280)
#define UNITYENGINE_CONTACTPOINT2D_GET_OTHERCOLLIDER_OFFSET UNITYSDK_OFFSET(0x9820A0)
#define UNITYENGINE_CONTACTPOINT2D_GET_OTHERRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x9821A0)
#define UNITYENGINE_CONTACTPOINT2D_GET_POINT_OFFSET UNITYSDK_OFFSET(0x223870)
#define UNITYENGINE_CONTACTPOINT2D_GET_RELATIVEVELOCITY_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define UNITYENGINE_CONTACTPOINT2D_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0x982140)
#define UNITYENGINE_CONTACTPOINT2D_GET_SEPARATION_OFFSET UNITYSDK_OFFSET(0x36DB20)
#define UNITYENGINE_CONTACTPOINT2D_GET_TANGENTIMPULSE_OFFSET UNITYSDK_OFFSET(0x3431F0)
