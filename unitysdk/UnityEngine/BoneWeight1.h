...
#define UNITYENGINE_BONEWEIGHT1_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8E7DC0)
#define UNITYENGINE_BONEWEIGHT1_EQUALS_OFFSET UNITYSDK_OFFSET(0x8E7D30)
#define UNITYENGINE_BONEWEIGHT1_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8E7E10)
#define UNITYENGINE_BONEWEIGHT1_GET_BONEINDEX_OFFSET UNITYSDK_OFFSET(0x2D38E0)
#define UNITYENGINE_BONEWEIGHT1_GET_WEIGHT_OFFSET UNITYSDK_OFFSET(0x2C4AF0)

namespace UnityEngine
{
	inline static constexpr unsigned int BoneWeight1_TypeDefinitionIndex = 5265;
