...
#define UNITYENGINE_RECTTRANSFORMUTILITY_CALCULATERELATIVERECTTRANSFORMBOUNDS_1_OFFSET UNITYSDK_OFFSET(0x1B681B00)
#define UNITYENGINE_RECTTRANSFORMUTILITY_CALCULATERELATIVERECTTRANSFORMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1B681220)
#define UNITYENGINE_RECTTRANSFORMUTILITY_FLIPLAYOUTAXES_OFFSET UNITYSDK_OFFSET(0x1B682100)
#define UNITYENGINE_RECTTRANSFORMUTILITY_FLIPLAYOUTONAXIS_OFFSET UNITYSDK_OFFSET(0x1B681B60)
#define UNITYENGINE_RECTTRANSFORMUTILITY_GETTRANSPOSED_OFFSET UNITYSDK_OFFSET(0x1B6823B0)
#define UNITYENGINE_RECTTRANSFORMUTILITY_PIXELADJUSTPOINT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B6809A0)
#define UNITYENGINE_RECTTRANSFORMUTILITY_PIXELADJUSTPOINT_OFFSET UNITYSDK_OFFSET(0x1B680940)
#define UNITYENGINE_RECTTRANSFORMUTILITY_PIXELADJUSTRECT_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B680A10)
#define UNITYENGINE_RECTTRANSFORMUTILITY_PIXELADJUSTRECT_OFFSET UNITYSDK_OFFSET(0x1B6809B0)
#define UNITYENGINE_RECTTRANSFORMUTILITY_POINTINRECTANGLE_INJECTED_OFFSET UNITYSDK_OFFSET(0x1B680A70)
#define UNITYENGINE_RECTTRANSFORMUTILITY_POINTINRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1B680A20)
#define UNITYENGINE_RECTTRANSFORMUTILITY_RECTANGLECONTAINSSCREENPOINT_1_OFFSET UNITYSDK_OFFSET(0x1B680B40)
#define UNITYENGINE_RECTTRANSFORMUTILITY_RECTANGLECONTAINSSCREENPOINT_OFFSET UNITYSDK_OFFSET(0x1B680A90)
#define UNITYENGINE_RECTTRANSFORMUTILITY_SCREENPOINTTOLOCALPOINTINRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1B6810A0)
#define UNITYENGINE_RECTTRANSFORMUTILITY_SCREENPOINTTORAY_OFFSET UNITYSDK_OFFSET(0x1B680F20)
#define UNITYENGINE_RECTTRANSFORMUTILITY_SCREENPOINTTOWORLDPOINTINRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1B680BD0)
#define UNITYENGINE_RECTTRANSFORMUTILITY_WORLDTOSCREENPOINT_OFFSET UNITYSDK_OFFSET(0x1B681160)
#define UNITYENGINE_RECTTRANSFORMUTILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6823C0)
#define UNITYENGINE_RECTTRANSFORMUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B680A80)
