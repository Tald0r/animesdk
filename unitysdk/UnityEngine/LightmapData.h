...
#define UNITYENGINE_LIGHTMAPDATA_SET_AREADIRECT_OFFSET UNITYSDK_OFFSET(0x1A1127D0)
#define UNITYENGINE_LIGHTMAPDATA_SET_LIGHTMAPCOLOR_OFFSET UNITYSDK_OFFSET(0x1A1127C0)
#define UNITYENGINE_LIGHTMAPDATA_SET_LIGHTSKYOC_OFFSET UNITYSDK_OFFSET(0x1A1127E0)
#define UNITYENGINE_LIGHTMAPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1127F0)
