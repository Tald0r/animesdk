...
#define UNITYENGINE_LIGHTMAPDATA_SET_AREADIRECT_OFFSET UNITYSDK_OFFSET(0x1A689920)
#define UNITYENGINE_LIGHTMAPDATA_SET_LIGHTMAPCOLOR_OFFSET UNITYSDK_OFFSET(0x1A689910)
#define UNITYENGINE_LIGHTMAPDATA_SET_LIGHTSKYOC_OFFSET UNITYSDK_OFFSET(0x1A689930)
#define UNITYENGINE_LIGHTMAPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A689940)
