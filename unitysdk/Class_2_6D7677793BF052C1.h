...
#define CLASS_2_6D7677793BF052C1_METHOD_2_9FA85F81BF5EE3CA_OFFSET UNITYSDK_OFFSET(0x69A9F30)
#define CLASS_2_6D7677793BF052C1_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0x69AA000)
#define CLASS_2_6D7677793BF052C1_METHOD_2_E2771629F876FF04_OFFSET UNITYSDK_OFFSET(0x69A9D40)
#define CLASS_2_6D7677793BF052C1__CTOR_OFFSET UNITYSDK_OFFSET(0x69A9FF0)

inline static constexpr unsigned int Class_2_6D7677793BF052C1_TypeDefinitionIndex = 42250;

class Class_2_6D7677793BF052C1 : public ::Class_1_EEA0111A28582B57
{
public:
	::UnityEngine::UI::Extension::UILocalizationText* Field_2_0; // 0x18
	::UnityEngine::UI::Extension::UIImgText* Field_2_3; // 0x20
