...
#define BINARYDESERIALIZATION_OBJECTFIELDMAPCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AC15A80)
#define BINARYDESERIALIZATION_OBJECTFIELDMAPCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AC15B30)
#define BINARYDESERIALIZATION_OBJECTFIELDMAPCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC15CE0)

inline static constexpr unsigned int BinaryDeserialization_ObjectFieldMapComparer_TypeDefinitionIndex = 30177;
