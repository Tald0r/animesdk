...
#define BINARYDESERIALIZATION_OBJECTFIELDMAPCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B22A240)
#define BINARYDESERIALIZATION_OBJECTFIELDMAPCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B22A2F0)
#define BINARYDESERIALIZATION_OBJECTFIELDMAPCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22A4A0)

inline static constexpr unsigned int BinaryDeserialization_ObjectFieldMapComparer_TypeDefinitionIndex = 31130;
