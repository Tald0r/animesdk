...
#define UISNAKEENDINGANIMSCRIPTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF60110)

inline static constexpr unsigned int UISnakeEndingAnimScriptParam_TypeDefinitionIndex = 81699;
