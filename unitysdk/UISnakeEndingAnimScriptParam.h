...
#define UISNAKEENDINGANIMSCRIPTPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A886B00)

inline static constexpr unsigned int UISnakeEndingAnimScriptParam_TypeDefinitionIndex = 83649;
