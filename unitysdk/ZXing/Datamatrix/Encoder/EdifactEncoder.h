...
#define ZXING_DATAMATRIX_ENCODER_EDIFACTENCODER_ENCODECHAR_OFFSET UNITYSDK_OFFSET(0x17D29560)
#define ZXING_DATAMATRIX_ENCODER_EDIFACTENCODER_ENCODETOCODEWORDS_OFFSET UNITYSDK_OFFSET(0x17D295B0)
#define ZXING_DATAMATRIX_ENCODER_EDIFACTENCODER_ENCODE_OFFSET UNITYSDK_OFFSET(0x17D29320)
#define ZXING_DATAMATRIX_ENCODER_EDIFACTENCODER_GET_ENCODINGMODE_OFFSET UNITYSDK_OFFSET(0x17D29310)
#define ZXING_DATAMATRIX_ENCODER_EDIFACTENCODER_HANDLEEOD_OFFSET UNITYSDK_OFFSET(0x17D29750)
#define ZXING_DATAMATRIX_ENCODER_EDIFACTENCODER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D29D00)

namespace ZXing::Datamatrix::Encoder
{
	inline static constexpr unsigned int EdifactEncoder_TypeDefinitionIndex = 8626;
