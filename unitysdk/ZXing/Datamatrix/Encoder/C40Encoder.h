...
#define ZXING_DATAMATRIX_ENCODER_C40ENCODER_BACKTRACKONECHARACTER_OFFSET UNITYSDK_OFFSET(0x17D27660)
#define ZXING_DATAMATRIX_ENCODER_C40ENCODER_ENCODECHAR_OFFSET UNITYSDK_OFFSET(0x17D27E30)
#define ZXING_DATAMATRIX_ENCODER_C40ENCODER_ENCODETOCODEWORDS_OFFSET UNITYSDK_OFFSET(0x17D277F0)
#define ZXING_DATAMATRIX_ENCODER_C40ENCODER_ENCODE_OFFSET UNITYSDK_OFFSET(0x17D27240)
#define ZXING_DATAMATRIX_ENCODER_C40ENCODER_GET_ENCODINGMODE_OFFSET UNITYSDK_OFFSET(0x17D27230)
#define ZXING_DATAMATRIX_ENCODER_C40ENCODER_HANDLEEOD_OFFSET UNITYSDK_OFFSET(0x17D27950)
#define ZXING_DATAMATRIX_ENCODER_C40ENCODER_WRITENEXTTRIPLET_OFFSET UNITYSDK_OFFSET(0x17D27720)
#define ZXING_DATAMATRIX_ENCODER_C40ENCODER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D28050)

namespace ZXing::Datamatrix::Encoder
{
	inline static constexpr unsigned int C40Encoder_TypeDefinitionIndex = 8630;
