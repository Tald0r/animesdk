...
#define ZXING_DATAMATRIX_ENCODER_BASE256ENCODER_ENCODE_OFFSET UNITYSDK_OFFSET(0x1842E6F0)
#define ZXING_DATAMATRIX_ENCODER_BASE256ENCODER_GET_ENCODINGMODE_OFFSET UNITYSDK_OFFSET(0x1842E6E0)
#define ZXING_DATAMATRIX_ENCODER_BASE256ENCODER_RANDOMIZE255STATE_OFFSET UNITYSDK_OFFSET(0x1842EC20)
#define ZXING_DATAMATRIX_ENCODER_BASE256ENCODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1842EC70)

namespace ZXing::Datamatrix::Encoder
{
	inline static constexpr unsigned int Base256Encoder_TypeDefinitionIndex = 8678;
