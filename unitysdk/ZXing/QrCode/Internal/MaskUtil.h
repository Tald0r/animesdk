...
#define ZXING_QRCODE_INTERNAL_MASKUTIL_APPLYMASKPENALTYRULE1INTERNAL_OFFSET UNITYSDK_OFFSET(0x17D4CDA0)
#define ZXING_QRCODE_INTERNAL_MASKUTIL_APPLYMASKPENALTYRULE1_OFFSET UNITYSDK_OFFSET(0x17D48510)
#define ZXING_QRCODE_INTERNAL_MASKUTIL_APPLYMASKPENALTYRULE2_OFFSET UNITYSDK_OFFSET(0x17D48540)
#define ZXING_QRCODE_INTERNAL_MASKUTIL_APPLYMASKPENALTYRULE3_OFFSET UNITYSDK_OFFSET(0x17D48720)
#define ZXING_QRCODE_INTERNAL_MASKUTIL_APPLYMASKPENALTYRULE4_OFFSET UNITYSDK_OFFSET(0x17D48E80)
#define ZXING_QRCODE_INTERNAL_MASKUTIL_GETDATAMASKBIT_OFFSET UNITYSDK_OFFSET(0x17D4D120)
#define ZXING_QRCODE_INTERNAL_MASKUTIL_ISWHITEHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x17D4D020)
#define ZXING_QRCODE_INTERNAL_MASKUTIL_ISWHITEVERTICAL_OFFSET UNITYSDK_OFFSET(0x17D4D090)

namespace ZXing::QrCode::Internal
{
	inline static constexpr unsigned int MaskUtil_TypeDefinitionIndex = 8595;
