...
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_CLEAR_OFFSET UNITYSDK_OFFSET(0x17D480D0)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_GET_ARRAY_OFFSET UNITYSDK_OFFSET(0x17D480C0)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x17D48040)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x17D25D10)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x17D48050)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x17D48060)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_SET_OFFSET UNITYSDK_OFFSET(0x17D25A80)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17D48180)
#define ZXING_QRCODE_INTERNAL_BYTEMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x17D25970)

namespace ZXing::QrCode::Internal
{
	inline static constexpr unsigned int ByteMatrix_TypeDefinitionIndex = 8615;
