...
#define ZXING_QRCODE_INTERNAL_QRCODE_GET_ECLEVEL_OFFSET UNITYSDK_OFFSET(0x1845B210)
#define ZXING_QRCODE_INTERNAL_QRCODE_GET_MASKPATTERN_OFFSET UNITYSDK_OFFSET(0x1845B250)
#define ZXING_QRCODE_INTERNAL_QRCODE_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1845B270)
#define ZXING_QRCODE_INTERNAL_QRCODE_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1845B1F0)
#define ZXING_QRCODE_INTERNAL_QRCODE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1845B230)
#define ZXING_QRCODE_INTERNAL_QRCODE_ISVALIDMASKPATTERN_OFFSET UNITYSDK_OFFSET(0x18456A60)
#define ZXING_QRCODE_INTERNAL_QRCODE_SET_ECLEVEL_OFFSET UNITYSDK_OFFSET(0x1845B220)
#define ZXING_QRCODE_INTERNAL_QRCODE_SET_MASKPATTERN_OFFSET UNITYSDK_OFFSET(0x1845B260)
#define ZXING_QRCODE_INTERNAL_QRCODE_SET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1845B280)
#define ZXING_QRCODE_INTERNAL_QRCODE_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1845B200)
#define ZXING_QRCODE_INTERNAL_QRCODE_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1845B240)
#define ZXING_QRCODE_INTERNAL_QRCODE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1845B290)
#define ZXING_QRCODE_INTERNAL_QRCODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1845B460)
#define ZXING_QRCODE_INTERNAL_QRCODE__CTOR_OFFSET UNITYSDK_OFFSET(0x18453230)

namespace ZXing::QrCode::Internal
{
	inline static constexpr unsigned int QRCode_TypeDefinitionIndex = 8656;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(QRCode_TypeDefinitionIndex)->GetStaticField(0x3C40);
		}
