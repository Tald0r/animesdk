...
#define ZXING_QRCODE_INTERNAL_ENCODER_APPEND8BITBYTES_OFFSET UNITYSDK_OFFSET(0x17D4C690)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDALPHANUMERICBYTES_OFFSET UNITYSDK_OFFSET(0x17D4C400)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDBYTES_OFFSET UNITYSDK_OFFSET(0x17D49F70)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDECI_OFFSET UNITYSDK_OFFSET(0x17D49E80)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDKANJIBYTES_OFFSET UNITYSDK_OFFSET(0x17D4C850)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDLENGTHINFO_OFFSET UNITYSDK_OFFSET(0x17D4A520)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDMODEINFO_OFFSET UNITYSDK_OFFSET(0x17D49F40)
#define ZXING_QRCODE_INTERNAL_ENCODER_APPENDNUMERICBYTES_OFFSET UNITYSDK_OFFSET(0x17D4C210)
#define ZXING_QRCODE_INTERNAL_ENCODER_CALCULATEBITSNEEDED_OFFSET UNITYSDK_OFFSET(0x17D4A270)
#define ZXING_QRCODE_INTERNAL_ENCODER_CALCULATEMASKPENALTY_OFFSET UNITYSDK_OFFSET(0x17D484C0)
#define ZXING_QRCODE_INTERNAL_ENCODER_CHOOSEMASKPATTERN_OFFSET UNITYSDK_OFFSET(0x17D4B800)
#define ZXING_QRCODE_INTERNAL_ENCODER_CHOOSEMODE_OFFSET UNITYSDK_OFFSET(0x17D49CA0)
#define ZXING_QRCODE_INTERNAL_ENCODER_CHOOSEVERSION_OFFSET UNITYSDK_OFFSET(0x17D4BA80)
#define ZXING_QRCODE_INTERNAL_ENCODER_ENCODE_OFFSET UNITYSDK_OFFSET(0x17D490F0)
#define ZXING_QRCODE_INTERNAL_ENCODER_GENERATEECBYTES_OFFSET UNITYSDK_OFFSET(0x17D4C040)
#define ZXING_QRCODE_INTERNAL_ENCODER_GETALPHANUMERICCODE_OFFSET UNITYSDK_OFFSET(0x17D4BC00)
#define ZXING_QRCODE_INTERNAL_ENCODER_GETNUMDATABYTESANDNUMECBYTESFORBLOCKID_OFFSET UNITYSDK_OFFSET(0x17D4BE70)
#define ZXING_QRCODE_INTERNAL_ENCODER_INTERLEAVEWITHECBYTES_OFFSET UNITYSDK_OFFSET(0x17D4A970)
#define ZXING_QRCODE_INTERNAL_ENCODER_ISONLYDOUBLEBYTEKANJI_OFFSET UNITYSDK_OFFSET(0x17D4BCE0)
#define ZXING_QRCODE_INTERNAL_ENCODER_RECOMMENDVERSION_OFFSET UNITYSDK_OFFSET(0x17D4A380)
#define ZXING_QRCODE_INTERNAL_ENCODER_TERMINATEBITS_OFFSET UNITYSDK_OFFSET(0x17D4A6B0)
#define ZXING_QRCODE_INTERNAL_ENCODER_WILLFIT_OFFSET UNITYSDK_OFFSET(0x17D4A2B0)
#define ZXING_QRCODE_INTERNAL_ENCODER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17D4CB20)

namespace ZXing::QrCode::Internal
{
	inline static constexpr unsigned int Encoder_TypeDefinitionIndex = 8640;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Encoder_TypeDefinitionIndex)->GetStaticField(0x7BA0);
		}
		static ::System::String** StaticGet_DEFAULT_BYTE_MODE_ENCODING()
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Encoder_TypeDefinitionIndex)->GetStaticField(0x7BA8);
		}
