...
#define ZXING_PDF417_PDF417WRITER_BITMATRIXFROMBITARRAY_OFFSET UNITYSDK_OFFSET(0x1844F850)
#define ZXING_PDF417_PDF417WRITER_BITMATRIXFROMENCODER_OFFSET UNITYSDK_OFFSET(0x1844F450)
#define ZXING_PDF417_PDF417WRITER_ENCODE_OFFSET UNITYSDK_OFFSET(0x1844E1F0)
#define ZXING_PDF417_PDF417WRITER_ROTATEARRAY_OFFSET UNITYSDK_OFFSET(0x1844F5A0)
#define ZXING_PDF417_PDF417WRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x184368D0)

namespace ZXing::PDF417
{
	inline static constexpr unsigned int PDF417Writer_TypeDefinitionIndex = 8672;
