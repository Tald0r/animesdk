...
#define ZXING_ONED_CODE128WRITER_CHOOSECODE_OFFSET UNITYSDK_OFFSET(0x17D361A0)
#define ZXING_ONED_CODE128WRITER_ENCODE_1_OFFSET UNITYSDK_OFFSET(0x17D35B00)
#define ZXING_ONED_CODE128WRITER_ENCODE_OFFSET UNITYSDK_OFFSET(0x17D354F0)
#define ZXING_ONED_CODE128WRITER_FINDCTYPE_OFFSET UNITYSDK_OFFSET(0x17D36510)
#define ZXING_ONED_CODE128WRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D2EDD0)

namespace ZXing::OneD
{
	inline static constexpr unsigned int Code128Writer_TypeDefinitionIndex = 8657;
