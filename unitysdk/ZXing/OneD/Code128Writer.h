...
#define ZXING_ONED_CODE128WRITER_CHOOSECODE_OFFSET UNITYSDK_OFFSET(0x1843DC00)
#define ZXING_ONED_CODE128WRITER_ENCODE_1_OFFSET UNITYSDK_OFFSET(0x1843D560)
#define ZXING_ONED_CODE128WRITER_ENCODE_OFFSET UNITYSDK_OFFSET(0x1843CF50)
#define ZXING_ONED_CODE128WRITER_FINDCTYPE_OFFSET UNITYSDK_OFFSET(0x1843DF70)
#define ZXING_ONED_CODE128WRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x18436830)

namespace ZXing::OneD
{
	inline static constexpr unsigned int Code128Writer_TypeDefinitionIndex = 8668;
