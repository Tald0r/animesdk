...
#define ZXING_ONED_CODE93WRITER_APPENDPATTERN_OFFSET UNITYSDK_OFFSET(0x17D38380)
#define ZXING_ONED_CODE93WRITER_COMPUTECHECKSUMINDEX_OFFSET UNITYSDK_OFFSET(0x17D384C0)
#define ZXING_ONED_CODE93WRITER_ENCODE_1_OFFSET UNITYSDK_OFFSET(0x17D37620)
#define ZXING_ONED_CODE93WRITER_ENCODE_OFFSET UNITYSDK_OFFSET(0x17D37580)
#define ZXING_ONED_CODE93WRITER_TOINTARRAY_OFFSET UNITYSDK_OFFSET(0x17D382B0)
#define ZXING_ONED_CODE93WRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D2ED80)

namespace ZXing::OneD
{
	inline static constexpr unsigned int Code93Writer_TypeDefinitionIndex = 8586;
