...
#define ZXING_ONED_ONEDIMENSIONALCODEWRITER_APPENDPATTERN_OFFSET UNITYSDK_OFFSET(0x1843DDD0)
#define ZXING_ONED_ONEDIMENSIONALCODEWRITER_ENCODE_OFFSET UNITYSDK_OFFSET(0x1843D240)
#define ZXING_ONED_ONEDIMENSIONALCODEWRITER_GET_DEFAULTMARGIN_OFFSET UNITYSDK_OFFSET(0x18444520)
#define ZXING_ONED_ONEDIMENSIONALCODEWRITER_RENDERRESULT_OFFSET UNITYSDK_OFFSET(0x184443A0)
#define ZXING_ONED_ONEDIMENSIONALCODEWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x184378B0)

namespace ZXing::OneD
{
	inline static constexpr unsigned int OneDimensionalCodeWriter_TypeDefinitionIndex = 8596;
