...
#define ZXING_ONED_EANMANUFACTURERORGSUPPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x17D3A0E0)

namespace ZXing::OneD
{
	inline static constexpr unsigned int EANManufacturerOrgSupport_TypeDefinitionIndex = 8656;
