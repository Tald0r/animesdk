...
#define MONOCOPYLAYOUTELEMENT_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x9933B60)
#define MONOCOPYLAYOUTELEMENT_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x9933BC0)
#define MONOCOPYLAYOUTELEMENT_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x9933CE0)
#define MONOCOPYLAYOUTELEMENT_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x99338E0)
#define MONOCOPYLAYOUTELEMENT_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x9933A20)
#define MONOCOPYLAYOUTELEMENT_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x99338D0)
#define MONOCOPYLAYOUTELEMENT_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x9933780)
#define MONOCOPYLAYOUTELEMENT_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x9933630)
#define MONOCOPYLAYOUTELEMENT_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x99334E0)
#define MONOCOPYLAYOUTELEMENT_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x9933390)
#define MONOCOPYLAYOUTELEMENT_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x9933C20)
#define MONOCOPYLAYOUTELEMENT_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x9933C80)
#define MONOCOPYLAYOUTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x9933D50)

inline static constexpr unsigned int MonoCopyLayoutElement_TypeDefinitionIndex = 38291;
