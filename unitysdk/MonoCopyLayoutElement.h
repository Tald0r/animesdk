...
#define MONOCOPYLAYOUTELEMENT_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x7558D60)
#define MONOCOPYLAYOUTELEMENT_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x7558DC0)
#define MONOCOPYLAYOUTELEMENT_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x7558EE0)
#define MONOCOPYLAYOUTELEMENT_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x7558AE0)
#define MONOCOPYLAYOUTELEMENT_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x7558C20)
#define MONOCOPYLAYOUTELEMENT_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x7558AD0)
#define MONOCOPYLAYOUTELEMENT_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x7558980)
#define MONOCOPYLAYOUTELEMENT_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x7558830)
#define MONOCOPYLAYOUTELEMENT_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x75586E0)
#define MONOCOPYLAYOUTELEMENT_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x7558590)
#define MONOCOPYLAYOUTELEMENT_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x7558E20)
#define MONOCOPYLAYOUTELEMENT_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x7558E80)
#define MONOCOPYLAYOUTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x7558F50)

inline static constexpr unsigned int MonoCopyLayoutElement_TypeDefinitionIndex = 55881;
