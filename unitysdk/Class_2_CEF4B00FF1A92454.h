...
#define CLASS_2_CEF4B00FF1A92454_METHOD_2_2B5F6CF81A41B998_OFFSET UNITYSDK_OFFSET(0x97AD500)
#define CLASS_2_CEF4B00FF1A92454_METHOD_2_60D66D1EE0DABC91_OFFSET UNITYSDK_OFFSET(0x97AD970)
#define CLASS_2_CEF4B00FF1A92454_METHOD_2_7A61F59CD69023FD_OFFSET UNITYSDK_OFFSET(0x97AD820)
#define CLASS_2_CEF4B00FF1A92454_METHOD_2_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0x97ADA00)
#define CLASS_2_CEF4B00FF1A92454__CTOR_OFFSET UNITYSDK_OFFSET(0x97AD480)

inline static constexpr unsigned int Class_2_CEF4B00FF1A92454_TypeDefinitionIndex = 74283;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::MoleMole::GalGame::MainCityChatNPCEnterAction*))((::PBYTE)hIl2Cpp + CLASS_2_CEF4B00FF1A92454_METHOD_2_7A61F59CD69023FD_OFFSET))(this, a1);
	}
};
