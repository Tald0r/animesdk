...
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18DE2B40)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_MIHOYOSDKJSON_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18DE31B0)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_MIHOYOSDKJSON_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18DE3140)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18DE3230)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18DE31A0)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18DE3150)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18DE2830)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43__CTOR_OFFSET UNITYSDK_OFFSET(0x18DE2810)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x18DE2A90)
#define MIHOYOSDKJSON_JSONNODE__GET_DEEPCHILDREN_D__43___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x18DE29E0)

namespace MiHoYoSDKJSON
{
	inline static constexpr unsigned int JSONNode__get_DeepChildren_d__43_TypeDefinitionIndex = 33385;
