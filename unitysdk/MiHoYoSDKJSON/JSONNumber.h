...
#define MIHOYOSDKJSON_JSONNUMBER_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C94EB0)
#define MIHOYOSDKJSON_JSONNUMBER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19C94BC0)
#define MIHOYOSDKJSON_JSONNUMBER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C95050)
#define MIHOYOSDKJSON_JSONNUMBER_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x19C94C80)
#define MIHOYOSDKJSON_JSONNUMBER_GET_ASLONG_OFFSET UNITYSDK_OFFSET(0x19C94CA0)
#define MIHOYOSDKJSON_JSONNUMBER_GET_ISNUMBER_OFFSET UNITYSDK_OFFSET(0x19C94BB0)
#define MIHOYOSDKJSON_JSONNUMBER_GET_TAG_OFFSET UNITYSDK_OFFSET(0x19C94BA0)
#define MIHOYOSDKJSON_JSONNUMBER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19C94BE0)
#define MIHOYOSDKJSON_JSONNUMBER_ISNUMERIC_OFFSET UNITYSDK_OFFSET(0x19C94E30)
#define MIHOYOSDKJSON_JSONNUMBER_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x19C94C90)
#define MIHOYOSDKJSON_JSONNUMBER_SET_ASLONG_OFFSET UNITYSDK_OFFSET(0x19C94CB0)
#define MIHOYOSDKJSON_JSONNUMBER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19C94C20)
#define MIHOYOSDKJSON_JSONNUMBER_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x19C94DD0)
#define MIHOYOSDKJSON_JSONNUMBER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C94D30)
#define MIHOYOSDKJSON_JSONNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C94CC0)

namespace MiHoYoSDKJSON
{
	inline static constexpr unsigned int JSONNumber_TypeDefinitionIndex = 34346;
