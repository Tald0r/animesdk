...
#define NAPMATERIALPROPERTY_GET_ISMATERIALIDPROPERTY_OFFSET UNITYSDK_OFFSET(0x7D3480)
#define NAPMATERIALPROPERTY_GET_ISRAMPDEPENDENCYPROPERTY_OFFSET UNITYSDK_OFFSET(0x7D34D0)
#define NAPMATERIALPROPERTY_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x17776F40)
#define NAPMATERIALPROPERTY_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x17776E40)
#define NAPMATERIALPROPERTY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x17776DE0)
#define NAPMATERIALPROPERTY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7D3670)
#define NAPMATERIALPROPERTY__CCTOR_OFFSET UNITYSDK_OFFSET(0x17777100)
#define NAPMATERIALPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7D35C0)
#define NAPMATERIALPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x7D3520)
#define NAPMATERIALPROPERTY___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7D3680)

inline static constexpr unsigned int NapMaterialProperty_TypeDefinitionIndex = 29055;

struct alignas(4) NapMaterialProperty
{
	static ::NapMaterialProperty* StaticGet_Invalid()
	{
		return (::NapMaterialProperty*)Il2CppClass::FromTypeDefinitionIndex(NapMaterialProperty_TypeDefinitionIndex)->GetStaticField(0x56A0);
	}
