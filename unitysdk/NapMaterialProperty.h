...
#define NAPMATERIALPROPERTY_GET_ISMATERIALIDPROPERTY_OFFSET UNITYSDK_OFFSET(0x79B920)
#define NAPMATERIALPROPERTY_GET_ISRAMPDEPENDENCYPROPERTY_OFFSET UNITYSDK_OFFSET(0x79B970)
#define NAPMATERIALPROPERTY_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1794F890)
#define NAPMATERIALPROPERTY_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1794F790)
#define NAPMATERIALPROPERTY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1794F730)
#define NAPMATERIALPROPERTY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x79BB10)
#define NAPMATERIALPROPERTY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1794FA50)
#define NAPMATERIALPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x79BA60)
#define NAPMATERIALPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x79B9C0)
#define NAPMATERIALPROPERTY___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x79BB20)

inline static constexpr unsigned int NapMaterialProperty_TypeDefinitionIndex = 28115;

struct alignas(4) NapMaterialProperty
{
	static ::NapMaterialProperty* StaticGet_Invalid()
	{
		return (::NapMaterialProperty*)Il2CppClass::FromTypeDefinitionIndex(NapMaterialProperty_TypeDefinitionIndex)->GetStaticField(0x55C0);
	}
