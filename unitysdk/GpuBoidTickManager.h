...
#define GPUBOIDTICKMANAGER_ALLPOINTSOUTSIDEPLANEAABB_OFFSET UNITYSDK_OFFSET(0x17BE4CA0)
#define GPUBOIDTICKMANAGER_FRUSTUMCULLED_OFFSET UNITYSDK_OFFSET(0x17BE48C0)
#define GPUBOIDTICKMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x17BE4240)
#define GPUBOIDTICKMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x17BE4440)
#define GPUBOIDTICKMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x17BE44D0)
#define GPUBOIDTICKMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x17BE4560)
#define GPUBOIDTICKMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17BE4EC0)
#define GPUBOIDTICKMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x17BE4390)

inline static constexpr unsigned int GpuBoidTickManager_TypeDefinitionIndex = 28081;
...
public:
	...
	{
		return (::GpuBoidTickManager**)Il2CppClass::FromTypeDefinitionIndex(GpuBoidTickManager_TypeDefinitionIndex)->GetStaticField(0x22220);
	}
