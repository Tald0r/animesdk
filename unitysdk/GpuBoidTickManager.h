...
#define GPUBOIDTICKMANAGER_ALLPOINTSOUTSIDEPLANEAABB_OFFSET UNITYSDK_OFFSET(0x182CCEE0)
#define GPUBOIDTICKMANAGER_FRUSTUMCULLED_OFFSET UNITYSDK_OFFSET(0x182CCB00)
#define GPUBOIDTICKMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x182CC480)
#define GPUBOIDTICKMANAGER_REGISTER_OFFSET UNITYSDK_OFFSET(0x182CC680)
#define GPUBOIDTICKMANAGER_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x182CC710)
#define GPUBOIDTICKMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x182CC7A0)
#define GPUBOIDTICKMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x182CD100)
#define GPUBOIDTICKMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x182CC5D0)

inline static constexpr unsigned int GpuBoidTickManager_TypeDefinitionIndex = 29021;
...
public:
	...
	{
		return (::GpuBoidTickManager**)Il2CppClass::FromTypeDefinitionIndex(GpuBoidTickManager_TypeDefinitionIndex)->GetStaticField(0x23C70);
	}
