...
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS__GETLOD3MESHASYNC_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x33C1A0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS__GETLOD3MESHASYNC_D__15_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

inline static constexpr unsigned int NPCAvatarMeshAssetsSO_FNPCAvatarLodMeshAssets__GetLOD3MeshAsync_d__15_TypeDefinitionIndex = 62315;
