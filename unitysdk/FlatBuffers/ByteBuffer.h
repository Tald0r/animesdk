...
#define FLATBUFFERS_BYTEBUFFER_ASSERTOFFSETANDLENGTH_OFFSET UNITYSDK_OFFSET(0x1B1D5880)
#define FLATBUFFERS_BYTEBUFFER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B1D56A0)
#define FLATBUFFERS_BYTEBUFFER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B1D5620)
#define FLATBUFFERS_BYTEBUFFER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B1D6BF0)
#define FLATBUFFERS_BYTEBUFFER_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1B1D6B40)
#define FLATBUFFERS_BYTEBUFFER_GETINT_OFFSET UNITYSDK_OFFSET(0x1B1D68A0)
#define FLATBUFFERS_BYTEBUFFER_GETLONG_OFFSET UNITYSDK_OFFSET(0x1B1D69F0)
#define FLATBUFFERS_BYTEBUFFER_GETSBYTE_OFFSET UNITYSDK_OFFSET(0x1B1D6550)
#define FLATBUFFERS_BYTEBUFFER_GETSHORT_OFFSET UNITYSDK_OFFSET(0x1B1D6750)
#define FLATBUFFERS_BYTEBUFFER_GETSTRINGUTF8_OFFSET UNITYSDK_OFFSET(0x1B1D6660)
#define FLATBUFFERS_BYTEBUFFER_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1B1D6650)
#define FLATBUFFERS_BYTEBUFFER_GETUINT_OFFSET UNITYSDK_OFFSET(0x1B1D68B0)
#define FLATBUFFERS_BYTEBUFFER_GETULONG_OFFSET UNITYSDK_OFFSET(0x1B1D6A00)
#define FLATBUFFERS_BYTEBUFFER_GETUSHORT_OFFSET UNITYSDK_OFFSET(0x1B1D6760)
#define FLATBUFFERS_BYTEBUFFER_GET_ISMONOSTRING_OFFSET UNITYSDK_OFFSET(0x1B1D56D0)
#define FLATBUFFERS_BYTEBUFFER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B1D5710)
#define FLATBUFFERS_BYTEBUFFER_GET_OFFSET UNITYSDK_OFFSET(0x1B1D65D0)
#define FLATBUFFERS_BYTEBUFFER_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B1D56F0)
#define FLATBUFFERS_BYTEBUFFER_GROWFRONT_OFFSET UNITYSDK_OFFSET(0x1B1D5740)
#define FLATBUFFERS_BYTEBUFFER_PUTBYTE_1_OFFSET UNITYSDK_OFFSET(0x1B1D59F0)
#define FLATBUFFERS_BYTEBUFFER_PUTBYTE_OFFSET UNITYSDK_OFFSET(0x1B1D5960)
#define FLATBUFFERS_BYTEBUFFER_PUTDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B1D6490)
#define FLATBUFFERS_BYTEBUFFER_PUTFLOAT_OFFSET UNITYSDK_OFFSET(0x1B1D63D0)
#define FLATBUFFERS_BYTEBUFFER_PUTINT_OFFSET UNITYSDK_OFFSET(0x1B1D6110)
#define FLATBUFFERS_BYTEBUFFER_PUTLONG_OFFSET UNITYSDK_OFFSET(0x1B1D6270)
#define FLATBUFFERS_BYTEBUFFER_PUTSBYTE_OFFSET UNITYSDK_OFFSET(0x1B1D58D0)
#define FLATBUFFERS_BYTEBUFFER_PUTSHORT_OFFSET UNITYSDK_OFFSET(0x1B1D5FB0)
#define FLATBUFFERS_BYTEBUFFER_PUTSTRINGUTF16_OFFSET UNITYSDK_OFFSET(0x1B1D5BB0)
#define FLATBUFFERS_BYTEBUFFER_PUTSTRINGUTF8_OFFSET UNITYSDK_OFFSET(0x1B1D5E40)
#define FLATBUFFERS_BYTEBUFFER_PUTUINT_OFFSET UNITYSDK_OFFSET(0x1B1D6120)
#define FLATBUFFERS_BYTEBUFFER_PUTULONG_OFFSET UNITYSDK_OFFSET(0x1B1D6280)
#define FLATBUFFERS_BYTEBUFFER_PUTUSHORT_OFFSET UNITYSDK_OFFSET(0x1B1D5FC0)
#define FLATBUFFERS_BYTEBUFFER_PUT_OFFSET UNITYSDK_OFFSET(0x1B1D5B20)
#define FLATBUFFERS_BYTEBUFFER_RESET_OFFSET UNITYSDK_OFFSET(0x1B1D5730)
#define FLATBUFFERS_BYTEBUFFER_REVERSEBYTES_1_OFFSET UNITYSDK_OFFSET(0x1B1D5860)
#define FLATBUFFERS_BYTEBUFFER_REVERSEBYTES_2_OFFSET UNITYSDK_OFFSET(0x1B1D5870)
#define FLATBUFFERS_BYTEBUFFER_REVERSEBYTES_OFFSET UNITYSDK_OFFSET(0x1B1D5850)
#define FLATBUFFERS_BYTEBUFFER_SET_ISMONOSTRING_OFFSET UNITYSDK_OFFSET(0x1B1D56E0)
#define FLATBUFFERS_BYTEBUFFER_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B1D5700)
#define FLATBUFFERS_BYTEBUFFER_TOARRAY_OFFSET UNITYSDK_OFFSET(0x1B1D5770)
#define FLATBUFFERS_BYTEBUFFER_TOFULLARRAY_OFFSET UNITYSDK_OFFSET(0x1B1D57B0)
#define FLATBUFFERS_BYTEBUFFER_TOSIZEDARRAY_OFFSET UNITYSDK_OFFSET(0x1B1D5780)
#define FLATBUFFERS_BYTEBUFFER_TOSPAN_OFFSET UNITYSDK_OFFSET(0x1B1D57E0)
#define FLATBUFFERS_BYTEBUFFER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1D6CA0)
#define FLATBUFFERS_BYTEBUFFER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1D4FF0)
#define FLATBUFFERS_BYTEBUFFER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B1D50B0)
#define FLATBUFFERS_BYTEBUFFER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B1D5160)
#define FLATBUFFERS_BYTEBUFFER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B1D5520)
#define FLATBUFFERS_BYTEBUFFER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1B1D5580)
#define FLATBUFFERS_BYTEBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D4FE0)

namespace FlatBuffers
{
	inline static constexpr unsigned int ByteBuffer_TypeDefinitionIndex = 8727;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ByteBuffer_TypeDefinitionIndex)->GetStaticField(0x3C50);
		}
