...
#define FLATBUFFERS_STRUCT_GET_BB_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define FLATBUFFERS_STRUCT_GET_BB_POS_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define FLATBUFFERS_STRUCT_SET_BB_OFFSET UNITYSDK_OFFSET(0x2CB170)
#define FLATBUFFERS_STRUCT_SET_BB_POS_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define FLATBUFFERS_STRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x95C4B0)

namespace FlatBuffers
{
	inline static constexpr unsigned int Struct_TypeDefinitionIndex = 8724;
