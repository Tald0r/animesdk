...
#define FLATBUFFERS_STRUCT_GET_BB_OFFSET UNITYSDK_OFFSET(0x272280)
#define FLATBUFFERS_STRUCT_GET_BB_POS_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define FLATBUFFERS_STRUCT_SET_BB_OFFSET UNITYSDK_OFFSET(0x302310)
#define FLATBUFFERS_STRUCT_SET_BB_POS_OFFSET UNITYSDK_OFFSET(0x302300)
#define FLATBUFFERS_STRUCT__CTOR_OFFSET UNITYSDK_OFFSET(0x98EFF0)

namespace FlatBuffers
{
	inline static constexpr unsigned int Struct_TypeDefinitionIndex = 8735;
