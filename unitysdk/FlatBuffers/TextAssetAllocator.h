...
#define FLATBUFFERS_TEXTASSETALLOCATOR_ASSERT_OFFSET UNITYSDK_OFFSET(0x1ABD28C0)
#define FLATBUFFERS_TEXTASSETALLOCATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ABD2BA0)
#define FLATBUFFERS_TEXTASSETALLOCATOR_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1ABD2B70)
#define FLATBUFFERS_TEXTASSETALLOCATOR_GET_READONLYSPAN_OFFSET UNITYSDK_OFFSET(0x1ABD2AB0)
#define FLATBUFFERS_TEXTASSETALLOCATOR_GET_SPAN_OFFSET UNITYSDK_OFFSET(0x1ABD29F0)
#define FLATBUFFERS_TEXTASSETALLOCATOR_GROWFRONT_OFFSET UNITYSDK_OFFSET(0x1ABD29A0)
#define FLATBUFFERS_TEXTASSETALLOCATOR_INITBUFFER_OFFSET UNITYSDK_OFFSET(0x1ABD27C0)
#define FLATBUFFERS_TEXTASSETALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABCD020)
#define FLATBUFFERS_TEXTASSETALLOCATOR__INITBUFFER_B__10_0_OFFSET UNITYSDK_OFFSET(0x1ABD2BB0)

namespace FlatBuffers
{
	inline static constexpr unsigned int TextAssetAllocator_TypeDefinitionIndex = 8713;
