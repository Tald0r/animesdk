...
#define FLATBUFFERS_BYTEBUFFERUTIL_CONVERTUTF16TOUTF8_OFFSET UNITYSDK_OFFSET(0x1ABCECA0)
#define FLATBUFFERS_BYTEBUFFERUTIL_GETSIZEPREFIX_OFFSET UNITYSDK_OFFSET(0x1ABCEC80)
#define FLATBUFFERS_BYTEBUFFERUTIL_TRYDATALIST_OFFSET UNITYSDK_OFFSET(0x1ABCEDA0)

namespace FlatBuffers
{
	inline static constexpr unsigned int ByteBufferUtil_TypeDefinitionIndex = 8717;
