...
#define FLATBUFFERS_BYTEBUFFERUTIL_CONVERTUTF16TOUTF8_OFFSET UNITYSDK_OFFSET(0x1B1D7250)
#define FLATBUFFERS_BYTEBUFFERUTIL_GETSIZEPREFIX_OFFSET UNITYSDK_OFFSET(0x1B1D7230)
#define FLATBUFFERS_BYTEBUFFERUTIL_TRYDATALIST_OFFSET UNITYSDK_OFFSET(0x1B1D7350)

namespace FlatBuffers
{
	inline static constexpr unsigned int ByteBufferUtil_TypeDefinitionIndex = 8728;
