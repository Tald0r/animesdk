...
#define FLATBUFFERS_BYTEBUFFERALLOCATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B1D7200)
#define FLATBUFFERS_BYTEBUFFERALLOCATOR_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B1D7210)
#define FLATBUFFERS_BYTEBUFFERALLOCATOR_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B1D7220)
#define FLATBUFFERS_BYTEBUFFERALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D4DC0)

namespace FlatBuffers
{
	inline static constexpr unsigned int ByteBufferAllocator_TypeDefinitionIndex = 8722;
