...
#define FLATBUFFERS_BYTEBUFFERALLOCATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ABCEC50)
#define FLATBUFFERS_BYTEBUFFERALLOCATOR_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1ABCEC60)
#define FLATBUFFERS_BYTEBUFFERALLOCATOR_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1ABCEC70)
#define FLATBUFFERS_BYTEBUFFERALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABCC800)

namespace FlatBuffers
{
	inline static constexpr unsigned int ByteBufferAllocator_TypeDefinitionIndex = 8711;
