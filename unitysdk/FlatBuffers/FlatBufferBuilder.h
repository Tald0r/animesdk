...
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDBOOL_1_OFFSET UNITYSDK_OFFSET(0x1ABCFE60)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDBOOL_2_OFFSET UNITYSDK_OFFSET(0x1ABCFEB0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDBOOL_OFFSET UNITYSDK_OFFSET(0x1ABCF740)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDBYTE_1_OFFSET UNITYSDK_OFFSET(0x1ABCFFC0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDBYTE_2_OFFSET UNITYSDK_OFFSET(0x1ABD0010)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDBYTE_OFFSET UNITYSDK_OFFSET(0x1ABCF7A0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDDOUBLE_1_OFFSET UNITYSDK_OFFSET(0x1ABD0750)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDDOUBLE_2_OFFSET UNITYSDK_OFFSET(0x1ABD07D0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDDOUBLE_OFFSET UNITYSDK_OFFSET(0x1ABCF9A0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDFLOAT_1_OFFSET UNITYSDK_OFFSET(0x1ABD0660)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDFLOAT_2_OFFSET UNITYSDK_OFFSET(0x1ABD06E0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDFLOAT_OFFSET UNITYSDK_OFFSET(0x1ABCF950)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDINT_1_OFFSET UNITYSDK_OFFSET(0x1ABD0260)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDINT_2_OFFSET UNITYSDK_OFFSET(0x1ABD02D0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDINT_OFFSET UNITYSDK_OFFSET(0x1ABCF850)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDLONG_1_OFFSET UNITYSDK_OFFSET(0x1ABD0420)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDLONG_2_OFFSET UNITYSDK_OFFSET(0x1ABD0490)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDLONG_OFFSET UNITYSDK_OFFSET(0x1ABCF8D0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDOFFSET_1_OFFSET UNITYSDK_OFFSET(0x1ABD0890)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDOFFSET_OFFSET UNITYSDK_OFFSET(0x1ABCF9F0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSBYTE_1_OFFSET UNITYSDK_OFFSET(0x1ABCFF00)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSBYTE_2_OFFSET UNITYSDK_OFFSET(0x1ABCFF50)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSBYTE_OFFSET UNITYSDK_OFFSET(0x1ABCF770)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSHORT_1_OFFSET UNITYSDK_OFFSET(0x1ABD0080)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSHORT_2_OFFSET UNITYSDK_OFFSET(0x1ABD00F0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSHORT_OFFSET UNITYSDK_OFFSET(0x1ABCF7D0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSTRUCT_OFFSET UNITYSDK_OFFSET(0x1ABD10C0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDUINT_1_OFFSET UNITYSDK_OFFSET(0x1ABD0340)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDUINT_2_OFFSET UNITYSDK_OFFSET(0x1ABD03B0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDUINT_OFFSET UNITYSDK_OFFSET(0x1ABCF890)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDULONG_1_OFFSET UNITYSDK_OFFSET(0x1ABD0540)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDULONG_2_OFFSET UNITYSDK_OFFSET(0x1ABD05B0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDULONG_OFFSET UNITYSDK_OFFSET(0x1ABCF910)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDUSHORT_1_OFFSET UNITYSDK_OFFSET(0x1ABD0170)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDUSHORT_2_OFFSET UNITYSDK_OFFSET(0x1ABD01E0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDUSHORT_OFFSET UNITYSDK_OFFSET(0x1ABCF810)
#define FLATBUFFERS_FLATBUFFERBUILDER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1ABCF130)
#define FLATBUFFERS_FLATBUFFERBUILDER_CREATESHAREDSTRING_OFFSET UNITYSDK_OFFSET(0x1ABD0F10)
#define FLATBUFFERS_FLATBUFFERBUILDER_CREATESTRING_OFFSET UNITYSDK_OFFSET(0x1ABD08C0)
#define FLATBUFFERS_FLATBUFFERBUILDER_CREATEUTF8STRING_OFFSET UNITYSDK_OFFSET(0x1ABD0D70)
#define FLATBUFFERS_FLATBUFFERBUILDER_ENDTABLE_OFFSET UNITYSDK_OFFSET(0x1ABD10F0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ENDVECTOR_OFFSET UNITYSDK_OFFSET(0x1ABCFBA0)
#define FLATBUFFERS_FLATBUFFERBUILDER_FINISHSIZEPREFIXED_1_OFFSET UNITYSDK_OFFSET(0x1ABD19B0)
#define FLATBUFFERS_FLATBUFFERBUILDER_FINISHSIZEPREFIXED_OFFSET UNITYSDK_OFFSET(0x1ABD1750)
#define FLATBUFFERS_FLATBUFFERBUILDER_FINISH_1_OFFSET UNITYSDK_OFFSET(0x1ABD1710)
#define FLATBUFFERS_FLATBUFFERBUILDER_FINISH_2_OFFSET UNITYSDK_OFFSET(0x1ABD17B0)
#define FLATBUFFERS_FLATBUFFERBUILDER_FINISH_3_OFFSET UNITYSDK_OFFSET(0x1ABD19A0)
#define FLATBUFFERS_FLATBUFFERBUILDER_FINISH_OFFSET UNITYSDK_OFFSET(0x1ABD1670)
#define FLATBUFFERS_FLATBUFFERBUILDER_GET_DATABUFFER_OFFSET UNITYSDK_OFFSET(0x1ABD1760)
#define FLATBUFFERS_FLATBUFFERBUILDER_GET_FORCEDEFAULTS_OFFSET UNITYSDK_OFFSET(0x1ABCF240)
#define FLATBUFFERS_FLATBUFFERBUILDER_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1ABCF260)
#define FLATBUFFERS_FLATBUFFERBUILDER_GROWBUFFER_OFFSET UNITYSDK_OFFSET(0x1ABCF2C0)
#define FLATBUFFERS_FLATBUFFERBUILDER_NESTED_OFFSET UNITYSDK_OFFSET(0x1ABCFC00)
#define FLATBUFFERS_FLATBUFFERBUILDER_NOTNESTED_OFFSET UNITYSDK_OFFSET(0x1ABCFB30)
#define FLATBUFFERS_FLATBUFFERBUILDER_PAD_OFFSET UNITYSDK_OFFSET(0x1ABCF290)
#define FLATBUFFERS_FLATBUFFERBUILDER_PREP_OFFSET UNITYSDK_OFFSET(0x1ABCF300)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTBOOL_OFFSET UNITYSDK_OFFSET(0x1ABCF3E0)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTBYTE_OFFSET UNITYSDK_OFFSET(0x1ABCF520)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTDOUBLE_OFFSET UNITYSDK_OFFSET(0x1ABCF710)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTFLOAT_OFFSET UNITYSDK_OFFSET(0x1ABCF6E0)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTINT_OFFSET UNITYSDK_OFFSET(0x1ABCF620)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTLONG_OFFSET UNITYSDK_OFFSET(0x1ABCF680)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTSBYTE_OFFSET UNITYSDK_OFFSET(0x1ABCF480)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTSHORT_OFFSET UNITYSDK_OFFSET(0x1ABCF5C0)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTUINT_OFFSET UNITYSDK_OFFSET(0x1ABCF650)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTULONG_OFFSET UNITYSDK_OFFSET(0x1ABCF6B0)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTUSHORT_OFFSET UNITYSDK_OFFSET(0x1ABCF5F0)
#define FLATBUFFERS_FLATBUFFERBUILDER_REQUIRED_OFFSET UNITYSDK_OFFSET(0x1ABD1590)
#define FLATBUFFERS_FLATBUFFERBUILDER_SET_FORCEDEFAULTS_OFFSET UNITYSDK_OFFSET(0x1ABCF250)
#define FLATBUFFERS_FLATBUFFERBUILDER_SIZEDBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1ABD1770)
#define FLATBUFFERS_FLATBUFFERBUILDER_SLOT_OFFSET UNITYSDK_OFFSET(0x1ABCFDB0)
#define FLATBUFFERS_FLATBUFFERBUILDER_STARTTABLE_OFFSET UNITYSDK_OFFSET(0x1ABCFC90)
#define FLATBUFFERS_FLATBUFFERBUILDER_STARTVECTOR_OFFSET UNITYSDK_OFFSET(0x1ABCFA90)
#define FLATBUFFERS_FLATBUFFERBUILDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ABCF0B0)
#define FLATBUFFERS_FLATBUFFERBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABCEF10)

namespace FlatBuffers
{
	inline static constexpr unsigned int FlatBufferBuilder_TypeDefinitionIndex = 8718;

	class FlatBufferBuilder : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::String*, ::FlatBuffers::StringOffset>* _sharedStringMap; // 0x10
		...
		::FlatBuffers::ByteBuffer* _bb; // 0x28
		::Il2CppArray<::System::Int32>* _vtables; // 0x30
		::System::Int32 _numVtables; // 0x38
		::System::Int32 _minAlign; // 0x3C
		::System::Int32 _vtableSize; // 0x40
		::System::Int32 _space; // 0x44
		::System::Int32 _vectorNumElems; // 0x48
		::System::Boolean _ForceDefaults_k__BackingField; // 0x4C
		::System::Int32 _objectStart; // 0x50
