...
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDBOOL_1_OFFSET UNITYSDK_OFFSET(0x1B1D8410)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDBOOL_2_OFFSET UNITYSDK_OFFSET(0x1B1D8460)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDBOOL_OFFSET UNITYSDK_OFFSET(0x1B1D7CF0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDBYTE_1_OFFSET UNITYSDK_OFFSET(0x1B1D8570)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDBYTE_2_OFFSET UNITYSDK_OFFSET(0x1B1D85C0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDBYTE_OFFSET UNITYSDK_OFFSET(0x1B1D7D50)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDDOUBLE_1_OFFSET UNITYSDK_OFFSET(0x1B1D8D00)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDDOUBLE_2_OFFSET UNITYSDK_OFFSET(0x1B1D8D80)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B1D7F50)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDFLOAT_1_OFFSET UNITYSDK_OFFSET(0x1B1D8C10)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDFLOAT_2_OFFSET UNITYSDK_OFFSET(0x1B1D8C90)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDFLOAT_OFFSET UNITYSDK_OFFSET(0x1B1D7F00)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDINT_1_OFFSET UNITYSDK_OFFSET(0x1B1D8810)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDINT_2_OFFSET UNITYSDK_OFFSET(0x1B1D8880)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDINT_OFFSET UNITYSDK_OFFSET(0x1B1D7E00)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDLONG_1_OFFSET UNITYSDK_OFFSET(0x1B1D89D0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDLONG_2_OFFSET UNITYSDK_OFFSET(0x1B1D8A40)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDLONG_OFFSET UNITYSDK_OFFSET(0x1B1D7E80)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDOFFSET_1_OFFSET UNITYSDK_OFFSET(0x1B1D8E40)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDOFFSET_OFFSET UNITYSDK_OFFSET(0x1B1D7FA0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSBYTE_1_OFFSET UNITYSDK_OFFSET(0x1B1D84B0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSBYTE_2_OFFSET UNITYSDK_OFFSET(0x1B1D8500)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSBYTE_OFFSET UNITYSDK_OFFSET(0x1B1D7D20)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSHORT_1_OFFSET UNITYSDK_OFFSET(0x1B1D8630)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSHORT_2_OFFSET UNITYSDK_OFFSET(0x1B1D86A0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSHORT_OFFSET UNITYSDK_OFFSET(0x1B1D7D80)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDSTRUCT_OFFSET UNITYSDK_OFFSET(0x1B1D9670)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDUINT_1_OFFSET UNITYSDK_OFFSET(0x1B1D88F0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDUINT_2_OFFSET UNITYSDK_OFFSET(0x1B1D8960)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDUINT_OFFSET UNITYSDK_OFFSET(0x1B1D7E40)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDULONG_1_OFFSET UNITYSDK_OFFSET(0x1B1D8AF0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDULONG_2_OFFSET UNITYSDK_OFFSET(0x1B1D8B60)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDULONG_OFFSET UNITYSDK_OFFSET(0x1B1D7EC0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDUSHORT_1_OFFSET UNITYSDK_OFFSET(0x1B1D8720)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDUSHORT_2_OFFSET UNITYSDK_OFFSET(0x1B1D8790)
#define FLATBUFFERS_FLATBUFFERBUILDER_ADDUSHORT_OFFSET UNITYSDK_OFFSET(0x1B1D7DC0)
#define FLATBUFFERS_FLATBUFFERBUILDER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B1D76E0)
#define FLATBUFFERS_FLATBUFFERBUILDER_CREATESHAREDSTRING_OFFSET UNITYSDK_OFFSET(0x1B1D94C0)
#define FLATBUFFERS_FLATBUFFERBUILDER_CREATESTRING_OFFSET UNITYSDK_OFFSET(0x1B1D8E70)
#define FLATBUFFERS_FLATBUFFERBUILDER_CREATEUTF8STRING_OFFSET UNITYSDK_OFFSET(0x1B1D9320)
#define FLATBUFFERS_FLATBUFFERBUILDER_ENDTABLE_OFFSET UNITYSDK_OFFSET(0x1B1D96A0)
#define FLATBUFFERS_FLATBUFFERBUILDER_ENDVECTOR_OFFSET UNITYSDK_OFFSET(0x1B1D8150)
#define FLATBUFFERS_FLATBUFFERBUILDER_FINISHSIZEPREFIXED_1_OFFSET UNITYSDK_OFFSET(0x1B1D9F60)
#define FLATBUFFERS_FLATBUFFERBUILDER_FINISHSIZEPREFIXED_OFFSET UNITYSDK_OFFSET(0x1B1D9D00)
#define FLATBUFFERS_FLATBUFFERBUILDER_FINISH_1_OFFSET UNITYSDK_OFFSET(0x1B1D9CC0)
#define FLATBUFFERS_FLATBUFFERBUILDER_FINISH_2_OFFSET UNITYSDK_OFFSET(0x1B1D9D60)
#define FLATBUFFERS_FLATBUFFERBUILDER_FINISH_3_OFFSET UNITYSDK_OFFSET(0x1B1D9F50)
#define FLATBUFFERS_FLATBUFFERBUILDER_FINISH_OFFSET UNITYSDK_OFFSET(0x1B1D9C20)
#define FLATBUFFERS_FLATBUFFERBUILDER_GET_DATABUFFER_OFFSET UNITYSDK_OFFSET(0x1B1D9D10)
#define FLATBUFFERS_FLATBUFFERBUILDER_GET_FORCEDEFAULTS_OFFSET UNITYSDK_OFFSET(0x1B1D77F0)
#define FLATBUFFERS_FLATBUFFERBUILDER_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1B1D7810)
#define FLATBUFFERS_FLATBUFFERBUILDER_GROWBUFFER_OFFSET UNITYSDK_OFFSET(0x1B1D7870)
#define FLATBUFFERS_FLATBUFFERBUILDER_NESTED_OFFSET UNITYSDK_OFFSET(0x1B1D81B0)
#define FLATBUFFERS_FLATBUFFERBUILDER_NOTNESTED_OFFSET UNITYSDK_OFFSET(0x1B1D80E0)
#define FLATBUFFERS_FLATBUFFERBUILDER_PAD_OFFSET UNITYSDK_OFFSET(0x1B1D7840)
#define FLATBUFFERS_FLATBUFFERBUILDER_PREP_OFFSET UNITYSDK_OFFSET(0x1B1D78B0)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTBOOL_OFFSET UNITYSDK_OFFSET(0x1B1D7990)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTBYTE_OFFSET UNITYSDK_OFFSET(0x1B1D7AD0)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B1D7CC0)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTFLOAT_OFFSET UNITYSDK_OFFSET(0x1B1D7C90)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTINT_OFFSET UNITYSDK_OFFSET(0x1B1D7BD0)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTLONG_OFFSET UNITYSDK_OFFSET(0x1B1D7C30)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTSBYTE_OFFSET UNITYSDK_OFFSET(0x1B1D7A30)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTSHORT_OFFSET UNITYSDK_OFFSET(0x1B1D7B70)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTUINT_OFFSET UNITYSDK_OFFSET(0x1B1D7C00)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTULONG_OFFSET UNITYSDK_OFFSET(0x1B1D7C60)
#define FLATBUFFERS_FLATBUFFERBUILDER_PUTUSHORT_OFFSET UNITYSDK_OFFSET(0x1B1D7BA0)
#define FLATBUFFERS_FLATBUFFERBUILDER_REQUIRED_OFFSET UNITYSDK_OFFSET(0x1B1D9B40)
#define FLATBUFFERS_FLATBUFFERBUILDER_SET_FORCEDEFAULTS_OFFSET UNITYSDK_OFFSET(0x1B1D7800)
#define FLATBUFFERS_FLATBUFFERBUILDER_SIZEDBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1B1D9D20)
#define FLATBUFFERS_FLATBUFFERBUILDER_SLOT_OFFSET UNITYSDK_OFFSET(0x1B1D8360)
#define FLATBUFFERS_FLATBUFFERBUILDER_STARTTABLE_OFFSET UNITYSDK_OFFSET(0x1B1D8240)
#define FLATBUFFERS_FLATBUFFERBUILDER_STARTVECTOR_OFFSET UNITYSDK_OFFSET(0x1B1D8040)
#define FLATBUFFERS_FLATBUFFERBUILDER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1D7660)
#define FLATBUFFERS_FLATBUFFERBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D74C0)

namespace FlatBuffers
{
	inline static constexpr unsigned int FlatBufferBuilder_TypeDefinitionIndex = 8729;
	...
	public:
		...
		::System::Boolean _ForceDefaults_k__BackingField; // 0x3C
		::System::Int32 _objectStart; // 0x40
		::System::Int32 _vtableSize; // 0x44
		::System::Int32 _minAlign; // 0x48
		::System::Int32 _numVtables; // 0x4C
		::System::Int32 _vectorNumElems; // 0x50
