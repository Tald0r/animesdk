...
#define FLATBUFFERS_TABLE_COMPARESTRINGS_1_OFFSET UNITYSDK_OFFSET(0x1B1DAC20)
#define FLATBUFFERS_TABLE_COMPARESTRINGS_OFFSET UNITYSDK_OFFSET(0x1B1DAA60)
#define FLATBUFFERS_TABLE_GET_BB_OFFSET UNITYSDK_OFFSET(0x272280)
#define FLATBUFFERS_TABLE_GET_BB_POS_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define FLATBUFFERS_TABLE_GET_BYTEBUFFER_OFFSET UNITYSDK_OFFSET(0x272280)
#define FLATBUFFERS_TABLE_SET_BB_OFFSET UNITYSDK_OFFSET(0x302310)
#define FLATBUFFERS_TABLE_SET_BB_POS_OFFSET UNITYSDK_OFFSET(0x302300)
#define FLATBUFFERS_TABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x98EFF0)
#define FLATBUFFERS_TABLE___HAS_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B1DA760)
#define FLATBUFFERS_TABLE___INDIRECT_1_OFFSET UNITYSDK_OFFSET(0x1B1DA690)
#define FLATBUFFERS_TABLE___INDIRECT_OFFSET UNITYSDK_OFFSET(0x98F030)
#define FLATBUFFERS_TABLE___OFFSET_1_OFFSET UNITYSDK_OFFSET(0x1B1DA640)
#define FLATBUFFERS_TABLE___OFFSET_OFFSET UNITYSDK_OFFSET(0x98F020)
#define FLATBUFFERS_TABLE___STRING_OFFSET UNITYSDK_OFFSET(0x98F060)
#define FLATBUFFERS_TABLE___VECTOR_LEN_OFFSET UNITYSDK_OFFSET(0x98F0C0)
#define FLATBUFFERS_TABLE___VECTOR_OFFSET UNITYSDK_OFFSET(0x98F110)

namespace FlatBuffers
{
	inline static constexpr unsigned int Table_TypeDefinitionIndex = 8736;
