...
#define FLATBUFFERS_TABLE_COMPARESTRINGS_1_OFFSET UNITYSDK_OFFSET(0x1ABD2670)
#define FLATBUFFERS_TABLE_COMPARESTRINGS_OFFSET UNITYSDK_OFFSET(0x1ABD24B0)
#define FLATBUFFERS_TABLE_GET_BB_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define FLATBUFFERS_TABLE_GET_BB_POS_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define FLATBUFFERS_TABLE_GET_BYTEBUFFER_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define FLATBUFFERS_TABLE_SET_BB_OFFSET UNITYSDK_OFFSET(0x2CB170)
#define FLATBUFFERS_TABLE_SET_BB_POS_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define FLATBUFFERS_TABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x95C4B0)
#define FLATBUFFERS_TABLE___HAS_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1ABD21B0)
#define FLATBUFFERS_TABLE___INDIRECT_1_OFFSET UNITYSDK_OFFSET(0x1ABD20E0)
#define FLATBUFFERS_TABLE___INDIRECT_OFFSET UNITYSDK_OFFSET(0x95C4F0)
#define FLATBUFFERS_TABLE___OFFSET_1_OFFSET UNITYSDK_OFFSET(0x1ABD2090)
#define FLATBUFFERS_TABLE___OFFSET_OFFSET UNITYSDK_OFFSET(0x95C4E0)
#define FLATBUFFERS_TABLE___STRING_OFFSET UNITYSDK_OFFSET(0x95C520)
#define FLATBUFFERS_TABLE___VECTOR_LEN_OFFSET UNITYSDK_OFFSET(0x95C580)
#define FLATBUFFERS_TABLE___VECTOR_OFFSET UNITYSDK_OFFSET(0x95C5D0)

namespace FlatBuffers
{
	inline static constexpr unsigned int Table_TypeDefinitionIndex = 8725;
