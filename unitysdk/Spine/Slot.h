...
#define SPINE_SLOT_CLAMPCOLOR_OFFSET UNITYSDK_OFFSET(0x1B5EC550)
#define SPINE_SLOT_CLAMPSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x1B5ED960)
#define SPINE_SLOT_GET_ATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1B5EDA00)
#define SPINE_SLOT_GET_A_OFFSET UNITYSDK_OFFSET(0x1B5ED8A0)
#define SPINE_SLOT_GET_B2_OFFSET UNITYSDK_OFFSET(0x1B5ED900)
#define SPINE_SLOT_GET_BONE_OFFSET UNITYSDK_OFFSET(0x1B5ED810)
#define SPINE_SLOT_GET_B_OFFSET UNITYSDK_OFFSET(0x1B5ED880)
#define SPINE_SLOT_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1B5ED800)
#define SPINE_SLOT_GET_DEFORM_OFFSET UNITYSDK_OFFSET(0x1B5EDB10)
#define SPINE_SLOT_GET_G2_OFFSET UNITYSDK_OFFSET(0x1B5ED8E0)
#define SPINE_SLOT_GET_G_OFFSET UNITYSDK_OFFSET(0x1B5ED860)
#define SPINE_SLOT_GET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x1B5ED920)
#define SPINE_SLOT_GET_R2_OFFSET UNITYSDK_OFFSET(0x1B5ED8C0)
#define SPINE_SLOT_GET_R_OFFSET UNITYSDK_OFFSET(0x1B5ED840)
#define SPINE_SLOT_GET_SEQUENCEINDEX_OFFSET UNITYSDK_OFFSET(0x1B5EDAF0)
#define SPINE_SLOT_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x1B5ED820)
#define SPINE_SLOT_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x1B5ED4C0)
#define SPINE_SLOT_SET_ATTACHMENT_OFFSET UNITYSDK_OFFSET(0x1B5EDA10)
#define SPINE_SLOT_SET_A_OFFSET UNITYSDK_OFFSET(0x1B5ED8B0)
#define SPINE_SLOT_SET_B2_OFFSET UNITYSDK_OFFSET(0x1B5ED910)
#define SPINE_SLOT_SET_B_OFFSET UNITYSDK_OFFSET(0x1B5ED890)
#define SPINE_SLOT_SET_DEFORM_OFFSET UNITYSDK_OFFSET(0x1B5EDB20)
#define SPINE_SLOT_SET_G2_OFFSET UNITYSDK_OFFSET(0x1B5ED8F0)
#define SPINE_SLOT_SET_G_OFFSET UNITYSDK_OFFSET(0x1B5ED870)
#define SPINE_SLOT_SET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x1B5ED940)
#define SPINE_SLOT_SET_R2_OFFSET UNITYSDK_OFFSET(0x1B5ED8D0)
#define SPINE_SLOT_SET_R_OFFSET UNITYSDK_OFFSET(0x1B5ED850)
#define SPINE_SLOT_SET_SEQUENCEINDEX_OFFSET UNITYSDK_OFFSET(0x1B5EDB00)
#define SPINE_SLOT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B5EDBA0)
#define SPINE_SLOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B5ED660)
#define SPINE_SLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5ED370)

namespace Spine
{
	inline static constexpr unsigned int Slot_TypeDefinitionIndex = 30825;
	...
	public:
		...
		::System::Int32 sequenceIndex; // 0x40
