...
#define SPINE_MATHUTILS_ATAN2_OFFSET UNITYSDK_OFFSET(0x1A963ED0)
#define SPINE_MATHUTILS_CLAMP_OFFSET UNITYSDK_OFFSET(0x1A963EF0)
#define SPINE_MATHUTILS_COSDEG_OFFSET UNITYSDK_OFFSET(0x1A963EB0)
#define SPINE_MATHUTILS_COS_OFFSET UNITYSDK_OFFSET(0x1A963E70)
#define SPINE_MATHUTILS_RANDOMTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x1A9640C0)
#define SPINE_MATHUTILS_RANDOMTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1A963F10)
#define SPINE_MATHUTILS_SINDEG_OFFSET UNITYSDK_OFFSET(0x1A963E90)
#define SPINE_MATHUTILS_SIN_OFFSET UNITYSDK_OFFSET(0x1A963E50)
#define SPINE_MATHUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A964200)

namespace Spine
{
	inline static constexpr unsigned int MathUtils_TypeDefinitionIndex = 30801;
	...
	public:
		...
		{
			return (::System::Random**)Il2CppClass::FromTypeDefinitionIndex(MathUtils_TypeDefinitionIndex)->GetStaticField(0x24C00);
		}
