...
#define SPINE_ANIMATIONSTATE_TRACKENTRYEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B69EBF0)
#define SPINE_ANIMATIONSTATE_TRACKENTRYEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B69EC30)
#define SPINE_ANIMATIONSTATE_TRACKENTRYEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B69E670)
#define SPINE_ANIMATIONSTATE_TRACKENTRYEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B69E650)

namespace Spine
{
	inline static constexpr unsigned int AnimationState_TrackEntryEventDelegate_TypeDefinitionIndex = 30755;
