...
#define SPINE_BONEDATA_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1B650B90)
#define SPINE_BONEDATA_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B650BC0)
#define SPINE_BONEDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B650BA0)
#define SPINE_BONEDATA_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1B650BB0)
#define SPINE_BONEDATA_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1B650C20)
#define SPINE_BONEDATA_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1B650C40)
#define SPINE_BONEDATA_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1B650C60)
#define SPINE_BONEDATA_GET_SHEARX_OFFSET UNITYSDK_OFFSET(0x1B650C80)
#define SPINE_BONEDATA_GET_SHEARY_OFFSET UNITYSDK_OFFSET(0x1B650CA0)
#define SPINE_BONEDATA_GET_SKINREQUIRED_OFFSET UNITYSDK_OFFSET(0x1B650CE0)
#define SPINE_BONEDATA_GET_TRANSFORMMODE_OFFSET UNITYSDK_OFFSET(0x1B650CC0)
#define SPINE_BONEDATA_GET_X_OFFSET UNITYSDK_OFFSET(0x1B650BE0)
#define SPINE_BONEDATA_GET_Y_OFFSET UNITYSDK_OFFSET(0x1B650C00)
#define SPINE_BONEDATA_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B650BD0)
#define SPINE_BONEDATA_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1B650C30)
#define SPINE_BONEDATA_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1B650C50)
#define SPINE_BONEDATA_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1B650C70)
#define SPINE_BONEDATA_SET_SHEARX_OFFSET UNITYSDK_OFFSET(0x1B650C90)
#define SPINE_BONEDATA_SET_SHEARY_OFFSET UNITYSDK_OFFSET(0x1B650CB0)
#define SPINE_BONEDATA_SET_SKINREQUIRED_OFFSET UNITYSDK_OFFSET(0x1B650CF0)
#define SPINE_BONEDATA_SET_TRANSFORMMODE_OFFSET UNITYSDK_OFFSET(0x1B650CD0)
#define SPINE_BONEDATA_SET_X_OFFSET UNITYSDK_OFFSET(0x1B650BF0)
#define SPINE_BONEDATA_SET_Y_OFFSET UNITYSDK_OFFSET(0x1B650C10)
#define SPINE_BONEDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B650DE0)
#define SPINE_BONEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B650D00)

namespace Spine
{
	inline static constexpr unsigned int BoneData_TypeDefinitionIndex = 30790;
