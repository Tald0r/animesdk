...
#define SPINE_POWOUT_APPLY_OFFSET UNITYSDK_OFFSET(0x1B091F20)
#define SPINE_POWOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B091EB0)

namespace Spine
{
	inline static constexpr unsigned int PowOut_TypeDefinitionIndex = 29851;
