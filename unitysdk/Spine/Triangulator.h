...
#define SPINE_TRIANGULATOR_DECOMPOSE_OFFSET UNITYSDK_OFFSET(0x1AA4CE20)
#define SPINE_TRIANGULATOR_ISCONCAVE_OFFSET UNITYSDK_OFFSET(0x1AA4CC30)
#define SPINE_TRIANGULATOR_POSITIVEAREA_OFFSET UNITYSDK_OFFSET(0x1AA4CDE0)
#define SPINE_TRIANGULATOR_TRIANGULATE_OFFSET UNITYSDK_OFFSET(0x1AA4C180)
#define SPINE_TRIANGULATOR_WINDING_OFFSET UNITYSDK_OFFSET(0x1AA4E100)
#define SPINE_TRIANGULATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4E140)

namespace Spine
{
	inline static constexpr unsigned int Triangulator_TypeDefinitionIndex = 29877;

	class Triangulator : public ::System::Object
	{
	public:
		::Spine::ExposedList_1<::Spine::ExposedList_1<::System::Single>*>* convexPolygons; // 0x10
		...
		::Spine::ExposedList_1<::System::Int32>* indicesArray; // 0x30
