...
#define SPINE_SLOTDATA_GET_ATTACHMENTNAME_OFFSET UNITYSDK_OFFSET(0x1AA4B5A0)
#define SPINE_SLOTDATA_GET_A_OFFSET UNITYSDK_OFFSET(0x1AA4B500)
#define SPINE_SLOTDATA_GET_B2_OFFSET UNITYSDK_OFFSET(0x1AA4B560)
#define SPINE_SLOTDATA_GET_BLENDMODE_OFFSET UNITYSDK_OFFSET(0x1AA4B5C0)
#define SPINE_SLOTDATA_GET_BONEDATA_OFFSET UNITYSDK_OFFSET(0x1AA4B490)
#define SPINE_SLOTDATA_GET_B_OFFSET UNITYSDK_OFFSET(0x1AA4B4E0)
#define SPINE_SLOTDATA_GET_G2_OFFSET UNITYSDK_OFFSET(0x1AA4B540)
#define SPINE_SLOTDATA_GET_G_OFFSET UNITYSDK_OFFSET(0x1AA4B4C0)
#define SPINE_SLOTDATA_GET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x1AA4B580)
#define SPINE_SLOTDATA_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1AA4B470)
#define SPINE_SLOTDATA_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AA4B480)
#define SPINE_SLOTDATA_GET_R2_OFFSET UNITYSDK_OFFSET(0x1AA4B520)
#define SPINE_SLOTDATA_GET_R_OFFSET UNITYSDK_OFFSET(0x1AA4B4A0)
#define SPINE_SLOTDATA_SET_ATTACHMENTNAME_OFFSET UNITYSDK_OFFSET(0x1AA4B5B0)
#define SPINE_SLOTDATA_SET_A_OFFSET UNITYSDK_OFFSET(0x1AA4B510)
#define SPINE_SLOTDATA_SET_B2_OFFSET UNITYSDK_OFFSET(0x1AA4B570)
#define SPINE_SLOTDATA_SET_BLENDMODE_OFFSET UNITYSDK_OFFSET(0x1AA4B5D0)
#define SPINE_SLOTDATA_SET_B_OFFSET UNITYSDK_OFFSET(0x1AA4B4F0)
#define SPINE_SLOTDATA_SET_G2_OFFSET UNITYSDK_OFFSET(0x1AA4B550)
#define SPINE_SLOTDATA_SET_G_OFFSET UNITYSDK_OFFSET(0x1AA4B4D0)
#define SPINE_SLOTDATA_SET_HASSECONDCOLOR_OFFSET UNITYSDK_OFFSET(0x1AA4B590)
#define SPINE_SLOTDATA_SET_R2_OFFSET UNITYSDK_OFFSET(0x1AA4B530)
#define SPINE_SLOTDATA_SET_R_OFFSET UNITYSDK_OFFSET(0x1AA4B4B0)
#define SPINE_SLOTDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AA4B6F0)
#define SPINE_SLOTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4B5E0)

namespace Spine
{
	inline static constexpr unsigned int SlotData_TypeDefinitionIndex = 29873;
