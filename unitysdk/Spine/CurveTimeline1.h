...
#define SPINE_CURVETIMELINE1_GETCURVEVALUE_OFFSET UNITYSDK_OFFSET(0x1AF34990)
#define SPINE_CURVETIMELINE1_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x1AF34920)
#define SPINE_CURVETIMELINE1_SETFRAME_OFFSET UNITYSDK_OFFSET(0x1AF34930)
#define SPINE_CURVETIMELINE1__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF34830)

namespace Spine
{
	inline static constexpr unsigned int CurveTimeline1_TypeDefinitionIndex = 29773;
