...
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1829C140)
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1829C1B0)
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1829BA80)
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1829C120)

namespace Spine::Unity
{
	inline static constexpr unsigned int OnDemandTextureLoader_TextureLoadDelegate_TypeDefinitionIndex = 37253;
