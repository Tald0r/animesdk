...
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17BB3FE0)
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17BB4050)
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17BB3940)
#define SPINE_UNITY_ONDEMANDTEXTURELOADER_TEXTURELOADDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x17BB3FD0)

namespace Spine::Unity
{
	inline static constexpr unsigned int OnDemandTextureLoader_TextureLoadDelegate_TypeDefinitionIndex = 36233;
