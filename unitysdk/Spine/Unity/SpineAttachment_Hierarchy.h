...
#define SPINE_UNITY_SPINEATTACHMENT_HIERARCHY__CTOR_OFFSET UNITYSDK_OFFSET(0x7D5890)

namespace Spine::Unity
{
	inline static constexpr unsigned int SpineAttachment_Hierarchy_TypeDefinitionIndex = 37353;
