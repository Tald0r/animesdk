...
#define SPINE_UNITY_SKELETONSUBMESHGRAPHIC_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x182BE3C0)
#define SPINE_UNITY_SKELETONSUBMESHGRAPHIC_ONENABLE_OFFSET UNITYSDK_OFFSET(0x182BE400)
#define SPINE_UNITY_SKELETONSUBMESHGRAPHIC_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x182BE3A0)
#define SPINE_UNITY_SKELETONSUBMESHGRAPHIC_SETMATERIALDIRTY_OFFSET UNITYSDK_OFFSET(0x182BE380)
#define SPINE_UNITY_SKELETONSUBMESHGRAPHIC_SETVERTICESDIRTY_OFFSET UNITYSDK_OFFSET(0x182BE390)
#define SPINE_UNITY_SKELETONSUBMESHGRAPHIC__CTOR_OFFSET UNITYSDK_OFFSET(0x182BE440)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonSubmeshGraphic_TypeDefinitionIndex = 37272;
