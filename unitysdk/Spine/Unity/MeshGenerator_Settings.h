...
#define SPINE_UNITY_MESHGENERATOR_SETTINGS_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x17BA9B70)

namespace Spine::Unity
{
	inline static constexpr unsigned int MeshGenerator_Settings_TypeDefinitionIndex = 36315;
