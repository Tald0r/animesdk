...
#define SPINE_UNITY_ANIMATIONTOOLS_TIMELINEEXTENSIONS_EVALUATEROTATEMIX_OFFSET UNITYSDK_OFFSET(0x18280E50)
#define SPINE_UNITY_ANIMATIONTOOLS_TIMELINEEXTENSIONS_EVALUATETRANSLATEXYMIX_OFFSET UNITYSDK_OFFSET(0x18280D80)
#define SPINE_UNITY_ANIMATIONTOOLS_TIMELINEEXTENSIONS_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x18280B30)
#define SPINE_UNITY_ANIMATIONTOOLS_TIMELINEEXTENSIONS_EVALUATE_2_OFFSET UNITYSDK_OFFSET(0x18280CD0)
#define SPINE_UNITY_ANIMATIONTOOLS_TIMELINEEXTENSIONS_EVALUATE_OFFSET UNITYSDK_OFFSET(0x18280A30)
#define SPINE_UNITY_ANIMATIONTOOLS_TIMELINEEXTENSIONS_FINDTRANSFORMCONSTRAINTTIMELINE_OFFSET UNITYSDK_OFFSET(0x182810F0)
#define SPINE_UNITY_ANIMATIONTOOLS_TIMELINEEXTENSIONS_FINDTRANSLATETIMELINEFORBONE_OFFSET UNITYSDK_OFFSET(0x18280F10)

namespace Spine::Unity::AnimationTools
{
	inline static constexpr unsigned int TimelineExtensions_TypeDefinitionIndex = 37364;
