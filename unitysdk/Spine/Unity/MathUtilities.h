...
#define SPINE_UNITY_MATHUTILITIES_INVERSELERP_1_OFFSET UNITYSDK_OFFSET(0x17BA96F0)
#define SPINE_UNITY_MATHUTILITIES_INVERSELERP_2_OFFSET UNITYSDK_OFFSET(0x17BA9740)
#define SPINE_UNITY_MATHUTILITIES_INVERSELERP_3_OFFSET UNITYSDK_OFFSET(0x17BA9780)
#define SPINE_UNITY_MATHUTILITIES_INVERSELERP_OFFSET UNITYSDK_OFFSET(0x17BA96E0)

namespace Spine::Unity
{
	inline static constexpr unsigned int MathUtilities_TypeDefinitionIndex = 36335;
