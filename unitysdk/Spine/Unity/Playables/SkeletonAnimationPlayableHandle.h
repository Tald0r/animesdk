...
#define SPINE_UNITY_PLAYABLES_SKELETONANIMATIONPLAYABLEHANDLE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B5350A0)
#define SPINE_UNITY_PLAYABLES_SKELETONANIMATIONPLAYABLEHANDLE_GET_SKELETONDATA_OFFSET UNITYSDK_OFFSET(0x1B535050)
#define SPINE_UNITY_PLAYABLES_SKELETONANIMATIONPLAYABLEHANDLE_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x1B535010)
#define SPINE_UNITY_PLAYABLES_SKELETONANIMATIONPLAYABLEHANDLE_INITIALIZEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B5351C0)
#define SPINE_UNITY_PLAYABLES_SKELETONANIMATIONPLAYABLEHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5352E0)

namespace Spine::Unity::Playables
{
	inline static constexpr unsigned int SkeletonAnimationPlayableHandle_TypeDefinitionIndex = 84158;
