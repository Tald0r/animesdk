...
#define SPINE_UNITY_NAPSKELETONGRAPHIC_AWAKE_OFFSET UNITYSDK_OFFSET(0x17BB26A0)
#define SPINE_UNITY_NAPSKELETONGRAPHIC_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x17BB2860)
#define SPINE_UNITY_NAPSKELETONGRAPHIC_UPDATE_OFFSET UNITYSDK_OFFSET(0x17BB27A0)
#define SPINE_UNITY_NAPSKELETONGRAPHIC__CTOR_OFFSET UNITYSDK_OFFSET(0x17BB2990)

namespace Spine::Unity
{
	inline static constexpr unsigned int NapSkeletonGraphic_TypeDefinitionIndex = 36254;
