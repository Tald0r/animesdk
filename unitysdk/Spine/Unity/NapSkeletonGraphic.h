...
#define SPINE_UNITY_NAPSKELETONGRAPHIC_AWAKE_OFFSET UNITYSDK_OFFSET(0x1829A7F0)
#define SPINE_UNITY_NAPSKELETONGRAPHIC_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1829A9B0)
#define SPINE_UNITY_NAPSKELETONGRAPHIC_UPDATE_OFFSET UNITYSDK_OFFSET(0x1829A8F0)
#define SPINE_UNITY_NAPSKELETONGRAPHIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1829AAE0)

namespace Spine::Unity
{
	inline static constexpr unsigned int NapSkeletonGraphic_TypeDefinitionIndex = 37274;
