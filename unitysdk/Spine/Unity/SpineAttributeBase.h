...
#define SPINE_UNITY_SPINEATTRIBUTEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x17BDB2E0)

namespace Spine::Unity
{
	inline static constexpr unsigned int SpineAttributeBase_TypeDefinitionIndex = 36323;
