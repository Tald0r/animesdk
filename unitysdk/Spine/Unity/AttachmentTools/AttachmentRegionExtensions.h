...
#define SPINE_UNITY_ATTACHMENTTOOLS_ATTACHMENTREGIONEXTENSIONS_SETPOSITIONOFFSET_1_OFFSET UNITYSDK_OFFSET(0x182880C0)
#define SPINE_UNITY_ATTACHMENTTOOLS_ATTACHMENTREGIONEXTENSIONS_SETPOSITIONOFFSET_OFFSET UNITYSDK_OFFSET(0x182880A0)
#define SPINE_UNITY_ATTACHMENTTOOLS_ATTACHMENTREGIONEXTENSIONS_SETROTATION_OFFSET UNITYSDK_OFFSET(0x182880E0)
#define SPINE_UNITY_ATTACHMENTTOOLS_ATTACHMENTREGIONEXTENSIONS_SETSCALE_1_OFFSET UNITYSDK_OFFSET(0x18288080)
#define SPINE_UNITY_ATTACHMENTTOOLS_ATTACHMENTREGIONEXTENSIONS_SETSCALE_OFFSET UNITYSDK_OFFSET(0x18288050)
#define SPINE_UNITY_ATTACHMENTTOOLS_ATTACHMENTREGIONEXTENSIONS_TOREGIONATTACHMENTPMACLONE_1_OFFSET UNITYSDK_OFFSET(0x18287FB0)
#define SPINE_UNITY_ATTACHMENTTOOLS_ATTACHMENTREGIONEXTENSIONS_TOREGIONATTACHMENTPMACLONE_OFFSET UNITYSDK_OFFSET(0x18287D60)
#define SPINE_UNITY_ATTACHMENTTOOLS_ATTACHMENTREGIONEXTENSIONS_TOREGIONATTACHMENT_1_OFFSET UNITYSDK_OFFSET(0x182879A0)
#define SPINE_UNITY_ATTACHMENTTOOLS_ATTACHMENTREGIONEXTENSIONS_TOREGIONATTACHMENT_2_OFFSET UNITYSDK_OFFSET(0x18287BC0)
#define SPINE_UNITY_ATTACHMENTTOOLS_ATTACHMENTREGIONEXTENSIONS_TOREGIONATTACHMENT_OFFSET UNITYSDK_OFFSET(0x18287920)

namespace Spine::Unity::AttachmentTools
{
	inline static constexpr unsigned int AttachmentRegionExtensions_TypeDefinitionIndex = 37368;
