...
#define SPINE_UNITY_ATTACHMENTTOOLS_ATTACHMENTCLONEEXTENSIONS_GETREMAPPEDCLONE_1_OFFSET UNITYSDK_OFFSET(0x17B9F530)
#define SPINE_UNITY_ATTACHMENTTOOLS_ATTACHMENTCLONEEXTENSIONS_GETREMAPPEDCLONE_OFFSET UNITYSDK_OFFSET(0x17B9F200)

namespace Spine::Unity::AttachmentTools
{
	inline static constexpr unsigned int AttachmentCloneExtensions_TypeDefinitionIndex = 36347;
