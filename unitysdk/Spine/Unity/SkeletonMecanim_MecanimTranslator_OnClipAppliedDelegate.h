...
#define SPINE_UNITY_SKELETONMECANIM_MECANIMTRANSLATOR_ONCLIPAPPLIEDDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x182B05A0)
#define SPINE_UNITY_SKELETONMECANIM_MECANIMTRANSLATOR_ONCLIPAPPLIEDDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x182B0670)
#define SPINE_UNITY_SKELETONMECANIM_MECANIMTRANSLATOR_ONCLIPAPPLIEDDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x182AF0E0)
#define SPINE_UNITY_SKELETONMECANIM_MECANIMTRANSLATOR_ONCLIPAPPLIEDDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x182B0580)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonMecanim_MecanimTranslator_OnClipAppliedDelegate_TypeDefinitionIndex = 37290;
