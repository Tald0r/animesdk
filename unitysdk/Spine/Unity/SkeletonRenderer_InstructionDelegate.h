...
#define SPINE_UNITY_SKELETONRENDERER_INSTRUCTIONDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x182B82B0)
#define SPINE_UNITY_SKELETONRENDERER_INSTRUCTIONDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x182B82E0)
#define SPINE_UNITY_SKELETONRENDERER_INSTRUCTIONDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x182B6A60)
#define SPINE_UNITY_SKELETONRENDERER_INSTRUCTIONDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x182B41C0)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonRenderer_InstructionDelegate_TypeDefinitionIndex = 37300;
