...
#define SPINE_UNITY_SKELETONGRAPHIC_MESHASSIGNMENTDELEGATEMULTIPLE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17BC1810)
#define SPINE_UNITY_SKELETONGRAPHIC_MESHASSIGNMENTDELEGATEMULTIPLE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17BC18A0)
#define SPINE_UNITY_SKELETONGRAPHIC_MESHASSIGNMENTDELEGATEMULTIPLE_INVOKE_OFFSET UNITYSDK_OFFSET(0x17BC1390)
#define SPINE_UNITY_SKELETONGRAPHIC_MESHASSIGNMENTDELEGATEMULTIPLE__CTOR_OFFSET UNITYSDK_OFFSET(0x17BC1800)

namespace Spine::Unity
{
	inline static constexpr unsigned int SkeletonGraphic_MeshAssignmentDelegateMultiple_TypeDefinitionIndex = 36265;
