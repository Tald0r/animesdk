...
#define SPINE_UNITY_SPINEIKCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x182C4C40)

namespace Spine::Unity
{
	inline static constexpr unsigned int SpineIkConstraint_TypeDefinitionIndex = 37348;
