...
#define SPINE_UNITY_SPINETRANSFORMCONSTRAINT__CTOR_OFFSET UNITYSDK_OFFSET(0x17BDD940)

namespace Spine::Unity
{
	inline static constexpr unsigned int SpineTransformConstraint_TypeDefinitionIndex = 36329;
