...
#define SPINE_ATLASREGION_CLONE_OFFSET UNITYSDK_OFFSET(0x1A9DFB70)
#define SPINE_ATLASREGION_GET_ORIGINALHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A9DFB60)
#define SPINE_ATLASREGION_GET_ORIGINALWIDTH_OFFSET UNITYSDK_OFFSET(0x1A9DFB50)
#define SPINE_ATLASREGION_GET_PACKEDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A9DFB30)
#define SPINE_ATLASREGION_GET_PACKEDWIDTH_OFFSET UNITYSDK_OFFSET(0x1A9DFB10)
#define SPINE_ATLASREGION_SET_PACKEDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A9DFB40)
#define SPINE_ATLASREGION_SET_PACKEDWIDTH_OFFSET UNITYSDK_OFFSET(0x1A9DFB20)
#define SPINE_ATLASREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9DFC70)

namespace Spine
{
	inline static constexpr unsigned int AtlasRegion_TypeDefinitionIndex = 29819;
	...
	public:
		...
		::System::Int32 originalWidth; // 0x54
		::System::Int32 degrees; // 0x58
		::System::Int32 index; // 0x5C
		::System::Int32 x; // 0x60
		::System::Single offsetY; // 0x64
		::System::Int32 originalHeight; // 0x68
