...
#define SPINE_ATLAS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AE4B0D0)
#define SPINE_ATLAS_FINDREGION_OFFSET UNITYSDK_OFFSET(0x1AE4AF80)
#define SPINE_ATLAS_FLIPV_OFFSET UNITYSDK_OFFSET(0x1AE4AEE0)
#define SPINE_ATLAS_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AE49710)
#define SPINE_ATLAS_GET_PAGES_OFFSET UNITYSDK_OFFSET(0x1AE49860)
#define SPINE_ATLAS_GET_REGIONS_OFFSET UNITYSDK_OFFSET(0x1AE49850)
#define SPINE_ATLAS_READENTRY_OFFSET UNITYSDK_OFFSET(0x1AE4AC40)
#define SPINE_ATLAS_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1AE497B0)
#define SPINE_ATLAS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE499F0)
#define SPINE_ATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE49870)

namespace Spine
{
	inline static constexpr unsigned int Atlas_TypeDefinitionIndex = 29813;
