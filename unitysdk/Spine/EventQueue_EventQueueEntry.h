...
#define SPINE_EVENTQUEUE_EVENTQUEUEENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x360260)

namespace Spine
{
	inline static constexpr unsigned int EventQueue_EventQueueEntry_TypeDefinitionIndex = 29805;
