...
#define SPINE_BONE_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1B5D2050)
#define SPINE_BONE_GET_APPLIEDROTATION_OFFSET UNITYSDK_OFFSET(0x1B5D2140)
#define SPINE_BONE_GET_ASCALEX_OFFSET UNITYSDK_OFFSET(0x1B5D21A0)
#define SPINE_BONE_GET_ASCALEY_OFFSET UNITYSDK_OFFSET(0x1B5D21C0)
#define SPINE_BONE_GET_ASHEARX_OFFSET UNITYSDK_OFFSET(0x1B5D21E0)
#define SPINE_BONE_GET_ASHEARY_OFFSET UNITYSDK_OFFSET(0x1B5D2200)
#define SPINE_BONE_GET_AX_OFFSET UNITYSDK_OFFSET(0x1B5D2160)
#define SPINE_BONE_GET_AY_OFFSET UNITYSDK_OFFSET(0x1B5D2180)
#define SPINE_BONE_GET_A_OFFSET UNITYSDK_OFFSET(0x1B5D2220)
#define SPINE_BONE_GET_B_OFFSET UNITYSDK_OFFSET(0x1B5D2240)
#define SPINE_BONE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x1B5D2040)
#define SPINE_BONE_GET_C_OFFSET UNITYSDK_OFFSET(0x1B5D2260)
#define SPINE_BONE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1B5D2010)
#define SPINE_BONE_GET_D_OFFSET UNITYSDK_OFFSET(0x1B5D2280)
#define SPINE_BONE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1B5D2030)
#define SPINE_BONE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1B5D20A0)
#define SPINE_BONE_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1B5D20C0)
#define SPINE_BONE_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1B5D20E0)
#define SPINE_BONE_GET_SHEARX_OFFSET UNITYSDK_OFFSET(0x1B5D2100)
#define SPINE_BONE_GET_SHEARY_OFFSET UNITYSDK_OFFSET(0x1B5D2120)
#define SPINE_BONE_GET_SKELETON_OFFSET UNITYSDK_OFFSET(0x1B5D2020)
#define SPINE_BONE_GET_WORLDROTATIONX_OFFSET UNITYSDK_OFFSET(0x1B5D22E0)
#define SPINE_BONE_GET_WORLDROTATIONY_OFFSET UNITYSDK_OFFSET(0x1B5D2360)
#define SPINE_BONE_GET_WORLDSCALEX_OFFSET UNITYSDK_OFFSET(0x1B5D23E0)
#define SPINE_BONE_GET_WORLDSCALEY_OFFSET UNITYSDK_OFFSET(0x1B5D2410)
#define SPINE_BONE_GET_WORLDTOLOCALROTATIONX_OFFSET UNITYSDK_OFFSET(0x1B5D3840)
#define SPINE_BONE_GET_WORLDTOLOCALROTATIONY_OFFSET UNITYSDK_OFFSET(0x1B5D3960)
#define SPINE_BONE_GET_WORLDX_OFFSET UNITYSDK_OFFSET(0x1B5D22A0)
#define SPINE_BONE_GET_WORLDY_OFFSET UNITYSDK_OFFSET(0x1B5D22C0)
#define SPINE_BONE_GET_X_OFFSET UNITYSDK_OFFSET(0x1B5D2060)
#define SPINE_BONE_GET_Y_OFFSET UNITYSDK_OFFSET(0x1B5D2080)
#define SPINE_BONE_LOCALTOWORLDROTATION_OFFSET UNITYSDK_OFFSET(0x1B5D3B60)
#define SPINE_BONE_LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0x1B5D3800)
#define SPINE_BONE_ROTATEWORLD_OFFSET UNITYSDK_OFFSET(0x1B5D3C50)
#define SPINE_BONE_SETTOSETUPPOSE_OFFSET UNITYSDK_OFFSET(0x1B5D2570)
#define SPINE_BONE_SET_APPLIEDROTATION_OFFSET UNITYSDK_OFFSET(0x1B5D2150)
#define SPINE_BONE_SET_ASCALEX_OFFSET UNITYSDK_OFFSET(0x1B5D21B0)
#define SPINE_BONE_SET_ASCALEY_OFFSET UNITYSDK_OFFSET(0x1B5D21D0)
#define SPINE_BONE_SET_ASHEARX_OFFSET UNITYSDK_OFFSET(0x1B5D21F0)
#define SPINE_BONE_SET_ASHEARY_OFFSET UNITYSDK_OFFSET(0x1B5D2210)
#define SPINE_BONE_SET_AX_OFFSET UNITYSDK_OFFSET(0x1B5D2170)
#define SPINE_BONE_SET_AY_OFFSET UNITYSDK_OFFSET(0x1B5D2190)
#define SPINE_BONE_SET_A_OFFSET UNITYSDK_OFFSET(0x1B5D2230)
#define SPINE_BONE_SET_B_OFFSET UNITYSDK_OFFSET(0x1B5D2250)
#define SPINE_BONE_SET_C_OFFSET UNITYSDK_OFFSET(0x1B5D2270)
#define SPINE_BONE_SET_D_OFFSET UNITYSDK_OFFSET(0x1B5D2290)
#define SPINE_BONE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1B5D20B0)
#define SPINE_BONE_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1B5D20D0)
#define SPINE_BONE_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1B5D20F0)
#define SPINE_BONE_SET_SHEARX_OFFSET UNITYSDK_OFFSET(0x1B5D2110)
#define SPINE_BONE_SET_SHEARY_OFFSET UNITYSDK_OFFSET(0x1B5D2130)
#define SPINE_BONE_SET_WORLDX_OFFSET UNITYSDK_OFFSET(0x1B5D22B0)
#define SPINE_BONE_SET_WORLDY_OFFSET UNITYSDK_OFFSET(0x1B5D22D0)
#define SPINE_BONE_SET_X_OFFSET UNITYSDK_OFFSET(0x1B5D2070)
#define SPINE_BONE_SET_Y_OFFSET UNITYSDK_OFFSET(0x1B5D2090)
#define SPINE_BONE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B5D3D90)
#define SPINE_BONE_UPDATEAPPLIEDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B5D3370)
#define SPINE_BONE_UPDATEWORLDTRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x1B5D2750)
#define SPINE_BONE_UPDATEWORLDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B5D3310)
#define SPINE_BONE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B5D26F0)
#define SPINE_BONE_WORLDTOLOCALROTATION_OFFSET UNITYSDK_OFFSET(0x1B5D3A70)
#define SPINE_BONE_WORLDTOLOCAL_OFFSET UNITYSDK_OFFSET(0x1B5D3790)
#define SPINE_BONE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B5D25D0)
#define SPINE_BONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D2440)

namespace Spine
{
	inline static constexpr unsigned int Bone_TypeDefinitionIndex = 30789;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Bone_TypeDefinitionIndex)->GetStaticField(0x7B50);
		}
		...
		::System::Single arotation; // 0x38
		::System::Single ashearY; // 0x3C
		::System::Single worldY; // 0x40
		::System::Single ashearX; // 0x44
		::System::Single y; // 0x48
		::System::Single shearX; // 0x4C
		::System::Single c; // 0x50
		::System::Single shearY; // 0x54
		::System::Single scaleX; // 0x58
		::System::Single d; // 0x5C
		::System::Single scaleY; // 0x60
		::System::Single ay; // 0x64
		::System::Single ascaleX; // 0x68
		::System::Boolean sorted; // 0x6C
		::System::Boolean active; // 0x6D
		::System::Single b; // 0x70
		::System::Single rotation; // 0x74
