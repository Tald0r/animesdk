...
#define SPINE_TIMELINE_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1A9834E0)
#define SPINE_TIMELINE_GET_FRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1A983630)
#define SPINE_TIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x1A983620)
#define SPINE_TIMELINE_GET_FRAMES_OFFSET UNITYSDK_OFFSET(0x1A983610)
#define SPINE_TIMELINE_GET_PROPERTYIDS_OFFSET UNITYSDK_OFFSET(0x1A983600)
#define SPINE_TIMELINE_SEARCH_1_OFFSET UNITYSDK_OFFSET(0x1A965170)
#define SPINE_TIMELINE_SEARCH_OFFSET UNITYSDK_OFFSET(0x1A983660)
#define SPINE_TIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A983560)

namespace Spine
{
	inline static constexpr unsigned int Timeline_TypeDefinitionIndex = 30722;
