...
#define SPINE_PATHCONSTRAINTMIXTIMELINE_APPLY_OFFSET UNITYSDK_OFFSET(0x1AE4CF80)
#define SPINE_PATHCONSTRAINTMIXTIMELINE_GET_FRAMEENTRIES_OFFSET UNITYSDK_OFFSET(0x1AE4CEB0)
#define SPINE_PATHCONSTRAINTMIXTIMELINE_GET_PATHCONSTRAINTINDEX_OFFSET UNITYSDK_OFFSET(0x1AE4CEC0)
#define SPINE_PATHCONSTRAINTMIXTIMELINE_SETFRAME_OFFSET UNITYSDK_OFFSET(0x1AE4CED0)
#define SPINE_PATHCONSTRAINTMIXTIMELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE4CDF0)

namespace Spine
{
	inline static constexpr unsigned int PathConstraintMixTimeline_TypeDefinitionIndex = 29798;
