...
#define CUSTOMSKIN_OVERSEABINDEMAIL__COUNTDOWN_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x80C5990)
#define CUSTOMSKIN_OVERSEABINDEMAIL__COUNTDOWN_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x80C5B80)
#define CUSTOMSKIN_OVERSEABINDEMAIL__COUNTDOWN_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x80C5BE0)
#define CUSTOMSKIN_OVERSEABINDEMAIL__COUNTDOWN_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x80C5B90)
#define CUSTOMSKIN_OVERSEABINDEMAIL__COUNTDOWN_D__21_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x80C5980)
#define CUSTOMSKIN_OVERSEABINDEMAIL__COUNTDOWN_D__21__CTOR_OFFSET UNITYSDK_OFFSET(0x80C5970)

inline static constexpr unsigned int CustomSkin_OverseaBindEmail__CountDown_d__21_TypeDefinitionIndex = 67648;
