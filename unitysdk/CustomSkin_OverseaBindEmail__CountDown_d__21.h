...
#define CUSTOMSKIN_OVERSEABINDEMAIL__COUNTDOWN_D__21_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x98DCEC0)
#define CUSTOMSKIN_OVERSEABINDEMAIL__COUNTDOWN_D__21_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x98DD0B0)
#define CUSTOMSKIN_OVERSEABINDEMAIL__COUNTDOWN_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x98DD110)
#define CUSTOMSKIN_OVERSEABINDEMAIL__COUNTDOWN_D__21_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x98DD0C0)
#define CUSTOMSKIN_OVERSEABINDEMAIL__COUNTDOWN_D__21_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x98DCEB0)
#define CUSTOMSKIN_OVERSEABINDEMAIL__COUNTDOWN_D__21__CTOR_OFFSET UNITYSDK_OFFSET(0x98DCEA0)

inline static constexpr unsigned int CustomSkin_OverseaBindEmail__CountDown_d__21_TypeDefinitionIndex = 59146;
