...
#define TESTWHCLOGICMETHOD_LOCKTARGET_OFFSET UNITYSDK_OFFSET(0x1B06DBE0)
#define TESTWHCLOGICMETHOD_STARTZOOM_OFFSET UNITYSDK_OFFSET(0x1B06DBC0)
#define TESTWHCLOGICMETHOD_STOPZOOM_OFFSET UNITYSDK_OFFSET(0x1B06DBD0)
#define TESTWHCLOGICMETHOD_TEST_OFFSET UNITYSDK_OFFSET(0x1B06DA20)
#define TESTWHCLOGICMETHOD_UNLOCK_OFFSET UNITYSDK_OFFSET(0x1B06DCA0)
#define TESTWHCLOGICMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B06DCB0)

inline static constexpr unsigned int TestWhcLogicMethod_TypeDefinitionIndex = 81709;
