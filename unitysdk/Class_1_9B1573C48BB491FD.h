...
#define CLASS_1_9B1573C48BB491FD_ADDDOWNLOAD_OFFSET UNITYSDK_OFFSET(0x7B9C740)
#define CLASS_1_9B1573C48BB491FD_CLOSE_OFFSET UNITYSDK_OFFSET(0x7B9D5A0)
#define CLASS_1_9B1573C48BB491FD_GETTOTALDOWNLOADEDSIZE_OFFSET UNITYSDK_OFFSET(0x7B9D3C0)
#define CLASS_1_9B1573C48BB491FD_GETTOTALDOWNLOADSIZE_OFFSET UNITYSDK_OFFSET(0x7B9D4A0)
#define CLASS_1_9B1573C48BB491FD_GETTOTALNEEDDOWNLOADSIZE_OFFSET UNITYSDK_OFFSET(0x7B9DA50)
#define CLASS_1_9B1573C48BB491FD_GET_ISENABLEVERIFIER_OFFSET UNITYSDK_OFFSET(0x7B9C720)
#define CLASS_1_9B1573C48BB491FD_GET_ISSHOWALIVEKEEPER_OFFSET UNITYSDK_OFFSET(0x7B9C700)
#define CLASS_1_9B1573C48BB491FD_GET_ONFAILED_OFFSET UNITYSDK_OFFSET(0x7B9C500)
#define CLASS_1_9B1573C48BB491FD_GET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x7B9C4E0)
#define CLASS_1_9B1573C48BB491FD_GET_ONUPDATEDELTA_OFFSET UNITYSDK_OFFSET(0x7B9C4C0)
#define CLASS_1_9B1573C48BB491FD_GET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x7B9C4A0)
#define CLASS_1_9B1573C48BB491FD_GET_ONWEBRESPONSE_OFFSET UNITYSDK_OFFSET(0x7B9C480)
#define CLASS_1_9B1573C48BB491FD_ISDONE_OFFSET UNITYSDK_OFFSET(0x7B9D960)
#define CLASS_1_9B1573C48BB491FD_ISFINISHED_OFFSET UNITYSDK_OFFSET(0x7B9D9E0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_1C4AB311C5F7F725_OFFSET UNITYSDK_OFFSET(0x7BA0BA0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_21EAE8EE56AEE451_OFFSET UNITYSDK_OFFSET(0x7B9F5E0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_26EDB267E37FAB3C_OFFSET UNITYSDK_OFFSET(0x7B9E7F0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_283DA224BE06DA9F_OFFSET UNITYSDK_OFFSET(0x7B9EEB0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_2ACF2A61FB239D23_OFFSET UNITYSDK_OFFSET(0x7BA1040)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_30D1209326FA87FC_OFFSET UNITYSDK_OFFSET(0x7B9CB80)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_39FFE99F2DCEB398_OFFSET UNITYSDK_OFFSET(0x7BA1EF0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_3AC8F91835D61B3F_OFFSET UNITYSDK_OFFSET(0x7B9C900)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_3BB5E8AF3669DD69_OFFSET UNITYSDK_OFFSET(0x7BA1BE0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_3DACC45AC8150727_OFFSET UNITYSDK_OFFSET(0x7BA1D80)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_58D830BED947ACCC_OFFSET UNITYSDK_OFFSET(0x7BA1A60)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_601078E132B9F236_OFFSET UNITYSDK_OFFSET(0x7BA0DE0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_696E70B96088889D_OFFSET UNITYSDK_OFFSET(0x7BA0D00)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_6A521C35B3EF553F_OFFSET UNITYSDK_OFFSET(0x7BA0AF0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_6B5EA38BAE5646C2_OFFSET UNITYSDK_OFFSET(0x7BA1DE0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_70BBBEA481107523_OFFSET UNITYSDK_OFFSET(0x7BA1D60)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_7F1B8738237E0A4B_OFFSET UNITYSDK_OFFSET(0x7B9E8F0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_82E992240300FB30_OFFSET UNITYSDK_OFFSET(0x7B9CCB0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_8A87B4D6FB7FDD03_OFFSET UNITYSDK_OFFSET(0x7BA12E0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0x7B9E760)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x7B9D8B0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_97FECEFC129264AF_OFFSET UNITYSDK_OFFSET(0x7BA1060)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_9B81597B4B113C3D_1_OFFSET UNITYSDK_OFFSET(0x7B9F490)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_9B81597B4B113C3D_OFFSET UNITYSDK_OFFSET(0x7B9F350)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_A36150C5DCC8409E_OFFSET UNITYSDK_OFFSET(0x7BA1710)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_A5B6063FFC26FC8F_1_OFFSET UNITYSDK_OFFSET(0x7BA1780)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_A5B6063FFC26FC8F_OFFSET UNITYSDK_OFFSET(0x7B9EBD0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_A93B7CD3768E295E_OFFSET UNITYSDK_OFFSET(0x7B9DDE0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x7BA1F00)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_AD0F9D7AB7E793D8_OFFSET UNITYSDK_OFFSET(0x7BA1630)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_AD3BA6426D34368E_OFFSET UNITYSDK_OFFSET(0x7B9DF00)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_B283605EECB8DCF3_OFFSET UNITYSDK_OFFSET(0x7B9DC30)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C114A1F8E08B6F92_1_OFFSET UNITYSDK_OFFSET(0x7BA1DB0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C114A1F8E08B6F92_OFFSET UNITYSDK_OFFSET(0x7BA1D40)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74CF020AA42ED85_1_OFFSET UNITYSDK_OFFSET(0x7BA1D90)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74CF020AA42ED85_OFFSET UNITYSDK_OFFSET(0x7BA1D70)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74E50CBD41F0264_1_OFFSET UNITYSDK_OFFSET(0x7BA0DD0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74E50CBD41F0264_2_OFFSET UNITYSDK_OFFSET(0x7BA1050)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74E50CBD41F0264_3_OFFSET UNITYSDK_OFFSET(0x7BA1620)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74E50CBD41F0264_4_OFFSET UNITYSDK_OFFSET(0x7BA1DA0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x7B9F480)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_D03F13E5EC3F80DD_OFFSET UNITYSDK_OFFSET(0x7B9F5C0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_D3B9FBAF07067BAD_OFFSET UNITYSDK_OFFSET(0x7B9DAD0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_D66F211912D83957_OFFSET UNITYSDK_OFFSET(0x7B9D350)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_DF5EFA7071326019_OFFSET UNITYSDK_OFFSET(0x7B9DDF0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_EE5D71FBB4261BF2_OFFSET UNITYSDK_OFFSET(0x7B9DDD0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x7BA1D30)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_F0088C88851A7DFB_2_OFFSET UNITYSDK_OFFSET(0x7BA1D50)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_F0088C88851A7DFB_3_OFFSET UNITYSDK_OFFSET(0x7BA1DC0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_F0088C88851A7DFB_4_OFFSET UNITYSDK_OFFSET(0x7BA1DD0)
#define CLASS_1_9B1573C48BB491FD_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x7B9F5D0)
#define CLASS_1_9B1573C48BB491FD_PAUSE_OFFSET UNITYSDK_OFFSET(0x7B9D710)
#define CLASS_1_9B1573C48BB491FD_SET_ISENABLEVERIFIER_OFFSET UNITYSDK_OFFSET(0x7B9C730)
#define CLASS_1_9B1573C48BB491FD_SET_ISSHOWALIVEKEEPER_OFFSET UNITYSDK_OFFSET(0x7B9C710)
#define CLASS_1_9B1573C48BB491FD_SET_ONFAILED_OFFSET UNITYSDK_OFFSET(0x7B9C510)
#define CLASS_1_9B1573C48BB491FD_SET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x7B9C4F0)
#define CLASS_1_9B1573C48BB491FD_SET_ONUPDATEDELTA_OFFSET UNITYSDK_OFFSET(0x7B9C4D0)
#define CLASS_1_9B1573C48BB491FD_SET_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x7B9C4B0)
#define CLASS_1_9B1573C48BB491FD_SET_ONWEBRESPONSE_OFFSET UNITYSDK_OFFSET(0x7B9C490)
#define CLASS_1_9B1573C48BB491FD_START_OFFSET UNITYSDK_OFFSET(0x7B9C9B0)
#define CLASS_1_9B1573C48BB491FD_UNPAUSE_OFFSET UNITYSDK_OFFSET(0x7B9D7C0)
#define CLASS_1_9B1573C48BB491FD_UPDATE_OFFSET UNITYSDK_OFFSET(0x7B9CFF0)
#define CLASS_1_9B1573C48BB491FD__CTOR_OFFSET UNITYSDK_OFFSET(0x7B9C520)

inline static constexpr unsigned int Class_1_9B1573C48BB491FD_TypeDefinitionIndex = 59148;

class Class_1_9B1573C48BB491FD : public ::System::Object
{
public:
	// static const ::System::String* Field_1_21; // 0x0
	::System::Action_1<::System::Boolean>* Field_1_20; // 0x10
	::System::Action_2<::System::Single, ::System::Int64>* Field_1_13; // 0x18
	::System::Action_4<::System::Int64, ::System::Int64, ::System::Single, ::System::Single>* Field_1_12; // 0x20
	::System::Action_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_19; // 0x28
	::System::Collections::Generic::List_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_4; // 0x30
	::System::Threading::ManualResetEvent* Field_1_30; // 0x38
	::System::Exception* Field_1_8; // 0x40
	::System::Collections::Generic::Queue_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_28; // 0x48
	::System::Collections::Generic::Queue_1<::System::Single>* Field_1_27; // 0x50
	::System::Action_3<::System::Int32, ::System::String*, ::System::Action_1<::System::Boolean>*>* Field_1_15; // 0x58
	::System::Action_1<::System::Int64>* Field_1_14; // 0x60
	::System::Collections::Generic::Queue_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_29; // 0x68
	::System::Action_2<::System::String*, ::System::Boolean>* Field_1_11; // 0x70
	::System::Action_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_17; // 0x78
	::System::Action_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_16; // 0x80
	::System::Action_1<::Class_1_9B1573C48BB491FD_Class_1_C6455FAF85D1C79C*>* Field_1_18; // 0x88
	::Class_1_9B1573C48BB491FD_Enum_3_161872DC1725FD46 Field_1_6; // 0x90
	::System::Int32 Field_1_5; // 0x94
	::System::Int64 Field_1_24; // 0x98
	::System::Boolean Field_1_9; // 0xA0
	::System::Boolean Field_1_39; // 0xA1
	::System::Boolean Field_1_3; // 0xA2
	::Enum_3_0A3761FE34514D6C Field_1_0; // 0xA4
	::System::Int32 Field_1_32; // 0xA8
	::System::Int32 Field_1_35; // 0xAC
	::System::Int32 Field_1_33; // 0xB0
	::System::Int32 Field_1_37; // 0xB4
	::System::Int64 Field_1_23; // 0xB8
	...
	::System::Boolean Field_1_1; // 0xE4
	::System::Boolean Field_1_2; // 0xE5
	::System::Boolean Field_1_40; // 0xE6
	::System::Boolean Field_1_10; // 0xE7
