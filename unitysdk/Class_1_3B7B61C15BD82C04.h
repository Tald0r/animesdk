...
#define CLASS_1_3B7B61C15BD82C04_METHOD_1_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xBB83E80)
#define CLASS_1_3B7B61C15BD82C04_METHOD_1_B9489D332A757B66_OFFSET UNITYSDK_OFFSET(0xBB83E60)
#define CLASS_1_3B7B61C15BD82C04__CTOR_OFFSET UNITYSDK_OFFSET(0xBB83E50)

inline static constexpr unsigned int Class_1_3B7B61C15BD82C04_TypeDefinitionIndex = 63433;

class Class_1_3B7B61C15BD82C04 : public ::System::Object
{
public:
	::System::Action* Field_1_6; // 0x10
	::Class_2_208CC9941471731A_148* Field_1_5; // 0x18
