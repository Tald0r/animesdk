...
#define CLASS_1_D66FF03D93DBBB59_CONTAINS_OFFSET UNITYSDK_OFFSET(0x7982D70)
#define CLASS_1_D66FF03D93DBBB59_DISABLE_OFFSET UNITYSDK_OFFSET(0x7983070)
#define CLASS_1_D66FF03D93DBBB59_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7982A30)
#define CLASS_1_D66FF03D93DBBB59_ENABLE_OFFSET UNITYSDK_OFFSET(0x7983000)
#define CLASS_1_D66FF03D93DBBB59_FINDACTION_OFFSET UNITYSDK_OFFSET(0x7983140)
#define CLASS_1_D66FF03D93DBBB59_FINDBINDING_OFFSET UNITYSDK_OFFSET(0x79831D0)
#define CLASS_1_D66FF03D93DBBB59_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x7982E70)
#define CLASS_1_D66FF03D93DBBB59_GET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x7982AD0)
#define CLASS_1_D66FF03D93DBBB59_GET_BINDINGS_OFFSET UNITYSDK_OFFSET(0x79830E0)
#define CLASS_1_D66FF03D93DBBB59_GET_CONTROLSCHEMES_OFFSET UNITYSDK_OFFSET(0x7982D30)
#define CLASS_1_D66FF03D93DBBB59_GET_DEVICES_OFFSET UNITYSDK_OFFSET(0x7982C30)
#define CLASS_1_D66FF03D93DBBB59_METHOD_1_AF82526B82A7316A_OFFSET UNITYSDK_OFFSET(0x79832F0)
#define CLASS_1_D66FF03D93DBBB59_METHOD_1_FA5975137CC99DA0_OFFSET UNITYSDK_OFFSET(0x7983300)
#define CLASS_1_D66FF03D93DBBB59_SET_BINDINGMASK_OFFSET UNITYSDK_OFFSET(0x7982B20)
#define CLASS_1_D66FF03D93DBBB59_SET_DEVICES_OFFSET UNITYSDK_OFFSET(0x7982C90)
#define CLASS_1_D66FF03D93DBBB59_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x7982F10)
#define CLASS_1_D66FF03D93DBBB59__CTOR_OFFSET UNITYSDK_OFFSET(0x7982960)

inline static constexpr unsigned int Class_1_D66FF03D93DBBB59_TypeDefinitionIndex = 52674;

class Class_1_D66FF03D93DBBB59 : public ::System::Object
{
public:
	::UnityEngine::InputSystem::InputActionAsset* Field_1_0; // 0x10
	::Class_1_D66FF03D93DBBB59_Class_0_16E7307DCC43CB2C_27* Field_1_2; // 0x18
	::UnityEngine::InputSystem::InputAction* Field_1_5; // 0x20
	::UnityEngine::InputSystem::InputAction* Field_1_6; // 0x28
	::UnityEngine::InputSystem::InputActionMap* Field_1_1; // 0x30
	::UnityEngine::InputSystem::InputAction* Field_1_4; // 0x38
