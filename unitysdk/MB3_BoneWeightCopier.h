...
#define MB3_BONEWEIGHTCOPIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3863C0)

inline static constexpr unsigned int MB3_BoneWeightCopier_TypeDefinitionIndex = 81194;
