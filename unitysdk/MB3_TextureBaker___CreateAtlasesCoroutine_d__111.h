...
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINE_D__111_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AFE8E80)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINE_D__111_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AFE9800)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINE_D__111_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AFE9860)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINE_D__111_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AFE9810)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINE_D__111_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AFE8E70)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINE_D__111__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE8E60)

inline static constexpr unsigned int MB3_TextureBaker___CreateAtlasesCoroutine_d__111_TypeDefinitionIndex = 81213;
...
public:
	...
	::DigitalOpus::MB::Core::MB3_TextureCombiner_CreateAtlasesCoroutineResult* coroutineResult; // 0x20
