...
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINE_D__111_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B5F7CC0)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINE_D__111_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B5F8640)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINE_D__111_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B5F86A0)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINE_D__111_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B5F8650)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINE_D__111_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B5F7CB0)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINE_D__111__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F7CA0)

inline static constexpr unsigned int MB3_TextureBaker___CreateAtlasesCoroutine_d__111_TypeDefinitionIndex = 83254;
