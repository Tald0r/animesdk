...
#define EFFECTCASTRECORDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x7337F90)
#define EFFECTCASTRECORDER_BEGIN_OFFSET UNITYSDK_OFFSET(0x7338360)
#define EFFECTCASTRECORDER_END_OFFSET UNITYSDK_OFFSET(0x7338570)
#define EFFECTCASTRECORDER_GET_ENABLEERRORWHILELIMIT_OFFSET UNITYSDK_OFFSET(0x7338350)
#define EFFECTCASTRECORDER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x7337DB0)
#define EFFECTCASTRECORDER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x7339200)
#define EFFECTCASTRECORDER_SET_ENABLEERRORWHILELIMIT_OFFSET UNITYSDK_OFFSET(0x7338260)
#define EFFECTCASTRECORDER_START_OFFSET UNITYSDK_OFFSET(0x7338040)
#define EFFECTCASTRECORDER_TIMEFILENAMEPATH_OFFSET UNITYSDK_OFFSET(0x73383F0)
#define EFFECTCASTRECORDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x73385E0)
#define EFFECTCASTRECORDER_WRITEFILEIFNEED_OFFSET UNITYSDK_OFFSET(0x73386A0)
#define EFFECTCASTRECORDER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB9734C0)
#define EFFECTCASTRECORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x73392B0)

inline static constexpr unsigned int EffectCastRecorder_TypeDefinitionIndex = 45209;
...
public:
	...
	{
		return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(EffectCastRecorder_TypeDefinitionIndex)->GetStaticField(0x376E0);
	}
	static ::EffectCastRecorder** StaticGet_s_instance()
	{
		return (::EffectCastRecorder**)Il2CppClass::FromTypeDefinitionIndex(EffectCastRecorder_TypeDefinitionIndex)->GetStaticField(0x376E8);
	}
