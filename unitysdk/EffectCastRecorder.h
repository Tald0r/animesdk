...
#define EFFECTCASTRECORDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x7661C40)
#define EFFECTCASTRECORDER_BEGIN_OFFSET UNITYSDK_OFFSET(0x7662010)
#define EFFECTCASTRECORDER_END_OFFSET UNITYSDK_OFFSET(0x7662220)
#define EFFECTCASTRECORDER_GET_ENABLEERRORWHILELIMIT_OFFSET UNITYSDK_OFFSET(0x7662000)
#define EFFECTCASTRECORDER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x7661A60)
#define EFFECTCASTRECORDER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x7662EB0)
#define EFFECTCASTRECORDER_SET_ENABLEERRORWHILELIMIT_OFFSET UNITYSDK_OFFSET(0x7661F10)
#define EFFECTCASTRECORDER_START_OFFSET UNITYSDK_OFFSET(0x7661CF0)
#define EFFECTCASTRECORDER_TIMEFILENAMEPATH_OFFSET UNITYSDK_OFFSET(0x76620A0)
#define EFFECTCASTRECORDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x7662290)
#define EFFECTCASTRECORDER_WRITEFILEIFNEED_OFFSET UNITYSDK_OFFSET(0x7662350)
#define EFFECTCASTRECORDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x7662FA0)
#define EFFECTCASTRECORDER__CTOR_OFFSET UNITYSDK_OFFSET(0x7662F60)

inline static constexpr unsigned int EffectCastRecorder_TypeDefinitionIndex = 67637;
...
public:
	...
	{
		return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(EffectCastRecorder_TypeDefinitionIndex)->GetStaticField(0x3A5C0);
	}
	static ::EffectCastRecorder** StaticGet_s_instance()
	{
		return (::EffectCastRecorder**)Il2CppClass::FromTypeDefinitionIndex(EffectCastRecorder_TypeDefinitionIndex)->GetStaticField(0x3A5C8);
	}
