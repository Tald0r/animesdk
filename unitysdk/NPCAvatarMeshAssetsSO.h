...
#define NPCAVATARMESHASSETSSO_ADDMESHASSETS_OFFSET UNITYSDK_OFFSET(0x688ECB0)
#define NPCAVATARMESHASSETSSO_CLEARMESHASSETS_OFFSET UNITYSDK_OFFSET(0x688EBC0)
#define NPCAVATARMESHASSETSSO_GETAVATARSLOTMESHASSETS_OFFSET UNITYSDK_OFFSET(0x688EC50)
#define NPCAVATARMESHASSETSSO_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x688E9E0)
#define NPCAVATARMESHASSETSSO__CTOR_OFFSET UNITYSDK_OFFSET(0x688EE80)

inline static constexpr unsigned int NPCAvatarMeshAssetsSO_TypeDefinitionIndex = 62303;
