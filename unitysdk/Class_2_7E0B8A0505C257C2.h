...
#define CLASS_2_7E0B8A0505C257C2_METHOD_2_37917191637BFFF4_OFFSET UNITYSDK_OFFSET(0xB5911E0)
#define CLASS_2_7E0B8A0505C257C2_METHOD_2_7835DD7D7F7FF1B7_OFFSET UNITYSDK_OFFSET(0xB591350)
#define CLASS_2_7E0B8A0505C257C2_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0xB591440)
#define CLASS_2_7E0B8A0505C257C2__CTOR_OFFSET UNITYSDK_OFFSET(0xB591430)

inline static constexpr unsigned int Class_2_7E0B8A0505C257C2_TypeDefinitionIndex = 43585;

class Class_2_7E0B8A0505C257C2 : public ::Class_1_EEA0111A28582B57
{
public:
	::Class_3_A2BF74BADF6F7D16<::MoleMole::UIVHSPlayerRoleWidgetController*>* Field_2_0; // 0x18
