...
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A90EE10)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A90EEE0)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A90EF40)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A90EEF0)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A90EE00)
#define DIGITALOPUS_MB_CORE_MBVERSION__FINDRUNTIMEMATERIALSFROMADDRESSES_D__36__CTOR_OFFSET UNITYSDK_OFFSET(0x1A90EDF0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MBVersion__FindRuntimeMaterialsFromAddresses_d__36_TypeDefinitionIndex = 83311;
