...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1AECE510)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE_FILTERINTOGROUPS_OFFSET UNITYSDK_OFFSET(0x1AECE1B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1AECE520)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECE530)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperNone_TypeDefinitionIndex = 83267;
