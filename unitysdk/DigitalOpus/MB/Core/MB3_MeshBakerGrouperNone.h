...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1A8F5170)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE_FILTERINTOGROUPS_OFFSET UNITYSDK_OFFSET(0x1A8F4E10)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1A8F5180)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERNONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8F5190)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperNone_TypeDefinitionIndex = 81226;
