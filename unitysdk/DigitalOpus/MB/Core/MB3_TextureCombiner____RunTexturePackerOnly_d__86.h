...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER____RUNTEXTUREPACKERONLY_D__86_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ABF9410)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER____RUNTEXTUREPACKERONLY_D__86_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ABF9B70)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER____RUNTEXTUREPACKERONLY_D__86_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ABF9BD0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER____RUNTEXTUREPACKERONLY_D__86_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ABF9B80)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER____RUNTEXTUREPACKERONLY_D__86_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ABF9400)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER____RUNTEXTUREPACKERONLY_D__86__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABF93F0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombiner____RunTexturePackerOnly_d__86_TypeDefinitionIndex = 83397;
	...
	public:
		...
		::System::Collections::Generic::List_1<::DigitalOpus::MB::Core::AtlasPackingResult*>* packingResult; // 0x48
