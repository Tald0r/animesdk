...
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_CONVERTTEXTURESTOREADABLEFORMAT_OFFSET UNITYSDK_OFFSET(0x1A3844A0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_CREATETEXTUREARRAYSFORRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A3839C0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_DETERMINEWHICHPROPERTIESHAVETEXTURES_OFFSET UNITYSDK_OFFSET(0x1A3836C0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_FINDBESTSIZEANDMIPCOUNTANDFORMATFORTEXTUREARRAYS_OFFSET UNITYSDK_OFFSET(0x1A3857D0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_ISLINEARPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A383890)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS__CREATEATLASESCOROUTINESINGLERESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A385D30)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A385E30)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TextureArrays_TypeDefinitionIndex = 81408;
