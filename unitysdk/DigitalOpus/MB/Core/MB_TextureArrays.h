...
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_CONVERTTEXTURESTOREADABLEFORMAT_OFFSET UNITYSDK_OFFSET(0x1A9574C0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_CREATETEXTUREARRAYSFORRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A9569E0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_DETERMINEWHICHPROPERTIESHAVETEXTURES_OFFSET UNITYSDK_OFFSET(0x1A9566E0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_FINDBESTSIZEANDMIPCOUNTANDFORMATFORTEXTUREARRAYS_OFFSET UNITYSDK_OFFSET(0x1A9587F0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS_ISLINEARPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A9568B0)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS__CREATEATLASESCOROUTINESINGLERESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A958D50)
#define DIGITALOPUS_MB_CORE_MB_TEXTUREARRAYS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A958E50)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TextureArrays_TypeDefinitionIndex = 83449;
