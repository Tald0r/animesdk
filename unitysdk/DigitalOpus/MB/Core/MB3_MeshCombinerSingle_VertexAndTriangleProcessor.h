...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ADJUSTVERTSTOWRITEACCORDINGTOPIVOTPOSITIONIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x97CC90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ASSIGNBUFFERSTOMESH_OFFSET UNITYSDK_OFFSET(0x97CC70)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ASSIGNTRIANGLEDATAFORSUBMESHES_OFFSET UNITYSDK_OFFSET(0x97CC80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ASSIGNTRIANGLEDATAFORSUBMESHES_SHOWHIDE_OFFSET UNITYSDK_OFFSET(0x97CC80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_COPYARRAYSFROMPREVIOUSBAKEBUFFERSTONEWBUFFERS_OFFSET UNITYSDK_OFFSET(0x97CBF0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_COPYFROMDGOMESHTOBUFFERS_OFFSET UNITYSDK_OFFSET(0x97CC00)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_COPYUV2UNCHANGEDTOSEPARATERECTS_OFFSET UNITYSDK_OFFSET(0x97CCF0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x97CAD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GETSUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x97CBA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GETSUBMESHTRISWITHSHOWHIDEAPPLIED_OFFSET UNITYSDK_OFFSET(0x97CD00)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GETTRIANGLESIZES_OFFSET UNITYSDK_OFFSET(0x97CD10)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GETVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x97CB80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GET_CHANNELS_OFFSET UNITYSDK_OFFSET(0x2EC6E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_INITFROMMESHCOMBINER_OFFSET UNITYSDK_OFFSET(0x97CB70)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_INITSHOWHIDE_OFFSET UNITYSDK_OFFSET(0x97CB40)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_INIT_OFFSET UNITYSDK_OFFSET(0x97CB10)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x306AA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x36E730)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_SET_CHANNELS_OFFSET UNITYSDK_OFFSET(0x3028C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_TRANSFEROWNERSHIPOFSERIALIZABLEBUFFERSTOCOMBINER_OFFSET UNITYSDK_OFFSET(0x97CBC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__COPYANDADJUSTUV2FROMMESH_OFFSET UNITYSDK_OFFSET(0x97CCE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__COPYANDADJUSTUVSFROMMESH_OFFSET UNITYSDK_OFFSET(0x97CCD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__LOCALTOWORLDMATRIX_TRS_OFFSET UNITYSDK_OFFSET(0x1AED6350)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0x97CD20)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__LOCALTOWORLD_TRS_OFFSET UNITYSDK_OFFSET(0x1AED6A90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__LOCALTOWORLD_TR_OFFSET UNITYSDK_OFFSET(0x1AED5E00)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__NUMNONZEROLENGTHSUBMESHTRIS_OFFSET UNITYSDK_OFFSET(0x1AED5610)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_VertexAndTriangleProcessor_TypeDefinitionIndex = 83344;
