...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ADJUSTVERTSTOWRITEACCORDINGTOPIVOTPOSITIONIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x94D250)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ASSIGNBUFFERSTOMESH_OFFSET UNITYSDK_OFFSET(0x94D230)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ASSIGNTRIANGLEDATAFORSUBMESHES_OFFSET UNITYSDK_OFFSET(0x94D240)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ASSIGNTRIANGLEDATAFORSUBMESHES_SHOWHIDE_OFFSET UNITYSDK_OFFSET(0x94D240)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_COPYARRAYSFROMPREVIOUSBAKEBUFFERSTONEWBUFFERS_OFFSET UNITYSDK_OFFSET(0x94D1B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_COPYFROMDGOMESHTOBUFFERS_OFFSET UNITYSDK_OFFSET(0x94D1C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_COPYUV2UNCHANGEDTOSEPARATERECTS_OFFSET UNITYSDK_OFFSET(0x94D2B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x94D090)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GETSUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x94D160)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GETSUBMESHTRISWITHSHOWHIDEAPPLIED_OFFSET UNITYSDK_OFFSET(0x94D2C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GETTRIANGLESIZES_OFFSET UNITYSDK_OFFSET(0x94D2D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GETVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x94D140)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_GET_CHANNELS_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_INITFROMMESHCOMBINER_OFFSET UNITYSDK_OFFSET(0x94D130)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_INITSHOWHIDE_OFFSET UNITYSDK_OFFSET(0x94D100)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_INIT_OFFSET UNITYSDK_OFFSET(0x94D0D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x2D71A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x34DAA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_SET_CHANNELS_OFFSET UNITYSDK_OFFSET(0x2C6250)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR_TRANSFEROWNERSHIPOFSERIALIZABLEBUFFERSTOCOMBINER_OFFSET UNITYSDK_OFFSET(0x94D180)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__COPYANDADJUSTUV2FROMMESH_OFFSET UNITYSDK_OFFSET(0x94D2A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__COPYANDADJUSTUVSFROMMESH_OFFSET UNITYSDK_OFFSET(0x94D290)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__LOCALTOWORLDMATRIX_TRS_OFFSET UNITYSDK_OFFSET(0x1A8FCFB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0x94D2E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__LOCALTOWORLD_TRS_OFFSET UNITYSDK_OFFSET(0x1A8FD6F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__LOCALTOWORLD_TR_OFFSET UNITYSDK_OFFSET(0x1A8FCA60)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VERTEXANDTRIANGLEPROCESSOR__NUMNONZEROLENGTHSUBMESHTRIS_OFFSET UNITYSDK_OFFSET(0x1A8FC270)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_VertexAndTriangleProcessor_TypeDefinitionIndex = 81303;
