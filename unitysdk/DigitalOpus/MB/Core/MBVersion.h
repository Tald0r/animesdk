...
#define DIGITALOPUS_MB_CORE_MBVERSION_ADDBLENDSHAPEFRAME_OFFSET UNITYSDK_OFFSET(0x1A21A0B0)
#define DIGITALOPUS_MB_CORE_MBVERSION_CLEARBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1A219FA0)
#define DIGITALOPUS_MB_CORE_MBVERSION_COLLECTPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1A213960)
#define DIGITALOPUS_MB_CORE_MBVERSION_DETECTPIPELINE_OFFSET UNITYSDK_OFFSET(0x1A21A930)
#define DIGITALOPUS_MB_CORE_MBVERSION_DOSPECIALRENDERPIPELINE_TEXTUREPACKERFASTSETUP_OFFSET UNITYSDK_OFFSET(0x1A21A730)
#define DIGITALOPUS_MB_CORE_MBVERSION_FINDRUNTIMEMATERIALSFROMADDRESSES_OFFSET UNITYSDK_OFFSET(0x1A21AEA0)
#define DIGITALOPUS_MB_CORE_MBVERSION_FINDSCENEOBJECTSOFTYPE_OFFSET UNITYSDK_OFFSET(0x1A219230)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETACTIVE_OFFSET UNITYSDK_OFFSET(0x1A218EE0)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETBLENDSHAPEFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1A219C20)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETBLENDSHAPEFRAMEVERTICES_OFFSET UNITYSDK_OFFSET(0x1A219E70)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETBLENDSHAPEFRAMEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1A219D40)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETBONES_OFFSET UNITYSDK_OFFSET(0x1A219A20)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETLIGHTMAPTILINGOFFSET_OFFSET UNITYSDK_OFFSET(0x1A2198E0)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETMESHCHANNEL_OFFSET UNITYSDK_OFFSET(0x1A219480)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETPROJECTCOLORSPACE_OFFSET UNITYSDK_OFFSET(0x1A21A820)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETSCALEINLIGHTMAP_OFFSET UNITYSDK_OFFSET(0x1A2195A0)
#define DIGITALOPUS_MB_CORE_MBVERSION_GRAPHICSUVSTARTSATTOP_OFFSET UNITYSDK_OFFSET(0x1A21A420)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISASSETINPROJECT_OFFSET UNITYSDK_OFFSET(0x1A21ABC0)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISRUNNINGANDMESHNOTREADWRITEABLE_OFFSET UNITYSDK_OFFSET(0x1A219350)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISTEXTUREREADABLE_OFFSET UNITYSDK_OFFSET(0x1A21A620)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISTEXTURE_SRGBGAMMACORRECTED_OFFSET UNITYSDK_OFFSET(0x1A21A520)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISUSINGADDRESSABLES_OFFSET UNITYSDK_OFFSET(0x1A21ACC0)
#define DIGITALOPUS_MB_CORE_MBVERSION_IS_2017_1_ORNEWER_OFFSET UNITYSDK_OFFSET(0x1A218DE0)
#define DIGITALOPUS_MB_CORE_MBVERSION_IS_2018_3_ORNEWER_OFFSET UNITYSDK_OFFSET(0x1A218CE0)
#define DIGITALOPUS_MB_CORE_MBVERSION_MAXMESHVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1A21A1F0)
#define DIGITALOPUS_MB_CORE_MBVERSION_MESHASSIGNUVCHANNEL_OFFSET UNITYSDK_OFFSET(0x1A2197C0)
#define DIGITALOPUS_MB_CORE_MBVERSION_MESHCLEAR_OFFSET UNITYSDK_OFFSET(0x1A2196A0)
#define DIGITALOPUS_MB_CORE_MBVERSION_OPTIMIZEMESH_OFFSET UNITYSDK_OFFSET(0x1A219B30)
#define DIGITALOPUS_MB_CORE_MBVERSION_SETACTIVERECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1A219110)
#define DIGITALOPUS_MB_CORE_MBVERSION_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x1A218FF0)
#define DIGITALOPUS_MB_CORE_MBVERSION_SETMESHINDEXFORMATANDCLEARMESH_OFFSET UNITYSDK_OFFSET(0x1A21A2F0)
#define DIGITALOPUS_MB_CORE_MBVERSION_UNESCAPEURL_OFFSET UNITYSDK_OFFSET(0x1A21AA40)
#define DIGITALOPUS_MB_CORE_MBVERSION_VERSION_OFFSET UNITYSDK_OFFSET(0x1A218BC0)
#define DIGITALOPUS_MB_CORE_MBVERSION__CREATEMBVERSIONCONCRETE_OFFSET UNITYSDK_OFFSET(0x1A218B30)
#define DIGITALOPUS_MB_CORE_MBVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A21AEF0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MBVersion_TypeDefinitionIndex = 81268;
	...
	public:
		...
		{
			return (::DigitalOpus::MB::Core::MBVersionInterface**)Il2CppClass::FromTypeDefinitionIndex(MBVersion_TypeDefinitionIndex)->GetStaticField(0x46720);
		}
