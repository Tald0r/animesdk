...
#define DIGITALOPUS_MB_CORE_MBVERSION_ADDBLENDSHAPEFRAME_OFFSET UNITYSDK_OFFSET(0x1A7D0D40)
#define DIGITALOPUS_MB_CORE_MBVERSION_CLEARBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1A7D0C30)
#define DIGITALOPUS_MB_CORE_MBVERSION_COLLECTPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1A7CA600)
#define DIGITALOPUS_MB_CORE_MBVERSION_DETECTPIPELINE_OFFSET UNITYSDK_OFFSET(0x1A7D15C0)
#define DIGITALOPUS_MB_CORE_MBVERSION_DOSPECIALRENDERPIPELINE_TEXTUREPACKERFASTSETUP_OFFSET UNITYSDK_OFFSET(0x1A7D13C0)
#define DIGITALOPUS_MB_CORE_MBVERSION_FINDRUNTIMEMATERIALSFROMADDRESSES_OFFSET UNITYSDK_OFFSET(0x1A7D1B30)
#define DIGITALOPUS_MB_CORE_MBVERSION_FINDSCENEOBJECTSOFTYPE_OFFSET UNITYSDK_OFFSET(0x1A7CFEC0)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETACTIVE_OFFSET UNITYSDK_OFFSET(0x1A7CFB70)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETBLENDSHAPEFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1A7D08B0)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETBLENDSHAPEFRAMEVERTICES_OFFSET UNITYSDK_OFFSET(0x1A7D0B00)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETBLENDSHAPEFRAMEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1A7D09D0)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETBONES_OFFSET UNITYSDK_OFFSET(0x1A7D06B0)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETLIGHTMAPTILINGOFFSET_OFFSET UNITYSDK_OFFSET(0x1A7D0570)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETMESHCHANNEL_OFFSET UNITYSDK_OFFSET(0x1A7D0110)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETPROJECTCOLORSPACE_OFFSET UNITYSDK_OFFSET(0x1A7D14B0)
#define DIGITALOPUS_MB_CORE_MBVERSION_GETSCALEINLIGHTMAP_OFFSET UNITYSDK_OFFSET(0x1A7D0230)
#define DIGITALOPUS_MB_CORE_MBVERSION_GRAPHICSUVSTARTSATTOP_OFFSET UNITYSDK_OFFSET(0x1A7D10B0)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISASSETINPROJECT_OFFSET UNITYSDK_OFFSET(0x1A7D1850)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISRUNNINGANDMESHNOTREADWRITEABLE_OFFSET UNITYSDK_OFFSET(0x1A7CFFE0)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISTEXTUREREADABLE_OFFSET UNITYSDK_OFFSET(0x1A7D12B0)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISTEXTURE_SRGBGAMMACORRECTED_OFFSET UNITYSDK_OFFSET(0x1A7D11B0)
#define DIGITALOPUS_MB_CORE_MBVERSION_ISUSINGADDRESSABLES_OFFSET UNITYSDK_OFFSET(0x1A7D1950)
#define DIGITALOPUS_MB_CORE_MBVERSION_IS_2017_1_ORNEWER_OFFSET UNITYSDK_OFFSET(0x1A7CFA70)
#define DIGITALOPUS_MB_CORE_MBVERSION_IS_2018_3_ORNEWER_OFFSET UNITYSDK_OFFSET(0x1A7CF970)
#define DIGITALOPUS_MB_CORE_MBVERSION_MAXMESHVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1A7D0E80)
#define DIGITALOPUS_MB_CORE_MBVERSION_MESHASSIGNUVCHANNEL_OFFSET UNITYSDK_OFFSET(0x1A7D0450)
#define DIGITALOPUS_MB_CORE_MBVERSION_MESHCLEAR_OFFSET UNITYSDK_OFFSET(0x1A7D0330)
#define DIGITALOPUS_MB_CORE_MBVERSION_OPTIMIZEMESH_OFFSET UNITYSDK_OFFSET(0x1A7D07C0)
#define DIGITALOPUS_MB_CORE_MBVERSION_SETACTIVERECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1A7CFDA0)
#define DIGITALOPUS_MB_CORE_MBVERSION_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x1A7CFC80)
#define DIGITALOPUS_MB_CORE_MBVERSION_SETMESHINDEXFORMATANDCLEARMESH_OFFSET UNITYSDK_OFFSET(0x1A7D0F80)
#define DIGITALOPUS_MB_CORE_MBVERSION_UNESCAPEURL_OFFSET UNITYSDK_OFFSET(0x1A7D16D0)
#define DIGITALOPUS_MB_CORE_MBVERSION_VERSION_OFFSET UNITYSDK_OFFSET(0x1A7CF850)
#define DIGITALOPUS_MB_CORE_MBVERSION__CREATEMBVERSIONCONCRETE_OFFSET UNITYSDK_OFFSET(0x1A7CF7C0)
#define DIGITALOPUS_MB_CORE_MBVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D1B80)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MBVersion_TypeDefinitionIndex = 83309;
	...
	public:
		...
		{
			return (::DigitalOpus::MB::Core::MBVersionInterface**)Il2CppClass::FromTypeDefinitionIndex(MBVersion_TypeDefinitionIndex)->GetStaticField(0x48130);
		}
