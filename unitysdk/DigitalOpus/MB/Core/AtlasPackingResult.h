...
#define DIGITALOPUS_MB_CORE_ATLASPACKINGRESULT_CALCUSEDWIDTHANDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1ACDB0E0)
#define DIGITALOPUS_MB_CORE_ATLASPACKINGRESULT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1ACDB2A0)
#define DIGITALOPUS_MB_CORE_ATLASPACKINGRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACDB0D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int AtlasPackingResult_TypeDefinitionIndex = 81331;
