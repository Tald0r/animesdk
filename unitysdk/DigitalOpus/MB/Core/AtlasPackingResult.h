...
#define DIGITALOPUS_MB_CORE_ATLASPACKINGRESULT_CALCUSEDWIDTHANDHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B2FEDF0)
#define DIGITALOPUS_MB_CORE_ATLASPACKINGRESULT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B2FEFB0)
#define DIGITALOPUS_MB_CORE_ATLASPACKINGRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FEDE0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int AtlasPackingResult_TypeDefinitionIndex = 83372;
