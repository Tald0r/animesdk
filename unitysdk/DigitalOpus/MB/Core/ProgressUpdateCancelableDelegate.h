...
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AACE480)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AACE4E0)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AACDEE0)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AACDED0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int ProgressUpdateCancelableDelegate_TypeDefinitionIndex = 81252;
