...
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B112590)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B1125F0)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B111FE0)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATECANCELABLEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B111FC0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int ProgressUpdateCancelableDelegate_TypeDefinitionIndex = 83293;
