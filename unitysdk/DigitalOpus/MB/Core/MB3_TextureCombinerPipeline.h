...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CALCULATEALLTEXTURESARENULLANDSAMECOLOR_OFFSET UNITYSDK_OFFSET(0x1A7CA910)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CALCULATEIDEALSIZESFORTEXTURESINATLASANDPADDING_OFFSET UNITYSDK_OFFSET(0x1A7CB0F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CONVERTNORMALFORMATFROMUNITY_TOSTANDARD_OFFSET UNITYSDK_OFFSET(0x1A7CDFF0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CREATEPACKER_OFFSET UNITYSDK_OFFSET(0x1A7CBF10)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CREATETEXTUREPACKER_OFFSET UNITYSDK_OFFSET(0x1A7CD570)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_FILLATLASPACKINGRESULTAUXILLARYDATA_OFFSET UNITYSDK_OFFSET(0x1A7CB2B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_FILLRESULTATLASESANDRECTS_OFFSET UNITYSDK_OFFSET(0x1A7CB990)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GENERATEREPORT_OFFSET UNITYSDK_OFFSET(0x1A7CC1C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETADJUSTEDFORSCALEANDOFFSET2DIMENSIONS_OFFSET UNITYSDK_OFFSET(0x1A7CD6C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETMATERIALSCALEANDOFFSET_OFFSET UNITYSDK_OFFSET(0x1A7CE0D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETSUBMESHAREA_OFFSET UNITYSDK_OFFSET(0x1A7CE210)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETTEXTURECONSIDERINGSTANDARDSHADERKEYWORDS_OFFSET UNITYSDK_OFFSET(0x1A7CA740)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_ISPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1A7CE470)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_RUNTEXTUREPACKERONLY_OFFSET UNITYSDK_OFFSET(0x1A7CB140)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7CE490)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__COLLECTPROPERTYNAMES_1_OFFSET UNITYSDK_OFFSET(0x1A7CA1F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__COLLECTPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1A7CA160)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7CE480)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__DOANYSRCMATSHAVEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A7CA120)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__SHOULDWECREATEATLASFORTHISPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A7C8330)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE___STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A7CA880)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE___STEP3_BUILDANDSAVEATLASESANDSTORERESULTS_OFFSET UNITYSDK_OFFSET(0x1A7CC100)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPipeline_TypeDefinitionIndex = 83439;
	...
	public:
		...
		{
			return (::Il2CppArray<::DigitalOpus::MB::Core::ShaderTextureProperty*>**)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombinerPipeline_TypeDefinitionIndex)->GetStaticField(0x48170);
		}
		static ::System::Boolean* StaticGet_USE_EXPERIMENTAL_HOIZONTALVERTICAL()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombinerPipeline_TypeDefinitionIndex)->GetStaticField(0x11AE0);
		}
