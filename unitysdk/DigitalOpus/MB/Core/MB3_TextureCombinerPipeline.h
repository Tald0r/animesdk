...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CALCULATEALLTEXTURESARENULLANDSAMECOLOR_OFFSET UNITYSDK_OFFSET(0x1A213C70)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CALCULATEIDEALSIZESFORTEXTURESINATLASANDPADDING_OFFSET UNITYSDK_OFFSET(0x1A214450)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CONVERTNORMALFORMATFROMUNITY_TOSTANDARD_OFFSET UNITYSDK_OFFSET(0x1A217360)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CREATEPACKER_OFFSET UNITYSDK_OFFSET(0x1A215280)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_CREATETEXTUREPACKER_OFFSET UNITYSDK_OFFSET(0x1A2168E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_FILLATLASPACKINGRESULTAUXILLARYDATA_OFFSET UNITYSDK_OFFSET(0x1A214610)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_FILLRESULTATLASESANDRECTS_OFFSET UNITYSDK_OFFSET(0x1A214CF0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GENERATEREPORT_OFFSET UNITYSDK_OFFSET(0x1A215530)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETADJUSTEDFORSCALEANDOFFSET2DIMENSIONS_OFFSET UNITYSDK_OFFSET(0x1A216A30)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETMATERIALSCALEANDOFFSET_OFFSET UNITYSDK_OFFSET(0x1A217440)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETSUBMESHAREA_OFFSET UNITYSDK_OFFSET(0x1A217580)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_GETTEXTURECONSIDERINGSTANDARDSHADERKEYWORDS_OFFSET UNITYSDK_OFFSET(0x1A213AA0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_ISPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1A2177E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE_RUNTEXTUREPACKERONLY_OFFSET UNITYSDK_OFFSET(0x1A2144A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A217800)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__COLLECTPROPERTYNAMES_1_OFFSET UNITYSDK_OFFSET(0x1A213550)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__COLLECTPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1A2134C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2177F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__DOANYSRCMATSHAVEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A213480)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE__SHOULDWECREATEATLASFORTHISPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A211690)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE___STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A213BE0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE___STEP3_BUILDANDSAVEATLASESANDSTORERESULTS_OFFSET UNITYSDK_OFFSET(0x1A215470)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPipeline_TypeDefinitionIndex = 81398;
	...
	public:
		...
		{
			return (::Il2CppArray<::DigitalOpus::MB::Core::ShaderTextureProperty*>**)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombinerPipeline_TypeDefinitionIndex)->GetStaticField(0x46760);
		}
		static ::System::Boolean* StaticGet_USE_EXPERIMENTAL_HOIZONTALVERTICAL()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombinerPipeline_TypeDefinitionIndex)->GetStaticField(0x119D0);
		}
