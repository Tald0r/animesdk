...
#define DIGITALOPUS_MB_CORE_DRECT_ENCLOSES_OFFSET UNITYSDK_OFFSET(0x94D910)
#define DIGITALOPUS_MB_CORE_DRECT_EQUALS_OFFSET UNITYSDK_OFFSET(0x94D8B0)
#define DIGITALOPUS_MB_CORE_DRECT_EXPAND_OFFSET UNITYSDK_OFFSET(0x94D8D0)
#define DIGITALOPUS_MB_CORE_DRECT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x94D9A0)
#define DIGITALOPUS_MB_CORE_DRECT_GETRECT_OFFSET UNITYSDK_OFFSET(0x94D7F0)
#define DIGITALOPUS_MB_CORE_DRECT_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x94D890)
#define DIGITALOPUS_MB_CORE_DRECT_GET_MAXD_OFFSET UNITYSDK_OFFSET(0x94D810)
#define DIGITALOPUS_MB_CORE_DRECT_GET_MAX_OFFSET UNITYSDK_OFFSET(0x94D830)
#define DIGITALOPUS_MB_CORE_DRECT_GET_MIND_OFFSET UNITYSDK_OFFSET(0x2CA610)
#define DIGITALOPUS_MB_CORE_DRECT_GET_MIN_OFFSET UNITYSDK_OFFSET(0x925CE0)
#define DIGITALOPUS_MB_CORE_DRECT_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x94D860)
#define DIGITALOPUS_MB_CORE_DRECT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A942660)
#define DIGITALOPUS_MB_CORE_DRECT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A9426C0)
#define DIGITALOPUS_MB_CORE_DRECT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x94D8C0)
#define DIGITALOPUS_MB_CORE_DRECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x94D790)
#define DIGITALOPUS_MB_CORE_DRECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8E7C80)
#define DIGITALOPUS_MB_CORE_DRECT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x94D7D0)
#define DIGITALOPUS_MB_CORE_DRECT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x8C5470)
#define DIGITALOPUS_MB_CORE_DRECT__CTOR_OFFSET UNITYSDK_OFFSET(0x94D780)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int DRect_TypeDefinitionIndex = 81312;
