...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x1B285440)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1B284C40)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_FILTERINTOGROUPS_OFFSET UNITYSDK_OFFSET(0x1B283E90)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1B285A30)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_MAXINDEXINVECTOR3_OFFSET UNITYSDK_OFFSET(0x1B285A00)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B285A40)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperPie_TypeDefinitionIndex = 83269;
