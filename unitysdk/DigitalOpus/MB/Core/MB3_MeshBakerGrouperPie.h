...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x1AC6BED0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1AC6B6D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_FILTERINTOGROUPS_OFFSET UNITYSDK_OFFSET(0x1AC6A920)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1AC6C4C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE_MAXINDEXINVECTOR3_OFFSET UNITYSDK_OFFSET(0x1AC6C490)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERPIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC6C4D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperPie_TypeDefinitionIndex = 81228;
