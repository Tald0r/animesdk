...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_CEILTONEARESTPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1A310690)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_CONVERTTORECTSWITHOUTPADDINGANDNORMALIZE01_OFFSET UNITYSDK_OFFSET(0x1A310DB0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_ROUNDTONEARESTPOSITIVEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1A3105B0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_SCALEATLASTOFITMAXDIM_OFFSET UNITYSDK_OFFSET(0x1A3106D0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A311070)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePacker_TypeDefinitionIndex = 83373;
	...
	public:
		...
		::System::Boolean atlasMustBePowerOfTwo; // 0x14
