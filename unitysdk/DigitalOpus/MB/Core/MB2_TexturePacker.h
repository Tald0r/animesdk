...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_CEILTONEARESTPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x19D52210)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_CONVERTTORECTSWITHOUTPADDINGANDNORMALIZE01_OFFSET UNITYSDK_OFFSET(0x19D52930)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_ROUNDTONEARESTPOSITIVEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x19D52130)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_SCALEATLASTOFITMAXDIM_OFFSET UNITYSDK_OFFSET(0x19D52250)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D52BF0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePacker_TypeDefinitionIndex = 81332;
