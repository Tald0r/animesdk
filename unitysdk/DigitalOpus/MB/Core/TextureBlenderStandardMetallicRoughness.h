...
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERSTANDARDMETALLICROUGHNESS_DOESSHADERNAMEMATCH_OFFSET UNITYSDK_OFFSET(0x19D6C930)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERSTANDARDMETALLICROUGHNESS_GETCOLORIFNOTEXTURE_OFFSET UNITYSDK_OFFSET(0x19D6DB60)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERSTANDARDMETALLICROUGHNESS_NONTEXTUREPROPERTIESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x19D6CFB0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERSTANDARDMETALLICROUGHNESS_ONBEFORETINTTEXTURE_OFFSET UNITYSDK_OFFSET(0x19D6C9A0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERSTANDARDMETALLICROUGHNESS_ONBLENDTEXTUREPIXEL_OFFSET UNITYSDK_OFFSET(0x19D6CE50)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERSTANDARDMETALLICROUGHNESS_SETNONTEXTUREPROPERTYVALUESONRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x19D6D4E0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERSTANDARDMETALLICROUGHNESS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19D6E4E0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERSTANDARDMETALLICROUGHNESS__CTOR_OFFSET UNITYSDK_OFFSET(0x19D6E3C0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int TextureBlenderStandardMetallicRoughness_TypeDefinitionIndex = 81243;
	...
	public:
		...
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(TextureBlenderStandardMetallicRoughness_TypeDefinitionIndex)->GetStaticField(0x11A00);
		}
		...
		::System::Single m_roughness; // 0x20
		::UnityEngine::Color m_notGeneratingAtlasDefaultColor; // 0x24
		::UnityEngine::Color m_generatingTintedAtlasColor; // 0x34
		::System::Single m_notGeneratingAtlasDefaultMetallic; // 0x44
		::System::Single m_bumpScale; // 0x48
		::System::Single m_generatingTintedAtlasRoughness; // 0x4C
		::UnityEngine::Color m_notGeneratingAtlasDefaultEmisionColor; // 0x50
		::DigitalOpus::MB::Core::TextureBlenderStandardMetallicRoughness_Prop propertyToDo; // 0x60
		::UnityEngine::Color m_generatingTintedAtlasEmission; // 0x64
		::System::Single m_generatingTintedAtlasBumpScale; // 0x74
		::System::Single m_metallic; // 0x78
		::UnityEngine::Color m_emissionColor; // 0x7C
		::System::Boolean m_hasSpecGlossMap; // 0x8C
		::System::Boolean m_shaderDoesEmission; // 0x8D
		::System::Boolean m_hasMetallicGlossMap; // 0x8E
		::UnityEngine::Color m_tintColor; // 0x90
