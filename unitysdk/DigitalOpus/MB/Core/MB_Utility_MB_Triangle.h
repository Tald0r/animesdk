...
#define DIGITALOPUS_MB_CORE_MB_UTILITY_MB_TRIANGLE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A9611C0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_MB_TRIANGLE_ISSAME_OFFSET UNITYSDK_OFFSET(0x1A960EB0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_MB_TRIANGLE_SHARESVERTS_OFFSET UNITYSDK_OFFSET(0x1A961020)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_MB_TRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9612E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_Utility_MB_Triangle_TypeDefinitionIndex = 81328;
