...
#define DIGITALOPUS_MB_CORE_SERIALIZABLESOURCEBLENDSHAPE2COMBINED_DEBUGPRINT_OFFSET UNITYSDK_OFFSET(0x1A90F610)
#define DIGITALOPUS_MB_CORE_SERIALIZABLESOURCEBLENDSHAPE2COMBINED_GENERATEMAPFROMSERIALIZEDDATA_OFFSET UNITYSDK_OFFSET(0x1A90FA50)
#define DIGITALOPUS_MB_CORE_SERIALIZABLESOURCEBLENDSHAPE2COMBINED_SETBUFFERS_OFFSET UNITYSDK_OFFSET(0x1A90F5F0)
#define DIGITALOPUS_MB_CORE_SERIALIZABLESOURCEBLENDSHAPE2COMBINED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A90FDF0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int SerializableSourceBlendShape2Combined_TypeDefinitionIndex = 83365;
