...
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK_DOESSHADERNAMEMATCH_OFFSET UNITYSDK_OFFSET(0x1ACDEF70)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK_GETCOLORIFNOTEXTURE_OFFSET UNITYSDK_OFFSET(0x1ACDF390)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK_NONTEXTUREPROPERTIESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x1ACDF0C0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK_ONBEFORETINTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1ACDEF80)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK_ONBLENDTEXTUREPIXEL_OFFSET UNITYSDK_OFFSET(0x1ACDF090)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK_SETNONTEXTUREPROPERTYVALUESONRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1ACDF2C0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK__COMPARECOLOR_OFFSET UNITYSDK_OFFSET(0x1ACDF190)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK__COMPAREFLOAT_OFFSET UNITYSDK_OFFSET(0x1ACDFD70)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACDFE30)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int TextureBlenderFallback_TypeDefinitionIndex = 81233;
