...
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK_DOESSHADERNAMEMATCH_OFFSET UNITYSDK_OFFSET(0x1B302C70)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK_GETCOLORIFNOTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B303090)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK_NONTEXTUREPROPERTIESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x1B302DC0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK_ONBEFORETINTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1B302C80)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK_ONBLENDTEXTUREPIXEL_OFFSET UNITYSDK_OFFSET(0x1B302D90)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK_SETNONTEXTUREPROPERTYVALUESONRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B302FC0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK__COMPARECOLOR_OFFSET UNITYSDK_OFFSET(0x1B302E90)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK__COMPAREFLOAT_OFFSET UNITYSDK_OFFSET(0x1B303A70)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERFALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B303B30)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int TextureBlenderFallback_TypeDefinitionIndex = 83274;

	class TextureBlenderFallback : public ::System::Object
	{
	public:
		::UnityEngine::Color m_defaultColor; // 0x10
		::System::Boolean m_doTintColor; // 0x20
