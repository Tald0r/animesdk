...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2__CREATEATLASES_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A7C8410)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2__CREATEATLASES_D__6_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7CA0B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2__CREATEATLASES_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7CA110)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2__CREATEATLASES_D__6_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A7CA0C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2__CREATEATLASES_D__6_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7C8400)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2__CREATEATLASES_D__6__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7C83F0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerFastV2__CreateAtlases_d__6_TypeDefinitionIndex = 83425;
	...
	public:
		...
		::DigitalOpus::MB::Core::MB3_TextureCombinerPackerMeshBakerFastV2* __4__this; // 0x48
