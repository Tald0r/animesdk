...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_ALLOCATEBLENDSHAPEARRAYIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1A95A020)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_APPLYBLENDSHAPEFRAMESTOMESHANDBUILDMAP_MERGEBLENDSHAPESWITHTHESAMENAME_OFFSET UNITYSDK_OFFSET(0x1A95A590)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_APPLYBLENDSHAPEFRAMESTOMESHANDBUILDMAP_OFFSET UNITYSDK_OFFSET(0x1A958F40)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_ASSIGNNEWBLENDSHAPESTOCOMBINERIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1A95A120)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_COPYBLENDSHAPESFORNEWMESHIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1A95A360)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_COPYBLENDSHAPESINCURRENTMESHIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1A95A230)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A9585B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A958590)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_GETBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1A9585E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__BUILDSRCSHAPE2COMBINEDMAP_OFFSET UNITYSDK_OFFSET(0x1A959B90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__CONVERTBLENDSHAPENAMETOOUTPUTNAME_OFFSET UNITYSDK_OFFSET(0x1A959A80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9585D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__ZEROARRAY_OFFSET UNITYSDK_OFFSET(0x1A959B20)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MB_MeshCombinerSingle_BlendShapeProcessor_TypeDefinitionIndex = 81287;
