...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_ALLOCATEBLENDSHAPEARRAYIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1AF369C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_APPLYBLENDSHAPEFRAMESTOMESHANDBUILDMAP_MERGEBLENDSHAPESWITHTHESAMENAME_OFFSET UNITYSDK_OFFSET(0x1AF36F30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_APPLYBLENDSHAPEFRAMESTOMESHANDBUILDMAP_OFFSET UNITYSDK_OFFSET(0x1AF358E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_ASSIGNNEWBLENDSHAPESTOCOMBINERIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1AF36AC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_COPYBLENDSHAPESFORNEWMESHIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1AF36D00)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_COPYBLENDSHAPESINCURRENTMESHIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1AF36BD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1AF34F50)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AF34F30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR_GETBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1AF34F80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__BUILDSRCSHAPE2COMBINEDMAP_OFFSET UNITYSDK_OFFSET(0x1AF36530)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__CONVERTBLENDSHAPENAMETOOUTPUTNAME_OFFSET UNITYSDK_OFFSET(0x1AF36420)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF34F70)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BLENDSHAPEPROCESSOR__ZEROARRAY_OFFSET UNITYSDK_OFFSET(0x1AF364C0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MB_MeshCombinerSingle_BlendShapeProcessor_TypeDefinitionIndex = 83328;
