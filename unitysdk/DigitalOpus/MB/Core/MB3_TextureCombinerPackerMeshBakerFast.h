...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFAST_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1B302640)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFAST_CONVERTTEXTURESTOREADABLEFORMATS_OFFSET UNITYSDK_OFFSET(0x1B302600)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFAST_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1B302650)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFAST_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1B3025F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFAST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3026F0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerFast_TypeDefinitionIndex = 83420;
