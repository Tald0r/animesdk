...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_NONTEXTUREPROPERTIESBLENDPROPS_ADJUSTNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AACCC80)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_NONTEXTUREPROPERTIESBLENDPROPS_GETCOLORASITWOULDAPPEARINATLASIFNOTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AACCF60)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_NONTEXTUREPROPERTIESBLENDPROPS_GETCOLORFORTEMPORARYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1AACD150)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_NONTEXTUREPROPERTIESBLENDPROPS_NONTEXTUREPROPERTIESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x1AACC5E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_NONTEXTUREPROPERTIESBLENDPROPS_TINTTEXTUREWITHTEXTURECOMBINER_OFFSET UNITYSDK_OFFSET(0x1AACC6D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_NONTEXTUREPROPERTIESBLENDPROPS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AACC5D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerNonTextureProperties_NonTexturePropertiesBlendProps_TypeDefinitionIndex = 81375;
