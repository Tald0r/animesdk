...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_BUILDCLUSTERS_OFFSET UNITYSDK_OFFSET(0x1A9534D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1A954430)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_FILTERINTOGROUPS_OFFSET UNITYSDK_OFFSET(0x1A953080)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1A9545B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER__BUILDLISTOFCLUSTERSTODRAW_OFFSET UNITYSDK_OFFSET(0x1A953AE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9545C0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperCluster_TypeDefinitionIndex = 83270;
