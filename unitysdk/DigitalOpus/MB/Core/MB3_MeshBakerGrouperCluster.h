...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_BUILDCLUSTERS_OFFSET UNITYSDK_OFFSET(0x1A380490)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1A381400)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_FILTERINTOGROUPS_OFFSET UNITYSDK_OFFSET(0x1A380040)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1A381580)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER__BUILDLISTOFCLUSTERSTODRAW_OFFSET UNITYSDK_OFFSET(0x1A380AB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERCLUSTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A381590)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperCluster_TypeDefinitionIndex = 81229;
