...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT_GETRECTS_1_OFFSET UNITYSDK_OFFSET(0x1AC65CA0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT_GETRECTS_OFFSET UNITYSDK_OFFSET(0x1AC65BB0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT_POPLARGESTTHATFITS_OFFSET UNITYSDK_OFFSET(0x1AC68EA0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC68FB0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT__GETRECTSMULTIATLASHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1AC66C90)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT__GETRECTSMULTIATLASVERTICAL_OFFSET UNITYSDK_OFFSET(0x1AC66000)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT__GETRECTSSINGLEATLAS_OFFSET UNITYSDK_OFFSET(0x1AC67970)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePackerHorizontalVert_TypeDefinitionIndex = 81343;
