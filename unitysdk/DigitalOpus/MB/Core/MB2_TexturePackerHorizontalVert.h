...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT_GETRECTS_1_OFFSET UNITYSDK_OFFSET(0x1B27F230)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT_GETRECTS_OFFSET UNITYSDK_OFFSET(0x1B27F140)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT_POPLARGESTTHATFITS_OFFSET UNITYSDK_OFFSET(0x1B282410)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B282520)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT__GETRECTSMULTIATLASHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1B280200)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT__GETRECTSMULTIATLASVERTICAL_OFFSET UNITYSDK_OFFSET(0x1B27F590)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERHORIZONTALVERT__GETRECTSSINGLEATLAS_OFFSET UNITYSDK_OFFSET(0x1B280EE0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePackerHorizontalVert_TypeDefinitionIndex = 83384;
