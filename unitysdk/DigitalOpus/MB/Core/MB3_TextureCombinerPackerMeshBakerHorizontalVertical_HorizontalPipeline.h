...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE_GETEDGE2EDGETREATMENT_OFFSET UNITYSDK_OFFSET(0x1ACDEAD0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE_GETEXTRAROOMFORREGULARATLAS_OFFSET UNITYSDK_OFFSET(0x1ACDEC60)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE_GETPACKINGALG_OFFSET UNITYSDK_OFFSET(0x1ACDEA00)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE_INITIALIZEATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1ACDEAE0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE_MERGEATLASPACKINGRESULTSTACKBONAINTERNAL_OFFSET UNITYSDK_OFFSET(0x1ACDEAF0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE_SORTTEXSETINTOBINS_OFFSET UNITYSDK_OFFSET(0x1ACDEA10)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_HORIZONTALPIPELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACDEC80)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerHorizontalVertical_HorizontalPipeline_TypeDefinitionIndex = 81391;
