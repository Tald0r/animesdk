...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSETTINGS_GETMESHBAKERSETTINGSASSERIALIZEDPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B6F0B90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSETTINGS_GETMESHBAKERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B6F0B80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F0BA0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSettings_TypeDefinitionIndex = 83326;
