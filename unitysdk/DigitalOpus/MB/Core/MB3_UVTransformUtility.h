...
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_COMBINETRANSFORMS_1_OFFSET UNITYSDK_OFFSET(0x1ABFA0E0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_COMBINETRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1ABFA060)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_GETENCAPSULATINGRECTSHIFTED_OFFSET UNITYSDK_OFFSET(0x1ABFA280)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_GETENCAPSULATINGRECT_OFFSET UNITYSDK_OFFSET(0x1ABFA420)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_GETSHIFTTRANSFORMTOFITBINA_OFFSET UNITYSDK_OFFSET(0x1ABFA110)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_INVERSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1ABFA030)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_LINESEGMENTCONTAINSSHIFTED_OFFSET UNITYSDK_OFFSET(0x1ABFA840)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINSSHIFTED_1_OFFSET UNITYSDK_OFFSET(0x1ABFA640)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINSSHIFTED_OFFSET UNITYSDK_OFFSET(0x1ABFA460)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1ABFA790)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINS_OFFSET UNITYSDK_OFFSET(0x1ABFA900)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TEST_OFFSET UNITYSDK_OFFSET(0x1ABF9BE0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TRANSFORMPOINT_1_OFFSET UNITYSDK_OFFSET(0x1ABFA9B0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1ABFA090)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TRANSFORMX_OFFSET UNITYSDK_OFFSET(0x1ABFA0D0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABFA9D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_UVTransformUtility_TypeDefinitionIndex = 83354;
