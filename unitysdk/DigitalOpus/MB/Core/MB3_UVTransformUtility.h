...
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_COMBINETRANSFORMS_1_OFFSET UNITYSDK_OFFSET(0x1A64EE70)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_COMBINETRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1A64EDF0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_GETENCAPSULATINGRECTSHIFTED_OFFSET UNITYSDK_OFFSET(0x1A64F010)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_GETENCAPSULATINGRECT_OFFSET UNITYSDK_OFFSET(0x1A64F1B0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_GETSHIFTTRANSFORMTOFITBINA_OFFSET UNITYSDK_OFFSET(0x1A64EEA0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_INVERSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A64EDC0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_LINESEGMENTCONTAINSSHIFTED_OFFSET UNITYSDK_OFFSET(0x1A64F5D0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINSSHIFTED_1_OFFSET UNITYSDK_OFFSET(0x1A64F3D0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINSSHIFTED_OFFSET UNITYSDK_OFFSET(0x1A64F1F0)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1A64F520)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_RECTCONTAINS_OFFSET UNITYSDK_OFFSET(0x1A64F690)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TEST_OFFSET UNITYSDK_OFFSET(0x1A64E970)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TRANSFORMPOINT_1_OFFSET UNITYSDK_OFFSET(0x1A64F740)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1A64EE20)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY_TRANSFORMX_OFFSET UNITYSDK_OFFSET(0x1A64EE60)
#define DIGITALOPUS_MB_CORE_MB3_UVTRANSFORMUTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A64F760)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_UVTransformUtility_TypeDefinitionIndex = 81313;
