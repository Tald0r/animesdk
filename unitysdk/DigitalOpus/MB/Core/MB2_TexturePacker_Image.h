...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_IMAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AECDA50)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKER_IMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECDA10)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePacker_Image_TypeDefinitionIndex = 83376;
