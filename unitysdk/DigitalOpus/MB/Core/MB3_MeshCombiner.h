...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_APPLY_OFFSET UNITYSDK_OFFSET(0x1B286930)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_DISPOSERUNTIMECREATED_OFFSET UNITYSDK_OFFSET(0x1B2868B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B286900)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B2868D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_DOUV2_OFFSET UNITYSDK_OFFSET(0x1B2862F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_ASSIGNTOMESHCUSTOMIZER_OFFSET UNITYSDK_OFFSET(0x1B286720)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_BAKESTATUS_OFFSET UNITYSDK_OFFSET(0x1B285A60)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_CLEARBUFFERSAFTERBAKE_OFFSET UNITYSDK_OFFSET(0x1B286660)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_DOBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1B2865F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_DOCOL_OFFSET UNITYSDK_OFFSET(0x1B286290)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_DONORM_OFFSET UNITYSDK_OFFSET(0x1B286250)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_DOTAN_OFFSET UNITYSDK_OFFSET(0x1B286270)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_DOUV1_OFFSET UNITYSDK_OFFSET(0x1B2862D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_DOUV3_OFFSET UNITYSDK_OFFSET(0x1B286530)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_DOUV4_OFFSET UNITYSDK_OFFSET(0x1B286550)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_DOUV5_OFFSET UNITYSDK_OFFSET(0x1B286570)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_DOUV6_OFFSET UNITYSDK_OFFSET(0x1B286590)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_DOUV7_OFFSET UNITYSDK_OFFSET(0x1B2865B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_DOUV8_OFFSET UNITYSDK_OFFSET(0x1B2865D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_DOUV_OFFSET UNITYSDK_OFFSET(0x1B2862B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_EVAL_VERSION_OFFSET UNITYSDK_OFFSET(0x1B285A50)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_LIGHTMAPOPTION_OFFSET UNITYSDK_OFFSET(0x1B286230)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_LOG_LEVEL_OFFSET UNITYSDK_OFFSET(0x1B285E90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_MESHAPI_OFFSET UNITYSDK_OFFSET(0x1B2867F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B285A90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_OPTIMIZEAFTERBAKE_OFFSET UNITYSDK_OFFSET(0x1B286680)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_OUTPUTOPTION_OFFSET UNITYSDK_OFFSET(0x1B2861F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_PIVOTLOCATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1B286610)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_PIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x1B286630)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_RENDERTYPE_OFFSET UNITYSDK_OFFSET(0x1B286210)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_RESULTSCENEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B285AD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_SETTINGSHOLDER_OFFSET UNITYSDK_OFFSET(0x1B286010)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1B285EB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_SMRMERGEBLENDSHAPESWITHSAMENAMES_OFFSET UNITYSDK_OFFSET(0x1B286700)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_SMRNOEXTRABONESWHENCOMBININGMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x1B2866E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_TARGETRENDERER_OFFSET UNITYSDK_OFFSET(0x1B285AF0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1B285AB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_UV2UNWRAPPINGPARAMSHARDANGLE_OFFSET UNITYSDK_OFFSET(0x1B2866A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_UV2UNWRAPPINGPARAMSPACKMARGIN_OFFSET UNITYSDK_OFFSET(0x1B2866C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_GET_VALIDATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1B285A70)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x1B2868F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_ASSIGNTOMESHCUSTOMIZER_OFFSET UNITYSDK_OFFSET(0x1B2867A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_CLEARBUFFERSAFTERBAKE_OFFSET UNITYSDK_OFFSET(0x1B286670)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_DOBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1B286600)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_DOCOL_OFFSET UNITYSDK_OFFSET(0x1B2862A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_DONORM_OFFSET UNITYSDK_OFFSET(0x1B286260)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_DOTAN_OFFSET UNITYSDK_OFFSET(0x1B286280)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_DOUV1_OFFSET UNITYSDK_OFFSET(0x1B2862E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_DOUV3_OFFSET UNITYSDK_OFFSET(0x1B286540)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_DOUV4_OFFSET UNITYSDK_OFFSET(0x1B286560)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_DOUV5_OFFSET UNITYSDK_OFFSET(0x1B286580)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_DOUV6_OFFSET UNITYSDK_OFFSET(0x1B2865A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_DOUV7_OFFSET UNITYSDK_OFFSET(0x1B2865C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_DOUV8_OFFSET UNITYSDK_OFFSET(0x1B2865E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_DOUV_OFFSET UNITYSDK_OFFSET(0x1B2862C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_LIGHTMAPOPTION_OFFSET UNITYSDK_OFFSET(0x1B286240)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_LOG_LEVEL_OFFSET UNITYSDK_OFFSET(0x1B285EA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_MESHAPI_OFFSET UNITYSDK_OFFSET(0x1B2868A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B285AA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_OPTIMIZEAFTERBAKE_OFFSET UNITYSDK_OFFSET(0x1B286690)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_OUTPUTOPTION_OFFSET UNITYSDK_OFFSET(0x1B286200)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_PIVOTLOCATIONTYPE_OFFSET UNITYSDK_OFFSET(0x1B286620)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_PIVOTLOCATION_OFFSET UNITYSDK_OFFSET(0x1B286650)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_RENDERTYPE_OFFSET UNITYSDK_OFFSET(0x1B286220)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_RESULTSCENEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B285AE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_SETTINGSHOLDER_OFFSET UNITYSDK_OFFSET(0x1B286110)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_SMRMERGEBLENDSHAPESWITHSAMENAMES_OFFSET UNITYSDK_OFFSET(0x1B286710)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_SMRNOEXTRABONESWHENCOMBININGMESHRENDERERS_OFFSET UNITYSDK_OFFSET(0x1B2866F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_TARGETRENDERER_OFFSET UNITYSDK_OFFSET(0x1B285B00)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1B285AC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_UV2UNWRAPPINGPARAMSHARDANGLE_OFFSET UNITYSDK_OFFSET(0x1B2866B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_UV2UNWRAPPINGPARAMSPACKMARGIN_OFFSET UNITYSDK_OFFSET(0x1B2866D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_SET_VALIDATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1B285A80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_UPDATEGAMEOBJECTS_1_OFFSET UNITYSDK_OFFSET(0x1B2869C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1B286950)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBONESSTATIC_OFFSET UNITYSDK_OFFSET(0x1B286A30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBOUNDSSTATIC_OFFSET UNITYSDK_OFFSET(0x1B286E10)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER__CREATETEMPORARYTEXTRUEBAKERESULT_OFFSET UNITYSDK_OFFSET(0x1B287110)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B287200)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombiner_TypeDefinitionIndex = 83319;
