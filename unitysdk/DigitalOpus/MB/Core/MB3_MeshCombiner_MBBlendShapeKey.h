...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_MBBLENDSHAPEKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1ACDE6D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_MBBLENDSHAPEKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1ACDE800)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_MBBLENDSHAPEKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACDE6C0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombiner_MBBlendShapeKey_TypeDefinitionIndex = 81281;
