...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_MBBLENDSHAPEKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B3023D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_MBBLENDSHAPEKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B302500)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINER_MBBLENDSHAPEKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3023C0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombiner_MBBlendShapeKey_TypeDefinitionIndex = 83322;
