...
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS_ADDNINESLICEDRECT_OFFSET UNITYSDK_OFFSET(0x1B2834B0)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS_ADDQUAD_OFFSET UNITYSDK_OFFSET(0x1B283C30)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS_BUILDATLAS_OFFSET UNITYSDK_OFFSET(0x1B282530)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS_CONFIGUREMATERIAL_DEFAULTPIPELINE_OFFSET UNITYSDK_OFFSET(0x1B283AA0)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B283E80)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_AtlasPackerRenderTextureUsingMesh_MeshAtlas_TypeDefinitionIndex = 83428;
