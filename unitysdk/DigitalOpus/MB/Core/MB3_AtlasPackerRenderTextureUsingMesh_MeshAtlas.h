...
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS_ADDNINESLICEDRECT_OFFSET UNITYSDK_OFFSET(0x1AC69F40)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS_ADDQUAD_OFFSET UNITYSDK_OFFSET(0x1AC6A6C0)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS_BUILDATLAS_OFFSET UNITYSDK_OFFSET(0x1AC68FC0)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS_CONFIGUREMATERIAL_DEFAULTPIPELINE_OFFSET UNITYSDK_OFFSET(0x1AC6A530)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_MESHATLAS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC6A910)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_AtlasPackerRenderTextureUsingMesh_MeshAtlas_TypeDefinitionIndex = 81387;
