...
#define DIGITALOPUS_MB_CORE_MESHBAKERSETTINGSUTILITY_DOUV2GETDATAFROMSOURCEMESHES_OFFSET UNITYSDK_OFFSET(0x1ACAB480)
#define DIGITALOPUS_MB_CORE_MESHBAKERSETTINGSUTILITY_GETMESHCHANNELSASFLAGS_OFFSET UNITYSDK_OFFSET(0x1ACAACA0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MeshBakerSettingsUtility_TypeDefinitionIndex = 81322;
