...
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0DFB50)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0DFBB0)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0DF5B0)
#define DIGITALOPUS_MB_CORE_PROGRESSUPDATEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0DF5A0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int ProgressUpdateDelegate_TypeDefinitionIndex = 81251;
