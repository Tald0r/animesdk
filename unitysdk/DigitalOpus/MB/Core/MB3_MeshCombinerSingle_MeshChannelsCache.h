...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_COLLECTCHANNELDATAFORALLMESHESINLIST_OFFSET UNITYSDK_OFFSET(0x1ABF54C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1ABF44C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ABF44A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETBINDPOSES_OFFSET UNITYSDK_OFFSET(0x1ABF6FA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1ABF7350)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETBONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1ABF71B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETCOLORS_OFFSET UNITYSDK_OFFSET(0x1ABF5340)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETNORMALS_OFFSET UNITYSDK_OFFSET(0x1ABF4A30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETTANGENTS_OFFSET UNITYSDK_OFFSET(0x1ABF4BB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETUV0MODIFIED_OFFSET UNITYSDK_OFFSET(0x1ABF4D30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETUV0RAW_OFFSET UNITYSDK_OFFSET(0x1ABF4660)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETUV2MODIFIED_OFFSET UNITYSDK_OFFSET(0x1ABF4EB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETUVCHANNEL_OFFSET UNITYSDK_OFFSET(0x1ABF5030)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETVERTICES_OFFSET UNITYSDK_OFFSET(0x1ABF47E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_HASCOLLECTEDMESHDATA_OFFSET UNITYSDK_OFFSET(0x1ABF4620)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_HASOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1ABF4630)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABF43E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GENERATETANGENTS_OFFSET UNITYSDK_OFFSET(0x1ABF7660)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETBINDPOSES_OFFSET UNITYSDK_OFFSET(0x1ABF6A20)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETBONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1ABF6D40)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHCOLORS_OFFSET UNITYSDK_OFFSET(0x1ABF6870)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHNORMALS_OFFSET UNITYSDK_OFFSET(0x1ABF6460)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHTANGENTS_OFFSET UNITYSDK_OFFSET(0x1ABF6670)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHUV2S_OFFSET UNITYSDK_OFFSET(0x1ABF63A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHUVS_OFFSET UNITYSDK_OFFSET(0x1ABF6230)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MeshChannelsCache_TypeDefinitionIndex = 83340;
	...
	public:
		...
		::UnityEngine::Vector2 _HALF_UV; // 0x1C
		::System::Boolean _disposed; // 0x24
		::System::Boolean _collectedMeshData; // 0x25
