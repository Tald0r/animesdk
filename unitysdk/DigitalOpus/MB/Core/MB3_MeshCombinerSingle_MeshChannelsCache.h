...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_COLLECTCHANNELDATAFORALLMESHESINLIST_OFFSET UNITYSDK_OFFSET(0x1A64A250)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A649250)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A649230)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETBINDPOSES_OFFSET UNITYSDK_OFFSET(0x1A64BD10)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1A64C0C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETBONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1A64BF20)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETCOLORS_OFFSET UNITYSDK_OFFSET(0x1A64A0D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETNORMALS_OFFSET UNITYSDK_OFFSET(0x1A6497C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETTANGENTS_OFFSET UNITYSDK_OFFSET(0x1A649940)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETUV0MODIFIED_OFFSET UNITYSDK_OFFSET(0x1A649AC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETUV0RAW_OFFSET UNITYSDK_OFFSET(0x1A6493F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETUV2MODIFIED_OFFSET UNITYSDK_OFFSET(0x1A649C40)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETUVCHANNEL_OFFSET UNITYSDK_OFFSET(0x1A649DC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_GETVERTICES_OFFSET UNITYSDK_OFFSET(0x1A649570)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_HASCOLLECTEDMESHDATA_OFFSET UNITYSDK_OFFSET(0x1A6493B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE_HASOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1A6493C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A649180)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GENERATETANGENTS_OFFSET UNITYSDK_OFFSET(0x1A64C3E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETBINDPOSES_OFFSET UNITYSDK_OFFSET(0x1A64B790)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETBONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x1A64BAB0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHCOLORS_OFFSET UNITYSDK_OFFSET(0x1A64B5E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHNORMALS_OFFSET UNITYSDK_OFFSET(0x1A64B1D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHTANGENTS_OFFSET UNITYSDK_OFFSET(0x1A64B3E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHUV2S_OFFSET UNITYSDK_OFFSET(0x1A64B110)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MESHCHANNELSCACHE__GETMESHUVS_OFFSET UNITYSDK_OFFSET(0x1A64AFB0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MeshChannelsCache_TypeDefinitionIndex = 81299;
