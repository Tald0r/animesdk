...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_SUBCOMBINER_APPLYSHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1A348AA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_SUBCOMBINER_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1A3489E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_SUBCOMBINER_APPLY_2_OFFSET UNITYSDK_OFFSET(0x1A3450A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_SUBCOMBINER_APPLY_OFFSET UNITYSDK_OFFSET(0x1A344740)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_SUBCOMBINER_INSTANCE2COMBINED_MAPADD_OFFSET UNITYSDK_OFFSET(0x1A340360)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_SUBCOMBINER_INSTANCE2COMBINED_MAPREMOVE_OFFSET UNITYSDK_OFFSET(0x1A3403F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_SUBCOMBINER__ADDTOCOMBINED_OFFSET UNITYSDK_OFFSET(0x1A340540)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_SUBCOMBINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3493E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_SUBCOMBINER__SHOWHIDEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A340450)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_SUBCOMBINER__UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A343DA0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MB_MeshCombinerSingle_SubCombiner_TypeDefinitionIndex = 81301;
