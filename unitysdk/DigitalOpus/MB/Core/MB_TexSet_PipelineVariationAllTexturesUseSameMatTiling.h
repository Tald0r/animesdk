...
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING_ADJUSTRESULTMATERIALNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AACD9D0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING_GETMATERIALTILINGRECTFORTEXTUREBAKERRESULTS_OFFSET UNITYSDK_OFFSET(0x1AACD920)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING_GETRECTSFORTEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1AACD670)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING_SETTILINGTREATMENTANDADJUSTENCAPSULATINGSAMPLINGRECT_OFFSET UNITYSDK_OFFSET(0x1AACD780)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING__CTOR_OFFSET UNITYSDK_OFFSET(0x1AACD660)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TexSet_PipelineVariationAllTexturesUseSameMatTiling_TypeDefinitionIndex = 81362;
