...
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING_ADJUSTRESULTMATERIALNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B111AC0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING_GETMATERIALTILINGRECTFORTEXTUREBAKERRESULTS_OFFSET UNITYSDK_OFFSET(0x1B111A10)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING_GETRECTSFORTEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1B111760)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING_SETTILINGTREATMENTANDADJUSTENCAPSULATINGSAMPLINGRECT_OFFSET UNITYSDK_OFFSET(0x1B111870)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONALLTEXTURESUSESAMEMATTILING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B111750)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TexSet_PipelineVariationAllTexturesUseSameMatTiling_TypeDefinitionIndex = 83403;
