...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR_ADDMESHBAKER_OFFSET UNITYSDK_OFFSET(0x1B301F70)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR_DOCLUSTERING_OFFSET UNITYSDK_OFFSET(0x1B300260)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1B302290)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR_GROUPBYLIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1B301CA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3022A0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperBehaviour_TypeDefinitionIndex = 83265;
