...
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR_ADDMESHBAKER_OFFSET UNITYSDK_OFFSET(0x1ACDE270)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR_DOCLUSTERING_OFFSET UNITYSDK_OFFSET(0x1ACDC550)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR_GETCLUSTERTYPE_OFFSET UNITYSDK_OFFSET(0x1ACDE590)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR_GROUPBYLIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1ACDDFA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHBAKERGROUPERBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACDE5A0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshBakerGrouperBehaviour_TypeDefinitionIndex = 81224;
