...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_DRAWGIZMOSNODE_OFFSET UNITYSDK_OFFSET(0x1A379E80)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1A37A170)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_FLATTENTREE_OFFSET UNITYSDK_OFFSET(0x1A379CC0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_GETEXTENT_OFFSET UNITYSDK_OFFSET(0x1A37AAE0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_GETRECTS_1_OFFSET UNITYSDK_OFFSET(0x1A37B340)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_GETRECTS_OFFSET UNITYSDK_OFFSET(0x1A37B250)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PRINTTREE_OFFSET UNITYSDK_OFFSET(0x1A379880)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBEMULTIATLAS_OFFSET UNITYSDK_OFFSET(0x1A37ABC0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBESINGLEATLAS_OFFSET UNITYSDK_OFFSET(0x1A37A210)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_STEPWIDTHHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A37B220)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A380030)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR__GETRECTSMULTIATLAS_OFFSET UNITYSDK_OFFSET(0x1A37B680)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR__GETRECTSSINGLEATLAS_OFFSET UNITYSDK_OFFSET(0x1A37D320)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePackerRegular_TypeDefinitionIndex = 81340;
