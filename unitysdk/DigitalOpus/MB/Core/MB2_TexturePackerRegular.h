...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_DRAWGIZMOSNODE_OFFSET UNITYSDK_OFFSET(0x1A94CEB0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_DRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1A94D1B0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_FLATTENTREE_OFFSET UNITYSDK_OFFSET(0x1A94CCF0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_GETEXTENT_OFFSET UNITYSDK_OFFSET(0x1A94DB20)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_GETRECTS_1_OFFSET UNITYSDK_OFFSET(0x1A94E390)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_GETRECTS_OFFSET UNITYSDK_OFFSET(0x1A94E2A0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PRINTTREE_OFFSET UNITYSDK_OFFSET(0x1A94C8B0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBEMULTIATLAS_OFFSET UNITYSDK_OFFSET(0x1A94DC00)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBESINGLEATLAS_OFFSET UNITYSDK_OFFSET(0x1A94D250)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_STEPWIDTHHEIGHT_OFFSET UNITYSDK_OFFSET(0x1A94E270)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A953070)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR__GETRECTSMULTIATLAS_OFFSET UNITYSDK_OFFSET(0x1A94E6D0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR__GETRECTSSINGLEATLAS_OFFSET UNITYSDK_OFFSET(0x1A950360)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePackerRegular_TypeDefinitionIndex = 83381;
