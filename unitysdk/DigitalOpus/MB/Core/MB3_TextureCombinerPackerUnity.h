...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x19D63E40)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x19D63F20)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_GETADJUSTEDFORSCALEANDOFFSET2_OFFSET UNITYSDK_OFFSET(0x19D646F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_VALIDATE_OFFSET UNITYSDK_OFFSET(0x19D63E30)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY__COPYTEXTURESINTOATLAS_OFFSET UNITYSDK_OFFSET(0x19D63FC0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY__CTOR_OFFSET UNITYSDK_OFFSET(0x19D64FA0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerUnity_TypeDefinitionIndex = 81396;
