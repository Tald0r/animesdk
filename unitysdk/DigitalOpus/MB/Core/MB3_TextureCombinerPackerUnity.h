...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1A3222B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1A322390)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_GETADJUSTEDFORSCALEANDOFFSET2_OFFSET UNITYSDK_OFFSET(0x1A322B60)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A3222A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY__COPYTEXTURESINTOATLAS_OFFSET UNITYSDK_OFFSET(0x1A322430)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERUNITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A323400)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerUnity_TypeDefinitionIndex = 83437;
