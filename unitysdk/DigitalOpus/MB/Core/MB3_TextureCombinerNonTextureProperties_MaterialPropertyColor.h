...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR_GETAVERAGECALCULATOR_OFFSET UNITYSDK_OFFSET(0x1B2872B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR_GETDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1B2872C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B287240)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR_SET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1B287250)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B287260)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerNonTextureProperties_MaterialPropertyColor_TypeDefinitionIndex = 83409;
