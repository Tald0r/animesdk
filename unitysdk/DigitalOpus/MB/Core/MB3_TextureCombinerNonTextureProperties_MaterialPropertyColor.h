...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR_GETAVERAGECALCULATOR_OFFSET UNITYSDK_OFFSET(0x1AC6DD40)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR_GETDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1AC6DD50)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AC6DCD0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR_SET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AC6DCE0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYCOLOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC6DCF0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerNonTextureProperties_MaterialPropertyColor_TypeDefinitionIndex = 81368;
