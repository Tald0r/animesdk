...
#define DIGITALOPUS_MB_CORE_MB_UTILITY_AREALLSHAREDMATERIALSDISTINCT_OFFSET UNITYSDK_OFFSET(0x1A21FAD0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_ARRAYBISSUBSETOFA_OFFSET UNITYSDK_OFFSET(0x1A21DAA0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_BONEWEIGHTTOSTRING_OFFSET UNITYSDK_OFFSET(0x1A220330)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_CONVERTASSETSRELATIVEPATHTOFULLSYSTEMPATH_OFFSET UNITYSDK_OFFSET(0x1A2202B0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_CREATETEXTURECOPY_OFFSET UNITYSDK_OFFSET(0x1A21D930)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_DESTROY_OFFSET UNITYSDK_OFFSET(0x1A213390)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_DISABLERENDERERINSOURCE_OFFSET UNITYSDK_OFFSET(0x1A21EC80)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_DOSUBMESHESSHAREVERTSORTRIS_OFFSET UNITYSDK_OFFSET(0x1A21FC90)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A21FF30)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETGOMATERIALS_OFFSET UNITYSDK_OFFSET(0x1A21DB30)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETMESH_OFFSET UNITYSDK_OFFSET(0x1A21E540)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETRENDERER_OFFSET UNITYSDK_OFFSET(0x1A21EA20)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_1_OFFSET UNITYSDK_OFFSET(0x1A21EFB0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_2_OFFSET UNITYSDK_OFFSET(0x1A21F060)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_3_OFFSET UNITYSDK_OFFSET(0x1A21F2E0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1A21EF00)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_ISSCENEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A2202F0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_RESAMPLETEXTURE_OFFSET UNITYSDK_OFFSET(0x1A21F560)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_SETMESH_OFFSET UNITYSDK_OFFSET(0x1A21E7B0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_SETSOLIDCOLOR_OFFSET UNITYSDK_OFFSET(0x1A21D6A0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A220860)
#define DIGITALOPUS_MB_CORE_MB_UTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A220850)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_Utility_TypeDefinitionIndex = 81326;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MB_Utility_TypeDefinitionIndex)->GetStaticField(0x119F0);
		}
