...
#define DIGITALOPUS_MB_CORE_MB_UTILITY_AREALLSHAREDMATERIALSDISTINCT_OFFSET UNITYSDK_OFFSET(0x1A7D6730)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_ARRAYBISSUBSETOFA_OFFSET UNITYSDK_OFFSET(0x1A7D4700)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_BONEWEIGHTTOSTRING_OFFSET UNITYSDK_OFFSET(0x1A7D6F90)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_CONVERTASSETSRELATIVEPATHTOFULLSYSTEMPATH_OFFSET UNITYSDK_OFFSET(0x1A7D6F10)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_CREATETEXTURECOPY_OFFSET UNITYSDK_OFFSET(0x1A7D4590)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_DESTROY_OFFSET UNITYSDK_OFFSET(0x1A7CA030)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_DISABLERENDERERINSOURCE_OFFSET UNITYSDK_OFFSET(0x1A7D58E0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_DOSUBMESHESSHAREVERTSORTRIS_OFFSET UNITYSDK_OFFSET(0x1A7D68F0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A7D6B90)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETGOMATERIALS_OFFSET UNITYSDK_OFFSET(0x1A7D4790)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETMESH_OFFSET UNITYSDK_OFFSET(0x1A7D51A0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_GETRENDERER_OFFSET UNITYSDK_OFFSET(0x1A7D5680)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_1_OFFSET UNITYSDK_OFFSET(0x1A7D5C10)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_2_OFFSET UNITYSDK_OFFSET(0x1A7D5CC0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_3_OFFSET UNITYSDK_OFFSET(0x1A7D5F40)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_HASOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1A7D5B60)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_ISSCENEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A7D6F50)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_RESAMPLETEXTURE_OFFSET UNITYSDK_OFFSET(0x1A7D61C0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_SETMESH_OFFSET UNITYSDK_OFFSET(0x1A7D5410)
#define DIGITALOPUS_MB_CORE_MB_UTILITY_SETSOLIDCOLOR_OFFSET UNITYSDK_OFFSET(0x1A7D4300)
#define DIGITALOPUS_MB_CORE_MB_UTILITY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7D74C0)
#define DIGITALOPUS_MB_CORE_MB_UTILITY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D74B0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_Utility_TypeDefinitionIndex = 83367;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MB_Utility_TypeDefinitionIndex)->GetStaticField(0x11B00);
		}
