...
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_MATERIALPROPERTYPAIR_EQUALS_OFFSET UNITYSDK_OFFSET(0x97CE00)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_MATERIALPROPERTYPAIR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x97CEA0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_MATERIALPROPERTYPAIR__CTOR_OFFSET UNITYSDK_OFFSET(0x301710)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int TextureBlenderMaterialPropertyCacheHelper_MaterialPropertyPair_TypeDefinitionIndex = 83281;
