...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A3259F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A3283A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A328400)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A3283B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A3259E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3259D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPipeline____Step1_CollectDistinctMatTexturesAndUsedObjects_d__9_TypeDefinitionIndex = 83446;
