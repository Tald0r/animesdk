...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19D675A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19D69F60)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19D69FC0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19D69F70)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19D67590)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x19D67580)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPipeline____Step1_CollectDistinctMatTexturesAndUsedObjects_d__9_TypeDefinitionIndex = 81405;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* usedObjsToMesh; // 0x18
		::System::Object* __2__current; // 0x20
		::DigitalOpus::MB::Core::MB3_TextureCombiner_CombineTexturesIntoAtlasesCoroutineResult* result; // 0x28
