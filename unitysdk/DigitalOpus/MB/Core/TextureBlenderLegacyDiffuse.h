...
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYDIFFUSE_DOESSHADERNAMEMATCH_OFFSET UNITYSDK_OFFSET(0x1A385E40)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYDIFFUSE_GETCOLORIFNOTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A386010)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYDIFFUSE_NONTEXTUREPROPERTIESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x1A385F90)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYDIFFUSE_ONBEFORETINTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A385EE0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYDIFFUSE_ONBLENDTEXTUREPIXEL_OFFSET UNITYSDK_OFFSET(0x1A385F60)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYDIFFUSE_SETNONTEXTUREPROPERTYVALUESONRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A385FC0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYDIFFUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A386110)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int TextureBlenderLegacyDiffuse_TypeDefinitionIndex = 81238;

	class TextureBlenderLegacyDiffuse : public ::System::Object
	{
	public:
		::UnityEngine::Color m_tintColor; // 0x10
		::UnityEngine::Color m_defaultTintColor; // 0x20
