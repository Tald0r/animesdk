...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE___C__DISPLAYCLASS9_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0DF3D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPIPELINE___C__DISPLAYCLASS9_1____STEP1_COLLECTDISTINCTMATTEXTURESANDUSEDOBJECTS_B__0_OFFSET UNITYSDK_OFFSET(0x1B0DF3E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPipeline___c__DisplayClass9_1_TypeDefinitionIndex = 81404;
