...
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_DORENDERATLAS_OFFSET UNITYSDK_OFFSET(0x1ABED880)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABED6A0)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_SETUPCAMERAGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1ABED6C0)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABEE3E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_AtlasPackerRenderTextureUsingMesh_TypeDefinitionIndex = 81385;

	class MB3_AtlasPackerRenderTextureUsingMesh : public ::System::Object
	{
	public:
		::DigitalOpus::MB::Core::MB2_LogLevel LOG_LEVEL; // 0x10
		::System::Int32 camMaskLayer; // 0x14
		::System::Int32 width; // 0x18
		::System::Int32 padding; // 0x1C
		::System::Int32 height; // 0x20
		::System::Boolean _camSetup; // 0x24
		::System::Boolean _initialized; // 0x25
