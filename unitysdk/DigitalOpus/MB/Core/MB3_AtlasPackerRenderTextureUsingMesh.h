...
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_DORENDERATLAS_OFFSET UNITYSDK_OFFSET(0x1B1FE730)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1FE550)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH_SETUPCAMERAGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B1FE570)
#define DIGITALOPUS_MB_CORE_MB3_ATLASPACKERRENDERTEXTUREUSINGMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1FF290)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_AtlasPackerRenderTextureUsingMesh_TypeDefinitionIndex = 83426;

	class MB3_AtlasPackerRenderTextureUsingMesh : public ::System::Object
	{
	public:
		::System::Boolean _initialized; // 0x10
		::System::Boolean _camSetup; // 0x11
