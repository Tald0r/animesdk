...
#define DIGITALOPUS_MB_CORE_MB_TEXSET_ADJUSTRESULTMATERIALNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19D6AFB0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_ALLTEXTURESARESAMEFORMERGE_OFFSET UNITYSDK_OFFSET(0x19D6B7A0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_CALCINITIALFULLSAMPLINGRECTS_OFFSET UNITYSDK_OFFSET(0x19D6B270)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_CALCMATANDUVSAMPLINGRECTS_OFFSET UNITYSDK_OFFSET(0x19D6B560)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_CREATECOLOREDTEXTOREPLACENULL_OFFSET UNITYSDK_OFFSET(0x19D6AEB0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_DRAWRECTSTOMERGEGIZMOS_OFFSET UNITYSDK_OFFSET(0x19D6BC10)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19D6BF00)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETENCAPSULATINGSAMPLINGRECTIFTILINGSAME_OFFSET UNITYSDK_OFFSET(0x19D6AC70)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETMATERIALTILINGRECTFORTEXTUREBAKERRESULTS_OFFSET UNITYSDK_OFFSET(0x19D6B180)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETMATSUBRECTDESCRIPTIONS_OFFSET UNITYSDK_OFFSET(0x19D6C290)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETMAXRAWTEXTUREHEIGHTWIDTH_OFFSET UNITYSDK_OFFSET(0x19D6AA10)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETRECTSFORTEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x19D6B0A0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_ALLTEXTURESUSESAMEMATTILING_OFFSET UNITYSDK_OFFSET(0x19D6A4A0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_OBUVOFFSET_OFFSET UNITYSDK_OFFSET(0x19D6A500)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_OBUVRECT_OFFSET UNITYSDK_OFFSET(0x19D6A540)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_OBUVSCALE_OFFSET UNITYSDK_OFFSET(0x19D6A520)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_THISISONLYTEXSETINATLAS_OFFSET UNITYSDK_OFFSET(0x19D6A4C0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_TILINGTREATMENT_OFFSET UNITYSDK_OFFSET(0x19D6A4E0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_ISEQUAL_OFFSET UNITYSDK_OFFSET(0x19D6A5A0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETALLTEXTURESUSESAMEMATTILINGTRUE_OFFSET UNITYSDK_OFFSET(0x19D6AF60)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETENCAPSULATINGRECT_OFFSET UNITYSDK_OFFSET(0x19D6ADD0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETENCAPSULATINGSAMPLINGRECTFORTESTING_OFFSET UNITYSDK_OFFSET(0x19D6AD80)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETENCAPSULATINGSAMPLINGRECTWHENMERGINGTEXSETS_OFFSET UNITYSDK_OFFSET(0x19D6AD10)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETTHISISONLYTEXSETINATLASTRUE_OFFSET UNITYSDK_OFFSET(0x19D67420)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETTILINGTREATMENTANDADJUSTENCAPSULATINGSAMPLINGRECT_OFFSET UNITYSDK_OFFSET(0x19D67430)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_ALLTEXTURESUSESAMEMATTILING_OFFSET UNITYSDK_OFFSET(0x19D6A4B0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_OBUVOFFSET_OFFSET UNITYSDK_OFFSET(0x19D6A510)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_OBUVSCALE_OFFSET UNITYSDK_OFFSET(0x19D6A530)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_THISISONLYTEXSETINATLAS_OFFSET UNITYSDK_OFFSET(0x19D6A4D0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_TILINGTREATMENT_OFFSET UNITYSDK_OFFSET(0x19D6A4F0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET__CTOR_OFFSET UNITYSDK_OFFSET(0x19D69E10)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TexSet_TypeDefinitionIndex = 81360;
	...
	public:
		...
		::UnityEngine::Vector2 _obUVscale_k__BackingField; // 0x28
		::DigitalOpus::MB::Core::MB_TextureTilingTreatment _tilingTreatment_k__BackingField; // 0x30
		::UnityEngine::Vector2 _obUVoffset_k__BackingField; // 0x34
		::System::Int32 idealHeight_pix; // 0x3C
		::System::Int32 idealWidth_pix; // 0x40
