...
#define DIGITALOPUS_MB_CORE_MB_TEXSET_ADJUSTRESULTMATERIALNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A3293F0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_ALLTEXTURESARESAMEFORMERGE_OFFSET UNITYSDK_OFFSET(0x1A329BE0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_CALCINITIALFULLSAMPLINGRECTS_OFFSET UNITYSDK_OFFSET(0x1A3296B0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_CALCMATANDUVSAMPLINGRECTS_OFFSET UNITYSDK_OFFSET(0x1A3299A0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_CREATECOLOREDTEXTOREPLACENULL_OFFSET UNITYSDK_OFFSET(0x1A3292F0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_DRAWRECTSTOMERGEGIZMOS_OFFSET UNITYSDK_OFFSET(0x1A32A050)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A32A340)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETENCAPSULATINGSAMPLINGRECTIFTILINGSAME_OFFSET UNITYSDK_OFFSET(0x1A3290B0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETMATERIALTILINGRECTFORTEXTUREBAKERRESULTS_OFFSET UNITYSDK_OFFSET(0x1A3295C0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETMATSUBRECTDESCRIPTIONS_OFFSET UNITYSDK_OFFSET(0x1A32A6D0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETMAXRAWTEXTUREHEIGHTWIDTH_OFFSET UNITYSDK_OFFSET(0x1A328E50)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GETRECTSFORTEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1A3294E0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_ALLTEXTURESUSESAMEMATTILING_OFFSET UNITYSDK_OFFSET(0x1A3288E0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_OBUVOFFSET_OFFSET UNITYSDK_OFFSET(0x1A328940)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_OBUVRECT_OFFSET UNITYSDK_OFFSET(0x1A328980)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_OBUVSCALE_OFFSET UNITYSDK_OFFSET(0x1A328960)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_THISISONLYTEXSETINATLAS_OFFSET UNITYSDK_OFFSET(0x1A328900)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_GET_TILINGTREATMENT_OFFSET UNITYSDK_OFFSET(0x1A328920)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_ISEQUAL_OFFSET UNITYSDK_OFFSET(0x1A3289E0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETALLTEXTURESUSESAMEMATTILINGTRUE_OFFSET UNITYSDK_OFFSET(0x1A3293A0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETENCAPSULATINGRECT_OFFSET UNITYSDK_OFFSET(0x1A329210)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETENCAPSULATINGSAMPLINGRECTFORTESTING_OFFSET UNITYSDK_OFFSET(0x1A3291C0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETENCAPSULATINGSAMPLINGRECTWHENMERGINGTEXSETS_OFFSET UNITYSDK_OFFSET(0x1A329150)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETTHISISONLYTEXSETINATLASTRUE_OFFSET UNITYSDK_OFFSET(0x1A325870)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SETTILINGTREATMENTANDADJUSTENCAPSULATINGSAMPLINGRECT_OFFSET UNITYSDK_OFFSET(0x1A325880)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_ALLTEXTURESUSESAMEMATTILING_OFFSET UNITYSDK_OFFSET(0x1A3288F0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_OBUVOFFSET_OFFSET UNITYSDK_OFFSET(0x1A328950)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_OBUVSCALE_OFFSET UNITYSDK_OFFSET(0x1A328970)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_THISISONLYTEXSETINATLAS_OFFSET UNITYSDK_OFFSET(0x1A328910)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_SET_TILINGTREATMENT_OFFSET UNITYSDK_OFFSET(0x1A328930)
#define DIGITALOPUS_MB_CORE_MB_TEXSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A328250)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TexSet_TypeDefinitionIndex = 83401;

	class MB_TexSet : public ::System::Object
	{
	public:
		::DigitalOpus::MB::Core::MatsAndGOs* matsAndGOs; // 0x10
		...
		::System::Int32 idealHeight_pix; // 0x28
		::UnityEngine::Vector2 _obUVoffset_k__BackingField; // 0x2C
		::System::Int32 idealWidth_pix; // 0x34
		::UnityEngine::Vector2 _obUVscale_k__BackingField; // 0x38
		::DigitalOpus::MB::Core::MB_TextureTilingTreatment _tilingTreatment_k__BackingField; // 0x40
		::System::Boolean _allTexturesUseSameMatTiling_k__BackingField; // 0x44
		::System::Boolean _thisIsOnlyTexSetInAtlas_k__BackingField; // 0x45
