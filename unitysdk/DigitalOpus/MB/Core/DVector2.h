...
#define DIGITALOPUS_MB_CORE_DVECTOR2_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1ABF1D10)
#define DIGITALOPUS_MB_CORE_DVECTOR2_GETVECTOR2_OFFSET UNITYSDK_OFFSET(0x953AB0)
#define DIGITALOPUS_MB_CORE_DVECTOR2_ISCONTAINEDINWITHMARGIN_OFFSET UNITYSDK_OFFSET(0x953B20)
#define DIGITALOPUS_MB_CORE_DVECTOR2_ISCONTAINEDIN_OFFSET UNITYSDK_OFFSET(0x953AE0)
#define DIGITALOPUS_MB_CORE_DVECTOR2_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x1ABF1960)
#define DIGITALOPUS_MB_CORE_DVECTOR2_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x953C00)
#define DIGITALOPUS_MB_CORE_DVECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x953B50)
#define DIGITALOPUS_MB_CORE_DVECTOR2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABF1D40)
#define DIGITALOPUS_MB_CORE_DVECTOR2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2EC7B0)
#define DIGITALOPUS_MB_CORE_DVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x76DF80)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int DVector2_TypeDefinitionIndex = 83352;

	struct alignas(8) DVector2
	{
		static ::System::Double* StaticGet_epsilon()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(DVector2_TypeDefinitionIndex)->GetStaticField(0x11A90);
		}
