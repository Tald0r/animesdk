...
#define DIGITALOPUS_MB_CORE_DVECTOR2_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1A646AB0)
#define DIGITALOPUS_MB_CORE_DVECTOR2_GETVECTOR2_OFFSET UNITYSDK_OFFSET(0x925CE0)
#define DIGITALOPUS_MB_CORE_DVECTOR2_ISCONTAINEDINWITHMARGIN_OFFSET UNITYSDK_OFFSET(0x925D50)
#define DIGITALOPUS_MB_CORE_DVECTOR2_ISCONTAINEDIN_OFFSET UNITYSDK_OFFSET(0x925D10)
#define DIGITALOPUS_MB_CORE_DVECTOR2_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x1A646700)
#define DIGITALOPUS_MB_CORE_DVECTOR2_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x925E30)
#define DIGITALOPUS_MB_CORE_DVECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x925D80)
#define DIGITALOPUS_MB_CORE_DVECTOR2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A646AE0)
#define DIGITALOPUS_MB_CORE_DVECTOR2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2FB050)
#define DIGITALOPUS_MB_CORE_DVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x48B8B0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int DVector2_TypeDefinitionIndex = 81311;

	struct alignas(8) DVector2
	{
		static ::System::Double* StaticGet_epsilon()
		{
			return (::System::Double*)Il2CppClass::FromTypeDefinitionIndex(DVector2_TypeDefinitionIndex)->GetStaticField(0x11980);
		}
