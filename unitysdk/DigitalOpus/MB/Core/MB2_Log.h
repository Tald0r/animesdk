...
#define DIGITALOPUS_MB_CORE_MB2_LOG_ERROR_OFFSET UNITYSDK_OFFSET(0x1B2FF740)
#define DIGITALOPUS_MB_CORE_MB2_LOG_INFO_OFFSET UNITYSDK_OFFSET(0x1B2FFA90)
#define DIGITALOPUS_MB_CORE_MB2_LOG_LOGDEBUG_OFFSET UNITYSDK_OFFSET(0x1B2FFC40)
#define DIGITALOPUS_MB_CORE_MB2_LOG_LOG_OFFSET UNITYSDK_OFFSET(0x1B2FF320)
#define DIGITALOPUS_MB_CORE_MB2_LOG_TRACE_OFFSET UNITYSDK_OFFSET(0x1B2FFDF0)
#define DIGITALOPUS_MB_CORE_MB2_LOG_WARN_OFFSET UNITYSDK_OFFSET(0x1B2FF8E0)
#define DIGITALOPUS_MB_CORE_MB2_LOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2FFFA0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_Log_TypeDefinitionIndex = 83306;
