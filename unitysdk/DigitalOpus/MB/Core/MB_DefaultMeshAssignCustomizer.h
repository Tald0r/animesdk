...
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_DEFAULTDELEGATEASSIGNMESHCOLORS_OFFSET UNITYSDK_OFFSET(0x1AC234E0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_COLORS_OFFSET UNITYSDK_OFFSET(0x1AC234B0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV0_OFFSET UNITYSDK_OFFSET(0x1AC23330)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV2_OFFSET UNITYSDK_OFFSET(0x1AC23360)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV3_OFFSET UNITYSDK_OFFSET(0x1AC23390)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV4_OFFSET UNITYSDK_OFFSET(0x1AC233C0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV5_OFFSET UNITYSDK_OFFSET(0x1AC233F0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV6_OFFSET UNITYSDK_OFFSET(0x1AC23420)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV7_OFFSET UNITYSDK_OFFSET(0x1AC23450)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV8_OFFSET UNITYSDK_OFFSET(0x1AC23480)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC23510)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_DefaultMeshAssignCustomizer_TypeDefinitionIndex = 81315;
