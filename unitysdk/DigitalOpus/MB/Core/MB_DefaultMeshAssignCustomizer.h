...
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_DEFAULTDELEGATEASSIGNMESHCOLORS_OFFSET UNITYSDK_OFFSET(0x1B22E9B0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_COLORS_OFFSET UNITYSDK_OFFSET(0x1B22E980)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV0_OFFSET UNITYSDK_OFFSET(0x1B22E800)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV2_OFFSET UNITYSDK_OFFSET(0x1B22E830)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV3_OFFSET UNITYSDK_OFFSET(0x1B22E860)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV4_OFFSET UNITYSDK_OFFSET(0x1B22E890)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV5_OFFSET UNITYSDK_OFFSET(0x1B22E8C0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV6_OFFSET UNITYSDK_OFFSET(0x1B22E8F0)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV7_OFFSET UNITYSDK_OFFSET(0x1B22E920)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER_MESHASSIGN_UV8_OFFSET UNITYSDK_OFFSET(0x1B22E950)
#define DIGITALOPUS_MB_CORE_MB_DEFAULTMESHASSIGNCUSTOMIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22E9E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_DefaultMeshAssignCustomizer_TypeDefinitionIndex = 83356;
