...
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_ADDBLENDSHAPEFRAME_OFFSET UNITYSDK_OFFSET(0x1B22D4C0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_CLEARBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1B22D4A0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_COLLECTPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1B22D610)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_DETECTPIPELINE_OFFSET UNITYSDK_OFFSET(0x1B22E0D0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_DOSPECIALRENDERPIPELINE_TEXTUREPACKERFASTSETUP_OFFSET UNITYSDK_OFFSET(0x1B22E290)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_FINDRUNTIMEMATERIALSFROMADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B22E720)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_FINDSCENEOBJECTSOFTYPE_OFFSET UNITYSDK_OFFSET(0x1B22C580)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETACTIVE_OFFSET UNITYSDK_OFFSET(0x1B22C500)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETBLENDSHAPEFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1B22D400)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETBLENDSHAPEFRAMEVERTICES_OFFSET UNITYSDK_OFFSET(0x1B22D460)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETBLENDSHAPEFRAMEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B22D430)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETBONES_OFFSET UNITYSDK_OFFSET(0x1B22D210)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETLIGHTMAPTILINGOFFSET_OFFSET UNITYSDK_OFFSET(0x1B22D1D0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETMESHUV1S_OFFSET UNITYSDK_OFFSET(0x1B22C600)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETMESHUVCHANNEL_OFFSET UNITYSDK_OFFSET(0x1B22C880)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETPROJECTCOLORSPACE_OFFSET UNITYSDK_OFFSET(0x1B22E2A0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETSCALEINLIGHTMAP_OFFSET UNITYSDK_OFFSET(0x1B22D600)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GRAPHICSUVSTARTSATTOP_OFFSET UNITYSDK_OFFSET(0x1B22D5C0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_ISASSETINPROJECT_OFFSET UNITYSDK_OFFSET(0x1B22E770)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_ISRUNNINGANDMESHNOTREADWRITEABLE_OFFSET UNITYSDK_OFFSET(0x1B22C5C0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_ISTEXTUREREADABLE_OFFSET UNITYSDK_OFFSET(0x1B22D5E0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_ISTEXTURE_SRGBGAMMACORRECTED_OFFSET UNITYSDK_OFFSET(0x1B22D5D0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_IS_2017_1_ORNEWER_OFFSET UNITYSDK_OFFSET(0x1B22C4E0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_IS_2018_3_ORNEWER_OFFSET UNITYSDK_OFFSET(0x1B22C4F0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_MAXMESHVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1B22D500)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_MESHASSIGNUVCHANNEL_OFFSET UNITYSDK_OFFSET(0x1B22CF50)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_MESHCLEAR_OFFSET UNITYSDK_OFFSET(0x1B22CF20)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_OPTIMIZEMESH_OFFSET UNITYSDK_OFFSET(0x1B22C5B0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_SETACTIVERECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1B22C550)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x1B22C520)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_SETMESHINDEXFORMATANDCLEARMESH_OFFSET UNITYSDK_OFFSET(0x1B22D510)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_UNESCAPEURL_OFFSET UNITYSDK_OFFSET(0x1B22E6A0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_VERSION_OFFSET UNITYSDK_OFFSET(0x1B22C4A0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22E780)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MBVersionConcrete_TypeDefinitionIndex = 83261;
