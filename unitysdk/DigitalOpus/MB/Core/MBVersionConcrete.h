...
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_ADDBLENDSHAPEFRAME_OFFSET UNITYSDK_OFFSET(0x1AC22000)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_CLEARBLENDSHAPES_OFFSET UNITYSDK_OFFSET(0x1AC21FE0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_COLLECTPROPERTYNAMES_OFFSET UNITYSDK_OFFSET(0x1AC22150)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_DETECTPIPELINE_OFFSET UNITYSDK_OFFSET(0x1AC22C00)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_DOSPECIALRENDERPIPELINE_TEXTUREPACKERFASTSETUP_OFFSET UNITYSDK_OFFSET(0x1AC22DC0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_FINDRUNTIMEMATERIALSFROMADDRESSES_OFFSET UNITYSDK_OFFSET(0x1AC23250)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_FINDSCENEOBJECTSOFTYPE_OFFSET UNITYSDK_OFFSET(0x1AC210C0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETACTIVE_OFFSET UNITYSDK_OFFSET(0x1AC21040)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETBLENDSHAPEFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1AC21F40)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETBLENDSHAPEFRAMEVERTICES_OFFSET UNITYSDK_OFFSET(0x1AC21FA0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETBLENDSHAPEFRAMEWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AC21F70)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETBONES_OFFSET UNITYSDK_OFFSET(0x1AC21D50)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETLIGHTMAPTILINGOFFSET_OFFSET UNITYSDK_OFFSET(0x1AC21D10)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETMESHUV1S_OFFSET UNITYSDK_OFFSET(0x1AC21140)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETMESHUVCHANNEL_OFFSET UNITYSDK_OFFSET(0x1AC213C0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETPROJECTCOLORSPACE_OFFSET UNITYSDK_OFFSET(0x1AC22DD0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GETSCALEINLIGHTMAP_OFFSET UNITYSDK_OFFSET(0x1AC22140)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_GRAPHICSUVSTARTSATTOP_OFFSET UNITYSDK_OFFSET(0x1AC22100)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_ISASSETINPROJECT_OFFSET UNITYSDK_OFFSET(0x1AC232A0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_ISRUNNINGANDMESHNOTREADWRITEABLE_OFFSET UNITYSDK_OFFSET(0x1AC21100)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_ISTEXTUREREADABLE_OFFSET UNITYSDK_OFFSET(0x1AC22120)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_ISTEXTURE_SRGBGAMMACORRECTED_OFFSET UNITYSDK_OFFSET(0x1AC22110)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_IS_2017_1_ORNEWER_OFFSET UNITYSDK_OFFSET(0x1AC21020)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_IS_2018_3_ORNEWER_OFFSET UNITYSDK_OFFSET(0x1AC21030)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_MAXMESHVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1AC22040)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_MESHASSIGNUVCHANNEL_OFFSET UNITYSDK_OFFSET(0x1AC21A90)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_MESHCLEAR_OFFSET UNITYSDK_OFFSET(0x1AC21A60)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_OPTIMIZEMESH_OFFSET UNITYSDK_OFFSET(0x1AC210F0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_SETACTIVERECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1AC21090)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_SETACTIVE_OFFSET UNITYSDK_OFFSET(0x1AC21060)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_SETMESHINDEXFORMATANDCLEARMESH_OFFSET UNITYSDK_OFFSET(0x1AC22050)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_UNESCAPEURL_OFFSET UNITYSDK_OFFSET(0x1AC231D0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE_VERSION_OFFSET UNITYSDK_OFFSET(0x1AC20FE0)
#define DIGITALOPUS_MB_CORE_MBVERSIONCONCRETE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC232B0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MBVersionConcrete_TypeDefinitionIndex = 81220;
