...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1A943D10)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_MERGEATLASPACKINGRESULTSTACKBONA_OFFSET UNITYSDK_OFFSET(0x1A9458B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_TESTSTACKRECTANGLESHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1A945EB0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_TESTSTACKRECTANGLESVERTICAL_OFFSET UNITYSDK_OFFSET(0x1A945F20)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A943D00)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerHorizontalVertical_TypeDefinitionIndex = 81388;
