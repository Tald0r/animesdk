...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1AF24930)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_MERGEATLASPACKINGRESULTSTACKBONA_OFFSET UNITYSDK_OFFSET(0x1AF264C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_TESTSTACKRECTANGLESHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1AF26AC0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL_TESTSTACKRECTANGLESVERTICAL_OFFSET UNITYSDK_OFFSET(0x1AF26B30)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERHORIZONTALVERTICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF24920)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerHorizontalVertical_TypeDefinitionIndex = 83429;
