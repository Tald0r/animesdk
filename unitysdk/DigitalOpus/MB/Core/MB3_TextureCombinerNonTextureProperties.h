...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_ADJUSTNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A3831B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_COLLECTAVERAGEVALUESOFNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A381F60)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_FINDBESTTEXTUREBLENDER_OFFSET UNITYSDK_OFFSET(0x1A382AD0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_FINDMATCHINGTEXTUREBLENDER_OFFSET UNITYSDK_OFFSET(0x1A382E50)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_GETCOLORASITWOULDAPPEARINATLASIFNOTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A383330)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_GETCOLORFORTEMPORARYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A383440)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_INTERFACEFILTER_OFFSET UNITYSDK_OFFSET(0x1A382DC0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_LOADTEXTUREBLENDERSIFNEEDED_OFFSET UNITYSDK_OFFSET(0x1A382280)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_LOADTEXTUREBLENDERS_OFFSET UNITYSDK_OFFSET(0x1A3822B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_NONTEXTUREPROPERTIESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x1A382FD0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_TINTTEXTUREWITHTEXTURECOMBINER_OFFSET UNITYSDK_OFFSET(0x1A3830B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A383550)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3815C0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerNonTextureProperties_TypeDefinitionIndex = 81365;
	...
	public:
		...
		{
			return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombinerNonTextureProperties_TypeDefinitionIndex)->GetStaticField(0x119C0);
		}
		...
		::Il2CppArray<::DigitalOpus::MB::Core::MB3_TextureCombinerNonTextureProperties_MaterialProperty*>* _nonTextureProperties; // 0x20
		::Il2CppArray<::DigitalOpus::MB::Core::TextureBlender*>* textureBlenders; // 0x28
		::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::Color>* textureProperty2DefaultColorMap; // 0x30
		::DigitalOpus::MB::Core::MB3_TextureCombinerNonTextureProperties_NonTextureProperties* _nonTexturePropertiesBlender; // 0x38
