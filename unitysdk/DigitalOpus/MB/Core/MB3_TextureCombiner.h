...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_ADDTEMPORARYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A908350)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_COMBINETEXTURESINTOATLASESCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A907D50)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_COMBINETEXTURESINTOATLASES_OFFSET UNITYSDK_OFFSET(0x1A907AE0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_ATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1A907560)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_CONSIDERNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A907740)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_CUSTOMSHADERPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1A907720)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_DOMERGEDISTINCTMATERIALTEXTURESTHATWOULDEXCEEDATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1A907760)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_FIXOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1A907640)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_LAYERTEXTUREPACKERFASTMESH_OFFSET UNITYSDK_OFFSET(0x1A907660)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A9075C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MAXATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1A907580)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A9075A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MAXTILINGBAKESIZE_OFFSET UNITYSDK_OFFSET(0x1A907680)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MESHBAKERTEXTUREPACKERFORCEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1A907700)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_PACKINGALGORITHM_OFFSET UNITYSDK_OFFSET(0x1A9076E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_RESIZEPOWEROFTWOTEXTURES_OFFSET UNITYSDK_OFFSET(0x1A907620)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1A9076C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_SAVEATLASESASASSETS_OFFSET UNITYSDK_OFFSET(0x1A9076A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1A907540)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_USEMAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A907600)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_USEMAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A9075E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_LOADPIPELINEDATA_OFFSET UNITYSDK_OFFSET(0x1A907E40)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_PRINTLIST_OFFSET UNITYSDK_OFFSET(0x1A90BC80)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_RUNCORUTINEWITHOUTPAUSE_OFFSET UNITYSDK_OFFSET(0x1A907780)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_ATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1A907570)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_CONSIDERNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A907750)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_CUSTOMSHADERPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1A907730)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_DOMERGEDISTINCTMATERIALTEXTURESTHATWOULDEXCEEDATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1A907770)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_FIXOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1A907650)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_LAYERTEXTUREPACKERFASTMESH_OFFSET UNITYSDK_OFFSET(0x1A907670)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A9075D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MAXATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1A907590)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A9075B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MAXTILINGBAKESIZE_OFFSET UNITYSDK_OFFSET(0x1A907690)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MESHBAKERTEXTUREPACKERFORCEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1A907710)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_PACKINGALGORITHM_OFFSET UNITYSDK_OFFSET(0x1A9076F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_RESIZEPOWEROFTWOTEXTURES_OFFSET UNITYSDK_OFFSET(0x1A907630)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1A9076D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_SAVEATLASESASASSETS_OFFSET UNITYSDK_OFFSET(0x1A9076B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1A907550)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_USEMAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A907610)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_USEMAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A9075F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SHOULDTEXTUREBELINEAR_OFFSET UNITYSDK_OFFSET(0x1A90BE10)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SUGGESTTREATMENT_OFFSET UNITYSDK_OFFSET(0x1A908EF0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A90BF20)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__COMBINETEXTURESINTOATLASES_OFFSET UNITYSDK_OFFSET(0x1A907C80)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__CREATETEMPORARYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A908180)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__CREATETEXTURECOPY_OFFSET UNITYSDK_OFFSET(0x1A9083B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A90BE40)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__DESTROYALLTEMPORARYTEXTURES_OFFSET UNITYSDK_OFFSET(0x1A9086B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__DESTROYTEMPORARYTEXTURES_OFFSET UNITYSDK_OFFSET(0x1A9088B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__GETNUMTEMPORARYTEXTURES_OFFSET UNITYSDK_OFFSET(0x1A908160)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__RESIZETEXTURE_OFFSET UNITYSDK_OFFSET(0x1A908530)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__RESTOREPROCEDURALMATERIALS_OFFSET UNITYSDK_OFFSET(0x1A908EE0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER___COMBINETEXTURESINTOATLASES_OFFSET UNITYSDK_OFFSET(0x1A908050)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER___RUNTEXTUREPACKERONLY_OFFSET UNITYSDK_OFFSET(0x1A9080D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombiner_TypeDefinitionIndex = 83390;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombiner_TypeDefinitionIndex)->GetStaticField(0x11AB0);
		}
