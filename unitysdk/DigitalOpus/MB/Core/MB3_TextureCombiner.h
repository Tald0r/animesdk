...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_ADDTEMPORARYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A34A300)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_COMBINETEXTURESINTOATLASESCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A349CE0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_COMBINETEXTURESINTOATLASES_OFFSET UNITYSDK_OFFSET(0x1A349A70)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_ATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1A3494F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_CONSIDERNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A3496D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_CUSTOMSHADERPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1A3496B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_DOMERGEDISTINCTMATERIALTEXTURESTHATWOULDEXCEEDATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1A3496F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_FIXOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1A3495D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_LAYERTEXTUREPACKERFASTMESH_OFFSET UNITYSDK_OFFSET(0x1A3495F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A349550)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MAXATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1A349510)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A349530)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MAXTILINGBAKESIZE_OFFSET UNITYSDK_OFFSET(0x1A349610)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_MESHBAKERTEXTUREPACKERFORCEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1A349690)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_PACKINGALGORITHM_OFFSET UNITYSDK_OFFSET(0x1A349670)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_RESIZEPOWEROFTWOTEXTURES_OFFSET UNITYSDK_OFFSET(0x1A3495B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1A349650)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_SAVEATLASESASASSETS_OFFSET UNITYSDK_OFFSET(0x1A349630)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1A3494D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_USEMAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A349590)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_GET_USEMAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A349570)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_LOADPIPELINEDATA_OFFSET UNITYSDK_OFFSET(0x1A349DD0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_PRINTLIST_OFFSET UNITYSDK_OFFSET(0x1A34DC30)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_RUNCORUTINEWITHOUTPAUSE_OFFSET UNITYSDK_OFFSET(0x1A349710)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_ATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1A349500)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_CONSIDERNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A3496E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_CUSTOMSHADERPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1A3496C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_DOMERGEDISTINCTMATERIALTEXTURESTHATWOULDEXCEEDATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1A349700)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_FIXOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1A3495E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_LAYERTEXTUREPACKERFASTMESH_OFFSET UNITYSDK_OFFSET(0x1A349600)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A349560)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MAXATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1A349520)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A349540)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MAXTILINGBAKESIZE_OFFSET UNITYSDK_OFFSET(0x1A349620)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_MESHBAKERTEXTUREPACKERFORCEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1A3496A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_PACKINGALGORITHM_OFFSET UNITYSDK_OFFSET(0x1A349680)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_RESIZEPOWEROFTWOTEXTURES_OFFSET UNITYSDK_OFFSET(0x1A3495C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1A349660)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_SAVEATLASESASASSETS_OFFSET UNITYSDK_OFFSET(0x1A349640)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1A3494E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_USEMAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A3495A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SET_USEMAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A349580)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SHOULDTEXTUREBELINEAR_OFFSET UNITYSDK_OFFSET(0x1A34DDC0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER_SUGGESTTREATMENT_OFFSET UNITYSDK_OFFSET(0x1A34AEA0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A34DEE0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__COMBINETEXTURESINTOATLASES_OFFSET UNITYSDK_OFFSET(0x1A349C10)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__CREATETEMPORARYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A34A130)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__CREATETEXTURECOPY_OFFSET UNITYSDK_OFFSET(0x1A34A360)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A34DDF0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__DESTROYALLTEMPORARYTEXTURES_OFFSET UNITYSDK_OFFSET(0x1A34A660)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__DESTROYTEMPORARYTEXTURES_OFFSET UNITYSDK_OFFSET(0x1A34A860)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__GETNUMTEMPORARYTEXTURES_OFFSET UNITYSDK_OFFSET(0x1A34A110)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__RESIZETEXTURE_OFFSET UNITYSDK_OFFSET(0x1A34A4E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER__RESTOREPROCEDURALMATERIALS_OFFSET UNITYSDK_OFFSET(0x1A34AE90)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER___COMBINETEXTURESINTOATLASES_OFFSET UNITYSDK_OFFSET(0x1A34A000)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINER___RUNTEXTUREPACKERONLY_OFFSET UNITYSDK_OFFSET(0x1A34A080)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombiner_TypeDefinitionIndex = 81349;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MB3_TextureCombiner_TypeDefinitionIndex)->GetStaticField(0x119A0);
		}
