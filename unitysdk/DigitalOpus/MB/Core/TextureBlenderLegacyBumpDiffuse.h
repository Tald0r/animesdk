...
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE_DOESSHADERNAMEMATCH_OFFSET UNITYSDK_OFFSET(0x1ABF4D30)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE_GETCOLORIFNOTEXTURE_OFFSET UNITYSDK_OFFSET(0x1ABF4F00)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE_NONTEXTUREPROPERTIESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x1ABF4E80)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE_ONBEFORETINTTEXTURE_OFFSET UNITYSDK_OFFSET(0x1ABF4DD0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE_ONBLENDTEXTUREPIXEL_OFFSET UNITYSDK_OFFSET(0x1ABF4E50)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE_SETNONTEXTUREPROPERTYVALUESONRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1ABF4EB0)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERLEGACYBUMPDIFFUSE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABF4FE0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int TextureBlenderLegacyBumpDiffuse_TypeDefinitionIndex = 81237;
