...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_ADDDELETEGAMEOBJECTSBYID_OFFSET UNITYSDK_OFFSET(0x1A31D480)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_ADDDELETEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A31CFC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_APPLYSHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1A31AC70)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1A31ADA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_APPLY_2_OFFSET UNITYSDK_OFFSET(0x1A31AFC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_APPLY_OFFSET UNITYSDK_OFFSET(0x1A31AB50)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BUILDSCENEHIERARCHPREBAKE_OFFSET UNITYSDK_OFFSET(0x1A31EC90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BUILDSCENEMESHOBJECT_OFFSET UNITYSDK_OFFSET(0x1A31E1F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BUILDSOURCEMATSTOSUBMESHIDXMAP_OFFSET UNITYSDK_OFFSET(0x1A3175F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CHECKINTEGRITY_OFFSET UNITYSDK_OFFSET(0x1A320770)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CLEARBUFFERS_OFFSET UNITYSDK_OFFSET(0x1A31E420)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CLEARMESH_1_OFFSET UNITYSDK_OFFSET(0x1A31EA40)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CLEARMESH_OFFSET UNITYSDK_OFFSET(0x1A31E970)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_COMBINEDMESHCONTAINS_OFFSET UNITYSDK_OFFSET(0x1A31E3C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CREATE_BONEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1A3179B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CREATE_MESHCHANNELSCACHE_OFFSET UNITYSDK_OFFSET(0x1A317960)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_CREATE_VERTEXANDTRIANGLEPROCESSOR_OFFSET UNITYSDK_OFFSET(0x1A314EA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_DESTROYMESHEDITOR_OFFSET UNITYSDK_OFFSET(0x1A31EAF0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_DESTROYMESH_OFFSET UNITYSDK_OFFSET(0x1A317490)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A311A40)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETBONES_OFFSET UNITYSDK_OFFSET(0x1A312BD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETLIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1A312BE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETMATERIALSONTARGETRENDERER_OFFSET UNITYSDK_OFFSET(0x1A31E090)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETMESH_OFFSET UNITYSDK_OFFSET(0x1A312A20)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETNUMOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1A312940)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1A312960)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_GETVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1A311E30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPADD_OFFSET UNITYSDK_OFFSET(0x1A312240)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPCLEAR_OFFSET UNITYSDK_OFFSET(0x1A312430)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPCONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1A3124A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPCOUNT_OFFSET UNITYSDK_OFFSET(0x1A312400)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPGET_OFFSET UNITYSDK_OFFSET(0x1A3121E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPREMOVE_OFFSET UNITYSDK_OFFSET(0x1A3122D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCE2COMBINED_MAPTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1A312330)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_INSTANCEID2DGO_OFFSET UNITYSDK_OFFSET(0x1A312530)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_ISMIRRORED_OFFSET UNITYSDK_OFFSET(0x1A31A8C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_PRINTPROFILEINFO_OFFSET UNITYSDK_OFFSET(0x1A311120)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SETMESH_OFFSET UNITYSDK_OFFSET(0x1A312B40)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SET_RENDERTYPE_OFFSET UNITYSDK_OFFSET(0x1A311E50)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SET_RESULTSCENEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A311F40)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1A311C00)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_SHOWHIDEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A31CD70)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_STARTPROFILE_OFFSET UNITYSDK_OFFSET(0x1A311080)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATEGAMEOBJECTS_1_OFFSET UNITYSDK_OFFSET(0x1A31C070)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A31B250)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBONES_OFFSET UNITYSDK_OFFSET(0x1A320D70)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A3209A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_UPDATESKINNEDMESHAPPROXIMATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A320990)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_VALIDATETARGRENDERERANDMESHANDRESULTSCENEOBJ_OFFSET UNITYSDK_OFFSET(0x1A316CF0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__ADDTOCOMBINED_OFFSET UNITYSDK_OFFSET(0x1A314F20)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__COLLECTMATERIALTRIANGLES_OFFSET UNITYSDK_OFFSET(0x1A3132C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__COLLECTOUTOFBOUNDSUVRECTS2_OFFSET UNITYSDK_OFFSET(0x1A313F90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__CONFIGURESCENEHIERARCH_OFFSET UNITYSDK_OFFSET(0x1A31FEF0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A321630)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__DISPOSERUNTIMECREATED_OFFSET UNITYSDK_OFFSET(0x1A31EA50)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__GETBONES_OFFSET UNITYSDK_OFFSET(0x1A31AB40)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A312D80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__NEWMESH_OFFSET UNITYSDK_OFFSET(0x1A312AE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__SETLIGHTMAPINDEXIFPRESERVELIGHTMAPPING_OFFSET UNITYSDK_OFFSET(0x1A320500)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__SHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1A314730)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A31B450)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__UPDATEMATERIALSONTARGETRENDERER_OFFSET UNITYSDK_OFFSET(0x1A321130)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__USENATIVEARRAYAPIORNOT_OFFSET UNITYSDK_OFFSET(0x1A314E90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE__VALIDATETEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1A314580)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE___ADDTOCOMBINED_OFFSET UNITYSDK_OFFSET(0x1A317A00)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE___UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A31C2E0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_TypeDefinitionIndex = 83327;
