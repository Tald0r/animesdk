...
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_ADDDELETEGAMEOBJECTSBYID_OFFSET UNITYSDK_OFFSET(0x1ABF0150)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_ADDDELETEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1ABEFDA0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1ABEF080)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_APPLY_2_OFFSET UNITYSDK_OFFSET(0x1ABEF140)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_APPLY_OFFSET UNITYSDK_OFFSET(0x1ABEEDE0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_CHECKINTEGRITY_OFFSET UNITYSDK_OFFSET(0x1ABF4850)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_CLEARBUFFERS_OFFSET UNITYSDK_OFFSET(0x1ABF40B0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_CLEARMESH_1_OFFSET UNITYSDK_OFFSET(0x1ABF4510)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_CLEARMESH_OFFSET UNITYSDK_OFFSET(0x1ABF41E0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_COMBINEDMESHCONTAINS_OFFSET UNITYSDK_OFFSET(0x1ABEEAF0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_DESTROYMESHEDITOR_OFFSET UNITYSDK_OFFSET(0x1ABF4530)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_DESTROYMESH_OFFSET UNITYSDK_OFFSET(0x1ABF4200)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GETLIGHTMAPINDEX_OFFSET UNITYSDK_OFFSET(0x1ABEEA70)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GETMATERIALSONTARGETRENDERER_OFFSET UNITYSDK_OFFSET(0x1ABF0940)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GETNUMOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1ABEE8E0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GETOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1ABEE910)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GET_LOG_LEVEL_OFFSET UNITYSDK_OFFSET(0x1ABEE3F0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GET_MAXVERTSINMESH_OFFSET UNITYSDK_OFFSET(0x1ABEE550)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_GET_VALIDATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1ABEE540)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_SET_LOG_LEVEL_OFFSET UNITYSDK_OFFSET(0x1ABEE400)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_SET_MAXVERTSINMESH_OFFSET UNITYSDK_OFFSET(0x1ABEE560)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_SET_VALIDATIONLEVEL_OFFSET UNITYSDK_OFFSET(0x1ABEE4A0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATEGAMEOBJECTS_1_OFFSET UNITYSDK_OFFSET(0x1ABEF6F0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1ABEF650)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBONES_OFFSET UNITYSDK_OFFSET(0x1ABEF510)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1ABEF5B0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER_UPDATESKINNEDMESHAPPROXIMATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1ABEF470)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__BAKESTEP1_OFFSET UNITYSDK_OFFSET(0x1ABF25D0)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABF4A40)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABF4900)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__DISPOSERUNTIMECREATED_OFFSET UNITYSDK_OFFSET(0x1ABF4710)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__DISTRIBUTEAMONGBAKERS_OFFSET UNITYSDK_OFFSET(0x1ABF1970)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__SETMBVALUES_OFFSET UNITYSDK_OFFSET(0x1ABF3F50)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__VALIDATETEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1ABEEC30)
#define DIGITALOPUS_MB_CORE_MB3_MULTIMESHCOMBINER__VALIDATE_OFFSET UNITYSDK_OFFSET(0x1ABF0B00)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MultiMeshCombiner_TypeDefinitionIndex = 81306;
	...
	public:
		...
		{
			return (::Il2CppArray<::UnityEngine::GameObject*>**)Il2CppClass::FromTypeDefinitionIndex(MB3_MultiMeshCombiner_TypeDefinitionIndex)->GetStaticField(0x46780);
		}
		static ::Il2CppArray<::System::Int32>** StaticGet_emptyIDs()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(MB3_MultiMeshCombiner_TypeDefinitionIndex)->GetStaticField(0x46788);
		}
