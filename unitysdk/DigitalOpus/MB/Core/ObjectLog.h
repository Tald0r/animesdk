...
#define DIGITALOPUS_MB_CORE_OBJECTLOG_DUMP_OFFSET UNITYSDK_OFFSET(0x1AACDD20)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_ERROR_OFFSET UNITYSDK_OFFSET(0x1AACDAF0)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_INFO_OFFSET UNITYSDK_OFFSET(0x1AACDBD0)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_LOGDEBUG_OFFSET UNITYSDK_OFFSET(0x1AACDC40)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_LOG_OFFSET UNITYSDK_OFFSET(0x1AACDA70)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_TRACE_OFFSET UNITYSDK_OFFSET(0x1AACDCB0)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_WARN_OFFSET UNITYSDK_OFFSET(0x1AACDB60)
#define DIGITALOPUS_MB_CORE_OBJECTLOG__CACHELOGMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AACD9E0)
#define DIGITALOPUS_MB_CORE_OBJECTLOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AACDA40)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int ObjectLog_TypeDefinitionIndex = 81266;
