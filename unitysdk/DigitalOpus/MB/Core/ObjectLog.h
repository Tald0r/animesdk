...
#define DIGITALOPUS_MB_CORE_OBJECTLOG_DUMP_OFFSET UNITYSDK_OFFSET(0x1B111E10)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_ERROR_OFFSET UNITYSDK_OFFSET(0x1B111BE0)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_INFO_OFFSET UNITYSDK_OFFSET(0x1B111CC0)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_LOGDEBUG_OFFSET UNITYSDK_OFFSET(0x1B111D30)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_LOG_OFFSET UNITYSDK_OFFSET(0x1B111B60)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_TRACE_OFFSET UNITYSDK_OFFSET(0x1B111DA0)
#define DIGITALOPUS_MB_CORE_OBJECTLOG_WARN_OFFSET UNITYSDK_OFFSET(0x1B111C50)
#define DIGITALOPUS_MB_CORE_OBJECTLOG__CACHELOGMESSAGE_OFFSET UNITYSDK_OFFSET(0x1B111AD0)
#define DIGITALOPUS_MB_CORE_OBJECTLOG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B111B30)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int ObjectLog_TypeDefinitionIndex = 83307;
