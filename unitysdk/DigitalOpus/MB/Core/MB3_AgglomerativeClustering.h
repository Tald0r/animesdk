...
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING_AGGLOMERATE_OFFSET UNITYSDK_OFFSET(0x1A20D740)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING_EUCLIDEAN_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1A20D6F0)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING_MAIN_OFFSET UNITYSDK_OFFSET(0x1A20F9F0)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING_TESTRUN_OFFSET UNITYSDK_OFFSET(0x1A20F830)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20FBE0)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING__REFILLPRIORITYQWITHSOME_OFFSET UNITYSDK_OFFSET(0x1A20F0D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_AgglomerativeClustering_TypeDefinitionIndex = 81271;
