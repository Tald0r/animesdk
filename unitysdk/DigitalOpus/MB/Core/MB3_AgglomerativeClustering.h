...
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING_AGGLOMERATE_OFFSET UNITYSDK_OFFSET(0x1A7C4430)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING_EUCLIDEAN_DISTANCE_OFFSET UNITYSDK_OFFSET(0x1A7C43E0)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING_MAIN_OFFSET UNITYSDK_OFFSET(0x1A7C66E0)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING_TESTRUN_OFFSET UNITYSDK_OFFSET(0x1A7C6520)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7C68D0)
#define DIGITALOPUS_MB_CORE_MB3_AGGLOMERATIVECLUSTERING__REFILLPRIORITYQWITHSOME_OFFSET UNITYSDK_OFFSET(0x1A7C5DC0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_AgglomerativeClustering_TypeDefinitionIndex = 83312;
