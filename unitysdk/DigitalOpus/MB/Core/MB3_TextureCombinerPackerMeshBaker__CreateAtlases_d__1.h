...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CREATEATLASES_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A7C6970)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CREATEATLASES_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7C8380)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CREATEATLASES_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7C83E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CREATEATLASES_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A7C8390)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CREATEATLASES_D__1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7C6960)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CREATEATLASES_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7C6950)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBaker__CreateAtlases_d__1_TypeDefinitionIndex = 83418;
	...
	public:
		...
		::Il2CppArray<::UnityEngine::Rect>* _uvRects_5__2; // 0x40
		::DigitalOpus::MB::Core::ShaderTextureProperty* _property_5__6; // 0x48
		::Il2CppArray<::Il2CppArray<::UnityEngine::Color>*>* _atlasPixels_5__7; // 0x50
		::System::Object* __2__current; // 0x58
		::System::Int32 _propIdx_5__5; // 0x60
		::DigitalOpus::MB::Core::MB2_LogLevel LOG_LEVEL; // 0x64
		::System::Boolean _isNormalMap_5__8; // 0x68
		::System::Int32 _texSetIdx_5__9; // 0x6C
