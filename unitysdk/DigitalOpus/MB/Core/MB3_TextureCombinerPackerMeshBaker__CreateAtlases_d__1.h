...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CREATEATLASES_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A20FC80)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CREATEATLASES_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A2116E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CREATEATLASES_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A211740)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CREATEATLASES_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A2116F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CREATEATLASES_D__1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A20FC70)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CREATEATLASES_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A20FC60)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBaker__CreateAtlases_d__1_TypeDefinitionIndex = 81377;
	...
	public:
		...
		::DigitalOpus::MB::Core::ShaderTextureProperty* _property_5__6; // 0x40
		::DigitalOpus::MB::Core::AtlasPackingResult* packedAtlasRects; // 0x48
		::Il2CppArray<::UnityEngine::Texture2D*>* atlases; // 0x50
		::Il2CppArray<::UnityEngine::Rect>* _uvRects_5__2; // 0x58
		::DigitalOpus::MB::Core::MB2_LogLevel LOG_LEVEL; // 0x60
		::System::Int32 _texSetIdx_5__9; // 0x64
		::System::Int32 _atlasSizeX_5__3; // 0x68
		::System::Int32 _propIdx_5__5; // 0x6C
		::System::Int32 _atlasSizeY_5__4; // 0x70
		::System::Boolean _isNormalMap_5__8; // 0x74
