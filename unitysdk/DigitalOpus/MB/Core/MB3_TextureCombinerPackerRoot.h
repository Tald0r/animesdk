...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CALCULATEATLASRECTANGLESSTATIC_OFFSET UNITYSDK_OFFSET(0x1AFE84F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1AFE8770)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CONVERTTEXTURESTOREADABLEFORMATS_OFFSET UNITYSDK_OFFSET(0x1AFE8710)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CREATETEMPORARYTEXTURESFORATLAS_OFFSET UNITYSDK_OFFSET(0x1AFE8030)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_MAKEPROCEDURALTEXTURESREADABLE_OFFSET UNITYSDK_OFFSET(0x1AFE8700)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_SAVEATLASANDCONFIGURERESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1AFE82B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE8780)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerRoot_TypeDefinitionIndex = 81346;
