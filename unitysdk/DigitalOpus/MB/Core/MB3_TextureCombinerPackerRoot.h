...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CALCULATEATLASRECTANGLESSTATIC_OFFSET UNITYSDK_OFFSET(0x1B5F7340)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1B5F75C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CONVERTTEXTURESTOREADABLEFORMATS_OFFSET UNITYSDK_OFFSET(0x1B5F7560)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_CREATETEMPORARYTEXTURESFORATLAS_OFFSET UNITYSDK_OFFSET(0x1B5F6E80)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_MAKEPROCEDURALTEXTURESREADABLE_OFFSET UNITYSDK_OFFSET(0x1B5F7550)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT_SAVEATLASANDCONFIGURERESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B5F7100)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F75D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerRoot_TypeDefinitionIndex = 83387;
