...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_ADDBONESTONEWBONESARRAYANDADJUSTBWINDEXES1_OFFSET UNITYSDK_OFFSET(0x1A95E630)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_ALLOCATEANDSETUPSMRDATASTRUCTURES_OFFSET UNITYSDK_OFFSET(0x1A95C320)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_APPLYSMRDATATOMESHTOBUFFER_OFFSET UNITYSDK_OFFSET(0x1A9600F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_APPLYSMRDATATOMESH_OFFSET UNITYSDK_OFFSET(0x1A960100)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_BUILDBONEIDX2DGOMAPIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1A95BB50)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_COLLECTBONESTOADDFORDGO_OFFSET UNITYSDK_OFFSET(0x1A95CCA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_COPYBONESWEAREKEEPINGTONEWBONESARRAYANDADJUSTBWINDEXES_OFFSET UNITYSDK_OFFSET(0x1A95DCE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_COPYBONEWEIGHTSFROMMESHFORDGOSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1A9600B0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_COPYVERTSNORMSTANSTOBUFFERS_1_OFFSET UNITYSDK_OFFSET(0x1A95F170)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_COPYVERTSNORMSTANSTOBUFFERS_OFFSET UNITYSDK_OFFSET(0x1A95F0C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_DB_CHECKINTEGRITY_OFFSET UNITYSDK_OFFSET(0x1A960160)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_DISPOSEOFTEMPORARYSMRDATA_OFFSET UNITYSDK_OFFSET(0x1A95FFD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A95B920)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A95B8F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_GETBONESTOADD_OFFSET UNITYSDK_OFFSET(0x1A95BB20)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_GETCACHEDSMRMESHDATA_OFFSET UNITYSDK_OFFSET(0x1A960150)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_GETNEWBONESLENGTH_OFFSET UNITYSDK_OFFSET(0x1A95C660)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_GETNEWBONESSIZE_OFFSET UNITYSDK_OFFSET(0x1A95B950)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_GETNUMBONESTODELETE_OFFSET UNITYSDK_OFFSET(0x1A95BB30)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_INSERTNEWBONESINTOBONESARRAY_OFFSET UNITYSDK_OFFSET(0x1A95E300)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_REMOVEBONESFORDGOSWEAREDELETING_OFFSET UNITYSDK_OFFSET(0x1A95C200)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_UPDATEGAMEOBJECTS_READBONEWEIGHTINFOFROMCOMBINEDMESH_OFFSET UNITYSDK_OFFSET(0x1A95C790)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_UPDATEGAMEOBJECTS_UPDATEBWINDEXES_OFFSET UNITYSDK_OFFSET(0x1A95ECC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR__BUILDBONEIDX2DGOMAP_OFFSET UNITYSDK_OFFSET(0x1A95BD60)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR__COLLECTSKINNINGDATAFORDGOSINCOMBINEDMESH_OFFSET UNITYSDK_OFFSET(0x1A95C4C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A95B960)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MB_MeshCombinerSingle_BoneProcessor_TypeDefinitionIndex = 81288;
	...
	public:
		...
		::System::Collections::Generic::HashSet_1<::DigitalOpus::MB::Core::MB3_MeshCombinerSingle_BoneAndBindpose>* bonesToAdd; // 0x18
		::Il2CppArray<::UnityEngine::Matrix4x4>* oldBindPosesPreviousBake; // 0x20
		::System::Collections::Generic::HashSet_1<::System::Int32>* boneIdxsToDelete; // 0x28
		::DigitalOpus::MB::Core::MB3_MeshCombinerSingle* combiner; // 0x30
		::Il2CppArray<::System::Collections::Generic::List_1<::DigitalOpus::MB::Core::MB3_MeshCombinerSingle_MB_DynamicGameObject*>*>* boneIdx2dgoMap; // 0x38
		::Il2CppArray<::UnityEngine::Transform*>* oldBonesPreviousBake; // 0x40
		::Il2CppArray<::UnityEngine::BoneWeight>* boneWeights; // 0x48
		::Il2CppArray<::UnityEngine::BoneWeight>* nboneWeights; // 0x50
