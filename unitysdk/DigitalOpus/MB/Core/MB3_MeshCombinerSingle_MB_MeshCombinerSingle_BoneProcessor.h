...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_ADDBONESTONEWBONESARRAYANDADJUSTBWINDEXES1_OFFSET UNITYSDK_OFFSET(0x1AF3AFE0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_ALLOCATEANDSETUPSMRDATASTRUCTURES_OFFSET UNITYSDK_OFFSET(0x1AF38CC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_APPLYSMRDATATOMESHTOBUFFER_OFFSET UNITYSDK_OFFSET(0x1AF3CA90)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_APPLYSMRDATATOMESH_OFFSET UNITYSDK_OFFSET(0x1AF3CAA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_BUILDBONEIDX2DGOMAPIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1AF384F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_COLLECTBONESTOADDFORDGO_OFFSET UNITYSDK_OFFSET(0x1AF39640)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_COPYBONESWEAREKEEPINGTONEWBONESARRAYANDADJUSTBWINDEXES_OFFSET UNITYSDK_OFFSET(0x1AF3A680)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_COPYBONEWEIGHTSFROMMESHFORDGOSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1AF3CA50)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_COPYVERTSNORMSTANSTOBUFFERS_1_OFFSET UNITYSDK_OFFSET(0x1AF3BB20)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_COPYVERTSNORMSTANSTOBUFFERS_OFFSET UNITYSDK_OFFSET(0x1AF3BA70)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_DB_CHECKINTEGRITY_OFFSET UNITYSDK_OFFSET(0x1AF3CB00)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_DISPOSEOFTEMPORARYSMRDATA_OFFSET UNITYSDK_OFFSET(0x1AF3C980)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1AF382C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AF38290)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_GETBONESTOADD_OFFSET UNITYSDK_OFFSET(0x1AF384C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_GETCACHEDSMRMESHDATA_OFFSET UNITYSDK_OFFSET(0x1AF3CAF0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_GETNEWBONESLENGTH_OFFSET UNITYSDK_OFFSET(0x1AF39000)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_GETNEWBONESSIZE_OFFSET UNITYSDK_OFFSET(0x1AF382F0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_GETNUMBONESTODELETE_OFFSET UNITYSDK_OFFSET(0x1AF384D0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_INSERTNEWBONESINTOBONESARRAY_OFFSET UNITYSDK_OFFSET(0x1AF3ACA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_REMOVEBONESFORDGOSWEAREDELETING_OFFSET UNITYSDK_OFFSET(0x1AF38BA0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_UPDATEGAMEOBJECTS_READBONEWEIGHTINFOFROMCOMBINEDMESH_OFFSET UNITYSDK_OFFSET(0x1AF39130)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR_UPDATEGAMEOBJECTS_UPDATEBWINDEXES_OFFSET UNITYSDK_OFFSET(0x1AF3B670)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR__BUILDBONEIDX2DGOMAP_OFFSET UNITYSDK_OFFSET(0x1AF38700)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR__COLLECTSKINNINGDATAFORDGOSINCOMBINEDMESH_OFFSET UNITYSDK_OFFSET(0x1AF38E60)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_MESHCOMBINERSINGLE_BONEPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF38300)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MB_MeshCombinerSingle_BoneProcessor_TypeDefinitionIndex = 83329;
	...
	public:
		...
		::Il2CppArray<::UnityEngine::BoneWeight>* nboneWeights; // 0x18
		::Il2CppArray<::UnityEngine::Matrix4x4>* nbindPoses; // 0x20
		::Il2CppArray<::System::Collections::Generic::List_1<::DigitalOpus::MB::Core::MB3_MeshCombinerSingle_MB_DynamicGameObject*>*>* boneIdx2dgoMap; // 0x28
		::System::Collections::Generic::HashSet_1<::System::Int32>* boneIdxsToDelete; // 0x30
		::System::Collections::Generic::HashSet_1<::DigitalOpus::MB::Core::MB3_MeshCombinerSingle_BoneAndBindpose>* bonesToAdd; // 0x38
		::Il2CppArray<::UnityEngine::BoneWeight>* boneWeights; // 0x40
		::System::Collections::Generic::Dictionary_2<::DigitalOpus::MB::Core::MB3_MeshCombinerSingle_BoneAndBindpose, ::System::Int32>* boneAndBindPose2idx; // 0x48
		::Il2CppArray<::UnityEngine::Matrix4x4>* oldBindPosesPreviousBake; // 0x50
		::DigitalOpus::MB::Core::MB3_MeshCombinerSingle* combiner; // 0x58
		::Il2CppArray<::UnityEngine::Transform*>* nbones; // 0x60
		::System::Boolean _didSetup; // 0x68
		::System::Boolean _disposed; // 0x69
