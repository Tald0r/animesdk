...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BONEANDBINDPOSE_EQUALS_OFFSET UNITYSDK_OFFSET(0x94DAC0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BONEANDBINDPOSE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x94DAD0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_BONEANDBINDPOSE__CTOR_OFFSET UNITYSDK_OFFSET(0x5103A0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_BoneAndBindpose_TypeDefinitionIndex = 81297;
