...
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_ALLNONTEXTUREPROPERTYVALUESAREEQUAL_OFFSET UNITYSDK_OFFSET(0x1B22F050)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_CACHEMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B22F280)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER_GETVALUEIFALLSOURCEARETHESAMEORDEFAULT_OFFSET UNITYSDK_OFFSET(0x1B22F320)
#define DIGITALOPUS_MB_CORE_TEXTUREBLENDERMATERIALPROPERTYCACHEHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B22F4F0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int TextureBlenderMaterialPropertyCacheHelper_TypeDefinitionIndex = 83280;
