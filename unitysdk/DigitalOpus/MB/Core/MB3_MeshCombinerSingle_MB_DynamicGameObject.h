...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1A943C80)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT_INITIALIZENEW_OFFSET UNITYSDK_OFFSET(0x1A9439C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A9438C0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT_UNINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A943C60)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A943CA0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MB_DynamicGameObject_TypeDefinitionIndex = 81293;
