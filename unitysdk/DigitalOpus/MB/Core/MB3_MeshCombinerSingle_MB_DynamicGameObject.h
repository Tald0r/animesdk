...
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1AF248A0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT_INITIALIZENEW_OFFSET UNITYSDK_OFFSET(0x1AF245E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AF244E0)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT_UNINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AF24880)
#define DIGITALOPUS_MB_CORE_MB3_MESHCOMBINERSINGLE_MB_DYNAMICGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF248C0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_MeshCombinerSingle_MB_DynamicGameObject_TypeDefinitionIndex = 83334;
