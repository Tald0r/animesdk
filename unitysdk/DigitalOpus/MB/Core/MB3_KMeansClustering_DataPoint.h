...
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_DATAPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACDC2F0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_KMeansClustering_DataPoint_TypeDefinitionIndex = 81277;
