...
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_ANYAREEMPTY_OFFSET UNITYSDK_OFFSET(0x1ACA7910)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_CLUSTER_OFFSET UNITYSDK_OFFSET(0x1ACA8500)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_ELUCIDANDISTANCE_OFFSET UNITYSDK_OFFSET(0x1ACA7F70)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_GETCLUSTER_OFFSET UNITYSDK_OFFSET(0x1ACA80F0)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_INITIALIZECENTROIDS_OFFSET UNITYSDK_OFFSET(0x1ACA75B0)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_MININDEX_OFFSET UNITYSDK_OFFSET(0x1ACA7FE0)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_UPDATECLUSTERMEMBERSHIP_OFFSET UNITYSDK_OFFSET(0x1ACA7A40)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING_UPDATEDATAPOINTMEANS_OFFSET UNITYSDK_OFFSET(0x1ACA7690)
#define DIGITALOPUS_MB_CORE_MB3_KMEANSCLUSTERING__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACA7190)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_KMeansClustering_TypeDefinitionIndex = 81276;
