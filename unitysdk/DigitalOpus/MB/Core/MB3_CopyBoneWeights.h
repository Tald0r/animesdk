...
#define DIGITALOPUS_MB_CORE_MB3_COPYBONEWEIGHTS_COPYBONEWEIGHTSFROMSEAMMESHTOOTHERMESHES_OFFSET UNITYSDK_OFFSET(0x1A646DA0)
#define DIGITALOPUS_MB_CORE_MB3_COPYBONEWEIGHTS_REMAPBONEWEIGHTINDEXES_OFFSET UNITYSDK_OFFSET(0x1A648E30)
#define DIGITALOPUS_MB_CORE_MB3_COPYBONEWEIGHTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6490B0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_CopyBoneWeights_TypeDefinitionIndex = 81275;
