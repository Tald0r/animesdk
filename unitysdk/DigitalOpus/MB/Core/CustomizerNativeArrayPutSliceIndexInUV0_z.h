...
#define DIGITALOPUS_MB_CORE_CUSTOMIZERNATIVEARRAYPUTSLICEINDEXINUV0_Z_MESHASSIGN_UV_OFFSET UNITYSDK_OFFSET(0x1B0DE360)
#define DIGITALOPUS_MB_CORE_CUSTOMIZERNATIVEARRAYPUTSLICEINDEXINUV0_Z_UVCHANNELWITHEXTRAPARAMETER_OFFSET UNITYSDK_OFFSET(0x1B0DE350)
#define DIGITALOPUS_MB_CORE_CUSTOMIZERNATIVEARRAYPUTSLICEINDEXINUV0_Z__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0DE490)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int CustomizerNativeArrayPutSliceIndexInUV0_z_TypeDefinitionIndex = 81217;
