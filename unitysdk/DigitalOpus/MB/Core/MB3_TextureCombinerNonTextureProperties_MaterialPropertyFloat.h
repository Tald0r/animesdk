...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYFLOAT_GETAVERAGECALCULATOR_OFFSET UNITYSDK_OFFSET(0x1AF3D3F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYFLOAT_GETDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1AF3D400)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYFLOAT_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AF3D370)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYFLOAT_SET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1AF3D380)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERNONTEXTUREPROPERTIES_MATERIALPROPERTYFLOAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF3D390)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerNonTextureProperties_MaterialPropertyFloat_TypeDefinitionIndex = 83408;
