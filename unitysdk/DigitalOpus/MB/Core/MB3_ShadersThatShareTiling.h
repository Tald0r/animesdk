...
#define DIGITALOPUS_MB_CORE_MB3_SHADERSTHATSHARETILING_GETSCALEANDOFFSETFORTEXTUREPROP_OFFSET UNITYSDK_OFFSET(0x19D63A00)
#define DIGITALOPUS_MB_CORE_MB3_SHADERSTHATSHARETILING_GETSHADERSTHATSHARETILING_OFFSET UNITYSDK_OFFSET(0x19D635F0)
#define DIGITALOPUS_MB_CORE_MB3_SHADERSTHATSHARETILING_INIT_OFFSET UNITYSDK_OFFSET(0x19D63660)
#define DIGITALOPUS_MB_CORE_MB3_SHADERSTHATSHARETILING__CTOR_OFFSET UNITYSDK_OFFSET(0x19D63C60)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_ShadersThatShareTiling_TypeDefinitionIndex = 81309;
	...
	public:
		...
		{
			return (::DigitalOpus::MB::Core::MB3_ShadersThatShareTiling**)Il2CppClass::FromTypeDefinitionIndex(MB3_ShadersThatShareTiling_TypeDefinitionIndex)->GetStaticField(0x46790);
		}
