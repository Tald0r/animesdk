...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1A34F190)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_CONVERTTEXTURESTOREADABLEFORMATS_OFFSET UNITYSDK_OFFSET(0x1A34F150)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1A34F1A0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_ONETIMESETUP_OFFSET UNITYSDK_OFFSET(0x1A34F240)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A34F080)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A34F380)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerFastV2_TypeDefinitionIndex = 81382;
