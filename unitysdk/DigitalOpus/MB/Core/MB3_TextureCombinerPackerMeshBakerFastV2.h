...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_CALCULATEATLASRECTANGLES_OFFSET UNITYSDK_OFFSET(0x1A90D1C0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_CONVERTTEXTURESTOREADABLEFORMATS_OFFSET UNITYSDK_OFFSET(0x1A90D180)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1A90D1D0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_ONETIMESETUP_OFFSET UNITYSDK_OFFSET(0x1A90D270)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A90D0B0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKERFASTV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A90D3B0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBakerFastV2_TypeDefinitionIndex = 83423;
