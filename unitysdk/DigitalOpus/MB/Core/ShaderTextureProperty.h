...
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AACE550)
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AACE5F0)
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY_GETNAMES_OFFSET UNITYSDK_OFFSET(0x1AACE600)
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AACE530)
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AACE510)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int ShaderTextureProperty_TypeDefinitionIndex = 81348;
