...
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B112660)
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B112700)
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY_GETNAMES_OFFSET UNITYSDK_OFFSET(0x1B112710)
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B112640)
#define DIGITALOPUS_MB_CORE_SHADERTEXTUREPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B112620)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int ShaderTextureProperty_TypeDefinitionIndex = 83389;
