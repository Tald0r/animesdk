...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBERESULT_GETSCORE_OFFSET UNITYSDK_OFFSET(0x1A942B60)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBERESULT_PRINTTREE_OFFSET UNITYSDK_OFFSET(0x1A942BA0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBERESULT_SET_OFFSET UNITYSDK_OFFSET(0x1A942B20)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A942BB0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePackerRegular_ProbeResult_TypeDefinitionIndex = 81341;
	...
	public:
		...
		::System::Boolean largerOrEqualToMaxDim; // 0x18
		::System::Int32 outW; // 0x1C
		::System::Single squareness; // 0x20
		::System::Single totalAtlasArea; // 0x24
		::System::Single efficiency; // 0x28
		::System::Int32 h; // 0x2C
		::System::Int32 numAtlases; // 0x30
		::System::Int32 w; // 0x34
