...
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBERESULT_GETSCORE_OFFSET UNITYSDK_OFFSET(0x1AF23780)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBERESULT_PRINTTREE_OFFSET UNITYSDK_OFFSET(0x1AF237C0)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBERESULT_SET_OFFSET UNITYSDK_OFFSET(0x1AF23740)
#define DIGITALOPUS_MB_CORE_MB2_TEXTUREPACKERREGULAR_PROBERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF237D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB2_TexturePackerRegular_ProbeResult_TypeDefinitionIndex = 83382;
	...
	public:
		...
		::System::Int32 h; // 0x1C
		::System::Int32 outH; // 0x20
		::System::Boolean largerOrEqualToMaxDim; // 0x24
		::System::Single squareness; // 0x28
		::System::Int32 outW; // 0x2C
		::System::Int32 w; // 0x30
		::System::Single efficiency; // 0x34
		::System::Single totalAtlasArea; // 0x38
