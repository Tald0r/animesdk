...
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONSOMETEXTURESUSEDIFFERENTMATTILING_ADJUSTRESULTMATERIALNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A32AB10)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONSOMETEXTURESUSEDIFFERENTMATTILING_GETMATERIALTILINGRECTFORTEXTUREBAKERRESULTS_OFFSET UNITYSDK_OFFSET(0x1A32AB00)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONSOMETEXTURESUSEDIFFERENTMATTILING_GETRECTSFORTEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1A32A8D0)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONSOMETEXTURESUSEDIFFERENTMATTILING_SETTILINGTREATMENTANDADJUSTENCAPSULATINGSAMPLINGRECT_OFFSET UNITYSDK_OFFSET(0x1A32A960)
#define DIGITALOPUS_MB_CORE_MB_TEXSET_PIPELINEVARIATIONSOMETEXTURESUSEDIFFERENTMATTILING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3289D0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB_TexSet_PipelineVariationSomeTexturesUseDifferentMatTiling_TypeDefinitionIndex = 83404;
