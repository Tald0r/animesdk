...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER_COPYSCALEDANDTILEDTOATLAS_OFFSET UNITYSDK_OFFSET(0x1A322190)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1A3220F0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A3220E0)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A322290)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBaker_TypeDefinitionIndex = 83417;
