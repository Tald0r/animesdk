...
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER_COPYSCALEDANDTILEDTOATLAS_OFFSET UNITYSDK_OFFSET(0x19D63D20)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x19D63C80)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER_VALIDATE_OFFSET UNITYSDK_OFFSET(0x19D63C70)
#define DIGITALOPUS_MB_CORE_MB3_TEXTURECOMBINERPACKERMESHBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x19D63E20)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MB3_TextureCombinerPackerMeshBaker_TypeDefinitionIndex = 81376;
