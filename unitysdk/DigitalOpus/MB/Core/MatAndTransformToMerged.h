...
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_ASSIGNINITIALVALUESFORMATERIALTILINGANDSAMPLINGRECTMATANDUVTILING_OFFSET UNITYSDK_OFFSET(0x1A351550)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A351060)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A351360)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_GETMATERIALNAME_OFFSET UNITYSDK_OFFSET(0x1A351410)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_GET_MATERIALTILING_OFFSET UNITYSDK_OFFSET(0x1A350F70)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_GET_OBUVRECTIFTILINGSAME_OFFSET UNITYSDK_OFFSET(0x1A350F10)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_GET_SAMPLINGRECTMATANDUVTILING_OFFSET UNITYSDK_OFFSET(0x1A350F40)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_SET_MATERIALTILING_OFFSET UNITYSDK_OFFSET(0x1A350F90)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_SET_OBUVRECTIFTILINGSAME_OFFSET UNITYSDK_OFFSET(0x1A350F30)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED_SET_SAMPLINGRECTMATANDUVTILING_OFFSET UNITYSDK_OFFSET(0x1A350F60)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A351020)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A350FA0)
#define DIGITALOPUS_MB_CORE_MATANDTRANSFORMTOMERGED__INIT_OFFSET UNITYSDK_OFFSET(0x1A350FE0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MatAndTransformToMerged_TypeDefinitionIndex = 81358;
