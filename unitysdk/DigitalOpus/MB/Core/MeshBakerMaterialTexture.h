...
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_ARETEXTURESEQUAL_OFFSET UNITYSDK_OFFSET(0x1AC23AC0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GETENCAPSULATINGSAMPLINGRECT_OFFSET UNITYSDK_OFFSET(0x1AC237B0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GETTEXNAME_OFFSET UNITYSDK_OFFSET(0x1AC23A10)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GETTEXTURE2D_OFFSET UNITYSDK_OFFSET(0x1AC237F0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1AC23980)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GET_ISIMPORTEDASNORMALMAP_OFFSET UNITYSDK_OFFSET(0x1AC23580)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x1AC23880)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GET_MATTILINGRECT_OFFSET UNITYSDK_OFFSET(0x1AC23550)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1AC238F0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_SETENCAPSULATINGSAMPLINGRECT_OFFSET UNITYSDK_OFFSET(0x1AC237D0)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_SET_ISIMPORTEDASNORMALMAP_OFFSET UNITYSDK_OFFSET(0x1AC23590)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_SET_MATTILINGRECT_OFFSET UNITYSDK_OFFSET(0x1AC23570)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE_SET_T_OFFSET UNITYSDK_OFFSET(0x1AC23540)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AC23B70)
#define DIGITALOPUS_MB_CORE_MESHBAKERMATERIALTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC235A0)

namespace DigitalOpus::MB::Core
{
	inline static constexpr unsigned int MeshBakerMaterialTexture_TypeDefinitionIndex = 81357;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MeshBakerMaterialTexture_TypeDefinitionIndex)->GetStaticField(0x11990);
		}
		::UnityEngine::Texture2D* _t; // 0x10
		::System::Single texelDensity; // 0x18
		::System::Int32 _isImportedAsNormalMap_k__BackingField; // 0x1C
		::DigitalOpus::MB::Core::DRect encapsulatingSamplingRect; // 0x20
		::DigitalOpus::MB::Core::DRect _matTilingRect_k__BackingField; // 0x40
