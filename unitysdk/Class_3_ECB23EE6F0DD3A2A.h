...
#define CLASS_3_ECB23EE6F0DD3A2A_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A0DC460)
#define CLASS_3_ECB23EE6F0DD3A2A_FLUSH_OFFSET UNITYSDK_OFFSET(0x1A0DB540)
#define CLASS_3_ECB23EE6F0DD3A2A_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1A0DB340)
#define CLASS_3_ECB23EE6F0DD3A2A_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1A0DB350)
#define CLASS_3_ECB23EE6F0DD3A2A_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1A0DB360)
#define CLASS_3_ECB23EE6F0DD3A2A_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A0DB370)
#define CLASS_3_ECB23EE6F0DD3A2A_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A0DB470)
#define CLASS_3_ECB23EE6F0DD3A2A_METHOD_3_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0x1A0DB3D0)
#define CLASS_3_ECB23EE6F0DD3A2A_METHOD_3_C74E50CBD41F0264_OFFSET UNITYSDK_OFFSET(0x1A0DC620)
#define CLASS_3_ECB23EE6F0DD3A2A_READ_OFFSET UNITYSDK_OFFSET(0x1A0DB590)
#define CLASS_3_ECB23EE6F0DD3A2A_SEEK_OFFSET UNITYSDK_OFFSET(0x1A0DBF00)
#define CLASS_3_ECB23EE6F0DD3A2A_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1A0DC1A0)
#define CLASS_3_ECB23EE6F0DD3A2A_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A0DB490)
#define CLASS_3_ECB23EE6F0DD3A2A_WRITE_OFFSET UNITYSDK_OFFSET(0x1A0DC230)
#define CLASS_3_ECB23EE6F0DD3A2A__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0DB2A0)

inline static constexpr unsigned int Class_3_ECB23EE6F0DD3A2A_TypeDefinitionIndex = 31857;
