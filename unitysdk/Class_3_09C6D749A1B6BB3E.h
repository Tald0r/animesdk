...
#define CLASS_3_09C6D749A1B6BB3E_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x91CC4B0)
#define CLASS_3_09C6D749A1B6BB3E_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x91CC490)
#define CLASS_3_09C6D749A1B6BB3E_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x91CC0A0)
#define CLASS_3_09C6D749A1B6BB3E_METHOD_3_043C7D36DE4B7257_OFFSET UNITYSDK_OFFSET(0x91CC6E0)
#define CLASS_3_09C6D749A1B6BB3E_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x91CC790)
#define CLASS_3_09C6D749A1B6BB3E_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x91CC7F0)
#define CLASS_3_09C6D749A1B6BB3E_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x91CBCA0)
#define CLASS_3_09C6D749A1B6BB3E__CCTOR_OFFSET UNITYSDK_OFFSET(0x91CC510)
#define CLASS_3_09C6D749A1B6BB3E__CTOR_OFFSET UNITYSDK_OFFSET(0x91CC590)

inline static constexpr unsigned int Class_3_09C6D749A1B6BB3E_TypeDefinitionIndex = 75854;

class Class_3_09C6D749A1B6BB3E : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_6 = 0x8; // 0x0
	::System::Collections::Generic::Stack_1<::UnityEngine::GameObject*>* Field_3_4; // 0x48
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::UnityEngine::GameObject*>* Field_3_2; // 0x50
	::System::Collections::Generic::Queue_1<::UnityEngine::GameObject*>* Field_3_5; // 0x58
