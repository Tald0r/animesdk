...
#define CLASS_3_09C6D749A1B6BB3E_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x863DB30)
#define CLASS_3_09C6D749A1B6BB3E_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0x863DB10)
#define CLASS_3_09C6D749A1B6BB3E_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x863D720)
#define CLASS_3_09C6D749A1B6BB3E_METHOD_3_043C7D36DE4B7257_OFFSET UNITYSDK_OFFSET(0x863DDC0)
#define CLASS_3_09C6D749A1B6BB3E_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x863DD60)
#define CLASS_3_09C6D749A1B6BB3E_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x863DE70)
#define CLASS_3_09C6D749A1B6BB3E_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x863D320)
#define CLASS_3_09C6D749A1B6BB3E__CCTOR_OFFSET UNITYSDK_OFFSET(0x863DB90)
#define CLASS_3_09C6D749A1B6BB3E__CTOR_OFFSET UNITYSDK_OFFSET(0x863DC10)

inline static constexpr unsigned int Class_3_09C6D749A1B6BB3E_TypeDefinitionIndex = 54827;
...
public:
	...
	::System::Collections::Generic::Stack_1<::UnityEngine::GameObject*>* Field_3_4; // 0x50
	::System::String* Field_3_3; // 0x58
	::System::Collections::Generic::Dictionary_2<::System::UInt32, ::UnityEngine::GameObject*>* Field_3_2; // 0x60
	::System::Collections::Generic::Queue_1<::UnityEngine::GameObject*>* Field_3_5; // 0x68
