...
#define STATICGRID2D_CALCULATEGRIDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1919D310)
#define STATICGRID2D_CHECKIFSORTED_OFFSET UNITYSDK_OFFSET(0x1919D1A0)
#define STATICGRID2D_GET_COLS_OFFSET UNITYSDK_OFFSET(0x1919D020)
#define STATICGRID2D_GET_GRIDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1919D040)
#define STATICGRID2D_GET_ISSORTED_OFFSET UNITYSDK_OFFSET(0x1919D070)
#define STATICGRID2D_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x1919CFE0)
#define STATICGRID2D_GET_ROWS_OFFSET UNITYSDK_OFFSET(0x1919D000)
#define STATICGRID2D_SET_COLS_OFFSET UNITYSDK_OFFSET(0x1919D030)
#define STATICGRID2D_SET_GRIDBOUNDS_OFFSET UNITYSDK_OFFSET(0x1919D060)
#define STATICGRID2D_SET_ISSORTED_OFFSET UNITYSDK_OFFSET(0x1919D080)
#define STATICGRID2D_SET_POINTS_OFFSET UNITYSDK_OFFSET(0x1919CFF0)
#define STATICGRID2D_SET_ROWS_OFFSET UNITYSDK_OFFSET(0x1919D010)
#define STATICGRID2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1919D090)

inline static constexpr unsigned int StaticGrid2D_TypeDefinitionIndex = 41989;
...
public:
	...
	::System::Int32 _Rows_k__BackingField; // 0x30
	::System::Int32 _Cols_k__BackingField; // 0x34
	::System::Boolean _IsSorted_k__BackingField; // 0x38
