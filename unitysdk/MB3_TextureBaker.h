...
#define MB3_TEXTUREBAKER_CONFIGURENEWMATERIALTOMATCHOLD_OFFSET UNITYSDK_OFFSET(0x1AC25740)
#define MB3_TEXTUREBAKER_CREATEANDCONFIGURETEXTURECOMBINER_OFFSET UNITYSDK_OFFSET(0x1AC25640)
#define MB3_TEXTUREBAKER_CREATEATLASESCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1AC24C20)
#define MB3_TEXTUREBAKER_CREATEATLASES_1_OFFSET UNITYSDK_OFFSET(0x1AC24640)
#define MB3_TEXTUREBAKER_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1AC24630)
#define MB3_TEXTUREBAKER_GETOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1AC243A0)
#define MB3_TEXTUREBAKER_GET_ATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1AC240D0)
#define MB3_TEXTUREBAKER_GET_CONSIDERNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AC24350)
#define MB3_TEXTUREBAKER_GET_COROUTINERESULT_OFFSET UNITYSDK_OFFSET(0x1AC24390)
#define MB3_TEXTUREBAKER_GET_CUSTOMSHADERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AC24250)
#define MB3_TEXTUREBAKER_GET_CUSTOMSHADERPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1AC24290)
#define MB3_TEXTUREBAKER_GET_DOMULTIMATERIALSPLITATLASESIFOBUVS_OFFSET UNITYSDK_OFFSET(0x1AC24310)
#define MB3_TEXTUREBAKER_GET_DOMULTIMATERIALSPLITATLASESIFTOOBIG_OFFSET UNITYSDK_OFFSET(0x1AC242F0)
#define MB3_TEXTUREBAKER_GET_DOMULTIMATERIAL_OFFSET UNITYSDK_OFFSET(0x1AC242D0)
#define MB3_TEXTUREBAKER_GET_DOSUGGESTTREATMENT_OFFSET UNITYSDK_OFFSET(0x1AC24370)
#define MB3_TEXTUREBAKER_GET_FIXOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1AC241B0)
#define MB3_TEXTUREBAKER_GET_LAYERFORTEXTUREPACKERFASTMESH_OFFSET UNITYSDK_OFFSET(0x1AC24210)
#define MB3_TEXTUREBAKER_GET_MAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1AC24170)
#define MB3_TEXTUREBAKER_GET_MAXATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1AC240F0)
#define MB3_TEXTUREBAKER_GET_MAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1AC24130)
#define MB3_TEXTUREBAKER_GET_MAXTILINGBAKESIZE_OFFSET UNITYSDK_OFFSET(0x1AC241D0)
#define MB3_TEXTUREBAKER_GET_MESHBAKERTEXTUREPACKERFORCEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1AC24230)
#define MB3_TEXTUREBAKER_GET_PACKINGALGORITHM_OFFSET UNITYSDK_OFFSET(0x1AC241F0)
#define MB3_TEXTUREBAKER_GET_RESIZEPOWEROFTWOTEXTURES_OFFSET UNITYSDK_OFFSET(0x1AC24190)
#define MB3_TEXTUREBAKER_GET_RESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1AC24330)
#define MB3_TEXTUREBAKER_GET_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1AC242B0)
#define MB3_TEXTUREBAKER_GET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1AC240B0)
#define MB3_TEXTUREBAKER_GET_TEXTUREPROPNAMESTOIGNORE_OFFSET UNITYSDK_OFFSET(0x1AC24270)
#define MB3_TEXTUREBAKER_GET_USEMAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1AC24150)
#define MB3_TEXTUREBAKER_GET_USEMAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1AC24110)
#define MB3_TEXTUREBAKER_PRINTSET_OFFSET UNITYSDK_OFFSET(0x1AC25C40)
#define MB3_TEXTUREBAKER_PURGENULLSFROMOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1AC24430)
#define MB3_TEXTUREBAKER_SET_ATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1AC240E0)
#define MB3_TEXTUREBAKER_SET_CONSIDERNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AC24360)
#define MB3_TEXTUREBAKER_SET_CUSTOMSHADERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1AC24260)
#define MB3_TEXTUREBAKER_SET_CUSTOMSHADERPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1AC242A0)
#define MB3_TEXTUREBAKER_SET_DOMULTIMATERIALSPLITATLASESIFOBUVS_OFFSET UNITYSDK_OFFSET(0x1AC24320)
#define MB3_TEXTUREBAKER_SET_DOMULTIMATERIALSPLITATLASESIFTOOBIG_OFFSET UNITYSDK_OFFSET(0x1AC24300)
#define MB3_TEXTUREBAKER_SET_DOMULTIMATERIAL_OFFSET UNITYSDK_OFFSET(0x1AC242E0)
#define MB3_TEXTUREBAKER_SET_DOSUGGESTTREATMENT_OFFSET UNITYSDK_OFFSET(0x1AC24380)
#define MB3_TEXTUREBAKER_SET_FIXOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1AC241C0)
#define MB3_TEXTUREBAKER_SET_LAYERFORTEXTUREPACKERFASTMESH_OFFSET UNITYSDK_OFFSET(0x1AC24220)
#define MB3_TEXTUREBAKER_SET_MAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1AC24180)
#define MB3_TEXTUREBAKER_SET_MAXATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1AC24100)
#define MB3_TEXTUREBAKER_SET_MAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1AC24140)
#define MB3_TEXTUREBAKER_SET_MAXTILINGBAKESIZE_OFFSET UNITYSDK_OFFSET(0x1AC241E0)
#define MB3_TEXTUREBAKER_SET_MESHBAKERTEXTUREPACKERFORCEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1AC24240)
#define MB3_TEXTUREBAKER_SET_PACKINGALGORITHM_OFFSET UNITYSDK_OFFSET(0x1AC24200)
#define MB3_TEXTUREBAKER_SET_RESIZEPOWEROFTWOTEXTURES_OFFSET UNITYSDK_OFFSET(0x1AC241A0)
#define MB3_TEXTUREBAKER_SET_RESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1AC24340)
#define MB3_TEXTUREBAKER_SET_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1AC242C0)
#define MB3_TEXTUREBAKER_SET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1AC240C0)
#define MB3_TEXTUREBAKER_SET_TEXTUREPROPNAMESTOIGNORE_OFFSET UNITYSDK_OFFSET(0x1AC24280)
#define MB3_TEXTUREBAKER_SET_USEMAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1AC24160)
#define MB3_TEXTUREBAKER_SET_USEMAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1AC24120)
#define MB3_TEXTUREBAKER_UNPACKMAT2RECTMAP_1_OFFSET UNITYSDK_OFFSET(0x1AC251B0)
#define MB3_TEXTUREBAKER_UNPACKMAT2RECTMAP_OFFSET UNITYSDK_OFFSET(0x1AC24E70)
#define MB3_TEXTUREBAKER__CREATEATLASESCOROUTINEATLASES_OFFSET UNITYSDK_OFFSET(0x1AC24CB0)
#define MB3_TEXTUREBAKER__CREATEATLASESCOROUTINETEXTUREARRAY_OFFSET UNITYSDK_OFFSET(0x1AC24D40)
#define MB3_TEXTUREBAKER__CREATEATLASESCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1AC24DE0)
#define MB3_TEXTUREBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC26F20)
#define MB3_TEXTUREBAKER__VALIDATERESULTMATERIALS_OFFSET UNITYSDK_OFFSET(0x1AC25E70)

inline static constexpr unsigned int MB3_TextureBaker_TypeDefinitionIndex = 81206;
