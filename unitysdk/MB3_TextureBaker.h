...
#define MB3_TEXTUREBAKER_CONFIGURENEWMATERIALTOMATCHOLD_OFFSET UNITYSDK_OFFSET(0x1B230BF0)
#define MB3_TEXTUREBAKER_CREATEANDCONFIGURETEXTURECOMBINER_OFFSET UNITYSDK_OFFSET(0x1B230AF0)
#define MB3_TEXTUREBAKER_CREATEATLASESCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1B2300E0)
#define MB3_TEXTUREBAKER_CREATEATLASES_1_OFFSET UNITYSDK_OFFSET(0x1B22FB10)
#define MB3_TEXTUREBAKER_CREATEATLASES_OFFSET UNITYSDK_OFFSET(0x1B22FB00)
#define MB3_TEXTUREBAKER_GETOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1B22F870)
#define MB3_TEXTUREBAKER_GET_ATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1B22F5A0)
#define MB3_TEXTUREBAKER_GET_CONSIDERNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B22F820)
#define MB3_TEXTUREBAKER_GET_COROUTINERESULT_OFFSET UNITYSDK_OFFSET(0x1B22F860)
#define MB3_TEXTUREBAKER_GET_CUSTOMSHADERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B22F720)
#define MB3_TEXTUREBAKER_GET_CUSTOMSHADERPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1B22F760)
#define MB3_TEXTUREBAKER_GET_DOMULTIMATERIALSPLITATLASESIFOBUVS_OFFSET UNITYSDK_OFFSET(0x1B22F7E0)
#define MB3_TEXTUREBAKER_GET_DOMULTIMATERIALSPLITATLASESIFTOOBIG_OFFSET UNITYSDK_OFFSET(0x1B22F7C0)
#define MB3_TEXTUREBAKER_GET_DOMULTIMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B22F7A0)
#define MB3_TEXTUREBAKER_GET_DOSUGGESTTREATMENT_OFFSET UNITYSDK_OFFSET(0x1B22F840)
#define MB3_TEXTUREBAKER_GET_FIXOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1B22F680)
#define MB3_TEXTUREBAKER_GET_LAYERFORTEXTUREPACKERFASTMESH_OFFSET UNITYSDK_OFFSET(0x1B22F6E0)
#define MB3_TEXTUREBAKER_GET_MAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1B22F640)
#define MB3_TEXTUREBAKER_GET_MAXATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1B22F5C0)
#define MB3_TEXTUREBAKER_GET_MAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1B22F600)
#define MB3_TEXTUREBAKER_GET_MAXTILINGBAKESIZE_OFFSET UNITYSDK_OFFSET(0x1B22F6A0)
#define MB3_TEXTUREBAKER_GET_MESHBAKERTEXTUREPACKERFORCEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1B22F700)
#define MB3_TEXTUREBAKER_GET_PACKINGALGORITHM_OFFSET UNITYSDK_OFFSET(0x1B22F6C0)
#define MB3_TEXTUREBAKER_GET_RESIZEPOWEROFTWOTEXTURES_OFFSET UNITYSDK_OFFSET(0x1B22F660)
#define MB3_TEXTUREBAKER_GET_RESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B22F800)
#define MB3_TEXTUREBAKER_GET_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1B22F780)
#define MB3_TEXTUREBAKER_GET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1B22F580)
#define MB3_TEXTUREBAKER_GET_TEXTUREPROPNAMESTOIGNORE_OFFSET UNITYSDK_OFFSET(0x1B22F740)
#define MB3_TEXTUREBAKER_GET_USEMAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1B22F620)
#define MB3_TEXTUREBAKER_GET_USEMAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1B22F5E0)
#define MB3_TEXTUREBAKER_PRINTSET_OFFSET UNITYSDK_OFFSET(0x1B2310F0)
#define MB3_TEXTUREBAKER_PURGENULLSFROMOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1B22F900)
#define MB3_TEXTUREBAKER_SET_ATLASPADDING_OFFSET UNITYSDK_OFFSET(0x1B22F5B0)
#define MB3_TEXTUREBAKER_SET_CONSIDERNONTEXTUREPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B22F830)
#define MB3_TEXTUREBAKER_SET_CUSTOMSHADERPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1B22F730)
#define MB3_TEXTUREBAKER_SET_CUSTOMSHADERPROPNAMES_OFFSET UNITYSDK_OFFSET(0x1B22F770)
#define MB3_TEXTUREBAKER_SET_DOMULTIMATERIALSPLITATLASESIFOBUVS_OFFSET UNITYSDK_OFFSET(0x1B22F7F0)
#define MB3_TEXTUREBAKER_SET_DOMULTIMATERIALSPLITATLASESIFTOOBIG_OFFSET UNITYSDK_OFFSET(0x1B22F7D0)
#define MB3_TEXTUREBAKER_SET_DOMULTIMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B22F7B0)
#define MB3_TEXTUREBAKER_SET_DOSUGGESTTREATMENT_OFFSET UNITYSDK_OFFSET(0x1B22F850)
#define MB3_TEXTUREBAKER_SET_FIXOUTOFBOUNDSUVS_OFFSET UNITYSDK_OFFSET(0x1B22F690)
#define MB3_TEXTUREBAKER_SET_LAYERFORTEXTUREPACKERFASTMESH_OFFSET UNITYSDK_OFFSET(0x1B22F6F0)
#define MB3_TEXTUREBAKER_SET_MAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1B22F650)
#define MB3_TEXTUREBAKER_SET_MAXATLASSIZE_OFFSET UNITYSDK_OFFSET(0x1B22F5D0)
#define MB3_TEXTUREBAKER_SET_MAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1B22F610)
#define MB3_TEXTUREBAKER_SET_MAXTILINGBAKESIZE_OFFSET UNITYSDK_OFFSET(0x1B22F6B0)
#define MB3_TEXTUREBAKER_SET_MESHBAKERTEXTUREPACKERFORCEPOWEROFTWO_OFFSET UNITYSDK_OFFSET(0x1B22F710)
#define MB3_TEXTUREBAKER_SET_PACKINGALGORITHM_OFFSET UNITYSDK_OFFSET(0x1B22F6D0)
#define MB3_TEXTUREBAKER_SET_RESIZEPOWEROFTWOTEXTURES_OFFSET UNITYSDK_OFFSET(0x1B22F670)
#define MB3_TEXTUREBAKER_SET_RESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B22F810)
#define MB3_TEXTUREBAKER_SET_RESULTTYPE_OFFSET UNITYSDK_OFFSET(0x1B22F790)
#define MB3_TEXTUREBAKER_SET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1B22F590)
#define MB3_TEXTUREBAKER_SET_TEXTUREPROPNAMESTOIGNORE_OFFSET UNITYSDK_OFFSET(0x1B22F750)
#define MB3_TEXTUREBAKER_SET_USEMAXATLASHEIGHTOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1B22F630)
#define MB3_TEXTUREBAKER_SET_USEMAXATLASWIDTHOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1B22F5F0)
#define MB3_TEXTUREBAKER_UNPACKMAT2RECTMAP_1_OFFSET UNITYSDK_OFFSET(0x1B230660)
#define MB3_TEXTUREBAKER_UNPACKMAT2RECTMAP_OFFSET UNITYSDK_OFFSET(0x1B230330)
#define MB3_TEXTUREBAKER__CREATEATLASESCOROUTINEATLASES_OFFSET UNITYSDK_OFFSET(0x1B230170)
#define MB3_TEXTUREBAKER__CREATEATLASESCOROUTINETEXTUREARRAY_OFFSET UNITYSDK_OFFSET(0x1B230200)
#define MB3_TEXTUREBAKER__CREATEATLASESCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1B2302A0)
#define MB3_TEXTUREBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2323C0)
#define MB3_TEXTUREBAKER__VALIDATERESULTMATERIALS_OFFSET UNITYSDK_OFFSET(0x1B231320)

inline static constexpr unsigned int MB3_TextureBaker_TypeDefinitionIndex = 83247;
