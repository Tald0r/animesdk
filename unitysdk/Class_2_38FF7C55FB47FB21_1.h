...
#define CLASS_2_38FF7C55FB47FB21_1_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xA6D9400)
#define CLASS_2_38FF7C55FB47FB21_1_FROMFLX_OFFSET UNITYSDK_OFFSET(0xA6D8C50)
#define CLASS_2_38FF7C55FB47FB21_1_METHOD_2_03C4FFAD29DE0852_OFFSET UNITYSDK_OFFSET(0xA6D8040)
#define CLASS_2_38FF7C55FB47FB21_1_METHOD_2_0B2CB6A77D912E66_OFFSET UNITYSDK_OFFSET(0xA6D99C0)
#define CLASS_2_38FF7C55FB47FB21_1_METHOD_2_0BD393E566CD3D4A_OFFSET UNITYSDK_OFFSET(0xA6D8CD0)
#define CLASS_2_38FF7C55FB47FB21_1_METHOD_2_5C90773220FA8136_OFFSET UNITYSDK_OFFSET(0xA6D8990)
#define CLASS_2_38FF7C55FB47FB21_1_METHOD_2_82F37E818D9FE609_OFFSET UNITYSDK_OFFSET(0xA6D9460)
#define CLASS_2_38FF7C55FB47FB21_1_METHOD_2_B525722F60E6B94F_OFFSET UNITYSDK_OFFSET(0xA6D8B20)
#define CLASS_2_38FF7C55FB47FB21_1_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0xA6D9800)
#define CLASS_2_38FF7C55FB47FB21_1_METHOD_2_D4943D8F67F4699C_OFFSET UNITYSDK_OFFSET(0xA6D9860)
#define CLASS_2_38FF7C55FB47FB21_1_METHOD_2_D8A163211C06267F_OFFSET UNITYSDK_OFFSET(0xA6D8A20)
#define CLASS_2_38FF7C55FB47FB21_1__CTOR_OFFSET UNITYSDK_OFFSET(0xA6D9790)

inline static constexpr unsigned int Class_2_38FF7C55FB47FB21_1_TypeDefinitionIndex = 57875;

class Class_2_38FF7C55FB47FB21_1 : public ::Class_1_8088D8743C1058EF
{
public:
	::Struct_2_7548B21900B2290B<::UnityEngine::Vector3> Field_2_3; // 0x30
	::Struct_2_7548B21900B2290B<::System::String*> Field_2_2; // 0x50
	::Class_1_ED5EE319EA265EB6* Field_2_0; // 0x70
	::Struct_2_7548B21900B2290B<::System::String*> Field_2_1; // 0x78
	...
	{
		return ((::System::Int32(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_38FF7C55FB47FB21_1_METHOD_2_B525722F60E6B94F_OFFSET))(this);
	}
