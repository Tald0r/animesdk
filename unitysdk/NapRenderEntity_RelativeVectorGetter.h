...
#define NAPRENDERENTITY_RELATIVEVECTORGETTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D0A1B0)
#define NAPRENDERENTITY_RELATIVEVECTORGETTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D0A240)
#define NAPRENDERENTITY_RELATIVEVECTORGETTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D09E20)
#define NAPRENDERENTITY_RELATIVEVECTORGETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18D09E00)

inline static constexpr unsigned int NapRenderEntity_RelativeVectorGetter_TypeDefinitionIndex = 29060;
