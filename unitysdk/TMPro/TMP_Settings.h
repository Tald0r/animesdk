...
#define TMPRO_TMP_SETTINGS_GETCHARACTERS_OFFSET UNITYSDK_OFFSET(0x1ACF1440)
#define TMPRO_TMP_SETTINGS_GETFONTASSET_OFFSET UNITYSDK_OFFSET(0x1ACF0F00)
#define TMPRO_TMP_SETTINGS_GETSETTINGS_OFFSET UNITYSDK_OFFSET(0x1ACF0D40)
#define TMPRO_TMP_SETTINGS_GETSPRITEASSET_OFFSET UNITYSDK_OFFSET(0x1ACF10C0)
#define TMPRO_TMP_SETTINGS_GETSTYLESHEET_OFFSET UNITYSDK_OFFSET(0x1ACF1280)
#define TMPRO_TMP_SETTINGS_GET_AUTOSIZETEXTCONTAINER_OFFSET UNITYSDK_OFFSET(0x1ACEFC50)
#define TMPRO_TMP_SETTINGS_GET_DEFAULTCOLORGRADIENTPRESETSPATH_OFFSET UNITYSDK_OFFSET(0x1ACF03E0)
#define TMPRO_TMP_SETTINGS_GET_DEFAULTFONTASSETPATH_OFFSET UNITYSDK_OFFSET(0x1ACEF830)
#define TMPRO_TMP_SETTINGS_GET_DEFAULTFONTASSET_OFFSET UNITYSDK_OFFSET(0x1ACEF780)
#define TMPRO_TMP_SETTINGS_GET_DEFAULTFONTSIZE_OFFSET UNITYSDK_OFFSET(0x1ACEF8E0)
#define TMPRO_TMP_SETTINGS_GET_DEFAULTSPRITEASSETPATH_OFFSET UNITYSDK_OFFSET(0x1ACF0070)
#define TMPRO_TMP_SETTINGS_GET_DEFAULTSPRITEASSET_OFFSET UNITYSDK_OFFSET(0x1ACEFFC0)
#define TMPRO_TMP_SETTINGS_GET_DEFAULTSTYLESHEET_OFFSET UNITYSDK_OFFSET(0x1ACF0490)
#define TMPRO_TMP_SETTINGS_GET_DEFAULTTEXTAUTOSIZINGMAXRATIO_OFFSET UNITYSDK_OFFSET(0x1ACEFA40)
#define TMPRO_TMP_SETTINGS_GET_DEFAULTTEXTAUTOSIZINGMINRATIO_OFFSET UNITYSDK_OFFSET(0x1ACEF990)
#define TMPRO_TMP_SETTINGS_GET_DEFAULTTEXTMESHPROTEXTCONTAINERSIZE_OFFSET UNITYSDK_OFFSET(0x1ACEFAF0)
#define TMPRO_TMP_SETTINGS_GET_DEFAULTTEXTMESHPROUITEXTCONTAINERSIZE_OFFSET UNITYSDK_OFFSET(0x1ACEFBA0)
#define TMPRO_TMP_SETTINGS_GET_ENABLEEMOJISUPPORT_OFFSET UNITYSDK_OFFSET(0x1ACF0120)
#define TMPRO_TMP_SETTINGS_GET_ENABLEEXTRAPADDING_OFFSET UNITYSDK_OFFSET(0x1ACEF200)
#define TMPRO_TMP_SETTINGS_GET_ENABLEKERNING_OFFSET UNITYSDK_OFFSET(0x1ACEF150)
#define TMPRO_TMP_SETTINGS_GET_ENABLEPARSEESCAPECHARACTERS_OFFSET UNITYSDK_OFFSET(0x1ACEF360)
#define TMPRO_TMP_SETTINGS_GET_ENABLERAYCASTTARGET_OFFSET UNITYSDK_OFFSET(0x1ACEF410)
#define TMPRO_TMP_SETTINGS_GET_ENABLETINTALLSPRITES_OFFSET UNITYSDK_OFFSET(0x1ACEF2B0)
#define TMPRO_TMP_SETTINGS_GET_ENABLEWORDWRAPPING_OFFSET UNITYSDK_OFFSET(0x1ACEEFF0)
#define TMPRO_TMP_SETTINGS_GET_FALLBACKFONTASSETS_OFFSET UNITYSDK_OFFSET(0x1ACEFE60)
#define TMPRO_TMP_SETTINGS_GET_FOLLOWINGCHARACTERS_OFFSET UNITYSDK_OFFSET(0x1ACF06A0)
#define TMPRO_TMP_SETTINGS_GET_GETFONTFEATURESATRUNTIME_OFFSET UNITYSDK_OFFSET(0x1ACEF4C0)
#define TMPRO_TMP_SETTINGS_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1ACEF0A0)
#define TMPRO_TMP_SETTINGS_GET_ISTEXTOBJECTSCALESTATIC_OFFSET UNITYSDK_OFFSET(0x1ACEFD00)
#define TMPRO_TMP_SETTINGS_GET_LEADINGCHARACTERS_OFFSET UNITYSDK_OFFSET(0x1ACF05F0)
#define TMPRO_TMP_SETTINGS_GET_LINEBREAKINGRULES_OFFSET UNITYSDK_OFFSET(0x1ACF0750)
#define TMPRO_TMP_SETTINGS_GET_MATCHMATERIALPRESET_OFFSET UNITYSDK_OFFSET(0x1ACEFF10)
#define TMPRO_TMP_SETTINGS_GET_MISSINGCHARACTERSPRITEUNICODE_OFFSET UNITYSDK_OFFSET(0x1ACF0280)
#define TMPRO_TMP_SETTINGS_GET_MISSINGGLYPHCHARACTER_OFFSET UNITYSDK_OFFSET(0x1ACEF570)
#define TMPRO_TMP_SETTINGS_GET_STYLESHEETSRESOURCEPATH_OFFSET UNITYSDK_OFFSET(0x1ACF0540)
#define TMPRO_TMP_SETTINGS_GET_USEMODERNHANGULLINEBREAKINGRULES_OFFSET UNITYSDK_OFFSET(0x1ACF0AB0)
#define TMPRO_TMP_SETTINGS_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1ACEEFB0)
#define TMPRO_TMP_SETTINGS_GET_WARNINGSDISABLED_OFFSET UNITYSDK_OFFSET(0x1ACEF6D0)
#define TMPRO_TMP_SETTINGS_LOADDEFAULTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1ACF0C20)
#define TMPRO_TMP_SETTINGS_LOADLINEBREAKINGRULES_OFFSET UNITYSDK_OFFSET(0x1ACF08B0)
#define TMPRO_TMP_SETTINGS_SET_ENABLEEMOJISUPPORT_OFFSET UNITYSDK_OFFSET(0x1ACF01D0)
#define TMPRO_TMP_SETTINGS_SET_ISTEXTOBJECTSCALESTATIC_OFFSET UNITYSDK_OFFSET(0x1ACEFDB0)
#define TMPRO_TMP_SETTINGS_SET_MISSINGCHARACTERSPRITEUNICODE_OFFSET UNITYSDK_OFFSET(0x1ACF0330)
#define TMPRO_TMP_SETTINGS_SET_MISSINGGLYPHCHARACTER_OFFSET UNITYSDK_OFFSET(0x1ACEF620)
#define TMPRO_TMP_SETTINGS_SET_USEMODERNHANGULLINEBREAKINGRULES_OFFSET UNITYSDK_OFFSET(0x1ACF0B60)
#define TMPRO_TMP_SETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACF1590)

namespace TMPro
{
	inline static constexpr unsigned int TMP_Settings_TypeDefinitionIndex = 35997;
	...
	public:
		...
		{
			return (::TMPro::TMP_Settings**)Il2CppClass::FromTypeDefinitionIndex(TMP_Settings_TypeDefinitionIndex)->GetStaticField(0x26BA0);
		}
