...
#define TMPRO_KERNINGTABLE___C__DISPLAYCLASS3_0__ADDKERNINGPAIR_B__0_OFFSET UNITYSDK_OFFSET(0x1B13C200)
#define TMPRO_KERNINGTABLE___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B13C1F0)

namespace TMPro
{
	inline static constexpr unsigned int KerningTable___c__DisplayClass3_0_TypeDefinitionIndex = 35948;
