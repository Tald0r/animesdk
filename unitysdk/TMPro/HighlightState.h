...
#define TMPRO_HIGHLIGHTSTATE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x97B370)
#define TMPRO_HIGHLIGHTSTATE_EQUALS_OFFSET UNITYSDK_OFFSET(0x97B300)
#define TMPRO_HIGHLIGHTSTATE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x97B290)
#define TMPRO_HIGHLIGHTSTATE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B1099C0)
#define TMPRO_HIGHLIGHTSTATE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B109A50)
#define TMPRO_HIGHLIGHTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x30C820)

namespace TMPro
{
	inline static constexpr unsigned int HighlightState_TypeDefinitionIndex = 35914;
