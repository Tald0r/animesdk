...
#define TMPRO_TMP_INPUTFIELD_ONVALIDATEINPUT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19EE7340)
#define TMPRO_TMP_INPUTFIELD_ONVALIDATEINPUT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19EE73C0)
#define TMPRO_TMP_INPUTFIELD_ONVALIDATEINPUT_INVOKE_OFFSET UNITYSDK_OFFSET(0x19EE6D40)
#define TMPRO_TMP_INPUTFIELD_ONVALIDATEINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x19EE6D20)

namespace TMPro
{
	inline static constexpr unsigned int TMP_InputField_OnValidateInput_TypeDefinitionIndex = 36986;
