...
#define TMPRO_TMP_STYLESHEET_GETSTYLE_1_OFFSET UNITYSDK_OFFSET(0x1ACF1A50)
#define TMPRO_TMP_STYLESHEET_GETSTYLE_OFFSET UNITYSDK_OFFSET(0x1ACF19B0)
#define TMPRO_TMP_STYLESHEET_GET_STYLES_OFFSET UNITYSDK_OFFSET(0x1ACF15D0)
#define TMPRO_TMP_STYLESHEET_LOADSTYLEDICTIONARYINTERNAL_OFFSET UNITYSDK_OFFSET(0x1ACF15F0)
#define TMPRO_TMP_STYLESHEET_REFRESHSTYLES_OFFSET UNITYSDK_OFFSET(0x1ACF1B10)
#define TMPRO_TMP_STYLESHEET_RESET_OFFSET UNITYSDK_OFFSET(0x1ACF15E0)
#define TMPRO_TMP_STYLESHEET__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACF1B20)

namespace TMPro
{
	inline static constexpr unsigned int TMP_StyleSheet_TypeDefinitionIndex = 36008;
