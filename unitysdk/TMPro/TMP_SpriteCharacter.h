...
#define TMPRO_TMP_SPRITECHARACTER_GET_HASHCODE_OFFSET UNITYSDK_OFFSET(0x1AE12520)
#define TMPRO_TMP_SPRITECHARACTER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AE123D0)
#define TMPRO_TMP_SPRITECHARACTER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1AE123E0)
#define TMPRO_TMP_SPRITECHARACTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE12540)
#define TMPRO_TMP_SPRITECHARACTER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AE12570)
#define TMPRO_TMP_SPRITECHARACTER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AE125B0)
#define TMPRO_TMP_SPRITECHARACTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE12530)

namespace TMPro
{
	inline static constexpr unsigned int TMP_SpriteCharacter_TypeDefinitionIndex = 36005;
