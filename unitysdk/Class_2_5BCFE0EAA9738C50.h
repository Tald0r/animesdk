...
#define CLASS_2_5BCFE0EAA9738C50_METHOD_2_65367CC4DD011F4E_OFFSET UNITYSDK_OFFSET(0xD09DE40)
#define CLASS_2_5BCFE0EAA9738C50_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0xD09DFC0)
#define CLASS_2_5BCFE0EAA9738C50_METHOD_2_E9A21D244C9D6B36_OFFSET UNITYSDK_OFFSET(0xD09DCE0)
#define CLASS_2_5BCFE0EAA9738C50__CTOR_OFFSET UNITYSDK_OFFSET(0xD09DFB0)

inline static constexpr unsigned int Class_2_5BCFE0EAA9738C50_TypeDefinitionIndex = 56987;

class Class_2_5BCFE0EAA9738C50 : public ::Class_1_EEA0111A28582B57
{
public:
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* Field_2_4; // 0x18
	::UnityEngine::Rendering::Volume* Field_2_5; // 0x20
	::System::Collections::Generic::List_1<::UnityEngine::Transform*>* Field_2_1; // 0x28
	::UnityEngine::GameObject* Field_2_3; // 0x30
	::UnityEngine::Camera* Field_2_0; // 0x38
	::MoleMole::MonoGameSceneObjectMap* Field_2_2; // 0x40
