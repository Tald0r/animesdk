...
#define ARASAMPLES_WALLPLAYERCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ABA6330)
#define ARASAMPLES_WALLPLAYERCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ABA63C0)
#define ARASAMPLES_WALLPLAYERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA6930)

namespace AraSamples
{
	inline static constexpr unsigned int WallPlayerController_TypeDefinitionIndex = 29887;
