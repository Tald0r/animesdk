...
#define ARASAMPLES_WALLPLAYERCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B1B4690)
#define ARASAMPLES_WALLPLAYERCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B1B4720)
#define ARASAMPLES_WALLPLAYERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B4C90)

namespace AraSamples
{
	inline static constexpr unsigned int WallPlayerController_TypeDefinitionIndex = 30840;
