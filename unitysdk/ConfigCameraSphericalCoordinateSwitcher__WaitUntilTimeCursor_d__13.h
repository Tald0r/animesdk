...
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER__WAITUNTILTIMECURSOR_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3927D0)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER__WAITUNTILTIMECURSOR_D__13_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

inline static constexpr unsigned int ConfigCameraSphericalCoordinateSwitcher__WaitUntilTimeCursor_d__13_TypeDefinitionIndex = 78827;
...
struct alignas(8) ConfigCameraSphericalCoordinateSwitcher__WaitUntilTimeCursor_d__13
{
	...
	::ConfigCameraSphericalCoordinateSwitcher* __4__this; // 0x28
