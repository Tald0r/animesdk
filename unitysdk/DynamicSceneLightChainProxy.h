...
#define DYNAMICSCENELIGHTCHAINPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17BE1460)
#define DYNAMICSCENELIGHTCHAINPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17BE13E0)
#define DYNAMICSCENELIGHTCHAINPROXY_TRIGGERLIGHT_OFFSET UNITYSDK_OFFSET(0x17BE14E0)
#define DYNAMICSCENELIGHTCHAINPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x17BE1590)

inline static constexpr unsigned int DynamicSceneLightChainProxy_TypeDefinitionIndex = 28092;
