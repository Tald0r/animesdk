...
#define DYNAMICSCENELIGHTCHAINPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x182C96A0)
#define DYNAMICSCENELIGHTCHAINPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x182C9620)
#define DYNAMICSCENELIGHTCHAINPROXY_TRIGGERLIGHT_OFFSET UNITYSDK_OFFSET(0x182C9720)
#define DYNAMICSCENELIGHTCHAINPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x182C97D0)

inline static constexpr unsigned int DynamicSceneLightChainProxy_TypeDefinitionIndex = 29032;
