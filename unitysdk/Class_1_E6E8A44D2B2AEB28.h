...
#define CLASS_1_E6E8A44D2B2AEB28_METHOD_1_3E7178C5ECF017DB_OFFSET UNITYSDK_OFFSET(0x84C9760)
#define CLASS_1_E6E8A44D2B2AEB28_METHOD_1_5C42E9BE9928BBD1_OFFSET UNITYSDK_OFFSET(0x84C97D0)
#define CLASS_1_E6E8A44D2B2AEB28_METHOD_1_729BA3A7B36168F1_OFFSET UNITYSDK_OFFSET(0x84C96B0)
#define CLASS_1_E6E8A44D2B2AEB28__CTOR_OFFSET UNITYSDK_OFFSET(0x84C9640)

inline static constexpr unsigned int Class_1_E6E8A44D2B2AEB28_TypeDefinitionIndex = 52946;
...
public:
	...
	::System::IO::MemoryStream* Method_1_5C42E9BE9928BBD1(::Class_1_79B32D340B0895B6* a1)
	{
		return ((::System::IO::MemoryStream*(*)(::PVOID, ::Class_1_79B32D340B0895B6*))((::PBYTE)hIl2Cpp + CLASS_1_E6E8A44D2B2AEB28_METHOD_1_5C42E9BE9928BBD1_OFFSET))(this, a1);
	}
};
