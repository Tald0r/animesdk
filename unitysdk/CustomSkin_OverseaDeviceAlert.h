...
#define CUSTOMSKIN_OVERSEADEVICEALERT_CLICKBACKBTN_OFFSET UNITYSDK_OFFSET(0x6F6E2A0)
#define CUSTOMSKIN_OVERSEADEVICEALERT_CLICKBIND_OFFSET UNITYSDK_OFFSET(0x6F6E0C0)
#define CUSTOMSKIN_OVERSEADEVICEALERT_CLICKCLOSEBTN_OFFSET UNITYSDK_OFFSET(0x6F6E340)
#define CUSTOMSKIN_OVERSEADEVICEALERT_CLICKNOW_OFFSET UNITYSDK_OFFSET(0x6F6E020)
#define CUSTOMSKIN_OVERSEADEVICEALERT_INSTANCE_OFFSET UNITYSDK_OFFSET(0x6F6CF70)
#define CUSTOMSKIN_OVERSEADEVICEALERT_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x6F6D0F0)
#define CUSTOMSKIN_OVERSEADEVICEALERT_ONCONSOLECANCEL_OFFSET UNITYSDK_OFFSET(0x6F6E3E0)
#define CUSTOMSKIN_OVERSEADEVICEALERT_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6F6D170)
#define CUSTOMSKIN_OVERSEADEVICEALERT_SETDEVICELIST_OFFSET UNITYSDK_OFFSET(0x6F6DCE0)
#define CUSTOMSKIN_OVERSEADEVICEALERT_SETNOTICE_OFFSET UNITYSDK_OFFSET(0x6F6DB50)
#define CUSTOMSKIN_OVERSEADEVICEALERT__CTOR_OFFSET UNITYSDK_OFFSET(0x6F6D070)

inline static constexpr unsigned int CustomSkin_OverseaDeviceAlert_TypeDefinitionIndex = 49487;
...
public:
	...
	{
		return (::CustomSkin_OverseaDeviceAlert**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_OverseaDeviceAlert_TypeDefinitionIndex)->GetStaticField(0x47020);
	}
