...
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDBYTESTOSHAREDVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x1ABE6530)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDBYTESTOSHAREDVARIABLE_OFFSET UNITYSDK_OFFSET(0x1ABE47B0)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOADFIELDS_OFFSET UNITYSDK_OFFSET(0x1ABE7250)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOADTASK_OFFSET UNITYSDK_OFFSET(0x1ABE49A0)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_1_OFFSET UNITYSDK_OFFSET(0x1ABE57E0)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_OFFSET UNITYSDK_OFFSET(0x1ABE2E50)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_TRYGETFIELDINDEX_OFFSET UNITYSDK_OFFSET(0x1ABE6320)

inline static constexpr unsigned int BinaryDeserialization_PrecompiledDeserialization_TypeDefinitionIndex = 31128;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::BehaviorDesigner::Runtime::TaskFieldAssigner>**)Il2CppClass::FromTypeDefinitionIndex(BinaryDeserialization_PrecompiledDeserialization_TypeDefinitionIndex)->GetStaticField(0x24EB0);
	}
