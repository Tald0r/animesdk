...
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDBYTESTOSHAREDVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x1A63B320)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDBYTESTOSHAREDVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A6395A0)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOADFIELDS_OFFSET UNITYSDK_OFFSET(0x1A63C040)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOADTASK_OFFSET UNITYSDK_OFFSET(0x1A639790)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_1_OFFSET UNITYSDK_OFFSET(0x1A63A5D0)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_PRECOMPILEDLOAD_OFFSET UNITYSDK_OFFSET(0x1A637C40)
#define BINARYDESERIALIZATION_PRECOMPILEDDESERIALIZATION_TRYGETFIELDINDEX_OFFSET UNITYSDK_OFFSET(0x1A63B110)

inline static constexpr unsigned int BinaryDeserialization_PrecompiledDeserialization_TypeDefinitionIndex = 30175;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::BehaviorDesigner::Runtime::TaskFieldAssigner>**)Il2CppClass::FromTypeDefinitionIndex(BinaryDeserialization_PrecompiledDeserialization_TypeDefinitionIndex)->GetStaticField(0x23590);
	}
