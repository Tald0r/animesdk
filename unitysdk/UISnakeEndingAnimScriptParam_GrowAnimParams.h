...
#define UISNAKEENDINGANIMSCRIPTPARAM_GROWANIMPARAMS_CALVALUEBYEVALUATECURVE_OFFSET UNITYSDK_OFFSET(0x19BA04D0)
#define UISNAKEENDINGANIMSCRIPTPARAM_GROWANIMPARAMS_EVALUATE_OFFSET UNITYSDK_OFFSET(0x19BA0540)
#define UISNAKEENDINGANIMSCRIPTPARAM_GROWANIMPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x19BA05B0)

inline static constexpr unsigned int UISnakeEndingAnimScriptParam_GrowAnimParams_TypeDefinitionIndex = 83651;
