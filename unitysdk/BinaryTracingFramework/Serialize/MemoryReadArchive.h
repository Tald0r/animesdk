...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYREADARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1ABAC580)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYREADARCHIVE_INIT_OFFSET UNITYSDK_OFFSET(0x1ABA7A50)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYREADARCHIVE_RESET_OFFSET UNITYSDK_OFFSET(0x1ABAC5B0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYREADARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABAC4B0)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int MemoryReadArchive_TypeDefinitionIndex = 30947;
