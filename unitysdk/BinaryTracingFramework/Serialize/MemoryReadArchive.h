...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYREADARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1B1D3A50)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYREADARCHIVE_INIT_OFFSET UNITYSDK_OFFSET(0x1B1CEF30)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYREADARCHIVE_RESET_OFFSET UNITYSDK_OFFSET(0x1B1D3A80)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYREADARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D3980)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int MemoryReadArchive_TypeDefinitionIndex = 31899;
