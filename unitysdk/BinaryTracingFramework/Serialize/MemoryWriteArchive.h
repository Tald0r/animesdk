...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1B1D3AD0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x1B1CEED0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1B1CEF00)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x1B1D3B90)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_RESET_OFFSET UNITYSDK_OFFSET(0x1B1D23E0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1B1D2410)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1B1D2440)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1B1D24B0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_4_OFFSET UNITYSDK_OFFSET(0x1B1D2470)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_5_OFFSET UNITYSDK_OFFSET(0x1B1D3B00)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_6_OFFSET UNITYSDK_OFFSET(0x1B1D3B30)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_7_OFFSET UNITYSDK_OFFSET(0x1B1D3B60)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1CFEF0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1D1FC0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D20E0)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int MemoryWriteArchive_TypeDefinitionIndex = 31897;
