...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1ABAC600)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x1ABA79F0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1ABA7A20)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_GETSTREAM_OFFSET UNITYSDK_OFFSET(0x1ABAC6C0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_RESET_OFFSET UNITYSDK_OFFSET(0x1ABAAF10)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1ABAAF40)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1ABAAF70)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1ABAAFE0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_4_OFFSET UNITYSDK_OFFSET(0x1ABAAFA0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_5_OFFSET UNITYSDK_OFFSET(0x1ABAC630)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_6_OFFSET UNITYSDK_OFFSET(0x1ABAC660)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_7_OFFSET UNITYSDK_OFFSET(0x1ABAC690)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABA8A10)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ABAAAF0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_MEMORYWRITEARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABAAC10)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int MemoryWriteArchive_TypeDefinitionIndex = 30945;
