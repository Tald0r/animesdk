...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_COMMONREADARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1B1D3930)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_COMMONREADARCHIVE_INIT_OFFSET UNITYSDK_OFFSET(0x1B1D38C0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_COMMONREADARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D3840)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int CommonReadArchive_TypeDefinitionIndex = 31900;
