...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_COMMONREADARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1ABAC460)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_COMMONREADARCHIVE_INIT_OFFSET UNITYSDK_OFFSET(0x1ABAC3F0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_COMMONREADARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABAC370)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int CommonReadArchive_TypeDefinitionIndex = 30948;
