...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_SERIALIZEOBJECTREF_GETTYPEGUID_OFFSET UNITYSDK_OFFSET(0x95C370)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_SERIALIZEOBJECTREF_GET_SERIALIZEABLESUCCESS_OFFSET UNITYSDK_OFFSET(0x31FD90)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_SERIALIZEOBJECTREF_RESET_OFFSET UNITYSDK_OFFSET(0x95C360)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_SERIALIZEOBJECTREF_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x95C350)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_SERIALIZEOBJECTREF_SET_SERIALIZEABLESUCCESS_OFFSET UNITYSDK_OFFSET(0x31FDA0)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int SerializeObjectRef_TypeDefinitionIndex = 30944;
