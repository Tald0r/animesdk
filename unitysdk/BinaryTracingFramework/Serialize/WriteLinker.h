...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_WRITELINKER_FLUSH_OFFSET UNITYSDK_OFFSET(0x1ABAB950)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_WRITELINKER_PUSHSERIALIZEOBJ_OFFSET UNITYSDK_OFFSET(0x1ABABA20)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_WRITELINKER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ABAB5F0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_WRITELINKER_WRITETOFILE_OFFSET UNITYSDK_OFFSET(0x1ABAD370)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_WRITELINKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABAB1D0)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int WriteLinker_TypeDefinitionIndex = 30955;

	class WriteLinker : public ::System::Object
	{
	public:
		::System::Threading::Tasks::Task* WriteTask; // 0x10
