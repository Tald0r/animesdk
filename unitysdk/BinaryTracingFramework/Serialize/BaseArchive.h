...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BASEARCHIVE_GET_ARISLOADING_OFFSET UNITYSDK_OFFSET(0x1B1D3680)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BASEARCHIVE_SET_ARISLOADING_OFFSET UNITYSDK_OFFSET(0x1B1D3690)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BASEARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D36A0)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int BaseArchive_TypeDefinitionIndex = 31892;
