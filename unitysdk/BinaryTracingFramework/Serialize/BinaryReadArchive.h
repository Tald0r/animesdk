...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1ABAC260)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1ABA7AE0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1ABA7B60)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1ABA7B20)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_4_OFFSET UNITYSDK_OFFSET(0x1ABA7BA0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_5_OFFSET UNITYSDK_OFFSET(0x1ABAC2B0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_6_OFFSET UNITYSDK_OFFSET(0x1ABAC2F0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_7_OFFSET UNITYSDK_OFFSET(0x1ABAC330)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABAC270)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SETUP_OFFSET UNITYSDK_OFFSET(0x1ABAC1F0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABAC1E0)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int BinaryReadArchive_TypeDefinitionIndex = 30946;
