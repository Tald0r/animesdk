...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_CONTENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1B1D3730)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1B1CEFC0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x1B1CF040)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x1B1CF000)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_4_OFFSET UNITYSDK_OFFSET(0x1B1CF080)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_5_OFFSET UNITYSDK_OFFSET(0x1B1D3780)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_6_OFFSET UNITYSDK_OFFSET(0x1B1D37C0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_7_OFFSET UNITYSDK_OFFSET(0x1B1D3800)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1D3740)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE_SETUP_OFFSET UNITYSDK_OFFSET(0x1B1D36C0)
#define BINARYTRACINGFRAMEWORK_SERIALIZE_BINARYREADARCHIVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D36B0)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int BinaryReadArchive_TypeDefinitionIndex = 31898;
