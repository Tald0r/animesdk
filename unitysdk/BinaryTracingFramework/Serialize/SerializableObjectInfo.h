...
#define BINARYTRACINGFRAMEWORK_SERIALIZE_SERIALIZABLEOBJECTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABAC8A0)

namespace BinaryTracingFramework::Serialize
{
	inline static constexpr unsigned int SerializableObjectInfo_TypeDefinitionIndex = 30951;
