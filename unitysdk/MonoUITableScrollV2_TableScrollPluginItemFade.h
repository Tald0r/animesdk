...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_CLEARCOROUTINES_OFFSET UNITYSDK_OFFSET(0x6063F20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_ANIMSHOWALL_OFFSET UNITYSDK_OFFSET(0x6061B60)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_CALFADEINTIME_OFFSET UNITYSDK_OFFSET(0x6061AD0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_CALFADEOUTTIME_OFFSET UNITYSDK_OFFSET(0x6061D50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x6061E40)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_DONTPLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x6061C10)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_FADEINANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x60619B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_FADEINTERVAL_OFFSET UNITYSDK_OFFSET(0x6061A40)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_FADEOUTANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x6061C30)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_FADEOUTINTERVAL_OFFSET UNITYSDK_OFFSET(0x6061CC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x6061E20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_ISPLAYINGFADEINANIM_OFFSET UNITYSDK_OFFSET(0x60618A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_ISPLAYINGFADEOUT_OFFSET UNITYSDK_OFFSET(0x6061880)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_ITEMFADEINDELAYTIME_OFFSET UNITYSDK_OFFSET(0x6061B80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_LOGIC_OFFSET UNITYSDK_OFFSET(0x6061E00)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_M_DATAS_OFFSET UNITYSDK_OFFSET(0x6061E80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_M_ISDESTROY_OFFSET UNITYSDK_OFFSET(0x6066440)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_SIMPLEMODE_OFFSET UNITYSDK_OFFSET(0x6061DE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_SKIPFADEIN_OFFSET UNITYSDK_OFFSET(0x6061990)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET__DATAMAP_OFFSET UNITYSDK_OFFSET(0x6061E60)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_LATEPLAYITEMANIM_OFFSET UNITYSDK_OFFSET(0x60659F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_LATEPLAYPAGESHOWANIMATION_OFFSET UNITYSDK_OFFSET(0x6062610)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6061930)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_ONINITDATA_OFFSET UNITYSDK_OFFSET(0x60618C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYCELLFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x6065AD0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATIONWITHOUTEXPAND_OFFSET UNITYSDK_OFFSET(0x60640B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATION_1_OFFSET UNITYSDK_OFFSET(0x60626D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATION_2_OFFSET UNITYSDK_OFFSET(0x60623E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATION_3_OFFSET UNITYSDK_OFFSET(0x6065270)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x6062140)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEOUTANIMATION_1_OFFSET UNITYSDK_OFFSET(0x6063EA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x6063350)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEOUTWITHOUTEXPAND_OFFSET UNITYSDK_OFFSET(0x6063650)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_RESETUIANIMCELL_OFFSET UNITYSDK_OFFSET(0x6064970)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SAMPLEANIMATIONTOSTART_1_OFFSET UNITYSDK_OFFSET(0x6064A60)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SAMPLEANIMATIONTOSTART_OFFSET UNITYSDK_OFFSET(0x60661C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SETFADEINANIMATIONTOFIRSTFRAMEWITHOUTEXPAND_OFFSET UNITYSDK_OFFSET(0x6061F80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SETFADEINANIMATIONTOFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0x6061EA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SET_ISPLAYINGFADEINANIM_OFFSET UNITYSDK_OFFSET(0x60618B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SET_ISPLAYINGFADEOUT_OFFSET UNITYSDK_OFFSET(0x6061890)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SET_M_ISDESTROY_OFFSET UNITYSDK_OFFSET(0x6066450)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_STOPANIMATION_OFFSET UNITYSDK_OFFSET(0x6062740)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__CTOR_OFFSET UNITYSDK_OFFSET(0x6061840)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__PLAYFADEINANIMATION_B__51_0_OFFSET UNITYSDK_OFFSET(0x6066460)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__SHOWNEXTANIMATION_OFFSET UNITYSDK_OFFSET(0x6065950)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x60664E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE___BASE_ONINITDATA_OFFSET UNITYSDK_OFFSET(0x6066540)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginItemFade_TypeDefinitionIndex = 43840;
...
public:
	...
	::System::Int32 _animOffset; // 0x28
	::System::Single _fadeInAnimLength; // 0x2C
	::System::Single _fadeOutAnimLength; // 0x30
	::System::Boolean _isPlayingFadeInAnim_k__BackingField; // 0x34
	::System::Boolean _isPlayingFadeOut_k__BackingField; // 0x35
	::System::Boolean _m_isDestroy_k__BackingField; // 0x36
