...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_CLEARCOROUTINES_OFFSET UNITYSDK_OFFSET(0x7BF9110)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_ANIMSHOWALL_OFFSET UNITYSDK_OFFSET(0x7BF6D50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_CALFADEINTIME_OFFSET UNITYSDK_OFFSET(0x7BF6CC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_CALFADEOUTTIME_OFFSET UNITYSDK_OFFSET(0x7BF6F40)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x7BF7030)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_DONTPLAYFADEOUT_OFFSET UNITYSDK_OFFSET(0x7BF6E00)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_FADEINANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x7BF6BA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_FADEINTERVAL_OFFSET UNITYSDK_OFFSET(0x7BF6C30)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_FADEOUTANIMATIONNAME_OFFSET UNITYSDK_OFFSET(0x7BF6E20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_FADEOUTINTERVAL_OFFSET UNITYSDK_OFFSET(0x7BF6EB0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_GAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x7BF7010)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_ISPLAYINGFADEINANIM_OFFSET UNITYSDK_OFFSET(0x7BF6A90)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_ISPLAYINGFADEOUT_OFFSET UNITYSDK_OFFSET(0x7BF6A70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_ITEMFADEINDELAYTIME_OFFSET UNITYSDK_OFFSET(0x7BF6D70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_LOGIC_OFFSET UNITYSDK_OFFSET(0x7BF6FF0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_M_DATAS_OFFSET UNITYSDK_OFFSET(0x7BF7070)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_M_ISDESTROY_OFFSET UNITYSDK_OFFSET(0x7BFB630)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_SIMPLEMODE_OFFSET UNITYSDK_OFFSET(0x7BF6FD0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET_SKIPFADEIN_OFFSET UNITYSDK_OFFSET(0x7BF6B80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_GET__DATAMAP_OFFSET UNITYSDK_OFFSET(0x7BF7050)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_LATEPLAYITEMANIM_OFFSET UNITYSDK_OFFSET(0x7BFABE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_LATEPLAYPAGESHOWANIMATION_OFFSET UNITYSDK_OFFSET(0x7BF7800)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x7BF6B20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_ONINITDATA_OFFSET UNITYSDK_OFFSET(0x7BF6AB0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYCELLFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x7BFACC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATIONWITHOUTEXPAND_OFFSET UNITYSDK_OFFSET(0x7BF92A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATION_1_OFFSET UNITYSDK_OFFSET(0x7BF78C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATION_2_OFFSET UNITYSDK_OFFSET(0x7BF75D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATION_3_OFFSET UNITYSDK_OFFSET(0x7BFA460)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEINANIMATION_OFFSET UNITYSDK_OFFSET(0x7BF7330)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEOUTANIMATION_1_OFFSET UNITYSDK_OFFSET(0x7BF9090)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x7BF8540)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_PLAYFADEOUTWITHOUTEXPAND_OFFSET UNITYSDK_OFFSET(0x7BF8840)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_RESETUIANIMCELL_OFFSET UNITYSDK_OFFSET(0x7BF9B60)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SAMPLEANIMATIONTOSTART_1_OFFSET UNITYSDK_OFFSET(0x7BF9C50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SAMPLEANIMATIONTOSTART_OFFSET UNITYSDK_OFFSET(0x7BFB3B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SETFADEINANIMATIONTOFIRSTFRAMEWITHOUTEXPAND_OFFSET UNITYSDK_OFFSET(0x7BF7170)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SETFADEINANIMATIONTOFIRSTFRAME_OFFSET UNITYSDK_OFFSET(0x7BF7090)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SET_ISPLAYINGFADEINANIM_OFFSET UNITYSDK_OFFSET(0x7BF6AA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SET_ISPLAYINGFADEOUT_OFFSET UNITYSDK_OFFSET(0x7BF6A80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_SET_M_ISDESTROY_OFFSET UNITYSDK_OFFSET(0x7BFB640)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE_STOPANIMATION_OFFSET UNITYSDK_OFFSET(0x7BF7930)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__CTOR_OFFSET UNITYSDK_OFFSET(0x7BF6A30)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__PLAYFADEINANIMATION_B__51_0_OFFSET UNITYSDK_OFFSET(0x7BFB650)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE__SHOWNEXTANIMATION_OFFSET UNITYSDK_OFFSET(0x7BFAB40)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x7BFB6D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINITEMFADE___BASE_ONINITDATA_OFFSET UNITYSDK_OFFSET(0x7BFB730)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginItemFade_TypeDefinitionIndex = 64401;
...
public:
	...
	::System::Single _fadeOutAnimLength; // 0x28
	::System::Boolean _m_isDestroy_k__BackingField; // 0x2C
	::System::Boolean _isPlayingFadeInAnim_k__BackingField; // 0x2D
	::System::Boolean _isPlayingFadeOut_k__BackingField; // 0x2E
	::System::Single _fadeInAnimLength; // 0x30
	::System::Int32 _animOffset; // 0x34
