...
#define MATANIMATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x9B90320)
#define MATANIMATION_GET_TARGETMATERIAL_OFFSET UNITYSDK_OFFSET(0x9B90230)
#define MATANIMATION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9B904C0)
#define MATANIMATION_RECOVERMATPROPERTY_OFFSET UNITYSDK_OFFSET(0x9B90580)
#define MATANIMATION_SETMAT_OFFSET UNITYSDK_OFFSET(0x9B90640)
#define MATANIMATION_STARTANIMATION_OFFSET UNITYSDK_OFFSET(0x9B903A0)
#define MATANIMATION_STOPANIMATION_OFFSET UNITYSDK_OFFSET(0x9B90700)
#define MATANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x9B90770)

inline static constexpr unsigned int MatAnimation_TypeDefinitionIndex = 42740;
