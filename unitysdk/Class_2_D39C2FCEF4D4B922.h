...
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_002A3C2EF46C74CF_OFFSET UNITYSDK_OFFSET(0x6402680)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_04DC58A6E3312864_OFFSET UNITYSDK_OFFSET(0x6402AD0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_0841DD481C9E7631_OFFSET UNITYSDK_OFFSET(0x63FF5E0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_0CC78D4556EB7518_OFFSET UNITYSDK_OFFSET(0x63FFF40)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_0ECCCB67C31BD45B_OFFSET UNITYSDK_OFFSET(0x64013E0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x6401360)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_2541F0C25622ECD9_OFFSET UNITYSDK_OFFSET(0x63FF100)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_25EC27153ED46963_OFFSET UNITYSDK_OFFSET(0x6400E90)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_377FB896229E27DD_OFFSET UNITYSDK_OFFSET(0x6402720)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_3A43654647DF6A74_OFFSET UNITYSDK_OFFSET(0x63FFE90)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_3AF977ABBC8283D6_OFFSET UNITYSDK_OFFSET(0x6402160)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_421ECE05A9FEB34D_OFFSET UNITYSDK_OFFSET(0x63FF510)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_42F584F3983A9ACF_OFFSET UNITYSDK_OFFSET(0x6401200)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_4DA895CFB760E2A1_1_OFFSET UNITYSDK_OFFSET(0x6402400)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_4DA895CFB760E2A1_2_OFFSET UNITYSDK_OFFSET(0x6402B40)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_4DA895CFB760E2A1_OFFSET UNITYSDK_OFFSET(0x6400C90)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_575495378A53B008_OFFSET UNITYSDK_OFFSET(0x64021E0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_5EF9DDA5070B0261_OFFSET UNITYSDK_OFFSET(0x63FF320)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_656CD7CD7E175989_OFFSET UNITYSDK_OFFSET(0x6400040)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_70459B7C790C82DB_OFFSET UNITYSDK_OFFSET(0x6401DC0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_79830F666EE579C0_OFFSET UNITYSDK_OFFSET(0x6402560)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_9818E41BDCF3063A_OFFSET UNITYSDK_OFFSET(0x63FFC00)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_991C84568C655F51_OFFSET UNITYSDK_OFFSET(0x64020D0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x63FEF30)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_AA8656BCDBBD4870_OFFSET UNITYSDK_OFFSET(0x6401370)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_AF83D5EA21386D95_OFFSET UNITYSDK_OFFSET(0x64018F0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_B7F8E960CB973ADC_OFFSET UNITYSDK_OFFSET(0x63FF800)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_CF242B0F311AA6EB_OFFSET UNITYSDK_OFFSET(0x6401F40)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_CF6EEB0206D60DE3_OFFSET UNITYSDK_OFFSET(0x6400DF0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_DA624ED5E7AFDE43_1_OFFSET UNITYSDK_OFFSET(0x6401180)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_DA624ED5E7AFDE43_OFFSET UNITYSDK_OFFSET(0x63FFE10)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_DD360325DD9325C8_OFFSET UNITYSDK_OFFSET(0x64019B0)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_E1101755D700590F_OFFSET UNITYSDK_OFFSET(0x63FEF40)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_EDBFE3C4D4F7A857_OFFSET UNITYSDK_OFFSET(0x6401D40)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_F343EB366B5A896D_OFFSET UNITYSDK_OFFSET(0x6402A50)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_F7A2740694EB100F_OFFSET UNITYSDK_OFFSET(0x6401010)
#define CLASS_2_D39C2FCEF4D4B922_METHOD_2_FFFEA3B2FB2730AD_OFFSET UNITYSDK_OFFSET(0x6401CF0)
#define CLASS_2_D39C2FCEF4D4B922__CTOR_OFFSET UNITYSDK_OFFSET(0x64008F0)

inline static constexpr unsigned int Class_2_D39C2FCEF4D4B922_TypeDefinitionIndex = 43205;

class Class_2_D39C2FCEF4D4B922 : public ::Class_1_2A3859B4230FECE9
{
public:
	::MoleMole::CameraDelayDatas* Field_2_8; // 0x38
	::MoleMole::CameraDelayDatas* Field_2_6; // 0x40
	::MoleMole::CameraDelayDatas* Field_2_10; // 0x48
	::Class_1_A422B5C99AB5650D* Field_2_3; // 0x50
	::MoleMole::CameraDelayDatas* Field_2_9; // 0x58
	::Class_1_9DAA93B261093A09* Field_2_12; // 0x60
	::MoleMole::Cameras::CameraDelayMoveDataBlendDefinition Field_2_2; // 0x68
	::MoleMole::Cameras::NapVirtual3DActionCamera_1* Field_2_0; // 0x80
	::System::Collections::Generic::List_1<::Class_1_4E9B72F06BA2FBA2*>* Field_2_4; // 0x88
	::Class_1_9DAA93B261093A09* Field_2_1; // 0x90
	::MoleMole::CameraDelayDatas* Field_2_7; // 0x98
	::Cinemachine::CameraState Field_2_11; // 0xA0
