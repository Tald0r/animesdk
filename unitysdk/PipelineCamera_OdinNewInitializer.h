...
#define PIPELINECAMERA_ODINNEWINITIALIZER_INITODINNEW_OFFSET UNITYSDK_OFFSET(0x1A44D310)
#define PIPELINECAMERA_ODINNEWINITIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A44D530)

inline static constexpr unsigned int PipelineCamera_OdinNewInitializer_TypeDefinitionIndex = 34319;
