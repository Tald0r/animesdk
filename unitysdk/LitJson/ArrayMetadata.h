...
#define LITJSON_ARRAYMETADATA_GET_ELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x8B8380)
#define LITJSON_ARRAYMETADATA_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x34AA60)
#define LITJSON_ARRAYMETADATA_GET_ISLIST_OFFSET UNITYSDK_OFFSET(0x31B120)
#define LITJSON_ARRAYMETADATA_SET_ELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define LITJSON_ARRAYMETADATA_SET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x34AA50)
#define LITJSON_ARRAYMETADATA_SET_ISLIST_OFFSET UNITYSDK_OFFSET(0x91DE80)

namespace LitJson
{
	inline static constexpr unsigned int ArrayMetadata_TypeDefinitionIndex = 8312;
