...
#define LITJSON_JSONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEC0B50)
#define LITJSON_JSONEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AEC0C30)
#define LITJSON_JSONEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AEC0D10)
#define LITJSON_JSONEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1AEC0DF0)
#define LITJSON_JSONEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1AEC0ED0)
#define LITJSON_JSONEXCEPTION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1AEC0F40)
#define LITJSON_JSONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEC0AB0)

namespace LitJson
{
	inline static constexpr unsigned int JsonException_TypeDefinitionIndex = 8321;
