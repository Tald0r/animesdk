...
#define LITJSON_JSONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A998370)
#define LITJSON_JSONEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A998450)
#define LITJSON_JSONEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A998530)
#define LITJSON_JSONEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A998610)
#define LITJSON_JSONEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A9986F0)
#define LITJSON_JSONEXCEPTION__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1A998760)
#define LITJSON_JSONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9982D0)

namespace LitJson
{
	inline static constexpr unsigned int JsonException_TypeDefinitionIndex = 8216;
