...
#define LITJSON_OBJECTMETADATA_GET_ELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x8B8380)
#define LITJSON_OBJECTMETADATA_GET_ISDICTIONARY_OFFSET UNITYSDK_OFFSET(0x34AA60)
#define LITJSON_OBJECTMETADATA_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define LITJSON_OBJECTMETADATA_SET_ELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define LITJSON_OBJECTMETADATA_SET_ISDICTIONARY_OFFSET UNITYSDK_OFFSET(0x34AA50)
#define LITJSON_OBJECTMETADATA_SET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x3123A0)

namespace LitJson
{
	inline static constexpr unsigned int ObjectMetadata_TypeDefinitionIndex = 7891;
