...
#define LITJSON_JSONMOCKWRAPPER_GETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x19780440)
#define LITJSON_JSONMOCKWRAPPER_GETCOMMENT_OFFSET UNITYSDK_OFFSET(0x197804A0)
#define LITJSON_JSONMOCKWRAPPER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x19780450)
#define LITJSON_JSONMOCKWRAPPER_GETINT_OFFSET UNITYSDK_OFFSET(0x19780460)
#define LITJSON_JSONMOCKWRAPPER_GETJSONTYPE_OFFSET UNITYSDK_OFFSET(0x19780470)
#define LITJSON_JSONMOCKWRAPPER_GETLONG_OFFSET UNITYSDK_OFFSET(0x19780480)
#define LITJSON_JSONMOCKWRAPPER_GETSTRING_OFFSET UNITYSDK_OFFSET(0x19780490)
#define LITJSON_JSONMOCKWRAPPER_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x197803D0)
#define LITJSON_JSONMOCKWRAPPER_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0x197803E0)
#define LITJSON_JSONMOCKWRAPPER_GET_ISDOUBLE_OFFSET UNITYSDK_OFFSET(0x197803F0)
#define LITJSON_JSONMOCKWRAPPER_GET_ISINT_OFFSET UNITYSDK_OFFSET(0x19780400)
#define LITJSON_JSONMOCKWRAPPER_GET_ISLONG_OFFSET UNITYSDK_OFFSET(0x19780410)
#define LITJSON_JSONMOCKWRAPPER_GET_ISOBJECT_OFFSET UNITYSDK_OFFSET(0x19780420)
#define LITJSON_JSONMOCKWRAPPER_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x19780430)
#define LITJSON_JSONMOCKWRAPPER_SETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x197804B0)
#define LITJSON_JSONMOCKWRAPPER_SETCOMMENT_OFFSET UNITYSDK_OFFSET(0x19780510)
#define LITJSON_JSONMOCKWRAPPER_SETDOUBLE_OFFSET UNITYSDK_OFFSET(0x197804C0)
#define LITJSON_JSONMOCKWRAPPER_SETINT_OFFSET UNITYSDK_OFFSET(0x197804D0)
#define LITJSON_JSONMOCKWRAPPER_SETJSONTYPE_OFFSET UNITYSDK_OFFSET(0x197804E0)
#define LITJSON_JSONMOCKWRAPPER_SETLONG_OFFSET UNITYSDK_OFFSET(0x197804F0)
#define LITJSON_JSONMOCKWRAPPER_SETSTRING_OFFSET UNITYSDK_OFFSET(0x19780500)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x19780620)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x197805F0)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19780600)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x19780610)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_IDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x197806A0)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_IDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0x197806B0)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_IDICTIONARY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x197806C0)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_IDICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x197806E0)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x19780640)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x19780650)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19780680)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_IDICTIONARY_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x19780660)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_IDICTIONARY_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x19780670)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_IDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x197806D0)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_IDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19780690)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19780630)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x19780580)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ILIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x19780590)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ILIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x197805A0)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ILIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x19780540)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ILIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x19780550)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19780560)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ILIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x197805B0)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x197805C0)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ILIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x197805E0)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x197805D0)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19780570)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19780710)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x197806F0)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_INSERT_OFFSET UNITYSDK_OFFSET(0x19780720)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x19780730)
#define LITJSON_JSONMOCKWRAPPER_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19780700)
#define LITJSON_JSONMOCKWRAPPER_TOJSON_1_OFFSET UNITYSDK_OFFSET(0x19780530)
#define LITJSON_JSONMOCKWRAPPER_TOJSON_OFFSET UNITYSDK_OFFSET(0x19780520)
#define LITJSON_JSONMOCKWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1977F1A0)

namespace LitJson
{
	inline static constexpr unsigned int JsonMockWrapper_TypeDefinitionIndex = 8289;
