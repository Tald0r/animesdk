...
#define LITJSON_UNITYTYPEBINDINGS___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC64A0)
#define LITJSON_UNITYTYPEBINDINGS___C__DISPLAYCLASS1_0__REGISTER_B__10_OFFSET UNITYSDK_OFFSET(0x1ABC6580)
#define LITJSON_UNITYTYPEBINDINGS___C__DISPLAYCLASS1_0__REGISTER_B__3_OFFSET UNITYSDK_OFFSET(0x1ABC64B0)
#define LITJSON_UNITYTYPEBINDINGS___C__DISPLAYCLASS1_0__REGISTER_B__5_OFFSET UNITYSDK_OFFSET(0x1ABC6510)

namespace LitJson
{
	inline static constexpr unsigned int UnityTypeBindings___c__DisplayClass1_0_TypeDefinitionIndex = 8292;
