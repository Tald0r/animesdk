...
#define LITJSON_JSONDATA_ADD_OFFSET UNITYSDK_OFFSET(0x1977D110)
#define LITJSON_JSONDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x1977EA90)
#define LITJSON_JSONDATA_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x19779BF0)
#define LITJSON_JSONDATA_ENSURECOLLECTION_OFFSET UNITYSDK_OFFSET(0x19779670)
#define LITJSON_JSONDATA_ENSUREDICTIONARY_OFFSET UNITYSDK_OFFSET(0x19779AA0)
#define LITJSON_JSONDATA_ENSURELIST_OFFSET UNITYSDK_OFFSET(0x1977AAE0)
#define LITJSON_JSONDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x1977EB90)
#define LITJSON_JSONDATA_GETCOMMENT_OFFSET UNITYSDK_OFFSET(0x1977CE80)
#define LITJSON_JSONDATA_GETJSONTYPE_OFFSET UNITYSDK_OFFSET(0x1977ED50)
#define LITJSON_JSONDATA_GET_ASBOOLEAN_OFFSET UNITYSDK_OFFSET(0x19779740)
#define LITJSON_JSONDATA_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x19779840)
#define LITJSON_JSONDATA_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x197797C0)
#define LITJSON_JSONDATA_GET_ASINT_OFFSET UNITYSDK_OFFSET(0x19779850)
#define LITJSON_JSONDATA_GET_ASLONG_OFFSET UNITYSDK_OFFSET(0x197798D0)
#define LITJSON_JSONDATA_GET_ASSTRING_OFFSET UNITYSDK_OFFSET(0x19779960)
#define LITJSON_JSONDATA_GET_COMMENT_OFFSET UNITYSDK_OFFSET(0x197799D0)
#define LITJSON_JSONDATA_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x197795C0)
#define LITJSON_JSONDATA_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x19779720)
#define LITJSON_JSONDATA_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0x19779730)
#define LITJSON_JSONDATA_GET_ISDOUBLE_OFFSET UNITYSDK_OFFSET(0x197797B0)
#define LITJSON_JSONDATA_GET_ISINT_OFFSET UNITYSDK_OFFSET(0x19779830)
#define LITJSON_JSONDATA_GET_ISLONG_OFFSET UNITYSDK_OFFSET(0x197798C0)
#define LITJSON_JSONDATA_GET_ISOBJECT_OFFSET UNITYSDK_OFFSET(0x19779940)
#define LITJSON_JSONDATA_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x19779950)
#define LITJSON_JSONDATA_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1977BAF0)
#define LITJSON_JSONDATA_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1977BA40)
#define LITJSON_JSONDATA_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x197799F0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1977CC10)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1977CC80)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETINT_OFFSET UNITYSDK_OFFSET(0x1977CCF0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETLONG_OFFSET UNITYSDK_OFFSET(0x1977CD60)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GETSTRING_OFFSET UNITYSDK_OFFSET(0x1977CDD0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISARRAY_OFFSET UNITYSDK_OFFSET(0x1977A9C0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1977A9D0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISDOUBLE_OFFSET UNITYSDK_OFFSET(0x1977A9E0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISINT_OFFSET UNITYSDK_OFFSET(0x1977A9F0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISLONG_OFFSET UNITYSDK_OFFSET(0x1977AA00)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISOBJECT_OFFSET UNITYSDK_OFFSET(0x1977AA10)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x1977AA20)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1977CE40)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1977CE90)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETINT_OFFSET UNITYSDK_OFFSET(0x1977CED0)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETLONG_OFFSET UNITYSDK_OFFSET(0x1977CF10)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_SETSTRING_OFFSET UNITYSDK_OFFSET(0x1977CF50)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_TOJSON_1_OFFSET UNITYSDK_OFFSET(0x1977D080)
#define LITJSON_JSONDATA_LITJSON_IJSONWRAPPER_TOJSON_OFFSET UNITYSDK_OFFSET(0x1977CFA0)
#define LITJSON_JSONDATA_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1977C0D0)
#define LITJSON_JSONDATA_OP_EXPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1977C140)
#define LITJSON_JSONDATA_OP_EXPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1977C1C0)
#define LITJSON_JSONDATA_OP_EXPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1977C240)
#define LITJSON_JSONDATA_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1977C060)
#define LITJSON_JSONDATA_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1977BFA0)
#define LITJSON_JSONDATA_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1977BFD0)
#define LITJSON_JSONDATA_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x1977C000)
#define LITJSON_JSONDATA_OP_IMPLICIT_4_OFFSET UNITYSDK_OFFSET(0x1977C030)
#define LITJSON_JSONDATA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1977BF70)
#define LITJSON_JSONDATA_REMOVE_OFFSET UNITYSDK_OFFSET(0x1977E690)
#define LITJSON_JSONDATA_SETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1977CE60)
#define LITJSON_JSONDATA_SETCOMMENT_OFFSET UNITYSDK_OFFSET(0x1977CF90)
#define LITJSON_JSONDATA_SETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1977CEB0)
#define LITJSON_JSONDATA_SETINT_OFFSET UNITYSDK_OFFSET(0x1977CEF0)
#define LITJSON_JSONDATA_SETJSONTYPE_OFFSET UNITYSDK_OFFSET(0x1977ED60)
#define LITJSON_JSONDATA_SETLONG_OFFSET UNITYSDK_OFFSET(0x1977CF30)
#define LITJSON_JSONDATA_SETSTRING_OFFSET UNITYSDK_OFFSET(0x1977CF70)
#define LITJSON_JSONDATA_SET_COMMENT_OFFSET UNITYSDK_OFFSET(0x197799E0)
#define LITJSON_JSONDATA_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1977B750)
#define LITJSON_JSONDATA_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1977AE80)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ICOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1977C2B0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ICOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19779E30)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ICOLLECTION_GET_ISSYNCHRONIZED_OFFSET UNITYSDK_OFFSET(0x19779EE0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ICOLLECTION_GET_SYNCROOT_OFFSET UNITYSDK_OFFSET(0x19779F90)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1977C360)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_CLEAR_OFFSET UNITYSDK_OFFSET(0x1977C550)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1977C6A0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1977C760)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1977A040)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1977A0F0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1977ACA0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1977A1A0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x1977A5B0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_REMOVE_OFFSET UNITYSDK_OFFSET(0x1977C820)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1977AD50)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1977CB60)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_ADD_OFFSET UNITYSDK_OFFSET(0x1977D100)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x1977D220)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1977D2E0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_GET_ISFIXEDSIZE_OFFSET UNITYSDK_OFFSET(0x1977AA30)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_GET_ISREADONLY_OFFSET UNITYSDK_OFFSET(0x1977ABF0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1977B630)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1977D3A0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_INSERT_OFFSET UNITYSDK_OFFSET(0x1977D460)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1977D5F0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x1977D530)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_ILIST_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1977B6E0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1977D6B0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1977B300)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_INSERT_OFFSET UNITYSDK_OFFSET(0x1977D790)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_REMOVEAT_OFFSET UNITYSDK_OFFSET(0x1977D8D0)
#define LITJSON_JSONDATA_SYSTEM_COLLECTIONS_SPECIALIZED_IORDEREDDICTIONARY_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1977B3C0)
#define LITJSON_JSONDATA_TOJSONDATA_OFFSET UNITYSDK_OFFSET(0x1977AE20)
#define LITJSON_JSONDATA_TOJSON_1_OFFSET UNITYSDK_OFFSET(0x1977D0C0)
#define LITJSON_JSONDATA_TOJSON_2_OFFSET UNITYSDK_OFFSET(0x1977EF00)
#define LITJSON_JSONDATA_TOJSON_OFFSET UNITYSDK_OFFSET(0x1977CFB0)
#define LITJSON_JSONDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1977EFF0)
#define LITJSON_JSONDATA_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x19779D60)
#define LITJSON_JSONDATA_WRITECOMMENT_OFFSET UNITYSDK_OFFSET(0x1977E5B0)
#define LITJSON_JSONDATA_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1977DAD0)
#define LITJSON_JSONDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1977BC90)
#define LITJSON_JSONDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1977BCA0)
#define LITJSON_JSONDATA__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1977BCB0)
#define LITJSON_JSONDATA__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1977BCC0)
#define LITJSON_JSONDATA__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1977BCD0)
#define LITJSON_JSONDATA__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1977BF60)
#define LITJSON_JSONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1977BC80)

namespace LitJson
{
	inline static constexpr unsigned int JsonData_TypeDefinitionIndex = 7850;

	class JsonData : public ::System::Object
	{
	public:
		::System::String* inst_string; // 0x10
		::System::String* comment; // 0x18
		::System::Collections::Generic::IList_1<::LitJson::JsonData*>* inst_array; // 0x20
		::System::String* json; // 0x28
		::System::Collections::Generic::IDictionary_2<::System::String*, ::LitJson::JsonData*>* inst_object; // 0x30
		::System::Collections::Generic::IList_1<::System::Collections::Generic::KeyValuePair_2<::System::String*, ::LitJson::JsonData*>>* object_list; // 0x38
		::System::Int64 inst_long; // 0x40
		::System::Boolean inst_boolean; // 0x48
		::System::Double inst_double; // 0x50
		::System::Int32 inst_int; // 0x58
		::LitJson::JsonType type; // 0x5C
