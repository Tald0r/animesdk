...
#define LITJSON_ORDEREDDICTIONARYENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AA3A940)
#define LITJSON_ORDEREDDICTIONARYENUMERATOR_GET_ENTRY_OFFSET UNITYSDK_OFFSET(0x1AA3A970)
#define LITJSON_ORDEREDDICTIONARYENUMERATOR_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1AA3AA60)
#define LITJSON_ORDEREDDICTIONARYENUMERATOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1AA3AB40)
#define LITJSON_ORDEREDDICTIONARYENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AA3AC30)
#define LITJSON_ORDEREDDICTIONARYENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AA3ACE0)
#define LITJSON_ORDEREDDICTIONARYENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA3AC20)

namespace LitJson
{
	inline static constexpr unsigned int OrderedDictionaryEnumerator_TypeDefinitionIndex = 8024;
