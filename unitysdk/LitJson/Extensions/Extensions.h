...
#define LITJSON_EXTENSIONS_EXTENSIONS_HASIMPLEMENTEDRAWGENERIC_OFFSET UNITYSDK_OFFSET(0x1938B440)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x1938B3A0)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_2_OFFSET UNITYSDK_OFFSET(0x1938B3D0)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_3_OFFSET UNITYSDK_OFFSET(0x1938B400)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1938B370)

namespace LitJson::Extensions
{
	inline static constexpr unsigned int Extensions_TypeDefinitionIndex = 8217;
