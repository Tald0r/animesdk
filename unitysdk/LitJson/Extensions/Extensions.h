...
#define LITJSON_EXTENSIONS_EXTENSIONS_HASIMPLEMENTEDRAWGENERIC_OFFSET UNITYSDK_OFFSET(0x19779410)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x19779370)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_2_OFFSET UNITYSDK_OFFSET(0x197793A0)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_3_OFFSET UNITYSDK_OFFSET(0x197793D0)
#define LITJSON_EXTENSIONS_EXTENSIONS_WRITEPROPERTY_OFFSET UNITYSDK_OFFSET(0x19779340)

namespace LitJson::Extensions
{
	inline static constexpr unsigned int Extensions_TypeDefinitionIndex = 7771;
