...
#define LITJSON_JSONREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A9B05E0)
#define LITJSON_JSONREADER_GET_ALLOWCOMMENTS_OFFSET UNITYSDK_OFFSET(0x1A9AEE70)
#define LITJSON_JSONREADER_GET_ALLOWSINGLEQUOTEDSTRINGS_OFFSET UNITYSDK_OFFSET(0x1A9AEEB0)
#define LITJSON_JSONREADER_GET_COMMENTSTACK_OFFSET UNITYSDK_OFFSET(0x1A9AEEF0)
#define LITJSON_JSONREADER_GET_ENDOFINPUT_OFFSET UNITYSDK_OFFSET(0x1A9AEF50)
#define LITJSON_JSONREADER_GET_ENDOFJSON_OFFSET UNITYSDK_OFFSET(0x1A9AEF60)
#define LITJSON_JSONREADER_GET_SKIPMISMATCHMEMBERS_OFFSET UNITYSDK_OFFSET(0x1A9AEF30)
#define LITJSON_JSONREADER_GET_SKIPNONMEMBERS_OFFSET UNITYSDK_OFFSET(0x1A9AEF10)
#define LITJSON_JSONREADER_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x1A9AEF70)
#define LITJSON_JSONREADER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A9AEF80)
#define LITJSON_JSONREADER_POPULATEPARSETABLE_OFFSET UNITYSDK_OFFSET(0x1A9AEFB0)
#define LITJSON_JSONREADER_PROCESSNUMBER_OFFSET UNITYSDK_OFFSET(0x1A9B00F0)
#define LITJSON_JSONREADER_PROCESSSYMBOL_OFFSET UNITYSDK_OFFSET(0x1A9B02D0)
#define LITJSON_JSONREADER_READTOKEN_OFFSET UNITYSDK_OFFSET(0x1A9B04C0)
#define LITJSON_JSONREADER_READ_OFFSET UNITYSDK_OFFSET(0x1A9B0660)
#define LITJSON_JSONREADER_SET_ALLOWCOMMENTS_OFFSET UNITYSDK_OFFSET(0x1A9AEE90)
#define LITJSON_JSONREADER_SET_ALLOWSINGLEQUOTEDSTRINGS_OFFSET UNITYSDK_OFFSET(0x1A9AEED0)
#define LITJSON_JSONREADER_SET_SKIPMISMATCHMEMBERS_OFFSET UNITYSDK_OFFSET(0x1A9AEF40)
#define LITJSON_JSONREADER_SET_SKIPNONMEMBERS_OFFSET UNITYSDK_OFFSET(0x1A9AEF20)
#define LITJSON_JSONREADER_TABLEADDCOL_OFFSET UNITYSDK_OFFSET(0x1A9AFFA0)
#define LITJSON_JSONREADER_TABLEADDROW_OFFSET UNITYSDK_OFFSET(0x1A9AFE80)
#define LITJSON_JSONREADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9AEF90)
#define LITJSON_JSONREADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9AFE70)
#define LITJSON_JSONREADER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A9AFD60)
#define LITJSON_JSONREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9AFCD0)

namespace LitJson
{
	inline static constexpr unsigned int JsonReader_TypeDefinitionIndex = 7992;
	...
	public:
		...
		{
			return (::System::Collections::Generic::IDictionary_2<::System::Int32, ::System::Collections::Generic::IDictionary_2<::System::Int32, ::Il2CppArray<::System::Int32>*>*>**)Il2CppClass::FromTypeDefinitionIndex(JsonReader_TypeDefinitionIndex)->GetStaticField(0x6DC0);
		}
		::System::IO::TextReader* reader; // 0x10
		::LitJson::Lexer* lexer; // 0x18
		::System::Object* token_value; // 0x20
		::System::Collections::Generic::Stack_1<::System::Int32>* automaton_stack; // 0x28
		::System::Boolean read_started; // 0x30
		::System::Boolean skip_mismatch_members; // 0x31
		::System::Boolean reader_is_owned; // 0x32
		::System::Boolean end_of_input; // 0x33
		::System::Int32 current_symbol; // 0x34
		::System::Int32 current_input; // 0x38
		::LitJson::JsonToken token; // 0x3C
		::System::Boolean end_of_json; // 0x40
		::System::Boolean skip_non_members; // 0x41
		::System::Boolean parser_return; // 0x42
		::System::Boolean parser_in_string; // 0x43
