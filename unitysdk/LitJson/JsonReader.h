...
#define LITJSON_JSONREADER_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B181890)
#define LITJSON_JSONREADER_GET_ALLOWCOMMENTS_OFFSET UNITYSDK_OFFSET(0x1B180120)
#define LITJSON_JSONREADER_GET_ALLOWSINGLEQUOTEDSTRINGS_OFFSET UNITYSDK_OFFSET(0x1B180160)
#define LITJSON_JSONREADER_GET_COMMENTSTACK_OFFSET UNITYSDK_OFFSET(0x1B1801A0)
#define LITJSON_JSONREADER_GET_ENDOFINPUT_OFFSET UNITYSDK_OFFSET(0x1B180200)
#define LITJSON_JSONREADER_GET_ENDOFJSON_OFFSET UNITYSDK_OFFSET(0x1B180210)
#define LITJSON_JSONREADER_GET_SKIPMISMATCHMEMBERS_OFFSET UNITYSDK_OFFSET(0x1B1801E0)
#define LITJSON_JSONREADER_GET_SKIPNONMEMBERS_OFFSET UNITYSDK_OFFSET(0x1B1801C0)
#define LITJSON_JSONREADER_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x1B180220)
#define LITJSON_JSONREADER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B180230)
#define LITJSON_JSONREADER_POPULATEPARSETABLE_OFFSET UNITYSDK_OFFSET(0x1B180260)
#define LITJSON_JSONREADER_PROCESSNUMBER_OFFSET UNITYSDK_OFFSET(0x1B1813A0)
#define LITJSON_JSONREADER_PROCESSSYMBOL_OFFSET UNITYSDK_OFFSET(0x1B181580)
#define LITJSON_JSONREADER_READTOKEN_OFFSET UNITYSDK_OFFSET(0x1B181770)
#define LITJSON_JSONREADER_READ_OFFSET UNITYSDK_OFFSET(0x1B181910)
#define LITJSON_JSONREADER_SET_ALLOWCOMMENTS_OFFSET UNITYSDK_OFFSET(0x1B180140)
#define LITJSON_JSONREADER_SET_ALLOWSINGLEQUOTEDSTRINGS_OFFSET UNITYSDK_OFFSET(0x1B180180)
#define LITJSON_JSONREADER_SET_SKIPMISMATCHMEMBERS_OFFSET UNITYSDK_OFFSET(0x1B1801F0)
#define LITJSON_JSONREADER_SET_SKIPNONMEMBERS_OFFSET UNITYSDK_OFFSET(0x1B1801D0)
#define LITJSON_JSONREADER_TABLEADDCOL_OFFSET UNITYSDK_OFFSET(0x1B181250)
#define LITJSON_JSONREADER_TABLEADDROW_OFFSET UNITYSDK_OFFSET(0x1B181130)
#define LITJSON_JSONREADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B180240)
#define LITJSON_JSONREADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B181120)
#define LITJSON_JSONREADER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B181010)
#define LITJSON_JSONREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B180F80)

namespace LitJson
{
	inline static constexpr unsigned int JsonReader_TypeDefinitionIndex = 8318;
	...
	public:
		...
		{
			return (::System::Collections::Generic::IDictionary_2<::System::Int32, ::System::Collections::Generic::IDictionary_2<::System::Int32, ::Il2CppArray<::System::Int32>*>*>**)Il2CppClass::FromTypeDefinitionIndex(JsonReader_TypeDefinitionIndex)->GetStaticField(0x6DA0);
		}
		...
		::System::Boolean end_of_json; // 0x3A
		::System::Boolean reader_is_owned; // 0x3B
		::System::Boolean end_of_input; // 0x3C
		::System::Boolean read_started; // 0x3D
		::System::Boolean parser_in_string; // 0x3E
		::System::Boolean skip_non_members; // 0x3F
