...
#define LITJSON_LEXER_STATEHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B219360)
#define LITJSON_LEXER_STATEHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B219390)
#define LITJSON_LEXER_STATEHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B218E20)
#define LITJSON_LEXER_STATEHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B218E00)

namespace LitJson
{
	inline static constexpr unsigned int Lexer_StateHandler_TypeDefinitionIndex = 7795;
