...
#define STRUCT_2_5EA6B0C02BD8B1A0_METHOD_2_08B13B541773FBB0_OFFSET UNITYSDK_OFFSET(0x2EB550)
#define STRUCT_2_5EA6B0C02BD8B1A0_METHOD_2_2FBCD398A9261AD9_OFFSET UNITYSDK_OFFSET(0x346EC0)
#define STRUCT_2_5EA6B0C02BD8B1A0_METHOD_2_371A55F2C8CB01A5_OFFSET UNITYSDK_OFFSET(0x346D90)
#define STRUCT_2_5EA6B0C02BD8B1A0_METHOD_2_58FEC22ED8D18E98_OFFSET UNITYSDK_OFFSET(0x346C00)
#define STRUCT_2_5EA6B0C02BD8B1A0_METHOD_2_5C18560E727BC523_OFFSET UNITYSDK_OFFSET(0x7E4ABC0)
#define STRUCT_2_5EA6B0C02BD8B1A0_METHOD_2_BF6F8FDC48A86D8B_OFFSET UNITYSDK_OFFSET(0x346D00)
#define STRUCT_2_5EA6B0C02BD8B1A0__CTOR_OFFSET UNITYSDK_OFFSET(0x312860)

inline static constexpr unsigned int Struct_2_5EA6B0C02BD8B1A0_TypeDefinitionIndex = 76859;
