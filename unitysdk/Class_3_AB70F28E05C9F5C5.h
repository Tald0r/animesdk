...
#define CLASS_3_AB70F28E05C9F5C5_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x8B4C610)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_128774387667156B_OFFSET UNITYSDK_OFFSET(0x8B4C760)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_1D5C4143EE1D2D7C_OFFSET UNITYSDK_OFFSET(0x8B4C890)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_486AF1E6C0038D4C_OFFSET UNITYSDK_OFFSET(0x8B4C810)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_4E8DF6F8A37B229A_OFFSET UNITYSDK_OFFSET(0x8B4C710)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_5323F2DF46A044DA_1_OFFSET UNITYSDK_OFFSET(0x8B4C800)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x8B4C730)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x8B4C820)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x8B4C7A0)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x8B4C140)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x8B4C910)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_D37FAD0A6AA04B25_OFFSET UNITYSDK_OFFSET(0x8B4C740)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_E7F1AECA7CFF8AAD_1_OFFSET UNITYSDK_OFFSET(0x8B4C900)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0x8B4C880)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x8B4C600)
#define CLASS_3_AB70F28E05C9F5C5_METHOD_3_FF798D152DDA9A15_OFFSET UNITYSDK_OFFSET(0x8B4C700)
#define CLASS_3_AB70F28E05C9F5C5_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x8B4BB30)
#define CLASS_3_AB70F28E05C9F5C5_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8B4C1A0)
#define CLASS_3_AB70F28E05C9F5C5__CCTOR_OFFSET UNITYSDK_OFFSET(0x8B4C670)
#define CLASS_3_AB70F28E05C9F5C5__CTOR_OFFSET UNITYSDK_OFFSET(0x8B4C6F0)

inline static constexpr unsigned int Class_3_AB70F28E05C9F5C5_TypeDefinitionIndex = 54428;
...
public:
	...
	::Class_1_04AABD269B0AE5A9* Field_3_3; // 0x50
	...
	::System::Collections::Generic::Dictionary_2<::MoleMole::Config::AnimMoveState, ::Class_1_A2413FF173BBC90D*>* Field_3_8; // 0x68
	::System::Collections::Generic::List_1<::System::String*>* Field_3_11; // 0x70
	::System::Boolean Field_3_1; // 0x78
	::System::Boolean Field_3_12; // 0x79
	::System::Boolean Field_3_0; // 0x7A
	::Enum_3_8711E36030A57C8C Field_3_6; // 0x7C
	::Enum_3_1BBFAA1B5EC0AE5D Field_3_4; // 0x80
	::System::Single Field_3_5; // 0x84
	::UnityEngine::Vector2 Field_3_15; // 0x88
