...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK_EXPAND_OFFSET UNITYSDK_OFFSET(0xAA99010)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK_GET__MONOUIEXPANDANDSHRINKCELL_OFFSET UNITYSDK_OFFSET(0xAA98ED0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK_REGISTEREXPANDEND_OFFSET UNITYSDK_OFFSET(0xAA99230)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK_REGISTERSHRINKEND_OFFSET UNITYSDK_OFFSET(0xAA99300)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK_SHRINK_OFFSET UNITYSDK_OFFSET(0xAA99120)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK_UPDATE_OFFSET UNITYSDK_OFFSET(0xAA98D10)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK__CTOR_OFFSET UNITYSDK_OFFSET(0xAA98D00)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xAA993D0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginExpandAndShrink_TypeDefinitionIndex = 64452;
