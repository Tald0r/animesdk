...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK_EXPAND_OFFSET UNITYSDK_OFFSET(0xEE720E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK_GET__MONOUIEXPANDANDSHRINKCELL_OFFSET UNITYSDK_OFFSET(0xEE71FA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK_REGISTEREXPANDEND_OFFSET UNITYSDK_OFFSET(0xEE72300)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK_REGISTERSHRINKEND_OFFSET UNITYSDK_OFFSET(0xEE723D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK_SHRINK_OFFSET UNITYSDK_OFFSET(0xEE721F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK_UPDATE_OFFSET UNITYSDK_OFFSET(0xEE71DE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK__CTOR_OFFSET UNITYSDK_OFFSET(0xEE71DD0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINEXPANDANDSHRINK___BASE_UPDATE_OFFSET UNITYSDK_OFFSET(0xEE724A0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginExpandAndShrink_TypeDefinitionIndex = 43847;
