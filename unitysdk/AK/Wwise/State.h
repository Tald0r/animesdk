...
#define AK_WWISE_STATE_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B615D00)
#define AK_WWISE_STATE_GET_WWISEOBJECTGROUPTYPE_OFFSET UNITYSDK_OFFSET(0x1B615D90)
#define AK_WWISE_STATE_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1B615D80)
#define AK_WWISE_STATE_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1B615DA0)
#define AK_WWISE_STATE_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B615D10)
#define AK_WWISE_STATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B615E90)

namespace AK::Wwise
{
	inline static constexpr unsigned int State_TypeDefinitionIndex = 31123;
