...
#define AK_WWISE_BANK_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B6C4440)
#define AK_WWISE_BANK_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1B6C44C0)
#define AK_WWISE_BANK_LOADASYNC_OFFSET UNITYSDK_OFFSET(0x1B6C45E0)
#define AK_WWISE_BANK_LOAD_OFFSET UNITYSDK_OFFSET(0x1B6C44D0)
#define AK_WWISE_BANK_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B6C4450)
#define AK_WWISE_BANK_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1B6C46F0)
#define AK_WWISE_BANK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C47F0)

namespace AK::Wwise
{
	inline static constexpr unsigned int Bank_TypeDefinitionIndex = 31117;
