...
#define AK_WWISE_AUXBUS_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B37DAB0)
#define AK_WWISE_AUXBUS_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1B37DB30)
#define AK_WWISE_AUXBUS_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B37DAC0)
#define AK_WWISE_AUXBUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B37DB40)

namespace AK::Wwise
{
	inline static constexpr unsigned int AuxBus_TypeDefinitionIndex = 31116;
