...
#define AK_WWISE_AUXBUS_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AD6E4D0)
#define AK_WWISE_AUXBUS_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1AD6E550)
#define AK_WWISE_AUXBUS_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1AD6E4E0)
#define AK_WWISE_AUXBUS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD6E560)

namespace AK::Wwise
{
	inline static constexpr unsigned int AuxBus_TypeDefinitionIndex = 30163;
