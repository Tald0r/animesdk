...
#define AK_WWISE_EVENT_EXECUTEACTION_OFFSET UNITYSDK_OFFSET(0x1B003670)
#define AK_WWISE_EVENT_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B0031E0)
#define AK_WWISE_EVENT_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1B003260)
#define AK_WWISE_EVENT_POSTMIDI_1_OFFSET UNITYSDK_OFFSET(0x1B003850)
#define AK_WWISE_EVENT_POSTMIDI_OFFSET UNITYSDK_OFFSET(0x1B003770)
#define AK_WWISE_EVENT_POST_1_OFFSET UNITYSDK_OFFSET(0x1B003360)
#define AK_WWISE_EVENT_POST_2_OFFSET UNITYSDK_OFFSET(0x1B003480)
#define AK_WWISE_EVENT_POST_OFFSET UNITYSDK_OFFSET(0x1B003280)
#define AK_WWISE_EVENT_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B0031F0)
#define AK_WWISE_EVENT_STOPMIDI_1_OFFSET UNITYSDK_OFFSET(0x1B003A10)
#define AK_WWISE_EVENT_STOPMIDI_OFFSET UNITYSDK_OFFSET(0x1B003930)
#define AK_WWISE_EVENT_STOP_OFFSET UNITYSDK_OFFSET(0x1B003580)
#define AK_WWISE_EVENT_VERIFYPLAYINGID_OFFSET UNITYSDK_OFFSET(0x1B003270)
#define AK_WWISE_EVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B003B70)

namespace AK::Wwise
{
	inline static constexpr unsigned int Event_TypeDefinitionIndex = 30168;
