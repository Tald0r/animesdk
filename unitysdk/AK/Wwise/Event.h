...
#define AK_WWISE_EVENT_EXECUTEACTION_OFFSET UNITYSDK_OFFSET(0x1B6157F0)
#define AK_WWISE_EVENT_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B615360)
#define AK_WWISE_EVENT_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1B6153E0)
#define AK_WWISE_EVENT_POSTMIDI_1_OFFSET UNITYSDK_OFFSET(0x1B6159D0)
#define AK_WWISE_EVENT_POSTMIDI_OFFSET UNITYSDK_OFFSET(0x1B6158F0)
#define AK_WWISE_EVENT_POST_1_OFFSET UNITYSDK_OFFSET(0x1B6154E0)
#define AK_WWISE_EVENT_POST_2_OFFSET UNITYSDK_OFFSET(0x1B615600)
#define AK_WWISE_EVENT_POST_OFFSET UNITYSDK_OFFSET(0x1B615400)
#define AK_WWISE_EVENT_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B615370)
#define AK_WWISE_EVENT_STOPMIDI_1_OFFSET UNITYSDK_OFFSET(0x1B615B90)
#define AK_WWISE_EVENT_STOPMIDI_OFFSET UNITYSDK_OFFSET(0x1B615AB0)
#define AK_WWISE_EVENT_STOP_OFFSET UNITYSDK_OFFSET(0x1B615700)
#define AK_WWISE_EVENT_VERIFYPLAYINGID_OFFSET UNITYSDK_OFFSET(0x1B6153F0)
#define AK_WWISE_EVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B615CF0)

namespace AK::Wwise
{
	inline static constexpr unsigned int Event_TypeDefinitionIndex = 31121;
