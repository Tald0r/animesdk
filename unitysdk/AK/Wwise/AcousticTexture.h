...
#define AK_WWISE_ACOUSTICTEXTURE_GET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B0EE440)
#define AK_WWISE_ACOUSTICTEXTURE_GET_WWISEOBJECTTYPE_OFFSET UNITYSDK_OFFSET(0x1B0EE4C0)
#define AK_WWISE_ACOUSTICTEXTURE_SET_OBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B0EE450)
#define AK_WWISE_ACOUSTICTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0EE4D0)

namespace AK::Wwise
{
	inline static constexpr unsigned int AcousticTexture_TypeDefinitionIndex = 30162;
