...
#define AK_WWISE_BASEGROUPTYPE_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1B08B280)
#define AK_WWISE_BASEGROUPTYPE_GET_GROUPID_1_OFFSET UNITYSDK_OFFSET(0x1B08B270)
#define AK_WWISE_BASEGROUPTYPE_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B08AEA0)
#define AK_WWISE_BASEGROUPTYPE_GET_GROUPWWISEOBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B08ADE0)
#define AK_WWISE_BASEGROUPTYPE_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B08B0B0)
#define AK_WWISE_BASEGROUPTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B08B3B0)

namespace AK::Wwise
{
	inline static constexpr unsigned int BaseGroupType_TypeDefinitionIndex = 30165;
