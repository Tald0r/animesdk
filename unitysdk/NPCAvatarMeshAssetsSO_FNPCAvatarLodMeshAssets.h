...
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETGPUMESHLOD2ASYNC_OFFSET UNITYSDK_OFFSET(0x650A300)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETGPUMESHLOD2SYNC_OFFSET UNITYSDK_OFFSET(0x650A260)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETGPUMESHLOD3ASYNC_OFFSET UNITYSDK_OFFSET(0x650A490)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETGPUMESHLOD3SYNC_OFFSET UNITYSDK_OFFSET(0x650A3F0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD0MESHASYNC_OFFSET UNITYSDK_OFFSET(0x6509AA0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD0MESHSYNC_OFFSET UNITYSDK_OFFSET(0x6509A00)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD1MESHASYNC_OFFSET UNITYSDK_OFFSET(0x6509C30)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD1MESHSYNC_OFFSET UNITYSDK_OFFSET(0x6509B90)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD2MESHASYNC_OFFSET UNITYSDK_OFFSET(0x6509DB0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD2MESHSYNC_OFFSET UNITYSDK_OFFSET(0x6509D10)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD3MESHASYNC_OFFSET UNITYSDK_OFFSET(0x6509F40)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD3MESHSYNC_OFFSET UNITYSDK_OFFSET(0x6509EA0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETMATERIALSASYNC_OFFSET UNITYSDK_OFFSET(0x650A0D0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETMATERIALSSYNC_OFFSET UNITYSDK_OFFSET(0x650A030)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETUIMATERIALSSYNC_OFFSET UNITYSDK_OFFSET(0x650A1C0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x650A580)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS__CTOR_OFFSET UNITYSDK_OFFSET(0x650A6A0)

inline static constexpr unsigned int NPCAvatarMeshAssetsSO_FNPCAvatarLodMeshAssets_TypeDefinitionIndex = 40978;
