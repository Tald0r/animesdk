...
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETGPUMESHLOD2ASYNC_OFFSET UNITYSDK_OFFSET(0x6608A10)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETGPUMESHLOD2SYNC_OFFSET UNITYSDK_OFFSET(0x6608970)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETGPUMESHLOD3ASYNC_OFFSET UNITYSDK_OFFSET(0x6608B90)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETGPUMESHLOD3SYNC_OFFSET UNITYSDK_OFFSET(0x6608AF0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD0MESHASYNC_OFFSET UNITYSDK_OFFSET(0x66081C0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD0MESHSYNC_OFFSET UNITYSDK_OFFSET(0x6608120)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD1MESHASYNC_OFFSET UNITYSDK_OFFSET(0x6608350)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD1MESHSYNC_OFFSET UNITYSDK_OFFSET(0x66082B0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD2MESHASYNC_OFFSET UNITYSDK_OFFSET(0x66084E0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD2MESHSYNC_OFFSET UNITYSDK_OFFSET(0x6608440)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD3MESHASYNC_OFFSET UNITYSDK_OFFSET(0x6608660)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETLOD3MESHSYNC_OFFSET UNITYSDK_OFFSET(0x66085C0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETMATERIALSASYNC_OFFSET UNITYSDK_OFFSET(0x66087E0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETMATERIALSSYNC_OFFSET UNITYSDK_OFFSET(0x6608740)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_GETUIMATERIALSSYNC_OFFSET UNITYSDK_OFFSET(0x66088D0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS_UNLOADEDASSETS_OFFSET UNITYSDK_OFFSET(0x6608C70)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS__CTOR_OFFSET UNITYSDK_OFFSET(0x6608D90)

inline static constexpr unsigned int NPCAvatarMeshAssetsSO_FNPCAvatarLodMeshAssets_TypeDefinitionIndex = 62310;
