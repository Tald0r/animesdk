...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS27_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4ED6A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS27_0__DONORMALIZEDPOS_B__0_OFFSET UNITYSDK_OFFSET(0x1B4EEF00)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS27_0__DONORMALIZEDPOS_B__1_OFFSET UNITYSDK_OFFSET(0x1B4EEF60)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass27_0_TypeDefinitionIndex = 32381;
