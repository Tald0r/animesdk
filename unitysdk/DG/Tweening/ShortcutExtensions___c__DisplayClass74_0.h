...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS74_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71EBC0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS74_0__DOBLENDABLELOCALMOVEBY_B__0_OFFSET UNITYSDK_OFFSET(0x1B71EBD0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS74_0__DOBLENDABLELOCALMOVEBY_B__1_OFFSET UNITYSDK_OFFSET(0x1B71EBF0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass74_0_TypeDefinitionIndex = 24920;
