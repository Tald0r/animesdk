...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS67_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B52F680)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS67_0__DOLOCALPATH_B__0_OFFSET UNITYSDK_OFFSET(0x1B52F690)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS67_0__DOLOCALPATH_B__1_OFFSET UNITYSDK_OFFSET(0x1B52F6E0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass67_0_TypeDefinitionIndex = 24913;
