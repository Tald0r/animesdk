...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS26_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B12BA30)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS26_0__DOTILING_B__0_OFFSET UNITYSDK_OFFSET(0x1B12BA40)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS26_0__DOTILING_B__1_OFFSET UNITYSDK_OFFSET(0x1B12BA90)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass26_0_TypeDefinitionIndex = 24048;
