...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS75_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71EC90)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS75_0__DOBLENDABLEROTATEBY_B__0_OFFSET UNITYSDK_OFFSET(0x1B71ECA0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS75_0__DOBLENDABLEROTATEBY_B__1_OFFSET UNITYSDK_OFFSET(0x1B71ECB0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass75_0_TypeDefinitionIndex = 24921;
