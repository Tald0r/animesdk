...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B4470)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS1_0__DOPITCH_B__0_OFFSET UNITYSDK_OFFSET(0x1A9BD1D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS1_0__DOPITCH_B__1_OFFSET UNITYSDK_OFFSET(0x1A9BD1F0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass1_0_TypeDefinitionIndex = 24023;
