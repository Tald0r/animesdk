...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECBD20)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS0_0__DOFADE_B__0_OFFSET UNITYSDK_OFFSET(0x1AECF4B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS0_0__DOFADE_B__1_OFFSET UNITYSDK_OFFSET(0x1AECF4D0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass0_0_TypeDefinitionIndex = 31403;
