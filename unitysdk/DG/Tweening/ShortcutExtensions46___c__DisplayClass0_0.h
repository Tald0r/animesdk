...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EAC00)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS0_0__DOFADE_B__0_OFFSET UNITYSDK_OFFSET(0x1B4EE440)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS0_0__DOFADE_B__1_OFFSET UNITYSDK_OFFSET(0x1B4EE460)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass0_0_TypeDefinitionIndex = 32355;
