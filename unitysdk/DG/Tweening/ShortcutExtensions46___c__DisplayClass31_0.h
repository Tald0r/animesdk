...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS31_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EDC00)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS31_0__DOCOLOR_B__0_OFFSET UNITYSDK_OFFSET(0x1B4EF270)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS31_0__DOCOLOR_B__1_OFFSET UNITYSDK_OFFSET(0x1B4EF2A0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass31_0_TypeDefinitionIndex = 32385;
