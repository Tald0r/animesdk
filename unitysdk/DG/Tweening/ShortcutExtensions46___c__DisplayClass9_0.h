...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECCAF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS9_0__DOPREFERREDSIZE_B__0_OFFSET UNITYSDK_OFFSET(0x1AED0820)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS9_0__DOPREFERREDSIZE_B__1_OFFSET UNITYSDK_OFFSET(0x1AED0880)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass9_0_TypeDefinitionIndex = 31411;
