...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EBA10)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS9_0__DOPREFERREDSIZE_B__0_OFFSET UNITYSDK_OFFSET(0x1B4EF7B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS9_0__DOPREFERREDSIZE_B__1_OFFSET UNITYSDK_OFFSET(0x1B4EF810)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass9_0_TypeDefinitionIndex = 32363;
