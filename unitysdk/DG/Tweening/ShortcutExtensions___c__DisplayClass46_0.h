...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS46_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B571070)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS46_0__DOROTATEQUATERNION_B__0_OFFSET UNITYSDK_OFFSET(0x1B571080)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS46_0__DOROTATEQUATERNION_B__1_OFFSET UNITYSDK_OFFSET(0x1B5710C0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass46_0_TypeDefinitionIndex = 24892;
