...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS46_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4D2A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS46_0__DOROTATEQUATERNION_B__0_OFFSET UNITYSDK_OFFSET(0x1AF4D2B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS46_0__DOROTATEQUATERNION_B__1_OFFSET UNITYSDK_OFFSET(0x1AF4D2F0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass46_0_TypeDefinitionIndex = 24068;
