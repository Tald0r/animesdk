...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS56_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD4400)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS56_0__DOPUNCHSCALE_B__0_OFFSET UNITYSDK_OFFSET(0x1AFD4410)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS56_0__DOPUNCHSCALE_B__1_OFFSET UNITYSDK_OFFSET(0x1AFD4460)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass56_0_TypeDefinitionIndex = 24078;
