...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS56_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5DFF30)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS56_0__DOPUNCHSCALE_B__0_OFFSET UNITYSDK_OFFSET(0x1B5DFF40)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS56_0__DOPUNCHSCALE_B__1_OFFSET UNITYSDK_OFFSET(0x1B5DFF90)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass56_0_TypeDefinitionIndex = 24902;
