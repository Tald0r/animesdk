...
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOBLENDABLECOLOR_OFFSET UNITYSDK_OFFSET(0x1B736EB0)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOCOLOR_OFFSET UNITYSDK_OFFSET(0x1B735EF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOFADE_OFFSET UNITYSDK_OFFSET(0x1B736060)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOGRADIENTCOLOR_1_OFFSET UNITYSDK_OFFSET(0x1B735BC0)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOGRADIENTCOLOR_2_OFFSET UNITYSDK_OFFSET(0x1B7361D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOGRADIENTCOLOR_OFFSET UNITYSDK_OFFSET(0x1B7358A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOJUMP_OFFSET UNITYSDK_OFFSET(0x1B736A40)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOMOVEX_OFFSET UNITYSDK_OFFSET(0x1B736610)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOMOVEY_OFFSET UNITYSDK_OFFSET(0x1B736780)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOMOVE_OFFSET UNITYSDK_OFFSET(0x1B7364C0)
#define DG_TWEENING_SHORTCUTEXTENSIONS43_DOROTATE_OFFSET UNITYSDK_OFFSET(0x1B7368F0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions43_TypeDefinitionIndex = 32343;
