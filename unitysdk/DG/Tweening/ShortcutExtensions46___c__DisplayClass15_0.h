...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECD300)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS15_0__DOANCHORPOSY_B__0_OFFSET UNITYSDK_OFFSET(0x1AECF6E0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS15_0__DOANCHORPOSY_B__1_OFFSET UNITYSDK_OFFSET(0x1AECF720)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass15_0_TypeDefinitionIndex = 31417;
