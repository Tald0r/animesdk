...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B106DA0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS0_0__DOFADE_B__0_OFFSET UNITYSDK_OFFSET(0x1B106DB0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS0_0__DOFADE_B__1_OFFSET UNITYSDK_OFFSET(0x1B106DD0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass0_0_TypeDefinitionIndex = 24022;
