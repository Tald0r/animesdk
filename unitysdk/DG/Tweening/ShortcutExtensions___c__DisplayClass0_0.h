...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71E890)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS0_0__DOFADE_B__0_OFFSET UNITYSDK_OFFSET(0x1B71E8A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS0_0__DOFADE_B__1_OFFSET UNITYSDK_OFFSET(0x1B71E8C0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass0_0_TypeDefinitionIndex = 24846;
