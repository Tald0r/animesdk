...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4ED0E0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS25_0__DOSHAKEANCHORPOS_B__0_OFFSET UNITYSDK_OFFSET(0x1B4EEC00)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS25_0__DOSHAKEANCHORPOS_B__1_OFFSET UNITYSDK_OFFSET(0x1B4EEC50)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass25_0_TypeDefinitionIndex = 32379;
