...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECE180)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS25_0__DOSHAKEANCHORPOS_B__0_OFFSET UNITYSDK_OFFSET(0x1AECFC70)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS25_0__DOSHAKEANCHORPOS_B__1_OFFSET UNITYSDK_OFFSET(0x1AECFCC0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass25_0_TypeDefinitionIndex = 31427;
