...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS38_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AC680)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS38_0__DOMOVEX_B__0_OFFSET UNITYSDK_OFFSET(0x1B0AC690)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS38_0__DOMOVEX_B__1_OFFSET UNITYSDK_OFFSET(0x1B0AC6E0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass38_0_TypeDefinitionIndex = 24060;
