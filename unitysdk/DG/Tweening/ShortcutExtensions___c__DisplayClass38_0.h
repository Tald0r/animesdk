...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS38_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6BA5A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS38_0__DOMOVEX_B__0_OFFSET UNITYSDK_OFFSET(0x1B6BA5B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS38_0__DOMOVEX_B__1_OFFSET UNITYSDK_OFFSET(0x1B6BA600)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass38_0_TypeDefinitionIndex = 24884;
