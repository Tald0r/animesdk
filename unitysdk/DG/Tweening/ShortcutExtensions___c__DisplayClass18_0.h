...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D9BD0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS18_0__DOCOLOR_B__0_OFFSET UNITYSDK_OFFSET(0x1B0D9BE0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS18_0__DOCOLOR_B__1_OFFSET UNITYSDK_OFFSET(0x1B0D9C50)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass18_0_TypeDefinitionIndex = 24040;
