...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EA740)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS18_0__DOCOLOR_B__0_OFFSET UNITYSDK_OFFSET(0x1B6EA750)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS18_0__DOCOLOR_B__1_OFFSET UNITYSDK_OFFSET(0x1B6EA7C0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass18_0_TypeDefinitionIndex = 24864;
