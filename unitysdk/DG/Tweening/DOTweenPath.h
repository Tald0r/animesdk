...
#define DG_TWEENING_DOTWEENPATH_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B63BF50)
#define DG_TWEENING_DOTWEENPATH_DOCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1B63D370)
#define DG_TWEENING_DOTWEENPATH_DOKILL_OFFSET UNITYSDK_OFFSET(0x1B63D380)
#define DG_TWEENING_DOTWEENPATH_DOPAUSE_OFFSET UNITYSDK_OFFSET(0x1B63D1D0)
#define DG_TWEENING_DOTWEENPATH_DOPLAYBACKWARDS_OFFSET UNITYSDK_OFFSET(0x1B63D0B0)
#define DG_TWEENING_DOTWEENPATH_DOPLAYFORWARD_OFFSET UNITYSDK_OFFSET(0x1B63D140)
#define DG_TWEENING_DOTWEENPATH_DOPLAY_OFFSET UNITYSDK_OFFSET(0x1B63D0A0)
#define DG_TWEENING_DOTWEENPATH_DORESTART_OFFSET UNITYSDK_OFFSET(0x1B63D2B0)
#define DG_TWEENING_DOTWEENPATH_DOREWIND_OFFSET UNITYSDK_OFFSET(0x1B63D2A0)
#define DG_TWEENING_DOTWEENPATH_DOTOGGLEPAUSE_OFFSET UNITYSDK_OFFSET(0x1B63D210)
#define DG_TWEENING_DOTWEENPATH_GETDRAWPOINTS_OFFSET UNITYSDK_OFFSET(0x1B63D3E0)
#define DG_TWEENING_DOTWEENPATH_GETFULLWPS_OFFSET UNITYSDK_OFFSET(0x1B63D460)
#define DG_TWEENING_DOTWEENPATH_GETTWEEN_OFFSET UNITYSDK_OFFSET(0x1B63D390)
#define DG_TWEENING_DOTWEENPATH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B63D070)
#define DG_TWEENING_DOTWEENPATH_REEVALUATERELATIVETWEEN_OFFSET UNITYSDK_OFFSET(0x1B63CD70)
#define DG_TWEENING_DOTWEENPATH_RESET_OFFSET UNITYSDK_OFFSET(0x1B63CF90)
#define DG_TWEENING_DOTWEENPATH__AWAKE_B__36_0_OFFSET UNITYSDK_OFFSET(0x1B63D810)
#define DG_TWEENING_DOTWEENPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B63D620)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOTweenPath_TypeDefinitionIndex = 32396;
