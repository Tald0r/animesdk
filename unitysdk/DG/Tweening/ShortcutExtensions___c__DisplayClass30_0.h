...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B9FA0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS30_0__DOMOVEY_B__0_OFFSET UNITYSDK_OFFSET(0x1B6B9FB0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass30_0_TypeDefinitionIndex = 24876;
