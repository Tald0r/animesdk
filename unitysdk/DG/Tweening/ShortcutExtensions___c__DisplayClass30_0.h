...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AC080)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS30_0__DOMOVEY_B__0_OFFSET UNITYSDK_OFFSET(0x1B0AC090)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass30_0_TypeDefinitionIndex = 24052;
