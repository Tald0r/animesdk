...
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_APPENDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AF8DA70)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_APPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1AF8D950)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_APPEND_OFFSET UNITYSDK_OFFSET(0x1AF87DB0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_INSERTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AF8DBF0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_INSERT_OFFSET UNITYSDK_OFFSET(0x1AF8D900)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_JOIN_OFFSET UNITYSDK_OFFSET(0x1AF87E00)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_PREPENDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AF8DB30)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_PREPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1AF8D990)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_PREPEND_OFFSET UNITYSDK_OFFSET(0x1AF8D8B0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETLOOKAT_1_OFFSET UNITYSDK_OFFSET(0x1AF8E2A0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETLOOKAT_2_OFFSET UNITYSDK_OFFSET(0x1AF8E300)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETLOOKAT_OFFSET UNITYSDK_OFFSET(0x1AF8DF60)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_10_OFFSET UNITYSDK_OFFSET(0x1AF8DDB0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_11_OFFSET UNITYSDK_OFFSET(0x1AF89DE0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_12_OFFSET UNITYSDK_OFFSET(0x1AF8DEE0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_13_OFFSET UNITYSDK_OFFSET(0x1AF8DF00)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_14_OFFSET UNITYSDK_OFFSET(0x1AF8DF30)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_1_OFFSET UNITYSDK_OFFSET(0x1AF8DCD0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_2_OFFSET UNITYSDK_OFFSET(0x1AF8DCF0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_3_OFFSET UNITYSDK_OFFSET(0x1AF86FC0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_4_OFFSET UNITYSDK_OFFSET(0x1AF87140)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_5_OFFSET UNITYSDK_OFFSET(0x1AF8DD10)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_6_OFFSET UNITYSDK_OFFSET(0x1AF8DD30)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_7_OFFSET UNITYSDK_OFFSET(0x1AF8DD50)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_8_OFFSET UNITYSDK_OFFSET(0x1AF8DD70)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_9_OFFSET UNITYSDK_OFFSET(0x1AF8DD90)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_OFFSET UNITYSDK_OFFSET(0x1AF8DCB0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETPATHFORWARDDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AF8DFC0)

namespace DG::Tweening
{
	inline static constexpr unsigned int TweenSettingsExtensions_TypeDefinitionIndex = 24925;
