...
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_APPENDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A9BD3E0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_APPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1A9BD2C0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_APPEND_OFFSET UNITYSDK_OFFSET(0x1A9B7860)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_INSERTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A9BD560)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_INSERT_OFFSET UNITYSDK_OFFSET(0x1A9BD270)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_JOIN_OFFSET UNITYSDK_OFFSET(0x1A9B78B0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_PREPENDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A9BD4A0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_PREPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1A9BD300)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_PREPEND_OFFSET UNITYSDK_OFFSET(0x1A9BD220)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETLOOKAT_1_OFFSET UNITYSDK_OFFSET(0x1A9BDC10)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETLOOKAT_2_OFFSET UNITYSDK_OFFSET(0x1A9BDC70)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETLOOKAT_OFFSET UNITYSDK_OFFSET(0x1A9BD8D0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_10_OFFSET UNITYSDK_OFFSET(0x1A9BD720)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_11_OFFSET UNITYSDK_OFFSET(0x1A9B97F0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_12_OFFSET UNITYSDK_OFFSET(0x1A9BD850)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_13_OFFSET UNITYSDK_OFFSET(0x1A9BD870)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_14_OFFSET UNITYSDK_OFFSET(0x1A9BD8A0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_1_OFFSET UNITYSDK_OFFSET(0x1A9BD640)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_2_OFFSET UNITYSDK_OFFSET(0x1A9BD660)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_3_OFFSET UNITYSDK_OFFSET(0x1A9B6A80)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_4_OFFSET UNITYSDK_OFFSET(0x1A9B6C00)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_5_OFFSET UNITYSDK_OFFSET(0x1A9BD680)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_6_OFFSET UNITYSDK_OFFSET(0x1A9BD6A0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_7_OFFSET UNITYSDK_OFFSET(0x1A9BD6C0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_8_OFFSET UNITYSDK_OFFSET(0x1A9BD6E0)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_9_OFFSET UNITYSDK_OFFSET(0x1A9BD700)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A9BD620)
#define DG_TWEENING_TWEENSETTINGSEXTENSIONS_SETPATHFORWARDDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A9BD930)

namespace DG::Tweening
{
	inline static constexpr unsigned int TweenSettingsExtensions_TypeDefinitionIndex = 24101;
