...
#define DG_TWEENING_DOTWEENANIMATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x11AC14D0)
#define DG_TWEENING_DOTWEENANIMATION_CREATETWEEN_OFFSET UNITYSDK_OFFSET(0x11AC16F0)
#define DG_TWEENING_DOTWEENANIMATION_DOCOMPLETE_OFFSET UNITYSDK_OFFSET(0x11AC2380)
#define DG_TWEENING_DOTWEENANIMATION_DOKILL_OFFSET UNITYSDK_OFFSET(0x11AC2450)
#define DG_TWEENING_DOTWEENANIMATION_DOPAUSE_OFFSET UNITYSDK_OFFSET(0x11AC1BE0)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYALLBYID_OFFSET UNITYSDK_OFFSET(0x11AC2620)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYBACKWARDSALLBYID_OFFSET UNITYSDK_OFFSET(0x11AC27E0)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYBACKWARDSBYID_OFFSET UNITYSDK_OFFSET(0x11AC26F0)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYBACKWARDS_OFFSET UNITYSDK_OFFSET(0x11AC1A40)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYBYID_OFFSET UNITYSDK_OFFSET(0x11AC2530)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYFORWARDALLBYID_OFFSET UNITYSDK_OFFSET(0x11AC29A0)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYFORWARDBYID_OFFSET UNITYSDK_OFFSET(0x11AC28B0)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYFORWARD_OFFSET UNITYSDK_OFFSET(0x11AC1B10)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYNEXT_OFFSET UNITYSDK_OFFSET(0x11AC2A70)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAY_OFFSET UNITYSDK_OFFSET(0x11AC1970)
#define DG_TWEENING_DOTWEENANIMATION_DORESTARTALLBYID_OFFSET UNITYSDK_OFFSET(0x11AC2E70)
#define DG_TWEENING_DOTWEENANIMATION_DORESTARTBYID_OFFSET UNITYSDK_OFFSET(0x11AC2D80)
#define DG_TWEENING_DOTWEENANIMATION_DORESTART_OFFSET UNITYSDK_OFFSET(0x11AC1EE0)
#define DG_TWEENING_DOTWEENANIMATION_DOREWINDANDPLAYNEXT_OFFSET UNITYSDK_OFFSET(0x11AC2C90)
#define DG_TWEENING_DOTWEENANIMATION_DOREWIND_OFFSET UNITYSDK_OFFSET(0x11AC1D80)
#define DG_TWEENING_DOTWEENANIMATION_DOTOGGLEPAUSE_OFFSET UNITYSDK_OFFSET(0x11AC1CB0)
#define DG_TWEENING_DOTWEENANIMATION_GETTWEENS_OFFSET UNITYSDK_OFFSET(0x11AC2F40)
#define DG_TWEENING_DOTWEENANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x11AC1670)
#define DG_TWEENING_DOTWEENANIMATION_REEVALUATERELATIVETWEEN_OFFSET UNITYSDK_OFFSET(0x11AC2160)
#define DG_TWEENING_DOTWEENANIMATION_START_OFFSET UNITYSDK_OFFSET(0x11AC15A0)
#define DG_TWEENING_DOTWEENANIMATION_TYPETODOTARGETTYPE_OFFSET UNITYSDK_OFFSET(0x11AC30F0)
#define DG_TWEENING_DOTWEENANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x11AC3490)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOTweenAnimation_TypeDefinitionIndex = 84228;
