...
#define DG_TWEENING_DOTWEENANIMATION_AWAKE_OFFSET UNITYSDK_OFFSET(0x12445E00)
#define DG_TWEENING_DOTWEENANIMATION_CREATETWEEN_OFFSET UNITYSDK_OFFSET(0x12446020)
#define DG_TWEENING_DOTWEENANIMATION_DOCOMPLETE_OFFSET UNITYSDK_OFFSET(0x12446CA0)
#define DG_TWEENING_DOTWEENANIMATION_DOKILL_OFFSET UNITYSDK_OFFSET(0x12446D70)
#define DG_TWEENING_DOTWEENANIMATION_DOPAUSE_OFFSET UNITYSDK_OFFSET(0x12446500)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYALLBYID_OFFSET UNITYSDK_OFFSET(0x12446F40)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYBACKWARDSALLBYID_OFFSET UNITYSDK_OFFSET(0x12447100)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYBACKWARDSBYID_OFFSET UNITYSDK_OFFSET(0x12447010)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYBACKWARDS_OFFSET UNITYSDK_OFFSET(0x12446360)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYBYID_OFFSET UNITYSDK_OFFSET(0x12446E50)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYFORWARDALLBYID_OFFSET UNITYSDK_OFFSET(0x124472C0)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYFORWARDBYID_OFFSET UNITYSDK_OFFSET(0x124471D0)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYFORWARD_OFFSET UNITYSDK_OFFSET(0x12446430)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAYNEXT_OFFSET UNITYSDK_OFFSET(0x12447390)
#define DG_TWEENING_DOTWEENANIMATION_DOPLAY_OFFSET UNITYSDK_OFFSET(0x12446290)
#define DG_TWEENING_DOTWEENANIMATION_DORESTARTALLBYID_OFFSET UNITYSDK_OFFSET(0x12447790)
#define DG_TWEENING_DOTWEENANIMATION_DORESTARTBYID_OFFSET UNITYSDK_OFFSET(0x124476A0)
#define DG_TWEENING_DOTWEENANIMATION_DORESTART_OFFSET UNITYSDK_OFFSET(0x12446800)
#define DG_TWEENING_DOTWEENANIMATION_DOREWINDANDPLAYNEXT_OFFSET UNITYSDK_OFFSET(0x124475B0)
#define DG_TWEENING_DOTWEENANIMATION_DOREWIND_OFFSET UNITYSDK_OFFSET(0x124466A0)
#define DG_TWEENING_DOTWEENANIMATION_DOTOGGLEPAUSE_OFFSET UNITYSDK_OFFSET(0x124465D0)
#define DG_TWEENING_DOTWEENANIMATION_GETTWEENS_OFFSET UNITYSDK_OFFSET(0x12447860)
#define DG_TWEENING_DOTWEENANIMATION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x12445FA0)
#define DG_TWEENING_DOTWEENANIMATION_REEVALUATERELATIVETWEEN_OFFSET UNITYSDK_OFFSET(0x12446A80)
#define DG_TWEENING_DOTWEENANIMATION_START_OFFSET UNITYSDK_OFFSET(0x12445ED0)
#define DG_TWEENING_DOTWEENANIMATION_TYPETODOTARGETTYPE_OFFSET UNITYSDK_OFFSET(0x12447A10)
#define DG_TWEENING_DOTWEENANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x12447DB0)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOTweenAnimation_TypeDefinitionIndex = 82116;
