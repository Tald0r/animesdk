...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EA8D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS2_0__DOASPECT_B__0_OFFSET UNITYSDK_OFFSET(0x1B6EA8E0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS2_0__DOASPECT_B__1_OFFSET UNITYSDK_OFFSET(0x1B6EA900)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass2_0_TypeDefinitionIndex = 24848;
