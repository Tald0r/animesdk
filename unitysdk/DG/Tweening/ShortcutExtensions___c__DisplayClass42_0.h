...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS42_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B570E10)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS42_0__DOLOCALMOVEX_B__0_OFFSET UNITYSDK_OFFSET(0x1B570E20)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS42_0__DOLOCALMOVEX_B__1_OFFSET UNITYSDK_OFFSET(0x1B570E70)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass42_0_TypeDefinitionIndex = 24888;
