...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS1_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EAD70)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS1_0__DOCOLOR_B__0_OFFSET UNITYSDK_OFFSET(0x1B4EE930)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS1_0__DOCOLOR_B__1_OFFSET UNITYSDK_OFFSET(0x1B4EE970)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass1_0_TypeDefinitionIndex = 32356;
