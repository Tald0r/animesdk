...
#define DG_TWEENING_DOVIRTUAL___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4CC10)
#define DG_TWEENING_DOVIRTUAL___C__DISPLAYCLASS0_0__FLOAT_B__0_OFFSET UNITYSDK_OFFSET(0x1AF4CC20)
#define DG_TWEENING_DOVIRTUAL___C__DISPLAYCLASS0_0__FLOAT_B__1_OFFSET UNITYSDK_OFFSET(0x1AF4CC30)
#define DG_TWEENING_DOVIRTUAL___C__DISPLAYCLASS0_0__FLOAT_B__2_OFFSET UNITYSDK_OFFSET(0x1AF4CC40)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOVirtual___c__DisplayClass0_0_TypeDefinitionIndex = 24009;
