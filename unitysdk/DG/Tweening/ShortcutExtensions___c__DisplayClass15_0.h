...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D9A80)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS15_0__DOINTENSITY_B__0_OFFSET UNITYSDK_OFFSET(0x1B0D9A90)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS15_0__DOINTENSITY_B__1_OFFSET UNITYSDK_OFFSET(0x1B0D9AB0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass15_0_TypeDefinitionIndex = 24037;
