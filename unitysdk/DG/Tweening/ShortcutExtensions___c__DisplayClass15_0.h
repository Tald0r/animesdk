...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS15_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EA5F0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS15_0__DOINTENSITY_B__0_OFFSET UNITYSDK_OFFSET(0x1B6EA600)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS15_0__DOINTENSITY_B__1_OFFSET UNITYSDK_OFFSET(0x1B6EA620)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass15_0_TypeDefinitionIndex = 24861;
