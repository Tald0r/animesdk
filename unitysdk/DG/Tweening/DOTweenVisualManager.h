...
#define DG_TWEENING_DOTWEENVISUALMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B02DC00)
#define DG_TWEENING_DOTWEENVISUALMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B02D9B0)
#define DG_TWEENING_DOTWEENVISUALMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B02D870)
#define DG_TWEENING_DOTWEENVISUALMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02E160)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOTweenVisualManager_TypeDefinitionIndex = 31440;
