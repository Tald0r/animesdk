...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS23_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4ECD40)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS23_0__DOPUNCHANCHORPOS_B__0_OFFSET UNITYSDK_OFFSET(0x1B4EEB00)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS23_0__DOPUNCHANCHORPOS_B__1_OFFSET UNITYSDK_OFFSET(0x1B4EEB50)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass23_0_TypeDefinitionIndex = 32377;
