...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS22_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECDC70)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS22_0__DOSIZEDELTA_B__0_OFFSET UNITYSDK_OFFSET(0x1AECFB00)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS22_0__DOSIZEDELTA_B__1_OFFSET UNITYSDK_OFFSET(0x1AECFB40)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass22_0_TypeDefinitionIndex = 31424;
