...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS49_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5711F0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS49_0__DOSCALE_B__0_OFFSET UNITYSDK_OFFSET(0x1B571200)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS49_0__DOSCALE_B__1_OFFSET UNITYSDK_OFFSET(0x1B571250)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass49_0_TypeDefinitionIndex = 24895;
