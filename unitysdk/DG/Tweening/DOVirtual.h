...
#define DG_TWEENING_DOVIRTUAL_DELAYEDCALL_OFFSET UNITYSDK_OFFSET(0x1B6B9010)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_1_OFFSET UNITYSDK_OFFSET(0x1B6B8E20)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_2_OFFSET UNITYSDK_OFFSET(0x1B6B8EC0)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_3_OFFSET UNITYSDK_OFFSET(0x1B6B8F20)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_OFFSET UNITYSDK_OFFSET(0x1B6B8D90)
#define DG_TWEENING_DOVIRTUAL_FLOAT_OFFSET UNITYSDK_OFFSET(0x1B6B8C00)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOVirtual_TypeDefinitionIndex = 24832;
