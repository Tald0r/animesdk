...
#define DG_TWEENING_DOVIRTUAL_DELAYEDCALL_OFFSET UNITYSDK_OFFSET(0x1B0AB0F0)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_1_OFFSET UNITYSDK_OFFSET(0x1B0AAF00)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_2_OFFSET UNITYSDK_OFFSET(0x1B0AAFA0)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_3_OFFSET UNITYSDK_OFFSET(0x1B0AB000)
#define DG_TWEENING_DOVIRTUAL_EASEDVALUE_OFFSET UNITYSDK_OFFSET(0x1B0AAE70)
#define DG_TWEENING_DOVIRTUAL_FLOAT_OFFSET UNITYSDK_OFFSET(0x1B0AACF0)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOVirtual_TypeDefinitionIndex = 24008;
