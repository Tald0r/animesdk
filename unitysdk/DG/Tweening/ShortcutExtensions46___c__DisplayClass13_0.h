...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EBF80)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS13_0__DOANCHORPOS_B__0_OFFSET UNITYSDK_OFFSET(0x1B4EE590)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS13_0__DOANCHORPOS_B__1_OFFSET UNITYSDK_OFFSET(0x1B4EE5D0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass13_0_TypeDefinitionIndex = 32367;
