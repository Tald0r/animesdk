...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECD490)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS16_0__DOANCHORPOS3D_B__0_OFFSET UNITYSDK_OFFSET(0x1AECF750)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS16_0__DOANCHORPOS3D_B__1_OFFSET UNITYSDK_OFFSET(0x1AECF7D0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass16_0_TypeDefinitionIndex = 31418;
