...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECCEF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS12_0__DOSCALE_B__0_OFFSET UNITYSDK_OFFSET(0x1AECF5C0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS12_0__DOSCALE_B__1_OFFSET UNITYSDK_OFFSET(0x1AECF5E0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass12_0_TypeDefinitionIndex = 31414;
