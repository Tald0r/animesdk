...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS30_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EDA90)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS30_0__DOVALUE_B__0_OFFSET UNITYSDK_OFFSET(0x1B4EF210)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS30_0__DOVALUE_B__1_OFFSET UNITYSDK_OFFSET(0x1B4EF240)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass30_0_TypeDefinitionIndex = 32384;
