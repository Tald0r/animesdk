...
#define DG_TWEENING_EASEFACTORY_STOPMOTION_1_OFFSET UNITYSDK_OFFSET(0x1B570BC0)
#define DG_TWEENING_EASEFACTORY_STOPMOTION_2_OFFSET UNITYSDK_OFFSET(0x1B570B20)
#define DG_TWEENING_EASEFACTORY_STOPMOTION_OFFSET UNITYSDK_OFFSET(0x1B570A50)
#define DG_TWEENING_EASEFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B570CC0)

namespace DG::Tweening
{
	inline static constexpr unsigned int EaseFactory_TypeDefinitionIndex = 24835;
