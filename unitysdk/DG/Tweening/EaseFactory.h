...
#define DG_TWEENING_EASEFACTORY_STOPMOTION_1_OFFSET UNITYSDK_OFFSET(0x1AF4CE00)
#define DG_TWEENING_EASEFACTORY_STOPMOTION_2_OFFSET UNITYSDK_OFFSET(0x1AF4CD60)
#define DG_TWEENING_EASEFACTORY_STOPMOTION_OFFSET UNITYSDK_OFFSET(0x1AF4CC90)
#define DG_TWEENING_EASEFACTORY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4CEF0)

namespace DG::Tweening
{
	inline static constexpr unsigned int EaseFactory_TypeDefinitionIndex = 24011;
