...
#define DG_TWEENING_TWEENEXTENSIONS_COMPLETEDLOOPS_OFFSET UNITYSDK_OFFSET(0x1B4C9740)
#define DG_TWEENING_TWEENEXTENSIONS_COMPLETE_1_OFFSET UNITYSDK_OFFSET(0x1B4C8670)
#define DG_TWEENING_TWEENEXTENSIONS_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1B4C8660)
#define DG_TWEENING_TWEENEXTENSIONS_DELAY_OFFSET UNITYSDK_OFFSET(0x1B4C9780)
#define DG_TWEENING_TWEENEXTENSIONS_DURATION_OFFSET UNITYSDK_OFFSET(0x1B4C97D0)
#define DG_TWEENING_TWEENEXTENSIONS_ELAPSEDDIRECTIONALPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x1B4C98C0)
#define DG_TWEENING_TWEENEXTENSIONS_ELAPSEDPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x1B4C9840)
#define DG_TWEENING_TWEENEXTENSIONS_ELAPSED_OFFSET UNITYSDK_OFFSET(0x1B4C7DA0)
#define DG_TWEENING_TWEENEXTENSIONS_FLIP_OFFSET UNITYSDK_OFFSET(0x1B4C87A0)
#define DG_TWEENING_TWEENEXTENSIONS_FORCEINIT_OFFSET UNITYSDK_OFFSET(0x1B4C8830)
#define DG_TWEENING_TWEENEXTENSIONS_GOTOWAYPOINT_OFFSET UNITYSDK_OFFSET(0x1B4C8EF0)
#define DG_TWEENING_TWEENEXTENSIONS_GOTO_OFFSET UNITYSDK_OFFSET(0x1B4C7F80)
#define DG_TWEENING_TWEENEXTENSIONS_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1B4C9950)
#define DG_TWEENING_TWEENEXTENSIONS_ISBACKWARDS_OFFSET UNITYSDK_OFFSET(0x1B4C9970)
#define DG_TWEENING_TWEENEXTENSIONS_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1B4C99B0)
#define DG_TWEENING_TWEENEXTENSIONS_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1B4C99F0)
#define DG_TWEENING_TWEENEXTENSIONS_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x1B4C9A30)
#define DG_TWEENING_TWEENEXTENSIONS_KILL_OFFSET UNITYSDK_OFFSET(0x1B4C8940)
#define DG_TWEENING_TWEENEXTENSIONS_LOOPS_OFFSET UNITYSDK_OFFSET(0x1B4C9A70)
#define DG_TWEENING_TWEENEXTENSIONS_PATHGETDRAWPOINTS_OFFSET UNITYSDK_OFFSET(0x1B4C9C10)
#define DG_TWEENING_TWEENEXTENSIONS_PATHGETPOINT_OFFSET UNITYSDK_OFFSET(0x1B4C9AB0)
#define DG_TWEENING_TWEENEXTENSIONS_PATHLENGTH_OFFSET UNITYSDK_OFFSET(0x1B4C9D20)
#define DG_TWEENING_TWEENEXTENSIONS_PLAYBACKWARDS_OFFSET UNITYSDK_OFFSET(0x1B4C8AE0)
#define DG_TWEENING_TWEENEXTENSIONS_PLAYFORWARD_OFFSET UNITYSDK_OFFSET(0x1B4C8B70)
#define DG_TWEENING_TWEENEXTENSIONS_RESTART_OFFSET UNITYSDK_OFFSET(0x1B4C8C00)
#define DG_TWEENING_TWEENEXTENSIONS_REWIND_OFFSET UNITYSDK_OFFSET(0x1B4C8CA0)
#define DG_TWEENING_TWEENEXTENSIONS_SMOOTHREWIND_OFFSET UNITYSDK_OFFSET(0x1B4C8DD0)
#define DG_TWEENING_TWEENEXTENSIONS_TOGGLEPAUSE_OFFSET UNITYSDK_OFFSET(0x1B4C8E60)
#define DG_TWEENING_TWEENEXTENSIONS_WAITFORCOMPLETION_OFFSET UNITYSDK_OFFSET(0x1B4C9290)
#define DG_TWEENING_TWEENEXTENSIONS_WAITFORELAPSEDLOOPS_OFFSET UNITYSDK_OFFSET(0x1B4C94D0)
#define DG_TWEENING_TWEENEXTENSIONS_WAITFORKILL_OFFSET UNITYSDK_OFFSET(0x1B4C9410)
#define DG_TWEENING_TWEENEXTENSIONS_WAITFORPOSITION_OFFSET UNITYSDK_OFFSET(0x1B4C95A0)
#define DG_TWEENING_TWEENEXTENSIONS_WAITFORREWIND_OFFSET UNITYSDK_OFFSET(0x1B4C9350)
#define DG_TWEENING_TWEENEXTENSIONS_WAITFORSTART_OFFSET UNITYSDK_OFFSET(0x1B4C9680)

namespace DG::Tweening
{
	inline static constexpr unsigned int TweenExtensions_TypeDefinitionIndex = 24842;
