...
#define DG_TWEENING_TWEENEXTENSIONS_COMPLETEDLOOPS_OFFSET UNITYSDK_OFFSET(0x1AEAF0F0)
#define DG_TWEENING_TWEENEXTENSIONS_COMPLETE_1_OFFSET UNITYSDK_OFFSET(0x1AEAE020)
#define DG_TWEENING_TWEENEXTENSIONS_COMPLETE_OFFSET UNITYSDK_OFFSET(0x1AEAE010)
#define DG_TWEENING_TWEENEXTENSIONS_DELAY_OFFSET UNITYSDK_OFFSET(0x1AEAF130)
#define DG_TWEENING_TWEENEXTENSIONS_DURATION_OFFSET UNITYSDK_OFFSET(0x1AEAF180)
#define DG_TWEENING_TWEENEXTENSIONS_ELAPSEDDIRECTIONALPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x1AEAF270)
#define DG_TWEENING_TWEENEXTENSIONS_ELAPSEDPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x1AEAF1F0)
#define DG_TWEENING_TWEENEXTENSIONS_ELAPSED_OFFSET UNITYSDK_OFFSET(0x1AEAD740)
#define DG_TWEENING_TWEENEXTENSIONS_FLIP_OFFSET UNITYSDK_OFFSET(0x1AEAE150)
#define DG_TWEENING_TWEENEXTENSIONS_FORCEINIT_OFFSET UNITYSDK_OFFSET(0x1AEAE1E0)
#define DG_TWEENING_TWEENEXTENSIONS_GOTOWAYPOINT_OFFSET UNITYSDK_OFFSET(0x1AEAE8A0)
#define DG_TWEENING_TWEENEXTENSIONS_GOTO_OFFSET UNITYSDK_OFFSET(0x1AEAD920)
#define DG_TWEENING_TWEENEXTENSIONS_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1AEAF300)
#define DG_TWEENING_TWEENEXTENSIONS_ISBACKWARDS_OFFSET UNITYSDK_OFFSET(0x1AEAF320)
#define DG_TWEENING_TWEENEXTENSIONS_ISCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1AEAF360)
#define DG_TWEENING_TWEENEXTENSIONS_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1AEAF3A0)
#define DG_TWEENING_TWEENEXTENSIONS_ISPLAYING_OFFSET UNITYSDK_OFFSET(0x1AEAF3E0)
#define DG_TWEENING_TWEENEXTENSIONS_KILL_OFFSET UNITYSDK_OFFSET(0x1AEAE2F0)
#define DG_TWEENING_TWEENEXTENSIONS_LOOPS_OFFSET UNITYSDK_OFFSET(0x1AEAF420)
#define DG_TWEENING_TWEENEXTENSIONS_PATHGETDRAWPOINTS_OFFSET UNITYSDK_OFFSET(0x1AEAF5C0)
#define DG_TWEENING_TWEENEXTENSIONS_PATHGETPOINT_OFFSET UNITYSDK_OFFSET(0x1AEAF460)
#define DG_TWEENING_TWEENEXTENSIONS_PATHLENGTH_OFFSET UNITYSDK_OFFSET(0x1AEAF6D0)
#define DG_TWEENING_TWEENEXTENSIONS_PLAYBACKWARDS_OFFSET UNITYSDK_OFFSET(0x1AEAE490)
#define DG_TWEENING_TWEENEXTENSIONS_PLAYFORWARD_OFFSET UNITYSDK_OFFSET(0x1AEAE520)
#define DG_TWEENING_TWEENEXTENSIONS_RESTART_OFFSET UNITYSDK_OFFSET(0x1AEAE5B0)
#define DG_TWEENING_TWEENEXTENSIONS_REWIND_OFFSET UNITYSDK_OFFSET(0x1AEAE650)
#define DG_TWEENING_TWEENEXTENSIONS_SMOOTHREWIND_OFFSET UNITYSDK_OFFSET(0x1AEAE780)
#define DG_TWEENING_TWEENEXTENSIONS_TOGGLEPAUSE_OFFSET UNITYSDK_OFFSET(0x1AEAE810)
#define DG_TWEENING_TWEENEXTENSIONS_WAITFORCOMPLETION_OFFSET UNITYSDK_OFFSET(0x1AEAEC40)
#define DG_TWEENING_TWEENEXTENSIONS_WAITFORELAPSEDLOOPS_OFFSET UNITYSDK_OFFSET(0x1AEAEE80)
#define DG_TWEENING_TWEENEXTENSIONS_WAITFORKILL_OFFSET UNITYSDK_OFFSET(0x1AEAEDC0)
#define DG_TWEENING_TWEENEXTENSIONS_WAITFORPOSITION_OFFSET UNITYSDK_OFFSET(0x1AEAEF50)
#define DG_TWEENING_TWEENEXTENSIONS_WAITFORREWIND_OFFSET UNITYSDK_OFFSET(0x1AEAED00)
#define DG_TWEENING_TWEENEXTENSIONS_WAITFORSTART_OFFSET UNITYSDK_OFFSET(0x1AEAF030)

namespace DG::Tweening
{
	inline static constexpr unsigned int TweenExtensions_TypeDefinitionIndex = 24018;
