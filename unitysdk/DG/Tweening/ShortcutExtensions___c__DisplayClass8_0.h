...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEAD650)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS8_0__DOPIXELRECT_B__0_OFFSET UNITYSDK_OFFSET(0x1AEAD660)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS8_0__DOPIXELRECT_B__1_OFFSET UNITYSDK_OFFSET(0x1AEAD6A0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass8_0_TypeDefinitionIndex = 24030;
