...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6BA4A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS36_0__DOTIME_B__0_OFFSET UNITYSDK_OFFSET(0x1B6BA4B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS36_0__DOTIME_B__1_OFFSET UNITYSDK_OFFSET(0x1B6BA4D0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass36_0_TypeDefinitionIndex = 24882;
