...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS24_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECDFB0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS24_0__DOSHAKEANCHORPOS_B__0_OFFSET UNITYSDK_OFFSET(0x1AECFBF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS24_0__DOSHAKEANCHORPOS_B__1_OFFSET UNITYSDK_OFFSET(0x1AECFC40)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass24_0_TypeDefinitionIndex = 31426;
