...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS3_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EB050)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS3_0__DOCOLOR_B__0_OFFSET UNITYSDK_OFFSET(0x1B4EF4B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS3_0__DOCOLOR_B__1_OFFSET UNITYSDK_OFFSET(0x1B4EF4E0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass3_0_TypeDefinitionIndex = 32358;
