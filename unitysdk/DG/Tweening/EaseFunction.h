...
#define DG_TWEENING_EASEFUNCTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B131850)
#define DG_TWEENING_EASEFUNCTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B131900)
#define DG_TWEENING_EASEFUNCTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B131450)
#define DG_TWEENING_EASEFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B131440)

namespace DG::Tweening
{
	inline static constexpr unsigned int EaseFunction_TypeDefinitionIndex = 24005;
