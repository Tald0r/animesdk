...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS43_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF4D0E0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS43_0__DOLOCALMOVEY_B__0_OFFSET UNITYSDK_OFFSET(0x1AF4D0F0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS43_0__DOLOCALMOVEY_B__1_OFFSET UNITYSDK_OFFSET(0x1AF4D140)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass43_0_TypeDefinitionIndex = 24065;
