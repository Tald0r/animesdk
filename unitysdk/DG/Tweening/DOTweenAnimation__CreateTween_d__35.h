...
#define DG_TWEENING_DOTWEENANIMATION__CREATETWEEN_D__35_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x6D1120)
#define DG_TWEENING_DOTWEENANIMATION__CREATETWEEN_D__35_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOTweenAnimation__CreateTween_d__35_TypeDefinitionIndex = 82119;
