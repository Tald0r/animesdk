...
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOANCHORMAX_OFFSET UNITYSDK_OFFSET(0x1AECD4A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOANCHORMIN_OFFSET UNITYSDK_OFFSET(0x1AECD5F0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOANCHORPOS3D_OFFSET UNITYSDK_OFFSET(0x1AECD310)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOANCHORPOSX_OFFSET UNITYSDK_OFFSET(0x1AECD050)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOANCHORPOSY_OFFSET UNITYSDK_OFFSET(0x1AECD1B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOANCHORPOS_OFFSET UNITYSDK_OFFSET(0x1AECCF00)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOBLENDABLECOLOR_1_OFFSET UNITYSDK_OFFSET(0x1AECF170)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOBLENDABLECOLOR_2_OFFSET UNITYSDK_OFFSET(0x1AECF310)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOBLENDABLECOLOR_OFFSET UNITYSDK_OFFSET(0x1AECEFB0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOCOLOR_1_OFFSET UNITYSDK_OFFSET(0x1AECBFF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOCOLOR_2_OFFSET UNITYSDK_OFFSET(0x1AECCB00)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOCOLOR_3_OFFSET UNITYSDK_OFFSET(0x1AECEB40)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOCOLOR_OFFSET UNITYSDK_OFFSET(0x1AECBD30)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOFADE_1_OFFSET UNITYSDK_OFFSET(0x1AECBE90)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOFADE_2_OFFSET UNITYSDK_OFFSET(0x1AECC150)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOFADE_3_OFFSET UNITYSDK_OFFSET(0x1AECCC60)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOFADE_4_OFFSET UNITYSDK_OFFSET(0x1AECECA0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOFADE_OFFSET UNITYSDK_OFFSET(0x1AECBBF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOFILLAMOUNT_OFFSET UNITYSDK_OFFSET(0x1AECC2B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOFLEXIBLESIZE_OFFSET UNITYSDK_OFFSET(0x1AECC710)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOGRADIENTCOLOR_OFFSET UNITYSDK_OFFSET(0x1AECC420)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOHORIZONTALNORMALIZEDPOS_OFFSET UNITYSDK_OFFSET(0x1AECE750)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOJUMPANCHORPOS_OFFSET UNITYSDK_OFFSET(0x1AECE190)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOMINSIZE_OFFSET UNITYSDK_OFFSET(0x1AECC860)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DONORMALIZEDPOS_OFFSET UNITYSDK_OFFSET(0x1AECE600)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOPIVOTX_OFFSET UNITYSDK_OFFSET(0x1AECD880)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOPIVOTY_OFFSET UNITYSDK_OFFSET(0x1AECD9D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOPIVOT_OFFSET UNITYSDK_OFFSET(0x1AECD740)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOPREFERREDSIZE_OFFSET UNITYSDK_OFFSET(0x1AECC9B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOPUNCHANCHORPOS_OFFSET UNITYSDK_OFFSET(0x1AECDC80)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOSCALE_OFFSET UNITYSDK_OFFSET(0x1AECCDC0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOSHAKEANCHORPOS_1_OFFSET UNITYSDK_OFFSET(0x1AECDFC0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOSHAKEANCHORPOS_OFFSET UNITYSDK_OFFSET(0x1AECDDF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOSIZEDELTA_OFFSET UNITYSDK_OFFSET(0x1AECDB30)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOTEXT_OFFSET UNITYSDK_OFFSET(0x1AECEE00)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOVALUE_OFFSET UNITYSDK_OFFSET(0x1AECE9F0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46_DOVERTICALNORMALIZEDPOS_OFFSET UNITYSDK_OFFSET(0x1AECE8A0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46_TypeDefinitionIndex = 31402;
