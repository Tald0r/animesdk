...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EA6B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS17_0__DOCOLOR_B__0_OFFSET UNITYSDK_OFFSET(0x1B6EA6C0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS17_0__DOCOLOR_B__1_OFFSET UNITYSDK_OFFSET(0x1B6EA6E0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass17_0_TypeDefinitionIndex = 24863;
