...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS17_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D9B40)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS17_0__DOCOLOR_B__0_OFFSET UNITYSDK_OFFSET(0x1B0D9B50)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS17_0__DOCOLOR_B__1_OFFSET UNITYSDK_OFFSET(0x1B0D9B70)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass17_0_TypeDefinitionIndex = 24039;
