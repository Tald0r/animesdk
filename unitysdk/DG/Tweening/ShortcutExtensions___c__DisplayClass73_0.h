...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS73_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B71EAF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS73_0__DOBLENDABLEMOVEBY_B__0_OFFSET UNITYSDK_OFFSET(0x1B71EB00)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS73_0__DOBLENDABLEMOVEBY_B__1_OFFSET UNITYSDK_OFFSET(0x1B71EB20)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass73_0_TypeDefinitionIndex = 24919;
