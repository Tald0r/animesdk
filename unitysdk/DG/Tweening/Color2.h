...
#define DG_TWEENING_COLOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1B6E89A0)
#define DG_TWEENING_COLOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B6E8A00)
#define DG_TWEENING_COLOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1B6E89D0)
#define DG_TWEENING_COLOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x393320)

namespace DG::Tweening
{
	inline static constexpr unsigned int Color2_TypeDefinitionIndex = 24826;
