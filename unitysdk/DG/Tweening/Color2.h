...
#define DG_TWEENING_COLOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1B0D7E40)
#define DG_TWEENING_COLOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B0D7EA0)
#define DG_TWEENING_COLOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1B0D7E70)
#define DG_TWEENING_COLOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x46EF60)

namespace DG::Tweening
{
	inline static constexpr unsigned int Color2_TypeDefinitionIndex = 24002;
