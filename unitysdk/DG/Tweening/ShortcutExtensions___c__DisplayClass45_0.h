...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS45_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B570FF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS45_0__DOROTATE_B__0_OFFSET UNITYSDK_OFFSET(0x1B571000)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS45_0__DOROTATE_B__1_OFFSET UNITYSDK_OFFSET(0x1B571040)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass45_0_TypeDefinitionIndex = 24891;
