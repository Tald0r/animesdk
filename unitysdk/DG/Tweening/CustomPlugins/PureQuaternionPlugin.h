...
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1AFD17A0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1AFD19D0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1AFD18C0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_PLUG_OFFSET UNITYSDK_OFFSET(0x1AFD1570)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1AFD1610)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1AFD1890)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1AFD1620)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1AFD17B0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD15F0)

namespace DG::Tweening::CustomPlugins
{
	inline static constexpr unsigned int PureQuaternionPlugin_TypeDefinitionIndex = 24147;
	...
	public:
		...
		{
			return (::DG::Tweening::CustomPlugins::PureQuaternionPlugin**)Il2CppClass::FromTypeDefinitionIndex(PureQuaternionPlugin_TypeDefinitionIndex)->GetStaticField(0x1DAA0);
		}
