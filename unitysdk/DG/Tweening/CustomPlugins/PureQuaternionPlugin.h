...
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B5DD2E0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B5DD520)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B5DD410)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_PLUG_OFFSET UNITYSDK_OFFSET(0x1B5DD0B0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B5DD150)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B5DD3E0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B5DD160)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B5DD2F0)
#define DG_TWEENING_CUSTOMPLUGINS_PUREQUATERNIONPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5DD130)

namespace DG::Tweening::CustomPlugins
{
	inline static constexpr unsigned int PureQuaternionPlugin_TypeDefinitionIndex = 24971;
	...
	public:
		...
		{
			return (::DG::Tweening::CustomPlugins::PureQuaternionPlugin**)Il2CppClass::FromTypeDefinitionIndex(PureQuaternionPlugin_TypeDefinitionIndex)->GetStaticField(0x1E570);
		}
