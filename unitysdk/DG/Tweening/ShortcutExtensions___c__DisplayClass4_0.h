...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B147EB0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS4_0__DOFARCLIPPLANE_B__0_OFFSET UNITYSDK_OFFSET(0x1B147EC0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS4_0__DOFARCLIPPLANE_B__1_OFFSET UNITYSDK_OFFSET(0x1B147EE0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass4_0_TypeDefinitionIndex = 24026;
