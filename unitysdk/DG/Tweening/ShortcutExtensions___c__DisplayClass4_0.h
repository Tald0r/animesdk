...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B765EE0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS4_0__DOFARCLIPPLANE_B__0_OFFSET UNITYSDK_OFFSET(0x1B765EF0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS4_0__DOFARCLIPPLANE_B__1_OFFSET UNITYSDK_OFFSET(0x1B765F10)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass4_0_TypeDefinitionIndex = 24850;
