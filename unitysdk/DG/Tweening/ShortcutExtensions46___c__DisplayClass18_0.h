...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS18_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECD730)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS18_0__DOANCHORMIN_B__0_OFFSET UNITYSDK_OFFSET(0x1AECF8C0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS18_0__DOANCHORMIN_B__1_OFFSET UNITYSDK_OFFSET(0x1AECF900)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass18_0_TypeDefinitionIndex = 31420;
