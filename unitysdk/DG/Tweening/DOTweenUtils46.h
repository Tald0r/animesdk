...
#define DG_TWEENING_DOTWEENUTILS46_SWITCHTORECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AECB900)

namespace DG::Tweening
{
	inline static constexpr unsigned int DOTweenUtils46_TypeDefinitionIndex = 31401;
