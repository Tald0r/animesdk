...
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B5DD670)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B5DDB70)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B5DDA70)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B5DD630)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B5DD950)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B5DD660)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B5DD790)
#define DG_TWEENING_PLUGINS_VECTOR3ARRAYPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5DE5F0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int Vector3ArrayPlugin_TypeDefinitionIndex = 24935;
