...
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B63E1E0)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B63E2C0)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B63E2B0)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_GET_OFFSET UNITYSDK_OFFSET(0x1B63E1A0)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B63E180)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B63E210)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B63E190)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B63E200)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B63E780)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B63E760)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int SpiralPlugin_TypeDefinitionIndex = 32403;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(SpiralPlugin_TypeDefinitionIndex)->GetStaticField(0x7EC0);
		}
