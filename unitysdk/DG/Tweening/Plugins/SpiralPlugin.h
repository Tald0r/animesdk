...
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B02E1E0)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B02E2C0)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B02E2B0)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_GET_OFFSET UNITYSDK_OFFSET(0x1B02E1A0)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B02E180)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B02E210)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B02E190)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B02E200)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B02E780)
#define DG_TWEENING_PLUGINS_SPIRALPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B02E760)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int SpiralPlugin_TypeDefinitionIndex = 31451;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(SpiralPlugin_TypeDefinitionIndex)->GetStaticField(0x7B90);
		}
