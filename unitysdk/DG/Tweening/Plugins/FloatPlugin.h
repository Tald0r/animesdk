...
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1AEAB410)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1AEAB4A0)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1AEAB480)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1AEAB290)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1AEAB450)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1AEAB2A0)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1AEAB420)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEAB6D0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int FloatPlugin_TypeDefinitionIndex = 24123;
