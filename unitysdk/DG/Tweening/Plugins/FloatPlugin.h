...
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B4C5A60)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B4C5AF0)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B4C5AD0)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B4C58E0)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B4C5AA0)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B4C58F0)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B4C5A70)
#define DG_TWEENING_PLUGINS_FLOATPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C5D20)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int FloatPlugin_TypeDefinitionIndex = 24947;
