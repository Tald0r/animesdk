...
#define DG_TWEENING_PLUGINS_COLORPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B243C30)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B243CB0)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B243CA0)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B243AF0)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B243C70)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B243B00)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B243C40)
#define DG_TWEENING_PLUGINS_COLORPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B243EF0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int ColorPlugin_TypeDefinitionIndex = 24937;
