...
#define DG_TWEENING_PLUGINS_COLORPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1AC41830)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1AC418B0)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1AC418A0)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1AC416F0)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1AC41870)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1AC41700)
#define DG_TWEENING_PLUGINS_COLORPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1AC41840)
#define DG_TWEENING_PLUGINS_COLORPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC41AF0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int ColorPlugin_TypeDefinitionIndex = 24113;
