...
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1AEAB8F0)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1AEABCF0)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1AEABC60)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1AEAB6F0)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1AEABAD0)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1AEAB720)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1AEAB990)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AEAC620)
#define DG_TWEENING_PLUGINS_RECTOFFSETPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEAC600)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int RectOffsetPlugin_TypeDefinitionIndex = 24116;
	...
	public:
		...
		{
			return (::UnityEngine::RectOffset**)Il2CppClass::FromTypeDefinitionIndex(RectOffsetPlugin_TypeDefinitionIndex)->GetStaticField(0x1DA00);
		}
