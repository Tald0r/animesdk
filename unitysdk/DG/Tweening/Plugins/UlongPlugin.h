...
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B752680)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B752730)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B7526F0)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B7525D0)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B7526C0)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B7525E0)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B752690)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7529B0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int UlongPlugin_TypeDefinitionIndex = 24934;
