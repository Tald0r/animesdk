...
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B135C60)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B135D10)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B135CD0)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B135BB0)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B135CA0)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B135BC0)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B135C70)
#define DG_TWEENING_PLUGINS_ULONGPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B135F90)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int UlongPlugin_TypeDefinitionIndex = 24110;
