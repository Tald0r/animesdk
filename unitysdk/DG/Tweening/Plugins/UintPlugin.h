...
#define DG_TWEENING_PLUGINS_UINTPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B147BC0)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B147C50)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B147C30)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B147B10)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B147BF0)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B147B20)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B147BD0)
#define DG_TWEENING_PLUGINS_UINTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B147E90)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int UintPlugin_TypeDefinitionIndex = 24118;
