...
#define DG_TWEENING_PLUGINS_UINTPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B765BF0)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B765C80)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B765C60)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B765B40)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B765C20)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B765B50)
#define DG_TWEENING_PLUGINS_UINTPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B765C00)
#define DG_TWEENING_PLUGINS_UINTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B765EC0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int UintPlugin_TypeDefinitionIndex = 24942;
