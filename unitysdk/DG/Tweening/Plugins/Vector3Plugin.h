...
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B70C7B0)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B70C950)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B70C900)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B70C3F0)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B70C820)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B70C400)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B70C7D0)
#define DG_TWEENING_PLUGINS_VECTOR3PLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B70D0F0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int Vector3Plugin_TypeDefinitionIndex = 24948;
