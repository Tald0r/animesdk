...
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_APPEND_OFFSET UNITYSDK_OFFSET(0x1B0D8790)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B0D7F80)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B0D8130)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B0D80F0)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B0D7F50)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_SCRAMBLEDCHARSTOUSE_OFFSET UNITYSDK_OFFSET(0x1B0D9320)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B0D7FA0)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B0D7EC0)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B0D7F90)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0D9430)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D9410)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int StringPlugin_TypeDefinitionIndex = 24121;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(StringPlugin_TypeDefinitionIndex)->GetStaticField(0x1D890);
		}
		static ::System::Text::StringBuilder** StaticGet__Buffer()
		{
			return (::System::Text::StringBuilder**)Il2CppClass::FromTypeDefinitionIndex(StringPlugin_TypeDefinitionIndex)->GetStaticField(0x1D898);
		}
