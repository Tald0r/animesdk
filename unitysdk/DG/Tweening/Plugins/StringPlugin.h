...
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_APPEND_OFFSET UNITYSDK_OFFSET(0x1B6E9300)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B6E8AF0)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B6E8CA0)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B6E8C60)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B6E8AB0)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_SCRAMBLEDCHARSTOUSE_OFFSET UNITYSDK_OFFSET(0x1B6E9E90)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B6E8B10)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B6E8A20)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B6E8B00)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6E9FA0)
#define DG_TWEENING_PLUGINS_STRINGPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6E9F80)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int StringPlugin_TypeDefinitionIndex = 24945;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(StringPlugin_TypeDefinitionIndex)->GetStaticField(0x1E360);
		}
		static ::System::Text::StringBuilder** StaticGet__Buffer()
		{
			return (::System::Text::StringBuilder**)Il2CppClass::FromTypeDefinitionIndex(StringPlugin_TypeDefinitionIndex)->GetStaticField(0x1E368);
		}
