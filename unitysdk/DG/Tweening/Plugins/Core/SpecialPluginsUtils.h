...
#define DG_TWEENING_PLUGINS_CORE_SPECIALPLUGINSUTILS_SETCAMERASHAKEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B245770)
#define DG_TWEENING_PLUGINS_CORE_SPECIALPLUGINSUTILS_SETLOOKAT_OFFSET UNITYSDK_OFFSET(0x1B2453D0)
#define DG_TWEENING_PLUGINS_CORE_SPECIALPLUGINSUTILS_SETPUNCH_OFFSET UNITYSDK_OFFSET(0x1B2455E0)
#define DG_TWEENING_PLUGINS_CORE_SPECIALPLUGINSUTILS_SETSHAKE_OFFSET UNITYSDK_OFFSET(0x1B245740)

namespace DG::Tweening::Plugins::Core
{
	inline static constexpr unsigned int SpecialPluginsUtils_TypeDefinitionIndex = 24961;
