...
#define DG_TWEENING_PLUGINS_CORE_SPECIALPLUGINSUTILS_SETCAMERASHAKEPOSITION_OFFSET UNITYSDK_OFFSET(0x1AC43370)
#define DG_TWEENING_PLUGINS_CORE_SPECIALPLUGINSUTILS_SETLOOKAT_OFFSET UNITYSDK_OFFSET(0x1AC42FD0)
#define DG_TWEENING_PLUGINS_CORE_SPECIALPLUGINSUTILS_SETPUNCH_OFFSET UNITYSDK_OFFSET(0x1AC431E0)
#define DG_TWEENING_PLUGINS_CORE_SPECIALPLUGINSUTILS_SETSHAKE_OFFSET UNITYSDK_OFFSET(0x1AC43340)

namespace DG::Tweening::Plugins::Core
{
	inline static constexpr unsigned int SpecialPluginsUtils_TypeDefinitionIndex = 24137;
