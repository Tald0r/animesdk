...
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_ASSIGNDECODER_OFFSET UNITYSDK_OFFSET(0x1B244180)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_ASSIGNWAYPOINTS_OFFSET UNITYSDK_OFFSET(0x1B2440B0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_CLONEINCREMENTAL_OFFSET UNITYSDK_OFFSET(0x1B244A50)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_CONVERTTOCONSTANTPATHPERC_OFFSET UNITYSDK_OFFSET(0x1B2444A0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B244940)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_DRAW_1_OFFSET UNITYSDK_OFFSET(0x1B244F60)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_DRAW_OFFSET UNITYSDK_OFFSET(0x1B244F50)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_FINALIZEPATH_OFFSET UNITYSDK_OFFSET(0x1B244240)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_GETDRAWPOINTS_OFFSET UNITYSDK_OFFSET(0x1B244690)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1B244420)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_GETWAYPOINTINDEXFROMPERC_OFFSET UNITYSDK_OFFSET(0x1B244600)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH_REFRESHNONLINEARDRAWWPS_OFFSET UNITYSDK_OFFSET(0x1B244800)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B244220)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_PATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B243F10)

namespace DG::Tweening::Plugins::Core::PathCore
{
	inline static constexpr unsigned int Path_TypeDefinitionIndex = 24970;
	...
	public:
		...
		{
			return (::DG::Tweening::Plugins::Core::PathCore::CatmullRomDecoder**)Il2CppClass::FromTypeDefinitionIndex(Path_TypeDefinitionIndex)->GetStaticField(0x1E350);
		}
		static ::DG::Tweening::Plugins::Core::PathCore::LinearDecoder** StaticGet__linearDecoder()
		{
			return (::DG::Tweening::Plugins::Core::PathCore::LinearDecoder**)Il2CppClass::FromTypeDefinitionIndex(Path_TypeDefinitionIndex)->GetStaticField(0x1E358);
		}
