...
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_FINALIZEPATH_OFFSET UNITYSDK_OFFSET(0x1B752080)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1B752380)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_SETTIMETOLENGTHTABLES_OFFSET UNITYSDK_OFFSET(0x1B7520C0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_SETWAYPOINTSLENGTHS_OFFSET UNITYSDK_OFFSET(0x1B7525B0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7525C0)

namespace DG::Tweening::Plugins::Core::PathCore
{
	inline static constexpr unsigned int LinearDecoder_TypeDefinitionIndex = 24969;
