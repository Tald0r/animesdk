...
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_FINALIZEPATH_OFFSET UNITYSDK_OFFSET(0x1B135660)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1B135960)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_SETTIMETOLENGTHTABLES_OFFSET UNITYSDK_OFFSET(0x1B1356A0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER_SETWAYPOINTSLENGTHS_OFFSET UNITYSDK_OFFSET(0x1B135B90)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_LINEARDECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B135BA0)

namespace DG::Tweening::Plugins::Core::PathCore
{
	inline static constexpr unsigned int LinearDecoder_TypeDefinitionIndex = 24145;
