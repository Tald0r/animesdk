...
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CONTROLPOINT_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1AF0AFF0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CONTROLPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x310080)

namespace DG::Tweening::Plugins::Core::PathCore
{
	inline static constexpr unsigned int ControlPoint_TypeDefinitionIndex = 24142;
