...
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER_FINALIZEPATH_OFFSET UNITYSDK_OFFSET(0x1B6B9150)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1B6B9C30)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER_SETTIMETOLENGTHTABLES_OFFSET UNITYSDK_OFFSET(0x1B6B9440)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER_SETWAYPOINTSLENGTHS_OFFSET UNITYSDK_OFFSET(0x1B6B96F0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B9F90)

namespace DG::Tweening::Plugins::Core::PathCore
{
	inline static constexpr unsigned int CatmullRomDecoder_TypeDefinitionIndex = 24968;
