...
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER_FINALIZEPATH_OFFSET UNITYSDK_OFFSET(0x1B0AB230)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1B0ABD10)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER_SETTIMETOLENGTHTABLES_OFFSET UNITYSDK_OFFSET(0x1B0AB520)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER_SETWAYPOINTSLENGTHS_OFFSET UNITYSDK_OFFSET(0x1B0AB7D0)
#define DG_TWEENING_PLUGINS_CORE_PATHCORE_CATMULLROMDECODER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AC070)

namespace DG::Tweening::Plugins::Core::PathCore
{
	inline static constexpr unsigned int CatmullRomDecoder_TypeDefinitionIndex = 24144;
