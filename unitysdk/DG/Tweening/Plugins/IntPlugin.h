...
#define DG_TWEENING_PLUGINS_INTPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1AF84050)
#define DG_TWEENING_PLUGINS_INTPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1AF840D0)
#define DG_TWEENING_PLUGINS_INTPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1AF840B0)
#define DG_TWEENING_PLUGINS_INTPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1AF83FA0)
#define DG_TWEENING_PLUGINS_INTPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1AF84080)
#define DG_TWEENING_PLUGINS_INTPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1AF83FB0)
#define DG_TWEENING_PLUGINS_INTPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1AF84060)
#define DG_TWEENING_PLUGINS_INTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF842B0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int IntPlugin_TypeDefinitionIndex = 24938;
