...
#define DG_TWEENING_PLUGINS_INTPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1A9B3C10)
#define DG_TWEENING_PLUGINS_INTPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1A9B3C90)
#define DG_TWEENING_PLUGINS_INTPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1A9B3C70)
#define DG_TWEENING_PLUGINS_INTPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1A9B3B60)
#define DG_TWEENING_PLUGINS_INTPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1A9B3C40)
#define DG_TWEENING_PLUGINS_INTPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1A9B3B70)
#define DG_TWEENING_PLUGINS_INTPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1A9B3C20)
#define DG_TWEENING_PLUGINS_INTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B3E70)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int IntPlugin_TypeDefinitionIndex = 24114;
