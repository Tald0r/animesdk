...
#define DG_TWEENING_PLUGINS_RECTPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B12B0D0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B12B180)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B12B140)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B12AD00)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B12B110)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B12AD10)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B12B0E0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B12B580)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int RectPlugin_TypeDefinitionIndex = 24117;
