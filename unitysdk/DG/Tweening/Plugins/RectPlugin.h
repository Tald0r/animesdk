...
#define DG_TWEENING_PLUGINS_RECTPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B7449C0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B744A70)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B744A30)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B744590)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B744A00)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B7445A0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B7449D0)
#define DG_TWEENING_PLUGINS_RECTPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B744E70)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int RectPlugin_TypeDefinitionIndex = 24941;
