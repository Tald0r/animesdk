...
#define DG_TWEENING_PLUGINS_PATHPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1AF0B3C0)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1AF0B9E0)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1AF0B9C0)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_GET_OFFSET UNITYSDK_OFFSET(0x1AF0B380)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1AF0B320)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1AF0B520)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1AF0B370)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETORIENTATION_OFFSET UNITYSDK_OFFSET(0x1AF0BD60)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1AF0B3E0)
#define DG_TWEENING_PLUGINS_PATHPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF0D180)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int PathPlugin_TypeDefinitionIndex = 24112;
