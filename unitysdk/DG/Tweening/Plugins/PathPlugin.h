...
#define DG_TWEENING_PLUGINS_PATHPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B52CC70)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B52D2A0)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B52D280)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_GET_OFFSET UNITYSDK_OFFSET(0x1B52CC30)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B52CBD0)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B52CDD0)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B52CC20)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETORIENTATION_OFFSET UNITYSDK_OFFSET(0x1B52D620)
#define DG_TWEENING_PLUGINS_PATHPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B52CC90)
#define DG_TWEENING_PLUGINS_PATHPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B52EA40)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int PathPlugin_TypeDefinitionIndex = 24936;
