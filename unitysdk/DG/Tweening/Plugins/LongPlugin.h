...
#define DG_TWEENING_PLUGINS_LONGPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1AF84380)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1AF84410)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1AF843F0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1AF842D0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1AF843C0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1AF842E0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1AF84390)
#define DG_TWEENING_PLUGINS_LONGPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF84600)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int LongPlugin_TypeDefinitionIndex = 24933;
