...
#define DG_TWEENING_PLUGINS_LONGPLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1A9B3F40)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1A9B3FD0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1A9B3FB0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1A9B3E90)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1A9B3F80)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1A9B3EA0)
#define DG_TWEENING_PLUGINS_LONGPLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1A9B3F50)
#define DG_TWEENING_PLUGINS_LONGPLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B41C0)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int LongPlugin_TypeDefinitionIndex = 24109;
