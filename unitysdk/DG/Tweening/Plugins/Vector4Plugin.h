...
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_CONVERTTOSTARTVALUE_OFFSET UNITYSDK_OFFSET(0x1B4C7150)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_EVALUATEANDAPPLY_OFFSET UNITYSDK_OFFSET(0x1B4C72F0)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_GETSPEEDBASEDDURATION_OFFSET UNITYSDK_OFFSET(0x1B4C7290)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_RESET_OFFSET UNITYSDK_OFFSET(0x1B4C6CC0)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_SETCHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1B4C7190)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_SETFROM_OFFSET UNITYSDK_OFFSET(0x1B4C6CD0)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN_SETRELATIVEENDVALUE_OFFSET UNITYSDK_OFFSET(0x1B4C7160)
#define DG_TWEENING_PLUGINS_VECTOR4PLUGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4C7C90)

namespace DG::Tweening::Plugins
{
	inline static constexpr unsigned int Vector4Plugin_TypeDefinitionIndex = 24944;
