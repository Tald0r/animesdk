...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0AC720)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS39_0__DOMOVEY_B__0_OFFSET UNITYSDK_OFFSET(0x1B0AC730)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS39_0__DOMOVEY_B__1_OFFSET UNITYSDK_OFFSET(0x1B0AC780)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass39_0_TypeDefinitionIndex = 24061;
