...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS39_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6BA640)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS39_0__DOMOVEY_B__0_OFFSET UNITYSDK_OFFSET(0x1B6BA650)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS39_0__DOMOVEY_B__1_OFFSET UNITYSDK_OFFSET(0x1B6BA6A0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass39_0_TypeDefinitionIndex = 24885;
