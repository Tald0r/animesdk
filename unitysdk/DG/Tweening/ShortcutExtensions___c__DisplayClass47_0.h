...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS47_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5710F0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS47_0__DOLOCALROTATE_B__0_OFFSET UNITYSDK_OFFSET(0x1B571100)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS47_0__DOLOCALROTATE_B__1_OFFSET UNITYSDK_OFFSET(0x1B571140)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass47_0_TypeDefinitionIndex = 24893;
