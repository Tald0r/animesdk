...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4EDD70)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS32_0__DOFADE_B__0_OFFSET UNITYSDK_OFFSET(0x1B4EF2D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS32_0__DOFADE_B__1_OFFSET UNITYSDK_OFFSET(0x1B4EF300)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass32_0_TypeDefinitionIndex = 32386;
