...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS25_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B745240)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS25_0__DOTILING_B__0_OFFSET UNITYSDK_OFFSET(0x1B745250)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS25_0__DOTILING_B__1_OFFSET UNITYSDK_OFFSET(0x1B7452C0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass25_0_TypeDefinitionIndex = 24871;
