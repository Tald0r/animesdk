...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS61_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B52EC00)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS61_0__DOSHAKEROTATION_B__0_OFFSET UNITYSDK_OFFSET(0x1B52EC10)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS61_0__DOSHAKEROTATION_B__1_OFFSET UNITYSDK_OFFSET(0x1B52ED20)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass61_0_TypeDefinitionIndex = 24907;
