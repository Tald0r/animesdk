...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS57_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5DFFD0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS57_0__DOPUNCHROTATION_B__0_OFFSET UNITYSDK_OFFSET(0x1B5DFFE0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS57_0__DOPUNCHROTATION_B__1_OFFSET UNITYSDK_OFFSET(0x1B5E00F0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass57_0_TypeDefinitionIndex = 24903;
