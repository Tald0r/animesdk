...
#define DG_TWEENING_SHORTCUTEXTENSIONS43___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B11F6B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS43___C__DISPLAYCLASS8_0__DOROTATE_B__0_OFFSET UNITYSDK_OFFSET(0x1B11FF20)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions43___c__DisplayClass8_0_TypeDefinitionIndex = 31397;
