...
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORSTART_D__18_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AC3C470)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORSTART_D__18_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC3C4C0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORSTART_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AC3C520)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORSTART_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AC3C4D0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORSTART_D__18_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AC3C460)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORSTART_D__18__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC3C450)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int DOTweenComponent__WaitForStart_d__18_TypeDefinitionIndex = 24158;
