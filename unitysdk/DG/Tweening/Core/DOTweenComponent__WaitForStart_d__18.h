...
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORSTART_D__18_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B23E840)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORSTART_D__18_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B23E890)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORSTART_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B23E8F0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORSTART_D__18_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B23E8A0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORSTART_D__18_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B23E830)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORSTART_D__18__CTOR_OFFSET UNITYSDK_OFFSET(0x1B23E820)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int DOTweenComponent__WaitForStart_d__18_TypeDefinitionIndex = 24982;
