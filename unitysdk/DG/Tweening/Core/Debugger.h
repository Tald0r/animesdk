...
#define DG_TWEENING_CORE_DEBUGGER_LOGERROR_OFFSET UNITYSDK_OFFSET(0x1B0AA110)
#define DG_TWEENING_CORE_DEBUGGER_LOGINVALIDTWEEN_OFFSET UNITYSDK_OFFSET(0x1B0AA310)
#define DG_TWEENING_CORE_DEBUGGER_LOGMISSINGMATERIALPROPERTY_OFFSET UNITYSDK_OFFSET(0x1B0AA950)
#define DG_TWEENING_CORE_DEBUGGER_LOGNESTEDTWEEN_OFFSET UNITYSDK_OFFSET(0x1B0AA4A0)
#define DG_TWEENING_CORE_DEBUGGER_LOGNONPATHTWEEN_OFFSET UNITYSDK_OFFSET(0x1B0AA7C0)
#define DG_TWEENING_CORE_DEBUGGER_LOGNULLTWEEN_OFFSET UNITYSDK_OFFSET(0x1B0AA630)
#define DG_TWEENING_CORE_DEBUGGER_LOGREMOVEACTIVETWEENERROR_OFFSET UNITYSDK_OFFSET(0x1B0AAB00)
#define DG_TWEENING_CORE_DEBUGGER_LOGREPORT_OFFSET UNITYSDK_OFFSET(0x1B0AA260)
#define DG_TWEENING_CORE_DEBUGGER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1B0A9FB0)
#define DG_TWEENING_CORE_DEBUGGER_LOG_OFFSET UNITYSDK_OFFSET(0x1B0A9E50)
#define DG_TWEENING_CORE_DEBUGGER_SETLOGPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B0AACB0)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int Debugger_TypeDefinitionIndex = 24151;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Debugger_TypeDefinitionIndex)->GetStaticField(0x47C0);
		}
