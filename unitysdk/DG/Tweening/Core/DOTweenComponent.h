...
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B0F4350)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_CREATE_OFFSET UNITYSDK_OFFSET(0x1B0F5280)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_DESTROYINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B0F5420)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0F4940)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0F4830)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x1B0F5010)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B0F4C50)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1B0F4AD0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B0F5050)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_START_OFFSET UNITYSDK_OFFSET(0x1B0F4370)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B0F44C0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_WAITFORCOMPLETION_OFFSET UNITYSDK_OFFSET(0x1B0F5090)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_WAITFORELAPSEDLOOPS_OFFSET UNITYSDK_OFFSET(0x1B0F5180)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_WAITFORKILL_OFFSET UNITYSDK_OFFSET(0x1B0F5130)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_WAITFORPOSITION_OFFSET UNITYSDK_OFFSET(0x1B0F51D0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_WAITFORREWIND_OFFSET UNITYSDK_OFFSET(0x1B0F50E0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_WAITFORSTART_OFFSET UNITYSDK_OFFSET(0x1B0F5230)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F5590)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int DOTweenComponent_TypeDefinitionIndex = 24152;
