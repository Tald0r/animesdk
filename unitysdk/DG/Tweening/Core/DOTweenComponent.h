...
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B70AE60)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_CREATE_OFFSET UNITYSDK_OFFSET(0x1B70BD90)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_DESTROYINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B70BF30)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1B70B450)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B70B340)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x1B70BB20)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B70B760)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1B70B5E0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B70BB60)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_START_OFFSET UNITYSDK_OFFSET(0x1B70AE80)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B70AFD0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_WAITFORCOMPLETION_OFFSET UNITYSDK_OFFSET(0x1B70BBA0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_WAITFORELAPSEDLOOPS_OFFSET UNITYSDK_OFFSET(0x1B70BC90)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_WAITFORKILL_OFFSET UNITYSDK_OFFSET(0x1B70BC40)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_WAITFORPOSITION_OFFSET UNITYSDK_OFFSET(0x1B70BCE0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_WAITFORREWIND_OFFSET UNITYSDK_OFFSET(0x1B70BBF0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT_WAITFORSTART_OFFSET UNITYSDK_OFFSET(0x1B70BD40)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B70C0A0)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int DOTweenComponent_TypeDefinitionIndex = 24976;
