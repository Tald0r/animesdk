...
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORREWIND_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B751FA0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORREWIND_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B752010)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORREWIND_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B752070)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORREWIND_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B752020)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORREWIND_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B751F90)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORREWIND_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1B751F80)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int DOTweenComponent__WaitForRewind_d__14_TypeDefinitionIndex = 24978;
