...
#define DG_TWEENING_CORE_EASING_EASEMANAGER_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x1B52A390)
#define DG_TWEENING_CORE_EASING_EASEMANAGER_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1B52A340)
#define DG_TWEENING_CORE_EASING_EASEMANAGER_ISFLASHEASE_OFFSET UNITYSDK_OFFSET(0x1B52C1A0)
#define DG_TWEENING_CORE_EASING_EASEMANAGER_TOEASEFUNCTION_OFFSET UNITYSDK_OFFSET(0x1B52B270)

namespace DG::Tweening::Core::Easing
{
	inline static constexpr unsigned int EaseManager_TypeDefinitionIndex = 24997;
