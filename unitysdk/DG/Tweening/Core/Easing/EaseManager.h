...
#define DG_TWEENING_CORE_EASING_EASEMANAGER_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x1AF08AF0)
#define DG_TWEENING_CORE_EASING_EASEMANAGER_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1AF08AA0)
#define DG_TWEENING_CORE_EASING_EASEMANAGER_ISFLASHEASE_OFFSET UNITYSDK_OFFSET(0x1AF0A8F0)
#define DG_TWEENING_CORE_EASING_EASEMANAGER_TOEASEFUNCTION_OFFSET UNITYSDK_OFFSET(0x1AF099D0)

namespace DG::Tweening::Core::Easing
{
	inline static constexpr unsigned int EaseManager_TypeDefinitionIndex = 24173;
