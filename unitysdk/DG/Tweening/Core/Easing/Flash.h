...
#define DG_TWEENING_CORE_EASING_FLASH_EASEINOUT_OFFSET UNITYSDK_OFFSET(0x1AEAB090)
#define DG_TWEENING_CORE_EASING_FLASH_EASEIN_OFFSET UNITYSDK_OFFSET(0x1AEAAD30)
#define DG_TWEENING_CORE_EASING_FLASH_EASEOUT_OFFSET UNITYSDK_OFFSET(0x1AEAAED0)
#define DG_TWEENING_CORE_EASING_FLASH_EASE_OFFSET UNITYSDK_OFFSET(0x1AEAAA30)
#define DG_TWEENING_CORE_EASING_FLASH_WEIGHTEDEASE_OFFSET UNITYSDK_OFFSET(0x1AEAABD0)

namespace DG::Tweening::Core::Easing
{
	inline static constexpr unsigned int Flash_TypeDefinitionIndex = 24176;
