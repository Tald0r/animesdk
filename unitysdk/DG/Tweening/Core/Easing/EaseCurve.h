...
#define DG_TWEENING_CORE_EASING_EASECURVE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1AFD14E0)
#define DG_TWEENING_CORE_EASING_EASECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD14D0)

namespace DG::Tweening::Core::Easing
{
	inline static constexpr unsigned int EaseCurve_TypeDefinitionIndex = 24175;
