...
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORELAPSEDLOOPS_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AF490A0)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORELAPSEDLOOPS_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AF49100)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORELAPSEDLOOPS_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AF49160)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORELAPSEDLOOPS_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AF49110)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORELAPSEDLOOPS_D__16_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AF49090)
#define DG_TWEENING_CORE_DOTWEENCOMPONENT__WAITFORELAPSEDLOOPS_D__16__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF49080)

namespace DG::Tweening::Core
{
	inline static constexpr unsigned int DOTweenComponent__WaitForElapsedLoops_d__16_TypeDefinitionIndex = 24156;
	...
	public:
		...
		::System::Int32 elapsedLoops; // 0x20
