...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS54_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5DFE10)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS54_0__DOLOOKAT_B__0_OFFSET UNITYSDK_OFFSET(0x1B5DFE20)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS54_0__DOLOOKAT_B__1_OFFSET UNITYSDK_OFFSET(0x1B5DFE60)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass54_0_TypeDefinitionIndex = 24900;
