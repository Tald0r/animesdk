...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D95A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS11_0__DOSHAKEPOSITION_B__0_OFFSET UNITYSDK_OFFSET(0x1B0D95B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS11_0__DOSHAKEPOSITION_B__1_OFFSET UNITYSDK_OFFSET(0x1B0D9610)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass11_0_TypeDefinitionIndex = 24033;
