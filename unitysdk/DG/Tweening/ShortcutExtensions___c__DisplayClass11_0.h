...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS11_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EA110)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS11_0__DOSHAKEPOSITION_B__0_OFFSET UNITYSDK_OFFSET(0x1B6EA120)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS11_0__DOSHAKEPOSITION_B__1_OFFSET UNITYSDK_OFFSET(0x1B6EA180)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass11_0_TypeDefinitionIndex = 24857;
