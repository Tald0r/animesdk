...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF0DFA0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS7_0__DOORTHOSIZE_B__0_OFFSET UNITYSDK_OFFSET(0x1AF0DFB0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS7_0__DOORTHOSIZE_B__1_OFFSET UNITYSDK_OFFSET(0x1AF0DFD0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass7_0_TypeDefinitionIndex = 24029;
