...
#define DG_TWEENING_SEQUENCE_APPLYINTERNALCYCLE_OFFSET UNITYSDK_OFFSET(0x1AFD3980)
#define DG_TWEENING_SEQUENCE_APPLYTWEEN_OFFSET UNITYSDK_OFFSET(0x1AFD3550)
#define DG_TWEENING_SEQUENCE_DOAPPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1AFD30A0)
#define DG_TWEENING_SEQUENCE_DOAPPLYTWEEN_OFFSET UNITYSDK_OFFSET(0x1AFD3560)
#define DG_TWEENING_SEQUENCE_DOINSERTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AFD31C0)
#define DG_TWEENING_SEQUENCE_DOINSERT_OFFSET UNITYSDK_OFFSET(0x1AFD2F20)
#define DG_TWEENING_SEQUENCE_DOPREPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1AFD30E0)
#define DG_TWEENING_SEQUENCE_DOPREPEND_OFFSET UNITYSDK_OFFSET(0x1AFD2E10)
#define DG_TWEENING_SEQUENCE_DOSTARTUP_OFFSET UNITYSDK_OFFSET(0x1AFD3360)
#define DG_TWEENING_SEQUENCE_RESET_OFFSET UNITYSDK_OFFSET(0x1AFD2CF0)
#define DG_TWEENING_SEQUENCE_SETUP_OFFSET UNITYSDK_OFFSET(0x1AFD38A0)
#define DG_TWEENING_SEQUENCE_SORTSEQUENCEDOBJS_OFFSET UNITYSDK_OFFSET(0x1AFD4020)
#define DG_TWEENING_SEQUENCE_STARTUP_OFFSET UNITYSDK_OFFSET(0x1AFD3350)
#define DG_TWEENING_SEQUENCE_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1AFD3270)
#define DG_TWEENING_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD2AC0)

namespace DG::Tweening
{
	inline static constexpr unsigned int Sequence_TypeDefinitionIndex = 24020;
