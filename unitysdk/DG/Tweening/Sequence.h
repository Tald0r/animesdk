...
#define DG_TWEENING_SEQUENCE_APPLYINTERNALCYCLE_OFFSET UNITYSDK_OFFSET(0x1B5DF4B0)
#define DG_TWEENING_SEQUENCE_APPLYTWEEN_OFFSET UNITYSDK_OFFSET(0x1B5DF080)
#define DG_TWEENING_SEQUENCE_DOAPPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1B5DEBD0)
#define DG_TWEENING_SEQUENCE_DOAPPLYTWEEN_OFFSET UNITYSDK_OFFSET(0x1B5DF090)
#define DG_TWEENING_SEQUENCE_DOINSERTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B5DECF0)
#define DG_TWEENING_SEQUENCE_DOINSERT_OFFSET UNITYSDK_OFFSET(0x1B5DEA50)
#define DG_TWEENING_SEQUENCE_DOPREPENDINTERVAL_OFFSET UNITYSDK_OFFSET(0x1B5DEC10)
#define DG_TWEENING_SEQUENCE_DOPREPEND_OFFSET UNITYSDK_OFFSET(0x1B5DE940)
#define DG_TWEENING_SEQUENCE_DOSTARTUP_OFFSET UNITYSDK_OFFSET(0x1B5DEE90)
#define DG_TWEENING_SEQUENCE_RESET_OFFSET UNITYSDK_OFFSET(0x1B5DE820)
#define DG_TWEENING_SEQUENCE_SETUP_OFFSET UNITYSDK_OFFSET(0x1B5DF3D0)
#define DG_TWEENING_SEQUENCE_SORTSEQUENCEDOBJS_OFFSET UNITYSDK_OFFSET(0x1B5DFB50)
#define DG_TWEENING_SEQUENCE_STARTUP_OFFSET UNITYSDK_OFFSET(0x1B5DEE80)
#define DG_TWEENING_SEQUENCE_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1B5DEDA0)
#define DG_TWEENING_SEQUENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5DE610)

namespace DG::Tweening
{
	inline static constexpr unsigned int Sequence_TypeDefinitionIndex = 24844;
