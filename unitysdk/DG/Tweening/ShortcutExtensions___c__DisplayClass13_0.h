...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EA3A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS13_0__DOSHAKEROTATION_B__0_OFFSET UNITYSDK_OFFSET(0x1B6EA3B0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS13_0__DOSHAKEROTATION_B__1_OFFSET UNITYSDK_OFFSET(0x1B6EA4E0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass13_0_TypeDefinitionIndex = 24859;
