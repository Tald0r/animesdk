...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS13_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D9830)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS13_0__DOSHAKEROTATION_B__0_OFFSET UNITYSDK_OFFSET(0x1B0D9840)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS13_0__DOSHAKEROTATION_B__1_OFFSET UNITYSDK_OFFSET(0x1B0D9970)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass13_0_TypeDefinitionIndex = 24035;
