...
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS12_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EA1D0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS12_0__DOSHAKEROTATION_B__0_OFFSET UNITYSDK_OFFSET(0x1B6EA1E0)
#define DG_TWEENING_SHORTCUTEXTENSIONS___C__DISPLAYCLASS12_0__DOSHAKEROTATION_B__1_OFFSET UNITYSDK_OFFSET(0x1B6EA310)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions___c__DisplayClass12_0_TypeDefinitionIndex = 24858;
