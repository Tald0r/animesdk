...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS4_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECC2A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS4_0__DOFADE_B__0_OFFSET UNITYSDK_OFFSET(0x1AED0580)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS4_0__DOFADE_B__1_OFFSET UNITYSDK_OFFSET(0x1AED05B0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass4_0_TypeDefinitionIndex = 31407;
