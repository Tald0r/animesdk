...
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AECC9A0)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS8_0__DOMINSIZE_B__0_OFFSET UNITYSDK_OFFSET(0x1AED0760)
#define DG_TWEENING_SHORTCUTEXTENSIONS46___C__DISPLAYCLASS8_0__DOMINSIZE_B__1_OFFSET UNITYSDK_OFFSET(0x1AED07C0)

namespace DG::Tweening
{
	inline static constexpr unsigned int ShortcutExtensions46___c__DisplayClass8_0_TypeDefinitionIndex = 31410;
