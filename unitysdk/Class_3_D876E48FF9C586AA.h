...
#define CLASS_3_D876E48FF9C586AA_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x7EB5410)
#define CLASS_3_D876E48FF9C586AA_METHOD_3_128774387667156B_OFFSET UNITYSDK_OFFSET(0x7EB5560)
#define CLASS_3_D876E48FF9C586AA_METHOD_3_1D5C4143EE1D2D7C_OFFSET UNITYSDK_OFFSET(0x7EB57C0)
#define CLASS_3_D876E48FF9C586AA_METHOD_3_323F95926A2F616E_OFFSET UNITYSDK_OFFSET(0x7EB55A0)
#define CLASS_3_D876E48FF9C586AA_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x7EB5700)
#define CLASS_3_D876E48FF9C586AA_METHOD_3_BA904CAFF6C7217F_OFFSET UNITYSDK_OFFSET(0x7EB5330)
#define CLASS_3_D876E48FF9C586AA_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x7EB56A0)
#define CLASS_3_D876E48FF9C586AA_METHOD_3_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x7EB5760)
#define CLASS_3_D876E48FF9C586AA_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x7EB4AA0)
#define CLASS_3_D876E48FF9C586AA_METHOD_3_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x7EB4ED0)
#define CLASS_3_D876E48FF9C586AA_METHOD_3_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x7EB5690)
#define CLASS_3_D876E48FF9C586AA_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x7EB4EE0)
#define CLASS_3_D876E48FF9C586AA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7EB4B00)
#define CLASS_3_D876E48FF9C586AA__CCTOR_OFFSET UNITYSDK_OFFSET(0x7EB5470)
#define CLASS_3_D876E48FF9C586AA__CTOR_OFFSET UNITYSDK_OFFSET(0x7EB54F0)

inline static constexpr unsigned int Class_3_D876E48FF9C586AA_TypeDefinitionIndex = 72886;
...
public:
	...
	::System::Collections::Generic::Dictionary_2<::MoleMole::Config::AnimMoveState, ::Class_1_A2413FF173BBC90D*>* Field_3_6; // 0x48
	::MoleMole::Config::ConfigEntityRunState* Field_3_12; // 0x50
	::Class_1_04AABD269B0AE5A9* Field_3_0; // 0x58
	::System::Collections::Generic::List_1<::UnityEngine::Vector3>* Field_3_9; // 0x60
	::System::Single Field_3_10; // 0x68
	::System::Single Field_3_4; // 0x6C
	::Enum_3_1BBFAA1B5EC0AE5D Field_3_3; // 0x70
	::System::Single Field_3_11; // 0x74
	::System::Boolean Field_3_8; // 0x78
	::System::Boolean Field_3_7; // 0x79
	::System::Boolean Field_3_1; // 0x7A
	::Enum_3_8711E36030A57C8C Field_3_5; // 0x7C
