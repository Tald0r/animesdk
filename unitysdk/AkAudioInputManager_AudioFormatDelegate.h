...
#define AKAUDIOINPUTMANAGER_AUDIOFORMATDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B66AFA0)
#define AKAUDIOINPUTMANAGER_AUDIOFORMATDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B66B000)
#define AKAUDIOINPUTMANAGER_AUDIOFORMATDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B66AC60)
#define AKAUDIOINPUTMANAGER_AUDIOFORMATDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B66AC40)

inline static constexpr unsigned int AkAudioInputManager_AudioFormatDelegate_TypeDefinitionIndex = 30959;
