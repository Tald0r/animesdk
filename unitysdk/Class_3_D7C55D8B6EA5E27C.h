...
#define CLASS_3_D7C55D8B6EA5E27C_CREATEFILTERS_OFFSET UNITYSDK_OFFSET(0x7401000)
#define CLASS_3_D7C55D8B6EA5E27C_METHOD_3_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x7401BB0)
#define CLASS_3_D7C55D8B6EA5E27C_METHOD_3_50B777F1D5CF5EF8_OFFSET UNITYSDK_OFFSET(0x7401AC0)
#define CLASS_3_D7C55D8B6EA5E27C_METHOD_3_5C0F4CFE9C6CAB7B_OFFSET UNITYSDK_OFFSET(0x7401C20)
#define CLASS_3_D7C55D8B6EA5E27C_METHOD_3_63EDAB3EFF913F92_OFFSET UNITYSDK_OFFSET(0x7401320)
#define CLASS_3_D7C55D8B6EA5E27C_METHOD_3_682BB5FF95382E9B_OFFSET UNITYSDK_OFFSET(0x7401780)
#define CLASS_3_D7C55D8B6EA5E27C_METHOD_3_BADC81CF9C936EDA_OFFSET UNITYSDK_OFFSET(0x7401710)
#define CLASS_3_D7C55D8B6EA5E27C_METHOD_3_E7558A1DFF7208C8_OFFSET UNITYSDK_OFFSET(0x7401700)
#define CLASS_3_D7C55D8B6EA5E27C__CTOR_OFFSET UNITYSDK_OFFSET(0x74015B0)

inline static constexpr unsigned int Class_3_D7C55D8B6EA5E27C_TypeDefinitionIndex = 71863;

class Class_3_D7C55D8B6EA5E27C : public ::Class_2_5560EE9F1F33A604
{
public:
	::Nap::NapECS::EcsFilter* Field_3_0; // 0x40
	::System::Action_2<::Class_4_32396EAD2453B355*, ::Class_5_F638703ACD0FA08E*>* Field_3_3; // 0x48
	::System::Collections::Generic::List_1<::MoleMole::HollowChessboard::HackerGameCollisionData>* Field_3_1; // 0x50
