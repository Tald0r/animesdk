...
#define POPEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1826DBB0)
#define POPEFFECT_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x1826CF70)
#define POPEFFECT_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1826DE80)
#define POPEFFECT_REGISTERIMG_OFFSET UNITYSDK_OFFSET(0x1826D7C0)
#define POPEFFECT_RESETIMG_OFFSET UNITYSDK_OFFSET(0x1826D9A0)
#define POPEFFECT_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1826D510)
#define POPEFFECT_SETFINISH_OFFSET UNITYSDK_OFFSET(0x1826DAA0)
#define POPEFFECT_SETTEXTWITHOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x1826D270)
#define POPEFFECT_SETTEXT_OFFSET UNITYSDK_OFFSET(0x1826CF80)
#define POPEFFECT_UPDATEIMGSIZE_OFFSET UNITYSDK_OFFSET(0x1826D590)
#define POPEFFECT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1826DCC0)
#define POPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1826E890)
#define POPEFFECT___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1826E930)

inline static constexpr unsigned int PopEffect_TypeDefinitionIndex = 44807;
