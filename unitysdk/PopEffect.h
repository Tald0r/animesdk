...
#define POPEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1815D670)
#define POPEFFECT_GET_ISFINISH_OFFSET UNITYSDK_OFFSET(0x1815CA30)
#define POPEFFECT_MODIFYMESH_OFFSET UNITYSDK_OFFSET(0x1815D940)
#define POPEFFECT_REGISTERIMG_OFFSET UNITYSDK_OFFSET(0x1815D280)
#define POPEFFECT_RESETIMG_OFFSET UNITYSDK_OFFSET(0x1815D460)
#define POPEFFECT_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x1815CFD0)
#define POPEFFECT_SETFINISH_OFFSET UNITYSDK_OFFSET(0x1815D560)
#define POPEFFECT_SETTEXTWITHOUTANIMATION_OFFSET UNITYSDK_OFFSET(0x1815CD30)
#define POPEFFECT_SETTEXT_OFFSET UNITYSDK_OFFSET(0x1815CA40)
#define POPEFFECT_UPDATEIMGSIZE_OFFSET UNITYSDK_OFFSET(0x1815D050)
#define POPEFFECT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1815D780)
#define POPEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1815E350)
#define POPEFFECT___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1815E3F0)

inline static constexpr unsigned int PopEffect_TypeDefinitionIndex = 49422;
