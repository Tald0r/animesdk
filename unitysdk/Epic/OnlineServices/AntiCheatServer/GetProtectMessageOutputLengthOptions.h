...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_GETPROTECTMESSAGEOUTPUTLENGTHOPTIONS_GET_DATALENGTHBYTES_OFFSET UNITYSDK_OFFSET(0x19AE4520)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_GETPROTECTMESSAGEOUTPUTLENGTHOPTIONS_SET_DATALENGTHBYTES_OFFSET UNITYSDK_OFFSET(0x19AE4530)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_GETPROTECTMESSAGEOUTPUTLENGTHOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE4540)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int GetProtectMessageOutputLengthOptions_TypeDefinitionIndex = 33165;
