...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ADDNOTIFYCLIENTACTIONREQUIRED_OFFSET UNITYSDK_OFFSET(0x19D3F5A0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ADDNOTIFYCLIENTAUTHSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x19D3F820)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ADDNOTIFYMESSAGETOCLIENT_OFFSET UNITYSDK_OFFSET(0x19D3FAA0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_BEGINSESSION_OFFSET UNITYSDK_OFFSET(0x19D3FD20)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ENDSESSION_OFFSET UNITYSDK_OFFSET(0x19D3FE80)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_GETPROTECTMESSAGEOUTPUTLENGTH_OFFSET UNITYSDK_OFFSET(0x19D400A0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGEVENT_OFFSET UNITYSDK_OFFSET(0x19D40210)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGGAMEROUNDEND_OFFSET UNITYSDK_OFFSET(0x19D40440)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGGAMEROUNDSTART_OFFSET UNITYSDK_OFFSET(0x19D405A0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERDESPAWN_OFFSET UNITYSDK_OFFSET(0x19D40700)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERREVIVE_OFFSET UNITYSDK_OFFSET(0x19D40860)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERSPAWN_OFFSET UNITYSDK_OFFSET(0x19D409C0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERTAKEDAMAGE_OFFSET UNITYSDK_OFFSET(0x19D40B20)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERTICK_OFFSET UNITYSDK_OFFSET(0x19D40C80)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERUSEABILITY_OFFSET UNITYSDK_OFFSET(0x19D40DE0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERUSEWEAPON_OFFSET UNITYSDK_OFFSET(0x19D40F40)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ONCLIENTACTIONREQUIREDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19D3F3D0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ONCLIENTAUTHSTATUSCHANGEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19D3F460)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ONMESSAGETOCLIENTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19D3F4F0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_PROTECTMESSAGE_OFFSET UNITYSDK_OFFSET(0x19D410A0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_RECEIVEMESSAGEFROMCLIENT_OFFSET UNITYSDK_OFFSET(0x19D41450)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REGISTERCLIENT_OFFSET UNITYSDK_OFFSET(0x19D41680)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REGISTEREVENT_OFFSET UNITYSDK_OFFSET(0x19D417E0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REMOVENOTIFYCLIENTACTIONREQUIRED_OFFSET UNITYSDK_OFFSET(0x19D41940)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REMOVENOTIFYCLIENTAUTHSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x19D41A20)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REMOVENOTIFYMESSAGETOCLIENT_OFFSET UNITYSDK_OFFSET(0x19D41B00)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_SETCLIENTDETAILS_OFFSET UNITYSDK_OFFSET(0x19D41BE0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_SETCLIENTNETWORKSTATE_OFFSET UNITYSDK_OFFSET(0x19D41D40)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_SETGAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x19D41F70)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_UNPROTECTMESSAGE_OFFSET UNITYSDK_OFFSET(0x19D42170)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_UNREGISTERCLIENT_OFFSET UNITYSDK_OFFSET(0x19D42520)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19D3F590)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19D3F580)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int AntiCheatServerInterface_TypeDefinitionIndex = 34114;
