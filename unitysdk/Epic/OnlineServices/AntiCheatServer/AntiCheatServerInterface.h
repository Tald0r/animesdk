...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ADDNOTIFYCLIENTACTIONREQUIRED_OFFSET UNITYSDK_OFFSET(0x19768DC0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ADDNOTIFYCLIENTAUTHSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x19769040)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ADDNOTIFYMESSAGETOCLIENT_OFFSET UNITYSDK_OFFSET(0x197692C0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_BEGINSESSION_OFFSET UNITYSDK_OFFSET(0x19769540)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ENDSESSION_OFFSET UNITYSDK_OFFSET(0x197696A0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_GETPROTECTMESSAGEOUTPUTLENGTH_OFFSET UNITYSDK_OFFSET(0x197698C0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGEVENT_OFFSET UNITYSDK_OFFSET(0x19769A30)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGGAMEROUNDEND_OFFSET UNITYSDK_OFFSET(0x19769C60)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGGAMEROUNDSTART_OFFSET UNITYSDK_OFFSET(0x19769DC0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERDESPAWN_OFFSET UNITYSDK_OFFSET(0x19769F20)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERREVIVE_OFFSET UNITYSDK_OFFSET(0x1976A080)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERSPAWN_OFFSET UNITYSDK_OFFSET(0x1976A1E0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERTAKEDAMAGE_OFFSET UNITYSDK_OFFSET(0x1976A340)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERTICK_OFFSET UNITYSDK_OFFSET(0x1976A4A0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERUSEABILITY_OFFSET UNITYSDK_OFFSET(0x1976A600)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_LOGPLAYERUSEWEAPON_OFFSET UNITYSDK_OFFSET(0x1976A760)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ONCLIENTACTIONREQUIREDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19768BF0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ONCLIENTAUTHSTATUSCHANGEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19768C80)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_ONMESSAGETOCLIENTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19768D10)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_PROTECTMESSAGE_OFFSET UNITYSDK_OFFSET(0x1976A8C0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_RECEIVEMESSAGEFROMCLIENT_OFFSET UNITYSDK_OFFSET(0x1976AC70)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REGISTERCLIENT_OFFSET UNITYSDK_OFFSET(0x1976AEA0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REGISTEREVENT_OFFSET UNITYSDK_OFFSET(0x1976B000)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REMOVENOTIFYCLIENTACTIONREQUIRED_OFFSET UNITYSDK_OFFSET(0x1976B160)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REMOVENOTIFYCLIENTAUTHSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x1976B240)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_REMOVENOTIFYMESSAGETOCLIENT_OFFSET UNITYSDK_OFFSET(0x1976B320)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_SETCLIENTDETAILS_OFFSET UNITYSDK_OFFSET(0x1976B400)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_SETCLIENTNETWORKSTATE_OFFSET UNITYSDK_OFFSET(0x1976B560)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_SETGAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x1976B790)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_UNPROTECTMESSAGE_OFFSET UNITYSDK_OFFSET(0x1976B990)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE_UNREGISTERCLIENT_OFFSET UNITYSDK_OFFSET(0x1976BD40)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19768DB0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ANTICHEATSERVERINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19768DA0)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int AntiCheatServerInterface_TypeDefinitionIndex = 33160;
