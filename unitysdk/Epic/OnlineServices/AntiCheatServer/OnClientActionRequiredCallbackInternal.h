...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18F1E720)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18F1E770)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x18F1E420)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18F1E410)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int OnClientActionRequiredCallbackInternal_TypeDefinitionIndex = 33168;
