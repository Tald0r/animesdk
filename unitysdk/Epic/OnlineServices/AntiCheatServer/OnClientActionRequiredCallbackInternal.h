...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19266950)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x192669A0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19266660)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19266640)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int OnClientActionRequiredCallbackInternal_TypeDefinitionIndex = 34122;
