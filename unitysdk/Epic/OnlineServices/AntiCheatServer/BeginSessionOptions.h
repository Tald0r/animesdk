...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONS_GET_ENABLEGAMEPLAYDATA_OFFSET UNITYSDK_OFFSET(0x195265F0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19526610)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONS_GET_REGISTERTIMEOUTSECONDS_OFFSET UNITYSDK_OFFSET(0x195265B0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONS_GET_SERVERNAME_OFFSET UNITYSDK_OFFSET(0x195265D0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONS_SET_ENABLEGAMEPLAYDATA_OFFSET UNITYSDK_OFFSET(0x19526600)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19526620)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONS_SET_REGISTERTIMEOUTSECONDS_OFFSET UNITYSDK_OFFSET(0x195265C0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONS_SET_SERVERNAME_OFFSET UNITYSDK_OFFSET(0x195265E0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19526630)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int BeginSessionOptions_TypeDefinitionIndex = 34115;
