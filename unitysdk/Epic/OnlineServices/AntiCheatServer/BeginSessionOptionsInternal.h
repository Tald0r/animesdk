...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x83A550)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x83A4E0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_SET_ENABLEGAMEPLAYDATA_OFFSET UNITYSDK_OFFSET(0x83A360)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x83A410)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x83A4D0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_SET_REGISTERTIMEOUTSECONDS_OFFSET UNITYSDK_OFFSET(0x2D38F0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_BEGINSESSIONOPTIONSINTERNAL_SET_SERVERNAME_OFFSET UNITYSDK_OFFSET(0x83A2B0)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int BeginSessionOptionsInternal_TypeDefinitionIndex = 33162;
