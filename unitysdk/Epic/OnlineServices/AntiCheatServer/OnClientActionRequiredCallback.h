...
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D95670)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D956A0)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D95170)
#define EPIC_ONLINESERVICES_ANTICHEATSERVER_ONCLIENTACTIONREQUIREDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18D95160)

namespace Epic::OnlineServices::AntiCheatServer
{
	inline static constexpr unsigned int OnClientActionRequiredCallback_TypeDefinitionIndex = 33167;
