...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A5200)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_GET_FILETRANSFERPROGRESSCALLBACK_OFFSET UNITYSDK_OFFSET(0x195318C0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_GET_READFILEDATACALLBACK_OFFSET UNITYSDK_OFFSET(0x19531830)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8A5190)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x8A50D0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8A5010)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8A5180)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEOPTIONSINTERNAL_SET_READCHUNKLENGTHBYTES_OFFSET UNITYSDK_OFFSET(0x318710)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int ReadFileOptionsInternal_TypeDefinitionIndex = 33367;
	...
	struct alignas(8) ReadFileOptionsInternal
	{
		...
		{
			return (::Epic::OnlineServices::PlayerDataStorage::OnReadFileDataCallbackInternal**)Il2CppClass::FromTypeDefinitionIndex(ReadFileOptionsInternal_TypeDefinitionIndex)->GetStaticField(0x25E30);
		}
		...
		{
			return (::Epic::OnlineServices::PlayerDataStorage::OnFileTransferProgressCallbackInternal**)Il2CppClass::FromTypeDefinitionIndex(ReadFileOptionsInternal_TypeDefinitionIndex)->GetStaticField(0x25E38);
		}
