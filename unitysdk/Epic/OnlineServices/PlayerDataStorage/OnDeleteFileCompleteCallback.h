...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONDELETEFILECOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D4E9B0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONDELETEFILECOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D4E9E0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONDELETEFILECOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D4E4B0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONDELETEFILECOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19D4E490)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int OnDeleteFileCompleteCallback_TypeDefinitionIndex = 33334;
