...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x19540870)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x195407B0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_GET_DATACHUNK_OFFSET UNITYSDK_OFFSET(0x19540850)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x195407F0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_GET_ISLASTCHUNK_OFFSET UNITYSDK_OFFSET(0x19540830)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x195407D0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_GET_TOTALFILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x19540810)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x19540DC0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x195407C0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_SET_DATACHUNK_OFFSET UNITYSDK_OFFSET(0x19540860)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x19540800)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_SET_ISLASTCHUNK_OFFSET UNITYSDK_OFFSET(0x19540840)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x195407E0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x19540880)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO_SET_TOTALFILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x19540820)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_READFILEDATACALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19540F10)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int ReadFileDataCallbackInfo_TypeDefinitionIndex = 32410;
