...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_GET_CHUNKLENGTHBYTES_OFFSET UNITYSDK_OFFSET(0x1A073020)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1A073000)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_GET_FILETRANSFERPROGRESSCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A073060)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1A072FE0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_GET_WRITEFILEDATACALLBACK_OFFSET UNITYSDK_OFFSET(0x1A073040)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_SET_CHUNKLENGTHBYTES_OFFSET UNITYSDK_OFFSET(0x1A073030)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1A073010)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_SET_FILETRANSFERPROGRESSCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A073070)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1A072FF0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS_SET_WRITEFILEDATACALLBACK_OFFSET UNITYSDK_OFFSET(0x1A073050)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_WRITEFILEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A073080)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int WriteFileOptions_TypeDefinitionIndex = 33373;
