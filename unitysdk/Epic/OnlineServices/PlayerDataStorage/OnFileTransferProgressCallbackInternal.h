...
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONFILETRANSFERPROGRESSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18DCD260)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONFILETRANSFERPROGRESSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18DCD2B0)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONFILETRANSFERPROGRESSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DCCF60)
#define EPIC_ONLINESERVICES_PLAYERDATASTORAGE_ONFILETRANSFERPROGRESSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18DCCF50)

namespace Epic::OnlineServices::PlayerDataStorage
{
	inline static constexpr unsigned int OnFileTransferProgressCallbackInternal_TypeDefinitionIndex = 32385;
