...
#define EPIC_ONLINESERVICES_CUSTOMINVITES_CUSTOMINVITESINTERFACE_ADDNOTIFYCUSTOMINVITEACCEPTED_OFFSET UNITYSDK_OFFSET(0x16E49160)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_CUSTOMINVITESINTERFACE_ADDNOTIFYCUSTOMINVITERECEIVED_OFFSET UNITYSDK_OFFSET(0x16E493E0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_CUSTOMINVITESINTERFACE_FINALIZEINVITE_OFFSET UNITYSDK_OFFSET(0x16E49660)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_CUSTOMINVITESINTERFACE_ONCUSTOMINVITEACCEPTEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x16E48F90)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_CUSTOMINVITESINTERFACE_ONCUSTOMINVITERECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x16E49020)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_CUSTOMINVITESINTERFACE_ONSENDCUSTOMINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x16E490B0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_CUSTOMINVITESINTERFACE_REMOVENOTIFYCUSTOMINVITEACCEPTED_OFFSET UNITYSDK_OFFSET(0x16E497C0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_CUSTOMINVITESINTERFACE_REMOVENOTIFYCUSTOMINVITERECEIVED_OFFSET UNITYSDK_OFFSET(0x16E498A0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_CUSTOMINVITESINTERFACE_SENDCUSTOMINVITE_OFFSET UNITYSDK_OFFSET(0x16E49980)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_CUSTOMINVITESINTERFACE_SETCUSTOMINVITE_OFFSET UNITYSDK_OFFSET(0x16E49B40)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_CUSTOMINVITESINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16E49150)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_CUSTOMINVITESINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x16E49140)

namespace Epic::OnlineServices::CustomInvites
{
	inline static constexpr unsigned int CustomInvitesInterface_TypeDefinitionIndex = 32965;
