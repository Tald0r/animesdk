...
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x19C79DF0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x19C79D50)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_GET_CUSTOMINVITEID_OFFSET UNITYSDK_OFFSET(0x19C79DB0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19C79D90)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_GET_PAYLOAD_OFFSET UNITYSDK_OFFSET(0x19C79DD0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x19C79D70)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x19C7A2E0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x19C79D60)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_SET_CUSTOMINVITEID_OFFSET UNITYSDK_OFFSET(0x19C79DC0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19C79DA0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x19C79E00)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_SET_PAYLOAD_OFFSET UNITYSDK_OFFSET(0x19C79DE0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x19C79D80)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7A420)

namespace Epic::OnlineServices::CustomInvites
{
	inline static constexpr unsigned int OnCustomInviteAcceptedCallbackInfo_TypeDefinitionIndex = 33924;
