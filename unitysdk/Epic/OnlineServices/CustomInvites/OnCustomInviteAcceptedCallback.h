...
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190DA720)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190DA750)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x190DA220)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONCUSTOMINVITEACCEPTEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x190DA210)

namespace Epic::OnlineServices::CustomInvites
{
	inline static constexpr unsigned int OnCustomInviteAcceptedCallback_TypeDefinitionIndex = 32968;
