...
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONSENDCUSTOMINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19AE62D0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONSENDCUSTOMINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19AE6300)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONSENDCUSTOMINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19AE5DD0)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONSENDCUSTOMINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE5DC0)

namespace Epic::OnlineServices::CustomInvites
{
	inline static constexpr unsigned int OnSendCustomInviteCallback_TypeDefinitionIndex = 32976;
