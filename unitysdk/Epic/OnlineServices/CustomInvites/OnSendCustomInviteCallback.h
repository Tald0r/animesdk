...
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONSENDCUSTOMINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A06EC50)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONSENDCUSTOMINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A06EC80)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONSENDCUSTOMINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A06E750)
#define EPIC_ONLINESERVICES_CUSTOMINVITES_ONSENDCUSTOMINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A06E730)

namespace Epic::OnlineServices::CustomInvites
{
	inline static constexpr unsigned int OnSendCustomInviteCallback_TypeDefinitionIndex = 33930;
