...
#define EPIC_ONLINESERVICES_METRICS_ENDPLAYERSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x83D870)
#define EPIC_ONLINESERVICES_METRICS_ENDPLAYERSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x83D7A0)
#define EPIC_ONLINESERVICES_METRICS_ENDPLAYERSESSIONOPTIONSINTERNAL_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x83D6B0)
#define EPIC_ONLINESERVICES_METRICS_ENDPLAYERSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x83D720)

namespace Epic::OnlineServices::Metrics
{
	inline static constexpr unsigned int EndPlayerSessionOptionsInternal_TypeDefinitionIndex = 32527;
