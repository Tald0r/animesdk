...
#define EPIC_ONLINESERVICES_METRICS_ENDPLAYERSESSIONOPTIONS_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x190BC810)
#define EPIC_ONLINESERVICES_METRICS_ENDPLAYERSESSIONOPTIONS_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x190BC820)
#define EPIC_ONLINESERVICES_METRICS_ENDPLAYERSESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x190BC830)

namespace Epic::OnlineServices::Metrics
{
	inline static constexpr unsigned int EndPlayerSessionOptions_TypeDefinitionIndex = 32526;
