...
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x18E11BE0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_GET_CONTROLLERTYPE_OFFSET UNITYSDK_OFFSET(0x18E11C20)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x18E11C00)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_GET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x18E11C60)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_GET_SERVERIP_OFFSET UNITYSDK_OFFSET(0x18E11C40)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x18E11BF0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_SET_CONTROLLERTYPE_OFFSET UNITYSDK_OFFSET(0x18E11C30)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x18E11C10)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_SET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x18E11C70)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS_SET_SERVERIP_OFFSET UNITYSDK_OFFSET(0x18E11C50)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18E11C80)

namespace Epic::OnlineServices::Metrics
{
	inline static constexpr unsigned int BeginPlayerSessionOptions_TypeDefinitionIndex = 32522;
