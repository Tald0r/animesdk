...
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D2280)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D2210)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x8D1F80)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_CONTROLLERTYPE_OFFSET UNITYSDK_OFFSET(0x379D90)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8D1FF0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x8D2150)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D2200)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_SERVERIP_OFFSET UNITYSDK_OFFSET(0x8D20A0)

namespace Epic::OnlineServices::Metrics
{
	inline static constexpr unsigned int BeginPlayerSessionOptionsInternal_TypeDefinitionIndex = 32523;
