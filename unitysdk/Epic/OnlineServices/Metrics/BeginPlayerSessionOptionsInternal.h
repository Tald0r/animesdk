...
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F33F0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8F3380)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x8F30F0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_CONTROLLERTYPE_OFFSET UNITYSDK_OFFSET(0x318710)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8F3160)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x8F32C0)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8F3370)
#define EPIC_ONLINESERVICES_METRICS_BEGINPLAYERSESSIONOPTIONSINTERNAL_SET_SERVERIP_OFFSET UNITYSDK_OFFSET(0x8F3210)

namespace Epic::OnlineServices::Metrics
{
	inline static constexpr unsigned int BeginPlayerSessionOptionsInternal_TypeDefinitionIndex = 33477;
