...
#define EPIC_ONLINESERVICES_LOGGING_LOGGINGINTERFACE_LOGMESSAGEFUNCINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x184F7370)
#define EPIC_ONLINESERVICES_LOGGING_LOGGINGINTERFACE_SETCALLBACK_OFFSET UNITYSDK_OFFSET(0x184F7430)
#define EPIC_ONLINESERVICES_LOGGING_LOGGINGINTERFACE_SETLOGLEVEL_OFFSET UNITYSDK_OFFSET(0x184F7530)

namespace Epic::OnlineServices::Logging
{
	inline static constexpr unsigned int LoggingInterface_TypeDefinitionIndex = 33493;
