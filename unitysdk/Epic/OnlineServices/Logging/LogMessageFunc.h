...
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D4CC20)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D4CC50)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D4C720)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x19D4C700)

namespace Epic::OnlineServices::Logging
{
	inline static constexpr unsigned int LogMessageFunc_TypeDefinitionIndex = 33491;
