...
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19776400)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19776430)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x19775F00)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x19775EF0)

namespace Epic::OnlineServices::Logging
{
	inline static constexpr unsigned int LogMessageFunc_TypeDefinitionIndex = 32537;
