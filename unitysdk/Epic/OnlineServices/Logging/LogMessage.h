...
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGE_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x18DC9DD0)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGE_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x18DC9E10)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGE_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x18DC9DF0)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGE_SET_1_OFFSET UNITYSDK_OFFSET(0x18DCA110)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGE_SET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x18DC9DE0)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGE_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x18DC9E20)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGE_SET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x18DC9E00)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGE_SET_OFFSET UNITYSDK_OFFSET(0x18DC9E30)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x18DCA460)

namespace Epic::OnlineServices::Logging
{
	inline static constexpr unsigned int LogMessage_TypeDefinitionIndex = 32535;
