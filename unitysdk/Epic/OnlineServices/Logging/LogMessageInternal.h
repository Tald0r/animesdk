...
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEINTERNAL_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x8CB520)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEINTERNAL_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x2CB090)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEINTERNAL_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x8CB5D0)

namespace Epic::OnlineServices::Logging
{
	inline static constexpr unsigned int LogMessageInternal_TypeDefinitionIndex = 32536;
