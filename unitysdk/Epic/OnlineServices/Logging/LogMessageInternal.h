...
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEINTERNAL_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x8FE6A0)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEINTERNAL_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x302AD0)
#define EPIC_ONLINESERVICES_LOGGING_LOGMESSAGEINTERNAL_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x8FE750)

namespace Epic::OnlineServices::Logging
{
	inline static constexpr unsigned int LogMessageInternal_TypeDefinitionIndex = 33490;
