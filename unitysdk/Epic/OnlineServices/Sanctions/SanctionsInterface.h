...
#define EPIC_ONLINESERVICES_SANCTIONS_SANCTIONSINTERFACE_COPYPLAYERSANCTIONBYINDEX_OFFSET UNITYSDK_OFFSET(0x19848840)
#define EPIC_ONLINESERVICES_SANCTIONS_SANCTIONSINTERFACE_GETPLAYERSANCTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x19848AF0)
#define EPIC_ONLINESERVICES_SANCTIONS_SANCTIONSINTERFACE_ONQUERYACTIVEPLAYERSANCTIONSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19848790)
#define EPIC_ONLINESERVICES_SANCTIONS_SANCTIONSINTERFACE_QUERYACTIVEPLAYERSANCTIONS_OFFSET UNITYSDK_OFFSET(0x19848CF0)
#define EPIC_ONLINESERVICES_SANCTIONS_SANCTIONSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19848830)
#define EPIC_ONLINESERVICES_SANCTIONS_SANCTIONSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19848820)

namespace Epic::OnlineServices::Sanctions
{
	inline static constexpr unsigned int SanctionsInterface_TypeDefinitionIndex = 32137;
