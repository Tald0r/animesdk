...
#define EPIC_ONLINESERVICES_SANCTIONS_QUERYACTIVEPLAYERSANCTIONSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x190C6560)
#define EPIC_ONLINESERVICES_SANCTIONS_QUERYACTIVEPLAYERSANCTIONSOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x190C6540)
#define EPIC_ONLINESERVICES_SANCTIONS_QUERYACTIVEPLAYERSANCTIONSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x190C6570)
#define EPIC_ONLINESERVICES_SANCTIONS_QUERYACTIVEPLAYERSANCTIONSOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x190C6550)
#define EPIC_ONLINESERVICES_SANCTIONS_QUERYACTIVEPLAYERSANCTIONSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x190C6580)

namespace Epic::OnlineServices::Sanctions
{
	inline static constexpr unsigned int QueryActivePlayerSanctionsOptions_TypeDefinitionIndex = 32135;
