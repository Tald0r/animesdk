...
#define EPIC_ONLINESERVICES_SANCTIONS_QUERYACTIVEPLAYERSANCTIONSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19535AF0)
#define EPIC_ONLINESERVICES_SANCTIONS_QUERYACTIVEPLAYERSANCTIONSOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x19535AD0)
#define EPIC_ONLINESERVICES_SANCTIONS_QUERYACTIVEPLAYERSANCTIONSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19535B00)
#define EPIC_ONLINESERVICES_SANCTIONS_QUERYACTIVEPLAYERSANCTIONSOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x19535AE0)
#define EPIC_ONLINESERVICES_SANCTIONS_QUERYACTIVEPLAYERSANCTIONSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19535B10)

namespace Epic::OnlineServices::Sanctions
{
	inline static constexpr unsigned int QueryActivePlayerSanctionsOptions_TypeDefinitionIndex = 33089;
