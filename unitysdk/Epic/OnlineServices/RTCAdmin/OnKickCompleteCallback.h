...
#define EPIC_ONLINESERVICES_RTCADMIN_ONKICKCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x198465F0)
#define EPIC_ONLINESERVICES_RTCADMIN_ONKICKCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19846620)
#define EPIC_ONLINESERVICES_RTCADMIN_ONKICKCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x198460F0)
#define EPIC_ONLINESERVICES_RTCADMIN_ONKICKCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x198460E0)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int OnKickCompleteCallback_TypeDefinitionIndex = 32230;
