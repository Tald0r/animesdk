...
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8580B0)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x858040)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x858030)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x857EC0)
#define EPIC_ONLINESERVICES_RTCADMIN_KICKOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x857F70)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int KickOptionsInternal_TypeDefinitionIndex = 32229;
