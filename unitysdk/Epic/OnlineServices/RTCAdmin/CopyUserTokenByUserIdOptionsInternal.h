...
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYUSERIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8BC760)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYUSERIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8BC750)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYUSERIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8BC670)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYUSERIDOPTIONSINTERNAL_SET_QUERYID_OFFSET UNITYSDK_OFFSET(0x3197D0)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYUSERIDOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x8BC5B0)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int CopyUserTokenByUserIdOptionsInternal_TypeDefinitionIndex = 32225;
