...
#define EPIC_ONLINESERVICES_RTCADMIN_SETPARTICIPANTHARDMUTEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8ACFE0)
#define EPIC_ONLINESERVICES_RTCADMIN_SETPARTICIPANTHARDMUTEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8ACF70)
#define EPIC_ONLINESERVICES_RTCADMIN_SETPARTICIPANTHARDMUTEOPTIONSINTERNAL_SET_MUTE_OFFSET UNITYSDK_OFFSET(0x8ACEB0)
#define EPIC_ONLINESERVICES_RTCADMIN_SETPARTICIPANTHARDMUTEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8ACF60)
#define EPIC_ONLINESERVICES_RTCADMIN_SETPARTICIPANTHARDMUTEOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x8ACD40)
#define EPIC_ONLINESERVICES_RTCADMIN_SETPARTICIPANTHARDMUTEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x8ACDF0)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int SetParticipantHardMuteOptionsInternal_TypeDefinitionIndex = 33198;
