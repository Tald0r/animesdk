...
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x858540)
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_GET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x858230)
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x858360)
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8584D0)
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8584C0)
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_SET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x8582A0)
#define EPIC_ONLINESERVICES_RTCADMIN_USERTOKENINTERNAL_SET_TOKEN_OFFSET UNITYSDK_OFFSET(0x858410)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int UserTokenInternal_TypeDefinitionIndex = 32246;
