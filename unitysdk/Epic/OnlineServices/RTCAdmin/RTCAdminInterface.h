...
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_COPYUSERTOKENBYINDEX_OFFSET UNITYSDK_OFFSET(0x18F2E5E0)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_COPYUSERTOKENBYUSERID_OFFSET UNITYSDK_OFFSET(0x18F2E7E0)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_KICK_OFFSET UNITYSDK_OFFSET(0x18F2EA90)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_ONKICKCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18F2E410)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_ONQUERYJOINROOMTOKENCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18F2E4A0)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_ONSETPARTICIPANTHARDMUTECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18F2E530)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_QUERYJOINROOMTOKEN_OFFSET UNITYSDK_OFFSET(0x18F2EC50)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_SETPARTICIPANTHARDMUTE_OFFSET UNITYSDK_OFFSET(0x18F2EE10)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F2E5D0)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x18F2E5C0)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int RTCAdminInterface_TypeDefinitionIndex = 32240;
