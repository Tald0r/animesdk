...
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_COPYUSERTOKENBYINDEX_OFFSET UNITYSDK_OFFSET(0x19276880)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_COPYUSERTOKENBYUSERID_OFFSET UNITYSDK_OFFSET(0x19276A80)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_KICK_OFFSET UNITYSDK_OFFSET(0x19276D30)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_ONKICKCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x192766B0)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_ONQUERYJOINROOMTOKENCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19276740)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_ONSETPARTICIPANTHARDMUTECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x192767D0)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_QUERYJOINROOMTOKEN_OFFSET UNITYSDK_OFFSET(0x19276EF0)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE_SETPARTICIPANTHARDMUTE_OFFSET UNITYSDK_OFFSET(0x192770B0)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19276870)
#define EPIC_ONLINESERVICES_RTCADMIN_RTCADMININTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19276860)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int RTCAdminInterface_TypeDefinitionIndex = 33194;
