...
#define EPIC_ONLINESERVICES_RTCADMIN_ONSETPARTICIPANTHARDMUTECOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x195FEED0)
#define EPIC_ONLINESERVICES_RTCADMIN_ONSETPARTICIPANTHARDMUTECOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x195FEF00)
#define EPIC_ONLINESERVICES_RTCADMIN_ONSETPARTICIPANTHARDMUTECOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x195FE9D0)
#define EPIC_ONLINESERVICES_RTCADMIN_ONSETPARTICIPANTHARDMUTECOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x195FE9C0)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int OnSetParticipantHardMuteCompleteCallback_TypeDefinitionIndex = 32234;
