...
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS_GET_QUERYID_OFFSET UNITYSDK_OFFSET(0x19224970)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS_GET_USERTOKENINDEX_OFFSET UNITYSDK_OFFSET(0x19224950)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS_SET_QUERYID_OFFSET UNITYSDK_OFFSET(0x19224980)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS_SET_USERTOKENINDEX_OFFSET UNITYSDK_OFFSET(0x19224960)
#define EPIC_ONLINESERVICES_RTCADMIN_COPYUSERTOKENBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19224990)

namespace Epic::OnlineServices::RTCAdmin
{
	inline static constexpr unsigned int CopyUserTokenByIndexOptions_TypeDefinitionIndex = 33176;
