...
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x19534020)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x19533F80)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_GET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0x19534000)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19533FA0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_GET_PREVIOUSSTATUS_OFFSET UNITYSDK_OFFSET(0x19533FE0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x19533FC0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x19534350)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x19533F90)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0x19534010)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19533FB0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_OFFSET UNITYSDK_OFFSET(0x19534030)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_PREVIOUSSTATUS_OFFSET UNITYSDK_OFFSET(0x19533FF0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x19533FD0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19534490)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnFriendsUpdateInfo_TypeDefinitionIndex = 32843;
