...
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x199B35B0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x199B3510)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_GET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0x199B3590)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x199B3530)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_GET_PREVIOUSSTATUS_OFFSET UNITYSDK_OFFSET(0x199B3570)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x199B3550)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x199B38E0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x199B3520)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_CURRENTSTATUS_OFFSET UNITYSDK_OFFSET(0x199B35A0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x199B3540)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_OFFSET UNITYSDK_OFFSET(0x199B35C0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_PREVIOUSSTATUS_OFFSET UNITYSDK_OFFSET(0x199B3580)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x199B3560)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x199B3A20)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnFriendsUpdateInfo_TypeDefinitionIndex = 33797;
