...
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A054FD0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A055020)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A054CE0)
#define EPIC_ONLINESERVICES_FRIENDS_ONFRIENDSUPDATECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A054CC0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnFriendsUpdateCallbackInternal_TypeDefinitionIndex = 33796;
