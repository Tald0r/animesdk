...
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x903FB0)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x903FA0)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONSINTERNAL_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x302AE0)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x903E00)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x903EC0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int GetFriendAtIndexOptionsInternal_TypeDefinitionIndex = 33788;
