...
#define EPIC_ONLINESERVICES_FRIENDS_REJECTINVITECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_FRIENDS_REJECTINVITECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x873B80)
#define EPIC_ONLINESERVICES_FRIENDS_REJECTINVITECALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x873C90)
#define EPIC_ONLINESERVICES_FRIENDS_REJECTINVITECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define EPIC_ONLINESERVICES_FRIENDS_REJECTINVITECALLBACKINFOINTERNAL_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x873D00)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int RejectInviteCallbackInfoInternal_TypeDefinitionIndex = 32856;
