...
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18E0F330)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18E0F380)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x18E0F030)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18E0F020)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnAcceptInviteCallbackInternal_TypeDefinitionIndex = 32840;
