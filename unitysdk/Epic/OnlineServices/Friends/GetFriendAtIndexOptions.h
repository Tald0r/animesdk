...
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONS_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x19C7B4A0)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19C7B480)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONS_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x19C7B4B0)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19C7B490)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDATINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7B4C0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int GetFriendAtIndexOptions_TypeDefinitionIndex = 33787;
