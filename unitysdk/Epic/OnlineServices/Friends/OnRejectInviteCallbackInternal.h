...
#define EPIC_ONLINESERVICES_FRIENDS_ONREJECTINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x187DF900)
#define EPIC_ONLINESERVICES_FRIENDS_ONREJECTINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187DF950)
#define EPIC_ONLINESERVICES_FRIENDS_ONREJECTINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x187DF600)
#define EPIC_ONLINESERVICES_FRIENDS_ONREJECTINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x187DF5F0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnRejectInviteCallbackInternal_TypeDefinitionIndex = 32848;
