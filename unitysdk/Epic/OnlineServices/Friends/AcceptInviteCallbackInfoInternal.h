...
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x7A82B0)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITECALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x7A83C0)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define EPIC_ONLINESERVICES_FRIENDS_ACCEPTINVITECALLBACKINFOINTERNAL_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x7A8430)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int AcceptInviteCallbackInfoInternal_TypeDefinitionIndex = 32826;
