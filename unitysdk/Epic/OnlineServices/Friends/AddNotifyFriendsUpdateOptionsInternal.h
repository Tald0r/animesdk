...
#define EPIC_ONLINESERVICES_FRIENDS_ADDNOTIFYFRIENDSUPDATEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define EPIC_ONLINESERVICES_FRIENDS_ADDNOTIFYFRIENDSUPDATEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8BA130)
#define EPIC_ONLINESERVICES_FRIENDS_ADDNOTIFYFRIENDSUPDATEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7CBF80)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int AddNotifyFriendsUpdateOptionsInternal_TypeDefinitionIndex = 33784;
