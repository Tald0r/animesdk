...
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x193F5620)
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x193F5650)
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x193F5120)
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x193F5100)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnSendInviteCallback_TypeDefinitionIndex = 33803;
