...
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190F4130)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190F4160)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x190F3C30)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x190F3C10)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnAcceptInviteCallback_TypeDefinitionIndex = 33793;
