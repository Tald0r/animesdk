...
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D98B70)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D98BA0)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D98670)
#define EPIC_ONLINESERVICES_FRIENDS_ONACCEPTINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18D98660)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnAcceptInviteCallback_TypeDefinitionIndex = 32839;
