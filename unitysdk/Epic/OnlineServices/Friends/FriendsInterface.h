...
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ACCEPTINVITE_OFFSET UNITYSDK_OFFSET(0x19532E60)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ADDNOTIFYFRIENDSUPDATE_OFFSET UNITYSDK_OFFSET(0x19533020)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_GETFRIENDATINDEX_OFFSET UNITYSDK_OFFSET(0x195332A0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_GETFRIENDSCOUNT_OFFSET UNITYSDK_OFFSET(0x195334D0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x195336D0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONACCEPTINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19532B70)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONFRIENDSUPDATECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19532C00)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONQUERYFRIENDSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19532C90)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONREJECTINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19532D20)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_ONSENDINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19532DB0)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_QUERYFRIENDS_OFFSET UNITYSDK_OFFSET(0x19533830)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_REJECTINVITE_OFFSET UNITYSDK_OFFSET(0x19533A80)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_REMOVENOTIFYFRIENDSUPDATE_OFFSET UNITYSDK_OFFSET(0x19533C40)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE_SENDINVITE_OFFSET UNITYSDK_OFFSET(0x19533D20)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19532E50)
#define EPIC_ONLINESERVICES_FRIENDS_FRIENDSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19532E40)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int FriendsInterface_TypeDefinitionIndex = 32831;
