...
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDSCOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1926D3D0)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDSCOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1926D3E0)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDSCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1926D3F0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int GetFriendsCountOptions_TypeDefinitionIndex = 33789;
