...
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x882450)
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x882230)
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x881EE0)
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x882060)
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x881FA0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int SendInviteOptionsInternal_TypeDefinitionIndex = 33816;
