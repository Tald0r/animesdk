...
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x854160)
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x853F40)
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x853BF0)
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x853D70)
#define EPIC_ONLINESERVICES_FRIENDS_SENDINVITEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x853CB0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int SendInviteOptionsInternal_TypeDefinitionIndex = 32862;
