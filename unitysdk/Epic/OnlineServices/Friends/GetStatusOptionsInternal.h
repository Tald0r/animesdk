...
#define EPIC_ONLINESERVICES_FRIENDS_GETSTATUSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D88F0)
#define EPIC_ONLINESERVICES_FRIENDS_GETSTATUSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D8880)
#define EPIC_ONLINESERVICES_FRIENDS_GETSTATUSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8D86F0)
#define EPIC_ONLINESERVICES_FRIENDS_GETSTATUSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D8870)
#define EPIC_ONLINESERVICES_FRIENDS_GETSTATUSOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x8D87B0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int GetStatusOptionsInternal_TypeDefinitionIndex = 32838;
