...
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D990C0)
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D990F0)
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D98BC0)
#define EPIC_ONLINESERVICES_FRIENDS_ONQUERYFRIENDSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18D98BB0)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnQueryFriendsCallback_TypeDefinitionIndex = 32845;
