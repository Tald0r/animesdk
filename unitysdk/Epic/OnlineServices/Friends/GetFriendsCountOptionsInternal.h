...
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDSCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A8A40)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDSCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8A8910)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDSCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8A8780)
#define EPIC_ONLINESERVICES_FRIENDS_GETFRIENDSCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8A8840)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int GetFriendsCountOptionsInternal_TypeDefinitionIndex = 33790;
