...
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1956B130)
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1956B180)
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1956AE40)
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1956AE20)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnSendInviteCallbackInternal_TypeDefinitionIndex = 33804;
