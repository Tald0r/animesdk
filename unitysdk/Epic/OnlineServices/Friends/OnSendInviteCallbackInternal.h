...
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190DC2A0)
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190DC2F0)
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x190DBFA0)
#define EPIC_ONLINESERVICES_FRIENDS_ONSENDINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x190DBF90)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int OnSendInviteCallbackInternal_TypeDefinitionIndex = 32850;
