...
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7E4580)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7E4450)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x7E42C0)
#define EPIC_ONLINESERVICES_FRIENDS_QUERYFRIENDSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7E4380)

namespace Epic::OnlineServices::Friends
{
	inline static constexpr unsigned int QueryFriendsOptionsInternal_TypeDefinitionIndex = 33808;
