...
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x272280)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x89A8F0)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x89AA00)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTCALLBACKINFOINTERNAL_GET_TRANSACTIONID_OFFSET UNITYSDK_OFFSET(0x89AA70)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CheckoutCallbackInfoInternal_TypeDefinitionIndex = 33824;
