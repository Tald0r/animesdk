...
#define EPIC_ONLINESERVICES_ECOM_TRANSACTION_COPYENTITLEMENTBYINDEX_OFFSET UNITYSDK_OFFSET(0x195322F0)
#define EPIC_ONLINESERVICES_ECOM_TRANSACTION_GETENTITLEMENTSCOUNT_OFFSET UNITYSDK_OFFSET(0x195324F0)
#define EPIC_ONLINESERVICES_ECOM_TRANSACTION_GETTRANSACTIONID_OFFSET UNITYSDK_OFFSET(0x19532710)
#define EPIC_ONLINESERVICES_ECOM_TRANSACTION_RELEASE_OFFSET UNITYSDK_OFFSET(0x19532940)
#define EPIC_ONLINESERVICES_ECOM_TRANSACTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195322E0)
#define EPIC_ONLINESERVICES_ECOM_TRANSACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x195322D0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int Transaction_TypeDefinitionIndex = 32956;
