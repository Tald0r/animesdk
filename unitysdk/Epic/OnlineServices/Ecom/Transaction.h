...
#define EPIC_ONLINESERVICES_ECOM_TRANSACTION_COPYENTITLEMENTBYINDEX_OFFSET UNITYSDK_OFFSET(0x199B1880)
#define EPIC_ONLINESERVICES_ECOM_TRANSACTION_GETENTITLEMENTSCOUNT_OFFSET UNITYSDK_OFFSET(0x199B1A80)
#define EPIC_ONLINESERVICES_ECOM_TRANSACTION_GETTRANSACTIONID_OFFSET UNITYSDK_OFFSET(0x199B1CA0)
#define EPIC_ONLINESERVICES_ECOM_TRANSACTION_RELEASE_OFFSET UNITYSDK_OFFSET(0x199B1ED0)
#define EPIC_ONLINESERVICES_ECOM_TRANSACTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x199B1870)
#define EPIC_ONLINESERVICES_ECOM_TRANSACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x199B1860)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int Transaction_TypeDefinitionIndex = 33910;
