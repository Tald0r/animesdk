...
#define EPIC_ONLINESERVICES_ECOM_REDEEMENTITLEMENTSOPTIONS_GET_ENTITLEMENTIDS_OFFSET UNITYSDK_OFFSET(0x19155190)
#define EPIC_ONLINESERVICES_ECOM_REDEEMENTITLEMENTSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19155170)
#define EPIC_ONLINESERVICES_ECOM_REDEEMENTITLEMENTSOPTIONS_SET_ENTITLEMENTIDS_OFFSET UNITYSDK_OFFSET(0x191551A0)
#define EPIC_ONLINESERVICES_ECOM_REDEEMENTITLEMENTSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19155180)
#define EPIC_ONLINESERVICES_ECOM_REDEEMENTITLEMENTSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x191551B0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int RedeemEntitlementsOptions_TypeDefinitionIndex = 33908;
