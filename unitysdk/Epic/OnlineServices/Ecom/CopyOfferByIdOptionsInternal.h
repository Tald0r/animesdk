...
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7E3940)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7E38D0)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x7E3750)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONSINTERNAL_SET_OFFERID_OFFSET UNITYSDK_OFFSET(0x7E3810)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7E38C0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyOfferByIdOptionsInternal_TypeDefinitionIndex = 33842;
