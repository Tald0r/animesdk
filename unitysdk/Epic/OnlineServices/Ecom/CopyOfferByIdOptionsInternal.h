...
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7A7B20)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7A7AB0)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x7A7930)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONSINTERNAL_SET_OFFERID_OFFSET UNITYSDK_OFFSET(0x7A79F0)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7A7AA0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyOfferByIdOptionsInternal_TypeDefinitionIndex = 32888;
