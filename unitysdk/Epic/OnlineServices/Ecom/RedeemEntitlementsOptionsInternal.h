...
#define EPIC_ONLINESERVICES_ECOM_REDEEMENTITLEMENTSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x903CD0)
#define EPIC_ONLINESERVICES_ECOM_REDEEMENTITLEMENTSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x903C60)
#define EPIC_ONLINESERVICES_ECOM_REDEEMENTITLEMENTSOPTIONSINTERNAL_SET_ENTITLEMENTIDS_OFFSET UNITYSDK_OFFSET(0x903BE0)
#define EPIC_ONLINESERVICES_ECOM_REDEEMENTITLEMENTSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x903B20)
#define EPIC_ONLINESERVICES_ECOM_REDEEMENTITLEMENTSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x903C50)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int RedeemEntitlementsOptionsInternal_TypeDefinitionIndex = 33909;
