...
#define EPIC_ONLINESERVICES_ECOM_COPYENTITLEMENTBYNAMEANDINDEXOPTIONS_GET_ENTITLEMENTNAME_OFFSET UNITYSDK_OFFSET(0x19D45CF0)
#define EPIC_ONLINESERVICES_ECOM_COPYENTITLEMENTBYNAMEANDINDEXOPTIONS_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x19D45D10)
#define EPIC_ONLINESERVICES_ECOM_COPYENTITLEMENTBYNAMEANDINDEXOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19D45CD0)
#define EPIC_ONLINESERVICES_ECOM_COPYENTITLEMENTBYNAMEANDINDEXOPTIONS_SET_ENTITLEMENTNAME_OFFSET UNITYSDK_OFFSET(0x19D45D00)
#define EPIC_ONLINESERVICES_ECOM_COPYENTITLEMENTBYNAMEANDINDEXOPTIONS_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x19D45D20)
#define EPIC_ONLINESERVICES_ECOM_COPYENTITLEMENTBYNAMEANDINDEXOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19D45CE0)
#define EPIC_ONLINESERVICES_ECOM_COPYENTITLEMENTBYNAMEANDINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19D45D30)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyEntitlementByNameAndIndexOptions_TypeDefinitionIndex = 33833;
