...
#define EPIC_ONLINESERVICES_ECOM_GETITEMRELEASECOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B9D90)
#define EPIC_ONLINESERVICES_ECOM_GETITEMRELEASECOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8B9D20)
#define EPIC_ONLINESERVICES_ECOM_GETITEMRELEASECOUNTOPTIONSINTERNAL_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x8B9C60)
#define EPIC_ONLINESERVICES_ECOM_GETITEMRELEASECOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8B9BA0)
#define EPIC_ONLINESERVICES_ECOM_GETITEMRELEASECOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B9D10)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int GetItemReleaseCountOptionsInternal_TypeDefinitionIndex = 33864;
