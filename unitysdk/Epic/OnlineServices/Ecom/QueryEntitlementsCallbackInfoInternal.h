...
#define EPIC_ONLINESERVICES_ECOM_QUERYENTITLEMENTSCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x272280)
#define EPIC_ONLINESERVICES_ECOM_QUERYENTITLEMENTSCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x87AB70)
#define EPIC_ONLINESERVICES_ECOM_QUERYENTITLEMENTSCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x87AC80)
#define EPIC_ONLINESERVICES_ECOM_QUERYENTITLEMENTSCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int QueryEntitlementsCallbackInfoInternal_TypeDefinitionIndex = 33891;
