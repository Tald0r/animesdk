...
#define EPIC_ONLINESERVICES_ECOM_QUERYENTITLEMENTSOPTIONS_GET_ENTITLEMENTNAMES_OFFSET UNITYSDK_OFFSET(0x1926D380)
#define EPIC_ONLINESERVICES_ECOM_QUERYENTITLEMENTSOPTIONS_GET_INCLUDEREDEEMED_OFFSET UNITYSDK_OFFSET(0x1926D3A0)
#define EPIC_ONLINESERVICES_ECOM_QUERYENTITLEMENTSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1926D360)
#define EPIC_ONLINESERVICES_ECOM_QUERYENTITLEMENTSOPTIONS_SET_ENTITLEMENTNAMES_OFFSET UNITYSDK_OFFSET(0x1926D390)
#define EPIC_ONLINESERVICES_ECOM_QUERYENTITLEMENTSOPTIONS_SET_INCLUDEREDEEMED_OFFSET UNITYSDK_OFFSET(0x1926D3B0)
#define EPIC_ONLINESERVICES_ECOM_QUERYENTITLEMENTSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1926D370)
#define EPIC_ONLINESERVICES_ECOM_QUERYENTITLEMENTSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1926D3C0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int QueryEntitlementsOptions_TypeDefinitionIndex = 33892;
