...
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A82B0)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8A8240)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8A80C0)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8A8230)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONSINTERNAL_SET_TRANSACTIONID_OFFSET UNITYSDK_OFFSET(0x8A8180)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyTransactionByIdOptionsInternal_TypeDefinitionIndex = 33850;
