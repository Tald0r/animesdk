...
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18DC3B40)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONS_GET_TRANSACTIONID_OFFSET UNITYSDK_OFFSET(0x18DC3B60)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18DC3B50)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONS_SET_TRANSACTIONID_OFFSET UNITYSDK_OFFSET(0x18DC3B70)
#define EPIC_ONLINESERVICES_ECOM_COPYTRANSACTIONBYIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC3B80)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyTransactionByIdOptions_TypeDefinitionIndex = 32895;
