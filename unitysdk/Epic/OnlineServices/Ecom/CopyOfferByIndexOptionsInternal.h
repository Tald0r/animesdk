...
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D14A0)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D1490)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8D12F0)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONSINTERNAL_SET_OFFERINDEX_OFFSET UNITYSDK_OFFSET(0x3197D0)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D13B0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyOfferByIndexOptionsInternal_TypeDefinitionIndex = 32890;
