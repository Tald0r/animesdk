...
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A2340)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8A2210)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8A2080)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8A2140)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int GetTransactionCountOptionsInternal_TypeDefinitionIndex = 33872;
