...
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x86D8A0)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x86D770)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x86D5E0)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x86D6A0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int GetTransactionCountOptionsInternal_TypeDefinitionIndex = 32918;
