...
#define EPIC_ONLINESERVICES_ECOM_COPYITEMBYIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8E7060)
#define EPIC_ONLINESERVICES_ECOM_COPYITEMBYIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8E6FF0)
#define EPIC_ONLINESERVICES_ECOM_COPYITEMBYIDOPTIONSINTERNAL_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x8E6F30)
#define EPIC_ONLINESERVICES_ECOM_COPYITEMBYIDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8E6E70)
#define EPIC_ONLINESERVICES_ECOM_COPYITEMBYIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8E6FE0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyItemByIdOptionsInternal_TypeDefinitionIndex = 33836;
