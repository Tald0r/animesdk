...
#define EPIC_ONLINESERVICES_ECOM_COPYITEMBYIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8AD600)
#define EPIC_ONLINESERVICES_ECOM_COPYITEMBYIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8AD590)
#define EPIC_ONLINESERVICES_ECOM_COPYITEMBYIDOPTIONSINTERNAL_SET_ITEMID_OFFSET UNITYSDK_OFFSET(0x8AD4D0)
#define EPIC_ONLINESERVICES_ECOM_COPYITEMBYIDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8AD410)
#define EPIC_ONLINESERVICES_ECOM_COPYITEMBYIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8AD580)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyItemByIdOptionsInternal_TypeDefinitionIndex = 32882;
