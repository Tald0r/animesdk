...
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1983EA30)
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1983EA60)
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1983E530)
#define EPIC_ONLINESERVICES_ECOM_ONCHECKOUTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1983E520)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnCheckoutCallback_TypeDefinitionIndex = 32923;
