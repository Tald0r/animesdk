...
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FBA10)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8FB9A0)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTOPTIONSINTERNAL_SET_ENTRIES_OFFSET UNITYSDK_OFFSET(0x8FB870)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8FB700)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8FB990)
#define EPIC_ONLINESERVICES_ECOM_CHECKOUTOPTIONSINTERNAL_SET_OVERRIDECATALOGNAMESPACE_OFFSET UNITYSDK_OFFSET(0x8FB7C0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CheckoutOptionsInternal_TypeDefinitionIndex = 33828;
