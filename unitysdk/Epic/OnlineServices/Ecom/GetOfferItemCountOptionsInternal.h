...
#define EPIC_ONLINESERVICES_ECOM_GETOFFERITEMCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x863250)
#define EPIC_ONLINESERVICES_ECOM_GETOFFERITEMCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8631E0)
#define EPIC_ONLINESERVICES_ECOM_GETOFFERITEMCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x863060)
#define EPIC_ONLINESERVICES_ECOM_GETOFFERITEMCOUNTOPTIONSINTERNAL_SET_OFFERID_OFFSET UNITYSDK_OFFSET(0x863120)
#define EPIC_ONLINESERVICES_ECOM_GETOFFERITEMCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8631D0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int GetOfferItemCountOptionsInternal_TypeDefinitionIndex = 32916;
