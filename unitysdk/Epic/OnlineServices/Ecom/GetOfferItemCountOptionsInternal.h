...
#define EPIC_ONLINESERVICES_ECOM_GETOFFERITEMCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x890CC0)
#define EPIC_ONLINESERVICES_ECOM_GETOFFERITEMCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x890C50)
#define EPIC_ONLINESERVICES_ECOM_GETOFFERITEMCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x890AD0)
#define EPIC_ONLINESERVICES_ECOM_GETOFFERITEMCOUNTOPTIONSINTERNAL_SET_OFFERID_OFFSET UNITYSDK_OFFSET(0x890B90)
#define EPIC_ONLINESERVICES_ECOM_GETOFFERITEMCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x890C40)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int GetOfferItemCountOptionsInternal_TypeDefinitionIndex = 33870;
