...
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_CHECKOUT_OFFSET UNITYSDK_OFFSET(0x17ED7B90)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_COPYENTITLEMENTBYID_OFFSET UNITYSDK_OFFSET(0x17ED7D50)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_COPYENTITLEMENTBYINDEX_OFFSET UNITYSDK_OFFSET(0x17ED7F50)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_COPYENTITLEMENTBYNAMEANDINDEX_OFFSET UNITYSDK_OFFSET(0x17ED8200)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_COPYITEMBYID_OFFSET UNITYSDK_OFFSET(0x17ED8400)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_COPYITEMIMAGEINFOBYINDEX_OFFSET UNITYSDK_OFFSET(0x17ED8600)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_COPYITEMRELEASEBYINDEX_OFFSET UNITYSDK_OFFSET(0x17ED8800)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_COPYOFFERBYID_OFFSET UNITYSDK_OFFSET(0x17ED8A00)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_COPYOFFERBYINDEX_OFFSET UNITYSDK_OFFSET(0x17ED8C00)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_COPYOFFERIMAGEINFOBYINDEX_OFFSET UNITYSDK_OFFSET(0x17ED8EB0)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_COPYOFFERITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0x17ED90B0)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_COPYTRANSACTIONBYID_OFFSET UNITYSDK_OFFSET(0x17ED92B0)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_COPYTRANSACTIONBYINDEX_OFFSET UNITYSDK_OFFSET(0x17ED9440)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_GETENTITLEMENTSBYNAMECOUNT_OFFSET UNITYSDK_OFFSET(0x17ED9670)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_GETENTITLEMENTSCOUNT_OFFSET UNITYSDK_OFFSET(0x17ED97D0)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_GETITEMIMAGEINFOCOUNT_OFFSET UNITYSDK_OFFSET(0x17ED99D0)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_GETITEMRELEASECOUNT_OFFSET UNITYSDK_OFFSET(0x17ED9B30)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_GETOFFERCOUNT_OFFSET UNITYSDK_OFFSET(0x17ED9C90)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_GETOFFERIMAGEINFOCOUNT_OFFSET UNITYSDK_OFFSET(0x17ED9E90)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_GETOFFERITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x17ED9FF0)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_GETTRANSACTIONCOUNT_OFFSET UNITYSDK_OFFSET(0x17EDA150)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_ONCHECKOUTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x17ED7810)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_ONQUERYENTITLEMENTSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x17ED78A0)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_ONQUERYOFFERSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x17ED7930)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_ONQUERYOWNERSHIPCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x17ED79C0)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_ONQUERYOWNERSHIPTOKENCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x17ED7A50)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_ONREDEEMENTITLEMENTSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x17ED7AE0)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_QUERYENTITLEMENTS_OFFSET UNITYSDK_OFFSET(0x17EDA350)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_QUERYOFFERS_OFFSET UNITYSDK_OFFSET(0x17EDA510)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_QUERYOWNERSHIPTOKEN_OFFSET UNITYSDK_OFFSET(0x17EDA890)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_QUERYOWNERSHIP_OFFSET UNITYSDK_OFFSET(0x17EDA6D0)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE_REDEEMENTITLEMENTS_OFFSET UNITYSDK_OFFSET(0x17EDAA50)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17ED7B80)
#define EPIC_ONLINESERVICES_ECOM_ECOMINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x17ED7B70)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int EcomInterface_TypeDefinitionIndex = 32899;
