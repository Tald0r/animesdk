...
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18F24D50)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18F24D80)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18F24850)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18F24840)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnQueryEntitlementsCallback_TypeDefinitionIndex = 32925;
