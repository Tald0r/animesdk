...
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1926CFB0)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1926CFE0)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1926CAB0)
#define EPIC_ONLINESERVICES_ECOM_ONQUERYENTITLEMENTSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1926CA90)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int OnQueryEntitlementsCallback_TypeDefinitionIndex = 33879;
