...
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_GET_CATALOGITEMID_OFFSET UNITYSDK_OFFSET(0x1921E690)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_GET_ENDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1921E6F0)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_GET_ENTITLEMENTID_OFFSET UNITYSDK_OFFSET(0x1921E670)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_GET_ENTITLEMENTNAME_OFFSET UNITYSDK_OFFSET(0x1921E650)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_GET_REDEEMED_OFFSET UNITYSDK_OFFSET(0x1921E6D0)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_GET_SERVERINDEX_OFFSET UNITYSDK_OFFSET(0x1921E6B0)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_SET_1_OFFSET UNITYSDK_OFFSET(0x1921EC90)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_SET_CATALOGITEMID_OFFSET UNITYSDK_OFFSET(0x1921E6A0)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_SET_ENDTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1921E700)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_SET_ENTITLEMENTID_OFFSET UNITYSDK_OFFSET(0x1921E680)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_SET_ENTITLEMENTNAME_OFFSET UNITYSDK_OFFSET(0x1921E660)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_SET_OFFSET UNITYSDK_OFFSET(0x1921E710)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_SET_REDEEMED_OFFSET UNITYSDK_OFFSET(0x1921E6E0)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT_SET_SERVERINDEX_OFFSET UNITYSDK_OFFSET(0x1921E6C0)
#define EPIC_ONLINESERVICES_ECOM_ENTITLEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1921EDE0)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int Entitlement_TypeDefinitionIndex = 33855;
