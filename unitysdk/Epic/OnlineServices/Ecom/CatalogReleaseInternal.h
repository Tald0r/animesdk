...
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x790080)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_GET_COMPATIBLEAPPIDS_OFFSET UNITYSDK_OFFSET(0x78FA40)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_GET_COMPATIBLEPLATFORMS_OFFSET UNITYSDK_OFFSET(0x78FC70)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_GET_RELEASENOTE_OFFSET UNITYSDK_OFFSET(0x78FEA0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x790010)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_SET_COMPATIBLEAPPIDS_OFFSET UNITYSDK_OFFSET(0x78FB50)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_SET_COMPATIBLEPLATFORMS_OFFSET UNITYSDK_OFFSET(0x78FD80)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x790000)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_SET_RELEASENOTE_OFFSET UNITYSDK_OFFSET(0x78FF50)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CatalogReleaseInternal_TypeDefinitionIndex = 32868;
