...
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7CD4C0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_GET_COMPATIBLEAPPIDS_OFFSET UNITYSDK_OFFSET(0x7CCE80)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_GET_COMPATIBLEPLATFORMS_OFFSET UNITYSDK_OFFSET(0x7CD0B0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_GET_RELEASENOTE_OFFSET UNITYSDK_OFFSET(0x7CD2E0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7CD450)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_SET_COMPATIBLEAPPIDS_OFFSET UNITYSDK_OFFSET(0x7CCF90)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_SET_COMPATIBLEPLATFORMS_OFFSET UNITYSDK_OFFSET(0x7CD1C0)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7CD440)
#define EPIC_ONLINESERVICES_ECOM_CATALOGRELEASEINTERNAL_SET_RELEASENOTE_OFFSET UNITYSDK_OFFSET(0x7CD390)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CatalogReleaseInternal_TypeDefinitionIndex = 33822;
