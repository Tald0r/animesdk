...
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x16E4B8F0)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x16E4B900)
#define EPIC_ONLINESERVICES_ECOM_GETTRANSACTIONCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x16E4B910)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int GetTransactionCountOptions_TypeDefinitionIndex = 32917;
