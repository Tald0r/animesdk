...
#define EPIC_ONLINESERVICES_ECOM_GETENTITLEMENTSCOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1921EE40)
#define EPIC_ONLINESERVICES_ECOM_GETENTITLEMENTSCOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1921EE50)
#define EPIC_ONLINESERVICES_ECOM_GETENTITLEMENTSCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1921EE60)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int GetEntitlementsCountOptions_TypeDefinitionIndex = 33859;
