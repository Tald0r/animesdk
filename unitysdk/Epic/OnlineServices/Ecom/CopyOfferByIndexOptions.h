...
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18F23340)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONS_GET_OFFERINDEX_OFFSET UNITYSDK_OFFSET(0x18F23360)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18F23350)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONS_SET_OFFERINDEX_OFFSET UNITYSDK_OFFSET(0x18F23370)
#define EPIC_ONLINESERVICES_ECOM_COPYOFFERBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18F23380)

namespace Epic::OnlineServices::Ecom
{
	inline static constexpr unsigned int CopyOfferByIndexOptions_TypeDefinitionIndex = 32889;
