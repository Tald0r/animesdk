...
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87D760)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_GET_CHANNELS_OFFSET UNITYSDK_OFFSET(0x3186C0)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_GET_FRAMES_OFFSET UNITYSDK_OFFSET(0x87D5E0)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_GET_SAMPLERATE_OFFSET UNITYSDK_OFFSET(0x338550)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x87D750)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_SET_CHANNELS_OFFSET UNITYSDK_OFFSET(0x318710)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_SET_FRAMES_OFFSET UNITYSDK_OFFSET(0x87D650)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x87D6C0)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_SET_SAMPLERATE_OFFSET UNITYSDK_OFFSET(0x338540)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int AudioBufferInternal_TypeDefinitionIndex = 33117;
