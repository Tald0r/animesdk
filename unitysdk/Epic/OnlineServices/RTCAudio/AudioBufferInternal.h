...
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x84F970)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_GET_CHANNELS_OFFSET UNITYSDK_OFFSET(0x359050)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_GET_FRAMES_OFFSET UNITYSDK_OFFSET(0x84F7F0)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_GET_SAMPLERATE_OFFSET UNITYSDK_OFFSET(0x34CDD0)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x84F960)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_SET_CHANNELS_OFFSET UNITYSDK_OFFSET(0x379D90)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_SET_FRAMES_OFFSET UNITYSDK_OFFSET(0x84F860)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x84F8D0)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOBUFFERINTERNAL_SET_SAMPLERATE_OFFSET UNITYSDK_OFFSET(0x34CE60)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int AudioBufferInternal_TypeDefinitionIndex = 32163;
