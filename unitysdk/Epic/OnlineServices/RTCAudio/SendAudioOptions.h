...
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x19C85110)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19C850D0)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS_GET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x19C850F0)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS_SET_BUFFER_OFFSET UNITYSDK_OFFSET(0x19C85120)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19C850E0)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x19C85100)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C85130)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int SendAudioOptions_TypeDefinitionIndex = 33160;
