...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATERECEIVINGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x192261B0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATERECEIVINGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x192261E0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATERECEIVINGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19225CB0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATERECEIVINGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19225C90)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnUpdateReceivingCallback_TypeDefinitionIndex = 33148;
