...
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOOUTPUTDEVICEINFO_GET_DEFAULTDEVICE_OFFSET UNITYSDK_OFFSET(0x16E558F0)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOOUTPUTDEVICEINFO_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x16E55910)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOOUTPUTDEVICEINFO_GET_DEVICENAME_OFFSET UNITYSDK_OFFSET(0x16E55930)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOOUTPUTDEVICEINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x16E55CF0)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOOUTPUTDEVICEINFO_SET_DEFAULTDEVICE_OFFSET UNITYSDK_OFFSET(0x16E55900)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOOUTPUTDEVICEINFO_SET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x16E55920)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOOUTPUTDEVICEINFO_SET_DEVICENAME_OFFSET UNITYSDK_OFFSET(0x16E55940)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOOUTPUTDEVICEINFO_SET_OFFSET UNITYSDK_OFFSET(0x16E55950)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOOUTPUTDEVICEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16E55E20)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int AudioOutputDeviceInfo_TypeDefinitionIndex = 32170;
