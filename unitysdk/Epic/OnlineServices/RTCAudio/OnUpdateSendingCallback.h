...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184FEBB0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184FEBE0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x184FE6B0)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x184FE690)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnUpdateSendingCallback_TypeDefinitionIndex = 33150;
