...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17EE6260)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17EE6290)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x17EE5D60)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONUPDATESENDINGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17EE5D50)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnUpdateSendingCallback_TypeDefinitionIndex = 32196;
