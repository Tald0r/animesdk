...
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATERECEIVINGOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8CDDD0)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATERECEIVINGOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8CDD60)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATERECEIVINGOPTIONSINTERNAL_SET_AUDIOENABLED_OFFSET UNITYSDK_OFFSET(0x8CDCA0)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATERECEIVINGOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8CDA70)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATERECEIVINGOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8CDD50)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATERECEIVINGOPTIONSINTERNAL_SET_PARTICIPANTID_OFFSET UNITYSDK_OFFSET(0x8CDBE0)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATERECEIVINGOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x8CDB30)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int UpdateReceivingOptionsInternal_TypeDefinitionIndex = 32217;
