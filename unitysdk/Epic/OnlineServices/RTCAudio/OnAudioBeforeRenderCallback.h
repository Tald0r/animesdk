...
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18DA3200)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18DA3230)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DA2D00)
#define EPIC_ONLINESERVICES_RTCAUDIO_ONAUDIOBEFORERENDERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18DA2CF0)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int OnAudioBeforeRenderCallback_TypeDefinitionIndex = 32182;
