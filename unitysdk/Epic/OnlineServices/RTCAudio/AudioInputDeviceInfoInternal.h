...
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOINPUTDEVICEINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8DBE80)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOINPUTDEVICEINFOINTERNAL_GET_DEFAULTDEVICE_OFFSET UNITYSDK_OFFSET(0x8DB9E0)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOINPUTDEVICEINFOINTERNAL_GET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x8DBB40)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOINPUTDEVICEINFOINTERNAL_GET_DEVICENAME_OFFSET UNITYSDK_OFFSET(0x8DBCA0)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOINPUTDEVICEINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8DBE10)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOINPUTDEVICEINFOINTERNAL_SET_DEFAULTDEVICE_OFFSET UNITYSDK_OFFSET(0x8DBA90)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOINPUTDEVICEINFOINTERNAL_SET_DEVICEID_OFFSET UNITYSDK_OFFSET(0x8DBBF0)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOINPUTDEVICEINFOINTERNAL_SET_DEVICENAME_OFFSET UNITYSDK_OFFSET(0x8DBD50)
#define EPIC_ONLINESERVICES_RTCAUDIO_AUDIOINPUTDEVICEINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8DBE00)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int AudioInputDeviceInfoInternal_TypeDefinitionIndex = 33121;
