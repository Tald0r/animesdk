...
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x88BCA0)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x88BC30)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONSINTERNAL_SET_BUFFER_OFFSET UNITYSDK_OFFSET(0x88BB00)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x88B990)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x88BC20)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x88BA50)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int SendAudioOptionsInternal_TypeDefinitionIndex = 33161;
