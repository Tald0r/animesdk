...
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x85D3D0)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x85D360)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONSINTERNAL_SET_BUFFER_OFFSET UNITYSDK_OFFSET(0x85D230)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x85D0C0)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x85D350)
#define EPIC_ONLINESERVICES_RTCAUDIO_SENDAUDIOOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x85D180)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int SendAudioOptionsInternal_TypeDefinitionIndex = 32207;
