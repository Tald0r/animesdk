...
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATESENDINGOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x893910)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATESENDINGOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8938A0)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATESENDINGOPTIONSINTERNAL_SET_AUDIOSTATUS_OFFSET UNITYSDK_OFFSET(0x318710)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATESENDINGOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x893720)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATESENDINGOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x893890)
#define EPIC_ONLINESERVICES_RTCAUDIO_UPDATESENDINGOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x8937E0)

namespace Epic::OnlineServices::RTCAudio
{
	inline static constexpr unsigned int UpdateSendingOptionsInternal_TypeDefinitionIndex = 33175;
