...
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8DD340)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8DD2D0)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x8DD050)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8DCF00)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8DD2C0)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x8DCFC0)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_STATNAMES_OFFSET UNITYSDK_OFFSET(0x8DD0E0)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x8DD200)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int QueryStatsOptionsInternal_TypeDefinitionIndex = 32905;
