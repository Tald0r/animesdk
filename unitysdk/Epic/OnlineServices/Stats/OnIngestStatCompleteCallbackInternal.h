...
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18F32C80)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18F32CD0)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x18F32980)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18F32970)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int OnIngestStatCompleteCallbackInternal_TypeDefinitionIndex = 31945;
