...
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87FA50)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x87F9E0)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONSINTERNAL_SET_NAME_OFFSET UNITYSDK_OFFSET(0x87F920)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x87F9D0)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x87F860)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int CopyStatByNameOptionsInternal_TypeDefinitionIndex = 32889;
