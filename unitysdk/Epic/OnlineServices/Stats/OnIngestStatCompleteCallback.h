...
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x185032D0)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18503300)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18502DD0)
#define EPIC_ONLINESERVICES_STATS_ONINGESTSTATCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18502DB0)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int OnIngestStatCompleteCallback_TypeDefinitionIndex = 32898;
