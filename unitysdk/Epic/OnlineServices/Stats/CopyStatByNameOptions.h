...
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x185025C0)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x185025A0)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONS_SET_NAME_OFFSET UNITYSDK_OFFSET(0x185025D0)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x185025B0)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYNAMEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x185025E0)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int CopyStatByNameOptions_TypeDefinitionIndex = 32888;
