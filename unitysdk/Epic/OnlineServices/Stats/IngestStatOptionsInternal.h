...
#define EPIC_ONLINESERVICES_STATS_INGESTSTATOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7AC560)
#define EPIC_ONLINESERVICES_STATS_INGESTSTATOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7AC4F0)
#define EPIC_ONLINESERVICES_STATS_INGESTSTATOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x7AC240)
#define EPIC_ONLINESERVICES_STATS_INGESTSTATOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7AC4E0)
#define EPIC_ONLINESERVICES_STATS_INGESTSTATOPTIONSINTERNAL_SET_STATS_OFFSET UNITYSDK_OFFSET(0x7AC300)
#define EPIC_ONLINESERVICES_STATS_INGESTSTATOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x7AC420)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int IngestStatOptionsInternal_TypeDefinitionIndex = 31943;
