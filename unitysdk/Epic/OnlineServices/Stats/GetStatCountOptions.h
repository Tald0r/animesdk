...
#define EPIC_ONLINESERVICES_STATS_GETSTATCOUNTOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x17EE9C50)
#define EPIC_ONLINESERVICES_STATS_GETSTATCOUNTOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x17EE9C60)
#define EPIC_ONLINESERVICES_STATS_GETSTATCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x17EE9C70)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int GetStatCountOptions_TypeDefinitionIndex = 31936;
