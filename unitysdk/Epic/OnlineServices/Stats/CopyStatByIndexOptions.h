...
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYINDEXOPTIONS_GET_STATINDEX_OFFSET UNITYSDK_OFFSET(0x18502570)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYINDEXOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x18502550)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYINDEXOPTIONS_SET_STATINDEX_OFFSET UNITYSDK_OFFSET(0x18502580)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYINDEXOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x18502560)
#define EPIC_ONLINESERVICES_STATS_COPYSTATBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18502590)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int CopyStatByIndexOptions_TypeDefinitionIndex = 32886;
