...
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONS_GET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x190C7A10)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x190C79C0)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONS_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x190C79E0)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONS_GET_STATNAMES_OFFSET UNITYSDK_OFFSET(0x190C7A40)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x190C7A60)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONS_SET_ENDTIME_OFFSET UNITYSDK_OFFSET(0x190C7A30)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x190C79D0)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONS_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x190C7A00)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONS_SET_STATNAMES_OFFSET UNITYSDK_OFFSET(0x190C7A50)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x190C7A70)
#define EPIC_ONLINESERVICES_STATS_QUERYSTATSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x190C7A80)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int QueryStatsOptions_TypeDefinitionIndex = 31950;
