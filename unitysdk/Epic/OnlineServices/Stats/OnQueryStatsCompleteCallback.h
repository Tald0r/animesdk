...
#define EPIC_ONLINESERVICES_STATS_ONQUERYSTATSCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x195778B0)
#define EPIC_ONLINESERVICES_STATS_ONQUERYSTATSCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x195778E0)
#define EPIC_ONLINESERVICES_STATS_ONQUERYSTATSCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x195773B0)
#define EPIC_ONLINESERVICES_STATS_ONQUERYSTATSCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19577390)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int OnQueryStatsCompleteCallback_TypeDefinitionIndex = 32900;
