...
#define EPIC_ONLINESERVICES_STATS_GETSTATCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x840CB0)
#define EPIC_ONLINESERVICES_STATS_GETSTATCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x840B80)
#define EPIC_ONLINESERVICES_STATS_GETSTATCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x840AB0)
#define EPIC_ONLINESERVICES_STATS_GETSTATCOUNTOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x8409F0)

namespace Epic::OnlineServices::Stats
{
	inline static constexpr unsigned int GetStatCountOptionsInternal_TypeDefinitionIndex = 31937;
