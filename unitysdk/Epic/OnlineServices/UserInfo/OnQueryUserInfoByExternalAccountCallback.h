...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18504570)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x185045A0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18504070)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18504050)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoByExternalAccountCallback_TypeDefinitionIndex = 32789;
