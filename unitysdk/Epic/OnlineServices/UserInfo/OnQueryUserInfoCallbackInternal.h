...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A8E4E0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A8E530)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A8E1E0)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19A8E1D0)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoCallbackInternal_TypeDefinitionIndex = 31838;
