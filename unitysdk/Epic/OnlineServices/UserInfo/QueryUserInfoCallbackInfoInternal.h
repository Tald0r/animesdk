...
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x841500)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x841610)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define EPIC_ONLINESERVICES_USERINFO_QUERYUSERINFOCALLBACKINFOINTERNAL_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x841680)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int QueryUserInfoCallbackInfoInternal_TypeDefinitionIndex = 31848;
