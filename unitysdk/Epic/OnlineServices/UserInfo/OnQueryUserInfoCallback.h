...
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19105010)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19105040)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19104B10)
#define EPIC_ONLINESERVICES_USERINFO_ONQUERYUSERINFOCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19104AF0)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int OnQueryUserInfoCallback_TypeDefinitionIndex = 32791;
