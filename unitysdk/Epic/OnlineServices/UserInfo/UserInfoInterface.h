...
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE_COPYEXTERNALUSERINFOBYACCOUNTID_OFFSET UNITYSDK_OFFSET(0x1922A620)
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE_COPYEXTERNALUSERINFOBYACCOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x1922A820)
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE_COPYEXTERNALUSERINFOBYINDEX_OFFSET UNITYSDK_OFFSET(0x1922AA20)
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE_COPYUSERINFO_OFFSET UNITYSDK_OFFSET(0x1922AC20)
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE_GETEXTERNALUSERINFOCOUNT_OFFSET UNITYSDK_OFFSET(0x1922AE20)
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE_ONQUERYUSERINFOBYDISPLAYNAMECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1922A450)
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE_ONQUERYUSERINFOBYEXTERNALACCOUNTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1922A4E0)
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE_ONQUERYUSERINFOCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1922A570)
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE_QUERYUSERINFOBYDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1922B140)
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE_QUERYUSERINFOBYEXTERNALACCOUNT_OFFSET UNITYSDK_OFFSET(0x1922B300)
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE_QUERYUSERINFO_OFFSET UNITYSDK_OFFSET(0x1922AF80)
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1922A610)
#define EPIC_ONLINESERVICES_USERINFO_USERINFOINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1922A600)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int UserInfoInterface_TypeDefinitionIndex = 32807;
