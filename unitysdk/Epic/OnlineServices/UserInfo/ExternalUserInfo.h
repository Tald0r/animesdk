...
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFO_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x19A8DBC0)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFO_GET_ACCOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x19A8DBA0)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFO_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x19A8DBE0)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x19A8DE90)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFO_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x19A8DBD0)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFO_SET_ACCOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x19A8DBB0)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFO_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x19A8DBF0)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFO_SET_OFFSET UNITYSDK_OFFSET(0x19A8DC00)
#define EPIC_ONLINESERVICES_USERINFO_EXTERNALUSERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19A8E1C0)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int ExternalUserInfo_TypeDefinitionIndex = 31829;
