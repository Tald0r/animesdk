...
#define EPIC_ONLINESERVICES_USERINFO_COPYEXTERNALUSERINFOBYACCOUNTTYPEOPTIONS_GET_ACCOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x19FCEFD0)
#define EPIC_ONLINESERVICES_USERINFO_COPYEXTERNALUSERINFOBYACCOUNTTYPEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19FCEF90)
#define EPIC_ONLINESERVICES_USERINFO_COPYEXTERNALUSERINFOBYACCOUNTTYPEOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x19FCEFB0)
#define EPIC_ONLINESERVICES_USERINFO_COPYEXTERNALUSERINFOBYACCOUNTTYPEOPTIONS_SET_ACCOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x19FCEFE0)
#define EPIC_ONLINESERVICES_USERINFO_COPYEXTERNALUSERINFOBYACCOUNTTYPEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19FCEFA0)
#define EPIC_ONLINESERVICES_USERINFO_COPYEXTERNALUSERINFOBYACCOUNTTYPEOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x19FCEFC0)
#define EPIC_ONLINESERVICES_USERINFO_COPYEXTERNALUSERINFOBYACCOUNTTYPEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19FCEFF0)

namespace Epic::OnlineServices::UserInfo
{
	inline static constexpr unsigned int CopyExternalUserInfoByAccountTypeOptions_TypeDefinitionIndex = 32777;
