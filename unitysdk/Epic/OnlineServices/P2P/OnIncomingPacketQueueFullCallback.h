...
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C7F130)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C7F160)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C7EC30)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7EC10)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnIncomingPacketQueueFullCallback_TypeDefinitionIndex = 33409;
