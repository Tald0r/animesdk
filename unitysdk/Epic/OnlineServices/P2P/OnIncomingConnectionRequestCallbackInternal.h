...
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18F2A5A0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18F2A5F0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x18F2A2A0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18F2A290)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnIncomingConnectionRequestCallbackInternal_TypeDefinitionIndex = 32452;
