...
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x874BE0)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x874B70)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x874910)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x874B60)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONSINTERNAL_SET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x8749D0)
#define EPIC_ONLINESERVICES_P2P_ACCEPTCONNECTIONOPTIONSINTERNAL_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x874A90)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int AcceptConnectionOptionsInternal_TypeDefinitionIndex = 32423;
