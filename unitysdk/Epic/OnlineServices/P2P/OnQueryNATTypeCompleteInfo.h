...
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x1953F920)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1953F8E0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_GET_NATTYPE_OFFSET UNITYSDK_OFFSET(0x1953F900)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1953F8C0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1953FA50)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1953F8F0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_SET_NATTYPE_OFFSET UNITYSDK_OFFSET(0x1953F910)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_SET_OFFSET UNITYSDK_OFFSET(0x1953F940)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1953F8D0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1953FC00)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnQueryNATTypeCompleteInfo_TypeDefinitionIndex = 32465;
