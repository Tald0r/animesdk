...
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x199BEF00)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x199BEEC0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_GET_NATTYPE_OFFSET UNITYSDK_OFFSET(0x199BEEE0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x199BEEA0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x199BF030)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x199BEED0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_SET_NATTYPE_OFFSET UNITYSDK_OFFSET(0x199BEEF0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_SET_OFFSET UNITYSDK_OFFSET(0x199BEF20)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x199BEEB0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x199BF1E0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnQueryNATTypeCompleteInfo_TypeDefinitionIndex = 33419;
