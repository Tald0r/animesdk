...
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18E12F50)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18E12F80)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18E12A50)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18E12A40)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnQueryNATTypeCompleteCallback_TypeDefinitionIndex = 32463;
