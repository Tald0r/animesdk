...
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18E12A00)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18E12A30)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18E12500)
#define EPIC_ONLINESERVICES_P2P_ONPEERCONNECTIONESTABLISHEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18E124F0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnPeerConnectionEstablishedCallback_TypeDefinitionIndex = 32459;
