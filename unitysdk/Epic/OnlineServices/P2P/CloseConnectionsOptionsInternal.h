...
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x874FA0)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x874F30)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x874D90)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x874F20)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x874E50)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int CloseConnectionsOptionsInternal_TypeDefinitionIndex = 32437;
