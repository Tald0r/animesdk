...
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A9F10)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8A9EA0)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8A9D00)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8A9E90)
#define EPIC_ONLINESERVICES_P2P_CLOSECONNECTIONSOPTIONSINTERNAL_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x8A9DC0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int CloseConnectionsOptionsInternal_TypeDefinitionIndex = 33391;
