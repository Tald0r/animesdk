...
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x272280)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8AA0B0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_NATTYPE_OFFSET UNITYSDK_OFFSET(0x302AD0)
#define EPIC_ONLINESERVICES_P2P_ONQUERYNATTYPECOMPLETEINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnQueryNATTypeCompleteInfoInternal_TypeDefinitionIndex = 33420;
