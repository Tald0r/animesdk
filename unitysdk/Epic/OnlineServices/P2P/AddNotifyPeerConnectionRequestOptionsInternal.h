...
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89CA20)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x89C9B0)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x89C7F0)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x89C9A0)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONSINTERNAL_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x89C8B0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int AddNotifyPeerConnectionRequestOptionsInternal_TypeDefinitionIndex = 33385;
