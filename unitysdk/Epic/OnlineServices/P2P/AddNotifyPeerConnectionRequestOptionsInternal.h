...
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x895040)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x894FD0)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x894E10)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x894FC0)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONREQUESTOPTIONSINTERNAL_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x894ED0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int AddNotifyPeerConnectionRequestOptionsInternal_TypeDefinitionIndex = 32431;
