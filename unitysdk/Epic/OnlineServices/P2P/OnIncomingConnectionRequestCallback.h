...
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19222EF0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19222F20)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x192229F0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGCONNECTIONREQUESTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x192229D0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnIncomingConnectionRequestCallback_TypeDefinitionIndex = 33405;
