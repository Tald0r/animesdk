...
#define EPIC_ONLINESERVICES_P2P_GETPORTRANGEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define EPIC_ONLINESERVICES_P2P_GETPORTRANGEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x89CB50)
#define EPIC_ONLINESERVICES_P2P_GETPORTRANGEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7CBF80)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int GetPortRangeOptionsInternal_TypeDefinitionIndex = 33401;
