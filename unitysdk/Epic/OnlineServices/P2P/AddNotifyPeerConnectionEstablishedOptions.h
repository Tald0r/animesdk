...
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18DA06F0)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x18DA0710)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18DA0700)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x18DA0720)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18DA0730)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int AddNotifyPeerConnectionEstablishedOptions_TypeDefinitionIndex = 32428;
