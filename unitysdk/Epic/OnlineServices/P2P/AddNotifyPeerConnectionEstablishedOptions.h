...
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x190FBD20)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x190FBD40)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x190FBD30)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x190FBD50)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONESTABLISHEDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x190FBD60)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int AddNotifyPeerConnectionEstablishedOptions_TypeDefinitionIndex = 33382;
