...
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7CFCA0)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7CFC30)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_ALLOWDELAYEDDELIVERY_OFFSET UNITYSDK_OFFSET(0x7CFB70)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_CHANNEL_OFFSET UNITYSDK_OFFSET(0x322CE0)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_DATA_OFFSET UNITYSDK_OFFSET(0x7CFB00)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x7CF890)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7CFC20)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_RELIABILITY_OFFSET UNITYSDK_OFFSET(0x53B9D0)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x7CF950)
#define EPIC_ONLINESERVICES_P2P_SENDPACKETOPTIONSINTERNAL_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x7CFA10)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int SendPacketOptionsInternal_TypeDefinitionIndex = 33435;
