...
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x175B37B0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x175B36F0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_OVERFLOWPACKETCHANNEL_OFFSET UNITYSDK_OFFSET(0x175B3770)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_OVERFLOWPACKETLOCALUSERID_OFFSET UNITYSDK_OFFSET(0x175B3750)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_OVERFLOWPACKETSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x175B3790)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_PACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x175B3730)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_PACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x175B3710)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x175B3B00)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x175B3700)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_OFFSET UNITYSDK_OFFSET(0x175B37C0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_OVERFLOWPACKETCHANNEL_OFFSET UNITYSDK_OFFSET(0x175B3780)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_OVERFLOWPACKETLOCALUSERID_OFFSET UNITYSDK_OFFSET(0x175B3760)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_OVERFLOWPACKETSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x175B37A0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_PACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x175B3740)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_PACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x175B3720)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x175B3C40)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnIncomingPacketQueueFullInfo_TypeDefinitionIndex = 33411;
