...
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x16E51480)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x16E513C0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_OVERFLOWPACKETCHANNEL_OFFSET UNITYSDK_OFFSET(0x16E51440)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_OVERFLOWPACKETLOCALUSERID_OFFSET UNITYSDK_OFFSET(0x16E51420)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_OVERFLOWPACKETSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x16E51460)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_PACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x16E51400)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_GET_PACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x16E513E0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x16E517D0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x16E513D0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_OFFSET UNITYSDK_OFFSET(0x16E51490)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_OVERFLOWPACKETCHANNEL_OFFSET UNITYSDK_OFFSET(0x16E51450)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_OVERFLOWPACKETLOCALUSERID_OFFSET UNITYSDK_OFFSET(0x16E51430)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_OVERFLOWPACKETSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x16E51470)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_PACKETQUEUECURRENTSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x16E51410)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO_SET_PACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x16E513F0)
#define EPIC_ONLINESERVICES_P2P_ONINCOMINGPACKETQUEUEFULLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16E51910)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnIncomingPacketQueueFullInfo_TypeDefinitionIndex = 32457;
