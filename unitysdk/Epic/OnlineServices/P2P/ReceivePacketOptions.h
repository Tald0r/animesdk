...
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x187E5680)
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS_GET_MAXDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x187E56A0)
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS_GET_REQUESTEDCHANNEL_OFFSET UNITYSDK_OFFSET(0x187E56C0)
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x187E5690)
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS_SET_MAXDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x187E56B0)
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS_SET_REQUESTEDCHANNEL_OFFSET UNITYSDK_OFFSET(0x187E56D0)
#define EPIC_ONLINESERVICES_P2P_RECEIVEPACKETOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x187E56E0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int ReceivePacketOptions_TypeDefinitionIndex = 32477;
