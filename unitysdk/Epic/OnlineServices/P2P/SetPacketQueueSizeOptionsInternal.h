...
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8A4010)
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONSINTERNAL_SET_INCOMINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x302310)
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7E1C20)
#define EPIC_ONLINESERVICES_P2P_SETPACKETQUEUESIZEOPTIONSINTERNAL_SET_OUTGOINGPACKETQUEUEMAXSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x3123A0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int SetPacketQueueSizeOptionsInternal_TypeDefinitionIndex = 33437;
