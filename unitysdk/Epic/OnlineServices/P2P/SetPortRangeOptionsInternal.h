...
#define EPIC_ONLINESERVICES_P2P_SETPORTRANGEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define EPIC_ONLINESERVICES_P2P_SETPORTRANGEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x86F620)
#define EPIC_ONLINESERVICES_P2P_SETPORTRANGEOPTIONSINTERNAL_SET_MAXADDITIONALPORTSTOTRY_OFFSET UNITYSDK_OFFSET(0x838790)
#define EPIC_ONLINESERVICES_P2P_SETPORTRANGEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x86F600)
#define EPIC_ONLINESERVICES_P2P_SETPORTRANGEOPTIONSINTERNAL_SET_PORT_OFFSET UNITYSDK_OFFSET(0x86F5F0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int SetPortRangeOptionsInternal_TypeDefinitionIndex = 32485;
