...
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D25C0)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7A4F30)
#define EPIC_ONLINESERVICES_P2P_SETRELAYCONTROLOPTIONSINTERNAL_SET_RELAYCONTROL_OFFSET UNITYSDK_OFFSET(0x2D38F0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int SetRelayControlOptionsInternal_TypeDefinitionIndex = 32487;
