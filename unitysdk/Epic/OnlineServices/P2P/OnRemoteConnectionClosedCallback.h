...
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18F2B100)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18F2B130)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18F2AC00)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18F2ABF0)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnRemoteConnectionClosedCallback_TypeDefinitionIndex = 32467;
