...
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19273380)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x192733B0)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19272E80)
#define EPIC_ONLINESERVICES_P2P_ONREMOTECONNECTIONCLOSEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19272E60)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int OnRemoteConnectionClosedCallback_TypeDefinitionIndex = 33421;
