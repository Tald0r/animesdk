...
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ACCEPTCONNECTION_OFFSET UNITYSDK_OFFSET(0x184F7D50)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ADDNOTIFYINCOMINGPACKETQUEUEFULL_OFFSET UNITYSDK_OFFSET(0x184F7EB0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ADDNOTIFYPEERCONNECTIONCLOSED_OFFSET UNITYSDK_OFFSET(0x184F8130)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ADDNOTIFYPEERCONNECTIONESTABLISHED_OFFSET UNITYSDK_OFFSET(0x184F8310)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ADDNOTIFYPEERCONNECTIONREQUEST_OFFSET UNITYSDK_OFFSET(0x184F84F0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_CLEARPACKETQUEUE_OFFSET UNITYSDK_OFFSET(0x184F86D0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_CLOSECONNECTIONS_OFFSET UNITYSDK_OFFSET(0x184F8990)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_CLOSECONNECTION_OFFSET UNITYSDK_OFFSET(0x184F8830)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_GETNATTYPE_OFFSET UNITYSDK_OFFSET(0x184F8AF0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_GETNEXTRECEIVEDPACKETSIZE_OFFSET UNITYSDK_OFFSET(0x184F8D00)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_GETPACKETQUEUEINFO_OFFSET UNITYSDK_OFFSET(0x184F8E70)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_GETPORTRANGE_OFFSET UNITYSDK_OFFSET(0x184F9180)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_GETRELAYCONTROL_OFFSET UNITYSDK_OFFSET(0x184F93A0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ONINCOMINGCONNECTIONREQUESTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x184F7A60)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ONINCOMINGPACKETQUEUEFULLCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x184F7AF0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ONPEERCONNECTIONESTABLISHEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x184F7B80)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ONQUERYNATTYPECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x184F7C10)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_ONREMOTECONNECTIONCLOSEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x184F7CA0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_QUERYNATTYPE_OFFSET UNITYSDK_OFFSET(0x184F95B0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_RECEIVEPACKET_OFFSET UNITYSDK_OFFSET(0x184F9820)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_REMOVENOTIFYINCOMINGPACKETQUEUEFULL_OFFSET UNITYSDK_OFFSET(0x184F9C50)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_REMOVENOTIFYPEERCONNECTIONCLOSED_OFFSET UNITYSDK_OFFSET(0x184F9D30)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_REMOVENOTIFYPEERCONNECTIONESTABLISHED_OFFSET UNITYSDK_OFFSET(0x184F9E10)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_REMOVENOTIFYPEERCONNECTIONREQUEST_OFFSET UNITYSDK_OFFSET(0x184F9EF0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_SENDPACKET_OFFSET UNITYSDK_OFFSET(0x184F9FD0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_SETPACKETQUEUESIZE_OFFSET UNITYSDK_OFFSET(0x184FA130)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_SETPORTRANGE_OFFSET UNITYSDK_OFFSET(0x184FA290)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE_SETRELAYCONTROL_OFFSET UNITYSDK_OFFSET(0x184FA3F0)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x184F7D40)
#define EPIC_ONLINESERVICES_P2P_P2PINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x184F7D30)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int P2PInterface_TypeDefinitionIndex = 33425;
