...
#define EPIC_ONLINESERVICES_P2P_CLEARPACKETQUEUEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7CF6E0)
#define EPIC_ONLINESERVICES_P2P_CLEARPACKETQUEUEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7CF670)
#define EPIC_ONLINESERVICES_P2P_CLEARPACKETQUEUEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x7CF3F0)
#define EPIC_ONLINESERVICES_P2P_CLEARPACKETQUEUEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7CF660)
#define EPIC_ONLINESERVICES_P2P_CLEARPACKETQUEUEOPTIONSINTERNAL_SET_REMOTEUSERID_OFFSET UNITYSDK_OFFSET(0x7CF4B0)
#define EPIC_ONLINESERVICES_P2P_CLEARPACKETQUEUEOPTIONSINTERNAL_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x7CF570)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int ClearPacketQueueOptionsInternal_TypeDefinitionIndex = 33387;
