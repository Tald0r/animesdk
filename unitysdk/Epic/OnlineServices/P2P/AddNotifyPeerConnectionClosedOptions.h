...
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONCLOSEDOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19FC8600)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONCLOSEDOPTIONS_GET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x19FC8620)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONCLOSEDOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19FC8610)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONCLOSEDOPTIONS_SET_SOCKETID_OFFSET UNITYSDK_OFFSET(0x19FC8630)
#define EPIC_ONLINESERVICES_P2P_ADDNOTIFYPEERCONNECTIONCLOSEDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19FC8640)

namespace Epic::OnlineServices::P2P
{
	inline static constexpr unsigned int AddNotifyPeerConnectionClosedOptions_TypeDefinitionIndex = 33380;
