...
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8850E0)
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x884EC0)
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x884B70)
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x884CF0)
#define EPIC_ONLINESERVICES_PRESENCE_GETJOININFOOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x884C30)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int GetJoinInfoOptionsInternal_TypeDefinitionIndex = 33270;
