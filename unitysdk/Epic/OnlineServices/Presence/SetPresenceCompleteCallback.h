...
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A6F2D0)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A6F300)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A6EDD0)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A6EDC0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int SetPresenceCompleteCallback_TypeDefinitionIndex = 32351;
