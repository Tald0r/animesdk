...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONS_GET_RECORDS_OFFSET UNITYSDK_OFFSET(0x19572D60)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONS_SET_RECORDS_OFFSET UNITYSDK_OFFSET(0x19572D70)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19572D80)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetDataOptions_TypeDefinitionIndex = 33291;
