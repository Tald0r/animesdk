...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONS_GET_RECORDS_OFFSET UNITYSDK_OFFSET(0x19C80B90)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONS_SET_RECORDS_OFFSET UNITYSDK_OFFSET(0x19C80BA0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONDELETEDATAOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C80BB0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationDeleteDataOptions_TypeDefinitionIndex = 33289;
