...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONS_GET_JOININFO_OFFSET UNITYSDK_OFFSET(0x18E13420)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONS_SET_JOININFO_OFFSET UNITYSDK_OFFSET(0x18E13430)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18E13440)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetJoinInfoOptions_TypeDefinitionIndex = 32339;
