...
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x870BA0)
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x870B30)
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8709A0)
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x870B20)
#define EPIC_ONLINESERVICES_PRESENCE_HASPRESENCEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x870A60)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int HasPresenceOptionsInternal_TypeDefinitionIndex = 32318;
