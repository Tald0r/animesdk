...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION_DELETEDATA_OFFSET UNITYSDK_OFFSET(0x19533220)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION_RELEASE_OFFSET UNITYSDK_OFFSET(0x19533380)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION_SETDATA_OFFSET UNITYSDK_OFFSET(0x19533400)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION_SETJOININFO_OFFSET UNITYSDK_OFFSET(0x19533560)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION_SETRAWRICHTEXT_OFFSET UNITYSDK_OFFSET(0x19533760)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION_SETSTATUS_OFFSET UNITYSDK_OFFSET(0x19533960)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19533210)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19533200)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModification_TypeDefinitionIndex = 33286;
