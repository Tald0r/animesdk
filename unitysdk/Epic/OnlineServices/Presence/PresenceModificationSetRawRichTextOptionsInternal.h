...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8AC9D0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8AC8B0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8AC7E0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETRAWRICHTEXTOPTIONSINTERNAL_SET_RICHTEXT_OFFSET UNITYSDK_OFFSET(0x8AC730)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetRawRichTextOptionsInternal_TypeDefinitionIndex = 33296;
