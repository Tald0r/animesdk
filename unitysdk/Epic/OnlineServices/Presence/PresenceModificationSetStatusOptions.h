...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONS_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x190FD5B0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONS_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x190FD5C0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x190FD5D0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetStatusOptions_TypeDefinitionIndex = 33297;
