...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x877720)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x877600)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONSINTERNAL_SET_JOININFO_OFFSET UNITYSDK_OFFSET(0x877480)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETJOININFOOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x877530)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetJoinInfoOptionsInternal_TypeDefinitionIndex = 32340;
