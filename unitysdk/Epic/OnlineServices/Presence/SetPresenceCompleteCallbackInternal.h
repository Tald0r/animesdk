...
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19534230)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19534280)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19533F40)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCECOMPLETECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19533F20)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int SetPresenceCompleteCallbackInternal_TypeDefinitionIndex = 33306;
