...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x895D90)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7A4F30)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETSTATUSOPTIONSINTERNAL_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x2D38F0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetStatusOptionsInternal_TypeDefinitionIndex = 32344;
