...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89D6D0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x89D6C0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x89D630)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONSINTERNAL_SET_RECORDS_OFFSET UNITYSDK_OFFSET(0x89D5C0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetDataOptionsInternal_TypeDefinitionIndex = 33292;
