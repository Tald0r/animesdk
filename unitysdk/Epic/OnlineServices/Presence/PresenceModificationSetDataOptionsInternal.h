...
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x895CE0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x895CD0)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x895C40)
#define EPIC_ONLINESERVICES_PRESENCE_PRESENCEMODIFICATIONSETDATAOPTIONSINTERNAL_SET_RECORDS_OFFSET UNITYSDK_OFFSET(0x895BD0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int PresenceModificationSetDataOptionsInternal_TypeDefinitionIndex = 32338;
