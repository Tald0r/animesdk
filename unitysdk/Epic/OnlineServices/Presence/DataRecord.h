...
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD_GET_KEY_OFFSET UNITYSDK_OFFSET(0x175B6310)
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x175B6330)
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD_SET_1_OFFSET UNITYSDK_OFFSET(0x175B65D0)
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD_SET_KEY_OFFSET UNITYSDK_OFFSET(0x175B6320)
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD_SET_OFFSET UNITYSDK_OFFSET(0x175B6350)
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x175B6340)
#define EPIC_ONLINESERVICES_PRESENCE_DATARECORD__CTOR_OFFSET UNITYSDK_OFFSET(0x175B68F0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int DataRecord_TypeDefinitionIndex = 33267;
