...
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FF1E0)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8FF170)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8FEFE0)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8FF160)
#define EPIC_ONLINESERVICES_PRESENCE_SETPRESENCEOPTIONSINTERNAL_SET_PRESENCEMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x8FF0A0)

namespace Epic::OnlineServices::Presence
{
	inline static constexpr unsigned int SetPresenceOptionsInternal_TypeDefinitionIndex = 33308;
