...
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x272280)
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x886A80)
#define EPIC_ONLINESERVICES_REPORTS_SENDPLAYERBEHAVIORREPORTCOMPLETECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)

namespace Epic::OnlineServices::Reports
{
	inline static constexpr unsigned int SendPlayerBehaviorReportCompleteCallbackInfoInternal_TypeDefinitionIndex = 33097;
