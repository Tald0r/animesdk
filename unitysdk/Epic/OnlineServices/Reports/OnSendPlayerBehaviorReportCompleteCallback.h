...
#define EPIC_ONLINESERVICES_REPORTS_ONSENDPLAYERBEHAVIORREPORTCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190C6500)
#define EPIC_ONLINESERVICES_REPORTS_ONSENDPLAYERBEHAVIORREPORTCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190C6530)
#define EPIC_ONLINESERVICES_REPORTS_ONSENDPLAYERBEHAVIORREPORTCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x190C6000)
#define EPIC_ONLINESERVICES_REPORTS_ONSENDPLAYERBEHAVIORREPORTCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x190C5FF0)

namespace Epic::OnlineServices::Reports
{
	inline static constexpr unsigned int OnSendPlayerBehaviorReportCompleteCallback_TypeDefinitionIndex = 32138;
