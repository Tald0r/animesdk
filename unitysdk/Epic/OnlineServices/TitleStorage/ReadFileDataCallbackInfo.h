...
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x19A8C710)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x19A8C650)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GET_DATACHUNK_OFFSET UNITYSDK_OFFSET(0x19A8C6F0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x19A8C690)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GET_ISLASTCHUNK_OFFSET UNITYSDK_OFFSET(0x19A8C6D0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19A8C670)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GET_TOTALFILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x19A8C6B0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x19A8CC60)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x19A8C660)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_DATACHUNK_OFFSET UNITYSDK_OFFSET(0x19A8C700)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x19A8C6A0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_ISLASTCHUNK_OFFSET UNITYSDK_OFFSET(0x19A8C6E0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19A8C680)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x19A8C720)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_TOTALFILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x19A8C6C0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19A8CDB0)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int ReadFileDataCallbackInfo_TypeDefinitionIndex = 31925;
