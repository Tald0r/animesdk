...
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x19FCE570)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x19FCE4B0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GET_DATACHUNK_OFFSET UNITYSDK_OFFSET(0x19FCE550)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x19FCE4F0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GET_ISLASTCHUNK_OFFSET UNITYSDK_OFFSET(0x19FCE530)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19FCE4D0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_GET_TOTALFILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x19FCE510)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x19FCEAC0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x19FCE4C0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_DATACHUNK_OFFSET UNITYSDK_OFFSET(0x19FCE560)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x19FCE500)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_ISLASTCHUNK_OFFSET UNITYSDK_OFFSET(0x19FCE540)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19FCE4E0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x19FCE580)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO_SET_TOTALFILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x19FCE520)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILEDATACALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19FCEC10)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int ReadFileDataCallbackInfo_TypeDefinitionIndex = 32879;
