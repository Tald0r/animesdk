...
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONS_GET_LISTOFTAGS_OFFSET UNITYSDK_OFFSET(0x196024C0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x196024A0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONS_SET_LISTOFTAGS_OFFSET UNITYSDK_OFFSET(0x196024D0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x196024B0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x196024E0)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int QueryFileListOptions_TypeDefinitionIndex = 31919;
