...
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILECALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x1A079F00)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILECALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1A079EA0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILECALLBACKINFO_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1A079EE0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILECALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1A079EC0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILECALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1A079E80)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILECALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1A07A1E0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILECALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1A079EB0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILECALLBACKINFO_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1A079EF0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILECALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1A079ED0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILECALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x1A079F20)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILECALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1A079E90)
#define EPIC_ONLINESERVICES_TITLESTORAGE_READFILECALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A07A320)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int ReadFileCallbackInfo_TypeDefinitionIndex = 32877;
