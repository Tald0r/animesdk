...
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A5FD0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8A5F60)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILEOPTIONSINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x8A5EA0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8A5DE0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8A5F50)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int QueryFileOptionsInternal_TypeDefinitionIndex = 32876;
