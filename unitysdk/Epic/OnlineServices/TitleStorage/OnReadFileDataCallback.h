...
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190C8B50)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190C8B80)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x190C8610)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x190C8600)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int OnReadFileDataCallback_TypeDefinitionIndex = 31913;
