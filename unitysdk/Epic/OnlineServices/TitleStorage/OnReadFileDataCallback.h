...
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x195380F0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19538120)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19537BB0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_ONREADFILEDATACALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19537B90)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int OnReadFileDataCallback_TypeDefinitionIndex = 32867;
