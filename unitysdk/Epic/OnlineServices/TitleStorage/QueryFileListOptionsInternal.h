...
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8CF000)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8CEF90)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONSINTERNAL_SET_LISTOFTAGS_OFFSET UNITYSDK_OFFSET(0x8CEF10)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8CEE50)
#define EPIC_ONLINESERVICES_TITLESTORAGE_QUERYFILELISTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8CEF80)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int QueryFileListOptionsInternal_TypeDefinitionIndex = 31920;
