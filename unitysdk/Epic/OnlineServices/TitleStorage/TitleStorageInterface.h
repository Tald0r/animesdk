...
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_COPYFILEMETADATAATINDEX_OFFSET UNITYSDK_OFFSET(0x18F330F0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_COPYFILEMETADATABYFILENAME_OFFSET UNITYSDK_OFFSET(0x18F333A0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_DELETECACHE_OFFSET UNITYSDK_OFFSET(0x18F335A0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_GETFILEMETADATACOUNT_OFFSET UNITYSDK_OFFSET(0x18F33800)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_ONDELETECACHECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18F32CE0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_ONFILETRANSFERPROGRESSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18F32D70)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_ONQUERYFILECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18F32E40)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_ONQUERYFILELISTCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18F32ED0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_ONREADFILECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18F32F60)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_ONREADFILEDATACALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18F32FF0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_QUERYFILELIST_OFFSET UNITYSDK_OFFSET(0x18F33BC0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_QUERYFILE_OFFSET UNITYSDK_OFFSET(0x18F33A00)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_READFILE_OFFSET UNITYSDK_OFFSET(0x18F33D80)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18F330E0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x18F330D0)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int TitleStorageInterface_TypeDefinitionIndex = 31931;
