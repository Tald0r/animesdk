...
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_COPYFILEMETADATAATINDEX_OFFSET UNITYSDK_OFFSET(0x1927B390)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_COPYFILEMETADATABYFILENAME_OFFSET UNITYSDK_OFFSET(0x1927B640)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_DELETECACHE_OFFSET UNITYSDK_OFFSET(0x1927B840)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_GETFILEMETADATACOUNT_OFFSET UNITYSDK_OFFSET(0x1927BAA0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_ONDELETECACHECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1927AF80)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_ONFILETRANSFERPROGRESSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1927B010)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_ONQUERYFILECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1927B0E0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_ONQUERYFILELISTCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1927B170)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_ONREADFILECOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1927B200)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_ONREADFILEDATACALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x1927B290)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_QUERYFILELIST_OFFSET UNITYSDK_OFFSET(0x1927BE60)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_QUERYFILE_OFFSET UNITYSDK_OFFSET(0x1927BCA0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE_READFILE_OFFSET UNITYSDK_OFFSET(0x1927C020)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1927B380)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1927B370)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int TitleStorageInterface_TypeDefinitionIndex = 32885;
