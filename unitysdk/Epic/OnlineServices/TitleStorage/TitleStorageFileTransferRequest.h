...
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST_CANCELREQUEST_OFFSET UNITYSDK_OFFSET(0x19403390)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST_GETFILENAME_OFFSET UNITYSDK_OFFSET(0x19403490)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST_GETFILEREQUESTSTATE_OFFSET UNITYSDK_OFFSET(0x19403410)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST_RELEASE_OFFSET UNITYSDK_OFFSET(0x194036C0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19403380)
#define EPIC_ONLINESERVICES_TITLESTORAGE_TITLESTORAGEFILETRANSFERREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x19403370)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int TitleStorageFileTransferRequest_TypeDefinitionIndex = 32884;
