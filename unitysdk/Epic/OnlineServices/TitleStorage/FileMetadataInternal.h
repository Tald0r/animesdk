...
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8BF790)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x8BF5B0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_GET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x302230)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_GET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x8BF450)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_GET_UNENCRYPTEDDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x3186C0)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8BF720)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x8BF660)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_FILESIZEBYTES_OFFSET UNITYSDK_OFFSET(0x302120)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_MD5HASH_OFFSET UNITYSDK_OFFSET(0x8BF500)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8BF710)
#define EPIC_ONLINESERVICES_TITLESTORAGE_FILEMETADATAINTERNAL_SET_UNENCRYPTEDDATASIZEBYTES_OFFSET UNITYSDK_OFFSET(0x318710)

namespace Epic::OnlineServices::TitleStorage
{
	inline static constexpr unsigned int FileMetadataInternal_TypeDefinitionIndex = 32852;
