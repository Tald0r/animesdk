...
#define EPIC_ONLINESERVICES_ALLOCATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x192099F0)

namespace Epic::OnlineServices
{
	inline static constexpr unsigned int AllocationException_TypeDefinitionIndex = 32745;
