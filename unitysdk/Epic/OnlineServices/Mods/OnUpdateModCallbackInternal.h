...
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190BE550)
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190BE5A0)
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x190BE250)
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x190BD990)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnUpdateModCallbackInternal_TypeDefinitionIndex = 32513;
