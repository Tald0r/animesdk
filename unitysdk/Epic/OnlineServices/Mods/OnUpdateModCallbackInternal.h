...
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1952DAB0)
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1952DB00)
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1952D7C0)
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1952CEF0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnUpdateModCallbackInternal_TypeDefinitionIndex = 33467;
