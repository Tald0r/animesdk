...
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x184F75B0)
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONS_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x184F75D0)
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x184F75C0)
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONS_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x184F75E0)
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x184F75F0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int CopyModInfoOptions_TypeDefinitionIndex = 33444;
