...
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x17EDECD0)
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONS_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x17EDECF0)
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x17EDECE0)
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONS_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x17EDED00)
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x17EDED10)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int CopyModInfoOptions_TypeDefinitionIndex = 32490;
