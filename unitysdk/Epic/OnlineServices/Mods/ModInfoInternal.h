...
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x88B280)
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_GET_MODS_OFFSET UNITYSDK_OFFSET(0x88B100)
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x302AD0)
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x88B270)
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_SET_MODS_OFFSET UNITYSDK_OFFSET(0x88B170)
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x88B1E0)
#define EPIC_ONLINESERVICES_MODS_MODINFOINTERNAL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x302AE0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int ModInfoInternal_TypeDefinitionIndex = 33458;
