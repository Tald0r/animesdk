...
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x87CA00)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x87C990)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_MOD_OFFSET UNITYSDK_OFFSET(0x87CB10)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int InstallModCallbackInfoInternal_TypeDefinitionIndex = 33451;
