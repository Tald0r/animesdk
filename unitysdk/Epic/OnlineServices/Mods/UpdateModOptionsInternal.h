...
#define EPIC_ONLINESERVICES_MODS_UPDATEMODOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x883FD0)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x883FC0)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x883D20)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODOPTIONSINTERNAL_SET_MOD_OFFSET UNITYSDK_OFFSET(0x883DE0)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x883E50)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int UpdateModOptionsInternal_TypeDefinitionIndex = 33475;
