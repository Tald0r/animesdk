...
#define EPIC_ONLINESERVICES_MODS_UPDATEMODOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x855CE0)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x855CD0)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x855A30)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODOPTIONSINTERNAL_SET_MOD_OFFSET UNITYSDK_OFFSET(0x855AF0)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x855B60)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int UpdateModOptionsInternal_TypeDefinitionIndex = 32521;
