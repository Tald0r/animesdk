...
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190DEBD0)
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190DEC20)
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x190DE8D0)
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x190DE8C0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnUninstallModCallbackInternal_TypeDefinitionIndex = 32511;
