...
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1956DA70)
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1956DAC0)
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1956D780)
#define EPIC_ONLINESERVICES_MODS_ONUNINSTALLMODCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1956D760)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnUninstallModCallbackInternal_TypeDefinitionIndex = 33465;
