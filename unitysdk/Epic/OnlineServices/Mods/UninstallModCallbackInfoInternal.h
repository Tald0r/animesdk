...
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8BAD00)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8BAC90)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_MOD_OFFSET UNITYSDK_OFFSET(0x8BAE10)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int UninstallModCallbackInfoInternal_TypeDefinitionIndex = 32515;
