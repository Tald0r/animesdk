...
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D90D0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D9060)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8D8E70)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_MOD_OFFSET UNITYSDK_OFFSET(0x8D8F30)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D9050)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_REMOVEAFTEREXIT_OFFSET UNITYSDK_OFFSET(0x8D8FA0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int InstallModOptionsInternal_TypeDefinitionIndex = 32499;
