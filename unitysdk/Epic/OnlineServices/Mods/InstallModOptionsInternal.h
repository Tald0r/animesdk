...
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x904A40)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9049D0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x9047E0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_MOD_OFFSET UNITYSDK_OFFSET(0x9048A0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9049C0)
#define EPIC_ONLINESERVICES_MODS_INSTALLMODOPTIONSINTERNAL_SET_REMOVEAFTEREXIT_OFFSET UNITYSDK_OFFSET(0x904910)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int InstallModOptionsInternal_TypeDefinitionIndex = 33453;
