...
#define EPIC_ONLINESERVICES_MODS_MODSINTERFACE_COPYMODINFO_OFFSET UNITYSDK_OFFSET(0x190BCE50)
#define EPIC_ONLINESERVICES_MODS_MODSINTERFACE_ENUMERATEMODS_OFFSET UNITYSDK_OFFSET(0x190BD100)
#define EPIC_ONLINESERVICES_MODS_MODSINTERFACE_INSTALLMOD_OFFSET UNITYSDK_OFFSET(0x190BD380)
#define EPIC_ONLINESERVICES_MODS_MODSINTERFACE_ONENUMERATEMODSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x190BCBF0)
#define EPIC_ONLINESERVICES_MODS_MODSINTERFACE_ONINSTALLMODCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x190BCC80)
#define EPIC_ONLINESERVICES_MODS_MODSINTERFACE_ONUNINSTALLMODCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x190BCD10)
#define EPIC_ONLINESERVICES_MODS_MODSINTERFACE_ONUPDATEMODCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x190BCDA0)
#define EPIC_ONLINESERVICES_MODS_MODSINTERFACE_UNINSTALLMOD_OFFSET UNITYSDK_OFFSET(0x190BD550)
#define EPIC_ONLINESERVICES_MODS_MODSINTERFACE_UPDATEMOD_OFFSET UNITYSDK_OFFSET(0x190BD710)
#define EPIC_ONLINESERVICES_MODS_MODSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x190BCE40)
#define EPIC_ONLINESERVICES_MODS_MODSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x190BCE30)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int ModsInterface_TypeDefinitionIndex = 32505;
