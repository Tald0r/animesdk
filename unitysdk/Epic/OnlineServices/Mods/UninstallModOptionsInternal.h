...
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8689B0)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x868940)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x868800)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODOPTIONSINTERNAL_SET_MOD_OFFSET UNITYSDK_OFFSET(0x8688C0)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x868930)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int UninstallModOptionsInternal_TypeDefinitionIndex = 33471;
