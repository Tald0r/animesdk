...
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x83DC00)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x83DB90)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x83DA50)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODOPTIONSINTERNAL_SET_MOD_OFFSET UNITYSDK_OFFSET(0x83DB10)
#define EPIC_ONLINESERVICES_MODS_UNINSTALLMODOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x83DB80)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int UninstallModOptionsInternal_TypeDefinitionIndex = 32517;
