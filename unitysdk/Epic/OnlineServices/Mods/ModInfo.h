...
#define EPIC_ONLINESERVICES_MODS_MODINFO_GET_MODS_OFFSET UNITYSDK_OFFSET(0x1952BD90)
#define EPIC_ONLINESERVICES_MODS_MODINFO_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1952BDB0)
#define EPIC_ONLINESERVICES_MODS_MODINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1952BF30)
#define EPIC_ONLINESERVICES_MODS_MODINFO_SET_MODS_OFFSET UNITYSDK_OFFSET(0x1952BDA0)
#define EPIC_ONLINESERVICES_MODS_MODINFO_SET_OFFSET UNITYSDK_OFFSET(0x1952BDD0)
#define EPIC_ONLINESERVICES_MODS_MODINFO_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1952BDC0)
#define EPIC_ONLINESERVICES_MODS_MODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1952C130)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int ModInfo_TypeDefinitionIndex = 33457;
