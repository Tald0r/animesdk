...
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8A39F0)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8A3980)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_MOD_OFFSET UNITYSDK_OFFSET(0x8A3B00)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int UpdateModCallbackInfoInternal_TypeDefinitionIndex = 33473;
