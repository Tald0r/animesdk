...
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x86EF50)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x86EEE0)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_MOD_OFFSET UNITYSDK_OFFSET(0x86F060)
#define EPIC_ONLINESERVICES_MODS_UPDATEMODCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int UpdateModCallbackInfoInternal_TypeDefinitionIndex = 32519;
