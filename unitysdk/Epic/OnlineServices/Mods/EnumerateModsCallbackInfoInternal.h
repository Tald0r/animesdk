...
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x83D940)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x83D8D0)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define EPIC_ONLINESERVICES_MODS_ENUMERATEMODSCALLBACKINFOINTERNAL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x359050)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int EnumerateModsCallbackInfoInternal_TypeDefinitionIndex = 32493;
