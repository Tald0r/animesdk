...
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190BE210)
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190BE240)
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x190BD9A0)
#define EPIC_ONLINESERVICES_MODS_ONUPDATEMODCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x190BE200)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnUpdateModCallback_TypeDefinitionIndex = 32512;
