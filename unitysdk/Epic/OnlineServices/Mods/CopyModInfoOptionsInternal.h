...
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x791BA0)
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x791B90)
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x7919F0)
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x791AB0)
#define EPIC_ONLINESERVICES_MODS_COPYMODINFOOPTIONSINTERNAL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x3197D0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int CopyModInfoOptionsInternal_TypeDefinitionIndex = 32491;
