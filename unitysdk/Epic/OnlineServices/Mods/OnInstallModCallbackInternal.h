...
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1952D700)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1952D750)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1952D410)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1952CA90)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnInstallModCallbackInternal_TypeDefinitionIndex = 33463;
