...
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190BE1A0)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190BE1F0)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x190BDEA0)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x190BD540)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnInstallModCallbackInternal_TypeDefinitionIndex = 32509;
