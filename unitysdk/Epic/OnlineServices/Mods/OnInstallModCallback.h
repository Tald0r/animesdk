...
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D4D4F0)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D4D520)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D4CFF0)
#define EPIC_ONLINESERVICES_MODS_ONINSTALLMODCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19D4CFD0)

namespace Epic::OnlineServices::Mods
{
	inline static constexpr unsigned int OnInstallModCallback_TypeDefinitionIndex = 33462;
