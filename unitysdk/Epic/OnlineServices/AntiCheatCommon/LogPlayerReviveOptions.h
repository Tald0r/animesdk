...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_GET_REVIVEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x19AE3810)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_GET_REVIVERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x19AE3830)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_SET_REVIVEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x19AE3820)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS_SET_REVIVERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x19AE3840)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE3850)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerReviveOptions_TypeDefinitionIndex = 33211;
