...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONS_GET_DESPAWNEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x19767D70)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONS_SET_DESPAWNEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x19767D80)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19767D90)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerDespawnOptions_TypeDefinitionIndex = 33209;
