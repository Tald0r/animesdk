...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONS_GET_DESPAWNEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x19D3E550)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONS_SET_DESPAWNEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x19D3E560)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19D3E570)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerDespawnOptions_TypeDefinitionIndex = 34163;
