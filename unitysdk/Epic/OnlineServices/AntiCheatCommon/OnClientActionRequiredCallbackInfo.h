...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x18F1D770)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_GET_ACTIONREASONCODE_OFFSET UNITYSDK_OFFSET(0x18F1D730)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_GET_ACTIONREASONDETAILSSTRING_OFFSET UNITYSDK_OFFSET(0x18F1D750)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_GET_CLIENTACTION_OFFSET UNITYSDK_OFFSET(0x18F1D710)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x18F1D6D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_GET_CLIENTHANDLE_OFFSET UNITYSDK_OFFSET(0x18F1D6F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x18F1DA60)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_SET_ACTIONREASONCODE_OFFSET UNITYSDK_OFFSET(0x18F1D740)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_SET_ACTIONREASONDETAILSSTRING_OFFSET UNITYSDK_OFFSET(0x18F1D760)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_SET_CLIENTACTION_OFFSET UNITYSDK_OFFSET(0x18F1D720)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x18F1D6E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_SET_CLIENTHANDLE_OFFSET UNITYSDK_OFFSET(0x18F1D700)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x18F1D780)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_ONCLIENTACTIONREQUIREDCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18F1DBA0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int OnClientActionRequiredCallbackInfo_TypeDefinitionIndex = 33225;
