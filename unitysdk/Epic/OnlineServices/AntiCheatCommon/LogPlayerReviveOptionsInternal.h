...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7E1CC0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7E1C40)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7E1C20)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONSINTERNAL_SET_REVIVEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x302310)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONSINTERNAL_SET_REVIVERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x3123A0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerReviveOptionsInternal_TypeDefinitionIndex = 34166;
