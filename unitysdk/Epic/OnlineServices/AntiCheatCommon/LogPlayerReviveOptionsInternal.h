...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7A5EA0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7A5E20)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7A5E00)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONSINTERNAL_SET_REVIVEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x2CB170)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERREVIVEOPTIONSINTERNAL_SET_REVIVERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x2D26A0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerReviveOptionsInternal_TypeDefinitionIndex = 33212;
