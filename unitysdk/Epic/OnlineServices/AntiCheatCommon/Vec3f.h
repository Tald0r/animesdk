...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_GET_X_OFFSET UNITYSDK_OFFSET(0x18F1E0B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_GET_Y_OFFSET UNITYSDK_OFFSET(0x18F1E0D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_GET_Z_OFFSET UNITYSDK_OFFSET(0x18F1E0F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_SET_1_OFFSET UNITYSDK_OFFSET(0x18F1E1F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_SET_OFFSET UNITYSDK_OFFSET(0x18F1E110)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_SET_X_OFFSET UNITYSDK_OFFSET(0x18F1E0C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_SET_Y_OFFSET UNITYSDK_OFFSET(0x18F1E0E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_SET_Z_OFFSET UNITYSDK_OFFSET(0x18F1E100)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F__CTOR_OFFSET UNITYSDK_OFFSET(0x18F1E350)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int Vec3f_TypeDefinitionIndex = 33241;
