...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_GET_X_OFFSET UNITYSDK_OFFSET(0x192662E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_GET_Y_OFFSET UNITYSDK_OFFSET(0x19266300)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_GET_Z_OFFSET UNITYSDK_OFFSET(0x19266320)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_SET_1_OFFSET UNITYSDK_OFFSET(0x19266420)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_SET_OFFSET UNITYSDK_OFFSET(0x19266340)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_SET_X_OFFSET UNITYSDK_OFFSET(0x192662F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_SET_Y_OFFSET UNITYSDK_OFFSET(0x19266310)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F_SET_Z_OFFSET UNITYSDK_OFFSET(0x19266330)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_VEC3F__CTOR_OFFSET UNITYSDK_OFFSET(0x19266580)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int Vec3f_TypeDefinitionIndex = 34195;
