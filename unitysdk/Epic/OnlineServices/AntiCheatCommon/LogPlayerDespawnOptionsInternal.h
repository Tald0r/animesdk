...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B8560)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8B84F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONSINTERNAL_SET_DESPAWNEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x2CB170)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7917A0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerDespawnOptionsInternal_TypeDefinitionIndex = 33210;
