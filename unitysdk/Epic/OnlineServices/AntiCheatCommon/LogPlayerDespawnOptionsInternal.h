...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D7360)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D72F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONSINTERNAL_SET_DESPAWNEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x302310)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERDESPAWNOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7CEBE0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerDespawnOptionsInternal_TypeDefinitionIndex = 34164;
