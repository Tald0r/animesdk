...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETGAMESESSIONIDOPTIONS_GET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x193F0240)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETGAMESESSIONIDOPTIONS_SET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x193F0250)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETGAMESESSIONIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x193F0260)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int SetGameSessionIdOptions_TypeDefinitionIndex = 34193;
