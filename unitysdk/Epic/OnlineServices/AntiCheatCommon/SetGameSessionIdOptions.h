...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETGAMESESSIONIDOPTIONS_GET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x195EF450)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETGAMESESSIONIDOPTIONS_SET_GAMESESSIONID_OFFSET UNITYSDK_OFFSET(0x195EF460)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_SETGAMESESSIONIDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x195EF470)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int SetGameSessionIdOptions_TypeDefinitionIndex = 33239;
