...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B8B30)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8B8AB0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_ABILITYCOOLDOWNMS_OFFSET UNITYSDK_OFFSET(0x318710)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_ABILITYDURATIONMS_OFFSET UNITYSDK_OFFSET(0x338540)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_ABILITYID_OFFSET UNITYSDK_OFFSET(0x302AE0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B8A80)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEABILITYOPTIONSINTERNAL_SET_PLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x302310)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerUseAbilityOptionsInternal_TypeDefinitionIndex = 34174;
