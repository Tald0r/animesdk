...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_GET_ISMELEEATTACK_OFFSET UNITYSDK_OFFSET(0x19AE3A60)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_GET_ISPLAYERVIEWZOOMED_OFFSET UNITYSDK_OFFSET(0x19AE3A40)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_GET_PLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x19AE39E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_GET_PLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x19AE3A00)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_GET_PLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x19AE3A20)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_GET_WEAPONNAME_OFFSET UNITYSDK_OFFSET(0x19AE3A80)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_1_OFFSET UNITYSDK_OFFSET(0x19AE3FF0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_ISMELEEATTACK_OFFSET UNITYSDK_OFFSET(0x19AE3A70)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_ISPLAYERVIEWZOOMED_OFFSET UNITYSDK_OFFSET(0x19AE3A50)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_OFFSET UNITYSDK_OFFSET(0x19AE3AA0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_PLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x19AE39F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_PLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x19AE3A10)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_PLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x19AE3A30)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_WEAPONNAME_OFFSET UNITYSDK_OFFSET(0x19AE3A90)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE4130)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerUseWeaponData_TypeDefinitionIndex = 33221;
