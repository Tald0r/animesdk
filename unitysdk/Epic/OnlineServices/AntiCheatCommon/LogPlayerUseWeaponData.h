...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_GET_ISMELEEATTACK_OFFSET UNITYSDK_OFFSET(0x1A06C3C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_GET_ISPLAYERVIEWZOOMED_OFFSET UNITYSDK_OFFSET(0x1A06C3A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_GET_PLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1A06C340)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_GET_PLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x1A06C360)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_GET_PLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x1A06C380)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_GET_WEAPONNAME_OFFSET UNITYSDK_OFFSET(0x1A06C3E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_1_OFFSET UNITYSDK_OFFSET(0x1A06C950)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_ISMELEEATTACK_OFFSET UNITYSDK_OFFSET(0x1A06C3D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_ISPLAYERVIEWZOOMED_OFFSET UNITYSDK_OFFSET(0x1A06C3B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_OFFSET UNITYSDK_OFFSET(0x1A06C400)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_PLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x1A06C350)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_PLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x1A06C370)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_PLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x1A06C390)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA_SET_WEAPONNAME_OFFSET UNITYSDK_OFFSET(0x1A06C3F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERUSEWEAPONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A06CA90)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerUseWeaponData_TypeDefinitionIndex = 34175;
