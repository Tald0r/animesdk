...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTOPTIONS_GET_CLIENTHANDLE_OFFSET UNITYSDK_OFFSET(0x187D61C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTOPTIONS_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x187D61E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTOPTIONS_GET_PARAMS_OFFSET UNITYSDK_OFFSET(0x187D6200)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTOPTIONS_SET_CLIENTHANDLE_OFFSET UNITYSDK_OFFSET(0x187D61D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTOPTIONS_SET_EVENTID_OFFSET UNITYSDK_OFFSET(0x187D61F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTOPTIONS_SET_PARAMS_OFFSET UNITYSDK_OFFSET(0x187D6210)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGEVENTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x187D6220)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogEventOptions_TypeDefinitionIndex = 33199;
