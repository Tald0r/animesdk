...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONS_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x190F0560)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONS_GET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x190F0580)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONS_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x190F05A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONS_GET_PARAMDEFS_OFFSET UNITYSDK_OFFSET(0x190F05C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONS_SET_EVENTID_OFFSET UNITYSDK_OFFSET(0x190F0570)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONS_SET_EVENTNAME_OFFSET UNITYSDK_OFFSET(0x190F0590)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONS_SET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x190F05B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONS_SET_PARAMDEFS_OFFSET UNITYSDK_OFFSET(0x190F05D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_REGISTEREVENTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x190F05E0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int RegisterEventOptions_TypeDefinitionIndex = 34187;
