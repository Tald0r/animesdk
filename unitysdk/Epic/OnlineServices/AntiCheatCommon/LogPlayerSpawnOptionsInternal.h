...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERSPAWNOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x902C00)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERSPAWNOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x902B80)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERSPAWNOPTIONSINTERNAL_SET_CHARACTERID_OFFSET UNITYSDK_OFFSET(0x338540)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERSPAWNOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x902B50)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERSPAWNOPTIONSINTERNAL_SET_SPAWNEDPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x302310)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERSPAWNOPTIONSINTERNAL_SET_TEAMID_OFFSET UNITYSDK_OFFSET(0x302AE0)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerSpawnOptionsInternal_TypeDefinitionIndex = 34168;
