...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7E2380)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7E2310)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ATTACKERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x3186D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ATTACKERPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x7E1ED0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ATTACKERPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x7E1F40)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x7E2290)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGERESULT_OFFSET UNITYSDK_OFFSET(0x7E2200)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGESOURCE_OFFSET UNITYSDK_OFFSET(0x7E21F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGETAKEN_OFFSET UNITYSDK_OFFSET(0x7E21D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x3B26F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_HASLINEOFSIGHT_OFFSET UNITYSDK_OFFSET(0x7E2060)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_HEALTHREMAINING_OFFSET UNITYSDK_OFFSET(0x7E21E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_HITBONEID_DEPRECATED_OFFSET UNITYSDK_OFFSET(0x7E21C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ISCRITICALHIT_OFFSET UNITYSDK_OFFSET(0x7E2110)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ISHITSCANATTACK_OFFSET UNITYSDK_OFFSET(0x7E1FB0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7E2300)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_PLAYERUSEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0x7E2210)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_TIMESINCEPLAYERUSEWEAPONMS_OFFSET UNITYSDK_OFFSET(0x7E2280)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_VICTIMPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x302310)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_VICTIMPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x7E1DF0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_VICTIMPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x7E1E60)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerTakeDamageOptionsInternal_TypeDefinitionIndex = 34170;
