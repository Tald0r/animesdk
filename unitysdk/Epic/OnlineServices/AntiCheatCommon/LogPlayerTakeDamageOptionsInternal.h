...
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7A6560)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7A64F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ATTACKERPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x2FC190)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ATTACKERPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x7A60B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ATTACKERPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x7A6120)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGEPOSITION_OFFSET UNITYSDK_OFFSET(0x7A6470)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGERESULT_OFFSET UNITYSDK_OFFSET(0x7A63E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGESOURCE_OFFSET UNITYSDK_OFFSET(0x7A63D0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGETAKEN_OFFSET UNITYSDK_OFFSET(0x7A63B0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_DAMAGETYPE_OFFSET UNITYSDK_OFFSET(0x345280)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_HASLINEOFSIGHT_OFFSET UNITYSDK_OFFSET(0x7A6240)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_HEALTHREMAINING_OFFSET UNITYSDK_OFFSET(0x7A63C0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_HITBONEID_DEPRECATED_OFFSET UNITYSDK_OFFSET(0x7A63A0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ISCRITICALHIT_OFFSET UNITYSDK_OFFSET(0x7A62F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_ISHITSCANATTACK_OFFSET UNITYSDK_OFFSET(0x7A6190)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7A64E0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_PLAYERUSEWEAPONDATA_OFFSET UNITYSDK_OFFSET(0x7A63F0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_TIMESINCEPLAYERUSEWEAPONMS_OFFSET UNITYSDK_OFFSET(0x7A6460)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_VICTIMPLAYERHANDLE_OFFSET UNITYSDK_OFFSET(0x2CB170)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_VICTIMPLAYERPOSITION_OFFSET UNITYSDK_OFFSET(0x7A5FD0)
#define EPIC_ONLINESERVICES_ANTICHEATCOMMON_LOGPLAYERTAKEDAMAGEOPTIONSINTERNAL_SET_VICTIMPLAYERVIEWROTATION_OFFSET UNITYSDK_OFFSET(0x7A6040)

namespace Epic::OnlineServices::AntiCheatCommon
{
	inline static constexpr unsigned int LogPlayerTakeDamageOptionsInternal_TypeDefinitionIndex = 33216;
