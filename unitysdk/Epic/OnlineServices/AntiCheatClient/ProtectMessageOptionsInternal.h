...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x879640)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x879630)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONSINTERNAL_SET_DATA_OFFSET UNITYSDK_OFFSET(0x879540)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8795B0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONSINTERNAL_SET_OUTBUFFERSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x302AE0)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int ProtectMessageOptionsInternal_TypeDefinitionIndex = 34229;
