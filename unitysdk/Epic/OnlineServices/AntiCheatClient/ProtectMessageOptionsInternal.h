...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x84B850)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x84B840)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONSINTERNAL_SET_DATA_OFFSET UNITYSDK_OFFSET(0x84B750)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x84B7C0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_PROTECTMESSAGEOPTIONSINTERNAL_SET_OUTBUFFERSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x3197D0)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int ProtectMessageOptionsInternal_TypeDefinitionIndex = 33275;
