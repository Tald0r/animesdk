...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19AE37D0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19AE3800)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19AE32D0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOSERVERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE32C0)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int OnMessageToServerCallback_TypeDefinitionIndex = 33264;
