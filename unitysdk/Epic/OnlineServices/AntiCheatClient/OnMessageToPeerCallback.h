...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOPEERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D34FF0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOPEERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D35020)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOPEERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D34AF0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOPEERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18D34AD0)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int OnMessageToPeerCallback_TypeDefinitionIndex = 34216;
