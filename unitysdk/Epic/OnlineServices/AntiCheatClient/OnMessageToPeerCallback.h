...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOPEERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x187D6180)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOPEERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187D61B0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOPEERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x187D5C80)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONMESSAGETOPEERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x187D5C70)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int OnMessageToPeerCallback_TypeDefinitionIndex = 33262;
