...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ENDSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ENDSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x85A400)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ENDSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x78EB40)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int EndSessionOptionsInternal_TypeDefinitionIndex = 33259;
