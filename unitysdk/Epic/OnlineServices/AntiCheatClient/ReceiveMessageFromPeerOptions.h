...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMPEEROPTIONS_GET_DATA_OFFSET UNITYSDK_OFFSET(0x19D3E160)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMPEEROPTIONS_GET_PEERHANDLE_OFFSET UNITYSDK_OFFSET(0x19D3E140)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMPEEROPTIONS_SET_DATA_OFFSET UNITYSDK_OFFSET(0x19D3E170)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMPEEROPTIONS_SET_PEERHANDLE_OFFSET UNITYSDK_OFFSET(0x19D3E150)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMPEEROPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19D3E180)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int ReceiveMessageFromPeerOptions_TypeDefinitionIndex = 34230;
