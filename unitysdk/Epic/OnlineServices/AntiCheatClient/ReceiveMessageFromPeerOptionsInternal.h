...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMPEEROPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8AA280)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMPEEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8AA270)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMPEEROPTIONSINTERNAL_SET_DATA_OFFSET UNITYSDK_OFFSET(0x8AA170)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMPEEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8AA1E0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMPEEROPTIONSINTERNAL_SET_PEERHANDLE_OFFSET UNITYSDK_OFFSET(0x2CB170)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int ReceiveMessageFromPeerOptionsInternal_TypeDefinitionIndex = 33277;
