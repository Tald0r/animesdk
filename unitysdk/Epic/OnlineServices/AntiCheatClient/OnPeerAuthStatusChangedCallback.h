...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONPEERAUTHSTATUSCHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1983B5D0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONPEERAUTHSTATUSCHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1983B600)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONPEERAUTHSTATUSCHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1983B0D0)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONPEERAUTHSTATUSCHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1983B0C0)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int OnPeerAuthStatusChangedCallback_TypeDefinitionIndex = 33270;
