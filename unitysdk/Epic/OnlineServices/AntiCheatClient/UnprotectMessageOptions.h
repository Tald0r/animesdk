...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_UNPROTECTMESSAGEOPTIONS_GET_DATA_OFFSET UNITYSDK_OFFSET(0x19A7E430)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_UNPROTECTMESSAGEOPTIONS_GET_OUTBUFFERSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x19A7E450)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_UNPROTECTMESSAGEOPTIONS_SET_DATA_OFFSET UNITYSDK_OFFSET(0x19A7E440)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_UNPROTECTMESSAGEOPTIONS_SET_OUTBUFFERSIZEBYTES_OFFSET UNITYSDK_OFFSET(0x19A7E460)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_UNPROTECTMESSAGEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7E470)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int UnprotectMessageOptions_TypeDefinitionIndex = 33282;
