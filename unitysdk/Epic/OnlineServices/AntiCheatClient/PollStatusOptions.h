...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONS_GET_OUTMESSAGELENGTH_OFFSET UNITYSDK_OFFSET(0x199ACE10)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONS_SET_OUTMESSAGELENGTH_OFFSET UNITYSDK_OFFSET(0x199ACE20)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_POLLSTATUSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x199ACE30)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int PollStatusOptions_TypeDefinitionIndex = 34226;
