...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONPEERACTIONREQUIREDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18F1D540)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONPEERACTIONREQUIREDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18F1D570)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONPEERACTIONREQUIREDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18F1D040)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_ONPEERACTIONREQUIREDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18F1D030)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int OnPeerActionRequiredCallback_TypeDefinitionIndex = 33268;
