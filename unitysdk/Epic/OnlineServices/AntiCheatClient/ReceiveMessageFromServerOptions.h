...
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMSERVEROPTIONS_GET_DATA_OFFSET UNITYSDK_OFFSET(0x19566110)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMSERVEROPTIONS_SET_DATA_OFFSET UNITYSDK_OFFSET(0x19566120)
#define EPIC_ONLINESERVICES_ANTICHEATCLIENT_RECEIVEMESSAGEFROMSERVEROPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19566130)

namespace Epic::OnlineServices::AntiCheatClient
{
	inline static constexpr unsigned int ReceiveMessageFromServerOptions_TypeDefinitionIndex = 34232;
