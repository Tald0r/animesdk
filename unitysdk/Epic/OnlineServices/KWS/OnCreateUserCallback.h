...
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1983F550)
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1983F580)
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1983F050)
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1983F040)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnCreateUserCallback_TypeDefinitionIndex = 32793;
