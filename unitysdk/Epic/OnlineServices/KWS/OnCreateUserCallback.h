...
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C7BEC0)
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C7BEF0)
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C7B9C0)
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7B9A0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnCreateUserCallback_TypeDefinitionIndex = 33747;
