...
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x190DCE30)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x190DCDF0)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x190DCE10)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x190DCDD0)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x190DCFE0)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x190DCE00)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x190DCE20)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x190DCE50)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x190DCDE0)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x190DD200)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int UpdateParentEmailCallbackInfo_TypeDefinitionIndex = 32821;
