...
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ADDNOTIFYPERMISSIONSUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0x175AEAA0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_COPYPERMISSIONBYINDEX_OFFSET UNITYSDK_OFFSET(0x175AED20)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_CREATEUSER_OFFSET UNITYSDK_OFFSET(0x175AEFD0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_GETPERMISSIONBYKEY_OFFSET UNITYSDK_OFFSET(0x175AF190)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_GETPERMISSIONSCOUNT_OFFSET UNITYSDK_OFFSET(0x175AF300)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONCREATEUSERCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x175AE720)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONPERMISSIONSUPDATERECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x175AE7B0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONQUERYAGEGATECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x175AE840)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONQUERYPERMISSIONSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x175AE8D0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONREQUESTPERMISSIONSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x175AE960)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_ONUPDATEPARENTEMAILCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x175AE9F0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_QUERYAGEGATE_OFFSET UNITYSDK_OFFSET(0x175AF500)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_QUERYPERMISSIONS_OFFSET UNITYSDK_OFFSET(0x175AF770)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_REMOVENOTIFYPERMISSIONSUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0x175AF9C0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_REQUESTPERMISSIONS_OFFSET UNITYSDK_OFFSET(0x175AFAA0)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE_UPDATEPARENTEMAIL_OFFSET UNITYSDK_OFFSET(0x175AFC60)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x175AEA90)
#define EPIC_ONLINESERVICES_KWS_KWSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x175AEA80)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int KWSInterface_TypeDefinitionIndex = 33745;
