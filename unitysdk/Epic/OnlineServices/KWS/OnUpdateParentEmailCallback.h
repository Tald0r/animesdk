...
#define EPIC_ONLINESERVICES_KWS_ONUPDATEPARENTEMAILCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A83C00)
#define EPIC_ONLINESERVICES_KWS_ONUPDATEPARENTEMAILCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A83C30)
#define EPIC_ONLINESERVICES_KWS_ONUPDATEPARENTEMAILCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A83700)
#define EPIC_ONLINESERVICES_KWS_ONUPDATEPARENTEMAILCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A836F0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnUpdateParentEmailCallback_TypeDefinitionIndex = 32803;
