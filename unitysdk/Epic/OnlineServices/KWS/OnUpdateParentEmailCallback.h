...
#define EPIC_ONLINESERVICES_KWS_ONUPDATEPARENTEMAILCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FC5A40)
#define EPIC_ONLINESERVICES_KWS_ONUPDATEPARENTEMAILCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FC5A70)
#define EPIC_ONLINESERVICES_KWS_ONUPDATEPARENTEMAILCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FC5540)
#define EPIC_ONLINESERVICES_KWS_ONUPDATEPARENTEMAILCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19FC5520)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnUpdateParentEmailCallback_TypeDefinitionIndex = 33757;
