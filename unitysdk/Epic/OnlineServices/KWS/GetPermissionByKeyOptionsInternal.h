...
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONBYKEYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D89B0)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONBYKEYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D8940)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONBYKEYOPTIONSINTERNAL_SET_KEY_OFFSET UNITYSDK_OFFSET(0x8D8880)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONBYKEYOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8D87C0)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONBYKEYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D8930)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int GetPermissionByKeyOptionsInternal_TypeDefinitionIndex = 33742;
