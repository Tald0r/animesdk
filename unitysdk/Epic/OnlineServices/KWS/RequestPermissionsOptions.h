...
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19FC6810)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONS_GET_PERMISSIONKEYS_OFFSET UNITYSDK_OFFSET(0x19FC6830)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19FC6820)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONS_SET_PERMISSIONKEYS_OFFSET UNITYSDK_OFFSET(0x19FC6840)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19FC6850)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int RequestPermissionsOptions_TypeDefinitionIndex = 33773;
