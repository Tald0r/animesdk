...
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x84D650)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x84D5E0)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x84D3F0)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x84D5D0)
#define EPIC_ONLINESERVICES_KWS_REQUESTPERMISSIONSOPTIONSINTERNAL_SET_PERMISSIONKEYS_OFFSET UNITYSDK_OFFSET(0x84D4B0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int RequestPermissionsOptionsInternal_TypeDefinitionIndex = 32820;
