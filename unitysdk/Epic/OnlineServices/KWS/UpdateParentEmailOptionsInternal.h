...
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FCC00)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8FCB90)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8FCA10)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8FCB80)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONSINTERNAL_SET_PARENTEMAIL_OFFSET UNITYSDK_OFFSET(0x8FCAD0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int UpdateParentEmailOptionsInternal_TypeDefinitionIndex = 33778;
