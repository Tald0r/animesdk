...
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x85BC90)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x85BA50)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x2CB090)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x85BC80)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_SET_NAME_OFFSET UNITYSDK_OFFSET(0x85BB00)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x85BBB0)
#define EPIC_ONLINESERVICES_KWS_PERMISSIONSTATUSINTERNAL_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x3197D0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int PermissionStatusInternal_TypeDefinitionIndex = 32806;
