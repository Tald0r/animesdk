...
#define EPIC_ONLINESERVICES_KWS_CREATEUSEROPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A2C20)
#define EPIC_ONLINESERVICES_KWS_CREATEUSEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8A2BB0)
#define EPIC_ONLINESERVICES_KWS_CREATEUSEROPTIONSINTERNAL_SET_DATEOFBIRTH_OFFSET UNITYSDK_OFFSET(0x8A2A40)
#define EPIC_ONLINESERVICES_KWS_CREATEUSEROPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8A2980)
#define EPIC_ONLINESERVICES_KWS_CREATEUSEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8A2BA0)
#define EPIC_ONLINESERVICES_KWS_CREATEUSEROPTIONSINTERNAL_SET_PARENTEMAIL_OFFSET UNITYSDK_OFFSET(0x8A2AF0)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int CreateUserOptionsInternal_TypeDefinitionIndex = 33740;
