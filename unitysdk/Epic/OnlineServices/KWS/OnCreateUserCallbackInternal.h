...
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D3ED10)
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D3ED60)
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D3EA20)
#define EPIC_ONLINESERVICES_KWS_ONCREATEUSERCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3EA00)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnCreateUserCallbackInternal_TypeDefinitionIndex = 33748;
