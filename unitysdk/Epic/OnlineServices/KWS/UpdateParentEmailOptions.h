...
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19C7C350)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONS_GET_PARENTEMAIL_OFFSET UNITYSDK_OFFSET(0x19C7C370)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19C7C360)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONS_SET_PARENTEMAIL_OFFSET UNITYSDK_OFFSET(0x19C7C380)
#define EPIC_ONLINESERVICES_KWS_UPDATEPARENTEMAILOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7C390)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int UpdateParentEmailOptions_TypeDefinitionIndex = 33777;
