...
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16E4E030)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16E4E060)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x16E4DB20)
#define EPIC_ONLINESERVICES_KWS_ONQUERYPERMISSIONSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16E4E020)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int OnQueryPermissionsCallback_TypeDefinitionIndex = 32799;
