...
#define EPIC_ONLINESERVICES_KWS_COPYPERMISSIONBYINDEXOPTIONS_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1926D420)
#define EPIC_ONLINESERVICES_KWS_COPYPERMISSIONBYINDEXOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1926D400)
#define EPIC_ONLINESERVICES_KWS_COPYPERMISSIONBYINDEXOPTIONS_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x1926D430)
#define EPIC_ONLINESERVICES_KWS_COPYPERMISSIONBYINDEXOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1926D410)
#define EPIC_ONLINESERVICES_KWS_COPYPERMISSIONBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1926D440)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int CopyPermissionByIndexOptions_TypeDefinitionIndex = 33735;
