...
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87B130)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x87B000)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x87AE70)
#define EPIC_ONLINESERVICES_KWS_GETPERMISSIONSCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x87AF30)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int GetPermissionsCountOptionsInternal_TypeDefinitionIndex = 33744;
