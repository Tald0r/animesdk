...
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x863380)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x78EB40)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int QueryAgeGateOptionsInternal_TypeDefinitionIndex = 32812;
