...
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_AGEOFCONSENT_OFFSET UNITYSDK_OFFSET(0x359050)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x86E4B0)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_COUNTRYCODE_OFFSET UNITYSDK_OFFSET(0x86E5C0)
#define EPIC_ONLINESERVICES_KWS_QUERYAGEGATECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)

namespace Epic::OnlineServices::KWS
{
	inline static constexpr unsigned int QueryAgeGateCallbackInfoInternal_TypeDefinitionIndex = 32810;
