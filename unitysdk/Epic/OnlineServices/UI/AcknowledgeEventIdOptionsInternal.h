...
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8BEB20)
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8BEB00)
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_SET_RESULT_OFFSET UNITYSDK_OFFSET(0x3197D0)
#define EPIC_ONLINESERVICES_UI_ACKNOWLEDGEEVENTIDOPTIONSINTERNAL_SET_UIEVENTID_OFFSET UNITYSDK_OFFSET(0x2CB170)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int AcknowledgeEventIdOptionsInternal_TypeDefinitionIndex = 31855;
