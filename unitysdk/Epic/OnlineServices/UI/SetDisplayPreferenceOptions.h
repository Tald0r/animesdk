...
#define EPIC_ONLINESERVICES_UI_SETDISPLAYPREFERENCEOPTIONS_GET_NOTIFICATIONLOCATION_OFFSET UNITYSDK_OFFSET(0x1977D1F0)
#define EPIC_ONLINESERVICES_UI_SETDISPLAYPREFERENCEOPTIONS_SET_NOTIFICATIONLOCATION_OFFSET UNITYSDK_OFFSET(0x1977D200)
#define EPIC_ONLINESERVICES_UI_SETDISPLAYPREFERENCEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1977D210)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int SetDisplayPreferenceOptions_TypeDefinitionIndex = 31880;
