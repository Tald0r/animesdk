...
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19545CC0)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19545CF0)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x195457C0)
#define EPIC_ONLINESERVICES_UI_ONSHOWFRIENDSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x195457B0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int OnShowFriendsCallback_TypeDefinitionIndex = 31874;
