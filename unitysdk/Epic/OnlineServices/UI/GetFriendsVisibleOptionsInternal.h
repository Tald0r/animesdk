...
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x878C50)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x878B20)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x878990)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x878A50)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int GetFriendsVisibleOptionsInternal_TypeDefinitionIndex = 31859;
