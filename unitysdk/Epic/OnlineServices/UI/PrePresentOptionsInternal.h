...
#define EPIC_ONLINESERVICES_UI_PREPRESENTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x841000)
#define EPIC_ONLINESERVICES_UI_PREPRESENTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x840F90)
#define EPIC_ONLINESERVICES_UI_PREPRESENTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7917A0)
#define EPIC_ONLINESERVICES_UI_PREPRESENTOPTIONSINTERNAL_SET_PLATFORMSPECIFICDATA_OFFSET UNITYSDK_OFFSET(0x2CB170)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int PrePresentOptionsInternal_TypeDefinitionIndex = 31877;
