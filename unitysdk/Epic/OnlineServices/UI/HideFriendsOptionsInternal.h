...
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8DB9D0)
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8DB8A0)
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8DB710)
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8DB7D0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int HideFriendsOptionsInternal_TypeDefinitionIndex = 31865;
