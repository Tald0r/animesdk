...
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_ACKNOWLEDGEEVENTID_OFFSET UNITYSDK_OFFSET(0x18D4C750)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_ADDNOTIFYDISPLAYSETTINGSUPDATED_OFFSET UNITYSDK_OFFSET(0x18D4C8B0)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_GETFRIENDSVISIBLE_OFFSET UNITYSDK_OFFSET(0x18D4CB30)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_GETNOTIFICATIONLOCATIONPREFERENCE_OFFSET UNITYSDK_OFFSET(0x18D4CDA0)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_GETTOGGLEFRIENDSKEY_OFFSET UNITYSDK_OFFSET(0x18D4CE20)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_HIDEFRIENDS_OFFSET UNITYSDK_OFFSET(0x18D4D040)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_ISVALIDKEYCOMBINATION_OFFSET UNITYSDK_OFFSET(0x18D4D290)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_ONDISPLAYSETTINGSUPDATEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18D4C580)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_ONHIDEFRIENDSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18D4C610)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_ONSHOWFRIENDSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18D4C6A0)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_REMOVENOTIFYDISPLAYSETTINGSUPDATED_OFFSET UNITYSDK_OFFSET(0x18D4D3B0)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_SETDISPLAYPREFERENCE_OFFSET UNITYSDK_OFFSET(0x18D4D490)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_SETTOGGLEFRIENDSKEY_OFFSET UNITYSDK_OFFSET(0x18D4D5F0)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE_SHOWFRIENDS_OFFSET UNITYSDK_OFFSET(0x18D4D750)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18D4C740)
#define EPIC_ONLINESERVICES_UI_UIINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x18D4C730)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int UIInterface_TypeDefinitionIndex = 32842;
