...
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A76300)
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A76330)
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A75E00)
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A75DF0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int OnHideFriendsCallback_TypeDefinitionIndex = 31872;
