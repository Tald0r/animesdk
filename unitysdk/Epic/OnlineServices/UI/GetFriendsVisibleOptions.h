...
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18DD5B50)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18DD5B60)
#define EPIC_ONLINESERVICES_UI_GETFRIENDSVISIBLEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD5B70)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int GetFriendsVisibleOptions_TypeDefinitionIndex = 31858;
