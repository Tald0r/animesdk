...
#define EPIC_ONLINESERVICES_UI_SETTOGGLEFRIENDSKEYOPTIONS_GET_KEYCOMBINATION_OFFSET UNITYSDK_OFFSET(0x19AF2080)
#define EPIC_ONLINESERVICES_UI_SETTOGGLEFRIENDSKEYOPTIONS_SET_KEYCOMBINATION_OFFSET UNITYSDK_OFFSET(0x19AF2090)
#define EPIC_ONLINESERVICES_UI_SETTOGGLEFRIENDSKEYOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF20A0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int SetToggleFriendsKeyOptions_TypeDefinitionIndex = 31882;
