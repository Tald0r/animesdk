...
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18504020)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18504030)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18504040)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int ShowFriendsOptions_TypeDefinitionIndex = 32840;
