...
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x859630)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x859640)
#define EPIC_ONLINESERVICES_UI_SHOWFRIENDSCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int ShowFriendsCallbackInfoInternal_TypeDefinitionIndex = 31885;
