...
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18D4C2B0)
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18D4C2C0)
#define EPIC_ONLINESERVICES_UI_HIDEFRIENDSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18D4C2D0)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int HideFriendsOptions_TypeDefinitionIndex = 32818;
