...
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190E9D90)
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190E9DE0)
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x190E9A90)
#define EPIC_ONLINESERVICES_UI_ONHIDEFRIENDSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x190E9A80)

namespace Epic::OnlineServices::UI
{
	inline static constexpr unsigned int OnHideFriendsCallbackInternal_TypeDefinitionIndex = 31873;
