...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8AA160)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x8A9810)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x8A9CC0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8A9B60)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_FLAVORTEXT_OFFSET UNITYSDK_OFFSET(0x8A9F80)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_ICONURL_OFFSET UNITYSDK_OFFSET(0x8A9E20)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x2D8760)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_STATINFO_OFFSET UNITYSDK_OFFSET(0x8A9A80)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_GET_UNLOCKTIME_OFFSET UNITYSDK_OFFSET(0x8A9970)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8AA0F0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x8A98C0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x8A9D70)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8A9C10)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_FLAVORTEXT_OFFSET UNITYSDK_OFFSET(0x8AA030)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_ICONURL_OFFSET UNITYSDK_OFFSET(0x8A9ED0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8AA0E0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x2D8710)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_STATINFO_OFFSET UNITYSDK_OFFSET(0x8A9AF0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERACHIEVEMENTINTERNAL_SET_UNLOCKTIME_OFFSET UNITYSDK_OFFSET(0x8A99F0)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int PlayerAchievementInternal_TypeDefinitionIndex = 33363;
