...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_GETUNLOCKEDACHIEVEMENTCOUNTOPTIONS_GET_USERID_OFFSET UNITYSDK_OFFSET(0x1A04E810)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_GETUNLOCKEDACHIEVEMENTCOUNTOPTIONS_SET_USERID_OFFSET UNITYSDK_OFFSET(0x1A04E820)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_GETUNLOCKEDACHIEVEMENTCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A04E830)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int GetUnlockedAchievementCountOptions_TypeDefinitionIndex = 34294;
