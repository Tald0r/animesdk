...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x839BA0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x839B30)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONSINTERNAL_SET_ACHIEVEMENTIDS_OFFSET UNITYSDK_OFFSET(0x839A00)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x839B20)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKACHIEVEMENTSOPTIONSINTERNAL_SET_USERID_OFFSET UNITYSDK_OFFSET(0x839940)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int UnlockAchievementsOptionsInternal_TypeDefinitionIndex = 33373;
