...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_GET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x18D33920)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x18D33900)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_GET_THRESHOLDVALUE_OFFSET UNITYSDK_OFFSET(0x18D33940)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x18D33B50)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_SET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x18D33930)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_SET_NAME_OFFSET UNITYSDK_OFFSET(0x18D33910)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_SET_OFFSET UNITYSDK_OFFSET(0x18D33960)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO_SET_THRESHOLDVALUE_OFFSET UNITYSDK_OFFSET(0x18D33950)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18D33DB0)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int PlayerStatInfo_TypeDefinitionIndex = 34318;
