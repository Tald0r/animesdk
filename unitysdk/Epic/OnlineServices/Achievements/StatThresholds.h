...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDS_GET_NAME_OFFSET UNITYSDK_OFFSET(0x192095A0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDS_GET_THRESHOLD_OFFSET UNITYSDK_OFFSET(0x192095C0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDS_SET_1_OFFSET UNITYSDK_OFFSET(0x19209790)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDS_SET_NAME_OFFSET UNITYSDK_OFFSET(0x192095B0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDS_SET_OFFSET UNITYSDK_OFFSET(0x192095E0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDS_SET_THRESHOLD_OFFSET UNITYSDK_OFFSET(0x192095D0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_STATTHRESHOLDS__CTOR_OFFSET UNITYSDK_OFFSET(0x192099E0)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int StatThresholds_TypeDefinitionIndex = 34324;
