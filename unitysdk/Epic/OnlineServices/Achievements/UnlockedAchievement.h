...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKEDACHIEVEMENT_GET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x197673B0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKEDACHIEVEMENT_GET_UNLOCKTIME_OFFSET UNITYSDK_OFFSET(0x197673D0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKEDACHIEVEMENT_SET_1_OFFSET UNITYSDK_OFFSET(0x19767630)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKEDACHIEVEMENT_SET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x197673C0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKEDACHIEVEMENT_SET_OFFSET UNITYSDK_OFFSET(0x19767400)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKEDACHIEVEMENT_SET_UNLOCKTIME_OFFSET UNITYSDK_OFFSET(0x197673F0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_UNLOCKEDACHIEVEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19767900)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int UnlockedAchievement_TypeDefinitionIndex = 33374;
