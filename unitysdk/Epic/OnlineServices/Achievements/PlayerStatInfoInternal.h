...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D7240)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_GET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x302AD0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_GET_NAME_OFFSET UNITYSDK_OFFSET(0x8D7000)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_GET_THRESHOLDVALUE_OFFSET UNITYSDK_OFFSET(0x338550)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D7230)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_SET_CURRENTVALUE_OFFSET UNITYSDK_OFFSET(0x302AE0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_SET_NAME_OFFSET UNITYSDK_OFFSET(0x8D70B0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D7160)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_PLAYERSTATINFOINTERNAL_SET_THRESHOLDVALUE_OFFSET UNITYSDK_OFFSET(0x338540)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int PlayerStatInfoInternal_TypeDefinitionIndex = 34319;
