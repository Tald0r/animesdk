...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D338C0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D338F0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D333C0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_ONACHIEVEMENTSUNLOCKEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18D333A0)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int OnAchievementsUnlockedCallback_TypeDefinitionIndex = 34296;
