...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8914F0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x8905D0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_COMPLETIONDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x890E10)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x890890)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x890730)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_HIDDENDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x890CB0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_ISHIDDEN_OFFSET UNITYSDK_OFFSET(0x891230)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_LOCKEDDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x890B50)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_LOCKEDDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8909F0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_LOCKEDICONID_OFFSET UNITYSDK_OFFSET(0x8910D0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_STATTHRESHOLDS_OFFSET UNITYSDK_OFFSET(0x891390)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_UNLOCKEDICONID_OFFSET UNITYSDK_OFFSET(0x890F70)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x891480)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x890680)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_COMPLETIONDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x890EC0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x890940)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8907E0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_HIDDENDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x890D60)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_ISHIDDEN_OFFSET UNITYSDK_OFFSET(0x8912E0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_LOCKEDDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x890C00)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_LOCKEDDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x890AA0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_LOCKEDICONID_OFFSET UNITYSDK_OFFSET(0x891180)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x891470)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_STATTHRESHOLDS_OFFSET UNITYSDK_OFFSET(0x891400)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_UNLOCKEDICONID_OFFSET UNITYSDK_OFFSET(0x891020)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int DefinitionInternal_TypeDefinitionIndex = 33333;
