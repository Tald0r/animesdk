...
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x898EE0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x897FC0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_COMPLETIONDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x898800)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x898280)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x898120)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_HIDDENDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x8986A0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_ISHIDDEN_OFFSET UNITYSDK_OFFSET(0x898C20)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_LOCKEDDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x898540)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_LOCKEDDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8983E0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_LOCKEDICONID_OFFSET UNITYSDK_OFFSET(0x898AC0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_STATTHRESHOLDS_OFFSET UNITYSDK_OFFSET(0x898D80)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_GET_UNLOCKEDICONID_OFFSET UNITYSDK_OFFSET(0x898960)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x898E70)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_ACHIEVEMENTID_OFFSET UNITYSDK_OFFSET(0x898070)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_COMPLETIONDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x8988B0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x898330)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8981D0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_HIDDENDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x898750)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_ISHIDDEN_OFFSET UNITYSDK_OFFSET(0x898CD0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_LOCKEDDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x8985F0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_LOCKEDDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x898490)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_LOCKEDICONID_OFFSET UNITYSDK_OFFSET(0x898B70)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x898E60)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_STATTHRESHOLDS_OFFSET UNITYSDK_OFFSET(0x898DF0)
#define EPIC_ONLINESERVICES_ACHIEVEMENTS_DEFINITIONINTERNAL_SET_UNLOCKEDICONID_OFFSET UNITYSDK_OFFSET(0x898A10)

namespace Epic::OnlineServices::Achievements
{
	inline static constexpr unsigned int DefinitionInternal_TypeDefinitionIndex = 34287;
