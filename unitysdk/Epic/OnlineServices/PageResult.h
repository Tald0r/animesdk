...
#define EPIC_ONLINESERVICES_PAGERESULT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19AE9890)
#define EPIC_ONLINESERVICES_PAGERESULT_GET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0x19AE9870)
#define EPIC_ONLINESERVICES_PAGERESULT_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x19AE98B0)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_1_OFFSET UNITYSDK_OFFSET(0x19AE99A0)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x19AE98A0)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_OFFSET UNITYSDK_OFFSET(0x19AE98D0)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0x19AE9880)
#define EPIC_ONLINESERVICES_PAGERESULT_SET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x19AE98C0)
#define EPIC_ONLINESERVICES_PAGERESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE9AF0)

namespace Epic::OnlineServices
{
	inline static constexpr unsigned int PageResult_TypeDefinitionIndex = 31817;
