...
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x892BD0)
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x892AB0)
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8929E0)
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONSINTERNAL_SET_REFRESHTOKEN_OFFSET UNITYSDK_OFFSET(0x892930)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int DeletePersistentAuthOptionsInternal_TypeDefinitionIndex = 33097;
