...
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89A5B0)
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x89A490)
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x89A3C0)
#define EPIC_ONLINESERVICES_AUTH_DELETEPERSISTENTAUTHOPTIONSINTERNAL_SET_REFRESHTOKEN_OFFSET UNITYSDK_OFFSET(0x89A310)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int DeletePersistentAuthOptionsInternal_TypeDefinitionIndex = 34051;
