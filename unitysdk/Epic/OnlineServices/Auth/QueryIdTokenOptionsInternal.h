...
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87A380)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x87A310)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x87A180)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x87A300)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_SET_TARGETACCOUNTID_OFFSET UNITYSDK_OFFSET(0x87A240)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int QueryIdTokenOptionsInternal_TypeDefinitionIndex = 34091;
