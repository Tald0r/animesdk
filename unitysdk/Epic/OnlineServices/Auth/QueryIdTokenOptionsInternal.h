...
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x84C590)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x84C520)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x84C390)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x84C510)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENOPTIONSINTERNAL_SET_TARGETACCOUNTID_OFFSET UNITYSDK_OFFSET(0x84C450)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int QueryIdTokenOptionsInternal_TypeDefinitionIndex = 33137;
