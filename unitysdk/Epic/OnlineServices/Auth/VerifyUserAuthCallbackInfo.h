...
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x195275E0)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x195275C0)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x195275A0)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x19527690)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x195275D0)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x19527600)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x195275B0)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x195277F0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int VerifyUserAuthCallbackInfo_TypeDefinitionIndex = 34098;
