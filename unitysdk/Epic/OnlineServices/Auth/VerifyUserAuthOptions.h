...
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHOPTIONS_GET_AUTHTOKEN_OFFSET UNITYSDK_OFFSET(0x19FC15A0)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHOPTIONS_SET_AUTHTOKEN_OFFSET UNITYSDK_OFFSET(0x19FC15B0)
#define EPIC_ONLINESERVICES_AUTH_VERIFYUSERAUTHOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19FC15C0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int VerifyUserAuthOptions_TypeDefinitionIndex = 34100;
