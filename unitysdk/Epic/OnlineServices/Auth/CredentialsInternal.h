...
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B8950)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_GET_EXTERNALTYPE_OFFSET UNITYSDK_OFFSET(0x2FD450)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_GET_ID_OFFSET UNITYSDK_OFFSET(0x8B8610)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_GET_SYSTEMAUTHCREDENTIALSOPTIONS_OFFSET UNITYSDK_OFFSET(0x2FC120)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x8B8770)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x359050)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8B88E0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_SET_EXTERNALTYPE_OFFSET UNITYSDK_OFFSET(0x35D7B0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_SET_ID_OFFSET UNITYSDK_OFFSET(0x8B86C0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B88D0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_SET_SYSTEMAUTHCREDENTIALSOPTIONS_OFFSET UNITYSDK_OFFSET(0x2FC190)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_SET_TOKEN_OFFSET UNITYSDK_OFFSET(0x8B8820)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALSINTERNAL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x379D90)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int CredentialsInternal_TypeDefinitionIndex = 33093;
