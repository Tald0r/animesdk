...
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO_GET_VERIFICATIONURI_OFFSET UNITYSDK_OFFSET(0x18D95C20)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x18D95D80)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO_SET_OFFSET UNITYSDK_OFFSET(0x18D95C40)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO_SET_VERIFICATIONURI_OFFSET UNITYSDK_OFFSET(0x18D95C30)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18D95FA0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int AccountFeatureRestrictedInfo_TypeDefinitionIndex = 33081;
