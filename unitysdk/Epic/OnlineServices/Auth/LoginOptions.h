...
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONS_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x190B7330)
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONS_GET_SCOPEFLAGS_OFFSET UNITYSDK_OFFSET(0x190B7350)
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONS_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x190B7340)
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONS_SET_SCOPEFLAGS_OFFSET UNITYSDK_OFFSET(0x190B7360)
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x190B7370)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LoginOptions_TypeDefinitionIndex = 33108;
