...
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A652C0)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A65310)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A64FC0)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19A64FB0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnVerifyIdTokenCallbackInternal_TypeDefinitionIndex = 33129;
