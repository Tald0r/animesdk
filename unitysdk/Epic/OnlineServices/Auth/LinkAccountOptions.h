...
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONS_GET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x190F1650)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONS_GET_LINKACCOUNTFLAGS_OFFSET UNITYSDK_OFFSET(0x190F1630)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x190F1670)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONS_SET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x190F1660)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONS_SET_LINKACCOUNTFLAGS_OFFSET UNITYSDK_OFFSET(0x190F1640)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x190F1680)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x190F1690)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LinkAccountOptions_TypeDefinitionIndex = 34057;
