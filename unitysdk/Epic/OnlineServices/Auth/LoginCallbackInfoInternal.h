...
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFOINTERNAL_GET_ACCOUNTFEATURERESTRICTEDINFO_OFFSET UNITYSDK_OFFSET(0x8C7DE0)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8C7B80)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFOINTERNAL_GET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x8C7D70)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8C7C90)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFOINTERNAL_GET_PINGRANTINFO_OFFSET UNITYSDK_OFFSET(0x8C7D00)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define EPIC_ONLINESERVICES_AUTH_LOGINCALLBACKINFOINTERNAL_GET_SELECTEDACCOUNTID_OFFSET UNITYSDK_OFFSET(0x8C7E50)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LoginCallbackInfoInternal_TypeDefinitionIndex = 33106;
