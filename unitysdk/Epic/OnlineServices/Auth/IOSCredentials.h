...
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS_GET_EXTERNALTYPE_OFFSET UNITYSDK_OFFSET(0x18F20D50)
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS_GET_ID_OFFSET UNITYSDK_OFFSET(0x18F20CD0)
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS_GET_SYSTEMAUTHCREDENTIALSOPTIONS_OFFSET UNITYSDK_OFFSET(0x18F20D30)
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x18F20CF0)
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x18F20D10)
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS_SET_1_OFFSET UNITYSDK_OFFSET(0x18F21170)
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS_SET_EXTERNALTYPE_OFFSET UNITYSDK_OFFSET(0x18F20D60)
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS_SET_ID_OFFSET UNITYSDK_OFFSET(0x18F20CE0)
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS_SET_OFFSET UNITYSDK_OFFSET(0x18F20D70)
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS_SET_SYSTEMAUTHCREDENTIALSOPTIONS_OFFSET UNITYSDK_OFFSET(0x18F20D40)
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS_SET_TOKEN_OFFSET UNITYSDK_OFFSET(0x18F20D00)
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x18F20D20)
#define EPIC_ONLINESERVICES_AUTH_IOSCREDENTIALS__CTOR_OFFSET UNITYSDK_OFFSET(0x18F212C0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int IOSCredentials_TypeDefinitionIndex = 33148;
