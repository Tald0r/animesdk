...
#define EPIC_ONLINESERVICES_AUTH_IDTOKEN_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x190D77B0)
#define EPIC_ONLINESERVICES_AUTH_IDTOKEN_GET_JSONWEBTOKEN_OFFSET UNITYSDK_OFFSET(0x190D77D0)
#define EPIC_ONLINESERVICES_AUTH_IDTOKEN_SET_1_OFFSET UNITYSDK_OFFSET(0x190D7A20)
#define EPIC_ONLINESERVICES_AUTH_IDTOKEN_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x190D77C0)
#define EPIC_ONLINESERVICES_AUTH_IDTOKEN_SET_JSONWEBTOKEN_OFFSET UNITYSDK_OFFSET(0x190D77E0)
#define EPIC_ONLINESERVICES_AUTH_IDTOKEN_SET_OFFSET UNITYSDK_OFFSET(0x190D77F0)
#define EPIC_ONLINESERVICES_AUTH_IDTOKEN__CTOR_OFFSET UNITYSDK_OFFSET(0x190D7CF0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int IdToken_TypeDefinitionIndex = 33098;
