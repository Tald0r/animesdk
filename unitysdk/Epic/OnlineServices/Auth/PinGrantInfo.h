...
#define EPIC_ONLINESERVICES_AUTH_PINGRANTINFO_GET_EXPIRESIN_OFFSET UNITYSDK_OFFSET(0x18DC06A0)
#define EPIC_ONLINESERVICES_AUTH_PINGRANTINFO_GET_USERCODE_OFFSET UNITYSDK_OFFSET(0x18DC0660)
#define EPIC_ONLINESERVICES_AUTH_PINGRANTINFO_GET_VERIFICATIONURICOMPLETE_OFFSET UNITYSDK_OFFSET(0x18DC06C0)
#define EPIC_ONLINESERVICES_AUTH_PINGRANTINFO_GET_VERIFICATIONURI_OFFSET UNITYSDK_OFFSET(0x18DC0680)
#define EPIC_ONLINESERVICES_AUTH_PINGRANTINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x18DC0AD0)
#define EPIC_ONLINESERVICES_AUTH_PINGRANTINFO_SET_EXPIRESIN_OFFSET UNITYSDK_OFFSET(0x18DC06B0)
#define EPIC_ONLINESERVICES_AUTH_PINGRANTINFO_SET_OFFSET UNITYSDK_OFFSET(0x18DC06E0)
#define EPIC_ONLINESERVICES_AUTH_PINGRANTINFO_SET_USERCODE_OFFSET UNITYSDK_OFFSET(0x18DC0670)
#define EPIC_ONLINESERVICES_AUTH_PINGRANTINFO_SET_VERIFICATIONURICOMPLETE_OFFSET UNITYSDK_OFFSET(0x18DC06D0)
#define EPIC_ONLINESERVICES_AUTH_PINGRANTINFO_SET_VERIFICATIONURI_OFFSET UNITYSDK_OFFSET(0x18DC0690)
#define EPIC_ONLINESERVICES_AUTH_PINGRANTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC0C10)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int PinGrantInfo_TypeDefinitionIndex = 33132;
