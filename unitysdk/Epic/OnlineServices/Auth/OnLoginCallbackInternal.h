...
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19AE4A40)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19AE4A90)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19AE4740)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19AE4730)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLoginCallbackInternal_TypeDefinitionIndex = 33121;
