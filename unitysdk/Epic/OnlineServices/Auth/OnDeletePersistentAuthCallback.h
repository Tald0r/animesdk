...
#define EPIC_ONLINESERVICES_AUTH_ONDELETEPERSISTENTAUTHCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184EB5A0)
#define EPIC_ONLINESERVICES_AUTH_ONDELETEPERSISTENTAUTHCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184EB5D0)
#define EPIC_ONLINESERVICES_AUTH_ONDELETEPERSISTENTAUTHCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x184EB0A0)
#define EPIC_ONLINESERVICES_AUTH_ONDELETEPERSISTENTAUTHCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x184EB080)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnDeletePersistentAuthCallback_TypeDefinitionIndex = 34070;
