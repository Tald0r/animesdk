...
#define EPIC_ONLINESERVICES_AUTH_LOGOUTCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x272280)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x7CC000)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x7CC110)
#define EPIC_ONLINESERVICES_AUTH_LOGOUTCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LogoutCallbackInfoInternal_TypeDefinitionIndex = 34067;
