...
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x872150)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x872260)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTCALLBACKINFOINTERNAL_GET_PINGRANTINFO_OFFSET UNITYSDK_OFFSET(0x8722D0)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define EPIC_ONLINESERVICES_AUTH_LINKACCOUNTCALLBACKINFOINTERNAL_GET_SELECTEDACCOUNTID_OFFSET UNITYSDK_OFFSET(0x872340)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LinkAccountCallbackInfoInternal_TypeDefinitionIndex = 33101;
