...
#define EPIC_ONLINESERVICES_AUTH_VERIFYIDTOKENOPTIONS_GET_IDTOKEN_OFFSET UNITYSDK_OFFSET(0x19A7F750)
#define EPIC_ONLINESERVICES_AUTH_VERIFYIDTOKENOPTIONS_SET_IDTOKEN_OFFSET UNITYSDK_OFFSET(0x19A7F760)
#define EPIC_ONLINESERVICES_AUTH_VERIFYIDTOKENOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7F770)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int VerifyIdTokenOptions_TypeDefinitionIndex = 33142;
