...
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B9080)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFOINTERNAL_GET_VERIFICATIONURI_OFFSET UNITYSDK_OFFSET(0x8B8D30)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8B8F60)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B8E90)
#define EPIC_ONLINESERVICES_AUTH_ACCOUNTFEATURERESTRICTEDINFOINTERNAL_SET_VERIFICATIONURI_OFFSET UNITYSDK_OFFSET(0x8B8DE0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int AccountFeatureRestrictedInfoInternal_TypeDefinitionIndex = 34036;
