...
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x272280)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8E4E50)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8E4F60)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define EPIC_ONLINESERVICES_AUTH_QUERYIDTOKENCALLBACKINFOINTERNAL_GET_TARGETACCOUNTID_OFFSET UNITYSDK_OFFSET(0x8E4FD0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int QueryIdTokenCallbackInfoInternal_TypeDefinitionIndex = 34089;
