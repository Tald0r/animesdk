...
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x78EA90)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x78E960)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONSINTERNAL_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x78E7D0)
#define EPIC_ONLINESERVICES_AUTH_COPYIDTOKENOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x78E890)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int CopyIdTokenOptionsInternal_TypeDefinitionIndex = 33089;
