...
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190B8010)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190B8060)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x190B7D10)
#define EPIC_ONLINESERVICES_AUTH_ONLOGOUTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x190B7D00)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLogoutCallbackInternal_TypeDefinitionIndex = 33125;
