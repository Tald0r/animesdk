...
#define EPIC_ONLINESERVICES_AUTH_ONLOGINSTATUSCHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x195F05F0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINSTATUSCHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x195F0620)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINSTATUSCHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x195F00F0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINSTATUSCHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x195F00E0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLoginStatusChangedCallback_TypeDefinitionIndex = 33122;
