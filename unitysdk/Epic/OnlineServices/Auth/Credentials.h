...
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_GET_EXTERNALTYPE_OFFSET UNITYSDK_OFFSET(0x17ED1900)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_GET_ID_OFFSET UNITYSDK_OFFSET(0x17ED1880)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_GET_SYSTEMAUTHCREDENTIALSOPTIONS_OFFSET UNITYSDK_OFFSET(0x17ED18E0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x17ED18A0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x17ED18C0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_1_OFFSET UNITYSDK_OFFSET(0x17ED1CB0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_EXTERNALTYPE_OFFSET UNITYSDK_OFFSET(0x17ED1910)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_ID_OFFSET UNITYSDK_OFFSET(0x17ED1890)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_OFFSET UNITYSDK_OFFSET(0x17ED1920)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_SYSTEMAUTHCREDENTIALSOPTIONS_OFFSET UNITYSDK_OFFSET(0x17ED18F0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_TOKEN_OFFSET UNITYSDK_OFFSET(0x17ED18B0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x17ED18D0)
#define EPIC_ONLINESERVICES_AUTH_CREDENTIALS__CTOR_OFFSET UNITYSDK_OFFSET(0x17ED1E00)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int Credentials_TypeDefinitionIndex = 33092;
