...
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A7F710)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A7F740)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A7F210)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7F200)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnVerifyIdTokenCallback_TypeDefinitionIndex = 33128;
