...
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FC1530)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FC1560)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FC1030)
#define EPIC_ONLINESERVICES_AUTH_ONVERIFYIDTOKENCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19FC1010)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnVerifyIdTokenCallback_TypeDefinitionIndex = 34082;
