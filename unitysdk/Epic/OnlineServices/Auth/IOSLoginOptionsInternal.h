...
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8720A0)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x872090)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x871FA0)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x872010)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_SET_SCOPEFLAGS_OFFSET UNITYSDK_OFFSET(0x3197D0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int IOSLoginOptionsInternal_TypeDefinitionIndex = 33153;
