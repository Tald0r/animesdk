...
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A7010)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8A7000)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x8A6F10)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8A6F80)
#define EPIC_ONLINESERVICES_AUTH_IOSLOGINOPTIONSINTERNAL_SET_SCOPEFLAGS_OFFSET UNITYSDK_OFFSET(0x302AE0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int IOSLoginOptionsInternal_TypeDefinitionIndex = 34107;
