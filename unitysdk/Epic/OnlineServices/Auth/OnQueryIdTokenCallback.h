...
#define EPIC_ONLINESERVICES_AUTH_ONQUERYIDTOKENCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19151870)
#define EPIC_ONLINESERVICES_AUTH_ONQUERYIDTOKENCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x191518A0)
#define EPIC_ONLINESERVICES_AUTH_ONQUERYIDTOKENCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19151370)
#define EPIC_ONLINESERVICES_AUTH_ONQUERYIDTOKENCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19151350)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnQueryIdTokenCallback_TypeDefinitionIndex = 34080;
