...
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x86CF40)
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x86CF30)
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONSINTERNAL_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x86CE40)
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x86CEB0)
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONSINTERNAL_SET_SCOPEFLAGS_OFFSET UNITYSDK_OFFSET(0x3197D0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LoginOptionsInternal_TypeDefinitionIndex = 33109;
