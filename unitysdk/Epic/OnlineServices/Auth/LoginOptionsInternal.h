...
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8A19E0)
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8A19D0)
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONSINTERNAL_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x8A18E0)
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8A1950)
#define EPIC_ONLINESERVICES_AUTH_LOGINOPTIONSINTERNAL_SET_SCOPEFLAGS_OFFSET UNITYSDK_OFFSET(0x302AE0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int LoginOptionsInternal_TypeDefinitionIndex = 34063;
