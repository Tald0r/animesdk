...
#define EPIC_ONLINESERVICES_AUTH_IDTOKENINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7E2830)
#define EPIC_ONLINESERVICES_AUTH_IDTOKENINTERNAL_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x7E2520)
#define EPIC_ONLINESERVICES_AUTH_IDTOKENINTERNAL_GET_JSONWEBTOKEN_OFFSET UNITYSDK_OFFSET(0x7E2650)
#define EPIC_ONLINESERVICES_AUTH_IDTOKENINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7E27C0)
#define EPIC_ONLINESERVICES_AUTH_IDTOKENINTERNAL_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x7E2590)
#define EPIC_ONLINESERVICES_AUTH_IDTOKENINTERNAL_SET_JSONWEBTOKEN_OFFSET UNITYSDK_OFFSET(0x7E2700)
#define EPIC_ONLINESERVICES_AUTH_IDTOKENINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7E27B0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int IdTokenInternal_TypeDefinitionIndex = 34053;
