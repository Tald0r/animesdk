...
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D96610)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D96640)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D96110)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18D96100)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLoginCallback_TypeDefinitionIndex = 33120;
