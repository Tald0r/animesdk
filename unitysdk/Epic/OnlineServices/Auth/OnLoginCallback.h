...
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190F1BC0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190F1BF0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x190F16C0)
#define EPIC_ONLINESERVICES_AUTH_ONLOGINCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x190F16A0)

namespace Epic::OnlineServices::Auth
{
	inline static constexpr unsigned int OnLoginCallback_TypeDefinitionIndex = 34074;
