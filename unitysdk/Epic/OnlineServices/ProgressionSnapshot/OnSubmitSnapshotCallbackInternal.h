...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184FC890)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184FC8E0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x184FC5A0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x184FC580)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int OnSubmitSnapshotCallbackInternal_TypeDefinitionIndex = 33253;
