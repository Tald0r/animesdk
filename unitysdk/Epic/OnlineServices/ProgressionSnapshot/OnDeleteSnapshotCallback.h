...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONDELETESNAPSHOTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17EE36C0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONDELETESNAPSHOTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17EE36F0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONDELETESNAPSHOTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x17EE31C0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONDELETESNAPSHOTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17EE31B0)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int OnDeleteSnapshotCallback_TypeDefinitionIndex = 32296;
