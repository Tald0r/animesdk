...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17EE3C10)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17EE3C40)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x17EE3710)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x17EE3700)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int OnSubmitSnapshotCallback_TypeDefinitionIndex = 32298;
