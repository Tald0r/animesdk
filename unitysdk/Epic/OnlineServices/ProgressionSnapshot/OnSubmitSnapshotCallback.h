...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184FC540)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184FC570)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x184FC040)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ONSUBMITSNAPSHOTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x184FC020)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int OnSubmitSnapshotCallback_TypeDefinitionIndex = 33252;
