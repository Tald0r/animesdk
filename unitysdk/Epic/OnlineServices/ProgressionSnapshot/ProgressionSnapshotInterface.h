...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_ADDPROGRESSION_OFFSET UNITYSDK_OFFSET(0x190E4F30)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_BEGINSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x190E5090)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_DELETESNAPSHOT_OFFSET UNITYSDK_OFFSET(0x190E5280)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_ENDSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x190E54D0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_ONDELETESNAPSHOTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x190E4DF0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_ONSUBMITSNAPSHOTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x190E4E80)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_SUBMITSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x190E5630)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x190E4F20)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x190E4F10)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int ProgressionSnapshotInterface_TypeDefinitionIndex = 32300;
