...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_ADDPROGRESSION_OFFSET UNITYSDK_OFFSET(0x19573DF0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_BEGINSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x19573F50)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_DELETESNAPSHOT_OFFSET UNITYSDK_OFFSET(0x19574140)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_ENDSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x19574390)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_ONDELETESNAPSHOTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19573CB0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_ONSUBMITSNAPSHOTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19573D40)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE_SUBMITSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x195744F0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19573DE0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_PROGRESSIONSNAPSHOTINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19573DD0)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int ProgressionSnapshotInterface_TypeDefinitionIndex = 33254;
