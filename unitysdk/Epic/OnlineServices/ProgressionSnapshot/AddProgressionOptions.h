...
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_GET_KEY_OFFSET UNITYSDK_OFFSET(0x19A89590)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_GET_SNAPSHOTID_OFFSET UNITYSDK_OFFSET(0x19A89570)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19A895B0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_SET_KEY_OFFSET UNITYSDK_OFFSET(0x19A895A0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_SET_SNAPSHOTID_OFFSET UNITYSDK_OFFSET(0x19A89580)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19A895C0)
#define EPIC_ONLINESERVICES_PROGRESSIONSNAPSHOT_ADDPROGRESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A895D0)

namespace Epic::OnlineServices::ProgressionSnapshot
{
	inline static constexpr unsigned int AddProgressionOptions_TypeDefinitionIndex = 32286;
