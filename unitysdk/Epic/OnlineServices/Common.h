...
#define EPIC_ONLINESERVICES_COMMON_ISOPERATIONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x17ED32E0)
#define EPIC_ONLINESERVICES_COMMON_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x17ED3520)
#define EPIC_ONLINESERVICES_COMMON_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x17ED3820)
#define EPIC_ONLINESERVICES_COMMON_TOSTRING_OFFSET UNITYSDK_OFFSET(0x17ED33F0)

namespace Epic::OnlineServices
{
	inline static constexpr unsigned int Common_TypeDefinitionIndex = 31808;
