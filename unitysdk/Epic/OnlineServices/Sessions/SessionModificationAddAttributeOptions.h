...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS_GET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x19544050)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS_GET_SESSIONATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19544030)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS_SET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x19544060)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS_SET_SESSIONATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19544040)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19544070)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionModificationAddAttributeOptions_TypeDefinitionIndex = 32073;
