...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS_GET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x199C3650)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS_GET_SESSIONATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x199C3630)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS_SET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x199C3660)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS_SET_SESSIONATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x199C3640)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONADDATTRIBUTEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x199C3670)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionModificationAddAttributeOptions_TypeDefinitionIndex = 33027;
