...
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x195432B0)
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x195432E0)
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19542DB0)
#define EPIC_ONLINESERVICES_SESSIONS_ONUPDATESESSIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19542DA0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnUpdateSessionCallback_TypeDefinitionIndex = 32032;
