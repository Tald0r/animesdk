...
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x272280)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x7D0C50)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x7D0D60)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int QueryInvitesCallbackInfoInternal_TypeDefinitionIndex = 32991;
