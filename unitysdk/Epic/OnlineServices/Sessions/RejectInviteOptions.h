...
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONS_GET_INVITEID_OFFSET UNITYSDK_OFFSET(0x19601020)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19601000)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONS_SET_INVITEID_OFFSET UNITYSDK_OFFSET(0x19601030)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19601010)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19601040)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int RejectInviteOptions_TypeDefinitionIndex = 32046;
