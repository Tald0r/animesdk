...
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATA_GET_KEY_OFFSET UNITYSDK_OFFSET(0x19848F40)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATA_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19848F60)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATA_SET_1_OFFSET UNITYSDK_OFFSET(0x19849150)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATA_SET_KEY_OFFSET UNITYSDK_OFFSET(0x19848F50)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATA_SET_OFFSET UNITYSDK_OFFSET(0x19848F80)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATA_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19848F70)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x198493B0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int AttributeData_TypeDefinitionIndex = 31970;
