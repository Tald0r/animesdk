...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETMAXPLAYERSOPTIONS_GET_MAXPLAYERS_OFFSET UNITYSDK_OFFSET(0x19A8B840)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETMAXPLAYERSOPTIONS_SET_MAXPLAYERS_OFFSET UNITYSDK_OFFSET(0x19A8B850)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETMAXPLAYERSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A8B860)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionModificationSetMaxPlayersOptions_TypeDefinitionIndex = 32085;
