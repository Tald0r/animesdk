...
#define EPIC_ONLINESERVICES_SESSIONS_ONSENDINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D51BA0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSENDINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D51BD0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSENDINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D516A0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSENDINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19D51680)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnSendInviteCallback_TypeDefinitionIndex = 32976;
