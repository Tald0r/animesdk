...
#define EPIC_ONLINESERVICES_SESSIONS_ONSENDINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1977B320)
#define EPIC_ONLINESERVICES_SESSIONS_ONSENDINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1977B350)
#define EPIC_ONLINESERVICES_SESSIONS_ONSENDINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1977AE20)
#define EPIC_ONLINESERVICES_SESSIONS_ONSENDINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1977AE10)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnSendInviteCallback_TypeDefinitionIndex = 32022;
