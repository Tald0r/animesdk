...
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x83F980)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_GET_KEY_OFFSET UNITYSDK_OFFSET(0x83F620)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x83F780)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x83F910)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_SET_KEY_OFFSET UNITYSDK_OFFSET(0x83F6D0)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x83F900)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAINTERNAL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x83F890)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int AttributeDataInternal_TypeDefinitionIndex = 31971;
