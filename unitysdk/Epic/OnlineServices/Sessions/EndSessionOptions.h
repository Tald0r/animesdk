...
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONOPTIONS_GET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x19100B30)
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONOPTIONS_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x19100B40)
#define EPIC_ONLINESERVICES_SESSIONS_ENDSESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19100B50)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int EndSessionOptions_TypeDefinitionIndex = 32948;
