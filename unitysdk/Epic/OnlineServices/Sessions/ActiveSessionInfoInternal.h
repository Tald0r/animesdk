...
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x850400)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x850170)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONINFOINTERNAL_GET_SESSIONDETAILS_OFFSET UNITYSDK_OFFSET(0x8502A0)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONINFOINTERNAL_GET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x850010)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONINFOINTERNAL_GET_STATE_OFFSET UNITYSDK_OFFSET(0x359050)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x850390)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONINFOINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8501E0)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x850380)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONINFOINTERNAL_SET_SESSIONDETAILS_OFFSET UNITYSDK_OFFSET(0x850310)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONINFOINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x8500C0)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSIONINFOINTERNAL_SET_STATE_OFFSET UNITYSDK_OFFSET(0x379D90)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int ActiveSessionInfoInternal_TypeDefinitionIndex = 31963;
