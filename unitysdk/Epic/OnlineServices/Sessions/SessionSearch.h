...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_COPYSEARCHRESULTBYINDEX_OFFSET UNITYSDK_OFFSET(0x16E58400)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_FIND_OFFSET UNITYSDK_OFFSET(0x16E58590)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_GETSEARCHRESULTCOUNT_OFFSET UNITYSDK_OFFSET(0x16E587E0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_ONFINDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x16E58350)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_RELEASE_OFFSET UNITYSDK_OFFSET(0x16E58A00)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_REMOVEPARAMETER_OFFSET UNITYSDK_OFFSET(0x16E58A80)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_SETMAXRESULTS_OFFSET UNITYSDK_OFFSET(0x16E58CB0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_SETPARAMETER_OFFSET UNITYSDK_OFFSET(0x16E58E10)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_SETSESSIONID_OFFSET UNITYSDK_OFFSET(0x16E59040)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH_SETTARGETUSERID_OFFSET UNITYSDK_OFFSET(0x16E59240)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16E583F0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0x16E583E0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionSearch_TypeDefinitionIndex = 32089;
