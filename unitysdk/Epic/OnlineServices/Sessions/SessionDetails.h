...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS_COPYINFO_OFFSET UNITYSDK_OFFSET(0x19227DF0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS_COPYSESSIONATTRIBUTEBYINDEX_OFFSET UNITYSDK_OFFSET(0x19228090)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS_COPYSESSIONATTRIBUTEBYKEY_OFFSET UNITYSDK_OFFSET(0x19228290)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS_GETSESSIONATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x19228520)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS_RELEASE_OFFSET UNITYSDK_OFFSET(0x19228740)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19227DE0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILS__CTOR_OFFSET UNITYSDK_OFFSET(0x19227DD0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionDetails_TypeDefinitionIndex = 33007;
