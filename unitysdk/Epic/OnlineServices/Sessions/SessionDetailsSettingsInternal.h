...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x851300)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_GET_ALLOWJOININPROGRESS_OFFSET UNITYSDK_OFFSET(0x850FC0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_GET_BUCKETID_OFFSET UNITYSDK_OFFSET(0x850E60)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_GET_INVITESALLOWED_OFFSET UNITYSDK_OFFSET(0x851120)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_GET_NUMPUBLICCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x2CB090)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_GET_PERMISSIONLEVEL_OFFSET UNITYSDK_OFFSET(0x359050)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x851290)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_ALLOWJOININPROGRESS_OFFSET UNITYSDK_OFFSET(0x851070)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_BUCKETID_OFFSET UNITYSDK_OFFSET(0x850F10)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_INVITESALLOWED_OFFSET UNITYSDK_OFFSET(0x8511D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_NUMPUBLICCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x3197D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x851280)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSSETTINGSINTERNAL_SET_PERMISSIONLEVEL_OFFSET UNITYSDK_OFFSET(0x379D90)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionDetailsSettingsInternal_TypeDefinitionIndex = 32067;
