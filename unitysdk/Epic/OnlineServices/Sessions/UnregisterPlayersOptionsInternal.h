...
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x866E50)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x866DE0)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x866DD0)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_SET_PLAYERSTOUNREGISTER_OFFSET UNITYSDK_OFFSET(0x866D60)
#define EPIC_ONLINESERVICES_SESSIONS_UNREGISTERPLAYERSOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x866CB0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int UnregisterPlayersOptionsInternal_TypeDefinitionIndex = 32118;
