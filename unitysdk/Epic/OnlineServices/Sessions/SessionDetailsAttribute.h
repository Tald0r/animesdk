...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE_GET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x19536BD0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x19536BB0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE_SET_1_OFFSET UNITYSDK_OFFSET(0x19536D50)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE_SET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x19536BE0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE_SET_DATA_OFFSET UNITYSDK_OFFSET(0x19536BC0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE_SET_OFFSET UNITYSDK_OFFSET(0x19536BF0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19536F40)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionDetailsAttribute_TypeDefinitionIndex = 33008;
