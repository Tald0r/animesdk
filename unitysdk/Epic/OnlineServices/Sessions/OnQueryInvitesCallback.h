...
#define EPIC_ONLINESERVICES_SESSIONS_ONQUERYINVITESCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19542D60)
#define EPIC_ONLINESERVICES_SESSIONS_ONQUERYINVITESCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19542D90)
#define EPIC_ONLINESERVICES_SESSIONS_ONQUERYINVITESCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19542860)
#define EPIC_ONLINESERVICES_SESSIONS_ONQUERYINVITESCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19542850)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnQueryInvitesCallback_TypeDefinitionIndex = 32016;
