...
#define EPIC_ONLINESERVICES_SESSIONS_ONQUERYINVITESCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x199C2350)
#define EPIC_ONLINESERVICES_SESSIONS_ONQUERYINVITESCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x199C2380)
#define EPIC_ONLINESERVICES_SESSIONS_ONQUERYINVITESCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x199C1E50)
#define EPIC_ONLINESERVICES_SESSIONS_ONQUERYINVITESCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199C1E30)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnQueryInvitesCallback_TypeDefinitionIndex = 32970;
