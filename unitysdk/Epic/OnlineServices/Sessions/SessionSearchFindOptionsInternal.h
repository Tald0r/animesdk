...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHFINDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8BDC30)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHFINDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8BDB00)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHFINDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8BD970)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHFINDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8BDA30)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionSearchFindOptionsInternal_TypeDefinitionIndex = 32095;
