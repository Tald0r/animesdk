...
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x272280)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x901AE0)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int StartSessionCallbackInfoInternal_TypeDefinitionIndex = 33066;
