...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x199C2FF0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x199C2F50)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_GET_INVITEID_OFFSET UNITYSDK_OFFSET(0x199C2FD0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x199C2F90)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_GET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x199C2F70)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x199C2FB0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x199C34E0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x199C2F60)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_SET_INVITEID_OFFSET UNITYSDK_OFFSET(0x199C2FE0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x199C2FA0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x199C3000)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_SET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x199C2F80)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x199C2FC0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONINVITEACCEPTEDCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x199C3620)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionInviteAcceptedCallbackInfo_TypeDefinitionIndex = 33022;
