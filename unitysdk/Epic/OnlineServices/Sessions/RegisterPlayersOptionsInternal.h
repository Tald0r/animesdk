...
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x850D30)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x850CC0)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x850CB0)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSOPTIONSINTERNAL_SET_PLAYERSTOREGISTER_OFFSET UNITYSDK_OFFSET(0x850C40)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x850B90)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int RegisterPlayersOptionsInternal_TypeDefinitionIndex = 32043;
