...
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87EB20)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x87EAB0)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x87EAA0)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSOPTIONSINTERNAL_SET_PLAYERSTOREGISTER_OFFSET UNITYSDK_OFFSET(0x87EA30)
#define EPIC_ONLINESERVICES_SESSIONS_REGISTERPLAYERSOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x87E980)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int RegisterPlayersOptionsInternal_TypeDefinitionIndex = 32997;
