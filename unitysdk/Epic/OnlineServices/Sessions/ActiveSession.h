...
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSION_COPYINFO_OFFSET UNITYSDK_OFFSET(0x1A05F550)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSION_GETREGISTEREDPLAYERBYINDEX_OFFSET UNITYSDK_OFFSET(0x1A05F7F0)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSION_GETREGISTEREDPLAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x1A05F950)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSION_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A05FB70)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A05F540)
#define EPIC_ONLINESERVICES_SESSIONS_ACTIVESESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05F530)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int ActiveSession_TypeDefinitionIndex = 32909;
