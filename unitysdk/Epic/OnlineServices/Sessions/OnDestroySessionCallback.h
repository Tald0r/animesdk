...
#define EPIC_ONLINESERVICES_SESSIONS_ONDESTROYSESSIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18DA5BC0)
#define EPIC_ONLINESERVICES_SESSIONS_ONDESTROYSESSIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18DA5BF0)
#define EPIC_ONLINESERVICES_SESSIONS_ONDESTROYSESSIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DA56C0)
#define EPIC_ONLINESERVICES_SESSIONS_ONDESTROYSESSIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18DA56B0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnDestroySessionCallback_TypeDefinitionIndex = 32008;
