...
#define EPIC_ONLINESERVICES_SESSIONS_ONDESTROYSESSIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19101220)
#define EPIC_ONLINESERVICES_SESSIONS_ONDESTROYSESSIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19101250)
#define EPIC_ONLINESERVICES_SESSIONS_ONDESTROYSESSIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19100D20)
#define EPIC_ONLINESERVICES_SESSIONS_ONDESTROYSESSIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19100D00)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnDestroySessionCallback_TypeDefinitionIndex = 32962;
