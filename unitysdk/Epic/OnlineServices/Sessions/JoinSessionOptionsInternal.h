...
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x858B10)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x858AA0)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x858920)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x858A90)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_SET_PRESENCEENABLED_OFFSET UNITYSDK_OFFSET(0x8589E0)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_SET_SESSIONHANDLE_OFFSET UNITYSDK_OFFSET(0x858860)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x8587B0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int JoinSessionOptionsInternal_TypeDefinitionIndex = 32007;
