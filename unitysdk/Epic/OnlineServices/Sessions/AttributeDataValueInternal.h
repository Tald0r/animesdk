...
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x86AD90)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x86AAE0)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x86A9B0)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_GET_ASINT64_OFFSET UNITYSDK_OFFSET(0x86A880)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_GET_ASUTF8_OFFSET UNITYSDK_OFFSET(0x86ABF0)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x86AD20)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x86AB60)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x86AA40)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_ASINT64_OFFSET UNITYSDK_OFFSET(0x86A910)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_ASUTF8_OFFSET UNITYSDK_OFFSET(0x86AC70)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x86AD10)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int AttributeDataValueInternal_TypeDefinitionIndex = 32927;
