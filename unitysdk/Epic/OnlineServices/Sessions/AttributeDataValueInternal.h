...
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x83FFE0)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x83FD30)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x83FC00)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_GET_ASINT64_OFFSET UNITYSDK_OFFSET(0x83FAD0)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_GET_ASUTF8_OFFSET UNITYSDK_OFFSET(0x83FE40)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x83FF70)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x83FDB0)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x83FC90)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_ASINT64_OFFSET UNITYSDK_OFFSET(0x83FB60)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_ASUTF8_OFFSET UNITYSDK_OFFSET(0x83FEC0)
#define EPIC_ONLINESERVICES_SESSIONS_ATTRIBUTEDATAVALUEINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x83FF60)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int AttributeDataValueInternal_TypeDefinitionIndex = 31973;
