...
#define EPIC_ONLINESERVICES_SESSIONS_ONENDSESSIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19227D90)
#define EPIC_ONLINESERVICES_SESSIONS_ONENDSESSIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19227DC0)
#define EPIC_ONLINESERVICES_SESSIONS_ONENDSESSIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19227890)
#define EPIC_ONLINESERVICES_SESSIONS_ONENDSESSIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19227870)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnEndSessionCallback_TypeDefinitionIndex = 32964;
