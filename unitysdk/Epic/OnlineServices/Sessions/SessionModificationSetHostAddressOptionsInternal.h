...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x851650)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x851530)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONSINTERNAL_SET_HOSTADDRESS_OFFSET UNITYSDK_OFFSET(0x8513B0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x851460)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionModificationSetHostAddressOptionsInternal_TypeDefinitionIndex = 32080;
