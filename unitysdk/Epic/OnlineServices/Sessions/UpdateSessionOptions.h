...
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONS_GET_SESSIONMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x18F32730)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONS_SET_SESSIONMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x18F32740)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18F32750)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int UpdateSessionOptions_TypeDefinitionIndex = 32123;
