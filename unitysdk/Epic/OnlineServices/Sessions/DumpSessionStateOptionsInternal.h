...
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x905A40)
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x905920)
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x905850)
#define EPIC_ONLINESERVICES_SESSIONS_DUMPSESSIONSTATEOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x9057A0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int DumpSessionStateOptionsInternal_TypeDefinitionIndex = 32945;
