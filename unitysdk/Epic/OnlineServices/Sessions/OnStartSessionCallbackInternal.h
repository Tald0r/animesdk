...
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16E57070)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16E570C0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x16E56D70)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x16E56D60)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnStartSessionCallbackInternal_TypeDefinitionIndex = 32029;
