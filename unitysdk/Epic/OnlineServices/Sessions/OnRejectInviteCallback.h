...
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D4A510)
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D4A540)
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D4A010)
#define EPIC_ONLINESERVICES_SESSIONS_ONREJECTINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18D49FF0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnRejectInviteCallback_TypeDefinitionIndex = 32974;
