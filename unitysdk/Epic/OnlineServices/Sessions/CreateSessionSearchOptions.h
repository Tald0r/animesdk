...
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONS_GET_MAXSEARCHRESULTS_OFFSET UNITYSDK_OFFSET(0x18DD3600)
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONS_SET_MAXSEARCHRESULTS_OFFSET UNITYSDK_OFFSET(0x18DD3610)
#define EPIC_ONLINESERVICES_SESSIONS_CREATESESSIONSEARCHOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18DD3620)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int CreateSessionSearchOptions_TypeDefinitionIndex = 31984;
