...
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D4090)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D3F70)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D3EA0)
#define EPIC_ONLINESERVICES_SESSIONS_STARTSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x8D3DF0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int StartSessionOptionsInternal_TypeDefinitionIndex = 32114;
