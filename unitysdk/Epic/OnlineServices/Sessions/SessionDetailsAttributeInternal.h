...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x794090)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_GET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x2CB090)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_GET_DATA_OFFSET UNITYSDK_OFFSET(0x793F20)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x794080)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_SET_ADVERTISEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x3197D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_SET_DATA_OFFSET UNITYSDK_OFFSET(0x793F90)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONDETAILSATTRIBUTEINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x794000)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionDetailsAttributeInternal_TypeDefinitionIndex = 32055;
