...
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8968E0)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x896870)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONSINTERNAL_SET_INVITEID_OFFSET UNITYSDK_OFFSET(0x8967B0)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8966F0)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x896860)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int RejectInviteOptionsInternal_TypeDefinitionIndex = 32047;
