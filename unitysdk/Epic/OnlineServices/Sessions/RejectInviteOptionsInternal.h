...
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89E2D0)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x89E260)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONSINTERNAL_SET_INVITEID_OFFSET UNITYSDK_OFFSET(0x89E1A0)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x89E0E0)
#define EPIC_ONLINESERVICES_SESSIONS_REJECTINVITEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x89E250)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int RejectInviteOptionsInternal_TypeDefinitionIndex = 33001;
