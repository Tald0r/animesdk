...
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x894170)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x894040)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x893EB0)
#define EPIC_ONLINESERVICES_SESSIONS_QUERYINVITESOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x893F70)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int QueryInvitesOptionsInternal_TypeDefinitionIndex = 32993;
