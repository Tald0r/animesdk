...
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x85DB50)
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x85DA30)
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x85D960)
#define EPIC_ONLINESERVICES_SESSIONS_DESTROYSESSIONOPTIONSINTERNAL_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x85D8B0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int DestroySessionOptionsInternal_TypeDefinitionIndex = 31989;
