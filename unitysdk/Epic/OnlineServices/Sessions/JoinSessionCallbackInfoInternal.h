...
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x88DC10)
#define EPIC_ONLINESERVICES_SESSIONS_JOINSESSIONCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int JoinSessionCallbackInfoInternal_TypeDefinitionIndex = 32005;
