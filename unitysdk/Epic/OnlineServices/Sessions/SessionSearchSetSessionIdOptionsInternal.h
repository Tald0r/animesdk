...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETSESSIONIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8871E0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETSESSIONIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8871D0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETSESSIONIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x887110)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHSETSESSIONIDOPTIONSINTERNAL_SET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x887060)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionSearchSetSessionIdOptionsInternal_TypeDefinitionIndex = 33061;
