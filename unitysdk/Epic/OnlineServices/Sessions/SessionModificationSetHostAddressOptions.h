...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONS_GET_HOSTADDRESS_OFFSET UNITYSDK_OFFSET(0x19576D50)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONS_SET_HOSTADDRESS_OFFSET UNITYSDK_OFFSET(0x19576D60)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONMODIFICATIONSETHOSTADDRESSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19576D70)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionModificationSetHostAddressOptions_TypeDefinitionIndex = 33033;
