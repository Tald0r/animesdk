...
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19576C80)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19576CB0)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19576780)
#define EPIC_ONLINESERVICES_SESSIONS_ONSTARTSESSIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19576760)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnStartSessionCallback_TypeDefinitionIndex = 32982;
