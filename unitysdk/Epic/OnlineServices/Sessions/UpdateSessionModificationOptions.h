...
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONMODIFICATIONOPTIONS_GET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x16E596A0)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONMODIFICATIONOPTIONS_SET_SESSIONNAME_OFFSET UNITYSDK_OFFSET(0x16E596B0)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONMODIFICATIONOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x16E596C0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int UpdateSessionModificationOptions_TypeDefinitionIndex = 32121;
