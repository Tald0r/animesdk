...
#define EPIC_ONLINESERVICES_SESSIONS_ONUNREGISTERPLAYERSCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x187EB930)
#define EPIC_ONLINESERVICES_SESSIONS_ONUNREGISTERPLAYERSCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187EB980)
#define EPIC_ONLINESERVICES_SESSIONS_ONUNREGISTERPLAYERSCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x187EB630)
#define EPIC_ONLINESERVICES_SESSIONS_ONUNREGISTERPLAYERSCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x187EB620)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnUnregisterPlayersCallbackInternal_TypeDefinitionIndex = 32031;
