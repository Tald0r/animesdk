...
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8519C0)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x851890)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8517C0)
#define EPIC_ONLINESERVICES_SESSIONS_UPDATESESSIONOPTIONSINTERNAL_SET_SESSIONMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x851700)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int UpdateSessionOptionsInternal_TypeDefinitionIndex = 32124;
