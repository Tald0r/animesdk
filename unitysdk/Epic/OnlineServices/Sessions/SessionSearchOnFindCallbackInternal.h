...
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHONFINDCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18DA7850)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHONFINDCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18DA78A0)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHONFINDCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DA7550)
#define EPIC_ONLINESERVICES_SESSIONS_SESSIONSEARCHONFINDCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x18DA7540)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int SessionSearchOnFindCallbackInternal_TypeDefinitionIndex = 32099;
