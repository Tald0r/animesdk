...
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A8B7C0)
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A8B7F0)
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A8B2C0)
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A8B2B0)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnJoinSessionCallback_TypeDefinitionIndex = 32014;
