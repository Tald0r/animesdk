...
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19FCD620)
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19FCD650)
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19FCD120)
#define EPIC_ONLINESERVICES_SESSIONS_ONJOINSESSIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19FCD100)

namespace Epic::OnlineServices::Sessions
{
	inline static constexpr unsigned int OnJoinSessionCallback_TypeDefinitionIndex = 32968;
