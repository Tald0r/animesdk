...
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONS_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x1926E6E0)
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1926E700)
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONS_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x1926E6F0)
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1926E710)
#define EPIC_ONLINESERVICES_LOBBY_ADDNOTIFYRTCROOMCONNECTIONCHANGEDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1926E720)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int AddNotifyRTCRoomConnectionChangedOptions_TypeDefinitionIndex = 33506;
