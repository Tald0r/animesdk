...
#define EPIC_ONLINESERVICES_LOBBY_GETINVITECOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x854440)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITECOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x854310)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITECOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x854180)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITECOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x854240)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int GetInviteCountOptionsInternal_TypeDefinitionIndex = 32577;
