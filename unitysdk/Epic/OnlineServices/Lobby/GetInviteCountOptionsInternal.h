...
#define EPIC_ONLINESERVICES_LOBBY_GETINVITECOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x882730)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITECOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x882600)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITECOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x882470)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITECOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x882530)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int GetInviteCountOptionsInternal_TypeDefinitionIndex = 33531;
