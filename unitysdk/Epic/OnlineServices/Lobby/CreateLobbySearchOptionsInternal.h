...
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x88A6F0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONSINTERNAL_SET_MAXRESULTS_OFFSET UNITYSDK_OFFSET(0x2D38F0)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7A4F30)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int CreateLobbySearchOptionsInternal_TypeDefinitionIndex = 32571;
