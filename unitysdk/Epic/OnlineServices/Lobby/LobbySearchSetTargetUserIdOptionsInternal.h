...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETTARGETUSERIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8839A0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETTARGETUSERIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x883870)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETTARGETUSERIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8837A0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETTARGETUSERIDOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x8836E0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbySearchSetTargetUserIdOptionsInternal_TypeDefinitionIndex = 33624;
