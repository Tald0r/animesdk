...
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D9E2E0)
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D9E310)
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D9DDE0)
#define EPIC_ONLINESERVICES_LOBBY_ONKICKMEMBERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18D9DDD0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnKickMemberCallback_TypeDefinitionIndex = 32683;
