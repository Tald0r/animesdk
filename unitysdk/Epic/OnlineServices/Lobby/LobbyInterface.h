...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYJOINLOBBYACCEPTED_OFFSET UNITYSDK_OFFSET(0x199B80A0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYLOBBYINVITEACCEPTED_OFFSET UNITYSDK_OFFSET(0x199B8320)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYLOBBYINVITERECEIVED_OFFSET UNITYSDK_OFFSET(0x199B85A0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYLOBBYMEMBERSTATUSRECEIVED_OFFSET UNITYSDK_OFFSET(0x199B8820)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYLOBBYMEMBERUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0x199B8AA0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYLOBBYUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0x199B8D20)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ADDNOTIFYRTCROOMCONNECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x199B8FA0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_COPYLOBBYDETAILSHANDLEBYINVITEID_OFFSET UNITYSDK_OFFSET(0x199B9310)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_COPYLOBBYDETAILSHANDLEBYUIEVENTID_OFFSET UNITYSDK_OFFSET(0x199B9520)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_COPYLOBBYDETAILSHANDLE_OFFSET UNITYSDK_OFFSET(0x199B9180)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_CREATELOBBYSEARCH_OFFSET UNITYSDK_OFFSET(0x199B9870)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_CREATELOBBY_OFFSET UNITYSDK_OFFSET(0x199B96B0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_DESTROYLOBBY_OFFSET UNITYSDK_OFFSET(0x199B9A00)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_GETINVITECOUNT_OFFSET UNITYSDK_OFFSET(0x199B9BC0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_GETINVITEIDBYINDEX_OFFSET UNITYSDK_OFFSET(0x199B9DB0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_GETRTCROOMNAME_OFFSET UNITYSDK_OFFSET(0x199BA120)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ISRTCROOMCONNECTED_OFFSET UNITYSDK_OFFSET(0x199BA440)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_JOINLOBBY_OFFSET UNITYSDK_OFFSET(0x199BA610)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_KICKMEMBER_OFFSET UNITYSDK_OFFSET(0x199BA7D0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_LEAVELOBBY_OFFSET UNITYSDK_OFFSET(0x199BA990)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONCREATELOBBYCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B76F0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONDESTROYLOBBYCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7780)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONJOINLOBBYACCEPTEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7810)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONJOINLOBBYCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B78A0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONKICKMEMBERCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7930)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONLEAVELOBBYCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B79C0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONLOBBYINVITEACCEPTEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7A50)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONLOBBYINVITERECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7AE0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONLOBBYMEMBERSTATUSRECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7B70)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONLOBBYMEMBERUPDATERECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7C00)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONLOBBYUPDATERECEIVEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7C90)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONPROMOTEMEMBERCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7D20)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONQUERYINVITESCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7DB0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONREJECTINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7ED0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONRTCROOMCONNECTIONCHANGEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7E40)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONSENDINVITECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7F60)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_ONUPDATELOBBYCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x199B7FF0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_PROMOTEMEMBER_OFFSET UNITYSDK_OFFSET(0x199BAB50)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_QUERYINVITES_OFFSET UNITYSDK_OFFSET(0x199BAD30)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REJECTINVITE_OFFSET UNITYSDK_OFFSET(0x199BAF80)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYJOINLOBBYACCEPTED_OFFSET UNITYSDK_OFFSET(0x199BB160)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYLOBBYINVITEACCEPTED_OFFSET UNITYSDK_OFFSET(0x199BB240)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYLOBBYINVITERECEIVED_OFFSET UNITYSDK_OFFSET(0x199BB320)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYLOBBYMEMBERSTATUSRECEIVED_OFFSET UNITYSDK_OFFSET(0x199BB400)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYLOBBYMEMBERUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0x199BB4E0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYLOBBYUPDATERECEIVED_OFFSET UNITYSDK_OFFSET(0x199BB5C0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_REMOVENOTIFYRTCROOMCONNECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x199BB6A0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_SENDINVITE_OFFSET UNITYSDK_OFFSET(0x199BB780)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_UPDATELOBBYMODIFICATION_OFFSET UNITYSDK_OFFSET(0x199BBB80)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE_UPDATELOBBY_OFFSET UNITYSDK_OFFSET(0x199BB940)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x199B8090)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x199B8080)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbyInterface_TypeDefinitionIndex = 33576;
