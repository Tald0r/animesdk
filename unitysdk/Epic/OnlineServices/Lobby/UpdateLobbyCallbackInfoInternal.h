...
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x791830)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x791940)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int UpdateLobbyCallbackInfoInternal_TypeDefinitionIndex = 32728;
