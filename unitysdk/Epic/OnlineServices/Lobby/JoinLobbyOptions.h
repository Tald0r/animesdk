...
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_GET_LOBBYDETAILSHANDLE_OFFSET UNITYSDK_OFFSET(0x18D9AE50)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_GET_LOCALRTCOPTIONS_OFFSET UNITYSDK_OFFSET(0x18D9AEB0)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18D9AE70)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_GET_PRESENCEENABLED_OFFSET UNITYSDK_OFFSET(0x18D9AE90)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_SET_LOBBYDETAILSHANDLE_OFFSET UNITYSDK_OFFSET(0x18D9AE60)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_SET_LOCALRTCOPTIONS_OFFSET UNITYSDK_OFFSET(0x18D9AEC0)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x18D9AE80)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_SET_PRESENCEENABLED_OFFSET UNITYSDK_OFFSET(0x18D9AEA0)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18D9AED0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int JoinLobbyOptions_TypeDefinitionIndex = 32588;
