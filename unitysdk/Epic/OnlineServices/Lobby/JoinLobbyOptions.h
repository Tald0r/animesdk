...
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_GET_LOBBYDETAILSHANDLE_OFFSET UNITYSDK_OFFSET(0x190F6420)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_GET_LOCALRTCOPTIONS_OFFSET UNITYSDK_OFFSET(0x190F6480)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x190F6440)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_GET_PRESENCEENABLED_OFFSET UNITYSDK_OFFSET(0x190F6460)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_SET_LOBBYDETAILSHANDLE_OFFSET UNITYSDK_OFFSET(0x190F6430)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_SET_LOCALRTCOPTIONS_OFFSET UNITYSDK_OFFSET(0x190F6490)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x190F6450)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS_SET_PRESENCEENABLED_OFFSET UNITYSDK_OFFSET(0x190F6470)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x190F64A0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int JoinLobbyOptions_TypeDefinitionIndex = 33542;
