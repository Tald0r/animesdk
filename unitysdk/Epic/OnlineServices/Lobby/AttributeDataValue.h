...
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x17EDBF60)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x17EDBE00)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_GET_ASINT64_OFFSET UNITYSDK_OFFSET(0x17EDBCA0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_GET_ASUTF8_OFFSET UNITYSDK_OFFSET(0x17EDC0A0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x17EDC200)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x17EDC380)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x17EDC4E0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x17EDC620)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x17EDC220)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_1_OFFSET UNITYSDK_OFFSET(0x17EDCE60)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x17EDBFE0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x17EDBEA0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_ASINT64_OFFSET UNITYSDK_OFFSET(0x17EDBD40)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_ASUTF8_OFFSET UNITYSDK_OFFSET(0x17EDC120)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_OFFSET UNITYSDK_OFFSET(0x17EDC770)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x17EDC210)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x17EDC370)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int AttributeDataValue_TypeDefinitionIndex = 32558;
