...
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x184F4840)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x184F46E0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_GET_ASINT64_OFFSET UNITYSDK_OFFSET(0x184F4580)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_GET_ASUTF8_OFFSET UNITYSDK_OFFSET(0x184F4980)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x184F4AE0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x184F4C60)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x184F4DC0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_OP_IMPLICIT_3_OFFSET UNITYSDK_OFFSET(0x184F4F00)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x184F4B00)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_1_OFFSET UNITYSDK_OFFSET(0x184F5740)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x184F48C0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x184F4780)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_ASINT64_OFFSET UNITYSDK_OFFSET(0x184F4620)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_ASUTF8_OFFSET UNITYSDK_OFFSET(0x184F4A00)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_OFFSET UNITYSDK_OFFSET(0x184F5050)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE_SET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x184F4AF0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x184F4C50)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int AttributeDataValue_TypeDefinitionIndex = 33512;
