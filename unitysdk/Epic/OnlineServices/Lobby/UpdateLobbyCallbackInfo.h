...
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x184F6EF0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x184F6EB0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFO_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x184F6ED0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x184F6E90)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x184F70F0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x184F6EC0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFO_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x184F6EE0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x184F6F10)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x184F6EA0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x184F7360)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int UpdateLobbyCallbackInfo_TypeDefinitionIndex = 33681;
