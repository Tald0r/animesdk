...
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUEINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x88A100)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUEINTERNAL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x889E50)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUEINTERNAL_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x889D20)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUEINTERNAL_GET_ASINT64_OFFSET UNITYSDK_OFFSET(0x889BF0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUEINTERNAL_GET_ASUTF8_OFFSET UNITYSDK_OFFSET(0x889F60)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUEINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x88A090)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUEINTERNAL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x889ED0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUEINTERNAL_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x889DB0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUEINTERNAL_SET_ASINT64_OFFSET UNITYSDK_OFFSET(0x889C80)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUEINTERNAL_SET_ASUTF8_OFFSET UNITYSDK_OFFSET(0x889FE0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTEDATAVALUEINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x88A080)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int AttributeDataValueInternal_TypeDefinitionIndex = 32559;
