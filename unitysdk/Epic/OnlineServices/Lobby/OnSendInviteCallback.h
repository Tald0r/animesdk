...
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x195F6EC0)
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x195F6EF0)
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x195F69C0)
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x195F69B0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnSendInviteCallback_TypeDefinitionIndex = 32705;
