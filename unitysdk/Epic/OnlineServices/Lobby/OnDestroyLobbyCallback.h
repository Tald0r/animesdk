...
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1953E560)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1953E590)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1953CC40)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1953E550)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnDestroyLobbyCallback_TypeDefinitionIndex = 32677;
