...
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x199BDB50)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x199BDB80)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x199BC210)
#define EPIC_ONLINESERVICES_LOBBY_ONDESTROYLOBBYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199BDB30)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnDestroyLobbyCallback_TypeDefinitionIndex = 33631;
