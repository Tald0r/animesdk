...
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITECALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITECALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8D8CB0)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITECALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x8D8DC0)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITECALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int SendInviteCallbackInfoInternal_TypeDefinitionIndex = 32724;
