...
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x195F6600)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x195F6630)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x195F6100)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x195F60F0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnJoinLobbyCallback_TypeDefinitionIndex = 32681;
