...
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x193F7450)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x193F7480)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x193F6F50)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x193F6F30)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnJoinLobbyCallback_TypeDefinitionIndex = 33635;
