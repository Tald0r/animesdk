...
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYOPTIONS_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x17EDD480)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x17EDD460)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYOPTIONS_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x17EDD490)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x17EDD470)
#define EPIC_ONLINESERVICES_LOBBY_DESTROYLOBBYOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x17EDD4A0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int DestroyLobbyOptions_TypeDefinitionIndex = 32574;
