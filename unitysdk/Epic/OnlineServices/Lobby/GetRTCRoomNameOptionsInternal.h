...
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FDE70)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8FDE00)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x8FDC80)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8FDD30)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8FDDF0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int GetRTCRoomNameOptionsInternal_TypeDefinitionIndex = 33535;
