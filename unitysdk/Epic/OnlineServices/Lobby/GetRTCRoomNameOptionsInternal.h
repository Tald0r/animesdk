...
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8CACF0)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8CAC80)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x8CAB00)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8CABB0)
#define EPIC_ONLINESERVICES_LOBBY_GETRTCROOMNAMEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8CAC70)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int GetRTCRoomNameOptionsInternal_TypeDefinitionIndex = 32581;
