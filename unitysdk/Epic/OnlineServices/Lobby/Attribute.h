...
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x193F5BB0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE_GET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x193F5BD0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE_SET_1_OFFSET UNITYSDK_OFFSET(0x193F5D50)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE_SET_DATA_OFFSET UNITYSDK_OFFSET(0x193F5BC0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE_SET_OFFSET UNITYSDK_OFFSET(0x193F5BF0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE_SET_VISIBILITY_OFFSET UNITYSDK_OFFSET(0x193F5BE0)
#define EPIC_ONLINESERVICES_LOBBY_ATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x193F5F40)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int Attribute_TypeDefinitionIndex = 33508;
