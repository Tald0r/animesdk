...
#define EPIC_ONLINESERVICES_LOBBY_QUERYINVITESCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_LOBBY_QUERYINVITESCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8CB3A0)
#define EPIC_ONLINESERVICES_LOBBY_QUERYINVITESCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8CB4B0)
#define EPIC_ONLINESERVICES_LOBBY_QUERYINVITESCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int QueryInvitesCallbackInfoInternal_TypeDefinitionIndex = 32714;
