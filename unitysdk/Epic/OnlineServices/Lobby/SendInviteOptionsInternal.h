...
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8644A0)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x864430)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x8641F0)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8642A0)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x864420)
#define EPIC_ONLINESERVICES_LOBBY_SENDINVITEOPTIONSINTERNAL_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x864360)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int SendInviteOptionsInternal_TypeDefinitionIndex = 32726;
