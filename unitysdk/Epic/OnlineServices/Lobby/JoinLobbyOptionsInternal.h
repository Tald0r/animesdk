...
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D96B0)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D9640)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_SET_LOBBYDETAILSHANDLE_OFFSET UNITYSDK_OFFSET(0x8D9390)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_SET_LOCALRTCOPTIONS_OFFSET UNITYSDK_OFFSET(0x8D95C0)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8D9450)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D9630)
#define EPIC_ONLINESERVICES_LOBBY_JOINLOBBYOPTIONSINTERNAL_SET_PRESENCEENABLED_OFFSET UNITYSDK_OFFSET(0x8D9510)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int JoinLobbyOptionsInternal_TypeDefinitionIndex = 33543;
