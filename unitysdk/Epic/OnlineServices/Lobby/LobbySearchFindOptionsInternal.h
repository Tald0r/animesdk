...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHFINDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8BD790)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHFINDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8BD660)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHFINDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8BD4D0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHFINDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8BD590)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbySearchFindOptionsInternal_TypeDefinitionIndex = 33610;
