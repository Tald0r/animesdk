...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHFINDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x88C3B0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHFINDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x88C280)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHFINDOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x88C0F0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHFINDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x88C1B0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbySearchFindOptionsInternal_TypeDefinitionIndex = 32656;
