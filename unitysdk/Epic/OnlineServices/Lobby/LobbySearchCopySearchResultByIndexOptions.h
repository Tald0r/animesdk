...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHCOPYSEARCHRESULTBYINDEXOPTIONS_GET_LOBBYINDEX_OFFSET UNITYSDK_OFFSET(0x19D4B3B0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHCOPYSEARCHRESULTBYINDEXOPTIONS_SET_LOBBYINDEX_OFFSET UNITYSDK_OFFSET(0x19D4B3C0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHCOPYSEARCHRESULTBYINDEXOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19D4B3D0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbySearchCopySearchResultByIndexOptions_TypeDefinitionIndex = 33605;
