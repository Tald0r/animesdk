...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_COPYSEARCHRESULTBYINDEX_OFFSET UNITYSDK_OFFSET(0x18D9CCE0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_FIND_OFFSET UNITYSDK_OFFSET(0x18D9CE70)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_GETSEARCHRESULTCOUNT_OFFSET UNITYSDK_OFFSET(0x18D9D0C0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_ONFINDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x18D9CC30)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_RELEASE_OFFSET UNITYSDK_OFFSET(0x18D9D2E0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_REMOVEPARAMETER_OFFSET UNITYSDK_OFFSET(0x18D9D360)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_SETLOBBYID_OFFSET UNITYSDK_OFFSET(0x18D9D590)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_SETMAXRESULTS_OFFSET UNITYSDK_OFFSET(0x18D9D790)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_SETPARAMETER_OFFSET UNITYSDK_OFFSET(0x18D9D8F0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH_SETTARGETUSERID_OFFSET UNITYSDK_OFFSET(0x18D9DB20)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x18D9CCD0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCH__CTOR_OFFSET UNITYSDK_OFFSET(0x18D9CCC0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbySearch_TypeDefinitionIndex = 32650;
