...
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x272280)
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8D9860)
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x8D9970)
#define EPIC_ONLINESERVICES_LOBBY_LEAVELOBBYCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LeaveLobbyCallbackInfoInternal_TypeDefinitionIndex = 33549;
