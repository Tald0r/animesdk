...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETMAXRESULTSOPTIONS_GET_MAXRESULTS_OFFSET UNITYSDK_OFFSET(0x175B0B40)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETMAXRESULTSOPTIONS_SET_MAXRESULTS_OFFSET UNITYSDK_OFFSET(0x175B0B50)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYSEARCHSETMAXRESULTSOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x175B0B60)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbySearchSetMaxResultsOptions_TypeDefinitionIndex = 33619;
