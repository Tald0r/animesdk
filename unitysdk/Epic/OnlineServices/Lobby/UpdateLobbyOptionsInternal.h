...
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8BDB00)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8BD9D0)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONSINTERNAL_SET_LOBBYMODIFICATIONHANDLE_OFFSET UNITYSDK_OFFSET(0x8BD840)
#define EPIC_ONLINESERVICES_LOBBY_UPDATELOBBYOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8BD900)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int UpdateLobbyOptionsInternal_TypeDefinitionIndex = 33686;
