...
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS_COPYATTRIBUTEBYINDEX_OFFSET UNITYSDK_OFFSET(0x1926EF40)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS_COPYATTRIBUTEBYKEY_OFFSET UNITYSDK_OFFSET(0x1926F140)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS_COPYINFO_OFFSET UNITYSDK_OFFSET(0x1926F3D0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS_COPYMEMBERATTRIBUTEBYINDEX_OFFSET UNITYSDK_OFFSET(0x1926F670)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS_COPYMEMBERATTRIBUTEBYKEY_OFFSET UNITYSDK_OFFSET(0x1926F920)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS_GETATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x1926FB20)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS_GETLOBBYOWNER_OFFSET UNITYSDK_OFFSET(0x1926FD40)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS_GETMEMBERATTRIBUTECOUNT_OFFSET UNITYSDK_OFFSET(0x1926FF70)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS_GETMEMBERBYINDEX_OFFSET UNITYSDK_OFFSET(0x19270170)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS_GETMEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x192702D0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS_RELEASE_OFFSET UNITYSDK_OFFSET(0x192704F0)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1926EF30)
#define EPIC_ONLINESERVICES_LOBBY_LOBBYDETAILS__CTOR_OFFSET UNITYSDK_OFFSET(0x1926EF20)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LobbyDetails_TypeDefinitionIndex = 33553;
