...
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONS_GET_MAXRESULTS_OFFSET UNITYSDK_OFFSET(0x18D3FC50)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONS_SET_MAXRESULTS_OFFSET UNITYSDK_OFFSET(0x18D3FC60)
#define EPIC_ONLINESERVICES_LOBBY_CREATELOBBYSEARCHOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18D3FC70)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int CreateLobbySearchOptions_TypeDefinitionIndex = 33524;
