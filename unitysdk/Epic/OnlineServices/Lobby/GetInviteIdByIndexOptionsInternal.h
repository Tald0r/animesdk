...
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7A8D50)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7A8D40)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONSINTERNAL_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x3197D0)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x7A8BA0)
#define EPIC_ONLINESERVICES_LOBBY_GETINVITEIDBYINDEXOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7A8C60)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int GetInviteIdByIndexOptionsInternal_TypeDefinitionIndex = 32579;
