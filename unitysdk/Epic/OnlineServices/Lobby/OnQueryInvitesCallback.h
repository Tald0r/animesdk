...
#define EPIC_ONLINESERVICES_LOBBY_ONQUERYINVITESCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x199BDF00)
#define EPIC_ONLINESERVICES_LOBBY_ONQUERYINVITESCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x199BDF30)
#define EPIC_ONLINESERVICES_LOBBY_ONQUERYINVITESCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x199BC710)
#define EPIC_ONLINESERVICES_LOBBY_ONQUERYINVITESCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199BDEE0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnQueryInvitesCallback_TypeDefinitionIndex = 33653;
