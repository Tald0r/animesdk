...
#define EPIC_ONLINESERVICES_LOBBY_LOCALRTCOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define EPIC_ONLINESERVICES_LOBBY_LOCALRTCOPTIONSINTERNAL_GET_FLAGS_OFFSET UNITYSDK_OFFSET(0x302230)
#define EPIC_ONLINESERVICES_LOBBY_LOCALRTCOPTIONSINTERNAL_GET_LOCALAUDIODEVICEINPUTSTARTSMUTED_OFFSET UNITYSDK_OFFSET(0x7E52A0)
#define EPIC_ONLINESERVICES_LOBBY_LOCALRTCOPTIONSINTERNAL_GET_USEMANUALAUDIOINPUT_OFFSET UNITYSDK_OFFSET(0x7E4FE0)
#define EPIC_ONLINESERVICES_LOBBY_LOCALRTCOPTIONSINTERNAL_GET_USEMANUALAUDIOOUTPUT_OFFSET UNITYSDK_OFFSET(0x7E5140)
#define EPIC_ONLINESERVICES_LOBBY_LOCALRTCOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7E5410)
#define EPIC_ONLINESERVICES_LOBBY_LOCALRTCOPTIONSINTERNAL_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x302120)
#define EPIC_ONLINESERVICES_LOBBY_LOCALRTCOPTIONSINTERNAL_SET_LOCALAUDIODEVICEINPUTSTARTSMUTED_OFFSET UNITYSDK_OFFSET(0x7E5350)
#define EPIC_ONLINESERVICES_LOBBY_LOCALRTCOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7E5400)
#define EPIC_ONLINESERVICES_LOBBY_LOCALRTCOPTIONSINTERNAL_SET_USEMANUALAUDIOINPUT_OFFSET UNITYSDK_OFFSET(0x7E5090)
#define EPIC_ONLINESERVICES_LOBBY_LOCALRTCOPTIONSINTERNAL_SET_USEMANUALAUDIOOUTPUT_OFFSET UNITYSDK_OFFSET(0x7E51F0)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int LocalRTCOptionsInternal_TypeDefinitionIndex = 33628;
