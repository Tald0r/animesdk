...
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBERCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBERCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x864030)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBERCALLBACKINFOINTERNAL_GET_LOBBYID_OFFSET UNITYSDK_OFFSET(0x864140)
#define EPIC_ONLINESERVICES_LOBBY_PROMOTEMEMBERCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int PromoteMemberCallbackInfoInternal_TypeDefinitionIndex = 32710;
