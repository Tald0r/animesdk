...
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190BC140)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190BC190)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x190BBE40)
#define EPIC_ONLINESERVICES_LOBBY_ONJOINLOBBYCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x190BBE30)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnJoinLobbyCallbackInternal_TypeDefinitionIndex = 32682;
