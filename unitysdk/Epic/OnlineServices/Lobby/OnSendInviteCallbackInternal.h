...
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1915AF60)
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1915AFB0)
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1915AC70)
#define EPIC_ONLINESERVICES_LOBBY_ONSENDINVITECALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1915AC50)

namespace Epic::OnlineServices::Lobby
{
	inline static constexpr unsigned int OnSendInviteCallbackInternal_TypeDefinitionIndex = 33660;
