...
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_GET_OPTIONALEXTERNALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1915D200)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_GET_OPTIONALINTERNALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1915D1E0)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_GET_RESERVED_OFFSET UNITYSDK_OFFSET(0x1915D1C0)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_1_OFFSET UNITYSDK_OFFSET(0x1915D4B0)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_OFFSET UNITYSDK_OFFSET(0x1915D220)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_OPTIONALEXTERNALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1915D210)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_OPTIONALINTERNALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1915D1F0)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_RESERVED_OFFSET UNITYSDK_OFFSET(0x1915D1D0)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1915D7E0)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int AndroidInitializeOptionsSystemInitializeOptions_TypeDefinitionIndex = 34242;
