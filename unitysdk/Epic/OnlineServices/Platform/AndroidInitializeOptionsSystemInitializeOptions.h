...
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_GET_OPTIONALEXTERNALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x18DCBF60)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_GET_OPTIONALINTERNALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x18DCBF40)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_GET_RESERVED_OFFSET UNITYSDK_OFFSET(0x18DCBF20)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_1_OFFSET UNITYSDK_OFFSET(0x18DCC210)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_OFFSET UNITYSDK_OFFSET(0x18DCBF80)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_OPTIONALEXTERNALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x18DCBF70)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_OPTIONALINTERNALDIRECTORY_OFFSET UNITYSDK_OFFSET(0x18DCBF50)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS_SET_RESERVED_OFFSET UNITYSDK_OFFSET(0x18DCBF30)
#define EPIC_ONLINESERVICES_PLATFORM_ANDROIDINITIALIZEOPTIONSSYSTEMINITIALIZEOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18DCC540)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int AndroidInitializeOptionsSystemInitializeOptions_TypeDefinitionIndex = 33288;
