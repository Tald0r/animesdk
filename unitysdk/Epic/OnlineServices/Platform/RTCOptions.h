...
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONS_GET_PLATFORMSPECIFICOPTIONS_OFFSET UNITYSDK_OFFSET(0x19FC9630)
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONS_SET_1_OFFSET UNITYSDK_OFFSET(0x19FC96C0)
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONS_SET_OFFSET UNITYSDK_OFFSET(0x19FC9650)
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONS_SET_PLATFORMSPECIFICOPTIONS_OFFSET UNITYSDK_OFFSET(0x19FC9640)
#define EPIC_ONLINESERVICES_PLATFORM_RTCOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19FC9800)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int RTCOptions_TypeDefinitionIndex = 34255;
