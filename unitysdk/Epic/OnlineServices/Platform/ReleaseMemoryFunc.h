...
#define EPIC_ONLINESERVICES_PLATFORM_RELEASEMEMORYFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18D44920)
#define EPIC_ONLINESERVICES_PLATFORM_RELEASEMEMORYFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18D44970)
#define EPIC_ONLINESERVICES_PLATFORM_RELEASEMEMORYFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x18D44630)
#define EPIC_ONLINESERVICES_PLATFORM_RELEASEMEMORYFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x18D44610)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int ReleaseMemoryFunc_TypeDefinitionIndex = 34258;
