...
#define EPIC_ONLINESERVICES_PLATFORM_RELEASEMEMORYFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x187E5A50)
#define EPIC_ONLINESERVICES_PLATFORM_RELEASEMEMORYFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x187E5AA0)
#define EPIC_ONLINESERVICES_PLATFORM_RELEASEMEMORYFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x187E5750)
#define EPIC_ONLINESERVICES_PLATFORM_RELEASEMEMORYFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x187E5740)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int ReleaseMemoryFunc_TypeDefinitionIndex = 33304;
