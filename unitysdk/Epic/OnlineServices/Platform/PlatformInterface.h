...
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_CHECKFORLAUNCHERANDRESTART_OFFSET UNITYSDK_OFFSET(0x195F9840)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_CREATE_1_OFFSET UNITYSDK_OFFSET(0x195FC100)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_CREATE_OFFSET UNITYSDK_OFFSET(0x195F98C0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETACHIEVEMENTSINTERFACE_OFFSET UNITYSDK_OFFSET(0x195F9A10)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETACTIVECOUNTRYCODE_OFFSET UNITYSDK_OFFSET(0x195F9AF0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETACTIVELOCALECODE_OFFSET UNITYSDK_OFFSET(0x195F9DB0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETANTICHEATCLIENTINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FA070)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETANTICHEATSERVERINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FA150)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETAUTHINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FA230)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETCONNECTINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FA310)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETCUSTOMINVITESINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FA3F0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETECOMINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FA4D0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETFRIENDSINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FA5B0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETKWSINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FA690)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETLEADERBOARDSINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FA770)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETLOBBYINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FA850)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETMETRICSINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FA930)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETMODSINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FAA10)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETOVERRIDECOUNTRYCODE_OFFSET UNITYSDK_OFFSET(0x195FAAF0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETOVERRIDELOCALECODE_OFFSET UNITYSDK_OFFSET(0x195FAD20)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETP2PINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FAF50)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETPLAYERDATASTORAGEINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FB030)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETPRESENCEINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FB110)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETPROGRESSIONSNAPSHOTINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FB1F0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETREPORTSINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FB490)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETRTCADMININTERFACE_OFFSET UNITYSDK_OFFSET(0x195FB2D0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETRTCINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FB3B0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETSANCTIONSINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FB570)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETSESSIONSINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FB650)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETSTATSINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FB730)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETTITLESTORAGEINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FB810)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETUIINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FB8F0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_GETUSERINFOINTERFACE_OFFSET UNITYSDK_OFFSET(0x195FB9D0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_INITIALIZE_1_OFFSET UNITYSDK_OFFSET(0x195FBAB0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x195F96D0)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_RELEASE_OFFSET UNITYSDK_OFFSET(0x195FBC00)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_SETOVERRIDECOUNTRYCODE_OFFSET UNITYSDK_OFFSET(0x195FBC80)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_SETOVERRIDELOCALECODE_OFFSET UNITYSDK_OFFSET(0x195FBE40)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_SHUTDOWN_OFFSET UNITYSDK_OFFSET(0x195FC000)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE_TICK_OFFSET UNITYSDK_OFFSET(0x195FC080)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x195F9830)
#define EPIC_ONLINESERVICES_PLATFORM_PLATFORMINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x195F9820)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int PlatformInterface_TypeDefinitionIndex = 33290;
