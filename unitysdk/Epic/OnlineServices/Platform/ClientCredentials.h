...
#define EPIC_ONLINESERVICES_PLATFORM_CLIENTCREDENTIALS_GET_CLIENTID_OFFSET UNITYSDK_OFFSET(0x1915D7F0)
#define EPIC_ONLINESERVICES_PLATFORM_CLIENTCREDENTIALS_GET_CLIENTSECRET_OFFSET UNITYSDK_OFFSET(0x1915D810)
#define EPIC_ONLINESERVICES_PLATFORM_CLIENTCREDENTIALS_SET_1_OFFSET UNITYSDK_OFFSET(0x1915DAB0)
#define EPIC_ONLINESERVICES_PLATFORM_CLIENTCREDENTIALS_SET_CLIENTID_OFFSET UNITYSDK_OFFSET(0x1915D800)
#define EPIC_ONLINESERVICES_PLATFORM_CLIENTCREDENTIALS_SET_CLIENTSECRET_OFFSET UNITYSDK_OFFSET(0x1915D820)
#define EPIC_ONLINESERVICES_PLATFORM_CLIENTCREDENTIALS_SET_OFFSET UNITYSDK_OFFSET(0x1915D830)
#define EPIC_ONLINESERVICES_PLATFORM_CLIENTCREDENTIALS__CTOR_OFFSET UNITYSDK_OFFSET(0x1915DDD0)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int ClientCredentials_TypeDefinitionIndex = 34246;
