...
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x89D2B0)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x89D240)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_CACHEDIRECTORY_OFFSET UNITYSDK_OFFSET(0x89D110)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_CLIENTCREDENTIALS_OFFSET UNITYSDK_OFFSET(0x89CD20)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_DEPLOYMENTID_OFFSET UNITYSDK_OFFSET(0x89D050)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_ENCRYPTIONKEY_OFFSET UNITYSDK_OFFSET(0x89CE40)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_FLAGS_OFFSET UNITYSDK_OFFSET(0x89D100)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_ISSERVER_OFFSET UNITYSDK_OFFSET(0x89CD90)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x89D230)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_OVERRIDECOUNTRYCODE_OFFSET UNITYSDK_OFFSET(0x89CEF0)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_OVERRIDELOCALECODE_OFFSET UNITYSDK_OFFSET(0x89CFA0)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_PRODUCTID_OFFSET UNITYSDK_OFFSET(0x89CBC0)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_RESERVED_OFFSET UNITYSDK_OFFSET(0x302310)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_RTCOPTIONS_OFFSET UNITYSDK_OFFSET(0x89D1C0)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_SANDBOXID_OFFSET UNITYSDK_OFFSET(0x89CC70)
#define EPIC_ONLINESERVICES_PLATFORM_OPTIONSINTERNAL_SET_TICKBUDGETINMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x7E2280)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int OptionsInternal_TypeDefinitionIndex = 34253;
