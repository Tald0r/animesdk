...
#define EPIC_ONLINESERVICES_PLATFORM_ALLOCATEMEMORYFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x175B49F0)
#define EPIC_ONLINESERVICES_PLATFORM_ALLOCATEMEMORYFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x175B4A60)
#define EPIC_ONLINESERVICES_PLATFORM_ALLOCATEMEMORYFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x175B4690)
#define EPIC_ONLINESERVICES_PLATFORM_ALLOCATEMEMORYFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x175B4670)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int AllocateMemoryFunc_TypeDefinitionIndex = 34245;
