...
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D2880)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D2810)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_ALLOCATEMEMORYFUNCTION_OFFSET UNITYSDK_OFFSET(0x2CB170)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D2800)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_OVERRIDETHREADAFFINITY_OFFSET UNITYSDK_OFFSET(0x8D2790)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_PRODUCTNAME_OFFSET UNITYSDK_OFFSET(0x8D2630)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_PRODUCTVERSION_OFFSET UNITYSDK_OFFSET(0x8D26E0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_REALLOCATEMEMORYFUNCTION_OFFSET UNITYSDK_OFFSET(0x2D26A0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_RELEASEMEMORYFUNCTION_OFFSET UNITYSDK_OFFSET(0x3197C0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_SYSTEMINITIALIZEOPTIONS_OFFSET UNITYSDK_OFFSET(0x379D80)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int InitializeOptionsInternal_TypeDefinitionIndex = 33295;
