...
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F39F0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8F3980)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_ALLOCATEMEMORYFUNCTION_OFFSET UNITYSDK_OFFSET(0x302310)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8F3970)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_OVERRIDETHREADAFFINITY_OFFSET UNITYSDK_OFFSET(0x8F3900)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_PRODUCTNAME_OFFSET UNITYSDK_OFFSET(0x8F37A0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_PRODUCTVERSION_OFFSET UNITYSDK_OFFSET(0x8F3850)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_REALLOCATEMEMORYFUNCTION_OFFSET UNITYSDK_OFFSET(0x3123A0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_RELEASEMEMORYFUNCTION_OFFSET UNITYSDK_OFFSET(0x302AF0)
#define EPIC_ONLINESERVICES_PLATFORM_INITIALIZEOPTIONSINTERNAL_SET_SYSTEMINITIALIZEOPTIONS_OFFSET UNITYSDK_OFFSET(0x3186E0)

namespace Epic::OnlineServices::Platform
{
	inline static constexpr unsigned int InitializeOptionsInternal_TypeDefinitionIndex = 34249;
