...
#define EPIC_ONLINESERVICES_LEADERBOARDS_GETLEADERBOARDUSERSCORECOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D92E0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_GETLEADERBOARDUSERSCORECOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D91C0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_GETLEADERBOARDUSERSCORECOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D90F0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_GETLEADERBOARDUSERSCORECOUNTOPTIONSINTERNAL_SET_STATNAME_OFFSET UNITYSDK_OFFSET(0x8D9040)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int GetLeaderboardUserScoreCountOptionsInternal_TypeDefinitionIndex = 33706;
