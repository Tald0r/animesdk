...
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_COPYLEADERBOARDDEFINITIONBYINDEX_OFFSET UNITYSDK_OFFSET(0x19771B70)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_COPYLEADERBOARDDEFINITIONBYLEADERBOARDID_OFFSET UNITYSDK_OFFSET(0x19771D70)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_COPYLEADERBOARDRECORDBYINDEX_OFFSET UNITYSDK_OFFSET(0x19772000)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_COPYLEADERBOARDRECORDBYUSERID_OFFSET UNITYSDK_OFFSET(0x19772200)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_COPYLEADERBOARDUSERSCOREBYINDEX_OFFSET UNITYSDK_OFFSET(0x19772490)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_COPYLEADERBOARDUSERSCOREBYUSERID_OFFSET UNITYSDK_OFFSET(0x19772720)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_GETLEADERBOARDDEFINITIONCOUNT_OFFSET UNITYSDK_OFFSET(0x19772920)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_GETLEADERBOARDRECORDCOUNT_OFFSET UNITYSDK_OFFSET(0x19772B40)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_GETLEADERBOARDUSERSCORECOUNT_OFFSET UNITYSDK_OFFSET(0x19772D60)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_ONQUERYLEADERBOARDDEFINITIONSCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x197719A0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_ONQUERYLEADERBOARDRANKSCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19771A30)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_ONQUERYLEADERBOARDUSERSCORESCOMPLETECALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x19771AC0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_QUERYLEADERBOARDDEFINITIONS_OFFSET UNITYSDK_OFFSET(0x19772F60)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_QUERYLEADERBOARDRANKS_OFFSET UNITYSDK_OFFSET(0x19773120)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE_QUERYLEADERBOARDUSERSCORES_OFFSET UNITYSDK_OFFSET(0x197732E0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19771B60)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDSINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x19771B50)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int LeaderboardsInterface_TypeDefinitionIndex = 32758;
