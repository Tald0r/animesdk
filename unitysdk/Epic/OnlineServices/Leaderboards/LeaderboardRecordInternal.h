...
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORDINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8FD040)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORDINTERNAL_GET_RANK_OFFSET UNITYSDK_OFFSET(0x302AD0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORDINTERNAL_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x338550)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORDINTERNAL_GET_USERDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8FCE60)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORDINTERNAL_GET_USERID_OFFSET UNITYSDK_OFFSET(0x8FCD30)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORDINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8FCFD0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORDINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8FCFC0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORDINTERNAL_SET_RANK_OFFSET UNITYSDK_OFFSET(0x302AE0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORDINTERNAL_SET_SCORE_OFFSET UNITYSDK_OFFSET(0x338540)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORDINTERNAL_SET_USERDISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8FCF10)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDRECORDINTERNAL_SET_USERID_OFFSET UNITYSDK_OFFSET(0x8FCDA0)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int LeaderboardRecordInternal_TypeDefinitionIndex = 33709;
