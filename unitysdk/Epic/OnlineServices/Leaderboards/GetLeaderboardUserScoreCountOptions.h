...
#define EPIC_ONLINESERVICES_LEADERBOARDS_GETLEADERBOARDUSERSCORECOUNTOPTIONS_GET_STATNAME_OFFSET UNITYSDK_OFFSET(0x1956C0F0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_GETLEADERBOARDUSERSCORECOUNTOPTIONS_SET_STATNAME_OFFSET UNITYSDK_OFFSET(0x1956C100)
#define EPIC_ONLINESERVICES_LEADERBOARDS_GETLEADERBOARDUSERSCORECOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1956C110)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int GetLeaderboardUserScoreCountOptions_TypeDefinitionIndex = 33705;
