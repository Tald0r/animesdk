...
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE_GET_SCORE_OFFSET UNITYSDK_OFFSET(0x1A070380)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE_GET_USERID_OFFSET UNITYSDK_OFFSET(0x1A070360)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE_SET_1_OFFSET UNITYSDK_OFFSET(0x1A070500)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE_SET_OFFSET UNITYSDK_OFFSET(0x1A0703A0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE_SET_SCORE_OFFSET UNITYSDK_OFFSET(0x1A070390)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE_SET_USERID_OFFSET UNITYSDK_OFFSET(0x1A070370)
#define EPIC_ONLINESERVICES_LEADERBOARDS_LEADERBOARDUSERSCORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0706F0)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int LeaderboardUserScore_TypeDefinitionIndex = 33710;
