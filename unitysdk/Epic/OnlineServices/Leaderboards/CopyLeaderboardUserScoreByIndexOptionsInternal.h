...
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYINDEXOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B9E70)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYINDEXOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8B9E60)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYINDEXOPTIONSINTERNAL_SET_LEADERBOARDUSERSCOREINDEX_OFFSET UNITYSDK_OFFSET(0x2D38F0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYINDEXOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B9D90)
#define EPIC_ONLINESERVICES_LEADERBOARDS_COPYLEADERBOARDUSERSCOREBYINDEXOPTIONSINTERNAL_SET_STATNAME_OFFSET UNITYSDK_OFFSET(0x8B9CE0)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int CopyLeaderboardUserScoreByIndexOptionsInternal_TypeDefinitionIndex = 32742;
