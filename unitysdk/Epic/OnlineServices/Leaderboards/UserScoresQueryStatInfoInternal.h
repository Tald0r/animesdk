...
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8BAC00)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_GET_AGGREGATION_OFFSET UNITYSDK_OFFSET(0x302AD0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_GET_STATNAME_OFFSET UNITYSDK_OFFSET(0x8BA9C0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8BABF0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_SET_AGGREGATION_OFFSET UNITYSDK_OFFSET(0x302AE0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8BAB20)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFOINTERNAL_SET_STATNAME_OFFSET UNITYSDK_OFFSET(0x8BAA70)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int UserScoresQueryStatInfoInternal_TypeDefinitionIndex = 33732;
