...
#define EPIC_ONLINESERVICES_LEADERBOARDS_ONQUERYLEADERBOARDRANKSCOMPLETECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19D4A1B0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_ONQUERYLEADERBOARDRANKSCOMPLETECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19D4A1E0)
#define EPIC_ONLINESERVICES_LEADERBOARDS_ONQUERYLEADERBOARDRANKSCOMPLETECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19D49C90)
#define EPIC_ONLINESERVICES_LEADERBOARDS_ONQUERYLEADERBOARDRANKSCOMPLETECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19D4A190)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int OnQueryLeaderboardRanksCompleteCallback_TypeDefinitionIndex = 33717;
