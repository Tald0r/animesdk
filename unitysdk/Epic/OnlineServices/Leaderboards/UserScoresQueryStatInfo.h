...
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFO_GET_AGGREGATION_OFFSET UNITYSDK_OFFSET(0x1A057530)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFO_GET_STATNAME_OFFSET UNITYSDK_OFFSET(0x1A057510)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1A057700)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFO_SET_AGGREGATION_OFFSET UNITYSDK_OFFSET(0x1A057540)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFO_SET_OFFSET UNITYSDK_OFFSET(0x1A057550)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFO_SET_STATNAME_OFFSET UNITYSDK_OFFSET(0x1A057520)
#define EPIC_ONLINESERVICES_LEADERBOARDS_USERSCORESQUERYSTATINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A057950)

namespace Epic::OnlineServices::Leaderboards
{
	inline static constexpr unsigned int UserScoresQueryStatInfo_TypeDefinitionIndex = 33731;
