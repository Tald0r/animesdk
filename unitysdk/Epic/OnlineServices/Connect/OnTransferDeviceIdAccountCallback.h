...
#define EPIC_ONLINESERVICES_CONNECT_ONTRANSFERDEVICEIDACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A66AD0)
#define EPIC_ONLINESERVICES_CONNECT_ONTRANSFERDEVICEIDACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A66B00)
#define EPIC_ONLINESERVICES_CONNECT_ONTRANSFERDEVICEIDACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A665D0)
#define EPIC_ONLINESERVICES_CONNECT_ONTRANSFERDEVICEIDACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A665C0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnTransferDeviceIdAccountCallback_TypeDefinitionIndex = 33053;
