...
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x853860)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_GET_JSONWEBTOKEN_OFFSET UNITYSDK_OFFSET(0x853680)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_GET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x853550)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8537F0)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_SET_JSONWEBTOKEN_OFFSET UNITYSDK_OFFSET(0x853730)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8537E0)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_SET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x8535C0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int IdTokenInternal_TypeDefinitionIndex = 33024;
