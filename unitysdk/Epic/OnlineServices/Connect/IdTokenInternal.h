...
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x881B50)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_GET_JSONWEBTOKEN_OFFSET UNITYSDK_OFFSET(0x881970)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_GET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x881840)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x881AE0)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_SET_JSONWEBTOKEN_OFFSET UNITYSDK_OFFSET(0x881A20)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x881AD0)
#define EPIC_ONLINESERVICES_CONNECT_IDTOKENINTERNAL_SET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x8818B0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int IdTokenInternal_TypeDefinitionIndex = 33978;
