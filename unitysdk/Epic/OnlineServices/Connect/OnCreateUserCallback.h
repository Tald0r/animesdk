...
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A80A60)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A80A90)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A80560)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEUSERCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19A80550)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnCreateUserCallback_TypeDefinitionIndex = 33039;
