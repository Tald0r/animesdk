...
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18F22EC0)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18F22EF0)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18F229C0)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18F229B0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnUnlinkAccountCallback_TypeDefinitionIndex = 33055;
