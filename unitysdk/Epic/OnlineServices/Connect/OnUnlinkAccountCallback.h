...
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1926B110)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1926B140)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1926AC10)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1926ABF0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnUnlinkAccountCallback_TypeDefinitionIndex = 34009;
