...
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONS_GET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x1A06DD20)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1A06DD00)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONS_SET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x1A06DD30)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1A06DD10)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A06DD40)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int LinkAccountOptions_TypeDefinitionIndex = 33981;
