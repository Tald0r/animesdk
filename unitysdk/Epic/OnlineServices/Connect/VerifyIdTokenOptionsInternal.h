...
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D8100)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D80F0)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENOPTIONSINTERNAL_SET_IDTOKEN_OFFSET UNITYSDK_OFFSET(0x8D8000)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D8070)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int VerifyIdTokenOptionsInternal_TypeDefinitionIndex = 33080;
