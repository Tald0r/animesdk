...
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_GET_ACCOUNTIDTYPE_OFFSET UNITYSDK_OFFSET(0x190D8C50)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x190D8C30)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x190D8C10)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_GET_LASTLOGINTIME_OFFSET UNITYSDK_OFFSET(0x190D8C70)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_GET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x190D8BF0)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x190D9120)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_ACCOUNTIDTYPE_OFFSET UNITYSDK_OFFSET(0x190D8C60)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x190D8C40)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x190D8C20)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_LASTLOGINTIME_OFFSET UNITYSDK_OFFSET(0x190D8C90)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_OFFSET UNITYSDK_OFFSET(0x190D8CA0)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO_SET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x190D8C00)
#define EPIC_ONLINESERVICES_CONNECT_EXTERNALACCOUNTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x190D9270)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int ExternalAccountInfo_TypeDefinitionIndex = 33015;
