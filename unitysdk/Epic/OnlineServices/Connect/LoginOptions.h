...
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONS_GET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x184EC9A0)
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONS_GET_USERLOGININFO_OFFSET UNITYSDK_OFFSET(0x184EC9C0)
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONS_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x184EC9B0)
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONS_SET_USERLOGININFO_OFFSET UNITYSDK_OFFSET(0x184EC9D0)
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x184EC9E0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int LoginOptions_TypeDefinitionIndex = 33985;
