...
#define EPIC_ONLINESERVICES_CONNECT_ONLINKACCOUNTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x184ED280)
#define EPIC_ONLINESERVICES_CONNECT_ONLINKACCOUNTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x184ED2B0)
#define EPIC_ONLINESERVICES_CONNECT_ONLINKACCOUNTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x184ECD80)
#define EPIC_ONLINESERVICES_CONNECT_ONLINKACCOUNTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x184ECD60)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnLinkAccountCallback_TypeDefinitionIndex = 33997;
