...
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B97D0)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8B96A0)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8B9510)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B95D0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int UnlinkAccountOptionsInternal_TypeDefinitionIndex = 34028;
