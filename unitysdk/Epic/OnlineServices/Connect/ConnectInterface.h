...
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ADDNOTIFYAUTHEXPIRATION_OFFSET UNITYSDK_OFFSET(0x187D8CF0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ADDNOTIFYLOGINSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x187D8F70)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_COPYIDTOKEN_OFFSET UNITYSDK_OFFSET(0x187D91F0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_COPYPRODUCTUSEREXTERNALACCOUNTBYACCOUNTID_OFFSET UNITYSDK_OFFSET(0x187D9480)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_COPYPRODUCTUSEREXTERNALACCOUNTBYACCOUNTTYPE_OFFSET UNITYSDK_OFFSET(0x187D9680)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_COPYPRODUCTUSEREXTERNALACCOUNTBYINDEX_OFFSET UNITYSDK_OFFSET(0x187D9930)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_COPYPRODUCTUSERINFO_OFFSET UNITYSDK_OFFSET(0x187D9BE0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_CREATEDEVICEID_OFFSET UNITYSDK_OFFSET(0x187D9E70)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_CREATEUSER_OFFSET UNITYSDK_OFFSET(0x187DA0C0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_DELETEDEVICEID_OFFSET UNITYSDK_OFFSET(0x187DA310)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_GETEXTERNALACCOUNTMAPPING_OFFSET UNITYSDK_OFFSET(0x187DA580)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_GETLOGGEDINUSERBYINDEX_OFFSET UNITYSDK_OFFSET(0x187DA6E0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_GETLOGGEDINUSERSCOUNT_OFFSET UNITYSDK_OFFSET(0x187DA7D0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_GETLOGINSTATUS_OFFSET UNITYSDK_OFFSET(0x187DA850)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_GETPRODUCTUSEREXTERNALACCOUNTCOUNT_OFFSET UNITYSDK_OFFSET(0x187DA9B0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_GETPRODUCTUSERIDMAPPING_OFFSET UNITYSDK_OFFSET(0x187DABB0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_LINKACCOUNT_OFFSET UNITYSDK_OFFSET(0x187DAE70)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_LOGIN_OFFSET UNITYSDK_OFFSET(0x187DB030)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONAUTHEXPIRATIONCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x187D85F0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONCREATEDEVICEIDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x187D8680)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONCREATEUSERCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x187D8710)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONDELETEDEVICEIDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x187D87A0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONLINKACCOUNTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x187D8830)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONLOGINCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x187D88C0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONLOGINSTATUSCHANGEDCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x187D8950)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONQUERYEXTERNALACCOUNTMAPPINGSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x187D89E0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONQUERYPRODUCTUSERIDMAPPINGSCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x187D8A70)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONTRANSFERDEVICEIDACCOUNTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x187D8B00)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONUNLINKACCOUNTCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x187D8B90)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_ONVERIFYIDTOKENCALLBACKINTERNALIMPLEMENTATION_OFFSET UNITYSDK_OFFSET(0x187D8C20)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_QUERYEXTERNALACCOUNTMAPPINGS_OFFSET UNITYSDK_OFFSET(0x187DB1F0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_QUERYPRODUCTUSERIDMAPPINGS_OFFSET UNITYSDK_OFFSET(0x187DB3B0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_REMOVENOTIFYAUTHEXPIRATION_OFFSET UNITYSDK_OFFSET(0x187DB570)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_REMOVENOTIFYLOGINSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x187DB650)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_TRANSFERDEVICEIDACCOUNT_OFFSET UNITYSDK_OFFSET(0x187DB730)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_UNLINKACCOUNT_OFFSET UNITYSDK_OFFSET(0x187DB8F0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE_VERIFYIDTOKEN_OFFSET UNITYSDK_OFFSET(0x187DBB40)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x187D8CD0)
#define EPIC_ONLINESERVICES_CONNECT_CONNECTINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x187D8CB0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int ConnectInterface_TypeDefinitionIndex = 32990;
