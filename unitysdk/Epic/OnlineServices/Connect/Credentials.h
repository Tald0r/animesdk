...
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALS_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x19A7FC10)
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALS_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19A7FC30)
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALS_SET_1_OFFSET UNITYSDK_OFFSET(0x19A7FE00)
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALS_SET_OFFSET UNITYSDK_OFFSET(0x19A7FC50)
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALS_SET_TOKEN_OFFSET UNITYSDK_OFFSET(0x19A7FC20)
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALS_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x19A7FC40)
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A80050)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int Credentials_TypeDefinitionIndex = 33009;
