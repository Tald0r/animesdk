...
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSEREXTERNALACCOUNTCOUNTOPTIONS_GET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x18DC1CF0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSEREXTERNALACCOUNTCOUNTOPTIONS_SET_TARGETUSERID_OFFSET UNITYSDK_OFFSET(0x18DC1D00)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSEREXTERNALACCOUNTCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x18DC1D10)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int GetProductUserExternalAccountCountOptions_TypeDefinitionIndex = 33019;
