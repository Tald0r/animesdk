...
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x1926B1B0)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1926B170)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1926B190)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1926B150)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x1926B360)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x1926B180)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x1926B1A0)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x1926B1D0)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x1926B160)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1926B580)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int UnlinkAccountCallbackInfo_TypeDefinitionIndex = 34025;
