...
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x195F1510)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x195F1560)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x195F1210)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x195F1200)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnUnlinkAccountCallbackInternal_TypeDefinitionIndex = 33056;
