...
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x193F2340)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x193F2390)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x193F2050)
#define EPIC_ONLINESERVICES_CONNECT_ONUNLINKACCOUNTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x193F2030)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnUnlinkAccountCallbackInternal_TypeDefinitionIndex = 34010;
