...
#define EPIC_ONLINESERVICES_CONNECT_GETEXTERNALACCOUNTMAPPINGSOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F17A0)
#define EPIC_ONLINESERVICES_CONNECT_GETEXTERNALACCOUNTMAPPINGSOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8F1730)
#define EPIC_ONLINESERVICES_CONNECT_GETEXTERNALACCOUNTMAPPINGSOPTIONSINTERNAL_SET_ACCOUNTIDTYPE_OFFSET UNITYSDK_OFFSET(0x302AE0)
#define EPIC_ONLINESERVICES_CONNECT_GETEXTERNALACCOUNTMAPPINGSOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8F15B0)
#define EPIC_ONLINESERVICES_CONNECT_GETEXTERNALACCOUNTMAPPINGSOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8F1720)
#define EPIC_ONLINESERVICES_CONNECT_GETEXTERNALACCOUNTMAPPINGSOPTIONSINTERNAL_SET_TARGETEXTERNALUSERID_OFFSET UNITYSDK_OFFSET(0x8F1670)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int GetExternalAccountMappingsOptionsInternal_TypeDefinitionIndex = 33972;
