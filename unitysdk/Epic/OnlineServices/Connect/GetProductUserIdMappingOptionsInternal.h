...
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x903650)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x9035E0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_ACCOUNTIDTYPE_OFFSET UNITYSDK_OFFSET(0x302AE0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x903450)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x9035D0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_TARGETPRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x903510)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int GetProductUserIdMappingOptionsInternal_TypeDefinitionIndex = 33976;
