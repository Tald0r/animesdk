...
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D7CE0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D7C70)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_ACCOUNTIDTYPE_OFFSET UNITYSDK_OFFSET(0x3197D0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8D7AE0)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D7C60)
#define EPIC_ONLINESERVICES_CONNECT_GETPRODUCTUSERIDMAPPINGOPTIONSINTERNAL_SET_TARGETPRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x8D7BA0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int GetProductUserIdMappingOptionsInternal_TypeDefinitionIndex = 33022;
