...
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENOPTIONS_GET_IDTOKEN_OFFSET UNITYSDK_OFFSET(0x190B8910)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENOPTIONS_SET_IDTOKEN_OFFSET UNITYSDK_OFFSET(0x190B8920)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x190B8930)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int VerifyIdTokenOptions_TypeDefinitionIndex = 33079;
