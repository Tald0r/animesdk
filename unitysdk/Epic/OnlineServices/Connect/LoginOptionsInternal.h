...
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D7B80)
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D7B10)
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONSINTERNAL_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x8D7900)
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D7B00)
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONSINTERNAL_SET_USERLOGININFO_OFFSET UNITYSDK_OFFSET(0x8D7A10)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int LoginOptionsInternal_TypeDefinitionIndex = 33986;
