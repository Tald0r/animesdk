...
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B8D80)
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8B8D10)
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONSINTERNAL_SET_CREDENTIALS_OFFSET UNITYSDK_OFFSET(0x8B8B00)
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B8D00)
#define EPIC_ONLINESERVICES_CONNECT_LOGINOPTIONSINTERNAL_SET_USERLOGININFO_OFFSET UNITYSDK_OFFSET(0x8B8C10)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int LoginOptionsInternal_TypeDefinitionIndex = 33032;
