...
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEDEVICEIDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16E484E0)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEDEVICEIDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16E48510)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEDEVICEIDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x16E47FE0)
#define EPIC_ONLINESERVICES_CONNECT_ONCREATEDEVICEIDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x16E47FD0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnCreateDeviceIdCallback_TypeDefinitionIndex = 33037;
