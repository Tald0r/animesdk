...
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8899B0)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x889940)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONSINTERNAL_SET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x889870)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8897B0)
#define EPIC_ONLINESERVICES_CONNECT_LINKACCOUNTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x889930)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int LinkAccountOptionsInternal_TypeDefinitionIndex = 33982;
