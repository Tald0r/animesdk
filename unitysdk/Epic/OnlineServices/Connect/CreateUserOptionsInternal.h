...
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSEROPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8F1500)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8F13D0)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSEROPTIONSINTERNAL_SET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x8F1240)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8F1300)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int CreateUserOptionsInternal_TypeDefinitionIndex = 33962;
