...
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSEROPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D0390)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSEROPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D0260)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSEROPTIONSINTERNAL_SET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x8D00D0)
#define EPIC_ONLINESERVICES_CONNECT_CREATEUSEROPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8D0190)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int CreateUserOptionsInternal_TypeDefinitionIndex = 33008;
