...
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x88FF50)
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALSINTERNAL_GET_TOKEN_OFFSET UNITYSDK_OFFSET(0x88FD10)
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALSINTERNAL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x302AD0)
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x88FF40)
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x88FE70)
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALSINTERNAL_SET_TOKEN_OFFSET UNITYSDK_OFFSET(0x88FDC0)
#define EPIC_ONLINESERVICES_CONNECT_CREDENTIALSINTERNAL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x302AE0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int CredentialsInternal_TypeDefinitionIndex = 33964;
