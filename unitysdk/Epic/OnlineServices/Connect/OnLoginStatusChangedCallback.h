...
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINSTATUSCHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18F22970)
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINSTATUSCHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18F229A0)
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINSTATUSCHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18F22470)
#define EPIC_ONLINESERVICES_CONNECT_ONLOGINSTATUSCHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18F22460)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int OnLoginStatusChangedCallback_TypeDefinitionIndex = 33047;
