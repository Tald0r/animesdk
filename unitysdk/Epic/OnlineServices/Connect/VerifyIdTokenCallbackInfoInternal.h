...
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_ACCOUNTIDTYPE_OFFSET UNITYSDK_OFFSET(0x3840E0)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x85B440)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x85B210)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_DEVICETYPE_OFFSET UNITYSDK_OFFSET(0x85B5A0)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_ISACCOUNTINFOPRESENT_OFFSET UNITYSDK_OFFSET(0x85B390)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_PLATFORM_OFFSET UNITYSDK_OFFSET(0x85B4F0)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x85B320)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int VerifyIdTokenCallbackInfoInternal_TypeDefinitionIndex = 33078;
