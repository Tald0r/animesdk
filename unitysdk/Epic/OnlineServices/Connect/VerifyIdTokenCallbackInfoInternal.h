...
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_ACCOUNTIDTYPE_OFFSET UNITYSDK_OFFSET(0x31B130)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_ACCOUNTID_OFFSET UNITYSDK_OFFSET(0x889D10)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x272280)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x889AE0)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_DEVICETYPE_OFFSET UNITYSDK_OFFSET(0x889E70)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_ISACCOUNTINFOPRESENT_OFFSET UNITYSDK_OFFSET(0x889C60)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_PLATFORM_OFFSET UNITYSDK_OFFSET(0x889DC0)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_PRODUCTUSERID_OFFSET UNITYSDK_OFFSET(0x889BF0)
#define EPIC_ONLINESERVICES_CONNECT_VERIFYIDTOKENCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2F1F70)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int VerifyIdTokenCallbackInfoInternal_TypeDefinitionIndex = 34032;
