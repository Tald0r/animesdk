...
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19A66B10)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19A66B20)
#define EPIC_ONLINESERVICES_CONNECT_UNLINKACCOUNTOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A66B30)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int UnlinkAccountOptions_TypeDefinitionIndex = 33073;
