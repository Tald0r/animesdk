...
#define EPIC_ONLINESERVICES_CONNECT_LOGINCALLBACKINFOINTERNAL_GET_CLIENTDATAADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define EPIC_ONLINESERVICES_CONNECT_LOGINCALLBACKINFOINTERNAL_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x8D7E10)
#define EPIC_ONLINESERVICES_CONNECT_LOGINCALLBACKINFOINTERNAL_GET_CONTINUANCETOKEN_OFFSET UNITYSDK_OFFSET(0x8D7F90)
#define EPIC_ONLINESERVICES_CONNECT_LOGINCALLBACKINFOINTERNAL_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8D7F20)
#define EPIC_ONLINESERVICES_CONNECT_LOGINCALLBACKINFOINTERNAL_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x2C3E30)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int LoginCallbackInfoInternal_TypeDefinitionIndex = 33030;
