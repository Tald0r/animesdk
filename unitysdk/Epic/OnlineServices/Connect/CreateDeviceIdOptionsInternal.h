...
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8E60E0)
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8E5FC0)
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDOPTIONSINTERNAL_SET_DEVICEMODEL_OFFSET UNITYSDK_OFFSET(0x8E5E40)
#define EPIC_ONLINESERVICES_CONNECT_CREATEDEVICEIDOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8E5EF0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int CreateDeviceIdOptionsInternal_TypeDefinitionIndex = 33958;
