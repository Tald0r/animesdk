...
#define EPIC_ONLINESERVICES_CONNECT_USERLOGININFOINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8B94E0)
#define EPIC_ONLINESERVICES_CONNECT_USERLOGININFOINTERNAL_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8B9190)
#define EPIC_ONLINESERVICES_CONNECT_USERLOGININFOINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8B93C0)
#define EPIC_ONLINESERVICES_CONNECT_USERLOGININFOINTERNAL_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x8B9240)
#define EPIC_ONLINESERVICES_CONNECT_USERLOGININFOINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8B92F0)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int UserLoginInfoInternal_TypeDefinitionIndex = 33076;
