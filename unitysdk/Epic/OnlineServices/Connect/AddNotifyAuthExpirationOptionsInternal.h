...
#define EPIC_ONLINESERVICES_CONNECT_ADDNOTIFYAUTHEXPIRATIONOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define EPIC_ONLINESERVICES_CONNECT_ADDNOTIFYAUTHEXPIRATIONOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8D7700)
#define EPIC_ONLINESERVICES_CONNECT_ADDNOTIFYAUTHEXPIRATIONOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x78EB40)

namespace Epic::OnlineServices::Connect
{
	inline static constexpr unsigned int AddNotifyAuthExpirationOptionsInternal_TypeDefinitionIndex = 32985;
