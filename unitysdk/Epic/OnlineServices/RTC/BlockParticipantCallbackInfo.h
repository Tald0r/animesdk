...
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_GETRESULTCODE_OFFSET UNITYSDK_OFFSET(0x195FDB30)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_GET_BLOCKED_OFFSET UNITYSDK_OFFSET(0x195FDB10)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_GET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x195FDA90)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x195FDAB0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_GET_PARTICIPANTID_OFFSET UNITYSDK_OFFSET(0x195FDAF0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_GET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x195FDA70)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_GET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x195FDAD0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_SET_1_OFFSET UNITYSDK_OFFSET(0x195FE040)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_SET_BLOCKED_OFFSET UNITYSDK_OFFSET(0x195FDB20)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_SET_CLIENTDATA_OFFSET UNITYSDK_OFFSET(0x195FDAA0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x195FDAC0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_SET_OFFSET UNITYSDK_OFFSET(0x195FDB50)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_SET_PARTICIPANTID_OFFSET UNITYSDK_OFFSET(0x195FDB00)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_SET_RESULTCODE_OFFSET UNITYSDK_OFFSET(0x195FDA80)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x195FDAE0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTCALLBACKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x195FE190)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int BlockParticipantCallbackInfo_TypeDefinitionIndex = 32251;
