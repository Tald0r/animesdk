...
#define EPIC_ONLINESERVICES_RTC_SETSETTINGOPTIONS_GET_SETTINGNAME_OFFSET UNITYSDK_OFFSET(0x19D509F0)
#define EPIC_ONLINESERVICES_RTC_SETSETTINGOPTIONS_GET_SETTINGVALUE_OFFSET UNITYSDK_OFFSET(0x19D50A10)
#define EPIC_ONLINESERVICES_RTC_SETSETTINGOPTIONS_SET_SETTINGNAME_OFFSET UNITYSDK_OFFSET(0x19D50A00)
#define EPIC_ONLINESERVICES_RTC_SETSETTINGOPTIONS_SET_SETTINGVALUE_OFFSET UNITYSDK_OFFSET(0x19D50A20)
#define EPIC_ONLINESERVICES_RTC_SETSETTINGOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19D50A30)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int SetSettingOptions_TypeDefinitionIndex = 33238;
