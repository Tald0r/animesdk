...
#define EPIC_ONLINESERVICES_RTC_ADDNOTIFYPARTICIPANTSTATUSCHANGEDOPTIONS_GET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19FCB460)
#define EPIC_ONLINESERVICES_RTC_ADDNOTIFYPARTICIPANTSTATUSCHANGEDOPTIONS_GET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x19FCB480)
#define EPIC_ONLINESERVICES_RTC_ADDNOTIFYPARTICIPANTSTATUSCHANGEDOPTIONS_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x19FCB470)
#define EPIC_ONLINESERVICES_RTC_ADDNOTIFYPARTICIPANTSTATUSCHANGEDOPTIONS_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x19FCB490)
#define EPIC_ONLINESERVICES_RTC_ADDNOTIFYPARTICIPANTSTATUSCHANGEDOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19FCB4A0)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int AddNotifyParticipantStatusChangedOptions_TypeDefinitionIndex = 33203;
