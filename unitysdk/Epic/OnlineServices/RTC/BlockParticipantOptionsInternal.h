...
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7AABD0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x7AAB60)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTOPTIONSINTERNAL_SET_BLOCKED_OFFSET UNITYSDK_OFFSET(0x7AAAA0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x7AA870)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x7AAB50)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTOPTIONSINTERNAL_SET_PARTICIPANTID_OFFSET UNITYSDK_OFFSET(0x7AA9E0)
#define EPIC_ONLINESERVICES_RTC_BLOCKPARTICIPANTOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x7AA930)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int BlockParticipantOptionsInternal_TypeDefinitionIndex = 32254;
