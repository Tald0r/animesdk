...
#define EPIC_ONLINESERVICES_RTC_SETSETTINGOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8861A0)
#define EPIC_ONLINESERVICES_RTC_SETSETTINGOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x886130)
#define EPIC_ONLINESERVICES_RTC_SETSETTINGOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x886120)
#define EPIC_ONLINESERVICES_RTC_SETSETTINGOPTIONSINTERNAL_SET_SETTINGNAME_OFFSET UNITYSDK_OFFSET(0x885FC0)
#define EPIC_ONLINESERVICES_RTC_SETSETTINGOPTIONSINTERNAL_SET_SETTINGVALUE_OFFSET UNITYSDK_OFFSET(0x886070)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int SetSettingOptionsInternal_TypeDefinitionIndex = 33239;
