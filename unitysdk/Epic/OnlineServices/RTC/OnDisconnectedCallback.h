...
#define EPIC_ONLINESERVICES_RTC_ONDISCONNECTEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19161270)
#define EPIC_ONLINESERVICES_RTC_ONDISCONNECTEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x191612A0)
#define EPIC_ONLINESERVICES_RTC_ONDISCONNECTEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x19160D70)
#define EPIC_ONLINESERVICES_RTC_ONDISCONNECTEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x19160D50)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnDisconnectedCallback_TypeDefinitionIndex = 33222;
