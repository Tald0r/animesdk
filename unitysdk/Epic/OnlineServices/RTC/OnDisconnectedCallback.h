...
#define EPIC_ONLINESERVICES_RTC_ONDISCONNECTEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18DCFFD0)
#define EPIC_ONLINESERVICES_RTC_ONDISCONNECTEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18DD0000)
#define EPIC_ONLINESERVICES_RTC_ONDISCONNECTEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18DCFAD0)
#define EPIC_ONLINESERVICES_RTC_ONDISCONNECTEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18DCFAC0)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnDisconnectedCallback_TypeDefinitionIndex = 32268;
