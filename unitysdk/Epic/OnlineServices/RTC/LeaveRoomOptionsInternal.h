...
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8DB280)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_1_OFFSET UNITYSDK_OFFSET(0x8DB210)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_LOCALUSERID_OFFSET UNITYSDK_OFFSET(0x8DB090)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_OFFSET UNITYSDK_OFFSET(0x8DB200)
#define EPIC_ONLINESERVICES_RTC_LEAVEROOMOPTIONSINTERNAL_SET_ROOMNAME_OFFSET UNITYSDK_OFFSET(0x8DB150)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int LeaveRoomOptionsInternal_TypeDefinitionIndex = 33219;
