...
#define EPIC_ONLINESERVICES_RTC_ONPARTICIPANTSTATUSCHANGEDCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18E13E10)
#define EPIC_ONLINESERVICES_RTC_ONPARTICIPANTSTATUSCHANGEDCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18E13E40)
#define EPIC_ONLINESERVICES_RTC_ONPARTICIPANTSTATUSCHANGEDCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x18E13910)
#define EPIC_ONLINESERVICES_RTC_ONPARTICIPANTSTATUSCHANGEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x18E13900)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnParticipantStatusChangedCallback_TypeDefinitionIndex = 32274;
