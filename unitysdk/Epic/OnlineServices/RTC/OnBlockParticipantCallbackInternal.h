...
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A05BF30)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A05BF80)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A05BC40)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A05BC20)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnBlockParticipantCallbackInternal_TypeDefinitionIndex = 33221;
