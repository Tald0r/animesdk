...
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A6FB10)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A6FB60)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A6F810)
#define EPIC_ONLINESERVICES_RTC_ONBLOCKPARTICIPANTCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x19A6F800)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnBlockParticipantCallbackInternal_TypeDefinitionIndex = 32267;
