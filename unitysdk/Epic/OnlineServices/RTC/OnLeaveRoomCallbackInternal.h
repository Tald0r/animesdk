...
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x190C5020)
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x190C5070)
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x190C4D20)
#define EPIC_ONLINESERVICES_RTC_ONLEAVEROOMCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x190C4D10)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnLeaveRoomCallbackInternal_TypeDefinitionIndex = 32273;
