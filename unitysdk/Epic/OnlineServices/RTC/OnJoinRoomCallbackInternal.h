...
#define EPIC_ONLINESERVICES_RTC_ONJOINROOMCALLBACKINTERNAL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19845CD0)
#define EPIC_ONLINESERVICES_RTC_ONJOINROOMCALLBACKINTERNAL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19845D20)
#define EPIC_ONLINESERVICES_RTC_ONJOINROOMCALLBACKINTERNAL_INVOKE_OFFSET UNITYSDK_OFFSET(0x198459D0)
#define EPIC_ONLINESERVICES_RTC_ONJOINROOMCALLBACKINTERNAL__CTOR_OFFSET UNITYSDK_OFFSET(0x198459C0)

namespace Epic::OnlineServices::RTC
{
	inline static constexpr unsigned int OnJoinRoomCallbackInternal_TypeDefinitionIndex = 32271;
