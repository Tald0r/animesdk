...
#define NODECANVAS_TASKS_ACTIONS_SETFLOATRANDOM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19C86C50)
#define NODECANVAS_TASKS_ACTIONS_SETFLOATRANDOM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C87010)
#define NODECANVAS_TASKS_ACTIONS_SETFLOATRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C870C0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetFloatRandom_TypeDefinitionIndex = 25466;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::System::Single>* floatVariable; // 0x70
