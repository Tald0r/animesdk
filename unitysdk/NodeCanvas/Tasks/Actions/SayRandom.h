...
#define NODECANVAS_TASKS_ACTIONS_SAYRANDOM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A123A80)
#define NODECANVAS_TASKS_ACTIONS_SAYRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A123C60)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SayRandom_TypeDefinitionIndex = 27411;
