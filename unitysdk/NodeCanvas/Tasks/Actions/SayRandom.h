...
#define NODECANVAS_TASKS_ACTIONS_SAYRANDOM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A1B6670)
#define NODECANVAS_TASKS_ACTIONS_SAYRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B6850)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SayRandom_TypeDefinitionIndex = 26290;
