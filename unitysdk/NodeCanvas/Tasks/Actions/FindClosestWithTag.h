...
#define NODECANVAS_TASKS_ACTIONS_FINDCLOSESTWITHTAG_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A1D1420)
#define NODECANVAS_TASKS_ACTIONS_FINDCLOSESTWITHTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D1910)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int FindClosestWithTag_TypeDefinitionIndex = 25963;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::System::Boolean>* ignoreChildren; // 0x68
		::NodeCanvas::Framework::BBParameter_1<::System::String*>* searchTag; // 0x70
