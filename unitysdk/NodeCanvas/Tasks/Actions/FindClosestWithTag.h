...
#define NODECANVAS_TASKS_ACTIONS_FINDCLOSESTWITHTAG_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C12780)
#define NODECANVAS_TASKS_ACTIONS_FINDCLOSESTWITHTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x19C12C70)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int FindClosestWithTag_TypeDefinitionIndex = 26862;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::System::String*>* searchTag; // 0x78
