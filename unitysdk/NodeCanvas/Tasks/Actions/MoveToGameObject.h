...
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19C2F550)
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19C2FD10)
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C2F630)
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x19C2FD00)
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT_ONSTOP_OFFSET UNITYSDK_OFFSET(0x19C2FC60)
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19C2F930)
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2FE90)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int MoveToGameObject_TypeDefinitionIndex = 26944;
