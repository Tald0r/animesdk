...
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x197616D0)
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19761E90)
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x197617B0)
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x19761E80)
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT_ONSTOP_OFFSET UNITYSDK_OFFSET(0x19761DE0)
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19761AB0)
#define NODECANVAS_TASKS_ACTIONS_MOVETOGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19762010)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int MoveToGameObject_TypeDefinitionIndex = 25923;
