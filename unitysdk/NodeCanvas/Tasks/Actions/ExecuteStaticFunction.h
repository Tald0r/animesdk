...
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A609790)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A609770)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_NODECANVAS_FRAMEWORK_ISUBPARAMETERSCONTAINER_GETSUBPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A609740)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A60A190)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_ONINIT_OFFSET UNITYSDK_OFFSET(0x1A60A0D0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A609E90)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A609FC0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A60A2C0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int ExecuteStaticFunction_TypeDefinitionIndex = 27031;
