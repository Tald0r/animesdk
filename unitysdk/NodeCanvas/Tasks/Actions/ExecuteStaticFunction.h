...
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19FF0700)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x19FF06E0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_NODECANVAS_FRAMEWORK_ISUBPARAMETERSCONTAINER_GETSUBPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19FF06B0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19FF1100)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_ONINIT_OFFSET UNITYSDK_OFFSET(0x19FF1040)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19FF0E00)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x19FF0F30)
#define NODECANVAS_TASKS_ACTIONS_EXECUTESTATICFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF1230)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int ExecuteStaticFunction_TypeDefinitionIndex = 25881;
