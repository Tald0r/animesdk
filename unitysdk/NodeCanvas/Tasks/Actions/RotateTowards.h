...
#define NODECANVAS_TASKS_ACTIONS_ROTATETOWARDS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19C86430)
#define NODECANVAS_TASKS_ACTIONS_ROTATETOWARDS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C86AE0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int RotateTowards_TypeDefinitionIndex = 26471;
