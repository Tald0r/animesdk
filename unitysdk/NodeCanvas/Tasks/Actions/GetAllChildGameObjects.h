...
#define NODECANVAS_TASKS_ACTIONS_GETALLCHILDGAMEOBJECTS_GET_INFO_OFFSET UNITYSDK_OFFSET(0x183F22D0)
#define NODECANVAS_TASKS_ACTIONS_GETALLCHILDGAMEOBJECTS_GET_OFFSET UNITYSDK_OFFSET(0x183F28A0)
#define NODECANVAS_TASKS_ACTIONS_GETALLCHILDGAMEOBJECTS_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x183F23A0)
#define NODECANVAS_TASKS_ACTIONS_GETALLCHILDGAMEOBJECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x183F2C40)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetAllChildGameObjects_TypeDefinitionIndex = 25152;
