...
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A56AF10)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A56B020)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A56AEF0)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1A56B330)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_ONINIT_OFFSET UNITYSDK_OFFSET(0x1A56B510)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1A56B700)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A56B5F0)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A56B350)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A56B440)
#define NODECANVAS_TASKS_ACTIONS_IMPLEMENTEDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A56B710)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int ImplementedAction_TypeDefinitionIndex = 27704;
