...
#define NODECANVAS_TASKS_ACTIONS_SETOTHERBLACKBOARDVARIABLE_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A3ABA90)
#define NODECANVAS_TASKS_ACTIONS_SETOTHERBLACKBOARDVARIABLE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A3ABB30)
#define NODECANVAS_TASKS_ACTIONS_SETOTHERBLACKBOARDVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3ABC00)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetOtherBlackboardVariable_TypeDefinitionIndex = 26931;
