...
#define NODECANVAS_TASKS_ACTIONS_SETOTHERBLACKBOARDVARIABLE_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19DBA830)
#define NODECANVAS_TASKS_ACTIONS_SETOTHERBLACKBOARDVARIABLE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19DBA8D0)
#define NODECANVAS_TASKS_ACTIONS_SETOTHERBLACKBOARDVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBA9A0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetOtherBlackboardVariable_TypeDefinitionIndex = 26173;
