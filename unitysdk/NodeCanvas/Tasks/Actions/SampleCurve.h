...
#define NODECANVAS_TASKS_ACTIONS_SAMPLECURVE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A831BA0)
#define NODECANVAS_TASKS_ACTIONS_SAMPLECURVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A831C80)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SampleCurve_TypeDefinitionIndex = 26589;
