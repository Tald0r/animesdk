...
#define NODECANVAS_TASKS_ACTIONS_MECANIMSETBOOL_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19760EB0)
#define NODECANVAS_TASKS_ACTIONS_MECANIMSETBOOL_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19760FA0)
#define NODECANVAS_TASKS_ACTIONS_MECANIMSETBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x19761100)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int MecanimSetBool_TypeDefinitionIndex = 25975;

	class MecanimSetBool : public ::NodeCanvas::Framework::ActionTask_1<::UnityEngine::Animator*>
	{
	public:
		::NodeCanvas::Framework::BBParameter_1<::System::Boolean>* setTo; // 0x60
