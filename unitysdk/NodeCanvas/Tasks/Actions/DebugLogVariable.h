...
#define NODECANVAS_TASKS_ACTIONS_DEBUGLOGVARIABLE_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19C85AF0)
#define NODECANVAS_TASKS_ACTIONS_DEBUGLOGVARIABLE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C85D90)
#define NODECANVAS_TASKS_ACTIONS_DEBUGLOGVARIABLE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19C85DA0)
#define NODECANVAS_TASKS_ACTIONS_DEBUGLOGVARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C85EA0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int DebugLogVariable_TypeDefinitionIndex = 25926;
