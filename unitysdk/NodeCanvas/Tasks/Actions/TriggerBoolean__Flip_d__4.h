...
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__FLIP_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A72C710)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__FLIP_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A72C770)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__FLIP_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A72C7D0)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__FLIP_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A72C780)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__FLIP_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A72C700)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__FLIP_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1A72C6F0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int TriggerBoolean__Flip_d__4_TypeDefinitionIndex = 27635;
