...
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN_FLIP_OFFSET UNITYSDK_OFFSET(0x196EFE60)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN_GET_INFO_OFFSET UNITYSDK_OFFSET(0x196EFD20)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x196EFD90)
#define NODECANVAS_TASKS_ACTIONS_TRIGGERBOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x196EFEB0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int TriggerBoolean_TypeDefinitionIndex = 27634;
