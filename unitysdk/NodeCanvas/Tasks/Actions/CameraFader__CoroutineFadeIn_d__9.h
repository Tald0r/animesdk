...
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEIN_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A08A3D0)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEIN_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A08A480)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEIN_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A08A4E0)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEIN_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A08A490)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEIN_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A08A3C0)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEIN_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x1A08A3B0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int CameraFader__CoroutineFadeIn_d__9_TypeDefinitionIndex = 25944;
