...
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION_DO_OFFSET UNITYSDK_OFFSET(0x19166FA0)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19166F00)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19167040)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x191670E0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetMousePosition_TypeDefinitionIndex = 25119;
