...
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION_DO_OFFSET UNITYSDK_OFFSET(0x195590E0)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19559040)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19559180)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSEPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19559220)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetMousePosition_TypeDefinitionIndex = 27033;
