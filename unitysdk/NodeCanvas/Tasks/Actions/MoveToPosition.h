...
#define NODECANVAS_TASKS_ACTIONS_MOVETOPOSITION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A72C050)
#define NODECANVAS_TASKS_ACTIONS_MOVETOPOSITION_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A72C130)
#define NODECANVAS_TASKS_ACTIONS_MOVETOPOSITION_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1A72C610)
#define NODECANVAS_TASKS_ACTIONS_MOVETOPOSITION_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1A72C570)
#define NODECANVAS_TASKS_ACTIONS_MOVETOPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A72C300)
#define NODECANVAS_TASKS_ACTIONS_MOVETOPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A72C620)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int MoveToPosition_TypeDefinitionIndex = 27232;
