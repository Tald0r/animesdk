...
#define NODECANVAS_TASKS_ACTIONS_DEBUGBEEP_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C2CA10)
#define NODECANVAS_TASKS_ACTIONS_DEBUGBEEP__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2CA40)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int DebugBeep_TypeDefinitionIndex = 26324;
