...
#define NODECANVAS_TASKS_ACTIONS_SETINTRANDOM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A65E100)
#define NODECANVAS_TASKS_ACTIONS_SETINTRANDOM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A65E4C0)
#define NODECANVAS_TASKS_ACTIONS_SETINTRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65E560)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetIntRandom_TypeDefinitionIndex = 26653;
