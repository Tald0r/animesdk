...
#define NODECANVAS_TASKS_ACTIONS_SETINTRANDOM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A08B4E0)
#define NODECANVAS_TASKS_ACTIONS_SETINTRANDOM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A08B8A0)
#define NODECANVAS_TASKS_ACTIONS_SETINTRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A08B940)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetIntRandom_TypeDefinitionIndex = 25284;

	class SetIntRandom : public ::NodeCanvas::Framework::ActionTask
	{
	public:
		::NodeCanvas::Framework::BBParameter_1<::System::Int32>* maxValue; // 0x60
		::NodeCanvas::Framework::BBParameter_1<::System::Int32>* minValue; // 0x68
