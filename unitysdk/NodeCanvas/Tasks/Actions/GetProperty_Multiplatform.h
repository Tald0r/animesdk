...
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A56A8E0)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A56A9E0)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A56A8C0)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1A56AC30)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A56ADE0)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_ONINIT_OFFSET UNITYSDK_OFFSET(0x1A56AD50)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A56AC40)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A56ACD0)
#define NODECANVAS_TASKS_ACTIONS_GETPROPERTY_MULTIPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A56AEE0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetProperty_Multiplatform_TypeDefinitionIndex = 27736;
