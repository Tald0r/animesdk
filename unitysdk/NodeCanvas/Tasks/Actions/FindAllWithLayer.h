...
#define NODECANVAS_TASKS_ACTIONS_FINDALLWITHLAYER_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19FF1ED0)
#define NODECANVAS_TASKS_ACTIONS_FINDALLWITHLAYER_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19FF2120)
#define NODECANVAS_TASKS_ACTIONS_FINDALLWITHLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF2210)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int FindAllWithLayer_TypeDefinitionIndex = 26313;
