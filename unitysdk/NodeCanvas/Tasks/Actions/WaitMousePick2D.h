...
#define NODECANVAS_TASKS_ACTIONS_WAITMOUSEPICK2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A1D1B40)
#define NODECANVAS_TASKS_ACTIONS_WAITMOUSEPICK2D_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A1D1BD0)
#define NODECANVAS_TASKS_ACTIONS_WAITMOUSEPICK2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D1F80)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int WaitMousePick2D_TypeDefinitionIndex = 26567;
