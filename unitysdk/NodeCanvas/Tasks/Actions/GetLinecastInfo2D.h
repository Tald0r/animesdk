...
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO2D_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19C2E200)
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO2D_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C2DE00)
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO2D__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2E440)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetLinecastInfo2D_TypeDefinitionIndex = 26050;
