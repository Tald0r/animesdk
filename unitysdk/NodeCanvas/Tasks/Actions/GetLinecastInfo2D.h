...
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO2D_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x197603A0)
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO2D_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1975FFA0)
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO2D__CTOR_OFFSET UNITYSDK_OFFSET(0x197605E0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetLinecastInfo2D_TypeDefinitionIndex = 26809;

	class GetLinecastInfo2D : public ::NodeCanvas::Framework::ActionTask_1<::UnityEngine::Transform*>
	{
	public:
		::NodeCanvas::Framework::BBParameter_1<::UnityEngine::Vector3>* savePointAs; // 0x60
		::NodeCanvas::Framework::BBParameter_1<::UnityEngine::GameObject*>* saveHitGameObjectAs; // 0x68
		::NodeCanvas::Framework::BBParameter_1<::UnityEngine::GameObject*>* target; // 0x70
		::NodeCanvas::Framework::BBParameter_1<::UnityEngine::Vector3>* saveNormalAs; // 0x78
