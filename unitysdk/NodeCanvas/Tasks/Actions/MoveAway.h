...
#define NODECANVAS_TASKS_ACTIONS_MOVEAWAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19FF2B10)
#define NODECANVAS_TASKS_ACTIONS_MOVEAWAY__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF2EB0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int MoveAway_TypeDefinitionIndex = 26845;
