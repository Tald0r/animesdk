...
#define NODECANVAS_TASKS_ACTIONS_MOVEAWAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A60BBA0)
#define NODECANVAS_TASKS_ACTIONS_MOVEAWAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A60BF40)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int MoveAway_TypeDefinitionIndex = 26389;
