...
#define NODECANVAS_TASKS_ACTIONS_SETENUM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A124190)
#define NODECANVAS_TASKS_ACTIONS_SETENUM_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A1241D0)
#define NODECANVAS_TASKS_ACTIONS_SETENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A124270)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetEnum_TypeDefinitionIndex = 26847;
