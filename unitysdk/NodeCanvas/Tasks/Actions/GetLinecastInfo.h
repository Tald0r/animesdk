...
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A3AAB00)
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A3AA7B0)
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AAD40)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetLinecastInfo_TypeDefinitionIndex = 26473;
