...
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19DB98A0)
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19DB9550)
#define NODECANVAS_TASKS_ACTIONS_GETLINECASTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB9AE0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetLinecastInfo_TypeDefinitionIndex = 25562;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::UnityEngine::GameObject*>* saveHitGameObjectAs; // 0x80
