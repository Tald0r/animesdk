...
#define NODECANVAS_TASKS_ACTIONS_SETVECTOR3_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A1B6F50)
#define NODECANVAS_TASKS_ACTIONS_SETVECTOR3_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A1B7230)
#define NODECANVAS_TASKS_ACTIONS_SETVECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B7480)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetVector3_TypeDefinitionIndex = 26658;
