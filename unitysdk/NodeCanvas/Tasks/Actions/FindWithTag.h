...
#define NODECANVAS_TASKS_ACTIONS_FINDWITHTAG_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19DB90D0)
#define NODECANVAS_TASKS_ACTIONS_FINDWITHTAG_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19DB9320)
#define NODECANVAS_TASKS_ACTIONS_FINDWITHTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB93B0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int FindWithTag_TypeDefinitionIndex = 26248;
