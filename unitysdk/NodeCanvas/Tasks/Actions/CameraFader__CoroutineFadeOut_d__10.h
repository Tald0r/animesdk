...
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x196ED1A0)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x196ED260)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x196ED2C0)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x196ED270)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x196ED190)
#define NODECANVAS_TASKS_ACTIONS_CAMERAFADER__COROUTINEFADEOUT_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x196ED180)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int CameraFader__CoroutineFadeOut_d__10_TypeDefinitionIndex = 25947;
