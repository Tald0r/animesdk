...
#define NODECANVAS_TASKS_ACTIONS_ROTATEAWAY_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E9EA10)
#define NODECANVAS_TASKS_ACTIONS_ROTATEAWAY__CTOR_OFFSET UNITYSDK_OFFSET(0x19E9F110)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int RotateAway_TypeDefinitionIndex = 26581;
