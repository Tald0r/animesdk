...
#define NODECANVAS_TASKS_ACTIONS_SORTGAMEOBJECTLISTBYDISTANCE_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A08B950)
#define NODECANVAS_TASKS_ACTIONS_SORTGAMEOBJECTLISTBYDISTANCE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A08BBA0)
#define NODECANVAS_TASKS_ACTIONS_SORTGAMEOBJECTLISTBYDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A08BCE0)
#define NODECANVAS_TASKS_ACTIONS_SORTGAMEOBJECTLISTBYDISTANCE__ONEXECUTE_B__5_0_OFFSET UNITYSDK_OFFSET(0x1A08BD00)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SortGameObjectListByDistance_TypeDefinitionIndex = 25551;
