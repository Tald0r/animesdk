...
#define NODECANVAS_TASKS_ACTIONS_INSTANTIATEGAMEOBJECT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A72B590)
#define NODECANVAS_TASKS_ACTIONS_INSTANTIATEGAMEOBJECT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A72BAB0)
#define NODECANVAS_TASKS_ACTIONS_INSTANTIATEGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A72BCB0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int InstantiateGameObject_TypeDefinitionIndex = 26996;
