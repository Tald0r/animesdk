...
#define NODECANVAS_TASKS_ACTIONS_INSTANTIATEGAMEOBJECT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A182D10)
#define NODECANVAS_TASKS_ACTIONS_INSTANTIATEGAMEOBJECT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A183230)
#define NODECANVAS_TASKS_ACTIONS_INSTANTIATEGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A183430)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int InstantiateGameObject_TypeDefinitionIndex = 25182;
	...
	public:
		...
		::NodeCanvas::Framework::BBParameter_1<::UnityEngine::Vector3>* clonePosition; // 0x68
