...
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION__INTERNALCOROUTINE_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19DB8B10)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION__INTERNALCOROUTINE_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19DB8CF0)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION__INTERNALCOROUTINE_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19DB8D50)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION__INTERNALCOROUTINE_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19DB8D00)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION__INTERNALCOROUTINE_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19DB8B00)
#define NODECANVAS_TASKS_ACTIONS_EXECUTEFUNCTION__INTERNALCOROUTINE_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB8AF0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int ExecuteFunction__InternalCoroutine_d__13_TypeDefinitionIndex = 26246;

	class ExecuteFunction__InternalCoroutine_d__13 : public ::System::Object
	{
	public:
		::NodeCanvas::Tasks::Actions::ExecuteFunction* __4__this; // 0x10
