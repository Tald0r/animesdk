...
#define NODECANVAS_TASKS_ACTIONS_PLAYAUDIOATPOSITION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19272D80)
#define NODECANVAS_TASKS_ACTIONS_PLAYAUDIOATPOSITION_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19272DE0)
#define NODECANVAS_TASKS_ACTIONS_PLAYAUDIOATPOSITION_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19272ED0)
#define NODECANVAS_TASKS_ACTIONS_PLAYAUDIOATPOSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19273040)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int PlayAudioAtPosition_TypeDefinitionIndex = 25620;
