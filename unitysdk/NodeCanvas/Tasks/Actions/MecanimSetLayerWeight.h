...
#define NODECANVAS_TASKS_ACTIONS_MECANIMSETLAYERWEIGHT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19C85EC0)
#define NODECANVAS_TASKS_ACTIONS_MECANIMSETLAYERWEIGHT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C86110)
#define NODECANVAS_TASKS_ACTIONS_MECANIMSETLAYERWEIGHT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19C86180)
#define NODECANVAS_TASKS_ACTIONS_MECANIMSETLAYERWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C86410)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int MecanimSetLayerWeight_TypeDefinitionIndex = 25266;
