...
#define NODECANVAS_TASKS_ACTIONS_SENDEVENTTOOBJECTS_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A1B68E0)
#define NODECANVAS_TASKS_ACTIONS_SENDEVENTTOOBJECTS_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A1B6950)
#define NODECANVAS_TASKS_ACTIONS_SENDEVENTTOOBJECTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B6C30)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SendEventToObjects_TypeDefinitionIndex = 25651;
