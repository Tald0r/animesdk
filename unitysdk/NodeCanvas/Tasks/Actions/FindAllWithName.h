...
#define NODECANVAS_TASKS_ACTIONS_FINDALLWITHNAME_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19C2D940)
#define NODECANVAS_TASKS_ACTIONS_FINDALLWITHNAME_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C2DB90)
#define NODECANVAS_TASKS_ACTIONS_FINDALLWITHNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2DDD0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int FindAllWithName_TypeDefinitionIndex = 26425;

	class FindAllWithName : public ::NodeCanvas::Framework::ActionTask
	{
	public:
		::NodeCanvas::Framework::BBParameter_1<::System::String*>* searchName; // 0x60
