...
#define NODECANVAS_TASKS_ACTIONS_GETMOUSESCROLLDELTA_DO_OFFSET UNITYSDK_OFFSET(0x1A60B540)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSESCROLLDELTA_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A60B3F0)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSESCROLLDELTA_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A60B4D0)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSESCROLLDELTA_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A60B5B0)
#define NODECANVAS_TASKS_ACTIONS_GETMOUSESCROLLDELTA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A60B620)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int GetMouseScrollDelta_TypeDefinitionIndex = 26552;
