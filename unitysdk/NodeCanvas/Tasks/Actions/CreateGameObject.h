...
#define NODECANVAS_TASKS_ACTIONS_CREATEGAMEOBJECT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A08A4F0)
#define NODECANVAS_TASKS_ACTIONS_CREATEGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A08A6D0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int CreateGameObject_TypeDefinitionIndex = 26373;
