...
#define NODECANVAS_TASKS_ACTIONS_DEBUGDRAWLINE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A269960)
#define NODECANVAS_TASKS_ACTIONS_DEBUGDRAWLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A269AB0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int DebugDrawLine_TypeDefinitionIndex = 26808;
