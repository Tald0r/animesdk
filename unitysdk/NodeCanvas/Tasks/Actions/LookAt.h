...
#define NODECANVAS_TASKS_ACTIONS_LOOKAT_DOLOOK_OFFSET UNITYSDK_OFFSET(0x1A8319E0)
#define NODECANVAS_TASKS_ACTIONS_LOOKAT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A8318F0)
#define NODECANVAS_TASKS_ACTIONS_LOOKAT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A8319D0)
#define NODECANVAS_TASKS_ACTIONS_LOOKAT_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A831B70)
#define NODECANVAS_TASKS_ACTIONS_LOOKAT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A831B80)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int LookAt_TypeDefinitionIndex = 26670;
