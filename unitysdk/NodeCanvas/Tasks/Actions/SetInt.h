...
#define NODECANVAS_TASKS_ACTIONS_SETINT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x183F33F0)
#define NODECANVAS_TASKS_ACTIONS_SETINT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x183F34A0)
#define NODECANVAS_TASKS_ACTIONS_SETINT__CTOR_OFFSET UNITYSDK_OFFSET(0x183F35C0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetInt_TypeDefinitionIndex = 25635;
