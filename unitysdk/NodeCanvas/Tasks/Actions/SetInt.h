...
#define NODECANVAS_TASKS_ACTIONS_SETINT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x191900B0)
#define NODECANVAS_TASKS_ACTIONS_SETINT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19190160)
#define NODECANVAS_TASKS_ACTIONS_SETINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19190280)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetInt_TypeDefinitionIndex = 26638;
