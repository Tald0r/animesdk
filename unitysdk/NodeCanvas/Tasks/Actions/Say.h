...
#define NODECANVAS_TASKS_ACTIONS_SAY_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A26A2E0)
#define NODECANVAS_TASKS_ACTIONS_SAY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A26A3B0)
#define NODECANVAS_TASKS_ACTIONS_SAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A26A560)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int Say_TypeDefinitionIndex = 25443;
