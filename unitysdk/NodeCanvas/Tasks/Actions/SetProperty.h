...
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A26A5F0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A26A700)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A26A5D0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1A26A990)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A26AC50)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_ONINIT_OFFSET UNITYSDK_OFFSET(0x1A26AB70)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A26A9B0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A26AAA0)
#define NODECANVAS_TASKS_ACTIONS_SETPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A26ACD0)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int SetProperty_TypeDefinitionIndex = 25976;
