...
#define NODECANVAS_TASKS_ACTIONS_MOVETOWARDS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19A0B6B0)
#define NODECANVAS_TASKS_ACTIONS_MOVETOWARDS__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0BA30)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int MoveTowards_TypeDefinitionIndex = 25181;
