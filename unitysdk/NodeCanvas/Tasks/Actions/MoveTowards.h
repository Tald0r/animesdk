...
#define NODECANVAS_TASKS_ACTIONS_MOVETOWARDS_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19FFB690)
#define NODECANVAS_TASKS_ACTIONS_MOVETOWARDS__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFBA10)

namespace NodeCanvas::Tasks::Actions
{
	inline static constexpr unsigned int MoveTowards_TypeDefinitionIndex = 26663;
