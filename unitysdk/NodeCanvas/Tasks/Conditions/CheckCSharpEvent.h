...
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x19FFC480)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19FFC5F0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_GET_TARGETEVENT_OFFSET UNITYSDK_OFFSET(0x19FFC460)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x19FFC720)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19FFCC00)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19FFC9F0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19FFC8C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONINIT_OFFSET UNITYSDK_OFFSET(0x19FFC730)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_0__MIGRATE_OFFSET UNITYSDK_OFFSET(0x19FFC290)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_NODECANVAS_TASKS_CONDITIONS_CHECKSTATICCSHARPEVENT__MIGRATE_OFFSET UNITYSDK_OFFSET(0x19FFC3A0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_RAISED_OFFSET UNITYSDK_OFFSET(0x19FFCB20)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_SETTARGETEVENT_OFFSET UNITYSDK_OFFSET(0x19FFC350)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFCC10)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckCSharpEvent_TypeDefinitionIndex = 27732;

	class CheckCSharpEvent : public ::NodeCanvas::Framework::ConditionTask
	{
	public:
		::System::Delegate* handler; // 0x60
		::ParadoxNotion::Serialization::SerializedEventInfo* eventInfo; // 0x68
