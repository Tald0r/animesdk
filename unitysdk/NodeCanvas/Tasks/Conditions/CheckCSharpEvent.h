...
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x19A0C4A0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19A0C610)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_GET_TARGETEVENT_OFFSET UNITYSDK_OFFSET(0x19A0C480)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x19A0C740)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19A0CC20)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19A0CA10)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19A0C8E0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_ONINIT_OFFSET UNITYSDK_OFFSET(0x19A0C750)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_0__MIGRATE_OFFSET UNITYSDK_OFFSET(0x19A0C2B0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_NODECANVAS_TASKS_CONDITIONS_CHECKSTATICCSHARPEVENT__MIGRATE_OFFSET UNITYSDK_OFFSET(0x19A0C3C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_RAISED_OFFSET UNITYSDK_OFFSET(0x19A0CB40)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT_SETTARGETEVENT_OFFSET UNITYSDK_OFFSET(0x19A0C370)
#define NODECANVAS_TASKS_CONDITIONS_CHECKCSHARPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0CC30)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckCSharpEvent_TypeDefinitionIndex = 25481;
