...
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x19C14270)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19C14380)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x19C14250)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19C14A60)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_ONINIT_OFFSET UNITYSDK_OFFSET(0x19C14980)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19C14640)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x19C147F0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C14EB0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckProperty_TypeDefinitionIndex = 25787;
