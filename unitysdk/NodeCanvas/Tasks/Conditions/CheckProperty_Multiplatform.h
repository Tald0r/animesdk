...
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x19762CE0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19762DE0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x19762CC0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x19763110)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19763340)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_ONINIT_OFFSET UNITYSDK_OFFSET(0x19763250)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19763120)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x197631C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x19763830)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckProperty_Multiplatform_TypeDefinitionIndex = 26411;
