...
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x19C30B60)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19C30C60)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x19C30B40)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x19C30F90)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19C311C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_ONINIT_OFFSET UNITYSDK_OFFSET(0x19C310D0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19C30FA0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x19C31040)
#define NODECANVAS_TASKS_CONDITIONS_CHECKPROPERTY_MULTIPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x19C316B0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckProperty_Multiplatform_TypeDefinitionIndex = 27167;
