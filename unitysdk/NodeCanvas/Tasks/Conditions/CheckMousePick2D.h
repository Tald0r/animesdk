...
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSEPICK2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19C87B70)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSEPICK2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19C87CB0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSEPICK2D__CTOR_OFFSET UNITYSDK_OFFSET(0x19C88040)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckMousePick2D_TypeDefinitionIndex = 25953;
