...
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSEPICK2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A229340)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSEPICK2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A229480)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSEPICK2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A229810)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckMousePick2D_TypeDefinitionIndex = 27064;
