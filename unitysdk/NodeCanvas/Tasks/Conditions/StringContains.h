...
#define NODECANVAS_TASKS_CONDITIONS_STRINGCONTAINS_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A08CEF0)
#define NODECANVAS_TASKS_CONDITIONS_STRINGCONTAINS_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A08CF60)
#define NODECANVAS_TASKS_CONDITIONS_STRINGCONTAINS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A08CFE0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int StringContains_TypeDefinitionIndex = 26457;
