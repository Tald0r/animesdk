...
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x19192280)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_EVENTTYPE_OFFSET UNITYSDK_OFFSET(0x19192180)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19192390)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_ISSTATIC_OFFSET UNITYSDK_OFFSET(0x19192160)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_TARGETEVENTFIELD_OFFSET UNITYSDK_OFFSET(0x19192200)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_TARGETEVENTPROP_OFFSET UNITYSDK_OFFSET(0x19192240)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_GET_TARGETMEMBER_OFFSET UNITYSDK_OFFSET(0x19192140)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x19192510)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19192960)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x191927F0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19192700)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_ONINIT_OFFSET UNITYSDK_OFFSET(0x19192520)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_IMIGRATABLE_NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_0__MIGRATE_OFFSET UNITYSDK_OFFSET(0x191920A0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_RAISED_OFFSET UNITYSDK_OFFSET(0x19192880)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT_SETTARGETEVENT_OFFSET UNITYSDK_OFFSET(0x19192970)
#define NODECANVAS_TASKS_CONDITIONS_CHECKUNITYEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191929D0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckUnityEvent_TypeDefinitionIndex = 27387;
