...
#define NODECANVAS_TASKS_CONDITIONS_CHECKSTATICCSHARPEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F5CCE0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckStaticCSharpEvent_TypeDefinitionIndex = 25593;
