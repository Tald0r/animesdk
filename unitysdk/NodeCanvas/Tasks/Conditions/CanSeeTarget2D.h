...
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGET2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A3ABC20)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGET2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A3ABD00)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGET2D_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A3AC3F0)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGET2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3ACC90)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CanSeeTarget2D_TypeDefinitionIndex = 26890;
