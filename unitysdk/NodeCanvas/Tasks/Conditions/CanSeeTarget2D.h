...
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGET2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19DBA9C0)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGET2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19DBAAA0)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGET2D_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19DBB190)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGET2D__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBBA30)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CanSeeTarget2D_TypeDefinitionIndex = 26301;
	...
	public:
		...
		::UnityEngine::Vector2 offset; // 0x80
