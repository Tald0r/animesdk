...
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A1B7490)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A1B7570)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A1B8360)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B8C50)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY__ONCHECK_B__10_0_OFFSET UNITYSDK_OFFSET(0x1A1B8DA0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CanSeeTargetAny_TypeDefinitionIndex = 26672;
