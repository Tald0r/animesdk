...
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A56DC00)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A56DE20)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A56DE80)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A56DD70)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A56DCB0)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A56DEC0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int Timeout_TypeDefinitionIndex = 27332;
