...
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19F5CDC0)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19F5CFE0)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19F5D040)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19F5CF30)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19F5CE70)
#define NODECANVAS_TASKS_CONDITIONS_TIMEOUT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F5D080)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int Timeout_TypeDefinitionIndex = 26853;
