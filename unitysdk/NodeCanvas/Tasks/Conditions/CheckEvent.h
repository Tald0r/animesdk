...
#define NODECANVAS_TASKS_CONDITIONS_CHECKEVENT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19C870D0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKEVENT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19C87290)
#define NODECANVAS_TASKS_CONDITIONS_CHECKEVENT_ONCUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0x19C872A0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19C871D0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19C87110)
#define NODECANVAS_TASKS_CONDITIONS_CHECKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C873C0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckEvent_TypeDefinitionIndex = 25983;
