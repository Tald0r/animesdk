...
#define NODECANVAS_TASKS_CONDITIONS_CHECKBOOLEANTRIGGER_GET_INFO_OFFSET UNITYSDK_OFFSET(0x196EFEC0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKBOOLEANTRIGGER_ONCHECK_OFFSET UNITYSDK_OFFSET(0x196EFF30)
#define NODECANVAS_TASKS_CONDITIONS_CHECKBOOLEANTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x196EFF80)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckBooleanTrigger_TypeDefinitionIndex = 25961;
