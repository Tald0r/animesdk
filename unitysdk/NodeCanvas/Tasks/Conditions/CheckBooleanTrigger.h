...
#define NODECANVAS_TASKS_CONDITIONS_CHECKBOOLEANTRIGGER_GET_INFO_OFFSET UNITYSDK_OFFSET(0x192738E0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKBOOLEANTRIGGER_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19273950)
#define NODECANVAS_TASKS_CONDITIONS_CHECKBOOLEANTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x192739A0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckBooleanTrigger_TypeDefinitionIndex = 26794;
