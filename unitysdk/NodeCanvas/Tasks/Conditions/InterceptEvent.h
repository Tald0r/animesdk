...
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19C887F0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19C89B60)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x19C8A430)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19C89220)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONDRAG_OFFSET UNITYSDK_OFFSET(0x19C89FD0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONDROP_OFFSET UNITYSDK_OFFSET(0x19C8A0B0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19C888E0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONMOVE_OFFSET UNITYSDK_OFFSET(0x19C8A510)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x19C89EF0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x19C89D30)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x19C89B70)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x19C89C50)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x19C89E10)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x19C8A190)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONSELECT_OFFSET UNITYSDK_OFFSET(0x19C8A350)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONSUBMIT_OFFSET UNITYSDK_OFFSET(0x19C8A5F0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONUPDATESELECTED_OFFSET UNITYSDK_OFFSET(0x19C8A270)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8A6D0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int InterceptEvent_TypeDefinitionIndex = 26748;
