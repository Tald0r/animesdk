...
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A229FC0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A22B350)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x1A22BC20)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A22AA00)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1A22B7C0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONDROP_OFFSET UNITYSDK_OFFSET(0x1A22B8A0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A22A0B0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONMOVE_OFFSET UNITYSDK_OFFSET(0x1A22BD00)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTERCLICK_OFFSET UNITYSDK_OFFSET(0x1A22B6E0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1A22B520)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1A22B360)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x1A22B440)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1A22B600)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x1A22B980)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONSELECT_OFFSET UNITYSDK_OFFSET(0x1A22BB40)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONSUBMIT_OFFSET UNITYSDK_OFFSET(0x1A22BDE0)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT_ONUPDATESELECTED_OFFSET UNITYSDK_OFFSET(0x1A22BA60)
#define NODECANVAS_TASKS_CONDITIONS_INTERCEPTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A22BEC0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int InterceptEvent_TypeDefinitionIndex = 26637;
