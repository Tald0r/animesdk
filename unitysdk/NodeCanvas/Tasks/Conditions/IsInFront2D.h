...
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19DBCB40)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19DBCC20)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT2D_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19DBCEC0)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT2D__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBD130)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int IsInFront2D_TypeDefinitionIndex = 26888;
