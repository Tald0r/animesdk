...
#define NODECANVAS_TASKS_CONDITIONS_CHECKBUTTONINPUT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A26B990)
#define NODECANVAS_TASKS_CONDITIONS_CHECKBUTTONINPUT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A26BA30)
#define NODECANVAS_TASKS_CONDITIONS_CHECKBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A26BAD0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckButtonInput_TypeDefinitionIndex = 25906;
