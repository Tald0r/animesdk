...
#define NODECANVAS_TASKS_CONDITIONS_CHECKBUTTONINPUT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A833340)
#define NODECANVAS_TASKS_CONDITIONS_CHECKBUTTONINPUT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A8333E0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKBUTTONINPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A833480)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckButtonInput_TypeDefinitionIndex = 26774;
