...
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19190290)
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19190430)
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED_ONCLICK_OFFSET UNITYSDK_OFFSET(0x19190440)
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED_ONINIT_OFFSET UNITYSDK_OFFSET(0x19190310)
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED__CTOR_OFFSET UNITYSDK_OFFSET(0x19190520)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int ButtonClicked_TypeDefinitionIndex = 27423;
