...
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED_GET_INFO_OFFSET UNITYSDK_OFFSET(0x183F35D0)
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED_ONCHECK_OFFSET UNITYSDK_OFFSET(0x183F3770)
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED_ONCLICK_OFFSET UNITYSDK_OFFSET(0x183F3780)
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED_ONINIT_OFFSET UNITYSDK_OFFSET(0x183F3650)
#define NODECANVAS_TASKS_CONDITIONS_BUTTONCLICKED__CTOR_OFFSET UNITYSDK_OFFSET(0x183F3860)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int ButtonClicked_TypeDefinitionIndex = 25973;
