...
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x19FF42D0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19FF43D0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x19FF42B0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x19FF49B0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19FF5000)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_ONINIT_OFFSET UNITYSDK_OFFSET(0x19FF4E70)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19FF49C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x19FF49E0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF56D0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckFunction_Multiplatform_TypeDefinitionIndex = 26083;
	...
	public:
		...
		::System::Collections::Generic::List_1<::NodeCanvas::Framework::Internal::BBObjectParameter*>* parameters; // 0x80
