...
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A60D360)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A60D460)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A60D340)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x1A60DA40)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A60E080)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_ONINIT_OFFSET UNITYSDK_OFFSET(0x1A60DF00)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A60DA50)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x1A60DA70)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_MULTIPLATFORM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A60E750)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckFunction_Multiplatform_TypeDefinitionIndex = 26689;
	...
	public:
		...
		::NodeCanvas::Framework::Internal::BBObjectParameter* checkValue; // 0x78
