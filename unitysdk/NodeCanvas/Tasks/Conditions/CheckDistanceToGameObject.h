...
#define NODECANVAS_TASKS_CONDITIONS_CHECKDISTANCETOGAMEOBJECT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19C13BC0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKDISTANCETOGAMEOBJECT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19C13ED0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKDISTANCETOGAMEOBJECT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19C14090)
#define NODECANVAS_TASKS_CONDITIONS_CHECKDISTANCETOGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C141D0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckDistanceToGameObject_TypeDefinitionIndex = 25480;
