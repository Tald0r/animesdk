...
#define NODECANVAS_TASKS_CONDITIONS_CHECKVECTORDISTANCE_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A1B8EF0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKVECTORDISTANCE_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A1B91C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKVECTORDISTANCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B92E0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckVectorDistance_TypeDefinitionIndex = 26800;
