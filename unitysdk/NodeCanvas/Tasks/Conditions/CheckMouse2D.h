...
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A48D750)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A48DC40)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A48DA00)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A48D7C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_ONMOUSEENTER_OFFSET UNITYSDK_OFFSET(0x1A48DC50)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_ONMOUSEEXIT_OFFSET UNITYSDK_OFFSET(0x1A48DD30)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D_ONMOUSEOVER_OFFSET UNITYSDK_OFFSET(0x1A48DE10)
#define NODECANVAS_TASKS_CONDITIONS_CHECKMOUSE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A48DEF0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckMouse2D_TypeDefinitionIndex = 26645;
