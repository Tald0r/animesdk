...
#define NODECANVAS_TASKS_CONDITIONS_CHECKENUM_GET_INFO_OFFSET UNITYSDK_OFFSET(0x192739B0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKENUM_ONCHECK_OFFSET UNITYSDK_OFFSET(0x192739F0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKENUM__CTOR_OFFSET UNITYSDK_OFFSET(0x19273AA0)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckEnum_TypeDefinitionIndex = 25257;
