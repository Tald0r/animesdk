...
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A26C4C0)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A26C5A0)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A26C900)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A26CB80)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int IsInFront_TypeDefinitionIndex = 26736;
