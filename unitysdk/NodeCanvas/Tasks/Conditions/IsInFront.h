...
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A833E70)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A833F50)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A8342B0)
#define NODECANVAS_TASKS_CONDITIONS_ISINFRONT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A834530)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int IsInFront_TypeDefinitionIndex = 27602;
