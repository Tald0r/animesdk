...
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x19DBBB90)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19DBBCA0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_GET_TARGETMETHOD_OFFSET UNITYSDK_OFFSET(0x19DBBB70)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19DBC6E0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_ONINIT_OFFSET UNITYSDK_OFFSET(0x19DBC600)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19DBC2C0)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION_SETMETHOD_OFFSET UNITYSDK_OFFSET(0x19DBC470)
#define NODECANVAS_TASKS_CONDITIONS_CHECKFUNCTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBCB30)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CheckFunction_TypeDefinitionIndex = 25693;
