...
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19167950)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19167A40)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY2D_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19168780)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY2D__CTOR_OFFSET UNITYSDK_OFFSET(0x19168EE0)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY2D__ONCHECK_B__9_0_OFFSET UNITYSDK_OFFSET(0x19169020)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CanSeeTargetAny2D_TypeDefinitionIndex = 26535;

	class CanSeeTargetAny2D : public ::NodeCanvas::Framework::ConditionTask_1<::UnityEngine::Transform*>
	{
	public:
		::NodeCanvas::Framework::BBParameter_1<::System::Single>* awarnessDistance; // 0x60
		...
		::NodeCanvas::Framework::BBParameter_1<::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*>* targetObjects; // 0x88
