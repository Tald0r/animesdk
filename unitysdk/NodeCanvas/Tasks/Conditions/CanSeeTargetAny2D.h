...
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY2D_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19559A90)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY2D_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19559B80)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY2D_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1955A8B0)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1955B010)
#define NODECANVAS_TASKS_CONDITIONS_CANSEETARGETANY2D__ONCHECK_B__9_0_OFFSET UNITYSDK_OFFSET(0x1955B160)

namespace NodeCanvas::Tasks::Conditions
{
	inline static constexpr unsigned int CanSeeTargetAny2D_TypeDefinitionIndex = 26586;
