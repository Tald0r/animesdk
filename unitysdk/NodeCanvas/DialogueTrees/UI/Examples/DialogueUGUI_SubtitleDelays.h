...
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_SUBTITLEDELAYS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1ADFD0)

namespace NodeCanvas::DialogueTrees::UI::Examples
{
	inline static constexpr unsigned int DialogueUGUI_SubtitleDelays_TypeDefinitionIndex = 26526;
