...
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__INTERNAL_ONSUBTITLESREQUESTINFO_D__25_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x183F0AC0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__INTERNAL_ONSUBTITLESREQUESTINFO_D__25_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x183F19A0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__INTERNAL_ONSUBTITLESREQUESTINFO_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x183F1A00)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__INTERNAL_ONSUBTITLESREQUESTINFO_D__25_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x183F19B0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__INTERNAL_ONSUBTITLESREQUESTINFO_D__25_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x183F0AB0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__INTERNAL_ONSUBTITLESREQUESTINFO_D__25__CTOR_OFFSET UNITYSDK_OFFSET(0x183F0AA0)

namespace NodeCanvas::DialogueTrees::UI::Examples
{
	inline static constexpr unsigned int DialogueUGUI__Internal_OnSubtitlesRequestInfo_d__25_TypeDefinitionIndex = 26524;

	class DialogueUGUI__Internal_OnSubtitlesRequestInfo_d__25 : public ::System::Object
	{
	public:
		::UnityEngine::AudioClip* _audio_5__3; // 0x10
		::System::String* _text_5__2; // 0x18
		::System::String* _tempText_5__6; // 0x20
		...
		::NodeCanvas::DialogueTrees::UI::Examples::DialogueUGUI* __4__this; // 0x40
		::UnityEngine::AudioSource* _playSource_5__4; // 0x48
		::System::Single _timer_5__5; // 0x50
		::System::Int32 _i_5__7; // 0x54
