...
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__COUNTDOWN_D__30_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19FF8670)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__COUNTDOWN_D__30_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FF87F0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__COUNTDOWN_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FF8850)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__COUNTDOWN_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19FF8800)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__COUNTDOWN_D__30_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19FF8660)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__COUNTDOWN_D__30__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF8650)

namespace NodeCanvas::DialogueTrees::UI::Examples
{
	inline static constexpr unsigned int DialogueUGUI__CountDown_d__30_TypeDefinitionIndex = 26519;
	...
	public:
		...
		::NodeCanvas::DialogueTrees::MultipleChoiceRequestInfo* info; // 0x20
