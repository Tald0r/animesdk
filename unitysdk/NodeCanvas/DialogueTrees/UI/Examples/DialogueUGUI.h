...
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_CHECKINPUT_OFFSET UNITYSDK_OFFSET(0x19163E90)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x191647D0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_DELAYPRINT_OFFSET UNITYSDK_OFFSET(0x19163EE0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19164820)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_GET_LOCALSOURCE_OFFSET UNITYSDK_OFFSET(0x19163000)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_INTERNAL_ONSUBTITLESREQUESTINFO_OFFSET UNITYSDK_OFFSET(0x19163D10)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDIALOGUEFINISHED_OFFSET UNITYSDK_OFFSET(0x19163A10)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDIALOGUEPAUSED_OFFSET UNITYSDK_OFFSET(0x191639A0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDIALOGUESTARTED_OFFSET UNITYSDK_OFFSET(0x19163990)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x191634A0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONENABLE_OFFSET UNITYSDK_OFFSET(0x191630D0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONMULTIPLECHOICEREQUEST_OFFSET UNITYSDK_OFFSET(0x19163F30)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONSUBTITLESREQUEST_OFFSET UNITYSDK_OFFSET(0x19163C50)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_PLAYTYPESOUND_OFFSET UNITYSDK_OFFSET(0x19163D60)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_SETMASSALPHA_OFFSET UNITYSDK_OFFSET(0x19164AA0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_START_OFFSET UNITYSDK_OFFSET(0x19163870)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19164C20)

namespace NodeCanvas::DialogueTrees::UI::Examples
{
	inline static constexpr unsigned int DialogueUGUI_TypeDefinitionIndex = 26519;
