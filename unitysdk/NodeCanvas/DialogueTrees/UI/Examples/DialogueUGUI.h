...
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_CHECKINPUT_OFFSET UNITYSDK_OFFSET(0x19555FE0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x19556920)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_DELAYPRINT_OFFSET UNITYSDK_OFFSET(0x19556030)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19556970)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_GET_LOCALSOURCE_OFFSET UNITYSDK_OFFSET(0x19555150)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_INTERNAL_ONSUBTITLESREQUESTINFO_OFFSET UNITYSDK_OFFSET(0x19555E60)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDIALOGUEFINISHED_OFFSET UNITYSDK_OFFSET(0x19555B60)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDIALOGUEPAUSED_OFFSET UNITYSDK_OFFSET(0x19555AF0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDIALOGUESTARTED_OFFSET UNITYSDK_OFFSET(0x19555AE0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x195555F0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19555220)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONMULTIPLECHOICEREQUEST_OFFSET UNITYSDK_OFFSET(0x19556080)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_ONSUBTITLESREQUEST_OFFSET UNITYSDK_OFFSET(0x19555DA0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_PLAYTYPESOUND_OFFSET UNITYSDK_OFFSET(0x19555EB0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_SETMASSALPHA_OFFSET UNITYSDK_OFFSET(0x19556BF0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI_START_OFFSET UNITYSDK_OFFSET(0x195559C0)
#define NODECANVAS_DIALOGUETREES_UI_EXAMPLES_DIALOGUEUGUI__CTOR_OFFSET UNITYSDK_OFFSET(0x19556D70)

namespace NodeCanvas::DialogueTrees::UI::Examples
{
	inline static constexpr unsigned int DialogueUGUI_TypeDefinitionIndex = 26518;
