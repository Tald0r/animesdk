...
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER_GET_ACTOR_OFFSET UNITYSDK_OFFSET(0x19FEE2A0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER_GET_ID_OFFSET UNITYSDK_OFFSET(0x19FEF120)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19FEF100)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER_SET_ACTOR_OFFSET UNITYSDK_OFFSET(0x19FEE490)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19FEF110)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FEF1D0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FEF170)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19FEF180)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE_ACTORPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEF160)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DialogueTree_ActorParameter_TypeDefinitionIndex = 26234;
