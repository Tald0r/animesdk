...
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICENODE___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19C84430)
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICENODE___C__DISPLAYCLASS9_0__ONOPTIONSELECTED_B__0_OFFSET UNITYSDK_OFFSET(0x19C84440)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int MultipleChoiceNode___c__DisplayClass9_0_TypeDefinitionIndex = 25155;
