...
#define NODECANVAS_DIALOGUETREES_STATEMENT___C__DISPLAYCLASS16_0__BLACKBOARDREPLACE_B__0_OFFSET UNITYSDK_OFFSET(0x1975E000)
#define NODECANVAS_DIALOGUETREES_STATEMENT___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1975DFF0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int Statement___c__DisplayClass16_0_TypeDefinitionIndex = 26226;
