...
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FEF090)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE___C__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEF0D0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREE___C__GET_DEFINEDACTORPARAMETERNAMES_B__46_0_OFFSET UNITYSDK_OFFSET(0x19FEF0E0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DialogueTree___c_TypeDefinitionIndex = 26237;
	...
	public:
		...
		{
			return (::System::Func_2<::NodeCanvas::DialogueTrees::DialogueTree_ActorParameter*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(DialogueTree___c_TypeDefinitionIndex)->GetStaticField(0x1F820);
		}
		static ::NodeCanvas::DialogueTrees::DialogueTree___c** StaticGet___9()
		{
			return (::NodeCanvas::DialogueTrees::DialogueTree___c**)Il2CppClass::FromTypeDefinitionIndex(DialogueTree___c_TypeDefinitionIndex)->GetStaticField(0x1F828);
		}
