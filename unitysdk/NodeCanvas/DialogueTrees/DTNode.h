...
#define NODECANVAS_DIALOGUETREES_DTNODE_GET_ACTORNAME_OFFSET UNITYSDK_OFFSET(0x196E0A30)
#define NODECANVAS_DIALOGUETREES_DTNODE_GET_ALLOWASPRIME_OFFSET UNITYSDK_OFFSET(0x196E0B20)
#define NODECANVAS_DIALOGUETREES_DTNODE_GET_CANSELFCONNECT_OFFSET UNITYSDK_OFFSET(0x196E0B30)
#define NODECANVAS_DIALOGUETREES_DTNODE_GET_COMMENTSALIGNMENT_OFFSET UNITYSDK_OFFSET(0x196E0B40)
#define NODECANVAS_DIALOGUETREES_DTNODE_GET_DLGTREE_OFFSET UNITYSDK_OFFSET(0x196E09C0)
#define NODECANVAS_DIALOGUETREES_DTNODE_GET_FINALACTOR_OFFSET UNITYSDK_OFFSET(0x196E0C70)
#define NODECANVAS_DIALOGUETREES_DTNODE_GET_ICONALIGNMENT_OFFSET UNITYSDK_OFFSET(0x196E0B50)
#define NODECANVAS_DIALOGUETREES_DTNODE_GET_MAXINCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x196E0AD0)
#define NODECANVAS_DIALOGUETREES_DTNODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x196E0AE0)
#define NODECANVAS_DIALOGUETREES_DTNODE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x196E0780)
#define NODECANVAS_DIALOGUETREES_DTNODE_GET_OUTCONNECTIONTYPE_OFFSET UNITYSDK_OFFSET(0x196E0AF0)
#define NODECANVAS_DIALOGUETREES_DTNODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x196E0AC0)
#define NODECANVAS_DIALOGUETREES_DTNODE_SET_ACTORNAME_OFFSET UNITYSDK_OFFSET(0x196E0B60)
#define NODECANVAS_DIALOGUETREES_DTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x196E0D80)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DTNode_TypeDefinitionIndex = 26735;
