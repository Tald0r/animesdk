...
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x19FECD20)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x19FECDC0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x19FECD40)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_ONACTIONEND_OFFSET UNITYSDK_OFFSET(0x19FECF90)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19FECDD0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_ONGRAPHPAUSED_OFFSET UNITYSDK_OFFSET(0x19FED2F0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19FED2B0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_SET_ACTION_OFFSET UNITYSDK_OFFSET(0x19FECD30)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x19FECD50)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_UPDATEACTION_OFFSET UNITYSDK_OFFSET(0x19FECF40)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FED320)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ActionNode_TypeDefinitionIndex = 25781;
