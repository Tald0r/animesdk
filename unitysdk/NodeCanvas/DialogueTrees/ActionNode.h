...
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x1A605DC0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1A605E60)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1A605DE0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_ONACTIONEND_OFFSET UNITYSDK_OFFSET(0x1A606030)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A605E70)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_ONGRAPHPAUSED_OFFSET UNITYSDK_OFFSET(0x1A606390)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A606350)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_SET_ACTION_OFFSET UNITYSDK_OFFSET(0x1A605DD0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1A605DF0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE_UPDATEACTION_OFFSET UNITYSDK_OFFSET(0x1A605FE0)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6063C0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ActionNode_TypeDefinitionIndex = 27275;
