...
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A726370)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A726520)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A726580)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A726530)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A726360)
#define NODECANVAS_DIALOGUETREES_ACTIONNODE__UPDATEACTION_D__10__CTOR_OFFSET UNITYSDK_OFFSET(0x1A726350)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ActionNode__UpdateAction_d__10_TypeDefinitionIndex = 27276;
	...
	public:
		...
		::UnityEngine::Component* actionAgent; // 0x20
