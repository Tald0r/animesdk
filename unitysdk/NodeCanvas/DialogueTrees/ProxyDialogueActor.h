...
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_DIALOGUECOLOR_OFFSET UNITYSDK_OFFSET(0x19FEF210)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_DIALOGUEPOSITION_OFFSET UNITYSDK_OFFSET(0x19FEF220)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19FEF1E0)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_PORTRAITSPRITE_OFFSET UNITYSDK_OFFSET(0x19FEF200)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_PORTRAIT_OFFSET UNITYSDK_OFFSET(0x19FEF1F0)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x19FEF240)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEE290)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ProxyDialogueActor_TypeDefinitionIndex = 26826;
