...
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_DIALOGUECOLOR_OFFSET UNITYSDK_OFFSET(0x1A6082A0)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_DIALOGUEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A6082B0)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A608270)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_PORTRAITSPRITE_OFFSET UNITYSDK_OFFSET(0x1A608290)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_PORTRAIT_OFFSET UNITYSDK_OFFSET(0x1A608280)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A6082D0)
#define NODECANVAS_DIALOGUETREES_PROXYDIALOGUEACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A607330)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ProxyDialogueActor_TypeDefinitionIndex = 27192;
