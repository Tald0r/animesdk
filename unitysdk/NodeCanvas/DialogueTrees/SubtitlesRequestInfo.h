...
#define NODECANVAS_DIALOGUETREES_SUBTITLESREQUESTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19F58BF0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int SubtitlesRequestInfo_TypeDefinitionIndex = 25250;
