...
#define NODECANVAS_DIALOGUETREES_FINISHNODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A65C3C0)
#define NODECANVAS_DIALOGUETREES_FINISHNODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1A65C3D0)
#define NODECANVAS_DIALOGUETREES_FINISHNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A65C3E0)
#define NODECANVAS_DIALOGUETREES_FINISHNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65C490)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int FinishNode_TypeDefinitionIndex = 27346;
