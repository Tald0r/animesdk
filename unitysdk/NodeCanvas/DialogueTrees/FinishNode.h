...
#define NODECANVAS_DIALOGUETREES_FINISHNODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A0897B0)
#define NODECANVAS_DIALOGUETREES_FINISHNODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1A0897C0)
#define NODECANVAS_DIALOGUETREES_FINISHNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A0897D0)
#define NODECANVAS_DIALOGUETREES_FINISHNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A089880)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int FinishNode_TypeDefinitionIndex = 26430;
