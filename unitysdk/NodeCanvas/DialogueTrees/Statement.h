...
#define NODECANVAS_DIALOGUETREES_STATEMENT_BLACKBOARDREPLACE_OFFSET UNITYSDK_OFFSET(0x192648D0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_GET_AUDIO_OFFSET UNITYSDK_OFFSET(0x19264820)
#define NODECANVAS_DIALOGUETREES_STATEMENT_GET_META_OFFSET UNITYSDK_OFFSET(0x19264840)
#define NODECANVAS_DIALOGUETREES_STATEMENT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x19264800)
#define NODECANVAS_DIALOGUETREES_STATEMENT_SET_AUDIO_OFFSET UNITYSDK_OFFSET(0x19264830)
#define NODECANVAS_DIALOGUETREES_STATEMENT_SET_META_OFFSET UNITYSDK_OFFSET(0x19264850)
#define NODECANVAS_DIALOGUETREES_STATEMENT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x19264810)
#define NODECANVAS_DIALOGUETREES_STATEMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x192649E0)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19264880)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x192648A0)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x192648C0)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19264860)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int Statement_TypeDefinitionIndex = 26225;
