...
#define NODECANVAS_DIALOGUETREES_STATEMENT_BLACKBOARDREPLACE_OFFSET UNITYSDK_OFFSET(0x196E0E90)
#define NODECANVAS_DIALOGUETREES_STATEMENT_GET_AUDIO_OFFSET UNITYSDK_OFFSET(0x196E0DE0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_GET_META_OFFSET UNITYSDK_OFFSET(0x196E0E00)
#define NODECANVAS_DIALOGUETREES_STATEMENT_GET_TEXT_OFFSET UNITYSDK_OFFSET(0x196E0DC0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_SET_AUDIO_OFFSET UNITYSDK_OFFSET(0x196E0DF0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_SET_META_OFFSET UNITYSDK_OFFSET(0x196E0E10)
#define NODECANVAS_DIALOGUETREES_STATEMENT_SET_TEXT_OFFSET UNITYSDK_OFFSET(0x196E0DD0)
#define NODECANVAS_DIALOGUETREES_STATEMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x196E0FA0)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x196E0E40)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x196E0E60)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x196E0E80)
#define NODECANVAS_DIALOGUETREES_STATEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x196E0E20)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int Statement_TypeDefinitionIndex = 27478;
