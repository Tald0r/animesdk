...
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR_GET_DIALOGUECOLOR_OFFSET UNITYSDK_OFFSET(0x19C2BD90)
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR_GET_DIALOGUEPOSITION_OFFSET UNITYSDK_OFFSET(0x19C2BDA0)
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19C2BBD0)
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR_GET_PORTRAITSPRITE_OFFSET UNITYSDK_OFFSET(0x19C2BBF0)
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR_GET_PORTRAIT_OFFSET UNITYSDK_OFFSET(0x19C2BBE0)
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x19C2BE40)
#define NODECANVAS_DIALOGUETREES_DIALOGUEACTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2BE10)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DialogueActor_TypeDefinitionIndex = 26651;
