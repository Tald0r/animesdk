...
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_GETACTORREFERENCEBYNAME_OFFSET UNITYSDK_OFFSET(0x19F58B00)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_DIALOGUECOLOR_OFFSET UNITYSDK_OFFSET(0x19F58530)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_DIALOGUEPOSITION_OFFSET UNITYSDK_OFFSET(0x19F58540)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19F584E0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_PORTRAITSPRITE_OFFSET UNITYSDK_OFFSET(0x19F58520)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_PORTRAIT_OFFSET UNITYSDK_OFFSET(0x19F58510)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x19F58560)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_PAUSEDIALOGUE_OFFSET UNITYSDK_OFFSET(0x19F588C0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_SETACTORREFERENCES_OFFSET UNITYSDK_OFFSET(0x19F58A30)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_SETACTORREFERENCE_OFFSET UNITYSDK_OFFSET(0x19F58960)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_1_OFFSET UNITYSDK_OFFSET(0x19F587E0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_2_OFFSET UNITYSDK_OFFSET(0x19F587F0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_3_OFFSET UNITYSDK_OFFSET(0x19F58800)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_4_OFFSET UNITYSDK_OFFSET(0x19F58580)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_OFFSET UNITYSDK_OFFSET(0x19F58570)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STOPDIALOGUE_OFFSET UNITYSDK_OFFSET(0x19F58910)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F58BD0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DialogueTreeController_TypeDefinitionIndex = 26191;
