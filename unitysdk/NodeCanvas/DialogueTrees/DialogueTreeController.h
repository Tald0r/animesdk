...
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_GETACTORREFERENCEBYNAME_OFFSET UNITYSDK_OFFSET(0x1A569930)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_DIALOGUECOLOR_OFFSET UNITYSDK_OFFSET(0x1A569360)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_DIALOGUEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A569370)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A569310)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_PORTRAITSPRITE_OFFSET UNITYSDK_OFFSET(0x1A569350)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_PORTRAIT_OFFSET UNITYSDK_OFFSET(0x1A569340)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_NODECANVAS_DIALOGUETREES_IDIALOGUEACTOR_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A569390)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_PAUSEDIALOGUE_OFFSET UNITYSDK_OFFSET(0x1A5696F0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_SETACTORREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A569860)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_SETACTORREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A569790)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_1_OFFSET UNITYSDK_OFFSET(0x1A569610)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_2_OFFSET UNITYSDK_OFFSET(0x1A569620)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_3_OFFSET UNITYSDK_OFFSET(0x1A569630)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_4_OFFSET UNITYSDK_OFFSET(0x1A5693B0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STARTDIALOGUE_OFFSET UNITYSDK_OFFSET(0x1A5693A0)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER_STOPDIALOGUE_OFFSET UNITYSDK_OFFSET(0x1A569740)
#define NODECANVAS_DIALOGUETREES_DIALOGUETREECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A569A00)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DialogueTreeController_TypeDefinitionIndex = 27012;
