...
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_GETTOTAL_OFFSET UNITYSDK_OFFSET(0x19E9CB50)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19E9C650)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONCHILDCONNECTED_OFFSET UNITYSDK_OFFSET(0x19E9C660)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x19E9C720)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19E9C7A0)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E9CC40)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19E9CC50)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ProbabilitySelector_TypeDefinitionIndex = 25970;

	class ProbabilitySelector : public ::NodeCanvas::DialogueTrees::DTNode
	{
	public:
		::System::Collections::Generic::List_1<::System::Int32>* successIndeces; // 0x88
		::System::Collections::Generic::List_1<::NodeCanvas::DialogueTrees::ProbabilitySelector_Option*>* childOptions; // 0x90
