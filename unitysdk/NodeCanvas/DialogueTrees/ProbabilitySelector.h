...
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_GETTOTAL_OFFSET UNITYSDK_OFFSET(0x1A48A2E0)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A489DE0)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONCHILDCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A489DF0)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A489EB0)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A489F30)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A48A3D0)
#define NODECANVAS_DIALOGUETREES_PROBABILITYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A48A3E0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ProbabilitySelector_TypeDefinitionIndex = 26894;
