...
#define NODECANVAS_DIALOGUETREES_GOTONODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19A08550)
#define NODECANVAS_DIALOGUETREES_GOTONODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x19A08560)
#define NODECANVAS_DIALOGUETREES_GOTONODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19A08570)
#define NODECANVAS_DIALOGUETREES_GOTONODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A08640)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int GoToNode_TypeDefinitionIndex = 26494;
