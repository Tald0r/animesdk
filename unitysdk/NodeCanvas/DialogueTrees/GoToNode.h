...
#define NODECANVAS_DIALOGUETREES_GOTONODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19FF8520)
#define NODECANVAS_DIALOGUETREES_GOTONODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x19FF8530)
#define NODECANVAS_DIALOGUETREES_GOTONODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19FF8540)
#define NODECANVAS_DIALOGUETREES_GOTONODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF8610)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int GoToNode_TypeDefinitionIndex = 26042;
