...
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x196E0FB0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x196E1080)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x196E0FC0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x196E2EB0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x196E1090)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_ONSUBDIALOGUEFINISH_OFFSET UNITYSDK_OFFSET(0x196E2920)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x196E1020)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_TRYWRITEMAPPEDACTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x196E22D0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE__CTOR_OFFSET UNITYSDK_OFFSET(0x196E3010)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int SubDialogueTree_TypeDefinitionIndex = 26721;

	class SubDialogueTree : public ::NodeCanvas::DialogueTrees::DTNodeNested_1<::NodeCanvas::DialogueTrees::DialogueTree*>
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _actorParametersMap; // 0xA0
		::NodeCanvas::Framework::BBParameter_1<::NodeCanvas::DialogueTrees::DialogueTree*>* _subTree; // 0xA8
