...
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x192649F0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x19264AC0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x19264A00)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x192668F0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19264AD0)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_ONSUBDIALOGUEFINISH_OFFSET UNITYSDK_OFFSET(0x19266360)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x19264A60)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE_TRYWRITEMAPPEDACTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19265D10)
#define NODECANVAS_DIALOGUETREES_SUBDIALOGUETREE__CTOR_OFFSET UNITYSDK_OFFSET(0x19266A50)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int SubDialogueTree_TypeDefinitionIndex = 26729;
