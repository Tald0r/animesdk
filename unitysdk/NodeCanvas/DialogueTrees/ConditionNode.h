...
#define NODECANVAS_DIALOGUETREES_CONDITIONNODE_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1A8301A0)
#define NODECANVAS_DIALOGUETREES_CONDITIONNODE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A830240)
#define NODECANVAS_DIALOGUETREES_CONDITIONNODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1A830250)
#define NODECANVAS_DIALOGUETREES_CONDITIONNODE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1A8301C0)
#define NODECANVAS_DIALOGUETREES_CONDITIONNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A830260)
#define NODECANVAS_DIALOGUETREES_CONDITIONNODE_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1A8301B0)
#define NODECANVAS_DIALOGUETREES_CONDITIONNODE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1A8301D0)
#define NODECANVAS_DIALOGUETREES_CONDITIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A830430)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int ConditionNode_TypeDefinitionIndex = 27042;
