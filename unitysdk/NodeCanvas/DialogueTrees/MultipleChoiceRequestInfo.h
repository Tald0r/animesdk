...
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICEREQUESTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19E07F20)
#define NODECANVAS_DIALOGUETREES_MULTIPLECHOICEREQUESTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19E07F00)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int MultipleChoiceRequestInfo_TypeDefinitionIndex = 25795;
	...
	public:
		...
		::System::Action_1<::System::Int32>* SelectOption; // 0x20
