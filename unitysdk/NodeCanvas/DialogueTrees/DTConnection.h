...
#define NODECANVAS_DIALOGUETREES_DTCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19F584D0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DTConnection_TypeDefinitionIndex = 26222;
