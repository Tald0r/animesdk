...
#define NODECANVAS_DIALOGUETREES_STATEMENTNODE_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1A1ADDA0)
#define NODECANVAS_DIALOGUETREES_STATEMENTNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A1ADDB0)
#define NODECANVAS_DIALOGUETREES_STATEMENTNODE_ONSTATEMENTFINISH_OFFSET UNITYSDK_OFFSET(0x1A1ADEC0)
#define NODECANVAS_DIALOGUETREES_STATEMENTNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1ADF40)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int StatementNode_TypeDefinitionIndex = 26128;
