...
#define NODECANVAS_DIALOGUETREES_JUMPER_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19C10370)
#define NODECANVAS_DIALOGUETREES_JUMPER_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x19C10380)
#define NODECANVAS_DIALOGUETREES_JUMPER_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x19C10310)
#define NODECANVAS_DIALOGUETREES_JUMPER_NODECANVAS_FRAMEWORK_IHAVENODEREFERENCE_GET_TARGETREFERENCE_OFFSET UNITYSDK_OFFSET(0x19C10300)
#define NODECANVAS_DIALOGUETREES_JUMPER_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C10390)
#define NODECANVAS_DIALOGUETREES_JUMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C10520)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int Jumper_TypeDefinitionIndex = 25987;
