...
#define NODECANVAS_DIALOGUETREES_JUMPER_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A1CF010)
#define NODECANVAS_DIALOGUETREES_JUMPER_GET_REQUIREACTORSELECTION_OFFSET UNITYSDK_OFFSET(0x1A1CF020)
#define NODECANVAS_DIALOGUETREES_JUMPER_GET_TARGET_OFFSET UNITYSDK_OFFSET(0x1A1CEFB0)
#define NODECANVAS_DIALOGUETREES_JUMPER_NODECANVAS_FRAMEWORK_IHAVENODEREFERENCE_GET_TARGETREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A1CEFA0)
#define NODECANVAS_DIALOGUETREES_JUMPER_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A1CF030)
#define NODECANVAS_DIALOGUETREES_JUMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1CF1C0)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int Jumper_TypeDefinitionIndex = 27717;
