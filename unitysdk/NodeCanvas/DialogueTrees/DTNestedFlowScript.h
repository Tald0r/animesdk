...
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1918D270)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1918D340)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1918D280)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1918D570)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1918D350)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_ONFLOWSCRIPTFINISH_OFFSET UNITYSDK_OFFSET(0x1918D670)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1918D2E0)
#define NODECANVAS_DIALOGUETREES_DTNESTEDFLOWSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1918D700)

namespace NodeCanvas::DialogueTrees
{
	inline static constexpr unsigned int DTNestedFlowScript_TypeDefinitionIndex = 27339;
