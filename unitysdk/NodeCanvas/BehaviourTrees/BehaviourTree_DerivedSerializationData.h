...
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_DERIVEDSERIALIZATIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A267F50)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BehaviourTree_DerivedSerializationData_TypeDefinitionIndex = 26706;
