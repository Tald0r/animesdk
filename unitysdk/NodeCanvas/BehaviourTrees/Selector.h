...
#define NODECANVAS_BEHAVIOURTREES_SELECTOR_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A830120)
#define NODECANVAS_BEHAVIOURTREES_SELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A82FE20)
#define NODECANVAS_BEHAVIOURTREES_SELECTOR_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A830130)
#define NODECANVAS_BEHAVIOURTREES_SELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A8300C0)
#define NODECANVAS_BEHAVIOURTREES_SELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A830190)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Selector_TypeDefinitionIndex = 27504;
