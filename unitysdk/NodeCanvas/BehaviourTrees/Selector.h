...
#define NODECANVAS_BEHAVIOURTREES_SELECTOR_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A268770)
#define NODECANVAS_BEHAVIOURTREES_SELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A268470)
#define NODECANVAS_BEHAVIOURTREES_SELECTOR_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A268780)
#define NODECANVAS_BEHAVIOURTREES_SELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A268710)
#define NODECANVAS_BEHAVIOURTREES_SELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2687E0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Selector_TypeDefinitionIndex = 26080;
