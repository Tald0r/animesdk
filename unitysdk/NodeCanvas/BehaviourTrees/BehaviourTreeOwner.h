...
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER_GET_REPEAT_OFFSET UNITYSDK_OFFSET(0x19C821E0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER_GET_ROOTSTATUS_OFFSET UNITYSDK_OFFSET(0x19C82500)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER_GET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x19C82360)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER_SET_REPEAT_OFFSET UNITYSDK_OFFSET(0x19C822A0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER_SET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x19C82430)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER_TICK_OFFSET UNITYSDK_OFFSET(0x19C825C0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREEOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C82690)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BehaviourTreeOwner_TypeDefinitionIndex = 25735;
