...
#define NODECANVAS_BEHAVIOURTREES_ITERATOR_GET_LIST_OFFSET UNITYSDK_OFFSET(0x1A225010)
#define NODECANVAS_BEHAVIOURTREES_ITERATOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A225070)
#define NODECANVAS_BEHAVIOURTREES_ITERATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A225780)
#define NODECANVAS_BEHAVIOURTREES_ITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2257A0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Iterator_TypeDefinitionIndex = 26119;

	class Iterator : public ::NodeCanvas::BehaviourTrees::BTDecorator
	{
	public:
		::NodeCanvas::Framework::BBParameter_1<::System::Int32>* storeIndex; // 0x78
		::NodeCanvas::Framework::Internal::BBObjectParameter* current; // 0x80
		::NodeCanvas::Framework::BBParameter_1<::System::Int32>* maxIteration; // 0x88
