...
#define NODECANVAS_BEHAVIOURTREES_ITERATOR_GET_LIST_OFFSET UNITYSDK_OFFSET(0x19C83850)
#define NODECANVAS_BEHAVIOURTREES_ITERATOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C838B0)
#define NODECANVAS_BEHAVIOURTREES_ITERATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x19C83FC0)
#define NODECANVAS_BEHAVIOURTREES_ITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19C83FE0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Iterator_TypeDefinitionIndex = 26116;
	...
	public:
		...
		::NodeCanvas::Framework::Internal::BBObjectParameter* current; // 0x90
		::System::Boolean resetIndex; // 0x98
