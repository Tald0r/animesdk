...
#define NODECANVAS_BEHAVIOURTREES_ACTIONNODE_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x19DB5F60)
#define NODECANVAS_BEHAVIOURTREES_ACTIONNODE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19DB5F80)
#define NODECANVAS_BEHAVIOURTREES_ACTIONNODE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x19DB5EE0)
#define NODECANVAS_BEHAVIOURTREES_ACTIONNODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19DB5FA0)
#define NODECANVAS_BEHAVIOURTREES_ACTIONNODE_ONGRAPHPAUSED_OFFSET UNITYSDK_OFFSET(0x19DB6000)
#define NODECANVAS_BEHAVIOURTREES_ACTIONNODE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19DB5FD0)
#define NODECANVAS_BEHAVIOURTREES_ACTIONNODE_SET_ACTION_OFFSET UNITYSDK_OFFSET(0x19DB5F70)
#define NODECANVAS_BEHAVIOURTREES_ACTIONNODE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x19DB5EF0)
#define NODECANVAS_BEHAVIOURTREES_ACTIONNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB6030)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int ActionNode_TypeDefinitionIndex = 25859;
