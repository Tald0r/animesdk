...
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1A6055B0)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1A605530)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A6055D0)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A6059D0)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1A6055C0)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1A605540)
#define NODECANVAS_BEHAVIOURTREES_CONDITIONALEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A605A20)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int ConditionalEvaluator_TypeDefinitionIndex = 26631;
	...
	public:
		...
		::System::Boolean accessed; // 0x84
		::System::Boolean isDynamic; // 0x85
