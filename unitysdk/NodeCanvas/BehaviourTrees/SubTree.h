...
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x19F58210)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x19F58150)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19F58220)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19F58420)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x19F581B0)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F584B0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int SubTree_TypeDefinitionIndex = 26311;
