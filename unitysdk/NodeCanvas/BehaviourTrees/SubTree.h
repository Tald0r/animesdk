...
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A569030)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A568F70)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A569040)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A569250)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A568FD0)
#define NODECANVAS_BEHAVIOURTREES_SUBTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5692E0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int SubTree_TypeDefinitionIndex = 26019;
