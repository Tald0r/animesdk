...
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A489B30)
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A489A70)
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A489B40)
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT_ONFLOWSCRIPTFINISHED_OFFSET UNITYSDK_OFFSET(0x1A489D20)
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A489D30)
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A489AD0)
#define NODECANVAS_BEHAVIOURTREES_BTNESTEDFLOWSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A489DC0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BTNestedFlowScript_TypeDefinitionIndex = 26278;
