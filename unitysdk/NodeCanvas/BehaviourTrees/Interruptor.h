...
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1A3A72A0)
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1A3A72C0)
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A3A7340)
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A3A7550)
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1A3A72B0)
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1A3A72D0)
#define NODECANVAS_BEHAVIOURTREES_INTERRUPTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A7590)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Interruptor_TypeDefinitionIndex = 26213;
