...
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x183F0170)
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL_GET_TASK_OFFSET UNITYSDK_OFFSET(0x183F00F0)
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x183F0190)
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL_ONRESET_OFFSET UNITYSDK_OFFSET(0x183F0560)
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x183F0180)
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL_SET_TASK_OFFSET UNITYSDK_OFFSET(0x183F0100)
#define NODECANVAS_BEHAVIOURTREES_WAITUNTIL__CTOR_OFFSET UNITYSDK_OFFSET(0x183F05B0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int WaitUntil_TypeDefinitionIndex = 25484;
