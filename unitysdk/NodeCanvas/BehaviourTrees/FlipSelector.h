...
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19A082C0)
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x19A084D0)
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR_SENDTOBACK_OFFSET UNITYSDK_OFFSET(0x19A08420)
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19A084E0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int FlipSelector_TypeDefinitionIndex = 25241;
