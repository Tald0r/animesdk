...
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19FF8290)
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x19FF84A0)
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR_SENDTOBACK_OFFSET UNITYSDK_OFFSET(0x19FF83F0)
#define NODECANVAS_BEHAVIOURTREES_FLIPSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF84B0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int FlipSelector_TypeDefinitionIndex = 27471;
