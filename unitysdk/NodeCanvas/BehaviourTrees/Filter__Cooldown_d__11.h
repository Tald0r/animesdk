...
#define NODECANVAS_BEHAVIOURTREES_FILTER__COOLDOWN_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A65BA00)
#define NODECANVAS_BEHAVIOURTREES_FILTER__COOLDOWN_D__11_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A65BAB0)
#define NODECANVAS_BEHAVIOURTREES_FILTER__COOLDOWN_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A65BB10)
#define NODECANVAS_BEHAVIOURTREES_FILTER__COOLDOWN_D__11_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A65BAC0)
#define NODECANVAS_BEHAVIOURTREES_FILTER__COOLDOWN_D__11_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A65B9F0)
#define NODECANVAS_BEHAVIOURTREES_FILTER__COOLDOWN_D__11__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65B9E0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Filter__Cooldown_d__11_TypeDefinitionIndex = 26087;
