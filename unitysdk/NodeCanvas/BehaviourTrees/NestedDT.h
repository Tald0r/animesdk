...
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A2258E0)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A225820)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_ONDLGFINISHED_OFFSET UNITYSDK_OFFSET(0x1A225B30)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A2258F0)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A225B40)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A225880)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A225BD0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int NestedDT_TypeDefinitionIndex = 27626;
