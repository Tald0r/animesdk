...
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x19C84120)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x19C84060)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_ONDLGFINISHED_OFFSET UNITYSDK_OFFSET(0x19C84370)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C84130)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_ONRESET_OFFSET UNITYSDK_OFFSET(0x19C84380)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x19C840C0)
#define NODECANVAS_BEHAVIOURTREES_NESTEDDT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C84410)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int NestedDT_TypeDefinitionIndex = 26881;
