...
#define NODECANVAS_BEHAVIOURTREES_FILTER_COOLDOWN_OFFSET UNITYSDK_OFFSET(0x19A08190)
#define NODECANVAS_BEHAVIOURTREES_FILTER_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19A07EF0)
#define NODECANVAS_BEHAVIOURTREES_FILTER_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19A07ED0)
#define NODECANVAS_BEHAVIOURTREES_FILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A081E0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Filter_TypeDefinitionIndex = 26741;
	...
	public:
		...
		::System::Int32 executedCount; // 0x88
		::System::Boolean inactiveWhenLimited; // 0x8C
		::NodeCanvas::BehaviourTrees::Filter_FilterMode filterMode; // 0x90
		::NodeCanvas::BehaviourTrees::Filter_Policy policy; // 0x94
		::System::Single currentTime; // 0x98
