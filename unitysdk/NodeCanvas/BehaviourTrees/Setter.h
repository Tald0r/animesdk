...
#define NODECANVAS_BEHAVIOURTREES_SETTER_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C2B9E0)
#define NODECANVAS_BEHAVIOURTREES_SETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2BBC0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Setter_TypeDefinitionIndex = 27241;
