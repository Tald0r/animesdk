...
#define NODECANVAS_BEHAVIOURTREES_SETTER_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1975DB80)
#define NODECANVAS_BEHAVIOURTREES_SETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1975DD60)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int Setter_TypeDefinitionIndex = 26615;
