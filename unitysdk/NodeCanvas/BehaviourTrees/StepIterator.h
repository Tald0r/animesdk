...
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A1CEE70)
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A1CEE60)
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A1CEF20)
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1CEF30)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int StepIterator_TypeDefinitionIndex = 26313;
