...
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19C101D0)
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19C101C0)
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x19C10280)
#define NODECANVAS_BEHAVIOURTREES_STEPITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19C10290)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int StepIterator_TypeDefinitionIndex = 26228;
