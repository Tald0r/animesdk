...
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR_GET_COMMENTSALIGNMENT_OFFSET UNITYSDK_OFFSET(0x183EFBD0)
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR_GET_DECORATEDCONNECTION_OFFSET UNITYSDK_OFFSET(0x183EFBE0)
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR_GET_DECORATEDNODE_OFFSET UNITYSDK_OFFSET(0x183EFC10)
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x183EFBC0)
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x183EFC50)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BTDecorator_TypeDefinitionIndex = 26310;
