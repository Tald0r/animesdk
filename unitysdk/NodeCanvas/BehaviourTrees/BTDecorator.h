...
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR_GET_COMMENTSALIGNMENT_OFFSET UNITYSDK_OFFSET(0x1918C880)
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR_GET_DECORATEDCONNECTION_OFFSET UNITYSDK_OFFSET(0x1918C890)
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR_GET_DECORATEDNODE_OFFSET UNITYSDK_OFFSET(0x1918C8C0)
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1918C870)
#define NODECANVAS_BEHAVIOURTREES_BTDECORATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1918C900)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BTDecorator_TypeDefinitionIndex = 26224;
