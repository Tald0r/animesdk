...
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR_ONCHILDCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A1AD670)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A1AD8C0)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A1AD940)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A1ADB20)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1ADB30)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR__ONEXECUTE_B__5_0_OFFSET UNITYSDK_OFFSET(0x1A1ADB40)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int PrioritySelector_TypeDefinitionIndex = 26835;
