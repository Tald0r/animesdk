...
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR_ONCHILDCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A11AA80)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A11ACD0)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A11AD50)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A11AF30)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11AF40)
#define NODECANVAS_BEHAVIOURTREES_PRIORITYSELECTOR__ONEXECUTE_B__5_0_OFFSET UNITYSDK_OFFSET(0x1A11AF50)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int PrioritySelector_TypeDefinitionIndex = 26729;
