...
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_ADD_ONROOTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x19C2B400)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_ALLOWBLACKBOARDOVERRIDES_OFFSET UNITYSDK_OFFSET(0x19C2B640)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_BASENODETYPE_OFFSET UNITYSDK_OFFSET(0x19C2B5E0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_CANACCEPTVARIABLEDROPS_OFFSET UNITYSDK_OFFSET(0x19C2B650)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_ISTREE_OFFSET UNITYSDK_OFFSET(0x19C2B630)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_REQUIRESAGENT_OFFSET UNITYSDK_OFFSET(0x19C2B610)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_REQUIRESPRIMENODE_OFFSET UNITYSDK_OFFSET(0x19C2B620)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_GET_ROOTSTATUS_OFFSET UNITYSDK_OFFSET(0x19C2B560)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_ONDERIVEDDATADESERIALIZATION_OFFSET UNITYSDK_OFFSET(0x19C2B360)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_ONDERIVEDDATASERIALIZATION_OFFSET UNITYSDK_OFFSET(0x19C2B2F0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19C2B660)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_ONGRAPHUPDATE_OFFSET UNITYSDK_OFFSET(0x19C2B6F0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_REMOVE_ONROOTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x19C2B4B0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_SET_ROOTSTATUS_OFFSET UNITYSDK_OFFSET(0x19C2B570)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE_TICK_OFFSET UNITYSDK_OFFSET(0x19C2B7A0)
#define NODECANVAS_BEHAVIOURTREES_BEHAVIOURTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2B8A0)

namespace NodeCanvas::BehaviourTrees
{
	inline static constexpr unsigned int BehaviourTree_TypeDefinitionIndex = 27281;
	...
	public:
		...
		{
			return (::System::Action_2<::NodeCanvas::BehaviourTrees::BehaviourTree*, ::NodeCanvas::Framework::Status>**)Il2CppClass::FromTypeDefinitionIndex(BehaviourTree_TypeDefinitionIndex)->GetStaticField(0x1F760);
		}
