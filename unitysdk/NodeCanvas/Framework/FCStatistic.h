...
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_GETFCCALLDICT_OFFSET UNITYSDK_OFFSET(0x19FEF290)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_GET_ISUSEDDIFFERDATA_OFFSET UNITYSDK_OFFSET(0x19FEF270)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_ISRECORD_OFFSET UNITYSDK_OFFSET(0x19FEF2A0)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_RECORDFCCALLINFO_OFFSET UNITYSDK_OFFSET(0x19FEF330)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_SET_ISUSEDDIFFERDATA_OFFSET UNITYSDK_OFFSET(0x19FEF280)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEF540)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int FCStatistic_TypeDefinitionIndex = 25794;
