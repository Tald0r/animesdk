...
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_GETFCCALLDICT_OFFSET UNITYSDK_OFFSET(0x1A608320)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_GET_ISUSEDDIFFERDATA_OFFSET UNITYSDK_OFFSET(0x1A608300)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_ISRECORD_OFFSET UNITYSDK_OFFSET(0x1A608330)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_RECORDFCCALLINFO_OFFSET UNITYSDK_OFFSET(0x1A6083C0)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC_SET_ISUSEDDIFFERDATA_OFFSET UNITYSDK_OFFSET(0x1A608310)
#define NODECANVAS_FRAMEWORK_FCSTATISTIC__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6085C0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int FCStatistic_TypeDefinitionIndex = 26547;
