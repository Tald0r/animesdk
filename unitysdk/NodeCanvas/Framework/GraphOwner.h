...
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ADD_ONMONOBEHAVIOURSTART_OFFSET UNITYSDK_OFFSET(0x19A08D50)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ADD_ONOWNERBEHAVIOURSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x19A08BF0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_AWAKE_OFFSET UNITYSDK_OFFSET(0x19A09C00)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_BINDEXPOSEDPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19A0A210)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GETFCSTATISTC_OFFSET UNITYSDK_OFFSET(0x19A08E10)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x19A09220)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_BOUNDGRAPHOBJECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x19A08EC0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_BOUNDGRAPHSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x19A08EA0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_BOUNDGRAPHSOURCE_OFFSET UNITYSDK_OFFSET(0x19A08E80)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_DISABLEACTION_OFFSET UNITYSDK_OFFSET(0x19A08F90)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x19A09150)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ENABLEACTION_OFFSET UNITYSDK_OFFSET(0x19A08F70)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ENABLECALLED_OFFSET UNITYSDK_OFFSET(0x19A08E40)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_EXPOSEDPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19A08890)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_FIRSTACTIVATION_OFFSET UNITYSDK_OFFSET(0x19A08F50)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_GRAPHISBOUND_OFFSET UNITYSDK_OFFSET(0x19A08F00)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x19A08E20)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x19A09090)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ISRUNNING_OFFSET UNITYSDK_OFFSET(0x19A08FD0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_LOCKBOUNDGRAPHPREFABOVERRIDES_OFFSET UNITYSDK_OFFSET(0x19A08EE0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_PREINITIALIZESUBGRAPHS_OFFSET UNITYSDK_OFFSET(0x19A08F30)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_STARTCALLED_OFFSET UNITYSDK_OFFSET(0x19A08E60)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x19A08FB0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19A09C10)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_INVOKESTARTEVENT_OFFSET UNITYSDK_OFFSET(0x19A0A650)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19A0A6C0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19A0A680)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19A0A390)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_PAUSEBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x19A096B0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_REMOVE_ONMONOBEHAVIOURSTART_OFFSET UNITYSDK_OFFSET(0x19A08DB0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_REMOVE_ONOWNERBEHAVIOURSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x19A08CA0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_RESTARTBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x19A09A20)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SENDEVENT_1_OFFSET UNITYSDK_OFFSET(0x19A09B20)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x19A09A50)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_BOUNDGRAPHOBJECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x19A08ED0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_BOUNDGRAPHSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x19A08EB0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_BOUNDGRAPHSOURCE_OFFSET UNITYSDK_OFFSET(0x19A08E90)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_DISABLEACTION_OFFSET UNITYSDK_OFFSET(0x19A08FA0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_ENABLEACTION_OFFSET UNITYSDK_OFFSET(0x19A08F80)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_ENABLECALLED_OFFSET UNITYSDK_OFFSET(0x19A08E50)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_EXPOSEDPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19A088A0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_FIRSTACTIVATION_OFFSET UNITYSDK_OFFSET(0x19A08F60)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x19A08E30)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_LOCKBOUNDGRAPHPREFABOVERRIDES_OFFSET UNITYSDK_OFFSET(0x19A08F20)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_PREINITIALIZESUBGRAPHS_OFFSET UNITYSDK_OFFSET(0x19A08F40)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_STARTCALLED_OFFSET UNITYSDK_OFFSET(0x19A08E70)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x19A08FC0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_STARTBEHAVIOUR_1_OFFSET UNITYSDK_OFFSET(0x19A096A0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_STARTBEHAVIOUR_2_OFFSET UNITYSDK_OFFSET(0x19A09420)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_STARTBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x19A09410)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_START_OFFSET UNITYSDK_OFFSET(0x19A0A550)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_STOPBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x19A097D0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A08A80)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A088B0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_UPDATEBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x19A09900)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0AC30)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER__INITIALIZE_B__97_0_OFFSET UNITYSDK_OFFSET(0x19A0ADC0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int GraphOwner_TypeDefinitionIndex = 25565;
	...
	public:
		...
		{
			return (::System::Action_1<::NodeCanvas::Framework::GraphOwner*>**)Il2CppClass::FromTypeDefinitionIndex(GraphOwner_TypeDefinitionIndex)->GetStaticField(0x1F660);
		}
