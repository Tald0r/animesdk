...
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ADD_ONMONOBEHAVIOURSTART_OFFSET UNITYSDK_OFFSET(0x19FF8D20)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ADD_ONOWNERBEHAVIOURSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x19FF8BC0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_AWAKE_OFFSET UNITYSDK_OFFSET(0x19FF9BD0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_BINDEXPOSEDPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19FFA1F0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GETFCSTATISTC_OFFSET UNITYSDK_OFFSET(0x19FF8DE0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x19FF91F0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_BOUNDGRAPHOBJECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x19FF8E90)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_BOUNDGRAPHSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x19FF8E70)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_BOUNDGRAPHSOURCE_OFFSET UNITYSDK_OFFSET(0x19FF8E50)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_DISABLEACTION_OFFSET UNITYSDK_OFFSET(0x19FF8F60)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x19FF9120)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ENABLEACTION_OFFSET UNITYSDK_OFFSET(0x19FF8F40)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ENABLECALLED_OFFSET UNITYSDK_OFFSET(0x19FF8E10)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_EXPOSEDPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19FF8860)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_FIRSTACTIVATION_OFFSET UNITYSDK_OFFSET(0x19FF8F20)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_GRAPHISBOUND_OFFSET UNITYSDK_OFFSET(0x19FF8ED0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x19FF8DF0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x19FF9060)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_ISRUNNING_OFFSET UNITYSDK_OFFSET(0x19FF8FA0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_LOCKBOUNDGRAPHPREFABOVERRIDES_OFFSET UNITYSDK_OFFSET(0x19FF8EB0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_PREINITIALIZESUBGRAPHS_OFFSET UNITYSDK_OFFSET(0x19FF8F00)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_STARTCALLED_OFFSET UNITYSDK_OFFSET(0x19FF8E30)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_GET_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x19FF8F80)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19FF9BE0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_INVOKESTARTEVENT_OFFSET UNITYSDK_OFFSET(0x19FFA630)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19FFA6A0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19FFA660)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19FFA370)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_PAUSEBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x19FF9680)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_REMOVE_ONMONOBEHAVIOURSTART_OFFSET UNITYSDK_OFFSET(0x19FF8D80)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_REMOVE_ONOWNERBEHAVIOURSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x19FF8C70)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_RESTARTBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x19FF99F0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SENDEVENT_1_OFFSET UNITYSDK_OFFSET(0x19FF9AF0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x19FF9A20)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_BOUNDGRAPHOBJECTREFERENCES_OFFSET UNITYSDK_OFFSET(0x19FF8EA0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_BOUNDGRAPHSERIALIZATION_OFFSET UNITYSDK_OFFSET(0x19FF8E80)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_BOUNDGRAPHSOURCE_OFFSET UNITYSDK_OFFSET(0x19FF8E60)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_DISABLEACTION_OFFSET UNITYSDK_OFFSET(0x19FF8F70)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_ENABLEACTION_OFFSET UNITYSDK_OFFSET(0x19FF8F50)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_ENABLECALLED_OFFSET UNITYSDK_OFFSET(0x19FF8E20)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_EXPOSEDPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19FF8870)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_FIRSTACTIVATION_OFFSET UNITYSDK_OFFSET(0x19FF8F30)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_INITIALIZED_OFFSET UNITYSDK_OFFSET(0x19FF8E00)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_LOCKBOUNDGRAPHPREFABOVERRIDES_OFFSET UNITYSDK_OFFSET(0x19FF8EF0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_PREINITIALIZESUBGRAPHS_OFFSET UNITYSDK_OFFSET(0x19FF8F10)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_STARTCALLED_OFFSET UNITYSDK_OFFSET(0x19FF8E40)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_SET_UPDATEMODE_OFFSET UNITYSDK_OFFSET(0x19FF8F90)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_STARTBEHAVIOUR_1_OFFSET UNITYSDK_OFFSET(0x19FF9670)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_STARTBEHAVIOUR_2_OFFSET UNITYSDK_OFFSET(0x19FF93F0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_STARTBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x19FF93E0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_START_OFFSET UNITYSDK_OFFSET(0x19FFA530)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_STOPBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x19FF97A0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FF8A50)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FF8880)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER_UPDATEBEHAVIOUR_OFFSET UNITYSDK_OFFSET(0x19FF98D0)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFAC10)
#define NODECANVAS_FRAMEWORK_GRAPHOWNER__INITIALIZE_B__97_0_OFFSET UNITYSDK_OFFSET(0x19FFADA0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int GraphOwner_TypeDefinitionIndex = 27106;
	...
	public:
		...
		{
			return (::System::Action_1<::NodeCanvas::Framework::GraphOwner*>**)Il2CppClass::FromTypeDefinitionIndex(GraphOwner_TypeDefinitionIndex)->GetStaticField(0x1FA60);
		}
