...
#define NODECANVAS_FRAMEWORK_ACTIONTASK_ENDACTION_1_OFFSET UNITYSDK_OFFSET(0x191650A0)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_ENDACTION_2_OFFSET UNITYSDK_OFFSET(0x191650D0)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_ENDACTION_OFFSET UNITYSDK_OFFSET(0x19165070)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_EXECUTEACTION_OFFSET UNITYSDK_OFFSET(0x19164EE0)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_EXECUTEINDEPENDENT_OFFSET UNITYSDK_OFFSET(0x19164D80)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19164EF0)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_GET_ELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x19164C80)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_GET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x19164D60)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_GET_ISRUNNING_OFFSET UNITYSDK_OFFSET(0x19164D50)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_INDEPENDENTACTIONUPDATER_OFFSET UNITYSDK_OFFSET(0x19164E80)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19165130)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x19165170)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_ONRESUME_OFFSET UNITYSDK_OFFSET(0x19165180)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_ONSTOP_1_OFFSET UNITYSDK_OFFSET(0x19165160)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_ONSTOP_OFFSET UNITYSDK_OFFSET(0x19165150)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19165140)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_PAUSE_OFFSET UNITYSDK_OFFSET(0x19165110)
#define NODECANVAS_FRAMEWORK_ACTIONTASK_SET_ISPAUSED_OFFSET UNITYSDK_OFFSET(0x19164D70)
#define NODECANVAS_FRAMEWORK_ACTIONTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x19165190)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ActionTask_TypeDefinitionIndex = 25644;
	...
	public:
		...
		::System::Boolean latch; // 0x58
		::System::Boolean _isPaused_k__BackingField; // 0x59
