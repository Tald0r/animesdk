...
#define NODECANVAS_FRAMEWORK_CONNECTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1A3F69C0)
#define NODECANVAS_FRAMEWORK_CONNECTION_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1A3F6FE0)
#define NODECANVAS_FRAMEWORK_CONNECTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A3F6710)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_GRAPH_OFFSET UNITYSDK_OFFSET(0x1A3F6990)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A3F6550)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_SOURCENODE_OFFSET UNITYSDK_OFFSET(0x1A3F6920)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x1A3F6970)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_TARGETNODE_OFFSET UNITYSDK_OFFSET(0x1A3F6940)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_UID_OFFSET UNITYSDK_OFFSET(0x1A3F68E0)
#define NODECANVAS_FRAMEWORK_CONNECTION_NODECANVAS_FRAMEWORK_IGRAPHELEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A3F6960)
#define NODECANVAS_FRAMEWORK_CONNECTION_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1A3F75D0)
#define NODECANVAS_FRAMEWORK_CONNECTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A3F75F0)
#define NODECANVAS_FRAMEWORK_CONNECTION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A3F75E0)
#define NODECANVAS_FRAMEWORK_CONNECTION_RESET_OFFSET UNITYSDK_OFFSET(0x1A3F66D0)
#define NODECANVAS_FRAMEWORK_CONNECTION_SETSOURCENODE_OFFSET UNITYSDK_OFFSET(0x1A3F6B50)
#define NODECANVAS_FRAMEWORK_CONNECTION_SETTARGETNODE_OFFSET UNITYSDK_OFFSET(0x1A3F6DA0)
#define NODECANVAS_FRAMEWORK_CONNECTION_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A3F6500)
#define NODECANVAS_FRAMEWORK_CONNECTION_SET_SOURCENODE_OFFSET UNITYSDK_OFFSET(0x1A3F6930)
#define NODECANVAS_FRAMEWORK_CONNECTION_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x1A3F6980)
#define NODECANVAS_FRAMEWORK_CONNECTION_SET_TARGETNODE_OFFSET UNITYSDK_OFFSET(0x1A3F6950)
#define NODECANVAS_FRAMEWORK_CONNECTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3F7600)
#define NODECANVAS_FRAMEWORK_CONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F69B0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Connection_TypeDefinitionIndex = 27525;
