...
#define NODECANVAS_FRAMEWORK_CONNECTION_CREATE_OFFSET UNITYSDK_OFFSET(0x19E08130)
#define NODECANVAS_FRAMEWORK_CONNECTION_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x19E08760)
#define NODECANVAS_FRAMEWORK_CONNECTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E07E80)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_GRAPH_OFFSET UNITYSDK_OFFSET(0x19E08100)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19E07CC0)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_SOURCENODE_OFFSET UNITYSDK_OFFSET(0x19E08090)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x19E080E0)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_TARGETNODE_OFFSET UNITYSDK_OFFSET(0x19E080B0)
#define NODECANVAS_FRAMEWORK_CONNECTION_GET_UID_OFFSET UNITYSDK_OFFSET(0x19E08050)
#define NODECANVAS_FRAMEWORK_CONNECTION_NODECANVAS_FRAMEWORK_IGRAPHELEMENT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19E080D0)
#define NODECANVAS_FRAMEWORK_CONNECTION_ONCREATE_OFFSET UNITYSDK_OFFSET(0x19E08D50)
#define NODECANVAS_FRAMEWORK_CONNECTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19E08D70)
#define NODECANVAS_FRAMEWORK_CONNECTION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19E08D60)
#define NODECANVAS_FRAMEWORK_CONNECTION_RESET_OFFSET UNITYSDK_OFFSET(0x19E07E40)
#define NODECANVAS_FRAMEWORK_CONNECTION_SETSOURCENODE_OFFSET UNITYSDK_OFFSET(0x19E082C0)
#define NODECANVAS_FRAMEWORK_CONNECTION_SETTARGETNODE_OFFSET UNITYSDK_OFFSET(0x19E08510)
#define NODECANVAS_FRAMEWORK_CONNECTION_SET_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x19E07C70)
#define NODECANVAS_FRAMEWORK_CONNECTION_SET_SOURCENODE_OFFSET UNITYSDK_OFFSET(0x19E080A0)
#define NODECANVAS_FRAMEWORK_CONNECTION_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x19E080F0)
#define NODECANVAS_FRAMEWORK_CONNECTION_SET_TARGETNODE_OFFSET UNITYSDK_OFFSET(0x19E080C0)
#define NODECANVAS_FRAMEWORK_CONNECTION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19E08D80)
#define NODECANVAS_FRAMEWORK_CONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E08120)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Connection_TypeDefinitionIndex = 26538;

	class Connection : public ::System::Object
	{
	public:
		::NodeCanvas::Framework::Node* _sourceNode; // 0x10
		::NodeCanvas::Framework::Node* _targetNode; // 0x18
		::System::String* _UID; // 0x20
		::NodeCanvas::Framework::Status _status; // 0x28
		::System::Boolean _isDisabled; // 0x2C
