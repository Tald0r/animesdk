...
#define NODECANVAS_FRAMEWORK_TASK_CREATE_OFFSET UNITYSDK_OFFSET(0x1A3F5880)
#define NODECANVAS_FRAMEWORK_TASK_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1A3F7990)
#define NODECANVAS_FRAMEWORK_TASK_ERROR_OFFSET UNITYSDK_OFFSET(0x1A3F8ED0)
#define NODECANVAS_FRAMEWORK_TASK_GETHARDERROR_OFFSET UNITYSDK_OFFSET(0x1A3F7B30)
#define NODECANVAS_FRAMEWORK_TASK_GETWARNINGORERROR_OFFSET UNITYSDK_OFFSET(0x1A3F9500)
#define NODECANVAS_FRAMEWORK_TASK_GET_AGENTINFO_OFFSET UNITYSDK_OFFSET(0x1A3F8420)
#define NODECANVAS_FRAMEWORK_TASK_GET_AGENTISOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A3F83F0)
#define NODECANVAS_FRAMEWORK_TASK_GET_AGENTPARAMETERNAME_OFFSET UNITYSDK_OFFSET(0x1A3F8470)
#define NODECANVAS_FRAMEWORK_TASK_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A3F8410)
#define NODECANVAS_FRAMEWORK_TASK_GET_AGENT_OFFSET UNITYSDK_OFFSET(0x1A3F86F0)
#define NODECANVAS_FRAMEWORK_TASK_GET_BLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1A3F8650)
#define NODECANVAS_FRAMEWORK_TASK_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A3F8220)
#define NODECANVAS_FRAMEWORK_TASK_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A3F8400)
#define NODECANVAS_FRAMEWORK_TASK_GET_ISUSERENABLED_OFFSET UNITYSDK_OFFSET(0x1A3F8080)
#define NODECANVAS_FRAMEWORK_TASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A3F8130)
#define NODECANVAS_FRAMEWORK_TASK_GET_OBSOLETE_OFFSET UNITYSDK_OFFSET(0x1A3F80A0)
#define NODECANVAS_FRAMEWORK_TASK_GET_OWNERSYSTEMAGENT_OFFSET UNITYSDK_OFFSET(0x1A3F7EA0)
#define NODECANVAS_FRAMEWORK_TASK_GET_OWNERSYSTEMBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1A3F7F40)
#define NODECANVAS_FRAMEWORK_TASK_GET_OWNERSYSTEMELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x1A3F7FE0)
#define NODECANVAS_FRAMEWORK_TASK_GET_OWNERSYSTEM_OFFSET UNITYSDK_OFFSET(0x1A3F7E80)
#define NODECANVAS_FRAMEWORK_TASK_GET_ROUTER_OFFSET UNITYSDK_OFFSET(0x1A3F8920)
#define NODECANVAS_FRAMEWORK_TASK_GET_SUMMARYINFO_OFFSET UNITYSDK_OFFSET(0x1A3F82B0)
#define NODECANVAS_FRAMEWORK_TASK_INITIALIZEFIELDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A3F8F30)
#define NODECANVAS_FRAMEWORK_TASK_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3F8CC0)
#define NODECANVAS_FRAMEWORK_TASK_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1A3F9C60)
#define NODECANVAS_FRAMEWORK_TASK_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A3F9C90)
#define NODECANVAS_FRAMEWORK_TASK_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x1A3F9C80)
#define NODECANVAS_FRAMEWORK_TASK_ONINIT_OFFSET UNITYSDK_OFFSET(0x1A3F9C50)
#define NODECANVAS_FRAMEWORK_TASK_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A3F9C70)
#define NODECANVAS_FRAMEWORK_TASK_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x1A3F9440)
#define NODECANVAS_FRAMEWORK_TASK_SETOWNERSYSTEM_OFFSET UNITYSDK_OFFSET(0x1A3F5D40)
#define NODECANVAS_FRAMEWORK_TASK_SET_AGENTISOVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A3F8490)
#define NODECANVAS_FRAMEWORK_TASK_SET_ISUSERENABLED_OFFSET UNITYSDK_OFFSET(0x1A3F8090)
#define NODECANVAS_FRAMEWORK_TASK_SET_OFFSET UNITYSDK_OFFSET(0x1A3F89C0)
#define NODECANVAS_FRAMEWORK_TASK_SET_OWNERSYSTEM_OFFSET UNITYSDK_OFFSET(0x1A3F7E90)
#define NODECANVAS_FRAMEWORK_TASK_STARTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A3F93E0)
#define NODECANVAS_FRAMEWORK_TASK_STOPCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A3F9410)
#define NODECANVAS_FRAMEWORK_TASK_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3F9CA0)
#define NODECANVAS_FRAMEWORK_TASK_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3F7970)
#define NODECANVAS_FRAMEWORK_TASK_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3F78C0)
#define NODECANVAS_FRAMEWORK_TASK_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A3F7540)
#define NODECANVAS_FRAMEWORK_TASK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F7980)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Task_TypeDefinitionIndex = 26548;

	class Task : public ::System::Object
	{
	public:
		::ParadoxNotion::Services::EventRouter* _eventRouter; // 0x10
		::NodeCanvas::Framework::ITaskSystem* _ownerSystem; // 0x18
		::System::String* _taskDescription; // 0x20
		::System::String* _obsoleteInfo; // 0x28
		...
		::System::Boolean _isInitSuccess; // 0x4A
