...
#define NODECANVAS_FRAMEWORK_TASK_CREATE_OFFSET UNITYSDK_OFFSET(0x19E06FF0)
#define NODECANVAS_FRAMEWORK_TASK_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x19E09110)
#define NODECANVAS_FRAMEWORK_TASK_ERROR_OFFSET UNITYSDK_OFFSET(0x19E0A650)
#define NODECANVAS_FRAMEWORK_TASK_GETHARDERROR_OFFSET UNITYSDK_OFFSET(0x19E092B0)
#define NODECANVAS_FRAMEWORK_TASK_GETWARNINGORERROR_OFFSET UNITYSDK_OFFSET(0x19E0AC80)
#define NODECANVAS_FRAMEWORK_TASK_GET_AGENTINFO_OFFSET UNITYSDK_OFFSET(0x19E09BA0)
#define NODECANVAS_FRAMEWORK_TASK_GET_AGENTISOVERRIDE_OFFSET UNITYSDK_OFFSET(0x19E09B70)
#define NODECANVAS_FRAMEWORK_TASK_GET_AGENTPARAMETERNAME_OFFSET UNITYSDK_OFFSET(0x19E09BF0)
#define NODECANVAS_FRAMEWORK_TASK_GET_AGENTTYPE_OFFSET UNITYSDK_OFFSET(0x19E09B90)
#define NODECANVAS_FRAMEWORK_TASK_GET_AGENT_OFFSET UNITYSDK_OFFSET(0x19E09E70)
#define NODECANVAS_FRAMEWORK_TASK_GET_BLACKBOARD_OFFSET UNITYSDK_OFFSET(0x19E09DD0)
#define NODECANVAS_FRAMEWORK_TASK_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19E099A0)
#define NODECANVAS_FRAMEWORK_TASK_GET_INFO_OFFSET UNITYSDK_OFFSET(0x19E09B80)
#define NODECANVAS_FRAMEWORK_TASK_GET_ISUSERENABLED_OFFSET UNITYSDK_OFFSET(0x19E09800)
#define NODECANVAS_FRAMEWORK_TASK_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19E098B0)
#define NODECANVAS_FRAMEWORK_TASK_GET_OBSOLETE_OFFSET UNITYSDK_OFFSET(0x19E09820)
#define NODECANVAS_FRAMEWORK_TASK_GET_OWNERSYSTEMAGENT_OFFSET UNITYSDK_OFFSET(0x19E09620)
#define NODECANVAS_FRAMEWORK_TASK_GET_OWNERSYSTEMBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x19E096C0)
#define NODECANVAS_FRAMEWORK_TASK_GET_OWNERSYSTEMELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x19E09760)
#define NODECANVAS_FRAMEWORK_TASK_GET_OWNERSYSTEM_OFFSET UNITYSDK_OFFSET(0x19E09600)
#define NODECANVAS_FRAMEWORK_TASK_GET_ROUTER_OFFSET UNITYSDK_OFFSET(0x19E0A0A0)
#define NODECANVAS_FRAMEWORK_TASK_GET_SUMMARYINFO_OFFSET UNITYSDK_OFFSET(0x19E09A30)
#define NODECANVAS_FRAMEWORK_TASK_INITIALIZEFIELDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19E0A6B0)
#define NODECANVAS_FRAMEWORK_TASK_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19E0A440)
#define NODECANVAS_FRAMEWORK_TASK_ONCREATE_OFFSET UNITYSDK_OFFSET(0x19E0B3E0)
#define NODECANVAS_FRAMEWORK_TASK_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x19E0B410)
#define NODECANVAS_FRAMEWORK_TASK_ONDRAWGIZMOS_OFFSET UNITYSDK_OFFSET(0x19E0B400)
#define NODECANVAS_FRAMEWORK_TASK_ONINIT_OFFSET UNITYSDK_OFFSET(0x19E0B3D0)
#define NODECANVAS_FRAMEWORK_TASK_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19E0B3F0)
#define NODECANVAS_FRAMEWORK_TASK_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x19E0ABC0)
#define NODECANVAS_FRAMEWORK_TASK_SETOWNERSYSTEM_OFFSET UNITYSDK_OFFSET(0x19E074B0)
#define NODECANVAS_FRAMEWORK_TASK_SET_AGENTISOVERRIDE_OFFSET UNITYSDK_OFFSET(0x19E09C10)
#define NODECANVAS_FRAMEWORK_TASK_SET_ISUSERENABLED_OFFSET UNITYSDK_OFFSET(0x19E09810)
#define NODECANVAS_FRAMEWORK_TASK_SET_OFFSET UNITYSDK_OFFSET(0x19E0A140)
#define NODECANVAS_FRAMEWORK_TASK_SET_OWNERSYSTEM_OFFSET UNITYSDK_OFFSET(0x19E09610)
#define NODECANVAS_FRAMEWORK_TASK_STARTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x19E0AB60)
#define NODECANVAS_FRAMEWORK_TASK_STOPCOROUTINE_OFFSET UNITYSDK_OFFSET(0x19E0AB90)
#define NODECANVAS_FRAMEWORK_TASK_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19E0B420)
#define NODECANVAS_FRAMEWORK_TASK_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19E090F0)
#define NODECANVAS_FRAMEWORK_TASK_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19E09040)
#define NODECANVAS_FRAMEWORK_TASK_VALIDATE_OFFSET UNITYSDK_OFFSET(0x19E08CC0)
#define NODECANVAS_FRAMEWORK_TASK__CTOR_OFFSET UNITYSDK_OFFSET(0x19E09100)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Task_TypeDefinitionIndex = 25270;

	class Task : public ::System::Object
	{
	public:
		::System::String* _taskName; // 0x10
		::System::String* _taskDescription; // 0x18
		::System::String* _obsoleteInfo; // 0x20
		::NodeCanvas::Framework::Internal::TaskAgentParameter* _agentParameter; // 0x28
		::ParadoxNotion::Services::EventRouter* _eventRouter; // 0x30
		::UnityEngine::Component* _currentAgent; // 0x38
		::NodeCanvas::Framework::ITaskSystem* _ownerSystem; // 0x40
