...
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_ADDVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x1A1AF8C0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_ADDVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A1B1540)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_GETALLPARENTS_OFFSET UNITYSDK_OFFSET(0x1A1B1420)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_GETROOT_OFFSET UNITYSDK_OFFSET(0x1A1B12D0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_GETVARIABLEBYID_OFFSET UNITYSDK_OFFSET(0x1A1AED20)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_GETVARIABLES_OFFSET UNITYSDK_OFFSET(0x1A1B1E40)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_GETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A1AF100)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_INITIALIZEPROPERTIESBINDING_OFFSET UNITYSDK_OFFSET(0x1A1B1BB0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_ISPARTOF_OFFSET UNITYSDK_OFFSET(0x1A1B1480)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_OVERWRITEFROM_OFFSET UNITYSDK_OFFSET(0x1A1B1EA0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_OVERWRITEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A1B25D0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_REMOVEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A1B1630)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_SETVARIABLEVALUE_OFFSET UNITYSDK_OFFSET(0x1A1B18E0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int IBlackboardExtensions_TypeDefinitionIndex = 25763;
