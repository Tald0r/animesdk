...
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_ADDVARIABLE_1_OFFSET UNITYSDK_OFFSET(0x1A11CCD0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_ADDVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A11E950)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_GETALLPARENTS_OFFSET UNITYSDK_OFFSET(0x1A11E830)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_GETROOT_OFFSET UNITYSDK_OFFSET(0x1A11E6E0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_GETVARIABLEBYID_OFFSET UNITYSDK_OFFSET(0x1A11C130)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_GETVARIABLES_OFFSET UNITYSDK_OFFSET(0x1A11F250)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_GETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A11C510)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_INITIALIZEPROPERTIESBINDING_OFFSET UNITYSDK_OFFSET(0x1A11EFC0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_ISPARTOF_OFFSET UNITYSDK_OFFSET(0x1A11E890)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_OVERWRITEFROM_OFFSET UNITYSDK_OFFSET(0x1A11F2B0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_OVERWRITEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A11F9E0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_REMOVEVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A11EA40)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS_SETVARIABLEVALUE_OFFSET UNITYSDK_OFFSET(0x1A11ECF0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int IBlackboardExtensions_TypeDefinitionIndex = 26657;
