...
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD_CREATE_OFFSET UNITYSDK_OFFSET(0x1A0899D0)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD_FIND_OFFSET UNITYSDK_OFFSET(0x1A089A50)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD_GETALL_OFFSET UNITYSDK_OFFSET(0x1A0899A0)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A089970)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A089990)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD_GET_UID_OFFSET UNITYSDK_OFFSET(0x1A089980)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD_ISPREFABASSET_OFFSET UNITYSDK_OFFSET(0x1A089DA0)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A089DB0)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A089AE0)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A089E40)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A08A190)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A08A210)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A08A1A0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int GlobalBlackboard_TypeDefinitionIndex = 25399;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::NodeCanvas::Framework::GlobalBlackboard*>**)Il2CppClass::FromTypeDefinitionIndex(GlobalBlackboard_TypeDefinitionIndex)->GetStaticField(0x1ED70);
		}
