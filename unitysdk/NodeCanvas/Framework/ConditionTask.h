...
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_CHECKCONDITION_OFFSET UNITYSDK_OFFSET(0x19F58CA0)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_CHECKONCE_OFFSET UNITYSDK_OFFSET(0x19F58DA0)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_CHECK_OFFSET UNITYSDK_OFFSET(0x19F58D20)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_DISABLE_OFFSET UNITYSDK_OFFSET(0x19F58C70)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_ENABLE_OFFSET UNITYSDK_OFFSET(0x19F58C20)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_FLIP_OFFSET UNITYSDK_OFFSET(0x19F58F10)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_GET_INVERT_OFFSET UNITYSDK_OFFSET(0x19F58C00)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_ONCHECK_OFFSET UNITYSDK_OFFSET(0x19F58F80)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19F58F70)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19F58F60)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_SET_INVERT_OFFSET UNITYSDK_OFFSET(0x19F58C10)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK_YIELDRETURN_OFFSET UNITYSDK_OFFSET(0x19F58EA0)
#define NODECANVAS_FRAMEWORK_CONDITIONTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x19F58F90)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ConditionTask_TypeDefinitionIndex = 25603;
