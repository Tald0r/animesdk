...
#define NODECANVAS_FRAMEWORK_FCCALLINFO_ADDCALLCOUNT_OFFSET UNITYSDK_OFFSET(0x1A830550)
#define NODECANVAS_FRAMEWORK_FCCALLINFO_GET_CALLCOUNT_OFFSET UNITYSDK_OFFSET(0x1A830530)
#define NODECANVAS_FRAMEWORK_FCCALLINFO_SET_CALLCOUNT_OFFSET UNITYSDK_OFFSET(0x1A830540)
#define NODECANVAS_FRAMEWORK_FCCALLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A830560)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int FCCallInfo_TypeDefinitionIndex = 26413;
