...
#define NODECANVAS_FRAMEWORK_FCCALLINFO_ADDCALLCOUNT_OFFSET UNITYSDK_OFFSET(0x1A268BA0)
#define NODECANVAS_FRAMEWORK_FCCALLINFO_GET_CALLCOUNT_OFFSET UNITYSDK_OFFSET(0x1A268B80)
#define NODECANVAS_FRAMEWORK_FCCALLINFO_SET_CALLCOUNT_OFFSET UNITYSDK_OFFSET(0x1A268B90)
#define NODECANVAS_FRAMEWORK_FCCALLINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A268BB0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int FCCallInfo_TypeDefinitionIndex = 26082;
