...
#define NODECANVAS_FRAMEWORK_VARIABLESEPERATOR_GET_ISEDITINGNAME_OFFSET UNITYSDK_OFFSET(0x1A3F9D90)
#define NODECANVAS_FRAMEWORK_VARIABLESEPERATOR_SET_ISEDITINGNAME_OFFSET UNITYSDK_OFFSET(0x1A3F9DA0)
#define NODECANVAS_FRAMEWORK_VARIABLESEPERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F9D80)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int VariableSeperator_TypeDefinitionIndex = 27672;
