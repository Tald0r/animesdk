...
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_ADD_ONVARIABLEADDED_OFFSET UNITYSDK_OFFSET(0x1A225C90)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_ADD_ONVARIABLEREMOVED_OFFSET UNITYSDK_OFFSET(0x1A225D90)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A226270)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A226290)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_GET_UID_OFFSET UNITYSDK_OFFSET(0x1A226280)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_INDEPENDANTVARIABLESFIELDNAME_OFFSET UNITYSDK_OFFSET(0x1A2261A0)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1A226180)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_PROPERTIESBINDTARGET_OFFSET UNITYSDK_OFFSET(0x1A226190)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_UNITYCONTEXTOBJECT_OFFSET UNITYSDK_OFFSET(0x1A226170)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_GET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1A226130)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_SET_VARIABLES_OFFSET UNITYSDK_OFFSET(0x1A226150)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_TRYINVOKEONVARIABLEADDED_OFFSET UNITYSDK_OFFSET(0x1A2261B0)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_NODECANVAS_FRAMEWORK_IBLACKBOARD_TRYINVOKEONVARIABLEREMOVED_OFFSET UNITYSDK_OFFSET(0x1A226210)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_REMOVE_ONVARIABLEADDED_OFFSET UNITYSDK_OFFSET(0x1A225D10)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_REMOVE_ONVARIABLEREMOVED_OFFSET UNITYSDK_OFFSET(0x1A225E10)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_SELFDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A2260A0)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_SELFSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A225F50)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_SHOWJSON_OFFSET UNITYSDK_OFFSET(0x1A2262A0)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A2262E0)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A226010)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A225E90)
#define NODECANVAS_FRAMEWORK_ASSETBLACKBOARD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2262F0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int AssetBlackboard_TypeDefinitionIndex = 25991;
