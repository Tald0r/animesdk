...
#define NODECANVAS_FRAMEWORK_FCCALLKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x19C10D80)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x19C10CF0)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19C10E60)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_GET_NODEID_OFFSET UNITYSDK_OFFSET(0x19C10C90)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0x19C10CB0)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_GET_PORTNAME_OFFSET UNITYSDK_OFFSET(0x19C10CD0)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_SET_NODEID_OFFSET UNITYSDK_OFFSET(0x19C10CA0)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_SET_NODENAME_OFFSET UNITYSDK_OFFSET(0x19C10CC0)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_SET_PORTNAME_OFFSET UNITYSDK_OFFSET(0x19C10CE0)
#define NODECANVAS_FRAMEWORK_FCCALLKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C10F80)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int FCCallKey_TypeDefinitionIndex = 26837;
