...
#define NODECANVAS_FRAMEWORK_FCCALLKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A1CFA20)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A1CF990)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A1CFB00)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_GET_NODEID_OFFSET UNITYSDK_OFFSET(0x1A1CF930)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_GET_NODENAME_OFFSET UNITYSDK_OFFSET(0x1A1CF950)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_GET_PORTNAME_OFFSET UNITYSDK_OFFSET(0x1A1CF970)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_SET_NODEID_OFFSET UNITYSDK_OFFSET(0x1A1CF940)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_SET_NODENAME_OFFSET UNITYSDK_OFFSET(0x1A1CF960)
#define NODECANVAS_FRAMEWORK_FCCALLKEY_SET_PORTNAME_OFFSET UNITYSDK_OFFSET(0x1A1CF980)
#define NODECANVAS_FRAMEWORK_FCCALLKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1CFC20)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int FCCallKey_TypeDefinitionIndex = 27369;
