...
#define NODECANVAS_FRAMEWORK_BBPARAMETER_ADD_ONVARIABLEREFERENCECHANGED_OFFSET UNITYSDK_OFFSET(0x1A1AE040)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A1AE150)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_BB_OFFSET UNITYSDK_OFFSET(0x1A1AE830)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1A1AEA90)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_ISNONEORNULL_OFFSET UNITYSDK_OFFSET(0x1A1AEA20)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0x1A1AE990)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x1A1AE9D0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_ISPRESUMEDDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1A1AE970)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A1AE510)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_REFTYPE_OFFSET UNITYSDK_OFFSET(0x1A1AEAB0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_TARGETVARIABLEID_OFFSET UNITYSDK_OFFSET(0x1A1AE460)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_USEBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1A1AE020)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A1AEA00)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_VARREF_OFFSET UNITYSDK_OFFSET(0x1A1AE480)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_PROMOTETOVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A1AF450)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_REMOVE_ONVARIABLEREFERENCECHANGED_OFFSET UNITYSDK_OFFSET(0x1A1AE0C0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_RESOLVEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A1AE670)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SETBBFIELDS_OFFSET UNITYSDK_OFFSET(0x1A1AE380)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SETTARGETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A1AEB00)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_BB_OFFSET UNITYSDK_OFFSET(0x1A1AD820)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A1AE520)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_TARGETVARIABLEID_OFFSET UNITYSDK_OFFSET(0x1A1AE470)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_TSETTARGETVARIABLEID_OFFSET UNITYSDK_OFFSET(0x1A1ADFE0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_USEBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1A1AE840)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A1AEAE0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_VARREF_OFFSET UNITYSDK_OFFSET(0x1A1AE490)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1AFE00)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A1AE030)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A1ADFF0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1AE140)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int BBParameter_TypeDefinitionIndex = 25411;
