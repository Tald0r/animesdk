...
#define NODECANVAS_FRAMEWORK_BBPARAMETER_ADD_ONVARIABLEREFERENCECHANGED_OFFSET UNITYSDK_OFFSET(0x1A11B450)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A11B560)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_BB_OFFSET UNITYSDK_OFFSET(0x1A11BC40)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_ISDEFINED_OFFSET UNITYSDK_OFFSET(0x1A11BEA0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_ISNONEORNULL_OFFSET UNITYSDK_OFFSET(0x1A11BE30)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_ISNONE_OFFSET UNITYSDK_OFFSET(0x1A11BDA0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x1A11BDE0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_ISPRESUMEDDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1A11BD80)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A11B920)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_REFTYPE_OFFSET UNITYSDK_OFFSET(0x1A11BEC0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_TARGETVARIABLEID_OFFSET UNITYSDK_OFFSET(0x1A11B870)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_USEBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1A11B430)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A11BE10)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_GET_VARREF_OFFSET UNITYSDK_OFFSET(0x1A11B890)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_PROMOTETOVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A11C860)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_REMOVE_ONVARIABLEREFERENCECHANGED_OFFSET UNITYSDK_OFFSET(0x1A11B4D0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_RESOLVEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A11BA80)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SETBBFIELDS_OFFSET UNITYSDK_OFFSET(0x1A11B790)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SETTARGETVARIABLE_OFFSET UNITYSDK_OFFSET(0x1A11BF10)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_BB_OFFSET UNITYSDK_OFFSET(0x1A11AC30)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A11B930)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_TARGETVARIABLEID_OFFSET UNITYSDK_OFFSET(0x1A11B880)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_TSETTARGETVARIABLEID_OFFSET UNITYSDK_OFFSET(0x1A11B3F0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_USEBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1A11BC50)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A11BEF0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_SET_VARREF_OFFSET UNITYSDK_OFFSET(0x1A11B8A0)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A11D210)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A11B440)
#define NODECANVAS_FRAMEWORK_BBPARAMETER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A11B400)
#define NODECANVAS_FRAMEWORK_BBPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11B550)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int BBParameter_TypeDefinitionIndex = 27630;
