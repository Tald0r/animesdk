...
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C857C0)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C85840)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C85110)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x19C85100)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int SignalDefinition_InvokeArguments_TypeDefinitionIndex = 25523;
