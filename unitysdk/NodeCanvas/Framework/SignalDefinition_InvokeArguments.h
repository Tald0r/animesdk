...
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A226F90)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A227010)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A2268E0)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_INVOKEARGUMENTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2268C0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int SignalDefinition_InvokeArguments_TypeDefinitionIndex = 27486;
