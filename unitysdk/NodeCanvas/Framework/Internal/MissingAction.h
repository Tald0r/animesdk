...
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGACTION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A1CFC70)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGACTION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A1CFC30)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGACTION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1A1CFC50)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGACTION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A1CFC40)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGACTION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1A1CFC60)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1CFD50)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int MissingAction_TypeDefinitionIndex = 27614;
