...
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONNECTION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A8309E0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONNECTION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1A830A00)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONNECTION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A8309F0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONNECTION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1A830A10)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A830A20)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int MissingConnection_TypeDefinitionIndex = 27255;
