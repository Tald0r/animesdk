...
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_ASSTRING_OFFSET UNITYSDK_OFFSET(0x19FFB160)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_CREATE_OFFSET UNITYSDK_OFFSET(0x19FFAEB0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_GETMETHOD_OFFSET UNITYSDK_OFFSET(0x19FFB120)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_GETSERIALIZEDMETHOD_OFFSET UNITYSDK_OFFSET(0x19FFB110)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_HASCHANGED_OFFSET UNITYSDK_OFFSET(0x19FFB140)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_NODECANVAS_FRAMEWORK_IREFLECTEDWRAPPER_GETSERIALIZEDINFO_OFFSET UNITYSDK_OFFSET(0x19FFAF20)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_SETVARIABLESBB_OFFSET UNITYSDK_OFFSET(0x19FFAF30)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FFB180)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFAEA0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int ReflectedWrapper_TypeDefinitionIndex = 26123;
