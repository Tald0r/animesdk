...
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1A3F76F0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1A3F7710)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER_GET_TARGETSUBGRAPHVARIABLEID_OFFSET UNITYSDK_OFFSET(0x1A3F76E0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER_SET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1A3F7700)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER_SET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1A3F7720)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3F7780)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F7730)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int BBMappingParameter_TypeDefinitionIndex = 27122;
