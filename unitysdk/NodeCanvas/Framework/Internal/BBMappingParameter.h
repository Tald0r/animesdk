...
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x19E08E70)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x19E08E90)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER_GET_TARGETSUBGRAPHVARIABLEID_OFFSET UNITYSDK_OFFSET(0x19E08E60)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER_SET_CANREAD_OFFSET UNITYSDK_OFFSET(0x19E08E80)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER_SET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x19E08EA0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19E08F00)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBMAPPINGPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E08EB0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int BBMappingParameter_TypeDefinitionIndex = 26142;
