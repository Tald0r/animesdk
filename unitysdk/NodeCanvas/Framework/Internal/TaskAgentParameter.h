...
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER_GETVALUEBOXED_OFFSET UNITYSDK_OFFSET(0x1A1207C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A120720)
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER_GET_VARTYPE_OFFSET UNITYSDK_OFFSET(0x1A1206E0)
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER_SETTYPE_OFFSET UNITYSDK_OFFSET(0x1A120890)
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER_SETVALUEBOXED_OFFSET UNITYSDK_OFFSET(0x1A120850)
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A1207B0)
#define NODECANVAS_FRAMEWORK_INTERNAL_TASKAGENTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1208F0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int TaskAgentParameter_TypeDefinitionIndex = 26497;
