...
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_ALLPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A1B28A0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_ALLTASKS_OFFSET UNITYSDK_OFFSET(0x1A1B2880)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_CANVASGROUPS_OFFSET UNITYSDK_OFFSET(0x1A1B2B40)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1A1B2A60)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_COMMENTS_OFFSET UNITYSDK_OFFSET(0x1A1B2A80)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_CONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A1B2B20)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_DERIVEDDATA_OFFSET UNITYSDK_OFFSET(0x1A1B2B80)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_LOCALBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1A1B2B60)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_NODES_OFFSET UNITYSDK_OFFSET(0x1A1B2B00)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1A1B2AA0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A1B2AE0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1A1B2A40)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_GET_ZOOMFACTOR_OFFSET UNITYSDK_OFFSET(0x1A1B2AC0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_PACK_OFFSET UNITYSDK_OFFSET(0x1A1B2D10)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_ISERIALIZATIONCOLLECTOR_ONCOLLECT_OFFSET UNITYSDK_OFFSET(0x1A1B2960)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_ISERIALIZATIONCOLLECTOR_ONPOP_OFFSET UNITYSDK_OFFSET(0x1A1B2A30)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_ISERIALIZATIONCOLLECTOR_ONPUSH_OFFSET UNITYSDK_OFFSET(0x1A1B28C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_PURGEREDUNDANTREFERENCES_OFFSET UNITYSDK_OFFSET(0x1A1B3290)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SETMETADATA_OFFSET UNITYSDK_OFFSET(0x1A1B3250)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_ALLPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A1B28B0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_ALLTASKS_OFFSET UNITYSDK_OFFSET(0x1A1B2890)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_CANVASGROUPS_OFFSET UNITYSDK_OFFSET(0x1A1B2B50)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_CATEGORY_OFFSET UNITYSDK_OFFSET(0x1A1B2A70)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_COMMENTS_OFFSET UNITYSDK_OFFSET(0x1A1B2A90)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_CONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A1B2B30)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_DERIVEDDATA_OFFSET UNITYSDK_OFFSET(0x1A1B2B90)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_LOCALBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1A1B2B70)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_NODES_OFFSET UNITYSDK_OFFSET(0x1A1B2B10)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1A1B2AB0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A1B2AF0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1A1B2A50)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_SET_ZOOMFACTOR_OFFSET UNITYSDK_OFFSET(0x1A1B2AD0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE_UNPACK_OFFSET UNITYSDK_OFFSET(0x1A1B2FA0)
#define NODECANVAS_FRAMEWORK_INTERNAL_GRAPHSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B2BA0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int GraphSource_TypeDefinitionIndex = 26886;
