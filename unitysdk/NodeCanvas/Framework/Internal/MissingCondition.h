...
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A65CEE0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A65CEA0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1A65CEC0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A65CEB0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1A65CED0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A65CFC0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int MissingCondition_TypeDefinitionIndex = 26115;
