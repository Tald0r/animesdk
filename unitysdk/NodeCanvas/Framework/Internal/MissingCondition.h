...
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A08A2C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A08A280)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1A08A2A0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A08A290)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1A08A2B0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGCONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A08A3A0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int MissingCondition_TypeDefinitionIndex = 25767;
