...
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDACTION_CALL_OFFSET UNITYSDK_OFFSET(0x19C2C650)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDACTION_GETVARIABLES_OFFSET UNITYSDK_OFFSET(0x19C2C580)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDACTION_INIT_OFFSET UNITYSDK_OFFSET(0x19C2C5C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2C910)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int ReflectedAction_TypeDefinitionIndex = 27053;
