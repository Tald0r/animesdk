...
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDFUNCTIONWRAPPER_CREATE_OFFSET UNITYSDK_OFFSET(0x19C110C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_REFLECTEDFUNCTIONWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C11700)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int ReflectedFunctionWrapper_TypeDefinitionIndex = 26103;
