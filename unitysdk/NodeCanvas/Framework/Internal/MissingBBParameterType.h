...
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x19C850A0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x19C850C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x19C850B0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x19C850D0)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C850E0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int MissingBBParameterType_TypeDefinitionIndex = 26022;

	class MissingBBParameterType : public ::NodeCanvas::Framework::BBParameter_1<::System::Object*>
	{
	public:
		::System::String* _missingType; // 0x50
		::System::String* _recoveryState; // 0x58
