...
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A226860)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_GET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1A226880)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_MISSINGTYPE_OFFSET UNITYSDK_OFFSET(0x1A226870)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE_PARADOXNOTION_SERIALIZATION_IMISSINGRECOVERABLE_SET_RECOVERYSTATE_OFFSET UNITYSDK_OFFSET(0x1A226890)
#define NODECANVAS_FRAMEWORK_INTERNAL_MISSINGBBPARAMETERTYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2268A0)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int MissingBBParameterType_TypeDefinitionIndex = 27695;
