...
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19C2C330)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_GET_VARTYPE_OFFSET UNITYSDK_OFFSET(0x19C2C350)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_SETTYPE_OFFSET UNITYSDK_OFFSET(0x19C2C3E0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x19C2C340)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19C2C2C0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19C2C290)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C2C4E0)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19C2C500)
#define NODECANVAS_FRAMEWORK_INTERNAL_BBOBJECTPARAMETER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C2C390)

namespace NodeCanvas::Framework::Internal
{
	inline static constexpr unsigned int BBObjectParameter_TypeDefinitionIndex = 27184;
