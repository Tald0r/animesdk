...
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD___C__DISPLAYCLASS14_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A48A5B0)
#define NODECANVAS_FRAMEWORK_GLOBALBLACKBOARD___C__DISPLAYCLASS14_0__FIND_B__0_OFFSET UNITYSDK_OFFSET(0x1A48A5C0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int GlobalBlackboard___c__DisplayClass14_0_TypeDefinitionIndex = 27531;
