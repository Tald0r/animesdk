...
#define NODECANVAS_FRAMEWORK_VARIABLE_ADD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1D0540)
#define NODECANVAS_FRAMEWORK_VARIABLE_ADD_ONNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x1A1D03C0)
#define NODECANVAS_FRAMEWORK_VARIABLE_ADD_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A1D0480)
#define NODECANVAS_FRAMEWORK_VARIABLE_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x1A1D0BF0)
#define NODECANVAS_FRAMEWORK_VARIABLE_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x1A1D0A90)
#define NODECANVAS_FRAMEWORK_VARIABLE_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1A1D07F0)
#define NODECANVAS_FRAMEWORK_VARIABLE_GETGETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1A1D0AB0)
#define NODECANVAS_FRAMEWORK_VARIABLE_GETSETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1A1D0C10)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A1D0690)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_ISEXPOSEDPUBLIC_OFFSET UNITYSDK_OFFSET(0x1A1D0710)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_ISPROPERTYBOUND_OFFSET UNITYSDK_OFFSET(0x1A1D0760)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A1D0600)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A1D06D0)
#define NODECANVAS_FRAMEWORK_VARIABLE_HASVALUECHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x1A1D0A20)
#define NODECANVAS_FRAMEWORK_VARIABLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1D07E0)
#define NODECANVAS_FRAMEWORK_VARIABLE_REMOVE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1D05A0)
#define NODECANVAS_FRAMEWORK_VARIABLE_REMOVE_ONNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x1A1D0420)
#define NODECANVAS_FRAMEWORK_VARIABLE_REMOVE_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A1D04E0)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_ISEXPOSEDPUBLIC_OFFSET UNITYSDK_OFFSET(0x1A1D07A0)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A1D0610)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_TSETID_OFFSET UNITYSDK_OFFSET(0x1A1D03B0)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A1D06F0)
#define NODECANVAS_FRAMEWORK_VARIABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A1D0D50)
#define NODECANVAS_FRAMEWORK_VARIABLE_TRYINVOKEVALUECHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x1A1D0A30)
#define NODECANVAS_FRAMEWORK_VARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D07B0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Variable_TypeDefinitionIndex = 26782;

	class Variable : public ::System::Object
	{
	public:
		::System::Action_1<::System::Object*>* onValueChanged; // 0x10
		::System::Action* onDestroy; // 0x18
