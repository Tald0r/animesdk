...
#define NODECANVAS_FRAMEWORK_VARIABLE_ADD_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C118A0)
#define NODECANVAS_FRAMEWORK_VARIABLE_ADD_ONNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x19C11720)
#define NODECANVAS_FRAMEWORK_VARIABLE_ADD_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19C117E0)
#define NODECANVAS_FRAMEWORK_VARIABLE_CANCONVERTFROM_OFFSET UNITYSDK_OFFSET(0x19C11F50)
#define NODECANVAS_FRAMEWORK_VARIABLE_CANCONVERTTO_OFFSET UNITYSDK_OFFSET(0x19C11DF0)
#define NODECANVAS_FRAMEWORK_VARIABLE_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x19C11B50)
#define NODECANVAS_FRAMEWORK_VARIABLE_GETGETCONVERTER_OFFSET UNITYSDK_OFFSET(0x19C11E10)
#define NODECANVAS_FRAMEWORK_VARIABLE_GETSETCONVERTER_OFFSET UNITYSDK_OFFSET(0x19C11F70)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_ID_OFFSET UNITYSDK_OFFSET(0x19C119F0)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_ISEXPOSEDPUBLIC_OFFSET UNITYSDK_OFFSET(0x19C11A70)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_ISPROPERTYBOUND_OFFSET UNITYSDK_OFFSET(0x19C11AC0)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19C11960)
#define NODECANVAS_FRAMEWORK_VARIABLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19C11A30)
#define NODECANVAS_FRAMEWORK_VARIABLE_HASVALUECHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x19C11D80)
#define NODECANVAS_FRAMEWORK_VARIABLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C11B40)
#define NODECANVAS_FRAMEWORK_VARIABLE_REMOVE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C11900)
#define NODECANVAS_FRAMEWORK_VARIABLE_REMOVE_ONNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x19C11780)
#define NODECANVAS_FRAMEWORK_VARIABLE_REMOVE_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19C11840)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_ISEXPOSEDPUBLIC_OFFSET UNITYSDK_OFFSET(0x19C11B00)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19C11970)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_TSETID_OFFSET UNITYSDK_OFFSET(0x19C11710)
#define NODECANVAS_FRAMEWORK_VARIABLE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19C11A50)
#define NODECANVAS_FRAMEWORK_VARIABLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C120B0)
#define NODECANVAS_FRAMEWORK_VARIABLE_TRYINVOKEVALUECHANGEEVENT_OFFSET UNITYSDK_OFFSET(0x19C11D90)
#define NODECANVAS_FRAMEWORK_VARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C11B10)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Variable_TypeDefinitionIndex = 25229;
	...
	public:
		...
		::System::Action_1<::System::Object*>* onValueChanged; // 0x28
		::System::Action_1<::System::String*>* onNameChanged; // 0x30
