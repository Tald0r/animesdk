...
#define NODECANVAS_FRAMEWORK_UTILS_NODECANVASDEBUG_EDITORLOGERROR_OFFSET UNITYSDK_OFFSET(0x19270970)
#define NODECANVAS_FRAMEWORK_UTILS_NODECANVASDEBUG_LOGERROR_OFFSET UNITYSDK_OFFSET(0x192707A0)
#define NODECANVAS_FRAMEWORK_UTILS_NODECANVASDEBUG_LOG_OFFSET UNITYSDK_OFFSET(0x192705D0)
#define NODECANVAS_FRAMEWORK_UTILS_NODECANVASDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x19270AF0)

namespace NodeCanvas::Framework::Utils
{
	inline static constexpr unsigned int NodeCanvasDebug_TypeDefinitionIndex = 26253;
