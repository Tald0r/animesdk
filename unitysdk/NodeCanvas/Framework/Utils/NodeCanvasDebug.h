...
#define NODECANVAS_FRAMEWORK_UTILS_NODECANVASDEBUG_EDITORLOGERROR_OFFSET UNITYSDK_OFFSET(0x196ECF30)
#define NODECANVAS_FRAMEWORK_UTILS_NODECANVASDEBUG_LOGERROR_OFFSET UNITYSDK_OFFSET(0x196ECD60)
#define NODECANVAS_FRAMEWORK_UTILS_NODECANVASDEBUG_LOG_OFFSET UNITYSDK_OFFSET(0x196ECB90)
#define NODECANVAS_FRAMEWORK_UTILS_NODECANVASDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x196ED0B0)

namespace NodeCanvas::Framework::Utils
{
	inline static constexpr unsigned int NodeCanvasDebug_TypeDefinitionIndex = 26479;
