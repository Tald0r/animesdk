...
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19C84D70)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NODECANVAS_FRAMEWORK_IBLACKBOARD__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19C84FA0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NODECANVAS_FRAMEWORK_IBLACKBOARD__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C84F30)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19C85020)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C84F90)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19C84F40)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C84D60)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0x19C84D40)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int IBlackboardExtensions__GetAllParents_d__1_TypeDefinitionIndex = 25764;

	class IBlackboardExtensions__GetAllParents_d__1 : public ::System::Object
	{
	public:
		::NodeCanvas::Framework::IBlackboard* blackboard; // 0x10
		::NodeCanvas::Framework::IBlackboard* __3__blackboard; // 0x18
		::NodeCanvas::Framework::IBlackboard* __2__current; // 0x20
		::NodeCanvas::Framework::IBlackboard* _current_5__2; // 0x28
		::System::Int32 __1__state; // 0x30
		::System::Boolean includeSelf; // 0x34
		::System::Boolean __3__includeSelf; // 0x35
