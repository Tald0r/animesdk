...
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A226530)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NODECANVAS_FRAMEWORK_IBLACKBOARD__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A226760)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NODECANVAS_FRAMEWORK_IBLACKBOARD__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A2266F0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A2267E0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A226750)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A226700)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A226520)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETALLPARENTS_D__1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A226500)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int IBlackboardExtensions__GetAllParents_d__1_TypeDefinitionIndex = 26658;
	...
	public:
		...
		::System::Boolean __3__includeSelf; // 0x30
		::System::Boolean includeSelf; // 0x31
