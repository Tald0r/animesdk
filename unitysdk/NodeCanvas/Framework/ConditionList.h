...
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ADDCONDITION_OFFSET UNITYSDK_OFFSET(0x1A11DEB0)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1A11DCC0)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_GETWARNINGORERROR_OFFSET UNITYSDK_OFFSET(0x1A11E550)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_GET_ALLTRUEREQUIRED_OFFSET UNITYSDK_OFFSET(0x1A11DB60)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A11DB70)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A11E290)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A11E1E0)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A11E4C0)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A11E030)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11E5F0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ConditionList_TypeDefinitionIndex = 26648;
