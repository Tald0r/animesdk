...
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ADDCONDITION_OFFSET UNITYSDK_OFFSET(0x1A1B0AA0)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1A1B08B0)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_GETWARNINGORERROR_OFFSET UNITYSDK_OFFSET(0x1A1B1140)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_GET_ALLTRUEREQUIRED_OFFSET UNITYSDK_OFFSET(0x1A1B0750)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A1B0760)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ONCHECK_OFFSET UNITYSDK_OFFSET(0x1A1B0E80)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A1B0DD0)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A1B10B0)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A1B0C20)
#define NODECANVAS_FRAMEWORK_CONDITIONLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1B11E0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ConditionList_TypeDefinitionIndex = 26806;
