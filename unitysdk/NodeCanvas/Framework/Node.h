...
#define NODECANVAS_FRAMEWORK_NODE_ARENODESCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A180D20)
#define NODECANVAS_FRAMEWORK_NODE_CANCONNECTFROMSOURCE_OFFSET UNITYSDK_OFFSET(0x1A180D10)
#define NODECANVAS_FRAMEWORK_NODE_CANCONNECTTOTARGET_OFFSET UNITYSDK_OFFSET(0x1A180D00)
#define NODECANVAS_FRAMEWORK_NODE_CREATE_OFFSET UNITYSDK_OFFSET(0x1A17FC30)
#define NODECANVAS_FRAMEWORK_NODE_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1A17FE70)
#define NODECANVAS_FRAMEWORK_NODE_ERROR_OFFSET UNITYSDK_OFFSET(0x1A1809E0)
#define NODECANVAS_FRAMEWORK_NODE_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A180820)
#define NODECANVAS_FRAMEWORK_NODE_FAIL_OFFSET UNITYSDK_OFFSET(0x1A180B00)
#define NODECANVAS_FRAMEWORK_NODE_GETCHILDNODES_OFFSET UNITYSDK_OFFSET(0x1A181070)
#define NODECANVAS_FRAMEWORK_NODE_GETHARDERROR_OFFSET UNITYSDK_OFFSET(0x1A1804A0)
#define NODECANVAS_FRAMEWORK_NODE_GETPARENTNODES_OFFSET UNITYSDK_OFFSET(0x1A180F50)
#define NODECANVAS_FRAMEWORK_NODE_GETWARNINGORERROR_OFFSET UNITYSDK_OFFSET(0x1A1812D0)
#define NODECANVAS_FRAMEWORK_NODE_GET_BREAKPOINTREACHED_OFFSET UNITYSDK_OFFSET(0x1A17FB60)
#define NODECANVAS_FRAMEWORK_NODE_GET_COMMENTS_OFFSET UNITYSDK_OFFSET(0x1A17F890)
#define NODECANVAS_FRAMEWORK_NODE_GET_CUSTOMNAME_OFFSET UNITYSDK_OFFSET(0x1A17F830)
#define NODECANVAS_FRAMEWORK_NODE_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A17F8E0)
#define NODECANVAS_FRAMEWORK_NODE_GET_ELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x1A17FAF0)
#define NODECANVAS_FRAMEWORK_NODE_GET_GRAPHAGENT_OFFSET UNITYSDK_OFFSET(0x1A17FA60)
#define NODECANVAS_FRAMEWORK_NODE_GET_GRAPHBLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1A17DC10)
#define NODECANVAS_FRAMEWORK_NODE_GET_GRAPH_OFFSET UNITYSDK_OFFSET(0x1A17F730)
#define NODECANVAS_FRAMEWORK_NODE_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A17F750)
#define NODECANVAS_FRAMEWORK_NODE_GET_INCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A17F7D0)
#define NODECANVAS_FRAMEWORK_NODE_GET_ISBREAKPOINT_OFFSET UNITYSDK_OFFSET(0x1A17F8B0)
#define NODECANVAS_FRAMEWORK_NODE_GET_ISCHECKED_OFFSET UNITYSDK_OFFSET(0x1A17FB40)
#define NODECANVAS_FRAMEWORK_NODE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A17D3C0)
#define NODECANVAS_FRAMEWORK_NODE_GET_OUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A17F7F0)
#define NODECANVAS_FRAMEWORK_NODE_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A17F810)
#define NODECANVAS_FRAMEWORK_NODE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1A17F980)
#define NODECANVAS_FRAMEWORK_NODE_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x1A17FA10)
#define NODECANVAS_FRAMEWORK_NODE_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1A17F870)
#define NODECANVAS_FRAMEWORK_NODE_GET_TIMESTARTED_OFFSET UNITYSDK_OFFSET(0x1A17FB20)
#define NODECANVAS_FRAMEWORK_NODE_GET_TNAME_OFFSET UNITYSDK_OFFSET(0x1A17F850)
#define NODECANVAS_FRAMEWORK_NODE_GET_TUID_OFFSET UNITYSDK_OFFSET(0x1A17F7B0)
#define NODECANVAS_FRAMEWORK_NODE_GET_UID_OFFSET UNITYSDK_OFFSET(0x1A17F770)
#define NODECANVAS_FRAMEWORK_NODE_ISCHILDOF_OFFSET UNITYSDK_OFFSET(0x1A181190)
#define NODECANVAS_FRAMEWORK_NODE_ISNEWCONNECTIONALLOWED_OFFSET UNITYSDK_OFFSET(0x1A180BF0)
#define NODECANVAS_FRAMEWORK_NODE_ISPARENTOF_OFFSET UNITYSDK_OFFSET(0x1A181230)
#define NODECANVAS_FRAMEWORK_NODE_ONCHILDCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A1814E0)
#define NODECANVAS_FRAMEWORK_NODE_ONCHILDDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A1814F0)
#define NODECANVAS_FRAMEWORK_NODE_ONCHILDRENCONNECTIONSSORTED_OFFSET UNITYSDK_OFFSET(0x1A181500)
#define NODECANVAS_FRAMEWORK_NODE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1A181490)
#define NODECANVAS_FRAMEWORK_NODE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1814B0)
#define NODECANVAS_FRAMEWORK_NODE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A181470)
#define NODECANVAS_FRAMEWORK_NODE_ONGRAPHPAUSED_OFFSET UNITYSDK_OFFSET(0x1A181550)
#define NODECANVAS_FRAMEWORK_NODE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A181510)
#define NODECANVAS_FRAMEWORK_NODE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A181530)
#define NODECANVAS_FRAMEWORK_NODE_ONGRAPHUNPAUSED_OFFSET UNITYSDK_OFFSET(0x1A181560)
#define NODECANVAS_FRAMEWORK_NODE_ONPARENTCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A1814C0)
#define NODECANVAS_FRAMEWORK_NODE_ONPARENTDISCONNECTED_OFFSET UNITYSDK_OFFSET(0x1A1814D0)
#define NODECANVAS_FRAMEWORK_NODE_ONPOSTGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A181520)
#define NODECANVAS_FRAMEWORK_NODE_ONPOSTGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A181540)
#define NODECANVAS_FRAMEWORK_NODE_ONRESET_OFFSET UNITYSDK_OFFSET(0x1A181480)
#define NODECANVAS_FRAMEWORK_NODE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A1814A0)
#define NODECANVAS_FRAMEWORK_NODE_RESET_OFFSET UNITYSDK_OFFSET(0x1A180870)
#define NODECANVAS_FRAMEWORK_NODE_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x1A180BC0)
#define NODECANVAS_FRAMEWORK_NODE_SETSTATUS_OFFSET UNITYSDK_OFFSET(0x1A180B80)
#define NODECANVAS_FRAMEWORK_NODE_SET_BREAKPOINTREACHED_OFFSET UNITYSDK_OFFSET(0x1A17FB70)
#define NODECANVAS_FRAMEWORK_NODE_SET_COMMENTS_OFFSET UNITYSDK_OFFSET(0x1A17F8A0)
#define NODECANVAS_FRAMEWORK_NODE_SET_CUSTOMNAME_OFFSET UNITYSDK_OFFSET(0x1A17F840)
#define NODECANVAS_FRAMEWORK_NODE_SET_GRAPH_OFFSET UNITYSDK_OFFSET(0x1A17F740)
#define NODECANVAS_FRAMEWORK_NODE_SET_ID_OFFSET UNITYSDK_OFFSET(0x1A17F760)
#define NODECANVAS_FRAMEWORK_NODE_SET_INCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A17F7E0)
#define NODECANVAS_FRAMEWORK_NODE_SET_ISBREAKPOINT_OFFSET UNITYSDK_OFFSET(0x1A17F8C0)
#define NODECANVAS_FRAMEWORK_NODE_SET_ISCHECKED_OFFSET UNITYSDK_OFFSET(0x1A17FB50)
#define NODECANVAS_FRAMEWORK_NODE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A17F8D0)
#define NODECANVAS_FRAMEWORK_NODE_SET_OUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A17F800)
#define NODECANVAS_FRAMEWORK_NODE_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A17F820)
#define NODECANVAS_FRAMEWORK_NODE_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x1A17FA20)
#define NODECANVAS_FRAMEWORK_NODE_SET_TAG_OFFSET UNITYSDK_OFFSET(0x1A17F880)
#define NODECANVAS_FRAMEWORK_NODE_SET_TIMESTARTED_OFFSET UNITYSDK_OFFSET(0x1A17FB30)
#define NODECANVAS_FRAMEWORK_NODE_SET_TNAME_OFFSET UNITYSDK_OFFSET(0x1A17F860)
#define NODECANVAS_FRAMEWORK_NODE_SET_TUID_OFFSET UNITYSDK_OFFSET(0x1A17F7C0)
#define NODECANVAS_FRAMEWORK_NODE_STARTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A180E30)
#define NODECANVAS_FRAMEWORK_NODE_STOPCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1A180EC0)
#define NODECANVAS_FRAMEWORK_NODE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A181570)
#define NODECANVAS_FRAMEWORK_NODE_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A17FDC0)
#define NODECANVAS_FRAMEWORK_NODE_WARN_OFFSET UNITYSDK_OFFSET(0x1A180B70)
#define NODECANVAS_FRAMEWORK_NODE_YIELDBREAK_OFFSET UNITYSDK_OFFSET(0x1A180990)
#define NODECANVAS_FRAMEWORK_NODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A17FB80)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Node_TypeDefinitionIndex = 26412;
	...
	public:
		...
		::System::String* _comment; // 0x28
		::System::String* _name; // 0x30
		::System::Collections::Generic::List_1<::NodeCanvas::Framework::Connection*>* _outConnections; // 0x38
		::NodeCanvas::Framework::Graph* _graph; // 0x40
		::System::String* _descriptionCache; // 0x48
		::System::String* _UID; // 0x50
		...
		::System::Boolean _breakPointReached_k__BackingField; // 0x68
		::System::Boolean _isBreakpoint; // 0x69
