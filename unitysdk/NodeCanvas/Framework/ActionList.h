...
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ADDACTION_OFFSET UNITYSDK_OFFSET(0x1A17E0A0)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1A17DEB0)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_GETWARNINGORERROR_OFFSET UNITYSDK_OFFSET(0x1A17EA70)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A17DD10)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A17E9E0)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A17E260)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONINIT_OFFSET UNITYSDK_OFFSET(0x1A17E220)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1A17E940)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1A17E890)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A17E310)
#define NODECANVAS_FRAMEWORK_ACTIONLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A17EB10)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ActionList_TypeDefinitionIndex = 25158;
