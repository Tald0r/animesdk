...
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ADDACTION_OFFSET UNITYSDK_OFFSET(0x1A726920)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_DUPLICATE_OFFSET UNITYSDK_OFFSET(0x1A726730)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_GETWARNINGORERROR_OFFSET UNITYSDK_OFFSET(0x1A7272F0)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A726590)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A727260)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A726AE0)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONINIT_OFFSET UNITYSDK_OFFSET(0x1A726AA0)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1A7271C0)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONSTOP_OFFSET UNITYSDK_OFFSET(0x1A727110)
#define NODECANVAS_FRAMEWORK_ACTIONLIST_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A726B90)
#define NODECANVAS_FRAMEWORK_ACTIONLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A727390)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int ActionList_TypeDefinitionIndex = 26081;
