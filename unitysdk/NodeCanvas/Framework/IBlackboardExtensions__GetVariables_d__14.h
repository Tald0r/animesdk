...
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A7277C0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NODECANVAS_FRAMEWORK_VARIABLE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A727EB0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NODECANVAS_FRAMEWORK_VARIABLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A727E40)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A727F30)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A727EA0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A727E50)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A727620)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1A727600)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1A727700)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1A7277B0)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int IBlackboardExtensions__GetVariables_d__14_TypeDefinitionIndex = 26659;

	class IBlackboardExtensions__GetVariables_d__14 : public ::System::Object
	{
	public:
		::NodeCanvas::Framework::Variable* __2__current; // 0x10
		::System::Type* ofType; // 0x18
		::NodeCanvas::Framework::IBlackboard* __3__blackboard; // 0x20
		::System::Type* __3__ofType; // 0x28
		::System::Collections::Generic::IEnumerator_1<::NodeCanvas::Framework::Variable*>* __7__wrap1; // 0x30
