...
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A17EF40)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_NODECANVAS_FRAMEWORK_VARIABLE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A17F630)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_NODECANVAS_FRAMEWORK_VARIABLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A17F5C0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A17F6B0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A17F620)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A17F5D0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A17EDA0)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14__CTOR_OFFSET UNITYSDK_OFFSET(0x1A17ED80)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1A17EE80)
#define NODECANVAS_FRAMEWORK_IBLACKBOARDEXTENSIONS__GETVARIABLES_D__14___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1A17EF30)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int IBlackboardExtensions__GetVariables_d__14_TypeDefinitionIndex = 25765;

	class IBlackboardExtensions__GetVariables_d__14 : public ::System::Object
	{
	public:
		::NodeCanvas::Framework::Variable* __2__current; // 0x10
		::System::Collections::Generic::Dictionary_2_Enumerator<::System::String*, ::NodeCanvas::Framework::Variable*> __7__wrap2; // 0x18
		::System::Type* __3__ofType; // 0x40
		::System::Type* ofType; // 0x48
		::System::Collections::Generic::IEnumerator_1<::NodeCanvas::Framework::Variable*>* __7__wrap1; // 0x50
		::NodeCanvas::Framework::IBlackboard* __3__blackboard; // 0x58
		::NodeCanvas::Framework::IBlackboard* blackboard; // 0x60
