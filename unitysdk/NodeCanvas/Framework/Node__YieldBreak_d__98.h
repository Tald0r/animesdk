...
#define NODECANVAS_FRAMEWORK_NODE__YIELDBREAK_D__98_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A830AA0)
#define NODECANVAS_FRAMEWORK_NODE__YIELDBREAK_D__98_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A830B20)
#define NODECANVAS_FRAMEWORK_NODE__YIELDBREAK_D__98_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A830B80)
#define NODECANVAS_FRAMEWORK_NODE__YIELDBREAK_D__98_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A830B30)
#define NODECANVAS_FRAMEWORK_NODE__YIELDBREAK_D__98_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A830A90)
#define NODECANVAS_FRAMEWORK_NODE__YIELDBREAK_D__98__CTOR_OFFSET UNITYSDK_OFFSET(0x1A830A80)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int Node__YieldBreak_d__98_TypeDefinitionIndex = 26955;
