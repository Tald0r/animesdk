...
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY_ADD_ONINVOKE_OFFSET UNITYSDK_OFFSET(0x1A227030)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY_GET_PROXYID_OFFSET UNITYSDK_OFFSET(0x1A227020)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A227130)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY_REMOVE_ONINVOKE_OFFSET UNITYSDK_OFFSET(0x1A2270B0)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A2271A0)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A227160)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int SignalDefinition_SignalDefinitionProxy_TypeDefinitionIndex = 27484;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(SignalDefinition_SignalDefinitionProxy_TypeDefinitionIndex)->GetStaticField(0x4A30);
		}
