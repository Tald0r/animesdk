...
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY_ADD_ONINVOKE_OFFSET UNITYSDK_OFFSET(0x19C85860)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY_GET_PROXYID_OFFSET UNITYSDK_OFFSET(0x19C85850)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C85960)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY_REMOVE_ONINVOKE_OFFSET UNITYSDK_OFFSET(0x19C858E0)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C859D0)
#define NODECANVAS_FRAMEWORK_SIGNALDEFINITION_SIGNALDEFINITIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x19C85990)

namespace NodeCanvas::Framework
{
	inline static constexpr unsigned int SignalDefinition_SignalDefinitionProxy_TypeDefinitionIndex = 25524;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(SignalDefinition_SignalDefinitionProxy_TypeDefinitionIndex)->GetStaticField(0x4A00);
		}
