...
#define NODECANVAS_STATEMACHINES_ANYSTATE_GET_ALLOWASPRIME_OFFSET UNITYSDK_OFFSET(0x1A3A8AC0)
#define NODECANVAS_STATEMACHINES_ANYSTATE_GET_MAXINCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A3A8AA0)
#define NODECANVAS_STATEMACHINES_ANYSTATE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A3A8AB0)
#define NODECANVAS_STATEMACHINES_ANYSTATE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A3A8A60)
#define NODECANVAS_STATEMACHINES_ANYSTATE_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A3A8D90)
#define NODECANVAS_STATEMACHINES_ANYSTATE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A3A8AD0)
#define NODECANVAS_STATEMACHINES_ANYSTATE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x1A3A8C90)
#define NODECANVAS_STATEMACHINES_ANYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A9200)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int AnyState_TypeDefinitionIndex = 27283;
