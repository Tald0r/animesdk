...
#define NODECANVAS_STATEMACHINES_ANYSTATE_GET_ALLOWASPRIME_OFFSET UNITYSDK_OFFSET(0x19DB7860)
#define NODECANVAS_STATEMACHINES_ANYSTATE_GET_MAXINCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19DB7840)
#define NODECANVAS_STATEMACHINES_ANYSTATE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19DB7850)
#define NODECANVAS_STATEMACHINES_ANYSTATE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19DB7800)
#define NODECANVAS_STATEMACHINES_ANYSTATE_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x19DB7B30)
#define NODECANVAS_STATEMACHINES_ANYSTATE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19DB7870)
#define NODECANVAS_STATEMACHINES_ANYSTATE_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19DB7A30)
#define NODECANVAS_STATEMACHINES_ANYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB7FA0)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int AnyState_TypeDefinitionIndex = 26813;
