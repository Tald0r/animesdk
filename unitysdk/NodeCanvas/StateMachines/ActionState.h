...
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_GET_ACTIONLIST_OFFSET UNITYSDK_OFFSET(0x1A1819C0)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_GET_REPEATSTATEACTIONS_OFFSET UNITYSDK_OFFSET(0x1A1819E0)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1A181940)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x1A181AD0)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x1A181C50)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1A181CA0)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A181AE0)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A181A00)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_SET_ACTIONLIST_OFFSET UNITYSDK_OFFSET(0x1A1819D0)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_SET_REPEATSTATEACTIONS_OFFSET UNITYSDK_OFFSET(0x1A1819F0)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1A181950)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A181CE0)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int ActionState_TypeDefinitionIndex = 26487;
