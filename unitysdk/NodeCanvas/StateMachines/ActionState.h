...
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_GET_ACTIONLIST_OFFSET UNITYSDK_OFFSET(0x1A72A240)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_GET_REPEATSTATEACTIONS_OFFSET UNITYSDK_OFFSET(0x1A72A260)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1A72A1C0)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x1A72A350)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x1A72A4D0)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1A72A520)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A72A360)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A72A280)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_SET_ACTIONLIST_OFFSET UNITYSDK_OFFSET(0x1A72A250)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_SET_REPEATSTATEACTIONS_OFFSET UNITYSDK_OFFSET(0x1A72A270)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1A72A1D0)
#define NODECANVAS_STATEMACHINES_ACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A72A560)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int ActionState_TypeDefinitionIndex = 27093;
