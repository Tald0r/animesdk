...
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_GET_ALLOWASPRIME_OFFSET UNITYSDK_OFFSET(0x19C12100)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_GET_MAXINCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19C120E0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19C120F0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19C120C0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x19C121D0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x19C12110)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x19C123D0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19C121E0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x19C12170)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C123E0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBFLOWSCRIPT__ONGRAPHSTARTED_B__14_0_OFFSET UNITYSDK_OFFSET(0x19C12400)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int ConcurrentSubFlowScript_TypeDefinitionIndex = 25838;
