...
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x1A609390)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x1A609550)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x1A6096C0)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A6093A0)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A609190)
#define NODECANVAS_STATEMACHINES_SUPERACTIONSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A609730)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int SuperActionState_TypeDefinitionIndex = 26761;

	class SuperActionState : public ::NodeCanvas::StateMachines::FSMState
	{
	public:
		::NodeCanvas::Framework::ActionList* _onUpdateList; // 0x80
		::NodeCanvas::Framework::ActionList* _onExitList; // 0x88
