...
#define NODECANVAS_STATEMACHINES_FSM_ADD_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x191653C0)
#define NODECANVAS_STATEMACHINES_FSM_ADD_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x191655C0)
#define NODECANVAS_STATEMACHINES_FSM_ADD_ONSTATETRANSITION_OFFSET UNITYSDK_OFFSET(0x191656C0)
#define NODECANVAS_STATEMACHINES_FSM_ADD_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x191654C0)
#define NODECANVAS_STATEMACHINES_FSM_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x19165BB0)
#define NODECANVAS_STATEMACHINES_FSM_GATHERCALLBACKRECEIVERS_OFFSET UNITYSDK_OFFSET(0x191664E0)
#define NODECANVAS_STATEMACHINES_FSM_GETSTATENAMES_OFFSET UNITYSDK_OFFSET(0x19166310)
#define NODECANVAS_STATEMACHINES_FSM_GETSTATEWITHNAME_OFFSET UNITYSDK_OFFSET(0x19166220)
#define NODECANVAS_STATEMACHINES_FSM_GET_ALLOWBLACKBOARDOVERRIDES_OFFSET UNITYSDK_OFFSET(0x191658C0)
#define NODECANVAS_STATEMACHINES_FSM_GET_BASENODETYPE_OFFSET UNITYSDK_OFFSET(0x19165860)
#define NODECANVAS_STATEMACHINES_FSM_GET_CANACCEPTVARIABLEDROPS_OFFSET UNITYSDK_OFFSET(0x191658D0)
#define NODECANVAS_STATEMACHINES_FSM_GET_CURRENTSTATENAME_OFFSET UNITYSDK_OFFSET(0x19165800)
#define NODECANVAS_STATEMACHINES_FSM_GET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x191657C0)
#define NODECANVAS_STATEMACHINES_FSM_GET_ISTREE_OFFSET UNITYSDK_OFFSET(0x191658B0)
#define NODECANVAS_STATEMACHINES_FSM_GET_PREVIOUSSTATENAME_OFFSET UNITYSDK_OFFSET(0x19165830)
#define NODECANVAS_STATEMACHINES_FSM_GET_PREVIOUSSTATE_OFFSET UNITYSDK_OFFSET(0x191657E0)
#define NODECANVAS_STATEMACHINES_FSM_GET_REQUIRESAGENT_OFFSET UNITYSDK_OFFSET(0x19165890)
#define NODECANVAS_STATEMACHINES_FSM_GET_REQUIRESPRIMENODE_OFFSET UNITYSDK_OFFSET(0x191658A0)
#define NODECANVAS_STATEMACHINES_FSM_ONGRAPHINITIALIZE_OFFSET UNITYSDK_OFFSET(0x191658E0)
#define NODECANVAS_STATEMACHINES_FSM_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19165AA0)
#define NODECANVAS_STATEMACHINES_FSM_ONGRAPHSTOPED_OFFSET UNITYSDK_OFFSET(0x19166160)
#define NODECANVAS_STATEMACHINES_FSM_ONGRAPHUPDATE_OFFSET UNITYSDK_OFFSET(0x19165E30)
#define NODECANVAS_STATEMACHINES_FSM_PEEKSTACK_OFFSET UNITYSDK_OFFSET(0x191667C0)
#define NODECANVAS_STATEMACHINES_FSM_REMOVE_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x19165440)
#define NODECANVAS_STATEMACHINES_FSM_REMOVE_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x19165640)
#define NODECANVAS_STATEMACHINES_FSM_REMOVE_ONSTATETRANSITION_OFFSET UNITYSDK_OFFSET(0x19165740)
#define NODECANVAS_STATEMACHINES_FSM_REMOVE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19165540)
#define NODECANVAS_STATEMACHINES_FSM_SET_CURRENTSTATE_OFFSET UNITYSDK_OFFSET(0x191657D0)
#define NODECANVAS_STATEMACHINES_FSM_SET_PREVIOUSSTATE_OFFSET UNITYSDK_OFFSET(0x191657F0)
#define NODECANVAS_STATEMACHINES_FSM_TRIGGERSTATE_OFFSET UNITYSDK_OFFSET(0x191661E0)
#define NODECANVAS_STATEMACHINES_FSM__CTOR_OFFSET UNITYSDK_OFFSET(0x19166820)
#define NODECANVAS_STATEMACHINES_FSM__GATHERCALLBACKRECEIVERS_B__48_0_OFFSET UNITYSDK_OFFSET(0x19166830)
#define NODECANVAS_STATEMACHINES_FSM__GATHERCALLBACKRECEIVERS_B__48_1_OFFSET UNITYSDK_OFFSET(0x19166990)
#define NODECANVAS_STATEMACHINES_FSM__GATHERCALLBACKRECEIVERS_B__48_2_OFFSET UNITYSDK_OFFSET(0x19166AF0)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int FSM_TypeDefinitionIndex = 25930;
