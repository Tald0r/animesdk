...
#define NODECANVAS_STATEMACHINES_EMPTYSTATE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A2692C0)
#define NODECANVAS_STATEMACHINES_EMPTYSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x1A2692E0)
#define NODECANVAS_STATEMACHINES_EMPTYSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2692F0)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int EmptyState_TypeDefinitionIndex = 26466;
