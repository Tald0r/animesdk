...
#define NODECANVAS_STATEMACHINES_NESTEDBTSTATE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A72A630)
#define NODECANVAS_STATEMACHINES_NESTEDBTSTATE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A72A570)
#define NODECANVAS_STATEMACHINES_NESTEDBTSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x1A72A640)
#define NODECANVAS_STATEMACHINES_NESTEDBTSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x1A72AA90)
#define NODECANVAS_STATEMACHINES_NESTEDBTSTATE_ONFINISH_OFFSET UNITYSDK_OFFSET(0x1A72AA00)
#define NODECANVAS_STATEMACHINES_NESTEDBTSTATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A72A8F0)
#define NODECANVAS_STATEMACHINES_NESTEDBTSTATE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A72A5D0)
#define NODECANVAS_STATEMACHINES_NESTEDBTSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A72AB50)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int NestedBTState_TypeDefinitionIndex = 27017;
	...
	public:
		...
		::NodeCanvas::StateMachines::NestedBTState_BTExecutionMode executionMode; // 0xB0
		::NodeCanvas::StateMachines::NestedBTState_BTExitMode exitMode; // 0xB4
