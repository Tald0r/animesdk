...
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_ALLOWASPRIME_OFFSET UNITYSDK_OFFSET(0x19C12460)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_MAXINCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19C12440)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19C12450)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19C12420)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x19C12530)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x19C12470)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x19C12730)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x19C12540)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x19C124D0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C12740)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE__ONGRAPHSTARTED_B__14_0_OFFSET UNITYSDK_OFFSET(0x19C12760)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int ConcurrentSubTree_TypeDefinitionIndex = 26540;
