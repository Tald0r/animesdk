...
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_ALLOWASPRIME_OFFSET UNITYSDK_OFFSET(0x1A1D1100)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_MAXINCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A1D10E0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x1A1D10F0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A1D10C0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_SUBGRAPHPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A1D11D0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_GET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A1D1110)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_NODECANVAS_FRAMEWORK_IUPDATABLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A1D13D0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_ONGRAPHSTARTED_OFFSET UNITYSDK_OFFSET(0x1A1D11E0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE_SET_SUBGRAPH_OFFSET UNITYSDK_OFFSET(0x1A1D1170)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D13E0)
#define NODECANVAS_STATEMACHINES_CONCURRENTSUBTREE__ONGRAPHSTARTED_B__14_0_OFFSET UNITYSDK_OFFSET(0x1A1D1400)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int ConcurrentSubTree_TypeDefinitionIndex = 26210;
