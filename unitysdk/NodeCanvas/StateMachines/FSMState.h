...
#define NODECANVAS_STATEMACHINES_FSMSTATE_CANCONNECTFROMSOURCE_OFFSET UNITYSDK_OFFSET(0x19E0C080)
#define NODECANVAS_STATEMACHINES_FSMSTATE_CANCONNECTTOTARGET_OFFSET UNITYSDK_OFFSET(0x19E0C120)
#define NODECANVAS_STATEMACHINES_FSMSTATE_CHECKTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x19E0C3A0)
#define NODECANVAS_STATEMACHINES_FSMSTATE_FINISH_1_OFFSET UNITYSDK_OFFSET(0x19E0C040)
#define NODECANVAS_STATEMACHINES_FSMSTATE_FINISH_2_OFFSET UNITYSDK_OFFSET(0x19E0C000)
#define NODECANVAS_STATEMACHINES_FSMSTATE_FINISH_OFFSET UNITYSDK_OFFSET(0x19E0BFF0)
#define NODECANVAS_STATEMACHINES_FSMSTATE_GETTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x19E0BE60)
#define NODECANVAS_STATEMACHINES_FSMSTATE_GET_ALLOWASPRIME_OFFSET UNITYSDK_OFFSET(0x19E0BE00)
#define NODECANVAS_STATEMACHINES_FSMSTATE_GET_CANSELFCONNECT_OFFSET UNITYSDK_OFFSET(0x19E0BE10)
#define NODECANVAS_STATEMACHINES_FSMSTATE_GET_MAXINCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19E0BE20)
#define NODECANVAS_STATEMACHINES_FSMSTATE_GET_MAXOUTCONNECTIONS_OFFSET UNITYSDK_OFFSET(0x19E0BE30)
#define NODECANVAS_STATEMACHINES_FSMSTATE_GET_TRANSITIONEVALUATION_OFFSET UNITYSDK_OFFSET(0x19E0BE40)
#define NODECANVAS_STATEMACHINES_FSMSTATE_ONENTER_OFFSET UNITYSDK_OFFSET(0x19E0C7D0)
#define NODECANVAS_STATEMACHINES_FSMSTATE_ONEXECUTE_OFFSET UNITYSDK_OFFSET(0x19E0C1C0)
#define NODECANVAS_STATEMACHINES_FSMSTATE_ONEXIT_OFFSET UNITYSDK_OFFSET(0x19E0C7F0)
#define NODECANVAS_STATEMACHINES_FSMSTATE_ONGRAPHPAUSED_OFFSET UNITYSDK_OFFSET(0x19E0C060)
#define NODECANVAS_STATEMACHINES_FSMSTATE_ONINIT_OFFSET UNITYSDK_OFFSET(0x19E0C7C0)
#define NODECANVAS_STATEMACHINES_FSMSTATE_ONPAUSE_OFFSET UNITYSDK_OFFSET(0x19E0C800)
#define NODECANVAS_STATEMACHINES_FSMSTATE_ONRESET_OFFSET UNITYSDK_OFFSET(0x19E0C6A0)
#define NODECANVAS_STATEMACHINES_FSMSTATE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19E0C7E0)
#define NODECANVAS_STATEMACHINES_FSMSTATE_SET_TRANSITIONEVALUATION_OFFSET UNITYSDK_OFFSET(0x19E0BE50)
#define NODECANVAS_STATEMACHINES_FSMSTATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x19E0C340)
#define NODECANVAS_STATEMACHINES_FSMSTATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19E0C810)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int FSMState_TypeDefinitionIndex = 25394;
