...
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_DISABLECONDITION_OFFSET UNITYSDK_OFFSET(0x1A48A970)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_ENABLECONDITION_OFFSET UNITYSDK_OFFSET(0x1A48A910)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1A48A850)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_GET_TASK_OFFSET UNITYSDK_OFFSET(0x1A48A870)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_GET_TRANSITIONCALLMODE_OFFSET UNITYSDK_OFFSET(0x1A48A8F0)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_PERFORMTRANSITION_OFFSET UNITYSDK_OFFSET(0x1A48A9B0)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x1A48A860)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_SET_TASK_OFFSET UNITYSDK_OFFSET(0x1A48A880)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_SET_TRANSITIONCALLMODE_OFFSET UNITYSDK_OFFSET(0x1A48A900)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A48AAA0)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int FSMConnection_TypeDefinitionIndex = 26577;
