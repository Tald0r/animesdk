...
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_DISABLECONDITION_OFFSET UNITYSDK_OFFSET(0x19E9D1E0)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_ENABLECONDITION_OFFSET UNITYSDK_OFFSET(0x19E9D180)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_GET_CONDITION_OFFSET UNITYSDK_OFFSET(0x19E9D0C0)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_GET_TASK_OFFSET UNITYSDK_OFFSET(0x19E9D0E0)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_GET_TRANSITIONCALLMODE_OFFSET UNITYSDK_OFFSET(0x19E9D160)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_PERFORMTRANSITION_OFFSET UNITYSDK_OFFSET(0x19E9D220)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_SET_CONDITION_OFFSET UNITYSDK_OFFSET(0x19E9D0D0)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_SET_TASK_OFFSET UNITYSDK_OFFSET(0x19E9D0F0)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION_SET_TRANSITIONCALLMODE_OFFSET UNITYSDK_OFFSET(0x19E9D170)
#define NODECANVAS_STATEMACHINES_FSMCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19E9D310)

namespace NodeCanvas::StateMachines
{
	inline static constexpr unsigned int FSMConnection_TypeDefinitionIndex = 25718;
