...
#define NODECANVAS_ACTIONLISTPLAYER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A3F5C90)
#define NODECANVAS_ACTIONLISTPLAYER_CREATE_OFFSET UNITYSDK_OFFSET(0x1A3F5C10)
#define NODECANVAS_ACTIONLISTPLAYER_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x1A3F5E50)
#define NODECANVAS_ACTIONLISTPLAYER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A3F5E20)
#define NODECANVAS_ACTIONLISTPLAYER_GET_ACTIONLIST_OFFSET UNITYSDK_OFFSET(0x1A3F5A00)
#define NODECANVAS_ACTIONLISTPLAYER_GET_BLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1A3F5A50)
#define NODECANVAS_ACTIONLISTPLAYER_GET_ELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x1A3F5A10)
#define NODECANVAS_ACTIONLISTPLAYER_NODECANVAS_FRAMEWORK_ITASKSYSTEM_GET_AGENT_OFFSET UNITYSDK_OFFSET(0x1A3F5A40)
#define NODECANVAS_ACTIONLISTPLAYER_NODECANVAS_FRAMEWORK_ITASKSYSTEM_GET_CONTEXTOBJECT_OFFSET UNITYSDK_OFFSET(0x1A3F5A30)
#define NODECANVAS_ACTIONLISTPLAYER_NODECANVAS_FRAMEWORK_ITASKSYSTEM_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x1A3F5D50)
#define NODECANVAS_ACTIONLISTPLAYER_PLAY_1_OFFSET UNITYSDK_OFFSET(0x1A3F5DC0)
#define NODECANVAS_ACTIONLISTPLAYER_PLAY_2_OFFSET UNITYSDK_OFFSET(0x1A3F5D60)
#define NODECANVAS_ACTIONLISTPLAYER_PLAY_OFFSET UNITYSDK_OFFSET(0x1A3F5CF0)
#define NODECANVAS_ACTIONLISTPLAYER_SET_BLACKBOARD_OFFSET UNITYSDK_OFFSET(0x1A3F5A60)
#define NODECANVAS_ACTIONLISTPLAYER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3F57A0)
#define NODECANVAS_ACTIONLISTPLAYER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3F5690)
#define NODECANVAS_ACTIONLISTPLAYER_UPDATETASKSOWNER_OFFSET UNITYSDK_OFFSET(0x1A3F5AE0)
#define NODECANVAS_ACTIONLISTPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F5E80)

namespace NodeCanvas
{
	inline static constexpr unsigned int ActionListPlayer_TypeDefinitionIndex = 27261;
