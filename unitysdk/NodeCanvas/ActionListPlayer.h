...
#define NODECANVAS_ACTIONLISTPLAYER_AWAKE_OFFSET UNITYSDK_OFFSET(0x19E07400)
#define NODECANVAS_ACTIONLISTPLAYER_CREATE_OFFSET UNITYSDK_OFFSET(0x19E07380)
#define NODECANVAS_ACTIONLISTPLAYER_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x19E075C0)
#define NODECANVAS_ACTIONLISTPLAYER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19E07590)
#define NODECANVAS_ACTIONLISTPLAYER_GET_ACTIONLIST_OFFSET UNITYSDK_OFFSET(0x19E07170)
#define NODECANVAS_ACTIONLISTPLAYER_GET_BLACKBOARD_OFFSET UNITYSDK_OFFSET(0x19E071C0)
#define NODECANVAS_ACTIONLISTPLAYER_GET_ELAPSEDTIME_OFFSET UNITYSDK_OFFSET(0x19E07180)
#define NODECANVAS_ACTIONLISTPLAYER_NODECANVAS_FRAMEWORK_ITASKSYSTEM_GET_AGENT_OFFSET UNITYSDK_OFFSET(0x19E071B0)
#define NODECANVAS_ACTIONLISTPLAYER_NODECANVAS_FRAMEWORK_ITASKSYSTEM_GET_CONTEXTOBJECT_OFFSET UNITYSDK_OFFSET(0x19E071A0)
#define NODECANVAS_ACTIONLISTPLAYER_NODECANVAS_FRAMEWORK_ITASKSYSTEM_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x19E074C0)
#define NODECANVAS_ACTIONLISTPLAYER_PLAY_1_OFFSET UNITYSDK_OFFSET(0x19E07530)
#define NODECANVAS_ACTIONLISTPLAYER_PLAY_2_OFFSET UNITYSDK_OFFSET(0x19E074D0)
#define NODECANVAS_ACTIONLISTPLAYER_PLAY_OFFSET UNITYSDK_OFFSET(0x19E07460)
#define NODECANVAS_ACTIONLISTPLAYER_SET_BLACKBOARD_OFFSET UNITYSDK_OFFSET(0x19E071D0)
#define NODECANVAS_ACTIONLISTPLAYER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19E06F10)
#define NODECANVAS_ACTIONLISTPLAYER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19E06E00)
#define NODECANVAS_ACTIONLISTPLAYER_UPDATETASKSOWNER_OFFSET UNITYSDK_OFFSET(0x19E07250)
#define NODECANVAS_ACTIONLISTPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E075F0)

namespace NodeCanvas
{
	inline static constexpr unsigned int ActionListPlayer_TypeDefinitionIndex = 26606;
