...
#define STRUCT_2_6402D4A3EAB8BDC8_METHOD_2_0D3CEA11284B35A1_1_OFFSET UNITYSDK_OFFSET(0xBD80830)
#define STRUCT_2_6402D4A3EAB8BDC8_METHOD_2_0D3CEA11284B35A1_OFFSET UNITYSDK_OFFSET(0xBD80810)
#define STRUCT_2_6402D4A3EAB8BDC8_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x334FA0)
#define STRUCT_2_6402D4A3EAB8BDC8__CCTOR_OFFSET UNITYSDK_OFFSET(0xBD807D0)
#define STRUCT_2_6402D4A3EAB8BDC8__CTOR_OFFSET UNITYSDK_OFFSET(0x302300)

inline static constexpr unsigned int Struct_2_6402D4A3EAB8BDC8_TypeDefinitionIndex = 63898;

struct alignas(4) Struct_2_6402D4A3EAB8BDC8
{
	static ::Struct_2_6402D4A3EAB8BDC8* StaticGet_Field_2_1()
	{
		return (::Struct_2_6402D4A3EAB8BDC8*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_6402D4A3EAB8BDC8_TypeDefinitionIndex)->GetStaticField(0xB9D0);
	}
