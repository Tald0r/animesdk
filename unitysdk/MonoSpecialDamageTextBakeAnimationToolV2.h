...
#define MONOSPECIALDAMAGETEXTBAKEANIMATIONTOOLV2_SETCURVE_OFFSET UNITYSDK_OFFSET(0x95CCB50)
#define MONOSPECIALDAMAGETEXTBAKEANIMATIONTOOLV2__CTOR_OFFSET UNITYSDK_OFFSET(0x95CCC30)
#define MONOSPECIALDAMAGETEXTBAKEANIMATIONTOOLV2___BASE_SETCURVE_OFFSET UNITYSDK_OFFSET(0x95CCC40)

inline static constexpr unsigned int MonoSpecialDamageTextBakeAnimationToolV2_TypeDefinitionIndex = 46715;
