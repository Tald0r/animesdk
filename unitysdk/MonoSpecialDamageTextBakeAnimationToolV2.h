...
#define MONOSPECIALDAMAGETEXTBAKEANIMATIONTOOLV2_SETCURVE_OFFSET UNITYSDK_OFFSET(0xAACD120)
#define MONOSPECIALDAMAGETEXTBAKEANIMATIONTOOLV2__CTOR_OFFSET UNITYSDK_OFFSET(0xAACD200)
#define MONOSPECIALDAMAGETEXTBAKEANIMATIONTOOLV2___BASE_SETCURVE_OFFSET UNITYSDK_OFFSET(0xAACD210)

inline static constexpr unsigned int MonoSpecialDamageTextBakeAnimationToolV2_TypeDefinitionIndex = 52164;
