...
#define CINEMACHINE_CINEMACHINEIMPULSEDEFINITION_CREATEANDRETURNEVENT_OFFSET UNITYSDK_OFFSET(0x1B694AA0)
#define CINEMACHINE_CINEMACHINEIMPULSEDEFINITION_CREATEEVENT_OFFSET UNITYSDK_OFFSET(0x1B694A60)
#define CINEMACHINE_CINEMACHINEIMPULSEDEFINITION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B694A20)
#define CINEMACHINE_CINEMACHINEIMPULSEDEFINITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B694E30)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineImpulseDefinition_TypeDefinitionIndex = 32095;
