...
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_CHOOSECURRENTCAMERA_OFFSET UNITYSDK_OFFSET(0x1B321230)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_CREATEFAKEHASH_OFFSET UNITYSDK_OFFSET(0x1B322150)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x1B320A10)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GETCLIPHASH_OFFSET UNITYSDK_OFFSET(0x1B322900)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_CHILDCAMERAS_OFFSET UNITYSDK_OFFSET(0x1B322120)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1B3203F0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_FOLLOW_OFFSET UNITYSDK_OFFSET(0x1B3205C0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_ISBLENDING_OFFSET UNITYSDK_OFFSET(0x1B322140)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_LIVECHILD_OFFSET UNITYSDK_OFFSET(0x1B320540)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1B3205A0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1B320570)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_GET_TRANSITIONINGFROM_OFFSET UNITYSDK_OFFSET(0x1B321210)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_INTERNALUPDATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x1B320C30)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_INVALIDATELISTOFCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B321CB0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ISLIVECHILD_OFFSET UNITYSDK_OFFSET(0x1B320550)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_LOOKUPBLEND_OFFSET UNITYSDK_OFFSET(0x1B321850)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_LOOKUPFAKEHASH_OFFSET UNITYSDK_OFFSET(0x1B3221C0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B321CF0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B321B50)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ONGUIHANDLER_OFFSET UNITYSDK_OFFSET(0x1B321E20)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ONTARGETOBJECTWARPED_OFFSET UNITYSDK_OFFSET(0x1B3205E0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x1B321E00)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0x1B320B90)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_SET_FOLLOW_OFFSET UNITYSDK_OFFSET(0x1B3205D0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_SET_LIVECHILD_OFFSET UNITYSDK_OFFSET(0x1B320530)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_SET_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1B3205B0)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_SET_TRANSITIONINGFROM_OFFSET UNITYSDK_OFFSET(0x1B321220)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_UPDATELISTOFCHILDREN_OFFSET UNITYSDK_OFFSET(0x1B320720)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA_VALIDATEINSTRUCTIONS_OFFSET UNITYSDK_OFFSET(0x1B322490)
#define CINEMACHINE_CINEMACHINESTATEDRIVENCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3229C0)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineStateDrivenCamera_TypeDefinitionIndex = 31962;
