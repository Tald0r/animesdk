...
#define CINEMACHINE_CINEMACHINETRIGGERACTION_FILTER_OFFSET UNITYSDK_OFFSET(0x1B1C7840)
#define CINEMACHINE_CINEMACHINETRIGGERACTION_INTERNALDOTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1B1C78D0)
#define CINEMACHINE_CINEMACHINETRIGGERACTION_INTERNALDOTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1B1C7A00)
#define CINEMACHINE_CINEMACHINETRIGGERACTION_ONCOLLISIONENTER2D_OFFSET UNITYSDK_OFFSET(0x1B1C7EF0)
#define CINEMACHINE_CINEMACHINETRIGGERACTION_ONCOLLISIONENTER_OFFSET UNITYSDK_OFFSET(0x1B1C7C10)
#define CINEMACHINE_CINEMACHINETRIGGERACTION_ONCOLLISIONEXIT2D_OFFSET UNITYSDK_OFFSET(0x1B1C8030)
#define CINEMACHINE_CINEMACHINETRIGGERACTION_ONCOLLISIONEXIT_OFFSET UNITYSDK_OFFSET(0x1B1C7D50)
#define CINEMACHINE_CINEMACHINETRIGGERACTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B1C8060)
#define CINEMACHINE_CINEMACHINETRIGGERACTION_ONTRIGGERENTER2D_OFFSET UNITYSDK_OFFSET(0x1B1C7D80)
#define CINEMACHINE_CINEMACHINETRIGGERACTION_ONTRIGGERENTER_OFFSET UNITYSDK_OFFSET(0x1B1C7AA0)
#define CINEMACHINE_CINEMACHINETRIGGERACTION_ONTRIGGEREXIT2D_OFFSET UNITYSDK_OFFSET(0x1B1C7EC0)
#define CINEMACHINE_CINEMACHINETRIGGERACTION_ONTRIGGEREXIT_OFFSET UNITYSDK_OFFSET(0x1B1C7BE0)
#define CINEMACHINE_CINEMACHINETRIGGERACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C8070)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineTriggerAction_TypeDefinitionIndex = 32086;
