...
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB97340)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GETMAXDAMPTIME_OFFSET UNITYSDK_OFFSET(0x1AB97350)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_ABSTRACTFOLLOWTARGETGROUP_OFFSET UNITYSDK_OFFSET(0x1AB96440)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_ABSTRACTLOOKATTARGETGROUP_OFFSET UNITYSDK_OFFSET(0x1AB96850)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_BODYAPPLIESAFTERAIM_OFFSET UNITYSDK_OFFSET(0x1AB97310)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_FOLLOWTARGETGROUP_OFFSET UNITYSDK_OFFSET(0x1AB96590)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_FOLLOWTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB94E80)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_FOLLOWTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1AB95170)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x1AB94360)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_LOOKATTARGETGROUP_OFFSET UNITYSDK_OFFSET(0x1AB969A0)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_LOOKATTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB96A20)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_LOOKATTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1AB96D10)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x1AB96180)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_VCAMSTATE_OFFSET UNITYSDK_OFFSET(0x1AB97060)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_VIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x1AB94490)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_ONTARGETOBJECTWARPED_OFFSET UNITYSDK_OFFSET(0x1AB97330)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0x1AB97320)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_PREPIPELINEMUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x1AB97300)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_UPDATEFOLLOWTARGETCACHE_OFFSET UNITYSDK_OFFSET(0x1AB96200)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_UPDATELOOKATTARGETCACHE_OFFSET UNITYSDK_OFFSET(0x1AB96610)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB96000)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineComponentBase_TypeDefinitionIndex = 31069;
