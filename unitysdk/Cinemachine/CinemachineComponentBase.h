...
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x1B1C2640)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GETMAXDAMPTIME_OFFSET UNITYSDK_OFFSET(0x1B1C2650)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_ABSTRACTFOLLOWTARGETGROUP_OFFSET UNITYSDK_OFFSET(0x1B1C1740)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_ABSTRACTLOOKATTARGETGROUP_OFFSET UNITYSDK_OFFSET(0x1B1C1B50)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_BODYAPPLIESAFTERAIM_OFFSET UNITYSDK_OFFSET(0x1B1C2610)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_FOLLOWTARGETGROUP_OFFSET UNITYSDK_OFFSET(0x1B1C1890)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_FOLLOWTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1B1C0180)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_FOLLOWTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1B1C0470)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_FOLLOWTARGET_OFFSET UNITYSDK_OFFSET(0x1B1BF660)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_LOOKATTARGETGROUP_OFFSET UNITYSDK_OFFSET(0x1B1C1CA0)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_LOOKATTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1B1C1D20)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_LOOKATTARGETROTATION_OFFSET UNITYSDK_OFFSET(0x1B1C2010)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_LOOKATTARGET_OFFSET UNITYSDK_OFFSET(0x1B1C1480)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_VCAMSTATE_OFFSET UNITYSDK_OFFSET(0x1B1C2360)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_GET_VIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x1B1BF790)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_ONTARGETOBJECTWARPED_OFFSET UNITYSDK_OFFSET(0x1B1C2630)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0x1B1C2620)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_PREPIPELINEMUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x1B1C2600)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_UPDATEFOLLOWTARGETCACHE_OFFSET UNITYSDK_OFFSET(0x1B1C1500)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE_UPDATELOOKATTARGETCACHE_OFFSET UNITYSDK_OFFSET(0x1B1C1910)
#define CINEMACHINE_CINEMACHINECOMPONENTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C1300)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineComponentBase_TypeDefinitionIndex = 32021;
