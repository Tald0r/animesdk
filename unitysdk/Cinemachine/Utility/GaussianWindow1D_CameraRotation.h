...
#define CINEMACHINE_UTILITY_GAUSSIANWINDOW1D_CAMERAROTATION_COMPUTE_OFFSET UNITYSDK_OFFSET(0x1B5932E0)
#define CINEMACHINE_UTILITY_GAUSSIANWINDOW1D_CAMERAROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B593290)

namespace Cinemachine::Utility
{
	inline static constexpr unsigned int GaussianWindow1D_CameraRotation_TypeDefinitionIndex = 32115;
