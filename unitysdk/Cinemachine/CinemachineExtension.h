...
#define CINEMACHINE_CINEMACHINEEXTENSION_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A96F520)
#define CINEMACHINE_CINEMACHINEEXTENSION_CONNECTTOVCAM_OFFSET UNITYSDK_OFFSET(0x1A96F590)
#define CINEMACHINE_CINEMACHINEEXTENSION_ENSURESTARTED_OFFSET UNITYSDK_OFFSET(0x1A96F570)
#define CINEMACHINE_CINEMACHINEEXTENSION_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x1A96FAF0)
#define CINEMACHINE_CINEMACHINEEXTENSION_GETMAXDAMPTIME_OFFSET UNITYSDK_OFFSET(0x1A96FB10)
#define CINEMACHINE_CINEMACHINEEXTENSION_GET_VIRTUALCAMERA_OFFSET UNITYSDK_OFFSET(0x1A96F450)
#define CINEMACHINE_CINEMACHINEEXTENSION_INVOKEPOSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0x1A96FAB0)
#define CINEMACHINE_CINEMACHINEEXTENSION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A96F550)
#define CINEMACHINE_CINEMACHINEEXTENSION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A96F540)
#define CINEMACHINE_CINEMACHINEEXTENSION_ONTARGETOBJECTWARPED_OFFSET UNITYSDK_OFFSET(0x1A96FAE0)
#define CINEMACHINE_CINEMACHINEEXTENSION_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0x1A96FB00)
#define CINEMACHINE_CINEMACHINEEXTENSION_PREPIPELINEMUTATECAMERASTATECALLBACK_OFFSET UNITYSDK_OFFSET(0x1A96FAA0)
#define CINEMACHINE_CINEMACHINEEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A96FB20)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineExtension_TypeDefinitionIndex = 31078;
