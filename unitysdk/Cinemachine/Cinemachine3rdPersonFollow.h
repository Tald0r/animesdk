...
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_GETHEADING_OFFSET UNITYSDK_OFFSET(0x1B1C08B0)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_GETMAXDAMPTIME_OFFSET UNITYSDK_OFFSET(0x1B1BF6F0)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_GETRAWRIGPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1B1C0990)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_GETRIGPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1B1C0F70)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B1BF560)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_GET_STAGE_OFFSET UNITYSDK_OFFSET(0x1B1BF6E0)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_MUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x1B1BF710)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B1BF530)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B1BF4A0)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_POSITIONCAMERA_OFFSET UNITYSDK_OFFSET(0x1B1BFA10)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_RESET_OFFSET UNITYSDK_OFFSET(0x1B1BF500)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW_RESOLVECOLLISIONS_OFFSET UNITYSDK_OFFSET(0x1B1C0CE0)
#define CINEMACHINE_CINEMACHINE3RDPERSONFOLLOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C12D0)

namespace Cinemachine
{
	inline static constexpr unsigned int Cinemachine3rdPersonFollow_TypeDefinitionIndex = 31980;
