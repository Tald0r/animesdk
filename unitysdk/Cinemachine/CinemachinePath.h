...
#define CINEMACHINE_CINEMACHINEPATH_EVALUATEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1B1353A0)
#define CINEMACHINE_CINEMACHINEPATH_EVALUATEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B134D00)
#define CINEMACHINE_CINEMACHINEPATH_EVALUATETANGENT_OFFSET UNITYSDK_OFFSET(0x1B134FE0)
#define CINEMACHINE_CINEMACHINEPATH_GETBOUNDINGINDICES_OFFSET UNITYSDK_OFFSET(0x1B134B10)
#define CINEMACHINE_CINEMACHINEPATH_GET_DISTANCECACHESAMPLESTEPSPERSEGMENT_OFFSET UNITYSDK_OFFSET(0x1B134B00)
#define CINEMACHINE_CINEMACHINEPATH_GET_LOOPED_OFFSET UNITYSDK_OFFSET(0x1B1349E0)
#define CINEMACHINE_CINEMACHINEPATH_GET_MAXPOS_OFFSET UNITYSDK_OFFSET(0x1B1349A0)
#define CINEMACHINE_CINEMACHINEPATH_GET_MINPOS_OFFSET UNITYSDK_OFFSET(0x1B134990)
#define CINEMACHINE_CINEMACHINEPATH_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B135840)
#define CINEMACHINE_CINEMACHINEPATH_RESET_OFFSET UNITYSDK_OFFSET(0x1B1349F0)
#define CINEMACHINE_CINEMACHINEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B135850)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachinePath_TypeDefinitionIndex = 31956;
