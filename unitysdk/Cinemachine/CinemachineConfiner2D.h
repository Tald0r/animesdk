...
#define CINEMACHINE_CINEMACHINECONFINER2D_CALCULATEHALFFRUSTUMHEIGHT_OFFSET UNITYSDK_OFFSET(0x1B593CE0)
#define CINEMACHINE_CINEMACHINECONFINER2D_INVALIDATECACHE_OFFSET UNITYSDK_OFFSET(0x1B5934B0)
#define CINEMACHINE_CINEMACHINECONFINER2D_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B593D40)
#define CINEMACHINE_CINEMACHINECONFINER2D_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0x1B593590)
#define CINEMACHINE_CINEMACHINECONFINER2D_RESET_OFFSET UNITYSDK_OFFSET(0x1B593D60)
#define CINEMACHINE_CINEMACHINECONFINER2D_VALIDATECACHE_OFFSET UNITYSDK_OFFSET(0x1B593550)
#define CINEMACHINE_CINEMACHINECONFINER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1B593D70)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineConfiner2D_TypeDefinitionIndex = 31943;
