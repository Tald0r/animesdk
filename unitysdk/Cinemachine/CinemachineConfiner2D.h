...
#define CINEMACHINE_CINEMACHINECONFINER2D_CALCULATEHALFFRUSTUMHEIGHT_OFFSET UNITYSDK_OFFSET(0x1AF7B4D0)
#define CINEMACHINE_CINEMACHINECONFINER2D_INVALIDATECACHE_OFFSET UNITYSDK_OFFSET(0x1AF7ACA0)
#define CINEMACHINE_CINEMACHINECONFINER2D_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AF7B530)
#define CINEMACHINE_CINEMACHINECONFINER2D_POSTPIPELINESTAGECALLBACK_OFFSET UNITYSDK_OFFSET(0x1AF7AD80)
#define CINEMACHINE_CINEMACHINECONFINER2D_RESET_OFFSET UNITYSDK_OFFSET(0x1AF7B550)
#define CINEMACHINE_CINEMACHINECONFINER2D_VALIDATECACHE_OFFSET UNITYSDK_OFFSET(0x1AF7AD40)
#define CINEMACHINE_CINEMACHINECONFINER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF7B560)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineConfiner2D_TypeDefinitionIndex = 30991;
