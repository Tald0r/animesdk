...
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_CHOOSECURRENTCAMERA_OFFSET UNITYSDK_OFFSET(0x1A974F60)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_CREATEBLEND1_OFFSET UNITYSDK_OFFSET(0x1A975730)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x1A974750)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_CHILDCAMERAS_OFFSET UNITYSDK_OFFSET(0x1A975E40)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A974130)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_FOLLOW_OFFSET UNITYSDK_OFFSET(0x1A974300)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_ISBLENDING_OFFSET UNITYSDK_OFFSET(0x1A975E60)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_LIVECHILD_OFFSET UNITYSDK_OFFSET(0x1A974280)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1A9742E0)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1A9742B0)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_TRANSITIONINGFROM_OFFSET UNITYSDK_OFFSET(0x1A974F40)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_HIDELISTOFCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A976570)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_INTERNALUPDATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x1A974970)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_INVALIDATELISTOFCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A9759F0)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ISLIVECHILD_OFFSET UNITYSDK_OFFSET(0x1A974290)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_LOOKUPBLEND_OFFSET UNITYSDK_OFFSET(0x1A975430)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A975A10)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A975890)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ONGUIHANDLER_OFFSET UNITYSDK_OFFSET(0x1A975B40)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ONTARGETOBJECTWARPED_OFFSET UNITYSDK_OFFSET(0x1A974320)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x1A975B20)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0x1A9748D0)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A975E70)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_SET_FOLLOW_OFFSET UNITYSDK_OFFSET(0x1A974310)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_SET_LIVECHILD_OFFSET UNITYSDK_OFFSET(0x1A974270)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_SET_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1A9742F0)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_SET_TRANSITIONINGFROM_OFFSET UNITYSDK_OFFSET(0x1A974F50)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_UPDATELISTOFCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A974460)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_VALIDATEINSTRUCTIONS_OFFSET UNITYSDK_OFFSET(0x1A976060)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9766F0)

namespace Cinemachine
{
	inline static constexpr unsigned int NapVirtualStateDrivenCamera_TypeDefinitionIndex = 31025;
