...
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_CHOOSECURRENTCAMERA_OFFSET UNITYSDK_OFFSET(0x1AF45C80)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_CREATEBLEND1_OFFSET UNITYSDK_OFFSET(0x1AF46440)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x1AF45470)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_CHILDCAMERAS_OFFSET UNITYSDK_OFFSET(0x1AF46B50)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1AF44E50)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_FOLLOW_OFFSET UNITYSDK_OFFSET(0x1AF45020)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_ISBLENDING_OFFSET UNITYSDK_OFFSET(0x1AF46B70)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_LIVECHILD_OFFSET UNITYSDK_OFFSET(0x1AF44FA0)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1AF45000)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1AF44FD0)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_GET_TRANSITIONINGFROM_OFFSET UNITYSDK_OFFSET(0x1AF45C60)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_HIDELISTOFCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AF47280)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_INTERNALUPDATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x1AF45690)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_INVALIDATELISTOFCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AF46700)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ISLIVECHILD_OFFSET UNITYSDK_OFFSET(0x1AF44FB0)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_LOOKUPBLEND_OFFSET UNITYSDK_OFFSET(0x1AF46140)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AF46720)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AF465A0)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ONGUIHANDLER_OFFSET UNITYSDK_OFFSET(0x1AF46850)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ONTARGETOBJECTWARPED_OFFSET UNITYSDK_OFFSET(0x1AF45040)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF46830)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0x1AF455F0)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x1AF46B80)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_SET_FOLLOW_OFFSET UNITYSDK_OFFSET(0x1AF45030)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_SET_LIVECHILD_OFFSET UNITYSDK_OFFSET(0x1AF44F90)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_SET_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1AF45010)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_SET_TRANSITIONINGFROM_OFFSET UNITYSDK_OFFSET(0x1AF45C70)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_UPDATELISTOFCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AF45180)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA_VALIDATEINSTRUCTIONS_OFFSET UNITYSDK_OFFSET(0x1AF46D70)
#define CINEMACHINE_NAPVIRTUALSTATEDRIVENCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF47400)

namespace Cinemachine
{
	inline static constexpr unsigned int NapVirtualStateDrivenCamera_TypeDefinitionIndex = 31977;
