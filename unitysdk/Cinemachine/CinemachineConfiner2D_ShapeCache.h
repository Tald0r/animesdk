...
#define CINEMACHINE_CINEMACHINECONFINER2D_SHAPECACHE_CALCULATEDELTATRANSFORMATIONMATRIX_OFFSET UNITYSDK_OFFSET(0x98C070)
#define CINEMACHINE_CINEMACHINECONFINER2D_SHAPECACHE_INVALIDATE_OFFSET UNITYSDK_OFFSET(0x98BFB0)
#define CINEMACHINE_CINEMACHINECONFINER2D_SHAPECACHE_ISVALID_OFFSET UNITYSDK_OFFSET(0x98C060)
#define CINEMACHINE_CINEMACHINECONFINER2D_SHAPECACHE_VALIDATECACHE_OFFSET UNITYSDK_OFFSET(0x98C050)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineConfiner2D_ShapeCache_TypeDefinitionIndex = 31945;
