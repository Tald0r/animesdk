...
#define CINEMACHINE_CINEMACHINEORBITALTRANSPOSER_UPDATEHEADINGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A917B40)
#define CINEMACHINE_CINEMACHINEORBITALTRANSPOSER_UPDATEHEADINGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A917BC0)
#define CINEMACHINE_CINEMACHINEORBITALTRANSPOSER_UPDATEHEADINGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A9172E0)
#define CINEMACHINE_CINEMACHINEORBITALTRANSPOSER_UPDATEHEADINGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9172D0)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineOrbitalTransposer_UpdateHeadingDelegate_TypeDefinitionIndex = 31043;
