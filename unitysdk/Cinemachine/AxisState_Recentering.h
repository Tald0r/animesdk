...
#define CINEMACHINE_AXISSTATE_RECENTERING_CANCELRECENTERING_OFFSET UNITYSDK_OFFSET(0x97ADD0)
#define CINEMACHINE_AXISSTATE_RECENTERING_COPYSTATEFROM_OFFSET UNITYSDK_OFFSET(0x94D530)
#define CINEMACHINE_AXISSTATE_RECENTERING_DORECENTERING_OFFSET UNITYSDK_OFFSET(0x97AE50)
#define CINEMACHINE_AXISSTATE_RECENTERING_LEGACYUPGRADE_OFFSET UNITYSDK_OFFSET(0x94D5A0)
#define CINEMACHINE_AXISSTATE_RECENTERING_RECENTERNOW_OFFSET UNITYSDK_OFFSET(0x94D580)
#define CINEMACHINE_AXISSTATE_RECENTERING_VALIDATE_OFFSET UNITYSDK_OFFSET(0x94D520)
#define CINEMACHINE_AXISSTATE_RECENTERING__CTOR_OFFSET UNITYSDK_OFFSET(0x94D500)

namespace Cinemachine
{
	inline static constexpr unsigned int AxisState_Recentering_TypeDefinitionIndex = 31058;
