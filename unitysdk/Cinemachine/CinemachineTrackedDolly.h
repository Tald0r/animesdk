...
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY_GETCAMERAORIENTATIONATPATHPOINT_OFFSET UNITYSDK_OFFSET(0x1AF79450)
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY_GETMAXDAMPTIME_OFFSET UNITYSDK_OFFSET(0x1AF78480)
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY_GET_ANGULARDAMPING_OFFSET UNITYSDK_OFFSET(0x1AF78500)
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AF783F0)
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY_GET_STAGE_OFFSET UNITYSDK_OFFSET(0x1AF78470)
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY_MUTATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x1AF78570)
#define CINEMACHINE_CINEMACHINETRACKEDDOLLY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF79B30)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineTrackedDolly_TypeDefinitionIndex = 31048;
