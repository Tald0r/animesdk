...
#define CINEMACHINE_CONFINEROVEN_ASPECTSTRETCHER_GET_ASPECT_OFFSET UNITYSDK_OFFSET(0x2C4AF0)
#define CINEMACHINE_CONFINEROVEN_ASPECTSTRETCHER_STRETCH_OFFSET UNITYSDK_OFFSET(0x9613D0)
#define CINEMACHINE_CONFINEROVEN_ASPECTSTRETCHER_UNSTRETCH_OFFSET UNITYSDK_OFFSET(0x961400)
#define CINEMACHINE_CONFINEROVEN_ASPECTSTRETCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x9613B0)

namespace Cinemachine
{
	inline static constexpr unsigned int ConfinerOven_AspectStretcher_TypeDefinitionIndex = 31102;
