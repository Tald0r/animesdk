...
#define CINEMACHINE_CONFINEROVEN_ASPECTSTRETCHER_GET_ASPECT_OFFSET UNITYSDK_OFFSET(0x2F60A0)
#define CINEMACHINE_CONFINEROVEN_ASPECTSTRETCHER_STRETCH_OFFSET UNITYSDK_OFFSET(0x991B80)
#define CINEMACHINE_CONFINEROVEN_ASPECTSTRETCHER_UNSTRETCH_OFFSET UNITYSDK_OFFSET(0x991BB0)
#define CINEMACHINE_CONFINEROVEN_ASPECTSTRETCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x991B60)

namespace Cinemachine
{
	inline static constexpr unsigned int ConfinerOven_AspectStretcher_TypeDefinitionIndex = 32054;
