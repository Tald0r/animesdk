...
#define CINEMACHINE_CINEMACHINEFREELOOK_CREATERIGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B085E80)
#define CINEMACHINE_CINEMACHINEFREELOOK_CREATERIGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B085EC0)
#define CINEMACHINE_CINEMACHINEFREELOOK_CREATERIGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B085860)
#define CINEMACHINE_CINEMACHINEFREELOOK_CREATERIGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B085850)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineFreeLook_CreateRigDelegate_TypeDefinitionIndex = 31001;
