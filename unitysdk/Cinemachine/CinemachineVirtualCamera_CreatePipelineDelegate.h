...
#define CINEMACHINE_CINEMACHINEVIRTUALCAMERA_CREATEPIPELINEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AAEC5C0)
#define CINEMACHINE_CINEMACHINEVIRTUALCAMERA_CREATEPIPELINEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AAEC600)
#define CINEMACHINE_CINEMACHINEVIRTUALCAMERA_CREATEPIPELINEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AAEBFA0)
#define CINEMACHINE_CINEMACHINEVIRTUALCAMERA_CREATEPIPELINEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAEBF90)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineVirtualCamera_CreatePipelineDelegate_TypeDefinitionIndex = 31022;
