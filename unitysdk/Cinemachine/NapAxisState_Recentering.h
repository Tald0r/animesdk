...
#define CINEMACHINE_NAPAXISSTATE_RECENTERING_CANCELRECENTERING_OFFSET UNITYSDK_OFFSET(0x97CFA0)
#define CINEMACHINE_NAPAXISSTATE_RECENTERING_COPYSTATEFROM_OFFSET UNITYSDK_OFFSET(0x97CF70)
#define CINEMACHINE_NAPAXISSTATE_RECENTERING_DORECENTERING_OFFSET UNITYSDK_OFFSET(0x97CFD0)
#define CINEMACHINE_NAPAXISSTATE_RECENTERING_LEGACYUPGRADE_OFFSET UNITYSDK_OFFSET(0x97CFE0)
#define CINEMACHINE_NAPAXISSTATE_RECENTERING_RECENTERNOW_OFFSET UNITYSDK_OFFSET(0x97CFC0)
#define CINEMACHINE_NAPAXISSTATE_RECENTERING_VALIDATE_OFFSET UNITYSDK_OFFSET(0x97CF60)
#define CINEMACHINE_NAPAXISSTATE_RECENTERING__CTOR_OFFSET UNITYSDK_OFFSET(0x97CF40)

namespace Cinemachine
{
	inline static constexpr unsigned int NapAxisState_Recentering_TypeDefinitionIndex = 32063;
