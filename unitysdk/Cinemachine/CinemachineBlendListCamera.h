...
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_ADVANCECURRENTINSTRUCTION_OFFSET UNITYSDK_OFFSET(0x1AD261E0)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_FORCECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x1AD25890)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_GET_CHILDCAMERAS_OFFSET UNITYSDK_OFFSET(0x1AD26980)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1AD25260)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_GET_FOLLOW_OFFSET UNITYSDK_OFFSET(0x1AD25450)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_GET_ISBLENDING_OFFSET UNITYSDK_OFFSET(0x1AD269A0)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_GET_LIVECHILD_OFFSET UNITYSDK_OFFSET(0x1AD253D0)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_GET_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1AD25430)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_GET_STATE_OFFSET UNITYSDK_OFFSET(0x1AD25400)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_GET_TRANSITIONINGFROM_OFFSET UNITYSDK_OFFSET(0x1AD261C0)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_INTERNALUPDATECAMERASTATE_OFFSET UNITYSDK_OFFSET(0x1AD25B50)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_INVALIDATELISTOFCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AD26530)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_ISLIVECHILD_OFFSET UNITYSDK_OFFSET(0x1AD253E0)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AD26550)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AD263D0)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_ONGUIHANDLER_OFFSET UNITYSDK_OFFSET(0x1AD26680)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_ONTARGETOBJECTWARPED_OFFSET UNITYSDK_OFFSET(0x1AD25470)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_ONTRANSFORMCHILDRENCHANGED_OFFSET UNITYSDK_OFFSET(0x1AD26660)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_ONTRANSITIONFROMCAMERA_OFFSET UNITYSDK_OFFSET(0x1AD25A10)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_RESET_OFFSET UNITYSDK_OFFSET(0x1AD253A0)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_SET_FOLLOW_OFFSET UNITYSDK_OFFSET(0x1AD25460)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_SET_LIVECHILD_OFFSET UNITYSDK_OFFSET(0x1AD253C0)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_SET_LOOKAT_OFFSET UNITYSDK_OFFSET(0x1AD25440)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_SET_TRANSITIONINGFROM_OFFSET UNITYSDK_OFFSET(0x1AD261D0)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_UPDATELISTOFCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AD255B0)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA_VALIDATEINSTRUCTIONS_OFFSET UNITYSDK_OFFSET(0x1AD269B0)
#define CINEMACHINE_CINEMACHINEBLENDLISTCAMERA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD26C70)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineBlendListCamera_TypeDefinitionIndex = 30973;
