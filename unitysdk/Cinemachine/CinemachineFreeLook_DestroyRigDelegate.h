...
#define CINEMACHINE_CINEMACHINEFREELOOK_DESTROYRIGDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B1C5520)
#define CINEMACHINE_CINEMACHINEFREELOOK_DESTROYRIGDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B1C5550)
#define CINEMACHINE_CINEMACHINEFREELOOK_DESTROYRIGDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B1C5020)
#define CINEMACHINE_CINEMACHINEFREELOOK_DESTROYRIGDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1C5000)

namespace Cinemachine
{
	inline static constexpr unsigned int CinemachineFreeLook_DestroyRigDelegate_TypeDefinitionIndex = 31954;
