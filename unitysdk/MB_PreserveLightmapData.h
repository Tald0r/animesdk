...
#define MB_PRESERVELIGHTMAPDATA_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ABF52E0)
#define MB_PRESERVELIGHTMAPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABF54F0)

inline static constexpr unsigned int MB_PreserveLightmapData_TypeDefinitionIndex = 81214;
