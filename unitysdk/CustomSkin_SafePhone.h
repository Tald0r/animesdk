...
#define CUSTOMSKIN_SAFEPHONE_CLICKBACKBTN_OFFSET UNITYSDK_OFFSET(0x6D0C040)
#define CUSTOMSKIN_SAFEPHONE_CLICKCLOSEBTN_OFFSET UNITYSDK_OFFSET(0x6D0BFA0)
#define CUSTOMSKIN_SAFEPHONE_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0x6D0C5B0)
#define CUSTOMSKIN_SAFEPHONE_ENTERGAME_OFFSET UNITYSDK_OFFSET(0x6D0C6D0)
#define CUSTOMSKIN_SAFEPHONE_INSTANCE_OFFSET UNITYSDK_OFFSET(0x6D0AA00)
#define CUSTOMSKIN_SAFEPHONE_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x6D0AB80)
#define CUSTOMSKIN_SAFEPHONE_ONCONSOLECANCEL_OFFSET UNITYSDK_OFFSET(0x6D0C970)
#define CUSTOMSKIN_SAFEPHONE_ONPWDVALUECHANGE_OFFSET UNITYSDK_OFFSET(0x6D0C0E0)
#define CUSTOMSKIN_SAFEPHONE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6D0ADA0)
#define CUSTOMSKIN_SAFEPHONE_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0x6D0C160)
#define CUSTOMSKIN_SAFEPHONE_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x6D0C660)
#define CUSTOMSKIN_SAFEPHONE_SETACCOUNTINPUT_OFFSET UNITYSDK_OFFSET(0x6D0B6A0)
#define CUSTOMSKIN_SAFEPHONE_SETNOTICE_OFFSET UNITYSDK_OFFSET(0x6D0BD30)
#define CUSTOMSKIN_SAFEPHONE_SETPWDINPUT_OFFSET UNITYSDK_OFFSET(0x6D0B9A0)
#define CUSTOMSKIN_SAFEPHONE_SETVERIFY_OFFSET UNITYSDK_OFFSET(0x6D0BBF0)
#define CUSTOMSKIN_SAFEPHONE_SETZONETIP_OFFSET UNITYSDK_OFFSET(0x6D0B5C0)
#define CUSTOMSKIN_SAFEPHONE_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0x6D0C3B0)
#define CUSTOMSKIN_SAFEPHONE_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0x6D0BE10)
#define CUSTOMSKIN_SAFEPHONE__CTOR_OFFSET UNITYSDK_OFFSET(0x6D0AB00)
#define CUSTOMSKIN_SAFEPHONE__REQUESTVERIFYMESSAGE_B__17_0_OFFSET UNITYSDK_OFFSET(0x6D0CBB0)

inline static constexpr unsigned int CustomSkin_SafePhone_TypeDefinitionIndex = 51736;
...
public:
	...
	{
		return (::CustomSkin_SafePhone**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_SafePhone_TypeDefinitionIndex)->GetStaticField(0x331C0);
	}
