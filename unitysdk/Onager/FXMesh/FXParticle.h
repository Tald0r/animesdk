...
#define ONAGER_FXMESH_FXPARTICLE_APPLYMESH_OFFSET UNITYSDK_OFFSET(0x1B16D740)
#define ONAGER_FXMESH_FXPARTICLE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B16D730)
#define ONAGER_FXMESH_FXPARTICLE_GET_PSR_OFFSET UNITYSDK_OFFSET(0x1B16D660)
#define ONAGER_FXMESH_FXPARTICLE_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1B16D650)
#define ONAGER_FXMESH_FXPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B16D8A0)

namespace Onager::FXMesh
{
	inline static constexpr unsigned int FXParticle_TypeDefinitionIndex = 35904;
