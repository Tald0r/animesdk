...
#define ONAGER_FXMESH_FXPARTICLE_APPLYMESH_OFFSET UNITYSDK_OFFSET(0x1AB504F0)
#define ONAGER_FXMESH_FXPARTICLE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AB504E0)
#define ONAGER_FXMESH_FXPARTICLE_GET_PSR_OFFSET UNITYSDK_OFFSET(0x1AB50410)
#define ONAGER_FXMESH_FXPARTICLE_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1AB50400)
#define ONAGER_FXMESH_FXPARTICLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB50650)

namespace Onager::FXMesh
{
	inline static constexpr unsigned int FXParticle_TypeDefinitionIndex = 34902;
