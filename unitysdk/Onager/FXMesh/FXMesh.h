...
#define ONAGER_FXMESH_FXMESH_APPLYMESH_OFFSET UNITYSDK_OFFSET(0x1B16B280)
#define ONAGER_FXMESH_FXMESH_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B16C300)
#define ONAGER_FXMESH_FXMESH_GET_MFILTER_OFFSET UNITYSDK_OFFSET(0x1B16B0E0)
#define ONAGER_FXMESH_FXMESH_GET_MRENDERER_OFFSET UNITYSDK_OFFSET(0x1B16B1B0)
#define ONAGER_FXMESH_FXMESH_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1B16B0D0)
#define ONAGER_FXMESH_FXMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B16C310)

namespace Onager::FXMesh
{
	inline static constexpr unsigned int FXMesh_TypeDefinitionIndex = 35899;
