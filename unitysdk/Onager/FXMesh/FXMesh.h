...
#define ONAGER_FXMESH_FXMESH_APPLYMESH_OFFSET UNITYSDK_OFFSET(0x1AB4E030)
#define ONAGER_FXMESH_FXMESH_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AB4F0B0)
#define ONAGER_FXMESH_FXMESH_GET_MFILTER_OFFSET UNITYSDK_OFFSET(0x1AB4DE90)
#define ONAGER_FXMESH_FXMESH_GET_MRENDERER_OFFSET UNITYSDK_OFFSET(0x1AB4DF60)
#define ONAGER_FXMESH_FXMESH_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1AB4DE80)
#define ONAGER_FXMESH_FXMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB4F0C0)

namespace Onager::FXMesh
{
	inline static constexpr unsigned int FXMesh_TypeDefinitionIndex = 34897;
