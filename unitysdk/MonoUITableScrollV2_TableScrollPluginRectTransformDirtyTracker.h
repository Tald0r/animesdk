...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINRECTTRANSFORMDIRTYTRACKER_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x69BAB60)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINRECTTRANSFORMDIRTYTRACKER_ONRECTTRANSFORMDIMENSIONSCHANGE_CONTENT_OFFSET UNITYSDK_OFFSET(0x69BAF10)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINRECTTRANSFORMDIRTYTRACKER_ONRECTTRANSFORMDIMENSIONSCHANGE_VIEWRECT_OFFSET UNITYSDK_OFFSET(0x69BB140)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINRECTTRANSFORMDIRTYTRACKER_ONTRANSFORMCHILDRENCHANGED_CONTENT_OFFSET UNITYSDK_OFFSET(0x69BB410)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINRECTTRANSFORMDIRTYTRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x69BAB50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINRECTTRANSFORMDIRTYTRACKER___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x69BB540)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginRectTransformDirtyTracker_TypeDefinitionIndex = 43837;
