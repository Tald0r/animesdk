...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINRECTTRANSFORMDIRTYTRACKER_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xA146540)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINRECTTRANSFORMDIRTYTRACKER_ONRECTTRANSFORMDIMENSIONSCHANGE_CONTENT_OFFSET UNITYSDK_OFFSET(0xA1468F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINRECTTRANSFORMDIRTYTRACKER_ONRECTTRANSFORMDIMENSIONSCHANGE_VIEWRECT_OFFSET UNITYSDK_OFFSET(0xA146B20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINRECTTRANSFORMDIRTYTRACKER_ONTRANSFORMCHILDRENCHANGED_CONTENT_OFFSET UNITYSDK_OFFSET(0xA146DF0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINRECTTRANSFORMDIRTYTRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0xA146530)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINRECTTRANSFORMDIRTYTRACKER___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0xA146F20)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginRectTransformDirtyTracker_TypeDefinitionIndex = 64418;
