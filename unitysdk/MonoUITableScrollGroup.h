...
#define MONOUITABLESCROLLGROUP_ADDSCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x6452E60)
#define MONOUITABLESCROLLGROUP_GET_SCROLLVIEWLIST_OFFSET UNITYSDK_OFFSET(0x6452A30)
#define MONOUITABLESCROLLGROUP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x6452C50)
#define MONOUITABLESCROLLGROUP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x6452A40)
#define MONOUITABLESCROLLGROUP_ONSCROLL_OFFSET UNITYSDK_OFFSET(0x6453160)
#define MONOUITABLESCROLLGROUP_REMOVESCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x6452FE0)
#define MONOUITABLESCROLLGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x6453460)

inline static constexpr unsigned int MonoUITableScrollGroup_TypeDefinitionIndex = 57269;
