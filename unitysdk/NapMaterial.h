...
#define NAPMATERIAL_COLLECTMATCAPVECTORARRAYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x16F5A9C0)
#define NAPMATERIAL_GETMATERIALFROMCONTAINER_OFFSET UNITYSDK_OFFSET(0x16F59CF0)
#define NAPMATERIAL_GET_CACHEDSHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x16F59FF0)
#define NAPMATERIAL_GET_HASINSTANCEDMAT_OFFSET UNITYSDK_OFFSET(0x16F59A90)
#define NAPMATERIAL_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x16F59B00)
#define NAPMATERIAL_GET_SHAREDMATERIAL_OFFSET UNITYSDK_OFFSET(0x16F59F10)
#define NAPMATERIAL_GET_SUPPORTPEROBJECTSHADOW_OFFSET UNITYSDK_OFFSET(0x16F5A2B0)
#define NAPMATERIAL_HASFLAG_OFFSET UNITYSDK_OFFSET(0x16F5A350)
#define NAPMATERIAL_INITPROPERTY_OFFSET UNITYSDK_OFFSET(0x16F5AE10)
#define NAPMATERIAL_REBINDARRAYPROPERTYBUFFER_OFFSET UNITYSDK_OFFSET(0x16F5A590)
#define NAPMATERIAL_REFRESHMATCAPVECTORARRAYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x16F5C4D0)
#define NAPMATERIAL_REFRESHMATERIALMATCAPVECTORARRAY_OFFSET UNITYSDK_OFFSET(0x16F5B540)
#define NAPMATERIAL_REPLACEINSTANCEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x16F5A970)
#define NAPMATERIAL_RESET_OFFSET UNITYSDK_OFFSET(0x16F5A3C0)
#define NAPMATERIAL_SETFLAG_OFFSET UNITYSDK_OFFSET(0x16F5A530)
#define NAPMATERIAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x16F5D200)
#define NAPMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5D1C0)
#define NAPMATERIAL__REFRESHMATCAPVECTORARRAYPROPERTIES_G__GETFLOAT_48_0_OFFSET UNITYSDK_OFFSET(0x16F5D170)

inline static constexpr unsigned int NapMaterial_TypeDefinitionIndex = 28116;
...
public:
	...
	{
		return (::Il2CppArray<::NapMaterialProperty>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x22650);
	}
	static ::Il2CppArray<::NapMaterialProperty>** StaticGet__MatCapColorBurst()
	{
		return (::Il2CppArray<::NapMaterialProperty>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x22658);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_sampler_RefreshMatCapVectorArrayProperties()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x22660);
	}
	static ::Il2CppArray<::NapMaterialProperty>** StaticGet__MatCapAlphaBurst()
	{
		return (::Il2CppArray<::NapMaterialProperty>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x22668);
	}
	static ::Il2CppArray<::NapMaterialProperty>** StaticGet__MatCapRefract()
	{
		return (::Il2CppArray<::NapMaterialProperty>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x22670);
	}
	static ::Il2CppArray<::NapMaterialProperty>** StaticGet__MatCapUSpeed()
	{
		return (::Il2CppArray<::NapMaterialProperty>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x22678);
	}
	static ::Il2CppArray<::NapMaterialProperty>** StaticGet__MatCapTexID()
	{
		return (::Il2CppArray<::NapMaterialProperty>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x22680);
	}
	static ::Il2CppArray<::NapMaterialProperty>** StaticGet__RefractParam()
	{
		return (::Il2CppArray<::NapMaterialProperty>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x22688);
	}
	static ::System::Collections::Generic::HashSet_1<::System::Int32>** StaticGet_matcapVectorArrayProperties()
	{
		return (::System::Collections::Generic::HashSet_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x22690);
	}
	static ::Il2CppArray<::NapMaterialProperty>** StaticGet__MatCapBlendMode()
	{
		return (::Il2CppArray<::NapMaterialProperty>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x22698);
	}
	static ::Il2CppArray<::NapMaterialProperty>** StaticGet__MatCapVSpeed()
	{
		return (::Il2CppArray<::NapMaterialProperty>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x226A0);
	}
	static ::Il2CppArray<::System::ValueTuple_2<::NapMaterialProperty, ::Il2CppArray<::NapMaterialProperty>*>>** StaticGet_vectorProperties()
	{
		return (::Il2CppArray<::System::ValueTuple_2<::NapMaterialProperty, ::Il2CppArray<::NapMaterialProperty>*>>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x226A8);
	}
	...
	{
		return (::Il2CppArray<::System::ValueTuple_5<::NapMaterialProperty, ::Il2CppArray<::NapMaterialProperty>*, ::Il2CppArray<::NapMaterialProperty>*, ::Il2CppArray<::NapMaterialProperty>*, ::Il2CppArray<::NapMaterialProperty>*>>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x226B0);
	}
	static ::Il2CppArray<::NapMaterialProperty>** StaticGet__MatCapColorTint()
	{
		return (::Il2CppArray<::NapMaterialProperty>**)Il2CppClass::FromTypeDefinitionIndex(NapMaterial_TypeDefinitionIndex)->GetStaticField(0x226B8);
	}
	...
	::Il2CppArray<::UnityEngine::Vector4>* arrayValues; // 0x28
	...
	::System::Int32 usedMaterialIDCount; // 0x48
	::System::Int32 matIndex; // 0x4C
	::UnityEngine::Vector4 _RampTexParams1; // 0x50
	::NapMaterialFlags flags; // 0x60
	::System::Int32 materialIDCount; // 0x64
	::System::Single albedoSmoothness; // 0x68
