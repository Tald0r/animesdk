...
#define AKPLAYLIST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B579BE0)
#define AKPLAYLIST_ENQUEUE_1_OFFSET UNITYSDK_OFFSET(0x1B579E20)
#define AKPLAYLIST_ENQUEUE_2_OFFSET UNITYSDK_OFFSET(0x1B579ED0)
#define AKPLAYLIST_ENQUEUE_3_OFFSET UNITYSDK_OFFSET(0x1B579F70)
#define AKPLAYLIST_ENQUEUE_4_OFFSET UNITYSDK_OFFSET(0x1B57A000)
#define AKPLAYLIST_ENQUEUE_OFFSET UNITYSDK_OFFSET(0x1B579D50)
#define AKPLAYLIST_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1B579B00)
#define AKPLAYLIST_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1B579B10)
#define AKPLAYLIST__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B57A090)
#define AKPLAYLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B579A70)

inline static constexpr unsigned int AkPlaylist_TypeDefinitionIndex = 30921;
