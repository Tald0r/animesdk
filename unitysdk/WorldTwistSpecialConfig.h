...
#define WORLDTWISTSPECIALCONFIG_MESHRENDERCOLLECTION_OFFSET UNITYSDK_OFFSET(0x19B729F0)
#define WORLDTWISTSPECIALCONFIG_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19B72CD0)
#define WORLDTWISTSPECIALCONFIG_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19B72780)
#define WORLDTWISTSPECIALCONFIG_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x19B72900)
#define WORLDTWISTSPECIALCONFIG_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x19B72890)
#define WORLDTWISTSPECIALCONFIG_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x19B72D40)
#define WORLDTWISTSPECIALCONFIG_SETUPMATERIALPARAMS_OFFSET UNITYSDK_OFFSET(0x19B72B30)
#define WORLDTWISTSPECIALCONFIG_START_OFFSET UNITYSDK_OFFSET(0x19B729A0)
#define WORLDTWISTSPECIALCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19B72D90)

inline static constexpr unsigned int WorldTwistSpecialConfig_TypeDefinitionIndex = 29014;
