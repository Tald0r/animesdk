...
#define BNATIVE_UNITYDEBUG_ASSETFORMAT_OFFSET UNITYSDK_OFFSET(0xE101540)
#define BNATIVE_UNITYDEBUG_GET_DEBUGENABLED_OFFSET UNITYSDK_OFFSET(0xE100FF0)
#define BNATIVE_UNITYDEBUG_LOGERROR_OFFSET UNITYSDK_OFFSET(0xE101160)
#define BNATIVE_UNITYDEBUG_LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0xE1012A0)
#define BNATIVE_UNITYDEBUG_LOGWARNING_OFFSET UNITYSDK_OFFSET(0xE1013F0)
#define BNATIVE_UNITYDEBUG_LOG_OFFSET UNITYSDK_OFFSET(0xE101010)
#define BNATIVE_UNITYDEBUG_SET_DEBUGENABLED_OFFSET UNITYSDK_OFFSET(0xE101000)
#define BNATIVE_UNITYDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0xE100FE0)

namespace BNative
{
	inline static constexpr unsigned int UnityDebug_TypeDefinitionIndex = 70915;
