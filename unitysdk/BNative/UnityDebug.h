...
#define BNATIVE_UNITYDEBUG_ASSETFORMAT_OFFSET UNITYSDK_OFFSET(0x79AE990)
#define BNATIVE_UNITYDEBUG_GET_DEBUGENABLED_OFFSET UNITYSDK_OFFSET(0x79AE440)
#define BNATIVE_UNITYDEBUG_LOGERROR_OFFSET UNITYSDK_OFFSET(0x79AE5B0)
#define BNATIVE_UNITYDEBUG_LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x79AE6F0)
#define BNATIVE_UNITYDEBUG_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x79AE840)
#define BNATIVE_UNITYDEBUG_LOG_OFFSET UNITYSDK_OFFSET(0x79AE460)
#define BNATIVE_UNITYDEBUG_SET_DEBUGENABLED_OFFSET UNITYSDK_OFFSET(0x79AE450)
#define BNATIVE_UNITYDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x79AE430)

namespace BNative
{
	inline static constexpr unsigned int UnityDebug_TypeDefinitionIndex = 69855;
