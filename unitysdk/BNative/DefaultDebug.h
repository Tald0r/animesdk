...
#define BNATIVE_DEFAULTDEBUG_ASSETFORMAT_OFFSET UNITYSDK_OFFSET(0x73B9050)
#define BNATIVE_DEFAULTDEBUG_GET_DEBUGENABLED_OFFSET UNITYSDK_OFFSET(0x73B89F0)
#define BNATIVE_DEFAULTDEBUG_LOGERROR_OFFSET UNITYSDK_OFFSET(0x73B8BA0)
#define BNATIVE_DEFAULTDEBUG_LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x73B8D30)
#define BNATIVE_DEFAULTDEBUG_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x73B8EC0)
#define BNATIVE_DEFAULTDEBUG_LOG_OFFSET UNITYSDK_OFFSET(0x73B8A10)
#define BNATIVE_DEFAULTDEBUG_SET_DEBUGENABLED_OFFSET UNITYSDK_OFFSET(0x73B8A00)
#define BNATIVE_DEFAULTDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x73B9110)

namespace BNative
{
	inline static constexpr unsigned int DefaultDebug_TypeDefinitionIndex = 62219;
