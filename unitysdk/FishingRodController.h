...
#define FISHINGRODCONTROLLER_BLENDTO_OFFSET UNITYSDK_OFFSET(0xAA7D800)
#define FISHINGRODCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xAA7C5D0)
#define FISHINGRODCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0xAA7CA00)
#define FISHINGRODCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0xAA7C990)
#define FISHINGRODCONTROLLER_TRYINITIALIZE_OFFSET UNITYSDK_OFFSET(0xAA7C740)
#define FISHINGRODCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xAA7D890)

inline static constexpr unsigned int FishingRodController_TypeDefinitionIndex = 74004;
