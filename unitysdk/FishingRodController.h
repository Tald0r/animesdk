...
#define FISHINGRODCONTROLLER_BLENDTO_OFFSET UNITYSDK_OFFSET(0x9044FC0)
#define FISHINGRODCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x9043D90)
#define FISHINGRODCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x90441C0)
#define FISHINGRODCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x9044150)
#define FISHINGRODCONTROLLER_TRYINITIALIZE_OFFSET UNITYSDK_OFFSET(0x9043F00)
#define FISHINGRODCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9045050)

inline static constexpr unsigned int FishingRodController_TypeDefinitionIndex = 44396;
