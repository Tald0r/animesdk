...
#define STRUCT_2_32BC8A3A2B32C8F9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3B5EB0)
#define STRUCT_2_32BC8A3A2B32C8F9__CTOR_OFFSET UNITYSDK_OFFSET(0x3B5E10)

inline static constexpr unsigned int Struct_2_32BC8A3A2B32C8F9_TypeDefinitionIndex = 61339;
