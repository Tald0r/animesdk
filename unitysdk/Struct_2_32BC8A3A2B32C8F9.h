...
#define STRUCT_2_32BC8A3A2B32C8F9_DISPOSE_OFFSET UNITYSDK_OFFSET(0x34DF20)
#define STRUCT_2_32BC8A3A2B32C8F9__CTOR_OFFSET UNITYSDK_OFFSET(0x34DE80)

inline static constexpr unsigned int Struct_2_32BC8A3A2B32C8F9_TypeDefinitionIndex = 57567;
