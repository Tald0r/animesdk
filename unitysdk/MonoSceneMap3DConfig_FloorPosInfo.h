...
#define MONOSCENEMAP3DCONFIG_FLOORPOSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9A32F60)

inline static constexpr unsigned int MonoSceneMap3DConfig_FloorPosInfo_TypeDefinitionIndex = 47949;
