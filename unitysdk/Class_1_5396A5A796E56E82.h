...
#define CLASS_1_5396A5A796E56E82_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x956AD10)
#define CLASS_1_5396A5A796E56E82_FROMFLX_OFFSET UNITYSDK_OFFSET(0x956B270)
#define CLASS_1_5396A5A796E56E82_METHOD_1_0578713EDB32B89E_OFFSET UNITYSDK_OFFSET(0x956B2F0)
#define CLASS_1_5396A5A796E56E82_METHOD_1_41430AFD3BF44B19_OFFSET UNITYSDK_OFFSET(0x956AD70)
#define CLASS_1_5396A5A796E56E82__CTOR_OFFSET UNITYSDK_OFFSET(0x956C200)

inline static constexpr unsigned int Class_1_5396A5A796E56E82_TypeDefinitionIndex = 68525;

class Class_1_5396A5A796E56E82 : public ::System::Object
{
public:
	::MoleMole::Config::DynamicFloat* Field_1_8; // 0x10
	::Class_1_CE2E7DC9D5241F3C* Field_1_1; // 0x18
	::MoleMole::Config::DynamicFloat* Field_1_4; // 0x20
	::MoleMole::Config::DynamicInt* Field_1_3; // 0x28
	::MoleMole::Config::DynamicFloat* Field_1_6; // 0x30
