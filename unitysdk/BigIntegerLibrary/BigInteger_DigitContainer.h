...
#define BIGINTEGERLIBRARY_BIGINTEGER_DIGITCONTAINER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x17D0F060)
#define BIGINTEGERLIBRARY_BIGINTEGER_DIGITCONTAINER_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x17D0ED00)
#define BIGINTEGERLIBRARY_BIGINTEGER_DIGITCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x17D0ECC0)

namespace BigIntegerLibrary
{
	inline static constexpr unsigned int BigInteger_DigitContainer_TypeDefinitionIndex = 8612;
