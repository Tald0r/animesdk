...
#define UGUIMESHRENDER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1534A7E0)
#define UGUIMESHRENDER_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x153498C0)
#define UGUIMESHRENDER_GET_MESHFILTER_OFFSET UNITYSDK_OFFSET(0x1534A860)
#define UGUIMESHRENDER_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x15349B40)
#define UGUIMESHRENDER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15349CA0)
#define UGUIMESHRENDER_ONCANVASGROUPCHANGED_OFFSET UNITYSDK_OFFSET(0x15349780)
#define UGUIMESHRENDER_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x153497F0)
#define UGUIMESHRENDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x153496D0)
#define UGUIMESHRENDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x153493F0)
#define UGUIMESHRENDER_REBUILD_OFFSET UNITYSDK_OFFSET(0x1534A740)
#define UGUIMESHRENDER_SETCANVASADDITIONALCHANNELS_OFFSET UNITYSDK_OFFSET(0x15349210)
#define UGUIMESHRENDER_SET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x15349B50)
#define UGUIMESHRENDER_START_OFFSET UNITYSDK_OFFSET(0x15349360)
#define UGUIMESHRENDER_UPDATEMESH_OFFSET UNITYSDK_OFFSET(0x15349D10)
#define UGUIMESHRENDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1534A990)
#define UGUIMESHRENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1534A870)
#define UGUIMESHRENDER___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1534AA30)
#define UGUIMESHRENDER___BASE_ONCANVASGROUPCHANGED_OFFSET UNITYSDK_OFFSET(0x1534AA60)
#define UGUIMESHRENDER___BASE_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1534AA70)
#define UGUIMESHRENDER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1534AB40)
#define UGUIMESHRENDER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1534AB50)
#define UGUIMESHRENDER___BASE_REBUILD_OFFSET UNITYSDK_OFFSET(0x1534AB60)
#define UGUIMESHRENDER___BASE_START_OFFSET UNITYSDK_OFFSET(0x1534AB70)

inline static constexpr unsigned int UGUIMeshRender_TypeDefinitionIndex = 53220;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Color32>**)Il2CppClass::FromTypeDefinitionIndex(UGUIMeshRender_TypeDefinitionIndex)->GetStaticField(0x3C170);
	}
	static ::System::Collections::Generic::List_1<::UnityEngine::Vector3>** StaticGet_s_Vertices()
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(UGUIMeshRender_TypeDefinitionIndex)->GetStaticField(0x3C178);
	}
