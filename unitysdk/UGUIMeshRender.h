...
#define UGUIMESHRENDER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1817E0D0)
#define UGUIMESHRENDER_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1817D1B0)
#define UGUIMESHRENDER_GET_MESHFILTER_OFFSET UNITYSDK_OFFSET(0x1817E150)
#define UGUIMESHRENDER_GET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1817D430)
#define UGUIMESHRENDER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1817D590)
#define UGUIMESHRENDER_ONCANVASGROUPCHANGED_OFFSET UNITYSDK_OFFSET(0x1817D070)
#define UGUIMESHRENDER_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1817D0E0)
#define UGUIMESHRENDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1817CFC0)
#define UGUIMESHRENDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1817CCE0)
#define UGUIMESHRENDER_REBUILD_OFFSET UNITYSDK_OFFSET(0x1817E030)
#define UGUIMESHRENDER_SETCANVASADDITIONALCHANNELS_OFFSET UNITYSDK_OFFSET(0x1817CB00)
#define UGUIMESHRENDER_SET_TEXTURE_OFFSET UNITYSDK_OFFSET(0x1817D440)
#define UGUIMESHRENDER_START_OFFSET UNITYSDK_OFFSET(0x1817CC50)
#define UGUIMESHRENDER_UPDATEMESH_OFFSET UNITYSDK_OFFSET(0x1817D600)
#define UGUIMESHRENDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1817E280)
#define UGUIMESHRENDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1817E160)
#define UGUIMESHRENDER___BASE_GET_MAINTEXTURE_OFFSET UNITYSDK_OFFSET(0x1817E320)
#define UGUIMESHRENDER___BASE_ONCANVASGROUPCHANGED_OFFSET UNITYSDK_OFFSET(0x1817E350)
#define UGUIMESHRENDER___BASE_ONCANVASHIERARCHYCHANGED_OFFSET UNITYSDK_OFFSET(0x1817E360)
#define UGUIMESHRENDER___BASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1817E430)
#define UGUIMESHRENDER___BASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1817E440)
#define UGUIMESHRENDER___BASE_REBUILD_OFFSET UNITYSDK_OFFSET(0x1817E450)
#define UGUIMESHRENDER___BASE_START_OFFSET UNITYSDK_OFFSET(0x1817E460)

inline static constexpr unsigned int UGUIMeshRender_TypeDefinitionIndex = 37637;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Color32>**)Il2CppClass::FromTypeDefinitionIndex(UGUIMeshRender_TypeDefinitionIndex)->GetStaticField(0x39510);
	}
	static ::System::Collections::Generic::List_1<::UnityEngine::Vector3>** StaticGet_s_Vertices()
	{
		return (::System::Collections::Generic::List_1<::UnityEngine::Vector3>**)Il2CppClass::FromTypeDefinitionIndex(UGUIMeshRender_TypeDefinitionIndex)->GetStaticField(0x39518);
	}
