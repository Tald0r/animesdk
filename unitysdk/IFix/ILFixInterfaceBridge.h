...
#define IFIX_ILFIXINTERFACEBRIDGE_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x11AC7AA0)
#define IFIX_ILFIXINTERFACEBRIDGE_REFASYNCBUILDERSTARTMETHOD_OFFSET UNITYSDK_OFFSET(0x11AC8B20)
#define IFIX_ILFIXINTERFACEBRIDGE_REFAWAITUNSAFEONCOMPLETEMETHOD_OFFSET UNITYSDK_OFFSET(0x11AC89F0)
#define IFIX_ILFIXINTERFACEBRIDGE_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x11AC7BC0)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_OBJECT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x11AC8430)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x11AC8610)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x11AC8000)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x11AC8250)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x11AC7D00)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_IENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x11AC7BD0)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x11AC7EE0)
#define IFIX_ILFIXINTERFACEBRIDGE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x11AC8130)
#define IFIX_ILFIXINTERFACEBRIDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x11AC87F0)

namespace IFix
{
	inline static constexpr unsigned int ILFixInterfaceBridge_TypeDefinitionIndex = 84235;

	class ILFixInterfaceBridge : public ::IFix::Core::AnonymousStorey
	{
	public:
		::System::Int32 methodId_7; // 0x40
		::System::Int32 methodId_1; // 0x44
		::System::Int32 methodId_9; // 0x48
		::System::Int32 methodId_8; // 0x4C
		::System::Int32 methodId_4; // 0x50
		::System::Int32 methodId_0; // 0x54
		::System::Int32 methodId_3; // 0x58
