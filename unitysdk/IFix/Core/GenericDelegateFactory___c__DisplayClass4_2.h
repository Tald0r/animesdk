...
#define IFIX_CORE_GENERICDELEGATEFACTORY___C__DISPLAYCLASS4_2__CREATE_B__8_OFFSET UNITYSDK_OFFSET(0x19EAF1A0)
#define IFIX_CORE_GENERICDELEGATEFACTORY___C__DISPLAYCLASS4_2__CTOR_OFFSET UNITYSDK_OFFSET(0x19EAEE40)
