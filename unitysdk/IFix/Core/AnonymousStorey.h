...
#define IFIX_CORE_ANONYMOUSSTOREY_EQUALS_OFFSET UNITYSDK_OFFSET(0x19910840)
#define IFIX_CORE_ANONYMOUSSTOREY_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19910F00)
#define IFIX_CORE_ANONYMOUSSTOREY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19910B20)
#define IFIX_CORE_ANONYMOUSSTOREY_GET_OFFSET UNITYSDK_OFFSET(0x1990FA10)
#define IFIX_CORE_ANONYMOUSSTOREY_LDFLD_OFFSET UNITYSDK_OFFSET(0x1990F770)
#define IFIX_CORE_ANONYMOUSSTOREY_OBJECTEQUALS_OFFSET UNITYSDK_OFFSET(0x19910830)
#define IFIX_CORE_ANONYMOUSSTOREY_OBJECTGETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19910B10)
#define IFIX_CORE_ANONYMOUSSTOREY_OBJECTTOSTRING_OFFSET UNITYSDK_OFFSET(0x19910CA0)
#define IFIX_CORE_ANONYMOUSSTOREY_SET_OFFSET UNITYSDK_OFFSET(0x199104D0)
#define IFIX_CORE_ANONYMOUSSTOREY_STFLD_OFFSET UNITYSDK_OFFSET(0x1990F8D0)
#define IFIX_CORE_ANONYMOUSSTOREY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19910CE0)
#define IFIX_CORE_ANONYMOUSSTOREY__CTOR_OFFSET UNITYSDK_OFFSET(0x1990F420)

namespace IFix::Core
{
	inline static constexpr unsigned int AnonymousStorey_TypeDefinitionIndex = 6789;
