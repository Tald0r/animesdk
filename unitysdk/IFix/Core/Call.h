...
#define IFIX_CORE_CALL_BEGINFORSTACK_OFFSET UNITYSDK_OFFSET(0x19EAB2A0)
#define IFIX_CORE_CALL_BEGIN_OFFSET UNITYSDK_OFFSET(0x19EAB0A0)
#define IFIX_CORE_CALL_END_OFFSET UNITYSDK_OFFSET(0x19EABFD0)
#define IFIX_CORE_CALL_GETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x8EE790)
#define IFIX_CORE_CALL_GETBYTE_OFFSET UNITYSDK_OFFSET(0x8EE7C0)
#define IFIX_CORE_CALL_GETCHAR_OFFSET UNITYSDK_OFFSET(0x8EE850)
#define IFIX_CORE_CALL_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x8EEA00)
#define IFIX_CORE_CALL_GETINT16_OFFSET UNITYSDK_OFFSET(0x8EE850)
#define IFIX_CORE_CALL_GETINT32_OFFSET UNITYSDK_OFFSET(0x8EE8E0)
#define IFIX_CORE_CALL_GETINT64_OFFSET UNITYSDK_OFFSET(0x8EE940)
#define IFIX_CORE_CALL_GETINTPTR_OFFSET UNITYSDK_OFFSET(0x8EE940)
#define IFIX_CORE_CALL_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x8EEAA0)
#define IFIX_CORE_CALL_GETSBYTE_OFFSET UNITYSDK_OFFSET(0x8EE7C0)
#define IFIX_CORE_CALL_GETSINGLE_OFFSET UNITYSDK_OFFSET(0x8EE9A0)
#define IFIX_CORE_CALL_GETUINT16_OFFSET UNITYSDK_OFFSET(0x8EE850)
#define IFIX_CORE_CALL_GETUINT32_OFFSET UNITYSDK_OFFSET(0x8EE8E0)
#define IFIX_CORE_CALL_GETUINT64_OFFSET UNITYSDK_OFFSET(0x8EE940)
#define IFIX_CORE_CALL_GETUINTPTR_OFFSET UNITYSDK_OFFSET(0x8EEA30)
#define IFIX_CORE_CALL_PUSHBOOLEAN_OFFSET UNITYSDK_OFFSET(0x8EE760)
#define IFIX_CORE_CALL_PUSHBYTE_OFFSET UNITYSDK_OFFSET(0x8EE760)
#define IFIX_CORE_CALL_PUSHCHAR_OFFSET UNITYSDK_OFFSET(0x8EE880)
#define IFIX_CORE_CALL_PUSHDOUBLE_OFFSET UNITYSDK_OFFSET(0x8EE9D0)
#define IFIX_CORE_CALL_PUSHINT16_OFFSET UNITYSDK_OFFSET(0x8EE820)
#define IFIX_CORE_CALL_PUSHINT32_OFFSET UNITYSDK_OFFSET(0x8EE8B0)
#define IFIX_CORE_CALL_PUSHINT64_OFFSET UNITYSDK_OFFSET(0x8EE910)
#define IFIX_CORE_CALL_PUSHINTPTR_OFFSET UNITYSDK_OFFSET(0x8EE910)
#define IFIX_CORE_CALL_PUSHOBJECTASRESULT_OFFSET UNITYSDK_OFFSET(0x8EEAB0)
#define IFIX_CORE_CALL_PUSHOBJECT_OFFSET UNITYSDK_OFFSET(0x8EEA80)
#define IFIX_CORE_CALL_PUSHREF_OFFSET UNITYSDK_OFFSET(0x8EEAF0)
#define IFIX_CORE_CALL_PUSHSBYTE_OFFSET UNITYSDK_OFFSET(0x8EE7F0)
#define IFIX_CORE_CALL_PUSHSINGLE_OFFSET UNITYSDK_OFFSET(0x8EE970)
#define IFIX_CORE_CALL_PUSHUINT16_OFFSET UNITYSDK_OFFSET(0x8EE880)
#define IFIX_CORE_CALL_PUSHUINT32_OFFSET UNITYSDK_OFFSET(0x8EE8B0)
#define IFIX_CORE_CALL_PUSHUINT64_OFFSET UNITYSDK_OFFSET(0x8EE910)
#define IFIX_CORE_CALL_PUSHUINTPTR_OFFSET UNITYSDK_OFFSET(0x8EE910)
#define IFIX_CORE_CALL_PUSHVALUETYPE_OFFSET UNITYSDK_OFFSET(0x8EEA90)
#define IFIX_CORE_CALL_UPDATEREFERENCE_OFFSET UNITYSDK_OFFSET(0x8EEB30)
