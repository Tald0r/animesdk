...
#define IFIX_CORE_CALL_BEGINFORSTACK_OFFSET UNITYSDK_OFFSET(0x199112A0)
#define IFIX_CORE_CALL_BEGIN_OFFSET UNITYSDK_OFFSET(0x199110A0)
#define IFIX_CORE_CALL_END_OFFSET UNITYSDK_OFFSET(0x19911FD0)
#define IFIX_CORE_CALL_GETBOOLEAN_OFFSET UNITYSDK_OFFSET(0x8C06B0)
#define IFIX_CORE_CALL_GETBYTE_OFFSET UNITYSDK_OFFSET(0x8C06E0)
#define IFIX_CORE_CALL_GETCHAR_OFFSET UNITYSDK_OFFSET(0x8C0770)
#define IFIX_CORE_CALL_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x8C0920)
#define IFIX_CORE_CALL_GETINT16_OFFSET UNITYSDK_OFFSET(0x8C0770)
#define IFIX_CORE_CALL_GETINT32_OFFSET UNITYSDK_OFFSET(0x8C0800)
#define IFIX_CORE_CALL_GETINT64_OFFSET UNITYSDK_OFFSET(0x8C0860)
#define IFIX_CORE_CALL_GETINTPTR_OFFSET UNITYSDK_OFFSET(0x8C0860)
#define IFIX_CORE_CALL_GETOBJECT_OFFSET UNITYSDK_OFFSET(0x8C09C0)
#define IFIX_CORE_CALL_GETSBYTE_OFFSET UNITYSDK_OFFSET(0x8C06E0)
#define IFIX_CORE_CALL_GETSINGLE_OFFSET UNITYSDK_OFFSET(0x8C08C0)
#define IFIX_CORE_CALL_GETUINT16_OFFSET UNITYSDK_OFFSET(0x8C0770)
#define IFIX_CORE_CALL_GETUINT32_OFFSET UNITYSDK_OFFSET(0x8C0800)
#define IFIX_CORE_CALL_GETUINT64_OFFSET UNITYSDK_OFFSET(0x8C0860)
#define IFIX_CORE_CALL_GETUINTPTR_OFFSET UNITYSDK_OFFSET(0x8C0950)
#define IFIX_CORE_CALL_PUSHBOOLEAN_OFFSET UNITYSDK_OFFSET(0x8C0680)
#define IFIX_CORE_CALL_PUSHBYTE_OFFSET UNITYSDK_OFFSET(0x8C0680)
#define IFIX_CORE_CALL_PUSHCHAR_OFFSET UNITYSDK_OFFSET(0x8C07A0)
#define IFIX_CORE_CALL_PUSHDOUBLE_OFFSET UNITYSDK_OFFSET(0x8C08F0)
#define IFIX_CORE_CALL_PUSHINT16_OFFSET UNITYSDK_OFFSET(0x8C0740)
#define IFIX_CORE_CALL_PUSHINT32_OFFSET UNITYSDK_OFFSET(0x8C07D0)
#define IFIX_CORE_CALL_PUSHINT64_OFFSET UNITYSDK_OFFSET(0x8C0830)
#define IFIX_CORE_CALL_PUSHINTPTR_OFFSET UNITYSDK_OFFSET(0x8C0830)
#define IFIX_CORE_CALL_PUSHOBJECTASRESULT_OFFSET UNITYSDK_OFFSET(0x8C09D0)
#define IFIX_CORE_CALL_PUSHOBJECT_OFFSET UNITYSDK_OFFSET(0x8C09A0)
#define IFIX_CORE_CALL_PUSHREF_OFFSET UNITYSDK_OFFSET(0x8C0A10)
#define IFIX_CORE_CALL_PUSHSBYTE_OFFSET UNITYSDK_OFFSET(0x8C0710)
#define IFIX_CORE_CALL_PUSHSINGLE_OFFSET UNITYSDK_OFFSET(0x8C0890)
#define IFIX_CORE_CALL_PUSHUINT16_OFFSET UNITYSDK_OFFSET(0x8C07A0)
#define IFIX_CORE_CALL_PUSHUINT32_OFFSET UNITYSDK_OFFSET(0x8C07D0)
#define IFIX_CORE_CALL_PUSHUINT64_OFFSET UNITYSDK_OFFSET(0x8C0830)
#define IFIX_CORE_CALL_PUSHUINTPTR_OFFSET UNITYSDK_OFFSET(0x8C0830)
#define IFIX_CORE_CALL_PUSHVALUETYPE_OFFSET UNITYSDK_OFFSET(0x8C09B0)
#define IFIX_CORE_CALL_UPDATEREFERENCE_OFFSET UNITYSDK_OFFSET(0x8C0A50)

namespace IFix::Core
{
	inline static constexpr unsigned int Call_TypeDefinitionIndex = 6808;
