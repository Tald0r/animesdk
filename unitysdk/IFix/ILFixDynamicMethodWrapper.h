...
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x11AC7A70)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x11AC5F00)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_0_OFFSET UNITYSDK_OFFSET(0x11AC5F10)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_10_OFFSET UNITYSDK_OFFSET(0x11AC3350)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_11_OFFSET UNITYSDK_OFFSET(0x11AC60F0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_12_OFFSET UNITYSDK_OFFSET(0x11AC17B0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_13_OFFSET UNITYSDK_OFFSET(0x11AC2000)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_14_OFFSET UNITYSDK_OFFSET(0x11AC6230)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_15_OFFSET UNITYSDK_OFFSET(0x11AC63F0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_16_OFFSET UNITYSDK_OFFSET(0x11AC65F0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_17_OFFSET UNITYSDK_OFFSET(0x11AC6810)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_18_OFFSET UNITYSDK_OFFSET(0x11AC6A20)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_19_OFFSET UNITYSDK_OFFSET(0x11AC6C10)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_1_OFFSET UNITYSDK_OFFSET(0x11ABFFB0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_20_OFFSET UNITYSDK_OFFSET(0x11AC6E10)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_21_OFFSET UNITYSDK_OFFSET(0x11AC7050)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_22_OFFSET UNITYSDK_OFFSET(0x11AC7260)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_23_OFFSET UNITYSDK_OFFSET(0x11AC73B0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_24_OFFSET UNITYSDK_OFFSET(0x11AC7500)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_25_OFFSET UNITYSDK_OFFSET(0x11AC7690)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_26_OFFSET UNITYSDK_OFFSET(0x11AC77C0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_27_OFFSET UNITYSDK_OFFSET(0x11AC7920)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_2_OFFSET UNITYSDK_OFFSET(0x11ABC4D0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_3_OFFSET UNITYSDK_OFFSET(0x11AC0860)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_4_OFFSET UNITYSDK_OFFSET(0x11ABFBD0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_5_OFFSET UNITYSDK_OFFSET(0x11AC04C0)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_6_OFFSET UNITYSDK_OFFSET(0x11AC0660)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_7_OFFSET UNITYSDK_OFFSET(0x11AC0330)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_8_OFFSET UNITYSDK_OFFSET(0x11ABFD20)
#define IFIX_ILFIXDYNAMICMETHODWRAPPER__GW_9_OFFSET UNITYSDK_OFFSET(0x11AC0100)

namespace IFix
{
	inline static constexpr unsigned int ILFixDynamicMethodWrapper_TypeDefinitionIndex = 84216;
	...
	public:
		...
		{
			return (::Il2CppArray<::IFix::ILFixDynamicMethodWrapper*>**)Il2CppClass::FromTypeDefinitionIndex(ILFixDynamicMethodWrapper_TypeDefinitionIndex)->GetStaticField(0x490B0);
		}
