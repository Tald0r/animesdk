...
#define CLASS_1_CFB7A3C91FBAC44A__CTOR_1_OFFSET UNITYSDK_OFFSET(0x92CB270)
#define CLASS_1_CFB7A3C91FBAC44A__CTOR_OFFSET UNITYSDK_OFFSET(0x92CB1E0)

inline static constexpr unsigned int Class_1_CFB7A3C91FBAC44A_TypeDefinitionIndex = 53828;

class Class_1_CFB7A3C91FBAC44A : public ::System::Object
{
public:
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::Struct_2_F780BA94AF5E7E37_2>* Field_1_8; // 0x10
