...
#define CALLBACKSCOPE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1965CC90)
#define CALLBACKSCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1965CC80)

inline static constexpr unsigned int CallbackScope_TypeDefinitionIndex = 28978;
