...
#define CALLBACKSCOPE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19237EB0)
#define CALLBACKSCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x19237EA0)

inline static constexpr unsigned int CallbackScope_TypeDefinitionIndex = 28038;
