...
#define BRIGHTSPOTSFLARERESOURCES_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1762D660)
#define BRIGHTSPOTSFLARERESOURCES_ENSUREBUFFERS_OFFSET UNITYSDK_OFFSET(0x1762D520)
#define BRIGHTSPOTSFLARERESOURCES_GET_DRAWARGSBUFFER_OFFSET UNITYSDK_OFFSET(0x1762D3B0)
#define BRIGHTSPOTSFLARERESOURCES_GET_FLAREMATERIAL_OFFSET UNITYSDK_OFFSET(0x1762D3D0)
#define BRIGHTSPOTSFLARERESOURCES_GET_HASFLARE_OFFSET UNITYSDK_OFFSET(0x1762D3F0)
#define BRIGHTSPOTSFLARERESOURCES_INIT_OFFSET UNITYSDK_OFFSET(0x1762D410)
#define BRIGHTSPOTSFLARERESOURCES_RESETDRAWARGS_OFFSET UNITYSDK_OFFSET(0x1762D5C0)
#define BRIGHTSPOTSFLARERESOURCES_SETHASFLARE_OFFSET UNITYSDK_OFFSET(0x1762D4D0)
#define BRIGHTSPOTSFLARERESOURCES_SET_DRAWARGSBUFFER_OFFSET UNITYSDK_OFFSET(0x1762D3C0)
#define BRIGHTSPOTSFLARERESOURCES_SET_FLAREMATERIAL_OFFSET UNITYSDK_OFFSET(0x1762D3E0)
#define BRIGHTSPOTSFLARERESOURCES_SET_HASFLARE_OFFSET UNITYSDK_OFFSET(0x1762D400)
#define BRIGHTSPOTSFLARERESOURCES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1762D710)
#define BRIGHTSPOTSFLARERESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1762D700)

inline static constexpr unsigned int BrightSpotsFlareResources_TypeDefinitionIndex = 29085;
...
public:
	...
	{
		return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(BrightSpotsFlareResources_TypeDefinitionIndex)->GetStaticField(0x237D0);
	}
