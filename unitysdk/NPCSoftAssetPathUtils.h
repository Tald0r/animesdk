...
#define NPCSOFTASSETPATHUTILS_GET_ISNPCUNLOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x6FB2380)
#define NPCSOFTASSETPATHUTILS_SET_ISNPCUNLOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x6FB23E0)
#define NPCSOFTASSETPATHUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x6FB2440)

inline static constexpr unsigned int NPCSoftAssetPathUtils_TypeDefinitionIndex = 66013;
