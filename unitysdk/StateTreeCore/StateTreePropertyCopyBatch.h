...
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x985D30)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x985D10)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_CREATE_OFFSET UNITYSDK_OFFSET(0x1B0877B0)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x985C90)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x985C30)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x985DF0)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x985D30)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x985D10)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_RESET_OFFSET UNITYSDK_OFFSET(0x985D50)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYCOPYBATCH__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x985D30)
#define STATETREECORE_STATETREEPROPERTYCOPYBATCH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B087A40)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyCopyBatch_TypeDefinitionIndex = 27837;

	struct alignas(4) StateTreePropertyCopyBatch
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyCopyBatch_TypeDefinitionIndex)->GetStaticField(0x20E60);
		}
