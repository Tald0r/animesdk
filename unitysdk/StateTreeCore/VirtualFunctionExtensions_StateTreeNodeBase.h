...
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREENODEBASE_COMPILE_OFFSET UNITYSDK_OFFSET(0x1B0C8760)
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREENODEBASE_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1B0C8810)
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREENODEBASE_LINK_OFFSET UNITYSDK_OFFSET(0x1B0C87C0)

namespace StateTreeCore
{
	inline static constexpr unsigned int VirtualFunctionExtensions_StateTreeNodeBase_TypeDefinitionIndex = 27819;
