...
#define STATETREECORE_VIRTUALPROXY_STATETREENODEBASE_COMPILE_OFFSET UNITYSDK_OFFSET(0x1B6C42D0)
#define STATETREECORE_VIRTUALPROXY_STATETREENODEBASE_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1B6C4390)
#define STATETREECORE_VIRTUALPROXY_STATETREENODEBASE_LINK_OFFSET UNITYSDK_OFFSET(0x1B6C4330)
#define STATETREECORE_VIRTUALPROXY_STATETREENODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C4430)

namespace StateTreeCore
{
	inline static constexpr unsigned int VirtualProxy_StateTreeNodeBase_TypeDefinitionIndex = 27820;
