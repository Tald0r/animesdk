...
#define STATETREECORE_VIRTUALPROXY_STATETREETASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1B0C8880)
#define STATETREECORE_VIRTUALPROXY_STATETREETASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x1B0C88E0)
#define STATETREECORE_VIRTUALPROXY_STATETREETASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1B0C8930)
#define STATETREECORE_VIRTUALPROXY_STATETREETASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0x1B0C8980)
#define STATETREECORE_VIRTUALPROXY_STATETREETASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x1B0C89E0)
#define STATETREECORE_VIRTUALPROXY_STATETREETASKBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C8A30)

namespace StateTreeCore
{
	inline static constexpr unsigned int VirtualProxy_StateTreeTaskBase_TypeDefinitionIndex = 27884;
