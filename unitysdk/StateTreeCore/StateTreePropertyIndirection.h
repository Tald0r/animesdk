...
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9AFCC0)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9AFC90)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1B7150A0)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9AFBF0)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9AFB90)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9AFD80)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9AFCC0)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9AFC90)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_RESET_OFFSET UNITYSDK_OFFSET(0x9AFCF0)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYINDIRECTION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9AFCC0)
#define STATETREECORE_STATETREEPROPERTYINDIRECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B715350)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyIndirection_TypeDefinitionIndex = 27835;

	struct alignas(4) StateTreePropertyIndirection
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyIndirection_TypeDefinitionIndex)->GetStaticField(0x20CD0);
		}
