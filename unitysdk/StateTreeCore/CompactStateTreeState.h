...
#define STATETREECORE_COMPACTSTATETREESTATE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9AABB0)
#define STATETREECORE_COMPACTSTATETREESTATE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9AAB40)
#define STATETREECORE_COMPACTSTATETREESTATE_CREATE_OFFSET UNITYSDK_OFFSET(0x1B66E810)
#define STATETREECORE_COMPACTSTATETREESTATE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9AAA30)
#define STATETREECORE_COMPACTSTATETREESTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_COMPACTSTATETREESTATE_GET_HASCHILDREN_OFFSET UNITYSDK_OFFSET(0x9AA9C0)
#define STATETREECORE_COMPACTSTATETREESTATE_GET_NEXTSIBLING_OFFSET UNITYSDK_OFFSET(0x431820)
#define STATETREECORE_COMPACTSTATETREESTATE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9AA9D0)
#define STATETREECORE_COMPACTSTATETREESTATE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9AACD0)
#define STATETREECORE_COMPACTSTATETREESTATE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9AABB0)
#define STATETREECORE_COMPACTSTATETREESTATE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9AAB40)
#define STATETREECORE_COMPACTSTATETREESTATE_RESET_OFFSET UNITYSDK_OFFSET(0x9AAC00)
#define STATETREECORE_COMPACTSTATETREESTATE_UNREALTYPES_ISTRUCT_STATETREECORE_COMPACTSTATETREESTATE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9AABB0)
#define STATETREECORE_COMPACTSTATETREESTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B66EC70)

namespace StateTreeCore
{
	inline static constexpr unsigned int CompactStateTreeState_TypeDefinitionIndex = 27904;

	struct alignas(8) CompactStateTreeState
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(CompactStateTreeState_TypeDefinitionIndex)->GetStaticField(0x20A60);
		}
