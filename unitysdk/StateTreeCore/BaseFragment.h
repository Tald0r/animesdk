...
#define STATETREECORE_BASEFRAGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_BASEFRAGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_BASEFRAGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0x1A9C5280)
#define STATETREECORE_BASEFRAGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_BASEFRAGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_BASEFRAGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x93F910)
#define STATETREECORE_BASEFRAGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x93F970)
#define STATETREECORE_BASEFRAGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_BASEFRAGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_BASEFRAGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x2F1E90)
#define STATETREECORE_BASEFRAGMENT_UNREALTYPES_ISTRUCT_STATETREECORE_BASEFRAGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_BASEFRAGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9C53B0)

namespace StateTreeCore
{
	inline static constexpr unsigned int BaseFragment_TypeDefinitionIndex = 27808;

	struct alignas(1) BaseFragment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(BaseFragment_TypeDefinitionIndex)->GetStaticField(0x20670);
		}
