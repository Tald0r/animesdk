...
#define STATETREECORE_STATETREETASKBASE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define STATETREECORE_STATETREETASKBASE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9AF2A0)
#define STATETREECORE_STATETREETASKBASE_CREATE_OFFSET UNITYSDK_OFFSET(0x1B70FF00)
#define STATETREECORE_STATETREETASKBASE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9AF280)
#define STATETREECORE_STATETREETASKBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_STATETREETASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1B70FC50)
#define STATETREECORE_STATETREETASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x1B70FC60)
#define STATETREECORE_STATETREETASKBASE_GET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x2F2260)
#define STATETREECORE_STATETREETASKBASE_GET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x2F2360)
#define STATETREECORE_STATETREETASKBASE_GET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x2F22E0)
#define STATETREECORE_STATETREETASKBASE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x2F21E0)
#define STATETREECORE_STATETREETASKBASE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9AF220)
#define STATETREECORE_STATETREETASKBASE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9AF2F0)
#define STATETREECORE_STATETREETASKBASE_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define STATETREECORE_STATETREETASKBASE_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x9AF0D0)
#define STATETREECORE_STATETREETASKBASE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define STATETREECORE_STATETREETASKBASE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9AF2A0)
#define STATETREECORE_STATETREETASKBASE_RESET_OFFSET UNITYSDK_OFFSET(0x2F4640)
#define STATETREECORE_STATETREETASKBASE_SET_BINDINGSBATCH_OFFSET UNITYSDK_OFFSET(0x9AC740)
#define STATETREECORE_STATETREETASKBASE_SET_INSTANCEDATAHANDLE_OFFSET UNITYSDK_OFFSET(0x340820)
#define STATETREECORE_STATETREETASKBASE_SET_INSTANCETEMPLATEINDEX_OFFSET UNITYSDK_OFFSET(0x9AC750)
#define STATETREECORE_STATETREETASKBASE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x9AC730)
#define STATETREECORE_STATETREETASKBASE_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x302300)
#define STATETREECORE_STATETREETASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1B70FC70)
#define STATETREECORE_STATETREETASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0x1B70FC80)
#define STATETREECORE_STATETREETASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x1B70FC90)
#define STATETREECORE_STATETREETASKBASE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETASKBASE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x2F4600)
#define STATETREECORE_STATETREETASKBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B710300)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTaskBase_TypeDefinitionIndex = 27881;

	struct alignas(4) StateTreeTaskBase
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTaskBase_TypeDefinitionIndex)->GetStaticField(0x20410);
		}
