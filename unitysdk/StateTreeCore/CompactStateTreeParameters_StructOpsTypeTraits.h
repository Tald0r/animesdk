...
#define STATETREECORE_COMPACTSTATETREEPARAMETERS_STRUCTOPSTYPETRAITS_GET_HASALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1B7020A0)
#define STATETREECORE_COMPACTSTATETREEPARAMETERS_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7020B0)

namespace StateTreeCore
{
	inline static constexpr unsigned int CompactStateTreeParameters_StructOpsTypeTraits_TypeDefinitionIndex = 27907;
