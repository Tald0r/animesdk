...
#define STATETREECORE_STATETREEEXECUTIONSTATE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9B1390)
#define STATETREECORE_STATETREEEXECUTIONSTATE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9B1020)
#define STATETREECORE_STATETREEEXECUTIONSTATE_CREATE_OFFSET UNITYSDK_OFFSET(0x1B742850)
#define STATETREECORE_STATETREEEXECUTIONSTATE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9B1000)
#define STATETREECORE_STATETREEEXECUTIONSTATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9B1650)
#define STATETREECORE_STATETREEEXECUTIONSTATE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define STATETREECORE_STATETREEEXECUTIONSTATE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9B1680)
#define STATETREECORE_STATETREEEXECUTIONSTATE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9B1510)
#define STATETREECORE_STATETREEEXECUTIONSTATE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9B1250)
#define STATETREECORE_STATETREEEXECUTIONSTATE_RESET_OFFSET UNITYSDK_OFFSET(0x9B15C0)
#define STATETREECORE_STATETREEEXECUTIONSTATE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEEXECUTIONSTATE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9B1390)
#define STATETREECORE_STATETREEEXECUTIONSTATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B743080)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeExecutionState_TypeDefinitionIndex = 27787;

	struct alignas(8) StateTreeExecutionState
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeExecutionState_TypeDefinitionIndex)->GetStaticField(0x20E10);
		}
