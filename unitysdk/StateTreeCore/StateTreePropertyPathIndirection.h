...
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9B1BA0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9B1B60)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1B7464B0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9B1AB0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9B1C80)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9B1BA0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9B1B60)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_RESET_OFFSET UNITYSDK_OFFSET(0x9B1BD0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYPATHINDIRECTION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9B1BA0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B7467E0)
#define STATETREECORE_STATETREEPROPERTYPATHINDIRECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x9B1A10)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyPathIndirection_TypeDefinitionIndex = 27833;

	struct alignas(8) StateTreePropertyPathIndirection
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyPathIndirection_TypeDefinitionIndex)->GetStaticField(0x20F10);
		}
