...
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9B4100)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9B3E20)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_CREATE_OFFSET UNITYSDK_OFFSET(0x1B74D4E0)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9B3D50)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9B4340)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9B3CF0)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9B4370)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9B4290)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9B3F60)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_RESET_OFFSET UNITYSDK_OFFSET(0x9B42D0)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYPATHBINDING__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9B4100)
#define STATETREECORE_STATETREEPROPERTYPATHBINDING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B74DBF0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyPathBinding_TypeDefinitionIndex = 27830;

	struct alignas(8) StateTreePropertyPathBinding
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyPathBinding_TypeDefinitionIndex)->GetStaticField(0x20EF0);
		}
