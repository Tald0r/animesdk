...
#define STATETREECORE_STATETREETRANSITIONRESULT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9AEEA0)
#define STATETREECORE_STATETREETRANSITIONRESULT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9AEC80)
#define STATETREECORE_STATETREETRANSITIONRESULT_CREATE_OFFSET UNITYSDK_OFFSET(0x1B702BE0)
#define STATETREECORE_STATETREETRANSITIONRESULT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9AEB90)
#define STATETREECORE_STATETREETRANSITIONRESULT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3DD4E0)
#define STATETREECORE_STATETREETRANSITIONRESULT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define STATETREECORE_STATETREETRANSITIONRESULT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9AF040)
#define STATETREECORE_STATETREETRANSITIONRESULT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9AEF00)
#define STATETREECORE_STATETREETRANSITIONRESULT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9AEE20)
#define STATETREECORE_STATETREETRANSITIONRESULT_RESET_OFFSET UNITYSDK_OFFSET(0x9AEFB0)
#define STATETREECORE_STATETREETRANSITIONRESULT_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETRANSITIONRESULT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9AEEA0)
#define STATETREECORE_STATETREETRANSITIONRESULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B7031A0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTransitionResult_TypeDefinitionIndex = 27789;

	struct alignas(8) StateTreeTransitionResult
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTransitionResult_TypeDefinitionIndex)->GetStaticField(0x20A50);
		}
