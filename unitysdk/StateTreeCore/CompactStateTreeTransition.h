...
#define STATETREECORE_COMPACTSTATETREETRANSITION_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x986890)
#define STATETREECORE_COMPACTSTATETREETRANSITION_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x986850)
#define STATETREECORE_COMPACTSTATETREETRANSITION_CREATE_OFFSET UNITYSDK_OFFSET(0x1B0C5D60)
#define STATETREECORE_COMPACTSTATETREETRANSITION_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x986830)
#define STATETREECORE_COMPACTSTATETREETRANSITION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_GET_HASDELAY_OFFSET UNITYSDK_OFFSET(0x9867B0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9867D0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x986960)
#define STATETREECORE_COMPACTSTATETREETRANSITION_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x986890)
#define STATETREECORE_COMPACTSTATETREETRANSITION_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x986850)
#define STATETREECORE_COMPACTSTATETREETRANSITION_RESET_OFFSET UNITYSDK_OFFSET(0x9868C0)
#define STATETREECORE_COMPACTSTATETREETRANSITION_UNREALTYPES_ISTRUCT_STATETREECORE_COMPACTSTATETREETRANSITION__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x986890)
#define STATETREECORE_COMPACTSTATETREETRANSITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0C60E0)

namespace StateTreeCore
{
	inline static constexpr unsigned int CompactStateTreeTransition_TypeDefinitionIndex = 27902;

	struct alignas(4) CompactStateTreeTransition
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(CompactStateTreeTransition_TypeDefinitionIndex)->GetStaticField(0x20C60);
		}
