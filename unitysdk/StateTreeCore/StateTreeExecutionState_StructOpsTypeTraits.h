...
#define STATETREECORE_STATETREEEXECUTIONSTATE_STRUCTOPSTYPETRAITS_GET_HASALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1B6C3FA0)
#define STATETREECORE_STATETREEEXECUTIONSTATE_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C3FB0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeExecutionState_StructOpsTypeTraits_TypeDefinitionIndex = 27788;
