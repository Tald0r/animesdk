...
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9A57A0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x7C38A0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_CREATE_OFFSET UNITYSDK_OFFSET(0x1B5D1750)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9A5720)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_EQUALS_OFFSET UNITYSDK_OFFSET(0x9A5600)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9A56C0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9A5830)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9A57A0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x7C38A0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B5D1550)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B5D1620)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_RESET_OFFSET UNITYSDK_OFFSET(0x9A57C0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYPATHSEGMENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9A57A0)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5D19A0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyPathSegment_TypeDefinitionIndex = 27826;

	struct alignas(4) StateTreePropertyPathSegment
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyPathSegment_TypeDefinitionIndex)->GetStaticField(0x20C50);
		}
