...
#define STATETREECORE_STATETREEEXTERNALDATADESC_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9A6EA0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9AFA30)
#define STATETREECORE_STATETREEEXTERNALDATADESC_CREATE_OFFSET UNITYSDK_OFFSET(0x1B714C90)
#define STATETREECORE_STATETREEEXTERNALDATADESC_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9AF970)
#define STATETREECORE_STATETREEEXTERNALDATADESC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_EQUALS_OFFSET UNITYSDK_OFFSET(0x9AF840)
#define STATETREECORE_STATETREEEXTERNALDATADESC_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9AF910)
#define STATETREECORE_STATETREEEXTERNALDATADESC_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9AFB30)
#define STATETREECORE_STATETREEEXTERNALDATADESC_ISCOMPATIBLEWITH_OFFSET UNITYSDK_OFFSET(0x9AF720)
#define STATETREECORE_STATETREEEXTERNALDATADESC_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9A6EA0)
#define STATETREECORE_STATETREEEXTERNALDATADESC_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9AFA30)
#define STATETREECORE_STATETREEEXTERNALDATADESC_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B714A90)
#define STATETREECORE_STATETREEEXTERNALDATADESC_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B714B60)
#define STATETREECORE_STATETREEEXTERNALDATADESC_RESET_OFFSET UNITYSDK_OFFSET(0x9AFA60)
#define STATETREECORE_STATETREEEXTERNALDATADESC_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEEXTERNALDATADESC__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9A6EA0)
#define STATETREECORE_STATETREEEXTERNALDATADESC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B714FD0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeExternalDataDesc_TypeDefinitionIndex = 27772;

	struct alignas(4) StateTreeExternalDataDesc
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeExternalDataDesc_TypeDefinitionIndex)->GetStaticField(0x20CC0);
		}
