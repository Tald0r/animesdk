...
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_ADDTEMPORARYINSTANCE_OFFSET UNITYSDK_OFFSET(0x940430)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_APPENDINSTANCESTRUCT_OFFSET UNITYSDK_OFFSET(0x1A9D4490)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_COPYBATCHONACTIVEINSTANCES_OFFSET UNITYSDK_OFFSET(0x9404F0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_COPYBATCHWITHVALIDATION_OFFSET UNITYSDK_OFFSET(0x940520)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_DEBUGGETSTATEPATH_OFFSET UNITYSDK_OFFSET(0x940550)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x93FF20)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x940040)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x940030)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_FORMATINDENTSTRING_OFFSET UNITYSDK_OFFSET(0x1A9D6780)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETDATAVIEWORTEMPORARY_OFFSET UNITYSDK_OFFSET(0x9402D0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETDATAVIEW_1_OFFSET UNITYSDK_OFFSET(0x1A9D5D30)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETDATAVIEW_OFFSET UNITYSDK_OFFSET(0x9401A0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETSAFESTATENAME_OFFSET UNITYSDK_OFFSET(0x1A9D6630)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETSTATESTATUSSTRING_OFFSET UNITYSDK_OFFSET(0x1A9D7070)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GETSTATETREERUNSTATUS_OFFSET UNITYSDK_OFFSET(0x93FFB0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_CURRENTLYPROCESSEDFRAME_OFFSET UNITYSDK_OFFSET(0x81E460)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_CURRENTLYPROCESSEDPARENTFRAME_OFFSET UNITYSDK_OFFSET(0x93FF00)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_INSTANCEDATA_OFFSET UNITYSDK_OFFSET(0x272280)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x93FE60)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_LOGINSTANCEID_OFFSET UNITYSDK_OFFSET(0x93FE80)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_STATEPATH_OFFSET UNITYSDK_OFFSET(0x1A9D67A0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_GET_STATETREENAME_OFFSET UNITYSDK_OFFSET(0x93FE90)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_HASEVENTTOPROCESS_OFFSET UNITYSDK_OFFSET(0x940190)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_ISHANDLESOURCEVALID_OFFSET UNITYSDK_OFFSET(0x9402A0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_SETUPNEXTTRANSITION_OFFSET UNITYSDK_OFFSET(0x940080)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_STARTGLOBALTASKS_OFFSET UNITYSDK_OFFSET(0x93FFE0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_STARTTEMPORARYGLOBALTASKS_OFFSET UNITYSDK_OFFSET(0x326E70)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x940020)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_STOPGLOBALTASKS_OFFSET UNITYSDK_OFFSET(0x93FFF0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_STOPTEMPORARYGLOBALTASKS_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_TESTALLCONDITIONS_OFFSET UNITYSDK_OFFSET(0x940180)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_TICKGLOBALTASKS_OFFSET UNITYSDK_OFFSET(0x940000)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_TICKTASKS_OFFSET UNITYSDK_OFFSET(0x940010)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT_UPDATEINSTANCEDATA_OFFSET UNITYSDK_OFFSET(0x940050)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x93FF10)
#define STATETREECORE_STATETREEEXECUTIONCONTEXT__UPDATEINSTANCEDATA_G__FINDINSTANCETEMPDATA_46_0_OFFSET UNITYSDK_OFFSET(0x1A9D4280)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeExecutionContext_TypeDefinitionIndex = 27759;
