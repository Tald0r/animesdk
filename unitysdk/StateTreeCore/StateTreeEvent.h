...
#define STATETREECORE_STATETREEEVENT_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x32DE30)
#define STATETREECORE_STATETREEEVENT_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x223870)
#define STATETREECORE_STATETREEEVENT_CREATE_OFFSET UNITYSDK_OFFSET(0x1B7461E0)
#define STATETREECORE_STATETREEEVENT_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9B18F0)
#define STATETREECORE_STATETREEEVENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_STATETREEEVENT_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define STATETREECORE_STATETREEEVENT_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9B19B0)
#define STATETREECORE_STATETREEEVENT_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x32DE30)
#define STATETREECORE_STATETREEEVENT_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x223870)
#define STATETREECORE_STATETREEEVENT_RESET_OFFSET UNITYSDK_OFFSET(0x9B1950)
#define STATETREECORE_STATETREEEVENT_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEEVENT__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x32DE30)
#define STATETREECORE_STATETREEEVENT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B7463B0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeEvent_TypeDefinitionIndex = 27754;

	struct alignas(4) StateTreeEvent
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeEvent_TypeDefinitionIndex)->GetStaticField(0x20F00);
		}
