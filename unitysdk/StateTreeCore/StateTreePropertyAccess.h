...
#define STATETREECORE_STATETREEPROPERTYACCESS_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9AEAC0)
#define STATETREECORE_STATETREEPROPERTYACCESS_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9AEA90)
#define STATETREECORE_STATETREEPROPERTYACCESS_CREATE_OFFSET UNITYSDK_OFFSET(0x1B702840)
#define STATETREECORE_STATETREEPROPERTYACCESS_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9AEA70)
#define STATETREECORE_STATETREEPROPERTYACCESS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_STATETREEPROPERTYACCESS_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9AEA10)
#define STATETREECORE_STATETREEPROPERTYACCESS_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9AEB30)
#define STATETREECORE_STATETREEPROPERTYACCESS_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9AEAC0)
#define STATETREECORE_STATETREEPROPERTYACCESS_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9AEA90)
#define STATETREECORE_STATETREEPROPERTYACCESS_RESET_OFFSET UNITYSDK_OFFSET(0x9AEAF0)
#define STATETREECORE_STATETREEPROPERTYACCESS_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYACCESS__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9AEAC0)
#define STATETREECORE_STATETREEPROPERTYACCESS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B702B40)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyAccess_TypeDefinitionIndex = 27842;

	struct alignas(4) StateTreePropertyAccess
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyAccess_TypeDefinitionIndex)->GetStaticField(0x20A40);
		}
