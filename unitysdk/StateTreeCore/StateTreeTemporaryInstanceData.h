...
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9AAF60)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9AAD50)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_CREATE_OFFSET UNITYSDK_OFFSET(0x1B670090)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9AAD30)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9AB090)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9AB0B0)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9AAFA0)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9AAEC0)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_RESET_OFFSET UNITYSDK_OFFSET(0x9AAFE0)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREETEMPORARYINSTANCEDATA__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9AAF60)
#define STATETREECORE_STATETREETEMPORARYINSTANCEDATA__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B670610)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeTemporaryInstanceData_TypeDefinitionIndex = 27801;

	struct alignas(8) StateTreeTemporaryInstanceData
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeTemporaryInstanceData_TypeDefinitionIndex)->GetStaticField(0x20B10);
		}
