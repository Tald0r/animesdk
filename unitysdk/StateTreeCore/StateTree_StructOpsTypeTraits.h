...
#define STATETREECORE_STATETREE_STRUCTOPSTYPETRAITS_GET_HASALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1B7027C0)
#define STATETREECORE_STATETREE_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7027D0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTree_StructOpsTypeTraits_TypeDefinitionIndex = 27745;
