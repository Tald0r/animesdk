...
#define STATETREECORE_STATETREEPROPERTYCOPY_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9A1C90)
#define STATETREECORE_STATETREEPROPERTYCOPY_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9A1C40)
#define STATETREECORE_STATETREEPROPERTYCOPY_CREATE_OFFSET UNITYSDK_OFFSET(0x1B5AE670)
#define STATETREECORE_STATETREEPROPERTYCOPY_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9A1C20)
#define STATETREECORE_STATETREEPROPERTYCOPY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_STATETREEPROPERTYCOPY_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9A1BC0)
#define STATETREECORE_STATETREEPROPERTYCOPY_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9A1D20)
#define STATETREECORE_STATETREEPROPERTYCOPY_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9A1C90)
#define STATETREECORE_STATETREEPROPERTYCOPY_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9A1C40)
#define STATETREECORE_STATETREEPROPERTYCOPY_RESET_OFFSET UNITYSDK_OFFSET(0x9A1CD0)
#define STATETREECORE_STATETREEPROPERTYCOPY_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYCOPY__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9A1C90)
#define STATETREECORE_STATETREEPROPERTYCOPY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5AEA20)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyCopy_TypeDefinitionIndex = 27840;

	struct alignas(4) StateTreePropertyCopy
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyCopy_TypeDefinitionIndex)->GetStaticField(0x20DC0);
		}
