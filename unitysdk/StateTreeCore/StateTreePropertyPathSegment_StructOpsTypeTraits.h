...
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x1B743240)
#define STATETREECORE_STATETREEPROPERTYPATHSEGMENT_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B743250)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyPathSegment_StructOpsTypeTraits_TypeDefinitionIndex = 27827;
