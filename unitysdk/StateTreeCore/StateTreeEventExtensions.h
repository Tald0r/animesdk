...
#define STATETREECORE_STATETREEEVENTEXTENSIONS_GETTAG_OFFSET UNITYSDK_OFFSET(0x19BD8D70)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeEventExtensions_TypeDefinitionIndex = 26922;
