...
#define STATETREECORE_STATETREESTATEHANDLE_STRUCTOPSTYPETRAITS_GET_ISPLAINOLDDATA_OFFSET UNITYSDK_OFFSET(0x1B60BC00)
#define STATETREECORE_STATETREESTATEHANDLE_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B60BC10)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeStateHandle_StructOpsTypeTraits_TypeDefinitionIndex = 27895;
