...
#define STATETREECORE_STATETREEPROPERTYREFPATH_STRUCTOPSTYPETRAITS_GET_HASALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1B746850)
#define STATETREECORE_STATETREEPROPERTYREFPATH_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B746860)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyRefPath_StructOpsTypeTraits_TypeDefinitionIndex = 27846;
