...
#define STATETREECORE_STATETREENODEBASE_COMPILE_OFFSET UNITYSDK_OFFSET(0x1B4731A0)
#define STATETREECORE_STATETREENODEBASE_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9993A0)
#define STATETREECORE_STATETREENODEBASE_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x999370)
#define STATETREECORE_STATETREENODEBASE_CREATE_OFFSET UNITYSDK_OFFSET(0x1B4733F0)
#define STATETREECORE_STATETREENODEBASE_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x999350)
#define STATETREECORE_STATETREENODEBASE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_STATETREENODEBASE_GETINSTANCEDATATYPE_OFFSET UNITYSDK_OFFSET(0x1B4731C0)
#define STATETREECORE_STATETREENODEBASE_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9992F0)
#define STATETREECORE_STATETREENODEBASE_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x999440)
#define STATETREECORE_STATETREENODEBASE_GET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define STATETREECORE_STATETREENODEBASE_GET_VIRTUALPROXY_OFFSET UNITYSDK_OFFSET(0x9991A0)
#define STATETREECORE_STATETREENODEBASE_LINK_OFFSET UNITYSDK_OFFSET(0x1B4731B0)
#define STATETREECORE_STATETREENODEBASE_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9993A0)
#define STATETREECORE_STATETREENODEBASE_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x999370)
#define STATETREECORE_STATETREENODEBASE_RESET_OFFSET UNITYSDK_OFFSET(0x9993D0)
#define STATETREECORE_STATETREENODEBASE_SET_TYPEINFO_OFFSET UNITYSDK_OFFSET(0x302300)
#define STATETREECORE_STATETREENODEBASE_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREENODEBASE__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9993A0)
#define STATETREECORE_STATETREENODEBASE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B473780)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeNodeBase_TypeDefinitionIndex = 27817;

	struct alignas(4) StateTreeNodeBase
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeNodeBase_TypeDefinitionIndex)->GetStaticField(0x20640);
		}
