...
#define STATETREECORE_STATETREEINSTANCEDATA_STRUCTOPSTYPETRAITS_GET_HASALLOCATOR_OFFSET UNITYSDK_OFFSET(0x1B0C69E0)
#define STATETREECORE_STATETREEINSTANCEDATA_STRUCTOPSTYPETRAITS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C69F0)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeInstanceData_StructOpsTypeTraits_TypeDefinitionIndex = 27804;
