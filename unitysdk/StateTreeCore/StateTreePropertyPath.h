...
#define STATETREECORE_STATETREEPROPERTYPATH_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x7F25E0)
#define STATETREECORE_STATETREEPROPERTYPATH_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x7F2490)
#define STATETREECORE_STATETREEPROPERTYPATH_CREATE_OFFSET UNITYSDK_OFFSET(0x1B0C8280)
#define STATETREECORE_STATETREEPROPERTYPATH_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x986CD0)
#define STATETREECORE_STATETREEPROPERTYPATH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7F2800)
#define STATETREECORE_STATETREEPROPERTYPATH_EQUALS_OFFSET UNITYSDK_OFFSET(0x986BA0)
#define STATETREECORE_STATETREEPROPERTYPATH_FROMSTRING_OFFSET UNITYSDK_OFFSET(0x986B90)
#define STATETREECORE_STATETREEPROPERTYPATH_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x986B80)
#define STATETREECORE_STATETREEPROPERTYPATH_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x986C70)
#define STATETREECORE_STATETREEPROPERTYPATH_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x986D70)
#define STATETREECORE_STATETREEPROPERTYPATH_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x986D50)
#define STATETREECORE_STATETREEPROPERTYPATH_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x7F2510)
#define STATETREECORE_STATETREEPROPERTYPATH_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B0C70F0)
#define STATETREECORE_STATETREEPROPERTYPATH_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B0C7130)
#define STATETREECORE_STATETREEPROPERTYPATH_RESET_OFFSET UNITYSDK_OFFSET(0x986D60)
#define STATETREECORE_STATETREEPROPERTYPATH_RESOLVEINDIRECTIONSWITHVALUE_OFFSET UNITYSDK_OFFSET(0x986C20)
#define STATETREECORE_STATETREEPROPERTYPATH_RESOLVEINDIRECTIONS_OFFSET UNITYSDK_OFFSET(0x986BE0)
#define STATETREECORE_STATETREEPROPERTYPATH_TOSTRING_OFFSET UNITYSDK_OFFSET(0x986BD0)
#define STATETREECORE_STATETREEPROPERTYPATH_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYPATH__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x7F25E0)
#define STATETREECORE_STATETREEPROPERTYPATH_UPDATESEGMENTSFROMVALUE_OFFSET UNITYSDK_OFFSET(0x986C50)
#define STATETREECORE_STATETREEPROPERTYPATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0C8630)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyPath_TypeDefinitionIndex = 27828;

	struct alignas(8) StateTreePropertyPath
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyPath_TypeDefinitionIndex)->GetStaticField(0x20C90);
		}
