...
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREETASKBASE_ENTERSTATE_OFFSET UNITYSDK_OFFSET(0x1B088410)
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREETASKBASE_EXITSTATE_OFFSET UNITYSDK_OFFSET(0x1B0884A0)
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREETASKBASE_STATECOMPLETED_OFFSET UNITYSDK_OFFSET(0x1B088530)
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREETASKBASE_TICK_OFFSET UNITYSDK_OFFSET(0x1B0885C0)
#define STATETREECORE_VIRTUALFUNCTIONEXTENSIONS_STATETREETASKBASE_TRIGGERTRANSITIONS_OFFSET UNITYSDK_OFFSET(0x1B088650)

namespace StateTreeCore
{
	inline static constexpr unsigned int VirtualFunctionExtensions_StateTreeTaskBase_TypeDefinitionIndex = 27883;
