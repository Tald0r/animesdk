...
#define STATETREECORE_STATETREEPROPERTYREFPATH_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9860E0)
#define STATETREECORE_STATETREEPROPERTYREFPATH_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x985F60)
#define STATETREECORE_STATETREEPROPERTYREFPATH_CREATE_OFFSET UNITYSDK_OFFSET(0x1B087B00)
#define STATETREECORE_STATETREEPROPERTYREFPATH_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x985EB0)
#define STATETREECORE_STATETREEPROPERTYREFPATH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7F2800)
#define STATETREECORE_STATETREEPROPERTYREFPATH_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x985E50)
#define STATETREECORE_STATETREEPROPERTYREFPATH_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x986260)
#define STATETREECORE_STATETREEPROPERTYREFPATH_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9861C0)
#define STATETREECORE_STATETREEPROPERTYREFPATH_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x986000)
#define STATETREECORE_STATETREEPROPERTYREFPATH_RESET_OFFSET UNITYSDK_OFFSET(0x9861F0)
#define STATETREECORE_STATETREEPROPERTYREFPATH_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEPROPERTYREFPATH__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9860E0)
#define STATETREECORE_STATETREEPROPERTYREFPATH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B087F90)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreePropertyRefPath_TypeDefinitionIndex = 27845;

	struct alignas(8) StateTreePropertyRefPath
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreePropertyRefPath_TypeDefinitionIndex)->GetStaticField(0x20E70);
		}
