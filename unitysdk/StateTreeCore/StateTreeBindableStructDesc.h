...
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9A6EA0)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_COPYCREATE_OFFSET UNITYSDK_OFFSET(0x9A6E70)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_CREATE_OFFSET UNITYSDK_OFFSET(0x1B60B850)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_DEFAULTCREATE_OFFSET UNITYSDK_OFFSET(0x9A6DC0)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x37DF50)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_GET_STATICSTRUCT_OFFSET UNITYSDK_OFFSET(0x9A6D60)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_GET_STRUCTOPSTRAITS_OFFSET UNITYSDK_OFFSET(0x9A6F70)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_MOVEASSIGN_OFFSET UNITYSDK_OFFSET(0x9A6EA0)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_MOVECREATE_OFFSET UNITYSDK_OFFSET(0x9A6E70)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_RESET_OFFSET UNITYSDK_OFFSET(0x9A6ED0)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9A6D50)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC_UNREALTYPES_ISTRUCT_STATETREECORE_STATETREEBINDABLESTRUCTDESC__COPYASSIGN_OFFSET UNITYSDK_OFFSET(0x9A6EA0)
#define STATETREECORE_STATETREEBINDABLESTRUCTDESC__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B60BB50)

namespace StateTreeCore
{
	inline static constexpr unsigned int StateTreeBindableStructDesc_TypeDefinitionIndex = 27824;

	struct alignas(4) StateTreeBindableStructDesc
	{
		static ::UnrealTypes::StructOpsTraitsBase** StaticGet_StaticStructOpsTraits()
		{
			return (::UnrealTypes::StructOpsTraitsBase**)Il2CppClass::FromTypeDefinitionIndex(StateTreeBindableStructDesc_TypeDefinitionIndex)->GetStaticField(0x20EE0);
		}
