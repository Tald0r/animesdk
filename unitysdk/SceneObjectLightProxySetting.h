...
#define SCENEOBJECTLIGHTPROXYSETTING__CTOR_OFFSET UNITYSDK_OFFSET(0x1815E7F0)

inline static constexpr unsigned int SceneObjectLightProxySetting_TypeDefinitionIndex = 73701;
