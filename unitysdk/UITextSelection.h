...
#define UITEXTSELECTION_AWAKE_OFFSET UNITYSDK_OFFSET(0x1388F830)
#define UITEXTSELECTION_CHECKSTATE_OFFSET UNITYSDK_OFFSET(0x13890B90)
#define UITEXTSELECTION_CHECKTEXTCHANGE_OFFSET UNITYSDK_OFFSET(0x13890060)
#define UITEXTSELECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x1388F930)
#define UITEXTSELECTION_COLLECTALLCHANGETEXT_OFFSET UNITYSDK_OFFSET(0x13890770)
#define UITEXTSELECTION_COLLECTALLTEXT_OFFSET UNITYSDK_OFFSET(0x13890440)
#define UITEXTSELECTION_GETSIMPLETEXT_OFFSET UNITYSDK_OFFSET(0x13890AA0)
#define UITEXTSELECTION_SETTEXTRAWTEXT_OFFSET UNITYSDK_OFFSET(0x1388FF20)
#define UITEXTSELECTION_START_OFFSET UNITYSDK_OFFSET(0x138901E0)
#define UITEXTSELECTION_UPDATECHANGETEXT_OFFSET UNITYSDK_OFFSET(0x138908E0)
#define UITEXTSELECTION_UPDATERAWTEXT_OFFSET UNITYSDK_OFFSET(0x138905C0)
#define UITEXTSELECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x13890240)
#define UITEXTSELECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x13890D50)
#define UITEXTSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x13890BF0)

inline static constexpr unsigned int UITextSelection_TypeDefinitionIndex = 42499;
...
public:
	...
	{
		return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(UITextSelection_TypeDefinitionIndex)->GetStaticField(0x44340);
	}
