...
#define UITEXTSELECTION_AWAKE_OFFSET UNITYSDK_OFFSET(0x191A12C0)
#define UITEXTSELECTION_CHECKSTATE_OFFSET UNITYSDK_OFFSET(0x191A2620)
#define UITEXTSELECTION_CHECKTEXTCHANGE_OFFSET UNITYSDK_OFFSET(0x191A1AF0)
#define UITEXTSELECTION_CLEAR_OFFSET UNITYSDK_OFFSET(0x191A13C0)
#define UITEXTSELECTION_COLLECTALLCHANGETEXT_OFFSET UNITYSDK_OFFSET(0x191A2200)
#define UITEXTSELECTION_COLLECTALLTEXT_OFFSET UNITYSDK_OFFSET(0x191A1ED0)
#define UITEXTSELECTION_GETSIMPLETEXT_OFFSET UNITYSDK_OFFSET(0x191A2530)
#define UITEXTSELECTION_SETTEXTRAWTEXT_OFFSET UNITYSDK_OFFSET(0x191A19B0)
#define UITEXTSELECTION_START_OFFSET UNITYSDK_OFFSET(0x191A1C70)
#define UITEXTSELECTION_UPDATECHANGETEXT_OFFSET UNITYSDK_OFFSET(0x191A2370)
#define UITEXTSELECTION_UPDATERAWTEXT_OFFSET UNITYSDK_OFFSET(0x191A2050)
#define UITEXTSELECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x191A1CD0)
#define UITEXTSELECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x191A27E0)
#define UITEXTSELECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x191A2680)

inline static constexpr unsigned int UITextSelection_TypeDefinitionIndex = 75896;
...
public:
	...
	{
		return (::System::Text::RegularExpressions::Regex**)Il2CppClass::FromTypeDefinitionIndex(UITextSelection_TypeDefinitionIndex)->GetStaticField(0x455A0);
	}
