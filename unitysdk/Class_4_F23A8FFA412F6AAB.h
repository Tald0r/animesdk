...
#define CLASS_4_F23A8FFA412F6AAB_METHOD_4_33E2FA8E6403B93D_OFFSET UNITYSDK_OFFSET(0x759BCC0)
#define CLASS_4_F23A8FFA412F6AAB_METHOD_4_484A5E36F1DEDF51_OFFSET UNITYSDK_OFFSET(0x759BB70)
#define CLASS_4_F23A8FFA412F6AAB_METHOD_4_4962F047950FECC1_OFFSET UNITYSDK_OFFSET(0x759C060)
#define CLASS_4_F23A8FFA412F6AAB_METHOD_4_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x759C000)
#define CLASS_4_F23A8FFA412F6AAB__CTOR_OFFSET UNITYSDK_OFFSET(0x759BFB0)

inline static constexpr unsigned int Class_4_F23A8FFA412F6AAB_TypeDefinitionIndex = 37674;

class Class_4_F23A8FFA412F6AAB : public ::Class_3_E6E2CD5B8103BD02
{
public:
	::MoleMole::UIHollowMainPageController* Field_4_0; // 0x40
	::MoleMole::Config::ConfigChessboardPlayStartPerform* Field_4_1; // 0x48
