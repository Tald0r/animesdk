...
#define MONOUIPAINTING_DOENDDRAW_OFFSET UNITYSDK_OFFSET(0x93AB180)
#define MONOUIPAINTING_DOPROCESSDRAW_OFFSET UNITYSDK_OFFSET(0x93AAF40)
#define MONOUIPAINTING_DOSTARTDRAW_OFFSET UNITYSDK_OFFSET(0x93AB0F0)
#define MONOUIPAINTING_DRAWBYGAMEPADJOYSTICK_OFFSET UNITYSDK_OFFSET(0x93AA860)
#define MONOUIPAINTING_DRAW_OFFSET UNITYSDK_OFFSET(0x93AB3E0)
#define MONOUIPAINTING_FILLRENDERTEXTUREWITHBG_OFFSET UNITYSDK_OFFSET(0x93AA420)
#define MONOUIPAINTING_FULLPROGRESS_OFFSET UNITYSDK_OFFSET(0x93A94A0)
#define MONOUIPAINTING_GET_MESH_OFFSET UNITYSDK_OFFSET(0x93A97B0)
#define MONOUIPAINTING_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x93A9490)
#define MONOUIPAINTING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x93AA370)
#define MONOUIPAINTING_ONDRAG_OFFSET UNITYSDK_OFFSET(0x93ABD90)
#define MONOUIPAINTING_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x93AB1F0)
#define MONOUIPAINTING_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x93ABF20)
#define MONOUIPAINTING_REFRESHRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x93AA660)
#define MONOUIPAINTING_RESETIMAGE_OFFSET UNITYSDK_OFFSET(0x93AA200)
#define MONOUIPAINTING_SETUP_OFFSET UNITYSDK_OFFSET(0x93A9C40)
#define MONOUIPAINTING_START_OFFSET UNITYSDK_OFFSET(0x93A9BC0)
#define MONOUIPAINTING__CCTOR_OFFSET UNITYSDK_OFFSET(0x93AC050)
#define MONOUIPAINTING__CTOR_OFFSET UNITYSDK_OFFSET(0x93ABFE0)

inline static constexpr unsigned int MonoUIPainting_TypeDefinitionIndex = 49775;
...
public:
	...
	{
		return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(MonoUIPainting_TypeDefinitionIndex)->GetStaticField(0x3DA50);
	}
	static ::System::Int32* StaticGet__ScaleOffset()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoUIPainting_TypeDefinitionIndex)->GetStaticField(0xF3F0);
	}
	static ::System::Int32* StaticGet__MainTex()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoUIPainting_TypeDefinitionIndex)->GetStaticField(0xF3F4);
	}
