...
#define MONOUIPAINTING_DOENDDRAW_OFFSET UNITYSDK_OFFSET(0x955A050)
#define MONOUIPAINTING_DOPROCESSDRAW_OFFSET UNITYSDK_OFFSET(0x9559E10)
#define MONOUIPAINTING_DOSTARTDRAW_OFFSET UNITYSDK_OFFSET(0x9559FC0)
#define MONOUIPAINTING_DRAWBYGAMEPADJOYSTICK_OFFSET UNITYSDK_OFFSET(0x9559730)
#define MONOUIPAINTING_DRAW_OFFSET UNITYSDK_OFFSET(0x955A2B0)
#define MONOUIPAINTING_FILLRENDERTEXTUREWITHBG_OFFSET UNITYSDK_OFFSET(0x95592F0)
#define MONOUIPAINTING_FULLPROGRESS_OFFSET UNITYSDK_OFFSET(0x9558370)
#define MONOUIPAINTING_GET_MESH_OFFSET UNITYSDK_OFFSET(0x9558680)
#define MONOUIPAINTING_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x9558360)
#define MONOUIPAINTING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9559240)
#define MONOUIPAINTING_ONDRAG_OFFSET UNITYSDK_OFFSET(0x955AC60)
#define MONOUIPAINTING_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x955A0C0)
#define MONOUIPAINTING_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x955ADF0)
#define MONOUIPAINTING_REFRESHRENDERTEXTURE_OFFSET UNITYSDK_OFFSET(0x9559530)
#define MONOUIPAINTING_RESETIMAGE_OFFSET UNITYSDK_OFFSET(0x95590D0)
#define MONOUIPAINTING_SETUP_OFFSET UNITYSDK_OFFSET(0x9558B10)
#define MONOUIPAINTING_START_OFFSET UNITYSDK_OFFSET(0x9558A90)
#define MONOUIPAINTING__CCTOR_OFFSET UNITYSDK_OFFSET(0x955AF20)
#define MONOUIPAINTING__CTOR_OFFSET UNITYSDK_OFFSET(0x955AEB0)

inline static constexpr unsigned int MonoUIPainting_TypeDefinitionIndex = 63309;
...
public:
	...
	{
		return (::UnityEngine::Mesh**)Il2CppClass::FromTypeDefinitionIndex(MonoUIPainting_TypeDefinitionIndex)->GetStaticField(0x409A0);
	}
	static ::System::Int32* StaticGet__ScaleOffset()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoUIPainting_TypeDefinitionIndex)->GetStaticField(0xF8F0);
	}
	static ::System::Int32* StaticGet__MainTex()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(MonoUIPainting_TypeDefinitionIndex)->GetStaticField(0xF8F4);
	}
