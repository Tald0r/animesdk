...
#define MONOUITABLESCROLLV2_PARAMSTRING_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x6060EA0)
#define MONOUITABLESCROLLV2_PARAMSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x6060DE0)
#define MONOUITABLESCROLLV2_PARAMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x6060E80)

inline static constexpr unsigned int MonoUITableScrollV2_ParamString_TypeDefinitionIndex = 43779;
