...
#define MONOUITABLESCROLLV2_PARAMSTRING_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x7BF6090)
#define MONOUITABLESCROLLV2_PARAMSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x7BF5FD0)
#define MONOUITABLESCROLLV2_PARAMSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x7BF6070)

inline static constexpr unsigned int MonoUITableScrollV2_ParamString_TypeDefinitionIndex = 64387;
