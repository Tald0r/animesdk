...
#define MS_INTERNAL_XML_XPATH_FILTER_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x1A5A6910)
#define MS_INTERNAL_XML_XPATH_FILTER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A5A6900)
#define MS_INTERNAL_XML_XPATH_FILTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5A68F0)
