...
#define MS_INTERNAL_XML_XPATH_OPERATOR_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x190FF1C0)
#define MS_INTERNAL_XML_XPATH_OPERATOR_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x190FF1B0)
#define MS_INTERNAL_XML_XPATH_OPERATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x190FF1E0)
#define MS_INTERNAL_XML_XPATH_OPERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x190FF1A0)
