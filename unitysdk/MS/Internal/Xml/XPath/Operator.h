...
#define MS_INTERNAL_XML_XPATH_OPERATOR_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x19472650)
#define MS_INTERNAL_XML_XPATH_OPERATOR_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19472640)
#define MS_INTERNAL_XML_XPATH_OPERATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x19472670)
#define MS_INTERNAL_XML_XPATH_OPERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19472630)
...
namespace MS::Internal::Xml::XPath
{
	...
	public:
		...
		::MS::Internal::Xml::XPath::AstNode* opnd2; // 0x10
		::MS::Internal::Xml::XPath::AstNode* opnd1; // 0x18
