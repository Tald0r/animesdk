...
#define MS_INTERNAL_XML_XPATH_OPERAND_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x19A33A00)
#define MS_INTERNAL_XML_XPATH_OPERAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19A339F0)
#define MS_INTERNAL_XML_XPATH_OPERAND__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A339C0)
#define MS_INTERNAL_XML_XPATH_OPERAND__CTOR_OFFSET UNITYSDK_OFFSET(0x19A339B0)
