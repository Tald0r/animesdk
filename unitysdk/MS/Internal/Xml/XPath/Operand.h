...
#define MS_INTERNAL_XML_XPATH_OPERAND_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x19591D30)
#define MS_INTERNAL_XML_XPATH_OPERAND_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19591D20)
#define MS_INTERNAL_XML_XPATH_OPERAND__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19591CF0)
#define MS_INTERNAL_XML_XPATH_OPERAND__CTOR_OFFSET UNITYSDK_OFFSET(0x19591CE0)
