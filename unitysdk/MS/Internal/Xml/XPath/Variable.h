...
#define MS_INTERNAL_XML_XPATH_VARIABLE_GET_RETURNTYPE_OFFSET UNITYSDK_OFFSET(0x194533A0)
#define MS_INTERNAL_XML_XPATH_VARIABLE_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19453390)
#define MS_INTERNAL_XML_XPATH_VARIABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19453380)
