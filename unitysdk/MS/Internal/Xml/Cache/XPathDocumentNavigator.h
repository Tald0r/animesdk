...
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_CLONE_OFFSET UNITYSDK_OFFSET(0x19471CE0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GETPOSITIONHASHCODE_OFFSET UNITYSDK_OFFSET(0x19472620)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x19472470)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x19472530)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x19471DD0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x19471E20)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x19471EC0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x19471D90)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x19471E70)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_UNDERLYINGOBJECT_OFFSET UNITYSDK_OFFSET(0x194723C0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19471A70)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_ISSAMEPOSITION_OFFSET UNITYSDK_OFFSET(0x19472350)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_MOVETOFIRSTNAMESPACE_OFFSET UNITYSDK_OFFSET(0x19471F20)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_MOVETONEXTNAMESPACE_OFFSET UNITYSDK_OFFSET(0x19472090)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_MOVETOPARENT_OFFSET UNITYSDK_OFFSET(0x194722C0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x194719F0)
