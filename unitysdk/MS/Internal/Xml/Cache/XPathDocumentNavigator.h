...
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_CLONE_OFFSET UNITYSDK_OFFSET(0x190FE850)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GETPOSITIONHASHCODE_OFFSET UNITYSDK_OFFSET(0x190FF190)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_LINENUMBER_OFFSET UNITYSDK_OFFSET(0x190FEFE0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_LINEPOSITION_OFFSET UNITYSDK_OFFSET(0x190FF0A0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_LOCALNAME_OFFSET UNITYSDK_OFFSET(0x190FE940)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_NAMESPACEURI_OFFSET UNITYSDK_OFFSET(0x190FE990)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_NAMETABLE_OFFSET UNITYSDK_OFFSET(0x190FEA30)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_NODETYPE_OFFSET UNITYSDK_OFFSET(0x190FE900)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_PREFIX_OFFSET UNITYSDK_OFFSET(0x190FE9E0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_UNDERLYINGOBJECT_OFFSET UNITYSDK_OFFSET(0x190FEF30)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x190FE5E0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_ISSAMEPOSITION_OFFSET UNITYSDK_OFFSET(0x190FEEC0)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_MOVETOFIRSTNAMESPACE_OFFSET UNITYSDK_OFFSET(0x190FEA90)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_MOVETONEXTNAMESPACE_OFFSET UNITYSDK_OFFSET(0x190FEC00)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR_MOVETOPARENT_OFFSET UNITYSDK_OFFSET(0x190FEE30)
#define MS_INTERNAL_XML_CACHE_XPATHDOCUMENTNAVIGATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x190FE560)
