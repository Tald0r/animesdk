...
#define MONOUIANIMCELL_APPLYDRIVENTRANSFORMPROPERTIES_OFFSET UNITYSDK_OFFSET(0xF0CAA60)
#define MONOUIANIMCELL_CLEARDRIVENTRANSFORMPROPERTIES_OFFSET UNITYSDK_OFFSET(0xF0CA9F0)
#define MONOUIANIMCELL_GET_K_OFFSET UNITYSDK_OFFSET(0xF0CA850)
#define MONOUIANIMCELL_ONCHANGEINNER_OFFSET UNITYSDK_OFFSET(0xF0CAB10)
#define MONOUIANIMCELL_ONCHANGE_OFFSET UNITYSDK_OFFSET(0xF0CA870)
#define MONOUIANIMCELL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xF0CB2F0)
#define MONOUIANIMCELL_ONRESETINNER_OFFSET UNITYSDK_OFFSET(0xF0CB0D0)
#define MONOUIANIMCELL_ONRESET_OFFSET UNITYSDK_OFFSET(0xF0CB000)
#define MONOUIANIMCELL_PREUPDATE_OFFSET UNITYSDK_OFFSET(0xF0CAF50)
#define MONOUIANIMCELL_SET_K_OFFSET UNITYSDK_OFFSET(0xF0CA860)
#define MONOUIANIMCELL__CTOR_OFFSET UNITYSDK_OFFSET(0xF0CB350)

inline static constexpr unsigned int MonoUIAnimCell_TypeDefinitionIndex = 50246;
