...
#define MONOUIANIMCELL_APPLYDRIVENTRANSFORMPROPERTIES_OFFSET UNITYSDK_OFFSET(0xEA424F0)
#define MONOUIANIMCELL_CLEARDRIVENTRANSFORMPROPERTIES_OFFSET UNITYSDK_OFFSET(0xEA42480)
#define MONOUIANIMCELL_GET_K_OFFSET UNITYSDK_OFFSET(0xEA422E0)
#define MONOUIANIMCELL_ONCHANGEINNER_OFFSET UNITYSDK_OFFSET(0xEA425A0)
#define MONOUIANIMCELL_ONCHANGE_OFFSET UNITYSDK_OFFSET(0xEA42300)
#define MONOUIANIMCELL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xEA42D80)
#define MONOUIANIMCELL_ONRESETINNER_OFFSET UNITYSDK_OFFSET(0xEA42B60)
#define MONOUIANIMCELL_ONRESET_OFFSET UNITYSDK_OFFSET(0xEA42A90)
#define MONOUIANIMCELL_PREUPDATE_OFFSET UNITYSDK_OFFSET(0xEA429E0)
#define MONOUIANIMCELL_SET_K_OFFSET UNITYSDK_OFFSET(0xEA422F0)
#define MONOUIANIMCELL__CTOR_OFFSET UNITYSDK_OFFSET(0xEA42DE0)

inline static constexpr unsigned int MonoUIAnimCell_TypeDefinitionIndex = 65345;
