...
#define ENVIRONMENTCONFIGV2_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0x17B60290)
#define ENVIRONMENTCONFIGV2_READFROMVOLUME_OFFSET UNITYSDK_OFFSET(0x17B601E0)
#define ENVIRONMENTCONFIGV2_WRITETOVOLUME_OFFSET UNITYSDK_OFFSET(0x17B60450)
#define ENVIRONMENTCONFIGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x17B601A0)

inline static constexpr unsigned int EnvironmentConfigV2_TypeDefinitionIndex = 28001;
