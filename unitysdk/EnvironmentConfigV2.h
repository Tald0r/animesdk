...
#define ENVIRONMENTCONFIGV2_DEEPCLONE_OFFSET UNITYSDK_OFFSET(0x177F68D0)
#define ENVIRONMENTCONFIGV2_READFROMVOLUME_OFFSET UNITYSDK_OFFSET(0x177F6820)
#define ENVIRONMENTCONFIGV2_WRITETOVOLUME_OFFSET UNITYSDK_OFFSET(0x177F6A80)
#define ENVIRONMENTCONFIGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x177F67E0)

inline static constexpr unsigned int EnvironmentConfigV2_TypeDefinitionIndex = 28941;
