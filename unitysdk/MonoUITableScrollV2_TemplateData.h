...
#define MONOUITABLESCROLLV2_TEMPLATEDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x65D9020)
#define MONOUITABLESCROLLV2_TEMPLATEDATA_CREATESCROLLVIEWITEMBYINDEX_OFFSET UNITYSDK_OFFSET(0x65D87E0)
#define MONOUITABLESCROLLV2_TEMPLATEDATA_CREATESCROLLVIEWITEM_OFFSET UNITYSDK_OFFSET(0x65D8470)
#define MONOUITABLESCROLLV2_TEMPLATEDATA_FLUSHALLTEMPRECYCLEITEMTORECYCLE_OFFSET UNITYSDK_OFFSET(0x65D8E70)
#define MONOUITABLESCROLLV2_TEMPLATEDATA_GETTEMPLATECELLSIZE_OFFSET UNITYSDK_OFFSET(0x65D83A0)
#define MONOUITABLESCROLLV2_TEMPLATEDATA_RECYCLE_OFFSET UNITYSDK_OFFSET(0x65D89C0)
#define MONOUITABLESCROLLV2_TEMPLATEDATA_SETTEMPLATECELL_OFFSET UNITYSDK_OFFSET(0x65D8330)
#define MONOUITABLESCROLLV2_TEMPLATEDATA_TEMPRECYCLE_OFFSET UNITYSDK_OFFSET(0x65D8CD0)
#define MONOUITABLESCROLLV2_TEMPLATEDATA__CREATESCROLLVIEWITEM_B__18_0_OFFSET UNITYSDK_OFFSET(0x65D9090)
#define MONOUITABLESCROLLV2_TEMPLATEDATA__CREATESCROLLVIEWITEM_B__18_1_OFFSET UNITYSDK_OFFSET(0x65D9100)
#define MONOUITABLESCROLLV2_TEMPLATEDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x65D8120)
#define MONOUITABLESCROLLV2_TEMPLATEDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x65D81A0)
#define MONOUITABLESCROLLV2_TEMPLATEDATA__CTOR_3_OFFSET UNITYSDK_OFFSET(0x65D8230)
#define MONOUITABLESCROLLV2_TEMPLATEDATA__CTOR_4_OFFSET UNITYSDK_OFFSET(0x65D82B0)
#define MONOUITABLESCROLLV2_TEMPLATEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x65D80A0)

inline static constexpr unsigned int MonoUITableScrollV2_TemplateData_TypeDefinitionIndex = 43886;

class MonoUITableScrollV2_TemplateData : public ::System::Object
{
public:
	::System::Collections::Generic::Stack_1<::MoleMole::ScrollViewItemWidgetController*>* _tempFreeList; // 0x10
	::System::Func_2<::System::Int32, ::MoleMole::ScrollViewItemWidgetController*>* _createFuncByIndex; // 0x18
	::System::Func_3<::Enum_3_B90C1A15EA6E3C2B, ::System::Func_1<::MoleMole::UIControlReference*>*, ::MoleMole::ScrollViewItemWidgetController*>* _createFunc; // 0x20
	::System::Func_2<::System::Func_1<::MoleMole::UIControlReference*>*, ::MoleMole::ScrollViewItemWidgetController*>* _easyCreateFunc; // 0x28
	::System::Func_2<::Struct_2_575273D27F02957E, ::MoleMole::ScrollViewItemWidgetController*>* _binderCreateFunc; // 0x30
	::System::Collections::Generic::Stack_1<::MoleMole::ScrollViewItemWidgetController*>* _freeList; // 0x38
	::MoleMole::UIControlReference* _templateCell; // 0x40
	::Struct_2_575273D27F02957E _binderInfo; // 0x48
	::System::Boolean _userBinder; // 0x58
	::System::Nullable_1<::UnityEngine::Vector2> _cellSize; // 0x5C
	::Enum_3_B90C1A15EA6E3C2B _ctrlId; // 0x68

	::System::Void _ctor(::MoleMole::UIControlReference* templateCell, ::Enum_3_B90C1A15EA6E3C2B ctrlId, ::System::Func_3<::Enum_3_B90C1A15EA6E3C2B, ::System::Func_1<::MoleMole::UIControlReference*>*, ::MoleMole::ScrollViewItemWidgetController*>* createFunc)
	{
		return ((::System::Void(*)(::PVOID, ::MoleMole::UIControlReference*, ::Enum_3_B90C1A15EA6E3C2B, ::System::Func_3<::Enum_3_B90C1A15EA6E3C2B, ::System::Func_1<::MoleMole::UIControlReference*>*, ::MoleMole::ScrollViewItemWidgetController*>*))((::PBYTE)hIl2Cpp + MONOUITABLESCROLLV2_TEMPLATEDATA__CTOR_OFFSET))(this, templateCell, ctrlId, createFunc);
	}
