...
#define TASKTREETEST__START_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x784520)
#define TASKTREETEST__START_D__1_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2C7C30)

inline static constexpr unsigned int TaskTreeTest__Start_d__1_TypeDefinitionIndex = 78728;

struct alignas(8) TaskTreeTest__Start_d__1
{
	::System::Runtime::CompilerServices::AsyncVoidMethodBuilder __t__builder; // 0x10
	::TaskTreeTest* __4__this; // 0x30
