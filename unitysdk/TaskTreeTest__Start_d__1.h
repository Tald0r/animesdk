...
#define TASKTREETEST__START_D__1_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9529A0)
#define TASKTREETEST__START_D__1_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x308FB0)

inline static constexpr unsigned int TaskTreeTest__Start_d__1_TypeDefinitionIndex = 63226;
