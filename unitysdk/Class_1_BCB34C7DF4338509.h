...
#define CLASS_1_BCB34C7DF4338509_METHOD_1_0B5F7BD0B5A8D2DF_OFFSET UNITYSDK_OFFSET(0x681BB60)
#define CLASS_1_BCB34C7DF4338509_METHOD_1_6A0EBEECA245A27C_OFFSET UNITYSDK_OFFSET(0x67F9800)
#define CLASS_1_BCB34C7DF4338509_METHOD_1_810DD818C57F797D_OFFSET UNITYSDK_OFFSET(0x681BE50)
#define CLASS_1_BCB34C7DF4338509__CTOR_OFFSET UNITYSDK_OFFSET(0x681BAD0)

inline static constexpr unsigned int Class_1_BCB34C7DF4338509_TypeDefinitionIndex = 36817;

class Class_1_BCB34C7DF4338509 : public ::System::Object
{
public:
	::MoleMole::UIBaseController* Field_1_2; // 0x10
	::System::Collections::Generic::List_1<::MoleMole::UIGeneralConsoleBaseBtnWidgetController*>* Field_1_0; // 0x18
