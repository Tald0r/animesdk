...
#define MOTIONBLURPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xA0A46F0)
#define MOTIONBLURPROXY_COPYVALUEFROM_OFFSET UNITYSDK_OFFSET(0xA0A4A60)
#define MOTIONBLURPROXY_SETVALUETO_OFFSET UNITYSDK_OFFSET(0xA0A4BF0)
#define MOTIONBLURPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xA0A4B80)
#define MOTIONBLURPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xA0A4D30)

inline static constexpr unsigned int MotionBlurProxy_TypeDefinitionIndex = 61208;
