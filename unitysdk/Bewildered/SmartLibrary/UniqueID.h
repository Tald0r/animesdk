...
#define BEWILDERED_SMARTLIBRARY_UNIQUEID_EQUALS_OFFSET UNITYSDK_OFFSET(0x987E30)
#define BEWILDERED_SMARTLIBRARY_UNIQUEID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8A1550)
#define BEWILDERED_SMARTLIBRARY_UNIQUEID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8A1540)
#define BEWILDERED_SMARTLIBRARY_UNIQUEID_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x987EC0)
#define BEWILDERED_SMARTLIBRARY_UNIQUEID_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x987E40)
#define BEWILDERED_SMARTLIBRARY_UNIQUEID__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B152FB0)

namespace Bewildered::SmartLibrary
{
	inline static constexpr unsigned int UniqueID_TypeDefinitionIndex = 81138;

	struct alignas(8) UniqueID
	{
		static ::Bewildered::SmartLibrary::UniqueID* StaticGet_Empty()
		{
			return (::Bewildered::SmartLibrary::UniqueID*)Il2CppClass::FromTypeDefinitionIndex(UniqueID_TypeDefinitionIndex)->GetStaticField(0x46660);
		}
