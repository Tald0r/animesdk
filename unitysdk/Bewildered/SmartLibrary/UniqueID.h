...
#define BEWILDERED_SMARTLIBRARY_UNIQUEID_EQUALS_OFFSET UNITYSDK_OFFSET(0x9BDEC0)
#define BEWILDERED_SMARTLIBRARY_UNIQUEID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8CC5F0)
#define BEWILDERED_SMARTLIBRARY_UNIQUEID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8CC5E0)
#define BEWILDERED_SMARTLIBRARY_UNIQUEID_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9BDF50)
#define BEWILDERED_SMARTLIBRARY_UNIQUEID_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9BDED0)
#define BEWILDERED_SMARTLIBRARY_UNIQUEID__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B771E80)

namespace Bewildered::SmartLibrary
{
	inline static constexpr unsigned int UniqueID_TypeDefinitionIndex = 83179;

	struct alignas(8) UniqueID
	{
		static ::Bewildered::SmartLibrary::UniqueID* StaticGet_Empty()
		{
			return (::Bewildered::SmartLibrary::UniqueID*)Il2CppClass::FromTypeDefinitionIndex(UniqueID_TypeDefinitionIndex)->GetStaticField(0x48070);
		}
