...
#define DUNGEONMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0xA218240)
#define DUNGEONMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0xA218830)

inline static constexpr unsigned int DungeonManager_TypeDefinitionIndex = 74431;
