...
#define MONOUPDATEMODEBASE_GETDELTATIME_OFFSET UNITYSDK_OFFSET(0x65D9220)
#define MONOUPDATEMODEBASE_GET__ACCURACYCOUNT_OFFSET UNITYSDK_OFFSET(0x65D9170)
#define MONOUPDATEMODEBASE_TRYCALCULATESTEPTIME_OFFSET UNITYSDK_OFFSET(0x65D9180)
#define MONOUPDATEMODEBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x65D93D0)
#define MONOUPDATEMODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x65D9440)

inline static constexpr unsigned int MonoUpdateModeBase_TypeDefinitionIndex = 66245;
