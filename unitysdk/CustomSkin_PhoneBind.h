...
#define CUSTOMSKIN_PHONEBIND_BIND_OFFSET UNITYSDK_OFFSET(0xBD9C700)
#define CUSTOMSKIN_PHONEBIND_CLICKCLOSEBTN_OFFSET UNITYSDK_OFFSET(0xBD9BE40)
#define CUSTOMSKIN_PHONEBIND_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0xBD9C5E0)
#define CUSTOMSKIN_PHONEBIND_INSTANCE_OFFSET UNITYSDK_OFFSET(0xBD9AC00)
#define CUSTOMSKIN_PHONEBIND_ONCLOSE_OFFSET UNITYSDK_OFFSET(0xBD9AD80)
#define CUSTOMSKIN_PHONEBIND_ONCONSOLECANCEL_OFFSET UNITYSDK_OFFSET(0xBD9C9A0)
#define CUSTOMSKIN_PHONEBIND_ONPHONEALUECHANGE_OFFSET UNITYSDK_OFFSET(0xBD9BEE0)
#define CUSTOMSKIN_PHONEBIND_ONSHOW_OFFSET UNITYSDK_OFFSET(0xBD9AFA0)
#define CUSTOMSKIN_PHONEBIND_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0xBD9C180)
#define CUSTOMSKIN_PHONEBIND_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0xBD9C690)
#define CUSTOMSKIN_PHONEBIND_SETACCOUNTINPUT_OFFSET UNITYSDK_OFFSET(0xBD9B730)
#define CUSTOMSKIN_PHONEBIND_SETNOTICE_OFFSET UNITYSDK_OFFSET(0xBD9BD60)
#define CUSTOMSKIN_PHONEBIND_SETPWDINPUT_OFFSET UNITYSDK_OFFSET(0xBD9BA30)
#define CUSTOMSKIN_PHONEBIND_SETREGISTER_OFFSET UNITYSDK_OFFSET(0xBD9BC80)
#define CUSTOMSKIN_PHONEBIND_SETZONETIP_OFFSET UNITYSDK_OFFSET(0xBD9B650)
#define CUSTOMSKIN_PHONEBIND_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0xBD9C3D0)
#define CUSTOMSKIN_PHONEBIND_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0xBD9BF60)
#define CUSTOMSKIN_PHONEBIND__CTOR_OFFSET UNITYSDK_OFFSET(0xBD9AD00)
#define CUSTOMSKIN_PHONEBIND__REQUESTVERIFYMESSAGE_B__16_0_OFFSET UNITYSDK_OFFSET(0xBD9CB30)

inline static constexpr unsigned int CustomSkin_PhoneBind_TypeDefinitionIndex = 47487;
...
public:
	...
	{
		return (::CustomSkin_PhoneBind**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_PhoneBind_TypeDefinitionIndex)->GetStaticField(0x35B80);
	}
	::UnityEngine::Coroutine* coroutine; // 0x18
	::Class_2_79F6D62CE30E3F8E_1* _loginView; // 0x20
