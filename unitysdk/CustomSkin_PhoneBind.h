...
#define CUSTOMSKIN_PHONEBIND_BIND_OFFSET UNITYSDK_OFFSET(0xB59D6F0)
#define CUSTOMSKIN_PHONEBIND_CLICKCLOSEBTN_OFFSET UNITYSDK_OFFSET(0xB59CE40)
#define CUSTOMSKIN_PHONEBIND_COUNTDOWN_OFFSET UNITYSDK_OFFSET(0xB59D5D0)
#define CUSTOMSKIN_PHONEBIND_INSTANCE_OFFSET UNITYSDK_OFFSET(0xB59BC10)
#define CUSTOMSKIN_PHONEBIND_ONCLOSE_OFFSET UNITYSDK_OFFSET(0xB59BD90)
#define CUSTOMSKIN_PHONEBIND_ONCONSOLECANCEL_OFFSET UNITYSDK_OFFSET(0xB59D990)
#define CUSTOMSKIN_PHONEBIND_ONPHONEALUECHANGE_OFFSET UNITYSDK_OFFSET(0xB59CEE0)
#define CUSTOMSKIN_PHONEBIND_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB59BFB0)
#define CUSTOMSKIN_PHONEBIND_REQUESTVERIFYMESSAGE_OFFSET UNITYSDK_OFFSET(0xB59D180)
#define CUSTOMSKIN_PHONEBIND_RESETCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0xB59D680)
#define CUSTOMSKIN_PHONEBIND_SETACCOUNTINPUT_OFFSET UNITYSDK_OFFSET(0xB59C730)
#define CUSTOMSKIN_PHONEBIND_SETNOTICE_OFFSET UNITYSDK_OFFSET(0xB59CD60)
#define CUSTOMSKIN_PHONEBIND_SETPWDINPUT_OFFSET UNITYSDK_OFFSET(0xB59CA30)
#define CUSTOMSKIN_PHONEBIND_SETREGISTER_OFFSET UNITYSDK_OFFSET(0xB59CC80)
#define CUSTOMSKIN_PHONEBIND_SETZONETIP_OFFSET UNITYSDK_OFFSET(0xB59C650)
#define CUSTOMSKIN_PHONEBIND_STARTCOUNTDOWN_OFFSET UNITYSDK_OFFSET(0xB59D3C0)
#define CUSTOMSKIN_PHONEBIND_UPDATEREQUESTCODEBUTTONSTATUS_OFFSET UNITYSDK_OFFSET(0xB59CF60)
#define CUSTOMSKIN_PHONEBIND__CTOR_OFFSET UNITYSDK_OFFSET(0xB59BD10)
#define CUSTOMSKIN_PHONEBIND__REQUESTVERIFYMESSAGE_B__16_0_OFFSET UNITYSDK_OFFSET(0xB59DB20)

inline static constexpr unsigned int CustomSkin_PhoneBind_TypeDefinitionIndex = 51246;
...
public:
	...
	{
		return (::CustomSkin_PhoneBind**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_PhoneBind_TypeDefinitionIndex)->GetStaticField(0x333E0);
	}
	::MoleMole::UIGeneralLoginCheckDialogPopWindowController* _phonePage; // 0x18
	::UnityEngine::Coroutine* coroutine; // 0x20
	::Class_2_79F6D62CE30E3F8E_48* _loginView; // 0x28
