...
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGUNITVIEW_READ_OFFSET UNITYSDK_OFFSET(0x1B1CE620)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGUNITVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1CF0C0)

namespace BinaryTracingCore::Source::TracingRead
{
	inline static constexpr unsigned int LogUnitView_TypeDefinitionIndex = 31889;
