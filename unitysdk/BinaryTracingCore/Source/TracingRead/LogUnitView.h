...
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGUNITVIEW_READ_OFFSET UNITYSDK_OFFSET(0x1ABA7140)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGUNITVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA7BE0)

namespace BinaryTracingCore::Source::TracingRead
{
	inline static constexpr unsigned int LogUnitView_TypeDefinitionIndex = 30937;

	class LogUnitView : public ::System::Object
	{
	public:
		::BinaryTracingCore::Source::TracingTools::LogUnit* unit; // 0x10
		::BinaryTracingCore::Source::TracingTools::LogMeta* meta; // 0x18
		::System::Collections::Generic::List_1<::BinaryTracingCore::Source::TracingRead::LogPropertyView*>* views; // 0x20
