...
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYVIEW_GET_PROPERTYKEY_OFFSET UNITYSDK_OFFSET(0x1ABA7070)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYVIEW_GET_PROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x1ABA7080)
#define BINARYTRACINGCORE_SOURCE_TRACINGREAD_LOGPROPERTYVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA7130)

namespace BinaryTracingCore::Source::TracingRead
{
	inline static constexpr unsigned int LogPropertyView_TypeDefinitionIndex = 30935;
