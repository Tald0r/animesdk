...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGTAGDEFINE_LOGTAG_GET_TAGNAME_OFFSET UNITYSDK_OFFSET(0x1ABAA880)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGTAGDEFINE_LOGTAG_GET_TAGVALUE_OFFSET UNITYSDK_OFFSET(0x1ABAA870)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGTAGDEFINE_LOGTAG__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABAA820)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogTagDefine_LogTag_TypeDefinitionIndex = 30930;
