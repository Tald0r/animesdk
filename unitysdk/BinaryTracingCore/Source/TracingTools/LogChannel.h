...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_BEGINLOG_OFFSET UNITYSDK_OFFSET(0x1ABA8D20)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_GET_CHANNELMETA_OFFSET UNITYSDK_OFFSET(0x1ABA8CD0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_GET_SYSTEM_OFFSET UNITYSDK_OFFSET(0x1ABA8CF0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_SET_CHANNELMETA_OFFSET UNITYSDK_OFFSET(0x1ABA8CE0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_SET_SYSTEM_OFFSET UNITYSDK_OFFSET(0x1ABA8D00)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA8D10)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogChannel_TypeDefinitionIndex = 30915;
