...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_DEFINELOGCHANNEL_OFFSET UNITYSDK_OFFSET(0x1ABABA50)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_FLUSHWRITE_OFFSET UNITYSDK_OFFSET(0x1ABAB930)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_GETFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1ABAB520)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_GETTIME_OFFSET UNITYSDK_OFFSET(0x1ABAB530)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_INIT_OFFSET UNITYSDK_OFFSET(0x1ABAB110)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_PUSHCURBLOCK_OFFSET UNITYSDK_OFFSET(0x1ABABC20)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_REGISTERLOGMETA_OFFSET UNITYSDK_OFFSET(0x1ABAADF0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_REGISTERTRACINGSYSTEM_OFFSET UNITYSDK_OFFSET(0x1ABAB0D0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_TRYGETMETA_OFFSET UNITYSDK_OFFSET(0x1ABAAD20)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_UPDATEBLOCK_OFFSET UNITYSDK_OFFSET(0x1ABAB480)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_UPDATESATE_OFFSET UNITYSDK_OFFSET(0x1ABAB5E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ABAB5B0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_WRITELOG_OFFSET UNITYSDK_OFFSET(0x1ABA8F60)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABABE10)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int TracingSystem_TypeDefinitionIndex = 30932;
	...
	public:
		...
		::System::Diagnostics::Stopwatch* TimeStopwatch; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Guid, ::BinaryTracingCore::Source::TracingTools::LogChannel*>* Channels; // 0x20
