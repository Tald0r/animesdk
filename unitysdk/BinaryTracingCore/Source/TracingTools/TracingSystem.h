...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_DEFINELOGCHANNEL_OFFSET UNITYSDK_OFFSET(0x1B1D2F20)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_FLUSHWRITE_OFFSET UNITYSDK_OFFSET(0x1B1D2E00)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_GETFRAMECOUNT_OFFSET UNITYSDK_OFFSET(0x1B1D29F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_GETTIME_OFFSET UNITYSDK_OFFSET(0x1B1D2A00)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_INIT_OFFSET UNITYSDK_OFFSET(0x1B1D25E0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_PUSHCURBLOCK_OFFSET UNITYSDK_OFFSET(0x1B1D30F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_REGISTERLOGMETA_OFFSET UNITYSDK_OFFSET(0x1B1D22C0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_REGISTERTRACINGSYSTEM_OFFSET UNITYSDK_OFFSET(0x1B1D25A0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_TRYGETMETA_OFFSET UNITYSDK_OFFSET(0x1B1D21F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_UPDATEBLOCK_OFFSET UNITYSDK_OFFSET(0x1B1D2950)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_UPDATESATE_OFFSET UNITYSDK_OFFSET(0x1B1D2AB0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B1D2A80)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM_WRITELOG_OFFSET UNITYSDK_OFFSET(0x1B1D0440)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_TRACINGSYSTEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D32E0)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int TracingSystem_TypeDefinitionIndex = 31884;

	class TracingSystem : public ::System::Object
	{
	public:
		// static const ::System::String* TracingCondition; // 0x0
		::System::Diagnostics::Stopwatch* TimeStopwatch; // 0x10
		::BinaryTracingCore::Source::TracingTools::LogMetaContainer* MetaContainer; // 0x18
		::BinaryTracingFramework::Serialize::WriteLinker* Linker; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::Guid, ::BinaryTracingCore::Source::TracingTools::LogChannel*>* Channels; // 0x28
