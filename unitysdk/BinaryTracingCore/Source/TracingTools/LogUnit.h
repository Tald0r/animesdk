...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_CREATE_OFFSET UNITYSDK_OFFSET(0x1B1CFE00)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_GET_VALIDUNIT_OFFSET UNITYSDK_OFFSET(0x1B1D1D60)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_1_OFFSET UNITYSDK_OFFSET(0x1B1D0620)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_2_OFFSET UNITYSDK_OFFSET(0x1B1D0720)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_3_OFFSET UNITYSDK_OFFSET(0x1B1D07A0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_OFFSET UNITYSDK_OFFSET(0x1B1D0520)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1B1D00D0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_RESET_OFFSET UNITYSDK_OFFSET(0x1B1D2320)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_RESLOVELOGUNIT_OFFSET UNITYSDK_OFFSET(0x1B1CF350)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_SETHEADINFO_OFFSET UNITYSDK_OFFSET(0x1B1D21C0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_SET_VALIDUNIT_OFFSET UNITYSDK_OFFSET(0x1B1D1D70)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D1D80)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogUnit_TypeDefinitionIndex = 31865;
	...
	public:
		...
		::System::Collections::Generic::List_1<::BinaryTracingCore::Source::TracingTools::LogProperty>* Properties; // 0x68
