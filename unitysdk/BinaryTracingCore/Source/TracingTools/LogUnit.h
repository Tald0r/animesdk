...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_CREATE_OFFSET UNITYSDK_OFFSET(0x1ABA8920)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_GET_VALIDUNIT_OFFSET UNITYSDK_OFFSET(0x1ABAA890)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_1_OFFSET UNITYSDK_OFFSET(0x1ABA9140)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_2_OFFSET UNITYSDK_OFFSET(0x1ABA9240)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_3_OFFSET UNITYSDK_OFFSET(0x1ABA92C0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_LOG_OFFSET UNITYSDK_OFFSET(0x1ABA9040)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1ABA8BF0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_RESET_OFFSET UNITYSDK_OFFSET(0x1ABAAE50)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_RESLOVELOGUNIT_OFFSET UNITYSDK_OFFSET(0x1ABA7E70)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_SETHEADINFO_OFFSET UNITYSDK_OFFSET(0x1ABAACF0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT_SET_VALIDUNIT_OFFSET UNITYSDK_OFFSET(0x1ABAA8A0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGUNIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABAA8B0)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogUnit_TypeDefinitionIndex = 30913;
	...
	public:
		...
		::BinaryTracingFramework::Serialize::MemoryWriteArchive* AttachContent; // 0x20
