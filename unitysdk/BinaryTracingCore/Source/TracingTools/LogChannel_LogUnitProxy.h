...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x98E970)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x306AA0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_INITUNIT_OFFSET UNITYSDK_OFFSET(0x98E960)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_LOG_1_OFFSET UNITYSDK_OFFSET(0x98EA70)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_LOG_2_OFFSET UNITYSDK_OFFSET(0x98EB00)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_LOG_3_OFFSET UNITYSDK_OFFSET(0x98EB80)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_LOG_OFFSET UNITYSDK_OFFSET(0x98E9F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXY_SET_ISVALID_OFFSET UNITYSDK_OFFSET(0x30FC20)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogChannel_LogUnitProxy_TypeDefinitionIndex = 31868;
