...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_LOG_1_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_LOG_2_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_LOG_3_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGCHANNEL_LOGUNITPROXYEMPTY_LOG_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogChannel_LogUnitProxyEmpty_TypeDefinitionIndex = 31869;
