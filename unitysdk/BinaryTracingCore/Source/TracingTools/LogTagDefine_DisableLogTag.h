...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGTAGDEFINE_DISABLELOGTAG_GET_ENABLE_OFFSET UNITYSDK_OFFSET(0x2FB060)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGTAGDEFINE_DISABLELOGTAG_GET_TAGNAME_OFFSET UNITYSDK_OFFSET(0x38AAD0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGTAGDEFINE_DISABLELOGTAG_GET_TAGVALUE_OFFSET UNITYSDK_OFFSET(0x8C17F0)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogTagDefine_DisableLogTag_TypeDefinitionIndex = 30931;
