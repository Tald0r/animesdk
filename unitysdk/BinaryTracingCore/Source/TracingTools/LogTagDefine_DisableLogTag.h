...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGTAGDEFINE_DISABLELOGTAG_GET_ENABLE_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGTAGDEFINE_DISABLELOGTAG_GET_TAGNAME_OFFSET UNITYSDK_OFFSET(0x3BF680)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGTAGDEFINE_DISABLELOGTAG_GET_TAGVALUE_OFFSET UNITYSDK_OFFSET(0x8EE290)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogTagDefine_DisableLogTag_TypeDefinitionIndex = 31883;
