...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_GET_METATYPE_OFFSET UNITYSDK_OFFSET(0x1ABA9AB0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_GET_PROPERTIESVIEW_OFFSET UNITYSDK_OFFSET(0x1ABA9A50)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_MATCH_OFFSET UNITYSDK_OFFSET(0x1ABA9C00)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABA9F50)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_SET_METATYPE_OFFSET UNITYSDK_OFFSET(0x1ABA9AC0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ABA9AD0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1ABA9B60)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA9720)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogMeta_TypeDefinitionIndex = 30926;
