...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_GET_METATYPE_OFFSET UNITYSDK_OFFSET(0x1B1D0FA0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_GET_PROPERTIESVIEW_OFFSET UNITYSDK_OFFSET(0x1B1D0F40)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_MATCH_OFFSET UNITYSDK_OFFSET(0x1B1D10F0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1D1440)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA_SET_METATYPE_OFFSET UNITYSDK_OFFSET(0x1B1D0FB0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1D0FC0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B1D1050)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGMETA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D0C10)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogMeta_TypeDefinitionIndex = 31878;
