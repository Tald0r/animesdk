...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_MEMORYBUFF_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x1B1CFE70)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_MEMORYBUFF_RESET_OFFSET UNITYSDK_OFFSET(0x1B1D2500)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_MEMORYBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D2530)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int MemoryBuff_TypeDefinitionIndex = 31863;
