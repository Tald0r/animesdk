...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_MEMORYBUFF_GETBUFFER_OFFSET UNITYSDK_OFFSET(0x1ABA8990)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_MEMORYBUFF_RESET_OFFSET UNITYSDK_OFFSET(0x1ABAB030)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_MEMORYBUFF__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABAB060)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int MemoryBuff_TypeDefinitionIndex = 30911;
