...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_ADDUNIT_OFFSET UNITYSDK_OFFSET(0x1B1CF1D0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GETLOGUNIT_OFFSET UNITYSDK_OFFSET(0x1B1CF1C0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GET_FRAMECOUNTVIEW_OFFSET UNITYSDK_OFFSET(0x1B1CF190)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GET_LOGUNITSVIEW_OFFSET UNITYSDK_OFFSET(0x1B1CF140)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GET_TIMESTAMPVIEW_OFFSET UNITYSDK_OFFSET(0x1B1CF1A0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_RESET_OFFSET UNITYSDK_OFFSET(0x1B1CFF30)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_RESLOVELOGUNIT_OFFSET UNITYSDK_OFFSET(0x1B1CF230)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1CF580)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_SETUPHEADINFO_OFFSET UNITYSDK_OFFSET(0x1B1CF1B0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1D0130)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogBlock_TypeDefinitionIndex = 31866;
