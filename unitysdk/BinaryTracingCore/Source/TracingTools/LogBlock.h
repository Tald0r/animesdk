...
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_ADDUNIT_OFFSET UNITYSDK_OFFSET(0x1ABA7CF0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GETLOGUNIT_OFFSET UNITYSDK_OFFSET(0x1ABA7CE0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GET_FRAMECOUNTVIEW_OFFSET UNITYSDK_OFFSET(0x1ABA7CB0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GET_LOGUNITSVIEW_OFFSET UNITYSDK_OFFSET(0x1ABA7C60)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_GET_TIMESTAMPVIEW_OFFSET UNITYSDK_OFFSET(0x1ABA7CC0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_RESET_OFFSET UNITYSDK_OFFSET(0x1ABA8A50)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_RESLOVELOGUNIT_OFFSET UNITYSDK_OFFSET(0x1ABA7D50)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABA80A0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK_SETUPHEADINFO_OFFSET UNITYSDK_OFFSET(0x1ABA7CD0)
#define BINARYTRACINGCORE_SOURCE_TRACINGTOOLS_LOGBLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA8C50)

namespace BinaryTracingCore::Source::TracingTools
{
	inline static constexpr unsigned int LogBlock_TypeDefinitionIndex = 30914;
