...
#define UNITY_PROFILING_PROFILERMARKER_AUTO_OFFSET UNITYSDK_OFFSET(0x9240A0)
#define UNITY_PROFILING_PROFILERMARKER_INTERNAL_BEGIN_OFFSET UNITYSDK_OFFSET(0x1A3E0EC0)
#define UNITY_PROFILING_PROFILERMARKER_INTERNAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1A3E0E90)
#define UNITY_PROFILING_PROFILERMARKER_INTERNAL_END_OFFSET UNITYSDK_OFFSET(0x1A3E0ED0)
#define UNITY_PROFILING_PROFILERMARKER__CTOR_OFFSET UNITYSDK_OFFSET(0x924080)
