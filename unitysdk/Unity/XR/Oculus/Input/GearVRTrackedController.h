...
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1A3E5250)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_GET_BACK_OFFSET UNITYSDK_OFFSET(0x1A3E5170)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_GET_DEVICEACCELERATION_OFFSET UNITYSDK_OFFSET(0x1A3E5210)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_GET_DEVICEANGULARACCELERATION_OFFSET UNITYSDK_OFFSET(0x1A3E5230)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_GET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1A3E51F0)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_GET_TOUCHPADCLICKED_OFFSET UNITYSDK_OFFSET(0x1A3E51B0)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_GET_TOUCHPADTOUCHED_OFFSET UNITYSDK_OFFSET(0x1A3E51D0)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_GET_TOUCHPAD_OFFSET UNITYSDK_OFFSET(0x1A3E5130)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_GET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1A3E5190)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1A3E5150)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_SET_BACK_OFFSET UNITYSDK_OFFSET(0x1A3E5180)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_SET_DEVICEACCELERATION_OFFSET UNITYSDK_OFFSET(0x1A3E5220)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_SET_DEVICEANGULARACCELERATION_OFFSET UNITYSDK_OFFSET(0x1A3E5240)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_SET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1A3E5200)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_SET_TOUCHPADCLICKED_OFFSET UNITYSDK_OFFSET(0x1A3E51C0)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_SET_TOUCHPADTOUCHED_OFFSET UNITYSDK_OFFSET(0x1A3E51E0)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_SET_TOUCHPAD_OFFSET UNITYSDK_OFFSET(0x1A3E5140)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_SET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1A3E51A0)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1A3E5160)
#define UNITY_XR_OCULUS_INPUT_GEARVRTRACKEDCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3E5390)

namespace Unity::XR::Oculus::Input
{
	inline static constexpr unsigned int GearVRTrackedController_TypeDefinitionIndex = 27401;
	...
	public:
		...
		::UnityEngine::InputSystem::Controls::Vector3Control* _deviceAngularAcceleration_k__BackingField; // 0x190
		...
		::UnityEngine::InputSystem::Controls::ButtonControl* _touchpadTouched_k__BackingField; // 0x1A8
		::UnityEngine::InputSystem::Controls::ButtonControl* _back_k__BackingField; // 0x1B0
