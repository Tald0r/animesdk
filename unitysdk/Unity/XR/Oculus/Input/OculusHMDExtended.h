...
#define UNITY_XR_OCULUS_INPUT_OCULUSHMDEXTENDED_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x19D9AAE0)
#define UNITY_XR_OCULUS_INPUT_OCULUSHMDEXTENDED_GET_BACK_OFFSET UNITYSDK_OFFSET(0x19D9AAA0)
#define UNITY_XR_OCULUS_INPUT_OCULUSHMDEXTENDED_GET_TOUCHPAD_OFFSET UNITYSDK_OFFSET(0x19D9AAC0)
#define UNITY_XR_OCULUS_INPUT_OCULUSHMDEXTENDED_SET_BACK_OFFSET UNITYSDK_OFFSET(0x19D9AAB0)
#define UNITY_XR_OCULUS_INPUT_OCULUSHMDEXTENDED_SET_TOUCHPAD_OFFSET UNITYSDK_OFFSET(0x19D9AAD0)
#define UNITY_XR_OCULUS_INPUT_OCULUSHMDEXTENDED__CTOR_OFFSET UNITYSDK_OFFSET(0x19D9AB50)

namespace Unity::XR::Oculus::Input
{
	inline static constexpr unsigned int OculusHMDExtended_TypeDefinitionIndex = 27400;
