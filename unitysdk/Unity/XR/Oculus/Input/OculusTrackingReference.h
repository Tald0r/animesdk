...
#define UNITY_XR_OCULUS_INPUT_OCULUSTRACKINGREFERENCE_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1AD36030)
#define UNITY_XR_OCULUS_INPUT_OCULUSTRACKINGREFERENCE_GET_ISTRACKED_OFFSET UNITYSDK_OFFSET(0x1AD36010)
#define UNITY_XR_OCULUS_INPUT_OCULUSTRACKINGREFERENCE_GET_TRACKINGSTATE_OFFSET UNITYSDK_OFFSET(0x1AD35FF0)
#define UNITY_XR_OCULUS_INPUT_OCULUSTRACKINGREFERENCE_SET_ISTRACKED_OFFSET UNITYSDK_OFFSET(0x1AD36020)
#define UNITY_XR_OCULUS_INPUT_OCULUSTRACKINGREFERENCE_SET_TRACKINGSTATE_OFFSET UNITYSDK_OFFSET(0x1AD36000)
#define UNITY_XR_OCULUS_INPUT_OCULUSTRACKINGREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD360A0)

namespace Unity::XR::Oculus::Input
{
	inline static constexpr unsigned int OculusTrackingReference_TypeDefinitionIndex = 28338;
