...
#define UNITY_XR_OPENVR_VIVEWAND_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x19F5F130)
#define UNITY_XR_OPENVR_VIVEWAND_GET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x19F5F110)
#define UNITY_XR_OPENVR_VIVEWAND_GET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x19F5F0F0)
#define UNITY_XR_OPENVR_VIVEWAND_GET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x19F5F010)
#define UNITY_XR_OPENVR_VIVEWAND_GET_GRIP_OFFSET UNITYSDK_OFFSET(0x19F5EFF0)
#define UNITY_XR_OPENVR_VIVEWAND_GET_PRIMARY_OFFSET UNITYSDK_OFFSET(0x19F5F030)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRACKPADPRESSED_OFFSET UNITYSDK_OFFSET(0x19F5F050)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRACKPADTOUCHED_OFFSET UNITYSDK_OFFSET(0x19F5F070)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRACKPAD_OFFSET UNITYSDK_OFFSET(0x19F5F090)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x19F5F0D0)
#define UNITY_XR_OPENVR_VIVEWAND_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x19F5F0B0)
#define UNITY_XR_OPENVR_VIVEWAND_SET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x19F5F120)
#define UNITY_XR_OPENVR_VIVEWAND_SET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x19F5F100)
#define UNITY_XR_OPENVR_VIVEWAND_SET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x19F5F020)
#define UNITY_XR_OPENVR_VIVEWAND_SET_GRIP_OFFSET UNITYSDK_OFFSET(0x19F5F000)
#define UNITY_XR_OPENVR_VIVEWAND_SET_PRIMARY_OFFSET UNITYSDK_OFFSET(0x19F5F040)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRACKPADPRESSED_OFFSET UNITYSDK_OFFSET(0x19F5F060)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRACKPADTOUCHED_OFFSET UNITYSDK_OFFSET(0x19F5F080)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRACKPAD_OFFSET UNITYSDK_OFFSET(0x19F5F0A0)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x19F5F0E0)
#define UNITY_XR_OPENVR_VIVEWAND_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x19F5F0C0)
#define UNITY_XR_OPENVR_VIVEWAND__CTOR_OFFSET UNITYSDK_OFFSET(0x19F5F290)

namespace Unity::XR::OpenVR
{
	inline static constexpr unsigned int ViveWand_TypeDefinitionIndex = 27391;
	...
	public:
		...
		::UnityEngine::InputSystem::Controls::Vector2Control* _trackpad_k__BackingField; // 0x188
		...
		::UnityEngine::InputSystem::Controls::AxisControl* _grip_k__BackingField; // 0x1C0
