...
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1AD36230)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_GET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1AD36210)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_GET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1AD361F0)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_GET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1AD36170)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_GET_GRIP_OFFSET UNITYSDK_OFFSET(0x1AD36110)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_GET_PRIMARYBUTTON_OFFSET UNITYSDK_OFFSET(0x1AD36130)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_GET_SECONDARYBUTTON_OFFSET UNITYSDK_OFFSET(0x1AD36150)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_GET_THUMBSTICKCLICKED_OFFSET UNITYSDK_OFFSET(0x1AD361B0)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_GET_THUMBSTICKTOUCHED_OFFSET UNITYSDK_OFFSET(0x1AD361D0)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_GET_THUMBSTICK_OFFSET UNITYSDK_OFFSET(0x1AD360D0)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_GET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1AD36190)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1AD360F0)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_SET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1AD36220)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_SET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1AD36200)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_SET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1AD36180)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_SET_GRIP_OFFSET UNITYSDK_OFFSET(0x1AD36120)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_SET_PRIMARYBUTTON_OFFSET UNITYSDK_OFFSET(0x1AD36140)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_SET_SECONDARYBUTTON_OFFSET UNITYSDK_OFFSET(0x1AD36160)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_SET_THUMBSTICKCLICKED_OFFSET UNITYSDK_OFFSET(0x1AD361C0)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_SET_THUMBSTICKTOUCHED_OFFSET UNITYSDK_OFFSET(0x1AD361E0)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_SET_THUMBSTICK_OFFSET UNITYSDK_OFFSET(0x1AD360E0)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_SET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1AD361A0)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1AD36100)
#define UNITY_XR_OPENVR_OPENVROCULUSTOUCHCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD363B0)

namespace Unity::XR::OpenVR
{
	inline static constexpr unsigned int OpenVROculusTouchController_TypeDefinitionIndex = 28335;
	...
	public:
		...
		::UnityEngine::InputSystem::Controls::ButtonControl* _thumbstickClicked_k__BackingField; // 0x180
		::UnityEngine::InputSystem::Controls::ButtonControl* _primaryButton_k__BackingField; // 0x188
