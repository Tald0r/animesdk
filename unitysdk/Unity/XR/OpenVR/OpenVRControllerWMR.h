...
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1AB7E520)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1AB7E3E0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1AB7E3C0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1AB7E440)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_GRIP_OFFSET UNITYSDK_OFFSET(0x1AB7E4C0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_JOYSTICK_OFFSET UNITYSDK_OFFSET(0x1AB7E500)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_MENU_OFFSET UNITYSDK_OFFSET(0x1AB7E480)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_TOUCHPADCLICK_OFFSET UNITYSDK_OFFSET(0x1AB7E400)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_TOUCHPADTOUCH_OFFSET UNITYSDK_OFFSET(0x1AB7E420)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_TOUCHPAD_OFFSET UNITYSDK_OFFSET(0x1AB7E4E0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1AB7E460)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1AB7E4A0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1AB7E3F0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1AB7E3D0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1AB7E450)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_GRIP_OFFSET UNITYSDK_OFFSET(0x1AB7E4D0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_JOYSTICK_OFFSET UNITYSDK_OFFSET(0x1AB7E510)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_MENU_OFFSET UNITYSDK_OFFSET(0x1AB7E490)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_TOUCHPADCLICK_OFFSET UNITYSDK_OFFSET(0x1AB7E410)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_TOUCHPADTOUCH_OFFSET UNITYSDK_OFFSET(0x1AB7E430)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_TOUCHPAD_OFFSET UNITYSDK_OFFSET(0x1AB7E4F0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1AB7E470)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1AB7E4B0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB7E6A0)

namespace Unity::XR::OpenVR
{
	inline static constexpr unsigned int OpenVRControllerWMR_TypeDefinitionIndex = 27390;

	class OpenVRControllerWMR : public ::UnityEngine::InputSystem::XR::XRController
	{
	public:
		::UnityEngine::InputSystem::Controls::ButtonControl* _touchpadClick_k__BackingField; // 0x178
		...
		::UnityEngine::InputSystem::Controls::ButtonControl* _touchpadTouch_k__BackingField; // 0x198
		::UnityEngine::InputSystem::Controls::ButtonControl* _menu_k__BackingField; // 0x1A0
