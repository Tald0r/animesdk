...
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_FINISHSETUP_OFFSET UNITYSDK_OFFSET(0x1B19E2D0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B19E190)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B19E170)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1B19E1F0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_GRIP_OFFSET UNITYSDK_OFFSET(0x1B19E270)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_JOYSTICK_OFFSET UNITYSDK_OFFSET(0x1B19E2B0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_MENU_OFFSET UNITYSDK_OFFSET(0x1B19E230)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_TOUCHPADCLICK_OFFSET UNITYSDK_OFFSET(0x1B19E1B0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_TOUCHPADTOUCH_OFFSET UNITYSDK_OFFSET(0x1B19E1D0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_TOUCHPAD_OFFSET UNITYSDK_OFFSET(0x1B19E290)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1B19E210)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_GET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1B19E250)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_DEVICEANGULARVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B19E1A0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_DEVICEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B19E180)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_GRIPPRESSED_OFFSET UNITYSDK_OFFSET(0x1B19E200)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_GRIP_OFFSET UNITYSDK_OFFSET(0x1B19E280)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_JOYSTICK_OFFSET UNITYSDK_OFFSET(0x1B19E2C0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_MENU_OFFSET UNITYSDK_OFFSET(0x1B19E240)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_TOUCHPADCLICK_OFFSET UNITYSDK_OFFSET(0x1B19E1C0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_TOUCHPADTOUCH_OFFSET UNITYSDK_OFFSET(0x1B19E1E0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_TOUCHPAD_OFFSET UNITYSDK_OFFSET(0x1B19E2A0)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_TRIGGERPRESSED_OFFSET UNITYSDK_OFFSET(0x1B19E220)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR_SET_TRIGGER_OFFSET UNITYSDK_OFFSET(0x1B19E260)
#define UNITY_XR_OPENVR_OPENVRCONTROLLERWMR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B19E450)

namespace Unity::XR::OpenVR
{
	inline static constexpr unsigned int OpenVRControllerWMR_TypeDefinitionIndex = 28330;

	class OpenVRControllerWMR : public ::UnityEngine::InputSystem::XR::XRController
	{
	public:
		::UnityEngine::InputSystem::Controls::ButtonControl* _touchpadTouch_k__BackingField; // 0x178
		::UnityEngine::InputSystem::Controls::Vector2Control* _joystick_k__BackingField; // 0x180
		...
		::UnityEngine::InputSystem::Controls::AxisControl* _grip_k__BackingField; // 0x1A8
		::UnityEngine::InputSystem::Controls::Vector2Control* _touchpad_k__BackingField; // 0x1B0
		::UnityEngine::InputSystem::Controls::ButtonControl* _touchpadClick_k__BackingField; // 0x1B8
