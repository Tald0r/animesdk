...
#define UNITY_THROWSTUB_THROWNOTSUPPORTEDEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A47C2B0)

namespace Unity
{
	inline static constexpr unsigned int ThrowStub_TypeDefinitionIndex = 35601;
