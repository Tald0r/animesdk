...
#define UNITY_THROWSTUB_THROWNOTSUPPORTEDEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1AA739A0)

namespace Unity
{
	inline static constexpr unsigned int ThrowStub_TypeDefinitionIndex = 36621;
