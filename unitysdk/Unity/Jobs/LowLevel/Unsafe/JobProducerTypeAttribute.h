...
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBPRODUCERTYPEATTRIBUTE_GET_PRODUCERTYPE_OFFSET UNITYSDK_OFFSET(0x1A6887A0)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBPRODUCERTYPEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6887B0)
