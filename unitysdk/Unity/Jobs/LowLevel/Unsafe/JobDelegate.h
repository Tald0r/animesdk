...
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A688740)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A688790)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A688450)
#define UNITY_JOBS_LOWLEVEL_UNSAFE_JOBDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A688430)
