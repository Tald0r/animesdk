...
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIESINTERNAL2_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52CD50)
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIESINTERNAL2_OFFSET UNITYSDK_OFFSET(0x1A52CC50)
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIESINTERNALPTR_INJECTED_OFFSET UNITYSDK_OFFSET(0x1A52CD60)
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIESINTERNALPTR_OFFSET UNITYSDK_OFFSET(0x1A52CCD0)
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIES_1_OFFSET UNITYSDK_OFFSET(0x1A52CC90)
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIES_2_OFFSET UNITYSDK_OFFSET(0x1A52CD10)
#define UNITY_JOBS_JOBHANDLE_COMBINEDEPENDENCIES_OFFSET UNITYSDK_OFFSET(0x1A52CC10)
#define UNITY_JOBS_JOBHANDLE_COMPLETEALL_OFFSET UNITYSDK_OFFSET(0x1A52CBB0)
#define UNITY_JOBS_JOBHANDLE_COMPLETE_OFFSET UNITYSDK_OFFSET(0x92AF50)
#define UNITY_JOBS_JOBHANDLE_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x92AF70)
#define UNITY_JOBS_JOBHANDLE_SCHEDULEBATCHEDJOBSANDCOMPLETEALL_OFFSET UNITYSDK_OFFSET(0x1A52CBD0)
#define UNITY_JOBS_JOBHANDLE_SCHEDULEBATCHEDJOBSANDCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1A52CBA0)
#define UNITY_JOBS_JOBHANDLE_SCHEDULEBATCHEDJOBSANDISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1A52CBF0)
#define UNITY_JOBS_JOBHANDLE_SCHEDULEBATCHEDJOBS_OFFSET UNITYSDK_OFFSET(0x1A52CC00)
