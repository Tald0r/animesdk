...
#define UNITY_COLLECTIONS_NATIVEQUEUEDATA_DEALLOCATEQUEUE_OFFSET UNITYSDK_OFFSET(0x1B112260)
#define UNITY_COLLECTIONS_NATIVEQUEUEDATA_GETCURRENTWRITEBLOCKTLS_OFFSET UNITYSDK_OFFSET(0x97B9F0)
#define UNITY_COLLECTIONS_NATIVEQUEUEDATA_SETCURRENTWRITEBLOCKTLS_OFFSET UNITYSDK_OFFSET(0x97BA00)

namespace Unity::Collections
{
	inline static constexpr unsigned int NativeQueueData_TypeDefinitionIndex = 19204;
