...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A520020)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x1A520070)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_COUNT_OFFSET UNITYSDK_OFFSET(0x1A520030)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_CREATE_OFFSET UNITYSDK_OFFSET(0x1A520000)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_DESTROY_OFFSET UNITYSDK_OFFSET(0x1A520010)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_INSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1A520050)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A520060)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1A520040)
