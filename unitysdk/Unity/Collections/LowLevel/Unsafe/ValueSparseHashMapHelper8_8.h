...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_CLEAR_OFFSET UNITYSDK_OFFSET(0x19F43350)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_CONTAINSKEY_OFFSET UNITYSDK_OFFSET(0x19F433A0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_COUNT_OFFSET UNITYSDK_OFFSET(0x19F43360)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_CREATE_OFFSET UNITYSDK_OFFSET(0x19F43330)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_DESTROY_OFFSET UNITYSDK_OFFSET(0x19F43340)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_INSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x19F43380)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_REMOVE_OFFSET UNITYSDK_OFFSET(0x19F43390)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_8_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x19F43370)
