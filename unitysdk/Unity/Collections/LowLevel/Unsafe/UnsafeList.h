...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x9B03B0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_CREATE_OFFSET UNITYSDK_OFFSET(0x1B728540)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B728720)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9B03A0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_REALLOC_OFFSET UNITYSDK_OFFSET(0x9B0480)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_REMOVERANGESWAPBACK_OFFSET UNITYSDK_OFFSET(0x9B04F0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_RESIZE_OFFSET UNITYSDK_OFFSET(0x9B03C0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x9B0490)

namespace Unity::Collections::LowLevel::Unsafe
{
	inline static constexpr unsigned int UnsafeList_TypeDefinitionIndex = 19811;
