...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_CLEAR_OFFSET UNITYSDK_OFFSET(0x97B760)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_CREATE_OFFSET UNITYSDK_OFFSET(0x1B111840)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B111A20)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_DISPOSE_OFFSET UNITYSDK_OFFSET(0x97B750)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_REALLOC_OFFSET UNITYSDK_OFFSET(0x97B830)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_REMOVERANGESWAPBACK_OFFSET UNITYSDK_OFFSET(0x97B8A0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_RESIZE_OFFSET UNITYSDK_OFFSET(0x97B770)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_UNSAFELIST_SETCAPACITY_OFFSET UNITYSDK_OFFSET(0x97B840)

namespace Unity::Collections::LowLevel::Unsafe
{
	inline static constexpr unsigned int UnsafeList_TypeDefinitionIndex = 19213;
