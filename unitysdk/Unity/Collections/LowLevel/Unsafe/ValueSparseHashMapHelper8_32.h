...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_CLEAR_OFFSET UNITYSDK_OFFSET(0x19DD5D00)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_COUNT_OFFSET UNITYSDK_OFFSET(0x19DD5D10)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_CREATE_OFFSET UNITYSDK_OFFSET(0x19DD5CE0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_DESTROY_OFFSET UNITYSDK_OFFSET(0x19DD5CF0)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_INSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x19DD5D30)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_32_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x19DD5D20)
