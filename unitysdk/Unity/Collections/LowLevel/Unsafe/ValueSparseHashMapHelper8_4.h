...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_CLEAR_OFFSET UNITYSDK_OFFSET(0x19E8E940)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_COUNT_OFFSET UNITYSDK_OFFSET(0x19E8E950)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_CREATE_OFFSET UNITYSDK_OFFSET(0x19E8E920)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_DESTROY_OFFSET UNITYSDK_OFFSET(0x19E8E930)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_INSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x19E8E970)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x19E8E960)
