...
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_CLEAR_OFFSET UNITYSDK_OFFSET(0x1994EB20)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_COUNT_OFFSET UNITYSDK_OFFSET(0x1994EB30)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_CREATE_OFFSET UNITYSDK_OFFSET(0x1994EB00)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_DESTROY_OFFSET UNITYSDK_OFFSET(0x1994EB10)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_INSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1994EB50)
#define UNITY_COLLECTIONS_LOWLEVEL_UNSAFE_VALUESPARSEHASHMAPHELPER8_4_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1994EB40)
