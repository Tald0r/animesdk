...
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_RANGE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9B0390)

namespace Unity::Collections
{
	inline static constexpr unsigned int AllocatorManager_Range_TypeDefinitionIndex = 19791;
