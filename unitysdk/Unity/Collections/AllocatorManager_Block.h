...
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9B0140)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_GET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x9B00F0)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_GET_BYTES_OFFSET UNITYSDK_OFFSET(0x9B00E0)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_SET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x9B0100)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_TRYFREE_OFFSET UNITYSDK_OFFSET(0x9B0260)

namespace Unity::Collections
{
	inline static constexpr unsigned int AllocatorManager_Block_TypeDefinitionIndex = 19792;
