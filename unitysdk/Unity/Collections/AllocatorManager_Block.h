...
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x97B4F0)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_GET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x97B4A0)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_GET_BYTES_OFFSET UNITYSDK_OFFSET(0x97B490)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_SET_ALIGNMENT_OFFSET UNITYSDK_OFFSET(0x97B4B0)
#define UNITY_COLLECTIONS_ALLOCATORMANAGER_BLOCK_TRYFREE_OFFSET UNITYSDK_OFFSET(0x97B610)

namespace Unity::Collections
{
	inline static constexpr unsigned int AllocatorManager_Block_TypeDefinitionIndex = 19194;
