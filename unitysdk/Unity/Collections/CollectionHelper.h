...
#define UNITY_COLLECTIONS_COLLECTIONHELPER_ALIGN_OFFSET UNITYSDK_OFFSET(0x1B111700)
#define UNITY_COLLECTIONS_COLLECTIONHELPER_CEILPOW2_OFFSET UNITYSDK_OFFSET(0x1B111730)
#define UNITY_COLLECTIONS_COLLECTIONHELPER_LZCNT_1_OFFSET UNITYSDK_OFFSET(0x1B1117A0)
#define UNITY_COLLECTIONS_COLLECTIONHELPER_LZCNT_OFFSET UNITYSDK_OFFSET(0x1B111760)
#define UNITY_COLLECTIONS_COLLECTIONHELPER_SHOULDDEALLOCATE_OFFSET UNITYSDK_OFFSET(0x1B111720)

namespace Unity::Collections
{
	inline static constexpr unsigned int CollectionHelper_TypeDefinitionIndex = 19195;
