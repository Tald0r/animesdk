...
#define UNITY_COLLECTIONS_COLLECTIONHELPER_ALIGN_OFFSET UNITYSDK_OFFSET(0x1B728400)
#define UNITY_COLLECTIONS_COLLECTIONHELPER_CEILPOW2_OFFSET UNITYSDK_OFFSET(0x1B728430)
#define UNITY_COLLECTIONS_COLLECTIONHELPER_LZCNT_1_OFFSET UNITYSDK_OFFSET(0x1B7284A0)
#define UNITY_COLLECTIONS_COLLECTIONHELPER_LZCNT_OFFSET UNITYSDK_OFFSET(0x1B728460)
#define UNITY_COLLECTIONS_COLLECTIONHELPER_SHOULDDEALLOCATE_OFFSET UNITYSDK_OFFSET(0x1B728420)

namespace Unity::Collections
{
	inline static constexpr unsigned int CollectionHelper_TypeDefinitionIndex = 19793;
