...
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_ENABLEMAXHBLKONEXPAND_OFFSET UNITYSDK_OFFSET(0x1B76EA90)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCCOLLECTMEMORYINFO_OFFSET UNITYSDK_OFFSET(0x1B76EA50)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCCOLLECTTIMEINFO_OFFSET UNITYSDK_OFFSET(0x1B76EA40)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCEVENTCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B76EA30)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCEVENTCOUNTER_OFFSET UNITYSDK_OFFSET(0x1B76EA10)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B76EA20)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCEXPANDINFO_OFFSET UNITYSDK_OFFSET(0x1B76EA60)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCMALLOCEXCESSIVESTACKSTR_OFFSET UNITYSDK_OFFSET(0x1B76EA70)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_SETMALLOCEXCESSIVETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B76EA80)

namespace Unity::IL2CPP::RuntimeServices
{
	inline static constexpr unsigned int BoehmgcStats_TypeDefinitionIndex = 6845;
