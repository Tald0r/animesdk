...
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_ENABLEMAXHBLKONEXPAND_OFFSET UNITYSDK_OFFSET(0x1B14FAE0)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCCOLLECTMEMORYINFO_OFFSET UNITYSDK_OFFSET(0x1B14FAA0)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCCOLLECTTIMEINFO_OFFSET UNITYSDK_OFFSET(0x1B14FA90)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCEVENTCAPACITY_OFFSET UNITYSDK_OFFSET(0x1B14FA80)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCEVENTCOUNTER_OFFSET UNITYSDK_OFFSET(0x1B14FA60)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCEVENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B14FA70)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCEXPANDINFO_OFFSET UNITYSDK_OFFSET(0x1B14FAB0)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_GETGCMALLOCEXCESSIVESTACKSTR_OFFSET UNITYSDK_OFFSET(0x1B14FAC0)
#define UNITY_IL2CPP_RUNTIMESERVICES_BOEHMGCSTATS_SETMALLOCEXCESSIVETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1B14FAD0)

namespace Unity::IL2CPP::RuntimeServices
{
	inline static constexpr unsigned int BoehmgcStats_TypeDefinitionIndex = 6818;
