...
#define UNITY_IL2CPP_RUNTIMESERVICES_IL2CPPCODESWITCH_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B14FB20)
#define UNITY_IL2CPP_RUNTIMESERVICES_IL2CPPCODESWITCH_ISENABLED_OFFSET UNITYSDK_OFFSET(0x1B14FB10)
#define UNITY_IL2CPP_RUNTIMESERVICES_IL2CPPCODESWITCH_REMOVE_OFFSET UNITYSDK_OFFSET(0x1B14FB00)
#define UNITY_IL2CPP_RUNTIMESERVICES_IL2CPPCODESWITCH_SET_OFFSET UNITYSDK_OFFSET(0x1B14FAF0)

namespace Unity::IL2CPP::RuntimeServices
{
	inline static constexpr unsigned int Il2CppCodeSwitch_TypeDefinitionIndex = 6831;
