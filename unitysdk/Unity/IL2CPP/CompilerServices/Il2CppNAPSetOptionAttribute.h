...
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE_GET_OPTION_OFFSET UNITYSDK_OFFSET(0x18A23CA0)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x18A23CC0)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE_SET_OPTION_OFFSET UNITYSDK_OFFSET(0x18A23CB0)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x18A23CD0)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x18A23CE0)

namespace Unity::IL2CPP::CompilerServices
{
	inline static constexpr unsigned int Il2CppNAPSetOptionAttribute_TypeDefinitionIndex = 9490;
