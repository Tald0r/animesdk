...
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE_GET_OPTION_OFFSET UNITYSDK_OFFSET(0x1841EA50)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1841EA70)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE_SET_OPTION_OFFSET UNITYSDK_OFFSET(0x1841EA60)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1841EA80)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPNAPSETOPTIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1841EA90)

namespace Unity::IL2CPP::CompilerServices
{
	inline static constexpr unsigned int Il2CppNAPSetOptionAttribute_TypeDefinitionIndex = 9488;
