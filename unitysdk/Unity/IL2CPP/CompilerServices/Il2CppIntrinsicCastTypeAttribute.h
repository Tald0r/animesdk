...
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICCASTTYPEATTRIBUTE_GET_NATIVETYPE_OFFSET UNITYSDK_OFFSET(0x1B14F8A0)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICCASTTYPEATTRIBUTE_SET_NATIVETYPE_OFFSET UNITYSDK_OFFSET(0x1B14F8B0)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICCASTTYPEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14F8C0)

namespace Unity::IL2CPP::CompilerServices
{
	inline static constexpr unsigned int Il2CppIntrinsicCastTypeAttribute_TypeDefinitionIndex = 6841;
