...
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_ADDGCEVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B76E990)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_FASTCREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1B76E930)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_GETCURRENTMETHODRID_OFFSET UNITYSDK_OFFSET(0x1B76E970)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_GETGCMARKTHREADIDS_OFFSET UNITYSDK_OFFSET(0x1B76E980)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_GETTYPEHANDLE_OFFSET UNITYSDK_OFFSET(0x1B76E8F0)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_LIKELY_OFFSET UNITYSDK_OFFSET(0x1B76E8D0)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_REMOVEGCEVENTCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B76E9A0)
#define UNITY_IL2CPP_COMPILERSERVICES_IL2CPPINTRINSICS_UNLIKELY_OFFSET UNITYSDK_OFFSET(0x1B76E8E0)

namespace Unity::IL2CPP::CompilerServices
{
	inline static constexpr unsigned int Il2CppIntrinsics_TypeDefinitionIndex = 6844;
