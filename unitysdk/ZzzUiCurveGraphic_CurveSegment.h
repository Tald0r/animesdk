...
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_COMPUTECONTROLPOINTS_1_OFFSET UNITYSDK_OFFSET(0xD5D8A80)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_COMPUTECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0xD5D8A00)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_COMPUTECURVEINFO_OFFSET UNITYSDK_OFFSET(0xD5D9220)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_GET_HASNEXTCURVE_OFFSET UNITYSDK_OFFSET(0xD5D8540)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_GET_HASPREVCURVE_OFFSET UNITYSDK_OFFSET(0xD5D8530)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0xD5D88B0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0xD5D8980)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0xD5D89A0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0xD5D89D0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0xD5D8550)

inline static constexpr unsigned int ZzzUiCurveGraphic_CurveSegment_TypeDefinitionIndex = 39829;
