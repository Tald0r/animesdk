...
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_COMPUTECONTROLPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1A4C2060)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_COMPUTECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1A4C1FE0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_COMPUTECURVEINFO_OFFSET UNITYSDK_OFFSET(0x1A4C2800)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_GET_HASNEXTCURVE_OFFSET UNITYSDK_OFFSET(0x1A4C1B20)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT_GET_HASPREVCURVE_OFFSET UNITYSDK_OFFSET(0x1A4C1B10)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4C1E90)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A4C1F60)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A4C1F80)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A4C1FB0)
#define ZZZUICURVEGRAPHIC_CURVESEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4C1B30)

inline static constexpr unsigned int ZzzUiCurveGraphic_CurveSegment_TypeDefinitionIndex = 76422;
