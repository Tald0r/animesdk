...
#define CURTAINCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x6744FC0)
#define CURTAINCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x6744EA0)
#define CURTAINCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x6745110)
#define CURTAINCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x6745320)
#define CURTAINCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x67457D0)

inline static constexpr unsigned int CurtainController_TypeDefinitionIndex = 76015;
