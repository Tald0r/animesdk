...
#define BLEND2DDATA_FROMBINARY_OFFSET UNITYSDK_OFFSET(0xD07C810)
#define BLEND2DDATA_FROMFLX_OFFSET UNITYSDK_OFFSET(0xD07AEF0)
#define BLEND2DDATA_FROMJSON_OFFSET UNITYSDK_OFFSET(0xD07AFB0)
#define BLEND2DDATA_TOBINARY_OFFSET UNITYSDK_OFFSET(0xD07C8C0)
#define BLEND2DDATA_TOJSON_OFFSET UNITYSDK_OFFSET(0xD07C770)
#define BLEND2DDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xD07C970)

inline static constexpr unsigned int Blend2dData_TypeDefinitionIndex = 65002;
