...
#define COMPUTERGROUP_GETSCREENDATA_OFFSET UNITYSDK_OFFSET(0x908D5E0)
#define COMPUTERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x908D6C0)

inline static constexpr unsigned int ComputerGroup_TypeDefinitionIndex = 47132;
