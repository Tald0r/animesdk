...
#define COMPUTERGROUP_GETSCREENDATA_OFFSET UNITYSDK_OFFSET(0x9F3D560)
#define COMPUTERGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x9F3D640)

inline static constexpr unsigned int ComputerGroup_TypeDefinitionIndex = 74699;
