...
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_4F49AC32E99BB202_OFFSET UNITYSDK_OFFSET(0x302620)
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_5E256ABCBB78EAD2_1_OFFSET UNITYSDK_OFFSET(0x302750)
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_5E256ABCBB78EAD2_OFFSET UNITYSDK_OFFSET(0x302580)
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_A538D7DBA7BF5017_OFFSET UNITYSDK_OFFSET(0x6480020)
#define STRUCT_2_DBBF6AB516C866C7_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x3026C0)
#define STRUCT_2_DBBF6AB516C866C7__CCTOR_OFFSET UNITYSDK_OFFSET(0x647FFC0)

inline static constexpr unsigned int Struct_2_DBBF6AB516C866C7_TypeDefinitionIndex = 71636;

struct alignas(8) Struct_2_DBBF6AB516C866C7
{
	static ::Struct_2_DBBF6AB516C866C7* StaticGet_Field_2_11()
	{
		return (::Struct_2_DBBF6AB516C866C7*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_DBBF6AB516C866C7_TypeDefinitionIndex)->GetStaticField(0x2CE60);
	}
