...
#define UIDRAGCOMPONENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1388E500)
#define UIDRAGCOMPONENT_FORBIDRIGHTMOUSEINPUT_OFFSET UNITYSDK_OFFSET(0x1388F720)
#define UIDRAGCOMPONENT_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x1388EF70)
#define UIDRAGCOMPONENT_REGISTERCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x1388F520)
#define UIDRAGCOMPONENT_REGISTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1388F1C0)
#define UIDRAGCOMPONENT_RESET_OFFSET UNITYSDK_OFFSET(0x1388F790)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IBEGINDRAGHANDLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x1388E5D0)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IDRAGHANDLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1388E840)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IENDDRAGHANDLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x1388EAB0)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IPOINTERDOWNHANDLER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1388ED20)
#define UIDRAGCOMPONENT_UNREGISTERCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x1388F620)
#define UIDRAGCOMPONENT_UNREGISTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x1388F370)
#define UIDRAGCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1388F810)

inline static constexpr unsigned int UIDragComponent_TypeDefinitionIndex = 46795;
