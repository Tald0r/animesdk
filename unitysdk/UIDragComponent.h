...
#define UIDRAGCOMPONENT_AWAKE_OFFSET UNITYSDK_OFFSET(0x1919FF90)
#define UIDRAGCOMPONENT_FORBIDRIGHTMOUSEINPUT_OFFSET UNITYSDK_OFFSET(0x191A11B0)
#define UIDRAGCOMPONENT_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0x191A0A00)
#define UIDRAGCOMPONENT_REGISTERCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x191A0FB0)
#define UIDRAGCOMPONENT_REGISTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x191A0C50)
#define UIDRAGCOMPONENT_RESET_OFFSET UNITYSDK_OFFSET(0x191A1220)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IBEGINDRAGHANDLER_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0x191A0060)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IDRAGHANDLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x191A02D0)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IENDDRAGHANDLER_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0x191A0540)
#define UIDRAGCOMPONENT_UNITYENGINE_EVENTSYSTEMS_IPOINTERDOWNHANDLER_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x191A07B0)
#define UIDRAGCOMPONENT_UNREGISTERCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x191A10B0)
#define UIDRAGCOMPONENT_UNREGISTERCALLBACK_OFFSET UNITYSDK_OFFSET(0x191A0E00)
#define UIDRAGCOMPONENT__CTOR_OFFSET UNITYSDK_OFFSET(0x191A12A0)

inline static constexpr unsigned int UIDragComponent_TypeDefinitionIndex = 66953;
