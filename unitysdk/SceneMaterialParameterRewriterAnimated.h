...
#define SCENEMATERIALPARAMETERREWRITERANIMATED_APPLY_OFFSET UNITYSDK_OFFSET(0x173EE4C0)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_CLEARCONTENT_OFFSET UNITYSDK_OFFSET(0x173EF390)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x173EF340)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_ONENABLE_OFFSET UNITYSDK_OFFSET(0x173EE470)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_UPDATE_OFFSET UNITYSDK_OFFSET(0x173EF500)
#define SCENEMATERIALPARAMETERREWRITERANIMATED__CTOR_OFFSET UNITYSDK_OFFSET(0x173EF560)

inline static constexpr unsigned int SceneMaterialParameterRewriterAnimated_TypeDefinitionIndex = 28970;
