...
#define SCENEMATERIALPARAMETERREWRITERANIMATED_APPLY_OFFSET UNITYSDK_OFFSET(0x16D87350)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_CLEARCONTENT_OFFSET UNITYSDK_OFFSET(0x16D88220)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16D881D0)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16D87300)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_UPDATE_OFFSET UNITYSDK_OFFSET(0x16D88390)
#define SCENEMATERIALPARAMETERREWRITERANIMATED__CTOR_OFFSET UNITYSDK_OFFSET(0x16D883F0)

inline static constexpr unsigned int SceneMaterialParameterRewriterAnimated_TypeDefinitionIndex = 28030;
