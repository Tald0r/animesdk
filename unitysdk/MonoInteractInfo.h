...
#define MONOINTERACTINFO_GET_INTERACTSINFO_OFFSET UNITYSDK_OFFSET(0xAD00240)
#define MONOINTERACTINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0xAD001A0)
#define MONOINTERACTINFO_GET_SCALE_OFFSET UNITYSDK_OFFSET(0xAD00230)
#define MONOINTERACTINFO_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0xAD00210)
#define MONOINTERACTINFO_SETINTERACTCONFIG_OFFSET UNITYSDK_OFFSET(0xAD00250)
#define MONOINTERACTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xAD00710)

inline static constexpr unsigned int MonoInteractInfo_TypeDefinitionIndex = 70113;
