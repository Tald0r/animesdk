...
#define MONOGALGAME3D_GET_Z_OFFSET UNITYSDK_OFFSET(0x73FA090)
#define MONOGALGAME3D_SET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x73F9FD0)
#define MONOGALGAME3D_START_OFFSET UNITYSDK_OFFSET(0x73FA0A0)
#define MONOGALGAME3D_UPDATE_OFFSET UNITYSDK_OFFSET(0x73FA130)
#define MONOGALGAME3D__CTOR_OFFSET UNITYSDK_OFFSET(0x605BAD0)

inline static constexpr unsigned int MonoGalGame3D_TypeDefinitionIndex = 41567;
