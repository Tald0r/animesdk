...
#define AKVERTEXARRAY_CLONEINTOREFERENCEFROMINTPTR_OFFSET UNITYSDK_OFFSET(0x1B57BD60)
#define AKVERTEXARRAY_CREATENEWREFERENCEFROMINTPTR_OFFSET UNITYSDK_OFFSET(0x1B57BD50)
#define AKVERTEXARRAY_GET_STRUCTURESIZE_OFFSET UNITYSDK_OFFSET(0x1B57BD40)
#define AKVERTEXARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B57BD00)

inline static constexpr unsigned int AkVertexArray_TypeDefinitionIndex = 31000;
