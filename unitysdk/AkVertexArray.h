...
#define AKVERTEXARRAY_CLONEINTOREFERENCEFROMINTPTR_OFFSET UNITYSDK_OFFSET(0x1AF57F70)
#define AKVERTEXARRAY_CREATENEWREFERENCEFROMINTPTR_OFFSET UNITYSDK_OFFSET(0x1AF57F60)
#define AKVERTEXARRAY_GET_STRUCTURESIZE_OFFSET UNITYSDK_OFFSET(0x1AF57F50)
#define AKVERTEXARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF57F10)

inline static constexpr unsigned int AkVertexArray_TypeDefinitionIndex = 30047;
