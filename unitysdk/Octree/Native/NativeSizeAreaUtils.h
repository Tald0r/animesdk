...
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_ASNODEELEMENTPTR_OFFSET UNITYSDK_OFFSET(0xD823760)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_ASNODEELEMENT_OFFSET UNITYSDK_OFFSET(0xD823750)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMCOPY_OFFSET UNITYSDK_OFFSET(0xD823770)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMEQUALSFAST_OFFSET UNITYSDK_OFFSET(0xD823C40)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMEQUALS_1_OFFSET UNITYSDK_OFFSET(0xD823AA0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMEQUALS_2_OFFSET UNITYSDK_OFFSET(0xD823B70)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMEQUALS_OFFSET UNITYSDK_OFFSET(0xD8239E0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMSET_OFFSET UNITYSDK_OFFSET(0xD8238F0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_READBYTEBE_OFFSET UNITYSDK_OFFSET(0xD823630)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_READINTBE_OFFSET UNITYSDK_OFFSET(0xD8235D0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_READSHORTBE_OFFSET UNITYSDK_OFFSET(0xD823600)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_TOHEX_OFFSET UNITYSDK_OFFSET(0xD823650)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_WRITEBYTEBE_OFFSET UNITYSDK_OFFSET(0xD823640)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_WRITEINTBE_OFFSET UNITYSDK_OFFSET(0xD8235E0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_WRITESHORTBE_OFFSET UNITYSDK_OFFSET(0xD823620)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0xD823E40)

namespace Octree::Native
{
	inline static constexpr unsigned int NativeSizeAreaUtils_TypeDefinitionIndex = 67646;
