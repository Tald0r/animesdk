...
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_ASNODEELEMENTPTR_OFFSET UNITYSDK_OFFSET(0x74E34D0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_ASNODEELEMENT_OFFSET UNITYSDK_OFFSET(0x74E34C0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMCOPY_OFFSET UNITYSDK_OFFSET(0x74E34E0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMEQUALSFAST_OFFSET UNITYSDK_OFFSET(0x74E39B0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMEQUALS_1_OFFSET UNITYSDK_OFFSET(0x74E3810)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMEQUALS_2_OFFSET UNITYSDK_OFFSET(0x74E38E0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMEQUALS_OFFSET UNITYSDK_OFFSET(0x74E3750)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_PTRMEMSET_OFFSET UNITYSDK_OFFSET(0x74E3660)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_READBYTEBE_OFFSET UNITYSDK_OFFSET(0x74E33A0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_READINTBE_OFFSET UNITYSDK_OFFSET(0x74E3340)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_READSHORTBE_OFFSET UNITYSDK_OFFSET(0x74E3370)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_TOHEX_OFFSET UNITYSDK_OFFSET(0x74E33C0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_WRITEBYTEBE_OFFSET UNITYSDK_OFFSET(0x74E33B0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_WRITEINTBE_OFFSET UNITYSDK_OFFSET(0x74E3350)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_WRITESHORTBE_OFFSET UNITYSDK_OFFSET(0x74E3390)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x74E3BB0)

namespace Octree::Native
{
	inline static constexpr unsigned int NativeSizeAreaUtils_TypeDefinitionIndex = 72618;
