...
#define OCTREE_NATIVE_NATIVEPTR_ADD_OFFSET UNITYSDK_OFFSET(0xDDDCD40)
#define OCTREE_NATIVE_NATIVEPTR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x4CCAC0)
#define OCTREE_NATIVE_NATIVEPTR_EQUALS_OFFSET UNITYSDK_OFFSET(0x4CCA50)
#define OCTREE_NATIVE_NATIVEPTR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x4CCB70)
#define OCTREE_NATIVE_NATIVEPTR_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x2C3A90)
#define OCTREE_NATIVE_NATIVEPTR_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0xDDDD1C0)
#define OCTREE_NATIVE_NATIVEPTR_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xDDDD2A0)
#define OCTREE_NATIVE_NATIVEPTR_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0xDDDD1B0)
#define OCTREE_NATIVE_NATIVEPTR_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0xDDDD1A0)
#define OCTREE_NATIVE_NATIVEPTR_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0xDDDD460)
#define OCTREE_NATIVE_NATIVEPTR_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0xDDDD380)
#define OCTREE_NATIVE_NATIVEPTR_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0xDDDD140)
#define OCTREE_NATIVE_NATIVEPTR_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xDDDD0E0)
#define OCTREE_NATIVE_NATIVEPTR_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xDDDD310)
#define OCTREE_NATIVE_NATIVEPTR_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0xDDDD4D0)
#define OCTREE_NATIVE_NATIVEPTR_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0xDDDD3F0)
#define OCTREE_NATIVE_NATIVEPTR_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0xDDDD230)
#define OCTREE_NATIVE_NATIVEPTR_SUBTRACT_OFFSET UNITYSDK_OFFSET(0xDDDCDB0)
#define OCTREE_NATIVE_NATIVEPTR_TOINT32_OFFSET UNITYSDK_OFFSET(0x4CC960)
#define OCTREE_NATIVE_NATIVEPTR_TOINT64_OFFSET UNITYSDK_OFFSET(0x4CC8F0)
#define OCTREE_NATIVE_NATIVEPTR_TOPOINTER_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define OCTREE_NATIVE_NATIVEPTR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x4CC9D0)
#define OCTREE_NATIVE_NATIVEPTR__CCTOR_OFFSET UNITYSDK_OFFSET(0xDDDD540)
#define OCTREE_NATIVE_NATIVEPTR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define OCTREE_NATIVE_NATIVEPTR__CTOR_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define OCTREE_NATIVE_NATIVEPTR___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x4CCBE0)
#define OCTREE_NATIVE_NATIVEPTR___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x4CCC40)
#define OCTREE_NATIVE_NATIVEPTR___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x4CCCA0)

namespace Octree::Native
{
	inline static constexpr unsigned int NativePtr_TypeDefinitionIndex = 56964;

	struct alignas(8) NativePtr
	{
		static ::System::Int32* StaticGet_Size()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NativePtr_TypeDefinitionIndex)->GetStaticField(0xEF90);
		}
		static ::Octree::Native::NativePtr* StaticGet_Zero()
		{
			return (::Octree::Native::NativePtr*)Il2CppClass::FromTypeDefinitionIndex(NativePtr_TypeDefinitionIndex)->GetStaticField(0xEF98);
		}
