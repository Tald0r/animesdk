...
#define OCTREE_NATIVE_NATIVEPTR_ADD_OFFSET UNITYSDK_OFFSET(0xD6FB760)
#define OCTREE_NATIVE_NATIVEPTR_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x45E3E0)
#define OCTREE_NATIVE_NATIVEPTR_EQUALS_OFFSET UNITYSDK_OFFSET(0x45E370)
#define OCTREE_NATIVE_NATIVEPTR_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x45E490)
#define OCTREE_NATIVE_NATIVEPTR_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x314B50)
#define OCTREE_NATIVE_NATIVEPTR_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0xD6FBBE0)
#define OCTREE_NATIVE_NATIVEPTR_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xD6FBCC0)
#define OCTREE_NATIVE_NATIVEPTR_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0xD6FBBD0)
#define OCTREE_NATIVE_NATIVEPTR_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0xD6FBBC0)
#define OCTREE_NATIVE_NATIVEPTR_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0xD6FBE80)
#define OCTREE_NATIVE_NATIVEPTR_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0xD6FBDA0)
#define OCTREE_NATIVE_NATIVEPTR_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0xD6FBB60)
#define OCTREE_NATIVE_NATIVEPTR_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0xD6FBB00)
#define OCTREE_NATIVE_NATIVEPTR_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xD6FBD30)
#define OCTREE_NATIVE_NATIVEPTR_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0xD6FBEF0)
#define OCTREE_NATIVE_NATIVEPTR_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0xD6FBE10)
#define OCTREE_NATIVE_NATIVEPTR_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0xD6FBC50)
#define OCTREE_NATIVE_NATIVEPTR_SUBTRACT_OFFSET UNITYSDK_OFFSET(0xD6FB7D0)
#define OCTREE_NATIVE_NATIVEPTR_TOINT32_OFFSET UNITYSDK_OFFSET(0x45E280)
#define OCTREE_NATIVE_NATIVEPTR_TOINT64_OFFSET UNITYSDK_OFFSET(0x45E210)
#define OCTREE_NATIVE_NATIVEPTR_TOPOINTER_OFFSET UNITYSDK_OFFSET(0x223870)
#define OCTREE_NATIVE_NATIVEPTR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x45E2F0)
#define OCTREE_NATIVE_NATIVEPTR__CCTOR_OFFSET UNITYSDK_OFFSET(0xD6FBF60)
#define OCTREE_NATIVE_NATIVEPTR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define OCTREE_NATIVE_NATIVEPTR__CTOR_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define OCTREE_NATIVE_NATIVEPTR___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x45E500)
#define OCTREE_NATIVE_NATIVEPTR___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x45E560)
#define OCTREE_NATIVE_NATIVEPTR___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x45E5C0)

namespace Octree::Native
{
	inline static constexpr unsigned int NativePtr_TypeDefinitionIndex = 49181;

	struct alignas(8) NativePtr
	{
		static ::System::Int32* StaticGet_Size()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NativePtr_TypeDefinitionIndex)->GetStaticField(0xF650);
		}
		static ::Octree::Native::NativePtr* StaticGet_Zero()
		{
			return (::Octree::Native::NativePtr*)Il2CppClass::FromTypeDefinitionIndex(NativePtr_TypeDefinitionIndex)->GetStaticField(0xF658);
		}
