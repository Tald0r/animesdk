...
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMCOPY_OFFSET UNITYSDK_OFFSET(0x74E3BC0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMEQUALSFAST_OFFSET UNITYSDK_OFFSET(0x74E3FD0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMEQUALS_1_OFFSET UNITYSDK_OFFSET(0x74E3D50)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMEQUALS_2_OFFSET UNITYSDK_OFFSET(0x74E3DA0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMEQUALS_OFFSET UNITYSDK_OFFSET(0x74E3D10)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMISZERO_OFFSET UNITYSDK_OFFSET(0x74E3E00)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMSET_OFFSET UNITYSDK_OFFSET(0x74E3CB0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x74E4150)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x74E4140)

namespace Octree::Native
{
	inline static constexpr unsigned int NativeSizeAreaUtils_DNativeUtils_TypeDefinitionIndex = 72619;
	...
	public:
		...
		{
			return (::Octree::Native::SIMD::uint4*)Il2CppClass::FromTypeDefinitionIndex(NativeSizeAreaUtils_DNativeUtils_TypeDefinitionIndex)->GetStaticField(0xBBD0);
		}
