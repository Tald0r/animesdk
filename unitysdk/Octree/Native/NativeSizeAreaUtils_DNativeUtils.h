...
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMCOPY_OFFSET UNITYSDK_OFFSET(0xD823E50)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMEQUALSFAST_OFFSET UNITYSDK_OFFSET(0xD824260)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMEQUALS_1_OFFSET UNITYSDK_OFFSET(0xD823FE0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMEQUALS_2_OFFSET UNITYSDK_OFFSET(0xD824030)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMEQUALS_OFFSET UNITYSDK_OFFSET(0xD823FA0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMISZERO_OFFSET UNITYSDK_OFFSET(0xD824090)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS_PTRMEMSET_OFFSET UNITYSDK_OFFSET(0xD823F40)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0xD8243E0)
#define OCTREE_NATIVE_NATIVESIZEAREAUTILS_DNATIVEUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0xD8243D0)

namespace Octree::Native
{
	inline static constexpr unsigned int NativeSizeAreaUtils_DNativeUtils_TypeDefinitionIndex = 67647;
	...
	public:
		...
		{
			return (::Octree::Native::SIMD::uint4*)Il2CppClass::FromTypeDefinitionIndex(NativeSizeAreaUtils_DNativeUtils_TypeDefinitionIndex)->GetStaticField(0xC7E0);
		}
