...
#define OCTREE_BOUNDINGBOX_CONTAINS_OFFSET UNITYSDK_OFFSET(0x3743B0)
#define OCTREE_BOUNDINGBOX_ENCAPSULATE_1_OFFSET UNITYSDK_OFFSET(0x374230)
#define OCTREE_BOUNDINGBOX_ENCAPSULATE_OFFSET UNITYSDK_OFFSET(0x374200)
#define OCTREE_BOUNDINGBOX_EQUALS_OFFSET UNITYSDK_OFFSET(0x374710)
#define OCTREE_BOUNDINGBOX_EXPAND_1_OFFSET UNITYSDK_OFFSET(0x374300)
#define OCTREE_BOUNDINGBOX_EXPAND_OFFSET UNITYSDK_OFFSET(0x374260)
#define OCTREE_BOUNDINGBOX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x374510)
#define OCTREE_BOUNDINGBOX_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define OCTREE_BOUNDINGBOX_GET_EXTENTS_OFFSET UNITYSDK_OFFSET(0x2D0730)
#define OCTREE_BOUNDINGBOX_GET_MAX_OFFSET UNITYSDK_OFFSET(0x2D0760)
#define OCTREE_BOUNDINGBOX_GET_MIN_OFFSET UNITYSDK_OFFSET(0x374030)
#define OCTREE_BOUNDINGBOX_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x373F60)
#define OCTREE_BOUNDINGBOX_INTERSECTRAY_1_OFFSET UNITYSDK_OFFSET(0x3744E0)
#define OCTREE_BOUNDINGBOX_INTERSECTRAY_OFFSET UNITYSDK_OFFSET(0x374430)
#define OCTREE_BOUNDINGBOX_INTERSECTSPHERE_OFFSET UNITYSDK_OFFSET(0x374410)
#define OCTREE_BOUNDINGBOX_INTERSECTS_OFFSET UNITYSDK_OFFSET(0x3743E0)
#define OCTREE_BOUNDINGBOX_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x9EFFB00)
#define OCTREE_BOUNDINGBOX_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x9EFFBE0)
#define OCTREE_BOUNDINGBOX_SETMINMAX_OFFSET UNITYSDK_OFFSET(0x374100)
#define OCTREE_BOUNDINGBOX_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x2C4D20)
#define OCTREE_BOUNDINGBOX_SET_EXTENTS_OFFSET UNITYSDK_OFFSET(0x2D0750)
#define OCTREE_BOUNDINGBOX_SET_MAX_OFFSET UNITYSDK_OFFSET(0x374090)
#define OCTREE_BOUNDINGBOX_SET_MIN_OFFSET UNITYSDK_OFFSET(0x374060)
#define OCTREE_BOUNDINGBOX_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x373F80)
#define OCTREE_BOUNDINGBOX_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x374730)
#define OCTREE_BOUNDINGBOX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x374720)
#define OCTREE_BOUNDINGBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x3740C0)
#define OCTREE_BOUNDINGBOX__INTERSECTSPHERE_G__CLAMP_25_0_OFFSET UNITYSDK_OFFSET(0x9EFF290)
#define OCTREE_BOUNDINGBOX___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x374740)
#define OCTREE_BOUNDINGBOX___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3747B0)
#define OCTREE_BOUNDINGBOX___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x374820)

namespace Octree
{
	inline static constexpr unsigned int BoundingBox_TypeDefinitionIndex = 55587;
