...
#define OCTREE_BOUNDINGBOX_CONTAINS_OFFSET UNITYSDK_OFFSET(0x2F8EA0)
#define OCTREE_BOUNDINGBOX_ENCAPSULATE_1_OFFSET UNITYSDK_OFFSET(0x2F8D20)
#define OCTREE_BOUNDINGBOX_ENCAPSULATE_OFFSET UNITYSDK_OFFSET(0x2F8CF0)
#define OCTREE_BOUNDINGBOX_EQUALS_OFFSET UNITYSDK_OFFSET(0x2F9200)
#define OCTREE_BOUNDINGBOX_EXPAND_1_OFFSET UNITYSDK_OFFSET(0x2F8DF0)
#define OCTREE_BOUNDINGBOX_EXPAND_OFFSET UNITYSDK_OFFSET(0x2F8D50)
#define OCTREE_BOUNDINGBOX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F9000)
#define OCTREE_BOUNDINGBOX_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x2EA460)
#define OCTREE_BOUNDINGBOX_GET_EXTENTS_OFFSET UNITYSDK_OFFSET(0x2F89F0)
#define OCTREE_BOUNDINGBOX_GET_MAX_OFFSET UNITYSDK_OFFSET(0x2F8B50)
#define OCTREE_BOUNDINGBOX_GET_MIN_OFFSET UNITYSDK_OFFSET(0x2F8AF0)
#define OCTREE_BOUNDINGBOX_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x2F8A20)
#define OCTREE_BOUNDINGBOX_INTERSECTRAY_1_OFFSET UNITYSDK_OFFSET(0x2F8FD0)
#define OCTREE_BOUNDINGBOX_INTERSECTRAY_OFFSET UNITYSDK_OFFSET(0x2F8F20)
#define OCTREE_BOUNDINGBOX_INTERSECTSPHERE_OFFSET UNITYSDK_OFFSET(0x2F8F00)
#define OCTREE_BOUNDINGBOX_INTERSECTS_OFFSET UNITYSDK_OFFSET(0x2F8ED0)
#define OCTREE_BOUNDINGBOX_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x63D8A30)
#define OCTREE_BOUNDINGBOX_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x63D8B10)
#define OCTREE_BOUNDINGBOX_SETMINMAX_OFFSET UNITYSDK_OFFSET(0x2F8BF0)
#define OCTREE_BOUNDINGBOX_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x2EA450)
#define OCTREE_BOUNDINGBOX_SET_EXTENTS_OFFSET UNITYSDK_OFFSET(0x2F8A10)
#define OCTREE_BOUNDINGBOX_SET_MAX_OFFSET UNITYSDK_OFFSET(0x2F8B80)
#define OCTREE_BOUNDINGBOX_SET_MIN_OFFSET UNITYSDK_OFFSET(0x2F8B20)
#define OCTREE_BOUNDINGBOX_SET_SIZE_OFFSET UNITYSDK_OFFSET(0x2F8A40)
#define OCTREE_BOUNDINGBOX_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x2F9220)
#define OCTREE_BOUNDINGBOX_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2F9210)
#define OCTREE_BOUNDINGBOX__CTOR_OFFSET UNITYSDK_OFFSET(0x2F8BB0)
#define OCTREE_BOUNDINGBOX__INTERSECTSPHERE_G__CLAMP_25_0_OFFSET UNITYSDK_OFFSET(0x63D81C0)
#define OCTREE_BOUNDINGBOX___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x2F9230)
#define OCTREE_BOUNDINGBOX___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x2F92A0)
#define OCTREE_BOUNDINGBOX___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2F9310)

namespace Octree
{
	inline static constexpr unsigned int BoundingBox_TypeDefinitionIndex = 68503;
