...
#define OCTREE_SPHERE_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define OCTREE_SPHERE_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x2D8630)
#define OCTREE_SPHERE_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x2C4D20)
#define OCTREE_SPHERE_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x33FDA0)
#define OCTREE_SPHERE_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x33FDE0)
#define OCTREE_SPHERE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x33FDD0)
#define OCTREE_SPHERE__CTOR_OFFSET UNITYSDK_OFFSET(0x33FDB0)
#define OCTREE_SPHERE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x33FDF0)

namespace Octree
{
	inline static constexpr unsigned int Sphere_TypeDefinitionIndex = 49501;
