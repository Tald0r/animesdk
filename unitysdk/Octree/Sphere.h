...
#define OCTREE_SPHERE_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x2EA460)
#define OCTREE_SPHERE_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x2EB550)
#define OCTREE_SPHERE_SET_CENTER_OFFSET UNITYSDK_OFFSET(0x2EA450)
#define OCTREE_SPHERE_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x351EB0)
#define OCTREE_SPHERE_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x7425B0)
#define OCTREE_SPHERE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7425A0)
#define OCTREE_SPHERE__CTOR_OFFSET UNITYSDK_OFFSET(0x312860)
#define OCTREE_SPHERE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7425C0)

namespace Octree
{
	inline static constexpr unsigned int Sphere_TypeDefinitionIndex = 79633;
