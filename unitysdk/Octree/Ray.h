...
#define OCTREE_RAY_GETPOINT_OFFSET UNITYSDK_OFFSET(0x39A310)
#define OCTREE_RAY_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x2F89F0)
#define OCTREE_RAY_GET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x2EA460)
#define OCTREE_RAY_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x39A1C0)
#define OCTREE_RAY_SET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x2EA450)
#define OCTREE_RAY_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x39A3D0)
#define OCTREE_RAY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x39A3C0)
#define OCTREE_RAY__CTOR_OFFSET UNITYSDK_OFFSET(0x39A290)
#define OCTREE_RAY___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x39A3E0)

namespace Octree
{
	inline static constexpr unsigned int Ray_TypeDefinitionIndex = 54276;
