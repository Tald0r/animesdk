...
#define OCTREE_RAY_GETPOINT_OFFSET UNITYSDK_OFFSET(0x35BD60)
#define OCTREE_RAY_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x2D0730)
#define OCTREE_RAY_GET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define OCTREE_RAY_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x35BC10)
#define OCTREE_RAY_SET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x2C4D20)
#define OCTREE_RAY_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x35BE20)
#define OCTREE_RAY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x35BE10)
#define OCTREE_RAY__CTOR_OFFSET UNITYSDK_OFFSET(0x35BCE0)
#define OCTREE_RAY___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x35BE30)

namespace Octree
{
	inline static constexpr unsigned int Ray_TypeDefinitionIndex = 73286;
