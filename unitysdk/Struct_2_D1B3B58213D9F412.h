...
#define STRUCT_2_D1B3B58213D9F412_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x341C60)
#define STRUCT_2_D1B3B58213D9F412_METHOD_2_776272FEED5AE92B_OFFSET UNITYSDK_OFFSET(0x341C50)
#define STRUCT_2_D1B3B58213D9F412_TOSTRING_OFFSET UNITYSDK_OFFSET(0x341C40)
#define STRUCT_2_D1B3B58213D9F412__CCTOR_OFFSET UNITYSDK_OFFSET(0x7B05B90)
#define STRUCT_2_D1B3B58213D9F412__CTOR_OFFSET UNITYSDK_OFFSET(0x341C00)

inline static constexpr unsigned int Struct_2_D1B3B58213D9F412_TypeDefinitionIndex = 79119;

struct alignas(4) Struct_2_D1B3B58213D9F412
{
	static ::System::Int32* StaticGet_Field_2_0()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_D1B3B58213D9F412_TypeDefinitionIndex)->GetStaticField(0xD6B0);
	}
