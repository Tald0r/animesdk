...
#define CONVERTHELPER_CHARTOINT_OFFSET UNITYSDK_OFFSET(0xA43B670)
#define CONVERTHELPER_STRINGTOINTLIST_OFFSET UNITYSDK_OFFSET(0xA43B6D0)

inline static constexpr unsigned int ConvertHelper_TypeDefinitionIndex = 76128;
