...
#define MAP3DLIFTRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x95C1510)
#define MAP3DLIFTRENDERER_SETUPLIFTEFFECT_OFFSET UNITYSDK_OFFSET(0x95C1A80)
#define MAP3DLIFTRENDERER_SWITCHLINETYPE_OFFSET UNITYSDK_OFFSET(0x95C2250)
#define MAP3DLIFTRENDERER_UPDATECURRENTDISTANCE_OFFSET UNITYSDK_OFFSET(0x95C2450)
#define MAP3DLIFTRENDERER_UPDATE_OFFSET UNITYSDK_OFFSET(0x95C2540)
#define MAP3DLIFTRENDERER__CCTOR_OFFSET UNITYSDK_OFFSET(0x95C2C10)
#define MAP3DLIFTRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x95C2A50)

inline static constexpr unsigned int Map3DLiftRenderer_TypeDefinitionIndex = 64544;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Map3DLiftRenderer_TypeDefinitionIndex)->GetStaticField(0xB480);
	}
