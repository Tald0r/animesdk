...
#define MONOEFFECTPARTICLEGUIDELINE_CONTROLPARTICLE_OFFSET UNITYSDK_OFFSET(0x71F7330)
#define MONOEFFECTPARTICLEGUIDELINE_CRATEMESH_OFFSET UNITYSDK_OFFSET(0x71F75D0)
#define MONOEFFECTPARTICLEGUIDELINE_GENERATEMESH_OFFSET UNITYSDK_OFFSET(0x71F7A30)
#define MONOEFFECTPARTICLEGUIDELINE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x71F8FB0)
#define MONOEFFECTPARTICLEGUIDELINE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x71F7930)
#define MONOEFFECTPARTICLEGUIDELINE_REFRESHGUIDELINE_OFFSET UNITYSDK_OFFSET(0x71F8EB0)
#define MONOEFFECTPARTICLEGUIDELINE_START_OFFSET UNITYSDK_OFFSET(0x71F71E0)
#define MONOEFFECTPARTICLEGUIDELINE_TESTREFRESHGUIDELINE_OFFSET UNITYSDK_OFFSET(0x71F8DA0)
#define MONOEFFECTPARTICLEGUIDELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x71F9100)

inline static constexpr unsigned int MonoEffectParticleGuideLine_TypeDefinitionIndex = 39014;
