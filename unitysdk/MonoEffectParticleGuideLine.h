...
#define MONOEFFECTPARTICLEGUIDELINE_CONTROLPARTICLE_OFFSET UNITYSDK_OFFSET(0x9ACB150)
#define MONOEFFECTPARTICLEGUIDELINE_CRATEMESH_OFFSET UNITYSDK_OFFSET(0x9ACB3F0)
#define MONOEFFECTPARTICLEGUIDELINE_GENERATEMESH_OFFSET UNITYSDK_OFFSET(0x9ACB850)
#define MONOEFFECTPARTICLEGUIDELINE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9ACCDD0)
#define MONOEFFECTPARTICLEGUIDELINE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9ACB750)
#define MONOEFFECTPARTICLEGUIDELINE_REFRESHGUIDELINE_OFFSET UNITYSDK_OFFSET(0x9ACCCD0)
#define MONOEFFECTPARTICLEGUIDELINE_START_OFFSET UNITYSDK_OFFSET(0x9ACB000)
#define MONOEFFECTPARTICLEGUIDELINE_TESTREFRESHGUIDELINE_OFFSET UNITYSDK_OFFSET(0x9ACCBC0)
#define MONOEFFECTPARTICLEGUIDELINE__CTOR_OFFSET UNITYSDK_OFFSET(0x9ACCF20)

inline static constexpr unsigned int MonoEffectParticleGuideLine_TypeDefinitionIndex = 55752;
