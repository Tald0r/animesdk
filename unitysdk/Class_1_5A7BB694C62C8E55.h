...
#define CLASS_1_5A7BB694C62C8E55__CTOR_OFFSET UNITYSDK_OFFSET(0x767CAB0)

inline static constexpr unsigned int Class_1_5A7BB694C62C8E55_TypeDefinitionIndex = 39617;
...
public:
	...
	::Enum_3_DB663931210BBC27_26 Field_1_4; // 0x20
