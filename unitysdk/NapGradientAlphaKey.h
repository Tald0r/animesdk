...
#define NAPGRADIENTALPHAKEY_COMPARETO_OFFSET UNITYSDK_OFFSET(0x324E40)
#define NAPGRADIENTALPHAKEY_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x7454E80)
#define NAPGRADIENTALPHAKEY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define NAPGRADIENTALPHAKEY__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define NAPGRADIENTALPHAKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x324E30)

inline static constexpr unsigned int NapGradientAlphaKey_TypeDefinitionIndex = 64567;
