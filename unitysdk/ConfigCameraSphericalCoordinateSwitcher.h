...
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_CALCULATECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0xD620090)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_GET_ISTICKING_OFFSET UNITYSDK_OFFSET(0xD6202E0)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_ONCLICKSWITCH_OFFSET UNITYSDK_OFFSET(0xD61FF50)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_REGONSWITCHCOMPLETE_OFFSET UNITYSDK_OFFSET(0xD61FDF0)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_REGONSWITCHSTART_OFFSET UNITYSDK_OFFSET(0xD61FE60)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_SETCAMERAANDVIEWTARGET_OFFSET UNITYSDK_OFFSET(0xD61FED0)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_SWITCHCAMERA_OFFSET UNITYSDK_OFFSET(0xD61FFE0)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_UPDATE_OFFSET UNITYSDK_OFFSET(0xD620250)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_WAITUNTILTIMECURSOR_OFFSET UNITYSDK_OFFSET(0xD620160)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0xD6202F0)

inline static constexpr unsigned int ConfigCameraSphericalCoordinateSwitcher_TypeDefinitionIndex = 68008;

class ConfigCameraSphericalCoordinateSwitcher : public ::System::Object
{
public:
	::System::Action* m_onSwitchStart; // 0x10
	::UnityEngine::Coroutine* m_switchCoroutine; // 0x18
	::UnityEngine::Transform* m_viewTarget; // 0x20
	::System::Threading::CancellationTokenSource* m_originalSource; // 0x28
	::System::Action* m_onSwitchComplete; // 0x30
	::UnityEngine::Transform* m_cam; // 0x38
	::MoleMole::Config::PlayerAccessoryTabData* m_prevConfigID; // 0x40
