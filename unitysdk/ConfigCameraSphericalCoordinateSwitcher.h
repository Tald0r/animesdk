...
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_CALCULATECAMERAPOSITION_OFFSET UNITYSDK_OFFSET(0x9D2E3F0)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_GET_ISTICKING_OFFSET UNITYSDK_OFFSET(0x9D2E640)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_ONCLICKSWITCH_OFFSET UNITYSDK_OFFSET(0x9D2E2B0)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_REGONSWITCHCOMPLETE_OFFSET UNITYSDK_OFFSET(0x9D2E150)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_REGONSWITCHSTART_OFFSET UNITYSDK_OFFSET(0x9D2E1C0)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_SETCAMERAANDVIEWTARGET_OFFSET UNITYSDK_OFFSET(0x9D2E230)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_SWITCHCAMERA_OFFSET UNITYSDK_OFFSET(0x9D2E340)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D2E5B0)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER_WAITUNTILTIMECURSOR_OFFSET UNITYSDK_OFFSET(0x9D2E4C0)
#define CONFIGCAMERASPHERICALCOORDINATESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x9D2E650)

inline static constexpr unsigned int ConfigCameraSphericalCoordinateSwitcher_TypeDefinitionIndex = 78823;
