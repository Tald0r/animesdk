...
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_CONVERTVECTOR2TOSCROLLFLOAT_OFFSET UNITYSDK_OFFSET(0xA09C020)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GETCONTENTSIZEATAXIS_OFFSET UNITYSDK_OFFSET(0xA09C090)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GET_CONTENTSELECTALIGNCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0xA09A8D0)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GET_CONTENTSELECTALIGNSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0xA09A700)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GET_CONTENTSELECTALIGNTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0xA09AAA0)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GET_CONTENTSIZE_OFFSET UNITYSDK_OFFSET(0xA09A610)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GET_CURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0xA09BD30)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GET_PADDINGEND_OFFSET UNITYSDK_OFFSET(0xA09B020)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GET_PADDINGSTART_OFFSET UNITYSDK_OFFSET(0xA09ADB0)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GET_SCROLLBARVALUE_OFFSET UNITYSDK_OFFSET(0xA09B860)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GET_SPACEATAXIS_OFFSET UNITYSDK_OFFSET(0xA09B290)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GET_SPACEATOTHERAXIS_OFFSET UNITYSDK_OFFSET(0xA09B5D0)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GET_VIEWRECTSIZEATAXIS_OFFSET UNITYSDK_OFFSET(0xA09AC70)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_GET_VIEWRECTSIZEATOTHERAXIS_OFFSET UNITYSDK_OFFSET(0xA09AD10)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_SETSCROLLBARVALUEWITHOUTNOTIFY_OFFSET UNITYSDK_OFFSET(0xA09BB70)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_SET_CONTENTSELECTALIGNCURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0xA09A980)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_SET_CONTENTSELECTALIGNSTARTPOSITION_OFFSET UNITYSDK_OFFSET(0xA09A7B0)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_SET_CONTENTSELECTALIGNTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0xA09AB50)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_SET_CURRENTPOSITION_OFFSET UNITYSDK_OFFSET(0xA09BDD0)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_SET_PADDINGEND_OFFSET UNITYSDK_OFFSET(0xA09B060)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_SET_PADDINGSTART_OFFSET UNITYSDK_OFFSET(0xA09ADF0)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_SET_SCROLLBARVALUE_OFFSET UNITYSDK_OFFSET(0xA09B970)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_SET_SPACEATAXIS_OFFSET UNITYSDK_OFFSET(0xA09B380)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC_SET_SPACEATOTHERAXIS_OFFSET UNITYSDK_OFFSET(0xA09B6C0)
#define MONOUITABLESCROLLV2_HORIZONTALLOGIC__CTOR_OFFSET UNITYSDK_OFFSET(0xA09C140)

inline static constexpr unsigned int MonoUITableScrollV2_HorizontalLogic_TypeDefinitionIndex = 43803;
