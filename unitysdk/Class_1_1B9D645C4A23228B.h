...
#define CLASS_1_1B9D645C4A23228B_ISCONTEXTOF_OFFSET UNITYSDK_OFFSET(0xE7C1270)
#define CLASS_1_1B9D645C4A23228B_METHOD_1_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0xE7C1260)
#define CLASS_1_1B9D645C4A23228B_METHOD_1_E7F1AECA7CFF8AAD_OFFSET UNITYSDK_OFFSET(0xE7C12F0)
#define CLASS_1_1B9D645C4A23228B__CTOR_OFFSET UNITYSDK_OFFSET(0xE7C12E0)

inline static constexpr unsigned int Class_1_1B9D645C4A23228B_TypeDefinitionIndex = 55175;
