...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITDATA_FILLPIVOTBOUNDSBYPIVOT_OFFSET UNITYSDK_OFFSET(0x6453970)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITDATA_PROCESSALIGNPARAM_OFFSET UNITYSDK_OFFSET(0x6453620)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6453610)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginInitData_TypeDefinitionIndex = 43835;
