...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITDATA_FILLPIVOTBOUNDSBYPIVOT_OFFSET UNITYSDK_OFFSET(0x792B1A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITDATA_PROCESSALIGNPARAM_OFFSET UNITYSDK_OFFSET(0x792AE50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGININITDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x792AE40)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginInitData_TypeDefinitionIndex = 64414;
