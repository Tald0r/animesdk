...
#define MB3_MESHBAKERGROUPER_CREATEGROUPER_OFFSET UNITYSDK_OFFSET(0x1A94A4E0)
#define MB3_MESHBAKERGROUPER_DELETEALLCHILDMESHBAKERS_OFFSET UNITYSDK_OFFSET(0x1A94A570)
#define MB3_MESHBAKERGROUPER_GENERATEMESHBAKERS_OFFSET UNITYSDK_OFFSET(0x1A94A7A0)
#define MB3_MESHBAKERGROUPER_GETMESHBAKERSETTINGSASSERIALIZEDPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A94A310)
#define MB3_MESHBAKERGROUPER_GETMESHBAKERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A94A220)
#define MB3_MESHBAKERGROUPER_ONDRAWGIZMOSSELECTED_OFFSET UNITYSDK_OFFSET(0x1A94A3E0)
#define MB3_MESHBAKERGROUPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A94B210)
#define MB3_MESHBAKERGROUPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A94B1B0)

inline static constexpr unsigned int MB3_MeshBakerGrouper_TypeDefinitionIndex = 81199;
...
public:
	...
	{
		return (::UnityEngine::Color*)Il2CppClass::FromTypeDefinitionIndex(MB3_MeshBakerGrouper_TypeDefinitionIndex)->GetStaticField(0x119B0);
	}
