...
#define MB3_DISABLEHIDDENANIMATIONS_ONBECAMEINVISIBLE_OFFSET UNITYSDK_OFFSET(0x1A32CD70)
#define MB3_DISABLEHIDDENANIMATIONS_ONBECAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x1A32CC40)
#define MB3_DISABLEHIDDENANIMATIONS_START_OFFSET UNITYSDK_OFFSET(0x1A32CAB0)
#define MB3_DISABLEHIDDENANIMATIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A32CEA0)

inline static constexpr unsigned int MB3_DisableHiddenAnimations_TypeDefinitionIndex = 83236;
