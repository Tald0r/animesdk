...
#define GIZMOSAREACREATEPOINTS__CTOR_OFFSET UNITYSDK_OFFSET(0xD7500D0)

inline static constexpr unsigned int GizmosAreaCreatePoints_TypeDefinitionIndex = 71276;
