...
#define MB3_MESHBAKERCOMMON_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1AF2A110)
#define MB3_MESHBAKERCOMMON_APPLY_OFFSET UNITYSDK_OFFSET(0x1AF29E90)
#define MB3_MESHBAKERCOMMON_CLEARMESH_1_OFFSET UNITYSDK_OFFSET(0x1AF29A30)
#define MB3_MESHBAKERCOMMON_CLEARMESH_OFFSET UNITYSDK_OFFSET(0x1AF299B0)
#define MB3_MESHBAKERCOMMON_COMBINEDMESHCONTAINS_OFFSET UNITYSDK_OFFSET(0x1AF2A430)
#define MB3_MESHBAKERCOMMON_DESTROYMESHEDITOR_OFFSET UNITYSDK_OFFSET(0x1AF29B30)
#define MB3_MESHBAKERCOMMON_DESTROYMESH_OFFSET UNITYSDK_OFFSET(0x1AF29AB0)
#define MB3_MESHBAKERCOMMON_ENABLEDISABLESOURCEOBJECTRENDERERS_OFFSET UNITYSDK_OFFSET(0x1AF29600)
#define MB3_MESHBAKERCOMMON_GETNUMOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1AF29B70)
#define MB3_MESHBAKERCOMMON_GETOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1AF28BD0)
#define MB3_MESHBAKERCOMMON_GETTEXTUREBAKER_OFFSET UNITYSDK_OFFSET(0x1AF29BA0)
#define MB3_MESHBAKERCOMMON_GET_CLEARBUFFERSAFTERBAKE_OFFSET UNITYSDK_OFFSET(0x1AF288A0)
#define MB3_MESHBAKERCOMMON_GET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1AF28B60)
#define MB3_MESHBAKERCOMMON_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AF28890)
#define MB3_MESHBAKERCOMMON_PURGENULLSFROMOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1AF290B0)
#define MB3_MESHBAKERCOMMON_SET_CLEARBUFFERSAFTERBAKE_OFFSET UNITYSDK_OFFSET(0x1AF28A20)
#define MB3_MESHBAKERCOMMON_SET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1AF28B90)
#define MB3_MESHBAKERCOMMON_UPDATEGAMEOBJECTS_1_OFFSET UNITYSDK_OFFSET(0x1AF2A5D0)
#define MB3_MESHBAKERCOMMON_UPDATEGAMEOBJECTS_2_OFFSET UNITYSDK_OFFSET(0x1AF2A730)
#define MB3_MESHBAKERCOMMON_UPDATEGAMEOBJECTS_3_OFFSET UNITYSDK_OFFSET(0x1AF2A8C0)
#define MB3_MESHBAKERCOMMON_UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1AF2A470)
#define MB3_MESHBAKERCOMMON_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBONES_OFFSET UNITYSDK_OFFSET(0x1AF2AAF0)
#define MB3_MESHBAKERCOMMON_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AF2AB40)
#define MB3_MESHBAKERCOMMON_UPDATESKINNEDMESHAPPROXIMATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AF2AAA0)
#define MB3_MESHBAKERCOMMON_UPGRADETOCURRENTVERSIONIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1AF289D0)
#define MB3_MESHBAKERCOMMON__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF2AE10)
#define MB3_MESHBAKERCOMMON__VALIDATEFORUPDATESKINNEDMESHBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AF2AB90)

inline static constexpr unsigned int MB3_MeshBakerCommon_TypeDefinitionIndex = 83238;
