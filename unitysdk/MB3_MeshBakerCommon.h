...
#define MB3_MESHBAKERCOMMON_APPLY_1_OFFSET UNITYSDK_OFFSET(0x1A949500)
#define MB3_MESHBAKERCOMMON_APPLY_OFFSET UNITYSDK_OFFSET(0x1A949280)
#define MB3_MESHBAKERCOMMON_CLEARMESH_1_OFFSET UNITYSDK_OFFSET(0x1A948E20)
#define MB3_MESHBAKERCOMMON_CLEARMESH_OFFSET UNITYSDK_OFFSET(0x1A948DA0)
#define MB3_MESHBAKERCOMMON_COMBINEDMESHCONTAINS_OFFSET UNITYSDK_OFFSET(0x1A949820)
#define MB3_MESHBAKERCOMMON_DESTROYMESHEDITOR_OFFSET UNITYSDK_OFFSET(0x1A948F20)
#define MB3_MESHBAKERCOMMON_DESTROYMESH_OFFSET UNITYSDK_OFFSET(0x1A948EA0)
#define MB3_MESHBAKERCOMMON_ENABLEDISABLESOURCEOBJECTRENDERERS_OFFSET UNITYSDK_OFFSET(0x1A9489F0)
#define MB3_MESHBAKERCOMMON_GETNUMOBJECTSINCOMBINED_OFFSET UNITYSDK_OFFSET(0x1A948F60)
#define MB3_MESHBAKERCOMMON_GETOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1A947FC0)
#define MB3_MESHBAKERCOMMON_GETTEXTUREBAKER_OFFSET UNITYSDK_OFFSET(0x1A948F90)
#define MB3_MESHBAKERCOMMON_GET_CLEARBUFFERSAFTERBAKE_OFFSET UNITYSDK_OFFSET(0x1A947C90)
#define MB3_MESHBAKERCOMMON_GET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1A947F50)
#define MB3_MESHBAKERCOMMON_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1A947C80)
#define MB3_MESHBAKERCOMMON_PURGENULLSFROMOBJECTSTOCOMBINE_OFFSET UNITYSDK_OFFSET(0x1A9484A0)
#define MB3_MESHBAKERCOMMON_SET_CLEARBUFFERSAFTERBAKE_OFFSET UNITYSDK_OFFSET(0x1A947E10)
#define MB3_MESHBAKERCOMMON_SET_TEXTUREBAKERESULTS_OFFSET UNITYSDK_OFFSET(0x1A947F80)
#define MB3_MESHBAKERCOMMON_UPDATEGAMEOBJECTS_1_OFFSET UNITYSDK_OFFSET(0x1A9499C0)
#define MB3_MESHBAKERCOMMON_UPDATEGAMEOBJECTS_2_OFFSET UNITYSDK_OFFSET(0x1A949B20)
#define MB3_MESHBAKERCOMMON_UPDATEGAMEOBJECTS_3_OFFSET UNITYSDK_OFFSET(0x1A949CB0)
#define MB3_MESHBAKERCOMMON_UPDATEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A949860)
#define MB3_MESHBAKERCOMMON_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBONES_OFFSET UNITYSDK_OFFSET(0x1A949EE0)
#define MB3_MESHBAKERCOMMON_UPDATESKINNEDMESHAPPROXIMATEBOUNDSFROMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A949F30)
#define MB3_MESHBAKERCOMMON_UPDATESKINNEDMESHAPPROXIMATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A949E90)
#define MB3_MESHBAKERCOMMON_UPGRADETOCURRENTVERSIONIFNECESSARY_OFFSET UNITYSDK_OFFSET(0x1A947DC0)
#define MB3_MESHBAKERCOMMON__CTOR_OFFSET UNITYSDK_OFFSET(0x1A94A200)
#define MB3_MESHBAKERCOMMON__VALIDATEFORUPDATESKINNEDMESHBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A949F80)

inline static constexpr unsigned int MB3_MeshBakerCommon_TypeDefinitionIndex = 81197;
