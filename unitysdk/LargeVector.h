...
#define LARGEVECTOR_CREATEZEROVECTOR_OFFSET UNITYSDK_OFFSET(0xE83E3A0)
#define LARGEVECTOR_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x539F60)
#define LARGEVECTOR_GET_VECTORS_OFFSET UNITYSDK_OFFSET(0x539EF0)
#define LARGEVECTOR_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0xE83D710)
#define LARGEVECTOR_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0xE83E320)
#define LARGEVECTOR_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0xE83E090)
#define LARGEVECTOR_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0xE83DBD0)
#define LARGEVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x3074E0)

inline static constexpr unsigned int LargeVector_TypeDefinitionIndex = 80641;
