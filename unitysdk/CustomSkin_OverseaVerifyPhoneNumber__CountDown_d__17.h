...
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x87CA920)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x87CAAB0)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x87CAB10)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x87CAAC0)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87CA910)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x87CA900)

inline static constexpr unsigned int CustomSkin_OverseaVerifyPhoneNumber__CountDown_d__17_TypeDefinitionIndex = 73668;
