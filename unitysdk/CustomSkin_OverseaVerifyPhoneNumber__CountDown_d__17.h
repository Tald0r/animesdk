...
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x6E5DCA0)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x6E5DE30)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x6E5DE90)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x6E5DE40)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6E5DC90)
#define CUSTOMSKIN_OVERSEAVERIFYPHONENUMBER__COUNTDOWN_D__17__CTOR_OFFSET UNITYSDK_OFFSET(0x6E5DC80)

inline static constexpr unsigned int CustomSkin_OverseaVerifyPhoneNumber__CountDown_d__17_TypeDefinitionIndex = 65987;
