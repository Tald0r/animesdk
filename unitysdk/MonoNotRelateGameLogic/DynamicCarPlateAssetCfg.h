...
#define MONONOTRELATEGAMELOGIC_DYNAMICCARPLATEASSETCFG__CTOR_OFFSET UNITYSDK_OFFSET(0xEE6FA20)

namespace MonoNotRelateGameLogic
{
	inline static constexpr unsigned int DynamicCarPlateAssetCfg_TypeDefinitionIndex = 77577;
