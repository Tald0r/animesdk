...
#define MONONOTRELATEGAMELOGIC_MONOCUSTOMTEXTMESH_AWAKE_OFFSET UNITYSDK_OFFSET(0x9ACCF80)
#define MONONOTRELATEGAMELOGIC_MONOCUSTOMTEXTMESH_REBUILD_OFFSET UNITYSDK_OFFSET(0x9ACD080)
#define MONONOTRELATEGAMELOGIC_MONOCUSTOMTEXTMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x9ACD1B0)

namespace MonoNotRelateGameLogic
{
	inline static constexpr unsigned int MonoCustomTextMesh_TypeDefinitionIndex = 61947;
