...
#define MONONOTRELATEGAMELOGIC_MONOCUSTOMTEXTMESH_AWAKE_OFFSET UNITYSDK_OFFSET(0x71F9160)
#define MONONOTRELATEGAMELOGIC_MONOCUSTOMTEXTMESH_REBUILD_OFFSET UNITYSDK_OFFSET(0x71F9260)
#define MONONOTRELATEGAMELOGIC_MONOCUSTOMTEXTMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x71F9390)

namespace MonoNotRelateGameLogic
{
	inline static constexpr unsigned int MonoCustomTextMesh_TypeDefinitionIndex = 62629;
