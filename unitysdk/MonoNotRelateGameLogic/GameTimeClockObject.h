...
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x68597F0)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x68593F0)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_ONMAINCITYTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x68599C0)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_UPDATECLOCKTIME_OFFSET UNITYSDK_OFFSET(0x6859670)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_UPDATEHANDROTATION_OFFSET UNITYSDK_OFFSET(0x6859A30)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x6859DF0)

namespace MonoNotRelateGameLogic
{
	inline static constexpr unsigned int GameTimeClockObject_TypeDefinitionIndex = 47842;
