...
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x852ECC0)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x852E8C0)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_ONMAINCITYTIMECHANGED_OFFSET UNITYSDK_OFFSET(0x852EE90)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_UPDATECLOCKTIME_OFFSET UNITYSDK_OFFSET(0x852EB40)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT_UPDATEHANDROTATION_OFFSET UNITYSDK_OFFSET(0x852EF00)
#define MONONOTRELATEGAMELOGIC_GAMETIMECLOCKOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x852F2C0)

namespace MonoNotRelateGameLogic
{
	inline static constexpr unsigned int GameTimeClockObject_TypeDefinitionIndex = 51027;
