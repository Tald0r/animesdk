...
#define STRUCT_2_B83E4BEE65ED8440_METHOD_2_1F8314262457963A_OFFSET UNITYSDK_OFFSET(0x30D9C0)
#define STRUCT_2_B83E4BEE65ED8440_METHOD_2_3F6DD32D583A9FCF_OFFSET UNITYSDK_OFFSET(0x30D9B0)
#define STRUCT_2_B83E4BEE65ED8440_METHOD_2_5489F9CD0AA85DE6_OFFSET UNITYSDK_OFFSET(0x30D9E0)
#define STRUCT_2_B83E4BEE65ED8440_METHOD_2_C3B21C74C45D6F86_OFFSET UNITYSDK_OFFSET(0x30D970)
#define STRUCT_2_B83E4BEE65ED8440_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x30D8F0)
#define STRUCT_2_B83E4BEE65ED8440_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x30D930)
#define STRUCT_2_B83E4BEE65ED8440__CCTOR_OFFSET UNITYSDK_OFFSET(0x6BF70F0)
#define STRUCT_2_B83E4BEE65ED8440__CTOR_OFFSET UNITYSDK_OFFSET(0x30D8A0)

inline static constexpr unsigned int Struct_2_B83E4BEE65ED8440_TypeDefinitionIndex = 42388;

struct alignas(8) Struct_2_B83E4BEE65ED8440
{
	static ::Struct_2_B83E4BEE65ED8440* StaticGet_Field_2_4()
	{
		return (::Struct_2_B83E4BEE65ED8440*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_B83E4BEE65ED8440_TypeDefinitionIndex)->GetStaticField(0xD9A0);
	}
