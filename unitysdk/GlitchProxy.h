...
#define GLITCHPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x961F500)
#define GLITCHPROXY_COPYVALUEFROM_OFFSET UNITYSDK_OFFSET(0x961F870)
#define GLITCHPROXY_SETVALUETO_OFFSET UNITYSDK_OFFSET(0x961FAF0)
#define GLITCHPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x961FA80)
#define GLITCHPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x961FDB0)

inline static constexpr unsigned int GlitchProxy_TypeDefinitionIndex = 46765;
