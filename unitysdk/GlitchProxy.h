...
#define GLITCHPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x7A1E700)
#define GLITCHPROXY_COPYVALUEFROM_OFFSET UNITYSDK_OFFSET(0x7A1EA70)
#define GLITCHPROXY_SETVALUETO_OFFSET UNITYSDK_OFFSET(0x7A1ECF0)
#define GLITCHPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x7A1EC80)
#define GLITCHPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x7A1EFB0)

inline static constexpr unsigned int GlitchProxy_TypeDefinitionIndex = 48482;
