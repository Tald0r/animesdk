...
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x71F9560)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_GET_HASPUSH_OFFSET UNITYSDK_OFFSET(0x31FD90)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_SET_HASPUSH_OFFSET UNITYSDK_OFFSET(0x31FDA0)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x31FDC0)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x31FDB0)

inline static constexpr unsigned int MonoUITableScrollV2_TempRecycleScope_TypeDefinitionIndex = 43888;
