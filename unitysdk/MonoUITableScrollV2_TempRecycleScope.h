...
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x9ACD380)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_GET_HASPUSH_OFFSET UNITYSDK_OFFSET(0x34AA60)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_SET_HASPUSH_OFFSET UNITYSDK_OFFSET(0x34AA50)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x37F2F0)
#define MONOUITABLESCROLLV2_TEMPRECYCLESCOPE__CTOR_OFFSET UNITYSDK_OFFSET(0x37F2E0)

inline static constexpr unsigned int MonoUITableScrollV2_TempRecycleScope_TypeDefinitionIndex = 64436;
