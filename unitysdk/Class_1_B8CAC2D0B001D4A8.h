...
#define CLASS_1_B8CAC2D0B001D4A8_METHOD_1_78DB76B0E64804D4_OFFSET UNITYSDK_OFFSET(0x16C34930)
#define CLASS_1_B8CAC2D0B001D4A8_PROVIDECHARACTERRENDERINGTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x16C33FE0)
#define CLASS_1_B8CAC2D0B001D4A8_RELEASE_OFFSET UNITYSDK_OFFSET(0x16C346C0)
#define CLASS_1_B8CAC2D0B001D4A8__CCTOR_OFFSET UNITYSDK_OFFSET(0x16C34790)
#define CLASS_1_B8CAC2D0B001D4A8__CTOR_OFFSET UNITYSDK_OFFSET(0x16C34780)

inline static constexpr unsigned int Class_1_B8CAC2D0B001D4A8_TypeDefinitionIndex = 74720;
...
public:
	...
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B8CAC2D0B001D4A8_TypeDefinitionIndex)->GetStaticField(0x40650);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_Field_1_1()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(Class_1_B8CAC2D0B001D4A8_TypeDefinitionIndex)->GetStaticField(0x40658);
	}
