...
#define AKIOSSETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x1AF9DCE0)
#define AKIOSSETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x1AF9DCF0)
#define AKIOSSETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1AF9DCD0)
#define AKIOSSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF9DAA0)

inline static constexpr unsigned int AkiOSSettings_TypeDefinitionIndex = 30091;
