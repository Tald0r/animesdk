...
#define AKIOSSETTINGS_GETADVANCEDSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B5A7740)
#define AKIOSSETTINGS_GETCOMMSSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B5A7750)
#define AKIOSSETTINGS_GETUSERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B5A7730)
#define AKIOSSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A7500)

inline static constexpr unsigned int AkiOSSettings_TypeDefinitionIndex = 31044;
