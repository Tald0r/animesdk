...
#define FLEXBUFFERS_FLEXBUFFERBUILDER_MAP_OFFSET UNITYSDK_OFFSET(0x1A298AB0)
#define FLEXBUFFERS_FLEXBUFFERBUILDER_VECTOR_OFFSET UNITYSDK_OFFSET(0x1A298B70)
#define FLEXBUFFERS_FLEXBUFFERBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A298C30)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlexBufferBuilder_TypeDefinitionIndex = 8734;
