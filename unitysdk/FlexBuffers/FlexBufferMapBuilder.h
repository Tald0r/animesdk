...
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADDNULL_OFFSET UNITYSDK_OFFSET(0x93A650)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_10_OFFSET UNITYSDK_OFFSET(0x93A750)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_11_OFFSET UNITYSDK_OFFSET(0x93A760)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_12_OFFSET UNITYSDK_OFFSET(0x93A770)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_13_OFFSET UNITYSDK_OFFSET(0x93A7E0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_14_OFFSET UNITYSDK_OFFSET(0x93A820)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_1_OFFSET UNITYSDK_OFFSET(0x93A6C0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_2_OFFSET UNITYSDK_OFFSET(0x93A6D0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_3_OFFSET UNITYSDK_OFFSET(0x93A6E0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_4_OFFSET UNITYSDK_OFFSET(0x93A6F0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_5_OFFSET UNITYSDK_OFFSET(0x93A700)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_6_OFFSET UNITYSDK_OFFSET(0x93A710)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_7_OFFSET UNITYSDK_OFFSET(0x93A720)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_8_OFFSET UNITYSDK_OFFSET(0x93A730)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_9_OFFSET UNITYSDK_OFFSET(0x93A740)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_OFFSET UNITYSDK_OFFSET(0x93A6B0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_MAP_OFFSET UNITYSDK_OFFSET(0x93A860)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_VECTOR_OFFSET UNITYSDK_OFFSET(0x93A870)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x3074E0)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlexBufferMapBuilder_TypeDefinitionIndex = 8748;
