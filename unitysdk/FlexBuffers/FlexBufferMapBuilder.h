...
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADDNULL_OFFSET UNITYSDK_OFFSET(0x90E040)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_10_OFFSET UNITYSDK_OFFSET(0x90E140)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_11_OFFSET UNITYSDK_OFFSET(0x90E150)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_12_OFFSET UNITYSDK_OFFSET(0x90E160)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_13_OFFSET UNITYSDK_OFFSET(0x90E1D0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_14_OFFSET UNITYSDK_OFFSET(0x90E210)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_1_OFFSET UNITYSDK_OFFSET(0x90E0B0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_2_OFFSET UNITYSDK_OFFSET(0x90E0C0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_3_OFFSET UNITYSDK_OFFSET(0x90E0D0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_4_OFFSET UNITYSDK_OFFSET(0x90E0E0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_5_OFFSET UNITYSDK_OFFSET(0x90E0F0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_6_OFFSET UNITYSDK_OFFSET(0x90E100)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_7_OFFSET UNITYSDK_OFFSET(0x90E110)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_8_OFFSET UNITYSDK_OFFSET(0x90E120)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_9_OFFSET UNITYSDK_OFFSET(0x90E130)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_ADD_OFFSET UNITYSDK_OFFSET(0x90E0A0)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_MAP_OFFSET UNITYSDK_OFFSET(0x90E250)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER_VECTOR_OFFSET UNITYSDK_OFFSET(0x90E260)
#define FLEXBUFFERS_FLEXBUFFERMAPBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x2C3980)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlexBufferMapBuilder_TypeDefinitionIndex = 8737;
