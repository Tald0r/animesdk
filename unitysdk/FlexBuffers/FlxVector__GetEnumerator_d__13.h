...
#define FLEXBUFFERS_FLXVECTOR__GETENUMERATOR_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A85DED0)
#define FLEXBUFFERS_FLXVECTOR__GETENUMERATOR_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_FLEXBUFFERS_FLXVALUE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A85DF50)
#define FLEXBUFFERS_FLXVECTOR__GETENUMERATOR_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A85DFB0)
#define FLEXBUFFERS_FLXVECTOR__GETENUMERATOR_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A85DF60)
#define FLEXBUFFERS_FLXVECTOR__GETENUMERATOR_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A85DEC0)
#define FLEXBUFFERS_FLXVECTOR__GETENUMERATOR_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x1A85DE80)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlxVector__GetEnumerator_d__13_TypeDefinitionIndex = 8755;
