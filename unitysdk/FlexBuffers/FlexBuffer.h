...
#define FLEXBUFFERS_FLEXBUFFER_ADDDYNAMICMAP_OFFSET UNITYSDK_OFFSET(0x1A853610)
#define FLEXBUFFERS_FLEXBUFFER_ADDDYNAMICVECTOR_OFFSET UNITYSDK_OFFSET(0x1A853D30)
#define FLEXBUFFERS_FLEXBUFFER_ADDDYNAMIC_OFFSET UNITYSDK_OFFSET(0x1A854C80)
#define FLEXBUFFERS_FLEXBUFFER_ADDINDIRECT_1_OFFSET UNITYSDK_OFFSET(0x1A854890)
#define FLEXBUFFERS_FLEXBUFFER_ADDINDIRECT_2_OFFSET UNITYSDK_OFFSET(0x1A854A40)
#define FLEXBUFFERS_FLEXBUFFER_ADDINDIRECT_OFFSET UNITYSDK_OFFSET(0x1A854690)
#define FLEXBUFFERS_FLEXBUFFER_ADDKEY_OFFSET UNITYSDK_OFFSET(0x1A855010)
#define FLEXBUFFERS_FLEXBUFFER_ADDNULL_OFFSET UNITYSDK_OFFSET(0x1A851D70)
#define FLEXBUFFERS_FLEXBUFFER_ADD_1_OFFSET UNITYSDK_OFFSET(0x1A852000)
#define FLEXBUFFERS_FLEXBUFFER_ADD_2_OFFSET UNITYSDK_OFFSET(0x1A852140)
#define FLEXBUFFERS_FLEXBUFFER_ADD_3_OFFSET UNITYSDK_OFFSET(0x1A852240)
#define FLEXBUFFERS_FLEXBUFFER_ADD_4_OFFSET UNITYSDK_OFFSET(0x1A8517D0)
#define FLEXBUFFERS_FLEXBUFFER_ADD_5_OFFSET UNITYSDK_OFFSET(0x1A853430)
#define FLEXBUFFERS_FLEXBUFFER_ADD_OFFSET UNITYSDK_OFFSET(0x1A851E90)
#define FLEXBUFFERS_FLEXBUFFER_ALIGN_OFFSET UNITYSDK_OFFSET(0x1A854360)
#define FLEXBUFFERS_FLEXBUFFER_CREATEVECTOR_OFFSET UNITYSDK_OFFSET(0x1A855BC0)
#define FLEXBUFFERS_FLEXBUFFER_ENDMAP_OFFSET UNITYSDK_OFFSET(0x1A855610)
#define FLEXBUFFERS_FLEXBUFFER_ENDVECTOR_OFFSET UNITYSDK_OFFSET(0x1A851B70)
#define FLEXBUFFERS_FLEXBUFFER_FINISHBUFFER_OFFSET UNITYSDK_OFFSET(0x1A8540A0)
#define FLEXBUFFERS_FLEXBUFFER_FINISH_OFFSET UNITYSDK_OFFSET(0x1A851C40)
#define FLEXBUFFERS_FLEXBUFFER_FROM_OFFSET UNITYSDK_OFFSET(0x1A853570)
#define FLEXBUFFERS_FLEXBUFFER_NEWOFFSET_OFFSET UNITYSDK_OFFSET(0x1A854BC0)
#define FLEXBUFFERS_FLEXBUFFER_NULL_OFFSET UNITYSDK_OFFSET(0x1A851CF0)
#define FLEXBUFFERS_FLEXBUFFER_PARTITION_OFFSET UNITYSDK_OFFSET(0x1A8559D0)
#define FLEXBUFFERS_FLEXBUFFER_QUICKSORT_OFFSET UNITYSDK_OFFSET(0x1A8555C0)
#define FLEXBUFFERS_FLEXBUFFER_SHOULDFLIP_OFFSET UNITYSDK_OFFSET(0x1A855470)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_10_OFFSET UNITYSDK_OFFSET(0x1A852C60)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_11_OFFSET UNITYSDK_OFFSET(0x1A852EA0)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_12_OFFSET UNITYSDK_OFFSET(0x1A852FE0)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_13_OFFSET UNITYSDK_OFFSET(0x1A853190)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_14_OFFSET UNITYSDK_OFFSET(0x1A8533B0)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A851F20)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_2_OFFSET UNITYSDK_OFFSET(0x1A852080)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_3_OFFSET UNITYSDK_OFFSET(0x1A8521A0)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_4_OFFSET UNITYSDK_OFFSET(0x1A852290)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_5_OFFSET UNITYSDK_OFFSET(0x1A852310)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_6_OFFSET UNITYSDK_OFFSET(0x1A852490)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_7_OFFSET UNITYSDK_OFFSET(0x1A8526A0)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_8_OFFSET UNITYSDK_OFFSET(0x1A852930)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_9_OFFSET UNITYSDK_OFFSET(0x1A852A90)
#define FLEXBUFFERS_FLEXBUFFER_SINGLEVALUE_OFFSET UNITYSDK_OFFSET(0x1A851DA0)
#define FLEXBUFFERS_FLEXBUFFER_SORTANDENDMAP_OFFSET UNITYSDK_OFFSET(0x1A855310)
#define FLEXBUFFERS_FLEXBUFFER_STARTVECTOR_OFFSET UNITYSDK_OFFSET(0x1A8517B0)
#define FLEXBUFFERS_FLEXBUFFER_SWAP_OFFSET UNITYSDK_OFFSET(0x1A855B00)
#define FLEXBUFFERS_FLEXBUFFER_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1A854590)
#define FLEXBUFFERS_FLEXBUFFER_WRITE_2_OFFSET UNITYSDK_OFFSET(0x1A8547B0)
#define FLEXBUFFERS_FLEXBUFFER_WRITE_3_OFFSET UNITYSDK_OFFSET(0x1A854990)
#define FLEXBUFFERS_FLEXBUFFER_WRITE_4_OFFSET UNITYSDK_OFFSET(0x1A854B30)
#define FLEXBUFFERS_FLEXBUFFER_WRITE_OFFSET UNITYSDK_OFFSET(0x1A854390)
#define FLEXBUFFERS_FLEXBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A851580)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlexBuffer_TypeDefinitionIndex = 8742;

	class FlexBuffer : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::UInt64>* _keyCache; // 0x10
		...
		::FlexBuffers::FlexBuffer_Options _options; // 0x40
		::System::Boolean _finished; // 0x41
