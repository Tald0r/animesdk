...
#define FLEXBUFFERS_FLXVECTOR_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x90EAD0)
#define FLEXBUFFERS_FLXVECTOR_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x90EA90)
#define FLEXBUFFERS_FLXVECTOR_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x2C50B0)
#define FLEXBUFFERS_FLXVECTOR_GET_TOJSON_OFFSET UNITYSDK_OFFSET(0x90EAB0)
#define FLEXBUFFERS_FLXVECTOR_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x90EAD0)
#define FLEXBUFFERS_FLXVECTOR_TOPRETTYJSON_OFFSET UNITYSDK_OFFSET(0x90EAC0)
#define FLEXBUFFERS_FLXVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x90EA70)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlxVector_TypeDefinitionIndex = 8743;
