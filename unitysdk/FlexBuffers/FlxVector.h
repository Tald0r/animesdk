...
#define FLEXBUFFERS_FLXVECTOR_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x93B0E0)
#define FLEXBUFFERS_FLXVECTOR_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x93B0A0)
#define FLEXBUFFERS_FLXVECTOR_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x2F6540)
#define FLEXBUFFERS_FLXVECTOR_GET_TOJSON_OFFSET UNITYSDK_OFFSET(0x93B0C0)
#define FLEXBUFFERS_FLXVECTOR_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x93B0E0)
#define FLEXBUFFERS_FLXVECTOR_TOPRETTYJSON_OFFSET UNITYSDK_OFFSET(0x93B0D0)
#define FLEXBUFFERS_FLXVECTOR__CTOR_OFFSET UNITYSDK_OFFSET(0x93B080)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlxVector_TypeDefinitionIndex = 8754;
