...
#define FLEXBUFFERS_FLXMAP_COMPSTR_OFFSET UNITYSDK_OFFSET(0x93AD50)
#define FLEXBUFFERS_FLXMAP_COMP_1_OFFSET UNITYSDK_OFFSET(0x93AD40)
#define FLEXBUFFERS_FLXMAP_COMP_OFFSET UNITYSDK_OFFSET(0x93ACE0)
#define FLEXBUFFERS_FLXMAP_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x93AD60)
#define FLEXBUFFERS_FLXMAP_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x93AC00)
#define FLEXBUFFERS_FLXMAP_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x93ABB0)
#define FLEXBUFFERS_FLXMAP_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x2F6540)
#define FLEXBUFFERS_FLXMAP_GET_TOJSON_OFFSET UNITYSDK_OFFSET(0x93AC40)
#define FLEXBUFFERS_FLXMAP_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x93ABD0)
#define FLEXBUFFERS_FLXMAP_KEYINDEX_OFFSET UNITYSDK_OFFSET(0x93AC60)
#define FLEXBUFFERS_FLXMAP_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x93AD60)
#define FLEXBUFFERS_FLXMAP_TOPRETTYJSON_OFFSET UNITYSDK_OFFSET(0x93AC50)
#define FLEXBUFFERS_FLXMAP_VALUEBYINDEX_OFFSET UNITYSDK_OFFSET(0x93AC20)
#define FLEXBUFFERS_FLXMAP__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A85AFF0)
#define FLEXBUFFERS_FLXMAP__CTOR_OFFSET UNITYSDK_OFFSET(0x93AB90)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlxMap_TypeDefinitionIndex = 8756;

	struct alignas(8) FlxMap
	{
		static ::Il2CppArray<::System::Char>** StaticGet__chars()
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(FlxMap_TypeDefinitionIndex)->GetStaticField(0x7CD0);
		}
		static ::Il2CppArray<::System::Byte>** StaticGet__charBytes()
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(FlxMap_TypeDefinitionIndex)->GetStaticField(0x7CD8);
		}
