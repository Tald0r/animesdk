...
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A29D720)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_FLEXBUFFERS_FLXVALUE___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A29D800)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A29D870)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A29D820)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A29D710)
#define FLEXBUFFERS_FLXMAP__GETENUMERATOR_D__23__CTOR_OFFSET UNITYSDK_OFFSET(0x1A29D640)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlxMap__GetEnumerator_d__23_TypeDefinitionIndex = 8746;
