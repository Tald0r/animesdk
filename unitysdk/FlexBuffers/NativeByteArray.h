...
#define FLEXBUFFERS_NATIVEBYTEARRAY_ASSERT_OFFSET UNITYSDK_OFFSET(0x1A2A2E00)
#define FLEXBUFFERS_NATIVEBYTEARRAY_BLOCKCOPY_OFFSET UNITYSDK_OFFSET(0x1A2A32B0)
#define FLEXBUFFERS_NATIVEBYTEARRAY_COMPUTEINDIRECTOFFSET_OFFSET UNITYSDK_OFFSET(0x1A2A33D0)
#define FLEXBUFFERS_NATIVEBYTEARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A2A3470)
#define FLEXBUFFERS_NATIVEBYTEARRAY_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1A2A2DF0)
#define FLEXBUFFERS_NATIVEBYTEARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A2A2D40)
#define FLEXBUFFERS_NATIVEBYTEARRAY_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A2A2DE0)
#define FLEXBUFFERS_NATIVEBYTEARRAY_READBYTE_OFFSET UNITYSDK_OFFSET(0x1A2A2D90)
#define FLEXBUFFERS_NATIVEBYTEARRAY_READDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A2A3020)
#define FLEXBUFFERS_NATIVEBYTEARRAY_READLONG_OFFSET UNITYSDK_OFFSET(0x1A2A2EE0)
#define FLEXBUFFERS_NATIVEBYTEARRAY_READSPANBYTES_OFFSET UNITYSDK_OFFSET(0x1A2A31D0)
#define FLEXBUFFERS_NATIVEBYTEARRAY_READSTRING_OFFSET UNITYSDK_OFFSET(0x1A2A30F0)
#define FLEXBUFFERS_NATIVEBYTEARRAY_READULONG_OFFSET UNITYSDK_OFFSET(0x1A2A2F80)
#define FLEXBUFFERS_NATIVEBYTEARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A29DD90)

namespace FlexBuffers
{
	inline static constexpr unsigned int NativeByteArray_TypeDefinitionIndex = 8741;

	class NativeByteArray : public ::System::Object
	{
	public:
		::UnityEngine::TextAsset* _buffer; // 0x10
		::System::Int32 _lenght; // 0x18
		::System::Boolean m_Disposed; // 0x1C
