...
#define FLEXBUFFERS_TEXTSCANNER_ASSERT_1_OFFSET UNITYSDK_OFFSET(0x1A860180)
#define FLEXBUFFERS_TEXTSCANNER_ASSERT_OFFSET UNITYSDK_OFFSET(0x1A8604A0)
#define FLEXBUFFERS_TEXTSCANNER_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1A860470)
#define FLEXBUFFERS_TEXTSCANNER_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A861080)
#define FLEXBUFFERS_TEXTSCANNER_PEEK_OFFSET UNITYSDK_OFFSET(0x1A85F200)
#define FLEXBUFFERS_TEXTSCANNER_READLINE_OFFSET UNITYSDK_OFFSET(0x1A861090)
#define FLEXBUFFERS_TEXTSCANNER_READ_OFFSET UNITYSDK_OFFSET(0x1A860370)
#define FLEXBUFFERS_TEXTSCANNER_SKIPWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A85EF50)
#define FLEXBUFFERS_TEXTSCANNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A85E090)

namespace FlexBuffers
{
	inline static constexpr unsigned int TextScanner_TypeDefinitionIndex = 8759;
