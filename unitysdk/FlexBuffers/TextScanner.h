...
#define FLEXBUFFERS_TEXTSCANNER_ASSERT_1_OFFSET UNITYSDK_OFFSET(0x1A2A2840)
#define FLEXBUFFERS_TEXTSCANNER_ASSERT_OFFSET UNITYSDK_OFFSET(0x1A2A2B60)
#define FLEXBUFFERS_TEXTSCANNER_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1A2A2B30)
#define FLEXBUFFERS_TEXTSCANNER_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A2A3740)
#define FLEXBUFFERS_TEXTSCANNER_PEEK_OFFSET UNITYSDK_OFFSET(0x1A2A18C0)
#define FLEXBUFFERS_TEXTSCANNER_READLINE_OFFSET UNITYSDK_OFFSET(0x1A2A3750)
#define FLEXBUFFERS_TEXTSCANNER_READ_OFFSET UNITYSDK_OFFSET(0x1A2A2A30)
#define FLEXBUFFERS_TEXTSCANNER_SKIPWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1A2A1610)
#define FLEXBUFFERS_TEXTSCANNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2A0740)

namespace FlexBuffers
{
	inline static constexpr unsigned int TextScanner_TypeDefinitionIndex = 8748;
