...
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_CONVERTFILE_OFFSET UNITYSDK_OFFSET(0x1A85EBF0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_CONVERT_1_OFFSET UNITYSDK_OFFSET(0x1A85EDD0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_CONVERT_OFFSET UNITYSDK_OFFSET(0x1A85E8D0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_ENSUREVALIDFLXVALUE_OFFSET UNITYSDK_OFFSET(0x1A85E150)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_ENSUREVALIDJSON_OFFSET UNITYSDK_OFFSET(0x1A85E110)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READARRAY_OFFSET UNITYSDK_OFFSET(0x1A85F900)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1A85FE60)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READDIGITS_OFFSET UNITYSDK_OFFSET(0x1A860210)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READHEXDIGIT_OFFSET UNITYSDK_OFFSET(0x1A8605B0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READJSONVALUE_OFFSET UNITYSDK_OFFSET(0x1A85EA40)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READNULL_OFFSET UNITYSDK_OFFSET(0x1A8600C0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READNUMBER_OFFSET UNITYSDK_OFFSET(0x1A85F2B0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READOBJECT_OFFSET UNITYSDK_OFFSET(0x1A85F6B0)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READSTRING_OFFSET UNITYSDK_OFFSET(0x1A85FB00)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER_READUNICODELITERAL_OFFSET UNITYSDK_OFFSET(0x1A860560)
#define FLEXBUFFERS_JSONTOFLEXBUFFERCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A85DFE0)

namespace FlexBuffers
{
	inline static constexpr unsigned int JsonToFlexBufferConverter_TypeDefinitionIndex = 8760;
