...
#define FLEXBUFFERS_TYPESUTIL_FIXEDTYPEDVECTORELEMENTSIZE_OFFSET UNITYSDK_OFFSET(0x1A85D860)
#define FLEXBUFFERS_TYPESUTIL_FIXEDTYPEDVECTORELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A85DE30)
#define FLEXBUFFERS_TYPESUTIL_ISAVECTOR_OFFSET UNITYSDK_OFFSET(0x1A85D820)
#define FLEXBUFFERS_TYPESUTIL_ISFIXEDTYPEDVECTOR_OFFSET UNITYSDK_OFFSET(0x1A85D850)
#define FLEXBUFFERS_TYPESUTIL_ISINLINE_OFFSET UNITYSDK_OFFSET(0x1A860F70)
#define FLEXBUFFERS_TYPESUTIL_ISTYPEDVECTORELEMENT_OFFSET UNITYSDK_OFFSET(0x1A854FF0)
#define FLEXBUFFERS_TYPESUTIL_ISTYPEDVECTOR_OFFSET UNITYSDK_OFFSET(0x1A85DE00)
#define FLEXBUFFERS_TYPESUTIL_NULLPACKEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A861150)
#define FLEXBUFFERS_TYPESUTIL_PACKEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A860F80)
#define FLEXBUFFERS_TYPESUTIL_TOTYPEDVECTOR_OFFSET UNITYSDK_OFFSET(0x1A856350)
#define FLEXBUFFERS_TYPESUTIL_TYPEDVECTORELEMENTTYPE_OFFSET UNITYSDK_OFFSET(0x1A85DE20)

namespace FlexBuffers
{
	inline static constexpr unsigned int TypesUtil_TypeDefinitionIndex = 8763;
