...
#define FLEXBUFFERS_FLXVALUE_COMPARETO_OFFSET UNITYSDK_OFFSET(0x90E870)
#define FLEXBUFFERS_FLXVALUE_CONVERTUTF16TOUTF8_OFFSET UNITYSDK_OFFSET(0x1A29F920)
#define FLEXBUFFERS_FLXVALUE_FROMBYTES_1_OFFSET UNITYSDK_OFFSET(0x1A29DD20)
#define FLEXBUFFERS_FLXVALUE_FROMBYTES_2_OFFSET UNITYSDK_OFFSET(0x1A29D950)
#define FLEXBUFFERS_FLXVALUE_FROMBYTES_OFFSET UNITYSDK_OFFSET(0x1A29D910)
#define FLEXBUFFERS_FLXVALUE_GET_ASBLOB_OFFSET UNITYSDK_OFFSET(0x90E960)
#define FLEXBUFFERS_FLXVALUE_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x90E850)
#define FLEXBUFFERS_FLXVALUE_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x90E840)
#define FLEXBUFFERS_FLXVALUE_GET_ASLONG_OFFSET UNITYSDK_OFFSET(0x90E820)
#define FLEXBUFFERS_FLXVALUE_GET_ASMAP_OFFSET UNITYSDK_OFFSET(0x90E940)
#define FLEXBUFFERS_FLXVALUE_GET_ASSTRING_OFFSET UNITYSDK_OFFSET(0x90E860)
#define FLEXBUFFERS_FLXVALUE_GET_ASULONG_OFFSET UNITYSDK_OFFSET(0x90E830)
#define FLEXBUFFERS_FLXVALUE_GET_ASVECTOR_OFFSET UNITYSDK_OFFSET(0x90E920)
#define FLEXBUFFERS_FLXVALUE_GET_BUFFEROFFSET_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define FLEXBUFFERS_FLXVALUE_GET_BUFFER_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define FLEXBUFFERS_FLXVALUE_GET_INDIRECTOFFSET_OFFSET UNITYSDK_OFFSET(0x90E990)
#define FLEXBUFFERS_FLXVALUE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x90E810)
#define FLEXBUFFERS_FLXVALUE_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x90E8D0)
#define FLEXBUFFERS_FLXVALUE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x90E880)
#define FLEXBUFFERS_FLXVALUE_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define FLEXBUFFERS_FLXVALUE_GET_TOJSON_OFFSET UNITYSDK_OFFSET(0x90E970)
#define FLEXBUFFERS_FLXVALUE_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x35D940)
#define FLEXBUFFERS_FLXVALUE_TOPRETTYJSON_OFFSET UNITYSDK_OFFSET(0x90E980)
#define FLEXBUFFERS_FLXVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x90E7F0)
#define FLEXBUFFERS_FLXVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x90E7C0)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlxValue_TypeDefinitionIndex = 8742;
