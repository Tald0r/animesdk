...
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADDNULL_OFFSET UNITYSDK_OFFSET(0x90E290)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_10_OFFSET UNITYSDK_OFFSET(0x90E480)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_11_OFFSET UNITYSDK_OFFSET(0x90E490)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_12_OFFSET UNITYSDK_OFFSET(0x90E4A0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_13_OFFSET UNITYSDK_OFFSET(0x90E500)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_14_OFFSET UNITYSDK_OFFSET(0x90E520)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_1_OFFSET UNITYSDK_OFFSET(0x90E2E0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_2_OFFSET UNITYSDK_OFFSET(0x90E2F0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_3_OFFSET UNITYSDK_OFFSET(0x90E300)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_4_OFFSET UNITYSDK_OFFSET(0x90E310)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_5_OFFSET UNITYSDK_OFFSET(0x90E3B0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_6_OFFSET UNITYSDK_OFFSET(0x90E3C0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_7_OFFSET UNITYSDK_OFFSET(0x90E3D0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_8_OFFSET UNITYSDK_OFFSET(0x90E3E0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_9_OFFSET UNITYSDK_OFFSET(0x90E470)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_OFFSET UNITYSDK_OFFSET(0x90E2D0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_MAP_OFFSET UNITYSDK_OFFSET(0x90E540)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_VECTOR_OFFSET UNITYSDK_OFFSET(0x90E550)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x2C3980)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlexBufferVectorBuilder_TypeDefinitionIndex = 8738;
