...
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADDNULL_OFFSET UNITYSDK_OFFSET(0x93A8A0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_10_OFFSET UNITYSDK_OFFSET(0x93AA90)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_11_OFFSET UNITYSDK_OFFSET(0x93AAA0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_12_OFFSET UNITYSDK_OFFSET(0x93AAB0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_13_OFFSET UNITYSDK_OFFSET(0x93AB10)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_14_OFFSET UNITYSDK_OFFSET(0x93AB30)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_1_OFFSET UNITYSDK_OFFSET(0x93A8F0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_2_OFFSET UNITYSDK_OFFSET(0x93A900)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_3_OFFSET UNITYSDK_OFFSET(0x93A910)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_4_OFFSET UNITYSDK_OFFSET(0x93A920)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_5_OFFSET UNITYSDK_OFFSET(0x93A9C0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_6_OFFSET UNITYSDK_OFFSET(0x93A9D0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_7_OFFSET UNITYSDK_OFFSET(0x93A9E0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_8_OFFSET UNITYSDK_OFFSET(0x93A9F0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_9_OFFSET UNITYSDK_OFFSET(0x93AA80)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_ADD_OFFSET UNITYSDK_OFFSET(0x93A8E0)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_MAP_OFFSET UNITYSDK_OFFSET(0x93AB50)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER_VECTOR_OFFSET UNITYSDK_OFFSET(0x93AB60)
#define FLEXBUFFERS_FLEXBUFFERVECTORBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x3074E0)

namespace FlexBuffers
{
	inline static constexpr unsigned int FlexBufferVectorBuilder_TypeDefinitionIndex = 8749;
