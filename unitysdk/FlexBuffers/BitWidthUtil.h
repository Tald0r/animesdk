...
#define FLEXBUFFERS_BITWIDTHUTIL_PADDINGSIZE_OFFSET UNITYSDK_OFFSET(0x1A850B90)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_1_OFFSET UNITYSDK_OFFSET(0x1A850A50)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_2_OFFSET UNITYSDK_OFFSET(0x1A850A70)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_3_OFFSET UNITYSDK_OFFSET(0x1A850AA0)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_4_OFFSET UNITYSDK_OFFSET(0x1A850AF0)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_5_OFFSET UNITYSDK_OFFSET(0x1A850B00)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_6_OFFSET UNITYSDK_OFFSET(0x1A850B10)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_7_OFFSET UNITYSDK_OFFSET(0x1A850B30)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_8_OFFSET UNITYSDK_OFFSET(0x1A850B60)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_9_OFFSET UNITYSDK_OFFSET(0x1A850B70)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_OFFSET UNITYSDK_OFFSET(0x1A850A40)

namespace FlexBuffers
{
	inline static constexpr unsigned int BitWidthUtil_TypeDefinitionIndex = 8740;
