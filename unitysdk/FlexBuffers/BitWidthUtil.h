...
#define FLEXBUFFERS_BITWIDTHUTIL_PADDINGSIZE_OFFSET UNITYSDK_OFFSET(0x1A293230)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_1_OFFSET UNITYSDK_OFFSET(0x1A2930F0)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_2_OFFSET UNITYSDK_OFFSET(0x1A293110)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_3_OFFSET UNITYSDK_OFFSET(0x1A293140)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_4_OFFSET UNITYSDK_OFFSET(0x1A293190)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_5_OFFSET UNITYSDK_OFFSET(0x1A2931A0)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_6_OFFSET UNITYSDK_OFFSET(0x1A2931B0)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_7_OFFSET UNITYSDK_OFFSET(0x1A2931D0)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_8_OFFSET UNITYSDK_OFFSET(0x1A293200)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_9_OFFSET UNITYSDK_OFFSET(0x1A293210)
#define FLEXBUFFERS_BITWIDTHUTIL_WIDTH_OFFSET UNITYSDK_OFFSET(0x1A2930E0)

namespace FlexBuffers
{
	inline static constexpr unsigned int BitWidthUtil_TypeDefinitionIndex = 8729;
