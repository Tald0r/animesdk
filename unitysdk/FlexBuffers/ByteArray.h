...
#define FLEXBUFFERS_BYTEARRAY_BLOCKCOPY_OFFSET UNITYSDK_OFFSET(0x1A293820)
#define FLEXBUFFERS_BYTEARRAY_COMPUTEINDIRECTOFFSET_OFFSET UNITYSDK_OFFSET(0x1A293830)
#define FLEXBUFFERS_BYTEARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A293850)
#define FLEXBUFFERS_BYTEARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A293240)
#define FLEXBUFFERS_BYTEARRAY_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A293280)
#define FLEXBUFFERS_BYTEARRAY_READDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A293580)
#define FLEXBUFFERS_BYTEARRAY_READLONG_OFFSET UNITYSDK_OFFSET(0x1A2932B0)
#define FLEXBUFFERS_BYTEARRAY_READSPANBYTES_OFFSET UNITYSDK_OFFSET(0x1A293750)
#define FLEXBUFFERS_BYTEARRAY_READSTRING_OFFSET UNITYSDK_OFFSET(0x1A2936A0)
#define FLEXBUFFERS_BYTEARRAY_READULONG_OFFSET UNITYSDK_OFFSET(0x1A293400)
#define FLEXBUFFERS_BYTEARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2932A0)

namespace FlexBuffers
{
	inline static constexpr unsigned int ByteArray_TypeDefinitionIndex = 8740;
