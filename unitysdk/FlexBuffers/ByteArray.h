...
#define FLEXBUFFERS_BYTEARRAY_BLOCKCOPY_OFFSET UNITYSDK_OFFSET(0x1A851180)
#define FLEXBUFFERS_BYTEARRAY_COMPUTEINDIRECTOFFSET_OFFSET UNITYSDK_OFFSET(0x1A851190)
#define FLEXBUFFERS_BYTEARRAY_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A8511B0)
#define FLEXBUFFERS_BYTEARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A850BA0)
#define FLEXBUFFERS_BYTEARRAY_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A850BE0)
#define FLEXBUFFERS_BYTEARRAY_READDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A850EE0)
#define FLEXBUFFERS_BYTEARRAY_READLONG_OFFSET UNITYSDK_OFFSET(0x1A850C10)
#define FLEXBUFFERS_BYTEARRAY_READSPANBYTES_OFFSET UNITYSDK_OFFSET(0x1A8510B0)
#define FLEXBUFFERS_BYTEARRAY_READSTRING_OFFSET UNITYSDK_OFFSET(0x1A851000)
#define FLEXBUFFERS_BYTEARRAY_READULONG_OFFSET UNITYSDK_OFFSET(0x1A850D60)
#define FLEXBUFFERS_BYTEARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A850C00)

namespace FlexBuffers
{
	inline static constexpr unsigned int ByteArray_TypeDefinitionIndex = 8751;
