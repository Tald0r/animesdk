...
#define FLEXBUFFERS_OFFSETARRAYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A2A3490)
#define FLEXBUFFERS_OFFSETARRAYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A2A3500)
#define FLEXBUFFERS_OFFSETARRAYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A294380)

namespace FlexBuffers
{
	inline static constexpr unsigned int OffsetArrayComparer_TypeDefinitionIndex = 8733;
