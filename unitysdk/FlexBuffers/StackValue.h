...
#define FLEXBUFFERS_STACKVALUE_ELEMENTWIDTH_OFFSET UNITYSDK_OFFSET(0x93B180)
#define FLEXBUFFERS_STACKVALUE_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x3EB2F0)
#define FLEXBUFFERS_STACKVALUE_GET_ASLONG_OFFSET UNITYSDK_OFFSET(0x223870)
#define FLEXBUFFERS_STACKVALUE_GET_ASULONG_OFFSET UNITYSDK_OFFSET(0x223870)
#define FLEXBUFFERS_STACKVALUE_GET_INTERNALWIDTH_OFFSET UNITYSDK_OFFSET(0x34AA60)
#define FLEXBUFFERS_STACKVALUE_GET_ISFLOAT32_OFFSET UNITYSDK_OFFSET(0x93B190)
#define FLEXBUFFERS_STACKVALUE_GET_ISOFFSET_OFFSET UNITYSDK_OFFSET(0x93B1B0)
#define FLEXBUFFERS_STACKVALUE_GET_TYPEOFVALUE_OFFSET UNITYSDK_OFFSET(0x31B120)
#define FLEXBUFFERS_STACKVALUE_NULL_OFFSET UNITYSDK_OFFSET(0x1A854620)
#define FLEXBUFFERS_STACKVALUE_STOREDPACKEDTYPE_OFFSET UNITYSDK_OFFSET(0x93B140)
#define FLEXBUFFERS_STACKVALUE_STOREDWIDTH_OFFSET UNITYSDK_OFFSET(0x93B120)
#define FLEXBUFFERS_STACKVALUE_VALUE_1_OFFSET UNITYSDK_OFFSET(0x1A854A00)
#define FLEXBUFFERS_STACKVALUE_VALUE_2_OFFSET UNITYSDK_OFFSET(0x1A854BA0)
#define FLEXBUFFERS_STACKVALUE_VALUE_3_OFFSET UNITYSDK_OFFSET(0x1A854630)
#define FLEXBUFFERS_STACKVALUE_VALUE_4_OFFSET UNITYSDK_OFFSET(0x1A854840)
#define FLEXBUFFERS_STACKVALUE_VALUE_5_OFFSET UNITYSDK_OFFSET(0x1A854820)
#define FLEXBUFFERS_STACKVALUE_VALUE_6_OFFSET UNITYSDK_OFFSET(0x1A860F30)
#define FLEXBUFFERS_STACKVALUE_VALUE_OFFSET UNITYSDK_OFFSET(0x1A860F10)

namespace FlexBuffers
{
	inline static constexpr unsigned int StackValue_TypeDefinitionIndex = 8761;
