...
#define FLEXBUFFERS_STACKVALUE_ELEMENTWIDTH_OFFSET UNITYSDK_OFFSET(0x90EB70)
#define FLEXBUFFERS_STACKVALUE_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x39B980)
#define FLEXBUFFERS_STACKVALUE_GET_ASLONG_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define FLEXBUFFERS_STACKVALUE_GET_ASULONG_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define FLEXBUFFERS_STACKVALUE_GET_INTERNALWIDTH_OFFSET UNITYSDK_OFFSET(0x31FD90)
#define FLEXBUFFERS_STACKVALUE_GET_ISFLOAT32_OFFSET UNITYSDK_OFFSET(0x90EB80)
#define FLEXBUFFERS_STACKVALUE_GET_ISOFFSET_OFFSET UNITYSDK_OFFSET(0x90EBA0)
#define FLEXBUFFERS_STACKVALUE_GET_TYPEOFVALUE_OFFSET UNITYSDK_OFFSET(0x44A160)
#define FLEXBUFFERS_STACKVALUE_NULL_OFFSET UNITYSDK_OFFSET(0x1A296CD0)
#define FLEXBUFFERS_STACKVALUE_STOREDPACKEDTYPE_OFFSET UNITYSDK_OFFSET(0x90EB30)
#define FLEXBUFFERS_STACKVALUE_STOREDWIDTH_OFFSET UNITYSDK_OFFSET(0x90EB10)
#define FLEXBUFFERS_STACKVALUE_VALUE_1_OFFSET UNITYSDK_OFFSET(0x1A2970B0)
#define FLEXBUFFERS_STACKVALUE_VALUE_2_OFFSET UNITYSDK_OFFSET(0x1A297250)
#define FLEXBUFFERS_STACKVALUE_VALUE_3_OFFSET UNITYSDK_OFFSET(0x1A296CE0)
#define FLEXBUFFERS_STACKVALUE_VALUE_4_OFFSET UNITYSDK_OFFSET(0x1A296EF0)
#define FLEXBUFFERS_STACKVALUE_VALUE_5_OFFSET UNITYSDK_OFFSET(0x1A296ED0)
#define FLEXBUFFERS_STACKVALUE_VALUE_6_OFFSET UNITYSDK_OFFSET(0x1A2A35F0)
#define FLEXBUFFERS_STACKVALUE_VALUE_OFFSET UNITYSDK_OFFSET(0x1A2A35D0)

namespace FlexBuffers
{
	inline static constexpr unsigned int StackValue_TypeDefinitionIndex = 8750;
