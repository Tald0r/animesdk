...
#define ZZZUICURVEGRAPHIC_ADDTOLIST_1_OFFSET UNITYSDK_OFFSET(0x15686CA0)
#define ZZZUICURVEGRAPHIC_ADDTOLIST_2_OFFSET UNITYSDK_OFFSET(0x15686DA0)
#define ZZZUICURVEGRAPHIC_ADDTOLIST_OFFSET UNITYSDK_OFFSET(0x15686BE0)
#define ZZZUICURVEGRAPHIC_APPLYSPHEREMASK_OFFSET UNITYSDK_OFFSET(0x15685470)
#define ZZZUICURVEGRAPHIC_APPLYTOPOSRADIUSLIST_OFFSET UNITYSDK_OFFSET(0x156853B0)
#define ZZZUICURVEGRAPHIC_CALCULATEBEZIERPOINT_OFFSET UNITYSDK_OFFSET(0x15688200)
#define ZZZUICURVEGRAPHIC_CLEARCURVESANIMATEDTAG_1_OFFSET UNITYSDK_OFFSET(0x15686780)
#define ZZZUICURVEGRAPHIC_CLEARCURVESANIMATEDTAG_OFFSET UNITYSDK_OFFSET(0x15686610)
#define ZZZUICURVEGRAPHIC_CLEARCURVESOPENTAG_OFFSET UNITYSDK_OFFSET(0x156868F0)
#define ZZZUICURVEGRAPHIC_CLEAR_OFFSET UNITYSDK_OFFSET(0x15686B20)
#define ZZZUICURVEGRAPHIC_COMPUTECURVES_OFFSET UNITYSDK_OFFSET(0x156856F0)
#define ZZZUICURVEGRAPHIC_CURVEFILLANIMATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x15685260)
#define ZZZUICURVEGRAPHIC_CURVEFILLANIMATIONPLAY_OFFSET UNITYSDK_OFFSET(0x156851F0)
#define ZZZUICURVEGRAPHIC_CURVEFILLANIMATIONRESET_OFFSET UNITYSDK_OFFSET(0x15685180)
#define ZZZUICURVEGRAPHIC_CURVEFILLANIMATIONSTOP_OFFSET UNITYSDK_OFFSET(0x156852D0)
#define ZZZUICURVEGRAPHIC_DRAWBEZIERCURVELIST_OFFSET UNITYSDK_OFFSET(0x15687120)
#define ZZZUICURVEGRAPHIC_DRAWBEZIERCURVE_OFFSET UNITYSDK_OFFSET(0x15687330)
#define ZZZUICURVEGRAPHIC_ENABLEUIVERTEXCOLORCALC_OFFSET UNITYSDK_OFFSET(0x15684A70)
#define ZZZUICURVEGRAPHIC_GETAPPROXPOINT_OFFSET UNITYSDK_OFFSET(0x156863B0)
#define ZZZUICURVEGRAPHIC_LINETOOSHORT_OFFSET UNITYSDK_OFFSET(0x15686A60)
#define ZZZUICURVEGRAPHIC_ONMATERIALCHANGED_OFFSET UNITYSDK_OFFSET(0x15684AF0)
#define ZZZUICURVEGRAPHIC_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x15687020)
#define ZZZUICURVEGRAPHIC_REFRESHMESH_OFFSET UNITYSDK_OFFSET(0x15685650)
#define ZZZUICURVEGRAPHIC_REMOVESAMECURVE_OFFSET UNITYSDK_OFFSET(0x15686070)
#define ZZZUICURVEGRAPHIC_SPLITTOMIXEDCURVES_OFFSET UNITYSDK_OFFSET(0x156858B0)
#define ZZZUICURVEGRAPHIC_START_OFFSET UNITYSDK_OFFSET(0x156848A0)
#define ZZZUICURVEGRAPHIC_UPDATECURVEANIMATION_OFFSET UNITYSDK_OFFSET(0x15684DB0)
#define ZZZUICURVEGRAPHIC_UPDATEMASKPOSRADIUS_OFFSET UNITYSDK_OFFSET(0x15684F40)
#define ZZZUICURVEGRAPHIC_UPDATE_OFFSET UNITYSDK_OFFSET(0x15684D30)
#define ZZZUICURVEGRAPHIC__CCTOR_OFFSET UNITYSDK_OFFSET(0x15688540)
#define ZZZUICURVEGRAPHIC__CTOR_OFFSET UNITYSDK_OFFSET(0x15688350)
#define ZZZUICURVEGRAPHIC___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x15688610)
#define ZZZUICURVEGRAPHIC___BASE_START_OFFSET UNITYSDK_OFFSET(0x15688620)

inline static constexpr unsigned int ZzzUiCurveGraphic_TypeDefinitionIndex = 76421;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xB8F0);
	}
	static ::System::Int32* StaticGet_IconPosArraySize()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xB8F4);
	}
	static ::System::Int32* StaticGet_CurveCloseColor()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xB8F8);
	}
	static ::System::Int32* StaticGet_WorldScaleUV()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xB8FC);
	}
	static ::System::Int32* StaticGet_CurveOpenColor()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xB900);
	}
	static ::System::Int32* StaticGet_CurveCloseShadowColor()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xB904);
	}
	static ::System::Int32* StaticGet_AnimationProgress()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xB908);
	}
	static ::System::Int32* StaticGet_CurveOpenShadowColor()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xB90C);
	}
