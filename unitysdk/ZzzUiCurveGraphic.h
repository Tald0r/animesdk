...
#define ZZZUICURVEGRAPHIC_ADDTOLIST_1_OFFSET UNITYSDK_OFFSET(0x19700A30)
#define ZZZUICURVEGRAPHIC_ADDTOLIST_2_OFFSET UNITYSDK_OFFSET(0x19700B30)
#define ZZZUICURVEGRAPHIC_ADDTOLIST_OFFSET UNITYSDK_OFFSET(0x19700970)
#define ZZZUICURVEGRAPHIC_APPLYSPHEREMASK_OFFSET UNITYSDK_OFFSET(0x196FF200)
#define ZZZUICURVEGRAPHIC_APPLYTOPOSRADIUSLIST_OFFSET UNITYSDK_OFFSET(0x196FF140)
#define ZZZUICURVEGRAPHIC_CALCULATEBEZIERPOINT_OFFSET UNITYSDK_OFFSET(0x19701F90)
#define ZZZUICURVEGRAPHIC_CLEARCURVESANIMATEDTAG_1_OFFSET UNITYSDK_OFFSET(0x19700510)
#define ZZZUICURVEGRAPHIC_CLEARCURVESANIMATEDTAG_OFFSET UNITYSDK_OFFSET(0x197003A0)
#define ZZZUICURVEGRAPHIC_CLEARCURVESOPENTAG_OFFSET UNITYSDK_OFFSET(0x19700680)
#define ZZZUICURVEGRAPHIC_CLEAR_OFFSET UNITYSDK_OFFSET(0x197008B0)
#define ZZZUICURVEGRAPHIC_COMPUTECURVES_OFFSET UNITYSDK_OFFSET(0x196FF480)
#define ZZZUICURVEGRAPHIC_CURVEFILLANIMATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x196FEFF0)
#define ZZZUICURVEGRAPHIC_CURVEFILLANIMATIONPLAY_OFFSET UNITYSDK_OFFSET(0x196FEF80)
#define ZZZUICURVEGRAPHIC_CURVEFILLANIMATIONRESET_OFFSET UNITYSDK_OFFSET(0x196FEF10)
#define ZZZUICURVEGRAPHIC_CURVEFILLANIMATIONSTOP_OFFSET UNITYSDK_OFFSET(0x196FF060)
#define ZZZUICURVEGRAPHIC_DRAWBEZIERCURVELIST_OFFSET UNITYSDK_OFFSET(0x19700EB0)
#define ZZZUICURVEGRAPHIC_DRAWBEZIERCURVE_OFFSET UNITYSDK_OFFSET(0x197010C0)
#define ZZZUICURVEGRAPHIC_ENABLEUIVERTEXCOLORCALC_OFFSET UNITYSDK_OFFSET(0x196FE800)
#define ZZZUICURVEGRAPHIC_GETAPPROXPOINT_OFFSET UNITYSDK_OFFSET(0x19700140)
#define ZZZUICURVEGRAPHIC_LINETOOSHORT_OFFSET UNITYSDK_OFFSET(0x197007F0)
#define ZZZUICURVEGRAPHIC_ONMATERIALCHANGED_OFFSET UNITYSDK_OFFSET(0x196FE880)
#define ZZZUICURVEGRAPHIC_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x19700DB0)
#define ZZZUICURVEGRAPHIC_REFRESHMESH_OFFSET UNITYSDK_OFFSET(0x196FF3E0)
#define ZZZUICURVEGRAPHIC_REMOVESAMECURVE_OFFSET UNITYSDK_OFFSET(0x196FFE00)
#define ZZZUICURVEGRAPHIC_SPLITTOMIXEDCURVES_OFFSET UNITYSDK_OFFSET(0x196FF640)
#define ZZZUICURVEGRAPHIC_START_OFFSET UNITYSDK_OFFSET(0x196FE630)
#define ZZZUICURVEGRAPHIC_UPDATECURVEANIMATION_OFFSET UNITYSDK_OFFSET(0x196FEB40)
#define ZZZUICURVEGRAPHIC_UPDATEMASKPOSRADIUS_OFFSET UNITYSDK_OFFSET(0x196FECD0)
#define ZZZUICURVEGRAPHIC_UPDATE_OFFSET UNITYSDK_OFFSET(0x196FEAC0)
#define ZZZUICURVEGRAPHIC__CCTOR_OFFSET UNITYSDK_OFFSET(0x197022D0)
#define ZZZUICURVEGRAPHIC__CTOR_OFFSET UNITYSDK_OFFSET(0x197020E0)
#define ZZZUICURVEGRAPHIC___BASE_ONPOPULATEMESH_OFFSET UNITYSDK_OFFSET(0x197023A0)
#define ZZZUICURVEGRAPHIC___BASE_START_OFFSET UNITYSDK_OFFSET(0x197023B0)

inline static constexpr unsigned int ZzzUiCurveGraphic_TypeDefinitionIndex = 39828;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xAF30);
	}
	static ::System::Int32* StaticGet_IconPosRadiusArray()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xAF34);
	}
	static ::System::Int32* StaticGet_WorldScaleUV()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xAF38);
	}
	static ::System::Int32* StaticGet_CurveCloseShadowColor()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xAF3C);
	}
	static ::System::Int32* StaticGet_CurveCloseColor()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xAF40);
	}
	static ::System::Int32* StaticGet_IconPosArraySize()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xAF44);
	}
	static ::System::Int32* StaticGet_CurveOpenColor()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xAF48);
	}
	static ::System::Int32* StaticGet_AnimationProgress()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ZzzUiCurveGraphic_TypeDefinitionIndex)->GetStaticField(0xAF4C);
	}
