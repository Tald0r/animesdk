...
#define CLASS_1_C1A35900D7C07432__CTOR_OFFSET UNITYSDK_OFFSET(0x8CE3A40)

inline static constexpr unsigned int Class_1_C1A35900D7C07432_TypeDefinitionIndex = 65917;

class Class_1_C1A35900D7C07432 : public ::System::Object
{
public:
	::MoleMole::UIForbiddenAreaTalentLinkWidgetController* Field_1_6; // 0x10
	::MoleMole::UIForbiddenAreaTalentBranchLinkWidgetController* Field_1_8; // 0x18
	::MoleMole::UIForbiddenAreaTalentPointWidgetController* Field_1_5; // 0x20
	...
	::MoleMole::UIForbiddenAreaTalentPointWidgetController* Field_1_3; // 0x38
