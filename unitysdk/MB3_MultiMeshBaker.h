...
#define MB3_MULTIMESHBAKER_ADDDELETEGAMEOBJECTSBYID_OFFSET UNITYSDK_OFFSET(0x1A7D8870)
#define MB3_MULTIMESHBAKER_ADDDELETEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A7D8660)
#define MB3_MULTIMESHBAKER_GET_MESHCOMBINER_OFFSET UNITYSDK_OFFSET(0x1A7D8650)
#define MB3_MULTIMESHBAKER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A7D8A80)
#define MB3_MULTIMESHBAKER_PRINTTIMINGS_OFFSET UNITYSDK_OFFSET(0x1A7D74E0)
#define MB3_MULTIMESHBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D8AA0)

inline static constexpr unsigned int MB3_MultiMeshBaker_TypeDefinitionIndex = 83246;
