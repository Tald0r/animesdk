...
#define MB3_MULTIMESHBAKER_ADDDELETEGAMEOBJECTSBYID_OFFSET UNITYSDK_OFFSET(0x1A221C10)
#define MB3_MULTIMESHBAKER_ADDDELETEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A221A00)
#define MB3_MULTIMESHBAKER_GET_MESHCOMBINER_OFFSET UNITYSDK_OFFSET(0x1A2219F0)
#define MB3_MULTIMESHBAKER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A221E20)
#define MB3_MULTIMESHBAKER_PRINTTIMINGS_OFFSET UNITYSDK_OFFSET(0x1A220880)
#define MB3_MULTIMESHBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A221E40)

inline static constexpr unsigned int MB3_MultiMeshBaker_TypeDefinitionIndex = 81205;
