...
#define MONOLAYOUTELEMENTPROCESSOR_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x6857CE0)
#define MONOLAYOUTELEMENTPROCESSOR_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x6857D40)
#define MONOLAYOUTELEMENTPROCESSOR_CANUSE_OFFSET UNITYSDK_OFFSET(0x6856F40)
#define MONOLAYOUTELEMENTPROCESSOR_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x68578C0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x6857AD0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x68578B0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x68576A0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x6857490)
#define MONOLAYOUTELEMENTPROCESSOR_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x6857280)
#define MONOLAYOUTELEMENTPROCESSOR_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x6857070)
#define MONOLAYOUTELEMENTPROCESSOR_GET_SOURCELAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0x6857060)
#define MONOLAYOUTELEMENTPROCESSOR_VALIDATESOURCEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x6856D80)
#define MONOLAYOUTELEMENTPROCESSOR_VALIDATESOURCETYPE_OFFSET UNITYSDK_OFFSET(0x6856D00)
#define MONOLAYOUTELEMENTPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x6857DA0)

inline static constexpr unsigned int MonoLayoutElementProcessor_TypeDefinitionIndex = 58374;
