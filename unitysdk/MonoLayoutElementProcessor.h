...
#define MONOLAYOUTELEMENTPROCESSOR_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x852D100)
#define MONOLAYOUTELEMENTPROCESSOR_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x852D160)
#define MONOLAYOUTELEMENTPROCESSOR_CANUSE_OFFSET UNITYSDK_OFFSET(0x852C360)
#define MONOLAYOUTELEMENTPROCESSOR_GET_FLEXIBLEHEIGHT_OFFSET UNITYSDK_OFFSET(0x852CCE0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_FLEXIBLEWIDTH_OFFSET UNITYSDK_OFFSET(0x852CEF0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_LAYOUTPRIORITY_OFFSET UNITYSDK_OFFSET(0x852CCD0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_MINHEIGHT_OFFSET UNITYSDK_OFFSET(0x852CAC0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_MINWIDTH_OFFSET UNITYSDK_OFFSET(0x852C8B0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_PREFERREDHEIGHT_OFFSET UNITYSDK_OFFSET(0x852C6A0)
#define MONOLAYOUTELEMENTPROCESSOR_GET_PREFERREDWIDTH_OFFSET UNITYSDK_OFFSET(0x852C490)
#define MONOLAYOUTELEMENTPROCESSOR_GET_SOURCELAYOUTELEMENT_OFFSET UNITYSDK_OFFSET(0x852C480)
#define MONOLAYOUTELEMENTPROCESSOR_VALIDATESOURCEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x852C1A0)
#define MONOLAYOUTELEMENTPROCESSOR_VALIDATESOURCETYPE_OFFSET UNITYSDK_OFFSET(0x852C120)
#define MONOLAYOUTELEMENTPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x852D1C0)

inline static constexpr unsigned int MonoLayoutElementProcessor_TypeDefinitionIndex = 80219;
