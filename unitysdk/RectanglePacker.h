...
#define RECTANGLEPACKER_ALLOCATERECTANGLE_OFFSET UNITYSDK_OFFSET(0x17633740)
#define RECTANGLEPACKER_ALLOCATESIZE_OFFSET UNITYSDK_OFFSET(0x17633B00)
#define RECTANGLEPACKER_FILTERSELFSUBAREAS_OFFSET UNITYSDK_OFFSET(0x17634A50)
#define RECTANGLEPACKER_FREERECTANGLE_OFFSET UNITYSDK_OFFSET(0x176336B0)
#define RECTANGLEPACKER_FREESIZE_OFFSET UNITYSDK_OFFSET(0x17633860)
#define RECTANGLEPACKER_GENERATEDIVIDEDAREAS_OFFSET UNITYSDK_OFFSET(0x17634CD0)
#define RECTANGLEPACKER_GENERATENEWFREEAREAS_OFFSET UNITYSDK_OFFSET(0x17634390)
#define RECTANGLEPACKER_GETFREEAREAINDEX_OFFSET UNITYSDK_OFFSET(0x176341E0)
#define RECTANGLEPACKER_GETRECTANGLEID_OFFSET UNITYSDK_OFFSET(0x17633990)
#define RECTANGLEPACKER_GETRECTANGLE_OFFSET UNITYSDK_OFFSET(0x176338E0)
#define RECTANGLEPACKER_GET_FAILEDRECTINDICES_OFFSET UNITYSDK_OFFSET(0x17633080)
#define RECTANGLEPACKER_GET_PACKEDHEIGHT_OFFSET UNITYSDK_OFFSET(0x17633060)
#define RECTANGLEPACKER_GET_PACKEDWIDTH_OFFSET UNITYSDK_OFFSET(0x17633050)
#define RECTANGLEPACKER_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x17633070)
#define RECTANGLEPACKER_GET_RECTANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x17633030)
#define RECTANGLEPACKER_INSERTRECTANGLE_OFFSET UNITYSDK_OFFSET(0x17633A00)
#define RECTANGLEPACKER_PACKRECTANGLES_OFFSET UNITYSDK_OFFSET(0x17633BA0)
#define RECTANGLEPACKER_RESET_OFFSET UNITYSDK_OFFSET(0x17633240)
#define RECTANGLEPACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x17633090)

inline static constexpr unsigned int RectanglePacker_TypeDefinitionIndex = 29113;

class RectanglePacker : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::IntegerRectangle>* mInsertedRectangles; // 0x10
	::System::Collections::Generic::Queue_1<::RectanglePacker_SortableSize>* mInsertList; // 0x18
	::System::Collections::Generic::List_1<::IntegerRectangle>* mRectangleStack; // 0x20
	::System::Collections::Generic::List_1<::IntegerRectangle>* mNewFreeAreas; // 0x28
	::System::Collections::Generic::List_1<::System::Int32>* mFailedRectIndices; // 0x30
	::System::Collections::Generic::List_1<::RectanglePacker_SortableSize>* mSortableSizeStack; // 0x38
	::System::Collections::Generic::List_1<::IntegerRectangle>* mFreeAreas; // 0x40
	::System::Int32 mPackedHeight; // 0x48
	::System::Int32 mPadding; // 0x4C
	::IntegerRectangle mOutsideRectangle; // 0x50
	::System::Int32 mHeight; // 0x70
	::System::Int32 mWidth; // 0x74
	::System::Int32 mPackedWidth; // 0x78
