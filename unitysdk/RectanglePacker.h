...
#define RECTANGLEPACKER_ALLOCATERECTANGLE_OFFSET UNITYSDK_OFFSET(0x16F5F4A0)
#define RECTANGLEPACKER_ALLOCATESIZE_OFFSET UNITYSDK_OFFSET(0x16F5F860)
#define RECTANGLEPACKER_FILTERSELFSUBAREAS_OFFSET UNITYSDK_OFFSET(0x16F607B0)
#define RECTANGLEPACKER_FREERECTANGLE_OFFSET UNITYSDK_OFFSET(0x16F5F410)
#define RECTANGLEPACKER_FREESIZE_OFFSET UNITYSDK_OFFSET(0x16F5F5C0)
#define RECTANGLEPACKER_GENERATEDIVIDEDAREAS_OFFSET UNITYSDK_OFFSET(0x16F60A30)
#define RECTANGLEPACKER_GENERATENEWFREEAREAS_OFFSET UNITYSDK_OFFSET(0x16F600F0)
#define RECTANGLEPACKER_GETFREEAREAINDEX_OFFSET UNITYSDK_OFFSET(0x16F5FF40)
#define RECTANGLEPACKER_GETRECTANGLEID_OFFSET UNITYSDK_OFFSET(0x16F5F6F0)
#define RECTANGLEPACKER_GETRECTANGLE_OFFSET UNITYSDK_OFFSET(0x16F5F640)
#define RECTANGLEPACKER_GET_FAILEDRECTINDICES_OFFSET UNITYSDK_OFFSET(0x16F5EDE0)
#define RECTANGLEPACKER_GET_PACKEDHEIGHT_OFFSET UNITYSDK_OFFSET(0x16F5EDC0)
#define RECTANGLEPACKER_GET_PACKEDWIDTH_OFFSET UNITYSDK_OFFSET(0x16F5EDB0)
#define RECTANGLEPACKER_GET_PADDING_OFFSET UNITYSDK_OFFSET(0x16F5EDD0)
#define RECTANGLEPACKER_GET_RECTANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x16F5ED90)
#define RECTANGLEPACKER_INSERTRECTANGLE_OFFSET UNITYSDK_OFFSET(0x16F5F760)
#define RECTANGLEPACKER_PACKRECTANGLES_OFFSET UNITYSDK_OFFSET(0x16F5F900)
#define RECTANGLEPACKER_RESET_OFFSET UNITYSDK_OFFSET(0x16F5EFA0)
#define RECTANGLEPACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5EDF0)

inline static constexpr unsigned int RectanglePacker_TypeDefinitionIndex = 28172;
...
public:
	...
	::System::Collections::Generic::List_1<::RectanglePacker_SortableSize>* mSortableSizeStack; // 0x28
	::System::Collections::Generic::List_1<::System::Int32>* mFailedRectIndices; // 0x30
	::System::Collections::Generic::List_1<::IntegerRectangle>* mFreeAreas; // 0x38
	::System::Collections::Generic::Queue_1<::RectanglePacker_SortableSize>* mInsertList; // 0x40
	::System::Int32 mPadding; // 0x48
	::System::Int32 mPackedWidth; // 0x4C
	::IntegerRectangle mOutsideRectangle; // 0x50
	::System::Int32 mWidth; // 0x70
	::System::Int32 mHeight; // 0x74
