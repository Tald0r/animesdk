...
#define SHADERANIHELP_AWAKE_OFFSET UNITYSDK_OFFSET(0x1820DA50)
#define SHADERANIHELP_GETISPLAYINGANDNOTPREFAB_OFFSET UNITYSDK_OFFSET(0x1820D9E0)
#define SHADERANIHELP_INIT_OFFSET UNITYSDK_OFFSET(0x1820E690)
#define SHADERANIHELP_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18210660)
#define SHADERANIHELP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x182106E0)
#define SHADERANIHELP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x18210240)
#define SHADERANIHELP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1820E3D0)
#define SHADERANIHELP_ONGRAPHICMATERIALCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0x182105F0)
#define SHADERANIHELP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x18210810)
#define SHADERANIHELP_PRECHECKFIELDS_OFFSET UNITYSDK_OFFSET(0x1820DE10)
#define SHADERANIHELP_REFLESH_OFFSET UNITYSDK_OFFSET(0x1820E6F0)
#define SHADERANIHELP_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1820D550)
#define SHADERANIHELP__CTOR_OFFSET UNITYSDK_OFFSET(0x18210880)

inline static constexpr unsigned int ShaderAniHelp_TypeDefinitionIndex = 46598;
