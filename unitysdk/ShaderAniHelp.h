...
#define SHADERANIHELP_AWAKE_OFFSET UNITYSDK_OFFSET(0x8F02FE0)
#define SHADERANIHELP_GETISPLAYINGANDNOTPREFAB_OFFSET UNITYSDK_OFFSET(0x8F02F70)
#define SHADERANIHELP_INIT_OFFSET UNITYSDK_OFFSET(0x1A8A0DC0)
#define SHADERANIHELP_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A8A2D90)
#define SHADERANIHELP_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A8A2970)
#define SHADERANIHELP_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A8A0B00)
#define SHADERANIHELP_ONGRAPHICMATERIALCHANGEHANDLE_OFFSET UNITYSDK_OFFSET(0x1A8A2D20)
#define SHADERANIHELP_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A8A2EC0)
#define SHADERANIHELP_PRECHECKFIELDS_OFFSET UNITYSDK_OFFSET(0x8F033A0)
#define SHADERANIHELP_REFLESH_OFFSET UNITYSDK_OFFSET(0x1A8A0E20)
#define SHADERANIHELP_UPDATEMATERIAL_OFFSET UNITYSDK_OFFSET(0x8F02AE0)
#define SHADERANIHELP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8A2F30)

inline static constexpr unsigned int ShaderAniHelp_TypeDefinitionIndex = 75518;
