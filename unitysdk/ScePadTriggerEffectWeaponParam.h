...
#define SCEPADTRIGGEREFFECTWEAPONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x3A3220)

inline static constexpr unsigned int ScePadTriggerEffectWeaponParam_TypeDefinitionIndex = 59537;
