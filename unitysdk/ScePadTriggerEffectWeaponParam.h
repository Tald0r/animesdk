...
#define SCEPADTRIGGEREFFECTWEAPONPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0x784930)

inline static constexpr unsigned int ScePadTriggerEffectWeaponParam_TypeDefinitionIndex = 74085;
