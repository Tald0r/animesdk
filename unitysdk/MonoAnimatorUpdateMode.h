...
#define MONOANIMATORUPDATEMODE_AWAKE_OFFSET UNITYSDK_OFFSET(0x6B010B0)
#define MONOANIMATORUPDATEMODE_GET_AVATARANIMATOR_OFFSET UNITYSDK_OFFSET(0x6B00F70)
#define MONOANIMATORUPDATEMODE_UPDATEMANUAL_OFFSET UNITYSDK_OFFSET(0x6B011D0)
#define MONOANIMATORUPDATEMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x6B01310)

inline static constexpr unsigned int MonoAnimatorUpdateMode_TypeDefinitionIndex = 72184;
