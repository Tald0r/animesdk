...
#define CLASS_2_A5A7A6F10C2C8A88_METHOD_2_086AF5E1F81FD4BC_OFFSET UNITYSDK_OFFSET(0x9580050)
#define CLASS_2_A5A7A6F10C2C8A88_METHOD_2_2CC6984AABE321AA_OFFSET UNITYSDK_OFFSET(0x957FE10)
#define CLASS_2_A5A7A6F10C2C8A88_METHOD_2_92CECBA9626A797C_OFFSET UNITYSDK_OFFSET(0x957FD80)
#define CLASS_2_A5A7A6F10C2C8A88_METHOD_2_E2D9D20A8901CE22_OFFSET UNITYSDK_OFFSET(0x957F8E0)
#define CLASS_2_A5A7A6F10C2C8A88__CTOR_OFFSET UNITYSDK_OFFSET(0x957FD30)

inline static constexpr unsigned int Class_2_A5A7A6F10C2C8A88_TypeDefinitionIndex = 78788;
...
public:
	...
	{
		return ((::System::Void(*)(::PVOID, ::Enum_3_D6CF5AFC914C2B63))((::PBYTE)hIl2Cpp + CLASS_2_A5A7A6F10C2C8A88_METHOD_2_92CECBA9626A797C_OFFSET))(this, a1);
	}
