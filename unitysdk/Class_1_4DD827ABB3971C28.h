...
#define CLASS_1_4DD827ABB3971C28_METHOD_1_03B1BF2F2F8589FD_1_OFFSET UNITYSDK_OFFSET(0x964FFD0)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_03B1BF2F2F8589FD_OFFSET UNITYSDK_OFFSET(0x964E250)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_0CBDBA9CA0B6BF99_OFFSET UNITYSDK_OFFSET(0x964D840)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_1659BCB6D1A9FC34_1_OFFSET UNITYSDK_OFFSET(0x964DDB0)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_1659BCB6D1A9FC34_OFFSET UNITYSDK_OFFSET(0x964CDA0)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_18CC28A365540467_OFFSET UNITYSDK_OFFSET(0x964D240)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_1E91FFFB37216F67_1_OFFSET UNITYSDK_OFFSET(0x964DAE0)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_1E91FFFB37216F67_OFFSET UNITYSDK_OFFSET(0x964CC90)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_2C0A443620D4B5E2_OFFSET UNITYSDK_OFFSET(0x964F7C0)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_2CBE0B79DD36047E_OFFSET UNITYSDK_OFFSET(0x964EFB0)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_43D07ADB8B3A84C6_OFFSET UNITYSDK_OFFSET(0x964E810)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_5790A55946AA509D_OFFSET UNITYSDK_OFFSET(0x964E900)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_5DF574466CCD0CE3_OFFSET UNITYSDK_OFFSET(0x964E360)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_71BA9FC96EAA27D0_OFFSET UNITYSDK_OFFSET(0x964E2B0)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_7E8421BD4C2BAFFA_OFFSET UNITYSDK_OFFSET(0x964E880)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_B44D811F22C9DB74_OFFSET UNITYSDK_OFFSET(0x964CB60)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_BE3C026E37192957_OFFSET UNITYSDK_OFFSET(0x964DBF0)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_C74F1F5106B79E79_OFFSET UNITYSDK_OFFSET(0x964ED20)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_C8E2469222842786_OFFSET UNITYSDK_OFFSET(0x964E960)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_DEAC86EB2AD5D389_OFFSET UNITYSDK_OFFSET(0x964F870)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_E30D25437A17FB18_OFFSET UNITYSDK_OFFSET(0x964FB10)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_E9C5DEE581662A66_OFFSET UNITYSDK_OFFSET(0x964FB90)
#define CLASS_1_4DD827ABB3971C28_METHOD_1_F8159D27A5B9DBC8_OFFSET UNITYSDK_OFFSET(0x964C860)
#define CLASS_1_4DD827ABB3971C28__CCTOR_OFFSET UNITYSDK_OFFSET(0x964C790)

inline static constexpr unsigned int Class_1_4DD827ABB3971C28_TypeDefinitionIndex = 63427;
...
public:
	...
	{
		return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4DD827ABB3971C28_TypeDefinitionIndex)->GetStaticField(0x41D40);
	}
	static ::Il2CppArray<::System::Char>** StaticGet_Field_1_1()
	{
		return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_4DD827ABB3971C28_TypeDefinitionIndex)->GetStaticField(0x41D48);
	}
