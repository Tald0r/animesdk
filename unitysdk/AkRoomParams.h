...
#define AKROOMPARAMS_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B018F80)
#define AKROOMPARAMS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B018EC0)
#define AKROOMPARAMS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B018F10)
#define AKROOMPARAMS_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1B018E50)
#define AKROOMPARAMS_GET_FRONT_OFFSET UNITYSDK_OFFSET(0x1B0193E0)
#define AKROOMPARAMS_GET_REVERBAUXBUS_OFFSET UNITYSDK_OFFSET(0x1B019500)
#define AKROOMPARAMS_GET_REVERBLEVEL_OFFSET UNITYSDK_OFFSET(0x1B019610)
#define AKROOMPARAMS_GET_ROOMGAMEOBJ_AUXSENDLEVELTOSELF_OFFSET UNITYSDK_OFFSET(0x1B019830)
#define AKROOMPARAMS_GET_ROOMGAMEOBJ_KEEPREGISTERED_OFFSET UNITYSDK_OFFSET(0x1B019930)
#define AKROOMPARAMS_GET_UP_OFFSET UNITYSDK_OFFSET(0x1B0192A0)
#define AKROOMPARAMS_GET_WALLOCCLUSION_OFFSET UNITYSDK_OFFSET(0x1B019720)
#define AKROOMPARAMS_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1B018E60)
#define AKROOMPARAMS_SET_FRONT_OFFSET UNITYSDK_OFFSET(0x1B019340)
#define AKROOMPARAMS_SET_REVERBAUXBUS_OFFSET UNITYSDK_OFFSET(0x1B019480)
#define AKROOMPARAMS_SET_REVERBLEVEL_OFFSET UNITYSDK_OFFSET(0x1B019580)
#define AKROOMPARAMS_SET_ROOMGAMEOBJ_AUXSENDLEVELTOSELF_OFFSET UNITYSDK_OFFSET(0x1B0197A0)
#define AKROOMPARAMS_SET_ROOMGAMEOBJ_KEEPREGISTERED_OFFSET UNITYSDK_OFFSET(0x1B0198B0)
#define AKROOMPARAMS_SET_UP_OFFSET UNITYSDK_OFFSET(0x1B019200)
#define AKROOMPARAMS_SET_WALLOCCLUSION_OFFSET UNITYSDK_OFFSET(0x1B019690)
#define AKROOMPARAMS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0190E0)
#define AKROOMPARAMS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B019160)
#define AKROOMPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B018E40)

inline static constexpr unsigned int AkRoomParams_TypeDefinitionIndex = 29978;
