...
#define AKROOMPARAMS_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B6273B0)
#define AKROOMPARAMS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B6272F0)
#define AKROOMPARAMS_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B627340)
#define AKROOMPARAMS_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1B627280)
#define AKROOMPARAMS_GET_FRONT_OFFSET UNITYSDK_OFFSET(0x1B627810)
#define AKROOMPARAMS_GET_REVERBAUXBUS_OFFSET UNITYSDK_OFFSET(0x1B627930)
#define AKROOMPARAMS_GET_REVERBLEVEL_OFFSET UNITYSDK_OFFSET(0x1B627A40)
#define AKROOMPARAMS_GET_ROOMGAMEOBJ_AUXSENDLEVELTOSELF_OFFSET UNITYSDK_OFFSET(0x1B627C60)
#define AKROOMPARAMS_GET_ROOMGAMEOBJ_KEEPREGISTERED_OFFSET UNITYSDK_OFFSET(0x1B627D60)
#define AKROOMPARAMS_GET_UP_OFFSET UNITYSDK_OFFSET(0x1B6276D0)
#define AKROOMPARAMS_GET_WALLOCCLUSION_OFFSET UNITYSDK_OFFSET(0x1B627B50)
#define AKROOMPARAMS_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1B627290)
#define AKROOMPARAMS_SET_FRONT_OFFSET UNITYSDK_OFFSET(0x1B627770)
#define AKROOMPARAMS_SET_REVERBAUXBUS_OFFSET UNITYSDK_OFFSET(0x1B6278B0)
#define AKROOMPARAMS_SET_REVERBLEVEL_OFFSET UNITYSDK_OFFSET(0x1B6279B0)
#define AKROOMPARAMS_SET_ROOMGAMEOBJ_AUXSENDLEVELTOSELF_OFFSET UNITYSDK_OFFSET(0x1B627BD0)
#define AKROOMPARAMS_SET_ROOMGAMEOBJ_KEEPREGISTERED_OFFSET UNITYSDK_OFFSET(0x1B627CE0)
#define AKROOMPARAMS_SET_UP_OFFSET UNITYSDK_OFFSET(0x1B627630)
#define AKROOMPARAMS_SET_WALLOCCLUSION_OFFSET UNITYSDK_OFFSET(0x1B627AC0)
#define AKROOMPARAMS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B627510)
#define AKROOMPARAMS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B627590)
#define AKROOMPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B627270)

inline static constexpr unsigned int AkRoomParams_TypeDefinitionIndex = 30931;
