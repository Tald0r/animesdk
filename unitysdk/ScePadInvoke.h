...
#define SCEPADINVOKE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x16EB1CB0)
#define SCEPADINVOKE_GETSCEPADHANDLE_OFFSET UNITYSDK_OFFSET(0x16EB0DB0)
#define SCEPADINVOKE_INITSCEPADINTERNAL_OFFSET UNITYSDK_OFFSET(0x16EB0A80)
#define SCEPADINVOKE_SCEPADSETTRIGGEREFFECTINTERNAL_OFFSET UNITYSDK_OFFSET(0x16EB0EB0)
#define SCEPADINVOKE_SCEPADSETTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x16EB0960)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTFEEDBACK_OFFSET UNITYSDK_OFFSET(0x16EB1460)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTMULTIPLEPOSITIONFEEDBACK_OFFSET UNITYSDK_OFFSET(0x16EB17F0)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTMULTIPLEPOSITIONVIBRATION_OFFSET UNITYSDK_OFFSET(0x16EB15D0)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTOFF_OFFSET UNITYSDK_OFFSET(0x16EB1B80)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTSLOPEFEEDBACK_OFFSET UNITYSDK_OFFSET(0x16EB19C0)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTVIBRATION_OFFSET UNITYSDK_OFFSET(0x16EB12B0)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTWEAPON_OFFSET UNITYSDK_OFFSET(0x16EB1100)
#define SCEPADINVOKE__CCTOR_OFFSET UNITYSDK_OFFSET(0x16EB1E80)
#define SCEPADINVOKE__CTOR_OFFSET UNITYSDK_OFFSET(0x16EB1E70)

inline static constexpr unsigned int ScePadInvoke_TypeDefinitionIndex = 49949;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScePadInvoke_TypeDefinitionIndex)->GetStaticField(0xDC50);
	}
	static ::System::Int32* StaticGet__scePadHandle()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScePadInvoke_TypeDefinitionIndex)->GetStaticField(0xDC54);
	}
	static ::System::Boolean* StaticGet__sceInited()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ScePadInvoke_TypeDefinitionIndex)->GetStaticField(0xDC58);
	}
	static ::System::Byte* StaticGet_SCE_PAD_TRIGGER_EFFECT_TRIGGER_MASK_L2()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(ScePadInvoke_TypeDefinitionIndex)->GetStaticField(0xDC59);
	}
	static ::System::Byte* StaticGet_SCE_PAD_TRIGGER_EFFECT_TRIGGER_MASK_R2()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(ScePadInvoke_TypeDefinitionIndex)->GetStaticField(0xDC5A);
	}
	static ::System::Int32* StaticGet_SCE_PAD_TRIGGER_EFFECT_CONTROL_POINT_NUM()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScePadInvoke_TypeDefinitionIndex)->GetStaticField(0xDC5C);
	}
