...
#define SCEPADINVOKE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6A82F00)
#define SCEPADINVOKE_GETSCEPADHANDLE_OFFSET UNITYSDK_OFFSET(0x6A82000)
#define SCEPADINVOKE_INITSCEPADINTERNAL_OFFSET UNITYSDK_OFFSET(0x6A81CD0)
#define SCEPADINVOKE_SCEPADSETTRIGGEREFFECTINTERNAL_OFFSET UNITYSDK_OFFSET(0x6A82100)
#define SCEPADINVOKE_SCEPADSETTRIGGEREFFECT_OFFSET UNITYSDK_OFFSET(0x6A81BB0)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTFEEDBACK_OFFSET UNITYSDK_OFFSET(0x6A826B0)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTMULTIPLEPOSITIONFEEDBACK_OFFSET UNITYSDK_OFFSET(0x6A82A40)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTMULTIPLEPOSITIONVIBRATION_OFFSET UNITYSDK_OFFSET(0x6A82820)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTOFF_OFFSET UNITYSDK_OFFSET(0x6A82DD0)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTSLOPEFEEDBACK_OFFSET UNITYSDK_OFFSET(0x6A82C10)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTVIBRATION_OFFSET UNITYSDK_OFFSET(0x6A82500)
#define SCEPADINVOKE_SETGAMEPADTRIGGEREFFECTWEAPON_OFFSET UNITYSDK_OFFSET(0x6A82350)
#define SCEPADINVOKE__CCTOR_OFFSET UNITYSDK_OFFSET(0x6A830D0)
#define SCEPADINVOKE__CTOR_OFFSET UNITYSDK_OFFSET(0x6A830C0)

inline static constexpr unsigned int ScePadInvoke_TypeDefinitionIndex = 42072;
...
public:
	...
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScePadInvoke_TypeDefinitionIndex)->GetStaticField(0xE350);
	}
	static ::System::Byte* StaticGet_SCE_PAD_TRIGGER_EFFECT_TRIGGER_MASK_L2()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(ScePadInvoke_TypeDefinitionIndex)->GetStaticField(0xE354);
	}
	static ::System::Byte* StaticGet_SCE_PAD_TRIGGER_EFFECT_TRIGGER_MASK_R2()
	{
		return (::System::Byte*)Il2CppClass::FromTypeDefinitionIndex(ScePadInvoke_TypeDefinitionIndex)->GetStaticField(0xE355);
	}
	static ::System::Boolean* StaticGet__sceInited()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ScePadInvoke_TypeDefinitionIndex)->GetStaticField(0xE356);
	}
	static ::System::Int32* StaticGet_SCE_USER_SERVICE_MAX_LOGIN_USERS()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScePadInvoke_TypeDefinitionIndex)->GetStaticField(0xE358);
	}
	static ::System::Int32* StaticGet_SCE_PAD_TRIGGER_EFFECT_CONTROL_POINT_NUM()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(ScePadInvoke_TypeDefinitionIndex)->GetStaticField(0xE35C);
	}
