...
#define AKSWITCH_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1B0F0CB0)
#define AKSWITCH_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B0F0B60)
#define AKSWITCH_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1B0F0B80)
#define AKSWITCH_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1B0F0B10)
#define AKSWITCH_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1B0F09D0)
#define AKSWITCH_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1B0F09E0)
#define AKSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F0DF0)

inline static constexpr unsigned int AkSwitch_TypeDefinitionIndex = 30146;
