...
#define AKSWITCH_GET_GROUPGUID_OFFSET UNITYSDK_OFFSET(0x1B7077C0)
#define AKSWITCH_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x1B707670)
#define AKSWITCH_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1B707690)
#define AKSWITCH_GET_VALUEID_OFFSET UNITYSDK_OFFSET(0x1B707620)
#define AKSWITCH_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1B7074E0)
#define AKSWITCH_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1B7074F0)
#define AKSWITCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B707900)

inline static constexpr unsigned int AkSwitch_TypeDefinitionIndex = 31099;
