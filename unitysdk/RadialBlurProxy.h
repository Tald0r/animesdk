...
#define RADIALBLURPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xD5D1E20)
#define RADIALBLURPROXY_COPYVALUEFROMRADIALBLUR_OFFSET UNITYSDK_OFFSET(0xD5D2190)
#define RADIALBLURPROXY_SETVALUETORADIALBLUR_OFFSET UNITYSDK_OFFSET(0xD5D2370)
#define RADIALBLURPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xD5D2300)
#define RADIALBLURPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xD5D2700)

inline static constexpr unsigned int RadialBlurProxy_TypeDefinitionIndex = 40587;
