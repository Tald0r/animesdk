...
#define RADIALBLURPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A4BB900)
#define RADIALBLURPROXY_COPYVALUEFROMRADIALBLUR_OFFSET UNITYSDK_OFFSET(0x1A4BBC70)
#define RADIALBLURPROXY_SETVALUETORADIALBLUR_OFFSET UNITYSDK_OFFSET(0x1A4BBE50)
#define RADIALBLURPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A4BBDE0)
#define RADIALBLURPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4BC1E0)

inline static constexpr unsigned int RadialBlurProxy_TypeDefinitionIndex = 62213;
