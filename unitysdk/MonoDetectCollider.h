...
#define MONODETECTCOLLIDER_LOOKAROUND_OFFSET UNITYSDK_OFFSET(0x1B6790E0)
#define MONODETECTCOLLIDER_LOOK_OFFSET UNITYSDK_OFFSET(0x1B679040)
#define MONODETECTCOLLIDER_START_OFFSET UNITYSDK_OFFSET(0x1B678A70)
#define MONODETECTCOLLIDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B678A80)
#define MONODETECTCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B679770)

inline static constexpr unsigned int MonoDetectCollider_TypeDefinitionIndex = 83753;
