...
#define MONODETECTCOLLIDER_LOOKAROUND_OFFSET UNITYSDK_OFFSET(0x1B06B3D0)
#define MONODETECTCOLLIDER_LOOK_OFFSET UNITYSDK_OFFSET(0x1B06B330)
#define MONODETECTCOLLIDER_START_OFFSET UNITYSDK_OFFSET(0x1B06AD60)
#define MONODETECTCOLLIDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B06AD70)
#define MONODETECTCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B06BA60)

inline static constexpr unsigned int MonoDetectCollider_TypeDefinitionIndex = 81708;
