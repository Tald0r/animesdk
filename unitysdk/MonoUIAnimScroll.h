...
#define MONOUIANIMSCROLL_ADDCHILD_OFFSET UNITYSDK_OFFSET(0xA143EB0)
#define MONOUIANIMSCROLL_AWAKE_OFFSET UNITYSDK_OFFSET(0xA1435D0)
#define MONOUIANIMSCROLL_GETCHILDBOUNDS_OFFSET UNITYSDK_OFFSET(0xA144E40)
#define MONOUIANIMSCROLL_GETUIELEMENTINFO_OFFSET UNITYSDK_OFFSET(0xA143E10)
#define MONOUIANIMSCROLL_GET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0xA146180)
#define MONOUIANIMSCROLL_GET_SOUNDACTIONSOURCEHINT_OFFSET UNITYSDK_OFFSET(0xA1461F0)
#define MONOUIANIMSCROLL_GET_SOUNDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xA1461E0)
#define MONOUIANIMSCROLL_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA1460F0)
#define MONOUIANIMSCROLL_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0xA146060)
#define MONOUIANIMSCROLL_ONCONTENTBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xA1455B0)
#define MONOUIANIMSCROLL_ONCONTENTDRAG_OFFSET UNITYSDK_OFFSET(0xA145AF0)
#define MONOUIANIMSCROLL_ONCONTENTENDDRAG_OFFSET UNITYSDK_OFFSET(0xA145830)
#define MONOUIANIMSCROLL_ONSCROLLBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xA145C90)
#define MONOUIANIMSCROLL_ONSCROLLDRAG_OFFSET UNITYSDK_OFFSET(0xA145D00)
#define MONOUIANIMSCROLL_ONSCROLLENDDRAG_OFFSET UNITYSDK_OFFSET(0xA145D80)
#define MONOUIANIMSCROLL_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xA144240)
#define MONOUIANIMSCROLL_ONVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xA145350)
#define MONOUIANIMSCROLL_ONVERTICALBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xA145DF0)
#define MONOUIANIMSCROLL_ONVERTICALDRAG_OFFSET UNITYSDK_OFFSET(0xA145F70)
#define MONOUIANIMSCROLL_ONVERTICALPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xA145FE0)
#define MONOUIANIMSCROLL_ONVERTICALPOINTERUP_OFFSET UNITYSDK_OFFSET(0xA145EF0)
#define MONOUIANIMSCROLL_ONVERTICALVALUECHANGED_OFFSET UNITYSDK_OFFSET(0xA145E60)
#define MONOUIANIMSCROLL_OUTOFRANGE_OFFSET UNITYSDK_OFFSET(0xA1440B0)
#define MONOUIANIMSCROLL_REFRESHSTATE_OFFSET UNITYSDK_OFFSET(0xA144570)
#define MONOUIANIMSCROLL_REFRESH_OFFSET UNITYSDK_OFFSET(0xA144620)
#define MONOUIANIMSCROLL_SCROLLMOVE_OFFSET UNITYSDK_OFFSET(0xA144340)
#define MONOUIANIMSCROLL_SETFIXPOSITION_OFFSET UNITYSDK_OFFSET(0xA1452D0)
#define MONOUIANIMSCROLL_SET_SERIALIZATIONDATA_OFFSET UNITYSDK_OFFSET(0xA1461B0)
#define MONOUIANIMSCROLL_UPDATE_OFFSET UNITYSDK_OFFSET(0xA145400)
#define MONOUIANIMSCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0xA1462C0)
#define MONOUIANIMSCROLL___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0xA146360)
#define MONOUIANIMSCROLL___BASE_ONSCROLL_OFFSET UNITYSDK_OFFSET(0xA1463F0)

inline static constexpr unsigned int MonoUIAnimScroll_TypeDefinitionIndex = 51769;
