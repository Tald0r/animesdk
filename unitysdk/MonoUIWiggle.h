...
#define MONOUIWIGGLE_FRAC_OFFSET UNITYSDK_OFFSET(0x7BFB8D0)
#define MONOUIWIGGLE_RAND_OFFSET UNITYSDK_OFFSET(0x7BFB950)
#define MONOUIWIGGLE_START_OFFSET UNITYSDK_OFFSET(0x7BFB790)
#define MONOUIWIGGLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x7BFBA50)
#define MONOUIWIGGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x7BFBB90)

inline static constexpr unsigned int MonoUIWiggle_TypeDefinitionIndex = 41212;
