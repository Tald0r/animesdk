...
#define MONOUIWIGGLE_FRAC_OFFSET UNITYSDK_OFFSET(0x60666E0)
#define MONOUIWIGGLE_RAND_OFFSET UNITYSDK_OFFSET(0x6066760)
#define MONOUIWIGGLE_START_OFFSET UNITYSDK_OFFSET(0x60665A0)
#define MONOUIWIGGLE_UPDATE_OFFSET UNITYSDK_OFFSET(0x6066860)
#define MONOUIWIGGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x60669A0)

inline static constexpr unsigned int MonoUIWiggle_TypeDefinitionIndex = 47116;
