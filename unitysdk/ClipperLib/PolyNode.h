...
#define CLIPPERLIB_POLYNODE_ADDCHILD_OFFSET UNITYSDK_OFFSET(0x19BAC260)
#define CLIPPERLIB_POLYNODE_GETNEXTSIBLINGUP_OFFSET UNITYSDK_OFFSET(0x19BB6710)
#define CLIPPERLIB_POLYNODE_GETNEXT_OFFSET UNITYSDK_OFFSET(0x19BB6600)
#define CLIPPERLIB_POLYNODE_GET_CHILDCOUNT_OFFSET UNITYSDK_OFFSET(0x19BB1930)
#define CLIPPERLIB_POLYNODE_GET_CHILDS_OFFSET UNITYSDK_OFFSET(0x19BB67D0)
#define CLIPPERLIB_POLYNODE_GET_CONTOUR_OFFSET UNITYSDK_OFFSET(0x19BB65F0)
#define CLIPPERLIB_POLYNODE_GET_ISHOLE_OFFSET UNITYSDK_OFFSET(0x19BB67F0)
#define CLIPPERLIB_POLYNODE_GET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x19BB6820)
#define CLIPPERLIB_POLYNODE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x19BB67E0)
#define CLIPPERLIB_POLYNODE_ISHOLENODE_OFFSET UNITYSDK_OFFSET(0x19BB65C0)
#define CLIPPERLIB_POLYNODE_SET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x19BB6830)
#define CLIPPERLIB_POLYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BAC1B0)

namespace ClipperLib
{
	inline static constexpr unsigned int PolyNode_TypeDefinitionIndex = 29736;

	class PolyNode : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::ClipperLib::PolyNode*>* m_Childs; // 0x10
		::ClipperLib::PolyNode* m_Parent; // 0x18
		::System::Collections::Generic::List_1<::ClipperLib::IntPoint>* m_polygon; // 0x20
		::ClipperLib::EndType m_endtype; // 0x28
		::System::Boolean _IsOpen_k__BackingField; // 0x2C
		::System::Int32 m_Index; // 0x30
		::ClipperLib::JoinType m_jointype; // 0x34
