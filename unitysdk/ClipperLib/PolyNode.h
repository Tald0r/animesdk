...
#define CLIPPERLIB_POLYNODE_ADDCHILD_OFFSET UNITYSDK_OFFSET(0x1A190940)
#define CLIPPERLIB_POLYNODE_GETNEXTSIBLINGUP_OFFSET UNITYSDK_OFFSET(0x1A19AE20)
#define CLIPPERLIB_POLYNODE_GETNEXT_OFFSET UNITYSDK_OFFSET(0x1A19AD10)
#define CLIPPERLIB_POLYNODE_GET_CHILDCOUNT_OFFSET UNITYSDK_OFFSET(0x1A195FE0)
#define CLIPPERLIB_POLYNODE_GET_CHILDS_OFFSET UNITYSDK_OFFSET(0x1A19AEE0)
#define CLIPPERLIB_POLYNODE_GET_CONTOUR_OFFSET UNITYSDK_OFFSET(0x1A19AD00)
#define CLIPPERLIB_POLYNODE_GET_ISHOLE_OFFSET UNITYSDK_OFFSET(0x1A19AF00)
#define CLIPPERLIB_POLYNODE_GET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x1A19AF30)
#define CLIPPERLIB_POLYNODE_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x1A19AEF0)
#define CLIPPERLIB_POLYNODE_ISHOLENODE_OFFSET UNITYSDK_OFFSET(0x1A19ACD0)
#define CLIPPERLIB_POLYNODE_SET_ISOPEN_OFFSET UNITYSDK_OFFSET(0x1A19AF40)
#define CLIPPERLIB_POLYNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A190890)

namespace ClipperLib
{
	inline static constexpr unsigned int PolyNode_TypeDefinitionIndex = 30689;
