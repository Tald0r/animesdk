...
#define CLIPPERLIB_CLIPPERBASE_ADDPATHS_OFFSET UNITYSDK_OFFSET(0x1A1939D0)
#define CLIPPERLIB_CLIPPERBASE_ADDPATH_OFFSET UNITYSDK_OFFSET(0x1A192C10)
#define CLIPPERLIB_CLIPPERBASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A196600)
#define CLIPPERLIB_CLIPPERBASE_CREATEOUTREC_OFFSET UNITYSDK_OFFSET(0x1A18D5C0)
#define CLIPPERLIB_CLIPPERBASE_DELETEFROMAEL_OFFSET UNITYSDK_OFFSET(0x1A18EEE0)
#define CLIPPERLIB_CLIPPERBASE_DISPOSELOCALMINIMALIST_OFFSET UNITYSDK_OFFSET(0x1A196780)
#define CLIPPERLIB_CLIPPERBASE_DISPOSEOUTREC_OFFSET UNITYSDK_OFFSET(0x1A18B9C0)
#define CLIPPERLIB_CLIPPERBASE_FINDNEXTLOCMIN_OFFSET UNITYSDK_OFFSET(0x1A1969E0)
#define CLIPPERLIB_CLIPPERBASE_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A197160)
#define CLIPPERLIB_CLIPPERBASE_GET_PRESERVECOLLINEAR_OFFSET UNITYSDK_OFFSET(0x1A196180)
#define CLIPPERLIB_CLIPPERBASE_INITEDGE2_OFFSET UNITYSDK_OFFSET(0x1A1968C0)
#define CLIPPERLIB_CLIPPERBASE_INITEDGE_OFFSET UNITYSDK_OFFSET(0x1A196890)
#define CLIPPERLIB_CLIPPERBASE_INSERTLOCALMINIMA_OFFSET UNITYSDK_OFFSET(0x1A197080)
#define CLIPPERLIB_CLIPPERBASE_INSERTSCANBEAM_OFFSET UNITYSDK_OFFSET(0x1A18C2C0)
#define CLIPPERLIB_CLIPPERBASE_ISHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1A18C650)
#define CLIPPERLIB_CLIPPERBASE_LOCALMINIMAPENDING_OFFSET UNITYSDK_OFFSET(0x1A18A9C0)
#define CLIPPERLIB_CLIPPERBASE_NEAR_ZERO_OFFSET UNITYSDK_OFFSET(0x1A196150)
#define CLIPPERLIB_CLIPPERBASE_POINTISVERTEX_OFFSET UNITYSDK_OFFSET(0x1A1961A0)
#define CLIPPERLIB_CLIPPERBASE_POINTONLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x1A1961E0)
#define CLIPPERLIB_CLIPPERBASE_POINTONPOLYGON_OFFSET UNITYSDK_OFFSET(0x1A196560)
#define CLIPPERLIB_CLIPPERBASE_POPLOCALMINIMA_OFFSET UNITYSDK_OFFSET(0x1A18CE60)
#define CLIPPERLIB_CLIPPERBASE_POPSCANBEAM_OFFSET UNITYSDK_OFFSET(0x1A189830)
#define CLIPPERLIB_CLIPPERBASE_PROCESSBOUND_OFFSET UNITYSDK_OFFSET(0x1A196B10)
#define CLIPPERLIB_CLIPPERBASE_PT2ISBETWEENPT1ANDPT3_OFFSET UNITYSDK_OFFSET(0x1A190B70)
#define CLIPPERLIB_CLIPPERBASE_RANGETEST_OFFSET UNITYSDK_OFFSET(0x1A1967A0)
#define CLIPPERLIB_CLIPPERBASE_REMOVEEDGE_OFFSET UNITYSDK_OFFSET(0x1A197110)
#define CLIPPERLIB_CLIPPERBASE_RESET_OFFSET UNITYSDK_OFFSET(0x1A1897B0)
#define CLIPPERLIB_CLIPPERBASE_REVERSEHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1A1970D0)
#define CLIPPERLIB_CLIPPERBASE_SETDX_OFFSET UNITYSDK_OFFSET(0x1A196970)
#define CLIPPERLIB_CLIPPERBASE_SET_PRESERVECOLLINEAR_OFFSET UNITYSDK_OFFSET(0x1A196190)
#define CLIPPERLIB_CLIPPERBASE_SLOPESEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1A1909B0)
#define CLIPPERLIB_CLIPPERBASE_SLOPESEQUAL_2_OFFSET UNITYSDK_OFFSET(0x1A18C6F0)
#define CLIPPERLIB_CLIPPERBASE_SLOPESEQUAL_OFFSET UNITYSDK_OFFSET(0x1A18F1C0)
#define CLIPPERLIB_CLIPPERBASE_SWAPPOSITIONSINAEL_OFFSET UNITYSDK_OFFSET(0x1A18EF40)
#define CLIPPERLIB_CLIPPERBASE_SWAP_OFFSET UNITYSDK_OFFSET(0x1A18D860)
#define CLIPPERLIB_CLIPPERBASE_UPDATEEDGEINTOAEL_OFFSET UNITYSDK_OFFSET(0x1A18F050)
#define CLIPPERLIB_CLIPPERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1880E0)

namespace ClipperLib
{
	inline static constexpr unsigned int ClipperBase_TypeDefinitionIndex = 30709;
	...
	public:
		...
		::ClipperLib::LocalMinima* m_MinimaList; // 0x10
		::System::Collections::Generic::List_1<::ClipperLib::OutRec*>* m_PolyOuts; // 0x18
		::ClipperLib::LocalMinima* m_CurrentLM; // 0x20
