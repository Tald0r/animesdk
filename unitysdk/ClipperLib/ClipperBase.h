...
#define CLIPPERLIB_CLIPPERBASE_ADDPATHS_OFFSET UNITYSDK_OFFSET(0x19BAF320)
#define CLIPPERLIB_CLIPPERBASE_ADDPATH_OFFSET UNITYSDK_OFFSET(0x19BAE530)
#define CLIPPERLIB_CLIPPERBASE_CLEAR_OFFSET UNITYSDK_OFFSET(0x19BB1F50)
#define CLIPPERLIB_CLIPPERBASE_CREATEOUTREC_OFFSET UNITYSDK_OFFSET(0x19BA8F70)
#define CLIPPERLIB_CLIPPERBASE_DELETEFROMAEL_OFFSET UNITYSDK_OFFSET(0x19BAA880)
#define CLIPPERLIB_CLIPPERBASE_DISPOSELOCALMINIMALIST_OFFSET UNITYSDK_OFFSET(0x19BB20D0)
#define CLIPPERLIB_CLIPPERBASE_DISPOSEOUTREC_OFFSET UNITYSDK_OFFSET(0x19BA7370)
#define CLIPPERLIB_CLIPPERBASE_FINDNEXTLOCMIN_OFFSET UNITYSDK_OFFSET(0x19BB2330)
#define CLIPPERLIB_CLIPPERBASE_GETBOUNDS_OFFSET UNITYSDK_OFFSET(0x19BB2A60)
#define CLIPPERLIB_CLIPPERBASE_GET_PRESERVECOLLINEAR_OFFSET UNITYSDK_OFFSET(0x19BB1AD0)
#define CLIPPERLIB_CLIPPERBASE_INITEDGE2_OFFSET UNITYSDK_OFFSET(0x19BB2220)
#define CLIPPERLIB_CLIPPERBASE_INITEDGE_OFFSET UNITYSDK_OFFSET(0x19BB21E0)
#define CLIPPERLIB_CLIPPERBASE_INSERTLOCALMINIMA_OFFSET UNITYSDK_OFFSET(0x19BB2980)
#define CLIPPERLIB_CLIPPERBASE_INSERTSCANBEAM_OFFSET UNITYSDK_OFFSET(0x19BA7C60)
#define CLIPPERLIB_CLIPPERBASE_ISHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x19BA7FF0)
#define CLIPPERLIB_CLIPPERBASE_LOCALMINIMAPENDING_OFFSET UNITYSDK_OFFSET(0x19BA6380)
#define CLIPPERLIB_CLIPPERBASE_NEAR_ZERO_OFFSET UNITYSDK_OFFSET(0x19BB1AA0)
#define CLIPPERLIB_CLIPPERBASE_POINTISVERTEX_OFFSET UNITYSDK_OFFSET(0x19BB1AF0)
#define CLIPPERLIB_CLIPPERBASE_POINTONLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x19BB1B30)
#define CLIPPERLIB_CLIPPERBASE_POINTONPOLYGON_OFFSET UNITYSDK_OFFSET(0x19BB1EB0)
#define CLIPPERLIB_CLIPPERBASE_POPLOCALMINIMA_OFFSET UNITYSDK_OFFSET(0x19BA8810)
#define CLIPPERLIB_CLIPPERBASE_POPSCANBEAM_OFFSET UNITYSDK_OFFSET(0x19BA50B0)
#define CLIPPERLIB_CLIPPERBASE_PROCESSBOUND_OFFSET UNITYSDK_OFFSET(0x19BB2450)
#define CLIPPERLIB_CLIPPERBASE_PT2ISBETWEENPT1ANDPT3_OFFSET UNITYSDK_OFFSET(0x19BAC490)
#define CLIPPERLIB_CLIPPERBASE_RANGETEST_OFFSET UNITYSDK_OFFSET(0x19BB20F0)
#define CLIPPERLIB_CLIPPERBASE_REMOVEEDGE_OFFSET UNITYSDK_OFFSET(0x19BB2A10)
#define CLIPPERLIB_CLIPPERBASE_RESET_OFFSET UNITYSDK_OFFSET(0x19BA5030)
#define CLIPPERLIB_CLIPPERBASE_REVERSEHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x19BB29D0)
#define CLIPPERLIB_CLIPPERBASE_SETDX_OFFSET UNITYSDK_OFFSET(0x19BB22D0)
#define CLIPPERLIB_CLIPPERBASE_SET_PRESERVECOLLINEAR_OFFSET UNITYSDK_OFFSET(0x19BB1AE0)
#define CLIPPERLIB_CLIPPERBASE_SLOPESEQUAL_1_OFFSET UNITYSDK_OFFSET(0x19BAC2D0)
#define CLIPPERLIB_CLIPPERBASE_SLOPESEQUAL_2_OFFSET UNITYSDK_OFFSET(0x19BA8090)
#define CLIPPERLIB_CLIPPERBASE_SLOPESEQUAL_OFFSET UNITYSDK_OFFSET(0x19BAAB60)
#define CLIPPERLIB_CLIPPERBASE_SWAPPOSITIONSINAEL_OFFSET UNITYSDK_OFFSET(0x19BAA8E0)
#define CLIPPERLIB_CLIPPERBASE_SWAP_OFFSET UNITYSDK_OFFSET(0x19BA9210)
#define CLIPPERLIB_CLIPPERBASE_UPDATEEDGEINTOAEL_OFFSET UNITYSDK_OFFSET(0x19BAA9F0)
#define CLIPPERLIB_CLIPPERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19BA3970)

namespace ClipperLib
{
	inline static constexpr unsigned int ClipperBase_TypeDefinitionIndex = 29756;
	...
	public:
		...
		::ClipperLib::LocalMinima* m_CurrentLM; // 0x10
		::ClipperLib::LocalMinima* m_MinimaList; // 0x18
		::System::Collections::Generic::List_1<::ClipperLib::OutRec*>* m_PolyOuts; // 0x20
		::ClipperLib::TEdge* m_ActiveEdges; // 0x28
		::ClipperLib::Scanbeam* m_Scanbeam; // 0x30
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::ClipperLib::TEdge*>*>* m_edges; // 0x38
