...
#define CLIPPERLIB_CLIPPER_ADDEDGETOSEL_OFFSET UNITYSDK_OFFSET(0x19BA8010)
#define CLIPPERLIB_CLIPPER_ADDGHOSTJOIN_OFFSET UNITYSDK_OFFSET(0x19BA74A0)
#define CLIPPERLIB_CLIPPER_ADDJOIN_OFFSET UNITYSDK_OFFSET(0x19BA7400)
#define CLIPPERLIB_CLIPPER_ADDLOCALMAXPOLY_OFFSET UNITYSDK_OFFSET(0x19BA8B70)
#define CLIPPERLIB_CLIPPER_ADDLOCALMINPOLY_OFFSET UNITYSDK_OFFSET(0x19BA7D50)
#define CLIPPERLIB_CLIPPER_ADDOUTPT_OFFSET UNITYSDK_OFFSET(0x19BA7AA0)
#define CLIPPERLIB_CLIPPER_ADDPOLYNODETOPATHS_OFFSET UNITYSDK_OFFSET(0x19BB1660)
#define CLIPPERLIB_CLIPPER_APPENDPOLYGON_OFFSET UNITYSDK_OFFSET(0x19BA8C10)
#define CLIPPERLIB_CLIPPER_AREA_1_OFFSET UNITYSDK_OFFSET(0x19BA6390)
#define CLIPPERLIB_CLIPPER_AREA_2_OFFSET UNITYSDK_OFFSET(0x19BA9560)
#define CLIPPERLIB_CLIPPER_AREA_OFFSET UNITYSDK_OFFSET(0x19BAC000)
#define CLIPPERLIB_CLIPPER_BUILDINTERSECTLIST_OFFSET UNITYSDK_OFFSET(0x19BAAE90)
#define CLIPPERLIB_CLIPPER_BUILDRESULT2_OFFSET UNITYSDK_OFFSET(0x19BA49A0)
#define CLIPPERLIB_CLIPPER_BUILDRESULT_OFFSET UNITYSDK_OFFSET(0x19BA45B0)
#define CLIPPERLIB_CLIPPER_CLEANPOLYGONS_OFFSET UNITYSDK_OFFSET(0x19BAFC70)
#define CLIPPERLIB_CLIPPER_CLEANPOLYGON_OFFSET UNITYSDK_OFFSET(0x19BAF720)
#define CLIPPERLIB_CLIPPER_CLOSEDPATHSFROMPOLYTREE_OFFSET UNITYSDK_OFFSET(0x19BB1950)
#define CLIPPERLIB_CLIPPER_COPYAELTOSEL_OFFSET UNITYSDK_OFFSET(0x19BA8A10)
#define CLIPPERLIB_CLIPPER_DELETEFROMSEL_OFFSET UNITYSDK_OFFSET(0x19BA98C0)
#define CLIPPERLIB_CLIPPER_DISPOSEALLPOLYPTS_OFFSET UNITYSDK_OFFSET(0x19BA4930)
#define CLIPPERLIB_CLIPPER_DISTANCEFROMLINESQRD_OFFSET UNITYSDK_OFFSET(0x19BAF430)
#define CLIPPERLIB_CLIPPER_DISTANCESQRD_OFFSET UNITYSDK_OFFSET(0x19BAF3D0)
#define CLIPPERLIB_CLIPPER_DOMAXIMA_OFFSET UNITYSDK_OFFSET(0x19BAB960)
#define CLIPPERLIB_CLIPPER_DOSIMPLEPOLYGONS_OFFSET UNITYSDK_OFFSET(0x19BA6D30)
#define CLIPPERLIB_CLIPPER_DUPOUTPT_OFFSET UNITYSDK_OFFSET(0x19BAC4F0)
#define CLIPPERLIB_CLIPPER_E2INSERTSBEFOREE1_OFFSET UNITYSDK_OFFSET(0x19BA8840)
#define CLIPPERLIB_CLIPPER_EDGESADJACENT_OFFSET UNITYSDK_OFFSET(0x19BAB8D0)
#define CLIPPERLIB_CLIPPER_EXCLUDEOP_OFFSET UNITYSDK_OFFSET(0x19BAF6D0)
#define CLIPPERLIB_CLIPPER_EXECUTEINTERNAL_OFFSET UNITYSDK_OFFSET(0x19BA3F50)
#define CLIPPERLIB_CLIPPER_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x19BA3D60)
#define CLIPPERLIB_CLIPPER_EXECUTE_2_OFFSET UNITYSDK_OFFSET(0x19BA3B60)
#define CLIPPERLIB_CLIPPER_EXECUTE_3_OFFSET UNITYSDK_OFFSET(0x19BA3D80)
#define CLIPPERLIB_CLIPPER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19BA3B40)
#define CLIPPERLIB_CLIPPER_FIRSTISBOTTOMPT_OFFSET UNITYSDK_OFFSET(0x19BA9250)
#define CLIPPERLIB_CLIPPER_FIXHOLELINKAGE_OFFSET UNITYSDK_OFFSET(0x19BA4FB0)
#define CLIPPERLIB_CLIPPER_FIXUPFIRSTLEFTS1_OFFSET UNITYSDK_OFFSET(0x19BADA00)
#define CLIPPERLIB_CLIPPER_FIXUPFIRSTLEFTS2_OFFSET UNITYSDK_OFFSET(0x19BADD80)
#define CLIPPERLIB_CLIPPER_FIXUPFIRSTLEFTS3_OFFSET UNITYSDK_OFFSET(0x19BAE2A0)
#define CLIPPERLIB_CLIPPER_FIXUPINTERSECTIONORDER_OFFSET UNITYSDK_OFFSET(0x19BAB1C0)
#define CLIPPERLIB_CLIPPER_FIXUPOUTPOLYGON_OFFSET UNITYSDK_OFFSET(0x19BA6AF0)
#define CLIPPERLIB_CLIPPER_FIXUPOUTPOLYLINE_OFFSET UNITYSDK_OFFSET(0x19BA6A50)
#define CLIPPERLIB_CLIPPER_GETBOTTOMPT_OFFSET UNITYSDK_OFFSET(0x19BA95D0)
#define CLIPPERLIB_CLIPPER_GETDX_OFFSET UNITYSDK_OFFSET(0x19BA9220)
#define CLIPPERLIB_CLIPPER_GETHORZDIRECTION_OFFSET UNITYSDK_OFFSET(0x19BAA780)
#define CLIPPERLIB_CLIPPER_GETLASTOUTPT_OFFSET UNITYSDK_OFFSET(0x19BA9150)
#define CLIPPERLIB_CLIPPER_GETLOWERMOSTREC_OFFSET UNITYSDK_OFFSET(0x19BA96E0)
#define CLIPPERLIB_CLIPPER_GETMAXIMAPAIREX_OFFSET UNITYSDK_OFFSET(0x19BAADF0)
#define CLIPPERLIB_CLIPPER_GETMAXIMAPAIR_OFFSET UNITYSDK_OFFSET(0x19BAA7D0)
#define CLIPPERLIB_CLIPPER_GETNEXTINAEL_OFFSET UNITYSDK_OFFSET(0x19BAA840)
#define CLIPPERLIB_CLIPPER_GETOUTREC_OFFSET UNITYSDK_OFFSET(0x19BA97D0)
#define CLIPPERLIB_CLIPPER_GETOVERLAP_OFFSET UNITYSDK_OFFSET(0x19BAC5C0)
#define CLIPPERLIB_CLIPPER_GET_REVERSESOLUTION_OFFSET UNITYSDK_OFFSET(0x19BA3B00)
#define CLIPPERLIB_CLIPPER_GET_STRICTLYSIMPLE_OFFSET UNITYSDK_OFFSET(0x19BA3B20)
#define CLIPPERLIB_CLIPPER_HORZSEGMENTSOVERLAP_OFFSET UNITYSDK_OFFSET(0x19BA8060)
#define CLIPPERLIB_CLIPPER_INSERTEDGEINTOAEL_OFFSET UNITYSDK_OFFSET(0x19BA7530)
#define CLIPPERLIB_CLIPPER_INSERTLOCALMINIMAINTOAEL_OFFSET UNITYSDK_OFFSET(0x19BA50E0)
#define CLIPPERLIB_CLIPPER_INSERTMAXIMA_OFFSET UNITYSDK_OFFSET(0x19BA3A10)
#define CLIPPERLIB_CLIPPER_INTERSECTEDGES_OFFSET UNITYSDK_OFFSET(0x19BA8250)
#define CLIPPERLIB_CLIPPER_INTERSECTNODESORT_OFFSET UNITYSDK_OFFSET(0x19BAB910)
#define CLIPPERLIB_CLIPPER_INTERSECTPOINT_OFFSET UNITYSDK_OFFSET(0x19BAB530)
#define CLIPPERLIB_CLIPPER_ISCONTRIBUTING_OFFSET UNITYSDK_OFFSET(0x19BA7980)
#define CLIPPERLIB_CLIPPER_ISEVENODDALTFILLTYPE_OFFSET UNITYSDK_OFFSET(0x19BA89A0)
#define CLIPPERLIB_CLIPPER_ISEVENODDFILLTYPE_OFFSET UNITYSDK_OFFSET(0x19BA8970)
#define CLIPPERLIB_CLIPPER_ISINTERMEDIATE_OFFSET UNITYSDK_OFFSET(0x19BAADB0)
#define CLIPPERLIB_CLIPPER_ISMAXIMA_OFFSET UNITYSDK_OFFSET(0x19BAAD90)
#define CLIPPERLIB_CLIPPER_ISMINIMA_OFFSET UNITYSDK_OFFSET(0x19BAAD50)
#define CLIPPERLIB_CLIPPER_JOINCOMMONEDGES_OFFSET UNITYSDK_OFFSET(0x19BA6450)
#define CLIPPERLIB_CLIPPER_JOINHORZ_OFFSET UNITYSDK_OFFSET(0x19BAC650)
#define CLIPPERLIB_CLIPPER_JOINPOINTS_OFFSET UNITYSDK_OFFSET(0x19BACFA0)
#define CLIPPERLIB_CLIPPER_MINKOWSKIDIFF_OFFSET UNITYSDK_OFFSET(0x19BB1380)
#define CLIPPERLIB_CLIPPER_MINKOWSKISUM_1_OFFSET UNITYSDK_OFFSET(0x19BB0FF0)
#define CLIPPERLIB_CLIPPER_MINKOWSKISUM_OFFSET UNITYSDK_OFFSET(0x19BB0D80)
#define CLIPPERLIB_CLIPPER_MINKOWSKI_OFFSET UNITYSDK_OFFSET(0x19BAFD50)
#define CLIPPERLIB_CLIPPER_OPENPATHSFROMPOLYTREE_OFFSET UNITYSDK_OFFSET(0x19BB17F0)
#define CLIPPERLIB_CLIPPER_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x19BABF50)
#define CLIPPERLIB_CLIPPER_OUTREC1RIGHTOFOUTREC2_OFFSET UNITYSDK_OFFSET(0x19BA9790)
#define CLIPPERLIB_CLIPPER_PARSEFIRSTLEFT_OFFSET UNITYSDK_OFFSET(0x19BADD50)
#define CLIPPERLIB_CLIPPER_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x19BAC0B0)
#define CLIPPERLIB_CLIPPER_POINTINPOLYGON_1_OFFSET UNITYSDK_OFFSET(0x19BAD860)
#define CLIPPERLIB_CLIPPER_POINTINPOLYGON_OFFSET UNITYSDK_OFFSET(0x19BAD6D0)
#define CLIPPERLIB_CLIPPER_POINTSARECLOSE_OFFSET UNITYSDK_OFFSET(0x19BAF670)
#define CLIPPERLIB_CLIPPER_POLY2CONTAINSPOLY1_OFFSET UNITYSDK_OFFSET(0x19BAD9A0)
#define CLIPPERLIB_CLIPPER_POLYTREETOPATHS_OFFSET UNITYSDK_OFFSET(0x19BB1490)
#define CLIPPERLIB_CLIPPER_POPEDGEFROMSEL_OFFSET UNITYSDK_OFFSET(0x19BA89D0)
#define CLIPPERLIB_CLIPPER_PROCESSEDGESATTOPOFSCANBEAM_OFFSET UNITYSDK_OFFSET(0x19BA5B40)
#define CLIPPERLIB_CLIPPER_PROCESSHORIZONTALS_OFFSET UNITYSDK_OFFSET(0x19BA59B0)
#define CLIPPERLIB_CLIPPER_PROCESSHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x19BA9920)
#define CLIPPERLIB_CLIPPER_PROCESSINTERSECTIONS_OFFSET UNITYSDK_OFFSET(0x19BA5A10)
#define CLIPPERLIB_CLIPPER_PROCESSINTERSECTLIST_OFFSET UNITYSDK_OFFSET(0x19BAB450)
#define CLIPPERLIB_CLIPPER_REVERSEPATHS_OFFSET UNITYSDK_OFFSET(0x19BABE20)
#define CLIPPERLIB_CLIPPER_REVERSEPOLYPTLINKS_OFFSET UNITYSDK_OFFSET(0x19BA6410)
#define CLIPPERLIB_CLIPPER_ROUND_OFFSET UNITYSDK_OFFSET(0x19BAB940)
#define CLIPPERLIB_CLIPPER_SETHOLESTATE_OFFSET UNITYSDK_OFFSET(0x19BA9030)
#define CLIPPERLIB_CLIPPER_SETWINDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x19BA7780)
#define CLIPPERLIB_CLIPPER_SET_REVERSESOLUTION_OFFSET UNITYSDK_OFFSET(0x19BA3B10)
#define CLIPPERLIB_CLIPPER_SET_STRICTLYSIMPLE_OFFSET UNITYSDK_OFFSET(0x19BA3B30)
#define CLIPPERLIB_CLIPPER_SIMPLIFYPOLYGONS_OFFSET UNITYSDK_OFFSET(0x19BAF1C0)
#define CLIPPERLIB_CLIPPER_SIMPLIFYPOLYGON_OFFSET UNITYSDK_OFFSET(0x19BAE440)
#define CLIPPERLIB_CLIPPER_SLOPESNEARCOLLINEAR_OFFSET UNITYSDK_OFFSET(0x19BAF4A0)
#define CLIPPERLIB_CLIPPER_SWAPPOINTS_OFFSET UNITYSDK_OFFSET(0x19BA91F0)
#define CLIPPERLIB_CLIPPER_SWAPPOLYINDEXES_OFFSET UNITYSDK_OFFSET(0x19BA9890)
#define CLIPPERLIB_CLIPPER_SWAPPOSITIONSINSEL_OFFSET UNITYSDK_OFFSET(0x19BA8A40)
#define CLIPPERLIB_CLIPPER_SWAPSIDES_OFFSET UNITYSDK_OFFSET(0x19BA9860)
#define CLIPPERLIB_CLIPPER_TOPX_OFFSET UNITYSDK_OFFSET(0x19BA8910)
#define CLIPPERLIB_CLIPPER_TRANSLATEPATH_OFFSET UNITYSDK_OFFSET(0x19BB0EA0)
#define CLIPPERLIB_CLIPPER_UPDATEOUTPTIDXS_OFFSET UNITYSDK_OFFSET(0x19BAE400)
#define CLIPPERLIB_CLIPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19BA3710)

namespace ClipperLib
{
	inline static constexpr unsigned int Clipper_TypeDefinitionIndex = 29757;
	...
	public:
		...
		::System::Collections::Generic::List_1<::ClipperLib::Join*>* m_GhostJoins; // 0x58
		::System::Collections::Generic::List_1<::ClipperLib::Join*>* m_Joins; // 0x60
		::System::Collections::Generic::List_1<::ClipperLib::IntersectNode*>* m_IntersectList; // 0x68
		...
		::ClipperLib::PolyFillType m_SubjFillType; // 0x7C
		::ClipperLib::ClipType m_ClipType; // 0x80
		::System::Boolean _StrictlySimple_k__BackingField; // 0x84
		::System::Boolean m_UsingPolyTree; // 0x85
