...
#define CLIPPERLIB_CLIPPER_ADDEDGETOSEL_OFFSET UNITYSDK_OFFSET(0x1A18C670)
#define CLIPPERLIB_CLIPPER_ADDGHOSTJOIN_OFFSET UNITYSDK_OFFSET(0x1A18BAF0)
#define CLIPPERLIB_CLIPPER_ADDJOIN_OFFSET UNITYSDK_OFFSET(0x1A18BA50)
#define CLIPPERLIB_CLIPPER_ADDLOCALMAXPOLY_OFFSET UNITYSDK_OFFSET(0x1A18D1C0)
#define CLIPPERLIB_CLIPPER_ADDLOCALMINPOLY_OFFSET UNITYSDK_OFFSET(0x1A18C3B0)
#define CLIPPERLIB_CLIPPER_ADDOUTPT_OFFSET UNITYSDK_OFFSET(0x1A18C100)
#define CLIPPERLIB_CLIPPER_ADDPOLYNODETOPATHS_OFFSET UNITYSDK_OFFSET(0x1A195D10)
#define CLIPPERLIB_CLIPPER_APPENDPOLYGON_OFFSET UNITYSDK_OFFSET(0x1A18D260)
#define CLIPPERLIB_CLIPPER_AREA_1_OFFSET UNITYSDK_OFFSET(0x1A18A9D0)
#define CLIPPERLIB_CLIPPER_AREA_2_OFFSET UNITYSDK_OFFSET(0x1A18DBB0)
#define CLIPPERLIB_CLIPPER_AREA_OFFSET UNITYSDK_OFFSET(0x1A1906E0)
#define CLIPPERLIB_CLIPPER_BUILDINTERSECTLIST_OFFSET UNITYSDK_OFFSET(0x1A18F500)
#define CLIPPERLIB_CLIPPER_BUILDRESULT2_OFFSET UNITYSDK_OFFSET(0x1A189130)
#define CLIPPERLIB_CLIPPER_BUILDRESULT_OFFSET UNITYSDK_OFFSET(0x1A188D40)
#define CLIPPERLIB_CLIPPER_CLEANPOLYGONS_OFFSET UNITYSDK_OFFSET(0x1A194320)
#define CLIPPERLIB_CLIPPER_CLEANPOLYGON_OFFSET UNITYSDK_OFFSET(0x1A193DD0)
#define CLIPPERLIB_CLIPPER_CLOSEDPATHSFROMPOLYTREE_OFFSET UNITYSDK_OFFSET(0x1A196000)
#define CLIPPERLIB_CLIPPER_COPYAELTOSEL_OFFSET UNITYSDK_OFFSET(0x1A18D060)
#define CLIPPERLIB_CLIPPER_DELETEFROMSEL_OFFSET UNITYSDK_OFFSET(0x1A18DF10)
#define CLIPPERLIB_CLIPPER_DISPOSEALLPOLYPTS_OFFSET UNITYSDK_OFFSET(0x1A1890C0)
#define CLIPPERLIB_CLIPPER_DISTANCEFROMLINESQRD_OFFSET UNITYSDK_OFFSET(0x1A193AE0)
#define CLIPPERLIB_CLIPPER_DISTANCESQRD_OFFSET UNITYSDK_OFFSET(0x1A193A80)
#define CLIPPERLIB_CLIPPER_DOMAXIMA_OFFSET UNITYSDK_OFFSET(0x1A190020)
#define CLIPPERLIB_CLIPPER_DOSIMPLEPOLYGONS_OFFSET UNITYSDK_OFFSET(0x1A18B380)
#define CLIPPERLIB_CLIPPER_DUPOUTPT_OFFSET UNITYSDK_OFFSET(0x1A190BD0)
#define CLIPPERLIB_CLIPPER_E2INSERTSBEFOREE1_OFFSET UNITYSDK_OFFSET(0x1A18CE90)
#define CLIPPERLIB_CLIPPER_EDGESADJACENT_OFFSET UNITYSDK_OFFSET(0x1A18FF90)
#define CLIPPERLIB_CLIPPER_EXCLUDEOP_OFFSET UNITYSDK_OFFSET(0x1A193D80)
#define CLIPPERLIB_CLIPPER_EXECUTEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A1886D0)
#define CLIPPERLIB_CLIPPER_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x1A1884E0)
#define CLIPPERLIB_CLIPPER_EXECUTE_2_OFFSET UNITYSDK_OFFSET(0x1A1882E0)
#define CLIPPERLIB_CLIPPER_EXECUTE_3_OFFSET UNITYSDK_OFFSET(0x1A188500)
#define CLIPPERLIB_CLIPPER_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A1882C0)
#define CLIPPERLIB_CLIPPER_FIRSTISBOTTOMPT_OFFSET UNITYSDK_OFFSET(0x1A18D8A0)
#define CLIPPERLIB_CLIPPER_FIXHOLELINKAGE_OFFSET UNITYSDK_OFFSET(0x1A189730)
#define CLIPPERLIB_CLIPPER_FIXUPFIRSTLEFTS1_OFFSET UNITYSDK_OFFSET(0x1A1920E0)
#define CLIPPERLIB_CLIPPER_FIXUPFIRSTLEFTS2_OFFSET UNITYSDK_OFFSET(0x1A192460)
#define CLIPPERLIB_CLIPPER_FIXUPFIRSTLEFTS3_OFFSET UNITYSDK_OFFSET(0x1A192980)
#define CLIPPERLIB_CLIPPER_FIXUPINTERSECTIONORDER_OFFSET UNITYSDK_OFFSET(0x1A18F830)
#define CLIPPERLIB_CLIPPER_FIXUPOUTPOLYGON_OFFSET UNITYSDK_OFFSET(0x1A18B140)
#define CLIPPERLIB_CLIPPER_FIXUPOUTPOLYLINE_OFFSET UNITYSDK_OFFSET(0x1A18B0A0)
#define CLIPPERLIB_CLIPPER_GETBOTTOMPT_OFFSET UNITYSDK_OFFSET(0x1A18DC20)
#define CLIPPERLIB_CLIPPER_GETDX_OFFSET UNITYSDK_OFFSET(0x1A18D870)
#define CLIPPERLIB_CLIPPER_GETHORZDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A18EDE0)
#define CLIPPERLIB_CLIPPER_GETLASTOUTPT_OFFSET UNITYSDK_OFFSET(0x1A18D7A0)
#define CLIPPERLIB_CLIPPER_GETLOWERMOSTREC_OFFSET UNITYSDK_OFFSET(0x1A18DD30)
#define CLIPPERLIB_CLIPPER_GETMAXIMAPAIREX_OFFSET UNITYSDK_OFFSET(0x1A18F460)
#define CLIPPERLIB_CLIPPER_GETMAXIMAPAIR_OFFSET UNITYSDK_OFFSET(0x1A18EE30)
#define CLIPPERLIB_CLIPPER_GETNEXTINAEL_OFFSET UNITYSDK_OFFSET(0x1A18EEA0)
#define CLIPPERLIB_CLIPPER_GETOUTREC_OFFSET UNITYSDK_OFFSET(0x1A18DE20)
#define CLIPPERLIB_CLIPPER_GETOVERLAP_OFFSET UNITYSDK_OFFSET(0x1A190CA0)
#define CLIPPERLIB_CLIPPER_GET_REVERSESOLUTION_OFFSET UNITYSDK_OFFSET(0x1A188280)
#define CLIPPERLIB_CLIPPER_GET_STRICTLYSIMPLE_OFFSET UNITYSDK_OFFSET(0x1A1882A0)
#define CLIPPERLIB_CLIPPER_HORZSEGMENTSOVERLAP_OFFSET UNITYSDK_OFFSET(0x1A18C6C0)
#define CLIPPERLIB_CLIPPER_INSERTEDGEINTOAEL_OFFSET UNITYSDK_OFFSET(0x1A18BB80)
#define CLIPPERLIB_CLIPPER_INSERTLOCALMINIMAINTOAEL_OFFSET UNITYSDK_OFFSET(0x1A189860)
#define CLIPPERLIB_CLIPPER_INSERTMAXIMA_OFFSET UNITYSDK_OFFSET(0x1A188190)
#define CLIPPERLIB_CLIPPER_INTERSECTEDGES_OFFSET UNITYSDK_OFFSET(0x1A18C8B0)
#define CLIPPERLIB_CLIPPER_INTERSECTNODESORT_OFFSET UNITYSDK_OFFSET(0x1A18FFD0)
#define CLIPPERLIB_CLIPPER_INTERSECTPOINT_OFFSET UNITYSDK_OFFSET(0x1A18FBA0)
#define CLIPPERLIB_CLIPPER_ISCONTRIBUTING_OFFSET UNITYSDK_OFFSET(0x1A18BFF0)
#define CLIPPERLIB_CLIPPER_ISEVENODDALTFILLTYPE_OFFSET UNITYSDK_OFFSET(0x1A18CFF0)
#define CLIPPERLIB_CLIPPER_ISEVENODDFILLTYPE_OFFSET UNITYSDK_OFFSET(0x1A18CFC0)
#define CLIPPERLIB_CLIPPER_ISINTERMEDIATE_OFFSET UNITYSDK_OFFSET(0x1A18F420)
#define CLIPPERLIB_CLIPPER_ISMAXIMA_OFFSET UNITYSDK_OFFSET(0x1A18F3F0)
#define CLIPPERLIB_CLIPPER_ISMINIMA_OFFSET UNITYSDK_OFFSET(0x1A18F3B0)
#define CLIPPERLIB_CLIPPER_JOINCOMMONEDGES_OFFSET UNITYSDK_OFFSET(0x1A18AA90)
#define CLIPPERLIB_CLIPPER_JOINHORZ_OFFSET UNITYSDK_OFFSET(0x1A190D30)
#define CLIPPERLIB_CLIPPER_JOINPOINTS_OFFSET UNITYSDK_OFFSET(0x1A191680)
#define CLIPPERLIB_CLIPPER_MINKOWSKIDIFF_OFFSET UNITYSDK_OFFSET(0x1A195A30)
#define CLIPPERLIB_CLIPPER_MINKOWSKISUM_1_OFFSET UNITYSDK_OFFSET(0x1A1956A0)
#define CLIPPERLIB_CLIPPER_MINKOWSKISUM_OFFSET UNITYSDK_OFFSET(0x1A195430)
#define CLIPPERLIB_CLIPPER_MINKOWSKI_OFFSET UNITYSDK_OFFSET(0x1A194400)
#define CLIPPERLIB_CLIPPER_OPENPATHSFROMPOLYTREE_OFFSET UNITYSDK_OFFSET(0x1A195EA0)
#define CLIPPERLIB_CLIPPER_ORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A190630)
#define CLIPPERLIB_CLIPPER_OUTREC1RIGHTOFOUTREC2_OFFSET UNITYSDK_OFFSET(0x1A18DDE0)
#define CLIPPERLIB_CLIPPER_PARSEFIRSTLEFT_OFFSET UNITYSDK_OFFSET(0x1A192430)
#define CLIPPERLIB_CLIPPER_POINTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A190790)
#define CLIPPERLIB_CLIPPER_POINTINPOLYGON_1_OFFSET UNITYSDK_OFFSET(0x1A191F40)
#define CLIPPERLIB_CLIPPER_POINTINPOLYGON_OFFSET UNITYSDK_OFFSET(0x1A191DB0)
#define CLIPPERLIB_CLIPPER_POINTSARECLOSE_OFFSET UNITYSDK_OFFSET(0x1A193D20)
#define CLIPPERLIB_CLIPPER_POLY2CONTAINSPOLY1_OFFSET UNITYSDK_OFFSET(0x1A192080)
#define CLIPPERLIB_CLIPPER_POLYTREETOPATHS_OFFSET UNITYSDK_OFFSET(0x1A195B40)
#define CLIPPERLIB_CLIPPER_POPEDGEFROMSEL_OFFSET UNITYSDK_OFFSET(0x1A18D020)
#define CLIPPERLIB_CLIPPER_PROCESSEDGESATTOPOFSCANBEAM_OFFSET UNITYSDK_OFFSET(0x1A18A190)
#define CLIPPERLIB_CLIPPER_PROCESSHORIZONTALS_OFFSET UNITYSDK_OFFSET(0x1A18A000)
#define CLIPPERLIB_CLIPPER_PROCESSHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1A18DF70)
#define CLIPPERLIB_CLIPPER_PROCESSINTERSECTIONS_OFFSET UNITYSDK_OFFSET(0x1A18A060)
#define CLIPPERLIB_CLIPPER_PROCESSINTERSECTLIST_OFFSET UNITYSDK_OFFSET(0x1A18FAC0)
#define CLIPPERLIB_CLIPPER_REVERSEPATHS_OFFSET UNITYSDK_OFFSET(0x1A190500)
#define CLIPPERLIB_CLIPPER_REVERSEPOLYPTLINKS_OFFSET UNITYSDK_OFFSET(0x1A18AA50)
#define CLIPPERLIB_CLIPPER_ROUND_OFFSET UNITYSDK_OFFSET(0x1A190000)
#define CLIPPERLIB_CLIPPER_SETHOLESTATE_OFFSET UNITYSDK_OFFSET(0x1A18D680)
#define CLIPPERLIB_CLIPPER_SETWINDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x1A18BDF0)
#define CLIPPERLIB_CLIPPER_SET_REVERSESOLUTION_OFFSET UNITYSDK_OFFSET(0x1A188290)
#define CLIPPERLIB_CLIPPER_SET_STRICTLYSIMPLE_OFFSET UNITYSDK_OFFSET(0x1A1882B0)
#define CLIPPERLIB_CLIPPER_SIMPLIFYPOLYGONS_OFFSET UNITYSDK_OFFSET(0x1A193870)
#define CLIPPERLIB_CLIPPER_SIMPLIFYPOLYGON_OFFSET UNITYSDK_OFFSET(0x1A192B20)
#define CLIPPERLIB_CLIPPER_SLOPESNEARCOLLINEAR_OFFSET UNITYSDK_OFFSET(0x1A193B50)
#define CLIPPERLIB_CLIPPER_SWAPPOINTS_OFFSET UNITYSDK_OFFSET(0x1A18D840)
#define CLIPPERLIB_CLIPPER_SWAPPOLYINDEXES_OFFSET UNITYSDK_OFFSET(0x1A18DEE0)
#define CLIPPERLIB_CLIPPER_SWAPPOSITIONSINSEL_OFFSET UNITYSDK_OFFSET(0x1A18D090)
#define CLIPPERLIB_CLIPPER_SWAPSIDES_OFFSET UNITYSDK_OFFSET(0x1A18DEB0)
#define CLIPPERLIB_CLIPPER_TOPX_OFFSET UNITYSDK_OFFSET(0x1A18CF60)
#define CLIPPERLIB_CLIPPER_TRANSLATEPATH_OFFSET UNITYSDK_OFFSET(0x1A195550)
#define CLIPPERLIB_CLIPPER_UPDATEOUTPTIDXS_OFFSET UNITYSDK_OFFSET(0x1A192AE0)
#define CLIPPERLIB_CLIPPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A187E70)

namespace ClipperLib
{
	inline static constexpr unsigned int Clipper_TypeDefinitionIndex = 30710;
	...
	public:
		...
		::ClipperLib::TEdge* m_SortedEdges; // 0x48
		::System::Collections::Generic::List_1<::ClipperLib::Join*>* m_Joins; // 0x50
		::System::Collections::Generic::List_1<::ClipperLib::IntersectNode*>* m_IntersectList; // 0x58
		::ClipperLib::Maxima* m_Maxima; // 0x60
		::System::Collections::Generic::List_1<::ClipperLib::Join*>* m_GhostJoins; // 0x68
		::System::Collections::Generic::IComparer_1<::ClipperLib::IntersectNode*>* m_IntersectNodeComparer; // 0x70
		::ClipperLib::PolyFillType m_ClipFillType; // 0x78
		::ClipperLib::ClipType m_ClipType; // 0x7C
		::ClipperLib::PolyFillType m_SubjFillType; // 0x80
		::System::Boolean _StrictlySimple_k__BackingField; // 0x84
		::System::Boolean m_ExecuteLocked; // 0x85
		::System::Boolean m_UsingPolyTree; // 0x86
		::System::Boolean _ReverseSolution_k__BackingField; // 0x87
