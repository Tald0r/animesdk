...
#define CLIPPERLIB_INTPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x915BC0)
#define CLIPPERLIB_INTPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x915C20)
#define CLIPPERLIB_INTPOINT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A18D780)
#define CLIPPERLIB_INTPOINT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A18DD10)
#define CLIPPERLIB_INTPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x915BA0)
#define CLIPPERLIB_INTPOINT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2EC7B0)
#define CLIPPERLIB_INTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x301710)

namespace ClipperLib
{
	inline static constexpr unsigned int IntPoint_TypeDefinitionIndex = 30691;
