...
#define CLIPPERLIB_INTPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x8E7BC0)
#define CLIPPERLIB_INTPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8E7C20)
#define CLIPPERLIB_INTPOINT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19BA9130)
#define CLIPPERLIB_INTPOINT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19BA96C0)
#define CLIPPERLIB_INTPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8E7BA0)
#define CLIPPERLIB_INTPOINT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2FB050)
#define CLIPPERLIB_INTPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x2D6E20)

namespace ClipperLib
{
	inline static constexpr unsigned int IntPoint_TypeDefinitionIndex = 29738;
