...
#define CLIPPERLIB_CLIPPEREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A188670)

namespace ClipperLib
{
	inline static constexpr unsigned int ClipperException_TypeDefinitionIndex = 30713;
