...
#define CLIPPERLIB_CLIPPEREXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19BA3EF0)

namespace ClipperLib
{
	inline static constexpr unsigned int ClipperException_TypeDefinitionIndex = 29760;
