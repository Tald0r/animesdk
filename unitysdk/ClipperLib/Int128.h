...
#define CLIPPERLIB_INT128_EQUALS_OFFSET UNITYSDK_OFFSET(0x915B20)
#define CLIPPERLIB_INT128_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x915B80)
#define CLIPPERLIB_INT128_INT128MUL_OFFSET UNITYSDK_OFFSET(0x1A196440)
#define CLIPPERLIB_INT128_ISNEGATIVE_OFFSET UNITYSDK_OFFSET(0x565170)
#define CLIPPERLIB_INT128_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A19AA40)
#define CLIPPERLIB_INT128_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A1964D0)
#define CLIPPERLIB_INT128_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1A19AAF0)
#define CLIPPERLIB_INT128_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1A19AA00)
#define CLIPPERLIB_INT128_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A19A8F0)
#define CLIPPERLIB_INT128_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1A19AA20)
#define CLIPPERLIB_INT128_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1A19AA80)
#define CLIPPERLIB_INT128_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1A19AAC0)
#define CLIPPERLIB_INT128__CTOR_1_OFFSET UNITYSDK_OFFSET(0x915B10)
#define CLIPPERLIB_INT128__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2EC7B0)
#define CLIPPERLIB_INT128__CTOR_OFFSET UNITYSDK_OFFSET(0x915B00)

namespace ClipperLib
{
	inline static constexpr unsigned int Int128_TypeDefinitionIndex = 30690;
