...
#define CLIPPERLIB_CLIPPEROFFSET_ADDPATHS_OFFSET UNITYSDK_OFFSET(0x1A197A30)
#define CLIPPERLIB_CLIPPEROFFSET_ADDPATH_OFFSET UNITYSDK_OFFSET(0x1A197580)
#define CLIPPERLIB_CLIPPEROFFSET_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A197500)
#define CLIPPERLIB_CLIPPEROFFSET_DOMITER_OFFSET UNITYSDK_OFFSET(0x1A19A740)
#define CLIPPERLIB_CLIPPEROFFSET_DOOFFSET_OFFSET UNITYSDK_OFFSET(0x1A197FF0)
#define CLIPPERLIB_CLIPPEROFFSET_DOROUND_OFFSET UNITYSDK_OFFSET(0x1A199B40)
#define CLIPPERLIB_CLIPPEROFFSET_DOSQUARE_OFFSET UNITYSDK_OFFSET(0x1A199860)
#define CLIPPERLIB_CLIPPEROFFSET_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x1A19A150)
#define CLIPPERLIB_CLIPPEROFFSET_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A199E40)
#define CLIPPERLIB_CLIPPEROFFSET_FIXORIENTATIONS_OFFSET UNITYSDK_OFFSET(0x1A197B40)
#define CLIPPERLIB_CLIPPEROFFSET_GETUNITNORMAL_OFFSET UNITYSDK_OFFSET(0x1A197F30)
#define CLIPPERLIB_CLIPPEROFFSET_GET_ARCTOLERANCE_OFFSET UNITYSDK_OFFSET(0x1A197360)
#define CLIPPERLIB_CLIPPEROFFSET_GET_MITERLIMIT_OFFSET UNITYSDK_OFFSET(0x1A197380)
#define CLIPPERLIB_CLIPPEROFFSET_OFFSETPOINT_OFFSET UNITYSDK_OFFSET(0x1A199430)
#define CLIPPERLIB_CLIPPEROFFSET_ROUND_OFFSET UNITYSDK_OFFSET(0x1A197560)
#define CLIPPERLIB_CLIPPEROFFSET_SET_ARCTOLERANCE_OFFSET UNITYSDK_OFFSET(0x1A197370)
#define CLIPPERLIB_CLIPPEROFFSET_SET_MITERLIMIT_OFFSET UNITYSDK_OFFSET(0x1A197390)
#define CLIPPERLIB_CLIPPEROFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1973A0)

namespace ClipperLib
{
	inline static constexpr unsigned int ClipperOffset_TypeDefinitionIndex = 30712;
	...
	public:
		...
		::System::Collections::Generic::List_1<::ClipperLib::IntPoint>* m_srcPoly; // 0x28
		::System::Collections::Generic::List_1<::ClipperLib::IntPoint>* m_destPoly; // 0x30
		::ClipperLib::IntPoint m_lowest; // 0x38
		::System::Double m_StepsPerRad; // 0x48
		::System::Double _ArcTolerance_k__BackingField; // 0x50
		::System::Double m_miterLim; // 0x58
		::System::Double m_sin; // 0x60
		::System::Double m_delta; // 0x68
		::System::Double m_cos; // 0x70
		::System::Double _MiterLimit_k__BackingField; // 0x78
		::System::Double m_sinA; // 0x80
