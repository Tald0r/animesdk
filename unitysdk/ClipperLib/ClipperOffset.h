...
#define CLIPPERLIB_CLIPPEROFFSET_ADDPATHS_OFFSET UNITYSDK_OFFSET(0x19BB3330)
#define CLIPPERLIB_CLIPPEROFFSET_ADDPATH_OFFSET UNITYSDK_OFFSET(0x19BB2E80)
#define CLIPPERLIB_CLIPPEROFFSET_CLEAR_OFFSET UNITYSDK_OFFSET(0x19BB2E00)
#define CLIPPERLIB_CLIPPEROFFSET_DOMITER_OFFSET UNITYSDK_OFFSET(0x19BB6030)
#define CLIPPERLIB_CLIPPEROFFSET_DOOFFSET_OFFSET UNITYSDK_OFFSET(0x19BB38F0)
#define CLIPPERLIB_CLIPPEROFFSET_DOROUND_OFFSET UNITYSDK_OFFSET(0x19BB5430)
#define CLIPPERLIB_CLIPPEROFFSET_DOSQUARE_OFFSET UNITYSDK_OFFSET(0x19BB5160)
#define CLIPPERLIB_CLIPPEROFFSET_EXECUTE_1_OFFSET UNITYSDK_OFFSET(0x19BB5A40)
#define CLIPPERLIB_CLIPPEROFFSET_EXECUTE_OFFSET UNITYSDK_OFFSET(0x19BB5730)
#define CLIPPERLIB_CLIPPEROFFSET_FIXORIENTATIONS_OFFSET UNITYSDK_OFFSET(0x19BB3440)
#define CLIPPERLIB_CLIPPEROFFSET_GETUNITNORMAL_OFFSET UNITYSDK_OFFSET(0x19BB3830)
#define CLIPPERLIB_CLIPPEROFFSET_GET_ARCTOLERANCE_OFFSET UNITYSDK_OFFSET(0x19BB2C60)
#define CLIPPERLIB_CLIPPEROFFSET_GET_MITERLIMIT_OFFSET UNITYSDK_OFFSET(0x19BB2C80)
#define CLIPPERLIB_CLIPPEROFFSET_OFFSETPOINT_OFFSET UNITYSDK_OFFSET(0x19BB4D30)
#define CLIPPERLIB_CLIPPEROFFSET_ROUND_OFFSET UNITYSDK_OFFSET(0x19BB2E60)
#define CLIPPERLIB_CLIPPEROFFSET_SET_ARCTOLERANCE_OFFSET UNITYSDK_OFFSET(0x19BB2C70)
#define CLIPPERLIB_CLIPPEROFFSET_SET_MITERLIMIT_OFFSET UNITYSDK_OFFSET(0x19BB2C90)
#define CLIPPERLIB_CLIPPEROFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x19BB2CA0)

namespace ClipperLib
{
	inline static constexpr unsigned int ClipperOffset_TypeDefinitionIndex = 29759;
	...
	public:
		...
		::System::Collections::Generic::List_1<::ClipperLib::IntPoint>* m_destPoly; // 0x18
		::System::Collections::Generic::List_1<::ClipperLib::IntPoint>* m_srcPoly; // 0x20
		::ClipperLib::PolyNode* m_polyNodes; // 0x28
		::System::Collections::Generic::List_1<::System::Collections::Generic::List_1<::ClipperLib::IntPoint>*>* m_destPolys; // 0x30
		::ClipperLib::IntPoint m_lowest; // 0x38
		::System::Double m_miterLim; // 0x48
		::System::Double m_delta; // 0x50
		::System::Double m_cos; // 0x58
		::System::Double _ArcTolerance_k__BackingField; // 0x60
		::System::Double m_sinA; // 0x68
		::System::Double _MiterLimit_k__BackingField; // 0x70
		::System::Double m_StepsPerRad; // 0x78
