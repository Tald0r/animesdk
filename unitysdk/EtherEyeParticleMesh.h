...
#define ETHEREYEPARTICLEMESH_DEALMESHTRANSMIT_OFFSET UNITYSDK_OFFSET(0x8FF1100)
#define ETHEREYEPARTICLEMESH_DEALSIZESETTINGSANDMESHTRANSMIT_OFFSET UNITYSDK_OFFSET(0x8FF0DB0)
#define ETHEREYEPARTICLEMESH_DOCOLLECTPROPERPARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0x8FEFBC0)
#define ETHEREYEPARTICLEMESH_FETCHCONFIG_OFFSET UNITYSDK_OFFSET(0x8FF0080)
#define ETHEREYEPARTICLEMESH_ONENTITYDISABLE_OFFSET UNITYSDK_OFFSET(0x8FF1210)
#define ETHEREYEPARTICLEMESH_UPDATEPARTICLEMESHSOURCE_OFFSET UNITYSDK_OFFSET(0x8FF0200)
#define ETHEREYEPARTICLEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x8FF1640)

inline static constexpr unsigned int EtherEyeParticleMesh_TypeDefinitionIndex = 74634;
