...
#define ETHEREYEPARTICLEMESH_DEALMESHTRANSMIT_OFFSET UNITYSDK_OFFSET(0xAA46960)
#define ETHEREYEPARTICLEMESH_DEALSIZESETTINGSANDMESHTRANSMIT_OFFSET UNITYSDK_OFFSET(0xAA46610)
#define ETHEREYEPARTICLEMESH_DOCOLLECTPROPERPARTICLESYSTEM_OFFSET UNITYSDK_OFFSET(0xAA45420)
#define ETHEREYEPARTICLEMESH_FETCHCONFIG_OFFSET UNITYSDK_OFFSET(0xAA458E0)
#define ETHEREYEPARTICLEMESH_ONENTITYDISABLE_OFFSET UNITYSDK_OFFSET(0xAA46A70)
#define ETHEREYEPARTICLEMESH_UPDATEPARTICLEMESHSOURCE_OFFSET UNITYSDK_OFFSET(0xAA45A60)
#define ETHEREYEPARTICLEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0xAA46EA0)

inline static constexpr unsigned int EtherEyeParticleMesh_TypeDefinitionIndex = 54242;
