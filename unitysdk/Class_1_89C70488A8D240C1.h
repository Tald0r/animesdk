...
#include "unitysdk/Class_1_89C70488A8D240C1_Enum_3_C780BFBFED223F30_2.h"
...
#define CLASS_1_89C70488A8D240C1_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7380030)
#define CLASS_1_89C70488A8D240C1_METHOD_1_08BC081A69C9E1AA_OFFSET UNITYSDK_OFFSET(0x737FF10)
#define CLASS_1_89C70488A8D240C1_METHOD_1_193443EF57621030_OFFSET UNITYSDK_OFFSET(0x7380100)
#define CLASS_1_89C70488A8D240C1_METHOD_1_1D4018D4200358D0_OFFSET UNITYSDK_OFFSET(0x7381E30)
#define CLASS_1_89C70488A8D240C1_METHOD_1_34E0F94BD1913283_OFFSET UNITYSDK_OFFSET(0x7381C80)
#define CLASS_1_89C70488A8D240C1_METHOD_1_41541A33EEEE8620_1_OFFSET UNITYSDK_OFFSET(0x7381B40)
#define CLASS_1_89C70488A8D240C1_METHOD_1_41541A33EEEE8620_2_OFFSET UNITYSDK_OFFSET(0x7381EB0)
#define CLASS_1_89C70488A8D240C1_METHOD_1_41541A33EEEE8620_3_OFFSET UNITYSDK_OFFSET(0x73825E0)
#define CLASS_1_89C70488A8D240C1_METHOD_1_41541A33EEEE8620_OFFSET UNITYSDK_OFFSET(0x7381A00)
#define CLASS_1_89C70488A8D240C1_METHOD_1_4300251440128830_OFFSET UNITYSDK_OFFSET(0x7380500)
#define CLASS_1_89C70488A8D240C1_METHOD_1_5323F2DF46A044DA_OFFSET UNITYSDK_OFFSET(0x73804F0)
#define CLASS_1_89C70488A8D240C1_METHOD_1_5967057CD668BF97_OFFSET UNITYSDK_OFFSET(0x7382310)
#define CLASS_1_89C70488A8D240C1_METHOD_1_6A7F69A381F965E9_1_OFFSET UNITYSDK_OFFSET(0x7381D50)
#define CLASS_1_89C70488A8D240C1_METHOD_1_6A7F69A381F965E9_2_OFFSET UNITYSDK_OFFSET(0x7382350)
#define CLASS_1_89C70488A8D240C1_METHOD_1_6A7F69A381F965E9_OFFSET UNITYSDK_OFFSET(0x73816B0)
#define CLASS_1_89C70488A8D240C1_METHOD_1_95CDD79345389B03_OFFSET UNITYSDK_OFFSET(0x7380410)
#define CLASS_1_89C70488A8D240C1_METHOD_1_97C1833A0D1E1653_OFFSET UNITYSDK_OFFSET(0x7382430)
#define CLASS_1_89C70488A8D240C1_METHOD_1_99B63E6D0FA503A0_OFFSET UNITYSDK_OFFSET(0x7381790)
#define CLASS_1_89C70488A8D240C1_METHOD_1_B13A873C7C334E65_OFFSET UNITYSDK_OFFSET(0x7380FB0)
#define CLASS_1_89C70488A8D240C1_METHOD_1_B9C4EFFA1AC5E536_OFFSET UNITYSDK_OFFSET(0x7380270)
#define CLASS_1_89C70488A8D240C1_METHOD_1_BAABF31354CA413C_OFFSET UNITYSDK_OFFSET(0x73827A0)
#define CLASS_1_89C70488A8D240C1_METHOD_1_BE6D496EC3EAF75B_OFFSET UNITYSDK_OFFSET(0x7380B40)
#define CLASS_1_89C70488A8D240C1_METHOD_1_C20F5FF37D4114B8_OFFSET UNITYSDK_OFFSET(0x7381130)
#define CLASS_1_89C70488A8D240C1_METHOD_1_C87D57F9A59D7DD3_OFFSET UNITYSDK_OFFSET(0x7381FF0)
#define CLASS_1_89C70488A8D240C1_METHOD_1_CEDE067F5AA920F4_1_OFFSET UNITYSDK_OFFSET(0x7382550)
#define CLASS_1_89C70488A8D240C1_METHOD_1_CEDE067F5AA920F4_OFFSET UNITYSDK_OFFSET(0x7380380)
#define CLASS_1_89C70488A8D240C1_METHOD_1_DDF4E6AEE2216B17_OFFSET UNITYSDK_OFFSET(0x7382720)
#define CLASS_1_89C70488A8D240C1_METHOD_1_E2A7ABF15BCFCFB9_OFFSET UNITYSDK_OFFSET(0x7381450)
#define CLASS_1_89C70488A8D240C1_METHOD_1_FE7B7FBDE6969B4A_OFFSET UNITYSDK_OFFSET(0x73809A0)
#define CLASS_1_89C70488A8D240C1_METHOD_1_FF7B2911BBACA4A9_1_OFFSET UNITYSDK_OFFSET(0x7382290)
#define CLASS_1_89C70488A8D240C1_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0x7380300)
#define CLASS_1_89C70488A8D240C1__CTOR_OFFSET UNITYSDK_OFFSET(0x737FC90)

inline static constexpr unsigned int Class_1_89C70488A8D240C1_TypeDefinitionIndex = 57850;

class Class_1_89C70488A8D240C1 : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Struct_2_5D55D2D92073E392_Class_3_9A1ADE0F4CE714BA_1*>* Field_1_7; // 0x10
	::MoleMole::Utils::TaskBasedEventCollection_1<::Class_1_89C70488A8D240C1_Enum_3_C780BFBFED223F30_2>* Field_1_0; // 0x18
	::Struct_2_5D55D2D92073E392 Field_1_1; // 0x20
	::MoleMole::Cameras::CameraTrackBlending* Field_1_3; // 0x150
	::MoleMole::Cameras::CameraTrackBlending* Field_1_4; // 0x158
	::PipelineCamera::CameraVariableSubModule_1<::PipelineCamera::WorldBasicCameraData>* Field_1_6; // 0x160
	::System::Func_3<::PipelineCamera::WorldBasicCameraData, ::PipelineCamera::WorldBasicCameraData, ::System::Boolean>* Field_1_8; // 0x168
	...
	{
		return ((::PipelineCamera::ICameraDataBlender*(*)(::PVOID, ::PipelineCamera::ICameraDataBlender*))((::PBYTE)hIl2Cpp + CLASS_1_89C70488A8D240C1_METHOD_1_CEDE067F5AA920F4_OFFSET))(this, a1);
	}
	...
	::System::Void Method_1_E2A7ABF15BCFCFB9(::MoleMole::Cameras::PhotoCameraConfig*& a1, ::System::UInt32 a2, ::PipelineCamera::WorldBasicCameraData a3)
	{
		return ((::System::Void(*)(::PVOID, ::MoleMole::Cameras::PhotoCameraConfig*&, ::System::UInt32, ::PipelineCamera::WorldBasicCameraData))((::PBYTE)hIl2Cpp + CLASS_1_89C70488A8D240C1_METHOD_1_E2A7ABF15BCFCFB9_OFFSET))(this, a1, a2, a3);
	}
	...
	{
		return ((::PipelineCamera::Blender::DefaultBlender*(*)(::System::Boolean, ::System::Single, ::UnityEngine::AnimationCurve*))((::PBYTE)hIl2Cpp + CLASS_1_89C70488A8D240C1_METHOD_1_95CDD79345389B03_OFFSET))(a1, a2, a3);
	}
	...
	::Cysharp::Threading::Tasks::UniTask Method_1_34E0F94BD1913283(::Class_1_89C70488A8D240C1_Enum_3_C780BFBFED223F30_2 a1)
	{
		return ((::Cysharp::Threading::Tasks::UniTask(*)(::PVOID, ::Class_1_89C70488A8D240C1_Enum_3_C780BFBFED223F30_2))((::PBYTE)hIl2Cpp + CLASS_1_89C70488A8D240C1_METHOD_1_34E0F94BD1913283_OFFSET))(this, a1);
	}
	...
	{
		return ((::PipelineCamera::ScopedDelegateHandle(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_89C70488A8D240C1_METHOD_1_C87D57F9A59D7DD3_OFFSET))(this);
	}
	...
	::PipelineCamera::ICameraSubModuleBuilder_1<::PipelineCamera::WorldBasicCameraData>* Method_1_C20F5FF37D4114B8()
	{
		return ((::PipelineCamera::ICameraSubModuleBuilder_1<::PipelineCamera::WorldBasicCameraData>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_89C70488A8D240C1_METHOD_1_C20F5FF37D4114B8_OFFSET))(this);
	}
	...
	{
		return ((::System::Void(*)(::PVOID, ::PipelineCamera::ICameraSubModule_1<::PipelineCamera::WorldBasicCameraData>*))((::PBYTE)hIl2Cpp + CLASS_1_89C70488A8D240C1_METHOD_1_97C1833A0D1E1653_OFFSET))(this, a1);
	}

	::PipelineCamera::ICameraDataBlender* Method_1_CEDE067F5AA920F4_1(::PipelineCamera::ICameraDataBlender* a1)
	{
		return ((::PipelineCamera::ICameraDataBlender*(*)(::PVOID, ::PipelineCamera::ICameraDataBlender*))((::PBYTE)hIl2Cpp + CLASS_1_89C70488A8D240C1_METHOD_1_CEDE067F5AA920F4_1_OFFSET))(this, a1);
	}
	...
	::PipelineCamera::ICameraSubModule_1<::PipelineCamera::WorldBasicCameraData>* Method_1_BAABF31354CA413C()
	{
		return ((::PipelineCamera::ICameraSubModule_1<::PipelineCamera::WorldBasicCameraData>*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_89C70488A8D240C1_METHOD_1_BAABF31354CA413C_OFFSET))(this);
	}
};
