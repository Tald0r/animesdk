...
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19A15320)
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19A15360)
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19A14D50)
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A15310)

namespace ParadoxNotion
{
	inline static constexpr unsigned int TypeConverter_CustomConverter_TypeDefinitionIndex = 25775;
