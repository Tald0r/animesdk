...
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A005300)
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A005340)
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A004D20)
#define PARADOXNOTION_TYPECONVERTER_CUSTOMCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0052E0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int TypeConverter_CustomConverter_TypeDefinitionIndex = 27039;
