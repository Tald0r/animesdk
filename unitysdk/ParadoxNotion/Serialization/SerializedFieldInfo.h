...
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_ASMEMBERINFO_OFFSET UNITYSDK_OFFSET(0x1A22D670)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_ASSTRING_OFFSET UNITYSDK_OFFSET(0x1A22D680)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_GET_TBASEINFO_OFFSET UNITYSDK_OFFSET(0x1A22D3C0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A22D6E0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_SET_TBASEINFO_OFFSET UNITYSDK_OFFSET(0x1A22D3D0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A22D6B0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A22D4F0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A22D3E0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A22D660)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A22D650)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int SerializedFieldInfo_TypeDefinitionIndex = 26488;
