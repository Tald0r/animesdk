...
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_ASMEMBERINFO_OFFSET UNITYSDK_OFFSET(0x19C8BE60)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_ASSTRING_OFFSET UNITYSDK_OFFSET(0x19C8BE70)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_GET_TBASEINFO_OFFSET UNITYSDK_OFFSET(0x19C8BBB0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19C8BED0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_SET_TBASEINFO_OFFSET UNITYSDK_OFFSET(0x19C8BBC0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C8BEA0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19C8BCE0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19C8BBD0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C8BE50)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDFIELDINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8BE40)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int SerializedFieldInfo_TypeDefinitionIndex = 25541;
