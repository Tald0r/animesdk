...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_RESOLVEDEXCEPTION_GET_RAWEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A185E00)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_RESOLVEDEXCEPTION_SET_RAWEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A185E10)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_RESOLVEDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A185E20)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int ResolvedException_TypeDefinitionIndex = 26656;
