...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_RESOLVEDEXCEPTION_GET_RAWEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A72E4C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_RESOLVEDEXCEPTION_SET_RAWEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A72E4D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_RESOLVEDEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A72E4E0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int ResolvedException_TypeDefinitionIndex = 26967;
