...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1A492DF0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A4935A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A492E40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A4932F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A493100)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A492DD0)

namespace ParadoxNotion::Serialization::FullSerializer::Internal
{
	inline static constexpr unsigned int fsForwardConverter_TypeDefinitionIndex = 26969;
