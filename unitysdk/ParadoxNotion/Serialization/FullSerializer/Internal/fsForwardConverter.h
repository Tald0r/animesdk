...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x19EA56A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19EA5E60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x19EA56F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19EA5BB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x19EA59B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSFORWARDCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA5680)

namespace ParadoxNotion::Serialization::FullSerializer::Internal
{
	inline static constexpr unsigned int fsForwardConverter_TypeDefinitionIndex = 25269;
