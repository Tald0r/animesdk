...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1A1D4F30)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A1D4F80)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER_REQUESTCYCLESUPPORT_OFFSET UNITYSDK_OFFSET(0x1A1D4F60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER_REQUESTINHERITANCESUPPORT_OFFSET UNITYSDK_OFFSET(0x1A1D4F70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A1D5630)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A1D4FC0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSENUMCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D5CE0)

namespace ParadoxNotion::Serialization::FullSerializer::Internal
{
	inline static constexpr unsigned int fsEnumConverter_TypeDefinitionIndex = 25951;
