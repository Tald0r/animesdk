...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSPRIMITIVECONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1A1849C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSPRIMITIVECONVERTER_REQUESTCYCLESUPPORT_OFFSET UNITYSDK_OFFSET(0x1A184A50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSPRIMITIVECONVERTER_REQUESTINHERITANCESUPPORT_OFFSET UNITYSDK_OFFSET(0x1A184A60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSPRIMITIVECONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A1853C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSPRIMITIVECONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A184D10)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSPRIMITIVECONVERTER_USEBOOL_OFFSET UNITYSDK_OFFSET(0x1A184A70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSPRIMITIVECONVERTER_USEDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A184C10)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSPRIMITIVECONVERTER_USEINT64_OFFSET UNITYSDK_OFFSET(0x1A184AB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSPRIMITIVECONVERTER_USESTRING_OFFSET UNITYSDK_OFFSET(0x1A184CA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSPRIMITIVECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A185DF0)

namespace ParadoxNotion::Serialization::FullSerializer::Internal
{
	inline static constexpr unsigned int fsPrimitiveConverter_TypeDefinitionIndex = 25283;
