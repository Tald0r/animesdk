...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSDICTIONARYCONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x18400C40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSDICTIONARYCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x18400CB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSDICTIONARYCONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x184019D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSDICTIONARYCONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x18400D40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_FSDICTIONARYCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18403370)

namespace ParadoxNotion::Serialization::FullSerializer::Internal
{
	inline static constexpr unsigned int fsDictionaryConverter_TypeDefinitionIndex = 25984;
