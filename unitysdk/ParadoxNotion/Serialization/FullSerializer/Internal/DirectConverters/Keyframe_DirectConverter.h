...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_KEYFRAME_DIRECTCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19C8B5A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_KEYFRAME_DIRECTCONVERTER_DODESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19C8B0D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_KEYFRAME_DIRECTCONVERTER_DOSERIALIZE_OFFSET UNITYSDK_OFFSET(0x19C8AC90)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_KEYFRAME_DIRECTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8B5D0)

namespace ParadoxNotion::Serialization::FullSerializer::Internal::DirectConverters
{
	inline static constexpr unsigned int Keyframe_DirectConverter_TypeDefinitionIndex = 26408;
