...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_VECTOR2_DIRECTCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19A0DA60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_VECTOR2_DIRECTCONVERTER_DODESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A0D980)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_VECTOR2_DIRECTCONVERTER_DOSERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A0D8D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_VECTOR2_DIRECTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0DA90)

namespace ParadoxNotion::Serialization::FullSerializer::Internal::DirectConverters
{
	inline static constexpr unsigned int Vector2_DirectConverter_TypeDefinitionIndex = 25536;
