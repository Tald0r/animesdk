...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_VECTOR2INT_DIRECTCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19763ED0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_VECTOR2INT_DIRECTCONVERTER_DODESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19763E00)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_VECTOR2INT_DIRECTCONVERTER_DOSERIALIZE_OFFSET UNITYSDK_OFFSET(0x19763D50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_VECTOR2INT_DIRECTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19763F00)

namespace ParadoxNotion::Serialization::FullSerializer::Internal::DirectConverters
{
	inline static constexpr unsigned int Vector2Int_DirectConverter_TypeDefinitionIndex = 26073;
