...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_LAYERMASK_DIRECTCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19FFD860)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_LAYERMASK_DIRECTCONVERTER_DODESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FFD710)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_LAYERMASK_DIRECTCONVERTER_DOSERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FFD5E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_INTERNAL_DIRECTCONVERTERS_LAYERMASK_DIRECTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFD890)

namespace ParadoxNotion::Serialization::FullSerializer::Internal::DirectConverters
{
	inline static constexpr unsigned int LayerMask_DirectConverter_TypeDefinitionIndex = 27543;
