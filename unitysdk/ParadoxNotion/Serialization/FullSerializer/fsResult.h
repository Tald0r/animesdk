...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_ADDMESSAGES_OFFSET UNITYSDK_OFFSET(0x9147F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_ADDMESSAGE_OFFSET UNITYSDK_OFFSET(0x914770)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_ASSERTSUCCESSWITHOUTWARNINGS_OFFSET UNITYSDK_OFFSET(0x9149E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_ASSERTSUCCESS_OFFSET UNITYSDK_OFFSET(0x9149A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_FAIL_OFFSET UNITYSDK_OFFSET(0x1A126B70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_GET_ASEXCEPTION_OFFSET UNITYSDK_OFFSET(0x914A80)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_GET_FAILED_OFFSET UNITYSDK_OFFSET(0x3602B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_GET_FORMATTEDMESSAGES_OFFSET UNITYSDK_OFFSET(0x914AD0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_GET_HASWARNINGS_OFFSET UNITYSDK_OFFSET(0x914950)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_GET_RAWMESSAGES_OFFSET UNITYSDK_OFFSET(0x914A90)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_GET_SUCCEEDED_OFFSET UNITYSDK_OFFSET(0x306AA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_MERGE_OFFSET UNITYSDK_OFFSET(0x9148A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A126E00)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x914AD0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT_WARN_OFFSET UNITYSDK_OFFSET(0x1A126AF0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSRESULT__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1273B0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsResult_TypeDefinitionIndex = 27296;

	struct alignas(8) fsResult
	{
		static ::Il2CppArray<::System::String*>** StaticGet_EmptyStringArray()
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(fsResult_TypeDefinitionIndex)->GetStaticField(0x1EF50);
		}
		static ::ParadoxNotion::Serialization::FullSerializer::fsResult* StaticGet_Success()
		{
			return (::ParadoxNotion::Serialization::FullSerializer::fsResult*)Il2CppClass::FromTypeDefinitionIndex(fsResult_TypeDefinitionIndex)->GetStaticField(0x1EF58);
		}
