...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_CHECKKEY_1_OFFSET UNITYSDK_OFFSET(0x184035C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_CHECKKEY_OFFSET UNITYSDK_OFFSET(0x18402D50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_CHECKTYPE_OFFSET UNITYSDK_OFFSET(0x18402870)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x18403380)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_FAILEXPECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x18402DC0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_REQUESTCYCLESUPPORT_OFFSET UNITYSDK_OFFSET(0x184034C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_REQUESTINHERITANCESUPPORT_OFFSET UNITYSDK_OFFSET(0x18403590)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18403A20)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsBaseConverter_TypeDefinitionIndex = 26202;
