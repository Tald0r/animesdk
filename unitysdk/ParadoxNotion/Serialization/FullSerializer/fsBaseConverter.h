...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_CHECKKEY_1_OFFSET UNITYSDK_OFFSET(0x191956D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_CHECKKEY_OFFSET UNITYSDK_OFFSET(0x19194E60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_CHECKTYPE_OFFSET UNITYSDK_OFFSET(0x19194980)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x19195490)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_FAILEXPECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x19194ED0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_REQUESTCYCLESUPPORT_OFFSET UNITYSDK_OFFSET(0x191955D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER_REQUESTINHERITANCESUPPORT_OFFSET UNITYSDK_OFFSET(0x191956A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSBASECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19195B30)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsBaseConverter_TypeDefinitionIndex = 27379;
