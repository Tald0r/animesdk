...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSDIRECTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A08E320)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsDirectConverter_TypeDefinitionIndex = 26110;
