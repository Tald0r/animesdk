...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_OBJECTREFERENCEEQUALITYCOMPARATOR_SYSTEM_COLLECTIONS_GENERIC_IEQUALITYCOMPARER_SYSTEM_OBJECT__EQUALS_OFFSET UNITYSDK_OFFSET(0x19EA6840)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_OBJECTREFERENCEEQUALITYCOMPARATOR_SYSTEM_COLLECTIONS_GENERIC_IEQUALITYCOMPARER_SYSTEM_OBJECT__GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19EA6850)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_OBJECTREFERENCEEQUALITYCOMPARATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EA6870)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_OBJECTREFERENCEEQUALITYCOMPARATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA6860)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsCyclicReferenceManager_ObjectReferenceEqualityComparator_TypeDefinitionIndex = 25640;
	...
	public:
		...
		{
			return (::System::Collections::Generic::IEqualityComparer_1<::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(fsCyclicReferenceManager_ObjectReferenceEqualityComparator_TypeDefinitionIndex)->GetStaticField(0x1F1D0);
		}
