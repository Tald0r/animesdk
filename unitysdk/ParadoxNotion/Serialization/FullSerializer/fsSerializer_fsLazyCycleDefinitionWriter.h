...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_FSLAZYCYCLEDEFINITIONWRITER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A3AE7B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_FSLAZYCYCLEDEFINITIONWRITER_WRITEDEFINITION_OFFSET UNITYSDK_OFFSET(0x1A3AE430)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_FSLAZYCYCLEDEFINITIONWRITER_WRITEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A3AE570)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_FSLAZYCYCLEDEFINITIONWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AE880)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsSerializer_fsLazyCycleDefinitionWriter_TypeDefinitionIndex = 27223;
