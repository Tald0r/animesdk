...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_FSLAZYCYCLEDEFINITIONWRITER_CLEAR_OFFSET UNITYSDK_OFFSET(0x19DBD550)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_FSLAZYCYCLEDEFINITIONWRITER_WRITEDEFINITION_OFFSET UNITYSDK_OFFSET(0x19DBD1D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_FSLAZYCYCLEDEFINITIONWRITER_WRITEREFERENCE_OFFSET UNITYSDK_OFFSET(0x19DBD310)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_FSLAZYCYCLEDEFINITIONWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBD620)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsSerializer_fsLazyCycleDefinitionWriter_TypeDefinitionIndex = 25274;
