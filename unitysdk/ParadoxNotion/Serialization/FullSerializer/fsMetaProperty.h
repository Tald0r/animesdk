...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_ASREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A1D5E90)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_AUTOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A1D5E70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_FIELD_OFFSET UNITYSDK_OFFSET(0x1A1D5D90)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x1A1D5DB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_MEMBERNAME_OFFSET UNITYSDK_OFFSET(0x1A1D5E00)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_READONLY_OFFSET UNITYSDK_OFFSET(0x1A1D5E30)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_STORAGETYPE_OFFSET UNITYSDK_OFFSET(0x1A1D5DD0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_GET_WRITEONLY_OFFSET UNITYSDK_OFFSET(0x1A1D5E50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_READ_OFFSET UNITYSDK_OFFSET(0x1A1D6060)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_ASREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A1D5EA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_AUTOINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A1D5E80)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_FIELD_OFFSET UNITYSDK_OFFSET(0x1A1D5DA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_JSONNAME_OFFSET UNITYSDK_OFFSET(0x1A1D5DC0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_READONLY_OFFSET UNITYSDK_OFFSET(0x1A1D5E40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_SET_WRITEONLY_OFFSET UNITYSDK_OFFSET(0x1A1D5E60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY_WRITE_OFFSET UNITYSDK_OFFSET(0x1A1D6090)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETAPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1D5EB0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsMetaProperty_TypeDefinitionIndex = 26652;
	...
	public:
		...
		::System::Boolean _AutoInstance_k__BackingField; // 0x20
		::System::Boolean _AsReference_k__BackingField; // 0x21
