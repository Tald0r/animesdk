...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZEASATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A127410)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZEASATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A127400)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsSerializeAsAttribute_TypeDefinitionIndex = 26379;
