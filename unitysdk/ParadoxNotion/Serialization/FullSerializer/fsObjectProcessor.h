...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1A60FF20)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A60FFB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONAFTERSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A60FF80)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONBEFOREDESERIALIZEAFTERINSTANCECREATION_OFFSET UNITYSDK_OFFSET(0x1A60FFA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONBEFOREDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A60FF90)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A60FF70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSOBJECTPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A60FFC0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsObjectProcessor_TypeDefinitionIndex = 26855;
