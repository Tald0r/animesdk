...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_BUILDCOMPRESSEDSTRING_OFFSET UNITYSDK_OFFSET(0x1955EB70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_BUILDPRETTYSTRING_OFFSET UNITYSDK_OFFSET(0x1955F130)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_COMPRESSEDJSON_1_OFFSET UNITYSDK_OFFSET(0x1955F8F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_COMPRESSEDJSON_OFFSET UNITYSDK_OFFSET(0x1955FA70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_CONVERTDOUBLETOSTRING_OFFSET UNITYSDK_OFFSET(0x1955F040)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_ESCAPESTRING_OFFSET UNITYSDK_OFFSET(0x1955E7C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_INSERTSPACING_OFFSET UNITYSDK_OFFSET(0x1955E770)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_PRETTYJSON_1_OFFSET UNITYSDK_OFFSET(0x1955F780)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_PRETTYJSON_OFFSET UNITYSDK_OFFSET(0x1955FA60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_TOJSON_OFFSET UNITYSDK_OFFSET(0x1955F770)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsJsonPrinter_TypeDefinitionIndex = 26196;
