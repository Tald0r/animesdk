...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_BUILDCOMPRESSEDSTRING_OFFSET UNITYSDK_OFFSET(0x1916CAB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_BUILDPRETTYSTRING_OFFSET UNITYSDK_OFFSET(0x1916D070)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_COMPRESSEDJSON_1_OFFSET UNITYSDK_OFFSET(0x1916D830)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_COMPRESSEDJSON_OFFSET UNITYSDK_OFFSET(0x1916D9B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_CONVERTDOUBLETOSTRING_OFFSET UNITYSDK_OFFSET(0x1916CF80)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_ESCAPESTRING_OFFSET UNITYSDK_OFFSET(0x1916C700)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_INSERTSPACING_OFFSET UNITYSDK_OFFSET(0x1916C6B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_PRETTYJSON_1_OFFSET UNITYSDK_OFFSET(0x1916D6C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_PRETTYJSON_OFFSET UNITYSDK_OFFSET(0x1916D9A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSJSONPRINTER_TOJSON_OFFSET UNITYSDK_OFFSET(0x1916D6B0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsJsonPrinter_TypeDefinitionIndex = 25650;
