...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_OBJECTGENERATOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C320C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_OBJECTGENERATOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C320F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_OBJECTGENERATOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C31E20)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_OBJECTGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x19C31E00)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsMetaType_ObjectGenerator_TypeDefinitionIndex = 26073;
