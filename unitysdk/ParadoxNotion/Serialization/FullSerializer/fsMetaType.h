...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_CANSERIALIZEFIELD_OFFSET UNITYSDK_OFFSET(0x1A56F4C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_COLLECTPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A56F0A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A56EA50)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_FLUSHMEM_OFFSET UNITYSDK_OFFSET(0x1A56EBD0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GETDEFAULTINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A56F960)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GETGENERATOR_OFFSET UNITYSDK_OFFSET(0x1A56ED40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GET_DESERIALIZEOVERWRITEREQUEST_OFFSET UNITYSDK_OFFSET(0x1A56ED20)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GET_OFFSET UNITYSDK_OFFSET(0x1A56E8C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A56ED00)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_GET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A56ECE0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_HASDEFAULTCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1A56F8D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_SET_DESERIALIZEOVERWRITEREQUEST_OFFSET UNITYSDK_OFFSET(0x1A56ED30)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_SET_PROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A56ED10)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE_SET_REFLECTEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A56ECF0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A56FB20)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSMETATYPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A56EAC0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsMetaType_TypeDefinitionIndex = 26071;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::ParadoxNotion::Serialization::FullSerializer::fsMetaType*>**)Il2CppClass::FromTypeDefinitionIndex(fsMetaType_TypeDefinitionIndex)->GetStaticField(0x20380);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Object*>** StaticGet__defaultInstances()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Object*>**)Il2CppClass::FromTypeDefinitionIndex(fsMetaType_TypeDefinitionIndex)->GetStaticField(0x20388);
		}
