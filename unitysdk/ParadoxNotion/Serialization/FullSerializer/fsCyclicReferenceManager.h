...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_ADDREFERENCEWITHID_OFFSET UNITYSDK_OFFSET(0x19EA6320)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x19EA6010)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_ENTER_OFFSET UNITYSDK_OFFSET(0x19EA6100)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_EXIT_OFFSET UNITYSDK_OFFSET(0x19EA6110)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_GETREFERENCEID_OFFSET UNITYSDK_OFFSET(0x19EA6390)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_GETREFERENCEOBJECT_OFFSET UNITYSDK_OFFSET(0x19EA6240)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_ISREFERENCE_OFFSET UNITYSDK_OFFSET(0x19EA6480)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_MARKSERIALIZED_OFFSET UNITYSDK_OFFSET(0x19EA6610)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19EA5EF0)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsCyclicReferenceManager_TypeDefinitionIndex = 25639;
