...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_ADDREFERENCEWITHID_OFFSET UNITYSDK_OFFSET(0x1A493A60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A493750)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_ENTER_OFFSET UNITYSDK_OFFSET(0x1A493840)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_EXIT_OFFSET UNITYSDK_OFFSET(0x1A493850)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_GETREFERENCEID_OFFSET UNITYSDK_OFFSET(0x1A493AD0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_GETREFERENCEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A493980)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_ISREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A493BC0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER_MARKSERIALIZED_OFFSET UNITYSDK_OFFSET(0x1A493D40)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSCYCLICREFERENCEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A493630)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsCyclicReferenceManager_TypeDefinitionIndex = 27701;
