...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ADDCONVERTER_OFFSET UNITYSDK_OFFSET(0x19A10080)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ADD_ONAFTEROBJECTSERIALIZED_OFFSET UNITYSDK_OFFSET(0x19A0F990)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ADD_ONBEFOREOBJECTSERIALIZED_OFFSET UNITYSDK_OFFSET(0x19A0F8D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ENSUREDICTIONARY_OFFSET UNITYSDK_OFFSET(0x19A0EF30)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x19A106B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_GETPROCESSORS_OFFSET UNITYSDK_OFFSET(0x19A10310)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_GET_IGNORESERIALIZECYCLEREFERENCES_OFFSET UNITYSDK_OFFSET(0x19A0F8B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_GET_REFERENCESDATABASE_OFFSET UNITYSDK_OFFSET(0x19A0F890)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INTERNAL_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A11AF0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INTERNAL_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A10EE0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A0F6E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONAFTERSERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A0F540)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONBEFOREDESERIALIZEAFTERINSTANCECREATION_OFFSET UNITYSDK_OFFSET(0x19A0F650)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONBEFOREDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A0F5D0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A0F3A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISOBJECTDEFINITION_OFFSET UNITYSDK_OFFSET(0x19A0F0E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISOBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x19A0F030)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISRESERVEDKEYWORD_OFFSET UNITYSDK_OFFSET(0x19A0EC80)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISTYPESPECIFIED_OFFSET UNITYSDK_OFFSET(0x19A0F240)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISVERSIONED_OFFSET UNITYSDK_OFFSET(0x19A0F190)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISWRAPPEDDATA_OFFSET UNITYSDK_OFFSET(0x19A0F2F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_PURGETEMPORARYDATA_OFFSET UNITYSDK_OFFSET(0x19A10290)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_REMOVEMETADATA_OFFSET UNITYSDK_OFFSET(0x19A0ED80)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_REMOVE_ONAFTEROBJECTSERIALIZED_OFFSET UNITYSDK_OFFSET(0x19A0F9F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_REMOVE_ONBEFOREOBJECTSERIALIZED_OFFSET UNITYSDK_OFFSET(0x19A0F930)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_SET_IGNORESERIALIZECYCLEREFERENCES_OFFSET UNITYSDK_OFFSET(0x19A0F8C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_SET_REFERENCESDATABASE_OFFSET UNITYSDK_OFFSET(0x19A0F8A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYDESERIALIZEMIGRATION_OFFSET UNITYSDK_OFFSET(0x19A12A00)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYDESERIALIZEVERSIONING_OFFSET UNITYSDK_OFFSET(0x19A127F0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYDESERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x19A117B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A0EA90)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYPOP_OFFSET UNITYSDK_OFFSET(0x19A11700)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYPUSH_OFFSET UNITYSDK_OFFSET(0x19A11520)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYSERIALIZEVERSIONING_OFFSET UNITYSDK_OFFSET(0x19A11370)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYSERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x19A10B60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A0E180)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0FA50)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsSerializer_TypeDefinitionIndex = 25272;
	...
	public:
		...
		::System::Collections::Generic::List_1<::UnityEngine::Object*>* _ReferencesDatabase_k__BackingField; // 0x18
		::System::Collections::Generic::List_1<::ParadoxNotion::Serialization::FullSerializer::fsObjectProcessor*>* _processors; // 0x20
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::ParadoxNotion::Serialization::FullSerializer::fsBaseConverter*>* _cachedConverters; // 0x28
		::System::Action_2<::System::Object*, ::ParadoxNotion::Serialization::FullSerializer::fsData*>* onAfterObjectSerialized; // 0x30
		...
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Collections::Generic::List_1<::ParadoxNotion::Serialization::FullSerializer::fsObjectProcessor*>*>* _cachedProcessors; // 0x50
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::ParadoxNotion::Serialization::FullSerializer::fsBaseConverter*>* _cachedOverrideConverterInstances; // 0x58
		::ParadoxNotion::Serialization::FullSerializer::fsSerializer_fsLazyCycleDefinitionWriter* _lazyReferenceWriter; // 0x60
