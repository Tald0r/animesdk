...
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ADDCONVERTER_OFFSET UNITYSDK_OFFSET(0x1A000050)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ADD_ONAFTEROBJECTSERIALIZED_OFFSET UNITYSDK_OFFSET(0x19FFF960)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ADD_ONBEFOREOBJECTSERIALIZED_OFFSET UNITYSDK_OFFSET(0x19FFF8A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ENSUREDICTIONARY_OFFSET UNITYSDK_OFFSET(0x19FFEF10)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_GETCONVERTER_OFFSET UNITYSDK_OFFSET(0x1A000680)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_GETPROCESSORS_OFFSET UNITYSDK_OFFSET(0x1A0002E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_GET_IGNORESERIALIZECYCLEREFERENCES_OFFSET UNITYSDK_OFFSET(0x19FFF880)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_GET_REFERENCESDATABASE_OFFSET UNITYSDK_OFFSET(0x19FFF860)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INTERNAL_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A001AB0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INTERNAL_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A000EA0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FFF6B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONAFTERSERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FFF510)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONBEFOREDESERIALIZEAFTERINSTANCECREATION_OFFSET UNITYSDK_OFFSET(0x19FFF620)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONBEFOREDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FFF5A0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_INVOKE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FFF370)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISOBJECTDEFINITION_OFFSET UNITYSDK_OFFSET(0x19FFF0B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISOBJECTREFERENCE_OFFSET UNITYSDK_OFFSET(0x19FFF000)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISRESERVEDKEYWORD_OFFSET UNITYSDK_OFFSET(0x19FFEC60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISTYPESPECIFIED_OFFSET UNITYSDK_OFFSET(0x19FFF210)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISVERSIONED_OFFSET UNITYSDK_OFFSET(0x19FFF160)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_ISWRAPPEDDATA_OFFSET UNITYSDK_OFFSET(0x19FFF2C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_PURGETEMPORARYDATA_OFFSET UNITYSDK_OFFSET(0x1A000260)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_REMOVEMETADATA_OFFSET UNITYSDK_OFFSET(0x19FFED60)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_REMOVE_ONAFTEROBJECTSERIALIZED_OFFSET UNITYSDK_OFFSET(0x19FFF9C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_REMOVE_ONBEFOREOBJECTSERIALIZED_OFFSET UNITYSDK_OFFSET(0x19FFF900)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_SET_IGNORESERIALIZECYCLEREFERENCES_OFFSET UNITYSDK_OFFSET(0x19FFF890)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_SET_REFERENCESDATABASE_OFFSET UNITYSDK_OFFSET(0x19FFF870)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYDESERIALIZEMIGRATION_OFFSET UNITYSDK_OFFSET(0x1A0029C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYDESERIALIZEVERSIONING_OFFSET UNITYSDK_OFFSET(0x1A0027B0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYDESERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1A001770)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FFEA70)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYPOP_OFFSET UNITYSDK_OFFSET(0x1A0016C0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYPUSH_OFFSET UNITYSDK_OFFSET(0x1A0014E0)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYSERIALIZEVERSIONING_OFFSET UNITYSDK_OFFSET(0x1A001330)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYSERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1A000B20)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FFE160)
#define PARADOXNOTION_SERIALIZATION_FULLSERIALIZER_FSSERIALIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFFA20)

namespace ParadoxNotion::Serialization::FullSerializer
{
	inline static constexpr unsigned int fsSerializer_TypeDefinitionIndex = 27221;
	...
	public:
		...
		::System::Collections::Generic::List_1<::ParadoxNotion::Serialization::FullSerializer::fsObjectProcessor*>* _processors; // 0x10
		::ParadoxNotion::Serialization::FullSerializer::fsSerializer_fsLazyCycleDefinitionWriter* _lazyReferenceWriter; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::System::Collections::Generic::List_1<::ParadoxNotion::Serialization::FullSerializer::fsObjectProcessor*>*>* _cachedProcessors; // 0x20
		::System::Collections::Generic::List_1<::UnityEngine::Object*>* _ReferencesDatabase_k__BackingField; // 0x28
		::System::Action_1<::System::Object*>* onBeforeObjectSerialized; // 0x30
		...
		::System::Action_2<::System::Object*, ::ParadoxNotion::Serialization::FullSerializer::fsData*>* onAfterObjectSerialized; // 0x40
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::ParadoxNotion::Serialization::FullSerializer::fsDirectConverter*>* _availableDirectConverters; // 0x48
		::System::Collections::Generic::Dictionary_2<::System::Type*, ::ParadoxNotion::Serialization::FullSerializer::fsBaseConverter*>* _cachedConverters; // 0x50
		::ParadoxNotion::Serialization::FullSerializer::fsCyclicReferenceManager* _references; // 0x58
		::System::Collections::Generic::List_1<::ParadoxNotion::Serialization::FullSerializer::fsConverter*>* _availableConverters; // 0x60
