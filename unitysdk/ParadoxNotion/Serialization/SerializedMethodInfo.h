...
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_ASMEMBERINFO_OFFSET UNITYSDK_OFFSET(0x19C32D50)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_ASSTRING_OFFSET UNITYSDK_OFFSET(0x19C19590)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_GETMETHODBASE_OFFSET UNITYSDK_OFFSET(0x19C32D60)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_GET_TBASEINFO_OFFSET UNITYSDK_OFFSET(0x19C32100)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_GET_T_GENERICARGUMENTSINFO_OFFSET UNITYSDK_OFFSET(0x19C32140)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_GET_T_PARAMSINFO_OFFSET UNITYSDK_OFFSET(0x19C32120)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_HASCHANGED_OFFSET UNITYSDK_OFFSET(0x19C32D70)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19C19020)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_SET_TBASEINFO_OFFSET UNITYSDK_OFFSET(0x19C32110)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_SET_T_GENERICARGUMENTSINFO_OFFSET UNITYSDK_OFFSET(0x19C32150)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_SET_T_PARAMSINFO_OFFSET UNITYSDK_OFFSET(0x19C32130)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19C32D80)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19C32530)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19C32160)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19C198C0)
#define PARADOXNOTION_SERIALIZATION_SERIALIZEDMETHODINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19C32D40)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int SerializedMethodInfo_TypeDefinitionIndex = 27352;
