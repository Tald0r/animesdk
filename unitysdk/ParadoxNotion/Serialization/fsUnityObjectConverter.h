...
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER_CANPROCESS_OFFSET UNITYSDK_OFFSET(0x1A185EB0)
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER_CREATEINSTANCE_OFFSET UNITYSDK_OFFSET(0x1A186300)
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER_REQUESTCYCLESUPPORT_OFFSET UNITYSDK_OFFSET(0x1A185F40)
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER_REQUESTINHERITANCESUPPORT_OFFSET UNITYSDK_OFFSET(0x1A185F50)
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER_TRYDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A1860E0)
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER_TRYSERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A185F60)
#define PARADOXNOTION_SERIALIZATION_FSUNITYOBJECTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A186310)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int fsUnityObjectConverter_TypeDefinitionIndex = 26363;
