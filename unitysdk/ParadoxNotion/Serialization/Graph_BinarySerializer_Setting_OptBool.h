...
#define PARADOXNOTION_SERIALIZATION_GRAPH_BINARYSERIALIZER_SETTING_OPTBOOL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19DBD7F0)
#define PARADOXNOTION_SERIALIZATION_GRAPH_BINARYSERIALIZER_SETTING_OPTBOOL_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19DBD7D0)
#define PARADOXNOTION_SERIALIZATION_GRAPH_BINARYSERIALIZER_SETTING_OPTBOOL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19DBD800)
#define PARADOXNOTION_SERIALIZATION_GRAPH_BINARYSERIALIZER_SETTING_OPTBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBD750)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int Graph_BinarySerializer_Setting_OptBool_TypeDefinitionIndex = 25347;
