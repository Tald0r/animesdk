...
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_CLONE_OFFSET UNITYSDK_OFFSET(0x1927ABF0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_COPYSERIALIZED_OFFSET UNITYSDK_OFFSET(0x1927ACD0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1927A630)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_FLUSHMEM_OFFSET UNITYSDK_OFFSET(0x1927A4C0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_INTERNAL_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1927A670)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_PRETTIFYJSON_OFFSET UNITYSDK_OFFSET(0x1927AF80)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_SERIALIZEANDEXECUTENOCYCLES_1_OFFSET UNITYSDK_OFFSET(0x1926CEC0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_SERIALIZEANDEXECUTENOCYCLES_OFFSET UNITYSDK_OFFSET(0x1926D400)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x192687E0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_SHOWDATA_OFFSET UNITYSDK_OFFSET(0x1927ADD0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_TRYDESERIALIZEOVERWRITE_OFFSET UNITYSDK_OFFSET(0x1927AB90)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1927A420)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER___FLUSHDATACACHE_OFFSET UNITYSDK_OFFSET(0x1927A590)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int JSONSerializer_TypeDefinitionIndex = 25739;
	...
	public:
		...
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(JSONSerializer_TypeDefinitionIndex)->GetStaticField(0x1E8F0);
		}
		static ::ParadoxNotion::Serialization::FullSerializer::fsSerializer** StaticGet_serializer()
		{
			return (::ParadoxNotion::Serialization::FullSerializer::fsSerializer**)Il2CppClass::FromTypeDefinitionIndex(JSONSerializer_TypeDefinitionIndex)->GetStaticField(0x1E8F8);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::ParadoxNotion::Serialization::FullSerializer::fsData*>**)Il2CppClass::FromTypeDefinitionIndex(JSONSerializer_TypeDefinitionIndex)->GetStaticField(0x1E900);
		}
