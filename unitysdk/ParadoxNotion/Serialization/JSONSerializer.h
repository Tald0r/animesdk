...
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_CLONE_OFFSET UNITYSDK_OFFSET(0x196F71D0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_COPYSERIALIZED_OFFSET UNITYSDK_OFFSET(0x196F72B0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x196F6C10)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_FLUSHMEM_OFFSET UNITYSDK_OFFSET(0x196F6AA0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_INTERNAL_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x196F6C50)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_PRETTIFYJSON_OFFSET UNITYSDK_OFFSET(0x196F7560)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_SERIALIZEANDEXECUTENOCYCLES_1_OFFSET UNITYSDK_OFFSET(0x196E9490)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_SERIALIZEANDEXECUTENOCYCLES_OFFSET UNITYSDK_OFFSET(0x196E99D0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x196E4DA0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_SHOWDATA_OFFSET UNITYSDK_OFFSET(0x196F73B0)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER_TRYDESERIALIZEOVERWRITE_OFFSET UNITYSDK_OFFSET(0x196F7170)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x196F6A00)
#define PARADOXNOTION_SERIALIZATION_JSONSERIALIZER___FLUSHDATACACHE_OFFSET UNITYSDK_OFFSET(0x196F6B70)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int JSONSerializer_TypeDefinitionIndex = 27538;
	...
	public:
		...
		{
			return (::ParadoxNotion::Serialization::FullSerializer::fsSerializer**)Il2CppClass::FromTypeDefinitionIndex(JSONSerializer_TypeDefinitionIndex)->GetStaticField(0x1F3F0);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::ParadoxNotion::Serialization::FullSerializer::fsData*>**)Il2CppClass::FromTypeDefinitionIndex(JSONSerializer_TypeDefinitionIndex)->GetStaticField(0x1F3F8);
		}
		static ::System::Object** StaticGet_serializerLock()
		{
			return (::System::Object**)Il2CppClass::FromTypeDefinitionIndex(JSONSerializer_TypeDefinitionIndex)->GetStaticField(0x1F400);
		}
