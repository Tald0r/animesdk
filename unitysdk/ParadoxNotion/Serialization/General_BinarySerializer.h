...
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_ATTACHEXTRAFORMATTER_OFFSET UNITYSDK_OFFSET(0x1A494770)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_ATTACHEXTRARESOLVER_OFFSET UNITYSDK_OFFSET(0x1A494890)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_ENLARGEBUFF_OFFSET UNITYSDK_OFFSET(0x1A4949B0)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_INIT_OFFSET UNITYSDK_OFFSET(0x1A493FE0)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_MARKUNINIT_OFFSET UNITYSDK_OFFSET(0x1A4943D0)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER_RESET_OFFSET UNITYSDK_OFFSET(0x1A4946A0)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A493FD0)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER__GETDEFAULTFORMATTERS_OFFSET UNITYSDK_OFFSET(0x1A494620)
#define PARADOXNOTION_SERIALIZATION_GENERAL_BINARYSERIALIZER__GETDEFAULTRESOLVERS_OFFSET UNITYSDK_OFFSET(0x1A494430)

namespace ParadoxNotion::Serialization
{
	inline static constexpr unsigned int General_BinarySerializer_TypeDefinitionIndex = 26261;
	...
	public:
		...
		{
			return (::MessagePack::MessagePackSerializerOptions**)Il2CppClass::FromTypeDefinitionIndex(General_BinarySerializer_TypeDefinitionIndex)->GetStaticField(0x1FDD0);
		}
		static ::MessagePack::IFormatterResolver** StaticGet__sharedDeserializeResolver()
		{
			return (::MessagePack::IFormatterResolver**)Il2CppClass::FromTypeDefinitionIndex(General_BinarySerializer_TypeDefinitionIndex)->GetStaticField(0x1FDD8);
		}
		static ::MessagePack::GraphMemoryStreamBufferWriter** StaticGet__generalBufferWriter()
		{
			return (::MessagePack::GraphMemoryStreamBufferWriter**)Il2CppClass::FromTypeDefinitionIndex(General_BinarySerializer_TypeDefinitionIndex)->GetStaticField(0x1FDE0);
		}
		static ::MessagePack::MessagePackSerializerOptions** StaticGet__sharedSerializeOption()
		{
			return (::MessagePack::MessagePackSerializerOptions**)Il2CppClass::FromTypeDefinitionIndex(General_BinarySerializer_TypeDefinitionIndex)->GetStaticField(0x1FDE8);
		}
		static ::MessagePack::IFormatterResolver** StaticGet__sharedSerializeResolver()
		{
			return (::MessagePack::IFormatterResolver**)Il2CppClass::FromTypeDefinitionIndex(General_BinarySerializer_TypeDefinitionIndex)->GetStaticField(0x1FDF0);
		}
		static ::System::Boolean* StaticGet__isInit()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(General_BinarySerializer_TypeDefinitionIndex)->GetStaticField(0x4A00);
		}
