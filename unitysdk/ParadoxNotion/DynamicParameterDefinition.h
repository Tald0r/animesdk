...
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_GET_ID_OFFSET UNITYSDK_OFFSET(0x199FCE70)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x19A0D560)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19A0D580)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_SET_ID_OFFSET UNITYSDK_OFFSET(0x19A0D550)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_SET_NAME_OFFSET UNITYSDK_OFFSET(0x19A0D570)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x19A0D590)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A0D4E0)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19A0D4B0)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19A0D5B0)
#define PARADOXNOTION_DYNAMICPARAMETERDEFINITION__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0D5A0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int DynamicParameterDefinition_TypeDefinitionIndex = 26654;
