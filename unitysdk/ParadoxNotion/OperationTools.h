...
#define PARADOXNOTION_OPERATIONTOOLS_COMPARE_1_OFFSET UNITYSDK_OFFSET(0x19191FB0)
#define PARADOXNOTION_OPERATIONTOOLS_COMPARE_OFFSET UNITYSDK_OFFSET(0x19190F00)
#define PARADOXNOTION_OPERATIONTOOLS_GETCOMPARESTRING_OFFSET UNITYSDK_OFFSET(0x19190840)
#define PARADOXNOTION_OPERATIONTOOLS_GETOPERATIONSTRING_OFFSET UNITYSDK_OFFSET(0x19190110)
#define PARADOXNOTION_OPERATIONTOOLS_OPERATE_1_OFFSET UNITYSDK_OFFSET(0x19190230)
#define PARADOXNOTION_OPERATIONTOOLS_OPERATE_2_OFFSET UNITYSDK_OFFSET(0x19192C50)
#define PARADOXNOTION_OPERATIONTOOLS_OPERATE_OFFSET UNITYSDK_OFFSET(0x19192BF0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int OperationTools_TypeDefinitionIndex = 27154;
