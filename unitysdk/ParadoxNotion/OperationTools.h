...
#define PARADOXNOTION_OPERATIONTOOLS_COMPARE_1_OFFSET UNITYSDK_OFFSET(0x183F5330)
#define PARADOXNOTION_OPERATIONTOOLS_COMPARE_OFFSET UNITYSDK_OFFSET(0x183F4240)
#define PARADOXNOTION_OPERATIONTOOLS_GETCOMPARESTRING_OFFSET UNITYSDK_OFFSET(0x183F3B80)
#define PARADOXNOTION_OPERATIONTOOLS_GETOPERATIONSTRING_OFFSET UNITYSDK_OFFSET(0x183F3450)
#define PARADOXNOTION_OPERATIONTOOLS_OPERATE_1_OFFSET UNITYSDK_OFFSET(0x183F3570)
#define PARADOXNOTION_OPERATIONTOOLS_OPERATE_2_OFFSET UNITYSDK_OFFSET(0x18400B40)
#define PARADOXNOTION_OPERATIONTOOLS_OPERATE_OFFSET UNITYSDK_OFFSET(0x18400AE0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int OperationTools_TypeDefinitionIndex = 26738;
