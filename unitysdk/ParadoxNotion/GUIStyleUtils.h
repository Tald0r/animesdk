...
#define PARADOXNOTION_GUISTYLEUTILS_BORDER_OFFSET UNITYSDK_OFFSET(0x19E0E3A0)
#define PARADOXNOTION_GUISTYLEUTILS_MARGIN_OFFSET UNITYSDK_OFFSET(0x19E0E260)
#define PARADOXNOTION_GUISTYLEUTILS_OVERFLOW_OFFSET UNITYSDK_OFFSET(0x19E0E430)
#define PARADOXNOTION_GUISTYLEUTILS_PADDING_OFFSET UNITYSDK_OFFSET(0x19E0E300)
#define PARADOXNOTION_GUISTYLEUTILS_RICHTEXT_OFFSET UNITYSDK_OFFSET(0x19E0E500)
#define PARADOXNOTION_GUISTYLEUTILS_TEXTALIGNMENT_OFFSET UNITYSDK_OFFSET(0x19E0E4D0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int GUIStyleUtils_TypeDefinitionIndex = 26154;
