...
#define PARADOXNOTION_OBJECTUTILS_ANYEQUALS_OFFSET UNITYSDK_OFFSET(0x1A22BF90)
#define PARADOXNOTION_OBJECTUTILS_FINDGAMEOBJECTSWITHINLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1A22C390)
#define PARADOXNOTION_OBJECTUTILS_ISINLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1A22C460)
#define PARADOXNOTION_OBJECTUTILS_TRANSFORMTOTYPE_OFFSET UNITYSDK_OFFSET(0x1A22C180)

namespace ParadoxNotion
{
	inline static constexpr unsigned int ObjectUtils_TypeDefinitionIndex = 26919;
