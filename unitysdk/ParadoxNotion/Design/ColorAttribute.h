...
#define PARADOXNOTION_DESIGN_COLORATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x196F4DB0)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int ColorAttribute_TypeDefinitionIndex = 26312;
