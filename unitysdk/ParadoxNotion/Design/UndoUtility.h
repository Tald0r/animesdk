...
#define PARADOXNOTION_DESIGN_UNDOUTILITY_CHECKDIRTY_OFFSET UNITYSDK_OFFSET(0x18400AB0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_CHECKUNDO_OFFSET UNITYSDK_OFFSET(0x18400A30)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_GETLASTOPERATIONNAMEOR_OFFSET UNITYSDK_OFFSET(0x184009D0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_GET_LASTOPERATIONNAME_OFFSET UNITYSDK_OFFSET(0x184008E0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECTCOMPLETE_1_OFFSET UNITYSDK_OFFSET(0x184009B0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x18400970)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECT_1_OFFSET UNITYSDK_OFFSET(0x18400990)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECT_OFFSET UNITYSDK_OFFSET(0x18400960)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x18400980)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_SET_LASTOPERATIONNAME_OFFSET UNITYSDK_OFFSET(0x18400920)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int UndoUtility_TypeDefinitionIndex = 26054;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UndoUtility_TypeDefinitionIndex)->GetStaticField(0x1EE80);
		}
