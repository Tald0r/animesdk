...
#define PARADOXNOTION_DESIGN_UNDOUTILITY_CHECKDIRTY_OFFSET UNITYSDK_OFFSET(0x19192BC0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_CHECKUNDO_OFFSET UNITYSDK_OFFSET(0x19192B40)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_GETLASTOPERATIONNAMEOR_OFFSET UNITYSDK_OFFSET(0x19192AE0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_GET_LASTOPERATIONNAME_OFFSET UNITYSDK_OFFSET(0x191929F0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECTCOMPLETE_1_OFFSET UNITYSDK_OFFSET(0x19192AC0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECTCOMPLETE_OFFSET UNITYSDK_OFFSET(0x19192A80)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECT_1_OFFSET UNITYSDK_OFFSET(0x19192AA0)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_RECORDOBJECT_OFFSET UNITYSDK_OFFSET(0x19192A70)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_SETDIRTY_OFFSET UNITYSDK_OFFSET(0x19192A90)
#define PARADOXNOTION_DESIGN_UNDOUTILITY_SET_LASTOPERATIONNAME_OFFSET UNITYSDK_OFFSET(0x19192A30)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int UndoUtility_TypeDefinitionIndex = 27667;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(UndoUtility_TypeDefinitionIndex)->GetStaticField(0x1FE90);
		}
