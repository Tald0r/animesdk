...
#define PARADOXNOTION_DESIGN_DIMIFDEFAULTATTRIBUTE_GET_ISDECORATOR_OFFSET UNITYSDK_OFFSET(0x19763AC0)
#define PARADOXNOTION_DESIGN_DIMIFDEFAULTATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x19763AD0)
#define PARADOXNOTION_DESIGN_DIMIFDEFAULTATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19763AE0)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int DimIfDefaultAttribute_TypeDefinitionIndex = 26687;
