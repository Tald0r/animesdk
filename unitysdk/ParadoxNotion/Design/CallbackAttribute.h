...
#define PARADOXNOTION_DESIGN_CALLBACKATTRIBUTE_GET_ISDECORATOR_OFFSET UNITYSDK_OFFSET(0x1A3FCA90)
#define PARADOXNOTION_DESIGN_CALLBACKATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x1A3FCAA0)
#define PARADOXNOTION_DESIGN_CALLBACKATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3FCAB0)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int CallbackAttribute_TypeDefinitionIndex = 26864;
