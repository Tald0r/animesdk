...
#define PARADOXNOTION_DESIGN_NAMEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1916C100)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int NameAttribute_TypeDefinitionIndex = 25246;
