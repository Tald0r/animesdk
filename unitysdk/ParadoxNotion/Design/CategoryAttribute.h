...
#define PARADOXNOTION_DESIGN_CATEGORYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFD400)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int CategoryAttribute_TypeDefinitionIndex = 27347;
