...
#define PARADOXNOTION_DESIGN_SHOWIFATTRIBUTE_GET_ISDECORATOR_OFFSET UNITYSDK_OFFSET(0x19FFD460)
#define PARADOXNOTION_DESIGN_SHOWIFATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x19FFD470)
#define PARADOXNOTION_DESIGN_SHOWIFATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19FFD480)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int ShowIfAttribute_TypeDefinitionIndex = 26767;
