...
#define PARADOXNOTION_DESIGN_REQUIREDFIELDATTRIBUTE_GET_ISDECORATOR_OFFSET UNITYSDK_OFFSET(0x19A0D450)
#define PARADOXNOTION_DESIGN_REQUIREDFIELDATTRIBUTE_GET_PRIORITY_OFFSET UNITYSDK_OFFSET(0x19A0D460)
#define PARADOXNOTION_DESIGN_REQUIREDFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19A0D470)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int RequiredFieldAttribute_TypeDefinitionIndex = 26428;
