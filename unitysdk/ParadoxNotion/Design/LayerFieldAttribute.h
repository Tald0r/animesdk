...
#define PARADOXNOTION_DESIGN_LAYERFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x184008D0)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int LayerFieldAttribute_TypeDefinitionIndex = 25344;
