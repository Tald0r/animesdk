...
#define PARADOXNOTION_DESIGN_TEXTAREAFIELDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C8A790)

namespace ParadoxNotion::Design
{
	inline static constexpr unsigned int TextAreaFieldAttribute_TypeDefinitionIndex = 25376;
