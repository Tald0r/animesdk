...
#define PARADOXNOTION_EVENTDATA_GET_RECEIVER_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define PARADOXNOTION_EVENTDATA_GET_SENDER_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define PARADOXNOTION_EVENTDATA_GET_VALUEBOXED_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define PARADOXNOTION_EVENTDATA_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define PARADOXNOTION_EVENTDATA_SET_RECEIVER_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define PARADOXNOTION_EVENTDATA_SET_SENDER_OFFSET UNITYSDK_OFFSET(0x2CB170)
#define PARADOXNOTION_EVENTDATA_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x2D26A0)
#define PARADOXNOTION_EVENTDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x901C50)
#define PARADOXNOTION_EVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x901C40)

namespace ParadoxNotion
{
	inline static constexpr unsigned int EventData_TypeDefinitionIndex = 26386;
