...
#define PARADOXNOTION_EVENTDATA_GET_RECEIVER_OFFSET UNITYSDK_OFFSET(0x223870)
#define PARADOXNOTION_EVENTDATA_GET_SENDER_OFFSET UNITYSDK_OFFSET(0x272280)
#define PARADOXNOTION_EVENTDATA_GET_VALUEBOXED_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define PARADOXNOTION_EVENTDATA_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define PARADOXNOTION_EVENTDATA_SET_RECEIVER_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define PARADOXNOTION_EVENTDATA_SET_SENDER_OFFSET UNITYSDK_OFFSET(0x302310)
#define PARADOXNOTION_EVENTDATA_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x3123A0)
#define PARADOXNOTION_EVENTDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x92D5E0)
#define PARADOXNOTION_EVENTDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x92D5D0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int EventData_TypeDefinitionIndex = 27435;
