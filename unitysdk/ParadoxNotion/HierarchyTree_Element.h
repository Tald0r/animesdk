...
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_ADDCHILD_OFFSET UNITYSDK_OFFSET(0x19C31A00)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_FINDREFERENCEELEMENT_OFFSET UNITYSDK_OFFSET(0x19C31B20)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_GETROOT_OFFSET UNITYSDK_OFFSET(0x19C31B10)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x19C319E0)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x19C319D0)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_GET_REFERENCE_OFFSET UNITYSDK_OFFSET(0x19C319C0)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_REMOVECHILD_OFFSET UNITYSDK_OFFSET(0x19C31AB0)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19C319F0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int HierarchyTree_Element_TypeDefinitionIndex = 27587;

	class HierarchyTree_Element : public ::System::Object
	{
	public:
		::ParadoxNotion::HierarchyTree_Element* _parent; // 0x10
