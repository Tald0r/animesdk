...
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_ADDCHILD_OFFSET UNITYSDK_OFFSET(0x19763B70)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_FINDREFERENCEELEMENT_OFFSET UNITYSDK_OFFSET(0x19763C90)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_GETROOT_OFFSET UNITYSDK_OFFSET(0x19763C80)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x19763B50)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_GET_PARENT_OFFSET UNITYSDK_OFFSET(0x19763B40)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_GET_REFERENCE_OFFSET UNITYSDK_OFFSET(0x19763B30)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT_REMOVECHILD_OFFSET UNITYSDK_OFFSET(0x19763C20)
#define PARADOXNOTION_HIERARCHYTREE_ELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19763B60)

namespace ParadoxNotion
{
	inline static constexpr unsigned int HierarchyTree_Element_TypeDefinitionIndex = 26175;
