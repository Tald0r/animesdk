...
#define PARADOXNOTION_CURVEUTILS_GETPOSALONGCURVE_OFFSET UNITYSDK_OFFSET(0x1916B710)
#define PARADOXNOTION_CURVEUTILS_ISPOSALONGCURVE_1_OFFSET UNITYSDK_OFFSET(0x1916B890)
#define PARADOXNOTION_CURVEUTILS_ISPOSALONGCURVE_OFFSET UNITYSDK_OFFSET(0x1916B860)
#define PARADOXNOTION_CURVEUTILS_RESOLVETANGENTS_1_OFFSET UNITYSDK_OFFSET(0x1916BEB0)
#define PARADOXNOTION_CURVEUTILS_RESOLVETANGENTS_OFFSET UNITYSDK_OFFSET(0x1916BC70)

namespace ParadoxNotion
{
	inline static constexpr unsigned int CurveUtils_TypeDefinitionIndex = 26299;
