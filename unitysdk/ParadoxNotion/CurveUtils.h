...
#define PARADOXNOTION_CURVEUTILS_GETPOSALONGCURVE_OFFSET UNITYSDK_OFFSET(0x1955D7D0)
#define PARADOXNOTION_CURVEUTILS_ISPOSALONGCURVE_1_OFFSET UNITYSDK_OFFSET(0x1955D950)
#define PARADOXNOTION_CURVEUTILS_ISPOSALONGCURVE_OFFSET UNITYSDK_OFFSET(0x1955D920)
#define PARADOXNOTION_CURVEUTILS_RESOLVETANGENTS_1_OFFSET UNITYSDK_OFFSET(0x1955DF70)
#define PARADOXNOTION_CURVEUTILS_RESOLVETANGENTS_OFFSET UNITYSDK_OFFSET(0x1955DD30)

namespace ParadoxNotion
{
	inline static constexpr unsigned int CurveUtils_TypeDefinitionIndex = 26008;
