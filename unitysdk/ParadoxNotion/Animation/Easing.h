...
#define PARADOXNOTION_ANIMATION_EASING_BACKINOUT_OFFSET UNITYSDK_OFFSET(0x196F39A0)
#define PARADOXNOTION_ANIMATION_EASING_BACKIN_OFFSET UNITYSDK_OFFSET(0x196F37A0)
#define PARADOXNOTION_ANIMATION_EASING_BACKOUT_OFFSET UNITYSDK_OFFSET(0x196F3890)
#define PARADOXNOTION_ANIMATION_EASING_BOUNCEINOUT_OFFSET UNITYSDK_OFFSET(0x196F3540)
#define PARADOXNOTION_ANIMATION_EASING_BOUNCEIN_OFFSET UNITYSDK_OFFSET(0x196F31D0)
#define PARADOXNOTION_ANIMATION_EASING_BOUNCEOUT_OFFSET UNITYSDK_OFFSET(0x196F33E0)
#define PARADOXNOTION_ANIMATION_EASING_CIRCULARINOUT_OFFSET UNITYSDK_OFFSET(0x196F2BC0)
#define PARADOXNOTION_ANIMATION_EASING_CIRCULARIN_OFFSET UNITYSDK_OFFSET(0x196F29B0)
#define PARADOXNOTION_ANIMATION_EASING_CIRCULAROUT_OFFSET UNITYSDK_OFFSET(0x196F2AC0)
#define PARADOXNOTION_ANIMATION_EASING_CUBICINOUT_OFFSET UNITYSDK_OFFSET(0x196F21B0)
#define PARADOXNOTION_ANIMATION_EASING_CUBICIN_OFFSET UNITYSDK_OFFSET(0x196F1FD0)
#define PARADOXNOTION_ANIMATION_EASING_CUBICOUT_OFFSET UNITYSDK_OFFSET(0x196F20B0)
#define PARADOXNOTION_ANIMATION_EASING_DIFFERENCE_OFFSET UNITYSDK_OFFSET(0x196F1660)
#define PARADOXNOTION_ANIMATION_EASING_EASE_1_OFFSET UNITYSDK_OFFSET(0x196F1280)
#define PARADOXNOTION_ANIMATION_EASING_EASE_2_OFFSET UNITYSDK_OFFSET(0x196F13F0)
#define PARADOXNOTION_ANIMATION_EASING_EASE_3_OFFSET UNITYSDK_OFFSET(0x196F1540)
#define PARADOXNOTION_ANIMATION_EASING_EASE_OFFSET UNITYSDK_OFFSET(0x196F0340)
#define PARADOXNOTION_ANIMATION_EASING_ELASTICINOUT_OFFSET UNITYSDK_OFFSET(0x196F3000)
#define PARADOXNOTION_ANIMATION_EASING_ELASTICIN_OFFSET UNITYSDK_OFFSET(0x196F2D00)
#define PARADOXNOTION_ANIMATION_EASING_ELASTICOUT_OFFSET UNITYSDK_OFFSET(0x196F2E80)
#define PARADOXNOTION_ANIMATION_EASING_EXPONENTIALINOUT_OFFSET UNITYSDK_OFFSET(0x196F2830)
#define PARADOXNOTION_ANIMATION_EASING_EXPONENTIALIN_OFFSET UNITYSDK_OFFSET(0x196F25D0)
#define PARADOXNOTION_ANIMATION_EASING_EXPONENTIALOUT_OFFSET UNITYSDK_OFFSET(0x196F26F0)
#define PARADOXNOTION_ANIMATION_EASING_FUNCTION_OFFSET UNITYSDK_OFFSET(0x196F0410)
#define PARADOXNOTION_ANIMATION_EASING_LINEAR_OFFSET UNITYSDK_OFFSET(0x196F1690)
#define PARADOXNOTION_ANIMATION_EASING_QUADRATICINOUT_OFFSET UNITYSDK_OFFSET(0x196F1870)
#define PARADOXNOTION_ANIMATION_EASING_QUADRATICIN_OFFSET UNITYSDK_OFFSET(0x196F16C0)
#define PARADOXNOTION_ANIMATION_EASING_QUADRATICOUT_OFFSET UNITYSDK_OFFSET(0x196F1790)
#define PARADOXNOTION_ANIMATION_EASING_QUARTICINOUT_OFFSET UNITYSDK_OFFSET(0x196F1B80)
#define PARADOXNOTION_ANIMATION_EASING_QUARTICIN_OFFSET UNITYSDK_OFFSET(0x196F19A0)
#define PARADOXNOTION_ANIMATION_EASING_QUARTICOUT_OFFSET UNITYSDK_OFFSET(0x196F1A80)
#define PARADOXNOTION_ANIMATION_EASING_QUINTICINOUT_OFFSET UNITYSDK_OFFSET(0x196F1E90)
#define PARADOXNOTION_ANIMATION_EASING_QUINTICIN_OFFSET UNITYSDK_OFFSET(0x196F1CB0)
#define PARADOXNOTION_ANIMATION_EASING_QUINTICOUT_OFFSET UNITYSDK_OFFSET(0x196F1D90)
#define PARADOXNOTION_ANIMATION_EASING_SINUSOIDALINOUT_OFFSET UNITYSDK_OFFSET(0x196F24D0)
#define PARADOXNOTION_ANIMATION_EASING_SINUSOIDALIN_OFFSET UNITYSDK_OFFSET(0x196F22E0)
#define PARADOXNOTION_ANIMATION_EASING_SINUSOIDALOUT_OFFSET UNITYSDK_OFFSET(0x196F23E0)
#define PARADOXNOTION_ANIMATION_EASING__CCTOR_OFFSET UNITYSDK_OFFSET(0x196F3AF0)

namespace ParadoxNotion::Animation
{
	inline static constexpr unsigned int Easing_TypeDefinitionIndex = 26606;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Func_4<::System::Single, ::System::Single, ::System::Single, ::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(Easing_TypeDefinitionIndex)->GetStaticField(0x1F320);
		}
