...
#define PARADOXNOTION_ANIMATION_EASING_BACKINOUT_OFFSET UNITYSDK_OFFSET(0x192773C0)
#define PARADOXNOTION_ANIMATION_EASING_BACKIN_OFFSET UNITYSDK_OFFSET(0x192771C0)
#define PARADOXNOTION_ANIMATION_EASING_BACKOUT_OFFSET UNITYSDK_OFFSET(0x192772B0)
#define PARADOXNOTION_ANIMATION_EASING_BOUNCEINOUT_OFFSET UNITYSDK_OFFSET(0x19276F60)
#define PARADOXNOTION_ANIMATION_EASING_BOUNCEIN_OFFSET UNITYSDK_OFFSET(0x19276BF0)
#define PARADOXNOTION_ANIMATION_EASING_BOUNCEOUT_OFFSET UNITYSDK_OFFSET(0x19276E00)
#define PARADOXNOTION_ANIMATION_EASING_CIRCULARINOUT_OFFSET UNITYSDK_OFFSET(0x192765E0)
#define PARADOXNOTION_ANIMATION_EASING_CIRCULARIN_OFFSET UNITYSDK_OFFSET(0x192763D0)
#define PARADOXNOTION_ANIMATION_EASING_CIRCULAROUT_OFFSET UNITYSDK_OFFSET(0x192764E0)
#define PARADOXNOTION_ANIMATION_EASING_CUBICINOUT_OFFSET UNITYSDK_OFFSET(0x19275BD0)
#define PARADOXNOTION_ANIMATION_EASING_CUBICIN_OFFSET UNITYSDK_OFFSET(0x192759F0)
#define PARADOXNOTION_ANIMATION_EASING_CUBICOUT_OFFSET UNITYSDK_OFFSET(0x19275AD0)
#define PARADOXNOTION_ANIMATION_EASING_DIFFERENCE_OFFSET UNITYSDK_OFFSET(0x19275080)
#define PARADOXNOTION_ANIMATION_EASING_EASE_1_OFFSET UNITYSDK_OFFSET(0x19274CA0)
#define PARADOXNOTION_ANIMATION_EASING_EASE_2_OFFSET UNITYSDK_OFFSET(0x19274E10)
#define PARADOXNOTION_ANIMATION_EASING_EASE_3_OFFSET UNITYSDK_OFFSET(0x19274F60)
#define PARADOXNOTION_ANIMATION_EASING_EASE_OFFSET UNITYSDK_OFFSET(0x19273D60)
#define PARADOXNOTION_ANIMATION_EASING_ELASTICINOUT_OFFSET UNITYSDK_OFFSET(0x19276A20)
#define PARADOXNOTION_ANIMATION_EASING_ELASTICIN_OFFSET UNITYSDK_OFFSET(0x19276720)
#define PARADOXNOTION_ANIMATION_EASING_ELASTICOUT_OFFSET UNITYSDK_OFFSET(0x192768A0)
#define PARADOXNOTION_ANIMATION_EASING_EXPONENTIALINOUT_OFFSET UNITYSDK_OFFSET(0x19276250)
#define PARADOXNOTION_ANIMATION_EASING_EXPONENTIALIN_OFFSET UNITYSDK_OFFSET(0x19275FF0)
#define PARADOXNOTION_ANIMATION_EASING_EXPONENTIALOUT_OFFSET UNITYSDK_OFFSET(0x19276110)
#define PARADOXNOTION_ANIMATION_EASING_FUNCTION_OFFSET UNITYSDK_OFFSET(0x19273E30)
#define PARADOXNOTION_ANIMATION_EASING_LINEAR_OFFSET UNITYSDK_OFFSET(0x192750B0)
#define PARADOXNOTION_ANIMATION_EASING_QUADRATICINOUT_OFFSET UNITYSDK_OFFSET(0x19275290)
#define PARADOXNOTION_ANIMATION_EASING_QUADRATICIN_OFFSET UNITYSDK_OFFSET(0x192750E0)
#define PARADOXNOTION_ANIMATION_EASING_QUADRATICOUT_OFFSET UNITYSDK_OFFSET(0x192751B0)
#define PARADOXNOTION_ANIMATION_EASING_QUARTICINOUT_OFFSET UNITYSDK_OFFSET(0x192755A0)
#define PARADOXNOTION_ANIMATION_EASING_QUARTICIN_OFFSET UNITYSDK_OFFSET(0x192753C0)
#define PARADOXNOTION_ANIMATION_EASING_QUARTICOUT_OFFSET UNITYSDK_OFFSET(0x192754A0)
#define PARADOXNOTION_ANIMATION_EASING_QUINTICINOUT_OFFSET UNITYSDK_OFFSET(0x192758B0)
#define PARADOXNOTION_ANIMATION_EASING_QUINTICIN_OFFSET UNITYSDK_OFFSET(0x192756D0)
#define PARADOXNOTION_ANIMATION_EASING_QUINTICOUT_OFFSET UNITYSDK_OFFSET(0x192757B0)
#define PARADOXNOTION_ANIMATION_EASING_SINUSOIDALINOUT_OFFSET UNITYSDK_OFFSET(0x19275EF0)
#define PARADOXNOTION_ANIMATION_EASING_SINUSOIDALIN_OFFSET UNITYSDK_OFFSET(0x19275D00)
#define PARADOXNOTION_ANIMATION_EASING_SINUSOIDALOUT_OFFSET UNITYSDK_OFFSET(0x19275E00)
#define PARADOXNOTION_ANIMATION_EASING__CCTOR_OFFSET UNITYSDK_OFFSET(0x19277510)

namespace ParadoxNotion::Animation
{
	inline static constexpr unsigned int Easing_TypeDefinitionIndex = 25502;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Func_4<::System::Single, ::System::Single, ::System::Single, ::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(Easing_TypeDefinitionIndex)->GetStaticField(0x1E820);
		}
