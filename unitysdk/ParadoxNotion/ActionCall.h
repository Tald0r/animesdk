...
#define PARADOXNOTION_ACTIONCALL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19763A80)
#define PARADOXNOTION_ACTIONCALL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19763AB0)
#define PARADOXNOTION_ACTIONCALL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1975E810)
#define PARADOXNOTION_ACTIONCALL__CTOR_OFFSET UNITYSDK_OFFSET(0x19763A70)

namespace ParadoxNotion
{
	inline static constexpr unsigned int ActionCall_TypeDefinitionIndex = 26189;
