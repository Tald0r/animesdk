...
#define PARADOXNOTION_RECTUTILS_ENCAPSULATES_OFFSET UNITYSDK_OFFSET(0x1A834790)
#define PARADOXNOTION_RECTUTILS_EXPANDBY_1_OFFSET UNITYSDK_OFFSET(0x1A834800)
#define PARADOXNOTION_RECTUTILS_EXPANDBY_2_OFFSET UNITYSDK_OFFSET(0x1A834830)
#define PARADOXNOTION_RECTUTILS_EXPANDBY_OFFSET UNITYSDK_OFFSET(0x1A8347D0)
#define PARADOXNOTION_RECTUTILS_GETBOUNDRECT_1_OFFSET UNITYSDK_OFFSET(0x1A8346B0)
#define PARADOXNOTION_RECTUTILS_GETBOUNDRECT_OFFSET UNITYSDK_OFFSET(0x1A8345D0)
#define PARADOXNOTION_RECTUTILS_TRANSFORMSPACE_1_OFFSET UNITYSDK_OFFSET(0x1A834990)
#define PARADOXNOTION_RECTUTILS_TRANSFORMSPACE_OFFSET UNITYSDK_OFFSET(0x1A834870)

namespace ParadoxNotion
{
	inline static constexpr unsigned int RectUtils_TypeDefinitionIndex = 27292;
