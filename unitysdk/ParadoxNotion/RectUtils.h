...
#define PARADOXNOTION_RECTUTILS_ENCAPSULATES_OFFSET UNITYSDK_OFFSET(0x1A26CDE0)
#define PARADOXNOTION_RECTUTILS_EXPANDBY_1_OFFSET UNITYSDK_OFFSET(0x1A26CE50)
#define PARADOXNOTION_RECTUTILS_EXPANDBY_2_OFFSET UNITYSDK_OFFSET(0x1A26CE80)
#define PARADOXNOTION_RECTUTILS_EXPANDBY_OFFSET UNITYSDK_OFFSET(0x1A26CE20)
#define PARADOXNOTION_RECTUTILS_GETBOUNDRECT_1_OFFSET UNITYSDK_OFFSET(0x1A26CD00)
#define PARADOXNOTION_RECTUTILS_GETBOUNDRECT_OFFSET UNITYSDK_OFFSET(0x1A26CC20)
#define PARADOXNOTION_RECTUTILS_TRANSFORMSPACE_1_OFFSET UNITYSDK_OFFSET(0x1A26CFE0)
#define PARADOXNOTION_RECTUTILS_TRANSFORMSPACE_OFFSET UNITYSDK_OFFSET(0x1A26CEC0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int RectUtils_TypeDefinitionIndex = 26777;
