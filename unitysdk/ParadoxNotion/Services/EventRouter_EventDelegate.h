...
#define PARADOXNOTION_SERVICES_EVENTROUTER_EVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A08E8C0)
#define PARADOXNOTION_SERVICES_EVENTROUTER_EVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A08E930)
#define PARADOXNOTION_SERVICES_EVENTROUTER_EVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A08E460)
#define PARADOXNOTION_SERVICES_EVENTROUTER_EVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A08E450)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int EventRouter_EventDelegate_TypeDefinitionIndex = 26041;
