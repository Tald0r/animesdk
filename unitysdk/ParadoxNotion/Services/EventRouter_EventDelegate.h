...
#define PARADOXNOTION_SERVICES_EVENTROUTER_EVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A6614D0)
#define PARADOXNOTION_SERVICES_EVENTROUTER_EVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A661540)
#define PARADOXNOTION_SERVICES_EVENTROUTER_EVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A661070)
#define PARADOXNOTION_SERVICES_EVENTROUTER_EVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A661050)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int EventRouter_EventDelegate_TypeDefinitionIndex = 26114;
