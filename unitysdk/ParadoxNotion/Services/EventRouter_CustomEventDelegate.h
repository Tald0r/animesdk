...
#define PARADOXNOTION_SERVICES_EVENTROUTER_CUSTOMEVENTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19C334C0)
#define PARADOXNOTION_SERVICES_EVENTROUTER_CUSTOMEVENTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19C33500)
#define PARADOXNOTION_SERVICES_EVENTROUTER_CUSTOMEVENTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C32F40)
#define PARADOXNOTION_SERVICES_EVENTROUTER_CUSTOMEVENTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C32F20)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int EventRouter_CustomEventDelegate_TypeDefinitionIndex = 26112;
