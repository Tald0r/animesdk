...
#define PARADOXNOTION_SERVICES_LOGGER_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x19A13080)
#define PARADOXNOTION_SERVICES_LOGGER_FORWARDTOUNITY_OFFSET UNITYSDK_OFFSET(0x19A13810)
#define PARADOXNOTION_SERVICES_LOGGER_INTERNAL_LOG_OFFSET UNITYSDK_OFFSET(0x19A131F0)
#define PARADOXNOTION_SERVICES_LOGGER_LOGERROR_OFFSET UNITYSDK_OFFSET(0x19A03CF0)
#define PARADOXNOTION_SERVICES_LOGGER_LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x19A00200)
#define PARADOXNOTION_SERVICES_LOGGER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x19A13720)
#define PARADOXNOTION_SERVICES_LOGGER_LOG_OFFSET UNITYSDK_OFFSET(0x19A131A0)
#define PARADOXNOTION_SERVICES_LOGGER_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x19A13110)
#define PARADOXNOTION_SERVICES_LOGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A13A30)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int Logger_TypeDefinitionIndex = 26135;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::ParadoxNotion::Services::Logger_LogHandler*>**)Il2CppClass::FromTypeDefinitionIndex(Logger_TypeDefinitionIndex)->GetStaticField(0x1F670);
		}
