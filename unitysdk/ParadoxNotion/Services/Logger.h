...
#define PARADOXNOTION_SERVICES_LOGGER_ADDLISTENER_OFFSET UNITYSDK_OFFSET(0x1A003040)
#define PARADOXNOTION_SERVICES_LOGGER_FORWARDTOUNITY_OFFSET UNITYSDK_OFFSET(0x1A0037D0)
#define PARADOXNOTION_SERVICES_LOGGER_INTERNAL_LOG_OFFSET UNITYSDK_OFFSET(0x1A0031B0)
#define PARADOXNOTION_SERVICES_LOGGER_LOGERROR_OFFSET UNITYSDK_OFFSET(0x19FF3CF0)
#define PARADOXNOTION_SERVICES_LOGGER_LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x19FEFF30)
#define PARADOXNOTION_SERVICES_LOGGER_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1A0036E0)
#define PARADOXNOTION_SERVICES_LOGGER_LOG_OFFSET UNITYSDK_OFFSET(0x1A003160)
#define PARADOXNOTION_SERVICES_LOGGER_REMOVELISTENER_OFFSET UNITYSDK_OFFSET(0x1A0030D0)
#define PARADOXNOTION_SERVICES_LOGGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A0039F0)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int Logger_TypeDefinitionIndex = 26753;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::ParadoxNotion::Services::Logger_LogHandler*>**)Il2CppClass::FromTypeDefinitionIndex(Logger_TypeDefinitionIndex)->GetStaticField(0x1FA70);
		}
