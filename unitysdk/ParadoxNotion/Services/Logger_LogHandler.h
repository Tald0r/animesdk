...
#define PARADOXNOTION_SERVICES_LOGGER_LOGHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19DBDC70)
#define PARADOXNOTION_SERVICES_LOGGER_LOGHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19DBDCE0)
#define PARADOXNOTION_SERVICES_LOGGER_LOGHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x19DBD820)
#define PARADOXNOTION_SERVICES_LOGGER_LOGHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DBD810)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int Logger_LogHandler_TypeDefinitionIndex = 26137;
