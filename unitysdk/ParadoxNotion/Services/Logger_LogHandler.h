...
#define PARADOXNOTION_SERVICES_LOGGER_LOGHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A3AEEF0)
#define PARADOXNOTION_SERVICES_LOGGER_LOGHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A3AEF60)
#define PARADOXNOTION_SERVICES_LOGGER_LOGHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A3AEA90)
#define PARADOXNOTION_SERVICES_LOGGER_LOGHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3AEA70)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int Logger_LogHandler_TypeDefinitionIndex = 26755;
