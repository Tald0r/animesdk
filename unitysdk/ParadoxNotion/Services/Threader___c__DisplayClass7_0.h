...
#define PARADOXNOTION_SERVICES_THREADER___C__DISPLAYCLASS7_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19765650)
#define PARADOXNOTION_SERVICES_THREADER___C__DISPLAYCLASS7_0__STARTACTION_B__0_OFFSET UNITYSDK_OFFSET(0x19765660)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int Threader___c__DisplayClass7_0_TypeDefinitionIndex = 25199;
