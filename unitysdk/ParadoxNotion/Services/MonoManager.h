...
#define PARADOXNOTION_SERVICES_MONOMANAGER_ADDUPDATECALL_OFFSET UNITYSDK_OFFSET(0x19FF7F50)
#define PARADOXNOTION_SERVICES_MONOMANAGER_ADD_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x19FF79D0)
#define PARADOXNOTION_SERVICES_MONOMANAGER_ADD_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x19FF7910)
#define PARADOXNOTION_SERVICES_MONOMANAGER_ADD_ONFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x19FF7850)
#define PARADOXNOTION_SERVICES_MONOMANAGER_ADD_ONGUI_OFFSET UNITYSDK_OFFSET(0x19FF7AD0)
#define PARADOXNOTION_SERVICES_MONOMANAGER_ADD_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19FF7790)
#define PARADOXNOTION_SERVICES_MONOMANAGER_ADD_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19FF76D0)
#define PARADOXNOTION_SERVICES_MONOMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x19FF8130)
#define PARADOXNOTION_SERVICES_MONOMANAGER_CREATE_OFFSET UNITYSDK_OFFSET(0x19FF7F30)
#define PARADOXNOTION_SERVICES_MONOMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x19FF83C0)
#define PARADOXNOTION_SERVICES_MONOMANAGER_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19FF7B90)
#define PARADOXNOTION_SERVICES_MONOMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19FF83B0)
#define PARADOXNOTION_SERVICES_MONOMANAGER_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x19FF8340)
#define PARADOXNOTION_SERVICES_MONOMANAGER_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x19FF8320)
#define PARADOXNOTION_SERVICES_MONOMANAGER_PURGE_OFFSET UNITYSDK_OFFSET(0x19FF7F20)
#define PARADOXNOTION_SERVICES_MONOMANAGER_REMOVEUPDATECALL_OFFSET UNITYSDK_OFFSET(0x19FF8040)
#define PARADOXNOTION_SERVICES_MONOMANAGER_REMOVE_ONAPPLICATIONPAUSE_OFFSET UNITYSDK_OFFSET(0x19FF7A50)
#define PARADOXNOTION_SERVICES_MONOMANAGER_REMOVE_ONAPPLICATIONQUIT_OFFSET UNITYSDK_OFFSET(0x19FF7970)
#define PARADOXNOTION_SERVICES_MONOMANAGER_REMOVE_ONFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x19FF78B0)
#define PARADOXNOTION_SERVICES_MONOMANAGER_REMOVE_ONGUI_OFFSET UNITYSDK_OFFSET(0x19FF7B30)
#define PARADOXNOTION_SERVICES_MONOMANAGER_REMOVE_ONLATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19FF77F0)
#define PARADOXNOTION_SERVICES_MONOMANAGER_REMOVE_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x19FF7730)
#define PARADOXNOTION_SERVICES_MONOMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19FF83A0)
#define PARADOXNOTION_SERVICES_MONOMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF83D0)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int MonoManager_TypeDefinitionIndex = 25662;
	...
	public:
		...
		{
			return (::ParadoxNotion::Services::MonoManager**)Il2CppClass::FromTypeDefinitionIndex(MonoManager_TypeDefinitionIndex)->GetStaticField(0x1F840);
		}
		static ::System::Boolean* StaticGet_isQuiting()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(MonoManager_TypeDefinitionIndex)->GetStaticField(0x4A40);
		}
