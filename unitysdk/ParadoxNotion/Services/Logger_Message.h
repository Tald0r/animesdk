...
#define PARADOXNOTION_SERVICES_LOGGER_MESSAGE_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x8C5BC0)
#define PARADOXNOTION_SERVICES_LOGGER_MESSAGE_ISVALID_OFFSET UNITYSDK_OFFSET(0x8C5CD0)
#define PARADOXNOTION_SERVICES_LOGGER_MESSAGE_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x8C5C30)

namespace ParadoxNotion::Services
{
	inline static constexpr unsigned int Logger_Message_TypeDefinitionIndex = 26136;
