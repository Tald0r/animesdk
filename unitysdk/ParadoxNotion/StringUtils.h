...
#define PARADOXNOTION_STRINGUTILS_CAPITALIZEFIRST_OFFSET UNITYSDK_OFFSET(0x1A1BA340)
#define PARADOXNOTION_STRINGUTILS_CAPLENGTH_OFFSET UNITYSDK_OFFSET(0x1A1BA400)
#define PARADOXNOTION_STRINGUTILS_FORMATERROR_OFFSET UNITYSDK_OFFSET(0x1A1B4660)
#define PARADOXNOTION_STRINGUTILS_GETALPHABETLETTER_OFFSET UNITYSDK_OFFSET(0x1A1BA570)
#define PARADOXNOTION_STRINGUTILS_GETCAPITALS_OFFSET UNITYSDK_OFFSET(0x1A1BA450)
#define PARADOXNOTION_STRINGUTILS_GETSTRINGWITHININNER_OFFSET UNITYSDK_OFFSET(0x1A1BA6B0)
#define PARADOXNOTION_STRINGUTILS_GETSTRINGWITHINOUTER_OFFSET UNITYSDK_OFFSET(0x1A1BA640)
#define PARADOXNOTION_STRINGUTILS_REPLACEWITHIN_OFFSET UNITYSDK_OFFSET(0x1A1BA760)
#define PARADOXNOTION_STRINGUTILS_SCORESEARCHMATCH_OFFSET UNITYSDK_OFFSET(0x1A1BA8E0)
#define PARADOXNOTION_STRINGUTILS_SEARCHMATCH_OFFSET UNITYSDK_OFFSET(0x1A1BAC10)
#define PARADOXNOTION_STRINGUTILS_SPLITCAMELCASE_OFFSET UNITYSDK_OFFSET(0x1A1BA0E0)
#define PARADOXNOTION_STRINGUTILS_TOSTRINGADVANCED_OFFSET UNITYSDK_OFFSET(0x1A1AFFF0)
#define PARADOXNOTION_STRINGUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1BB050)

namespace ParadoxNotion
{
	inline static constexpr unsigned int StringUtils_TypeDefinitionIndex = 26511;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(StringUtils_TypeDefinitionIndex)->GetStaticField(0x1F580);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_splitCaseCache()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(StringUtils_TypeDefinitionIndex)->GetStaticField(0x1F588);
		}
