...
#define PARADOXNOTION_STRINGUTILS_CAPITALIZEFIRST_OFFSET UNITYSDK_OFFSET(0x1A10FB90)
#define PARADOXNOTION_STRINGUTILS_CAPLENGTH_OFFSET UNITYSDK_OFFSET(0x1A127740)
#define PARADOXNOTION_STRINGUTILS_FORMATERROR_OFFSET UNITYSDK_OFFSET(0x1A121A70)
#define PARADOXNOTION_STRINGUTILS_GETALPHABETLETTER_OFFSET UNITYSDK_OFFSET(0x1A1278B0)
#define PARADOXNOTION_STRINGUTILS_GETCAPITALS_OFFSET UNITYSDK_OFFSET(0x1A127790)
#define PARADOXNOTION_STRINGUTILS_GETSTRINGWITHININNER_OFFSET UNITYSDK_OFFSET(0x1A116C70)
#define PARADOXNOTION_STRINGUTILS_GETSTRINGWITHINOUTER_OFFSET UNITYSDK_OFFSET(0x1A127980)
#define PARADOXNOTION_STRINGUTILS_REPLACEWITHIN_OFFSET UNITYSDK_OFFSET(0x1A1279F0)
#define PARADOXNOTION_STRINGUTILS_SCORESEARCHMATCH_OFFSET UNITYSDK_OFFSET(0x1A127B70)
#define PARADOXNOTION_STRINGUTILS_SEARCHMATCH_OFFSET UNITYSDK_OFFSET(0x1A127EA0)
#define PARADOXNOTION_STRINGUTILS_SPLITCAMELCASE_OFFSET UNITYSDK_OFFSET(0x1A1274E0)
#define PARADOXNOTION_STRINGUTILS_TOSTRINGADVANCED_OFFSET UNITYSDK_OFFSET(0x1A11D400)
#define PARADOXNOTION_STRINGUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1282E0)

namespace ParadoxNotion
{
	inline static constexpr unsigned int StringUtils_TypeDefinitionIndex = 26924;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(StringUtils_TypeDefinitionIndex)->GetStaticField(0x1F8E0);
		}
		static ::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>** StaticGet_splitCaseCache()
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(StringUtils_TypeDefinitionIndex)->GetStaticField(0x1F8E8);
		}
