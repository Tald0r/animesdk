...
#define NPCSTREAMINGPROXY_CHANGESTATE_OFFSET UNITYSDK_OFFSET(0x7E126F0)
#define NPCSTREAMINGPROXY_CHECKDUMMY_OFFSET UNITYSDK_OFFSET(0x7E12B20)
#define NPCSTREAMINGPROXY_CREATENPCSTREAMINGPROXY_OFFSET UNITYSDK_OFFSET(0x7E12A90)
#define NPCSTREAMINGPROXY_GET_PREFABPATH_OFFSET UNITYSDK_OFFSET(0x7E12170)
#define NPCSTREAMINGPROXY_ONBECAMEINVISIBLE_OFFSET UNITYSDK_OFFSET(0x7E12940)
#define NPCSTREAMINGPROXY_ONBECAMEVISIBLE_OFFSET UNITYSDK_OFFSET(0x7E129E0)
#define NPCSTREAMINGPROXY_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x7E12200)
#define NPCSTREAMINGPROXY_START_OFFSET UNITYSDK_OFFSET(0x7E12180)
#define NPCSTREAMINGPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x7E12440)
#define NPCSTREAMINGPROXY__CCTOR_OFFSET UNITYSDK_OFFSET(0x7E12CE0)
#define NPCSTREAMINGPROXY__CHANGESTATE_B__20_0_OFFSET UNITYSDK_OFFSET(0x7E12D90)
#define NPCSTREAMINGPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x7E12CC0)

inline static constexpr unsigned int NPCStreamingProxy_TypeDefinitionIndex = 36802;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NPCStreamingProxy_TypeDefinitionIndex)->GetStaticField(0x42A40);
	}
	static ::System::Single* StaticGet_CachedDistance()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCStreamingProxy_TypeDefinitionIndex)->GetStaticField(0x10910);
	}
	static ::System::Boolean* StaticGet_OpenStreaming()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(NPCStreamingProxy_TypeDefinitionIndex)->GetStaticField(0x10914);
	}
	static ::System::Single* StaticGet_CachedTime()
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(NPCStreamingProxy_TypeDefinitionIndex)->GetStaticField(0x10918);
	}
