...
#define CLASS_2_1D269C3F2FF0EA02_METHOD_2_0DD5A223C12DF330_OFFSET UNITYSDK_OFFSET(0x9472E30)
#define CLASS_2_1D269C3F2FF0EA02_METHOD_2_7B76336B4CE925CE_OFFSET UNITYSDK_OFFSET(0x9472EA0)
#define CLASS_2_1D269C3F2FF0EA02_METHOD_2_A96DCA30C6927810_OFFSET UNITYSDK_OFFSET(0x9472DD0)
#define CLASS_2_1D269C3F2FF0EA02__CTOR_OFFSET UNITYSDK_OFFSET(0x9472DE0)

inline static constexpr unsigned int Class_2_1D269C3F2FF0EA02_TypeDefinitionIndex = 78211;

class Class_2_1D269C3F2FF0EA02 : public ::Class_1_43BD383C98B4C0C5_23
{
public:
