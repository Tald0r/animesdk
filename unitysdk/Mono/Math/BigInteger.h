...
#define MONO_MATH_BIGINTEGER_ADD_OFFSET UNITYSDK_OFFSET(0x1B1405A0)
#define MONO_MATH_BIGINTEGER_BITCOUNT_OFFSET UNITYSDK_OFFSET(0x1B1411C0)
#define MONO_MATH_BIGINTEGER_CLEARBIT_OFFSET UNITYSDK_OFFSET(0x1B1414D0)
#define MONO_MATH_BIGINTEGER_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B141E70)
#define MONO_MATH_BIGINTEGER_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B141AD0)
#define MONO_MATH_BIGINTEGER_DIVID_1_OFFSET UNITYSDK_OFFSET(0x1B140BA0)
#define MONO_MATH_BIGINTEGER_DIVID_OFFSET UNITYSDK_OFFSET(0x1B140AE0)
#define MONO_MATH_BIGINTEGER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B142080)
#define MONO_MATH_BIGINTEGER_GCD_OFFSET UNITYSDK_OFFSET(0x1B1421F0)
#define MONO_MATH_BIGINTEGER_GENERATEPSEUDOPRIME_OFFSET UNITYSDK_OFFSET(0x1B142750)
#define MONO_MATH_BIGINTEGER_GENERATERANDOM_1_OFFSET UNITYSDK_OFFSET(0x1B140F90)
#define MONO_MATH_BIGINTEGER_GENERATERANDOM_OFFSET UNITYSDK_OFFSET(0x1B140DE0)
#define MONO_MATH_BIGINTEGER_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1B1415B0)
#define MONO_MATH_BIGINTEGER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B141ED0)
#define MONO_MATH_BIGINTEGER_GET_RNG_OFFSET UNITYSDK_OFFSET(0x1B140CF0)
#define MONO_MATH_BIGINTEGER_INCR2_OFFSET UNITYSDK_OFFSET(0x1B1427C0)
#define MONO_MATH_BIGINTEGER_ISPROBABLEPRIME_OFFSET UNITYSDK_OFFSET(0x1B142280)
#define MONO_MATH_BIGINTEGER_LOWESTSETBIT_OFFSET UNITYSDK_OFFSET(0x1B141520)
#define MONO_MATH_BIGINTEGER_MODINVERSE_OFFSET UNITYSDK_OFFSET(0x1B142200)
#define MONO_MATH_BIGINTEGER_MODPOW_OFFSET UNITYSDK_OFFSET(0x1B142210)
#define MONO_MATH_BIGINTEGER_MODULUS_1_OFFSET UNITYSDK_OFFSET(0x1B1408E0)
#define MONO_MATH_BIGINTEGER_MODULUS_2_OFFSET UNITYSDK_OFFSET(0x1B140A50)
#define MONO_MATH_BIGINTEGER_MODULUS_OFFSET UNITYSDK_OFFSET(0x1B140660)
#define MONO_MATH_BIGINTEGER_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1B140C90)
#define MONO_MATH_BIGINTEGER_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B140C30)
#define MONO_MATH_BIGINTEGER_NEXTHIGHESTPRIME_OFFSET UNITYSDK_OFFSET(0x1B1426F0)
#define MONO_MATH_BIGINTEGER_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1B13EE20)
#define MONO_MATH_BIGINTEGER_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1B13F7F0)
#define MONO_MATH_BIGINTEGER_OP_DIVISION_1_OFFSET UNITYSDK_OFFSET(0x1B140230)
#define MONO_MATH_BIGINTEGER_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1B1401C0)
#define MONO_MATH_BIGINTEGER_OP_EQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1B141910)
#define MONO_MATH_BIGINTEGER_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B13FAB0)
#define MONO_MATH_BIGINTEGER_OP_GREATERTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x1B141A90)
#define MONO_MATH_BIGINTEGER_OP_GREATERTHAN_OFFSET UNITYSDK_OFFSET(0x1B141A50)
#define MONO_MATH_BIGINTEGER_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B13F200)
#define MONO_MATH_BIGINTEGER_OP_IMPLICIT_2_OFFSET UNITYSDK_OFFSET(0x1B13F2B0)
#define MONO_MATH_BIGINTEGER_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B13F180)
#define MONO_MATH_BIGINTEGER_OP_INEQUALITY_1_OFFSET UNITYSDK_OFFSET(0x1B1419B0)
#define MONO_MATH_BIGINTEGER_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B141840)
#define MONO_MATH_BIGINTEGER_OP_LEFTSHIFT_OFFSET UNITYSDK_OFFSET(0x1B140580)
#define MONO_MATH_BIGINTEGER_OP_LESSTHANOREQUAL_OFFSET UNITYSDK_OFFSET(0x1B141AB0)
#define MONO_MATH_BIGINTEGER_OP_LESSTHAN_OFFSET UNITYSDK_OFFSET(0x1B141A70)
#define MONO_MATH_BIGINTEGER_OP_MODULUS_1_OFFSET UNITYSDK_OFFSET(0x1B140050)
#define MONO_MATH_BIGINTEGER_OP_MODULUS_2_OFFSET UNITYSDK_OFFSET(0x1B140180)
#define MONO_MATH_BIGINTEGER_OP_MODULUS_OFFSET UNITYSDK_OFFSET(0x1B13FE00)
#define MONO_MATH_BIGINTEGER_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1B13F620)
#define MONO_MATH_BIGINTEGER_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B140270)
#define MONO_MATH_BIGINTEGER_OP_RIGHTSHIFT_OFFSET UNITYSDK_OFFSET(0x1B140590)
#define MONO_MATH_BIGINTEGER_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1B13FB70)
#define MONO_MATH_BIGINTEGER_PARSE_OFFSET UNITYSDK_OFFSET(0x1B13F300)
#define MONO_MATH_BIGINTEGER_RANDOMIZE_1_OFFSET UNITYSDK_OFFSET(0x1B1412C0)
#define MONO_MATH_BIGINTEGER_RANDOMIZE_OFFSET UNITYSDK_OFFSET(0x1B140FF0)
#define MONO_MATH_BIGINTEGER_SETBIT_1_OFFSET UNITYSDK_OFFSET(0x1B141450)
#define MONO_MATH_BIGINTEGER_SETBIT_OFFSET UNITYSDK_OFFSET(0x1B141400)
#define MONO_MATH_BIGINTEGER_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x1B140600)
#define MONO_MATH_BIGINTEGER_TESTBIT_1_OFFSET UNITYSDK_OFFSET(0x1B141360)
#define MONO_MATH_BIGINTEGER_TESTBIT_OFFSET UNITYSDK_OFFSET(0x1B141320)
#define MONO_MATH_BIGINTEGER_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1B141B20)
#define MONO_MATH_BIGINTEGER_TOSTRING_2_OFFSET UNITYSDK_OFFSET(0x1B142040)
#define MONO_MATH_BIGINTEGER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B141AE0)
#define MONO_MATH_BIGINTEGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B142860)
#define MONO_MATH_BIGINTEGER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B13E8D0)
#define MONO_MATH_BIGINTEGER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B13E900)
#define MONO_MATH_BIGINTEGER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B13EA00)
#define MONO_MATH_BIGINTEGER__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B13EAD0)
#define MONO_MATH_BIGINTEGER__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1B13EE90)
#define MONO_MATH_BIGINTEGER__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1B13F090)
#define MONO_MATH_BIGINTEGER__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1B13F0F0)
#define MONO_MATH_BIGINTEGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B13E890)
