...
#define MONO_MATH_PRIME_GENERATOR_SEQUENTIALSEARCHPRIMEGENERATORBASE_GENERATENEWPRIME_1_OFFSET UNITYSDK_OFFSET(0x1AFED950)
#define MONO_MATH_PRIME_GENERATOR_SEQUENTIALSEARCHPRIMEGENERATORBASE_GENERATENEWPRIME_OFFSET UNITYSDK_OFFSET(0x1AFED930)
#define MONO_MATH_PRIME_GENERATOR_SEQUENTIALSEARCHPRIMEGENERATORBASE_GENERATESEARCHBASE_OFFSET UNITYSDK_OFFSET(0x1AFED840)
#define MONO_MATH_PRIME_GENERATOR_SEQUENTIALSEARCHPRIMEGENERATORBASE_ISPRIMEACCEPTABLE_OFFSET UNITYSDK_OFFSET(0x1AFEDEF0)
#define MONO_MATH_PRIME_GENERATOR_SEQUENTIALSEARCHPRIMEGENERATORBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFEDF00)
