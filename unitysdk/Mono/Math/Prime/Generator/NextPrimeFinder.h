...
#define MONO_MATH_PRIME_GENERATOR_NEXTPRIMEFINDER_GENERATESEARCHBASE_OFFSET UNITYSDK_OFFSET(0x1B6C7390)
#define MONO_MATH_PRIME_GENERATOR_NEXTPRIMEFINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C7490)
