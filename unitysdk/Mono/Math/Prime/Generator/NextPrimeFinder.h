...
#define MONO_MATH_PRIME_GENERATOR_NEXTPRIMEFINDER_GENERATESEARCHBASE_OFFSET UNITYSDK_OFFSET(0x1B0B6340)
#define MONO_MATH_PRIME_GENERATOR_NEXTPRIMEFINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B6440)
