...
#define MONO_MATH_PRIME_PRIMALITYTEST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AAA7200)
#define MONO_MATH_PRIME_PRIMALITYTEST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AAA7280)
#define MONO_MATH_PRIME_PRIMALITYTEST_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AAA6CA0)
#define MONO_MATH_PRIME_PRIMALITYTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAA6C80)
