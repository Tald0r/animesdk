...
#define MONO_MATH_PRIME_PRIMALITYTESTS_GETSPPROUNDS_OFFSET UNITYSDK_OFFSET(0x1AAA72C0)
#define MONO_MATH_PRIME_PRIMALITYTESTS_RABINMILLERTEST_OFFSET UNITYSDK_OFFSET(0x1AAA7840)
#define MONO_MATH_PRIME_PRIMALITYTESTS_SMALLPRIMESPPTEST_OFFSET UNITYSDK_OFFSET(0x1AAA74A0)
#define MONO_MATH_PRIME_PRIMALITYTESTS_TEST_OFFSET UNITYSDK_OFFSET(0x1AAA7460)
#define MONO_MATH_PRIME_PRIMALITYTESTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAA72B0)
