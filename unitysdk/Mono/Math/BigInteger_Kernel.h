...
#define MONO_MATH_BIGINTEGER_KERNEL_ADDSAMESIGN_OFFSET UNITYSDK_OFFSET(0x1AA0EFD0)
#define MONO_MATH_BIGINTEGER_KERNEL_COMPARE_OFFSET UNITYSDK_OFFSET(0x1AA0F990)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDDIVMOD_OFFSET UNITYSDK_OFFSET(0x1AA0FE90)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDDIV_OFFSET UNITYSDK_OFFSET(0x1AA0FCF0)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDMOD_OFFSET UNITYSDK_OFFSET(0x1AA0FC60)
#define MONO_MATH_BIGINTEGER_KERNEL_GCD_OFFSET UNITYSDK_OFFSET(0x1AA11570)
#define MONO_MATH_BIGINTEGER_KERNEL_LEFTSHIFT_OFFSET UNITYSDK_OFFSET(0x1AA10A30)
#define MONO_MATH_BIGINTEGER_KERNEL_MINUSEQ_OFFSET UNITYSDK_OFFSET(0x1AA0F570)
#define MONO_MATH_BIGINTEGER_KERNEL_MODINVERSE_1_OFFSET UNITYSDK_OFFSET(0x1AA119F0)
#define MONO_MATH_BIGINTEGER_KERNEL_MODINVERSE_OFFSET UNITYSDK_OFFSET(0x1AA11820)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIBYTEDIVIDE_OFFSET UNITYSDK_OFFSET(0x1AA10140)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLYBYDWORD_OFFSET UNITYSDK_OFFSET(0x1AA10F60)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLYMOD2P32PMOD_OFFSET UNITYSDK_OFFSET(0x1AA111D0)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1AA110E0)
#define MONO_MATH_BIGINTEGER_KERNEL_PLUSEQ_OFFSET UNITYSDK_OFFSET(0x1AA0F6F0)
#define MONO_MATH_BIGINTEGER_KERNEL_RIGHTSHIFT_OFFSET UNITYSDK_OFFSET(0x1AA10D10)
#define MONO_MATH_BIGINTEGER_KERNEL_SINGLEBYTEDIVIDEINPLACE_OFFSET UNITYSDK_OFFSET(0x1AA0FB70)
#define MONO_MATH_BIGINTEGER_KERNEL_SQUAREPOSITIVE_OFFSET UNITYSDK_OFFSET(0x1AA112D0)
#define MONO_MATH_BIGINTEGER_KERNEL_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x1AA0F2D0)
#define MONO_MATH_BIGINTEGER_KERNEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA12580)
