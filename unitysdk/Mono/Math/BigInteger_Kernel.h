...
#define MONO_MATH_BIGINTEGER_KERNEL_ADDSAMESIGN_OFFSET UNITYSDK_OFFSET(0x1AFFECF0)
#define MONO_MATH_BIGINTEGER_KERNEL_COMPARE_OFFSET UNITYSDK_OFFSET(0x1AFFF6B0)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDDIVMOD_OFFSET UNITYSDK_OFFSET(0x1AFFFBB0)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDDIV_OFFSET UNITYSDK_OFFSET(0x1AFFFA10)
#define MONO_MATH_BIGINTEGER_KERNEL_DWORDMOD_OFFSET UNITYSDK_OFFSET(0x1AFFF980)
#define MONO_MATH_BIGINTEGER_KERNEL_GCD_OFFSET UNITYSDK_OFFSET(0x1B001290)
#define MONO_MATH_BIGINTEGER_KERNEL_LEFTSHIFT_OFFSET UNITYSDK_OFFSET(0x1B000750)
#define MONO_MATH_BIGINTEGER_KERNEL_MINUSEQ_OFFSET UNITYSDK_OFFSET(0x1AFFF290)
#define MONO_MATH_BIGINTEGER_KERNEL_MODINVERSE_1_OFFSET UNITYSDK_OFFSET(0x1B001710)
#define MONO_MATH_BIGINTEGER_KERNEL_MODINVERSE_OFFSET UNITYSDK_OFFSET(0x1B001540)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIBYTEDIVIDE_OFFSET UNITYSDK_OFFSET(0x1AFFFE60)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLYBYDWORD_OFFSET UNITYSDK_OFFSET(0x1B000C80)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLYMOD2P32PMOD_OFFSET UNITYSDK_OFFSET(0x1B000EF0)
#define MONO_MATH_BIGINTEGER_KERNEL_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B000E00)
#define MONO_MATH_BIGINTEGER_KERNEL_PLUSEQ_OFFSET UNITYSDK_OFFSET(0x1AFFF410)
#define MONO_MATH_BIGINTEGER_KERNEL_RIGHTSHIFT_OFFSET UNITYSDK_OFFSET(0x1B000A30)
#define MONO_MATH_BIGINTEGER_KERNEL_SINGLEBYTEDIVIDEINPLACE_OFFSET UNITYSDK_OFFSET(0x1AFFF890)
#define MONO_MATH_BIGINTEGER_KERNEL_SQUAREPOSITIVE_OFFSET UNITYSDK_OFFSET(0x1B000FF0)
#define MONO_MATH_BIGINTEGER_KERNEL_SUBTRACT_OFFSET UNITYSDK_OFFSET(0x1AFFEFF0)
#define MONO_MATH_BIGINTEGER_KERNEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0022A0)
