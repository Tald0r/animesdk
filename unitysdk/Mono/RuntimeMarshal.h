...
#define MONO_RUNTIMEMARSHAL_ASCIHEXDIGITVALUE_OFFSET UNITYSDK_OFFSET(0x19590250)
#define MONO_RUNTIMEMARSHAL_DECODEBLOBARRAY_OFFSET UNITYSDK_OFFSET(0x195901C0)
#define MONO_RUNTIMEMARSHAL_DECODEBLOBSIZE_OFFSET UNITYSDK_OFFSET(0x19590150)
#define MONO_RUNTIMEMARSHAL_FREEASSEMBLYNAME_OFFSET UNITYSDK_OFFSET(0x19590280)
#define MONO_RUNTIMEMARSHAL_MARSHALSTRING_OFFSET UNITYSDK_OFFSET(0x19590140)
#define MONO_RUNTIMEMARSHAL_PTRTOUTF8STRING_OFFSET UNITYSDK_OFFSET(0x19590060)
