...
#define MONO_XML_MINIPARSER_XMLERROR_GET_COLUMN_OFFSET UNITYSDK_OFFSET(0x1B0C0830)
#define MONO_XML_MINIPARSER_XMLERROR_GET_LINE_OFFSET UNITYSDK_OFFSET(0x1B0C0820)
#define MONO_XML_MINIPARSER_XMLERROR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0C0840)
#define MONO_XML_MINIPARSER_XMLERROR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0C0730)
#define MONO_XML_MINIPARSER_XMLERROR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B0C07A0)
#define MONO_XML_MINIPARSER_XMLERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0C06B0)
