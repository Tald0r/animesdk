...
#define MONO_XML_MINIPARSER_XMLERROR_GET_COLUMN_OFFSET UNITYSDK_OFFSET(0x1B6CE900)
#define MONO_XML_MINIPARSER_XMLERROR_GET_LINE_OFFSET UNITYSDK_OFFSET(0x1B6CE8F0)
#define MONO_XML_MINIPARSER_XMLERROR_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B6CE910)
#define MONO_XML_MINIPARSER_XMLERROR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6CE800)
#define MONO_XML_MINIPARSER_XMLERROR__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B6CE870)
#define MONO_XML_MINIPARSER_XMLERROR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CE780)
