...
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_ADD_OFFSET UNITYSDK_OFFSET(0x1AFEF7F0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1AFEF660)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AFEF7A0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_COPYFROM_OFFSET UNITYSDK_OFFSET(0x1AFEF2F0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GETNAME_OFFSET UNITYSDK_OFFSET(0x1AFEF4D0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GETVALUE_1_OFFSET UNITYSDK_OFFSET(0x1AFEF5D0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1AFEF550)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1AFEF4A0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1AFEF2C0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x1AFEF6E0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x1AFEF740)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x1AFEF8A0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_REMOVE_OFFSET UNITYSDK_OFFSET(0x1AFEF840)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFEF120)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AFEF1E0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFEF090)
