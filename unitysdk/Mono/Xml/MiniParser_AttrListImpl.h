...
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_ADD_OFFSET UNITYSDK_OFFSET(0x1A9FFAC0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_CHANGEVALUE_OFFSET UNITYSDK_OFFSET(0x1A9FF930)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A9FFA70)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_COPYFROM_OFFSET UNITYSDK_OFFSET(0x1A9FF5C0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GETNAME_OFFSET UNITYSDK_OFFSET(0x1A9FF7A0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GETVALUE_1_OFFSET UNITYSDK_OFFSET(0x1A9FF8A0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A9FF820)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A9FF770)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A9FF590)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GET_NAMES_OFFSET UNITYSDK_OFFSET(0x1A9FF9B0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_GET_VALUES_OFFSET UNITYSDK_OFFSET(0x1A9FFA10)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x1A9FFB70)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A9FFB10)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9FF3F0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A9FF4B0)
#define MONO_XML_MINIPARSER_ATTRLISTIMPL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9FF360)
