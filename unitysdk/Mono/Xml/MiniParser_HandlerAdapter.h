...
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONCHARS_OFFSET UNITYSDK_OFFSET(0x1AFD1450)
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1AFD1440)
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONENDPARSING_OFFSET UNITYSDK_OFFSET(0x1AFD1460)
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONSTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1AFD1430)
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONSTARTPARSING_OFFSET UNITYSDK_OFFSET(0x1AFD1420)
#define MONO_XML_MINIPARSER_HANDLERADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFD1220)
