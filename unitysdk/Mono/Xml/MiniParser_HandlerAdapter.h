...
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONCHARS_OFFSET UNITYSDK_OFFSET(0x1B5DCF90)
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONENDELEMENT_OFFSET UNITYSDK_OFFSET(0x1B5DCF80)
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONENDPARSING_OFFSET UNITYSDK_OFFSET(0x1B5DCFA0)
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONSTARTELEMENT_OFFSET UNITYSDK_OFFSET(0x1B5DCF70)
#define MONO_XML_MINIPARSER_HANDLERADAPTER_ONSTARTPARSING_OFFSET UNITYSDK_OFFSET(0x1B5DCF60)
#define MONO_XML_MINIPARSER_HANDLERADAPTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5DCD60)
