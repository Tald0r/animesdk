...
#define MONO_XML_MINIPARSER_FATALERR_OFFSET UNITYSDK_OFFSET(0x1AFCE990)
#define MONO_XML_MINIPARSER_PARSE_OFFSET UNITYSDK_OFFSET(0x1AFCEB80)
#define MONO_XML_MINIPARSER_RESET_OFFSET UNITYSDK_OFFSET(0x1AFCE8B0)
#define MONO_XML_MINIPARSER_STREQUALS_OFFSET UNITYSDK_OFFSET(0x1AFCE8C0)
#define MONO_XML_MINIPARSER_XLAT_OFFSET UNITYSDK_OFFSET(0x1AFCE9F0)
#define MONO_XML_MINIPARSER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFD1230)
#define MONO_XML_MINIPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFCE880)
