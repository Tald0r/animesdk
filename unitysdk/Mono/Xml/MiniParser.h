...
#define MONO_XML_MINIPARSER_FATALERR_OFFSET UNITYSDK_OFFSET(0x1B5DA4C0)
#define MONO_XML_MINIPARSER_PARSE_OFFSET UNITYSDK_OFFSET(0x1B5DA6B0)
#define MONO_XML_MINIPARSER_RESET_OFFSET UNITYSDK_OFFSET(0x1B5DA3E0)
#define MONO_XML_MINIPARSER_STREQUALS_OFFSET UNITYSDK_OFFSET(0x1B5DA3F0)
#define MONO_XML_MINIPARSER_XLAT_OFFSET UNITYSDK_OFFSET(0x1B5DA520)
#define MONO_XML_MINIPARSER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5DCD70)
#define MONO_XML_MINIPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5DA3A0)
