...
#define MONO_DATACONVERTER_COPYCONVERTER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x18973440)
#define MONO_DATACONVERTER_COPYCONVERTER_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x18973920)
#define MONO_DATACONVERTER_COPYCONVERTER_GETINT16_OFFSET UNITYSDK_OFFSET(0x18973D10)
#define MONO_DATACONVERTER_COPYCONVERTER_GETINT32_OFFSET UNITYSDK_OFFSET(0x18973A70)
#define MONO_DATACONVERTER_COPYCONVERTER_GETINT64_OFFSET UNITYSDK_OFFSET(0x18973780)
#define MONO_DATACONVERTER_COPYCONVERTER_GETUINT16_OFFSET UNITYSDK_OFFSET(0x18973E30)
#define MONO_DATACONVERTER_COPYCONVERTER_GETUINT32_OFFSET UNITYSDK_OFFSET(0x18973BC0)
#define MONO_DATACONVERTER_COPYCONVERTER_GETUINT64_OFFSET UNITYSDK_OFFSET(0x189735E0)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_1_OFFSET UNITYSDK_OFFSET(0x18973FB0)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_2_OFFSET UNITYSDK_OFFSET(0x18974010)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_3_OFFSET UNITYSDK_OFFSET(0x18974060)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_4_OFFSET UNITYSDK_OFFSET(0x189740B0)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_5_OFFSET UNITYSDK_OFFSET(0x18974100)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_6_OFFSET UNITYSDK_OFFSET(0x18974150)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_7_OFFSET UNITYSDK_OFFSET(0x189741A0)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_OFFSET UNITYSDK_OFFSET(0x18973F50)
#define MONO_DATACONVERTER_COPYCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x189741F0)
