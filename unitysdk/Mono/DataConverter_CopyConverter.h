...
#define MONO_DATACONVERTER_COPYCONVERTER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x18EBAF10)
#define MONO_DATACONVERTER_COPYCONVERTER_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x18EBB3F0)
#define MONO_DATACONVERTER_COPYCONVERTER_GETINT16_OFFSET UNITYSDK_OFFSET(0x18EBB7E0)
#define MONO_DATACONVERTER_COPYCONVERTER_GETINT32_OFFSET UNITYSDK_OFFSET(0x18EBB540)
#define MONO_DATACONVERTER_COPYCONVERTER_GETINT64_OFFSET UNITYSDK_OFFSET(0x18EBB250)
#define MONO_DATACONVERTER_COPYCONVERTER_GETUINT16_OFFSET UNITYSDK_OFFSET(0x18EBB900)
#define MONO_DATACONVERTER_COPYCONVERTER_GETUINT32_OFFSET UNITYSDK_OFFSET(0x18EBB690)
#define MONO_DATACONVERTER_COPYCONVERTER_GETUINT64_OFFSET UNITYSDK_OFFSET(0x18EBB0B0)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_1_OFFSET UNITYSDK_OFFSET(0x18EBBA80)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_2_OFFSET UNITYSDK_OFFSET(0x18EBBAE0)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_3_OFFSET UNITYSDK_OFFSET(0x18EBBB30)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_4_OFFSET UNITYSDK_OFFSET(0x18EBBB80)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_5_OFFSET UNITYSDK_OFFSET(0x18EBBBD0)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_6_OFFSET UNITYSDK_OFFSET(0x18EBBC20)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_7_OFFSET UNITYSDK_OFFSET(0x18EBBC70)
#define MONO_DATACONVERTER_COPYCONVERTER_PUTBYTES_OFFSET UNITYSDK_OFFSET(0x18EBBA20)
#define MONO_DATACONVERTER_COPYCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x18EBBCC0)
