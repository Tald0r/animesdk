...
#define MONO_NET_CFBOOLEAN_CFBOOLEANGETVALUE_OFFSET UNITYSDK_OFFSET(0x194477F0)
#define MONO_NET_CFBOOLEAN_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19447460)
#define MONO_NET_CFBOOLEAN_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19447410)
#define MONO_NET_CFBOOLEAN_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19447390)
#define MONO_NET_CFBOOLEAN_FROMBOOLEAN_OFFSET UNITYSDK_OFFSET(0x19447780)
#define MONO_NET_CFBOOLEAN_GETVALUE_OFFSET UNITYSDK_OFFSET(0x19447870)
#define MONO_NET_CFBOOLEAN_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x19447400)
#define MONO_NET_CFBOOLEAN_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x194475E0)
#define MONO_NET_CFBOOLEAN_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x194476D0)
#define MONO_NET_CFBOOLEAN_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x194474F0)
#define MONO_NET_CFBOOLEAN__CCTOR_OFFSET UNITYSDK_OFFSET(0x19446EE0)
#define MONO_NET_CFBOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x19447300)
