...
#define MONO_NET_CFBOOLEAN_CFBOOLEANGETVALUE_OFFSET UNITYSDK_OFFSET(0x1908B0A0)
#define MONO_NET_CFBOOLEAN_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1908AD20)
#define MONO_NET_CFBOOLEAN_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1908ACD0)
#define MONO_NET_CFBOOLEAN_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1908AC50)
#define MONO_NET_CFBOOLEAN_FROMBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1908B040)
#define MONO_NET_CFBOOLEAN_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1908B120)
#define MONO_NET_CFBOOLEAN_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1908ACC0)
#define MONO_NET_CFBOOLEAN_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1908AEA0)
#define MONO_NET_CFBOOLEAN_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1908AF90)
#define MONO_NET_CFBOOLEAN_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1908ADB0)
#define MONO_NET_CFBOOLEAN__CCTOR_OFFSET UNITYSDK_OFFSET(0x1908A7A0)
#define MONO_NET_CFBOOLEAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1908ABC0)
