...
#define MONO_NET_CFDICTIONARY_CFDICTIONARYCREATECOPY_OFFSET UNITYSDK_OFFSET(0x19314A50)
#define MONO_NET_CFDICTIONARY_CFDICTIONARYCREATEMUTABLECOPY_OFFSET UNITYSDK_OFFSET(0x19314D20)
#define MONO_NET_CFDICTIONARY_CFDICTIONARYCREATE_OFFSET UNITYSDK_OFFSET(0x193143F0)
#define MONO_NET_CFDICTIONARY_CFDICTIONARYGETVALUE_OFFSET UNITYSDK_OFFSET(0x193149C0)
#define MONO_NET_CFDICTIONARY_COPY_OFFSET UNITYSDK_OFFSET(0x19314AE0)
#define MONO_NET_CFDICTIONARY_FROMKEYSANDOBJECTS_OFFSET UNITYSDK_OFFSET(0x193144C0)
#define MONO_NET_CFDICTIONARY_FROMOBJECTANDKEY_OFFSET UNITYSDK_OFFSET(0x19314260)
#define MONO_NET_CFDICTIONARY_GETVALUE_OFFSET UNITYSDK_OFFSET(0x19314DB0)
#define MONO_NET_CFDICTIONARY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19314EA0)
#define MONO_NET_CFDICTIONARY_MUTABLECOPY_OFFSET UNITYSDK_OFFSET(0x19314BE0)
#define MONO_NET_CFDICTIONARY__CCTOR_OFFSET UNITYSDK_OFFSET(0x19313F10)
#define MONO_NET_CFDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x193141D0)
