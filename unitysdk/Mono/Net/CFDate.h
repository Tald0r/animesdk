...
#define MONO_NET_CFDATE_CFDATECREATE_OFFSET UNITYSDK_OFFSET(0x1908B300)
#define MONO_NET_CFDATE_CREATE_OFFSET UNITYSDK_OFFSET(0x1908B390)
#define MONO_NET_CFDATE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1908B510)
#define MONO_NET_CFDATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1908B4C0)
#define MONO_NET_CFDATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1908B290)
#define MONO_NET_CFDATE_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1908B4B0)
#define MONO_NET_CFDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1908B200)
