...
#define MONO_NET_CFDATE_CFDATECREATE_OFFSET UNITYSDK_OFFSET(0x19447A50)
#define MONO_NET_CFDATE_CREATE_OFFSET UNITYSDK_OFFSET(0x19447AE0)
#define MONO_NET_CFDATE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x19447C60)
#define MONO_NET_CFDATE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19447C10)
#define MONO_NET_CFDATE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x194479E0)
#define MONO_NET_CFDATE_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x19447C00)
#define MONO_NET_CFDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19447950)
