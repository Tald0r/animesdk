...
#define MONO_NET_SECURITY_NOREFLECTIONHELPER_CREATEHTTPLISTENER_OFFSET UNITYSDK_OFFSET(0x187C5120)
#define MONO_NET_SECURITY_NOREFLECTIONHELPER_CREATEHTTPSREQUEST_OFFSET UNITYSDK_OFFSET(0x187C5070)
#define MONO_NET_SECURITY_NOREFLECTIONHELPER_GETDEFAULTVALIDATOR_OFFSET UNITYSDK_OFFSET(0x187C4DA0)
#define MONO_NET_SECURITY_NOREFLECTIONHELPER_GETINTERNALVALIDATOR_OFFSET UNITYSDK_OFFSET(0x187C4BF0)
#define MONO_NET_SECURITY_NOREFLECTIONHELPER_GETMONOSSLSTREAM_1_OFFSET UNITYSDK_OFFSET(0x187C5290)
#define MONO_NET_SECURITY_NOREFLECTIONHELPER_GETMONOSSLSTREAM_OFFSET UNITYSDK_OFFSET(0x187C5210)
#define MONO_NET_SECURITY_NOREFLECTIONHELPER_GETPROVIDER_1_OFFSET UNITYSDK_OFFSET(0x187C5390)
#define MONO_NET_SECURITY_NOREFLECTIONHELPER_GETPROVIDER_OFFSET UNITYSDK_OFFSET(0x187C4E70)
#define MONO_NET_SECURITY_NOREFLECTIONHELPER_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x187C4ED0)
#define MONO_NET_SECURITY_NOREFLECTIONHELPER_INITIALIZE_1_OFFSET UNITYSDK_OFFSET(0x187C4FD0)
#define MONO_NET_SECURITY_NOREFLECTIONHELPER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x187C4F30)
#define MONO_NET_SECURITY_NOREFLECTIONHELPER_ISPROVIDERSUPPORTED_OFFSET UNITYSDK_OFFSET(0x187C5330)
