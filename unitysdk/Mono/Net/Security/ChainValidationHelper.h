...
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_CLONEWITHCALLBACKWRAPPER_OFFSET UNITYSDK_OFFSET(0x1A32DE30)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_CREATE_OFFSET UNITYSDK_OFFSET(0x1A32E230)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_DEFAULTSELECTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A32E300)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GETDEFAULTVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1A32DD40)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GETINTERNALVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1A32D950)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GET_HASCERTIFICATESELECTIONCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A32E360)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GET_PROVIDER_OFFSET UNITYSDK_OFFSET(0x1A32E340)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x1A32E350)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_INVOKECALLBACK_OFFSET UNITYSDK_OFFSET(0x1A32E100)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_INVOKESYSTEMVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1A32EFF0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_SELECTCLIENTCERTIFICATE_1_OFFSET UNITYSDK_OFFSET(0x1A32E3B0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_SELECTCLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1A32E370)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECERTIFICATE_1_OFFSET UNITYSDK_OFFSET(0x1A32E920)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1A32E740)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECHAIN_1_OFFSET UNITYSDK_OFFSET(0x1A32EB10)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECHAIN_OFFSET UNITYSDK_OFFSET(0x1A32E630)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER_VALIDATECLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1A32E3D0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A32D9E0)
#define MONO_NET_SECURITY_CHAINVALIDATIONHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A32DFB0)
