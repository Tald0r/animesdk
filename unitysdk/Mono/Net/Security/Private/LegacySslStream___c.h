...
#define MONO_NET_SECURITY_PRIVATE_LEGACYSSLSTREAM___C__AUTHENTICATEASCLIENTASYNC_B__79_0_OFFSET UNITYSDK_OFFSET(0x19314FE0)
#define MONO_NET_SECURITY_PRIVATE_LEGACYSSLSTREAM___C__AUTHENTICATEASSERVERASYNC_B__81_0_OFFSET UNITYSDK_OFFSET(0x19315090)
#define MONO_NET_SECURITY_PRIVATE_LEGACYSSLSTREAM___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19314F90)
#define MONO_NET_SECURITY_PRIVATE_LEGACYSSLSTREAM___C__CTOR_OFFSET UNITYSDK_OFFSET(0x19314FD0)
