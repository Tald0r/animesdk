...
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_INTERNALTOMONO_1_OFFSET UNITYSDK_OFFSET(0x191AA920)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_INTERNALTOMONO_OFFSET UNITYSDK_OFFSET(0x191AA800)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_INTERNALTOPUBLIC_OFFSET UNITYSDK_OFFSET(0x191AA890)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_MONOTOINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x191AAB60)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_MONOTOINTERNAL_OFFSET UNITYSDK_OFFSET(0x191AAAD0)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_MONOTOPUBLIC_1_OFFSET UNITYSDK_OFFSET(0x191AAA40)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_MONOTOPUBLIC_OFFSET UNITYSDK_OFFSET(0x191AA9B0)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_PUBLICTOMONO_1_OFFSET UNITYSDK_OFFSET(0x191AA770)
#define MONO_NET_SECURITY_PRIVATE_CALLBACKHELPERS_PUBLICTOMONO_OFFSET UNITYSDK_OFFSET(0x191AA6E0)
