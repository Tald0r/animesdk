...
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_BUILDX509CHAIN_OFFSET UNITYSDK_OFFSET(0x18B88970)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CHECKCERTIFICATEUSAGE_OFFSET UNITYSDK_OFFSET(0x18B88B10)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CHECKDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x18B89B30)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CHECKSERVERIDENTITY_OFFSET UNITYSDK_OFFSET(0x18B88F30)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CHECKUSAGE_OFFSET UNITYSDK_OFFSET(0x18B88980)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_CREATEX509CHAIN_OFFSET UNITYSDK_OFFSET(0x18B88830)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_EVALUATESYSTEM_OFFSET UNITYSDK_OFFSET(0x18B892C0)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_EVALUATE_OFFSET UNITYSDK_OFFSET(0x18B89400)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_MATCH_OFFSET UNITYSDK_OFFSET(0x18B89900)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR_NEEDSCHAIN_OFFSET UNITYSDK_OFFSET(0x18B894F0)
#define MONO_NET_SECURITY_SYSTEMCERTIFICATEVALIDATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x18B887F0)
