...
#define MONO_NET_SECURITY_ASYNCSHUTDOWNREQUEST_RUN_OFFSET UNITYSDK_OFFSET(0x18B54910)
#define MONO_NET_SECURITY_ASYNCSHUTDOWNREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x18B548E0)
