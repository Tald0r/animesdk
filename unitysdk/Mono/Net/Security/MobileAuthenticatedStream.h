...
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASCLIENTASYNC_1_OFFSET UNITYSDK_OFFSET(0x19368490)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASCLIENTASYNC_OFFSET UNITYSDK_OFFSET(0x193682D0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASCLIENT_1_OFFSET UNITYSDK_OFFSET(0x19367730)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x19367690)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASSERVERASYNC_1_OFFSET UNITYSDK_OFFSET(0x19368680)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASSERVERASYNC_OFFSET UNITYSDK_OFFSET(0x19368660)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASSERVER_1_OFFSET UNITYSDK_OFFSET(0x19367E50)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_AUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x19367E30)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINAUTHENTICATEASCLIENT_1_OFFSET UNITYSDK_OFFSET(0x19367BD0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINAUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x19367B10)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINAUTHENTICATEASSERVER_1_OFFSET UNITYSDK_OFFSET(0x19368060)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINAUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x19368030)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINREAD_OFFSET UNITYSDK_OFFSET(0x19368B00)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_BEGINWRITE_OFFSET UNITYSDK_OFFSET(0x19368D70)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_CHECKTHROW_OFFSET UNITYSDK_OFFSET(0x19367140)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_DEBUG_OFFSET UNITYSDK_OFFSET(0x19369770)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1936A600)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_ENDAUTHENTICATEASCLIENT_OFFSET UNITYSDK_OFFSET(0x19367DB0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_ENDAUTHENTICATEASSERVER_OFFSET UNITYSDK_OFFSET(0x19368250)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_ENDREAD_OFFSET UNITYSDK_OFFSET(0x19368D00)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_ENDWRITE_OFFSET UNITYSDK_OFFSET(0x19368F70)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1936A940)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GETCONNECTIONINFO_OFFSET UNITYSDK_OFFSET(0x1936ACF0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GETIOEXCEPTION_OFFSET UNITYSDK_OFFSET(0x19367510)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GETSSPIEXCEPTION_OFFSET UNITYSDK_OFFSET(0x193673D0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_AUTHENTICATEDSTREAM_OFFSET UNITYSDK_OFFSET(0x19368AF0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1936AE90)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1936B0D0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CANTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1936AF90)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1936AFC0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CHECKCERTREVOCATIONSTATUS_OFFSET UNITYSDK_OFFSET(0x1936B810)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CIPHERALGORITHM_OFFSET UNITYSDK_OFFSET(0x1936B410)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_CIPHERSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1936B720)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_DEFAULTPROTOCOLS_OFFSET UNITYSDK_OFFSET(0x19367680)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_HASCONTEXT_OFFSET UNITYSDK_OFFSET(0x19367130)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_HASHALGORITHM_OFFSET UNITYSDK_OFFSET(0x1936B510)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_HASHSTRENGTH_OFFSET UNITYSDK_OFFSET(0x1936B770)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_INTERNALLOCALCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1936ABE0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x193672F0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISENCRYPTED_OFFSET UNITYSDK_OFFSET(0x1936B190)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISMUTUALLYAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x1936A440)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISSERVER_OFFSET UNITYSDK_OFFSET(0x1936A3E0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_ISSIGNED_OFFSET UNITYSDK_OFFSET(0x1936B270)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_KEYEXCHANGEALGORITHM_OFFSET UNITYSDK_OFFSET(0x1936B620)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_KEYEXCHANGESTRENGTH_OFFSET UNITYSDK_OFFSET(0x1936B7C0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1936B0E0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_LOCALCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1936AB20)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1936B110)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_PROVIDER_OFFSET UNITYSDK_OFFSET(0x19367120)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1936B350)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_REMOTECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1936AA50)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_SETTINGS_OFFSET UNITYSDK_OFFSET(0x19367110)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_SSLPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1936A970)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_SSLSTREAM_OFFSET UNITYSDK_OFFSET(0x19367100)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_TRANSPORTCONTEXT_OFFSET UNITYSDK_OFFSET(0x1936AE40)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_GET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1936B3B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INNERREAD_OFFSET UNITYSDK_OFFSET(0x19369CE0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INNERWRITE_OFFSET UNITYSDK_OFFSET(0x19369E00)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INTERNALREAD_1_OFFSET UNITYSDK_OFFSET(0x19369890)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INTERNALREAD_OFFSET UNITYSDK_OFFSET(0x19369780)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INTERNALWRITE_1_OFFSET UNITYSDK_OFFSET(0x19369B40)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_INTERNALWRITE_OFFSET UNITYSDK_OFFSET(0x19369A40)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSAUTHENTICATION_OFFSET UNITYSDK_OFFSET(0x19367910)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x19369F80)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSREAD_OFFSET UNITYSDK_OFFSET(0x1936A130)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSSHUTDOWN_OFFSET UNITYSDK_OFFSET(0x1936A310)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_PROCESSWRITE_OFFSET UNITYSDK_OFFSET(0x1936A220)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_READASYNC_OFFSET UNITYSDK_OFFSET(0x193693F0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x19368FF0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1936ADC0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SETEXCEPTION_OFFSET UNITYSDK_OFFSET(0x19367650)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1936AE10)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1936B140)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SET_READTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1936B380)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SET_WRITETIMEOUT_OFFSET UNITYSDK_OFFSET(0x1936B3E0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_SHUTDOWNASYNC_OFFSET UNITYSDK_OFFSET(0x19368860)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_STARTOPERATION_OFFSET UNITYSDK_OFFSET(0x193689E0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_WRITEASYNC_OFFSET UNITYSDK_OFFSET(0x193695B0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_WRITE_1_OFFSET UNITYSDK_OFFSET(0x19369200)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x193691E0)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__CCTOR_OFFSET UNITYSDK_OFFSET(0x1936B860)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x19366E30)
#define MONO_NET_SECURITY_MOBILEAUTHENTICATEDSTREAM__INNERWRITE_B__67_0_OFFSET UNITYSDK_OFFSET(0x1936B8A0)
...
namespace Mono::Net::Security
{
	...
	public:
		...
		::Mono::Net::Security::AsyncProtocolRequest* asyncReadRequest; // 0x40
		::Mono::Security::Interface::MonoTlsSettings* _Settings_k__BackingField; // 0x48
		::Mono::Net::Security::BufferOffsetSize2* writeBuffer; // 0x50
		...
		::Mono::Net::Security::AsyncProtocolRequest* asyncWriteRequest; // 0x78
