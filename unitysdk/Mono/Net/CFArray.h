...
#define MONO_NET_CFARRAY_CFARRAYCREATE_OFFSET UNITYSDK_OFFSET(0x19B12620)
#define MONO_NET_CFARRAY_CFARRAYGETCOUNT_OFFSET UNITYSDK_OFFSET(0x19B12F90)
#define MONO_NET_CFARRAY_CFARRAYGETVALUEATINDEX_OFFSET UNITYSDK_OFFSET(0x19B130F0)
#define MONO_NET_CFARRAY_CREATEARRAY_1_OFFSET UNITYSDK_OFFSET(0x19B12F20)
#define MONO_NET_CFARRAY_CREATEARRAY_OFFSET UNITYSDK_OFFSET(0x19B12D60)
#define MONO_NET_CFARRAY_CREATE_1_OFFSET UNITYSDK_OFFSET(0x19B12960)
#define MONO_NET_CFARRAY_CREATE_OFFSET UNITYSDK_OFFSET(0x19B12C20)
#define MONO_NET_CFARRAY_FROMNATIVEOBJECTS_OFFSET UNITYSDK_OFFSET(0x19B128F0)
#define MONO_NET_CFARRAY_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x19B13010)
#define MONO_NET_CFARRAY_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19B13180)
#define MONO_NET_CFARRAY__CCTOR_OFFSET UNITYSDK_OFFSET(0x19B126C0)
#define MONO_NET_CFARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x19B12590)
