...
#define MONO_NET_CFMUTABLEDICTIONARY_CFDICTIONARYCREATEMUTABLE_OFFSET UNITYSDK_OFFSET(0x19D1AAF0)
#define MONO_NET_CFMUTABLEDICTIONARY_CFDICTIONARYSETVALUE_OFFSET UNITYSDK_OFFSET(0x19D1A920)
#define MONO_NET_CFMUTABLEDICTIONARY_CREATE_OFFSET UNITYSDK_OFFSET(0x19D1A9B0)
#define MONO_NET_CFMUTABLEDICTIONARY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x19D1A890)
#define MONO_NET_CFMUTABLEDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x19D1A7A0)
