...
#define MONO_NET_CFMUTABLEDICTIONARY_CFDICTIONARYCREATEMUTABLE_OFFSET UNITYSDK_OFFSET(0x197DB7C0)
#define MONO_NET_CFMUTABLEDICTIONARY_CFDICTIONARYSETVALUE_OFFSET UNITYSDK_OFFSET(0x197DB5F0)
#define MONO_NET_CFMUTABLEDICTIONARY_CREATE_OFFSET UNITYSDK_OFFSET(0x197DB680)
#define MONO_NET_CFMUTABLEDICTIONARY_SETVALUE_OFFSET UNITYSDK_OFFSET(0x197DB560)
#define MONO_NET_CFMUTABLEDICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x197DB470)
