...
#define MONO_NET_CFSTRING_ASSTRING_OFFSET UNITYSDK_OFFSET(0x191BFC30)
#define MONO_NET_CFSTRING_CFSTRINGCREATEWITHCHARACTERS_OFFSET UNITYSDK_OFFSET(0x191BF880)
#define MONO_NET_CFSTRING_CFSTRINGGETCHARACTERSPTR_OFFSET UNITYSDK_OFFSET(0x191BFB10)
#define MONO_NET_CFSTRING_CFSTRINGGETCHARACTERS_OFFSET UNITYSDK_OFFSET(0x191BFB90)
#define MONO_NET_CFSTRING_CFSTRINGGETLENGTH_OFFSET UNITYSDK_OFFSET(0x191BFA00)
#define MONO_NET_CFSTRING_CREATE_OFFSET UNITYSDK_OFFSET(0x191BF910)
#define MONO_NET_CFSTRING_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x191BFA80)
#define MONO_NET_CFSTRING_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x191BFEA0)
#define MONO_NET_CFSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x191BFE60)
#define MONO_NET_CFSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x191BFE30)
#define MONO_NET_CFSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x191BF7F0)
