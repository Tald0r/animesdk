...
#define MONO_NET_CFSTRING_ASSTRING_OFFSET UNITYSDK_OFFSET(0x195BBEE0)
#define MONO_NET_CFSTRING_CFSTRINGCREATEWITHCHARACTERS_OFFSET UNITYSDK_OFFSET(0x195BBB30)
#define MONO_NET_CFSTRING_CFSTRINGGETCHARACTERSPTR_OFFSET UNITYSDK_OFFSET(0x195BBDC0)
#define MONO_NET_CFSTRING_CFSTRINGGETCHARACTERS_OFFSET UNITYSDK_OFFSET(0x195BBE40)
#define MONO_NET_CFSTRING_CFSTRINGGETLENGTH_OFFSET UNITYSDK_OFFSET(0x195BBCB0)
#define MONO_NET_CFSTRING_CREATE_OFFSET UNITYSDK_OFFSET(0x195BBBC0)
#define MONO_NET_CFSTRING_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x195BBD30)
#define MONO_NET_CFSTRING_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x195BC150)
#define MONO_NET_CFSTRING_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x195BC110)
#define MONO_NET_CFSTRING_TOSTRING_OFFSET UNITYSDK_OFFSET(0x195BC0E0)
#define MONO_NET_CFSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x195BBAA0)
