...
#define MONO_NET_CFNUMBER_ASBOOL_OFFSET UNITYSDK_OFFSET(0x18FA7D80)
#define MONO_NET_CFNUMBER_ASINT32_OFFSET UNITYSDK_OFFSET(0x18FA7F70)
#define MONO_NET_CFNUMBER_CFNUMBERCREATE_OFFSET UNITYSDK_OFFSET(0x18FA8010)
#define MONO_NET_CFNUMBER_CFNUMBERGETVALUE_1_OFFSET UNITYSDK_OFFSET(0x18FA7ED0)
#define MONO_NET_CFNUMBER_CFNUMBERGETVALUE_OFFSET UNITYSDK_OFFSET(0x18FA7CE0)
#define MONO_NET_CFNUMBER_FROMINT32_OFFSET UNITYSDK_OFFSET(0x18FA80A0)
#define MONO_NET_CFNUMBER_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x18FA8170)
#define MONO_NET_CFNUMBER_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x18FA7E20)
#define MONO_NET_CFNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x18FA7C50)
