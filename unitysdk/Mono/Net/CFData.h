...
#define MONO_NET_CFDATA_CFDATACREATE_OFFSET UNITYSDK_OFFSET(0x19002E90)
#define MONO_NET_CFDATA_CFDATAGETBYTEPTR_OFFSET UNITYSDK_OFFSET(0x190031D0)
#define MONO_NET_CFDATA_CFDATAGETLENGTH_OFFSET UNITYSDK_OFFSET(0x19003150)
#define MONO_NET_CFDATA_FROMDATA_1_OFFSET UNITYSDK_OFFSET(0x19003000)
#define MONO_NET_CFDATA_FROMDATA_OFFSET UNITYSDK_OFFSET(0x19002F20)
#define MONO_NET_CFDATA_GET_BYTES_OFFSET UNITYSDK_OFFSET(0x19003250)
#define MONO_NET_CFDATA_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x190032D0)
#define MONO_NET_CFDATA_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x190030D0)
#define MONO_NET_CFDATA_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19003430)
#define MONO_NET_CFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19002E00)
