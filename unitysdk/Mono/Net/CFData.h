...
#define MONO_NET_CFDATA_CFDATACREATE_OFFSET UNITYSDK_OFFSET(0x19418CF0)
#define MONO_NET_CFDATA_CFDATAGETBYTEPTR_OFFSET UNITYSDK_OFFSET(0x19419030)
#define MONO_NET_CFDATA_CFDATAGETLENGTH_OFFSET UNITYSDK_OFFSET(0x19418FB0)
#define MONO_NET_CFDATA_FROMDATA_1_OFFSET UNITYSDK_OFFSET(0x19418E60)
#define MONO_NET_CFDATA_FROMDATA_OFFSET UNITYSDK_OFFSET(0x19418D80)
#define MONO_NET_CFDATA_GET_BYTES_OFFSET UNITYSDK_OFFSET(0x194190B0)
#define MONO_NET_CFDATA_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x19419130)
#define MONO_NET_CFDATA_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x19418F30)
#define MONO_NET_CFDATA_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x19419290)
#define MONO_NET_CFDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x19418C60)
