...
#define MONO_SECURITY_PKCS7_ENCRYPTEDDATA_GETASN1_OFFSET UNITYSDK_OFFSET(0x1B366510)
#define MONO_SECURITY_PKCS7_ENCRYPTEDDATA_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1B366630)
#define MONO_SECURITY_PKCS7_ENCRYPTEDDATA_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1B366500)
#define MONO_SECURITY_PKCS7_ENCRYPTEDDATA_GET_CONTENTINFO_OFFSET UNITYSDK_OFFSET(0x1B366520)
#define MONO_SECURITY_PKCS7_ENCRYPTEDDATA_GET_ENCRYPTEDCONTENT_OFFSET UNITYSDK_OFFSET(0x1B366540)
#define MONO_SECURITY_PKCS7_ENCRYPTEDDATA_GET_ENCRYPTIONALGORITHM_OFFSET UNITYSDK_OFFSET(0x1B366530)
#define MONO_SECURITY_PKCS7_ENCRYPTEDDATA_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B366610)
#define MONO_SECURITY_PKCS7_ENCRYPTEDDATA_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B366620)
#define MONO_SECURITY_PKCS7_ENCRYPTEDDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B366110)
#define MONO_SECURITY_PKCS7_ENCRYPTEDDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B366170)
#define MONO_SECURITY_PKCS7_ENCRYPTEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B366100)
