...
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GETASN1_OFFSET UNITYSDK_OFFSET(0x1AA158F0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1AA16F30)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1AA158E0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1AA16880)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_CONTENTINFO_OFFSET UNITYSDK_OFFSET(0x1AA16890)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_CRLS_OFFSET UNITYSDK_OFFSET(0x1AA168A0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_HASHNAME_OFFSET UNITYSDK_OFFSET(0x1AA168B0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_SIGNERINFO_OFFSET UNITYSDK_OFFSET(0x1AA168C0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_USEAUTHENTICATEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AA168F0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AA168D0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_OIDTONAME_OFFSET UNITYSDK_OFFSET(0x1AA15730)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_SET_HASHNAME_OFFSET UNITYSDK_OFFSET(0x1AA158C0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_SET_USEAUTHENTICATEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AA16900)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AA168E0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1AA16910)
#define MONO_SECURITY_PKCS7_SIGNEDDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA14F70)
#define MONO_SECURITY_PKCS7_SIGNEDDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AA14FD0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA14DB0)
...
namespace Mono::Security
{
	...
	public:
		...
		::System::Collections::ArrayList* crls; // 0x20
