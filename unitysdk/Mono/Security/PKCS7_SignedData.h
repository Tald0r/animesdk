...
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GETASN1_OFFSET UNITYSDK_OFFSET(0x1B005620)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1B006C60)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1B005610)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1B0065B0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_CONTENTINFO_OFFSET UNITYSDK_OFFSET(0x1B0065C0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_CRLS_OFFSET UNITYSDK_OFFSET(0x1B0065D0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_HASHNAME_OFFSET UNITYSDK_OFFSET(0x1B0065E0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_SIGNERINFO_OFFSET UNITYSDK_OFFSET(0x1B0065F0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_USEAUTHENTICATEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B006620)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B006600)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_OIDTONAME_OFFSET UNITYSDK_OFFSET(0x1B005460)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_SET_HASHNAME_OFFSET UNITYSDK_OFFSET(0x1B0055F0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_SET_USEAUTHENTICATEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B006630)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B006610)
#define MONO_SECURITY_PKCS7_SIGNEDDATA_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B006640)
#define MONO_SECURITY_PKCS7_SIGNEDDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B004CA0)
#define MONO_SECURITY_PKCS7_SIGNEDDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B004D00)
#define MONO_SECURITY_PKCS7_SIGNEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B004AD0)
...
namespace Mono::Security
{
	...
	{
	public:
		::Mono::Security::PKCS7_ContentInfo* contentInfo; // 0x10
		::Mono::Security::PKCS7_SignerInfo* signerInfo; // 0x18
		::System::String* hashAlgorithm; // 0x20
		::System::Collections::ArrayList* crls; // 0x28
