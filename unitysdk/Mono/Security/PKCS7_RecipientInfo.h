...
#define MONO_SECURITY_PKCS7_RECIPIENTINFO_GET_ISSUER_OFFSET UNITYSDK_OFFSET(0x1B6C96C0)
#define MONO_SECURITY_PKCS7_RECIPIENTINFO_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1B6C9520)
#define MONO_SECURITY_PKCS7_RECIPIENTINFO_GET_OID_OFFSET UNITYSDK_OFFSET(0x1B6C9510)
#define MONO_SECURITY_PKCS7_RECIPIENTINFO_GET_SERIAL_OFFSET UNITYSDK_OFFSET(0x1B6C96D0)
#define MONO_SECURITY_PKCS7_RECIPIENTINFO_GET_SUBJECTKEYIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B6C95F0)
#define MONO_SECURITY_PKCS7_RECIPIENTINFO_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B6C97A0)
#define MONO_SECURITY_PKCS7_RECIPIENTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6C9310)
#define MONO_SECURITY_PKCS7_RECIPIENTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C9300)
...
namespace Mono::Security
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* _ski; // 0x18
