...
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_CORE_1_OFFSET UNITYSDK_OFFSET(0x1B0BE7E0)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_CORE_OFFSET UNITYSDK_OFFSET(0x1B0BE7C0)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B0BE720)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_FINAL_OFFSET UNITYSDK_OFFSET(0x1B0BEA50)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0BE790)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0BE660)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BE550)
