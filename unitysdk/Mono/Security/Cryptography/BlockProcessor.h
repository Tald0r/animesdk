...
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_CORE_1_OFFSET UNITYSDK_OFFSET(0x1B6CC8B0)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_CORE_OFFSET UNITYSDK_OFFSET(0x1B6CC890)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B6CC7F0)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_FINAL_OFFSET UNITYSDK_OFFSET(0x1B6CCB20)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6CC860)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6CC730)
#define MONO_SECURITY_CRYPTOGRAPHY_BLOCKPROCESSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CC620)
