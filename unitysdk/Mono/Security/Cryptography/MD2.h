...
#define MONO_SECURITY_CRYPTOGRAPHY_MD2_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1B142950)
#define MONO_SECURITY_CRYPTOGRAPHY_MD2_CREATE_OFFSET UNITYSDK_OFFSET(0x1B142900)
#define MONO_SECURITY_CRYPTOGRAPHY_MD2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1428F0)
