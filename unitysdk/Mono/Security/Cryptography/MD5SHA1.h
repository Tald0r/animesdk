...
#define MONO_SECURITY_CRYPTOGRAPHY_MD5SHA1_CREATESIGNATURE_OFFSET UNITYSDK_OFFSET(0x1AFEE1D0)
#define MONO_SECURITY_CRYPTOGRAPHY_MD5SHA1_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1AFEE150)
#define MONO_SECURITY_CRYPTOGRAPHY_MD5SHA1_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1AFEE050)
#define MONO_SECURITY_CRYPTOGRAPHY_MD5SHA1_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AFEE000)
#define MONO_SECURITY_CRYPTOGRAPHY_MD5SHA1_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1AFEE2F0)
#define MONO_SECURITY_CRYPTOGRAPHY_MD5SHA1__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFEDF10)
