...
#define MONO_SECURITY_CRYPTOGRAPHY_SHACONSTANTS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6C9270)
#define MONO_SECURITY_CRYPTOGRAPHY_SHACONSTANTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C9260)
