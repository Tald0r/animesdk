...
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1B5F2830)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1B5F30D0)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1B5F2F60)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_INITIALIZEPAD_OFFSET UNITYSDK_OFFSET(0x1B5F2A70)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B5F2DD0)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1B5F2900)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B5F2E10)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F2C10)
...
namespace Mono::Security::Cryptography
{
	...
	public:
		...
		::System::Security::Cryptography::HashAlgorithm* hash; // 0x38
		::Il2CppArray<::System::Byte>* outerPad; // 0x40
