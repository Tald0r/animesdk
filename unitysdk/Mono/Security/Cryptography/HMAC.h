...
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1AFDFB60)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1AFE0400)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1AFE0290)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_INITIALIZEPAD_OFFSET UNITYSDK_OFFSET(0x1AFDFDA0)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AFE0100)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1AFDFC30)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFE0140)
#define MONO_SECURITY_CRYPTOGRAPHY_HMAC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFDFF40)
