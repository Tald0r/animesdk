...
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_ADDLENGTH_OFFSET UNITYSDK_OFFSET(0x1B6ED0D0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_CH_OFFSET UNITYSDK_OFFSET(0x1B6EC680)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1B6EC720)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1B6ECDB0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6EC570)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_MAJ_OFFSET UNITYSDK_OFFSET(0x1B6EC690)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_PROCESSBLOCK_OFFSET UNITYSDK_OFFSET(0x1B6EC800)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_PROCESSFINALBLOCK_OFFSET UNITYSDK_OFFSET(0x1B6ECF00)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_RO0_OFFSET UNITYSDK_OFFSET(0x1B6EC6A0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_RO1_OFFSET UNITYSDK_OFFSET(0x1B6EC6C0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_SIG0_OFFSET UNITYSDK_OFFSET(0x1B6EC6E0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_SIG1_OFFSET UNITYSDK_OFFSET(0x1B6EC700)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EC510)
