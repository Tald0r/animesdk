...
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_ADDLENGTH_OFFSET UNITYSDK_OFFSET(0x1B0DC550)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_CH_OFFSET UNITYSDK_OFFSET(0x1B0DBB00)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1B0DBBA0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1B0DC230)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0DB9F0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_MAJ_OFFSET UNITYSDK_OFFSET(0x1B0DBB10)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_PROCESSBLOCK_OFFSET UNITYSDK_OFFSET(0x1B0DBC80)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_PROCESSFINALBLOCK_OFFSET UNITYSDK_OFFSET(0x1B0DC380)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_RO0_OFFSET UNITYSDK_OFFSET(0x1B0DBB20)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_RO1_OFFSET UNITYSDK_OFFSET(0x1B0DBB40)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_SIG0_OFFSET UNITYSDK_OFFSET(0x1B0DBB60)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED_SIG1_OFFSET UNITYSDK_OFFSET(0x1B0DBB80)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224MANAGED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0DB990)
