...
#define MONO_SECURITY_CRYPTOGRAPHY_KEYBUILDER_GET_RNG_OFFSET UNITYSDK_OFFSET(0x1B45F640)
#define MONO_SECURITY_CRYPTOGRAPHY_KEYBUILDER_IV_OFFSET UNITYSDK_OFFSET(0x1B45F770)
#define MONO_SECURITY_CRYPTOGRAPHY_KEYBUILDER_KEY_OFFSET UNITYSDK_OFFSET(0x1B45F6C0)
#define MONO_SECURITY_CRYPTOGRAPHY_KEYBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B45F630)
