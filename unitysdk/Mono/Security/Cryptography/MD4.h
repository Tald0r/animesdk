...
#define MONO_SECURITY_CRYPTOGRAPHY_MD4_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1B142AB0)
#define MONO_SECURITY_CRYPTOGRAPHY_MD4_CREATE_OFFSET UNITYSDK_OFFSET(0x1B1429F0)
#define MONO_SECURITY_CRYPTOGRAPHY_MD4__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1429E0)
