...
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_CREATE_1_OFFSET UNITYSDK_OFFSET(0x19EEC6B0)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_CREATE_OFFSET UNITYSDK_OFFSET(0x19EEC610)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_FROMXMLSTRING_OFFSET UNITYSDK_OFFSET(0x19EEC7A0)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_GETNAMEDPARAM_OFFSET UNITYSDK_OFFSET(0x19EEC730)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_TOXMLSTRING_OFFSET UNITYSDK_OFFSET(0x19EECDE0)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN__CTOR_OFFSET UNITYSDK_OFFSET(0x19EED140)
