...
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1A4EBBD0)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4EBB30)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_FROMXMLSTRING_OFFSET UNITYSDK_OFFSET(0x1A4EBCC0)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_GETNAMEDPARAM_OFFSET UNITYSDK_OFFSET(0x1A4EBC50)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN_TOXMLSTRING_OFFSET UNITYSDK_OFFSET(0x1A4EC310)
#define MONO_SECURITY_CRYPTOGRAPHY_DIFFIEHELLMAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4EC670)
