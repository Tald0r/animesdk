...
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A4F9EF0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_CREATEFROMNAME_OFFSET UNITYSDK_OFFSET(0x1A4FB700)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_CREATEFROMOID_OFFSET UNITYSDK_OFFSET(0x1A4FC240)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_DECRYPT_OAEP_OFFSET UNITYSDK_OFFSET(0x1A4FA8D0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_DECRYPT_V15_OFFSET UNITYSDK_OFFSET(0x1A4FAE50)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_ENCODE_V15_OFFSET UNITYSDK_OFFSET(0x1A4FB130)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_ENCRYPT_OAEP_OFFSET UNITYSDK_OFFSET(0x1A4FA420)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_ENCRYPT_V15_OFFSET UNITYSDK_OFFSET(0x1A4FAC50)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_GETEMPTYHASH_OFFSET UNITYSDK_OFFSET(0x1A4FA010)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_HASHNAMEFROMOID_OFFSET UNITYSDK_OFFSET(0x1A4FBFD0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_I2OSP_1_OFFSET UNITYSDK_OFFSET(0x1A4FA260)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_I2OSP_OFFSET UNITYSDK_OFFSET(0x1A4FA1B0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_MGF1_OFFSET UNITYSDK_OFFSET(0x1A4FA710)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_OS2IP_OFFSET UNITYSDK_OFFSET(0x1A4FA2C0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_RSADP_OFFSET UNITYSDK_OFFSET(0x1A4FA390)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_RSAEP_OFFSET UNITYSDK_OFFSET(0x1A4FA360)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_RSASP1_OFFSET UNITYSDK_OFFSET(0x1A4FA3C0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_RSAVP1_OFFSET UNITYSDK_OFFSET(0x1A4FA3F0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_SIGN_V15_1_OFFSET UNITYSDK_OFFSET(0x1A4FB5A0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_SIGN_V15_OFFSET UNITYSDK_OFFSET(0x1A4FB040)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_VERIFY_V15_1_OFFSET UNITYSDK_OFFSET(0x1A4FBE60)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_VERIFY_V15_2_OFFSET UNITYSDK_OFFSET(0x1A4FBB90)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_VERIFY_V15_OFFSET UNITYSDK_OFFSET(0x1A4FBB10)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1_XOR_OFFSET UNITYSDK_OFFSET(0x1A4F9F60)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4FC2A0)
#define MONO_SECURITY_CRYPTOGRAPHY_PKCS1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F9EE0)
