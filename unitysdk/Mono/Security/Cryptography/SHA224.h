...
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1AAAEEA0)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224_CREATE_OFFSET UNITYSDK_OFFSET(0x1AAAED90)
#define MONO_SECURITY_CRYPTOGRAPHY_SHA224__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAAED80)
