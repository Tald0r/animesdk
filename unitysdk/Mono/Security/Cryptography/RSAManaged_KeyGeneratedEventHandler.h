...
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_KEYGENERATEDEVENTHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA9BE60)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_KEYGENERATEDEVENTHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA9BEA0)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_KEYGENERATEDEVENTHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA9B8E0)
#define MONO_SECURITY_CRYPTOGRAPHY_RSAMANAGED_KEYGENERATEDEVENTHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9B8D0)
