...
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_CLIFLAGPOSITION_OFFSET UNITYSDK_OFFSET(0x1B463E60)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_CLIFLAG_OFFSET UNITYSDK_OFFSET(0x1B463E40)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_HASH_OFFSET UNITYSDK_OFFSET(0x1B463D80)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_METADATALENGTH_OFFSET UNITYSDK_OFFSET(0x1B463DE0)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_METADATAPOSITION_OFFSET UNITYSDK_OFFSET(0x1B463DC0)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_SIGNATURELENGTH_OFFSET UNITYSDK_OFFSET(0x1B463E20)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_SIGNATUREPOSITION_OFFSET UNITYSDK_OFFSET(0x1B463E00)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B463DA0)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_CLIFLAGPOSITION_OFFSET UNITYSDK_OFFSET(0x1B463E70)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_CLIFLAG_OFFSET UNITYSDK_OFFSET(0x1B463E50)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_HASH_OFFSET UNITYSDK_OFFSET(0x1B463D90)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_METADATALENGTH_OFFSET UNITYSDK_OFFSET(0x1B463DF0)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_METADATAPOSITION_OFFSET UNITYSDK_OFFSET(0x1B463DD0)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_SIGNATURELENGTH_OFFSET UNITYSDK_OFFSET(0x1B463E30)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_SIGNATUREPOSITION_OFFSET UNITYSDK_OFFSET(0x1B463E10)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE_SET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B463DB0)
#define MONO_SECURITY_STRONGNAME_STRONGNAMESIGNATURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B463E80)
...
namespace Mono::Security
{
	...
	public:
		...
		::System::UInt32 metadataLength; // 0x20
		::System::Byte cliFlag; // 0x24
		::System::UInt32 cliFlagPosition; // 0x28
		::System::UInt32 signatureLength; // 0x2C
		::System::UInt32 metadataPosition; // 0x30
		::System::UInt32 signaturePosition; // 0x34
