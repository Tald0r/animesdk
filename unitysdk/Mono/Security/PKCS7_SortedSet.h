...
#define MONO_SECURITY_PKCS7_SORTEDSET_COMPARE_OFFSET UNITYSDK_OFFSET(0x1AA9C220)
#define MONO_SECURITY_PKCS7_SORTEDSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9C3A0)
