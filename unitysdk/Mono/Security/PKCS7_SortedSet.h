...
#define MONO_SECURITY_PKCS7_SORTEDSET_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B0D8570)
#define MONO_SECURITY_PKCS7_SORTEDSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D86F0)
