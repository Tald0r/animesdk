...
#define MONO_SECURITY_X509_X509CHAIN_BUILD_OFFSET UNITYSDK_OFFSET(0x1AEA3950)
#define MONO_SECURITY_X509_X509CHAIN_FINDBYISSUERNAME_OFFSET UNITYSDK_OFFSET(0x1AEA36B0)
#define MONO_SECURITY_X509_X509CHAIN_FINDCERTIFICATEPARENT_OFFSET UNITYSDK_OFFSET(0x1AEA3FA0)
#define MONO_SECURITY_X509_X509CHAIN_FINDCERTIFICATEROOT_OFFSET UNITYSDK_OFFSET(0x1AEA4210)
#define MONO_SECURITY_X509_X509CHAIN_GET_CHAIN_OFFSET UNITYSDK_OFFSET(0x1AEA3580)
#define MONO_SECURITY_X509_X509CHAIN_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x1AEA3590)
#define MONO_SECURITY_X509_X509CHAIN_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x1AEA35A0)
#define MONO_SECURITY_X509_X509CHAIN_GET_TRUSTANCHORS_OFFSET UNITYSDK_OFFSET(0x1AEA35B0)
#define MONO_SECURITY_X509_X509CHAIN_ISPARENT_OFFSET UNITYSDK_OFFSET(0x1AEA4580)
#define MONO_SECURITY_X509_X509CHAIN_ISTRUSTED_OFFSET UNITYSDK_OFFSET(0x1AEA4870)
#define MONO_SECURITY_X509_X509CHAIN_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AEA46C0)
#define MONO_SECURITY_X509_X509CHAIN_LOADCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1AEA3690)
#define MONO_SECURITY_X509_X509CHAIN_LOADCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1AEA3670)
#define MONO_SECURITY_X509_X509CHAIN_RESET_OFFSET UNITYSDK_OFFSET(0x1AEA4750)
#define MONO_SECURITY_X509_X509CHAIN_SET_TRUSTANCHORS_OFFSET UNITYSDK_OFFSET(0x1AEA3660)
#define MONO_SECURITY_X509_X509CHAIN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEA3460)
#define MONO_SECURITY_X509_X509CHAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEA33E0)
...
namespace Mono::Security::X509
{
	...
	{
	public:
		::Mono::Security::X509::X509CertificateCollection* certs; // 0x10
