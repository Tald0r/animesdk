...
#define MONO_SECURITY_X509_X509BUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x1B149ED0)
#define MONO_SECURITY_X509_X509BUILDER_GETOID_OFFSET UNITYSDK_OFFSET(0x1B149AF0)
#define MONO_SECURITY_X509_X509BUILDER_GET_HASH_OFFSET UNITYSDK_OFFSET(0x1B149DA0)
#define MONO_SECURITY_X509_X509BUILDER_SET_HASH_OFFSET UNITYSDK_OFFSET(0x1B149DB0)
#define MONO_SECURITY_X509_X509BUILDER_SIGN_1_OFFSET UNITYSDK_OFFSET(0x1B14A0C0)
#define MONO_SECURITY_X509_X509BUILDER_SIGN_2_OFFSET UNITYSDK_OFFSET(0x1B14A240)
#define MONO_SECURITY_X509_X509BUILDER_SIGN_OFFSET UNITYSDK_OFFSET(0x1B149DD0)
#define MONO_SECURITY_X509_X509BUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B149AE0)
