...
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_ADDRANGE_1_OFFSET UNITYSDK_OFFSET(0x1A507380)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_ADDRANGE_OFFSET UNITYSDK_OFFSET(0x1A507230)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1A507130)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x1A507890)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1A5076C0)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A507A70)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1A507E30)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1A4EEB80)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A5075F0)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_INDEXOF_1_OFFSET UNITYSDK_OFFSET(0x1A5078B0)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A5076E0)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_INSERT_OFFSET UNITYSDK_OFFSET(0x1A507B40)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x1A507CD0)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A507C10)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A507DC0)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A506FB0)
#define MONO_SECURITY_X509_X509EXTENSIONCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A506F60)
