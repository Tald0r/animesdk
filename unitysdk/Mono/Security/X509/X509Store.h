...
#define MONO_SECURITY_X509_X509STORE_BUILDCERTIFICATESCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1AA17E60)
#define MONO_SECURITY_X509_X509STORE_BUILDCRLSCOLLECTION_OFFSET UNITYSDK_OFFSET(0x1AA181E0)
#define MONO_SECURITY_X509_X509STORE_CHECKSTORE_OFFSET UNITYSDK_OFFSET(0x1AA18F70)
#define MONO_SECURITY_X509_X509STORE_CLEARCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1AA185D0)
#define MONO_SECURITY_X509_X509STORE_CLEARCRLS_OFFSET UNITYSDK_OFFSET(0x1AA18660)
#define MONO_SECURITY_X509_X509STORE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AA18530)
#define MONO_SECURITY_X509_X509STORE_GETUNIQUENAMEWITHSERIAL_OFFSET UNITYSDK_OFFSET(0x1AA19270)
#define MONO_SECURITY_X509_X509STORE_GETUNIQUENAME_1_OFFSET UNITYSDK_OFFSET(0x1AA19780)
#define MONO_SECURITY_X509_X509STORE_GETUNIQUENAME_2_OFFSET UNITYSDK_OFFSET(0x1AA19D60)
#define MONO_SECURITY_X509_X509STORE_GETUNIQUENAME_3_OFFSET UNITYSDK_OFFSET(0x1AA19EB0)
#define MONO_SECURITY_X509_X509STORE_GETUNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1AA191F0)
#define MONO_SECURITY_X509_X509STORE_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1AA17E30)
#define MONO_SECURITY_X509_X509STORE_GET_CRLS_OFFSET UNITYSDK_OFFSET(0x1AA18160)
#define MONO_SECURITY_X509_X509STORE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AA184C0)
#define MONO_SECURITY_X509_X509STORE_IMPORTNEWFORMAT_OFFSET UNITYSDK_OFFSET(0x1AA190F0)
#define MONO_SECURITY_X509_X509STORE_IMPORT_1_OFFSET UNITYSDK_OFFSET(0x1AA19360)
#define MONO_SECURITY_X509_X509STORE_IMPORT_OFFSET UNITYSDK_OFFSET(0x1AA18690)
#define MONO_SECURITY_X509_X509STORE_LOADCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1AA19300)
#define MONO_SECURITY_X509_X509STORE_LOADCRL_OFFSET UNITYSDK_OFFSET(0x1AA1A1B0)
#define MONO_SECURITY_X509_X509STORE_LOAD_OFFSET UNITYSDK_OFFSET(0x1AA19FD0)
#define MONO_SECURITY_X509_X509STORE_REMOVENEWFORMAT_OFFSET UNITYSDK_OFFSET(0x1AA19AC0)
#define MONO_SECURITY_X509_X509STORE_REMOVE_1_OFFSET UNITYSDK_OFFSET(0x1AA19BC0)
#define MONO_SECURITY_X509_X509STORE_REMOVE_OFFSET UNITYSDK_OFFSET(0x1AA19800)
#define MONO_SECURITY_X509_X509STORE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA17E20)
...
namespace Mono::Security::X509
{
	...
	public:
		...
		::System::String* _storePath; // 0x18
		::Mono::Security::X509::X509CertificateCollection* _certificates; // 0x20
