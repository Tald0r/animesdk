...
#define MONO_SECURITY_X509_X509EXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1A506410)
#define MONO_SECURITY_X509_X509EXTENSION_ENCODE_OFFSET UNITYSDK_OFFSET(0x1A506420)
#define MONO_SECURITY_X509_X509EXTENSION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A506670)
#define MONO_SECURITY_X509_X509EXTENSION_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1A5067D0)
#define MONO_SECURITY_X509_X509EXTENSION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A5067F0)
#define MONO_SECURITY_X509_X509EXTENSION_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1A506430)
#define MONO_SECURITY_X509_X509EXTENSION_GET_CRITICAL_OFFSET UNITYSDK_OFFSET(0x1A506640)
#define MONO_SECURITY_X509_X509EXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A506660)
#define MONO_SECURITY_X509_X509EXTENSION_GET_OID_OFFSET UNITYSDK_OFFSET(0x1A506630)
#define MONO_SECURITY_X509_X509EXTENSION_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A5063E0)
#define MONO_SECURITY_X509_X509EXTENSION_SET_CRITICAL_OFFSET UNITYSDK_OFFSET(0x1A506650)
#define MONO_SECURITY_X509_X509EXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A506E40)
#define MONO_SECURITY_X509_X509EXTENSION_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1A506880)
#define MONO_SECURITY_X509_X509EXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A505FA0)
#define MONO_SECURITY_X509_X509EXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A5062B0)
#define MONO_SECURITY_X509_X509EXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A505F90)
