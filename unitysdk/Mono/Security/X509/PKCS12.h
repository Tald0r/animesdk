...
#define MONO_SECURITY_X509_PKCS12_ADDCERTIFICATE_1_OFFSET UNITYSDK_OFFSET(0x1A500040)
#define MONO_SECURITY_X509_PKCS12_ADDCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1A4FFA40)
#define MONO_SECURITY_X509_PKCS12_ADDKEYBAG_1_OFFSET UNITYSDK_OFFSET(0x1A5014E0)
#define MONO_SECURITY_X509_PKCS12_ADDKEYBAG_OFFSET UNITYSDK_OFFSET(0x1A5014D0)
#define MONO_SECURITY_X509_PKCS12_ADDPKCS8SHROUDEDKEYBAG_1_OFFSET UNITYSDK_OFFSET(0x1A500C90)
#define MONO_SECURITY_X509_PKCS12_ADDPKCS8SHROUDEDKEYBAG_OFFSET UNITYSDK_OFFSET(0x1A500C80)
#define MONO_SECURITY_X509_PKCS12_ADDPRIVATEKEY_OFFSET UNITYSDK_OFFSET(0x1A4F7D10)
#define MONO_SECURITY_X509_PKCS12_ADDSECRETBAG_1_OFFSET UNITYSDK_OFFSET(0x1A501C00)
#define MONO_SECURITY_X509_PKCS12_ADDSECRETBAG_OFFSET UNITYSDK_OFFSET(0x1A501BF0)
#define MONO_SECURITY_X509_PKCS12_CERTIFICATESAFEBAG_OFFSET UNITYSDK_OFFSET(0x1A4FB4C0)
#define MONO_SECURITY_X509_PKCS12_CLONE_OFFSET UNITYSDK_OFFSET(0x1A5058B0)
#define MONO_SECURITY_X509_PKCS12_COMPAREASYMMETRICALGORITHM_OFFSET UNITYSDK_OFFSET(0x1A500BD0)
#define MONO_SECURITY_X509_PKCS12_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A4F5490)
#define MONO_SECURITY_X509_PKCS12_DECODE_OFFSET UNITYSDK_OFFSET(0x1A4F4760)
#define MONO_SECURITY_X509_PKCS12_DECRYPT_1_OFFSET UNITYSDK_OFFSET(0x1A4F5F20)
#define MONO_SECURITY_X509_PKCS12_DECRYPT_OFFSET UNITYSDK_OFFSET(0x1A4F6800)
#define MONO_SECURITY_X509_PKCS12_ENCRYPTEDCONTENTINFO_OFFSET UNITYSDK_OFFSET(0x1A4FFA50)
#define MONO_SECURITY_X509_PKCS12_ENCRYPT_OFFSET UNITYSDK_OFFSET(0x1A4F7880)
#define MONO_SECURITY_X509_PKCS12_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A4F5FE0)
#define MONO_SECURITY_X509_PKCS12_GETASYMMETRICALGORITHM_OFFSET UNITYSDK_OFFSET(0x1A501FF0)
#define MONO_SECURITY_X509_PKCS12_GETATTRIBUTES_1_OFFSET UNITYSDK_OFFSET(0x1A504E10)
#define MONO_SECURITY_X509_PKCS12_GETATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1A504140)
#define MONO_SECURITY_X509_PKCS12_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1A4FC660)
#define MONO_SECURITY_X509_PKCS12_GETCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1A503730)
#define MONO_SECURITY_X509_PKCS12_GETEXISTINGPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1A4F7A20)
#define MONO_SECURITY_X509_PKCS12_GETSECRET_OFFSET UNITYSDK_OFFSET(0x1A502DD0)
#define MONO_SECURITY_X509_PKCS12_GETSYMMETRICALGORITHM_OFFSET UNITYSDK_OFFSET(0x1A4F7280)
#define MONO_SECURITY_X509_PKCS12_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1A4F6D90)
#define MONO_SECURITY_X509_PKCS12_GET_ITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1A4F6060)
#define MONO_SECURITY_X509_PKCS12_GET_KEYS_OFFSET UNITYSDK_OFFSET(0x1A4F6080)
#define MONO_SECURITY_X509_PKCS12_GET_MAXIMUMPASSWORDLENGTH_OFFSET UNITYSDK_OFFSET(0x1A505A50)
#define MONO_SECURITY_X509_PKCS12_GET_RNG_OFFSET UNITYSDK_OFFSET(0x1A4F7240)
#define MONO_SECURITY_X509_PKCS12_GET_SECRETS_OFFSET UNITYSDK_OFFSET(0x1A4F69D0)
#define MONO_SECURITY_X509_PKCS12_KEYBAGSAFEBAG_OFFSET UNITYSDK_OFFSET(0x1A4F91F0)
#define MONO_SECURITY_X509_PKCS12_LOADFILE_OFFSET UNITYSDK_OFFSET(0x1A505BA0)
#define MONO_SECURITY_X509_PKCS12_LOADFROMFILE_1_OFFSET UNITYSDK_OFFSET(0x1A505E90)
#define MONO_SECURITY_X509_PKCS12_LOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x1A505D80)
#define MONO_SECURITY_X509_PKCS12_MAC_OFFSET UNITYSDK_OFFSET(0x1A4F5290)
#define MONO_SECURITY_X509_PKCS12_PKCS8SHROUDEDKEYBAGSAFEBAG_OFFSET UNITYSDK_OFFSET(0x1A4F7E90)
#define MONO_SECURITY_X509_PKCS12_READSAFEBAG_OFFSET UNITYSDK_OFFSET(0x1A4F5500)
#define MONO_SECURITY_X509_PKCS12_REMOVECERTIFICATE_1_OFFSET UNITYSDK_OFFSET(0x1A500350)
#define MONO_SECURITY_X509_PKCS12_REMOVECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1A4FFA30)
#define MONO_SECURITY_X509_PKCS12_REMOVEKEYBAG_OFFSET UNITYSDK_OFFSET(0x1A501880)
#define MONO_SECURITY_X509_PKCS12_REMOVEPKCS8SHROUDEDKEYBAG_OFFSET UNITYSDK_OFFSET(0x1A5010D0)
#define MONO_SECURITY_X509_PKCS12_REMOVESECRETBAG_OFFSET UNITYSDK_OFFSET(0x1A501E20)
#define MONO_SECURITY_X509_PKCS12_SAVETOFILE_OFFSET UNITYSDK_OFFSET(0x1A505740)
#define MONO_SECURITY_X509_PKCS12_SECRETBAGSAFEBAG_OFFSET UNITYSDK_OFFSET(0x1A4FA480)
#define MONO_SECURITY_X509_PKCS12_SET_ITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1A4F6070)
#define MONO_SECURITY_X509_PKCS12_SET_MAXIMUMPASSWORDLENGTH_OFFSET UNITYSDK_OFFSET(0x1A505AB0)
#define MONO_SECURITY_X509_PKCS12_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1A4F4580)
#define MONO_SECURITY_X509_PKCS12__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A505F50)
#define MONO_SECURITY_X509_PKCS12__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4F4510)
#define MONO_SECURITY_X509_PKCS12__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A4F5220)
#define MONO_SECURITY_X509_PKCS12__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A4F5260)
#define MONO_SECURITY_X509_PKCS12__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F43B0)
