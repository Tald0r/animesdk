...
#define MONO_SECURITY_X509_X509STORES_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B5FF670)
#define MONO_SECURITY_X509_X509STORES_GET_INTERMEDIATECA_OFFSET UNITYSDK_OFFSET(0x1B5FF4F0)
#define MONO_SECURITY_X509_X509STORES_GET_OTHERPEOPLE_OFFSET UNITYSDK_OFFSET(0x1B5FF480)
#define MONO_SECURITY_X509_X509STORES_GET_PERSONAL_OFFSET UNITYSDK_OFFSET(0x1B5FF410)
#define MONO_SECURITY_X509_X509STORES_GET_TRUSTEDROOT_OFFSET UNITYSDK_OFFSET(0x1B5FF570)
#define MONO_SECURITY_X509_X509STORES_GET_UNTRUSTED_OFFSET UNITYSDK_OFFSET(0x1B5FF5F0)
#define MONO_SECURITY_X509_X509STORES_OPEN_OFFSET UNITYSDK_OFFSET(0x1B5FF9E0)
#define MONO_SECURITY_X509_X509STORES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5FF400)
...
namespace Mono::Security::X509
{
	...
	public:
		...
		::Mono::Security::X509::X509Store* _personal; // 0x18
