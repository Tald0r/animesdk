...
#define MONO_SECURITY_X509_EXTENSIONS_PRIVATEKEYUSAGEPERIODEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1AE3D940)
#define MONO_SECURITY_X509_EXTENSIONS_PRIVATEKEYUSAGEPERIODEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AE3DAA0)
#define MONO_SECURITY_X509_EXTENSIONS_PRIVATEKEYUSAGEPERIODEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AE3DAE0)
#define MONO_SECURITY_X509_EXTENSIONS_PRIVATEKEYUSAGEPERIODEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE3D920)
#define MONO_SECURITY_X509_EXTENSIONS_PRIVATEKEYUSAGEPERIODEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AE3D930)
#define MONO_SECURITY_X509_EXTENSIONS_PRIVATEKEYUSAGEPERIODEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE3D8E0)
