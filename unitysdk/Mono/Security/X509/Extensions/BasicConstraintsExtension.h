...
#define MONO_SECURITY_X509_EXTENSIONS_BASICCONSTRAINTSEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1AFEE9C0)
#define MONO_SECURITY_X509_EXTENSIONS_BASICCONSTRAINTSEXTENSION_ENCODE_OFFSET UNITYSDK_OFFSET(0x1AFEEAF0)
#define MONO_SECURITY_X509_EXTENSIONS_BASICCONSTRAINTSEXTENSION_GET_CERTIFICATEAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1AFEED00)
#define MONO_SECURITY_X509_EXTENSIONS_BASICCONSTRAINTSEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AFEED20)
#define MONO_SECURITY_X509_EXTENSIONS_BASICCONSTRAINTSEXTENSION_GET_PATHLENCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1AFEED60)
#define MONO_SECURITY_X509_EXTENSIONS_BASICCONSTRAINTSEXTENSION_SET_CERTIFICATEAUTHORITY_OFFSET UNITYSDK_OFFSET(0x1AFEED10)
#define MONO_SECURITY_X509_EXTENSIONS_BASICCONSTRAINTSEXTENSION_SET_PATHLENCONSTRAINT_OFFSET UNITYSDK_OFFSET(0x1AFEED70)
#define MONO_SECURITY_X509_EXTENSIONS_BASICCONSTRAINTSEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AFEEE40)
#define MONO_SECURITY_X509_EXTENSIONS_BASICCONSTRAINTSEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFEE9A0)
#define MONO_SECURITY_X509_EXTENSIONS_BASICCONSTRAINTSEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AFEE9B0)
#define MONO_SECURITY_X509_EXTENSIONS_BASICCONSTRAINTSEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFEE960)
