...
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1B453470)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_ENCODE_OFFSET UNITYSDK_OFFSET(0x1B4535E0)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_GET_KEYPURPOSE_OFFSET UNITYSDK_OFFSET(0x1B4539A0)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B4539B0)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B4539F0)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B453450)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B453460)
#define MONO_SECURITY_X509_EXTENSIONS_EXTENDEDKEYUSAGEEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4533D0)
