...
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1B6CDA70)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_GET_DISTRIBUTIONPOINTS_OFFSET UNITYSDK_OFFSET(0x1B6CDCA0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B6CDC60)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B6CDCB0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6CDA50)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B6CDA60)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CD9D0)
