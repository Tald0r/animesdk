...
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1B0BF9A0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_GET_DISTRIBUTIONPOINTS_OFFSET UNITYSDK_OFFSET(0x1B0BFBD0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B0BFB90)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0BFBE0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0BF980)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B0BF990)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BF900)
