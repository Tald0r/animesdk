...
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1B454030)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_ENCODE_OFFSET UNITYSDK_OFFSET(0x1B454160)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_GET_KEYUSAGE_OFFSET UNITYSDK_OFFSET(0x1B4543F0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B454460)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_SET_KEYUSAGE_OFFSET UNITYSDK_OFFSET(0x1B454400)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_SUPPORT_OFFSET UNITYSDK_OFFSET(0x1B4544A0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B454510)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B453FE0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B453FF0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B453FD0)
