...
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1AE3CE20)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_ENCODE_OFFSET UNITYSDK_OFFSET(0x1AE3CF50)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_GET_KEYUSAGE_OFFSET UNITYSDK_OFFSET(0x1AE3D1E0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AE3D250)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_SET_KEYUSAGE_OFFSET UNITYSDK_OFFSET(0x1AE3D1F0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_SUPPORT_OFFSET UNITYSDK_OFFSET(0x1AE3D290)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AE3D300)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE3CDD0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AE3CDE0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYUSAGEEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE3CDC0)
