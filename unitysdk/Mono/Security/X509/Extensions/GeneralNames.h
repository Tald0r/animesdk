...
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1B368B90)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_DIRECTORYNAMES_OFFSET UNITYSDK_OFFSET(0x1B368910)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_DNSNAMES_OFFSET UNITYSDK_OFFSET(0x1B3689B0)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_IPADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B368AF0)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_RFC822_OFFSET UNITYSDK_OFFSET(0x1B368870)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_GET_UNIFORMRESOURCEIDENTIFIERS_OFFSET UNITYSDK_OFFSET(0x1B368A50)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B368BC0)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B3671F0)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B367D90)
#define MONO_SECURITY_X509_EXTENSIONS_GENERALNAMES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3671E0)
...
namespace Mono::Security::X509::Extensions
{
	...
	{
	public:
		::Mono::Security::ASN1* asn; // 0x10
		::System::Collections::ArrayList* directoryNames; // 0x18
		::System::Collections::ArrayList* rfc822Name; // 0x20
