...
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_GET_CRLISSUER_OFFSET UNITYSDK_OFFSET(0x1B5D9BB0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B5D9B70)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_GET_REASONS_OFFSET UNITYSDK_OFFSET(0x1B5D9B90)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_SET_CRLISSUER_OFFSET UNITYSDK_OFFSET(0x1B5D9BC0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1B5D9B80)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_SET_REASONS_OFFSET UNITYSDK_OFFSET(0x1B5D9BA0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B5D9BE0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5D9BD0)
