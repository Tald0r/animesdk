...
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_GET_CRLISSUER_OFFSET UNITYSDK_OFFSET(0x1AFCE090)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AFCE050)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_GET_REASONS_OFFSET UNITYSDK_OFFSET(0x1AFCE070)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_SET_CRLISSUER_OFFSET UNITYSDK_OFFSET(0x1AFCE0A0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1AFCE060)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT_SET_REASONS_OFFSET UNITYSDK_OFFSET(0x1AFCE080)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFCE0C0)
#define MONO_SECURITY_X509_EXTENSIONS_CRLDISTRIBUTIONPOINTSEXTENSION_DISTRIBUTIONPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFCE0B0)
...
namespace Mono::Security::X509::Extensions
{
	...
	public:
		...
		::System::String* _CRLIssuer_k__BackingField; // 0x18
