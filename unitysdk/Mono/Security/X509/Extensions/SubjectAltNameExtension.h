...
#define MONO_SECURITY_X509_EXTENSIONS_SUBJECTALTNAMEEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1AFCE440)
#define MONO_SECURITY_X509_EXTENSIONS_SUBJECTALTNAMEEXTENSION_GET_DNSNAMES_OFFSET UNITYSDK_OFFSET(0x1AFCE600)
#define MONO_SECURITY_X509_EXTENSIONS_SUBJECTALTNAMEEXTENSION_GET_IPADDRESSES_OFFSET UNITYSDK_OFFSET(0x1AFCE6B0)
#define MONO_SECURITY_X509_EXTENSIONS_SUBJECTALTNAMEEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AFCE510)
#define MONO_SECURITY_X509_EXTENSIONS_SUBJECTALTNAMEEXTENSION_GET_RFC822_OFFSET UNITYSDK_OFFSET(0x1AFCE550)
#define MONO_SECURITY_X509_EXTENSIONS_SUBJECTALTNAMEEXTENSION_GET_UNIFORMRESOURCEIDENTIFIERS_OFFSET UNITYSDK_OFFSET(0x1AFCE760)
#define MONO_SECURITY_X509_EXTENSIONS_SUBJECTALTNAMEEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AFCE810)
#define MONO_SECURITY_X509_EXTENSIONS_SUBJECTALTNAMEEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFCE350)
#define MONO_SECURITY_X509_EXTENSIONS_SUBJECTALTNAMEEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AFCE360)
#define MONO_SECURITY_X509_EXTENSIONS_SUBJECTALTNAMEEXTENSION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AFCE370)
#define MONO_SECURITY_X509_EXTENSIONS_SUBJECTALTNAMEEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFCE300)
