...
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1B0DA0C0)
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B0DA1F0)
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION_SUPPORT_OFFSET UNITYSDK_OFFSET(0x1B0DA230)
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0DA2A0)
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0DA0A0)
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B0DA0B0)
#define MONO_SECURITY_X509_EXTENSIONS_NETSCAPECERTTYPEEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0DA060)
