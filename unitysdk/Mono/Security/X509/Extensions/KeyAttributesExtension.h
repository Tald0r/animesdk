...
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_DECODE_OFFSET UNITYSDK_OFFSET(0x1B4BCBD0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_GET_KEYIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B4BCE80)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1B4BCF50)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_GET_NOTAFTER_OFFSET UNITYSDK_OFFSET(0x1B4BCF90)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_GET_NOTBEFORE_OFFSET UNITYSDK_OFFSET(0x1B4BCFA0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_SUPPORT_OFFSET UNITYSDK_OFFSET(0x1B4BCFB0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B4BD020)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4BCBB0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B4BCBC0)
#define MONO_SECURITY_X509_EXTENSIONS_KEYATTRIBUTESEXTENSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4BCB70)
...
namespace Mono::Security::X509::Extensions
{
	...
	public:
		...
		::System::DateTime notBefore; // 0x38
