...
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GETASN1_1_OFFSET UNITYSDK_OFFSET(0x19F08C80)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GETASN1_OFFSET UNITYSDK_OFFSET(0x19F08C90)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x19F08FF0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x19F08FD0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x19F08C70)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19F08BB0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_SELECTBESTENCODING_OFFSET UNITYSDK_OFFSET(0x19F08F70)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19F08BC0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19F08BA0)
#define MONO_SECURITY_X509_X520_ATTRIBUTETYPEANDVALUE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F08B90)
