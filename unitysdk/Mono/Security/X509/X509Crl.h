...
#define MONO_SECURITY_X509_X509CRL_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B36AC40)
#define MONO_SECURITY_X509_X509CRL_CREATEFROMFILE_OFFSET UNITYSDK_OFFSET(0x1B36B490)
#define MONO_SECURITY_X509_X509CRL_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1B36AB70)
#define MONO_SECURITY_X509_X509CRL_GETCRLENTRY_1_OFFSET UNITYSDK_OFFSET(0x1B36A4E0)
#define MONO_SECURITY_X509_X509CRL_GETCRLENTRY_OFFSET UNITYSDK_OFFSET(0x1B36AC90)
#define MONO_SECURITY_X509_X509CRL_GET_ENTRIES_OFFSET UNITYSDK_OFFSET(0x1B36A410)
#define MONO_SECURITY_X509_X509CRL_GET_EXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1B36A650)
#define MONO_SECURITY_X509_X509CRL_GET_HASH_OFFSET UNITYSDK_OFFSET(0x1B36A660)
#define MONO_SECURITY_X509_X509CRL_GET_ISCURRENT_OFFSET UNITYSDK_OFFSET(0x1B36AA70)
#define MONO_SECURITY_X509_X509CRL_GET_ISSUERNAME_OFFSET UNITYSDK_OFFSET(0x1B36A880)
#define MONO_SECURITY_X509_X509CRL_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1B36A4D0)
#define MONO_SECURITY_X509_X509CRL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B36A440)
#define MONO_SECURITY_X509_X509CRL_GET_NEXTUPDATE_OFFSET UNITYSDK_OFFSET(0x1B36A890)
#define MONO_SECURITY_X509_X509CRL_GET_RAWDATA_OFFSET UNITYSDK_OFFSET(0x1B36A990)
#define MONO_SECURITY_X509_X509CRL_GET_SIGNATUREALGORITHM_OFFSET UNITYSDK_OFFSET(0x1B36A8B0)
#define MONO_SECURITY_X509_X509CRL_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B36A8C0)
#define MONO_SECURITY_X509_X509CRL_GET_THISUPDATE_OFFSET UNITYSDK_OFFSET(0x1B36A8A0)
#define MONO_SECURITY_X509_X509CRL_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B36AA60)
#define MONO_SECURITY_X509_X509CRL_PARSE_OFFSET UNITYSDK_OFFSET(0x1B369E20)
#define MONO_SECURITY_X509_X509CRL_VERIFYSIGNATURE_1_OFFSET UNITYSDK_OFFSET(0x1B36AFB0)
#define MONO_SECURITY_X509_X509CRL_VERIFYSIGNATURE_2_OFFSET UNITYSDK_OFFSET(0x1B36B220)
#define MONO_SECURITY_X509_X509CRL_VERIFYSIGNATURE_3_OFFSET UNITYSDK_OFFSET(0x1B36B370)
#define MONO_SECURITY_X509_X509CRL_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B36AD10)
#define MONO_SECURITY_X509_X509CRL_WASCURRENT_OFFSET UNITYSDK_OFFSET(0x1B36AB20)
#define MONO_SECURITY_X509_X509CRL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B369CF0)
...
namespace Mono::Security::X509
{
	...
	{
	public:
		::System::String* signatureOID; // 0x10
		::Il2CppArray<::System::Byte>* hash_value; // 0x18
		...
		::System::DateTime thisUpdate; // 0x58
