...
#define MONO_SECURITY_X509_X509CRL_X509CRLENTRY_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1B4564B0)
#define MONO_SECURITY_X509_X509CRL_X509CRLENTRY_GET_EXTENSIONS_OFFSET UNITYSDK_OFFSET(0x1B4564A0)
#define MONO_SECURITY_X509_X509CRL_X509CRLENTRY_GET_REVOCATIONDATE_OFFSET UNITYSDK_OFFSET(0x1B456490)
#define MONO_SECURITY_X509_X509CRL_X509CRLENTRY_GET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x1B4563C0)
#define MONO_SECURITY_X509_X509CRL_X509CRLENTRY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B456290)
#define MONO_SECURITY_X509_X509CRL_X509CRLENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4561E0)
