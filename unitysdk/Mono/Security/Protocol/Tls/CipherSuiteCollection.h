...
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITECOLLECTION_ADD_OFFSET UNITYSDK_OFFSET(0x1A4EDC70)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITECOLLECTION_GETNAMES_OFFSET UNITYSDK_OFFSET(0x1A4EDF60)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITECOLLECTION_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x1A4ED990)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITECOLLECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A4ED6A0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITECOLLECTION_INDEXOF_1_OFFSET UNITYSDK_OFFSET(0x1A4EDAC0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITECOLLECTION_INDEXOF_OFFSET UNITYSDK_OFFSET(0x1A4ED830)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4EDBB0)
