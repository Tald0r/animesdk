...
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ADD_CLIENTCERTSELECTION_OFFSET UNITYSDK_OFFSET(0x1A503560)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ADD_PRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1A503660)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ADD_SERVERCERTVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1A503830)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ADD_SERVERCERTVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A503460)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_BEGINNEGOTIATEHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1A503E70)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A503DB0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ENDNEGOTIATEHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1A504030)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A503D30)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_CLIENTCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1A503770)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_CLIENTCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A5037F0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_HAVEREMOTEVALIDATION2CALLBACK_OFFSET UNITYSDK_OFFSET(0x1A5057A0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_INPUTBUFFER_OFFSET UNITYSDK_OFFSET(0x1A503760)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_PRIVATEKEYCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A503810)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_SELECTEDCLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1A5037A0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_GET_SERVERCERTVALIDATIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A5037D0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_NEGOTIATEASYNCWORKER_OFFSET UNITYSDK_OFFSET(0x1A5041D0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ONLOCALCERTIFICATESELECTION_OFFSET UNITYSDK_OFFSET(0x1A505780)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ONLOCALPRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1A505850)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ONREMOTECERTIFICATEVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1A5057B0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_ONREMOTECERTIFICATEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A5057D0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_RAISECLIENTCERTIFICATESELECTION_OFFSET UNITYSDK_OFFSET(0x1A505820)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_RAISEPRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1A505870)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_RAISESERVERCERTIFICATEVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1A505810)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_RAISESERVERCERTIFICATEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A505800)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_REMOVE_CLIENTCERTSELECTION_OFFSET UNITYSDK_OFFSET(0x1A5035E0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_REMOVE_PRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1A5036E0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_REMOVE_SERVERCERTVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1A5038B0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_REMOVE_SERVERCERTVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A5034E0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_SAFEENDRECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1A503DE0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_SET_CLIENTCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A503800)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_SET_PRIVATEKEYCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A503820)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM_SET_SERVERCERTVALIDATIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A5037E0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A503AF0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A503C50)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A503C70)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A503950)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCLIENTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A503930)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::Mono::Security::Protocol::Tls::CertificateSelectionCallback* ClientCertSelection; // 0x88
		::Mono::Security::Protocol::Tls::CertificateValidationCallback2* ServerCertValidation2; // 0x90
		::Mono::Security::Protocol::Tls::CertificateValidationCallback* ServerCertValidation; // 0x98
