...
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1B0DA000)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1B0D9770)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1B0D9780)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1B0D9760)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1B0D96D0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1B0D9730)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B0D9700)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READBYTES_OFFSET UNITYSDK_OFFSET(0x1B0D9C20)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1B0D9A70)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READINT16_OFFSET UNITYSDK_OFFSET(0x1B0D9AB0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READINT24_OFFSET UNITYSDK_OFFSET(0x1B0D9B00)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READINT32_OFFSET UNITYSDK_OFFSET(0x1B0D9B80)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READSMALLVALUE_OFFSET UNITYSDK_OFFSET(0x1B0D9880)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1B0D99E0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_RESET_OFFSET UNITYSDK_OFFSET(0x1B0D8DD0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1B0DA040)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1B0DA020)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1B0D97A0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_TOARRAY_OFFSET UNITYSDK_OFFSET(0x1B0D8DA0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITEINT24_OFFSET UNITYSDK_OFFSET(0x1B0D9E90)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1B0D9140)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_2_OFFSET UNITYSDK_OFFSET(0x1B0D8B60)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_3_OFFSET UNITYSDK_OFFSET(0x1B0D9FD0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_4_OFFSET UNITYSDK_OFFSET(0x1B0D8CF0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_5_OFFSET UNITYSDK_OFFSET(0x1B0D9DF0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1B0D9D10)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0D97C0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D8AE0)
