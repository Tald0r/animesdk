...
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_FLUSH_OFFSET UNITYSDK_OFFSET(0x1AA9DCB0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_CANREAD_OFFSET UNITYSDK_OFFSET(0x1AA9D420)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_CANSEEK_OFFSET UNITYSDK_OFFSET(0x1AA9D430)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_CANWRITE_OFFSET UNITYSDK_OFFSET(0x1AA9D410)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_EOF_OFFSET UNITYSDK_OFFSET(0x1AA9D380)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1AA9D3E0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AA9D3B0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READBYTES_OFFSET UNITYSDK_OFFSET(0x1AA9D8D0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READBYTE_OFFSET UNITYSDK_OFFSET(0x1AA9D720)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READINT16_OFFSET UNITYSDK_OFFSET(0x1AA9D760)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READINT24_OFFSET UNITYSDK_OFFSET(0x1AA9D7B0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READINT32_OFFSET UNITYSDK_OFFSET(0x1AA9D830)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READSMALLVALUE_OFFSET UNITYSDK_OFFSET(0x1AA9D530)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_READ_OFFSET UNITYSDK_OFFSET(0x1AA9D690)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_RESET_OFFSET UNITYSDK_OFFSET(0x1AA9CA80)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_SEEK_OFFSET UNITYSDK_OFFSET(0x1AA9DCF0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_SETLENGTH_OFFSET UNITYSDK_OFFSET(0x1AA9DCD0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AA9D450)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_TOARRAY_OFFSET UNITYSDK_OFFSET(0x1AA9CA50)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITEINT24_OFFSET UNITYSDK_OFFSET(0x1AA9DB40)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1AA9CDF0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_2_OFFSET UNITYSDK_OFFSET(0x1AA9C810)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_3_OFFSET UNITYSDK_OFFSET(0x1AA9DC80)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_4_OFFSET UNITYSDK_OFFSET(0x1AA9C9A0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_5_OFFSET UNITYSDK_OFFSET(0x1AA9DAA0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM_WRITE_OFFSET UNITYSDK_OFFSET(0x1AA9D9C0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA9D470)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9C790)
