...
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B0BF8F0)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_GET_CIPHER_OFFSET UNITYSDK_OFFSET(0x1B0BF890)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_GET_CLIENTWRITEMAC_OFFSET UNITYSDK_OFFSET(0x1B0BF8B0)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_GET_SERVERWRITEMAC_OFFSET UNITYSDK_OFFSET(0x1B0BF8D0)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_SET_CIPHER_OFFSET UNITYSDK_OFFSET(0x1B0BF8A0)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_SET_CLIENTWRITEMAC_OFFSET UNITYSDK_OFFSET(0x1B0BF8C0)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS_SET_SERVERWRITEMAC_OFFSET UNITYSDK_OFFSET(0x1B0BF8E0)
#define MONO_SECURITY_PROTOCOL_TLS_SECURITYPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BF880)
