...
#define MONO_SECURITY_PROTOCOL_TLS_PRIVATEKEYSELECTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE3B780)
#define MONO_SECURITY_PROTOCOL_TLS_PRIVATEKEYSELECTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE3B7C0)
#define MONO_SECURITY_PROTOCOL_TLS_PRIVATEKEYSELECTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE3B1E0)
#define MONO_SECURITY_PROTOCOL_TLS_PRIVATEKEYSELECTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE3B1D0)
