...
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_CHANGEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AE50900)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_CLEARKEYINFO_OFFSET UNITYSDK_OFFSET(0x1AE50700)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AE50560)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_DECODEPROTOCOLCODE_OFFSET UNITYSDK_OFFSET(0x1AE50860)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_ENDSWITCHINGSECURITYPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1AE50C50)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GETSECURERANDOMBYTES_OFFSET UNITYSDK_OFFSET(0x1AE50510)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GETUNIXTIME_OFFSET UNITYSDK_OFFSET(0x1AE504B0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_ABBREVIATEDHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1AE4FE90)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_CHANGECIPHERSPECDONE_OFFSET UNITYSDK_OFFSET(0x1AE4FED0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_CLIENTRANDOM_OFFSET UNITYSDK_OFFSET(0x1AE501C0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_CLIENTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1AE500C0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_CLIENTWRITEIV_OFFSET UNITYSDK_OFFSET(0x1AE502A0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_CLIENTWRITEKEY_OFFSET UNITYSDK_OFFSET(0x1AE50260)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_COMPRESSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1AE50090)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AE50B20)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_HANDSHAKEMESSAGES_OFFSET UNITYSDK_OFFSET(0x1AE50170)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_HANDSHAKESTATE_OFFSET UNITYSDK_OFFSET(0x1AE500F0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_LASTHANDSHAKEMSG_OFFSET UNITYSDK_OFFSET(0x1AE500D0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_MASTERSECRET_OFFSET UNITYSDK_OFFSET(0x1AE50240)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_NEGOTIATING_OFFSET UNITYSDK_OFFSET(0x1AE50B90)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_PROTOCOLNEGOTIATED_OFFSET UNITYSDK_OFFSET(0x1AE4FEB0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_PROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AE4FFB0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_RANDOMCS_OFFSET UNITYSDK_OFFSET(0x1AE50200)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_RANDOMSC_OFFSET UNITYSDK_OFFSET(0x1AE50220)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_READSEQUENCENUMBER_OFFSET UNITYSDK_OFFSET(0x1AE501A0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_READ_OFFSET UNITYSDK_OFFSET(0x1AE50C00)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_RECEIVEDCONNECTIONEND_OFFSET UNITYSDK_OFFSET(0x1AE50110)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_RECORDPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AE502E0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SECURITYPROTOCOLFLAGS_OFFSET UNITYSDK_OFFSET(0x1AE4FFA0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SECURITYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AE4FEF0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SENTCONNECTIONEND_OFFSET UNITYSDK_OFFSET(0x1AE50130)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SERVERRANDOM_OFFSET UNITYSDK_OFFSET(0x1AE501E0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SERVERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1AE500B0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SERVERWRITEIV_OFFSET UNITYSDK_OFFSET(0x1AE502C0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SERVERWRITEKEY_OFFSET UNITYSDK_OFFSET(0x1AE50280)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x1AE50070)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SUPPORTEDCIPHERS_OFFSET UNITYSDK_OFFSET(0x1AE50150)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_WRITESEQUENCENUMBER_OFFSET UNITYSDK_OFFSET(0x1AE50180)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_WRITE_OFFSET UNITYSDK_OFFSET(0x1AE50C10)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_ABBREVIATEDHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1AE4FEA0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_CHANGECIPHERSPECDONE_OFFSET UNITYSDK_OFFSET(0x1AE4FEE0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_CLIENTRANDOM_OFFSET UNITYSDK_OFFSET(0x1AE501D0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_CLIENTWRITEIV_OFFSET UNITYSDK_OFFSET(0x1AE502B0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_CLIENTWRITEKEY_OFFSET UNITYSDK_OFFSET(0x1AE50270)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_COMPRESSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1AE500A0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_HANDSHAKESTATE_OFFSET UNITYSDK_OFFSET(0x1AE50100)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_LASTHANDSHAKEMSG_OFFSET UNITYSDK_OFFSET(0x1AE500E0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_MASTERSECRET_OFFSET UNITYSDK_OFFSET(0x1AE50250)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_PROTOCOLNEGOTIATED_OFFSET UNITYSDK_OFFSET(0x1AE4FEC0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_RANDOMCS_OFFSET UNITYSDK_OFFSET(0x1AE50210)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_RANDOMSC_OFFSET UNITYSDK_OFFSET(0x1AE50230)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_READSEQUENCENUMBER_OFFSET UNITYSDK_OFFSET(0x1AE501B0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_RECEIVEDCONNECTIONEND_OFFSET UNITYSDK_OFFSET(0x1AE50120)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_RECORDPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AE502F0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SECURITYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AE4FF90)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SENTCONNECTIONEND_OFFSET UNITYSDK_OFFSET(0x1AE50140)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SERVERRANDOM_OFFSET UNITYSDK_OFFSET(0x1AE501F0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SERVERWRITEIV_OFFSET UNITYSDK_OFFSET(0x1AE502D0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SERVERWRITEKEY_OFFSET UNITYSDK_OFFSET(0x1AE50290)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x1AE50080)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SUPPORTEDCIPHERS_OFFSET UNITYSDK_OFFSET(0x1AE50160)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_WRITESEQUENCENUMBER_OFFSET UNITYSDK_OFFSET(0x1AE50190)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_STARTSWITCHINGSECURITYPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1AE50C20)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE50300)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* sessionId; // 0x10
		::Il2CppArray<::System::Byte>* randomCS; // 0x18
		::Mono::Security::Protocol::Tls::TlsClientSettings* clientSettings; // 0x20
		::Il2CppArray<::System::Byte>* clientWriteKey; // 0x28
		::Il2CppArray<::System::Byte>* clientWriteIV; // 0x30
		::Mono::Security::Protocol::Tls::SecurityParameters* write; // 0x38
		::Mono::Security::Protocol::Tls::TlsServerSettings* serverSettings; // 0x40
		::Mono::Security::Protocol::Tls::SecurityParameters* read; // 0x48
		::Mono::Security::Protocol::Tls::TlsStream* handshakeMessages; // 0x50
		::Mono::Security::Protocol::Tls::SecurityParameters* current; // 0x58
		::Il2CppArray<::System::Byte>* masterSecret; // 0x60
		::Mono::Security::Protocol::Tls::CipherSuiteCollection* supportedCiphers; // 0x68
		::Il2CppArray<::System::Byte>* serverWriteIV; // 0x70
		::Il2CppArray<::System::Byte>* randomSC; // 0x78
		::Il2CppArray<::System::Byte>* serverRandom; // 0x80
		::Mono::Security::Protocol::Tls::RecordProtocol* recordProtocol; // 0x88
		::Il2CppArray<::System::Byte>* clientRandom; // 0x90
		::Mono::Security::Protocol::Tls::SecurityParameters* negotiating; // 0x98
		::System::Security::Cryptography::RandomNumberGenerator* random; // 0xA0
		::Il2CppArray<::System::Byte>* serverWriteKey; // 0xA8
		::System::UInt64 readSequenceNumber; // 0xB0
		::System::Boolean sentConnectionEnd; // 0xB8
		::System::Boolean receivedConnectionEnd; // 0xB9
		::System::UInt64 writeSequenceNumber; // 0xC0
		::Mono::Security::Protocol::Tls::SecurityProtocolType securityProtocol; // 0xC8
		::Mono::Security::Protocol::Tls::SecurityCompressionType compressionMethod; // 0xCC
		::Mono::Security::Protocol::Tls::Handshake::HandshakeType lastHandshakeMsg; // 0xD0
		::System::Boolean _ChangeCipherSpecDone_k__BackingField; // 0xD1
		::System::Boolean abbreviatedHandshake; // 0xD2
		::System::Boolean protocolNegotiated; // 0xD3
