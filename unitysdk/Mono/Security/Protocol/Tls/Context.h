...
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_CHANGEPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1B461C70)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_CLEARKEYINFO_OFFSET UNITYSDK_OFFSET(0x1B461A60)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B4618C0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_DECODEPROTOCOLCODE_OFFSET UNITYSDK_OFFSET(0x1B461BD0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_ENDSWITCHINGSECURITYPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B461FC0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GETSECURERANDOMBYTES_OFFSET UNITYSDK_OFFSET(0x1B461870)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GETUNIXTIME_OFFSET UNITYSDK_OFFSET(0x1B461810)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_ABBREVIATEDHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1B4611F0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_CHANGECIPHERSPECDONE_OFFSET UNITYSDK_OFFSET(0x1B461230)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_CLIENTRANDOM_OFFSET UNITYSDK_OFFSET(0x1B461520)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_CLIENTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B461420)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_CLIENTWRITEIV_OFFSET UNITYSDK_OFFSET(0x1B461600)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_CLIENTWRITEKEY_OFFSET UNITYSDK_OFFSET(0x1B4615C0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_COMPRESSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1B4613F0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B461E90)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_HANDSHAKEMESSAGES_OFFSET UNITYSDK_OFFSET(0x1B4614D0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_HANDSHAKESTATE_OFFSET UNITYSDK_OFFSET(0x1B461450)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_LASTHANDSHAKEMSG_OFFSET UNITYSDK_OFFSET(0x1B461430)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_MASTERSECRET_OFFSET UNITYSDK_OFFSET(0x1B4615A0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_NEGOTIATING_OFFSET UNITYSDK_OFFSET(0x1B461F00)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_PROTOCOLNEGOTIATED_OFFSET UNITYSDK_OFFSET(0x1B461210)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_PROTOCOL_OFFSET UNITYSDK_OFFSET(0x1B461310)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_RANDOMCS_OFFSET UNITYSDK_OFFSET(0x1B461560)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_RANDOMSC_OFFSET UNITYSDK_OFFSET(0x1B461580)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_READSEQUENCENUMBER_OFFSET UNITYSDK_OFFSET(0x1B461500)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_READ_OFFSET UNITYSDK_OFFSET(0x1B461F70)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_RECEIVEDCONNECTIONEND_OFFSET UNITYSDK_OFFSET(0x1B461470)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_RECORDPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1B461640)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SECURITYPROTOCOLFLAGS_OFFSET UNITYSDK_OFFSET(0x1B461300)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SECURITYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1B461250)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SENTCONNECTIONEND_OFFSET UNITYSDK_OFFSET(0x1B461490)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SERVERRANDOM_OFFSET UNITYSDK_OFFSET(0x1B461540)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SERVERSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B461410)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SERVERWRITEIV_OFFSET UNITYSDK_OFFSET(0x1B461620)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SERVERWRITEKEY_OFFSET UNITYSDK_OFFSET(0x1B4615E0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x1B4613D0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_SUPPORTEDCIPHERS_OFFSET UNITYSDK_OFFSET(0x1B4614B0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_WRITESEQUENCENUMBER_OFFSET UNITYSDK_OFFSET(0x1B4614E0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_GET_WRITE_OFFSET UNITYSDK_OFFSET(0x1B461F80)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_ABBREVIATEDHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1B461200)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_CHANGECIPHERSPECDONE_OFFSET UNITYSDK_OFFSET(0x1B461240)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_CLIENTRANDOM_OFFSET UNITYSDK_OFFSET(0x1B461530)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_CLIENTWRITEIV_OFFSET UNITYSDK_OFFSET(0x1B461610)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_CLIENTWRITEKEY_OFFSET UNITYSDK_OFFSET(0x1B4615D0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_COMPRESSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1B461400)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_HANDSHAKESTATE_OFFSET UNITYSDK_OFFSET(0x1B461460)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_LASTHANDSHAKEMSG_OFFSET UNITYSDK_OFFSET(0x1B461440)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_MASTERSECRET_OFFSET UNITYSDK_OFFSET(0x1B4615B0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_PROTOCOLNEGOTIATED_OFFSET UNITYSDK_OFFSET(0x1B461220)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_RANDOMCS_OFFSET UNITYSDK_OFFSET(0x1B461570)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_RANDOMSC_OFFSET UNITYSDK_OFFSET(0x1B461590)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_READSEQUENCENUMBER_OFFSET UNITYSDK_OFFSET(0x1B461510)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_RECEIVEDCONNECTIONEND_OFFSET UNITYSDK_OFFSET(0x1B461480)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_RECORDPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1B461650)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SECURITYPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1B4612F0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SENTCONNECTIONEND_OFFSET UNITYSDK_OFFSET(0x1B4614A0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SERVERRANDOM_OFFSET UNITYSDK_OFFSET(0x1B461550)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SERVERWRITEIV_OFFSET UNITYSDK_OFFSET(0x1B461630)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SERVERWRITEKEY_OFFSET UNITYSDK_OFFSET(0x1B4615F0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SESSIONID_OFFSET UNITYSDK_OFFSET(0x1B4613E0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_SUPPORTEDCIPHERS_OFFSET UNITYSDK_OFFSET(0x1B4614C0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_SET_WRITESEQUENCENUMBER_OFFSET UNITYSDK_OFFSET(0x1B4614F0)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT_STARTSWITCHINGSECURITYPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B461F90)
#define MONO_SECURITY_PROTOCOL_TLS_CONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B461660)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::System::Security::Cryptography::RandomNumberGenerator* random; // 0x10
		::Mono::Security::Protocol::Tls::RecordProtocol* recordProtocol; // 0x18
		::Il2CppArray<::System::Byte>* sessionId; // 0x20
		::Il2CppArray<::System::Byte>* clientRandom; // 0x28
		::Mono::Security::Protocol::Tls::SecurityParameters* write; // 0x30
		::Mono::Security::Protocol::Tls::TlsClientSettings* clientSettings; // 0x38
		::Il2CppArray<::System::Byte>* masterSecret; // 0x40
		::Il2CppArray<::System::Byte>* serverWriteKey; // 0x48
		::Mono::Security::Protocol::Tls::SecurityParameters* current; // 0x50
		::Il2CppArray<::System::Byte>* serverWriteIV; // 0x58
		::Mono::Security::Protocol::Tls::TlsServerSettings* serverSettings; // 0x60
		::Mono::Security::Protocol::Tls::TlsStream* handshakeMessages; // 0x68
		::Mono::Security::Protocol::Tls::CipherSuiteCollection* supportedCiphers; // 0x70
		::Mono::Security::Protocol::Tls::SecurityParameters* negotiating; // 0x78
		::Il2CppArray<::System::Byte>* clientWriteKey; // 0x80
		::Mono::Security::Protocol::Tls::SecurityParameters* read; // 0x88
		::Il2CppArray<::System::Byte>* randomSC; // 0x90
		::Il2CppArray<::System::Byte>* randomCS; // 0x98
		::Il2CppArray<::System::Byte>* serverRandom; // 0xA0
		::Il2CppArray<::System::Byte>* clientWriteIV; // 0xA8
		::Mono::Security::Protocol::Tls::Handshake::HandshakeType lastHandshakeMsg; // 0xB0
		::System::Boolean protocolNegotiated; // 0xB1
		::System::Boolean abbreviatedHandshake; // 0xB2
		::System::Boolean _ChangeCipherSpecDone_k__BackingField; // 0xB3
		::Mono::Security::Protocol::Tls::SecurityCompressionType compressionMethod; // 0xB4
		::System::Boolean receivedConnectionEnd; // 0xB8
		::System::Boolean sentConnectionEnd; // 0xB9
		::Mono::Security::Protocol::Tls::HandshakeState handshakeState; // 0xBC
		::Mono::Security::Protocol::Tls::SecurityProtocolType securityProtocol; // 0xC0
		::System::UInt64 readSequenceNumber; // 0xC8
		::System::UInt64 writeSequenceNumber; // 0xD0
