...
#define MONO_SECURITY_PROTOCOL_TLS_SERVERRECORDPROTOCOL_CREATECLIENTHANDSHAKEMESSAGE_OFFSET UNITYSDK_OFFSET(0x19EF17C0)
#define MONO_SECURITY_PROTOCOL_TLS_SERVERRECORDPROTOCOL_CREATESERVERHANDSHAKEMESSAGE_OFFSET UNITYSDK_OFFSET(0x19EF1010)
#define MONO_SECURITY_PROTOCOL_TLS_SERVERRECORDPROTOCOL_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x19EF1000)
#define MONO_SECURITY_PROTOCOL_TLS_SERVERRECORDPROTOCOL_PROCESSHANDSHAKEMESSAGE_OFFSET UNITYSDK_OFFSET(0x19EF1500)
#define MONO_SECURITY_PROTOCOL_TLS_SERVERRECORDPROTOCOL__CTOR_OFFSET UNITYSDK_OFFSET(0x19EF0F80)
