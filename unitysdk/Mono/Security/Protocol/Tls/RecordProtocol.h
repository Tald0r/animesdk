...
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINRECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1AAB3700)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINSENDCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1AAB50F0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINSENDRECORD_1_OFFSET UNITYSDK_OFFSET(0x1AAB5160)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINSENDRECORD_OFFSET UNITYSDK_OFFSET(0x1AAB3360)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_COMPARE_OFFSET UNITYSDK_OFFSET(0x1AAB5930)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_DECRYPTRECORDFRAGMENT_OFFSET UNITYSDK_OFFSET(0x1AAB40F0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCODEHANDSHAKERECORD_OFFSET UNITYSDK_OFFSET(0x1AAB5880)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCODERECORD_1_OFFSET UNITYSDK_OFFSET(0x1AAB5520)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCODERECORD_OFFSET UNITYSDK_OFFSET(0x1AAB50C0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCRYPTRECORDFRAGMENT_OFFSET UNITYSDK_OFFSET(0x1AAB5760)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENDRECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1AAB43F0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENDSENDCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1AAB5270)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENDSENDRECORD_OFFSET UNITYSDK_OFFSET(0x1AAB3450)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AAB36B0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1AAB32F0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_INTERNALRECEIVERECORDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AAB38E0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_INTERNALSENDRECORDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AAB5330)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_PROCESSALERT_OFFSET UNITYSDK_OFFSET(0x1AAB4360)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_PROCESSCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1AAB35F0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_READRECORDBUFFER_OFFSET UNITYSDK_OFFSET(0x1AAB3DB0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_RECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1AAB4630)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_1_OFFSET UNITYSDK_OFFSET(0x1AAB4D70)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_2_OFFSET UNITYSDK_OFFSET(0x1AAB4DF0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_3_OFFSET UNITYSDK_OFFSET(0x1AAB4C30)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_OFFSET UNITYSDK_OFFSET(0x1AAB4AC0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDCHANGECIPHERSPEC_1_OFFSET UNITYSDK_OFFSET(0x1AAB4F80)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1AAB4E70)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORD_1_OFFSET UNITYSDK_OFFSET(0x1AAB4E40)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORD_OFFSET UNITYSDK_OFFSET(0x1AAB3330)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1AAB3300)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AAB5990)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAB3310)
