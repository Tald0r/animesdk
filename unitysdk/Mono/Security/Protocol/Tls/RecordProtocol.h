...
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINRECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1A501170)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINSENDCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1A502B60)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINSENDRECORD_1_OFFSET UNITYSDK_OFFSET(0x1A502BD0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_BEGINSENDRECORD_OFFSET UNITYSDK_OFFSET(0x1A500DD0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_COMPARE_OFFSET UNITYSDK_OFFSET(0x1A5033A0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_DECRYPTRECORDFRAGMENT_OFFSET UNITYSDK_OFFSET(0x1A501B50)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCODEHANDSHAKERECORD_OFFSET UNITYSDK_OFFSET(0x1A5032F0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCODERECORD_1_OFFSET UNITYSDK_OFFSET(0x1A502F90)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCODERECORD_OFFSET UNITYSDK_OFFSET(0x1A502B30)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENCRYPTRECORDFRAGMENT_OFFSET UNITYSDK_OFFSET(0x1A5031D0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENDRECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1A501E50)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENDSENDCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1A502CE0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_ENDSENDRECORD_OFFSET UNITYSDK_OFFSET(0x1A500EC0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A501120)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1A500D50)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_INTERNALRECEIVERECORDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A501350)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_INTERNALSENDRECORDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1A502DA0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_PROCESSALERT_OFFSET UNITYSDK_OFFSET(0x1A501DC0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_PROCESSCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1A501060)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_READRECORDBUFFER_OFFSET UNITYSDK_OFFSET(0x1A501810)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_RECEIVERECORD_OFFSET UNITYSDK_OFFSET(0x1A502090)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_1_OFFSET UNITYSDK_OFFSET(0x1A5027D0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_2_OFFSET UNITYSDK_OFFSET(0x1A502850)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_3_OFFSET UNITYSDK_OFFSET(0x1A502690)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDALERT_OFFSET UNITYSDK_OFFSET(0x1A502520)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDCHANGECIPHERSPEC_1_OFFSET UNITYSDK_OFFSET(0x1A5029F0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDCHANGECIPHERSPEC_OFFSET UNITYSDK_OFFSET(0x1A5028D0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORD_1_OFFSET UNITYSDK_OFFSET(0x1A5028A0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SENDRECORD_OFFSET UNITYSDK_OFFSET(0x1A500DA0)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1A500D60)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A503400)
#define MONO_SECURITY_PROTOCOL_TLS_RECORDPROTOCOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A500D70)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::System::IO::Stream* innerStream; // 0x18
