...
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREFORMATTER_CREATESIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B0DCFB0)
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREFORMATTER_SETHASHALGORITHM_OFFSET UNITYSDK_OFFSET(0x1B0DD0B0)
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREFORMATTER_SETKEY_OFFSET UNITYSDK_OFFSET(0x1B0DCF20)
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0DCE90)
#define MONO_SECURITY_PROTOCOL_TLS_RSASSLSIGNATUREFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0DCE80)
