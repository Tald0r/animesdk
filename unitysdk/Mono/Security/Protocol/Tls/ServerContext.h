...
#define MONO_SECURITY_PROTOCOL_TLS_SERVERCONTEXT_GET_CLIENTCERTIFICATEREQUIRED_OFFSET UNITYSDK_OFFSET(0x1AFEFF30)
#define MONO_SECURITY_PROTOCOL_TLS_SERVERCONTEXT_GET_REQUESTCLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1AFEFF40)
#define MONO_SECURITY_PROTOCOL_TLS_SERVERCONTEXT_GET_SSLSTREAM_OFFSET UNITYSDK_OFFSET(0x1AFEFF20)
#define MONO_SECURITY_PROTOCOL_TLS_SERVERCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFEFF50)
