...
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITEFACTORY_GETSSL3SUPPORTEDCIPHERS_OFFSET UNITYSDK_OFFSET(0x1AFE96F0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITEFACTORY_GETSUPPORTEDCIPHERS_OFFSET UNITYSDK_OFFSET(0x1AFE93E0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITEFACTORY_GETTLS1SUPPORTEDCIPHERS_OFFSET UNITYSDK_OFFSET(0x1AFE9470)
