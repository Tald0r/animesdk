...
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTRECORDPROTOCOL_CREATECLIENTHANDSHAKEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AE9EEE0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTRECORDPROTOCOL_CREATESERVERHANDSHAKEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AE9F480)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTRECORDPROTOCOL_GETMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AE9EED0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTRECORDPROTOCOL_PROCESSHANDSHAKEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AE9F1A0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTRECORDPROTOCOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE9EE50)
