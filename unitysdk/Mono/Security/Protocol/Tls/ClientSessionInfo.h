...
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONINFO_CHECKDISPOSED_OFFSET UNITYSDK_OFFSET(0x1B0B8C60)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONINFO_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1B0B8A50)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONINFO_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B0B8E20)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONINFO_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B0B89A0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONINFO_GETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1B0B8B10)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONINFO_GET_HOSTNAME_OFFSET UNITYSDK_OFFSET(0x1B0B8AA0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONINFO_GET_ID_OFFSET UNITYSDK_OFFSET(0x1B0B8AB0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONINFO_GET_VALID_OFFSET UNITYSDK_OFFSET(0x1B0B8AC0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONINFO_KEEPALIVE_OFFSET UNITYSDK_OFFSET(0x1B0B88A0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONINFO_SETCONTEXT_OFFSET UNITYSDK_OFFSET(0x1B0B8CD0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0B8760)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTSESSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0B8890)
