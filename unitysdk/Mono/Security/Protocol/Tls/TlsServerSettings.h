...
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_CERTIFICATEREQUEST_OFFSET UNITYSDK_OFFSET(0x1B366F70)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_CERTIFICATERSA_OFFSET UNITYSDK_OFFSET(0x1B366EF0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1B366ED0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_CERTIFICATETYPES_OFFSET UNITYSDK_OFFSET(0x1B366F90)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_DISTINGUISEDNAMES_OFFSET UNITYSDK_OFFSET(0x1B366FB0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_RSAPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B366F00)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_SERVERKEYEXCHANGE_OFFSET UNITYSDK_OFFSET(0x1B366EB0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_GET_SIGNEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1B366F50)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_CERTIFICATEREQUEST_OFFSET UNITYSDK_OFFSET(0x1B366F80)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1B366EE0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_CERTIFICATETYPES_OFFSET UNITYSDK_OFFSET(0x1B366FA0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_DISTINGUISEDNAMES_OFFSET UNITYSDK_OFFSET(0x1B366FC0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_RSAPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B366F30)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_SERVERKEYEXCHANGE_OFFSET UNITYSDK_OFFSET(0x1B366EC0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_SET_SIGNEDPARAMS_OFFSET UNITYSDK_OFFSET(0x1B366F60)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS_UPDATECERTIFICATERSA_OFFSET UNITYSDK_OFFSET(0x1B366FE0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSSERVERSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B366FD0)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::Il2CppArray<::System::String*>* distinguisedNames; // 0x50
