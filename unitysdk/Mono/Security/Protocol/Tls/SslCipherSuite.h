...
#define MONO_SECURITY_PROTOCOL_TLS_SSLCIPHERSUITE_COMPUTECLIENTRECORDMAC_OFFSET UNITYSDK_OFFSET(0x1AE51800)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCIPHERSUITE_COMPUTEKEYS_OFFSET UNITYSDK_OFFSET(0x1AE52050)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCIPHERSUITE_COMPUTEMASTERSECRET_OFFSET UNITYSDK_OFFSET(0x1AE51B70)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCIPHERSUITE_COMPUTESERVERRECORDMAC_OFFSET UNITYSDK_OFFSET(0x1AE514E0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCIPHERSUITE_PRF_OFFSET UNITYSDK_OFFSET(0x1AE51CF0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLCIPHERSUITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE51330)
