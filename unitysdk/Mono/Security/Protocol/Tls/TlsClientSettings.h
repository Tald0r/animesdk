...
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_GET_CERTIFICATERSA_OFFSET UNITYSDK_OFFSET(0x1AFEE8C0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1AFEE6C0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_GET_CLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1AFEE6E0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_GET_TARGETHOST_OFFSET UNITYSDK_OFFSET(0x1AFEE6A0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_SET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1AFEE6D0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_SET_CLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1AFEE6F0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_SET_TARGETHOST_OFFSET UNITYSDK_OFFSET(0x1AFEE6B0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_UPDATECERTIFICATERSA_OFFSET UNITYSDK_OFFSET(0x1AFEE700)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFEE8D0)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::System::Security::Cryptography::X509Certificates::X509Certificate* clientCertificate; // 0x18
