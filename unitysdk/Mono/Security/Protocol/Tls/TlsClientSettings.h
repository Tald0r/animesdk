...
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_GET_CERTIFICATERSA_OFFSET UNITYSDK_OFFSET(0x1A9FEB90)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1A9FE990)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_GET_CLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1A9FE9B0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_GET_TARGETHOST_OFFSET UNITYSDK_OFFSET(0x1A9FE970)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_SET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1A9FE9A0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_SET_CLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1A9FE9C0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_SET_TARGETHOST_OFFSET UNITYSDK_OFFSET(0x1A9FE980)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS_UPDATECERTIFICATERSA_OFFSET UNITYSDK_OFFSET(0x1A9FE9D0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCLIENTSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9FEBA0)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::System::Security::Cryptography::X509Certificates::X509CertificateCollection* certificates; // 0x20
