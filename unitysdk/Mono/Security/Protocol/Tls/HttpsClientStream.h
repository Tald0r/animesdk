...
#define MONO_SECURITY_PROTOCOL_TLS_HTTPSCLIENTSTREAM_GET_TRUSTFAILURE_OFFSET UNITYSDK_OFFSET(0x1AFEF9B0)
#define MONO_SECURITY_PROTOCOL_TLS_HTTPSCLIENTSTREAM_RAISESERVERCERTIFICATEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1AFEF9D0)
#define MONO_SECURITY_PROTOCOL_TLS_HTTPSCLIENTSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFEF5D0)
