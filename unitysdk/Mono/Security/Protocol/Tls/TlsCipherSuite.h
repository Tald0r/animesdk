...
#define MONO_SECURITY_PROTOCOL_TLS_TLSCIPHERSUITE_COMPUTECLIENTRECORDMAC_OFFSET UNITYSDK_OFFSET(0x1AA17770)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCIPHERSUITE_COMPUTEKEYS_OFFSET UNITYSDK_OFFSET(0x1AA17AC0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCIPHERSUITE_COMPUTEMASTERSECRET_OFFSET UNITYSDK_OFFSET(0x1AA17A30)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCIPHERSUITE_COMPUTESERVERRECORDMAC_OFFSET UNITYSDK_OFFSET(0x1AA174B0)
#define MONO_SECURITY_PROTOCOL_TLS_TLSCIPHERSUITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA17380)
