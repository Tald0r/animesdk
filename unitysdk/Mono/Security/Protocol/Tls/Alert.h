...
#define MONO_SECURITY_PROTOCOL_TLS_ALERT_GETALERTMESSAGE_OFFSET UNITYSDK_OFFSET(0x1A4FFC50)
#define MONO_SECURITY_PROTOCOL_TLS_ALERT_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A4FFB50)
#define MONO_SECURITY_PROTOCOL_TLS_ALERT_GET_ISCLOSENOTIFY_OFFSET UNITYSDK_OFFSET(0x1A4FFBB0)
#define MONO_SECURITY_PROTOCOL_TLS_ALERT_GET_ISWARNING_OFFSET UNITYSDK_OFFSET(0x1A4FFBA0)
#define MONO_SECURITY_PROTOCOL_TLS_ALERT_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A4FFB40)
#define MONO_SECURITY_PROTOCOL_TLS_ALERT_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1A4FFB60)
#define MONO_SECURITY_PROTOCOL_TLS_ALERT_INFERALERTLEVEL_OFFSET UNITYSDK_OFFSET(0x1A4FFC10)
#define MONO_SECURITY_PROTOCOL_TLS_ALERT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4FFC40)
#define MONO_SECURITY_PROTOCOL_TLS_ALERT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4FFBD0)
