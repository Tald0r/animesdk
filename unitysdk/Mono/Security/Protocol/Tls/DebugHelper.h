...
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6C9EE0)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITEBUFFER_1_OFFSET UNITYSDK_OFFSET(0x1B6C9F70)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITEBUFFER_OFFSET UNITYSDK_OFFSET(0x1B6C9F60)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITELINE_1_OFFSET UNITYSDK_OFFSET(0x1B6C9F40)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITELINE_2_OFFSET UNITYSDK_OFFSET(0x1B6C9F50)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER_WRITELINE_OFFSET UNITYSDK_OFFSET(0x1B6C9F30)
#define MONO_SECURITY_PROTOCOL_TLS_DEBUGHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CA2F0)
