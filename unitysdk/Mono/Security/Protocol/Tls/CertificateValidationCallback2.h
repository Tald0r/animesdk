...
#define MONO_SECURITY_PROTOCOL_TLS_CERTIFICATEVALIDATIONCALLBACK2_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19EEE100)
#define MONO_SECURITY_PROTOCOL_TLS_CERTIFICATEVALIDATIONCALLBACK2_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19EEE130)
#define MONO_SECURITY_PROTOCOL_TLS_CERTIFICATEVALIDATIONCALLBACK2_INVOKE_OFFSET UNITYSDK_OFFSET(0x19EEDBC0)
#define MONO_SECURITY_PROTOCOL_TLS_CERTIFICATEVALIDATIONCALLBACK2__CTOR_OFFSET UNITYSDK_OFFSET(0x19EEDBB0)
