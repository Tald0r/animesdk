...
#define MONO_SECURITY_PROTOCOL_TLS_SSLSTREAMBASE_ASYNCHANDSHAKEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE3C150)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSTREAMBASE_ASYNCHANDSHAKEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE3C1B0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSTREAMBASE_ASYNCHANDSHAKEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE3BB60)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSTREAMBASE_ASYNCHANDSHAKEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE3BB50)
