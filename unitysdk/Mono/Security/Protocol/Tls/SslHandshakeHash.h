...
#define MONO_SECURITY_PROTOCOL_TLS_SSLHANDSHAKEHASH_CREATESIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B149850)
#define MONO_SECURITY_PROTOCOL_TLS_SSLHANDSHAKEHASH_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1B1497D0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLHANDSHAKEHASH_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1B149440)
#define MONO_SECURITY_PROTOCOL_TLS_SSLHANDSHAKEHASH_INITIALIZEPAD_OFFSET UNITYSDK_OFFSET(0x1B1492F0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLHANDSHAKEHASH_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1492A0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLHANDSHAKEHASH_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B149970)
#define MONO_SECURITY_PROTOCOL_TLS_SSLHANDSHAKEHASH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B149170)
