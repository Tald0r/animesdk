...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1AFE22C0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_ENCODEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1AFE2180)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1AFE1FC0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1AFE1FA0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_GET_HANDSHAKETYPE_OFFSET UNITYSDK_OFFSET(0x1AFE1FB0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_PROCESS_OFFSET UNITYSDK_OFFSET(0x1AFE20A0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AFE1BC0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AFE1FD0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AFE2070)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE1A50)
