...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_COMPARE_OFFSET UNITYSDK_OFFSET(0x1B5F4F80)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_ENCODEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1B5F4E40)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_GET_CONTENTTYPE_OFFSET UNITYSDK_OFFSET(0x1B5F4C80)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1B5F4C60)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_GET_HANDSHAKETYPE_OFFSET UNITYSDK_OFFSET(0x1B5F4C70)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_PROCESS_OFFSET UNITYSDK_OFFSET(0x1B5F4D60)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B5F4880)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B5F4C90)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B5F4D30)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_HANDSHAKEMESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F4710)
