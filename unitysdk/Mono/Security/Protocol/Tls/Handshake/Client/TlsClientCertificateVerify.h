...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_GETCLIENTCERTRSA_OFFSET UNITYSDK_OFFSET(0x1AFCD250)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_GETUNSIGNEDBIGINTEGER_OFFSET UNITYSDK_OFFSET(0x1AFCD890)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1AFCCED0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1AFCD520)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AFCCE80)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATEVERIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFCCDF0)
