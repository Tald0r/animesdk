...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATE_FINDPARENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1B5FDF90)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATE_GETCLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1B5FDBC0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATE_GET_CLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1B5FDB90)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATE_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1B5FE370)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATE_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1B5FE3B0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATE_SENDCERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1B5FDE00)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B5FDDB0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSCLIENTCERTIFICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5FDB00)
