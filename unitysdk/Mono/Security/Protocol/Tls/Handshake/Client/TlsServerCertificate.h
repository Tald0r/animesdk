...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_CHECKCERTIFICATEUSAGE_OFFSET UNITYSDK_OFFSET(0x19EEF200)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_CHECKDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x19EF00A0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_CHECKSERVERIDENTITY_OFFSET UNITYSDK_OFFSET(0x19EEFC40)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_LOCALVALIDATION_OFFSET UNITYSDK_OFFSET(0x19EEF800)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_MATCH_OFFSET UNITYSDK_OFFSET(0x19EEFE70)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x19EEF030)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x19EEF040)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_REMOTEVALIDATION_OFFSET UNITYSDK_OFFSET(0x19EEF730)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x19EEEFF0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_VALIDATECERTIFICATES_OFFSET UNITYSDK_OFFSET(0x19EEF150)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x19EEEFC0)
