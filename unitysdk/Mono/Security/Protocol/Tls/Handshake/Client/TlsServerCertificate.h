...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_CHECKCERTIFICATEUSAGE_OFFSET UNITYSDK_OFFSET(0x1A4EE740)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_CHECKDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x1A4EF5E0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_CHECKSERVERIDENTITY_OFFSET UNITYSDK_OFFSET(0x1A4EF180)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_LOCALVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A4EED40)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_MATCH_OFFSET UNITYSDK_OFFSET(0x1A4EF3B0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1A4EE570)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1A4EE580)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_REMOTEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A4EEC70)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A4EE530)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE_VALIDATECERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1A4EE690)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERCERTIFICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4EE500)
