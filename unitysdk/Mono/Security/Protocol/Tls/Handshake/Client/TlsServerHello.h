...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERHELLO_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1B6CD540)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERHELLO_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1B6CD550)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERHELLO_PROCESSPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1B6CD830)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERHELLO_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B6CD340)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_CLIENT_TLSSERVERHELLO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6CD310)
...
namespace Mono::Security::Protocol::Tls::Handshake::Client
{
	...
	public:
		...
		::Mono::Security::Protocol::Tls::CipherSuite* cipherSuite; // 0x68
