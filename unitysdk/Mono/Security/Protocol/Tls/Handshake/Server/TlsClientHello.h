...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1B4622C0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1B4622D0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_PROCESSPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1B462560)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_SELECTCIPHERSUITE_OFFSET UNITYSDK_OFFSET(0x1B462070)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_SELECTCOMPRESSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1B462290)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B462020)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B461FF0)
...
namespace Mono::Security::Protocol::Tls::Handshake::Server
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* compressionMethods; // 0x60
		::Il2CppArray<::System::Int16>* cipherSuites; // 0x68
