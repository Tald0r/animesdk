...
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_PROCESSASSSL3_OFFSET UNITYSDK_OFFSET(0x1AE50F60)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_PROCESSASTLS1_OFFSET UNITYSDK_OFFSET(0x1AE50F70)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_PROCESSPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AE51200)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_SELECTCIPHERSUITE_OFFSET UNITYSDK_OFFSET(0x1AE50D00)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_SELECTCOMPRESSIONMETHOD_OFFSET UNITYSDK_OFFSET(0x1AE50F30)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AE50CB0)
#define MONO_SECURITY_PROTOCOL_TLS_HANDSHAKE_SERVER_TLSCLIENTHELLO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE50C80)
...
namespace Mono::Security::Protocol::Tls::Handshake::Server
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* compressionMethods; // 0x68
