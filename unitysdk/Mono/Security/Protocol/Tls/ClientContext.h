...
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTCONTEXT_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AA9C430)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTCONTEXT_GET_CLIENTHELLOPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AA9C3C0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTCONTEXT_GET_SSLSTREAM_OFFSET UNITYSDK_OFFSET(0x1AA9C3B0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTCONTEXT_SET_CLIENTHELLOPROTOCOL_OFFSET UNITYSDK_OFFSET(0x1AA9C3D0)
#define MONO_SECURITY_PROTOCOL_TLS_CLIENTCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9C3E0)
