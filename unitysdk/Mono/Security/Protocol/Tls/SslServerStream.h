...
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ADD_CLIENTCERTVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1A4F1240)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ADD_CLIENTCERTVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A4F0FC0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ADD_PRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1A4F10C0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_BEGINNEGOTIATEHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1A4F1640)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A4F1600)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ENDNEGOTIATEHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x1A4F1770)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A4F1580)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_GET_CLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1A4F11C0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_GET_CLIENTCERTVALIDATIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A4F1200)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_GET_HAVEREMOTEVALIDATION2CALLBACK_OFFSET UNITYSDK_OFFSET(0x1A4F1AD0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_GET_PRIVATEKEYCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A4F1220)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ONLOCALCERTIFICATESELECTION_OFFSET UNITYSDK_OFFSET(0x1A4F1A50)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ONLOCALPRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1A4F1B10)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ONREMOTECERTIFICATEVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1A4F1AE0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_ONREMOTECERTIFICATEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A4F1AA0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_RAISECLIENTCERTIFICATEVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A4F1B00)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_RAISEPRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1A4F00A0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_REMOVE_CLIENTCERTVALIDATION2_OFFSET UNITYSDK_OFFSET(0x1A4F12C0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_REMOVE_CLIENTCERTVALIDATION_OFFSET UNITYSDK_OFFSET(0x1A4F1040)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_REMOVE_PRIVATEKEYSELECTION_OFFSET UNITYSDK_OFFSET(0x1A4F1140)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_SET_CLIENTCERTVALIDATIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A4F1210)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM_SET_PRIVATEKEYCERTSELECTIONDELEGATE_OFFSET UNITYSDK_OFFSET(0x1A4F1230)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4F13A0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A4F13D0)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A4F1370)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A4F1400)
#define MONO_SECURITY_PROTOCOL_TLS_SSLSERVERSTREAM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F1340)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::Mono::Security::Protocol::Tls::CertificateValidationCallback2* ClientCertValidation2; // 0x88
		::Mono::Security::Protocol::Tls::CertificateValidationCallback* ClientCertValidation; // 0x90
