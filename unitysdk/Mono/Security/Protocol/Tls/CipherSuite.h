...
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_CREATEDECRYPTIONCIPHER_OFFSET UNITYSDK_OFFSET(0x1AFE7EC0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_CREATEENCRYPTIONCIPHER_OFFSET UNITYSDK_OFFSET(0x1AFE77E0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_CREATEHASHALGORITHM_OFFSET UNITYSDK_OFFSET(0x1AFE72F0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_CREATEPREMASTERSECRET_OFFSET UNITYSDK_OFFSET(0x1AFE8980)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_DECRYPTRECORD_OFFSET UNITYSDK_OFFSET(0x1AFE8780)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_ENCRYPTRECORD_OFFSET UNITYSDK_OFFSET(0x1AFE85A0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_EXPAND_OFFSET UNITYSDK_OFFSET(0x1AFE8E30)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CIPHERALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1AFE72B0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CIPHERMODE_OFFSET UNITYSDK_OFFSET(0x1AFE73F0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CLIENTHMAC_OFFSET UNITYSDK_OFFSET(0x1AFE7290)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CODE_OFFSET UNITYSDK_OFFSET(0x1AFE7400)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1AFE7480)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_DECRYPTIONCIPHER_OFFSET UNITYSDK_OFFSET(0x1AFE7280)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_EFFECTIVEKEYBITS_OFFSET UNITYSDK_OFFSET(0x1AFE7460)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_ENCRYPTIONCIPHER_OFFSET UNITYSDK_OFFSET(0x1AFE7270)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_EXCHANGEALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1AFE73E0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_EXPANDEDKEYMATERIALSIZE_OFFSET UNITYSDK_OFFSET(0x1AFE7450)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_HASHALGORITHMNAME_OFFSET UNITYSDK_OFFSET(0x1AFE72C0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_HASHALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1AFE73B0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_HASHSIZE_OFFSET UNITYSDK_OFFSET(0x1AFE73C0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_ISEXPORTABLE_OFFSET UNITYSDK_OFFSET(0x1AFE7420)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_IVSIZE_OFFSET UNITYSDK_OFFSET(0x1AFE7470)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_KEYBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1AFE7440)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_KEYMATERIALSIZE_OFFSET UNITYSDK_OFFSET(0x1AFE7430)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1AFE7410)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_SERVERHMAC_OFFSET UNITYSDK_OFFSET(0x1AFE72A0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_INITIALIZECIPHER_OFFSET UNITYSDK_OFFSET(0x1AFE77C0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_PRF_OFFSET UNITYSDK_OFFSET(0x1AFE8A80)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1AFE7490)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1AFE7600)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_WRITE_OFFSET UNITYSDK_OFFSET(0x1AFE7550)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFE9390)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE74A0)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::System::Security::Cryptography::KeyedHashAlgorithm* clientHMAC; // 0x18
		::System::Security::Cryptography::SymmetricAlgorithm* encryptionAlgorithm; // 0x20
		::System::Security::Cryptography::ICryptoTransform* decryptionCipher; // 0x28
		::Mono::Security::Protocol::Tls::Context* context; // 0x30
		::System::Security::Cryptography::KeyedHashAlgorithm* serverHMAC; // 0x38
		::System::Security::Cryptography::ICryptoTransform* encryptionCipher; // 0x40
		::System::String* name; // 0x48
		::System::Security::Cryptography::CipherMode cipherMode; // 0x50
		::System::Int32 keyBlockSize; // 0x54
		::Mono::Security::Protocol::Tls::CipherAlgorithmType cipherAlgorithmType; // 0x58
		::System::Byte keyMaterialSize; // 0x5C
		::System::Int16 effectiveKeyBits; // 0x5E
		::Mono::Security::Protocol::Tls::ExchangeAlgorithmType exchangeAlgorithmType; // 0x60
		::System::Int16 code; // 0x64
		::System::Boolean isExportable; // 0x66
		::System::Byte ivSize; // 0x67
		::System::Byte blockSize; // 0x68
		::System::Byte expandedKeyMaterialSize; // 0x69
		::Mono::Security::Protocol::Tls::HashAlgorithmType hashAlgorithmType; // 0x6C
