...
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_CREATEDECRYPTIONCIPHER_OFFSET UNITYSDK_OFFSET(0x1A9F8190)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_CREATEENCRYPTIONCIPHER_OFFSET UNITYSDK_OFFSET(0x1A9F7AA0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_CREATEHASHALGORITHM_OFFSET UNITYSDK_OFFSET(0x1A9F75B0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_CREATEPREMASTERSECRET_OFFSET UNITYSDK_OFFSET(0x1A9F8C60)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_DECRYPTRECORD_OFFSET UNITYSDK_OFFSET(0x1A9F8A60)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_ENCRYPTRECORD_OFFSET UNITYSDK_OFFSET(0x1A9F8880)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_EXPAND_OFFSET UNITYSDK_OFFSET(0x1A9F9120)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CIPHERALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1A9F7570)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CIPHERMODE_OFFSET UNITYSDK_OFFSET(0x1A9F76B0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CLIENTHMAC_OFFSET UNITYSDK_OFFSET(0x1A9F7550)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CODE_OFFSET UNITYSDK_OFFSET(0x1A9F76C0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1A9F7740)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_DECRYPTIONCIPHER_OFFSET UNITYSDK_OFFSET(0x1A9F7540)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_EFFECTIVEKEYBITS_OFFSET UNITYSDK_OFFSET(0x1A9F7720)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_ENCRYPTIONCIPHER_OFFSET UNITYSDK_OFFSET(0x1A9F7530)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_EXCHANGEALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1A9F76A0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_EXPANDEDKEYMATERIALSIZE_OFFSET UNITYSDK_OFFSET(0x1A9F7710)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_HASHALGORITHMNAME_OFFSET UNITYSDK_OFFSET(0x1A9F7580)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_HASHALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1A9F7670)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_HASHSIZE_OFFSET UNITYSDK_OFFSET(0x1A9F7680)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_ISEXPORTABLE_OFFSET UNITYSDK_OFFSET(0x1A9F76E0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_IVSIZE_OFFSET UNITYSDK_OFFSET(0x1A9F7730)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_KEYBLOCKSIZE_OFFSET UNITYSDK_OFFSET(0x1A9F7700)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_KEYMATERIALSIZE_OFFSET UNITYSDK_OFFSET(0x1A9F76F0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A9F76D0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_GET_SERVERHMAC_OFFSET UNITYSDK_OFFSET(0x1A9F7560)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_INITIALIZECIPHER_OFFSET UNITYSDK_OFFSET(0x1A9F7A80)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_PRF_OFFSET UNITYSDK_OFFSET(0x1A9F8D70)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_SET_CONTEXT_OFFSET UNITYSDK_OFFSET(0x1A9F7750)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_WRITE_1_OFFSET UNITYSDK_OFFSET(0x1A9F78C0)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE_WRITE_OFFSET UNITYSDK_OFFSET(0x1A9F7810)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9F9680)
#define MONO_SECURITY_PROTOCOL_TLS_CIPHERSUITE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9F7760)
...
namespace Mono::Security::Protocol::Tls
{
	...
	public:
		...
		::System::Security::Cryptography::KeyedHashAlgorithm* serverHMAC; // 0x10
		::System::Security::Cryptography::ICryptoTransform* encryptionCipher; // 0x18
		::System::Security::Cryptography::SymmetricAlgorithm* decryptionAlgorithm; // 0x20
		...
		::System::Boolean isExportable; // 0x58
		::System::Byte expandedKeyMaterialSize; // 0x59
		::System::Byte blockSize; // 0x5A
		::System::Int16 effectiveKeyBits; // 0x5C
		::System::Int16 code; // 0x5E
		::System::Byte keyMaterialSize; // 0x60
		::System::Byte ivSize; // 0x61
		::Mono::Security::Protocol::Tls::HashAlgorithmType hashAlgorithmType; // 0x64
		::System::Security::Cryptography::CipherMode cipherMode; // 0x68
		::Mono::Security::Protocol::Tls::CipherAlgorithmType cipherAlgorithmType; // 0x6C
