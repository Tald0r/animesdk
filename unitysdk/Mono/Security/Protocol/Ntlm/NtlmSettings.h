...
#define MONO_SECURITY_PROTOCOL_NTLM_NTLMSETTINGS_GET_DEFAULTAUTHLEVEL_OFFSET UNITYSDK_OFFSET(0x1B6CCBE0)
#define MONO_SECURITY_PROTOCOL_NTLM_NTLMSETTINGS_SET_DEFAULTAUTHLEVEL_OFFSET UNITYSDK_OFFSET(0x1B6CCC40)
#define MONO_SECURITY_PROTOCOL_NTLM_NTLMSETTINGS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B6CCCA0)
