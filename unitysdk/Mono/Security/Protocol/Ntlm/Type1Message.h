...
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE1MESSAGE_DECODE_OFFSET UNITYSDK_OFFSET(0x1B5FD370)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE1MESSAGE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1B5FD650)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE1MESSAGE_GET_DOMAIN_OFFSET UNITYSDK_OFFSET(0x1B5FD530)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE1MESSAGE_GET_HOST_OFFSET UNITYSDK_OFFSET(0x1B5FD5C0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE1MESSAGE_SET_DOMAIN_OFFSET UNITYSDK_OFFSET(0x1B5FD540)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE1MESSAGE_SET_HOST_OFFSET UNITYSDK_OFFSET(0x1B5FD5D0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE1MESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B5FD300)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE1MESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5FD290)
