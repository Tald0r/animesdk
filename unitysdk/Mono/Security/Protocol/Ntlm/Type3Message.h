...
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_DECODESTRING_OFFSET UNITYSDK_OFFSET(0x1A9F66D0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_DECODE_OFFSET UNITYSDK_OFFSET(0x1A9F5A70)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_ENCODESTRING_OFFSET UNITYSDK_OFFSET(0x1A9F67F0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A9F6140)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1A9F6920)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_CHALLENGE_OFFSET UNITYSDK_OFFSET(0x1A9F62C0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_DEFAULTAUTHLEVEL_OFFSET UNITYSDK_OFFSET(0x1A9F61E0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_DOMAIN_OFFSET UNITYSDK_OFFSET(0x1A9F6540)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_HOST_OFFSET UNITYSDK_OFFSET(0x1A9F65D0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A9F62A0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_LM_OFFSET UNITYSDK_OFFSET(0x1A9F66A0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_NT_OFFSET UNITYSDK_OFFSET(0x1A9F66B0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1A9F6660)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_GET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1A9F6680)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_CHALLENGE_OFFSET UNITYSDK_OFFSET(0x1A9F6390)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_DEFAULTAUTHLEVEL_OFFSET UNITYSDK_OFFSET(0x1A9F6240)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_DOMAIN_OFFSET UNITYSDK_OFFSET(0x1A9F6550)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_HOST_OFFSET UNITYSDK_OFFSET(0x1A9F65E0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1A9F62B0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_NT_OFFSET UNITYSDK_OFFSET(0x1A9F66C0)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_PASSWORD_OFFSET UNITYSDK_OFFSET(0x1A9F6670)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE_SET_USERNAME_OFFSET UNITYSDK_OFFSET(0x1A9F6690)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9F5A00)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A9F5F70)
#define MONO_SECURITY_PROTOCOL_NTLM_TYPE3MESSAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9F5910)
...
namespace Mono::Security::Protocol::Ntlm
{
	...
	public:
		...
		::Mono::Security::Protocol::Ntlm::Type2Message* _type2; // 0x20
		::Il2CppArray<::System::Byte>* _nt; // 0x28
