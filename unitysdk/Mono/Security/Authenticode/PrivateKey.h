...
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_CREATEFROMFILE_1_OFFSET UNITYSDK_OFFSET(0x1B0D6810)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_CREATEFROMFILE_OFFSET UNITYSDK_OFFSET(0x1B0D6800)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_DECODE_OFFSET UNITYSDK_OFFSET(0x1B0D5830)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_DERIVEKEY_OFFSET UNITYSDK_OFFSET(0x1B0D5D80)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_ENCRYPTED_OFFSET UNITYSDK_OFFSET(0x1B0D5D00)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_KEYTYPE_OFFSET UNITYSDK_OFFSET(0x1B0D5D10)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_RSA_OFFSET UNITYSDK_OFFSET(0x1B0D5D30)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_WEAK_OFFSET UNITYSDK_OFFSET(0x1B0D5D50)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SAVE_1_OFFSET UNITYSDK_OFFSET(0x1B0D5F50)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SAVE_OFFSET UNITYSDK_OFFSET(0x1B0D5F40)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SET_KEYTYPE_OFFSET UNITYSDK_OFFSET(0x1B0D5D20)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SET_RSA_OFFSET UNITYSDK_OFFSET(0x1B0D5D40)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SET_WEAK_OFFSET UNITYSDK_OFFSET(0x1B0D5D70)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0D5780)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D5770)
