...
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_CREATEFROMFILE_1_OFFSET UNITYSDK_OFFSET(0x1AA9A4D0)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_CREATEFROMFILE_OFFSET UNITYSDK_OFFSET(0x1AA9A4C0)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_DECODE_OFFSET UNITYSDK_OFFSET(0x1AA994F0)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_DERIVEKEY_OFFSET UNITYSDK_OFFSET(0x1AA99A40)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_ENCRYPTED_OFFSET UNITYSDK_OFFSET(0x1AA999C0)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_KEYTYPE_OFFSET UNITYSDK_OFFSET(0x1AA999D0)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_RSA_OFFSET UNITYSDK_OFFSET(0x1AA999F0)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_GET_WEAK_OFFSET UNITYSDK_OFFSET(0x1AA99A10)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SAVE_1_OFFSET UNITYSDK_OFFSET(0x1AA99C10)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SAVE_OFFSET UNITYSDK_OFFSET(0x1AA99C00)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SET_KEYTYPE_OFFSET UNITYSDK_OFFSET(0x1AA999E0)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SET_RSA_OFFSET UNITYSDK_OFFSET(0x1AA99A00)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY_SET_WEAK_OFFSET UNITYSDK_OFFSET(0x1AA99A30)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA99440)
#define MONO_SECURITY_AUTHENTICODE_PRIVATEKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA99430)
