...
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_CHECKSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1AA97010)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_COMPAREISSUERSERIAL_OFFSET UNITYSDK_OFFSET(0x1AA984B0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1AA97820)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1AA96F90)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_HASH_OFFSET UNITYSDK_OFFSET(0x1AA974F0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_REASON_OFFSET UNITYSDK_OFFSET(0x1AA975D0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1AA97740)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_SIGNINGCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1AA97830)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1AA97810)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_ISTRUSTED_OFFSET UNITYSDK_OFFSET(0x1AA97600)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_RESET_OFFSET UNITYSDK_OFFSET(0x1AA96FA0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1AA96E80)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_VERIFYCOUNTERSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1AA987B0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1AA97840)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AA96CF0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA96B80)
...
namespace Mono::Security::Authenticode
{
	...
	public:
		...
		::Mono::Security::X509::X509Chain* timestampChain; // 0x70
		::System::DateTime timestamp; // 0x78
		::System::Boolean trustedRoot; // 0x80
		::System::Boolean trustedTimestampRoot; // 0x81
		::System::Int32 reason; // 0x84
