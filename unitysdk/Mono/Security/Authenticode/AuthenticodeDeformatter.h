...
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_CHECKSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B0D3350)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_COMPAREISSUERSERIAL_OFFSET UNITYSDK_OFFSET(0x1B0D47F0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1B0D3B60)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1B0D32D0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_HASH_OFFSET UNITYSDK_OFFSET(0x1B0D3830)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_REASON_OFFSET UNITYSDK_OFFSET(0x1B0D3910)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B0D3A80)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_SIGNINGCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1B0D3B70)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_GET_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1B0D3B50)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_ISTRUSTED_OFFSET UNITYSDK_OFFSET(0x1B0D3940)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_RESET_OFFSET UNITYSDK_OFFSET(0x1B0D32E0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_SET_FILENAME_OFFSET UNITYSDK_OFFSET(0x1B0D31C0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_VERIFYCOUNTERSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B0D4AF0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER_VERIFYSIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B0D3B80)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0D3030)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEDEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D2EC0)
...
namespace Mono::Security::Authenticode
{
	...
	{
	public:
		::Mono::Security::X509::X509Chain* timestampChain; // 0x38
		::Mono::Security::X509::X509Chain* signerChain; // 0x40
		::Il2CppArray<::System::Byte>* hash; // 0x48
		::Il2CppArray<::System::Byte>* entry; // 0x50
		::System::String* filename; // 0x58
		::Mono::Security::X509::X509CertificateCollection* coll; // 0x60
		::Mono::Security::X509::X509Certificate* signingCertificate; // 0x68
		::Mono::Security::ASN1* signedHash; // 0x70
		::System::DateTime timestamp; // 0x78
		::System::Int32 reason; // 0x80
		::System::Boolean trustedTimestampRoot; // 0x84
		::System::Boolean trustedRoot; // 0x85
