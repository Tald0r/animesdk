...
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_CREATEFROMFILE_OFFSET UNITYSDK_OFFSET(0x1B44FA00)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1B44F8C0)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1B44F880)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_GET_CRLS_OFFSET UNITYSDK_OFFSET(0x1B44F8A0)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_PEM_OFFSET UNITYSDK_OFFSET(0x1B44FCC0)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B44F6A0)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B44F630)
