...
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_CREATEFROMFILE_OFFSET UNITYSDK_OFFSET(0x1AE38810)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1AE386D0)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1AE38690)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_GET_CRLS_OFFSET UNITYSDK_OFFSET(0x1AE386B0)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE_PEM_OFFSET UNITYSDK_OFFSET(0x1AE38AD0)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE384B0)
#define MONO_SECURITY_AUTHENTICODE_SOFTWAREPUBLISHERCERTIFICATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE38440)
