...
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_ALGORITHMIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A4E98C0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_ATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A4E9A00)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_AUTHORITY_OFFSET UNITYSDK_OFFSET(0x1A4E9660)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1A4E9680)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_CRL_OFFSET UNITYSDK_OFFSET(0x1A4E9690)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A4E9880)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_HASH_OFFSET UNITYSDK_OFFSET(0x1A4E96A0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_RSA_OFFSET UNITYSDK_OFFSET(0x1A4E9840)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_TIMESTAMPURL_OFFSET UNITYSDK_OFFSET(0x1A4E9860)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_URL_OFFSET UNITYSDK_OFFSET(0x1A4E98A0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_HEADER_OFFSET UNITYSDK_OFFSET(0x1A4E9F00)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_OPUS_OFFSET UNITYSDK_OFFSET(0x1A4E9BA0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_PROCESSTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1A4EA5A0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SAVE_OFFSET UNITYSDK_OFFSET(0x1A4EABF0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_AUTHORITY_OFFSET UNITYSDK_OFFSET(0x1A4E9670)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1A4E9890)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_HASH_OFFSET UNITYSDK_OFFSET(0x1A4E96C0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_RSA_OFFSET UNITYSDK_OFFSET(0x1A4E9850)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_TIMESTAMPURL_OFFSET UNITYSDK_OFFSET(0x1A4E9870)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_URL_OFFSET UNITYSDK_OFFSET(0x1A4E98B0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SIGN_OFFSET UNITYSDK_OFFSET(0x1A4EB030)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_TIMESTAMPREQUEST_OFFSET UNITYSDK_OFFSET(0x1A4EA480)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_TIMESTAMP_1_OFFSET UNITYSDK_OFFSET(0x1A4EB330)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x1A4EA8F0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4EBAA0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E9550)
...
namespace Mono::Security::Authenticode
{
	...
	public:
		...
		::System::Uri* url; // 0x38
		::System::String* hash; // 0x40
		::Mono::Security::ASN1* authenticode; // 0x48
		::System::Security::Cryptography::RSA* rsa; // 0x50
		::System::Uri* timestamp; // 0x58
		::Mono::Security::PKCS7_SignedData* pkcs7; // 0x60
		::Mono::Security::X509::X509CertificateCollection* certs; // 0x68
		::System::String* description; // 0x70
		::System::Collections::ArrayList* crls; // 0x78
