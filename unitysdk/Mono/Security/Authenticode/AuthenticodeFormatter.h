...
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_ALGORITHMIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x19EEA390)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_ATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x19EEA4D0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_AUTHORITY_OFFSET UNITYSDK_OFFSET(0x19EEA130)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_CERTIFICATES_OFFSET UNITYSDK_OFFSET(0x19EEA150)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_CRL_OFFSET UNITYSDK_OFFSET(0x19EEA160)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19EEA350)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_HASH_OFFSET UNITYSDK_OFFSET(0x19EEA170)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_RSA_OFFSET UNITYSDK_OFFSET(0x19EEA310)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_TIMESTAMPURL_OFFSET UNITYSDK_OFFSET(0x19EEA330)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_GET_URL_OFFSET UNITYSDK_OFFSET(0x19EEA370)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_HEADER_OFFSET UNITYSDK_OFFSET(0x19EEA9D0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_OPUS_OFFSET UNITYSDK_OFFSET(0x19EEA670)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_PROCESSTIMESTAMP_OFFSET UNITYSDK_OFFSET(0x19EEB070)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SAVE_OFFSET UNITYSDK_OFFSET(0x19EEB6D0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_AUTHORITY_OFFSET UNITYSDK_OFFSET(0x19EEA140)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x19EEA360)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_HASH_OFFSET UNITYSDK_OFFSET(0x19EEA190)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_RSA_OFFSET UNITYSDK_OFFSET(0x19EEA320)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_TIMESTAMPURL_OFFSET UNITYSDK_OFFSET(0x19EEA340)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SET_URL_OFFSET UNITYSDK_OFFSET(0x19EEA380)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_SIGN_OFFSET UNITYSDK_OFFSET(0x19EEBB10)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_TIMESTAMPREQUEST_OFFSET UNITYSDK_OFFSET(0x19EEAF50)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_TIMESTAMP_1_OFFSET UNITYSDK_OFFSET(0x19EEBE10)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER_TIMESTAMP_OFFSET UNITYSDK_OFFSET(0x19EEB3C0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EEC580)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19EEA020)
...
namespace Mono::Security::Authenticode
{
	...
	public:
		...
		::System::Uri* timestamp; // 0x38
		::System::Uri* url; // 0x40
		::System::String* hash; // 0x48
		::System::String* description; // 0x50
		::Mono::Security::X509::X509CertificateCollection* certs; // 0x58
		::System::Collections::ArrayList* crls; // 0x60
		::Mono::Security::ASN1* authenticode; // 0x68
		::System::Security::Cryptography::RSA* rsa; // 0x70
		::Mono::Security::PKCS7_SignedData* pkcs7; // 0x78
