...
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_CLOSE_OFFSET UNITYSDK_OFFSET(0x1AFDF060)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_GETHASH_OFFSET UNITYSDK_OFFSET(0x1AFDF450)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_GETSECURITYENTRY_OFFSET UNITYSDK_OFFSET(0x1AFDF340)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_GET_COFFSYMBOLTABLEOFFSET_OFFSET UNITYSDK_OFFSET(0x1AFDEF60)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_GET_PEOFFSET_OFFSET UNITYSDK_OFFSET(0x1AFDEE70)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_GET_SECURITYOFFSET_OFFSET UNITYSDK_OFFSET(0x1AFDEF80)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_HASHFILE_OFFSET UNITYSDK_OFFSET(0x1AFDF9A0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_OPEN_OFFSET UNITYSDK_OFFSET(0x1AFDEFA0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_PROCESSFIRSTBLOCK_OFFSET UNITYSDK_OFFSET(0x1AFDF0D0)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE_READFIRSTBLOCK_OFFSET UNITYSDK_OFFSET(0x1AFDEE90)
#define MONO_SECURITY_AUTHENTICODE_AUTHENTICODEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFDEE40)
...
namespace Mono::Security::Authenticode
{
	...
	public:
		...
		::System::Int32 peOffset; // 0x24
		::System::Int32 dirSecuritySize; // 0x28
		::System::Int32 blockNo; // 0x2C
