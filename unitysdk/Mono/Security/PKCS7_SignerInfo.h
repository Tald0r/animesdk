...
#define MONO_SECURITY_PKCS7_SIGNERINFO_GETASN1_OFFSET UNITYSDK_OFFSET(0x1B148180)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1B1490F0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1B148170)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_AUTHENTICATEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B148EA0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_CERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1B148EB0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_HASHNAME_OFFSET UNITYSDK_OFFSET(0x1B148ED0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_ISSUERNAME_OFFSET UNITYSDK_OFFSET(0x1B147FC0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1B148EF0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x1B147FD0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B148F10)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_SUBJECTKEYIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B1480A0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_UNAUTHENTICATEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1B1490C0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B1490D0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_SET_CERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1B148EC0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_SET_HASHNAME_OFFSET UNITYSDK_OFFSET(0x1B148EE0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1B148F00)
#define MONO_SECURITY_PKCS7_SIGNERINFO_SET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1B148FE0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B1490E0)
#define MONO_SECURITY_PKCS7_SIGNERINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B147AA0)
#define MONO_SECURITY_PKCS7_SIGNERINFO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B147B00)
#define MONO_SECURITY_PKCS7_SIGNERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B147A10)
...
namespace Mono::Security
{
	...
	public:
		...
		::System::Collections::ArrayList* unauthenticatedAttributes; // 0x18
		::Il2CppArray<::System::Byte>* serial; // 0x20
		::Mono::Security::X509::X509Certificate* x509; // 0x28
		...
		::Il2CppArray<::System::Byte>* ski; // 0x48
		::System::Security::Cryptography::AsymmetricAlgorithm* key; // 0x50
