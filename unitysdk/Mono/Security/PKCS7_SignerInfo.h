...
#define MONO_SECURITY_PKCS7_SIGNERINFO_GETASN1_OFFSET UNITYSDK_OFFSET(0x1AAF60E0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1AAF7050)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1AAF60D0)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_AUTHENTICATEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AAF6E00)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_CERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1AAF6E10)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_HASHNAME_OFFSET UNITYSDK_OFFSET(0x1AAF6E30)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_ISSUERNAME_OFFSET UNITYSDK_OFFSET(0x1AAF5F20)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1AAF6E50)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_SERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x1AAF5F30)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1AAF6E70)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_SUBJECTKEYIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1AAF6000)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_UNAUTHENTICATEDATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x1AAF7020)
#define MONO_SECURITY_PKCS7_SIGNERINFO_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AAF7030)
#define MONO_SECURITY_PKCS7_SIGNERINFO_SET_CERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1AAF6E20)
#define MONO_SECURITY_PKCS7_SIGNERINFO_SET_HASHNAME_OFFSET UNITYSDK_OFFSET(0x1AAF6E40)
#define MONO_SECURITY_PKCS7_SIGNERINFO_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1AAF6E60)
#define MONO_SECURITY_PKCS7_SIGNERINFO_SET_SIGNATURE_OFFSET UNITYSDK_OFFSET(0x1AAF6F40)
#define MONO_SECURITY_PKCS7_SIGNERINFO_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AAF7040)
#define MONO_SECURITY_PKCS7_SIGNERINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AAF5A00)
#define MONO_SECURITY_PKCS7_SIGNERINFO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AAF5A60)
#define MONO_SECURITY_PKCS7_SIGNERINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAF5970)
...
namespace Mono::Security
{
	...
	{
	public:
		::System::Collections::ArrayList* authenticatedAttributes; // 0x10
		...
		::System::String* hashAlgorithm; // 0x48
		::Il2CppArray<::System::Byte>* ski; // 0x50
