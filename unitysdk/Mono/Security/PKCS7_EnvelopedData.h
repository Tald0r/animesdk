...
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GETASN1_OFFSET UNITYSDK_OFFSET(0x1AE3A580)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1AE3A6D0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1AE3A540)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_CONTENTINFO_OFFSET UNITYSDK_OFFSET(0x1AE3A5C0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_ENCRYPTEDCONTENT_OFFSET UNITYSDK_OFFSET(0x1AE3A5E0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_ENCRYPTIONALGORITHM_OFFSET UNITYSDK_OFFSET(0x1AE3A5D0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_RECIPIENTINFOS_OFFSET UNITYSDK_OFFSET(0x1AE3A530)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AE3A6B0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AE3A6C0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE39FC0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AE3A020)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE39EA0)
...
namespace Mono::Security
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* _encrypted; // 0x28
