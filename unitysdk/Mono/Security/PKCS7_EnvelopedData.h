...
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GETASN1_OFFSET UNITYSDK_OFFSET(0x1B451770)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1B4518C0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_ASN1_OFFSET UNITYSDK_OFFSET(0x1B451730)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_CONTENTINFO_OFFSET UNITYSDK_OFFSET(0x1B4517B0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_ENCRYPTEDCONTENT_OFFSET UNITYSDK_OFFSET(0x1B4517D0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_ENCRYPTIONALGORITHM_OFFSET UNITYSDK_OFFSET(0x1B4517C0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_RECIPIENTINFOS_OFFSET UNITYSDK_OFFSET(0x1B451720)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B4518A0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B4518B0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4511B0)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B451210)
#define MONO_SECURITY_PKCS7_ENVELOPEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B451090)
