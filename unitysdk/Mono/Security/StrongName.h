...
#define MONO_SECURITY_STRONGNAME_GETBYTES_OFFSET UNITYSDK_OFFSET(0x1A4F2E70)
#define MONO_SECURITY_STRONGNAME_GET_CANSIGN_OFFSET UNITYSDK_OFFSET(0x1A4F23B0)
#define MONO_SECURITY_STRONGNAME_GET_PUBLICKEYTOKEN_OFFSET UNITYSDK_OFFSET(0x1A4F2B40)
#define MONO_SECURITY_STRONGNAME_GET_PUBLICKEY_OFFSET UNITYSDK_OFFSET(0x1A4F25D0)
#define MONO_SECURITY_STRONGNAME_GET_RSA_OFFSET UNITYSDK_OFFSET(0x1A4F2580)
#define MONO_SECURITY_STRONGNAME_GET_TOKENALGORITHM_OFFSET UNITYSDK_OFFSET(0x1A4F2CF0)
#define MONO_SECURITY_STRONGNAME_HASH_OFFSET UNITYSDK_OFFSET(0x1A4F39C0)
#define MONO_SECURITY_STRONGNAME_INVALIDATECACHE_OFFSET UNITYSDK_OFFSET(0x1A4F2390)
#define MONO_SECURITY_STRONGNAME_RVATOPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4F2EC0)
#define MONO_SECURITY_STRONGNAME_SET_RSA_OFFSET UNITYSDK_OFFSET(0x1A4F22F0)
#define MONO_SECURITY_STRONGNAME_SET_TOKENALGORITHM_OFFSET UNITYSDK_OFFSET(0x1A4F2D10)
#define MONO_SECURITY_STRONGNAME_SIGN_OFFSET UNITYSDK_OFFSET(0x1A4F3A90)
#define MONO_SECURITY_STRONGNAME_STRONGHASH_OFFSET UNITYSDK_OFFSET(0x1A4F2F90)
#define MONO_SECURITY_STRONGNAME_VERIFY_1_OFFSET UNITYSDK_OFFSET(0x1A4F40E0)
#define MONO_SECURITY_STRONGNAME_VERIFY_2_OFFSET UNITYSDK_OFFSET(0x1A4F42C0)
#define MONO_SECURITY_STRONGNAME_VERIFY_OFFSET UNITYSDK_OFFSET(0x1A4F3F90)
#define MONO_SECURITY_STRONGNAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4F2070)
#define MONO_SECURITY_STRONGNAME__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A4F2130)
#define MONO_SECURITY_STRONGNAME__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A4F2310)
#define MONO_SECURITY_STRONGNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F2060)
...
namespace Mono::Security
{
	...
	public:
		...
		::Il2CppArray<::System::Byte>* publicKey; // 0x28
