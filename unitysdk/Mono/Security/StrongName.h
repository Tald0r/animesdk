...
#define MONO_SECURITY_STRONGNAME_GETBYTES_OFFSET UNITYSDK_OFFSET(0x19EF3960)
#define MONO_SECURITY_STRONGNAME_GET_CANSIGN_OFFSET UNITYSDK_OFFSET(0x19EF2EA0)
#define MONO_SECURITY_STRONGNAME_GET_PUBLICKEYTOKEN_OFFSET UNITYSDK_OFFSET(0x19EF3630)
#define MONO_SECURITY_STRONGNAME_GET_PUBLICKEY_OFFSET UNITYSDK_OFFSET(0x19EF30C0)
#define MONO_SECURITY_STRONGNAME_GET_RSA_OFFSET UNITYSDK_OFFSET(0x19EF3070)
#define MONO_SECURITY_STRONGNAME_GET_TOKENALGORITHM_OFFSET UNITYSDK_OFFSET(0x19EF37E0)
#define MONO_SECURITY_STRONGNAME_HASH_OFFSET UNITYSDK_OFFSET(0x19EF44B0)
#define MONO_SECURITY_STRONGNAME_INVALIDATECACHE_OFFSET UNITYSDK_OFFSET(0x19EF2E80)
#define MONO_SECURITY_STRONGNAME_RVATOPOSITION_OFFSET UNITYSDK_OFFSET(0x19EF39B0)
#define MONO_SECURITY_STRONGNAME_SET_RSA_OFFSET UNITYSDK_OFFSET(0x19EF2DE0)
#define MONO_SECURITY_STRONGNAME_SET_TOKENALGORITHM_OFFSET UNITYSDK_OFFSET(0x19EF3800)
#define MONO_SECURITY_STRONGNAME_SIGN_OFFSET UNITYSDK_OFFSET(0x19EF4580)
#define MONO_SECURITY_STRONGNAME_STRONGHASH_OFFSET UNITYSDK_OFFSET(0x19EF3A80)
#define MONO_SECURITY_STRONGNAME_VERIFY_1_OFFSET UNITYSDK_OFFSET(0x19EF4BD0)
#define MONO_SECURITY_STRONGNAME_VERIFY_2_OFFSET UNITYSDK_OFFSET(0x19EF4DB0)
#define MONO_SECURITY_STRONGNAME_VERIFY_OFFSET UNITYSDK_OFFSET(0x19EF4A80)
#define MONO_SECURITY_STRONGNAME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19EF2B60)
#define MONO_SECURITY_STRONGNAME__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19EF2C20)
#define MONO_SECURITY_STRONGNAME__CTOR_3_OFFSET UNITYSDK_OFFSET(0x19EF2E00)
#define MONO_SECURITY_STRONGNAME__CTOR_OFFSET UNITYSDK_OFFSET(0x19EF2B50)
...
namespace Mono::Security
{
	...
	public:
		...
		::System::String* tokenAlgorithm; // 0x18
