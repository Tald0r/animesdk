...
#define MONO_SECURITY_PKCS7_ALGORITHMIDENTIFIER_1_OFFSET UNITYSDK_OFFSET(0x1B450CF0)
#define MONO_SECURITY_PKCS7_ALGORITHMIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1B450BB0)
#define MONO_SECURITY_PKCS7_ATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1B450A10)
#define MONO_SECURITY_PKCS7_ISSUERANDSERIALNUMBER_OFFSET UNITYSDK_OFFSET(0x1B450E20)
#define MONO_SECURITY_PKCS7__CTOR_OFFSET UNITYSDK_OFFSET(0x1B450A00)
