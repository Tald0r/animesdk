...
#define MONO_SECURITY_INTERFACE_TLSEXCEPTION_GET_ALERT_OFFSET UNITYSDK_OFFSET(0x1A9F5440)
#define MONO_SECURITY_INTERFACE_TLSEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9F5540)
#define MONO_SECURITY_INTERFACE_TLSEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A9F55B0)
#define MONO_SECURITY_INTERFACE_TLSEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A9F5600)
#define MONO_SECURITY_INTERFACE_TLSEXCEPTION__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A9F5680)
#define MONO_SECURITY_INTERFACE_TLSEXCEPTION__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A9F5780)
#define MONO_SECURITY_INTERFACE_TLSEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9F5450)
