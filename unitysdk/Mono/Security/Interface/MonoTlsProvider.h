...
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDER_GETNATIVECERTIFICATE_1_OFFSET UNITYSDK_OFFSET(0x1B6ED9D0)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDER_GETNATIVECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x1B6ED980)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDER_GET_HASNATIVECERTIFICATES_OFFSET UNITYSDK_OFFSET(0x1B6ED970)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6ED960)
