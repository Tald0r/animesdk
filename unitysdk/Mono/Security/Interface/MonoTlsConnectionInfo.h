...
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_CIPHERALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1B0D8440)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_CIPHERSUITECODE_OFFSET UNITYSDK_OFFSET(0x1B0D8400)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_EXCHANGEALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1B0D8480)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_HASHALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1B0D8460)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_PEERDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x1B0D84A0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_GET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x1B0D8420)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_CIPHERALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1B0D8450)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_CIPHERSUITECODE_OFFSET UNITYSDK_OFFSET(0x1B0D8410)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_EXCHANGEALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1B0D8490)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_HASHALGORITHMTYPE_OFFSET UNITYSDK_OFFSET(0x1B0D8470)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_PEERDOMAINNAME_OFFSET UNITYSDK_OFFSET(0x1B0D84B0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_SET_PROTOCOLVERSION_OFFSET UNITYSDK_OFFSET(0x1B0D8430)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0D84C0)
#define MONO_SECURITY_INTERFACE_MONOTLSCONNECTIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D8560)
...
namespace Mono::Security::Interface
{
	...
	public:
		...
		::Mono::Security::Interface::CipherAlgorithmType _CipherAlgorithmType_k__BackingField; // 0x20
