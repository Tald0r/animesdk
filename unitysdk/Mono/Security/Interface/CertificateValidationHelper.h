...
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GETDEFAULTVALIDATOR_OFFSET UNITYSDK_OFFSET(0x19EED360)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GETINTERNALVALIDATOR_OFFSET UNITYSDK_OFFSET(0x19EED2F0)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GETVALIDATOR_OFFSET UNITYSDK_OFFSET(0x19EED410)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GET_SUPPORTSTRUSTANCHORS_OFFSET UNITYSDK_OFFSET(0x19EED290)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GET_SUPPORTSX509CHAIN_OFFSET UNITYSDK_OFFSET(0x19EED230)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19EED150)
