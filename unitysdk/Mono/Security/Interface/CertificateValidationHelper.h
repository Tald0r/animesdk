...
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GETDEFAULTVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1A4EC890)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GETINTERNALVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1A4EC820)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GETVALIDATOR_OFFSET UNITYSDK_OFFSET(0x1A4EC940)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GET_SUPPORTSTRUSTANCHORS_OFFSET UNITYSDK_OFFSET(0x1A4EC7C0)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER_GET_SUPPORTSX509CHAIN_OFFSET UNITYSDK_OFFSET(0x1A4EC760)
#define MONO_SECURITY_INTERFACE_CERTIFICATEVALIDATIONHELPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4EC680)
