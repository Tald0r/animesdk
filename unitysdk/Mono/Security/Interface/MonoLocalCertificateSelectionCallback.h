...
#define MONO_SECURITY_INTERFACE_MONOLOCALCERTIFICATESELECTIONCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0DCD60)
#define MONO_SECURITY_INTERFACE_MONOLOCALCERTIFICATESELECTIONCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0DCDB0)
#define MONO_SECURITY_INTERFACE_MONOLOCALCERTIFICATESELECTIONCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0DC6B0)
#define MONO_SECURITY_INTERFACE_MONOLOCALCERTIFICATESELECTIONCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0DC6A0)
