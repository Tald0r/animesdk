...
#define MONO_SECURITY_INTERFACE_ALERT_GETALERTMESSAGE_OFFSET UNITYSDK_OFFSET(0x1B0D83C0)
#define MONO_SECURITY_INTERFACE_ALERT_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1B0D8210)
#define MONO_SECURITY_INTERFACE_ALERT_GET_ISCLOSENOTIFY_OFFSET UNITYSDK_OFFSET(0x1B0D8270)
#define MONO_SECURITY_INTERFACE_ALERT_GET_ISWARNING_OFFSET UNITYSDK_OFFSET(0x1B0D8260)
#define MONO_SECURITY_INTERFACE_ALERT_GET_LEVEL_OFFSET UNITYSDK_OFFSET(0x1B0D8200)
#define MONO_SECURITY_INTERFACE_ALERT_GET_MESSAGE_OFFSET UNITYSDK_OFFSET(0x1B0D8220)
#define MONO_SECURITY_INTERFACE_ALERT_INFERALERTLEVEL_OFFSET UNITYSDK_OFFSET(0x1B0D82D0)
#define MONO_SECURITY_INTERFACE_ALERT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0D8320)
#define MONO_SECURITY_INTERFACE_ALERT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0D8310)
#define MONO_SECURITY_INTERFACE_ALERT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0D8290)
