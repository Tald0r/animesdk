...
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDERFACTORY_CREATEHTTPLISTENER_OFFSET UNITYSDK_OFFSET(0x1AAF5220)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDERFACTORY_CREATEHTTPSREQUEST_OFFSET UNITYSDK_OFFSET(0x1AAF5210)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDERFACTORY_GETMONOSSLSTREAM_1_OFFSET UNITYSDK_OFFSET(0x1AAF5340)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDERFACTORY_GETMONOSSLSTREAM_OFFSET UNITYSDK_OFFSET(0x1AAF5280)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDERFACTORY_GETPROVIDER_1_OFFSET UNITYSDK_OFFSET(0x1AAF50E0)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDERFACTORY_GETPROVIDER_OFFSET UNITYSDK_OFFSET(0x1AAF4E30)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDERFACTORY_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1AAF4EE0)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDERFACTORY_INITIALIZE_1_OFFSET UNITYSDK_OFFSET(0x1AAF4FE0)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDERFACTORY_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AAF4F40)
#define MONO_SECURITY_INTERFACE_MONOTLSPROVIDERFACTORY_ISPROVIDERSUPPORTED_OFFSET UNITYSDK_OFFSET(0x1AAF5080)
