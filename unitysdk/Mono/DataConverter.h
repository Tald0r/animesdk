...
#define MONO_DATACONVERTER_ALIGN_OFFSET UNITYSDK_OFFSET(0x19AF0DE0)
#define MONO_DATACONVERTER_CHECK_OFFSET UNITYSDK_OFFSET(0x19AF42F0)
#define MONO_DATACONVERTER_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x19AF0AC0)
#define MONO_DATACONVERTER_GETBYTES_2_OFFSET UNITYSDK_OFFSET(0x19AF0B20)
#define MONO_DATACONVERTER_GETBYTES_3_OFFSET UNITYSDK_OFFSET(0x19AF0B70)
#define MONO_DATACONVERTER_GETBYTES_4_OFFSET UNITYSDK_OFFSET(0x19AF0BC0)
#define MONO_DATACONVERTER_GETBYTES_5_OFFSET UNITYSDK_OFFSET(0x19AF0C10)
#define MONO_DATACONVERTER_GETBYTES_6_OFFSET UNITYSDK_OFFSET(0x19AF0C60)
#define MONO_DATACONVERTER_GETBYTES_7_OFFSET UNITYSDK_OFFSET(0x19AF0CB0)
#define MONO_DATACONVERTER_GETBYTES_OFFSET UNITYSDK_OFFSET(0x19AF0A60)
#define MONO_DATACONVERTER_GET_BIGENDIAN_OFFSET UNITYSDK_OFFSET(0x19AF0D70)
#define MONO_DATACONVERTER_GET_LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x19AF0D00)
#define MONO_DATACONVERTER_PACKONE_OFFSET UNITYSDK_OFFSET(0x19AF0FD0)
#define MONO_DATACONVERTER_PACK_OFFSET UNITYSDK_OFFSET(0x19AF0E00)
#define MONO_DATACONVERTER_PREPARE_OFFSET UNITYSDK_OFFSET(0x19AF2740)
#define MONO_DATACONVERTER_UNPACK_OFFSET UNITYSDK_OFFSET(0x19AF27E0)
#define MONO_DATACONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19AF43B0)
#define MONO_DATACONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19AF43A0)
