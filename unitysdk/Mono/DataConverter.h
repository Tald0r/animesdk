...
#define MONO_DATACONVERTER_ALIGN_OFFSET UNITYSDK_OFFSET(0x19652460)
#define MONO_DATACONVERTER_CHECK_OFFSET UNITYSDK_OFFSET(0x19655970)
#define MONO_DATACONVERTER_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x19652140)
#define MONO_DATACONVERTER_GETBYTES_2_OFFSET UNITYSDK_OFFSET(0x196521A0)
#define MONO_DATACONVERTER_GETBYTES_3_OFFSET UNITYSDK_OFFSET(0x196521F0)
#define MONO_DATACONVERTER_GETBYTES_4_OFFSET UNITYSDK_OFFSET(0x19652240)
#define MONO_DATACONVERTER_GETBYTES_5_OFFSET UNITYSDK_OFFSET(0x19652290)
#define MONO_DATACONVERTER_GETBYTES_6_OFFSET UNITYSDK_OFFSET(0x196522E0)
#define MONO_DATACONVERTER_GETBYTES_7_OFFSET UNITYSDK_OFFSET(0x19652330)
#define MONO_DATACONVERTER_GETBYTES_OFFSET UNITYSDK_OFFSET(0x196520E0)
#define MONO_DATACONVERTER_GET_BIGENDIAN_OFFSET UNITYSDK_OFFSET(0x196523F0)
#define MONO_DATACONVERTER_GET_LITTLEENDIAN_OFFSET UNITYSDK_OFFSET(0x19652380)
#define MONO_DATACONVERTER_PACKONE_OFFSET UNITYSDK_OFFSET(0x19652650)
#define MONO_DATACONVERTER_PACK_OFFSET UNITYSDK_OFFSET(0x19652480)
#define MONO_DATACONVERTER_PREPARE_OFFSET UNITYSDK_OFFSET(0x19653DC0)
#define MONO_DATACONVERTER_UNPACK_OFFSET UNITYSDK_OFFSET(0x19653E60)
#define MONO_DATACONVERTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19655A30)
#define MONO_DATACONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19655A20)
