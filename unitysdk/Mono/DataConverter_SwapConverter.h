...
#define MONO_DATACONVERTER_SWAPCONVERTER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x1A128770)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x1A128C50)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETINT16_OFFSET UNITYSDK_OFFSET(0x1A129040)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETINT32_OFFSET UNITYSDK_OFFSET(0x1A128DA0)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETINT64_OFFSET UNITYSDK_OFFSET(0x1A128AB0)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETUINT16_OFFSET UNITYSDK_OFFSET(0x1A129160)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETUINT32_OFFSET UNITYSDK_OFFSET(0x1A128EF0)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETUINT64_OFFSET UNITYSDK_OFFSET(0x1A128910)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_1_OFFSET UNITYSDK_OFFSET(0x1A129310)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_2_OFFSET UNITYSDK_OFFSET(0x1A129380)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_3_OFFSET UNITYSDK_OFFSET(0x1A1293F0)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_4_OFFSET UNITYSDK_OFFSET(0x1A129460)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_5_OFFSET UNITYSDK_OFFSET(0x1A1294F0)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_6_OFFSET UNITYSDK_OFFSET(0x1A129580)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_7_OFFSET UNITYSDK_OFFSET(0x1A1295E0)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_OFFSET UNITYSDK_OFFSET(0x1A129280)
#define MONO_DATACONVERTER_SWAPCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A129640)
