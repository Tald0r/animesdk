...
#define MONO_DATACONVERTER_SWAPCONVERTER_GETDOUBLE_OFFSET UNITYSDK_OFFSET(0x19B63ED0)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETFLOAT_OFFSET UNITYSDK_OFFSET(0x19B643B0)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETINT16_OFFSET UNITYSDK_OFFSET(0x19B647A0)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETINT32_OFFSET UNITYSDK_OFFSET(0x19B64500)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETINT64_OFFSET UNITYSDK_OFFSET(0x19B64210)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETUINT16_OFFSET UNITYSDK_OFFSET(0x19B648C0)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETUINT32_OFFSET UNITYSDK_OFFSET(0x19B64650)
#define MONO_DATACONVERTER_SWAPCONVERTER_GETUINT64_OFFSET UNITYSDK_OFFSET(0x19B64070)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_1_OFFSET UNITYSDK_OFFSET(0x19B64A70)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_2_OFFSET UNITYSDK_OFFSET(0x19B64AE0)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_3_OFFSET UNITYSDK_OFFSET(0x19B64B50)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_4_OFFSET UNITYSDK_OFFSET(0x19B64BC0)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_5_OFFSET UNITYSDK_OFFSET(0x19B64C50)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_6_OFFSET UNITYSDK_OFFSET(0x19B64CE0)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_7_OFFSET UNITYSDK_OFFSET(0x19B64D40)
#define MONO_DATACONVERTER_SWAPCONVERTER_PUTBYTES_OFFSET UNITYSDK_OFFSET(0x19B649E0)
#define MONO_DATACONVERTER_SWAPCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19B64DA0)
