...
#define MONO_UNITY_UNITYTLSCONTEXT_CERTIFICATECALLBACK_1_OFFSET UNITYSDK_OFFSET(0x188D4270)
#define MONO_UNITY_UNITYTLSCONTEXT_CERTIFICATECALLBACK_OFFSET UNITYSDK_OFFSET(0x188D14B0)
#define MONO_UNITY_UNITYTLSCONTEXT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x188D32D0)
#define MONO_UNITY_UNITYTLSCONTEXT_EXTRACTNATIVEKEYANDCHAINFROMMANAGEDCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x188D2630)
#define MONO_UNITY_UNITYTLSCONTEXT_FINISHHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x188D3950)
#define MONO_UNITY_UNITYTLSCONTEXT_FLUSH_OFFSET UNITYSDK_OFFSET(0x188D2A50)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_CONNECTIONINFO_OFFSET UNITYSDK_OFFSET(0x188D29F0)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_HASCONTEXT_OFFSET UNITYSDK_OFFSET(0x188D29D0)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_ISAUTHENTICATED_OFFSET UNITYSDK_OFFSET(0x188D29E0)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_ISREMOTECERTIFICATEAVAILABLE_OFFSET UNITYSDK_OFFSET(0x188D2A00)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_LOCALCLIENTCERTIFICATE_OFFSET UNITYSDK_OFFSET(0x188D2A10)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_NEGOTIATEDPROTOCOL_OFFSET UNITYSDK_OFFSET(0x188D2A30)
#define MONO_UNITY_UNITYTLSCONTEXT_GET_REMOTECERTIFICATE_OFFSET UNITYSDK_OFFSET(0x188D2A20)
#define MONO_UNITY_UNITYTLSCONTEXT_PROCESSHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x188D36B0)
#define MONO_UNITY_UNITYTLSCONTEXT_READCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x188D3D90)
#define MONO_UNITY_UNITYTLSCONTEXT_READCALLBACK_OFFSET UNITYSDK_OFFSET(0x188D1300)
#define MONO_UNITY_UNITYTLSCONTEXT_READ_OFFSET UNITYSDK_OFFSET(0x188D2A60)
#define MONO_UNITY_UNITYTLSCONTEXT_SHUTDOWN_OFFSET UNITYSDK_OFFSET(0x188D2F30)
#define MONO_UNITY_UNITYTLSCONTEXT_STARTHANDSHAKE_OFFSET UNITYSDK_OFFSET(0x188D33B0)
#define MONO_UNITY_UNITYTLSCONTEXT_TRACECALLBACK_OFFSET UNITYSDK_OFFSET(0x188D15A0)
#define MONO_UNITY_UNITYTLSCONTEXT_VERIFYCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x188D40D0)
#define MONO_UNITY_UNITYTLSCONTEXT_VERIFYCALLBACK_OFFSET UNITYSDK_OFFSET(0x188D13E0)
#define MONO_UNITY_UNITYTLSCONTEXT_WRITECALLBACK_1_OFFSET UNITYSDK_OFFSET(0x188D3BE0)
#define MONO_UNITY_UNITYTLSCONTEXT_WRITECALLBACK_OFFSET UNITYSDK_OFFSET(0x188D1220)
#define MONO_UNITY_UNITYTLSCONTEXT_WRITE_OFFSET UNITYSDK_OFFSET(0x188D2CD0)
#define MONO_UNITY_UNITYTLSCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x188D1700)
...
namespace Mono::Unity
{
	...
	public:
		...
		::Mono::Unity::UnityTls_unitytls_tlsctx_trace_callback* traceCallback; // 0x70
		...
		::Mono::Unity::UnityTls_unitytls_tlsctx_read_callback* readCallback; // 0x88
		...
		::System::Boolean isAuthenticated; // 0xB8
		::System::Boolean hasContext; // 0xB9
		::System::Boolean closedGraceful; // 0xBA
		::System::Runtime::InteropServices::GCHandle handle; // 0xBC
