...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_GET_PROTOCOL_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1908C750)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_GET_PROTOCOL_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1908C790)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_GET_PROTOCOL_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1908C410)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_TLSCTX_GET_PROTOCOL_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1908C400)
