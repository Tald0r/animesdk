...
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_APPEND_DER_T_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1822B400)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_APPEND_DER_T_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1822B480)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_APPEND_DER_T_INVOKE_OFFSET UNITYSDK_OFFSET(0x1822B090)
#define MONO_UNITY_UNITYTLS_UNITYTLS_INTERFACE_STRUCT_UNITYTLS_X509LIST_APPEND_DER_T__CTOR_OFFSET UNITYSDK_OFFSET(0x1822B080)
