...
#define MONO_UNITY_UNITYTLS_GETUNITYTLSINTERFACE_OFFSET UNITYSDK_OFFSET(0x195BE0D0)
#define MONO_UNITY_UNITYTLS_GET_ISSUPPORTED_OFFSET UNITYSDK_OFFSET(0x195BE0E0)
#define MONO_UNITY_UNITYTLS_GET_NATIVEINTERFACE_OFFSET UNITYSDK_OFFSET(0x195BE160)
#define MONO_UNITY_UNITYTLS__CCTOR_OFFSET UNITYSDK_OFFSET(0x195BE1E0)
