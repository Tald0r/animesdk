...
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_414F0AF51956DE20_OFFSET UNITYSDK_OFFSET(0x1749DEE0)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_4B9DBFC8428B015A_OFFSET UNITYSDK_OFFSET(0x1749DED0)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_60A1793BCE006FB1_OFFSET UNITYSDK_OFFSET(0x1749DBF0)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_6D0092BF65C5AC1F_OFFSET UNITYSDK_OFFSET(0x17499510)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_7B8B1935187FCFC5_OFFSET UNITYSDK_OFFSET(0x1749CAE0)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_AF3D51C0C4820425_OFFSET UNITYSDK_OFFSET(0x1749BDA0)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_C517D1E49C803379_1_OFFSET UNITYSDK_OFFSET(0x1749DEF0)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_C517D1E49C803379_OFFSET UNITYSDK_OFFSET(0x1749DEB0)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_CC7841E04D5BC26D_OFFSET UNITYSDK_OFFSET(0x1749DF00)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_CD7849764A507E10_OFFSET UNITYSDK_OFFSET(0x17499F00)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_E917DA7598A51C17_1_OFFSET UNITYSDK_OFFSET(0x1749DF40)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_E917DA7598A51C17_OFFSET UNITYSDK_OFFSET(0x1749DEC0)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_FD1183EF272AE482_OFFSET UNITYSDK_OFFSET(0x17498280)
#define CLASS_3_F71D1A223C2F87B9_METHOD_3_FFCC0F6E802A34D6_OFFSET UNITYSDK_OFFSET(0x1749AD10)
#define CLASS_3_F71D1A223C2F87B9_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1749D410)
#define CLASS_3_F71D1A223C2F87B9__CTOR_OFFSET UNITYSDK_OFFSET(0x17498120)

inline static constexpr unsigned int Class_3_F71D1A223C2F87B9_TypeDefinitionIndex = 41709;

class Class_3_F71D1A223C2F87B9 : public ::Class_2_390F2A0D02A71B76<::UnityEngine::Rendering::Universal::Vignette*, ::MoleMole::Config::ConfigEntityVignette*>
{
public:
	...
	::MoleMole::TwoValue_1<::UnityEngine::Vector2>* Field_3_2; // 0xC8
	::UnityEngine::Vector2 Field_3_3; // 0xD0
	::System::Boolean Field_3_9; // 0xD8
	::System::Single Field_3_5; // 0xDC
	::UnityEngine::Color Field_3_1; // 0xE0
	::System::Single Field_3_7; // 0xF0

	::System::Void _ctor(::System::String* a1, ::MoleMole::Config::ConfigEntityVignette* a2, ::UnityEngine::Rendering::Volume* a3, ::MoleMole::Battle::Entity* a4, ::Class_1_8A50BFB20D9D2482_1* a5)
	{
		return ((::System::Void(*)(::PVOID, ::System::String*, ::MoleMole::Config::ConfigEntityVignette*, ::UnityEngine::Rendering::Volume*, ::MoleMole::Battle::Entity*, ::Class_1_8A50BFB20D9D2482_1*))((::PBYTE)hIl2Cpp + CLASS_3_F71D1A223C2F87B9__CTOR_OFFSET))(this, a1, a2, a3, a4, a5);
	}
	...
	::System::Void Method_3_7B8B1935187FCFC5(::UnityEngine::NAPRenderPipeline0::VolumeProfile_NativeSRP* a1, ::UnityEngine::Rendering::Universal::Vignette* a2, ::System::Boolean a3)
	{
		return ((::System::Void(*)(::PVOID, ::UnityEngine::NAPRenderPipeline0::VolumeProfile_NativeSRP*, ::UnityEngine::Rendering::Universal::Vignette*, ::System::Boolean))((::PBYTE)hIl2Cpp + CLASS_3_F71D1A223C2F87B9_METHOD_3_7B8B1935187FCFC5_OFFSET))(this, a1, a2, a3);
	}
