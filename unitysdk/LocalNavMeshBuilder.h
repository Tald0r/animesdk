...
#define LOCALNAVMESHBUILDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x92E4620)
#define LOCALNAVMESHBUILDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x92E42C0)
#define LOCALNAVMESHBUILDER_QUANTIZEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x92E4690)
#define LOCALNAVMESHBUILDER_QUANTIZE_OFFSET UNITYSDK_OFFSET(0x92E4980)
#define LOCALNAVMESHBUILDER_START_OFFSET UNITYSDK_OFFSET(0x92E4220)
#define LOCALNAVMESHBUILDER_UPDATENAVMESH_OFFSET UNITYSDK_OFFSET(0x92E43F0)
#define LOCALNAVMESHBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x92E4AC0)

inline static constexpr unsigned int LocalNavMeshBuilder_TypeDefinitionIndex = 70000;
