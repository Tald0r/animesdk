...
#define LOCALNAVMESHBUILDER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x6088A40)
#define LOCALNAVMESHBUILDER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x60886E0)
#define LOCALNAVMESHBUILDER_QUANTIZEDBOUNDS_OFFSET UNITYSDK_OFFSET(0x6088AB0)
#define LOCALNAVMESHBUILDER_QUANTIZE_OFFSET UNITYSDK_OFFSET(0x6088DA0)
#define LOCALNAVMESHBUILDER_START_OFFSET UNITYSDK_OFFSET(0x6088640)
#define LOCALNAVMESHBUILDER_UPDATENAVMESH_OFFSET UNITYSDK_OFFSET(0x6088810)
#define LOCALNAVMESHBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x6088EE0)

inline static constexpr unsigned int LocalNavMeshBuilder_TypeDefinitionIndex = 66247;
