...
#define MB_TEXTUREARRAYFORMATSET_GETFORMATFORPROPERTY_OFFSET UNITYSDK_OFFSET(0x1ABFEDA0)
#define MB_TEXTUREARRAYFORMATSET_VALIDATETEXTUREIMPORTERFORMATSEXISTSFORTEXTUREFORMATS_OFFSET UNITYSDK_OFFSET(0x1ABFE4E0)
#define MB_TEXTUREARRAYFORMATSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABFEE70)

inline static constexpr unsigned int MB_TextureArrayFormatSet_TypeDefinitionIndex = 83225;
