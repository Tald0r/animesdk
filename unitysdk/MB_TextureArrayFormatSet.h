...
#define MB_TEXTUREARRAYFORMATSET_GETFORMATFORPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A653AF0)
#define MB_TEXTUREARRAYFORMATSET_VALIDATETEXTUREIMPORTERFORMATSEXISTSFORTEXTUREFORMATS_OFFSET UNITYSDK_OFFSET(0x1A653230)
#define MB_TEXTUREARRAYFORMATSET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A653BC0)

inline static constexpr unsigned int MB_TextureArrayFormatSet_TypeDefinitionIndex = 81184;
