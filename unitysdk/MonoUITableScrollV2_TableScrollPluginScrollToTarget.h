...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_CALSELECTALIGNTARGETPOSITIONV2_OFFSET UNITYSDK_OFFSET(0x9A3CB90)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_CALSELECTALIGNTARGETPOSITION_OFFSET UNITYSDK_OFFSET(0x9A39F50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_CHECKSCROLLDATAINDEX_OFFSET UNITYSDK_OFFSET(0x9A36760)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_DEBUGLOG_OFFSET UNITYSDK_OFFSET(0x9A37170)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GETREALALIGNDATAINDEXV2_OFFSET UNITYSDK_OFFSET(0x9A38150)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GETREALALIGNRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9A39400)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_CANNOTMOVERUNTIME_OFFSET UNITYSDK_OFFSET(0x9A352A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0x9A351D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_DYNAMICITEMSIZE_OFFSET UNITYSDK_OFFSET(0x9A35240)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_DYNAMICVIEWRECTSIZE_OFFSET UNITYSDK_OFFSET(0x9A35260)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_ISDRAGGINGSCROLLBAR_OFFSET UNITYSDK_OFFSET(0x9A352F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_ISDRAGGING_OFFSET UNITYSDK_OFFSET(0x9A352C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x9A35420)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_LOGIC_OFFSET UNITYSDK_OFFSET(0x9A35280)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_LOOPSCROLL_OFFSET UNITYSDK_OFFSET(0x9A35200)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_MANUALMODE_OFFSET UNITYSDK_OFFSET(0x9A35400)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_M_DATAS_OFFSET UNITYSDK_OFFSET(0x9A353E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_M_INITED_OFFSET UNITYSDK_OFFSET(0x9A353C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_SIMPLEMODE_OFFSET UNITYSDK_OFFSET(0x9A35220)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET_STARTAXISEQUALSCROLLAXIS_OFFSET UNITYSDK_OFFSET(0x9A354A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__CURRENTSELECTALIGNTARGETDATAINDEX_OFFSET UNITYSDK_OFFSET(0x9A35090)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__CURRENTSELECTALIGNTARGETRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9A35130)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__DATAINDEX_OFFSET UNITYSDK_OFFSET(0x9A354D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__FEATURESTATE_OFFSET UNITYSDK_OFFSET(0x9A35320)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__SCROLLDATAINDEX_OFFSET UNITYSDK_OFFSET(0x9A3F480)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__SCROLLFROMDATAINDEX_OFFSET UNITYSDK_OFFSET(0x9A3F4C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_GET__SCROLLTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9A3F4A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_ISMOVETOEND_1_OFFSET UNITYSDK_OFFSET(0x9A37EB0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_ISMOVETOEND_OFFSET UNITYSDK_OFFSET(0x9A3A380)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_JUDGEALIGNDATAINDEX_OFFSET UNITYSDK_OFFSET(0x9A382A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_ONAFTERREFRESHGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x9A35E10)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_ONCLEARALLITEMDATAS_OFFSET UNITYSDK_OFFSET(0x9A35020)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_ONINITDATA_OFFSET UNITYSDK_OFFSET(0x9A34FC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_ONSELECTITEMWHENNOTINIT_OFFSET UNITYSDK_OFFSET(0x9A366E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLDELTA_OFFSET UNITYSDK_OFFSET(0x9A35970)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOSHOWTARGETWITHOUTANIM_OFFSET UNITYSDK_OFFSET(0x9A36C60)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOSHOWTARGET_1_OFFSET UNITYSDK_OFFSET(0x9A36EE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOSHOWTARGET_OFFSET UNITYSDK_OFFSET(0x9A36BB0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOTARGETINNERWITHOUTALIGNDATAINDEXOFFSET_1_OFFSET UNITYSDK_OFFSET(0x9A399F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOTARGETINNERWITHOUTALIGNDATAINDEXOFFSET_OFFSET UNITYSDK_OFFSET(0x9A396E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOTARGETINNER_1_OFFSET UNITYSDK_OFFSET(0x9A390B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOTARGETINNER_2_OFFSET UNITYSDK_OFFSET(0x9A389A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOTARGETINNER_OFFSET UNITYSDK_OFFSET(0x9A376C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SCROLLTOTARGET_OFFSET UNITYSDK_OFFSET(0x9A354F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SET__CURRENTSELECTALIGNTARGETDATAINDEX_OFFSET UNITYSDK_OFFSET(0x9A350B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SET__CURRENTSELECTALIGNTARGETRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9A35150)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SET__FEATURESTATE_OFFSET UNITYSDK_OFFSET(0x9A35340)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SET__SCROLLDATAINDEX_OFFSET UNITYSDK_OFFSET(0x9A3F490)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SET__SCROLLFROMDATAINDEX_OFFSET UNITYSDK_OFFSET(0x9A3F4D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET_SET__SCROLLTRANSFORM_OFFSET UNITYSDK_OFFSET(0x9A3F4B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITIONV2_G__CALALIGNTARGETPOSITION_CENTER_63_0_OFFSET UNITYSDK_OFFSET(0x9A3D670)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITIONV2_G__CALALIGNTARGETPOSITION_CUSTOMRANGE_63_4_OFFSET UNITYSDK_OFFSET(0x9A3D9E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITIONV2_G__CALALIGNTARGETPOSITION_VISIBLE_63_3_OFFSET UNITYSDK_OFFSET(0x9A3CD20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITIONV2_G__CALGRIDALIGNTARGETPOSITION_END_63_2_OFFSET UNITYSDK_OFFSET(0x9A3F1A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITIONV2_G__CALGRIDALIGNTARGETPOSITION_START_63_1_OFFSET UNITYSDK_OFFSET(0x9A3EEB0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITION_G__CALALIGNTARGETPOSITION_CENTER_62_0_OFFSET UNITYSDK_OFFSET(0x9A3AD80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITION_G__CALALIGNTARGETPOSITION_CUSTOMRANGE_62_4_OFFSET UNITYSDK_OFFSET(0x9A3B0F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITION_G__CALALIGNTARGETPOSITION_VISIBLE_62_3_OFFSET UNITYSDK_OFFSET(0x9A3A430)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITION_G__CALGRIDALIGNTARGETPOSITION_END_62_2_OFFSET UNITYSDK_OFFSET(0x9A3C8B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CALSELECTALIGNTARGETPOSITION_G__CALGRIDALIGNTARGETPOSITION_START_62_1_OFFSET UNITYSDK_OFFSET(0x9A3C5C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CHECKSCROLLDATAINDEX_G__GETSCROLLDIRECTION_47_0_OFFSET UNITYSDK_OFFSET(0x9A36B90)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__CTOR_OFFSET UNITYSDK_OFFSET(0x9A34FB0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__GETREALALIGNDATAINDEXV2_G__GETNEXTINDEX_58_1_OFFSET UNITYSDK_OFFSET(0x9A3A200)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__GETREALALIGNDATAINDEXV2_G__GETPREVINDEX_58_0_OFFSET UNITYSDK_OFFSET(0x9A3A180)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__GETREALALIGNRECTTRANSFORM_G__ISMOVETOENDV2_57_0_OFFSET UNITYSDK_OFFSET(0x9A3A0D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__JUDGEALIGNDATAINDEX_G__GETALIGNDATAINDEX_59_0_OFFSET UNITYSDK_OFFSET(0x9A3A280)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__JUDGEALIGNDATAINDEX_G__GETALIGNDATAINDEX_59_2_OFFSET UNITYSDK_OFFSET(0x9A3A3F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__JUDGEALIGNDATAINDEX_G__GETSCROLLDISTANCE_59_1_OFFSET UNITYSDK_OFFSET(0x9A3F500)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__SCROLLTOSHOWTARGETWITHOUTANIM_G__GETSCROLLDIRECTION_49_0_OFFSET UNITYSDK_OFFSET(0x9A36EC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__SCROLLTOTARGETINNER_G__GETDISTANCETOVISIBLE_52_1_OFFSET UNITYSDK_OFFSET(0x9A3F4E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__SCROLLTOTARGETINNER_G__GETNEARESTDATAINDEX_52_0_OFFSET UNITYSDK_OFFSET(0x9A38900)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET__SCROLLTOTARGET_G__INNER_43_0_OFFSET UNITYSDK_OFFSET(0x9A35810)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET___BASE_ONCLEARALLITEMDATAS_OFFSET UNITYSDK_OFFSET(0x9A3F590)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLTOTARGET___BASE_ONINITDATA_OFFSET UNITYSDK_OFFSET(0x9A3F5F0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginScrollToTarget_TypeDefinitionIndex = 64388;
...
public:
	...
	::System::Boolean _tempParamFor1_0; // 0x20
	::System::Nullable_1<::System::Boolean> _consoleScrollToEnd; // 0x21
	::System::Int32 __scrollDataIndex_k__BackingField; // 0x24
	::System::Nullable_1<::System::Int32> __scrollFromDataIndex_k__BackingField; // 0x28
