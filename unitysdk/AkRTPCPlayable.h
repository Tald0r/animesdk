...
#define AKRTPCPLAYABLE_CREATEPLAYABLE_OFFSET UNITYSDK_OFFSET(0x1AF9CDA0)
#define AKRTPCPLAYABLE_GET_OWNINGCLIP_OFFSET UNITYSDK_OFFSET(0x1AF9CD70)
#define AKRTPCPLAYABLE_GET_PARAMETER_OFFSET UNITYSDK_OFFSET(0x1AF9CD50)
#define AKRTPCPLAYABLE_SET_OWNINGCLIP_OFFSET UNITYSDK_OFFSET(0x1AF9CD80)
#define AKRTPCPLAYABLE_SET_PARAMETER_OFFSET UNITYSDK_OFFSET(0x1AF9CD60)
#define AKRTPCPLAYABLE_UNITYENGINE_TIMELINE_ITIMELINECLIPASSET_GET_CLIPCAPS_OFFSET UNITYSDK_OFFSET(0x1AF9CD90)
#define AKRTPCPLAYABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF9CFB0)

inline static constexpr unsigned int AkRTPCPlayable_TypeDefinitionIndex = 30129;
