...
#define ROTATIONHELPER_GETROTATIONBYTWOPOSITION_OFFSET UNITYSDK_OFFSET(0x1826EB90)

inline static constexpr unsigned int RotationHelper_TypeDefinitionIndex = 80783;
