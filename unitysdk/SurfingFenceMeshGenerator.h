...
#define SURFINGFENCEMESHGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1817A7E0)

inline static constexpr unsigned int SurfingFenceMeshGenerator_TypeDefinitionIndex = 76225;
