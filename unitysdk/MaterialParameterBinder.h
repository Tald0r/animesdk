...
#define MATERIALPARAMETERBINDER_APPLYBINDINGS_OFFSET UNITYSDK_OFFSET(0x1931B640)
#define MATERIALPARAMETERBINDER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1931A750)
#define MATERIALPARAMETERBINDER_CACHEBINDINGS_OFFSET UNITYSDK_OFFSET(0x1931A850)
#define MATERIALPARAMETERBINDER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1931BD10)
#define MATERIALPARAMETERBINDER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1931B5F0)
#define MATERIALPARAMETERBINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1931BD90)

inline static constexpr unsigned int MaterialParameterBinder_TypeDefinitionIndex = 28005;
