...
#define CLASS_3_5D328B4E190C7472_METHOD_3_DF36652FF6AEAAC1_OFFSET UNITYSDK_OFFSET(0x825FBC0)
#define CLASS_3_5D328B4E190C7472__CTOR_1_OFFSET UNITYSDK_OFFSET(0x825FBB0)
#define CLASS_3_5D328B4E190C7472__CTOR_2_OFFSET UNITYSDK_OFFSET(0x825FBA0)
#define CLASS_3_5D328B4E190C7472__CTOR_OFFSET UNITYSDK_OFFSET(0x825FB90)

inline static constexpr unsigned int Class_3_5D328B4E190C7472_TypeDefinitionIndex = 58863;

class Class_3_5D328B4E190C7472 : public ::UnityEngine::PropertyAttribute
{
public:
	::System::Int32 Field_3_2; // 0x10
