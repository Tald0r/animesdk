...
#define MONOUITABLESCROLLV2_SCROLLPARAMS_ALIGNPARAM_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA09D020)
#define MONOUITABLESCROLLV2_SCROLLPARAMS_ALIGNPARAM__CTOR_1_OFFSET UNITYSDK_OFFSET(0xA09D010)
#define MONOUITABLESCROLLV2_SCROLLPARAMS_ALIGNPARAM__CTOR_OFFSET UNITYSDK_OFFSET(0xA09D000)
#define MONOUITABLESCROLLV2_SCROLLPARAMS_ALIGNPARAM___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0xA09D1B0)

inline static constexpr unsigned int MonoUITableScrollV2_ScrollParams_AlignParam_TypeDefinitionIndex = 43851;
