...
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_CALCULATEAABB_OFFSET UNITYSDK_OFFSET(0xD85B460)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_CALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0xD85BAB0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_CALCULATEINSIDEFAST_OFFSET UNITYSDK_OFFSET(0xD85C980)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_CALCULATEINSIDE_OFFSET UNITYSDK_OFFSET(0xD85CC30)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_HIDENGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xD85D3D0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_ISBAKE_OFFSET UNITYSDK_OFFSET(0xD85CFB0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_ISPOINTINRECT_OFFSET UNITYSDK_OFFSET(0xD85C6E0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_MERGEBOUNDS_OFFSET UNITYSDK_OFFSET(0xD85C330)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_SETGAMEOBJECTVISIBILITYANDENABLE_OFFSET UNITYSDK_OFFSET(0xD85D270)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_SETGAMEOBJECTVISIBILITY_OFFSET UNITYSDK_OFFSET(0xD85D0B0)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_SHOWGAMEOBJECTFIRST_OFFSET UNITYSDK_OFFSET(0xD85D200)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER_SHOWGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0xD85D040)
#define SCENEMESHCULLEDMANAGER_MYTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0xD85D440)

inline static constexpr unsigned int SceneMeshCulledManager_MyTrigger_TypeDefinitionIndex = 43709;
