...
#define AKROOMPORTAL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B08E9B0)
#define AKROOMPORTAL_CLOSEPORTAL_OFFSET UNITYSDK_OFFSET(0x1B08EC20)
#define AKROOMPORTAL_CLOSE_OFFSET UNITYSDK_OFFSET(0x1B08EC50)
#define AKROOMPORTAL_FILLROOMLIST_OFFSET UNITYSDK_OFFSET(0x1B08EF40)
#define AKROOMPORTAL_FINDOVERLAPPINGROOMS_OFFSET UNITYSDK_OFFSET(0x1B08E7B0)
#define AKROOMPORTAL_GETID_OFFSET UNITYSDK_OFFSET(0x1B08E2F0)
#define AKROOMPORTAL_GETROOM_OFFSET UNITYSDK_OFFSET(0x1B08D9D0)
#define AKROOMPORTAL_GET_BACKROOMID_OFFSET UNITYSDK_OFFSET(0x1B08D830)
#define AKROOMPORTAL_GET_BACKROOM_OFFSET UNITYSDK_OFFSET(0x1B08D990)
#define AKROOMPORTAL_GET_FRONTROOMID_OFFSET UNITYSDK_OFFSET(0x1B08D610)
#define AKROOMPORTAL_GET_FRONTROOM_OFFSET UNITYSDK_OFFSET(0x1B08D770)
#define AKROOMPORTAL_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x1B08E2C0)
#define AKROOMPORTAL_GET_PORTALACTIVE_OFFSET UNITYSDK_OFFSET(0x1B08D5F0)
#define AKROOMPORTAL_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1B08EC30)
#define AKROOMPORTAL_ISROOMACTIVE_OFFSET UNITYSDK_OFFSET(0x1B08D7B0)
#define AKROOMPORTAL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B08EC60)
#define AKROOMPORTAL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B08EDC0)
#define AKROOMPORTAL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B08ED60)
#define AKROOMPORTAL_OPEN_OFFSET UNITYSDK_OFFSET(0x1B08EC40)
#define AKROOMPORTAL_OVERLAPS_OFFSET UNITYSDK_OFFSET(0x1B08E720)
#define AKROOMPORTAL_SETBACKROOM_OFFSET UNITYSDK_OFFSET(0x1B08F340)
#define AKROOMPORTAL_SETFRONTROOM_OFFSET UNITYSDK_OFFSET(0x1B08F2D0)
#define AKROOMPORTAL_SETROOMPORTAL_OFFSET UNITYSDK_OFFSET(0x1B08DA10)
#define AKROOMPORTAL_SETROOM_OFFSET UNITYSDK_OFFSET(0x1B08F260)
#define AKROOMPORTAL_SET_PORTALACTIVE_OFFSET UNITYSDK_OFFSET(0x1B08D600)
#define AKROOMPORTAL_START_OFFSET UNITYSDK_OFFSET(0x1B08EBB0)
#define AKROOMPORTAL_UPDATEOVERLAPPINGROOMS_OFFSET UNITYSDK_OFFSET(0x1B08F3D0)
#define AKROOMPORTAL_UPDATEROOMPORTAL_OFFSET UNITYSDK_OFFSET(0x1B08E3A0)
#define AKROOMPORTAL_UPDATEROOMS_OFFSET UNITYSDK_OFFSET(0x1B08E3C0)
#define AKROOMPORTAL_UPDATESOUNDENGINEROOMIDS_OFFSET UNITYSDK_OFFSET(0x1B08F3B0)
#define AKROOMPORTAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B08F3E0)

inline static constexpr unsigned int AkRoomPortal_TypeDefinitionIndex = 30136;
