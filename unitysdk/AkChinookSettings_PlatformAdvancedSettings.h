...
#define AKCHINOOKSETTINGS_PLATFORMADVANCEDSETTINGS_COPYTO_1_OFFSET UNITYSDK_OFFSET(0x1B016AF0)
#define AKCHINOOKSETTINGS_PLATFORMADVANCEDSETTINGS_COPYTO_OFFSET UNITYSDK_OFFSET(0x1B016AE0)
#define AKCHINOOKSETTINGS_PLATFORMADVANCEDSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B016B00)

inline static constexpr unsigned int AkChinookSettings_PlatformAdvancedSettings_TypeDefinitionIndex = 30004;
