...
#define AKCHINOOKSETTINGS_PLATFORMADVANCEDSETTINGS_COPYTO_1_OFFSET UNITYSDK_OFFSET(0x1B624F20)
#define AKCHINOOKSETTINGS_PLATFORMADVANCEDSETTINGS_COPYTO_OFFSET UNITYSDK_OFFSET(0x1B624F10)
#define AKCHINOOKSETTINGS_PLATFORMADVANCEDSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B624F30)

inline static constexpr unsigned int AkChinookSettings_PlatformAdvancedSettings_TypeDefinitionIndex = 30957;
