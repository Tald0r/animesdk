...
#define REPLAYCHECKPOINTELEMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x198EA470)
#define REPLAYCHECKPOINTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x198EA050)
#define REPLAYCHECKPOINTELEMENT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x198EA600)

inline static constexpr unsigned int ReplayCheckpointElement_TypeDefinitionIndex = 31476;
