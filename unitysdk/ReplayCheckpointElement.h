...
#define REPLAYCHECKPOINTELEMENT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19E1F4F0)
#define REPLAYCHECKPOINTELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19DF9F60)
#define REPLAYCHECKPOINTELEMENT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19E1F680)

inline static constexpr unsigned int ReplayCheckpointElement_TypeDefinitionIndex = 32492;
