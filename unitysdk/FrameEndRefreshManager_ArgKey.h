...
#define FRAMEENDREFRESHMANAGER_ARGKEY_ARRAYSEQUAL_OFFSET UNITYSDK_OFFSET(0x80507B0)
#define FRAMEENDREFRESHMANAGER_ARGKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x349EC0)
#define FRAMEENDREFRESHMANAGER_ARGKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x349E90)
#define FRAMEENDREFRESHMANAGER_ARGKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x349ED0)
#define FRAMEENDREFRESHMANAGER_ARGKEY_HASHARRAY_OFFSET UNITYSDK_OFFSET(0x8050010)
#define FRAMEENDREFRESHMANAGER_ARGKEY_TRYGETSAFEHASH_OFFSET UNITYSDK_OFFSET(0x8050480)
#define FRAMEENDREFRESHMANAGER_ARGKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x349E80)
#define FRAMEENDREFRESHMANAGER_ARGKEY___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x349F40)
#define FRAMEENDREFRESHMANAGER_ARGKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x349FB0)

inline static constexpr unsigned int FrameEndRefreshManager_ArgKey_TypeDefinitionIndex = 68156;
