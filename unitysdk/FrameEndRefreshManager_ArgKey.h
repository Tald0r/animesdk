...
#define FRAMEENDREFRESHMANAGER_ARGKEY_ARRAYSEQUAL_OFFSET UNITYSDK_OFFSET(0xB7ED780)
#define FRAMEENDREFRESHMANAGER_ARGKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3AD2C0)
#define FRAMEENDREFRESHMANAGER_ARGKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x3AD290)
#define FRAMEENDREFRESHMANAGER_ARGKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3AD2D0)
#define FRAMEENDREFRESHMANAGER_ARGKEY_HASHARRAY_OFFSET UNITYSDK_OFFSET(0xB7ECFE0)
#define FRAMEENDREFRESHMANAGER_ARGKEY_TRYGETSAFEHASH_OFFSET UNITYSDK_OFFSET(0xB7ED450)
#define FRAMEENDREFRESHMANAGER_ARGKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x3AD280)
#define FRAMEENDREFRESHMANAGER_ARGKEY___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3AD340)
#define FRAMEENDREFRESHMANAGER_ARGKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3AD3B0)

inline static constexpr unsigned int FrameEndRefreshManager_ArgKey_TypeDefinitionIndex = 54489;
