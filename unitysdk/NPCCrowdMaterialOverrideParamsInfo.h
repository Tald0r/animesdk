...
#define NPCCROWDMATERIALOVERRIDEPARAMSINFO_GETSHADERPROPERTYFROMINDEX_OFFSET UNITYSDK_OFFSET(0x63B1FA0)
#define NPCCROWDMATERIALOVERRIDEPARAMSINFO_PRECOMPUTECOLOR_OFFSET UNITYSDK_OFFSET(0x63B1E90)
#define NPCCROWDMATERIALOVERRIDEPARAMSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x63B2490)

inline static constexpr unsigned int NPCCrowdMaterialOverrideParamsInfo_TypeDefinitionIndex = 81139;
