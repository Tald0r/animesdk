...
#define NPCCROWDMATERIALOVERRIDEPARAMSINFO_GETSHADERPROPERTYFROMINDEX_OFFSET UNITYSDK_OFFSET(0x9EC09F0)
#define NPCCROWDMATERIALOVERRIDEPARAMSINFO_PRECOMPUTECOLOR_OFFSET UNITYSDK_OFFSET(0x9EC08E0)
#define NPCCROWDMATERIALOVERRIDEPARAMSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x9EC0F90)

inline static constexpr unsigned int NPCCrowdMaterialOverrideParamsInfo_TypeDefinitionIndex = 48797;
