...
#define LEVELUPPROGRESSWIDGET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9B61780)
#define LEVELUPPROGRESSWIDGET_PROGRESSBARANIM_OFFSET UNITYSDK_OFFSET(0x9B60BB0)
#define LEVELUPPROGRESSWIDGET_PROGRESSBARMAX_OFFSET UNITYSDK_OFFSET(0x9B614F0)
#define LEVELUPPROGRESSWIDGET_RESETPROGRESS_OFFSET UNITYSDK_OFFSET(0x9B61700)
#define LEVELUPPROGRESSWIDGET_UPDATEPROGRESSMES_OFFSET UNITYSDK_OFFSET(0x9B61400)
#define LEVELUPPROGRESSWIDGET_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0x9B61590)
#define LEVELUPPROGRESSWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x9B618D0)
#define LEVELUPPROGRESSWIDGET__PROGRESSBARANIM_B__13_0_OFFSET UNITYSDK_OFFSET(0x9B61900)
#define LEVELUPPROGRESSWIDGET__PROGRESSBARANIM_B__13_2_OFFSET UNITYSDK_OFFSET(0x9B61910)

inline static constexpr unsigned int LevelUpProgressWidget_TypeDefinitionIndex = 65382;
