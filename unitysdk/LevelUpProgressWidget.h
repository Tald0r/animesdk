...
#define LEVELUPPROGRESSWIDGET_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x7E8D5D0)
#define LEVELUPPROGRESSWIDGET_PROGRESSBARANIM_OFFSET UNITYSDK_OFFSET(0x7E8CA00)
#define LEVELUPPROGRESSWIDGET_PROGRESSBARMAX_OFFSET UNITYSDK_OFFSET(0x7E8D340)
#define LEVELUPPROGRESSWIDGET_RESETPROGRESS_OFFSET UNITYSDK_OFFSET(0x7E8D550)
#define LEVELUPPROGRESSWIDGET_UPDATEPROGRESSMES_OFFSET UNITYSDK_OFFSET(0x7E8D250)
#define LEVELUPPROGRESSWIDGET_UPDATEPROGRESS_OFFSET UNITYSDK_OFFSET(0x7E8D3E0)
#define LEVELUPPROGRESSWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0x7E8D720)
#define LEVELUPPROGRESSWIDGET__PROGRESSBARANIM_B__13_0_OFFSET UNITYSDK_OFFSET(0x7E8D750)
#define LEVELUPPROGRESSWIDGET__PROGRESSBARANIM_B__13_2_OFFSET UNITYSDK_OFFSET(0x7E8D760)

inline static constexpr unsigned int LevelUpProgressWidget_TypeDefinitionIndex = 75293;
