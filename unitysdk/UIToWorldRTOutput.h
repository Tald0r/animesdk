...
#define UITOWORLDRTOUTPUT_RELEASE_OFFSET UNITYSDK_OFFSET(0x1ABB7AB0)
#define UITOWORLDRTOUTPUT_SETRENDERTEXTURERAWIMAGE_OFFSET UNITYSDK_OFFSET(0x1ABB7740)
#define UITOWORLDRTOUTPUT_SETRENDERTEXUTRE_OFFSET UNITYSDK_OFFSET(0x1ABB7450)
#define UITOWORLDRTOUTPUT_SETUI_OFFSET UNITYSDK_OFFSET(0x1ABB7A20)
#define UITOWORLDRTOUTPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABB7B20)

inline static constexpr unsigned int UIToWorldRTOutput_TypeDefinitionIndex = 37383;
