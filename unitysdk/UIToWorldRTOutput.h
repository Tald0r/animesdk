...
#define UITOWORLDRTOUTPUT_RELEASE_OFFSET UNITYSDK_OFFSET(0x16C3E130)
#define UITOWORLDRTOUTPUT_SETRENDERTEXTURERAWIMAGE_OFFSET UNITYSDK_OFFSET(0x16C3DDC0)
#define UITOWORLDRTOUTPUT_SETRENDERTEXUTRE_OFFSET UNITYSDK_OFFSET(0x16C3DAD0)
#define UITOWORLDRTOUTPUT_SETUI_OFFSET UNITYSDK_OFFSET(0x16C3E0A0)
#define UITOWORLDRTOUTPUT__CTOR_OFFSET UNITYSDK_OFFSET(0x16C3E1A0)

inline static constexpr unsigned int UIToWorldRTOutput_TypeDefinitionIndex = 40085;
