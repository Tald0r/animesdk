...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAYOUTDIRTYCHECKER_ONRECTTRANSFORMDIMENSIONSCHANGE_CONTENT_OFFSET UNITYSDK_OFFSET(0x7E6CBC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAYOUTDIRTYCHECKER_ONRECTTRANSFORMDIMENSIONSCHANGE_VIEWRECT_OFFSET UNITYSDK_OFFSET(0x7E6CCB0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAYOUTDIRTYCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x7E6CBB0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginLayoutDirtyChecker_TypeDefinitionIndex = 64412;
