...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAYOUTDIRTYCHECKER_ONRECTTRANSFORMDIMENSIONSCHANGE_CONTENT_OFFSET UNITYSDK_OFFSET(0x73FDEF0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAYOUTDIRTYCHECKER_ONRECTTRANSFORMDIMENSIONSCHANGE_VIEWRECT_OFFSET UNITYSDK_OFFSET(0x73FDFE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAYOUTDIRTYCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x73FDEE0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginLayoutDirtyChecker_TypeDefinitionIndex = 43809;
