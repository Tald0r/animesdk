...
#define MESHDECIMATOR_MESH_CLEARVERTEXATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19FE9D20)
#define MESHDECIMATOR_MESH_GETINDICES_OFFSET UNITYSDK_OFFSET(0x19FE14C0)
#define MESHDECIMATOR_MESH_GETSUBMESHINDICES_OFFSET UNITYSDK_OFFSET(0x19FEB7A0)
#define MESHDECIMATOR_MESH_GETTRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x19FEB6F0)
#define MESHDECIMATOR_MESH_GETUVDIMENSION_OFFSET UNITYSDK_OFFSET(0x19FE15B0)
#define MESHDECIMATOR_MESH_GETUVS2D_OFFSET UNITYSDK_OFFSET(0x19FE16A0)
#define MESHDECIMATOR_MESH_GETUVS3D_OFFSET UNITYSDK_OFFSET(0x19FE1730)
#define MESHDECIMATOR_MESH_GETUVS4D_OFFSET UNITYSDK_OFFSET(0x19FE17C0)
#define MESHDECIMATOR_MESH_GETUVS_1_OFFSET UNITYSDK_OFFSET(0x19FEBA50)
#define MESHDECIMATOR_MESH_GETUVS_2_OFFSET UNITYSDK_OFFSET(0x19FEBB50)
#define MESHDECIMATOR_MESH_GETUVS_OFFSET UNITYSDK_OFFSET(0x19FEB950)
#define MESHDECIMATOR_MESH_GET_BONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x19FEA450)
#define MESHDECIMATOR_MESH_GET_COLORS_OFFSET UNITYSDK_OFFSET(0x19FEA440)
#define MESHDECIMATOR_MESH_GET_INDICES_OFFSET UNITYSDK_OFFSET(0x19FE9D50)
#define MESHDECIMATOR_MESH_GET_NORMALS_OFFSET UNITYSDK_OFFSET(0x19FEA260)
#define MESHDECIMATOR_MESH_GET_SUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x19FE1390)
#define MESHDECIMATOR_MESH_GET_TANGENTS_OFFSET UNITYSDK_OFFSET(0x19FEA270)
#define MESHDECIMATOR_MESH_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x19FE13B0)
#define MESHDECIMATOR_MESH_GET_UV1_OFFSET UNITYSDK_OFFSET(0x19FEA280)
#define MESHDECIMATOR_MESH_GET_UV2_OFFSET UNITYSDK_OFFSET(0x19FEA2F0)
#define MESHDECIMATOR_MESH_GET_UV3_OFFSET UNITYSDK_OFFSET(0x19FEA360)
#define MESHDECIMATOR_MESH_GET_UV4_OFFSET UNITYSDK_OFFSET(0x19FEA3D0)
#define MESHDECIMATOR_MESH_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x19FE9BA0)
#define MESHDECIMATOR_MESH_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x19FE9C70)
#define MESHDECIMATOR_MESH_RECALCULATENORMALS_OFFSET UNITYSDK_OFFSET(0x19FEA5E0)
#define MESHDECIMATOR_MESH_RECALCULATETANGENTS_OFFSET UNITYSDK_OFFSET(0x19FEAB30)
#define MESHDECIMATOR_MESH_SETINDICES_OFFSET UNITYSDK_OFFSET(0x19FEA0F0)
#define MESHDECIMATOR_MESH_SETUVS_1_OFFSET UNITYSDK_OFFSET(0x19FE3020)
#define MESHDECIMATOR_MESH_SETUVS_2_OFFSET UNITYSDK_OFFSET(0x19FE32A0)
#define MESHDECIMATOR_MESH_SETUVS_3_OFFSET UNITYSDK_OFFSET(0x19FEBC50)
#define MESHDECIMATOR_MESH_SETUVS_4_OFFSET UNITYSDK_OFFSET(0x19FEBED0)
#define MESHDECIMATOR_MESH_SETUVS_5_OFFSET UNITYSDK_OFFSET(0x19FEC150)
#define MESHDECIMATOR_MESH_SETUVS_OFFSET UNITYSDK_OFFSET(0x19FE2DA0)
#define MESHDECIMATOR_MESH_SET_BONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x19FE2CD0)
#define MESHDECIMATOR_MESH_SET_COLORS_OFFSET UNITYSDK_OFFSET(0x19FE2C00)
#define MESHDECIMATOR_MESH_SET_INDICES_OFFSET UNITYSDK_OFFSET(0x19FE9FA0)
#define MESHDECIMATOR_MESH_SET_NORMALS_OFFSET UNITYSDK_OFFSET(0x19FE2A60)
#define MESHDECIMATOR_MESH_SET_SUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x19FE9BC0)
#define MESHDECIMATOR_MESH_SET_TANGENTS_OFFSET UNITYSDK_OFFSET(0x19FE2B30)
#define MESHDECIMATOR_MESH_SET_UV1_OFFSET UNITYSDK_OFFSET(0x19FEA2E0)
#define MESHDECIMATOR_MESH_SET_UV2_OFFSET UNITYSDK_OFFSET(0x19FEA350)
#define MESHDECIMATOR_MESH_SET_UV3_OFFSET UNITYSDK_OFFSET(0x19FEA3C0)
#define MESHDECIMATOR_MESH_SET_UV4_OFFSET UNITYSDK_OFFSET(0x19FEA430)
#define MESHDECIMATOR_MESH_SET_VERTICES_OFFSET UNITYSDK_OFFSET(0x19FE9C80)
#define MESHDECIMATOR_MESH_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19FEC3D0)
#define MESHDECIMATOR_MESH__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FEC460)
#define MESHDECIMATOR_MESH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FE2900)
#define MESHDECIMATOR_MESH__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEA460)

namespace MeshDecimator
{
	inline static constexpr unsigned int Mesh_TypeDefinitionIndex = 32717;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Mesh_TypeDefinitionIndex)->GetStaticField(0x255C0);
		}
		// static const ::System::Int32 UVChannelCount = 0x4; // 0x0
		::Il2CppArray<::Il2CppArray<::MeshDecimator::Math::Vector3>*>* uvs3D; // 0x10
		::Il2CppArray<::MeshDecimator::BoneWeight>* boneWeights; // 0x18
		::Il2CppArray<::Il2CppArray<::MeshDecimator::Math::Vector2>*>* uvs2D; // 0x20
		::Il2CppArray<::MeshDecimator::Math::Vector3>* normals; // 0x28
		::Il2CppArray<::MeshDecimator::Math::Vector4>* colors; // 0x30
		::Il2CppArray<::MeshDecimator::Math::Vector3d>* vertices; // 0x38
		::Il2CppArray<::MeshDecimator::Math::Vector4>* tangents; // 0x40
		::Il2CppArray<::Il2CppArray<::System::Int32>*>* indices; // 0x48
		::Il2CppArray<::Il2CppArray<::MeshDecimator::Math::Vector4>*>* uvs4D; // 0x50
