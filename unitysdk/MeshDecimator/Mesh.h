...
#define MESHDECIMATOR_MESH_CLEARVERTEXATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x199FA050)
#define MESHDECIMATOR_MESH_GETINDICES_OFFSET UNITYSDK_OFFSET(0x199F1800)
#define MESHDECIMATOR_MESH_GETSUBMESHINDICES_OFFSET UNITYSDK_OFFSET(0x199FBAC0)
#define MESHDECIMATOR_MESH_GETTRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x199FBA10)
#define MESHDECIMATOR_MESH_GETUVDIMENSION_OFFSET UNITYSDK_OFFSET(0x199F18F0)
#define MESHDECIMATOR_MESH_GETUVS2D_OFFSET UNITYSDK_OFFSET(0x199F19E0)
#define MESHDECIMATOR_MESH_GETUVS3D_OFFSET UNITYSDK_OFFSET(0x199F1A70)
#define MESHDECIMATOR_MESH_GETUVS4D_OFFSET UNITYSDK_OFFSET(0x199F1B00)
#define MESHDECIMATOR_MESH_GETUVS_1_OFFSET UNITYSDK_OFFSET(0x199FBD70)
#define MESHDECIMATOR_MESH_GETUVS_2_OFFSET UNITYSDK_OFFSET(0x199FBE70)
#define MESHDECIMATOR_MESH_GETUVS_OFFSET UNITYSDK_OFFSET(0x199FBC70)
#define MESHDECIMATOR_MESH_GET_BONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x199FA770)
#define MESHDECIMATOR_MESH_GET_COLORS_OFFSET UNITYSDK_OFFSET(0x199FA760)
#define MESHDECIMATOR_MESH_GET_INDICES_OFFSET UNITYSDK_OFFSET(0x199FA070)
#define MESHDECIMATOR_MESH_GET_NORMALS_OFFSET UNITYSDK_OFFSET(0x199FA580)
#define MESHDECIMATOR_MESH_GET_SUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x199F16D0)
#define MESHDECIMATOR_MESH_GET_TANGENTS_OFFSET UNITYSDK_OFFSET(0x199FA590)
#define MESHDECIMATOR_MESH_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x199F16F0)
#define MESHDECIMATOR_MESH_GET_UV1_OFFSET UNITYSDK_OFFSET(0x199FA5A0)
#define MESHDECIMATOR_MESH_GET_UV2_OFFSET UNITYSDK_OFFSET(0x199FA610)
#define MESHDECIMATOR_MESH_GET_UV3_OFFSET UNITYSDK_OFFSET(0x199FA680)
#define MESHDECIMATOR_MESH_GET_UV4_OFFSET UNITYSDK_OFFSET(0x199FA6F0)
#define MESHDECIMATOR_MESH_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x199F9EE0)
#define MESHDECIMATOR_MESH_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x199F9FB0)
#define MESHDECIMATOR_MESH_RECALCULATENORMALS_OFFSET UNITYSDK_OFFSET(0x199FA900)
#define MESHDECIMATOR_MESH_RECALCULATETANGENTS_OFFSET UNITYSDK_OFFSET(0x199FAE50)
#define MESHDECIMATOR_MESH_SETINDICES_OFFSET UNITYSDK_OFFSET(0x199FA410)
#define MESHDECIMATOR_MESH_SETUVS_1_OFFSET UNITYSDK_OFFSET(0x199F3360)
#define MESHDECIMATOR_MESH_SETUVS_2_OFFSET UNITYSDK_OFFSET(0x199F35E0)
#define MESHDECIMATOR_MESH_SETUVS_3_OFFSET UNITYSDK_OFFSET(0x199FBF70)
#define MESHDECIMATOR_MESH_SETUVS_4_OFFSET UNITYSDK_OFFSET(0x199FC1F0)
#define MESHDECIMATOR_MESH_SETUVS_5_OFFSET UNITYSDK_OFFSET(0x199FC470)
#define MESHDECIMATOR_MESH_SETUVS_OFFSET UNITYSDK_OFFSET(0x199F30E0)
#define MESHDECIMATOR_MESH_SET_BONEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x199F3010)
#define MESHDECIMATOR_MESH_SET_COLORS_OFFSET UNITYSDK_OFFSET(0x199F2F40)
#define MESHDECIMATOR_MESH_SET_INDICES_OFFSET UNITYSDK_OFFSET(0x199FA2C0)
#define MESHDECIMATOR_MESH_SET_NORMALS_OFFSET UNITYSDK_OFFSET(0x199F2DA0)
#define MESHDECIMATOR_MESH_SET_SUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x199F9F00)
#define MESHDECIMATOR_MESH_SET_TANGENTS_OFFSET UNITYSDK_OFFSET(0x199F2E70)
#define MESHDECIMATOR_MESH_SET_UV1_OFFSET UNITYSDK_OFFSET(0x199FA600)
#define MESHDECIMATOR_MESH_SET_UV2_OFFSET UNITYSDK_OFFSET(0x199FA670)
#define MESHDECIMATOR_MESH_SET_UV3_OFFSET UNITYSDK_OFFSET(0x199FA6E0)
#define MESHDECIMATOR_MESH_SET_UV4_OFFSET UNITYSDK_OFFSET(0x199FA750)
#define MESHDECIMATOR_MESH_SET_VERTICES_OFFSET UNITYSDK_OFFSET(0x199F9FC0)
#define MESHDECIMATOR_MESH_TOSTRING_OFFSET UNITYSDK_OFFSET(0x199FC6F0)
#define MESHDECIMATOR_MESH__CCTOR_OFFSET UNITYSDK_OFFSET(0x199FC780)
#define MESHDECIMATOR_MESH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x199F2C40)
#define MESHDECIMATOR_MESH__CTOR_OFFSET UNITYSDK_OFFSET(0x199FA780)

namespace MeshDecimator
{
	inline static constexpr unsigned int Mesh_TypeDefinitionIndex = 31763;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(Mesh_TypeDefinitionIndex)->GetStaticField(0x23CA0);
		}
		// static const ::System::Int32 UVChannelCount = 0x4; // 0x0
		::Il2CppArray<::Il2CppArray<::MeshDecimator::Math::Vector3>*>* uvs3D; // 0x10
		::Il2CppArray<::MeshDecimator::Math::Vector3>* normals; // 0x18
		::Il2CppArray<::MeshDecimator::Math::Vector4>* tangents; // 0x20
		::Il2CppArray<::MeshDecimator::BoneWeight>* boneWeights; // 0x28
		::Il2CppArray<::MeshDecimator::Math::Vector4>* colors; // 0x30
		::Il2CppArray<::MeshDecimator::Math::Vector3d>* vertices; // 0x38
		::Il2CppArray<::Il2CppArray<::System::Int32>*>* indices; // 0x40
		::Il2CppArray<::Il2CppArray<::MeshDecimator::Math::Vector4>*>* uvs4D; // 0x48
		::Il2CppArray<::Il2CppArray<::MeshDecimator::Math::Vector2>*>* uvs2D; // 0x50
