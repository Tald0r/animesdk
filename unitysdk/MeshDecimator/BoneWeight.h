...
#define MESHDECIMATOR_BONEWEIGHT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8C3780)
#define MESHDECIMATOR_BONEWEIGHT_EQUALS_OFFSET UNITYSDK_OFFSET(0x8C36E0)
#define MESHDECIMATOR_BONEWEIGHT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8C3640)
#define MESHDECIMATOR_BONEWEIGHT_MERGEBONEWEIGHT_OFFSET UNITYSDK_OFFSET(0x8C35B0)
#define MESHDECIMATOR_BONEWEIGHT_MERGE_OFFSET UNITYSDK_OFFSET(0x199F4370)
#define MESHDECIMATOR_BONEWEIGHT_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x8C35C0)
#define MESHDECIMATOR_BONEWEIGHT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x199F3910)
#define MESHDECIMATOR_BONEWEIGHT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x199F3AD0)
#define MESHDECIMATOR_BONEWEIGHT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x199F3A90)
#define MESHDECIMATOR_BONEWEIGHT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8C37E0)
#define MESHDECIMATOR_BONEWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x8C3570)

namespace MeshDecimator
{
	inline static constexpr unsigned int BoneWeight_TypeDefinitionIndex = 31762;
