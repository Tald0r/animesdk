...
#define MESHDECIMATOR_BONEWEIGHT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8F6910)
#define MESHDECIMATOR_BONEWEIGHT_EQUALS_OFFSET UNITYSDK_OFFSET(0x8F6870)
#define MESHDECIMATOR_BONEWEIGHT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F67D0)
#define MESHDECIMATOR_BONEWEIGHT_MERGEBONEWEIGHT_OFFSET UNITYSDK_OFFSET(0x8F6740)
#define MESHDECIMATOR_BONEWEIGHT_MERGE_OFFSET UNITYSDK_OFFSET(0x19FE4030)
#define MESHDECIMATOR_BONEWEIGHT_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x8F6750)
#define MESHDECIMATOR_BONEWEIGHT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19FE35D0)
#define MESHDECIMATOR_BONEWEIGHT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19FE3790)
#define MESHDECIMATOR_BONEWEIGHT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19FE3750)
#define MESHDECIMATOR_BONEWEIGHT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8F6970)
#define MESHDECIMATOR_BONEWEIGHT__CTOR_OFFSET UNITYSDK_OFFSET(0x8F6700)

namespace MeshDecimator
{
	inline static constexpr unsigned int BoneWeight_TypeDefinitionIndex = 32716;
