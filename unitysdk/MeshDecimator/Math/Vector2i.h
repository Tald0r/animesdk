...
#define MESHDECIMATOR_MATH_VECTOR2I_CLAMP_OFFSET UNITYSDK_OFFSET(0x8F7570)
#define MESHDECIMATOR_MATH_VECTOR2I_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x316060)
#define MESHDECIMATOR_MATH_VECTOR2I_EQUALS_OFFSET UNITYSDK_OFFSET(0x8F75B0)
#define MESHDECIMATOR_MATH_VECTOR2I_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F75A0)
#define MESHDECIMATOR_MATH_VECTOR2I_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F7450)
#define MESHDECIMATOR_MATH_VECTOR2I_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x8F7440)
#define MESHDECIMATOR_MATH_VECTOR2I_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x8F7400)
#define MESHDECIMATOR_MATH_VECTOR2I_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x19FE6760)
#define MESHDECIMATOR_MATH_VECTOR2I_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x19FE67E0)
#define MESHDECIMATOR_MATH_VECTOR2I_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19FE6830)
#define MESHDECIMATOR_MATH_VECTOR2I_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x19FE6870)
#define MESHDECIMATOR_MATH_VECTOR2I_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x19FE6850)
#define MESHDECIMATOR_MATH_VECTOR2I_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19FE6840)
#define MESHDECIMATOR_MATH_VECTOR2I_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x19FE67C0)
#define MESHDECIMATOR_MATH_VECTOR2I_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x19FE67A0)
#define MESHDECIMATOR_MATH_VECTOR2I_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x19FE6780)
#define MESHDECIMATOR_MATH_VECTOR2I_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x19FE6810)
#define MESHDECIMATOR_MATH_VECTOR2I_SCALE_1_OFFSET UNITYSDK_OFFSET(0x19FE69A0)
#define MESHDECIMATOR_MATH_VECTOR2I_SCALE_OFFSET UNITYSDK_OFFSET(0x8F7550)
#define MESHDECIMATOR_MATH_VECTOR2I_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F74D0)
#define MESHDECIMATOR_MATH_VECTOR2I_SET_OFFSET UNITYSDK_OFFSET(0x2F3C30)
#define MESHDECIMATOR_MATH_VECTOR2I_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8F70D0)
#define MESHDECIMATOR_MATH_VECTOR2I_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8F70D0)
#define MESHDECIMATOR_MATH_VECTOR2I__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FE69C0)
#define MESHDECIMATOR_MATH_VECTOR2I__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2F3C30)
#define MESHDECIMATOR_MATH_VECTOR2I__CTOR_OFFSET UNITYSDK_OFFSET(0x49FF50)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector2i_TypeDefinitionIndex = 32724;

	struct alignas(4) Vector2i
	{
		static ::MeshDecimator::Math::Vector2i* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector2i*)Il2CppClass::FromTypeDefinitionIndex(Vector2i_TypeDefinitionIndex)->GetStaticField(0x80C0);
		}
		::System::Int32 x; // 0x10
		::System::Int32 y; // 0x14
