...
#define MESHDECIMATOR_MATH_VECTOR3_ANGLE_OFFSET UNITYSDK_OFFSET(0x199F4760)
#define MESHDECIMATOR_MATH_VECTOR3_CLAMP_OFFSET UNITYSDK_OFFSET(0x8C4670)
#define MESHDECIMATOR_MATH_VECTOR3_CROSS_OFFSET UNITYSDK_OFFSET(0x199F7500)
#define MESHDECIMATOR_MATH_VECTOR3_DOT_OFFSET UNITYSDK_OFFSET(0x199F74D0)
#define MESHDECIMATOR_MATH_VECTOR3_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8B7890)
#define MESHDECIMATOR_MATH_VECTOR3_EQUALS_OFFSET UNITYSDK_OFFSET(0x8C46C0)
#define MESHDECIMATOR_MATH_VECTOR3_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8B77E0)
#define MESHDECIMATOR_MATH_VECTOR3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C44A0)
#define MESHDECIMATOR_MATH_VECTOR3_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x8B7A10)
#define MESHDECIMATOR_MATH_VECTOR3_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x8B79E0)
#define MESHDECIMATOR_MATH_VECTOR3_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x8C4480)
#define MESHDECIMATOR_MATH_VECTOR3_LERP_OFFSET UNITYSDK_OFFSET(0x199F7550)
#define MESHDECIMATOR_MATH_VECTOR3_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x199F6E80)
#define MESHDECIMATOR_MATH_VECTOR3_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x8C45F0)
#define MESHDECIMATOR_MATH_VECTOR3_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x199ECC10)
#define MESHDECIMATOR_MATH_VECTOR3_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x199F70C0)
#define MESHDECIMATOR_MATH_VECTOR3_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x199ED230)
#define MESHDECIMATOR_MATH_VECTOR3_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x199F7200)
#define MESHDECIMATOR_MATH_VECTOR3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x199F7240)
#define MESHDECIMATOR_MATH_VECTOR3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x199F7220)
#define MESHDECIMATOR_MATH_VECTOR3_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x199F7110)
#define MESHDECIMATOR_MATH_VECTOR3_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x199F70A0)
#define MESHDECIMATOR_MATH_VECTOR3_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x199ECC40)
#define MESHDECIMATOR_MATH_VECTOR3_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x199F4700)
#define MESHDECIMATOR_MATH_VECTOR3_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x199F70E0)
#define MESHDECIMATOR_MATH_VECTOR3_ORTHONORMALIZE_OFFSET UNITYSDK_OFFSET(0x199F75B0)
#define MESHDECIMATOR_MATH_VECTOR3_SCALE_1_OFFSET UNITYSDK_OFFSET(0x199F7590)
#define MESHDECIMATOR_MATH_VECTOR3_SCALE_OFFSET UNITYSDK_OFFSET(0x8C45D0)
#define MESHDECIMATOR_MATH_VECTOR3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C4520)
#define MESHDECIMATOR_MATH_VECTOR3_SET_OFFSET UNITYSDK_OFFSET(0x42AD80)
#define MESHDECIMATOR_MATH_VECTOR3_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8C4770)
#define MESHDECIMATOR_MATH_VECTOR3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8C4740)
#define MESHDECIMATOR_MATH_VECTOR3__CCTOR_OFFSET UNITYSDK_OFFSET(0x199F7730)
#define MESHDECIMATOR_MATH_VECTOR3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x42AD80)
#define MESHDECIMATOR_MATH_VECTOR3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8C45B0)
#define MESHDECIMATOR_MATH_VECTOR3__CTOR_OFFSET UNITYSDK_OFFSET(0x692690)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector3_TypeDefinitionIndex = 31771;

	struct alignas(4) Vector3
	{
		static ::MeshDecimator::Math::Vector3* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector3*)Il2CppClass::FromTypeDefinitionIndex(Vector3_TypeDefinitionIndex)->GetStaticField(0x7DA0);
		}
