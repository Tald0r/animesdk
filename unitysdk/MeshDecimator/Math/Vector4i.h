...
#define MESHDECIMATOR_MATH_VECTOR4I_CLAMP_OFFSET UNITYSDK_OFFSET(0x8F8B80)
#define MESHDECIMATOR_MATH_VECTOR4I_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8F8C70)
#define MESHDECIMATOR_MATH_VECTOR4I_EQUALS_OFFSET UNITYSDK_OFFSET(0x8F8C00)
#define MESHDECIMATOR_MATH_VECTOR4I_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F8BE0)
#define MESHDECIMATOR_MATH_VECTOR4I_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F89F0)
#define MESHDECIMATOR_MATH_VECTOR4I_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x8F89B0)
#define MESHDECIMATOR_MATH_VECTOR4I_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x8F8940)
#define MESHDECIMATOR_MATH_VECTOR4I_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x19FE9770)
#define MESHDECIMATOR_MATH_VECTOR4I_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x19FE9830)
#define MESHDECIMATOR_MATH_VECTOR4I_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19FE98A0)
#define MESHDECIMATOR_MATH_VECTOR4I_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x19FE9910)
#define MESHDECIMATOR_MATH_VECTOR4I_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x19FE9900)
#define MESHDECIMATOR_MATH_VECTOR4I_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19FE98D0)
#define MESHDECIMATOR_MATH_VECTOR4I_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x19FE97F0)
#define MESHDECIMATOR_MATH_VECTOR4I_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x19FE97B0)
#define MESHDECIMATOR_MATH_VECTOR4I_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x19FE9790)
#define MESHDECIMATOR_MATH_VECTOR4I_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x19FE9880)
#define MESHDECIMATOR_MATH_VECTOR4I_SCALE_1_OFFSET UNITYSDK_OFFSET(0x19FE9B40)
#define MESHDECIMATOR_MATH_VECTOR4I_SCALE_OFFSET UNITYSDK_OFFSET(0x8F8B50)
#define MESHDECIMATOR_MATH_VECTOR4I_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F8A90)
#define MESHDECIMATOR_MATH_VECTOR4I_SET_OFFSET UNITYSDK_OFFSET(0x3A03E0)
#define MESHDECIMATOR_MATH_VECTOR4I_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8F8CF0)
#define MESHDECIMATOR_MATH_VECTOR4I_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8F8CA0)
#define MESHDECIMATOR_MATH_VECTOR4I__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FE9B70)
#define MESHDECIMATOR_MATH_VECTOR4I__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3A03E0)
#define MESHDECIMATOR_MATH_VECTOR4I__CTOR_OFFSET UNITYSDK_OFFSET(0x8F8B40)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector4i_TypeDefinitionIndex = 32730;

	struct alignas(4) Vector4i
	{
		static ::MeshDecimator::Math::Vector4i* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector4i*)Il2CppClass::FromTypeDefinitionIndex(Vector4i_TypeDefinitionIndex)->GetStaticField(0x8140);
		}
		::System::Int32 x; // 0x10
		::System::Int32 y; // 0x14
		::System::Int32 z; // 0x18
