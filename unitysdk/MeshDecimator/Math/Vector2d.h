...
#define MESHDECIMATOR_MATH_VECTOR2D_CLAMP_OFFSET UNITYSDK_OFFSET(0x8C4170)
#define MESHDECIMATOR_MATH_VECTOR2D_DOT_OFFSET UNITYSDK_OFFSET(0x199F68B0)
#define MESHDECIMATOR_MATH_VECTOR2D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8C4240)
#define MESHDECIMATOR_MATH_VECTOR2D_EQUALS_OFFSET UNITYSDK_OFFSET(0x8C41D0)
#define MESHDECIMATOR_MATH_VECTOR2D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8C41B0)
#define MESHDECIMATOR_MATH_VECTOR2D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C3FC0)
#define MESHDECIMATOR_MATH_VECTOR2D_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x8C3F80)
#define MESHDECIMATOR_MATH_VECTOR2D_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x8C3F50)
#define MESHDECIMATOR_MATH_VECTOR2D_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x8C3FA0)
#define MESHDECIMATOR_MATH_VECTOR2D_LERP_OFFSET UNITYSDK_OFFSET(0x199F68D0)
#define MESHDECIMATOR_MATH_VECTOR2D_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x199F62F0)
#define MESHDECIMATOR_MATH_VECTOR2D_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x8C4100)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x199F64C0)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x199F6540)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x199F6580)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x199F66D0)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x199F66A0)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x199F6610)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x199F6520)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x199F6500)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x199F64E0)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x199F6560)
#define MESHDECIMATOR_MATH_VECTOR2D_SCALE_1_OFFSET UNITYSDK_OFFSET(0x199F68F0)
#define MESHDECIMATOR_MATH_VECTOR2D_SCALE_OFFSET UNITYSDK_OFFSET(0x8C40E0)
#define MESHDECIMATOR_MATH_VECTOR2D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C4040)
#define MESHDECIMATOR_MATH_VECTOR2D_SET_OFFSET UNITYSDK_OFFSET(0x48B8B0)
#define MESHDECIMATOR_MATH_VECTOR2D_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8C3F40)
#define MESHDECIMATOR_MATH_VECTOR2D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8C3F40)
#define MESHDECIMATOR_MATH_VECTOR2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x199F6910)
#define MESHDECIMATOR_MATH_VECTOR2D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x48B8B0)
#define MESHDECIMATOR_MATH_VECTOR2D__CTOR_OFFSET UNITYSDK_OFFSET(0x8C40D0)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector2d_TypeDefinitionIndex = 31769;

	struct alignas(8) Vector2d
	{
		static ::MeshDecimator::Math::Vector2d* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector2d*)Il2CppClass::FromTypeDefinitionIndex(Vector2d_TypeDefinitionIndex)->GetStaticField(0x7D80);
		}
