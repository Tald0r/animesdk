...
#define MESHDECIMATOR_MATH_VECTOR2D_CLAMP_OFFSET UNITYSDK_OFFSET(0x8F7300)
#define MESHDECIMATOR_MATH_VECTOR2D_DOT_OFFSET UNITYSDK_OFFSET(0x19FE6570)
#define MESHDECIMATOR_MATH_VECTOR2D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8F73D0)
#define MESHDECIMATOR_MATH_VECTOR2D_EQUALS_OFFSET UNITYSDK_OFFSET(0x8F7360)
#define MESHDECIMATOR_MATH_VECTOR2D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F7340)
#define MESHDECIMATOR_MATH_VECTOR2D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F7150)
#define MESHDECIMATOR_MATH_VECTOR2D_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x8F7110)
#define MESHDECIMATOR_MATH_VECTOR2D_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x8F70E0)
#define MESHDECIMATOR_MATH_VECTOR2D_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x8F7130)
#define MESHDECIMATOR_MATH_VECTOR2D_LERP_OFFSET UNITYSDK_OFFSET(0x19FE6590)
#define MESHDECIMATOR_MATH_VECTOR2D_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x19FE5FB0)
#define MESHDECIMATOR_MATH_VECTOR2D_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x8F7290)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x19FE6180)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x19FE6200)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19FE6240)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x19FE6390)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19FE6360)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19FE62D0)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x19FE61E0)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x19FE61C0)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x19FE61A0)
#define MESHDECIMATOR_MATH_VECTOR2D_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x19FE6220)
#define MESHDECIMATOR_MATH_VECTOR2D_SCALE_1_OFFSET UNITYSDK_OFFSET(0x19FE65B0)
#define MESHDECIMATOR_MATH_VECTOR2D_SCALE_OFFSET UNITYSDK_OFFSET(0x8F7270)
#define MESHDECIMATOR_MATH_VECTOR2D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F71D0)
#define MESHDECIMATOR_MATH_VECTOR2D_SET_OFFSET UNITYSDK_OFFSET(0x76DF80)
#define MESHDECIMATOR_MATH_VECTOR2D_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8F70D0)
#define MESHDECIMATOR_MATH_VECTOR2D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8F70D0)
#define MESHDECIMATOR_MATH_VECTOR2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FE65D0)
#define MESHDECIMATOR_MATH_VECTOR2D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x76DF80)
#define MESHDECIMATOR_MATH_VECTOR2D__CTOR_OFFSET UNITYSDK_OFFSET(0x8F7260)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector2d_TypeDefinitionIndex = 32723;

	struct alignas(8) Vector2d
	{
		static ::MeshDecimator::Math::Vector2d* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector2d*)Il2CppClass::FromTypeDefinitionIndex(Vector2d_TypeDefinitionIndex)->GetStaticField(0x80B0);
		}
