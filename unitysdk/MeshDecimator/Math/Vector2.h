...
#define MESHDECIMATOR_MATH_VECTOR2_CLAMP_OFFSET UNITYSDK_OFFSET(0x8C3E20)
#define MESHDECIMATOR_MATH_VECTOR2_DOT_OFFSET UNITYSDK_OFFSET(0x199F6100)
#define MESHDECIMATOR_MATH_VECTOR2_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8C3F10)
#define MESHDECIMATOR_MATH_VECTOR2_EQUALS_OFFSET UNITYSDK_OFFSET(0x8C3EA0)
#define MESHDECIMATOR_MATH_VECTOR2_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8C3E60)
#define MESHDECIMATOR_MATH_VECTOR2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C3C90)
#define MESHDECIMATOR_MATH_VECTOR2_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x8C3C60)
#define MESHDECIMATOR_MATH_VECTOR2_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x8C3C30)
#define MESHDECIMATOR_MATH_VECTOR2_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x8C3C80)
#define MESHDECIMATOR_MATH_VECTOR2_LERP_OFFSET UNITYSDK_OFFSET(0x199F6120)
#define MESHDECIMATOR_MATH_VECTOR2_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x199F5BF0)
#define MESHDECIMATOR_MATH_VECTOR2_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x8C3DC0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x199ECCA0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x199F5E10)
#define MESHDECIMATOR_MATH_VECTOR2_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x199ED1A0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x199F5EF0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x199F5F40)
#define MESHDECIMATOR_MATH_VECTOR2_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x199F5F20)
#define MESHDECIMATOR_MATH_VECTOR2_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x199F5E60)
#define MESHDECIMATOR_MATH_VECTOR2_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x199F5DE0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x199ECCD0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x199F5DB0)
#define MESHDECIMATOR_MATH_VECTOR2_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x199F5E40)
#define MESHDECIMATOR_MATH_VECTOR2_SCALE_1_OFFSET UNITYSDK_OFFSET(0x199F6140)
#define MESHDECIMATOR_MATH_VECTOR2_SCALE_OFFSET UNITYSDK_OFFSET(0x8C3DA0)
#define MESHDECIMATOR_MATH_VECTOR2_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C3D10)
#define MESHDECIMATOR_MATH_VECTOR2_SET_OFFSET UNITYSDK_OFFSET(0x324E30)
#define MESHDECIMATOR_MATH_VECTOR2_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8C3F40)
#define MESHDECIMATOR_MATH_VECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8C3F40)
#define MESHDECIMATOR_MATH_VECTOR2__CCTOR_OFFSET UNITYSDK_OFFSET(0x199F6150)
#define MESHDECIMATOR_MATH_VECTOR2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x324E30)
#define MESHDECIMATOR_MATH_VECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x5FE6D0)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector2_TypeDefinitionIndex = 31768;

	struct alignas(4) Vector2
	{
		static ::MeshDecimator::Math::Vector2* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector2*)Il2CppClass::FromTypeDefinitionIndex(Vector2_TypeDefinitionIndex)->GetStaticField(0x7D70);
		}
