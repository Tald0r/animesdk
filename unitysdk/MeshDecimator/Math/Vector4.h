...
#define MESHDECIMATOR_MATH_VECTOR4_CLAMP_OFFSET UNITYSDK_OFFSET(0x8C50C0)
#define MESHDECIMATOR_MATH_VECTOR4_DOT_OFFSET UNITYSDK_OFFSET(0x199F8D00)
#define MESHDECIMATOR_MATH_VECTOR4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8B5F10)
#define MESHDECIMATOR_MATH_VECTOR4_EQUALS_OFFSET UNITYSDK_OFFSET(0x8C5130)
#define MESHDECIMATOR_MATH_VECTOR4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8B5E40)
#define MESHDECIMATOR_MATH_VECTOR4_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C4ED0)
#define MESHDECIMATOR_MATH_VECTOR4_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x8B6090)
#define MESHDECIMATOR_MATH_VECTOR4_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x8B6050)
#define MESHDECIMATOR_MATH_VECTOR4_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x8C4EB0)
#define MESHDECIMATOR_MATH_VECTOR4_LERP_OFFSET UNITYSDK_OFFSET(0x199F8D30)
#define MESHDECIMATOR_MATH_VECTOR4_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x199F8680)
#define MESHDECIMATOR_MATH_VECTOR4_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x8C5040)
#define MESHDECIMATOR_MATH_VECTOR4_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x199ECC60)
#define MESHDECIMATOR_MATH_VECTOR4_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x199F88D0)
#define MESHDECIMATOR_MATH_VECTOR4_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x199ED320)
#define MESHDECIMATOR_MATH_VECTOR4_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x199F89D0)
#define MESHDECIMATOR_MATH_VECTOR4_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x199F89F0)
#define MESHDECIMATOR_MATH_VECTOR4_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x199F8910)
#define MESHDECIMATOR_MATH_VECTOR4_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x199F88B0)
#define MESHDECIMATOR_MATH_VECTOR4_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x199ECC80)
#define MESHDECIMATOR_MATH_VECTOR4_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x199F8890)
#define MESHDECIMATOR_MATH_VECTOR4_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x199F88F0)
#define MESHDECIMATOR_MATH_VECTOR4_SCALE_1_OFFSET UNITYSDK_OFFSET(0x199F8D50)
#define MESHDECIMATOR_MATH_VECTOR4_SCALE_OFFSET UNITYSDK_OFFSET(0x8C5030)
#define MESHDECIMATOR_MATH_VECTOR4_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C4F80)
#define MESHDECIMATOR_MATH_VECTOR4_SET_OFFSET UNITYSDK_OFFSET(0x396450)
#define MESHDECIMATOR_MATH_VECTOR4_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8C5210)
#define MESHDECIMATOR_MATH_VECTOR4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8C51C0)
#define MESHDECIMATOR_MATH_VECTOR4__CCTOR_OFFSET UNITYSDK_OFFSET(0x199F8D60)
#define MESHDECIMATOR_MATH_VECTOR4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x396450)
#define MESHDECIMATOR_MATH_VECTOR4__CTOR_OFFSET UNITYSDK_OFFSET(0x62EF90)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector4_TypeDefinitionIndex = 31774;

	struct alignas(4) Vector4
	{
		static ::MeshDecimator::Math::Vector4* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector4*)Il2CppClass::FromTypeDefinitionIndex(Vector4_TypeDefinitionIndex)->GetStaticField(0x7DE0);
		}
