...
#define MESHDECIMATOR_MATH_VECTOR4_CLAMP_OFFSET UNITYSDK_OFFSET(0x8F8260)
#define MESHDECIMATOR_MATH_VECTOR4_DOT_OFFSET UNITYSDK_OFFSET(0x19FE89C0)
#define MESHDECIMATOR_MATH_VECTOR4_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8D11B0)
#define MESHDECIMATOR_MATH_VECTOR4_EQUALS_OFFSET UNITYSDK_OFFSET(0x8F82D0)
#define MESHDECIMATOR_MATH_VECTOR4_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8D10E0)
#define MESHDECIMATOR_MATH_VECTOR4_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F8070)
#define MESHDECIMATOR_MATH_VECTOR4_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x8D1330)
#define MESHDECIMATOR_MATH_VECTOR4_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x8D12F0)
#define MESHDECIMATOR_MATH_VECTOR4_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x8F8050)
#define MESHDECIMATOR_MATH_VECTOR4_LERP_OFFSET UNITYSDK_OFFSET(0x19FE89F0)
#define MESHDECIMATOR_MATH_VECTOR4_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x19FE8340)
#define MESHDECIMATOR_MATH_VECTOR4_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x8F81E0)
#define MESHDECIMATOR_MATH_VECTOR4_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x19FDC920)
#define MESHDECIMATOR_MATH_VECTOR4_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x19FE8590)
#define MESHDECIMATOR_MATH_VECTOR4_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19FDCFE0)
#define MESHDECIMATOR_MATH_VECTOR4_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x19FE8690)
#define MESHDECIMATOR_MATH_VECTOR4_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19FE86B0)
#define MESHDECIMATOR_MATH_VECTOR4_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19FE85D0)
#define MESHDECIMATOR_MATH_VECTOR4_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x19FE8570)
#define MESHDECIMATOR_MATH_VECTOR4_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x19FDC940)
#define MESHDECIMATOR_MATH_VECTOR4_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x19FE8550)
#define MESHDECIMATOR_MATH_VECTOR4_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x19FE85B0)
#define MESHDECIMATOR_MATH_VECTOR4_SCALE_1_OFFSET UNITYSDK_OFFSET(0x19FE8A10)
#define MESHDECIMATOR_MATH_VECTOR4_SCALE_OFFSET UNITYSDK_OFFSET(0x8F81D0)
#define MESHDECIMATOR_MATH_VECTOR4_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F8120)
#define MESHDECIMATOR_MATH_VECTOR4_SET_OFFSET UNITYSDK_OFFSET(0x42F920)
#define MESHDECIMATOR_MATH_VECTOR4_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8F83B0)
#define MESHDECIMATOR_MATH_VECTOR4_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8F8360)
#define MESHDECIMATOR_MATH_VECTOR4__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FE8A20)
#define MESHDECIMATOR_MATH_VECTOR4__CTOR_1_OFFSET UNITYSDK_OFFSET(0x42F920)
#define MESHDECIMATOR_MATH_VECTOR4__CTOR_OFFSET UNITYSDK_OFFSET(0x39D0C0)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector4_TypeDefinitionIndex = 32728;

	struct alignas(4) Vector4
	{
		static ::MeshDecimator::Math::Vector4* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector4*)Il2CppClass::FromTypeDefinitionIndex(Vector4_TypeDefinitionIndex)->GetStaticField(0x8110);
		}
