...
#define MESHDECIMATOR_MATH_VECTOR4D_CLAMP_OFFSET UNITYSDK_OFFSET(0x8F8700)
#define MESHDECIMATOR_MATH_VECTOR4D_DOT_OFFSET UNITYSDK_OFFSET(0x19FE9460)
#define MESHDECIMATOR_MATH_VECTOR4D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8F8860)
#define MESHDECIMATOR_MATH_VECTOR4D_EQUALS_OFFSET UNITYSDK_OFFSET(0x8F87D0)
#define MESHDECIMATOR_MATH_VECTOR4D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F8780)
#define MESHDECIMATOR_MATH_VECTOR4D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F8490)
#define MESHDECIMATOR_MATH_VECTOR4D_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x8F8440)
#define MESHDECIMATOR_MATH_VECTOR4D_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x8F8400)
#define MESHDECIMATOR_MATH_VECTOR4D_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x8F8470)
#define MESHDECIMATOR_MATH_VECTOR4D_LERP_OFFSET UNITYSDK_OFFSET(0x19FE94A0)
#define MESHDECIMATOR_MATH_VECTOR4D_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x19FE8BF0)
#define MESHDECIMATOR_MATH_VECTOR4D_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x8F8660)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x19FE8E60)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x19FE8F20)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19FE8F70)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x19FE9120)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x19FE9100)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19FE9040)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x19FE8EF0)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x19FE8EC0)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x19FE8E90)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x19FE8F50)
#define MESHDECIMATOR_MATH_VECTOR4D_SCALE_1_OFFSET UNITYSDK_OFFSET(0x19FE94E0)
#define MESHDECIMATOR_MATH_VECTOR4D_SCALE_OFFSET UNITYSDK_OFFSET(0x8F8630)
#define MESHDECIMATOR_MATH_VECTOR4D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F8540)
#define MESHDECIMATOR_MATH_VECTOR4D_SET_OFFSET UNITYSDK_OFFSET(0x8F8610)
#define MESHDECIMATOR_MATH_VECTOR4D_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8F88F0)
#define MESHDECIMATOR_MATH_VECTOR4D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8F88A0)
#define MESHDECIMATOR_MATH_VECTOR4D__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FE9510)
#define MESHDECIMATOR_MATH_VECTOR4D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8F8610)
#define MESHDECIMATOR_MATH_VECTOR4D__CTOR_OFFSET UNITYSDK_OFFSET(0x8F85F0)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector4d_TypeDefinitionIndex = 32729;

	struct alignas(8) Vector4d
	{
		static ::MeshDecimator::Math::Vector4d* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector4d*)Il2CppClass::FromTypeDefinitionIndex(Vector4d_TypeDefinitionIndex)->GetStaticField(0x8120);
		}
