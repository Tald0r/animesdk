...
#define MESHDECIMATOR_MATH_VECTOR4D_CLAMP_OFFSET UNITYSDK_OFFSET(0x8C5560)
#define MESHDECIMATOR_MATH_VECTOR4D_DOT_OFFSET UNITYSDK_OFFSET(0x199F97A0)
#define MESHDECIMATOR_MATH_VECTOR4D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8C56C0)
#define MESHDECIMATOR_MATH_VECTOR4D_EQUALS_OFFSET UNITYSDK_OFFSET(0x8C5630)
#define MESHDECIMATOR_MATH_VECTOR4D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8C55E0)
#define MESHDECIMATOR_MATH_VECTOR4D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C52F0)
#define MESHDECIMATOR_MATH_VECTOR4D_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x8C52A0)
#define MESHDECIMATOR_MATH_VECTOR4D_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x8C5260)
#define MESHDECIMATOR_MATH_VECTOR4D_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x8C52D0)
#define MESHDECIMATOR_MATH_VECTOR4D_LERP_OFFSET UNITYSDK_OFFSET(0x199F97E0)
#define MESHDECIMATOR_MATH_VECTOR4D_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x199F8F30)
#define MESHDECIMATOR_MATH_VECTOR4D_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x8C54C0)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x199F91A0)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x199F9260)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x199F92B0)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x199F9460)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x199F9440)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x199F9380)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x199F9230)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x199F9200)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x199F91D0)
#define MESHDECIMATOR_MATH_VECTOR4D_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x199F9290)
#define MESHDECIMATOR_MATH_VECTOR4D_SCALE_1_OFFSET UNITYSDK_OFFSET(0x199F9820)
#define MESHDECIMATOR_MATH_VECTOR4D_SCALE_OFFSET UNITYSDK_OFFSET(0x8C5490)
#define MESHDECIMATOR_MATH_VECTOR4D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C53A0)
#define MESHDECIMATOR_MATH_VECTOR4D_SET_OFFSET UNITYSDK_OFFSET(0x8C5470)
#define MESHDECIMATOR_MATH_VECTOR4D_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8C5750)
#define MESHDECIMATOR_MATH_VECTOR4D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8C5700)
#define MESHDECIMATOR_MATH_VECTOR4D__CCTOR_OFFSET UNITYSDK_OFFSET(0x199F9850)
#define MESHDECIMATOR_MATH_VECTOR4D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8C5470)
#define MESHDECIMATOR_MATH_VECTOR4D__CTOR_OFFSET UNITYSDK_OFFSET(0x8C5450)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector4d_TypeDefinitionIndex = 31775;

	struct alignas(8) Vector4d
	{
		static ::MeshDecimator::Math::Vector4d* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector4d*)Il2CppClass::FromTypeDefinitionIndex(Vector4d_TypeDefinitionIndex)->GetStaticField(0x7DF0);
		}
