...
#define MESHDECIMATOR_MATH_VECTOR3D_ANGLE_OFFSET UNITYSDK_OFFSET(0x199F4A60)
#define MESHDECIMATOR_MATH_VECTOR3D_CLAMP_OFFSET UNITYSDK_OFFSET(0x8C4A20)
#define MESHDECIMATOR_MATH_VECTOR3D_CROSS_OFFSET UNITYSDK_OFFSET(0x199EAAD0)
#define MESHDECIMATOR_MATH_VECTOR3D_DOT_OFFSET UNITYSDK_OFFSET(0x199EAAA0)
#define MESHDECIMATOR_MATH_VECTOR3D_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8C4B40)
#define MESHDECIMATOR_MATH_VECTOR3D_EQUALS_OFFSET UNITYSDK_OFFSET(0x8C4AC0)
#define MESHDECIMATOR_MATH_VECTOR3D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8C4A80)
#define MESHDECIMATOR_MATH_VECTOR3D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C4820)
#define MESHDECIMATOR_MATH_VECTOR3D_GET_MAGNITUDESQR_OFFSET UNITYSDK_OFFSET(0x8C47E0)
#define MESHDECIMATOR_MATH_VECTOR3D_GET_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x8C47A0)
#define MESHDECIMATOR_MATH_VECTOR3D_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x8C4800)
#define MESHDECIMATOR_MATH_VECTOR3D_LERP_OFFSET UNITYSDK_OFFSET(0x199F7F80)
#define MESHDECIMATOR_MATH_VECTOR3D_NORMALIZE_1_OFFSET UNITYSDK_OFFSET(0x199F78C0)
#define MESHDECIMATOR_MATH_VECTOR3D_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x8C4990)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x199EA330)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x199F7B00)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x199F7B50)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x199F7D70)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x199F7D50)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x199F7D30)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x199F7C40)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x199F7AE0)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x199EA360)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x199EA9E0)
#define MESHDECIMATOR_MATH_VECTOR3D_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x199F7B30)
#define MESHDECIMATOR_MATH_VECTOR3D_SCALE_1_OFFSET UNITYSDK_OFFSET(0x199F7FC0)
#define MESHDECIMATOR_MATH_VECTOR3D_SCALE_OFFSET UNITYSDK_OFFSET(0x8C4960)
#define MESHDECIMATOR_MATH_VECTOR3D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C48A0)
#define MESHDECIMATOR_MATH_VECTOR3D_SET_OFFSET UNITYSDK_OFFSET(0x7976F0)
#define MESHDECIMATOR_MATH_VECTOR3D_TOSTRING_1_OFFSET UNITYSDK_OFFSET(0x8C4BB0)
#define MESHDECIMATOR_MATH_VECTOR3D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8C4B80)
#define MESHDECIMATOR_MATH_VECTOR3D__CCTOR_OFFSET UNITYSDK_OFFSET(0x199F7FF0)
#define MESHDECIMATOR_MATH_VECTOR3D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x7976F0)
#define MESHDECIMATOR_MATH_VECTOR3D__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8C4940)
#define MESHDECIMATOR_MATH_VECTOR3D__CTOR_OFFSET UNITYSDK_OFFSET(0x8C4930)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int Vector3d_TypeDefinitionIndex = 31772;

	struct alignas(8) Vector3d
	{
		static ::MeshDecimator::Math::Vector3d* StaticGet_zero()
		{
			return (::MeshDecimator::Math::Vector3d*)Il2CppClass::FromTypeDefinitionIndex(Vector3d_TypeDefinitionIndex)->GetStaticField(0x7DB0);
		}
