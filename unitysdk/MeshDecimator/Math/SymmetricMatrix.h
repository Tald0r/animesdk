...
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT1_OFFSET UNITYSDK_OFFSET(0x8C39C0)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT2_OFFSET UNITYSDK_OFFSET(0x8C3A40)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT3_OFFSET UNITYSDK_OFFSET(0x8C3AE0)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT4_OFFSET UNITYSDK_OFFSET(0x8C3B70)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT_OFFSET UNITYSDK_OFFSET(0x8C3C20)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C37F0)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x199EA050)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8C3910)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8C3960)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x8C38D0)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int SymmetricMatrix_TypeDefinitionIndex = 31767;
