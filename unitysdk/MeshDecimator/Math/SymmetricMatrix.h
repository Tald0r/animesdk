...
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT1_OFFSET UNITYSDK_OFFSET(0x8F6B50)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT2_OFFSET UNITYSDK_OFFSET(0x8F6BD0)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT3_OFFSET UNITYSDK_OFFSET(0x8F6C70)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT4_OFFSET UNITYSDK_OFFSET(0x8F6D00)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_DETERMINANT_OFFSET UNITYSDK_OFFSET(0x8F6DB0)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F6980)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x19FD9D10)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8F6AA0)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8F6AF0)
#define MESHDECIMATOR_MATH_SYMMETRICMATRIX__CTOR_OFFSET UNITYSDK_OFFSET(0x8F6A60)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int SymmetricMatrix_TypeDefinitionIndex = 32721;
