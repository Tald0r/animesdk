...
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP01_1_OFFSET UNITYSDK_OFFSET(0x19FE4210)
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP01_OFFSET UNITYSDK_OFFSET(0x19FE41F0)
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x19FE41B0)
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP_OFFSET UNITYSDK_OFFSET(0x19FE4180)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_1_OFFSET UNITYSDK_OFFSET(0x19FE4130)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_2_OFFSET UNITYSDK_OFFSET(0x19FE4140)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_3_OFFSET UNITYSDK_OFFSET(0x19FE4150)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_4_OFFSET UNITYSDK_OFFSET(0x19FE4160)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_5_OFFSET UNITYSDK_OFFSET(0x19FE4170)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_OFFSET UNITYSDK_OFFSET(0x19FD89B0)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_1_OFFSET UNITYSDK_OFFSET(0x19FE40F0)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_2_OFFSET UNITYSDK_OFFSET(0x19FE4100)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_3_OFFSET UNITYSDK_OFFSET(0x19FE4110)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_4_OFFSET UNITYSDK_OFFSET(0x19FE4120)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_5_OFFSET UNITYSDK_OFFSET(0x19FDA040)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_OFFSET UNITYSDK_OFFSET(0x19FE40E0)
#define MESHDECIMATOR_MATH_MATHHELPER_TRIANGLEAREA_1_OFFSET UNITYSDK_OFFSET(0x19FE4530)
#define MESHDECIMATOR_MATH_MATHHELPER_TRIANGLEAREA_OFFSET UNITYSDK_OFFSET(0x19FE4230)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int MathHelper_TypeDefinitionIndex = 32720;
