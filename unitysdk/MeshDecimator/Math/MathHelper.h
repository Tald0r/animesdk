...
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP01_1_OFFSET UNITYSDK_OFFSET(0x199F4550)
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP01_OFFSET UNITYSDK_OFFSET(0x199F4530)
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x199F44F0)
#define MESHDECIMATOR_MATH_MATHHELPER_CLAMP_OFFSET UNITYSDK_OFFSET(0x199F44C0)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_1_OFFSET UNITYSDK_OFFSET(0x199F4470)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_2_OFFSET UNITYSDK_OFFSET(0x199F4480)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_3_OFFSET UNITYSDK_OFFSET(0x199F4490)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_4_OFFSET UNITYSDK_OFFSET(0x199F44A0)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_5_OFFSET UNITYSDK_OFFSET(0x199F44B0)
#define MESHDECIMATOR_MATH_MATHHELPER_MAX_OFFSET UNITYSDK_OFFSET(0x199E8D20)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_1_OFFSET UNITYSDK_OFFSET(0x199F4430)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_2_OFFSET UNITYSDK_OFFSET(0x199F4440)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_3_OFFSET UNITYSDK_OFFSET(0x199F4450)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_4_OFFSET UNITYSDK_OFFSET(0x199F4460)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_5_OFFSET UNITYSDK_OFFSET(0x199EA380)
#define MESHDECIMATOR_MATH_MATHHELPER_MIN_OFFSET UNITYSDK_OFFSET(0x199F4420)
#define MESHDECIMATOR_MATH_MATHHELPER_TRIANGLEAREA_1_OFFSET UNITYSDK_OFFSET(0x199F4870)
#define MESHDECIMATOR_MATH_MATHHELPER_TRIANGLEAREA_OFFSET UNITYSDK_OFFSET(0x199F4570)

namespace MeshDecimator::Math
{
	inline static constexpr unsigned int MathHelper_TypeDefinitionIndex = 31766;
