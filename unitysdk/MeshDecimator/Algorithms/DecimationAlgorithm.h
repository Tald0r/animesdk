...
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_ADD_STATUSREPORT_OFFSET UNITYSDK_OFFSET(0x19FD89E0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_GET_KEEPBORDERS_OFFSET UNITYSDK_OFFSET(0x19FD8930)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_GET_KEEPLINKEDVERTICES_OFFSET UNITYSDK_OFFSET(0x19FD8970)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_GET_MAXVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x19FD8990)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_GET_PRESERVEBORDERS_OFFSET UNITYSDK_OFFSET(0x19FD8950)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_GET_VERBOSE_OFFSET UNITYSDK_OFFSET(0x19FD89C0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_REMOVE_STATUSREPORT_OFFSET UNITYSDK_OFFSET(0x19FD8A60)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_REPORTSTATUS_OFFSET UNITYSDK_OFFSET(0x19FD8AE0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_SET_KEEPBORDERS_OFFSET UNITYSDK_OFFSET(0x19FD8940)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_SET_KEEPLINKEDVERTICES_OFFSET UNITYSDK_OFFSET(0x19FD8980)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_SET_MAXVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x19FD89A0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_SET_PRESERVEBORDERS_OFFSET UNITYSDK_OFFSET(0x19FD8960)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_SET_VERBOSE_OFFSET UNITYSDK_OFFSET(0x19FD89D0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD9120)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int DecimationAlgorithm_TypeDefinitionIndex = 32733;
	...
	public:
		...
		::System::Boolean preserveBorders; // 0x1C
		::System::Boolean verbose; // 0x1D
