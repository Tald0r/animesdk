...
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_ADD_STATUSREPORT_OFFSET UNITYSDK_OFFSET(0x199E8D50)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_GET_KEEPBORDERS_OFFSET UNITYSDK_OFFSET(0x199E8CA0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_GET_KEEPLINKEDVERTICES_OFFSET UNITYSDK_OFFSET(0x199E8CE0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_GET_MAXVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x199E8D00)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_GET_PRESERVEBORDERS_OFFSET UNITYSDK_OFFSET(0x199E8CC0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_GET_VERBOSE_OFFSET UNITYSDK_OFFSET(0x199E8D30)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_REMOVE_STATUSREPORT_OFFSET UNITYSDK_OFFSET(0x199E8DD0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_REPORTSTATUS_OFFSET UNITYSDK_OFFSET(0x199E8E50)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_SET_KEEPBORDERS_OFFSET UNITYSDK_OFFSET(0x199E8CB0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_SET_KEEPLINKEDVERTICES_OFFSET UNITYSDK_OFFSET(0x199E8CF0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_SET_MAXVERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x199E8D10)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_SET_PRESERVEBORDERS_OFFSET UNITYSDK_OFFSET(0x199E8CD0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_SET_VERBOSE_OFFSET UNITYSDK_OFFSET(0x199E8D40)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM__CTOR_OFFSET UNITYSDK_OFFSET(0x199E9480)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int DecimationAlgorithm_TypeDefinitionIndex = 31779;
	...
	public:
		...
		::System::Boolean preserveBorders; // 0x18
		::System::Boolean verbose; // 0x19
		::System::Int32 maxVertexCount; // 0x1C
