...
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_GETATTRIBUTEINDICES_OFFSET UNITYSDK_OFFSET(0x8F6560)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_GETERRORS_OFFSET UNITYSDK_OFFSET(0x8F65F0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F6480)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_SETATTRIBUTEINDEX_OFFSET UNITYSDK_OFFSET(0x8F6570)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8F64A0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x8F6520)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int FastQuadricMeshSimplification_Triangle_TypeDefinitionIndex = 32736;
