...
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_GETATTRIBUTEINDICES_OFFSET UNITYSDK_OFFSET(0x8C33D0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_GETERRORS_OFFSET UNITYSDK_OFFSET(0x8C3460)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C32F0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_SETATTRIBUTEINDEX_OFFSET UNITYSDK_OFFSET(0x8C33E0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8C3310)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x8C3390)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int FastQuadricMeshSimplification_Triangle_TypeDefinitionIndex = 31782;
