...
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_AREUVSTHESAME_OFFSET UNITYSDK_OFFSET(0x199ECD00)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_CALCULATEERROR_OFFSET UNITYSDK_OFFSET(0x199E9920)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_COMPACTMESH_OFFSET UNITYSDK_OFFSET(0x199EF920)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_DECIMATEMESHLOSSLESS_OFFSET UNITYSDK_OFFSET(0x199F1E90)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_DECIMATEMESH_OFFSET UNITYSDK_OFFSET(0x199F1B90)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_FLIPPED_OFFSET UNITYSDK_OFFSET(0x199EA390)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_AGRESSIVENESS_OFFSET UNITYSDK_OFFSET(0x199E95D0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_ENABLESMARTLINK_OFFSET UNITYSDK_OFFSET(0x199E9590)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_MAXITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x199E95B0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_PRESERVEFOLDOVERS_OFFSET UNITYSDK_OFFSET(0x199E9570)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_PRESERVESEAMS_OFFSET UNITYSDK_OFFSET(0x199E9550)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_VERTEXLINKDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x199E95F0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x199F0E60)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_MERGEVERTEXATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x199EBC00)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_MOVEVERTEXATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x199EB2D0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_REMOVEVERTEXPASS_OFFSET UNITYSDK_OFFSET(0x199ED3E0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_AGRESSIVENESS_OFFSET UNITYSDK_OFFSET(0x199E95E0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_ENABLESMARTLINK_OFFSET UNITYSDK_OFFSET(0x199E95A0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_MAXITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x199E95C0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_PRESERVEFOLDOVERS_OFFSET UNITYSDK_OFFSET(0x199E9580)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_PRESERVESEAMS_OFFSET UNITYSDK_OFFSET(0x199E9560)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_VERTEXLINKDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x199E9600)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TOMESH_OFFSET UNITYSDK_OFFSET(0x199F20C0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_UPDATEMESH_OFFSET UNITYSDK_OFFSET(0x199EDE70)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_UPDATEREFERENCES_OFFSET UNITYSDK_OFFSET(0x199EF4A0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_UPDATETRIANGLES_OFFSET UNITYSDK_OFFSET(0x199EAB20)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_VERTEXERROR_OFFSET UNITYSDK_OFFSET(0x199E9810)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x199E9610)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int FastQuadricMeshSimplification_TypeDefinitionIndex = 31781;
	...
	public:
		...
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::BoneWeight>* vertBoneWeights; // 0x20
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Math::Vector3>* vertNormals; // 0x28
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Math::Vector4>* vertTangents; // 0x30
		::MeshDecimator::Collections::UVChannels_1<::MeshDecimator::Math::Vector4>* vertUV4D; // 0x38
		::MeshDecimator::Collections::UVChannels_1<::MeshDecimator::Math::Vector2>* vertUV2D; // 0x40
		::Il2CppArray<::System::Double>* errArr; // 0x48
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Algorithms::FastQuadricMeshSimplification_Triangle>* triangles; // 0x50
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Algorithms::FastQuadricMeshSimplification_Vertex>* vertices; // 0x58
		::Il2CppArray<::System::Int32>* attributeIndexArr; // 0x60
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Math::Vector4>* vertColors; // 0x68
		::MeshDecimator::Collections::UVChannels_1<::MeshDecimator::Math::Vector3>* vertUV3D; // 0x70
		...
		::System::Boolean preserveFoldovers; // 0x9C
		::System::Boolean preserveSeams; // 0x9D
		::System::Boolean enableSmartLink; // 0x9E
