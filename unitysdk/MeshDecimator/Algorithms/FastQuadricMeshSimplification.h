...
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_AREUVSTHESAME_OFFSET UNITYSDK_OFFSET(0x19FDC9C0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_CALCULATEERROR_OFFSET UNITYSDK_OFFSET(0x19FD95E0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_COMPACTMESH_OFFSET UNITYSDK_OFFSET(0x19FDF5E0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_DECIMATEMESHLOSSLESS_OFFSET UNITYSDK_OFFSET(0x19FE1B50)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_DECIMATEMESH_OFFSET UNITYSDK_OFFSET(0x19FE1850)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_FLIPPED_OFFSET UNITYSDK_OFFSET(0x19FDA050)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_AGRESSIVENESS_OFFSET UNITYSDK_OFFSET(0x19FD9280)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_ENABLESMARTLINK_OFFSET UNITYSDK_OFFSET(0x19FD9240)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_MAXITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x19FD9260)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_PRESERVEFOLDOVERS_OFFSET UNITYSDK_OFFSET(0x19FD9220)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_PRESERVESEAMS_OFFSET UNITYSDK_OFFSET(0x19FD9200)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_GET_VERTEXLINKDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x19FD92A0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x19FE0B20)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_MERGEVERTEXATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19FDB8C0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_MOVEVERTEXATTRIBUTES_OFFSET UNITYSDK_OFFSET(0x19FDAF90)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_REMOVEVERTEXPASS_OFFSET UNITYSDK_OFFSET(0x19FDD0A0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_AGRESSIVENESS_OFFSET UNITYSDK_OFFSET(0x19FD9290)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_ENABLESMARTLINK_OFFSET UNITYSDK_OFFSET(0x19FD9250)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_MAXITERATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x19FD9270)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_PRESERVEFOLDOVERS_OFFSET UNITYSDK_OFFSET(0x19FD9230)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_PRESERVESEAMS_OFFSET UNITYSDK_OFFSET(0x19FD9210)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_SET_VERTEXLINKDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x19FD92B0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_TOMESH_OFFSET UNITYSDK_OFFSET(0x19FE1D80)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_UPDATEMESH_OFFSET UNITYSDK_OFFSET(0x19FDDB30)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_UPDATEREFERENCES_OFFSET UNITYSDK_OFFSET(0x19FDF160)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_UPDATETRIANGLES_OFFSET UNITYSDK_OFFSET(0x19FDA7E0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_VERTEXERROR_OFFSET UNITYSDK_OFFSET(0x19FD94D0)
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD92C0)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int FastQuadricMeshSimplification_TypeDefinitionIndex = 32735;
	...
	public:
		...
		::MeshDecimator::Collections::UVChannels_1<::MeshDecimator::Math::Vector3>* vertUV3D; // 0x20
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Algorithms::FastQuadricMeshSimplification_Ref>* refs; // 0x28
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Algorithms::FastQuadricMeshSimplification_Triangle>* triangles; // 0x30
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Math::Vector3>* vertNormals; // 0x38
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::BoneWeight>* vertBoneWeights; // 0x40
		::Il2CppArray<::System::Double>* errArr; // 0x48
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Math::Vector4>* vertTangents; // 0x50
		::MeshDecimator::Collections::UVChannels_1<::MeshDecimator::Math::Vector4>* vertUV4D; // 0x58
		::MeshDecimator::Collections::UVChannels_1<::MeshDecimator::Math::Vector2>* vertUV2D; // 0x60
		::Il2CppArray<::System::Int32>* attributeIndexArr; // 0x68
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Math::Vector4>* vertColors; // 0x70
		::MeshDecimator::Collections::ResizableArray_1<::MeshDecimator::Algorithms::FastQuadricMeshSimplification_Vertex>* vertices; // 0x78
		::System::Int32 subMeshCount; // 0x80
		::System::Int32 maxIterationCount; // 0x84
		::System::Double agressiveness; // 0x88
		::System::Boolean preserveSeams; // 0x90
		::System::Boolean enableSmartLink; // 0x91
		::System::Boolean preserveFoldovers; // 0x92
		::System::Int32 remainingVertices; // 0x94
		::System::Double vertexLinkDistanceSqr; // 0x98
