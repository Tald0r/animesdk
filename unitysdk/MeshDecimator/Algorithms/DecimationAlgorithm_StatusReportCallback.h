...
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_STATUSREPORTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x199E94A0)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_STATUSREPORTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x199E9540)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_STATUSREPORTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x199E8E60)
#define MESHDECIMATOR_ALGORITHMS_DECIMATIONALGORITHM_STATUSREPORTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x199E9490)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int DecimationAlgorithm_StatusReportCallback_TypeDefinitionIndex = 31780;
