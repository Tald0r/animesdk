...
#define MESHDECIMATOR_ALGORITHMS_FASTQUADRICMESHSIMPLIFICATION_VERTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x8C3530)

namespace MeshDecimator::Algorithms
{
	inline static constexpr unsigned int FastQuadricMeshSimplification_Vertex_TypeDefinitionIndex = 31783;
