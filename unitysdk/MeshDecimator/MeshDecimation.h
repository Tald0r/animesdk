...
#define MESHDECIMATOR_MESHDECIMATION_CREATEALGORITHM_OFFSET UNITYSDK_OFFSET(0x199FC7D0)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESHLOSSLESS_1_OFFSET UNITYSDK_OFFSET(0x199FCB20)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESHLOSSLESS_2_OFFSET UNITYSDK_OFFSET(0x199FCC10)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESHLOSSLESS_OFFSET UNITYSDK_OFFSET(0x199FCB10)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESH_1_OFFSET UNITYSDK_OFFSET(0x199FC860)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESH_2_OFFSET UNITYSDK_OFFSET(0x199FC950)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESH_OFFSET UNITYSDK_OFFSET(0x199FC850)

namespace MeshDecimator
{
	inline static constexpr unsigned int MeshDecimation_TypeDefinitionIndex = 31765;
