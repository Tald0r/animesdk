...
#define MESHDECIMATOR_MESHDECIMATION_CREATEALGORITHM_OFFSET UNITYSDK_OFFSET(0x19FEC4B0)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESHLOSSLESS_1_OFFSET UNITYSDK_OFFSET(0x19FEC800)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESHLOSSLESS_2_OFFSET UNITYSDK_OFFSET(0x19FEC8F0)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESHLOSSLESS_OFFSET UNITYSDK_OFFSET(0x19FEC7F0)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESH_1_OFFSET UNITYSDK_OFFSET(0x19FEC540)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESH_2_OFFSET UNITYSDK_OFFSET(0x19FEC630)
#define MESHDECIMATOR_MESHDECIMATION_DECIMATEMESH_OFFSET UNITYSDK_OFFSET(0x19FEC530)

namespace MeshDecimator
{
	inline static constexpr unsigned int MeshDecimation_TypeDefinitionIndex = 32719;
