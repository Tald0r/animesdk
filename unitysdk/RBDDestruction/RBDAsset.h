...
#define RBDDESTRUCTION_RBDASSET_CLEARJSONDATA_OFFSET UNITYSDK_OFFSET(0x189D6DC0)
#define RBDDESTRUCTION_RBDASSET_GETTOTALGROUPS_OFFSET UNITYSDK_OFFSET(0x189D6530)
#define RBDDESTRUCTION_RBDASSET_READJSONDATA_OFFSET UNITYSDK_OFFSET(0x189D6970)
#define RBDDESTRUCTION_RBDASSET_UPDATEGROUPFRAGMENTCOUNTS_OFFSET UNITYSDK_OFFSET(0x189D6650)
#define RBDDESTRUCTION_RBDASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x189D6E10)

namespace RBDDestruction
{
	inline static constexpr unsigned int RBDAsset_TypeDefinitionIndex = 29185;
