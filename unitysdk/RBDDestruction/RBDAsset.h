...
#define RBDDESTRUCTION_RBDASSET_CLEARJSONDATA_OFFSET UNITYSDK_OFFSET(0x18380CE0)
#define RBDDESTRUCTION_RBDASSET_GETTOTALGROUPS_OFFSET UNITYSDK_OFFSET(0x18380450)
#define RBDDESTRUCTION_RBDASSET_READJSONDATA_OFFSET UNITYSDK_OFFSET(0x18380890)
#define RBDDESTRUCTION_RBDASSET_UPDATEGROUPFRAGMENTCOUNTS_OFFSET UNITYSDK_OFFSET(0x18380570)
#define RBDDESTRUCTION_RBDASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x18380D30)

namespace RBDDestruction
{
	inline static constexpr unsigned int RBDAsset_TypeDefinitionIndex = 28244;
