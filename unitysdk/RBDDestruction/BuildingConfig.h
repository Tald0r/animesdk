...
#define RBDDESTRUCTION_BUILDINGCONFIG_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x17632E70)
#define RBDDESTRUCTION_BUILDINGCONFIG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17632AD0)
#define RBDDESTRUCTION_BUILDINGCONFIG_RESET_OFFSET UNITYSDK_OFFSET(0x17632EB0)
#define RBDDESTRUCTION_BUILDINGCONFIG_SWITCH_OFFSET UNITYSDK_OFFSET(0x17632DB0)
#define RBDDESTRUCTION_BUILDINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x17632F70)

namespace RBDDestruction
{
	inline static constexpr unsigned int BuildingConfig_TypeDefinitionIndex = 29178;
