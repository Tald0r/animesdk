...
#define RBDDESTRUCTION_BUILDINGCONFIG_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x16F5EBD0)
#define RBDDESTRUCTION_BUILDINGCONFIG_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16F5E830)
#define RBDDESTRUCTION_BUILDINGCONFIG_RESET_OFFSET UNITYSDK_OFFSET(0x16F5EC10)
#define RBDDESTRUCTION_BUILDINGCONFIG_SWITCH_OFFSET UNITYSDK_OFFSET(0x16F5EB10)
#define RBDDESTRUCTION_BUILDINGCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x16F5ECD0)

namespace RBDDestruction
{
	inline static constexpr unsigned int BuildingConfig_TypeDefinitionIndex = 28237;
