...
#define RBDDESTRUCTION_SIMULATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x151A0F30)

namespace RBDDestruction
{
	inline static constexpr unsigned int SimulationConfig_TypeDefinitionIndex = 29183;
