...
#define RBDDESTRUCTION_SIMULATIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13919C90)

namespace RBDDestruction
{
	inline static constexpr unsigned int SimulationConfig_TypeDefinitionIndex = 28242;
