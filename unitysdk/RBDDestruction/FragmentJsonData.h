...
#define RBDDESTRUCTION_FRAGMENTJSONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1923C1A0)

namespace RBDDestruction
{
	inline static constexpr unsigned int FragmentJsonData_TypeDefinitionIndex = 28238;
