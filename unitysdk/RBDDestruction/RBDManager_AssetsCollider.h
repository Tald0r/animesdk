...
#define RBDDESTRUCTION_RBDMANAGER_ASSETSCOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x18B2C1A0)

namespace RBDDestruction
{
	inline static constexpr unsigned int RBDManager_AssetsCollider_TypeDefinitionIndex = 28253;
