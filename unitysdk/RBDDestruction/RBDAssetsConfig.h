...
#define RBDDESTRUCTION_RBDASSETSCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x13919B60)

namespace RBDDestruction
{
	inline static constexpr unsigned int RBDAssetsConfig_TypeDefinitionIndex = 28245;
