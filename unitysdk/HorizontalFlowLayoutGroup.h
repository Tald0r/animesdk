...
#define HORIZONTALFLOWLAYOUTGROUP_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x889AF90)
#define HORIZONTALFLOWLAYOUTGROUP_CALCULATELAYOUTINPUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x889BE20)
#define HORIZONTALFLOWLAYOUTGROUP_CALCULATEROWVERTICALOFFSET_OFFSET UNITYSDK_OFFSET(0x889BEC0)
#define HORIZONTALFLOWLAYOUTGROUP_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x889C990)
#define HORIZONTALFLOWLAYOUTGROUP_GETGREATESTMINCOLWIDTH_OFFSET UNITYSDK_OFFSET(0x889B0F0)
#define HORIZONTALFLOWLAYOUTGROUP_GETGREATESTMINIMUMCHILDWIDTH_OFFSET UNITYSDK_OFFSET(0x889C8C0)
#define HORIZONTALFLOWLAYOUTGROUP_GET_CHILDFORCEEXPANDHEIGHT_OFFSET UNITYSDK_OFFSET(0x889AC50)
#define HORIZONTALFLOWLAYOUTGROUP_GET_CHILDFORCEEXPANDWIDTH_OFFSET UNITYSDK_OFFSET(0x889AD00)
#define HORIZONTALFLOWLAYOUTGROUP_GET_CONSTRAINTCOUNT_OFFSET UNITYSDK_OFFSET(0x889AB90)
#define HORIZONTALFLOWLAYOUTGROUP_GET_CONSTRAINT_OFFSET UNITYSDK_OFFSET(0x889AAE0)
#define HORIZONTALFLOWLAYOUTGROUP_GET_ISCENTERALIGN_OFFSET UNITYSDK_OFFSET(0x889ADB0)
#define HORIZONTALFLOWLAYOUTGROUP_GET_ISLOWERALIGN_OFFSET UNITYSDK_OFFSET(0x889AF20)
#define HORIZONTALFLOWLAYOUTGROUP_GET_ISMIDDLEALIGN_OFFSET UNITYSDK_OFFSET(0x889AEB0)
#define HORIZONTALFLOWLAYOUTGROUP_GET_ISRIGHTALIGN_OFFSET UNITYSDK_OFFSET(0x889AE30)
#define HORIZONTALFLOWLAYOUTGROUP_GET_SPACING_OFFSET UNITYSDK_OFFSET(0x889AA00)
#define HORIZONTALFLOWLAYOUTGROUP_LAYOUTROW_OFFSET UNITYSDK_OFFSET(0x889C050)
#define HORIZONTALFLOWLAYOUTGROUP_SETLAYOUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x889B240)
#define HORIZONTALFLOWLAYOUTGROUP_SETLAYOUTVERTICAL_OFFSET UNITYSDK_OFFSET(0x889BD80)
#define HORIZONTALFLOWLAYOUTGROUP_SETLAYOUT_OFFSET UNITYSDK_OFFSET(0x889B2E0)
#define HORIZONTALFLOWLAYOUTGROUP_SET_CHILDFORCEEXPANDHEIGHT_OFFSET UNITYSDK_OFFSET(0x889AC60)
#define HORIZONTALFLOWLAYOUTGROUP_SET_CHILDFORCEEXPANDWIDTH_OFFSET UNITYSDK_OFFSET(0x889AD10)
#define HORIZONTALFLOWLAYOUTGROUP_SET_CONSTRAINTCOUNT_OFFSET UNITYSDK_OFFSET(0x889ABA0)
#define HORIZONTALFLOWLAYOUTGROUP_SET_CONSTRAINT_OFFSET UNITYSDK_OFFSET(0x889AAF0)
#define HORIZONTALFLOWLAYOUTGROUP_SET_SPACING_OFFSET UNITYSDK_OFFSET(0x889AA10)
#define HORIZONTALFLOWLAYOUTGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x889C9F0)
#define HORIZONTALFLOWLAYOUTGROUP___BASE_CALCULATELAYOUTINPUTHORIZONTAL_OFFSET UNITYSDK_OFFSET(0x889CA60)
#define HORIZONTALFLOWLAYOUTGROUP___BASE_GETCOLROW_OFFSET UNITYSDK_OFFSET(0x889CA70)

inline static constexpr unsigned int HorizontalFlowLayoutGroup_TypeDefinitionIndex = 48557;
