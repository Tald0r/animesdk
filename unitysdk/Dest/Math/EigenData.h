...
#define DEST_MATH_EIGENDATA_GETEIGENVALUE_OFFSET UNITYSDK_OFFSET(0x1A9D41F0)
#define DEST_MATH_EIGENDATA_GETEIGENVECTOR2_OFFSET UNITYSDK_OFFSET(0x1A9D4230)
#define DEST_MATH_EIGENDATA_GETEIGENVECTOR3_OFFSET UNITYSDK_OFFSET(0x1A9D55C0)
#define DEST_MATH_EIGENDATA_GETEIGENVECTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9D7A20)
#define DEST_MATH_EIGENDATA_GETEIGENVECTOR_OFFSET UNITYSDK_OFFSET(0x1A9D7950)
#define DEST_MATH_EIGENDATA_GET_SIZE_OFFSET UNITYSDK_OFFSET(0x1A9D7910)
#define DEST_MATH_EIGENDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9D7920)

namespace Dest::Math
{
	inline static constexpr unsigned int EigenData_TypeDefinitionIndex = 31699;
