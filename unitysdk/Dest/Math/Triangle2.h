...
#define DEST_MATH_TRIANGLE2_CALCANGLESDEG_1_OFFSET UNITYSDK_OFFSET(0x1B516480)
#define DEST_MATH_TRIANGLE2_CALCANGLESDEG_2_OFFSET UNITYSDK_OFFSET(0x1B5165F0)
#define DEST_MATH_TRIANGLE2_CALCANGLESDEG_OFFSET UNITYSDK_OFFSET(0x99DF00)
#define DEST_MATH_TRIANGLE2_CALCANGLESRAD_1_OFFSET UNITYSDK_OFFSET(0x1B516900)
#define DEST_MATH_TRIANGLE2_CALCANGLESRAD_2_OFFSET UNITYSDK_OFFSET(0x1B516A90)
#define DEST_MATH_TRIANGLE2_CALCANGLESRAD_OFFSET UNITYSDK_OFFSET(0x99E070)
#define DEST_MATH_TRIANGLE2_CALCAREA_1_OFFSET UNITYSDK_OFFSET(0x1B516210)
#define DEST_MATH_TRIANGLE2_CALCAREA_2_OFFSET UNITYSDK_OFFSET(0x1B516280)
#define DEST_MATH_TRIANGLE2_CALCAREA_OFFSET UNITYSDK_OFFSET(0x99DE90)
#define DEST_MATH_TRIANGLE2_CALCBARYCENTRICCOORDS_1_OFFSET UNITYSDK_OFFSET(0x99E320)
#define DEST_MATH_TRIANGLE2_CALCBARYCENTRICCOORDS_2_OFFSET UNITYSDK_OFFSET(0x99E380)
#define DEST_MATH_TRIANGLE2_CALCBARYCENTRICCOORDS_OFFSET UNITYSDK_OFFSET(0x1B516D50)
#define DEST_MATH_TRIANGLE2_CALCDETERMINANT_OFFSET UNITYSDK_OFFSET(0x99DDB0)
#define DEST_MATH_TRIANGLE2_CALCEDGE_OFFSET UNITYSDK_OFFSET(0x99DD40)
#define DEST_MATH_TRIANGLE2_CALCORIENTATION_OFFSET UNITYSDK_OFFSET(0x99DE10)
#define DEST_MATH_TRIANGLE2_CONTAINSCCW_1_OFFSET UNITYSDK_OFFSET(0x99E950)
#define DEST_MATH_TRIANGLE2_CONTAINSCCW_OFFSET UNITYSDK_OFFSET(0x99E8C0)
#define DEST_MATH_TRIANGLE2_CONTAINSCW_1_OFFSET UNITYSDK_OFFSET(0x99EAE0)
#define DEST_MATH_TRIANGLE2_CONTAINSCW_OFFSET UNITYSDK_OFFSET(0x99EA50)
#define DEST_MATH_TRIANGLE2_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x99E7C0)
#define DEST_MATH_TRIANGLE2_CONTAINS_OFFSET UNITYSDK_OFFSET(0x99E6F0)
#define DEST_MATH_TRIANGLE2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x99E3E0)
#define DEST_MATH_TRIANGLE2_EVALBARYCENTRIC_1_OFFSET UNITYSDK_OFFSET(0x99E260)
#define DEST_MATH_TRIANGLE2_EVALBARYCENTRIC_2_OFFSET UNITYSDK_OFFSET(0x99E2C0)
#define DEST_MATH_TRIANGLE2_EVALBARYCENTRIC_OFFSET UNITYSDK_OFFSET(0x99E200)
#define DEST_MATH_TRIANGLE2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x99DCB0)
#define DEST_MATH_TRIANGLE2_PROJECT_OFFSET UNITYSDK_OFFSET(0x99E6B0)
#define DEST_MATH_TRIANGLE2_QUERYSIDECCW_OFFSET UNITYSDK_OFFSET(0x99E400)
#define DEST_MATH_TRIANGLE2_QUERYSIDECW_OFFSET UNITYSDK_OFFSET(0x99E550)
#define DEST_MATH_TRIANGLE2_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x99DCF0)
#define DEST_MATH_TRIANGLE2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x99EBE0)
#define DEST_MATH_TRIANGLE2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x30B240)
#define DEST_MATH_TRIANGLE2__CTOR_OFFSET UNITYSDK_OFFSET(0x99DD20)

namespace Dest::Math
{
	inline static constexpr unsigned int Triangle2_TypeDefinitionIndex = 32673;
