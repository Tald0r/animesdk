...
#define DEST_MATH_TRIANGLE2_CALCANGLESDEG_1_OFFSET UNITYSDK_OFFSET(0x1AEF8E00)
#define DEST_MATH_TRIANGLE2_CALCANGLESDEG_2_OFFSET UNITYSDK_OFFSET(0x1AEF8F70)
#define DEST_MATH_TRIANGLE2_CALCANGLESDEG_OFFSET UNITYSDK_OFFSET(0x96B140)
#define DEST_MATH_TRIANGLE2_CALCANGLESRAD_1_OFFSET UNITYSDK_OFFSET(0x1AEF9280)
#define DEST_MATH_TRIANGLE2_CALCANGLESRAD_2_OFFSET UNITYSDK_OFFSET(0x1AEF9410)
#define DEST_MATH_TRIANGLE2_CALCANGLESRAD_OFFSET UNITYSDK_OFFSET(0x96B2B0)
#define DEST_MATH_TRIANGLE2_CALCAREA_1_OFFSET UNITYSDK_OFFSET(0x1AEF8B90)
#define DEST_MATH_TRIANGLE2_CALCAREA_2_OFFSET UNITYSDK_OFFSET(0x1AEF8C00)
#define DEST_MATH_TRIANGLE2_CALCAREA_OFFSET UNITYSDK_OFFSET(0x96B0D0)
#define DEST_MATH_TRIANGLE2_CALCBARYCENTRICCOORDS_1_OFFSET UNITYSDK_OFFSET(0x96B560)
#define DEST_MATH_TRIANGLE2_CALCBARYCENTRICCOORDS_2_OFFSET UNITYSDK_OFFSET(0x96B5C0)
#define DEST_MATH_TRIANGLE2_CALCBARYCENTRICCOORDS_OFFSET UNITYSDK_OFFSET(0x1AEF96D0)
#define DEST_MATH_TRIANGLE2_CALCDETERMINANT_OFFSET UNITYSDK_OFFSET(0x96AFF0)
#define DEST_MATH_TRIANGLE2_CALCEDGE_OFFSET UNITYSDK_OFFSET(0x96AF80)
#define DEST_MATH_TRIANGLE2_CALCORIENTATION_OFFSET UNITYSDK_OFFSET(0x96B050)
#define DEST_MATH_TRIANGLE2_CONTAINSCCW_1_OFFSET UNITYSDK_OFFSET(0x96BB90)
#define DEST_MATH_TRIANGLE2_CONTAINSCCW_OFFSET UNITYSDK_OFFSET(0x96BB00)
#define DEST_MATH_TRIANGLE2_CONTAINSCW_1_OFFSET UNITYSDK_OFFSET(0x96BD20)
#define DEST_MATH_TRIANGLE2_CONTAINSCW_OFFSET UNITYSDK_OFFSET(0x96BC90)
#define DEST_MATH_TRIANGLE2_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x96BA00)
#define DEST_MATH_TRIANGLE2_CONTAINS_OFFSET UNITYSDK_OFFSET(0x96B930)
#define DEST_MATH_TRIANGLE2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x96B620)
#define DEST_MATH_TRIANGLE2_EVALBARYCENTRIC_1_OFFSET UNITYSDK_OFFSET(0x96B4A0)
#define DEST_MATH_TRIANGLE2_EVALBARYCENTRIC_2_OFFSET UNITYSDK_OFFSET(0x96B500)
#define DEST_MATH_TRIANGLE2_EVALBARYCENTRIC_OFFSET UNITYSDK_OFFSET(0x96B440)
#define DEST_MATH_TRIANGLE2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x96AEF0)
#define DEST_MATH_TRIANGLE2_PROJECT_OFFSET UNITYSDK_OFFSET(0x96B8F0)
#define DEST_MATH_TRIANGLE2_QUERYSIDECCW_OFFSET UNITYSDK_OFFSET(0x96B640)
#define DEST_MATH_TRIANGLE2_QUERYSIDECW_OFFSET UNITYSDK_OFFSET(0x96B790)
#define DEST_MATH_TRIANGLE2_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x96AF30)
#define DEST_MATH_TRIANGLE2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x96BE20)
#define DEST_MATH_TRIANGLE2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3481C0)
#define DEST_MATH_TRIANGLE2__CTOR_OFFSET UNITYSDK_OFFSET(0x96AF60)

namespace Dest::Math
{
	inline static constexpr unsigned int Triangle2_TypeDefinitionIndex = 31719;
