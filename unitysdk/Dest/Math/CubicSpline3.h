...
#define DEST_MATH_CUBICSPLINE3_ADDVERTEXFIRST_OFFSET UNITYSDK_OFFSET(0x1B65E3F0)
#define DEST_MATH_CUBICSPLINE3_ADDVERTEXLAST_OFFSET UNITYSDK_OFFSET(0x1B65E4B0)
#define DEST_MATH_CUBICSPLINE3_BUILDSPLINE_OFFSET UNITYSDK_OFFSET(0x1B65CDC0)
#define DEST_MATH_CUBICSPLINE3_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B65E630)
#define DEST_MATH_CUBICSPLINE3_CREATECLOSEDSPLINE_OFFSET UNITYSDK_OFFSET(0x1B65D870)
#define DEST_MATH_CUBICSPLINE3_CREATEOPENEDSPLINE_OFFSET UNITYSDK_OFFSET(0x1B65D240)
#define DEST_MATH_CUBICSPLINE3_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1B65CE80)
#define DEST_MATH_CUBICSPLINE3_CREATE_OFFSET UNITYSDK_OFFSET(0x1B65CE00)
#define DEST_MATH_CUBICSPLINE3_GETVERTEX_OFFSET UNITYSDK_OFFSET(0x1B65E820)
#define DEST_MATH_CUBICSPLINE3_GET_SPLINETYPE_OFFSET UNITYSDK_OFFSET(0x1B65CD60)
#define DEST_MATH_CUBICSPLINE3_INSERTAFTER_OFFSET UNITYSDK_OFFSET(0x1B65E750)
#define DEST_MATH_CUBICSPLINE3_INSERTBEFORE_OFFSET UNITYSDK_OFFSET(0x1B65E680)
#define DEST_MATH_CUBICSPLINE3_REMOVEVERTEX_OFFSET UNITYSDK_OFFSET(0x1B65E570)
#define DEST_MATH_CUBICSPLINE3_SETVERTEX_OFFSET UNITYSDK_OFFSET(0x1B65E8A0)
#define DEST_MATH_CUBICSPLINE3_SET_SPLINETYPE_OFFSET UNITYSDK_OFFSET(0x1B65CD70)
#define DEST_MATH_CUBICSPLINE3__CTOR_OFFSET UNITYSDK_OFFSET(0x1B65E950)

namespace Dest::Math
{
	inline static constexpr unsigned int CubicSpline3_TypeDefinitionIndex = 32693;
