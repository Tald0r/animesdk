...
#define DEST_MATH_CUBICSPLINE3_ADDVERTEXFIRST_OFFSET UNITYSDK_OFFSET(0x1B04F160)
#define DEST_MATH_CUBICSPLINE3_ADDVERTEXLAST_OFFSET UNITYSDK_OFFSET(0x1B04F220)
#define DEST_MATH_CUBICSPLINE3_BUILDSPLINE_OFFSET UNITYSDK_OFFSET(0x1B04DB30)
#define DEST_MATH_CUBICSPLINE3_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B04F3A0)
#define DEST_MATH_CUBICSPLINE3_CREATECLOSEDSPLINE_OFFSET UNITYSDK_OFFSET(0x1B04E5E0)
#define DEST_MATH_CUBICSPLINE3_CREATEOPENEDSPLINE_OFFSET UNITYSDK_OFFSET(0x1B04DFB0)
#define DEST_MATH_CUBICSPLINE3_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1B04DBF0)
#define DEST_MATH_CUBICSPLINE3_CREATE_OFFSET UNITYSDK_OFFSET(0x1B04DB70)
#define DEST_MATH_CUBICSPLINE3_GETVERTEX_OFFSET UNITYSDK_OFFSET(0x1B04F590)
#define DEST_MATH_CUBICSPLINE3_GET_SPLINETYPE_OFFSET UNITYSDK_OFFSET(0x1B04DAD0)
#define DEST_MATH_CUBICSPLINE3_INSERTAFTER_OFFSET UNITYSDK_OFFSET(0x1B04F4C0)
#define DEST_MATH_CUBICSPLINE3_INSERTBEFORE_OFFSET UNITYSDK_OFFSET(0x1B04F3F0)
#define DEST_MATH_CUBICSPLINE3_REMOVEVERTEX_OFFSET UNITYSDK_OFFSET(0x1B04F2E0)
#define DEST_MATH_CUBICSPLINE3_SETVERTEX_OFFSET UNITYSDK_OFFSET(0x1B04F610)
#define DEST_MATH_CUBICSPLINE3_SET_SPLINETYPE_OFFSET UNITYSDK_OFFSET(0x1B04DAE0)
#define DEST_MATH_CUBICSPLINE3__CTOR_OFFSET UNITYSDK_OFFSET(0x1B04F6C0)

namespace Dest::Math
{
	inline static constexpr unsigned int CubicSpline3_TypeDefinitionIndex = 31739;
