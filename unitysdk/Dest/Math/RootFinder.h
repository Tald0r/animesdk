...
#define DEST_MATH_ROOTFINDER_BRENTSMETHOD_OFFSET UNITYSDK_OFFSET(0x1AE87F00)
#define DEST_MATH_ROOTFINDER_CUBIC_OFFSET UNITYSDK_OFFSET(0x1AE88530)
#define DEST_MATH_ROOTFINDER_LINEAR_OFFSET UNITYSDK_OFFSET(0x1AE88350)
#define DEST_MATH_ROOTFINDER_POLYNOMIALBOUND_OFFSET UNITYSDK_OFFSET(0x1AE88F70)
#define DEST_MATH_ROOTFINDER_POLYNOMIAL_1_OFFSET UNITYSDK_OFFSET(0x1AE89140)
#define DEST_MATH_ROOTFINDER_POLYNOMIAL_OFFSET UNITYSDK_OFFSET(0x1AE89060)
#define DEST_MATH_ROOTFINDER_QUADRATIC_OFFSET UNITYSDK_OFFSET(0x1AE88390)
#define DEST_MATH_ROOTFINDER_QUARTIC_OFFSET UNITYSDK_OFFSET(0x1AE88A60)
#define DEST_MATH_ROOTFINDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE892C0)

namespace Dest::Math
{
	inline static constexpr unsigned int RootFinder_TypeDefinitionIndex = 32651;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(RootFinder_TypeDefinitionIndex)->GetStaticField(0x8050);
		}
