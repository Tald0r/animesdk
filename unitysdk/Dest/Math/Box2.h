...
#define DEST_MATH_BOX2_CALCAREA_OFFSET UNITYSDK_OFFSET(0x94D9B0)
#define DEST_MATH_BOX2_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x94D990)
#define DEST_MATH_BOX2_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x94D9A0)
#define DEST_MATH_BOX2_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x94D8B0)
#define DEST_MATH_BOX2_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x94DA60)
#define DEST_MATH_BOX2_CONTAINS_OFFSET UNITYSDK_OFFSET(0x94DA50)
#define DEST_MATH_BOX2_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1AAFBDA0)
#define DEST_MATH_BOX2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x94D9D0)
#define DEST_MATH_BOX2_GETAXIS_OFFSET UNITYSDK_OFFSET(0x94D840)
#define DEST_MATH_BOX2_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x94DA80)
#define DEST_MATH_BOX2_INCLUDE_OFFSET UNITYSDK_OFFSET(0x94DA70)
#define DEST_MATH_BOX2_PROJECT_OFFSET UNITYSDK_OFFSET(0x94DA10)
#define DEST_MATH_BOX2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x94DAB0)
#define DEST_MATH_BOX2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3B6380)
#define DEST_MATH_BOX2__CTOR_2_OFFSET UNITYSDK_OFFSET(0x94D710)
#define DEST_MATH_BOX2__CTOR_3_OFFSET UNITYSDK_OFFSET(0x94D7A0)
#define DEST_MATH_BOX2__CTOR_OFFSET UNITYSDK_OFFSET(0x94D6E0)

namespace Dest::Math
{
	inline static constexpr unsigned int Box2_TypeDefinitionIndex = 32666;
