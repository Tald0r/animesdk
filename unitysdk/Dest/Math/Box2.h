...
#define DEST_MATH_BOX2_CALCAREA_OFFSET UNITYSDK_OFFSET(0x920500)
#define DEST_MATH_BOX2_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x9204E0)
#define DEST_MATH_BOX2_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x9204F0)
#define DEST_MATH_BOX2_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x920400)
#define DEST_MATH_BOX2_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x9205B0)
#define DEST_MATH_BOX2_CONTAINS_OFFSET UNITYSDK_OFFSET(0x9205A0)
#define DEST_MATH_BOX2_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1A5222A0)
#define DEST_MATH_BOX2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x920520)
#define DEST_MATH_BOX2_GETAXIS_OFFSET UNITYSDK_OFFSET(0x920390)
#define DEST_MATH_BOX2_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x9205D0)
#define DEST_MATH_BOX2_INCLUDE_OFFSET UNITYSDK_OFFSET(0x9205C0)
#define DEST_MATH_BOX2_PROJECT_OFFSET UNITYSDK_OFFSET(0x920560)
#define DEST_MATH_BOX2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x920600)
#define DEST_MATH_BOX2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x38AAB0)
#define DEST_MATH_BOX2__CTOR_2_OFFSET UNITYSDK_OFFSET(0x920260)
#define DEST_MATH_BOX2__CTOR_3_OFFSET UNITYSDK_OFFSET(0x9202F0)
#define DEST_MATH_BOX2__CTOR_OFFSET UNITYSDK_OFFSET(0x920230)

namespace Dest::Math
{
	inline static constexpr unsigned int Box2_TypeDefinitionIndex = 31712;
