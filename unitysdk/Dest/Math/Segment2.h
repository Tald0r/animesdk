...
#define DEST_MATH_SEGMENT2_CALCCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0x8C1F30)
#define DEST_MATH_SEGMENT2_CALCENDPOINTS_OFFSET UNITYSDK_OFFSET(0x8C2010)
#define DEST_MATH_SEGMENT2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x8C20A0)
#define DEST_MATH_SEGMENT2_EVAL_OFFSET UNITYSDK_OFFSET(0x8C2060)
#define DEST_MATH_SEGMENT2_PROJECT_OFFSET UNITYSDK_OFFSET(0x8C2200)
#define DEST_MATH_SEGMENT2_SETCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0x8C1ED0)
#define DEST_MATH_SEGMENT2_SETENDPOINTS_OFFSET UNITYSDK_OFFSET(0x8C1D80)
#define DEST_MATH_SEGMENT2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8C22F0)
#define DEST_MATH_SEGMENT2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8C1D80)
#define DEST_MATH_SEGMENT2__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8C1E70)
#define DEST_MATH_SEGMENT2__CTOR_3_OFFSET UNITYSDK_OFFSET(0x8C1ED0)
#define DEST_MATH_SEGMENT2__CTOR_OFFSET UNITYSDK_OFFSET(0x8C1C90)

namespace Dest::Math
{
	inline static constexpr unsigned int Segment2_TypeDefinitionIndex = 31718;
