...
#define DEST_MATH_SEGMENT2_CALCCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0x8EF7D0)
#define DEST_MATH_SEGMENT2_CALCENDPOINTS_OFFSET UNITYSDK_OFFSET(0x8EF8B0)
#define DEST_MATH_SEGMENT2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x8EF940)
#define DEST_MATH_SEGMENT2_EVAL_OFFSET UNITYSDK_OFFSET(0x8EF900)
#define DEST_MATH_SEGMENT2_PROJECT_OFFSET UNITYSDK_OFFSET(0x8EFAA0)
#define DEST_MATH_SEGMENT2_SETCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0x8EF770)
#define DEST_MATH_SEGMENT2_SETENDPOINTS_OFFSET UNITYSDK_OFFSET(0x8EF620)
#define DEST_MATH_SEGMENT2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8EFB90)
#define DEST_MATH_SEGMENT2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8EF620)
#define DEST_MATH_SEGMENT2__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8EF710)
#define DEST_MATH_SEGMENT2__CTOR_3_OFFSET UNITYSDK_OFFSET(0x8EF770)
#define DEST_MATH_SEGMENT2__CTOR_OFFSET UNITYSDK_OFFSET(0x8EF530)

namespace Dest::Math
{
	inline static constexpr unsigned int Segment2_TypeDefinitionIndex = 32672;
