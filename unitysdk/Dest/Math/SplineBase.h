...
#define DEST_MATH_SPLINEBASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AB080B0)
#define DEST_MATH_SPLINEBASE_CALCTOTALLENGTH_OFFSET UNITYSDK_OFFSET(0x1AB0B300)
#define DEST_MATH_SPLINEBASE_EVALCURVATUREPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1AB0ACE0)
#define DEST_MATH_SPLINEBASE_EVALCURVATURE_OFFSET UNITYSDK_OFFSET(0x1AB095C0)
#define DEST_MATH_SPLINEBASE_EVALFRAMEPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1AB0A8F0)
#define DEST_MATH_SPLINEBASE_EVALFRAME_OFFSET UNITYSDK_OFFSET(0x1AB091F0)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONPARAMETRIZED_1_OFFSET UNITYSDK_OFFSET(0x1AB0A2D0)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1AB09BD0)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONTANGENTPARAMETRIZED_1_OFFSET UNITYSDK_OFFSET(0x1AB0A690)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONTANGENTPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1AB09FA0)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONTANGENT_1_OFFSET UNITYSDK_OFFSET(0x1AB08FA0)
#define DEST_MATH_SPLINEBASE_EVALPOSITIONTANGENT_OFFSET UNITYSDK_OFFSET(0x1AB08900)
#define DEST_MATH_SPLINEBASE_EVALPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1AB08C10)
#define DEST_MATH_SPLINEBASE_EVALPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB08570)
#define DEST_MATH_SPLINEBASE_EVALTANGENTPARAMETRIZED_1_OFFSET UNITYSDK_OFFSET(0x1AB0A480)
#define DEST_MATH_SPLINEBASE_EVALTANGENTPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1AB09D80)
#define DEST_MATH_SPLINEBASE_EVALTANGENT_1_OFFSET UNITYSDK_OFFSET(0x1AB08DA0)
#define DEST_MATH_SPLINEBASE_EVALTANGENT_OFFSET UNITYSDK_OFFSET(0x1AB08700)
#define DEST_MATH_SPLINEBASE_EVALTORSIONPARAMETRIZED_OFFSET UNITYSDK_OFFSET(0x1AB0B000)
#define DEST_MATH_SPLINEBASE_EVALTORSION_OFFSET UNITYSDK_OFFSET(0x1AB098E0)
#define DEST_MATH_SPLINEBASE_GETSEGMENTINDEXANDTIME_OFFSET UNITYSDK_OFFSET(0x1AB08260)
#define DEST_MATH_SPLINEBASE_GET_SEGMENTCOUNT_OFFSET UNITYSDK_OFFSET(0x1AB08030)
#define DEST_MATH_SPLINEBASE_GET_VALID_OFFSET UNITYSDK_OFFSET(0x1AB08090)
#define DEST_MATH_SPLINEBASE_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1AB08070)
#define DEST_MATH_SPLINEBASE_LENGTHTOTIME_1_OFFSET UNITYSDK_OFFSET(0x1AB0B7D0)
#define DEST_MATH_SPLINEBASE_LENGTHTOTIME_OFFSET UNITYSDK_OFFSET(0x1AB0B3B0)
#define DEST_MATH_SPLINEBASE_PARAMETRIZEBYARCLENGTH_OFFSET UNITYSDK_OFFSET(0x1AB0B7F0)
#define DEST_MATH_SPLINEBASE_PREPAREFORRUNTIME_OFFSET UNITYSDK_OFFSET(0x1AB08130)
#define DEST_MATH_SPLINEBASE_RECALCSEGMENTSLENGTH_OFFSET UNITYSDK_OFFSET(0x1AB08330)
#define DEST_MATH_SPLINEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB081B0)

namespace Dest::Math
{
	inline static constexpr unsigned int SplineBase_TypeDefinitionIndex = 32698;
