...
#define DEST_MATH_MATHFEX_CARTESIANTOCYLINDRICAL_OFFSET UNITYSDK_OFFSET(0x1AB03FF0)
#define DEST_MATH_MATHFEX_CARTESIANTOPOLAR_OFFSET UNITYSDK_OFFSET(0x1AB03CB0)
#define DEST_MATH_MATHFEX_CARTESIANTOSPHERICAL_OFFSET UNITYSDK_OFFSET(0x1AB03E10)
#define DEST_MATH_MATHFEX_COSINTERP_OFFSET UNITYSDK_OFFSET(0x1AB03A00)
#define DEST_MATH_MATHFEX_CURVEINTERP_OFFSET UNITYSDK_OFFSET(0x1AB03B70)
#define DEST_MATH_MATHFEX_CYLINDRICALTOCARTESIAN_OFFSET UNITYSDK_OFFSET(0x1AB040F0)
#define DEST_MATH_MATHFEX_EVALCUBIC_OFFSET UNITYSDK_OFFSET(0x1AB03750)
#define DEST_MATH_MATHFEX_EVALGAUSSIAN2D_OFFSET UNITYSDK_OFFSET(0x1AB038B0)
#define DEST_MATH_MATHFEX_EVALGAUSSIAN_OFFSET UNITYSDK_OFFSET(0x1AB03870)
#define DEST_MATH_MATHFEX_EVALINVCUBIC_OFFSET UNITYSDK_OFFSET(0x1AB03760)
#define DEST_MATH_MATHFEX_EVALINVSQUARED_OFFSET UNITYSDK_OFFSET(0x1AB03730)
#define DEST_MATH_MATHFEX_EVALOVERLAPPEDSTEP_OFFSET UNITYSDK_OFFSET(0x1AB037B0)
#define DEST_MATH_MATHFEX_EVALQUADRATIC_OFFSET UNITYSDK_OFFSET(0x1AB03770)
#define DEST_MATH_MATHFEX_EVALSIGMOID_OFFSET UNITYSDK_OFFSET(0x1AB03790)
#define DEST_MATH_MATHFEX_EVALSMOOTHOVERLAPPEDSTEP_OFFSET UNITYSDK_OFFSET(0x1AB03800)
#define DEST_MATH_MATHFEX_EVALSQUARED_OFFSET UNITYSDK_OFFSET(0x1AB03720)
#define DEST_MATH_MATHFEX_FUNCINTERP_OFFSET UNITYSDK_OFFSET(0x1AB03BD0)
#define DEST_MATH_MATHFEX_INVSQRT_OFFSET UNITYSDK_OFFSET(0x1AAFFD70)
#define DEST_MATH_MATHFEX_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1AB03940)
#define DEST_MATH_MATHFEX_LERP_OFFSET UNITYSDK_OFFSET(0x1AB03910)
#define DEST_MATH_MATHFEX_NEARZERO_OFFSET UNITYSDK_OFFSET(0x1AB03CA0)
#define DEST_MATH_MATHFEX_NEAR_OFFSET UNITYSDK_OFFSET(0x1AB03C80)
#define DEST_MATH_MATHFEX_POLARTOCARTESIAN_OFFSET UNITYSDK_OFFSET(0x1AB03DA0)
#define DEST_MATH_MATHFEX_SIGMOIDINTERP_OFFSET UNITYSDK_OFFSET(0x1AB03950)
#define DEST_MATH_MATHFEX_SININTERP_OFFSET UNITYSDK_OFFSET(0x1AB039A0)
#define DEST_MATH_MATHFEX_SPHERICALTOCARTESIAN_OFFSET UNITYSDK_OFFSET(0x1AB03F40)
#define DEST_MATH_MATHFEX_WOBBLEINTERP_OFFSET UNITYSDK_OFFSET(0x1AB03A70)

namespace Dest::Math
{
	inline static constexpr unsigned int Mathfex_TypeDefinitionIndex = 32641;
