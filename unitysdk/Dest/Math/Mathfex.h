...
#define DEST_MATH_MATHFEX_CARTESIANTOCYLINDRICAL_OFFSET UNITYSDK_OFFSET(0x1A52A520)
#define DEST_MATH_MATHFEX_CARTESIANTOPOLAR_OFFSET UNITYSDK_OFFSET(0x1A52A1E0)
#define DEST_MATH_MATHFEX_CARTESIANTOSPHERICAL_OFFSET UNITYSDK_OFFSET(0x1A52A340)
#define DEST_MATH_MATHFEX_COSINTERP_OFFSET UNITYSDK_OFFSET(0x1A529F30)
#define DEST_MATH_MATHFEX_CURVEINTERP_OFFSET UNITYSDK_OFFSET(0x1A52A0A0)
#define DEST_MATH_MATHFEX_CYLINDRICALTOCARTESIAN_OFFSET UNITYSDK_OFFSET(0x1A52A620)
#define DEST_MATH_MATHFEX_EVALCUBIC_OFFSET UNITYSDK_OFFSET(0x1A529C80)
#define DEST_MATH_MATHFEX_EVALGAUSSIAN2D_OFFSET UNITYSDK_OFFSET(0x1A529DE0)
#define DEST_MATH_MATHFEX_EVALGAUSSIAN_OFFSET UNITYSDK_OFFSET(0x1A529DA0)
#define DEST_MATH_MATHFEX_EVALINVCUBIC_OFFSET UNITYSDK_OFFSET(0x1A529C90)
#define DEST_MATH_MATHFEX_EVALINVSQUARED_OFFSET UNITYSDK_OFFSET(0x1A529C60)
#define DEST_MATH_MATHFEX_EVALOVERLAPPEDSTEP_OFFSET UNITYSDK_OFFSET(0x1A529CE0)
#define DEST_MATH_MATHFEX_EVALQUADRATIC_OFFSET UNITYSDK_OFFSET(0x1A529CA0)
#define DEST_MATH_MATHFEX_EVALSIGMOID_OFFSET UNITYSDK_OFFSET(0x1A529CC0)
#define DEST_MATH_MATHFEX_EVALSMOOTHOVERLAPPEDSTEP_OFFSET UNITYSDK_OFFSET(0x1A529D30)
#define DEST_MATH_MATHFEX_EVALSQUARED_OFFSET UNITYSDK_OFFSET(0x1A529C50)
#define DEST_MATH_MATHFEX_FUNCINTERP_OFFSET UNITYSDK_OFFSET(0x1A52A100)
#define DEST_MATH_MATHFEX_INVSQRT_OFFSET UNITYSDK_OFFSET(0x1A526270)
#define DEST_MATH_MATHFEX_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1A529E70)
#define DEST_MATH_MATHFEX_LERP_OFFSET UNITYSDK_OFFSET(0x1A529E40)
#define DEST_MATH_MATHFEX_NEARZERO_OFFSET UNITYSDK_OFFSET(0x1A52A1D0)
#define DEST_MATH_MATHFEX_NEAR_OFFSET UNITYSDK_OFFSET(0x1A52A1B0)
#define DEST_MATH_MATHFEX_POLARTOCARTESIAN_OFFSET UNITYSDK_OFFSET(0x1A52A2D0)
#define DEST_MATH_MATHFEX_SIGMOIDINTERP_OFFSET UNITYSDK_OFFSET(0x1A529E80)
#define DEST_MATH_MATHFEX_SININTERP_OFFSET UNITYSDK_OFFSET(0x1A529ED0)
#define DEST_MATH_MATHFEX_SPHERICALTOCARTESIAN_OFFSET UNITYSDK_OFFSET(0x1A52A470)
#define DEST_MATH_MATHFEX_WOBBLEINTERP_OFFSET UNITYSDK_OFFSET(0x1A529FA0)

namespace Dest::Math
{
	inline static constexpr unsigned int Mathfex_TypeDefinitionIndex = 31687;
