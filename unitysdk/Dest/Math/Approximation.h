...
#define DEST_MATH_APPROXIMATION_GAUSSPOINTSFIT2_OFFSET UNITYSDK_OFFSET(0x1A9D3A40)
#define DEST_MATH_APPROXIMATION_GAUSSPOINTSFIT3_OFFSET UNITYSDK_OFFSET(0x1A9D4F20)
#define DEST_MATH_APPROXIMATION_HEIGHTLINEFIT2_OFFSET UNITYSDK_OFFSET(0x1A9D43A0)
#define DEST_MATH_APPROXIMATION_HEIGHTPLANEFIT3_OFFSET UNITYSDK_OFFSET(0x1A9D5D30)
#define DEST_MATH_APPROXIMATION_LEASTSQUARESLINEFIT2_OFFSET UNITYSDK_OFFSET(0x1A9D4A80)
#define DEST_MATH_APPROXIMATION_LEASTSQUARESPLANEFIT3_OFFSET UNITYSDK_OFFSET(0x1A9D6920)
#define DEST_MATH_APPROXIMATION_LEASTSSQUARESLINEFIT3_OFFSET UNITYSDK_OFFSET(0x1A9D5770)

namespace Dest::Math
{
	inline static constexpr unsigned int Approximation_TypeDefinitionIndex = 31610;
