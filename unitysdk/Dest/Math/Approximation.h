...
#define DEST_MATH_APPROXIMATION_GAUSSPOINTSFIT2_OFFSET UNITYSDK_OFFSET(0x1AFC3720)
#define DEST_MATH_APPROXIMATION_GAUSSPOINTSFIT3_OFFSET UNITYSDK_OFFSET(0x1AFC4C00)
#define DEST_MATH_APPROXIMATION_HEIGHTLINEFIT2_OFFSET UNITYSDK_OFFSET(0x1AFC4080)
#define DEST_MATH_APPROXIMATION_HEIGHTPLANEFIT3_OFFSET UNITYSDK_OFFSET(0x1AFC5A10)
#define DEST_MATH_APPROXIMATION_LEASTSQUARESLINEFIT2_OFFSET UNITYSDK_OFFSET(0x1AFC4760)
#define DEST_MATH_APPROXIMATION_LEASTSQUARESPLANEFIT3_OFFSET UNITYSDK_OFFSET(0x1AFC6600)
#define DEST_MATH_APPROXIMATION_LEASTSSQUARESLINEFIT3_OFFSET UNITYSDK_OFFSET(0x1AFC5450)

namespace Dest::Math
{
	inline static constexpr unsigned int Approximation_TypeDefinitionIndex = 32564;
