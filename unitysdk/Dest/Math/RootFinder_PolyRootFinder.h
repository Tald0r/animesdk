...
#define DEST_MATH_ROOTFINDER_POLYROOTFINDER_BISECTION_OFFSET UNITYSDK_OFFSET(0x1A52DC70)
#define DEST_MATH_ROOTFINDER_POLYROOTFINDER_FIND_OFFSET UNITYSDK_OFFSET(0x1A52E060)
#define DEST_MATH_ROOTFINDER_POLYROOTFINDER_GET_ROOTS_OFFSET UNITYSDK_OFFSET(0x1A52DC10)
#define DEST_MATH_ROOTFINDER_POLYROOTFINDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A52DC20)

namespace Dest::Math
{
	inline static constexpr unsigned int RootFinder_PolyRootFinder_TypeDefinitionIndex = 31698;

	class RootFinder_PolyRootFinder : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Single>* _roots; // 0x10
		::System::Int32 _maxRoot; // 0x18
