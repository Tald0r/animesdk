...
#define DEST_MATH_AAB2_CALCAREA_OFFSET UNITYSDK_OFFSET(0x996DB0)
#define DEST_MATH_AAB2_CALCCENTEREXTENTS_OFFSET UNITYSDK_OFFSET(0x996D30)
#define DEST_MATH_AAB2_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x996D90)
#define DEST_MATH_AAB2_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x996DA0)
#define DEST_MATH_AAB2_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x996D60)
#define DEST_MATH_AAB2_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x996F10)
#define DEST_MATH_AAB2_CONTAINS_OFFSET UNITYSDK_OFFSET(0x996ED0)
#define DEST_MATH_AAB2_CREATEFROMPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1B40CFE0)
#define DEST_MATH_AAB2_CREATEFROMPOINTS_2_OFFSET UNITYSDK_OFFSET(0x1B40D2D0)
#define DEST_MATH_AAB2_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1B40CAF0)
#define DEST_MATH_AAB2_CREATEFROMPOINT_1_OFFSET UNITYSDK_OFFSET(0x1B40CA70)
#define DEST_MATH_AAB2_CREATEFROMPOINT_OFFSET UNITYSDK_OFFSET(0x1B40CA60)
#define DEST_MATH_AAB2_CREATEFROMTWOPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1B40CAB0)
#define DEST_MATH_AAB2_CREATEFROMTWOPOINTS_OFFSET UNITYSDK_OFFSET(0x1B40CA80)
#define DEST_MATH_AAB2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x996DD0)
#define DEST_MATH_AAB2_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x996FA0)
#define DEST_MATH_AAB2_INCLUDE_2_OFFSET UNITYSDK_OFFSET(0x996FF0)
#define DEST_MATH_AAB2_INCLUDE_3_OFFSET UNITYSDK_OFFSET(0x997080)
#define DEST_MATH_AAB2_INCLUDE_OFFSET UNITYSDK_OFFSET(0x996F50)
#define DEST_MATH_AAB2_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B40CA40)
#define DEST_MATH_AAB2_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B40CA00)
#define DEST_MATH_AAB2_PROJECT_OFFSET UNITYSDK_OFFSET(0x996E60)
#define DEST_MATH_AAB2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x997110)
#define DEST_MATH_AAB2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x301710)
#define DEST_MATH_AAB2__CTOR_2_OFFSET UNITYSDK_OFFSET(0x996D10)
#define DEST_MATH_AAB2__CTOR_OFFSET UNITYSDK_OFFSET(0x586F10)

namespace Dest::Math
{
	inline static constexpr unsigned int AAB2_TypeDefinitionIndex = 32665;
