...
#define DEST_MATH_LINE3_ANGLEBETWEENTWOLINES_OFFSET UNITYSDK_OFFSET(0x984FD0)
#define DEST_MATH_LINE3_CREATEFROMTWOPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1B14F2A0)
#define DEST_MATH_LINE3_CREATEFROMTWOPOINTS_OFFSET UNITYSDK_OFFSET(0x1B14F1E0)
#define DEST_MATH_LINE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x984D80)
#define DEST_MATH_LINE3_EVAL_OFFSET UNITYSDK_OFFSET(0x8E99F0)
#define DEST_MATH_LINE3_PROJECT_OFFSET UNITYSDK_OFFSET(0x984ED0)
#define DEST_MATH_LINE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x985080)
#define DEST_MATH_LINE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x310080)
#define DEST_MATH_LINE3__CTOR_OFFSET UNITYSDK_OFFSET(0x7ECAD0)

namespace Dest::Math
{
	inline static constexpr unsigned int Line3_TypeDefinitionIndex = 31724;
