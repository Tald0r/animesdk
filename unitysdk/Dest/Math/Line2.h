...
#define DEST_MATH_LINE2_ANGLEBETWEENTWOLINES_OFFSET UNITYSDK_OFFSET(0x9B6010)
#define DEST_MATH_LINE2_CREATEBETWEENANDEQUIDISTANTTOPOINTS_OFFSET UNITYSDK_OFFSET(0x1B75D170)
#define DEST_MATH_LINE2_CREATEFROMTWOPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1B75D040)
#define DEST_MATH_LINE2_CREATEFROMTWOPOINTS_OFFSET UNITYSDK_OFFSET(0x1B75CF90)
#define DEST_MATH_LINE2_CREATEPARALLELTOGIVENLINEATGIVENDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B75D1E0)
#define DEST_MATH_LINE2_CREATEPERPTOLINETRHOUGHPOINT_OFFSET UNITYSDK_OFFSET(0x1B75D0F0)
#define DEST_MATH_LINE2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9B5460)
#define DEST_MATH_LINE2_EVAL_OFFSET UNITYSDK_OFFSET(0x9AA320)
#define DEST_MATH_LINE2_PROJECT_OFFSET UNITYSDK_OFFSET(0x9B5F30)
#define DEST_MATH_LINE2_QUERYSIDENEGATIVE_1_OFFSET UNITYSDK_OFFSET(0x9B58B0)
#define DEST_MATH_LINE2_QUERYSIDENEGATIVE_2_OFFSET UNITYSDK_OFFSET(0x9B5B00)
#define DEST_MATH_LINE2_QUERYSIDENEGATIVE_3_OFFSET UNITYSDK_OFFSET(0x9B5DC0)
#define DEST_MATH_LINE2_QUERYSIDENEGATIVE_OFFSET UNITYSDK_OFFSET(0x9B5630)
#define DEST_MATH_LINE2_QUERYSIDEPOSITIVE_1_OFFSET UNITYSDK_OFFSET(0x9B59D0)
#define DEST_MATH_LINE2_QUERYSIDEPOSITIVE_2_OFFSET UNITYSDK_OFFSET(0x9B5BF0)
#define DEST_MATH_LINE2_QUERYSIDEPOSITIVE_3_OFFSET UNITYSDK_OFFSET(0x9B5E70)
#define DEST_MATH_LINE2_QUERYSIDEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x9B56D0)
#define DEST_MATH_LINE2_QUERYSIDE_1_OFFSET UNITYSDK_OFFSET(0x9B5780)
#define DEST_MATH_LINE2_QUERYSIDE_2_OFFSET UNITYSDK_OFFSET(0x9B5AF0)
#define DEST_MATH_LINE2_QUERYSIDE_3_OFFSET UNITYSDK_OFFSET(0x9B5CE0)
#define DEST_MATH_LINE2_QUERYSIDE_OFFSET UNITYSDK_OFFSET(0x9B5570)
#define DEST_MATH_LINE2_SIGNEDDISTANCETO_OFFSET UNITYSDK_OFFSET(0x9B53D0)
#define DEST_MATH_LINE2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9B60D0)
#define DEST_MATH_LINE2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x301710)
#define DEST_MATH_LINE2__CTOR_OFFSET UNITYSDK_OFFSET(0x586F10)

namespace Dest::Math
{
	inline static constexpr unsigned int Line2_TypeDefinitionIndex = 32668;
