...
#define DEST_MATH_LINE2_ANGLEBETWEENTWOLINES_OFFSET UNITYSDK_OFFSET(0x980050)
#define DEST_MATH_LINE2_CREATEBETWEENANDEQUIDISTANTTOPOINTS_OFFSET UNITYSDK_OFFSET(0x1B140390)
#define DEST_MATH_LINE2_CREATEFROMTWOPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1B140260)
#define DEST_MATH_LINE2_CREATEFROMTWOPOINTS_OFFSET UNITYSDK_OFFSET(0x1B1401B0)
#define DEST_MATH_LINE2_CREATEPARALLELTOGIVENLINEATGIVENDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B140400)
#define DEST_MATH_LINE2_CREATEPERPTOLINETRHOUGHPOINT_OFFSET UNITYSDK_OFFSET(0x1B140310)
#define DEST_MATH_LINE2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x97F4A0)
#define DEST_MATH_LINE2_EVAL_OFFSET UNITYSDK_OFFSET(0x9774F0)
#define DEST_MATH_LINE2_PROJECT_OFFSET UNITYSDK_OFFSET(0x97FF70)
#define DEST_MATH_LINE2_QUERYSIDENEGATIVE_1_OFFSET UNITYSDK_OFFSET(0x97F8F0)
#define DEST_MATH_LINE2_QUERYSIDENEGATIVE_2_OFFSET UNITYSDK_OFFSET(0x97FB40)
#define DEST_MATH_LINE2_QUERYSIDENEGATIVE_3_OFFSET UNITYSDK_OFFSET(0x97FE00)
#define DEST_MATH_LINE2_QUERYSIDENEGATIVE_OFFSET UNITYSDK_OFFSET(0x97F670)
#define DEST_MATH_LINE2_QUERYSIDEPOSITIVE_1_OFFSET UNITYSDK_OFFSET(0x97FA10)
#define DEST_MATH_LINE2_QUERYSIDEPOSITIVE_2_OFFSET UNITYSDK_OFFSET(0x97FC30)
#define DEST_MATH_LINE2_QUERYSIDEPOSITIVE_3_OFFSET UNITYSDK_OFFSET(0x97FEB0)
#define DEST_MATH_LINE2_QUERYSIDEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x97F710)
#define DEST_MATH_LINE2_QUERYSIDE_1_OFFSET UNITYSDK_OFFSET(0x97F7C0)
#define DEST_MATH_LINE2_QUERYSIDE_2_OFFSET UNITYSDK_OFFSET(0x97FB30)
#define DEST_MATH_LINE2_QUERYSIDE_3_OFFSET UNITYSDK_OFFSET(0x97FD20)
#define DEST_MATH_LINE2_QUERYSIDE_OFFSET UNITYSDK_OFFSET(0x97F5B0)
#define DEST_MATH_LINE2_SIGNEDDISTANCETO_OFFSET UNITYSDK_OFFSET(0x97F410)
#define DEST_MATH_LINE2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x980110)
#define DEST_MATH_LINE2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2D6E20)
#define DEST_MATH_LINE2__CTOR_OFFSET UNITYSDK_OFFSET(0x5A4C40)

namespace Dest::Math
{
	inline static constexpr unsigned int Line2_TypeDefinitionIndex = 31714;
