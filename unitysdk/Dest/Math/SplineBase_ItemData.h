...
#define DEST_MATH_SPLINEBASE_ITEMDATA_ENSURERENDERPOINTSVALIDITY_OFFSET UNITYSDK_OFFSET(0x1B4116B0)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALFIRSTDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1B411C90)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALLENGTH_1_OFFSET UNITYSDK_OFFSET(0x1B411F90)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALLENGTH_OFFSET UNITYSDK_OFFSET(0x1B411F10)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALPOSITION_OFFSET UNITYSDK_OFFSET(0x1B411C30)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALSECONDDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1B411CF0)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALSPEED_OFFSET UNITYSDK_OFFSET(0x1B411D70)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALTANGENT_OFFSET UNITYSDK_OFFSET(0x1B411E30)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALTHIRDDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1B411D40)
#define DEST_MATH_SPLINEBASE_ITEMDATA_PROCESSLENGTH_OFFSET UNITYSDK_OFFSET(0x1B412020)
#define DEST_MATH_SPLINEBASE_ITEMDATA_UPDATERENDERPOINTS_OFFSET UNITYSDK_OFFSET(0x1B4116F0)
#define DEST_MATH_SPLINEBASE_ITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4120C0)

namespace Dest::Math
{
	inline static constexpr unsigned int SplineBase_ItemData_TypeDefinitionIndex = 32699;
