...
#define DEST_MATH_SPLINEBASE_ITEMDATA_ENSURERENDERPOINTSVALIDITY_OFFSET UNITYSDK_OFFSET(0x1ADF0F10)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALFIRSTDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1ADF14F0)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALLENGTH_1_OFFSET UNITYSDK_OFFSET(0x1ADF17F0)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALLENGTH_OFFSET UNITYSDK_OFFSET(0x1ADF1770)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALPOSITION_OFFSET UNITYSDK_OFFSET(0x1ADF1490)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALSECONDDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1ADF1550)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALSPEED_OFFSET UNITYSDK_OFFSET(0x1ADF15D0)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALTANGENT_OFFSET UNITYSDK_OFFSET(0x1ADF1690)
#define DEST_MATH_SPLINEBASE_ITEMDATA_EVALTHIRDDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1ADF15A0)
#define DEST_MATH_SPLINEBASE_ITEMDATA_PROCESSLENGTH_OFFSET UNITYSDK_OFFSET(0x1ADF1880)
#define DEST_MATH_SPLINEBASE_ITEMDATA_UPDATERENDERPOINTS_OFFSET UNITYSDK_OFFSET(0x1ADF0F50)
#define DEST_MATH_SPLINEBASE_ITEMDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADF1920)

namespace Dest::Math
{
	inline static constexpr unsigned int SplineBase_ItemData_TypeDefinitionIndex = 31745;
