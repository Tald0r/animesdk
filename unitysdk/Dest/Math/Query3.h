...
#define DEST_MATH_QUERY3_DET3_OFFSET UNITYSDK_OFFSET(0x1B100B30)
#define DEST_MATH_QUERY3_DET4_OFFSET UNITYSDK_OFFSET(0x1B101370)
#define DEST_MATH_QUERY3_DOT_OFFSET UNITYSDK_OFFSET(0x1B101570)
#define DEST_MATH_QUERY3_TOCIRCUMSPHERE_1_OFFSET UNITYSDK_OFFSET(0x1B100E00)
#define DEST_MATH_QUERY3_TOCIRCUMSPHERE_OFFSET UNITYSDK_OFFSET(0x1B100DC0)
#define DEST_MATH_QUERY3_TOPLANE_1_OFFSET UNITYSDK_OFFSET(0x1B100960)
#define DEST_MATH_QUERY3_TOPLANE_OFFSET UNITYSDK_OFFSET(0x1B100920)
#define DEST_MATH_QUERY3_TOTETRAHEDRON_1_OFFSET UNITYSDK_OFFSET(0x1B100CE0)
#define DEST_MATH_QUERY3_TOTETRAHEDRON_OFFSET UNITYSDK_OFFSET(0x1B100BC0)
#define DEST_MATH_QUERY3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B101590)
#define DEST_MATH_QUERY3__CTOR_OFFSET UNITYSDK_OFFSET(0x1B100910)

namespace Dest::Math
{
	inline static constexpr unsigned int Query3_TypeDefinitionIndex = 31735;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Query3_TypeDefinitionIndex)->GetStaticField(0x7D50);
		}
