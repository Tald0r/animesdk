...
#define DEST_MATH_QUERY3_DET3_OFFSET UNITYSDK_OFFSET(0x1B719AE0)
#define DEST_MATH_QUERY3_DET4_OFFSET UNITYSDK_OFFSET(0x1B71A320)
#define DEST_MATH_QUERY3_DOT_OFFSET UNITYSDK_OFFSET(0x1B71A520)
#define DEST_MATH_QUERY3_TOCIRCUMSPHERE_1_OFFSET UNITYSDK_OFFSET(0x1B719DB0)
#define DEST_MATH_QUERY3_TOCIRCUMSPHERE_OFFSET UNITYSDK_OFFSET(0x1B719D70)
#define DEST_MATH_QUERY3_TOPLANE_1_OFFSET UNITYSDK_OFFSET(0x1B719910)
#define DEST_MATH_QUERY3_TOPLANE_OFFSET UNITYSDK_OFFSET(0x1B7198D0)
#define DEST_MATH_QUERY3_TOTETRAHEDRON_1_OFFSET UNITYSDK_OFFSET(0x1B719C90)
#define DEST_MATH_QUERY3_TOTETRAHEDRON_OFFSET UNITYSDK_OFFSET(0x1B719B70)
#define DEST_MATH_QUERY3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B71A540)
#define DEST_MATH_QUERY3__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7198C0)

namespace Dest::Math
{
	inline static constexpr unsigned int Query3_TypeDefinitionIndex = 32689;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Query3_TypeDefinitionIndex)->GetStaticField(0x8080);
		}
