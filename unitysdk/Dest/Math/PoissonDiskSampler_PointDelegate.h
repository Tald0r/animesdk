...
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B718FF0)
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B719040)
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B718CA0)
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B718C80)

namespace Dest::Math
{
	inline static constexpr unsigned int PoissonDiskSampler_PointDelegate_TypeDefinitionIndex = 32705;
