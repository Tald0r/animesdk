...
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B100040)
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B100090)
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0FFD00)
#define DEST_MATH_POISSONDISKSAMPLER_POINTDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0FFCF0)

namespace Dest::Math
{
	inline static constexpr unsigned int PoissonDiskSampler_PointDelegate_TypeDefinitionIndex = 31751;
