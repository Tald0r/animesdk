...
#define DEST_MATH_VECTOR2EX_INFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B517980)

namespace Dest::Math
{
	inline static constexpr unsigned int Vector2ex_Information_TypeDefinitionIndex = 32646;
	...
	public:
		...
		::System::Boolean ExtremeCCW; // 0x20
		::UnityEngine::Vector2 Max; // 0x24
		::System::Single MaxRange; // 0x2C
		::System::Int32 Dimension; // 0x30
