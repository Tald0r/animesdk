...
#define DEST_MATH_VISUALDEBUG_DRAWAAB_1_OFFSET UNITYSDK_OFFSET(0x1AF93FD0)
#define DEST_MATH_VISUALDEBUG_DRAWAAB_OFFSET UNITYSDK_OFFSET(0x1AF93EC0)
#define DEST_MATH_VISUALDEBUG_DRAWBOX_1_OFFSET UNITYSDK_OFFSET(0x1AF945E0)
#define DEST_MATH_VISUALDEBUG_DRAWBOX_OFFSET UNITYSDK_OFFSET(0x1AF943C0)
#define DEST_MATH_VISUALDEBUG_DRAWCAPSULE_OFFSET UNITYSDK_OFFSET(0x1AF95EC0)
#define DEST_MATH_VISUALDEBUG_DRAWCIRCLE_1_OFFSET UNITYSDK_OFFSET(0x1AF94D90)
#define DEST_MATH_VISUALDEBUG_DRAWCIRCLE_2_OFFSET UNITYSDK_OFFSET(0x1AF94E90)
#define DEST_MATH_VISUALDEBUG_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x1AF94C70)
#define DEST_MATH_VISUALDEBUG_DRAWFUNC_OFFSET UNITYSDK_OFFSET(0x1AF95BB0)
#define DEST_MATH_VISUALDEBUG_DRAWLINE_1_OFFSET UNITYSDK_OFFSET(0x1AF951A0)
#define DEST_MATH_VISUALDEBUG_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x1AF950A0)
#define DEST_MATH_VISUALDEBUG_DRAWPLANE_OFFSET UNITYSDK_OFFSET(0x1AF95690)
#define DEST_MATH_VISUALDEBUG_DRAWPOINTSWITHSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1AF93BE0)
#define DEST_MATH_VISUALDEBUG_DRAWPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1AF93550)
#define DEST_MATH_VISUALDEBUG_DRAWPOINTS_OFFSET UNITYSDK_OFFSET(0x1AF93230)
#define DEST_MATH_VISUALDEBUG_DRAWPOINT_1_OFFSET UNITYSDK_OFFSET(0x1AF931B0)
#define DEST_MATH_VISUALDEBUG_DRAWPOINT_OFFSET UNITYSDK_OFFSET(0x1AF93130)
#define DEST_MATH_VISUALDEBUG_DRAWPOLYGON_1_OFFSET UNITYSDK_OFFSET(0x1AF95AB0)
#define DEST_MATH_VISUALDEBUG_DRAWPOLYGON_OFFSET UNITYSDK_OFFSET(0x1AF959C0)
#define DEST_MATH_VISUALDEBUG_DRAWRAY_1_OFFSET UNITYSDK_OFFSET(0x1AF95370)
#define DEST_MATH_VISUALDEBUG_DRAWRAY_OFFSET UNITYSDK_OFFSET(0x1AF952B0)
#define DEST_MATH_VISUALDEBUG_DRAWRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1AF94A80)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1AF93A60)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_1_OFFSET UNITYSDK_OFFSET(0x1AF93E80)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_2_OFFSET UNITYSDK_OFFSET(0x1AF95470)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_3_OFFSET UNITYSDK_OFFSET(0x1AF954C0)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_OFFSET UNITYSDK_OFFSET(0x1AF93B90)
#define DEST_MATH_VISUALDEBUG_DRAWSPHERE_OFFSET UNITYSDK_OFFSET(0x1AF95070)
#define DEST_MATH_VISUALDEBUG_DRAWTETRAHEDRON_OFFSET UNITYSDK_OFFSET(0x1AF95D20)
#define DEST_MATH_VISUALDEBUG_DRAWTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AF96310)
#define DEST_MATH_VISUALDEBUG_DRAWTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x1AF955E0)
#define DEST_MATH_VISUALDEBUG_DRAWTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1AF95500)
#define DEST_MATH_VISUALDEBUG_DRAWWIREPOINTS_OFFSET UNITYSDK_OFFSET(0x1AF93880)
#define DEST_MATH_VISUALDEBUG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AF96960)
#define DEST_MATH_VISUALDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF96950)

namespace Dest::Math
{
	inline static constexpr unsigned int VisualDebug_TypeDefinitionIndex = 31747;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VisualDebug_TypeDefinitionIndex)->GetStaticField(0x7D60);
		}
		static ::System::Single* StaticGet__pointRadius()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VisualDebug_TypeDefinitionIndex)->GetStaticField(0x7D64);
		}
