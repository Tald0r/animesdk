...
#define DEST_MATH_VISUALDEBUG_DRAWAAB_1_OFFSET UNITYSDK_OFFSET(0x1B59FDB0)
#define DEST_MATH_VISUALDEBUG_DRAWAAB_OFFSET UNITYSDK_OFFSET(0x1B59FCA0)
#define DEST_MATH_VISUALDEBUG_DRAWBOX_1_OFFSET UNITYSDK_OFFSET(0x1B5A03C0)
#define DEST_MATH_VISUALDEBUG_DRAWBOX_OFFSET UNITYSDK_OFFSET(0x1B5A01A0)
#define DEST_MATH_VISUALDEBUG_DRAWCAPSULE_OFFSET UNITYSDK_OFFSET(0x1B5A1CA0)
#define DEST_MATH_VISUALDEBUG_DRAWCIRCLE_1_OFFSET UNITYSDK_OFFSET(0x1B5A0B70)
#define DEST_MATH_VISUALDEBUG_DRAWCIRCLE_2_OFFSET UNITYSDK_OFFSET(0x1B5A0C70)
#define DEST_MATH_VISUALDEBUG_DRAWCIRCLE_OFFSET UNITYSDK_OFFSET(0x1B5A0A50)
#define DEST_MATH_VISUALDEBUG_DRAWFUNC_OFFSET UNITYSDK_OFFSET(0x1B5A1990)
#define DEST_MATH_VISUALDEBUG_DRAWLINE_1_OFFSET UNITYSDK_OFFSET(0x1B5A0F80)
#define DEST_MATH_VISUALDEBUG_DRAWLINE_OFFSET UNITYSDK_OFFSET(0x1B5A0E80)
#define DEST_MATH_VISUALDEBUG_DRAWPLANE_OFFSET UNITYSDK_OFFSET(0x1B5A1470)
#define DEST_MATH_VISUALDEBUG_DRAWPOINTSWITHSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1B59F9C0)
#define DEST_MATH_VISUALDEBUG_DRAWPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1B59F330)
#define DEST_MATH_VISUALDEBUG_DRAWPOINTS_OFFSET UNITYSDK_OFFSET(0x1B59F010)
#define DEST_MATH_VISUALDEBUG_DRAWPOINT_1_OFFSET UNITYSDK_OFFSET(0x1B59EF90)
#define DEST_MATH_VISUALDEBUG_DRAWPOINT_OFFSET UNITYSDK_OFFSET(0x1B59EF10)
#define DEST_MATH_VISUALDEBUG_DRAWPOLYGON_1_OFFSET UNITYSDK_OFFSET(0x1B5A1890)
#define DEST_MATH_VISUALDEBUG_DRAWPOLYGON_OFFSET UNITYSDK_OFFSET(0x1B5A17A0)
#define DEST_MATH_VISUALDEBUG_DRAWRAY_1_OFFSET UNITYSDK_OFFSET(0x1B5A1150)
#define DEST_MATH_VISUALDEBUG_DRAWRAY_OFFSET UNITYSDK_OFFSET(0x1B5A1090)
#define DEST_MATH_VISUALDEBUG_DRAWRECTANGLE_OFFSET UNITYSDK_OFFSET(0x1B5A0860)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1B59F840)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_1_OFFSET UNITYSDK_OFFSET(0x1B59FC60)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_2_OFFSET UNITYSDK_OFFSET(0x1B5A1250)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_3_OFFSET UNITYSDK_OFFSET(0x1B5A12A0)
#define DEST_MATH_VISUALDEBUG_DRAWSEGMENT_OFFSET UNITYSDK_OFFSET(0x1B59F970)
#define DEST_MATH_VISUALDEBUG_DRAWSPHERE_OFFSET UNITYSDK_OFFSET(0x1B5A0E50)
#define DEST_MATH_VISUALDEBUG_DRAWTETRAHEDRON_OFFSET UNITYSDK_OFFSET(0x1B5A1B00)
#define DEST_MATH_VISUALDEBUG_DRAWTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B5A20F0)
#define DEST_MATH_VISUALDEBUG_DRAWTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x1B5A13C0)
#define DEST_MATH_VISUALDEBUG_DRAWTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1B5A12E0)
#define DEST_MATH_VISUALDEBUG_DRAWWIREPOINTS_OFFSET UNITYSDK_OFFSET(0x1B59F660)
#define DEST_MATH_VISUALDEBUG__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B5A2740)
#define DEST_MATH_VISUALDEBUG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A2730)

namespace Dest::Math
{
	inline static constexpr unsigned int VisualDebug_TypeDefinitionIndex = 32701;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VisualDebug_TypeDefinitionIndex)->GetStaticField(0x8090);
		}
		static ::System::Single* StaticGet__pointRadius()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VisualDebug_TypeDefinitionIndex)->GetStaticField(0x8094);
		}
