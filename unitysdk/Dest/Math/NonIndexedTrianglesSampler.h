...
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER_INIT_OFFSET UNITYSDK_OFFSET(0x1B410D60)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER_SAMPLEARRAY_OFFSET UNITYSDK_OFFSET(0x1B411390)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER_SAMPLE_OFFSET UNITYSDK_OFFSET(0x1B4111D0)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4110F0)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B411100)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B411190)
#define DEST_MATH_NONINDEXEDTRIANGLESSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B410CE0)

namespace Dest::Math
{
	inline static constexpr unsigned int NonIndexedTrianglesSampler_TypeDefinitionIndex = 32709;
