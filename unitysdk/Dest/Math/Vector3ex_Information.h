...
#define DEST_MATH_VECTOR3EX_INFORMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE6F750)

namespace Dest::Math
{
	inline static constexpr unsigned int Vector3ex_Information_TypeDefinitionIndex = 32649;
	...
	public:
		...
		::System::Single MaxRange; // 0x24
		::UnityEngine::Vector3 Max; // 0x28
		::UnityEngine::Vector3 Min; // 0x34
