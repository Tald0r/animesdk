...
#define DEST_MATH_WEIGHTEDSAMPLER_BINARYSEARCH_OFFSET UNITYSDK_OFFSET(0x1AF969B0)
#define DEST_MATH_WEIGHTEDSAMPLER_INIT_OFFSET UNITYSDK_OFFSET(0x1AF96AB0)
#define DEST_MATH_WEIGHTEDSAMPLER_SAMPLEINDEX_OFFSET UNITYSDK_OFFSET(0x1AF96BB0)
#define DEST_MATH_WEIGHTEDSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AF96A40)
#define DEST_MATH_WEIGHTEDSAMPLER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AF96BA0)
#define DEST_MATH_WEIGHTEDSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF969A0)

namespace Dest::Math
{
	inline static constexpr unsigned int WeightedSampler_TypeDefinitionIndex = 31752;
