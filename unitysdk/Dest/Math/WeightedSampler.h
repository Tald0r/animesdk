...
#define DEST_MATH_WEIGHTEDSAMPLER_BINARYSEARCH_OFFSET UNITYSDK_OFFSET(0x1B5A2790)
#define DEST_MATH_WEIGHTEDSAMPLER_INIT_OFFSET UNITYSDK_OFFSET(0x1B5A2890)
#define DEST_MATH_WEIGHTEDSAMPLER_SAMPLEINDEX_OFFSET UNITYSDK_OFFSET(0x1B5A2990)
#define DEST_MATH_WEIGHTEDSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B5A2820)
#define DEST_MATH_WEIGHTEDSAMPLER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B5A2980)
#define DEST_MATH_WEIGHTEDSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5A2780)

namespace Dest::Math
{
	inline static constexpr unsigned int WeightedSampler_TypeDefinitionIndex = 32706;
