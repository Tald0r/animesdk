...
#define DEST_MATH_LINEARSYSTEM_INVERSE_OFFSET UNITYSDK_OFFSET(0x1B054000)
#define DEST_MATH_LINEARSYSTEM_SOLVE2_1_OFFSET UNITYSDK_OFFSET(0x1B052AB0)
#define DEST_MATH_LINEARSYSTEM_SOLVE2_OFFSET UNITYSDK_OFFSET(0x1B052890)
#define DEST_MATH_LINEARSYSTEM_SOLVE3_1_OFFSET UNITYSDK_OFFSET(0x1B053130)
#define DEST_MATH_LINEARSYSTEM_SOLVE3_OFFSET UNITYSDK_OFFSET(0x1B052B90)
#define DEST_MATH_LINEARSYSTEM_SOLVETRIDIAGONAL_OFFSET UNITYSDK_OFFSET(0x1B053C70)
#define DEST_MATH_LINEARSYSTEM_SOLVE_OFFSET UNITYSDK_OFFSET(0x1B053380)
#define DEST_MATH_LINEARSYSTEM_SWAPROWS_OFFSET UNITYSDK_OFFSET(0x1B053200)

namespace Dest::Math
{
	inline static constexpr unsigned int LinearSystem_TypeDefinitionIndex = 31702;
