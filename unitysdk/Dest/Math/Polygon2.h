...
#define DEST_MATH_POLYGON2_CALCAREA_OFFSET UNITYSDK_OFFSET(0x1A52B390)
#define DEST_MATH_POLYGON2_CALCCENTER_OFFSET UNITYSDK_OFFSET(0x1A52B210)
#define DEST_MATH_POLYGON2_CALCPERIMETER_OFFSET UNITYSDK_OFFSET(0x1A52B2E0)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXCCW_1_OFFSET UNITYSDK_OFFSET(0x1A52BDB0)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXCCW_OFFSET UNITYSDK_OFFSET(0x1A52BC30)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXCW_1_OFFSET UNITYSDK_OFFSET(0x1A52BF50)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXCW_OFFSET UNITYSDK_OFFSET(0x1A52BDD0)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXQUADCCW_1_OFFSET UNITYSDK_OFFSET(0x1A52BA90)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXQUADCCW_OFFSET UNITYSDK_OFFSET(0x1A52B930)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXQUADCW_1_OFFSET UNITYSDK_OFFSET(0x1A52BC10)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXQUADCW_OFFSET UNITYSDK_OFFSET(0x1A52BAB0)
#define DEST_MATH_POLYGON2_CONTAINSSIMPLE_1_OFFSET UNITYSDK_OFFSET(0x1A52C0A0)
#define DEST_MATH_POLYGON2_CONTAINSSIMPLE_OFFSET UNITYSDK_OFFSET(0x1A52BF70)
#define DEST_MATH_POLYGON2_CREATEPROJECTED_OFFSET UNITYSDK_OFFSET(0x1A52AB70)
#define DEST_MATH_POLYGON2_GETEDGE_OFFSET UNITYSDK_OFFSET(0x1A52AF20)
#define DEST_MATH_POLYGON2_GET_EDGES_OFFSET UNITYSDK_OFFSET(0x1A52A6B0)
#define DEST_MATH_POLYGON2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A52A6E0)
#define DEST_MATH_POLYGON2_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1A52A6C0)
#define DEST_MATH_POLYGON2_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1A52A6A0)
#define DEST_MATH_POLYGON2_HASZEROCORNERS_OFFSET UNITYSDK_OFFSET(0x1A52B7A0)
#define DEST_MATH_POLYGON2_ISCONVEX_1_OFFSET UNITYSDK_OFFSET(0x1A52B780)
#define DEST_MATH_POLYGON2_ISCONVEX_OFFSET UNITYSDK_OFFSET(0x1A52B590)
#define DEST_MATH_POLYGON2_REVERSEVERTICES_OFFSET UNITYSDK_OFFSET(0x1A52B870)
#define DEST_MATH_POLYGON2_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A52A720)
#define DEST_MATH_POLYGON2_SUBCONTAINSPOINTCCW_OFFSET UNITYSDK_OFFSET(0x1A52BC40)
#define DEST_MATH_POLYGON2_SUBCONTAINSPOINTCW_OFFSET UNITYSDK_OFFSET(0x1A52BDE0)
#define DEST_MATH_POLYGON2_TOSEGMENTARRAY_OFFSET UNITYSDK_OFFSET(0x1A52C0C0)
#define DEST_MATH_POLYGON2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A52C310)
#define DEST_MATH_POLYGON2_UPDATEEDGES_OFFSET UNITYSDK_OFFSET(0x1A52A7F0)
#define DEST_MATH_POLYGON2_UPDATEEDGE_OFFSET UNITYSDK_OFFSET(0x1A52AF80)
#define DEST_MATH_POLYGON2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A52A770)
#define DEST_MATH_POLYGON2__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A52AB10)
#define DEST_MATH_POLYGON2__CTOR_OFFSET UNITYSDK_OFFSET(0x1A52A760)

namespace Dest::Math
{
	inline static constexpr unsigned int Polygon2_TypeDefinitionIndex = 31716;
