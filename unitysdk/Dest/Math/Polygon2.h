...
#define DEST_MATH_POLYGON2_CALCAREA_OFFSET UNITYSDK_OFFSET(0x1AB04E60)
#define DEST_MATH_POLYGON2_CALCCENTER_OFFSET UNITYSDK_OFFSET(0x1AB04CE0)
#define DEST_MATH_POLYGON2_CALCPERIMETER_OFFSET UNITYSDK_OFFSET(0x1AB04DB0)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXCCW_1_OFFSET UNITYSDK_OFFSET(0x1AB05880)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXCCW_OFFSET UNITYSDK_OFFSET(0x1AB05700)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXCW_1_OFFSET UNITYSDK_OFFSET(0x1AB05A20)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXCW_OFFSET UNITYSDK_OFFSET(0x1AB058A0)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXQUADCCW_1_OFFSET UNITYSDK_OFFSET(0x1AB05560)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXQUADCCW_OFFSET UNITYSDK_OFFSET(0x1AB05400)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXQUADCW_1_OFFSET UNITYSDK_OFFSET(0x1AB056E0)
#define DEST_MATH_POLYGON2_CONTAINSCONVEXQUADCW_OFFSET UNITYSDK_OFFSET(0x1AB05580)
#define DEST_MATH_POLYGON2_CONTAINSSIMPLE_1_OFFSET UNITYSDK_OFFSET(0x1AB05B70)
#define DEST_MATH_POLYGON2_CONTAINSSIMPLE_OFFSET UNITYSDK_OFFSET(0x1AB05A40)
#define DEST_MATH_POLYGON2_CREATEPROJECTED_OFFSET UNITYSDK_OFFSET(0x1AB04640)
#define DEST_MATH_POLYGON2_GETEDGE_OFFSET UNITYSDK_OFFSET(0x1AB049F0)
#define DEST_MATH_POLYGON2_GET_EDGES_OFFSET UNITYSDK_OFFSET(0x1AB04180)
#define DEST_MATH_POLYGON2_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AB041B0)
#define DEST_MATH_POLYGON2_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1AB04190)
#define DEST_MATH_POLYGON2_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1AB04170)
#define DEST_MATH_POLYGON2_HASZEROCORNERS_OFFSET UNITYSDK_OFFSET(0x1AB05270)
#define DEST_MATH_POLYGON2_ISCONVEX_1_OFFSET UNITYSDK_OFFSET(0x1AB05250)
#define DEST_MATH_POLYGON2_ISCONVEX_OFFSET UNITYSDK_OFFSET(0x1AB05060)
#define DEST_MATH_POLYGON2_REVERSEVERTICES_OFFSET UNITYSDK_OFFSET(0x1AB05340)
#define DEST_MATH_POLYGON2_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AB041F0)
#define DEST_MATH_POLYGON2_SUBCONTAINSPOINTCCW_OFFSET UNITYSDK_OFFSET(0x1AB05710)
#define DEST_MATH_POLYGON2_SUBCONTAINSPOINTCW_OFFSET UNITYSDK_OFFSET(0x1AB058B0)
#define DEST_MATH_POLYGON2_TOSEGMENTARRAY_OFFSET UNITYSDK_OFFSET(0x1AB05B90)
#define DEST_MATH_POLYGON2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AB05DE0)
#define DEST_MATH_POLYGON2_UPDATEEDGES_OFFSET UNITYSDK_OFFSET(0x1AB042C0)
#define DEST_MATH_POLYGON2_UPDATEEDGE_OFFSET UNITYSDK_OFFSET(0x1AB04A50)
#define DEST_MATH_POLYGON2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB04240)
#define DEST_MATH_POLYGON2__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB045E0)
#define DEST_MATH_POLYGON2__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB04230)

namespace Dest::Math
{
	inline static constexpr unsigned int Polygon2_TypeDefinitionIndex = 32670;
