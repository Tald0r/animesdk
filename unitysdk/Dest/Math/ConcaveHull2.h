...
#define DEST_MATH_CONCAVEHULL2_CALCDISTANCEFROMPOINTTOEDGE_OFFSET UNITYSDK_OFFSET(0x1ADF0220)
#define DEST_MATH_CONCAVEHULL2_CREATE_OFFSET UNITYSDK_OFFSET(0x1ADEED60)
#define DEST_MATH_CONCAVEHULL2_QUICKSORT_OFFSET UNITYSDK_OFFSET(0x1ADF0010)
#define DEST_MATH_CONCAVEHULL2__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADF0340)

namespace Dest::Math
{
	inline static constexpr unsigned int ConcaveHull2_TypeDefinitionIndex = 31611;
