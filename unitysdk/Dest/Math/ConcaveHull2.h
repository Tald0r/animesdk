...
#define DEST_MATH_CONCAVEHULL2_CALCDISTANCEFROMPOINTTOEDGE_OFFSET UNITYSDK_OFFSET(0x1B4109C0)
#define DEST_MATH_CONCAVEHULL2_CREATE_OFFSET UNITYSDK_OFFSET(0x1B40F500)
#define DEST_MATH_CONCAVEHULL2_QUICKSORT_OFFSET UNITYSDK_OFFSET(0x1B4107B0)
#define DEST_MATH_CONCAVEHULL2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B410AE0)

namespace Dest::Math
{
	inline static constexpr unsigned int ConcaveHull2_TypeDefinitionIndex = 32565;
