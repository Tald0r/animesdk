...
#define DEST_MATH_RAY3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x977900)
#define DEST_MATH_RAY3_EVAL_OFFSET UNITYSDK_OFFSET(0x8E99F0)
#define DEST_MATH_RAY3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B055000)
#define DEST_MATH_RAY3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B054F60)
#define DEST_MATH_RAY3_PROJECT_OFFSET UNITYSDK_OFFSET(0x977940)
#define DEST_MATH_RAY3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x977A10)
#define DEST_MATH_RAY3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x310080)
#define DEST_MATH_RAY3__CTOR_OFFSET UNITYSDK_OFFSET(0x7ECAD0)

namespace Dest::Math
{
	inline static constexpr unsigned int Ray3_TypeDefinitionIndex = 31728;
