...
#define DEST_MATH_RAY3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9AA730)
#define DEST_MATH_RAY3_EVAL_OFFSET UNITYSDK_OFFSET(0x91D940)
#define DEST_MATH_RAY3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B664280)
#define DEST_MATH_RAY3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B6641E0)
#define DEST_MATH_RAY3_PROJECT_OFFSET UNITYSDK_OFFSET(0x9AA770)
#define DEST_MATH_RAY3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9AA840)
#define DEST_MATH_RAY3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3889A0)
#define DEST_MATH_RAY3__CTOR_OFFSET UNITYSDK_OFFSET(0x81D370)

namespace Dest::Math
{
	inline static constexpr unsigned int Ray3_TypeDefinitionIndex = 32682;
