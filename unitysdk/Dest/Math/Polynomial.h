...
#define DEST_MATH_POLYNOMIAL_CALCDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1B65FEB0)
#define DEST_MATH_POLYNOMIAL_CALCINVERSION_OFFSET UNITYSDK_OFFSET(0x1B660000)
#define DEST_MATH_POLYNOMIAL_COMPRESS_OFFSET UNITYSDK_OFFSET(0x1B6601A0)
#define DEST_MATH_POLYNOMIAL_DEEPCOPY_OFFSET UNITYSDK_OFFSET(0x1B65FDD0)
#define DEST_MATH_POLYNOMIAL_EVAL_OFFSET UNITYSDK_OFFSET(0x1B660300)
#define DEST_MATH_POLYNOMIAL_GET_DEGREE_OFFSET UNITYSDK_OFFSET(0x1B65FCE0)
#define DEST_MATH_POLYNOMIAL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B65FD20)
#define DEST_MATH_POLYNOMIAL_SET_DEGREE_OFFSET UNITYSDK_OFFSET(0x1B65FCF0)
#define DEST_MATH_POLYNOMIAL_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B65FD60)
#define DEST_MATH_POLYNOMIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B65FDA0)

namespace Dest::Math
{
	inline static constexpr unsigned int Polynomial_TypeDefinitionIndex = 32563;
