...
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER_INIT_OFFSET UNITYSDK_OFFSET(0x1B65E9E0)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER_SAMPLEARRAY_1_OFFSET UNITYSDK_OFFSET(0x1B65F620)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER_SAMPLEARRAY_OFFSET UNITYSDK_OFFSET(0x1B65F240)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER_SAMPLE_OFFSET UNITYSDK_OFFSET(0x1B65F010)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B65EEB0)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B65EED0)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B65EFA0)
#define DEST_MATH_INDEXEDTRIANGLESSAMPLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B65E960)

namespace Dest::Math
{
	inline static constexpr unsigned int IndexedTrianglesSampler_TypeDefinitionIndex = 32708;
