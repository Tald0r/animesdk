...
#define DEST_MATH_CONVEXHULL3_TRIANGLE_ATTACHTO_OFFSET UNITYSDK_OFFSET(0x1A528CA0)
#define DEST_MATH_CONVEXHULL3_TRIANGLE_DETACHFROM_OFFSET UNITYSDK_OFFSET(0x1A529B60)
#define DEST_MATH_CONVEXHULL3_TRIANGLE_GETADJ_OFFSET UNITYSDK_OFFSET(0x1A529B30)
#define DEST_MATH_CONVEXHULL3_TRIANGLE_GETSIGN_OFFSET UNITYSDK_OFFSET(0x1A529AB0)
#define DEST_MATH_CONVEXHULL3_TRIANGLE_GETV_OFFSET UNITYSDK_OFFSET(0x1A529BF0)
#define DEST_MATH_CONVEXHULL3_TRIANGLE_SETADJ_OFFSET UNITYSDK_OFFSET(0x1A529C10)
#define DEST_MATH_CONVEXHULL3_TRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A528C80)

namespace Dest::Math
{
	inline static constexpr unsigned int ConvexHull3_Triangle_TypeDefinitionIndex = 31621;
