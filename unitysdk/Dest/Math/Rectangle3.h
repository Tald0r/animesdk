...
#define DEST_MATH_RECTANGLE3_CALCAREA_OFFSET UNITYSDK_OFFSET(0x980650)
#define DEST_MATH_RECTANGLE3_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x980630)
#define DEST_MATH_RECTANGLE3_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x980640)
#define DEST_MATH_RECTANGLE3_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x980570)
#define DEST_MATH_RECTANGLE3_CREATEFROMCCWPOINTS_OFFSET UNITYSDK_OFFSET(0x1AFCDC60)
#define DEST_MATH_RECTANGLE3_CREATEFROMCWPOINTS_OFFSET UNITYSDK_OFFSET(0x1AFCDEF0)
#define DEST_MATH_RECTANGLE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x980670)
#define DEST_MATH_RECTANGLE3_PROJECT_OFFSET UNITYSDK_OFFSET(0x9806B0)
#define DEST_MATH_RECTANGLE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x980710)
#define DEST_MATH_RECTANGLE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x980490)
#define DEST_MATH_RECTANGLE3__CTOR_OFFSET UNITYSDK_OFFSET(0x9803B0)

namespace Dest::Math
{
	inline static constexpr unsigned int Rectangle3_TypeDefinitionIndex = 32683;
