...
#define DEST_MATH_CIRCLE3_CALCAREA_OFFSET UNITYSDK_OFFSET(0x977200)
#define DEST_MATH_CIRCLE3_CALCPERIMETER_OFFSET UNITYSDK_OFFSET(0x9771F0)
#define DEST_MATH_CIRCLE3_CREATECIRCUMSCRIBED_OFFSET UNITYSDK_OFFSET(0x1B051680)
#define DEST_MATH_CIRCLE3_CREATEINSCRIBED_OFFSET UNITYSDK_OFFSET(0x1B051AB0)
#define DEST_MATH_CIRCLE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9773D0)
#define DEST_MATH_CIRCLE3_EVAL_1_OFFSET UNITYSDK_OFFSET(0x977300)
#define DEST_MATH_CIRCLE3_EVAL_OFFSET UNITYSDK_OFFSET(0x977220)
#define DEST_MATH_CIRCLE3_PROJECT_OFFSET UNITYSDK_OFFSET(0x977430)
#define DEST_MATH_CIRCLE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x977490)
#define DEST_MATH_CIRCLE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x977010)
#define DEST_MATH_CIRCLE3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x977100)
#define DEST_MATH_CIRCLE3__CTOR_3_OFFSET UNITYSDK_OFFSET(0x977170)
#define DEST_MATH_CIRCLE3__CTOR_OFFSET UNITYSDK_OFFSET(0x976F20)

namespace Dest::Math
{
	inline static constexpr unsigned int Circle3_TypeDefinitionIndex = 31723;
