...
#define DEST_MATH_CIRCLE3_CALCAREA_OFFSET UNITYSDK_OFFSET(0x9AA030)
#define DEST_MATH_CIRCLE3_CALCPERIMETER_OFFSET UNITYSDK_OFFSET(0x9AA020)
#define DEST_MATH_CIRCLE3_CREATECIRCUMSCRIBED_OFFSET UNITYSDK_OFFSET(0x1B660900)
#define DEST_MATH_CIRCLE3_CREATEINSCRIBED_OFFSET UNITYSDK_OFFSET(0x1B660D30)
#define DEST_MATH_CIRCLE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9AA200)
#define DEST_MATH_CIRCLE3_EVAL_1_OFFSET UNITYSDK_OFFSET(0x9AA130)
#define DEST_MATH_CIRCLE3_EVAL_OFFSET UNITYSDK_OFFSET(0x9AA050)
#define DEST_MATH_CIRCLE3_PROJECT_OFFSET UNITYSDK_OFFSET(0x9AA260)
#define DEST_MATH_CIRCLE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9AA2C0)
#define DEST_MATH_CIRCLE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9A9E40)
#define DEST_MATH_CIRCLE3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9A9F30)
#define DEST_MATH_CIRCLE3__CTOR_3_OFFSET UNITYSDK_OFFSET(0x9A9FA0)
#define DEST_MATH_CIRCLE3__CTOR_OFFSET UNITYSDK_OFFSET(0x9A9D50)

namespace Dest::Math
{
	inline static constexpr unsigned int Circle3_TypeDefinitionIndex = 32677;
