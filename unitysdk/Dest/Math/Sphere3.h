...
#define DEST_MATH_SPHERE3_CALCAREA_OFFSET UNITYSDK_OFFSET(0x96A920)
#define DEST_MATH_SPHERE3_CALCVOLUME_OFFSET UNITYSDK_OFFSET(0x96A940)
#define DEST_MATH_SPHERE3_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x96ABA0)
#define DEST_MATH_SPHERE3_CONTAINS_OFFSET UNITYSDK_OFFSET(0x96ABA0)
#define DEST_MATH_SPHERE3_CREATECIRCUMSCRIBED_OFFSET UNITYSDK_OFFSET(0x1AEF77A0)
#define DEST_MATH_SPHERE3_CREATEFROMPOINTSAAB_1_OFFSET UNITYSDK_OFFSET(0x1AEF6A80)
#define DEST_MATH_SPHERE3_CREATEFROMPOINTSAAB_OFFSET UNITYSDK_OFFSET(0x1AEF67C0)
#define DEST_MATH_SPHERE3_CREATEFROMPOINTSAVERAGE_1_OFFSET UNITYSDK_OFFSET(0x1AEF7380)
#define DEST_MATH_SPHERE3_CREATEFROMPOINTSAVERAGE_OFFSET UNITYSDK_OFFSET(0x1AEF6C10)
#define DEST_MATH_SPHERE3_CREATEINSCRIBED_OFFSET UNITYSDK_OFFSET(0x1AEF7B30)
#define DEST_MATH_SPHERE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x96AA70)
#define DEST_MATH_SPHERE3_EVAL_OFFSET UNITYSDK_OFFSET(0x96A960)
#define DEST_MATH_SPHERE3_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x96ACF0)
#define DEST_MATH_SPHERE3_INCLUDE_OFFSET UNITYSDK_OFFSET(0x96ABF0)
#define DEST_MATH_SPHERE3_PROJECT_OFFSET UNITYSDK_OFFSET(0x96AAE0)
#define DEST_MATH_SPHERE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x96AE10)
#define DEST_MATH_SPHERE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x33FDB0)
#define DEST_MATH_SPHERE3__CTOR_OFFSET UNITYSDK_OFFSET(0x33FDB0)

namespace Dest::Math
{
	inline static constexpr unsigned int Sphere3_TypeDefinitionIndex = 31731;
