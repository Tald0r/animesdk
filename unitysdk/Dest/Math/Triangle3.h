...
#define DEST_MATH_TRIANGLE3_CALCANGLESDEG_1_OFFSET UNITYSDK_OFFSET(0x1B59E190)
#define DEST_MATH_TRIANGLE3_CALCANGLESDEG_2_OFFSET UNITYSDK_OFFSET(0x1B59E330)
#define DEST_MATH_TRIANGLE3_CALCANGLESDEG_OFFSET UNITYSDK_OFFSET(0x9A0F80)
#define DEST_MATH_TRIANGLE3_CALCANGLESRAD_1_OFFSET UNITYSDK_OFFSET(0x1B59E690)
#define DEST_MATH_TRIANGLE3_CALCANGLESRAD_2_OFFSET UNITYSDK_OFFSET(0x1B59E860)
#define DEST_MATH_TRIANGLE3_CALCANGLESRAD_OFFSET UNITYSDK_OFFSET(0x9A1120)
#define DEST_MATH_TRIANGLE3_CALCAREA_1_OFFSET UNITYSDK_OFFSET(0x1B59DEB0)
#define DEST_MATH_TRIANGLE3_CALCAREA_2_OFFSET UNITYSDK_OFFSET(0x1B59DF50)
#define DEST_MATH_TRIANGLE3_CALCAREA_OFFSET UNITYSDK_OFFSET(0x9A0EE0)
#define DEST_MATH_TRIANGLE3_CALCBARYCENTRICCOORDS_1_OFFSET UNITYSDK_OFFSET(0x9A1410)
#define DEST_MATH_TRIANGLE3_CALCBARYCENTRICCOORDS_2_OFFSET UNITYSDK_OFFSET(0x9A1470)
#define DEST_MATH_TRIANGLE3_CALCBARYCENTRICCOORDS_OFFSET UNITYSDK_OFFSET(0x1B59EB70)
#define DEST_MATH_TRIANGLE3_CALCEDGE_OFFSET UNITYSDK_OFFSET(0x9A0DD0)
#define DEST_MATH_TRIANGLE3_CALCNORMAL_OFFSET UNITYSDK_OFFSET(0x9A0E60)
#define DEST_MATH_TRIANGLE3_EVALBARYCENTRIC_1_OFFSET UNITYSDK_OFFSET(0x9A1340)
#define DEST_MATH_TRIANGLE3_EVALBARYCENTRIC_2_OFFSET UNITYSDK_OFFSET(0x9A13B0)
#define DEST_MATH_TRIANGLE3_EVALBARYCENTRIC_OFFSET UNITYSDK_OFFSET(0x9A12E0)
#define DEST_MATH_TRIANGLE3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x9A0CE0)
#define DEST_MATH_TRIANGLE3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x9A0D40)
#define DEST_MATH_TRIANGLE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9A14E0)
#define DEST_MATH_TRIANGLE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9A0D70)
#define DEST_MATH_TRIANGLE3__CTOR_OFFSET UNITYSDK_OFFSET(0x96DDB0)

namespace Dest::Math
{
	inline static constexpr unsigned int Triangle3_TypeDefinitionIndex = 32686;
