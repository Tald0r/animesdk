...
#define DEST_MATH_MATRIX4X4EX_CALCDETERMINANT_OFFSET UNITYSDK_OFFSET(0x1A8BA190)
#define DEST_MATH_MATRIX4X4EX_COPYMATRIX_OFFSET UNITYSDK_OFFSET(0x1A8BACB0)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONANGLEAXIS_OFFSET UNITYSDK_OFFSET(0x1A8B98E0)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONANGLEUNITAXIS_OFFSET UNITYSDK_OFFSET(0x1A8B9AB0)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONEULER_1_OFFSET UNITYSDK_OFFSET(0x1A8B9310)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONEULER_2_OFFSET UNITYSDK_OFFSET(0x1A8B9520)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONEULER_OFFSET UNITYSDK_OFFSET(0x1A8B9100)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONFROMCOLUMNS_1_OFFSET UNITYSDK_OFFSET(0x1A8BD860)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONFROMCOLUMNS_OFFSET UNITYSDK_OFFSET(0x1A8BD790)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONX_OFFSET UNITYSDK_OFFSET(0x1A8B9730)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONY_OFFSET UNITYSDK_OFFSET(0x1A8B97C0)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATIONZ_OFFSET UNITYSDK_OFFSET(0x1A8B9850)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATION_1_OFFSET UNITYSDK_OFFSET(0x1A8B9E80)
#define DEST_MATH_MATRIX4X4EX_CREATEROTATION_OFFSET UNITYSDK_OFFSET(0x1A8B9C20)
#define DEST_MATH_MATRIX4X4EX_CREATERT_1_OFFSET UNITYSDK_OFFSET(0x1A8BD090)
#define DEST_MATH_MATRIX4X4EX_CREATERT_2_OFFSET UNITYSDK_OFFSET(0x1A8BD250)
#define DEST_MATH_MATRIX4X4EX_CREATERT_3_OFFSET UNITYSDK_OFFSET(0x1A8BD4C0)
#define DEST_MATH_MATRIX4X4EX_CREATERT_OFFSET UNITYSDK_OFFSET(0x1A8BCED0)
#define DEST_MATH_MATRIX4X4EX_CREATESCALE_1_OFFSET UNITYSDK_OFFSET(0x1A8B9090)
#define DEST_MATH_MATRIX4X4EX_CREATESCALE_2_OFFSET UNITYSDK_OFFSET(0x1A8B90D0)
#define DEST_MATH_MATRIX4X4EX_CREATESCALE_OFFSET UNITYSDK_OFFSET(0x1A8B9050)
#define DEST_MATH_MATRIX4X4EX_CREATESHADOWDIRECTIONAL_1_OFFSET UNITYSDK_OFFSET(0x1A8BDA70)
#define DEST_MATH_MATRIX4X4EX_CREATESHADOWDIRECTIONAL_OFFSET UNITYSDK_OFFSET(0x1A8BD930)
#define DEST_MATH_MATRIX4X4EX_CREATESHADOWPOINT_1_OFFSET UNITYSDK_OFFSET(0x1A8BDCF0)
#define DEST_MATH_MATRIX4X4EX_CREATESHADOWPOINT_OFFSET UNITYSDK_OFFSET(0x1A8BDBA0)
#define DEST_MATH_MATRIX4X4EX_CREATESHADOW_1_OFFSET UNITYSDK_OFFSET(0x1A8BDFB0)
#define DEST_MATH_MATRIX4X4EX_CREATESHADOW_OFFSET UNITYSDK_OFFSET(0x1A8BDE20)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_1_OFFSET UNITYSDK_OFFSET(0x1A8BBC40)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_2_OFFSET UNITYSDK_OFFSET(0x1A8BBEA0)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_3_OFFSET UNITYSDK_OFFSET(0x1A8BC0D0)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_4_OFFSET UNITYSDK_OFFSET(0x1A8BC300)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_5_OFFSET UNITYSDK_OFFSET(0x1A8BC620)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_6_OFFSET UNITYSDK_OFFSET(0x1A8BC900)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_7_OFFSET UNITYSDK_OFFSET(0x1A8BCC30)
#define DEST_MATH_MATRIX4X4EX_CREATESRT_OFFSET UNITYSDK_OFFSET(0x1A8BB9D0)
#define DEST_MATH_MATRIX4X4EX_CREATEST_1_OFFSET UNITYSDK_OFFSET(0x1A8BD730)
#define DEST_MATH_MATRIX4X4EX_CREATEST_OFFSET UNITYSDK_OFFSET(0x1A8BD6D0)
#define DEST_MATH_MATRIX4X4EX_CREATETRANSLATION_1_OFFSET UNITYSDK_OFFSET(0x1A8B9010)
#define DEST_MATH_MATRIX4X4EX_CREATETRANSLATION_OFFSET UNITYSDK_OFFSET(0x1A8B8FC0)
#define DEST_MATH_MATRIX4X4EX_INVERSE_1_OFFSET UNITYSDK_OFFSET(0x1A8BA760)
#define DEST_MATH_MATRIX4X4EX_INVERSE_OFFSET UNITYSDK_OFFSET(0x1A8BA300)
#define DEST_MATH_MATRIX4X4EX_MULTIPLYLEFT_OFFSET UNITYSDK_OFFSET(0x1A8BB560)
#define DEST_MATH_MATRIX4X4EX_MULTIPLYRIGHT_OFFSET UNITYSDK_OFFSET(0x1A8BB2A0)
#define DEST_MATH_MATRIX4X4EX_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1A8BB810)
#define DEST_MATH_MATRIX4X4EX_MULTIPLY_2_OFFSET UNITYSDK_OFFSET(0x1A8BB840)
#define DEST_MATH_MATRIX4X4EX_MULTIPLY_3_OFFSET UNITYSDK_OFFSET(0x1A8BB8F0)
#define DEST_MATH_MATRIX4X4EX_MULTIPLY_4_OFFSET UNITYSDK_OFFSET(0x1A8BB960)
#define DEST_MATH_MATRIX4X4EX_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A8BAD20)
#define DEST_MATH_MATRIX4X4EX_QUATERNIONTOROTATIONMATRIX_1_OFFSET UNITYSDK_OFFSET(0x1A8B8E80)
#define DEST_MATH_MATRIX4X4EX_QUATERNIONTOROTATIONMATRIX_OFFSET UNITYSDK_OFFSET(0x1A8B8D40)
#define DEST_MATH_MATRIX4X4EX_ROTATIONMATRIXTOQUATERNION_OFFSET UNITYSDK_OFFSET(0x1A8B8CB0)
#define DEST_MATH_MATRIX4X4EX_TRANSPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A8BA0F0)
#define DEST_MATH_MATRIX4X4EX_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1A8BA070)
#define DEST_MATH_MATRIX4X4EX__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8BE110)

namespace Dest::Math
{
	inline static constexpr unsigned int Matrix4x4ex_TypeDefinitionIndex = 31688;
	...
	public:
		...
		{
			return (::UnityEngine::Matrix4x4*)Il2CppClass::FromTypeDefinitionIndex(Matrix4x4ex_TypeDefinitionIndex)->GetStaticField(0x7CE0);
		}
