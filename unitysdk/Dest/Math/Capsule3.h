...
#define DEST_MATH_CAPSULE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x975CA0)
#define DEST_MATH_CAPSULE3__CTOR_OFFSET UNITYSDK_OFFSET(0x975CA0)

namespace Dest::Math
{
	inline static constexpr unsigned int Capsule3_TypeDefinitionIndex = 31722;
