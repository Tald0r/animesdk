...
#define DEST_MATH_CAPSULE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9A8B50)
#define DEST_MATH_CAPSULE3__CTOR_OFFSET UNITYSDK_OFFSET(0x9A8B50)

namespace Dest::Math
{
	inline static constexpr unsigned int Capsule3_TypeDefinitionIndex = 32676;
