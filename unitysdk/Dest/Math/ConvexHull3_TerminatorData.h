...
#define DEST_MATH_CONVEXHULL3_TERMINATORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8B8C90)

namespace Dest::Math
{
	inline static constexpr unsigned int ConvexHull3_TerminatorData_TypeDefinitionIndex = 31622;
