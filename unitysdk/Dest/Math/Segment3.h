...
#define DEST_MATH_SEGMENT3_CALCCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0x8C2710)
#define DEST_MATH_SEGMENT3_CALCENDPOINTS_OFFSET UNITYSDK_OFFSET(0x8C27D0)
#define DEST_MATH_SEGMENT3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x8C2880)
#define DEST_MATH_SEGMENT3_EVAL_OFFSET UNITYSDK_OFFSET(0x8C2830)
#define DEST_MATH_SEGMENT3_PROJECT_OFFSET UNITYSDK_OFFSET(0x8C28C0)
#define DEST_MATH_SEGMENT3_SETCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0x8C26A0)
#define DEST_MATH_SEGMENT3_SETENDPOINTS_OFFSET UNITYSDK_OFFSET(0x8C25C0)
#define DEST_MATH_SEGMENT3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8C29B0)
#define DEST_MATH_SEGMENT3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8C23E0)
#define DEST_MATH_SEGMENT3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8C24D0)
#define DEST_MATH_SEGMENT3__CTOR_3_OFFSET UNITYSDK_OFFSET(0x8C2540)
#define DEST_MATH_SEGMENT3__CTOR_OFFSET UNITYSDK_OFFSET(0x8C2300)

namespace Dest::Math
{
	inline static constexpr unsigned int Segment3_TypeDefinitionIndex = 31730;
