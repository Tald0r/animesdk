...
#define DEST_MATH_SEGMENT3_CALCCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0x8EFFB0)
#define DEST_MATH_SEGMENT3_CALCENDPOINTS_OFFSET UNITYSDK_OFFSET(0x8F0070)
#define DEST_MATH_SEGMENT3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x8F0120)
#define DEST_MATH_SEGMENT3_EVAL_OFFSET UNITYSDK_OFFSET(0x8F00D0)
#define DEST_MATH_SEGMENT3_PROJECT_OFFSET UNITYSDK_OFFSET(0x8F0160)
#define DEST_MATH_SEGMENT3_SETCENTERDIRECTIONEXTENT_OFFSET UNITYSDK_OFFSET(0x8EFF40)
#define DEST_MATH_SEGMENT3_SETENDPOINTS_OFFSET UNITYSDK_OFFSET(0x8EFE60)
#define DEST_MATH_SEGMENT3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8F0250)
#define DEST_MATH_SEGMENT3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8EFC80)
#define DEST_MATH_SEGMENT3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x8EFD70)
#define DEST_MATH_SEGMENT3__CTOR_3_OFFSET UNITYSDK_OFFSET(0x8EFDE0)
#define DEST_MATH_SEGMENT3__CTOR_OFFSET UNITYSDK_OFFSET(0x8EFBA0)

namespace Dest::Math
{
	inline static constexpr unsigned int Segment3_TypeDefinitionIndex = 32684;
