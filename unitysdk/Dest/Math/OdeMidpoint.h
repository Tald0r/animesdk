...
#define DEST_MATH_ODEMIDPOINT_GET_STEP_OFFSET UNITYSDK_OFFSET(0x1B770D50)
#define DEST_MATH_ODEMIDPOINT_SET_STEP_OFFSET UNITYSDK_OFFSET(0x1B770D60)
#define DEST_MATH_ODEMIDPOINT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B770DE0)
#define DEST_MATH_ODEMIDPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B770D80)

namespace Dest::Math
{
	inline static constexpr unsigned int OdeMidpoint_TypeDefinitionIndex = 32660;
