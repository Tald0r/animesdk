...
#define DEST_MATH_ODEMIDPOINT_GET_STEP_OFFSET UNITYSDK_OFFSET(0x1B151DA0)
#define DEST_MATH_ODEMIDPOINT_SET_STEP_OFFSET UNITYSDK_OFFSET(0x1B151DB0)
#define DEST_MATH_ODEMIDPOINT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B151E30)
#define DEST_MATH_ODEMIDPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B151DD0)

namespace Dest::Math
{
	inline static constexpr unsigned int OdeMidpoint_TypeDefinitionIndex = 31706;
