...
#define DEST_MATH_CIRCLE2_CALCAREA_OFFSET UNITYSDK_OFFSET(0x94DEC0)
#define DEST_MATH_CIRCLE2_CALCPERIMETER_OFFSET UNITYSDK_OFFSET(0x94DEB0)
#define DEST_MATH_CIRCLE2_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x94E150)
#define DEST_MATH_CIRCLE2_CONTAINS_OFFSET UNITYSDK_OFFSET(0x94E120)
#define DEST_MATH_CIRCLE2_CREATECIRCUMSCRIBED_OFFSET UNITYSDK_OFFSET(0x1AB01070)
#define DEST_MATH_CIRCLE2_CREATEFROMPOINTSAAB_1_OFFSET UNITYSDK_OFFSET(0x1AB00410)
#define DEST_MATH_CIRCLE2_CREATEFROMPOINTSAAB_OFFSET UNITYSDK_OFFSET(0x1AB00180)
#define DEST_MATH_CIRCLE2_CREATEFROMPOINTSAVERAGE_1_OFFSET UNITYSDK_OFFSET(0x1AB00CD0)
#define DEST_MATH_CIRCLE2_CREATEFROMPOINTSAVERAGE_OFFSET UNITYSDK_OFFSET(0x1AB00580)
#define DEST_MATH_CIRCLE2_CREATEINSCRIBED_OFFSET UNITYSDK_OFFSET(0x1AB01310)
#define DEST_MATH_CIRCLE2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x94E020)
#define DEST_MATH_CIRCLE2_EVAL_1_OFFSET UNITYSDK_OFFSET(0x94DF90)
#define DEST_MATH_CIRCLE2_EVAL_OFFSET UNITYSDK_OFFSET(0x94DEE0)
#define DEST_MATH_CIRCLE2_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x94E290)
#define DEST_MATH_CIRCLE2_INCLUDE_OFFSET UNITYSDK_OFFSET(0x94E190)
#define DEST_MATH_CIRCLE2_PROJECT_OFFSET UNITYSDK_OFFSET(0x94E080)
#define DEST_MATH_CIRCLE2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x94E3A0)
#define DEST_MATH_CIRCLE2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2EB420)
#define DEST_MATH_CIRCLE2__CTOR_OFFSET UNITYSDK_OFFSET(0x94DEA0)

namespace Dest::Math
{
	inline static constexpr unsigned int Circle2_TypeDefinitionIndex = 32667;
