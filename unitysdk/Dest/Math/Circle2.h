...
#define DEST_MATH_CIRCLE2_CALCAREA_OFFSET UNITYSDK_OFFSET(0x920A10)
#define DEST_MATH_CIRCLE2_CALCPERIMETER_OFFSET UNITYSDK_OFFSET(0x920A00)
#define DEST_MATH_CIRCLE2_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x920CA0)
#define DEST_MATH_CIRCLE2_CONTAINS_OFFSET UNITYSDK_OFFSET(0x920C70)
#define DEST_MATH_CIRCLE2_CREATECIRCUMSCRIBED_OFFSET UNITYSDK_OFFSET(0x1A527570)
#define DEST_MATH_CIRCLE2_CREATEFROMPOINTSAAB_1_OFFSET UNITYSDK_OFFSET(0x1A526910)
#define DEST_MATH_CIRCLE2_CREATEFROMPOINTSAAB_OFFSET UNITYSDK_OFFSET(0x1A526680)
#define DEST_MATH_CIRCLE2_CREATEFROMPOINTSAVERAGE_1_OFFSET UNITYSDK_OFFSET(0x1A5271D0)
#define DEST_MATH_CIRCLE2_CREATEFROMPOINTSAVERAGE_OFFSET UNITYSDK_OFFSET(0x1A526A80)
#define DEST_MATH_CIRCLE2_CREATEINSCRIBED_OFFSET UNITYSDK_OFFSET(0x1A527810)
#define DEST_MATH_CIRCLE2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x920B70)
#define DEST_MATH_CIRCLE2_EVAL_1_OFFSET UNITYSDK_OFFSET(0x920AE0)
#define DEST_MATH_CIRCLE2_EVAL_OFFSET UNITYSDK_OFFSET(0x920A30)
#define DEST_MATH_CIRCLE2_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x920DE0)
#define DEST_MATH_CIRCLE2_INCLUDE_OFFSET UNITYSDK_OFFSET(0x920CE0)
#define DEST_MATH_CIRCLE2_PROJECT_OFFSET UNITYSDK_OFFSET(0x920BD0)
#define DEST_MATH_CIRCLE2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x920EF0)
#define DEST_MATH_CIRCLE2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x30B7B0)
#define DEST_MATH_CIRCLE2__CTOR_OFFSET UNITYSDK_OFFSET(0x9209F0)

namespace Dest::Math
{
	inline static constexpr unsigned int Circle2_TypeDefinitionIndex = 31713;
