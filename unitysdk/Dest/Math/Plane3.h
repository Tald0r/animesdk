...
#define DEST_MATH_PLANE3_ANGLEBETWEENPLANEANDLINE_1_OFFSET UNITYSDK_OFFSET(0x94F7D0)
#define DEST_MATH_PLANE3_ANGLEBETWEENPLANEANDLINE_OFFSET UNITYSDK_OFFSET(0x94F720)
#define DEST_MATH_PLANE3_ANGLEBETWEENPLANENORMALANDLINE_1_OFFSET UNITYSDK_OFFSET(0x94F620)
#define DEST_MATH_PLANE3_ANGLEBETWEENPLANENORMALANDLINE_OFFSET UNITYSDK_OFFSET(0x94F580)
#define DEST_MATH_PLANE3_ANGLEBETWEENTWOPLANES_OFFSET UNITYSDK_OFFSET(0x94F8E0)
#define DEST_MATH_PLANE3_CALCORIGIN_OFFSET UNITYSDK_OFFSET(0x3ABA30)
#define DEST_MATH_PLANE3_CREATEORTHONORMALBASIS_OFFSET UNITYSDK_OFFSET(0x94EB50)
#define DEST_MATH_PLANE3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x94ED20)
#define DEST_MATH_PLANE3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1A9DB7E0)
#define DEST_MATH_PLANE3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A9DB730)
#define DEST_MATH_PLANE3_PROJECTVECTOR_OFFSET UNITYSDK_OFFSET(0x94F4C0)
#define DEST_MATH_PLANE3_PROJECT_OFFSET UNITYSDK_OFFSET(0x94F400)
#define DEST_MATH_PLANE3_QUERYSIDENEGATIVE_1_OFFSET UNITYSDK_OFFSET(0x94EFB0)
#define DEST_MATH_PLANE3_QUERYSIDENEGATIVE_2_OFFSET UNITYSDK_OFFSET(0x94EFE0)
#define DEST_MATH_PLANE3_QUERYSIDENEGATIVE_3_OFFSET UNITYSDK_OFFSET(0x94F2A0)
#define DEST_MATH_PLANE3_QUERYSIDENEGATIVE_OFFSET UNITYSDK_OFFSET(0x94EE60)
#define DEST_MATH_PLANE3_QUERYSIDEPOSITIVE_1_OFFSET UNITYSDK_OFFSET(0x94EFC0)
#define DEST_MATH_PLANE3_QUERYSIDEPOSITIVE_2_OFFSET UNITYSDK_OFFSET(0x94F0E0)
#define DEST_MATH_PLANE3_QUERYSIDEPOSITIVE_3_OFFSET UNITYSDK_OFFSET(0x94F350)
#define DEST_MATH_PLANE3_QUERYSIDEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x94EF00)
#define DEST_MATH_PLANE3_QUERYSIDE_1_OFFSET UNITYSDK_OFFSET(0x94EFA0)
#define DEST_MATH_PLANE3_QUERYSIDE_2_OFFSET UNITYSDK_OFFSET(0x94EFD0)
#define DEST_MATH_PLANE3_QUERYSIDE_3_OFFSET UNITYSDK_OFFSET(0x94F1E0)
#define DEST_MATH_PLANE3_QUERYSIDE_OFFSET UNITYSDK_OFFSET(0x94EDB0)
#define DEST_MATH_PLANE3_SIGNEDDISTANCETO_1_OFFSET UNITYSDK_OFFSET(0x94ECA0)
#define DEST_MATH_PLANE3_SIGNEDDISTANCETO_OFFSET UNITYSDK_OFFSET(0x94ECA0)
#define DEST_MATH_PLANE3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x94F980)
#define DEST_MATH_PLANE3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x33FDB0)
#define DEST_MATH_PLANE3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x94E810)
#define DEST_MATH_PLANE3__CTOR_3_OFFSET UNITYSDK_OFFSET(0x94E8D0)
#define DEST_MATH_PLANE3__CTOR_4_OFFSET UNITYSDK_OFFSET(0x94E990)
#define DEST_MATH_PLANE3__CTOR_5_OFFSET UNITYSDK_OFFSET(0x94E9A0)
#define DEST_MATH_PLANE3__CTOR_OFFSET UNITYSDK_OFFSET(0x33FDB0)

namespace Dest::Math
{
	inline static constexpr unsigned int Plane3_TypeDefinitionIndex = 31725;
