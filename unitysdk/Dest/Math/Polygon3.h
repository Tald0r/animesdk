...
#define DEST_MATH_POLYGON3_CALCCENTER_OFFSET UNITYSDK_OFFSET(0x1AB06B40)
#define DEST_MATH_POLYGON3_CALCPERIMETER_OFFSET UNITYSDK_OFFSET(0x1AB06BF0)
#define DEST_MATH_POLYGON3_GETEDGE_OFFSET UNITYSDK_OFFSET(0x1AB06810)
#define DEST_MATH_POLYGON3_GET_EDGES_OFFSET UNITYSDK_OFFSET(0x1AB06070)
#define DEST_MATH_POLYGON3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AB049A0)
#define DEST_MATH_POLYGON3_GET_PLANE_OFFSET UNITYSDK_OFFSET(0x1AB060D0)
#define DEST_MATH_POLYGON3_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1AB04980)
#define DEST_MATH_POLYGON3_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1AB06060)
#define DEST_MATH_POLYGON3_HASZEROCORNERS_OFFSET UNITYSDK_OFFSET(0x1AB06CA0)
#define DEST_MATH_POLYGON3_PROJECTVERTICES_OFFSET UNITYSDK_OFFSET(0x1AB06680)
#define DEST_MATH_POLYGON3_REVERSEVERTICES_OFFSET UNITYSDK_OFFSET(0x1AB06D90)
#define DEST_MATH_POLYGON3_SETVERTEXPROJECTED_OFFSET UNITYSDK_OFFSET(0x1AB06570)
#define DEST_MATH_POLYGON3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AB06080)
#define DEST_MATH_POLYGON3_SET_PLANE_OFFSET UNITYSDK_OFFSET(0x1AB060E0)
#define DEST_MATH_POLYGON3_TOSEGMENTARRAY_OFFSET UNITYSDK_OFFSET(0x1AB06E90)
#define DEST_MATH_POLYGON3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AB070F0)
#define DEST_MATH_POLYGON3_UPDATEEDGES_OFFSET UNITYSDK_OFFSET(0x1AB06190)
#define DEST_MATH_POLYGON3_UPDATEEDGE_OFFSET UNITYSDK_OFFSET(0x1AB06870)
#define DEST_MATH_POLYGON3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AB06100)
#define DEST_MATH_POLYGON3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AB06500)
#define DEST_MATH_POLYGON3__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB060F0)

namespace Dest::Math
{
	inline static constexpr unsigned int Polygon3_TypeDefinitionIndex = 32681;
