...
#define DEST_MATH_POLYGON3_CALCCENTER_OFFSET UNITYSDK_OFFSET(0x1A52D070)
#define DEST_MATH_POLYGON3_CALCPERIMETER_OFFSET UNITYSDK_OFFSET(0x1A52D120)
#define DEST_MATH_POLYGON3_GETEDGE_OFFSET UNITYSDK_OFFSET(0x1A52CD40)
#define DEST_MATH_POLYGON3_GET_EDGES_OFFSET UNITYSDK_OFFSET(0x1A52C5A0)
#define DEST_MATH_POLYGON3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A52AED0)
#define DEST_MATH_POLYGON3_GET_PLANE_OFFSET UNITYSDK_OFFSET(0x1A52C600)
#define DEST_MATH_POLYGON3_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1A52AEB0)
#define DEST_MATH_POLYGON3_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1A52C590)
#define DEST_MATH_POLYGON3_HASZEROCORNERS_OFFSET UNITYSDK_OFFSET(0x1A52D1D0)
#define DEST_MATH_POLYGON3_PROJECTVERTICES_OFFSET UNITYSDK_OFFSET(0x1A52CBB0)
#define DEST_MATH_POLYGON3_REVERSEVERTICES_OFFSET UNITYSDK_OFFSET(0x1A52D2C0)
#define DEST_MATH_POLYGON3_SETVERTEXPROJECTED_OFFSET UNITYSDK_OFFSET(0x1A52CAA0)
#define DEST_MATH_POLYGON3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A52C5B0)
#define DEST_MATH_POLYGON3_SET_PLANE_OFFSET UNITYSDK_OFFSET(0x1A52C610)
#define DEST_MATH_POLYGON3_TOSEGMENTARRAY_OFFSET UNITYSDK_OFFSET(0x1A52D3C0)
#define DEST_MATH_POLYGON3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A52D620)
#define DEST_MATH_POLYGON3_UPDATEEDGES_OFFSET UNITYSDK_OFFSET(0x1A52C6C0)
#define DEST_MATH_POLYGON3_UPDATEEDGE_OFFSET UNITYSDK_OFFSET(0x1A52CDA0)
#define DEST_MATH_POLYGON3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A52C630)
#define DEST_MATH_POLYGON3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A52CA30)
#define DEST_MATH_POLYGON3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A52C620)

namespace Dest::Math
{
	inline static constexpr unsigned int Polygon3_TypeDefinitionIndex = 31727;
