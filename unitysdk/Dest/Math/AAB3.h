...
#define DEST_MATH_AAB3_CALCCENTEREXTENTS_OFFSET UNITYSDK_OFFSET(0x966320)
#define DEST_MATH_AAB3_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x966450)
#define DEST_MATH_AAB3_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x966460)
#define DEST_MATH_AAB3_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x966380)
#define DEST_MATH_AAB3_CALCVOLUME_OFFSET UNITYSDK_OFFSET(0x966470)
#define DEST_MATH_AAB3_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x966610)
#define DEST_MATH_AAB3_CONTAINS_OFFSET UNITYSDK_OFFSET(0x966610)
#define DEST_MATH_AAB3_CREATEFROMPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1ADEDBC0)
#define DEST_MATH_AAB3_CREATEFROMPOINTS_2_OFFSET UNITYSDK_OFFSET(0x1ADEDF20)
#define DEST_MATH_AAB3_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1ADED630)
#define DEST_MATH_AAB3_CREATEFROMPOINT_1_OFFSET UNITYSDK_OFFSET(0x1ADED440)
#define DEST_MATH_AAB3_CREATEFROMPOINT_OFFSET UNITYSDK_OFFSET(0x1ADED3F0)
#define DEST_MATH_AAB3_CREATEFROMTWOPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1ADED560)
#define DEST_MATH_AAB3_CREATEFROMTWOPOINTS_OFFSET UNITYSDK_OFFSET(0x1ADED490)
#define DEST_MATH_AAB3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9664A0)
#define DEST_MATH_AAB3_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x9666D0)
#define DEST_MATH_AAB3_INCLUDE_2_OFFSET UNITYSDK_OFFSET(0x966740)
#define DEST_MATH_AAB3_INCLUDE_3_OFFSET UNITYSDK_OFFSET(0x966810)
#define DEST_MATH_AAB3_INCLUDE_OFFSET UNITYSDK_OFFSET(0x966660)
#define DEST_MATH_AAB3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1ADED3B0)
#define DEST_MATH_AAB3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1ADED300)
#define DEST_MATH_AAB3_PROJECT_OFFSET UNITYSDK_OFFSET(0x966560)
#define DEST_MATH_AAB3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9668F0)
#define DEST_MATH_AAB3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x310080)
#define DEST_MATH_AAB3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9662E0)
#define DEST_MATH_AAB3__CTOR_OFFSET UNITYSDK_OFFSET(0x7ECAD0)

namespace Dest::Math
{
	inline static constexpr unsigned int AAB3_TypeDefinitionIndex = 31720;
