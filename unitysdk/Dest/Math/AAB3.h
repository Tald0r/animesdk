...
#define DEST_MATH_AAB3_CALCCENTEREXTENTS_OFFSET UNITYSDK_OFFSET(0x9972E0)
#define DEST_MATH_AAB3_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x997410)
#define DEST_MATH_AAB3_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x997420)
#define DEST_MATH_AAB3_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x997340)
#define DEST_MATH_AAB3_CALCVOLUME_OFFSET UNITYSDK_OFFSET(0x997430)
#define DEST_MATH_AAB3_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x9975D0)
#define DEST_MATH_AAB3_CONTAINS_OFFSET UNITYSDK_OFFSET(0x9975D0)
#define DEST_MATH_AAB3_CREATEFROMPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1B40E360)
#define DEST_MATH_AAB3_CREATEFROMPOINTS_2_OFFSET UNITYSDK_OFFSET(0x1B40E6C0)
#define DEST_MATH_AAB3_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1B40DDD0)
#define DEST_MATH_AAB3_CREATEFROMPOINT_1_OFFSET UNITYSDK_OFFSET(0x1B40DBE0)
#define DEST_MATH_AAB3_CREATEFROMPOINT_OFFSET UNITYSDK_OFFSET(0x1B40DB90)
#define DEST_MATH_AAB3_CREATEFROMTWOPOINTS_1_OFFSET UNITYSDK_OFFSET(0x1B40DD00)
#define DEST_MATH_AAB3_CREATEFROMTWOPOINTS_OFFSET UNITYSDK_OFFSET(0x1B40DC30)
#define DEST_MATH_AAB3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x997460)
#define DEST_MATH_AAB3_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x997690)
#define DEST_MATH_AAB3_INCLUDE_2_OFFSET UNITYSDK_OFFSET(0x997700)
#define DEST_MATH_AAB3_INCLUDE_3_OFFSET UNITYSDK_OFFSET(0x9977D0)
#define DEST_MATH_AAB3_INCLUDE_OFFSET UNITYSDK_OFFSET(0x997620)
#define DEST_MATH_AAB3_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B40DB50)
#define DEST_MATH_AAB3_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B40DAA0)
#define DEST_MATH_AAB3_PROJECT_OFFSET UNITYSDK_OFFSET(0x997520)
#define DEST_MATH_AAB3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9978B0)
#define DEST_MATH_AAB3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3889A0)
#define DEST_MATH_AAB3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9972A0)
#define DEST_MATH_AAB3__CTOR_OFFSET UNITYSDK_OFFSET(0x81D370)

namespace Dest::Math
{
	inline static constexpr unsigned int AAB3_TypeDefinitionIndex = 32674;
