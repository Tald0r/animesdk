...
#define DEST_MATH_BOX3_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x920870)
#define DEST_MATH_BOX3_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x920880)
#define DEST_MATH_BOX3_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x920860)
#define DEST_MATH_BOX3_CALCVOLUME_OFFSET UNITYSDK_OFFSET(0x920890)
#define DEST_MATH_BOX3_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x920960)
#define DEST_MATH_BOX3_CONTAINS_OFFSET UNITYSDK_OFFSET(0x920950)
#define DEST_MATH_BOX3_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1A524060)
#define DEST_MATH_BOX3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9208B0)
#define DEST_MATH_BOX3_GETAXIS_OFFSET UNITYSDK_OFFSET(0x9207F0)
#define DEST_MATH_BOX3_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x9209A0)
#define DEST_MATH_BOX3_INCLUDE_OFFSET UNITYSDK_OFFSET(0x920990)
#define DEST_MATH_BOX3_PROJECT_OFFSET UNITYSDK_OFFSET(0x9208F0)
#define DEST_MATH_BOX3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9209E0)
#define DEST_MATH_BOX3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2FEB10)
#define DEST_MATH_BOX3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x920660)
#define DEST_MATH_BOX3__CTOR_3_OFFSET UNITYSDK_OFFSET(0x920720)
#define DEST_MATH_BOX3__CTOR_OFFSET UNITYSDK_OFFSET(0x920610)

namespace Dest::Math
{
	inline static constexpr unsigned int Box3_TypeDefinitionIndex = 31721;
