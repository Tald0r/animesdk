...
#define DEST_MATH_BOX3_CALCVERTICES_1_OFFSET UNITYSDK_OFFSET(0x94DD20)
#define DEST_MATH_BOX3_CALCVERTICES_2_OFFSET UNITYSDK_OFFSET(0x94DD30)
#define DEST_MATH_BOX3_CALCVERTICES_OFFSET UNITYSDK_OFFSET(0x94DD10)
#define DEST_MATH_BOX3_CALCVOLUME_OFFSET UNITYSDK_OFFSET(0x94DD40)
#define DEST_MATH_BOX3_CONTAINS_1_OFFSET UNITYSDK_OFFSET(0x94DE10)
#define DEST_MATH_BOX3_CONTAINS_OFFSET UNITYSDK_OFFSET(0x94DE00)
#define DEST_MATH_BOX3_CREATEFROMPOINTS_OFFSET UNITYSDK_OFFSET(0x1AAFDB60)
#define DEST_MATH_BOX3_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x94DD60)
#define DEST_MATH_BOX3_GETAXIS_OFFSET UNITYSDK_OFFSET(0x94DCA0)
#define DEST_MATH_BOX3_INCLUDE_1_OFFSET UNITYSDK_OFFSET(0x94DE50)
#define DEST_MATH_BOX3_INCLUDE_OFFSET UNITYSDK_OFFSET(0x94DE40)
#define DEST_MATH_BOX3_PROJECT_OFFSET UNITYSDK_OFFSET(0x94DDA0)
#define DEST_MATH_BOX3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x94DE90)
#define DEST_MATH_BOX3__CTOR_1_OFFSET UNITYSDK_OFFSET(0x35AA60)
#define DEST_MATH_BOX3__CTOR_2_OFFSET UNITYSDK_OFFSET(0x94DB10)
#define DEST_MATH_BOX3__CTOR_3_OFFSET UNITYSDK_OFFSET(0x94DBD0)
#define DEST_MATH_BOX3__CTOR_OFFSET UNITYSDK_OFFSET(0x94DAC0)

namespace Dest::Math
{
	inline static constexpr unsigned int Box3_TypeDefinitionIndex = 32675;
