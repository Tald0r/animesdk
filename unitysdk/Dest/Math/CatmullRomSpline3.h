...
#define DEST_MATH_CATMULLROMSPLINE3_ADDVERTEXFIRST_OFFSET UNITYSDK_OFFSET(0x1AE5FEB0)
#define DEST_MATH_CATMULLROMSPLINE3_ADDVERTEXLAST_OFFSET UNITYSDK_OFFSET(0x1AE5FFF0)
#define DEST_MATH_CATMULLROMSPLINE3_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AE60120)
#define DEST_MATH_CATMULLROMSPLINE3_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1AE5F730)
#define DEST_MATH_CATMULLROMSPLINE3_CREATE_OFFSET UNITYSDK_OFFSET(0x1AE5F6B0)
#define DEST_MATH_CATMULLROMSPLINE3_GETVERTEX_OFFSET UNITYSDK_OFFSET(0x1AE60210)
#define DEST_MATH_CATMULLROMSPLINE3_GET_SPLINETYPE_OFFSET UNITYSDK_OFFSET(0x1AE5F560)
#define DEST_MATH_CATMULLROMSPLINE3_INSERTAFTER_OFFSET UNITYSDK_OFFSET(0x1AE60170)
#define DEST_MATH_CATMULLROMSPLINE3_INSERTBEFORE_OFFSET UNITYSDK_OFFSET(0x1AE5FF50)
#define DEST_MATH_CATMULLROMSPLINE3_REMOVEVERTEX_OFFSET UNITYSDK_OFFSET(0x1AE60090)
#define DEST_MATH_CATMULLROMSPLINE3_SETVERTEX_OFFSET UNITYSDK_OFFSET(0x1AE60290)
#define DEST_MATH_CATMULLROMSPLINE3_SET_SPLINETYPE_OFFSET UNITYSDK_OFFSET(0x1AE5F570)
#define DEST_MATH_CATMULLROMSPLINE3_UPDATEADJACENTSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1AE5F5C0)
#define DEST_MATH_CATMULLROMSPLINE3_UPDATESEGMENT_OFFSET UNITYSDK_OFFSET(0x1AE5FB20)
#define DEST_MATH_CATMULLROMSPLINE3__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE60320)

namespace Dest::Math
{
	inline static constexpr unsigned int CatmullRomSpline3_TypeDefinitionIndex = 32692;
