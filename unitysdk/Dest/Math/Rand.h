...
#define DEST_MATH_RAND_GETSTATE_OFFSET UNITYSDK_OFFSET(0x1B01B4C0)
#define DEST_MATH_RAND_INCIRCLE_1_OFFSET UNITYSDK_OFFSET(0x1B01ABB0)
#define DEST_MATH_RAND_INCIRCLE_OFFSET UNITYSDK_OFFSET(0x1B01CDB0)
#define DEST_MATH_RAND_INCUBE_OFFSET UNITYSDK_OFFSET(0x1B01C180)
#define DEST_MATH_RAND_INSPHERE_OFFSET UNITYSDK_OFFSET(0x1B01CF70)
#define DEST_MATH_RAND_INSQUARE_OFFSET UNITYSDK_OFFSET(0x1B01BBA0)
#define DEST_MATH_RAND_INTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x1B01D370)
#define DEST_MATH_RAND_INTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1B01D240)
#define DEST_MATH_RAND_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x1B01B7B0)
#define DEST_MATH_RAND_NEXTBYTE_OFFSET UNITYSDK_OFFSET(0x1B01B7F0)
#define DEST_MATH_RAND_NEXTDOUBLE_1_OFFSET UNITYSDK_OFFSET(0x1B01B6A0)
#define DEST_MATH_RAND_NEXTDOUBLE_OFFSET UNITYSDK_OFFSET(0x1B01B660)
#define DEST_MATH_RAND_NEXTFLOAT_1_OFFSET UNITYSDK_OFFSET(0x1B01B0E0)
#define DEST_MATH_RAND_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x1B01B770)
#define DEST_MATH_RAND_NEXTINTINCLUSIVE_OFFSET UNITYSDK_OFFSET(0x1B01B5E0)
#define DEST_MATH_RAND_NEXTINT_1_OFFSET UNITYSDK_OFFSET(0x1B01B1A0)
#define DEST_MATH_RAND_NEXTINT_2_OFFSET UNITYSDK_OFFSET(0x1B01B500)
#define DEST_MATH_RAND_NEXTINT_OFFSET UNITYSDK_OFFSET(0x1B01B470)
#define DEST_MATH_RAND_NEXTPOSITIVEINT_OFFSET UNITYSDK_OFFSET(0x1B01B5F0)
#define DEST_MATH_RAND_NEXTUINT_OFFSET UNITYSDK_OFFSET(0x1B01B630)
#define DEST_MATH_RAND_ONCIRCLE_OFFSET UNITYSDK_OFFSET(0x1B01CEC0)
#define DEST_MATH_RAND_ONCUBE_OFFSET UNITYSDK_OFFSET(0x1B01C3C0)
#define DEST_MATH_RAND_ONSPHERE_OFFSET UNITYSDK_OFFSET(0x1B01D100)
#define DEST_MATH_RAND_ONSQUARE_OFFSET UNITYSDK_OFFSET(0x1B01BD30)
#define DEST_MATH_RAND_RANDOMANGLEDEGREES_OFFSET UNITYSDK_OFFSET(0x1B01BB50)
#define DEST_MATH_RAND_RANDOMANGLERADIANS_OFFSET UNITYSDK_OFFSET(0x1B01BB00)
#define DEST_MATH_RAND_RANDOMCOLOR32OPAQUE_OFFSET UNITYSDK_OFFSET(0x1B01B9C0)
#define DEST_MATH_RAND_RANDOMCOLOR32TRANSPARENT_OFFSET UNITYSDK_OFFSET(0x1B01BA50)
#define DEST_MATH_RAND_RANDOMCOLOROPAQUE_OFFSET UNITYSDK_OFFSET(0x1B01B820)
#define DEST_MATH_RAND_RANDOMCOLORTRANSPARENT_OFFSET UNITYSDK_OFFSET(0x1B01B8E0)
#define DEST_MATH_RAND_RANDOMROTATION_OFFSET UNITYSDK_OFFSET(0x1B01D4A0)
#define DEST_MATH_RAND_RESETSEED_OFFSET UNITYSDK_OFFSET(0x1B01B4A0)
#define DEST_MATH_RAND_SETSTATE_OFFSET UNITYSDK_OFFSET(0x1B01B4E0)
#define DEST_MATH_RAND__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B01B1F0)
#define DEST_MATH_RAND__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B01B370)
#define DEST_MATH_RAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B01B390)

namespace Dest::Math
{
	inline static constexpr unsigned int Rand_TypeDefinitionIndex = 31690;
	...
	public:
		...
		{
			return (::Dest::Math::Rand**)Il2CppClass::FromTypeDefinitionIndex(Rand_TypeDefinitionIndex)->GetStaticField(0x23C50);
		}
		static ::Dest::Math::Rand** StaticGet__seedGenerator()
		{
			return (::Dest::Math::Rand**)Il2CppClass::FromTypeDefinitionIndex(Rand_TypeDefinitionIndex)->GetStaticField(0x23C58);
		}
