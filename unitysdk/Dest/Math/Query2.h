...
#define DEST_MATH_QUERY2_DET2_OFFSET UNITYSDK_OFFSET(0x1B100460)
#define DEST_MATH_QUERY2_DET3_OFFSET UNITYSDK_OFFSET(0x1B100850)
#define DEST_MATH_QUERY2_DOT_OFFSET UNITYSDK_OFFSET(0x1B1008E0)
#define DEST_MATH_QUERY2_TOCIRCUMCIRCLE_1_OFFSET UNITYSDK_OFFSET(0x1B100630)
#define DEST_MATH_QUERY2_TOCIRCUMCIRCLE_OFFSET UNITYSDK_OFFSET(0x1B1005F0)
#define DEST_MATH_QUERY2_TOLINE_1_OFFSET UNITYSDK_OFFSET(0x1B100360)
#define DEST_MATH_QUERY2_TOLINE_OFFSET UNITYSDK_OFFSET(0x1B100320)
#define DEST_MATH_QUERY2_TOTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x1B100550)
#define DEST_MATH_QUERY2_TOTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1B100480)
#define DEST_MATH_QUERY2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B100900)
#define DEST_MATH_QUERY2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B100310)

namespace Dest::Math
{
	inline static constexpr unsigned int Query2_TypeDefinitionIndex = 31734;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Query2_TypeDefinitionIndex)->GetStaticField(0x7D40);
		}
