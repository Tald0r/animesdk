...
#define DEST_MATH_QUERY2_DET2_OFFSET UNITYSDK_OFFSET(0x1B719410)
#define DEST_MATH_QUERY2_DET3_OFFSET UNITYSDK_OFFSET(0x1B719800)
#define DEST_MATH_QUERY2_DOT_OFFSET UNITYSDK_OFFSET(0x1B719890)
#define DEST_MATH_QUERY2_TOCIRCUMCIRCLE_1_OFFSET UNITYSDK_OFFSET(0x1B7195E0)
#define DEST_MATH_QUERY2_TOCIRCUMCIRCLE_OFFSET UNITYSDK_OFFSET(0x1B7195A0)
#define DEST_MATH_QUERY2_TOLINE_1_OFFSET UNITYSDK_OFFSET(0x1B719310)
#define DEST_MATH_QUERY2_TOLINE_OFFSET UNITYSDK_OFFSET(0x1B7192D0)
#define DEST_MATH_QUERY2_TOTRIANGLE_1_OFFSET UNITYSDK_OFFSET(0x1B719500)
#define DEST_MATH_QUERY2_TOTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1B719430)
#define DEST_MATH_QUERY2__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B7198B0)
#define DEST_MATH_QUERY2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7192C0)

namespace Dest::Math
{
	inline static constexpr unsigned int Query2_TypeDefinitionIndex = 32688;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(Query2_TypeDefinitionIndex)->GetStaticField(0x8070);
		}
