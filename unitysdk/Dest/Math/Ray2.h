...
#define DEST_MATH_RAY2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x977520)
#define DEST_MATH_RAY2_EVAL_OFFSET UNITYSDK_OFFSET(0x9774F0)
#define DEST_MATH_RAY2_PROJECT_OFFSET UNITYSDK_OFFSET(0x977680)
#define DEST_MATH_RAY2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x977770)
#define DEST_MATH_RAY2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2D6E20)
#define DEST_MATH_RAY2__CTOR_OFFSET UNITYSDK_OFFSET(0x5A4C40)

namespace Dest::Math
{
	inline static constexpr unsigned int Ray2_TypeDefinitionIndex = 31717;
