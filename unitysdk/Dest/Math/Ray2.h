...
#define DEST_MATH_RAY2_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x9AA350)
#define DEST_MATH_RAY2_EVAL_OFFSET UNITYSDK_OFFSET(0x9AA320)
#define DEST_MATH_RAY2_PROJECT_OFFSET UNITYSDK_OFFSET(0x9AA4B0)
#define DEST_MATH_RAY2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9AA5A0)
#define DEST_MATH_RAY2__CTOR_1_OFFSET UNITYSDK_OFFSET(0x301710)
#define DEST_MATH_RAY2__CTOR_OFFSET UNITYSDK_OFFSET(0x586F10)

namespace Dest::Math
{
	inline static constexpr unsigned int Ray2_TypeDefinitionIndex = 32671;
