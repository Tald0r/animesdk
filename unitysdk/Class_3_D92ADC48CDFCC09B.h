...
#define CLASS_3_D92ADC48CDFCC09B_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x198D0240)
#define CLASS_3_D92ADC48CDFCC09B_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x198D02B0)
#define CLASS_3_D92ADC48CDFCC09B_INVOKE_OFFSET UNITYSDK_OFFSET(0x198CFF00)
#define CLASS_3_D92ADC48CDFCC09B__CTOR_OFFSET UNITYSDK_OFFSET(0x198C9FC0)

inline static constexpr unsigned int Class_3_D92ADC48CDFCC09B_TypeDefinitionIndex = 31504;
