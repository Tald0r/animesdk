...
#define UIHIDEITEMMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x15AC03B0)
#define UIHIDEITEMMANAGER_HANDLESETUPUIANIMLENGTHMAX_OFFSET UNITYSDK_OFFSET(0x15AC1380)
#define UIHIDEITEMMANAGER_HANDLESETUPUIFINISHCB_OFFSET UNITYSDK_OFFSET(0x15AC1440)
#define UIHIDEITEMMANAGER_INTERRUPTSETUPUIBYTYPE_OFFSET UNITYSDK_OFFSET(0x15AC3110)
#define UIHIDEITEMMANAGER_INTERRUPTSETUPUI_OFFSET UNITYSDK_OFFSET(0x15AC2D60)
#define UIHIDEITEMMANAGER_ISITEMSHOW_OFFSET UNITYSDK_OFFSET(0x15AC3590)
#define UIHIDEITEMMANAGER_POP_OFFSET UNITYSDK_OFFSET(0x15AC0830)
#define UIHIDEITEMMANAGER_PUSH_OFFSET UNITYSDK_OFFSET(0x15AC04E0)
#define UIHIDEITEMMANAGER_RESETHIDEITEMS_OFFSET UNITYSDK_OFFSET(0x15AC36C0)
#define UIHIDEITEMMANAGER_SETUPUIBYACTION_OFFSET UNITYSDK_OFFSET(0x15AC1CD0)
#define UIHIDEITEMMANAGER_SETUPUIBYZONE_OFFSET UNITYSDK_OFFSET(0x15AC2C70)
#define UIHIDEITEMMANAGER_SETUPUI_1_OFFSET UNITYSDK_OFFSET(0x15AC1510)
#define UIHIDEITEMMANAGER_SETUPUI_2_OFFSET UNITYSDK_OFFSET(0x15AC1D80)
#define UIHIDEITEMMANAGER_SETUPUI_OFFSET UNITYSDK_OFFSET(0x15AC0A40)
#define UIHIDEITEMMANAGER_TRYGETHIDEITEM_OFFSET UNITYSDK_OFFSET(0x15AC3940)
#define UIHIDEITEMMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x15AC0460)

inline static constexpr unsigned int UIHideItemManager_TypeDefinitionIndex = 54236;
...
public:
	...
	{
		return (::UIHideItemManager**)Il2CppClass::FromTypeDefinitionIndex(UIHideItemManager_TypeDefinitionIndex)->GetStaticField(0x3DF60);
	}
	...
	::System::Void SetupUIByAction(::Class_3_81AF99C8F468D858* setupUIAction, ::System::Action* setupFinishCB)
	{
		return ((::System::Void(*)(::PVOID, ::Class_3_81AF99C8F468D858*, ::System::Action*))((::PBYTE)hIl2Cpp + UIHIDEITEMMANAGER_SETUPUIBYACTION_OFFSET))(this, setupUIAction, setupFinishCB);
	}
