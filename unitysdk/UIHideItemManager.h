...
#define UIHIDEITEMMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x15F5D0E0)
#define UIHIDEITEMMANAGER_HANDLESETUPUIANIMLENGTHMAX_OFFSET UNITYSDK_OFFSET(0x15F5E0B0)
#define UIHIDEITEMMANAGER_HANDLESETUPUIFINISHCB_OFFSET UNITYSDK_OFFSET(0x15F5E170)
#define UIHIDEITEMMANAGER_INTERRUPTSETUPUIBYTYPE_OFFSET UNITYSDK_OFFSET(0x15F5FE40)
#define UIHIDEITEMMANAGER_INTERRUPTSETUPUI_OFFSET UNITYSDK_OFFSET(0x15F5FA90)
#define UIHIDEITEMMANAGER_ISITEMSHOW_OFFSET UNITYSDK_OFFSET(0x15F602C0)
#define UIHIDEITEMMANAGER_POP_OFFSET UNITYSDK_OFFSET(0x15F5D560)
#define UIHIDEITEMMANAGER_PUSH_OFFSET UNITYSDK_OFFSET(0x15F5D210)
#define UIHIDEITEMMANAGER_RESETHIDEITEMS_OFFSET UNITYSDK_OFFSET(0x15F603F0)
#define UIHIDEITEMMANAGER_SETUPUIBYACTION_OFFSET UNITYSDK_OFFSET(0x15F5EA00)
#define UIHIDEITEMMANAGER_SETUPUIBYZONE_OFFSET UNITYSDK_OFFSET(0x15F5F9A0)
#define UIHIDEITEMMANAGER_SETUPUI_1_OFFSET UNITYSDK_OFFSET(0x15F5E240)
#define UIHIDEITEMMANAGER_SETUPUI_2_OFFSET UNITYSDK_OFFSET(0x15F5EAB0)
#define UIHIDEITEMMANAGER_SETUPUI_OFFSET UNITYSDK_OFFSET(0x15F5D770)
#define UIHIDEITEMMANAGER_TRYGETHIDEITEM_OFFSET UNITYSDK_OFFSET(0x15F60670)
#define UIHIDEITEMMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F5D190)

inline static constexpr unsigned int UIHideItemManager_TypeDefinitionIndex = 68328;
...
public:
	...
	{
		return (::UIHideItemManager**)Il2CppClass::FromTypeDefinitionIndex(UIHideItemManager_TypeDefinitionIndex)->GetStaticField(0x3AFD0);
	}
