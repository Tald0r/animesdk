...
#define ARA_ARATRAIL_ADD_ONUPDATEPOINTS_OFFSET UNITYSDK_OFFSET(0x1B1AC140)
#define ARA_ARATRAIL_APPENDFLATTRAIL_OFFSET UNITYSDK_OFFSET(0x1B1B17D0)
#define ARA_ARATRAIL_APPENDSECTION_OFFSET UNITYSDK_OFFSET(0x1B1B1210)
#define ARA_ARATRAIL_ATTACHTOCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x1B1AC570)
#define ARA_ARATRAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B1AC460)
#define ARA_ARATRAIL_CLEARMESHDATA_OFFSET UNITYSDK_OFFSET(0x1B1ADCA0)
#define ARA_ARATRAIL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B1AC740)
#define ARA_ARATRAIL_COMMITMESHDATA_OFFSET UNITYSDK_OFFSET(0x1B1ADE00)
#define ARA_ARATRAIL_DETACHFROMCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x1B1AC680)
#define ARA_ARATRAIL_EMISSIONSTEP_OFFSET UNITYSDK_OFFSET(0x1B1AC930)
#define ARA_ARATRAIL_EMITPOINT_OFFSET UNITYSDK_OFFSET(0x1B1AD4F0)
#define ARA_ARATRAIL_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1B1ADBE0)
#define ARA_ARATRAIL_GETLENGHT_OFFSET UNITYSDK_OFFSET(0x1B1AE470)
#define ARA_ARATRAIL_GETRENDERABLEPOINTS_OFFSET UNITYSDK_OFFSET(0x1B1AE570)
#define ARA_ARATRAIL_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x1B1AC240)
#define ARA_ARATRAIL_GET_FIXEDDELTATIME_OFFSET UNITYSDK_OFFSET(0x1B1AC260)
#define ARA_ARATRAIL_GET_MESH_OFFSET UNITYSDK_OFFSET(0x1B1AC280)
#define ARA_ARATRAIL_GET_VELOCITY_OFFSET UNITYSDK_OFFSET(0x1B1AC220)
#define ARA_ARATRAIL_GET_WORLDTOTRAIL_OFFSET UNITYSDK_OFFSET(0x1B1AC290)
#define ARA_ARATRAIL_INITIALIZECURVEFRAME_OFFSET UNITYSDK_OFFSET(0x1B1AF610)
#define ARA_ARATRAIL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B1AC8D0)
#define ARA_ARATRAIL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B1ABF90)
#define ARA_ARATRAIL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B1ABE00)
#define ARA_ARATRAIL_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B1AC0A0)
#define ARA_ARATRAIL_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1B1AC0D0)
#define ARA_ARATRAIL_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1B1AC040)
#define ARA_ARATRAIL_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1B1ABE70)
#define ARA_ARATRAIL_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B1AC430)
#define ARA_ARATRAIL_PHYSICSSTEP_OFFSET UNITYSDK_OFFSET(0x1B1ADA90)
#define ARA_ARATRAIL_REMOVE_ONUPDATEPOINTS_OFFSET UNITYSDK_OFFSET(0x1B1AC1B0)
#define ARA_ARATRAIL_RENDERMESH_OFFSET UNITYSDK_OFFSET(0x1B1AE170)
#define ARA_ARATRAIL_SNAPLASTPOINTTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B1ACB40)
#define ARA_ARATRAIL_UPDATEPOINTSLIFECYCLE_OFFSET UNITYSDK_OFFSET(0x1B1AD270)
#define ARA_ARATRAIL_UPDATESEGMENTMESH_OFFSET UNITYSDK_OFFSET(0x1B1B0130)
#define ARA_ARATRAIL_UPDATETRAILMESH_OFFSET UNITYSDK_OFFSET(0x1B1AFDB0)
#define ARA_ARATRAIL_UPDATEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1B1AC770)
#define ARA_ARATRAIL_WARMUP_OFFSET UNITYSDK_OFFSET(0x1B1AC470)
#define ARA_ARATRAIL__ATTACHTOCAMERARENDERING_B__88_0_OFFSET UNITYSDK_OFFSET(0x1B1B2C90)
#define ARA_ARATRAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B27F0)

namespace Ara
{
	inline static constexpr unsigned int AraTrail_TypeDefinitionIndex = 30841;
