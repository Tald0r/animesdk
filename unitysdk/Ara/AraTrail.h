...
#define ARA_ARATRAIL_ADD_ONUPDATEPOINTS_OFFSET UNITYSDK_OFFSET(0x1AB9DC60)
#define ARA_ARATRAIL_APPENDFLATTRAIL_OFFSET UNITYSDK_OFFSET(0x1ABA3470)
#define ARA_ARATRAIL_APPENDSECTION_OFFSET UNITYSDK_OFFSET(0x1ABA2EB0)
#define ARA_ARATRAIL_ATTACHTOCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x1AB9E1B0)
#define ARA_ARATRAIL_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AB9DF80)
#define ARA_ARATRAIL_CLEARMESHDATA_OFFSET UNITYSDK_OFFSET(0x1AB9F940)
#define ARA_ARATRAIL_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AB9E3E0)
#define ARA_ARATRAIL_COMMITMESHDATA_OFFSET UNITYSDK_OFFSET(0x1AB9FAA0)
#define ARA_ARATRAIL_DETACHFROMCAMERARENDERING_OFFSET UNITYSDK_OFFSET(0x1AB9E320)
#define ARA_ARATRAIL_EMISSIONSTEP_OFFSET UNITYSDK_OFFSET(0x1AB9E5D0)
#define ARA_ARATRAIL_EMITPOINT_OFFSET UNITYSDK_OFFSET(0x1AB9F190)
#define ARA_ARATRAIL_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB9F880)
#define ARA_ARATRAIL_GETLENGHT_OFFSET UNITYSDK_OFFSET(0x1ABA0110)
#define ARA_ARATRAIL_GETRENDERABLEPOINTS_OFFSET UNITYSDK_OFFSET(0x1ABA0210)
#define ARA_ARATRAIL_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x1AB9DD60)
#define ARA_ARATRAIL_GET_FIXEDDELTATIME_OFFSET UNITYSDK_OFFSET(0x1AB9DD80)
#define ARA_ARATRAIL_GET_MESH_OFFSET UNITYSDK_OFFSET(0x1AB9DDA0)
#define ARA_ARATRAIL_GET_VELOCITY_OFFSET UNITYSDK_OFFSET(0x1AB9DD40)
#define ARA_ARATRAIL_GET_WORLDTOTRAIL_OFFSET UNITYSDK_OFFSET(0x1AB9DDB0)
#define ARA_ARATRAIL_INITIALIZECURVEFRAME_OFFSET UNITYSDK_OFFSET(0x1ABA12B0)
#define ARA_ARATRAIL_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB9E570)
#define ARA_ARATRAIL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AB9E2C0)
#define ARA_ARATRAIL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AB9E090)
#define ARA_ARATRAIL_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AB9DF50)
#define ARA_ARATRAIL_PHYSICSSTEP_OFFSET UNITYSDK_OFFSET(0x1AB9F730)
#define ARA_ARATRAIL_REMOVE_ONUPDATEPOINTS_OFFSET UNITYSDK_OFFSET(0x1AB9DCD0)
#define ARA_ARATRAIL_RENDERMESH_OFFSET UNITYSDK_OFFSET(0x1AB9FE10)
#define ARA_ARATRAIL_SNAPLASTPOINTTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AB9E7E0)
#define ARA_ARATRAIL_UPDATEPOINTSLIFECYCLE_OFFSET UNITYSDK_OFFSET(0x1AB9EF10)
#define ARA_ARATRAIL_UPDATESEGMENTMESH_OFFSET UNITYSDK_OFFSET(0x1ABA1DD0)
#define ARA_ARATRAIL_UPDATETRAILMESH_OFFSET UNITYSDK_OFFSET(0x1ABA1A50)
#define ARA_ARATRAIL_UPDATEVELOCITY_OFFSET UNITYSDK_OFFSET(0x1AB9E410)
#define ARA_ARATRAIL_WARMUP_OFFSET UNITYSDK_OFFSET(0x1AB9DF90)
#define ARA_ARATRAIL__ATTACHTOCAMERARENDERING_B__84_0_OFFSET UNITYSDK_OFFSET(0x1ABA4930)
#define ARA_ARATRAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA4490)

namespace Ara
{
	inline static constexpr unsigned int AraTrail_TypeDefinitionIndex = 29888;
	...
	public:
		...
		::System::Void _AttachToCameraRendering_b__84_0(::UnityEngine::Rendering::ScriptableRenderContext cntxt, ::UnityEngine::Camera* cam)
		{
			return ((::System::Void(*)(::PVOID, ::UnityEngine::Rendering::ScriptableRenderContext, ::UnityEngine::Camera*))((::PBYTE)hIl2Cpp + ARA_ARATRAIL__ATTACHTOCAMERARENDERING_B__84_0_OFFSET))(this, cntxt, cam);
		}
	};
}
