...
#define ARA_ARATRAIL_POINT_CATMULLROM_OFFSET UNITYSDK_OFFSET(0x1B1AF560)
#define ARA_ARATRAIL_POINT_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1B1B2CA0)
#define ARA_ARATRAIL_POINT_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1B1B2D10)
#define ARA_ARATRAIL_POINT__CTOR_OFFSET UNITYSDK_OFFSET(0x98E540)

namespace Ara
{
	inline static constexpr unsigned int AraTrail_Point_TypeDefinitionIndex = 30848;
