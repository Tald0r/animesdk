...
#define ARA_ARATRAIL_POINT_CATMULLROM_OFFSET UNITYSDK_OFFSET(0x1ABA1200)
#define ARA_ARATRAIL_POINT_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1ABA4940)
#define ARA_ARATRAIL_POINT_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1ABA49B0)
#define ARA_ARATRAIL_POINT__CTOR_OFFSET UNITYSDK_OFFSET(0x95BBD0)

namespace Ara
{
	inline static constexpr unsigned int AraTrail_Point_TypeDefinitionIndex = 29895;
