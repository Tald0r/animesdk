...
#define ARA_COLORFROMSPEED_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1ABA4B40)
#define ARA_COLORFROMSPEED_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ABA4A20)
#define ARA_COLORFROMSPEED_SETCOLORFROMSPEED_OFFSET UNITYSDK_OFFSET(0x1ABA4BF0)
#define ARA_COLORFROMSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA4E80)

namespace Ara
{
	inline static constexpr unsigned int ColorFromSpeed_TypeDefinitionIndex = 29898;
