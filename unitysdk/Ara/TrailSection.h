...
#define ARA_TRAILSECTION_CIRCLEPRESET_OFFSET UNITYSDK_OFFSET(0x1B1B3D30)
#define ARA_TRAILSECTION_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x1B1B27D0)
#define ARA_TRAILSECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B1B3CC0)
#define ARA_TRAILSECTION_SNAPTO_OFFSET UNITYSDK_OFFSET(0x1B1B3E50)
#define ARA_TRAILSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B3EA0)

namespace Ara
{
	inline static constexpr unsigned int TrailSection_TypeDefinitionIndex = 30854;
