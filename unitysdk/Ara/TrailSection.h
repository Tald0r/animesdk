...
#define ARA_TRAILSECTION_CIRCLEPRESET_OFFSET UNITYSDK_OFFSET(0x1ABA59D0)
#define ARA_TRAILSECTION_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x1ABA4470)
#define ARA_TRAILSECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ABA5960)
#define ARA_TRAILSECTION_SNAPTO_OFFSET UNITYSDK_OFFSET(0x1ABA5AF0)
#define ARA_TRAILSECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABA5B40)

namespace Ara
{
	inline static constexpr unsigned int TrailSection_TypeDefinitionIndex = 29901;
