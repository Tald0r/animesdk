...
#define NAVMESHLISTITEMCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x77DEDE0)
#define NAVMESHLISTITEMCONTROLLER_ONNAMECHANGED_OFFSET UNITYSDK_OFFSET(0x77DF3D0)
#define NAVMESHLISTITEMCONTROLLER_ONNAVMESHDATADROPPED_OFFSET UNITYSDK_OFFSET(0x77DF5A0)
#define NAVMESHLISTITEMCONTROLLER_ONREMOVECLICKED_OFFSET UNITYSDK_OFFSET(0x77DF530)
#define NAVMESHLISTITEMCONTROLLER_ONTOGGLECHANGED_OFFSET UNITYSDK_OFFSET(0x77DF480)
#define NAVMESHLISTITEMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x77DF700)

inline static constexpr unsigned int NavMeshListItemController_TypeDefinitionIndex = 62956;
