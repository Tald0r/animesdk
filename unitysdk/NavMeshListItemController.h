...
#define NAVMESHLISTITEMCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0xC300D10)
#define NAVMESHLISTITEMCONTROLLER_ONNAMECHANGED_OFFSET UNITYSDK_OFFSET(0xC301300)
#define NAVMESHLISTITEMCONTROLLER_ONNAVMESHDATADROPPED_OFFSET UNITYSDK_OFFSET(0xC3014D0)
#define NAVMESHLISTITEMCONTROLLER_ONREMOVECLICKED_OFFSET UNITYSDK_OFFSET(0xC301460)
#define NAVMESHLISTITEMCONTROLLER_ONTOGGLECHANGED_OFFSET UNITYSDK_OFFSET(0xC3013B0)
#define NAVMESHLISTITEMCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0xC301630)

inline static constexpr unsigned int NavMeshListItemController_TypeDefinitionIndex = 47812;
