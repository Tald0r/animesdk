...
#define CLASS_2_EC5A7AD641CF932C_STRUCT_2_AEC7FD40056C4691_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x319950)
#define CLASS_2_EC5A7AD641CF932C_STRUCT_2_AEC7FD40056C4691_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

inline static constexpr unsigned int Class_2_EC5A7AD641CF932C_Struct_2_AEC7FD40056C4691_TypeDefinitionIndex = 69930;

struct alignas(8) Class_2_EC5A7AD641CF932C_Struct_2_AEC7FD40056C4691
{
	::System::Func_1<::PipelineCamera::WorldBasicCameraData>* Field_2_2; // 0x10
	::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::Int32> Field_2_4; // 0x18
	::Class_2_EC5A7AD641CF932C* Field_2_3; // 0x28
