...
#define PUSHBOXPLAYERVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x1664B4A0)
#define PUSHBOXPLAYERVIEW_GETWORLDLOCALPOS_OFFSET UNITYSDK_OFFSET(0x1664BC30)
#define PUSHBOXPLAYERVIEW_GET_SELFGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1664BEE0)
#define PUSHBOXPLAYERVIEW_GET_SELFTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1664BE10)
#define PUSHBOXPLAYERVIEW_INIT_OFFSET UNITYSDK_OFFSET(0x1664B520)
#define PUSHBOXPLAYERVIEW_PLAYTEXTURE_OFFSET UNITYSDK_OFFSET(0x1664B600)
#define PUSHBOXPLAYERVIEW_RESET_OFFSET UNITYSDK_OFFSET(0x1664BFB0)
#define PUSHBOXPLAYERVIEW_SETAPPEARANCE_OFFSET UNITYSDK_OFFSET(0x1664B830)
#define PUSHBOXPLAYERVIEW_SETWORLDLOCALPOS_OFFSET UNITYSDK_OFFSET(0x1664BB80)
#define PUSHBOXPLAYERVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1664BD00)
#define PUSHBOXPLAYERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1664C010)

inline static constexpr unsigned int PushBoxPlayerView_TypeDefinitionIndex = 73353;
