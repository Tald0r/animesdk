...
#define PUSHBOXPLAYERVIEW_AWAKE_OFFSET UNITYSDK_OFFSET(0x185398C0)
#define PUSHBOXPLAYERVIEW_GETWORLDLOCALPOS_OFFSET UNITYSDK_OFFSET(0x1853A050)
#define PUSHBOXPLAYERVIEW_GET_SELFGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1853A300)
#define PUSHBOXPLAYERVIEW_GET_SELFTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1853A230)
#define PUSHBOXPLAYERVIEW_INIT_OFFSET UNITYSDK_OFFSET(0x18539940)
#define PUSHBOXPLAYERVIEW_PLAYTEXTURE_OFFSET UNITYSDK_OFFSET(0x18539A20)
#define PUSHBOXPLAYERVIEW_RESET_OFFSET UNITYSDK_OFFSET(0x1853A3D0)
#define PUSHBOXPLAYERVIEW_SETAPPEARANCE_OFFSET UNITYSDK_OFFSET(0x18539C50)
#define PUSHBOXPLAYERVIEW_SETWORLDLOCALPOS_OFFSET UNITYSDK_OFFSET(0x18539FA0)
#define PUSHBOXPLAYERVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1853A120)
#define PUSHBOXPLAYERVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1853A430)

inline static constexpr unsigned int PushBoxPlayerView_TypeDefinitionIndex = 38838;
