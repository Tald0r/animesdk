...
#define SCENEMESHCULLEDMANAGER_BAKEAABB_OFFSET UNITYSDK_OFFSET(0x15F5B760)
#define SCENEMESHCULLEDMANAGER_DISTANCE_OFFSET UNITYSDK_OFFSET(0x15F5C240)
#define SCENEMESHCULLEDMANAGER_GETCAMERAPOS_OFFSET UNITYSDK_OFFSET(0x15F5BDF0)
#define SCENEMESHCULLEDMANAGER_INVISBLEMESH_OFFSET UNITYSDK_OFFSET(0x15F5BFE0)
#define SCENEMESHCULLEDMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15F5B6F0)
#define SCENEMESHCULLEDMANAGER_SHOWALL_OFFSET UNITYSDK_OFFSET(0x15F5B8F0)
#define SCENEMESHCULLEDMANAGER_START_OFFSET UNITYSDK_OFFSET(0x15F5BA50)
#define SCENEMESHCULLEDMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x15F5BAB0)
#define SCENEMESHCULLEDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x15F5C310)

inline static constexpr unsigned int SceneMeshCulledManager_TypeDefinitionIndex = 60940;
