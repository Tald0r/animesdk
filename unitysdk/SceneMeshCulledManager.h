...
#define SCENEMESHCULLEDMANAGER_BAKEAABB_OFFSET UNITYSDK_OFFSET(0x15ABEB60)
#define SCENEMESHCULLEDMANAGER_DISTANCE_OFFSET UNITYSDK_OFFSET(0x15ABF640)
#define SCENEMESHCULLEDMANAGER_GETCAMERAPOS_OFFSET UNITYSDK_OFFSET(0x15ABF1F0)
#define SCENEMESHCULLEDMANAGER_INVISBLEMESH_OFFSET UNITYSDK_OFFSET(0x15ABF3E0)
#define SCENEMESHCULLEDMANAGER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x15ABEAF0)
#define SCENEMESHCULLEDMANAGER_SHOWALL_OFFSET UNITYSDK_OFFSET(0x15ABECF0)
#define SCENEMESHCULLEDMANAGER_START_OFFSET UNITYSDK_OFFSET(0x15ABEE50)
#define SCENEMESHCULLEDMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x15ABEEB0)
#define SCENEMESHCULLEDMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x15ABF710)

inline static constexpr unsigned int SceneMeshCulledManager_TypeDefinitionIndex = 43707;
