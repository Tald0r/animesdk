...
#define UIWIDGETGROUPSCROLL_DESTROY_OFFSET UNITYSDK_OFFSET(0x6A84000)
#define UIWIDGETGROUPSCROLL_GETWIDGETBYINDEX_OFFSET UNITYSDK_OFFSET(0x6A83F20)
#define UIWIDGETGROUPSCROLL_SETDATA_OFFSET UNITYSDK_OFFSET(0x6A83F90)
#define UIWIDGETGROUPSCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x6A84070)
#define UIWIDGETGROUPSCROLL___BASE_DESTROY_OFFSET UNITYSDK_OFFSET(0x6A840D0)

inline static constexpr unsigned int UIWidgetGroupScroll_TypeDefinitionIndex = 76515;
