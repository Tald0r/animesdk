...
#define UIWIDGETGROUPSCROLL_DESTROY_OFFSET UNITYSDK_OFFSET(0x16EB2DB0)
#define UIWIDGETGROUPSCROLL_GETWIDGETBYINDEX_OFFSET UNITYSDK_OFFSET(0x16EB2CD0)
#define UIWIDGETGROUPSCROLL_SETDATA_OFFSET UNITYSDK_OFFSET(0x16EB2D40)
#define UIWIDGETGROUPSCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x16EB2E20)
#define UIWIDGETGROUPSCROLL___BASE_DESTROY_OFFSET UNITYSDK_OFFSET(0x16EB2E80)

inline static constexpr unsigned int UIWidgetGroupScroll_TypeDefinitionIndex = 59818;
