...
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_1_OFFSET UNITYSDK_OFFSET(0x1A02EDD0)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_2_OFFSET UNITYSDK_OFFSET(0x1A02EE50)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_3_OFFSET UNITYSDK_OFFSET(0x1A02EEF0)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_4_OFFSET UNITYSDK_OFFSET(0x1A02EF60)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_5_OFFSET UNITYSDK_OFFSET(0x1A02EFD0)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_6_OFFSET UNITYSDK_OFFSET(0x1A02F690)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x1A02ED50)
#define STANDART_HASH_XXHASH_XXHASH64_UNSAFECOMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x1A02F7B0)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_AVALANCHE_OFFSET UNITYSDK_OFFSET(0x1A02EAC0)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A02EB20)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_MERGEROUND_OFFSET UNITYSDK_OFFSET(0x1A02EA50)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_OFFSET UNITYSDK_OFFSET(0x1A02E330)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_ROUND_OFFSET UNITYSDK_OFFSET(0x1A02EA00)
#define STANDART_HASH_XXHASH_XXHASH64_XXH_ROTL64_OFFSET UNITYSDK_OFFSET(0x1A02E320)
#define STANDART_HASH_XXHASH_XXHASH64__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A02F7F0)
#define STANDART_HASH_XXHASH_XXHASH64___INLINE__XXH64_OFFSET UNITYSDK_OFFSET(0x1A02D9A0)
#define STANDART_HASH_XXHASH_XXHASH64___INLINE__XXH64_STREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A02DF80)
#define STANDART_HASH_XXHASH_XXHASH64___INLINE__XXH64_STREAM_PROCESS_OFFSET UNITYSDK_OFFSET(0x1A02DE30)

namespace Standart::Hash::xxHash
{
	inline static constexpr unsigned int xxHash64_TypeDefinitionIndex = 8078;
	...
	public:
		...
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(xxHash64_TypeDefinitionIndex)->GetStaticField(0x3680);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_2()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(xxHash64_TypeDefinitionIndex)->GetStaticField(0x3688);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_3()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(xxHash64_TypeDefinitionIndex)->GetStaticField(0x3690);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_1()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(xxHash64_TypeDefinitionIndex)->GetStaticField(0x3698);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_5()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(xxHash64_TypeDefinitionIndex)->GetStaticField(0x36A0);
		}
