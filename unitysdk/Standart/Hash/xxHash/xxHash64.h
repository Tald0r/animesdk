...
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_1_OFFSET UNITYSDK_OFFSET(0x19A5CEE0)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_2_OFFSET UNITYSDK_OFFSET(0x19A5CF60)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_3_OFFSET UNITYSDK_OFFSET(0x19A5D000)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_4_OFFSET UNITYSDK_OFFSET(0x19A5D070)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_5_OFFSET UNITYSDK_OFFSET(0x19A5D0E0)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_6_OFFSET UNITYSDK_OFFSET(0x19A5D7A0)
#define STANDART_HASH_XXHASH_XXHASH64_COMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x19A5CE60)
#define STANDART_HASH_XXHASH_XXHASH64_UNSAFECOMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x19A5D8C0)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_AVALANCHE_OFFSET UNITYSDK_OFFSET(0x19A5CBD0)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19A5CC30)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_MERGEROUND_OFFSET UNITYSDK_OFFSET(0x19A5CB60)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_OFFSET UNITYSDK_OFFSET(0x19A5C440)
#define STANDART_HASH_XXHASH_XXHASH64_XXH64_ROUND_OFFSET UNITYSDK_OFFSET(0x19A5CB10)
#define STANDART_HASH_XXHASH_XXHASH64_XXH_ROTL64_OFFSET UNITYSDK_OFFSET(0x19A5C430)
#define STANDART_HASH_XXHASH_XXHASH64__CCTOR_OFFSET UNITYSDK_OFFSET(0x19A5D900)
#define STANDART_HASH_XXHASH_XXHASH64___INLINE__XXH64_OFFSET UNITYSDK_OFFSET(0x19A5BAB0)
#define STANDART_HASH_XXHASH_XXHASH64___INLINE__XXH64_STREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19A5C090)
#define STANDART_HASH_XXHASH_XXHASH64___INLINE__XXH64_STREAM_PROCESS_OFFSET UNITYSDK_OFFSET(0x19A5BF40)

namespace Standart::Hash::xxHash
{
	inline static constexpr unsigned int xxHash64_TypeDefinitionIndex = 7776;
	...
	public:
		...
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(xxHash64_TypeDefinitionIndex)->GetStaticField(0x36C0);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_5()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(xxHash64_TypeDefinitionIndex)->GetStaticField(0x36C8);
		}
