...
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_DIGESTBYTES_OFFSET UNITYSDK_OFFSET(0x1A9B3150)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_DIGEST_1_OFFSET UNITYSDK_OFFSET(0x1A9B3510)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_DIGEST_OFFSET UNITYSDK_OFFSET(0x1A9B3000)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_RESET_1_OFFSET UNITYSDK_OFFSET(0x1A9B2A20)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_RESET_2_OFFSET UNITYSDK_OFFSET(0x1A9B32B0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_RESET_OFFSET UNITYSDK_OFFSET(0x1A9B28B0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1A9B2C50)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1A9B2D10)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_3_OFFSET UNITYSDK_OFFSET(0x1A9B2E10)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_4_OFFSET UNITYSDK_OFFSET(0x1A9B33D0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_5_OFFSET UNITYSDK_OFFSET(0x1A9B3440)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A9B2B90)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH64_DIGEST_OFFSET UNITYSDK_OFFSET(0x1A9B21B0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH64_RESET_OFFSET UNITYSDK_OFFSET(0x1A9B1D30)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH64_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A9B1DE0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH_COPY_OFFSET UNITYSDK_OFFSET(0x1A9B1D20)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH_READ32_OFFSET UNITYSDK_OFFSET(0x1A9B1CF0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH_READ64_OFFSET UNITYSDK_OFFSET(0x1A9B1D00)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH_ZERO_OFFSET UNITYSDK_OFFSET(0x1A9B1D10)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9B3610)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9B2740)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9B2730)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE___INLINE__XXH64_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A9B23B0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE___INLINE__XXH64_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A9B2250)

namespace Standart::Hash::xxHash
{
	inline static constexpr unsigned int XXHash64Update_TypeDefinitionIndex = 7936;
	...
	public:
		...
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(XXHash64Update_TypeDefinitionIndex)->GetStaticField(0x3690);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_5()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(XXHash64Update_TypeDefinitionIndex)->GetStaticField(0x3698);
		}
