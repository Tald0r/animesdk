...
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_DIGESTBYTES_OFFSET UNITYSDK_OFFSET(0x1B184210)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_DIGEST_1_OFFSET UNITYSDK_OFFSET(0x1B1845D0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_DIGEST_OFFSET UNITYSDK_OFFSET(0x1B1840C0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_RESET_1_OFFSET UNITYSDK_OFFSET(0x1B183AE0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_RESET_2_OFFSET UNITYSDK_OFFSET(0x1B184370)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_RESET_OFFSET UNITYSDK_OFFSET(0x1B183970)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1B183D10)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_2_OFFSET UNITYSDK_OFFSET(0x1B183DD0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_3_OFFSET UNITYSDK_OFFSET(0x1B183ED0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_4_OFFSET UNITYSDK_OFFSET(0x1B184490)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_5_OFFSET UNITYSDK_OFFSET(0x1B184500)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B183C50)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH64_DIGEST_OFFSET UNITYSDK_OFFSET(0x1B183270)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH64_RESET_OFFSET UNITYSDK_OFFSET(0x1B182DF0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH64_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B182EA0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH_COPY_OFFSET UNITYSDK_OFFSET(0x1B182DE0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH_READ32_OFFSET UNITYSDK_OFFSET(0x1B182DB0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH_READ64_OFFSET UNITYSDK_OFFSET(0x1B182DC0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE_XXH_ZERO_OFFSET UNITYSDK_OFFSET(0x1B182DD0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1846D0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B183800)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1837F0)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE___INLINE__XXH64_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B183470)
#define STANDART_HASH_XXHASH_XXHASH64UPDATE___INLINE__XXH64_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B183310)

namespace Standart::Hash::xxHash
{
	inline static constexpr unsigned int XXHash64Update_TypeDefinitionIndex = 8162;
	...
	public:
		...
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(XXHash64Update_TypeDefinitionIndex)->GetStaticField(0x3650);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_4()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(XXHash64Update_TypeDefinitionIndex)->GetStaticField(0x3658);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_2()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(XXHash64Update_TypeDefinitionIndex)->GetStaticField(0x3660);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_3()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(XXHash64Update_TypeDefinitionIndex)->GetStaticField(0x3668);
		}
		static ::System::UInt64* StaticGet_XXH_PRIME64_5()
		{
			return (::System::UInt64*)Il2CppClass::FromTypeDefinitionIndex(XXHash64Update_TypeDefinitionIndex)->GetStaticField(0x3670);
		}
