...
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_1_OFFSET UNITYSDK_OFFSET(0x19F1BC10)
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_2_OFFSET UNITYSDK_OFFSET(0x19F1BCE0)
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_3_OFFSET UNITYSDK_OFFSET(0x19F1BD50)
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_4_OFFSET UNITYSDK_OFFSET(0x19F1BE10)
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_5_OFFSET UNITYSDK_OFFSET(0x19F1BED0)
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_6_OFFSET UNITYSDK_OFFSET(0x19F1C520)
#define STANDART_HASH_XXHASH_XXHASH32_COMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x19F1BB40)
#define STANDART_HASH_XXHASH_XXHASH32_UNSAFECOMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x19F1C620)
#define STANDART_HASH_XXHASH_XXHASH32_XXH32_AVALANCHE_OFFSET UNITYSDK_OFFSET(0x19F1B870)
#define STANDART_HASH_XXHASH_XXHASH32_XXH32_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19F1B8F0)
#define STANDART_HASH_XXHASH_XXHASH32_XXH32_OFFSET UNITYSDK_OFFSET(0x19F1B2C0)
#define STANDART_HASH_XXHASH_XXHASH32_XXH32_ROUND_OFFSET UNITYSDK_OFFSET(0x19F1B800)
#define STANDART_HASH_XXHASH_XXHASH32_XXH_ROTL32_OFFSET UNITYSDK_OFFSET(0x19F1B2B0)
#define STANDART_HASH_XXHASH_XXHASH32__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F1C690)
#define STANDART_HASH_XXHASH_XXHASH32___INLINE__XXH32_OFFSET UNITYSDK_OFFSET(0x19F1AAF0)
#define STANDART_HASH_XXHASH_XXHASH32___INLINE__XXH32_STREAM_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19F1B000)
#define STANDART_HASH_XXHASH_XXHASH32___INLINE__XXH32_STREAM_PROCESS_OFFSET UNITYSDK_OFFSET(0x19F1AE90)

namespace Standart::Hash::xxHash
{
	inline static constexpr unsigned int xxHash32_TypeDefinitionIndex = 7713;
	...
	public:
		...
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(xxHash32_TypeDefinitionIndex)->GetStaticField(0x3780);
		}
		static ::System::UInt32* StaticGet_XXH_PRIME32_4()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(xxHash32_TypeDefinitionIndex)->GetStaticField(0x3784);
		}
		static ::System::UInt32* StaticGet_XXH_PRIME32_3()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(xxHash32_TypeDefinitionIndex)->GetStaticField(0x3788);
		}
		static ::System::UInt32* StaticGet_XXH_PRIME32_5()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(xxHash32_TypeDefinitionIndex)->GetStaticField(0x378C);
		}
		static ::System::UInt32* StaticGet_XXH_PRIME32_2()
		{
			return (::System::UInt32*)Il2CppClass::FromTypeDefinitionIndex(xxHash32_TypeDefinitionIndex)->GetStaticField(0x3790);
		}
