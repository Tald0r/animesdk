...
#define CLASS_2_B09BB97A3375B1CD_METHOD_2_8AF27F640869EFF7_OFFSET UNITYSDK_OFFSET(0xD2696E0)
#define CLASS_2_B09BB97A3375B1CD_METHOD_2_BBA49FAB086F388D_OFFSET UNITYSDK_OFFSET(0xD269AB0)
#define CLASS_2_B09BB97A3375B1CD_METHOD_2_C8903A36ECBA4078_OFFSET UNITYSDK_OFFSET(0xD269CC0)
#define CLASS_2_B09BB97A3375B1CD__CTOR_OFFSET UNITYSDK_OFFSET(0xD269CB0)

inline static constexpr unsigned int Class_2_B09BB97A3375B1CD_TypeDefinitionIndex = 62323;

class Class_2_B09BB97A3375B1CD : public ::Class_1_EEA0111A28582B57
{
public:
	::Class_2_60DDD9C206686F44* Field_2_8; // 0x18
	::Class_3_A2BF74BADF6F7D16<::MoleMole::UIActivityCameraExplorationWidgetController*>* Field_2_4; // 0x20
	::Class_2_CA67A9CEB871FFD3* Field_2_7; // 0x28
	::Class_2_60DDD9C206686F44* Field_2_3; // 0x30
	::UnityEngine::RectTransform* Field_2_12; // 0x38
	::Class_3_A2BF74BADF6F7D16<::MoleMole::UIActivityFruitToysSettlementWidgetController*>* Field_2_6; // 0x40
	::UnityEngine::UI::Extension::UILocalizationText* Field_2_0; // 0x48
	::Class_2_60DDD9C206686F44* Field_2_9; // 0x50
	::Class_3_A2BF74BADF6F7D16<::MoleMole::UIActivityCameraBountyWidgetController*>* Field_2_5; // 0x58
