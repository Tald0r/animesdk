...
#define PUSHBOXCELL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x79ED90)
#define PUSHBOXCELL_EQUALS_OFFSET UNITYSDK_OFFSET(0x79ED10)
#define PUSHBOXCELL_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x17CC8540)
#define PUSHBOXCELL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x79ED00)
#define PUSHBOXCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3730)
#define PUSHBOXCELL___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x79EDA0)

inline static constexpr unsigned int PushBoxCell_TypeDefinitionIndex = 73524;
