...
#define PUSHBOXCELL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x472610)
#define PUSHBOXCELL_EQUALS_OFFSET UNITYSDK_OFFSET(0x472590)
#define PUSHBOXCELL_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0xD85B100)
#define PUSHBOXCELL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x32DE30)
#define PUSHBOXCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3C30)
#define PUSHBOXCELL___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x472620)

inline static constexpr unsigned int PushBoxCell_TypeDefinitionIndex = 64696;
