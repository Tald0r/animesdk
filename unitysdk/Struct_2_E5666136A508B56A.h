...
#define STRUCT_2_E5666136A508B56A__CCTOR_OFFSET UNITYSDK_OFFSET(0x164F0B30)

inline static constexpr unsigned int Struct_2_E5666136A508B56A_TypeDefinitionIndex = 54010;

struct alignas(8) Struct_2_E5666136A508B56A
{
	static ::System::String** StaticGet_Field_2_7()
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Struct_2_E5666136A508B56A_TypeDefinitionIndex)->GetStaticField(0x3C900);
	}
