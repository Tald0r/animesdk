...
#define STRUCT_2_C87A89B4261FDC79_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3450C0)
#define STRUCT_2_C87A89B4261FDC79_EQUALS_OFFSET UNITYSDK_OFFSET(0x344FF0)
#define STRUCT_2_C87A89B4261FDC79_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3450D0)
#define STRUCT_2_C87A89B4261FDC79_METHOD_2_4815DC3FA2B6C02F_OFFSET UNITYSDK_OFFSET(0x81A4B20)
#define STRUCT_2_C87A89B4261FDC79_METHOD_2_4A13BD8A67015544_OFFSET UNITYSDK_OFFSET(0x345230)
#define STRUCT_2_C87A89B4261FDC79_METHOD_2_57A8E11FECF10345_OFFSET UNITYSDK_OFFSET(0x81A4CB0)
#define STRUCT_2_C87A89B4261FDC79_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x345160)
#define STRUCT_2_C87A89B4261FDC79_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x3451D0)
#define STRUCT_2_C87A89B4261FDC79__CCTOR_OFFSET UNITYSDK_OFFSET(0x81A4B10)

inline static constexpr unsigned int Struct_2_C87A89B4261FDC79_TypeDefinitionIndex = 38463;

struct alignas(8) Struct_2_C87A89B4261FDC79
{
	static ::Struct_2_C87A89B4261FDC79* StaticGet_Field_2_0()
	{
		return (::Struct_2_C87A89B4261FDC79*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_C87A89B4261FDC79_TypeDefinitionIndex)->GetStaticField(0x2A000);
	}
	::MoleMole::ConfigHollowChessboardEntityBehavior_BehaviorConfig_ConfigType Field_2_1; // 0x10
	::Class_0_16E4307DCC419505_212* Field_2_2; // 0x18
