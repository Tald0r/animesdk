...
#define MONOUIHIDEITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x9A47FA0)
#define MONOUIHIDEITEM_CLEARRUNTIMEFADECONFIG_OFFSET UNITYSDK_OFFSET(0x9A4A700)
#define MONOUIHIDEITEM_GETALPHA_OFFSET UNITYSDK_OFFSET(0x9A49B80)
#define MONOUIHIDEITEM_GETANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x9A49DB0)
#define MONOUIHIDEITEM_GETSETUPINFO_OFFSET UNITYSDK_OFFSET(0x9A47D80)
#define MONOUIHIDEITEM_GET_ACTIONSETUPINFOS_OFFSET UNITYSDK_OFFSET(0x9A47D40)
#define MONOUIHIDEITEM_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x9A47D60)
#define MONOUIHIDEITEM_GET_REALTAG_OFFSET UNITYSDK_OFFSET(0x9A47A70)
#define MONOUIHIDEITEM_GET_RUNTIMEFADECONFIGS_OFFSET UNITYSDK_OFFSET(0x9A47C70)
#define MONOUIHIDEITEM_GET_ZONESETUPINFOS_OFFSET UNITYSDK_OFFSET(0x9A47D50)
#define MONOUIHIDEITEM_INTERRUPTSETUP_OFFSET UNITYSDK_OFFSET(0x9A49810)
#define MONOUIHIDEITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9A48A60)
#define MONOUIHIDEITEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9A489F0)
#define MONOUIHIDEITEM_ONPARENTSHOWSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x9A49980)
#define MONOUIHIDEITEM_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0x9A48E90)
#define MONOUIHIDEITEM_RESETITEM_OFFSET UNITYSDK_OFFSET(0x9A49C80)
#define MONOUIHIDEITEM_SAMPLEANIMLASTFRAME_OFFSET UNITYSDK_OFFSET(0x9A4A550)
#define MONOUIHIDEITEM_SETALPHA_OFFSET UNITYSDK_OFFSET(0x9A4A1A0)
#define MONOUIHIDEITEM_SETBLOCKRAYCASTSSTATE_OFFSET UNITYSDK_OFFSET(0x9A4A690)
#define MONOUIHIDEITEM_SETUPUI_1_OFFSET UNITYSDK_OFFSET(0x9A48B90)
#define MONOUIHIDEITEM_SETUPUI_OFFSET UNITYSDK_OFFSET(0x9A48AE0)
#define MONOUIHIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x9A4AA50)
#define MONOUIHIDEITEM__GETCURRENTPLAYINGANIM_OFFSET UNITYSDK_OFFSET(0x9A4A440)
#define MONOUIHIDEITEM__GETTARGETANIMATIONCLIPNAME_OFFSET UNITYSDK_OFFSET(0x9A49F20)
#define MONOUIHIDEITEM__PLAYANIMATIONWITHDELAYCONFIRM_OFFSET UNITYSDK_OFFSET(0x9A4A2D0)
#define MONOUIHIDEITEM__RESETFADECONFIGS_OFFSET UNITYSDK_OFFSET(0x9A47AF0)
#define MONOUIHIDEITEM__SETTOANIMATIONLASTFRAME_OFFSET UNITYSDK_OFFSET(0x9A4A8E0)
#define MONOUIHIDEITEM__STOPCURRENTPLAYINGANIMATIONDELAY_OFFSET UNITYSDK_OFFSET(0x9A4A9A0)
#define MONOUIHIDEITEM___PLAYANIMATIONWITHDELAYCONFIRM_B__54_0_OFFSET UNITYSDK_OFFSET(0x9A4AAE0)

inline static constexpr unsigned int MonoUIHideItem_TypeDefinitionIndex = 52690;
