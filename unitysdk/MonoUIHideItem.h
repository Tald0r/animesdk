...
#define MONOUIHIDEITEM_AWAKE_OFFSET UNITYSDK_OFFSET(0x88A3DC0)
#define MONOUIHIDEITEM_CLEARRUNTIMEFADECONFIG_OFFSET UNITYSDK_OFFSET(0x88A6520)
#define MONOUIHIDEITEM_GETALPHA_OFFSET UNITYSDK_OFFSET(0x88A59A0)
#define MONOUIHIDEITEM_GETANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x88A5BD0)
#define MONOUIHIDEITEM_GETSETUPINFO_OFFSET UNITYSDK_OFFSET(0x88A3BA0)
#define MONOUIHIDEITEM_GET_ACTIONSETUPINFOS_OFFSET UNITYSDK_OFFSET(0x88A3B60)
#define MONOUIHIDEITEM_GET_ISSHOW_OFFSET UNITYSDK_OFFSET(0x88A3B80)
#define MONOUIHIDEITEM_GET_REALTAG_OFFSET UNITYSDK_OFFSET(0x88A3890)
#define MONOUIHIDEITEM_GET_RUNTIMEFADECONFIGS_OFFSET UNITYSDK_OFFSET(0x88A3A90)
#define MONOUIHIDEITEM_GET_ZONESETUPINFOS_OFFSET UNITYSDK_OFFSET(0x88A3B70)
#define MONOUIHIDEITEM_INTERRUPTSETUP_OFFSET UNITYSDK_OFFSET(0x88A5630)
#define MONOUIHIDEITEM_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x88A4880)
#define MONOUIHIDEITEM_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x88A4810)
#define MONOUIHIDEITEM_ONPARENTSHOWSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x88A57A0)
#define MONOUIHIDEITEM_REFRESHITEM_OFFSET UNITYSDK_OFFSET(0x88A4CB0)
#define MONOUIHIDEITEM_RESETITEM_OFFSET UNITYSDK_OFFSET(0x88A5AA0)
#define MONOUIHIDEITEM_SAMPLEANIMLASTFRAME_OFFSET UNITYSDK_OFFSET(0x88A6370)
#define MONOUIHIDEITEM_SETALPHA_OFFSET UNITYSDK_OFFSET(0x88A5FC0)
#define MONOUIHIDEITEM_SETBLOCKRAYCASTSSTATE_OFFSET UNITYSDK_OFFSET(0x88A64B0)
#define MONOUIHIDEITEM_SETUPUI_1_OFFSET UNITYSDK_OFFSET(0x88A49B0)
#define MONOUIHIDEITEM_SETUPUI_OFFSET UNITYSDK_OFFSET(0x88A4900)
#define MONOUIHIDEITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x88A6870)
#define MONOUIHIDEITEM__GETCURRENTPLAYINGANIM_OFFSET UNITYSDK_OFFSET(0x88A6260)
#define MONOUIHIDEITEM__GETTARGETANIMATIONCLIPNAME_OFFSET UNITYSDK_OFFSET(0x88A5D40)
#define MONOUIHIDEITEM__PLAYANIMATIONWITHDELAYCONFIRM_OFFSET UNITYSDK_OFFSET(0x88A60F0)
#define MONOUIHIDEITEM__RESETFADECONFIGS_OFFSET UNITYSDK_OFFSET(0x88A3910)
#define MONOUIHIDEITEM__SETTOANIMATIONLASTFRAME_OFFSET UNITYSDK_OFFSET(0x88A6700)
#define MONOUIHIDEITEM__STOPCURRENTPLAYINGANIMATIONDELAY_OFFSET UNITYSDK_OFFSET(0x88A67C0)
#define MONOUIHIDEITEM___PLAYANIMATIONWITHDELAYCONFIRM_B__54_0_OFFSET UNITYSDK_OFFSET(0x88A6900)

inline static constexpr unsigned int MonoUIHideItem_TypeDefinitionIndex = 55258;
