...
#define RANDOMINSTANCING_AWAKE_OFFSET UNITYSDK_OFFSET(0x1567F0D0)
#define RANDOMINSTANCING_HASH2_OFFSET UNITYSDK_OFFSET(0x1567FD80)
#define RANDOMINSTANCING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1567F500)
#define RANDOMINSTANCING_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1567F250)
#define RANDOMINSTANCING_RANDOM_OFFSET UNITYSDK_OFFSET(0x1567FDF0)
#define RANDOMINSTANCING_UPDATEINSTANCES_OFFSET UNITYSDK_OFFSET(0x1567F2C0)
#define RANDOMINSTANCING_UPDATETILEINSTANCES_OFFSET UNITYSDK_OFFSET(0x1567F740)
#define RANDOMINSTANCING_UPDATE_OFFSET UNITYSDK_OFFSET(0x1567F6D0)
#define RANDOMINSTANCING__CTOR_OFFSET UNITYSDK_OFFSET(0x1567FEB0)

inline static constexpr unsigned int RandomInstancing_TypeDefinitionIndex = 53798;
