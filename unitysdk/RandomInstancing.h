...
#define RANDOMINSTANCING_AWAKE_OFFSET UNITYSDK_OFFSET(0x196F8D00)
#define RANDOMINSTANCING_HASH2_OFFSET UNITYSDK_OFFSET(0x196F99B0)
#define RANDOMINSTANCING_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x196F9130)
#define RANDOMINSTANCING_ONENABLE_OFFSET UNITYSDK_OFFSET(0x196F8E80)
#define RANDOMINSTANCING_RANDOM_OFFSET UNITYSDK_OFFSET(0x196F9A20)
#define RANDOMINSTANCING_UPDATEINSTANCES_OFFSET UNITYSDK_OFFSET(0x196F8EF0)
#define RANDOMINSTANCING_UPDATETILEINSTANCES_OFFSET UNITYSDK_OFFSET(0x196F9370)
#define RANDOMINSTANCING_UPDATE_OFFSET UNITYSDK_OFFSET(0x196F9300)
#define RANDOMINSTANCING__CTOR_OFFSET UNITYSDK_OFFSET(0x196F9AE0)

inline static constexpr unsigned int RandomInstancing_TypeDefinitionIndex = 69613;
