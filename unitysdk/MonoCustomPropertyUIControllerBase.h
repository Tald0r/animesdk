...
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x6B02620)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_COLLECTANIMATIONS_OFFSET UNITYSDK_OFFSET(0x6B03470)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_DOONCANVASWILLRENDER_OFFSET UNITYSDK_OFFSET(0x6B025C0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_DOONDISABLE_OFFSET UNITYSDK_OFFSET(0x6B022D0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_DOONENABLE_OFFSET UNITYSDK_OFFSET(0x6B02400)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GETANIMCLIPLENGTH_OFFSET UNITYSDK_OFFSET(0x6B035B0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GETCUSTOMPROPERTYMAXVALUE_OFFSET UNITYSDK_OFFSET(0x6B03210)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GETCUSTOMPROPERTYVALUE_OFFSET UNITYSDK_OFFSET(0x6B02FD0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GET_CONFIG_OFFSET UNITYSDK_OFFSET(0x6B014E0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_GET_OWNERENTITY_OFFSET UNITYSDK_OFFSET(0x6B01330)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_HANDLEPROGRESS_OFFSET UNITYSDK_OFFSET(0x6B03670)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_LOGCUSTOMTYPEHOLDERERROR_OFFSET UNITYSDK_OFFSET(0x6B031A0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_MOLEMOLE_BATTLE_IPROPERTYCHANGEINCURFRAMECALLBACK_ONPROPERTYLISTCHANGEINCURFRAME_OFFSET UNITYSDK_OFFSET(0x6B039F0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONATTACHENTITY_OFFSET UNITYSDK_OFFSET(0x6B021C0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONCANVASWILLRENDER_OFFSET UNITYSDK_OFFSET(0x6B02480)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6B01F80)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x6B02220)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x6B02340)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONFIGHTER_PROPERTYVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x6B01A20)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x6B01DB0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONPROPERTYCHANGE_OFFSET UNITYSDK_OFFSET(0x6B01AE0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONPROPERTYLISTCHANGEINCURFRAME_OFFSET UNITYSDK_OFFSET(0x6B01C30)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6B016B0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6B02150)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6B01500)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_REDIRECTCUSTOMPROPERTIES_OFFSET UNITYSDK_OFFSET(0x6B028D0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_REGISTERPROPCHANGECB_OFFSET UNITYSDK_OFFSET(0x6B01980)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_REMOVEPROEPRTYCALLBACK_OFFSET UNITYSDK_OFFSET(0x6B01FF0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_SETPROPERTYCHANGEHANDLEMODE_OFFSET UNITYSDK_OFFSET(0x6B01650)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_SET_CONFIG_OFFSET UNITYSDK_OFFSET(0x6B014F0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE_UNREGISTERPROPCHANGECB_OFFSET UNITYSDK_OFFSET(0x6B018E0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x6B039E0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x6B03A80)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONHIDE_OFFSET UNITYSDK_OFFSET(0x6B03A90)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONSHOW_OFFSET UNITYSDK_OFFSET(0x6B03AF0)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONUIDESTROY_OFFSET UNITYSDK_OFFSET(0x6B03A60)
#define MONOCUSTOMPROPERTYUICONTROLLERBASE___BASE_ONUIINIT_OFFSET UNITYSDK_OFFSET(0x6B03A70)

inline static constexpr unsigned int MonoCustomPropertyUIControllerBase_TypeDefinitionIndex = 66426;

class MonoCustomPropertyUIControllerBase : public ::MoleMole::UIWindowController
{
public:
	::System::UInt32 _ownerEntityID; // 0x2F8
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _placeholder2CustomTypes; // 0x300
	::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* _customType2Placeholders; // 0x308
	::Class_1_817E737241BDC0A2* _property; // 0x310
	::System::Collections::Generic::List_1<::UnityEngine::Animation*>* _allAnimationComponents; // 0x318
	::MoleMole::CharacterScriptConfig_ConfigCustomPropertyUI* _config_k__BackingField; // 0x320
	::System::Boolean _needHandleAllCustomPropertiesOnEnable; // 0x328
	::System::Boolean _mergeHandleEnable; // 0x329
