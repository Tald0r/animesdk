...
#define CLASS_1_ED492469204624B4_STRUCT_2_1D31833B4311C5D9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x360890)
#define CLASS_1_ED492469204624B4_STRUCT_2_1D31833B4311C5D9_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

inline static constexpr unsigned int Class_1_ED492469204624B4_Struct_2_1D31833B4311C5D9_TypeDefinitionIndex = 55372;

struct alignas(8) Class_1_ED492469204624B4_Struct_2_1D31833B4311C5D9
{
	::Class_1_ED492469204624B4* Field_2_2; // 0x10
	::Class_0_16E4307DCC419505_307* Field_2_4; // 0x18
	::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder Field_2_1; // 0x20
	::Class_1_C98C01B00CFF7D8A* Field_2_5; // 0x30
