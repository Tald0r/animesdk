...
#define CYSHARP_THREADING_TASKS_UNITYASYNCEXTENSIONS_TOUNITASK_OFFSET UNITYSDK_OFFSET(0x1AFA53E0)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int UnityAsyncExtensions_TypeDefinitionIndex = 27193;
