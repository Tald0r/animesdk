...
#define CYSHARP_THREADING_TASKS_UNITASKEXTENSIONS__CONTINUEWITH_D__52_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x97AF00)
#define CYSHARP_THREADING_TASKS_UNITASKEXTENSIONS__CONTINUEWITH_D__52_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int UniTaskExtensions__ContinueWith_d__52_TypeDefinitionIndex = 27188;

	struct alignas(8) UniTaskExtensions__ContinueWith_d__52
	{
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder __t__builder; // 0x10
		::System::Func_1<::Cysharp::Threading::Tasks::UniTask>* continuationFunction; // 0x20
