...
#define CYSHARP_THREADING_TASKS_UNITASK_CANCELEDRESULTSOURCE_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1AFF9480)
#define CYSHARP_THREADING_TASKS_UNITASK_CANCELEDRESULTSOURCE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1AFF94E0)
#define CYSHARP_THREADING_TASKS_UNITASK_CANCELEDRESULTSOURCE_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1AFF9500)
#define CYSHARP_THREADING_TASKS_UNITASK_CANCELEDRESULTSOURCE_UNSAFEGETSTATUS_OFFSET UNITYSDK_OFFSET(0x1AFF94F0)
#define CYSHARP_THREADING_TASKS_UNITASK_CANCELEDRESULTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFF9470)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int UniTask_CanceledResultSource_TypeDefinitionIndex = 27139;
