...
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE_AWAITER_GETRESULT_OFFSET UNITYSDK_OFFSET(0x259A50)
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE_AWAITER_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x2FB060)
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE_AWAITER_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x977F70)
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE_AWAITER_UNSAFEONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x977F70)
#define CYSHARP_THREADING_TASKS_YIELDAWAITABLE_AWAITER__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3600)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int YieldAwaitable_Awaiter_TypeDefinitionIndex = 27157;
