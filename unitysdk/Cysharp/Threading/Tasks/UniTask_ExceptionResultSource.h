...
#define CYSHARP_THREADING_TASKS_UNITASK_EXCEPTIONRESULTSOURCE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1B1214E0)
#define CYSHARP_THREADING_TASKS_UNITASK_EXCEPTIONRESULTSOURCE_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1B121410)
#define CYSHARP_THREADING_TASKS_UNITASK_EXCEPTIONRESULTSOURCE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1B121470)
#define CYSHARP_THREADING_TASKS_UNITASK_EXCEPTIONRESULTSOURCE_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1B121490)
#define CYSHARP_THREADING_TASKS_UNITASK_EXCEPTIONRESULTSOURCE_UNSAFEGETSTATUS_OFFSET UNITYSDK_OFFSET(0x1B121480)
#define CYSHARP_THREADING_TASKS_UNITASK_EXCEPTIONRESULTSOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1213F0)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int UniTask_ExceptionResultSource_TypeDefinitionIndex = 27137;
