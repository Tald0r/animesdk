...
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTILPROMISE_CREATE_OFFSET UNITYSDK_OFFSET(0x1B68F290)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTILPROMISE_GETRESULT_OFFSET UNITYSDK_OFFSET(0x1B68F3A0)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTILPROMISE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x1B68F580)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTILPROMISE_GET_NEXTNODE_OFFSET UNITYSDK_OFFSET(0x1B68F1C0)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTILPROMISE_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B68F6C0)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTILPROMISE_ONCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1B68F6A0)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTILPROMISE_TRYRETURN_OFFSET UNITYSDK_OFFSET(0x1B68F4C0)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTILPROMISE_UNSAFEGETSTATUS_OFFSET UNITYSDK_OFFSET(0x1B68F650)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTILPROMISE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B68F1D0)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTILPROMISE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B68F280)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int UniTask_WaitUntilPromise_TypeDefinitionIndex = 28081;
	...
	public:
		...
		{
			return (::Cysharp::Threading::Tasks::TaskPool_1<::Cysharp::Threading::Tasks::UniTask_WaitUntilPromise*>*)Il2CppClass::FromTypeDefinitionIndex(UniTask_WaitUntilPromise_TypeDefinitionIndex)->GetStaticField(0x21150);
		}
