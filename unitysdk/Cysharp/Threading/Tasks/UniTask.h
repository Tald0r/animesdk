...
#define CYSHARP_THREADING_TASKS_UNITASK_ACTION_OFFSET UNITYSDK_OFFSET(0x1AFA7660)
#define CYSHARP_THREADING_TASKS_UNITASK_DELAYFRAME_OFFSET UNITYSDK_OFFSET(0x1AFA7020)
#define CYSHARP_THREADING_TASKS_UNITASK_DELAY_1_OFFSET UNITYSDK_OFFSET(0x1AFA7170)
#define CYSHARP_THREADING_TASKS_UNITASK_DELAY_2_OFFSET UNITYSDK_OFFSET(0x1AFA7360)
#define CYSHARP_THREADING_TASKS_UNITASK_DELAY_3_OFFSET UNITYSDK_OFFSET(0x1AFA71E0)
#define CYSHARP_THREADING_TASKS_UNITASK_DELAY_OFFSET UNITYSDK_OFFSET(0x1AFA70E0)
#define CYSHARP_THREADING_TASKS_UNITASK_FROMCANCELED_OFFSET UNITYSDK_OFFSET(0x1AFA7590)
#define CYSHARP_THREADING_TASKS_UNITASK_FROMEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1AFA57D0)
#define CYSHARP_THREADING_TASKS_UNITASK_GETAWAITER_OFFSET UNITYSDK_OFFSET(0x2CA610)
#define CYSHARP_THREADING_TASKS_UNITASK_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x6806F0)
#define CYSHARP_THREADING_TASKS_UNITASK_NEXTFRAME_1_OFFSET UNITYSDK_OFFSET(0x1AFA6E80)
#define CYSHARP_THREADING_TASKS_UNITASK_NEXTFRAME_2_OFFSET UNITYSDK_OFFSET(0x1AFA6F00)
#define CYSHARP_THREADING_TASKS_UNITASK_NEXTFRAME_OFFSET UNITYSDK_OFFSET(0x1AFA6E00)
#define CYSHARP_THREADING_TASKS_UNITASK_SUPPRESSCANCELLATIONTHROW_OFFSET UNITYSDK_OFFSET(0x96FE30)
#define CYSHARP_THREADING_TASKS_UNITASK_SWITCHTOMAINTHREAD_OFFSET UNITYSDK_OFFSET(0x1AFA76E0)
#define CYSHARP_THREADING_TASKS_UNITASK_SWITCHTOTHREADPOOL_OFFSET UNITYSDK_OFFSET(0x1AFA7700)
#define CYSHARP_THREADING_TASKS_UNITASK_TOSTRING_OFFSET UNITYSDK_OFFSET(0x96FE50)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITFORENDOFFRAME_OFFSET UNITYSDK_OFFSET(0x1AFA6F60)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITFORFIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1AFA6FF0)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITUNTIL_OFFSET UNITYSDK_OFFSET(0x1AFA7710)
#define CYSHARP_THREADING_TASKS_UNITASK_WAITWHILE_OFFSET UNITYSDK_OFFSET(0x1AFA7780)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENALL_1_OFFSET UNITYSDK_OFFSET(0x1AFA78B0)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENALL_OFFSET UNITYSDK_OFFSET(0x1AFA7820)
#define CYSHARP_THREADING_TASKS_UNITASK_WHENANY_OFFSET UNITYSDK_OFFSET(0x1AFA7A10)
#define CYSHARP_THREADING_TASKS_UNITASK_YIELD__1_OFFSET UNITYSDK_OFFSET(0x1AFA6CD0)
#define CYSHARP_THREADING_TASKS_UNITASK_YIELD__2_OFFSET UNITYSDK_OFFSET(0x1AFA6CE0)
#define CYSHARP_THREADING_TASKS_UNITASK_YIELD__3_OFFSET UNITYSDK_OFFSET(0x1AFA6D70)
#define CYSHARP_THREADING_TASKS_UNITASK_YIELD__OFFSET UNITYSDK_OFFSET(0x1AFA6CC0)
#define CYSHARP_THREADING_TASKS_UNITASK__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AFA7DB0)
#define CYSHARP_THREADING_TASKS_UNITASK__CTOR_OFFSET UNITYSDK_OFFSET(0x2FBEA0)

namespace Cysharp::Threading::Tasks
{
	inline static constexpr unsigned int UniTask_TypeDefinitionIndex = 27121;

	struct alignas(8) UniTask
	{
		static ::Cysharp::Threading::Tasks::UniTask* StaticGet_CanceledUniTask()
		{
			return (::Cysharp::Threading::Tasks::UniTask*)Il2CppClass::FromTypeDefinitionIndex(UniTask_TypeDefinitionIndex)->GetStaticField(0x1F9F0);
		}
		static ::Cysharp::Threading::Tasks::UniTask* StaticGet_CompletedTask()
		{
			return (::Cysharp::Threading::Tasks::UniTask*)Il2CppClass::FromTypeDefinitionIndex(UniTask_TypeDefinitionIndex)->GetStaticField(0x1FA00);
		}
