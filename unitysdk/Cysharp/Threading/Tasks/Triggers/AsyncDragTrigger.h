...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDRAGTRIGGER_GETONDRAGASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1B11C710)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDRAGTRIGGER_GETONDRAGASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1B11C630)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDRAGTRIGGER_ONDRAGASYNC_1_OFFSET UNITYSDK_OFFSET(0x1B11C8F0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDRAGTRIGGER_ONDRAGASYNC_OFFSET UNITYSDK_OFFSET(0x1B11C770)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDRAGTRIGGER_UNITYENGINE_EVENTSYSTEMS_IDRAGHANDLER_ONDRAG_OFFSET UNITYSDK_OFFSET(0x1B11C5C0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDRAGTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B11CA10)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncDragTrigger_TypeDefinitionIndex = 27329;
