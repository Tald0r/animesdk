...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPARTICLETRIGGERTRIGGER_GETONPARTICLETRIGGERASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1B734320)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPARTICLETRIGGERTRIGGER_GETONPARTICLETRIGGERASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1B734270)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPARTICLETRIGGERTRIGGER_ONPARTICLETRIGGERASYNC_1_OFFSET UNITYSDK_OFFSET(0x1B7344D0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPARTICLETRIGGERTRIGGER_ONPARTICLETRIGGERASYNC_OFFSET UNITYSDK_OFFSET(0x1B734380)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPARTICLETRIGGERTRIGGER_ONPARTICLETRIGGER_OFFSET UNITYSDK_OFFSET(0x1B734250)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPARTICLETRIGGERTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7345E0)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncParticleTriggerTrigger_TypeDefinitionIndex = 28219;
