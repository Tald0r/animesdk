...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCVALIDATETRIGGER_GETONVALIDATEASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1B6FDFC0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCVALIDATETRIGGER_GETONVALIDATEASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1B6FDF10)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCVALIDATETRIGGER_ONVALIDATEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1B6FE170)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCVALIDATETRIGGER_ONVALIDATEASYNC_OFFSET UNITYSDK_OFFSET(0x1B6FE020)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCVALIDATETRIGGER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B6FDEF0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCVALIDATETRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6FE280)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncValidateTrigger_TypeDefinitionIndex = 28255;
