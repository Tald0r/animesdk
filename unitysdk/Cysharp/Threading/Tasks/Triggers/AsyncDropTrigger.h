...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDROPTRIGGER_GETONDROPASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1B0F6750)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDROPTRIGGER_GETONDROPASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1B0F6670)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDROPTRIGGER_ONDROPASYNC_1_OFFSET UNITYSDK_OFFSET(0x1B0F6930)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDROPTRIGGER_ONDROPASYNC_OFFSET UNITYSDK_OFFSET(0x1B0F67B0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDROPTRIGGER_UNITYENGINE_EVENTSYSTEMS_IDROPHANDLER_ONDROP_OFFSET UNITYSDK_OFFSET(0x1B0F6600)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDROPTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F6A50)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncDropTrigger_TypeDefinitionIndex = 27331;
