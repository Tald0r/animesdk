...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPOSTRENDERTRIGGER_GETONPOSTRENDERASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1B70E690)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPOSTRENDERTRIGGER_GETONPOSTRENDERASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1B70E5E0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPOSTRENDERTRIGGER_ONPOSTRENDERASYNC_1_OFFSET UNITYSDK_OFFSET(0x1B70E840)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPOSTRENDERTRIGGER_ONPOSTRENDERASYNC_OFFSET UNITYSDK_OFFSET(0x1B70E6F0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPOSTRENDERTRIGGER_ONPOSTRENDER_OFFSET UNITYSDK_OFFSET(0x1B70E5C0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCPOSTRENDERTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B70E950)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncPostRenderTrigger_TypeDefinitionIndex = 28223;
