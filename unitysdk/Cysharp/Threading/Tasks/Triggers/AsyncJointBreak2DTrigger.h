...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCJOINTBREAK2DTRIGGER_GETONJOINTBREAK2DASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1B14A420)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCJOINTBREAK2DTRIGGER_GETONJOINTBREAK2DASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1B14A340)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCJOINTBREAK2DTRIGGER_ONJOINTBREAK2DASYNC_1_OFFSET UNITYSDK_OFFSET(0x1B14A600)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCJOINTBREAK2DTRIGGER_ONJOINTBREAK2DASYNC_OFFSET UNITYSDK_OFFSET(0x1B14A480)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCJOINTBREAK2DTRIGGER_ONJOINTBREAK2D_OFFSET UNITYSDK_OFFSET(0x1B14A2D0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCJOINTBREAK2DTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14A720)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncJointBreak2DTrigger_TypeDefinitionIndex = 27259;
