...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDESELECTTRIGGER_GETONDESELECTASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1B046140)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDESELECTTRIGGER_GETONDESELECTASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1B046060)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDESELECTTRIGGER_ONDESELECTASYNC_1_OFFSET UNITYSDK_OFFSET(0x1B046320)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDESELECTTRIGGER_ONDESELECTASYNC_OFFSET UNITYSDK_OFFSET(0x1B0461A0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDESELECTTRIGGER_UNITYENGINE_EVENTSYSTEMS_IDESELECTHANDLER_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x1B045FF0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCDESELECTTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B046440)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncDeselectTrigger_TypeDefinitionIndex = 27327;
