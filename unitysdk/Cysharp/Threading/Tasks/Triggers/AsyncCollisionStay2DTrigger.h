...
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCOLLISIONSTAY2DTRIGGER_GETONCOLLISIONSTAY2DASYNCHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1B5BB810)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCOLLISIONSTAY2DTRIGGER_GETONCOLLISIONSTAY2DASYNCHANDLER_OFFSET UNITYSDK_OFFSET(0x1B5BB730)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCOLLISIONSTAY2DTRIGGER_ONCOLLISIONSTAY2DASYNC_1_OFFSET UNITYSDK_OFFSET(0x1B5BB9F0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCOLLISIONSTAY2DTRIGGER_ONCOLLISIONSTAY2DASYNC_OFFSET UNITYSDK_OFFSET(0x1B5BB870)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCOLLISIONSTAY2DTRIGGER_ONCOLLISIONSTAY2D_OFFSET UNITYSDK_OFFSET(0x1B5BB6C0)
#define CYSHARP_THREADING_TASKS_TRIGGERS_ASYNCCOLLISIONSTAY2DTRIGGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5BBB10)

namespace Cysharp::Threading::Tasks::Triggers
{
	inline static constexpr unsigned int AsyncCollisionStay2DTrigger_TypeDefinitionIndex = 28183;
