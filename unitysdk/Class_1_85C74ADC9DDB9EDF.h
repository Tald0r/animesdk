...
#define CLASS_1_85C74ADC9DDB9EDF_METHOD_1_4B5B0B4E28D31F7A_OFFSET UNITYSDK_OFFSET(0xA9FF780)
#define CLASS_1_85C74ADC9DDB9EDF_METHOD_1_B2C3C6DB5457B4DB_OFFSET UNITYSDK_OFFSET(0xA9FF800)
#define CLASS_1_85C74ADC9DDB9EDF_SYSTEM_ICOMPARABLE_MOLEMOLE_BATTLE_OPENCAMERASHOTBANNERREQUEST__COMPARETO_OFFSET UNITYSDK_OFFSET(0xA9FF700)
#define CLASS_1_85C74ADC9DDB9EDF__CCTOR_OFFSET UNITYSDK_OFFSET(0xA9FF770)
#define CLASS_1_85C74ADC9DDB9EDF__CTOR_OFFSET UNITYSDK_OFFSET(0xA9FF730)

inline static constexpr unsigned int Class_1_85C74ADC9DDB9EDF_TypeDefinitionIndex = 41619;
...
public:
	...
	{
		return (::System::Int64*)Il2CppClass::FromTypeDefinitionIndex(Class_1_85C74ADC9DDB9EDF_TypeDefinitionIndex)->GetStaticField(0x11740);
	}
