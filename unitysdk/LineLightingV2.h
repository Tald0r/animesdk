...
#define LINELIGHTINGV2_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B0E2D20)
#define LINELIGHTINGV2_COLLECTLINPOS_OFFSET UNITYSDK_OFFSET(0x1B0E37C0)
#define LINELIGHTINGV2_GETENABLE_OFFSET UNITYSDK_OFFSET(0x1B0E39E0)
#define LINELIGHTINGV2_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1B0E3A40)
#define LINELIGHTINGV2_INIT_OFFSET UNITYSDK_OFFSET(0x1B0E2E00)
#define LINELIGHTINGV2_SETCUSTOMSCALE_OFFSET UNITYSDK_OFFSET(0x1B0E39A0)
#define LINELIGHTINGV2_SETDYNAMICENDPOINT_OFFSET UNITYSDK_OFFSET(0x1B0E3960)
#define LINELIGHTINGV2_SETENABLE_OFFSET UNITYSDK_OFFSET(0x1B0E39B0)
#define LINELIGHTINGV2_SETLINELIGHTINGV2PARAM_OFFSET UNITYSDK_OFFSET(0x1B0E39F0)
#define LINELIGHTINGV2_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1B0E2F20)
#define LINELIGHTINGV2_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B0E2EE0)
#define LINELIGHTINGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E3A50)

inline static constexpr unsigned int LineLightingV2_TypeDefinitionIndex = 31603;
