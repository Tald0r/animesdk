...
#define LINELIGHTINGV2_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B6F3930)
#define LINELIGHTINGV2_COLLECTLINPOS_OFFSET UNITYSDK_OFFSET(0x1B6F43D0)
#define LINELIGHTINGV2_GETENABLE_OFFSET UNITYSDK_OFFSET(0x1B6F45F0)
#define LINELIGHTINGV2_GETLENGTH_OFFSET UNITYSDK_OFFSET(0x1B6F4650)
#define LINELIGHTINGV2_INIT_OFFSET UNITYSDK_OFFSET(0x1B6F3A10)
#define LINELIGHTINGV2_SETCUSTOMSCALE_OFFSET UNITYSDK_OFFSET(0x1B6F45B0)
#define LINELIGHTINGV2_SETDYNAMICENDPOINT_OFFSET UNITYSDK_OFFSET(0x1B6F4570)
#define LINELIGHTINGV2_SETENABLE_OFFSET UNITYSDK_OFFSET(0x1B6F45C0)
#define LINELIGHTINGV2_SETLINELIGHTINGV2PARAM_OFFSET UNITYSDK_OFFSET(0x1B6F4600)
#define LINELIGHTINGV2_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1B6F3B30)
#define LINELIGHTINGV2_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B6F3AF0)
#define LINELIGHTINGV2__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F4660)

inline static constexpr unsigned int LineLightingV2_TypeDefinitionIndex = 32557;
