...
#define CLASS_3_247B97EFF95C09A1_GETCLASSID_OFFSET UNITYSDK_OFFSET(0x9063700)
#define CLASS_3_247B97EFF95C09A1_METHOD_3_128774387667156B_OFFSET UNITYSDK_OFFSET(0x9063960)
#define CLASS_3_247B97EFF95C09A1_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0x9063900)
#define CLASS_3_247B97EFF95C09A1_METHOD_3_C2235B12D15AFAC5_OFFSET UNITYSDK_OFFSET(0x9063890)
#define CLASS_3_247B97EFF95C09A1_METHOD_3_CCBE730AF445BBD4_OFFSET UNITYSDK_OFFSET(0x90637F0)
#define CLASS_3_247B97EFF95C09A1_ONCLEAN_OFFSET UNITYSDK_OFFSET(0x9062E30)
#define CLASS_3_247B97EFF95C09A1_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9062E90)
#define CLASS_3_247B97EFF95C09A1__CCTOR_OFFSET UNITYSDK_OFFSET(0x9063760)
#define CLASS_3_247B97EFF95C09A1__CTOR_OFFSET UNITYSDK_OFFSET(0x90637E0)

inline static constexpr unsigned int Class_3_247B97EFF95C09A1_TypeDefinitionIndex = 73327;

class Class_3_247B97EFF95C09A1 : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_2 = 0xB1; // 0x0
	::Class_1_DACBF9026D8D91FB* Field_3_0; // 0x48
