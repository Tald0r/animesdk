...
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x173EF600)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x173EFBA0)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x173EFB40)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_RESETTRANSFORMMATRIX_OFFSET UNITYSDK_OFFSET(0x173EF9F0)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_SETTRANSFORMMATRIX_OFFSET UNITYSDK_OFFSET(0x173EF8A0)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x173EFBF0)

namespace UnityEditor::Rendering::Universal
{
	inline static constexpr unsigned int DynamicWorldTillingObjectProxy_TypeDefinitionIndex = 29176;
