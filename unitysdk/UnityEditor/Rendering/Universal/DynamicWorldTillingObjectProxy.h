...
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_INIT_OFFSET UNITYSDK_OFFSET(0x16D88490)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x16D88A30)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x16D889D0)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_RESETTRANSFORMMATRIX_OFFSET UNITYSDK_OFFSET(0x16D88880)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY_SETTRANSFORMMATRIX_OFFSET UNITYSDK_OFFSET(0x16D88730)
#define UNITYEDITOR_RENDERING_UNIVERSAL_DYNAMICWORLDTILLINGOBJECTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x16D88A80)

namespace UnityEditor::Rendering::Universal
{
	inline static constexpr unsigned int DynamicWorldTillingObjectProxy_TypeDefinitionIndex = 28235;
