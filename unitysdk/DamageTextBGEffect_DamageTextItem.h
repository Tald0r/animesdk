...
#define DAMAGETEXTBGEFFECT_DAMAGETEXTITEM_UPDATETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1931A3A0)
#define DAMAGETEXTBGEFFECT_DAMAGETEXTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1931A4B0)

inline static constexpr unsigned int DamageTextBGEffect_DamageTextItem_TypeDefinitionIndex = 28000;

class DamageTextBGEffect_DamageTextItem : public ::System::Object
{
public:
	::UnityEngine::Matrix4x4 trs; // 0x10
	::System::Single colorIndex; // 0x50
	::System::Single startTime; // 0x54
