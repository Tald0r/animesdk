...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETVERSION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5EE040)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETVERSION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5EE070)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETVERSION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5EDDA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETVERSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5EDD80)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_getVersion_TypeDefinitionIndex = 30507;
