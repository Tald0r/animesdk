...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTHEADERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B74A9F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTHEADERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B74AA70)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTHEADERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B74A660)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDREQUESTHEADERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B74A640)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_sendRequestHeaders_TypeDefinitionIndex = 30510;
