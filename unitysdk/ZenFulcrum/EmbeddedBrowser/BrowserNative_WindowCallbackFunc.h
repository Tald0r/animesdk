...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_WINDOWCALLBACKFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B415820)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_WINDOWCALLBACKFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B415890)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_WINDOWCALLBACKFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B4154E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_WINDOWCALLBACKFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4154C0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_WindowCallbackFunc_TypeDefinitionIndex = 30485;
