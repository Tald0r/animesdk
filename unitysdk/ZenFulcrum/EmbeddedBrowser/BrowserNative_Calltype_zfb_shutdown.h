...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHUTDOWN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5AB620)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHUTDOWN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5AB650)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHUTDOWN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5AA4B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHUTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5AB600)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_shutdown_TypeDefinitionIndex = 30517;
