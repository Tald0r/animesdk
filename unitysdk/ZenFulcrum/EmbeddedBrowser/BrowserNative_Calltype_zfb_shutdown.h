...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHUTDOWN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFA1B50)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHUTDOWN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFA1B80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHUTDOWN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFA0A20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SHUTDOWN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFA1B40)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_shutdown_TypeDefinitionIndex = 29564;
