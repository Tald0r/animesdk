...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER_JSRESULTFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AF1A020)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER_JSRESULTFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AF1A080)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER_JSRESULTFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AF19A30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER_JSRESULTFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF19A20)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int Browser_JSResultFunc_TypeDefinitionIndex = 29481;
