...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER_ONDESTROYFUN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B12EB70)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER_ONDESTROYFUN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B12EBA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER_ONDESTROYFUN_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B12E8D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER_ONDESTROYFUN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B12E8C0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int Browser_OnDestroyFun_TypeDefinitionIndex = 29482;
