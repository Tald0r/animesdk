...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GOTOURL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B74A1D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GOTOURL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B74A250)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GOTOURL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B749E40)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GOTOURL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B749E20)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_goToURL_TypeDefinitionIndex = 30534;
