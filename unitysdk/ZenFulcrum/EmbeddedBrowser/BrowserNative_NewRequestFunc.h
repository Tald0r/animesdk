...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NEWREQUESTFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE4CC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NEWREQUESTFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE4D20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NEWREQUESTFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFE4980)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NEWREQUESTFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE4970)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_NewRequestFunc_TypeDefinitionIndex = 29521;
