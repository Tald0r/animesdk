...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NEWREQUESTFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5EED30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NEWREQUESTFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5EED90)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NEWREQUESTFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5EE9F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NEWREQUESTFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5EE9D0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_NewRequestFunc_TypeDefinitionIndex = 30474;
