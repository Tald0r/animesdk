...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONTEXTMENUCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B746FF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONTEXTMENUCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B747050)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONTEXTMENUCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B746CB0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERCONTEXTMENUCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B746C90)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerContextMenuCallback_TypeDefinitionIndex = 30555;
