...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE___C__DISPLAYCLASS39_2__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADB2B40)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE___C__DISPLAYCLASS39_2__INITWEBVIEWASYNC_B__2_OFFSET UNITYSDK_OFFSET(0x1ADB2B50)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative___c__DisplayClass39_2_TypeDefinitionIndex = 29612;
