...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEBUTTON_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B60C890)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEBUTTON_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B60C960)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEBUTTON_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B60C510)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEBUTTON__CTOR_OFFSET UNITYSDK_OFFSET(0x1B60C4F0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_mouseButton_TypeDefinitionIndex = 30542;
