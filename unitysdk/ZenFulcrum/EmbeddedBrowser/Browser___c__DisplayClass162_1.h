...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS162_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5EDBC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS162_1__WHENREADY_B__0_OFFSET UNITYSDK_OFFSET(0x1B5EDBD0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int Browser___c__DisplayClass162_1_TypeDefinitionIndex = 30441;
