...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS248_0__CB_NAVSTATEFUNC_B__0_OFFSET UNITYSDK_OFFSET(0x1ADAFAE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS248_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADAFAD0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int Browser___c__DisplayClass248_0_TypeDefinitionIndex = 29511;
