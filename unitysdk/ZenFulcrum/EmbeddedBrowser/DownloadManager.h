...
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AF315A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_CANCELALL_OFFSET UNITYSDK_OFFSET(0x1AF32F10)
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_CLEARALL_OFFSET UNITYSDK_OFFSET(0x1AF330A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_GETUSERDOWNLOADFOLDER_OFFSET UNITYSDK_OFFSET(0x1AF31EF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x1AF32590)
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_HANDLEDOWNLOADSTARTED_OFFSET UNITYSDK_OFFSET(0x1AF317A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_HANDLEDOWNLOADSTATUS_OFFSET UNITYSDK_OFFSET(0x1AF32150)
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_MANAGEDOWNLOADS_OFFSET UNITYSDK_OFFSET(0x1AF31670)
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_PAUSEALL_OFFSET UNITYSDK_OFFSET(0x1AF32BF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_RESUMEALL_OFFSET UNITYSDK_OFFSET(0x1AF32D80)
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_SHGETKNOWNFOLDERPATH_OFFSET UNITYSDK_OFFSET(0x1AF330E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AF324F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_DOWNLOADMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF33180)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int DownloadManager_TypeDefinitionIndex = 29644;
