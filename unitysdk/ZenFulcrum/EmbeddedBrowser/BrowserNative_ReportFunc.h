...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_REPORTFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6B3B10)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_REPORTFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6B3BC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_REPORTFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6B3720)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_REPORTFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B3700)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_ReportFunc_TypeDefinitionIndex = 30484;
