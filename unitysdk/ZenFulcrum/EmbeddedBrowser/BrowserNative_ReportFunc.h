...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_REPORTFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A5C20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_REPORTFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A5CD0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_REPORTFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A5840)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_REPORTFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A5830)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_ReportFunc_TypeDefinitionIndex = 29531;
