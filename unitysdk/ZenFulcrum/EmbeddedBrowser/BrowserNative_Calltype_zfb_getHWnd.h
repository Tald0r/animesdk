...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETHWND_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B093F50)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETHWND_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B093FA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETHWND_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B093C50)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETHWND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B093C40)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_getHWnd_TypeDefinitionIndex = 29566;
