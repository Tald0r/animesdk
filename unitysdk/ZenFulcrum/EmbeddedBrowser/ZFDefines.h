...
#define ZENFULCRUM_EMBEDDEDBROWSER_ZFDEFINES_HASREPORTEVENTS_OFFSET UNITYSDK_OFFSET(0x1B6B4BA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_ZFDEFINES_HASREPORTEVENT_OFFSET UNITYSDK_OFFSET(0x1B6B4BD0)
#define ZENFULCRUM_EMBEDDEDBROWSER_ZFDEFINES_PARSEEVENTPARAM_OFFSET UNITYSDK_OFFSET(0x1B6B4B80)
#define ZENFULCRUM_EMBEDDEDBROWSER_ZFDEFINES_REPORTFRAMEPARAM1_OFFSET UNITYSDK_OFFSET(0x1B6B4B90)
#define ZENFULCRUM_EMBEDDEDBROWSER_ZFDEFINES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B4C00)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int ZFDefines_TypeDefinitionIndex = 30675;
