...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMCRASHTEST_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B490630)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMCRASHTEST_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B490680)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMCRASHTEST_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B490340)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMCRASHTEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1B490320)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setAPMCrashTest_TypeDefinitionIndex = 30501;
