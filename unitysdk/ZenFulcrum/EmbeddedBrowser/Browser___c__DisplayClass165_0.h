...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS165_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFF9AC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS165_0__SETGEOMETRY_B__0_OFFSET UNITYSDK_OFFSET(0x1AFF9AD0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int Browser___c__DisplayClass165_0_TypeDefinitionIndex = 29489;
