...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERDIALOGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AF2FF00)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERDIALOGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AF2FF60)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERDIALOGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AF2FBC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERDIALOGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF2FBB0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerDialogCallback_TypeDefinitionIndex = 29599;
