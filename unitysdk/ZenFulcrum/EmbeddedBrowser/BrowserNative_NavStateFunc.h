...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NAVSTATEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE7DE70)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NAVSTATEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE7DF40)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NAVSTATEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE7DAA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_NAVSTATEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE7DA90)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_NavStateFunc_TypeDefinitionIndex = 29530;
