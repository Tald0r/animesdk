...
#define ZENFULCRUM_EMBEDDEDBROWSER_PREDICATEWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B130230)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int PredicateWait_TypeDefinitionIndex = 29681;
