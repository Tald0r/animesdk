...
#define ZENFULCRUM_EMBEDDEDBROWSER_PREDICATEWAIT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B74AEB0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int PredicateWait_TypeDefinitionIndex = 30634;
