...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_SHOWCONTEXTMENUFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B54E9B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_SHOWCONTEXTMENUFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B54EA90)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_SHOWCONTEXTMENUFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B54E5E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_SHOWCONTEXTMENUFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B54E5C0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_ShowContextMenuFunc_TypeDefinitionIndex = 30481;
