...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CHANGELOADING_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B54CFB0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CHANGELOADING_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B54D040)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CHANGELOADING_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B54CC70)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CHANGELOADING__CTOR_OFFSET UNITYSDK_OFFSET(0x1B54CC50)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_changeLoading_TypeDefinitionIndex = 30538;
