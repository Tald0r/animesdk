...
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSBROWSERUI_CREATE_OFFSET UNITYSDK_OFFSET(0x1AF108D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSBROWSERUI_GET_LOOKRAY_OFFSET UNITYSDK_OFFSET(0x1AF10A60)
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSBROWSERUI_INPUTUPDATE_OFFSET UNITYSDK_OFFSET(0x1AF10CA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSBROWSERUI_SETCURSOR_OFFSET UNITYSDK_OFFSET(0x1AF10C60)
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSBROWSERUI_START_OFFSET UNITYSDK_OFFSET(0x1AF107F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_FPSBROWSERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF10CD0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int FPSBrowserUI_TypeDefinitionIndex = 29625;
