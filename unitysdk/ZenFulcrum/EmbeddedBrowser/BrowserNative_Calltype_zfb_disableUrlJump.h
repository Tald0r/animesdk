...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DISABLEURLJUMP_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A673EF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DISABLEURLJUMP_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A673F60)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DISABLEURLJUMP_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A66DC10)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DISABLEURLJUMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A673EE0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_disableUrlJump_TypeDefinitionIndex = 29575;
