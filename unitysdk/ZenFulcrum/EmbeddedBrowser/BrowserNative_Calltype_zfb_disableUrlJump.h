...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DISABLEURLJUMP_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AC1F1B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DISABLEURLJUMP_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AC1F220)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DISABLEURLJUMP_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AC18E90)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DISABLEURLJUMP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC1F190)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_disableUrlJump_TypeDefinitionIndex = 30528;
