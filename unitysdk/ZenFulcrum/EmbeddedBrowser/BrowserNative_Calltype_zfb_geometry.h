...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GEOMETRY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5272E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GEOMETRY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5273A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GEOMETRY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B526F10)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GEOMETRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B526EF0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_geometry_TypeDefinitionIndex = 30525;
