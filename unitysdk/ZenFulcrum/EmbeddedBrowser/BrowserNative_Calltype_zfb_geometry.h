...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GEOMETRY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AF0F260)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GEOMETRY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AF0F320)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GEOMETRY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AF0EE90)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GEOMETRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF0EE80)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_geometry_TypeDefinitionIndex = 29572;
