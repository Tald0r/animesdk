...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EDITCOOKIE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFC400)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EDITCOOKIE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFC4A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EDITCOOKIE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFC080)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EDITCOOKIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADFC070)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_editCookie_TypeDefinitionIndex = 29606;
