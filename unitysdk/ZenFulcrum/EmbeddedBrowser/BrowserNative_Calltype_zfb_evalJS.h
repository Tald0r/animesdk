...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EVALJS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AFA16B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EVALJS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AFA1760)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EVALJS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AFA12D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EVALJS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFA12C0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_evalJS_TypeDefinitionIndex = 29594;
