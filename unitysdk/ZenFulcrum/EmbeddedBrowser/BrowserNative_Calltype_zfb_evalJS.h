...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EVALJS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B5AB160)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EVALJS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B5AB210)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EVALJS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B5AAD80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_EVALJS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5AAD60)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_evalJS_TypeDefinitionIndex = 30547;
