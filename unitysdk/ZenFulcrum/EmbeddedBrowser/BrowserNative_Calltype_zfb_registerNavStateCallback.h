...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERNAVSTATECALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B48FEB0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERNAVSTATECALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B48FF10)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERNAVSTATECALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B48FB70)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_REGISTERNAVSTATECALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B48FB50)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_registerNavStateCallback_TypeDefinitionIndex = 30532;
