...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS231_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B2230)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS231_0__SETOVERLAY_B__0_OFFSET UNITYSDK_OFFSET(0x1B6B2240)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSER___C__DISPLAYCLASS231_0__SETOVERLAY_B__1_OFFSET UNITYSDK_OFFSET(0x1B6B2270)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int Browser___c__DisplayClass231_0_TypeDefinitionIndex = 30457;
