...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEMOVE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6EFB00)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEMOVE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6EFB90)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEMOVE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6EF7B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSEMOVE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6EF790)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_mouseMove_TypeDefinitionIndex = 30541;
