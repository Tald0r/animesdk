...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECUSTOMCURSOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AF0FBF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECUSTOMCURSOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AF0FCE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECUSTOMCURSOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AF0F7C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECUSTOMCURSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF0F7B0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_getMouseCustomCursor_TypeDefinitionIndex = 29598;
