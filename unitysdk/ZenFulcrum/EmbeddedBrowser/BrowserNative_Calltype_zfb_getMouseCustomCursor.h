...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECUSTOMCURSOR_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B527CA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECUSTOMCURSOR_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B527D90)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECUSTOMCURSOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B527870)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETMOUSECUSTOMCURSOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B527850)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_getMouseCustomCursor_TypeDefinitionIndex = 30551;
