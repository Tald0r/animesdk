...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CHARACTEREVENT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B749D80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CHARACTEREVENT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B749E10)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CHARACTEREVENT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B7499F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CHARACTEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7499D0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_characterEvent_TypeDefinitionIndex = 30545;
