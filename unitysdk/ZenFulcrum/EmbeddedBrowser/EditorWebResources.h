...
#define ZENFULCRUM_EMBEDDEDBROWSER_EDITORWEBRESOURCES_HANDLEREQUEST_OFFSET UNITYSDK_OFFSET(0x1B53B380)
#define ZENFULCRUM_EMBEDDEDBROWSER_EDITORWEBRESOURCES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B53B2C0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int EditorWebResources_TypeDefinitionIndex = 30600;
