...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NOOP_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6B2E90)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NOOP_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6B2EC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NOOP_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6B2BF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B2BD0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_noop_TypeDefinitionIndex = 30502;
