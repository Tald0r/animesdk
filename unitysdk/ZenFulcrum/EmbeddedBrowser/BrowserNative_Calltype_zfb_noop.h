...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NOOP_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A4FE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NOOP_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A5010)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NOOP_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A4D40)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_NOOP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A4D30)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_noop_TypeDefinitionIndex = 29549;
