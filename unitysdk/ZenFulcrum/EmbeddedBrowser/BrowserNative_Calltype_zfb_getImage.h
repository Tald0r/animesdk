...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETIMAGE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AF0F710)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETIMAGE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AF0F780)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETIMAGE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AF0F340)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_GETIMAGE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF0F330)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_getImage_TypeDefinitionIndex = 29578;
