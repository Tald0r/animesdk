...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETFOCUSED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AC1FDD0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETFOCUSED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AC1FE40)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETFOCUSED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AC16C30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETFOCUSED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AC1FDB0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setFocused_TypeDefinitionIndex = 30540;
