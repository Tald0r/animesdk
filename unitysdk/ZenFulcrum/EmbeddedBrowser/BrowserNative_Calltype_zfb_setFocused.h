...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETFOCUSED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A674AE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETFOCUSED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A674B50)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETFOCUSED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A66B9A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETFOCUSED__CTOR_OFFSET UNITYSDK_OFFSET(0x1A674AD0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setFocused_TypeDefinitionIndex = 29587;
