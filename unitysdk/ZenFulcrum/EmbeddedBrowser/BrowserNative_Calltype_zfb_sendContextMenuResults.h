...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCONTEXTMENURESULTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B12F970)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCONTEXTMENURESULTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B12F9E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCONTEXTMENURESULTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B12F630)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCONTEXTMENURESULTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B12F620)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_sendContextMenuResults_TypeDefinitionIndex = 29603;
