...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCONTEXTMENURESULTS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B74A5C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCONTEXTMENURESULTS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B74A630)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCONTEXTMENURESULTS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B74A280)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SENDCONTEXTMENURESULTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B74A260)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_sendContextMenuResults_TypeDefinitionIndex = 30556;
