...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CHANGEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B3C82E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CHANGEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B3C8380)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CHANGEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B3C7F50)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CHANGEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3C7F30)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_ChangeFunc_TypeDefinitionIndex = 30479;
