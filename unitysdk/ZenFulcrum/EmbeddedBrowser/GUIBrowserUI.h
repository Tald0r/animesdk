...
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B094C90)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_BROWSERCURSOR_OFFSET UNITYSDK_OFFSET(0x1B095E20)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_INPUTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B095E40)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_KEYBOARDHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1B095DF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_KEYEVENTS_OFFSET UNITYSDK_OFFSET(0x1B095E10)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_MOUSEBUTTONS_OFFSET UNITYSDK_OFFSET(0x1B095DB0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_MOUSEHASFOCUS_OFFSET UNITYSDK_OFFSET(0x1B095BD0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B095D90)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_GET_MOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x1B095DD0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_INPUTUPDATE_OFFSET UNITYSDK_OFFSET(0x1B095130)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONDESELECT_OFFSET UNITYSDK_OFFSET(0x1B095E70)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B094F70)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONGUI_OFFSET UNITYSDK_OFFSET(0x1B095BF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0x1B095EC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONPOINTERENTER_OFFSET UNITYSDK_OFFSET(0x1B095E80)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONPOINTEREXIT_OFFSET UNITYSDK_OFFSET(0x1B095EA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_ONSELECT_OFFSET UNITYSDK_OFFSET(0x1B095E60)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_SETCURSOR_OFFSET UNITYSDK_OFFSET(0x1B095CA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_SET_BROWSERCURSOR_OFFSET UNITYSDK_OFFSET(0x1B095E30)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_SET_INPUTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1B095E50)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_SET_MOUSEBUTTONS_OFFSET UNITYSDK_OFFSET(0x1B095DC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_SET_MOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x1B095DA0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_SET_MOUSESCROLL_OFFSET UNITYSDK_OFFSET(0x1B095DE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_UPDATETEXTURE_OFFSET UNITYSDK_OFFSET(0x1B095090)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI_WATCHRESIZE_OFFSET UNITYSDK_OFFSET(0x1B095040)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI__AWAKE_B__4_0_OFFSET UNITYSDK_OFFSET(0x1B095FD0)
#define ZENFULCRUM_EMBEDDEDBROWSER_GUIBROWSERUI__CTOR_OFFSET UNITYSDK_OFFSET(0x1B095F10)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int GUIBrowserUI_TypeDefinitionIndex = 29627;
