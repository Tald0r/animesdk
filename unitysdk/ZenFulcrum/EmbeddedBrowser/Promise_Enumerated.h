...
#define ZENFULCRUM_EMBEDDEDBROWSER_PROMISE_ENUMERATED_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B096090)
#define ZENFULCRUM_EMBEDDEDBROWSER_PROMISE_ENUMERATED_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B096000)
#define ZENFULCRUM_EMBEDDEDBROWSER_PROMISE_ENUMERATED_RESET_OFFSET UNITYSDK_OFFSET(0x1B096080)
#define ZENFULCRUM_EMBEDDEDBROWSER_PROMISE_ENUMERATED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B095FF0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int Promise_Enumerated_TypeDefinitionIndex = 29694;
