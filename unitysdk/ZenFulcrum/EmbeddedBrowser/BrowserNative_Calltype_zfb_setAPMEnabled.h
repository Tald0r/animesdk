...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMENABLED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AE7CDC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMENABLED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AE7CDF0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMENABLED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AE7C8C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETAPMENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE7C8B0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setAPMEnabled_TypeDefinitionIndex = 29547;
