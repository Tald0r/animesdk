...
#define ZENFULCRUM_EMBEDDEDBROWSER_CURSORRENDERERWORLDSPACE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B0A5CE0)
#define ZENFULCRUM_EMBEDDEDBROWSER_CURSORRENDERERWORLDSPACE_CURSORCHANGE_OFFSET UNITYSDK_OFFSET(0x1B0A6170)
#define ZENFULCRUM_EMBEDDEDBROWSER_CURSORRENDERERWORLDSPACE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B0A6420)
#define ZENFULCRUM_EMBEDDEDBROWSER_CURSORRENDERERWORLDSPACE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B0A6650)
#define ZENFULCRUM_EMBEDDEDBROWSER_CURSORRENDERERWORLDSPACE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A66B0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int CursorRendererWorldSpace_TypeDefinitionIndex = 29619;
