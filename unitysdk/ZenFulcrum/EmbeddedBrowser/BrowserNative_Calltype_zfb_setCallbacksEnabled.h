...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETCALLBACKSENABLED_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B490F80)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETCALLBACKSENABLED_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B490FD0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETCALLBACKSENABLED_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B490C10)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_SETCALLBACKSENABLED__CTOR_OFFSET UNITYSDK_OFFSET(0x1B490BF0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_setCallbacksEnabled_TypeDefinitionIndex = 30512;
