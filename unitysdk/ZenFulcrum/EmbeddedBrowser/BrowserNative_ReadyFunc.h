...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_READYFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFD090)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_READYFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFD0E0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_READYFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFCD90)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_READYFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADFCD80)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_ReadyFunc_TypeDefinitionIndex = 29522;
