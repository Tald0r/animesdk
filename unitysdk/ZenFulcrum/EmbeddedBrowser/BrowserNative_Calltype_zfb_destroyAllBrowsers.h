...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A673E30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A673E60)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A673B90)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DESTROYALLBROWSERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A673B80)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_destroyAllBrowsers_TypeDefinitionIndex = 29560;
