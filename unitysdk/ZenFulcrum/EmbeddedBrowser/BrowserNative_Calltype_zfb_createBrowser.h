...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CREATEBROWSER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFBFD0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CREATEBROWSER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFC040)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CREATEBROWSER_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADFB4B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_CREATEBROWSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADFBFC0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_createBrowser_TypeDefinitionIndex = 29565;
