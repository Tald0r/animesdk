...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CONSOLEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A5790)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CONSOLEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A5820)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CONSOLEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A5400)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CONSOLEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A53F0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_ConsoleFunc_TypeDefinitionIndex = 29523;
