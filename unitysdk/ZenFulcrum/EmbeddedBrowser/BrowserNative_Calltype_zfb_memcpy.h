...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MEMCPY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0E04D0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MEMCPY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0E0560)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MEMCPY_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0E0130)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MEMCPY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E0120)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_memcpy_TypeDefinitionIndex = 29553;
