...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSESCROLL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A4C90)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSESCROLL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A4D20)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSESCROLL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A4910)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSESCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A4900)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_mouseScroll_TypeDefinitionIndex = 29590;
