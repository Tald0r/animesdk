...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSESCROLL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6B2B30)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSESCROLL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6B2BC0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSESCROLL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6B27A0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_MOUSESCROLL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B2780)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_mouseScroll_TypeDefinitionIndex = 30543;
