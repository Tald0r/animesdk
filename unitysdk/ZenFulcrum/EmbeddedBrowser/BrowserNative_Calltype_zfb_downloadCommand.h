...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DOWNLOADCOMMAND_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A4830)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DOWNLOADCOMMAND_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A48F0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DOWNLOADCOMMAND_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0A4450)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DOWNLOADCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0A4440)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_downloadCommand_TypeDefinitionIndex = 29608;
