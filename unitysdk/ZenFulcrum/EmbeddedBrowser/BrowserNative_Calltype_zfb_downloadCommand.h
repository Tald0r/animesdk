...
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DOWNLOADCOMMAND_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6B26B0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DOWNLOADCOMMAND_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6B2770)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DOWNLOADCOMMAND_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6B22C0)
#define ZENFULCRUM_EMBEDDEDBROWSER_BROWSERNATIVE_CALLTYPE_ZFB_DOWNLOADCOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6B22A0)

namespace ZenFulcrum::EmbeddedBrowser
{
	inline static constexpr unsigned int BrowserNative_Calltype_zfb_downloadCommand_TypeDefinitionIndex = 30561;
