...
#define AKBANK_AWAKE_OFFSET UNITYSDK_OFFSET(0x1B6249A0)
#define AKBANK_GET_BANKNAME_OFFSET UNITYSDK_OFFSET(0x1B624C80)
#define AKBANK_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1B624CE0)
#define AKBANK_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1B624B30)
#define AKBANK_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B624B80)
#define AKBANK_START_OFFSET UNITYSDK_OFFSET(0x1B624A90)
#define AKBANK_UNLOADBANK_OFFSET UNITYSDK_OFFSET(0x1B624B10)
#define AKBANK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B624E10)

inline static constexpr unsigned int AkBank_TypeDefinitionIndex = 31056;
