...
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8DC3B0)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x8DC2D0)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8DC220)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x8DC4E0)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO_METHOD_2_7B1F794631F58D6D_OFFSET UNITYSDK_OFFSET(0x19AFF4D0)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x8DC470)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x8DC190)

namespace BinaryBundleLib::Runtime
{
	inline static constexpr unsigned int BinaryBundleFileInfo_TypeDefinitionIndex = 30894;
