...
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x909B60)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x909A80)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9099D0)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x909C20)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO_METHOD_2_7B1F794631F58D6D_OFFSET UNITYSDK_OFFSET(0x1A0D9460)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x909C90)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x909940)

namespace BinaryBundleLib::Runtime
{
	inline static constexpr unsigned int BinaryBundleFileInfo_TypeDefinitionIndex = 31835;
