...
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8DBF20)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x8DBF10)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8DBF00)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_METHOD_2_6D0360BD23602584_OFFSET UNITYSDK_OFFSET(0x8DC110)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO_METHOD_2_95780ED94B90ED36_OFFSET UNITYSDK_OFFSET(0x8DC0A0)
#define BINARYBUNDLELIB_RUNTIME_BINARYBUNDLEFILEENTRYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x575E10)

namespace BinaryBundleLib::Runtime
{
	inline static constexpr unsigned int BinaryBundleFileEntryInfo_TypeDefinitionIndex = 30889;
