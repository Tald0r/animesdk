...
#define SRDEBUGGER_TESTER_UICTRLREFLECTPROXY_FINDOPENDIALOGMETHOD_OFFSET UNITYSDK_OFFSET(0x11B25150)
#define SRDEBUGGER_TESTER_UICTRLREFLECTPROXY_FINDOPENPAGEMETHOD_OFFSET UNITYSDK_OFFSET(0x11B24F30)
#define SRDEBUGGER_TESTER_UICTRLREFLECTPROXY_INVOKEOPENDIALOGMETHOD_OFFSET UNITYSDK_OFFSET(0x11B25740)
#define SRDEBUGGER_TESTER_UICTRLREFLECTPROXY_INVOKEOPENMETHOD_INNER_OFFSET UNITYSDK_OFFSET(0x11B25400)
#define SRDEBUGGER_TESTER_UICTRLREFLECTPROXY_INVOKEOPENPAGEMETHOD_OFFSET UNITYSDK_OFFSET(0x11B25370)
#define SRDEBUGGER_TESTER_UICTRLREFLECTPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x11B257D0)

namespace SRDebugger::Tester
{
	inline static constexpr unsigned int UICtrlReflectProxy_TypeDefinitionIndex = 84233;
