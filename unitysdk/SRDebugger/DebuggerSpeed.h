...
#define SRDEBUGGER_DEBUGGERSPEED_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x124A7D10)
#define SRDEBUGGER_DEBUGGERSPEED_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x124A7AD0)
#define SRDEBUGGER_DEBUGGERSPEED_UPDATE_OFFSET UNITYSDK_OFFSET(0x124A7890)
#define SRDEBUGGER_DEBUGGERSPEED__CTOR_OFFSET UNITYSDK_OFFSET(0x124A7F50)

namespace SRDebugger
{
	inline static constexpr unsigned int DebuggerSpeed_TypeDefinitionIndex = 82123;
