...
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR_EVALEXPR_OFFSET UNITYSDK_OFFSET(0x8D6B340)
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR_EVALRPN_OFFSET UNITYSDK_OFFSET(0x8D6B500)
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR_INTERPOLATEBRACES_OFFSET UNITYSDK_OFFSET(0x8D6B090)
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x8D6B660)

namespace ExpressionV2
{
	inline static constexpr unsigned int ComplexExpressionEvaluator_TypeDefinitionIndex = 61016;
