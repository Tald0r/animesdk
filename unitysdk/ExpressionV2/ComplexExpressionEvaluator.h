...
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR_EVALEXPR_OFFSET UNITYSDK_OFFSET(0x9996FC0)
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR_EVALRPN_OFFSET UNITYSDK_OFFSET(0x9997180)
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR_INTERPOLATEBRACES_OFFSET UNITYSDK_OFFSET(0x9996D10)
#define EXPRESSIONV2_COMPLEXEXPRESSIONEVALUATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x99972E0)

namespace ExpressionV2
{
	inline static constexpr unsigned int ComplexExpressionEvaluator_TypeDefinitionIndex = 50264;
