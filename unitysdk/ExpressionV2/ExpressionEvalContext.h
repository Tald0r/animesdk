...
#define EXPRESSIONV2_EXPRESSIONEVALCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x9C37670)

namespace ExpressionV2
{
	inline static constexpr unsigned int ExpressionEvalContext_TypeDefinitionIndex = 62685;
	...
	public:
		...
		::Class_2_14986121AA61AD99* abilityParam; // 0x20
