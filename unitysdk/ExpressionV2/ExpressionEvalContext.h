...
#define EXPRESSIONV2_EXPRESSIONEVALCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x6C0DBA0)

namespace ExpressionV2
{
	inline static constexpr unsigned int ExpressionEvalContext_TypeDefinitionIndex = 67534;
