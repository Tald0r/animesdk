...
#define EXPRESSIONV2_EXPRESSIONCOMPILER_COMPILE_OFFSET UNITYSDK_OFFSET(0xA767E40)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_DEINIT_OFFSET UNITYSDK_OFFSET(0xA7679C0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_FINALIZE_OFFSET UNITYSDK_OFFSET(0xA767950)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_GETRPNCOUNT_OFFSET UNITYSDK_OFFSET(0xA76B190)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_GETRPN_OFFSET UNITYSDK_OFFSET(0xA76B1F0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_ISDIGIT_OFFSET UNITYSDK_OFFSET(0xA767D50)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_ISLETTERORDIGIT_OFFSET UNITYSDK_OFFSET(0xA767DC0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_ISLETTER_OFFSET UNITYSDK_OFFSET(0xA767CE0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_ISWHITESPACE_OFFSET UNITYSDK_OFFSET(0xA767C70)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_RECOMPILE_OFFSET UNITYSDK_OFFSET(0xA76B250)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_RETURNTOKEN_OFFSET UNITYSDK_OFFSET(0xA767B60)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_TOKENCREATOR_OFFSET UNITYSDK_OFFSET(0xA767AE0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_TOKENIZE_OFFSET UNITYSDK_OFFSET(0xA768020)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_TORPN_OFFSET UNITYSDK_OFFSET(0xA76A480)
#define EXPRESSIONV2_EXPRESSIONCOMPILER__CCTOR_OFFSET UNITYSDK_OFFSET(0xA76B3C0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0xA76B3B0)

namespace ExpressionV2
{
	inline static constexpr unsigned int ExpressionCompiler_TypeDefinitionIndex = 38611;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Stack_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(ExpressionCompiler_TypeDefinitionIndex)->GetStaticField(0x42650);
		}
		static ::ExpressionV2::ExpressionCompiler_ExpressionMode* StaticGet_Mode()
		{
			return (::ExpressionV2::ExpressionCompiler_ExpressionMode*)Il2CppClass::FromTypeDefinitionIndex(ExpressionCompiler_TypeDefinitionIndex)->GetStaticField(0x102C0);
		}
