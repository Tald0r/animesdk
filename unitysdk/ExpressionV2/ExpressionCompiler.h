...
#define EXPRESSIONV2_EXPRESSIONCOMPILER_COMPILE_OFFSET UNITYSDK_OFFSET(0x82A3B90)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_DEINIT_OFFSET UNITYSDK_OFFSET(0x82A3710)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_FINALIZE_OFFSET UNITYSDK_OFFSET(0x82A36A0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_GETRPNCOUNT_OFFSET UNITYSDK_OFFSET(0x82A6EE0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_GETRPN_OFFSET UNITYSDK_OFFSET(0x82A6F40)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_ISDIGIT_OFFSET UNITYSDK_OFFSET(0x82A3AA0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_ISLETTERORDIGIT_OFFSET UNITYSDK_OFFSET(0x82A3B10)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_ISLETTER_OFFSET UNITYSDK_OFFSET(0x82A3A30)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_ISWHITESPACE_OFFSET UNITYSDK_OFFSET(0x82A39C0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_RECOMPILE_OFFSET UNITYSDK_OFFSET(0x82A6FA0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_RETURNTOKEN_OFFSET UNITYSDK_OFFSET(0x82A38B0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_TOKENCREATOR_OFFSET UNITYSDK_OFFSET(0x82A3830)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_TOKENIZE_OFFSET UNITYSDK_OFFSET(0x82A3D70)
#define EXPRESSIONV2_EXPRESSIONCOMPILER_TORPN_OFFSET UNITYSDK_OFFSET(0x82A61D0)
#define EXPRESSIONV2_EXPRESSIONCOMPILER__CCTOR_OFFSET UNITYSDK_OFFSET(0x82A7110)
#define EXPRESSIONV2_EXPRESSIONCOMPILER__CTOR_OFFSET UNITYSDK_OFFSET(0x82A7100)

namespace ExpressionV2
{
	inline static constexpr unsigned int ExpressionCompiler_TypeDefinitionIndex = 69900;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Stack_1<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(ExpressionCompiler_TypeDefinitionIndex)->GetStaticField(0x42CF0);
		}
		static ::ExpressionV2::ExpressionCompiler_ExpressionMode* StaticGet_Mode()
		{
			return (::ExpressionV2::ExpressionCompiler_ExpressionMode*)Il2CppClass::FromTypeDefinitionIndex(ExpressionCompiler_TypeDefinitionIndex)->GetStaticField(0x10A00);
		}
		::System::Buffers::ArrayPool_1<::ExpressionV2::Token*>* pool4; // 0x10
		::Il2CppArray<::ExpressionV2::Token*>* buf2; // 0x18
		::Il2CppArray<::ExpressionV2::Token*>* rpn2; // 0x20
		::System::Buffers::ArrayPool_1<::ExpressionV2::Token*>* pool3; // 0x28
		::System::Int32 rpnCount2; // 0x30
		::System::Int32 count2; // 0x34
		::System::Boolean hasDispose; // 0x38
