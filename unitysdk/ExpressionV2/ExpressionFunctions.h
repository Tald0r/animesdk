...
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_ACTORPROPERTY_OFFSET UNITYSDK_OFFSET(0x818A860)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_AVATARSKILLLEVEL_OFFSET UNITYSDK_OFFSET(0x818BC10)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_CALL_OFFSET UNITYSDK_OFFSET(0x8188140)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_CARDTYPE_OFFSET UNITYSDK_OFFSET(0x818A390)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_CONCAT_OFFSET UNITYSDK_OFFSET(0x8188910)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETAVATARAUDIOEVENTNAME_OFFSET UNITYSDK_OFFSET(0x818C3C0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETAVATARNAME_OFFSET UNITYSDK_OFFSET(0x818B1E0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETAVATARTAG_OFFSET UNITYSDK_OFFSET(0x818C080)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETBUDDYCOUNT_OFFSET UNITYSDK_OFFSET(0x818B7A0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETINDEX_OFFSET UNITYSDK_OFFSET(0x818AA90)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETPOS_OFFSET UNITYSDK_OFFSET(0x818AC50)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_GETSTRING_OFFSET UNITYSDK_OFFSET(0x818B100)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_HOLLOWLEVEL_OFFSET UNITYSDK_OFFSET(0x818A6C0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_IF_OFFSET UNITYSDK_OFFSET(0x8188B20)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_ITEMTYPE_OFFSET UNITYSDK_OFFSET(0x8189F90)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_ITEM_OFFSET UNITYSDK_OFFSET(0x8188390)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_MAX_OFFSET UNITYSDK_OFFSET(0x8188780)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_MIN_OFFSET UNITYSDK_OFFSET(0x81885F0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_PLAYERPOS_OFFSET UNITYSDK_OFFSET(0x818AB70)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_PROPERTYID_OFFSET UNITYSDK_OFFSET(0x818B350)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_PROPERTY_OFFSET UNITYSDK_OFFSET(0x8188C40)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_RAND_OFFSET UNITYSDK_OFFSET(0x8189E90)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_SCENEPROPERTY_OFFSET UNITYSDK_OFFSET(0x8189AD0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_SCENEVAR_OFFSET UNITYSDK_OFFSET(0x81890F0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_SEPCIALS_OFFSET UNITYSDK_OFFSET(0x8188F30)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_SQRT_OFFSET UNITYSDK_OFFSET(0x81882A0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_TEAMPROPERTY_OFFSET UNITYSDK_OFFSET(0x818AD30)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS_TRASHREMAINSIZE_OFFSET UNITYSDK_OFFSET(0x818B5C0)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS__CCTOR_OFFSET UNITYSDK_OFFSET(0x8187B50)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x818C530)
#define EXPRESSIONV2_EXPRESSIONFUNCTIONS__GETSCENEPROPERTY_OFFSET UNITYSDK_OFFSET(0x8189950)

namespace ExpressionV2
{
	inline static constexpr unsigned int ExpressionFunctions_TypeDefinitionIndex = 46916;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::System::Func_4<::Il2CppArray<::ExpressionV2::ExprValue>*, ::System::Int32, ::ExpressionV2::ExpressionEvalContext*, ::ExpressionV2::ExprValue>*>**)Il2CppClass::FromTypeDefinitionIndex(ExpressionFunctions_TypeDefinitionIndex)->GetStaticField(0x40AF0);
		}
