...
#define EXPRESSIONV2_TOKEN_INIT_1_OFFSET UNITYSDK_OFFSET(0xAA46FC0)
#define EXPRESSIONV2_TOKEN_INIT_2_OFFSET UNITYSDK_OFFSET(0xAA47040)
#define EXPRESSIONV2_TOKEN_INIT_3_OFFSET UNITYSDK_OFFSET(0xAA470C0)
#define EXPRESSIONV2_TOKEN_INIT_4_OFFSET UNITYSDK_OFFSET(0xAA47140)
#define EXPRESSIONV2_TOKEN_INIT_OFFSET UNITYSDK_OFFSET(0xAA46F50)
#define EXPRESSIONV2_TOKEN__CTOR_OFFSET UNITYSDK_OFFSET(0xAA46F40)

namespace ExpressionV2
{
	inline static constexpr unsigned int Token_TypeDefinitionIndex = 71951;
	...
	public:
		...
		::ExpressionV2::TokenType Type; // 0x1C
		::System::UInt16 OperatorOpCode; // 0x20
		::System::Boolean IsUnary; // 0x22
		::System::Int32 OperatorPrecedence; // 0x24
