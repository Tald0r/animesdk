...
#define MONOANIMATIONHDRPROPERTY_APPLY_OFFSET UNITYSDK_OFFSET(0x7926670)
#define MONOANIMATIONHDRPROPERTY_FETCHALLRENDERERS_OFFSET UNITYSDK_OFFSET(0x7925B50)
#define MONOANIMATIONHDRPROPERTY_INIT_OFFSET UNITYSDK_OFFSET(0x7925D60)
#define MONOANIMATIONHDRPROPERTY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7926600)
#define MONOANIMATIONHDRPROPERTY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x7925CF0)
#define MONOANIMATIONHDRPROPERTY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x79275B0)
#define MONOANIMATIONHDRPROPERTY_SHOWRENDERERS_OFFSET UNITYSDK_OFFSET(0x7925C80)
#define MONOANIMATIONHDRPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x7927620)

inline static constexpr unsigned int MonoAnimationHDRProperty_TypeDefinitionIndex = 51095;
