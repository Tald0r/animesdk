...
#define MONOANIMATIONHDRPROPERTY_APPLY_OFFSET UNITYSDK_OFFSET(0x644EDE0)
#define MONOANIMATIONHDRPROPERTY_FETCHALLRENDERERS_OFFSET UNITYSDK_OFFSET(0x644E2A0)
#define MONOANIMATIONHDRPROPERTY_INIT_OFFSET UNITYSDK_OFFSET(0x644E4C0)
#define MONOANIMATIONHDRPROPERTY_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x644ED70)
#define MONOANIMATIONHDRPROPERTY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x644E450)
#define MONOANIMATIONHDRPROPERTY_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x644FD20)
#define MONOANIMATIONHDRPROPERTY_SHOWRENDERERS_OFFSET UNITYSDK_OFFSET(0x644E3E0)
#define MONOANIMATIONHDRPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x644FD90)

inline static constexpr unsigned int MonoAnimationHDRProperty_TypeDefinitionIndex = 62614;
