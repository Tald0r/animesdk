...
#define FLUFFYUNDERWARE_DEVTOOLS_ENUMSELECTIONGRIDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A240440)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int EnumSelectionGridAttribute_TypeDefinitionIndex = 24536;
