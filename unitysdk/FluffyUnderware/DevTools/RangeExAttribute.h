...
#define FLUFFYUNDERWARE_DEVTOOLS_RANGEEXATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A80E410)
#define FLUFFYUNDERWARE_DEVTOOLS_RANGEEXATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A80E440)
#define FLUFFYUNDERWARE_DEVTOOLS_RANGEEXATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A80E470)
#define FLUFFYUNDERWARE_DEVTOOLS_RANGEEXATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80E3E0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int RangeExAttribute_TypeDefinitionIndex = 25355;
