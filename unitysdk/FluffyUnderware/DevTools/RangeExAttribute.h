...
#define FLUFFYUNDERWARE_DEVTOOLS_RANGEEXATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A246B00)
#define FLUFFYUNDERWARE_DEVTOOLS_RANGEEXATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A246B30)
#define FLUFFYUNDERWARE_DEVTOOLS_RANGEEXATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A246B60)
#define FLUFFYUNDERWARE_DEVTOOLS_RANGEEXATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A246AD0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int RangeExAttribute_TypeDefinitionIndex = 24530;
