...
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2440C0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int FloatRegionAttribute_TypeDefinitionIndex = 24538;
