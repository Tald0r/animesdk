...
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A80B3B0)
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A80B3C0)
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A80B3D0)
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80B370)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int FieldConditionAttribute_TypeDefinitionIndex = 25321;
