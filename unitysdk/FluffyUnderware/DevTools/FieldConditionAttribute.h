...
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A243AA0)
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A243AB0)
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A243AC0)
#define FLUFFYUNDERWARE_DEVTOOLS_FIELDCONDITIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A243A60)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int FieldConditionAttribute_TypeDefinitionIndex = 24496;
