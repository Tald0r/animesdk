...
#define FLUFFYUNDERWARE_DEVTOOLS_QUEUEDCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A246AC0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int QueuedCallback_TypeDefinitionIndex = 24542;
