...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_AREA_1_OFFSET UNITYSDK_OFFSET(0x1A2411E0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_AREA_OFFSET UNITYSDK_OFFSET(0x1A241170)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_HORIZONTAL_1_OFFSET UNITYSDK_OFFSET(0x1A241290)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_HORIZONTAL_OFFSET UNITYSDK_OFFSET(0x1A241220)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GUILAYOUTEXTENSION_SCROLLVIEW_OFFSET UNITYSDK_OFFSET(0x1A2412C0)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int GUILayoutExtension_TypeDefinitionIndex = 24581;
