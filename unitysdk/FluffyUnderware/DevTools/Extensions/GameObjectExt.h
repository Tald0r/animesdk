...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GAMEOBJECTEXT_DUPLICATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A808C30)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GAMEOBJECTEXT_STRIPCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1A808280)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GAMEOBJECTEXT_UNDOABLECREATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A808D60)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int GameObjectExt_TypeDefinitionIndex = 25395;
