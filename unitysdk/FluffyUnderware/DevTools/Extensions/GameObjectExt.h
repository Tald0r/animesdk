...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GAMEOBJECTEXT_DUPLICATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A241320)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GAMEOBJECTEXT_STRIPCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1A240970)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_GAMEOBJECTEXT_UNDOABLECREATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A241450)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int GameObjectExt_TypeDefinitionIndex = 24570;
