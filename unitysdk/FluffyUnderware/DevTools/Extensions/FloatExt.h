...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_FLOATEXT_ISBETWEEN0AND1_OFFSET UNITYSDK_OFFSET(0x1A2410C0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_FLOATEXT_ISBETWEEN_OFFSET UNITYSDK_OFFSET(0x1A2410E0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_FLOATEXT_REPEAT_OFFSET UNITYSDK_OFFSET(0x1A241100)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int FloatExt_TypeDefinitionIndex = 24566;
