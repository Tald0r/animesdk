...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_OBJECTEXT_DESTROY_1_OFFSET UNITYSDK_OFFSET(0x1A2402A0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_OBJECTEXT_DESTROY_OFFSET UNITYSDK_OFFSET(0x1A241F90)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_OBJECTEXT_TODUMPSTRING_OFFSET UNITYSDK_OFFSET(0x1A241FB0)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int ObjectExt_TypeDefinitionIndex = 24565;
