...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_ANGLESIGNED_OFFSET UNITYSDK_OFFSET(0x1A80AF10)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1A80B110)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_NOTAPPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1A80B220)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_ROTATEAROUND_OFFSET UNITYSDK_OFFSET(0x1A80AFA0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR3EXT_TOVECTOR2_OFFSET UNITYSDK_OFFSET(0x1A80B100)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int Vector3Ext_TypeDefinitionIndex = 25393;
