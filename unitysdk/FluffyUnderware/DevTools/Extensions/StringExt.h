...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_STRINGEXT_COLORFROMHTML_OFFSET UNITYSDK_OFFSET(0x1A809BB0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_STRINGEXT_TRIMEND_OFFSET UNITYSDK_OFFSET(0x1A809F00)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_STRINGEXT_TRIMSTART_OFFSET UNITYSDK_OFFSET(0x1A809EB0)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int StringExt_TypeDefinitionIndex = 25400;
