...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_STRINGEXT_COLORFROMHTML_OFFSET UNITYSDK_OFFSET(0x1A2422A0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_STRINGEXT_TRIMEND_OFFSET UNITYSDK_OFFSET(0x1A2425F0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_STRINGEXT_TRIMSTART_OFFSET UNITYSDK_OFFSET(0x1A2425A0)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int StringExt_TypeDefinitionIndex = 24575;
