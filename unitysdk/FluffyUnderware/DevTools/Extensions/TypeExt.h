...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_FIELDBYNAME_OFFSET UNITYSDK_OFFSET(0x1A8019D0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_FINDIENUMERABLE_OFFSET UNITYSDK_OFFSET(0x1A80A7E0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETALLFIELDS_OFFSET UNITYSDK_OFFSET(0x1A803340)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETALLPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1A804310)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETENUMERABLETYPE_OFFSET UNITYSDK_OFFSET(0x1A804540)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETFIELDINCLUDINGBASECLASSES_OFFSET UNITYSDK_OFFSET(0x1A80A410)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETLOADEDASSEMBLIES_OFFSET UNITYSDK_OFFSET(0x1A80A180)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETLOADEDTYPES_OFFSET UNITYSDK_OFFSET(0x1A800790)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETMETHODINCLUDINGBASECLASSES_OFFSET UNITYSDK_OFFSET(0x1A80A270)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_GETPROPERTYINCLUDINGBASECLASSES_OFFSET UNITYSDK_OFFSET(0x1A80A530)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_ISARRAYORLIST_OFFSET UNITYSDK_OFFSET(0x1A80A760)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_ISFRAMEWORKTYPE_OFFSET UNITYSDK_OFFSET(0x1A80A6B0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_MATCHES_OFFSET UNITYSDK_OFFSET(0x1A80ABC0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_METHODBYNAME_OFFSET UNITYSDK_OFFSET(0x1A7FFF80)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TYPEEXT_PROPERTYBYNAME_OFFSET UNITYSDK_OFFSET(0x1A801A10)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int TypeExt_TypeDefinitionIndex = 25404;
