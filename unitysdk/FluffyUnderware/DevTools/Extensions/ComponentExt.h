...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_COMPONENTEXT_ADDCHILDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A808410)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_COMPONENTEXT_DUPLICATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A8084A0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_COMPONENTEXT_STRIPCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1A808180)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int ComponentExt_TypeDefinitionIndex = 25396;
