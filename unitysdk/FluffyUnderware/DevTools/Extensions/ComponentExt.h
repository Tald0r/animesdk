...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_COMPONENTEXT_ADDCHILDGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A240B00)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_COMPONENTEXT_DUPLICATEGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A240B90)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_COMPONENTEXT_STRIPCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1A240870)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int ComponentExt_TypeDefinitionIndex = 24571;
