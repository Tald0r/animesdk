...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TRANSFORMEXT_DELETECHILDREN_OFFSET UNITYSDK_OFFSET(0x1A809F70)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TRANSFORMEXT_DESTROYOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A80A070)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_TRANSFORMEXT_UNDOABLESETPARENT_OFFSET UNITYSDK_OFFSET(0x1A809F50)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int TransformExt_TypeDefinitionIndex = 25388;
