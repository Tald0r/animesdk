...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_ANGLESIGNED_OFFSET UNITYSDK_OFFSET(0x1A80AD20)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_LEFTNORMAL_OFFSET UNITYSDK_OFFSET(0x1A80AE50)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_RIGHTNORMAL_OFFSET UNITYSDK_OFFSET(0x1A80AE70)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_ROTATE_OFFSET UNITYSDK_OFFSET(0x1A80AE80)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_SNAP_OFFSET UNITYSDK_OFFSET(0x1A80ACA0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_TOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1A80AF00)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int Vector2Ext_TypeDefinitionIndex = 25392;
