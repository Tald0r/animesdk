...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_ANGLESIGNED_OFFSET UNITYSDK_OFFSET(0x1A243410)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_LEFTNORMAL_OFFSET UNITYSDK_OFFSET(0x1A243540)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_RIGHTNORMAL_OFFSET UNITYSDK_OFFSET(0x1A243560)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_ROTATE_OFFSET UNITYSDK_OFFSET(0x1A243570)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_SNAP_OFFSET UNITYSDK_OFFSET(0x1A243390)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_VECTOR2EXT_TOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1A2435F0)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int Vector2Ext_TypeDefinitionIndex = 24567;
