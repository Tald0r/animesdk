...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_GETSIZE_OFFSET UNITYSDK_OFFSET(0x1A242180)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_INCLUDE_OFFSET UNITYSDK_OFFSET(0x1A242270)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SCALEBY_1_OFFSET UNITYSDK_OFFSET(0x1A2421E0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SCALEBY_OFFSET UNITYSDK_OFFSET(0x1A2421B0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SETBETWEEN_OFFSET UNITYSDK_OFFSET(0x1A2420F0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SETPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1A242160)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A242140)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SETSIZE_OFFSET UNITYSDK_OFFSET(0x1A242190)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SET_OFFSET UNITYSDK_OFFSET(0x1A2420C0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SHIFTBY_1_OFFSET UNITYSDK_OFFSET(0x1A242250)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SHIFTBY_OFFSET UNITYSDK_OFFSET(0x1A242220)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int RectExt_TypeDefinitionIndex = 24574;
