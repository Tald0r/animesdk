...
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_GETSIZE_OFFSET UNITYSDK_OFFSET(0x1A809A90)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_INCLUDE_OFFSET UNITYSDK_OFFSET(0x1A809B80)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SCALEBY_1_OFFSET UNITYSDK_OFFSET(0x1A809AF0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SCALEBY_OFFSET UNITYSDK_OFFSET(0x1A809AC0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SETBETWEEN_OFFSET UNITYSDK_OFFSET(0x1A809A00)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SETPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1A809A70)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A809A50)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SETSIZE_OFFSET UNITYSDK_OFFSET(0x1A809AA0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SET_OFFSET UNITYSDK_OFFSET(0x1A8099D0)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SHIFTBY_1_OFFSET UNITYSDK_OFFSET(0x1A809B60)
#define FLUFFYUNDERWARE_DEVTOOLS_EXTENSIONS_RECTEXT_SHIFTBY_OFFSET UNITYSDK_OFFSET(0x1A809B30)

namespace FluffyUnderware::DevTools::Extensions
{
	inline static constexpr unsigned int RectExt_TypeDefinitionIndex = 25399;
