...
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_CLAMP_OFFSET UNITYSDK_OFFSET(0x939A40)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x939CF0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_EQUALS_OFFSET UNITYSDK_OFFSET(0x939C80)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F6FF0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_HIGH_OFFSET UNITYSDK_OFFSET(0x939B10)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_LENGTHPOSITIVE_OFFSET UNITYSDK_OFFSET(0x939BA0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x939B90)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_LOW_OFFSET UNITYSDK_OFFSET(0x939AD0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_NEXT_OFFSET UNITYSDK_OFFSET(0x939B70)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_POSITIVE_OFFSET UNITYSDK_OFFSET(0x939AC0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_RANDOM_OFFSET UNITYSDK_OFFSET(0x939B50)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_ZEROONE_OFFSET UNITYSDK_OFFSET(0x1A80B400)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_MAKEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x939A20)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A80B7F0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1A80B890)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A80B8B0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A80B940)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1A80B870)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A80B850)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1A80B810)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1A80B830)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_SET_HIGH_OFFSET UNITYSDK_OFFSET(0x939B30)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_SET_LOW_OFFSET UNITYSDK_OFFSET(0x939AF0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x939BD0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x939A10)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x939A00)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int FloatRegion_TypeDefinitionIndex = 25336;
