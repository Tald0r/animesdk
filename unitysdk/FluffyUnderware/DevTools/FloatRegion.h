...
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_CLAMP_OFFSET UNITYSDK_OFFSET(0x90DA10)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x90DCC0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_EQUALS_OFFSET UNITYSDK_OFFSET(0x90DC50)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8C3E60)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_HIGH_OFFSET UNITYSDK_OFFSET(0x90DAE0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_LENGTHPOSITIVE_OFFSET UNITYSDK_OFFSET(0x90DB70)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x90DB60)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_LOW_OFFSET UNITYSDK_OFFSET(0x90DAA0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_NEXT_OFFSET UNITYSDK_OFFSET(0x90DB40)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_POSITIVE_OFFSET UNITYSDK_OFFSET(0x90DA90)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_RANDOM_OFFSET UNITYSDK_OFFSET(0x90DB20)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_GET_ZEROONE_OFFSET UNITYSDK_OFFSET(0x1A243AF0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_MAKEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x90D9F0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A243EE0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1A243F80)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A243FA0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A244030)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1A243F60)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A243F40)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1A243F00)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1A243F20)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_SET_HIGH_OFFSET UNITYSDK_OFFSET(0x90DB00)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_SET_LOW_OFFSET UNITYSDK_OFFSET(0x90DAC0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x90DBA0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x90D9E0)
#define FLUFFYUNDERWARE_DEVTOOLS_FLOATREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x90D9D0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int FloatRegion_TypeDefinitionIndex = 24511;
