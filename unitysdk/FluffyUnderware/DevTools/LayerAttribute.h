...
#define FLUFFYUNDERWARE_DEVTOOLS_LAYERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A244670)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int LayerAttribute_TypeDefinitionIndex = 24523;
