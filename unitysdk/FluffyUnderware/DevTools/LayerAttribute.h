...
#define FLUFFYUNDERWARE_DEVTOOLS_LAYERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80BF80)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int LayerAttribute_TypeDefinitionIndex = 25348;
