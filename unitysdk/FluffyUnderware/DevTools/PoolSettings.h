...
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_AUTOCREATE_OFFSET UNITYSDK_OFFSET(0x1A80DA80)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_AUTOENABLEDISABLE_OFFSET UNITYSDK_OFFSET(0x1A80DAA0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_COUNTADJUSTMENTINTERVAL_OFFSET UNITYSDK_OFFSET(0x1A80DB00)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_INITIALIZECOUNTCONSTRAINED_OFFSET UNITYSDK_OFFSET(0x1A80DA60)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_MAXIMUMCOUNT_OFFSET UNITYSDK_OFFSET(0x1A80DAE0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_MINIMUMCOUNT_OFFSET UNITYSDK_OFFSET(0x1A80DAC0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_MINITEMS_OFFSET UNITYSDK_OFFSET(0x1A80DB40)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_PREWARM_OFFSET UNITYSDK_OFFSET(0x1A80DB20)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1A80DB80)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_GET_THRESHOLD_OFFSET UNITYSDK_OFFSET(0x1A80DB60)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A80DBD0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SETTODEFAULT_OFFSET UNITYSDK_OFFSET(0x1A80DBA0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_AUTOCREATE_OFFSET UNITYSDK_OFFSET(0x1A80DA90)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_AUTOENABLEDISABLE_OFFSET UNITYSDK_OFFSET(0x1A80DAB0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_COUNTADJUSTMENTINTERVAL_OFFSET UNITYSDK_OFFSET(0x1A80DB10)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_INITIALIZECOUNTCONSTRAINED_OFFSET UNITYSDK_OFFSET(0x1A80DA70)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_MAXIMUMCOUNT_OFFSET UNITYSDK_OFFSET(0x1A80DAF0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_MINIMUMCOUNT_OFFSET UNITYSDK_OFFSET(0x1A80DAD0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_MINITEMS_OFFSET UNITYSDK_OFFSET(0x1A80DB50)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_PREWARM_OFFSET UNITYSDK_OFFSET(0x1A80DB30)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_SPEED_OFFSET UNITYSDK_OFFSET(0x1A80DB90)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_SET_THRESHOLD_OFFSET UNITYSDK_OFFSET(0x1A80DB70)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS_VALIDATE_OFFSET UNITYSDK_OFFSET(0x1A80C290)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A80D430)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80DA30)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int PoolSettings_TypeDefinitionIndex = 25342;
