...
#define FLUFFYUNDERWARE_DEVTOOLS_INSPECTORNOTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80BB70)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int InspectorNote_TypeDefinitionIndex = 25382;
