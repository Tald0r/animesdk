...
#define FLUFFYUNDERWARE_DEVTOOLS_INSPECTORNOTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A244260)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int InspectorNote_TypeDefinitionIndex = 24557;
