...
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_CREATEPREFABPOOL_OFFSET UNITYSDK_OFFSET(0x1A80D190)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_DELETEPOOLS_OFFSET UNITYSDK_OFFSET(0x1A80D6B0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_DELETEPOOL_OFFSET UNITYSDK_OFFSET(0x1A80D730)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_FINDPOOLS_OFFSET UNITYSDK_OFFSET(0x1A80D510)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GETPREFABPOOL_OFFSET UNITYSDK_OFFSET(0x1A80D050)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GETUNIQUEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A80CF70)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GET_AUTOCREATEPOOLS_OFFSET UNITYSDK_OFFSET(0x1A80C220)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A80C2E0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GET_DEFAULTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A80C240)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A80C2C0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A80C570)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A80C370)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A80C320)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1A80C360)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_SET_AUTOCREATEPOOLS_OFFSET UNITYSDK_OFFSET(0x1A80C230)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_SET_DEFAULTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A80C250)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_SET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A80C2D0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A80C380)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80D8B0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int PoolManager_TypeDefinitionIndex = 25383;
