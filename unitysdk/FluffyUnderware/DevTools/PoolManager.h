...
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_CREATEPREFABPOOL_OFFSET UNITYSDK_OFFSET(0x1A245880)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_DELETEPOOLS_OFFSET UNITYSDK_OFFSET(0x1A245DA0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_DELETEPOOL_OFFSET UNITYSDK_OFFSET(0x1A245E20)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_FINDPOOLS_OFFSET UNITYSDK_OFFSET(0x1A245C00)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GETPREFABPOOL_OFFSET UNITYSDK_OFFSET(0x1A245740)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GETUNIQUEIDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A245660)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GET_AUTOCREATEPOOLS_OFFSET UNITYSDK_OFFSET(0x1A244910)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A2449D0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GET_DEFAULTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A244930)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A2449B0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A244C60)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A244A60)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A244A10)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1A244A50)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_SET_AUTOCREATEPOOLS_OFFSET UNITYSDK_OFFSET(0x1A244920)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_SET_DEFAULTSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A244940)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_SET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A2449C0)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A244A70)
#define FLUFFYUNDERWARE_DEVTOOLS_POOLMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A245FA0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int PoolManager_TypeDefinitionIndex = 24558;
