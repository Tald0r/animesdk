...
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE_CONDITIONMET_OFFSET UNITYSDK_OFFSET(0x1A239BA0)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A239C90)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A239620)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A239800)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A239A90)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2394F0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ConditionalAttribute_TypeDefinitionIndex = 24483;
