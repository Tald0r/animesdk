...
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE_CONDITIONMET_OFFSET UNITYSDK_OFFSET(0x1A8014C0)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE_EVALUATE_OFFSET UNITYSDK_OFFSET(0x1A8015B0)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A800F40)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A801120)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A8013B0)
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A800E10)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ConditionalAttribute_TypeDefinitionIndex = 25308;
