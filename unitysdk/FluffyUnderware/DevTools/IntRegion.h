...
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_CLAMP_OFFSET UNITYSDK_OFFSET(0x90DDC0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x90DF90)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_EQUALS_OFFSET UNITYSDK_OFFSET(0x90DF70)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8C4410)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_HIGH_OFFSET UNITYSDK_OFFSET(0x90DE60)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_LENGTHPOSITIVE_OFFSET UNITYSDK_OFFSET(0x90DEB0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x8E6D50)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_LOW_OFFSET UNITYSDK_OFFSET(0x90DE30)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_POSITIVE_OFFSET UNITYSDK_OFFSET(0x90DE20)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_RANDOM_OFFSET UNITYSDK_OFFSET(0x90DE90)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_ZEROONE_OFFSET UNITYSDK_OFFSET(0x1A2442A0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_MAKEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x90DDA0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A2444F0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1A244590)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A2445C0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A2445F0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1A244570)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A244550)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1A244510)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1A244530)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_SET_HIGH_OFFSET UNITYSDK_OFFSET(0x90DE70)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_SET_LOW_OFFSET UNITYSDK_OFFSET(0x90DE40)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x90DED0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x90DD90)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x90DD80)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int IntRegion_TypeDefinitionIndex = 24514;
