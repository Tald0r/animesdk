...
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_CLAMP_OFFSET UNITYSDK_OFFSET(0x939DF0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x939FD0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_EQUALS_OFFSET UNITYSDK_OFFSET(0x939FB0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F75A0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_HIGH_OFFSET UNITYSDK_OFFSET(0x939E90)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_LENGTHPOSITIVE_OFFSET UNITYSDK_OFFSET(0x939EF0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x939EE0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_LOW_OFFSET UNITYSDK_OFFSET(0x939E60)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_POSITIVE_OFFSET UNITYSDK_OFFSET(0x939E50)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_RANDOM_OFFSET UNITYSDK_OFFSET(0x939EC0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_GET_ZEROONE_OFFSET UNITYSDK_OFFSET(0x1A80BBB0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_MAKEPOSITIVE_OFFSET UNITYSDK_OFFSET(0x939DD0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1A80BE00)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1A80BEA0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A80BED0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A80BF00)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1A80BE80)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1A80BE60)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1A80BE20)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_OP_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1A80BE40)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_SET_HIGH_OFFSET UNITYSDK_OFFSET(0x939EA0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_SET_LOW_OFFSET UNITYSDK_OFFSET(0x939E70)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x939F10)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x939DC0)
#define FLUFFYUNDERWARE_DEVTOOLS_INTREGION__CTOR_OFFSET UNITYSDK_OFFSET(0x939DB0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int IntRegion_TypeDefinitionIndex = 25339;
