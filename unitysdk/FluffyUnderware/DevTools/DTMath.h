...
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_1_OFFSET UNITYSDK_OFFSET(0x1A8023F0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_2_OFFSET UNITYSDK_OFFSET(0x1A802410)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_3_OFFSET UNITYSDK_OFFSET(0x1A802460)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_OFFSET UNITYSDK_OFFSET(0x1A8023C0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LEFTTAN_OFFSET UNITYSDK_OFFSET(0x1A8022D0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LINELINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1A802BB0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LINELINEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1A802CA0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LINEPOINTDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x1A8026E0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_MAPVALUE_OFFSET UNITYSDK_OFFSET(0x1A8024E0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_PARALLELTRANSPORTFRAME_OFFSET UNITYSDK_OFFSET(0x1A801FD0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_POINTINSIDETRIANGLE_OFFSET UNITYSDK_OFFSET(0x1A802DC0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_RAYLINESEGMENTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1A8027C0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_REPEAT_OFFSET UNITYSDK_OFFSET(0x1A802370)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_RIGHTTAN_OFFSET UNITYSDK_OFFSET(0x1A802320)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SHORTESTINTERSECTIONLINE_OFFSET UNITYSDK_OFFSET(0x1A8028E0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SNAPPRECISION_1_OFFSET UNITYSDK_OFFSET(0x1A802560)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SNAPPRECISION_2_OFFSET UNITYSDK_OFFSET(0x1A802610)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SNAPPRECISION_OFFSET UNITYSDK_OFFSET(0x1A802500)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int DTMath_TypeDefinitionIndex = 25330;
