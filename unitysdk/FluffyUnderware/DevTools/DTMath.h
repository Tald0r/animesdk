...
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_1_OFFSET UNITYSDK_OFFSET(0x1A23AAD0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_2_OFFSET UNITYSDK_OFFSET(0x1A23AAF0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_3_OFFSET UNITYSDK_OFFSET(0x1A23AB40)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_FIXNAN_OFFSET UNITYSDK_OFFSET(0x1A23AAA0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LEFTTAN_OFFSET UNITYSDK_OFFSET(0x1A23A9B0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LINELINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1A23B290)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LINELINEINTERSECT_OFFSET UNITYSDK_OFFSET(0x1A23B380)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_LINEPOINTDISTANCESQR_OFFSET UNITYSDK_OFFSET(0x1A23ADC0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_MAPVALUE_OFFSET UNITYSDK_OFFSET(0x1A23ABC0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_PARALLELTRANSPORTFRAME_OFFSET UNITYSDK_OFFSET(0x1A23A6B0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_POINTINSIDETRIANGLE_OFFSET UNITYSDK_OFFSET(0x1A23B4A0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_RAYLINESEGMENTINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1A23AEA0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_REPEAT_OFFSET UNITYSDK_OFFSET(0x1A23AA50)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_RIGHTTAN_OFFSET UNITYSDK_OFFSET(0x1A23AA00)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SHORTESTINTERSECTIONLINE_OFFSET UNITYSDK_OFFSET(0x1A23AFC0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SNAPPRECISION_1_OFFSET UNITYSDK_OFFSET(0x1A23AC40)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SNAPPRECISION_2_OFFSET UNITYSDK_OFFSET(0x1A23ACF0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTMATH_SNAPPRECISION_OFFSET UNITYSDK_OFFSET(0x1A23ABE0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int DTMath_TypeDefinitionIndex = 24505;
