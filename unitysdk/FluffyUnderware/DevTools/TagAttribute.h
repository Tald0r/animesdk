...
#define FLUFFYUNDERWARE_DEVTOOLS_TAGATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A246E30)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int TagAttribute_TypeDefinitionIndex = 24524;
