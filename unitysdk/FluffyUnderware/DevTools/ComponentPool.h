...
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_CREATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A800400)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_GETITEMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A800500)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A8001B0)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A800210)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A800370)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A800540)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A800530)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_ONSCENELOADED_OFFSET UNITYSDK_OFFSET(0x1A800520)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_SET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A8001C0)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A800D70)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ComponentPool_TypeDefinitionIndex = 25376;
