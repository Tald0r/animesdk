...
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_CREATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A238AE0)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_GETITEMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A238BE0)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A238890)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A2388F0)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A238A50)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A238C20)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A238C10)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_ONSCENELOADED_OFFSET UNITYSDK_OFFSET(0x1A238C00)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL_SET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A2388A0)
#define FLUFFYUNDERWARE_DEVTOOLS_COMPONENTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A239450)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ComponentPool_TypeDefinitionIndex = 24551;
