...
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGERRORFORMAT_1_OFFSET UNITYSDK_OFFSET(0x1A23A480)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGERRORFORMAT_OFFSET UNITYSDK_OFFSET(0x1A23A440)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGERROR_1_OFFSET UNITYSDK_OFFSET(0x1A23A3C0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGERROR_OFFSET UNITYSDK_OFFSET(0x1A23A340)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGEXCEPTION_1_OFFSET UNITYSDK_OFFSET(0x1A23A4F0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A23A4C0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGFORMAT_1_OFFSET UNITYSDK_OFFSET(0x1A23A570)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A23A530)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGWARNINGFORMAT_1_OFFSET UNITYSDK_OFFSET(0x1A23A670)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGWARNINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A23A630)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGWARNING_1_OFFSET UNITYSDK_OFFSET(0x1A2389D0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1A23A5B0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOG_1_OFFSET UNITYSDK_OFFSET(0x1A23A2C0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOG_OFFSET UNITYSDK_OFFSET(0x1A23A240)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int DTLog_TypeDefinitionIndex = 24507;
