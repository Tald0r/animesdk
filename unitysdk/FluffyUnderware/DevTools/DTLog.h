...
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGERRORFORMAT_1_OFFSET UNITYSDK_OFFSET(0x1A801DA0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGERRORFORMAT_OFFSET UNITYSDK_OFFSET(0x1A801D60)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGERROR_1_OFFSET UNITYSDK_OFFSET(0x1A801CE0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGERROR_OFFSET UNITYSDK_OFFSET(0x1A801C60)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGEXCEPTION_1_OFFSET UNITYSDK_OFFSET(0x1A801E10)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGEXCEPTION_OFFSET UNITYSDK_OFFSET(0x1A801DE0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGFORMAT_1_OFFSET UNITYSDK_OFFSET(0x1A801E90)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A801E50)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGWARNINGFORMAT_1_OFFSET UNITYSDK_OFFSET(0x1A801F90)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGWARNINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A801F50)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGWARNING_1_OFFSET UNITYSDK_OFFSET(0x1A8002F0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOGWARNING_OFFSET UNITYSDK_OFFSET(0x1A801ED0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOG_1_OFFSET UNITYSDK_OFFSET(0x1A801BE0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTLOG_LOG_OFFSET UNITYSDK_OFFSET(0x1A801B60)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int DTLog_TypeDefinitionIndex = 25332;
