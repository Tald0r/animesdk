...
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETCENTERPOSITION_OFFSET UNITYSDK_OFFSET(0x1A807970)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETDEFAULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A807310)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETHANDLESIZE_1_OFFSET UNITYSDK_OFFSET(0x1A807730)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETHANDLESIZE_OFFSET UNITYSDK_OFFSET(0x1A807330)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETHELPURL_1_OFFSET UNITYSDK_OFFSET(0x1A8078A0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GETHELPURL_OFFSET UNITYSDK_OFFSET(0x1A807870)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GET_ISEDITORSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1A807320)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_GET_ISINEDITMODE_OFFSET UNITYSDK_OFFSET(0x1A807AC0)
#define FLUFFYUNDERWARE_DEVTOOLS_DTUTILITY_RANDOMSIGN_OFFSET UNITYSDK_OFFSET(0x1A807850)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int DTUtility_TypeDefinitionIndex = 25327;
