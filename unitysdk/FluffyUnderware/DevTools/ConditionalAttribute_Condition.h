...
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE_CONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A239610)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ConditionalAttribute_Condition_TypeDefinitionIndex = 24485;

	class ConditionalAttribute_Condition : public ::System::Object
	{
	public:
		::System::Object* CompareTo; // 0x10
		::System::Reflection::FieldInfo* FieldInfo; // 0x18
		::System::Reflection::MethodInfo* MethodInfo; // 0x20
		::System::String* MethodName; // 0x28
		::System::String* FieldName; // 0x30
		::System::Reflection::PropertyInfo* PropertyInfo; // 0x38
