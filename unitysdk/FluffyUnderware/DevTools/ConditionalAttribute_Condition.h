...
#define FLUFFYUNDERWARE_DEVTOOLS_CONDITIONALATTRIBUTE_CONDITION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A800F30)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ConditionalAttribute_Condition_TypeDefinitionIndex = 25310;
