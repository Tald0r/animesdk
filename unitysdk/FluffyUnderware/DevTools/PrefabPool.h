...
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_CREATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A246530)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_GETITEMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A246960)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A246310)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_GET_PREFABS_OFFSET UNITYSDK_OFFSET(0x1A246330)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A245B80)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A246350)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_SET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A246320)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_SET_PREFABS_OFFSET UNITYSDK_OFFSET(0x1A246340)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A246970)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int PrefabPool_TypeDefinitionIndex = 24559;
