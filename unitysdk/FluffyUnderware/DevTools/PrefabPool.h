...
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_CREATEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A80DE40)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_GETITEMGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A80E270)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_GET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A80DC20)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_GET_PREFABS_OFFSET UNITYSDK_OFFSET(0x1A80DC40)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A80D490)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A80DC60)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_SET_IDENTIFIER_OFFSET UNITYSDK_OFFSET(0x1A80DC30)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL_SET_PREFABS_OFFSET UNITYSDK_OFFSET(0x1A80DC50)
#define FLUFFYUNDERWARE_DEVTOOLS_PREFABPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80E280)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int PrefabPool_TypeDefinitionIndex = 25384;
