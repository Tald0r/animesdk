...
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A247570)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_DONEWORKITEM_OFFSET UNITYSDK_OFFSET(0x1A247390)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_HANDLEWORKITEM_OFFSET UNITYSDK_OFFSET(0x1A247480)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_1_OFFSET UNITYSDK_OFFSET(0x1A246F20)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_2_OFFSET UNITYSDK_OFFSET(0x1A246FF0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_3_OFFSET UNITYSDK_OFFSET(0x1A246EB0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_4_OFFSET UNITYSDK_OFFSET(0x1A246F30)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_OFFSET UNITYSDK_OFFSET(0x1A246E40)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_THROWIFDISPOSED_OFFSET UNITYSDK_OFFSET(0x1A247100)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_WAITALL_1_OFFSET UNITYSDK_OFFSET(0x1A247340)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_WAITALL_2_OFFSET UNITYSDK_OFFSET(0x1A2471B0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_WAITALL_OFFSET UNITYSDK_OFFSET(0x1A2471A0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2475E0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ThreadPoolWorker_TypeDefinitionIndex = 24545;
