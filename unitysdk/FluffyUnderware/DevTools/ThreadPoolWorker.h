...
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A80EE90)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_DONEWORKITEM_OFFSET UNITYSDK_OFFSET(0x1A80ECB0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_HANDLEWORKITEM_OFFSET UNITYSDK_OFFSET(0x1A80EDA0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_1_OFFSET UNITYSDK_OFFSET(0x1A80E830)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_2_OFFSET UNITYSDK_OFFSET(0x1A80E900)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_3_OFFSET UNITYSDK_OFFSET(0x1A80E7C0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_4_OFFSET UNITYSDK_OFFSET(0x1A80E840)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_QUEUEWORKITEM_OFFSET UNITYSDK_OFFSET(0x1A80E750)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_THROWIFDISPOSED_OFFSET UNITYSDK_OFFSET(0x1A80EA20)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_WAITALL_1_OFFSET UNITYSDK_OFFSET(0x1A80EC60)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_WAITALL_2_OFFSET UNITYSDK_OFFSET(0x1A80EAD0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER_WAITALL_OFFSET UNITYSDK_OFFSET(0x1A80EAC0)
#define FLUFFYUNDERWARE_DEVTOOLS_THREADPOOLWORKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80EF00)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int ThreadPoolWorker_TypeDefinitionIndex = 25370;
