...
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A80BB00)
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A80BB10)
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A80BB20)
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80BAF0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int GroupConditionAttribute_TypeDefinitionIndex = 25322;
