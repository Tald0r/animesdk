...
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A2441F0)
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A244200)
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A244210)
#define FLUFFYUNDERWARE_DEVTOOLS_GROUPCONDITIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2441E0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int GroupConditionAttribute_TypeDefinitionIndex = 24497;
