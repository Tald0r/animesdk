...
#define FLUFFYUNDERWARE_DEVTOOLS_DTVERSIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2401C0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int DTVersionAttribute_TypeDefinitionIndex = 24508;
