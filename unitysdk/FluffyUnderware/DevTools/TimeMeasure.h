...
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_AVERAGEMS_OFFSET UNITYSDK_OFFSET(0x1A80F320)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_AVERAGETICKS_OFFSET UNITYSDK_OFFSET(0x1A80F700)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_LASTMS_OFFSET UNITYSDK_OFFSET(0x1A80F2E0)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_LASTTICKS_OFFSET UNITYSDK_OFFSET(0x1A80F2A0)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_MAXIMUMMS_OFFSET UNITYSDK_OFFSET(0x1A80F5E0)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_MAXIMUMTICKS_OFFSET UNITYSDK_OFFSET(0x1A80F970)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_MINIMUMMS_OFFSET UNITYSDK_OFFSET(0x1A80F4C0)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_MINIMUMTICKS_OFFSET UNITYSDK_OFFSET(0x1A80F870)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_PAUSE_OFFSET UNITYSDK_OFFSET(0x1A80F210)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_START_OFFSET UNITYSDK_OFFSET(0x1A80F050)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_STOP_OFFSET UNITYSDK_OFFSET(0x1A80F0D0)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A80EFD0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int TimeMeasure_TypeDefinitionIndex = 25329;
