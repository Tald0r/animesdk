...
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_AVERAGEMS_OFFSET UNITYSDK_OFFSET(0x1A247A00)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_AVERAGETICKS_OFFSET UNITYSDK_OFFSET(0x1A247DE0)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_LASTMS_OFFSET UNITYSDK_OFFSET(0x1A2479C0)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_LASTTICKS_OFFSET UNITYSDK_OFFSET(0x1A247980)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_MAXIMUMMS_OFFSET UNITYSDK_OFFSET(0x1A247CC0)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_MAXIMUMTICKS_OFFSET UNITYSDK_OFFSET(0x1A248050)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_MINIMUMMS_OFFSET UNITYSDK_OFFSET(0x1A247BA0)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_GET_MINIMUMTICKS_OFFSET UNITYSDK_OFFSET(0x1A247F50)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_PAUSE_OFFSET UNITYSDK_OFFSET(0x1A2478F0)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_START_OFFSET UNITYSDK_OFFSET(0x1A247730)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE_STOP_OFFSET UNITYSDK_OFFSET(0x1A2477B0)
#define FLUFFYUNDERWARE_DEVTOOLS_TIMEMEASURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A2476B0)

namespace FluffyUnderware::DevTools
{
	inline static constexpr unsigned int TimeMeasure_TypeDefinitionIndex = 24504;
