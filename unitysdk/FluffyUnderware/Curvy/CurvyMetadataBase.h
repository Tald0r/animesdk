...
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AD07BB0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_GETNEXTCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1AD08090)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_GETPREVIOUSCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1AD07D50)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_GET_CONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1AD07B10)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1AD07B20)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_NOTIFYMODIFICATION_OFFSET UNITYSDK_OFFSET(0x1AD083D0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AD07CE0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD084D0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyMetadataBase_TypeDefinitionIndex = 36693;
