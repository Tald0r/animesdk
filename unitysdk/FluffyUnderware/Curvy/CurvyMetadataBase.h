...
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A769260)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_GETNEXTCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1A769740)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_GETPREVIOUSCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1A769400)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_GET_CONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1A7691C0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1A7691D0)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_NOTIFYMODIFICATION_OFFSET UNITYSDK_OFFSET(0x1A769A80)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A769390)
#define FLUFFYUNDERWARE_CURVY_CURVYMETADATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A769B80)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyMetadataBase_TypeDefinitionIndex = 35673;
