...
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_APPLYPLANE_OFFSET UNITYSDK_OFFSET(0x1AE234E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_APPLYROTATION_OFFSET UNITYSDK_OFFSET(0x1AE25F10)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1AE24F60)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_DELETE_OFFSET UNITYSDK_OFFSET(0x1AE234D0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GETSHAPENAME_OFFSET UNITYSDK_OFFSET(0x1AE25DB0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GETSHAPESMENUNAMES_1_OFFSET UNITYSDK_OFFSET(0x1AE25B70)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GETSHAPESMENUNAMES_OFFSET UNITYSDK_OFFSET(0x1AE25990)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GETSHAPETYPE_OFFSET UNITYSDK_OFFSET(0x1AE23790)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GET_PLANE_OFFSET UNITYSDK_OFFSET(0x1AE231A0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GET_SHAPEDEFINITIONS_OFFSET UNITYSDK_OFFSET(0x1AE25870)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1AE231C0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AE234A0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_PREPARECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1AE24F70)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_PREPARESPLINE_OFFSET UNITYSDK_OFFSET(0x1AE23980)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_REFRESH_OFFSET UNITYSDK_OFFSET(0x1AE23270)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_REPLACE_OFFSET UNITYSDK_OFFSET(0x1AE23690)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_RESET_OFFSET UNITYSDK_OFFSET(0x1AE234B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETBEZIERHANDLES_1_OFFSET UNITYSDK_OFFSET(0x1AE241C0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETBEZIERHANDLES_2_OFFSET UNITYSDK_OFFSET(0x1AE24740)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETBEZIERHANDLES_3_OFFSET UNITYSDK_OFFSET(0x1AE246B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETBEZIERHANDLES_OFFSET UNITYSDK_OFFSET(0x1AE241B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETCGHARDEDGES_OFFSET UNITYSDK_OFFSET(0x1AE24A30)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AE23E50)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETROTATION_OFFSET UNITYSDK_OFFSET(0x1AE24000)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SET_PLANE_OFFSET UNITYSDK_OFFSET(0x1AE231B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AE23260)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE267A0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE26780)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyShape_TypeDefinitionIndex = 36654;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::FluffyUnderware::Curvy::CurvyShapeInfo*, ::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(CurvyShape_TypeDefinitionIndex)->GetStaticField(0x26DD0);
		}
