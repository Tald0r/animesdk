...
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_APPLYPLANE_OFFSET UNITYSDK_OFFSET(0x1A843870)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_APPLYROTATION_OFFSET UNITYSDK_OFFSET(0x1A8462B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1A8452F0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_DELETE_OFFSET UNITYSDK_OFFSET(0x1A843860)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GETSHAPENAME_OFFSET UNITYSDK_OFFSET(0x1A846150)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GETSHAPESMENUNAMES_1_OFFSET UNITYSDK_OFFSET(0x1A845F00)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GETSHAPESMENUNAMES_OFFSET UNITYSDK_OFFSET(0x1A845D20)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GETSHAPETYPE_OFFSET UNITYSDK_OFFSET(0x1A843B20)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GET_PLANE_OFFSET UNITYSDK_OFFSET(0x1A843530)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GET_SHAPEDEFINITIONS_OFFSET UNITYSDK_OFFSET(0x1A845C00)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1A843550)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A843830)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_PREPARECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1A845300)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_PREPARESPLINE_OFFSET UNITYSDK_OFFSET(0x1A843D10)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A843600)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_REPLACE_OFFSET UNITYSDK_OFFSET(0x1A843A20)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_RESET_OFFSET UNITYSDK_OFFSET(0x1A843840)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETBEZIERHANDLES_1_OFFSET UNITYSDK_OFFSET(0x1A844550)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETBEZIERHANDLES_2_OFFSET UNITYSDK_OFFSET(0x1A844AD0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETBEZIERHANDLES_3_OFFSET UNITYSDK_OFFSET(0x1A844A40)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETBEZIERHANDLES_OFFSET UNITYSDK_OFFSET(0x1A844540)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETCGHARDEDGES_OFFSET UNITYSDK_OFFSET(0x1A844DC0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A8441E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SETROTATION_OFFSET UNITYSDK_OFFSET(0x1A844390)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_SET_PLANE_OFFSET UNITYSDK_OFFSET(0x1A843540)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A8435F0)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A846B40)
#define FLUFFYUNDERWARE_CURVY_CURVYSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A846B20)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyShape_TypeDefinitionIndex = 35634;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::FluffyUnderware::Curvy::CurvyShapeInfo*, ::System::Type*>**)Il2CppClass::FromTypeDefinitionIndex(CurvyShape_TypeDefinitionIndex)->GetStaticField(0x253A0);
		}
