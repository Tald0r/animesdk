...
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_DEBOORCLAMPED_OFFSET UNITYSDK_OFFSET(0x1ADDD3B0)
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_DEBOORUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1ADDD5C0)
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_GETBSPLINEN_OFFSET UNITYSDK_OFFSET(0x1ADDD730)
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_GETBSPLINEUANDK_OFFSET UNITYSDK_OFFSET(0x1ADDD740)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int BSplineHelper_TypeDefinitionIndex = 36631;
