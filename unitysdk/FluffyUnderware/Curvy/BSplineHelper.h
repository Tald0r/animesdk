...
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_DEBOORCLAMPED_OFFSET UNITYSDK_OFFSET(0x1A7E69D0)
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_DEBOORUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1A7E6BE0)
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_GETBSPLINEN_OFFSET UNITYSDK_OFFSET(0x1A7E6D50)
#define FLUFFYUNDERWARE_CURVY_BSPLINEHELPER_GETBSPLINEUANDK_OFFSET UNITYSDK_OFFSET(0x1A7E6D60)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int BSplineHelper_TypeDefinitionIndex = 35611;
