...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_ASSERTISNOTPROCESSING_OFFSET UNITYSDK_OFFSET(0x1B49D980)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_CANCELREQUESTS_OFFSET UNITYSDK_OFFSET(0x1B49D720)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_DEBUGLOG_OFFSET UNITYSDK_OFFSET(0x1B49D850)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_GET_CURRENTREQUEST_OFFSET UNITYSDK_OFFSET(0x1B49D400)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_LOGIGNOREDREQUEST_OFFSET UNITYSDK_OFFSET(0x1B49D8D0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_PROCESSREQUESTS_OFFSET UNITYSDK_OFFSET(0x1B49D470)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_REQUESTHIERARCHYTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1B49D450)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_REQUESTSPLINETOHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1B49D430)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_SET_CURRENTREQUEST_OFFSET UNITYSDK_OFFSET(0x1B49D410)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_SYNCHRONIZEHIERARCHYTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1B49D550)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER_SYNCHRONIZESPLINETOHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1B49D730)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTSSYNCHRONIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B49D420)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_ControlPointsSynchronizer_TypeDefinitionIndex = 36670;

	class CurvySpline_ControlPointsSynchronizer : public ::System::Object
	{
	public:
		::FluffyUnderware::Curvy::CurvySpline* spline; // 0x10
		::FluffyUnderware::Curvy::CurvySpline_ControlPointsSynchronizer_SynchronizationRequest _CurrentRequest_k__BackingField; // 0x18
		::System::Boolean processing; // 0x1C
