...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_APPLYPARALLELTRANSPORT_OFFSET UNITYSDK_OFFSET(0x1A923CC0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_APPLYSWIRLANDSMOOTHING_OFFSET UNITYSDK_OFFSET(0x1A923E90)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_GETACCUMULATEDSWIRLANGLES_OFFSET UNITYSDK_OFFSET(0x1A924570)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_GETORIENTATIONGAP_OFFSET UNITYSDK_OFFSET(0x1A924380)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x1A9239E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_SETUPORIENTATIONGROUP_OFFSET UNITYSDK_OFFSET(0x1A923AA0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_UPDATEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A923CA0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9239F0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_OrientationGroup_TypeDefinitionIndex = 36675;
