...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_APPLYPARALLELTRANSPORT_OFFSET UNITYSDK_OFFSET(0x1A360290)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_APPLYSWIRLANDSMOOTHING_OFFSET UNITYSDK_OFFSET(0x1A360460)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_GETACCUMULATEDSWIRLANGLES_OFFSET UNITYSDK_OFFSET(0x1A360B40)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_GETORIENTATIONGAP_OFFSET UNITYSDK_OFFSET(0x1A360950)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x1A35FFA0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_SETUPORIENTATIONGROUP_OFFSET UNITYSDK_OFFSET(0x1A360070)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP_UPDATEORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A360270)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_ORIENTATIONGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A35FFB0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_OrientationGroup_TypeDefinitionIndex = 35655;
