...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETORIENTATIONTODYNAMIC_OFFSET UNITYSDK_OFFSET(0x1A8491B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETORIENTATIONTONONE_OFFSET UNITYSDK_OFFSET(0x1A848E10)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETORIENTATIONTOSTATIC_OFFSET UNITYSDK_OFFSET(0x1A848F20)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOINTTANGENTANDDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A849650)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOBEZIER_OFFSET UNITYSDK_OFFSET(0x1A8480A0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOBSPLINE_OFFSET UNITYSDK_OFFSET(0x1A848680)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOCATMULLROM_OFFSET UNITYSDK_OFFSET(0x1A8471D0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOLINEAR_OFFSET UNITYSDK_OFFSET(0x1A846DC0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOPOINT_OFFSET UNITYSDK_OFFSET(0x1A846C70)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOTCB_OFFSET UNITYSDK_OFFSET(0x1A847830)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETSEGMENTPRECISETANGENTS_OFFSET UNITYSDK_OFFSET(0x1A84A380)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETSEGMENTTANGENTSANDDISTANCES_OFFSET UNITYSDK_OFFSET(0x1A849D80)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOBEZIER_OFFSET UNITYSDK_OFFSET(0x1A84A9F0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOCATMULLROM_OFFSET UNITYSDK_OFFSET(0x1A84AF70)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOLINEAR_OFFSET UNITYSDK_OFFSET(0x1A84B740)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOTCB_OFFSET UNITYSDK_OFFSET(0x1A84B2B0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineSegment_ApproximationsSetter_TypeDefinitionIndex = 35666;
