...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETORIENTATIONTODYNAMIC_OFFSET UNITYSDK_OFFSET(0x1AE28E10)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETORIENTATIONTONONE_OFFSET UNITYSDK_OFFSET(0x1AE28A70)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETORIENTATIONTOSTATIC_OFFSET UNITYSDK_OFFSET(0x1AE28B80)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOINTTANGENTANDDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AE292B0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOBEZIER_OFFSET UNITYSDK_OFFSET(0x1AE27D00)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOBSPLINE_OFFSET UNITYSDK_OFFSET(0x1AE282E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOCATMULLROM_OFFSET UNITYSDK_OFFSET(0x1AE26E30)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOLINEAR_OFFSET UNITYSDK_OFFSET(0x1AE26A20)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOPOINT_OFFSET UNITYSDK_OFFSET(0x1AE268D0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETPOSITIONSTOTCB_OFFSET UNITYSDK_OFFSET(0x1AE27490)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETSEGMENTPRECISETANGENTS_OFFSET UNITYSDK_OFFSET(0x1AE29FE0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETSEGMENTTANGENTSANDDISTANCES_OFFSET UNITYSDK_OFFSET(0x1AE299E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOBEZIER_OFFSET UNITYSDK_OFFSET(0x1AE2A650)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOCATMULLROM_OFFSET UNITYSDK_OFFSET(0x1AE2ABD0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOLINEAR_OFFSET UNITYSDK_OFFSET(0x1AE2B3A0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_APPROXIMATIONSSETTER_SETTANGENTSTOTCB_OFFSET UNITYSDK_OFFSET(0x1AE2AF10)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineSegment_ApproximationsSetter_TypeDefinitionIndex = 36686;
