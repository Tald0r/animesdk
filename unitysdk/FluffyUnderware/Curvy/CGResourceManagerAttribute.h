...
#define FLUFFYUNDERWARE_CURVY_CGRESOURCEMANAGERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E6DD0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CGResourceManagerAttribute_TypeDefinitionIndex = 35608;
