...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINETOEDGECOLLIDER2D_GET_EDGECOLLIDER_OFFSET UNITYSDK_OFFSET(0x1A9A02E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINETOEDGECOLLIDER2D_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A9A03F0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINETOEDGECOLLIDER2D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A0A30)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineToEdgeCollider2D_TypeDefinitionIndex = 35632;
