...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_CANCELREQUESTS_OFFSET UNITYSDK_OFFSET(0x1A591C50)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_GETCONTROLPOINTNAMES_OFFSET UNITYSDK_OFFSET(0x1A591E20)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_GETCONTROLPOINTNAME_OFFSET UNITYSDK_OFFSET(0x1A591C60)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_MAKECONTROLPOINTNAME_OFFSET UNITYSDK_OFFSET(0x1A591D90)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_PROCESSREQUESTS_OFFSET UNITYSDK_OFFSET(0x1A591AF0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_RENAMECONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1A591B60)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER_REQUESTRENAME_OFFSET UNITYSDK_OFFSET(0x1A591AE0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A592000)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_CONTROLPOINTNAMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A591AD0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_ControlPointNamer_TypeDefinitionIndex = 36679;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(CurvySpline_ControlPointNamer_TypeDefinitionIndex)->GetStaticField(0x26B20);
		}
