...
#define FLUFFYUNDERWARE_CURVY_CURVYCGEVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19F80CA0)
#define FLUFFYUNDERWARE_CURVY_CURVYCGEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x19F80C50)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyCGEventArgs_TypeDefinitionIndex = 35609;
