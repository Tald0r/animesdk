...
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_ADDITION_OFFSET UNITYSDK_OFFSET(0x1AE2B5A0)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_DIVISION_OFFSET UNITYSDK_OFFSET(0x1AE2D9D0)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_LERPUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1AE26DC0)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1AE2D9A0)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_MULTIPLY_2_OFFSET UNITYSDK_OFFSET(0x1AE2DA10)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_MULTIPLY_3_OFFSET UNITYSDK_OFFSET(0x1AE2DA30)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_MULTIPLY_4_OFFSET UNITYSDK_OFFSET(0x1AE2DA50)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1AE2D970)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1AE2B4E0)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1AE299A0)
#define FLUFFYUNDERWARE_CURVY_UTILS_OPTIMIZEDOPERATORS_UNARYNEGATION_OFFSET UNITYSDK_OFFSET(0x1AE2D940)

namespace FluffyUnderware::Curvy::Utils
{
	inline static constexpr unsigned int OptimizedOperators_TypeDefinitionIndex = 36710;
