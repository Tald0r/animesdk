...
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x1A5A84A0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_1_OFFSET UNITYSDK_OFFSET(0x1A5A8000)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_2_OFFSET UNITYSDK_OFFSET(0x1A5A81A0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_3_OFFSET UNITYSDK_OFFSET(0x1A5A82E0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A5A7EE0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPTF_1_OFFSET UNITYSDK_OFFSET(0x1A5A7C20)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPTF_OFFSET UNITYSDK_OFFSET(0x1A5A7B00)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPVALUE_OFFSET UNITYSDK_OFFSET(0x1A5A7D60)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_GETDEFAULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A5A3150)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_GETNEARESTPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x1A59BFD0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_INTERPOLATIONSEARCH_1_OFFSET UNITYSDK_OFFSET(0x1A59C380)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_INTERPOLATIONSEARCH_OFFSET UNITYSDK_OFFSET(0x1A5A8510)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_SPLINETOMESH_OFFSET UNITYSDK_OFFSET(0x1A5A8530)

namespace FluffyUnderware::Curvy::Utils
{
	inline static constexpr unsigned int CurvyUtility_TypeDefinitionIndex = 36709;
