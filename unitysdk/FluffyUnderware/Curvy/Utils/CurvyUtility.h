...
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_APPROXIMATELY_OFFSET UNITYSDK_OFFSET(0x19F97620)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_1_OFFSET UNITYSDK_OFFSET(0x19F97180)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_2_OFFSET UNITYSDK_OFFSET(0x19F97320)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_3_OFFSET UNITYSDK_OFFSET(0x19F97460)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPDISTANCE_OFFSET UNITYSDK_OFFSET(0x19F97060)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPTF_1_OFFSET UNITYSDK_OFFSET(0x19F96DA0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPTF_OFFSET UNITYSDK_OFFSET(0x19F96C80)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_CLAMPVALUE_OFFSET UNITYSDK_OFFSET(0x19F96EE0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_GETDEFAULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x19F922A0)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_GETNEARESTPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x19F8AF50)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_INTERPOLATIONSEARCH_1_OFFSET UNITYSDK_OFFSET(0x19F8B300)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_INTERPOLATIONSEARCH_OFFSET UNITYSDK_OFFSET(0x19F97690)
#define FLUFFYUNDERWARE_CURVY_UTILS_CURVYUTILITY_SPLINETOMESH_OFFSET UNITYSDK_OFFSET(0x19F976B0)

namespace FluffyUnderware::Curvy::Utils
{
	inline static constexpr unsigned int CurvyUtility_TypeDefinitionIndex = 35689;
