...
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE_GETPOLYGON_OFFSET UNITYSDK_OFFSET(0x1ACC8E70)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE_GETVERTEXLIST_OFFSET UNITYSDK_OFFSET(0x1ACC8C30)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE_GETVERTICES_OFFSET UNITYSDK_OFFSET(0x1ACC8A60)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x1ACC89D0)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ACC89B0)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1ACC8990)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACC8980)

namespace FluffyUnderware::Curvy::Utils
{
	inline static constexpr unsigned int SplinePolyLine_TypeDefinitionIndex = 35693;
