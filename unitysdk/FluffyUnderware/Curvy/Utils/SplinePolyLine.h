...
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE_GETPOLYGON_OFFSET UNITYSDK_OFFSET(0x1B2E0FF0)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE_GETVERTEXLIST_OFFSET UNITYSDK_OFFSET(0x1B2E0DB0)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE_GETVERTICES_OFFSET UNITYSDK_OFFSET(0x1B2E0BE0)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x1B2E0B50)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B2E0B30)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B2E0B10)
#define FLUFFYUNDERWARE_CURVY_UTILS_SPLINEPOLYLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B2E0B00)

namespace FluffyUnderware::Curvy::Utils
{
	inline static constexpr unsigned int SplinePolyLine_TypeDefinitionIndex = 36713;
