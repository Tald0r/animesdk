...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE___C__DISPLAYCLASS105_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19F8FBA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE___C__DISPLAYCLASS105_0__GETLINK_B__0_OFFSET UNITYSDK_OFFSET(0x19F8FBB0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule___c__DisplayClass105_0_TypeDefinitionIndex = 35759;

	class CGModule___c__DisplayClass105_0 : public ::System::Object
	{
	public:
		::FluffyUnderware::Curvy::Generator::CGModuleSlot* target; // 0x10
		::FluffyUnderware::Curvy::Generator::CGModuleSlot* source; // 0x18
