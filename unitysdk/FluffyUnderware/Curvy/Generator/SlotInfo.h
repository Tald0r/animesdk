...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_CHECKDATATYPES_OFFSET UNITYSDK_OFFSET(0x1AEE0710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1AEE0690)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_GET_DATATYPES_OFFSET UNITYSDK_OFFSET(0x1AEE0550)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1AEDDDB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1AEE05F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEE0640)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AEE0650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEE0600)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SlotInfo_TypeDefinitionIndex = 35814;
