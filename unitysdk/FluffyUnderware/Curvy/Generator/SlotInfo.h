...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_CHECKDATATYPES_OFFSET UNITYSDK_OFFSET(0x1B5084A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1B508420)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_GET_DATATYPES_OFFSET UNITYSDK_OFFSET(0x1B5082E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_GET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1B505B40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO_SET_DISPLAYNAME_OFFSET UNITYSDK_OFFSET(0x1B508380)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B5083D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B5083E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SLOTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B508390)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SlotInfo_TypeDefinitionIndex = 36834;
