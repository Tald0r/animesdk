...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ADDMANAGEDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1AAA05F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1AA9E280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_CHECKONSTATECHANGEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AAA0E10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_COPYTO_OFFSET UNITYSDK_OFFSET(0x1AAA0460)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DECREMENTCHILDS_OFFSET UNITYSDK_OFFSET(0x1AAA11C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1AA9F580)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETEALLPREFABPOOLS_OFFSET UNITYSDK_OFFSET(0x1AAA0920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETEMANAGEDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1AA9EEA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETE_OFFSET UNITYSDK_OFFSET(0x1AAA0A40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DOREFRESH_OFFSET UNITYSDK_OFFSET(0x1AAA0BF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETALLPREFABPOOLS_OFFSET UNITYSDK_OFFSET(0x1AAA0880)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINFO_OFFSET UNITYSDK_OFFSET(0x1AA9D470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTLINKS_OFFSET UNITYSDK_OFFSET(0x1AAA03F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTLINK_OFFSET UNITYSDK_OFFSET(0x1AAA02E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTSLOTS_OFFSET UNITYSDK_OFFSET(0x1AA9D8B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTSLOT_OFFSET UNITYSDK_OFFSET(0x1AAA0A70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETLINKS_OFFSET UNITYSDK_OFFSET(0x1AAA0230)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETLINK_OFFSET UNITYSDK_OFFSET(0x1AAA0120)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1AA9E760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTLINKS_OFFSET UNITYSDK_OFFSET(0x1AAA01C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTLINK_OFFSET UNITYSDK_OFFSET(0x1AAA0010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTSLOTS_OFFSET UNITYSDK_OFFSET(0x1AA9DAA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTSLOT_OFFSET UNITYSDK_OFFSET(0x1AAA0A90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETPREFABPOOL_OFFSET UNITYSDK_OFFSET(0x1AAA0AC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETRESOURCEMANAGERS_OFFSET UNITYSDK_OFFSET(0x1AA9FAB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1AA9DEB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_CIRCULARREFERENCEERROR_OFFSET UNITYSDK_OFFSET(0x1AA9E180)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_DIRTY_OFFSET UNITYSDK_OFFSET(0x1AA9DFA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_GENERATOR_OFFSET UNITYSDK_OFFSET(0x1AA9CB40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1AA9D400)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_INPUTBYNAME_OFFSET UNITYSDK_OFFSET(0x1AA9E240)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_INPUT_OFFSET UNITYSDK_OFFSET(0x1AA9DA60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ISCONFIGURED_OFFSET UNITYSDK_OFFSET(0x1AA9DFC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1AA9E070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_MODULENAME_OFFSET UNITYSDK_OFFSET(0x1AA9DD50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ONBEFOREREFRESH_OFFSET UNITYSDK_OFFSET(0x1AA9DC50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1AA9DC70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_OUTPUTBYNAME_OFFSET UNITYSDK_OFFSET(0x1AA9E260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_OUTPUT_OFFSET UNITYSDK_OFFSET(0x1AA9DA80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_RANDOMIZESEED_OFFSET UNITYSDK_OFFSET(0x1AA9DF80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_SEED_OFFSET UNITYSDK_OFFSET(0x1AA9DF40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1AA9E080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INITIALIZESORT_OFFSET UNITYSDK_OFFSET(0x1AAA0FC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AA9E330)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ISMANAGEDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1AAA0710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONBEFOREREFRESHEVENT_OFFSET UNITYSDK_OFFSET(0x1AA9DC90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AA9E430)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AA9E290)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONREFRESHEVENT_OFFSET UNITYSDK_OFFSET(0x1AA9DCF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1AA9F590)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1AA9F5F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AA9EF80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_REFRESH_OFFSET UNITYSDK_OFFSET(0x1AA9F520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_REINITIALIZELINKEDSLOTS_OFFSET UNITYSDK_OFFSET(0x1AA9D890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_REMOVEREQUESTPARAMETER_OFFSET UNITYSDK_OFFSET(0x1AA9F600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RENAMEMANAGEDRESOURCESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AA9D540)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RENAMERESOURCE_OFFSET UNITYSDK_OFFSET(0x1AA9D870)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1AAA0E50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESET_OFFSET UNITYSDK_OFFSET(0x1AA9F030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SETMODULENAME_OFFSET UNITYSDK_OFFSET(0x1AA9FCA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SETUNIQUEIDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AA9D290)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1AA9DEC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_CIRCULARREFERENCEERROR_OFFSET UNITYSDK_OFFSET(0x1AA9E1F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_DIRTY_OFFSET UNITYSDK_OFFSET(0x1AA9DF20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_MODULENAME_OFFSET UNITYSDK_OFFSET(0x1AA9DD80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_ONBEFOREREFRESH_OFFSET UNITYSDK_OFFSET(0x1AA9DC60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1AA9DC80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_RANDOMIZESEED_OFFSET UNITYSDK_OFFSET(0x1AA9DF90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_SEED_OFFSET UNITYSDK_OFFSET(0x1AA9DF50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1AA9E0B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_TRYDELETECHILDRENFROMASSOCIATEDPREFAB_OFFSET UNITYSDK_OFFSET(0x1AAA0BE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AA9F020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_USESRANDOM_OFFSET UNITYSDK_OFFSET(0x1AAA0F40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AAA19B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9F680)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE__RESET_B__80_0_OFFSET UNITYSDK_OFFSET(0x1AAA1B40)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule_TypeDefinitionIndex = 36771;
