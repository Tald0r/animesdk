...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ADDMANAGEDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1A4EE070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A4EBD10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_CHECKONSTATECHANGEDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A4EE890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_COPYTO_OFFSET UNITYSDK_OFFSET(0x1A4EDEE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DECREMENTCHILDS_OFFSET UNITYSDK_OFFSET(0x1A4EEC40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1A4ED010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETEALLPREFABPOOLS_OFFSET UNITYSDK_OFFSET(0x1A4EE3A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETEMANAGEDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1A4EC930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DELETE_OFFSET UNITYSDK_OFFSET(0x1A4EE4C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DOREFRESH_OFFSET UNITYSDK_OFFSET(0x1A4EE670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETALLPREFABPOOLS_OFFSET UNITYSDK_OFFSET(0x1A4EE300)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINFO_OFFSET UNITYSDK_OFFSET(0x1A4EAF00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTLINKS_OFFSET UNITYSDK_OFFSET(0x1A4EDE70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTLINK_OFFSET UNITYSDK_OFFSET(0x1A4EDD60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTSLOTS_OFFSET UNITYSDK_OFFSET(0x1A4EB340)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETINPUTSLOT_OFFSET UNITYSDK_OFFSET(0x1A4EE4F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETLINKS_OFFSET UNITYSDK_OFFSET(0x1A4EDCC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETLINK_OFFSET UNITYSDK_OFFSET(0x1A4EDBB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1A4EC1F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTLINKS_OFFSET UNITYSDK_OFFSET(0x1A4EDC50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTLINK_OFFSET UNITYSDK_OFFSET(0x1A4EDAA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTSLOTS_OFFSET UNITYSDK_OFFSET(0x1A4EB530)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETOUTPUTSLOT_OFFSET UNITYSDK_OFFSET(0x1A4EE510)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETPREFABPOOL_OFFSET UNITYSDK_OFFSET(0x1A4EE540)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GETRESOURCEMANAGERS_OFFSET UNITYSDK_OFFSET(0x1A4ED540)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1A4EB940)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_CIRCULARREFERENCEERROR_OFFSET UNITYSDK_OFFSET(0x1A4EBC10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_DIRTY_OFFSET UNITYSDK_OFFSET(0x1A4EBA30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_GENERATOR_OFFSET UNITYSDK_OFFSET(0x1A4EA5D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A4EAE90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_INPUTBYNAME_OFFSET UNITYSDK_OFFSET(0x1A4EBCD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_INPUT_OFFSET UNITYSDK_OFFSET(0x1A4EB4F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ISCONFIGURED_OFFSET UNITYSDK_OFFSET(0x1A4EBA50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A4EBB00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_MODULENAME_OFFSET UNITYSDK_OFFSET(0x1A4EB7E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ONBEFOREREFRESH_OFFSET UNITYSDK_OFFSET(0x1A4EB6E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1A4EB700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_OUTPUTBYNAME_OFFSET UNITYSDK_OFFSET(0x1A4EBCF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_OUTPUT_OFFSET UNITYSDK_OFFSET(0x1A4EB510)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_RANDOMIZESEED_OFFSET UNITYSDK_OFFSET(0x1A4EBA10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_SEED_OFFSET UNITYSDK_OFFSET(0x1A4EB9D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_GET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1A4EBB10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INITIALIZESORT_OFFSET UNITYSDK_OFFSET(0x1A4EEA40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A4EBDC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ISMANAGEDRESOURCE_OFFSET UNITYSDK_OFFSET(0x1A4EE190)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONBEFOREREFRESHEVENT_OFFSET UNITYSDK_OFFSET(0x1A4EB720)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A4EBEC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A4EBD20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONREFRESHEVENT_OFFSET UNITYSDK_OFFSET(0x1A4EB780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1A4ED020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1A4ED080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A4ECA10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A4ECFB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_REINITIALIZELINKEDSLOTS_OFFSET UNITYSDK_OFFSET(0x1A4EB320)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_REMOVEREQUESTPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A4ED090)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RENAMEMANAGEDRESOURCESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A4EAFD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RENAMERESOURCE_OFFSET UNITYSDK_OFFSET(0x1A4EB300)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1A4EE8D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESET_OFFSET UNITYSDK_OFFSET(0x1A4ECAC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SETMODULENAME_OFFSET UNITYSDK_OFFSET(0x1A4ED730)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SETUNIQUEIDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A4EAD20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_ACTIVE_OFFSET UNITYSDK_OFFSET(0x1A4EB950)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_CIRCULARREFERENCEERROR_OFFSET UNITYSDK_OFFSET(0x1A4EBC80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_DIRTY_OFFSET UNITYSDK_OFFSET(0x1A4EB9B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_MODULENAME_OFFSET UNITYSDK_OFFSET(0x1A4EB810)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_ONBEFOREREFRESH_OFFSET UNITYSDK_OFFSET(0x1A4EB6F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1A4EB710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_RANDOMIZESEED_OFFSET UNITYSDK_OFFSET(0x1A4EBA20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_SEED_OFFSET UNITYSDK_OFFSET(0x1A4EB9E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_SET_UNIQUEID_OFFSET UNITYSDK_OFFSET(0x1A4EBB40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_TRYDELETECHILDRENFROMASSOCIATEDPREFAB_OFFSET UNITYSDK_OFFSET(0x1A4EE660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A4ECAB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_USESRANDOM_OFFSET UNITYSDK_OFFSET(0x1A4EE9C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A4EF420)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4ED110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE__RESET_B__80_0_OFFSET UNITYSDK_OFFSET(0x1A4EF5B0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule_TypeDefinitionIndex = 35751;
