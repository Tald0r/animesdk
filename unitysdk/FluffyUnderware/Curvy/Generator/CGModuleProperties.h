...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1B14C1D0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModuleProperties_TypeDefinitionIndex = 35768;
