...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DIRTINESSMANAGER_CHECKONSTATECHANGED_OFFSET UNITYSDK_OFFSET(0x1A9A1E60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DIRTINESSMANAGER_FOREACHVALIDOUTPUTMODULE_OFFSET UNITYSDK_OFFSET(0x1A9A19D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DIRTINESSMANAGER_GET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x1A9A18C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DIRTINESSMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A9A1EA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DIRTINESSMANAGER_RESET_OFFSET UNITYSDK_OFFSET(0x1A9A1E50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DIRTINESSMANAGER_SETTREEDIRTYSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1A9A1F10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DIRTINESSMANAGER_SET_ISDIRTY_OFFSET UNITYSDK_OFFSET(0x1A9A18D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DIRTINESSMANAGER_UNSETDIRTYFLAG_OFFSET UNITYSDK_OFFSET(0x1A9A1E40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DIRTINESSMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A9A1F80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_DIRTINESSMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A18B0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule_DirtinessManager_TypeDefinitionIndex = 35752;
	...
	public:
		...
		{
			return (::System::Action_1<::FluffyUnderware::Curvy::Generator::CGModule*>**)Il2CppClass::FromTypeDefinitionIndex(CGModule_DirtinessManager_TypeDefinitionIndex)->GetStaticField(0x25090);
		}
		static ::System::Action_1<::FluffyUnderware::Curvy::Generator::CGModule*>** StaticGet_SetDirtyAction()
		{
			return (::System::Action_1<::FluffyUnderware::Curvy::Generator::CGModule*>**)Il2CppClass::FromTypeDefinitionIndex(CGModule_DirtinessManager_TypeDefinitionIndex)->GetStaticField(0x25098);
		}
		::FluffyUnderware::Curvy::Generator::CGModule* module; // 0x10
		::System::Boolean lastIsConfiguredState; // 0x18
		::System::Boolean isDirty; // 0x19
