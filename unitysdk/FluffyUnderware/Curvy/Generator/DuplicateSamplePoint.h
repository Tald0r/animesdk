...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x92FD40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_EQUALS_OFFSET UNITYSDK_OFFSET(0x92FD10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x92FDB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_GET_ENDINDEX_OFFSET UNITYSDK_OFFSET(0x302230)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_GET_ISHARDEDGE_OFFSET UNITYSDK_OFFSET(0x34AA60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_GET_STARTINDEX_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A5A2500)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A5A2530)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x92FDD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_DUPLICATESAMPLEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x31E810)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int DuplicateSamplePoint_TypeDefinitionIndex = 36818;
