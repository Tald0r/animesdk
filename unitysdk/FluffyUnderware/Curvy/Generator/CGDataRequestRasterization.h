...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTRASTERIZATION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A9A1020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTRASTERIZATION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A9A10C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTRASTERIZATION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A9A1160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTRASTERIZATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9A0F70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTRASTERIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A0EC0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGDataRequestRasterization_TypeDefinitionIndex = 35737;
	...
	public:
		...
		::FluffyUnderware::Curvy::Generator::CGDataRequestRasterization_ModeEnum Mode; // 0x18
