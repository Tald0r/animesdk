...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_AREINPUTANDOUTPUTSLOTSCOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A9263F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_CANLINKTO_OFFSET UNITYSDK_OFFSET(0x1A926070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_GET_INPUTINFO_OFFSET UNITYSDK_OFFSET(0x1A924BC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_GET_ISONREQUEST_OFFSET UNITYSDK_OFFSET(0x1A924C20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_LINKTO_OFFSET UNITYSDK_OFFSET(0x1A925130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_LOADLINKEDSLOTS_OFFSET UNITYSDK_OFFSET(0x1A924CF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_SOURCESLOT_OFFSET UNITYSDK_OFFSET(0x1A925D50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT_UNLINKFROM_OFFSET UNITYSDK_OFFSET(0x1A9258E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULEINPUTSLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A926470)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModuleInputSlot_TypeDefinitionIndex = 36782;
