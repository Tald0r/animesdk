...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTMETACGOPTIONS_EQUALS_OFFSET UNITYSDK_OFFSET(0x19F2DA60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTMETACGOPTIONS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x19F2DB10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTMETACGOPTIONS_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19F2DB80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTMETACGOPTIONS__CTOR_OFFSET UNITYSDK_OFFSET(0x19F2DA40)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGDataRequestMetaCGOptions_TypeDefinitionIndex = 35735;
