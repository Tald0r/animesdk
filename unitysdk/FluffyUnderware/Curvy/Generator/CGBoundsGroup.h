...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_CONVERTOBSOLETEDATA_OFFSET UNITYSDK_OFFSET(0x1ADE0640)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_FILLITEMBAG_OFFSET UNITYSDK_OFFSET(0x1ADE02F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1ADDFD20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1ADDFFF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_IGNOREMODULECROSSBASE_OFFSET UNITYSDK_OFFSET(0x1ADDFD50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1ADE0050)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0x1ADDFFE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_KEEPTOGETHER_OFFSET UNITYSDK_OFFSET(0x1ADDFC50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1ADE0070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1ADDFC30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_POSITIONRANGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1ADE05D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_RANDOMIZEITEMS_OFFSET UNITYSDK_OFFSET(0x1ADDFCD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_RELATIVETRANSLATION_OFFSET UNITYSDK_OFFSET(0x1ADDFF30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_REPEATINGGROUPSOPTIONS_OFFSET UNITYSDK_OFFSET(0x1ADE0540)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_REPEATINGITEMS_OFFSET UNITYSDK_OFFSET(0x1ADDFCF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ROTATIONMODE_OFFSET UNITYSDK_OFFSET(0x1ADDFD70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ROTATIONX_OFFSET UNITYSDK_OFFSET(0x1ADDFD90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ROTATIONY_OFFSET UNITYSDK_OFFSET(0x1ADDFDD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ROTATIONZ_OFFSET UNITYSDK_OFFSET(0x1ADDFE10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1ADDFE70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1ADDFEB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SCALEZ_OFFSET UNITYSDK_OFFSET(0x1ADDFEF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SPACEAFTER_OFFSET UNITYSDK_OFFSET(0x1ADDFCA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SPACEBEFORE_OFFSET UNITYSDK_OFFSET(0x1ADDFC70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_TRANSLATIONX_OFFSET UNITYSDK_OFFSET(0x1ADDFF50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_TRANSLATIONY_OFFSET UNITYSDK_OFFSET(0x1ADDFF80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_TRANSLATIONZ_OFFSET UNITYSDK_OFFSET(0x1ADDFFB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_UNIFORMSCALING_OFFSET UNITYSDK_OFFSET(0x1ADDFE50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1ADDFD40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1ADE0000)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_IGNOREMODULECROSSBASE_OFFSET UNITYSDK_OFFSET(0x1ADDFD60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_KEEPTOGETHER_OFFSET UNITYSDK_OFFSET(0x1ADDFC60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1ADE0080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1ADDFC40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_RANDOMIZEITEMS_OFFSET UNITYSDK_OFFSET(0x1ADDFCE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_RELATIVETRANSLATION_OFFSET UNITYSDK_OFFSET(0x1ADDFF40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_REPEATINGITEMS_OFFSET UNITYSDK_OFFSET(0x1ADDFD10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_ROTATIONMODE_OFFSET UNITYSDK_OFFSET(0x1ADDFD80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_ROTATIONX_OFFSET UNITYSDK_OFFSET(0x1ADDFDB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_ROTATIONY_OFFSET UNITYSDK_OFFSET(0x1ADDFDF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_ROTATIONZ_OFFSET UNITYSDK_OFFSET(0x1ADDFE30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1ADDFE90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1ADDFED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SCALEZ_OFFSET UNITYSDK_OFFSET(0x1ADDFF10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SPACEAFTER_OFFSET UNITYSDK_OFFSET(0x1ADDFCC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SPACEBEFORE_OFFSET UNITYSDK_OFFSET(0x1ADDFC90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_TRANSLATIONX_OFFSET UNITYSDK_OFFSET(0x1ADDFF70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_TRANSLATIONY_OFFSET UNITYSDK_OFFSET(0x1ADDFFA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_TRANSLATIONZ_OFFSET UNITYSDK_OFFSET(0x1ADDFFD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_UNIFORMSCALING_OFFSET UNITYSDK_OFFSET(0x1ADDFE60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE00D0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGBoundsGroup_TypeDefinitionIndex = 36747;
