...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_CONVERTOBSOLETEDATA_OFFSET UNITYSDK_OFFSET(0x1A7E9C60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_FILLITEMBAG_OFFSET UNITYSDK_OFFSET(0x1A7E9910)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1A7E9340)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1A7E9610)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_IGNOREMODULECROSSBASE_OFFSET UNITYSDK_OFFSET(0x1A7E9370)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ITEMCOUNT_OFFSET UNITYSDK_OFFSET(0x1A7E9670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ITEMS_OFFSET UNITYSDK_OFFSET(0x1A7E9600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_KEEPTOGETHER_OFFSET UNITYSDK_OFFSET(0x1A7E9270)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1A7E9690)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A7E9250)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_POSITIONRANGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A7E9BF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_RANDOMIZEITEMS_OFFSET UNITYSDK_OFFSET(0x1A7E92F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_RELATIVETRANSLATION_OFFSET UNITYSDK_OFFSET(0x1A7E9550)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_REPEATINGGROUPSOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A7E9B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_REPEATINGITEMS_OFFSET UNITYSDK_OFFSET(0x1A7E9310)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ROTATIONMODE_OFFSET UNITYSDK_OFFSET(0x1A7E9390)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ROTATIONX_OFFSET UNITYSDK_OFFSET(0x1A7E93B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ROTATIONY_OFFSET UNITYSDK_OFFSET(0x1A7E93F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_ROTATIONZ_OFFSET UNITYSDK_OFFSET(0x1A7E9430)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1A7E9490)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1A7E94D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SCALEZ_OFFSET UNITYSDK_OFFSET(0x1A7E9510)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SPACEAFTER_OFFSET UNITYSDK_OFFSET(0x1A7E92C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_SPACEBEFORE_OFFSET UNITYSDK_OFFSET(0x1A7E9290)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_TRANSLATIONX_OFFSET UNITYSDK_OFFSET(0x1A7E9570)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_TRANSLATIONY_OFFSET UNITYSDK_OFFSET(0x1A7E95A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_TRANSLATIONZ_OFFSET UNITYSDK_OFFSET(0x1A7E95D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_GET_UNIFORMSCALING_OFFSET UNITYSDK_OFFSET(0x1A7E9470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1A7E9360)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1A7E9620)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_IGNOREMODULECROSSBASE_OFFSET UNITYSDK_OFFSET(0x1A7E9380)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_KEEPTOGETHER_OFFSET UNITYSDK_OFFSET(0x1A7E9280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1A7E96A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A7E9260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_RANDOMIZEITEMS_OFFSET UNITYSDK_OFFSET(0x1A7E9300)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_RELATIVETRANSLATION_OFFSET UNITYSDK_OFFSET(0x1A7E9560)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_REPEATINGITEMS_OFFSET UNITYSDK_OFFSET(0x1A7E9330)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_ROTATIONMODE_OFFSET UNITYSDK_OFFSET(0x1A7E93A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_ROTATIONX_OFFSET UNITYSDK_OFFSET(0x1A7E93D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_ROTATIONY_OFFSET UNITYSDK_OFFSET(0x1A7E9410)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_ROTATIONZ_OFFSET UNITYSDK_OFFSET(0x1A7E9450)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1A7E94B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1A7E94F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SCALEZ_OFFSET UNITYSDK_OFFSET(0x1A7E9530)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SPACEAFTER_OFFSET UNITYSDK_OFFSET(0x1A7E92E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_SPACEBEFORE_OFFSET UNITYSDK_OFFSET(0x1A7E92B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_TRANSLATIONX_OFFSET UNITYSDK_OFFSET(0x1A7E9590)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_TRANSLATIONY_OFFSET UNITYSDK_OFFSET(0x1A7E95C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_TRANSLATIONZ_OFFSET UNITYSDK_OFFSET(0x1A7E95F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP_SET_UNIFORMSCALING_OFFSET UNITYSDK_OFFSET(0x1A7E9480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDSGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E96F0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGBoundsGroup_TypeDefinitionIndex = 35727;
