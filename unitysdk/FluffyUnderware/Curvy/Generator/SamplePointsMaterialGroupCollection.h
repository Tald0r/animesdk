...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION_CALCULATEASPECTCORRECTION_OFFSET UNITYSDK_OFFSET(0x19F337D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION_GET_ASPECTCORRECTION_OFFSET UNITYSDK_OFFSET(0x19F336B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x19F334C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION_SET_ASPECTCORRECTION_OFFSET UNITYSDK_OFFSET(0x19F336C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19F33730)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19F33780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x19F336D0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SamplePointsMaterialGroupCollection_TypeDefinitionIndex = 35811;
