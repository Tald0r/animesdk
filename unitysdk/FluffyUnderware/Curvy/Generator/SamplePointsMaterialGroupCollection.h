...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION_CALCULATEASPECTCORRECTION_OFFSET UNITYSDK_OFFSET(0x1A552120)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION_GET_ASPECTCORRECTION_OFFSET UNITYSDK_OFFSET(0x1A552000)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x1A551E10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION_SET_ASPECTCORRECTION_OFFSET UNITYSDK_OFFSET(0x1A552010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A552080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A5520D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUPCOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A552020)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SamplePointsMaterialGroupCollection_TypeDefinitionIndex = 36831;
