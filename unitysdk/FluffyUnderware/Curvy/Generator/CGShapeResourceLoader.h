...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1AD090D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1AD09200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER_INITIALIZEONLOAD_OFFSET UNITYSDK_OFFSET(0x1AD09060)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD090C0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGShapeResourceLoader_TypeDefinitionIndex = 36795;
