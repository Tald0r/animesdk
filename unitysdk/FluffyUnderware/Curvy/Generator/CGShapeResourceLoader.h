...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1A76A780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1A76A8B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER_INITIALIZEONLOAD_OFFSET UNITYSDK_OFFSET(0x1A76A710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSHAPERESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A76A770)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGShapeResourceLoader_TypeDefinitionIndex = 35775;
