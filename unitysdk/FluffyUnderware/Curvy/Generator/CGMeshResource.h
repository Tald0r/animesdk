...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A311830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_COLLIDERMATCHES_OFFSET UNITYSDK_OFFSET(0x1A30FAE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_GETNEWMESH_1_OFFSET UNITYSDK_OFFSET(0x1A311710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_GETNEWMESH_OFFSET UNITYSDK_OFFSET(0x1A3115F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1A30F980)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_GET_RENDERER_OFFSET UNITYSDK_OFFSET(0x1A30F8B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_ONAFTERPOP_OFFSET UNITYSDK_OFFSET(0x1A3114F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_ONBEFOREPUSH_OFFSET UNITYSDK_OFFSET(0x1A311420)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A311C00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A30FA50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_REMOVECOLLIDER_OFFSET UNITYSDK_OFFSET(0x1A310080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_UPDATECOLLIDER_OFFSET UNITYSDK_OFFSET(0x1A3101D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_USESSHAREDMESH_OFFSET UNITYSDK_OFFSET(0x1A311D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A312040)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A312020)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGMeshResource_TypeDefinitionIndex = 35748;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::UnityEngine::Mesh*>**)Il2CppClass::FromTypeDefinitionIndex(CGMeshResource_TypeDefinitionIndex)->GetStaticField(0x25360);
		}
