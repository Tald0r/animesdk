...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A8C7C20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_COLLIDERMATCHES_OFFSET UNITYSDK_OFFSET(0x1A8C5ED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_GETNEWMESH_1_OFFSET UNITYSDK_OFFSET(0x1A8C7B00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_GETNEWMESH_OFFSET UNITYSDK_OFFSET(0x1A8C79E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1A8C5D70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_GET_RENDERER_OFFSET UNITYSDK_OFFSET(0x1A8C5CA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_ONAFTERPOP_OFFSET UNITYSDK_OFFSET(0x1A8C78E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_ONBEFOREPUSH_OFFSET UNITYSDK_OFFSET(0x1A8C7810)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A8C7FF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A8C5E40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_REMOVECOLLIDER_OFFSET UNITYSDK_OFFSET(0x1A8C6470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_UPDATECOLLIDER_OFFSET UNITYSDK_OFFSET(0x1A8C65C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE_USESSHAREDMESH_OFFSET UNITYSDK_OFFSET(0x1A8C8120)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A8C8430)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C8410)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGMeshResource_TypeDefinitionIndex = 36768;
	...
	public:
		...
		{
			return (::System::Collections::Generic::HashSet_1<::UnityEngine::Mesh*>**)Il2CppClass::FromTypeDefinitionIndex(CGMeshResource_TypeDefinitionIndex)->GetStaticField(0x26D90);
		}
