...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_RASTERIZATIONRANGEVALIDATOR_VALIDATEDFROMVALUE_OFFSET UNITYSDK_OFFSET(0x1ABE4920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_RASTERIZATIONRANGEVALIDATOR_VALIDATETOVALUE_OFFSET UNITYSDK_OFFSET(0x1ABE4970)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int RasterizationRangeValidator_TypeDefinitionIndex = 35818;
