...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_GET_MIX_OFFSET UNITYSDK_OFFSET(0x1ADE5E10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1ADE5E80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_MIXPATH_OFFSET UNITYSDK_OFFSET(0x1ADE63C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ADE60D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1ADE6160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_RESET_OFFSET UNITYSDK_OFFSET(0x1ADE6110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_SET_MIX_OFFSET UNITYSDK_OFFSET(0x1ADE5E20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE6B90)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierMixPaths_TypeDefinitionIndex = 36881;
