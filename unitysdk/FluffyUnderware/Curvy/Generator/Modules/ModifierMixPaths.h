...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_GET_MIX_OFFSET UNITYSDK_OFFSET(0x1A7EF430)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1A7EF4A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_MIXPATH_OFFSET UNITYSDK_OFFSET(0x1A7EF9E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A7EF6F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1A7EF780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_RESET_OFFSET UNITYSDK_OFFSET(0x1A7EF730)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS_SET_MIX_OFFSET UNITYSDK_OFFSET(0x1A7EF440)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXPATHS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7F01B0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierMixPaths_TypeDefinitionIndex = 35861;
