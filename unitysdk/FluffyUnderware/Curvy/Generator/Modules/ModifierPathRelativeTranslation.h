...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_GET_ANGLE_OFFSET UNITYSDK_OFFSET(0x1AA54950)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_GET_LATERALTRANSLATION_OFFSET UNITYSDK_OFFSET(0x1AA54900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_GET_MULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1AA549C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1AA54A10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AA55130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1AA54B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AA55250)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_RESET_OFFSET UNITYSDK_OFFSET(0x1AA55170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_SET_ANGLE_OFFSET UNITYSDK_OFFSET(0x1AA54960)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_SET_LATERALTRANSLATION_OFFSET UNITYSDK_OFFSET(0x1AA54910)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_SET_MULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1AA549D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_TRANSLATEPOINT_OFFSET UNITYSDK_OFFSET(0x1AA54DD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA552B0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierPathRelativeTranslation_TypeDefinitionIndex = 35864;
