...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_GET_ANGLE_OFFSET UNITYSDK_OFFSET(0x1B0689E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_GET_LATERALTRANSLATION_OFFSET UNITYSDK_OFFSET(0x1B068990)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_GET_MULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1B068A50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1B068AA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B0691C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1B068BF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B0692E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_RESET_OFFSET UNITYSDK_OFFSET(0x1B069200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_SET_ANGLE_OFFSET UNITYSDK_OFFSET(0x1B0689F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_SET_LATERALTRANSLATION_OFFSET UNITYSDK_OFFSET(0x1B0689A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_SET_MULTIPLIER_OFFSET UNITYSDK_OFFSET(0x1B068A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION_TRANSLATEPOINT_OFFSET UNITYSDK_OFFSET(0x1B068E60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERPATHRELATIVETRANSLATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B069340)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierPathRelativeTranslation_TypeDefinitionIndex = 36884;
