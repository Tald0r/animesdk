...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_NOTE_GET_NOTETEXT_OFFSET UNITYSDK_OFFSET(0x1ABE4840)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_NOTE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ABE4860)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_NOTE_RESET_OFFSET UNITYSDK_OFFSET(0x1ABE48A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_NOTE_SET_NOTETEXT_OFFSET UNITYSDK_OFFSET(0x1ABE4850)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_NOTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABE48C0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int Note_TypeDefinitionIndex = 35870;
