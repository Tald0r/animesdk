...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_NOTE_GET_NOTETEXT_OFFSET UNITYSDK_OFFSET(0x1B1F5700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_NOTE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B1F5720)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_NOTE_RESET_OFFSET UNITYSDK_OFFSET(0x1B1F5760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_NOTE_SET_NOTETEXT_OFFSET UNITYSDK_OFFSET(0x1B1F5710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_NOTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F5780)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int Note_TypeDefinitionIndex = 36890;
