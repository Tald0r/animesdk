...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_GET_SPOTS_OFFSET UNITYSDK_OFFSET(0x1A31CC90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A31CCE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A31CD60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_RESET_OFFSET UNITYSDK_OFFSET(0x1A31CD10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_SET_SPOTS_OFFSET UNITYSDK_OFFSET(0x1A31CCA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A31CE60)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputSpots_TypeDefinitionIndex = 35857;
