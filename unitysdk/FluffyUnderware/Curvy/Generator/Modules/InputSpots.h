...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_GET_SPOTS_OFFSET UNITYSDK_OFFSET(0x1A8D3020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A8D3070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A8D30F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_RESET_OFFSET UNITYSDK_OFFSET(0x1A8D30A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS_SET_SPOTS_OFFSET UNITYSDK_OFFSET(0x1A8D3030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D31F0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputSpots_TypeDefinitionIndex = 36877;
