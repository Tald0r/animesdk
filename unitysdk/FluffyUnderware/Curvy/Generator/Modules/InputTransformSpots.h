...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_GET_TRANSFORMSPOTS_OFFSET UNITYSDK_OFFSET(0x1B067FA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B068020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B067FF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1B0682D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1B068590)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_RESET_OFFSET UNITYSDK_OFFSET(0x1B068030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_SET_TRANSFORMSPOTS_OFFSET UNITYSDK_OFFSET(0x1B067FB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B068080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B068610)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS__REFRESH_B__9_1_OFFSET UNITYSDK_OFFSET(0x1B068750)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputTransformSpots_TypeDefinitionIndex = 36878;
