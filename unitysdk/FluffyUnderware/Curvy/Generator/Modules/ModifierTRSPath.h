...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSPATH_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1A7F0240)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSPATH_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1A7F0390)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7F05F0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierTRSPath_TypeDefinitionIndex = 35867;
