...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_ANGLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1AAA2060)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_CLAMPPATH_OFFSET UNITYSDK_OFFSET(0x1AAA1ED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_FROM_OFFSET UNITYSDK_OFFSET(0x1AAA1D80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1AAA1EF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1AAA2010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1AAA2180)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1AAA20D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_RANGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1AAA23B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_RESOLUTION_OFFSET UNITYSDK_OFFSET(0x1AAA1FB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_TO_OFFSET UNITYSDK_OFFSET(0x1AAA1E10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_USEBUGGEDRANGE_OFFSET UNITYSDK_OFFSET(0x1AAA2360)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AAA2460)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1AAA2600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_RESET_OFFSET UNITYSDK_OFFSET(0x1AAA2520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_ANGLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1AAA2070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_FROM_OFFSET UNITYSDK_OFFSET(0x1AAA1D90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1AAA1F30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1AAA2020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_RESOLUTION_OFFSET UNITYSDK_OFFSET(0x1AAA1FC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_TO_OFFSET UNITYSDK_OFFSET(0x1AAA1E20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_USEBUGGEDRANGE_OFFSET UNITYSDK_OFFSET(0x1AAA2370)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAA2940)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildRasterizedPath_TypeDefinitionIndex = 36842;
