...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_ANGLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1A4EFAD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_CLAMPPATH_OFFSET UNITYSDK_OFFSET(0x1A4EF940)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_FROM_OFFSET UNITYSDK_OFFSET(0x1A4EF7F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A4EF960)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A4EFA80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1A4EFBF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1A4EFB40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_RANGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A4EFE20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_RESOLUTION_OFFSET UNITYSDK_OFFSET(0x1A4EFA20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_TO_OFFSET UNITYSDK_OFFSET(0x1A4EF880)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_GET_USEBUGGEDRANGE_OFFSET UNITYSDK_OFFSET(0x1A4EFDD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A4EFED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A4F0070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_RESET_OFFSET UNITYSDK_OFFSET(0x1A4EFF90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_ANGLETHRESHOLD_OFFSET UNITYSDK_OFFSET(0x1A4EFAE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_FROM_OFFSET UNITYSDK_OFFSET(0x1A4EF800)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A4EF9A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_OPTIMIZE_OFFSET UNITYSDK_OFFSET(0x1A4EFA90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_RESOLUTION_OFFSET UNITYSDK_OFFSET(0x1A4EFA30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_TO_OFFSET UNITYSDK_OFFSET(0x1A4EF890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH_SET_USEBUGGEDRANGE_OFFSET UNITYSDK_OFFSET(0x1A4EFDE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDRASTERIZEDPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F03B0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildRasterizedPath_TypeDefinitionIndex = 35822;
