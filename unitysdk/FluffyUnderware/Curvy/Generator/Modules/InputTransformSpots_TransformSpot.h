...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9044C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_EQUALS_OFFSET UNITYSDK_OFFSET(0x904470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x904550)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19F96470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19F964C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT__CTOR_OFFSET UNITYSDK_OFFSET(0x2C36D0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputTransformSpots_TransformSpot_TypeDefinitionIndex = 35859;
