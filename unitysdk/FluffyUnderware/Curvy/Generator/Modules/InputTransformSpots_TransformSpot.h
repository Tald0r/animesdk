...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x92FE50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_EQUALS_OFFSET UNITYSDK_OFFSET(0x92FE00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x92FEE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x272280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A5A72F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A5A7340)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTTRANSFORMSPOTS_TRANSFORMSPOT__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3C70)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputTransformSpots_TransformSpot_TypeDefinitionIndex = 36879;
