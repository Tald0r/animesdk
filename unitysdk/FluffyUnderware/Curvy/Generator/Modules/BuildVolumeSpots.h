...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ADDGROUPITEMS_1_OFFSET UNITYSDK_OFFSET(0x1A92C470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ADDGROUPITEMS_OFFSET UNITYSDK_OFFSET(0x1A92BB40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ADDGROUP_OFFSET UNITYSDK_OFFSET(0x1A929480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A9295C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETGROUPDEPTH_OFFSET UNITYSDK_OFFSET(0x1A92C220)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETGROUPITEMINDICES_OFFSET UNITYSDK_OFFSET(0x1A92BE90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETREGIONNEXTVALUE_OFFSET UNITYSDK_OFFSET(0x1A92C1D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETSPOT_OFFSET UNITYSDK_OFFSET(0x1A92CA20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETTRS630_OFFSET UNITYSDK_OFFSET(0x1A92D2D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETTRS_OFFSET UNITYSDK_OFFSET(0x1A92D8E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_BOUNDSINDICES_OFFSET UNITYSDK_OFFSET(0x1A928F50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_BOUNDSNAMES_OFFSET UNITYSDK_OFFSET(0x1A928E30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A929010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1A928B20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_CROSSCURVE_OFFSET UNITYSDK_OFFSET(0x1A928BD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1A928C90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_FITEND_OFFSET UNITYSDK_OFFSET(0x1A928DC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_GROUPCOUNT_OFFSET UNITYSDK_OFFSET(0x1A928E10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_GROUPS_OFFSET UNITYSDK_OFFSET(0x1A928C20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_LASTGROUPINDEX_OFFSET UNITYSDK_OFFSET(0x1A928D10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1A928D40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_RANGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A929030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x1A928940)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_REPEATINGGROUPSOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A9290A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_REPEATINGORDER_OFFSET UNITYSDK_OFFSET(0x1A928C40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_SHOWFITEND_OFFSET UNITYSDK_OFFSET(0x1A92DD30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1A928A80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_USEBUGGEDRNG_OFFSET UNITYSDK_OFFSET(0x1A928AD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_USEVOLUME_OFFSET UNITYSDK_OFFSET(0x1A928A30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ISINPUTAVOLUME_OFFSET UNITYSDK_OFFSET(0x1A929020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A92DE00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A92DDF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A929130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1A929550)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A92B720)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A9296B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_REMOVEGROUP_OFFSET UNITYSDK_OFFSET(0x1A92C9B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1A92DD60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_RESET_OFFSET UNITYSDK_OFFSET(0x1A929160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1A928B30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_CROSSCURVE_OFFSET UNITYSDK_OFFSET(0x1A928BE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1A928CA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_FITEND_OFFSET UNITYSDK_OFFSET(0x1A928DD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_GROUPS_OFFSET UNITYSDK_OFFSET(0x1A928C30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1A928D50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_RANGE_OFFSET UNITYSDK_OFFSET(0x1A928960)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_REPEATINGORDER_OFFSET UNITYSDK_OFFSET(0x1A928C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1A928A90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_USEBUGGEDRNG_OFFSET UNITYSDK_OFFSET(0x1A928AE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_USEVOLUME_OFFSET UNITYSDK_OFFSET(0x1A928A40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9287A0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeSpots_TypeDefinitionIndex = 36851;
