...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ADDGROUPITEMS_1_OFFSET UNITYSDK_OFFSET(0x1A368A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ADDGROUPITEMS_OFFSET UNITYSDK_OFFSET(0x1A368130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ADDGROUP_OFFSET UNITYSDK_OFFSET(0x1A365A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A365BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETGROUPDEPTH_OFFSET UNITYSDK_OFFSET(0x1A368810)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETGROUPITEMINDICES_OFFSET UNITYSDK_OFFSET(0x1A368480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETREGIONNEXTVALUE_OFFSET UNITYSDK_OFFSET(0x1A3687C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETSPOT_OFFSET UNITYSDK_OFFSET(0x1A369010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETTRS630_OFFSET UNITYSDK_OFFSET(0x1A3698C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GETTRS_OFFSET UNITYSDK_OFFSET(0x1A369ED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_BOUNDSINDICES_OFFSET UNITYSDK_OFFSET(0x1A365530)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_BOUNDSNAMES_OFFSET UNITYSDK_OFFSET(0x1A365410)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A3655F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1A365100)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_CROSSCURVE_OFFSET UNITYSDK_OFFSET(0x1A3651B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1A365270)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_FITEND_OFFSET UNITYSDK_OFFSET(0x1A3653A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_GROUPCOUNT_OFFSET UNITYSDK_OFFSET(0x1A3653F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_GROUPS_OFFSET UNITYSDK_OFFSET(0x1A365200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_LASTGROUPINDEX_OFFSET UNITYSDK_OFFSET(0x1A3652F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1A365320)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_RANGEOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A365610)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_RANGE_OFFSET UNITYSDK_OFFSET(0x1A364F20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_REPEATINGGROUPSOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A365680)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_REPEATINGORDER_OFFSET UNITYSDK_OFFSET(0x1A365220)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_SHOWFITEND_OFFSET UNITYSDK_OFFSET(0x1A36A320)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1A365060)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_USEBUGGEDRNG_OFFSET UNITYSDK_OFFSET(0x1A3650B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_GET_USEVOLUME_OFFSET UNITYSDK_OFFSET(0x1A365010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ISINPUTAVOLUME_OFFSET UNITYSDK_OFFSET(0x1A365600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A36A3F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A36A3E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A365710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ONSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x1A365B30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A367D10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A365C90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_REMOVEGROUP_OFFSET UNITYSDK_OFFSET(0x1A368FA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1A36A350)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_RESET_OFFSET UNITYSDK_OFFSET(0x1A365740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_CROSSBASE_OFFSET UNITYSDK_OFFSET(0x1A365110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_CROSSCURVE_OFFSET UNITYSDK_OFFSET(0x1A3651C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_FIRSTREPEATING_OFFSET UNITYSDK_OFFSET(0x1A365280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_FITEND_OFFSET UNITYSDK_OFFSET(0x1A3653B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_GROUPS_OFFSET UNITYSDK_OFFSET(0x1A365210)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_LASTREPEATING_OFFSET UNITYSDK_OFFSET(0x1A365330)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_RANGE_OFFSET UNITYSDK_OFFSET(0x1A364F40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_REPEATINGORDER_OFFSET UNITYSDK_OFFSET(0x1A365230)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1A365070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_USEBUGGEDRNG_OFFSET UNITYSDK_OFFSET(0x1A3650C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_SET_USEVOLUME_OFFSET UNITYSDK_OFFSET(0x1A365020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A364D80)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeSpots_TypeDefinitionIndex = 35831;
