...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_GET_MIX_OFFSET UNITYSDK_OFFSET(0x1AAA3960)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1AAA39D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_INTERPOLATESHAPE_OFFSET UNITYSDK_OFFSET(0x1AAA4120)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_MIXSHAPES_OFFSET UNITYSDK_OFFSET(0x1AAA4080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AAA3CB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1AAA3DC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_RESET_OFFSET UNITYSDK_OFFSET(0x1AAA3D70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_SET_MIX_OFFSET UNITYSDK_OFFSET(0x1AAA3970)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAA52F0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierMixShapes_TypeDefinitionIndex = 36882;
