...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_GET_MIX_OFFSET UNITYSDK_OFFSET(0x1A4F13D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1A4F1440)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_INTERPOLATESHAPE_OFFSET UNITYSDK_OFFSET(0x1A4F1B90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_MIXSHAPES_OFFSET UNITYSDK_OFFSET(0x1A4F1AF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A4F1720)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1A4F1830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_RESET_OFFSET UNITYSDK_OFFSET(0x1A4F17E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES_SET_MIX_OFFSET UNITYSDK_OFFSET(0x1A4F13E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERMIXSHAPES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F2D60)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierMixShapes_TypeDefinitionIndex = 35862;
