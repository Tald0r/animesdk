...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_DEFORMMESHES_1_OFFSET UNITYSDK_OFFSET(0x1A31BCD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_DEFORMMESHES_OFFSET UNITYSDK_OFFSET(0x1A31C6F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_GETSPOTDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A31C8B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_GET_STRETCHTOEND_OFFSET UNITYSDK_OFFSET(0x1A31ADA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_ISCURVEEVALUATIONNEEDED_OFFSET UNITYSDK_OFFSET(0x1A31C810)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A31AE30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A31AEB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1A31ADF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_SET_STRETCHTOEND_OFFSET UNITYSDK_OFFSET(0x1A31ADB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_TOONEDIMENSIONALARRAY_OFFSET UNITYSDK_OFFSET(0x1A31B830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A31C980)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int DeformMesh_TypeDefinitionIndex = 35847;
