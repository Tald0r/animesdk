...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_DEFORMMESHES_1_OFFSET UNITYSDK_OFFSET(0x1A8D2080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_DEFORMMESHES_OFFSET UNITYSDK_OFFSET(0x1A8D2A80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_GETSPOTDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A8D2C40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_GET_STRETCHTOEND_OFFSET UNITYSDK_OFFSET(0x1A8D1150)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_ISCURVEEVALUATIONNEEDED_OFFSET UNITYSDK_OFFSET(0x1A8D2BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A8D11E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A8D1260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1A8D11A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_SET_STRETCHTOEND_OFFSET UNITYSDK_OFFSET(0x1A8D1160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH_TOONEDIMENSIONALARRAY_OFFSET UNITYSDK_OFFSET(0x1A8D1BE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEFORMMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D2D10)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int DeformMesh_TypeDefinitionIndex = 36867;
