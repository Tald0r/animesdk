...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_ADDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A5A2CC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A5A2C90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_BUILD_OFFSET UNITYSDK_OFFSET(0x1A5A3F70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_CREATEMATERIALGROUPUV2_OFFSET UNITYSDK_OFFSET(0x1A5A5730)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_CREATEMATERIALGROUPUV_OFFSET UNITYSDK_OFFSET(0x1A5A53F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_CREATEPATCHTRIANGLES_OFFSET UNITYSDK_OFFSET(0x1A5A5880)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GETMATERIALIDGROUPS_OFFSET UNITYSDK_OFFSET(0x1A5A3970)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A5A4EF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1A5A2A10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1A5A29C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_ISSPLITUV2TOGGLABLE_OFFSET UNITYSDK_OFFSET(0x1A5A59C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_MATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x1A5A2C70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_MATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A5A2C60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_MATERIALSETTTINGS_OFFSET UNITYSDK_OFFSET(0x1A5A2C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1A5A2B00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_SPLITLENGTH_OFFSET UNITYSDK_OFFSET(0x1A5A2BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_SPLITUV2_OFFSET UNITYSDK_OFFSET(0x1A5A2C00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_SPLIT_OFFSET UNITYSDK_OFFSET(0x1A5A2B50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_UNSCALEU_OFFSET UNITYSDK_OFFSET(0x1A5A2A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_UNSCALINGORIGIN_OFFSET UNITYSDK_OFFSET(0x1A5A2AB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_PREPARESUBMESHES_OFFSET UNITYSDK_OFFSET(0x1A5A4FF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A5A3410)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_REMOVEMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A5A4900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1A5A2D90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A5A4B70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1A5A2A20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1A5A29D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1A5A2B10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_SPLITLENGTH_OFFSET UNITYSDK_OFFSET(0x1A5A2BB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_SPLITUV2_OFFSET UNITYSDK_OFFSET(0x1A5A2C10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_SPLIT_OFFSET UNITYSDK_OFFSET(0x1A5A2B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_UNSCALEU_OFFSET UNITYSDK_OFFSET(0x1A5A2A70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_UNSCALINGORIGIN_OFFSET UNITYSDK_OFFSET(0x1A5A2AC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_VALIDATEMATERIALINDEX_OFFSET UNITYSDK_OFFSET(0x1A5A4AA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5A59E0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeMesh_TypeDefinitionIndex = 36850;
