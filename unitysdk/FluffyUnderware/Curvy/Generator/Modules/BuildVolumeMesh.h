...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_ADDMATERIAL_OFFSET UNITYSDK_OFFSET(0x19F91E10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_AWAKE_OFFSET UNITYSDK_OFFSET(0x19F91DE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_BUILD_OFFSET UNITYSDK_OFFSET(0x19F930C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_CREATEMATERIALGROUPUV2_OFFSET UNITYSDK_OFFSET(0x19F94890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_CREATEMATERIALGROUPUV_OFFSET UNITYSDK_OFFSET(0x19F94550)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_CREATEPATCHTRIANGLES_OFFSET UNITYSDK_OFFSET(0x19F949E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GETMATERIALIDGROUPS_OFFSET UNITYSDK_OFFSET(0x19F92AC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x19F94050)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x19F91B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x19F91B10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_ISSPLITUV2TOGGLABLE_OFFSET UNITYSDK_OFFSET(0x19F94B20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_MATERIALCOUNT_OFFSET UNITYSDK_OFFSET(0x19F91DC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_MATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x19F91DB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_MATERIALSETTTINGS_OFFSET UNITYSDK_OFFSET(0x19F91DA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x19F91C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_SPLITLENGTH_OFFSET UNITYSDK_OFFSET(0x19F91CF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_SPLITUV2_OFFSET UNITYSDK_OFFSET(0x19F91D50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_SPLIT_OFFSET UNITYSDK_OFFSET(0x19F91CA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_UNSCALEU_OFFSET UNITYSDK_OFFSET(0x19F91BB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_GET_UNSCALINGORIGIN_OFFSET UNITYSDK_OFFSET(0x19F91C00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_PREPARESUBMESHES_OFFSET UNITYSDK_OFFSET(0x19F94150)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x19F92560)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_REMOVEMATERIAL_OFFSET UNITYSDK_OFFSET(0x19F93A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_RESET_OFFSET UNITYSDK_OFFSET(0x19F91EE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SETMATERIAL_OFFSET UNITYSDK_OFFSET(0x19F93CD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x19F91B70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x19F91B20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x19F91C60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_SPLITLENGTH_OFFSET UNITYSDK_OFFSET(0x19F91D00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_SPLITUV2_OFFSET UNITYSDK_OFFSET(0x19F91D60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_SPLIT_OFFSET UNITYSDK_OFFSET(0x19F91CB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_UNSCALEU_OFFSET UNITYSDK_OFFSET(0x19F91BC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_SET_UNSCALINGORIGIN_OFFSET UNITYSDK_OFFSET(0x19F91C10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH_VALIDATEMATERIALINDEX_OFFSET UNITYSDK_OFFSET(0x19F93C00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x19F94B40)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeMesh_TypeDefinitionIndex = 35830;
