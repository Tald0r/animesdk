...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A3178B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_CREATEMESHES_OFFSET UNITYSDK_OFFSET(0x1A3192E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_CREATESPOTMESHES_OFFSET UNITYSDK_OFFSET(0x1A3185E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1A317490)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GETNEWMESH_OFFSET UNITYSDK_OFFSET(0x1A319FB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ADDNORMALS_OFFSET UNITYSDK_OFFSET(0x1A316430)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ADDTANGENTS_OFFSET UNITYSDK_OFFSET(0x1A316480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ADDUV2_OFFSET UNITYSDK_OFFSET(0x1A3164D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ANCHOROVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A316820)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_AUTOUPDATECOLLIDERS_OFFSET UNITYSDK_OFFSET(0x1A316960)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CANGROUPMESHES_OFFSET UNITYSDK_OFFSET(0x1A316BF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CANMODIFYSTATICFLAG_OFFSET UNITYSDK_OFFSET(0x1A316C10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CANUPDATE_OFFSET UNITYSDK_OFFSET(0x1A316C20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CASTSHADOWS_OFFSET UNITYSDK_OFFSET(0x1A316690)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1A316910)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_COMBINE_OFFSET UNITYSDK_OFFSET(0x1A3161F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CONVEX_OFFSET UNITYSDK_OFFSET(0x1A3169B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_COOKINGOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A316A50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ENABLEISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A316C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_GROUPMESHES_OFFSET UNITYSDK_OFFSET(0x1A316340)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_INCLUDENORMALS_OFFSET UNITYSDK_OFFSET(0x1A316390)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_INCLUDETANGENTS_OFFSET UNITYSDK_OFFSET(0x1A3163E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A316A00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_LAYER_OFFSET UNITYSDK_OFFSET(0x1A316520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_LIGHTPROBEUSAGE_OFFSET UNITYSDK_OFFSET(0x1A316780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_MAKESTATIC_OFFSET UNITYSDK_OFFSET(0x1A3165F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A316AA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_MESHCOUNT_OFFSET UNITYSDK_OFFSET(0x1A316BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_MESHES_OFFSET UNITYSDK_OFFSET(0x1A316B90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_RECEIVESHADOWS_OFFSET UNITYSDK_OFFSET(0x1A3166E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_REFLECTIONPROBES_OFFSET UNITYSDK_OFFSET(0x1A3167D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_RENDERERENABLED_OFFSET UNITYSDK_OFFSET(0x1A316640)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1A316580)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_UNWRAPUV2_OFFSET UNITYSDK_OFFSET(0x1A316240)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_USELIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x1A316730)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1A316BD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A319AD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A319AC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A316C90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A3178C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1A31AA70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1A316CC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SAVERESOURCETOSCENE_OFFSET UNITYSDK_OFFSET(0x1A31AB20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SAVETOASSET_OFFSET UNITYSDK_OFFSET(0x1A31AA80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SAVETOSCENEANDASSET_OFFSET UNITYSDK_OFFSET(0x1A31AAD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ADDNORMALS_OFFSET UNITYSDK_OFFSET(0x1A316440)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ADDTANGENTS_OFFSET UNITYSDK_OFFSET(0x1A316490)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ADDUV2_OFFSET UNITYSDK_OFFSET(0x1A3164E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ANCHOROVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A316830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_AUTOUPDATECOLLIDERS_OFFSET UNITYSDK_OFFSET(0x1A316970)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_CASTSHADOWS_OFFSET UNITYSDK_OFFSET(0x1A3166A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1A316920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_COMBINE_OFFSET UNITYSDK_OFFSET(0x1A316200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_CONVEX_OFFSET UNITYSDK_OFFSET(0x1A3169C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_COOKINGOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A316A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_GROUPMESHES_OFFSET UNITYSDK_OFFSET(0x1A316350)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_INCLUDENORMALS_OFFSET UNITYSDK_OFFSET(0x1A3163A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_INCLUDETANGENTS_OFFSET UNITYSDK_OFFSET(0x1A3163F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A316A10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_LAYER_OFFSET UNITYSDK_OFFSET(0x1A316530)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_LIGHTPROBEUSAGE_OFFSET UNITYSDK_OFFSET(0x1A316790)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_MAKESTATIC_OFFSET UNITYSDK_OFFSET(0x1A316600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A316AB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_RECEIVESHADOWS_OFFSET UNITYSDK_OFFSET(0x1A3166F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_REFLECTIONPROBES_OFFSET UNITYSDK_OFFSET(0x1A3167E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_RENDERERENABLED_OFFSET UNITYSDK_OFFSET(0x1A316650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_TAG_OFFSET UNITYSDK_OFFSET(0x1A316590)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_UNWRAPUV2_OFFSET UNITYSDK_OFFSET(0x1A316250)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_USELIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x1A316740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1A316BE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_TOONEDIMENSIONALARRAY_OFFSET UNITYSDK_OFFSET(0x1A318140)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_UPDATECOLLIDERS_OFFSET UNITYSDK_OFFSET(0x1A319400)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_VALIDATEMESH_OFFSET UNITYSDK_OFFSET(0x1A31A680)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_WRITEVMESHTOMESH_OFFSET UNITYSDK_OFFSET(0x1A319B80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3172A0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int CreateMesh_TypeDefinitionIndex = 35840;
