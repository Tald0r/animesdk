...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A8CDC60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_CREATEMESHES_OFFSET UNITYSDK_OFFSET(0x1A8CF690)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_CREATESPOTMESHES_OFFSET UNITYSDK_OFFSET(0x1A8CE990)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1A8CD840)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GETNEWMESH_OFFSET UNITYSDK_OFFSET(0x1A8D0360)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ADDNORMALS_OFFSET UNITYSDK_OFFSET(0x1A8CC7F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ADDTANGENTS_OFFSET UNITYSDK_OFFSET(0x1A8CC840)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ADDUV2_OFFSET UNITYSDK_OFFSET(0x1A8CC890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ANCHOROVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A8CCBE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_AUTOUPDATECOLLIDERS_OFFSET UNITYSDK_OFFSET(0x1A8CCD20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CANGROUPMESHES_OFFSET UNITYSDK_OFFSET(0x1A8CCFB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CANMODIFYSTATICFLAG_OFFSET UNITYSDK_OFFSET(0x1A8CCFD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CANUPDATE_OFFSET UNITYSDK_OFFSET(0x1A8CCFE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CASTSHADOWS_OFFSET UNITYSDK_OFFSET(0x1A8CCA50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1A8CCCD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_COMBINE_OFFSET UNITYSDK_OFFSET(0x1A8CC5B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_CONVEX_OFFSET UNITYSDK_OFFSET(0x1A8CCD70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_COOKINGOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A8CCE10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ENABLEISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A8CD010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_GROUPMESHES_OFFSET UNITYSDK_OFFSET(0x1A8CC700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_INCLUDENORMALS_OFFSET UNITYSDK_OFFSET(0x1A8CC750)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_INCLUDETANGENTS_OFFSET UNITYSDK_OFFSET(0x1A8CC7A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A8CCDC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_LAYER_OFFSET UNITYSDK_OFFSET(0x1A8CC8E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_LIGHTPROBEUSAGE_OFFSET UNITYSDK_OFFSET(0x1A8CCB40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_MAKESTATIC_OFFSET UNITYSDK_OFFSET(0x1A8CC9B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A8CCE60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_MESHCOUNT_OFFSET UNITYSDK_OFFSET(0x1A8CCF60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_MESHES_OFFSET UNITYSDK_OFFSET(0x1A8CCF50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_RECEIVESHADOWS_OFFSET UNITYSDK_OFFSET(0x1A8CCAA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_REFLECTIONPROBES_OFFSET UNITYSDK_OFFSET(0x1A8CCB90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_RENDERERENABLED_OFFSET UNITYSDK_OFFSET(0x1A8CCA00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_TAG_OFFSET UNITYSDK_OFFSET(0x1A8CC940)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_UNWRAPUV2_OFFSET UNITYSDK_OFFSET(0x1A8CC600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_USELIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x1A8CCAF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1A8CCF90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A8CFE80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A8CFE70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A8CD050)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A8CDC70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1A8D0E20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1A8CD080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SAVERESOURCETOSCENE_OFFSET UNITYSDK_OFFSET(0x1A8D0ED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SAVETOASSET_OFFSET UNITYSDK_OFFSET(0x1A8D0E30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SAVETOSCENEANDASSET_OFFSET UNITYSDK_OFFSET(0x1A8D0E80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ADDNORMALS_OFFSET UNITYSDK_OFFSET(0x1A8CC800)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ADDTANGENTS_OFFSET UNITYSDK_OFFSET(0x1A8CC850)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ADDUV2_OFFSET UNITYSDK_OFFSET(0x1A8CC8A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ANCHOROVERRIDE_OFFSET UNITYSDK_OFFSET(0x1A8CCBF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_AUTOUPDATECOLLIDERS_OFFSET UNITYSDK_OFFSET(0x1A8CCD30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_CASTSHADOWS_OFFSET UNITYSDK_OFFSET(0x1A8CCA60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_COLLIDER_OFFSET UNITYSDK_OFFSET(0x1A8CCCE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_COMBINE_OFFSET UNITYSDK_OFFSET(0x1A8CC5C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_CONVEX_OFFSET UNITYSDK_OFFSET(0x1A8CCD80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_COOKINGOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A8CCE20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_GROUPMESHES_OFFSET UNITYSDK_OFFSET(0x1A8CC710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_INCLUDENORMALS_OFFSET UNITYSDK_OFFSET(0x1A8CC760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_INCLUDETANGENTS_OFFSET UNITYSDK_OFFSET(0x1A8CC7B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_ISTRIGGER_OFFSET UNITYSDK_OFFSET(0x1A8CCDD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_LAYER_OFFSET UNITYSDK_OFFSET(0x1A8CC8F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_LIGHTPROBEUSAGE_OFFSET UNITYSDK_OFFSET(0x1A8CCB50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_MAKESTATIC_OFFSET UNITYSDK_OFFSET(0x1A8CC9C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A8CCE70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_RECEIVESHADOWS_OFFSET UNITYSDK_OFFSET(0x1A8CCAB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_REFLECTIONPROBES_OFFSET UNITYSDK_OFFSET(0x1A8CCBA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_RENDERERENABLED_OFFSET UNITYSDK_OFFSET(0x1A8CCA10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_TAG_OFFSET UNITYSDK_OFFSET(0x1A8CC950)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_UNWRAPUV2_OFFSET UNITYSDK_OFFSET(0x1A8CC610)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_USELIGHTPROBES_OFFSET UNITYSDK_OFFSET(0x1A8CCB00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_SET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1A8CCFA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_TOONEDIMENSIONALARRAY_OFFSET UNITYSDK_OFFSET(0x1A8CE4F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_UPDATECOLLIDERS_OFFSET UNITYSDK_OFFSET(0x1A8CF7B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_VALIDATEMESH_OFFSET UNITYSDK_OFFSET(0x1A8D0A30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH_WRITEVMESHTOMESH_OFFSET UNITYSDK_OFFSET(0x1A8CFF30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8CD660)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int CreateMesh_TypeDefinitionIndex = 36860;
