...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_GET_GAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x19F32EC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x19F32ED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x19F331F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_REFRESH_OFFSET UNITYSDK_OFFSET(0x19F32F30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_RESET_OFFSET UNITYSDK_OFFSET(0x19F32EE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_WARNABOUTINVALIDINPUTS_OFFSET UNITYSDK_OFFSET(0x19F33240)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F33400)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputGameObject_TypeDefinitionIndex = 35851;
