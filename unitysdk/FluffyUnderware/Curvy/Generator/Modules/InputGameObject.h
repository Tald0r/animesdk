...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_GET_GAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A551810)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1A551820)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1A551B40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A551880)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_RESET_OFFSET UNITYSDK_OFFSET(0x1A551830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT_WARNABOUTINVALIDINPUTS_OFFSET UNITYSDK_OFFSET(0x1A551B90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A551D50)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputGameObject_TypeDefinitionIndex = 36871;
