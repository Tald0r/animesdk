...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_GET_MIXCURVE_OFFSET UNITYSDK_OFFSET(0x1A8D34D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1A8D3280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1A8D3560)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_RESET_OFFSET UNITYSDK_OFFSET(0x1A8D3520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_SET_MIXCURVE_OFFSET UNITYSDK_OFFSET(0x1A8D34E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D3B30)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierVariableMixShapes_TypeDefinitionIndex = 36889;
