...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_GET_MIXCURVE_OFFSET UNITYSDK_OFFSET(0x1A31D140)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1A31CEF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1A31D1D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_RESET_OFFSET UNITYSDK_OFFSET(0x1A31D190)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES_SET_MIXCURVE_OFFSET UNITYSDK_OFFSET(0x1A31D150)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERVARIABLEMIXSHAPES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A31D7A0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierVariableMixShapes_TypeDefinitionIndex = 35869;
