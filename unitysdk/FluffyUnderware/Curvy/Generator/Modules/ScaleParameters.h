...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALEPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A2DA0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ScaleParameters_TypeDefinitionIndex = 35820;
	...
	public:
		...
		::System::Single ScaleOffset; // 0x24
