...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALEPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF6EDB0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ScaleParameters_TypeDefinitionIndex = 36840;
	...
	public:
		...
		::FluffyUnderware::Curvy::Generator::Modules::ScaleMode ScaleMode; // 0x24
		::System::Boolean ScaleUniform; // 0x28
		::System::Single ScaleY; // 0x2C
		::FluffyUnderware::Curvy::Generator::CGReferenceMode ScaleReference; // 0x30
		::System::Single ScaleOffset; // 0x34
