...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_CLEAR_OFFSET UNITYSDK_OFFSET(0x19F95200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x19F94E60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_APPLYLAYERONCHILDREN_OFFSET UNITYSDK_OFFSET(0x19F94CB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_GAMEOBJECTCOUNT_OFFSET UNITYSDK_OFFSET(0x19F94D60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_GAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x19F94D50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_LAYER_OFFSET UNITYSDK_OFFSET(0x19F94C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_GET_MAKESTATIC_OFFSET UNITYSDK_OFFSET(0x19F94D00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19F94E20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_REFRESH_OFFSET UNITYSDK_OFFSET(0x19F95210)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x19F96110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_RESET_OFFSET UNITYSDK_OFFSET(0x19F94D90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_SAVERESOURCETOSCENE_OFFSET UNITYSDK_OFFSET(0x19F96070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_SET_APPLYLAYERONCHILDREN_OFFSET UNITYSDK_OFFSET(0x19F94CC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_SET_LAYER_OFFSET UNITYSDK_OFFSET(0x19F94C60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT_SET_MAKESTATIC_OFFSET UNITYSDK_OFFSET(0x19F94D10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F96190)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int CreateGameObject_TypeDefinitionIndex = 35838;
