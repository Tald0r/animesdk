...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_COMBINEMESHFILTERS_OFFSET UNITYSDK_OFFSET(0x1AE84AF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_GET_CENTERMESH_OFFSET UNITYSDK_OFFSET(0x1AE83B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_GET_USECHILDRENMESHES_OFFSET UNITYSDK_OFFSET(0x1AE83B10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1AE83C20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1AE83BB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_SET_CENTERMESH_OFFSET UNITYSDK_OFFSET(0x1AE83B70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_SET_USECHILDRENMESHES_OFFSET UNITYSDK_OFFSET(0x1AE83B20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE856C0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int GameObjectToMesh_TypeDefinitionIndex = 35850;
