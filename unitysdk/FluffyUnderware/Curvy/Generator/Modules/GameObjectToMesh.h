...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_COMBINEMESHFILTERS_OFFSET UNITYSDK_OFFSET(0x1B49FB50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_GET_CENTERMESH_OFFSET UNITYSDK_OFFSET(0x1B49EBC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_GET_USECHILDRENMESHES_OFFSET UNITYSDK_OFFSET(0x1B49EB70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1B49EC80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1B49EC10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_SET_CENTERMESH_OFFSET UNITYSDK_OFFSET(0x1B49EBD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH_SET_USECHILDRENMESHES_OFFSET UNITYSDK_OFFSET(0x1B49EB80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_GAMEOBJECTTOMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A0720)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int GameObjectToMesh_TypeDefinitionIndex = 36870;
