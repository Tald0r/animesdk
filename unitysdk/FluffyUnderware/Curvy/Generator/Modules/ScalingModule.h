...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETADVANCEDSCALE_OFFSET UNITYSDK_OFFSET(0x1A92E920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETRELATIVEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A92E880)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSCALE_1_OFFSET UNITYSDK_OFFSET(0x1A92E6D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSCALE_2_OFFSET UNITYSDK_OFFSET(0x1A92E570)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSCALE_OFFSET UNITYSDK_OFFSET(0x1A92E510)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSIMPLESCALE_OFFSET UNITYSDK_OFFSET(0x1A92E9E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEMODE_OFFSET UNITYSDK_OFFSET(0x1A92E0B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEMULTIPLIERX_OFFSET UNITYSDK_OFFSET(0x1A92E240)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEMULTIPLIERY_OFFSET UNITYSDK_OFFSET(0x1A92E2E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1A92E1A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A92E100)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEUNIFORM_OFFSET UNITYSDK_OFFSET(0x1A92E150)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1A92E1F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1A92E290)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_RESET_OFFSET UNITYSDK_OFFSET(0x1A92E330)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEMODE_OFFSET UNITYSDK_OFFSET(0x1A92E0C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEMULTIPLIERX_OFFSET UNITYSDK_OFFSET(0x1A92E250)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEMULTIPLIERY_OFFSET UNITYSDK_OFFSET(0x1A92E2F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1A92E1B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A92E110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEUNIFORM_OFFSET UNITYSDK_OFFSET(0x1A92E160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1A92E200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1A92E2A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A92EA00)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ScalingModule_TypeDefinitionIndex = 36841;
