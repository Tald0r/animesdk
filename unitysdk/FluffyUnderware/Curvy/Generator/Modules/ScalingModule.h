...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETADVANCEDSCALE_OFFSET UNITYSDK_OFFSET(0x1A36AF10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETRELATIVEDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A36AE70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSCALE_1_OFFSET UNITYSDK_OFFSET(0x1A36ACC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSCALE_2_OFFSET UNITYSDK_OFFSET(0x1A36AB60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSCALE_OFFSET UNITYSDK_OFFSET(0x1A36AB00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GETSIMPLESCALE_OFFSET UNITYSDK_OFFSET(0x1A36AFD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEMODE_OFFSET UNITYSDK_OFFSET(0x1A36A6A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEMULTIPLIERX_OFFSET UNITYSDK_OFFSET(0x1A36A830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEMULTIPLIERY_OFFSET UNITYSDK_OFFSET(0x1A36A8D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1A36A790)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A36A6F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEUNIFORM_OFFSET UNITYSDK_OFFSET(0x1A36A740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1A36A7E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_GET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1A36A880)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_RESET_OFFSET UNITYSDK_OFFSET(0x1A36A920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEMODE_OFFSET UNITYSDK_OFFSET(0x1A36A6B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEMULTIPLIERX_OFFSET UNITYSDK_OFFSET(0x1A36A840)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEMULTIPLIERY_OFFSET UNITYSDK_OFFSET(0x1A36A8E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEOFFSET_OFFSET UNITYSDK_OFFSET(0x1A36A7A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A36A700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEUNIFORM_OFFSET UNITYSDK_OFFSET(0x1A36A750)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEX_OFFSET UNITYSDK_OFFSET(0x1A36A7F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE_SET_SCALEY_OFFSET UNITYSDK_OFFSET(0x1A36A890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_SCALINGMODULE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A36AFF0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ScalingModule_TypeDefinitionIndex = 35821;
