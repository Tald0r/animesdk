...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_GET_MESHES_OFFSET UNITYSDK_OFFSET(0x1B0675D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1B0675E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1B067A00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B0675F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1B067740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1B0676F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_WARNABOUTINVALIDINPUTS_OFFSET UNITYSDK_OFFSET(0x1B067A50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B067DB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH__WARNABOUTINVALIDINPUTS_B__10_3_OFFSET UNITYSDK_OFFSET(0x1B067F00)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputMesh_TypeDefinitionIndex = 36873;
