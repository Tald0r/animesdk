...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_GET_MESHES_OFFSET UNITYSDK_OFFSET(0x1AA53540)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1AA53550)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1AA53970)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AA53560)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_REFRESH_OFFSET UNITYSDK_OFFSET(0x1AA536B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1AA53660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH_WARNABOUTINVALIDINPUTS_OFFSET UNITYSDK_OFFSET(0x1AA539C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA53D20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTMESH__WARNABOUTINVALIDINPUTS_B__10_3_OFFSET UNITYSDK_OFFSET(0x1AA53E70)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputMesh_TypeDefinitionIndex = 35853;
