...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_GET_INPUTSPLINE_OFFSET UNITYSDK_OFFSET(0x1AD134E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1AD130D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1AD131F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1AD13200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1AD13380)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_SET_INPUTSPLINE_OFFSET UNITYSDK_OFFSET(0x1AD134F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1AD130E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD13600)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputSplinePath_TypeDefinitionIndex = 36875;
