...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_GET_INPUTSPLINE_OFFSET UNITYSDK_OFFSET(0x1A774BD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1A7747C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1A7748E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1A7748F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_ONTEMPLATECREATED_OFFSET UNITYSDK_OFFSET(0x1A774A70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_SET_INPUTSPLINE_OFFSET UNITYSDK_OFFSET(0x1A774BE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1A7747D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A774CF0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputSplinePath_TypeDefinitionIndex = 35855;
