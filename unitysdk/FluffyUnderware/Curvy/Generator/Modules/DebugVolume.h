...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEBUGVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AE6EBF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEBUGVOLUME_RESET_OFFSET UNITYSDK_OFFSET(0x1AE6EC20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEBUGVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE6EC90)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int DebugVolume_TypeDefinitionIndex = 35846;
