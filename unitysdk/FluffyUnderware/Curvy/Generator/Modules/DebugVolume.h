...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEBUGVOLUME_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B4880C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEBUGVOLUME_RESET_OFFSET UNITYSDK_OFFSET(0x1B4880F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_DEBUGVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B488160)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int DebugVolume_TypeDefinitionIndex = 36866;
