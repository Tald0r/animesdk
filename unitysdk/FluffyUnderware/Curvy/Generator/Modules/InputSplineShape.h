...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_GET_FREEFORM_OFFSET UNITYSDK_OFFSET(0x1B507BF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_GET_INPUTSPLINE_OFFSET UNITYSDK_OFFSET(0x1B508230)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_GET_SHAPE_OFFSET UNITYSDK_OFFSET(0x1B507940)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_GET_SUPPORTSIPE_OFFSET UNITYSDK_OFFSET(0x1B507BE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1B508010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_ONSPLINEASSIGNED_OFFSET UNITYSDK_OFFSET(0x1B507B20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_REMOVEMANAGEDSHAPE_OFFSET UNITYSDK_OFFSET(0x1B508160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_SET_FREEFORM_OFFSET UNITYSDK_OFFSET(0x1B507DA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_SET_INPUTSPLINE_OFFSET UNITYSDK_OFFSET(0x1B508240)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE_SET_SHAPE_OFFSET UNITYSDK_OFFSET(0x1B507950)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_INPUTSPLINESHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B508250)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int InputSplineShape_TypeDefinitionIndex = 36876;
