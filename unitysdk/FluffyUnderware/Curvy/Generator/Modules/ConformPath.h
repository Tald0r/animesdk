...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_CONFORM_1_OFFSET UNITYSDK_OFFSET(0x1B5073D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_CONFORM_OFFSET UNITYSDK_OFFSET(0x1B507370)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1B506CB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x1B506E50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B506D60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1B506DB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1B507030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_WARP_OFFSET UNITYSDK_OFFSET(0x1B506E00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B506EA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1B507180)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_RESET_OFFSET UNITYSDK_OFFSET(0x1B506ED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1B506CD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x1B506E60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B506D70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1B506DC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_WARP_OFFSET UNITYSDK_OFFSET(0x1B506E10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5078B0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ConformPath_TypeDefinitionIndex = 36857;
