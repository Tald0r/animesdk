...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_CONFORM_1_OFFSET UNITYSDK_OFFSET(0x1AEDF640)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_CONFORM_OFFSET UNITYSDK_OFFSET(0x1AEDF5E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1AEDEF20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x1AEDF0C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AEDEFD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1AEDF020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1AEDF2A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_GET_WARP_OFFSET UNITYSDK_OFFSET(0x1AEDF070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AEDF110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1AEDF3F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_RESET_OFFSET UNITYSDK_OFFSET(0x1AEDF140)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1AEDEF40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_LAYERMASK_OFFSET UNITYSDK_OFFSET(0x1AEDF0D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_MAXDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AEDEFE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_OFFSET_OFFSET UNITYSDK_OFFSET(0x1AEDF030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH_SET_WARP_OFFSET UNITYSDK_OFFSET(0x1AEDF080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CONFORMPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEDFB20)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ConformPath_TypeDefinitionIndex = 35837;
