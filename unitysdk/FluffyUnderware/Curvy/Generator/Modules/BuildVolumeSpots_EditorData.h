...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9723F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x972340)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GETBOUNDSNAMES_OFFSET UNITYSDK_OFFSET(0x1AE2D570)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x972400)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GET_BOUNDSNAMES_OFFSET UNITYSDK_OFFSET(0x272280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GET_INPUTISAVOLUME_OFFSET UNITYSDK_OFFSET(0x351E80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GET_SPOTSCOUNT_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AE2D760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AE2D810)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x972320)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeSpots_EditorData_TypeDefinitionIndex = 36852;
