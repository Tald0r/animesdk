...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x942D10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x942C60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GETBOUNDSNAMES_OFFSET UNITYSDK_OFFSET(0x1A84D910)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x942D20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GET_BOUNDSNAMES_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GET_INPUTISAVOLUME_OFFSET UNITYSDK_OFFSET(0x33E1C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_GET_SPOTSCOUNT_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A84DB00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A84DBB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_EDITORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x942C40)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeSpots_EditorData_TypeDefinitionIndex = 35832;
