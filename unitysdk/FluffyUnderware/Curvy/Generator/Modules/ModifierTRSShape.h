...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSSHAPE_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1B1F53D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSSHAPE_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1B1F5520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F5640)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierTRSShape_TypeDefinitionIndex = 36888;
