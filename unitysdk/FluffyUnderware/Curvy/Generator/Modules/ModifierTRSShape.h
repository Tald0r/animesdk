...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSSHAPE_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1ABE4510)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSSHAPE_ONSLOTDATAREQUEST_OFFSET UNITYSDK_OFFSET(0x1ABE4660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_MODIFIERTRSSHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABE4780)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int ModifierTRSShape_TypeDefinitionIndex = 35868;
