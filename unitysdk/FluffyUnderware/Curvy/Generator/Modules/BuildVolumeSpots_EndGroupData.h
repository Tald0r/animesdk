...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1AF6ECC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AF6EB40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AF6ED40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_BOUNDSGROUP_OFFSET UNITYSDK_OFFSET(0x1AF6EAA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_GROUPDEPTH_OFFSET UNITYSDK_OFFSET(0x1AF6EAC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_ITEMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AF6EAD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_ITEMINDICES_OFFSET UNITYSDK_OFFSET(0x1AF6EAB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_SPACEAFTER_OFFSET UNITYSDK_OFFSET(0x1AF6EAF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_SPACEBEFORE_OFFSET UNITYSDK_OFFSET(0x1AF6EAE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF6EB00)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeSpots_EndGroupData_TypeDefinitionIndex = 36853;

	class BuildVolumeSpots_EndGroupData : public ::System::Object
	{
	public:
		::ToolBuddy::Pooling::Collections::SubArray_1<::System::Int32> _ItemIndices_k__BackingField; // 0x10
		::FluffyUnderware::Curvy::Generator::CGBoundsGroup* _BoundsGroup_k__BackingField; // 0x20
		::Il2CppArray<::FluffyUnderware::Curvy::Generator::CGBounds*>* _ItemBounds_k__BackingField; // 0x28
		::System::Single _SpaceAfter_k__BackingField; // 0x30
