...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A9A2CB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A9A2B30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A9A2D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_BOUNDSGROUP_OFFSET UNITYSDK_OFFSET(0x1A9A2A90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_GROUPDEPTH_OFFSET UNITYSDK_OFFSET(0x1A9A2AB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_ITEMBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A9A2AC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_ITEMINDICES_OFFSET UNITYSDK_OFFSET(0x1A9A2AA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_SPACEAFTER_OFFSET UNITYSDK_OFFSET(0x1A9A2AE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA_GET_SPACEBEFORE_OFFSET UNITYSDK_OFFSET(0x1A9A2AD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMESPOTS_ENDGROUPDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A2AF0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeSpots_EndGroupData_TypeDefinitionIndex = 35833;
	...
	public:
		...
		::Il2CppArray<::FluffyUnderware::Curvy::Generator::CGBounds*>* _ItemBounds_k__BackingField; // 0x20
		...
		::System::Single _GroupDepth_k__BackingField; // 0x34
