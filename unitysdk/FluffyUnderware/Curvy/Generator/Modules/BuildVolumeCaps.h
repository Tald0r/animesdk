...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_APPLYMATRIX_OFFSET UNITYSDK_OFFSET(0x1A315900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_APPLYUV2_OFFSET UNITYSDK_OFFSET(0x1A316010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_APPLYUV_OFFSET UNITYSDK_OFFSET(0x1A315C70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A312E40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_FLIPTRIS_OFFSET UNITYSDK_OFFSET(0x1A315BD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GETMATRIX_OFFSET UNITYSDK_OFFSET(0x1A315400)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_CLONESTARTCAP_OFFSET UNITYSDK_OFFSET(0x1A312CF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_ENDCAP_OFFSET UNITYSDK_OFFSET(0x1A312CA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_ENDMATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A312D40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_ENDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A312D50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1A312AB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1A312A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1A312B00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_STARTCAP_OFFSET UNITYSDK_OFFSET(0x1A312B50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_STARTMATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A312C90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_STARTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A312BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_MAKE2DSEGMENT_OFFSET UNITYSDK_OFFSET(0x1A3151A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A3134B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_RESET_OFFSET UNITYSDK_OFFSET(0x1A313120)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_CLONESTARTCAP_OFFSET UNITYSDK_OFFSET(0x1A312D00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_ENDCAP_OFFSET UNITYSDK_OFFSET(0x1A312CB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_ENDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A312D60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1A312AC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1A312A70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1A312B10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_STARTCAP_OFFSET UNITYSDK_OFFSET(0x1A312B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_STARTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A312BB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3160E0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeCaps_TypeDefinitionIndex = 35828;
