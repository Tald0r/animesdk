...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_APPLYMATRIX_OFFSET UNITYSDK_OFFSET(0x1A8CBCC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_APPLYUV2_OFFSET UNITYSDK_OFFSET(0x1A8CC3D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_APPLYUV_OFFSET UNITYSDK_OFFSET(0x1A8CC030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_AWAKE_OFFSET UNITYSDK_OFFSET(0x1A8C9220)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_FLIPTRIS_OFFSET UNITYSDK_OFFSET(0x1A8CBF90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GETMATRIX_OFFSET UNITYSDK_OFFSET(0x1A8CB7C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_CLONESTARTCAP_OFFSET UNITYSDK_OFFSET(0x1A8C90D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_ENDCAP_OFFSET UNITYSDK_OFFSET(0x1A8C9080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_ENDMATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A8C9120)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_ENDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A8C9130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1A8C8E90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1A8C8E40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1A8C8EE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_STARTCAP_OFFSET UNITYSDK_OFFSET(0x1A8C8F30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_STARTMATERIALSETTINGS_OFFSET UNITYSDK_OFFSET(0x1A8C9070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_GET_STARTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A8C8F80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_MAKE2DSEGMENT_OFFSET UNITYSDK_OFFSET(0x1A8CB560)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A8C9890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_RESET_OFFSET UNITYSDK_OFFSET(0x1A8C9500)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_CLONESTARTCAP_OFFSET UNITYSDK_OFFSET(0x1A8C90E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_ENDCAP_OFFSET UNITYSDK_OFFSET(0x1A8C9090)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_ENDMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A8C9140)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_GENERATEUV2_OFFSET UNITYSDK_OFFSET(0x1A8C8EA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_GENERATEUV_OFFSET UNITYSDK_OFFSET(0x1A8C8E50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_REVERSETRIORDER_OFFSET UNITYSDK_OFFSET(0x1A8C8EF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_STARTCAP_OFFSET UNITYSDK_OFFSET(0x1A8C8F40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS_SET_STARTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A8C8F90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_BUILDVOLUMECAPS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8CC4A0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int BuildVolumeCaps_TypeDefinitionIndex = 36848;
