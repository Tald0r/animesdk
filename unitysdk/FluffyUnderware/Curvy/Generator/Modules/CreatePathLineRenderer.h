...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEPATHLINERENDERER_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0x1A4F0450)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEPATHLINERENDERER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A4F08E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEPATHLINERENDERER_RESET_OFFSET UNITYSDK_OFFSET(0x1A4F0560)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEPATHLINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F0EB0)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int CreatePathLineRenderer_TypeDefinitionIndex = 35843;
