...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEPATHLINERENDERER_GET_LINERENDERER_OFFSET UNITYSDK_OFFSET(0x1AAA29E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEPATHLINERENDERER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1AAA2E70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEPATHLINERENDERER_RESET_OFFSET UNITYSDK_OFFSET(0x1AAA2AF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_MODULES_CREATEPATHLINERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAA3440)

namespace FluffyUnderware::Curvy::Generator::Modules
{
	inline static constexpr unsigned int CreatePathLineRenderer_TypeDefinitionIndex = 36863;
