...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_CANLINKTO_OFFSET UNITYSDK_OFFSET(0x1A362910)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GETLINKEDMODULES_OFFSET UNITYSDK_OFFSET(0x1A362FD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_CANVASSPACEDROPZONE_OFFSET UNITYSDK_OFFSET(0x1A362B40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A362500)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_DROPZONE_OFFSET UNITYSDK_OFFSET(0x1A362B20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_EXTERNALINPUT_OFFSET UNITYSDK_OFFSET(0x1A362F70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_INFO_OFFSET UNITYSDK_OFFSET(0x1A362AE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_ISLINKEDANDCONFIGURED_OFFSET UNITYSDK_OFFSET(0x1A362CD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_ISLINKED_OFFSET UNITYSDK_OFFSET(0x1A362B90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_ISONREQUEST_OFFSET UNITYSDK_OFFSET(0x1A361280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_LINKEDSLOTS_OFFSET UNITYSDK_OFFSET(0x1A3625A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_MODULE_OFFSET UNITYSDK_OFFSET(0x1A362AC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A362FB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_ONREQUESTMODULE_OFFSET UNITYSDK_OFFSET(0x1A362EF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x1A362B00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_GET_PATHPROVIDER_OFFSET UNITYSDK_OFFSET(0x1A362F30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_HASLINKTO_OFFSET UNITYSDK_OFFSET(0x1A361740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_LINKINPUTANDOUTPUT_OFFSET UNITYSDK_OFFSET(0x1A361900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_LINKTO_OFFSET UNITYSDK_OFFSET(0x1A361D10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_LOADLINKEDSLOTS_OFFSET UNITYSDK_OFFSET(0x1A3616E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A362900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_REINITIALIZELINKEDSLOTS_OFFSET UNITYSDK_OFFSET(0x1A3616F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_SETINFOFROMFIELD_OFFSET UNITYSDK_OFFSET(0x1A3633F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_SET_DROPZONE_OFFSET UNITYSDK_OFFSET(0x1A362B30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_SET_INFO_OFFSET UNITYSDK_OFFSET(0x1A362AF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_SET_MODULE_OFFSET UNITYSDK_OFFSET(0x1A362AD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_SET_ORIGIN_OFFSET UNITYSDK_OFFSET(0x1A362B10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A3636B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_UNLINKALL_OFFSET UNITYSDK_OFFSET(0x1A363210)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT_UNLINKFROM_OFFSET UNITYSDK_OFFSET(0x1A361FF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULESLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A362A50)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModuleSlot_TypeDefinitionIndex = 35769;
