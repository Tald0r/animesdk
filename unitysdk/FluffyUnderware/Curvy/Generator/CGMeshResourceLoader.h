...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1B49DA00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1B49DA90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER_INITIALIZEONLOAD_OFFSET UNITYSDK_OFFSET(0x1B49D990)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B49D9F0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGMeshResourceLoader_TypeDefinitionIndex = 36770;
