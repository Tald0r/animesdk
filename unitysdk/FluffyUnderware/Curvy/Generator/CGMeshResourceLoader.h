...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1AE829A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1AE82A30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER_INITIALIZEONLOAD_OFFSET UNITYSDK_OFFSET(0x1AE82930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE82990)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGMeshResourceLoader_TypeDefinitionIndex = 35750;
