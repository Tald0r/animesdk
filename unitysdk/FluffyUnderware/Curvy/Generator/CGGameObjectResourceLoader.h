...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1A4EA520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1A4EA7B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER_INITIALIZEONLOAD_OFFSET UNITYSDK_OFFSET(0x1A4EA4B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4EA510)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGGameObjectResourceLoader_TypeDefinitionIndex = 35743;
