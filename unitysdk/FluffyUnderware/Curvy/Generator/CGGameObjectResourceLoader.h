...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER_CREATE_OFFSET UNITYSDK_OFFSET(0x1AA9CA90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1AA9CD20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER_INITIALIZEONLOAD_OFFSET UNITYSDK_OFFSET(0x1AA9CA20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA9CA80)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGGameObjectResourceLoader_TypeDefinitionIndex = 36763;
