...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1AF73280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_CALCULATEEXTENDEDUV_OFFSET UNITYSDK_OFFSET(0x1AF743E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_CLEARRANGE_OFFSET UNITYSDK_OFFSET(0x1AF70000)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FILLDATA_OFFSET UNITYSDK_OFFSET(0x1AF73750)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FINDNEXTREFERENCECPOPTIONS_OFFSET UNITYSDK_OFFSET(0x1AF75170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FINDPREVIOUSREFERENCECPOPTIONS_OFFSET UNITYSDK_OFFSET(0x1AF74EF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FORCEREFRESH_OFFSET UNITYSDK_OFFSET(0x1AF70650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GETPATHCLOSED_OFFSET UNITYSDK_OFFSET(0x1AF6FD40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GETSPLINEDATA_OFFSET UNITYSDK_OFFSET(0x1AF70A00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_ENDCP_OFFSET UNITYSDK_OFFSET(0x1AF6F920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_ISCONFIGURED_OFFSET UNITYSDK_OFFSET(0x1AF6FA70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1AF6FAF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1AF6FBA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_STARTCP_OFFSET UNITYSDK_OFFSET(0x1AF6EE40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1AF6EDF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_USEGLOBALSPACE_OFFSET UNITYSDK_OFFSET(0x1AF6FA20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_MOVEBYANGLEEXT_OFFSET UNITYSDK_OFFSET(0x1AF73EC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AF70050)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AF70010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONINPUTSPLINECOORDINATESCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF70840)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONSPLINEASSIGNED_OFFSET UNITYSDK_OFFSET(0x1AF75490)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONSPLINEINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1AF70670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONSPLINEREFRESHED_OFFSET UNITYSDK_OFFSET(0x1AF70480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AF70280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_PROCESSCONTROLPOINTOPTIONS_OFFSET UNITYSDK_OFFSET(0x1AF734C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_RESET_OFFSET UNITYSDK_OFFSET(0x1AF702C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SETRANGE_OFFSET UNITYSDK_OFFSET(0x1AF6FE10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_ENDCP_OFFSET UNITYSDK_OFFSET(0x1AF6F930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_STARTCP_OFFSET UNITYSDK_OFFSET(0x1AF6EE50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1AF6EE00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_USEGLOBALSPACE_OFFSET UNITYSDK_OFFSET(0x1AF6FA30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_VALIDATESTARTANDENDCPS_OFFSET UNITYSDK_OFFSET(0x1AF6EF40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF75700)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SplineInputModuleBase_TypeDefinitionIndex = 36836;
