...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ADDPOINT_OFFSET UNITYSDK_OFFSET(0x1A9A7270)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_CALCULATEEXTENDEDUV_OFFSET UNITYSDK_OFFSET(0x1A9A83D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_CLEARRANGE_OFFSET UNITYSDK_OFFSET(0x1A9A3FF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FILLDATA_OFFSET UNITYSDK_OFFSET(0x1A9A7740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FINDNEXTREFERENCECPOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A9A9160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FINDPREVIOUSREFERENCECPOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A9A8EE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_FORCEREFRESH_OFFSET UNITYSDK_OFFSET(0x1A9A4640)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GETPATHCLOSED_OFFSET UNITYSDK_OFFSET(0x1A9A3D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GETSPLINEDATA_OFFSET UNITYSDK_OFFSET(0x1A9A49F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_ENDCP_OFFSET UNITYSDK_OFFSET(0x1A9A3910)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_ISCONFIGURED_OFFSET UNITYSDK_OFFSET(0x1A9A3A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A9A3AE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_PATHISCLOSED_OFFSET UNITYSDK_OFFSET(0x1A9A3B90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_STARTCP_OFFSET UNITYSDK_OFFSET(0x1A9A2E30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1A9A2DE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_GET_USEGLOBALSPACE_OFFSET UNITYSDK_OFFSET(0x1A9A3A10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_MOVEBYANGLEEXT_OFFSET UNITYSDK_OFFSET(0x1A9A7EB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A9A4040)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A9A4000)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONINPUTSPLINECOORDINATESCHANGED_OFFSET UNITYSDK_OFFSET(0x1A9A4830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONSPLINEASSIGNED_OFFSET UNITYSDK_OFFSET(0x1A9A9480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONSPLINEINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A9A4660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONSPLINEREFRESHED_OFFSET UNITYSDK_OFFSET(0x1A9A4470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A9A4270)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_PROCESSCONTROLPOINTOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A9A74B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_RESET_OFFSET UNITYSDK_OFFSET(0x1A9A42B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SETRANGE_OFFSET UNITYSDK_OFFSET(0x1A9A3E00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_ENDCP_OFFSET UNITYSDK_OFFSET(0x1A9A3920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_STARTCP_OFFSET UNITYSDK_OFFSET(0x1A9A2E40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1A9A2DF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_SET_USEGLOBALSPACE_OFFSET UNITYSDK_OFFSET(0x1A9A3A20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE_VALIDATESTARTANDENDCPS_OFFSET UNITYSDK_OFFSET(0x1A9A2F30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SPLINEINPUTMODULEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A96F0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SplineInputModuleBase_TypeDefinitionIndex = 35816;
