...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_ADDSUBMESH_OFFSET UNITYSDK_OFFSET(0x1A76DE50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_ASMESH_OFFSET UNITYSDK_OFFSET(0x1A76FF80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_CLEARCACHEDSORTEDVERTEXINDICES_OFFSET UNITYSDK_OFFSET(0x1A770670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A76D280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GETCACHEDSORTEDVERTEXINDICES_OFFSET UNITYSDK_OFFSET(0x1A770870)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GETMATERIALSUBMESH_OFFSET UNITYSDK_OFFSET(0x1A76E920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GETMATERIALS_OFFSET UNITYSDK_OFFSET(0x1A7701F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_1_OFFSET UNITYSDK_OFFSET(0x1A76D7E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_2_OFFSET UNITYSDK_OFFSET(0x1A76D820)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A76B770)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_HASNORMALS_OFFSET UNITYSDK_OFFSET(0x1A76B7A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_HASPARTIALNORMALS_OFFSET UNITYSDK_OFFSET(0x1A76B7B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_HASPARTIALTANGENTS_OFFSET UNITYSDK_OFFSET(0x1A76B7E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_HASTANGENTS_OFFSET UNITYSDK_OFFSET(0x1A76B7D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_HASUV2_OFFSET UNITYSDK_OFFSET(0x1A76B790)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_HASUV_OFFSET UNITYSDK_OFFSET(0x1A76B780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_NORMALSLIST_OFFSET UNITYSDK_OFFSET(0x1A76AC90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_NORMALS_OFFSET UNITYSDK_OFFSET(0x1A76B3F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_OFFSET UNITYSDK_OFFSET(0x1A76D790)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_TANGENTSLIST_OFFSET UNITYSDK_OFFSET(0x1A76ADA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_TANGENTS_OFFSET UNITYSDK_OFFSET(0x1A76B5B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x1A76B800)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_UV2S_OFFSET UNITYSDK_OFFSET(0x1A76AB70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_UV2_OFFSET UNITYSDK_OFFSET(0x1A76B230)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_UVS_OFFSET UNITYSDK_OFFSET(0x1A76AA60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_UV_OFFSET UNITYSDK_OFFSET(0x1A76B070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_VERTEX_OFFSET UNITYSDK_OFFSET(0x1A76AEB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1A76A930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_MERGEUVSNORMALSANDTANGENTS_OFFSET UNITYSDK_OFFSET(0x1A76E2D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_MERGEVMESHES_OFFSET UNITYSDK_OFFSET(0x1A76EB90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_MERGEVMESH_1_OFFSET UNITYSDK_OFFSET(0x1A76DEF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_MERGEVMESH_OFFSET UNITYSDK_OFFSET(0x1A76DEA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_ONVERTICESCHANGED_OFFSET UNITYSDK_OFFSET(0x1A770660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_RECALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A770380)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_RECALCULATEUV2_OFFSET UNITYSDK_OFFSET(0x1A770540)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SETSUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x1A76DE00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_HASPARTIALNORMALS_OFFSET UNITYSDK_OFFSET(0x1A76B7C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_HASPARTIALTANGENTS_OFFSET UNITYSDK_OFFSET(0x1A76B7F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_NORMALSLIST_OFFSET UNITYSDK_OFFSET(0x1A76ACA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_NORMALS_OFFSET UNITYSDK_OFFSET(0x1A76B520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_TANGENTSLIST_OFFSET UNITYSDK_OFFSET(0x1A76ADB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_TANGENTS_OFFSET UNITYSDK_OFFSET(0x1A76B6E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_UV2S_OFFSET UNITYSDK_OFFSET(0x1A76AB80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_UV2_OFFSET UNITYSDK_OFFSET(0x1A76B360)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_UVS_OFFSET UNITYSDK_OFFSET(0x1A76AA70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_UV_OFFSET UNITYSDK_OFFSET(0x1A76B1A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_VERTEX_OFFSET UNITYSDK_OFFSET(0x1A76AFE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1A76A940)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_TOMESH_OFFSET UNITYSDK_OFFSET(0x1A76FFE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_TRS_OFFSET UNITYSDK_OFFSET(0x1A76CFE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A76B8A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A76C0A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A76C100)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A76C1C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A76C890)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1A76C9E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A76B870)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__MERGEVMESHES_G__PROCESSTRIANGLEARRAYS_74_0_OFFSET UNITYSDK_OFFSET(0x1A76FE00)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGVMesh_TypeDefinitionIndex = 35781;

	class CGVMesh : public ::FluffyUnderware::Curvy::Generator::CGBounds
	{
	public:
		::System::Object* vertexIndicesLock; // 0x40
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector4> tangents; // 0x48
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector2> uvs; // 0x58
		::System::Nullable_1<::ToolBuddy::Pooling::Collections::SubArray_1<::System::Int32>> sortedVertexIndices; // 0x68
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector3> normals; // 0x80
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector2> uv2s; // 0x90
		::Il2CppArray<::FluffyUnderware::Curvy::Generator::CGVSubMesh*>* SubMeshes; // 0xA0
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector3> vertices; // 0xA8
