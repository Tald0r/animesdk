...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_ADDSUBMESH_OFFSET UNITYSDK_OFFSET(0x1AD0C7A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_ASMESH_OFFSET UNITYSDK_OFFSET(0x1AD0E880)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_CLEARCACHEDSORTEDVERTEXINDICES_OFFSET UNITYSDK_OFFSET(0x1AD0EF60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD0BBD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GETCACHEDSORTEDVERTEXINDICES_OFFSET UNITYSDK_OFFSET(0x1AD0F160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GETMATERIALSUBMESH_OFFSET UNITYSDK_OFFSET(0x1AD0D260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GETMATERIALS_OFFSET UNITYSDK_OFFSET(0x1AD0EAE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_1_OFFSET UNITYSDK_OFFSET(0x1AD0C130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_2_OFFSET UNITYSDK_OFFSET(0x1AD0C170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AD0A0E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_HASNORMALS_OFFSET UNITYSDK_OFFSET(0x1AD0A110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_HASPARTIALNORMALS_OFFSET UNITYSDK_OFFSET(0x1AD0A120)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_HASPARTIALTANGENTS_OFFSET UNITYSDK_OFFSET(0x1AD0A150)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_HASTANGENTS_OFFSET UNITYSDK_OFFSET(0x1AD0A140)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_HASUV2_OFFSET UNITYSDK_OFFSET(0x1AD0A100)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_HASUV_OFFSET UNITYSDK_OFFSET(0x1AD0A0F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_NORMALSLIST_OFFSET UNITYSDK_OFFSET(0x1AD095E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_NORMALS_OFFSET UNITYSDK_OFFSET(0x1AD09D60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_OFFSET UNITYSDK_OFFSET(0x1AD0C0E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_TANGENTSLIST_OFFSET UNITYSDK_OFFSET(0x1AD09700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_TANGENTS_OFFSET UNITYSDK_OFFSET(0x1AD09F20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x1AD0A170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_UV2S_OFFSET UNITYSDK_OFFSET(0x1AD094C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_UV2_OFFSET UNITYSDK_OFFSET(0x1AD09BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_UVS_OFFSET UNITYSDK_OFFSET(0x1AD093B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_UV_OFFSET UNITYSDK_OFFSET(0x1AD099E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_VERTEX_OFFSET UNITYSDK_OFFSET(0x1AD09820)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1AD09280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_MERGEUVSNORMALSANDTANGENTS_OFFSET UNITYSDK_OFFSET(0x1AD0CC00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_MERGEVMESHES_OFFSET UNITYSDK_OFFSET(0x1AD0D4C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_MERGEVMESH_1_OFFSET UNITYSDK_OFFSET(0x1AD0C840)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_MERGEVMESH_OFFSET UNITYSDK_OFFSET(0x1AD0C7F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_ONVERTICESCHANGED_OFFSET UNITYSDK_OFFSET(0x1AD0EF50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_RECALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AD0EC70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_RECALCULATEUV2_OFFSET UNITYSDK_OFFSET(0x1AD0EE30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SETSUBMESHCOUNT_OFFSET UNITYSDK_OFFSET(0x1AD0C750)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_HASPARTIALNORMALS_OFFSET UNITYSDK_OFFSET(0x1AD0A130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_HASPARTIALTANGENTS_OFFSET UNITYSDK_OFFSET(0x1AD0A160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_NORMALSLIST_OFFSET UNITYSDK_OFFSET(0x1AD095F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_NORMALS_OFFSET UNITYSDK_OFFSET(0x1AD09E90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_TANGENTSLIST_OFFSET UNITYSDK_OFFSET(0x1AD09710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_TANGENTS_OFFSET UNITYSDK_OFFSET(0x1AD0A050)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_UV2S_OFFSET UNITYSDK_OFFSET(0x1AD094D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_UV2_OFFSET UNITYSDK_OFFSET(0x1AD09CD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_UVS_OFFSET UNITYSDK_OFFSET(0x1AD093C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_UV_OFFSET UNITYSDK_OFFSET(0x1AD09B10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_VERTEX_OFFSET UNITYSDK_OFFSET(0x1AD09950)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_SET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1AD09290)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_TOMESH_OFFSET UNITYSDK_OFFSET(0x1AD0E8E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH_TRS_OFFSET UNITYSDK_OFFSET(0x1AD0B930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD0A210)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AD0AA10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AD0AA70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1AD0AB30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1AD0B1E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1AD0B330)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD0A1E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVMESH__MERGEVMESHES_G__PROCESSTRIANGLEARRAYS_74_0_OFFSET UNITYSDK_OFFSET(0x1AD0E700)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGVMesh_TypeDefinitionIndex = 36801;

	class CGVMesh : public ::FluffyUnderware::Curvy::Generator::CGBounds
	{
	public:
		::System::Object* vertexIndicesLock; // 0x40
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector2> uvs; // 0x48
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector3> vertices; // 0x58
		::Il2CppArray<::FluffyUnderware::Curvy::Generator::CGVSubMesh*>* SubMeshes; // 0x68
