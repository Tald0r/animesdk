...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A3640C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A363A80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x1A3638C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_GET_SPOTS_OFFSET UNITYSDK_OFFSET(0x1A3637B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_SET_POINTS_OFFSET UNITYSDK_OFFSET(0x1A3639F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_SET_SPOTS_OFFSET UNITYSDK_OFFSET(0x1A3637C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A363BB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A363C30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A363C40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A363D80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A363F70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A363A90)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGSpots_TypeDefinitionIndex = 35779;
