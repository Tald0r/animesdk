...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A927AE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A9274A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_GET_POINTS_OFFSET UNITYSDK_OFFSET(0x1A9272E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_GET_SPOTS_OFFSET UNITYSDK_OFFSET(0x1A9271D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_SET_POINTS_OFFSET UNITYSDK_OFFSET(0x1A927410)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS_SET_SPOTS_OFFSET UNITYSDK_OFFSET(0x1A9271E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9275D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A927650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A927660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A9277A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1A927990)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9274B0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGSpots_TypeDefinitionIndex = 36799;
