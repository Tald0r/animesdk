...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAINFOATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ABE2CA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAINFOATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1ABE2CC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAINFOATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABE2C90)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGDataInfoAttribute_TypeDefinitionIndex = 35733;
