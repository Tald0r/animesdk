...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAINFOATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B1F3B70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAINFOATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B1F3B90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAINFOATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F3B60)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGDataInfoAttribute_TypeDefinitionIndex = 36753;
