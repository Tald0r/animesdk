...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1ACC72B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ACC71F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1ACC7300)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA_GETGENERICFINDEX_OFFSET UNITYSDK_OFFSET(0x1ACC7390)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1ACC7370)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1ACC7380)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACC7430)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGData_TypeDefinitionIndex = 35732;
