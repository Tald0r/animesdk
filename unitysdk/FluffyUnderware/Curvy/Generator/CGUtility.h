...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGUTILITY_CALCULATEUV2_1_OFFSET UNITYSDK_OFFSET(0x1AE2C3B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGUTILITY_CALCULATEUV2_OFFSET UNITYSDK_OFFSET(0x1AE2C370)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGUTILITY_GETCONTROLPOINTSWITHOPTIONS_OFFSET UNITYSDK_OFFSET(0x1AE2C4E0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGUtility_TypeDefinitionIndex = 36800;
