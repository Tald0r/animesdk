...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGUTILITY_CALCULATEUV2_1_OFFSET UNITYSDK_OFFSET(0x1A84C750)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGUTILITY_CALCULATEUV2_OFFSET UNITYSDK_OFFSET(0x1A84C710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGUTILITY_GETCONTROLPOINTSWITHOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A84C880)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGUtility_TypeDefinitionIndex = 35780;
