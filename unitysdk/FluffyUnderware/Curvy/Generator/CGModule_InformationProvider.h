...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INFORMATIONPROVIDER_GETINFORMATION_OFFSET UNITYSDK_OFFSET(0x1A4EF700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INFORMATIONPROVIDER_GET_INFORMATION_OFFSET UNITYSDK_OFFSET(0x1A4EAED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_INFORMATIONPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4ED530)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule_InformationProvider_TypeDefinitionIndex = 35755;
