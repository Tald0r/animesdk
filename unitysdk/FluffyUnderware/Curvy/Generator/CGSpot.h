...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x969ED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_EQUALS_OFFSET UNITYSDK_OFFSET(0x969D20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x969EE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x969B20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x3101C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x44C6D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x969AF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AE836B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AE83860)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x3101F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x44C5D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x969B10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_TOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x969CA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x969C30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT__CTOR_OFFSET UNITYSDK_OFFSET(0x969BC0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGSpot_TypeDefinitionIndex = 35777;
