...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x99BED0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_EQUALS_OFFSET UNITYSDK_OFFSET(0x99BD20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x99BEE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x99BB20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x33F200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x394D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x99BAF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B49E710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B49E8C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x33F2F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x3BE200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x99BB10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT_TOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x99BCA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x99BC30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGSPOT__CTOR_OFFSET UNITYSDK_OFFSET(0x99BBC0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGSpot_TypeDefinitionIndex = 36797;
