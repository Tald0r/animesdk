...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCECOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A9A1740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCECOLLECTION_GET_ITEMSARRAY_OFFSET UNITYSDK_OFFSET(0x1A9A1760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A1810)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGGameObjectResourceCollection_TypeDefinitionIndex = 35742;
