...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCECOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AF6D740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCECOLLECTION_GET_ITEMSARRAY_OFFSET UNITYSDK_OFFSET(0x1AF6D760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTRESOURCECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF6D810)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGGameObjectResourceCollection_TypeDefinitionIndex = 36762;
