...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESSYNCHRONIZER_ADDMISSINGCHILDMODULES_OFFSET UNITYSDK_OFFSET(0x1B487C90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESSYNCHRONIZER_CANCELREQUESTS_OFFSET UNITYSDK_OFFSET(0x1B487C70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESSYNCHRONIZER_PROCESSREQUESTS_OFFSET UNITYSDK_OFFSET(0x1B487C80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESSYNCHRONIZER_REQUESTSYNCHRONIZATION_OFFSET UNITYSDK_OFFSET(0x1B487C60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESSYNCHRONIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B487EF0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CurvyGenerator_ModulesSynchronizer_TypeDefinitionIndex = 36810;
