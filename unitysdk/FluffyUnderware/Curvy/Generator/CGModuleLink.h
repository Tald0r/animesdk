...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ARESLOTSCOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1A9A2180)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1A9A2050)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_GET_SLOTNAME_OFFSET UNITYSDK_OFFSET(0x1A9A2060)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_GET_TARGETMODULEID_OFFSET UNITYSDK_OFFSET(0x1A9A2070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_GET_TARGETSLOTNAME_OFFSET UNITYSDK_OFFSET(0x1A9A2080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISBETWEEN_OFFSET UNITYSDK_OFFSET(0x1A9A2530)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISFROM_OFFSET UNITYSDK_OFFSET(0x1A9A2440)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISSAME_1_OFFSET UNITYSDK_OFFSET(0x1A9A2270)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISSAME_OFFSET UNITYSDK_OFFSET(0x1A9A21E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISTO_OFFSET UNITYSDK_OFFSET(0x1A9A23A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISUSING_OFFSET UNITYSDK_OFFSET(0x1A9A24E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A9A27B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_SETMODULEIDIINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A9A27A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A9A27C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9A20B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A2090)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModuleLink_TypeDefinitionIndex = 35764;
