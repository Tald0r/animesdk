...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ARESLOTSCOMPATIBLE_OFFSET UNITYSDK_OFFSET(0x1AF6E190)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_GET_MODULEID_OFFSET UNITYSDK_OFFSET(0x1AF6E060)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_GET_SLOTNAME_OFFSET UNITYSDK_OFFSET(0x1AF6E070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_GET_TARGETMODULEID_OFFSET UNITYSDK_OFFSET(0x1AF6E080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_GET_TARGETSLOTNAME_OFFSET UNITYSDK_OFFSET(0x1AF6E090)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISBETWEEN_OFFSET UNITYSDK_OFFSET(0x1AF6E540)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISFROM_OFFSET UNITYSDK_OFFSET(0x1AF6E450)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISSAME_1_OFFSET UNITYSDK_OFFSET(0x1AF6E280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISSAME_OFFSET UNITYSDK_OFFSET(0x1AF6E1F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISTO_OFFSET UNITYSDK_OFFSET(0x1AF6E3B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_ISUSING_OFFSET UNITYSDK_OFFSET(0x1AF6E4F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AF6E7C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_SETMODULEIDIINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AF6E7B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AF6E7D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AF6E0C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULELINK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF6E0A0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModuleLink_TypeDefinitionIndex = 36784;
