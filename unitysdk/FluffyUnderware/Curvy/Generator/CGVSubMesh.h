...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_ADD_OFFSET UNITYSDK_OFFSET(0x1A364B30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A3648D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A364470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_GET_OFFSET UNITYSDK_OFFSET(0x1A3649B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_GET_TRIANGLESLIST_OFFSET UNITYSDK_OFFSET(0x1A3641A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_GET_TRIANGLES_OFFSET UNITYSDK_OFFSET(0x1A3642B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_SET_TRIANGLESLIST_OFFSET UNITYSDK_OFFSET(0x1A3641B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_SET_TRIANGLES_OFFSET UNITYSDK_OFFSET(0x1A3643E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH_SHIFTINDICES_OFFSET UNITYSDK_OFFSET(0x1A364AE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3645B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A364630)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A364640)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A364770)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVSUBMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A364480)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGVSubMesh_TypeDefinitionIndex = 35782;
