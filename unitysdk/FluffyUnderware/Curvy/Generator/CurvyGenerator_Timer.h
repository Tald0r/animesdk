...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER_GET_NOW_OFFSET UNITYSDK_OFFSET(0x1AE6EA30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER_RESET_OFFSET UNITYSDK_OFFSET(0x1AE6EB20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AE6EA90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER_VALIDATETIMES_OFFSET UNITYSDK_OFFSET(0x1AE6EA50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE6EB30)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CurvyGenerator_Timer_TypeDefinitionIndex = 35791;
