...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER_GET_NOW_OFFSET UNITYSDK_OFFSET(0x1B487F00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER_RESET_OFFSET UNITYSDK_OFFSET(0x1B487FF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B487F60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER_VALIDATETIMES_OFFSET UNITYSDK_OFFSET(0x1B487F20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TIMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B488000)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CurvyGenerator_Timer_TypeDefinitionIndex = 36811;
