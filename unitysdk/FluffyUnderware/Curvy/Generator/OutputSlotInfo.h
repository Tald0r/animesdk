...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_OUTPUTSLOTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19F96530)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_OUTPUTSLOTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x19F96510)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int OutputSlotInfo_TypeDefinitionIndex = 35807;
