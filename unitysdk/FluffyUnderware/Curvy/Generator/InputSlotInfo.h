...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO_ISVALIDFROM_OFFSET UNITYSDK_OFFSET(0x1AE83AD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE83A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AE83A70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AE83AB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE83A20)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int InputSlotInfo_TypeDefinitionIndex = 35805;
	...
	public:
		...
		::System::Boolean RequestDataOnly; // 0x3A
