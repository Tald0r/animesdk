...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO_ISVALIDFROM_OFFSET UNITYSDK_OFFSET(0x1B49EB30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B49EAC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B49EAD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B49EB10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_INPUTSLOTINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1B49EA80)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int InputSlotInfo_TypeDefinitionIndex = 36825;

	class InputSlotInfo : public ::FluffyUnderware::Curvy::Generator::SlotInfo
	{
	public:
		::System::Boolean Optional; // 0x38
