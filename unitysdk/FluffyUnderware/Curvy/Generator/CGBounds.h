...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_COPY_OFFSET UNITYSDK_OFFSET(0x1A76A670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1A76A430)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1A76A4F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_RECALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A76A650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_SET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1A76A4D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A76A590)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A76A5B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A76A580)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGBounds_TypeDefinitionIndex = 35726;
