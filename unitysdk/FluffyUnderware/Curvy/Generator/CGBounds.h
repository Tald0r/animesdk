...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_COPY_OFFSET UNITYSDK_OFFSET(0x1AD08FC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_GET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1AD08D80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_GET_DEPTH_OFFSET UNITYSDK_OFFSET(0x1AD08E40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_RECALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AD08FA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS_SET_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1AD08E20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD08EE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AD08F00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGBOUNDS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD08ED0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGBounds_TypeDefinitionIndex = 36746;
