...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER_GET_ID_OFFSET UNITYSDK_OFFSET(0x1A54C9B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER_GET_STRINGID_OFFSET UNITYSDK_OFFSET(0x1A54CA00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER_RESET_OFFSET UNITYSDK_OFFSET(0x1A54CA60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER_SET_ID_OFFSET UNITYSDK_OFFSET(0x1A54C9D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A54CA50)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule_Identifier_TypeDefinitionIndex = 36774;
