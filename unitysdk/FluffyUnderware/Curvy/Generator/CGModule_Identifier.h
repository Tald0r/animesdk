...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER_GET_ID_OFFSET UNITYSDK_OFFSET(0x19F2E060)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER_GET_STRINGID_OFFSET UNITYSDK_OFFSET(0x19F2E0B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER_RESET_OFFSET UNITYSDK_OFFSET(0x19F2E110)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER_SET_ID_OFFSET UNITYSDK_OFFSET(0x19F2E080)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_IDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F2E100)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule_Identifier_TypeDefinitionIndex = 35754;
