...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_APPLYTRSONSHAPE_OFFSET UNITYSDK_OFFSET(0x19F33CA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x19F33B80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x19F33A20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x19F33AD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x19F33970)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19F341C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_RESET_OFFSET UNITYSDK_OFFSET(0x19F34200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x19F33A40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x19F33AF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_SET_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x19F33990)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F343B0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int TRSModuleBase_TypeDefinitionIndex = 35817;
