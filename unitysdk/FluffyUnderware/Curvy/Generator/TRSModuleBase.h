...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_APPLYTRSONSHAPE_OFFSET UNITYSDK_OFFSET(0x1A5525F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1A5524D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A552370)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x1A552420)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_GET_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1A5522C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A552B10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_RESET_OFFSET UNITYSDK_OFFSET(0x1A552B50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A552390)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x1A552440)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE_SET_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1A5522E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_TRSMODULEBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A552D00)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int TRSModuleBase_TypeDefinitionIndex = 36837;
