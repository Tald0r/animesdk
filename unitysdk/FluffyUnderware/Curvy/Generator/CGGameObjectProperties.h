...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1A361040)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_GET_OBJECT_OFFSET UNITYSDK_OFFSET(0x1A360F90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A360FE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x1A361010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1A360FB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_SET_OBJECT_OFFSET UNITYSDK_OFFSET(0x1A360FA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A361000)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x1A361030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_SET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1A360FD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A361170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A361150)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGGameObjectProperties_TypeDefinitionIndex = 35741;
