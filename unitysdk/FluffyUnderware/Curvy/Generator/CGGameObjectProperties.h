...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1A924A70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_GET_OBJECT_OFFSET UNITYSDK_OFFSET(0x1A9249C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A924A10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x1A924A40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1A9249E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_SET_OBJECT_OFFSET UNITYSDK_OFFSET(0x1A9249D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A924A30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x1A924A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES_SET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1A924A00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A924BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECTPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A924B80)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGGameObjectProperties_TypeDefinitionIndex = 36761;
