...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1ABE2CF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT_RECALCULATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1ABE3220)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ABE2E20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1ABE3020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1ABE2F30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1ABE3130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGGAMEOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABE2E00)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGGameObject_TypeDefinitionIndex = 35740;
	...
	public:
		...
		::UnityEngine::Vector3 Rotate; // 0x54
