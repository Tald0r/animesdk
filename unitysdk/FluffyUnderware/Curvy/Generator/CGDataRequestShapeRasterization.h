...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A84C3D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A84C5A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_GET_PATHF_OFFSET UNITYSDK_OFFSET(0x1A84BE60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_GET_RELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1A84BE40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_SET_PATHF_OFFSET UNITYSDK_OFFSET(0x1A84BF90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_SET_RELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1A84BE50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A84C680)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A84C1F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A84C010)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGDataRequestShapeRasterization_TypeDefinitionIndex = 35739;
