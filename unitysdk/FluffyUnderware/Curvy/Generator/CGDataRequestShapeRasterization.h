...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_EQUALS_OFFSET UNITYSDK_OFFSET(0x1AE2C030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1AE2C200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_GET_PATHF_OFFSET UNITYSDK_OFFSET(0x1AE2BAC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_GET_RELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1AE2BAA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_SET_PATHF_OFFSET UNITYSDK_OFFSET(0x1AE2BBF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_SET_RELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1AE2BAB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AE2C2E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE2BE50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREQUESTSHAPERASTERIZATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE2BC70)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGDataRequestShapeRasterization_TypeDefinitionIndex = 36759;
