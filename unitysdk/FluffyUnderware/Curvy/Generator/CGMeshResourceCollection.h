...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCECOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AA4E3A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCECOLLECTION_GET_ITEMSARRAY_OFFSET UNITYSDK_OFFSET(0x1AA4E3C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA4E470)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGMeshResourceCollection_TypeDefinitionIndex = 35749;
