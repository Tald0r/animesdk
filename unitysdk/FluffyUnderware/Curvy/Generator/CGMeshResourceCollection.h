...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCECOLLECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B062430)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCECOLLECTION_GET_ITEMSARRAY_OFFSET UNITYSDK_OFFSET(0x1B062450)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHRESOURCECOLLECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B062500)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGMeshResourceCollection_TypeDefinitionIndex = 36769;
