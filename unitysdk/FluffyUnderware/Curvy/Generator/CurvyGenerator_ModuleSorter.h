...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER_ENSUREISSORTED_OFFSET UNITYSDK_OFFSET(0x1B062600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER_ENSURELINKEDSLOTSBUILD_OFFSET UNITYSDK_OFFSET(0x1B0637B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER_GET_SORTINGNEEDED_OFFSET UNITYSDK_OFFSET(0x1B062580)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER_HASCIRCULARREFERENCE_OFFSET UNITYSDK_OFFSET(0x1B0625A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER_SET_SORTINGNEEDED_OFFSET UNITYSDK_OFFSET(0x1B062590)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER_SORT_OFFSET UNITYSDK_OFFSET(0x1B062620)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_MODULESORTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B063AF0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CurvyGenerator_ModuleSorter_TypeDefinitionIndex = 36808;
