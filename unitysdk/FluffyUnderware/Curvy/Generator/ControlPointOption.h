...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x96A710)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x96A6E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96A790)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AEDEEC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AEDEEF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x96A670)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int ControlPointOption_TypeDefinitionIndex = 35786;
