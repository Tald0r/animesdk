...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x99D100)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_EQUALS_OFFSET UNITYSDK_OFFSET(0x99D0D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x99D180)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B506C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B506C80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CONTROLPOINTOPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x99D060)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int ControlPointOption_TypeDefinitionIndex = 36806;
