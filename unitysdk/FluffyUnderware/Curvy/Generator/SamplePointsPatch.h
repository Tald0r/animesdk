...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x941C80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_EQUALS_OFFSET UNITYSDK_OFFSET(0x317C60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8B6960)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_GET_END_OFFSET UNITYSDK_OFFSET(0x906A00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x941C60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A7F0A80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A7F0A90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_SET_END_OFFSET UNITYSDK_OFFSET(0x941C50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH_TOSTRING_OFFSET UNITYSDK_OFFSET(0x941C70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSPATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x2D2380)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SamplePointsPatch_TypeDefinitionIndex = 35812;
