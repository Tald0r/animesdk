...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESOURCENAMER_CLEARCACHE_OFFSET UNITYSDK_OFFSET(0x1A312210)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESOURCENAMER_GETRESOURCENAME_OFFSET UNITYSDK_OFFSET(0x1A312280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESOURCENAMER_RENAME_OFFSET UNITYSDK_OFFSET(0x1A312900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESOURCENAMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A312170)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule_ResourceNamer_TypeDefinitionIndex = 35756;
