...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESOURCENAMER_CLEARCACHE_OFFSET UNITYSDK_OFFSET(0x1A8C8600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESOURCENAMER_GETRESOURCENAME_OFFSET UNITYSDK_OFFSET(0x1A8C8670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESOURCENAMER_RENAME_OFFSET UNITYSDK_OFFSET(0x1A8C8CE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMODULE_RESOURCENAMER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8C8560)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGModule_ResourceNamer_TypeDefinitionIndex = 36776;
