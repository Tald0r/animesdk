...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES_GET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A4EAA50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES_GET_MATRIX_OFFSET UNITYSDK_OFFSET(0x1A4EAB00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES_GET_MESH_OFFSET UNITYSDK_OFFSET(0x1A4EA920)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A4EAAA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES_GET_SCALE_OFFSET UNITYSDK_OFFSET(0x1A4EAAD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1A4EAA70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A4EAD10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES_SET_MATERIAL_OFFSET UNITYSDK_OFFSET(0x1A4EAA60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES_SET_MESH_OFFSET UNITYSDK_OFFSET(0x1A4EA930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x1A4EAAC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES_SET_SCALE_OFFSET UNITYSDK_OFFSET(0x1A4EAAF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES_SET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1A4EAA90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A4EAC50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGMESHPROPERTIES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4EAC10)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGMeshProperties_TypeDefinitionIndex = 35747;
