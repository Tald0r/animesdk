...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_CLONE_OFFSET UNITYSDK_OFFSET(0x1AE85C20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GETLENGTHS_OFFSET UNITYSDK_OFFSET(0x1AE85A00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_ENDVERTEX_OFFSET UNITYSDK_OFFSET(0x1AE85900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_STARTVERTEX_OFFSET UNITYSDK_OFFSET(0x1AE858D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x1AE85740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1AE85940)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AE859F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE85980)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SamplePointsMaterialGroup_TypeDefinitionIndex = 35810;
