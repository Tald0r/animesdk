...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_CLONE_OFFSET UNITYSDK_OFFSET(0x1B4A0C80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GETLENGTHS_OFFSET UNITYSDK_OFFSET(0x1B4A0A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_ENDVERTEX_OFFSET UNITYSDK_OFFSET(0x1B4A0960)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_STARTVERTEX_OFFSET UNITYSDK_OFFSET(0x1B4A0930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_TRIANGLECOUNT_OFFSET UNITYSDK_OFFSET(0x1B4A07A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1B4A09A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4A0A50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_SAMPLEPOINTSMATERIALGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4A09E0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int SamplePointsMaterialGroup_TypeDefinitionIndex = 36830;
