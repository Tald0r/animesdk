...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_COPY_OFFSET UNITYSDK_OFFSET(0x1AEDE410)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AEDE330)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_GET_DIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1AEDDDD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1AEDDEF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_INTERPOLATEDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AEDE9E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_INTERPOLATE_1_OFFSET UNITYSDK_OFFSET(0x1AEDE840)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_INTERPOLATE_OFFSET UNITYSDK_OFFSET(0x1AEDE550)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_SET_DIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1AEDDDE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1AEDE020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AEDE1D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEDE0B0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGPath_TypeDefinitionIndex = 35770;
