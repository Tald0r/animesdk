...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_COPY_OFFSET UNITYSDK_OFFSET(0x1B5061A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B5060C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_GET_DIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1B505B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1B505C80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_INTERPOLATEDIRECTION_OFFSET UNITYSDK_OFFSET(0x1B506770)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_INTERPOLATE_1_OFFSET UNITYSDK_OFFSET(0x1B5065D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_INTERPOLATE_OFFSET UNITYSDK_OFFSET(0x1B5062E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_SET_DIRECTIONS_OFFSET UNITYSDK_OFFSET(0x1B505B70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1B505DB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B505F60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B505E40)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGPath_TypeDefinitionIndex = 36790;
