...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_CALCSEGMENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1AD12B90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_CROSSDISTANCETOF_OFFSET UNITYSDK_OFFSET(0x1AD12CE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_CROSSFTODISTANCE_OFFSET UNITYSDK_OFFSET(0x1AD12CA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD112C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETCROSSFINDEX_OFFSET UNITYSDK_OFFSET(0x1AD12D30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETCROSSLENGTH_OFFSET UNITYSDK_OFFSET(0x1AD12830)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0x1AD12D20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETSEGMENTINDICES_OFFSET UNITYSDK_OFFSET(0x1AD12AB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETSEGMENTVERTICES_OFFSET UNITYSDK_OFFSET(0x1AD12E50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETVERTEXINDEX_1_OFFSET UNITYSDK_OFFSET(0x1AD11F60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETVERTEXINDEX_OFFSET UNITYSDK_OFFSET(0x1AD12DC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSCUSTOMVALUES_OFFSET UNITYSDK_OFFSET(0x1AD0F9E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSF_OFFSET UNITYSDK_OFFSET(0x1AD0FFA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSMAP_OFFSET UNITYSDK_OFFSET(0x1AD10160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSRELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1AD0F8C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSSIZE_OFFSET UNITYSDK_OFFSET(0x1AD0AB20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_OFFSET UNITYSDK_OFFSET(0x1AD11700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_SCALES_OFFSET UNITYSDK_OFFSET(0x1AD0FB00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_SEGMENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1AD10320)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1AD10370)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTEXNORMALS_OFFSET UNITYSDK_OFFSET(0x1AD0F7A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTEXNORMAL_OFFSET UNITYSDK_OFFSET(0x1AD0FDE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTEX_OFFSET UNITYSDK_OFFSET(0x1AD0FC20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1AD0F680)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_INTERPOLATEVOLUMEDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AD12320)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_INTERPOLATEVOLUMEPOSITION_OFFSET UNITYSDK_OFFSET(0x1AD12070)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_INTERPOLATEVOLUMEUP_OFFSET UNITYSDK_OFFSET(0x1AD125A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_INTERPOLATEVOLUME_OFFSET UNITYSDK_OFFSET(0x1AD11B80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_CROSSCUSTOMVALUES_OFFSET UNITYSDK_OFFSET(0x1AD0F9F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_CROSSF_OFFSET UNITYSDK_OFFSET(0x1AD100D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_CROSSMAP_OFFSET UNITYSDK_OFFSET(0x1AD10290)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_CROSSRELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1AD0F8D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_SCALES_OFFSET UNITYSDK_OFFSET(0x1AD0FB10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_SEGMENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1AD10360)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_VERTEXNORMALS_OFFSET UNITYSDK_OFFSET(0x1AD0F7B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_VERTEXNORMAL_OFFSET UNITYSDK_OFFSET(0x1AD0FF10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_VERTEX_OFFSET UNITYSDK_OFFSET(0x1AD0FD50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1AD0F690)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD10390)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AD10870)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AD10D50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD10380)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGVolume_TypeDefinitionIndex = 36803;

	class CGVolume : public ::FluffyUnderware::Curvy::Generator::CGPath
	{
	public:
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector3> vertexNormals; // 0xA8
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector2> scales; // 0xB8
		::ToolBuddy::Pooling::Collections::SubArray_1<::System::Single> crossCustomValues; // 0xC8
		::Il2CppArray<::System::Single>* _segmentLength; // 0xD8
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector3> vertices; // 0xE0
		::FluffyUnderware::Curvy::Generator::SamplePointsMaterialGroupCollection* CrossMaterialGroups; // 0xF0
		::ToolBuddy::Pooling::Collections::SubArray_1<::System::Single> crossRelativeDistances; // 0xF8
		::System::Boolean CrossClosed; // 0x108
		::System::Boolean CrossSeamless; // 0x109
