...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_CALCSEGMENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1A774280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_CROSSDISTANCETOF_OFFSET UNITYSDK_OFFSET(0x1A7743D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_CROSSFTODISTANCE_OFFSET UNITYSDK_OFFSET(0x1A774390)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7729B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETCROSSFINDEX_OFFSET UNITYSDK_OFFSET(0x1A774420)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETCROSSLENGTH_OFFSET UNITYSDK_OFFSET(0x1A773F20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETSEGMENTINDEX_OFFSET UNITYSDK_OFFSET(0x1A774410)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETSEGMENTINDICES_OFFSET UNITYSDK_OFFSET(0x1A7741A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETSEGMENTVERTICES_OFFSET UNITYSDK_OFFSET(0x1A774540)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETVERTEXINDEX_1_OFFSET UNITYSDK_OFFSET(0x1A773650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GETVERTEXINDEX_OFFSET UNITYSDK_OFFSET(0x1A7744B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSCUSTOMVALUES_OFFSET UNITYSDK_OFFSET(0x1A7710D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSF_OFFSET UNITYSDK_OFFSET(0x1A771690)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSMAP_OFFSET UNITYSDK_OFFSET(0x1A771850)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSRELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1A770FB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_CROSSSIZE_OFFSET UNITYSDK_OFFSET(0x1A76C1B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_OFFSET UNITYSDK_OFFSET(0x1A772DF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_SCALES_OFFSET UNITYSDK_OFFSET(0x1A7711F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_SEGMENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1A771A10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTEXCOUNT_OFFSET UNITYSDK_OFFSET(0x1A771A60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTEXNORMALS_OFFSET UNITYSDK_OFFSET(0x1A770E90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTEXNORMAL_OFFSET UNITYSDK_OFFSET(0x1A7714D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTEX_OFFSET UNITYSDK_OFFSET(0x1A771310)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_GET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1A770D70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_INTERPOLATEVOLUMEDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A773A10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_INTERPOLATEVOLUMEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A773760)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_INTERPOLATEVOLUMEUP_OFFSET UNITYSDK_OFFSET(0x1A773C90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_INTERPOLATEVOLUME_OFFSET UNITYSDK_OFFSET(0x1A773270)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_CROSSCUSTOMVALUES_OFFSET UNITYSDK_OFFSET(0x1A7710E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_CROSSF_OFFSET UNITYSDK_OFFSET(0x1A7717C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_CROSSMAP_OFFSET UNITYSDK_OFFSET(0x1A771980)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_CROSSRELATIVEDISTANCES_OFFSET UNITYSDK_OFFSET(0x1A770FC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_SCALES_OFFSET UNITYSDK_OFFSET(0x1A771200)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_SEGMENTLENGTH_OFFSET UNITYSDK_OFFSET(0x1A771A50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_VERTEXNORMALS_OFFSET UNITYSDK_OFFSET(0x1A770EA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_VERTEXNORMAL_OFFSET UNITYSDK_OFFSET(0x1A771600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_VERTEX_OFFSET UNITYSDK_OFFSET(0x1A771440)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME_SET_VERTICES_OFFSET UNITYSDK_OFFSET(0x1A770D80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A771A80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A771F60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A772440)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGVOLUME__CTOR_OFFSET UNITYSDK_OFFSET(0x1A771A70)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGVolume_TypeDefinitionIndex = 35783;
	...
	public:
		...
		::ToolBuddy::Pooling::Collections::SubArray_1<::System::Single> crossRelativeDistances; // 0xC0
		::ToolBuddy::Pooling::Collections::SubArray_1<::UnityEngine::Vector2> scales; // 0xD0
