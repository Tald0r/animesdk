...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ADDMODULE_1_OFFSET UNITYSDK_OFFSET(0x1A7EB300)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ADDMODULE_OFFSET UNITYSDK_OFFSET(0x1A7EB1E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ARRANGEMODULES_OFFSET UNITYSDK_OFFSET(0x1A7EB9B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A7ECC00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_CORRECTDUPLICATEMODULEIDS_OFFSET UNITYSDK_OFFSET(0x1A7ED520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_CREATE_OFFSET UNITYSDK_OFFSET(0x1A7EAFF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_DELETEALLOUTPUTMANAGEDRESOURCESFROMASSOCIATEDPREFAB_OFFSET UNITYSDK_OFFSET(0x1A7EECC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1A7EE520)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_DELETELINK_OFFSET UNITYSDK_OFFSET(0x1A7ECE00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_DELETEMODULE_OFFSET UNITYSDK_OFFSET(0x1A7ECD70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULEOUTPUTSLOT_1_OFFSET UNITYSDK_OFFSET(0x1A7ED370)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULEOUTPUTSLOT_OFFSET UNITYSDK_OFFSET(0x1A7ED2E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULES_1_OFFSET UNITYSDK_OFFSET(0x1A7ED180)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULES_OFFSET UNITYSDK_OFFSET(0x1A7ED170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULEUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1A7EB6B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULEUNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1A7EB7E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULE_1_OFFSET UNITYSDK_OFFSET(0x1A7ED030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULE_2_OFFSET UNITYSDK_OFFSET(0x1A7ED2D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULE_3_OFFSET UNITYSDK_OFFSET(0x1A7EA280)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULE_OFFSET UNITYSDK_OFFSET(0x1A7ED2B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETUNIQUEMODULENAMEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A7EE740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_AUTOREFRESH_OFFSET UNITYSDK_OFFSET(0x1A7EA610)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_DESTROYING_OFFSET UNITYSDK_OFFSET(0x1A7EA7B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_HASMODULESWITHSAMEID_OFFSET UNITYSDK_OFFSET(0x1A7EEB00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A7EA7A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_MODULESBYID_OFFSET UNITYSDK_OFFSET(0x1A7EA7D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_M_LASTMODULEID_OFFSET UNITYSDK_OFFSET(0x1A7EA490)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1A7EA780)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_POOLMANAGER_OFFSET UNITYSDK_OFFSET(0x1A7EA670)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_REFRESHDELAYEDITOR_OFFSET UNITYSDK_OFFSET(0x1A7EA650)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_REFRESHDELAY_OFFSET UNITYSDK_OFFSET(0x1A7EA630)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_SHOWDEBUG_OFFSET UNITYSDK_OFFSET(0x1A7EA470)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_HASCIRCULARREFERENCE_OFFSET UNITYSDK_OFFSET(0x1A7EEAA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A7EAC60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ISMODULENAMEUNIQUE_OFFSET UNITYSDK_OFFSET(0x1A7EE660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A7EAB60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A7EAB50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A7EAA10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ONREFRESHEVENT_OFFSET UNITYSDK_OFFSET(0x1A7EE4C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A7EE1B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_REMOVEMODULE_OFFSET UNITYSDK_OFFSET(0x1A7EB930)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_REORDERENDPOINTRECURSIVEINPUTS_OFFSET UNITYSDK_OFFSET(0x1A7EC740)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_REORDERMODULES_OFFSET UNITYSDK_OFFSET(0x1A7EBC20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_RESETALLMODULELINKS_OFFSET UNITYSDK_OFFSET(0x1A7EE0B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1A7EE700)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SAVEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1A7EECD0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SETMODULESFROMCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A7ED400)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_AUTOREFRESH_OFFSET UNITYSDK_OFFSET(0x1A7EA620)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_DESTROYING_OFFSET UNITYSDK_OFFSET(0x1A7EA7C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_MODULESBYID_OFFSET UNITYSDK_OFFSET(0x1A7EA9C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_M_LASTMODULEID_OFFSET UNITYSDK_OFFSET(0x1A7EA5C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1A7EA790)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_REFRESHDELAYEDITOR_OFFSET UNITYSDK_OFFSET(0x1A7EA660)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_REFRESHDELAY_OFFSET UNITYSDK_OFFSET(0x1A7EA640)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_SHOWDEBUG_OFFSET UNITYSDK_OFFSET(0x1A7EA480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SORTMODULESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A7EEA80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TRYAUTOREFRESH_OFFSET UNITYSDK_OFFSET(0x1A7EAF20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_UPDATEMODULESRECURSIVEINPUTS_OFFSET UNITYSDK_OFFSET(0x1A7EC3D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A7EAB70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7EF040)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR__SETMODULESFROMCHILDREN_B__89_0_OFFSET UNITYSDK_OFFSET(0x1A7EF1C0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CurvyGenerator_TypeDefinitionIndex = 35787;
