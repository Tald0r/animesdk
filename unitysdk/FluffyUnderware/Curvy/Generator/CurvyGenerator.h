...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ADDMODULE_1_OFFSET UNITYSDK_OFFSET(0x1ADE1CE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ADDMODULE_OFFSET UNITYSDK_OFFSET(0x1ADE1BC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ARRANGEMODULES_OFFSET UNITYSDK_OFFSET(0x1ADE2390)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_CLEAR_OFFSET UNITYSDK_OFFSET(0x1ADE35E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_CORRECTDUPLICATEMODULEIDS_OFFSET UNITYSDK_OFFSET(0x1ADE3F00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_CREATE_OFFSET UNITYSDK_OFFSET(0x1ADE19D0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_DELETEALLOUTPUTMANAGEDRESOURCESFROMASSOCIATEDPREFAB_OFFSET UNITYSDK_OFFSET(0x1ADE56A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_DELETEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1ADE4F00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_DELETELINK_OFFSET UNITYSDK_OFFSET(0x1ADE37E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_DELETEMODULE_OFFSET UNITYSDK_OFFSET(0x1ADE3750)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULEOUTPUTSLOT_1_OFFSET UNITYSDK_OFFSET(0x1ADE3D50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULEOUTPUTSLOT_OFFSET UNITYSDK_OFFSET(0x1ADE3CC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULES_1_OFFSET UNITYSDK_OFFSET(0x1ADE3B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULES_OFFSET UNITYSDK_OFFSET(0x1ADE3B50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULEUNIQUEID_OFFSET UNITYSDK_OFFSET(0x1ADE2090)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULEUNIQUENAME_OFFSET UNITYSDK_OFFSET(0x1ADE21C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULE_1_OFFSET UNITYSDK_OFFSET(0x1ADE3A10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULE_2_OFFSET UNITYSDK_OFFSET(0x1ADE3CB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULE_3_OFFSET UNITYSDK_OFFSET(0x1ADE0C60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETMODULE_OFFSET UNITYSDK_OFFSET(0x1ADE3C90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GETUNIQUEMODULENAMEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1ADE5130)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_AUTOREFRESH_OFFSET UNITYSDK_OFFSET(0x1ADE0FF0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_DESTROYING_OFFSET UNITYSDK_OFFSET(0x1ADE1190)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_HASMODULESWITHSAMEID_OFFSET UNITYSDK_OFFSET(0x1ADE54E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1ADE1180)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_MODULESBYID_OFFSET UNITYSDK_OFFSET(0x1ADE11B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_M_LASTMODULEID_OFFSET UNITYSDK_OFFSET(0x1ADE0E70)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1ADE1160)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_POOLMANAGER_OFFSET UNITYSDK_OFFSET(0x1ADE1050)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_REFRESHDELAYEDITOR_OFFSET UNITYSDK_OFFSET(0x1ADE1030)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_REFRESHDELAY_OFFSET UNITYSDK_OFFSET(0x1ADE1010)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_GET_SHOWDEBUG_OFFSET UNITYSDK_OFFSET(0x1ADE0E50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_HASCIRCULARREFERENCE_OFFSET UNITYSDK_OFFSET(0x1ADE5480)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1ADE1640)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ISMODULENAMEUNIQUE_OFFSET UNITYSDK_OFFSET(0x1ADE5040)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ADE1540)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1ADE1530)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ADE13F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_ONREFRESHEVENT_OFFSET UNITYSDK_OFFSET(0x1ADE4EA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_REFRESH_OFFSET UNITYSDK_OFFSET(0x1ADE4B90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_REMOVEMODULE_OFFSET UNITYSDK_OFFSET(0x1ADE2310)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_REORDERENDPOINTRECURSIVEINPUTS_OFFSET UNITYSDK_OFFSET(0x1ADE3120)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_REORDERMODULES_OFFSET UNITYSDK_OFFSET(0x1ADE2600)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_RESETALLMODULELINKS_OFFSET UNITYSDK_OFFSET(0x1ADE4A90)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1ADE50F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SAVEALLOUTPUTMANAGEDRESOURCES_OFFSET UNITYSDK_OFFSET(0x1ADE56B0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SETMODULESFROMCHILDREN_OFFSET UNITYSDK_OFFSET(0x1ADE3DE0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_AUTOREFRESH_OFFSET UNITYSDK_OFFSET(0x1ADE1000)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_DESTROYING_OFFSET UNITYSDK_OFFSET(0x1ADE11A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_MODULESBYID_OFFSET UNITYSDK_OFFSET(0x1ADE13A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_M_LASTMODULEID_OFFSET UNITYSDK_OFFSET(0x1ADE0FA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_ONREFRESH_OFFSET UNITYSDK_OFFSET(0x1ADE1170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_REFRESHDELAYEDITOR_OFFSET UNITYSDK_OFFSET(0x1ADE1040)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_REFRESHDELAY_OFFSET UNITYSDK_OFFSET(0x1ADE1020)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SET_SHOWDEBUG_OFFSET UNITYSDK_OFFSET(0x1ADE0E60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_SORTMODULESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1ADE5460)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_TRYAUTOREFRESH_OFFSET UNITYSDK_OFFSET(0x1ADE1900)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_UPDATEMODULESRECURSIVEINPUTS_OFFSET UNITYSDK_OFFSET(0x1ADE2DB0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ADE1550)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE5A20)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CURVYGENERATOR__SETMODULESFROMCHILDREN_B__89_0_OFFSET UNITYSDK_OFFSET(0x1ADE5BA0)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CurvyGenerator_TypeDefinitionIndex = 36807;
