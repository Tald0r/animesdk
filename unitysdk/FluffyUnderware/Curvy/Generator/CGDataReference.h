...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A7EA260)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1A7E9E10)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x1A7EA120)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1A7EA150)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_GET_MODULE_OFFSET UNITYSDK_OFFSET(0x1A7EA170)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_GET_SLOTNAME_OFFSET UNITYSDK_OFFSET(0x1A7EA180)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_GET_SLOT_OFFSET UNITYSDK_OFFSET(0x1A7E9E80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_SETINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x1A7EA220)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_SETINTERNAL_OFFSET UNITYSDK_OFFSET(0x1A7EA1C0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A7EA1A0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A7EA1E0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7EA190)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGDataReference_TypeDefinitionIndex = 35734;
