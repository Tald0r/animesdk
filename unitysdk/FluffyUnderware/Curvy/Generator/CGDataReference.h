...
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1ADE0C40)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_GET_DATA_OFFSET UNITYSDK_OFFSET(0x1ADE07F0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_GET_HASVALUE_OFFSET UNITYSDK_OFFSET(0x1ADE0B00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1ADE0B30)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_GET_MODULE_OFFSET UNITYSDK_OFFSET(0x1ADE0B50)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_GET_SLOTNAME_OFFSET UNITYSDK_OFFSET(0x1ADE0B60)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_GET_SLOT_OFFSET UNITYSDK_OFFSET(0x1ADE0860)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_SETINTERNAL_1_OFFSET UNITYSDK_OFFSET(0x1ADE0C00)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE_SETINTERNAL_OFFSET UNITYSDK_OFFSET(0x1ADE0BA0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1ADE0B80)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1ADE0BC0)
#define FLUFFYUNDERWARE_CURVY_GENERATOR_CGDATAREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADE0B70)

namespace FluffyUnderware::Curvy::Generator
{
	inline static constexpr unsigned int CGDataReference_TypeDefinitionIndex = 36754;
