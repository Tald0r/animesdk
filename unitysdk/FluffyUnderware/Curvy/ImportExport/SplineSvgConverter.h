...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_DRAWNODE_OFFSET UNITYSDK_OFFSET(0x1B2DFCB0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_SVGTOSERIALIZEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1B2DF7D0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_SVGTOSPLINES_OFFSET UNITYSDK_OFFSET(0x1B2DF680)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_SVGTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1B2DFC60)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SplineSvgConverter_TypeDefinitionIndex = 36722;
