...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_DRAWNODE_OFFSET UNITYSDK_OFFSET(0x1ACC7B30)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_SVGTOSERIALIZEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1ACC7650)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_SVGTOSPLINES_OFFSET UNITYSDK_OFFSET(0x1ACC7500)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINESVGCONVERTER_SVGTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1ACC7AE0)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SplineSvgConverter_TypeDefinitionIndex = 35702;
