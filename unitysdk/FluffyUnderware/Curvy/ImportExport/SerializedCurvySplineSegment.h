...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINESEGMENT_WRITEINTOCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x19F347F0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINESEGMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19F344A0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINESEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19F34420)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SerializedCurvySplineSegment_TypeDefinitionIndex = 35699;
