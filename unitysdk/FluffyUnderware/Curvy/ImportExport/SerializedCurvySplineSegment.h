...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINESEGMENT_WRITEINTOCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1A553140)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINESEGMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A552DF0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINESEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A552D70)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SerializedCurvySplineSegment_TypeDefinitionIndex = 36719;
