...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_JSONTOSERIALIZEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1B1F5BB0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_JSONTOSPLINES_OFFSET UNITYSDK_OFFSET(0x1B1F5A40)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_JSONTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1B1F6000)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_SPLINESTOJSON_OFFSET UNITYSDK_OFFSET(0x1B1F5890)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_SPLINETOJSON_OFFSET UNITYSDK_OFFSET(0x1B1F5970)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SplineJsonConverter_TypeDefinitionIndex = 36720;
