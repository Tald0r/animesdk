...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_JSONTOSERIALIZEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1ABE4CF0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_JSONTOSPLINES_OFFSET UNITYSDK_OFFSET(0x1ABE4B80)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_JSONTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1ABE5140)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_SPLINESTOJSON_OFFSET UNITYSDK_OFFSET(0x1ABE49D0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SPLINEJSONCONVERTER_SPLINETOJSON_OFFSET UNITYSDK_OFFSET(0x1ABE4AB0)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SplineJsonConverter_TypeDefinitionIndex = 35700;
