...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINE_WRITEINTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1AF75D70)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AF75800)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF75760)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SerializedCurvySpline_TypeDefinitionIndex = 36718;
