...
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINE_WRITEINTOSPLINE_OFFSET UNITYSDK_OFFSET(0x1A9A9D60)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9A97F0)
#define FLUFFYUNDERWARE_CURVY_IMPORTEXPORT_SERIALIZEDCURVYSPLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9A9750)

namespace FluffyUnderware::Curvy::ImportExport
{
	inline static constexpr unsigned int SerializedCurvySpline_TypeDefinitionIndex = 35698;
