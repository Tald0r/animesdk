...
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ADD_OFFSET UNITYSDK_OFFSET(0x1A99FBB0)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_GETSLOT_OFFSET UNITYSDK_OFFSET(0x1A99F9B0)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A99F5E0)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ONPOSTRENDER_OFFSET UNITYSDK_OFFSET(0x1A99F620)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ONSPLINEREFRESH_OFFSET UNITYSDK_OFFSET(0x1A99F7D0)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A99F420)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A99FD60)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_SANITIZE_OFFSET UNITYSDK_OFFSET(0x1A99F430)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A99FF80)

namespace FluffyUnderware::Curvy::Components
{
	inline static constexpr unsigned int CurvyGLRenderer_TypeDefinitionIndex = 35685;
