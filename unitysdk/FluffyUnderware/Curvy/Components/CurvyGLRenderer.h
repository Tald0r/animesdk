...
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ADD_OFFSET UNITYSDK_OFFSET(0x1AF6BBB0)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_GETSLOT_OFFSET UNITYSDK_OFFSET(0x1AF6B9B0)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AF6B5E0)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ONPOSTRENDER_OFFSET UNITYSDK_OFFSET(0x1AF6B620)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ONSPLINEREFRESH_OFFSET UNITYSDK_OFFSET(0x1AF6B7D0)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AF6B420)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_REMOVE_OFFSET UNITYSDK_OFFSET(0x1AF6BD60)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER_SANITIZE_OFFSET UNITYSDK_OFFSET(0x1AF6B430)
#define FLUFFYUNDERWARE_CURVY_COMPONENTS_CURVYGLRENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF6BF80)

namespace FluffyUnderware::Curvy::Components
{
	inline static constexpr unsigned int CurvyGLRenderer_TypeDefinitionIndex = 36705;
