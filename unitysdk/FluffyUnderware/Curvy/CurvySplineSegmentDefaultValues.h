...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENTDEFAULTVALUES__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B14C190)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineSegmentDefaultValues_TypeDefinitionIndex = 35670;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(CurvySplineSegmentDefaultValues_TypeDefinitionIndex)->GetStaticField(0x8A80);
		}
		static ::UnityEngine::Vector3* StaticGet_HandleIn()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(CurvySplineSegmentDefaultValues_TypeDefinitionIndex)->GetStaticField(0x8A8C);
		}
