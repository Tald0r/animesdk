...
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1AEE0B90)
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AEE0B50)
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT_PROCESS_OFFSET UNITYSDK_OFFSET(0x1AEE0860)
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AEE0B40)
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEE0BA0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int NearestSplinePoint_TypeDefinitionIndex = 35633;
