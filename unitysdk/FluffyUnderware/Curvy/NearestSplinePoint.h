...
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1B508920)
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B5088E0)
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT_PROCESS_OFFSET UNITYSDK_OFFSET(0x1B5085F0)
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B5088D0)
#define FLUFFYUNDERWARE_CURVY_NEARESTSPLINEPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B508930)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int NearestSplinePoint_TypeDefinitionIndex = 36653;
