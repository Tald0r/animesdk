...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_SEGMENTGROUPMETRICS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x95FB20)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_SEGMENTGROUPMETRICS_EQUALS_OFFSET UNITYSDK_OFFSET(0x95FAD0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_SEGMENTGROUPMETRICS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x95FBB0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_SEGMENTGROUPMETRICS_INCREMENT_OFFSET UNITYSDK_OFFSET(0x95FA80)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_SEGMENTGROUPMETRICS_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1ACC7150)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_SEGMENTGROUPMETRICS_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1ACC71A0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_SegmentGroupMetrics_TypeDefinitionIndex = 35658;
