...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_SANITYCHECKER_CHECK_OFFSET UNITYSDK_OFFSET(0x1A7E8F70)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_SANITYCHECKER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A7E8F60)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINE_SANITYCHECKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7E8F50)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySpline_SanityChecker_TypeDefinitionIndex = 35657;
