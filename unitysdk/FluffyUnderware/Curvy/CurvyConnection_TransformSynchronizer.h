...
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_APPLYTRANSFORMTOCONNECTION_OFFSET UNITYSDK_OFFSET(0x1ABE23B0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_APPLYTRANSFORMTOCPS_OFFSET UNITYSDK_OFFSET(0x1ABE2420)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_APPLYTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1ABE0850)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_ENSURECPSMONITORISVALID_OFFSET UNITYSDK_OFFSET(0x1ABE1570)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_GETCONNECTIONMONITORCHANGES_OFFSET UNITYSDK_OFFSET(0x1ABE1700)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_GETCPMONITORCHANGES_OFFSET UNITYSDK_OFFSET(0x1ABE1FC0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_GETCPSMONITORCHANGES_OFFSET UNITYSDK_OFFSET(0x1ABE19B0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_GETMONITORCHANGES_OFFSET UNITYSDK_OFFSET(0x1ABE15A0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_GET_CONNECTIONMONITOR_OFFSET UNITYSDK_OFFSET(0x1ABE0E60)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_GET_ISCPSMONITORVALID_OFFSET UNITYSDK_OFFSET(0x1ABE15E0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_ISCPTRIGGERINGTRANSFORMCHANGE_OFFSET UNITYSDK_OFFSET(0x1ABE2110)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_ONCONTROLPOINTSUPDATED_OFFSET UNITYSDK_OFFSET(0x1ABDF9C0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABE0A50)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_RESETCONNECTIONMONITORING_OFFSET UNITYSDK_OFFSET(0x1ABE2970)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_RESETCPSMONITORING_OFFSET UNITYSDK_OFFSET(0x1ABE10F0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_RESETMONITORING_OFFSET UNITYSDK_OFFSET(0x1ABDF640)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABDF370)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER__GET_ISCPSMONITORVALID_B__10_0_OFFSET UNITYSDK_OFFSET(0x1ABE2BA0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyConnection_TransformSynchronizer_TypeDefinitionIndex = 35642;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::FluffyUnderware::Curvy::CurvySplineSegment*, ::System::ValueTuple_2<::UnityEngine::Vector3, ::UnityEngine::Quaternion>>* monitoredCPCoordinated; // 0x20
