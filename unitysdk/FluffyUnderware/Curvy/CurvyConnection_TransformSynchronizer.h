...
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_APPLYTRANSFORMTOCONNECTION_OFFSET UNITYSDK_OFFSET(0x1B1F3280)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_APPLYTRANSFORMTOCPS_OFFSET UNITYSDK_OFFSET(0x1B1F32F0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_APPLYTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B1F1720)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_ENSURECPSMONITORISVALID_OFFSET UNITYSDK_OFFSET(0x1B1F2440)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_GETCONNECTIONMONITORCHANGES_OFFSET UNITYSDK_OFFSET(0x1B1F25D0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_GETCPMONITORCHANGES_OFFSET UNITYSDK_OFFSET(0x1B1F2E90)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_GETCPSMONITORCHANGES_OFFSET UNITYSDK_OFFSET(0x1B1F2880)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_GETMONITORCHANGES_OFFSET UNITYSDK_OFFSET(0x1B1F2470)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_GET_CONNECTIONMONITOR_OFFSET UNITYSDK_OFFSET(0x1B1F1D30)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_GET_ISCPSMONITORVALID_OFFSET UNITYSDK_OFFSET(0x1B1F24B0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_ISCPTRIGGERINGTRANSFORMCHANGE_OFFSET UNITYSDK_OFFSET(0x1B1F2FE0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_ONCONTROLPOINTSUPDATED_OFFSET UNITYSDK_OFFSET(0x1B1F0890)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_ONUPDATE_OFFSET UNITYSDK_OFFSET(0x1B1F1920)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_RESETCONNECTIONMONITORING_OFFSET UNITYSDK_OFFSET(0x1B1F3840)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_RESETCPSMONITORING_OFFSET UNITYSDK_OFFSET(0x1B1F1FC0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER_RESETMONITORING_OFFSET UNITYSDK_OFFSET(0x1B1F0510)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F0230)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_TRANSFORMSYNCHRONIZER__GET_ISCPSMONITORVALID_B__10_0_OFFSET UNITYSDK_OFFSET(0x1B1F3A70)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyConnection_TransformSynchronizer_TypeDefinitionIndex = 36662;
