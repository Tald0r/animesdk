...
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_CONTOURVERTICESTOPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1ABF12D0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_FROMCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1ABF1230)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_SETFROMCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1ABF1420)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_SETTOCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1ABF14C0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_TOCONTOURVERTEX_1_OFFSET UNITYSDK_OFFSET(0x1ABF1110)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_TOCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1ABF1010)

namespace FluffyUnderware::Curvy::ThirdParty::LibTessDotNet
{
	inline static constexpr unsigned int UnityLibTessUtility_TypeDefinitionIndex = 25436;
