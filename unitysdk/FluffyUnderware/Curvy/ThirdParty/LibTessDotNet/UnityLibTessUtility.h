...
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_CONTOURVERTICESTOPOSITIONS_OFFSET UNITYSDK_OFFSET(0x1A646070)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_FROMCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1A645FD0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_SETFROMCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1A6461C0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_SETTOCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1A646260)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_TOCONTOURVERTEX_1_OFFSET UNITYSDK_OFFSET(0x1A645EB0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_UNITYLIBTESSUTILITY_TOCONTOURVERTEX_OFFSET UNITYSDK_OFFSET(0x1A645DB0)

namespace FluffyUnderware::Curvy::ThirdParty::LibTessDotNet
{
	inline static constexpr unsigned int UnityLibTessUtility_TypeDefinitionIndex = 24611;
