...
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_DOT_OFFSET UNITYSDK_OFFSET(0x1ABEF520)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x953990)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_LONGAXIS_OFFSET UNITYSDK_OFFSET(0x1ABEEBF0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_NEG_OFFSET UNITYSDK_OFFSET(0x1ABEEE40)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1ABF1560)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x953A10)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_SUB_OFFSET UNITYSDK_OFFSET(0x1ABEEBD0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3_TOSTRING_OFFSET UNITYSDK_OFFSET(0x953AA0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_VEC3__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABF16A0)

namespace FluffyUnderware::Curvy::ThirdParty::LibTessDotNet
{
	inline static constexpr unsigned int Vec3_TypeDefinitionIndex = 25414;

	struct alignas(4) Vec3
	{
		static ::FluffyUnderware::Curvy::ThirdParty::LibTessDotNet::Vec3* StaticGet_Zero()
		{
			return (::FluffyUnderware::Curvy::ThirdParty::LibTessDotNet::Vec3*)Il2CppClass::FromTypeDefinitionIndex(Vec3_TypeDefinitionIndex)->GetStaticField(0x4840);
		}
