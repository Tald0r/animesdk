...
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_MESHUTILS_VERTEX_RESET_OFFSET UNITYSDK_OFFSET(0x1A63EEF0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_MESHUTILS_VERTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1A63EF50)

namespace FluffyUnderware::Curvy::ThirdParty::LibTessDotNet
{
	inline static constexpr unsigned int MeshUtils_Vertex_TypeDefinitionIndex = 24592;
	...
	public:
		...
		::FluffyUnderware::Curvy::ThirdParty::LibTessDotNet::MeshUtils_Vertex* _next; // 0x18
		::FluffyUnderware::Curvy::ThirdParty::LibTessDotNet::MeshUtils_Vertex* _prev; // 0x20
		::System::Object* _data; // 0x28
		::FluffyUnderware::Curvy::ThirdParty::LibTessDotNet::PQHandle _pqHandle; // 0x30
		::System::Int32 _n; // 0x34
		::System::Single _t; // 0x38
		::FluffyUnderware::Curvy::ThirdParty::LibTessDotNet::Vec3 _coords; // 0x3C
