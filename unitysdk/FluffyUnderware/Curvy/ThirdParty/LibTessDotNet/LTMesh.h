...
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LTMESH_ADDEDGEVERTEX_OFFSET UNITYSDK_OFFSET(0x1A63E0E0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LTMESH_CHECK_OFFSET UNITYSDK_OFFSET(0x1A63EAE0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LTMESH_CONNECT_OFFSET UNITYSDK_OFFSET(0x1A63E340)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LTMESH_DELETE_OFFSET UNITYSDK_OFFSET(0x1A63DDF0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LTMESH_MAKEEDGE_OFFSET UNITYSDK_OFFSET(0x1A63D820)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LTMESH_MERGECONVEXFACES_OFFSET UNITYSDK_OFFSET(0x1A63E7B0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LTMESH_ONFREE_OFFSET UNITYSDK_OFFSET(0x1A63D710)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LTMESH_RESET_OFFSET UNITYSDK_OFFSET(0x1A63D700)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LTMESH_SPLICE_OFFSET UNITYSDK_OFFSET(0x1A63DB20)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LTMESH_SPLITEDGE_OFFSET UNITYSDK_OFFSET(0x1A63E1A0)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LTMESH_ZAPFACE_OFFSET UNITYSDK_OFFSET(0x1A63E580)
#define FLUFFYUNDERWARE_CURVY_THIRDPARTY_LIBTESSDOTNET_LTMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A63D4E0)

namespace FluffyUnderware::Curvy::ThirdParty::LibTessDotNet
{
	inline static constexpr unsigned int LTMesh_TypeDefinitionIndex = 24588;
	...
	public:
		...
		::FluffyUnderware::Curvy::ThirdParty::LibTessDotNet::MeshUtils_Vertex* _vHead; // 0x28
