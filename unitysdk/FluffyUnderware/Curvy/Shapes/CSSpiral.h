...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1A92EB90)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_CIRCLES_OFFSET UNITYSDK_OFFSET(0x1A92EAF0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A92EAC0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_RADIUSFACTOR_OFFSET UNITYSDK_OFFSET(0x1A92EB50)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1A92EB20)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_Z_OFFSET UNITYSDK_OFFSET(0x1A92EB70)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_CIRCLES_OFFSET UNITYSDK_OFFSET(0x1A92EB00)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A92EAD0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_RADIUSFACTOR_OFFSET UNITYSDK_OFFSET(0x1A92EB60)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1A92EB30)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_Z_OFFSET UNITYSDK_OFFSET(0x1A92EB80)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A92EE30)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSSpiral_TypeDefinitionIndex = 36701;
