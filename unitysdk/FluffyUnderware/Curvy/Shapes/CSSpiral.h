...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1A36B180)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_CIRCLES_OFFSET UNITYSDK_OFFSET(0x1A36B0E0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A36B0B0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_RADIUSFACTOR_OFFSET UNITYSDK_OFFSET(0x1A36B140)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1A36B110)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_GET_Z_OFFSET UNITYSDK_OFFSET(0x1A36B160)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_CIRCLES_OFFSET UNITYSDK_OFFSET(0x1A36B0F0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1A36B0C0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_RADIUSFACTOR_OFFSET UNITYSDK_OFFSET(0x1A36B150)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1A36B120)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL_SET_Z_OFFSET UNITYSDK_OFFSET(0x1A36B170)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSPIRAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A36B420)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSSpiral_TypeDefinitionIndex = 35681;
