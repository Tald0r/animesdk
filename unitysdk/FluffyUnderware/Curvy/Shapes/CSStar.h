...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1B069520)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR_GET_INNERRADIUS_OFFSET UNITYSDK_OFFSET(0x1B069480)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR_GET_INNERROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1B0694B0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR_GET_OUTERRADIUS_OFFSET UNITYSDK_OFFSET(0x1B069410)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR_GET_OUTERROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1B069440)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR_GET_SIDES_OFFSET UNITYSDK_OFFSET(0x1B0693E0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B0694F0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR_SET_INNERRADIUS_OFFSET UNITYSDK_OFFSET(0x1B069490)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR_SET_INNERROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1B0694C0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR_SET_OUTERRADIUS_OFFSET UNITYSDK_OFFSET(0x1B069420)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR_SET_OUTERROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1B069450)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR_SET_SIDES_OFFSET UNITYSDK_OFFSET(0x1B0693F0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSSTAR__CTOR_OFFSET UNITYSDK_OFFSET(0x1B069B00)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSStar_TypeDefinitionIndex = 36702;
