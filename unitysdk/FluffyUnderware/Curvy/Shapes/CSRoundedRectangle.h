...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1AAA5740)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1AAA56D0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_GET_ROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1AAA5700)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1AAA56A0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1AAA56E0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_SET_ROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1AAA5710)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1AAA56B0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAA5F60)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSRoundedRectangle_TypeDefinitionIndex = 36700;
