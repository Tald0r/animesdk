...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1A4F31B0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1A4F3140)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_GET_ROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1A4F3170)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1A4F3110)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1A4F3150)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_SET_ROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1A4F3180)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1A4F3120)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSROUNDEDRECTANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4F39D0)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSRoundedRectangle_TypeDefinitionIndex = 35680;
