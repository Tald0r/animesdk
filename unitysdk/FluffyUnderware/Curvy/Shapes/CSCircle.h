...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1AE6FE50)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AE6FDF0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1AE6FE20)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1AE6FE00)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1AE6FE30)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE700F0)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSCircle_TypeDefinitionIndex = 35676;
