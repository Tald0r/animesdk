...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1B489300)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B4892A0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_GET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1B4892D0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_SET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B4892B0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE_SET_RADIUS_OFFSET UNITYSDK_OFFSET(0x1B4892E0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSCIRCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4895A0)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSCircle_TypeDefinitionIndex = 36696;
