...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSRECTANGLE_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x19F34AB0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSRECTANGLE_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x19F34A80)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSRECTANGLE_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x19F34A50)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSRECTANGLE_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x19F34A90)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSRECTANGLE_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x19F34A60)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSRECTANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x19F34BC0)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSRectangle_TypeDefinitionIndex = 35679;
