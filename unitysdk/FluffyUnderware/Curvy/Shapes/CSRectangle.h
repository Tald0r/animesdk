...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSRECTANGLE_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1A553400)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSRECTANGLE_GET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1A5533D0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSRECTANGLE_GET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1A5533A0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSRECTANGLE_SET_HEIGHT_OFFSET UNITYSDK_OFFSET(0x1A5533E0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSRECTANGLE_SET_WIDTH_OFFSET UNITYSDK_OFFSET(0x1A5533B0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSRECTANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A553510)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSRectangle_TypeDefinitionIndex = 36699;
