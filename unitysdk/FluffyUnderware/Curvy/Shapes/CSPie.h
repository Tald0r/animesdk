...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1A31E4B0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_CPPOSITION_OFFSET UNITYSDK_OFFSET(0x1A31E3F0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_GET_EAT_OFFSET UNITYSDK_OFFSET(0x1A31E3D0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1A31E390)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_GET_MAXEMPTY_OFFSET UNITYSDK_OFFSET(0x1A31E3C0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_GET_ROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1A31E350)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_SET_EAT_OFFSET UNITYSDK_OFFSET(0x1A31E3E0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_SET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1A31E3A0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_SET_ROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1A31E360)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A320030)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSPie_TypeDefinitionIndex = 35677;
