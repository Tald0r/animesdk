...
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_APPLYSHAPE_OFFSET UNITYSDK_OFFSET(0x1A8D4840)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_CPPOSITION_OFFSET UNITYSDK_OFFSET(0x1A8D4780)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_GET_EAT_OFFSET UNITYSDK_OFFSET(0x1A8D4760)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1A8D4720)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_GET_MAXEMPTY_OFFSET UNITYSDK_OFFSET(0x1A8D4750)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_GET_ROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1A8D46E0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_SET_EAT_OFFSET UNITYSDK_OFFSET(0x1A8D4770)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_SET_EMPTY_OFFSET UNITYSDK_OFFSET(0x1A8D4730)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE_SET_ROUNDNESS_OFFSET UNITYSDK_OFFSET(0x1A8D46F0)
#define FLUFFYUNDERWARE_CURVY_SHAPES_CSPIE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8D63C0)

namespace FluffyUnderware::Curvy::Shapes
{
	inline static constexpr unsigned int CSPie_TypeDefinitionIndex = 36697;
