...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9042D0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_EQUALS_OFFSET UNITYSDK_OFFSET(0x9041F0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9042E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_CONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_DEGREE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_ENDTF_OFFSET UNITYSDK_OFFSET(0x2D8630)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_ISCLAMPED_OFFSET UNITYSDK_OFFSET(0x33E1C0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x8F8090)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_SEGMENTSCOUNT_OFFSET UNITYSDK_OFFSET(0x359050)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_GET_STARTTF_OFFSET UNITYSDK_OFFSET(0x2C4B30)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19F8F9E0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19F8FAC0)
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINESEGMENT_BSPLINEAPPROXIMATIONPARAMETERS__CTOR_OFFSET UNITYSDK_OFFSET(0x9041E0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineSegment_BSplineApproximationParameters_TypeDefinitionIndex = 35667;
