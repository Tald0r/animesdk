...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_APPLYDELTATIME_OFFSET UNITYSDK_OFFSET(0x1A35C740)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_APPLYOFFSET_OFFSET UNITYSDK_OFFSET(0x1A35DF80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_BINDEVENTS_OFFSET UNITYSDK_OFFSET(0x1A35E2F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_COMPUTEOFFSETCOMPENSATEDSPEED_OFFSET UNITYSDK_OFFSET(0x1A35CEA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_COMPUTETARGETPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1A35D440)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_DEINITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A35E2D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1A35C880)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GETCLAMPEDPOSITION_OFFSET UNITYSDK_OFFSET(0x1A35BFF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GETMAXPOSITION_OFFSET UNITYSDK_OFFSET(0x1A35F950)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GETORIENTATIONNONEUPANDFORWARD_OFFSET UNITYSDK_OFFSET(0x1A35DAE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GETPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1A35E360)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ABSOLUTEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A35C1A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ARECONSTRAINTSCONFLICTING_OFFSET UNITYSDK_OFFSET(0x1A35FC30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_CLAMPING_OFFSET UNITYSDK_OFFSET(0x1A35BCA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_DAMPER_OFFSET UNITYSDK_OFFSET(0x1A35C580)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_DIRECTIONDAMPINGTIME_OFFSET UNITYSDK_OFFSET(0x1A35BD80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_DIRECTIONDAMPINGVELOCITY_OFFSET UNITYSDK_OFFSET(0x1A35BB50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_IGNOREDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A35BDC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A35F890)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ISNEEDED2DRIGIDBODYMISSING_OFFSET UNITYSDK_OFFSET(0x1A35FA70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ISNEEDED2DRIGIDBODYNOTKINEMATIC_OFFSET UNITYSDK_OFFSET(0x1A35FB90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ISNEEDEDRIGIDBODYMISSING_OFFSET UNITYSDK_OFFSET(0x1A35F9F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ISNEEDEDRIGIDBODYNOTKINEMATIC_OFFSET UNITYSDK_OFFSET(0x1A35FAF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_LOCKROTATION_OFFSET UNITYSDK_OFFSET(0x1A35BD00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_MAXPOSITION_OFFSET UNITYSDK_OFFSET(0x1A35F8B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_MOTIONCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1A35BCC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_MOVEMENTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A35C520)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_MOVEMODE_OFFSET UNITYSDK_OFFSET(0x1A35BC60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x1A35BDE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_OFFSETCOMPENSATION_OFFSET UNITYSDK_OFFSET(0x1A35BE20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_OFFSETRADIUS_OFFSET UNITYSDK_OFFSET(0x1A35BE00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ONINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A35BC10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ORIENTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x1A35BD60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_ORIENTATIONMODE_OFFSET UNITYSDK_OFFSET(0x1A35BCE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_PLAYAUTOMATICALLY_OFFSET UNITYSDK_OFFSET(0x1A35BC80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_PLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1A35C540)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_POSITIONMODE_OFFSET UNITYSDK_OFFSET(0x1A35BC40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A35C410)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_RELATIVEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A35BE70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_RIGIDBODY2D_OFFSET UNITYSDK_OFFSET(0x1A35CA20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_RIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1A35C9A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_SHOULDDISABLEPOSITIONSLIDER_OFFSET UNITYSDK_OFFSET(0x1A35C550)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_SHOWOFFSETSECTION_OFFSET UNITYSDK_OFFSET(0x1A35EE70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_SHOWORIENTATIONSECTION_OFFSET UNITYSDK_OFFSET(0x1A35EE60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1A35BE40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_TARGETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A35BC20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_TIMESINCELASTUPDATE_OFFSET UNITYSDK_OFFSET(0x1A35C730)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A35C990)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_UPDAMPINGTIME_OFFSET UNITYSDK_OFFSET(0x1A35BDA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_UPDAMPINGVELOCITY_OFFSET UNITYSDK_OFFSET(0x1A35BBB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_GET_USEOFFSET_OFFSET UNITYSDK_OFFSET(0x1A35CE90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_INITIALIZEDAPPLYDELTATIME_OFFSET UNITYSDK_OFFSET(0x1A35CAD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A35E160)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1A35C7D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A35FD70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A35FD60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A35C660)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A35C590)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A35C920)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_PAUSE_OFFSET UNITYSDK_OFFSET(0x1A35EFE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_PLAY_OFFSET UNITYSDK_OFFSET(0x1A35E2A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_REFRESH_OFFSET UNITYSDK_OFFSET(0x1A35F000)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_RESETPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1A35E350)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_RESTOREPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1A35E330)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SAVEPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1A35E310)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SETFROMSTRING_OFFSET UNITYSDK_OFFSET(0x1A35F330)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SETPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1A35E840)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_ABSOLUTEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A35C320)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_CLAMPING_OFFSET UNITYSDK_OFFSET(0x1A35BCB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_DIRECTIONDAMPINGTIME_OFFSET UNITYSDK_OFFSET(0x1A35BD90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_DIRECTIONDAMPINGVELOCITY_OFFSET UNITYSDK_OFFSET(0x1A35BB80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_IGNOREDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A35BDD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_ISINITIALIZED_OFFSET UNITYSDK_OFFSET(0x1A35F8A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_LOCKROTATION_OFFSET UNITYSDK_OFFSET(0x1A35BD10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_MOTIONCONSTRAINTS_OFFSET UNITYSDK_OFFSET(0x1A35BCD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_MOVEMENTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A35C530)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_MOVEMODE_OFFSET UNITYSDK_OFFSET(0x1A35BC70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_OFFSETANGLE_OFFSET UNITYSDK_OFFSET(0x1A35BDF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_OFFSETCOMPENSATION_OFFSET UNITYSDK_OFFSET(0x1A35BE30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_OFFSETRADIUS_OFFSET UNITYSDK_OFFSET(0x1A35BE10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_ORIENTATIONAXIS_OFFSET UNITYSDK_OFFSET(0x1A35BD70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_ORIENTATIONMODE_OFFSET UNITYSDK_OFFSET(0x1A35BCF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_PLAYAUTOMATICALLY_OFFSET UNITYSDK_OFFSET(0x1A35BC90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_POSITIONMODE_OFFSET UNITYSDK_OFFSET(0x1A35BC50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A35C490)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_RELATIVEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A35C0C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_SPEED_OFFSET UNITYSDK_OFFSET(0x1A35BE50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_TARGETCOMPONENT_OFFSET UNITYSDK_OFFSET(0x1A35BC30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_UPDAMPINGTIME_OFFSET UNITYSDK_OFFSET(0x1A35BDB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_SET_UPDAMPINGVELOCITY_OFFSET UNITYSDK_OFFSET(0x1A35BBE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_START_OFFSET UNITYSDK_OFFSET(0x1A35C610)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_STOP_OFFSET UNITYSDK_OFFSET(0x1A35EFB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_TELEPORTBY_OFFSET UNITYSDK_OFFSET(0x1A35F1A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_TELEPORTTO_OFFSET UNITYSDK_OFFSET(0x1A35F080)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_UNBINDEVENTS_OFFSET UNITYSDK_OFFSET(0x1A35E300)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A35C680)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_USERAFTERINIT_OFFSET UNITYSDK_OFFSET(0x1A35EE40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_USERAFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x1A35EE50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A35EE80)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int CurvyController_TypeDefinitionIndex = 35705;
