...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_CONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1A768480)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_DELTA_OFFSET UNITYSDK_OFFSET(0x1A7684E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_MOVEMENTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A7684C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A768500)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_SENDER_OFFSET UNITYSDK_OFFSET(0x1A768440)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1A768460)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_WORLDUNITS_OFFSET UNITYSDK_OFFSET(0x1A7684A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_CONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1A768490)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_DELTA_OFFSET UNITYSDK_OFFSET(0x1A7684F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1A7685C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_MOVEMENTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A7684D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1A768510)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_SENDER_OFFSET UNITYSDK_OFFSET(0x1A768450)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1A768470)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_WORLDUNITS_OFFSET UNITYSDK_OFFSET(0x1A7684B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A768520)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int CurvySplineMoveEventArgs_TypeDefinitionIndex = 35710;
	...
	public:
		...
		::FluffyUnderware::Curvy::CurvySplineSegment* _ControlPoint_k__BackingField; // 0x20
		::FluffyUnderware::Curvy::CurvySpline* _Spline_k__BackingField; // 0x28
		::System::Boolean _WorldUnits_k__BackingField; // 0x30
		::System::Single _Delta_k__BackingField; // 0x34
		::System::Single _Position_k__BackingField; // 0x38
