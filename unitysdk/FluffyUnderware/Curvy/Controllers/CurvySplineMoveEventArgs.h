...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_CONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1AD06DD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_DELTA_OFFSET UNITYSDK_OFFSET(0x1AD06E30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_MOVEMENTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AD06E10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AD06E50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_SENDER_OFFSET UNITYSDK_OFFSET(0x1AD06D90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1AD06DB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_GET_WORLDUNITS_OFFSET UNITYSDK_OFFSET(0x1AD06DF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_CONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1AD06DE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_DELTA_OFFSET UNITYSDK_OFFSET(0x1AD06E40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_INTERNAL_OFFSET UNITYSDK_OFFSET(0x1AD06F10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_MOVEMENTDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AD06E20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_POSITION_OFFSET UNITYSDK_OFFSET(0x1AD06E60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_SENDER_OFFSET UNITYSDK_OFFSET(0x1AD06DA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1AD06DC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS_SET_WORLDUNITS_OFFSET UNITYSDK_OFFSET(0x1AD06E00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYSPLINEMOVEEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD06E70)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int CurvySplineMoveEventArgs_TypeDefinitionIndex = 36730;
