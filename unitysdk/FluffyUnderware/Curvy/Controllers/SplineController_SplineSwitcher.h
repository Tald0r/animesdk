...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x1A8434A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1A843310)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1A8432B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_ISSWITCHING_OFFSET UNITYSDK_OFFSET(0x1A843330)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x1A843350)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1A8432D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1A843290)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_TF_OFFSET UNITYSDK_OFFSET(0x1A8432F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1A843320)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_DURATION_OFFSET UNITYSDK_OFFSET(0x1A8432C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_ISSWITCHING_OFFSET UNITYSDK_OFFSET(0x1A843340)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1A8432E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1A8432A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_TF_OFFSET UNITYSDK_OFFSET(0x1A843300)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_START_OFFSET UNITYSDK_OFFSET(0x1A8433A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_STOP_OFFSET UNITYSDK_OFFSET(0x1A843500)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A843520)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int SplineController_SplineSwitcher_TypeDefinitionIndex = 35717;

	class SplineController_SplineSwitcher : public ::System::Object
	{
	public:
		::FluffyUnderware::Curvy::CurvySpline* _Spline_k__BackingField; // 0x10
		::System::Boolean _IsSwitching_k__BackingField; // 0x18
