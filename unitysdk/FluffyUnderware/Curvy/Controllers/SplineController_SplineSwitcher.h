...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x1AE23120)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1AE22F90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_DURATION_OFFSET UNITYSDK_OFFSET(0x1AE22F30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_ISSWITCHING_OFFSET UNITYSDK_OFFSET(0x1AE22FB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x1AE22FD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1AE22F50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1AE22F10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_GET_TF_OFFSET UNITYSDK_OFFSET(0x1AE22F70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_DIRECTION_OFFSET UNITYSDK_OFFSET(0x1AE22FA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_DURATION_OFFSET UNITYSDK_OFFSET(0x1AE22F40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_ISSWITCHING_OFFSET UNITYSDK_OFFSET(0x1AE22FC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1AE22F60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_STARTTIME_OFFSET UNITYSDK_OFFSET(0x1AE22F20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_SET_TF_OFFSET UNITYSDK_OFFSET(0x1AE22F80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_START_OFFSET UNITYSDK_OFFSET(0x1AE23020)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER_STOP_OFFSET UNITYSDK_OFFSET(0x1AE23180)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SPLINESWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE23190)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int SplineController_SplineSwitcher_TypeDefinitionIndex = 36737;
	...
	public:
		...
		::System::Single _StartTime_k__BackingField; // 0x1C
		::System::Single _Duration_k__BackingField; // 0x20
		::System::Single _Tf_k__BackingField; // 0x24
