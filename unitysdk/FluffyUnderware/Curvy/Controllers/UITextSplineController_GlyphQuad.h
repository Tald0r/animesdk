...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_CALCRECT_OFFSET UNITYSDK_OFFSET(0x1B1EF3E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x1B1EF0F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_LOADTRIS_OFFSET UNITYSDK_OFFSET(0x1B1EF460)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_LOAD_OFFSET UNITYSDK_OFFSET(0x1B1EF120)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_ROTATE_OFFSET UNITYSDK_OFFSET(0x1B1EFB40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_SAVE_1_OFFSET UNITYSDK_OFFSET(0x1B1EFA00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_SAVE_OFFSET UNITYSDK_OFFSET(0x1B1EF720)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1B1EFA30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHQUAD__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F0080)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int UITextSplineController_GlyphQuad_TypeDefinitionIndex = 36743;
