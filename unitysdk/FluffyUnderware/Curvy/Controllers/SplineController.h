...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ABSOLUTETORELATIVE_OFFSET UNITYSDK_OFFSET(0x1A4E5DA0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ADVANCESWITCHING_OFFSET UNITYSDK_OFFSET(0x1A4E7B60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x1A4E65D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_CANCELCURRENTSWITCH_OFFSET UNITYSDK_OFFSET(0x1A4E5930)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_COMPUTEPOSITIONANDROTATIONONSWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1A4E87E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_COMPUTETARGETPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1A4E8250)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_EVENTAWAREMOVE_OFFSET UNITYSDK_OFFSET(0x1A4E66E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_FINISHCURRENTSWITCH_OFFSET UNITYSDK_OFFSET(0x1A4E58B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETANGLEBETWEENCONNECTEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1A4E5970)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETCONTROLPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4E8D10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETINTERPOLATEDSOURCEPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1A4E6030)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETINTERPOLATEDSOURCEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4E5E80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A4E6490)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETPOSTCONNECTIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A4E5BF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETSWITCHINGPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1A4E8560)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x1A4E62E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ALLOWDIRECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A4E51D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_CONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A4E5190)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_CONNECTIONCUSTOMSELECTOR_OFFSET UNITYSDK_OFFSET(0x1A4E51B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_DIRECTIONONSWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1A4E4E30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x1A4E5650)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ISSWITCHING_OFFSET UNITYSDK_OFFSET(0x1A4E5300)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A4E52B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_MAXALLOWEDDIVERGENCEANGLE_OFFSET UNITYSDK_OFFSET(0x1A4E5230)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONCONTROLPOINTREACHED_OFFSET UNITYSDK_OFFSET(0x1A4E5270)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONENDREACHED_OFFSET UNITYSDK_OFFSET(0x1A4E5290)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONPOSITIONREACHEDLIST_OFFSET UNITYSDK_OFFSET(0x1A4E5250)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONSWITCH_OFFSET UNITYSDK_OFFSET(0x1A4E5380)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_REJECTCURRENTSPLINE_OFFSET UNITYSDK_OFFSET(0x1A4E51F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_REJECTTOODIVERGENTSPLINES_OFFSET UNITYSDK_OFFSET(0x1A4E5210)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SHOWRANDOMCONNECTIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1A4EA4A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1A4E5150)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHDURATION_OFFSET UNITYSDK_OFFSET(0x1A4E4DD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A4E5320)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1A4E4DB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1A4E4DF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_TFONSWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1A4E4E10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1A4E5170)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEFOLLOWUPCONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A4E9750)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEONPOSITIONREACHEDEVENTS_OFFSET UNITYSDK_OFFSET(0x1A4E8DD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEONPOSITIONREACHEDEVENT_OFFSET UNITYSDK_OFFSET(0x1A4E9C00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLERANDOMCONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A4E98F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEREACHINGNEWCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1A4E93D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HEADINGTODIRECTION_OFFSET UNITYSDK_OFFSET(0x1A4EA2F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_INITIALIZEDAPPLYDELTATIME_OFFSET UNITYSDK_OFFSET(0x1A4E8080)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_INVOKEEVENTHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1A4EA050)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_INVOKEEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1A4EA180)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_MOVEMENTCOMPATIBLEGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4E8900)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_MOVEMENTCOMPATIBLESETPOSITION_OFFSET UNITYSDK_OFFSET(0x1A4E8B10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1A4E53A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RELATIVETOABSOLUTE_OFFSET UNITYSDK_OFFSET(0x1A4E5CE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1A4E8760)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RESETPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1A4E5CC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RESTOREPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1A4E5C80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SAVEPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1A4E5C40)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ALLOWDIRECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1A4E51E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_CONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1A4E51A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_CONNECTIONCUSTOMSELECTOR_OFFSET UNITYSDK_OFFSET(0x1A4E51C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_MAXALLOWEDDIVERGENCEANGLE_OFFSET UNITYSDK_OFFSET(0x1A4E5240)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONCONTROLPOINTREACHED_OFFSET UNITYSDK_OFFSET(0x1A4E5280)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONENDREACHED_OFFSET UNITYSDK_OFFSET(0x1A4E52A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONPOSITIONREACHEDLIST_OFFSET UNITYSDK_OFFSET(0x1A4E5260)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONSWITCH_OFFSET UNITYSDK_OFFSET(0x1A4E5390)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_REJECTCURRENTSPLINE_OFFSET UNITYSDK_OFFSET(0x1A4E5200)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_REJECTTOODIVERGENTSPLINES_OFFSET UNITYSDK_OFFSET(0x1A4E5220)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1A4E5160)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1A4E5180)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SIMULATEADVANCEONSPLINE_OFFSET UNITYSDK_OFFSET(0x1A4E7D90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SIMULATEADVANCE_OFFSET UNITYSDK_OFFSET(0x1A4E7D30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SWITCHTO_OFFSET UNITYSDK_OFFSET(0x1A4E56A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E4E50)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int SplineController_TypeDefinitionIndex = 35716;
