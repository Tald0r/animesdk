...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ABSOLUTETORELATIVE_OFFSET UNITYSDK_OFFSET(0x1AA98330)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ADVANCESWITCHING_OFFSET UNITYSDK_OFFSET(0x1AA9A0F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x1AA98B60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_CANCELCURRENTSWITCH_OFFSET UNITYSDK_OFFSET(0x1AA97ED0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_COMPUTEPOSITIONANDROTATIONONSWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1AA9AD50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_COMPUTETARGETPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1AA9A7C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_EVENTAWAREMOVE_OFFSET UNITYSDK_OFFSET(0x1AA98C70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_FINISHCURRENTSWITCH_OFFSET UNITYSDK_OFFSET(0x1AA97E60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETANGLEBETWEENCONNECTEDSPLINES_OFFSET UNITYSDK_OFFSET(0x1AA97F00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETCONTROLPOINTPOSITION_OFFSET UNITYSDK_OFFSET(0x1AA9B280)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETINTERPOLATEDSOURCEPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1AA985C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETINTERPOLATEDSOURCEPOSITION_OFFSET UNITYSDK_OFFSET(0x1AA98410)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETORIENTATION_OFFSET UNITYSDK_OFFSET(0x1AA98A20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETPOSTCONNECTIONDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AA98180)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETSWITCHINGPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1AA9AAD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x1AA98870)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ALLOWDIRECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1AA97780)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_CONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AA97740)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_CONNECTIONCUSTOMSELECTOR_OFFSET UNITYSDK_OFFSET(0x1AA97760)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_DIRECTIONONSWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1AA973E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x1AA97C00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ISSWITCHING_OFFSET UNITYSDK_OFFSET(0x1AA978B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1AA97860)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_MAXALLOWEDDIVERGENCEANGLE_OFFSET UNITYSDK_OFFSET(0x1AA977E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONCONTROLPOINTREACHED_OFFSET UNITYSDK_OFFSET(0x1AA97820)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONENDREACHED_OFFSET UNITYSDK_OFFSET(0x1AA97840)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONPOSITIONREACHEDLIST_OFFSET UNITYSDK_OFFSET(0x1AA97800)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_ONSWITCH_OFFSET UNITYSDK_OFFSET(0x1AA97930)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_REJECTCURRENTSPLINE_OFFSET UNITYSDK_OFFSET(0x1AA977A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_REJECTTOODIVERGENTSPLINES_OFFSET UNITYSDK_OFFSET(0x1AA977C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SHOWRANDOMCONNECTIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1AA9CA10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1AA97700)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHDURATION_OFFSET UNITYSDK_OFFSET(0x1AA97380)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHPROGRESS_OFFSET UNITYSDK_OFFSET(0x1AA978D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHSTARTTIME_OFFSET UNITYSDK_OFFSET(0x1AA97360)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_SWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1AA973A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_TFONSWITCHTARGET_OFFSET UNITYSDK_OFFSET(0x1AA973C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_GET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1AA97720)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEFOLLOWUPCONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AA9BCC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEONPOSITIONREACHEDEVENTS_OFFSET UNITYSDK_OFFSET(0x1AA9B340)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEONPOSITIONREACHEDEVENT_OFFSET UNITYSDK_OFFSET(0x1AA9C170)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLERANDOMCONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AA9BE60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HANDLEREACHINGNEWCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1AA9B940)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_HEADINGTODIRECTION_OFFSET UNITYSDK_OFFSET(0x1AA9C860)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_INITIALIZEDAPPLYDELTATIME_OFFSET UNITYSDK_OFFSET(0x1AA9A600)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_INVOKEEVENTHANDLER_1_OFFSET UNITYSDK_OFFSET(0x1AA9C5C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_INVOKEEVENTHANDLER_OFFSET UNITYSDK_OFFSET(0x1AA9C6F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_MOVEMENTCOMPATIBLEGETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AA9AE70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_MOVEMENTCOMPATIBLESETPOSITION_OFFSET UNITYSDK_OFFSET(0x1AA9B080)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AA97950)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RELATIVETOABSOLUTE_OFFSET UNITYSDK_OFFSET(0x1AA98270)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1AA9ACD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RESETPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1AA98250)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_RESTOREPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1AA98210)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SAVEPREPLAYSTATE_OFFSET UNITYSDK_OFFSET(0x1AA981D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ALLOWDIRECTIONCHANGE_OFFSET UNITYSDK_OFFSET(0x1AA97790)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_CONNECTIONBEHAVIOR_OFFSET UNITYSDK_OFFSET(0x1AA97750)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_CONNECTIONCUSTOMSELECTOR_OFFSET UNITYSDK_OFFSET(0x1AA97770)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_MAXALLOWEDDIVERGENCEANGLE_OFFSET UNITYSDK_OFFSET(0x1AA977F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONCONTROLPOINTREACHED_OFFSET UNITYSDK_OFFSET(0x1AA97830)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONENDREACHED_OFFSET UNITYSDK_OFFSET(0x1AA97850)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONPOSITIONREACHEDLIST_OFFSET UNITYSDK_OFFSET(0x1AA97810)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_ONSWITCH_OFFSET UNITYSDK_OFFSET(0x1AA97940)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_REJECTCURRENTSPLINE_OFFSET UNITYSDK_OFFSET(0x1AA977B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_REJECTTOODIVERGENTSPLINES_OFFSET UNITYSDK_OFFSET(0x1AA977D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_SPLINE_OFFSET UNITYSDK_OFFSET(0x1AA97710)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SET_USECACHE_OFFSET UNITYSDK_OFFSET(0x1AA97730)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SIMULATEADVANCEONSPLINE_OFFSET UNITYSDK_OFFSET(0x1AA9A310)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SIMULATEADVANCE_OFFSET UNITYSDK_OFFSET(0x1AA9A2B0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER_SWITCHTO_OFFSET UNITYSDK_OFFSET(0x1AA97C50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_SPLINECONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA97400)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int SplineController_TypeDefinitionIndex = 36736;
