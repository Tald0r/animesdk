...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_ABSOLUTETORELATIVE_OFFSET UNITYSDK_OFFSET(0x19F80000)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x19F80810)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETINTERPOLATEDSOURCEPOSITION_1_OFFSET UNITYSDK_OFFSET(0x19F802F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETINTERPOLATEDSOURCEPOSITION_OFFSET UNITYSDK_OFFSET(0x19F80180)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETORIENTATION_OFFSET UNITYSDK_OFFSET(0x19F806A0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x19F80530)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x19F7FE20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x19F7FCC0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_PATHDATA_OFFSET UNITYSDK_OFFSET(0x19F7FC30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_PATH_OFFSET UNITYSDK_OFFSET(0x19F7FC10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_RELATIVETOABSOLUTE_OFFSET UNITYSDK_OFFSET(0x19F7FE70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_SET_PATH_OFFSET UNITYSDK_OFFSET(0x19F7FC20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_SIMULATEADVANCE_OFFSET UNITYSDK_OFFSET(0x19F80880)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F80B70)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int PathController_TypeDefinitionIndex = 35715;
