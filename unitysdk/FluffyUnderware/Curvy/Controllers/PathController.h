...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_ABSOLUTETORELATIVE_OFFSET UNITYSDK_OFFSET(0x1A590DF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x1A591600)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETINTERPOLATEDSOURCEPOSITION_1_OFFSET UNITYSDK_OFFSET(0x1A5910E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETINTERPOLATEDSOURCEPOSITION_OFFSET UNITYSDK_OFFSET(0x1A590F70)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A591490)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x1A591320)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_ISREADY_OFFSET UNITYSDK_OFFSET(0x1A590C10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x1A590AB0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_PATHDATA_OFFSET UNITYSDK_OFFSET(0x1A590A20)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1A590A00)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_RELATIVETOABSOLUTE_OFFSET UNITYSDK_OFFSET(0x1A590C60)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_SET_PATH_OFFSET UNITYSDK_OFFSET(0x1A590A10)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER_SIMULATEADVANCE_OFFSET UNITYSDK_OFFSET(0x1A591670)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_PATHCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A591960)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int PathController_TypeDefinitionIndex = 36735;
