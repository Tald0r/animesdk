...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_CALCRECT_OFFSET UNITYSDK_OFFSET(0x1A768890)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x1A768600)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_LOAD_OFFSET UNITYSDK_OFFSET(0x1A768630)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_ROTATE_OFFSET UNITYSDK_OFFSET(0x1A768BD0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_SAVE_OFFSET UNITYSDK_OFFSET(0x1A768900)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1A768AE0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A769100)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int UITextSplineController_GlyphPlain_TypeDefinitionIndex = 35722;
