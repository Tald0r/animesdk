...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_CALCRECT_OFFSET UNITYSDK_OFFSET(0x1AD071E0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x1AD06F50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_LOAD_OFFSET UNITYSDK_OFFSET(0x1AD06F80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_ROTATE_OFFSET UNITYSDK_OFFSET(0x1AD07520)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_SAVE_OFFSET UNITYSDK_OFFSET(0x1AD07250)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN_TRANSPOSE_OFFSET UNITYSDK_OFFSET(0x1AD07430)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_UITEXTSPLINECONTROLLER_GLYPHPLAIN__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD07A50)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int UITextSplineController_GlyphPlain_TypeDefinitionIndex = 36742;
