...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CONTROLLEREVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4E4D20)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int ControllerEvent_TypeDefinitionIndex = 35704;
