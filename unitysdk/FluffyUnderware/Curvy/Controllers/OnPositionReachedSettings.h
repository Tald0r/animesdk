...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_CLONE_OFFSET UNITYSDK_OFFSET(0x1B1EEFF0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_INITIALIZEFIELDSWITHDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1B1EEF30)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1EEF90)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1EEF80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1EEE20)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int OnPositionReachedSettings_TypeDefinitionIndex = 36734;
