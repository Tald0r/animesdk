...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_CLONE_OFFSET UNITYSDK_OFFSET(0x1ABDE130)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_INITIALIZEFIELDSWITHDEFAULTVALUE_OFFSET UNITYSDK_OFFSET(0x1ABDE070)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABDE0D0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABDE0C0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_ONPOSITIONREACHEDSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABDDF60)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int OnPositionReachedSettings_TypeDefinitionIndex = 35714;
