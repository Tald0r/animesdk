...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ORIENTATIONDAMPER_DAMPENVECTOR_OFFSET UNITYSDK_OFFSET(0x19F1CF50)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ORIENTATIONDAMPER_DAMP_OFFSET UNITYSDK_OFFSET(0x19F1CA80)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ORIENTATIONDAMPER_RESET_OFFSET UNITYSDK_OFFSET(0x19F1D020)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_CURVYCONTROLLER_ORIENTATIONDAMPER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F1CA70)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int CurvyController_OrientationDamper_TypeDefinitionIndex = 35708;
