...
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_MOVEMENTDIRECTIONMETHODS_FROMINT_OFFSET UNITYSDK_OFFSET(0x1A9237F0)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_MOVEMENTDIRECTIONMETHODS_GETOPPOSITE_OFFSET UNITYSDK_OFFSET(0x1A923800)
#define FLUFFYUNDERWARE_CURVY_CONTROLLERS_MOVEMENTDIRECTIONMETHODS_TOINT_OFFSET UNITYSDK_OFFSET(0x1A923870)

namespace FluffyUnderware::Curvy::Controllers
{
	inline static constexpr unsigned int MovementDirectionMethods_TypeDefinitionIndex = 36733;
