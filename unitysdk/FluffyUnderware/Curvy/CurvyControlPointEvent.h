...
#define FLUFFYUNDERWARE_CURVY_CURVYCONTROLPOINTEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A769130)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyControlPointEvent_TypeDefinitionIndex = 35646;
