...
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ADDCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1B1F0C10)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_AUTOSETFOLLOWUP_OFFSET UNITYSDK_OFFSET(0x1B1F0E40)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1B1F08A0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_DELETE_OFFSET UNITYSDK_OFFSET(0x1B1F15B0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x1B1F0680)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1B1F06E0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_GET_CONTROLPOINTSLIST_OFFSET UNITYSDK_OFFSET(0x1B1F02E0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1B1F0340)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1B1F0360)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B1F06A0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1F1910)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B1F1800)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B1F0720)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B1F0530)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B1F03C0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONSCENELOADED_OFFSET UNITYSDK_OFFSET(0x1B1F1AE0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_OTHERCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1B1F15D0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_REMOVECONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1B1F13A0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_REMOVENULLCPS_OFFSET UNITYSDK_OFFSET(0x1B1F1810)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1B1F1D20)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_SETSYNCHRONISATIONPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1B1F16E0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_SETSYNCHRONIZATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1B1F1230)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B1F0640)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1F00B0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyConnection_TypeDefinitionIndex = 36661;
