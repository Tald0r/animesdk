...
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ADDCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1ABDFD40)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_AUTOSETFOLLOWUP_OFFSET UNITYSDK_OFFSET(0x1ABDFF70)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_CREATE_OFFSET UNITYSDK_OFFSET(0x1ABDF9D0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_DELETE_OFFSET UNITYSDK_OFFSET(0x1ABE06E0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_DOUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDF7B0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDF810)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_GET_CONTROLPOINTSLIST_OFFSET UNITYSDK_OFFSET(0x1ABDF420)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1ABDF480)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1ABDF4A0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDF7D0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABE0A40)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1ABE0930)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ABDF850)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1ABDF660)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ABDF500)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_ONSCENELOADED_OFFSET UNITYSDK_OFFSET(0x1ABE0C10)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_OTHERCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1ABE0700)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_REMOVECONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1ABE04D0)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_REMOVENULLCPS_OFFSET UNITYSDK_OFFSET(0x1ABE0940)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_RESETONENABLE_OFFSET UNITYSDK_OFFSET(0x1ABE0E50)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_SETSYNCHRONISATIONPOSITIONANDROTATION_OFFSET UNITYSDK_OFFSET(0x1ABE0810)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_SETSYNCHRONIZATIONOPTIONS_OFFSET UNITYSDK_OFFSET(0x1ABE0360)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ABDF770)
#define FLUFFYUNDERWARE_CURVY_CURVYCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABDF1F0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyConnection_TypeDefinitionIndex = 35641;
