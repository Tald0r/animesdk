...
#define FLUFFYUNDERWARE_CURVY_CURVYCGEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5919B0)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvyCGEvent_TypeDefinitionIndex = 36626;
