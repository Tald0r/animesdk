...
#define FLUFFYUNDERWARE_CURVY_CURVYSPLINEEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE26840)

namespace FluffyUnderware::Curvy
{
	inline static constexpr unsigned int CurvySplineEvent_TypeDefinitionIndex = 36682;
