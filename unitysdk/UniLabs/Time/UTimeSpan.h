...
#define UNILABS_TIME_UTIMESPAN_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x1B6F8050)
#define UNILABS_TIME_UTIMESPAN_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1B6F8030)
#define UNILABS_TIME_UTIMESPAN_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B6F80B0)
#define UNILABS_TIME_UTIMESPAN_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B6F8090)
#define UNILABS_TIME_UTIMESPAN_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B6F8150)
#define UNILABS_TIME_UTIMESPAN_GET_TIMESPAN_OFFSET UNITYSDK_OFFSET(0x1B6F7DB0)
#define UNILABS_TIME_UTIMESPAN_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6F8160)
#define UNILABS_TIME_UTIMESPAN_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6F8270)
#define UNILABS_TIME_UTIMESPAN_ONDESERIALIZEDMETHOD_OFFSET UNITYSDK_OFFSET(0x1B6F82F0)
#define UNILABS_TIME_UTIMESPAN_ONSERIALIZINGMETHOD_OFFSET UNITYSDK_OFFSET(0x1B6F82B0)
#define UNILABS_TIME_UTIMESPAN_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B6F7FF0)
#define UNILABS_TIME_UTIMESPAN_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B6F7FD0)
#define UNILABS_TIME_UTIMESPAN_SET_TIMESPAN_OFFSET UNITYSDK_OFFSET(0x1B6F7DC0)
#define UNILABS_TIME_UTIMESPAN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6F7DE0)
#define UNILABS_TIME_UTIMESPAN__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B6F7DF0)
#define UNILABS_TIME_UTIMESPAN__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B6F7E00)
#define UNILABS_TIME_UTIMESPAN__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B6F7E90)
#define UNILABS_TIME_UTIMESPAN__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1B6F7F30)
#define UNILABS_TIME_UTIMESPAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F7DD0)

namespace UniLabs::Time
{
	inline static constexpr unsigned int UTimeSpan_TypeDefinitionIndex = 84100;
