...
#define UNILABS_TIME_UTIMESPAN_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x1B0E7400)
#define UNILABS_TIME_UTIMESPAN_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1B0E73E0)
#define UNILABS_TIME_UTIMESPAN_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B0E7460)
#define UNILABS_TIME_UTIMESPAN_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B0E7440)
#define UNILABS_TIME_UTIMESPAN_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B0E7500)
#define UNILABS_TIME_UTIMESPAN_GET_TIMESPAN_OFFSET UNITYSDK_OFFSET(0x1B0E7160)
#define UNILABS_TIME_UTIMESPAN_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0E7510)
#define UNILABS_TIME_UTIMESPAN_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0E7620)
#define UNILABS_TIME_UTIMESPAN_ONDESERIALIZEDMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0E76A0)
#define UNILABS_TIME_UTIMESPAN_ONSERIALIZINGMETHOD_OFFSET UNITYSDK_OFFSET(0x1B0E7660)
#define UNILABS_TIME_UTIMESPAN_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B0E73A0)
#define UNILABS_TIME_UTIMESPAN_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B0E7380)
#define UNILABS_TIME_UTIMESPAN_SET_TIMESPAN_OFFSET UNITYSDK_OFFSET(0x1B0E7170)
#define UNILABS_TIME_UTIMESPAN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0E7190)
#define UNILABS_TIME_UTIMESPAN__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B0E71A0)
#define UNILABS_TIME_UTIMESPAN__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B0E71B0)
#define UNILABS_TIME_UTIMESPAN__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B0E7240)
#define UNILABS_TIME_UTIMESPAN__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1B0E72E0)
#define UNILABS_TIME_UTIMESPAN__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E7180)

namespace UniLabs::Time
{
	inline static constexpr unsigned int UTimeSpan_TypeDefinitionIndex = 82059;
