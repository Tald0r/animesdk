...
#define UNILABS_TIME_UDATETIME_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x1B0E6E20)
#define UNILABS_TIME_UDATETIME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1B0E6DF0)
#define UNILABS_TIME_UDATETIME_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B0E6E90)
#define UNILABS_TIME_UDATETIME_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B0E6E60)
#define UNILABS_TIME_UDATETIME_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B0E6F40)
#define UNILABS_TIME_UDATETIME_GET_DATETIME_OFFSET UNITYSDK_OFFSET(0x1B0E6D50)
#define UNILABS_TIME_UDATETIME_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0E6FC0)
#define UNILABS_TIME_UDATETIME_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0E7020)
#define UNILABS_TIME_UDATETIME_ONDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x1B0E7100)
#define UNILABS_TIME_UDATETIME_ONSERIALIZING_OFFSET UNITYSDK_OFFSET(0x1B0E7090)
#define UNILABS_TIME_UDATETIME_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B0E6DB0)
#define UNILABS_TIME_UDATETIME_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B0E6D90)
#define UNILABS_TIME_UDATETIME_SET_DATETIME_OFFSET UNITYSDK_OFFSET(0x1B0E6D60)
#define UNILABS_TIME_UDATETIME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B0E6F60)
#define UNILABS_TIME_UDATETIME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0E6D80)
#define UNILABS_TIME_UDATETIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E6D70)

namespace UniLabs::Time
{
	inline static constexpr unsigned int UDateTime_TypeDefinitionIndex = 82058;
