...
#define UNILABS_TIME_UDATETIME_COMPARETO_1_OFFSET UNITYSDK_OFFSET(0x1B6F7A70)
#define UNILABS_TIME_UDATETIME_COMPARETO_OFFSET UNITYSDK_OFFSET(0x1B6F7A40)
#define UNILABS_TIME_UDATETIME_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x1B6F7AE0)
#define UNILABS_TIME_UDATETIME_EQUALS_OFFSET UNITYSDK_OFFSET(0x1B6F7AB0)
#define UNILABS_TIME_UDATETIME_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1B6F7B90)
#define UNILABS_TIME_UDATETIME_GET_DATETIME_OFFSET UNITYSDK_OFFSET(0x1B6F79A0)
#define UNILABS_TIME_UDATETIME_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6F7C10)
#define UNILABS_TIME_UDATETIME_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B6F7C70)
#define UNILABS_TIME_UDATETIME_ONDESERIALIZED_OFFSET UNITYSDK_OFFSET(0x1B6F7D50)
#define UNILABS_TIME_UDATETIME_ONSERIALIZING_OFFSET UNITYSDK_OFFSET(0x1B6F7CE0)
#define UNILABS_TIME_UDATETIME_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B6F7A00)
#define UNILABS_TIME_UDATETIME_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B6F79E0)
#define UNILABS_TIME_UDATETIME_SET_DATETIME_OFFSET UNITYSDK_OFFSET(0x1B6F79B0)
#define UNILABS_TIME_UDATETIME_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B6F7BB0)
#define UNILABS_TIME_UDATETIME__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B6F79D0)
#define UNILABS_TIME_UDATETIME__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F79C0)

namespace UniLabs::Time
{
	inline static constexpr unsigned int UDateTime_TypeDefinitionIndex = 84099;
