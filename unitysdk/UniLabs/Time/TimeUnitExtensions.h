...
#define UNILABS_TIME_TIMEUNITEXTENSIONS_FROMSINGLEUNITVALUE_OFFSET UNITYSDK_OFFSET(0x1B6F6B80)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETHIGHESTUNITVALUE_OFFSET UNITYSDK_OFFSET(0x1B6F6040)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETLOWESTUNITVALUE_OFFSET UNITYSDK_OFFSET(0x1B6F5690)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETSINGLEUNITVALUE_OFFSET UNITYSDK_OFFSET(0x1B6F6A50)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUE_OFFSET UNITYSDK_OFFSET(0x1B6F5230)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_SNAPTOUNIT_OFFSET UNITYSDK_OFFSET(0x1B6F6C80)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_TOSEPARATORSTRING_OFFSET UNITYSDK_OFFSET(0x1B6F51A0)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_TOSHORTSTRING_OFFSET UNITYSDK_OFFSET(0x1B6F5110)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHHIGHESTUNITVALUE_OFFSET UNITYSDK_OFFSET(0x1B6F6500)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHLOWESTUNITVALUE_OFFSET UNITYSDK_OFFSET(0x1B6F5AC0)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUE_OFFSET UNITYSDK_OFFSET(0x1B6F5410)

namespace UniLabs::Time
{
	inline static constexpr unsigned int TimeUnitExtensions_TypeDefinitionIndex = 84096;
