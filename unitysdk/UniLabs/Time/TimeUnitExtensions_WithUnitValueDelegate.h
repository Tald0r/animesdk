...
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6F78C0)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6F7970)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6F7530)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_WITHUNITVALUEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F7510)

namespace UniLabs::Time
{
	inline static constexpr unsigned int TimeUnitExtensions_WithUnitValueDelegate_TypeDefinitionIndex = 84097;
