...
#define UNILABS_TIME_TIMESPANDRAWERSETTINGSATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B0E4480)
#define UNILABS_TIME_TIMESPANDRAWERSETTINGSATTRIBUTE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B0E4490)
#define UNILABS_TIME_TIMESPANDRAWERSETTINGSATTRIBUTE__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B0E44B0)
#define UNILABS_TIME_TIMESPANDRAWERSETTINGSATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E4470)

namespace UniLabs::Time
{
	inline static constexpr unsigned int TimeSpanDrawerSettingsAttribute_TypeDefinitionIndex = 82052;
