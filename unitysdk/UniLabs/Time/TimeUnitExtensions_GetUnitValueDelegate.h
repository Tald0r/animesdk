...
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B6F7450)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B6F74E0)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B6F70F0)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6F70D0)

namespace UniLabs::Time
{
	inline static constexpr unsigned int TimeUnitExtensions_GetUnitValueDelegate_TypeDefinitionIndex = 84098;
