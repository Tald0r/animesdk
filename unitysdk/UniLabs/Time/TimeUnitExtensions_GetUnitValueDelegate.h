...
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0E6810)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0E68A0)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0E64D0)
#define UNILABS_TIME_TIMEUNITEXTENSIONS_GETUNITVALUEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0E64C0)

namespace UniLabs::Time
{
	inline static constexpr unsigned int TimeUnitExtensions_GetUnitValueDelegate_TypeDefinitionIndex = 82057;
