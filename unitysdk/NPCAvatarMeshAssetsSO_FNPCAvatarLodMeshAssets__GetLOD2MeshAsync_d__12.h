...
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS__GETLOD2MESHASYNC_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x37A200)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS__GETLOD2MESHASYNC_D__12_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

inline static constexpr unsigned int NPCAvatarMeshAssetsSO_FNPCAvatarLodMeshAssets__GetLOD2MeshAsync_d__12_TypeDefinitionIndex = 62316;
