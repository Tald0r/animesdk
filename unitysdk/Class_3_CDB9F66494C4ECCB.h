...
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_0FD0EC313FAAB75A_OFFSET UNITYSDK_OFFSET(0x6A99860)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_4307B2A4B4A12C1A_OFFSET UNITYSDK_OFFSET(0x6A99AC0)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_4343F372F34C05BF_OFFSET UNITYSDK_OFFSET(0x6A99C10)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_4D2A473556700CDC_OFFSET UNITYSDK_OFFSET(0x6A99CB0)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_77EA5BCD93BD96AE_OFFSET UNITYSDK_OFFSET(0x6A9A2B0)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_866057E5772343C9_1_OFFSET UNITYSDK_OFFSET(0x6A9AC60)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_866057E5772343C9_OFFSET UNITYSDK_OFFSET(0x6A9A880)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_9C3D8ED2211D368B_OFFSET UNITYSDK_OFFSET(0x6A9A570)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_B387E1AED8A8F880_OFFSET UNITYSDK_OFFSET(0x6A9A370)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_BCC1EE49EAAACF06_OFFSET UNITYSDK_OFFSET(0x6A9AE10)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x6A9AB40)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_CA373AA1C7054598_2_OFFSET UNITYSDK_OFFSET(0x6A9ABA0)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_CA373AA1C7054598_3_OFFSET UNITYSDK_OFFSET(0x6A9AC00)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_CA373AA1C7054598_4_OFFSET UNITYSDK_OFFSET(0x6A9AD50)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_CA373AA1C7054598_5_OFFSET UNITYSDK_OFFSET(0x6A9ADB0)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x6A9AA40)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_DB4B43E60DCCA4C1_OFFSET UNITYSDK_OFFSET(0x6A9AAA0)
#define CLASS_3_CDB9F66494C4ECCB_METHOD_3_DF36652FF6AEAAC1_OFFSET UNITYSDK_OFFSET(0x6A9A970)
#define CLASS_3_CDB9F66494C4ECCB__CCTOR_OFFSET UNITYSDK_OFFSET(0x6A9A840)
#define CLASS_3_CDB9F66494C4ECCB__CTOR_OFFSET UNITYSDK_OFFSET(0x6A9A640)

inline static constexpr unsigned int Class_3_CDB9F66494C4ECCB_TypeDefinitionIndex = 66985;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Class_3_CDB9F66494C4ECCB_TypeDefinitionIndex)->GetStaticField(0x42940);
	}
	::System::Collections::Generic::List_1<::MoleMole::TurnBattleUnitBase*>* Field_3_3; // 0x70
	::Class_4_3D4EFA6B3CC691CC* Field_3_6; // 0x78
	::System::Collections::Generic::List_1<::Struct_2_3C85541F28E72E6B>* Field_3_5; // 0x80
	::Cysharp::Threading::Tasks::UniTask Field_3_8; // 0x88
	::System::Collections::Generic::List_1<::Cysharp::Threading::Tasks::UniTask>* Field_3_9; // 0x98
	::System::Collections::Generic::List_1<::Struct_2_3C85541F28E72E6B>* Field_3_4; // 0xA0
	::System::Threading::CancellationTokenSource* Field_3_7; // 0xA8
	...
	::Class_2_04999CCE6E77B4A2_14* Field_3_1; // 0xB8
	::System::Collections::Generic::List_1<::MoleMole::TurnBattleUnitBase*>* Field_3_2; // 0xC0
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_3_CDB9F66494C4ECCB_METHOD_3_B387E1AED8A8F880_OFFSET))(this);
	}
