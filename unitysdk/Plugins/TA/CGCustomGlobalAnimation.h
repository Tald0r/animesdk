...
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B16D8F0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_GETTIME_OFFSET UNITYSDK_OFFSET(0x1B16D8C0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B16DA00)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B16DA10)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B16E100)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_PLAYWITHTIME_OFFSET UNITYSDK_OFFSET(0x1B16DAA0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_REFRESH_OFFSET UNITYSDK_OFFSET(0x1B16D9E0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_START_OFFSET UNITYSDK_OFFSET(0x1B16D9F0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_STOP_OFFSET UNITYSDK_OFFSET(0x1B16D9D0)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B16DA20)
#define PLUGINS_TA_CGCUSTOMGLOBALANIMATION__CTOR_OFFSET UNITYSDK_OFFSET(0x1B16E110)

namespace Plugins::TA
{
	inline static constexpr unsigned int CGCustomGlobalAnimation_TypeDefinitionIndex = 35905;
