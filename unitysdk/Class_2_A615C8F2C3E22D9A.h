...
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_08A500CCFA7B1882_OFFSET UNITYSDK_OFFSET(0x87D7310)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_0A0296D150EB9DA4_OFFSET UNITYSDK_OFFSET(0x87D6EC0)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_2685B6183E614529_OFFSET UNITYSDK_OFFSET(0x87D7230)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_51D68607B7E96876_OFFSET UNITYSDK_OFFSET(0x87D7060)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_60069FCD99486CD7_OFFSET UNITYSDK_OFFSET(0x87D7160)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_610DB96480511960_OFFSET UNITYSDK_OFFSET(0x87D6F50)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_655EB97F58032004_OFFSET UNITYSDK_OFFSET(0x87D67F0)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_6FC489C2F3EDE0B8_OFFSET UNITYSDK_OFFSET(0x87D6500)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_96F6E9EA89A38FD1_OFFSET UNITYSDK_OFFSET(0x87D6740)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_A572622C7508F2B4_OFFSET UNITYSDK_OFFSET(0x87D6390)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_AB4AABC1733EB727_OFFSET UNITYSDK_OFFSET(0x87D72A0)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x87D71D0)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x87D66C0)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_D37FAD0A6AA04B25_1_OFFSET UNITYSDK_OFFSET(0x87D7030)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_D37FAD0A6AA04B25_OFFSET UNITYSDK_OFFSET(0x87D6F20)
#define CLASS_2_A615C8F2C3E22D9A_METHOD_2_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x87D7020)
#define CLASS_2_A615C8F2C3E22D9A__CTOR_OFFSET UNITYSDK_OFFSET(0x87D7050)

inline static constexpr unsigned int Class_2_A615C8F2C3E22D9A_TypeDefinitionIndex = 53808;

class Class_2_A615C8F2C3E22D9A : public ::Class_1_955D79091BFF8D4F
{
public:
	::MoleMole::Config::ConfigPosRot* Field_2_0; // 0x50
	::MoleMole::Battle::Entity* Field_2_1; // 0x58
	::MoleMole::Battle::Entity* Field_2_4; // 0x60
