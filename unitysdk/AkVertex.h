...
#define AKVERTEX_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B4299C0)
#define AKVERTEX_CLONE_OFFSET UNITYSDK_OFFSET(0x1B4299E0)
#define AKVERTEX_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1B4299D0)
#define AKVERTEX_GET_X_OFFSET UNITYSDK_OFFSET(0x1B429910)
#define AKVERTEX_GET_Y_OFFSET UNITYSDK_OFFSET(0x1B429930)
#define AKVERTEX_GET_Z_OFFSET UNITYSDK_OFFSET(0x1B429950)
#define AKVERTEX_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B429960)
#define AKVERTEX_SET_X_OFFSET UNITYSDK_OFFSET(0x1B429900)
#define AKVERTEX_SET_Y_OFFSET UNITYSDK_OFFSET(0x1B429920)
#define AKVERTEX_SET_Z_OFFSET UNITYSDK_OFFSET(0x1B429940)
#define AKVERTEX_ZERO_OFFSET UNITYSDK_OFFSET(0x1B4298F0)
#define AKVERTEX__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B4299B0)
#define AKVERTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x1B429990)

inline static constexpr unsigned int AkVertex_TypeDefinitionIndex = 30999;
