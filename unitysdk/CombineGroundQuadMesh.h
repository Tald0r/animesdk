...
#define COMBINEGROUNDQUADMESH__CTOR_OFFSET UNITYSDK_OFFSET(0x1965CCE0)

inline static constexpr unsigned int CombineGroundQuadMesh_TypeDefinitionIndex = 29116;
