...
#define AKANDROIDSETTINGS_PLATFORMADVANCEDSETTINGS_COPYTO_OFFSET UNITYSDK_OFFSET(0x1B37E180)
#define AKANDROIDSETTINGS_PLATFORMADVANCEDSETTINGS_GETANDROIDSDKVERSION_OFFSET UNITYSDK_OFFSET(0x1B37E160)
#define AKANDROIDSETTINGS_PLATFORMADVANCEDSETTINGS_ISCURRENTAPILEVELSUPPPORTAAUDIO_OFFSET UNITYSDK_OFFSET(0x1B37E170)
#define AKANDROIDSETTINGS_PLATFORMADVANCEDSETTINGS_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1B37DF20)
#define AKANDROIDSETTINGS_PLATFORMADVANCEDSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B37E190)

inline static constexpr unsigned int AkAndroidSettings_PlatformAdvancedSettings_TypeDefinitionIndex = 30954;
