...
#include "unitysdk/Class_1_3C7A2C6347C7498B_Enum_3_33B16E3E02BB0BB4_7.h"
...
#define CLASS_1_3C7A2C6347C7498B_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8D87460)
#define CLASS_1_3C7A2C6347C7498B_METHOD_1_09617CFF56041188_OFFSET UNITYSDK_OFFSET(0x8D879D0)
#define CLASS_1_3C7A2C6347C7498B_METHOD_1_0CACC767E855DBAE_OFFSET UNITYSDK_OFFSET(0x8D87CB0)
#define CLASS_1_3C7A2C6347C7498B_METHOD_1_4E84FD21E7EECC5B_OFFSET UNITYSDK_OFFSET(0x8D888C0)
#define CLASS_1_3C7A2C6347C7498B_METHOD_1_4EB3BA381499DA66_OFFSET UNITYSDK_OFFSET(0x8D88BA0)
#define CLASS_1_3C7A2C6347C7498B_METHOD_1_6775604F93DD7110_OFFSET UNITYSDK_OFFSET(0x8D88B10)
#define CLASS_1_3C7A2C6347C7498B_METHOD_1_6FB1B50B8A21D7AD_OFFSET UNITYSDK_OFFSET(0x8D873B0)
#define CLASS_1_3C7A2C6347C7498B_METHOD_1_700D287A85A1E345_OFFSET UNITYSDK_OFFSET(0x8D88A00)
#define CLASS_1_3C7A2C6347C7498B_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x8D88B00)
#define CLASS_1_3C7A2C6347C7498B_METHOD_1_F84739A7625D643A_OFFSET UNITYSDK_OFFSET(0x8D87530)
#define CLASS_1_3C7A2C6347C7498B__CTOR_OFFSET UNITYSDK_OFFSET(0x8D87240)

inline static constexpr unsigned int Class_1_3C7A2C6347C7498B_TypeDefinitionIndex = 57483;
...
public:
	...
	::MoleMole::Utils::TaskBasedEventCollection_1<::Class_1_3C7A2C6347C7498B_Enum_3_33B16E3E02BB0BB4_7>* Field_1_0; // 0x18
	::Struct_2_EBB8F49C837ECBC8 Field_1_1; // 0x20
	::MoleMole::Cameras::FirstPersonCameraDefaultSetting Field_1_4; // 0xA0
	::System::Single Field_1_5; // 0xA8
	::System::Boolean Field_1_2; // 0xAC
	::System::Nullable_1<::Foundation::Unreal::Interval_1<::System::Single>> Field_1_6; // 0xB0
	...
	::PipelineCamera::ScopedDelegateHandle Method_1_F84739A7625D643A(::MoleMole::Battle::Entity* a1, ::MoleMole::Cameras::FirstPersonCameraConfig*& a2)
	{
		return ((::PipelineCamera::ScopedDelegateHandle(*)(::PVOID, ::MoleMole::Battle::Entity*, ::MoleMole::Cameras::FirstPersonCameraConfig*&))((::PBYTE)hIl2Cpp + CLASS_1_3C7A2C6347C7498B_METHOD_1_F84739A7625D643A_OFFSET))(this, a1, a2);
	}
