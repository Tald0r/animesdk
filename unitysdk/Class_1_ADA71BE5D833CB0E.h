...
#define CLASS_1_ADA71BE5D833CB0E__CTOR_OFFSET UNITYSDK_OFFSET(0xAE67D00)

inline static constexpr unsigned int Class_1_ADA71BE5D833CB0E_TypeDefinitionIndex = 66889;
...
public:
	...
	::Enum_3_BEDB7A8B7ABCB952 Field_1_2; // 0x2C
