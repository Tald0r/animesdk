...
#define NAPLODCONTROLLER_APPLYLODLEVELIMPL_OFFSET UNITYSDK_OFFSET(0x9BD7340)
#define NAPLODCONTROLLER_APPLYLODLEVEL_OFFSET UNITYSDK_OFFSET(0x9BD6A50)
#define NAPLODCONTROLLER_APPLY_OFFSET UNITYSDK_OFFSET(0x9BD6D90)
#define NAPLODCONTROLLER_AWAKE_OFFSET UNITYSDK_OFFSET(0x9BD8040)
#define NAPLODCONTROLLER_CLEANUP_OFFSET UNITYSDK_OFFSET(0x9BD88B0)
#define NAPLODCONTROLLER_GETMESHFILTER_OFFSET UNITYSDK_OFFSET(0x9BD6B90)
#define NAPLODCONTROLLER_GETMESH_OFFSET UNITYSDK_OFFSET(0x9BD6BF0)
#define NAPLODCONTROLLER_GETRENDER_OFFSET UNITYSDK_OFFSET(0x9BD8AB0)
#define NAPLODCONTROLLER_GET_LODBASE_OFFSET UNITYSDK_OFFSET(0x9BD69C0)
#define NAPLODCONTROLLER_GET_LODLEVEL_OFFSET UNITYSDK_OFFSET(0x9BD69B0)
#define NAPLODCONTROLLER_GET_LODOFFSET_OFFSET UNITYSDK_OFFSET(0x9BD6AF0)
#define NAPLODCONTROLLER_LOADLODMESHASYNC_OFFSET UNITYSDK_OFFSET(0x9BD7060)
#define NAPLODCONTROLLER_NAPLODMESHSTREAMINGDEBUGLOG_OFFSET UNITYSDK_OFFSET(0x9BD8C20)
#define NAPLODCONTROLLER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9BD8840)
#define NAPLODCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x9BD87A0)
#define NAPLODCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x9BD8120)
#define NAPLODCONTROLLER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x9BD8A40)
#define NAPLODCONTROLLER_OVERRIDELODLEVELBYGAMEPLAY_OFFSET UNITYSDK_OFFSET(0x9BD7B60)
#define NAPLODCONTROLLER_RECOVERLODLEVEL_OFFSET UNITYSDK_OFFSET(0x9BD7EA0)
#define NAPLODCONTROLLER_RELEASELODMESH_OFFSET UNITYSDK_OFFSET(0x9BD7630)
#define NAPLODCONTROLLER_SET_LODBASE_OFFSET UNITYSDK_OFFSET(0x9BD69D0)
#define NAPLODCONTROLLER_SET_LODOFFSET_OFFSET UNITYSDK_OFFSET(0x9BD6B00)
#define NAPLODCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x9BD8DF0)

inline static constexpr unsigned int NapLodController_TypeDefinitionIndex = 37104;
