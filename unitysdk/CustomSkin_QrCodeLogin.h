...
#define CUSTOMSKIN_QRCODELOGIN_GENQRENTERICON_OFFSET UNITYSDK_OFFSET(0x7154DE0)
#define CUSTOMSKIN_QRCODELOGIN_INITDYNAMICSHOWELEMENTS_OFFSET UNITYSDK_OFFSET(0x7154480)
#define CUSTOMSKIN_QRCODELOGIN_INITPERSISTENCHECK_OFFSET UNITYSDK_OFFSET(0x7155000)
#define CUSTOMSKIN_QRCODELOGIN_INIT_OFFSET UNITYSDK_OFFSET(0x71533B0)
#define CUSTOMSKIN_QRCODELOGIN_INSTANCE_OFFSET UNITYSDK_OFFSET(0x7152FD0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKCLOSE_OFFSET UNITYSDK_OFFSET(0x71552A0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKFAILREFRESH_OFFSET UNITYSDK_OFFSET(0x7155AE0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKOVERDUEREFRESH_OFFSET UNITYSDK_OFFSET(0x71559A0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKPC_OFFSET UNITYSDK_OFFSET(0x7155340)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKPERSISTENCHECK_OFFSET UNITYSDK_OFFSET(0x71553E0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKSUCCESSSWITCH_OFFSET UNITYSDK_OFFSET(0x7155A40)
#define CUSTOMSKIN_QRCODELOGIN_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x71538A0)
#define CUSTOMSKIN_QRCODELOGIN_ONELEMENTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x7154360)
#define CUSTOMSKIN_QRCODELOGIN_ONENTERPCSWITCH_OFFSET UNITYSDK_OFFSET(0x71555E0)
#define CUSTOMSKIN_QRCODELOGIN_ONEXITPCSWITCH_OFFSET UNITYSDK_OFFSET(0x71556E0)
#define CUSTOMSKIN_QRCODELOGIN_ONHIDEELEMENT_OFFSET UNITYSDK_OFFSET(0x7153DB0)
#define CUSTOMSKIN_QRCODELOGIN_ONSHOWELEMENT_OFFSET UNITYSDK_OFFSET(0x7153A00)
#define CUSTOMSKIN_QRCODELOGIN_ONSHOW_OFFSET UNITYSDK_OFFSET(0x7153180)
#define CUSTOMSKIN_QRCODELOGIN_REFRESHBTNSTATE_OFFSET UNITYSDK_OFFSET(0x7153E30)
#define CUSTOMSKIN_QRCODELOGIN_SHOWELEMENT_OFFSET UNITYSDK_OFFSET(0x7153A80)
#define CUSTOMSKIN_QRCODELOGIN_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x7155760)
#define CUSTOMSKIN_QRCODELOGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x7153100)
#define CUSTOMSKIN_QRCODELOGIN___BASE_ONELEMENTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x7155B80)
#define CUSTOMSKIN_QRCODELOGIN___BASE_ONHIDEELEMENT_OFFSET UNITYSDK_OFFSET(0x7155B90)
#define CUSTOMSKIN_QRCODELOGIN___BASE_ONSHOWELEMENT_OFFSET UNITYSDK_OFFSET(0x7155BA0)

inline static constexpr unsigned int CustomSkin_QrCodeLogin_TypeDefinitionIndex = 73490;
...
public:
	...
	{
		return (::CustomSkin_QrCodeLogin**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_QrCodeLogin_TypeDefinitionIndex)->GetStaticField(0x29380);
	}
	::System::Collections::Generic::Dictionary_2<::System::String*, ::UnityEngine::GameObject*>* dynamicElementDict; // 0x18
	::MoleMole::UIGeneralLoginQRCodeDialogPopWindowController* _qrDialog; // 0x20
	::System::Collections::Generic::Dictionary_2<::System::String*, ::QREnterIcon>* enterIconDict; // 0x28
	::Class_2_79AE422BA06F6D26_197* _view; // 0x30
	...
	::QREnterIcon GenQREnterIcon(::System::String* elementName, ::Class_2_79AE422BA06F6D26_197_Class_2_FCBF41D0BBD215F7* appIconView, ::System::Boolean created, ::System::String* tipTextKey)
	{
		return ((::QREnterIcon(*)(::PVOID, ::System::String*, ::Class_2_79AE422BA06F6D26_197_Class_2_FCBF41D0BBD215F7*, ::System::Boolean, ::System::String*))((::PBYTE)hIl2Cpp + CUSTOMSKIN_QRCODELOGIN_GENQRENTERICON_OFFSET))(this, elementName, appIconView, created, tipTextKey);
	}
