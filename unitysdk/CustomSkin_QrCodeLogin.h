...
#define CUSTOMSKIN_QRCODELOGIN_GENQRENTERICON_OFFSET UNITYSDK_OFFSET(0x73E52F0)
#define CUSTOMSKIN_QRCODELOGIN_INITDYNAMICSHOWELEMENTS_OFFSET UNITYSDK_OFFSET(0x73E4990)
#define CUSTOMSKIN_QRCODELOGIN_INITPERSISTENCHECK_OFFSET UNITYSDK_OFFSET(0x73E5510)
#define CUSTOMSKIN_QRCODELOGIN_INIT_OFFSET UNITYSDK_OFFSET(0x73E38F0)
#define CUSTOMSKIN_QRCODELOGIN_INSTANCE_OFFSET UNITYSDK_OFFSET(0x73E3510)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKCLOSE_OFFSET UNITYSDK_OFFSET(0x73E57B0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKFAILREFRESH_OFFSET UNITYSDK_OFFSET(0x73E6000)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKOVERDUEREFRESH_OFFSET UNITYSDK_OFFSET(0x73E5EC0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKPC_OFFSET UNITYSDK_OFFSET(0x73E5850)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKPERSISTENCHECK_OFFSET UNITYSDK_OFFSET(0x73E58F0)
#define CUSTOMSKIN_QRCODELOGIN_ONCLICKSUCCESSSWITCH_OFFSET UNITYSDK_OFFSET(0x73E5F60)
#define CUSTOMSKIN_QRCODELOGIN_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x73E3DC0)
#define CUSTOMSKIN_QRCODELOGIN_ONELEMENTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x73E4870)
#define CUSTOMSKIN_QRCODELOGIN_ONENTERPCSWITCH_OFFSET UNITYSDK_OFFSET(0x73E5AF0)
#define CUSTOMSKIN_QRCODELOGIN_ONEXITPCSWITCH_OFFSET UNITYSDK_OFFSET(0x73E5C00)
#define CUSTOMSKIN_QRCODELOGIN_ONHIDEELEMENT_OFFSET UNITYSDK_OFFSET(0x73E42C0)
#define CUSTOMSKIN_QRCODELOGIN_ONSHOWELEMENT_OFFSET UNITYSDK_OFFSET(0x73E3F20)
#define CUSTOMSKIN_QRCODELOGIN_ONSHOW_OFFSET UNITYSDK_OFFSET(0x73E36C0)
#define CUSTOMSKIN_QRCODELOGIN_REFRESHBTNSTATE_OFFSET UNITYSDK_OFFSET(0x73E4340)
#define CUSTOMSKIN_QRCODELOGIN_SHOWELEMENT_OFFSET UNITYSDK_OFFSET(0x73E3FA0)
#define CUSTOMSKIN_QRCODELOGIN_UPDATETEXT_OFFSET UNITYSDK_OFFSET(0x73E5C80)
#define CUSTOMSKIN_QRCODELOGIN__CTOR_OFFSET UNITYSDK_OFFSET(0x73E3640)
#define CUSTOMSKIN_QRCODELOGIN___BASE_ONELEMENTSTATUSCHANGED_OFFSET UNITYSDK_OFFSET(0x73E60A0)
#define CUSTOMSKIN_QRCODELOGIN___BASE_ONHIDEELEMENT_OFFSET UNITYSDK_OFFSET(0x73E60B0)
#define CUSTOMSKIN_QRCODELOGIN___BASE_ONSHOWELEMENT_OFFSET UNITYSDK_OFFSET(0x73E60C0)

inline static constexpr unsigned int CustomSkin_QrCodeLogin_TypeDefinitionIndex = 41543;
...
public:
	...
	{
		return (::CustomSkin_QrCodeLogin**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_QrCodeLogin_TypeDefinitionIndex)->GetStaticField(0x2B020);
	}
	...
	::Class_2_79AE422BA06F6D26_52* _view; // 0x30
	...
	::QREnterIcon GenQREnterIcon(::System::String* elementName, ::Class_2_79AE422BA06F6D26_52_Class_2_FCBF41D0BBD215F7* appIconView, ::System::Boolean created, ::System::String* tipTextKey)
	{
		return ((::QREnterIcon(*)(::PVOID, ::System::String*, ::Class_2_79AE422BA06F6D26_52_Class_2_FCBF41D0BBD215F7*, ::System::Boolean, ::System::String*))((::PBYTE)hIl2Cpp + CUSTOMSKIN_QRCODELOGIN_GENQRENTERICON_OFFSET))(this, elementName, appIconView, created, tipTextKey);
	}
