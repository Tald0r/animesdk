...
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_ALIGNPARAMTYPE_OFFSET UNITYSDK_OFFSET(0x34CDD0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_ENABLEOVERINDEX_OFFSET UNITYSDK_OFFSET(0x5680D0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_FROMDATAINDEX_OFFSET UNITYSDK_OFFSET(0x5680B0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_HASANIM_OFFSET UNITYSDK_OFFSET(0x2F7C00)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_NOTINTERRUPTPRESCROLLIFCURNONEEDSCROLL_TEMPFOR1_0_OFFSET UNITYSDK_OFFSET(0x35D950)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_OVERRIDEALIGNPARAM_OFFSET UNITYSDK_OFFSET(0x2FC120)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_SCROLLDIRECTION_OFFSET UNITYSDK_OFFSET(0x2FD450)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_TARGETDATAINDEX_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_GET_TARGETRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_ALIGNPARAMTYPE_OFFSET UNITYSDK_OFFSET(0x34CE60)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_ENABLEOVERINDEX_OFFSET UNITYSDK_OFFSET(0x5680E0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_FROMDATAINDEX_OFFSET UNITYSDK_OFFSET(0x5680C0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_HASANIM_OFFSET UNITYSDK_OFFSET(0x2F7C90)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_NOTINTERRUPTPRESCROLLIFCURNONEEDSCROLL_TEMPFOR1_0_OFFSET UNITYSDK_OFFSET(0x35DA50)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_OVERRIDEALIGNPARAM_OFFSET UNITYSDK_OFFSET(0x2FC190)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_SCROLLDIRECTION_OFFSET UNITYSDK_OFFSET(0x35D7B0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_TARGETDATAINDEX_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_SET_TARGETRECTTRANSFORM_OFFSET UNITYSDK_OFFSET(0x2CB170)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_WITHALIGNPARAMTYPE_OFFSET UNITYSDK_OFFSET(0x568200)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_WITHENABLEOVERINDEX_OFFSET UNITYSDK_OFFSET(0x568490)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_WITHFROMDATAINDEX_OFFSET UNITYSDK_OFFSET(0x5683F0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_WITHNOTINTERRUPTPRESCROLLIFCURNONEEDSCROLL_TEMPFOR1_0_OFFSET UNITYSDK_OFFSET(0x568350)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_WITHOVERRIDEALIGNPARAM_OFFSET UNITYSDK_OFFSET(0x568150)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT_WITHSCROLLDIRECTION_OFFSET UNITYSDK_OFFSET(0x5682B0)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x568120)
#define MONOUITABLESCROLLV2_SCROLLTOTARGETCONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x5680F0)

inline static constexpr unsigned int MonoUITableScrollV2_ScrollToTargetContext_TypeDefinitionIndex = 43872;
