...
#define AKEVENT_CALLBACK_OFFSET UNITYSDK_OFFSET(0x1B6C5290)
#define AKEVENT_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x1B6C5670)
#define AKEVENT_GET_M_CALLBACKDATA_OFFSET UNITYSDK_OFFSET(0x1B6C57F0)
#define AKEVENT_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1B6C56C0)
#define AKEVENT_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1B6C51E0)
#define AKEVENT_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1B6C5340)
#define AKEVENT_START_OFFSET UNITYSDK_OFFSET(0x1B6C51F0)
#define AKEVENT_STOP_1_OFFSET UNITYSDK_OFFSET(0x1B6C5640)
#define AKEVENT_STOP_OFFSET UNITYSDK_OFFSET(0x1B6C5610)
#define AKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B6C5800)

inline static constexpr unsigned int AkEvent_TypeDefinitionIndex = 31064;
