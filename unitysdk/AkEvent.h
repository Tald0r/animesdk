...
#define AKEVENT_CALLBACK_OFFSET UNITYSDK_OFFSET(0x1B0BA6F0)
#define AKEVENT_GET_EVENTID_OFFSET UNITYSDK_OFFSET(0x1B0BAAD0)
#define AKEVENT_GET_M_CALLBACKDATA_OFFSET UNITYSDK_OFFSET(0x1B0BAC50)
#define AKEVENT_GET_VALUEGUID_OFFSET UNITYSDK_OFFSET(0x1B0BAB20)
#define AKEVENT_GET_WWISETYPE_OFFSET UNITYSDK_OFFSET(0x1B0BA640)
#define AKEVENT_HANDLEEVENT_OFFSET UNITYSDK_OFFSET(0x1B0BA7A0)
#define AKEVENT_START_OFFSET UNITYSDK_OFFSET(0x1B0BA650)
#define AKEVENT_STOP_1_OFFSET UNITYSDK_OFFSET(0x1B0BAAA0)
#define AKEVENT_STOP_OFFSET UNITYSDK_OFFSET(0x1B0BAA70)
#define AKEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0BAC60)

inline static constexpr unsigned int AkEvent_TypeDefinitionIndex = 30111;
