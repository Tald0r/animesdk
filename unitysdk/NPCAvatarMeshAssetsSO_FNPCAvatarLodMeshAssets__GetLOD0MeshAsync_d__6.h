...
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS__GETLOD0MESHASYNC_D__6_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x2C90F0)
#define NPCAVATARMESHASSETSSO_FNPCAVATARLODMESHASSETS__GETLOD0MESHASYNC_D__6_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

inline static constexpr unsigned int NPCAvatarMeshAssetsSO_FNPCAvatarLodMeshAssets__GetLOD0MeshAsync_d__6_TypeDefinitionIndex = 62317;
