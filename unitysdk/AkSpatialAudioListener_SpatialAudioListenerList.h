...
#define AKSPATIALAUDIOLISTENER_SPATIALAUDIOLISTENERLIST_ADD_OFFSET UNITYSDK_OFFSET(0x19590700)
#define AKSPATIALAUDIOLISTENER_SPATIALAUDIOLISTENERLIST_GET_LISTENERLIST_OFFSET UNITYSDK_OFFSET(0x195906F0)
#define AKSPATIALAUDIOLISTENER_SPATIALAUDIOLISTENERLIST_REFRESH_OFFSET UNITYSDK_OFFSET(0x19590810)
#define AKSPATIALAUDIOLISTENER_SPATIALAUDIOLISTENERLIST_REMOVE_OFFSET UNITYSDK_OFFSET(0x19590B60)
#define AKSPATIALAUDIOLISTENER_SPATIALAUDIOLISTENERLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x19590C30)

inline static constexpr unsigned int AkSpatialAudioListener_SpatialAudioListenerList_TypeDefinitionIndex = 30143;
