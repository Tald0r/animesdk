...
#define MB3_MESHBAKER_ADDDELETEGAMEOBJECTSBYID_OFFSET UNITYSDK_OFFSET(0x1A95A940)
#define MB3_MESHBAKER_ADDDELETEGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x1A95A850)
#define MB3_MESHBAKER_APPLYSHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1A95A820)
#define MB3_MESHBAKER_BUILDSCENEMESHOBJECT_OFFSET UNITYSDK_OFFSET(0x1A95A7D0)
#define MB3_MESHBAKER_GET_MESHCOMBINER_OFFSET UNITYSDK_OFFSET(0x1A95A7C0)
#define MB3_MESHBAKER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A95AA30)
#define MB3_MESHBAKER_PRINTTIMINGS_OFFSET UNITYSDK_OFFSET(0x1A959400)
#define MB3_MESHBAKER_SHOWHIDE_OFFSET UNITYSDK_OFFSET(0x1A95A800)
#define MB3_MESHBAKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A95AA50)

inline static constexpr unsigned int MB3_MeshBaker_TypeDefinitionIndex = 83237;
