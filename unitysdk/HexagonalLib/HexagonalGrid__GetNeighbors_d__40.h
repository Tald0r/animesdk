...
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__40_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A97C680)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__40_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_HEXAGONALLIB_COORDINATES_OFFSET__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A97CAF0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__40_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_HEXAGONALLIB_COORDINATES_OFFSET__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A97CA40)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__40_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A97CB80)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__40_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A97CAA0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__40_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A97CA50)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__40_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A97C510)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__40__CTOR_OFFSET UNITYSDK_OFFSET(0x1A97C4F0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__40___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1A97C5D0)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalGrid__GetNeighbors_d__40_TypeDefinitionIndex = 24861;
	...
	public:
		...
		::HexagonalLib::HexagonalGrid __3____4__this; // 0x28
		::HexagonalLib::Coordinates::Offset hex; // 0x34
		::System::Int32 __1__state; // 0x3C
		::HexagonalLib::Coordinates::Offset __3__hex; // 0x40
		::HexagonalLib::Coordinates::Offset __2__current; // 0x48
