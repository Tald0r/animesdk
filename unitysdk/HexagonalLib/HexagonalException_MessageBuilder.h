...
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_APPEND_1_OFFSET UNITYSDK_OFFSET(0x1A69F970)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_APPEND_2_OFFSET UNITYSDK_OFFSET(0x1A69F700)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_APPEND_3_OFFSET UNITYSDK_OFFSET(0x1A69FD40)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_APPEND_OFFSET UNITYSDK_OFFSET(0x1A69FC60)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A69F7E0)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A69FBE0)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A69FE30)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalException_MessageBuilder_TypeDefinitionIndex = 24953;
