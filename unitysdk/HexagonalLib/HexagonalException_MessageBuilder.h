...
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_APPEND_1_OFFSET UNITYSDK_OFFSET(0x1AD2AFD0)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_APPEND_2_OFFSET UNITYSDK_OFFSET(0x1AD2AD60)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_APPEND_3_OFFSET UNITYSDK_OFFSET(0x1AD2B3A0)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_APPEND_OFFSET UNITYSDK_OFFSET(0x1AD2B2C0)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AD2AE40)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD2B240)
#define HEXAGONALLIB_HEXAGONALEXCEPTION_MESSAGEBUILDER___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AD2B490)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalException_MessageBuilder_TypeDefinitionIndex = 25614;
