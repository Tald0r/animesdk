...
#define HEXAGONALLIB_COORDINATES_AXIAL_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x98F1C0)
#define HEXAGONALLIB_COORDINATES_AXIAL_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x98F240)
#define HEXAGONALLIB_COORDINATES_AXIAL_EQUALS_OFFSET UNITYSDK_OFFSET(0x98F1B0)
#define HEXAGONALLIB_COORDINATES_AXIAL_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0x98F3B0)
#define HEXAGONALLIB_COORDINATES_AXIAL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x98F310)
#define HEXAGONALLIB_COORDINATES_AXIAL_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1B1E0E80)
#define HEXAGONALLIB_COORDINATES_AXIAL_OP_ADDITION_1_OFFSET UNITYSDK_OFFSET(0x1B1E1010)
#define HEXAGONALLIB_COORDINATES_AXIAL_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1B1E0F80)
#define HEXAGONALLIB_COORDINATES_AXIAL_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B1E0EA0)
#define HEXAGONALLIB_COORDINATES_AXIAL_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B1E0F10)
#define HEXAGONALLIB_COORDINATES_AXIAL_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B1E11A0)
#define HEXAGONALLIB_COORDINATES_AXIAL_OP_SUBTRACTION_1_OFFSET UNITYSDK_OFFSET(0x1B1E1120)
#define HEXAGONALLIB_COORDINATES_AXIAL_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1B1E1090)
#define HEXAGONALLIB_COORDINATES_AXIAL_TOSTRING_OFFSET UNITYSDK_OFFSET(0x98F3C0)
#define HEXAGONALLIB_COORDINATES_AXIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3C30)
#define HEXAGONALLIB_COORDINATES_AXIAL___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x98F3D0)
#define HEXAGONALLIB_COORDINATES_AXIAL___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x98F430)
#define HEXAGONALLIB_COORDINATES_AXIAL___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x98F490)

namespace HexagonalLib::Coordinates
{
	inline static constexpr unsigned int Axial_TypeDefinitionIndex = 25927;
