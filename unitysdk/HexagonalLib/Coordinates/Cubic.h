...
#define HEXAGONALLIB_COORDINATES_CUBIC_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x96BDE0)
#define HEXAGONALLIB_COORDINATES_CUBIC_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x96BE70)
#define HEXAGONALLIB_COORDINATES_CUBIC_EQUALS_OFFSET UNITYSDK_OFFSET(0x96BDD0)
#define HEXAGONALLIB_COORDINATES_CUBIC_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0x96BF80)
#define HEXAGONALLIB_COORDINATES_CUBIC_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96BEB0)
#define HEXAGONALLIB_COORDINATES_CUBIC_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1AD29730)
#define HEXAGONALLIB_COORDINATES_CUBIC_ISVALID_OFFSET UNITYSDK_OFFSET(0x96BCA0)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_ADDITION_1_OFFSET UNITYSDK_OFFSET(0x1AD29BE0)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1AD29B20)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AD299D0)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AD29A80)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1AD29EB0)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1AD29E00)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_SUBTRACTION_1_OFFSET UNITYSDK_OFFSET(0x1AD29D50)
#define HEXAGONALLIB_COORDINATES_CUBIC_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1AD29C90)
#define HEXAGONALLIB_COORDINATES_CUBIC_ROTATETORIGHT_1_OFFSET UNITYSDK_OFFSET(0x96BDB0)
#define HEXAGONALLIB_COORDINATES_CUBIC_ROTATETORIGHT_OFFSET UNITYSDK_OFFSET(0x96BD10)
#define HEXAGONALLIB_COORDINATES_CUBIC_TOSTRING_OFFSET UNITYSDK_OFFSET(0x96BFB0)
#define HEXAGONALLIB_COORDINATES_CUBIC__CTOR_1_OFFSET UNITYSDK_OFFSET(0x96BC90)
#define HEXAGONALLIB_COORDINATES_CUBIC__CTOR_OFFSET UNITYSDK_OFFSET(0x37EE40)
#define HEXAGONALLIB_COORDINATES_CUBIC___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x96BFC0)
#define HEXAGONALLIB_COORDINATES_CUBIC___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96C030)
#define HEXAGONALLIB_COORDINATES_CUBIC___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x96C0A0)

namespace HexagonalLib::Coordinates
{
	inline static constexpr unsigned int Cubic_TypeDefinitionIndex = 25849;
