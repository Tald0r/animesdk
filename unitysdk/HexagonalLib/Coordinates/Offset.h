...
#define HEXAGONALLIB_COORDINATES_OFFSET_ADD_OFFSET UNITYSDK_OFFSET(0x95DEF0)
#define HEXAGONALLIB_COORDINATES_OFFSET_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x1AC03650)
#define HEXAGONALLIB_COORDINATES_OFFSET_CLAMP_OFFSET UNITYSDK_OFFSET(0x1AC034E0)
#define HEXAGONALLIB_COORDINATES_OFFSET_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x95DF80)
#define HEXAGONALLIB_COORDINATES_OFFSET_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x95E000)
#define HEXAGONALLIB_COORDINATES_OFFSET_EQUALS_OFFSET UNITYSDK_OFFSET(0x95DF70)
#define HEXAGONALLIB_COORDINATES_OFFSET_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0x95E170)
#define HEXAGONALLIB_COORDINATES_OFFSET_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x95E0D0)
#define HEXAGONALLIB_COORDINATES_OFFSET_GET_INVALID_OFFSET UNITYSDK_OFFSET(0x1AC033D0)
#define HEXAGONALLIB_COORDINATES_OFFSET_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x95DE70)
#define HEXAGONALLIB_COORDINATES_OFFSET_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1AC033B0)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_ADDITION_1_OFFSET UNITYSDK_OFFSET(0x1AC03840)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1AC037B0)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1AC03950)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AC036D0)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AC03740)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1AC039D0)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1AC038C0)
#define HEXAGONALLIB_COORDINATES_OFFSET_TOSTRING_OFFSET UNITYSDK_OFFSET(0x95E180)
#define HEXAGONALLIB_COORDINATES_OFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3730)
#define HEXAGONALLIB_COORDINATES_OFFSET___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x95E190)
#define HEXAGONALLIB_COORDINATES_OFFSET___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x95E1F0)
#define HEXAGONALLIB_COORDINATES_OFFSET___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x95E250)

namespace HexagonalLib::Coordinates
{
	inline static constexpr unsigned int Offset_TypeDefinitionIndex = 24894;
