...
#define HEXAGONALLIB_COORDINATES_OFFSET_ADD_OFFSET UNITYSDK_OFFSET(0x99D300)
#define HEXAGONALLIB_COORDINATES_OFFSET_CLAMP_1_OFFSET UNITYSDK_OFFSET(0x1B511E20)
#define HEXAGONALLIB_COORDINATES_OFFSET_CLAMP_OFFSET UNITYSDK_OFFSET(0x1B511CB0)
#define HEXAGONALLIB_COORDINATES_OFFSET_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x99D390)
#define HEXAGONALLIB_COORDINATES_OFFSET_EQUALS_2_OFFSET UNITYSDK_OFFSET(0x99D410)
#define HEXAGONALLIB_COORDINATES_OFFSET_EQUALS_OFFSET UNITYSDK_OFFSET(0x99D380)
#define HEXAGONALLIB_COORDINATES_OFFSET_GETHASHCODE_1_OFFSET UNITYSDK_OFFSET(0x99D580)
#define HEXAGONALLIB_COORDINATES_OFFSET_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x99D4E0)
#define HEXAGONALLIB_COORDINATES_OFFSET_GET_INVALID_OFFSET UNITYSDK_OFFSET(0x1B511BA0)
#define HEXAGONALLIB_COORDINATES_OFFSET_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x99D280)
#define HEXAGONALLIB_COORDINATES_OFFSET_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1B511B80)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_ADDITION_1_OFFSET UNITYSDK_OFFSET(0x1B512010)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1B511F80)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x1B512120)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B511EA0)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B511F10)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B5121A0)
#define HEXAGONALLIB_COORDINATES_OFFSET_OP_SUBTRACTION_OFFSET UNITYSDK_OFFSET(0x1B512090)
#define HEXAGONALLIB_COORDINATES_OFFSET_TOSTRING_OFFSET UNITYSDK_OFFSET(0x99D590)
#define HEXAGONALLIB_COORDINATES_OFFSET__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3C30)
#define HEXAGONALLIB_COORDINATES_OFFSET___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x99D5A0)
#define HEXAGONALLIB_COORDINATES_OFFSET___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x99D600)
#define HEXAGONALLIB_COORDINATES_OFFSET___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x99D660)

namespace HexagonalLib::Coordinates
{
	inline static constexpr unsigned int Offset_TypeDefinitionIndex = 25731;
