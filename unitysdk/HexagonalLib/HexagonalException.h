...
#define HEXAGONALLIB_HEXAGONALEXCEPTION_CREATEBUILDER_OFFSET UNITYSDK_OFFSET(0x1A69F520)
#define HEXAGONALLIB_HEXAGONALEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A69F410)
#define HEXAGONALLIB_HEXAGONALEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A69F850)
#define HEXAGONALLIB_HEXAGONALEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A69FAA0)
#define HEXAGONALLIB_HEXAGONALEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A69F3B0)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalException_TypeDefinitionIndex = 24952;
