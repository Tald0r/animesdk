...
#define HEXAGONALLIB_HEXAGONALEXCEPTION_CREATEBUILDER_OFFSET UNITYSDK_OFFSET(0x1AD2AB80)
#define HEXAGONALLIB_HEXAGONALEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD2AA70)
#define HEXAGONALLIB_HEXAGONALEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AD2AEB0)
#define HEXAGONALLIB_HEXAGONALEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AD2B100)
#define HEXAGONALLIB_HEXAGONALEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD2AA10)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalException_TypeDefinitionIndex = 25613;
