...
#define HEXAGONALLIB_HEXAGONALMATH_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1B1BA010)
#define HEXAGONALLIB_HEXAGONALMATH_ROTATE_OFFSET UNITYSDK_OFFSET(0x1B1B9EE0)
#define HEXAGONALLIB_HEXAGONALMATH_SIMILARTO_1_OFFSET UNITYSDK_OFFSET(0x1B1BA1C0)
#define HEXAGONALLIB_HEXAGONALMATH_SIMILARTO_OFFSET UNITYSDK_OFFSET(0x1B1BA0D0)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalMath_TypeDefinitionIndex = 25937;
