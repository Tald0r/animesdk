...
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__42_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B09FEC0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__42_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_HEXAGONALLIB_COORDINATES_CUBIC__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B0A0230)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__42_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_HEXAGONALLIB_COORDINATES_CUBIC__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B0A0170)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__42_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B0A02C0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B0A01E0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B0A0190)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__42_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B09FE90)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__42__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09FE70)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__42___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B09FEB0)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalGrid__GetNeighbors_d__42_TypeDefinitionIndex = 25746;
	...
	public:
		...
		::HexagonalLib::Coordinates::Cubic hex; // 0x30
		::System::Int32 __l__initialThreadId; // 0x3C
		::HexagonalLib::HexagonalGrid __3____4__this; // 0x40
		::System::Int32 __1__state; // 0x4C
		::HexagonalLib::Coordinates::Cubic __3__hex; // 0x50
		::HexagonalLib::HexagonalGrid __4__this; // 0x5C
		::HexagonalLib::Coordinates::Cubic __2__current; // 0x68
