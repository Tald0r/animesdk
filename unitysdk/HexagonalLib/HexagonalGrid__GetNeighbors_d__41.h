...
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A97CC60)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_HEXAGONALLIB_COORDINATES_AXIAL__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A97CF80)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_HEXAGONALLIB_COORDINATES_AXIAL__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A97CED0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A97D010)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A97CF30)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A97CEE0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A97CC30)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41__CTOR_OFFSET UNITYSDK_OFFSET(0x1A97CC10)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1A97CC50)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalGrid__GetNeighbors_d__41_TypeDefinitionIndex = 24860;
	...
	public:
		...
		::HexagonalLib::Coordinates::Axial __2__current; // 0x34
