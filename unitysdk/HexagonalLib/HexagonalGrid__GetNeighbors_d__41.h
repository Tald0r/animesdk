...
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B09FA30)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_HEXAGONALLIB_COORDINATES_AXIAL__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B09FD50)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_HEXAGONALLIB_COORDINATES_AXIAL__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B09FCA0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B09FDE0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B09FD00)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B09FCB0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B09FA00)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41__CTOR_OFFSET UNITYSDK_OFFSET(0x1B09F9E0)
#define HEXAGONALLIB_HEXAGONALGRID__GETNEIGHBORS_D__41___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B09FA20)

namespace HexagonalLib
{
	inline static constexpr unsigned int HexagonalGrid__GetNeighbors_d__41_TypeDefinitionIndex = 25749;
	...
	public:
		...
		::HexagonalLib::Coordinates::Axial __2__current; // 0x48
		::HexagonalLib::Coordinates::Axial hex; // 0x50
		::HexagonalLib::Coordinates::Axial __3__hex; // 0x58
