...
#define SCROLLCIRCLE_AWAKE_OFFSET UNITYSDK_OFFSET(0xC4CE920)
#define SCROLLCIRCLE_FIXCONTENTPOS_OFFSET UNITYSDK_OFFSET(0xC4CEB20)
#define SCROLLCIRCLE_ONBEGINDRAG_OFFSET UNITYSDK_OFFSET(0xC4CED30)
#define SCROLLCIRCLE_ONDRAG_OFFSET UNITYSDK_OFFSET(0xC4CEAB0)
#define SCROLLCIRCLE_ONENDDRAG_OFFSET UNITYSDK_OFFSET(0xC4CEDA0)
#define SCROLLCIRCLE_ONPOINTERDOWN_OFFSET UNITYSDK_OFFSET(0xC4CEE30)
#define SCROLLCIRCLE_ONPOINTERUP_OFFSET UNITYSDK_OFFSET(0xC4CEEA0)
#define SCROLLCIRCLE__CTOR_OFFSET UNITYSDK_OFFSET(0xC4CEF30)
#define SCROLLCIRCLE___BASE_AWAKE_OFFSET UNITYSDK_OFFSET(0xC4CEF50)

inline static constexpr unsigned int ScrollCircle_TypeDefinitionIndex = 54019;
