...
#define HDIFFPATCH_HDIFFFILE_OFFSET UNITYSDK_OFFSET(0x1B154D80)
#define HDIFFPATCH_HDIFF_CMD_LINE_OFFSET UNITYSDK_OFFSET(0x1B154730)
#define HDIFFPATCH_HPATCHFILE_OFFSET UNITYSDK_OFFSET(0x1B154D10)
#define HDIFFPATCH_HPATCH_CMD_LINE_OFFSET UNITYSDK_OFFSET(0x1B1545F0)
#define HDIFFPATCH_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B154560)
#define HDIFFPATCH_INVOKEDLL_HDIFFFILE_OFFSET UNITYSDK_OFFSET(0x1B154AC0)
#define HDIFFPATCH_INVOKEDLL_HPATCHFILE_OFFSET UNITYSDK_OFFSET(0x1B154870)
#define HDIFFPATCH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1544D0)

inline static constexpr unsigned int HDiffPatch_TypeDefinitionIndex = 31592;
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(HDiffPatch_TypeDefinitionIndex)->GetStaticField(0x7C10);
	}
