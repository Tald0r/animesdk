...
#define HDIFFPATCH_HDIFFFILE_OFFSET UNITYSDK_OFFSET(0x1B773C50)
#define HDIFFPATCH_HDIFF_CMD_LINE_OFFSET UNITYSDK_OFFSET(0x1B773600)
#define HDIFFPATCH_HPATCHFILE_OFFSET UNITYSDK_OFFSET(0x1B773BE0)
#define HDIFFPATCH_HPATCH_CMD_LINE_OFFSET UNITYSDK_OFFSET(0x1B7734C0)
#define HDIFFPATCH_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B773430)
#define HDIFFPATCH_INVOKEDLL_HDIFFFILE_OFFSET UNITYSDK_OFFSET(0x1B773990)
#define HDIFFPATCH_INVOKEDLL_HPATCHFILE_OFFSET UNITYSDK_OFFSET(0x1B773740)
#define HDIFFPATCH__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B7733A0)

inline static constexpr unsigned int HDiffPatch_TypeDefinitionIndex = 32546;
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(HDiffPatch_TypeDefinitionIndex)->GetStaticField(0x7F40);
	}
