...
#define CLASS_2_8A014097BF38B8E4_METHOD_2_01C54625BD8EFE71_OFFSET UNITYSDK_OFFSET(0xA1520F0)
#define CLASS_2_8A014097BF38B8E4_METHOD_2_38A4C95C9F47AE73_OFFSET UNITYSDK_OFFSET(0xA152BB0)
#define CLASS_2_8A014097BF38B8E4__CCTOR_OFFSET UNITYSDK_OFFSET(0xA152B60)
#define CLASS_2_8A014097BF38B8E4__CTOR_OFFSET UNITYSDK_OFFSET(0xA152B50)

inline static constexpr unsigned int Class_2_8A014097BF38B8E4_TypeDefinitionIndex = 37281;
...
public:
	...
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(Class_2_8A014097BF38B8E4_TypeDefinitionIndex)->GetStaticField(0x42EC0);
	}
	::Class_5_AF65C3A968E836D2* Field_2_0; // 0x10
	::MoleMole::UIHollowChessboard3DModelController* Field_2_1; // 0x18
	::MoleMole::Config::ConfigHollowCameraAvoidObstacle* Field_2_2; // 0x20
	...
	::System::Boolean Method_2_01C54625BD8EFE71(::Class_1_A8E94BAAEBB55F9A* a1, ::Struct_2_6E1B724B14572104_1& a2, ::Struct_2_D9E98FAEB7FF7336& a3, ::Struct_2_C006DA4A56FC21E6& a4, ::Struct_2_F213AC3D3FBF57B9& a5)
	{
		return ((::System::Boolean(*)(::PVOID, ::Class_1_A8E94BAAEBB55F9A*, ::Struct_2_6E1B724B14572104_1&, ::Struct_2_D9E98FAEB7FF7336&, ::Struct_2_C006DA4A56FC21E6&, ::Struct_2_F213AC3D3FBF57B9&))((::PBYTE)hIl2Cpp + CLASS_2_8A014097BF38B8E4_METHOD_2_01C54625BD8EFE71_OFFSET))(this, a1, a2, a3, a4, a5);
	}
