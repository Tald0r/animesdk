...
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_006E258B22EA43C8_OFFSET UNITYSDK_OFFSET(0x9897600)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_1F8314262457963A_OFFSET UNITYSDK_OFFSET(0x368380)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_222592086BA83928_OFFSET UNITYSDK_OFFSET(0x368370)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_224D6B6433F0D411_OFFSET UNITYSDK_OFFSET(0x3684C0)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_5489F9CD0AA85DE6_OFFSET UNITYSDK_OFFSET(0x368300)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_89C1A5C779599670_OFFSET UNITYSDK_OFFSET(0x2C6D00)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_AC2B82F3D026F3EA_1_OFFSET UNITYSDK_OFFSET(0x368520)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_AC2B82F3D026F3EA_OFFSET UNITYSDK_OFFSET(0x368500)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_BCDF1C0553E211C6_OFFSET UNITYSDK_OFFSET(0x3683A0)
#define STRUCT_2_2DA85EB68C1A6A6F_METHOD_2_C3B21C74C45D6F86_OFFSET UNITYSDK_OFFSET(0x368330)
#define STRUCT_2_2DA85EB68C1A6A6F_PROCESSANIMATION_OFFSET UNITYSDK_OFFSET(0x368280)
#define STRUCT_2_2DA85EB68C1A6A6F_PROCESSROOTMOTION_OFFSET UNITYSDK_OFFSET(0x3682C0)
#define STRUCT_2_2DA85EB68C1A6A6F__CCTOR_OFFSET UNITYSDK_OFFSET(0x9897DE0)
#define STRUCT_2_2DA85EB68C1A6A6F__CTOR_OFFSET UNITYSDK_OFFSET(0x368010)

inline static constexpr unsigned int Struct_2_2DA85EB68C1A6A6F_TypeDefinitionIndex = 73270;

struct alignas(8) Struct_2_2DA85EB68C1A6A6F
{
	static ::Struct_2_2DA85EB68C1A6A6F* StaticGet_Field_2_4()
	{
		return (::Struct_2_2DA85EB68C1A6A6F*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_2DA85EB68C1A6A6F_TypeDefinitionIndex)->GetStaticField(0xDCD0);
	}
