...
#define FURHELPER_CHECKPROPERTYHASMODIFYANDSYNC_OFFSET UNITYSDK_OFFSET(0x17BE3A70)
#define FURHELPER_GENERATEINSTANCEDMATERIAL_OFFSET UNITYSDK_OFFSET(0x17BE1720)
#define FURHELPER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17BE1ED0)
#define FURHELPER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17BE1E80)
#define FURHELPER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17BE18E0)
#define FURHELPER_ONINIT_OFFSET UNITYSDK_OFFSET(0x17BE1930)
#define FURHELPER_ONWILLRENDEROBJECT_OFFSET UNITYSDK_OFFSET(0x17BE3110)
#define FURHELPER_PREPAREBINDCOMPONENT_OFFSET UNITYSDK_OFFSET(0x17BE1FA0)
#define FURHELPER_REBUILDMATPROP_OFFSET UNITYSDK_OFFSET(0x17BE2330)
#define FURHELPER_REFRESHADDITIONALLIGHTSOFF_OFFSET UNITYSDK_OFFSET(0x17BE2EE0)
#define FURHELPER_REFRESHMATERIAL_OFFSET UNITYSDK_OFFSET(0x17BE15F0)
#define FURHELPER_UINTTOFLOATUNSAFE_OFFSET UNITYSDK_OFFSET(0x17BE1F60)
#define FURHELPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x17BE40A0)
#define FURHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x17BE4040)

inline static constexpr unsigned int FurHelper_TypeDefinitionIndex = 28075;
...
public:
	...
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(FurHelper_TypeDefinitionIndex)->GetStaticField(0x22210);
	}
	static ::UnityEngine::Profiling::CustomSampler** StaticGet_s_FurHelperOnWillRenderObject()
	{
		return (::UnityEngine::Profiling::CustomSampler**)Il2CppClass::FromTypeDefinitionIndex(FurHelper_TypeDefinitionIndex)->GetStaticField(0x22218);
	}
