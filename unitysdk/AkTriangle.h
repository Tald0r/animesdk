...
#define AKTRIANGLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A551B00)
#define AKTRIANGLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1A551C00)
#define AKTRIANGLE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A551470)
#define AKTRIANGLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A5513B0)
#define AKTRIANGLE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A551400)
#define AKTRIANGLE_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1A551340)
#define AKTRIANGLE_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1A551B80)
#define AKTRIANGLE_GET_POINT0_OFFSET UNITYSDK_OFFSET(0x1A551780)
#define AKTRIANGLE_GET_POINT1_OFFSET UNITYSDK_OFFSET(0x1A551880)
#define AKTRIANGLE_GET_POINT2_OFFSET UNITYSDK_OFFSET(0x1A551980)
#define AKTRIANGLE_GET_SURFACE_OFFSET UNITYSDK_OFFSET(0x1A551A80)
#define AKTRIANGLE_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1A551350)
#define AKTRIANGLE_SET_POINT0_OFFSET UNITYSDK_OFFSET(0x1A551700)
#define AKTRIANGLE_SET_POINT1_OFFSET UNITYSDK_OFFSET(0x1A551800)
#define AKTRIANGLE_SET_POINT2_OFFSET UNITYSDK_OFFSET(0x1A551900)
#define AKTRIANGLE_SET_SURFACE_OFFSET UNITYSDK_OFFSET(0x1A551A00)
#define AKTRIANGLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5515D0)
#define AKTRIANGLE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A551650)
#define AKTRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A551330)

inline static constexpr unsigned int AkTriangle_TypeDefinitionIndex = 29988;
