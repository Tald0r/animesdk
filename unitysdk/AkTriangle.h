...
#define AKTRIANGLE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1AAFB640)
#define AKTRIANGLE_CLONE_OFFSET UNITYSDK_OFFSET(0x1AAFB740)
#define AKTRIANGLE_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1AAFAFB0)
#define AKTRIANGLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AAFAEF0)
#define AKTRIANGLE_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AAFAF40)
#define AKTRIANGLE_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1AAFAE80)
#define AKTRIANGLE_GETSIZEOF_OFFSET UNITYSDK_OFFSET(0x1AAFB6C0)
#define AKTRIANGLE_GET_POINT0_OFFSET UNITYSDK_OFFSET(0x1AAFB2C0)
#define AKTRIANGLE_GET_POINT1_OFFSET UNITYSDK_OFFSET(0x1AAFB3C0)
#define AKTRIANGLE_GET_POINT2_OFFSET UNITYSDK_OFFSET(0x1AAFB4C0)
#define AKTRIANGLE_GET_SURFACE_OFFSET UNITYSDK_OFFSET(0x1AAFB5C0)
#define AKTRIANGLE_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1AAFAE90)
#define AKTRIANGLE_SET_POINT0_OFFSET UNITYSDK_OFFSET(0x1AAFB240)
#define AKTRIANGLE_SET_POINT1_OFFSET UNITYSDK_OFFSET(0x1AAFB340)
#define AKTRIANGLE_SET_POINT2_OFFSET UNITYSDK_OFFSET(0x1AAFB440)
#define AKTRIANGLE_SET_SURFACE_OFFSET UNITYSDK_OFFSET(0x1AAFB540)
#define AKTRIANGLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AAFB110)
#define AKTRIANGLE__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AAFB190)
#define AKTRIANGLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAFAE70)

inline static constexpr unsigned int AkTriangle_TypeDefinitionIndex = 30941;
