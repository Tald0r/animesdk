...
#define STRUCT_2_D927B6852EAC6ACC_METHOD_2_7CEB85D998FE3D88_OFFSET UNITYSDK_OFFSET(0x8FBA250)
#define STRUCT_2_D927B6852EAC6ACC_METHOD_2_B02B3E8B4A712563_OFFSET UNITYSDK_OFFSET(0x8FBA380)
#define STRUCT_2_D927B6852EAC6ACC__CCTOR_OFFSET UNITYSDK_OFFSET(0x8FBA210)

inline static constexpr unsigned int Struct_2_D927B6852EAC6ACC_TypeDefinitionIndex = 52798;

struct alignas(4) Struct_2_D927B6852EAC6ACC
{
	static ::Struct_2_D927B6852EAC6ACC* StaticGet_Field_2_0()
	{
		return (::Struct_2_D927B6852EAC6ACC*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_D927B6852EAC6ACC_TypeDefinitionIndex)->GetStaticField(0x9A40);
	}
