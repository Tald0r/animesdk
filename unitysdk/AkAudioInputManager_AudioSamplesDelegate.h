...
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A532820)
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A5328A0)
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A532480)
#define AKAUDIOINPUTMANAGER_AUDIOSAMPLESDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A532470)

inline static constexpr unsigned int AkAudioInputManager_AudioSamplesDelegate_TypeDefinitionIndex = 30008;
