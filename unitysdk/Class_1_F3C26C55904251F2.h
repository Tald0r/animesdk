...
#define CLASS_1_F3C26C55904251F2_METHOD_1_2E04E911EC2F4E81_OFFSET UNITYSDK_OFFSET(0x6D78370)
#define CLASS_1_F3C26C55904251F2_METHOD_1_412237BB7E5B7EBB_OFFSET UNITYSDK_OFFSET(0x6D77BF0)
#define CLASS_1_F3C26C55904251F2_METHOD_1_4BFE4240535C31C9_OFFSET UNITYSDK_OFFSET(0x6D78750)
#define CLASS_1_F3C26C55904251F2_METHOD_1_C55167FF5115C70C_OFFSET UNITYSDK_OFFSET(0x6D78620)
#define CLASS_1_F3C26C55904251F2_METHOD_1_D3E22AAF199A0D86_OFFSET UNITYSDK_OFFSET(0x6D78860)
#define CLASS_1_F3C26C55904251F2__CCTOR_OFFSET UNITYSDK_OFFSET(0x6D77BE0)

inline static constexpr unsigned int Class_1_F3C26C55904251F2_TypeDefinitionIndex = 42905;
...
public:
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::TimelineData*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_F3C26C55904251F2_TypeDefinitionIndex)->GetStaticField(0x3B9D0);
	}
	...
	static ::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::TimelineData*>* Method_1_D3E22AAF199A0D86()
	{
		return ((::System::Collections::Generic::Dictionary_2<::System::String*, ::MoleMole::TimelineData*>*(*)())((::PBYTE)hIl2Cpp + CLASS_1_F3C26C55904251F2_METHOD_1_D3E22AAF199A0D86_OFFSET))();
	}
};
