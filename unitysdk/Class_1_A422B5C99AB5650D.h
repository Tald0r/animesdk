...
template <typename T> class Class_0_16E4307DCC419505_385;

#define CLASS_1_A422B5C99AB5650D_METHOD_1_0340884D728972E3_OFFSET UNITYSDK_OFFSET(0xB1EFD20)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_04DC58A6E3312864_OFFSET UNITYSDK_OFFSET(0xB1F0950)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_05FE9C5ED5EF266A_OFFSET UNITYSDK_OFFSET(0xB1F09C0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_090740344CAC81EE_OFFSET UNITYSDK_OFFSET(0xB1F3D90)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_097768D86C218FF4_OFFSET UNITYSDK_OFFSET(0xB1F9750)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_097E072BCEB2DFAF_OFFSET UNITYSDK_OFFSET(0xB1F99C0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_0C85ED55B43C6510_OFFSET UNITYSDK_OFFSET(0xB1F3C60)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_15A0C00D0AF78536_OFFSET UNITYSDK_OFFSET(0xB1F97F0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0xB1F40A0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_255BE7B5E4C9B018_OFFSET UNITYSDK_OFFSET(0xB1F3550)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_2E01693CBA549693_1_OFFSET UNITYSDK_OFFSET(0xB1F6E70)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_2E01693CBA549693_OFFSET UNITYSDK_OFFSET(0xB1F0770)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_3422201382CE593B_OFFSET UNITYSDK_OFFSET(0xB1F0850)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_3432859576FFF31F_OFFSET UNITYSDK_OFFSET(0xB1F4070)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_426BC41501263DDE_1_OFFSET UNITYSDK_OFFSET(0xB1FA830)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_426BC41501263DDE_OFFSET UNITYSDK_OFFSET(0xB1FA6F0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_43A46E5F9FAC62B8_OFFSET UNITYSDK_OFFSET(0xB1F43F0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_4434C1B3C7070205_OFFSET UNITYSDK_OFFSET(0xB1F9FB0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_4AB9012B5D01108B_OFFSET UNITYSDK_OFFSET(0xB1FA2D0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_4F31904B94CD26A8_1_OFFSET UNITYSDK_OFFSET(0xB1F94B0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_4F31904B94CD26A8_OFFSET UNITYSDK_OFFSET(0xB1F3D80)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_5B12FB584315CCB9_OFFSET UNITYSDK_OFFSET(0xB1F48B0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_5D3291D964FEACFF_1_OFFSET UNITYSDK_OFFSET(0xB1F2B90)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_5D3291D964FEACFF_OFFSET UNITYSDK_OFFSET(0xB1F1A50)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_71E6511DBF2244D9_OFFSET UNITYSDK_OFFSET(0xB1F5350)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_76C6CA61FA3AF162_OFFSET UNITYSDK_OFFSET(0xB1F8030)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_77FD543600E00498_OFFSET UNITYSDK_OFFSET(0xB1F9410)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_7891671122F5C4CB_OFFSET UNITYSDK_OFFSET(0xB1F0530)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_79A71C42C344F272_OFFSET UNITYSDK_OFFSET(0xB1F0660)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_7D9E0AC8DDDB087D_OFFSET UNITYSDK_OFFSET(0xB1F5900)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_857FF94CE920A41B_OFFSET UNITYSDK_OFFSET(0xB1F1270)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_897B7867084DDD4E_OFFSET UNITYSDK_OFFSET(0xB1F4DE0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_89C52E338BB8A276_OFFSET UNITYSDK_OFFSET(0xB1F44A0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_92EF378E5C246C05_OFFSET UNITYSDK_OFFSET(0xB1F1EC0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_93826312070FC6F3_OFFSET UNITYSDK_OFFSET(0xB1F40B0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_95F053D451652F2E_OFFSET UNITYSDK_OFFSET(0xB1FA480)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_963BD5843D278A37_OFFSET UNITYSDK_OFFSET(0xB1F1100)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_A43E50D4ABCBF27B_OFFSET UNITYSDK_OFFSET(0xB1F6F80)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_B0AA35323E65AF78_OFFSET UNITYSDK_OFFSET(0xB1F2D80)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_B0B02299A559EC10_OFFSET UNITYSDK_OFFSET(0xB1F9560)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_B228DB26E10594DB_OFFSET UNITYSDK_OFFSET(0xB1F27E0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_BD67A279F5B78C9A_OFFSET UNITYSDK_OFFSET(0xB1F1040)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_C2245EC58D417830_OFFSET UNITYSDK_OFFSET(0xB1F9680)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_D64FD9A228A1C4E0_1_OFFSET UNITYSDK_OFFSET(0xB1FA3F0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_D64FD9A228A1C4E0_OFFSET UNITYSDK_OFFSET(0xB1F4820)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_DA6A516C6C038113_OFFSET UNITYSDK_OFFSET(0xB1F1C40)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_DD360325DD9325C8_OFFSET UNITYSDK_OFFSET(0xB1F16F0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_DE2C6C862AAD02E2_OFFSET UNITYSDK_OFFSET(0xB1F3970)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_E4B4A3F40157A79A_OFFSET UNITYSDK_OFFSET(0xB1F3640)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_EBF44BC910948FDA_1_OFFSET UNITYSDK_OFFSET(0xB1F94C0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_EBF44BC910948FDA_OFFSET UNITYSDK_OFFSET(0xB1F4400)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_EE5A9D6A8551521B_OFFSET UNITYSDK_OFFSET(0xB1F45D0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_F0589B1D9EEFB5E2_OFFSET UNITYSDK_OFFSET(0xB1F3F00)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_FA662896843C137A_OFFSET UNITYSDK_OFFSET(0xB1F7F90)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_FADE0812A01CB292_OFFSET UNITYSDK_OFFSET(0xB1F28F0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_FB525D2D16F36EA5_OFFSET UNITYSDK_OFFSET(0xB1F9FD0)
#define CLASS_1_A422B5C99AB5650D_METHOD_1_FF7B2911BBACA4A9_OFFSET UNITYSDK_OFFSET(0xB1F3E70)
#define CLASS_1_A422B5C99AB5650D__CTOR_OFFSET UNITYSDK_OFFSET(0xB1EF720)

inline static constexpr unsigned int Class_1_A422B5C99AB5650D_TypeDefinitionIndex = 61836;
...
public:
	...
	::Class_2_E7B5A02ED2B31407* Field_1_15; // 0x10
	::Il2CppArray<::UnityEngine::Vector4>* Field_1_20; // 0x18
	::Il2CppArray<::UnityEngine::Vector4>* Field_1_22; // 0x20
	::MoleMole::CameraModuleDirectionData* Field_1_18; // 0x28
	::Class_1_7D047D1B6B651F9C* Field_1_4; // 0x30
	::Class_1_7D047D1B6B651F9C* Field_1_5; // 0x38
	::Il2CppArray<::UnityEngine::Vector4>* Field_1_21; // 0x40
	::Il2CppArray<::UnityEngine::Vector4>* Field_1_19; // 0x48
	::MoleMole::Cameras::CameraDataAccessor* Field_1_2; // 0x50
	::Class_0_16E4307DCC419505_385<::System::Single>* Field_1_10; // 0x58
	::Class_2_D39C2FCEF4D4B922* Field_1_1; // 0x60
	::Class_2_E7B5A02ED2B31407* Field_1_17; // 0x68
	::Class_1_986CA5FC483F9BD8* Field_1_11; // 0x70
	::MoleMole::CameraDelayData* Field_1_28; // 0x78
	::Class_0_16E4307DCC419505_385<::System::Single>* Field_1_9; // 0x80
	::Class_2_E7B5A02ED2B31407* Field_1_16; // 0x88
	::Cinemachine::CameraState Field_1_0; // 0x90
	::UnityEngine::Vector2 Field_1_39; // 0x178
	::UnityEngine::Vector2 Field_1_35; // 0x180
	::UnityEngine::Vector3 Field_1_30; // 0x188
	::UnityEngine::Vector3 Field_1_33; // 0x194
	::UnityEngine::Vector3 Field_1_25; // 0x1A0
	::UnityEngine::Vector3 Field_1_26; // 0x1AC
	::UnityEngine::Vector3 Field_1_24; // 0x1B8
	::UnityEngine::Vector3 Field_1_34; // 0x1C4
	::Class_1_A422B5C99AB5650D_Struct_2_15616FB3866945B0 Field_1_32; // 0x1D0
	::System::Single Field_1_29; // 0x220
	::System::Single Field_1_7; // 0x224
	::UnityEngine::Vector3 Field_1_23; // 0x228
	::Class_1_A422B5C99AB5650D_Struct_2_15616FB3866945B0 Field_1_31; // 0x234
	::UnityEngine::Quaternion Field_1_36; // 0x284
	::System::Boolean Field_1_3; // 0x294
	::System::Byte Field_1_14; // 0x295
	::System::UInt32 Field_1_37; // 0x298
	::UnityEngine::Vector3 Field_1_38; // 0x29C
	::System::Single Field_1_12; // 0x2A8
	::System::Single Field_1_6; // 0x2AC
	::System::Single Field_1_13; // 0x2B0
	...
	{
		return ((::MoleMole::CameraModuleAvatarDataConfigExt*(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_A422B5C99AB5650D_METHOD_1_BD67A279F5B78C9A_OFFSET))(this);
	}
