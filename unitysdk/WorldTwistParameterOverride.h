...
#define WORLDTWISTPARAMETEROVERRIDE_MESHRENDERCOLLECTION_OFFSET UNITYSDK_OFFSET(0x19340D60)
#define WORLDTWISTPARAMETEROVERRIDE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19341160)
#define WORLDTWISTPARAMETEROVERRIDE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x193410F0)
#define WORLDTWISTPARAMETEROVERRIDE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x193411D0)
#define WORLDTWISTPARAMETEROVERRIDE_SETUPMATERIALPARAMS_OFFSET UNITYSDK_OFFSET(0x19340EB0)
#define WORLDTWISTPARAMETEROVERRIDE_START_OFFSET UNITYSDK_OFFSET(0x19340D10)
#define WORLDTWISTPARAMETEROVERRIDE__CTOR_OFFSET UNITYSDK_OFFSET(0x19341220)

inline static constexpr unsigned int WorldTwistParameterOverride_TypeDefinitionIndex = 28073;
