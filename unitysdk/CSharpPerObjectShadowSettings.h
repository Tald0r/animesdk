...
#define CSHARPPEROBJECTSHADOWSETTINGS_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1794D5D0)
#define CSHARPPEROBJECTSHADOWSETTINGS_GET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x1794D560)
#define CSHARPPEROBJECTSHADOWSETTINGS_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x1794D5E0)
#define CSHARPPEROBJECTSHADOWSETTINGS_SET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x1794D5C0)
#define CSHARPPEROBJECTSHADOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1794D640)

inline static constexpr unsigned int CSharpPerObjectShadowSettings_TypeDefinitionIndex = 28169;
