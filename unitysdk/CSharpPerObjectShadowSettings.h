...
#define CSHARPPEROBJECTSHADOWSETTINGS_GET_ENABLED_OFFSET UNITYSDK_OFFSET(0x17774990)
#define CSHARPPEROBJECTSHADOWSETTINGS_GET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x17774920)
#define CSHARPPEROBJECTSHADOWSETTINGS_SET_ENABLED_OFFSET UNITYSDK_OFFSET(0x177749A0)
#define CSHARPPEROBJECTSHADOWSETTINGS_SET_MAXCOUNT_OFFSET UNITYSDK_OFFSET(0x17774980)
#define CSHARPPEROBJECTSHADOWSETTINGS__CTOR_OFFSET UNITYSDK_OFFSET(0x17774A00)

inline static constexpr unsigned int CSharpPerObjectShadowSettings_TypeDefinitionIndex = 29110;
