...
#define CLASS_1_3714DB359DE5DD9E_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A0ED5D0)
#define CLASS_1_3714DB359DE5DD9E_METHOD_1_128774387667156B_OFFSET UNITYSDK_OFFSET(0x1A0ED720)
#define CLASS_1_3714DB359DE5DD9E_METHOD_1_294D0CA719F4FA94_OFFSET UNITYSDK_OFFSET(0x1A0ED200)
#define CLASS_1_3714DB359DE5DD9E_METHOD_1_A239DF324AF4215D_OFFSET UNITYSDK_OFFSET(0x1A0ED160)
#define CLASS_1_3714DB359DE5DD9E_METHOD_1_CB2C480C9456ACBA_OFFSET UNITYSDK_OFFSET(0x1A0ED080)
#define CLASS_1_3714DB359DE5DD9E_METHOD_1_F429D309F55DB9F1_OFFSET UNITYSDK_OFFSET(0x1A0ED3D0)
#define CLASS_1_3714DB359DE5DD9E_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A0ED6B0)
#define CLASS_1_3714DB359DE5DD9E__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0D7D10)

inline static constexpr unsigned int Class_1_3714DB359DE5DD9E_TypeDefinitionIndex = 31803;
...
public:
	...
	::System::Boolean Method_1_CB2C480C9456ACBA(::System::Int64 a1)
	{
		return ((::System::Boolean(*)(::PVOID, ::System::Int64))((::PBYTE)hIl2Cpp + CLASS_1_3714DB359DE5DD9E_METHOD_1_CB2C480C9456ACBA_OFFSET))(this, a1);
	}
