...
#define PUSHBOXGAMEVIEW_BINDUI_OFFSET UNITYSDK_OFFSET(0x8EFD3B0)
#define PUSHBOXGAMEVIEW_CANMOVETO_OFFSET UNITYSDK_OFFSET(0x8F005A0)
#define PUSHBOXGAMEVIEW_CREATENPC_OFFSET UNITYSDK_OFFSET(0x8EFF7B0)
#define PUSHBOXGAMEVIEW_CREATETILE_OFFSET UNITYSDK_OFFSET(0x8EFF5A0)
#define PUSHBOXGAMEVIEW_CREATEVIEW_OFFSET UNITYSDK_OFFSET(0x8F01EA0)
#define PUSHBOXGAMEVIEW_DESTROYVIEW_OFFSET UNITYSDK_OFFSET(0x8F01FA0)
#define PUSHBOXGAMEVIEW_DOGENCHESSBOARD_OFFSET UNITYSDK_OFFSET(0x8EFD6C0)
#define PUSHBOXGAMEVIEW_FRESHCHESSBOARDVIEW_OFFSET UNITYSDK_OFFSET(0x8EFFF40)
#define PUSHBOXGAMEVIEW_GENCHESSBOARD_OFFSET UNITYSDK_OFFSET(0x8EFD420)
#define PUSHBOXGAMEVIEW_GETINDEXWORLDPOS_OFFSET UNITYSDK_OFFSET(0x8EFFC50)
#define PUSHBOXGAMEVIEW_GETMOVEDIR_OFFSET UNITYSDK_OFFSET(0x8F01A80)
#define PUSHBOXGAMEVIEW_GETMOVETARGETINDEX_OFFSET UNITYSDK_OFFSET(0x8F01640)
#define PUSHBOXGAMEVIEW_GET_CURBOARDTYPE_OFFSET UNITYSDK_OFFSET(0x8F01630)
#define PUSHBOXGAMEVIEW_GET_REALXSIZE_OFFSET UNITYSDK_OFFSET(0x8EFFBE0)
#define PUSHBOXGAMEVIEW_GET_SECTIONUID_OFFSET UNITYSDK_OFFSET(0x8F02320)
#define PUSHBOXGAMEVIEW_HIDEALL_OFFSET UNITYSDK_OFFSET(0x8EFED90)
#define PUSHBOXGAMEVIEW_INITALLNPC_OFFSET UNITYSDK_OFFSET(0x8F00D90)
#define PUSHBOXGAMEVIEW_INITCHESSPIECES_OFFSET UNITYSDK_OFFSET(0x8EFDF70)
#define PUSHBOXGAMEVIEW_INITPLAYER_OFFSET UNITYSDK_OFFSET(0x8EFE8E0)
#define PUSHBOXGAMEVIEW_ONNPCUPDATE_OFFSET UNITYSDK_OFFSET(0x8F00890)
#define PUSHBOXGAMEVIEW_PLAYFULLSCREENTEXTURE_OFFSET UNITYSDK_OFFSET(0x8F02010)
#define PUSHBOXGAMEVIEW_PLAYINITANIM_OFFSET UNITYSDK_OFFSET(0x8EFF420)
#define PUSHBOXGAMEVIEW_PLAYRESETANIM_OFFSET UNITYSDK_OFFSET(0x8EFD930)
#define PUSHBOXGAMEVIEW_REFRESHPLAYERAPPEARANCE_OFFSET UNITYSDK_OFFSET(0x8F00810)
#define PUSHBOXGAMEVIEW_REFRESHPLAYERPOS_OFFSET UNITYSDK_OFFSET(0x8EFEA10)
#define PUSHBOXGAMEVIEW_SET_SECTIONUID_OFFSET UNITYSDK_OFFSET(0x8F02330)
#define PUSHBOXGAMEVIEW_SHOWNPCANDPLAYER_OFFSET UNITYSDK_OFFSET(0x8EFF130)
#define PUSHBOXGAMEVIEW_TRYENTITYMOVE_OFFSET UNITYSDK_OFFSET(0x8F02340)
#define PUSHBOXGAMEVIEW_UPDATESINGLENPC_OFFSET UNITYSDK_OFFSET(0x8F00A90)
#define PUSHBOXGAMEVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x8EFEC80)
#define PUSHBOXGAMEVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x8F02790)
#define PUSHBOXGAMEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x8F025F0)
#define PUSHBOXGAMEVIEW__INITCHESSPIECES_G____CALCENTERPOS_28_0_OFFSET UNITYSDK_OFFSET(0x8EFFBA0)
#define PUSHBOXGAMEVIEW__INITCHESSPIECES_G____CREATELOGICINFO_28_1_OFFSET UNITYSDK_OFFSET(0x8EFF9A0)
#define PUSHBOXGAMEVIEW__PLAYINITANIM_B__24_0_OFFSET UNITYSDK_OFFSET(0x8F02820)
#define PUSHBOXGAMEVIEW__PLAYINITANIM_B__24_1_OFFSET UNITYSDK_OFFSET(0x8F02AB0)

inline static constexpr unsigned int PushBoxGameView_TypeDefinitionIndex = 38292;
...
public:
	...
	{
		return (::Il2CppArray<::Share::GridDir>**)Il2CppClass::FromTypeDefinitionIndex(PushBoxGameView_TypeDefinitionIndex)->GetStaticField(0x41A80);
	}
