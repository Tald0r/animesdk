...
#define PUSHBOXGAMEVIEW_BINDUI_OFFSET UNITYSDK_OFFSET(0x18207E30)
#define PUSHBOXGAMEVIEW_CANMOVETO_OFFSET UNITYSDK_OFFSET(0x1820B010)
#define PUSHBOXGAMEVIEW_CREATENPC_OFFSET UNITYSDK_OFFSET(0x1820A220)
#define PUSHBOXGAMEVIEW_CREATETILE_OFFSET UNITYSDK_OFFSET(0x1820A010)
#define PUSHBOXGAMEVIEW_CREATEVIEW_OFFSET UNITYSDK_OFFSET(0x1820C900)
#define PUSHBOXGAMEVIEW_DESTROYVIEW_OFFSET UNITYSDK_OFFSET(0x1820CA00)
#define PUSHBOXGAMEVIEW_DOGENCHESSBOARD_OFFSET UNITYSDK_OFFSET(0x18208140)
#define PUSHBOXGAMEVIEW_FRESHCHESSBOARDVIEW_OFFSET UNITYSDK_OFFSET(0x1820A9B0)
#define PUSHBOXGAMEVIEW_GENCHESSBOARD_OFFSET UNITYSDK_OFFSET(0x18207EA0)
#define PUSHBOXGAMEVIEW_GETINDEXWORLDPOS_OFFSET UNITYSDK_OFFSET(0x1820A6C0)
#define PUSHBOXGAMEVIEW_GETMOVEDIR_OFFSET UNITYSDK_OFFSET(0x1820C4E0)
#define PUSHBOXGAMEVIEW_GETMOVETARGETINDEX_OFFSET UNITYSDK_OFFSET(0x1820C0A0)
#define PUSHBOXGAMEVIEW_GET_CURBOARDTYPE_OFFSET UNITYSDK_OFFSET(0x1820C090)
#define PUSHBOXGAMEVIEW_GET_REALXSIZE_OFFSET UNITYSDK_OFFSET(0x1820A650)
#define PUSHBOXGAMEVIEW_GET_SECTIONUID_OFFSET UNITYSDK_OFFSET(0x1820CD80)
#define PUSHBOXGAMEVIEW_HIDEALL_OFFSET UNITYSDK_OFFSET(0x18209810)
#define PUSHBOXGAMEVIEW_INITALLNPC_OFFSET UNITYSDK_OFFSET(0x1820B800)
#define PUSHBOXGAMEVIEW_INITCHESSPIECES_OFFSET UNITYSDK_OFFSET(0x182089F0)
#define PUSHBOXGAMEVIEW_INITPLAYER_OFFSET UNITYSDK_OFFSET(0x18209360)
#define PUSHBOXGAMEVIEW_ONNPCUPDATE_OFFSET UNITYSDK_OFFSET(0x1820B300)
#define PUSHBOXGAMEVIEW_PLAYFULLSCREENTEXTURE_OFFSET UNITYSDK_OFFSET(0x1820CA70)
#define PUSHBOXGAMEVIEW_PLAYINITANIM_OFFSET UNITYSDK_OFFSET(0x18209E90)
#define PUSHBOXGAMEVIEW_PLAYRESETANIM_OFFSET UNITYSDK_OFFSET(0x182083B0)
#define PUSHBOXGAMEVIEW_REFRESHPLAYERAPPEARANCE_OFFSET UNITYSDK_OFFSET(0x1820B280)
#define PUSHBOXGAMEVIEW_REFRESHPLAYERPOS_OFFSET UNITYSDK_OFFSET(0x18209490)
#define PUSHBOXGAMEVIEW_SET_SECTIONUID_OFFSET UNITYSDK_OFFSET(0x1820CD90)
#define PUSHBOXGAMEVIEW_SHOWNPCANDPLAYER_OFFSET UNITYSDK_OFFSET(0x18209BB0)
#define PUSHBOXGAMEVIEW_TRYENTITYMOVE_OFFSET UNITYSDK_OFFSET(0x1820CDA0)
#define PUSHBOXGAMEVIEW_UPDATESINGLENPC_OFFSET UNITYSDK_OFFSET(0x1820B500)
#define PUSHBOXGAMEVIEW_UPDATE_OFFSET UNITYSDK_OFFSET(0x18209700)
#define PUSHBOXGAMEVIEW__CCTOR_OFFSET UNITYSDK_OFFSET(0x1820D1F0)
#define PUSHBOXGAMEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x1820D050)
#define PUSHBOXGAMEVIEW__INITCHESSPIECES_G____CALCENTERPOS_28_0_OFFSET UNITYSDK_OFFSET(0x1820A610)
#define PUSHBOXGAMEVIEW__INITCHESSPIECES_G____CREATELOGICINFO_28_1_OFFSET UNITYSDK_OFFSET(0x1820A410)
#define PUSHBOXGAMEVIEW__PLAYINITANIM_B__24_0_OFFSET UNITYSDK_OFFSET(0x1820D280)
#define PUSHBOXGAMEVIEW__PLAYINITANIM_B__24_1_OFFSET UNITYSDK_OFFSET(0x1820D520)

inline static constexpr unsigned int PushBoxGameView_TypeDefinitionIndex = 71305;
...
public:
	...
	{
		return (::Il2CppArray<::Share::GridDir>**)Il2CppClass::FromTypeDefinitionIndex(PushBoxGameView_TypeDefinitionIndex)->GetStaticField(0x47C20);
	}
	...
	::Struct_2_02E84E3D148EE908 _SectionUID_k__BackingField; // 0x90
	...
	::System::Void GenChessboard(::Struct_2_02E84E3D148EE908 sectionId, ::MoleMole::HollowChessboard::HollowChessboardUID chessboardUid)
	{
		return ((::System::Void(*)(::PVOID, ::Struct_2_02E84E3D148EE908, ::MoleMole::HollowChessboard::HollowChessboardUID))((::PBYTE)hIl2Cpp + PUSHBOXGAMEVIEW_GENCHESSBOARD_OFFSET))(this, sectionId, chessboardUid);
	}

	::System::Void DoGenChessboard(::Struct_2_02E84E3D148EE908 sectionId, ::MoleMole::HollowChessboard::HollowChessboardUID chessboardUid)
	{
		return ((::System::Void(*)(::PVOID, ::Struct_2_02E84E3D148EE908, ::MoleMole::HollowChessboard::HollowChessboardUID))((::PBYTE)hIl2Cpp + PUSHBOXGAMEVIEW_DOGENCHESSBOARD_OFFSET))(this, sectionId, chessboardUid);
	}
	...
	::System::Void UpdateSingleNpc(::Class_1_9C9F648C2B4D18AF* npc, ::System::Boolean initMap)
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_9C9F648C2B4D18AF*, ::System::Boolean))((::PBYTE)hIl2Cpp + PUSHBOXGAMEVIEW_UPDATESINGLENPC_OFFSET))(this, npc, initMap);
	}
	...
	{
		return ((::Struct_2_02E84E3D148EE908(*)(::PVOID))((::PBYTE)hIl2Cpp + PUSHBOXGAMEVIEW_GET_SECTIONUID_OFFSET))(this);
	}

	::System::Void set_SectionUID(::Struct_2_02E84E3D148EE908 value)
	{
		return ((::System::Void(*)(::PVOID, ::Struct_2_02E84E3D148EE908))((::PBYTE)hIl2Cpp + PUSHBOXGAMEVIEW_SET_SECTIONUID_OFFSET))(this, value);
	}
