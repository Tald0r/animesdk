...
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0xD628980)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD628AE0)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0xD628B40)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0xD628AF0)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0xD628970)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0xD628960)

inline static constexpr unsigned int CustomSkin_SafePhone__CountDown_d__20_TypeDefinitionIndex = 51737;
