...
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x9D36C70)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9D36DD0)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9D36E30)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x9D36DE0)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x9D36C60)
#define CUSTOMSKIN_SAFEPHONE__COUNTDOWN_D__20__CTOR_OFFSET UNITYSDK_OFFSET(0x9D36C50)

inline static constexpr unsigned int CustomSkin_SafePhone__CountDown_d__20_TypeDefinitionIndex = 70548;

class CustomSkin_SafePhone__CountDown_d__20 : public ::System::Object
{
public:
	::System::Object* __2__current; // 0x10
	::CustomSkin_SafePhone* __4__this; // 0x18
