...
#define CLASS_1_C353FCD1325B3415_STRUCT_2_05898449385544E4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8C0550)
#define CLASS_1_C353FCD1325B3415_STRUCT_2_05898449385544E4_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

inline static constexpr unsigned int Class_1_C353FCD1325B3415_Struct_2_05898449385544E4_TypeDefinitionIndex = 31506;

struct alignas(8) Class_1_C353FCD1325B3415_Struct_2_05898449385544E4
{
	::ReplayFullData* Field_2_3; // 0x10
	::Class_1_C353FCD1325B3415* Field_2_2; // 0x18
	::System::Collections::Generic::IEnumerator_1<::ReplayChangeEvent*>* Field_2_5; // 0x20
	::Cysharp::Threading::Tasks::UniTask_Awaiter Field_2_8; // 0x28
	::ReplayChangeEvent* Field_2_6; // 0x38
