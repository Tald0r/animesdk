...
#define XFTWEAPON_SPLINE_ADDCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1A5DA180)
#define XFTWEAPON_SPLINE_CATMULROM_OFFSET UNITYSDK_OFFSET(0x1A5D9420)
#define XFTWEAPON_SPLINE_CLEAR_OFFSET UNITYSDK_OFFSET(0x1A5DA220)
#define XFTWEAPON_SPLINE_GET_BSPLINE_OFFSET UNITYSDK_OFFSET(0x1A5D9620)
#define XFTWEAPON_SPLINE_GET_CONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1A5D8F80)
#define XFTWEAPON_SPLINE_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A5D8F30)
#define XFTWEAPON_SPLINE_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x1A5D8F70)
#define XFTWEAPON_SPLINE_INTERPOLATEBYLEN_OFFSET UNITYSDK_OFFSET(0x1A5D9A60)
#define XFTWEAPON_SPLINE_INTERPOLATENORMALBYLEN_OFFSET UNITYSDK_OFFSET(0x1A5D9DF0)
#define XFTWEAPON_SPLINE_INTERPOLATE_BONESHAPE_OFFSET UNITYSDK_OFFSET(0x1A5D9920)
#define XFTWEAPON_SPLINE_INTERPOLATE_CUSTOMSHAPE_OFFSET UNITYSDK_OFFSET(0x1A5D97C0)
#define XFTWEAPON_SPLINE_INTERPOLATE_OFFSET UNITYSDK_OFFSET(0x1A5D9680)
#define XFTWEAPON_SPLINE_LENTOSEGMENT_FORBSPLINE_OFFSET UNITYSDK_OFFSET(0x1A5D9300)
#define XFTWEAPON_SPLINE_LENTOSEGMENT_OFFSET UNITYSDK_OFFSET(0x1A5D91F0)
#define XFTWEAPON_SPLINE_NEXTCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1A5D8F90)
#define XFTWEAPON_SPLINE_NEXTNORMAL_OFFSET UNITYSDK_OFFSET(0x1A5D9180)
#define XFTWEAPON_SPLINE_NEXTPOSITION_OFFSET UNITYSDK_OFFSET(0x1A5D9030)
#define XFTWEAPON_SPLINE_PREVIOUSCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x1A5D8FE0)
#define XFTWEAPON_SPLINE_PREVIOUSNORMAL_OFFSET UNITYSDK_OFFSET(0x1A5D9110)
#define XFTWEAPON_SPLINE_PREVIOUSPOSITION_OFFSET UNITYSDK_OFFSET(0x1A5D90A0)
#define XFTWEAPON_SPLINE_REFRESHDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A5DA260)
#define XFTWEAPON_SPLINE_REFRESHSPLINE_OFFSET UNITYSDK_OFFSET(0x1A5DA3B0)
#define XFTWEAPON_SPLINE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5DA530)

namespace XftWeapon
{
	inline static constexpr unsigned int Spline_TypeDefinitionIndex = 37130;

	class Spline : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::XftWeapon::SplineControlPoint*>* mControlPoints; // 0x10
		::XftWeapon::BSpline* _BSpline; // 0x18
		::System::Collections::Generic::List_1<::XftWeapon::SplineControlPoint*>* mSegments; // 0x20
