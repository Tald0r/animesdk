...
#define XFTWEAPON_VERTEXPOOL_VERTEXSEGMENT_CLEARINDICES_OFFSET UNITYSDK_OFFSET(0x1A5DE430)
#define XFTWEAPON_VERTEXPOOL_VERTEXSEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5DCEC0)

namespace XftWeapon
{
	inline static constexpr unsigned int VertexPool_VertexSegment_TypeDefinitionIndex = 37133;

	class VertexPool_VertexSegment : public ::System::Object
	{
	public:
		::XftWeapon::VertexPool* Pool; // 0x10
		::System::Int32 VertStart; // 0x18
		::System::Int32 IndexStart; // 0x1C
		::System::Int32 VertCount; // 0x20
		::System::Int32 IndexCount; // 0x24
