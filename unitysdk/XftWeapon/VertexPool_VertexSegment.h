...
#define XFTWEAPON_VERTEXPOOL_VERTEXSEGMENT_CLEARINDICES_OFFSET UNITYSDK_OFFSET(0x19FC55C0)
#define XFTWEAPON_VERTEXPOOL_VERTEXSEGMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FC4000)

namespace XftWeapon
{
	inline static constexpr unsigned int VertexPool_VertexSegment_TypeDefinitionIndex = 36113;
	...
	public:
		...
		::System::Int32 VertCount; // 0x1C
		::System::Int32 IndexCount; // 0x20
