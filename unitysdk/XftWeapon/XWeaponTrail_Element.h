...
#define XFTWEAPON_XWEAPONTRAIL_ELEMENT_GET_POS_OFFSET UNITYSDK_OFFSET(0x1A5E8D50)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5EABC0)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5EAB30)

namespace XftWeapon
{
	inline static constexpr unsigned int XWeaponTrail_Element_TypeDefinitionIndex = 37137;
