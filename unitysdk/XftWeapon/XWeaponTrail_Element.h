...
#define XFTWEAPON_XWEAPONTRAIL_ELEMENT_GET_POS_OFFSET UNITYSDK_OFFSET(0x19FCFD40)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19FD1B90)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FD1B00)

namespace XftWeapon
{
	inline static constexpr unsigned int XWeaponTrail_Element_TypeDefinitionIndex = 36117;
