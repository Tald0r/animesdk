...
#define XFTWEAPON_XWEAPONTRAIL_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A5D74A0)
#define XFTWEAPON_XWEAPONTRAIL_ADDFORCEDISWEIGHTMINMESHDISLIMITSHOWIF_OFFSET UNITYSDK_OFFSET(0x1A5E27D0)
#define XFTWEAPON_XWEAPONTRAIL_AFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x1A5E2740)
#define XFTWEAPON_XWEAPONTRAIL_APPLYATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x1A5DE4C0)
#define XFTWEAPON_XWEAPONTRAIL_BEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x1A5E26E0)
#define XFTWEAPON_XWEAPONTRAIL_BSPLINEBONESHAPERECORDPOINTS_OFFSET UNITYSDK_OFFSET(0x1A5E89E0)
#define XFTWEAPON_XWEAPONTRAIL_BSPLINEBONESHAPERECORDSNAPSHOTELEMDATA_OFFSET UNITYSDK_OFFSET(0x1A5E8D90)
#define XFTWEAPON_XWEAPONTRAIL_BSPLINEFORDFSPOINTS_OFFSET UNITYSDK_OFFSET(0x1A5EA230)
#define XFTWEAPON_XWEAPONTRAIL_BSPLINEREMOVEPOOLLASTPOINT_OFFSET UNITYSDK_OFFSET(0x1A5EA100)
#define XFTWEAPON_XWEAPONTRAIL_BUILDBSPLINECUSTOMSHAPERATELIST_OFFSET UNITYSDK_OFFSET(0x1A5DEA60)
#define XFTWEAPON_XWEAPONTRAIL_BUILDCONTROLLINKEDNODE_ADDHEADPOINT_OFFSET UNITYSDK_OFFSET(0x1A5E0680)
#define XFTWEAPON_XWEAPONTRAIL_BUILDCONTROLLINKEDNODE_DFS_OFFSET UNITYSDK_OFFSET(0x1A5E19A0)
#define XFTWEAPON_XWEAPONTRAIL_BUILDCONTROLLINKEDNODE_OFFSET UNITYSDK_OFFSET(0x1A5DF1C0)
#define XFTWEAPON_XWEAPONTRAIL_BUILDCONTROLLINKEDNODE_SPAWNNEWPOINT_OFFSET UNITYSDK_OFFSET(0x1A5E0DB0)
#define XFTWEAPON_XWEAPONTRAIL_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x1A5D7420)
#define XFTWEAPON_XWEAPONTRAIL_ENSUREBSPLINECUSTOMSHAPETRANSFORMLISTPOSCACHE_OFFSET UNITYSDK_OFFSET(0x1A5E5830)
#define XFTWEAPON_XWEAPONTRAIL_GETMESHRENDER_OFFSET UNITYSDK_OFFSET(0x1A5E7E50)
#define XFTWEAPON_XWEAPONTRAIL_GET_ACTIVATED_OFFSET UNITYSDK_OFFSET(0x1A5E7AB0)
#define XFTWEAPON_XWEAPONTRAIL_GET_BSPLINEBONESHAPE_OFFSET UNITYSDK_OFFSET(0x1A5DEA40)
#define XFTWEAPON_XWEAPONTRAIL_GET_BSPLINECUSTOMSHAPE_OFFSET UNITYSDK_OFFSET(0x1A5E1FF0)
#define XFTWEAPON_XWEAPONTRAIL_GET_CURFRAMEISSTOPFRAME_OFFSET UNITYSDK_OFFSET(0x1A5EA8E0)
#define XFTWEAPON_XWEAPONTRAIL_GET_CURHEADPOS_OFFSET UNITYSDK_OFFSET(0x1A5E7AC0)
#define XFTWEAPON_XWEAPONTRAIL_GET_DYNAMICMESHPOINTLENGTH_OFFSET UNITYSDK_OFFSET(0x1A5DB380)
#define XFTWEAPON_XWEAPONTRAIL_GET_NEEDCALCMESHPERPOINTDIS_OFFSET UNITYSDK_OFFSET(0x1A5E27A0)
#define XFTWEAPON_XWEAPONTRAIL_GET_NEEDRECORDINITPOS_OFFSET UNITYSDK_OFFSET(0x1A5E89C0)
#define XFTWEAPON_XWEAPONTRAIL_GET_TRAILWIDTH_OFFSET UNITYSDK_OFFSET(0x1A5E7B80)
#define XFTWEAPON_XWEAPONTRAIL_GET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x1A5E3F20)
#define XFTWEAPON_XWEAPONTRAIL_GET_UPDATE_CONTROLPOINT_FULL_MODE_OFFSET UNITYSDK_OFFSET(0x1A5DF190)
#define XFTWEAPON_XWEAPONTRAIL_GET_USEJOBOPT_OFFSET UNITYSDK_OFFSET(0x1A5E2A60)
#define XFTWEAPON_XWEAPONTRAIL_GOSTART_OFFSET UNITYSDK_OFFSET(0x1A5E8940)
#define XFTWEAPON_XWEAPONTRAIL_GRAPHICSSETTINGSHOWIF_OFFSET UNITYSDK_OFFSET(0x1A5E2790)
#define XFTWEAPON_XWEAPONTRAIL_HASAPPLIEDBYFORCE_OFFSET UNITYSDK_OFFSET(0x1A5E27C0)
#define XFTWEAPON_XWEAPONTRAIL_INITDATACO_OFFSET UNITYSDK_OFFSET(0x1A5E7DF0)
#define XFTWEAPON_XWEAPONTRAIL_INITMESHOBJ_OFFSET UNITYSDK_OFFSET(0x1A5E7C60)
#define XFTWEAPON_XWEAPONTRAIL_INITORIGINALELEMENTS_OFFSET UNITYSDK_OFFSET(0x1A5E2DE0)
#define XFTWEAPON_XWEAPONTRAIL_INITSPLINE_OFFSET UNITYSDK_OFFSET(0x1A5E2FE0)
#define XFTWEAPON_XWEAPONTRAIL_INIT_OFFSET UNITYSDK_OFFSET(0x1A5D66D0)
#define XFTWEAPON_XWEAPONTRAIL_MYPOSTRENDER_OFFSET UNITYSDK_OFFSET(0x1A5E75F0)
#define XFTWEAPON_XWEAPONTRAIL_MYPRERENDER_OFFSET UNITYSDK_OFFSET(0x1A5E8680)
#define XFTWEAPON_XWEAPONTRAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A5E88A0)
#define XFTWEAPON_XWEAPONTRAIL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1A5E7870)
#define XFTWEAPON_XWEAPONTRAIL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1A5E76B0)
#define XFTWEAPON_XWEAPONTRAIL_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1A5E7A50)
#define XFTWEAPON_XWEAPONTRAIL_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1A5E7A80)
#define XFTWEAPON_XWEAPONTRAIL_ONMATERIALVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A5EAB60)
#define XFTWEAPON_XWEAPONTRAIL_ONMAXFRAMEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A5EAB50)
#define XFTWEAPON_XWEAPONTRAIL_ONPOINTENDVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A5EABB0)
#define XFTWEAPON_XWEAPONTRAIL_ONPOINTSTARTVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x1A5EABA0)
#define XFTWEAPON_XWEAPONTRAIL_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1A5E78E0)
#define XFTWEAPON_XWEAPONTRAIL_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1A5E7720)
#define XFTWEAPON_XWEAPONTRAIL_POSTSIMULATIONUPDATE_OFFSET UNITYSDK_OFFSET(0x1A5E80E0)
#define XFTWEAPON_XWEAPONTRAIL_RECORDCURELEM_OFFSET UNITYSDK_OFFSET(0x1A5E3F40)
#define XFTWEAPON_XWEAPONTRAIL_REFRESHSPLINE_OFFSET UNITYSDK_OFFSET(0x1A5E4C30)
#define XFTWEAPON_XWEAPONTRAIL_RESETVERTEXTDATA_OFFSET UNITYSDK_OFFSET(0x1A5E3B40)
#define XFTWEAPON_XWEAPONTRAIL_SET_NEEDRECORDINITPOS_OFFSET UNITYSDK_OFFSET(0x1A5E89D0)
#define XFTWEAPON_XWEAPONTRAIL_SIMULATE_CALCULATE_OFFSET UNITYSDK_OFFSET(0x1A5E5AF0)
#define XFTWEAPON_XWEAPONTRAIL_SIMULATE_OFFSET UNITYSDK_OFFSET(0x1A5E8480)
#define XFTWEAPON_XWEAPONTRAIL_SIMULATE_RECORDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A5E2AA0)
#define XFTWEAPON_XWEAPONTRAIL_SIMULATE_SENDDATATORENDERER_OFFSET UNITYSDK_OFFSET(0x1A5E75D0)
#define XFTWEAPON_XWEAPONTRAIL_SPAWNNEWPOINT_OFFSET UNITYSDK_OFFSET(0x1A5E8E90)
#define XFTWEAPON_XWEAPONTRAIL_START_OFFSET UNITYSDK_OFFSET(0x1A5E88C0)
#define XFTWEAPON_XWEAPONTRAIL_STOPSMOOTHLY_OFFSET UNITYSDK_OFFSET(0x1A5D7500)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEADDFORCEMESHWEIGHTAVECACHE_OFFSET UNITYSDK_OFFSET(0x1A5E27E0)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEFADE_OFFSET UNITYSDK_OFFSET(0x1A5E5770)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEHEADELEM_OFFSET UNITYSDK_OFFSET(0x1A5E3BA0)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEINDICES_DYNAMICVERSION_GCOPT_OFFSET UNITYSDK_OFFSET(0x1A5E23F0)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEINDICES_DYNAMICVERSION_OFFSET UNITYSDK_OFFSET(0x1A5E0A20)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEINDICES_GCOPT_OFFSET UNITYSDK_OFFSET(0x1A5E2010)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEINDICES_OFFSET UNITYSDK_OFFSET(0x1A5E3870)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEVERTEX_OFFSET UNITYSDK_OFFSET(0x1A5E5B40)
#define XFTWEAPON_XWEAPONTRAIL_VECTOREQUAL_OFFSET UNITYSDK_OFFSET(0x1A5EA8F0)
#define XFTWEAPON_XWEAPONTRAIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A5EABD0)
#define XFTWEAPON_XWEAPONTRAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5D63A0)

namespace XftWeapon
{
	inline static constexpr unsigned int XWeaponTrail_TypeDefinitionIndex = 37134;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x28650);
		}
		static ::System::Boolean* StaticGet_bSplineUseToArray()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x92C0);
		}
		static ::System::Boolean* StaticGet_UseGCOpt()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x92C1);
		}
		static ::System::Boolean* StaticGet_USE_JOB_SWITCH()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x92C2);
		}
		static ::System::Single* StaticGet_EPS()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x92C4);
		}
