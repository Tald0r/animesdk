...
#define XFTWEAPON_XWEAPONTRAIL_ACTIVATE_OFFSET UNITYSDK_OFFSET(0x19FBE580)
#define XFTWEAPON_XWEAPONTRAIL_ADDFORCEDISWEIGHTMINMESHDISLIMITSHOWIF_OFFSET UNITYSDK_OFFSET(0x19FC9930)
#define XFTWEAPON_XWEAPONTRAIL_AFTERUPDATE_OFFSET UNITYSDK_OFFSET(0x19FC98A0)
#define XFTWEAPON_XWEAPONTRAIL_APPLYATTACHPOINT_OFFSET UNITYSDK_OFFSET(0x19FC5650)
#define XFTWEAPON_XWEAPONTRAIL_BEFOREUPDATE_OFFSET UNITYSDK_OFFSET(0x19FC9840)
#define XFTWEAPON_XWEAPONTRAIL_BSPLINEBONESHAPERECORDPOINTS_OFFSET UNITYSDK_OFFSET(0x19FCF9D0)
#define XFTWEAPON_XWEAPONTRAIL_BSPLINEBONESHAPERECORDSNAPSHOTELEMDATA_OFFSET UNITYSDK_OFFSET(0x19FCFD80)
#define XFTWEAPON_XWEAPONTRAIL_BSPLINEFORDFSPOINTS_OFFSET UNITYSDK_OFFSET(0x19FD1200)
#define XFTWEAPON_XWEAPONTRAIL_BSPLINEREMOVEPOOLLASTPOINT_OFFSET UNITYSDK_OFFSET(0x19FD10E0)
#define XFTWEAPON_XWEAPONTRAIL_BUILDBSPLINECUSTOMSHAPERATELIST_OFFSET UNITYSDK_OFFSET(0x19FC5BF0)
#define XFTWEAPON_XWEAPONTRAIL_BUILDCONTROLLINKEDNODE_ADDHEADPOINT_OFFSET UNITYSDK_OFFSET(0x19FC77E0)
#define XFTWEAPON_XWEAPONTRAIL_BUILDCONTROLLINKEDNODE_DFS_OFFSET UNITYSDK_OFFSET(0x19FC8B00)
#define XFTWEAPON_XWEAPONTRAIL_BUILDCONTROLLINKEDNODE_OFFSET UNITYSDK_OFFSET(0x19FC6350)
#define XFTWEAPON_XWEAPONTRAIL_BUILDCONTROLLINKEDNODE_SPAWNNEWPOINT_OFFSET UNITYSDK_OFFSET(0x19FC7F10)
#define XFTWEAPON_XWEAPONTRAIL_DEACTIVATE_OFFSET UNITYSDK_OFFSET(0x19FBE500)
#define XFTWEAPON_XWEAPONTRAIL_ENSUREBSPLINECUSTOMSHAPETRANSFORMLISTPOSCACHE_OFFSET UNITYSDK_OFFSET(0x19FCC990)
#define XFTWEAPON_XWEAPONTRAIL_GETMESHRENDER_OFFSET UNITYSDK_OFFSET(0x19FCEB80)
#define XFTWEAPON_XWEAPONTRAIL_GET_ACTIVATED_OFFSET UNITYSDK_OFFSET(0x19FCE7D0)
#define XFTWEAPON_XWEAPONTRAIL_GET_BSPLINEBONESHAPE_OFFSET UNITYSDK_OFFSET(0x19FC5BD0)
#define XFTWEAPON_XWEAPONTRAIL_GET_BSPLINECUSTOMSHAPE_OFFSET UNITYSDK_OFFSET(0x19FC9150)
#define XFTWEAPON_XWEAPONTRAIL_GET_CURFRAMEISSTOPFRAME_OFFSET UNITYSDK_OFFSET(0x19FD18B0)
#define XFTWEAPON_XWEAPONTRAIL_GET_CURHEADPOS_OFFSET UNITYSDK_OFFSET(0x19FCE7E0)
#define XFTWEAPON_XWEAPONTRAIL_GET_DYNAMICMESHPOINTLENGTH_OFFSET UNITYSDK_OFFSET(0x19FC2470)
#define XFTWEAPON_XWEAPONTRAIL_GET_NEEDCALCMESHPERPOINTDIS_OFFSET UNITYSDK_OFFSET(0x19FC9900)
#define XFTWEAPON_XWEAPONTRAIL_GET_NEEDRECORDINITPOS_OFFSET UNITYSDK_OFFSET(0x19FCF9B0)
#define XFTWEAPON_XWEAPONTRAIL_GET_TRAILWIDTH_OFFSET UNITYSDK_OFFSET(0x19FCE8A0)
#define XFTWEAPON_XWEAPONTRAIL_GET_UPDATEINTERVAL_OFFSET UNITYSDK_OFFSET(0x19FCB090)
#define XFTWEAPON_XWEAPONTRAIL_GET_UPDATE_CONTROLPOINT_FULL_MODE_OFFSET UNITYSDK_OFFSET(0x19FC6320)
#define XFTWEAPON_XWEAPONTRAIL_GET_USEJOBOPT_OFFSET UNITYSDK_OFFSET(0x19FC9BC0)
#define XFTWEAPON_XWEAPONTRAIL_GOSTART_OFFSET UNITYSDK_OFFSET(0x19FCF930)
#define XFTWEAPON_XWEAPONTRAIL_GRAPHICSSETTINGSHOWIF_OFFSET UNITYSDK_OFFSET(0x19FC98F0)
#define XFTWEAPON_XWEAPONTRAIL_HASAPPLIEDBYFORCE_OFFSET UNITYSDK_OFFSET(0x19FC9920)
#define XFTWEAPON_XWEAPONTRAIL_INITDATACO_OFFSET UNITYSDK_OFFSET(0x19FCEB20)
#define XFTWEAPON_XWEAPONTRAIL_INITMESHOBJ_OFFSET UNITYSDK_OFFSET(0x19FCE990)
#define XFTWEAPON_XWEAPONTRAIL_INITORIGINALELEMENTS_OFFSET UNITYSDK_OFFSET(0x19FC9F40)
#define XFTWEAPON_XWEAPONTRAIL_INITSPLINE_OFFSET UNITYSDK_OFFSET(0x19FCA140)
#define XFTWEAPON_XWEAPONTRAIL_INIT_OFFSET UNITYSDK_OFFSET(0x19FBD7B0)
#define XFTWEAPON_XWEAPONTRAIL_MYPOSTRENDER_OFFSET UNITYSDK_OFFSET(0x19FCE710)
#define XFTWEAPON_XWEAPONTRAIL_MYPRERENDER_OFFSET UNITYSDK_OFFSET(0x19FCF670)
#define XFTWEAPON_XWEAPONTRAIL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19FCF890)
#define XFTWEAPON_XWEAPONTRAIL_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x19FCEEA0)
#define XFTWEAPON_XWEAPONTRAIL_ONENABLE_OFFSET UNITYSDK_OFFSET(0x19FCEBA0)
#define XFTWEAPON_XWEAPONTRAIL_ONMATERIALVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19FD1B30)
#define XFTWEAPON_XWEAPONTRAIL_ONMAXFRAMEVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19FD1B20)
#define XFTWEAPON_XWEAPONTRAIL_ONPOINTENDVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19FD1B80)
#define XFTWEAPON_XWEAPONTRAIL_ONPOINTSTARTVALUECHANGED_OFFSET UNITYSDK_OFFSET(0x19FD1B70)
#define XFTWEAPON_XWEAPONTRAIL_POSTSIMULATIONUPDATE_OFFSET UNITYSDK_OFFSET(0x19FCF0D0)
#define XFTWEAPON_XWEAPONTRAIL_RECORDCURELEM_OFFSET UNITYSDK_OFFSET(0x19FCB0B0)
#define XFTWEAPON_XWEAPONTRAIL_REFRESHSPLINE_OFFSET UNITYSDK_OFFSET(0x19FCBD90)
#define XFTWEAPON_XWEAPONTRAIL_RESETVERTEXTDATA_OFFSET UNITYSDK_OFFSET(0x19FCACB0)
#define XFTWEAPON_XWEAPONTRAIL_SET_NEEDRECORDINITPOS_OFFSET UNITYSDK_OFFSET(0x19FCF9C0)
#define XFTWEAPON_XWEAPONTRAIL_SIMULATE_CALCULATE_OFFSET UNITYSDK_OFFSET(0x19FCCC50)
#define XFTWEAPON_XWEAPONTRAIL_SIMULATE_OFFSET UNITYSDK_OFFSET(0x19FCF470)
#define XFTWEAPON_XWEAPONTRAIL_SIMULATE_RECORDTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19FC9C00)
#define XFTWEAPON_XWEAPONTRAIL_SIMULATE_SENDDATATORENDERER_OFFSET UNITYSDK_OFFSET(0x19FCE6F0)
#define XFTWEAPON_XWEAPONTRAIL_SPAWNNEWPOINT_OFFSET UNITYSDK_OFFSET(0x19FCFE80)
#define XFTWEAPON_XWEAPONTRAIL_START_OFFSET UNITYSDK_OFFSET(0x19FCF8B0)
#define XFTWEAPON_XWEAPONTRAIL_STOPSMOOTHLY_OFFSET UNITYSDK_OFFSET(0x19FBE5E0)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEADDFORCEMESHWEIGHTAVECACHE_OFFSET UNITYSDK_OFFSET(0x19FC9940)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEFADE_OFFSET UNITYSDK_OFFSET(0x19FCC8D0)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEHEADELEM_OFFSET UNITYSDK_OFFSET(0x19FCAD10)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEINDICES_DYNAMICVERSION_GCOPT_OFFSET UNITYSDK_OFFSET(0x19FC9550)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEINDICES_DYNAMICVERSION_OFFSET UNITYSDK_OFFSET(0x19FC7B80)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEINDICES_GCOPT_OFFSET UNITYSDK_OFFSET(0x19FC9170)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEINDICES_OFFSET UNITYSDK_OFFSET(0x19FCA9E0)
#define XFTWEAPON_XWEAPONTRAIL_UPDATEVERTEX_OFFSET UNITYSDK_OFFSET(0x19FCCCA0)
#define XFTWEAPON_XWEAPONTRAIL_VECTOREQUAL_OFFSET UNITYSDK_OFFSET(0x19FD18C0)
#define XFTWEAPON_XWEAPONTRAIL__CCTOR_OFFSET UNITYSDK_OFFSET(0x19FD1BA0)
#define XFTWEAPON_XWEAPONTRAIL__CTOR_OFFSET UNITYSDK_OFFSET(0x19FBD480)

namespace XftWeapon
{
	inline static constexpr unsigned int XWeaponTrail_TypeDefinitionIndex = 36114;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x26C20);
		}
		static ::System::Single* StaticGet_EPS()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x8F60);
		}
		static ::System::Boolean* StaticGet_UseGCOpt()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x8F64);
		}
		static ::System::Boolean* StaticGet_bSplineUseToArray()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x8F65);
		}
		static ::System::Boolean* StaticGet_USE_JOB_SWITCH()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(XWeaponTrail_TypeDefinitionIndex)->GetStaticField(0x8F66);
		}
