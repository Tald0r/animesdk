...
#define XFTWEAPON_XWEAPONTRAIL__INITDATACO_D__127_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A5EAC10)
#define XFTWEAPON_XWEAPONTRAIL__INITDATACO_D__127_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A5EACB0)
#define XFTWEAPON_XWEAPONTRAIL__INITDATACO_D__127_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A5EAD10)
#define XFTWEAPON_XWEAPONTRAIL__INITDATACO_D__127_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A5EACC0)
#define XFTWEAPON_XWEAPONTRAIL__INITDATACO_D__127_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A5EAC00)
#define XFTWEAPON_XWEAPONTRAIL__INITDATACO_D__127__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5E7E40)

namespace XftWeapon
{
	inline static constexpr unsigned int XWeaponTrail__InitDataCo_d__127_TypeDefinitionIndex = 37139;
