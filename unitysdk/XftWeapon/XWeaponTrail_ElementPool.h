...
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_COUNTACTIVE_OFFSET UNITYSDK_OFFSET(0x1A5EAE90)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_COUNTALL_OFFSET UNITYSDK_OFFSET(0x1A5EAE70)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_COUNTINACTIVE_OFFSET UNITYSDK_OFFSET(0x1A5EAEB0)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_OFFSET UNITYSDK_OFFSET(0x1A5EA9B0)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A5EAA20)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_SET_COUNTALL_OFFSET UNITYSDK_OFFSET(0x1A5EAE80)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5E7B90)

namespace XftWeapon
{
	inline static constexpr unsigned int XWeaponTrail_ElementPool_TypeDefinitionIndex = 37138;
