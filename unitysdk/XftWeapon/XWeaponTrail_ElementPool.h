...
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_COUNTACTIVE_OFFSET UNITYSDK_OFFSET(0x19FD1E70)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_COUNTALL_OFFSET UNITYSDK_OFFSET(0x19FD1E50)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_COUNTINACTIVE_OFFSET UNITYSDK_OFFSET(0x19FD1E90)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_GET_OFFSET UNITYSDK_OFFSET(0x19FD1980)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_RELEASE_OFFSET UNITYSDK_OFFSET(0x19FD19F0)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL_SET_COUNTALL_OFFSET UNITYSDK_OFFSET(0x19FD1E60)
#define XFTWEAPON_XWEAPONTRAIL_ELEMENTPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x19FCE8B0)

namespace XftWeapon
{
	inline static constexpr unsigned int XWeaponTrail_ElementPool_TypeDefinitionIndex = 36118;
