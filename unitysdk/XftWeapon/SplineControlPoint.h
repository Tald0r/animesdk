...
#define XFTWEAPON_SPLINECONTROLPOINT_GETNEXT2NORMAL_OFFSET UNITYSDK_OFFSET(0x19FC19C0)
#define XFTWEAPON_SPLINECONTROLPOINT_GETNEXT2POSITION_OFFSET UNITYSDK_OFFSET(0x19FC18F0)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x19FC1570)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_NEXTCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x19FC1680)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_NEXTNORMAL_OFFSET UNITYSDK_OFFSET(0x19FC1810)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_NEXTPOSITION_OFFSET UNITYSDK_OFFSET(0x19FC1730)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_PREVIOUSCONTROLPOINT_OFFSET UNITYSDK_OFFSET(0x19FC16D0)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_PREVIOUSNORMAL_OFFSET UNITYSDK_OFFSET(0x19FC1880)
#define XFTWEAPON_SPLINECONTROLPOINT_GET_PREVIOUSPOSITION_OFFSET UNITYSDK_OFFSET(0x19FC17A0)
#define XFTWEAPON_SPLINECONTROLPOINT_INIT_OFFSET UNITYSDK_OFFSET(0x19FC12B0)
#define XFTWEAPON_SPLINECONTROLPOINT_INTERPOLATENORMAL_OFFSET UNITYSDK_OFFSET(0x19FC0EF0)
#define XFTWEAPON_SPLINECONTROLPOINT_INTERPOLATE_OFFSET UNITYSDK_OFFSET(0x19FC0B60)
#define XFTWEAPON_SPLINECONTROLPOINT__CTOR_OFFSET UNITYSDK_OFFSET(0x19FBFEE0)

namespace XftWeapon
{
	inline static constexpr unsigned int SplineControlPoint_TypeDefinitionIndex = 36111;

	class SplineControlPoint : public ::System::Object
	{
	public:
		::XftWeapon::Spline* mSpline; // 0x10
		...
		::System::Int32 ControlPointIndex; // 0x50
		::System::Single Dist; // 0x54
