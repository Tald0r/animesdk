...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_AFTERREFRESHARROW_OFFSET UNITYSDK_OFFSET(0x9F18520)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_CALARROWRED_OFFSET UNITYSDK_OFFSET(0x9F18010)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_CALARROWSTATE_OFFSET UNITYSDK_OFFSET(0x9F17F90)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET_CONTENT_OFFSET UNITYSDK_OFFSET(0x9F18970)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET_DATACOUNT_OFFSET UNITYSDK_OFFSET(0x9F188E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET_LOGIC_OFFSET UNITYSDK_OFFSET(0x9F18910)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET_SIMPLEMODE_OFFSET UNITYSDK_OFFSET(0x9F18950)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_GET__SCROLLPARAMS_OFFSET UNITYSDK_OFFSET(0x9F18930)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_HIDESCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0x9F183A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_INITSCROLLVIEWARROWBTN_OFFSET UNITYSDK_OFFSET(0x9F173D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9F17690)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_MARKARROWDIRTY_OFFSET UNITYSDK_OFFSET(0x9F17D30)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x9F17320)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_ONENABLENEXTFRAME_OFFSET UNITYSDK_OFFSET(0x9F17960)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x9F17B10)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_REFRESHARROWIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x9F17E00)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_RESETSCROLLVIEWARROWINNER_OFFSET UNITYSDK_OFFSET(0x9F182A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_RESETSCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0x9F179D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_SHOWSCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0x9F18460)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_UPDATEONENABLEDELAYMARKARROWDIRTY_OFFSET UNITYSDK_OFFSET(0x9F17780)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW_UPDATESCROLLVIEWARROW_OFFSET UNITYSDK_OFFSET(0x9F178C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__BYCONTENTEND_16_5_OFFSET UNITYSDK_OFFSET(0x9F19AD0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__BYCONTENTSTART_16_3_OFFSET UNITYSDK_OFFSET(0x9F192D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__BYFIRSTITEM_16_2_OFFSET UNITYSDK_OFFSET(0x9F18F60)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__BYLASTITEM_16_4_OFFSET UNITYSDK_OFFSET(0x9F19710)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__ISEND_16_1_OFFSET UNITYSDK_OFFSET(0x9F18840)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CALARROWSTATE_G__ISSTART_16_0_OFFSET UNITYSDK_OFFSET(0x9F187A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CCTOR_OFFSET UNITYSDK_OFFSET(0x9F18990)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__CTOR_OFFSET UNITYSDK_OFFSET(0x9F17310)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_B__14_0_OFFSET UNITYSDK_OFFSET(0x9F189D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_B__14_1_OFFSET UNITYSDK_OFFSET(0x9F18C00)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_G__GETINDEX_14_3_OFFSET UNITYSDK_OFFSET(0x9F18C10)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_G__SCROLLTO_14_2_OFFSET UNITYSDK_OFFSET(0x9F189E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__INITSCROLLVIEWARROWBTN_G__TRYSCROLLTOINDEX_14_4_OFFSET UNITYSDK_OFFSET(0x9F18D90)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__UPDATESCROLLVIEWARROW_G__UPDATEARROWREDDOT_12_1_OFFSET UNITYSDK_OFFSET(0x9F18790)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW__UPDATESCROLLVIEWARROW_G__UPDATEARROW_12_0_OFFSET UNITYSDK_OFFSET(0x9F18590)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW___BASE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x9F19F20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW___BASE_ONAWAKE_OFFSET UNITYSDK_OFFSET(0x9F19F80)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW___BASE_ONENABLENEXTFRAME_OFFSET UNITYSDK_OFFSET(0x9F19FE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINARROW___BASE_ONSCROLLVIEWITEMMOVE_OFFSET UNITYSDK_OFFSET(0x9F1A040)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginArrow_TypeDefinitionIndex = 64420;
...
public:
	...
	{
		return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(MonoUITableScrollV2_TableScrollPluginArrow_TypeDefinitionIndex)->GetStaticField(0x10880);
	}
	::System::Func_3<::System::Int32, ::System::Int32, ::System::Boolean>* GetRedRange; // 0x18
	::UnityEngine::UI::Extension::UIButtonEx* EndBtn; // 0x20
	::MoleMole::ScrollViewArrow* _scrollViewArrow; // 0x28
	::UnityEngine::UI::Extension::UIButtonEx* StartBtn; // 0x30
	...
	::System::ValueTuple_2<::System::Boolean, ::System::Boolean> _lastFrameScrollViewArrowState; // 0x3D
	::System::ValueTuple_2<::System::Boolean, ::System::Boolean> _currentFrameScrollViewArrowState; // 0x3F
