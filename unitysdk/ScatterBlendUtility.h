...
#define SCATTERBLENDUTILITY_CALCULATEDISTANCETOARC_OFFSET UNITYSDK_OFFSET(0x16C3B260)
#define SCATTERBLENDUTILITY_COMPUTEBARYCENTRICCOORDINATES_OFFSET UNITYSDK_OFFSET(0x16C3C700)
#define SCATTERBLENDUTILITY_GETBONEDIRVEC_OFFSET UNITYSDK_OFFSET(0x16C3A790)
#define SCATTERBLENDUTILITY_GETBONEPITCHYAW_OFFSET UNITYSDK_OFFSET(0x16C3A3E0)
#define SCATTERBLENDUTILITY_GETINTERSECTIONPOINT_OFFSET UNITYSDK_OFFSET(0x16C3C4D0)
#define SCATTERBLENDUTILITY_ISPOINTINSPHERICALTRIANGLE_OFFSET UNITYSDK_OFFSET(0x16C3AB40)
#define SCATTERBLENDUTILITY_ISPOINTONARC_OFFSET UNITYSDK_OFFSET(0x16C3AEC0)
#define SCATTERBLENDUTILITY_PROJECTIONCLOSESTAPPROACHSPHERE_1_OFFSET UNITYSDK_OFFSET(0x16C3BCB0)
#define SCATTERBLENDUTILITY_PROJECTIONCLOSESTAPPROACHSPHERE_OFFSET UNITYSDK_OFFSET(0x16C3B570)
#define SCATTERBLENDUTILITY_PROJECTIONCLOSESTAPPROACH_OFFSET UNITYSDK_OFFSET(0x16C3CA30)
#define SCATTERBLENDUTILITY_TRIANGLEBARYCENTRICTOBILINEAR_OFFSET UNITYSDK_OFFSET(0x16C3C940)

inline static constexpr unsigned int ScatterBlendUtility_TypeDefinitionIndex = 78050;
