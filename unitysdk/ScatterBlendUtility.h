...
#define SCATTERBLENDUTILITY_CALCULATEDISTANCETOARC_OFFSET UNITYSDK_OFFSET(0x1ABB4D40)
#define SCATTERBLENDUTILITY_COMPUTEBARYCENTRICCOORDINATES_OFFSET UNITYSDK_OFFSET(0x1ABB61E0)
#define SCATTERBLENDUTILITY_GETBONEDIRVEC_OFFSET UNITYSDK_OFFSET(0x1ABB4270)
#define SCATTERBLENDUTILITY_GETBONEPITCHYAW_OFFSET UNITYSDK_OFFSET(0x1ABB3EC0)
#define SCATTERBLENDUTILITY_GETINTERSECTIONPOINT_OFFSET UNITYSDK_OFFSET(0x1ABB5FB0)
#define SCATTERBLENDUTILITY_ISPOINTINSPHERICALTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1ABB4620)
#define SCATTERBLENDUTILITY_ISPOINTONARC_OFFSET UNITYSDK_OFFSET(0x1ABB49A0)
#define SCATTERBLENDUTILITY_PROJECTIONCLOSESTAPPROACHSPHERE_1_OFFSET UNITYSDK_OFFSET(0x1ABB5790)
#define SCATTERBLENDUTILITY_PROJECTIONCLOSESTAPPROACHSPHERE_OFFSET UNITYSDK_OFFSET(0x1ABB5050)
#define SCATTERBLENDUTILITY_PROJECTIONCLOSESTAPPROACH_OFFSET UNITYSDK_OFFSET(0x1ABB6510)
#define SCATTERBLENDUTILITY_TRIANGLEBARYCENTRICTOBILINEAR_OFFSET UNITYSDK_OFFSET(0x1ABB6420)

inline static constexpr unsigned int ScatterBlendUtility_TypeDefinitionIndex = 53833;
