...
#define CLASS_2_FB0CA2C4A4F857A4_METHOD_2_016E85CEDEE00FF4_OFFSET UNITYSDK_OFFSET(0x1A676970)
#define CLASS_2_FB0CA2C4A4F857A4_METHOD_2_0DCA45EDA639F38E_OFFSET UNITYSDK_OFFSET(0x1A676890)
#define CLASS_2_FB0CA2C4A4F857A4__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A676880)
#define CLASS_2_FB0CA2C4A4F857A4__CTOR_OFFSET UNITYSDK_OFFSET(0x1A676860)

inline static constexpr unsigned int Class_2_FB0CA2C4A4F857A4_TypeDefinitionIndex = 8033;
...
public:
	...
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Class_2_FB0CA2C4A4F857A4_TypeDefinitionIndex)->GetStaticField(0x3740);
	}
	::Class_0_16E4307DCC419505_1* Field_2_1; // 0x10
	::Class_0_16E4307DCC419505_1* Field_2_2; // 0x18
