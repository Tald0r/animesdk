...
#define CLASS_3_6B90C9F119FE08BB_GETCLASSID_OFFSET UNITYSDK_OFFSET(0xAA773F0)
#define CLASS_3_6B90C9F119FE08BB_METHOD_3_4AA7827CFB505DDD_OFFSET UNITYSDK_OFFSET(0xAA77540)
#define CLASS_3_6B90C9F119FE08BB_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xAA77630)
#define CLASS_3_6B90C9F119FE08BB_METHOD_3_FFFD00FEC6029AE6_OFFSET UNITYSDK_OFFSET(0xAA77690)
#define CLASS_3_6B90C9F119FE08BB_ONCLEAN_OFFSET UNITYSDK_OFFSET(0xAA77210)
#define CLASS_3_6B90C9F119FE08BB__CCTOR_OFFSET UNITYSDK_OFFSET(0xAA77450)
#define CLASS_3_6B90C9F119FE08BB__CTOR_OFFSET UNITYSDK_OFFSET(0xAA774D0)

inline static constexpr unsigned int Class_3_6B90C9F119FE08BB_TypeDefinitionIndex = 56872;

class Class_3_6B90C9F119FE08BB : public ::Class_2_F3CFF1AFF7EE7DCD
{
public:
	// static const ::System::Int32 Field_3_8 = 0x6; // 0x0
	::Class_2_93A9E55A4E05FAD9* Field_3_3; // 0x48
	::Class_2_93A9E55A4E05FAD9_1* Field_3_5; // 0x50
	::Class_2_93A9E55A4E05FAD9_2* Field_3_4; // 0x58
	::MoleMole::Config::AttackPatternMorphBase* Field_3_1; // 0x60
	::MoleMole::Battle::Entity* Field_3_7; // 0x68
	::Class_1_CFC8E3321E6584C8* Field_3_0; // 0x70
	::System::Single Field_3_6; // 0x78
	::Enum_3_9666512A8D753070 Field_3_2; // 0x7C
