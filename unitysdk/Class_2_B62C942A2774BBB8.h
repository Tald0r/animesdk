...
#define CLASS_2_B62C942A2774BBB8_METHOD_2_24748FC20F375725_OFFSET UNITYSDK_OFFSET(0x8317130)
#define CLASS_2_B62C942A2774BBB8_METHOD_2_89D1F247B9D324EE_OFFSET UNITYSDK_OFFSET(0x8316E10)
#define CLASS_2_B62C942A2774BBB8_METHOD_2_8C8625211DA811AE_OFFSET UNITYSDK_OFFSET(0x83172E0)
#define CLASS_2_B62C942A2774BBB8_METHOD_2_A4ADEEB3FB7DBABB_OFFSET UNITYSDK_OFFSET(0x8317140)
#define CLASS_2_B62C942A2774BBB8_METHOD_2_BC516BD7B592E51E_OFFSET UNITYSDK_OFFSET(0x8317010)
#define CLASS_2_B62C942A2774BBB8_METHOD_2_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x8317280)
#define CLASS_2_B62C942A2774BBB8_METHOD_2_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x83170C0)
#define CLASS_2_B62C942A2774BBB8_METHOD_2_F8B73ECE7F883AC1_OFFSET UNITYSDK_OFFSET(0x8316F30)
#define CLASS_2_B62C942A2774BBB8__CCTOR_OFFSET UNITYSDK_OFFSET(0x8316F90)
#define CLASS_2_B62C942A2774BBB8__CTOR_OFFSET UNITYSDK_OFFSET(0x8317000)

inline static constexpr unsigned int Class_2_B62C942A2774BBB8_TypeDefinitionIndex = 73365;
...
public:
	...
	::MoleMole::Config::AnimatorAirHitType Field_2_5; // 0x2C
	::System::UInt32 Field_2_2; // 0x30
	::MoleMole::Config::AnimatorHitEffect Field_2_4; // 0x34
	::MoleMole::Config::AnimatorGroundHitType Field_2_3; // 0x38
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_2_B62C942A2774BBB8_METHOD_2_BC516BD7B592E51E_OFFSET))(this);
	}
