...
#define BONEADJUST_ADJUSTBONETRANSFORMBYONEBONELAYERDATAWITH2TARGETPOSE_OFFSET UNITYSDK_OFFSET(0x6CEC690)
#define BONEADJUST_ADJUSTBONETRANSFORMBYSCATTER2DBLEND_OFFSET UNITYSDK_OFFSET(0x6CE9C00)
#define BONEADJUST_ADJUSTBONETRANSFORMBYVELOCITYIMPL_OFFSET UNITYSDK_OFFSET(0x6CEE180)
#define BONEADJUST_ADJUSTBONETRANSFORMBYVELOCITY_OFFSET UNITYSDK_OFFSET(0x6CEBDE0)
#define BONEADJUST_BLEND2DCOMPUTECHILDNODEWEIGHTS_OFFSET UNITYSDK_OFFSET(0x6CECF10)
#define BONEADJUST_GET_ANIMDIRVEC_OFFSET UNITYSDK_OFFSET(0x6CE68B0)
#define BONEADJUST_GET_ENABLEFORWARDLEANING_OFFSET UNITYSDK_OFFSET(0x6CE68D0)
#define BONEADJUST_GET_FORCEENABLEKNEESMOOTH_OFFSET UNITYSDK_OFFSET(0x6CE6850)
#define BONEADJUST_GET_IKDIRVEC_OFFSET UNITYSDK_OFFSET(0x6CE68C0)
#define BONEADJUST_GET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x6CE6830)
#define BONEADJUST_GET_OVERRIDEDDOWNSTAIRKNEEBENDSPEED_OFFSET UNITYSDK_OFFSET(0x6CE6890)
#define BONEADJUST_GET_OVERRIDEDUPSTAIRKNEEBENDSPEED_OFFSET UNITYSDK_OFFSET(0x6CE6870)
#define BONEADJUST_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x6CE68F0)
#define BONEADJUST_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x6CEC3D0)
#define BONEADJUST_LIFTBONESACCORDINGIK_OFFSET UNITYSDK_OFFSET(0x6CEC440)
#define BONEADJUST_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x6CE86D0)
#define BONEADJUST_ONLATEANIMAGEIK_OFFSET UNITYSDK_OFFSET(0x6CE91B0)
#define BONEADJUST_RECORDANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0x6CE7EB0)
#define BONEADJUST_SET_ENABLEFORWARDLEANING_OFFSET UNITYSDK_OFFSET(0x6CE68E0)
#define BONEADJUST_SET_FORCEENABLEKNEESMOOTH_OFFSET UNITYSDK_OFFSET(0x6CE6860)
#define BONEADJUST_SET_ISONMOVINGPLATFORM_OFFSET UNITYSDK_OFFSET(0x6CE6840)
#define BONEADJUST_SET_OVERRIDEDDOWNSTAIRKNEEBENDSPEED_OFFSET UNITYSDK_OFFSET(0x6CE68A0)
#define BONEADJUST_SET_OVERRIDEDUPSTAIRKNEEBENDSPEED_OFFSET UNITYSDK_OFFSET(0x6CE6880)
#define BONEADJUST_SMOOTHKNEE_OFFSET UNITYSDK_OFFSET(0x6CE9240)
#define BONEADJUST_START_OFFSET UNITYSDK_OFFSET(0x6CE7E40)
#define BONEADJUST_UPDATE_OFFSET UNITYSDK_OFFSET(0x6CE8590)
#define BONEADJUST__CTOR_OFFSET UNITYSDK_OFFSET(0x6CEE660)

inline static constexpr unsigned int BoneAdjust_TypeDefinitionIndex = 81132;
