...
#define FUNCTIONSWITCHMANAGER_BUILDFUNCMASKLEVEL_OFFSET UNITYSDK_OFFSET(0x965A9A0)
#define FUNCTIONSWITCHMANAGER_GETFUNCMASKLEVEL_OFFSET UNITYSDK_OFFSET(0x965AEB0)
#define FUNCTIONSWITCHMANAGER_REMOVEFUNCMASKLEVEL_OFFSET UNITYSDK_OFFSET(0x965AC90)
#define FUNCTIONSWITCHMANAGER_UPDATEFUNCMASKLEVEL_OFFSET UNITYSDK_OFFSET(0x965AA00)
#define FUNCTIONSWITCHMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x965AFF0)

inline static constexpr unsigned int FunctionSwitchManager_TypeDefinitionIndex = 56008;
