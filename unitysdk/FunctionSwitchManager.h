...
#define FUNCTIONSWITCHMANAGER_BUILDFUNCMASKLEVEL_OFFSET UNITYSDK_OFFSET(0x6D179B0)
#define FUNCTIONSWITCHMANAGER_GETFUNCMASKLEVEL_OFFSET UNITYSDK_OFFSET(0x6D17EC0)
#define FUNCTIONSWITCHMANAGER_REMOVEFUNCMASKLEVEL_OFFSET UNITYSDK_OFFSET(0x6D17CA0)
#define FUNCTIONSWITCHMANAGER_UPDATEFUNCMASKLEVEL_OFFSET UNITYSDK_OFFSET(0x6D17A10)
#define FUNCTIONSWITCHMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x6D18000)

inline static constexpr unsigned int FunctionSwitchManager_TypeDefinitionIndex = 49813;
