...
#define UICONTROLREFERENCELIST_GETGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0xD85F260)
#define UICONTROLREFERENCELIST_GETIMAGES_OFFSET UNITYSDK_OFFSET(0xD85F3A0)
#define UICONTROLREFERENCELIST_GETTEXTS_OFFSET UNITYSDK_OFFSET(0xD85F310)
#define UICONTROLREFERENCELIST__CTOR_OFFSET UNITYSDK_OFFSET(0xD85F430)

inline static constexpr unsigned int UIControlReferenceList_TypeDefinitionIndex = 49694;
