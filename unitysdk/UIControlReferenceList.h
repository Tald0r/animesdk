...
#define UICONTROLREFERENCELIST_GETGAMEOBJECTS_OFFSET UNITYSDK_OFFSET(0x17CCCB50)
#define UICONTROLREFERENCELIST_GETIMAGES_OFFSET UNITYSDK_OFFSET(0x17CCCC90)
#define UICONTROLREFERENCELIST_GETTEXTS_OFFSET UNITYSDK_OFFSET(0x17CCCC00)
#define UICONTROLREFERENCELIST__CTOR_OFFSET UNITYSDK_OFFSET(0x17CCCD20)

inline static constexpr unsigned int UIControlReferenceList_TypeDefinitionIndex = 66885;
