...
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_GET_MOUSEXCURVE_OFFSET UNITYSDK_OFFSET(0x8DEDC40)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_GET_NORMALIZEDMOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x8DEDB40)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8DEDCC0)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_SET_MOUSEXCURVE_OFFSET UNITYSDK_OFFSET(0x8DEDC50)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_SET_NORMALIZEDMOUSEPOSITION_OFFSET UNITYSDK_OFFSET(0x8DEDB50)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR_UPDATE_OFFSET UNITYSDK_OFFSET(0x8DEDD60)
#define CODE_LOGIC_UI_UICOMPONENT_MONOMINDSCAPELENTICULAR__CTOR_OFFSET UNITYSDK_OFFSET(0x8DEE110)

namespace Code::Logic::UI::UIComponent
{
	inline static constexpr unsigned int MonoMindscapeLenticular_TypeDefinitionIndex = 45413;
