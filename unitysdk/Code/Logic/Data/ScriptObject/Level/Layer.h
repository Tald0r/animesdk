...
#define CODE_LOGIC_DATA_SCRIPTOBJECT_LEVEL_LAYER__CTOR_OFFSET UNITYSDK_OFFSET(0xC9FF580)

namespace Code::Logic::Data::ScriptObject::Level
{
	inline static constexpr unsigned int Layer_TypeDefinitionIndex = 65184;
