...
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKFINALCAMERADATA___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0x9067FD0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKFINALCAMERADATA___C__DISPLAYCLASS0_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0x9067FE0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKFINALCAMERADATA___C__DISPLAYCLASS0_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0x90680D0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKFINALCAMERADATA___C__DISPLAYCLASS0_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0x90681B0)

namespace Code::Logic::Canvas::LevelDesign
{
	inline static constexpr unsigned int LDBreakFinalCameraData___c__DisplayClass0_0_TypeDefinitionIndex = 75752;
