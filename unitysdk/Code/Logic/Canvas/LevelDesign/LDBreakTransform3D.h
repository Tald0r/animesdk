...
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKTRANSFORM3D_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x9F3D220)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKTRANSFORM3D__CTOR_OFFSET UNITYSDK_OFFSET(0x9F3D3C0)

namespace Code::Logic::Canvas::LevelDesign
{
	inline static constexpr unsigned int LDBreakTransform3D_TypeDefinitionIndex = 44359;
