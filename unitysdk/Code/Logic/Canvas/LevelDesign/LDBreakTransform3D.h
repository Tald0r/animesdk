...
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKTRANSFORM3D_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x908D2A0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKTRANSFORM3D__CTOR_OFFSET UNITYSDK_OFFSET(0x908D440)

namespace Code::Logic::Canvas::LevelDesign
{
	inline static constexpr unsigned int LDBreakTransform3D_TypeDefinitionIndex = 54765;
