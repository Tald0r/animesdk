...
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDGETLASTCAMERADATA_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xBCA9DE0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDGETLASTCAMERADATA__CTOR_OFFSET UNITYSDK_OFFSET(0xBCA9F40)

namespace Code::Logic::Canvas::LevelDesign
{
	inline static constexpr unsigned int LDGetLastCameraData_TypeDefinitionIndex = 52208;
