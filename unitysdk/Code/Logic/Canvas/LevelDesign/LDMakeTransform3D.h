...
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDMAKETRANSFORM3D_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0x9F3D3E0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDMAKETRANSFORM3D__CTOR_OFFSET UNITYSDK_OFFSET(0x9F3D530)

namespace Code::Logic::Canvas::LevelDesign
{
	inline static constexpr unsigned int LDMakeTransform3D_TypeDefinitionIndex = 65017;
