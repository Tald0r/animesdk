...
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDMODIFYTIMERWIDGET_INVOKE_OFFSET UNITYSDK_OFFSET(0xC9FF2F0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDMODIFYTIMERWIDGET__CTOR_OFFSET UNITYSDK_OFFSET(0xC9FF560)

namespace Code::Logic::Canvas::LevelDesign
{
	inline static constexpr unsigned int LDModifyTimerWidget_TypeDefinitionIndex = 41062;
