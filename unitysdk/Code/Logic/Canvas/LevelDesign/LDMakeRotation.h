...
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDMAKEROTATION_REGISTERPORTS_OFFSET UNITYSDK_OFFSET(0xBCA9F60)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDMAKEROTATION__CTOR_OFFSET UNITYSDK_OFFSET(0xBCAA0B0)

namespace Code::Logic::Canvas::LevelDesign
{
	inline static constexpr unsigned int LDMakeRotation_TypeDefinitionIndex = 59985;
