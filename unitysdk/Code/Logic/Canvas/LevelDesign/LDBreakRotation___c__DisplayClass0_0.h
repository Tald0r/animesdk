...
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKROTATION___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBD9A7E0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKROTATION___C__DISPLAYCLASS0_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0xBD9A7F0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKROTATION___C__DISPLAYCLASS0_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0xBD9A8A0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKROTATION___C__DISPLAYCLASS0_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0xBD9A950)

namespace Code::Logic::Canvas::LevelDesign
{
	inline static constexpr unsigned int LDBreakRotation___c__DisplayClass0_0_TypeDefinitionIndex = 40850;
