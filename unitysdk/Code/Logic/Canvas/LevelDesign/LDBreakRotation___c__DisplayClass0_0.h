...
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKROTATION___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0xB59B7F0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKROTATION___C__DISPLAYCLASS0_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0xB59B800)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKROTATION___C__DISPLAYCLASS0_0__REGISTERPORTS_B__1_OFFSET UNITYSDK_OFFSET(0xB59B8B0)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDBREAKROTATION___C__DISPLAYCLASS0_0__REGISTERPORTS_B__2_OFFSET UNITYSDK_OFFSET(0xB59B960)

namespace Code::Logic::Canvas::LevelDesign
{
	inline static constexpr unsigned int LDBreakRotation___c__DisplayClass0_0_TypeDefinitionIndex = 62810;
