...
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDMAKEVECTOR3___C__DISPLAYCLASS0_0__CTOR_OFFSET UNITYSDK_OFFSET(0xBD9AA00)
#define CODE_LOGIC_CANVAS_LEVELDESIGN_LDMAKEVECTOR3___C__DISPLAYCLASS0_0__REGISTERPORTS_B__0_OFFSET UNITYSDK_OFFSET(0xBD9AA10)

namespace Code::Logic::Canvas::LevelDesign
{
	inline static constexpr unsigned int LDMakeVector3___c__DisplayClass0_0_TypeDefinitionIndex = 38807;

	class LDMakeVector3___c__DisplayClass0_0 : public ::System::Object
	{
	public:
		::FlowCanvas::ValueInput_1<::System::Single>* y; // 0x10
