...
#define FOUNDATION_DATASTRUCTURES_BITHELPER_ISMARKED_OFFSET UNITYSDK_OFFSET(0x193F49F0)
#define FOUNDATION_DATASTRUCTURES_BITHELPER_MARKBIT_OFFSET UNITYSDK_OFFSET(0x193F4920)
#define FOUNDATION_DATASTRUCTURES_BITHELPER_TOINTARRAYLENGTH_OFFSET UNITYSDK_OFFSET(0x193F4AC0)
#define FOUNDATION_DATASTRUCTURES_BITHELPER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x193F4910)
#define FOUNDATION_DATASTRUCTURES_BITHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x193F4900)

namespace Foundation::DataStructures
{
	inline static constexpr unsigned int BitHelper_TypeDefinitionIndex = 8053;
