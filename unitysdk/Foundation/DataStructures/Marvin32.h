...
#define FOUNDATION_DATASTRUCTURES_MARVIN32_COMPUTEHASH_1_OFFSET UNITYSDK_OFFSET(0x1784DE00)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_COMPUTEHASH_2_OFFSET UNITYSDK_OFFSET(0x1784DD60)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_COMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x1784DB40)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_MARVIN32_MIX_OFFSET UNITYSDK_OFFSET(0x1784D6C0)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_ROTL32_OFFSET UNITYSDK_OFFSET(0x1784D4D0)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_U8TO32_LE_OFFSET UNITYSDK_OFFSET(0x1784D6B0)

namespace Foundation::DataStructures
{
	inline static constexpr unsigned int Marvin32_TypeDefinitionIndex = 7827;
