...
#define FOUNDATION_DATASTRUCTURES_MARVIN32_COMPUTEHASH_1_OFFSET UNITYSDK_OFFSET(0x170E0A10)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_COMPUTEHASH_2_OFFSET UNITYSDK_OFFSET(0x170E0970)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_COMPUTEHASH_OFFSET UNITYSDK_OFFSET(0x170E0750)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_MARVIN32_MIX_OFFSET UNITYSDK_OFFSET(0x170E02D0)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_ROTL32_OFFSET UNITYSDK_OFFSET(0x170E00E0)
#define FOUNDATION_DATASTRUCTURES_MARVIN32_U8TO32_LE_OFFSET UNITYSDK_OFFSET(0x170E02C0)

namespace Foundation::DataStructures
{
	inline static constexpr unsigned int Marvin32_TypeDefinitionIndex = 7690;
