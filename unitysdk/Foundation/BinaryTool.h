...
#define FOUNDATION_BINARYTOOL_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x1A84E600)
#define FOUNDATION_BINARYTOOL_FROMBINARY_10_OFFSET UNITYSDK_OFFSET(0x1A84FB80)
#define FOUNDATION_BINARYTOOL_FROMBINARY_11_OFFSET UNITYSDK_OFFSET(0x1A84FDE0)
#define FOUNDATION_BINARYTOOL_FROMBINARY_12_OFFSET UNITYSDK_OFFSET(0x1A84FFE0)
#define FOUNDATION_BINARYTOOL_FROMBINARY_1_OFFSET UNITYSDK_OFFSET(0x1A84E950)
#define FOUNDATION_BINARYTOOL_FROMBINARY_2_OFFSET UNITYSDK_OFFSET(0x1A84EB80)
#define FOUNDATION_BINARYTOOL_FROMBINARY_3_OFFSET UNITYSDK_OFFSET(0x1A84EDB0)
#define FOUNDATION_BINARYTOOL_FROMBINARY_4_OFFSET UNITYSDK_OFFSET(0x1A84EF50)
#define FOUNDATION_BINARYTOOL_FROMBINARY_5_OFFSET UNITYSDK_OFFSET(0x1A84F180)
#define FOUNDATION_BINARYTOOL_FROMBINARY_6_OFFSET UNITYSDK_OFFSET(0x1A84F320)
#define FOUNDATION_BINARYTOOL_FROMBINARY_7_OFFSET UNITYSDK_OFFSET(0x1A84F550)
#define FOUNDATION_BINARYTOOL_FROMBINARY_8_OFFSET UNITYSDK_OFFSET(0x1A84F700)
#define FOUNDATION_BINARYTOOL_FROMBINARY_9_OFFSET UNITYSDK_OFFSET(0x1A84F930)
#define FOUNDATION_BINARYTOOL_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A84E680)
#define FOUNDATION_BINARYTOOL_READARRAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1A8503B0)
#define FOUNDATION_BINARYTOOL_READDICTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A850570)
#define FOUNDATION_BINARYTOOL_READLISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A850490)
#define FOUNDATION_BINARYTOOL_READSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1A8502D0)
#define FOUNDATION_BINARYTOOL_READTYPEINDEX_OFFSET UNITYSDK_OFFSET(0x1A850650)
#define FOUNDATION_BINARYTOOL_TOBINARY_10_OFFSET UNITYSDK_OFFSET(0x1A851240)
#define FOUNDATION_BINARYTOOL_TOBINARY_11_OFFSET UNITYSDK_OFFSET(0x1A851360)
#define FOUNDATION_BINARYTOOL_TOBINARY_12_OFFSET UNITYSDK_OFFSET(0x1A851480)
#define FOUNDATION_BINARYTOOL_TOBINARY_13_OFFSET UNITYSDK_OFFSET(0x1A8516E0)
#define FOUNDATION_BINARYTOOL_TOBINARY_1_OFFSET UNITYSDK_OFFSET(0x1A8508C0)
#define FOUNDATION_BINARYTOOL_TOBINARY_2_OFFSET UNITYSDK_OFFSET(0x1A8509D0)
#define FOUNDATION_BINARYTOOL_TOBINARY_3_OFFSET UNITYSDK_OFFSET(0x1A850AE0)
#define FOUNDATION_BINARYTOOL_TOBINARY_4_OFFSET UNITYSDK_OFFSET(0x1A850BA0)
#define FOUNDATION_BINARYTOOL_TOBINARY_5_OFFSET UNITYSDK_OFFSET(0x1A850D00)
#define FOUNDATION_BINARYTOOL_TOBINARY_6_OFFSET UNITYSDK_OFFSET(0x1A850DB0)
#define FOUNDATION_BINARYTOOL_TOBINARY_7_OFFSET UNITYSDK_OFFSET(0x1A850F00)
#define FOUNDATION_BINARYTOOL_TOBINARY_8_OFFSET UNITYSDK_OFFSET(0x1A850FC0)
#define FOUNDATION_BINARYTOOL_TOBINARY_9_OFFSET UNITYSDK_OFFSET(0x1A851120)
#define FOUNDATION_BINARYTOOL_TOBINARY_OFFSET UNITYSDK_OFFSET(0x1A850730)
#define FOUNDATION_BINARYTOOL_WRITEARRAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1A851990)
#define FOUNDATION_BINARYTOOL_WRITEDICTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A851AF0)
#define FOUNDATION_BINARYTOOL_WRITELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1A851A40)
#define FOUNDATION_BINARYTOOL_WRITESTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1A8518E0)
#define FOUNDATION_BINARYTOOL_WRITETYPEINDEX_OFFSET UNITYSDK_OFFSET(0x1A851BA0)
#define FOUNDATION_BINARYTOOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A84E4C0)

namespace Foundation
{
	inline static constexpr unsigned int BinaryTool_TypeDefinitionIndex = 7807;
	...
	public:
		...
		{
			return (::Il2CppArray<::Foundation::ByteArrayEncode*>**)Il2CppClass::FromTypeDefinitionIndex(BinaryTool_TypeDefinitionIndex)->GetStaticField(0x73C0);
		}
