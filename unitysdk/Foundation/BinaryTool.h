...
#define FOUNDATION_BINARYTOOL_CHECKVALID_OFFSET UNITYSDK_OFFSET(0x1AA4BF70)
#define FOUNDATION_BINARYTOOL_FROMBINARY_10_OFFSET UNITYSDK_OFFSET(0x1AA4D4F0)
#define FOUNDATION_BINARYTOOL_FROMBINARY_11_OFFSET UNITYSDK_OFFSET(0x1AA4D750)
#define FOUNDATION_BINARYTOOL_FROMBINARY_12_OFFSET UNITYSDK_OFFSET(0x1AA4D950)
#define FOUNDATION_BINARYTOOL_FROMBINARY_1_OFFSET UNITYSDK_OFFSET(0x1AA4C2C0)
#define FOUNDATION_BINARYTOOL_FROMBINARY_2_OFFSET UNITYSDK_OFFSET(0x1AA4C4F0)
#define FOUNDATION_BINARYTOOL_FROMBINARY_3_OFFSET UNITYSDK_OFFSET(0x1AA4C720)
#define FOUNDATION_BINARYTOOL_FROMBINARY_4_OFFSET UNITYSDK_OFFSET(0x1AA4C8C0)
#define FOUNDATION_BINARYTOOL_FROMBINARY_5_OFFSET UNITYSDK_OFFSET(0x1AA4CAF0)
#define FOUNDATION_BINARYTOOL_FROMBINARY_6_OFFSET UNITYSDK_OFFSET(0x1AA4CC90)
#define FOUNDATION_BINARYTOOL_FROMBINARY_7_OFFSET UNITYSDK_OFFSET(0x1AA4CEC0)
#define FOUNDATION_BINARYTOOL_FROMBINARY_8_OFFSET UNITYSDK_OFFSET(0x1AA4D070)
#define FOUNDATION_BINARYTOOL_FROMBINARY_9_OFFSET UNITYSDK_OFFSET(0x1AA4D2A0)
#define FOUNDATION_BINARYTOOL_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1AA4BFF0)
#define FOUNDATION_BINARYTOOL_READARRAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1AA4DD20)
#define FOUNDATION_BINARYTOOL_READDICTCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA4DEE0)
#define FOUNDATION_BINARYTOOL_READLISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA4DE00)
#define FOUNDATION_BINARYTOOL_READSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1AA4DC40)
#define FOUNDATION_BINARYTOOL_READTYPEINDEX_OFFSET UNITYSDK_OFFSET(0x1AA4DFC0)
#define FOUNDATION_BINARYTOOL_TOBINARY_10_OFFSET UNITYSDK_OFFSET(0x1AA4EBB0)
#define FOUNDATION_BINARYTOOL_TOBINARY_11_OFFSET UNITYSDK_OFFSET(0x1AA4ECD0)
#define FOUNDATION_BINARYTOOL_TOBINARY_12_OFFSET UNITYSDK_OFFSET(0x1AA4EDF0)
#define FOUNDATION_BINARYTOOL_TOBINARY_13_OFFSET UNITYSDK_OFFSET(0x1AA4F050)
#define FOUNDATION_BINARYTOOL_TOBINARY_1_OFFSET UNITYSDK_OFFSET(0x1AA4E230)
#define FOUNDATION_BINARYTOOL_TOBINARY_2_OFFSET UNITYSDK_OFFSET(0x1AA4E340)
#define FOUNDATION_BINARYTOOL_TOBINARY_3_OFFSET UNITYSDK_OFFSET(0x1AA4E450)
#define FOUNDATION_BINARYTOOL_TOBINARY_4_OFFSET UNITYSDK_OFFSET(0x1AA4E510)
#define FOUNDATION_BINARYTOOL_TOBINARY_5_OFFSET UNITYSDK_OFFSET(0x1AA4E670)
#define FOUNDATION_BINARYTOOL_TOBINARY_6_OFFSET UNITYSDK_OFFSET(0x1AA4E720)
#define FOUNDATION_BINARYTOOL_TOBINARY_7_OFFSET UNITYSDK_OFFSET(0x1AA4E870)
#define FOUNDATION_BINARYTOOL_TOBINARY_8_OFFSET UNITYSDK_OFFSET(0x1AA4E930)
#define FOUNDATION_BINARYTOOL_TOBINARY_9_OFFSET UNITYSDK_OFFSET(0x1AA4EA90)
#define FOUNDATION_BINARYTOOL_TOBINARY_OFFSET UNITYSDK_OFFSET(0x1AA4E0A0)
#define FOUNDATION_BINARYTOOL_WRITEARRAYLENGTH_OFFSET UNITYSDK_OFFSET(0x1AA4F300)
#define FOUNDATION_BINARYTOOL_WRITEDICTCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA4F460)
#define FOUNDATION_BINARYTOOL_WRITELISTCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA4F3B0)
#define FOUNDATION_BINARYTOOL_WRITESTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1AA4F250)
#define FOUNDATION_BINARYTOOL_WRITETYPEINDEX_OFFSET UNITYSDK_OFFSET(0x1AA4F510)
#define FOUNDATION_BINARYTOOL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA4BE30)

namespace Foundation
{
	inline static constexpr unsigned int BinaryTool_TypeDefinitionIndex = 8189;
	...
	public:
		...
		{
			return (::Il2CppArray<::Foundation::ByteArrayEncode*>**)Il2CppClass::FromTypeDefinitionIndex(BinaryTool_TypeDefinitionIndex)->GetStaticField(0x7420);
		}
