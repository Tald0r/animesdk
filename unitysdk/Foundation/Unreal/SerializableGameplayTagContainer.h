...
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGCONTAINER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0DF310)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGCONTAINER_GET_VALUEREF_OFFSET UNITYSDK_OFFSET(0x1B0DEF60)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGCONTAINER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0DF6D0)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGCONTAINER_UNITYENGINE_ISERIALIZATIONCALLBACKRECEIVER_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0DF6C0)
#define FOUNDATION_UNREAL_SERIALIZABLEGAMEPLAYTAGCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0DF6E0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int SerializableGameplayTagContainer_TypeDefinitionIndex = 9101;
