...
#define FOUNDATION_UNREAL_GAMEPLAYTAGNODE_COLLECTLEAFNODE_OFFSET UNITYSDK_OFFSET(0x1AD8F020)
#define FOUNDATION_UNREAL_GAMEPLAYTAGNODE_GET_ISLEAF_OFFSET UNITYSDK_OFFSET(0x1AD8F000)
#define FOUNDATION_UNREAL_GAMEPLAYTAGNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD8F360)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int GameplayTagNode_TypeDefinitionIndex = 8816;
