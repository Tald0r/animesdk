...
#define FOUNDATION_UNREAL_GAMEPLAYTAGNODE_COLLECTLEAFNODE_OFFSET UNITYSDK_OFFSET(0x1B397570)
#define FOUNDATION_UNREAL_GAMEPLAYTAGNODE_GET_ISLEAF_OFFSET UNITYSDK_OFFSET(0x1B397550)
#define FOUNDATION_UNREAL_GAMEPLAYTAGNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3978A0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int GameplayTagNode_TypeDefinitionIndex = 9123;
