...
#define FOUNDATION_UNREAL_FNAMEENTRYHEADER_ISEQUAL_OFFSET UNITYSDK_OFFSET(0x1B4C4F90)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FNameEntryHeader_TypeDefinitionIndex = 8839;
