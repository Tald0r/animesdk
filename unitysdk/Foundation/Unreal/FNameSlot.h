...
#define FOUNDATION_UNREAL_FNAMESLOT_GET_ENTRYID_OFFSET UNITYSDK_OFFSET(0x965CE0)
#define FOUNDATION_UNREAL_FNAMESLOT_GET_ISUSED_OFFSET UNITYSDK_OFFSET(0x315EF0)
#define FOUNDATION_UNREAL_FNAMESLOT_GET_PROBEHASH_OFFSET UNITYSDK_OFFSET(0x965D40)
#define FOUNDATION_UNREAL_FNAMESLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x965CD0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FNameSlot_TypeDefinitionIndex = 8856;
