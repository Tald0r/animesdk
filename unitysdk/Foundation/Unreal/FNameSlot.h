...
#define FOUNDATION_UNREAL_FNAMESLOT_GET_ENTRYID_OFFSET UNITYSDK_OFFSET(0x995410)
#define FOUNDATION_UNREAL_FNAMESLOT_GET_ISUSED_OFFSET UNITYSDK_OFFSET(0x34A5E0)
#define FOUNDATION_UNREAL_FNAMESLOT_GET_PROBEHASH_OFFSET UNITYSDK_OFFSET(0x995470)
#define FOUNDATION_UNREAL_FNAMESLOT__CTOR_OFFSET UNITYSDK_OFFSET(0x995400)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FNameSlot_TypeDefinitionIndex = 8835;
