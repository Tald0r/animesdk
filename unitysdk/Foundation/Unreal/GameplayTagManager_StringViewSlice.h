...
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_STRINGVIEWSLICE_GETFULLSTRING_OFFSET UNITYSDK_OFFSET(0x96F0D0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_STRINGVIEWSLICE_GETSLICESTRING_OFFSET UNITYSDK_OFFSET(0x96F080)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_STRINGVIEWSLICE__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3730)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int GameplayTagManager_StringViewSlice_TypeDefinitionIndex = 8962;
