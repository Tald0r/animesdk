...
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_STRINGVIEWSLICE_GETFULLSTRING_OFFSET UNITYSDK_OFFSET(0x990710)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_STRINGVIEWSLICE_GETSLICESTRING_OFFSET UNITYSDK_OFFSET(0x9906C0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_STRINGVIEWSLICE__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3C30)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int GameplayTagManager_StringViewSlice_TypeDefinitionIndex = 8957;
