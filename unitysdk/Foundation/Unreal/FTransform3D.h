...
#define FOUNDATION_UNREAL_FTRANSFORM3D_DIAGNOSTICCHECKNAN_ROTATION_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_DIAGNOSTICCHECKNAN_SCALE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_DIAGNOSTICCHECKNAN_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x35A5F0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_SCALE3D_OFFSET UNITYSDK_OFFSET(0x863D70)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_TRANSLATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1B45A080)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x2EA460)
#define FOUNDATION_UNREAL_FTRANSFORM3D_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1B45A200)
#define FOUNDATION_UNREAL_FTRANSFORM3D_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1B45A180)
#define FOUNDATION_UNREAL_FTRANSFORM3D_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x863D60)
#define FOUNDATION_UNREAL_FTRANSFORM3D_SET_SCALE3D_OFFSET UNITYSDK_OFFSET(0x863D90)
#define FOUNDATION_UNREAL_FTRANSFORM3D_SET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x2EA450)
#define FOUNDATION_UNREAL_FTRANSFORM3D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B45A290)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FTransform3D_TypeDefinitionIndex = 9068;

	struct alignas(4) FTransform3D
	{
		static ::Foundation::Unreal::FTransform3D* StaticGet_Identity()
		{
			return (::Foundation::Unreal::FTransform3D*)Il2CppClass::FromTypeDefinitionIndex(FTransform3D_TypeDefinitionIndex)->GetStaticField(0x3E40);
		}
