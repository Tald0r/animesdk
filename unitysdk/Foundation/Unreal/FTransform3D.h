...
#define FOUNDATION_UNREAL_FTRANSFORM3D_DIAGNOSTICCHECKNAN_ROTATION_OFFSET UNITYSDK_OFFSET(0x259A50)
#define FOUNDATION_UNREAL_FTRANSFORM3D_DIAGNOSTICCHECKNAN_SCALE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define FOUNDATION_UNREAL_FTRANSFORM3D_DIAGNOSTICCHECKNAN_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x259A50)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x37BFB0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_SCALE3D_OFFSET UNITYSDK_OFFSET(0x838AB0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_TRANSLATIONOFFSET_OFFSET UNITYSDK_OFFSET(0x1AE42EA0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x31DD30)
#define FOUNDATION_UNREAL_FTRANSFORM3D_OP_EXPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1AE43020)
#define FOUNDATION_UNREAL_FTRANSFORM3D_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1AE42FA0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_SET_ROTATION_OFFSET UNITYSDK_OFFSET(0x838AA0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_SET_SCALE3D_OFFSET UNITYSDK_OFFSET(0x838AD0)
#define FOUNDATION_UNREAL_FTRANSFORM3D_SET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x2C4D20)
#define FOUNDATION_UNREAL_FTRANSFORM3D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE430B0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FTransform3D_TypeDefinitionIndex = 9118;

	struct alignas(4) FTransform3D
	{
		static ::Foundation::Unreal::FTransform3D* StaticGet_Identity()
		{
			return (::Foundation::Unreal::FTransform3D*)Il2CppClass::FromTypeDefinitionIndex(FTransform3D_TypeDefinitionIndex)->GetStaticField(0x3E20);
		}
