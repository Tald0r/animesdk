...
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B07FC20)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B07FF40)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B07FED0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1B07FFC0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B07FF30)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B07FEE0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B07FBE0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x1B07FBC0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1B07FC10)
#define FOUNDATION_UNREAL_GAMEPLAYTAGCOLLECTION__COLLECT_D__3___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x1B07FC00)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int GameplayTagCollection__Collect_d__3_TypeDefinitionIndex = 8846;
	...
	public:
		...
		::System::Collections::Generic::List_1_Enumerator<::Foundation::Unreal::GameplayTagList*> __7__wrap2; // 0x18
		::Foundation::Unreal::GameplayTagCollection* __4__this; // 0x30
