...
#define FOUNDATION_UNREAL_FNAMEHASH_GENERATEHASH_OFFSET UNITYSDK_OFFSET(0x1A20CE40)
#define FOUNDATION_UNREAL_FNAMEHASH_GETPROBESTART_OFFSET UNITYSDK_OFFSET(0x1A20D6A0)
#define FOUNDATION_UNREAL_FNAMEHASH_ISNONE_OFFSET UNITYSDK_OFFSET(0x1A20D390)
#define FOUNDATION_UNREAL_FNAMEHASH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x90D920)
#define FOUNDATION_UNREAL_FNAMEHASH__CTOR_OFFSET UNITYSDK_OFFSET(0x90D890)
