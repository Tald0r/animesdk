...
#define FOUNDATION_UNREAL_FNAMEHASH_GENERATEHASH_OFFSET UNITYSDK_OFFSET(0x1A83D910)
#define FOUNDATION_UNREAL_FNAMEHASH_GETPROBESTART_OFFSET UNITYSDK_OFFSET(0x1A83DAA0)
#define FOUNDATION_UNREAL_FNAMEHASH_ISNONE_OFFSET UNITYSDK_OFFSET(0x1A83D950)
#define FOUNDATION_UNREAL_FNAMEHASH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x93A540)
#define FOUNDATION_UNREAL_FNAMEHASH__CTOR_OFFSET UNITYSDK_OFFSET(0x93A500)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FNameHash_TypeDefinitionIndex = 8921;
