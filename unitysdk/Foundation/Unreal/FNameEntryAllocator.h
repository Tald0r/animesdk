...
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_ALLOCATEBLOCK_OFFSET UNITYSDK_OFFSET(0x1AE42820)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_ALLOCATENAMEENTRY_OFFSET UNITYSDK_OFFSET(0x967EA0)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_CREATE_OFFSET UNITYSDK_OFFSET(0x1AE42C90)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_FREEBLOCK_OFFSET UNITYSDK_OFFSET(0x1AE428F0)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_ISDISPOSED_OFFSET UNITYSDK_OFFSET(0x2FE250)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_NEWBLOCK_OFFSET UNITYSDK_OFFSET(0x967E90)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x967EB0)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR_TOALIGNEDLENGTH_OFFSET UNITYSDK_OFFSET(0x1AE42890)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE42720)
#define FOUNDATION_UNREAL_FNAMEENTRYALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x967E00)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FNameEntryAllocator_TypeDefinitionIndex = 8924;

	struct alignas(8) FNameEntryAllocator
	{
		static ::System::Int32* StaticGet_Stride()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FNameEntryAllocator_TypeDefinitionIndex)->GetStaticField(0x3D10);
		}
		static ::System::Int32* StaticGet_DataOffset()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FNameEntryAllocator_TypeDefinitionIndex)->GetStaticField(0x3D14);
		}
		static ::System::Int32* StaticGet_BlockByteSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FNameEntryAllocator_TypeDefinitionIndex)->GetStaticField(0x3D18);
		}
