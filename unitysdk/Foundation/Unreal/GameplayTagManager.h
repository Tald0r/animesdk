...
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_ADDTAG_OFFSET UNITYSDK_OFFSET(0x1AD7AC40)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_CHECKVALIDGAMEPLAYTAGSIMPLESTRINGVIEW_OFFSET UNITYSDK_OFFSET(0x1AD7A540)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_CONSTRUCTGAMEPLAYTAGTREE_OFFSET UNITYSDK_OFFSET(0x1AD79C80)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_CREATEIFNULL_OFFSET UNITYSDK_OFFSET(0x1AD7A700)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_FINDORADDCHILD_OFFSET UNITYSDK_OFFSET(0x1AD7A9E0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GETNODETREE_OFFSET UNITYSDK_OFFSET(0x1AD79C00)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GETSINGLETAGCONTAINER_1_OFFSET UNITYSDK_OFFSET(0x1AD79AA0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GETSINGLETAGCONTAINER_OFFSET UNITYSDK_OFFSET(0x1AD79930)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x1AD78F80)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AD79050)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_PARSEINTOARRAY_OFFSET UNITYSDK_OFFSET(0x1AD7A780)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_REQUESTGAMEPLAYTAG_OFFSET UNITYSDK_OFFSET(0x1AD798A0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD78FE0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD797F0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int GameplayTagManager_TypeDefinitionIndex = 8955;
