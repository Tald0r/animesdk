...
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_ADDTAG_OFFSET UNITYSDK_OFFSET(0x1A797D80)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_CHECKVALIDGAMEPLAYTAGSIMPLESTRINGVIEW_OFFSET UNITYSDK_OFFSET(0x1A797680)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_CONSTRUCTGAMEPLAYTAGTREE_OFFSET UNITYSDK_OFFSET(0x1A796DC0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_CREATEIFNULL_OFFSET UNITYSDK_OFFSET(0x1A797840)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_FINDORADDCHILD_OFFSET UNITYSDK_OFFSET(0x1A797B20)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GETNODETREE_OFFSET UNITYSDK_OFFSET(0x1A796D40)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GETSINGLETAGCONTAINER_1_OFFSET UNITYSDK_OFFSET(0x1A796BE0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GETSINGLETAGCONTAINER_OFFSET UNITYSDK_OFFSET(0x1A796A70)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_GET_OFFSET UNITYSDK_OFFSET(0x1A7960C0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A796190)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_PARSEINTOARRAY_OFFSET UNITYSDK_OFFSET(0x1A7978C0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER_REQUESTGAMEPLAYTAG_OFFSET UNITYSDK_OFFSET(0x1A7969E0)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A796120)
#define FOUNDATION_UNREAL_GAMEPLAYTAGMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A796930)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int GameplayTagManager_TypeDefinitionIndex = 8960;
	...
	public:
		...
		{
			return (::Foundation::AssetPath*)Il2CppClass::FromTypeDefinitionIndex(GameplayTagManager_TypeDefinitionIndex)->GetStaticField(0x7D00);
		}
		static ::Foundation::Unreal::GameplayTagManager** StaticGet__instance()
		{
			return (::Foundation::Unreal::GameplayTagManager**)Il2CppClass::FromTypeDefinitionIndex(GameplayTagManager_TypeDefinitionIndex)->GetStaticField(0x7D10);
		}
		::Il2CppArray<::Foundation::Unreal::FGameplayTagNode>* _nodeTrees; // 0x10
		::System::Collections::Generic::Dictionary_2<::System::UInt64, ::Foundation::Unreal::FGameplayTagNodeIndex>* _gameplayTagLookUpTable; // 0x18
