...
#define FOUNDATION_UNREAL_UNSAFE_INTERVALBOUND_EXCLUSIVE_OFFSET UNITYSDK_OFFSET(0x1AD059E0)
#define FOUNDATION_UNREAL_UNSAFE_INTERVALBOUND_INCLUSIVE_OFFSET UNITYSDK_OFFSET(0x1AD059C0)
#define FOUNDATION_UNREAL_UNSAFE_INTERVALBOUND_OP_IMPLICIT_1_OFFSET UNITYSDK_OFFSET(0x1AD05AF0)
#define FOUNDATION_UNREAL_UNSAFE_INTERVALBOUND_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AD05A00)
#define FOUNDATION_UNREAL_UNSAFE_INTERVALBOUND__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD05BD0)
...
namespace Foundation::Unreal::Unsafe
{
	...
	struct alignas(4) IntervalBound
	{
		...
		{
			return (::Foundation::Unreal::Unsafe::IntervalBound*)Il2CppClass::FromTypeDefinitionIndex(IntervalBound_TypeDefinitionIndex)->GetStaticField(0x3DC0);
		}
