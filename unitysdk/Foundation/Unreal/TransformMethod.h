...
#define FOUNDATION_UNREAL_TRANSFORMMETHOD_GETRELATIVETRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x1A71F6F0)
#define FOUNDATION_UNREAL_TRANSFORMMETHOD_GETRELATIVETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A71F0C0)
#define FOUNDATION_UNREAL_TRANSFORMMETHOD_GETSAFESCALERECIPROCAL_1_OFFSET UNITYSDK_OFFSET(0x1A71FBF0)
#define FOUNDATION_UNREAL_TRANSFORMMETHOD_GETSAFESCALERECIPROCAL_2_OFFSET UNITYSDK_OFFSET(0x1A71FC50)
#define FOUNDATION_UNREAL_TRANSFORMMETHOD_GETSAFESCALERECIPROCAL_OFFSET UNITYSDK_OFFSET(0x1A71EEF0)
#define FOUNDATION_UNREAL_TRANSFORMMETHOD_INVERSETRANSFORMPOINTDIRECT_OFFSET UNITYSDK_OFFSET(0x1A71EF50)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int TransformMethod_TypeDefinitionIndex = 8874;
