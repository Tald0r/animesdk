...
#define FOUNDATION_UNREAL_FGAMEPLAYTAGNODEVIEW_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x4C2E40)
#define FOUNDATION_UNREAL_FGAMEPLAYTAGNODEVIEW__CTOR_OFFSET UNITYSDK_OFFSET(0x4489E0)

namespace Foundation::Unreal
{
	inline static constexpr unsigned int FGameplayTagNodeView_TypeDefinitionIndex = 8896;
