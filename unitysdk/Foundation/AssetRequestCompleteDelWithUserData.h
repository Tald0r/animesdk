...
#define FOUNDATION_ASSETREQUESTCOMPLETEDELWITHUSERDATA_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0F4BC0)
#define FOUNDATION_ASSETREQUESTCOMPLETEDELWITHUSERDATA_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0F4C30)
#define FOUNDATION_ASSETREQUESTCOMPLETEDELWITHUSERDATA_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0F4390)
#define FOUNDATION_ASSETREQUESTCOMPLETEDELWITHUSERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F4370)

namespace Foundation
{
	inline static constexpr unsigned int AssetRequestCompleteDelWithUserData_TypeDefinitionIndex = 7998;
