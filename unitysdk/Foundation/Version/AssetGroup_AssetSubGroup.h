...
#define FOUNDATION_VERSION_ASSETGROUP_ASSETSUBGROUP_GET_BLACKLISTMODE_OFFSET UNITYSDK_OFFSET(0x6C44100)
#define FOUNDATION_VERSION_ASSETGROUP_ASSETSUBGROUP_GET_SUBGROUPMODE_OFFSET UNITYSDK_OFFSET(0x6C440F0)
#define FOUNDATION_VERSION_ASSETGROUP_ASSETSUBGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x6C44110)

namespace Foundation::Version
{
	inline static constexpr unsigned int AssetGroup_AssetSubGroup_TypeDefinitionIndex = 79701;
