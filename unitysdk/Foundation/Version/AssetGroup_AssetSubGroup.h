...
#define FOUNDATION_VERSION_ASSETGROUP_ASSETSUBGROUP_GET_BLACKLISTMODE_OFFSET UNITYSDK_OFFSET(0x5F96580)
#define FOUNDATION_VERSION_ASSETGROUP_ASSETSUBGROUP_GET_SUBGROUPMODE_OFFSET UNITYSDK_OFFSET(0x5F96570)
#define FOUNDATION_VERSION_ASSETGROUP_ASSETSUBGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x5F96590)

namespace Foundation::Version
{
	inline static constexpr unsigned int AssetGroup_AssetSubGroup_TypeDefinitionIndex = 69994;
