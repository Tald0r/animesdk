...
#define FOUNDATION_MULTIVERSIONDIFFCONFIG___C__DISPLAYCLASS2_0__CONTAINS_B__0_OFFSET UNITYSDK_OFFSET(0x1A860260)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG___C__DISPLAYCLASS2_0__CONTAINS_B__1_OFFSET UNITYSDK_OFFSET(0x1A8602E0)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG___C__DISPLAYCLASS2_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A860250)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionDiffConfig___c__DisplayClass2_0_TypeDefinitionIndex = 8089;
