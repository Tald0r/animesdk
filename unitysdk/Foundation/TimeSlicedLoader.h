...
#define FOUNDATION_TIMESLICEDLOADER_ADDLOADERTASK_OFFSET UNITYSDK_OFFSET(0x1A02B800)
#define FOUNDATION_TIMESLICEDLOADER_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x1A02B5E0)
#define FOUNDATION_TIMESLICEDLOADER_GET_LOADERTYPE_OFFSET UNITYSDK_OFFSET(0x1A02B5D0)
#define FOUNDATION_TIMESLICEDLOADER_GET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x1A02B610)
#define FOUNDATION_TIMESLICEDLOADER_GET_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A02B5F0)
#define FOUNDATION_TIMESLICEDLOADER_GET_TIMESLICECOND_OFFSET UNITYSDK_OFFSET(0x1A02B630)
#define FOUNDATION_TIMESLICEDLOADER_ONTASKEND_OFFSET UNITYSDK_OFFSET(0x1A02BAD0)
#define FOUNDATION_TIMESLICEDLOADER_ONTASKLOADED_OFFSET UNITYSDK_OFFSET(0x1A02B9C0)
#define FOUNDATION_TIMESLICEDLOADER_SET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x1A02B620)
#define FOUNDATION_TIMESLICEDLOADER_SET_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A02B600)
#define FOUNDATION_TIMESLICEDLOADER_SET_TIMESLICECOND_OFFSET UNITYSDK_OFFSET(0x1A02B640)
#define FOUNDATION_TIMESLICEDLOADER_START_OFFSET UNITYSDK_OFFSET(0x1A02BB70)
#define FOUNDATION_TIMESLICEDLOADER_TERMINATE_OFFSET UNITYSDK_OFFSET(0x1A02BBD0)
#define FOUNDATION_TIMESLICEDLOADER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A02BCE0)
#define FOUNDATION_TIMESLICEDLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A02B650)

namespace Foundation
{
	inline static constexpr unsigned int TimeSlicedLoader_TypeDefinitionIndex = 7738;

	class TimeSlicedLoader : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::System::Exception*>* errorList; // 0x10
		::System::Action_2<::System::Int32, ::System::Int32>* _OnProgress_k__BackingField; // 0x18
		::System::Collections::Generic::Queue_1<::Foundation::TimeSlicedLoaderNode*>* callbackTasks; // 0x20
		...
		::System::Collections::Generic::HashSet_1<::Foundation::TimeSlicedLoaderNode*>* pendingTasks; // 0x38
