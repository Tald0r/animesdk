...
#define FOUNDATION_TIMESLICEDLOADER_ADDLOADERTASK_OFFSET UNITYSDK_OFFSET(0x19A59910)
#define FOUNDATION_TIMESLICEDLOADER_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x19A596F0)
#define FOUNDATION_TIMESLICEDLOADER_GET_LOADERTYPE_OFFSET UNITYSDK_OFFSET(0x19A596E0)
#define FOUNDATION_TIMESLICEDLOADER_GET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x19A59720)
#define FOUNDATION_TIMESLICEDLOADER_GET_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x19A59700)
#define FOUNDATION_TIMESLICEDLOADER_GET_TIMESLICECOND_OFFSET UNITYSDK_OFFSET(0x19A59740)
#define FOUNDATION_TIMESLICEDLOADER_ONTASKEND_OFFSET UNITYSDK_OFFSET(0x19A59BE0)
#define FOUNDATION_TIMESLICEDLOADER_ONTASKLOADED_OFFSET UNITYSDK_OFFSET(0x19A59AD0)
#define FOUNDATION_TIMESLICEDLOADER_SET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x19A59730)
#define FOUNDATION_TIMESLICEDLOADER_SET_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x19A59710)
#define FOUNDATION_TIMESLICEDLOADER_SET_TIMESLICECOND_OFFSET UNITYSDK_OFFSET(0x19A59750)
#define FOUNDATION_TIMESLICEDLOADER_START_OFFSET UNITYSDK_OFFSET(0x19A59C80)
#define FOUNDATION_TIMESLICEDLOADER_TERMINATE_OFFSET UNITYSDK_OFFSET(0x19A59CE0)
#define FOUNDATION_TIMESLICEDLOADER_UPDATE_OFFSET UNITYSDK_OFFSET(0x19A59DF0)
#define FOUNDATION_TIMESLICEDLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A59760)

namespace Foundation
{
	inline static constexpr unsigned int TimeSlicedLoader_TypeDefinitionIndex = 7827;
	...
	public:
		...
		::System::Collections::Generic::HashSet_1<::Foundation::TimeSlicedLoaderNode*>* pendingTasks; // 0x30
