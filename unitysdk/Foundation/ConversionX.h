...
#define FOUNDATION_CONVERSIONX_FROMBASE64_OFFSET UNITYSDK_OFFSET(0x170CAFC0)
#define FOUNDATION_CONVERSIONX_TOBASE64_OFFSET UNITYSDK_OFFSET(0x170CAD30)
#define FOUNDATION_CONVERSIONX_TOBOOLNULL_OFFSET UNITYSDK_OFFSET(0x170C9830)
#define FOUNDATION_CONVERSIONX_TOBOOL_OFFSET UNITYSDK_OFFSET(0x170C9610)
#define FOUNDATION_CONVERSIONX_TOCHAR_OFFSET UNITYSDK_OFFSET(0x170C7D60)
#define FOUNDATION_CONVERSIONX_TODATETIMENULL_OFFSET UNITYSDK_OFFSET(0x170C9D50)
#define FOUNDATION_CONVERSIONX_TODATETIME_OFFSET UNITYSDK_OFFSET(0x170C9AD0)
#define FOUNDATION_CONVERSIONX_TODECIMALNULLABLE_OFFSET UNITYSDK_OFFSET(0x170CA660)
#define FOUNDATION_CONVERSIONX_TODECIMALNULL_OFFSET UNITYSDK_OFFSET(0x170C8E10)
#define FOUNDATION_CONVERSIONX_TODECIMAL_1_OFFSET UNITYSDK_OFFSET(0x170C8910)
#define FOUNDATION_CONVERSIONX_TODECIMAL_OFFSET UNITYSDK_OFFSET(0x170C7AC0)
#define FOUNDATION_CONVERSIONX_TODOUBLENULLABLE_OFFSET UNITYSDK_OFFSET(0x170CA380)
#define FOUNDATION_CONVERSIONX_TODOUBLE_1_OFFSET UNITYSDK_OFFSET(0x170CAB60)
#define FOUNDATION_CONVERSIONX_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x170C8BE0)
#define FOUNDATION_CONVERSIONX_TOFLOATNULL_OFFSET UNITYSDK_OFFSET(0x170C9370)
#define FOUNDATION_CONVERSIONX_TOFLOAT_1_OFFSET UNITYSDK_OFFSET(0x170C9140)
#define FOUNDATION_CONVERSIONX_TOFLOAT_OFFSET UNITYSDK_OFFSET(0x170C7900)
#define FOUNDATION_CONVERSIONX_TOGUID_OFFSET UNITYSDK_OFFSET(0x170CA030)
#define FOUNDATION_CONVERSIONX_TOINTNULLABLE_OFFSET UNITYSDK_OFFSET(0x170CA750)
#define FOUNDATION_CONVERSIONX_TOINTNULL_OFFSET UNITYSDK_OFFSET(0x170C8180)
#define FOUNDATION_CONVERSIONX_TOINT_1_OFFSET UNITYSDK_OFFSET(0x170CA800)
#define FOUNDATION_CONVERSIONX_TOINT_OFFSET UNITYSDK_OFFSET(0x170C7F70)
#define FOUNDATION_CONVERSIONX_TOLONGNULL_OFFSET UNITYSDK_OFFSET(0x170C8630)
#define FOUNDATION_CONVERSIONX_TOLONG_1_OFFSET UNITYSDK_OFFSET(0x170CA9B0)
#define FOUNDATION_CONVERSIONX_TOLONG_OFFSET UNITYSDK_OFFSET(0x170C8420)

namespace Foundation
{
	inline static constexpr unsigned int ConversionX_TypeDefinitionIndex = 7775;
