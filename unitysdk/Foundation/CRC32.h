...
#define FOUNDATION_CRC32_CALCULATEHASH_OFFSET UNITYSDK_OFFSET(0x1A9AAEA0)
#define FOUNDATION_CRC32_COMPUTE_1_OFFSET UNITYSDK_OFFSET(0x1A9AB2B0)
#define FOUNDATION_CRC32_COMPUTE_2_OFFSET UNITYSDK_OFFSET(0x1A9AB3A0)
#define FOUNDATION_CRC32_COMPUTE_OFFSET UNITYSDK_OFFSET(0x1A9AB240)
#define FOUNDATION_CRC32_GET_HASHSIZE_OFFSET UNITYSDK_OFFSET(0x1A9AAD90)
#define FOUNDATION_CRC32_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1A9AAE10)
#define FOUNDATION_CRC32_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1A9AB0D0)
#define FOUNDATION_CRC32_INITIALIZETABLE_OFFSET UNITYSDK_OFFSET(0x1A9AAAF0)
#define FOUNDATION_CRC32_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A9AADA0)
#define FOUNDATION_CRC32_UINT32TOBIGENDIANBYTES_OFFSET UNITYSDK_OFFSET(0x1A9AB1B0)
#define FOUNDATION_CRC32__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A9AAA90)
#define FOUNDATION_CRC32__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9AAA30)

namespace Foundation
{
	inline static constexpr unsigned int CRC32_TypeDefinitionIndex = 8096;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(CRC32_TypeDefinitionIndex)->GetStaticField(0x6D30);
		}
