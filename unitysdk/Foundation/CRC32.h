...
#define FOUNDATION_CRC32_CALCULATEHASH_OFFSET UNITYSDK_OFFSET(0x1B17D3F0)
#define FOUNDATION_CRC32_COMPUTE_1_OFFSET UNITYSDK_OFFSET(0x1B17D800)
#define FOUNDATION_CRC32_COMPUTE_2_OFFSET UNITYSDK_OFFSET(0x1B17D8F0)
#define FOUNDATION_CRC32_COMPUTE_OFFSET UNITYSDK_OFFSET(0x1B17D790)
#define FOUNDATION_CRC32_GET_HASHSIZE_OFFSET UNITYSDK_OFFSET(0x1B17D2E0)
#define FOUNDATION_CRC32_HASHCORE_OFFSET UNITYSDK_OFFSET(0x1B17D360)
#define FOUNDATION_CRC32_HASHFINAL_OFFSET UNITYSDK_OFFSET(0x1B17D620)
#define FOUNDATION_CRC32_INITIALIZETABLE_OFFSET UNITYSDK_OFFSET(0x1B17D040)
#define FOUNDATION_CRC32_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1B17D2F0)
#define FOUNDATION_CRC32_UINT32TOBIGENDIANBYTES_OFFSET UNITYSDK_OFFSET(0x1B17D700)
#define FOUNDATION_CRC32__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B17CFE0)
#define FOUNDATION_CRC32__CTOR_OFFSET UNITYSDK_OFFSET(0x1B17CF80)

namespace Foundation
{
	inline static constexpr unsigned int CRC32_TypeDefinitionIndex = 7952;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::UInt32>**)Il2CppClass::FromTypeDefinitionIndex(CRC32_TypeDefinitionIndex)->GetStaticField(0x6D40);
		}
