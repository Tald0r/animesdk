...
#define FOUNDATION_ULONGSERIALIZABLE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0F8F10)
#define FOUNDATION_ULONGSERIALIZABLE_ONAFTERDESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0F8FF0)
#define FOUNDATION_ULONGSERIALIZABLE_ONBEFORESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B0F9070)
#define FOUNDATION_ULONGSERIALIZABLE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1B0F8F20)
#define FOUNDATION_ULONGSERIALIZABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F90F0)

namespace Foundation
{
	inline static constexpr unsigned int UlongSerializable_TypeDefinitionIndex = 8112;
