...
#define FOUNDATION_TEXTASSETLOADER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD5F0B0)
#define FOUNDATION_TEXTASSETLOADER___C__DISPLAYCLASS9_0__LOAD_B__0_OFFSET UNITYSDK_OFFSET(0x1AD5F0C0)
#define FOUNDATION_TEXTASSETLOADER___C__DISPLAYCLASS9_0__LOAD_B__1_OFFSET UNITYSDK_OFFSET(0x1AD5F540)
#define FOUNDATION_TEXTASSETLOADER___C__DISPLAYCLASS9_0__LOAD_B__2_OFFSET UNITYSDK_OFFSET(0x1AD5F220)
#define FOUNDATION_TEXTASSETLOADER___C__DISPLAYCLASS9_0__LOAD_B__3_OFFSET UNITYSDK_OFFSET(0x1AD5F330)

namespace Foundation
{
	inline static constexpr unsigned int TextAssetLoader___c__DisplayClass9_0_TypeDefinitionIndex = 8037;
