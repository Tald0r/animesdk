...
#define FOUNDATION_UTILITY_ENCODEBYTETOSTRINGASCII_OFFSET UNITYSDK_OFFSET(0x1A997E90)
#define FOUNDATION_UTILITY_ENCODESTRINGTOBYTEASCII_OFFSET UNITYSDK_OFFSET(0x1A997D70)
#define FOUNDATION_UTILITY_GETSTACKTRACE_OFFSET UNITYSDK_OFFSET(0x1A997C10)
#define FOUNDATION_UTILITY_ISNAPQUICKSTARTGAMEMODE_OFFSET UNITYSDK_OFFSET(0x1A997BB0)

namespace Foundation
{
	inline static constexpr unsigned int Utility_TypeDefinitionIndex = 8047;
