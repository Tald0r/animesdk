...
#define FOUNDATION_UTILITY_ENCODEBYTETOSTRINGASCII_OFFSET UNITYSDK_OFFSET(0x1AEC0130)
#define FOUNDATION_UTILITY_ENCODESTRINGTOBYTEASCII_OFFSET UNITYSDK_OFFSET(0x1AEC0010)
#define FOUNDATION_UTILITY_GETSTACKTRACE_OFFSET UNITYSDK_OFFSET(0x1AEBFEB0)
#define FOUNDATION_UTILITY_ISNAPQUICKSTARTGAMEMODE_OFFSET UNITYSDK_OFFSET(0x1AEBFE50)

namespace Foundation
{
	inline static constexpr unsigned int Utility_TypeDefinitionIndex = 7878;
