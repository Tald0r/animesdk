...
#define FOUNDATION_ASSETPOOLRUNMODE_ADDINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1ABAFEA0)
#define FOUNDATION_ASSETPOOLRUNMODE_ADDINSTANCE_OFFSET UNITYSDK_OFFSET(0x1ABAFD50)
#define FOUNDATION_ASSETPOOLRUNMODE_APPLICATIONONLOWMEMORY_OFFSET UNITYSDK_OFFSET(0x1ABAF9E0)
#define FOUNDATION_ASSETPOOLRUNMODE_CLEARALLPOOLINSTANCES_OFFSET UNITYSDK_OFFSET(0x1ABAFA50)
#define FOUNDATION_ASSETPOOLRUNMODE_CLEARASYNCREQUESTS_OFFSET UNITYSDK_OFFSET(0x1ABB3520)
#define FOUNDATION_ASSETPOOLRUNMODE_CLEARINSTANCES_1_OFFSET UNITYSDK_OFFSET(0x1ABB28D0)
#define FOUNDATION_ASSETPOOLRUNMODE_CLEARINSTANCES_OFFSET UNITYSDK_OFFSET(0x1ABB2830)
#define FOUNDATION_ASSETPOOLRUNMODE_GETASSET_1_OFFSET UNITYSDK_OFFSET(0x1ABB0320)
#define FOUNDATION_ASSETPOOLRUNMODE_GETASSET_OFFSET UNITYSDK_OFFSET(0x1ABB0270)
#define FOUNDATION_ASSETPOOLRUNMODE_GETINSTANCEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1ABB1400)
#define FOUNDATION_ASSETPOOLRUNMODE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1ABB1320)
#define FOUNDATION_ASSETPOOLRUNMODE_GETINSTANCEPOOLSNAPSHOTDIFF_OFFSET UNITYSDK_OFFSET(0x1ABAF290)
#define FOUNDATION_ASSETPOOLRUNMODE_GETINSTANCEPOOLSNAPSHOT_OFFSET UNITYSDK_OFFSET(0x1ABAEB20)
#define FOUNDATION_ASSETPOOLRUNMODE_GETINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1ABB0AC0)
#define FOUNDATION_ASSETPOOLRUNMODE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1ABB09F0)
#define FOUNDATION_ASSETPOOLRUNMODE_GETPRELOADINSTANCEIFNOTEXIST_OFFSET UNITYSDK_OFFSET(0x1ABB2370)
#define FOUNDATION_ASSETPOOLRUNMODE_GETPRELOADINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1ABB1DC0)
#define FOUNDATION_ASSETPOOLRUNMODE_GETPRELOADINSTANCE_OFFSET UNITYSDK_OFFSET(0x1ABB1C20)
#define FOUNDATION_ASSETPOOLRUNMODE_GET_ROOTTF_OFFSET UNITYSDK_OFFSET(0x1ABAEB00)
#define FOUNDATION_ASSETPOOLRUNMODE_ISASSETLOADEDINPOOL_OFFSET UNITYSDK_OFFSET(0x1ABB2270)
#define FOUNDATION_ASSETPOOLRUNMODE_LOGINSTANCEPOOLDETAIL_OFFSET UNITYSDK_OFFSET(0x1ABAEE60)
#define FOUNDATION_ASSETPOOLRUNMODE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1ABB2AB0)
#define FOUNDATION_ASSETPOOLRUNMODE_SETREQUESTHANDLECACHED_OFFSET UNITYSDK_OFFSET(0x1ABB36D0)
#define FOUNDATION_ASSETPOOLRUNMODE_SETUSINGINSTANCEPOOL_OFFSET UNITYSDK_OFFSET(0x1ABB2A40)
#define FOUNDATION_ASSETPOOLRUNMODE_SET_ROOTTF_OFFSET UNITYSDK_OFFSET(0x1ABAEB10)
#define FOUNDATION_ASSETPOOLRUNMODE_UNLOAD_1_OFFSET UNITYSDK_OFFSET(0x1ABB31F0)
#define FOUNDATION_ASSETPOOLRUNMODE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1ABB3150)
#define FOUNDATION_ASSETPOOLRUNMODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABB3790)
#define FOUNDATION_ASSETPOOLRUNMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABAF710)

namespace Foundation
{
	inline static constexpr unsigned int AssetPoolRunMode_TypeDefinitionIndex = 7794;
	...
	public:
		...
		{
			return (::System::Action_1<::Foundation::AssetPath>**)Il2CppClass::FromTypeDefinitionIndex(AssetPoolRunMode_TypeDefinitionIndex)->GetStaticField(0x70F0);
		}
		static ::System::Boolean* StaticGet_allowUIInPool()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(AssetPoolRunMode_TypeDefinitionIndex)->GetStaticField(0x37B0);
		}
		static ::System::Single* StaticGet_DISPOSE_CHECK_TIME()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(AssetPoolRunMode_TypeDefinitionIndex)->GetStaticField(0x37B4);
		}
		static ::System::Int32* StaticGet_DEFAULT_TIME_OUT()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AssetPoolRunMode_TypeDefinitionIndex)->GetStaticField(0x37B8);
		}
		...
		::System::Collections::Generic::Dictionary_2<::System::Int32, ::Foundation::TemporarayTracker*>* strTempPool; // 0x20
