...
#define FOUNDATION_GAMEOBJECTX_ACTIVATEANDPARENT_OFFSET UNITYSDK_OFFSET(0x1AB74810)
#define FOUNDATION_GAMEOBJECTX_ADDCOMPONENTSAFELY_OFFSET UNITYSDK_OFFSET(0x1AB75C80)
#define FOUNDATION_GAMEOBJECTX_CLONE_OFFSET UNITYSDK_OFFSET(0x1AB75730)
#define FOUNDATION_GAMEOBJECTX_GETCHILDBYABSPATH_OFFSET UNITYSDK_OFFSET(0x1AB73F30)
#define FOUNDATION_GAMEOBJECTX_GETCHILDBYRELATEDPATHLIST_OFFSET UNITYSDK_OFFSET(0x1AB73B40)
#define FOUNDATION_GAMEOBJECTX_GETCHILDBYRELATEDPATH_OFFSET UNITYSDK_OFFSET(0x1AB73540)
#define FOUNDATION_GAMEOBJECTX_GETCOLLISIONMASK_OFFSET UNITYSDK_OFFSET(0x1AB753F0)
#define FOUNDATION_GAMEOBJECTX_GETRELATEDREALPATHANDINDEX_OFFSET UNITYSDK_OFFSET(0x1AB73990)
#define FOUNDATION_GAMEOBJECTX_HASCHARACTERCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1AB74B10)
#define FOUNDATION_GAMEOBJECTX_HASRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1AB749D0)
#define FOUNDATION_GAMEOBJECTX_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1AB74720)
#define FOUNDATION_GAMEOBJECTX_ISNULLORINACTIVE_OFFSET UNITYSDK_OFFSET(0x1AB74650)
#define FOUNDATION_GAMEOBJECTX_NEWGAMEOBJECTASCHILD_OFFSET UNITYSDK_OFFSET(0x1AB754E0)
#define FOUNDATION_GAMEOBJECTX_REMOVEALLCHILDOBJECT_OFFSET UNITYSDK_OFFSET(0x1AB75A80)
#define FOUNDATION_GAMEOBJECTX_RESETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AB75660)
#define FOUNDATION_GAMEOBJECTX_SETACTIVERECURSIVELYEXT_OFFSET UNITYSDK_OFFSET(0x1AB75950)
#define FOUNDATION_GAMEOBJECTX_SETACTIVESAFELY_OFFSET UNITYSDK_OFFSET(0x1AB75850)
#define FOUNDATION_GAMEOBJECTX_SETCOLLISIONRECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1AB74FD0)
#define FOUNDATION_GAMEOBJECTX_SETLAYERRECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1AB74C80)
#define FOUNDATION_GAMEOBJECTX_TOSTRINGPARENTHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1AB72B80)
#define FOUNDATION_GAMEOBJECTX_TOSTRINGRELATEDPATH_OFFSET UNITYSDK_OFFSET(0x1AB72E40)

namespace Foundation
{
	inline static constexpr unsigned int GameObjectX_TypeDefinitionIndex = 8214;
