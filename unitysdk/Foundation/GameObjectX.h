...
#define FOUNDATION_GAMEOBJECTX_ACTIVATEANDPARENT_OFFSET UNITYSDK_OFFSET(0x1A59C570)
#define FOUNDATION_GAMEOBJECTX_ADDCOMPONENTSAFELY_OFFSET UNITYSDK_OFFSET(0x1A59D9E0)
#define FOUNDATION_GAMEOBJECTX_CLONE_OFFSET UNITYSDK_OFFSET(0x1A59D490)
#define FOUNDATION_GAMEOBJECTX_GETCHILDBYABSPATH_OFFSET UNITYSDK_OFFSET(0x1A59BC90)
#define FOUNDATION_GAMEOBJECTX_GETCHILDBYRELATEDPATHLIST_OFFSET UNITYSDK_OFFSET(0x1A59B8A0)
#define FOUNDATION_GAMEOBJECTX_GETCHILDBYRELATEDPATH_OFFSET UNITYSDK_OFFSET(0x1A59B2A0)
#define FOUNDATION_GAMEOBJECTX_GETCOLLISIONMASK_OFFSET UNITYSDK_OFFSET(0x1A59D150)
#define FOUNDATION_GAMEOBJECTX_GETRELATEDREALPATHANDINDEX_OFFSET UNITYSDK_OFFSET(0x1A59B6F0)
#define FOUNDATION_GAMEOBJECTX_HASCHARACTERCONTROLLER_OFFSET UNITYSDK_OFFSET(0x1A59C870)
#define FOUNDATION_GAMEOBJECTX_HASRIGIDBODY_OFFSET UNITYSDK_OFFSET(0x1A59C730)
#define FOUNDATION_GAMEOBJECTX_ISACTIVE_OFFSET UNITYSDK_OFFSET(0x1A59C480)
#define FOUNDATION_GAMEOBJECTX_ISNULLORINACTIVE_OFFSET UNITYSDK_OFFSET(0x1A59C3B0)
#define FOUNDATION_GAMEOBJECTX_NEWGAMEOBJECTASCHILD_OFFSET UNITYSDK_OFFSET(0x1A59D240)
#define FOUNDATION_GAMEOBJECTX_REMOVEALLCHILDOBJECT_OFFSET UNITYSDK_OFFSET(0x1A59D7E0)
#define FOUNDATION_GAMEOBJECTX_RESETTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A59D3C0)
#define FOUNDATION_GAMEOBJECTX_SETACTIVERECURSIVELYEXT_OFFSET UNITYSDK_OFFSET(0x1A59D6B0)
#define FOUNDATION_GAMEOBJECTX_SETACTIVESAFELY_OFFSET UNITYSDK_OFFSET(0x1A59D5B0)
#define FOUNDATION_GAMEOBJECTX_SETCOLLISIONRECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1A59CD30)
#define FOUNDATION_GAMEOBJECTX_SETLAYERRECURSIVELY_OFFSET UNITYSDK_OFFSET(0x1A59C9E0)
#define FOUNDATION_GAMEOBJECTX_TOSTRINGPARENTHIERARCHY_OFFSET UNITYSDK_OFFSET(0x1A59A8E0)
#define FOUNDATION_GAMEOBJECTX_TOSTRINGRELATEDPATH_OFFSET UNITYSDK_OFFSET(0x1A59ABA0)

namespace Foundation
{
	inline static constexpr unsigned int GameObjectX_TypeDefinitionIndex = 8131;
