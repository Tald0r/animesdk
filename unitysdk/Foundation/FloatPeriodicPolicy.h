...
#define FOUNDATION_FLOATPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_SINGLE__INVOKE_OFFSET UNITYSDK_OFFSET(0x1AD02C90)
#define FOUNDATION_FLOATPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_SINGLE__ISVALIDPERIOD_OFFSET UNITYSDK_OFFSET(0x1AD02E20)
#define FOUNDATION_FLOATPERIODICPOLICY_FOUNDATION_IPLUSFUNC_SYSTEM_SINGLE__PLUS_OFFSET UNITYSDK_OFFSET(0x1AD02E30)
#define FOUNDATION_FLOATPERIODICPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD02E40)
#define FOUNDATION_FLOATPERIODICPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD02C80)

namespace Foundation
{
	inline static constexpr unsigned int FloatPeriodicPolicy_TypeDefinitionIndex = 9140;
	...
	public:
		...
		{
			return (::Foundation::FloatPeriodicPolicy**)Il2CppClass::FromTypeDefinitionIndex(FloatPeriodicPolicy_TypeDefinitionIndex)->GetStaticField(0x7EF0);
		}
