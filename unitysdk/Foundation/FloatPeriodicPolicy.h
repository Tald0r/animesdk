...
#define FOUNDATION_FLOATPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_SINGLE__INVOKE_OFFSET UNITYSDK_OFFSET(0x1B31D210)
#define FOUNDATION_FLOATPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_SINGLE__ISVALIDPERIOD_OFFSET UNITYSDK_OFFSET(0x1B31D390)
#define FOUNDATION_FLOATPERIODICPOLICY_FOUNDATION_IPLUSFUNC_SYSTEM_SINGLE__PLUS_OFFSET UNITYSDK_OFFSET(0x1B31D3A0)
#define FOUNDATION_FLOATPERIODICPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B31D3B0)
#define FOUNDATION_FLOATPERIODICPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B31D200)

namespace Foundation
{
	inline static constexpr unsigned int FloatPeriodicPolicy_TypeDefinitionIndex = 9046;
