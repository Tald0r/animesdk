...
#define FOUNDATION_ARITHMETICUTILS_BEZIEREXTRACTU_OFFSET UNITYSDK_OFFSET(0x1A7190C0)
#define FOUNDATION_ARITHMETICUTILS_CALCULATEINERTIALFLOATPOLYNOMIAL_OFFSET UNITYSDK_OFFSET(0x1A718BA0)
#define FOUNDATION_ARITHMETICUTILS_FROMTOROTATIONBYORIENTATION_OFFSET UNITYSDK_OFFSET(0x1A719700)
#define FOUNDATION_ARITHMETICUTILS_FROMTOROTATIONBYSHORTESTPATH_OFFSET UNITYSDK_OFFSET(0x1A7196A0)
#define FOUNDATION_ARITHMETICUTILS_FROMTOROTATIONWITHOUTTWIST_OFFSET UNITYSDK_OFFSET(0x1A719930)
#define FOUNDATION_ARITHMETICUTILS_FROMTOROTATIONWITHOUTZ_OFFSET UNITYSDK_OFFSET(0x1A719E90)
#define FOUNDATION_ARITHMETICUTILS_FROMTOROTATION_OFFSET UNITYSDK_OFFSET(0x1A7199E0)
#define FOUNDATION_ARITHMETICUTILS_GETNEXTLARGESTPOWOFTWO_1_OFFSET UNITYSDK_OFFSET(0x1A718670)
#define FOUNDATION_ARITHMETICUTILS_GETNEXTLARGESTPOWOFTWO_OFFSET UNITYSDK_OFFSET(0x1A718640)
#define FOUNDATION_ARITHMETICUTILS_ROUNDANGLE_OFFSET UNITYSDK_OFFSET(0x1A7189C0)
#define FOUNDATION_ARITHMETICUTILS_ROUNDIMPL_1_OFFSET UNITYSDK_OFFSET(0x1A718960)
#define FOUNDATION_ARITHMETICUTILS_ROUNDIMPL_OFFSET UNITYSDK_OFFSET(0x1A718910)
#define FOUNDATION_ARITHMETICUTILS_ROUNDPERIODIC_1_OFFSET UNITYSDK_OFFSET(0x1A7187F0)
#define FOUNDATION_ARITHMETICUTILS_ROUNDPERIODIC_OFFSET UNITYSDK_OFFSET(0x1A7186B0)
#define FOUNDATION_ARITHMETICUTILS_ROUNDRADIAN_1_OFFSET UNITYSDK_OFFSET(0x1A718B00)
#define FOUNDATION_ARITHMETICUTILS_ROUNDRADIAN_OFFSET UNITYSDK_OFFSET(0x1A718A60)
#define FOUNDATION_ARITHMETICUTILS_TRIANGLEAREA_OFFSET UNITYSDK_OFFSET(0x1A71AC60)
#define FOUNDATION_ARITHMETICUTILS__BEZIEREXTRACTU_G__ATAN2F_13_5_OFFSET UNITYSDK_OFFSET(0x1A7195B0)
#define FOUNDATION_ARITHMETICUTILS__BEZIEREXTRACTU_G__COSF_13_4_OFFSET UNITYSDK_OFFSET(0x1A7195E0)
#define FOUNDATION_ARITHMETICUTILS__BEZIEREXTRACTU_G__FABSF_13_2_OFFSET UNITYSDK_OFFSET(0x1A719580)
#define FOUNDATION_ARITHMETICUTILS__BEZIEREXTRACTU_G__FASTCBRTPOSITIVE_13_0_OFFSET UNITYSDK_OFFSET(0x1A7195C0)
#define FOUNDATION_ARITHMETICUTILS__BEZIEREXTRACTU_G__FASTCBRT_13_1_OFFSET UNITYSDK_OFFSET(0x1A7195F0)
#define FOUNDATION_ARITHMETICUTILS__BEZIEREXTRACTU_G__SQRTF_13_3_OFFSET UNITYSDK_OFFSET(0x1A719590)
#define FOUNDATION_ARITHMETICUTILS__CALCULATEINERTIALFLOATPOLYNOMIAL_G__CALCULATEINERTIALFLOATINTERNAL_12_0_OFFSET UNITYSDK_OFFSET(0x1A718CC0)
#define FOUNDATION_ARITHMETICUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A71ACC0)
#define FOUNDATION_ARITHMETICUTILS__FROMTOROTATIONWITHOUTZ_G__TOROTATION_18_2_OFFSET UNITYSDK_OFFSET(0x1A71AC00)
#define FOUNDATION_ARITHMETICUTILS__FROMTOROTATIONWITHOUTZ_G__TOSINRANGE_18_3_OFFSET UNITYSDK_OFFSET(0x1A71A5A0)
#define FOUNDATION_ARITHMETICUTILS__FROMTOROTATIONWITHOUTZ_G__TOSINXPLUSB_18_0_OFFSET UNITYSDK_OFFSET(0x1A71AAC0)
#define FOUNDATION_ARITHMETICUTILS__FROMTOROTATIONWITHOUTZ_G__TOY_18_1_OFFSET UNITYSDK_OFFSET(0x1A71AB60)

namespace Foundation
{
	inline static constexpr unsigned int ArithmeticUtils_TypeDefinitionIndex = 9183;
	...
	public:
		...
		{
			return (::Il2CppArray<::Foundation::Unreal::Interval_1<::System::Double>>**)Il2CppClass::FromTypeDefinitionIndex(ArithmeticUtils_TypeDefinitionIndex)->GetStaticField(0x7E80);
		}
