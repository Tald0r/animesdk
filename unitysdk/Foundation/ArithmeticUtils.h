...
#define FOUNDATION_ARITHMETICUTILS_BEZIEREXTRACTU_OFFSET UNITYSDK_OFFSET(0x1AB20610)
#define FOUNDATION_ARITHMETICUTILS_CALCULATEINERTIALFLOATPOLYNOMIAL_OFFSET UNITYSDK_OFFSET(0x1AB200F0)
#define FOUNDATION_ARITHMETICUTILS_FROMTOROTATIONBYORIENTATION_OFFSET UNITYSDK_OFFSET(0x1AB20C50)
#define FOUNDATION_ARITHMETICUTILS_FROMTOROTATIONBYSHORTESTPATH_OFFSET UNITYSDK_OFFSET(0x1AB20BF0)
#define FOUNDATION_ARITHMETICUTILS_FROMTOROTATIONWITHOUTTWIST_OFFSET UNITYSDK_OFFSET(0x1AB20E80)
#define FOUNDATION_ARITHMETICUTILS_FROMTOROTATIONWITHOUTZ_OFFSET UNITYSDK_OFFSET(0x1AB213E0)
#define FOUNDATION_ARITHMETICUTILS_FROMTOROTATION_OFFSET UNITYSDK_OFFSET(0x1AB20F30)
#define FOUNDATION_ARITHMETICUTILS_GETNEXTLARGESTPOWOFTWO_1_OFFSET UNITYSDK_OFFSET(0x1AB1FBD0)
#define FOUNDATION_ARITHMETICUTILS_GETNEXTLARGESTPOWOFTWO_OFFSET UNITYSDK_OFFSET(0x1AB1FBA0)
#define FOUNDATION_ARITHMETICUTILS_ROUNDANGLE_OFFSET UNITYSDK_OFFSET(0x1AB1FF10)
#define FOUNDATION_ARITHMETICUTILS_ROUNDIMPL_1_OFFSET UNITYSDK_OFFSET(0x1AB1FEB0)
#define FOUNDATION_ARITHMETICUTILS_ROUNDIMPL_OFFSET UNITYSDK_OFFSET(0x1AB1FE60)
#define FOUNDATION_ARITHMETICUTILS_ROUNDPERIODIC_1_OFFSET UNITYSDK_OFFSET(0x1AB1FD40)
#define FOUNDATION_ARITHMETICUTILS_ROUNDPERIODIC_OFFSET UNITYSDK_OFFSET(0x1AB1FC10)
#define FOUNDATION_ARITHMETICUTILS_ROUNDRADIAN_1_OFFSET UNITYSDK_OFFSET(0x1AB20050)
#define FOUNDATION_ARITHMETICUTILS_ROUNDRADIAN_OFFSET UNITYSDK_OFFSET(0x1AB1FFB0)
#define FOUNDATION_ARITHMETICUTILS_TRIANGLEAREA_OFFSET UNITYSDK_OFFSET(0x1AB221B0)
#define FOUNDATION_ARITHMETICUTILS__BEZIEREXTRACTU_G__ATAN2F_13_5_OFFSET UNITYSDK_OFFSET(0x1AB20B00)
#define FOUNDATION_ARITHMETICUTILS__BEZIEREXTRACTU_G__COSF_13_4_OFFSET UNITYSDK_OFFSET(0x1AB20B30)
#define FOUNDATION_ARITHMETICUTILS__BEZIEREXTRACTU_G__FABSF_13_2_OFFSET UNITYSDK_OFFSET(0x1AB20AD0)
#define FOUNDATION_ARITHMETICUTILS__BEZIEREXTRACTU_G__FASTCBRTPOSITIVE_13_0_OFFSET UNITYSDK_OFFSET(0x1AB20B10)
#define FOUNDATION_ARITHMETICUTILS__BEZIEREXTRACTU_G__FASTCBRT_13_1_OFFSET UNITYSDK_OFFSET(0x1AB20B40)
#define FOUNDATION_ARITHMETICUTILS__BEZIEREXTRACTU_G__SQRTF_13_3_OFFSET UNITYSDK_OFFSET(0x1AB20AE0)
#define FOUNDATION_ARITHMETICUTILS__CALCULATEINERTIALFLOATPOLYNOMIAL_G__CALCULATEINERTIALFLOATINTERNAL_12_0_OFFSET UNITYSDK_OFFSET(0x1AB20210)
#define FOUNDATION_ARITHMETICUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB22210)
#define FOUNDATION_ARITHMETICUTILS__FROMTOROTATIONWITHOUTZ_G__TOROTATION_18_2_OFFSET UNITYSDK_OFFSET(0x1AB22150)
#define FOUNDATION_ARITHMETICUTILS__FROMTOROTATIONWITHOUTZ_G__TOSINRANGE_18_3_OFFSET UNITYSDK_OFFSET(0x1AB21AF0)
#define FOUNDATION_ARITHMETICUTILS__FROMTOROTATIONWITHOUTZ_G__TOSINXPLUSB_18_0_OFFSET UNITYSDK_OFFSET(0x1AB22010)
#define FOUNDATION_ARITHMETICUTILS__FROMTOROTATIONWITHOUTZ_G__TOY_18_1_OFFSET UNITYSDK_OFFSET(0x1AB220B0)

namespace Foundation
{
	inline static constexpr unsigned int ArithmeticUtils_TypeDefinitionIndex = 8916;
