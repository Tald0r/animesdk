...
#define FOUNDATION_MULTIVERSIONINFO_HANDLEASSETPATHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA5E430)
#define FOUNDATION_MULTIVERSIONINFO_HANDLEASSETPATHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA5E4B0)
#define FOUNDATION_MULTIVERSIONINFO_HANDLEASSETPATHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA5DED0)
#define FOUNDATION_MULTIVERSIONINFO_HANDLEASSETPATHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA5DEB0)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionInfo_HandleAssetPathDelegate_TypeDefinitionIndex = 8142;
