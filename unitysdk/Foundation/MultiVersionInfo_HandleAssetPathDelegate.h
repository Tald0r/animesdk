...
#define FOUNDATION_MULTIVERSIONINFO_HANDLEASSETPATHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A860AB0)
#define FOUNDATION_MULTIVERSIONINFO_HANDLEASSETPATHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A860B30)
#define FOUNDATION_MULTIVERSIONINFO_HANDLEASSETPATHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A860550)
#define FOUNDATION_MULTIVERSIONINFO_HANDLEASSETPATHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A860540)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionInfo_HandleAssetPathDelegate_TypeDefinitionIndex = 8074;
