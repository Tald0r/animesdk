...
#define FOUNDATION_ASSETS_CONFIGHASHSETTRIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0191F0)

namespace Foundation
{
	inline static constexpr unsigned int Assets_ConfigHashSetTrim_TypeDefinitionIndex = 8027;
