...
#define FOUNDATION_ASSETS_CONFIGHASHSETTRIM__CTOR_OFFSET UNITYSDK_OFFSET(0x19A475A0)

namespace Foundation
{
	inline static constexpr unsigned int Assets_ConfigHashSetTrim_TypeDefinitionIndex = 7695;
