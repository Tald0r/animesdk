...
#define FOUNDATION_ZIP_ZIPHELPER_UNZIP_1_OFFSET UNITYSDK_OFFSET(0x1ABB8D70)
#define FOUNDATION_ZIP_ZIPHELPER_UNZIP_OFFSET UNITYSDK_OFFSET(0x1ABB8600)
#define FOUNDATION_ZIP_ZIPHELPER_ZIPDIRECTORY_1_OFFSET UNITYSDK_OFFSET(0x1ABB7870)
#define FOUNDATION_ZIP_ZIPHELPER_ZIPDIRECTORY_2_OFFSET UNITYSDK_OFFSET(0x1ABB7AD0)
#define FOUNDATION_ZIP_ZIPHELPER_ZIPDIRECTORY_OFFSET UNITYSDK_OFFSET(0x1ABB6EF0)
#define FOUNDATION_ZIP_ZIPHELPER_ZIPFILE_1_OFFSET UNITYSDK_OFFSET(0x1ABB82A0)
#define FOUNDATION_ZIP_ZIPHELPER_ZIPFILE_OFFSET UNITYSDK_OFFSET(0x1ABB7B80)
#define FOUNDATION_ZIP_ZIPHELPER_ZIP_1_OFFSET UNITYSDK_OFFSET(0x1ABB8550)
#define FOUNDATION_ZIP_ZIPHELPER_ZIP_OFFSET UNITYSDK_OFFSET(0x1ABB8350)
#define FOUNDATION_ZIP_ZIPHELPER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABB8E30)
#define FOUNDATION_ZIP_ZIPHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABB8E20)

namespace Foundation::Zip
{
	inline static constexpr unsigned int ZipHelper_TypeDefinitionIndex = 7964;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(ZipHelper_TypeDefinitionIndex)->GetStaticField(0x7140);
		}
