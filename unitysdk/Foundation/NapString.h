...
#define FOUNDATION_NAPSTRING_GETCACHESTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x1A02B0A0)
#define FOUNDATION_NAPSTRING_GET__STRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x1A026710)
#define FOUNDATION_NAPSTRING_STRINGCATOBJ_OFFSET UNITYSDK_OFFSET(0x1A02AC70)
#define FOUNDATION_NAPSTRING_STRINGCAT_10_OFFSET UNITYSDK_OFFSET(0x1A02A960)
#define FOUNDATION_NAPSTRING_STRINGCAT_1_OFFSET UNITYSDK_OFFSET(0x1A0273D0)
#define FOUNDATION_NAPSTRING_STRINGCAT_2_OFFSET UNITYSDK_OFFSET(0x1A0276F0)
#define FOUNDATION_NAPSTRING_STRINGCAT_3_OFFSET UNITYSDK_OFFSET(0x1A027AC0)
#define FOUNDATION_NAPSTRING_STRINGCAT_4_OFFSET UNITYSDK_OFFSET(0x1A027F40)
#define FOUNDATION_NAPSTRING_STRINGCAT_5_OFFSET UNITYSDK_OFFSET(0x1A028480)
#define FOUNDATION_NAPSTRING_STRINGCAT_6_OFFSET UNITYSDK_OFFSET(0x1A028A70)
#define FOUNDATION_NAPSTRING_STRINGCAT_7_OFFSET UNITYSDK_OFFSET(0x1A029120)
#define FOUNDATION_NAPSTRING_STRINGCAT_8_OFFSET UNITYSDK_OFFSET(0x1A029880)
#define FOUNDATION_NAPSTRING_STRINGCAT_9_OFFSET UNITYSDK_OFFSET(0x1A02A090)
#define FOUNDATION_NAPSTRING_STRINGCAT_OFFSET UNITYSDK_OFFSET(0x1A027370)
#define FOUNDATION_NAPSTRING_STRINGFORMATWITHPARAMS_1_OFFSET UNITYSDK_OFFSET(0x1A0267F0)
#define FOUNDATION_NAPSTRING_STRINGFORMATWITHPARAMS_2_OFFSET UNITYSDK_OFFSET(0x1A026AA0)
#define FOUNDATION_NAPSTRING_STRINGFORMATWITHPARAMS_3_OFFSET UNITYSDK_OFFSET(0x1A026D60)
#define FOUNDATION_NAPSTRING_STRINGFORMATWITHPARAMS_4_OFFSET UNITYSDK_OFFSET(0x1A027020)
#define FOUNDATION_NAPSTRING_STRINGFORMATWITHPARAMS_OFFSET UNITYSDK_OFFSET(0x1A026790)
#define FOUNDATION_NAPSTRING_STRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A027310)
#define FOUNDATION_NAPSTRING__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A02B360)

namespace Foundation
{
	inline static constexpr unsigned int NapString_TypeDefinitionIndex = 7996;
	...
	public:
		...
		{
			return (::System::Threading::ThreadLocal_1<::System::Text::StringBuilder*>**)Il2CppClass::FromTypeDefinitionIndex(NapString_TypeDefinitionIndex)->GetStaticField(0x7000);
		}
