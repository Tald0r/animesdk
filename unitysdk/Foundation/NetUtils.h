...
#define FOUNDATION_NETUTILS_CRC32WITHSEED_1_OFFSET UNITYSDK_OFFSET(0x170E6500)
#define FOUNDATION_NETUTILS_CRC32WITHSEED_2_OFFSET UNITYSDK_OFFSET(0x170E6600)
#define FOUNDATION_NETUTILS_CRC32WITHSEED_OFFSET UNITYSDK_OFFSET(0x170E62D0)
#define FOUNDATION_NETUTILS_CRC32_1_OFFSET UNITYSDK_OFFSET(0x170E5DA0)
#define FOUNDATION_NETUTILS_CRC32_2_OFFSET UNITYSDK_OFFSET(0x170E5FF0)
#define FOUNDATION_NETUTILS_CRC32_3_OFFSET UNITYSDK_OFFSET(0x170E5D30)
#define FOUNDATION_NETUTILS_CRC32_OFFSET UNITYSDK_OFFSET(0x170E5B00)
#define FOUNDATION_NETUTILS_FINALURL_OFFSET UNITYSDK_OFFSET(0x170E7260)
#define FOUNDATION_NETUTILS_GETBYTES_1_OFFSET UNITYSDK_OFFSET(0x170E4C50)
#define FOUNDATION_NETUTILS_GETBYTES_2_OFFSET UNITYSDK_OFFSET(0x170E4CF0)
#define FOUNDATION_NETUTILS_GETBYTES_3_OFFSET UNITYSDK_OFFSET(0x170E4D90)
#define FOUNDATION_NETUTILS_GETBYTES_4_OFFSET UNITYSDK_OFFSET(0x170E4E30)
#define FOUNDATION_NETUTILS_GETBYTES_5_OFFSET UNITYSDK_OFFSET(0x170E5070)
#define FOUNDATION_NETUTILS_GETBYTES_OFFSET UNITYSDK_OFFSET(0x170E4A20)
#define FOUNDATION_NETUTILS_GETIPADDRESS_1_OFFSET UNITYSDK_OFFSET(0x170E68F0)
#define FOUNDATION_NETUTILS_GETIPADDRESS_OFFSET UNITYSDK_OFFSET(0x170E6890)
#define FOUNDATION_NETUTILS_GETIPV6ADRESS_OFFSET UNITYSDK_OFFSET(0x170E6FF0)
#define FOUNDATION_NETUTILS_GETIPV6_OFFSET UNITYSDK_OFFSET(0x170E6EA0)
#define FOUNDATION_NETUTILS_GET_ISIPV6_OFFSET UNITYSDK_OFFSET(0x170E66D0)
#define FOUNDATION_NETUTILS_HOSTTONETWORKORDER_1_OFFSET UNITYSDK_OFFSET(0x170E4470)
#define FOUNDATION_NETUTILS_HOSTTONETWORKORDER_2_OFFSET UNITYSDK_OFFSET(0x170E4650)
#define FOUNDATION_NETUTILS_HOSTTONETWORKORDER_OFFSET UNITYSDK_OFFSET(0x170E42A0)
#define FOUNDATION_NETUTILS_ISIPADRESS_OFFSET UNITYSDK_OFFSET(0x170E6F00)
#define FOUNDATION_NETUTILS_ISIPV6_OFFSET UNITYSDK_OFFSET(0x170E66F0)
#define FOUNDATION_NETUTILS_NETWORKTOHOSTORDER_1_OFFSET UNITYSDK_OFFSET(0x170E48E0)
#define FOUNDATION_NETUTILS_NETWORKTOHOSTORDER_2_OFFSET UNITYSDK_OFFSET(0x170E4970)
#define FOUNDATION_NETUTILS_NETWORKTOHOSTORDER_OFFSET UNITYSDK_OFFSET(0x170E4860)
#define FOUNDATION_NETUTILS_SET_ISIPV6_OFFSET UNITYSDK_OFFSET(0x170E66E0)
#define FOUNDATION_NETUTILS_SIZEOF_1_OFFSET UNITYSDK_OFFSET(0x170E5310)
#define FOUNDATION_NETUTILS_SIZEOF_2_OFFSET UNITYSDK_OFFSET(0x170E5370)
#define FOUNDATION_NETUTILS_SIZEOF_3_OFFSET UNITYSDK_OFFSET(0x170E53D0)
#define FOUNDATION_NETUTILS_SIZEOF_4_OFFSET UNITYSDK_OFFSET(0x170E5430)
#define FOUNDATION_NETUTILS_SIZEOF_5_OFFSET UNITYSDK_OFFSET(0x170E5490)
#define FOUNDATION_NETUTILS_SIZEOF_6_OFFSET UNITYSDK_OFFSET(0x170E54F0)
#define FOUNDATION_NETUTILS_SIZEOF_7_OFFSET UNITYSDK_OFFSET(0x170E56B0)
#define FOUNDATION_NETUTILS_SIZEOF_OFFSET UNITYSDK_OFFSET(0x170E52B0)
#define FOUNDATION_NETUTILS_WRITEBYTESREVERSE_OFFSET UNITYSDK_OFFSET(0x170E5870)

namespace Foundation
{
	inline static constexpr unsigned int NetUtils_TypeDefinitionIndex = 7998;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(NetUtils_TypeDefinitionIndex)->GetStaticField(0x39D0);
		}
