...
#define FOUNDATION_BITSET256_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x96D920)
#define FOUNDATION_BITSET256_EQUALS_OFFSET UNITYSDK_OFFSET(0x96D830)
#define FOUNDATION_BITSET256_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96D8C0)
#define FOUNDATION_BITSET256_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x96D730)
#define FOUNDATION_BITSET256_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x1AF46B60)
#define FOUNDATION_BITSET256_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AF46B90)
#define FOUNDATION_BITSET256_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x96D7A0)
#define FOUNDATION_BITSET256__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AF46D80)
#define FOUNDATION_BITSET256__CTOR_OFFSET UNITYSDK_OFFSET(0x38AAB0)

namespace Foundation
{
	inline static constexpr unsigned int BitSet256_TypeDefinitionIndex = 8983;

	struct alignas(8) BitSet256
	{
		static ::Foundation::BitSet256* StaticGet_Empty()
		{
			return (::Foundation::BitSet256*)Il2CppClass::FromTypeDefinitionIndex(BitSet256_TypeDefinitionIndex)->GetStaticField(0x3D40);
		}
		static ::Foundation::BitSet256* StaticGet_Full()
		{
			return (::Foundation::BitSet256*)Il2CppClass::FromTypeDefinitionIndex(BitSet256_TypeDefinitionIndex)->GetStaticField(0x3D60);
		}
