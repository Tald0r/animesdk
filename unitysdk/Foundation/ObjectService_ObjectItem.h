...
#define FOUNDATION_OBJECTSERVICE_OBJECTITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x99C7F0)

namespace Foundation
{
	inline static constexpr unsigned int ObjectService_ObjectItem_TypeDefinitionIndex = 9107;
