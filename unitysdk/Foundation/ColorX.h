...
#define FOUNDATION_COLORX_COLORTOHEX_OFFSET UNITYSDK_OFFSET(0x1B0F4E90)
#define FOUNDATION_COLORX_HEXTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1B0F51F0)
#define FOUNDATION_COLORX_LERP_OFFSET UNITYSDK_OFFSET(0x1B0F53D0)
#define FOUNDATION_COLORX_TOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1B0F54B0)

namespace Foundation
{
	inline static constexpr unsigned int ColorX_TypeDefinitionIndex = 7939;
