...
#define FOUNDATION_COLORX_COLORTOHEX_OFFSET UNITYSDK_OFFSET(0x1AB3D7D0)
#define FOUNDATION_COLORX_HEXTOCOLOR_OFFSET UNITYSDK_OFFSET(0x1AB3DB30)
#define FOUNDATION_COLORX_LERP_OFFSET UNITYSDK_OFFSET(0x1AB3DD10)
#define FOUNDATION_COLORX_TOVECTOR3_OFFSET UNITYSDK_OFFSET(0x1AB3DDF0)

namespace Foundation
{
	inline static constexpr unsigned int ColorX_TypeDefinitionIndex = 7692;
