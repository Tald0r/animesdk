...
#define FOUNDATION_DOWNLOADVERIFIER_COPYFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1AB3F4B0)
#define FOUNDATION_DOWNLOADVERIFIER_DELETEFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1AB3F210)
#define FOUNDATION_DOWNLOADVERIFIER_GETTEMPFILEPATH_OFFSET UNITYSDK_OFFSET(0x1AB3E830)
#define FOUNDATION_DOWNLOADVERIFIER_MOVEFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1AB3F350)
#define FOUNDATION_DOWNLOADVERIFIER_RENAMETEMPFILE_OFFSET UNITYSDK_OFFSET(0x1AB3EA70)
#define FOUNDATION_DOWNLOADVERIFIER_VERIFYANDRENAMETEMPFILE_OFFSET UNITYSDK_OFFSET(0x1AB3E790)
#define FOUNDATION_DOWNLOADVERIFIER_VERIFYFILE_OFFSET UNITYSDK_OFFSET(0x1AB3E930)
#define FOUNDATION_DOWNLOADVERIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB3F610)

namespace Foundation
{
	inline static constexpr unsigned int DownloadVerifier_TypeDefinitionIndex = 8294;
