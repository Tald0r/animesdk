...
#define FOUNDATION_DOWNLOADVERIFIER_COPYFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1B0F6B60)
#define FOUNDATION_DOWNLOADVERIFIER_DELETEFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1B0F68C0)
#define FOUNDATION_DOWNLOADVERIFIER_GETTEMPFILEPATH_OFFSET UNITYSDK_OFFSET(0x1B0F5EE0)
#define FOUNDATION_DOWNLOADVERIFIER_MOVEFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1B0F6A00)
#define FOUNDATION_DOWNLOADVERIFIER_RENAMETEMPFILE_OFFSET UNITYSDK_OFFSET(0x1B0F6120)
#define FOUNDATION_DOWNLOADVERIFIER_VERIFYANDRENAMETEMPFILE_OFFSET UNITYSDK_OFFSET(0x1B0F5E40)
#define FOUNDATION_DOWNLOADVERIFIER_VERIFYFILE_OFFSET UNITYSDK_OFFSET(0x1B0F5FE0)
#define FOUNDATION_DOWNLOADVERIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F6CC0)

namespace Foundation
{
	inline static constexpr unsigned int DownloadVerifier_TypeDefinitionIndex = 7791;
