...
#define FOUNDATION_ASSETPOOLEDITORMODE_ADDINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x19371BD0)
#define FOUNDATION_ASSETPOOLEDITORMODE_ADDINSTANCE_OFFSET UNITYSDK_OFFSET(0x19371B20)
#define FOUNDATION_ASSETPOOLEDITORMODE_APPLICATIONONLOWMEMORY_OFFSET UNITYSDK_OFFSET(0x19371AC0)
#define FOUNDATION_ASSETPOOLEDITORMODE_GETINSTANCEASYNC_1_OFFSET UNITYSDK_OFFSET(0x19371E80)
#define FOUNDATION_ASSETPOOLEDITORMODE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x19371D80)
#define FOUNDATION_ASSETPOOLEDITORMODE_GETINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x19372140)
#define FOUNDATION_ASSETPOOLEDITORMODE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x19372060)
#define FOUNDATION_ASSETPOOLEDITORMODE_INITINSTANTIATEDPREVIEWRECURSIVE_OFFSET UNITYSDK_OFFSET(0x19372420)
#define FOUNDATION_ASSETPOOLEDITORMODE_INTERNALDESTROY_OFFSET UNITYSDK_OFFSET(0x19371CF0)
#define FOUNDATION_ASSETPOOLEDITORMODE_RELEASE_OFFSET UNITYSDK_OFFSET(0x193723C0)
#define FOUNDATION_ASSETPOOLEDITORMODE_UNLOAD_1_OFFSET UNITYSDK_OFFSET(0x19372800)
#define FOUNDATION_ASSETPOOLEDITORMODE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x19372790)
#define FOUNDATION_ASSETPOOLEDITORMODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19372870)
#define FOUNDATION_ASSETPOOLEDITORMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19371AB0)

namespace Foundation
{
	inline static constexpr unsigned int AssetPoolEditorMode_TypeDefinitionIndex = 7837;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AssetPoolEditorMode_TypeDefinitionIndex)->GetStaticField(0x3840);
		}
