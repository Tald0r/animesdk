...
#define FOUNDATION_ASSETPOOLEDITORMODE_ADDINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1975E980)
#define FOUNDATION_ASSETPOOLEDITORMODE_ADDINSTANCE_OFFSET UNITYSDK_OFFSET(0x1975E8D0)
#define FOUNDATION_ASSETPOOLEDITORMODE_APPLICATIONONLOWMEMORY_OFFSET UNITYSDK_OFFSET(0x1975E870)
#define FOUNDATION_ASSETPOOLEDITORMODE_GETINSTANCEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1975EC30)
#define FOUNDATION_ASSETPOOLEDITORMODE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1975EB30)
#define FOUNDATION_ASSETPOOLEDITORMODE_GETINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1975EEF0)
#define FOUNDATION_ASSETPOOLEDITORMODE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1975EE10)
#define FOUNDATION_ASSETPOOLEDITORMODE_INITINSTANTIATEDPREVIEWRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1975F1D0)
#define FOUNDATION_ASSETPOOLEDITORMODE_INTERNALDESTROY_OFFSET UNITYSDK_OFFSET(0x1975EAA0)
#define FOUNDATION_ASSETPOOLEDITORMODE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1975F170)
#define FOUNDATION_ASSETPOOLEDITORMODE_UNLOAD_1_OFFSET UNITYSDK_OFFSET(0x1975F5B0)
#define FOUNDATION_ASSETPOOLEDITORMODE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1975F540)
#define FOUNDATION_ASSETPOOLEDITORMODE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1975F620)
#define FOUNDATION_ASSETPOOLEDITORMODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1975E860)

namespace Foundation
{
	inline static constexpr unsigned int AssetPoolEditorMode_TypeDefinitionIndex = 8281;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(AssetPoolEditorMode_TypeDefinitionIndex)->GetStaticField(0x3850);
		}
