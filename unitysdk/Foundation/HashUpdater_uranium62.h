...
#define FOUNDATION_HASHUPDATER_URANIUM62_DIGEST_OFFSET UNITYSDK_OFFSET(0xA0BF7D0)
#define FOUNDATION_HASHUPDATER_URANIUM62_RESET_OFFSET UNITYSDK_OFFSET(0xA0BF990)
#define FOUNDATION_HASHUPDATER_URANIUM62_UPDATE_OFFSET UNITYSDK_OFFSET(0xA0BF730)
#define FOUNDATION_HASHUPDATER_URANIUM62__CTOR_OFFSET UNITYSDK_OFFSET(0xA0BF6E0)

namespace Foundation
{
	inline static constexpr unsigned int HashUpdater_uranium62_TypeDefinitionIndex = 53791;
