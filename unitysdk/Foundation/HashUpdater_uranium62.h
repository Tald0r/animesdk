...
#define FOUNDATION_HASHUPDATER_URANIUM62_DIGEST_OFFSET UNITYSDK_OFFSET(0xD718730)
#define FOUNDATION_HASHUPDATER_URANIUM62_RESET_OFFSET UNITYSDK_OFFSET(0xD7188F0)
#define FOUNDATION_HASHUPDATER_URANIUM62_UPDATE_OFFSET UNITYSDK_OFFSET(0xD718690)
#define FOUNDATION_HASHUPDATER_URANIUM62__CTOR_OFFSET UNITYSDK_OFFSET(0xD718640)

namespace Foundation
{
	inline static constexpr unsigned int HashUpdater_uranium62_TypeDefinitionIndex = 41680;
