...
#define FOUNDATION_DOUBLEPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_DOUBLE__INVOKE_OFFSET UNITYSDK_OFFSET(0x1B396A00)
#define FOUNDATION_DOUBLEPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_DOUBLE__ISVALIDPERIOD_OFFSET UNITYSDK_OFFSET(0x1B396B70)
#define FOUNDATION_DOUBLEPERIODICPOLICY_FOUNDATION_IPLUSFUNC_SYSTEM_DOUBLE__PLUS_OFFSET UNITYSDK_OFFSET(0x1B396B80)
#define FOUNDATION_DOUBLEPERIODICPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B396B90)
#define FOUNDATION_DOUBLEPERIODICPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3969F0)

namespace Foundation
{
	inline static constexpr unsigned int DoublePeriodicPolicy_TypeDefinitionIndex = 8771;
