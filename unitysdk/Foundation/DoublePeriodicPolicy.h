...
#define FOUNDATION_DOUBLEPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_DOUBLE__INVOKE_OFFSET UNITYSDK_OFFSET(0x1AD8E520)
#define FOUNDATION_DOUBLEPERIODICPOLICY_FOUNDATION_IPERIODICPOLICY_SYSTEM_DOUBLE__ISVALIDPERIOD_OFFSET UNITYSDK_OFFSET(0x1AD8E690)
#define FOUNDATION_DOUBLEPERIODICPOLICY_FOUNDATION_IPLUSFUNC_SYSTEM_DOUBLE__PLUS_OFFSET UNITYSDK_OFFSET(0x1AD8E6A0)
#define FOUNDATION_DOUBLEPERIODICPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD8E6B0)
#define FOUNDATION_DOUBLEPERIODICPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD8E510)

namespace Foundation
{
	inline static constexpr unsigned int DoublePeriodicPolicy_TypeDefinitionIndex = 9180;
	...
	public:
		...
		{
			return (::Foundation::DoublePeriodicPolicy**)Il2CppClass::FromTypeDefinitionIndex(DoublePeriodicPolicy_TypeDefinitionIndex)->GetStaticField(0x7EA0);
		}
