...
#define FOUNDATION_ENDOFFRAMESERVICE_DOENDOFFRAMEWORK_OFFSET UNITYSDK_OFFSET(0x1B3AC260)
#define FOUNDATION_ENDOFFRAMESERVICE_FOUNDATION_IGAMESERVICE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1B3AC7F0)
#define FOUNDATION_ENDOFFRAMESERVICE_FOUNDATION_IGAMESERVICE_ONREADYTODESTROY_OFFSET UNITYSDK_OFFSET(0x1B3AC7E0)
#define FOUNDATION_ENDOFFRAMESERVICE_INVOKECALLONCECALLBACK_OFFSET UNITYSDK_OFFSET(0x1B3AC230)
#define FOUNDATION_ENDOFFRAMESERVICE_INVOKESELFDETERMINEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1B3AC130)
#define FOUNDATION_ENDOFFRAMESERVICE_REGISTER_OFFSET UNITYSDK_OFFSET(0x1B3AC660)
#define FOUNDATION_ENDOFFRAMESERVICE_START_OFFSET UNITYSDK_OFFSET(0x1B3AC0E0)
#define FOUNDATION_ENDOFFRAMESERVICE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1B3AC720)
#define FOUNDATION_ENDOFFRAMESERVICE_VALIDATEINVARIANT_OFFSET UNITYSDK_OFFSET(0x1B3AC250)
#define FOUNDATION_ENDOFFRAMESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3ABEB0)

namespace Foundation
{
	inline static constexpr unsigned int EndOfFrameService_TypeDefinitionIndex = 8823;
