...
#define FOUNDATION_ENDOFFRAMESERVICE_DOENDOFFRAMEWORK_OFFSET UNITYSDK_OFFSET(0x1ADDB7A0)
#define FOUNDATION_ENDOFFRAMESERVICE_FOUNDATION_IGAMESERVICE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1ADDBD30)
#define FOUNDATION_ENDOFFRAMESERVICE_FOUNDATION_IGAMESERVICE_ONREADYTODESTROY_OFFSET UNITYSDK_OFFSET(0x1ADDBD20)
#define FOUNDATION_ENDOFFRAMESERVICE_INVOKECALLONCECALLBACK_OFFSET UNITYSDK_OFFSET(0x1ADDB770)
#define FOUNDATION_ENDOFFRAMESERVICE_INVOKESELFDETERMINEDCALLBACK_OFFSET UNITYSDK_OFFSET(0x1ADDB670)
#define FOUNDATION_ENDOFFRAMESERVICE_REGISTER_OFFSET UNITYSDK_OFFSET(0x1ADDBBA0)
#define FOUNDATION_ENDOFFRAMESERVICE_START_OFFSET UNITYSDK_OFFSET(0x1ADDB620)
#define FOUNDATION_ENDOFFRAMESERVICE_UNREGISTER_OFFSET UNITYSDK_OFFSET(0x1ADDBC60)
#define FOUNDATION_ENDOFFRAMESERVICE_VALIDATEINVARIANT_OFFSET UNITYSDK_OFFSET(0x1ADDB790)
#define FOUNDATION_ENDOFFRAMESERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADDB3F0)

namespace Foundation
{
	inline static constexpr unsigned int EndOfFrameService_TypeDefinitionIndex = 9091;

	class EndOfFrameService : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Collections::Generic::List_1<::System::Func_1<::System::Boolean>*>*>* _selfDeterminedCallbacks; // 0x10
		::Il2CppArray<::System::Action*>* _callOnceCallbacks; // 0x18
		::Il2CppArray<::System::Action*>* _callbacks; // 0x20
		::UnityEngine::WaitForEndOfFrame* _endOfFrame; // 0x28
