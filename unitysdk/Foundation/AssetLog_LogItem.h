...
#define FOUNDATION_ASSETLOG_LOGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB6F020)

namespace Foundation
{
	inline static constexpr unsigned int AssetLog_LogItem_TypeDefinitionIndex = 7777;

	class AssetLog_LogItem : public ::System::Object
	{
	public:
		::System::String* TypeInfo; // 0x10
		::System::String* RefAsset; // 0x18
		::System::String* TimeInfo; // 0x20
		::System::String* CallStack; // 0x28
