...
#define FOUNDATION_ASSETLOG_LOGITEM__CTOR_OFFSET UNITYSDK_OFFSET(0x1A596D80)

namespace Foundation
{
	inline static constexpr unsigned int AssetLog_LogItem_TypeDefinitionIndex = 8113;

	class AssetLog_LogItem : public ::System::Object
	{
	public:
		::System::String* TypeInfo; // 0x10
		::System::String* TimeInfo; // 0x18
		::System::String* Path; // 0x20
		::System::String* RefAsset; // 0x28
		::System::String* CallStack; // 0x30
