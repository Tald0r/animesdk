...
#define FOUNDATION_IDGENERATOR_GETINTERNALCOUNTER_OFFSET UNITYSDK_OFFSET(0x19C4A850)
#define FOUNDATION_IDGENERATOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x19C4A9D0)

namespace Foundation
{
	inline static constexpr unsigned int IDGenerator_TypeDefinitionIndex = 8899;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(IDGenerator_TypeDefinitionIndex)->GetStaticField(0x3EF0);
		}
