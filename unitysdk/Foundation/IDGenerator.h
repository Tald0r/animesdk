...
#define FOUNDATION_IDGENERATOR_GETINTERNALCOUNTER_OFFSET UNITYSDK_OFFSET(0x1A1D8C90)
#define FOUNDATION_IDGENERATOR_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A1D8E10)

namespace Foundation
{
	inline static constexpr unsigned int IDGenerator_TypeDefinitionIndex = 8802;
	...
	public:
		...
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(IDGenerator_TypeDefinitionIndex)->GetStaticField(0x3F10);
		}
