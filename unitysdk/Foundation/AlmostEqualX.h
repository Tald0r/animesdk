...
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_1_OFFSET UNITYSDK_OFFSET(0x1AB6EC80)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_2_OFFSET UNITYSDK_OFFSET(0x1AB6ED30)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_3_OFFSET UNITYSDK_OFFSET(0x1AB6EE20)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_4_OFFSET UNITYSDK_OFFSET(0x1AB6EED0)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_OFFSET UNITYSDK_OFFSET(0x1AB6EBB0)

namespace Foundation
{
	inline static constexpr unsigned int AlmostEqualX_TypeDefinitionIndex = 8031;
