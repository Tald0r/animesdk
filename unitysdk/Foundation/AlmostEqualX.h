...
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_1_OFFSET UNITYSDK_OFFSET(0x1A5969E0)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_2_OFFSET UNITYSDK_OFFSET(0x1A596A90)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_3_OFFSET UNITYSDK_OFFSET(0x1A596B80)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_4_OFFSET UNITYSDK_OFFSET(0x1A596C30)
#define FOUNDATION_ALMOSTEQUALX_ALMOSTEQUALS_OFFSET UNITYSDK_OFFSET(0x1A596910)

namespace Foundation
{
	inline static constexpr unsigned int AlmostEqualX_TypeDefinitionIndex = 7953;
