...
#define FOUNDATION_CITYHASH_CITYHASH128TO64_OFFSET UNITYSDK_OFFSET(0x1B4C3530)
#define FOUNDATION_CITYHASH_CITYHASH64WITHSEEDS_OFFSET UNITYSDK_OFFSET(0x1B4C34C0)
#define FOUNDATION_CITYHASH_CITYHASH64WITHSEED_OFFSET UNITYSDK_OFFSET(0x1B4C3470)
#define FOUNDATION_CITYHASH_CITYHASH64_OFFSET UNITYSDK_OFFSET(0x1B4C2FB0)
#define FOUNDATION_CITYHASH_FETCH32_OFFSET UNITYSDK_OFFSET(0x1B4C3520)
#define FOUNDATION_CITYHASH_FETCH64_OFFSET UNITYSDK_OFFSET(0x1B4C3510)
#define FOUNDATION_CITYHASH_HASHLEN0TO16_OFFSET UNITYSDK_OFFSET(0x1B4C2CD0)
#define FOUNDATION_CITYHASH_HASHLEN16_1_OFFSET UNITYSDK_OFFSET(0x1B4C2CA0)
#define FOUNDATION_CITYHASH_HASHLEN16_OFFSET UNITYSDK_OFFSET(0x1B4C2C60)
#define FOUNDATION_CITYHASH_HASHLEN17TO32_OFFSET UNITYSDK_OFFSET(0x1B4C2DD0)
#define FOUNDATION_CITYHASH_HASHLEN33TO64_OFFSET UNITYSDK_OFFSET(0x1B4C2ED0)
#define FOUNDATION_CITYHASH_ROTATE_OFFSET UNITYSDK_OFFSET(0x1B4C2C30)
#define FOUNDATION_CITYHASH_SHIFTMIX_OFFSET UNITYSDK_OFFSET(0x1B4C2C50)
#define FOUNDATION_CITYHASH_WEAKHASHLEN32WITHSEEDS_1_OFFSET UNITYSDK_OFFSET(0x1B4C2E90)
#define FOUNDATION_CITYHASH_WEAKHASHLEN32WITHSEEDS_OFFSET UNITYSDK_OFFSET(0x1B4C2E50)

namespace Foundation
{
	inline static constexpr unsigned int CityHash_TypeDefinitionIndex = 9071;
