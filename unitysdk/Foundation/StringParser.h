...
#define FOUNDATION_STRINGPARSER_PARSETODICTIONARY_OFFSET UNITYSDK_OFFSET(0x1AD35820)
#define FOUNDATION_STRINGPARSER_PARSETOINTLIST_OFFSET UNITYSDK_OFFSET(0x1AD35680)

namespace Foundation
{
	inline static constexpr unsigned int StringParser_TypeDefinitionIndex = 8190;
