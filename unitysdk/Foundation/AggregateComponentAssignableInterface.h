...
#define FOUNDATION_AGGREGATECOMPONENTASSIGNABLEINTERFACE_GET_OFFSET UNITYSDK_OFFSET(0x90D440)
#define FOUNDATION_AGGREGATECOMPONENTASSIGNABLEINTERFACE_ISASSIGNABLE_OFFSET UNITYSDK_OFFSET(0x90D4F0)
#define FOUNDATION_AGGREGATECOMPONENTASSIGNABLEINTERFACE__CTOR_OFFSET UNITYSDK_OFFSET(0x90D430)

namespace Foundation
{
	inline static constexpr unsigned int AggregateComponentAssignableInterface_TypeDefinitionIndex = 8819;
