...
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x3275B0)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_FREE_OFFSET UNITYSDK_OFFSET(0x8EEC00)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x3B0730)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_MALLOC_OFFSET UNITYSDK_OFFSET(0x8EEC20)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x8EEC40)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3600)

namespace Foundation
{
	inline static constexpr unsigned int DefaultNativeAllocator_TypeDefinitionIndex = 8882;
