...
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_EQUALS_OFFSET UNITYSDK_OFFSET(0x32E7F0)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_FREE_OFFSET UNITYSDK_OFFSET(0x917B20)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x2EAC30)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_MALLOC_OFFSET UNITYSDK_OFFSET(0x917B40)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x917B60)
#define FOUNDATION_DEFAULTNATIVEALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x302300)

namespace Foundation
{
	inline static constexpr unsigned int DefaultNativeAllocator_TypeDefinitionIndex = 8822;
