...
#define FOUNDATION_INSTANCEPOOLREQUEST___C__DISPLAYCLASS16_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC5950)
#define FOUNDATION_INSTANCEPOOLREQUEST___C__DISPLAYCLASS16_0__GETINSTANCEASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1ABC5960)

namespace Foundation
{
	inline static constexpr unsigned int InstancePoolRequest___c__DisplayClass16_0_TypeDefinitionIndex = 8125;
