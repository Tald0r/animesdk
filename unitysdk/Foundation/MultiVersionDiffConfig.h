...
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1B0F6E90)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_GETALLOTHERVERSIONPATHS_OFFSET UNITYSDK_OFFSET(0x1B0F73A0)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_GETASSETPATHS_OFFSET UNITYSDK_OFFSET(0x1B0F6F80)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_UPDATEHASH_OFFSET UNITYSDK_OFFSET(0x1B0F7230)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F7650)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionDiffConfig_TypeDefinitionIndex = 7762;
