...
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_MULTIVERSIONDIFFCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1ABC5AA0)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_MULTIVERSIONDIFFCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1ABC5AB0)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_MULTIVERSIONDIFFCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1ABC5CB0)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_MULTIVERSIONDIFFCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ABC5E70)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_MULTIVERSIONDIFFCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC5E30)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionDiffConfig_MultiVersionDiffConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 8091;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::Foundation::MultiVersionErrorRef*>*>**)Il2CppClass::FromTypeDefinitionIndex(MultiVersionDiffConfig_MultiVersionDiffConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x73F0);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::Foundation::MultiVersionInfo*>*>**)Il2CppClass::FromTypeDefinitionIndex(MultiVersionDiffConfig_MultiVersionDiffConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x73F8);
		}
