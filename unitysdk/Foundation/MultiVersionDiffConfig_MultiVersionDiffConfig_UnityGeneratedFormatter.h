...
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_MULTIVERSIONDIFFCONFIG_UNITYGENERATEDFORMATTER_GET_MEMBERCOUNT_OFFSET UNITYSDK_OFFSET(0x1B2188E0)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_MULTIVERSIONDIFFCONFIG_UNITYGENERATEDFORMATTER_READMEMBER_OFFSET UNITYSDK_OFFSET(0x1B2188F0)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_MULTIVERSIONDIFFCONFIG_UNITYGENERATEDFORMATTER_WRITE_OFFSET UNITYSDK_OFFSET(0x1B218AF0)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_MULTIVERSIONDIFFCONFIG_UNITYGENERATEDFORMATTER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B218CB0)
#define FOUNDATION_MULTIVERSIONDIFFCONFIG_MULTIVERSIONDIFFCONFIG_UNITYGENERATEDFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B218C70)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionDiffConfig_MultiVersionDiffConfig_UnityGeneratedFormatter_TypeDefinitionIndex = 7766;
	...
	public:
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::Foundation::MultiVersionInfo*>*>**)Il2CppClass::FromTypeDefinitionIndex(MultiVersionDiffConfig_MultiVersionDiffConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x7060);
		}
		...
		{
			return (::Sirenix::Serialization::Serializer_1<::System::Collections::Generic::List_1<::Foundation::MultiVersionErrorRef*>*>**)Il2CppClass::FromTypeDefinitionIndex(MultiVersionDiffConfig_MultiVersionDiffConfig_UnityGeneratedFormatter_TypeDefinitionIndex)->GetStaticField(0x7068);
		}
