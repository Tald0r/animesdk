...
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_EQUALS_OFFSET UNITYSDK_OFFSET(0x399050)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_GET_COMBINEMEMBERID_OFFSET UNITYSDK_OFFSET(0x398FC0)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_GET_ISGROUP_OFFSET UNITYSDK_OFFSET(0x399030)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x315EF0)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_NEW_1_OFFSET UNITYSDK_OFFSET(0xB422E70)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_NEW_2_OFFSET UNITYSDK_OFFSET(0xB422EE0)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_NEW_OFFSET UNITYSDK_OFFSET(0xB422E00)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3990D0)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER__CCTOR_OFFSET UNITYSDK_OFFSET(0xB423240)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x399040)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3730)
#define FOUNDATION_VIEWOBJECT_GROUPMEMBERIDENTIFIER___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3990E0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int GroupMemberIdentifier_TypeDefinitionIndex = 57730;

	struct alignas(4) GroupMemberIdentifier
	{
		static ::Il2CppArray<::System::Char>** StaticGet_seperator()
		{
			return (::Il2CppArray<::System::Char>**)Il2CppClass::FromTypeDefinitionIndex(GroupMemberIdentifier_TypeDefinitionIndex)->GetStaticField(0x31360);
		}
