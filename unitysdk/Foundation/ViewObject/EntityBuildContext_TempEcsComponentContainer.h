...
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_TEMPECSCOMPONENTCONTAINER_ADD_OFFSET UNITYSDK_OFFSET(0xA3FFEE0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_TEMPECSCOMPONENTCONTAINER_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xA3FFE30)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_TEMPECSCOMPONENTCONTAINER_RESET_OFFSET UNITYSDK_OFFSET(0xA3FFDA0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_TEMPECSCOMPONENTCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0xA3FFFB0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int EntityBuildContext_TempEcsComponentContainer_TypeDefinitionIndex = 43974;
