...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER__DORELOADGROUP_D__111_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x2D29B0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER__DORELOADGROUP_D__111_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectManager__DoReloadGroup_d__111_TypeDefinitionIndex = 49680;

	struct alignas(8) ViewObjectManager__DoReloadGroup_d__111
	{
		::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder __t__builder; // 0x10
		::Foundation::ViewObject::ViewObjectManager_ReloadParamBase* param; // 0x20
		::Foundation::ViewObject::ViewObjectManager_ReloadGroupParam* _groupParam_5__3; // 0x28
