...
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER__GETVALUE_D__11_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x345240)
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER__GETVALUE_D__11_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int GroupVariableHelper__GetValue_d__11_TypeDefinitionIndex = 68072;
