...
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER__PUSHSINGLE_D__14_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3668D0)
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER__PUSHSINGLE_D__14_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int GroupVariableHelper__PushSingle_d__14_TypeDefinitionIndex = 41672;
	...
	struct alignas(8) GroupVariableHelper__PushSingle_d__14
	{
		...
		::Cysharp::Threading::Tasks::UniTask_1_Awaiter<::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_0_16E4307DCC419505_3*>*> __u__1; // 0x40
		::Class_3_3EC97B498E0B85D2* reason; // 0x58
