...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_ADDREADYREQUIRE_OFFSET UNITYSDK_OFFSET(0x6C456A0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_ADD_OFFSET UNITYSDK_OFFSET(0x6C45270)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_ENABLE_OFFSET UNITYSDK_OFFSET(0x6C45350)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_FINDASSOCIATEDENTITY_OFFSET UNITYSDK_OFFSET(0x6C46540)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_GETCURRENTSUITE_1_OFFSET UNITYSDK_OFFSET(0x6C48AB0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_GETCURRENTSUITE_OFFSET UNITYSDK_OFFSET(0x6C3A760)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_GETDFSCRIPTBYGRAPHID_OFFSET UNITYSDK_OFFSET(0x6C479C0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_GETDFSCRIPTSBYSUITEINFO_OFFSET UNITYSDK_OFFSET(0x6C46F80)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_GETENTITYHANDLE_OFFSET UNITYSDK_OFFSET(0x6C48B90)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_GETGROUPANDMEMID_OFFSET UNITYSDK_OFFSET(0x6C462A0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_GETMETAFLAGS_OFFSET UNITYSDK_OFFSET(0x6C46B60)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_GETRUNTIMEID_OFFSET UNITYSDK_OFFSET(0x6C45FA0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_GETVIEWOBJECTHANDLE_OFFSET UNITYSDK_OFFSET(0x6C48C30)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_GETVIEWOBJECT_OFFSET UNITYSDK_OFFSET(0x6C45DD0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_HASALL_OFFSET UNITYSDK_OFFSET(0x6C45200)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_HASANY_OFFSET UNITYSDK_OFFSET(0x6C45190)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_HASHREADYFLAGS_OFFSET UNITYSDK_OFFSET(0x6C45B70)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_ISGROUPVIEWOBJECT_OFFSET UNITYSDK_OFFSET(0x6C48520)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_ISREADY_OFFSET UNITYSDK_OFFSET(0x6C454B0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_ISVALID_OFFSET UNITYSDK_OFFSET(0x6C3A580)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_REMOVEREADYREQUIRE_OFFSET UNITYSDK_OFFSET(0x6C45900)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_REMOVE_OFFSET UNITYSDK_OFFSET(0x6C452E0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_SENDCUSTOMEVENT_OFFSET UNITYSDK_OFFSET(0x6C48820)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_SENDEVENTINSTANT_OFFSET UNITYSDK_OFFSET(0x6C485F0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_SENDEVENT_1_OFFSET UNITYSDK_OFFSET(0x6C478F0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_SENDEVENT_OFFSET UNITYSDK_OFFSET(0x6C46D50)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_TRYGETASSOCIATEDENTITY_OFFSET UNITYSDK_OFFSET(0x6C46630)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_TRYGETBASICDATA_OFFSET UNITYSDK_OFFSET(0x6C48F70)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_TRYGETGROUPANDMEMID_OFFSET UNITYSDK_OFFSET(0x6C46190)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_TRYGETGROUPID_OFFSET UNITYSDK_OFFSET(0x6C463A0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_TRYGETMEMBERID_OFFSET UNITYSDK_OFFSET(0x6C46480)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_TRYGETOWNERGROUP_OFFSET UNITYSDK_OFFSET(0x6C48290)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_TRYGETVIEWOBJECTASSOCIATEDENTITY_OFFSET UNITYSDK_OFFSET(0x6C48D50)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_TRYGETVIEWOBJECTBYENTITY_OFFSET UNITYSDK_OFFSET(0x6C48E60)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_TRYGETVIEWOBJECTENTITYPOSROT_OFFSET UNITYSDK_OFFSET(0x6C466D0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_TRYGETVIEWOBJECTHANDLE_OFFSET UNITYSDK_OFFSET(0x6C48CB0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_TRYGETVOCONFIGPOSROT_OFFSET UNITYSDK_OFFSET(0x6C46A50)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectExtension_TypeDefinitionIndex = 77770;
	...
	public:
		...
		static ::System::Void SendEvent(::Foundation::ViewObject::ViewObjectHandle handle, ::Enum_3_BB0E1DD4C880324C eventName, ::Foundation::ViewObject::SuiteInfo suiteInfo)
		{
			return ((::System::Void(*)(::Foundation::ViewObject::ViewObjectHandle, ::Enum_3_BB0E1DD4C880324C, ::Foundation::ViewObject::SuiteInfo))((::PBYTE)hIl2Cpp + FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_SENDEVENT_OFFSET))(handle, eventName, suiteInfo);
		}

		static ::System::Void SendEvent_1(::Foundation::ViewObject::ViewObjectHandle handle, ::System::Int32 graphID, ::Enum_3_BB0E1DD4C880324C eventName, ::Foundation::ViewObject::SuiteInfo suiteInfo)
		{
			return ((::System::Void(*)(::Foundation::ViewObject::ViewObjectHandle, ::System::Int32, ::Enum_3_BB0E1DD4C880324C, ::Foundation::ViewObject::SuiteInfo))((::PBYTE)hIl2Cpp + FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_SENDEVENT_1_OFFSET))(handle, graphID, eventName, suiteInfo);
		}
		...
		static ::System::Void SendEventInstant(::Foundation::ViewObject::ViewObjectHandle handle, ::Enum_3_BB0E1DD4C880324C eventName, ::Foundation::ViewObject::SuiteInfo suiteInfo)
		{
			return ((::System::Void(*)(::Foundation::ViewObject::ViewObjectHandle, ::Enum_3_BB0E1DD4C880324C, ::Foundation::ViewObject::SuiteInfo))((::PBYTE)hIl2Cpp + FOUNDATION_VIEWOBJECT_VIEWOBJECTEXTENSION_SENDEVENTINSTANT_OFFSET))(handle, eventName, suiteInfo);
		}
