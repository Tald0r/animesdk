...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_CAREGROUPORDERVO_OFFSET UNITYSDK_OFFSET(0x3B0B30)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_FINISH_OFFSET UNITYSDK_OFFSET(0x3B0B20)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_GET_ISALLREADY_OFFSET UNITYSDK_OFFSET(0x3B0AF0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_MARKVOREADY_OFFSET UNITYSDK_OFFSET(0x3B0C70)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_SET_ISALLREADY_OFFSET UNITYSDK_OFFSET(0x3B0B00)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_SHOOTCACHEVO_OFFSET UNITYSDK_OFFSET(0x3B0BE0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_SKIPVO_OFFSET UNITYSDK_OFFSET(0x3B0C90)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_UPDATECHECKALLREADY_OFFSET UNITYSDK_OFFSET(0x3B0BF0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY__CHECKALLREADY_OFFSET UNITYSDK_OFFSET(0x3B0C60)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x3B0B10)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectManager_GroupOrderReady_TypeDefinitionIndex = 49684;
