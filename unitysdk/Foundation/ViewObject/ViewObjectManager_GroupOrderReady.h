...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_CAREGROUPORDERVO_OFFSET UNITYSDK_OFFSET(0x32ABE0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_FINISH_OFFSET UNITYSDK_OFFSET(0x32ABD0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_GET_ISALLREADY_OFFSET UNITYSDK_OFFSET(0x2F4210)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_MARKVOREADY_OFFSET UNITYSDK_OFFSET(0x32AD20)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_SET_ISALLREADY_OFFSET UNITYSDK_OFFSET(0x32ABB0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_SHOOTCACHEVO_OFFSET UNITYSDK_OFFSET(0x32AC90)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_SKIPVO_OFFSET UNITYSDK_OFFSET(0x32AD40)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY_UPDATECHECKALLREADY_OFFSET UNITYSDK_OFFSET(0x32ACA0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY__CHECKALLREADY_OFFSET UNITYSDK_OFFSET(0x32AD10)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERREADY__CTOR_OFFSET UNITYSDK_OFFSET(0x32ABC0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectManager_GroupOrderReady_TypeDefinitionIndex = 74582;
