...
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSTATECHANGELISTENENTRY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x378A30)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSTATECHANGELISTENENTRY_EQUALS_OFFSET UNITYSDK_OFFSET(0x378940)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSTATECHANGELISTENENTRY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x378A40)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSTATECHANGELISTENENTRY_GETSTATEID_OFFSET UNITYSDK_OFFSET(0x378AC0)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSTATECHANGELISTENENTRY_NOTIFY_OFFSET UNITYSDK_OFFSET(0x378910)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSTATECHANGELISTENENTRY___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x378B60)
#define FOUNDATION_VIEWOBJECT_SUBSYSTEM_GROUPSTATECHANGELISTENENTRY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x378BD0)

namespace Foundation::ViewObject::Subsystem
{
	inline static constexpr unsigned int GroupStateChangeListenEntry_TypeDefinitionIndex = 51603;
