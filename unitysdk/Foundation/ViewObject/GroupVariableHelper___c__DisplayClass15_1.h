...
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER___C__DISPLAYCLASS15_1__CTOR_OFFSET UNITYSDK_OFFSET(0x9659E90)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int GroupVariableHelper___c__DisplayClass15_1_TypeDefinitionIndex = 68076;

	class GroupVariableHelper___c__DisplayClass15_1 : public ::System::Object
	{
	public:
		::Cysharp::Threading::Tasks::AutoResetUniTaskCompletionSource* tcs; // 0x10
		::Foundation::ViewObject::GroupVariableHelper___c__DisplayClass15_0* CS___8__locals1; // 0x18
