...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_BUILDGROUPBYSERVERDATA_OFFSET UNITYSDK_OFFSET(0xB9AD700)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_BUILDGROUPMEMBERBYSERVERINFO_OFFSET UNITYSDK_OFFSET(0xB9ADD10)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_BUILDVIEWOBJECTBYCONFIG_OFFSET UNITYSDK_OFFSET(0xB9AE380)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_COMBINECONFIGID_OFFSET UNITYSDK_OFFSET(0xB9AE740)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_GENERATEMEMBERSERVERCOMPONENT_OFFSET UNITYSDK_OFFSET(0xB9ACE80)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_GENERATEVOCOMMONCOMPONENT_OFFSET UNITYSDK_OFFSET(0xB9ACDD0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_GETALIVEGROUPMEMBERS_OFFSET UNITYSDK_OFFSET(0xB9AFC40)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_GETENTITYHANDLE_OFFSET UNITYSDK_OFFSET(0xB9AED60)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_GETGROUPID_OFFSET UNITYSDK_OFFSET(0xB9AE7B0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_GETMEMBERANDENTITYBYCONFIGID_OFFSET UNITYSDK_OFFSET(0xB9AFF90)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_GETMEMBERID_OFFSET UNITYSDK_OFFSET(0xB9AE820)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_GETMEMBERTYPE_1_OFFSET UNITYSDK_OFFSET(0xB9AE990)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_GETMEMBERTYPE_OFFSET UNITYSDK_OFFSET(0xB9AE880)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_HANDLEENTITYDISSOCIATEBYDITHERFADEOUT_OFFSET UNITYSDK_OFFSET(0xB9AF1D0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_ISMEMBERCONFIGBACKSTAGE_1_OFFSET UNITYSDK_OFFSET(0xB9AEC10)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_ISMEMBERCONFIGBACKSTAGE_OFFSET UNITYSDK_OFFSET(0xB9AEA70)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_ISVIEWOBJECTENTITYBACKSTAGE_OFFSET UNITYSDK_OFFSET(0xB9AFB20)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_SETUPENTITYPOSITIONBYVIEWOBJECT_OFFSET UNITYSDK_OFFSET(0xB9AEE50)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_TRYGETGROUPIDBYENTITY_OFFSET UNITYSDK_OFFSET(0xB9B0150)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_TRYGETGROUPLIMITEDLEVELABILITYLIST_OFFSET UNITYSDK_OFFSET(0xB9B02E0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_TRYGETMEMBERCONFIG_1_OFFSET UNITYSDK_OFFSET(0xB9AE280)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTUTILS_TRYGETMEMBERCONFIG_OFFSET UNITYSDK_OFFSET(0xB9AEA00)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectUtils_TypeDefinitionIndex = 72986;
