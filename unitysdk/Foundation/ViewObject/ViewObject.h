...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_ADDREADYREQUIRE_OFFSET UNITYSDK_OFFSET(0x6DB02A0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_CHECKCUSTOMREADYFLAGSEVENT_OFFSET UNITYSDK_OFFSET(0x6DB0070)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_CHECKREADY_OFFSET UNITYSDK_OFFSET(0x6DAF500)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_CLEARALLCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x6DAED60)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_AWOKEN_OFFSET UNITYSDK_OFFSET(0x6DAEC00)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_BPOSTEDREADY_OFFSET UNITYSDK_OFFSET(0x6DAFFA0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_COMPONENTSVIEW_OFFSET UNITYSDK_OFFSET(0x6DB09A0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_CONFIGVIEWOBJECT_OFFSET UNITYSDK_OFFSET(0x6DAEBA0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_ENABLE_OFFSET UNITYSDK_OFFSET(0x6DAEA20)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_MARKEDFORDESTROY_OFFSET UNITYSDK_OFFSET(0x6DAEBC0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_METAFLAGS_OFFSET UNITYSDK_OFFSET(0x6DAEC40)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_NAME_OFFSET UNITYSDK_OFFSET(0x6DAE9E0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_NETID_OFFSET UNITYSDK_OFFSET(0x6DAEA00)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_READYFLAGS_OFFSET UNITYSDK_OFFSET(0x6DAFFE0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_RECYCLING_OFFSET UNITYSDK_OFFSET(0x6DAEBE0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_REQUIREREADYFLAGS_OFFSET UNITYSDK_OFFSET(0x6DAFFC0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_SELFHANDLE_OFFSET UNITYSDK_OFFSET(0x6DAE9C0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_GET_SPAWNCOMPLETE_OFFSET UNITYSDK_OFFSET(0x6DAEC20)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_HASREADYFLAG_OFFSET UNITYSDK_OFFSET(0x6DB0000)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_INTERNALATTACHCOMPONENT_OFFSET UNITYSDK_OFFSET(0x6DAF820)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_INTERNALUNATTACHCOMPONENT_OFFSET UNITYSDK_OFFSET(0x6DAF640)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_MARKDESTROY_OFFSET UNITYSDK_OFFSET(0x6DAF050)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_MARKSPAWNCOMPLETE_OFFSET UNITYSDK_OFFSET(0x6DAF0C0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_NOTIFYCOMPONENTAWAKE_OFFSET UNITYSDK_OFFSET(0x6DAF1A0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_NOTIFYCOMPONENTFEATUREEVENT_OFFSET UNITYSDK_OFFSET(0x6DB0630)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_NOTIFYCOMPONENTUPDATEENABLE_OFFSET UNITYSDK_OFFSET(0x6DAEB20)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_NOTIFYREADY_OFFSET UNITYSDK_OFFSET(0x6DB0150)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_ONECSEVENT_OFFSET UNITYSDK_OFFSET(0x6DAF9C0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_RECYCLE_OFFSET UNITYSDK_OFFSET(0x6DAEC60)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_REGISTERCUSTOMREADYFLAGSEVENT_OFFSET UNITYSDK_OFFSET(0x6DB0390)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_REMOVEREADYFLAG_OFFSET UNITYSDK_OFFSET(0x6DB0230)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_REMOVEREADYREQUIRE_OFFSET UNITYSDK_OFFSET(0x6DB0310)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SETCONFIGVIEWOBJECT_OFFSET UNITYSDK_OFFSET(0x6DAF950)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SETREADYFLAG_OFFSET UNITYSDK_OFFSET(0x6DB01C0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_AWOKEN_OFFSET UNITYSDK_OFFSET(0x6DAEC10)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_BPOSTEDREADY_OFFSET UNITYSDK_OFFSET(0x6DAFFB0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_CONFIGVIEWOBJECT_OFFSET UNITYSDK_OFFSET(0x6DAEBB0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_ENABLE_OFFSET UNITYSDK_OFFSET(0x6DAEA30)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_MARKEDFORDESTROY_OFFSET UNITYSDK_OFFSET(0x6DAEBD0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_METAFLAGS_OFFSET UNITYSDK_OFFSET(0x6DAEC50)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_NAME_OFFSET UNITYSDK_OFFSET(0x6DAE9F0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_NETID_OFFSET UNITYSDK_OFFSET(0x6DAEA10)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_READYFLAGS_OFFSET UNITYSDK_OFFSET(0x6DAFFF0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_RECYCLING_OFFSET UNITYSDK_OFFSET(0x6DAEBF0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_REQUIREREADYFLAGS_OFFSET UNITYSDK_OFFSET(0x6DAFFD0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_SELFHANDLE_OFFSET UNITYSDK_OFFSET(0x6DAE9D0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_SET_SPAWNCOMPLETE_OFFSET UNITYSDK_OFFSET(0x6DAEC30)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT_UPDATE_OFFSET UNITYSDK_OFFSET(0x6DAF5D0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECT__CTOR_OFFSET UNITYSDK_OFFSET(0x6DB09C0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObject_TypeDefinitionIndex = 71343;

	class ViewObject : public ::System::Object
	{
	public:
		// static const ::System::UInt32 MaxFlags = 0xFFFFFFFF; // 0x0
		::Class_1_5FA9CCDDD9957726* _ConfigViewObject_k__BackingField; // 0x10
		::System::Collections::Generic::List_1<::Foundation::ViewObject::ViewObjectReadyFlagsRequest>* _readyFlagsRequests; // 0x18
		::Foundation::ViewObject::Container::ComponentContainer* ComponentContainer; // 0x20
		::Foundation::ViewObject::ViewObjectHandle _SelfHandle_k__BackingField; // 0x28
		::System::String* _Name_k__BackingField; // 0x38
		::System::UInt32 _ReadyFlags_k__BackingField; // 0x40
		::System::UInt32 _NetID_k__BackingField; // 0x44
		::System::Boolean _enable; // 0x48
		::System::Boolean _Recycling_k__BackingField; // 0x49
		::System::UInt32 _RequireReadyFlags_k__BackingField; // 0x4C
		::System::Boolean _bPostedReady_k__BackingField; // 0x50
		::System::Boolean _MarkedForDestroy_k__BackingField; // 0x51
		::System::Boolean _SpawnComplete_k__BackingField; // 0x52
		::System::Boolean _Awoken_k__BackingField; // 0x53
