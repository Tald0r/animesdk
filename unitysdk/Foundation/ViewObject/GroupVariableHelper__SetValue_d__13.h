...
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER__SETVALUE_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x35F870)
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER__SETVALUE_D__13_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int GroupVariableHelper__SetValue_d__13_TypeDefinitionIndex = 68066;

	struct alignas(8) GroupVariableHelper__SetValue_d__13
	{
		::Cysharp::Threading::Tasks::UniTask_Awaiter __u__1; // 0x10
		::Foundation::ViewObject::GroupVariableHelper* __4__this; // 0x20
		::Class_3_3EC97B498E0B85D2_1* reason; // 0x28
