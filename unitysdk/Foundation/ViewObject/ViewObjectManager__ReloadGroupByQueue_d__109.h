...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER__RELOADGROUPBYQUEUE_D__109_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3597F0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER__RELOADGROUPBYQUEUE_D__109_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectManager__ReloadGroupByQueue_d__109_TypeDefinitionIndex = 49687;
