...
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER__PUSH_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x32AB80)
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER__PUSH_D__15_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int GroupVariableHelper__Push_d__15_TypeDefinitionIndex = 41678;

	struct alignas(8) GroupVariableHelper__Push_d__15
	{
		::Cysharp::Threading::Tasks::UniTaskCompletionSource_1<::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_0_16E4307DCC419505_3*>*>* resultTcs; // 0x10
