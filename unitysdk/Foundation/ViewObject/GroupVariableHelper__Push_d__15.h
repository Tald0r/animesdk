...
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER__PUSH_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3B0AC0)
#define FOUNDATION_VIEWOBJECT_GROUPVARIABLEHELPER__PUSH_D__15_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int GroupVariableHelper__Push_d__15_TypeDefinitionIndex = 68077;

	struct alignas(8) GroupVariableHelper__Push_d__15
	{
		::Foundation::ViewObject::GroupVariableHelper* __4__this; // 0x10
		::Cysharp::Threading::Tasks::UniTaskCompletionSource_1<::System::Collections::Generic::Dictionary_2<::System::UInt32, ::Class_0_16E4307DCC419505_4*>*>* resultTcs; // 0x18
		::Class_3_3EC97B498E0B85D2_1* reason; // 0x20
