...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_VIEWOBJECTMODIFYDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xB9ACD50)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_VIEWOBJECTMODIFYDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xB9ACDC0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_VIEWOBJECTMODIFYDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xB9AC990)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_VIEWOBJECTMODIFYDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xB9AC980)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectManager_ViewObjectModifyDelegate_TypeDefinitionIndex = 49675;
