...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTLOADINGTASK_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTLOADINGTASK_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x2D26A0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTLOADINGTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x2D26B0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectLoadingTask_TypeDefinitionIndex = 66749;
