...
#define FOUNDATION_VIEWOBJECT_SCENEENTITYDATA_GET_CONFIGID_OFFSET UNITYSDK_OFFSET(0x368240)
#define FOUNDATION_VIEWOBJECT_SCENEENTITYDATA_GET_GROUPID_OFFSET UNITYSDK_OFFSET(0x3681C0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int SceneEntityData_TypeDefinitionIndex = 42537;
