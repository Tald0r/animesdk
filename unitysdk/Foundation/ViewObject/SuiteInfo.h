...
#define FOUNDATION_VIEWOBJECT_SUITEINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x38E0B0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x38E030)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x38E0C0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0xAA7DDF0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GET_ISV1_OFFSET UNITYSDK_OFFSET(0x3219F0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GET_ISV2_OFFSET UNITYSDK_OFFSET(0x3866C0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x38DFC0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xAA7E080)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xAA7E150)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x38E130)
#define FOUNDATION_VIEWOBJECT_SUITEINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x38E140)
#define FOUNDATION_VIEWOBJECT_SUITEINFO___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x38E1A0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x38E200)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int SuiteInfo_TypeDefinitionIndex = 41454;
