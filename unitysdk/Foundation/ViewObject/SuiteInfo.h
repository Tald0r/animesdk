...
#define FOUNDATION_VIEWOBJECT_SUITEINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3683B0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x368330)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3683C0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x90455B0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GET_ISV1_OFFSET UNITYSDK_OFFSET(0x318C20)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GET_ISV2_OFFSET UNITYSDK_OFFSET(0x318A40)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x3682C0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x9045840)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x9045910)
#define FOUNDATION_VIEWOBJECT_SUITEINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x368430)
#define FOUNDATION_VIEWOBJECT_SUITEINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x368440)
#define FOUNDATION_VIEWOBJECT_SUITEINFO___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3684A0)
#define FOUNDATION_VIEWOBJECT_SUITEINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x368500)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int SuiteInfo_TypeDefinitionIndex = 43007;
