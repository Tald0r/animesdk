...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_RELOADPARAMBASE_CHECKFLAG_OFFSET UNITYSDK_OFFSET(0x14EFD550)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_RELOADPARAMBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x14EFD680)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectManager_ReloadParamBase_TypeDefinitionIndex = 74572;
