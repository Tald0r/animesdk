...
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_CREATE_OFFSET UNITYSDK_OFFSET(0xB9AACC0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x3B0A40)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_GENERATECOMPONENTBYTRAIT_OFFSET UNITYSDK_OFFSET(0x3B09B0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_GENERATECOMPONENTBYVIEWOBJECTCONFIG_OFFSET UNITYSDK_OFFSET(0x3B09C0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_GENERATEENTITYHANDLE_OFFSET UNITYSDK_OFFSET(0x3B0990)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_GET_OUTER_OFFSET UNITYSDK_OFFSET(0x2D07B0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_SETTYPE_OFFSET UNITYSDK_OFFSET(0x3B09D0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_SET_OUTER_OFFSET UNITYSDK_OFFSET(0x2D07C0)
#define FOUNDATION_VIEWOBJECT_ENTITYBUILDCONTEXT_VALIDATE_OFFSET UNITYSDK_OFFSET(0x3B0A50)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int EntityBuildContext_TypeDefinitionIndex = 42995;
