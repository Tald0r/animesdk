...
#define FOUNDATION_VIEWOBJECT_BACKSTAGEENTITYLOADINGTASK_GET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define FOUNDATION_VIEWOBJECT_BACKSTAGEENTITYLOADINGTASK_SET_DESCRIPTION_OFFSET UNITYSDK_OFFSET(0x3123A0)
#define FOUNDATION_VIEWOBJECT_BACKSTAGEENTITYLOADINGTASK__CTOR_OFFSET UNITYSDK_OFFSET(0x2F1910)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int BackStageEntityLoadingTask_TypeDefinitionIndex = 65297;
