...
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_CAREGROUPORDERVO_OFFSET UNITYSDK_OFFSET(0x349D20)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_GETCURRENTGROUPORDERREADYMAP_OFFSET UNITYSDK_OFFSET(0x349C00)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_GETFUNCTIONOPENFLAG_OFFSET UNITYSDK_OFFSET(0x349D60)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_GET_CURFLAG_OFFSET UNITYSDK_OFFSET(0x338550)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_GROUPORDERWAIT_SETREADYVIEWOBJECT_OFFSET UNITYSDK_OFFSET(0x349D40)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_MARKREADYGROUPID_OFFSET UNITYSDK_OFFSET(0x349C70)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR_POSITIVECHECKGROUPREADY_OFFSET UNITYSDK_OFFSET(0x349D70)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR__CTOR_OFFSET UNITYSDK_OFFSET(0x349BF0)
#define FOUNDATION_VIEWOBJECT_VIEWOBJECTMANAGER_GROUPORDERMGR__SHOOTONEGROUP_OFFSET UNITYSDK_OFFSET(0x349CF0)

namespace Foundation::ViewObject
{
	inline static constexpr unsigned int ViewObjectManager_GroupOrderMgr_TypeDefinitionIndex = 74560;
