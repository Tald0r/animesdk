...
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMEMBERALIVESTATECHECKACTION_CHECKEXECUTE_OFFSET UNITYSDK_OFFSET(0x323D50)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMEMBERALIVESTATECHECKACTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x323D60)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMEMBERALIVESTATECHECKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x323D20)

namespace Foundation::ViewObject::Structures
{
	inline static constexpr unsigned int FMemberAliveStateCheckAction_TypeDefinitionIndex = 47090;
