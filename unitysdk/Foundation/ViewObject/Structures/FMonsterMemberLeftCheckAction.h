...
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION_BINDEVENT_OFFSET UNITYSDK_OFFSET(0x3453B0)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION_CHECKEXECUTE_OFFSET UNITYSDK_OFFSET(0x3453A0)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x345420)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION_GET_INSID_OFFSET UNITYSDK_OFFSET(0x345270)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION_ISMATCHNOTCOUNTTAG_OFFSET UNITYSDK_OFFSET(0x345370)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION_LISTENENTITYTAGCHANGE_OFFSET UNITYSDK_OFFSET(0x3453E0)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION_ONEVENTFROMANYONE_OFFSET UNITYSDK_OFFSET(0x3453D0)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION_ONMONSTERSTATECHANGE_OFFSET UNITYSDK_OFFSET(0x345410)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION_SET_INSID_OFFSET UNITYSDK_OFFSET(0x345280)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION_SHOULDCOUNT_OFFSET UNITYSDK_OFFSET(0x345390)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION_UNBINDEVENT_OFFSET UNITYSDK_OFFSET(0x3453C0)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x81B5930)
#define FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x345290)

namespace Foundation::ViewObject::Structures
{
	inline static constexpr unsigned int FMonsterMemberLeftCheckAction_TypeDefinitionIndex = 70935;

	struct alignas(8) FMonsterMemberLeftCheckAction
	{
		static ::System::Int32* StaticGet_IDG()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(FMonsterMemberLeftCheckAction_TypeDefinitionIndex)->GetStaticField(0x10060);
		}
		::Struct_2_FE9BD044832BC9C3 Action; // 0x10
		::System::Int32 LeftCount; // 0x40
		::Enum_3_9F43ACD08F0FC8E8 CompareType; // 0x44
		...
		::System::Void _ctor(::Struct_2_FE9BD044832BC9C3 action, ::System::Int32 leftCount, ::Enum_3_9F43ACD08F0FC8E8 compareType, ::Foundation::ViewObject::ViewObjectHandle groupHandle, ::MoleMole::FlowCanvas::Nodes::EntityDieCheckType dieCheckType, ::System::Collections::Generic::List_1<::System::Int32>* targetList)
		{
			return ((::System::Void(*)(::PVOID, ::Struct_2_FE9BD044832BC9C3, ::System::Int32, ::Enum_3_9F43ACD08F0FC8E8, ::Foundation::ViewObject::ViewObjectHandle, ::MoleMole::FlowCanvas::Nodes::EntityDieCheckType, ::System::Collections::Generic::List_1<::System::Int32>*))((::PBYTE)hIl2Cpp + FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION__CTOR_OFFSET))(this, action, leftCount, compareType, groupHandle, dieCheckType, targetList);
		}
		...
		*/
		...
		{
			return ((::System::Void(*)(::PVOID, ::MoleMole::EntityHandle, ::Class_2_5DFC66413CB20B09_Enum_3_A5191D6218CE9E26_1, ::MoleMole::GameplayTag))((::PBYTE)hIl2Cpp + FOUNDATION_VIEWOBJECT_STRUCTURES_FMONSTERMEMBERLEFTCHECKACTION_LISTENENTITYTAGCHANGE_OFFSET))(this, entityHandle, changeType, tag);
		}
		*/
