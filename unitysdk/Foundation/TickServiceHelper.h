...
#define FOUNDATION_TICKSERVICEHELPER_GETTIMEHASH_OFFSET UNITYSDK_OFFSET(0x1AB30BB0)
#define FOUNDATION_TICKSERVICEHELPER_PASS_OFFSET UNITYSDK_OFFSET(0x1AB30BC0)

namespace Foundation
{
	inline static constexpr unsigned int TickServiceHelper_TypeDefinitionIndex = 9041;
