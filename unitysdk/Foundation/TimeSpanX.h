...
#define FOUNDATION_TIMESPANX_GETFORTNIGHTS_OFFSET UNITYSDK_OFFSET(0x1AEBFC80)
#define FOUNDATION_TIMESPANX_GETWEEKS_OFFSET UNITYSDK_OFFSET(0x1AEBFBE0)
#define FOUNDATION_TIMESPANX_MINUTESTOTIMESPAN_OFFSET UNITYSDK_OFFSET(0x1AEBFDE0)
#define FOUNDATION_TIMESPANX_SECONDSTOTIMESPAN_OFFSET UNITYSDK_OFFSET(0x1AEBFD70)

namespace Foundation
{
	inline static constexpr unsigned int TimeSpanX_TypeDefinitionIndex = 8113;
