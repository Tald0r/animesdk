...
#define FOUNDATION_TIMESPANX_GETFORTNIGHTS_OFFSET UNITYSDK_OFFSET(0x1A9979E0)
#define FOUNDATION_TIMESPANX_GETWEEKS_OFFSET UNITYSDK_OFFSET(0x1A997940)
#define FOUNDATION_TIMESPANX_MINUTESTOTIMESPAN_OFFSET UNITYSDK_OFFSET(0x1A997B40)
#define FOUNDATION_TIMESPANX_SECONDSTOTIMESPAN_OFFSET UNITYSDK_OFFSET(0x1A997AD0)

namespace Foundation
{
	inline static constexpr unsigned int TimeSpanX_TypeDefinitionIndex = 7755;
