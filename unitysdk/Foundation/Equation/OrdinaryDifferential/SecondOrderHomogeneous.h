...
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_GET_A_OFFSET UNITYSDK_OFFSET(0x3456B0)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_GET_B_OFFSET UNITYSDK_OFFSET(0x36DB20)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVECHARACTEREQUATION_OFFSET UNITYSDK_OFFSET(0x1B4C3590)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVECONSTANTSSINGLEREALROOT_OFFSET UNITYSDK_OFFSET(0x1B4C3680)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVECONSTANTSTWOREALROOTS_OFFSET UNITYSDK_OFFSET(0x1B4C3630)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVECONSTANTSTWOVIRTUALROOTS_OFFSET UNITYSDK_OFFSET(0x1B4C36A0)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVESINGLEREALROOT_OFFSET UNITYSDK_OFFSET(0x1B4C3920)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVETWOREALROOTS_OFFSET UNITYSDK_OFFSET(0x1B4C3840)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVETWOVIRTUALROOTS_OFFSET UNITYSDK_OFFSET(0x1B4C39B0)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVE_OFFSET UNITYSDK_OFFSET(0x99C520)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS__CTOR_OFFSET UNITYSDK_OFFSET(0x99C3A0)

namespace Foundation::Equation::OrdinaryDifferential
{
	inline static constexpr unsigned int SecondOrderHomogeneous_TypeDefinitionIndex = 8986;
