...
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_GET_A_OFFSET UNITYSDK_OFFSET(0x35DA00)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_GET_B_OFFSET UNITYSDK_OFFSET(0x308880)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVECHARACTEREQUATION_OFFSET UNITYSDK_OFFSET(0x1AF47690)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVECONSTANTSSINGLEREALROOT_OFFSET UNITYSDK_OFFSET(0x1AF47780)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVECONSTANTSTWOREALROOTS_OFFSET UNITYSDK_OFFSET(0x1AF47730)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVECONSTANTSTWOVIRTUALROOTS_OFFSET UNITYSDK_OFFSET(0x1AF477A0)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVESINGLEREALROOT_OFFSET UNITYSDK_OFFSET(0x1AF47A20)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVETWOREALROOTS_OFFSET UNITYSDK_OFFSET(0x1AF47940)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVETWOVIRTUALROOTS_OFFSET UNITYSDK_OFFSET(0x1AF47AB0)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS_RESOLVE_OFFSET UNITYSDK_OFFSET(0x96DB70)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUS__CTOR_OFFSET UNITYSDK_OFFSET(0x96D9F0)

namespace Foundation::Equation::OrdinaryDifferential
{
	inline static constexpr unsigned int SecondOrderHomogeneous_TypeDefinitionIndex = 9009;
