...
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANTCRITICAL_GETPARTICULARSOLUTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1A8350A0)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANTCRITICAL_RESOLVE_OFFSET UNITYSDK_OFFSET(0x93A370)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANTCRITICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x93A290)

namespace Foundation::Equation::OrdinaryDifferential
{
	inline static constexpr unsigned int SecondOrderConstantCritical_TypeDefinitionIndex = 9017;
