...
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANTCRITICAL_GETPARTICULARSOLUTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1A204840)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANTCRITICAL_RESOLVE_OFFSET UNITYSDK_OFFSET(0x90D700)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANTCRITICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x90D620)

namespace Foundation::Equation::OrdinaryDifferential
{
	inline static constexpr unsigned int SecondOrderConstantCritical_TypeDefinitionIndex = 8996;
