...
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUSCRITICAL_GET_A_OFFSET UNITYSDK_OFFSET(0x993990)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUSCRITICAL_RESOLVE_OFFSET UNITYSDK_OFFSET(0x9939C0)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUSCRITICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x9939A0)

namespace Foundation::Equation::OrdinaryDifferential
{
	inline static constexpr unsigned int SecondOrderHomogeneousCritical_TypeDefinitionIndex = 9063;
