...
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUSCRITICAL_GET_A_OFFSET UNITYSDK_OFFSET(0x963A30)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUSCRITICAL_RESOLVE_OFFSET UNITYSDK_OFFSET(0x963A60)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERHOMOGENEOUSCRITICAL__CTOR_OFFSET UNITYSDK_OFFSET(0x963A40)

namespace Foundation::Equation::OrdinaryDifferential
{
	inline static constexpr unsigned int SecondOrderHomogeneousCritical_TypeDefinitionIndex = 9098;
