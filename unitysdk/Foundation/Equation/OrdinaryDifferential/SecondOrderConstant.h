...
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANT_GETPARTICULARSOLUTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1B396C70)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANT_RESOLVE_OFFSET UNITYSDK_OFFSET(0x993680)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANT__CTOR_OFFSET UNITYSDK_OFFSET(0x993670)

namespace Foundation::Equation::OrdinaryDifferential
{
	inline static constexpr unsigned int SecondOrderConstant_TypeDefinitionIndex = 9091;
