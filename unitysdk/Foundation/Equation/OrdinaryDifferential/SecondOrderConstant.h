...
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANT_GETPARTICULARSOLUTIONTYPE_OFFSET UNITYSDK_OFFSET(0x1AD8E790)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANT_RESOLVE_OFFSET UNITYSDK_OFFSET(0x963720)
#define FOUNDATION_EQUATION_ORDINARYDIFFERENTIAL_SECONDORDERCONSTANT__CTOR_OFFSET UNITYSDK_OFFSET(0x963710)

namespace Foundation::Equation::OrdinaryDifferential
{
	inline static constexpr unsigned int SecondOrderConstant_TypeDefinitionIndex = 8920;
