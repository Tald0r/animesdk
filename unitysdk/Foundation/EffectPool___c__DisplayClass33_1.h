...
#define FOUNDATION_EFFECTPOOL___C__DISPLAYCLASS33_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD5A5B0)
#define FOUNDATION_EFFECTPOOL___C__DISPLAYCLASS33_1__WARMUPINSTANCE_B__1_OFFSET UNITYSDK_OFFSET(0x1AD5A5C0)

namespace Foundation
{
	inline static constexpr unsigned int EffectPool___c__DisplayClass33_1_TypeDefinitionIndex = 8074;
