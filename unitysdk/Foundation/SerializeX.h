...
#define FOUNDATION_SERIALIZEX_SERIALIZETOBASE64_OFFSET UNITYSDK_OFFSET(0x1A4823A0)
#define FOUNDATION_SERIALIZEX_SERIALIZETOBYTES_OFFSET UNITYSDK_OFFSET(0x1A4820F0)
#define FOUNDATION_SERIALIZEX_SERIALIZETOUTF8STRING_OFFSET UNITYSDK_OFFSET(0x1A4822A0)
#define FOUNDATION_SERIALIZEX_TOBINARY_OFFSET UNITYSDK_OFFSET(0x1A481D70)
#define FOUNDATION_SERIALIZEX_TOJSON_OFFSET UNITYSDK_OFFSET(0x1A481D00)

namespace Foundation
{
	inline static constexpr unsigned int SerializeX_TypeDefinitionIndex = 7742;
