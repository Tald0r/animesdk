...
#define FOUNDATION_EXCLUSIVERESOURCEMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B3AC800)
#define FOUNDATION_EXCLUSIVERESOURCEMANAGER_INITIALIZETICKER_OFFSET UNITYSDK_OFFSET(0x1B3AC850)
#define FOUNDATION_EXCLUSIVERESOURCEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B3AC8C0)

namespace Foundation
{
	inline static constexpr unsigned int ExclusiveResourceManager_TypeDefinitionIndex = 8793;
