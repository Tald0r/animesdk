...
#define FOUNDATION_EXCLUSIVERESOURCEMANAGER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ADDBD40)
#define FOUNDATION_EXCLUSIVERESOURCEMANAGER_INITIALIZETICKER_OFFSET UNITYSDK_OFFSET(0x1ADDBD90)
#define FOUNDATION_EXCLUSIVERESOURCEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADDBE00)

namespace Foundation
{
	inline static constexpr unsigned int ExclusiveResourceManager_TypeDefinitionIndex = 8869;
