...
#define FOUNDATION_ASSETREQUEST_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1AEE0D00)
#define FOUNDATION_ASSETREQUEST_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1AEE10D0)
#define FOUNDATION_ASSETREQUEST_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AEE0D70)
#define FOUNDATION_ASSETREQUEST_INIT_OFFSET UNITYSDK_OFFSET(0x1AEE0420)
#define FOUNDATION_ASSETREQUEST_LOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1AEE0A30)
#define FOUNDATION_ASSETREQUEST_LOAD_OFFSET UNITYSDK_OFFSET(0x1AEE04A0)
#define FOUNDATION_ASSETREQUEST_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1AEE0C50)
#define FOUNDATION_ASSETREQUEST_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1AEE0A90)
#define FOUNDATION_ASSETREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEE11D0)
#define FOUNDATION_ASSETREQUEST___BASE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1AEE11E0)
#define FOUNDATION_ASSETREQUEST___BASE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1AEE12A0)
#define FOUNDATION_ASSETREQUEST___BASE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AEE11F0)
#define FOUNDATION_ASSETREQUEST___BASE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1AEE12E0)

namespace Foundation
{
	inline static constexpr unsigned int AssetRequest_TypeDefinitionIndex = 7851;
