...
#define FOUNDATION_ASSETREQUEST_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1ABB4090)
#define FOUNDATION_ASSETREQUEST_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1ABB4460)
#define FOUNDATION_ASSETREQUEST_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1ABB4100)
#define FOUNDATION_ASSETREQUEST_INIT_OFFSET UNITYSDK_OFFSET(0x1ABB37B0)
#define FOUNDATION_ASSETREQUEST_LOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1ABB3DC0)
#define FOUNDATION_ASSETREQUEST_LOAD_OFFSET UNITYSDK_OFFSET(0x1ABB3830)
#define FOUNDATION_ASSETREQUEST_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1ABB3FE0)
#define FOUNDATION_ASSETREQUEST_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1ABB3E20)
#define FOUNDATION_ASSETREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABB4560)
#define FOUNDATION_ASSETREQUEST___BASE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1ABB4570)
#define FOUNDATION_ASSETREQUEST___BASE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1ABB4630)
#define FOUNDATION_ASSETREQUEST___BASE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1ABB4580)
#define FOUNDATION_ASSETREQUEST___BASE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1ABB4670)

namespace Foundation
{
	inline static constexpr unsigned int AssetRequest_TypeDefinitionIndex = 7698;
