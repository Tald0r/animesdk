...
#define FOUNDATION_SPAWNERPOOL_CLEARPOOL_OFFSET UNITYSDK_OFFSET(0x1B4385D0)
#define FOUNDATION_SPAWNERPOOL_DESPAWNALL_OFFSET UNITYSDK_OFFSET(0x1B438510)
#define FOUNDATION_SPAWNERPOOL_DESPAWNLIST_OFFSET UNITYSDK_OFFSET(0x1B438370)
#define FOUNDATION_SPAWNERPOOL_DESPAWN_OFFSET UNITYSDK_OFFSET(0x1B438240)
#define FOUNDATION_SPAWNERPOOL_GETACTIVESPAWNS_OFFSET UNITYSDK_OFFSET(0x1B438680)
#define FOUNDATION_SPAWNERPOOL_PRESPAWN_OFFSET UNITYSDK_OFFSET(0x1B438060)
#define FOUNDATION_SPAWNERPOOL_SPAWN_1_OFFSET UNITYSDK_OFFSET(0x1B437D40)
#define FOUNDATION_SPAWNERPOOL_SPAWN_OFFSET UNITYSDK_OFFSET(0x1B437C90)
#define FOUNDATION_SPAWNERPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1B437BC0)

namespace Foundation
{
	inline static constexpr unsigned int SpawnerPool_TypeDefinitionIndex = 7748;
