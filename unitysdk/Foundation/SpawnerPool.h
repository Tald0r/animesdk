...
#define FOUNDATION_SPAWNERPOOL_CLEARPOOL_OFFSET UNITYSDK_OFFSET(0x1AD35470)
#define FOUNDATION_SPAWNERPOOL_DESPAWNALL_OFFSET UNITYSDK_OFFSET(0x1AD353B0)
#define FOUNDATION_SPAWNERPOOL_DESPAWNLIST_OFFSET UNITYSDK_OFFSET(0x1AD35210)
#define FOUNDATION_SPAWNERPOOL_DESPAWN_OFFSET UNITYSDK_OFFSET(0x1AD350E0)
#define FOUNDATION_SPAWNERPOOL_GETACTIVESPAWNS_OFFSET UNITYSDK_OFFSET(0x1AD35520)
#define FOUNDATION_SPAWNERPOOL_PRESPAWN_OFFSET UNITYSDK_OFFSET(0x1AD34F00)
#define FOUNDATION_SPAWNERPOOL_SPAWN_1_OFFSET UNITYSDK_OFFSET(0x1AD34BE0)
#define FOUNDATION_SPAWNERPOOL_SPAWN_OFFSET UNITYSDK_OFFSET(0x1AD34B30)
#define FOUNDATION_SPAWNERPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD34A60)

namespace Foundation
{
	inline static constexpr unsigned int SpawnerPool_TypeDefinitionIndex = 7787;

	class SpawnerPool : public ::System::Object
	{
	public:
		::UnityEngine::GameObject* SpawnObj; // 0x10
		::System::Collections::Stack* AvailableObjects; // 0x18
		::System::Collections::Generic::List_1<::UnityEngine::GameObject*>* SpawnedObjects; // 0x20
