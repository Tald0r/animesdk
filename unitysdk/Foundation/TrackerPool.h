...
#define FOUNDATION_TRACKERPOOL_ASSETTRACKERCREATER_OFFSET UNITYSDK_OFFSET(0x1AB795D0)
#define FOUNDATION_TRACKERPOOL_GETASSETTRAKER_OFFSET UNITYSDK_OFFSET(0x1AB79120)
#define FOUNDATION_TRACKERPOOL_GETINSTANCETRACKER_OFFSET UNITYSDK_OFFSET(0x1AB792D0)
#define FOUNDATION_TRACKERPOOL_GETTEMPORARAYTRACKER_OFFSET UNITYSDK_OFFSET(0x1AB79470)
#define FOUNDATION_TRACKERPOOL_INSTANCETRACKERCREATER_OFFSET UNITYSDK_OFFSET(0x1AB79630)
#define FOUNDATION_TRACKERPOOL_RELEASEASSETTRACKER_OFFSET UNITYSDK_OFFSET(0x1AB79220)
#define FOUNDATION_TRACKERPOOL_RELEASEINSTANCETRACKER_OFFSET UNITYSDK_OFFSET(0x1AB793F0)
#define FOUNDATION_TRACKERPOOL_RELEASETEMPORARAYTRACKER_OFFSET UNITYSDK_OFFSET(0x1AB79550)
#define FOUNDATION_TRACKERPOOL_TEMPORARAYTRACKERCREATER_OFFSET UNITYSDK_OFFSET(0x1AB796E0)
#define FOUNDATION_TRACKERPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB79790)

namespace Foundation
{
	inline static constexpr unsigned int TrackerPool_TypeDefinitionIndex = 7917;
