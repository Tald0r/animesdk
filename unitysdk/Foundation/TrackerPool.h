...
#define FOUNDATION_TRACKERPOOL_ASSETTRACKERCREATER_OFFSET UNITYSDK_OFFSET(0x1A5A1330)
#define FOUNDATION_TRACKERPOOL_GETASSETTRAKER_OFFSET UNITYSDK_OFFSET(0x1A5A0E80)
#define FOUNDATION_TRACKERPOOL_GETINSTANCETRACKER_OFFSET UNITYSDK_OFFSET(0x1A5A1030)
#define FOUNDATION_TRACKERPOOL_GETTEMPORARAYTRACKER_OFFSET UNITYSDK_OFFSET(0x1A5A11D0)
#define FOUNDATION_TRACKERPOOL_INSTANCETRACKERCREATER_OFFSET UNITYSDK_OFFSET(0x1A5A1390)
#define FOUNDATION_TRACKERPOOL_RELEASEASSETTRACKER_OFFSET UNITYSDK_OFFSET(0x1A5A0F80)
#define FOUNDATION_TRACKERPOOL_RELEASEINSTANCETRACKER_OFFSET UNITYSDK_OFFSET(0x1A5A1150)
#define FOUNDATION_TRACKERPOOL_RELEASETEMPORARAYTRACKER_OFFSET UNITYSDK_OFFSET(0x1A5A12B0)
#define FOUNDATION_TRACKERPOOL_TEMPORARAYTRACKERCREATER_OFFSET UNITYSDK_OFFSET(0x1A5A1440)
#define FOUNDATION_TRACKERPOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A5A14F0)

namespace Foundation
{
	inline static constexpr unsigned int TrackerPool_TypeDefinitionIndex = 8199;
	...
	public:
		...
		::Foundation::ObjectPool_1<::Foundation::AssetTracker*>* assetTrackerPool; // 0x20
