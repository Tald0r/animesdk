...
#define FOUNDATION_CONTAINER_CELLFUNC_EQUALS_OFFSET UNITYSDK_OFFSET(0x9AD6D0)
#define FOUNDATION_CONTAINER_CELLFUNC_GET_ALLOWDUPLICATEKEYS_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define FOUNDATION_CONTAINER_CELLFUNC_HASH_OFFSET UNITYSDK_OFFSET(0x9AD700)

namespace Foundation::Container
{
	inline static constexpr unsigned int CellFunc_TypeDefinitionIndex = 8784;
