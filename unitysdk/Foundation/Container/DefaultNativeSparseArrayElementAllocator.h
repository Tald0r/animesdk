...
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_CALCULATECAPACITYFORRESERVE_OFFSET UNITYSDK_OFFSET(0x990CE0)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_FREE_OFFSET UNITYSDK_OFFSET(0x917B20)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x2EAC30)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_MALLOC_OFFSET UNITYSDK_OFFSET(0x917B40)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x917B60)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x302300)

namespace Foundation::Container
{
	inline static constexpr unsigned int DefaultNativeSparseArrayElementAllocator_TypeDefinitionIndex = 9062;
