...
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_CALCULATECAPACITYFORRESERVE_OFFSET UNITYSDK_OFFSET(0x9604D0)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_FREE_OFFSET UNITYSDK_OFFSET(0x8EEC00)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x3B0730)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_MALLOC_OFFSET UNITYSDK_OFFSET(0x8EEC20)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x8EEC40)
#define FOUNDATION_CONTAINER_DEFAULTNATIVESPARSEARRAYELEMENTALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3600)

namespace Foundation::Container
{
	inline static constexpr unsigned int DefaultNativeSparseArrayElementAllocator_TypeDefinitionIndex = 9059;
