...
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_CALCULATECAPACITYFORRESERVE_OFFSET UNITYSDK_OFFSET(0x917A30)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_FREE_OFFSET UNITYSDK_OFFSET(0x917B20)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x2EAC30)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_MALLOC_OFFSET UNITYSDK_OFFSET(0x917B40)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x917B60)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x302300)

namespace Foundation::Container
{
	inline static constexpr unsigned int DefaultNativeVectorElementAllocator_TypeDefinitionIndex = 9016;
