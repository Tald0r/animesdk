...
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_CALCULATECAPACITYFORRESERVE_OFFSET UNITYSDK_OFFSET(0x8EEB10)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_FREE_OFFSET UNITYSDK_OFFSET(0x8EEC00)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_GET_ISCREATED_OFFSET UNITYSDK_OFFSET(0x3B0730)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_MALLOC_OFFSET UNITYSDK_OFFSET(0x8EEC20)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR_RESOLVE_OFFSET UNITYSDK_OFFSET(0x8EEC40)
#define FOUNDATION_CONTAINER_DEFAULTNATIVEVECTORELEMENTALLOCATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3600)

namespace Foundation::Container
{
	inline static constexpr unsigned int DefaultNativeVectorElementAllocator_TypeDefinitionIndex = 9175;
