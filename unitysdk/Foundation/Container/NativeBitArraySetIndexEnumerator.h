...
#define FOUNDATION_CONTAINER_NATIVEBITARRAYSETINDEXENUMERATOR_FINDSETBITINDEX_OFFSET UNITYSDK_OFFSET(0x1B489790)
#define FOUNDATION_CONTAINER_NATIVEBITARRAYSETINDEXENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x999FE0)
#define FOUNDATION_CONTAINER_NATIVEBITARRAYSETINDEXENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x99A050)
#define FOUNDATION_CONTAINER_NATIVEBITARRAYSETINDEXENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x999FC0)

namespace Foundation::Container
{
	inline static constexpr unsigned int NativeBitArraySetIndexEnumerator_TypeDefinitionIndex = 8994;
