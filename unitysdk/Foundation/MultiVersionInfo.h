...
#define FOUNDATION_MULTIVERSIONINFO_ADDMULTIVERPATH_OFFSET UNITYSDK_OFFSET(0x1AEBA520)
#define FOUNDATION_MULTIVERSIONINFO_CHECKFOREACHPATHS_OFFSET UNITYSDK_OFFSET(0x1AEBB2E0)
#define FOUNDATION_MULTIVERSIONINFO_FOREACHPATHS_OFFSET UNITYSDK_OFFSET(0x1AEBAA20)
#define FOUNDATION_MULTIVERSIONINFO_GETMULTIVERSUFFIX_OFFSET UNITYSDK_OFFSET(0x1AEBCA10)
#define FOUNDATION_MULTIVERSIONINFO_GETMULTIVERTPATH_OFFSET UNITYSDK_OFFSET(0x1AEBB0A0)
#define FOUNDATION_MULTIVERSIONINFO_ISALLNOTNULLOREMPTY_OFFSET UNITYSDK_OFFSET(0x1AEBB730)
#define FOUNDATION_MULTIVERSIONINFO_ISSUFFIXCORRECT_1_OFFSET UNITYSDK_OFFSET(0x1AEBB9D0)
#define FOUNDATION_MULTIVERSIONINFO_ISSUFFIXCORRECT_OFFSET UNITYSDK_OFFSET(0x1AEBB880)
#define FOUNDATION_MULTIVERSIONINFO_ISVALID_OFFSET UNITYSDK_OFFSET(0x1AEBB5E0)
#define FOUNDATION_MULTIVERSIONINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AEBA8C0)
#define FOUNDATION_MULTIVERSIONINFO_UPDATEHASH_OFFSET UNITYSDK_OFFSET(0x1AEBAD10)
#define FOUNDATION_MULTIVERSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEBA420)
#define FOUNDATION_MULTIVERSIONINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1AEBCAB0)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionInfo_TypeDefinitionIndex = 8138;
	...
	public:
		...
		::Foundation::UlongSerializable* basePathHash; // 0x20
		::Foundation::UlongSerializable* cnPathHash; // 0x28
