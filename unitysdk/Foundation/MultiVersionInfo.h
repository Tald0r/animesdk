...
#define FOUNDATION_MULTIVERSIONINFO_ADDMULTIVERPATH_OFFSET UNITYSDK_OFFSET(0x1A9922B0)
#define FOUNDATION_MULTIVERSIONINFO_CHECKFOREACHPATHS_OFFSET UNITYSDK_OFFSET(0x1A993070)
#define FOUNDATION_MULTIVERSIONINFO_FOREACHPATHS_OFFSET UNITYSDK_OFFSET(0x1A9927B0)
#define FOUNDATION_MULTIVERSIONINFO_GETMULTIVERSUFFIX_OFFSET UNITYSDK_OFFSET(0x1A9947A0)
#define FOUNDATION_MULTIVERSIONINFO_GETMULTIVERTPATH_OFFSET UNITYSDK_OFFSET(0x1A992E30)
#define FOUNDATION_MULTIVERSIONINFO_ISALLNOTNULLOREMPTY_OFFSET UNITYSDK_OFFSET(0x1A9934C0)
#define FOUNDATION_MULTIVERSIONINFO_ISSUFFIXCORRECT_1_OFFSET UNITYSDK_OFFSET(0x1A993760)
#define FOUNDATION_MULTIVERSIONINFO_ISSUFFIXCORRECT_OFFSET UNITYSDK_OFFSET(0x1A993610)
#define FOUNDATION_MULTIVERSIONINFO_ISVALID_OFFSET UNITYSDK_OFFSET(0x1A993370)
#define FOUNDATION_MULTIVERSIONINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A992650)
#define FOUNDATION_MULTIVERSIONINFO_UPDATEHASH_OFFSET UNITYSDK_OFFSET(0x1A992AA0)
#define FOUNDATION_MULTIVERSIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9921B0)
#define FOUNDATION_MULTIVERSIONINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A994840)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionInfo_TypeDefinitionIndex = 8072;
	...
	public:
		...
		::Foundation::UlongSerializable* cnPathHash; // 0x18
