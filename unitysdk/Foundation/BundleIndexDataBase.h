...
#define FOUNDATION_BUNDLEINDEXDATABASE_ASSETTOBUNDLESINSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA4FCB0)
#define FOUNDATION_BUNDLEINDEXDATABASE_ASSETTOBUNDLESREMOVEBYKEY_OFFSET UNITYSDK_OFFSET(0x1AA4FD50)
#define FOUNDATION_BUNDLEINDEXDATABASE_ASSETTOBUNDLESTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1AA4FE00)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLECHILDRENSADD_OFFSET UNITYSDK_OFFSET(0x1AA501A0)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLEINFOSINSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA4FB90)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLEINFOSTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1AA4FC20)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLETOCHILDRENINSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1AA4FEA0)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLETOCHILDRENTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1AA4FF30)
#define FOUNDATION_BUNDLEINDEXDATABASE_CLEARALLBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1AA4F640)
#define FOUNDATION_BUNDLEINDEXDATABASE_CLEARALLWITHOUTBUNDLES_OFFSET UNITYSDK_OFFSET(0x1AA4FAD0)
#define FOUNDATION_BUNDLEINDEXDATABASE_CLEARALL_OFFSET UNITYSDK_OFFSET(0x1AA4F9F0)
#define FOUNDATION_BUNDLEINDEXDATABASE_CLEARBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1AA4F6A0)
#define FOUNDATION_BUNDLEINDEXDATABASE_GETALLASSETHASHES_OFFSET UNITYSDK_OFFSET(0x1AA50220)
#define FOUNDATION_BUNDLEINDEXDATABASE_GETBUNDLECHILDRENSCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA50130)
#define FOUNDATION_BUNDLEINDEXDATABASE_GETCHILDREN_OFFSET UNITYSDK_OFFSET(0x1AA4FFC0)
#define FOUNDATION_BUNDLEINDEXDATABASE_INITASSETS_OFFSET UNITYSDK_OFFSET(0x1AA4F8F0)
#define FOUNDATION_BUNDLEINDEXDATABASE_INITBUNDLEINDEXASSET_OFFSET UNITYSDK_OFFSET(0x1AA4F5D0)
#define FOUNDATION_BUNDLEINDEXDATABASE_INITBUNDLES_OFFSET UNITYSDK_OFFSET(0x1AA4F710)
#define FOUNDATION_BUNDLEINDEXDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA50290)

namespace Foundation
{
	inline static constexpr unsigned int BundleIndexDataBase_TypeDefinitionIndex = 7830;
	...
	public:
		...
		::System::Collections::Generic::List_1<::Il2CppArray<::Foundation::BundleID>*>* BundleChildrens; // 0x20
		::Unity::Collections::ValueSparseHashMap8_32_1<::Foundation::BundleInfo>* BundleInfos; // 0x28
