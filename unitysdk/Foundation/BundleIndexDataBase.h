...
#define FOUNDATION_BUNDLEINDEXDATABASE_ASSETTOBUNDLESINSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1A852340)
#define FOUNDATION_BUNDLEINDEXDATABASE_ASSETTOBUNDLESREMOVEBYKEY_OFFSET UNITYSDK_OFFSET(0x1A8523E0)
#define FOUNDATION_BUNDLEINDEXDATABASE_ASSETTOBUNDLESTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1A852490)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLECHILDRENSADD_OFFSET UNITYSDK_OFFSET(0x1A852830)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLEINFOSINSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1A852220)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLEINFOSTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1A8522B0)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLETOCHILDRENINSERTORUPDATE_OFFSET UNITYSDK_OFFSET(0x1A852530)
#define FOUNDATION_BUNDLEINDEXDATABASE_BUNDLETOCHILDRENTRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1A8525C0)
#define FOUNDATION_BUNDLEINDEXDATABASE_CLEARALLBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1A851CD0)
#define FOUNDATION_BUNDLEINDEXDATABASE_CLEARALLWITHOUTBUNDLES_OFFSET UNITYSDK_OFFSET(0x1A852160)
#define FOUNDATION_BUNDLEINDEXDATABASE_CLEARALL_OFFSET UNITYSDK_OFFSET(0x1A852080)
#define FOUNDATION_BUNDLEINDEXDATABASE_CLEARBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x1A851D30)
#define FOUNDATION_BUNDLEINDEXDATABASE_GETALLASSETHASHES_OFFSET UNITYSDK_OFFSET(0x1A8528B0)
#define FOUNDATION_BUNDLEINDEXDATABASE_GETBUNDLECHILDRENSCOUNT_OFFSET UNITYSDK_OFFSET(0x1A8527C0)
#define FOUNDATION_BUNDLEINDEXDATABASE_GETCHILDREN_OFFSET UNITYSDK_OFFSET(0x1A852650)
#define FOUNDATION_BUNDLEINDEXDATABASE_INITASSETS_OFFSET UNITYSDK_OFFSET(0x1A851F80)
#define FOUNDATION_BUNDLEINDEXDATABASE_INITBUNDLEINDEXASSET_OFFSET UNITYSDK_OFFSET(0x1A851C60)
#define FOUNDATION_BUNDLEINDEXDATABASE_INITBUNDLES_OFFSET UNITYSDK_OFFSET(0x1A851DA0)
#define FOUNDATION_BUNDLEINDEXDATABASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A852920)

namespace Foundation
{
	inline static constexpr unsigned int BundleIndexDataBase_TypeDefinitionIndex = 8118;

	class BundleIndexDataBase : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::Il2CppArray<::Foundation::BundleID>*>* BundleChildrens; // 0x10
		::Unity::Collections::ValueSparseHashMap8_32_1<::Foundation::BundleInfo>* BundleInfos; // 0x18
		::Unity::Collections::ValueSparseHashMap8_8_1<::System::UInt64>* AssetToBundles; // 0x20
		::Unity::Collections::ValueSparseHashMap8_4_1<::System::Int32>* BundleToChildren; // 0x28
