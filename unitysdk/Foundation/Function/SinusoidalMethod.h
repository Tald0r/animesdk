...
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_GET_OFFSET UNITYSDK_OFFSET(0x19C49610)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x19C49640)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_MINVALUE_OFFSET UNITYSDK_OFFSET(0x19C49630)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_RANGE_OFFSET UNITYSDK_OFFSET(0x19C49650)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_RESOLVEGREATER_OFFSET UNITYSDK_OFFSET(0x19C495B0)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_RESOLVE_OFFSET UNITYSDK_OFFSET(0x19C495F0)

namespace Foundation::Function
{
	inline static constexpr unsigned int SinusoidalMethod_TypeDefinitionIndex = 9116;
