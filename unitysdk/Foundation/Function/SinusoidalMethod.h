...
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_GET_OFFSET UNITYSDK_OFFSET(0x1A1D7A50)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x1A1D7A80)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_MINVALUE_OFFSET UNITYSDK_OFFSET(0x1A1D7A70)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_RANGE_OFFSET UNITYSDK_OFFSET(0x1A1D7A90)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_RESOLVEGREATER_OFFSET UNITYSDK_OFFSET(0x1A1D79F0)
#define FOUNDATION_FUNCTION_SINUSOIDALMETHOD_RESOLVE_OFFSET UNITYSDK_OFFSET(0x1A1D7A30)
