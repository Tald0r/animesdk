...
#define FOUNDATION_FUNCTION_SINUSOIDAL_EVALUATE_1_OFFSET UNITYSDK_OFFSET(0x8EEDA0)
#define FOUNDATION_FUNCTION_SINUSOIDAL_EVALUATE_OFFSET UNITYSDK_OFFSET(0x8EED50)
#define FOUNDATION_FUNCTION_SINUSOIDAL_GET_COSCOEFFICIENT_OFFSET UNITYSDK_OFFSET(0x39B980)
#define FOUNDATION_FUNCTION_SINUSOIDAL_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x2D8720)
#define FOUNDATION_FUNCTION_SINUSOIDAL_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0x8EECC0)
#define FOUNDATION_FUNCTION_SINUSOIDAL_GET_SINCOEFFICIENT_OFFSET UNITYSDK_OFFSET(0x2D8730)
#define FOUNDATION_FUNCTION_SINUSOIDAL_NEW_OFFSET UNITYSDK_OFFSET(0x19C48B30)
#define FOUNDATION_FUNCTION_SINUSOIDAL_RANGE_OFFSET UNITYSDK_OFFSET(0x8EEDF0)
#define FOUNDATION_FUNCTION_SINUSOIDAL_RESOLVEGREATER_OFFSET UNITYSDK_OFFSET(0x8EEDD0)
#define FOUNDATION_FUNCTION_SINUSOIDAL__CTOR_OFFSET UNITYSDK_OFFSET(0x8EECD0)
#define FOUNDATION_FUNCTION_SINUSOIDAL__RANGE_G__UPDATEVALUE_21_0_OFFSET UNITYSDK_OFFSET(0x19C49520)

namespace Foundation::Function
{
	inline static constexpr unsigned int Sinusoidal_TypeDefinitionIndex = 9057;
