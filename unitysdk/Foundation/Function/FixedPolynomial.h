...
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_ADD_OFFSET UNITYSDK_OFFSET(0x960900)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_BEZIER_OFFSET UNITYSDK_OFFSET(0x1AD04EA0)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1AD03210)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1AD033A0)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_CREATE_3_OFFSET UNITYSDK_OFFSET(0x1AD03540)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_CREATE_OFFSET UNITYSDK_OFFSET(0x1AD03090)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_DERIVATIVE_OFFSET UNITYSDK_OFFSET(0x960860)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_EVALUATE_OFFSET UNITYSDK_OFFSET(0x9607D0)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x960760)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x2C37B0)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_HERMITE_OFFSET UNITYSDK_OFFSET(0x1AD04530)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_INTEGRAL_1_OFFSET UNITYSDK_OFFSET(0x9608A0)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_INTEGRAL_OFFSET UNITYSDK_OFFSET(0x960880)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x960920)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x9608E0)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x1AD043E0)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1AD04480)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_OP_MULTIPLY_2_OFFSET UNITYSDK_OFFSET(0x1AD044E0)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1AD04430)
#define FOUNDATION_FUNCTION_FIXEDPOLYNOMIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x960730)

namespace Foundation::Function
{
	inline static constexpr unsigned int FixedPolynomial_TypeDefinitionIndex = 8755;
