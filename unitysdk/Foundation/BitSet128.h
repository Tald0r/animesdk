...
#define FOUNDATION_BITSET128_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x963650)
#define FOUNDATION_BITSET128_EQUALS_OFFSET UNITYSDK_OFFSET(0x9635E0)
#define FOUNDATION_BITSET128_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x9636F0)
#define FOUNDATION_BITSET128_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x725290)
#define FOUNDATION_BITSET128_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x692540)
#define FOUNDATION_BITSET128_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x725330)
#define FOUNDATION_BITSET128_NUMBITSET_OFFSET UNITYSDK_OFFSET(0x7252C0)
#define FOUNDATION_BITSET128_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x1AD8E230)
#define FOUNDATION_BITSET128_OP_BITWISEOR_OFFSET UNITYSDK_OFFSET(0x1AD8E210)
#define FOUNDATION_BITSET128_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AD8E250)
#define FOUNDATION_BITSET128_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AD8E270)
#define FOUNDATION_BITSET128_OP_ONESCOMPLEMENT_OFFSET UNITYSDK_OFFSET(0x1AD8E1F0)
#define FOUNDATION_BITSET128_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x9634E0)
#define FOUNDATION_BITSET128__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD8E4D0)
#define FOUNDATION_BITSET128__CTOR_1_OFFSET UNITYSDK_OFFSET(0x963540)
#define FOUNDATION_BITSET128__CTOR_OFFSET UNITYSDK_OFFSET(0x2D6E20)

namespace Foundation
{
	inline static constexpr unsigned int BitSet128_TypeDefinitionIndex = 8849;

	struct alignas(8) BitSet128
	{
		static ::Foundation::BitSet128* StaticGet_Empty()
		{
			return (::Foundation::BitSet128*)Il2CppClass::FromTypeDefinitionIndex(BitSet128_TypeDefinitionIndex)->GetStaticField(0x3DF0);
		}
		static ::Foundation::BitSet128* StaticGet_Full()
		{
			return (::Foundation::BitSet128*)Il2CppClass::FromTypeDefinitionIndex(BitSet128_TypeDefinitionIndex)->GetStaticField(0x3E00);
		}
