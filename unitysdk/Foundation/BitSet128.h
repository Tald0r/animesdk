...
#define FOUNDATION_BITSET128_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9935B0)
#define FOUNDATION_BITSET128_EQUALS_OFFSET UNITYSDK_OFFSET(0x993540)
#define FOUNDATION_BITSET128_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x993650)
#define FOUNDATION_BITSET128_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x774890)
#define FOUNDATION_BITSET128_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x61C8F0)
#define FOUNDATION_BITSET128_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x774F00)
#define FOUNDATION_BITSET128_NUMBITSET_OFFSET UNITYSDK_OFFSET(0x774B30)
#define FOUNDATION_BITSET128_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x1B396710)
#define FOUNDATION_BITSET128_OP_BITWISEOR_OFFSET UNITYSDK_OFFSET(0x1B3966F0)
#define FOUNDATION_BITSET128_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B396730)
#define FOUNDATION_BITSET128_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B396750)
#define FOUNDATION_BITSET128_OP_ONESCOMPLEMENT_OFFSET UNITYSDK_OFFSET(0x1B3966D0)
#define FOUNDATION_BITSET128_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x993440)
#define FOUNDATION_BITSET128__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B3969B0)
#define FOUNDATION_BITSET128__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9934A0)
#define FOUNDATION_BITSET128__CTOR_OFFSET UNITYSDK_OFFSET(0x301710)

namespace Foundation
{
	inline static constexpr unsigned int BitSet128_TypeDefinitionIndex = 9009;

	struct alignas(8) BitSet128
	{
		static ::Foundation::BitSet128* StaticGet_Full()
		{
			return (::Foundation::BitSet128*)Il2CppClass::FromTypeDefinitionIndex(BitSet128_TypeDefinitionIndex)->GetStaticField(0x3E10);
		}
