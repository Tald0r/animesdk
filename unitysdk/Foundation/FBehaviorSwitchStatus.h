...
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x99C7E0)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASBLENDEDINSWITCH_OFFSET UNITYSDK_OFFSET(0x99C780)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASBLENDEDOUTSWITCH_OFFSET UNITYSDK_OFFSET(0x99C7C0)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASBLENDINSWITCH_OFFSET UNITYSDK_OFFSET(0x99C760)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASBLENDOUTSWITCH_OFFSET UNITYSDK_OFFSET(0x99C7A0)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASSTATESWITCH_OFFSET UNITYSDK_OFFSET(0x99C750)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x2F3C30)

namespace Foundation
{
	inline static constexpr unsigned int FBehaviorSwitchStatus_TypeDefinitionIndex = 9012;
