...
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_CONTAINS_OFFSET UNITYSDK_OFFSET(0x96DE30)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASBLENDEDINSWITCH_OFFSET UNITYSDK_OFFSET(0x96DDD0)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASBLENDEDOUTSWITCH_OFFSET UNITYSDK_OFFSET(0x96DE10)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASBLENDINSWITCH_OFFSET UNITYSDK_OFFSET(0x96DDB0)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASBLENDOUTSWITCH_OFFSET UNITYSDK_OFFSET(0x96DDF0)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS_GET_HASSTATESWITCH_OFFSET UNITYSDK_OFFSET(0x96DDA0)
#define FOUNDATION_FBEHAVIORSWITCHSTATUS__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3730)

namespace Foundation
{
	inline static constexpr unsigned int FBehaviorSwitchStatus_TypeDefinitionIndex = 8946;
