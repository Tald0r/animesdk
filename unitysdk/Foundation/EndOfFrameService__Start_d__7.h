...
#define FOUNDATION_ENDOFFRAMESERVICE__START_D__7_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AF815A0)
#define FOUNDATION_ENDOFFRAMESERVICE__START_D__7_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AF81650)
#define FOUNDATION_ENDOFFRAMESERVICE__START_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AF816B0)
#define FOUNDATION_ENDOFFRAMESERVICE__START_D__7_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AF81660)
#define FOUNDATION_ENDOFFRAMESERVICE__START_D__7_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AF81590)
#define FOUNDATION_ENDOFFRAMESERVICE__START_D__7__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF81580)

namespace Foundation
{
	inline static constexpr unsigned int EndOfFrameService__Start_d__7_TypeDefinitionIndex = 9093;
