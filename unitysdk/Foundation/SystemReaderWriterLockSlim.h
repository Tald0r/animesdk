...
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_ACQUIREREADERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1B07F990)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_ACQUIREREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1B07F950)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_ISREADERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1B07FA00)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_RELEASEREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1B07F9E0)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_ACQUIREWRITERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1B07FAE0)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_ACQUIREWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1B07FAA0)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_ISWRITERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1B07FB50)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_RELEASEWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1B07FB30)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1B07F8C0)

namespace Foundation
{
	inline static constexpr unsigned int SystemReaderWriterLockSlim_TypeDefinitionIndex = 8862;
