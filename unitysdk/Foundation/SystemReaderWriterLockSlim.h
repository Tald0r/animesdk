...
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_ACQUIREREADERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1AB309C0)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_ACQUIREREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1AB30980)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_ISREADERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1AB30A30)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IREADERLOCK_RELEASEREADERLOCK_OFFSET UNITYSDK_OFFSET(0x1AB30A10)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_ACQUIREWRITERLOCK_1_OFFSET UNITYSDK_OFFSET(0x1AB30B10)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_ACQUIREWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1AB30AD0)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_ISWRITERLOCKHELD_OFFSET UNITYSDK_OFFSET(0x1AB30B80)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM_FOUNDATION_IWRITERLOCK_RELEASEWRITERLOCK_OFFSET UNITYSDK_OFFSET(0x1AB30B60)
#define FOUNDATION_SYSTEMREADERWRITERLOCKSLIM__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB308E0)

namespace Foundation
{
	inline static constexpr unsigned int SystemReaderWriterLockSlim_TypeDefinitionIndex = 8905;
