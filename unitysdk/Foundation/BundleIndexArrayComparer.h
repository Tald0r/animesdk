...
#define FOUNDATION_BUNDLEINDEXARRAYCOMPARER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1A47F6A0)
#define FOUNDATION_BUNDLEINDEXARRAYCOMPARER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1A47F770)
#define FOUNDATION_BUNDLEINDEXARRAYCOMPARER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A47F880)
#define FOUNDATION_BUNDLEINDEXARRAYCOMPARER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A47F870)

namespace Foundation
{
	inline static constexpr unsigned int BundleIndexArrayComparer_TypeDefinitionIndex = 7743;
	...
	public:
		...
		{
			return (::Foundation::IEnumerableX_Set_1<::Foundation::BundleID>**)Il2CppClass::FromTypeDefinitionIndex(BundleIndexArrayComparer_TypeDefinitionIndex)->GetStaticField(0x6A20);
		}
