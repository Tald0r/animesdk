...
#define FOUNDATION_VERSIONFILEINFOLIST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD35DA0)

namespace Foundation
{
	inline static constexpr unsigned int VersionFileInfoList_TypeDefinitionIndex = 7719;
