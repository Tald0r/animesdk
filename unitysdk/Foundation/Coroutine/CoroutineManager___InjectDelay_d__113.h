...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___INJECTDELAY_D__113_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A59A5C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___INJECTDELAY_D__113_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A59A700)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___INJECTDELAY_D__113_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A59A760)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___INJECTDELAY_D__113_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A59A710)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___INJECTDELAY_D__113_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A59A5B0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___INJECTDELAY_D__113__CTOR_OFFSET UNITYSDK_OFFSET(0x1A59A5A0)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___InjectDelay_d__113_TypeDefinitionIndex = 7900;
