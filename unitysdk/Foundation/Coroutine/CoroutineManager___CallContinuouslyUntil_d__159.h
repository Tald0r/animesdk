...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLYUNTIL_D__159_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19765820)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLYUNTIL_D__159_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19765940)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLYUNTIL_D__159_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x197659A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLYUNTIL_D__159_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19765950)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLYUNTIL_D__159_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19765810)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___CALLCONTINUOUSLYUNTIL_D__159__CTOR_OFFSET UNITYSDK_OFFSET(0x19765800)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___CallContinuouslyUntil_d__159_TypeDefinitionIndex = 7841;
