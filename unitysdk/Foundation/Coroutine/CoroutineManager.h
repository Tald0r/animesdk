...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_ADDTAG_OFFSET UNITYSDK_OFFSET(0x170D3190)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_ADD_ONPREEXECUTE_OFFSET UNITYSDK_OFFSET(0x170CB4D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x170CB8A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLCONTINUOUSLYONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x170DE6B0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLCONTINUOUSLYONINSTANCE_OFFSET UNITYSDK_OFFSET(0x170DE1E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLCONTINUOUSLY_1_OFFSET UNITYSDK_OFFSET(0x170DE3A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLCONTINUOUSLY_OFFSET UNITYSDK_OFFSET(0x170DE0F0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYEDONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x170DC8D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYEDONINSTANCE_OFFSET UNITYSDK_OFFSET(0x170DBA10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYED_1_OFFSET UNITYSDK_OFFSET(0x170DBDC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYED_2_OFFSET UNITYSDK_OFFSET(0x170DC0A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYED_3_OFFSET UNITYSDK_OFFSET(0x170DC530)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYED_OFFSET UNITYSDK_OFFSET(0x170DB680)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLYONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x170DDCB0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLYONINSTANCE_OFFSET UNITYSDK_OFFSET(0x170DD540)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLYUNTIL_OFFSET UNITYSDK_OFFSET(0x170DED30)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLY_1_OFFSET UNITYSDK_OFFSET(0x170DD950)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLY_OFFSET UNITYSDK_OFFSET(0x170DD120)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CLOSEWAITINGPROCESS_OFFSET UNITYSDK_OFFSET(0x170CF430)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_COINDEXEXTRACT_OFFSET UNITYSDK_OFFSET(0x170D4360)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_COINDEXISNULL_OFFSET UNITYSDK_OFFSET(0x170CF2E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_COINDEXPEEK_OFFSET UNITYSDK_OFFSET(0x170D86C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_COINDEXREPLACE_OFFSET UNITYSDK_OFFSET(0x170D8C70)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CREATENEWHANDLE_OFFSET UNITYSDK_OFFSET(0x170D9340)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROYIMMEDIATE_1_OFFSET UNITYSDK_OFFSET(0x170DFA40)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROYIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x170DF9E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROYOBJECT_1_OFFSET UNITYSDK_OFFSET(0x170DF970)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROYOBJECT_OFFSET UNITYSDK_OFFSET(0x170DF910)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROY_1_OFFSET UNITYSDK_OFFSET(0x170DF740)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROY_OFFSET UNITYSDK_OFFSET(0x170DF6E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_FINDOBJECTOFTYPE_OFFSET UNITYSDK_OFFSET(0x170DFC10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_FINDOBJECTSOFTYPE_OFFSET UNITYSDK_OFFSET(0x170DFC70)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x170CE300)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x170D3F50)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GETSEGMENTTIME_OFFSET UNITYSDK_OFFSET(0x170D79E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x170CB490)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x170CB0A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GET_LOCALTIME_OFFSET UNITYSDK_OFFSET(0x170CB060)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GET_MAINTHREAD_OFFSET UNITYSDK_OFFSET(0x170CB610)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_HANDLEISINWAITINGLIST_OFFSET UNITYSDK_OFFSET(0x170DA740)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINESONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x170D4070)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINESONINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x170D4610)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINESONINSTANCE_OFFSET UNITYSDK_OFFSET(0x170D36C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINES_1_OFFSET UNITYSDK_OFFSET(0x170D3CB0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINES_2_OFFSET UNITYSDK_OFFSET(0x170D44B0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINES_OFFSET UNITYSDK_OFFSET(0x170D3420)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x170CEAF0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_LOCKCOROUTINE_OFFSET UNITYSDK_OFFSET(0x170DAF90)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_NULLIFY_1_OFFSET UNITYSDK_OFFSET(0x170D4A40)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_NULLIFY_OFFSET UNITYSDK_OFFSET(0x170D8130)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x170CBE10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINESONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x170D5100)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINESONINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x170D6500)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINESONINSTANCE_OFFSET UNITYSDK_OFFSET(0x170D4CF0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINES_1_OFFSET UNITYSDK_OFFSET(0x170D4FC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINES_2_OFFSET UNITYSDK_OFFSET(0x170D63A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINES_OFFSET UNITYSDK_OFFSET(0x170D4B90)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PRINT_OFFSET UNITYSDK_OFFSET(0x170DFCD0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_REMOVETAG_OFFSET UNITYSDK_OFFSET(0x170CF640)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_REMOVEUNUSED_OFFSET UNITYSDK_OFFSET(0x170CD0B0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_REMOVE_ONPREEXECUTE_OFFSET UNITYSDK_OFFSET(0x170CB570)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESETTIMECOUNTONINSTANCE_OFFSET UNITYSDK_OFFSET(0x170D3C40)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINESONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x170D6FE0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINESONINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x170D73D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINESONINSTANCE_OFFSET UNITYSDK_OFFSET(0x170D6830)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINES_1_OFFSET UNITYSDK_OFFSET(0x170D6EA0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINES_2_OFFSET UNITYSDK_OFFSET(0x170D7270)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINES_OFFSET UNITYSDK_OFFSET(0x170D66D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEINTERNAL_OFFSET UNITYSDK_OFFSET(0x170CFB60)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x170D2600)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEONINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x170D28F0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEONINSTANCE_3_OFFSET UNITYSDK_OFFSET(0x170D2C00)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEONINSTANCE_OFFSET UNITYSDK_OFFSET(0x170D24E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_1_OFFSET UNITYSDK_OFFSET(0x170D1850)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_2_OFFSET UNITYSDK_OFFSET(0x170D1B10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_3_OFFSET UNITYSDK_OFFSET(0x170D1E40)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_4_OFFSET UNITYSDK_OFFSET(0x170D2180)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_OFFSET UNITYSDK_OFFSET(0x170CF850)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_SETPAUSE_OFFSET UNITYSDK_OFFSET(0x170D51E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x170CB860)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_SET_MAINTHREAD_OFFSET UNITYSDK_OFFSET(0x170CB640)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STARTCOROUTINE_1_OFFSET UNITYSDK_OFFSET(0x170DF3E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STARTCOROUTINE_AUTO_OFFSET UNITYSDK_OFFSET(0x170DF450)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STARTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x170DF370)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STOPALLCOROUTINES_OFFSET UNITYSDK_OFFSET(0x170DF680)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STOPCOROUTINE_OFFSET UNITYSDK_OFFSET(0x170DF4C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_UNLOCKCOROUTINE_OFFSET UNITYSDK_OFFSET(0x170DB440)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_UPDATETIMEVALUES_OFFSET UNITYSDK_OFFSET(0x170CCF10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x170CC000)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITFORSECONDSONINSTANCE_OFFSET UNITYSDK_OFFSET(0x170D9600)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITFORSECONDS_OFFSET UNITYSDK_OFFSET(0x170D90B0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONEWRAPPER_OFFSET UNITYSDK_OFFSET(0x170DA000)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_1_OFFSET UNITYSDK_OFFSET(0x170D9870)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_2_OFFSET UNITYSDK_OFFSET(0x170DA880)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_3_OFFSET UNITYSDK_OFFSET(0x170DABC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_4_OFFSET UNITYSDK_OFFSET(0x170DADA0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_OFFSET UNITYSDK_OFFSET(0x170D9690)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__CALLCONTINUOUSLYUNTIL_OFFSET UNITYSDK_OFFSET(0x170DF030)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__CALLCONTINUOUSLY_OFFSET UNITYSDK_OFFSET(0x170DD450)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x170E0050)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x170DFD30)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__DELAYEDCALL_1_OFFSET UNITYSDK_OFFSET(0x170DC470)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__DELAYEDCALL_OFFSET UNITYSDK_OFFSET(0x170DB940)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__INJECTDELAY_OFFSET UNITYSDK_OFFSET(0x170D89A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__STARTWHENDONE_1_OFFSET UNITYSDK_OFFSET(0x170DAB10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__STARTWHENDONE_2_OFFSET UNITYSDK_OFFSET(0x170DACF0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__STARTWHENDONE_3_OFFSET UNITYSDK_OFFSET(0x170DAEE0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__STARTWHENDONE_OFFSET UNITYSDK_OFFSET(0x170D9F50)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager_TypeDefinitionIndex = 7882;
	...
	public:
		...
		{
			return (::System::Func_3<::System::Collections::Generic::IEnumerator_1<::System::Single>*, ::Foundation::Coroutine::CoroutineHandle, ::System::Collections::Generic::IEnumerator_1<::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6800);
		}
		static ::System::Action** StaticGet_OnPreExecute()
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6808);
		}
		static ::System::Action** StaticGet_OnPostExecute()
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6810);
		}
		static ::System::Threading::Thread** StaticGet__MainThread_k__BackingField()
		{
			return (::System::Threading::Thread**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6818);
		}
		static ::Foundation::Coroutine::CoroutineManager** StaticGet__instance()
		{
			return (::Foundation::Coroutine::CoroutineManager**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6820);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Byte, ::Foundation::Coroutine::CoroutineManager*>**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6828);
		}
		static ::Foundation::Coroutine::CoroutineHandle* StaticGet__tmpHandle()
		{
			return (::Foundation::Coroutine::CoroutineHandle*)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x3540);
		}
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x3548);
		}
