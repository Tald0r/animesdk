...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_ADDTAG_OFFSET UNITYSDK_OFFSET(0x17840580)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_ADD_ONPREEXECUTE_OFFSET UNITYSDK_OFFSET(0x178388C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_AWAKE_OFFSET UNITYSDK_OFFSET(0x17838C90)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLCONTINUOUSLYONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1784BAA0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLCONTINUOUSLYONINSTANCE_OFFSET UNITYSDK_OFFSET(0x1784B5D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLCONTINUOUSLY_1_OFFSET UNITYSDK_OFFSET(0x1784B790)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLCONTINUOUSLY_OFFSET UNITYSDK_OFFSET(0x1784B4E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYEDONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x17849CC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYEDONINSTANCE_OFFSET UNITYSDK_OFFSET(0x17848E00)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYED_1_OFFSET UNITYSDK_OFFSET(0x178491B0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYED_2_OFFSET UNITYSDK_OFFSET(0x17849490)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYED_3_OFFSET UNITYSDK_OFFSET(0x17849920)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLDELAYED_OFFSET UNITYSDK_OFFSET(0x17848A70)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLYONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1784B0A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLYONINSTANCE_OFFSET UNITYSDK_OFFSET(0x1784A930)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLYUNTIL_OFFSET UNITYSDK_OFFSET(0x1784C120)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLY_1_OFFSET UNITYSDK_OFFSET(0x1784AD40)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CALLPERIODICALLY_OFFSET UNITYSDK_OFFSET(0x1784A510)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CLOSEWAITINGPROCESS_OFFSET UNITYSDK_OFFSET(0x1783C820)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_COINDEXEXTRACT_OFFSET UNITYSDK_OFFSET(0x17841750)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_COINDEXISNULL_OFFSET UNITYSDK_OFFSET(0x1783C6D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_COINDEXPEEK_OFFSET UNITYSDK_OFFSET(0x17845AA0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_COINDEXREPLACE_OFFSET UNITYSDK_OFFSET(0x17846050)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_CREATENEWHANDLE_OFFSET UNITYSDK_OFFSET(0x17846720)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROYIMMEDIATE_1_OFFSET UNITYSDK_OFFSET(0x1784CE30)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROYIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1784CDD0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROYOBJECT_1_OFFSET UNITYSDK_OFFSET(0x1784CD60)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROYOBJECT_OFFSET UNITYSDK_OFFSET(0x1784CD00)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROY_1_OFFSET UNITYSDK_OFFSET(0x1784CB30)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_DESTROY_OFFSET UNITYSDK_OFFSET(0x1784CAD0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_FINDOBJECTOFTYPE_OFFSET UNITYSDK_OFFSET(0x1784D000)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_FINDOBJECTSOFTYPE_OFFSET UNITYSDK_OFFSET(0x1784D060)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1783B6F0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x17841340)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GETSEGMENTTIME_OFFSET UNITYSDK_OFFSET(0x17844DC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GET_DELTATIME_OFFSET UNITYSDK_OFFSET(0x17838880)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x17838490)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GET_LOCALTIME_OFFSET UNITYSDK_OFFSET(0x17838450)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_GET_MAINTHREAD_OFFSET UNITYSDK_OFFSET(0x17838A00)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_HANDLEISINWAITINGLIST_OFFSET UNITYSDK_OFFSET(0x17847B20)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINESONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x17841460)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINESONINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x17841A00)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINESONINSTANCE_OFFSET UNITYSDK_OFFSET(0x17840AB0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINES_1_OFFSET UNITYSDK_OFFSET(0x178410A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINES_2_OFFSET UNITYSDK_OFFSET(0x178418A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_KILLCOROUTINES_OFFSET UNITYSDK_OFFSET(0x17840810)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1783BEE0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_LOCKCOROUTINE_OFFSET UNITYSDK_OFFSET(0x17848380)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_NULLIFY_1_OFFSET UNITYSDK_OFFSET(0x17841E20)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_NULLIFY_OFFSET UNITYSDK_OFFSET(0x17845510)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x17839200)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINESONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x178424E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINESONINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x178438E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINESONINSTANCE_OFFSET UNITYSDK_OFFSET(0x178420D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINES_1_OFFSET UNITYSDK_OFFSET(0x178423A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINES_2_OFFSET UNITYSDK_OFFSET(0x17843780)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PAUSECOROUTINES_OFFSET UNITYSDK_OFFSET(0x17841F70)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PRINT_OFFSET UNITYSDK_OFFSET(0x1784D0C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_REMOVETAG_OFFSET UNITYSDK_OFFSET(0x1783CA30)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_REMOVEUNUSED_OFFSET UNITYSDK_OFFSET(0x1783A4A0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_REMOVE_ONPREEXECUTE_OFFSET UNITYSDK_OFFSET(0x17838960)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESETTIMECOUNTONINSTANCE_OFFSET UNITYSDK_OFFSET(0x17841030)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINESONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x178443C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINESONINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x178447B0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINESONINSTANCE_OFFSET UNITYSDK_OFFSET(0x17843C10)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINES_1_OFFSET UNITYSDK_OFFSET(0x17844280)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINES_2_OFFSET UNITYSDK_OFFSET(0x17844650)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RESUMECOROUTINES_OFFSET UNITYSDK_OFFSET(0x17843AB0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEINTERNAL_OFFSET UNITYSDK_OFFSET(0x1783CF50)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEONINSTANCE_1_OFFSET UNITYSDK_OFFSET(0x1783F9F0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEONINSTANCE_2_OFFSET UNITYSDK_OFFSET(0x1783FCE0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEONINSTANCE_3_OFFSET UNITYSDK_OFFSET(0x1783FFF0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINEONINSTANCE_OFFSET UNITYSDK_OFFSET(0x1783F8D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_1_OFFSET UNITYSDK_OFFSET(0x1783EC40)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_2_OFFSET UNITYSDK_OFFSET(0x1783EF00)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_3_OFFSET UNITYSDK_OFFSET(0x1783F230)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_4_OFFSET UNITYSDK_OFFSET(0x1783F570)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_RUNCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1783CC40)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_SETPAUSE_OFFSET UNITYSDK_OFFSET(0x178425C0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_SET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x17838C50)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_SET_MAINTHREAD_OFFSET UNITYSDK_OFFSET(0x17838A30)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STARTCOROUTINE_1_OFFSET UNITYSDK_OFFSET(0x1784C7D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STARTCOROUTINE_AUTO_OFFSET UNITYSDK_OFFSET(0x1784C840)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STARTCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1784C760)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STOPALLCOROUTINES_OFFSET UNITYSDK_OFFSET(0x1784CA70)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_STOPCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1784C8B0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_UNLOCKCOROUTINE_OFFSET UNITYSDK_OFFSET(0x17848830)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_UPDATETIMEVALUES_OFFSET UNITYSDK_OFFSET(0x1783A300)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_UPDATE_OFFSET UNITYSDK_OFFSET(0x178393F0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITFORSECONDSONINSTANCE_OFFSET UNITYSDK_OFFSET(0x178469E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITFORSECONDS_OFFSET UNITYSDK_OFFSET(0x17846490)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONEWRAPPER_OFFSET UNITYSDK_OFFSET(0x178473E0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_1_OFFSET UNITYSDK_OFFSET(0x17846C50)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_2_OFFSET UNITYSDK_OFFSET(0x17847C60)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_3_OFFSET UNITYSDK_OFFSET(0x17847FA0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_4_OFFSET UNITYSDK_OFFSET(0x17848180)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_WAITUNTILDONE_OFFSET UNITYSDK_OFFSET(0x17846A70)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__CALLCONTINUOUSLYUNTIL_OFFSET UNITYSDK_OFFSET(0x1784C420)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__CALLCONTINUOUSLY_OFFSET UNITYSDK_OFFSET(0x1784A840)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1784D440)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__CTOR_OFFSET UNITYSDK_OFFSET(0x1784D120)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__DELAYEDCALL_1_OFFSET UNITYSDK_OFFSET(0x17849860)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__DELAYEDCALL_OFFSET UNITYSDK_OFFSET(0x17848D30)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__INJECTDELAY_OFFSET UNITYSDK_OFFSET(0x17845D80)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__STARTWHENDONE_1_OFFSET UNITYSDK_OFFSET(0x17847EF0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__STARTWHENDONE_2_OFFSET UNITYSDK_OFFSET(0x178480D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__STARTWHENDONE_3_OFFSET UNITYSDK_OFFSET(0x178482D0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER__STARTWHENDONE_OFFSET UNITYSDK_OFFSET(0x17847330)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager_TypeDefinitionIndex = 7831;
	...
	public:
		...
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6820);
		}
		static ::System::Threading::Thread** StaticGet__MainThread_k__BackingField()
		{
			return (::System::Threading::Thread**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6828);
		}
		static ::System::Action** StaticGet_OnPreExecute()
		{
			return (::System::Action**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6830);
		}
		static ::Foundation::Coroutine::CoroutineManager** StaticGet__instance()
		{
			return (::Foundation::Coroutine::CoroutineManager**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6838);
		}
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::Byte, ::Foundation::Coroutine::CoroutineManager*>**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6840);
		}
		...
		{
			return (::System::Func_3<::System::Collections::Generic::IEnumerator_1<::System::Single>*, ::Foundation::Coroutine::CoroutineHandle, ::System::Collections::Generic::IEnumerator_1<::System::Single>*>**)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x6848);
		}
		static ::System::Single* StaticGet_WaitForOneFrame()
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x3540);
		}
		static ::System::Boolean* StaticGet__tmpBool()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x3544);
		}
		static ::Foundation::Coroutine::CoroutineHandle* StaticGet__tmpHandle()
		{
			return (::Foundation::Coroutine::CoroutineHandle*)Il2CppClass::FromTypeDefinitionIndex(CoroutineManager_TypeDefinitionIndex)->GetStaticField(0x3548);
		}
