...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__121_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AD57F20)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__121_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD582F0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__121_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD58350)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__121_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AD58300)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__121_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD57EA0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__121__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD57E90)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__121___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x1AD57EF0)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___StartWhenDone_d__121_TypeDefinitionIndex = 7836;
	...
	public:
		...
		::Foundation::Coroutine::CoroutineHandle handle; // 0x28
