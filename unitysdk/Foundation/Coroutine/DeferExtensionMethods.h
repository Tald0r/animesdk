...
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS_CANCELWITH_1_OFFSET UNITYSDK_OFFSET(0x1A98D5B0)
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS_CANCELWITH_2_OFFSET UNITYSDK_OFFSET(0x1A98D660)
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS_CANCELWITH_OFFSET UNITYSDK_OFFSET(0x1A98D500)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int DeferExtensionMethods_TypeDefinitionIndex = 8272;
