...
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS_CANCELWITH_1_OFFSET UNITYSDK_OFFSET(0x1AEB5830)
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS_CANCELWITH_2_OFFSET UNITYSDK_OFFSET(0x1AEB58E0)
#define FOUNDATION_COROUTINE_DEFEREXTENSIONMETHODS_CANCELWITH_OFFSET UNITYSDK_OFFSET(0x1AEB5780)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int DeferExtensionMethods_TypeDefinitionIndex = 7975;
