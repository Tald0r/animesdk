...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__125_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A7D6AD0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__125_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7D6C30)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__125_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7D6C90)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__125_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A7D6C40)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__125_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7D6AC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__125__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D6AB0)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___StartWhenDone_d__125_TypeDefinitionIndex = 7887;

	class CoroutineManager___StartWhenDone_d__125 : public ::System::Object
	{
	public:
		::UnityEngine::WWW* www; // 0x10
		::Foundation::Coroutine::CoroutineManager___c__DisplayClass125_0* __8__1; // 0x18
		::System::Collections::Generic::IEnumerator_1<::System::Single>* pausedProc; // 0x20
