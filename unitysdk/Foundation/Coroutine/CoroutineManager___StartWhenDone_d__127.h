...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__127_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A7D6CE0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__127_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_SINGLE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7D6E20)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__127_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7D6E80)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__127_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A7D6E30)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__127_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7D6CD0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER___STARTWHENDONE_D__127__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D6CC0)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager___StartWhenDone_d__127_TypeDefinitionIndex = 7883;
