...
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x941310)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x9412A0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x941320)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x941410)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_GET_KEY_OFFSET UNITYSDK_OFFSET(0x941190)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_KILLCOROUTINE_OFFSET UNITYSDK_OFFSET(0x941390)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A7D63A0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A7D6410)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_TOCOUTINEID_OFFSET UNITYSDK_OFFSET(0x941230)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7D64E0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9411A0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x941420)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x941460)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineHandle_TypeDefinitionIndex = 7963;

	struct alignas(4) CoroutineHandle
	{
		static ::Il2CppArray<::System::Int32>** StaticGet_NextIndex()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(CoroutineHandle_TypeDefinitionIndex)->GetStaticField(0x6840);
		}
		static ::Foundation::Coroutine::CoroutineHandle* StaticGet_Empty()
		{
			return (::Foundation::Coroutine::CoroutineHandle*)Il2CppClass::FromTypeDefinitionIndex(CoroutineHandle_TypeDefinitionIndex)->GetStaticField(0x3560);
		}
