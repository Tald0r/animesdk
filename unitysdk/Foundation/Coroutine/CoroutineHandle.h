...
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x96E450)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x96E3E0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96E460)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x96E550)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_GET_KEY_OFFSET UNITYSDK_OFFSET(0x96E2D0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_KILLCOROUTINE_OFFSET UNITYSDK_OFFSET(0x96E4D0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AD57C70)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AD57CE0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE_TOCOUTINEID_OFFSET UNITYSDK_OFFSET(0x96E370)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD57DB0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x302300)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x96E2E0)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x96E560)
#define FOUNDATION_COROUTINE_COROUTINEHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x96E5A0)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineHandle_TypeDefinitionIndex = 8277;

	struct alignas(4) CoroutineHandle
	{
		static ::Il2CppArray<::System::Int32>** StaticGet_NextIndex()
		{
			return (::Il2CppArray<::System::Int32>**)Il2CppClass::FromTypeDefinitionIndex(CoroutineHandle_TypeDefinitionIndex)->GetStaticField(0x6860);
		}
