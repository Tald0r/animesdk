...
#define FOUNDATION_COROUTINE_DEFER_DEFERFRAMESINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AEE1DD0)
#define FOUNDATION_COROUTINE_DEFER_DEFERSECONDSINTERNAL_OFFSET UNITYSDK_OFFSET(0x1AEE1FD0)
#define FOUNDATION_COROUTINE_DEFER_FRAMES_OFFSET UNITYSDK_OFFSET(0x1AEE1C80)
#define FOUNDATION_COROUTINE_DEFER_RUNCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1AEE2080)
#define FOUNDATION_COROUTINE_DEFER_SECONDS_OFFSET UNITYSDK_OFFSET(0x1AEE1E70)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int Defer_TypeDefinitionIndex = 7980;
