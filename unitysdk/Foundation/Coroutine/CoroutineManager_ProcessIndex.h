...
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8F8FC0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX_EQUALS_OFFSET UNITYSDK_OFFSET(0x8F8F40)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F8FD0)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A023D80)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1A023E00)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8F9040)
#define FOUNDATION_COROUTINE_COROUTINEMANAGER_PROCESSINDEX___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8F9080)

namespace Foundation::Coroutine
{
	inline static constexpr unsigned int CoroutineManager_ProcessIndex_TypeDefinitionIndex = 7848;
