...
#define FOUNDATION_PARALLELFILEVERIFIER_ABORT_OFFSET UNITYSDK_OFFSET(0x9C6CE50)
#define FOUNDATION_PARALLELFILEVERIFIER_ADDFINISHRESULT_OFFSET UNITYSDK_OFFSET(0x5F95860)
#define FOUNDATION_PARALLELFILEVERIFIER_CHECKFINISHRESULTTASK_OFFSET UNITYSDK_OFFSET(0x9C69C90)
#define FOUNDATION_PARALLELFILEVERIFIER_CHECKFINISHRESULT_OFFSET UNITYSDK_OFFSET(0x9C6A370)
#define FOUNDATION_PARALLELFILEVERIFIER_CHECKHASHFINISH_OFFSET UNITYSDK_OFFSET(0x9C6D0D0)
#define FOUNDATION_PARALLELFILEVERIFIER_CREATEFASTCHECKTASK_OFFSET UNITYSDK_OFFSET(0x9C6AB90)
#define FOUNDATION_PARALLELFILEVERIFIER_DONEXTSTEP_OFFSET UNITYSDK_OFFSET(0x9C6CC10)
#define FOUNDATION_PARALLELFILEVERIFIER_DOSLICE_CHECKFINISHRESULT_OFFSET UNITYSDK_OFFSET(0x9C69AB0)
#define FOUNDATION_PARALLELFILEVERIFIER_DOSLICE_PREFASTCHECK_OFFSET UNITYSDK_OFFSET(0x9C6A8C0)
#define FOUNDATION_PARALLELFILEVERIFIER_DUMP_OFFSET UNITYSDK_OFFSET(0x9C6C040)
#define FOUNDATION_PARALLELFILEVERIFIER_FILEHASHCHECK_OFFSET UNITYSDK_OFFSET(0x9C6CCE0)
#define FOUNDATION_PARALLELFILEVERIFIER_FINISHSTEP_OFFSET UNITYSDK_OFFSET(0x9C6C7F0)
#define FOUNDATION_PARALLELFILEVERIFIER_FINISH_OFFSET UNITYSDK_OFFSET(0x5F956C0)
#define FOUNDATION_PARALLELFILEVERIFIER_GETFILECHECKRESULT_OFFSET UNITYSDK_OFFSET(0x9C6AEE0)
#define FOUNDATION_PARALLELFILEVERIFIER_GETPARALLELHASHTASK_OFFSET UNITYSDK_OFFSET(0x9C6B730)
#define FOUNDATION_PARALLELFILEVERIFIER_ISFASTCHECKFAILED_OFFSET UNITYSDK_OFFSET(0x9C6B660)
#define FOUNDATION_PARALLELFILEVERIFIER_ISSKIPCHECK_OFFSET UNITYSDK_OFFSET(0x9C6B4F0)
#define FOUNDATION_PARALLELFILEVERIFIER_ONFILETASKFINISH_OFFSET UNITYSDK_OFFSET(0x9C6CF20)
#define FOUNDATION_PARALLELFILEVERIFIER_PREFASTCHECK_OFFSET UNITYSDK_OFFSET(0x9C6BA40)
#define FOUNDATION_PARALLELFILEVERIFIER_REGISTERSTATE_OFFSET UNITYSDK_OFFSET(0x9C6CA40)
#define FOUNDATION_PARALLELFILEVERIFIER_SETVERIFYRESULT_OFFSET UNITYSDK_OFFSET(0x9C69FC0)
#define FOUNDATION_PARALLELFILEVERIFIER_START_OFFSET UNITYSDK_OFFSET(0x9C6C3A0)
#define FOUNDATION_PARALLELFILEVERIFIER_UPDATE_OFFSET UNITYSDK_OFFSET(0x9C6CAC0)
#define FOUNDATION_PARALLELFILEVERIFIER__CTOR_OFFSET UNITYSDK_OFFSET(0x5F959B0)

namespace Foundation
{
	inline static constexpr unsigned int ParallelFileVerifier_TypeDefinitionIndex = 73080;

	class ParallelFileVerifier : public ::System::Object
	{
	public:
		::System::Collections::Generic::List_1<::Struct_2_DAA84C1CDD754F37>* _checkFiles; // 0x10
		::System::Collections::Generic::List_1<::Foundation::IFileHashTask*>* _FileHashCheckList; // 0x18
		...
		::System::Collections::Generic::Queue_1<::System::Action*>* sliceQueueTask; // 0x30
		...
		::Class_1_AB5D161F6D5522E7* timeSlice; // 0x48
		::System::Diagnostics::Stopwatch* sw; // 0x50
		::System::Collections::Generic::List_1<::Foundation::ExceptionInfo*>* errorList; // 0x58
		::System::Collections::Generic::List_1<::Struct_2_DAA84C1CDD754F37>* _badFiles; // 0x60
		::System::Collections::Concurrent::ConcurrentQueue_1<::Foundation::ParallelFileVerifier_FileInfoCheckResult*>* _finishResultList; // 0x68
		::Foundation::ParallelFileHash* _parallelFileHash; // 0x70
