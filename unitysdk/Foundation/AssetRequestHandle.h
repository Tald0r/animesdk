...
#define FOUNDATION_ASSETREQUESTHANDLE_ADDCOMPLETECALLBACKWITHUSERDATA_OFFSET UNITYSDK_OFFSET(0x8AF930)
#define FOUNDATION_ASSETREQUESTHANDLE_ADDCOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x8AF890)
#define FOUNDATION_ASSETREQUESTHANDLE_ADDDESTROYCALLBACK_OFFSET UNITYSDK_OFFSET(0x8AFB10)
#define FOUNDATION_ASSETREQUESTHANDLE_ADDPOOLINSTANCE_OFFSET UNITYSDK_OFFSET(0x8B02A0)
#define FOUNDATION_ASSETREQUESTHANDLE_ADDREFERENCE_OFFSET UNITYSDK_OFFSET(0x8B0700)
#define FOUNDATION_ASSETREQUESTHANDLE_CLEARINSTANCES_OFFSET UNITYSDK_OFFSET(0x8B0180)
#define FOUNDATION_ASSETREQUESTHANDLE_CLEARPOOLINSTANCES_OFFSET UNITYSDK_OFFSET(0x8B0340)
#define FOUNDATION_ASSETREQUESTHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8AF490)
#define FOUNDATION_ASSETREQUESTHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8AF400)
#define FOUNDATION_ASSETREQUESTHANDLE_ERROR_OFFSET UNITYSDK_OFFSET(0x8AFCE0)
#define FOUNDATION_ASSETREQUESTHANDLE_GENERATE_OFFSET UNITYSDK_OFFSET(0x1975F630)
#define FOUNDATION_ASSETREQUESTHANDLE_GETASSETINSTANCEREQUEST_OFFSET UNITYSDK_OFFSET(0x8AF880)
#define FOUNDATION_ASSETREQUESTHANDLE_GETASSETREQUEST_OFFSET UNITYSDK_OFFSET(0x8AF870)
#define FOUNDATION_ASSETREQUESTHANDLE_GETASSET_OFFSET UNITYSDK_OFFSET(0x8AFD60)
#define FOUNDATION_ASSETREQUESTHANDLE_GETCHECKERLOADSTACK_OFFSET UNITYSDK_OFFSET(0x8B06C0)
#define FOUNDATION_ASSETREQUESTHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8AF390)
#define FOUNDATION_ASSETREQUESTHANDLE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x8B0080)
#define FOUNDATION_ASSETREQUESTHANDLE_GETINSTANCESCOUNT_OFFSET UNITYSDK_OFFSET(0x8B0210)
#define FOUNDATION_ASSETREQUESTHANDLE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x8AFF80)
#define FOUNDATION_ASSETREQUESTHANDLE_GETPOOLINSTANCESCOUNT_OFFSET UNITYSDK_OFFSET(0x8B03D0)
#define FOUNDATION_ASSETREQUESTHANDLE_GETSTATUS_OFFSET UNITYSDK_OFFSET(0x8AFE70)
#define FOUNDATION_ASSETREQUESTHANDLE_ISDONE_OFFSET UNITYSDK_OFFSET(0x8AFDE0)
#define FOUNDATION_ASSETREQUESTHANDLE_ISUNUSED_OFFSET UNITYSDK_OFFSET(0x8B0590)
#define FOUNDATION_ASSETREQUESTHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x8AF660)
#define FOUNDATION_ASSETREQUESTHANDLE_LOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x8AFEF0)
#define FOUNDATION_ASSETREQUESTHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1975F920)
#define FOUNDATION_ASSETREQUESTHANDLE_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1975FDF0)
#define FOUNDATION_ASSETREQUESTHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1975F9B0)
#define FOUNDATION_ASSETREQUESTHANDLE_RELEASECALLBACKNOTUNLOAD_OFFSET UNITYSDK_OFFSET(0x8AF720)
#define FOUNDATION_ASSETREQUESTHANDLE_REMOVECOMPLETECALLBACK_1_OFFSET UNITYSDK_OFFSET(0x8AFA80)
#define FOUNDATION_ASSETREQUESTHANDLE_REMOVECOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x8AF9E0)
#define FOUNDATION_ASSETREQUESTHANDLE_REMOVEDESTROYCALLBACK_1_OFFSET UNITYSDK_OFFSET(0x8AFC50)
#define FOUNDATION_ASSETREQUESTHANDLE_REMOVEDESTROYCALLBACK_OFFSET UNITYSDK_OFFSET(0x8AFBB0)
#define FOUNDATION_ASSETREQUESTHANDLE_SCENENAME_OFFSET UNITYSDK_OFFSET(0x8B0620)
#define FOUNDATION_ASSETREQUESTHANDLE_SETUNLOADSCENECOMPLETED_OFFSET UNITYSDK_OFFSET(0x8B0460)
#define FOUNDATION_ASSETREQUESTHANDLE_SUBREFERENCE_OFFSET UNITYSDK_OFFSET(0x8B0720)
#define FOUNDATION_ASSETREQUESTHANDLE_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x8AF5E0)
#define FOUNDATION_ASSETREQUESTHANDLE_SYSTEM_COLLECTIONS_IENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x8AF5F0)
#define FOUNDATION_ASSETREQUESTHANDLE_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x8AF600)
#define FOUNDATION_ASSETREQUESTHANDLE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8AF530)
#define FOUNDATION_ASSETREQUESTHANDLE_TRYGETASSETREQUEST_OFFSET UNITYSDK_OFFSET(0x8AF7E0)
#define FOUNDATION_ASSETREQUESTHANDLE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x8AF670)
#define FOUNDATION_ASSETREQUESTHANDLE_URL_OFFSET UNITYSDK_OFFSET(0x8B0500)
#define FOUNDATION_ASSETREQUESTHANDLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x197615C0)
#define FOUNDATION_ASSETREQUESTHANDLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8B06D0)
#define FOUNDATION_ASSETREQUESTHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x8AF360)
#define FOUNDATION_ASSETREQUESTHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8B0730)
#define FOUNDATION_ASSETREQUESTHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8B0780)
#define FOUNDATION_ASSETREQUESTHANDLE___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8B07C0)

namespace Foundation
{
	inline static constexpr unsigned int AssetRequestHandle_TypeDefinitionIndex = 7863;

	struct alignas(8) AssetRequestHandle
	{
		static ::Foundation::AssetRequestHandle* StaticGet_None()
		{
			return (::Foundation::AssetRequestHandle*)Il2CppClass::FromTypeDefinitionIndex(AssetRequestHandle_TypeDefinitionIndex)->GetStaticField(0x6780);
		}
