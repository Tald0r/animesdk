...
#define FOUNDATION_ASSETREQUESTBASE_ADDCOMPLETECALLBACKWITHUSERDATA_OFFSET UNITYSDK_OFFSET(0x1AD54A30)
#define FOUNDATION_ASSETREQUESTBASE_ADDCOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x1AD54710)
#define FOUNDATION_ASSETREQUESTBASE_ADDDESTROYCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AD55740)
#define FOUNDATION_ASSETREQUESTBASE_ADDPOOLINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AD56200)
#define FOUNDATION_ASSETREQUESTBASE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1AD54270)
#define FOUNDATION_ASSETREQUESTBASE_CHECKUSEDINSTANCES_OFFSET UNITYSDK_OFFSET(0x1AD56190)
#define FOUNDATION_ASSETREQUESTBASE_CLEARINSTANCES_OFFSET UNITYSDK_OFFSET(0x1AD560D0)
#define FOUNDATION_ASSETREQUESTBASE_CLEARPOOLINSTANCES_OFFSET UNITYSDK_OFFSET(0x1AD56270)
#define FOUNDATION_ASSETREQUESTBASE_GETDEPENDENCIES_OFFSET UNITYSDK_OFFSET(0x1AD54520)
#define FOUNDATION_ASSETREQUESTBASE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x1AD56000)
#define FOUNDATION_ASSETREQUESTBASE_GETINSTANCESCOUNT_OFFSET UNITYSDK_OFFSET(0x1AD56130)
#define FOUNDATION_ASSETREQUESTBASE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x1AD55F80)
#define FOUNDATION_ASSETREQUESTBASE_GETPOOLINSTANCESCOUNT_OFFSET UNITYSDK_OFFSET(0x1AD562D0)
#define FOUNDATION_ASSETREQUESTBASE_GET_ASSETTYPE_OFFSET UNITYSDK_OFFSET(0x1AD545C0)
#define FOUNDATION_ASSETREQUESTBASE_GET_ASSET_OFFSET UNITYSDK_OFFSET(0x1AD545A0)
#define FOUNDATION_ASSETREQUESTBASE_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AD55F70)
#define FOUNDATION_ASSETREQUESTBASE_GET_DESTROYIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x1AD54580)
#define FOUNDATION_ASSETREQUESTBASE_GET_ERROR_OFFSET UNITYSDK_OFFSET(0x1AD546D0)
#define FOUNDATION_ASSETREQUESTBASE_GET_ISDESTROYED_OFFSET UNITYSDK_OFFSET(0x1AD54700)
#define FOUNDATION_ASSETREQUESTBASE_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x1AD541E0)
#define FOUNDATION_ASSETREQUESTBASE_GET_ISRUNNING_OFFSET UNITYSDK_OFFSET(0x1AD546F0)
#define FOUNDATION_ASSETREQUESTBASE_GET_LOADINGPERCENT_OFFSET UNITYSDK_OFFSET(0x1AD54620)
#define FOUNDATION_ASSETREQUESTBASE_GET_PROGRESS_OFFSET UNITYSDK_OFFSET(0x1AD54630)
#define FOUNDATION_ASSETREQUESTBASE_GET_REFCOUNT_OFFSET UNITYSDK_OFFSET(0x1AD55CD0)
#define FOUNDATION_ASSETREQUESTBASE_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x1AD546C0)
#define FOUNDATION_ASSETREQUESTBASE_GET_URL_OFFSET UNITYSDK_OFFSET(0x1AD545E0)
#define FOUNDATION_ASSETREQUESTBASE_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AD54600)
#define FOUNDATION_ASSETREQUESTBASE_INVOKECOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x1AD530A0)
#define FOUNDATION_ASSETREQUESTBASE_INVOKEDESTROYCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AD526D0)
#define FOUNDATION_ASSETREQUESTBASE_ISUNUSED_OFFSET UNITYSDK_OFFSET(0x1AD55E30)
#define FOUNDATION_ASSETREQUESTBASE_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AD55EA0)
#define FOUNDATION_ASSETREQUESTBASE_ONCOMPLETE_OFFSET UNITYSDK_OFFSET(0x1AD53030)
#define FOUNDATION_ASSETREQUESTBASE_ONUNUSED_OFFSET UNITYSDK_OFFSET(0x1AD540B0)
#define FOUNDATION_ASSETREQUESTBASE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1AD55D70)
#define FOUNDATION_ASSETREQUESTBASE_REMOVEALLCOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x1AD54F20)
#define FOUNDATION_ASSETREQUESTBASE_REMOVECOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x1AD554D0)
#define FOUNDATION_ASSETREQUESTBASE_REMOVEDESTROYCALLBACK_OFFSET UNITYSDK_OFFSET(0x1AD55AA0)
#define FOUNDATION_ASSETREQUESTBASE_RESET_OFFSET UNITYSDK_OFFSET(0x1AD55F10)
#define FOUNDATION_ASSETREQUESTBASE_RETAIN_OFFSET UNITYSDK_OFFSET(0x1AD55CF0)
#define FOUNDATION_ASSETREQUESTBASE_SET_ASSETTYPE_OFFSET UNITYSDK_OFFSET(0x1AD545D0)
#define FOUNDATION_ASSETREQUESTBASE_SET_ASSET_OFFSET UNITYSDK_OFFSET(0x1AD545B0)
#define FOUNDATION_ASSETREQUESTBASE_SET_DESTROYIMMEDIATELY_OFFSET UNITYSDK_OFFSET(0x1AD54590)
#define FOUNDATION_ASSETREQUESTBASE_SET_ERROR_OFFSET UNITYSDK_OFFSET(0x1AD546E0)
#define FOUNDATION_ASSETREQUESTBASE_SET_REFCOUNT_OFFSET UNITYSDK_OFFSET(0x1AD55CE0)
#define FOUNDATION_ASSETREQUESTBASE_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x1AD52F10)
#define FOUNDATION_ASSETREQUESTBASE_SET_URL_OFFSET UNITYSDK_OFFSET(0x1AD545F0)
#define FOUNDATION_ASSETREQUESTBASE_SET_VERSION_OFFSET UNITYSDK_OFFSET(0x1AD54610)
#define FOUNDATION_ASSETREQUESTBASE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1AD522A0)
#define FOUNDATION_ASSETREQUESTBASE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AD541F0)
#define FOUNDATION_ASSETREQUESTBASE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD56330)

namespace Foundation
{
	inline static constexpr unsigned int AssetRequestBase_TypeDefinitionIndex = 7852;

	class AssetRequestBase : public ::System::Object
	{
	public:
		::System::Collections::Generic::Dictionary_2<::Foundation::AssetRequestHandle, ::System::Collections::Generic::List_1<::System::Object*>*>* completeCallbackUserDataDict; // 0x10
		...
		::System::Collections::Generic::Dictionary_2<::Foundation::AssetRequestHandle, ::System::Collections::Generic::List_1<::Foundation::AssetRequestCompleteDel*>*>* completeCallbackDict; // 0x40
		...
		::System::Collections::Generic::Dictionary_2<::Foundation::AssetRequestHandle, ::System::Collections::Generic::List_1<::Foundation::AssetRequestCompleteDelWithUserData*>*>* completeCallbackWithUserDataDict; // 0x50
		::Foundation::Coroutine::CoroutineHandle completeCallbackHandle; // 0x58
		::Foundation::AssetRequestStatus statusCode; // 0x5C
		::System::Int32 _RefCount_k__BackingField; // 0x60
		::Foundation::Coroutine::CoroutineHandle destroyCallbackHandle; // 0x64
		::System::Int32 _Version_k__BackingField; // 0x68
		::System::Boolean _DestroyImmediately_k__BackingField; // 0x6C
