...
#define FOUNDATION_TICKCONTEXT_GET_TICKINGTIME_OFFSET UNITYSDK_OFFSET(0x2D8720)
#define FOUNDATION_TICKCONTEXT_GET_TIME_OFFSET UNITYSDK_OFFSET(0x2D8730)
#define FOUNDATION_TICKCONTEXT_PASS_OFFSET UNITYSDK_OFFSET(0x1AA8CAF0)
#define FOUNDATION_TICKCONTEXT_SET_TICKINGTIME_OFFSET UNITYSDK_OFFSET(0x951700)
#define FOUNDATION_TICKCONTEXT_SET_TIME_OFFSET UNITYSDK_OFFSET(0x9516E0)

namespace Foundation
{
	inline static constexpr unsigned int TickContext_TypeDefinitionIndex = 9071;
