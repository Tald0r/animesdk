...
#define FOUNDATION_TICKCONTEXT_GET_TICKINGTIME_OFFSET UNITYSDK_OFFSET(0x322CD0)
#define FOUNDATION_TICKCONTEXT_GET_TIME_OFFSET UNITYSDK_OFFSET(0x322CC0)
#define FOUNDATION_TICKCONTEXT_PASS_OFFSET UNITYSDK_OFFSET(0x1B0DE950)
#define FOUNDATION_TICKCONTEXT_SET_TICKINGTIME_OFFSET UNITYSDK_OFFSET(0x9872D0)
#define FOUNDATION_TICKCONTEXT_SET_TIME_OFFSET UNITYSDK_OFFSET(0x9872B0)

namespace Foundation
{
	inline static constexpr unsigned int TickContext_TypeDefinitionIndex = 8858;
