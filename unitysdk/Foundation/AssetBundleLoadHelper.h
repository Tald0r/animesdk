...
#define FOUNDATION_ASSETBUNDLELOADHELPER_GETASSETBUNDLEFILEPATH_OFFSET UNITYSDK_OFFSET(0x1B17CC20)
#define FOUNDATION_ASSETBUNDLELOADHELPER_GETBUNDLELOG_OFFSET UNITYSDK_OFFSET(0x1B17C810)
#define FOUNDATION_ASSETBUNDLELOADHELPER_LOADASSETASYNC_OFFSET UNITYSDK_OFFSET(0x1B17CE20)
#define FOUNDATION_ASSETBUNDLELOADHELPER_LOADASSET_OFFSET UNITYSDK_OFFSET(0x1B17CCC0)
#define FOUNDATION_ASSETBUNDLELOADHELPER_LOADFROMFILEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1B17C990)
#define FOUNDATION_ASSETBUNDLELOADHELPER_LOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0x1B17C880)
#define FOUNDATION_ASSETBUNDLELOADHELPER_LOADFROMFILE_1_OFFSET UNITYSDK_OFFSET(0x1B17CB60)
#define FOUNDATION_ASSETBUNDLELOADHELPER_LOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x1B17CA50)

namespace Foundation
{
	inline static constexpr unsigned int AssetBundleLoadHelper_TypeDefinitionIndex = 8019;
