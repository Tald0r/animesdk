...
#define FOUNDATION_ASSETBUNDLELOADHELPER_GETASSETBUNDLEFILEPATH_OFFSET UNITYSDK_OFFSET(0x1A9AA6D0)
#define FOUNDATION_ASSETBUNDLELOADHELPER_GETBUNDLELOG_OFFSET UNITYSDK_OFFSET(0x1A9AA2C0)
#define FOUNDATION_ASSETBUNDLELOADHELPER_LOADASSETASYNC_OFFSET UNITYSDK_OFFSET(0x1A9AA8D0)
#define FOUNDATION_ASSETBUNDLELOADHELPER_LOADASSET_OFFSET UNITYSDK_OFFSET(0x1A9AA770)
#define FOUNDATION_ASSETBUNDLELOADHELPER_LOADFROMFILEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A9AA440)
#define FOUNDATION_ASSETBUNDLELOADHELPER_LOADFROMFILEASYNC_OFFSET UNITYSDK_OFFSET(0x1A9AA330)
#define FOUNDATION_ASSETBUNDLELOADHELPER_LOADFROMFILE_1_OFFSET UNITYSDK_OFFSET(0x1A9AA610)
#define FOUNDATION_ASSETBUNDLELOADHELPER_LOADFROMFILE_OFFSET UNITYSDK_OFFSET(0x1A9AA500)

namespace Foundation
{
	inline static constexpr unsigned int AssetBundleLoadHelper_TypeDefinitionIndex = 7782;
