...
#define FOUNDATION_LAYERMASKX_ADDTOMASK_OFFSET UNITYSDK_OFFSET(0x1A991D10)
#define FOUNDATION_LAYERMASKX_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1A991930)
#define FOUNDATION_LAYERMASKX_CREATE_OFFSET UNITYSDK_OFFSET(0x1A991800)
#define FOUNDATION_LAYERMASKX_INVERSE_OFFSET UNITYSDK_OFFSET(0x1A991CB0)
#define FOUNDATION_LAYERMASKX_ISINLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1A992120)
#define FOUNDATION_LAYERMASKX_LAYERNUMBERSTOMASK_OFFSET UNITYSDK_OFFSET(0x1A991B10)
#define FOUNDATION_LAYERMASKX_MASKTONAMES_OFFSET UNITYSDK_OFFSET(0x1A991DF0)
#define FOUNDATION_LAYERMASKX_MASKTOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1A992070)
#define FOUNDATION_LAYERMASKX_MASKTOSTRING_OFFSET UNITYSDK_OFFSET(0x1A991F60)
#define FOUNDATION_LAYERMASKX_NAMESTOMASK_OFFSET UNITYSDK_OFFSET(0x1A991870)
#define FOUNDATION_LAYERMASKX_REMOVEFROMMASK_OFFSET UNITYSDK_OFFSET(0x1A991D80)

namespace Foundation
{
	inline static constexpr unsigned int LayerMaskX_TypeDefinitionIndex = 7822;
