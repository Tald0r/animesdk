...
#define FOUNDATION_LAYERMASKX_ADDTOMASK_OFFSET UNITYSDK_OFFSET(0x1AEB9F80)
#define FOUNDATION_LAYERMASKX_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1AEB9BA0)
#define FOUNDATION_LAYERMASKX_CREATE_OFFSET UNITYSDK_OFFSET(0x1AEB9A70)
#define FOUNDATION_LAYERMASKX_INVERSE_OFFSET UNITYSDK_OFFSET(0x1AEB9F20)
#define FOUNDATION_LAYERMASKX_ISINLAYERMASK_OFFSET UNITYSDK_OFFSET(0x1AEBA390)
#define FOUNDATION_LAYERMASKX_LAYERNUMBERSTOMASK_OFFSET UNITYSDK_OFFSET(0x1AEB9D80)
#define FOUNDATION_LAYERMASKX_MASKTONAMES_OFFSET UNITYSDK_OFFSET(0x1AEBA060)
#define FOUNDATION_LAYERMASKX_MASKTOSTRING_1_OFFSET UNITYSDK_OFFSET(0x1AEBA2E0)
#define FOUNDATION_LAYERMASKX_MASKTOSTRING_OFFSET UNITYSDK_OFFSET(0x1AEBA1D0)
#define FOUNDATION_LAYERMASKX_NAMESTOMASK_OFFSET UNITYSDK_OFFSET(0x1AEB9AE0)
#define FOUNDATION_LAYERMASKX_REMOVEFROMMASK_OFFSET UNITYSDK_OFFSET(0x1AEB9FF0)

namespace Foundation
{
	inline static constexpr unsigned int LayerMaskX_TypeDefinitionIndex = 8121;
