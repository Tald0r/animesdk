...
#define FOUNDATION_DUALQUATERNION_CONJUGATE_OFFSET UNITYSDK_OFFSET(0x1AE76C30)
#define FOUNDATION_DUALQUATERNION_DIAGNOSTICCHECK_ALL_OFFSET UNITYSDK_OFFSET(0x968F10)
#define FOUNDATION_DUALQUATERNION_DIAGNOSTICCHECK_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x968F10)
#define FOUNDATION_DUALQUATERNION_DIAGNOSTICCHECK_ROTATION_OFFSET UNITYSDK_OFFSET(0x259A50)
#define FOUNDATION_DUALQUATERNION_DIAGNOSTICCHECK_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x259A50)
#define FOUNDATION_DUALQUATERNION_GET_DUAL_OFFSET UNITYSDK_OFFSET(0x44C6D0)
#define FOUNDATION_DUALQUATERNION_GET_NORMALIZED_OFFSET UNITYSDK_OFFSET(0x968270)
#define FOUNDATION_DUALQUATERNION_GET_REAL_OFFSET UNITYSDK_OFFSET(0x2CA610)
#define FOUNDATION_DUALQUATERNION_GET_ROTATION_OFFSET UNITYSDK_OFFSET(0x2CA610)
#define FOUNDATION_DUALQUATERNION_GET_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x968140)
#define FOUNDATION_DUALQUATERNION_INVERSETRANSFORMPOSITION_OFFSET UNITYSDK_OFFSET(0x9687F0)
#define FOUNDATION_DUALQUATERNION_MAGNITUDE_OFFSET UNITYSDK_OFFSET(0x1AE76BD0)
#define FOUNDATION_DUALQUATERNION_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1AE76B20)
#define FOUNDATION_DUALQUATERNION_NEGATE_OFFSET UNITYSDK_OFFSET(0x1AE76C10)
#define FOUNDATION_DUALQUATERNION_NEW_OFFSET UNITYSDK_OFFSET(0x1AE76960)
#define FOUNDATION_DUALQUATERNION_PLUS_OFFSET UNITYSDK_OFFSET(0x1AE76AE0)
#define FOUNDATION_DUALQUATERNION_SCALE_OFFSET UNITYSDK_OFFSET(0x1AE76B00)
#define FOUNDATION_DUALQUATERNION_TRANSFORMPOSITION_OFFSET UNITYSDK_OFFSET(0x9683D0)
#define FOUNDATION_DUALQUATERNION_TRANSFORMVECTOR_OFFSET UNITYSDK_OFFSET(0x968C10)
#define FOUNDATION_DUALQUATERNION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AE76FE0)

namespace Foundation
{
	inline static constexpr unsigned int DualQuaternion_TypeDefinitionIndex = 8886;

	struct alignas(4) DualQuaternion
	{
		static ::Foundation::DualQuaternion* StaticGet_Identity()
		{
			return (::Foundation::DualQuaternion*)Il2CppClass::FromTypeDefinitionIndex(DualQuaternion_TypeDefinitionIndex)->GetStaticField(0x3EB0);
		}
