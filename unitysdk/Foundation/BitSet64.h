...
#define FOUNDATION_BITSET64_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9403B0)
#define FOUNDATION_BITSET64_EQUALS_OFFSET UNITYSDK_OFFSET(0x940340)
#define FOUNDATION_BITSET64_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7B3E80)
#define FOUNDATION_BITSET64_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x2C3A90)
#define FOUNDATION_BITSET64_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x9401D0)
#define FOUNDATION_BITSET64_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x1A792E50)
#define FOUNDATION_BITSET64_OP_BITWISEOR_OFFSET UNITYSDK_OFFSET(0x1A792E40)
#define FOUNDATION_BITSET64_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1A792E60)
#define FOUNDATION_BITSET64_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x9401E0)
#define FOUNDATION_BITSET64__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A792F80)
#define FOUNDATION_BITSET64__CTOR_1_OFFSET UNITYSDK_OFFSET(0x940200)
#define FOUNDATION_BITSET64__CTOR_OFFSET UNITYSDK_OFFSET(0x2C3980)

namespace Foundation
{
	inline static constexpr unsigned int BitSet64_TypeDefinitionIndex = 8972;

	struct alignas(8) BitSet64
	{
		static ::Foundation::BitSet64* StaticGet_Full()
		{
			return (::Foundation::BitSet64*)Il2CppClass::FromTypeDefinitionIndex(BitSet64_TypeDefinitionIndex)->GetStaticField(0x3CB0);
		}
		static ::Foundation::BitSet64* StaticGet_Empty()
		{
			return (::Foundation::BitSet64*)Il2CppClass::FromTypeDefinitionIndex(BitSet64_TypeDefinitionIndex)->GetStaticField(0x3CB8);
		}
