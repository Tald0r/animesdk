...
#define FOUNDATION_BITSET64_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x96EED0)
#define FOUNDATION_BITSET64_EQUALS_OFFSET UNITYSDK_OFFSET(0x96EE60)
#define FOUNDATION_BITSET64_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7E9CB0)
#define FOUNDATION_BITSET64_GET_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x314B50)
#define FOUNDATION_BITSET64_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x96ECF0)
#define FOUNDATION_BITSET64_OP_BITWISEAND_OFFSET UNITYSDK_OFFSET(0x1AD75C70)
#define FOUNDATION_BITSET64_OP_BITWISEOR_OFFSET UNITYSDK_OFFSET(0x1AD75C60)
#define FOUNDATION_BITSET64_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AD75C80)
#define FOUNDATION_BITSET64_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x96ED00)
#define FOUNDATION_BITSET64__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD75DA0)
#define FOUNDATION_BITSET64__CTOR_1_OFFSET UNITYSDK_OFFSET(0x96ED20)
#define FOUNDATION_BITSET64__CTOR_OFFSET UNITYSDK_OFFSET(0x3074E0)

namespace Foundation
{
	inline static constexpr unsigned int BitSet64_TypeDefinitionIndex = 8798;

	struct alignas(8) BitSet64
	{
		static ::Foundation::BitSet64* StaticGet_Empty()
		{
			return (::Foundation::BitSet64*)Il2CppClass::FromTypeDefinitionIndex(BitSet64_TypeDefinitionIndex)->GetStaticField(0x3CD0);
		}
		static ::Foundation::BitSet64* StaticGet_Full()
		{
			return (::Foundation::BitSet64*)Il2CppClass::FromTypeDefinitionIndex(BitSet64_TypeDefinitionIndex)->GetStaticField(0x3CD8);
		}
