...
#define FOUNDATION_CONFIGINFOGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABC2C50)

namespace Foundation
{
	inline static constexpr unsigned int ConfigInfoGroup_TypeDefinitionIndex = 8283;
