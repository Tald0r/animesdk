...
#define FOUNDATION_CONFIGINFOGROUP__CTOR_OFFSET UNITYSDK_OFFSET(0x1B215A90)

namespace Foundation
{
	inline static constexpr unsigned int ConfigInfoGroup_TypeDefinitionIndex = 8069;
