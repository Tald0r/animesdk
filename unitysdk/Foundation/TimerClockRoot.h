...
#define FOUNDATION_TIMERCLOCKROOT_ADDLISTENERSPEEDCHANGEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1ABB6D10)
#define FOUNDATION_TIMERCLOCKROOT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ABB6E80)
#define FOUNDATION_TIMERCLOCKROOT_GETDELTATIME_OFFSET UNITYSDK_OFFSET(0x1ABB6BF0)
#define FOUNDATION_TIMERCLOCKROOT_GETENGINETIME_OFFSET UNITYSDK_OFFSET(0x1ABB6C70)
#define FOUNDATION_TIMERCLOCKROOT_GET_E_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x1ABB6E60)
#define FOUNDATION_TIMERCLOCKROOT_GET_PARENTTIMERCLOCK_OFFSET UNITYSDK_OFFSET(0x1ABB6D00)
#define FOUNDATION_TIMERCLOCKROOT_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1ABB6CF0)
#define FOUNDATION_TIMERCLOCKROOT_REMOVELISTENERSPEEDCHANGEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1ABB6D80)
#define FOUNDATION_TIMERCLOCKROOT_SETPARENTCLOCK_OFFSET UNITYSDK_OFFSET(0x1ABB6B80)
#define FOUNDATION_TIMERCLOCKROOT_SETSPEED_OFFSET UNITYSDK_OFFSET(0x1ABB6DF0)
#define FOUNDATION_TIMERCLOCKROOT_SET_E_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x1ABB6E70)
#define FOUNDATION_TIMERCLOCKROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABB6EE0)

namespace Foundation
{
	inline static constexpr unsigned int TimerClockRoot_TypeDefinitionIndex = 8042;
