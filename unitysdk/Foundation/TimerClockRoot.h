...
#define FOUNDATION_TIMERCLOCKROOT_ADDLISTENERSPEEDCHANGEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1AEE3C20)
#define FOUNDATION_TIMERCLOCKROOT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AEE3D90)
#define FOUNDATION_TIMERCLOCKROOT_GETDELTATIME_OFFSET UNITYSDK_OFFSET(0x1AEE3B00)
#define FOUNDATION_TIMERCLOCKROOT_GETENGINETIME_OFFSET UNITYSDK_OFFSET(0x1AEE3B80)
#define FOUNDATION_TIMERCLOCKROOT_GET_E_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x1AEE3D70)
#define FOUNDATION_TIMERCLOCKROOT_GET_PARENTTIMERCLOCK_OFFSET UNITYSDK_OFFSET(0x1AEE3C10)
#define FOUNDATION_TIMERCLOCKROOT_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1AEE3C00)
#define FOUNDATION_TIMERCLOCKROOT_REMOVELISTENERSPEEDCHANGEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1AEE3C90)
#define FOUNDATION_TIMERCLOCKROOT_SETPARENTCLOCK_OFFSET UNITYSDK_OFFSET(0x1AEE3A90)
#define FOUNDATION_TIMERCLOCKROOT_SETSPEED_OFFSET UNITYSDK_OFFSET(0x1AEE3D00)
#define FOUNDATION_TIMERCLOCKROOT_SET_E_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x1AEE3D80)
#define FOUNDATION_TIMERCLOCKROOT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEE3DF0)

namespace Foundation
{
	inline static constexpr unsigned int TimerClockRoot_TypeDefinitionIndex = 7728;
