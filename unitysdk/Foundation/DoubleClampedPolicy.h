...
#define FOUNDATION_DOUBLECLAMPEDPOLICY_FOUNDATION_ICLAMPFUNC_SYSTEM_DOUBLE__CLAMP_OFFSET UNITYSDK_OFFSET(0x1A834FA0)
#define FOUNDATION_DOUBLECLAMPEDPOLICY_FOUNDATION_IMAXFUNC_SYSTEM_DOUBLE__MAX_OFFSET UNITYSDK_OFFSET(0x1A835010)
#define FOUNDATION_DOUBLECLAMPEDPOLICY_FOUNDATION_IMINFUNC_SYSTEM_DOUBLE__MIN_OFFSET UNITYSDK_OFFSET(0x1A834FC0)
#define FOUNDATION_DOUBLECLAMPEDPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A835060)
#define FOUNDATION_DOUBLECLAMPEDPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A834F90)

namespace Foundation
{
	inline static constexpr unsigned int DoubleClampedPolicy_TypeDefinitionIndex = 9033;
