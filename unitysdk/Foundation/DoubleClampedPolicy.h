...
#define FOUNDATION_DOUBLECLAMPEDPOLICY_FOUNDATION_ICLAMPFUNC_SYSTEM_DOUBLE__CLAMP_OFFSET UNITYSDK_OFFSET(0x1A204740)
#define FOUNDATION_DOUBLECLAMPEDPOLICY_FOUNDATION_IMAXFUNC_SYSTEM_DOUBLE__MAX_OFFSET UNITYSDK_OFFSET(0x1A2047B0)
#define FOUNDATION_DOUBLECLAMPEDPOLICY_FOUNDATION_IMINFUNC_SYSTEM_DOUBLE__MIN_OFFSET UNITYSDK_OFFSET(0x1A204760)
#define FOUNDATION_DOUBLECLAMPEDPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A204800)
#define FOUNDATION_DOUBLECLAMPEDPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A204730)

namespace Foundation
{
	inline static constexpr unsigned int DoubleClampedPolicy_TypeDefinitionIndex = 9135;
	...
	public:
		...
		{
			return (::Foundation::DoubleClampedPolicy**)Il2CppClass::FromTypeDefinitionIndex(DoubleClampedPolicy_TypeDefinitionIndex)->GetStaticField(0x7CA0);
		}
