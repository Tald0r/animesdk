...
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0xA0BFC00)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_GET_INSTANCEOBJECT_OFFSET UNITYSDK_OFFSET(0xA0BFBE0)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_GET_ISINPOOL_OFFSET UNITYSDK_OFFSET(0xA0BFC50)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_GET_POOL_OFFSET UNITYSDK_OFFSET(0xA0BFC30)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_GET_RESERVEDOBJECTPOOLDATAHANDLE_OFFSET UNITYSDK_OFFSET(0xA0BFBC0)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_GET_VERSION_OFFSET UNITYSDK_OFFSET(0xA0BFC70)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0xA0BFDB0)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_PUSHSELF_OFFSET UNITYSDK_OFFSET(0xA0BFCC0)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_RELEASESELF_OFFSET UNITYSDK_OFFSET(0xA0BFE30)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_SET_HANDLE_OFFSET UNITYSDK_OFFSET(0xA0BFC20)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_SET_INSTANCEOBJECT_OFFSET UNITYSDK_OFFSET(0xA0BFBF0)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_SET_ISINPOOL_OFFSET UNITYSDK_OFFSET(0xA0BFC60)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_SET_POOL_OFFSET UNITYSDK_OFFSET(0xA0BFC40)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA_SET_VERSION_OFFSET UNITYSDK_OFFSET(0xA0BFC80)
#define FOUNDATION_RESERVEDOBJECTPOOL_RESERVEDOBJECTPOOLDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xA0BFC90)

namespace Foundation
{
	inline static constexpr unsigned int ReservedObjectPool_ReservedObjectPoolData_TypeDefinitionIndex = 44183;
