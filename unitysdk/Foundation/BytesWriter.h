...
#define FOUNDATION_BYTESWRITER_WRITEBYTES_1_OFFSET UNITYSDK_OFFSET(0x1AD30750)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_2_OFFSET UNITYSDK_OFFSET(0x1AD30800)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_3_OFFSET UNITYSDK_OFFSET(0x1AD308B0)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_4_OFFSET UNITYSDK_OFFSET(0x1AD30960)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_5_OFFSET UNITYSDK_OFFSET(0x1AD30A10)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_OFFSET UNITYSDK_OFFSET(0x1AD306A0)
#define FOUNDATION_BYTESWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD30AC0)

namespace Foundation
{
	inline static constexpr unsigned int BytesWriter_TypeDefinitionIndex = 8281;
