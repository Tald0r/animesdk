...
#define FOUNDATION_BYTESWRITER_WRITEBYTES_1_OFFSET UNITYSDK_OFFSET(0x1B4339F0)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_2_OFFSET UNITYSDK_OFFSET(0x1B433AA0)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_3_OFFSET UNITYSDK_OFFSET(0x1B433B50)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_4_OFFSET UNITYSDK_OFFSET(0x1B433C00)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_5_OFFSET UNITYSDK_OFFSET(0x1B433CB0)
#define FOUNDATION_BYTESWRITER_WRITEBYTES_OFFSET UNITYSDK_OFFSET(0x1B433940)
#define FOUNDATION_BYTESWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B433D60)

namespace Foundation
{
	inline static constexpr unsigned int BytesWriter_TypeDefinitionIndex = 7801;
