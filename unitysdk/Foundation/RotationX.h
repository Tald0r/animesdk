...
#define FOUNDATION_ROTATIONX_GETCAMERAROTATIONTOTARGET_OFFSET UNITYSDK_OFFSET(0x19384AF0)
#define FOUNDATION_ROTATIONX_LOOKAT_1_OFFSET UNITYSDK_OFFSET(0x19383AF0)
#define FOUNDATION_ROTATIONX_LOOKAT_2_OFFSET UNITYSDK_OFFSET(0x19383C50)
#define FOUNDATION_ROTATIONX_LOOKAT_OFFSET UNITYSDK_OFFSET(0x19383A60)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_X_1_OFFSET UNITYSDK_OFFSET(0x19383650)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_X_OFFSET UNITYSDK_OFFSET(0x19383550)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Y_1_OFFSET UNITYSDK_OFFSET(0x19383800)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Y_OFFSET UNITYSDK_OFFSET(0x19383700)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Z_1_OFFSET UNITYSDK_OFFSET(0x193839B0)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Z_OFFSET UNITYSDK_OFFSET(0x193838B0)
#define FOUNDATION_ROTATIONX_ROTATE_DEGREESPERSECOND_1_OFFSET UNITYSDK_OFFSET(0x19383380)
#define FOUNDATION_ROTATIONX_ROTATE_DEGREESPERSECOND_OFFSET UNITYSDK_OFFSET(0x193832C0)
#define FOUNDATION_ROTATIONX_SLERPWITHREFERENCEUP_OFFSET UNITYSDK_OFFSET(0x19383D20)

namespace Foundation
{
	inline static constexpr unsigned int RotationX_TypeDefinitionIndex = 7850;
