...
#define FOUNDATION_ROTATIONX_GETCAMERAROTATIONTOTARGET_OFFSET UNITYSDK_OFFSET(0x197720B0)
#define FOUNDATION_ROTATIONX_LOOKAT_1_OFFSET UNITYSDK_OFFSET(0x197710B0)
#define FOUNDATION_ROTATIONX_LOOKAT_2_OFFSET UNITYSDK_OFFSET(0x19771210)
#define FOUNDATION_ROTATIONX_LOOKAT_OFFSET UNITYSDK_OFFSET(0x19771020)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_X_1_OFFSET UNITYSDK_OFFSET(0x19770C10)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_X_OFFSET UNITYSDK_OFFSET(0x19770B10)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Y_1_OFFSET UNITYSDK_OFFSET(0x19770DC0)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Y_OFFSET UNITYSDK_OFFSET(0x19770CC0)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Z_1_OFFSET UNITYSDK_OFFSET(0x19770F70)
#define FOUNDATION_ROTATIONX_ROTATEAROUNDAXIS_Z_OFFSET UNITYSDK_OFFSET(0x19770E70)
#define FOUNDATION_ROTATIONX_ROTATE_DEGREESPERSECOND_1_OFFSET UNITYSDK_OFFSET(0x19770940)
#define FOUNDATION_ROTATIONX_ROTATE_DEGREESPERSECOND_OFFSET UNITYSDK_OFFSET(0x19770880)
#define FOUNDATION_ROTATIONX_SLERPWITHREFERENCEUP_OFFSET UNITYSDK_OFFSET(0x197712E0)

namespace Foundation
{
	inline static constexpr unsigned int RotationX_TypeDefinitionIndex = 8311;
