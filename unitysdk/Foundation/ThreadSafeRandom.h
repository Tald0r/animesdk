...
#define FOUNDATION_THREADSAFERANDOM_GET_OFFSET UNITYSDK_OFFSET(0x96F830)
#define FOUNDATION_THREADSAFERANDOM_RANGE_OFFSET UNITYSDK_OFFSET(0x96F780)
#define FOUNDATION_THREADSAFERANDOM_SETSEED_OFFSET UNITYSDK_OFFSET(0x96F750)
#define FOUNDATION_THREADSAFERANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x96F750)

namespace Foundation
{
	inline static constexpr unsigned int ThreadSafeRandom_TypeDefinitionIndex = 9137;
