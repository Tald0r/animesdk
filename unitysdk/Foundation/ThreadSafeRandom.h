...
#define FOUNDATION_THREADSAFERANDOM_GET_OFFSET UNITYSDK_OFFSET(0x940D10)
#define FOUNDATION_THREADSAFERANDOM_RANGE_OFFSET UNITYSDK_OFFSET(0x940C60)
#define FOUNDATION_THREADSAFERANDOM_SETSEED_OFFSET UNITYSDK_OFFSET(0x940C30)
#define FOUNDATION_THREADSAFERANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x940C30)

namespace Foundation
{
	inline static constexpr unsigned int ThreadSafeRandom_TypeDefinitionIndex = 8894;
