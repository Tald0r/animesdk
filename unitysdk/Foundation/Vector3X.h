...
#define FOUNDATION_VECTOR3X_ALMOSTZERO_OFFSET UNITYSDK_OFFSET(0x19772010)
#define FOUNDATION_VECTOR3X_ANGLE_OFFSET UNITYSDK_OFFSET(0x197770D0)
#define FOUNDATION_VECTOR3X_CALREFLECT_1_OFFSET UNITYSDK_OFFSET(0x197764B0)
#define FOUNDATION_VECTOR3X_CALREFLECT_OFFSET UNITYSDK_OFFSET(0x197763F0)
#define FOUNDATION_VECTOR3X_CLAMPANGLEINDEGREE_OFFSET UNITYSDK_OFFSET(0x19778210)
#define FOUNDATION_VECTOR3X_COSANGLE_1_OFFSET UNITYSDK_OFFSET(0x19776250)
#define FOUNDATION_VECTOR3X_COSANGLE_OFFSET UNITYSDK_OFFSET(0x197760A0)
#define FOUNDATION_VECTOR3X_DISTANCE2_OFFSET UNITYSDK_OFFSET(0x19778540)
#define FOUNDATION_VECTOR3X_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x19776EC0)
#define FOUNDATION_VECTOR3X_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x19775D20)
#define FOUNDATION_VECTOR3X_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0x19775D60)
#define FOUNDATION_VECTOR3X_GET_NAN_OFFSET UNITYSDK_OFFSET(0x19775DE0)
#define FOUNDATION_VECTOR3X_GET_NULLVALUE_OFFSET UNITYSDK_OFFSET(0x19775DA0)
#define FOUNDATION_VECTOR3X_ISINFINITY_OFFSET UNITYSDK_OFFSET(0x19777610)
#define FOUNDATION_VECTOR3X_ISNAN_OFFSET UNITYSDK_OFFSET(0x19777570)
#define FOUNDATION_VECTOR3X_LERP_OFFSET UNITYSDK_OFFSET(0x197757B0)
#define FOUNDATION_VECTOR3X_LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0x197769E0)
#define FOUNDATION_VECTOR3X_LOOKATDIRECTION_OFFSET UNITYSDK_OFFSET(0x19776CC0)
#define FOUNDATION_VECTOR3X_MANHATTANDIS_OFFSET UNITYSDK_OFFSET(0x19778600)
#define FOUNDATION_VECTOR3X_MOVETO_1_OFFSET UNITYSDK_OFFSET(0x19777900)
#define FOUNDATION_VECTOR3X_MOVETO_OFFSET UNITYSDK_OFFSET(0x197776B0)
#define FOUNDATION_VECTOR3X_PROJECTONPLANE_OFFSET UNITYSDK_OFFSET(0x19776FA0)
#define FOUNDATION_VECTOR3X_PROJECTONTOPLANE_OFFSET UNITYSDK_OFFSET(0x19771F10)
#define FOUNDATION_VECTOR3X_RATIO_1_OFFSET UNITYSDK_OFFSET(0x19775C70)
#define FOUNDATION_VECTOR3X_RATIO_OFFSET UNITYSDK_OFFSET(0x19775930)
#define FOUNDATION_VECTOR3X_REVERSEROTATE_OFFSET UNITYSDK_OFFSET(0x19777310)
#define FOUNDATION_VECTOR3X_SET_OFFSET UNITYSDK_OFFSET(0x19774A40)
#define FOUNDATION_VECTOR3X_SIGNEDANGLE_OFFSET UNITYSDK_OFFSET(0x19772BB0)
#define FOUNDATION_VECTOR3X_SPEEDTO_OFFSET UNITYSDK_OFFSET(0x19777AF0)
#define FOUNDATION_VECTOR3X_TOFULLSTRING_OFFSET UNITYSDK_OFFSET(0x19775E20)
#define FOUNDATION_VECTOR3X_TOSYSTEMNUMERICS_OFFSET UNITYSDK_OFFSET(0x197786C0)
#define FOUNDATION_VECTOR3X_TOTRANSMATRIXVECTOR3_OFFSET UNITYSDK_OFFSET(0x19776660)
#define FOUNDATION_VECTOR3X_TOTRANSMATRIXVECTOR4_OFFSET UNITYSDK_OFFSET(0x197765B0)
#define FOUNDATION_VECTOR3X_WORLDTOLOCALPOSTION_OFFSET UNITYSDK_OFFSET(0x19776700)
#define FOUNDATION_VECTOR3X__CCTOR_OFFSET UNITYSDK_OFFSET(0x19778760)

namespace Foundation
{
	inline static constexpr unsigned int Vector3X_TypeDefinitionIndex = 8021;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(Vector3X_TypeDefinitionIndex)->GetStaticField(0x38C0);
		}
		static ::UnityEngine::Vector3* StaticGet__NullValue()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(Vector3X_TypeDefinitionIndex)->GetStaticField(0x38CC);
		}
		static ::UnityEngine::Vector3* StaticGet__MinValue()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(Vector3X_TypeDefinitionIndex)->GetStaticField(0x38D8);
		}
		static ::UnityEngine::Vector3* StaticGet__MaxValue()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(Vector3X_TypeDefinitionIndex)->GetStaticField(0x38E4);
		}
