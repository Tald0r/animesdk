...
#define FOUNDATION_VECTOR3X_ALMOSTZERO_OFFSET UNITYSDK_OFFSET(0x19384A50)
#define FOUNDATION_VECTOR3X_ANGLE_OFFSET UNITYSDK_OFFSET(0x19389B00)
#define FOUNDATION_VECTOR3X_CALREFLECT_1_OFFSET UNITYSDK_OFFSET(0x19388EE0)
#define FOUNDATION_VECTOR3X_CALREFLECT_OFFSET UNITYSDK_OFFSET(0x19388E20)
#define FOUNDATION_VECTOR3X_CLAMPANGLEINDEGREE_OFFSET UNITYSDK_OFFSET(0x1938AC40)
#define FOUNDATION_VECTOR3X_COSANGLE_1_OFFSET UNITYSDK_OFFSET(0x19388C80)
#define FOUNDATION_VECTOR3X_COSANGLE_OFFSET UNITYSDK_OFFSET(0x19388AD0)
#define FOUNDATION_VECTOR3X_DISTANCE2_OFFSET UNITYSDK_OFFSET(0x1938AF70)
#define FOUNDATION_VECTOR3X_DISTANCETO_OFFSET UNITYSDK_OFFSET(0x193898F0)
#define FOUNDATION_VECTOR3X_GET_MAXVALUE_OFFSET UNITYSDK_OFFSET(0x19388750)
#define FOUNDATION_VECTOR3X_GET_MINVALUE_OFFSET UNITYSDK_OFFSET(0x19388790)
#define FOUNDATION_VECTOR3X_GET_NAN_OFFSET UNITYSDK_OFFSET(0x19388810)
#define FOUNDATION_VECTOR3X_GET_NULLVALUE_OFFSET UNITYSDK_OFFSET(0x193887D0)
#define FOUNDATION_VECTOR3X_ISINFINITY_OFFSET UNITYSDK_OFFSET(0x1938A040)
#define FOUNDATION_VECTOR3X_ISNAN_OFFSET UNITYSDK_OFFSET(0x19389FA0)
#define FOUNDATION_VECTOR3X_LERP_OFFSET UNITYSDK_OFFSET(0x193881E0)
#define FOUNDATION_VECTOR3X_LOCALTOWORLD_OFFSET UNITYSDK_OFFSET(0x19389410)
#define FOUNDATION_VECTOR3X_LOOKATDIRECTION_OFFSET UNITYSDK_OFFSET(0x193896F0)
#define FOUNDATION_VECTOR3X_MANHATTANDIS_OFFSET UNITYSDK_OFFSET(0x1938B030)
#define FOUNDATION_VECTOR3X_MOVETO_1_OFFSET UNITYSDK_OFFSET(0x1938A330)
#define FOUNDATION_VECTOR3X_MOVETO_OFFSET UNITYSDK_OFFSET(0x1938A0E0)
#define FOUNDATION_VECTOR3X_PROJECTONPLANE_OFFSET UNITYSDK_OFFSET(0x193899D0)
#define FOUNDATION_VECTOR3X_PROJECTONTOPLANE_OFFSET UNITYSDK_OFFSET(0x19384950)
#define FOUNDATION_VECTOR3X_RATIO_1_OFFSET UNITYSDK_OFFSET(0x193886A0)
#define FOUNDATION_VECTOR3X_RATIO_OFFSET UNITYSDK_OFFSET(0x19388360)
#define FOUNDATION_VECTOR3X_REVERSEROTATE_OFFSET UNITYSDK_OFFSET(0x19389D40)
#define FOUNDATION_VECTOR3X_SET_OFFSET UNITYSDK_OFFSET(0x19387470)
#define FOUNDATION_VECTOR3X_SIGNEDANGLE_OFFSET UNITYSDK_OFFSET(0x193855F0)
#define FOUNDATION_VECTOR3X_SPEEDTO_OFFSET UNITYSDK_OFFSET(0x1938A520)
#define FOUNDATION_VECTOR3X_TOFULLSTRING_OFFSET UNITYSDK_OFFSET(0x19388850)
#define FOUNDATION_VECTOR3X_TOSYSTEMNUMERICS_OFFSET UNITYSDK_OFFSET(0x1938B0F0)
#define FOUNDATION_VECTOR3X_TOTRANSMATRIXVECTOR3_OFFSET UNITYSDK_OFFSET(0x19389090)
#define FOUNDATION_VECTOR3X_TOTRANSMATRIXVECTOR4_OFFSET UNITYSDK_OFFSET(0x19388FE0)
#define FOUNDATION_VECTOR3X_WORLDTOLOCALPOSTION_OFFSET UNITYSDK_OFFSET(0x19389130)
#define FOUNDATION_VECTOR3X__CCTOR_OFFSET UNITYSDK_OFFSET(0x1938B190)

namespace Foundation
{
	inline static constexpr unsigned int Vector3X_TypeDefinitionIndex = 8299;
	...
	public:
		...
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(Vector3X_TypeDefinitionIndex)->GetStaticField(0x38B0);
		}
		static ::UnityEngine::Vector3* StaticGet__MaxValue()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(Vector3X_TypeDefinitionIndex)->GetStaticField(0x38BC);
		}
		static ::UnityEngine::Vector3* StaticGet__NullValue()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(Vector3X_TypeDefinitionIndex)->GetStaticField(0x38C8);
		}
		static ::UnityEngine::Vector3* StaticGet__NaN()
		{
			return (::UnityEngine::Vector3*)Il2CppClass::FromTypeDefinitionIndex(Vector3X_TypeDefinitionIndex)->GetStaticField(0x38D4);
		}
