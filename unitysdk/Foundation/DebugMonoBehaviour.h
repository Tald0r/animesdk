...
#define FOUNDATION_DEBUGMONOBEHAVIOUR_DRAW_OFFSET UNITYSDK_OFFSET(0x1A024740)
#define FOUNDATION_DEBUGMONOBEHAVIOUR_GET__CURACTIONS_OFFSET UNITYSDK_OFFSET(0x1A024300)
#define FOUNDATION_DEBUGMONOBEHAVIOUR_INIT_OFFSET UNITYSDK_OFFSET(0x1A024370)
#define FOUNDATION_DEBUGMONOBEHAVIOUR_ONRENDEROBJECT_OFFSET UNITYSDK_OFFSET(0x1A0244C0)
#define FOUNDATION_DEBUGMONOBEHAVIOUR_PUSHCMD_OFFSET UNITYSDK_OFFSET(0x1A0243D0)
#define FOUNDATION_DEBUGMONOBEHAVIOUR_SWITCHLIST_OFFSET UNITYSDK_OFFSET(0x1A0245A0)
#define FOUNDATION_DEBUGMONOBEHAVIOUR_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A024520)
#define FOUNDATION_DEBUGMONOBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A024920)
#define FOUNDATION_DEBUGMONOBEHAVIOUR___BASE_INIT_OFFSET UNITYSDK_OFFSET(0x1A0249E0)

namespace Foundation
{
	inline static constexpr unsigned int DebugMonoBehaviour_TypeDefinitionIndex = 8276;
