...
#define FOUNDATION_BUNDLEASSETREQUEST_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x193754A0)
#define FOUNDATION_BUNDLEASSETREQUEST_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x19375860)
#define FOUNDATION_BUNDLEASSETREQUEST_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x19375560)
#define FOUNDATION_BUNDLEASSETREQUEST_GET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x193748A0)
#define FOUNDATION_BUNDLEASSETREQUEST_INITBUNDLEINFO_OFFSET UNITYSDK_OFFSET(0x193748C0)
#define FOUNDATION_BUNDLEASSETREQUEST_LOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x19375130)
#define FOUNDATION_BUNDLEASSETREQUEST_LOAD_OFFSET UNITYSDK_OFFSET(0x19374930)
#define FOUNDATION_BUNDLEASSETREQUEST_RECYCLE_OFFSET UNITYSDK_OFFSET(0x193753F0)
#define FOUNDATION_BUNDLEASSETREQUEST_SET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x193748B0)
#define FOUNDATION_BUNDLEASSETREQUEST_UNLOAD_OFFSET UNITYSDK_OFFSET(0x19375190)
#define FOUNDATION_BUNDLEASSETREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x19375960)
#define FOUNDATION_BUNDLEASSETREQUEST___BASE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x193759C0)
#define FOUNDATION_BUNDLEASSETREQUEST___BASE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x19375A90)
#define FOUNDATION_BUNDLEASSETREQUEST___BASE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x193759E0)
#define FOUNDATION_BUNDLEASSETREQUEST___BASE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x193759D0)

namespace Foundation
{
	inline static constexpr unsigned int BundleAssetRequest_TypeDefinitionIndex = 7969;

	class BundleAssetRequest : public ::Foundation::AssetRequestBase
	{
	public:
		// static const ::System::Int32 hightestPriority = 0x270F; // 0x0
		::Foundation::BundleRequest* bundle; // 0x60
		::UnityEngine::AssetBundle* assetBundle; // 0x68
		::System::Collections::Generic::List_1<::Foundation::BundleRequest*>* children; // 0x70
		::Foundation::BundleID _BundleID_k__BackingField; // 0x78
