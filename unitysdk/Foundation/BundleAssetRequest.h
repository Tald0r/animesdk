...
#define FOUNDATION_BUNDLEASSETREQUEST_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x19762300)
#define FOUNDATION_BUNDLEASSETREQUEST_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x197626D0)
#define FOUNDATION_BUNDLEASSETREQUEST_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x197623D0)
#define FOUNDATION_BUNDLEASSETREQUEST_GET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x197616F0)
#define FOUNDATION_BUNDLEASSETREQUEST_INITBUNDLEINFO_OFFSET UNITYSDK_OFFSET(0x19761710)
#define FOUNDATION_BUNDLEASSETREQUEST_LOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x19761F90)
#define FOUNDATION_BUNDLEASSETREQUEST_LOAD_OFFSET UNITYSDK_OFFSET(0x19761780)
#define FOUNDATION_BUNDLEASSETREQUEST_RECYCLE_OFFSET UNITYSDK_OFFSET(0x19762250)
#define FOUNDATION_BUNDLEASSETREQUEST_SET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x19761700)
#define FOUNDATION_BUNDLEASSETREQUEST_UNLOAD_OFFSET UNITYSDK_OFFSET(0x19761FF0)
#define FOUNDATION_BUNDLEASSETREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x197627D0)
#define FOUNDATION_BUNDLEASSETREQUEST___BASE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x19762830)
#define FOUNDATION_BUNDLEASSETREQUEST___BASE_GETINSTANCEASYNC_OFFSET UNITYSDK_OFFSET(0x19762900)
#define FOUNDATION_BUNDLEASSETREQUEST___BASE_GETINSTANCE_OFFSET UNITYSDK_OFFSET(0x19762850)
#define FOUNDATION_BUNDLEASSETREQUEST___BASE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x19762840)

namespace Foundation
{
	inline static constexpr unsigned int BundleAssetRequest_TypeDefinitionIndex = 8187;
