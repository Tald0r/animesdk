...
#define FOUNDATION_TEMPORARAYTRACKER_CHECKALIVE_OFFSET UNITYSDK_OFFSET(0x1AA5E580)
#define FOUNDATION_TEMPORARAYTRACKER_COMPOSETEMPORARAYTRACKER_OFFSET UNITYSDK_OFFSET(0x1AA5E500)
#define FOUNDATION_TEMPORARAYTRACKER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AA5E9C0)
#define FOUNDATION_TEMPORARAYTRACKER_GET_CAPCITY_OFFSET UNITYSDK_OFFSET(0x1AA5E4E0)
#define FOUNDATION_TEMPORARAYTRACKER_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1AA5E4C0)
#define FOUNDATION_TEMPORARAYTRACKER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1AA5E720)
#define FOUNDATION_TEMPORARAYTRACKER_SET_CAPCITY_OFFSET UNITYSDK_OFFSET(0x1AA5E4F0)
#define FOUNDATION_TEMPORARAYTRACKER_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1AA5E4D0)
#define FOUNDATION_TEMPORARAYTRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA5EA60)

namespace Foundation
{
	inline static constexpr unsigned int TemporarayTracker_TypeDefinitionIndex = 8168;
	...
	public:
		...
		::System::Int32 _Capcity_k__BackingField; // 0x24
