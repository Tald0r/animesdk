...
#define FOUNDATION_TEMPORARAYTRACKER_CHECKALIVE_OFFSET UNITYSDK_OFFSET(0x1A860C00)
#define FOUNDATION_TEMPORARAYTRACKER_COMPOSETEMPORARAYTRACKER_OFFSET UNITYSDK_OFFSET(0x1A860B80)
#define FOUNDATION_TEMPORARAYTRACKER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A861040)
#define FOUNDATION_TEMPORARAYTRACKER_GET_CAPCITY_OFFSET UNITYSDK_OFFSET(0x1A860B60)
#define FOUNDATION_TEMPORARAYTRACKER_GET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A860B40)
#define FOUNDATION_TEMPORARAYTRACKER_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A860DA0)
#define FOUNDATION_TEMPORARAYTRACKER_SET_CAPCITY_OFFSET UNITYSDK_OFFSET(0x1A860B70)
#define FOUNDATION_TEMPORARAYTRACKER_SET_TIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A860B50)
#define FOUNDATION_TEMPORARAYTRACKER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A8610E0)

namespace Foundation
{
	inline static constexpr unsigned int TemporarayTracker_TypeDefinitionIndex = 7989;
	...
	public:
		...
		::System::Single timeoutTick; // 0x1C
