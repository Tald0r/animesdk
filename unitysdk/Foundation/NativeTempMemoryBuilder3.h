...
#define FOUNDATION_NATIVETEMPMEMORYBUILDER3_BUILD_OFFSET UNITYSDK_OFFSET(0x97BBB0)
#define FOUNDATION_NATIVETEMPMEMORYBUILDER3__CTOR_OFFSET UNITYSDK_OFFSET(0x97BAA0)

namespace Foundation
{
	inline static constexpr unsigned int NativeTempMemoryBuilder3_TypeDefinitionIndex = 8868;
