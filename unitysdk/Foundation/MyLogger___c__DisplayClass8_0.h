...
#define FOUNDATION_MYLOGGER___C__DISPLAYCLASS8_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A995300)
#define FOUNDATION_MYLOGGER___C__DISPLAYCLASS8_0__DRAWBONE_B__0_OFFSET UNITYSDK_OFFSET(0x1A995310)

namespace Foundation
{
	inline static constexpr unsigned int MyLogger___c__DisplayClass8_0_TypeDefinitionIndex = 8137;
