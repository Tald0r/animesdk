...
#define FOUNDATION_BUNDLEINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9514E0)
#define FOUNDATION_BUNDLEINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x9513E0)
#define FOUNDATION_BUNDLEINFO_GETBUNDLELOADINFO_OFFSET UNITYSDK_OFFSET(0x951360)
#define FOUNDATION_BUNDLEINFO_GETBUNDLELOCATION_OFFSET UNITYSDK_OFFSET(0x951370)
#define FOUNDATION_BUNDLEINFO_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9514D0)
#define FOUNDATION_BUNDLEINFO_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1AB71460)
#define FOUNDATION_BUNDLEINFO_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1AB715E0)
#define FOUNDATION_BUNDLEINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9514F0)
#define FOUNDATION_BUNDLEINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB71E10)
#define FOUNDATION_BUNDLEINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x951330)
#define FOUNDATION_BUNDLEINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x951500)
#define FOUNDATION_BUNDLEINFO___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x951570)
#define FOUNDATION_BUNDLEINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9515E0)

namespace Foundation
{
	inline static constexpr unsigned int BundleInfo_TypeDefinitionIndex = 7890;

	struct alignas(8) BundleInfo
	{
		static ::Foundation::BundleInfo* StaticGet_None()
		{
			return (::Foundation::BundleInfo*)Il2CppClass::FromTypeDefinitionIndex(BundleInfo_TypeDefinitionIndex)->GetStaticField(0x39A0);
		}
