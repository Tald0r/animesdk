...
#define FOUNDATION_TIMERCLOCK_ADDLISTENERSPEEDCHANGEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1A4A0700)
#define FOUNDATION_TIMERCLOCK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A4A0A90)
#define FOUNDATION_TIMERCLOCK_GETDELTATIME_OFFSET UNITYSDK_OFFSET(0x1A4A0530)
#define FOUNDATION_TIMERCLOCK_GETENGINETIME_OFFSET UNITYSDK_OFFSET(0x1A4A0680)
#define FOUNDATION_TIMERCLOCK_GET_DEPENDENCECOUNT_OFFSET UNITYSDK_OFFSET(0x1A49FD80)
#define FOUNDATION_TIMERCLOCK_GET_E_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A49FD90)
#define FOUNDATION_TIMERCLOCK_GET_PARENTTIMERCLOCK_OFFSET UNITYSDK_OFFSET(0x1A4A06F0)
#define FOUNDATION_TIMERCLOCK_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1A4A0340)
#define FOUNDATION_TIMERCLOCK_ONSPEEDCHANGEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1A4A0480)
#define FOUNDATION_TIMERCLOCK_REMOVELISTENERSPEEDCHANGEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1A4A07B0)
#define FOUNDATION_TIMERCLOCK_SETPARENTCLOCK_OFFSET UNITYSDK_OFFSET(0x1A49FEB0)
#define FOUNDATION_TIMERCLOCK_SETSPEED_OFFSET UNITYSDK_OFFSET(0x1A4A0860)
#define FOUNDATION_TIMERCLOCK_SET_E_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x1A49FDA0)
#define FOUNDATION_TIMERCLOCK__CHECK_PARENT_VALID__OFFSET UNITYSDK_OFFSET(0x1A4A0930)
#define FOUNDATION_TIMERCLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A49FDB0)
#define FOUNDATION_TIMERCLOCK__REFRESH_CURRENT__OFFSET UNITYSDK_OFFSET(0x1A4A01A0)

namespace Foundation
{
	inline static constexpr unsigned int TimerClock_TypeDefinitionIndex = 7729;
	...
	public:
		...
		::System::Single _lastRefreshParentEngineTime; // 0x38
