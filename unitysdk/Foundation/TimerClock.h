...
#define FOUNDATION_TIMERCLOCK_ADDLISTENERSPEEDCHANGEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1AA1BDF0)
#define FOUNDATION_TIMERCLOCK_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AA1C180)
#define FOUNDATION_TIMERCLOCK_GETDELTATIME_OFFSET UNITYSDK_OFFSET(0x1AA1BC20)
#define FOUNDATION_TIMERCLOCK_GETENGINETIME_OFFSET UNITYSDK_OFFSET(0x1AA1BD70)
#define FOUNDATION_TIMERCLOCK_GET_DEPENDENCECOUNT_OFFSET UNITYSDK_OFFSET(0x1AA1B470)
#define FOUNDATION_TIMERCLOCK_GET_E_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x1AA1B480)
#define FOUNDATION_TIMERCLOCK_GET_PARENTTIMERCLOCK_OFFSET UNITYSDK_OFFSET(0x1AA1BDE0)
#define FOUNDATION_TIMERCLOCK_GET_SPEED_OFFSET UNITYSDK_OFFSET(0x1AA1BA30)
#define FOUNDATION_TIMERCLOCK_ONSPEEDCHANGEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1AA1BB70)
#define FOUNDATION_TIMERCLOCK_REMOVELISTENERSPEEDCHANGEDBEFORE_OFFSET UNITYSDK_OFFSET(0x1AA1BEA0)
#define FOUNDATION_TIMERCLOCK_SETPARENTCLOCK_OFFSET UNITYSDK_OFFSET(0x1AA1B5A0)
#define FOUNDATION_TIMERCLOCK_SETSPEED_OFFSET UNITYSDK_OFFSET(0x1AA1BF50)
#define FOUNDATION_TIMERCLOCK_SET_E_ONCHANGED_OFFSET UNITYSDK_OFFSET(0x1AA1B490)
#define FOUNDATION_TIMERCLOCK__CHECK_PARENT_VALID__OFFSET UNITYSDK_OFFSET(0x1AA1C020)
#define FOUNDATION_TIMERCLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA1B4A0)
#define FOUNDATION_TIMERCLOCK__REFRESH_CURRENT__OFFSET UNITYSDK_OFFSET(0x1AA1B890)

namespace Foundation
{
	inline static constexpr unsigned int TimerClock_TypeDefinitionIndex = 7696;
	...
	public:
		...
		::System::Single _myEngineTime; // 0x24
		::System::Int32 _dependenceCount; // 0x28
		::Foundation::TimerClock_EStateTag ClockTag; // 0x2C
		::System::Int32 _lastRefreshFrameCount; // 0x30
		::System::Single _lastRefreshParentEngineTime; // 0x34
		::System::Boolean isDisposed; // 0x38
