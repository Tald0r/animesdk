...
#define FOUNDATION_SCENEASSETREQUEST_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1AEBEA70)
#define FOUNDATION_SCENEASSETREQUEST_FORCERELEASE_OFFSET UNITYSDK_OFFSET(0x1AEBE4E0)
#define FOUNDATION_SCENEASSETREQUEST_FORCEUNLOAD_OFFSET UNITYSDK_OFFSET(0x1AEBE5D0)
#define FOUNDATION_SCENEASSETREQUEST_GET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x1AEBD7E0)
#define FOUNDATION_SCENEASSETREQUEST_GET_LOADINGPERCENT_OFFSET UNITYSDK_OFFSET(0x1AEBD8B0)
#define FOUNDATION_SCENEASSETREQUEST_GET_SCENE_OFFSET UNITYSDK_OFFSET(0x1AEBD800)
#define FOUNDATION_SCENEASSETREQUEST_LOADIMMEDIATE_OFFSET UNITYSDK_OFFSET(0x1AEBE090)
#define FOUNDATION_SCENEASSETREQUEST_LOAD_OFFSET UNITYSDK_OFFSET(0x1AEBD920)
#define FOUNDATION_SCENEASSETREQUEST_MASKSCENEASSETPERSISTENT_OFFSET UNITYSDK_OFFSET(0x1AEBD8C0)
#define FOUNDATION_SCENEASSETREQUEST_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1AEBEA10)
#define FOUNDATION_SCENEASSETREQUEST_RESETSCENE_OFFSET UNITYSDK_OFFSET(0x1AEBE9B0)
#define FOUNDATION_SCENEASSETREQUEST_SET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x1AEBD7F0)
#define FOUNDATION_SCENEASSETREQUEST_SET_SCENE_OFFSET UNITYSDK_OFFSET(0x1AEBD810)
#define FOUNDATION_SCENEASSETREQUEST_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1AEBE0F0)
#define FOUNDATION_SCENEASSETREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEBD820)
#define FOUNDATION_SCENEASSETREQUEST__FORCEUNLOAD_B__22_0_OFFSET UNITYSDK_OFFSET(0x1AEBEAF0)
#define FOUNDATION_SCENEASSETREQUEST__UNLOAD_B__20_0_OFFSET UNITYSDK_OFFSET(0x1AEBEAE0)
#define FOUNDATION_SCENEASSETREQUEST___BASE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1AEBEB10)
#define FOUNDATION_SCENEASSETREQUEST___BASE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1AEBEB00)

namespace Foundation
{
	inline static constexpr unsigned int SceneAssetRequest_TypeDefinitionIndex = 7916;

	class SceneAssetRequest : public ::Foundation::AssetRequestBase
	{
	public:
		::System::Action* unloadSceneCompleted; // 0x70
