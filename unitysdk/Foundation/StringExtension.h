...
#define FOUNDATION_STRINGEXTENSION_INT64VALUE_OFFSET UNITYSDK_OFFSET(0x1A02B540)
#define FOUNDATION_STRINGEXTENSION_INTVALUE_OFFSET UNITYSDK_OFFSET(0x1A02B420)
#define FOUNDATION_STRINGEXTENSION_UINTVALUE_OFFSET UNITYSDK_OFFSET(0x1A02B4B0)

namespace Foundation
{
	inline static constexpr unsigned int StringExtension_TypeDefinitionIndex = 7897;
