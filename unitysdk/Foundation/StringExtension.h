...
#define FOUNDATION_STRINGEXTENSION_INT64VALUE_OFFSET UNITYSDK_OFFSET(0x19A59650)
#define FOUNDATION_STRINGEXTENSION_INTVALUE_OFFSET UNITYSDK_OFFSET(0x19A59530)
#define FOUNDATION_STRINGEXTENSION_UINTVALUE_OFFSET UNITYSDK_OFFSET(0x19A595C0)

namespace Foundation
{
	inline static constexpr unsigned int StringExtension_TypeDefinitionIndex = 7860;
