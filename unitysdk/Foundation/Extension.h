...
#define FOUNDATION_EXTENSION_ADD_OFFSET UNITYSDK_OFFSET(0x1B2F3940)
#define FOUNDATION_EXTENSION_CLAMP_OFFSET UNITYSDK_OFFSET(0x1B2EFDF0)
#define FOUNDATION_EXTENSION_CONTAINNAN_OFFSET UNITYSDK_OFFSET(0x1B2F3E50)
#define FOUNDATION_EXTENSION_CROSS_OFFSET UNITYSDK_OFFSET(0x1B2F3B70)
#define FOUNDATION_EXTENSION_DELTA_OFFSET UNITYSDK_OFFSET(0x1B2F35E0)
#define FOUNDATION_EXTENSION_DIAGNOSTICCHECKNAN_ALL_OFFSET UNITYSDK_OFFSET(0x1B2F03F0)
#define FOUNDATION_EXTENSION_DIAGNOSTICCHECKNAN_ROTATION_OFFSET UNITYSDK_OFFSET(0x1B2F03D0)
#define FOUNDATION_EXTENSION_DIAGNOSTICCHECKNAN_SCALE_OFFSET UNITYSDK_OFFSET(0x1B2F03E0)
#define FOUNDATION_EXTENSION_DIAGNOSTICCHECKNAN_TRANSLATION_OFFSET UNITYSDK_OFFSET(0x1B2F03C0)
#define FOUNDATION_EXTENSION_FROMTOROTATION_OFFSET UNITYSDK_OFFSET(0x1B2F3610)
#define FOUNDATION_EXTENSION_GENERATECACHE_OFFSET UNITYSDK_OFFSET(0x1B2EFD30)
#define FOUNDATION_EXTENSION_GETFORWARDVECTOR_OFFSET UNITYSDK_OFFSET(0x1B2F2960)
#define FOUNDATION_EXTENSION_GETINTERVALCOUNT_OFFSET UNITYSDK_OFFSET(0x1B2EFD80)
#define FOUNDATION_EXTENSION_GETINVERSED_OFFSET UNITYSDK_OFFSET(0x1B2F3190)
#define FOUNDATION_EXTENSION_GETRELATIVETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B2F1CC0)
#define FOUNDATION_EXTENSION_GETRIGHTVECTOR_OFFSET UNITYSDK_OFFSET(0x1B2F2A90)
#define FOUNDATION_EXTENSION_GETSAFESCALERECIPROCAL_OFFSET UNITYSDK_OFFSET(0x1B2F2900)
#define FOUNDATION_EXTENSION_GETUPVECTOR_OFFSET UNITYSDK_OFFSET(0x1B2F2BC0)
#define FOUNDATION_EXTENSION_IDENTITYNAPTRANSFORMDATA_OFFSET UNITYSDK_OFFSET(0x1B2F00B0)
#define FOUNDATION_EXTENSION_INVERSETRANSFORMPOSITION_OFFSET UNITYSDK_OFFSET(0x1B2F1490)
#define FOUNDATION_EXTENSION_ISCOMPONENTSEQUAL_OFFSET UNITYSDK_OFFSET(0x1B2F3E90)
#define FOUNDATION_EXTENSION_ISNEARLYEQUAL_1_OFFSET UNITYSDK_OFFSET(0x1B2F3AB0)
#define FOUNDATION_EXTENSION_ISNEARLYEQUAL_2_OFFSET UNITYSDK_OFFSET(0x1B2F3BB0)
#define FOUNDATION_EXTENSION_ISNEARLYEQUAL_3_OFFSET UNITYSDK_OFFSET(0x1B2F3D80)
#define FOUNDATION_EXTENSION_ISNEARLYEQUAL_OFFSET UNITYSDK_OFFSET(0x1B2EFDD0)
#define FOUNDATION_EXTENSION_ISNEARLYRELATIVEEQUAL_OFFSET UNITYSDK_OFFSET(0x1B2F3AD0)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_1_OFFSET UNITYSDK_OFFSET(0x1B2F31D0)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_2_OFFSET UNITYSDK_OFFSET(0x1B2F3B00)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_3_OFFSET UNITYSDK_OFFSET(0x1B2F3B40)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_4_OFFSET UNITYSDK_OFFSET(0x1B2F3DD0)
#define FOUNDATION_EXTENSION_ISNEARLYZERO_OFFSET UNITYSDK_OFFSET(0x1B2EFDC0)
#define FOUNDATION_EXTENSION_ISNORMALIZED_1_OFFSET UNITYSDK_OFFSET(0x1B2F3E10)
#define FOUNDATION_EXTENSION_ISNORMALIZED_OFFSET UNITYSDK_OFFSET(0x1B2F3150)
#define FOUNDATION_EXTENSION_MEMBERWISEMULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B2F3ED0)
#define FOUNDATION_EXTENSION_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1B2F1710)
#define FOUNDATION_EXTENSION_NEWNAPTRANSFORMDATA_1_OFFSET UNITYSDK_OFFSET(0x1B2F01C0)
#define FOUNDATION_EXTENSION_NEWNAPTRANSFORMDATA_OFFSET UNITYSDK_OFFSET(0x1B2F0140)
#define FOUNDATION_EXTENSION_POW_OFFSET UNITYSDK_OFFSET(0x1B2F06B0)
#define FOUNDATION_EXTENSION_ROTATE_OFFSET UNITYSDK_OFFSET(0x1B2F37D0)
#define FOUNDATION_EXTENSION_SETAXIS_OFFSET UNITYSDK_OFFSET(0x1B2EFE20)
#define FOUNDATION_EXTENSION_SETBLENDIN_OFFSET UNITYSDK_OFFSET(0x1B2F3F10)
#define FOUNDATION_EXTENSION_SETBLENDOUT_OFFSET UNITYSDK_OFFSET(0x1B2F3FC0)
#define FOUNDATION_EXTENSION_SETIDENTITY_OFFSET UNITYSDK_OFFSET(0x1B2F16D0)
#define FOUNDATION_EXTENSION_SETPRIORITY_OFFSET UNITYSDK_OFFSET(0x1B2F4070)
#define FOUNDATION_EXTENSION_SETTIME_OFFSET UNITYSDK_OFFSET(0x1B2F3F00)
#define FOUNDATION_EXTENSION_SETTORELATIVETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B2F22C0)
#define FOUNDATION_EXTENSION_SIGN_OFFSET UNITYSDK_OFFSET(0x1B2F3B10)
#define FOUNDATION_EXTENSION_TOFLOAT_OFFSET UNITYSDK_OFFSET(0x1B2EFE10)
#define FOUNDATION_EXTENSION_TOINVERSEMATRIXWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1B2F0530)
#define FOUNDATION_EXTENSION_TOMATRIXWITHSCALE_OFFSET UNITYSDK_OFFSET(0x1B2F0400)
#define FOUNDATION_EXTENSION_TOORIENTEDEULER_OFFSET UNITYSDK_OFFSET(0x1B2F3CB0)
#define FOUNDATION_EXTENSION_TOORIENTEDQUATERNION_OFFSET UNITYSDK_OFFSET(0x1B2F3BF0)
#define FOUNDATION_EXTENSION_TOPITCHYAWROLL_OFFSET UNITYSDK_OFFSET(0x1B2F3200)
#define FOUNDATION_EXTENSION_TOSWINGTWIST_OFFSET UNITYSDK_OFFSET(0x1B2F2CF0)
#define FOUNDATION_EXTENSION_TOTRANSLATIONROTATIONSCALE_OFFSET UNITYSDK_OFFSET(0x1B2EFF20)
#define FOUNDATION_EXTENSION_TOTWISTSWING_OFFSET UNITYSDK_OFFSET(0x1B2F2F20)
#define FOUNDATION_EXTENSION_TRANSFORMPOSITIONNOSCALE_OFFSET UNITYSDK_OFFSET(0x1B2F1330)
#define FOUNDATION_EXTENSION_TRANSFORMPOSITION_OFFSET UNITYSDK_OFFSET(0x1B2F11E0)

namespace Foundation
{
	inline static constexpr unsigned int Extension_TypeDefinitionIndex = 9035;
