...
#define FOUNDATION_BITSET128_ENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x259A50)
#define FOUNDATION_BITSET128_ENUMERATOR_FETCHTWOBYTEBYTE_OFFSET UNITYSDK_OFFSET(0x1AE3F510)
#define FOUNDATION_BITSET128_ENUMERATOR_GETTWOBYTES_OFFSET UNITYSDK_OFFSET(0x967AE0)
#define FOUNDATION_BITSET128_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x2F7C00)
#define FOUNDATION_BITSET128_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x71EF70)
#define FOUNDATION_BITSET128_ENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x259A50)
#define FOUNDATION_BITSET128_ENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x967B10)
#define FOUNDATION_BITSET128_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x967AB0)

namespace Foundation
{
	inline static constexpr unsigned int BitSet128_Enumerator_TypeDefinitionIndex = 8850;
