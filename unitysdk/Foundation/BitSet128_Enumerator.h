...
#define FOUNDATION_BITSET128_ENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define FOUNDATION_BITSET128_ENUMERATOR_FETCHTWOBYTEBYTE_OFFSET UNITYSDK_OFFSET(0x1B456720)
#define FOUNDATION_BITSET128_ENUMERATOR_GETTWOBYTES_OFFSET UNITYSDK_OFFSET(0x9989C0)
#define FOUNDATION_BITSET128_ENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x302320)
#define FOUNDATION_BITSET128_ENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x774490)
#define FOUNDATION_BITSET128_ENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define FOUNDATION_BITSET128_ENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x9989F0)
#define FOUNDATION_BITSET128_ENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x998990)

namespace Foundation
{
	inline static constexpr unsigned int BitSet128_Enumerator_TypeDefinitionIndex = 9010;
