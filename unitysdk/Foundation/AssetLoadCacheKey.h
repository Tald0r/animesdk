...
#define FOUNDATION_ASSETLOADCACHEKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8FF320)
#define FOUNDATION_ASSETLOADCACHEKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x8FF270)
#define FOUNDATION_ASSETLOADCACHEKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8FF260)
#define FOUNDATION_ASSETLOADCACHEKEY_GET_ASSETTYPE_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define FOUNDATION_ASSETLOADCACHEKEY_GET_URL_OFFSET UNITYSDK_OFFSET(0x2CA610)
#define FOUNDATION_ASSETLOADCACHEKEY_ISNULLOREMPTY_OFFSET UNITYSDK_OFFSET(0x8FF330)
#define FOUNDATION_ASSETLOADCACHEKEY_ISVALID_OFFSET UNITYSDK_OFFSET(0x8FF410)
#define FOUNDATION_ASSETLOADCACHEKEY_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x19F0ACE0)
#define FOUNDATION_ASSETLOADCACHEKEY_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x19F0AE20)
#define FOUNDATION_ASSETLOADCACHEKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8FF420)
#define FOUNDATION_ASSETLOADCACHEKEY__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F0B260)
#define FOUNDATION_ASSETLOADCACHEKEY__CTOR_OFFSET UNITYSDK_OFFSET(0x2D26B0)
#define FOUNDATION_ASSETLOADCACHEKEY___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8FF430)
#define FOUNDATION_ASSETLOADCACHEKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8FF4A0)
#define FOUNDATION_ASSETLOADCACHEKEY___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8FF510)
...
namespace Foundation
{
	...
	struct alignas(8) AssetLoadCacheKey
	{
		...
		{
			return (::Foundation::AssetLoadCacheKey*)Il2CppClass::FromTypeDefinitionIndex(AssetLoadCacheKey_TypeDefinitionIndex)->GetStaticField(0x67D0);
		}
