...
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B0F7D60)
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B0F7DE0)
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B0F7800)
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B0F77E0)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionInfo_CheckAssetPathDelegate_TypeDefinitionIndex = 8139;
