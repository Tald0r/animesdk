...
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AB40680)
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AB40700)
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AB40120)
#define FOUNDATION_MULTIVERSIONINFO_CHECKASSETPATHDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB40110)

namespace Foundation
{
	inline static constexpr unsigned int MultiVersionInfo_CheckAssetPathDelegate_TypeDefinitionIndex = 8075;
