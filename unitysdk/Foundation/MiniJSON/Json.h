...
#define FOUNDATION_MINIJSON_JSON_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4340A0)
#define FOUNDATION_MINIJSON_JSON_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1B435EF0)
#define FOUNDATION_MINIJSON_JSON_GETLASTERRORINDEX_OFFSET UNITYSDK_OFFSET(0x1B434A50)
#define FOUNDATION_MINIJSON_JSON_GETLASTERRORSNIPPET_OFFSET UNITYSDK_OFFSET(0x1B434AF0)
#define FOUNDATION_MINIJSON_JSON_GETLASTINDEXOFNUMBER_OFFSET UNITYSDK_OFFSET(0x1B435FE0)
#define FOUNDATION_MINIJSON_JSON_LASTDECODESUCCESSFUL_OFFSET UNITYSDK_OFFSET(0x1B4349B0)
#define FOUNDATION_MINIJSON_JSON_LOOKAHEAD_OFFSET UNITYSDK_OFFSET(0x1B435400)
#define FOUNDATION_MINIJSON_JSON_NEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x1B434FD0)
#define FOUNDATION_MINIJSON_JSON_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x1B435AC0)
#define FOUNDATION_MINIJSON_JSON_PARSENUMBER_OFFSET UNITYSDK_OFFSET(0x1B435CD0)
#define FOUNDATION_MINIJSON_JSON_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B434CD0)
#define FOUNDATION_MINIJSON_JSON_PARSESTRING_OFFSET UNITYSDK_OFFSET(0x1B4354B0)
#define FOUNDATION_MINIJSON_JSON_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1B434260)
#define FOUNDATION_MINIJSON_JSON_PRINTPRETTYTAB_OFFSET UNITYSDK_OFFSET(0x1B436C50)
#define FOUNDATION_MINIJSON_JSON_SERIALIZEARRAY_OFFSET UNITYSDK_OFFSET(0x1B4372F0)
#define FOUNDATION_MINIJSON_JSON_SERIALIZENUMBER_1_OFFSET UNITYSDK_OFFSET(0x1B437740)
#define FOUNDATION_MINIJSON_JSON_SERIALIZENUMBER_OFFSET UNITYSDK_OFFSET(0x1B4377D0)
#define FOUNDATION_MINIJSON_JSON_SERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1B4360C0)
#define FOUNDATION_MINIJSON_JSON_SERIALIZESTRING_OFFSET UNITYSDK_OFFSET(0x1B436FB0)
#define FOUNDATION_MINIJSON_JSON_SERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1B434630)
#define FOUNDATION_MINIJSON_JSON_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1B4344F0)
#define FOUNDATION_MINIJSON_JSON__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B437870)

namespace Foundation::MiniJSON
{
	inline static constexpr unsigned int Json_TypeDefinitionIndex = 7723;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x7400);
		}
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x39E8);
		}
		static ::System::Int32* StaticGet_tabSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x39EC);
		}
