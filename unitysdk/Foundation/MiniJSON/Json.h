...
#define FOUNDATION_MINIJSON_JSON_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AD30F40)
#define FOUNDATION_MINIJSON_JSON_EATWHITESPACE_OFFSET UNITYSDK_OFFSET(0x1AD32D90)
#define FOUNDATION_MINIJSON_JSON_GETLASTERRORINDEX_OFFSET UNITYSDK_OFFSET(0x1AD318F0)
#define FOUNDATION_MINIJSON_JSON_GETLASTERRORSNIPPET_OFFSET UNITYSDK_OFFSET(0x1AD31990)
#define FOUNDATION_MINIJSON_JSON_GETLASTINDEXOFNUMBER_OFFSET UNITYSDK_OFFSET(0x1AD32E80)
#define FOUNDATION_MINIJSON_JSON_LASTDECODESUCCESSFUL_OFFSET UNITYSDK_OFFSET(0x1AD31850)
#define FOUNDATION_MINIJSON_JSON_LOOKAHEAD_OFFSET UNITYSDK_OFFSET(0x1AD322A0)
#define FOUNDATION_MINIJSON_JSON_NEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x1AD31E70)
#define FOUNDATION_MINIJSON_JSON_PARSEARRAY_OFFSET UNITYSDK_OFFSET(0x1AD32960)
#define FOUNDATION_MINIJSON_JSON_PARSENUMBER_OFFSET UNITYSDK_OFFSET(0x1AD32B70)
#define FOUNDATION_MINIJSON_JSON_PARSEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AD31B70)
#define FOUNDATION_MINIJSON_JSON_PARSESTRING_OFFSET UNITYSDK_OFFSET(0x1AD32350)
#define FOUNDATION_MINIJSON_JSON_PARSEVALUE_OFFSET UNITYSDK_OFFSET(0x1AD31100)
#define FOUNDATION_MINIJSON_JSON_PRINTPRETTYTAB_OFFSET UNITYSDK_OFFSET(0x1AD33AF0)
#define FOUNDATION_MINIJSON_JSON_SERIALIZEARRAY_OFFSET UNITYSDK_OFFSET(0x1AD34190)
#define FOUNDATION_MINIJSON_JSON_SERIALIZENUMBER_1_OFFSET UNITYSDK_OFFSET(0x1AD345E0)
#define FOUNDATION_MINIJSON_JSON_SERIALIZENUMBER_OFFSET UNITYSDK_OFFSET(0x1AD34670)
#define FOUNDATION_MINIJSON_JSON_SERIALIZEOBJECT_OFFSET UNITYSDK_OFFSET(0x1AD32F60)
#define FOUNDATION_MINIJSON_JSON_SERIALIZESTRING_OFFSET UNITYSDK_OFFSET(0x1AD33E50)
#define FOUNDATION_MINIJSON_JSON_SERIALIZEVALUE_OFFSET UNITYSDK_OFFSET(0x1AD314D0)
#define FOUNDATION_MINIJSON_JSON_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1AD31390)
#define FOUNDATION_MINIJSON_JSON__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AD34710)

namespace Foundation::MiniJSON
{
	inline static constexpr unsigned int Json_TypeDefinitionIndex = 8186;
	...
	public:
		...
		{
			return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x7090);
		}
		static ::System::Int32* StaticGet_tabSize()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x37A0);
		}
		static ::System::Boolean* StaticGet_PrettyPrint()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x37A4);
		}
		static ::System::Int32* StaticGet_tabCounter()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x37A8);
		}
		static ::System::Int32* StaticGet_lastErrorIndex()
		{
			return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(Json_TypeDefinitionIndex)->GetStaticField(0x37AC);
		}
