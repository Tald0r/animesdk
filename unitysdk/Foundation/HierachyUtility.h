...
#define FOUNDATION_HIERACHYUTILITY_GETBYHIERACHYPATH_OFFSET UNITYSDK_OFFSET(0x1A47FB10)
#define FOUNDATION_HIERACHYUTILITY_GETHIERARCHYPATH_OFFSET UNITYSDK_OFFSET(0x1A480200)
#define FOUNDATION_HIERACHYUTILITY_GETORCREATEBYGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A47FFF0)
#define FOUNDATION_HIERACHYUTILITY_GETORCREATEBYHIERACHYPATH_OFFSET UNITYSDK_OFFSET(0x1A47FC20)

namespace Foundation
{
	inline static constexpr unsigned int HierachyUtility_TypeDefinitionIndex = 8268;
