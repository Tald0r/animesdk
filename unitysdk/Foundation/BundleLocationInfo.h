...
#define FOUNDATION_BUNDLELOCATIONINFO_FINDBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x193F3690)
#define FOUNDATION_BUNDLELOCATIONINFO_FINDBLOCKLOCATIONINDEX_OFFSET UNITYSDK_OFFSET(0x193F3820)
#define FOUNDATION_BUNDLELOCATIONINFO_GETFILEEXT_OFFSET UNITYSDK_OFFSET(0x883F40)
#define FOUNDATION_BUNDLELOCATIONINFO_GETFOLDERPATH_OFFSET UNITYSDK_OFFSET(0x883E30)
#define FOUNDATION_BUNDLELOCATIONINFO_GETRELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x883EC0)
#define FOUNDATION_BUNDLELOCATIONINFO_GETROOTFOLDER_OFFSET UNITYSDK_OFFSET(0x883E40)
#define FOUNDATION_BUNDLELOCATIONINFO_GET_NONE_OFFSET UNITYSDK_OFFSET(0x193F3110)
#define FOUNDATION_BUNDLELOCATIONINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x883FC0)
#define FOUNDATION_BUNDLELOCATIONINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x193F3D50)
#define FOUNDATION_BUNDLELOCATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x4705B0)
#define FOUNDATION_BUNDLELOCATIONINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x883FD0)

namespace Foundation
{
	inline static constexpr unsigned int BundleLocationInfo_TypeDefinitionIndex = 7907;
	...
	struct alignas(4) BundleLocationInfo
	{
		...
		{
			return (::Il2CppArray<::System::ValueTuple_2<::Foundation::BundleLocation, ::Foundation::BundleType>>**)Il2CppClass::FromTypeDefinitionIndex(BundleLocationInfo_TypeDefinitionIndex)->GetStaticField(0x6C60);
		}
