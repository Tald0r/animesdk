...
#define FOUNDATION_BUNDLELOCATIONINFO_FINDBLOCKLOCATIONCACHE_OFFSET UNITYSDK_OFFSET(0x199757B0)
#define FOUNDATION_BUNDLELOCATIONINFO_FINDBLOCKLOCATIONINDEX_OFFSET UNITYSDK_OFFSET(0x19975930)
#define FOUNDATION_BUNDLELOCATIONINFO_GETFILEEXT_OFFSET UNITYSDK_OFFSET(0x8B8210)
#define FOUNDATION_BUNDLELOCATIONINFO_GETFOLDERPATH_OFFSET UNITYSDK_OFFSET(0x8B8100)
#define FOUNDATION_BUNDLELOCATIONINFO_GETRELATIVEPATH_OFFSET UNITYSDK_OFFSET(0x8B8190)
#define FOUNDATION_BUNDLELOCATIONINFO_GETROOTFOLDER_OFFSET UNITYSDK_OFFSET(0x8B8110)
#define FOUNDATION_BUNDLELOCATIONINFO_GET_NONE_OFFSET UNITYSDK_OFFSET(0x19975230)
#define FOUNDATION_BUNDLELOCATIONINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8B8290)
#define FOUNDATION_BUNDLELOCATIONINFO__CCTOR_OFFSET UNITYSDK_OFFSET(0x19975E60)
#define FOUNDATION_BUNDLELOCATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x470550)
#define FOUNDATION_BUNDLELOCATIONINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8B82A0)

namespace Foundation
{
	inline static constexpr unsigned int BundleLocationInfo_TypeDefinitionIndex = 8268;
