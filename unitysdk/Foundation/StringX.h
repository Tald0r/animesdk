...
#define FOUNDATION_STRINGX_ADDWWWFILEPREFIX_OFFSET UNITYSDK_OFFSET(0x1AD5C790)
#define FOUNDATION_STRINGX_APPENDCOMMA_OFFSET UNITYSDK_OFFSET(0x1AD5DFB0)
#define FOUNDATION_STRINGX_APPENDHTMLBR_OFFSET UNITYSDK_OFFSET(0x1AD5E130)
#define FOUNDATION_STRINGX_APPENDHYPHEN_OFFSET UNITYSDK_OFFSET(0x1AD5E2E0)
#define FOUNDATION_STRINGX_APPENDNEWLINE_OFFSET UNITYSDK_OFFSET(0x1AD5E070)
#define FOUNDATION_STRINGX_APPENDSEP_1_OFFSET UNITYSDK_OFFSET(0x1AD5E3A0)
#define FOUNDATION_STRINGX_APPENDSEP_OFFSET UNITYSDK_OFFSET(0x1AD5DF40)
#define FOUNDATION_STRINGX_APPENDSPACE_OFFSET UNITYSDK_OFFSET(0x1AD5E220)
#define FOUNDATION_STRINGX_APPENDWITHCOMMA_OFFSET UNITYSDK_OFFSET(0x1AD5E630)
#define FOUNDATION_STRINGX_APPENDWITHHTMLBR_OFFSET UNITYSDK_OFFSET(0x1AD5E730)
#define FOUNDATION_STRINGX_APPENDWITHHYPHEN_OFFSET UNITYSDK_OFFSET(0x1AD5E7D0)
#define FOUNDATION_STRINGX_APPENDWITHNEWLINE_OFFSET UNITYSDK_OFFSET(0x1AD5E6B0)
#define FOUNDATION_STRINGX_APPENDWITHSEP_1_OFFSET UNITYSDK_OFFSET(0x1AD5E5A0)
#define FOUNDATION_STRINGX_APPENDWITHSEP_OFFSET UNITYSDK_OFFSET(0x1AD5E4C0)
#define FOUNDATION_STRINGX_APPENDWITHSPACE_OFFSET UNITYSDK_OFFSET(0x1AD5E850)
#define FOUNDATION_STRINGX_CONTAINS_OFFSET UNITYSDK_OFFSET(0x1AD5F010)
#define FOUNDATION_STRINGX_FORMATTED_OFFSET UNITYSDK_OFFSET(0x1AD5CD60)
#define FOUNDATION_STRINGX_F_OFFSET UNITYSDK_OFFSET(0x1AD58B10)
#define FOUNDATION_STRINGX_GETWORDCOUNT_OFFSET UNITYSDK_OFFSET(0x1AD5D9B0)
#define FOUNDATION_STRINGX_INVERTCASE_OFFSET UNITYSDK_OFFSET(0x1AD5D260)
#define FOUNDATION_STRINGX_ISDATE_OFFSET UNITYSDK_OFFSET(0x1AD5C800)
#define FOUNDATION_STRINGX_ISINT_OFFSET UNITYSDK_OFFSET(0x1AD5C8C0)
#define FOUNDATION_STRINGX_ISNOTNULLOREMPTY_OFFSET UNITYSDK_OFFSET(0x1AD5CCF0)
#define FOUNDATION_STRINGX_ISNULLOREMPTYAFTERTRIMMED_OFFSET UNITYSDK_OFFSET(0x1AD5D450)
#define FOUNDATION_STRINGX_ISNULLOREMPTY_OFFSET UNITYSDK_OFFSET(0x1AD5CC80)
#define FOUNDATION_STRINGX_ISPALINDROME_OFFSET UNITYSDK_OFFSET(0x1AD5DB90)
#define FOUNDATION_STRINGX_ISVALIDEMAIL_OFFSET UNITYSDK_OFFSET(0x1AD5DDA0)
#define FOUNDATION_STRINGX_ISVALIDIPADDRESS_OFFSET UNITYSDK_OFFSET(0x1AD5DE60)
#define FOUNDATION_STRINGX_MATCH_OFFSET UNITYSDK_OFFSET(0x1AD5CFE0)
#define FOUNDATION_STRINGX_PADRIGHTEX_OFFSET UNITYSDK_OFFSET(0x1AD5EEB0)
#define FOUNDATION_STRINGX_REMOVECHAR_OFFSET UNITYSDK_OFFSET(0x1AD5D850)
#define FOUNDATION_STRINGX_REMOVESPACES_OFFSET UNITYSDK_OFFSET(0x1AD5D090)
#define FOUNDATION_STRINGX_REPLACERNWITHBR_OFFSET UNITYSDK_OFFSET(0x1AD5D110)
#define FOUNDATION_STRINGX_REVERSE_OFFSET UNITYSDK_OFFSET(0x1AD5CB20)
#define FOUNDATION_STRINGX_SKIP_OFFSET UNITYSDK_OFFSET(0x1AD5CA90)
#define FOUNDATION_STRINGX_STRIPHTML_OFFSET UNITYSDK_OFFSET(0x1AD5CE60)
#define FOUNDATION_STRINGX_SUBSETSTRING_OFFSET UNITYSDK_OFFSET(0x1AD5EA50)
#define FOUNDATION_STRINGX_SUBSTRINGFROMXTOY_OFFSET UNITYSDK_OFFSET(0x1AD5D730)
#define FOUNDATION_STRINGX_TAKE_OFFSET UNITYSDK_OFFSET(0x1AD5C990)
#define FOUNDATION_STRINGX_TOCHARLIST_OFFSET UNITYSDK_OFFSET(0x1AD5D590)
#define FOUNDATION_STRINGX_TODOUBLE_OFFSET UNITYSDK_OFFSET(0x1AD5C6B0)
#define FOUNDATION_STRINGX_TOEMPTYSTRING_OFFSET UNITYSDK_OFFSET(0x1AD5D1E0)
#define FOUNDATION_STRINGX_TOFLOAT_OFFSET UNITYSDK_OFFSET(0x1AD5C720)
#define FOUNDATION_STRINGX_TOTITLECASE_OFFSET UNITYSDK_OFFSET(0x1AD5E8D0)
#define FOUNDATION_STRINGX_TRUNCATE_OFFSET UNITYSDK_OFFSET(0x1AD5C620)

namespace Foundation
{
	inline static constexpr unsigned int StringX_TypeDefinitionIndex = 7767;
