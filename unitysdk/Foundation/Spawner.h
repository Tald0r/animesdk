...
#define FOUNDATION_SPAWNER_DESPAWN_OFFSET UNITYSDK_OFFSET(0x1A7DA2E0)
#define FOUNDATION_SPAWNER_PRESPAWN_OFFSET UNITYSDK_OFFSET(0x1A7DA580)
#define FOUNDATION_SPAWNER_SPAWN_1_OFFSET UNITYSDK_OFFSET(0x1A7D9F60)
#define FOUNDATION_SPAWNER_SPAWN_OFFSET UNITYSDK_OFFSET(0x1A7D9880)
#define FOUNDATION_SPAWNER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A7DA8A0)
#define FOUNDATION_SPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7DA870)

namespace Foundation
{
	inline static constexpr unsigned int Spawner_TypeDefinitionIndex = 8032;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::Foundation::SpawnerPool*>**)Il2CppClass::FromTypeDefinitionIndex(Spawner_TypeDefinitionIndex)->GetStaticField(0x69C0);
		}
