...
#define FOUNDATION_IENUMERATORLOADER_ADDLOADERNODE_OFFSET UNITYSDK_OFFSET(0x1A480E10)
#define FOUNDATION_IENUMERATORLOADER_AUTOPREPAREENV_OFFSET UNITYSDK_OFFSET(0x1A480A60)
#define FOUNDATION_IENUMERATORLOADER_GET_ISADDDONE_OFFSET UNITYSDK_OFFSET(0x1A480700)
#define FOUNDATION_IENUMERATORLOADER_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x1A480680)
#define FOUNDATION_IENUMERATORLOADER_GET_LOADERTYPE_OFFSET UNITYSDK_OFFSET(0x1A480670)
#define FOUNDATION_IENUMERATORLOADER_GET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x1A480740)
#define FOUNDATION_IENUMERATORLOADER_GET_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A480720)
#define FOUNDATION_IENUMERATORLOADER_GET_TIMESLICECONDINMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x1A480760)
#define FOUNDATION_IENUMERATORLOADER_LOADLOOPER_OFFSET UNITYSDK_OFFSET(0x1A4813B0)
#define FOUNDATION_IENUMERATORLOADER_LOAD_1_OFFSET UNITYSDK_OFFSET(0x1A481050)
#define FOUNDATION_IENUMERATORLOADER_LOAD_2_OFFSET UNITYSDK_OFFSET(0x1A4810E0)
#define FOUNDATION_IENUMERATORLOADER_LOAD_3_OFFSET UNITYSDK_OFFSET(0x1A4811B0)
#define FOUNDATION_IENUMERATORLOADER_LOAD_OFFSET UNITYSDK_OFFSET(0x1A480D80)
#define FOUNDATION_IENUMERATORLOADER_ONLOADERNODESTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x1A481280)
#define FOUNDATION_IENUMERATORLOADER_SET_ISADDDONE_OFFSET UNITYSDK_OFFSET(0x1A480710)
#define FOUNDATION_IENUMERATORLOADER_SET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x1A480750)
#define FOUNDATION_IENUMERATORLOADER_SET_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x1A480730)
#define FOUNDATION_IENUMERATORLOADER_SET_TIMESLICECONDINMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x1A480770)
#define FOUNDATION_IENUMERATORLOADER_START_1_OFFSET UNITYSDK_OFFSET(0x1A4809F0)
#define FOUNDATION_IENUMERATORLOADER_START_OFFSET UNITYSDK_OFFSET(0x1A480930)
#define FOUNDATION_IENUMERATORLOADER_TERMINATE_OFFSET UNITYSDK_OFFSET(0x1A480BD0)
#define FOUNDATION_IENUMERATORLOADER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A480D20)
#define FOUNDATION_IENUMERATORLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A480780)
#define FOUNDATION_IENUMERATORLOADER__LOAD_B__34_0_OFFSET UNITYSDK_OFFSET(0x1A481450)
#define FOUNDATION_IENUMERATORLOADER__LOAD_B__35_0_OFFSET UNITYSDK_OFFSET(0x1A481480)

namespace Foundation
{
	inline static constexpr unsigned int IEnumeratorLoader_TypeDefinitionIndex = 8127;
	...
	public:
		...
		::System::Action_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Exception*>*>* _OnFinished_k__BackingField; // 0x28
		::System::Collections::Generic::HashSet_1<::Foundation::IEnumeratorLoaderNode*>* pendingNodes; // 0x30
		::System::Collections::Generic::List_1<::System::Exception*>* errorList; // 0x38
		...
		::System::Int64 _TimeSliceCondInMilliseconds_k__BackingField; // 0x50
		::System::Int16 emptyRunTimes; // 0x58
		::System::Int16 emptyRunLimit; // 0x5A
