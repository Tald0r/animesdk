...
#define FOUNDATION_IENUMERATORLOADER_ADDLOADERNODE_OFFSET UNITYSDK_OFFSET(0x1AA2E120)
#define FOUNDATION_IENUMERATORLOADER_AUTOPREPAREENV_OFFSET UNITYSDK_OFFSET(0x1AA2DD70)
#define FOUNDATION_IENUMERATORLOADER_GET_ISADDDONE_OFFSET UNITYSDK_OFFSET(0x1AA2DA20)
#define FOUNDATION_IENUMERATORLOADER_GET_ISDONE_OFFSET UNITYSDK_OFFSET(0x1AA2D9A0)
#define FOUNDATION_IENUMERATORLOADER_GET_LOADERTYPE_OFFSET UNITYSDK_OFFSET(0x1AA2D990)
#define FOUNDATION_IENUMERATORLOADER_GET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x1AA2DA60)
#define FOUNDATION_IENUMERATORLOADER_GET_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x1AA2DA40)
#define FOUNDATION_IENUMERATORLOADER_GET_TIMESLICECONDINMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x1AA2DA80)
#define FOUNDATION_IENUMERATORLOADER_LOADLOOPER_OFFSET UNITYSDK_OFFSET(0x1AA2E6C0)
#define FOUNDATION_IENUMERATORLOADER_LOAD_1_OFFSET UNITYSDK_OFFSET(0x1AA2E360)
#define FOUNDATION_IENUMERATORLOADER_LOAD_2_OFFSET UNITYSDK_OFFSET(0x1AA2E3F0)
#define FOUNDATION_IENUMERATORLOADER_LOAD_3_OFFSET UNITYSDK_OFFSET(0x1AA2E4C0)
#define FOUNDATION_IENUMERATORLOADER_LOAD_OFFSET UNITYSDK_OFFSET(0x1AA2E090)
#define FOUNDATION_IENUMERATORLOADER_ONLOADERNODESTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x1AA2E590)
#define FOUNDATION_IENUMERATORLOADER_SET_ISADDDONE_OFFSET UNITYSDK_OFFSET(0x1AA2DA30)
#define FOUNDATION_IENUMERATORLOADER_SET_ONFINISHED_OFFSET UNITYSDK_OFFSET(0x1AA2DA70)
#define FOUNDATION_IENUMERATORLOADER_SET_ONPROGRESS_OFFSET UNITYSDK_OFFSET(0x1AA2DA50)
#define FOUNDATION_IENUMERATORLOADER_SET_TIMESLICECONDINMILLISECONDS_OFFSET UNITYSDK_OFFSET(0x1AA2DA90)
#define FOUNDATION_IENUMERATORLOADER_START_1_OFFSET UNITYSDK_OFFSET(0x1AA2DD00)
#define FOUNDATION_IENUMERATORLOADER_START_OFFSET UNITYSDK_OFFSET(0x1AA2DC40)
#define FOUNDATION_IENUMERATORLOADER_TERMINATE_OFFSET UNITYSDK_OFFSET(0x1AA2DEE0)
#define FOUNDATION_IENUMERATORLOADER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AA2E030)
#define FOUNDATION_IENUMERATORLOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2DAA0)
#define FOUNDATION_IENUMERATORLOADER__LOAD_B__34_0_OFFSET UNITYSDK_OFFSET(0x1AA2E760)
#define FOUNDATION_IENUMERATORLOADER__LOAD_B__35_0_OFFSET UNITYSDK_OFFSET(0x1AA2E790)

namespace Foundation
{
	inline static constexpr unsigned int IEnumeratorLoader_TypeDefinitionIndex = 7950;

	class IEnumeratorLoader : public ::System::Object
	{
	public:
		::System::Action_2<::System::Int32, ::System::Int32>* _OnProgress_k__BackingField; // 0x10
		::UnityEngine::Coroutine* coroutine; // 0x18
		::System::Collections::Generic::List_1<::Foundation::IEnumeratorLoaderNode*>* executeNodes; // 0x20
		::System::Collections::Generic::HashSet_1<::Foundation::IEnumeratorLoaderNode*>* pendingNodes; // 0x28
		::System::Collections::Generic::List_1<::System::Exception*>* errorList; // 0x30
		::System::Diagnostics::Stopwatch* stopWatch; // 0x38
		::System::Action_2<::System::Int32, ::System::Collections::Generic::List_1<::System::Exception*>*>* _OnFinished_k__BackingField; // 0x40
		::System::Int32 completeCount; // 0x48
		::System::Int16 emptyRunTimes; // 0x4C
		::System::Int16 emptyRunLimit; // 0x4E
		::System::Int32 totalCount; // 0x50
		::System::Boolean isStop; // 0x54
		::System::Boolean _IsAddDone_k__BackingField; // 0x55
