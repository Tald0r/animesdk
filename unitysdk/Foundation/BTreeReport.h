...
#define FOUNDATION_BTREEREPORT_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1A5977A0)
#define FOUNDATION_BTREEREPORT_RECORD_OFFSET UNITYSDK_OFFSET(0x1A597920)
#define FOUNDATION_BTREEREPORT_RESET_OFFSET UNITYSDK_OFFSET(0x1A597BA0)
#define FOUNDATION_BTREEREPORT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A5979C0)
#define FOUNDATION_BTREEREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1A597890)

namespace Foundation
{
	inline static constexpr unsigned int BTreeReport_TypeDefinitionIndex = 7902;
	...
	public:
		...
		{
			return (::Foundation::BTreeReport**)Il2CppClass::FromTypeDefinitionIndex(BTreeReport_TypeDefinitionIndex)->GetStaticField(0x7230);
		}
		...
		::System::Collections::Generic::Dictionary_2<::System::UInt32, ::System::Single>* BTreeMap; // 0x10
		::System::Action* OnUpdate; // 0x18
		::Il2CppArray<::UnityEngine::Vector3>* TimeQueue; // 0x20
		::System::Int32 curQueueIndex; // 0x28
