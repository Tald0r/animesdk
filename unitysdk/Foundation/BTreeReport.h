...
#define FOUNDATION_BTREEREPORT_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x1AB6FA40)
#define FOUNDATION_BTREEREPORT_RECORD_OFFSET UNITYSDK_OFFSET(0x1AB6FBC0)
#define FOUNDATION_BTREEREPORT_RESET_OFFSET UNITYSDK_OFFSET(0x1AB6FE40)
#define FOUNDATION_BTREEREPORT_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AB6FC60)
#define FOUNDATION_BTREEREPORT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB6FB30)

namespace Foundation
{
	inline static constexpr unsigned int BTreeReport_TypeDefinitionIndex = 7883;
	...
	public:
		...
		{
			return (::Foundation::BTreeReport**)Il2CppClass::FromTypeDefinitionIndex(BTreeReport_TypeDefinitionIndex)->GetStaticField(0x7330);
		}
