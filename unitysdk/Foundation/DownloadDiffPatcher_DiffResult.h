...
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_GET_COLLECTRESULT_OFFSET UNITYSDK_OFFSET(0x8B53290)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_GET_EXCEPTIONINFO_OFFSET UNITYSDK_OFFSET(0x8B532F0)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_GET_MOVERESULT_OFFSET UNITYSDK_OFFSET(0x8B532B0)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_GET_PATCHRESULT_OFFSET UNITYSDK_OFFSET(0x8B532D0)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_SET_COLLECTRESULT_OFFSET UNITYSDK_OFFSET(0x8B532A0)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_SET_MOVERESULT_OFFSET UNITYSDK_OFFSET(0x8B532C0)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT_SET_PATCHRESULT_OFFSET UNITYSDK_OFFSET(0x8B532E0)
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x8B53390)

namespace Foundation
{
	inline static constexpr unsigned int DownloadDiffPatcher_DiffResult_TypeDefinitionIndex = 43881;

	class DownloadDiffPatcher_DiffResult : public ::System::Object
	{
	public:
		::Foundation::DownloadDiffPatcher_DiffFileCollectResult* _CollectResult_k__BackingField; // 0x10
