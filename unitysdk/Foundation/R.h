...
#define FOUNDATION_R_GETBYTE_OFFSET UNITYSDK_OFFSET(0x1AA2EE20)
#define FOUNDATION_R_GETJSON_OFFSET UNITYSDK_OFFSET(0x1AA2ED10)
#define FOUNDATION_R_GETMATERIAL_OFFSET UNITYSDK_OFFSET(0x1AA2EAF0)
#define FOUNDATION_R_GETPNGIMAGE_OFFSET UNITYSDK_OFFSET(0x1AA2EC00)
#define FOUNDATION_R_GETPREFAB_OFFSET UNITYSDK_OFFSET(0x1AA2E7C0)
#define FOUNDATION_R_GETSCENE_OFFSET UNITYSDK_OFFSET(0x1AA2E9E0)
#define FOUNDATION_R_GETSCRIPTASSET_OFFSET UNITYSDK_OFFSET(0x1AA2E8D0)
#define FOUNDATION_R__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AA2EF40)
#define FOUNDATION_R__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA2EF30)

namespace Foundation
{
	inline static constexpr unsigned int R_TypeDefinitionIndex = 8304;
