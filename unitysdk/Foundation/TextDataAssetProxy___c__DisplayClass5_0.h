...
#define FOUNDATION_TEXTDATAASSETPROXY___C__DISPLAYCLASS5_0__CTOR_OFFSET UNITYSDK_OFFSET(0x8CEA720)
#define FOUNDATION_TEXTDATAASSETPROXY___C__DISPLAYCLASS5_0__LOADBYTESASSET_B__0_OFFSET UNITYSDK_OFFSET(0x8CEA730)
#define FOUNDATION_TEXTDATAASSETPROXY___C__DISPLAYCLASS5_0__LOADBYTESASSET_B__1_OFFSET UNITYSDK_OFFSET(0x8CEAB90)
#define FOUNDATION_TEXTDATAASSETPROXY___C__DISPLAYCLASS5_0__LOADBYTESASSET_B__2_OFFSET UNITYSDK_OFFSET(0x8CEA880)
#define FOUNDATION_TEXTDATAASSETPROXY___C__DISPLAYCLASS5_0__LOADBYTESASSET_B__3_OFFSET UNITYSDK_OFFSET(0x8CEA990)

namespace Foundation
{
	inline static constexpr unsigned int TextDataAssetProxy___c__DisplayClass5_0_TypeDefinitionIndex = 67391;
