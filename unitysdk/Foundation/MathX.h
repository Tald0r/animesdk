...
#define FOUNDATION_MATHX_ACCEL_OFFSET UNITYSDK_OFFSET(0x170E3970)
#define FOUNDATION_MATHX_CALPARALOBAPOSITION_OFFSET UNITYSDK_OFFSET(0x170E3DF0)
#define FOUNDATION_MATHX_CLAMPINDEGREE_OFFSET UNITYSDK_OFFSET(0x170E3D30)
#define FOUNDATION_MATHX_COSEULAR_OFFSET UNITYSDK_OFFSET(0x170E3620)
#define FOUNDATION_MATHX_LERP_OFFSET UNITYSDK_OFFSET(0x170E36F0)
#define FOUNDATION_MATHX_SINEULAR_OFFSET UNITYSDK_OFFSET(0x170E3360)
#define FOUNDATION_MATHX_SPEEDTO_OFFSET UNITYSDK_OFFSET(0x170E3A20)
#define FOUNDATION_MATHX_TOPI_OFFSET UNITYSDK_OFFSET(0x170E35A0)

namespace Foundation
{
	inline static constexpr unsigned int MathX_TypeDefinitionIndex = 8280;
