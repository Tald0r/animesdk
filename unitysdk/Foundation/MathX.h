...
#define FOUNDATION_MATHX_ACCEL_OFFSET UNITYSDK_OFFSET(0x17850D30)
#define FOUNDATION_MATHX_CALPARALOBAPOSITION_OFFSET UNITYSDK_OFFSET(0x178511B0)
#define FOUNDATION_MATHX_CLAMPINDEGREE_OFFSET UNITYSDK_OFFSET(0x178510F0)
#define FOUNDATION_MATHX_COSEULAR_OFFSET UNITYSDK_OFFSET(0x178509E0)
#define FOUNDATION_MATHX_LERP_OFFSET UNITYSDK_OFFSET(0x17850AB0)
#define FOUNDATION_MATHX_SINEULAR_OFFSET UNITYSDK_OFFSET(0x17850720)
#define FOUNDATION_MATHX_SPEEDTO_OFFSET UNITYSDK_OFFSET(0x17850DE0)
#define FOUNDATION_MATHX_TOPI_OFFSET UNITYSDK_OFFSET(0x17850960)

namespace Foundation
{
	inline static constexpr unsigned int MathX_TypeDefinitionIndex = 7910;
