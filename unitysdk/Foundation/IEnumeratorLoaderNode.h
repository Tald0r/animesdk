...
#define FOUNDATION_IENUMERATORLOADERNODE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1976E6D0)
#define FOUNDATION_IENUMERATORLOADERNODE_DEPENDENCYSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x1976E900)
#define FOUNDATION_IENUMERATORLOADERNODE_EXECUTEMOVENEXT_OFFSET UNITYSDK_OFFSET(0x1976EB40)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_EXCEPTION_OFFSET UNITYSDK_OFFSET(0x1976E2A0)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_FLAG_OFFSET UNITYSDK_OFFSET(0x1976E260)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x1976E250)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_PENDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x1976E280)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x1976E230)
#define FOUNDATION_IENUMERATORLOADERNODE_INTERNALSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x1976E850)
#define FOUNDATION_IENUMERATORLOADERNODE_SETDATA_OFFSET UNITYSDK_OFFSET(0x1976E2D0)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_EXCEPTION_OFFSET UNITYSDK_OFFSET(0x1976E2B0)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_FLAG_OFFSET UNITYSDK_OFFSET(0x1976E270)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_PENDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x1976E290)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x1976E240)
#define FOUNDATION_IENUMERATORLOADERNODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1976E6C0)
#define FOUNDATION_IENUMERATORLOADERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1976E2C0)
#define FOUNDATION_IENUMERATORLOADERNODE__SETDATA_B__25_2_OFFSET UNITYSDK_OFFSET(0x1976EF40)

namespace Foundation
{
	inline static constexpr unsigned int IEnumeratorLoaderNode_TypeDefinitionIndex = 7992;

	class IEnumeratorLoaderNode : public ::System::Object
	{
	public:
		::System::Action_1<::Foundation::IEnumeratorLoaderNode*>* OnLoaderNodeStatusChange; // 0x10
