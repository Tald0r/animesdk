...
#define FOUNDATION_IENUMERATORLOADERNODE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x19381110)
#define FOUNDATION_IENUMERATORLOADERNODE_DEPENDENCYSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x19381340)
#define FOUNDATION_IENUMERATORLOADERNODE_EXECUTEMOVENEXT_OFFSET UNITYSDK_OFFSET(0x19381580)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_EXCEPTION_OFFSET UNITYSDK_OFFSET(0x19380CF0)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_FLAG_OFFSET UNITYSDK_OFFSET(0x19380CB0)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_ISCOMPLETED_OFFSET UNITYSDK_OFFSET(0x19380CA0)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_PENDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x19380CD0)
#define FOUNDATION_IENUMERATORLOADERNODE_GET_STATUS_OFFSET UNITYSDK_OFFSET(0x19380C80)
#define FOUNDATION_IENUMERATORLOADERNODE_INTERNALSTATUSCHANGE_OFFSET UNITYSDK_OFFSET(0x19381290)
#define FOUNDATION_IENUMERATORLOADERNODE_SETDATA_OFFSET UNITYSDK_OFFSET(0x19380D20)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_EXCEPTION_OFFSET UNITYSDK_OFFSET(0x19380D00)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_FLAG_OFFSET UNITYSDK_OFFSET(0x19380CC0)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_PENDINGCOUNT_OFFSET UNITYSDK_OFFSET(0x19380CE0)
#define FOUNDATION_IENUMERATORLOADERNODE_SET_STATUS_OFFSET UNITYSDK_OFFSET(0x19380C90)
#define FOUNDATION_IENUMERATORLOADERNODE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19381100)
#define FOUNDATION_IENUMERATORLOADERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x19380D10)
#define FOUNDATION_IENUMERATORLOADERNODE__SETDATA_B__25_2_OFFSET UNITYSDK_OFFSET(0x19381980)

namespace Foundation
{
	inline static constexpr unsigned int IEnumeratorLoaderNode_TypeDefinitionIndex = 7927;

	class IEnumeratorLoaderNode : public ::System::Object
	{
	public:
		::System::Action* WrapperFunc; // 0x10
		::System::Predicate_1<::Foundation::IEnumeratorLoaderNode*>* MoveNextCond; // 0x18
		::System::Collections::Generic::HashSet_1<::Foundation::IEnumeratorLoaderNode*>* dependencies; // 0x20
		::System::Exception* _Exception_k__BackingField; // 0x28
		::System::String* _Flag_k__BackingField; // 0x30
		::System::Action_1<::Foundation::IEnumeratorLoaderNode*>* OnLoaderNodeStatusChange; // 0x38
		::System::Collections::IEnumerator* iEnumeratorFunc; // 0x40
		::System::Int32 _PendingCount_k__BackingField; // 0x48
		::Foundation::LoaderNodeStatus _Status_k__BackingField; // 0x4C
