...
#define FOUNDATION_FLOATCLAMPEDPOLICY_FOUNDATION_ICLAMPFUNC_SYSTEM_SINGLE__CLAMP_OFFSET UNITYSDK_OFFSET(0x1A83A6E0)
#define FOUNDATION_FLOATCLAMPEDPOLICY_FOUNDATION_IMAXFUNC_SYSTEM_SINGLE__MAX_OFFSET UNITYSDK_OFFSET(0x1A83A710)
#define FOUNDATION_FLOATCLAMPEDPOLICY_FOUNDATION_IMINFUNC_SYSTEM_SINGLE__MIN_OFFSET UNITYSDK_OFFSET(0x1A83A700)
#define FOUNDATION_FLOATCLAMPEDPOLICY__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A83A720)
#define FOUNDATION_FLOATCLAMPEDPOLICY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A83A6D0)

namespace Foundation
{
	inline static constexpr unsigned int FloatClampedPolicy_TypeDefinitionIndex = 9079;
