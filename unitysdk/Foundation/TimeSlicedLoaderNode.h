...
#define FOUNDATION_TIMESLICEDLOADERNODE_AWAITLOAD_OFFSET UNITYSDK_OFFSET(0x1AA1AB60)
#define FOUNDATION_TIMESLICEDLOADERNODE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1AA1B0C0)
#define FOUNDATION_TIMESLICEDLOADERNODE_CALLLOADED_OFFSET UNITYSDK_OFFSET(0x1AA1AF10)
#define FOUNDATION_TIMESLICEDLOADERNODE_ONASSETCOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x1AA1B030)
#define FOUNDATION_TIMESLICEDLOADERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA1A830)

namespace Foundation
{
	inline static constexpr unsigned int TimeSlicedLoaderNode_TypeDefinitionIndex = 7959;
