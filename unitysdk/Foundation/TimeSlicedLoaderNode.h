...
#define FOUNDATION_TIMESLICEDLOADERNODE_AWAITLOAD_OFFSET UNITYSDK_OFFSET(0x1A49F470)
#define FOUNDATION_TIMESLICEDLOADERNODE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1A49F9D0)
#define FOUNDATION_TIMESLICEDLOADERNODE_CALLLOADED_OFFSET UNITYSDK_OFFSET(0x1A49F820)
#define FOUNDATION_TIMESLICEDLOADERNODE_ONASSETCOMPLETECALLBACK_OFFSET UNITYSDK_OFFSET(0x1A49F940)
#define FOUNDATION_TIMESLICEDLOADERNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A49F140)

namespace Foundation
{
	inline static constexpr unsigned int TimeSlicedLoaderNode_TypeDefinitionIndex = 7834;
