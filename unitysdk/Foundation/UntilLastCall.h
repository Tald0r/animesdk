...
#define FOUNDATION_UNTILLASTCALL_GET_INVOCATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA1C420)
#define FOUNDATION_UNTILLASTCALL_GET_INVOKED_OFFSET UNITYSDK_OFFSET(0x1AA1C440)
#define FOUNDATION_UNTILLASTCALL_GET_REFCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA1C400)
#define FOUNDATION_UNTILLASTCALL_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA1C3E0)
#define FOUNDATION_UNTILLASTCALL_INCREASEREFCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA1C470)
#define FOUNDATION_UNTILLASTCALL_INVOKE_1_OFFSET UNITYSDK_OFFSET(0x1AA1C570)
#define FOUNDATION_UNTILLASTCALL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA1C4E0)
#define FOUNDATION_UNTILLASTCALL_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AA1C6A0)
#define FOUNDATION_UNTILLASTCALL_SET_INVOCATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA1C430)
#define FOUNDATION_UNTILLASTCALL_SET_INVOKED_OFFSET UNITYSDK_OFFSET(0x1AA1C450)
#define FOUNDATION_UNTILLASTCALL_SET_REFCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA1C410)
#define FOUNDATION_UNTILLASTCALL_SET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x1AA1C3F0)
#define FOUNDATION_UNTILLASTCALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA1C460)

namespace Foundation
{
	inline static constexpr unsigned int UntilLastCall_TypeDefinitionIndex = 7936;

	class UntilLastCall : public ::System::Object
	{
	public:
		::System::Action* Action; // 0x10
		::System::Boolean _Invoked_k__BackingField; // 0x18
