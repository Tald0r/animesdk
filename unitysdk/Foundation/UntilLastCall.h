...
#define FOUNDATION_UNTILLASTCALL_GET_INVOCATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1A4A0D30)
#define FOUNDATION_UNTILLASTCALL_GET_INVOKED_OFFSET UNITYSDK_OFFSET(0x1A4A0D50)
#define FOUNDATION_UNTILLASTCALL_GET_REFCOUNT_OFFSET UNITYSDK_OFFSET(0x1A4A0D10)
#define FOUNDATION_UNTILLASTCALL_GET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x1A4A0CF0)
#define FOUNDATION_UNTILLASTCALL_INCREASEREFCOUNT_OFFSET UNITYSDK_OFFSET(0x1A4A0D80)
#define FOUNDATION_UNTILLASTCALL_INVOKE_1_OFFSET UNITYSDK_OFFSET(0x1A4A0E80)
#define FOUNDATION_UNTILLASTCALL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A4A0DF0)
#define FOUNDATION_UNTILLASTCALL_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1A4A0FB0)
#define FOUNDATION_UNTILLASTCALL_SET_INVOCATIONCOUNT_OFFSET UNITYSDK_OFFSET(0x1A4A0D40)
#define FOUNDATION_UNTILLASTCALL_SET_INVOKED_OFFSET UNITYSDK_OFFSET(0x1A4A0D60)
#define FOUNDATION_UNTILLASTCALL_SET_REFCOUNT_OFFSET UNITYSDK_OFFSET(0x1A4A0D20)
#define FOUNDATION_UNTILLASTCALL_SET_TOTALCOUNT_OFFSET UNITYSDK_OFFSET(0x1A4A0D00)
#define FOUNDATION_UNTILLASTCALL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4A0D70)

namespace Foundation
{
	inline static constexpr unsigned int UntilLastCall_TypeDefinitionIndex = 8228;
	...
	public:
		...
		::System::Boolean _Invoked_k__BackingField; // 0x1C
