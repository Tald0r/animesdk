...
#define FOUNDATION_DYNAMICRESOURCELOADER_ADDRESPATHCOMMONPREFIX_OFFSET UNITYSDK_OFFSET(0x193FF520)
#define FOUNDATION_DYNAMICRESOURCELOADER_ADDSCENEPATHCOMMONPREFIX_OFFSET UNITYSDK_OFFSET(0x193FEF10)
#define FOUNDATION_DYNAMICRESOURCELOADER_CONTAINSASSET_1_OFFSET UNITYSDK_OFFSET(0x19400160)
#define FOUNDATION_DYNAMICRESOURCELOADER_CONTAINSASSET_OFFSET UNITYSDK_OFFSET(0x194000A0)
#define FOUNDATION_DYNAMICRESOURCELOADER_DESTROYOBJECT_1_OFFSET UNITYSDK_OFFSET(0x193FEBB0)
#define FOUNDATION_DYNAMICRESOURCELOADER_DESTROYOBJECT_OFFSET UNITYSDK_OFFSET(0x193FEB20)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADASSETASYNC_1_OFFSET UNITYSDK_OFFSET(0x193FFAD0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADASSETASYNC_OFFSET UNITYSDK_OFFSET(0x193FF910)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADASSET_OFFSET UNITYSDK_OFFSET(0x193FFC60)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADINSTANCEASSET_1_OFFSET UNITYSDK_OFFSET(0x193FFE20)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADINSTANCEASSET_OFFSET UNITYSDK_OFFSET(0x193FFD80)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADOBJECTINSTANCECACHESYNC_1_OFFSET UNITYSDK_OFFSET(0x193FF860)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADOBJECTINSTANCECACHESYNC_OFFSET UNITYSDK_OFFSET(0x193FF710)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADOBJECTINSTANCECACHE_1_OFFSET UNITYSDK_OFFSET(0x193FF660)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADOBJECTINSTANCECACHE_OFFSET UNITYSDK_OFFSET(0x193FF3D0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADSCENEASYNC_1_OFFSET UNITYSDK_OFFSET(0x193FEFC0)
#define FOUNDATION_DYNAMICRESOURCELOADER_LOADSCENEASYNC_OFFSET UNITYSDK_OFFSET(0x193FEE50)
#define FOUNDATION_DYNAMICRESOURCELOADER_REMOVEUNUSEDASSETS_OFFSET UNITYSDK_OFFSET(0x19400020)
#define FOUNDATION_DYNAMICRESOURCELOADER_SETSCENEPATHPERSISTENT_OFFSET UNITYSDK_OFFSET(0x193FECD0)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADALLAUTO_OFFSET UNITYSDK_OFFSET(0x19400200)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADALLSCENESINADDITIVESCENE_OFFSET UNITYSDK_OFFSET(0x193FF350)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADALLSCENES_OFFSET UNITYSDK_OFFSET(0x193FF2D0)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADASSET_OFFSET UNITYSDK_OFFSET(0x194005E0)
#define FOUNDATION_DYNAMICRESOURCELOADER_UNLOADSCENE_OFFSET UNITYSDK_OFFSET(0x193FF1A0)
#define FOUNDATION_DYNAMICRESOURCELOADER__CCTOR_OFFSET UNITYSDK_OFFSET(0x194006C0)
#define FOUNDATION_DYNAMICRESOURCELOADER__CTOR_OFFSET UNITYSDK_OFFSET(0x194006B0)

namespace Foundation
{
	inline static constexpr unsigned int DynamicResourceLoader_TypeDefinitionIndex = 7861;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>**)Il2CppClass::FromTypeDefinitionIndex(DynamicResourceLoader_TypeDefinitionIndex)->GetStaticField(0x6C70);
		}
		static ::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>** StaticGet_HookAutoHandles()
		{
			return (::System::Collections::Generic::List_1<::Foundation::AssetRequestHandle>**)Il2CppClass::FromTypeDefinitionIndex(DynamicResourceLoader_TypeDefinitionIndex)->GetStaticField(0x6C78);
		}
		static ::System::Collections::Generic::HashSet_1<::System::String*>** StaticGet_persistentSceneDict()
		{
			return (::System::Collections::Generic::HashSet_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(DynamicResourceLoader_TypeDefinitionIndex)->GetStaticField(0x6C80);
		}
