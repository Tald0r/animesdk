...
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFFILECOLLECTRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x6D16550)

namespace Foundation
{
	inline static constexpr unsigned int DownloadDiffPatcher_DiffFileCollectResult_TypeDefinitionIndex = 43883;

	class DownloadDiffPatcher_DiffFileCollectResult : public ::System::Object
	{
	public:
		::System::String* oldFilePath; // 0x10
		::Struct_2_DAA84C1CDD754F37 verifyFilePickInfo; // 0x18
		::System::String* outFilePath; // 0x60
		::Foundation::ExceptionInfo* exception; // 0x68
		::System::String* diffFilePath; // 0x70
