...
#define FOUNDATION_DOWNLOADDIFFPATCHER_DIFFFILECOLLECTRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x96599B0)

namespace Foundation
{
	inline static constexpr unsigned int DownloadDiffPatcher_DiffFileCollectResult_TypeDefinitionIndex = 61321;

	class DownloadDiffPatcher_DiffFileCollectResult : public ::System::Object
	{
	public:
		::System::String* diffFilePath; // 0x10
		::Foundation::ExceptionInfo* exception; // 0x18
		::System::String* outFilePath; // 0x20
		::System::String* oldFilePath; // 0x28
