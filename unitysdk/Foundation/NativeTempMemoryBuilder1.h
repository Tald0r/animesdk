...
#define FOUNDATION_NATIVETEMPMEMORYBUILDER1_BUILD_OFFSET UNITYSDK_OFFSET(0x8D5A40)
#define FOUNDATION_NATIVETEMPMEMORYBUILDER1_REQUESTINTERNAL_OFFSET UNITYSDK_OFFSET(0x8D5BE0)
#define FOUNDATION_NATIVETEMPMEMORYBUILDER1__CTOR_OFFSET UNITYSDK_OFFSET(0x8D59E0)

namespace Foundation
{
	inline static constexpr unsigned int NativeTempMemoryBuilder1_TypeDefinitionIndex = 8836;
