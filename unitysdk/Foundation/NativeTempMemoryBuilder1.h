...
#define FOUNDATION_NATIVETEMPMEMORYBUILDER1_BUILD_OFFSET UNITYSDK_OFFSET(0x8A7000)
#define FOUNDATION_NATIVETEMPMEMORYBUILDER1_REQUESTINTERNAL_OFFSET UNITYSDK_OFFSET(0x8A71A0)
#define FOUNDATION_NATIVETEMPMEMORYBUILDER1__CTOR_OFFSET UNITYSDK_OFFSET(0x8A6FA0)

namespace Foundation
{
	inline static constexpr unsigned int NativeTempMemoryBuilder1_TypeDefinitionIndex = 8863;
