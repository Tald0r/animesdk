...
#define FOUNDATION_ASSETREQUESTCOMPLETEDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AEE1AD0)
#define FOUNDATION_ASSETREQUESTCOMPLETEDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AEE1B30)
#define FOUNDATION_ASSETREQUESTCOMPLETEDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AEE12F0)
#define FOUNDATION_ASSETREQUESTCOMPLETEDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AEDE870)

namespace Foundation
{
	inline static constexpr unsigned int AssetRequestCompleteDel_TypeDefinitionIndex = 7920;
