...
#define FOUNDATION_SPANUTILS_BEGININDEX_OFFSET UNITYSDK_OFFSET(0x1A794610)
#define FOUNDATION_SPANUTILS_ENDINDEX_OFFSET UNITYSDK_OFFSET(0x1A794600)
#define FOUNDATION_SPANUTILS_ENSUREINDEX_OFFSET UNITYSDK_OFFSET(0x1A794620)

namespace Foundation
{
	inline static constexpr unsigned int SpanUtils_TypeDefinitionIndex = 9032;
