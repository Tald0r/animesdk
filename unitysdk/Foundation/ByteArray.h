...
#define FOUNDATION_BYTEARRAY_GET_OFFSET UNITYSDK_OFFSET(0x19F0B630)
#define FOUNDATION_BYTEARRAY_INITBUF_OFFSET UNITYSDK_OFFSET(0x19F0B8B0)
#define FOUNDATION_BYTEARRAY_MOVEPOSITION_OFFSET UNITYSDK_OFFSET(0x19F0B9A0)
#define FOUNDATION_BYTEARRAY_RELEASE_OFFSET UNITYSDK_OFFSET(0x19F0B7B0)
#define FOUNDATION_BYTEARRAY_RESET_OFFSET UNITYSDK_OFFSET(0x19F0BA30)
#define FOUNDATION_BYTEARRAY__CCTOR_OFFSET UNITYSDK_OFFSET(0x19F0BAE0)
#define FOUNDATION_BYTEARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x19F0B7A0)

namespace Foundation
{
	inline static constexpr unsigned int ByteArray_TypeDefinitionIndex = 7725;
	...
	public:
		...
		{
			return (::Il2CppArray<::System::Byte>**)Il2CppClass::FromTypeDefinitionIndex(ByteArray_TypeDefinitionIndex)->GetStaticField(0x6F20);
		}
		static ::System::Collections::Generic::Queue_1<::Foundation::ByteArray*>** StaticGet__pool()
		{
			return (::System::Collections::Generic::Queue_1<::Foundation::ByteArray*>**)Il2CppClass::FromTypeDefinitionIndex(ByteArray_TypeDefinitionIndex)->GetStaticField(0x6F28);
		}
