...
#define FOUNDATION_EFFECTPOOL___C__DISPLAYCLASS32_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA14470)
#define FOUNDATION_EFFECTPOOL___C__DISPLAYCLASS32_0__GETINSTANCEASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1AA14480)

namespace Foundation
{
	inline static constexpr unsigned int EffectPool___c__DisplayClass32_0_TypeDefinitionIndex = 8072;
