...
#define FOUNDATION_LERPFLOATFUNC_FOUNDATION_ILERPFUNC_SYSTEM_SINGLE__LERP_OFFSET UNITYSDK_OFFSET(0x990470)

namespace Foundation
{
	inline static constexpr unsigned int LerpFloatFunc_TypeDefinitionIndex = 9067;
