...
#define FOUNDATION_READWRITELOCKSLIMX_PERFORMUSINGREADLOCK_OFFSET UNITYSDK_OFFSET(0x1B0F7F80)
#define FOUNDATION_READWRITELOCKSLIMX_PERFORMUSINGUPGRADEABLEREADLOCK_OFFSET UNITYSDK_OFFSET(0x1B0F81E0)
#define FOUNDATION_READWRITELOCKSLIMX_PERFORMUSINGWRITELOCK_OFFSET UNITYSDK_OFFSET(0x1B0F80B0)

namespace Foundation
{
	inline static constexpr unsigned int ReadWriteLockSlimX_TypeDefinitionIndex = 8205;
