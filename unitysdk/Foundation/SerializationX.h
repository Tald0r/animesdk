...
#define FOUNDATION_SERIALIZATIONX_GUIDFROMSERIALSTRING_OFFSET UNITYSDK_OFFSET(0x1940CB00)
#define FOUNDATION_SERIALIZATIONX_GUIDNULLABLEFROMSERIALSTRING_OFFSET UNITYSDK_OFFSET(0x1940CA30)
#define FOUNDATION_SERIALIZATIONX_READBBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1940CC60)
#define FOUNDATION_SERIALIZATIONX_READDATETIMEASLOCALTIME_OFFSET UNITYSDK_OFFSET(0x1940D390)
#define FOUNDATION_SERIALIZATIONX_READDATETIMEASUTC_OFFSET UNITYSDK_OFFSET(0x1940D2D0)
#define FOUNDATION_SERIALIZATIONX_READGUIDNULLABLE_OFFSET UNITYSDK_OFFSET(0x1940CEC0)
#define FOUNDATION_SERIALIZATIONX_READGUID_OFFSET UNITYSDK_OFFSET(0x1940CF60)
#define FOUNDATION_SERIALIZATIONX_READVECTOR2_OFFSET UNITYSDK_OFFSET(0x1940D860)
#define FOUNDATION_SERIALIZATIONX_READVECTOR3_OFFSET UNITYSDK_OFFSET(0x1940D780)
#define FOUNDATION_SERIALIZATIONX_TOSTRINGSERIAL_1_OFFSET UNITYSDK_OFFSET(0x1940C840)
#define FOUNDATION_SERIALIZATIONX_TOSTRINGSERIAL_2_OFFSET UNITYSDK_OFFSET(0x1940C9B0)
#define FOUNDATION_SERIALIZATIONX_TOSTRINGSERIAL_OFFSET UNITYSDK_OFFSET(0x1940C7B0)
#define FOUNDATION_SERIALIZATIONX_WRITEBOOL_OFFSET UNITYSDK_OFFSET(0x1940D910)
#define FOUNDATION_SERIALIZATIONX_WRITEBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1940CBA0)
#define FOUNDATION_SERIALIZATIONX_WRITEDATETIME_OFFSET UNITYSDK_OFFSET(0x1940D1A0)
#define FOUNDATION_SERIALIZATIONX_WRITEFLOAT_OFFSET UNITYSDK_OFFSET(0x1940D580)
#define FOUNDATION_SERIALIZATIONX_WRITEGUID_1_OFFSET UNITYSDK_OFFSET(0x1940CDB0)
#define FOUNDATION_SERIALIZATIONX_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x1940CD00)
#define FOUNDATION_SERIALIZATIONX_WRITEINT_OFFSET UNITYSDK_OFFSET(0x1940D460)
#define FOUNDATION_SERIALIZATIONX_WRITELONG_OFFSET UNITYSDK_OFFSET(0x1940D4F0)
#define FOUNDATION_SERIALIZATIONX_WRITESERIALIZEDSTRING_OFFSET UNITYSDK_OFFSET(0x1940D080)
#define FOUNDATION_SERIALIZATIONX_WRITEVECTOR2_OFFSET UNITYSDK_OFFSET(0x1940D6D0)
#define FOUNDATION_SERIALIZATIONX_WRITEVECTOR3_OFFSET UNITYSDK_OFFSET(0x1940D610)

namespace Foundation
{
	inline static constexpr unsigned int SerializationX_TypeDefinitionIndex = 8167;
