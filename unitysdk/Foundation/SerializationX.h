...
#define FOUNDATION_SERIALIZATIONX_GUIDFROMSERIALSTRING_OFFSET UNITYSDK_OFFSET(0x1998EBF0)
#define FOUNDATION_SERIALIZATIONX_GUIDNULLABLEFROMSERIALSTRING_OFFSET UNITYSDK_OFFSET(0x1998EB20)
#define FOUNDATION_SERIALIZATIONX_READBBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1998ED50)
#define FOUNDATION_SERIALIZATIONX_READDATETIMEASLOCALTIME_OFFSET UNITYSDK_OFFSET(0x1998F480)
#define FOUNDATION_SERIALIZATIONX_READDATETIMEASUTC_OFFSET UNITYSDK_OFFSET(0x1998F3C0)
#define FOUNDATION_SERIALIZATIONX_READGUIDNULLABLE_OFFSET UNITYSDK_OFFSET(0x1998EFB0)
#define FOUNDATION_SERIALIZATIONX_READGUID_OFFSET UNITYSDK_OFFSET(0x1998F050)
#define FOUNDATION_SERIALIZATIONX_READVECTOR2_OFFSET UNITYSDK_OFFSET(0x1998F950)
#define FOUNDATION_SERIALIZATIONX_READVECTOR3_OFFSET UNITYSDK_OFFSET(0x1998F870)
#define FOUNDATION_SERIALIZATIONX_TOSTRINGSERIAL_1_OFFSET UNITYSDK_OFFSET(0x1998E930)
#define FOUNDATION_SERIALIZATIONX_TOSTRINGSERIAL_2_OFFSET UNITYSDK_OFFSET(0x1998EAA0)
#define FOUNDATION_SERIALIZATIONX_TOSTRINGSERIAL_OFFSET UNITYSDK_OFFSET(0x1998E8A0)
#define FOUNDATION_SERIALIZATIONX_WRITEBOOL_OFFSET UNITYSDK_OFFSET(0x1998FA00)
#define FOUNDATION_SERIALIZATIONX_WRITEBYTEARRAY_OFFSET UNITYSDK_OFFSET(0x1998EC90)
#define FOUNDATION_SERIALIZATIONX_WRITEDATETIME_OFFSET UNITYSDK_OFFSET(0x1998F290)
#define FOUNDATION_SERIALIZATIONX_WRITEFLOAT_OFFSET UNITYSDK_OFFSET(0x1998F670)
#define FOUNDATION_SERIALIZATIONX_WRITEGUID_1_OFFSET UNITYSDK_OFFSET(0x1998EEA0)
#define FOUNDATION_SERIALIZATIONX_WRITEGUID_OFFSET UNITYSDK_OFFSET(0x1998EDF0)
#define FOUNDATION_SERIALIZATIONX_WRITEINT_OFFSET UNITYSDK_OFFSET(0x1998F550)
#define FOUNDATION_SERIALIZATIONX_WRITELONG_OFFSET UNITYSDK_OFFSET(0x1998F5E0)
#define FOUNDATION_SERIALIZATIONX_WRITESERIALIZEDSTRING_OFFSET UNITYSDK_OFFSET(0x1998F170)
#define FOUNDATION_SERIALIZATIONX_WRITEVECTOR2_OFFSET UNITYSDK_OFFSET(0x1998F7C0)
#define FOUNDATION_SERIALIZATIONX_WRITEVECTOR3_OFFSET UNITYSDK_OFFSET(0x1998F700)

namespace Foundation
{
	inline static constexpr unsigned int SerializationX_TypeDefinitionIndex = 7783;
