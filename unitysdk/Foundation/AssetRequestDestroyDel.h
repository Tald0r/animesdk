...
#define FOUNDATION_ASSETREQUESTDESTROYDEL_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1AA29E00)
#define FOUNDATION_ASSETREQUESTDESTROYDEL_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1AA29E50)
#define FOUNDATION_ASSETREQUESTDESTROYDEL_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AA299A0)
#define FOUNDATION_ASSETREQUESTDESTROYDEL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA29980)

namespace Foundation
{
	inline static constexpr unsigned int AssetRequestDestroyDel_TypeDefinitionIndex = 8229;
