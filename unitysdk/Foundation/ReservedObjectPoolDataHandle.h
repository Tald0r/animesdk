...
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x331E50)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x331E40)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_GETDATAINSTANCE_OFFSET UNITYSDK_OFFSET(0x331E10)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x331EE0)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x331D90)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x79F4050)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x79F4150)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_PUSHSELF_OFFSET UNITYSDK_OFFSET(0x331E20)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_RELEASESELF_OFFSET UNITYSDK_OFFSET(0x331E30)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x331D70)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x331F60)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x331FD0)

namespace Foundation
{
	inline static constexpr unsigned int ReservedObjectPoolDataHandle_TypeDefinitionIndex = 69881;
