...
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x3911C0)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3911B0)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_GETDATAINSTANCE_OFFSET UNITYSDK_OFFSET(0x391180)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x391250)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_ISVALID_OFFSET UNITYSDK_OFFSET(0x391100)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0xA798E90)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0xA798F90)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_PUSHSELF_OFFSET UNITYSDK_OFFSET(0x391190)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE_RELEASESELF_OFFSET UNITYSDK_OFFSET(0x3911A0)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE__CTOR_OFFSET UNITYSDK_OFFSET(0x3910E0)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x3912D0)
#define FOUNDATION_RESERVEDOBJECTPOOLDATAHANDLE___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x391340)

namespace Foundation
{
	inline static constexpr unsigned int ReservedObjectPoolDataHandle_TypeDefinitionIndex = 77812;
