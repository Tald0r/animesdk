...
#define FOUNDATION_BUNDLEID_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8B7F00)
#define FOUNDATION_BUNDLEID_EQUALS_OFFSET UNITYSDK_OFFSET(0x8B7E70)
#define FOUNDATION_BUNDLEID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8B7E00)
#define FOUNDATION_BUNDLEID_ISVALID_OFFSET UNITYSDK_OFFSET(0x8B7D90)
#define FOUNDATION_BUNDLEID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8B7F70)
#define FOUNDATION_BUNDLEID__CCTOR_OFFSET UNITYSDK_OFFSET(0x19975120)
#define FOUNDATION_BUNDLEID__CTOR_OFFSET UNITYSDK_OFFSET(0x3074E0)
#define FOUNDATION_BUNDLEID___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8B8020)
#define FOUNDATION_BUNDLEID___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8B8060)
#define FOUNDATION_BUNDLEID___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8B80A0)

namespace Foundation
{
	inline static constexpr unsigned int BundleID_TypeDefinitionIndex = 8148;
	...
	struct alignas(8) BundleID
	{
		...
		{
			return (::Foundation::BundleID*)Il2CppClass::FromTypeDefinitionIndex(BundleID_TypeDefinitionIndex)->GetStaticField(0x35F0);
		}
