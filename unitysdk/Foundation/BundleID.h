...
#define FOUNDATION_BUNDLEID_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x883C30)
#define FOUNDATION_BUNDLEID_EQUALS_OFFSET UNITYSDK_OFFSET(0x883BA0)
#define FOUNDATION_BUNDLEID_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x883B30)
#define FOUNDATION_BUNDLEID_ISVALID_OFFSET UNITYSDK_OFFSET(0x883AC0)
#define FOUNDATION_BUNDLEID_TOSTRING_OFFSET UNITYSDK_OFFSET(0x883CA0)
#define FOUNDATION_BUNDLEID__CCTOR_OFFSET UNITYSDK_OFFSET(0x193F3000)
#define FOUNDATION_BUNDLEID__CTOR_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define FOUNDATION_BUNDLEID___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x883D50)
#define FOUNDATION_BUNDLEID___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x883D90)
#define FOUNDATION_BUNDLEID___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x883DD0)

namespace Foundation
{
	inline static constexpr unsigned int BundleID_TypeDefinitionIndex = 8006;

	struct alignas(8) BundleID
	{
		static ::Il2CppArray<::Foundation::BundleID>** StaticGet_EmptyArray()
		{
			return (::Il2CppArray<::Foundation::BundleID>**)Il2CppClass::FromTypeDefinitionIndex(BundleID_TypeDefinitionIndex)->GetStaticField(0x6C50);
		}
		static ::Foundation::BundleID* StaticGet_None()
		{
			return (::Foundation::BundleID*)Il2CppClass::FromTypeDefinitionIndex(BundleID_TypeDefinitionIndex)->GetStaticField(0x35E0);
		}
