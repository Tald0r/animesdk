...
#define FOUNDATION_TICKSERVICE_FOUNDATION_IGAMESERVICE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x197130F0)
#define FOUNDATION_TICKSERVICE_FOUNDATION_IGAMESERVICE_ONREADYTODESTROY_OFFSET UNITYSDK_OFFSET(0x197130E0)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__ADDTICKFUNCTION_OFFSET UNITYSDK_OFFSET(0x19712CB0)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__ENDSUBFRAME_OFFSET UNITYSDK_OFFSET(0x19712B70)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__HASTICKFUNCTION_OFFSET UNITYSDK_OFFSET(0x19712BC0)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__MARKDEPENDENCYGRAPHDIRTY_OFFSET UNITYSDK_OFFSET(0x19713000)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__REMOVETICKFUNCTION_OFFSET UNITYSDK_OFFSET(0x19712F20)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__RUNTTICKGROUP_OFFSET UNITYSDK_OFFSET(0x19712B20)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__STARTFRAME_OFFSET UNITYSDK_OFFSET(0x19712A80)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__STARTNEXTSUBFRAME_OFFSET UNITYSDK_OFFSET(0x19712AD0)
#define FOUNDATION_TICKSERVICE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x197127E0)
#define FOUNDATION_TICKSERVICE_UPDATE_OFFSET UNITYSDK_OFFSET(0x19712480)
#define FOUNDATION_TICKSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x19713100)

namespace Foundation
{
	inline static constexpr unsigned int TickService_TypeDefinitionIndex = 9080;
