...
#define FOUNDATION_TICKSERVICE_FOUNDATION_IGAMESERVICE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C5BE70)
#define FOUNDATION_TICKSERVICE_FOUNDATION_IGAMESERVICE_ONREADYTODESTROY_OFFSET UNITYSDK_OFFSET(0x19C5BE60)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__ADDTICKFUNCTION_OFFSET UNITYSDK_OFFSET(0x19C5BA40)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__ENDSUBFRAME_OFFSET UNITYSDK_OFFSET(0x19C5B900)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__HASTICKFUNCTION_OFFSET UNITYSDK_OFFSET(0x19C5B950)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__MARKDEPENDENCYGRAPHDIRTY_OFFSET UNITYSDK_OFFSET(0x19C5BD80)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__REMOVETICKFUNCTION_OFFSET UNITYSDK_OFFSET(0x19C5BCA0)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__RUNTTICKGROUP_OFFSET UNITYSDK_OFFSET(0x19C5B8B0)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__STARTFRAME_OFFSET UNITYSDK_OFFSET(0x19C5B810)
#define FOUNDATION_TICKSERVICE_FOUNDATION_ITICKSERVICE_FOUNDATION_ETICKINGGROUP__STARTNEXTSUBFRAME_OFFSET UNITYSDK_OFFSET(0x19C5B860)
#define FOUNDATION_TICKSERVICE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x19C5B570)
#define FOUNDATION_TICKSERVICE_UPDATE_OFFSET UNITYSDK_OFFSET(0x19C5B210)
#define FOUNDATION_TICKSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5BE80)

namespace Foundation
{
	inline static constexpr unsigned int TickService_TypeDefinitionIndex = 8981;
