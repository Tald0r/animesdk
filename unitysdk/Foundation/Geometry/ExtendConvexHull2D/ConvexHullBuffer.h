...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x302AD0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER_SET_1_OFFSET UNITYSDK_OFFSET(0x9839D0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER_SET_2_OFFSET UNITYSDK_OFFSET(0x983A60)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER_SET_OFFSET UNITYSDK_OFFSET(0x983920)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x5585F0)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int ConvexHullBuffer_TypeDefinitionIndex = 8888;
