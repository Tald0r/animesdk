...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x2CB090)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER_SET_1_OFFSET UNITYSDK_OFFSET(0x959CC0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER_SET_2_OFFSET UNITYSDK_OFFSET(0x959D50)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER_SET_OFFSET UNITYSDK_OFFSET(0x959C10)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULLBUFFER__CTOR_OFFSET UNITYSDK_OFFSET(0x52C4B0)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int ConvexHullBuffer_TypeDefinitionIndex = 8976;
