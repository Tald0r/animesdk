...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CONVEXHULLVERTEX_GET_POSITION_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CONVEXHULLVERTEX__CTOR_OFFSET UNITYSDK_OFFSET(0x324900)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int ConvexHull_ConvexHullVertex_TypeDefinitionIndex = 8929;
