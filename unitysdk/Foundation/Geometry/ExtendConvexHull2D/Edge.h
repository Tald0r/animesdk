...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GETPOINT_OFFSET UNITYSDK_OFFSET(0x940AA0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GET_ARCAREA_OFFSET UNITYSDK_OFFSET(0x9408A0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GET_END_OFFSET UNITYSDK_OFFSET(0x9409F0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GET_MAXX_OFFSET UNITYSDK_OFFSET(0x940A80)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GET_MAXY_OFFSET UNITYSDK_OFFSET(0x940A90)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GET_MINX_OFFSET UNITYSDK_OFFSET(0x940A70)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_GET_START_OFFSET UNITYSDK_OFFSET(0x940970)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_NEW_1_OFFSET UNITYSDK_OFFSET(0x1A794280)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_NEW_2_OFFSET UNITYSDK_OFFSET(0x1A794370)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE_NEW_OFFSET UNITYSDK_OFFSET(0x1A794070)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x940B10)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGE__CTOR_OFFSET UNITYSDK_OFFSET(0x940AB0)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int Edge_TypeDefinitionIndex = 9112;

	struct alignas(8) Edge
	{
		static ::Foundation::Geometry::ExtendConvexHull2D::Edge* StaticGet_Null()
		{
			return (::Foundation::Geometry::ExtendConvexHull2D::Edge*)Il2CppClass::FromTypeDefinitionIndex(Edge_TypeDefinitionIndex)->GetStaticField(0x3F10);
		}
