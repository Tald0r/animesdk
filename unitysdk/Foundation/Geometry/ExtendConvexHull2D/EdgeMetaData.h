...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA_GENERATE_1_OFFSET UNITYSDK_OFFSET(0x983CB0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA_GENERATE_OFFSET UNITYSDK_OFFSET(0x983C90)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1B07F740)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x983C20)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x983C40)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x983B10)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int EdgeMetaData_TypeDefinitionIndex = 8912;
