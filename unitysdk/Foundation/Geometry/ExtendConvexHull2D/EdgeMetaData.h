...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA_GENERATE_1_OFFSET UNITYSDK_OFFSET(0x959FA0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA_GENERATE_OFFSET UNITYSDK_OFFSET(0x959F80)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1AB30760)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x959F10)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA__CTOR_2_OFFSET UNITYSDK_OFFSET(0x959F30)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_EDGEMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x959E00)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int EdgeMetaData_TypeDefinitionIndex = 8975;
