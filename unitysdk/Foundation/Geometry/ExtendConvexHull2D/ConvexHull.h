...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CREATEPROJECTIONCONVEXHULL_1_OFFSET UNITYSDK_OFFSET(0x19C59A90)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CREATEPROJECTIONCONVEXHULL_2_OFFSET UNITYSDK_OFFSET(0x19C5A0A0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CREATEPROJECTIONCONVEXHULL_OFFSET UNITYSDK_OFFSET(0x19C59870)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CROSSCULLOUTAREA_OFFSET UNITYSDK_OFFSET(0x19C54BF0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLNOINTERSECTION_OFFSET UNITYSDK_OFFSET(0x19C54FD0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLONEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x19C53390)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLPOINT_OFFSET UNITYSDK_OFFSET(0x19C54500)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLTWOINTERSECTION_OFFSET UNITYSDK_OFFSET(0x19C53BE0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULL_OFFSET UNITYSDK_OFFSET(0x8D56B0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_ENTERCULLOUTAREA_OFFSET UNITYSDK_OFFSET(0x19C54570)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_EXITCULLOUTAREA_OFFSET UNITYSDK_OFFSET(0x19C54960)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GENERATECONVEXHULLFROMCONVEXLINES_OFFSET UNITYSDK_OFFSET(0x19C58930)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GENERATECUSTOMEQUATIONXINTERSECTION_OFFSET UNITYSDK_OFFSET(0x19C55B00)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GENERATECUSTOMEQUATIONYINTERSECTION_OFFSET UNITYSDK_OFFSET(0x19C55990)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETCONVEXLINES_OFFSET UNITYSDK_OFFSET(0x19C56370)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETEDGE_OFFSET UNITYSDK_OFFSET(0x8D5730)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETLINEFROMCUSTOMEQUATION_OFFSET UNITYSDK_OFFSET(0x19C55CA0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETSPHEREPROJECTIONELLIPSE_OFFSET UNITYSDK_OFFSET(0x19C55300)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_AREA_OFFSET UNITYSDK_OFFSET(0x8D53A0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_EDGECOUNT_OFFSET UNITYSDK_OFFSET(0x302AD0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x8D5380)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x8D5340)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_MAXX_OFFSET UNITYSDK_OFFSET(0x8D5490)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_MAXY_OFFSET UNITYSDK_OFFSET(0x8D55D0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_MINX_OFFSET UNITYSDK_OFFSET(0x8D53B0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_NULL_OFFSET UNITYSDK_OFFSET(0x19C50910)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_PUSHEDGE_OFFSET UNITYSDK_OFFSET(0x19C54D60)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8D5750)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL__CTOR_OFFSET UNITYSDK_OFFSET(0x5585F0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL__GENERATECONVEXHULLFROMCONVEXLINES_G__LINEINTERSECTION_44_0_OFFSET UNITYSDK_OFFSET(0x19C59540)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int ConvexHull_TypeDefinitionIndex = 9126;
