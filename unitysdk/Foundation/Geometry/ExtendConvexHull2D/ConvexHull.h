...
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CREATEPROJECTIONCONVEXHULL_1_OFFSET UNITYSDK_OFFSET(0x19710CD0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CREATEPROJECTIONCONVEXHULL_2_OFFSET UNITYSDK_OFFSET(0x197112E0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CREATEPROJECTIONCONVEXHULL_OFFSET UNITYSDK_OFFSET(0x19710AB0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CROSSCULLOUTAREA_OFFSET UNITYSDK_OFFSET(0x1970BFC0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLNOINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1970C3A0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLONEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1970A780)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLPOINT_OFFSET UNITYSDK_OFFSET(0x1970B8E0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULLTWOINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1970AFC0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_CULL_OFFSET UNITYSDK_OFFSET(0x8A6C70)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_ENTERCULLOUTAREA_OFFSET UNITYSDK_OFFSET(0x1970B940)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_EXITCULLOUTAREA_OFFSET UNITYSDK_OFFSET(0x1970BD30)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GENERATECONVEXHULLFROMCONVEXLINES_OFFSET UNITYSDK_OFFSET(0x1970FB70)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GENERATECUSTOMEQUATIONXINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1970CEB0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GENERATECUSTOMEQUATIONYINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1970CD60)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETCONVEXLINES_OFFSET UNITYSDK_OFFSET(0x1970D6D0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETEDGE_OFFSET UNITYSDK_OFFSET(0x8A6CF0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETLINEFROMCUSTOMEQUATION_OFFSET UNITYSDK_OFFSET(0x1970D000)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GETSPHEREPROJECTIONELLIPSE_OFFSET UNITYSDK_OFFSET(0x1970C6D0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_AREA_OFFSET UNITYSDK_OFFSET(0x8A6960)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_EDGECOUNT_OFFSET UNITYSDK_OFFSET(0x2CB090)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x8A6940)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x8A6900)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_MAXX_OFFSET UNITYSDK_OFFSET(0x8A6A50)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_MAXY_OFFSET UNITYSDK_OFFSET(0x8A6B90)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_MINX_OFFSET UNITYSDK_OFFSET(0x8A6970)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_GET_NULL_OFFSET UNITYSDK_OFFSET(0x19707D00)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL_PUSHEDGE_OFFSET UNITYSDK_OFFSET(0x1970C130)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8A6D10)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL__CTOR_OFFSET UNITYSDK_OFFSET(0x52C4B0)
#define FOUNDATION_GEOMETRY_EXTENDCONVEXHULL2D_CONVEXHULL__GENERATECONVEXHULLFROMCONVEXLINES_G__LINEINTERSECTION_44_0_OFFSET UNITYSDK_OFFSET(0x19710780)

namespace Foundation::Geometry::ExtendConvexHull2D
{
	inline static constexpr unsigned int ConvexHull_TypeDefinitionIndex = 8928;
