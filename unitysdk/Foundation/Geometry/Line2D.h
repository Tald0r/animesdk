...
#define FOUNDATION_GEOMETRY_LINE2D_CREATE_OFFSET UNITYSDK_OFFSET(0x1B0DE5B0)
#define FOUNDATION_GEOMETRY_LINE2D_GET_ISDEGENERATE_OFFSET UNITYSDK_OFFSET(0x9870B0)
#define FOUNDATION_GEOMETRY_LINE2D_ON_OFFSET UNITYSDK_OFFSET(0x9870F0)
#define FOUNDATION_GEOMETRY_LINE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x301710)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Line2D_TypeDefinitionIndex = 9119;
