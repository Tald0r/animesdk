...
#define FOUNDATION_GEOMETRY_LINE2D_CREATE_OFFSET UNITYSDK_OFFSET(0x1AA8C750)
#define FOUNDATION_GEOMETRY_LINE2D_GET_ISDEGENERATE_OFFSET UNITYSDK_OFFSET(0x9514E0)
#define FOUNDATION_GEOMETRY_LINE2D_ON_OFFSET UNITYSDK_OFFSET(0x951520)
#define FOUNDATION_GEOMETRY_LINE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x2D6E20)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Line2D_TypeDefinitionIndex = 8761;
