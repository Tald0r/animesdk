...
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER_FINDMINPOINTANDPLACEITATFIRST_OFFSET UNITYSDK_OFFSET(0x983240)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER_SCANPOINTSANDBUILDCONVEXHULL_OFFSET UNITYSDK_OFFSET(0x983430)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER_SOLVE_OFFSET UNITYSDK_OFFSET(0x982BA0)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER_SORTPOINTSBYPOLARANDDISTANCE_OFFSET UNITYSDK_OFFSET(0x983330)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x34B600)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int ConvexHull2D_ConvexHullGrahamSolver_TypeDefinitionIndex = 8778;
