...
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER_FINDMINPOINTANDPLACEITATFIRST_OFFSET UNITYSDK_OFFSET(0x959530)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER_SCANPOINTSANDBUILDCONVEXHULL_OFFSET UNITYSDK_OFFSET(0x959720)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER_SOLVE_OFFSET UNITYSDK_OFFSET(0x958E90)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER_SORTPOINTSBYPOLARANDDISTANCE_OFFSET UNITYSDK_OFFSET(0x959620)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_CONVEXHULLGRAHAMSOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x2CFB20)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int ConvexHull2D_ConvexHullGrahamSolver_TypeDefinitionIndex = 8944;
