...
#define FOUNDATION_GEOMETRY_SEGMENT2D_GET_CENTER_OFFSET UNITYSDK_OFFSET(0x8A6EB0)
#define FOUNDATION_GEOMETRY_SEGMENT2D_GET_ISDEGENERATE_OFFSET UNITYSDK_OFFSET(0x8A6E30)
#define FOUNDATION_GEOMETRY_SEGMENT2D_GET_LENGTH_OFFSET UNITYSDK_OFFSET(0x8A6EF0)
#define FOUNDATION_GEOMETRY_SEGMENT2D_GET_VECTOR_OFFSET UNITYSDK_OFFSET(0x8A6E80)
#define FOUNDATION_GEOMETRY_SEGMENT2D_ONLEFT_OFFSET UNITYSDK_OFFSET(0x8A6D60)
#define FOUNDATION_GEOMETRY_SEGMENT2D__CTOR_OFFSET UNITYSDK_OFFSET(0x2D6E20)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Segment2D_TypeDefinitionIndex = 8766;
