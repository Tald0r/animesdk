...
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_FINDMINPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x1B07DC20)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_GENERATECONVEXHULLGRAHAM_OFFSET UNITYSDK_OFFSET(0x1B07DDC0)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_SWAP_OFFSET UNITYSDK_OFFSET(0x1B07DD50)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int ConvexHull2D_TypeDefinitionIndex = 8773;
