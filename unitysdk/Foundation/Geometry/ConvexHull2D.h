...
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_FINDMINPOINTINDEX_OFFSET UNITYSDK_OFFSET(0x1AB2EC40)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_GENERATECONVEXHULLGRAHAM_OFFSET UNITYSDK_OFFSET(0x1AB2EDE0)
#define FOUNDATION_GEOMETRY_CONVEXHULL2D_SWAP_OFFSET UNITYSDK_OFFSET(0x1AB2ED70)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int ConvexHull2D_TypeDefinitionIndex = 8940;
