...
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D_GET_AREA_OFFSET UNITYSDK_OFFSET(0x9ADAD0)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D_GET_ENDTHETA_OFFSET UNITYSDK_OFFSET(0x9ADAC0)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x9AD7B0)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_2_OFFSET UNITYSDK_OFFSET(0x9AD880)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_3_OFFSET UNITYSDK_OFFSET(0x9AD8C0)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_OFFSET UNITYSDK_OFFSET(0x9AD720)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int EllipseArc2D_TypeDefinitionIndex = 9008;
