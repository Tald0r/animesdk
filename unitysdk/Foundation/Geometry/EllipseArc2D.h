...
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D_GET_AREA_OFFSET UNITYSDK_OFFSET(0x97A060)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D_GET_ENDTHETA_OFFSET UNITYSDK_OFFSET(0x97A050)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_1_OFFSET UNITYSDK_OFFSET(0x979D40)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_2_OFFSET UNITYSDK_OFFSET(0x979E10)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_3_OFFSET UNITYSDK_OFFSET(0x979E50)
#define FOUNDATION_GEOMETRY_ELLIPSEARC2D__CTOR_OFFSET UNITYSDK_OFFSET(0x979CB0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int EllipseArc2D_TypeDefinitionIndex = 8935;
