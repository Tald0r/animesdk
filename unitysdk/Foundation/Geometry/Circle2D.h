...
#define FOUNDATION_GEOMETRY_CIRCLE2D_CONTAINS_OFFSET UNITYSDK_OFFSET(0x967B70)
#define FOUNDATION_GEOMETRY_CIRCLE2D_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1AE3F920)
#define FOUNDATION_GEOMETRY_CIRCLE2D_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1AE3F9C0)
#define FOUNDATION_GEOMETRY_CIRCLE2D_CREATE_OFFSET UNITYSDK_OFFSET(0x1AE3F910)
#define FOUNDATION_GEOMETRY_CIRCLE2D_GET_ISDEGENERATE_OFFSET UNITYSDK_OFFSET(0x967B40)
#define FOUNDATION_GEOMETRY_CIRCLE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x30B7B0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Circle2D_TypeDefinitionIndex = 9106;
