...
#define FOUNDATION_GEOMETRY_CIRCLE2D_CONTAINS_OFFSET UNITYSDK_OFFSET(0x998A50)
#define FOUNDATION_GEOMETRY_CIRCLE2D_CREATE_1_OFFSET UNITYSDK_OFFSET(0x1B456B30)
#define FOUNDATION_GEOMETRY_CIRCLE2D_CREATE_2_OFFSET UNITYSDK_OFFSET(0x1B456BD0)
#define FOUNDATION_GEOMETRY_CIRCLE2D_CREATE_OFFSET UNITYSDK_OFFSET(0x1B456B20)
#define FOUNDATION_GEOMETRY_CIRCLE2D_GET_ISDEGENERATE_OFFSET UNITYSDK_OFFSET(0x998A20)
#define FOUNDATION_GEOMETRY_CIRCLE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x2EB420)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Circle2D_TypeDefinitionIndex = 8861;
