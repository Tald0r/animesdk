...
#define FOUNDATION_GEOMETRY_INTERSECTION2D_LINEINTERSECTION_1_OFFSET UNITYSDK_OFFSET(0x1A71B180)
#define FOUNDATION_GEOMETRY_INTERSECTION2D_LINEINTERSECTION_2_OFFSET UNITYSDK_OFFSET(0x1A71C810)
#define FOUNDATION_GEOMETRY_INTERSECTION2D_LINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1A71AF50)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Intersection2D_TypeDefinitionIndex = 8787;
