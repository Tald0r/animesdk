...
#define FOUNDATION_GEOMETRY_INTERSECTION2D_LINEINTERSECTION_1_OFFSET UNITYSDK_OFFSET(0x1AB226D0)
#define FOUNDATION_GEOMETRY_INTERSECTION2D_LINEINTERSECTION_2_OFFSET UNITYSDK_OFFSET(0x1AB23D60)
#define FOUNDATION_GEOMETRY_INTERSECTION2D_LINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1AB224A0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Intersection2D_TypeDefinitionIndex = 8948;
