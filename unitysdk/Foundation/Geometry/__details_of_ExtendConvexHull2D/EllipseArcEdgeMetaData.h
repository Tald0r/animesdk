...
#define FOUNDATION_GEOMETRY___DETAILS_OF_EXTENDCONVEXHULL2D_ELLIPSEARCEDGEMETADATA_GENERATE_1_OFFSET UNITYSDK_OFFSET(0x969430)
#define FOUNDATION_GEOMETRY___DETAILS_OF_EXTENDCONVEXHULL2D_ELLIPSEARCEDGEMETADATA_GENERATE_OFFSET UNITYSDK_OFFSET(0x9691B0)
#define FOUNDATION_GEOMETRY___DETAILS_OF_EXTENDCONVEXHULL2D_ELLIPSEARCEDGEMETADATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x3B8DC0)
#define FOUNDATION_GEOMETRY___DETAILS_OF_EXTENDCONVEXHULL2D_ELLIPSEARCEDGEMETADATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3B8DC0)

namespace Foundation::Geometry::__details_of_ExtendConvexHull2D
{
	inline static constexpr unsigned int EllipseArcEdgeMetaData_TypeDefinitionIndex = 9186;
