...
#define FOUNDATION_GEOMETRY_BEZIERDETAIL_SURFACEBERNSTEINMATRIXPROXY_GET_OFFSET UNITYSDK_OFFSET(0x965850)
#define FOUNDATION_GEOMETRY_BEZIERDETAIL_SURFACEBERNSTEINMATRIXPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x52C4B0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int BezierDetail_SurfaceBernsteinMatrixProxy_TypeDefinitionIndex = 9133;
