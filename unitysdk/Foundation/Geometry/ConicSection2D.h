...
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GENERATEQUADRATICEQUATIONX_OFFSET UNITYSDK_OFFSET(0x8D1630)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GENERATEQUADRATICEQUATIONY_OFFSET UNITYSDK_OFFSET(0x8D16E0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x8D15B0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETSCALE_OFFSET UNITYSDK_OFFSET(0x19C50680)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETTANGENTLINEXINTERSECTION_OFFSET UNITYSDK_OFFSET(0x8D2B90)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETTANGENTLINEYINTERSECTION_OFFSET UNITYSDK_OFFSET(0x8D27F0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETTANGENTPOINT_OFFSET UNITYSDK_OFFSET(0x8D2F30)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETTYPE_OFFSET UNITYSDK_OFFSET(0x19C50790)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GET_ELLIPSE_OFFSET UNITYSDK_OFFSET(0x8D2450)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GET_ISELLIPSE_OFFSET UNITYSDK_OFFSET(0x8D15A0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_INTERSECTIONSOFLINE_OFFSET UNITYSDK_OFFSET(0x8D1780)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_NEW_1_OFFSET UNITYSDK_OFFSET(0x19C50540)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_NEW_OFFSET UNITYSDK_OFFSET(0x19C50260)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_SOLVE_OFFSET UNITYSDK_OFFSET(0x19C4C0D0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D__CTOR_OFFSET UNITYSDK_OFFSET(0x8D5310)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int ConicSection2D_TypeDefinitionIndex = 9167;
