...
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GENERATEQUADRATICEQUATIONX_OFFSET UNITYSDK_OFFSET(0x8A2C20)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GENERATEQUADRATICEQUATIONY_OFFSET UNITYSDK_OFFSET(0x8A2CB0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x8A2BA0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETSCALE_OFFSET UNITYSDK_OFFSET(0x19707A70)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETTANGENTLINEXINTERSECTION_OFFSET UNITYSDK_OFFSET(0x8A4150)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETTANGENTLINEYINTERSECTION_OFFSET UNITYSDK_OFFSET(0x8A3DB0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETTANGENTPOINT_OFFSET UNITYSDK_OFFSET(0x8A44F0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GETTYPE_OFFSET UNITYSDK_OFFSET(0x19707B80)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GET_ELLIPSE_OFFSET UNITYSDK_OFFSET(0x8A3A10)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_GET_ISELLIPSE_OFFSET UNITYSDK_OFFSET(0x8A2B90)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_INTERSECTIONSOFLINE_OFFSET UNITYSDK_OFFSET(0x8A2D40)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_NEW_1_OFFSET UNITYSDK_OFFSET(0x19707930)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_NEW_OFFSET UNITYSDK_OFFSET(0x19707650)
#define FOUNDATION_GEOMETRY_CONICSECTION2D_SOLVE_OFFSET UNITYSDK_OFFSET(0x197034F0)
#define FOUNDATION_GEOMETRY_CONICSECTION2D__CTOR_OFFSET UNITYSDK_OFFSET(0x8A68D0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int ConicSection2D_TypeDefinitionIndex = 8762;
