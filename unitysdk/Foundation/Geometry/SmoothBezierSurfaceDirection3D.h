...
#define FOUNDATION_GEOMETRY_SMOOTHBEZIERSURFACEDIRECTION3D_EVALUATE_OFFSET UNITYSDK_OFFSET(0x19C5A900)
#define FOUNDATION_GEOMETRY_SMOOTHBEZIERSURFACEDIRECTION3D_GET_POLICY_OFFSET UNITYSDK_OFFSET(0x19C5A8A0)
#define FOUNDATION_GEOMETRY_SMOOTHBEZIERSURFACEDIRECTION3D__CTOR_OFFSET UNITYSDK_OFFSET(0x19C5ABA0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int SmoothBezierSurfaceDirection3D_TypeDefinitionIndex = 8961;
