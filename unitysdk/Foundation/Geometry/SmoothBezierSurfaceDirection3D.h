...
#define FOUNDATION_GEOMETRY_SMOOTHBEZIERSURFACEDIRECTION3D_EVALUATE_OFFSET UNITYSDK_OFFSET(0x19711B40)
#define FOUNDATION_GEOMETRY_SMOOTHBEZIERSURFACEDIRECTION3D_GET_POLICY_OFFSET UNITYSDK_OFFSET(0x19711AE0)
#define FOUNDATION_GEOMETRY_SMOOTHBEZIERSURFACEDIRECTION3D__CTOR_OFFSET UNITYSDK_OFFSET(0x19711DE0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int SmoothBezierSurfaceDirection3D_TypeDefinitionIndex = 9095;
