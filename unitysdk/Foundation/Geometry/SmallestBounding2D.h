...
#define FOUNDATION_GEOMETRY_SMALLESTBOUNDING2D_CREATECIRCLE_OFFSET UNITYSDK_OFFSET(0x19C4A250)
#define FOUNDATION_GEOMETRY_SMALLESTBOUNDING2D_MINIMUMENCLOSINGCIRCLEHELPER_OFFSET UNITYSDK_OFFSET(0x19C49990)
#define FOUNDATION_GEOMETRY_SMALLESTBOUNDING2D_MINIMUMENCLOSINGCIRCLE_OFFSET UNITYSDK_OFFSET(0x19C497B0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int SmallestBounding2D_TypeDefinitionIndex = 9014;
