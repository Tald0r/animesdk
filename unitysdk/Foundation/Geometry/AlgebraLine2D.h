...
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_GET_C_OFFSET UNITYSDK_OFFSET(0x322D10)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_GET_ISDEGENERATE_OFFSET UNITYSDK_OFFSET(0x982AF0)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_GET_X_OFFSET UNITYSDK_OFFSET(0x3EB2F0)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_GET_Y_OFFSET UNITYSDK_OFFSET(0x322CC0)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1B07DAA0)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_VALUEOF_1_OFFSET UNITYSDK_OFFSET(0x982B60)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_VALUEOF_OFFSET UNITYSDK_OFFSET(0x982B30)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x8F7AD0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int AlgebraLine2D_TypeDefinitionIndex = 8915;
