...
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_GET_C_OFFSET UNITYSDK_OFFSET(0x2D8760)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_GET_ISDEGENERATE_OFFSET UNITYSDK_OFFSET(0x958DE0)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_GET_X_OFFSET UNITYSDK_OFFSET(0x39B980)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_GET_Y_OFFSET UNITYSDK_OFFSET(0x2D8730)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_OP_EXPLICIT_OFFSET UNITYSDK_OFFSET(0x1AB2EAC0)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_VALUEOF_1_OFFSET UNITYSDK_OFFSET(0x958E50)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D_VALUEOF_OFFSET UNITYSDK_OFFSET(0x958E20)
#define FOUNDATION_GEOMETRY_ALGEBRALINE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x7976F0)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int AlgebraLine2D_TypeDefinitionIndex = 8837;
