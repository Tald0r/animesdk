...
#define FOUNDATION_GEOMETRY_ELLIPSE2D_GETPARAM_OFFSET UNITYSDK_OFFSET(0x940830)
#define FOUNDATION_GEOMETRY_ELLIPSE2D_GETPOINTX_OFFSET UNITYSDK_OFFSET(0x940620)
#define FOUNDATION_GEOMETRY_ELLIPSE2D_GETPOINTY_OFFSET UNITYSDK_OFFSET(0x9406F0)
#define FOUNDATION_GEOMETRY_ELLIPSE2D_GETPOINT_1_OFFSET UNITYSDK_OFFSET(0x9407B0)
#define FOUNDATION_GEOMETRY_ELLIPSE2D_GETPOINT_OFFSET UNITYSDK_OFFSET(0x940570)
#define FOUNDATION_GEOMETRY_ELLIPSE2D__CTOR_OFFSET UNITYSDK_OFFSET(0x940470)

namespace Foundation::Geometry
{
	inline static constexpr unsigned int Ellipse2D_TypeDefinitionIndex = 8812;
