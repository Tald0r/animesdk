...
#define FOUNDATION_NATIVEMEMORYBUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x1AE77A30)
#define FOUNDATION_NATIVEMEMORYBUILDER_REQUESTBLOB_OFFSET UNITYSDK_OFFSET(0x1AE77660)
#define FOUNDATION_NATIVEMEMORYBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AE77B00)

namespace Foundation
{
	inline static constexpr unsigned int NativeMemoryBuilder_TypeDefinitionIndex = 8986;
