...
#define FOUNDATION_NATIVEMEMORYBUILDER_BUILD_OFFSET UNITYSDK_OFFSET(0x1B48B690)
#define FOUNDATION_NATIVEMEMORYBUILDER_REQUESTBLOB_OFFSET UNITYSDK_OFFSET(0x1B48B2F0)
#define FOUNDATION_NATIVEMEMORYBUILDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B48B760)

namespace Foundation
{
	inline static constexpr unsigned int NativeMemoryBuilder_TypeDefinitionIndex = 9136;
