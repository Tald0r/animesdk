...
#define FOUNDATION_ASSETLOADCACHEKEYEXTENSIONS_TOLOADCACHEKEY_1_OFFSET UNITYSDK_OFFSET(0x1AD52140)
#define FOUNDATION_ASSETLOADCACHEKEYEXTENSIONS_TOLOADCACHEKEY_2_OFFSET UNITYSDK_OFFSET(0x1AD52200)
#define FOUNDATION_ASSETLOADCACHEKEYEXTENSIONS_TOLOADCACHEKEY_OFFSET UNITYSDK_OFFSET(0x1AD52070)

namespace Foundation
{
	inline static constexpr unsigned int AssetLoadCacheKeyExtensions_TypeDefinitionIndex = 7705;
