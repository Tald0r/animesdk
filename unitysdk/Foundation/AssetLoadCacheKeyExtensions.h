...
#define FOUNDATION_ASSETLOADCACHEKEYEXTENSIONS_TOLOADCACHEKEY_1_OFFSET UNITYSDK_OFFSET(0x1A7D1E50)
#define FOUNDATION_ASSETLOADCACHEKEYEXTENSIONS_TOLOADCACHEKEY_2_OFFSET UNITYSDK_OFFSET(0x1A7D1EF0)
#define FOUNDATION_ASSETLOADCACHEKEYEXTENSIONS_TOLOADCACHEKEY_OFFSET UNITYSDK_OFFSET(0x1A7D1D80)

namespace Foundation
{
	inline static constexpr unsigned int AssetLoadCacheKeyExtensions_TypeDefinitionIndex = 8168;
