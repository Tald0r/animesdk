...
#define FOUNDATION_NATIVETEMPMEMORY3_GETSLOT_OFFSET UNITYSDK_OFFSET(0x960D60)

namespace Foundation
{
	inline static constexpr unsigned int NativeTempMemory3_TypeDefinitionIndex = 8982;
