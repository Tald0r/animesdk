...
#define FOUNDATION_NATIVETEMPMEMORY3_GETSLOT_OFFSET UNITYSDK_OFFSET(0x991510)

namespace Foundation
{
	inline static constexpr unsigned int NativeTempMemory3_TypeDefinitionIndex = 9088;
