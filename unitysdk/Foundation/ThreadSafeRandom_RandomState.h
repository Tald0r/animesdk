...
#define FOUNDATION_THREADSAFERANDOM_RANDOMSTATE_NEXT_OFFSET UNITYSDK_OFFSET(0x940D10)
#define FOUNDATION_THREADSAFERANDOM_RANDOMSTATE_SETSEED_OFFSET UNITYSDK_OFFSET(0x940C30)

namespace Foundation
{
	inline static constexpr unsigned int ThreadSafeRandom_RandomState_TypeDefinitionIndex = 8895;
