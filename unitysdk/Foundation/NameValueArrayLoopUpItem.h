...
#define FOUNDATION_NAMEVALUEARRAYLOOPUPITEM_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define FOUNDATION_NAMEVALUEARRAYLOOPUPITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define FOUNDATION_NAMEVALUEARRAYLOOPUPITEM_RESET_1_OFFSET UNITYSDK_OFFSET(0x324900)
#define FOUNDATION_NAMEVALUEARRAYLOOPUPITEM_RESET_OFFSET UNITYSDK_OFFSET(0x7BF020)

namespace Foundation
{
	inline static constexpr unsigned int NameValueArrayLoopUpItem_TypeDefinitionIndex = 8862;
