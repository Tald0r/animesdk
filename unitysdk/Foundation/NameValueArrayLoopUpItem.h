...
#define FOUNDATION_NAMEVALUEARRAYLOOPUPITEM_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x2EC6E0)
#define FOUNDATION_NAMEVALUEARRAYLOOPUPITEM_GET_NAME_OFFSET UNITYSDK_OFFSET(0x223870)
#define FOUNDATION_NAMEVALUEARRAYLOOPUPITEM_RESET_1_OFFSET UNITYSDK_OFFSET(0x31E200)
#define FOUNDATION_NAMEVALUEARRAYLOOPUPITEM_RESET_OFFSET UNITYSDK_OFFSET(0x8221C0)

namespace Foundation
{
	inline static constexpr unsigned int NameValueArrayLoopUpItem_TypeDefinitionIndex = 9014;
