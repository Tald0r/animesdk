...
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1B17EEB0)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B17F1B0)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1B17F210)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1B17F1C0)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1B17EEA0)
#define FOUNDATION_IENUMERATORLOADER__LOADLOOPER_D__42__CTOR_OFFSET UNITYSDK_OFFSET(0x1B17EE90)

namespace Foundation
{
	inline static constexpr unsigned int IEnumeratorLoader__LoadLooper_d__42_TypeDefinitionIndex = 7951;

	class IEnumeratorLoader__LoadLooper_d__42 : public ::System::Object
	{
	public:
		::System::Object* __2__current; // 0x10
		::Foundation::IEnumeratorLoader* __4__this; // 0x18
