...
#define FOUNDATION_LERPEDUTILS_CALCULATEALPHACLAMPED_OFFSET UNITYSDK_OFFSET(0x1AF488D0)
#define FOUNDATION_LERPEDUTILS_CALCULATEALPHAUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1AF47F00)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__CIRCULARINOUT_1_17_OFFSET UNITYSDK_OFFSET(0x1AF487B0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__CIRCULARIN_1_15_OFFSET UNITYSDK_OFFSET(0x1AF48730)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__CIRCULAROUT_1_16_OFFSET UNITYSDK_OFFSET(0x1AF48780)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__EASEINOUT_1_11_OFFSET UNITYSDK_OFFSET(0x1AF48590)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__EASEIN_1_9_OFFSET UNITYSDK_OFFSET(0x1AF48540)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__EASEOUT_1_10_OFFSET UNITYSDK_OFFSET(0x1AF48550)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__EXPOINOUT_1_14_OFFSET UNITYSDK_OFFSET(0x1AF48680)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__EXPOIN_1_12_OFFSET UNITYSDK_OFFSET(0x1AF48600)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__EXPOOUT_1_13_OFFSET UNITYSDK_OFFSET(0x1AF48630)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__LINEAR_1_0_OFFSET UNITYSDK_OFFSET(0x1AF48420)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__LOWERHALFALPHA_1_2_OFFSET UNITYSDK_OFFSET(0x1AF48DC0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__LOWERHALFVALUE_1_4_OFFSET UNITYSDK_OFFSET(0x1AF48DE0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__SININOUT_1_8_OFFSET UNITYSDK_OFFSET(0x1AF484C0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__SININ_1_6_OFFSET UNITYSDK_OFFSET(0x1AF48470)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__SINOUT_1_7_OFFSET UNITYSDK_OFFSET(0x1AF484B0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__SMOOTHARRIVAL_1_18_OFFSET UNITYSDK_OFFSET(0x1AF48870)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__SMOOTHDEPARTURE_1_19_OFFSET UNITYSDK_OFFSET(0x1AF488A0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__SMOOTHSTEP_1_20_OFFSET UNITYSDK_OFFSET(0x1AF488B0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__STEP_1_1_OFFSET UNITYSDK_OFFSET(0x1AF48430)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__UPPERHALFALPHA_1_3_OFFSET UNITYSDK_OFFSET(0x1AF48DD0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__UPPERHALFVALUE_1_5_OFFSET UNITYSDK_OFFSET(0x1AF48DF0)

namespace Foundation
{
	inline static constexpr unsigned int LerpedUtils_TypeDefinitionIndex = 9006;
