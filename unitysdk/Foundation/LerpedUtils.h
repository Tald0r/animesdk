...
#define FOUNDATION_LERPEDUTILS_CALCULATEALPHACLAMPED_OFFSET UNITYSDK_OFFSET(0x1B4C47D0)
#define FOUNDATION_LERPEDUTILS_CALCULATEALPHAUNCLAMPED_OFFSET UNITYSDK_OFFSET(0x1B4C3E00)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__CIRCULARINOUT_1_17_OFFSET UNITYSDK_OFFSET(0x1B4C46B0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__CIRCULARIN_1_15_OFFSET UNITYSDK_OFFSET(0x1B4C4630)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__CIRCULAROUT_1_16_OFFSET UNITYSDK_OFFSET(0x1B4C4680)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__EASEINOUT_1_11_OFFSET UNITYSDK_OFFSET(0x1B4C4490)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__EASEIN_1_9_OFFSET UNITYSDK_OFFSET(0x1B4C4440)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__EASEOUT_1_10_OFFSET UNITYSDK_OFFSET(0x1B4C4450)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__EXPOINOUT_1_14_OFFSET UNITYSDK_OFFSET(0x1B4C4580)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__EXPOIN_1_12_OFFSET UNITYSDK_OFFSET(0x1B4C4500)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__EXPOOUT_1_13_OFFSET UNITYSDK_OFFSET(0x1B4C4530)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__LINEAR_1_0_OFFSET UNITYSDK_OFFSET(0x1B4C4320)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__LOWERHALFALPHA_1_2_OFFSET UNITYSDK_OFFSET(0x1B4C4CC0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__LOWERHALFVALUE_1_4_OFFSET UNITYSDK_OFFSET(0x1B4C4CE0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__SININOUT_1_8_OFFSET UNITYSDK_OFFSET(0x1B4C43C0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__SININ_1_6_OFFSET UNITYSDK_OFFSET(0x1B4C4370)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__SINOUT_1_7_OFFSET UNITYSDK_OFFSET(0x1B4C43B0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__SMOOTHARRIVAL_1_18_OFFSET UNITYSDK_OFFSET(0x1B4C4770)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__SMOOTHDEPARTURE_1_19_OFFSET UNITYSDK_OFFSET(0x1B4C47A0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__SMOOTHSTEP_1_20_OFFSET UNITYSDK_OFFSET(0x1B4C47B0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__STEP_1_1_OFFSET UNITYSDK_OFFSET(0x1B4C4330)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__UPPERHALFALPHA_1_3_OFFSET UNITYSDK_OFFSET(0x1B4C4CD0)
#define FOUNDATION_LERPEDUTILS__CALCULATEALPHAUNCLAMPED_G__UPPERHALFVALUE_1_5_OFFSET UNITYSDK_OFFSET(0x1B4C4CF0)

namespace Foundation
{
	inline static constexpr unsigned int LerpedUtils_TypeDefinitionIndex = 8998;
