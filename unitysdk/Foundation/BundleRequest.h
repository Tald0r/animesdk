...
#define FOUNDATION_BUNDLEREQUEST_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1AB72690)
#define FOUNDATION_BUNDLEREQUEST_GET_ASSETBUNDLE_OFFSET UNITYSDK_OFFSET(0x1AB71FA0)
#define FOUNDATION_BUNDLEREQUEST_GET_BUNDLEFILEPATH_OFFSET UNITYSDK_OFFSET(0x1AB72010)
#define FOUNDATION_BUNDLEREQUEST_GET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x1AB71FF0)
#define FOUNDATION_BUNDLEREQUEST_LOAD_OFFSET UNITYSDK_OFFSET(0x1AB72030)
#define FOUNDATION_BUNDLEREQUEST_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1AB725E0)
#define FOUNDATION_BUNDLEREQUEST_SET_ASSETBUNDLE_OFFSET UNITYSDK_OFFSET(0x1AB71FE0)
#define FOUNDATION_BUNDLEREQUEST_SET_BUNDLEFILEPATH_OFFSET UNITYSDK_OFFSET(0x1AB72020)
#define FOUNDATION_BUNDLEREQUEST_SET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x1AB72000)
#define FOUNDATION_BUNDLEREQUEST_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1AB723E0)
#define FOUNDATION_BUNDLEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB72780)
#define FOUNDATION_BUNDLEREQUEST___BASE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1AB727A0)
#define FOUNDATION_BUNDLEREQUEST___BASE_LOAD_OFFSET UNITYSDK_OFFSET(0x1AB72820)
#define FOUNDATION_BUNDLEREQUEST___BASE_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1AB72830)
#define FOUNDATION_BUNDLEREQUEST___BASE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1AB72810)

namespace Foundation
{
	inline static constexpr unsigned int BundleRequest_TypeDefinitionIndex = 7824;
