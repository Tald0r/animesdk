...
#define FOUNDATION_BUNDLEREQUEST_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1A59A3F0)
#define FOUNDATION_BUNDLEREQUEST_GET_ASSETBUNDLE_OFFSET UNITYSDK_OFFSET(0x1A599D00)
#define FOUNDATION_BUNDLEREQUEST_GET_BUNDLEFILEPATH_OFFSET UNITYSDK_OFFSET(0x1A599D70)
#define FOUNDATION_BUNDLEREQUEST_GET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x1A599D50)
#define FOUNDATION_BUNDLEREQUEST_LOAD_OFFSET UNITYSDK_OFFSET(0x1A599D90)
#define FOUNDATION_BUNDLEREQUEST_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1A59A340)
#define FOUNDATION_BUNDLEREQUEST_SET_ASSETBUNDLE_OFFSET UNITYSDK_OFFSET(0x1A599D40)
#define FOUNDATION_BUNDLEREQUEST_SET_BUNDLEFILEPATH_OFFSET UNITYSDK_OFFSET(0x1A599D80)
#define FOUNDATION_BUNDLEREQUEST_SET_BUNDLEID_OFFSET UNITYSDK_OFFSET(0x1A599D60)
#define FOUNDATION_BUNDLEREQUEST_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1A59A140)
#define FOUNDATION_BUNDLEREQUEST__CTOR_OFFSET UNITYSDK_OFFSET(0x1A59A4E0)
#define FOUNDATION_BUNDLEREQUEST___BASE_BEFORERECYCLE_OFFSET UNITYSDK_OFFSET(0x1A59A500)
#define FOUNDATION_BUNDLEREQUEST___BASE_LOAD_OFFSET UNITYSDK_OFFSET(0x1A59A580)
#define FOUNDATION_BUNDLEREQUEST___BASE_RECYCLE_OFFSET UNITYSDK_OFFSET(0x1A59A590)
#define FOUNDATION_BUNDLEREQUEST___BASE_UNLOAD_OFFSET UNITYSDK_OFFSET(0x1A59A570)

namespace Foundation
{
	inline static constexpr unsigned int BundleRequest_TypeDefinitionIndex = 7780;

	class BundleRequest : public ::Foundation::AssetRequest
	{
	public:
		::Foundation::AssetPath RefAssetUrl; // 0x60
