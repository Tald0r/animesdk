...
#define FOUNDATION_CITYHASH_UINT128__CTOR_OFFSET UNITYSDK_OFFSET(0x2D6E20)

namespace Foundation
{
	inline static constexpr unsigned int CityHash_Uint128_TypeDefinitionIndex = 9179;
