...
#define FOUNDATION_MYLOGGERSWITCHER_CHECKISENABLE_OFFSET UNITYSDK_OFFSET(0x19A54390)
#define FOUNDATION_MYLOGGERSWITCHER_GET_SAVEFILENAME_OFFSET UNITYSDK_OFFSET(0x19A54750)
#define FOUNDATION_MYLOGGERSWITCHER_LOAD_OFFSET UNITYSDK_OFFSET(0x19A541A0)
#define FOUNDATION_MYLOGGERSWITCHER_SAVE_OFFSET UNITYSDK_OFFSET(0x19A545A0)
#define FOUNDATION_MYLOGGERSWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A54180)

namespace Foundation
{
	inline static constexpr unsigned int MyLoggerSwitcher_TypeDefinitionIndex = 8202;
