...
#define FOUNDATION_MYLOGGERSWITCHER_CHECKISENABLE_OFFSET UNITYSDK_OFFSET(0x1A026280)
#define FOUNDATION_MYLOGGERSWITCHER_GET_SAVEFILENAME_OFFSET UNITYSDK_OFFSET(0x1A026640)
#define FOUNDATION_MYLOGGERSWITCHER_LOAD_OFFSET UNITYSDK_OFFSET(0x1A026090)
#define FOUNDATION_MYLOGGERSWITCHER_SAVE_OFFSET UNITYSDK_OFFSET(0x1A026490)
#define FOUNDATION_MYLOGGERSWITCHER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A026070)

namespace Foundation
{
	inline static constexpr unsigned int MyLoggerSwitcher_TypeDefinitionIndex = 7803;
