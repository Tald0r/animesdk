...
#define FOUNDATION_AUTOSTOPWATCH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19F0B4C0)
#define FOUNDATION_AUTOSTOPWATCH_FINALIZE_OFFSET UNITYSDK_OFFSET(0x19F0B5C0)
#define FOUNDATION_AUTOSTOPWATCH_STARTSTOPWATCH_OFFSET UNITYSDK_OFFSET(0x19F0B450)
#define FOUNDATION_AUTOSTOPWATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x19F0B3C0)

namespace Foundation
{
	inline static constexpr unsigned int AutoStopWatch_TypeDefinitionIndex = 7797;
