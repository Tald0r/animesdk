...
#define FOUNDATION_AUTOSTOPWATCH_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A6774F0)
#define FOUNDATION_AUTOSTOPWATCH_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A6775F0)
#define FOUNDATION_AUTOSTOPWATCH_STARTSTOPWATCH_OFFSET UNITYSDK_OFFSET(0x1A677480)
#define FOUNDATION_AUTOSTOPWATCH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6773F0)

namespace Foundation
{
	inline static constexpr unsigned int AutoStopWatch_TypeDefinitionIndex = 7751;
