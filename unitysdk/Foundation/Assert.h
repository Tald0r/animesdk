...
#define FOUNDATION_ASSERT_ASSERTATLEAST_OFFSET UNITYSDK_OFFSET(0x1B433270)
#define FOUNDATION_ASSERT_ASSERTATMOST_OFFSET UNITYSDK_OFFSET(0x1B433450)
#define FOUNDATION_ASSERT_ASSERTEQUALS_OFFSET UNITYSDK_OFFSET(0x1B433760)
#define FOUNDATION_ASSERT_ASSERTINRANGE_1_OFFSET UNITYSDK_OFFSET(0x1B432FB0)
#define FOUNDATION_ASSERT_ASSERTINRANGE_OFFSET UNITYSDK_OFFSET(0x1B432D30)
#define FOUNDATION_ASSERT_ASSERTNOTNULL_1_OFFSET UNITYSDK_OFFSET(0x1B433690)
#define FOUNDATION_ASSERT_ASSERTNOTNULL_OFFSET UNITYSDK_OFFSET(0x1B433630)
#define FOUNDATION_ASSERT_ASSERTSTRINGNOTNULL_OFFSET UNITYSDK_OFFSET(0x1B432C70)
#define FOUNDATION_ASSERT_ASSERTTRUE_1_OFFSET UNITYSDK_OFFSET(0x1B432BE0)
#define FOUNDATION_ASSERT_ASSERTTRUE_OFFSET UNITYSDK_OFFSET(0x1B432B40)
#define FOUNDATION_ASSERT_FAIL_1_OFFSET UNITYSDK_OFFSET(0x1B432AC0)
#define FOUNDATION_ASSERT_FAIL_OFFSET UNITYSDK_OFFSET(0x1B4329A0)

namespace Foundation
{
	inline static constexpr unsigned int Assert_TypeDefinitionIndex = 8226;
