...
#define FOUNDATION_ASSERT_ASSERTATLEAST_OFFSET UNITYSDK_OFFSET(0x1AD2FFD0)
#define FOUNDATION_ASSERT_ASSERTATMOST_OFFSET UNITYSDK_OFFSET(0x1AD301B0)
#define FOUNDATION_ASSERT_ASSERTEQUALS_OFFSET UNITYSDK_OFFSET(0x1AD304C0)
#define FOUNDATION_ASSERT_ASSERTINRANGE_1_OFFSET UNITYSDK_OFFSET(0x1AD2FD10)
#define FOUNDATION_ASSERT_ASSERTINRANGE_OFFSET UNITYSDK_OFFSET(0x1AD2FA90)
#define FOUNDATION_ASSERT_ASSERTNOTNULL_1_OFFSET UNITYSDK_OFFSET(0x1AD303F0)
#define FOUNDATION_ASSERT_ASSERTNOTNULL_OFFSET UNITYSDK_OFFSET(0x1AD30390)
#define FOUNDATION_ASSERT_ASSERTSTRINGNOTNULL_OFFSET UNITYSDK_OFFSET(0x1AD2F9D0)
#define FOUNDATION_ASSERT_ASSERTTRUE_1_OFFSET UNITYSDK_OFFSET(0x1AD2F940)
#define FOUNDATION_ASSERT_ASSERTTRUE_OFFSET UNITYSDK_OFFSET(0x1AD2F8A0)
#define FOUNDATION_ASSERT_FAIL_1_OFFSET UNITYSDK_OFFSET(0x1AD2F820)
#define FOUNDATION_ASSERT_FAIL_OFFSET UNITYSDK_OFFSET(0x1AD2F700)

namespace Foundation
{
	inline static constexpr unsigned int Assert_TypeDefinitionIndex = 8184;
