...
#define FOUNDATION_TRANSFORMX_ADJUSTLOCALX_OFFSET UNITYSDK_OFFSET(0x19774D90)
#define FOUNDATION_TRANSFORMX_ADJUSTLOCALY_OFFSET UNITYSDK_OFFSET(0x19774E60)
#define FOUNDATION_TRANSFORMX_ADJUSTLOCALZ_OFFSET UNITYSDK_OFFSET(0x19774F30)
#define FOUNDATION_TRANSFORMX_COPYFROM_OFFSET UNITYSDK_OFFSET(0x197754C0)
#define FOUNDATION_TRANSFORMX_FLIP_OFFSET UNITYSDK_OFFSET(0x19775000)
#define FOUNDATION_TRANSFORMX_GETINCHILDREN_OFFSET UNITYSDK_OFFSET(0x19775610)
#define FOUNDATION_TRANSFORMX_GETPOSITIONX_OFFSET UNITYSDK_OFFSET(0x197747A0)
#define FOUNDATION_TRANSFORMX_GETPOSITIONY_OFFSET UNITYSDK_OFFSET(0x19774830)
#define FOUNDATION_TRANSFORMX_GETPOSITIONZ_OFFSET UNITYSDK_OFFSET(0x197748C0)
#define FOUNDATION_TRANSFORMX_RESET_OFFSET UNITYSDK_OFFSET(0x197753F0)
#define FOUNDATION_TRANSFORMX_SETLOCALPOSITION_1_OFFSET UNITYSDK_OFFSET(0x197750E0)
#define FOUNDATION_TRANSFORMX_SETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x19774950)
#define FOUNDATION_TRANSFORMX_SETLOCALSCALE_OFFSET UNITYSDK_OFFSET(0x19775300)
#define FOUNDATION_TRANSFORMX_SETLOCALX_OFFSET UNITYSDK_OFFSET(0x19774B40)
#define FOUNDATION_TRANSFORMX_SETLOCALY_OFFSET UNITYSDK_OFFSET(0x19774C00)
#define FOUNDATION_TRANSFORMX_SETLOCALZ_OFFSET UNITYSDK_OFFSET(0x19774CD0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONX_1_OFFSET UNITYSDK_OFFSET(0x19774280)
#define FOUNDATION_TRANSFORMX_SETPOSITIONX_OFFSET UNITYSDK_OFFSET(0x19774100)
#define FOUNDATION_TRANSFORMX_SETPOSITIONY_1_OFFSET UNITYSDK_OFFSET(0x197744B0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONY_OFFSET UNITYSDK_OFFSET(0x19774330)
#define FOUNDATION_TRANSFORMX_SETPOSITIONZ_1_OFFSET UNITYSDK_OFFSET(0x197746F0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONZ_OFFSET UNITYSDK_OFFSET(0x19774570)
#define FOUNDATION_TRANSFORMX_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x197751F0)

namespace Foundation
{
	inline static constexpr unsigned int TransformX_TypeDefinitionIndex = 8265;
