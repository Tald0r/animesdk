...
#define FOUNDATION_TRANSFORMX_ADJUSTLOCALX_OFFSET UNITYSDK_OFFSET(0x193877C0)
#define FOUNDATION_TRANSFORMX_ADJUSTLOCALY_OFFSET UNITYSDK_OFFSET(0x19387890)
#define FOUNDATION_TRANSFORMX_ADJUSTLOCALZ_OFFSET UNITYSDK_OFFSET(0x19387960)
#define FOUNDATION_TRANSFORMX_COPYFROM_OFFSET UNITYSDK_OFFSET(0x19387EF0)
#define FOUNDATION_TRANSFORMX_FLIP_OFFSET UNITYSDK_OFFSET(0x19387A30)
#define FOUNDATION_TRANSFORMX_GETINCHILDREN_OFFSET UNITYSDK_OFFSET(0x19388040)
#define FOUNDATION_TRANSFORMX_GETPOSITIONX_OFFSET UNITYSDK_OFFSET(0x193871D0)
#define FOUNDATION_TRANSFORMX_GETPOSITIONY_OFFSET UNITYSDK_OFFSET(0x19387260)
#define FOUNDATION_TRANSFORMX_GETPOSITIONZ_OFFSET UNITYSDK_OFFSET(0x193872F0)
#define FOUNDATION_TRANSFORMX_RESET_OFFSET UNITYSDK_OFFSET(0x19387E20)
#define FOUNDATION_TRANSFORMX_SETLOCALPOSITION_1_OFFSET UNITYSDK_OFFSET(0x19387B10)
#define FOUNDATION_TRANSFORMX_SETLOCALPOSITION_OFFSET UNITYSDK_OFFSET(0x19387380)
#define FOUNDATION_TRANSFORMX_SETLOCALSCALE_OFFSET UNITYSDK_OFFSET(0x19387D30)
#define FOUNDATION_TRANSFORMX_SETLOCALX_OFFSET UNITYSDK_OFFSET(0x19387570)
#define FOUNDATION_TRANSFORMX_SETLOCALY_OFFSET UNITYSDK_OFFSET(0x19387630)
#define FOUNDATION_TRANSFORMX_SETLOCALZ_OFFSET UNITYSDK_OFFSET(0x19387700)
#define FOUNDATION_TRANSFORMX_SETPOSITIONX_1_OFFSET UNITYSDK_OFFSET(0x19386CB0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONX_OFFSET UNITYSDK_OFFSET(0x19386B30)
#define FOUNDATION_TRANSFORMX_SETPOSITIONY_1_OFFSET UNITYSDK_OFFSET(0x19386EE0)
#define FOUNDATION_TRANSFORMX_SETPOSITIONY_OFFSET UNITYSDK_OFFSET(0x19386D60)
#define FOUNDATION_TRANSFORMX_SETPOSITIONZ_1_OFFSET UNITYSDK_OFFSET(0x19387120)
#define FOUNDATION_TRANSFORMX_SETPOSITIONZ_OFFSET UNITYSDK_OFFSET(0x19386FA0)
#define FOUNDATION_TRANSFORMX_SETPOSITION_OFFSET UNITYSDK_OFFSET(0x19387C20)

namespace Foundation
{
	inline static constexpr unsigned int TransformX_TypeDefinitionIndex = 7966;
