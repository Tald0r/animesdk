...
#define FOUNDATION_OBJECTSERVICE_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x1A1DC2F0)
#define FOUNDATION_OBJECTSERVICE_COLLECTCHILDRENRELEASEOBJECTRECURSIVE_OFFSET UNITYSDK_OFFSET(0x1A1E1660)
#define FOUNDATION_OBJECTSERVICE_COLLECTRELEASEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A1E2B60)
#define FOUNDATION_OBJECTSERVICE_DORELEASEOBJECT_OFFSET UNITYSDK_OFFSET(0x1A1E13F0)
#define FOUNDATION_OBJECTSERVICE_DOREMOVEFROMPARENT_1_OFFSET UNITYSDK_OFFSET(0x1A1E0F50)
#define FOUNDATION_OBJECTSERVICE_DOREMOVEFROMPARENT_OFFSET UNITYSDK_OFFSET(0x1A1E05C0)
#define FOUNDATION_OBJECTSERVICE_DOREMOVE_OFFSET UNITYSDK_OFFSET(0x1A1E1910)
#define FOUNDATION_OBJECTSERVICE_DOSETPARENT_OFFSET UNITYSDK_OFFSET(0x1A1E1200)
#define FOUNDATION_OBJECTSERVICE_ENSUREOBJECTSINDEX_OFFSET UNITYSDK_OFFSET(0x1A1E1360)
#define FOUNDATION_OBJECTSERVICE_FOUNDATION_IGAMESERVICE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1A1E5EB0)
#define FOUNDATION_OBJECTSERVICE_FOUNDATION_IGAMESERVICE_ONREADYTODESTROY_OFFSET UNITYSDK_OFFSET(0x1A1E5E30)
#define FOUNDATION_OBJECTSERVICE_GETROOT_OFFSET UNITYSDK_OFFSET(0x1A1E3F40)
#define FOUNDATION_OBJECTSERVICE_INITRELEASEBUFFER_OFFSET UNITYSDK_OFFSET(0x1A1E2A90)
#define FOUNDATION_OBJECTSERVICE_ISALIVE_1_OFFSET UNITYSDK_OFFSET(0x1A1E3880)
#define FOUNDATION_OBJECTSERVICE_ISALIVE_2_OFFSET UNITYSDK_OFFSET(0x1A1E3DB0)
#define FOUNDATION_OBJECTSERVICE_ISALIVE_OFFSET UNITYSDK_OFFSET(0x1A1DD6F0)
#define FOUNDATION_OBJECTSERVICE_ISALLOCATED_OFFSET UNITYSDK_OFFSET(0x1A1E4A80)
#define FOUNDATION_OBJECTSERVICE_ISMATCHANDALIVE_1_OFFSET UNITYSDK_OFFSET(0x1A1E42F0)
#define FOUNDATION_OBJECTSERVICE_ISMATCHANDALIVE_OFFSET UNITYSDK_OFFSET(0x1A1E40C0)
#define FOUNDATION_OBJECTSERVICE_ISMATCHANDALLOCATED_OFFSET UNITYSDK_OFFSET(0x1A1E47C0)
#define FOUNDATION_OBJECTSERVICE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x1A1E4AA0)
#define FOUNDATION_OBJECTSERVICE_MARKFORREMOVAL_OFFSET UNITYSDK_OFFSET(0x1A1DDCA0)
#define FOUNDATION_OBJECTSERVICE_NEWITEM_OFFSET UNITYSDK_OFFSET(0x1A1E13E0)
#define FOUNDATION_OBJECTSERVICE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x1A1DC250)
#define FOUNDATION_OBJECTSERVICE_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A1E4AB0)
#define FOUNDATION_OBJECTSERVICE_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A1DEA40)
#define FOUNDATION_OBJECTSERVICE_RESET_OFFSET UNITYSDK_OFFSET(0x1A1DCF40)
#define FOUNDATION_OBJECTSERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1E6180)
#define FOUNDATION_OBJECTSERVICE__COLLECTRELEASEOBJECT_G__COLLECTANDMOVENEXT_32_0_OFFSET UNITYSDK_OFFSET(0x1A1E3720)
#define FOUNDATION_OBJECTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1DC060)

namespace Foundation
{
	inline static constexpr unsigned int ObjectService_TypeDefinitionIndex = 9106;
	...
	public:
		...
		{
			return (::Foundation::Container::DefaultNativeSparseArrayElementAllocator*)Il2CppClass::FromTypeDefinitionIndex(ObjectService_TypeDefinitionIndex)->GetStaticField(0x3CA0);
		}
		...
		::Foundation::ObjectService_ObjectItem _removalRoot; // 0x30
		::System::Int32 _idGenerator; // 0x44
		::Foundation::ObjectService_ObjectItem _aliveRoot; // 0x48
