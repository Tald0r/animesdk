...
#define FOUNDATION_OBJECTSERVICE_ALLOCATE_OFFSET UNITYSDK_OFFSET(0x19C4D900)
#define FOUNDATION_OBJECTSERVICE_COLLECTCHILDRENRELEASEOBJECTRECURSIVE_OFFSET UNITYSDK_OFFSET(0x19C52370)
#define FOUNDATION_OBJECTSERVICE_COLLECTRELEASEOBJECT_OFFSET UNITYSDK_OFFSET(0x19C535C0)
#define FOUNDATION_OBJECTSERVICE_DORELEASEOBJECT_OFFSET UNITYSDK_OFFSET(0x19C52230)
#define FOUNDATION_OBJECTSERVICE_DOREMOVEFROMPARENT_1_OFFSET UNITYSDK_OFFSET(0x19C51D90)
#define FOUNDATION_OBJECTSERVICE_DOREMOVEFROMPARENT_OFFSET UNITYSDK_OFFSET(0x19C514B0)
#define FOUNDATION_OBJECTSERVICE_DOREMOVE_OFFSET UNITYSDK_OFFSET(0x19C52610)
#define FOUNDATION_OBJECTSERVICE_DOSETPARENT_OFFSET UNITYSDK_OFFSET(0x19C52040)
#define FOUNDATION_OBJECTSERVICE_ENSUREOBJECTSINDEX_OFFSET UNITYSDK_OFFSET(0x19C521A0)
#define FOUNDATION_OBJECTSERVICE_FOUNDATION_IGAMESERVICE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x19C563F0)
#define FOUNDATION_OBJECTSERVICE_FOUNDATION_IGAMESERVICE_ONREADYTODESTROY_OFFSET UNITYSDK_OFFSET(0x19C56370)
#define FOUNDATION_OBJECTSERVICE_GETROOT_OFFSET UNITYSDK_OFFSET(0x19C548E0)
#define FOUNDATION_OBJECTSERVICE_INITRELEASEBUFFER_OFFSET UNITYSDK_OFFSET(0x19C534F0)
#define FOUNDATION_OBJECTSERVICE_ISALIVE_1_OFFSET UNITYSDK_OFFSET(0x19C542E0)
#define FOUNDATION_OBJECTSERVICE_ISALIVE_2_OFFSET UNITYSDK_OFFSET(0x19C54750)
#define FOUNDATION_OBJECTSERVICE_ISALIVE_OFFSET UNITYSDK_OFFSET(0x19C4EAB0)
#define FOUNDATION_OBJECTSERVICE_ISALLOCATED_OFFSET UNITYSDK_OFFSET(0x19C55280)
#define FOUNDATION_OBJECTSERVICE_ISMATCHANDALIVE_1_OFFSET UNITYSDK_OFFSET(0x19C54C90)
#define FOUNDATION_OBJECTSERVICE_ISMATCHANDALIVE_OFFSET UNITYSDK_OFFSET(0x19C54A60)
#define FOUNDATION_OBJECTSERVICE_ISMATCHANDALLOCATED_OFFSET UNITYSDK_OFFSET(0x19C55090)
#define FOUNDATION_OBJECTSERVICE_ISMATCH_OFFSET UNITYSDK_OFFSET(0x19C552A0)
#define FOUNDATION_OBJECTSERVICE_MARKFORREMOVAL_OFFSET UNITYSDK_OFFSET(0x19C4EFA0)
#define FOUNDATION_OBJECTSERVICE_NEWITEM_OFFSET UNITYSDK_OFFSET(0x19C52220)
#define FOUNDATION_OBJECTSERVICE_ONCREATE_OFFSET UNITYSDK_OFFSET(0x19C4D860)
#define FOUNDATION_OBJECTSERVICE_RELEASE_OFFSET UNITYSDK_OFFSET(0x19C552B0)
#define FOUNDATION_OBJECTSERVICE_REMOVE_OFFSET UNITYSDK_OFFSET(0x19C4FC90)
#define FOUNDATION_OBJECTSERVICE_RESET_OFFSET UNITYSDK_OFFSET(0x19C4E430)
#define FOUNDATION_OBJECTSERVICE__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C566C0)
#define FOUNDATION_OBJECTSERVICE__COLLECTRELEASEOBJECT_G__COLLECTANDMOVENEXT_32_0_OFFSET UNITYSDK_OFFSET(0x19C54180)
#define FOUNDATION_OBJECTSERVICE__CTOR_OFFSET UNITYSDK_OFFSET(0x19C4D670)

namespace Foundation
{
	inline static constexpr unsigned int ObjectService_TypeDefinitionIndex = 8777;
	...
	public:
		...
		{
			return (::Foundation::Container::DefaultNativeSparseArrayElementAllocator*)Il2CppClass::FromTypeDefinitionIndex(ObjectService_TypeDefinitionIndex)->GetStaticField(0x3C80);
		}
