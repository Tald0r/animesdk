...
#define FOUNDATION_STATEMACHINE_PARAMETERID_EQUALS_OFFSET UNITYSDK_OFFSET(0x960F00)
#define FOUNDATION_STATEMACHINE_PARAMETERID_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x2D71A0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_GET_ISFLOAT_OFFSET UNITYSDK_OFFSET(0x960EE0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x960ED0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x940B80)
#define FOUNDATION_STATEMACHINE_PARAMETERID_ISVALIDFLOAT_OFFSET UNITYSDK_OFFSET(0x960FF0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_ISVALID_OFFSET UNITYSDK_OFFSET(0x960FE0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_NEWBOOL_OFFSET UNITYSDK_OFFSET(0x1AD05930)
#define FOUNDATION_STATEMACHINE_PARAMETERID_NEWFLOAT_OFFSET UNITYSDK_OFFSET(0x1AD05910)
#define FOUNDATION_STATEMACHINE_PARAMETERID_NEWINT_OFFSET UNITYSDK_OFFSET(0x1AD05920)
#define FOUNDATION_STATEMACHINE_PARAMETERID_NEWTRIGGER_OFFSET UNITYSDK_OFFSET(0x1AD05940)
#define FOUNDATION_STATEMACHINE_PARAMETERID_SETBOOL_OFFSET UNITYSDK_OFFSET(0x960F10)
#define FOUNDATION_STATEMACHINE_PARAMETERID_SETFLOAT_1_OFFSET UNITYSDK_OFFSET(0x960F90)
#define FOUNDATION_STATEMACHINE_PARAMETERID_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x960F30)
#define FOUNDATION_STATEMACHINE_PARAMETERID_SETINT_OFFSET UNITYSDK_OFFSET(0x960F50)
#define FOUNDATION_STATEMACHINE_PARAMETERID_TRIGGER_OFFSET UNITYSDK_OFFSET(0x960F70)
#define FOUNDATION_STATEMACHINE_PARAMETERID__CTOR_OFFSET UNITYSDK_OFFSET(0x960EB0)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int ParameterId_TypeDefinitionIndex = 8815;

	struct alignas(2) ParameterId
	{
		static ::Foundation::StateMachine::ParameterId* StaticGet_Null()
		{
			return (::Foundation::StateMachine::ParameterId*)Il2CppClass::FromTypeDefinitionIndex(ParameterId_TypeDefinitionIndex)->GetStaticField(0xAD50);
		}
