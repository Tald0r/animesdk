...
#define FOUNDATION_STATEMACHINE_PARAMETERID_EQUALS_OFFSET UNITYSDK_OFFSET(0x9916B0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x306AA0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_GET_ISFLOAT_OFFSET UNITYSDK_OFFSET(0x991690)
#define FOUNDATION_STATEMACHINE_PARAMETERID_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x991680)
#define FOUNDATION_STATEMACHINE_PARAMETERID_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x96F6A0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_ISVALIDFLOAT_OFFSET UNITYSDK_OFFSET(0x9917A0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_ISVALID_OFFSET UNITYSDK_OFFSET(0x991790)
#define FOUNDATION_STATEMACHINE_PARAMETERID_NEWBOOL_OFFSET UNITYSDK_OFFSET(0x1B31FEA0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_NEWFLOAT_OFFSET UNITYSDK_OFFSET(0x1B31FE80)
#define FOUNDATION_STATEMACHINE_PARAMETERID_NEWINT_OFFSET UNITYSDK_OFFSET(0x1B31FE90)
#define FOUNDATION_STATEMACHINE_PARAMETERID_NEWTRIGGER_OFFSET UNITYSDK_OFFSET(0x1B31FEB0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_SETBOOL_OFFSET UNITYSDK_OFFSET(0x9916C0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_SETFLOAT_1_OFFSET UNITYSDK_OFFSET(0x991740)
#define FOUNDATION_STATEMACHINE_PARAMETERID_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x9916E0)
#define FOUNDATION_STATEMACHINE_PARAMETERID_SETINT_OFFSET UNITYSDK_OFFSET(0x991700)
#define FOUNDATION_STATEMACHINE_PARAMETERID_TRIGGER_OFFSET UNITYSDK_OFFSET(0x991720)
#define FOUNDATION_STATEMACHINE_PARAMETERID__CTOR_OFFSET UNITYSDK_OFFSET(0x991660)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int ParameterId_TypeDefinitionIndex = 8880;

	struct alignas(2) ParameterId
	{
		static ::Foundation::StateMachine::ParameterId* StaticGet_Null()
		{
			return (::Foundation::StateMachine::ParameterId*)Il2CppClass::FromTypeDefinitionIndex(ParameterId_TypeDefinitionIndex)->GetStaticField(0xB370);
		}
