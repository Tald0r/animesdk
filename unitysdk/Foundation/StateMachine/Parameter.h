...
#define FOUNDATION_STATEMACHINE_PARAMETER_EQUALS_OFFSET UNITYSDK_OFFSET(0x3275B0)
#define FOUNDATION_STATEMACHINE_PARAMETER_GET_BOOLVALUE_OFFSET UNITYSDK_OFFSET(0x2D4920)
#define FOUNDATION_STATEMACHINE_PARAMETER_GET_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0x2D4920)
#define FOUNDATION_STATEMACHINE_PARAMETER_NEWBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1AE3FC30)
#define FOUNDATION_STATEMACHINE_PARAMETER_NEWFLOAT_OFFSET UNITYSDK_OFFSET(0x1AE3FC10)
#define FOUNDATION_STATEMACHINE_PARAMETER_NEWINTEGER_OFFSET UNITYSDK_OFFSET(0x1AE3FC20)
#define FOUNDATION_STATEMACHINE_PARAMETER_NEWTRIGGER_OFFSET UNITYSDK_OFFSET(0x1AE3FC40)
#define FOUNDATION_STATEMACHINE_PARAMETER_RESETTRIGGER_OFFSET UNITYSDK_OFFSET(0x967BC0)
#define FOUNDATION_STATEMACHINE_PARAMETER_SET_BOOLVALUE_OFFSET UNITYSDK_OFFSET(0x2D4930)
#define FOUNDATION_STATEMACHINE_PARAMETER_TRIGGER_OFFSET UNITYSDK_OFFSET(0x967BB0)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int Parameter_TypeDefinitionIndex = 8851;
