...
#define FOUNDATION_STATEMACHINE_PARAMETER_EQUALS_OFFSET UNITYSDK_OFFSET(0x32E7F0)
#define FOUNDATION_STATEMACHINE_PARAMETER_GET_BOOLVALUE_OFFSET UNITYSDK_OFFSET(0x350D50)
#define FOUNDATION_STATEMACHINE_PARAMETER_GET_ISTRIGGERED_OFFSET UNITYSDK_OFFSET(0x350D50)
#define FOUNDATION_STATEMACHINE_PARAMETER_NEWBOOLEAN_OFFSET UNITYSDK_OFFSET(0x1B456E40)
#define FOUNDATION_STATEMACHINE_PARAMETER_NEWFLOAT_OFFSET UNITYSDK_OFFSET(0x1B456E20)
#define FOUNDATION_STATEMACHINE_PARAMETER_NEWINTEGER_OFFSET UNITYSDK_OFFSET(0x1B456E30)
#define FOUNDATION_STATEMACHINE_PARAMETER_NEWTRIGGER_OFFSET UNITYSDK_OFFSET(0x1B456E50)
#define FOUNDATION_STATEMACHINE_PARAMETER_RESETTRIGGER_OFFSET UNITYSDK_OFFSET(0x998AA0)
#define FOUNDATION_STATEMACHINE_PARAMETER_SET_BOOLVALUE_OFFSET UNITYSDK_OFFSET(0x30FC20)
#define FOUNDATION_STATEMACHINE_PARAMETER_TRIGGER_OFFSET UNITYSDK_OFFSET(0x998A90)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int Parameter_TypeDefinitionIndex = 9196;
