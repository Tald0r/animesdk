...
#define FOUNDATION_STATEMACHINE_MACHINECACHE_BUILD_OFFSET UNITYSDK_OFFSET(0x1AA8C860)
#define FOUNDATION_STATEMACHINE_MACHINECACHE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AA8C8C0)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int MachineCache_TypeDefinitionIndex = 9015;
