...
#define FOUNDATION_STATEMACHINE_TRANSITION_CHECK_OFFSET UNITYSDK_OFFSET(0x9871D0)
#define FOUNDATION_STATEMACHINE_TRANSITION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B0DE730)
#define FOUNDATION_STATEMACHINE_TRANSITION__CTOR_OFFSET UNITYSDK_OFFSET(0x9871B0)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int Transition_TypeDefinitionIndex = 8804;

	struct alignas(8) Transition
	{
		static ::Foundation::StateMachine::Transition* StaticGet_Invalid()
		{
			return (::Foundation::StateMachine::Transition*)Il2CppClass::FromTypeDefinitionIndex(Transition_TypeDefinitionIndex)->GetStaticField(0x3DB0);
		}
