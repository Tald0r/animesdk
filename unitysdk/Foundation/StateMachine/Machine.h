...
#define FOUNDATION_STATEMACHINE_MACHINE_DFS_OFFSET UNITYSDK_OFFSET(0x9953A0)
#define FOUNDATION_STATEMACHINE_MACHINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x96F740)
#define FOUNDATION_STATEMACHINE_MACHINE_EQUALS_OFFSET UNITYSDK_OFFSET(0x995230)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x995200)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_LAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x995070)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_PARAMCOUNT_OFFSET UNITYSDK_OFFSET(0x995050)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_STATECOUNT_OFFSET UNITYSDK_OFFSET(0x995060)
#define FOUNDATION_STATEMACHINE_MACHINE_PROCESS_OFFSET UNITYSDK_OFFSET(0x995270)
#define FOUNDATION_STATEMACHINE_MACHINE_RESETTRIGGER_OFFSET UNITYSDK_OFFSET(0x995090)
#define FOUNDATION_STATEMACHINE_MACHINE_STEPNEXTSTATE_OFFSET UNITYSDK_OFFSET(0x9952B0)
#define FOUNDATION_STATEMACHINE_MACHINE_UPDATECONDITIONS_OFFSET UNITYSDK_OFFSET(0x9952F0)
#define FOUNDATION_STATEMACHINE_MACHINE_UPDATELAYER_OFFSET UNITYSDK_OFFSET(0x995340)
#define FOUNDATION_STATEMACHINE_MACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0x995080)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int Machine_TypeDefinitionIndex = 9102;
