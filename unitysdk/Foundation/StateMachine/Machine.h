...
#define FOUNDATION_STATEMACHINE_MACHINE_DFS_OFFSET UNITYSDK_OFFSET(0x965C90)
#define FOUNDATION_STATEMACHINE_MACHINE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x940C20)
#define FOUNDATION_STATEMACHINE_MACHINE_EQUALS_OFFSET UNITYSDK_OFFSET(0x965B20)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x965AF0)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_LAYERCOUNT_OFFSET UNITYSDK_OFFSET(0x965960)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_PARAMCOUNT_OFFSET UNITYSDK_OFFSET(0x965940)
#define FOUNDATION_STATEMACHINE_MACHINE_GET_STATECOUNT_OFFSET UNITYSDK_OFFSET(0x965950)
#define FOUNDATION_STATEMACHINE_MACHINE_PROCESS_OFFSET UNITYSDK_OFFSET(0x965B60)
#define FOUNDATION_STATEMACHINE_MACHINE_RESETTRIGGER_OFFSET UNITYSDK_OFFSET(0x965980)
#define FOUNDATION_STATEMACHINE_MACHINE_STEPNEXTSTATE_OFFSET UNITYSDK_OFFSET(0x965BA0)
#define FOUNDATION_STATEMACHINE_MACHINE_UPDATECONDITIONS_OFFSET UNITYSDK_OFFSET(0x965BE0)
#define FOUNDATION_STATEMACHINE_MACHINE_UPDATELAYER_OFFSET UNITYSDK_OFFSET(0x965C30)
#define FOUNDATION_STATEMACHINE_MACHINE__CTOR_OFFSET UNITYSDK_OFFSET(0x965970)

namespace Foundation::StateMachine
{
	inline static constexpr unsigned int Machine_TypeDefinitionIndex = 8977;
