...
#define FOUNDATION_DOWNLOADHANDLER_ABORT_OFFSET UNITYSDK_OFFSET(0x1AD59040)
#define FOUNDATION_DOWNLOADHANDLER_CLOSETEMPFILE_OFFSET UNITYSDK_OFFSET(0x1AD59170)
#define FOUNDATION_DOWNLOADHANDLER_COMBINETEMPFILES_OFFSET UNITYSDK_OFFSET(0x1AD59B40)
#define FOUNDATION_DOWNLOADHANDLER_COMPLETECONTENT_OFFSET UNITYSDK_OFFSET(0x1AD59590)
#define FOUNDATION_DOWNLOADHANDLER_DELETEFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1AD5A270)
#define FOUNDATION_DOWNLOADHANDLER_GETFILECRC_OFFSET UNITYSDK_OFFSET(0x1AD599B0)
#define FOUNDATION_DOWNLOADHANDLER_GETFILEMD5_OFFSET UNITYSDK_OFFSET(0x1AD5A340)
#define FOUNDATION_DOWNLOADHANDLER_INIT_OFFSET UNITYSDK_OFFSET(0x1AD58F50)
#define FOUNDATION_DOWNLOADHANDLER_ISINASSETREQUEST_OFFSET UNITYSDK_OFFSET(0x1AD5A0A0)
#define FOUNDATION_DOWNLOADHANDLER_MOVEFILEIFEXIST_OFFSET UNITYSDK_OFFSET(0x1AD5A110)
#define FOUNDATION_DOWNLOADHANDLER_RECEIVEDATA_OFFSET UNITYSDK_OFFSET(0x1AD59240)
#define FOUNDATION_DOWNLOADHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD58F20)
#define FOUNDATION_DOWNLOADHANDLER___BASE_COMPLETECONTENT_OFFSET UNITYSDK_OFFSET(0x1AD5A590)
#define FOUNDATION_DOWNLOADHANDLER___BASE_RECEIVEDATA_OFFSET UNITYSDK_OFFSET(0x1AD5A5A0)

namespace Foundation
{
	inline static constexpr unsigned int DownloadHandler_TypeDefinitionIndex = 7784;
	...
	public:
		...
		::Foundation::Download* _downloadInfo; // 0x28
