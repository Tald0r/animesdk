...
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x9409A0)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_GETASSETBUNDLENAME_OFFSET UNITYSDK_OFFSET(0x9408C0)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x9408E0)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9408D0)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x38A310)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x940A50)

namespace Foundation::Block::Runtime
{
	inline static constexpr unsigned int BlockInfo_TypeDefinitionIndex = 7742;
