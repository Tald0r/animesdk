...
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x914D50)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_GETASSETBUNDLENAME_OFFSET UNITYSDK_OFFSET(0x914C70)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x914C90)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x914C80)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x360260)
#define FOUNDATION_BLOCK_RUNTIME_BLOCKINFO___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x914E00)

namespace Foundation::Block::Runtime
{
	inline static constexpr unsigned int BlockInfo_TypeDefinitionIndex = 7869;
