...
#define FOUNDATION_OBJECTX_COMPARENAME_1_OFFSET UNITYSDK_OFFSET(0x19770580)
#define FOUNDATION_OBJECTX_COMPARENAME_OFFSET UNITYSDK_OFFSET(0x197704F0)
#define FOUNDATION_OBJECTX_NAMECONTAINS_1_OFFSET UNITYSDK_OFFSET(0x197707D0)
#define FOUNDATION_OBJECTX_NAMECONTAINS_OFFSET UNITYSDK_OFFSET(0x19770730)
#define FOUNDATION_OBJECTX_NAMEENDSWITH_OFFSET UNITYSDK_OFFSET(0x197706A0)
#define FOUNDATION_OBJECTX_NAMESTARTSWITH_OFFSET UNITYSDK_OFFSET(0x19770610)

namespace Foundation
{
	inline static constexpr unsigned int ObjectX_TypeDefinitionIndex = 7954;
