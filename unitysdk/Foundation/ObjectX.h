...
#define FOUNDATION_OBJECTX_COMPARENAME_1_OFFSET UNITYSDK_OFFSET(0x19382FC0)
#define FOUNDATION_OBJECTX_COMPARENAME_OFFSET UNITYSDK_OFFSET(0x19382F30)
#define FOUNDATION_OBJECTX_NAMECONTAINS_1_OFFSET UNITYSDK_OFFSET(0x19383210)
#define FOUNDATION_OBJECTX_NAMECONTAINS_OFFSET UNITYSDK_OFFSET(0x19383170)
#define FOUNDATION_OBJECTX_NAMEENDSWITH_OFFSET UNITYSDK_OFFSET(0x193830E0)
#define FOUNDATION_OBJECTX_NAMESTARTSWITH_OFFSET UNITYSDK_OFFSET(0x19383050)

namespace Foundation
{
	inline static constexpr unsigned int ObjectX_TypeDefinitionIndex = 8302;
