...
#define FOUNDATION_IPADDRESSUTIL_IPPARSERESULT_GET_IPADDRESS_OFFSET UNITYSDK_OFFSET(0x272280)
#define FOUNDATION_IPADDRESSUTIL_IPPARSERESULT_GET_IPTYPE_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define FOUNDATION_IPADDRESSUTIL_IPPARSERESULT_GET_PORT_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define FOUNDATION_IPADDRESSUTIL_IPPARSERESULT_SET_IPADDRESS_OFFSET UNITYSDK_OFFSET(0x302310)
#define FOUNDATION_IPADDRESSUTIL_IPPARSERESULT_SET_IPTYPE_OFFSET UNITYSDK_OFFSET(0x302300)
#define FOUNDATION_IPADDRESSUTIL_IPPARSERESULT_SET_PORT_OFFSET UNITYSDK_OFFSET(0x3123A0)

namespace Foundation
{
	inline static constexpr unsigned int IpAddressUtil_IpParseResult_TypeDefinitionIndex = 8127;
