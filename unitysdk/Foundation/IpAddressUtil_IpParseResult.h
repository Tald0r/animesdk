...
#define FOUNDATION_IPADDRESSUTIL_IPPARSERESULT_GET_IPADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB080)
#define FOUNDATION_IPADDRESSUTIL_IPPARSERESULT_GET_IPTYPE_OFFSET UNITYSDK_OFFSET(0x2C3E30)
#define FOUNDATION_IPADDRESSUTIL_IPPARSERESULT_GET_PORT_OFFSET UNITYSDK_OFFSET(0x2C6240)
#define FOUNDATION_IPADDRESSUTIL_IPPARSERESULT_SET_IPADDRESS_OFFSET UNITYSDK_OFFSET(0x2CB170)
#define FOUNDATION_IPADDRESSUTIL_IPPARSERESULT_SET_IPTYPE_OFFSET UNITYSDK_OFFSET(0x2D3600)
#define FOUNDATION_IPADDRESSUTIL_IPPARSERESULT_SET_PORT_OFFSET UNITYSDK_OFFSET(0x2D26A0)

namespace Foundation
{
	inline static constexpr unsigned int IpAddressUtil_IpParseResult_TypeDefinitionIndex = 8056;
