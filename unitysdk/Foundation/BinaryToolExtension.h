...
#define FOUNDATION_BINARYTOOLEXTENSION_FROMBINARY_1_OFFSET UNITYSDK_OFFSET(0x1A47D4E0)
#define FOUNDATION_BINARYTOOLEXTENSION_FROMBINARY_2_OFFSET UNITYSDK_OFFSET(0x1A47D730)
#define FOUNDATION_BINARYTOOLEXTENSION_FROMBINARY_3_OFFSET UNITYSDK_OFFSET(0x1A47D960)
#define FOUNDATION_BINARYTOOLEXTENSION_FROMBINARY_4_OFFSET UNITYSDK_OFFSET(0x1A47DBA0)
#define FOUNDATION_BINARYTOOLEXTENSION_FROMBINARY_5_OFFSET UNITYSDK_OFFSET(0x1A47D2B0)
#define FOUNDATION_BINARYTOOLEXTENSION_FROMBINARY_6_OFFSET UNITYSDK_OFFSET(0x1A47DDD0)
#define FOUNDATION_BINARYTOOLEXTENSION_FROMBINARY_OFFSET UNITYSDK_OFFSET(0x1A47CFC0)
#define FOUNDATION_BINARYTOOLEXTENSION_TOBINARY_1_OFFSET UNITYSDK_OFFSET(0x1A47D3C0)
#define FOUNDATION_BINARYTOOLEXTENSION_TOBINARY_2_OFFSET UNITYSDK_OFFSET(0x1A47D610)
#define FOUNDATION_BINARYTOOLEXTENSION_TOBINARY_3_OFFSET UNITYSDK_OFFSET(0x1A47D840)
#define FOUNDATION_BINARYTOOLEXTENSION_TOBINARY_4_OFFSET UNITYSDK_OFFSET(0x1A47DA80)
#define FOUNDATION_BINARYTOOLEXTENSION_TOBINARY_5_OFFSET UNITYSDK_OFFSET(0x1A47CEB0)
#define FOUNDATION_BINARYTOOLEXTENSION_TOBINARY_6_OFFSET UNITYSDK_OFFSET(0x1A47DCC0)
#define FOUNDATION_BINARYTOOLEXTENSION_TOBINARY_OFFSET UNITYSDK_OFFSET(0x1A47CB70)

namespace Foundation
{
	inline static constexpr unsigned int BinaryToolExtension_TypeDefinitionIndex = 8126;
