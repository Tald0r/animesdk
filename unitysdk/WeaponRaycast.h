...
#define WEAPONRAYCAST_DOCALCULATETARGET_OFFSET UNITYSDK_OFFSET(0x18187600)
#define WEAPONRAYCAST_GETBIPROOTPOSITION_OFFSET UNITYSDK_OFFSET(0x18186450)
#define WEAPONRAYCAST_GETDELTAFROMRIGIDBODYTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x18186DE0)
#define WEAPONRAYCAST_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0x18186780)
#define WEAPONRAYCAST_GETSTAGEGROUNDPOSHIT_OFFSET UNITYSDK_OFFSET(0x18186990)
#define WEAPONRAYCAST_GET_BLENDVALUE_OFFSET UNITYSDK_OFFSET(0x18187200)
#define WEAPONRAYCAST_GET_CALCPROCESSTIME_OFFSET UNITYSDK_OFFSET(0x181870B0)
#define WEAPONRAYCAST_GET_ENABLEDEBUG_OFFSET UNITYSDK_OFFSET(0x18186410)
#define WEAPONRAYCAST_GET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x18186430)
#define WEAPONRAYCAST_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x18187C30)
#define WEAPONRAYCAST_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x18187B00)
#define WEAPONRAYCAST_SET_DISABLEDAMPING_OFFSET UNITYSDK_OFFSET(0x181865B0)
#define WEAPONRAYCAST_SET_ENABLEDEBUG_OFFSET UNITYSDK_OFFSET(0x18186420)
#define WEAPONRAYCAST_SET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x18186440)
#define WEAPONRAYCAST_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x18187000)
#define WEAPONRAYCAST_START_OFFSET UNITYSDK_OFFSET(0x181865C0)
#define WEAPONRAYCAST_TRIGGERRAYCASTCLOSE_OFFSET UNITYSDK_OFFSET(0x181874B0)
#define WEAPONRAYCAST_TRIGGERRAYCASTOPEN_OFFSET UNITYSDK_OFFSET(0x18187370)
#define WEAPONRAYCAST_UPDATESETTIME_OFFSET UNITYSDK_OFFSET(0x18187170)
#define WEAPONRAYCAST__CCTOR_OFFSET UNITYSDK_OFFSET(0x18188130)
#define WEAPONRAYCAST__CTOR_OFFSET UNITYSDK_OFFSET(0x181880B0)

inline static constexpr unsigned int WeaponRaycast_TypeDefinitionIndex = 76172;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WeaponRaycast_TypeDefinitionIndex)->GetStaticField(0x39540);
	}
	static ::Il2CppArray<::UnityEngine::RaycastHit>** StaticGet_rayCastHitResults()
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(WeaponRaycast_TypeDefinitionIndex)->GetStaticField(0x39548);
	}
