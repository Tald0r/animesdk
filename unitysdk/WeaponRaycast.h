...
#define WEAPONRAYCAST_DOCALCULATETARGET_OFFSET UNITYSDK_OFFSET(0x15353D40)
#define WEAPONRAYCAST_GETBIPROOTPOSITION_OFFSET UNITYSDK_OFFSET(0x15352B90)
#define WEAPONRAYCAST_GETDELTAFROMRIGIDBODYTOTRANSFORM_OFFSET UNITYSDK_OFFSET(0x15353520)
#define WEAPONRAYCAST_GETRAYCASTHIT_OFFSET UNITYSDK_OFFSET(0x15352EC0)
#define WEAPONRAYCAST_GETSTAGEGROUNDPOSHIT_OFFSET UNITYSDK_OFFSET(0x153530D0)
#define WEAPONRAYCAST_GET_BLENDVALUE_OFFSET UNITYSDK_OFFSET(0x15353940)
#define WEAPONRAYCAST_GET_CALCPROCESSTIME_OFFSET UNITYSDK_OFFSET(0x153537F0)
#define WEAPONRAYCAST_GET_ENABLEDEBUG_OFFSET UNITYSDK_OFFSET(0x15352B50)
#define WEAPONRAYCAST_GET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x15352B70)
#define WEAPONRAYCAST_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x15354370)
#define WEAPONRAYCAST_ONANIMATORIK_OFFSET UNITYSDK_OFFSET(0x15354240)
#define WEAPONRAYCAST_SET_DISABLEDAMPING_OFFSET UNITYSDK_OFFSET(0x15352CF0)
#define WEAPONRAYCAST_SET_ENABLEDEBUG_OFFSET UNITYSDK_OFFSET(0x15352B60)
#define WEAPONRAYCAST_SET_GIZMOSLASTTIME_OFFSET UNITYSDK_OFFSET(0x15352B80)
#define WEAPONRAYCAST_SMOOTHSTEP_OFFSET UNITYSDK_OFFSET(0x15353740)
#define WEAPONRAYCAST_START_OFFSET UNITYSDK_OFFSET(0x15352D00)
#define WEAPONRAYCAST_TRIGGERRAYCASTCLOSE_OFFSET UNITYSDK_OFFSET(0x15353BF0)
#define WEAPONRAYCAST_TRIGGERRAYCASTOPEN_OFFSET UNITYSDK_OFFSET(0x15353AB0)
#define WEAPONRAYCAST_UPDATESETTIME_OFFSET UNITYSDK_OFFSET(0x153538B0)
#define WEAPONRAYCAST__CCTOR_OFFSET UNITYSDK_OFFSET(0x15354870)
#define WEAPONRAYCAST__CTOR_OFFSET UNITYSDK_OFFSET(0x153547F0)

inline static constexpr unsigned int WeaponRaycast_TypeDefinitionIndex = 43049;
...
public:
	...
	{
		return (::System::String**)Il2CppClass::FromTypeDefinitionIndex(WeaponRaycast_TypeDefinitionIndex)->GetStaticField(0x3C1A0);
	}
	static ::Il2CppArray<::UnityEngine::RaycastHit>** StaticGet_rayCastHitResults()
	{
		return (::Il2CppArray<::UnityEngine::RaycastHit>**)Il2CppClass::FromTypeDefinitionIndex(WeaponRaycast_TypeDefinitionIndex)->GetStaticField(0x3C1A8);
	}
