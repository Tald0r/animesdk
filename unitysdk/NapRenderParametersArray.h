...
#define NAPRENDERPARAMETERSARRAY_FILLINGPROPERTYDICT_OFFSET UNITYSDK_OFFSET(0x17B60520)
#define NAPRENDERPARAMETERSARRAY_GETPROPERTYARRAYINFO_OFFSET UNITYSDK_OFFSET(0x17B62860)
#define NAPRENDERPARAMETERSARRAY_GETPROPERTYARRAYSIZE_OFFSET UNITYSDK_OFFSET(0x17B62AB0)
#define NAPRENDERPARAMETERSARRAY_INITMATERIALVECTORARRAYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x17B61FA0)
#define NAPRENDERPARAMETERSARRAY_ISARRAYPROPERTY_OFFSET UNITYSDK_OFFSET(0x17B62A00)
#define NAPRENDERPARAMETERSARRAY__CCTOR_OFFSET UNITYSDK_OFFSET(0x17B62B10)

inline static constexpr unsigned int NapRenderParametersArray_TypeDefinitionIndex = 28130;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::System::ValueTuple_2<::ArrayPropertyType, ::System::String*>>**)Il2CppClass::FromTypeDefinitionIndex(NapRenderParametersArray_TypeDefinitionIndex)->GetStaticField(0x21160);
	}
	static ::System::Collections::Generic::List_1<::System::String*>** StaticGet_floatLayout()
	{
		return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(NapRenderParametersArray_TypeDefinitionIndex)->GetStaticField(0x21168);
	}
	static ::System::Collections::Generic::Dictionary_2<::System::Int32, ::ArrayPropertyData>** StaticGet_propertyIDDict()
	{
		return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::ArrayPropertyData>**)Il2CppClass::FromTypeDefinitionIndex(NapRenderParametersArray_TypeDefinitionIndex)->GetStaticField(0x21170);
	}
	static ::System::Int32* StaticGet_vectorArrayLength()
	{
		return (::System::Int32*)Il2CppClass::FromTypeDefinitionIndex(NapRenderParametersArray_TypeDefinitionIndex)->GetStaticField(0x5920);
	}
	static ::System::Boolean* StaticGet_logOnSetArrayPropertyFromExt()
	{
		return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(NapRenderParametersArray_TypeDefinitionIndex)->GetStaticField(0x5924);
	}
