...
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESIMPL_OFFSET UNITYSDK_OFFSET(0x9FB2770)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICES_OFFSET UNITYSDK_OFFSET(0x9FB26B0)
#define AUDIO_PINVOKE_IDIRECTINPUT8_GETDEVICESGUIDPRODUCT_OFFSET UNITYSDK_OFFSET(0x9FB2590)
#define AUDIO_PINVOKE_IDIRECTINPUT8_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x9FB2790)
#define AUDIO_PINVOKE_IDIRECTINPUT8__CTOR_OFFSET UNITYSDK_OFFSET(0x9FB2520)

inline static constexpr unsigned int Audio_PINVOKE_IDirectInput8_TypeDefinitionIndex = 70693;
...
public:
	...
	::System::IntPtr _callbackPtr; // 0x28
