...
#define AUDIO_PINVOKE_IDIRECTINPUT8_DIRECTINPUTENUMDEVICESIMPL_OFFSET UNITYSDK_OFFSET(0xCBC7110)
#define AUDIO_PINVOKE_IDIRECTINPUT8_ENUMDEVICES_OFFSET UNITYSDK_OFFSET(0xCBC7050)
#define AUDIO_PINVOKE_IDIRECTINPUT8_GETDEVICESGUIDPRODUCT_OFFSET UNITYSDK_OFFSET(0xCBC6F30)
#define AUDIO_PINVOKE_IDIRECTINPUT8_GET_ITEM_OFFSET UNITYSDK_OFFSET(0xCBC7130)
#define AUDIO_PINVOKE_IDIRECTINPUT8__CTOR_OFFSET UNITYSDK_OFFSET(0xCBC6EC0)

inline static constexpr unsigned int Audio_PINVOKE_IDirectInput8_TypeDefinitionIndex = 59819;
