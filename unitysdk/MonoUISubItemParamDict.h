...
#define MONOUISUBITEMPARAMDICT__CTOR_OFFSET UNITYSDK_OFFSET(0xA09A5F0)

inline static constexpr unsigned int MonoUISubItemParamDict_TypeDefinitionIndex = 75895;
