...
#define MB2_TEXTUREBAKERESULTS_CONTAINSMATERIAL_OFFSET UNITYSDK_OFFSET(0x1ACE1120)
#define MB2_TEXTUREBAKERESULTS_CREATEFORMATERIALSONRENDERER_OFFSET UNITYSDK_OFFSET(0x1ACE0550)
#define MB2_TEXTUREBAKERESULTS_DOANYRESULTMATSUSECONSIDERMESHUVS_OFFSET UNITYSDK_OFFSET(0x1ACE0FE0)
#define MB2_TEXTUREBAKERESULTS_FINDRUNTIMEMATERIALSFROMADDRESSES_OFFSET UNITYSDK_OFFSET(0x1ACDFFA0)
#define MB2_TEXTUREBAKERESULTS_GETCOMBINEDMATERIALFORSUBMESH_OFFSET UNITYSDK_OFFSET(0x1ACDFF20)
#define MB2_TEXTUREBAKERESULTS_GETCONSIDERMESHUVS_OFFSET UNITYSDK_OFFSET(0x1ACDFFF0)
#define MB2_TEXTUREBAKERESULTS_GETDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1ACE12C0)
#define MB2_TEXTUREBAKERESULTS_GETSOURCEMATERIALSUSEDBYRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1ACE01E0)
#define MB2_TEXTUREBAKERESULTS_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1ACDFE40)
#define MB2_TEXTUREBAKERESULTS_ISMESHANDMATERIALRECTENCLOSEDBYATLASRECT_OFFSET UNITYSDK_OFFSET(0x1ACE19E0)
#define MB2_TEXTUREBAKERESULTS_NUMRESULTMATERIALS_OFFSET UNITYSDK_OFFSET(0x1ACDFEF0)
#define MB2_TEXTUREBAKERESULTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1ACDFE90)
#define MB2_TEXTUREBAKERESULTS_UPGRADETOCURRENTVERSION_OFFSET UNITYSDK_OFFSET(0x1ACE1980)
#define MB2_TEXTUREBAKERESULTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1ACDFE50)

inline static constexpr unsigned int MB2_TextureBakeResults_TypeDefinitionIndex = 81186;
