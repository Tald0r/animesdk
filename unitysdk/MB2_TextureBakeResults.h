...
#define MB2_TEXTUREBAKERESULTS_CONTAINSMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B304E20)
#define MB2_TEXTUREBAKERESULTS_CREATEFORMATERIALSONRENDERER_OFFSET UNITYSDK_OFFSET(0x1B304250)
#define MB2_TEXTUREBAKERESULTS_DOANYRESULTMATSUSECONSIDERMESHUVS_OFFSET UNITYSDK_OFFSET(0x1B304CE0)
#define MB2_TEXTUREBAKERESULTS_FINDRUNTIMEMATERIALSFROMADDRESSES_OFFSET UNITYSDK_OFFSET(0x1B303CA0)
#define MB2_TEXTUREBAKERESULTS_GETCOMBINEDMATERIALFORSUBMESH_OFFSET UNITYSDK_OFFSET(0x1B303C20)
#define MB2_TEXTUREBAKERESULTS_GETCONSIDERMESHUVS_OFFSET UNITYSDK_OFFSET(0x1B303CF0)
#define MB2_TEXTUREBAKERESULTS_GETDESCRIPTION_OFFSET UNITYSDK_OFFSET(0x1B304FC0)
#define MB2_TEXTUREBAKERESULTS_GETSOURCEMATERIALSUSEDBYRESULTMATERIAL_OFFSET UNITYSDK_OFFSET(0x1B303EE0)
#define MB2_TEXTUREBAKERESULTS_GET_VERSION_OFFSET UNITYSDK_OFFSET(0x1B303B40)
#define MB2_TEXTUREBAKERESULTS_ISMESHANDMATERIALRECTENCLOSEDBYATLASRECT_OFFSET UNITYSDK_OFFSET(0x1B3056E0)
#define MB2_TEXTUREBAKERESULTS_NUMRESULTMATERIALS_OFFSET UNITYSDK_OFFSET(0x1B303BF0)
#define MB2_TEXTUREBAKERESULTS_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B303B90)
#define MB2_TEXTUREBAKERESULTS_UPGRADETOCURRENTVERSION_OFFSET UNITYSDK_OFFSET(0x1B305680)
#define MB2_TEXTUREBAKERESULTS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B303B50)

inline static constexpr unsigned int MB2_TextureBakeResults_TypeDefinitionIndex = 83227;
