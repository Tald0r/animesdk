...
#define WOBBLEPATH_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B1B50A0)
#define WOBBLEPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1B1B52E0)

inline static constexpr unsigned int WobblePath_TypeDefinitionIndex = 30835;
