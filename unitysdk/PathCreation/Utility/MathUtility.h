...
#define PATHCREATION_UTILITY_MATHUTILITY_CLOSESTPOINTONLINESEGMENT_1_OFFSET UNITYSDK_OFFSET(0x1A51D2C0)
#define PATHCREATION_UTILITY_MATHUTILITY_CLOSESTPOINTONLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x1A51D200)
#define PATHCREATION_UTILITY_MATHUTILITY_INVERSETRANSFORMDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A51CE00)
#define PATHCREATION_UTILITY_MATHUTILITY_INVERSETRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1A51CA80)
#define PATHCREATION_UTILITY_MATHUTILITY_INVERSETRANSFORMVECTOR_OFFSET UNITYSDK_OFFSET(0x1A51CC40)
#define PATHCREATION_UTILITY_MATHUTILITY_LINESEGMENTSINTERSECT_OFFSET UNITYSDK_OFFSET(0x1A51CEE0)
#define PATHCREATION_UTILITY_MATHUTILITY_LINESINTERSECT_OFFSET UNITYSDK_OFFSET(0x1A51CFE0)
#define PATHCREATION_UTILITY_MATHUTILITY_LOCKTRANSFORMTOSPACE_OFFSET UNITYSDK_OFFSET(0x1A51C3F0)
#define PATHCREATION_UTILITY_MATHUTILITY_MINANGLE_OFFSET UNITYSDK_OFFSET(0x1A51D400)
#define PATHCREATION_UTILITY_MATHUTILITY_POINTINTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1A51D520)
#define PATHCREATION_UTILITY_MATHUTILITY_POINTOFLINELINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1A51D040)
#define PATHCREATION_UTILITY_MATHUTILITY_POINTSARECLOCKWISE_OFFSET UNITYSDK_OFFSET(0x1A51D680)
#define PATHCREATION_UTILITY_MATHUTILITY_SIDEOFLINE_OFFSET UNITYSDK_OFFSET(0x1A51D3A0)
#define PATHCREATION_UTILITY_MATHUTILITY_TRANSFORMDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A51CD20)
#define PATHCREATION_UTILITY_MATHUTILITY_TRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1A515B10)
#define PATHCREATION_UTILITY_MATHUTILITY_TRANSFORMVECTOR_OFFSET UNITYSDK_OFFSET(0x1A51CB60)

namespace PathCreation::Utility
{
	inline static constexpr unsigned int MathUtility_TypeDefinitionIndex = 34300;
