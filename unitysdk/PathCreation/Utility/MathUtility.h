...
#define PATHCREATION_UTILITY_MATHUTILITY_CLOSESTPOINTONLINESEGMENT_1_OFFSET UNITYSDK_OFFSET(0x1AAD6C60)
#define PATHCREATION_UTILITY_MATHUTILITY_CLOSESTPOINTONLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x1AAD6BA0)
#define PATHCREATION_UTILITY_MATHUTILITY_INVERSETRANSFORMDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AAD67A0)
#define PATHCREATION_UTILITY_MATHUTILITY_INVERSETRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1AAD6420)
#define PATHCREATION_UTILITY_MATHUTILITY_INVERSETRANSFORMVECTOR_OFFSET UNITYSDK_OFFSET(0x1AAD65E0)
#define PATHCREATION_UTILITY_MATHUTILITY_LINESEGMENTSINTERSECT_OFFSET UNITYSDK_OFFSET(0x1AAD6880)
#define PATHCREATION_UTILITY_MATHUTILITY_LINESINTERSECT_OFFSET UNITYSDK_OFFSET(0x1AAD6980)
#define PATHCREATION_UTILITY_MATHUTILITY_LOCKTRANSFORMTOSPACE_OFFSET UNITYSDK_OFFSET(0x1AAD5D90)
#define PATHCREATION_UTILITY_MATHUTILITY_MINANGLE_OFFSET UNITYSDK_OFFSET(0x1AAD6DA0)
#define PATHCREATION_UTILITY_MATHUTILITY_POINTINTRIANGLE_OFFSET UNITYSDK_OFFSET(0x1AAD6EC0)
#define PATHCREATION_UTILITY_MATHUTILITY_POINTOFLINELINEINTERSECTION_OFFSET UNITYSDK_OFFSET(0x1AAD69E0)
#define PATHCREATION_UTILITY_MATHUTILITY_POINTSARECLOCKWISE_OFFSET UNITYSDK_OFFSET(0x1AAD7020)
#define PATHCREATION_UTILITY_MATHUTILITY_SIDEOFLINE_OFFSET UNITYSDK_OFFSET(0x1AAD6D40)
#define PATHCREATION_UTILITY_MATHUTILITY_TRANSFORMDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AAD66C0)
#define PATHCREATION_UTILITY_MATHUTILITY_TRANSFORMPOINT_OFFSET UNITYSDK_OFFSET(0x1AACF4B0)
#define PATHCREATION_UTILITY_MATHUTILITY_TRANSFORMVECTOR_OFFSET UNITYSDK_OFFSET(0x1AAD6500)

namespace PathCreation::Utility
{
	inline static constexpr unsigned int MathUtility_TypeDefinitionIndex = 35302;
