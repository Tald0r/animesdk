...
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_CALCULATESEGMENTBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A51BCB0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_ESTIMATECURVELENGTH_OFFSET UNITYSDK_OFFSET(0x1A51C0E0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVEDERIVATIVE_1_OFFSET UNITYSDK_OFFSET(0x1A51B1F0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVEDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1A51B050)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVESECONDDERIVATIVE_1_OFFSET UNITYSDK_OFFSET(0x1A51B4C0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVESECONDDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1A51B320)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVE_1_OFFSET UNITYSDK_OFFSET(0x1A51AF80)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVE_OFFSET UNITYSDK_OFFSET(0x1A515EC0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EXTREMEPOINTTIMES_OFFSET UNITYSDK_OFFSET(0x1A515C30)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_NORMAL_1_OFFSET UNITYSDK_OFFSET(0x1A51B980)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_NORMAL_OFFSET UNITYSDK_OFFSET(0x1A51B630)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_SPLITCURVE_OFFSET UNITYSDK_OFFSET(0x1A5145B0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_STATIONARYPOINTTIMES_OFFSET UNITYSDK_OFFSET(0x1A51C280)

namespace PathCreation::Utility
{
	inline static constexpr unsigned int CubicBezierUtility_TypeDefinitionIndex = 34299;
