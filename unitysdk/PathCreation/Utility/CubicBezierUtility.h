...
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_CALCULATESEGMENTBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AAD5650)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_ESTIMATECURVELENGTH_OFFSET UNITYSDK_OFFSET(0x1AAD5A80)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVEDERIVATIVE_1_OFFSET UNITYSDK_OFFSET(0x1AAD4B90)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVEDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1AAD49F0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVESECONDDERIVATIVE_1_OFFSET UNITYSDK_OFFSET(0x1AAD4E60)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVESECONDDERIVATIVE_OFFSET UNITYSDK_OFFSET(0x1AAD4CC0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVE_1_OFFSET UNITYSDK_OFFSET(0x1AAD4920)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EVALUATECURVE_OFFSET UNITYSDK_OFFSET(0x1AACF860)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_EXTREMEPOINTTIMES_OFFSET UNITYSDK_OFFSET(0x1AACF5D0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_NORMAL_1_OFFSET UNITYSDK_OFFSET(0x1AAD5320)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_NORMAL_OFFSET UNITYSDK_OFFSET(0x1AAD4FD0)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_SPLITCURVE_OFFSET UNITYSDK_OFFSET(0x1AACDF50)
#define PATHCREATION_UTILITY_CUBICBEZIERUTILITY_STATIONARYPOINTTIMES_OFFSET UNITYSDK_OFFSET(0x1AAD5C20)

namespace PathCreation::Utility
{
	inline static constexpr unsigned int CubicBezierUtility_TypeDefinitionIndex = 35301;
