...
#define PATHCREATION_VERTEXPATH_CALCULATECLOSESTPOINTONPATHDATA_OFFSET UNITYSDK_OFFSET(0x1AADB180)
#define PATHCREATION_VERTEXPATH_CALCULATEPERCENTONPATHDATA_OFFSET UNITYSDK_OFFSET(0x1AADABF0)
#define PATHCREATION_VERTEXPATH_GETCLOSESTDISTANCEALONGPATH_OFFSET UNITYSDK_OFFSET(0x1AAD1540)
#define PATHCREATION_VERTEXPATH_GETCLOSESTPOINTONPATH_OFFSET UNITYSDK_OFFSET(0x1AADAE80)
#define PATHCREATION_VERTEXPATH_GETCLOSESTTIMEONPATH_OFFSET UNITYSDK_OFFSET(0x1AADBA10)
#define PATHCREATION_VERTEXPATH_GETDIRECTIONATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AADA3D0)
#define PATHCREATION_VERTEXPATH_GETDIRECTION_OFFSET UNITYSDK_OFFSET(0x1AADA400)
#define PATHCREATION_VERTEXPATH_GETNORMALATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AADA600)
#define PATHCREATION_VERTEXPATH_GETNORMAL_1_OFFSET UNITYSDK_OFFSET(0x1AADA630)
#define PATHCREATION_VERTEXPATH_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x1AAD3AB0)
#define PATHCREATION_VERTEXPATH_GETPOINTATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AAD1440)
#define PATHCREATION_VERTEXPATH_GETPOINTATTIME_OFFSET UNITYSDK_OFFSET(0x1AADA0F0)
#define PATHCREATION_VERTEXPATH_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1AAD3BF0)
#define PATHCREATION_VERTEXPATH_GETROTATIONATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AAD1470)
#define PATHCREATION_VERTEXPATH_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1AADA830)
#define PATHCREATION_VERTEXPATH_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x1AAD3970)
#define PATHCREATION_VERTEXPATH_GET_NUMPOINTS_OFFSET UNITYSDK_OFFSET(0x1AAD3950)
#define PATHCREATION_VERTEXPATH_UPDATETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AADA0E0)
#define PATHCREATION_VERTEXPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AADA090)
#define PATHCREATION_VERTEXPATH__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AAD9070)
#define PATHCREATION_VERTEXPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD4860)

namespace PathCreation
{
	inline static constexpr unsigned int VertexPath_TypeDefinitionIndex = 35299;
	...
	public:
		...
		::Il2CppArray<::UnityEngine::Vector3>* localPoints; // 0x10
		...
		::Il2CppArray<::System::Single>* times; // 0x30
		::Il2CppArray<::UnityEngine::Vector3>* localNormals; // 0x38
		::UnityEngine::Vector3 up; // 0x40
		::System::Boolean isClosedLoop; // 0x4C
		::System::Single length; // 0x50
		::PathCreation::PathSpace space; // 0x54
