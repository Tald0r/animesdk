...
#define PATHCREATION_VERTEXPATH_CALCULATECLOSESTPOINTONPATHDATA_OFFSET UNITYSDK_OFFSET(0x1A5217E0)
#define PATHCREATION_VERTEXPATH_CALCULATEPERCENTONPATHDATA_OFFSET UNITYSDK_OFFSET(0x1A521250)
#define PATHCREATION_VERTEXPATH_GETCLOSESTDISTANCEALONGPATH_OFFSET UNITYSDK_OFFSET(0x1A517BA0)
#define PATHCREATION_VERTEXPATH_GETCLOSESTPOINTONPATH_OFFSET UNITYSDK_OFFSET(0x1A5214E0)
#define PATHCREATION_VERTEXPATH_GETCLOSESTTIMEONPATH_OFFSET UNITYSDK_OFFSET(0x1A522070)
#define PATHCREATION_VERTEXPATH_GETDIRECTIONATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A520A30)
#define PATHCREATION_VERTEXPATH_GETDIRECTION_OFFSET UNITYSDK_OFFSET(0x1A520A60)
#define PATHCREATION_VERTEXPATH_GETNORMALATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A520C60)
#define PATHCREATION_VERTEXPATH_GETNORMAL_1_OFFSET UNITYSDK_OFFSET(0x1A520C90)
#define PATHCREATION_VERTEXPATH_GETNORMAL_OFFSET UNITYSDK_OFFSET(0x1A51A110)
#define PATHCREATION_VERTEXPATH_GETPOINTATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A517AA0)
#define PATHCREATION_VERTEXPATH_GETPOINTATTIME_OFFSET UNITYSDK_OFFSET(0x1A520750)
#define PATHCREATION_VERTEXPATH_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1A51A250)
#define PATHCREATION_VERTEXPATH_GETROTATIONATDISTANCE_OFFSET UNITYSDK_OFFSET(0x1A517AD0)
#define PATHCREATION_VERTEXPATH_GETROTATION_OFFSET UNITYSDK_OFFSET(0x1A520E90)
#define PATHCREATION_VERTEXPATH_GETTANGENT_OFFSET UNITYSDK_OFFSET(0x1A519FD0)
#define PATHCREATION_VERTEXPATH_GET_NUMPOINTS_OFFSET UNITYSDK_OFFSET(0x1A519FB0)
#define PATHCREATION_VERTEXPATH_UPDATETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A520740)
#define PATHCREATION_VERTEXPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5206F0)
#define PATHCREATION_VERTEXPATH__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A51F6D0)
#define PATHCREATION_VERTEXPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A51AEC0)

namespace PathCreation
{
	inline static constexpr unsigned int VertexPath_TypeDefinitionIndex = 34297;
	...
	public:
		...
		::Il2CppArray<::System::Single>* cumulativeLengthAtEachVertex; // 0x18
		...
		::Il2CppArray<::UnityEngine::Vector3>* localTangents; // 0x38
		::PathCreation::PathSpace space; // 0x40
		::System::Single length; // 0x44
		::UnityEngine::Bounds bounds; // 0x48
		::UnityEngine::Vector3 up; // 0x60
		::System::Boolean isClosedLoop; // 0x6C
