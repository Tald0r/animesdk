...
#define PATHCREATION_MINMAX3D_ADDVALUE_OFFSET UNITYSDK_OFFSET(0x1A515BF0)
#define PATHCREATION_MINMAX3D_GET_MAX_OFFSET UNITYSDK_OFFSET(0x1A51A4E0)
#define PATHCREATION_MINMAX3D_GET_MIN_OFFSET UNITYSDK_OFFSET(0x1A51A4B0)
#define PATHCREATION_MINMAX3D_SET_MAX_OFFSET UNITYSDK_OFFSET(0x1A51A500)
#define PATHCREATION_MINMAX3D_SET_MIN_OFFSET UNITYSDK_OFFSET(0x1A51A4D0)
#define PATHCREATION_MINMAX3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1A515AB0)

namespace PathCreation
{
	inline static constexpr unsigned int MinMax3D_TypeDefinitionIndex = 34293;
