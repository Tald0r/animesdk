...
#define PATHCREATION_MINMAX3D_ADDVALUE_OFFSET UNITYSDK_OFFSET(0x1AACF590)
#define PATHCREATION_MINMAX3D_GET_MAX_OFFSET UNITYSDK_OFFSET(0x1AAD3E80)
#define PATHCREATION_MINMAX3D_GET_MIN_OFFSET UNITYSDK_OFFSET(0x1AAD3E50)
#define PATHCREATION_MINMAX3D_SET_MAX_OFFSET UNITYSDK_OFFSET(0x1AAD3EA0)
#define PATHCREATION_MINMAX3D_SET_MIN_OFFSET UNITYSDK_OFFSET(0x1AAD3E70)
#define PATHCREATION_MINMAX3D__CTOR_OFFSET UNITYSDK_OFFSET(0x1AACF450)

namespace PathCreation
{
	inline static constexpr unsigned int MinMax3D_TypeDefinitionIndex = 35295;
