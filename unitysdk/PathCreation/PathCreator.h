...
#define PATHCREATION_PATHCREATOR_ADD_PATHUPDATED_OFFSET UNITYSDK_OFFSET(0x1A5177B0)
#define PATHCREATION_PATHCREATOR_GET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1A51A7C0)
#define PATHCREATION_PATHCREATOR_GET_EDITORDATA_OFFSET UNITYSDK_OFFSET(0x1A51ABD0)
#define PATHCREATION_PATHCREATOR_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1A5179C0)
#define PATHCREATION_PATHCREATOR_INITIALIZEEDITORDATA_OFFSET UNITYSDK_OFFSET(0x1A51A570)
#define PATHCREATION_PATHCREATOR_REMOVE_PATHUPDATED_OFFSET UNITYSDK_OFFSET(0x1A51A510)
#define PATHCREATION_PATHCREATOR_SET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1A517610)
#define PATHCREATION_PATHCREATOR_TRIGGERPATHUPDATE_OFFSET UNITYSDK_OFFSET(0x1A51ABE0)
#define PATHCREATION_PATHCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A51ABF0)

namespace PathCreation
{
	inline static constexpr unsigned int PathCreator_TypeDefinitionIndex = 34294;
