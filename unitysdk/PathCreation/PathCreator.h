...
#define PATHCREATION_PATHCREATOR_ADD_PATHUPDATED_OFFSET UNITYSDK_OFFSET(0x1AAD1150)
#define PATHCREATION_PATHCREATOR_GET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1AAD4160)
#define PATHCREATION_PATHCREATOR_GET_EDITORDATA_OFFSET UNITYSDK_OFFSET(0x1AAD4570)
#define PATHCREATION_PATHCREATOR_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1AAD1360)
#define PATHCREATION_PATHCREATOR_INITIALIZEEDITORDATA_OFFSET UNITYSDK_OFFSET(0x1AAD3F10)
#define PATHCREATION_PATHCREATOR_REMOVE_PATHUPDATED_OFFSET UNITYSDK_OFFSET(0x1AAD3EB0)
#define PATHCREATION_PATHCREATOR_SET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1AAD0FB0)
#define PATHCREATION_PATHCREATOR_TRIGGERPATHUPDATE_OFFSET UNITYSDK_OFFSET(0x1AAD4580)
#define PATHCREATION_PATHCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD4590)

namespace PathCreation
{
	inline static constexpr unsigned int PathCreator_TypeDefinitionIndex = 35296;
