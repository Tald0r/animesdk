...
#define PATHCREATION_BEZIERPATH_ADDSEGMENTTOEND_OFFSET UNITYSDK_OFFSET(0x1AACBE70)
#define PATHCREATION_BEZIERPATH_ADDSEGMENTTOSTART_OFFSET UNITYSDK_OFFSET(0x1AACD250)
#define PATHCREATION_BEZIERPATH_ADD_ONMODIFIED_OFFSET UNITYSDK_OFFSET(0x1AACB370)
#define PATHCREATION_BEZIERPATH_ADD_ONMOVEPOINT_OFFSET UNITYSDK_OFFSET(0x1AACB430)
#define PATHCREATION_BEZIERPATH_AUTOSETALLAFFECTEDCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1AACD1D0)
#define PATHCREATION_BEZIERPATH_AUTOSETALLCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1AACD090)
#define PATHCREATION_BEZIERPATH_AUTOSETANCHORCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1AAD0220)
#define PATHCREATION_BEZIERPATH_AUTOSETSTARTANDENDCONTROLS_OFFSET UNITYSDK_OFFSET(0x1AAD07E0)
#define PATHCREATION_BEZIERPATH_CALCULATEBOUNDSWITHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1AACEC40)
#define PATHCREATION_BEZIERPATH_DELETESEGMENT_OFFSET UNITYSDK_OFFSET(0x1AACE980)
#define PATHCREATION_BEZIERPATH_GETANCHORNORMALANGLE_OFFSET UNITYSDK_OFFSET(0x1AACFA40)
#define PATHCREATION_BEZIERPATH_GETPOINTSINSEGMENT_OFFSET UNITYSDK_OFFSET(0x1AACDD70)
#define PATHCREATION_BEZIERPATH_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1AACC5B0)
#define PATHCREATION_BEZIERPATH_GET_AUTOCONTROLLENGTH_OFFSET UNITYSDK_OFFSET(0x1AACD110)
#define PATHCREATION_BEZIERPATH_GET_CONTROLPOINTMODE_OFFSET UNITYSDK_OFFSET(0x1AACCFE0)
#define PATHCREATION_BEZIERPATH_GET_FLIPNORMALS_OFFSET UNITYSDK_OFFSET(0x1AACF9C0)
#define PATHCREATION_BEZIERPATH_GET_GLOBALNORMALSANGLE_OFFSET UNITYSDK_OFFSET(0x1AACFA00)
#define PATHCREATION_BEZIERPATH_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x1AACCBA0)
#define PATHCREATION_BEZIERPATH_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1AACC560)
#define PATHCREATION_BEZIERPATH_GET_NUMANCHORPOINTS_OFFSET UNITYSDK_OFFSET(0x1AACC6C0)
#define PATHCREATION_BEZIERPATH_GET_NUMPOINTS_OFFSET UNITYSDK_OFFSET(0x1AACC6A0)
#define PATHCREATION_BEZIERPATH_GET_NUMSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1AACC710)
#define PATHCREATION_BEZIERPATH_GET_PATHBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AACFBA0)
#define PATHCREATION_BEZIERPATH_GET_SPACE_OFFSET UNITYSDK_OFFSET(0x1AACC740)
#define PATHCREATION_BEZIERPATH_LOOPINDEX_OFFSET UNITYSDK_OFFSET(0x1AACEC10)
#define PATHCREATION_BEZIERPATH_MOVEPOINT_OFFSET UNITYSDK_OFFSET(0x1AACE420)
#define PATHCREATION_BEZIERPATH_NOTIFYPATHMODIFIED_OFFSET UNITYSDK_OFFSET(0x1AACC680)
#define PATHCREATION_BEZIERPATH_ONMOVEPONT_OFFSET UNITYSDK_OFFSET(0x1AACB530)
#define PATHCREATION_BEZIERPATH_REMOVE_ONMODIFIED_OFFSET UNITYSDK_OFFSET(0x1AACB3D0)
#define PATHCREATION_BEZIERPATH_REMOVE_ONMOVEPOINT_OFFSET UNITYSDK_OFFSET(0x1AACB4B0)
#define PATHCREATION_BEZIERPATH_RESETNORMALANGLES_OFFSET UNITYSDK_OFFSET(0x1AACFB10)
#define PATHCREATION_BEZIERPATH_SETANCHORNORMALANGLE_OFFSET UNITYSDK_OFFSET(0x1AACFA80)
#define PATHCREATION_BEZIERPATH_SETPOINT_OFFSET UNITYSDK_OFFSET(0x1AACC600)
#define PATHCREATION_BEZIERPATH_SET_AUTOCONTROLLENGTH_OFFSET UNITYSDK_OFFSET(0x1AACD120)
#define PATHCREATION_BEZIERPATH_SET_CONTROLPOINTMODE_OFFSET UNITYSDK_OFFSET(0x1AACCFF0)
#define PATHCREATION_BEZIERPATH_SET_FLIPNORMALS_OFFSET UNITYSDK_OFFSET(0x1AACF9D0)
#define PATHCREATION_BEZIERPATH_SET_GLOBALNORMALSANGLE_OFFSET UNITYSDK_OFFSET(0x1AACFA10)
#define PATHCREATION_BEZIERPATH_SET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x1AACBB50)
#define PATHCREATION_BEZIERPATH_SET_SPACE_OFFSET UNITYSDK_OFFSET(0x1AACBB30)
#define PATHCREATION_BEZIERPATH_SPLITSEGMENT_OFFSET UNITYSDK_OFFSET(0x1AACD590)
#define PATHCREATION_BEZIERPATH_UPDATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1AACFBE0)
#define PATHCREATION_BEZIERPATH_UPDATECLOSEDSTATE_OFFSET UNITYSDK_OFFSET(0x1AACCBB0)
#define PATHCREATION_BEZIERPATH_UPDATETONEWPATHSPACE_OFFSET UNITYSDK_OFFSET(0x1AACC750)
#define PATHCREATION_BEZIERPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AACBB70)
#define PATHCREATION_BEZIERPATH__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AACC200)
#define PATHCREATION_BEZIERPATH__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AACC320)
#define PATHCREATION_BEZIERPATH__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1AACC440)
#define PATHCREATION_BEZIERPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1AACB5A0)

namespace PathCreation
{
	inline static constexpr unsigned int BezierPath_TypeDefinitionIndex = 35289;
