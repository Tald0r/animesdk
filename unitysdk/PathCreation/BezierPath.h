...
#define PATHCREATION_BEZIERPATH_ADDSEGMENTTOEND_OFFSET UNITYSDK_OFFSET(0x1A5124D0)
#define PATHCREATION_BEZIERPATH_ADDSEGMENTTOSTART_OFFSET UNITYSDK_OFFSET(0x1A5138B0)
#define PATHCREATION_BEZIERPATH_ADD_ONMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A5119D0)
#define PATHCREATION_BEZIERPATH_ADD_ONMOVEPOINT_OFFSET UNITYSDK_OFFSET(0x1A511A90)
#define PATHCREATION_BEZIERPATH_AUTOSETALLAFFECTEDCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1A513830)
#define PATHCREATION_BEZIERPATH_AUTOSETALLCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1A5136F0)
#define PATHCREATION_BEZIERPATH_AUTOSETANCHORCONTROLPOINTS_OFFSET UNITYSDK_OFFSET(0x1A516880)
#define PATHCREATION_BEZIERPATH_AUTOSETSTARTANDENDCONTROLS_OFFSET UNITYSDK_OFFSET(0x1A516E40)
#define PATHCREATION_BEZIERPATH_CALCULATEBOUNDSWITHTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1A5152A0)
#define PATHCREATION_BEZIERPATH_DELETESEGMENT_OFFSET UNITYSDK_OFFSET(0x1A514FE0)
#define PATHCREATION_BEZIERPATH_GETANCHORNORMALANGLE_OFFSET UNITYSDK_OFFSET(0x1A5160A0)
#define PATHCREATION_BEZIERPATH_GETPOINTSINSEGMENT_OFFSET UNITYSDK_OFFSET(0x1A5143D0)
#define PATHCREATION_BEZIERPATH_GETPOINT_OFFSET UNITYSDK_OFFSET(0x1A512C10)
#define PATHCREATION_BEZIERPATH_GET_AUTOCONTROLLENGTH_OFFSET UNITYSDK_OFFSET(0x1A513770)
#define PATHCREATION_BEZIERPATH_GET_CONTROLPOINTMODE_OFFSET UNITYSDK_OFFSET(0x1A513640)
#define PATHCREATION_BEZIERPATH_GET_FLIPNORMALS_OFFSET UNITYSDK_OFFSET(0x1A516020)
#define PATHCREATION_BEZIERPATH_GET_GLOBALNORMALSANGLE_OFFSET UNITYSDK_OFFSET(0x1A516060)
#define PATHCREATION_BEZIERPATH_GET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x1A513200)
#define PATHCREATION_BEZIERPATH_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x1A512BC0)
#define PATHCREATION_BEZIERPATH_GET_NUMANCHORPOINTS_OFFSET UNITYSDK_OFFSET(0x1A512D20)
#define PATHCREATION_BEZIERPATH_GET_NUMPOINTS_OFFSET UNITYSDK_OFFSET(0x1A512D00)
#define PATHCREATION_BEZIERPATH_GET_NUMSEGMENTS_OFFSET UNITYSDK_OFFSET(0x1A512D70)
#define PATHCREATION_BEZIERPATH_GET_PATHBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A516200)
#define PATHCREATION_BEZIERPATH_GET_SPACE_OFFSET UNITYSDK_OFFSET(0x1A512DA0)
#define PATHCREATION_BEZIERPATH_LOOPINDEX_OFFSET UNITYSDK_OFFSET(0x1A515270)
#define PATHCREATION_BEZIERPATH_MOVEPOINT_OFFSET UNITYSDK_OFFSET(0x1A514A80)
#define PATHCREATION_BEZIERPATH_NOTIFYPATHMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A512CE0)
#define PATHCREATION_BEZIERPATH_ONMOVEPONT_OFFSET UNITYSDK_OFFSET(0x1A511B90)
#define PATHCREATION_BEZIERPATH_REMOVE_ONMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A511A30)
#define PATHCREATION_BEZIERPATH_REMOVE_ONMOVEPOINT_OFFSET UNITYSDK_OFFSET(0x1A511B10)
#define PATHCREATION_BEZIERPATH_RESETNORMALANGLES_OFFSET UNITYSDK_OFFSET(0x1A516170)
#define PATHCREATION_BEZIERPATH_SETANCHORNORMALANGLE_OFFSET UNITYSDK_OFFSET(0x1A5160E0)
#define PATHCREATION_BEZIERPATH_SETPOINT_OFFSET UNITYSDK_OFFSET(0x1A512C60)
#define PATHCREATION_BEZIERPATH_SET_AUTOCONTROLLENGTH_OFFSET UNITYSDK_OFFSET(0x1A513780)
#define PATHCREATION_BEZIERPATH_SET_CONTROLPOINTMODE_OFFSET UNITYSDK_OFFSET(0x1A513650)
#define PATHCREATION_BEZIERPATH_SET_FLIPNORMALS_OFFSET UNITYSDK_OFFSET(0x1A516030)
#define PATHCREATION_BEZIERPATH_SET_GLOBALNORMALSANGLE_OFFSET UNITYSDK_OFFSET(0x1A516070)
#define PATHCREATION_BEZIERPATH_SET_ISCLOSED_OFFSET UNITYSDK_OFFSET(0x1A5121B0)
#define PATHCREATION_BEZIERPATH_SET_SPACE_OFFSET UNITYSDK_OFFSET(0x1A512190)
#define PATHCREATION_BEZIERPATH_SPLITSEGMENT_OFFSET UNITYSDK_OFFSET(0x1A513BF0)
#define PATHCREATION_BEZIERPATH_UPDATEBOUNDS_OFFSET UNITYSDK_OFFSET(0x1A516240)
#define PATHCREATION_BEZIERPATH_UPDATECLOSEDSTATE_OFFSET UNITYSDK_OFFSET(0x1A513210)
#define PATHCREATION_BEZIERPATH_UPDATETONEWPATHSPACE_OFFSET UNITYSDK_OFFSET(0x1A512DB0)
#define PATHCREATION_BEZIERPATH__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A5121D0)
#define PATHCREATION_BEZIERPATH__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A512860)
#define PATHCREATION_BEZIERPATH__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A512980)
#define PATHCREATION_BEZIERPATH__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1A512AA0)
#define PATHCREATION_BEZIERPATH__CTOR_OFFSET UNITYSDK_OFFSET(0x1A511C00)

namespace PathCreation
{
	inline static constexpr unsigned int BezierPath_TypeDefinitionIndex = 34287;
