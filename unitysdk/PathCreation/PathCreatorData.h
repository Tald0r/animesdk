...
#define PATHCREATION_PATHCREATORDATA_ADD_BEZIERCREATED_OFFSET UNITYSDK_OFFSET(0x1A51AC10)
#define PATHCREATION_PATHCREATORDATA_ADD_BEZIERORVERTEXPATHMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A51AA00)
#define PATHCREATION_PATHCREATORDATA_BEZIERPATHEDITED_OFFSET UNITYSDK_OFFSET(0x1A51AF60)
#define PATHCREATION_PATHCREATORDATA_CREATEBEZIER_OFFSET UNITYSDK_OFFSET(0x1A51ACD0)
#define PATHCREATION_PATHCREATORDATA_GETVERTEXPATH_OFFSET UNITYSDK_OFFSET(0x1A51A700)
#define PATHCREATION_PATHCREATORDATA_GET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1A51AEB0)
#define PATHCREATION_PATHCREATORDATA_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1A51AA60)
#define PATHCREATION_PATHCREATORDATA_PATHMODIFIEDBYUNDO_OFFSET UNITYSDK_OFFSET(0x1A51AF40)
#define PATHCREATION_PATHCREATORDATA_PATHTRANSFORMED_OFFSET UNITYSDK_OFFSET(0x1A51AF10)
#define PATHCREATION_PATHCREATORDATA_REMOVE_BEZIERCREATED_OFFSET UNITYSDK_OFFSET(0x1A51AC70)
#define PATHCREATION_PATHCREATORDATA_REMOVE_BEZIERORVERTEXPATHMODIFIED_OFFSET UNITYSDK_OFFSET(0x1A51A9A0)
#define PATHCREATION_PATHCREATORDATA_RESETBEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1A51AE80)
#define PATHCREATION_PATHCREATORDATA_SET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1A51A800)
#define PATHCREATION_PATHCREATORDATA_VERTEXPATHSETTINGSCHANGED_OFFSET UNITYSDK_OFFSET(0x1A51AF20)
#define PATHCREATION_PATHCREATORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1A51A970)

namespace PathCreation
{
	inline static constexpr unsigned int PathCreatorData_TypeDefinitionIndex = 34295;
