...
#define PATHCREATION_PATHCREATORDATA_ADD_BEZIERCREATED_OFFSET UNITYSDK_OFFSET(0x1AAD45B0)
#define PATHCREATION_PATHCREATORDATA_ADD_BEZIERORVERTEXPATHMODIFIED_OFFSET UNITYSDK_OFFSET(0x1AAD43A0)
#define PATHCREATION_PATHCREATORDATA_BEZIERPATHEDITED_OFFSET UNITYSDK_OFFSET(0x1AAD4900)
#define PATHCREATION_PATHCREATORDATA_CREATEBEZIER_OFFSET UNITYSDK_OFFSET(0x1AAD4670)
#define PATHCREATION_PATHCREATORDATA_GETVERTEXPATH_OFFSET UNITYSDK_OFFSET(0x1AAD40A0)
#define PATHCREATION_PATHCREATORDATA_GET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1AAD4850)
#define PATHCREATION_PATHCREATORDATA_INITIALIZE_OFFSET UNITYSDK_OFFSET(0x1AAD4400)
#define PATHCREATION_PATHCREATORDATA_PATHMODIFIEDBYUNDO_OFFSET UNITYSDK_OFFSET(0x1AAD48E0)
#define PATHCREATION_PATHCREATORDATA_PATHTRANSFORMED_OFFSET UNITYSDK_OFFSET(0x1AAD48B0)
#define PATHCREATION_PATHCREATORDATA_REMOVE_BEZIERCREATED_OFFSET UNITYSDK_OFFSET(0x1AAD4610)
#define PATHCREATION_PATHCREATORDATA_REMOVE_BEZIERORVERTEXPATHMODIFIED_OFFSET UNITYSDK_OFFSET(0x1AAD4340)
#define PATHCREATION_PATHCREATORDATA_RESETBEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1AAD4820)
#define PATHCREATION_PATHCREATORDATA_SET_BEZIERPATH_OFFSET UNITYSDK_OFFSET(0x1AAD41A0)
#define PATHCREATION_PATHCREATORDATA_VERTEXPATHSETTINGSCHANGED_OFFSET UNITYSDK_OFFSET(0x1AAD48C0)
#define PATHCREATION_PATHCREATORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD4310)

namespace PathCreation
{
	inline static constexpr unsigned int PathCreatorData_TypeDefinitionIndex = 35297;
