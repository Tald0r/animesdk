...
#define PATHCREATION_EXAMPLES_PATHSCENETOOL_ADD_ONDESTROYED_OFFSET UNITYSDK_OFFSET(0x1AAD1750)
#define PATHCREATION_EXAMPLES_PATHSCENETOOL_GET_PATH_OFFSET UNITYSDK_OFFSET(0x1AAD1810)
#define PATHCREATION_EXAMPLES_PATHSCENETOOL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x1AAD1840)
#define PATHCREATION_EXAMPLES_PATHSCENETOOL_PATHUPDATED_OFFSET UNITYSDK_OFFSET(0x1AAD1850)
#define PATHCREATION_EXAMPLES_PATHSCENETOOL_REMOVE_ONDESTROYED_OFFSET UNITYSDK_OFFSET(0x1AAD17B0)
#define PATHCREATION_EXAMPLES_PATHSCENETOOL_TRIGGERUPDATE_OFFSET UNITYSDK_OFFSET(0x1AAD1830)
#define PATHCREATION_EXAMPLES_PATHSCENETOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD1730)

namespace PathCreation::Examples
{
	inline static constexpr unsigned int PathSceneTool_TypeDefinitionIndex = 35313;
