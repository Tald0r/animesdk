...
#define PATHCREATION_EXAMPLES_PATHPLACER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A517C70)

namespace PathCreation::Examples
{
	inline static constexpr unsigned int PathPlacer_TypeDefinitionIndex = 34306;
