...
#define PATHCREATION_EXAMPLES_PATHSPAWNER_START_OFFSET UNITYSDK_OFFSET(0x1A517EC0)
#define PATHCREATION_EXAMPLES_PATHSPAWNER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A518080)

namespace PathCreation::Examples
{
	inline static constexpr unsigned int PathSpawner_TypeDefinitionIndex = 34312;
