...
#define PATHCREATION_EXAMPLES_ROADMESHCREATOR_ASSIGNMATERIALS_OFFSET UNITYSDK_OFFSET(0x1A5186C0)
#define PATHCREATION_EXAMPLES_ROADMESHCREATOR_ASSIGNMESHCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1A518130)
#define PATHCREATION_EXAMPLES_ROADMESHCREATOR_CREATEROADMESH_OFFSET UNITYSDK_OFFSET(0x1A518A10)
#define PATHCREATION_EXAMPLES_ROADMESHCREATOR_PATHUPDATED_OFFSET UNITYSDK_OFFSET(0x1A5180A0)
#define PATHCREATION_EXAMPLES_ROADMESHCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1A51A390)

namespace PathCreation::Examples
{
	inline static constexpr unsigned int RoadMeshCreator_TypeDefinitionIndex = 34313;
