...
#define PATHCREATION_EXAMPLES_ROADMESHCREATOR_ASSIGNMATERIALS_OFFSET UNITYSDK_OFFSET(0x1AAD2060)
#define PATHCREATION_EXAMPLES_ROADMESHCREATOR_ASSIGNMESHCOMPONENTS_OFFSET UNITYSDK_OFFSET(0x1AAD1AD0)
#define PATHCREATION_EXAMPLES_ROADMESHCREATOR_CREATEROADMESH_OFFSET UNITYSDK_OFFSET(0x1AAD23B0)
#define PATHCREATION_EXAMPLES_ROADMESHCREATOR_PATHUPDATED_OFFSET UNITYSDK_OFFSET(0x1AAD1A40)
#define PATHCREATION_EXAMPLES_ROADMESHCREATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD3D30)

namespace PathCreation::Examples
{
	inline static constexpr unsigned int RoadMeshCreator_TypeDefinitionIndex = 35315;
