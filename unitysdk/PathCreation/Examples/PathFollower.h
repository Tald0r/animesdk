...
#define PATHCREATION_EXAMPLES_PATHFOLLOWER_ONPATHCHANGED_OFFSET UNITYSDK_OFFSET(0x1AAD14A0)
#define PATHCREATION_EXAMPLES_PATHFOLLOWER_START_OFFSET UNITYSDK_OFFSET(0x1AAD1010)
#define PATHCREATION_EXAMPLES_PATHFOLLOWER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AAD11B0)
#define PATHCREATION_EXAMPLES_PATHFOLLOWER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AAD15F0)

namespace PathCreation::Examples
{
	inline static constexpr unsigned int PathFollower_TypeDefinitionIndex = 35307;
