...
#define PATHCREATION_EXAMPLES_PATHFOLLOWER_ONPATHCHANGED_OFFSET UNITYSDK_OFFSET(0x1A517B00)
#define PATHCREATION_EXAMPLES_PATHFOLLOWER_START_OFFSET UNITYSDK_OFFSET(0x1A517670)
#define PATHCREATION_EXAMPLES_PATHFOLLOWER_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A517810)
#define PATHCREATION_EXAMPLES_PATHFOLLOWER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A517C50)

namespace PathCreation::Examples
{
	inline static constexpr unsigned int PathFollower_TypeDefinitionIndex = 34305;
