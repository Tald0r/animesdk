...
#define MONOUIEXPANDANDSHRINKCELL_AWAKE_OFFSET UNITYSDK_OFFSET(0x93A7160)
#define MONOUIEXPANDANDSHRINKCELL_EXPAND_OFFSET UNITYSDK_OFFSET(0x93A7250)
#define MONOUIEXPANDANDSHRINKCELL_GETFADEINCURVE_OFFSET UNITYSDK_OFFSET(0x93A79B0)
#define MONOUIEXPANDANDSHRINKCELL_GETFADEOUTCURVE_OFFSET UNITYSDK_OFFSET(0x93A7E60)
#define MONOUIEXPANDANDSHRINKCELL_GET_CUREXPANDSTATE_OFFSET UNITYSDK_OFFSET(0x93A8090)
#define MONOUIEXPANDANDSHRINKCELL_GET_SIZERATIO_OFFSET UNITYSDK_OFFSET(0x93A7AE0)
#define MONOUIEXPANDANDSHRINKCELL_ISENDTHAN_OFFSET UNITYSDK_OFFSET(0x93A8A80)
#define MONOUIEXPANDANDSHRINKCELL_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x93A71E0)
#define MONOUIEXPANDANDSHRINKCELL_ONRESET_OFFSET UNITYSDK_OFFSET(0x93A7F90)
#define MONOUIEXPANDANDSHRINKCELL_PLAYANIM_OFFSET UNITYSDK_OFFSET(0x93A8B50)
#define MONOUIEXPANDANDSHRINKCELL_SAMPLEANIMATION_1_OFFSET UNITYSDK_OFFSET(0x93A8DF0)
#define MONOUIEXPANDANDSHRINKCELL_SAMPLEANIMATION_OFFSET UNITYSDK_OFFSET(0x93A7470)
#define MONOUIEXPANDANDSHRINKCELL_SET_SIZERATIO_OFFSET UNITYSDK_OFFSET(0x93A88C0)
#define MONOUIEXPANDANDSHRINKCELL_SHRINK_OFFSET UNITYSDK_OFFSET(0x93A7BE0)
#define MONOUIEXPANDANDSHRINKCELL_UPDATE_OFFSET UNITYSDK_OFFSET(0x93A80A0)
#define MONOUIEXPANDANDSHRINKCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x93A90D0)

inline static constexpr unsigned int MonoUIExpandAndShrinkCell_TypeDefinitionIndex = 42363;
