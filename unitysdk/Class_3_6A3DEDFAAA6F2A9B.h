...
#define CLASS_3_6A3DEDFAAA6F2A9B_METHOD_3_7C2676DAE3F039F9_OFFSET UNITYSDK_OFFSET(0x9AAF4E0)
#define CLASS_3_6A3DEDFAAA6F2A9B_METHOD_3_BD0C0FD946920C7F_OFFSET UNITYSDK_OFFSET(0x9AAF130)
#define CLASS_3_6A3DEDFAAA6F2A9B_METHOD_3_BE8A1D0F6D838666_OFFSET UNITYSDK_OFFSET(0x9AAFAD0)
#define CLASS_3_6A3DEDFAAA6F2A9B_METHOD_3_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x9AAFA30)
#define CLASS_3_6A3DEDFAAA6F2A9B__CTOR_OFFSET UNITYSDK_OFFSET(0x9AAFAB0)

inline static constexpr unsigned int Class_3_6A3DEDFAAA6F2A9B_TypeDefinitionIndex = 44734;

class Class_3_6A3DEDFAAA6F2A9B : public ::Class_2_534AF681CC2BD5FD_174<::Class_3_6A3DEDFAAA6F2A9B*>
{
public:
	::MoleMole::EntityHandle Field_3_0; // 0x10
	::System::Single Field_3_2; // 0x20
	::UnityEngine::Vector3 Field_3_1; // 0x24
