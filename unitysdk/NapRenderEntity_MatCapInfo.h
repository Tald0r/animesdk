...
#define NAPRENDERENTITY_MATCAPINFO_INIT_OFFSET UNITYSDK_OFFSET(0x7ECFE0)
#define NAPRENDERENTITY_MATCAPINFO_RELEASE_OFFSET UNITYSDK_OFFSET(0x7ECFF0)

inline static constexpr unsigned int NapRenderEntity_MatCapInfo_TypeDefinitionIndex = 28122;
