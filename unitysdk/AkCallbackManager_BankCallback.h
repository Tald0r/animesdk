...
#define AKCALLBACKMANAGER_BANKCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B66B420)
#define AKCALLBACKMANAGER_BANKCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B66B4C0)
#define AKCALLBACKMANAGER_BANKCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B66B030)
#define AKCALLBACKMANAGER_BANKCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B66B010)

inline static constexpr unsigned int AkCallbackManager_BankCallback_TypeDefinitionIndex = 30971;
