...
#define BONEADJUSTSTATEBEHAVIOUR_INITCOMPONENT_OFFSET UNITYSDK_OFFSET(0x7B90D90)
#define BONEADJUSTSTATEBEHAVIOUR_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x7B91060)
#define BONEADJUSTSTATEBEHAVIOUR_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x7B91320)
#define BONEADJUSTSTATEBEHAVIOUR_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7B911C0)
#define BONEADJUSTSTATEBEHAVIOUR__CTOR_OFFSET UNITYSDK_OFFSET(0x7B91480)
#define BONEADJUSTSTATEBEHAVIOUR___BASE_ONSTATEENTER_OFFSET UNITYSDK_OFFSET(0x7B914B0)
#define BONEADJUSTSTATEBEHAVIOUR___BASE_ONSTATEEXIT_OFFSET UNITYSDK_OFFSET(0x7B914C0)
#define BONEADJUSTSTATEBEHAVIOUR___BASE_ONSTATEUPDATE_OFFSET UNITYSDK_OFFSET(0x7B914D0)

inline static constexpr unsigned int BoneAdjustStateBehaviour_TypeDefinitionIndex = 64823;
