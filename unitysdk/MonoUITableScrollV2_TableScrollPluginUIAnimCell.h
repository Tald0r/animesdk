...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL_CALGAMEOBJECTKXKY_OFFSET UNITYSDK_OFFSET(0x97379E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL_GET_LOGIC_OFFSET UNITYSDK_OFFSET(0x97376A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL_GET_USEUIANIMCELL_OFFSET UNITYSDK_OFFSET(0x9737660)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL_GET_VERTICAL_OFFSET UNITYSDK_OFFSET(0x9737680)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL_GET_VIEWRECTBOUNDS_OFFSET UNITYSDK_OFFSET(0x97376C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL_REFRESHUIANIMCELL_OFFSET UNITYSDK_OFFSET(0x9737700)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x9737650)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginUIAnimCell_TypeDefinitionIndex = 64443;
