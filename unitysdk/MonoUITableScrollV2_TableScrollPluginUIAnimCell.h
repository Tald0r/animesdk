...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL_CALGAMEOBJECTKXKY_OFFSET UNITYSDK_OFFSET(0xA0A4320)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL_GET_LOGIC_OFFSET UNITYSDK_OFFSET(0xA0A3FE0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL_GET_USEUIANIMCELL_OFFSET UNITYSDK_OFFSET(0xA0A3FA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL_GET_VERTICAL_OFFSET UNITYSDK_OFFSET(0xA0A3FC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL_GET_VIEWRECTBOUNDS_OFFSET UNITYSDK_OFFSET(0xA0A4000)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL_REFRESHUIANIMCELL_OFFSET UNITYSDK_OFFSET(0xA0A4040)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINUIANIMCELL__CTOR_OFFSET UNITYSDK_OFFSET(0xA0A3F90)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginUIAnimCell_TypeDefinitionIndex = 43812;
