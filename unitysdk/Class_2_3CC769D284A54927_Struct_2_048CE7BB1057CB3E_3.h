...
#define CLASS_2_3CC769D284A54927_STRUCT_2_048CE7BB1057CB3E_3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x34B840)
#define CLASS_2_3CC769D284A54927_STRUCT_2_048CE7BB1057CB3E_3_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

inline static constexpr unsigned int Class_2_3CC769D284A54927_Struct_2_048CE7BB1057CB3E_3_TypeDefinitionIndex = 46671;

struct alignas(8) Class_2_3CC769D284A54927_Struct_2_048CE7BB1057CB3E_3
{
	::UnityEngine::Animator* Field_2_5; // 0x10
	::Cysharp::Threading::Tasks::CompilerServices::AsyncUniTaskMethodBuilder Field_2_1; // 0x18
	::Class_2_3CC769D284A54927* Field_2_4; // 0x28
	::Cysharp::Threading::Tasks::UniTask_Awaiter Field_2_19; // 0x30
	::UnityEngine::AnimationCurve* Field_2_18; // 0x40
	::System::Threading::CancellationTokenSource* Field_2_15; // 0x48
	::Class_2_208CC9941471731A_312* Field_2_6; // 0x50
	::System::Int32 Field_2_0; // 0x58
	::System::Single Field_2_16; // 0x5C
	::System::Boolean Field_2_13; // 0x60
	::System::Boolean Field_2_14; // 0x61
	::Class_2_3CC769D284A54927_Enum_3_059D0CF60338BF04 Field_2_3; // 0x64
