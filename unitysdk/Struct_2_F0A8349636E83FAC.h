...
#define STRUCT_2_F0A8349636E83FAC_METHOD_2_02A3D10A9D535169_OFFSET UNITYSDK_OFFSET(0x2F1F70)
#define STRUCT_2_F0A8349636E83FAC_METHOD_2_7786DC814C2FC3BE_OFFSET UNITYSDK_OFFSET(0x302300)
#define STRUCT_2_F0A8349636E83FAC__CCTOR_OFFSET UNITYSDK_OFFSET(0xD418CB0)
#define STRUCT_2_F0A8349636E83FAC__CTOR_OFFSET UNITYSDK_OFFSET(0x302300)

inline static constexpr unsigned int Struct_2_F0A8349636E83FAC_TypeDefinitionIndex = 69272;

struct alignas(4) Struct_2_F0A8349636E83FAC
{
	static ::Struct_2_F0A8349636E83FAC* StaticGet_Field_2_0()
	{
		return (::Struct_2_F0A8349636E83FAC*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_F0A8349636E83FAC_TypeDefinitionIndex)->GetStaticField(0xDED0);
	}
