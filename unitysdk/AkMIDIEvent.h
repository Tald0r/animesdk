...
#define AKMIDIEVENT_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1AD6F510)
#define AKMIDIEVENT_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AD6F450)
#define AKMIDIEVENT_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1AD6F4A0)
#define AKMIDIEVENT_GETCPTR_OFFSET UNITYSDK_OFFSET(0x1AD6F3E0)
#define AKMIDIEVENT_GET_BYAFTERTOUCHNOTE_OFFSET UNITYSDK_OFFSET(0x1AD70990)
#define AKMIDIEVENT_GET_BYCCVALUE_OFFSET UNITYSDK_OFFSET(0x1AD70690)
#define AKMIDIEVENT_GET_BYCC_OFFSET UNITYSDK_OFFSET(0x1AD70590)
#define AKMIDIEVENT_GET_BYCHANAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x1AD70B90)
#define AKMIDIEVENT_GET_BYCHAN_OFFSET UNITYSDK_OFFSET(0x1AD6F6F0)
#define AKMIDIEVENT_GET_BYNOTEAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x1AD70A90)
#define AKMIDIEVENT_GET_BYONOFFNOTE_OFFSET UNITYSDK_OFFSET(0x1AD70390)
#define AKMIDIEVENT_GET_BYPROGRAMNUM_OFFSET UNITYSDK_OFFSET(0x1AD70C90)
#define AKMIDIEVENT_GET_BYTYPE_OFFSET UNITYSDK_OFFSET(0x1AD70290)
#define AKMIDIEVENT_GET_BYVALUELSB_OFFSET UNITYSDK_OFFSET(0x1AD70790)
#define AKMIDIEVENT_GET_BYVALUEMSB_OFFSET UNITYSDK_OFFSET(0x1AD70890)
#define AKMIDIEVENT_GET_BYVELOCITY_OFFSET UNITYSDK_OFFSET(0x1AD70490)
#define AKMIDIEVENT_GET_CC_OFFSET UNITYSDK_OFFSET(0x1AD6F9B0)
#define AKMIDIEVENT_GET_CHANAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x1AD6FFB0)
#define AKMIDIEVENT_GET_GEN_OFFSET UNITYSDK_OFFSET(0x1AD6F820)
#define AKMIDIEVENT_GET_NOTEAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x1AD6FE30)
#define AKMIDIEVENT_GET_NOTEONOFF_OFFSET UNITYSDK_OFFSET(0x1AD6FB30)
#define AKMIDIEVENT_GET_PITCHBEND_OFFSET UNITYSDK_OFFSET(0x1AD6FCB0)
#define AKMIDIEVENT_GET_PROGRAMCHANGE_OFFSET UNITYSDK_OFFSET(0x1AD70130)
#define AKMIDIEVENT_SETCPTR_OFFSET UNITYSDK_OFFSET(0x1AD6F3F0)
#define AKMIDIEVENT_SET_BYAFTERTOUCHNOTE_OFFSET UNITYSDK_OFFSET(0x1AD70910)
#define AKMIDIEVENT_SET_BYCCVALUE_OFFSET UNITYSDK_OFFSET(0x1AD70610)
#define AKMIDIEVENT_SET_BYCC_OFFSET UNITYSDK_OFFSET(0x1AD70510)
#define AKMIDIEVENT_SET_BYCHANAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x1AD70B10)
#define AKMIDIEVENT_SET_BYCHAN_OFFSET UNITYSDK_OFFSET(0x1AD6F670)
#define AKMIDIEVENT_SET_BYNOTEAFTERTOUCHVALUE_OFFSET UNITYSDK_OFFSET(0x1AD70A10)
#define AKMIDIEVENT_SET_BYONOFFNOTE_OFFSET UNITYSDK_OFFSET(0x1AD70310)
#define AKMIDIEVENT_SET_BYPROGRAMNUM_OFFSET UNITYSDK_OFFSET(0x1AD70C10)
#define AKMIDIEVENT_SET_BYTYPE_OFFSET UNITYSDK_OFFSET(0x1AD70210)
#define AKMIDIEVENT_SET_BYVALUELSB_OFFSET UNITYSDK_OFFSET(0x1AD70710)
#define AKMIDIEVENT_SET_BYVALUEMSB_OFFSET UNITYSDK_OFFSET(0x1AD70810)
#define AKMIDIEVENT_SET_BYVELOCITY_OFFSET UNITYSDK_OFFSET(0x1AD70410)
#define AKMIDIEVENT_SET_CC_OFFSET UNITYSDK_OFFSET(0x1AD6F910)
#define AKMIDIEVENT_SET_CHANAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x1AD6FF10)
#define AKMIDIEVENT_SET_GEN_OFFSET UNITYSDK_OFFSET(0x1AD6F770)
#define AKMIDIEVENT_SET_NOTEAFTERTOUCH_OFFSET UNITYSDK_OFFSET(0x1AD6FD90)
#define AKMIDIEVENT_SET_NOTEONOFF_OFFSET UNITYSDK_OFFSET(0x1AD6FA90)
#define AKMIDIEVENT_SET_PITCHBEND_OFFSET UNITYSDK_OFFSET(0x1AD6FC10)
#define AKMIDIEVENT_SET_PROGRAMCHANGE_OFFSET UNITYSDK_OFFSET(0x1AD70090)
#define AKMIDIEVENT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AD70D10)
#define AKMIDIEVENT__CTOR_OFFSET UNITYSDK_OFFSET(0x1AD6F3D0)

inline static constexpr unsigned int AkMIDIEvent_TypeDefinitionIndex = 29944;
