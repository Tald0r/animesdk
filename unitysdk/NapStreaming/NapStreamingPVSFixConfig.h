...
#define NAPSTREAMING_NAPSTREAMINGPVSFIXCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9B0CF20)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingPVSFixConfig_TypeDefinitionIndex = 39485;
