...
#define NAPSTREAMING_NAPSTREAMINGASSETPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9EC53B0)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingAssetPathConfig_TypeDefinitionIndex = 68995;
