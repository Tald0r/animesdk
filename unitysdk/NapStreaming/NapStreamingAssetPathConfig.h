...
#define NAPSTREAMING_NAPSTREAMINGASSETPATHCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x63B5610)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingAssetPathConfig_TypeDefinitionIndex = 48115;
