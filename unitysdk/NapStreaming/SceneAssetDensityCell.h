...
#define NAPSTREAMING_SCENEASSETDENSITYCELL_ADDMATERIALS_OFFSET UNITYSDK_OFFSET(0x9BDB670)
#define NAPSTREAMING_SCENEASSETDENSITYCELL_CHECKBUDGET_OFFSET UNITYSDK_OFFSET(0x9BDB870)
#define NAPSTREAMING_SCENEASSETDENSITYCELL_CLEAR_OFFSET UNITYSDK_OFFSET(0x9BDB6E0)
#define NAPSTREAMING_SCENEASSETDENSITYCELL_GETMAX_OFFSET UNITYSDK_OFFSET(0x9BDB1E0)
#define NAPSTREAMING_SCENEASSETDENSITYCELL_GETOVERREASONCOLOR_OFFSET UNITYSDK_OFFSET(0x9BDC010)
#define NAPSTREAMING_SCENEASSETDENSITYCELL_GETOVERREASONSTR_OFFSET UNITYSDK_OFFSET(0x9BDB980)
#define NAPSTREAMING_SCENEASSETDENSITYCELL_GETSERIALIZEDDATA_OFFSET UNITYSDK_OFFSET(0x9BDC0A0)
#define NAPSTREAMING_SCENEASSETDENSITYCELL_ISVALID_OFFSET UNITYSDK_OFFSET(0x9BDB7F0)
#define NAPSTREAMING_SCENEASSETDENSITYCELL_OP_ADDITION_OFFSET UNITYSDK_OFFSET(0x9BDB040)
#define NAPSTREAMING_SCENEASSETDENSITYCELL_OP_DIVISION_OFFSET UNITYSDK_OFFSET(0x9BDB100)
#define NAPSTREAMING_SCENEASSETDENSITYCELL_STOPADDANDCALC_OFFSET UNITYSDK_OFFSET(0x9BDB300)
#define NAPSTREAMING_SCENEASSETDENSITYCELL__CCTOR_OFFSET UNITYSDK_OFFSET(0x9BDC330)
#define NAPSTREAMING_SCENEASSETDENSITYCELL__CTOR_OFFSET UNITYSDK_OFFSET(0x9BDC1B0)

namespace NapStreaming
{
	inline static constexpr unsigned int SceneAssetDensityCell_TypeDefinitionIndex = 46058;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(SceneAssetDensityCell_TypeDefinitionIndex)->GetStaticField(0x3AE60);
		}
		...
		::System::Int32 textureCount; // 0x24
		::System::Int32 lightCount; // 0x28
		::System::Int32 objectCount; // 0x2C
		::System::Double texturePixelCount; // 0x30
		::System::Int32 particleCount; // 0x38
		::System::Int32 vertexCount; // 0x3C
		::System::Int32 skinnedMeshCount; // 0x40
		::System::Int32 materialCount; // 0x44
		::UnityEngine::Bounds bounds; // 0x48
		::System::Int32 animationClipCount; // 0x60
