...
#define NAPSTREAMING_NAPSTREAMINGASSETDENSITYCONFIG_CHECKNEEDGENERATE_OFFSET UNITYSDK_OFFSET(0x7FC23F0)
#define NAPSTREAMING_NAPSTREAMINGASSETDENSITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x7FC2470)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingAssetDensityConfig_TypeDefinitionIndex = 61663;
