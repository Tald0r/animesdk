...
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_GET_REALHLODLOADDISTANCE_OFFSET UNITYSDK_OFFSET(0x6534660)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_GET_REALLOADDISTANCE_OFFSET UNITYSDK_OFFSET(0x6534650)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_GET_REALUNLOADDISTANCE_OFFSET UNITYSDK_OFFSET(0x6534670)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_UPDATEREALDISTANCE_OFFSET UNITYSDK_OFFSET(0x6534680)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6534870)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingData_StreamingLayerData_TypeDefinitionIndex = 76074;
