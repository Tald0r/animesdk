...
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_GET_REALHLODLOADDISTANCE_OFFSET UNITYSDK_OFFSET(0x7E15840)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_GET_REALLOADDISTANCE_OFFSET UNITYSDK_OFFSET(0x7E15830)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_GET_REALUNLOADDISTANCE_OFFSET UNITYSDK_OFFSET(0x7E15850)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA_UPDATEREALDISTANCE_OFFSET UNITYSDK_OFFSET(0x7E15860)
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGLAYERDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x7E15A40)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingData_StreamingLayerData_TypeDefinitionIndex = 48958;
