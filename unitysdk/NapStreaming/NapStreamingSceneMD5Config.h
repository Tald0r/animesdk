...
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_CHECKNEEDGENERATEQUICKLY_OFFSET UNITYSDK_OFFSET(0x6989000)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_CHECKNEEDGENERATE_OFFSET UNITYSDK_OFFSET(0x6988F90)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_CLEARGENERATED_OFFSET UNITYSDK_OFFSET(0x6988E80)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_FASTCHECKSCENECHANGED_OFFSET UNITYSDK_OFFSET(0x6988830)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_GETMD5HASH_OFFSET UNITYSDK_OFFSET(0x6988430)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_INITCONFIG_OFFSET UNITYSDK_OFFSET(0x69889A0)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_ISGENERATED_OFFSET UNITYSDK_OFFSET(0x6988DA0)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_SAVECONFIG_OFFSET UNITYSDK_OFFSET(0x6988BF0)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x6989070)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingSceneMD5Config_TypeDefinitionIndex = 48621;
