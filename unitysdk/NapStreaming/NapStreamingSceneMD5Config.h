...
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_CHECKNEEDGENERATEQUICKLY_OFFSET UNITYSDK_OFFSET(0x6308160)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_CHECKNEEDGENERATE_OFFSET UNITYSDK_OFFSET(0x63080F0)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_CLEARGENERATED_OFFSET UNITYSDK_OFFSET(0x6307FE0)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_FASTCHECKSCENECHANGED_OFFSET UNITYSDK_OFFSET(0x6307990)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_GETMD5HASH_OFFSET UNITYSDK_OFFSET(0x6307590)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_INITCONFIG_OFFSET UNITYSDK_OFFSET(0x6307B00)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_ISGENERATED_OFFSET UNITYSDK_OFFSET(0x6307F00)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG_SAVECONFIG_OFFSET UNITYSDK_OFFSET(0x6307D50)
#define NAPSTREAMING_NAPSTREAMINGSCENEMD5CONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x63081D0)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingSceneMD5Config_TypeDefinitionIndex = 38638;
