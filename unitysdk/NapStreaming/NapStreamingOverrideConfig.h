...
#define NAPSTREAMING_NAPSTREAMINGOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x63B56C0)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingOverrideConfig_TypeDefinitionIndex = 43782;
