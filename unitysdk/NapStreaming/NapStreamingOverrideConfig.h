...
#define NAPSTREAMING_NAPSTREAMINGOVERRIDECONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x9EC5460)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingOverrideConfig_TypeDefinitionIndex = 52528;
