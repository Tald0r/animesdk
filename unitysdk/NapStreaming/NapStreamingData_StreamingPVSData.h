...
#define NAPSTREAMING_NAPSTREAMINGDATA_STREAMINGPVSDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x6988420)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingData_StreamingPVSData_TypeDefinitionIndex = 48959;
