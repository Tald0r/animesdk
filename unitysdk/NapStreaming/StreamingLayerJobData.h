...
#define NAPSTREAMING_STREAMINGLAYERJOBDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0x3277A0)
#define NAPSTREAMING_STREAMINGLAYERJOBDATA_UPDATEREALDISTANCE_OFFSET UNITYSDK_OFFSET(0x327880)
#define NAPSTREAMING_STREAMINGLAYERJOBDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x327830)
#define NAPSTREAMING_STREAMINGLAYERJOBDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x327810)

namespace NapStreaming
{
	inline static constexpr unsigned int StreamingLayerJobData_TypeDefinitionIndex = 78027;
