...
#define NAPSTREAMING_STREAMINGLAYERJOBDATA_ISVALID_OFFSET UNITYSDK_OFFSET(0x32E9E0)
#define NAPSTREAMING_STREAMINGLAYERJOBDATA_UPDATEREALDISTANCE_OFFSET UNITYSDK_OFFSET(0x32EAC0)
#define NAPSTREAMING_STREAMINGLAYERJOBDATA__CTOR_1_OFFSET UNITYSDK_OFFSET(0x32EA70)
#define NAPSTREAMING_STREAMINGLAYERJOBDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x32EA50)

namespace NapStreaming
{
	inline static constexpr unsigned int StreamingLayerJobData_TypeDefinitionIndex = 58579;
