...
#define NAPSTREAMING_NAPSTREAMINGMANAGER_STREAMINGPOSPROVIDER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x6ED9C80)
#define NAPSTREAMING_NAPSTREAMINGMANAGER_STREAMINGPOSPROVIDER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x6ED9CB0)
#define NAPSTREAMING_NAPSTREAMINGMANAGER_STREAMINGPOSPROVIDER_INVOKE_OFFSET UNITYSDK_OFFSET(0x6ED98F0)
#define NAPSTREAMING_NAPSTREAMINGMANAGER_STREAMINGPOSPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x6ED98E0)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingManager_StreamingPosProvider_TypeDefinitionIndex = 48091;
