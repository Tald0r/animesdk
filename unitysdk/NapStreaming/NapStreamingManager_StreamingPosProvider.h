...
#define NAPSTREAMING_NAPSTREAMINGMANAGER_STREAMINGPOSPROVIDER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x7862A20)
#define NAPSTREAMING_NAPSTREAMINGMANAGER_STREAMINGPOSPROVIDER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x7862A50)
#define NAPSTREAMING_NAPSTREAMINGMANAGER_STREAMINGPOSPROVIDER_INVOKE_OFFSET UNITYSDK_OFFSET(0x7862690)
#define NAPSTREAMING_NAPSTREAMINGMANAGER_STREAMINGPOSPROVIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x7862670)

namespace NapStreaming
{
	inline static constexpr unsigned int NapStreamingManager_StreamingPosProvider_TypeDefinitionIndex = 41988;
