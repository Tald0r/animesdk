...
#define COUNTDOWNNUMBERCONTROLLER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x17774B80)
#define COUNTDOWNNUMBERCONTROLLER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x17774A40)
#define COUNTDOWNNUMBERCONTROLLER_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x17774D40)
#define COUNTDOWNNUMBERCONTROLLER_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x17774DA0)
#define COUNTDOWNNUMBERCONTROLLER_ONPRERENDER_OFFSET UNITYSDK_OFFSET(0x177760A0)
#define COUNTDOWNNUMBERCONTROLLER_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x17774CC0)
#define COUNTDOWNNUMBERCONTROLLER_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x17774AE0)
#define COUNTDOWNNUMBERCONTROLLER_SETRENDERSTATE_OFFSET UNITYSDK_OFFSET(0x17774E50)
#define COUNTDOWNNUMBERCONTROLLER__CTOR_OFFSET UNITYSDK_OFFSET(0x177760F0)

inline static constexpr unsigned int CountDownNumberController_TypeDefinitionIndex = 28979;
