...
#define AKSOUNDENGINE_REGISTERGAMEOBJECTCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B706B50)
#define AKSOUNDENGINE_REGISTERGAMEOBJECTCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B706BB0)
#define AKSOUNDENGINE_REGISTERGAMEOBJECTCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B7065E0)
#define AKSOUNDENGINE_REGISTERGAMEOBJECTCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B7065C0)

inline static constexpr unsigned int AkSoundEngine_RegisterGameObjectCallback_TypeDefinitionIndex = 30949;
