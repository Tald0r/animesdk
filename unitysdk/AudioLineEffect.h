...
#define AUDIOLINEEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0x8DD8640)
#define AUDIOLINEEFFECT_GETCURRENTCURVE_OFFSET UNITYSDK_OFFSET(0x8DD8DE0)
#define AUDIOLINEEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0x8DD8A20)
#define AUDIOLINEEFFECT_REFRESHAUDIOEFFECT_1_OFFSET UNITYSDK_OFFSET(0x8DD8FA0)
#define AUDIOLINEEFFECT_REFRESHAUDIOEFFECT_OFFSET UNITYSDK_OFFSET(0x8DD8B40)
#define AUDIOLINEEFFECT_SETDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0x8DD8ED0)
#define AUDIOLINEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0x8DD9120)

inline static constexpr unsigned int AudioLineEffect_TypeDefinitionIndex = 73902;
