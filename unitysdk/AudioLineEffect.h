...
#define AUDIOLINEEFFECT_AWAKE_OFFSET UNITYSDK_OFFSET(0xBCCF750)
#define AUDIOLINEEFFECT_GETCURRENTCURVE_OFFSET UNITYSDK_OFFSET(0xBCCFEF0)
#define AUDIOLINEEFFECT_ONENABLE_OFFSET UNITYSDK_OFFSET(0xBCCFB30)
#define AUDIOLINEEFFECT_REFRESHAUDIOEFFECT_1_OFFSET UNITYSDK_OFFSET(0xBCD00B0)
#define AUDIOLINEEFFECT_REFRESHAUDIOEFFECT_OFFSET UNITYSDK_OFFSET(0xBCCFC50)
#define AUDIOLINEEFFECT_SETDEFAULTSTATE_OFFSET UNITYSDK_OFFSET(0xBCCFFE0)
#define AUDIOLINEEFFECT__CTOR_OFFSET UNITYSDK_OFFSET(0xBCD0230)

inline static constexpr unsigned int AudioLineEffect_TypeDefinitionIndex = 69224;
