...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE__PLAYFADEINANIMATIONINNER_D__15_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x3864D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINSCROLLVIEWFADE__PLAYFADEINANIMATIONINNER_D__15_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x2613F0)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginScrollViewFade__PlayFadeInAnimationInner_d__15_TypeDefinitionIndex = 64435;

struct alignas(8) MonoUITableScrollV2_TableScrollPluginScrollViewFade__PlayFadeInAnimationInner_d__15
{
	::MonoUITableScrollV2_TableScrollPluginScrollViewFade* __4__this; // 0x10
