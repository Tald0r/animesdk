...
#define CHROMATICABERRATIONPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x9D2DB30)
#define CHROMATICABERRATIONPROXY_COPYVALUEFROM_OFFSET UNITYSDK_OFFSET(0x9D2DEA0)
#define CHROMATICABERRATIONPROXY_SETVALUETO_OFFSET UNITYSDK_OFFSET(0x9D2E010)
#define CHROMATICABERRATIONPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x9D2DFA0)
#define CHROMATICABERRATIONPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x9D2E120)

inline static constexpr unsigned int ChromaticAberrationProxy_TypeDefinitionIndex = 63359;
