...
#define MONOUILOOPBGTEXT_AUTOREPAIR_OFFSET UNITYSDK_OFFSET(0xEE70C70)
#define MONOUILOOPBGTEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0xEE70BA0)
#define MONOUILOOPBGTEXT_GETRUNINGTIME_OFFSET UNITYSDK_OFFSET(0xEE713B0)
#define MONOUILOOPBGTEXT_GET__INITPOS_OFFSET UNITYSDK_OFFSET(0xEE704C0)
#define MONOUILOOPBGTEXT_INIT_OFFSET UNITYSDK_OFFSET(0xEE70540)
#define MONOUILOOPBGTEXT_INNERUPDATE_OFFSET UNITYSDK_OFFSET(0xEE71480)
#define MONOUILOOPBGTEXT_RESETANIMATION_OFFSET UNITYSDK_OFFSET(0xEE70E20)
#define MONOUILOOPBGTEXT_SETTEXT_OFFSET UNITYSDK_OFFSET(0xEE70D90)
#define MONOUILOOPBGTEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0xEE71410)
#define MONOUILOOPBGTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xEE71880)

inline static constexpr unsigned int MonoUILoopBGText_TypeDefinitionIndex = 62325;
