...
#define MONOUILOOPBGTEXT_AUTOREPAIR_OFFSET UNITYSDK_OFFSET(0xAA97BA0)
#define MONOUILOOPBGTEXT_AWAKE_OFFSET UNITYSDK_OFFSET(0xAA97AD0)
#define MONOUILOOPBGTEXT_GETRUNINGTIME_OFFSET UNITYSDK_OFFSET(0xAA982E0)
#define MONOUILOOPBGTEXT_GET__INITPOS_OFFSET UNITYSDK_OFFSET(0xAA973F0)
#define MONOUILOOPBGTEXT_INIT_OFFSET UNITYSDK_OFFSET(0xAA97470)
#define MONOUILOOPBGTEXT_INNERUPDATE_OFFSET UNITYSDK_OFFSET(0xAA983B0)
#define MONOUILOOPBGTEXT_RESETANIMATION_OFFSET UNITYSDK_OFFSET(0xAA97D50)
#define MONOUILOOPBGTEXT_SETTEXT_OFFSET UNITYSDK_OFFSET(0xAA97CC0)
#define MONOUILOOPBGTEXT_UPDATE_OFFSET UNITYSDK_OFFSET(0xAA98340)
#define MONOUILOOPBGTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0xAA987B0)

inline static constexpr unsigned int MonoUILoopBGText_TypeDefinitionIndex = 50181;
