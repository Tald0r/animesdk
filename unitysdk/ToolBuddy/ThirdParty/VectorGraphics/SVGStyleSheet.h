...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEET_CLEAR_OFFSET UNITYSDK_OFFSET(0x193BC150)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEET_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x193BB230)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEET_GET_SELECTORS_OFFSET UNITYSDK_OFFSET(0x193BB130)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEET_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x193BAFA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEET__CTOR_OFFSET UNITYSDK_OFFSET(0x193BAE70)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGStyleSheet_TypeDefinitionIndex = 27033;
