...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGPARSER_IMPORTSVG_1_OFFSET UNITYSDK_OFFSET(0x193BA110)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGPARSER_IMPORTSVG_OFFSET UNITYSDK_OFFSET(0x193BA0B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x193BAB70)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGParser_TypeDefinitionIndex = 26996;
