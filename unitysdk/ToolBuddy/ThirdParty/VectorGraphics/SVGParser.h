...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGPARSER_IMPORTSVG_1_OFFSET UNITYSDK_OFFSET(0x1983C9A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGPARSER_IMPORTSVG_OFFSET UNITYSDK_OFFSET(0x1983C940)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1983D400)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGParser_TypeDefinitionIndex = 27936;
