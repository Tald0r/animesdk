...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19845870)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERSEGMENT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19845E00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERSEGMENT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19845D40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19845E80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19845DB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19845D60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19845860)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75__CTOR_OFFSET UNITYSDK_OFFSET(0x198444F0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int VectorUtils__SegmentsInPath_d__75_TypeDefinitionIndex = 27983;

	class VectorUtils__SegmentsInPath_d__75 : public ::System::Object
	{
	public:
		::System::Collections::Generic::IEnumerable_1<::ToolBuddy::ThirdParty::VectorGraphics::BezierPathSegment>* segments; // 0x10
		...
		::ToolBuddy::ThirdParty::VectorGraphics::BezierSegment __2__current; // 0x44
		::System::Int32 __1__state; // 0x64
		::System::Boolean closed; // 0x68
		::System::Boolean __3__closed; // 0x69
