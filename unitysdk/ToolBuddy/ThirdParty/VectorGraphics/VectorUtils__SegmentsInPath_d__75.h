...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x193C2FF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERSEGMENT__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x193C3580)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERSEGMENT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x193C34C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x193C3600)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x193C3530)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x193C34E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x193C2FE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SEGMENTSINPATH_D__75__CTOR_OFFSET UNITYSDK_OFFSET(0x193C1C70)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int VectorUtils__SegmentsInPath_d__75_TypeDefinitionIndex = 27043;
	...
	public:
		...
		::System::Boolean __3__closed; // 0x40
