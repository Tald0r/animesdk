...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x2CA610)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_GET_STOPPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x2D8620)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_SET_COLOR_OFFSET UNITYSDK_OFFSET(0x2FB050)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_SET_STOPPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x3084C0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int GradientStop_TypeDefinitionIndex = 27049;
