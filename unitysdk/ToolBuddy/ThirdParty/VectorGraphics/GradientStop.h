...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_GET_COLOR_OFFSET UNITYSDK_OFFSET(0x2EC7C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_GET_STOPPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x2EB560)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_SET_COLOR_OFFSET UNITYSDK_OFFSET(0x2EC7B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTSTOP_SET_STOPPERCENTAGE_OFFSET UNITYSDK_OFFSET(0x33F1F0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int GradientStop_TypeDefinitionIndex = 27989;
