...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_ADDRESSING_OFFSET UNITYSDK_OFFSET(0x19399AC0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_MODE_OFFSET UNITYSDK_OFFSET(0x19399A80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_OPACITY_OFFSET UNITYSDK_OFFSET(0x19399AA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_RADIALFOCUS_OFFSET UNITYSDK_OFFSET(0x19399AE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_STOPS_OFFSET UNITYSDK_OFFSET(0x19399A60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x19399A40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_ADDRESSING_OFFSET UNITYSDK_OFFSET(0x19399AD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_MODE_OFFSET UNITYSDK_OFFSET(0x19399A90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_OPACITY_OFFSET UNITYSDK_OFFSET(0x19399AB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_RADIALFOCUS_OFFSET UNITYSDK_OFFSET(0x19399AF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_STOPS_OFFSET UNITYSDK_OFFSET(0x19399A70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x19399A50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL__CTOR_OFFSET UNITYSDK_OFFSET(0x19399B00)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int GradientFill_TypeDefinitionIndex = 27055;
	...
	public:
		...
		::ToolBuddy::ThirdParty::VectorGraphics::FillMode _Mode_k__BackingField; // 0x20
