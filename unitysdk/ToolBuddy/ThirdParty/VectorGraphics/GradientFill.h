...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_ADDRESSING_OFFSET UNITYSDK_OFFSET(0x1981C490)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_MODE_OFFSET UNITYSDK_OFFSET(0x1981C450)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_OPACITY_OFFSET UNITYSDK_OFFSET(0x1981C470)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_RADIALFOCUS_OFFSET UNITYSDK_OFFSET(0x1981C4B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_STOPS_OFFSET UNITYSDK_OFFSET(0x1981C430)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1981C410)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_ADDRESSING_OFFSET UNITYSDK_OFFSET(0x1981C4A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_MODE_OFFSET UNITYSDK_OFFSET(0x1981C460)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_OPACITY_OFFSET UNITYSDK_OFFSET(0x1981C480)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_RADIALFOCUS_OFFSET UNITYSDK_OFFSET(0x1981C4C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_STOPS_OFFSET UNITYSDK_OFFSET(0x1981C440)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1981C420)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_GRADIENTFILL__CTOR_OFFSET UNITYSDK_OFFSET(0x1981C4D0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int GradientFill_TypeDefinitionIndex = 27995;
