...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_GET_CORNERS_OFFSET UNITYSDK_OFFSET(0x2CB090)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_GET_HEAD_OFFSET UNITYSDK_OFFSET(0x2C6230)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_GET_STROKE_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_GET_TAIL_OFFSET UNITYSDK_OFFSET(0x2C50B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_SET_CORNERS_OFFSET UNITYSDK_OFFSET(0x3197D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_SET_HEAD_OFFSET UNITYSDK_OFFSET(0x2C6250)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_SET_STROKE_OFFSET UNITYSDK_OFFSET(0x2C3980)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_PATHPROPERTIES_SET_TAIL_OFFSET UNITYSDK_OFFSET(0x3084B0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int PathProperties_TypeDefinitionIndex = 27059;
