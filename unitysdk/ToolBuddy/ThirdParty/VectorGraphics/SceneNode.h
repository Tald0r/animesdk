...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_GET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x193BDF90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_GET_CLIPPER_OFFSET UNITYSDK_OFFSET(0x193BE000)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_GET_SHAPES_OFFSET UNITYSDK_OFFSET(0x193BDFB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_GET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x193BDFD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_SET_CHILDREN_OFFSET UNITYSDK_OFFSET(0x193BDFA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_SET_CLIPPER_OFFSET UNITYSDK_OFFSET(0x193BE010)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_SET_SHAPES_OFFSET UNITYSDK_OFFSET(0x193BDFC0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE_SET_TRANSFORM_OFFSET UNITYSDK_OFFSET(0x193BDFF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE__CTOR_OFFSET UNITYSDK_OFFSET(0x193A5FD0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SceneNode_TypeDefinitionIndex = 27061;
