...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENE_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x193BDF70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENE_SET_ROOT_OFFSET UNITYSDK_OFFSET(0x193BDF80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x193BAB40)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int Scene_TypeDefinitionIndex = 27062;
