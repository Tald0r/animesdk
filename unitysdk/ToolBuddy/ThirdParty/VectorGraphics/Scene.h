...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENE_GET_ROOT_OFFSET UNITYSDK_OFFSET(0x198407F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENE_SET_ROOT_OFFSET UNITYSDK_OFFSET(0x19840800)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENE__CTOR_OFFSET UNITYSDK_OFFSET(0x1983D3D0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int Scene_TypeDefinitionIndex = 28002;
