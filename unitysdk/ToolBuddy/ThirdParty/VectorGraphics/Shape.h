...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_GET_CONTOURS_OFFSET UNITYSDK_OFFSET(0x193BE020)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_GET_FILLTRANSFORM_OFFSET UNITYSDK_OFFSET(0x193BE060)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_GET_FILL_OFFSET UNITYSDK_OFFSET(0x193BE040)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_GET_ISCONVEX_OFFSET UNITYSDK_OFFSET(0x193BE0C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_GET_PATHPROPS_OFFSET UNITYSDK_OFFSET(0x193BE090)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_SET_CONTOURS_OFFSET UNITYSDK_OFFSET(0x193BE030)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_SET_FILLTRANSFORM_OFFSET UNITYSDK_OFFSET(0x193BE080)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_SET_FILL_OFFSET UNITYSDK_OFFSET(0x193BE050)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_SET_ISCONVEX_OFFSET UNITYSDK_OFFSET(0x193BE0D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_SET_PATHPROPS_OFFSET UNITYSDK_OFFSET(0x193BE0B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x193A7A70)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int Shape_TypeDefinitionIndex = 27060;
