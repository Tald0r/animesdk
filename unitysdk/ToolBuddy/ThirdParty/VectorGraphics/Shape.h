...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_GET_CONTOURS_OFFSET UNITYSDK_OFFSET(0x198408A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_GET_FILLTRANSFORM_OFFSET UNITYSDK_OFFSET(0x198408E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_GET_FILL_OFFSET UNITYSDK_OFFSET(0x198408C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_GET_ISCONVEX_OFFSET UNITYSDK_OFFSET(0x19840940)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_GET_PATHPROPS_OFFSET UNITYSDK_OFFSET(0x19840910)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_SET_CONTOURS_OFFSET UNITYSDK_OFFSET(0x198408B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_SET_FILLTRANSFORM_OFFSET UNITYSDK_OFFSET(0x19840900)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_SET_FILL_OFFSET UNITYSDK_OFFSET(0x198408D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_SET_ISCONVEX_OFFSET UNITYSDK_OFFSET(0x19840950)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE_SET_PATHPROPS_OFFSET UNITYSDK_OFFSET(0x19840930)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SHAPE__CTOR_OFFSET UNITYSDK_OFFSET(0x1982A3C0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int Shape_TypeDefinitionIndex = 28000;

	class Shape : public ::System::Object
	{
	public:
		::ToolBuddy::ThirdParty::VectorGraphics::PathProperties _PathProps_k__BackingField; // 0x10
		::Il2CppArray<::ToolBuddy::ThirdParty::VectorGraphics::BezierContour>* _Contours_k__BackingField; // 0x28
