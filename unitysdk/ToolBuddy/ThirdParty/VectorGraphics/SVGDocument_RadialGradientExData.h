...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGDOCUMENT_RADIALGRADIENTEXDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x198321D0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGDocument_RadialGradientExData_TypeDefinitionIndex = 27954;
	...
	public:
		...
		::System::String* Fx; // 0x40
		::System::String* Cy; // 0x48
