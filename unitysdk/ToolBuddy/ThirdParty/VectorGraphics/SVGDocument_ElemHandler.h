...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGDOCUMENT_ELEMHANDLER_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x193B9AF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGDOCUMENT_ELEMHANDLER_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x193B9B20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGDOCUMENT_ELEMHANDLER_INVOKE_OFFSET UNITYSDK_OFFSET(0x193A6650)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGDOCUMENT_ELEMHANDLER__CTOR_OFFSET UNITYSDK_OFFSET(0x193A4C70)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGDocument_ElemHandler_TypeDefinitionIndex = 27008;
