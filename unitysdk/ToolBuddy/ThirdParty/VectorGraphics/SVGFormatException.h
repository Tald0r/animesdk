...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION_COMPOSEMESSAGE_OFFSET UNITYSDK_OFFSET(0x1983C430)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION_GET_STACKERROR_OFFSET UNITYSDK_OFFSET(0x19827EB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19827820)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1983C8D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGFORMATEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1983C3D0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGFormatException_TypeDefinitionIndex = 27940;
