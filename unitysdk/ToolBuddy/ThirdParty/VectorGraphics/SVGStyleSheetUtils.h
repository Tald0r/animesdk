...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_COMBINEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x193BC610)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_COPYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x193BD3B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_ISSEPARATOR_OFFSET UNITYSDK_OFFSET(0x193BDF40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_ISWHITESPACE_OFFSET UNITYSDK_OFFSET(0x193BDF20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSEINLINE_OFFSET UNITYSDK_OFFSET(0x193BAEF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSEPARENVALUE_OFFSET UNITYSDK_OFFSET(0x193BDB00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x193BD0F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSEPROPERTY_OFFSET UNITYSDK_OFFSET(0x193BD580)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSESELECTOR_OFFSET UNITYSDK_OFFSET(0x193BC7A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSE_OFFSET UNITYSDK_OFFSET(0x193B3390)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PEEKTOKEN_OFFSET UNITYSDK_OFFSET(0x193BD370)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_POPTOKEN_OFFSET UNITYSDK_OFFSET(0x193BD2E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_TOKENIZE_OFFSET UNITYSDK_OFFSET(0x193BC250)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGStyleSheetUtils_TypeDefinitionIndex = 27037;
