...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_COMBINEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1983EE90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_COPYPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1983FC30)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_ISSEPARATOR_OFFSET UNITYSDK_OFFSET(0x198407C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_ISWHITESPACE_OFFSET UNITYSDK_OFFSET(0x198407A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSEINLINE_OFFSET UNITYSDK_OFFSET(0x1983D780)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSEPARENVALUE_OFFSET UNITYSDK_OFFSET(0x19840380)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSEPROPERTIES_OFFSET UNITYSDK_OFFSET(0x1983F970)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1983FE00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSESELECTOR_OFFSET UNITYSDK_OFFSET(0x1983F020)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PARSE_OFFSET UNITYSDK_OFFSET(0x19835C50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_PEEKTOKEN_OFFSET UNITYSDK_OFFSET(0x1983FBF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_POPTOKEN_OFFSET UNITYSDK_OFFSET(0x1983FB60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLESHEETUTILS_TOKENIZE_OFFSET UNITYSDK_OFFSET(0x1983EAD0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGStyleSheetUtils_TypeDefinitionIndex = 27977;
