...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_EQUALS_OFFSET UNITYSDK_OFFSET(0x8B5E10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GETCOLUMN_OFFSET UNITYSDK_OFFSET(0x8B5F70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8B5D50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x1981D130)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x8B5BC0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x8B5A30)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1981D0C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_INVERSE_OFFSET UNITYSDK_OFFSET(0x8B6010)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_MULTIPLYPOINT_OFFSET UNITYSDK_OFFSET(0x8B5F80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_MULTIPLYVECTOR_OFFSET UNITYSDK_OFFSET(0x8B5FD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1981CB60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1981CB00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_ROTATELH_OFFSET UNITYSDK_OFFSET(0x1981D060)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_SCALE_OFFSET UNITYSDK_OFFSET(0x1981D020)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x8B5C80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x8B5AF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8B6030)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x1981D040)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1981D5A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D__CTOR_OFFSET UNITYSDK_OFFSET(0x8B5A00)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int Matrix2D_TypeDefinitionIndex = 27934;

	struct alignas(4) Matrix2D
	{
		static ::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D* StaticGet_zeroMatrix()
		{
			return (::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D*)Il2CppClass::FromTypeDefinitionIndex(Matrix2D_TypeDefinitionIndex)->GetStaticField(0x4A90);
		}
		static ::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D* StaticGet_identityMatrix()
		{
			return (::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D*)Il2CppClass::FromTypeDefinitionIndex(Matrix2D_TypeDefinitionIndex)->GetStaticField(0x4AA8);
		}
