...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_EQUALS_OFFSET UNITYSDK_OFFSET(0x8831E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GETCOLUMN_OFFSET UNITYSDK_OFFSET(0x883340)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x883120)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_IDENTITY_OFFSET UNITYSDK_OFFSET(0x1939A760)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x882F90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_ITEM_OFFSET UNITYSDK_OFFSET(0x882E00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_GET_ZERO_OFFSET UNITYSDK_OFFSET(0x1939A6F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_INVERSE_OFFSET UNITYSDK_OFFSET(0x8833E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_MULTIPLYPOINT_OFFSET UNITYSDK_OFFSET(0x883350)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_MULTIPLYVECTOR_OFFSET UNITYSDK_OFFSET(0x8833A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_OP_MULTIPLY_1_OFFSET UNITYSDK_OFFSET(0x1939A190)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_OP_MULTIPLY_OFFSET UNITYSDK_OFFSET(0x1939A130)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_ROTATELH_OFFSET UNITYSDK_OFFSET(0x1939A690)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_SCALE_OFFSET UNITYSDK_OFFSET(0x1939A650)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_SET_ITEM_1_OFFSET UNITYSDK_OFFSET(0x883050)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_SET_ITEM_OFFSET UNITYSDK_OFFSET(0x882EC0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_TOSTRING_OFFSET UNITYSDK_OFFSET(0x883400)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D_TRANSLATE_OFFSET UNITYSDK_OFFSET(0x1939A670)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D__CCTOR_OFFSET UNITYSDK_OFFSET(0x1939ABD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_MATRIX2D__CTOR_OFFSET UNITYSDK_OFFSET(0x882DD0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int Matrix2D_TypeDefinitionIndex = 26994;

	struct alignas(4) Matrix2D
	{
		static ::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D* StaticGet_zeroMatrix()
		{
			return (::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D*)Il2CppClass::FromTypeDefinitionIndex(Matrix2D_TypeDefinitionIndex)->GetStaticField(0x4AE0);
		}
		static ::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D* StaticGet_identityMatrix()
		{
			return (::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D*)Il2CppClass::FromTypeDefinitionIndex(Matrix2D_TypeDefinitionIndex)->GetStaticField(0x4AF8);
		}
