...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x193C2A30)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x193C2EE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SCENENODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x193C2E70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x193C2F60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x193C2ED0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x193C2E80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x193C2840)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68__CTOR_OFFSET UNITYSDK_OFFSET(0x193C1BA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x193C2A20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__SCENENODES_D__68___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x193C2970)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int VectorUtils__SceneNodes_d__68_TypeDefinitionIndex = 27041;
	...
	public:
		...
		::ToolBuddy::ThirdParty::VectorGraphics::SceneNode* root; // 0x38
		::System::Collections::Generic::IEnumerator_1<::ToolBuddy::ThirdParty::VectorGraphics::SceneNode*>* __7__wrap2; // 0x40
