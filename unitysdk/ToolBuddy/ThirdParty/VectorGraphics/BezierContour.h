...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_GET_CLOSED_OFFSET UNITYSDK_OFFSET(0x34AA60)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x223870)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_SET_CLOSED_OFFSET UNITYSDK_OFFSET(0x34AA50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_SET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x3074E0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int BezierContour_TypeDefinitionIndex = 27992;
