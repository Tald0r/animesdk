...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_GET_CLOSED_OFFSET UNITYSDK_OFFSET(0x31FD90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_GET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x21C7C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_SET_CLOSED_OFFSET UNITYSDK_OFFSET(0x31FDA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_BEZIERCONTOUR_SET_SEGMENTS_OFFSET UNITYSDK_OFFSET(0x2C3980)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int BezierContour_TypeDefinitionIndex = 27052;
