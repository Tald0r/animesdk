...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x193BB960)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_STRING__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x193BC030)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_STRING__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x193BBFC0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x193BC0B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x193BC020)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x193BBFD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x193BB7B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12__CTOR_OFFSET UNITYSDK_OFFSET(0x193BB720)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x193BB8A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__SORTEDCLASSES_D__12___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x193BB8B0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGStyleResolver__SortedClasses_d__12_TypeDefinitionIndex = 27027;

	class SVGStyleResolver__SortedClasses_d__12 : public ::System::Object
	{
	public:
		::ToolBuddy::ThirdParty::VectorGraphics::SVGStyleResolver* __4__this; // 0x10
		::System::Collections::Generic::List_1<::System::String*>* classes; // 0x18
		::System::Collections::Generic::IEnumerator_1<::System::String*>* __7__wrap2; // 0x20
		::System::Collections::Generic::List_1_Enumerator<::System::String*> __7__wrap1; // 0x28
		::System::Collections::Generic::List_1<::System::String*>* __3__classes; // 0x40
		::System::String* __2__current; // 0x48
