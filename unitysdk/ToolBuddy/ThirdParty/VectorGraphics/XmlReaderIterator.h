...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_GOTONEXTCHILD_OFFSET UNITYSDK_OFFSET(0x193A6990)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_GOTOROOT_OFFSET UNITYSDK_OFFSET(0x193A4E40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_READTEXTWITHINELEMENT_OFFSET UNITYSDK_OFFSET(0x193B32D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_SKIPCURRENTCHILDTREE_OFFSET UNITYSDK_OFFSET(0x193A5F20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR_VISITCURRENT_OFFSET UNITYSDK_OFFSET(0x193A5EA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_XMLREADERITERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x193A4C80)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int XmlReaderIterator_TypeDefinitionIndex = 26998;
