...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_CLEANIRI_OFFSET UNITYSDK_OFFSET(0x19824710)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_CONCLUDEPATH_OFFSET UNITYSDK_OFFSET(0x19824A20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x198255E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x19824E10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTPATHCOMMAND_OFFSET UNITYSDK_OFFSET(0x198247C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTSTRINGCOMMAND_OFFSET UNITYSDK_OFFSET(0x19825A80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTVECTOR2_OFFSET UNITYSDK_OFFSET(0x198249D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSECOLOR_OFFSET UNITYSDK_OFFSET(0x19823E80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEFILL_1_OFFSET UNITYSDK_OFFSET(0x19823180)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEFILL_OFFSET UNITYSDK_OFFSET(0x19823150)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEFLOAT_OFFSET UNITYSDK_OFFSET(0x19823520)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEPATH_OFFSET UNITYSDK_OFFSET(0x19820C10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSERELATIVEREF_OFFSET UNITYSDK_OFFSET(0x198245E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSESTROKEANDOPACITY_OFFSET UNITYSDK_OFFSET(0x19823B30)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSETRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x19822570)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x19822510)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEURLREF_OFFSET UNITYSDK_OFFSET(0x19824560)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PEEKSYMBOL_OFFSET UNITYSDK_OFFSET(0x19825F40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_SKIPSYMBOL_OFFSET UNITYSDK_OFFSET(0x19825CE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_SKIPWHITESPACES_OFFSET UNITYSDK_OFFSET(0x198260A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x19822720)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x19823550)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x19820D60)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGAttribParser_TypeDefinitionIndex = 27968;
	...
	public:
		...
		{
			return (::ToolBuddy::ThirdParty::VectorGraphics::NamedWebColorDictionary**)Il2CppClass::FromTypeDefinitionIndex(SVGAttribParser_TypeDefinitionIndex)->GetStaticField(0x20F20);
		}
		::ToolBuddy::ThirdParty::VectorGraphics::IFill* fill; // 0x10
		::System::Collections::Generic::List_1<::ToolBuddy::ThirdParty::VectorGraphics::BezierContour>* contours; // 0x18
		::System::Collections::Generic::LinkedList_1<::ToolBuddy::ThirdParty::VectorGraphics::BezierSegment>* currentContour; // 0x20
		::System::String* attribString; // 0x28
		::System::String* attribName; // 0x30
		::System::Int32 stringPos; // 0x38
		::UnityEngine::Vector2 penPos; // 0x3C
		::System::Char pathCommand; // 0x44
		::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D transform; // 0x48
