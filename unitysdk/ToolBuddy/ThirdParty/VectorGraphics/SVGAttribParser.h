...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_CLEANIRI_OFFSET UNITYSDK_OFFSET(0x193A1DD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_CONCLUDEPATH_OFFSET UNITYSDK_OFFSET(0x193A20E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTBOOL_OFFSET UNITYSDK_OFFSET(0x193A2CA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTFLOAT_OFFSET UNITYSDK_OFFSET(0x193A24D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTPATHCOMMAND_OFFSET UNITYSDK_OFFSET(0x193A1E80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTSTRINGCOMMAND_OFFSET UNITYSDK_OFFSET(0x193A3140)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_NEXTVECTOR2_OFFSET UNITYSDK_OFFSET(0x193A2090)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSECOLOR_OFFSET UNITYSDK_OFFSET(0x193A1540)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEFILL_1_OFFSET UNITYSDK_OFFSET(0x193A0850)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEFILL_OFFSET UNITYSDK_OFFSET(0x193A0820)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEFLOAT_OFFSET UNITYSDK_OFFSET(0x193A0BF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEPATH_OFFSET UNITYSDK_OFFSET(0x1939E2E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSERELATIVEREF_OFFSET UNITYSDK_OFFSET(0x193A1CA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSESTROKEANDOPACITY_OFFSET UNITYSDK_OFFSET(0x193A11F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSETRANSFORM_1_OFFSET UNITYSDK_OFFSET(0x1939FC40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSETRANSFORM_OFFSET UNITYSDK_OFFSET(0x1939FBE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PARSEURLREF_OFFSET UNITYSDK_OFFSET(0x193A1C20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_PEEKSYMBOL_OFFSET UNITYSDK_OFFSET(0x193A3600)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_SKIPSYMBOL_OFFSET UNITYSDK_OFFSET(0x193A33A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER_SKIPWHITESPACES_OFFSET UNITYSDK_OFFSET(0x193A3760)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1939FDF0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER__CTOR_2_OFFSET UNITYSDK_OFFSET(0x193A0C20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGATTRIBPARSER__CTOR_OFFSET UNITYSDK_OFFSET(0x1939E430)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGAttribParser_TypeDefinitionIndex = 27028;
	...
	public:
		...
		{
			return (::ToolBuddy::ThirdParty::VectorGraphics::NamedWebColorDictionary**)Il2CppClass::FromTypeDefinitionIndex(SVGAttribParser_TypeDefinitionIndex)->GetStaticField(0x1F8C0);
		}
		...
		::ToolBuddy::ThirdParty::VectorGraphics::IFill* fill; // 0x20
		::System::String* attribString; // 0x28
		::System::Collections::Generic::List_1<::ToolBuddy::ThirdParty::VectorGraphics::BezierContour>* contours; // 0x30
		::System::Char pathCommand; // 0x38
		::ToolBuddy::ThirdParty::VectorGraphics::Matrix2D transform; // 0x3C
		::UnityEngine::Vector2 penPos; // 0x54
