...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_ARCSEGMENTFORQUADRANT_OFFSET UNITYSDK_OFFSET(0x193C0B40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BEZIERCOEFFICIENTS_OFFSET UNITYSDK_OFFSET(0x193C1C90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BEZIERSEGMENTSTOPATH_OFFSET UNITYSDK_OFFSET(0x193C0020)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BEZIERSEGMENTTOPATH_OFFSET UNITYSDK_OFFSET(0x193AC0F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BOUNDS_1_OFFSET UNITYSDK_OFFSET(0x193B9640)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BOUNDS_2_OFFSET UNITYSDK_OFFSET(0x193C0390)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BOUNDS_OFFSET UNITYSDK_OFFSET(0x193B91E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BUILDELLIPSEPATH_OFFSET UNITYSDK_OFFSET(0x193A2D10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BUILDRECTANGLECONTOUR_OFFSET UNITYSDK_OFFSET(0x193BF440)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_COMPUTEELLIPSEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x193BE290)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_CUBICROOTS_OFFSET UNITYSDK_OFFSET(0x193C1E20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_ENSURERADIIARELARGEENOUGH_OFFSET UNITYSDK_OFFSET(0x193BF3D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_EVAL_OFFSET UNITYSDK_OFFSET(0x193C17E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_FINDBEZIERLINEINTERSECTIONS_OFFSET UNITYSDK_OFFSET(0x193C0CA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_FLIPSEGMENT_OFFSET UNITYSDK_OFFSET(0x193C1700)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_ISEMPTYSEGMENT_OFFSET UNITYSDK_OFFSET(0x193A2B80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEARCQUARTER_OFFSET UNITYSDK_OFFSET(0x193C0990)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEARC_OFFSET UNITYSDK_OFFSET(0x193BE830)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKECIRCLESHAPE_OFFSET UNITYSDK_OFFSET(0x193A7B20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEELLIPSESHAPE_OFFSET UNITYSDK_OFFSET(0x193A8B20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKELINE_OFFSET UNITYSDK_OFFSET(0x193A2470)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEPATHLINE_OFFSET UNITYSDK_OFFSET(0x193BFF30)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKERECTANGLESHAPE_1_OFFSET UNITYSDK_OFFSET(0x193B15D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKERECTANGLESHAPE_OFFSET UNITYSDK_OFFSET(0x193AA790)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_QUADRANTATANGLE_OFFSET UNITYSDK_OFFSET(0x193C0AD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SCENENODEBOUNDS_OFFSET UNITYSDK_OFFSET(0x193B5BD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SCENENODES_OFFSET UNITYSDK_OFFSET(0x193B4490)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SEGMENTSINPATH_OFFSET UNITYSDK_OFFSET(0x193A30E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SOLVEQUADRATIC_OFFSET UNITYSDK_OFFSET(0x193C1720)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SPLITSEGMENT_OFFSET UNITYSDK_OFFSET(0x193C1200)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_TRANSFORMBEZIERPATH_1_OFFSET UNITYSDK_OFFSET(0x193C1960)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_TRANSFORMBEZIERPATH_OFFSET UNITYSDK_OFFSET(0x193BF080)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_TRANSFORMSEGMENT_OFFSET UNITYSDK_OFFSET(0x193C1510)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_WORLDTRANSFORMEDSCENENODES_1_OFFSET UNITYSDK_OFFSET(0x193B73B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_WORLDTRANSFORMEDSCENENODES_OFFSET UNITYSDK_OFFSET(0x193C1BC0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x193C2720)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int VectorUtils_TypeDefinitionIndex = 27038;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VectorUtils_TypeDefinitionIndex)->GetStaticField(0x4B10);
		}
