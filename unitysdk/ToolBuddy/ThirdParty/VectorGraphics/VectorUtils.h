...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_ARCSEGMENTFORQUADRANT_OFFSET UNITYSDK_OFFSET(0x198433C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BEZIERCOEFFICIENTS_OFFSET UNITYSDK_OFFSET(0x19844510)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BEZIERSEGMENTSTOPATH_OFFSET UNITYSDK_OFFSET(0x198428A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BEZIERSEGMENTTOPATH_OFFSET UNITYSDK_OFFSET(0x1982EA00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BOUNDS_1_OFFSET UNITYSDK_OFFSET(0x1983BED0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BOUNDS_2_OFFSET UNITYSDK_OFFSET(0x19842C10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BOUNDS_OFFSET UNITYSDK_OFFSET(0x1983BA70)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BUILDELLIPSEPATH_OFFSET UNITYSDK_OFFSET(0x19825650)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_BUILDRECTANGLECONTOUR_OFFSET UNITYSDK_OFFSET(0x19841CC0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_COMPUTEELLIPSEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x19840B10)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_CUBICROOTS_OFFSET UNITYSDK_OFFSET(0x198446A0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_ENSURERADIIARELARGEENOUGH_OFFSET UNITYSDK_OFFSET(0x19841C50)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_EVAL_OFFSET UNITYSDK_OFFSET(0x19844060)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_FINDBEZIERLINEINTERSECTIONS_OFFSET UNITYSDK_OFFSET(0x19843520)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_FLIPSEGMENT_OFFSET UNITYSDK_OFFSET(0x19843F80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_ISEMPTYSEGMENT_OFFSET UNITYSDK_OFFSET(0x198254C0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEARCQUARTER_OFFSET UNITYSDK_OFFSET(0x19843210)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEARC_OFFSET UNITYSDK_OFFSET(0x198410B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKECIRCLESHAPE_OFFSET UNITYSDK_OFFSET(0x1982A470)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEELLIPSESHAPE_OFFSET UNITYSDK_OFFSET(0x1982B460)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKELINE_OFFSET UNITYSDK_OFFSET(0x19824DB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKEPATHLINE_OFFSET UNITYSDK_OFFSET(0x198427B0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKERECTANGLESHAPE_1_OFFSET UNITYSDK_OFFSET(0x19833EA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_MAKERECTANGLESHAPE_OFFSET UNITYSDK_OFFSET(0x1982D0D0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_QUADRANTATANGLE_OFFSET UNITYSDK_OFFSET(0x19843350)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SCENENODEBOUNDS_OFFSET UNITYSDK_OFFSET(0x19838470)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SCENENODES_OFFSET UNITYSDK_OFFSET(0x19836D40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SEGMENTSINPATH_OFFSET UNITYSDK_OFFSET(0x19825A20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SOLVEQUADRATIC_OFFSET UNITYSDK_OFFSET(0x19843FA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_SPLITSEGMENT_OFFSET UNITYSDK_OFFSET(0x19843A80)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_TRANSFORMBEZIERPATH_1_OFFSET UNITYSDK_OFFSET(0x198441E0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_TRANSFORMBEZIERPATH_OFFSET UNITYSDK_OFFSET(0x19841900)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_TRANSFORMSEGMENT_OFFSET UNITYSDK_OFFSET(0x19843D90)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_WORLDTRANSFORMEDSCENENODES_1_OFFSET UNITYSDK_OFFSET(0x19839C40)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS_WORLDTRANSFORMEDSCENENODES_OFFSET UNITYSDK_OFFSET(0x19844440)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_VECTORUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x19844FA0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int VectorUtils_TypeDefinitionIndex = 27978;
	...
	public:
		...
		{
			return (::System::Single*)Il2CppClass::FromTypeDefinitionIndex(VectorUtils_TypeDefinitionIndex)->GetStaticField(0x4AC0);
		}
