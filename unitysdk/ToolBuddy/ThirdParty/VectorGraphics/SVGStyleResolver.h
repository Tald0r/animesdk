...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_EVALUATE_OFFSET UNITYSDK_OFFSET(0x19823400)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_GETLAYERFORSCENNODE_OFFSET UNITYSDK_OFFSET(0x19836C30)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_LOOKUPPROPERTYINSHEET_OFFSET UNITYSDK_OFFSET(0x1983DEB0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_LOOKUPPROPERTY_OFFSET UNITYSDK_OFFSET(0x1983DCE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_LOOKUPSTYLEORATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1983DBE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_PEEKLAYER_OFFSET UNITYSDK_OFFSET(0x19837D20)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_POPLAYER_OFFSET UNITYSDK_OFFSET(0x19837360)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_POPNODE_OFFSET UNITYSDK_OFFSET(0x19829260)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_PUSHLAYER_OFFSET UNITYSDK_OFFSET(0x19836CE0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_PUSHNODE_OFFSET UNITYSDK_OFFSET(0x198289F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_SAVELAYERFORSCENENODE_OFFSET UNITYSDK_OFFSET(0x19828ED0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_SETGLOBALSTYLESHEET_OFFSET UNITYSDK_OFFSET(0x19836920)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_SORTEDCLASSES_OFFSET UNITYSDK_OFFSET(0x1983D490)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x19827430)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGStyleResolver_TypeDefinitionIndex = 27963;
	...
	public:
		...
		::ToolBuddy::ThirdParty::VectorGraphics::SVGStyleSheet* globalStyleSheet; // 0x18
		::System::Collections::Generic::List_1<::ToolBuddy::ThirdParty::VectorGraphics::SVGStyleResolver_StyleLayer*>* layers; // 0x20
