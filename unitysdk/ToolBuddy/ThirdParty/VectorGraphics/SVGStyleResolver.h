...
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_EVALUATE_OFFSET UNITYSDK_OFFSET(0x193A0AD0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_GETLAYERFORSCENNODE_OFFSET UNITYSDK_OFFSET(0x193B4380)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_LOOKUPPROPERTYINSHEET_OFFSET UNITYSDK_OFFSET(0x193BB630)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_LOOKUPPROPERTY_OFFSET UNITYSDK_OFFSET(0x193BB460)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_LOOKUPSTYLEORATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x193BB350)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_PEEKLAYER_OFFSET UNITYSDK_OFFSET(0x193B5470)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_POPLAYER_OFFSET UNITYSDK_OFFSET(0x193B4AA0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_POPNODE_OFFSET UNITYSDK_OFFSET(0x193A68F0)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_PUSHLAYER_OFFSET UNITYSDK_OFFSET(0x193B4430)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_PUSHNODE_OFFSET UNITYSDK_OFFSET(0x193A6080)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_SAVELAYERFORSCENENODE_OFFSET UNITYSDK_OFFSET(0x193A6560)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_SETGLOBALSTYLESHEET_OFFSET UNITYSDK_OFFSET(0x193B4070)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER_SORTEDCLASSES_OFFSET UNITYSDK_OFFSET(0x193BAC00)
#define TOOLBUDDY_THIRDPARTY_VECTORGRAPHICS_SVGSTYLERESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x193A4AD0)

namespace ToolBuddy::ThirdParty::VectorGraphics
{
	inline static constexpr unsigned int SVGStyleResolver_TypeDefinitionIndex = 27023;
