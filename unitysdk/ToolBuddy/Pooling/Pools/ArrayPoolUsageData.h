...
#define TOOLBUDDY_POOLING_POOLS_ARRAYPOOLUSAGEDATA_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x9BB2F0)
#define TOOLBUDDY_POOLING_POOLS_ARRAYPOOLUSAGEDATA_EQUALS_OFFSET UNITYSDK_OFFSET(0x9BB2D0)
#define TOOLBUDDY_POOLING_POOLS_ARRAYPOOLUSAGEDATA_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x9BB360)
#define TOOLBUDDY_POOLING_POOLS_ARRAYPOOLUSAGEDATA_GET_ARRAYSCOUNT_OFFSET UNITYSDK_OFFSET(0x2EC6E0)
#define TOOLBUDDY_POOLING_POOLS_ARRAYPOOLUSAGEDATA_GET_ELEMENTSCAPACITY_OFFSET UNITYSDK_OFFSET(0x2F2E10)
#define TOOLBUDDY_POOLING_POOLS_ARRAYPOOLUSAGEDATA_GET_ELEMENTSCOUNT_OFFSET UNITYSDK_OFFSET(0x223870)
#define TOOLBUDDY_POOLING_POOLS_ARRAYPOOLUSAGEDATA_OP_EQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7702A0)
#define TOOLBUDDY_POOLING_POOLS_ARRAYPOOLUSAGEDATA_OP_INEQUALITY_OFFSET UNITYSDK_OFFSET(0x1B7702C0)
#define TOOLBUDDY_POOLING_POOLS_ARRAYPOOLUSAGEDATA_TOSTRING_OFFSET UNITYSDK_OFFSET(0x9BB390)
#define TOOLBUDDY_POOLING_POOLS_ARRAYPOOLUSAGEDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x3A3900)

namespace ToolBuddy::Pooling::Pools
{
	inline static constexpr unsigned int ArrayPoolUsageData_TypeDefinitionIndex = 24272;
