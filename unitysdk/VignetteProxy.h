...
#define VIGNETTEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xF4BE4C0)
#define VIGNETTEPROXY_COPYVALUEFROM_OFFSET UNITYSDK_OFFSET(0xF4BE830)
#define VIGNETTEPROXY_SETVALUETO_OFFSET UNITYSDK_OFFSET(0xF4BEA10)
#define VIGNETTEPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xF4BE9A0)
#define VIGNETTEPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xF4BED60)

inline static constexpr unsigned int VignetteProxy_TypeDefinitionIndex = 71914;
