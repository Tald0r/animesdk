...
#define VIGNETTEPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0xFB1B800)
#define VIGNETTEPROXY_COPYVALUEFROM_OFFSET UNITYSDK_OFFSET(0xFB1BB70)
#define VIGNETTEPROXY_SETVALUETO_OFFSET UNITYSDK_OFFSET(0xFB1BD50)
#define VIGNETTEPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0xFB1BCE0)
#define VIGNETTEPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0xFB1C0A0)

inline static constexpr unsigned int VignetteProxy_TypeDefinitionIndex = 56047;
