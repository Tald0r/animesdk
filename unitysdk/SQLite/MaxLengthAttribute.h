...
#define SQLITE_MAXLENGTHATTRIBUTE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A064240)
#define SQLITE_MAXLENGTHATTRIBUTE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A064250)
#define SQLITE_MAXLENGTHATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A064260)

namespace SQLite
{
	inline static constexpr unsigned int MaxLengthAttribute_TypeDefinitionIndex = 35230;
