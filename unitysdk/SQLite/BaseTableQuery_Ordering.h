...
#define SQLITE_BASETABLEQUERY_ORDERING_GET_ASCENDING_OFFSET UNITYSDK_OFFSET(0x1A62F2A0)
#define SQLITE_BASETABLEQUERY_ORDERING_GET_COLUMNNAME_OFFSET UNITYSDK_OFFSET(0x1A62F280)
#define SQLITE_BASETABLEQUERY_ORDERING_SET_ASCENDING_OFFSET UNITYSDK_OFFSET(0x1A62F2B0)
#define SQLITE_BASETABLEQUERY_ORDERING_SET_COLUMNNAME_OFFSET UNITYSDK_OFFSET(0x1A62F290)
#define SQLITE_BASETABLEQUERY_ORDERING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62F2C0)

namespace SQLite
{
	inline static constexpr unsigned int BaseTableQuery_Ordering_TypeDefinitionIndex = 36265;
