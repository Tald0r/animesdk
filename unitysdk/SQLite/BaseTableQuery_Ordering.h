...
#define SQLITE_BASETABLEQUERY_ORDERING_GET_ASCENDING_OFFSET UNITYSDK_OFFSET(0x1A063480)
#define SQLITE_BASETABLEQUERY_ORDERING_GET_COLUMNNAME_OFFSET UNITYSDK_OFFSET(0x1A063460)
#define SQLITE_BASETABLEQUERY_ORDERING_SET_ASCENDING_OFFSET UNITYSDK_OFFSET(0x1A063490)
#define SQLITE_BASETABLEQUERY_ORDERING_SET_COLUMNNAME_OFFSET UNITYSDK_OFFSET(0x1A063470)
#define SQLITE_BASETABLEQUERY_ORDERING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0634A0)

namespace SQLite
{
	inline static constexpr unsigned int BaseTableQuery_Ordering_TypeDefinitionIndex = 35263;
