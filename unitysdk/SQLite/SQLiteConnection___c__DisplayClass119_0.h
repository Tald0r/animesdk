...
#define SQLITE_SQLITECONNECTION___C__DISPLAYCLASS119_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A072350)
#define SQLITE_SQLITECONNECTION___C__DISPLAYCLASS119_0__INSERTALL_B__0_OFFSET UNITYSDK_OFFSET(0x1A073A60)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnection___c__DisplayClass119_0_TypeDefinitionIndex = 35215;
