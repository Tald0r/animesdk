...
#define SQLITE_SQLITEASYNCCONNECTION_BACKUPASYNC_OFFSET UNITYSDK_OFFSET(0x1A6341D0)
#define SQLITE_SQLITEASYNCCONNECTION_CLOSEASYNC_OFFSET UNITYSDK_OFFSET(0x1A6332C0)
#define SQLITE_SQLITEASYNCCONNECTION_CREATEINDEXASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A633770)
#define SQLITE_SQLITEASYNCCONNECTION_CREATEINDEXASYNC_2_OFFSET UNITYSDK_OFFSET(0x1A633840)
#define SQLITE_SQLITEASYNCCONNECTION_CREATEINDEXASYNC_3_OFFSET UNITYSDK_OFFSET(0x1A633900)
#define SQLITE_SQLITEASYNCCONNECTION_CREATEINDEXASYNC_OFFSET UNITYSDK_OFFSET(0x1A6336B0)
#define SQLITE_SQLITEASYNCCONNECTION_CREATETABLEASYNC_OFFSET UNITYSDK_OFFSET(0x1A6334B0)
#define SQLITE_SQLITEASYNCCONNECTION_CREATETABLESASYNC_OFFSET UNITYSDK_OFFSET(0x1A633560)
#define SQLITE_SQLITEASYNCCONNECTION_DEFERREDQUERYASYNC_OFFSET UNITYSDK_OFFSET(0x1A634A50)
#define SQLITE_SQLITEASYNCCONNECTION_DELETEALLASYNC_OFFSET UNITYSDK_OFFSET(0x1A634130)
#define SQLITE_SQLITEASYNCCONNECTION_DELETEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A634080)
#define SQLITE_SQLITEASYNCCONNECTION_DELETEASYNC_OFFSET UNITYSDK_OFFSET(0x1A633FE0)
#define SQLITE_SQLITEASYNCCONNECTION_DROPTABLEASYNC_OFFSET UNITYSDK_OFFSET(0x1A633610)
#define SQLITE_SQLITEASYNCCONNECTION_ENABLELOADEXTENSIONASYNC_OFFSET UNITYSDK_OFFSET(0x1A633410)
#define SQLITE_SQLITEASYNCCONNECTION_ENABLEWRITEAHEADLOGGINGASYNC_OFFSET UNITYSDK_OFFSET(0x1A6327F0)
#define SQLITE_SQLITEASYNCCONNECTION_EXECUTEASYNC_OFFSET UNITYSDK_OFFSET(0x1A634600)
#define SQLITE_SQLITEASYNCCONNECTION_FINDASYNC_OFFSET UNITYSDK_OFFSET(0x1A634330)
#define SQLITE_SQLITEASYNCCONNECTION_FINDWITHQUERYASYNC_OFFSET UNITYSDK_OFFSET(0x1A6343E0)
#define SQLITE_SQLITEASYNCCONNECTION_GETASYNC_OFFSET UNITYSDK_OFFSET(0x1A634280)
#define SQLITE_SQLITEASYNCCONNECTION_GETBUSYTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A632720)
#define SQLITE_SQLITEASYNCCONNECTION_GETCONNECTIONANDTRANSACTIONLOCK_OFFSET UNITYSDK_OFFSET(0x1A632FA0)
#define SQLITE_SQLITEASYNCCONNECTION_GETCONNECTION_OFFSET UNITYSDK_OFFSET(0x1A632610)
#define SQLITE_SQLITEASYNCCONNECTION_GETMAPPINGASYNC_OFFSET UNITYSDK_OFFSET(0x1A6344A0)
#define SQLITE_SQLITEASYNCCONNECTION_GETTABLEINFOASYNC_OFFSET UNITYSDK_OFFSET(0x1A634550)
#define SQLITE_SQLITEASYNCCONNECTION_GET_DATABASEPATH_OFFSET UNITYSDK_OFFSET(0x1A6325F0)
#define SQLITE_SQLITEASYNCCONNECTION_GET_DATETIMESTRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A632700)
#define SQLITE_SQLITEASYNCCONNECTION_GET_LIBVERSIONNUMBER_OFFSET UNITYSDK_OFFSET(0x1A6326E0)
#define SQLITE_SQLITEASYNCCONNECTION_GET_STOREDATETIMEASTICKS_OFFSET UNITYSDK_OFFSET(0x1A6328F0)
#define SQLITE_SQLITEASYNCCONNECTION_GET_STORETIMESPANASTICKS_OFFSET UNITYSDK_OFFSET(0x1A632910)
#define SQLITE_SQLITEASYNCCONNECTION_GET_TABLEMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1A632A00)
#define SQLITE_SQLITEASYNCCONNECTION_GET_TIMEEXECUTION_OFFSET UNITYSDK_OFFSET(0x1A6329C0)
#define SQLITE_SQLITEASYNCCONNECTION_GET_TRACER_OFFSET UNITYSDK_OFFSET(0x1A632970)
#define SQLITE_SQLITEASYNCCONNECTION_GET_TRACE_OFFSET UNITYSDK_OFFSET(0x1A632930)
#define SQLITE_SQLITEASYNCCONNECTION_INSERTALLASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A634760)
#define SQLITE_SQLITEASYNCCONNECTION_INSERTALLASYNC_2_OFFSET UNITYSDK_OFFSET(0x1A634820)
#define SQLITE_SQLITEASYNCCONNECTION_INSERTALLASYNC_OFFSET UNITYSDK_OFFSET(0x1A6346B0)
#define SQLITE_SQLITEASYNCCONNECTION_INSERTASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A633A70)
#define SQLITE_SQLITEASYNCCONNECTION_INSERTASYNC_2_OFFSET UNITYSDK_OFFSET(0x1A633B20)
#define SQLITE_SQLITEASYNCCONNECTION_INSERTASYNC_3_OFFSET UNITYSDK_OFFSET(0x1A633BD0)
#define SQLITE_SQLITEASYNCCONNECTION_INSERTASYNC_OFFSET UNITYSDK_OFFSET(0x1A6339D0)
#define SQLITE_SQLITEASYNCCONNECTION_INSERTORREPLACEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A633D30)
#define SQLITE_SQLITEASYNCCONNECTION_INSERTORREPLACEASYNC_OFFSET UNITYSDK_OFFSET(0x1A633C90)
#define SQLITE_SQLITEASYNCCONNECTION_QUERYASYNC_OFFSET UNITYSDK_OFFSET(0x1A634990)
#define SQLITE_SQLITEASYNCCONNECTION_REKEYASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A634BC0)
#define SQLITE_SQLITEASYNCCONNECTION_REKEYASYNC_OFFSET UNITYSDK_OFFSET(0x1A634B10)
#define SQLITE_SQLITEASYNCCONNECTION_RESETPOOL_OFFSET UNITYSDK_OFFSET(0x1A632BA0)
#define SQLITE_SQLITEASYNCCONNECTION_RUNINTRANSACTIONASYNC_OFFSET UNITYSDK_OFFSET(0x1A6348E0)
#define SQLITE_SQLITEASYNCCONNECTION_SETBUSYTIMEOUTASYNC_OFFSET UNITYSDK_OFFSET(0x1A632740)
#define SQLITE_SQLITEASYNCCONNECTION_SET_TIMEEXECUTION_OFFSET UNITYSDK_OFFSET(0x1A6329E0)
#define SQLITE_SQLITEASYNCCONNECTION_SET_TRACER_OFFSET UNITYSDK_OFFSET(0x1A632990)
#define SQLITE_SQLITEASYNCCONNECTION_SET_TRACE_OFFSET UNITYSDK_OFFSET(0x1A632950)
#define SQLITE_SQLITEASYNCCONNECTION_UPDATEALLASYNC_OFFSET UNITYSDK_OFFSET(0x1A633F30)
#define SQLITE_SQLITEASYNCCONNECTION_UPDATEASYNC_1_OFFSET UNITYSDK_OFFSET(0x1A633E80)
#define SQLITE_SQLITEASYNCCONNECTION_UPDATEASYNC_OFFSET UNITYSDK_OFFSET(0x1A633DE0)
#define SQLITE_SQLITEASYNCCONNECTION__CLOSEASYNC_B__31_0_OFFSET UNITYSDK_OFFSET(0x1A634C70)
#define SQLITE_SQLITEASYNCCONNECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A632560)
#define SQLITE_SQLITEASYNCCONNECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A632550)
#define SQLITE_SQLITEASYNCCONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6322F0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection_TypeDefinitionIndex = 36270;
