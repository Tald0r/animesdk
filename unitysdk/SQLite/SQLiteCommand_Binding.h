...
#define SQLITE_SQLITECOMMAND_BINDING_GET_INDEX_OFFSET UNITYSDK_OFFSET(0x1A63BFC0)
#define SQLITE_SQLITECOMMAND_BINDING_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A63BF80)
#define SQLITE_SQLITECOMMAND_BINDING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A63BFA0)
#define SQLITE_SQLITECOMMAND_BINDING_SET_INDEX_OFFSET UNITYSDK_OFFSET(0x1A63BFD0)
#define SQLITE_SQLITECOMMAND_BINDING_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A63BF90)
#define SQLITE_SQLITECOMMAND_BINDING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A63BFB0)
#define SQLITE_SQLITECOMMAND_BINDING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A63AE20)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteCommand_Binding_TypeDefinitionIndex = 36252;
