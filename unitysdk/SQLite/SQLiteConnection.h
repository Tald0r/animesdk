...
#define SQLITE_SQLITECONNECTION_ADD_TABLECHANGED_OFFSET UNITYSDK_OFFSET(0x1A63F550)
#define SQLITE_SQLITECONNECTION_BACKUP_OFFSET UNITYSDK_OFFSET(0x1A6386E0)
#define SQLITE_SQLITECONNECTION_BEGINTRANSACTION_OFFSET UNITYSDK_OFFSET(0x1A63A290)
#define SQLITE_SQLITECONNECTION_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A63F090)
#define SQLITE_SQLITECONNECTION_COMMIT_OFFSET UNITYSDK_OFFSET(0x1A63A3D0)
#define SQLITE_SQLITECONNECTION_CREATECOMMAND_1_OFFSET UNITYSDK_OFFSET(0x1A63D7E0)
#define SQLITE_SQLITECONNECTION_CREATECOMMAND_OFFSET UNITYSDK_OFFSET(0x1A63D6A0)
#define SQLITE_SQLITECONNECTION_CREATEINDEX_1_OFFSET UNITYSDK_OFFSET(0x1A6366D0)
#define SQLITE_SQLITECONNECTION_CREATEINDEX_2_OFFSET UNITYSDK_OFFSET(0x1A6365D0)
#define SQLITE_SQLITECONNECTION_CREATEINDEX_3_OFFSET UNITYSDK_OFFSET(0x1A6367E0)
#define SQLITE_SQLITECONNECTION_CREATEINDEX_OFFSET UNITYSDK_OFFSET(0x1A6368B0)
#define SQLITE_SQLITECONNECTION_CREATEINSERTCOMMAND_OFFSET UNITYSDK_OFFSET(0x1A63EA50)
#define SQLITE_SQLITECONNECTION_CREATETABLES_OFFSET UNITYSDK_OFFSET(0x1A636270)
#define SQLITE_SQLITECONNECTION_CREATETABLE_OFFSET UNITYSDK_OFFSET(0x1A635310)
#define SQLITE_SQLITECONNECTION_DEFERREDQUERY_OFFSET UNITYSDK_OFFSET(0x1A63A6D0)
#define SQLITE_SQLITECONNECTION_DELETEALL_OFFSET UNITYSDK_OFFSET(0x1A638590)
#define SQLITE_SQLITECONNECTION_DELETE_1_OFFSET UNITYSDK_OFFSET(0x1A638340)
#define SQLITE_SQLITECONNECTION_DELETE_OFFSET UNITYSDK_OFFSET(0x1A638080)
#define SQLITE_SQLITECONNECTION_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A63F0B0)
#define SQLITE_SQLITECONNECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A63F040)
#define SQLITE_SQLITECONNECTION_DOSAVEPOINTEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A63DE70)
#define SQLITE_SQLITECONNECTION_DROPTABLE_OFFSET UNITYSDK_OFFSET(0x1A6364B0)
#define SQLITE_SQLITECONNECTION_ENABLELOADEXTENSION_OFFSET UNITYSDK_OFFSET(0x1A635270)
#define SQLITE_SQLITECONNECTION_ENABLEWRITEAHEADLOGGING_OFFSET UNITYSDK_OFFSET(0x1A635020)
#define SQLITE_SQLITECONNECTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A639320)
#define SQLITE_SQLITECONNECTION_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A63EFD0)
#define SQLITE_SQLITECONNECTION_FINDWITHQUERY_OFFSET UNITYSDK_OFFSET(0x1A638CC0)
#define SQLITE_SQLITECONNECTION_FIND_OFFSET UNITYSDK_OFFSET(0x1A638A30)
#define SQLITE_SQLITECONNECTION_GETINSERTCOMMAND_OFFSET UNITYSDK_OFFSET(0x1A63E460)
#define SQLITE_SQLITECONNECTION_GETMAPPING_OFFSET UNITYSDK_OFFSET(0x1A638DC0)
#define SQLITE_SQLITECONNECTION_GETTABLEINFO_OFFSET UNITYSDK_OFFSET(0x1A639260)
#define SQLITE_SQLITECONNECTION_GET_BUSYTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A63CA00)
#define SQLITE_SQLITECONNECTION_GET_DATABASEPATH_OFFSET UNITYSDK_OFFSET(0x1A63C000)
#define SQLITE_SQLITECONNECTION_GET_DATETIMESTRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A63C100)
#define SQLITE_SQLITECONNECTION_GET_DATETIMESTYLE_OFFSET UNITYSDK_OFFSET(0x1A63C120)
#define SQLITE_SQLITECONNECTION_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1A63BFE0)
#define SQLITE_SQLITECONNECTION_GET_ISINTRANSACTION_OFFSET UNITYSDK_OFFSET(0x1A63D9D0)
#define SQLITE_SQLITECONNECTION_GET_LIBVERSIONNUMBER_OFFSET UNITYSDK_OFFSET(0x1A63C020)
#define SQLITE_SQLITECONNECTION_GET_OFFSET UNITYSDK_OFFSET(0x1A638860)
#define SQLITE_SQLITECONNECTION_GET_STOREDATETIMEASTICKS_OFFSET UNITYSDK_OFFSET(0x1A63C0A0)
#define SQLITE_SQLITECONNECTION_GET_STOREDATETIMOFFSETASTICKS_OFFSET UNITYSDK_OFFSET(0x1A63C0E0)
#define SQLITE_SQLITECONNECTION_GET_STORETIMESPANASTICKS_OFFSET UNITYSDK_OFFSET(0x1A63C0C0)
#define SQLITE_SQLITECONNECTION_GET_TABLEMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1A632A20)
#define SQLITE_SQLITECONNECTION_GET_TIMEEXECUTION_OFFSET UNITYSDK_OFFSET(0x1A63C040)
#define SQLITE_SQLITECONNECTION_GET_TRACER_OFFSET UNITYSDK_OFFSET(0x1A63C080)
#define SQLITE_SQLITECONNECTION_GET_TRACE_OFFSET UNITYSDK_OFFSET(0x1A63C060)
#define SQLITE_SQLITECONNECTION_INSERTALL_1_OFFSET UNITYSDK_OFFSET(0x1A6399E0)
#define SQLITE_SQLITECONNECTION_INSERTALL_2_OFFSET UNITYSDK_OFFSET(0x1A639E10)
#define SQLITE_SQLITECONNECTION_INSERTALL_OFFSET UNITYSDK_OFFSET(0x1A6395B0)
#define SQLITE_SQLITECONNECTION_INSERTORREPLACE_1_OFFSET UNITYSDK_OFFSET(0x1A637510)
#define SQLITE_SQLITECONNECTION_INSERTORREPLACE_OFFSET UNITYSDK_OFFSET(0x1A637420)
#define SQLITE_SQLITECONNECTION_INSERT_1_OFFSET UNITYSDK_OFFSET(0x1A636CE0)
#define SQLITE_SQLITECONNECTION_INSERT_2_OFFSET UNITYSDK_OFFSET(0x1A636D70)
#define SQLITE_SQLITECONNECTION_INSERT_3_OFFSET UNITYSDK_OFFSET(0x1A636E10)
#define SQLITE_SQLITECONNECTION_INSERT_OFFSET UNITYSDK_OFFSET(0x1A636C40)
#define SQLITE_SQLITECONNECTION_MIGRATETABLE_OFFSET UNITYSDK_OFFSET(0x1A63D160)
#define SQLITE_SQLITECONNECTION_NEWCOMMAND_OFFSET UNITYSDK_OFFSET(0x1A63D5F0)
#define SQLITE_SQLITECONNECTION_ONTABLECHANGED_OFFSET UNITYSDK_OFFSET(0x1A63E9B0)
#define SQLITE_SQLITECONNECTION_QUERY_OFFSET UNITYSDK_OFFSET(0x1A63A580)
#define SQLITE_SQLITECONNECTION_QUOTE_OFFSET UNITYSDK_OFFSET(0x1A63C990)
#define SQLITE_SQLITECONNECTION_REKEY_1_OFFSET UNITYSDK_OFFSET(0x1A63A8A0)
#define SQLITE_SQLITECONNECTION_REKEY_OFFSET UNITYSDK_OFFSET(0x1A63A760)
#define SQLITE_SQLITECONNECTION_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A63DF90)
#define SQLITE_SQLITECONNECTION_REMOVE_TABLECHANGED_OFFSET UNITYSDK_OFFSET(0x1A63F5D0)
#define SQLITE_SQLITECONNECTION_ROLLBACKTO_1_OFFSET UNITYSDK_OFFSET(0x1A63D9E0)
#define SQLITE_SQLITECONNECTION_ROLLBACKTO_OFFSET UNITYSDK_OFFSET(0x1A63DE60)
#define SQLITE_SQLITECONNECTION_ROLLBACK_OFFSET UNITYSDK_OFFSET(0x1A63A4C0)
#define SQLITE_SQLITECONNECTION_RUNINTRANSACTION_OFFSET UNITYSDK_OFFSET(0x1A63E0B0)
#define SQLITE_SQLITECONNECTION_SAVETRANSACTIONPOINT_OFFSET UNITYSDK_OFFSET(0x1A63DAE0)
#define SQLITE_SQLITECONNECTION_SETKEY_1_OFFSET UNITYSDK_OFFSET(0x1A63C7F0)
#define SQLITE_SQLITECONNECTION_SETKEY_OFFSET UNITYSDK_OFFSET(0x1A63C6E0)
#define SQLITE_SQLITECONNECTION_SET_BUSYTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A635130)
#define SQLITE_SQLITECONNECTION_SET_DATABASEPATH_OFFSET UNITYSDK_OFFSET(0x1A63C010)
#define SQLITE_SQLITECONNECTION_SET_DATETIMESTRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A63C110)
#define SQLITE_SQLITECONNECTION_SET_DATETIMESTYLE_OFFSET UNITYSDK_OFFSET(0x1A63C130)
#define SQLITE_SQLITECONNECTION_SET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1A63BFF0)
#define SQLITE_SQLITECONNECTION_SET_LIBVERSIONNUMBER_OFFSET UNITYSDK_OFFSET(0x1A63C030)
#define SQLITE_SQLITECONNECTION_SET_STOREDATETIMEASTICKS_OFFSET UNITYSDK_OFFSET(0x1A63C0B0)
#define SQLITE_SQLITECONNECTION_SET_STOREDATETIMOFFSETASTICKS_OFFSET UNITYSDK_OFFSET(0x1A63C0F0)
#define SQLITE_SQLITECONNECTION_SET_STORETIMESPANASTICKS_OFFSET UNITYSDK_OFFSET(0x1A63C0D0)
#define SQLITE_SQLITECONNECTION_SET_TIMEEXECUTION_OFFSET UNITYSDK_OFFSET(0x1A63C050)
#define SQLITE_SQLITECONNECTION_SET_TRACER_OFFSET UNITYSDK_OFFSET(0x1A63C090)
#define SQLITE_SQLITECONNECTION_SET_TRACE_OFFSET UNITYSDK_OFFSET(0x1A63C070)
#define SQLITE_SQLITECONNECTION_UPDATEALL_OFFSET UNITYSDK_OFFSET(0x1A637C50)
#define SQLITE_SQLITECONNECTION_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1A637670)
#define SQLITE_SQLITECONNECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A6375D0)
#define SQLITE_SQLITECONNECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A63F650)
#define SQLITE_SQLITECONNECTION__CREATETABLE_B__75_0_OFFSET UNITYSDK_OFFSET(0x1A63F6F0)
#define SQLITE_SQLITECONNECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A63C650)
#define SQLITE_SQLITECONNECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A63C1D0)
#define SQLITE_SQLITECONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A63C140)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnection_TypeDefinitionIndex = 36212;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::SQLite::TableMapping*>**)Il2CppClass::FromTypeDefinitionIndex(SQLiteConnection_TypeDefinitionIndex)->GetStaticField(0x267D0);
		}
		static ::System::IntPtr* StaticGet_NullHandle()
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(SQLiteConnection_TypeDefinitionIndex)->GetStaticField(0x88A0);
		}
		static ::System::IntPtr* StaticGet_NullBackupHandle()
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(SQLiteConnection_TypeDefinitionIndex)->GetStaticField(0x88A8);
		}
		::System::String* _DatabasePath_k__BackingField; // 0x10
		::System::Diagnostics::Stopwatch* _sw; // 0x18
		::System::Collections::Generic::Dictionary_2<::System::Tuple_2<::System::String*, ::System::String*>*, ::SQLite::PreparedSqlLiteInsertCommand*>* _insertCommandMap; // 0x20
		::System::Action_1<::System::String*>* _Tracer_k__BackingField; // 0x28
		::System::String* _DateTimeStringFormat_k__BackingField; // 0x30
		::System::Random* _rand; // 0x38
		::System::EventHandler_1<::SQLite::NotifyTableChangedEventArgs*>* TableChanged; // 0x40
		::System::Boolean _StoreDateTimeAsTicks_k__BackingField; // 0x48
		::System::Boolean _StoreTimeSpanAsTicks_k__BackingField; // 0x49
		::System::Boolean _Trace_k__BackingField; // 0x4A
		::System::Boolean _open; // 0x4B
		::System::Boolean _TimeExecution_k__BackingField; // 0x4C
		::System::Boolean _StoreDateTimOffsetAsTicks_k__BackingField; // 0x4D
		::System::Int64 _elapsedMilliseconds; // 0x50
		::System::IntPtr _Handle_k__BackingField; // 0x58
		::System::TimeSpan _busyTimeout; // 0x60
		::System::Int32 _LibVersionNumber_k__BackingField; // 0x68
		::System::Globalization::DateTimeStyles _DateTimeStyle_k__BackingField; // 0x6C
		::System::Int32 _transactionDepth; // 0x70
