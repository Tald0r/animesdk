...
#define SQLITE_SQLITECONNECTION_ADD_TABLECHANGED_OFFSET UNITYSDK_OFFSET(0x1A073730)
#define SQLITE_SQLITECONNECTION_BACKUP_OFFSET UNITYSDK_OFFSET(0x1A06C8C0)
#define SQLITE_SQLITECONNECTION_BEGINTRANSACTION_OFFSET UNITYSDK_OFFSET(0x1A06E480)
#define SQLITE_SQLITECONNECTION_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A073270)
#define SQLITE_SQLITECONNECTION_COMMIT_OFFSET UNITYSDK_OFFSET(0x1A06E5C0)
#define SQLITE_SQLITECONNECTION_CREATECOMMAND_1_OFFSET UNITYSDK_OFFSET(0x1A0719C0)
#define SQLITE_SQLITECONNECTION_CREATECOMMAND_OFFSET UNITYSDK_OFFSET(0x1A071880)
#define SQLITE_SQLITECONNECTION_CREATEINDEX_1_OFFSET UNITYSDK_OFFSET(0x1A06A8B0)
#define SQLITE_SQLITECONNECTION_CREATEINDEX_2_OFFSET UNITYSDK_OFFSET(0x1A06A7B0)
#define SQLITE_SQLITECONNECTION_CREATEINDEX_3_OFFSET UNITYSDK_OFFSET(0x1A06A9C0)
#define SQLITE_SQLITECONNECTION_CREATEINDEX_OFFSET UNITYSDK_OFFSET(0x1A06AA90)
#define SQLITE_SQLITECONNECTION_CREATEINSERTCOMMAND_OFFSET UNITYSDK_OFFSET(0x1A072C30)
#define SQLITE_SQLITECONNECTION_CREATETABLES_OFFSET UNITYSDK_OFFSET(0x1A06A450)
#define SQLITE_SQLITECONNECTION_CREATETABLE_OFFSET UNITYSDK_OFFSET(0x1A0694F0)
#define SQLITE_SQLITECONNECTION_DEFERREDQUERY_OFFSET UNITYSDK_OFFSET(0x1A06E8C0)
#define SQLITE_SQLITECONNECTION_DELETEALL_OFFSET UNITYSDK_OFFSET(0x1A06C770)
#define SQLITE_SQLITECONNECTION_DELETE_1_OFFSET UNITYSDK_OFFSET(0x1A06C520)
#define SQLITE_SQLITECONNECTION_DELETE_OFFSET UNITYSDK_OFFSET(0x1A06C260)
#define SQLITE_SQLITECONNECTION_DISPOSE_1_OFFSET UNITYSDK_OFFSET(0x1A073290)
#define SQLITE_SQLITECONNECTION_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A073220)
#define SQLITE_SQLITECONNECTION_DOSAVEPOINTEXECUTE_OFFSET UNITYSDK_OFFSET(0x1A072050)
#define SQLITE_SQLITECONNECTION_DROPTABLE_OFFSET UNITYSDK_OFFSET(0x1A06A690)
#define SQLITE_SQLITECONNECTION_ENABLELOADEXTENSION_OFFSET UNITYSDK_OFFSET(0x1A069450)
#define SQLITE_SQLITECONNECTION_ENABLEWRITEAHEADLOGGING_OFFSET UNITYSDK_OFFSET(0x1A069200)
#define SQLITE_SQLITECONNECTION_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1A06D510)
#define SQLITE_SQLITECONNECTION_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A0731B0)
#define SQLITE_SQLITECONNECTION_FINDWITHQUERY_OFFSET UNITYSDK_OFFSET(0x1A06CEA0)
#define SQLITE_SQLITECONNECTION_FIND_OFFSET UNITYSDK_OFFSET(0x1A06CC10)
#define SQLITE_SQLITECONNECTION_GETINSERTCOMMAND_OFFSET UNITYSDK_OFFSET(0x1A072640)
#define SQLITE_SQLITECONNECTION_GETMAPPING_OFFSET UNITYSDK_OFFSET(0x1A06CFA0)
#define SQLITE_SQLITECONNECTION_GETTABLEINFO_OFFSET UNITYSDK_OFFSET(0x1A06D450)
#define SQLITE_SQLITECONNECTION_GET_BUSYTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A070BE0)
#define SQLITE_SQLITECONNECTION_GET_DATABASEPATH_OFFSET UNITYSDK_OFFSET(0x1A0701F0)
#define SQLITE_SQLITECONNECTION_GET_DATETIMESTRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A0702F0)
#define SQLITE_SQLITECONNECTION_GET_DATETIMESTYLE_OFFSET UNITYSDK_OFFSET(0x1A070310)
#define SQLITE_SQLITECONNECTION_GET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1A0701D0)
#define SQLITE_SQLITECONNECTION_GET_ISINTRANSACTION_OFFSET UNITYSDK_OFFSET(0x1A071BB0)
#define SQLITE_SQLITECONNECTION_GET_LIBVERSIONNUMBER_OFFSET UNITYSDK_OFFSET(0x1A070210)
#define SQLITE_SQLITECONNECTION_GET_OFFSET UNITYSDK_OFFSET(0x1A06CA40)
#define SQLITE_SQLITECONNECTION_GET_STOREDATETIMEASTICKS_OFFSET UNITYSDK_OFFSET(0x1A070290)
#define SQLITE_SQLITECONNECTION_GET_STOREDATETIMOFFSETASTICKS_OFFSET UNITYSDK_OFFSET(0x1A0702D0)
#define SQLITE_SQLITECONNECTION_GET_STORETIMESPANASTICKS_OFFSET UNITYSDK_OFFSET(0x1A0702B0)
#define SQLITE_SQLITECONNECTION_GET_TABLEMAPPINGS_OFFSET UNITYSDK_OFFSET(0x1A066C00)
#define SQLITE_SQLITECONNECTION_GET_TIMEEXECUTION_OFFSET UNITYSDK_OFFSET(0x1A070230)
#define SQLITE_SQLITECONNECTION_GET_TRACER_OFFSET UNITYSDK_OFFSET(0x1A070270)
#define SQLITE_SQLITECONNECTION_GET_TRACE_OFFSET UNITYSDK_OFFSET(0x1A070250)
#define SQLITE_SQLITECONNECTION_INSERTALL_1_OFFSET UNITYSDK_OFFSET(0x1A06DBD0)
#define SQLITE_SQLITECONNECTION_INSERTALL_2_OFFSET UNITYSDK_OFFSET(0x1A06E000)
#define SQLITE_SQLITECONNECTION_INSERTALL_OFFSET UNITYSDK_OFFSET(0x1A06D7A0)
#define SQLITE_SQLITECONNECTION_INSERTORREPLACE_1_OFFSET UNITYSDK_OFFSET(0x1A06B6F0)
#define SQLITE_SQLITECONNECTION_INSERTORREPLACE_OFFSET UNITYSDK_OFFSET(0x1A06B600)
#define SQLITE_SQLITECONNECTION_INSERT_1_OFFSET UNITYSDK_OFFSET(0x1A06AEC0)
#define SQLITE_SQLITECONNECTION_INSERT_2_OFFSET UNITYSDK_OFFSET(0x1A06AF50)
#define SQLITE_SQLITECONNECTION_INSERT_3_OFFSET UNITYSDK_OFFSET(0x1A06AFF0)
#define SQLITE_SQLITECONNECTION_INSERT_OFFSET UNITYSDK_OFFSET(0x1A06AE20)
#define SQLITE_SQLITECONNECTION_MIGRATETABLE_OFFSET UNITYSDK_OFFSET(0x1A071340)
#define SQLITE_SQLITECONNECTION_NEWCOMMAND_OFFSET UNITYSDK_OFFSET(0x1A0717D0)
#define SQLITE_SQLITECONNECTION_ONTABLECHANGED_OFFSET UNITYSDK_OFFSET(0x1A072B90)
#define SQLITE_SQLITECONNECTION_QUERY_OFFSET UNITYSDK_OFFSET(0x1A06E770)
#define SQLITE_SQLITECONNECTION_QUOTE_OFFSET UNITYSDK_OFFSET(0x1A070B70)
#define SQLITE_SQLITECONNECTION_REKEY_1_OFFSET UNITYSDK_OFFSET(0x1A06EA90)
#define SQLITE_SQLITECONNECTION_REKEY_OFFSET UNITYSDK_OFFSET(0x1A06E950)
#define SQLITE_SQLITECONNECTION_RELEASE_OFFSET UNITYSDK_OFFSET(0x1A072170)
#define SQLITE_SQLITECONNECTION_REMOVE_TABLECHANGED_OFFSET UNITYSDK_OFFSET(0x1A0737B0)
#define SQLITE_SQLITECONNECTION_ROLLBACKTO_1_OFFSET UNITYSDK_OFFSET(0x1A071BC0)
#define SQLITE_SQLITECONNECTION_ROLLBACKTO_OFFSET UNITYSDK_OFFSET(0x1A072040)
#define SQLITE_SQLITECONNECTION_ROLLBACK_OFFSET UNITYSDK_OFFSET(0x1A06E6B0)
#define SQLITE_SQLITECONNECTION_RUNINTRANSACTION_OFFSET UNITYSDK_OFFSET(0x1A072290)
#define SQLITE_SQLITECONNECTION_SAVETRANSACTIONPOINT_OFFSET UNITYSDK_OFFSET(0x1A071CC0)
#define SQLITE_SQLITECONNECTION_SETKEY_1_OFFSET UNITYSDK_OFFSET(0x1A0709D0)
#define SQLITE_SQLITECONNECTION_SETKEY_OFFSET UNITYSDK_OFFSET(0x1A0708C0)
#define SQLITE_SQLITECONNECTION_SET_BUSYTIMEOUT_OFFSET UNITYSDK_OFFSET(0x1A069310)
#define SQLITE_SQLITECONNECTION_SET_DATABASEPATH_OFFSET UNITYSDK_OFFSET(0x1A070200)
#define SQLITE_SQLITECONNECTION_SET_DATETIMESTRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A070300)
#define SQLITE_SQLITECONNECTION_SET_DATETIMESTYLE_OFFSET UNITYSDK_OFFSET(0x1A070320)
#define SQLITE_SQLITECONNECTION_SET_HANDLE_OFFSET UNITYSDK_OFFSET(0x1A0701E0)
#define SQLITE_SQLITECONNECTION_SET_LIBVERSIONNUMBER_OFFSET UNITYSDK_OFFSET(0x1A070220)
#define SQLITE_SQLITECONNECTION_SET_STOREDATETIMEASTICKS_OFFSET UNITYSDK_OFFSET(0x1A0702A0)
#define SQLITE_SQLITECONNECTION_SET_STOREDATETIMOFFSETASTICKS_OFFSET UNITYSDK_OFFSET(0x1A0702E0)
#define SQLITE_SQLITECONNECTION_SET_STORETIMESPANASTICKS_OFFSET UNITYSDK_OFFSET(0x1A0702C0)
#define SQLITE_SQLITECONNECTION_SET_TIMEEXECUTION_OFFSET UNITYSDK_OFFSET(0x1A070240)
#define SQLITE_SQLITECONNECTION_SET_TRACER_OFFSET UNITYSDK_OFFSET(0x1A070280)
#define SQLITE_SQLITECONNECTION_SET_TRACE_OFFSET UNITYSDK_OFFSET(0x1A070260)
#define SQLITE_SQLITECONNECTION_UPDATEALL_OFFSET UNITYSDK_OFFSET(0x1A06BE30)
#define SQLITE_SQLITECONNECTION_UPDATE_1_OFFSET UNITYSDK_OFFSET(0x1A06B850)
#define SQLITE_SQLITECONNECTION_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A06B7B0)
#define SQLITE_SQLITECONNECTION__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A073830)
#define SQLITE_SQLITECONNECTION__CREATETABLE_B__75_0_OFFSET UNITYSDK_OFFSET(0x1A0738D0)
#define SQLITE_SQLITECONNECTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A070830)
#define SQLITE_SQLITECONNECTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A0703C0)
#define SQLITE_SQLITECONNECTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A070330)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnection_TypeDefinitionIndex = 35210;
	...
	public:
		...
		{
			return (::System::Collections::Generic::Dictionary_2<::System::String*, ::SQLite::TableMapping*>**)Il2CppClass::FromTypeDefinitionIndex(SQLiteConnection_TypeDefinitionIndex)->GetStaticField(0x24DA0);
		}
		static ::System::IntPtr* StaticGet_NullHandle()
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(SQLiteConnection_TypeDefinitionIndex)->GetStaticField(0x8540);
		}
		static ::System::IntPtr* StaticGet_NullBackupHandle()
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(SQLiteConnection_TypeDefinitionIndex)->GetStaticField(0x8548);
		}
		::System::EventHandler_1<::SQLite::NotifyTableChangedEventArgs*>* TableChanged; // 0x10
		::System::String* _DateTimeStringFormat_k__BackingField; // 0x18
		::System::Diagnostics::Stopwatch* _sw; // 0x20
		::System::Random* _rand; // 0x28
		::System::Action_1<::System::String*>* _Tracer_k__BackingField; // 0x30
		::System::Collections::Generic::Dictionary_2<::System::Tuple_2<::System::String*, ::System::String*>*, ::SQLite::PreparedSqlLiteInsertCommand*>* _insertCommandMap; // 0x38
		...
		::System::Int32 _LibVersionNumber_k__BackingField; // 0x58
		::System::Globalization::DateTimeStyles _DateTimeStyle_k__BackingField; // 0x5C
		::System::Boolean _open; // 0x60
		::System::Boolean _StoreDateTimeAsTicks_k__BackingField; // 0x61
		::System::Boolean _TimeExecution_k__BackingField; // 0x62
		::System::Boolean _StoreTimeSpanAsTicks_k__BackingField; // 0x63
		::System::Int32 _transactionDepth; // 0x64
		::System::TimeSpan _busyTimeout; // 0x68
		::System::Boolean _StoreDateTimOffsetAsTicks_k__BackingField; // 0x70
		::System::Boolean _Trace_k__BackingField; // 0x71
