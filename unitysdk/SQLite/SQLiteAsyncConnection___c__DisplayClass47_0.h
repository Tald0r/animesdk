...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS47_0__CREATEINDEXASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1A06A920)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS47_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A067AD0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass47_0_TypeDefinitionIndex = 35282;
