...
#define SQLITE_SQLITEDATAREADEXCEPTION_NEW_1_OFFSET UNITYSDK_OFFSET(0x1A63BE70)
#define SQLITE_SQLITEDATAREADEXCEPTION_NEW_OFFSET UNITYSDK_OFFSET(0x1A640EB0)
#define SQLITE_SQLITEDATAREADEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A640E20)
#define SQLITE_SQLITEDATAREADEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A640DA0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteDataReadException_TypeDefinitionIndex = 36206;
