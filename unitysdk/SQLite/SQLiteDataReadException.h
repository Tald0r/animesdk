...
#define SQLITE_SQLITEDATAREADEXCEPTION_NEW_1_OFFSET UNITYSDK_OFFSET(0x1A070060)
#define SQLITE_SQLITEDATAREADEXCEPTION_NEW_OFFSET UNITYSDK_OFFSET(0x1A075090)
#define SQLITE_SQLITEDATAREADEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A075000)
#define SQLITE_SQLITEDATAREADEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A074F80)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteDataReadException_TypeDefinitionIndex = 35204;
