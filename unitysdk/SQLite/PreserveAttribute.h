...
#define SQLITE_PRESERVEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0664B0)

namespace SQLite
{
	inline static constexpr unsigned int PreserveAttribute_TypeDefinitionIndex = 35231;
