...
#define SQLITE_TABLEMAPPING_FINDCOLUMNWITHPROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1A075F60)
#define SQLITE_TABLEMAPPING_FINDCOLUMN_OFFSET UNITYSDK_OFFSET(0x1A076010)
#define SQLITE_TABLEMAPPING_GETFIELDSFROMVALUETUPLE_OFFSET UNITYSDK_OFFSET(0x1A075E80)
#define SQLITE_TABLEMAPPING_GETPUBLICMEMBERS_OFFSET UNITYSDK_OFFSET(0x1A0752C0)
#define SQLITE_TABLEMAPPING_GET_COLUMNS_OFFSET UNITYSDK_OFFSET(0x1A075220)
#define SQLITE_TABLEMAPPING_GET_CREATEFLAGS_OFFSET UNITYSDK_OFFSET(0x1A075280)
#define SQLITE_TABLEMAPPING_GET_GETBYPRIMARYKEYSQL_OFFSET UNITYSDK_OFFSET(0x1A075260)
#define SQLITE_TABLEMAPPING_GET_HASAUTOINCPK_OFFSET UNITYSDK_OFFSET(0x1A075F20)
#define SQLITE_TABLEMAPPING_GET_INSERTCOLUMNS_OFFSET UNITYSDK_OFFSET(0x1A075F40)
#define SQLITE_TABLEMAPPING_GET_INSERTORREPLACECOLUMNS_OFFSET UNITYSDK_OFFSET(0x1A075F50)
#define SQLITE_TABLEMAPPING_GET_MAPPEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A0751C0)
#define SQLITE_TABLEMAPPING_GET_METHOD_OFFSET UNITYSDK_OFFSET(0x1A0752A0)
#define SQLITE_TABLEMAPPING_GET_PK_OFFSET UNITYSDK_OFFSET(0x1A075240)
#define SQLITE_TABLEMAPPING_GET_TABLENAME_OFFSET UNITYSDK_OFFSET(0x1A0751E0)
#define SQLITE_TABLEMAPPING_GET_WITHOUTROWID_OFFSET UNITYSDK_OFFSET(0x1A075200)
#define SQLITE_TABLEMAPPING_SETAUTOINCPK_OFFSET UNITYSDK_OFFSET(0x1A072B20)
#define SQLITE_TABLEMAPPING_SET_COLUMNS_OFFSET UNITYSDK_OFFSET(0x1A075230)
#define SQLITE_TABLEMAPPING_SET_CREATEFLAGS_OFFSET UNITYSDK_OFFSET(0x1A075290)
#define SQLITE_TABLEMAPPING_SET_GETBYPRIMARYKEYSQL_OFFSET UNITYSDK_OFFSET(0x1A075270)
#define SQLITE_TABLEMAPPING_SET_HASAUTOINCPK_OFFSET UNITYSDK_OFFSET(0x1A075F30)
#define SQLITE_TABLEMAPPING_SET_MAPPEDTYPE_OFFSET UNITYSDK_OFFSET(0x1A0751D0)
#define SQLITE_TABLEMAPPING_SET_METHOD_OFFSET UNITYSDK_OFFSET(0x1A0752B0)
#define SQLITE_TABLEMAPPING_SET_PK_OFFSET UNITYSDK_OFFSET(0x1A075250)
#define SQLITE_TABLEMAPPING_SET_TABLENAME_OFFSET UNITYSDK_OFFSET(0x1A0751F0)
#define SQLITE_TABLEMAPPING_SET_WITHOUTROWID_OFFSET UNITYSDK_OFFSET(0x1A075210)
#define SQLITE_TABLEMAPPING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A070BF0)

namespace SQLite
{
	inline static constexpr unsigned int TableMapping_TypeDefinitionIndex = 35236;

	class TableMapping : public ::System::Object
	{
	public:
		::Il2CppArray<::SQLite::TableMapping_Column*>* _insertColumns; // 0x10
		::SQLite::TableMapping_Column* _autoPk; // 0x18
		::System::Type* _MappedType_k__BackingField; // 0x20
		::Il2CppArray<::SQLite::TableMapping_Column*>* _insertOrReplaceColumns; // 0x28
		::System::String* _TableName_k__BackingField; // 0x30
		::Il2CppArray<::SQLite::TableMapping_Column*>* _Columns_k__BackingField; // 0x38
		::System::String* _GetByPrimaryKeySql_k__BackingField; // 0x40
		::SQLite::TableMapping_Column* _PK_k__BackingField; // 0x48
		::SQLite::CreateFlags _CreateFlags_k__BackingField; // 0x50
		::System::Boolean _WithoutRowId_k__BackingField; // 0x54
		::System::Boolean _HasAutoIncPK_k__BackingField; // 0x55
		::SQLite::TableMapping_MapMethod _Method_k__BackingField; // 0x58
