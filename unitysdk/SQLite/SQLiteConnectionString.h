...
#define SQLITE_SQLITECONNECTIONSTRING_GET_DATABASEPATH_OFFSET UNITYSDK_OFFSET(0x1A074C70)
#define SQLITE_SQLITECONNECTIONSTRING_GET_DATETIMESTRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A074CB0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_DATETIMESTYLE_OFFSET UNITYSDK_OFFSET(0x1A074CC0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1A074CD0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_OPENFLAGS_OFFSET UNITYSDK_OFFSET(0x1A074CE0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_POSTKEYACTION_OFFSET UNITYSDK_OFFSET(0x1A074D00)
#define SQLITE_SQLITECONNECTIONSTRING_GET_PREKEYACTION_OFFSET UNITYSDK_OFFSET(0x1A074CF0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_STOREDATETIMEASTICKS_OFFSET UNITYSDK_OFFSET(0x1A074C80)
#define SQLITE_SQLITECONNECTIONSTRING_GET_STOREDATETIMOFFSETASTICKS_OFFSET UNITYSDK_OFFSET(0x1A074CA0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_STORETIMESPANASTICKS_OFFSET UNITYSDK_OFFSET(0x1A074C90)
#define SQLITE_SQLITECONNECTIONSTRING_GET_UNIQUEKEY_OFFSET UNITYSDK_OFFSET(0x1A074C60)
#define SQLITE_SQLITECONNECTIONSTRING_GET_VFSNAME_OFFSET UNITYSDK_OFFSET(0x1A074D10)
#define SQLITE_SQLITECONNECTIONSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A074D90)
#define SQLITE_SQLITECONNECTIONSTRING__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A066560)
#define SQLITE_SQLITECONNECTIONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A074D20)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnectionString_TypeDefinitionIndex = 35222;
	...
	public:
		...
		::System::Action_1<::SQLite::SQLiteConnection*>* _PreKeyAction_k__BackingField; // 0x18
		::System::Object* _Key_k__BackingField; // 0x20
		::System::Action_1<::SQLite::SQLiteConnection*>* _PostKeyAction_k__BackingField; // 0x28
		::System::String* _VfsName_k__BackingField; // 0x30
		::System::String* _DatabasePath_k__BackingField; // 0x38
		::System::String* _UniqueKey_k__BackingField; // 0x40
