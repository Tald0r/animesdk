...
#define SQLITE_SQLITECONNECTIONSTRING_GET_DATABASEPATH_OFFSET UNITYSDK_OFFSET(0x1A640A90)
#define SQLITE_SQLITECONNECTIONSTRING_GET_DATETIMESTRINGFORMAT_OFFSET UNITYSDK_OFFSET(0x1A640AD0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_DATETIMESTYLE_OFFSET UNITYSDK_OFFSET(0x1A640AE0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1A640AF0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_OPENFLAGS_OFFSET UNITYSDK_OFFSET(0x1A640B00)
#define SQLITE_SQLITECONNECTIONSTRING_GET_POSTKEYACTION_OFFSET UNITYSDK_OFFSET(0x1A640B20)
#define SQLITE_SQLITECONNECTIONSTRING_GET_PREKEYACTION_OFFSET UNITYSDK_OFFSET(0x1A640B10)
#define SQLITE_SQLITECONNECTIONSTRING_GET_STOREDATETIMEASTICKS_OFFSET UNITYSDK_OFFSET(0x1A640AA0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_STOREDATETIMOFFSETASTICKS_OFFSET UNITYSDK_OFFSET(0x1A640AC0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_STORETIMESPANASTICKS_OFFSET UNITYSDK_OFFSET(0x1A640AB0)
#define SQLITE_SQLITECONNECTIONSTRING_GET_UNIQUEKEY_OFFSET UNITYSDK_OFFSET(0x1A640A80)
#define SQLITE_SQLITECONNECTIONSTRING_GET_VFSNAME_OFFSET UNITYSDK_OFFSET(0x1A640B30)
#define SQLITE_SQLITECONNECTIONSTRING__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A640BB0)
#define SQLITE_SQLITECONNECTIONSTRING__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A632380)
#define SQLITE_SQLITECONNECTIONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x1A640B40)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnectionString_TypeDefinitionIndex = 36224;
	...
	public:
		...
		::System::String* _VfsName_k__BackingField; // 0x18
		::System::String* _DatabasePath_k__BackingField; // 0x20
		::System::Object* _Key_k__BackingField; // 0x28
		::System::String* _UniqueKey_k__BackingField; // 0x30
		::System::Action_1<::SQLite::SQLiteConnection*>* _PostKeyAction_k__BackingField; // 0x38
