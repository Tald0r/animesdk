...
#define SQLITE_SQLITEEXCEPTION_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x1A640F60)
#define SQLITE_SQLITEEXCEPTION_NEW_OFFSET UNITYSDK_OFFSET(0x1A631A00)
#define SQLITE_SQLITEEXCEPTION_SET_RESULT_OFFSET UNITYSDK_OFFSET(0x1A640F70)
#define SQLITE_SQLITEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6302A0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteException_TypeDefinitionIndex = 36205;
