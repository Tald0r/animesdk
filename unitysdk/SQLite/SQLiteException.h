...
#define SQLITE_SQLITEEXCEPTION_GET_RESULT_OFFSET UNITYSDK_OFFSET(0x1A075140)
#define SQLITE_SQLITEEXCEPTION_NEW_OFFSET UNITYSDK_OFFSET(0x1A065BE0)
#define SQLITE_SQLITEEXCEPTION_SET_RESULT_OFFSET UNITYSDK_OFFSET(0x1A075150)
#define SQLITE_SQLITEEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A064480)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteException_TypeDefinitionIndex = 35203;
