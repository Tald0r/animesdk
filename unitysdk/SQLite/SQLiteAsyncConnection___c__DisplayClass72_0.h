...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS72_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A068670)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS72_0__FINDWITHQUERYASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1A06CDB0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass72_0_TypeDefinitionIndex = 35307;
