...
#define SQLITE_UNSAFECONVERTER_TOINT_OFFSET UNITYSDK_OFFSET(0x1A63B310)
#define SQLITE_UNSAFECONVERTER_TOLONG_OFFSET UNITYSDK_OFFSET(0x1A63B320)
#define SQLITE_UNSAFECONVERTER_TOUINT_OFFSET UNITYSDK_OFFSET(0x1A63BF30)
#define SQLITE_UNSAFECONVERTER_TOULONG_OFFSET UNITYSDK_OFFSET(0x1A63BF20)

namespace SQLite
{
	inline static constexpr unsigned int UnsafeConverter_TypeDefinitionIndex = 36339;
