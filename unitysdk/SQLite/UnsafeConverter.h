...
#define SQLITE_UNSAFECONVERTER_TOINT_OFFSET UNITYSDK_OFFSET(0x1A06F500)
#define SQLITE_UNSAFECONVERTER_TOLONG_OFFSET UNITYSDK_OFFSET(0x1A06F510)
#define SQLITE_UNSAFECONVERTER_TOUINT_OFFSET UNITYSDK_OFFSET(0x1A070120)
#define SQLITE_UNSAFECONVERTER_TOULONG_OFFSET UNITYSDK_OFFSET(0x1A070110)

namespace SQLite
{
	inline static constexpr unsigned int UnsafeConverter_TypeDefinitionIndex = 35337;
