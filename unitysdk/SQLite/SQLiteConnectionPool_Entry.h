...
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A074A10)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_GET_CONNECTIONSTRING_OFFSET UNITYSDK_OFFSET(0x1A074BE0)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_GET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x1A074BC0)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_GET_TRANSACTIONLOCK_OFFSET UNITYSDK_OFFSET(0x1A074BF0)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_SET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x1A074BD0)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0748E0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnectionPool_Entry_TypeDefinitionIndex = 35333;
