...
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_CLOSE_OFFSET UNITYSDK_OFFSET(0x1A640830)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_GET_CONNECTIONSTRING_OFFSET UNITYSDK_OFFSET(0x1A640A00)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_GET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x1A6409E0)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_GET_TRANSACTIONLOCK_OFFSET UNITYSDK_OFFSET(0x1A640A10)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY_SET_CONNECTION_OFFSET UNITYSDK_OFFSET(0x1A6409F0)
#define SQLITE_SQLITECONNECTIONPOOL_ENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A640700)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnectionPool_Entry_TypeDefinitionIndex = 36335;
