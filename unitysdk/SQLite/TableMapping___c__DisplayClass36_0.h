...
#define SQLITE_TABLEMAPPING___C__DISPLAYCLASS36_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A075E70)
#define SQLITE_TABLEMAPPING___C__DISPLAYCLASS36_0__GETPUBLICMEMBERS_B__0_OFFSET UNITYSDK_OFFSET(0x1A076190)

namespace SQLite
{
	inline static constexpr unsigned int TableMapping___c__DisplayClass36_0_TypeDefinitionIndex = 35241;
