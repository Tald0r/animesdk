...
#define SQLITE_SQLITECONNECTION_COLUMNINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A640640)
#define SQLITE_SQLITECONNECTION_COLUMNINFO_GET_NOTNULL_OFFSET UNITYSDK_OFFSET(0x1A640660)
#define SQLITE_SQLITECONNECTION_COLUMNINFO_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A640650)
#define SQLITE_SQLITECONNECTION_COLUMNINFO_SET_NOTNULL_OFFSET UNITYSDK_OFFSET(0x1A640670)
#define SQLITE_SQLITECONNECTION_COLUMNINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A640680)
#define SQLITE_SQLITECONNECTION_COLUMNINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A640690)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnection_ColumnInfo_TypeDefinitionIndex = 36215;
