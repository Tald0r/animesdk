...
#define SQLITE_SQLITECONNECTION_COLUMNINFO_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A074820)
#define SQLITE_SQLITECONNECTION_COLUMNINFO_GET_NOTNULL_OFFSET UNITYSDK_OFFSET(0x1A074840)
#define SQLITE_SQLITECONNECTION_COLUMNINFO_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A074830)
#define SQLITE_SQLITECONNECTION_COLUMNINFO_SET_NOTNULL_OFFSET UNITYSDK_OFFSET(0x1A074850)
#define SQLITE_SQLITECONNECTION_COLUMNINFO_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A074860)
#define SQLITE_SQLITECONNECTION_COLUMNINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1A074870)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnection_ColumnInfo_TypeDefinitionIndex = 35213;
