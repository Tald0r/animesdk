...
#define SQLITE_FASTCOLUMNSETTER_GETFASTSETTERMETHODINFOUNSAFE_OFFSET UNITYSDK_OFFSET(0x1A064020)
#define SQLITE_FASTCOLUMNSETTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0641A0)

namespace SQLite
{
	inline static constexpr unsigned int FastColumnSetter_TypeDefinitionIndex = 35253;
