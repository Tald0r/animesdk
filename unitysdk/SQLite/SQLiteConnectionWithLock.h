...
#define SQLITE_SQLITECONNECTIONWITHLOCK_GET_SKIPLOCK_OFFSET UNITYSDK_OFFSET(0x1A074E30)
#define SQLITE_SQLITECONNECTIONWITHLOCK_LOCK_OFFSET UNITYSDK_OFFSET(0x1A074E50)
#define SQLITE_SQLITECONNECTIONWITHLOCK_SET_SKIPLOCK_OFFSET UNITYSDK_OFFSET(0x1A074E40)
#define SQLITE_SQLITECONNECTIONWITHLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A074C00)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnectionWithLock_TypeDefinitionIndex = 35334;
