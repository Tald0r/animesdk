...
#define SQLITE_SQLITECONNECTIONWITHLOCK_GET_SKIPLOCK_OFFSET UNITYSDK_OFFSET(0x1A640C50)
#define SQLITE_SQLITECONNECTIONWITHLOCK_LOCK_OFFSET UNITYSDK_OFFSET(0x1A640C70)
#define SQLITE_SQLITECONNECTIONWITHLOCK_SET_SKIPLOCK_OFFSET UNITYSDK_OFFSET(0x1A640C60)
#define SQLITE_SQLITECONNECTIONWITHLOCK__CTOR_OFFSET UNITYSDK_OFFSET(0x1A640A20)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteConnectionWithLock_TypeDefinitionIndex = 36336;
