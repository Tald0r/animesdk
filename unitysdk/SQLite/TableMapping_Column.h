...
#define SQLITE_TABLEMAPPING_COLUMN_GETMEMBERTYPE_OFFSET UNITYSDK_OFFSET(0x1A076620)
#define SQLITE_TABLEMAPPING_COLUMN_GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A064720)
#define SQLITE_TABLEMAPPING_COLUMN_GET_COLLATION_OFFSET UNITYSDK_OFFSET(0x1A0764E0)
#define SQLITE_TABLEMAPPING_COLUMN_GET_COLUMNTYPE_OFFSET UNITYSDK_OFFSET(0x1A0764C0)
#define SQLITE_TABLEMAPPING_COLUMN_GET_FALLBACKVALUE_OFFSET UNITYSDK_OFFSET(0x1A076600)
#define SQLITE_TABLEMAPPING_COLUMN_GET_INDICES_OFFSET UNITYSDK_OFFSET(0x1A076560)
#define SQLITE_TABLEMAPPING_COLUMN_GET_ISAUTOGUID_OFFSET UNITYSDK_OFFSET(0x1A076520)
#define SQLITE_TABLEMAPPING_COLUMN_GET_ISAUTOINC_OFFSET UNITYSDK_OFFSET(0x1A076500)
#define SQLITE_TABLEMAPPING_COLUMN_GET_ISFALLBACKONERROR_OFFSET UNITYSDK_OFFSET(0x1A0765E0)
#define SQLITE_TABLEMAPPING_COLUMN_GET_ISNULLABLE_OFFSET UNITYSDK_OFFSET(0x1A076580)
#define SQLITE_TABLEMAPPING_COLUMN_GET_ISPK_OFFSET UNITYSDK_OFFSET(0x1A076540)
#define SQLITE_TABLEMAPPING_COLUMN_GET_MAXSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1A0765A0)
#define SQLITE_TABLEMAPPING_COLUMN_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A076460)
#define SQLITE_TABLEMAPPING_COLUMN_GET_PROPERTYINFO_OFFSET UNITYSDK_OFFSET(0x1A076480)
#define SQLITE_TABLEMAPPING_COLUMN_GET_PROPERTYNAME_OFFSET UNITYSDK_OFFSET(0x1A0763B0)
#define SQLITE_TABLEMAPPING_COLUMN_GET_STOREASTEXT_OFFSET UNITYSDK_OFFSET(0x1A0765C0)
#define SQLITE_TABLEMAPPING_COLUMN_SETVALUE_OFFSET UNITYSDK_OFFSET(0x1A072380)
#define SQLITE_TABLEMAPPING_COLUMN_SET_COLLATION_OFFSET UNITYSDK_OFFSET(0x1A0764F0)
#define SQLITE_TABLEMAPPING_COLUMN_SET_COLUMNTYPE_OFFSET UNITYSDK_OFFSET(0x1A0764D0)
#define SQLITE_TABLEMAPPING_COLUMN_SET_FALLBACKVALUE_OFFSET UNITYSDK_OFFSET(0x1A076610)
#define SQLITE_TABLEMAPPING_COLUMN_SET_INDICES_OFFSET UNITYSDK_OFFSET(0x1A076570)
#define SQLITE_TABLEMAPPING_COLUMN_SET_ISAUTOGUID_OFFSET UNITYSDK_OFFSET(0x1A076530)
#define SQLITE_TABLEMAPPING_COLUMN_SET_ISAUTOINC_OFFSET UNITYSDK_OFFSET(0x1A076510)
#define SQLITE_TABLEMAPPING_COLUMN_SET_ISFALLBACKONERROR_OFFSET UNITYSDK_OFFSET(0x1A0765F0)
#define SQLITE_TABLEMAPPING_COLUMN_SET_ISNULLABLE_OFFSET UNITYSDK_OFFSET(0x1A076590)
#define SQLITE_TABLEMAPPING_COLUMN_SET_ISPK_OFFSET UNITYSDK_OFFSET(0x1A076550)
#define SQLITE_TABLEMAPPING_COLUMN_SET_MAXSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1A0765B0)
#define SQLITE_TABLEMAPPING_COLUMN_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A076470)
#define SQLITE_TABLEMAPPING_COLUMN_SET_STOREASTEXT_OFFSET UNITYSDK_OFFSET(0x1A0765D0)
#define SQLITE_TABLEMAPPING_COLUMN__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A076720)
#define SQLITE_TABLEMAPPING_COLUMN__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0758F0)

namespace SQLite
{
	inline static constexpr unsigned int TableMapping_Column_TypeDefinitionIndex = 35237;

	class TableMapping_Column : public ::System::Object
	{
	public:
		::System::Object* _FallbackValue_k__BackingField; // 0x10
		::System::Type* _ColumnType_k__BackingField; // 0x18
		::System::String* _Collation_k__BackingField; // 0x20
		::System::Collections::Generic::IEnumerable_1<::SQLite::IndexedAttribute*>* _Indices_k__BackingField; // 0x28
		...
		::System::Boolean _IsAutoGuid_k__BackingField; // 0x43
		::System::Boolean _StoreAsText_k__BackingField; // 0x44
		::System::Boolean _IsPK_k__BackingField; // 0x45
