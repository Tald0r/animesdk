...
#define SQLITE_NOTIFYTABLECHANGEDEVENTARGS_GET_ACTION_OFFSET UNITYSDK_OFFSET(0x1A630660)
#define SQLITE_NOTIFYTABLECHANGEDEVENTARGS_GET_TABLE_OFFSET UNITYSDK_OFFSET(0x1A630640)
#define SQLITE_NOTIFYTABLECHANGEDEVENTARGS_SET_ACTION_OFFSET UNITYSDK_OFFSET(0x1A630670)
#define SQLITE_NOTIFYTABLECHANGEDEVENTARGS_SET_TABLE_OFFSET UNITYSDK_OFFSET(0x1A630650)
#define SQLITE_NOTIFYTABLECHANGEDEVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1A630680)

namespace SQLite
{
	inline static constexpr unsigned int NotifyTableChangedEventArgs_TypeDefinitionIndex = 36222;
