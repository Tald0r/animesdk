...
#define SQLITE_TABLEATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A075170)
#define SQLITE_TABLEATTRIBUTE_GET_WITHOUTROWID_OFFSET UNITYSDK_OFFSET(0x1A075190)
#define SQLITE_TABLEATTRIBUTE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A075180)
#define SQLITE_TABLEATTRIBUTE_SET_WITHOUTROWID_OFFSET UNITYSDK_OFFSET(0x1A0751A0)
#define SQLITE_TABLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A0751B0)

namespace SQLite
{
	inline static constexpr unsigned int TableAttribute_TypeDefinitionIndex = 35223;
