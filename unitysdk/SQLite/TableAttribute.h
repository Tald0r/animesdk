...
#define SQLITE_TABLEATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A640F90)
#define SQLITE_TABLEATTRIBUTE_GET_WITHOUTROWID_OFFSET UNITYSDK_OFFSET(0x1A640FB0)
#define SQLITE_TABLEATTRIBUTE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A640FA0)
#define SQLITE_TABLEATTRIBUTE_SET_WITHOUTROWID_OFFSET UNITYSDK_OFFSET(0x1A640FC0)
#define SQLITE_TABLEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A640FD0)

namespace SQLite
{
	inline static constexpr unsigned int TableAttribute_TypeDefinitionIndex = 36225;
