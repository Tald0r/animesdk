...
#define SQLITE_FALLBACKVALUEATTRIBUTE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A62FE10)
#define SQLITE_FALLBACKVALUEATTRIBUTE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A62FE20)
#define SQLITE_FALLBACKVALUEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A62FE30)

namespace SQLite
{
	inline static constexpr unsigned int FallbackValueAttribute_TypeDefinitionIndex = 36236;
