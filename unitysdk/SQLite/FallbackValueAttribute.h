...
#define SQLITE_FALLBACKVALUEATTRIBUTE_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A063FF0)
#define SQLITE_FALLBACKVALUEATTRIBUTE_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x1A064000)
#define SQLITE_FALLBACKVALUEATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A064010)

namespace SQLite
{
	inline static constexpr unsigned int FallbackValueAttribute_TypeDefinitionIndex = 35234;
