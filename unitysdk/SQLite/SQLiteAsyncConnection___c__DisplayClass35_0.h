...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS35_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6334A0)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS35_0__ENABLELOADEXTENSIONASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1A6351F0)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass35_0_TypeDefinitionIndex = 36276;
