...
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS87_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A634B00)
#define SQLITE_SQLITEASYNCCONNECTION___C__DISPLAYCLASS87_0__DEFERREDQUERYASYNC_B__0_OFFSET UNITYSDK_OFFSET(0x1A63A630)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteAsyncConnection___c__DisplayClass87_0_TypeDefinitionIndex = 36323;
