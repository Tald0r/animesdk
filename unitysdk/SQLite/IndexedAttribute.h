...
#define SQLITE_INDEXEDATTRIBUTE_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A0641C0)
#define SQLITE_INDEXEDATTRIBUTE_GET_ORDER_OFFSET UNITYSDK_OFFSET(0x1A0641E0)
#define SQLITE_INDEXEDATTRIBUTE_GET_UNIQUE_OFFSET UNITYSDK_OFFSET(0x1A064200)
#define SQLITE_INDEXEDATTRIBUTE_SET_NAME_OFFSET UNITYSDK_OFFSET(0x1A0641D0)
#define SQLITE_INDEXEDATTRIBUTE_SET_ORDER_OFFSET UNITYSDK_OFFSET(0x1A0641F0)
#define SQLITE_INDEXEDATTRIBUTE_SET_UNIQUE_OFFSET UNITYSDK_OFFSET(0x1A064210)
#define SQLITE_INDEXEDATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A064230)
#define SQLITE_INDEXEDATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A064220)

namespace SQLite
{
	inline static constexpr unsigned int IndexedAttribute_TypeDefinitionIndex = 35227;
