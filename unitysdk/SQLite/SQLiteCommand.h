...
#define SQLITE_SQLITECOMMAND_BINDALL_OFFSET UNITYSDK_OFFSET(0x1A06F330)
#define SQLITE_SQLITECOMMAND_BINDPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A065C80)
#define SQLITE_SQLITECOMMAND_BIND_1_OFFSET UNITYSDK_OFFSET(0x1A06F020)
#define SQLITE_SQLITECOMMAND_BIND_OFFSET UNITYSDK_OFFSET(0x1A06EF90)
#define SQLITE_SQLITECOMMAND_EXECUTENONQUERY_OFFSET UNITYSDK_OFFSET(0x1A06ECE0)
#define SQLITE_SQLITECOMMAND_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A06EF70)
#define SQLITE_SQLITECOMMAND_GET_COMMANDTEXT_OFFSET UNITYSDK_OFFSET(0x1A06EC30)
#define SQLITE_SQLITECOMMAND_ONINSTANCECREATED_OFFSET UNITYSDK_OFFSET(0x1A06EF80)
#define SQLITE_SQLITECOMMAND_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A06EEC0)
#define SQLITE_SQLITECOMMAND_READCOL_OFFSET UNITYSDK_OFFSET(0x1A06F520)
#define SQLITE_SQLITECOMMAND_SET_COMMANDTEXT_OFFSET UNITYSDK_OFFSET(0x1A06EC40)
#define SQLITE_SQLITECOMMAND_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A06F0A0)
#define SQLITE_SQLITECOMMAND__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A070130)
#define SQLITE_SQLITECOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1A06EC50)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteCommand_TypeDefinitionIndex = 35249;
	...
	public:
		...
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(SQLiteCommand_TypeDefinitionIndex)->GetStaticField(0x8530);
		}
		::SQLite::SQLiteConnection* _conn; // 0x10
		::System::String* _CommandText_k__BackingField; // 0x18
