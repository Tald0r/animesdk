...
#define SQLITE_SQLITECOMMAND_BINDALL_OFFSET UNITYSDK_OFFSET(0x1A63B140)
#define SQLITE_SQLITECOMMAND_BINDPARAMETER_OFFSET UNITYSDK_OFFSET(0x1A631AA0)
#define SQLITE_SQLITECOMMAND_BIND_1_OFFSET UNITYSDK_OFFSET(0x1A63AE30)
#define SQLITE_SQLITECOMMAND_BIND_OFFSET UNITYSDK_OFFSET(0x1A63ADA0)
#define SQLITE_SQLITECOMMAND_EXECUTENONQUERY_OFFSET UNITYSDK_OFFSET(0x1A63AAF0)
#define SQLITE_SQLITECOMMAND_FINALIZE_OFFSET UNITYSDK_OFFSET(0x1A63AD80)
#define SQLITE_SQLITECOMMAND_GET_COMMANDTEXT_OFFSET UNITYSDK_OFFSET(0x1A63AA40)
#define SQLITE_SQLITECOMMAND_ONINSTANCECREATED_OFFSET UNITYSDK_OFFSET(0x1A63AD90)
#define SQLITE_SQLITECOMMAND_PREPARE_OFFSET UNITYSDK_OFFSET(0x1A63ACD0)
#define SQLITE_SQLITECOMMAND_READCOL_OFFSET UNITYSDK_OFFSET(0x1A63B330)
#define SQLITE_SQLITECOMMAND_SET_COMMANDTEXT_OFFSET UNITYSDK_OFFSET(0x1A63AA50)
#define SQLITE_SQLITECOMMAND_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1A63AEB0)
#define SQLITE_SQLITECOMMAND__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A63BF40)
#define SQLITE_SQLITECOMMAND__CTOR_OFFSET UNITYSDK_OFFSET(0x1A63AA60)

namespace SQLite
{
	inline static constexpr unsigned int SQLiteCommand_TypeDefinitionIndex = 36251;
	...
	public:
		...
		{
			return (::System::IntPtr*)Il2CppClass::FromTypeDefinitionIndex(SQLiteCommand_TypeDefinitionIndex)->GetStaticField(0x8890);
		}
