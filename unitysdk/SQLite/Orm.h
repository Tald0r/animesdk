...
#define SQLITE_ORM_COLLATION_OFFSET UNITYSDK_OFFSET(0x1A630E60)
#define SQLITE_ORM_FALLBACKVALUE_OFFSET UNITYSDK_OFFSET(0x1A631490)
#define SQLITE_ORM_GETFIELD_OFFSET UNITYSDK_OFFSET(0x1A630FD0)
#define SQLITE_ORM_GETINDICES_OFFSET UNITYSDK_OFFSET(0x1A631170)
#define SQLITE_ORM_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A631080)
#define SQLITE_ORM_GETTYPE_OFFSET UNITYSDK_OFFSET(0x1A6306C0)
#define SQLITE_ORM_INFLATEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A631130)
#define SQLITE_ORM_ISAUTOINC_OFFSET UNITYSDK_OFFSET(0x1A630EC0)
#define SQLITE_ORM_ISFALLBACKONERROR_OFFSET UNITYSDK_OFFSET(0x1A631380)
#define SQLITE_ORM_ISMARKEDNOTNULL_OFFSET UNITYSDK_OFFSET(0x1A631270)
#define SQLITE_ORM_ISPK_OFFSET UNITYSDK_OFFSET(0x1A630D50)
#define SQLITE_ORM_MAXSTRINGLENGTH_1_OFFSET UNITYSDK_OFFSET(0x1A631210)
#define SQLITE_ORM_MAXSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1A6311B0)
#define SQLITE_ORM_SQLDECL_OFFSET UNITYSDK_OFFSET(0x1A630730)
#define SQLITE_ORM_SQLTYPE_OFFSET UNITYSDK_OFFSET(0x1A6308F0)

namespace SQLite
{
	inline static constexpr unsigned int Orm_TypeDefinitionIndex = 36249;
