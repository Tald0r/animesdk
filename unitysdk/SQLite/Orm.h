...
#define SQLITE_ORM_COLLATION_OFFSET UNITYSDK_OFFSET(0x1A065040)
#define SQLITE_ORM_FALLBACKVALUE_OFFSET UNITYSDK_OFFSET(0x1A065670)
#define SQLITE_ORM_GETFIELD_OFFSET UNITYSDK_OFFSET(0x1A0651B0)
#define SQLITE_ORM_GETINDICES_OFFSET UNITYSDK_OFFSET(0x1A065350)
#define SQLITE_ORM_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A065260)
#define SQLITE_ORM_GETTYPE_OFFSET UNITYSDK_OFFSET(0x1A0648A0)
#define SQLITE_ORM_INFLATEATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A065310)
#define SQLITE_ORM_ISAUTOINC_OFFSET UNITYSDK_OFFSET(0x1A0650A0)
#define SQLITE_ORM_ISFALLBACKONERROR_OFFSET UNITYSDK_OFFSET(0x1A065560)
#define SQLITE_ORM_ISMARKEDNOTNULL_OFFSET UNITYSDK_OFFSET(0x1A065450)
#define SQLITE_ORM_ISPK_OFFSET UNITYSDK_OFFSET(0x1A064F30)
#define SQLITE_ORM_MAXSTRINGLENGTH_1_OFFSET UNITYSDK_OFFSET(0x1A0653F0)
#define SQLITE_ORM_MAXSTRINGLENGTH_OFFSET UNITYSDK_OFFSET(0x1A065390)
#define SQLITE_ORM_SQLDECL_OFFSET UNITYSDK_OFFSET(0x1A064910)
#define SQLITE_ORM_SQLTYPE_OFFSET UNITYSDK_OFFSET(0x1A064AD0)

namespace SQLite
{
	inline static constexpr unsigned int Orm_TypeDefinitionIndex = 35247;
