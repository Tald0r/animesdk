...
#define CLASS_1_9F5A8B721785BBD2_METHOD_1_0BE1846AC20D43BE_OFFSET UNITYSDK_OFFSET(0x908B1E0)
#define CLASS_1_9F5A8B721785BBD2_METHOD_1_7335620F26BD6231_OFFSET UNITYSDK_OFFSET(0x908B420)
#define CLASS_1_9F5A8B721785BBD2_METHOD_1_A8AE4A9A45E37F95_OFFSET UNITYSDK_OFFSET(0x908B0D0)
#define CLASS_1_9F5A8B721785BBD2_METHOD_1_B22B4FDB2488C35A_OFFSET UNITYSDK_OFFSET(0x908B550)

inline static constexpr unsigned int Class_1_9F5A8B721785BBD2_TypeDefinitionIndex = 69112;
...
public:
	...
	{
		return (::System::Collections::Generic::List_1<::MoleMole::Config::HitEffectConfigAnimatorBeHitPriority*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9F5A8B721785BBD2_TypeDefinitionIndex)->GetStaticField(0x37470);
	}
	static ::System::Collections::Generic::List_1<::MoleMole::Config::BaseConfigAnimatorBeHitPriority*>** StaticGet_Field_1_1()
	{
		return (::System::Collections::Generic::List_1<::MoleMole::Config::BaseConfigAnimatorBeHitPriority*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9F5A8B721785BBD2_TypeDefinitionIndex)->GetStaticField(0x37478);
	}
	static ::MoleMole::Config::ConfigAnimatorBeHitPriorities** StaticGet_Field_1_0()
	{
		return (::MoleMole::Config::ConfigAnimatorBeHitPriorities**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9F5A8B721785BBD2_TypeDefinitionIndex)->GetStaticField(0x37480);
	}
	...
	{
		return (::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::Config::TagConfigAnimatorBeHitPriority*>**)Il2CppClass::FromTypeDefinitionIndex(Class_1_9F5A8B721785BBD2_TypeDefinitionIndex)->GetStaticField(0x37488);
	}
