...
#define LYRAGIPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x186412F0)
#define LYRAGIPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x18641570)
#define LYRAGIPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x186415E0)
#define LYRAGIPASS_UPDATEBAKEDCLIPMAP_OFFSET UNITYSDK_OFFSET(0x18641340)
#define LYRAGIPASS_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x18641440)
#define LYRAGIPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x18641260)
#define LYRAGIPASS___BASE_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x18641630)
#define LYRAGIPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x18641640)

inline static constexpr unsigned int LyraGIPass_TypeDefinitionIndex = 29093;
