...
#define LYRAGIPASS_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1801F5B0)
#define LYRAGIPASS_EXECUTE_OFFSET UNITYSDK_OFFSET(0x1801F830)
#define LYRAGIPASS_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1801F8A0)
#define LYRAGIPASS_UPDATEBAKEDCLIPMAP_OFFSET UNITYSDK_OFFSET(0x1801F600)
#define LYRAGIPASS_VISUALIZE_OFFSET UNITYSDK_OFFSET(0x1801F700)
#define LYRAGIPASS__CTOR_OFFSET UNITYSDK_OFFSET(0x1801F520)
#define LYRAGIPASS___BASE_CONFIGURE_OFFSET UNITYSDK_OFFSET(0x1801F8F0)
#define LYRAGIPASS___BASE_FRAMECLEANUP_OFFSET UNITYSDK_OFFSET(0x1801F900)

inline static constexpr unsigned int LyraGIPass_TypeDefinitionIndex = 28152;
