...
#define STRUCT_2_2D47C7A2C6B7C7A0_EQUALS_OFFSET UNITYSDK_OFFSET(0x321660)
#define STRUCT_2_2D47C7A2C6B7C7A0_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x3216E0)

inline static constexpr unsigned int Struct_2_2D47C7A2C6B7C7A0_TypeDefinitionIndex = 71319;
