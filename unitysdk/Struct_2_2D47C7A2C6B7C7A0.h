...
#define STRUCT_2_2D47C7A2C6B7C7A0_EQUALS_OFFSET UNITYSDK_OFFSET(0x309D40)
#define STRUCT_2_2D47C7A2C6B7C7A0_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x309DC0)

inline static constexpr unsigned int Struct_2_2D47C7A2C6B7C7A0_TypeDefinitionIndex = 78673;
