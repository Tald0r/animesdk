...
#define ARRAYPROPERTYDATA_OP_IMPLICIT_OFFSET UNITYSDK_OFFSET(0x1794D4C0)

inline static constexpr unsigned int ArrayPropertyData_TypeDefinitionIndex = 28129;
