...
#define AKSPATIALAUDIOEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B57AF90)

inline static constexpr unsigned int AkSpatialAudioEmitter_TypeDefinitionIndex = 31094;
