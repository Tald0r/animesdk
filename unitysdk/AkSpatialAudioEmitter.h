...
#define AKSPATIALAUDIOEMITTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF571A0)

inline static constexpr unsigned int AkSpatialAudioEmitter_TypeDefinitionIndex = 30141;
