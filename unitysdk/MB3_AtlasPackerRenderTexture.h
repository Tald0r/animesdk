...
#define MB3_ATLASPACKERRENDERTEXTURE_ONRENDERATLAS_OFFSET UNITYSDK_OFFSET(0x1AACE6A0)
#define MB3_ATLASPACKERRENDERTEXTURE_ONRENDEROBJECT_OFFSET UNITYSDK_OFFSET(0x1AACE7A0)
#define MB3_ATLASPACKERRENDERTEXTURE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AACE7D0)

inline static constexpr unsigned int MB3_AtlasPackerRenderTexture_TypeDefinitionIndex = 81216;
