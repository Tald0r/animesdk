...
#define RVO_RVOMATH_ABSSQ_OFFSET UNITYSDK_OFFSET(0x1A676E40)
#define RVO_RVOMATH_ABS_OFFSET UNITYSDK_OFFSET(0x1A676FA0)
#define RVO_RVOMATH_DET_OFFSET UNITYSDK_OFFSET(0x1A676E10)
#define RVO_RVOMATH_DISTSQPOINTLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x1A679360)
#define RVO_RVOMATH_FABS_OFFSET UNITYSDK_OFFSET(0x1A67A2C0)
#define RVO_RVOMATH_LEFTOF_OFFSET UNITYSDK_OFFSET(0x1A67CE80)
#define RVO_RVOMATH_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1A676EB0)
#define RVO_RVOMATH_SQRT_OFFSET UNITYSDK_OFFSET(0x1A676F20)
#define RVO_RVOMATH_SQR_OFFSET UNITYSDK_OFFSET(0x1A675060)

namespace RVO
{
	inline static constexpr unsigned int RVOMath_TypeDefinitionIndex = 34914;
