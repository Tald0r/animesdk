...
#define RVO_RVOMATH_ABSSQ_OFFSET UNITYSDK_OFFSET(0x1AC22140)
#define RVO_RVOMATH_ABS_OFFSET UNITYSDK_OFFSET(0x1AC222A0)
#define RVO_RVOMATH_DET_OFFSET UNITYSDK_OFFSET(0x1AC22110)
#define RVO_RVOMATH_DISTSQPOINTLINESEGMENT_OFFSET UNITYSDK_OFFSET(0x1AC24660)
#define RVO_RVOMATH_FABS_OFFSET UNITYSDK_OFFSET(0x1AC255C0)
#define RVO_RVOMATH_LEFTOF_OFFSET UNITYSDK_OFFSET(0x1AC28180)
#define RVO_RVOMATH_NORMALIZE_OFFSET UNITYSDK_OFFSET(0x1AC221B0)
#define RVO_RVOMATH_SQRT_OFFSET UNITYSDK_OFFSET(0x1AC22220)
#define RVO_RVOMATH_SQR_OFFSET UNITYSDK_OFFSET(0x1AC20360)

namespace RVO
{
	inline static constexpr unsigned int RVOMath_TypeDefinitionIndex = 35916;
