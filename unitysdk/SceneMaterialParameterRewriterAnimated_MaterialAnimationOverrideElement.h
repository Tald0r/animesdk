...
#define SCENEMATERIALPARAMETERREWRITERANIMATED_MATERIALANIMATIONOVERRIDEELEMENT_INIT_OFFSET UNITYSDK_OFFSET(0x17BED6C0)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_MATERIALANIMATIONOVERRIDEELEMENT_SETMPB_OFFSET UNITYSDK_OFFSET(0x17BED780)
#define SCENEMATERIALPARAMETERREWRITERANIMATED_MATERIALANIMATIONOVERRIDEELEMENT__CTOR_OFFSET UNITYSDK_OFFSET(0x17BED890)

inline static constexpr unsigned int SceneMaterialParameterRewriterAnimated_MaterialAnimationOverrideElement_TypeDefinitionIndex = 28031;
