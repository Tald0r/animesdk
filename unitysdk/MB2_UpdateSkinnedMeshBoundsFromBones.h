...
#define MB2_UPDATESKINNEDMESHBOUNDSFROMBONES_START_OFFSET UNITYSDK_OFFSET(0x1A386120)
#define MB2_UPDATESKINNEDMESHBOUNDSFROMBONES_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A386320)
#define MB2_UPDATESKINNEDMESHBOUNDSFROMBONES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3863A0)

inline static constexpr unsigned int MB2_UpdateSkinnedMeshBoundsFromBones_TypeDefinitionIndex = 81190;
