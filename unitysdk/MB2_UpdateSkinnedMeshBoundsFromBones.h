...
#define MB2_UPDATESKINNEDMESHBOUNDSFROMBONES_START_OFFSET UNITYSDK_OFFSET(0x1A959140)
#define MB2_UPDATESKINNEDMESHBOUNDSFROMBONES_UPDATE_OFFSET UNITYSDK_OFFSET(0x1A959340)
#define MB2_UPDATESKINNEDMESHBOUNDSFROMBONES__CTOR_OFFSET UNITYSDK_OFFSET(0x1A9593C0)

inline static constexpr unsigned int MB2_UpdateSkinnedMeshBoundsFromBones_TypeDefinitionIndex = 83231;
