...
#define PARTICLESYSTEMCOUNTER_AWAKE_OFFSET UNITYSDK_OFFSET(0x16C36600)
#define PARTICLESYSTEMCOUNTER_CLOSECANVAS_OFFSET UNITYSDK_OFFSET(0x16C393F0)
#define PARTICLESYSTEMCOUNTER_COUNTANDDISPLAYPARTICLESYSTEMS_OFFSET UNITYSDK_OFFSET(0x16C36FC0)
#define PARTICLESYSTEMCOUNTER_CREATEEXPORTBUTTON_OFFSET UNITYSDK_OFFSET(0x16C37550)
#define PARTICLESYSTEMCOUNTER_ENSUREUIINITIALIZED_OFFSET UNITYSDK_OFFSET(0x16C36A60)
#define PARTICLESYSTEMCOUNTER_EXPORTPARTICLESYSTEMS_OFFSET UNITYSDK_OFFSET(0x16C39380)
#define PARTICLESYSTEMCOUNTER_GETGAMEOBJECTPATH_OFFSET UNITYSDK_OFFSET(0x16C390B0)
#define PARTICLESYSTEMCOUNTER_GET_INSTANCE_OFFSET UNITYSDK_OFFSET(0x16C363B0)
#define PARTICLESYSTEMCOUNTER_OPENORCLOSEPARTICLESYSTEMCOUNTER_OFFSET UNITYSDK_OFFSET(0x16C391F0)
#define PARTICLESYSTEMCOUNTER_SAVEPARTICLESYSTEMSTOFILE_OFFSET UNITYSDK_OFFSET(0x16C37EE0)
#define PARTICLESYSTEMCOUNTER_TOGGLECOUNTER_OFFSET UNITYSDK_OFFSET(0x16C39310)
#define PARTICLESYSTEMCOUNTER_UPDATE_OFFSET UNITYSDK_OFFSET(0x16C368D0)
#define PARTICLESYSTEMCOUNTER__CTOR_OFFSET UNITYSDK_OFFSET(0x16C39520)

inline static constexpr unsigned int ParticleSystemCounter_TypeDefinitionIndex = 42894;
...
public:
	...
	{
		return (::ParticleSystemCounter**)Il2CppClass::FromTypeDefinitionIndex(ParticleSystemCounter_TypeDefinitionIndex)->GetStaticField(0x40680);
	}
