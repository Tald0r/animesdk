...
#define IL2CPPCLASS_FROMTYPEDEFINITIONINDEX_OFFSET UNITYSDK_OFFSET(0x23C2A0)
#define IL2CPPCLASS_NAME_OFFSET UNITYSDK_OFFSET(0x70)
#define IL2CPPCLASS_GETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x2312D0)
#define IL2CPPCLASS_GETPARENT_OFFSET UNITYSDK_OFFSET(0x9B2340)
#define STATICFIELDSPOOL_OFFSET UNITYSDK_OFFSET(0x49BF608)
