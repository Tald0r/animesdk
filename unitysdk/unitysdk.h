...
#define IL2CPPCLASS_FROMTYPEDEFINITIONINDEX_OFFSET UNITYSDK_OFFSET(0x2352F0)
#define IL2CPPCLASS_NAME_OFFSET UNITYSDK_OFFSET(0x70)
#define IL2CPPCLASS_GETNAMESPACE_OFFSET UNITYSDK_OFFSET(0x22A250)
#define IL2CPPCLASS_GETPARENT_OFFSET UNITYSDK_OFFSET(0x97C990)
#define STATICFIELDSPOOL_OFFSET UNITYSDK_OFFSET(0x4885C60)
