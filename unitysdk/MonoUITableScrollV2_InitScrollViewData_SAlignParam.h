...
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0xAD012A0)
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_KEEPCUSTOMDATAPOSITION_OFFSET UNITYSDK_OFFSET(0xAD01140)
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_KEEPCUSTOMITEMPOSITION_OFFSET UNITYSDK_OFFSET(0xAD01080)
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_KEEPSELECTEDITEMPOSITION_OFFSET UNITYSDK_OFFSET(0xAD00FD0)
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_RESETTOSTART_OFFSET UNITYSDK_OFFSET(0xAD011F0)

inline static constexpr unsigned int MonoUITableScrollV2_InitScrollViewData_SAlignParam_TypeDefinitionIndex = 43818;
