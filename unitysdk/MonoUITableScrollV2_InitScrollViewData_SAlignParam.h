...
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_GET_EMPTY_OFFSET UNITYSDK_OFFSET(0x9A33AD0)
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_KEEPCUSTOMDATAPOSITION_OFFSET UNITYSDK_OFFSET(0x9A33970)
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_KEEPCUSTOMITEMPOSITION_OFFSET UNITYSDK_OFFSET(0x9A338B0)
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_KEEPSELECTEDITEMPOSITION_OFFSET UNITYSDK_OFFSET(0x9A33800)
#define MONOUITABLESCROLLV2_INITSCROLLVIEWDATA_SALIGNPARAM_RESETTOSTART_OFFSET UNITYSDK_OFFSET(0x9A33A20)

inline static constexpr unsigned int MonoUITableScrollV2_InitScrollViewData_SAlignParam_TypeDefinitionIndex = 64461;
