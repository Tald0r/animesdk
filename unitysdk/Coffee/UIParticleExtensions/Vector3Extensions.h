...
#define COFFEE_UIPARTICLEEXTENSIONS_VECTOR3EXTENSIONS_GETSCALED_1_OFFSET UNITYSDK_OFFSET(0x1A1C6E00)
#define COFFEE_UIPARTICLEEXTENSIONS_VECTOR3EXTENSIONS_GETSCALED_2_OFFSET UNITYSDK_OFFSET(0x1A1CBA70)
#define COFFEE_UIPARTICLEEXTENSIONS_VECTOR3EXTENSIONS_GETSCALED_OFFSET UNITYSDK_OFFSET(0x1A1BC7F0)
#define COFFEE_UIPARTICLEEXTENSIONS_VECTOR3EXTENSIONS_INVERSE_OFFSET UNITYSDK_OFFSET(0x1A1C0590)
#define COFFEE_UIPARTICLEEXTENSIONS_VECTOR3EXTENSIONS_ISVISIBLE_OFFSET UNITYSDK_OFFSET(0x1A1C9D10)

namespace Coffee::UIParticleExtensions
{
	inline static constexpr unsigned int Vector3Extensions_TypeDefinitionIndex = 31178;
