...
#define COFFEE_UIPARTICLEEXTENSIONS_SPRITEEXTENSIONS_GETACTUALTEXTURE_OFFSET UNITYSDK_OFFSET(0x1A74B580)

namespace Coffee::UIParticleExtensions
{
	inline static constexpr unsigned int SpriteExtensions_TypeDefinitionIndex = 32131;
