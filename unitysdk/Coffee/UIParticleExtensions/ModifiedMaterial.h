...
#define COFFEE_UIPARTICLEEXTENSIONS_MODIFIEDMATERIAL_ADD_OFFSET UNITYSDK_OFFSET(0x1A7469B0)
#define COFFEE_UIPARTICLEEXTENSIONS_MODIFIEDMATERIAL_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A745AE0)
#define COFFEE_UIPARTICLEEXTENSIONS_MODIFIEDMATERIAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A74AC00)
#define COFFEE_UIPARTICLEEXTENSIONS_MODIFIEDMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A74ABF0)

namespace Coffee::UIParticleExtensions
{
	inline static constexpr unsigned int ModifiedMaterial_TypeDefinitionIndex = 32128;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Coffee::UIParticleExtensions::ModifiedMaterial_MatEntry*>**)Il2CppClass::FromTypeDefinitionIndex(ModifiedMaterial_TypeDefinitionIndex)->GetStaticField(0x25300);
		}
