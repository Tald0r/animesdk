...
#define COFFEE_UIPARTICLEEXTENSIONS_MODIFIEDMATERIAL_ADD_OFFSET UNITYSDK_OFFSET(0x1A1C94A0)
#define COFFEE_UIPARTICLEEXTENSIONS_MODIFIEDMATERIAL_REMOVE_OFFSET UNITYSDK_OFFSET(0x1A1C85D0)
#define COFFEE_UIPARTICLEEXTENSIONS_MODIFIEDMATERIAL__CCTOR_OFFSET UNITYSDK_OFFSET(0x1A1CD6F0)
#define COFFEE_UIPARTICLEEXTENSIONS_MODIFIEDMATERIAL__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1CD6E0)

namespace Coffee::UIParticleExtensions
{
	inline static constexpr unsigned int ModifiedMaterial_TypeDefinitionIndex = 31176;
	...
	public:
		...
		{
			return (::System::Collections::Generic::List_1<::Coffee::UIParticleExtensions::ModifiedMaterial_MatEntry*>**)Il2CppClass::FromTypeDefinitionIndex(ModifiedMaterial_TypeDefinitionIndex)->GetStaticField(0x239E0);
		}
