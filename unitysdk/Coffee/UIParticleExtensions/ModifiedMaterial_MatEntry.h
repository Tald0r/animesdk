...
#define COFFEE_UIPARTICLEEXTENSIONS_MODIFIEDMATERIAL_MATENTRY__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1CD6D0)

namespace Coffee::UIParticleExtensions
{
	inline static constexpr unsigned int ModifiedMaterial_MatEntry_TypeDefinitionIndex = 31177;
