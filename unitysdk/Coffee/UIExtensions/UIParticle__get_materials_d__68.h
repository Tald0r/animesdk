...
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A1C5420)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_UNITYENGINE_MATERIAL__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A1C5630)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_UNITYENGINE_MATERIAL__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A1C55C0)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1A1C56B0)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A1C5620)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A1C55D0)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A1C5410)
#define COFFEE_UIEXTENSIONS_UIPARTICLE__GET_MATERIALS_D__68__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1BC900)

namespace Coffee::UIExtensions
{
	inline static constexpr unsigned int UIParticle__get_materials_d__68_TypeDefinitionIndex = 31190;
