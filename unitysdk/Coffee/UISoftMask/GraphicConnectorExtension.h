...
#define COFFEE_UISOFTMASK_GRAPHICCONNECTOREXTENSION_SETMATERIALDIRTYEX_OFFSET UNITYSDK_OFFSET(0x1AE5E080)
#define COFFEE_UISOFTMASK_GRAPHICCONNECTOREXTENSION_SETVERTICESDIRTYEX_OFFSET UNITYSDK_OFFSET(0x1AE5E020)

namespace Coffee::UISoftMask
{
	inline static constexpr unsigned int GraphicConnectorExtension_TypeDefinitionIndex = 81153;
