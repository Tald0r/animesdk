...
#define PATHUTILS_FINDNEARESTPOINTSBYPATH_OFFSET UNITYSDK_OFFSET(0x10BAE7D0)
#define PATHUTILS_FINDSTRAIGHTPATH_OFFSET UNITYSDK_OFFSET(0x10BACF10)
#define PATHUTILS_PERP2D_OFFSET UNITYSDK_OFFSET(0x10BAC860)
#define PATHUTILS_RETRACEPORTALS_OFFSET UNITYSDK_OFFSET(0x10BAC990)
#define PATHUTILS_SWAP_OFFSET UNITYSDK_OFFSET(0x10BAC900)
#define PATHUTILS_TRYCALCULATEPATHLENGTH_OFFSET UNITYSDK_OFFSET(0x10BAECE0)
#define PATHUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x10BAF0E0)
#define PATHUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x10BAF0D0)

inline static constexpr unsigned int PathUtils_TypeDefinitionIndex = 77519;
...
public:
	...
	{
		return (::UnityEngine::AI::NavMeshPath**)Il2CppClass::FromTypeDefinitionIndex(PathUtils_TypeDefinitionIndex)->GetStaticField(0x3F700);
	}
