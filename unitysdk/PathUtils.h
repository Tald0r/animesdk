...
#define PATHUTILS_FINDNEARESTPOINTSBYPATH_OFFSET UNITYSDK_OFFSET(0x18DF14D0)
#define PATHUTILS_FINDSTRAIGHTPATH_OFFSET UNITYSDK_OFFSET(0x18DEFC10)
#define PATHUTILS_PERP2D_OFFSET UNITYSDK_OFFSET(0x18DEF560)
#define PATHUTILS_RETRACEPORTALS_OFFSET UNITYSDK_OFFSET(0x18DEF690)
#define PATHUTILS_SWAP_OFFSET UNITYSDK_OFFSET(0x18DEF600)
#define PATHUTILS_TRYCALCULATEPATHLENGTH_OFFSET UNITYSDK_OFFSET(0x18DF19E0)
#define PATHUTILS__CCTOR_OFFSET UNITYSDK_OFFSET(0x18DF1DE0)
#define PATHUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x18DF1DD0)

inline static constexpr unsigned int PathUtils_TypeDefinitionIndex = 40353;
...
public:
	...
	{
		return (::UnityEngine::AI::NavMeshPath**)Il2CppClass::FromTypeDefinitionIndex(PathUtils_TypeDefinitionIndex)->GetStaticField(0x3C8B0);
	}
