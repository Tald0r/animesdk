...
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ENTERGAME_OFFSET UNITYSDK_OFFSET(0x76A7FC0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_FORGETPASSWORD_OFFSET UNITYSDK_OFFSET(0x76A7890)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_GENENTRYCALLBACK_OFFSET UNITYSDK_OFFSET(0x76A7C80)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_INIT_OFFSET UNITYSDK_OFFSET(0x76A6290)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_INSTANCE_OFFSET UNITYSDK_OFFSET(0x76A5510)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ISREGISTERVISIBLE_OFFSET UNITYSDK_OFFSET(0x76A6D40)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONBTNCLOSE_OFFSET UNITYSDK_OFFSET(0x76A7D50)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONCLICKBACK_OFFSET UNITYSDK_OFFSET(0x76A7F20)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONCLOSE_OFFSET UNITYSDK_OFFSET(0x76A5710)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONCONSOLECANCEL_OFFSET UNITYSDK_OFFSET(0x76A8350)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONOPENLOGIN_OFFSET UNITYSDK_OFFSET(0x76A5D70)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONREGISTERACCOUNT_OFFSET UNITYSDK_OFFSET(0x76A79F0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONSHOW_OFFSET UNITYSDK_OFFSET(0x76A5BC0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_ONUILAYOUTPLATFORMCHANGED_OFFSET UNITYSDK_OFFSET(0x76A8510)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_REFRESHCONSOLERELATEUI_OFFSET UNITYSDK_OFFSET(0x76A6B20)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_REGISTER_OFFSET UNITYSDK_OFFSET(0x76A7930)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_RESET_OFFSET UNITYSDK_OFFSET(0x76A5850)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_SETPLATFORM_OFFSET UNITYSDK_OFFSET(0x76A6920)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_SETTHIRDLOGIN_OFFSET UNITYSDK_OFFSET(0x76A6E60)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA_UPDATE_OFFSET UNITYSDK_OFFSET(0x76A75D0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA__CCTOR_OFFSET UNITYSDK_OFFSET(0x76A8580)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA__CTOR_OFFSET UNITYSDK_OFFSET(0x76A5690)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA__INIT_B__9_0_OFFSET UNITYSDK_OFFSET(0x76A87E0)
#define CUSTOMSKIN_ACCOUNTLOGINOVERSEA__INIT_B__9_1_OFFSET UNITYSDK_OFFSET(0x76A8850)

inline static constexpr unsigned int CustomSkin_AccountLoginOversea_TypeDefinitionIndex = 77779;
...
public:
	...
	{
		return (::CustomSkin_AccountLoginOversea**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_AccountLoginOversea_TypeDefinitionIndex)->GetStaticField(0x3F940);
	}
	static ::Il2CppArray<::System::String*>** StaticGet_thirdEntryNameList()
	{
		return (::Il2CppArray<::System::String*>**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_AccountLoginOversea_TypeDefinitionIndex)->GetStaticField(0x3F948);
	}
	static ::Il2CppArray<::Foundation::AssetPath>** StaticGet_thirdEntryIconList()
	{
		return (::Il2CppArray<::Foundation::AssetPath>**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_AccountLoginOversea_TypeDefinitionIndex)->GetStaticField(0x3F950);
	}
	::MoleMole::UIGeneralSDKLoginDialogPopWindowController* _acctountPage; // 0x18
	::Class_2_79F6D62CE30E3F8E_23* _loginView; // 0x20
