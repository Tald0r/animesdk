...
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0xA0979D0)
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0xA0978C0)
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0xA097AD0)
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0xA097AE0)

inline static constexpr unsigned int MonoSceneMap3DConfig_LiftPosInfo_TypeDefinitionIndex = 57957;
