...
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x972B0E0)
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO_EQUALS_OFFSET UNITYSDK_OFFSET(0x9713410)
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x972B1E0)
#define MONOSCENEMAP3DCONFIG_LIFTPOSINFO___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x972B1F0)

inline static constexpr unsigned int MonoSceneMap3DConfig_LiftPosInfo_TypeDefinitionIndex = 47951;
