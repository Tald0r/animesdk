...
#define CUSTOMSKIN_OVERSEANEWDEVICEEMAILVERIFY__COUNTDOWN_D__16_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x6779D40)
#define CUSTOMSKIN_OVERSEANEWDEVICEEMAILVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x6779F20)
#define CUSTOMSKIN_OVERSEANEWDEVICEEMAILVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x6779F80)
#define CUSTOMSKIN_OVERSEANEWDEVICEEMAILVERIFY__COUNTDOWN_D__16_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x6779F30)
#define CUSTOMSKIN_OVERSEANEWDEVICEEMAILVERIFY__COUNTDOWN_D__16_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x6779D30)
#define CUSTOMSKIN_OVERSEANEWDEVICEEMAILVERIFY__COUNTDOWN_D__16__CTOR_OFFSET UNITYSDK_OFFSET(0x6779D20)

inline static constexpr unsigned int CustomSkin_OverseaNewDeviceEmailVerify__CountDown_d__16_TypeDefinitionIndex = 49010;
