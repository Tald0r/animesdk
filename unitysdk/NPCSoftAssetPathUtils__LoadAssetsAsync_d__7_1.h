...
inline static constexpr unsigned int NPCSoftAssetPathUtils__LoadAssetsAsync_d__7_1_TypeDefinitionIndex = 73728;

template <typename T>
struct NPCSoftAssetPathUtils__LoadAssetsAsync_d__7_1
{
