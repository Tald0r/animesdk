...
#define TAPTAP_SDK_QRCODEWINDOW__AUTOCHECK_D__38_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A7C9FD0)
#define TAPTAP_SDK_QRCODEWINDOW__AUTOCHECK_D__38_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7CA830)
#define TAPTAP_SDK_QRCODEWINDOW__AUTOCHECK_D__38_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7CA890)
#define TAPTAP_SDK_QRCODEWINDOW__AUTOCHECK_D__38_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A7CA840)
#define TAPTAP_SDK_QRCODEWINDOW__AUTOCHECK_D__38_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7C9FC0)
#define TAPTAP_SDK_QRCODEWINDOW__AUTOCHECK_D__38__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7C7B50)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int QRCodeWindow__AutoCheck_d__38_TypeDefinitionIndex = 9448;
