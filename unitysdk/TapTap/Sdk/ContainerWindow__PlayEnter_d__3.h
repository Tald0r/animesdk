...
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYENTER_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A7C0F40)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYENTER_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7C1090)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYENTER_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7C10F0)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYENTER_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A7C10A0)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYENTER_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7C0F30)
#define TAPTAP_SDK_CONTAINERWINDOW__PLAYENTER_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7C0EE0)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int ContainerWindow__PlayEnter_d__3_TypeDefinitionIndex = 9451;
