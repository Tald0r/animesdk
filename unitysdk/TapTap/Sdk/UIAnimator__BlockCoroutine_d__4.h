...
#define TAPTAP_SDK_UIANIMATOR__BLOCKCOROUTINE_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ADACE60)
#define TAPTAP_SDK_UIANIMATOR__BLOCKCOROUTINE_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ADACED0)
#define TAPTAP_SDK_UIANIMATOR__BLOCKCOROUTINE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ADACF30)
#define TAPTAP_SDK_UIANIMATOR__BLOCKCOROUTINE_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ADACEE0)
#define TAPTAP_SDK_UIANIMATOR__BLOCKCOROUTINE_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ADACE50)
#define TAPTAP_SDK_UIANIMATOR__BLOCKCOROUTINE_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADACE10)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int UIAnimator__BlockCoroutine_d__4_TypeDefinitionIndex = 9465;
