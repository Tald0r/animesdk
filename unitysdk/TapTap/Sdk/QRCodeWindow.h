...
#define TAPTAP_SDK_QRCODEWINDOW_AUTOCHECK_OFFSET UNITYSDK_OFFSET(0x1ADA97C0)
#define TAPTAP_SDK_QRCODEWINDOW_AWAKE_OFFSET UNITYSDK_OFFSET(0x1ADA6C70)
#define TAPTAP_SDK_QRCODEWINDOW_CHECK_OFFSET UNITYSDK_OFFSET(0x1ADA9010)
#define TAPTAP_SDK_QRCODEWINDOW_CLOSE_OFFSET UNITYSDK_OFFSET(0x1ADA8040)
#define TAPTAP_SDK_QRCODEWINDOW_DELETEWHITE_OFFSET UNITYSDK_OFFSET(0x1ADA94C0)
#define TAPTAP_SDK_QRCODEWINDOW_ENCODEQRIMAGE_OFFSET UNITYSDK_OFFSET(0x1ADA9020)
#define TAPTAP_SDK_QRCODEWINDOW_GETAUTHORIZATIONHEADER_OFFSET UNITYSDK_OFFSET(0x1ADA8410)
#define TAPTAP_SDK_QRCODEWINDOW_GETCODE_OFFSET UNITYSDK_OFFSET(0x1ADA7BA0)
#define TAPTAP_SDK_QRCODEWINDOW_GETPROFILE_OFFSET UNITYSDK_OFFSET(0x1ADA8280)
#define TAPTAP_SDK_QRCODEWINDOW_GET_EXTRA_OFFSET UNITYSDK_OFFSET(0x1ADA6B90)
#define TAPTAP_SDK_QRCODEWINDOW_GOTOTAPTAPPAGE_OFFSET UNITYSDK_OFFSET(0x1ADA8190)
#define TAPTAP_SDK_QRCODEWINDOW_ONENTER_OFFSET UNITYSDK_OFFSET(0x1ADA7A90)
#define TAPTAP_SDK_QRCODEWINDOW_ONEXIT_OFFSET UNITYSDK_OFFSET(0x1ADA7F40)
#define TAPTAP_SDK_QRCODEWINDOW_REFRESHCODE_OFFSET UNITYSDK_OFFSET(0x1ADA81E0)
#define TAPTAP_SDK_QRCODEWINDOW_SET_EXTRA_OFFSET UNITYSDK_OFFSET(0x1ADA6BA0)
#define TAPTAP_SDK_QRCODEWINDOW_STARTCHECK_OFFSET UNITYSDK_OFFSET(0x1ADA9740)
#define TAPTAP_SDK_QRCODEWINDOW_STOPCHECK_OFFSET UNITYSDK_OFFSET(0x1ADA9780)
#define TAPTAP_SDK_QRCODEWINDOW_UPDATE_OFFSET UNITYSDK_OFFSET(0x1ADA7A80)
#define TAPTAP_SDK_QRCODEWINDOW__CCTOR_OFFSET UNITYSDK_OFFSET(0x1ADA9850)
#define TAPTAP_SDK_QRCODEWINDOW__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADA9820)
#define TAPTAP_SDK_QRCODEWINDOW__GETCODE_B__32_0_OFFSET UNITYSDK_OFFSET(0x1ADA98D0)
#define TAPTAP_SDK_QRCODEWINDOW__GETCODE_B__32_1_OFFSET UNITYSDK_OFFSET(0x1ADAA0C0)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int QRCodeWindow_TypeDefinitionIndex = 9447;
