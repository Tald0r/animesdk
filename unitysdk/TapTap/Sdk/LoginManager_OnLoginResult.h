...
#define TAPTAP_SDK_LOGINMANAGER_ONLOGINRESULT_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADA4000)
#define TAPTAP_SDK_LOGINMANAGER_ONLOGINRESULT_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADA4030)
#define TAPTAP_SDK_LOGINMANAGER_ONLOGINRESULT_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADA3AE0)
#define TAPTAP_SDK_LOGINMANAGER_ONLOGINRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADA3FE0)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int LoginManager_OnLoginResult_TypeDefinitionIndex = 9470;
