...
#define TAPTAP_SDK_MINIJSON_JSON_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A7C0D40)
#define TAPTAP_SDK_MINIJSON_JSON_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A7C25B0)

namespace TapTap::Sdk::MiniJSON
{
	inline static constexpr unsigned int Json_TypeDefinitionIndex = 9472;
