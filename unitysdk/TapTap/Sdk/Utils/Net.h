...
#define TAPTAP_SDK_UTILS_NET_DICTTOQUERYSTRING_OFFSET UNITYSDK_OFFSET(0x1A7CE060)
#define TAPTAP_SDK_UTILS_NET_GETASYNC_OFFSET UNITYSDK_OFFSET(0x1A7C7170)
#define TAPTAP_SDK_UTILS_NET_GETRESPONSECODE_OFFSET UNITYSDK_OFFSET(0x1A7CDC70)
#define TAPTAP_SDK_UTILS_NET_GET_OFFSET UNITYSDK_OFFSET(0x1A7CDBE0)
#define TAPTAP_SDK_UTILS_NET_PARSERESPONSECODE_OFFSET UNITYSDK_OFFSET(0x1A7CDE60)
#define TAPTAP_SDK_UTILS_NET_PARSEURL_OFFSET UNITYSDK_OFFSET(0x1A7CE480)
#define TAPTAP_SDK_UTILS_NET_POSTASYNC_OFFSET UNITYSDK_OFFSET(0x1A7C7260)
#define TAPTAP_SDK_UTILS_NET_POST_OFFSET UNITYSDK_OFFSET(0x1A7CDB70)
#define TAPTAP_SDK_UTILS_NET__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7CE9C0)

namespace TapTap::Sdk::Utils
{
	inline static constexpr unsigned int Net_TypeDefinitionIndex = 9476;
