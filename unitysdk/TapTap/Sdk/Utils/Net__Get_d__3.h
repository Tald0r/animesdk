...
#define TAPTAP_SDK_UTILS_NET__GET_D__3_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1ADB06C0)
#define TAPTAP_SDK_UTILS_NET__GET_D__3_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ADB0E30)
#define TAPTAP_SDK_UTILS_NET__GET_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1ADB0E90)
#define TAPTAP_SDK_UTILS_NET__GET_D__3_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1ADB0E40)
#define TAPTAP_SDK_UTILS_NET__GET_D__3_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1ADB06B0)
#define TAPTAP_SDK_UTILS_NET__GET_D__3__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADAF920)

namespace TapTap::Sdk::Utils
{
	inline static constexpr unsigned int Net__Get_d__3_TypeDefinitionIndex = 9480;

	class Net__Get_d__3 : public ::System::Object
	{
	public:
		::UnityEngine::WWW* _w_5__2; // 0x10
		::System::String* authorization; // 0x18
		...
		::System::Action_2<::System::Int32, ::System::String*>* methodForError; // 0x38
