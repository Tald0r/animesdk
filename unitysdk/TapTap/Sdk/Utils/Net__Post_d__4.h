...
#define TAPTAP_SDK_UTILS_NET__POST_D__4_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A7CF1E0)
#define TAPTAP_SDK_UTILS_NET__POST_D__4_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7CFAF0)
#define TAPTAP_SDK_UTILS_NET__POST_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A7CFB50)
#define TAPTAP_SDK_UTILS_NET__POST_D__4_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A7CFB00)
#define TAPTAP_SDK_UTILS_NET__POST_D__4_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A7CF1D0)
#define TAPTAP_SDK_UTILS_NET__POST_D__4__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7CDC60)

namespace TapTap::Sdk::Utils
{
	inline static constexpr unsigned int Net__Post_d__4_TypeDefinitionIndex = 9479;
	...
	public:
		...
		::System::Collections::Generic::Dictionary_2<::System::String*, ::System::String*>* formParams; // 0x38
