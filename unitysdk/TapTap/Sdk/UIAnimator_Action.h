...
#define TAPTAP_SDK_UIANIMATOR_ACTION_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1ADACF40)
#define TAPTAP_SDK_UIANIMATOR_ACTION_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1ADACF70)
#define TAPTAP_SDK_UIANIMATOR_ACTION_INVOKE_OFFSET UNITYSDK_OFFSET(0x1ADACB70)
#define TAPTAP_SDK_UIANIMATOR_ACTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADACAF0)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int UIAnimator_Action_TypeDefinitionIndex = 9463;
