...
#define TAPTAP_SDK_UIANIMATOR_BLOCKCOROUTINE_OFFSET UNITYSDK_OFFSET(0x1ADACB10)
#define TAPTAP_SDK_UIANIMATOR_BLOCKFORSECOND_OFFSET UNITYSDK_OFFSET(0x1ADAC850)
#define TAPTAP_SDK_UIANIMATOR_DOENTERANIMATION_OFFSET UNITYSDK_OFFSET(0x1ADAC970)
#define TAPTAP_SDK_UIANIMATOR_DOEXITANIMATION_OFFSET UNITYSDK_OFFSET(0x1ADAC6E0)
#define TAPTAP_SDK_UIANIMATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x1ADACE20)

namespace TapTap::Sdk
{
	inline static constexpr unsigned int UIAnimator_TypeDefinitionIndex = 9462;
