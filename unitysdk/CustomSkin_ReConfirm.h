...
#define CUSTOMSKIN_RECONFIRM_INSTANCE_OFFSET UNITYSDK_OFFSET(0xB953010)
#define CUSTOMSKIN_RECONFIRM_ONCLICKACCEPT_OFFSET UNITYSDK_OFFSET(0xB9540C0)
#define CUSTOMSKIN_RECONFIRM_ONCLICKREFUSE_OFFSET UNITYSDK_OFFSET(0xB954020)
#define CUSTOMSKIN_RECONFIRM_ONCLOSE_OFFSET UNITYSDK_OFFSET(0xB953B00)
#define CUSTOMSKIN_RECONFIRM_ONHREFCLICK_OFFSET UNITYSDK_OFFSET(0xB953B80)
#define CUSTOMSKIN_RECONFIRM_ONOPENCONSOLEPROTOCOLWINDOW_OFFSET UNITYSDK_OFFSET(0xB954160)
#define CUSTOMSKIN_RECONFIRM_ONSHOW_OFFSET UNITYSDK_OFFSET(0xB9531C0)
#define CUSTOMSKIN_RECONFIRM_OPENPROTOCOLAGREEMENTHYPERLINK_OFFSET UNITYSDK_OFFSET(0xB953E40)
#define CUSTOMSKIN_RECONFIRM_OPENPROTOCOLOPERATORAGREEMENTHYPERLINK_OFFSET UNITYSDK_OFFSET(0xB953F80)
#define CUSTOMSKIN_RECONFIRM_OPENPROTOCOLPRIVACYHYPERLINK_OFFSET UNITYSDK_OFFSET(0xB953EE0)
#define CUSTOMSKIN_RECONFIRM_SETPLATFORM_OFFSET UNITYSDK_OFFSET(0xB9537C0)
#define CUSTOMSKIN_RECONFIRM__CTOR_OFFSET UNITYSDK_OFFSET(0xB953140)

inline static constexpr unsigned int CustomSkin_ReConfirm_TypeDefinitionIndex = 55638;
...
public:
	...
	{
		return (::CustomSkin_ReConfirm**)Il2CppClass::FromTypeDefinitionIndex(CustomSkin_ReConfirm_TypeDefinitionIndex)->GetStaticField(0x39950);
	}
	...
	::Class_2_79AE422BA06F6D26_93* _view; // 0x18
