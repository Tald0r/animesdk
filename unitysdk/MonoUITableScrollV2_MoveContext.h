...
#define MONOUITABLESCROLLV2_MOVECONTEXT_GETCOPYWITHMODIFIEDDELTA_OFFSET UNITYSDK_OFFSET(0x38F7B0)
#define MONOUITABLESCROLLV2_MOVECONTEXT_GET_NEEDUPDATESCROLL_OFFSET UNITYSDK_OFFSET(0x38F720)
#define MONOUITABLESCROLLV2_MOVECONTEXT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x38F860)
#define MONOUITABLESCROLLV2_MOVECONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x38F7A0)
#define MONOUITABLESCROLLV2_MOVECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x38F790)
#define MONOUITABLESCROLLV2_MOVECONTEXT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x38F870)

inline static constexpr unsigned int MonoUITableScrollV2_MoveContext_TypeDefinitionIndex = 64499;
