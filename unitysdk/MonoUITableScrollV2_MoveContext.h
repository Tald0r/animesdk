...
#define MONOUITABLESCROLLV2_MOVECONTEXT_GETCOPYWITHMODIFIEDDELTA_OFFSET UNITYSDK_OFFSET(0x335520)
#define MONOUITABLESCROLLV2_MOVECONTEXT_GET_NEEDUPDATESCROLL_OFFSET UNITYSDK_OFFSET(0x335490)
#define MONOUITABLESCROLLV2_MOVECONTEXT_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3355D0)
#define MONOUITABLESCROLLV2_MOVECONTEXT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x335510)
#define MONOUITABLESCROLLV2_MOVECONTEXT__CTOR_OFFSET UNITYSDK_OFFSET(0x335500)
#define MONOUITABLESCROLLV2_MOVECONTEXT___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x3355E0)

inline static constexpr unsigned int MonoUITableScrollV2_MoveContext_TypeDefinitionIndex = 43887;
