...
#define CLASS_1_4B8C8F1EAD31AFFF__CTOR_OFFSET UNITYSDK_OFFSET(0x6573920)

inline static constexpr unsigned int Class_1_4B8C8F1EAD31AFFF_TypeDefinitionIndex = 38631;

class Class_1_4B8C8F1EAD31AFFF : public ::System::Object
{
public:
	::System::Collections::Generic::List_1<::Class_1_E49B99468FA26AB2*>* Field_1_1; // 0x10
	::System::Int32 Field_1_3; // 0x18
	::MoleMole::Config::BuddyTeamType Field_1_5; // 0x1C
