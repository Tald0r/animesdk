...
#define CLASS_1_16DC19D7B8C71D25_INITMODULE1_OFFSET UNITYSDK_OFFSET(0x92A5DC0)
#define CLASS_1_16DC19D7B8C71D25_INITMODULE2_OFFSET UNITYSDK_OFFSET(0x92A5F70)
#define CLASS_1_16DC19D7B8C71D25_INITMODULE3_OFFSET UNITYSDK_OFFSET(0x92A69A0)
#define CLASS_1_16DC19D7B8C71D25_INITPIPELINE_OFFSET UNITYSDK_OFFSET(0x92A6B50)
#define CLASS_1_16DC19D7B8C71D25_METHOD_1_2F2E6C49AE161835_OFFSET UNITYSDK_OFFSET(0x92A6CD0)
#define CLASS_1_16DC19D7B8C71D25_METHOD_1_533404BA8D99FB73_OFFSET UNITYSDK_OFFSET(0x92A6D60)
#define CLASS_1_16DC19D7B8C71D25__CCTOR_OFFSET UNITYSDK_OFFSET(0x92A6C20)
#define CLASS_1_16DC19D7B8C71D25__CTOR_OFFSET UNITYSDK_OFFSET(0x92A6C10)

inline static constexpr unsigned int Class_1_16DC19D7B8C71D25_TypeDefinitionIndex = 72340;
...
public:
	...
	{
		return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(Class_1_16DC19D7B8C71D25_TypeDefinitionIndex)->GetStaticField(0x93B0);
	}
	static ::Foundation::Unreal::FName* StaticGet_Field_1_2()
	{
		return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(Class_1_16DC19D7B8C71D25_TypeDefinitionIndex)->GetStaticField(0x93B8);
	}
	static ::Foundation::Unreal::FName* StaticGet_Field_1_1()
	{
		return (::Foundation::Unreal::FName*)Il2CppClass::FromTypeDefinitionIndex(Class_1_16DC19D7B8C71D25_TypeDefinitionIndex)->GetStaticField(0x93C0);
	}
	...
	{
		return ((::Enum_3_4A097505A5A1A069(*)(::Enum_3_2BD1943B012482C0))((::PBYTE)hIl2Cpp + CLASS_1_16DC19D7B8C71D25_METHOD_1_2F2E6C49AE161835_OFFSET))(a1);
	}
