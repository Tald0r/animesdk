...
#define AKCALLBACKMANAGER_MONITORINGCALLBACK_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1B66B960)
#define AKCALLBACKMANAGER_MONITORINGCALLBACK_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1B66BA40)
#define AKCALLBACKMANAGER_MONITORINGCALLBACK_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B66B4F0)
#define AKCALLBACKMANAGER_MONITORINGCALLBACK__CTOR_OFFSET UNITYSDK_OFFSET(0x1B66B4D0)

inline static constexpr unsigned int AkCallbackManager_MonitoringCallback_TypeDefinitionIndex = 30970;
