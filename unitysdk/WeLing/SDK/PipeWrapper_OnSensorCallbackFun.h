...
#define WELING_SDK_PIPEWRAPPER_ONSENSORCALLBACKFUN_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x17B01170)
#define WELING_SDK_PIPEWRAPPER_ONSENSORCALLBACKFUN_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x17B01200)
#define WELING_SDK_PIPEWRAPPER_ONSENSORCALLBACKFUN_INVOKE_OFFSET UNITYSDK_OFFSET(0x17B00DF0)
#define WELING_SDK_PIPEWRAPPER_ONSENSORCALLBACKFUN__CTOR_OFFSET UNITYSDK_OFFSET(0x17B00DE0)

namespace WeLing::SDK
{
	inline static constexpr unsigned int PipeWrapper_OnSensorCallbackFun_TypeDefinitionIndex = 17574;
