...
#include "unitysdk/Struct_2_69AE4F0A725C1E2D.h"
...
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_15FFA3F8C5B2DD4F_OFFSET UNITYSDK_OFFSET(0x6313C40)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_5CEC4607322705E5_OFFSET UNITYSDK_OFFSET(0x6315410)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_61B2A1B49E1DAEBB_OFFSET UNITYSDK_OFFSET(0x6315A30)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_630803E44574EC60_OFFSET UNITYSDK_OFFSET(0x6315C30)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_68887892A9E0289B_OFFSET UNITYSDK_OFFSET(0x6315510)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_72F506570A14E43C_OFFSET UNITYSDK_OFFSET(0x6313EB0)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_8A5370F4070DF55A_OFFSET UNITYSDK_OFFSET(0x63158C0)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_8AE88CC79AC0221D_OFFSET UNITYSDK_OFFSET(0x6313990)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_90E49A1F2F0734FB_OFFSET UNITYSDK_OFFSET(0x6314000)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_9580FA6D91135FAE_OFFSET UNITYSDK_OFFSET(0x6313E40)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_97F653A15EA46B53_OFFSET UNITYSDK_OFFSET(0x6315CC0)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_A6E4C5DEE1077AA6_OFFSET UNITYSDK_OFFSET(0x6313AA0)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_CA373AA1C7054598_1_OFFSET UNITYSDK_OFFSET(0x6316160)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_CA373AA1C7054598_OFFSET UNITYSDK_OFFSET(0x6315490)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_EE7339DA6ECF5F6D_OFFSET UNITYSDK_OFFSET(0x6314600)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_F0088C88851A7DFB_1_OFFSET UNITYSDK_OFFSET(0x6315480)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_F0088C88851A7DFB_OFFSET UNITYSDK_OFFSET(0x63145F0)
#define CLASS_1_FF2ECD13EC40B5E1_METHOD_1_F240EFA7A704696B_OFFSET UNITYSDK_OFFSET(0x63157B0)
#define CLASS_1_FF2ECD13EC40B5E1__CTOR_OFFSET UNITYSDK_OFFSET(0x6313710)

inline static constexpr unsigned int Class_1_FF2ECD13EC40B5E1_TypeDefinitionIndex = 65230;

class Class_1_FF2ECD13EC40B5E1 : public ::System::Object
{
public:
	::Class_1_FF2ECD13EC40B5E1_Struct_2_0F33D881FDB3218F Field_1_2; // 0x10
	::MoleMole::Cameras::CameraTrackSetting* Field_1_6; // 0x120
	::MoleMole::Cameras::CameraTrackSetting* Field_1_0; // 0x128
	::System::Nullable_1<::Struct_2_69AE4F0A725C1E2D> Field_1_7; // 0x130
	::System::Collections::Generic::HashSet_1<::System::UInt64>* Field_1_4; // 0x160
	::Foundation::PriorityQueue_2<::MoleMole::Cameras::CameraTrackSetting*, ::System::UInt64>* Field_1_3; // 0x168
	::System::Nullable_1<::Struct_2_455336A079B58DD3> Field_1_8; // 0x170
	::MoleMole::Cameras::CameraTrackSetting* Field_1_1; // 0x198
	::System::UInt32 Field_1_5; // 0x1A0
	::System::Double Field_1_9; // 0x1A8
