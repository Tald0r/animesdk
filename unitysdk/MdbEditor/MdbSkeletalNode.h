...
#define MDBEDITOR_MDBSKELETALNODE_GET_BONENAME_OFFSET UNITYSDK_OFFSET(0x11B207D0)
#define MDBEDITOR_MDBSKELETALNODE_GET_CURRTRANS_OFFSET UNITYSDK_OFFSET(0x11B207A0)
#define MDBEDITOR_MDBSKELETALNODE_GET_ISENDPOINT_OFFSET UNITYSDK_OFFSET(0x11B207E0)
#define MDBEDITOR_MDBSKELETALNODE_GET_ISSKINBONE_OFFSET UNITYSDK_OFFSET(0x11B207F0)
#define MDBEDITOR_MDBSKELETALNODE_GET_PARENTINDEX_OFFSET UNITYSDK_OFFSET(0x11B207C0)
#define MDBEDITOR_MDBSKELETALNODE_GET_PARENTTRANS_OFFSET UNITYSDK_OFFSET(0x11B207B0)
#define MDBEDITOR_MDBSKELETALNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x11B20770)

namespace MdbEditor
{
	inline static constexpr unsigned int MdbSkeletalNode_TypeDefinitionIndex = 84199;
