...
#define MDBEDITOR_MDBSKELETALNODE_GET_BONENAME_OFFSET UNITYSDK_OFFSET(0x124A4690)
#define MDBEDITOR_MDBSKELETALNODE_GET_CURRTRANS_OFFSET UNITYSDK_OFFSET(0x124A4660)
#define MDBEDITOR_MDBSKELETALNODE_GET_ISENDPOINT_OFFSET UNITYSDK_OFFSET(0x124A46A0)
#define MDBEDITOR_MDBSKELETALNODE_GET_ISSKINBONE_OFFSET UNITYSDK_OFFSET(0x124A46B0)
#define MDBEDITOR_MDBSKELETALNODE_GET_PARENTINDEX_OFFSET UNITYSDK_OFFSET(0x124A4680)
#define MDBEDITOR_MDBSKELETALNODE_GET_PARENTTRANS_OFFSET UNITYSDK_OFFSET(0x124A4670)
#define MDBEDITOR_MDBSKELETALNODE__CTOR_OFFSET UNITYSDK_OFFSET(0x124A4630)

namespace MdbEditor
{
	inline static constexpr unsigned int MdbSkeletalNode_TypeDefinitionIndex = 82122;
