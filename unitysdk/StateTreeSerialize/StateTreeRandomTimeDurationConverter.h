...
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3C2C70)
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3C29D0)
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3C2840)
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C2CB0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeRandomTimeDurationConverter_TypeDefinitionIndex = 36369;
