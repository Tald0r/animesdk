...
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A4B71C0)
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A4B6F20)
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A4B6D90)
#define STATETREESERIALIZE_STATETREERANDOMTIMEDURATIONCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B7200)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeRandomTimeDurationConverter_TypeDefinitionIndex = 35356;
