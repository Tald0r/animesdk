...
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A4B8C80)
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A4B8770)
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A4B8470)
#define STATETREESERIALIZE_STATETREETASKBASECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B7F50)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeTaskBaseConverter_TypeDefinitionIndex = 35365;
