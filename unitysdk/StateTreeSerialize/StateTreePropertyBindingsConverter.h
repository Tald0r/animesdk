...
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A4B6D40)
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A4B6A00)
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A4B6830)
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B6D80)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyBindingsConverter_TypeDefinitionIndex = 35348;
