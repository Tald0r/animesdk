...
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3BEAC0)
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3BE3E0)
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3BE050)
#define STATETREESERIALIZE_STATETREEPROPERTYBINDINGSCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3BEB00)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyBindingsConverter_TypeDefinitionIndex = 36350;
