...
#define STATETREESERIALIZE_FPROPERTYBAGCONTAINERTYPESCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3B6F20)
#define STATETREESERIALIZE_FPROPERTYBAGCONTAINERTYPESCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3B6AC0)
#define STATETREESERIALIZE_FPROPERTYBAGCONTAINERTYPESCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3B68F0)
#define STATETREESERIALIZE_FPROPERTYBAGCONTAINERTYPESCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B6F60)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FPropertyBagContainerTypesConverter_TypeDefinitionIndex = 36377;
