...
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3B3700)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3B30A0)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3B2E80)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B3740)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int CompactStateTreeTransitionNativeStructListConverter_TypeDefinitionIndex = 36360;
