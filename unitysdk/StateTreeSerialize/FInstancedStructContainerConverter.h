...
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONTAINERCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A4B1C40)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONTAINERCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A4B15D0)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONTAINERCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A4B1320)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONTAINERCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B1C80)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FInstancedStructContainerConverter_TypeDefinitionIndex = 35359;
