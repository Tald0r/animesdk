...
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONTAINERCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3B5FB0)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONTAINERCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3B5970)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONTAINERCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3B55D0)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONTAINERCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B5FF0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FInstancedStructContainerConverter_TypeDefinitionIndex = 36372;
