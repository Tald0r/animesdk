...
#define STATETREESERIALIZE_STATETREEBINDABLESTRUCTDESCNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3B9340)
#define STATETREESERIALIZE_STATETREEBINDABLESTRUCTDESCNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3B8CF0)
#define STATETREESERIALIZE_STATETREEBINDABLESTRUCTDESCNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3B8AD0)
#define STATETREESERIALIZE_STATETREEBINDABLESTRUCTDESCNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B9380)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeBindableStructDescNativeStructListConverter_TypeDefinitionIndex = 36362;
