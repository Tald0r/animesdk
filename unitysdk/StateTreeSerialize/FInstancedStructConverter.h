...
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A4B2150)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A4B1E30)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A4B1C90)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B2190)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FInstancedStructConverter_TypeDefinitionIndex = 35360;
