...
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3B6590)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3B6280)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3B6000)
#define STATETREESERIALIZE_FINSTANCEDSTRUCTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B65D0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FInstancedStructConverter_TypeDefinitionIndex = 36373;
