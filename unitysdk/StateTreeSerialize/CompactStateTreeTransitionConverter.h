...
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A4B0590)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A4AFED0)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A4AFB60)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B05D0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int CompactStateTreeTransitionConverter_TypeDefinitionIndex = 35358;
