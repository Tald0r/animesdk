...
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3B2E30)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3B2680)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3B2310)
#define STATETREESERIALIZE_COMPACTSTATETREETRANSITIONCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B2E70)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int CompactStateTreeTransitionConverter_TypeDefinitionIndex = 36371;
