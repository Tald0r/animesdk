...
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3BD750)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3BD480)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3BD290)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3BD790)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyAccessConverter_TypeDefinitionIndex = 36356;
