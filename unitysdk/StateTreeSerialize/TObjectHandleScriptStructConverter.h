...
#define STATETREESERIALIZE_TOBJECTHANDLESCRIPTSTRUCTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3C5BD0)
#define STATETREESERIALIZE_TOBJECTHANDLESCRIPTSTRUCTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3C59F0)
#define STATETREESERIALIZE_TOBJECTHANDLESCRIPTSTRUCTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3C5820)
#define STATETREESERIALIZE_TOBJECTHANDLESCRIPTSTRUCTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C42B0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int TObjectHandleScriptStructConverter_TypeDefinitionIndex = 36380;
