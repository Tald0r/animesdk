...
#define STATETREESERIALIZE_STATETREESTATEHANDLECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3C47B0)
#define STATETREESERIALIZE_STATETREESTATEHANDLECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3C4590)
#define STATETREESERIALIZE_STATETREESTATEHANDLECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3C44A0)
#define STATETREESERIALIZE_STATETREESTATEHANDLECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C4280)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeStateHandleConverter_TypeDefinitionIndex = 36368;
