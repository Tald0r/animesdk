...
#define STATETREESERIALIZE_STATETREESTATEHANDLECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A4B8430)
#define STATETREESERIALIZE_STATETREESTATEHANDLECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A4B8210)
#define STATETREESERIALIZE_STATETREESTATEHANDLECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A4B8120)
#define STATETREESERIALIZE_STATETREESTATEHANDLECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B7F40)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeStateHandleConverter_TypeDefinitionIndex = 35355;
