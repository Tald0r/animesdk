...
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A4B1170)
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A4B0E70)
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A4B0D40)
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B11B0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FGameplayTagConverter_TypeDefinitionIndex = 35368;
