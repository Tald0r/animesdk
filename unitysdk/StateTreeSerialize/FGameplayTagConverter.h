...
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3B3B80)
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3B3880)
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3B3750)
#define STATETREESERIALIZE_FGAMEPLAYTAGCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B3BC0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FGameplayTagConverter_TypeDefinitionIndex = 36387;
