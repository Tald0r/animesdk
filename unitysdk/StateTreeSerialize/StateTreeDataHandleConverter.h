...
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3BB720)
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3BB470)
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3BB290)
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3BB760)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeDataHandleConverter_TypeDefinitionIndex = 36382;
