...
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A4B5670)
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A4B53C0)
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A4B51E0)
#define STATETREESERIALIZE_STATETREEDATAHANDLECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B56B0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeDataHandleConverter_TypeDefinitionIndex = 35363;
