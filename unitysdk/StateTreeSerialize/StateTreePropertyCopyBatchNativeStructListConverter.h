...
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3BF840)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3BF210)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3BEFF0)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3BF880)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyCopyBatchNativeStructListConverter_TypeDefinitionIndex = 36363;
