...
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3BE000)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3BD9C0)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3BD7A0)
#define STATETREESERIALIZE_STATETREEPROPERTYACCESSNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3BE040)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyAccessNativeStructListConverter_TypeDefinitionIndex = 36366;
