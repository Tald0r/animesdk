...
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3B7A10)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3B7340)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3B6F70)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B7A50)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FPropertyBagPropertyDescConverter_TypeDefinitionIndex = 36375;
