...
#define STATETREESERIALIZE_STATETREESERIALIZESETTINGS_FIELDSONLYCONTRACTRESOLVER_CREATEPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A4B8000)
#define STATETREESERIALIZE_STATETREESERIALIZESETTINGS_FIELDSONLYCONTRACTRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B7F60)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeSerializeSettings_FieldsOnlyContractResolver_TypeDefinitionIndex = 35345;
