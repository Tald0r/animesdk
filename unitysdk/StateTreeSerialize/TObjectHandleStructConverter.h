...
#define STATETREESERIALIZE_TOBJECTHANDLESTRUCTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3C5FC0)
#define STATETREESERIALIZE_TOBJECTHANDLESTRUCTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3C5DE0)
#define STATETREESERIALIZE_TOBJECTHANDLESTRUCTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3C5C10)
#define STATETREESERIALIZE_TOBJECTHANDLESTRUCTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C42A0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int TObjectHandleStructConverter_TypeDefinitionIndex = 36379;
