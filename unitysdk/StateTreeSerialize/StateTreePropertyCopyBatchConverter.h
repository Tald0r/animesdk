...
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3BEFA0)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3BECF0)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3BEB10)
#define STATETREESERIALIZE_STATETREEPROPERTYCOPYBATCHCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3BEFE0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyCopyBatchConverter_TypeDefinitionIndex = 36353;
