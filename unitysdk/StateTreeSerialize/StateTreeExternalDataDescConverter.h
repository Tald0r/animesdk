...
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3BBE50)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3BB9D0)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3BB770)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3BBE90)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeExternalDataDescConverter_TypeDefinitionIndex = 36351;
