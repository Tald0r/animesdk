...
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3BC710)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3BC0C0)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3BBEA0)
#define STATETREESERIALIZE_STATETREEEXTERNALDATADESCNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3BC750)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeExternalDataDescNativeStructListConverter_TypeDefinitionIndex = 36361;
