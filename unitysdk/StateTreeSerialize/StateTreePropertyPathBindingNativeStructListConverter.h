...
#define STATETREESERIALIZE_STATETREEPROPERTYPATHBINDINGNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3C07A0)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHBINDINGNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3C0230)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHBINDINGNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3BFFD0)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHBINDINGNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C07E0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyPathBindingNativeStructListConverter_TypeDefinitionIndex = 36364;
