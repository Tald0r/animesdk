...
#define STATETREESERIALIZE_FINSTANCEDPROPERTYBAGCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A4B12D0)
#define STATETREESERIALIZE_FINSTANCEDPROPERTYBAGCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A4B11F0)
#define STATETREESERIALIZE_FINSTANCEDPROPERTYBAGCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A4B11C0)
#define STATETREESERIALIZE_FINSTANCEDPROPERTYBAGCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B1310)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FInstancedPropertyBagConverter_TypeDefinitionIndex = 35361;
