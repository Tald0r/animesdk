...
#define STATETREESERIALIZE_FINSTANCEDPROPERTYBAGCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3B5580)
#define STATETREESERIALIZE_FINSTANCEDPROPERTYBAGCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3B4700)
#define STATETREESERIALIZE_FINSTANCEDPROPERTYBAGCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3B3EF0)
#define STATETREESERIALIZE_FINSTANCEDPROPERTYBAGCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B55C0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FInstancedPropertyBagConverter_TypeDefinitionIndex = 36374;
