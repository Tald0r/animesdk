...
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3C10A0)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3C0D70)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3C0B90)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHSEGMENTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C10E0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyPathSegmentConverter_TypeDefinitionIndex = 36358;
