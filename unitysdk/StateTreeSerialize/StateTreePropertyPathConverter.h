...
#define STATETREESERIALIZE_STATETREEPROPERTYPATHCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3C0B40)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3C0970)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3C07F0)
#define STATETREESERIALIZE_STATETREEPROPERTYPATHCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C0B80)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyPathConverter_TypeDefinitionIndex = 36357;
