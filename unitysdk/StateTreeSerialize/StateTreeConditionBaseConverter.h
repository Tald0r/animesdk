...
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A4B3C80)
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A4B3940)
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A4B3700)
#define STATETREESERIALIZE_STATETREECONDITIONBASECONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A4B3CC0)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreeConditionBaseConverter_TypeDefinitionIndex = 35366;
