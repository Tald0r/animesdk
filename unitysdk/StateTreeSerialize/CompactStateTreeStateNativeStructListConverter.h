...
#define STATETREESERIALIZE_COMPACTSTATETREESTATENATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3B22C0)
#define STATETREESERIALIZE_COMPACTSTATETREESTATENATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3B1B30)
#define STATETREESERIALIZE_COMPACTSTATETREESTATENATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3B18D0)
#define STATETREESERIALIZE_COMPACTSTATETREESTATENATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B2300)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int CompactStateTreeStateNativeStructListConverter_TypeDefinitionIndex = 36359;
