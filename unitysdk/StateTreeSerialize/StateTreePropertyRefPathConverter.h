...
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3C1E10)
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3C1B40)
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3C1940)
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C1E50)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyRefPathConverter_TypeDefinitionIndex = 36355;
