...
#define STATETREESERIALIZE_TOBJECTHANDLEENUMCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3C57E0)
#define STATETREESERIALIZE_TOBJECTHANDLEENUMCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3C5600)
#define STATETREESERIALIZE_TOBJECTHANDLEENUMCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3C5430)
#define STATETREESERIALIZE_TOBJECTHANDLEENUMCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C4290)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int TObjectHandleEnumConverter_TypeDefinitionIndex = 36378;
