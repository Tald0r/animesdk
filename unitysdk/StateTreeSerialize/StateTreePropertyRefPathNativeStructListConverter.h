...
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHNATIVESTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3C27F0)
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHNATIVESTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3C2080)
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHNATIVESTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3C1E60)
#define STATETREESERIALIZE_STATETREEPROPERTYREFPATHNATIVESTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3C2830)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int StateTreePropertyRefPathNativeStructListConverter_TypeDefinitionIndex = 36365;
