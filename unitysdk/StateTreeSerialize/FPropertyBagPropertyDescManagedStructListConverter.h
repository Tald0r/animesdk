...
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCMANAGEDSTRUCTLISTCONVERTER_CANCONVERT_OFFSET UNITYSDK_OFFSET(0x1A3B8350)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCMANAGEDSTRUCTLISTCONVERTER_READJSON_OFFSET UNITYSDK_OFFSET(0x1A3B7CA0)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCMANAGEDSTRUCTLISTCONVERTER_WRITEJSON_OFFSET UNITYSDK_OFFSET(0x1A3B7A60)
#define STATETREESERIALIZE_FPROPERTYBAGPROPERTYDESCMANAGEDSTRUCTLISTCONVERTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3B8390)

namespace StateTreeSerialize
{
	inline static constexpr unsigned int FPropertyBagPropertyDescManagedStructListConverter_TypeDefinitionIndex = 36376;
