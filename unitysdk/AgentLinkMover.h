...
#define AGENTLINKMOVER_CURVE_OFFSET UNITYSDK_OFFSET(0x77484F0)
#define AGENTLINKMOVER_NORMALSPEED_OFFSET UNITYSDK_OFFSET(0x7748380)
#define AGENTLINKMOVER_PARABOLA_OFFSET UNITYSDK_OFFSET(0x7748420)
#define AGENTLINKMOVER_START_OFFSET UNITYSDK_OFFSET(0x77482E0)
#define AGENTLINKMOVER__CTOR_OFFSET UNITYSDK_OFFSET(0x77485B0)

inline static constexpr unsigned int AgentLinkMover_TypeDefinitionIndex = 47399;
