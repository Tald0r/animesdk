...
#define AGENTLINKMOVER_CURVE_OFFSET UNITYSDK_OFFSET(0xA9FCC70)
#define AGENTLINKMOVER_NORMALSPEED_OFFSET UNITYSDK_OFFSET(0xA9FCB00)
#define AGENTLINKMOVER_PARABOLA_OFFSET UNITYSDK_OFFSET(0xA9FCBA0)
#define AGENTLINKMOVER_START_OFFSET UNITYSDK_OFFSET(0xA9FCA60)
#define AGENTLINKMOVER__CTOR_OFFSET UNITYSDK_OFFSET(0xA9FCD30)

inline static constexpr unsigned int AgentLinkMover_TypeDefinitionIndex = 75947;
