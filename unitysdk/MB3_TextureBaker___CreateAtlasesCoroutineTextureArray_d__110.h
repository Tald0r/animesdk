...
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINETEXTUREARRAY_D__110_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1AACE820)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINETEXTUREARRAY_D__110_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AACF8B0)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINETEXTUREARRAY_D__110_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1AACF910)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINETEXTUREARRAY_D__110_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1AACF8C0)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINETEXTUREARRAY_D__110_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1AACE810)
#define MB3_TEXTUREBAKER___CREATEATLASESCOROUTINETEXTUREARRAY_D__110__CTOR_OFFSET UNITYSDK_OFFSET(0x1AACE800)

inline static constexpr unsigned int MB3_TextureBaker___CreateAtlasesCoroutineTextureArray_d__110_TypeDefinitionIndex = 81212;
