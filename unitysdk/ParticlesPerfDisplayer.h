...
#define PARTICLESPERFDISPLAYER_GET_SUSEDRAWSTATSBETWEENPASS_OFFSET UNITYSDK_OFFSET(0x1B156F50)
#define PARTICLESPERFDISPLAYER_SET_SUSEDRAWSTATSBETWEENPASS_OFFSET UNITYSDK_OFFSET(0x1B156F80)
#define PARTICLESPERFDISPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B156FB0)

inline static constexpr unsigned int ParticlesPerfDisplayer_TypeDefinitionIndex = 81165;
