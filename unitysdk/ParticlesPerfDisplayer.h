...
#define PARTICLESPERFDISPLAYER_GET_SUSEDRAWSTATSBETWEENPASS_OFFSET UNITYSDK_OFFSET(0x1B7760A0)
#define PARTICLESPERFDISPLAYER_SET_SUSEDRAWSTATSBETWEENPASS_OFFSET UNITYSDK_OFFSET(0x1B7760D0)
#define PARTICLESPERFDISPLAYER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B776100)

inline static constexpr unsigned int ParticlesPerfDisplayer_TypeDefinitionIndex = 83206;
