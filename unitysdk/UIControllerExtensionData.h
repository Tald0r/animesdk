...
#define UICONTROLLEREXTENSIONDATA_GETBOOLDATA_OFFSET UNITYSDK_OFFSET(0xAEA5130)
#define UICONTROLLEREXTENSIONDATA_GETCOLORDATA_OFFSET UNITYSDK_OFFSET(0xAEA52F0)
#define UICONTROLLEREXTENSIONDATA_GETFLOATDATA_OFFSET UNITYSDK_OFFSET(0xAEA5040)
#define UICONTROLLEREXTENSIONDATA_GETINTDATA_OFFSET UNITYSDK_OFFSET(0xAEA4F50)
#define UICONTROLLEREXTENSIONDATA_GETSTRINGDATA_OFFSET UNITYSDK_OFFSET(0xAEA5210)
#define UICONTROLLEREXTENSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0xAEA5440)

inline static constexpr unsigned int UIControllerExtensionData_TypeDefinitionIndex = 76995;
