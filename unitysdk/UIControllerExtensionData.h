...
#define UICONTROLLEREXTENSIONDATA_GETBOOLDATA_OFFSET UNITYSDK_OFFSET(0x16C5BB30)
#define UICONTROLLEREXTENSIONDATA_GETCOLORDATA_OFFSET UNITYSDK_OFFSET(0x16C5BCF0)
#define UICONTROLLEREXTENSIONDATA_GETFLOATDATA_OFFSET UNITYSDK_OFFSET(0x16C5BA40)
#define UICONTROLLEREXTENSIONDATA_GETINTDATA_OFFSET UNITYSDK_OFFSET(0x16C5B950)
#define UICONTROLLEREXTENSIONDATA_GETSTRINGDATA_OFFSET UNITYSDK_OFFSET(0x16C5BC10)
#define UICONTROLLEREXTENSIONDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16C5BE40)

inline static constexpr unsigned int UIControllerExtensionData_TypeDefinitionIndex = 57677;
