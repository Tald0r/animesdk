...
#define CLASS_1_C8116EB1F0D068AE_METHOD_1_0BE1846AC20D43BE_OFFSET UNITYSDK_OFFSET(0x738AAA0)
#define CLASS_1_C8116EB1F0D068AE_METHOD_1_89EB09C7F436432A_OFFSET UNITYSDK_OFFSET(0x738AF80)
#define CLASS_1_C8116EB1F0D068AE_METHOD_1_A8AE4A9A45E37F95_OFFSET UNITYSDK_OFFSET(0x738A990)
#define CLASS_1_C8116EB1F0D068AE_METHOD_1_E4D99478DAD6C104_OFFSET UNITYSDK_OFFSET(0x738AD10)

inline static constexpr unsigned int Class_1_C8116EB1F0D068AE_TypeDefinitionIndex = 51648;
...
public:
	...
	{
		return (::MoleMole::ConfigNpcPrototype**)Il2CppClass::FromTypeDefinitionIndex(Class_1_C8116EB1F0D068AE_TypeDefinitionIndex)->GetStaticField(0x3E0B0);
	}
