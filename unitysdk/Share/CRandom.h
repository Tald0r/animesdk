...
#define SHARE_CRANDOM_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x16F353A0)
#define SHARE_CRANDOM_INTERNALSAMPLE_OFFSET UNITYSDK_OFFSET(0x16F35810)
#define SHARE_CRANDOM_NEXTBYTES_OFFSET UNITYSDK_OFFSET(0x16F35A30)
#define SHARE_CRANDOM_NEXTDOUBLE_OFFSET UNITYSDK_OFFSET(0x16F35A20)
#define SHARE_CRANDOM_NEXT_1_OFFSET UNITYSDK_OFFSET(0x16F358D0)
#define SHARE_CRANDOM_NEXT_2_OFFSET UNITYSDK_OFFSET(0x16F359A0)
#define SHARE_CRANDOM_NEXT_OFFSET UNITYSDK_OFFSET(0x16F358C0)
#define SHARE_CRANDOM_SAMPLE_OFFSET UNITYSDK_OFFSET(0x16F357F0)
#define SHARE_CRANDOM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16F35530)
#define SHARE_CRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x16F354E0)

namespace Share
{
	inline static constexpr unsigned int CRandom_TypeDefinitionIndex = 16030;
