...
#define SHARE_CRANDOM_GET_DEFAULT_OFFSET UNITYSDK_OFFSET(0x17B27AE0)
#define SHARE_CRANDOM_INTERNALSAMPLE_OFFSET UNITYSDK_OFFSET(0x17B27F50)
#define SHARE_CRANDOM_NEXTBYTES_OFFSET UNITYSDK_OFFSET(0x17B28170)
#define SHARE_CRANDOM_NEXTDOUBLE_OFFSET UNITYSDK_OFFSET(0x17B28160)
#define SHARE_CRANDOM_NEXT_1_OFFSET UNITYSDK_OFFSET(0x17B28010)
#define SHARE_CRANDOM_NEXT_2_OFFSET UNITYSDK_OFFSET(0x17B280E0)
#define SHARE_CRANDOM_NEXT_OFFSET UNITYSDK_OFFSET(0x17B28000)
#define SHARE_CRANDOM_SAMPLE_OFFSET UNITYSDK_OFFSET(0x17B27F30)
#define SHARE_CRANDOM__CTOR_1_OFFSET UNITYSDK_OFFSET(0x17B27C70)
#define SHARE_CRANDOM__CTOR_OFFSET UNITYSDK_OFFSET(0x17B27C20)

namespace Share
{
	inline static constexpr unsigned int CRandom_TypeDefinitionIndex = 15220;
