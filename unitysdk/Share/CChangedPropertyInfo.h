...
#define SHARE_CCHANGEDPROPERTYINFO_GET_CURVALUE_OFFSET UNITYSDK_OFFSET(0x178BD060)
#define SHARE_CCHANGEDPROPERTYINFO_GET_PREVVALUE_OFFSET UNITYSDK_OFFSET(0x178BD040)
#define SHARE_CCHANGEDPROPERTYINFO_SET_CURVALUE_OFFSET UNITYSDK_OFFSET(0x178BD070)
#define SHARE_CCHANGEDPROPERTYINFO_SET_PREVVALUE_OFFSET UNITYSDK_OFFSET(0x178BD050)
#define SHARE_CCHANGEDPROPERTYINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x178BD090)
#define SHARE_CCHANGEDPROPERTYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x178BD080)

namespace Share
{
	inline static constexpr unsigned int CChangedPropertyInfo_TypeDefinitionIndex = 14030;
