...
#define SHARE_CCHANGEDPROPERTYINFO_GET_CURVALUE_OFFSET UNITYSDK_OFFSET(0x16BCE9E0)
#define SHARE_CCHANGEDPROPERTYINFO_GET_PREVVALUE_OFFSET UNITYSDK_OFFSET(0x16BCE9C0)
#define SHARE_CCHANGEDPROPERTYINFO_SET_CURVALUE_OFFSET UNITYSDK_OFFSET(0x16BCE9F0)
#define SHARE_CCHANGEDPROPERTYINFO_SET_PREVVALUE_OFFSET UNITYSDK_OFFSET(0x16BCE9D0)
#define SHARE_CCHANGEDPROPERTYINFO__CTOR_1_OFFSET UNITYSDK_OFFSET(0x16BCEA10)
#define SHARE_CCHANGEDPROPERTYINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x16BCEA00)

namespace Share
{
	inline static constexpr unsigned int CChangedPropertyInfo_TypeDefinitionIndex = 12948;
