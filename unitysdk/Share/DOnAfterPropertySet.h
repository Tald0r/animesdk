...
#define SHARE_DONAFTERPROPERTYSET_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18F6E7B0)
#define SHARE_DONAFTERPROPERTYSET_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x18F6E860)
#define SHARE_DONAFTERPROPERTYSET_INVOKE_OFFSET UNITYSDK_OFFSET(0x18F6E410)
#define SHARE_DONAFTERPROPERTYSET__CTOR_OFFSET UNITYSDK_OFFSET(0x18F6E3F0)

namespace Share
{
	inline static constexpr unsigned int DOnAfterPropertySet_TypeDefinitionIndex = 16797;
