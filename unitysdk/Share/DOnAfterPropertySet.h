...
#define SHARE_DONAFTERPROPERTYSET_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x18349F70)
#define SHARE_DONAFTERPROPERTYSET_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1834A020)
#define SHARE_DONAFTERPROPERTYSET_INVOKE_OFFSET UNITYSDK_OFFSET(0x18349BE0)
#define SHARE_DONAFTERPROPERTYSET__CTOR_OFFSET UNITYSDK_OFFSET(0x18349BD0)

namespace Share
{
	inline static constexpr unsigned int DOnAfterPropertySet_TypeDefinitionIndex = 13331;
