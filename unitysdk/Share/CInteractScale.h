...
#define SHARE_CINTERACTSCALE_CLEAR_OFFSET UNITYSDK_OFFSET(0x16F35270)
#define SHARE_CINTERACTSCALE_GET_R_OFFSET UNITYSDK_OFFSET(0x16F34F80)
#define SHARE_CINTERACTSCALE_GET_W_OFFSET UNITYSDK_OFFSET(0x16F34F60)
#define SHARE_CINTERACTSCALE_GET_X_OFFSET UNITYSDK_OFFSET(0x16F34F00)
#define SHARE_CINTERACTSCALE_GET_Y_OFFSET UNITYSDK_OFFSET(0x16F34F20)
#define SHARE_CINTERACTSCALE_GET_Z_OFFSET UNITYSDK_OFFSET(0x16F34F40)
#define SHARE_CINTERACTSCALE_SET_R_OFFSET UNITYSDK_OFFSET(0x16F34F90)
#define SHARE_CINTERACTSCALE_SET_W_OFFSET UNITYSDK_OFFSET(0x16F34F70)
#define SHARE_CINTERACTSCALE_SET_X_OFFSET UNITYSDK_OFFSET(0x16F34F10)
#define SHARE_CINTERACTSCALE_SET_Y_OFFSET UNITYSDK_OFFSET(0x16F34F30)
#define SHARE_CINTERACTSCALE_SET_Z_OFFSET UNITYSDK_OFFSET(0x16F34F50)
#define SHARE_CINTERACTSCALE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x16F34FA0)
#define SHARE_CINTERACTSCALE__CTOR_OFFSET UNITYSDK_OFFSET(0x16F35290)

namespace Share
{
	inline static constexpr unsigned int CInteractScale_TypeDefinitionIndex = 13978;
