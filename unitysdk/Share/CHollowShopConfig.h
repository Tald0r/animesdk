...
#define SHARE_CHOLLOWSHOPCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x183215E0)
#define SHARE_CHOLLOWSHOPCONFIG_GET_PREDICATES_OFFSET UNITYSDK_OFFSET(0x18321360)
#define SHARE_CHOLLOWSHOPCONFIG_GET_SHOPTYPE_OFFSET UNITYSDK_OFFSET(0x183212E0)
#define SHARE_CHOLLOWSHOPCONFIG_GET_SHOWTYPE_OFFSET UNITYSDK_OFFSET(0x18321320)
#define SHARE_CHOLLOWSHOPCONFIG_GET_SLOT_OFFSET UNITYSDK_OFFSET(0x18321340)
#define SHARE_CHOLLOWSHOPCONFIG_GET_TOKENTYPE_OFFSET UNITYSDK_OFFSET(0x18321300)
#define SHARE_CHOLLOWSHOPCONFIG_SET_PREDICATES_OFFSET UNITYSDK_OFFSET(0x18321370)
#define SHARE_CHOLLOWSHOPCONFIG_SET_SHOPTYPE_OFFSET UNITYSDK_OFFSET(0x183212F0)
#define SHARE_CHOLLOWSHOPCONFIG_SET_SHOWTYPE_OFFSET UNITYSDK_OFFSET(0x18321330)
#define SHARE_CHOLLOWSHOPCONFIG_SET_SLOT_OFFSET UNITYSDK_OFFSET(0x18321350)
#define SHARE_CHOLLOWSHOPCONFIG_SET_TOKENTYPE_OFFSET UNITYSDK_OFFSET(0x18321310)
#define SHARE_CHOLLOWSHOPCONFIG_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18321380)
#define SHARE_CHOLLOWSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x18321660)

namespace Share
{
	inline static constexpr unsigned int CHollowShopConfig_TypeDefinitionIndex = 16071;
