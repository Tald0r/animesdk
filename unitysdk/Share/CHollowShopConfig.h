...
#define SHARE_CHOLLOWSHOPCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B4D9520)
#define SHARE_CHOLLOWSHOPCONFIG_GET_PREDICATES_OFFSET UNITYSDK_OFFSET(0x1B4D92A0)
#define SHARE_CHOLLOWSHOPCONFIG_GET_SHOPTYPE_OFFSET UNITYSDK_OFFSET(0x1B4D9220)
#define SHARE_CHOLLOWSHOPCONFIG_GET_SHOWTYPE_OFFSET UNITYSDK_OFFSET(0x1B4D9260)
#define SHARE_CHOLLOWSHOPCONFIG_GET_SLOT_OFFSET UNITYSDK_OFFSET(0x1B4D9280)
#define SHARE_CHOLLOWSHOPCONFIG_GET_TOKENTYPE_OFFSET UNITYSDK_OFFSET(0x1B4D9240)
#define SHARE_CHOLLOWSHOPCONFIG_SET_PREDICATES_OFFSET UNITYSDK_OFFSET(0x1B4D92B0)
#define SHARE_CHOLLOWSHOPCONFIG_SET_SHOPTYPE_OFFSET UNITYSDK_OFFSET(0x1B4D9230)
#define SHARE_CHOLLOWSHOPCONFIG_SET_SHOWTYPE_OFFSET UNITYSDK_OFFSET(0x1B4D9270)
#define SHARE_CHOLLOWSHOPCONFIG_SET_SLOT_OFFSET UNITYSDK_OFFSET(0x1B4D9290)
#define SHARE_CHOLLOWSHOPCONFIG_SET_TOKENTYPE_OFFSET UNITYSDK_OFFSET(0x1B4D9250)
#define SHARE_CHOLLOWSHOPCONFIG_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B4D92C0)
#define SHARE_CHOLLOWSHOPCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B4D95A0)

namespace Share
{
	inline static constexpr unsigned int CHollowShopConfig_TypeDefinitionIndex = 13492;
