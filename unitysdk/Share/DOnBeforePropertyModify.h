...
#define SHARE_DONBEFOREPROPERTYMODIFY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x178BDA60)
#define SHARE_DONBEFOREPROPERTYMODIFY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x178BDA90)
#define SHARE_DONBEFOREPROPERTYMODIFY_INVOKE_OFFSET UNITYSDK_OFFSET(0x178BD560)
#define SHARE_DONBEFOREPROPERTYMODIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x178BD550)

namespace Share
{
	inline static constexpr unsigned int DOnBeforePropertyModify_TypeDefinitionIndex = 16689;
