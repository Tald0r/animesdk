...
#define SHARE_DONBEFOREPROPERTYMODIFY_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x16BCF3F0)
#define SHARE_DONBEFOREPROPERTYMODIFY_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x16BCF420)
#define SHARE_DONBEFOREPROPERTYMODIFY_INVOKE_OFFSET UNITYSDK_OFFSET(0x16BCEEF0)
#define SHARE_DONBEFOREPROPERTYMODIFY__CTOR_OFFSET UNITYSDK_OFFSET(0x16BCEED0)

namespace Share
{
	inline static constexpr unsigned int DOnBeforePropertyModify_TypeDefinitionIndex = 17507;
