...
#define SHARE_CAVATARINFOEXT_GETRANKBYLEVEL_OFFSET UNITYSDK_OFFSET(0x17B275E0)

namespace Share
{
	inline static constexpr unsigned int CAvatarInfoExt_TypeDefinitionIndex = 14592;
