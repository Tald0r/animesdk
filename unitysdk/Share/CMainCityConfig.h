...
#define SHARE_CMAINCITYCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x19A7A230)
#define SHARE_CMAINCITYCONFIG_GET_DEFAULTSECTIONID_OFFSET UNITYSDK_OFFSET(0x19A7A020)
#define SHARE_CMAINCITYCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x19A7A000)
#define SHARE_CMAINCITYCONFIG_GET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x19A7A040)
#define SHARE_CMAINCITYCONFIG_SET_DEFAULTSECTIONID_OFFSET UNITYSDK_OFFSET(0x19A7A030)
#define SHARE_CMAINCITYCONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0x19A7A010)
#define SHARE_CMAINCITYCONFIG_SET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x19A7A050)
#define SHARE_CMAINCITYCONFIG_TOSTRING_OFFSET UNITYSDK_OFFSET(0x19A7A060)
#define SHARE_CMAINCITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x19A7A2B0)

namespace Share
{
	inline static constexpr unsigned int CMainCityConfig_TypeDefinitionIndex = 15039;
