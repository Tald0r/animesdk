...
#define SHARE_CMAINCITYCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x191BF650)
#define SHARE_CMAINCITYCONFIG_GET_DEFAULTSECTIONID_OFFSET UNITYSDK_OFFSET(0x191BF440)
#define SHARE_CMAINCITYCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x191BF420)
#define SHARE_CMAINCITYCONFIG_GET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x191BF460)
#define SHARE_CMAINCITYCONFIG_SET_DEFAULTSECTIONID_OFFSET UNITYSDK_OFFSET(0x191BF450)
#define SHARE_CMAINCITYCONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0x191BF430)
#define SHARE_CMAINCITYCONFIG_SET_SECTIONS_OFFSET UNITYSDK_OFFSET(0x191BF470)
#define SHARE_CMAINCITYCONFIG_TOSTRING_OFFSET UNITYSDK_OFFSET(0x191BF480)
#define SHARE_CMAINCITYCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x191BF6D0)

namespace Share
{
	inline static constexpr unsigned int CMainCityConfig_TypeDefinitionIndex = 16409;
