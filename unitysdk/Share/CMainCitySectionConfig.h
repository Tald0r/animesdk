...
#define SHARE_CMAINCITYSECTIONCONFIG_CLEAR_OFFSET UNITYSDK_OFFSET(0x1B29E8A0)
#define SHARE_CMAINCITYSECTIONCONFIG_GET_BORNPOSNAME_OFFSET UNITYSDK_OFFSET(0x1B29E6D0)
#define SHARE_CMAINCITYSECTIONCONFIG_GET_BORNTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B29E6B0)
#define SHARE_CMAINCITYSECTIONCONFIG_GET_ID_OFFSET UNITYSDK_OFFSET(0x1B29E670)
#define SHARE_CMAINCITYSECTIONCONFIG_GET_UNITYSCENEPATH_OFFSET UNITYSDK_OFFSET(0x1B29E690)
#define SHARE_CMAINCITYSECTIONCONFIG_SET_BORNPOSNAME_OFFSET UNITYSDK_OFFSET(0x1B29E6E0)
#define SHARE_CMAINCITYSECTIONCONFIG_SET_BORNTRANSFORM_OFFSET UNITYSDK_OFFSET(0x1B29E6C0)
#define SHARE_CMAINCITYSECTIONCONFIG_SET_ID_OFFSET UNITYSDK_OFFSET(0x1B29E680)
#define SHARE_CMAINCITYSECTIONCONFIG_SET_UNITYSCENEPATH_OFFSET UNITYSDK_OFFSET(0x1B29E6A0)
#define SHARE_CMAINCITYSECTIONCONFIG_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1B29E6F0)
#define SHARE_CMAINCITYSECTIONCONFIG__CTOR_OFFSET UNITYSDK_OFFSET(0x1B29E8D0)

namespace Share
{
	inline static constexpr unsigned int CMainCitySectionConfig_TypeDefinitionIndex = 17793;
