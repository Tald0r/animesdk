...
#define SHARE_CPROPERTYCONTAINER_ADDPROPERTY_OFFSET UNITYSDK_OFFSET(0x16DEDAC0)
#define SHARE_CPROPERTYCONTAINER_ADDRAWPROPERTY_OFFSET UNITYSDK_OFFSET(0x16DEDA20)
#define SHARE_CPROPERTYCONTAINER_ADD_ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x16DED2E0)
#define SHARE_CPROPERTYCONTAINER_ADD_ONBEFOREPROPERTYMODIFY_OFFSET UNITYSDK_OFFSET(0x16DED1E0)
#define SHARE_CPROPERTYCONTAINER_ADD_ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x16DED3E0)
#define SHARE_CPROPERTYCONTAINER_FIREALLEVENT_OFFSET UNITYSDK_OFFSET(0x16DEDD00)
#define SHARE_CPROPERTYCONTAINER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x16DEDC60)
#define SHARE_CPROPERTYCONTAINER_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x16DED8A0)
#define SHARE_CPROPERTYCONTAINER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x16DED4E0)
#define SHARE_CPROPERTYCONTAINER_ISPROPERTYSETTED_OFFSET UNITYSDK_OFFSET(0x16DED840)
#define SHARE_CPROPERTYCONTAINER_REFRESHRELATEDPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x16DEDBE0)
#define SHARE_CPROPERTYCONTAINER_REFRESHRELATEDPROPERTY_OFFSET UNITYSDK_OFFSET(0x16DEDB60)
#define SHARE_CPROPERTYCONTAINER_REMOVE_ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x16DED360)
#define SHARE_CPROPERTYCONTAINER_REMOVE_ONBEFOREPROPERTYMODIFY_OFFSET UNITYSDK_OFFSET(0x16DED260)
#define SHARE_CPROPERTYCONTAINER_REMOVE_ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x16DED460)
#define SHARE_CPROPERTYCONTAINER_SETPROPERTY_OFFSET UNITYSDK_OFFSET(0x16DED990)
#define SHARE_CPROPERTYCONTAINER_SETRAWPROPERTY_OFFSET UNITYSDK_OFFSET(0x16DED900)
#define SHARE_CPROPERTYCONTAINER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x16DEDCB0)
#define SHARE_CPROPERTYCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x16DED500)
#define SHARE_CPROPERTYCONTAINER__ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x16DED820)
#define SHARE_CPROPERTYCONTAINER__ONBEFOREPROPERTYMODIFY_OFFSET UNITYSDK_OFFSET(0x16DED810)
#define SHARE_CPROPERTYCONTAINER__ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x16DED830)

namespace Share
{
	inline static constexpr unsigned int CPropertyContainer_TypeDefinitionIndex = 15293;

	class CPropertyContainer : public ::System::Object
	{
	public:
		::Share::CPropertyContainer_COperatorHelper* m_oOperatorHelper; // 0x10
		::Share::DOnPropertyChanged* OnPropertyChanged; // 0x18
		::Share::CPropertyOperator_1<::Share::EPropertyType>* m_oPropertyOperator; // 0x20
		::Share::DOnBeforePropertyModify* OnBeforePropertyModify; // 0x28
		::Share::DOnAfterPropertySet* OnAfterPropertySet; // 0x30
