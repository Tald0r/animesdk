...
#define SHARE_CPROPERTYCONTAINER_ADDPROPERTY_OFFSET UNITYSDK_OFFSET(0x186400E0)
#define SHARE_CPROPERTYCONTAINER_ADDRAWPROPERTY_OFFSET UNITYSDK_OFFSET(0x18640050)
#define SHARE_CPROPERTYCONTAINER_ADD_ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x1863F910)
#define SHARE_CPROPERTYCONTAINER_ADD_ONBEFOREPROPERTYMODIFY_OFFSET UNITYSDK_OFFSET(0x1863F810)
#define SHARE_CPROPERTYCONTAINER_ADD_ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1863FA10)
#define SHARE_CPROPERTYCONTAINER_FIREALLEVENT_OFFSET UNITYSDK_OFFSET(0x18640310)
#define SHARE_CPROPERTYCONTAINER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18640270)
#define SHARE_CPROPERTYCONTAINER_GETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1863FED0)
#define SHARE_CPROPERTYCONTAINER_GET_COUNT_OFFSET UNITYSDK_OFFSET(0x1863FB10)
#define SHARE_CPROPERTYCONTAINER_ISPROPERTYSETTED_OFFSET UNITYSDK_OFFSET(0x1863FE70)
#define SHARE_CPROPERTYCONTAINER_REFRESHRELATEDPROPERTY_1_OFFSET UNITYSDK_OFFSET(0x186401F0)
#define SHARE_CPROPERTYCONTAINER_REFRESHRELATEDPROPERTY_OFFSET UNITYSDK_OFFSET(0x18640170)
#define SHARE_CPROPERTYCONTAINER_REMOVE_ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x1863F990)
#define SHARE_CPROPERTYCONTAINER_REMOVE_ONBEFOREPROPERTYMODIFY_OFFSET UNITYSDK_OFFSET(0x1863F890)
#define SHARE_CPROPERTYCONTAINER_REMOVE_ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1863FA90)
#define SHARE_CPROPERTYCONTAINER_SETPROPERTY_OFFSET UNITYSDK_OFFSET(0x1863FFC0)
#define SHARE_CPROPERTYCONTAINER_SETRAWPROPERTY_OFFSET UNITYSDK_OFFSET(0x1863FF30)
#define SHARE_CPROPERTYCONTAINER_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x186402C0)
#define SHARE_CPROPERTYCONTAINER__CTOR_OFFSET UNITYSDK_OFFSET(0x1863FB30)
#define SHARE_CPROPERTYCONTAINER__ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x1863FE50)
#define SHARE_CPROPERTYCONTAINER__ONBEFOREPROPERTYMODIFY_OFFSET UNITYSDK_OFFSET(0x1863FE40)
#define SHARE_CPROPERTYCONTAINER__ONPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1863FE60)

namespace Share
{
	inline static constexpr unsigned int CPropertyContainer_TypeDefinitionIndex = 10788;

	class CPropertyContainer : public ::System::Object
	{
	public:
		::Share::DOnPropertyChanged* OnPropertyChanged; // 0x10
		::Share::DOnAfterPropertySet* OnAfterPropertySet; // 0x18
