...
#define SHARE_CVECTOR2_CLEAR_OFFSET UNITYSDK_OFFSET(0x18640F70)
#define SHARE_CVECTOR2_GET_X_OFFSET UNITYSDK_OFFSET(0x18640DB0)
#define SHARE_CVECTOR2_GET_Y_OFFSET UNITYSDK_OFFSET(0x18640DD0)
#define SHARE_CVECTOR2_SET_X_OFFSET UNITYSDK_OFFSET(0x18640DC0)
#define SHARE_CVECTOR2_SET_Y_OFFSET UNITYSDK_OFFSET(0x18640DE0)
#define SHARE_CVECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x18640DF0)
#define SHARE_CVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x18640F80)

namespace Share
{
	inline static constexpr unsigned int CVector2_TypeDefinitionIndex = 10710;
