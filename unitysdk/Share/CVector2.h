...
#define SHARE_CVECTOR2_CLEAR_OFFSET UNITYSDK_OFFSET(0x16DEE960)
#define SHARE_CVECTOR2_GET_X_OFFSET UNITYSDK_OFFSET(0x16DEE7A0)
#define SHARE_CVECTOR2_GET_Y_OFFSET UNITYSDK_OFFSET(0x16DEE7C0)
#define SHARE_CVECTOR2_SET_X_OFFSET UNITYSDK_OFFSET(0x16DEE7B0)
#define SHARE_CVECTOR2_SET_Y_OFFSET UNITYSDK_OFFSET(0x16DEE7D0)
#define SHARE_CVECTOR2_TOSTRING_OFFSET UNITYSDK_OFFSET(0x16DEE7E0)
#define SHARE_CVECTOR2__CTOR_OFFSET UNITYSDK_OFFSET(0x16DEE970)

namespace Share
{
	inline static constexpr unsigned int CVector2_TypeDefinitionIndex = 13837;
