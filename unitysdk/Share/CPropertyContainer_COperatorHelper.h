...
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_GETPROPERTYTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1852EDA0)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_ISPERSISTENCEPORPERTY_OFFSET UNITYSDK_OFFSET(0x1852EE20)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x1852F1F0)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_ONBEFOREPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x1852EE90)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_TEMPLATEIDTOPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1852EE80)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1852ED90)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER__FIXHP_OFFSET UNITYSDK_OFFSET(0x1852EEB0)

namespace Share
{
	inline static constexpr unsigned int CPropertyContainer_COperatorHelper_TypeDefinitionIndex = 15294;
