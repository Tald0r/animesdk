...
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_GETPROPERTYTEMPLATE_OFFSET UNITYSDK_OFFSET(0x1762C9C0)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_ISPERSISTENCEPORPERTY_OFFSET UNITYSDK_OFFSET(0x1762CA40)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_ONAFTERPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x1762CE10)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_ONBEFOREPROPERTYSET_OFFSET UNITYSDK_OFFSET(0x1762CAB0)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER_TEMPLATEIDTOPROPERTYTYPE_OFFSET UNITYSDK_OFFSET(0x1762CAA0)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x1762C9B0)
#define SHARE_CPROPERTYCONTAINER_COPERATORHELPER__FIXHP_OFFSET UNITYSDK_OFFSET(0x1762CAD0)

namespace Share
{
	inline static constexpr unsigned int CPropertyContainer_COperatorHelper_TypeDefinitionIndex = 10789;
	...
	public:
		...
		::Class_0_16E4307DCC419505_16<::Share::EPropertyType>* GetPropertyTemplate(::Share::EPropertyType ePropertyType)
		{
			return ((::Class_0_16E4307DCC419505_16<::Share::EPropertyType>*(*)(::PVOID, ::Share::EPropertyType))((::PBYTE)hIl2Cpp + SHARE_CPROPERTYCONTAINER_COPERATORHELPER_GETPROPERTYTEMPLATE_OFFSET))(this, ePropertyType);
		}
