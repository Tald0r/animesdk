...
#define SHARE_CVECTOR3F_CLEAR_OFFSET UNITYSDK_OFFSET(0x174A23A0)
#define SHARE_CVECTOR3F_GET_X_OFFSET UNITYSDK_OFFSET(0x174A2150)
#define SHARE_CVECTOR3F_GET_Y_OFFSET UNITYSDK_OFFSET(0x174A2170)
#define SHARE_CVECTOR3F_GET_Z_OFFSET UNITYSDK_OFFSET(0x174A2190)
#define SHARE_CVECTOR3F_SET_X_OFFSET UNITYSDK_OFFSET(0x174A2160)
#define SHARE_CVECTOR3F_SET_Y_OFFSET UNITYSDK_OFFSET(0x174A2180)
#define SHARE_CVECTOR3F_SET_Z_OFFSET UNITYSDK_OFFSET(0x174A21A0)
#define SHARE_CVECTOR3F_TOSTRING_OFFSET UNITYSDK_OFFSET(0x174A21B0)
#define SHARE_CVECTOR3F__CTOR_OFFSET UNITYSDK_OFFSET(0x174A23B0)

namespace Share
{
	inline static constexpr unsigned int CVector3f_TypeDefinitionIndex = 11435;
