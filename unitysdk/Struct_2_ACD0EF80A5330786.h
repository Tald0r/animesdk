...
#define STRUCT_2_ACD0EF80A5330786_METHOD_2_5394145894BDC459_OFFSET UNITYSDK_OFFSET(0x30D0A0)
#define STRUCT_2_ACD0EF80A5330786_METHOD_2_CE34EA208837238D_OFFSET UNITYSDK_OFFSET(0x30D120)
#define STRUCT_2_ACD0EF80A5330786__CCTOR_OFFSET UNITYSDK_OFFSET(0x6B9C1B0)
#define STRUCT_2_ACD0EF80A5330786__CTOR_OFFSET UNITYSDK_OFFSET(0x30D020)

inline static constexpr unsigned int Struct_2_ACD0EF80A5330786_TypeDefinitionIndex = 65658;

struct alignas(8) Struct_2_ACD0EF80A5330786
{
	static ::Struct_2_ACD0EF80A5330786* StaticGet_Field_2_3()
	{
		return (::Struct_2_ACD0EF80A5330786*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_ACD0EF80A5330786_TypeDefinitionIndex)->GetStaticField(0xBE00);
	}
