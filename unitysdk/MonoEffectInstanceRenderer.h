...
#define MONOEFFECTINSTANCERENDERER_ADDCOLORVAL_OFFSET UNITYSDK_OFFSET(0x187A9FE0)
#define MONOEFFECTINSTANCERENDERER_ADDFLOATVAL_OFFSET UNITYSDK_OFFSET(0x187A9E50)
#define MONOEFFECTINSTANCERENDERER_ADDVEC4VAL_OFFSET UNITYSDK_OFFSET(0x187A9F00)
#define MONOEFFECTINSTANCERENDERER_CALCULATEFRAMEINDICES_OFFSET UNITYSDK_OFFSET(0x187A8CB0)
#define MONOEFFECTINSTANCERENDERER_CLEARBATCHES_OFFSET UNITYSDK_OFFSET(0x187A8BB0)
#define MONOEFFECTINSTANCERENDERER_CLEARVALMAP_OFFSET UNITYSDK_OFFSET(0x187A9D40)
#define MONOEFFECTINSTANCERENDERER_ENSUREBATCHCAPACITY_OFFSET UNITYSDK_OFFSET(0x187A8DA0)
#define MONOEFFECTINSTANCERENDERER_GETRENDERBATCHES_OFFSET UNITYSDK_OFFSET(0x187A9D00)
#define MONOEFFECTINSTANCERENDERER_GET_ANIMATIONDATA_OFFSET UNITYSDK_OFFSET(0x187A8210)
#define MONOEFFECTINSTANCERENDERER_GET_CURRENTFRAME_OFFSET UNITYSDK_OFFSET(0x187A7F70)
#define MONOEFFECTINSTANCERENDERER_GET_ISVALID_OFFSET UNITYSDK_OFFSET(0x187A8010)
#define MONOEFFECTINSTANCERENDERER_GET_PARTICLEMATERIAL_OFFSET UNITYSDK_OFFSET(0x187A7F60)
#define MONOEFFECTINSTANCERENDERER_GET_PARTICLEMESH_OFFSET UNITYSDK_OFFSET(0x187A7F50)
#define MONOEFFECTINSTANCERENDERER_NEEDUPDATEMPB_OFFSET UNITYSDK_OFFSET(0x187A7FD0)
#define MONOEFFECTINSTANCERENDERER_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x187A87B0)
#define MONOEFFECTINSTANCERENDERER_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x187A85D0)
#define MONOEFFECTINSTANCERENDERER_ONENABLE_OFFSET UNITYSDK_OFFSET(0x187A8220)
#define MONOEFFECTINSTANCERENDERER_SETNEEDUPDATEMPB_OFFSET UNITYSDK_OFFSET(0x187A7F80)
#define MONOEFFECTINSTANCERENDERER_UPDATEBATCHES_OFFSET UNITYSDK_OFFSET(0x187A8850)
#define MONOEFFECTINSTANCERENDERER_UPDATEBATCHMATRICES_OFFSET UNITYSDK_OFFSET(0x187A9220)
#define MONOEFFECTINSTANCERENDERER_UPDATEBATCHPROPERTYBLOCK_OFFSET UNITYSDK_OFFSET(0x187A9840)
#define MONOEFFECTINSTANCERENDERER_UPDATESINGLEBATCH_OFFSET UNITYSDK_OFFSET(0x187A9060)
#define MONOEFFECTINSTANCERENDERER__CTOR_OFFSET UNITYSDK_OFFSET(0x187AA050)

inline static constexpr unsigned int MonoEffectInstanceRenderer_TypeDefinitionIndex = 28041;
