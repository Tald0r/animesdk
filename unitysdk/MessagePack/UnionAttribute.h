...
#define MESSAGEPACK_UNIONATTRIBUTE_GET_KEY_OFFSET UNITYSDK_OFFSET(0x1918C190)
#define MESSAGEPACK_UNIONATTRIBUTE_GET_SUBTYPE_OFFSET UNITYSDK_OFFSET(0x1918C1B0)
#define MESSAGEPACK_UNIONATTRIBUTE_SET_KEY_OFFSET UNITYSDK_OFFSET(0x1918C1A0)
#define MESSAGEPACK_UNIONATTRIBUTE_SET_SUBTYPE_OFFSET UNITYSDK_OFFSET(0x1918C1C0)
#define MESSAGEPACK_UNIONATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1918C1E0)
#define MESSAGEPACK_UNIONATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1918C1D0)

namespace MessagePack
{
	inline static constexpr unsigned int UnionAttribute_TypeDefinitionIndex = 27684;
