...
#define MESSAGEPACK_UNITY_VECTOR3INTFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x183EF9D0)
#define MESSAGEPACK_UNITY_VECTOR3INTFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x183EF990)
#define MESSAGEPACK_UNITY_VECTOR3INTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x183EFBA0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int Vector3IntFormatter_TypeDefinitionIndex = 25936;
