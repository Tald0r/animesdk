...
#define MESSAGEPACK_UNITY_RECTOFFSETFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19DB5CE0)
#define MESSAGEPACK_UNITY_RECTOFFSETFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19DB5C60)
#define MESSAGEPACK_UNITY_RECTOFFSETFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB5ED0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int RectOffsetFormatter_TypeDefinitionIndex = 25796;
