...
#define MESSAGEPACK_UNITY_RECTINTFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A4897F0)
#define MESSAGEPACK_UNITY_RECTINTFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A4897A0)
#define MESSAGEPACK_UNITY_RECTINTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A489A00)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int RectIntFormatter_TypeDefinitionIndex = 27497;
