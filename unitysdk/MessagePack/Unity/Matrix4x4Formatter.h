...
#define MESSAGEPACK_UNITY_MATRIX4X4FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A088630)
#define MESSAGEPACK_UNITY_MATRIX4X4FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A088540)
#define MESSAGEPACK_UNITY_MATRIX4X4FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A088AE0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int Matrix4x4Formatter_TypeDefinitionIndex = 25249;
