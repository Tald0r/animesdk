...
#define MESSAGEPACK_UNITY_KEYFRAMEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19263F50)
#define MESSAGEPACK_UNITY_KEYFRAMEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19263EF0)
#define MESSAGEPACK_UNITY_KEYFRAMEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x192641A0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int KeyframeFormatter_TypeDefinitionIndex = 26467;
