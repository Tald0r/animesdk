...
#define MESSAGEPACK_UNITY_GRADIENTMODEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19F57AE0)
#define MESSAGEPACK_UNITY_GRADIENTMODEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19F57AD0)
#define MESSAGEPACK_UNITY_GRADIENTMODEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F57AF0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int GradientModeFormatter_TypeDefinitionIndex = 26350;
