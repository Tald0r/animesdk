...
#define MESSAGEPACK_UNITY_LAYERMASKFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1918C2A0)
#define MESSAGEPACK_UNITY_LAYERMASKFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1918C270)
#define MESSAGEPACK_UNITY_LAYERMASKFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1918C410)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int LayerMaskFormatter_TypeDefinitionIndex = 27016;
