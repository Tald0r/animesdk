...
#define MESSAGEPACK_UNITY_VECTOR2FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A11A8B0)
#define MESSAGEPACK_UNITY_VECTOR2FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A11A870)
#define MESSAGEPACK_UNITY_VECTOR2FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A11AA70)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int Vector2Formatter_TypeDefinitionIndex = 26976;
