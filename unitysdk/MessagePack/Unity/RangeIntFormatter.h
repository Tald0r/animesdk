...
#define MESSAGEPACK_UNITY_RANGEINTFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19F57B40)
#define MESSAGEPACK_UNITY_RANGEINTFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19F57B00)
#define MESSAGEPACK_UNITY_RANGEINTFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F57CE0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int RangeIntFormatter_TypeDefinitionIndex = 25165;
