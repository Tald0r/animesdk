...
#define MESSAGEPACK_UNITY_COLORFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19263520)
#define MESSAGEPACK_UNITY_COLORFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x192634C0)
#define MESSAGEPACK_UNITY_COLORFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19263760)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int ColorFormatter_TypeDefinitionIndex = 26312;
