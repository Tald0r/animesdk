...
#define MESSAGEPACK_UNITY_QUATERNIONFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A7259D0)
#define MESSAGEPACK_UNITY_QUATERNIONFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A725970)
#define MESSAGEPACK_UNITY_QUATERNIONFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A725C10)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int QuaternionFormatter_TypeDefinitionIndex = 26941;
