...
#define MESSAGEPACK_UNITY_EXTENSION_VECTOR3ARRAYBLITFORMATTER_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x19A07C50)
#define MESSAGEPACK_UNITY_EXTENSION_VECTOR3ARRAYBLITFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19A07C60)

namespace MessagePack::Unity::Extension
{
	inline static constexpr unsigned int Vector3ArrayBlitFormatter_TypeDefinitionIndex = 25609;
