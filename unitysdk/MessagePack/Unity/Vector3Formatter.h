...
#define MESSAGEPACK_UNITY_VECTOR3FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FF7CB0)
#define MESSAGEPACK_UNITY_VECTOR3FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FF7C60)
#define MESSAGEPACK_UNITY_VECTOR3FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF7EA0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int Vector3Formatter_TypeDefinitionIndex = 27284;
