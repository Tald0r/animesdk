...
#define MESSAGEPACK_UNITY_GRADIENTALPHAKEYFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19E06C30)
#define MESSAGEPACK_UNITY_GRADIENTALPHAKEYFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19E06BF0)
#define MESSAGEPACK_UNITY_GRADIENTALPHAKEYFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E06DF0)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int GradientAlphaKeyFormatter_TypeDefinitionIndex = 25590;
