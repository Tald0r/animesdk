...
#define MESSAGEPACK_UNITY_ANIMATIONCURVEFORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A2234D0)
#define MESSAGEPACK_UNITY_ANIMATIONCURVEFORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A2231F0)
#define MESSAGEPACK_UNITY_ANIMATIONCURVEFORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A223960)

namespace MessagePack::Unity
{
	inline static constexpr unsigned int AnimationCurveFormatter_TypeDefinitionIndex = 27168;
