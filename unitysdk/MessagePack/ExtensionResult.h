...
#define MESSAGEPACK_EXTENSIONRESULT_GET_DATA_OFFSET UNITYSDK_OFFSET(0x547E50)
#define MESSAGEPACK_EXTENSIONRESULT_GET_HEADER_OFFSET UNITYSDK_OFFSET(0x9287F0)
#define MESSAGEPACK_EXTENSIONRESULT_GET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x306AA0)
#define MESSAGEPACK_EXTENSIONRESULT_SET_DATA_OFFSET UNITYSDK_OFFSET(0x9287E0)
#define MESSAGEPACK_EXTENSIONRESULT_SET_TYPECODE_OFFSET UNITYSDK_OFFSET(0x30FC20)
#define MESSAGEPACK_EXTENSIONRESULT__CTOR_1_OFFSET UNITYSDK_OFFSET(0x558750)
#define MESSAGEPACK_EXTENSIONRESULT__CTOR_OFFSET UNITYSDK_OFFSET(0x928780)

namespace MessagePack
{
	inline static constexpr unsigned int ExtensionResult_TypeDefinitionIndex = 26101;
