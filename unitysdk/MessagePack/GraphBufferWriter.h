...
#define MESSAGEPACK_GRAPHBUFFERWRITER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x7EDB70)
#define MESSAGEPACK_GRAPHBUFFERWRITER_ENSUREMORE_OFFSET UNITYSDK_OFFSET(0x87A0A0)
#define MESSAGEPACK_GRAPHBUFFERWRITER_ENSURE_OFFSET UNITYSDK_OFFSET(0x879FD0)
#define MESSAGEPACK_GRAPHBUFFERWRITER_GETPOINTER_OFFSET UNITYSDK_OFFSET(0x879F20)
#define MESSAGEPACK_GRAPHBUFFERWRITER_GETRAWSPAN_OFFSET UNITYSDK_OFFSET(0x879E40)
#define MESSAGEPACK_GRAPHBUFFERWRITER_GETSPAN_OFFSET UNITYSDK_OFFSET(0x879DD0)
#define MESSAGEPACK_GRAPHBUFFERWRITER_GET_BYTESCOMMITTED_OFFSET UNITYSDK_OFFSET(0x7ED590)
#define MESSAGEPACK_GRAPHBUFFERWRITER_GET_SPAN_OFFSET UNITYSDK_OFFSET(0x879DA0)
#define MESSAGEPACK_GRAPHBUFFERWRITER_TRYGETUNCOMMITTEDSPAN_OFFSET UNITYSDK_OFFSET(0x879FF0)
#define MESSAGEPACK_GRAPHBUFFERWRITER_WRITEMULTIBUFFER_OFFSET UNITYSDK_OFFSET(0x87A0B0)
#define MESSAGEPACK_GRAPHBUFFERWRITER_WRITE_OFFSET UNITYSDK_OFFSET(0x7ED6F0)
#define MESSAGEPACK_GRAPHBUFFERWRITER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x879CE0)
#define MESSAGEPACK_GRAPHBUFFERWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x879C10)

namespace MessagePack
{
	inline static constexpr unsigned int GraphBufferWriter_TypeDefinitionIndex = 26652;
