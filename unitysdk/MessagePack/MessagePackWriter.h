...
#define MESSAGEPACK_MESSAGEPACKWRITER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x888430)
#define MESSAGEPACK_MESSAGEPACKWRITER_CLONE_OFFSET UNITYSDK_OFFSET(0x887DF0)
#define MESSAGEPACK_MESSAGEPACKWRITER_DIRECTSET_1_OFFSET UNITYSDK_OFFSET(0x887ED0)
#define MESSAGEPACK_MESSAGEPACKWRITER_DIRECTSET_OFFSET UNITYSDK_OFFSET(0x887E70)
#define MESSAGEPACK_MESSAGEPACKWRITER_FLUSHANDGETARRAY_OFFSET UNITYSDK_OFFSET(0x2F75F0)
#define MESSAGEPACK_MESSAGEPACKWRITER_FLUSH_OFFSET UNITYSDK_OFFSET(0x2613F0)
#define MESSAGEPACK_MESSAGEPACKWRITER_GETRAWSPAN_OFFSET UNITYSDK_OFFSET(0x887F70)
#define MESSAGEPACK_MESSAGEPACKWRITER_GETSPAN_OFFSET UNITYSDK_OFFSET(0x8883C0)
#define MESSAGEPACK_MESSAGEPACKWRITER_GET_CANCELLATIONTOKEN_OFFSET UNITYSDK_OFFSET(0x4D0810)
#define MESSAGEPACK_MESSAGEPACKWRITER_GET_OLDSPEC_OFFSET UNITYSDK_OFFSET(0x887DD0)
#define MESSAGEPACK_MESSAGEPACKWRITER_GET_WRITEPOSITION_OFFSET UNITYSDK_OFFSET(0x887E50)
#define MESSAGEPACK_MESSAGEPACKWRITER_MEMORYCOPY_OFFSET UNITYSDK_OFFSET(0x1918B2E0)
#define MESSAGEPACK_MESSAGEPACKWRITER_SET_CANCELLATIONTOKEN_OFFSET UNITYSDK_OFFSET(0x775850)
#define MESSAGEPACK_MESSAGEPACKWRITER_SET_OLDSPEC_OFFSET UNITYSDK_OFFSET(0x887DE0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEARRAYHEADER_1_OFFSET UNITYSDK_OFFSET(0x888120)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEARRAYHEADER_OFFSET UNITYSDK_OFFSET(0x888120)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_10_OFFSET UNITYSDK_OFFSET(0x19188950)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_11_OFFSET UNITYSDK_OFFSET(0x19188FA0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_12_OFFSET UNITYSDK_OFFSET(0x19189100)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_1_OFFSET UNITYSDK_OFFSET(0x888490)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_2_OFFSET UNITYSDK_OFFSET(0x8884A0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_3_OFFSET UNITYSDK_OFFSET(0x19187D50)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_4_OFFSET UNITYSDK_OFFSET(0x19186C70)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_5_OFFSET UNITYSDK_OFFSET(0x19188F60)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_6_OFFSET UNITYSDK_OFFSET(0x19187120)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_7_OFFSET UNITYSDK_OFFSET(0x1918AF80)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_8_OFFSET UNITYSDK_OFFSET(0x19187180)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_9_OFFSET UNITYSDK_OFFSET(0x1918AF90)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBIGENDIAN_OFFSET UNITYSDK_OFFSET(0x888480)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEBINHEADER_OFFSET UNITYSDK_OFFSET(0x8882D0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEEXTENSIONFORMATHEADER_OFFSET UNITYSDK_OFFSET(0x888370)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEEXTENSIONFORMAT_OFFSET UNITYSDK_OFFSET(0x888380)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEINT16_OFFSET UNITYSDK_OFFSET(0x8881B0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEINT32_OFFSET UNITYSDK_OFFSET(0x8881F0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEINT64_OFFSET UNITYSDK_OFFSET(0x888230)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEINT8_OFFSET UNITYSDK_OFFSET(0x888170)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEMAPHEADER_1_OFFSET UNITYSDK_OFFSET(0x888130)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEMAPHEADER_OFFSET UNITYSDK_OFFSET(0x888130)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITENIL_OFFSET UNITYSDK_OFFSET(0x887FA0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITERAW_1_OFFSET UNITYSDK_OFFSET(0x887FE0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITERAW_OFFSET UNITYSDK_OFFSET(0x887FB0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITESTRINGHEADER_OFFSET UNITYSDK_OFFSET(0x888320)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITESTRING_1_OFFSET UNITYSDK_OFFSET(0x8882F0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITESTRING_OFFSET UNITYSDK_OFFSET(0x8882E0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITESTRING_POSTENCODING_OFFSET UNITYSDK_OFFSET(0x8884C0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITESTRING_PREPARESPAN_OFFSET UNITYSDK_OFFSET(0x8884B0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEUINT16_OFFSET UNITYSDK_OFFSET(0x888190)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEUINT32_OFFSET UNITYSDK_OFFSET(0x8881D0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEUINT64_OFFSET UNITYSDK_OFFSET(0x888210)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITEUINT8_OFFSET UNITYSDK_OFFSET(0x888150)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_10_OFFSET UNITYSDK_OFFSET(0x888250)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_11_OFFSET UNITYSDK_OFFSET(0x888260)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_12_OFFSET UNITYSDK_OFFSET(0x888270)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_13_OFFSET UNITYSDK_OFFSET(0x888280)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_14_OFFSET UNITYSDK_OFFSET(0x888290)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_15_OFFSET UNITYSDK_OFFSET(0x8882C0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_16_OFFSET UNITYSDK_OFFSET(0x888330)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_17_OFFSET UNITYSDK_OFFSET(0x888340)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_1_OFFSET UNITYSDK_OFFSET(0x888160)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_2_OFFSET UNITYSDK_OFFSET(0x888180)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_3_OFFSET UNITYSDK_OFFSET(0x8881A0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_4_OFFSET UNITYSDK_OFFSET(0x8881C0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_5_OFFSET UNITYSDK_OFFSET(0x8881E0)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_6_OFFSET UNITYSDK_OFFSET(0x888200)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_7_OFFSET UNITYSDK_OFFSET(0x888220)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_8_OFFSET UNITYSDK_OFFSET(0x888240)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_9_OFFSET UNITYSDK_OFFSET(0x888180)
#define MESSAGEPACK_MESSAGEPACKWRITER_WRITE_OFFSET UNITYSDK_OFFSET(0x888140)
#define MESSAGEPACK_MESSAGEPACKWRITER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x887D00)
#define MESSAGEPACK_MESSAGEPACKWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x887CC0)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackWriter_TypeDefinitionIndex = 27115;
