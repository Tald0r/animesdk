...
#define MESSAGEPACK_TINYJSONREADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19E9B080)
#define MESSAGEPACK_TINYJSONREADER_GET_DECIMALVALUE_OFFSET UNITYSDK_OFFSET(0x19E9A820)
#define MESSAGEPACK_TINYJSONREADER_GET_DOUBLEVALUE_OFFSET UNITYSDK_OFFSET(0x19E9A7C0)
#define MESSAGEPACK_TINYJSONREADER_GET_LONGVALUE_OFFSET UNITYSDK_OFFSET(0x19E9A7E0)
#define MESSAGEPACK_TINYJSONREADER_GET_STRINGVALUE_OFFSET UNITYSDK_OFFSET(0x19E9A840)
#define MESSAGEPACK_TINYJSONREADER_GET_TOKENTYPE_OFFSET UNITYSDK_OFFSET(0x19E9A780)
#define MESSAGEPACK_TINYJSONREADER_GET_ULONGVALUE_OFFSET UNITYSDK_OFFSET(0x19E9A800)
#define MESSAGEPACK_TINYJSONREADER_GET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x19E9A7A0)
#define MESSAGEPACK_TINYJSONREADER_ISWORDBREAK_OFFSET UNITYSDK_OFFSET(0x19E9B190)
#define MESSAGEPACK_TINYJSONREADER_READCHAR_OFFSET UNITYSDK_OFFSET(0x19E9B160)
#define MESSAGEPACK_TINYJSONREADER_READNEXTTOKEN_OFFSET UNITYSDK_OFFSET(0x19E9A8A0)
#define MESSAGEPACK_TINYJSONREADER_READNUMBER_OFFSET UNITYSDK_OFFSET(0x19E9B1E0)
#define MESSAGEPACK_TINYJSONREADER_READSTRING_OFFSET UNITYSDK_OFFSET(0x19E9B520)
#define MESSAGEPACK_TINYJSONREADER_READVALUE_OFFSET UNITYSDK_OFFSET(0x19E9AB00)
#define MESSAGEPACK_TINYJSONREADER_READ_OFFSET UNITYSDK_OFFSET(0x19E9A870)
#define MESSAGEPACK_TINYJSONREADER_SET_DECIMALVALUE_OFFSET UNITYSDK_OFFSET(0x19E9A830)
#define MESSAGEPACK_TINYJSONREADER_SET_DOUBLEVALUE_OFFSET UNITYSDK_OFFSET(0x19E9A7D0)
#define MESSAGEPACK_TINYJSONREADER_SET_LONGVALUE_OFFSET UNITYSDK_OFFSET(0x19E9A7F0)
#define MESSAGEPACK_TINYJSONREADER_SET_STRINGVALUE_OFFSET UNITYSDK_OFFSET(0x19E9A850)
#define MESSAGEPACK_TINYJSONREADER_SET_TOKENTYPE_OFFSET UNITYSDK_OFFSET(0x19E9A790)
#define MESSAGEPACK_TINYJSONREADER_SET_ULONGVALUE_OFFSET UNITYSDK_OFFSET(0x19E9A810)
#define MESSAGEPACK_TINYJSONREADER_SET_VALUETYPE_OFFSET UNITYSDK_OFFSET(0x19E9A7B0)
#define MESSAGEPACK_TINYJSONREADER_SKIPWHITESPACE_OFFSET UNITYSDK_OFFSET(0x19E9B0F0)
#define MESSAGEPACK_TINYJSONREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E9A860)

namespace MessagePack
{
	inline static constexpr unsigned int TinyJsonReader_TypeDefinitionIndex = 26496;
	...
	public:
		...
		::System::UInt64 _ULongValue_k__BackingField; // 0x28
		::System::Double _DoubleValue_k__BackingField; // 0x30
		::System::Boolean disposeInnerReader; // 0x38
		::MessagePack::ValueType _ValueType_k__BackingField; // 0x39
