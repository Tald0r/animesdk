...
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS9_0__BUILDDESERIALIZE_B__0_OFFSET UNITYSDK_OFFSET(0x19E964B0)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19E964A0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass9_0_TypeDefinitionIndex = 25213;
	...
	public:
		...
		::MessagePack::Internal::ArgumentField argOptions; // 0x30
