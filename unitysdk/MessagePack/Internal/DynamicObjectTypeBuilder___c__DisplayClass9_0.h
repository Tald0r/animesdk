...
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS9_0__BUILDDESERIALIZE_B__0_OFFSET UNITYSDK_OFFSET(0x1A483C30)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS9_0__CTOR_OFFSET UNITYSDK_OFFSET(0x1A483C20)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass9_0_TypeDefinitionIndex = 26350;
	...
	public:
		...
		::MessagePack::Internal::ArgumentField argOptions; // 0x28
