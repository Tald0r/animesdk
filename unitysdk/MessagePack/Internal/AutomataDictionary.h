...
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_ADD_OFFSET UNITYSDK_OFFSET(0x1915B010)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_EMITMATCH_OFFSET UNITYSDK_OFFSET(0x1915BF30)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1915BD90)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1915BD80)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_TOSTRINGCORE_OFFSET UNITYSDK_OFFSET(0x1915B920)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x1915B830)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_TRYGETVALUE_1_OFFSET UNITYSDK_OFFSET(0x1915B7C0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1915B6D0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY_YIELDCORE_OFFSET UNITYSDK_OFFSET(0x1915BED0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__CTOR_OFFSET UNITYSDK_OFFSET(0x1915AFA0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int AutomataDictionary_TypeDefinitionIndex = 26057;
