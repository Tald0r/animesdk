...
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLFIELDS_D__30_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19C7D190)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLFIELDS_D__30_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_REFLECTION_FIELDINFO__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19C7D650)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLFIELDS_D__30_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_REFLECTION_FIELDINFO__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C7D5E0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLFIELDS_D__30_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19C7D6D0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLFIELDS_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C7D640)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLFIELDS_D__30_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19C7D5F0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLFIELDS_D__30_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C7D020)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLFIELDS_D__30__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7D000)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__GETALLFIELDS_D__30___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x19C7D0E0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ObjectSerializationInfo__GetAllFields_d__30_TypeDefinitionIndex = 25302;
