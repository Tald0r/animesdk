...
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19C044E0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_INT32___GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19C04C90)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_INT32___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C04BE0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19C04D10)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C04C40)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19C04BF0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C041A0)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9__CTOR_OFFSET UNITYSDK_OFFSET(0x19C04180)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x19C04430)
#define MESSAGEPACK_INTERNAL_AUTOMATADICTIONARY__YIELDCORE_D__9___M__FINALLY2_OFFSET UNITYSDK_OFFSET(0x19C04380)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int AutomataDictionary__YieldCore_d__9_TypeDefinitionIndex = 26058;
	...
	public:
		...
		::System::Collections::Generic::IEnumerator_1<::System::Collections::Generic::KeyValuePair_2<::System::String*, ::System::Int32>>* __7__wrap3; // 0x30
