...
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS9_4__BUILDDESERIALIZE_B__8_OFFSET UNITYSDK_OFFSET(0x19E96ED0)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS9_4__CTOR_OFFSET UNITYSDK_OFFSET(0x19E96EC0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass9_4_TypeDefinitionIndex = 25227;
