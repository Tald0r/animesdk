...
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__GETENUMERATOR_D__13_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x1A1AD190)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__GETENUMERATOR_D__13_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_COLLECTIONS_GENERIC_KEYVALUEPAIR_SYSTEM_STRING_SYSTEM_INT32___GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A1AD340)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__GETENUMERATOR_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x1A1AD3A0)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__GETENUMERATOR_D__13_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x1A1AD350)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__GETENUMERATOR_D__13_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x1A1AD180)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__GETENUMERATOR_D__13__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1AD170)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ByteArrayStringHashTable__GetEnumerator_d__13_TypeDefinitionIndex = 26632;

	class ByteArrayStringHashTable__GetEnumerator_d__13 : public ::System::Object
	{
	public:
		::MessagePack::Internal::ByteArrayStringHashTable* __4__this; // 0x10
		::Il2CppArray<::Il2CppArray<::MessagePack::Internal::ByteArrayStringHashTable_Entry>*>* __7__wrap1; // 0x18
		::System::Collections::Generic::KeyValuePair_2<::System::String*, ::System::Int32> __2__current; // 0x20
		::Il2CppArray<::MessagePack::Internal::ByteArrayStringHashTable_Entry>* __7__wrap3; // 0x30
