...
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITLDARGA_OFFSET UNITYSDK_OFFSET(0x917980)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITLDARG_OFFSET UNITYSDK_OFFSET(0x917970)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITLOAD_OFFSET UNITYSDK_OFFSET(0x917950)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITSTORE_OFFSET UNITYSDK_OFFSET(0x917990)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x917830)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x917820)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ArgumentField_TypeDefinitionIndex = 26083;
