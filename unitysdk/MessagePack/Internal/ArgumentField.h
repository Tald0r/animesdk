...
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITLDARGA_OFFSET UNITYSDK_OFFSET(0x8EE200)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITLDARG_OFFSET UNITYSDK_OFFSET(0x8EE1F0)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITLOAD_OFFSET UNITYSDK_OFFSET(0x8EE1D0)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD_EMITSTORE_OFFSET UNITYSDK_OFFSET(0x8EE210)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD__CTOR_1_OFFSET UNITYSDK_OFFSET(0x8EE0B0)
#define MESSAGEPACK_INTERNAL_ARGUMENTFIELD__CTOR_OFFSET UNITYSDK_OFFSET(0x8EE0A0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ArgumentField_TypeDefinitionIndex = 25752;
