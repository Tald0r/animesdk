...
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_EMITLOADVALUE_OFFSET UNITYSDK_OFFSET(0x1A82E7C0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_EMITSTOREVALUE_OFFSET UNITYSDK_OFFSET(0x1A82E860)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GETDATAMEMBERATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A82E770)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GETMESSAGEPACKFORMATTERATTRIBUTE_OFFSET UNITYSDK_OFFSET(0x1A82E720)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_FIELDINFO_OFFSET UNITYSDK_OFFSET(0x1A82E620)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_INTKEY_OFFSET UNITYSDK_OFFSET(0x1A82E5A0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISEXPLICITCONTRACT_OFFSET UNITYSDK_OFFSET(0x1A82E700)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISFIELD_OFFSET UNITYSDK_OFFSET(0x1A82E550)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISPROPERTY_OFFSET UNITYSDK_OFFSET(0x1A82E540)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISREADABLE_OFFSET UNITYSDK_OFFSET(0x1A82E580)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISVALUETYPE_OFFSET UNITYSDK_OFFSET(0x1A82E6A0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_ISWRITABLE_OFFSET UNITYSDK_OFFSET(0x1A82E560)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_NAME_OFFSET UNITYSDK_OFFSET(0x1A82E660)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_PROPERTYINFO_OFFSET UNITYSDK_OFFSET(0x1A82E640)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_STRINGKEY_OFFSET UNITYSDK_OFFSET(0x1A82E5C0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1A82E5E0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_FIELDINFO_OFFSET UNITYSDK_OFFSET(0x1A82E630)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_INTKEY_OFFSET UNITYSDK_OFFSET(0x1A82E5B0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_ISEXPLICITCONTRACT_OFFSET UNITYSDK_OFFSET(0x1A82E710)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_ISREADABLE_OFFSET UNITYSDK_OFFSET(0x1A82E590)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_ISWRITABLE_OFFSET UNITYSDK_OFFSET(0x1A82E570)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_PROPERTYINFO_OFFSET UNITYSDK_OFFSET(0x1A82E650)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER_SET_STRINGKEY_OFFSET UNITYSDK_OFFSET(0x1A82E5D0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_EMITTABLEMEMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A82E900)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ObjectSerializationInfo_EmittableMember_TypeDefinitionIndex = 26821;
