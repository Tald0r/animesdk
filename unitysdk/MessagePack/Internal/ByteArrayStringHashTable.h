...
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_ADD_1_OFFSET UNITYSDK_OFFSET(0x1917DBB0)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_ADD_OFFSET UNITYSDK_OFFSET(0x1917D340)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_BYTEARRAYGETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1917E5A0)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_CALCULATECAPACITY_OFFSET UNITYSDK_OFFSET(0x1917D300)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1917E760)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x1917E7B0)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_TRYADDINTERNAL_OFFSET UNITYSDK_OFFSET(0x1917D460)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_TRYGETVALUESLOW_OFFSET UNITYSDK_OFFSET(0x1917E380)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_TRYGETVALUE_1_OFFSET UNITYSDK_OFFSET(0x1917E0B0)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE_TRYGETVALUE_OFFSET UNITYSDK_OFFSET(0x1917DE00)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__CCTOR_OFFSET UNITYSDK_OFFSET(0x1917E800)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1917D250)
#define MESSAGEPACK_INTERNAL_BYTEARRAYSTRINGHASHTABLE__CTOR_OFFSET UNITYSDK_OFFSET(0x1917D1A0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ByteArrayStringHashTable_TypeDefinitionIndex = 27324;
	...
	public:
		...
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(ByteArrayStringHashTable_TypeDefinitionIndex)->GetStaticField(0x4A10);
		}
