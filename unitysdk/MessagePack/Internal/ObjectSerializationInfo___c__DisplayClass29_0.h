...
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO___C__DISPLAYCLASS29_0__CREATEORNULL_B__11_OFFSET UNITYSDK_OFFSET(0x191622A0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO___C__DISPLAYCLASS29_0__CREATEORNULL_B__1_OFFSET UNITYSDK_OFFSET(0x19162240)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO___C__DISPLAYCLASS29_0__CTOR_OFFSET UNITYSDK_OFFSET(0x19162010)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ObjectSerializationInfo___c__DisplayClass29_0_TypeDefinitionIndex = 25298;
