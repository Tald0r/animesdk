...
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_CREATEORNULL_OFFSET UNITYSDK_OFFSET(0x1954FB60)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GETALLFIELDS_OFFSET UNITYSDK_OFFSET(0x195541D0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GETALLPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19554170)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_BESTMATCHCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1954FAF0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_CONSTRUCTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1954FB10)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x1954FAC0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISINTKEY_OFFSET UNITYSDK_OFFSET(0x1954FA90)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISSTRINGKEY_OFFSET UNITYSDK_OFFSET(0x1954FAB0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISSTRUCT_OFFSET UNITYSDK_OFFSET(0x1954FAE0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x1954FB30)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1954FA70)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_BESTMATCHCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1954FB00)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_CONSTRUCTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1954FB20)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x1954FAD0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_ISINTKEY_OFFSET UNITYSDK_OFFSET(0x1954FAA0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x1954FB40)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1954FA80)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_TRYGETNEXTCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x19554230)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1954FB50)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ObjectSerializationInfo_TypeDefinitionIndex = 26815;
