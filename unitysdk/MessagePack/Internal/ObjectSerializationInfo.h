...
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_CREATEORNULL_OFFSET UNITYSDK_OFFSET(0x1915DA00)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GETALLFIELDS_OFFSET UNITYSDK_OFFSET(0x19162080)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GETALLPROPERTIES_OFFSET UNITYSDK_OFFSET(0x19162020)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_BESTMATCHCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1915D990)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_CONSTRUCTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1915D9B0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x1915D960)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISINTKEY_OFFSET UNITYSDK_OFFSET(0x1915D930)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISSTRINGKEY_OFFSET UNITYSDK_OFFSET(0x1915D950)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_ISSTRUCT_OFFSET UNITYSDK_OFFSET(0x1915D980)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x1915D9D0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_GET_TYPE_OFFSET UNITYSDK_OFFSET(0x1915D910)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_BESTMATCHCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x1915D9A0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_CONSTRUCTORPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1915D9C0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_ISCLASS_OFFSET UNITYSDK_OFFSET(0x1915D970)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_ISINTKEY_OFFSET UNITYSDK_OFFSET(0x1915D940)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_MEMBERS_OFFSET UNITYSDK_OFFSET(0x1915D9E0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_SET_TYPE_OFFSET UNITYSDK_OFFSET(0x1915D920)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO_TRYGETNEXTCONSTRUCTOR_OFFSET UNITYSDK_OFFSET(0x191620E0)
#define MESSAGEPACK_INTERNAL_OBJECTSERIALIZATIONINFO__CTOR_OFFSET UNITYSDK_OFFSET(0x1915D9F0)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int ObjectSerializationInfo_TypeDefinitionIndex = 25296;
