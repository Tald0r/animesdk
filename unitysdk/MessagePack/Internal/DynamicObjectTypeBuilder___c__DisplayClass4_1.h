...
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS4_1__BUILDFORMATTERTODYNAMICMETHOD_B__3_OFFSET UNITYSDK_OFFSET(0x1A4830A0)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS4_1__BUILDFORMATTERTODYNAMICMETHOD_B__4_OFFSET UNITYSDK_OFFSET(0x1A483320)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS4_1__CTOR_OFFSET UNITYSDK_OFFSET(0x1A483090)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass4_1_TypeDefinitionIndex = 26355;
