...
#define MESSAGEPACK_INTERNAL_FARMHASH_FETCH32_OFFSET UNITYSDK_OFFSET(0x1915C360)
#define MESSAGEPACK_INTERNAL_FARMHASH_FETCH64_OFFSET UNITYSDK_OFFSET(0x1915CA20)
#define MESSAGEPACK_INTERNAL_FARMHASH_FMIX_OFFSET UNITYSDK_OFFSET(0x1915C380)
#define MESSAGEPACK_INTERNAL_FARMHASH_H32_OFFSET UNITYSDK_OFFSET(0x1915D030)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32LEN0TO4_OFFSET UNITYSDK_OFFSET(0x1915C3D0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32LEN13TO24_OFFSET UNITYSDK_OFFSET(0x1915C620)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32LEN5TO12_OFFSET UNITYSDK_OFFSET(0x1915C580)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32_1_OFFSET UNITYSDK_OFFSET(0x1915C6E0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH32_OFFSET UNITYSDK_OFFSET(0x1915C260)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH64NA_OFFSET UNITYSDK_OFFSET(0x1915D3A0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH64UO_OFFSET UNITYSDK_OFFSET(0x1915D660)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH64_1_OFFSET UNITYSDK_OFFSET(0x1915CA90)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASH64_OFFSET UNITYSDK_OFFSET(0x1915C9E0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN0TO16_OFFSET UNITYSDK_OFFSET(0x1915CEB0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN16_OFFSET UNITYSDK_OFFSET(0x1915CA60)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN17TO32_OFFSET UNITYSDK_OFFSET(0x1915CFB0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN33TO64_OFFSET UNITYSDK_OFFSET(0x1915D0B0)
#define MESSAGEPACK_INTERNAL_FARMHASH_HASHLEN65TO96_OFFSET UNITYSDK_OFFSET(0x1915D1B0)
#define MESSAGEPACK_INTERNAL_FARMHASH_H_OFFSET UNITYSDK_OFFSET(0x1915D630)
#define MESSAGEPACK_INTERNAL_FARMHASH_MUR_OFFSET UNITYSDK_OFFSET(0x1915C3B0)
#define MESSAGEPACK_INTERNAL_FARMHASH_ROTATE32_OFFSET UNITYSDK_OFFSET(0x1915C370)
#define MESSAGEPACK_INTERNAL_FARMHASH_ROTATE64_OFFSET UNITYSDK_OFFSET(0x1915CA30)
#define MESSAGEPACK_INTERNAL_FARMHASH_SHIFTMIX_OFFSET UNITYSDK_OFFSET(0x1915CA50)
#define MESSAGEPACK_INTERNAL_FARMHASH_SWAP_OFFSET UNITYSDK_OFFSET(0x1915CA10)
#define MESSAGEPACK_INTERNAL_FARMHASH_WEAKHASHLEN32WITHSEEDS_1_OFFSET UNITYSDK_OFFSET(0x1915D360)
#define MESSAGEPACK_INTERNAL_FARMHASH_WEAKHASHLEN32WITHSEEDS_OFFSET UNITYSDK_OFFSET(0x1915D320)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int FarmHash_TypeDefinitionIndex = 25317;
