...
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS9_2__BUILDDESERIALIZE_B__5_OFFSET UNITYSDK_OFFSET(0x19E96810)
#define MESSAGEPACK_INTERNAL_DYNAMICOBJECTTYPEBUILDER___C__DISPLAYCLASS9_2__CTOR_OFFSET UNITYSDK_OFFSET(0x19E96800)

namespace MessagePack::Internal
{
	inline static constexpr unsigned int DynamicObjectTypeBuilder___c__DisplayClass9_2_TypeDefinitionIndex = 25218;
	...
	public:
		...
		::MessagePack::Internal::DynamicObjectTypeBuilder___c__DisplayClass9_0* CS___8__locals2; // 0x18
		::System::Reflection::Emit::LocalBuilder* buffer; // 0x20
