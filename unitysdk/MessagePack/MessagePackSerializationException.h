...
#define MESSAGEPACK_MESSAGEPACKSERIALIZATIONEXCEPTION__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A1C25B0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZATIONEXCEPTION__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1A1C58E0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZATIONEXCEPTION__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1A1C5950)
#define MESSAGEPACK_MESSAGEPACKSERIALIZATIONEXCEPTION__CTOR_OFFSET UNITYSDK_OFFSET(0x1A1C5880)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackSerializationException_TypeDefinitionIndex = 26763;
