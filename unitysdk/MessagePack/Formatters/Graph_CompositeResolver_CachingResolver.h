...
#define MESSAGEPACK_FORMATTERS_GRAPH_COMPOSITERESOLVER_CACHINGRESOLVER_ATTACHMOREFORMATTERS_OFFSET UNITYSDK_OFFSET(0x19E91240)
#define MESSAGEPACK_FORMATTERS_GRAPH_COMPOSITERESOLVER_CACHINGRESOLVER_ATTACHMORERESOLVERS_OFFSET UNITYSDK_OFFSET(0x19E913F0)
#define MESSAGEPACK_FORMATTERS_GRAPH_COMPOSITERESOLVER_CACHINGRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E91130)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_CompositeResolver_CachingResolver_TypeDefinitionIndex = 25417;
