...
#define MESSAGEPACK_FORMATTERS_GRAPH_COMPOSITERESOLVER_CACHINGRESOLVER_ATTACHMOREFORMATTERS_OFFSET UNITYSDK_OFFSET(0x1A47EA20)
#define MESSAGEPACK_FORMATTERS_GRAPH_COMPOSITERESOLVER_CACHINGRESOLVER_ATTACHMORERESOLVERS_OFFSET UNITYSDK_OFFSET(0x1A47EBD0)
#define MESSAGEPACK_FORMATTERS_GRAPH_COMPOSITERESOLVER_CACHINGRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A47E910)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_CompositeResolver_CachingResolver_TypeDefinitionIndex = 26910;
