...
#define MESSAGEPACK_FORMATTERS_GRAPH_BINDERCONNECTION_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19DB0330)
#define MESSAGEPACK_FORMATTERS_GRAPH_BINDERCONNECTION_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19DAF700)
#define MESSAGEPACK_FORMATTERS_GRAPH_BINDERCONNECTION_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB08F0)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_BinderConnection_Formatter_TypeDefinitionIndex = 25591;
