...
#define MESSAGEPACK_FORMATTERS_GRAPH_BINDERCONNECTION_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3A1590)
#define MESSAGEPACK_FORMATTERS_GRAPH_BINDERCONNECTION_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3A0970)
#define MESSAGEPACK_FORMATTERS_GRAPH_BINDERCONNECTION_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A1B50)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_BinderConnection_Formatter_TypeDefinitionIndex = 27399;
