...
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19DAFBB0)
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19DAF190)
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB08B0)
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER__GETVALUE_OFFSET UNITYSDK_OFFSET(0x19DAEF80)
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER__WRITEOBJMETA_OFFSET UNITYSDK_OFFSET(0x19DAF020)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int GraphSource_Formatter_TypeDefinitionIndex = 26434;
