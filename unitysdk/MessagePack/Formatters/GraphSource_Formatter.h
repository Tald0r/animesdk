...
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3A0E10)
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3A0400)
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A1B10)
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER__GETVALUE_OFFSET UNITYSDK_OFFSET(0x1A3A01F0)
#define MESSAGEPACK_FORMATTERS_GRAPHSOURCE_FORMATTER__WRITEOBJMETA_OFFSET UNITYSDK_OFFSET(0x1A3A0290)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int GraphSource_Formatter_TypeDefinitionIndex = 27260;
