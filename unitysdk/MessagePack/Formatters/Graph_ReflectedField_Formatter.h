...
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDFIELD_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A82CCB0)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDFIELD_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A82C240)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDFIELD_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A82D580)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_ReflectedField_Formatter_TypeDefinitionIndex = 26159;
