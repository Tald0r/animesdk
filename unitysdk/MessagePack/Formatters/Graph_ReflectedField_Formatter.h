...
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDFIELD_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A265330)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDFIELD_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A2648C0)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDFIELD_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A265C00)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_ReflectedField_Formatter_TypeDefinitionIndex = 25862;
