...
#define MESSAGEPACK_FORMATTERS_BLACKBOARDSOURCE_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19C7C370)
#define MESSAGEPACK_FORMATTERS_BLACKBOARDSOURCE_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19C7C200)
#define MESSAGEPACK_FORMATTERS_BLACKBOARDSOURCE_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C7C4E0)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int BlackboardSource_Formatter_TypeDefinitionIndex = 25989;
