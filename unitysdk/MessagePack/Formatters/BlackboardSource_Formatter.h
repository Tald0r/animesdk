...
#define MESSAGEPACK_FORMATTERS_BLACKBOARDSOURCE_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A21DB10)
#define MESSAGEPACK_FORMATTERS_BLACKBOARDSOURCE_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A21D9A0)
#define MESSAGEPACK_FORMATTERS_BLACKBOARDSOURCE_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A21DC80)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int BlackboardSource_Formatter_TypeDefinitionIndex = 26207;
