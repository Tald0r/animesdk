...
#define MESSAGEPACK_FORMATTERS_DESERIALIZEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x196D6140)
#define MESSAGEPACK_FORMATTERS_DESERIALIZEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x196D61D0)
#define MESSAGEPACK_FORMATTERS_DESERIALIZEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x196D5B10)
#define MESSAGEPACK_FORMATTERS_DESERIALIZEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x196D5AF0)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int DeserializeFunc_TypeDefinitionIndex = 26046;
