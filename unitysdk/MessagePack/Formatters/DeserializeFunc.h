...
#define MESSAGEPACK_FORMATTERS_DESERIALIZEFUNC_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x19259B70)
#define MESSAGEPACK_FORMATTERS_DESERIALIZEFUNC_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x19259C00)
#define MESSAGEPACK_FORMATTERS_DESERIALIZEFUNC_INVOKE_OFFSET UNITYSDK_OFFSET(0x19259550)
#define MESSAGEPACK_FORMATTERS_DESERIALIZEFUNC__CTOR_OFFSET UNITYSDK_OFFSET(0x19259540)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int DeserializeFunc_TypeDefinitionIndex = 26832;
