...
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDUNITYEVENTINFO_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19DB1750)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDUNITYEVENTINFO_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19DB1730)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDUNITYEVENTINFO_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19DB1850)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_SerializedUnityEventInfo_Formatter_TypeDefinitionIndex = 25927;
