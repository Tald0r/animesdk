...
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDUNITYEVENTINFO_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3A29B0)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDUNITYEVENTINFO_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3A2990)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDUNITYEVENTINFO_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A2AB0)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_SerializedUnityEventInfo_Formatter_TypeDefinitionIndex = 27374;
