...
#define MESSAGEPACK_FORMATTERS_GRAPH_MARCONODEWRAPPER_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3F3BA0)
#define MESSAGEPACK_FORMATTERS_GRAPH_MARCONODEWRAPPER_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3F37F0)
#define MESSAGEPACK_FORMATTERS_GRAPH_MARCONODEWRAPPER_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F4090)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_MarcoNodeWrapper_Formatter_TypeDefinitionIndex = 26598;
