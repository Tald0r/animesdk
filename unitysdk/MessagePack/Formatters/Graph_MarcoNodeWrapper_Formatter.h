...
#define MESSAGEPACK_FORMATTERS_GRAPH_MARCONODEWRAPPER_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19E05310)
#define MESSAGEPACK_FORMATTERS_GRAPH_MARCONODEWRAPPER_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19E04F60)
#define MESSAGEPACK_FORMATTERS_GRAPH_MARCONODEWRAPPER_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E05800)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_MarcoNodeWrapper_Formatter_TypeDefinitionIndex = 25552;
