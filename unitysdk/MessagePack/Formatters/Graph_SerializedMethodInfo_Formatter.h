...
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDMETHODINFO_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x196D6240)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDMETHODINFO_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x196D61F0)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDMETHODINFO_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x196D6350)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_SerializedMethodInfo_Formatter_TypeDefinitionIndex = 26268;
