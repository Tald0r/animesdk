...
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDTYPEINFO_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3F40C0)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDTYPEINFO_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3F40A0)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDTYPEINFO_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F41C0)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_SerializedTypeInfo_Formatter_TypeDefinitionIndex = 26731;
