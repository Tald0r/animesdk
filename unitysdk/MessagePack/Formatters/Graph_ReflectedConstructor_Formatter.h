...
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDCONSTRUCTOR_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19F55870)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDCONSTRUCTOR_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19F55240)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDCONSTRUCTOR_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19F56060)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_ReflectedConstructor_Formatter_TypeDefinitionIndex = 26723;
