...
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDCONSTRUCTOR_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A566680)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDCONSTRUCTOR_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A566050)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDCONSTRUCTOR_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A566E70)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_ReflectedConstructor_Formatter_TypeDefinitionIndex = 27579;
