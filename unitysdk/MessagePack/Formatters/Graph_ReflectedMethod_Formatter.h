...
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDMETHOD_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3A2190)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDMETHOD_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A3A1B60)
#define MESSAGEPACK_FORMATTERS_GRAPH_REFLECTEDMETHOD_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A2980)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_ReflectedMethod_Formatter_TypeDefinitionIndex = 26204;
