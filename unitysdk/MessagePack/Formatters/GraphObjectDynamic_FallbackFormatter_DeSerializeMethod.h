...
#define MESSAGEPACK_FORMATTERS_GRAPHOBJECTDYNAMIC_FALLBACKFORMATTER_DESERIALIZEMETHOD_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x1A655C90)
#define MESSAGEPACK_FORMATTERS_GRAPHOBJECTDYNAMIC_FALLBACKFORMATTER_DESERIALIZEMETHOD_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x1A655D20)
#define MESSAGEPACK_FORMATTERS_GRAPHOBJECTDYNAMIC_FALLBACKFORMATTER_DESERIALIZEMETHOD_INVOKE_OFFSET UNITYSDK_OFFSET(0x1A655660)
#define MESSAGEPACK_FORMATTERS_GRAPHOBJECTDYNAMIC_FALLBACKFORMATTER_DESERIALIZEMETHOD__CTOR_OFFSET UNITYSDK_OFFSET(0x1A655640)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int GraphObjectDynamic_FallbackFormatter_DeSerializeMethod_TypeDefinitionIndex = 27628;
