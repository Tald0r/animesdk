...
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDFIELDINFO_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FF4570)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDFIELDINFO_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x19FF4550)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDFIELDINFO_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FF4670)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_SerializedFieldInfo_Formatter_TypeDefinitionIndex = 26650;
