...
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDEVENTINFO_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A82D5B0)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDEVENTINFO_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A82D590)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDEVENTINFO_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A82D6B0)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_SerializedEventInfo_Formatter_TypeDefinitionIndex = 26605;
