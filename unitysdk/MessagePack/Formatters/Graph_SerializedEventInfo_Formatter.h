...
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDEVENTINFO_FORMATTER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A265C30)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDEVENTINFO_FORMATTER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x1A265C10)
#define MESSAGEPACK_FORMATTERS_GRAPH_SERIALIZEDEVENTINFO_FORMATTER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A265D30)

namespace MessagePack::Formatters
{
	inline static constexpr unsigned int Graph_SerializedEventInfo_Formatter_TypeDefinitionIndex = 25736;
