...
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER_DISCARDBUFFEREDDATA_OFFSET UNITYSDK_OFFSET(0x196DED10)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x196DED50)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER_GET_READDATA_OFFSET UNITYSDK_OFFSET(0x196DED00)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER_GET_REMAININGBYTES_OFFSET UNITYSDK_OFFSET(0x196DEAE0)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER_RECYCLELASTMESSAGE_OFFSET UNITYSDK_OFFSET(0x196DEDA0)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER_TRYREADNEXTMESSAGE_OFFSET UNITYSDK_OFFSET(0x196DEE40)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x196DEA10)
#define MESSAGEPACK_MESSAGEPACKSTREAMREADER__CTOR_OFFSET UNITYSDK_OFFSET(0x196DEA00)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackStreamReader_TypeDefinitionIndex = 27363;
