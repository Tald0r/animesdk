...
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x19E059B0)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_ENSURECAPCITY_OFFSET UNITYSDK_OFFSET(0x19E05A50)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_FLUSHANDGETARRAY_OFFSET UNITYSDK_OFFSET(0x19E05DD0)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_GETMEMORY_OFFSET UNITYSDK_OFFSET(0x19E059C0)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_GETRAWSPAN_OFFSET UNITYSDK_OFFSET(0x19E05CD0)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_GETSPAN_OFFSET UNITYSDK_OFFSET(0x19E05BC0)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_RESET_OFFSET UNITYSDK_OFFSET(0x19E05D90)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_TRYENLARGE_OFFSET UNITYSDK_OFFSET(0x19E05CC0)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x19E05940)

namespace MessagePack
{
	inline static constexpr unsigned int GraphMemoryStreamBufferWriter_TypeDefinitionIndex = 26900;
