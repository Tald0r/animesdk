...
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_ADVANCE_OFFSET UNITYSDK_OFFSET(0x1A3F4240)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_ENSURECAPCITY_OFFSET UNITYSDK_OFFSET(0x1A3F42E0)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_FLUSHANDGETARRAY_OFFSET UNITYSDK_OFFSET(0x1A3F4660)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_GETMEMORY_OFFSET UNITYSDK_OFFSET(0x1A3F4250)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_GETRAWSPAN_OFFSET UNITYSDK_OFFSET(0x1A3F4560)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_GETSPAN_OFFSET UNITYSDK_OFFSET(0x1A3F4450)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_RESET_OFFSET UNITYSDK_OFFSET(0x1A3F4620)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER_TRYENLARGE_OFFSET UNITYSDK_OFFSET(0x1A3F4550)
#define MESSAGEPACK_GRAPHMEMORYSTREAMBUFFERWRITER__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3F41D0)

namespace MessagePack
{
	inline static constexpr unsigned int GraphMemoryStreamBufferWriter_TypeDefinitionIndex = 26514;
