...
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_CONVERTFROMJSON_1_OFFSET UNITYSDK_OFFSET(0x196DBAC0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_CONVERTFROMJSON_2_OFFSET UNITYSDK_OFFSET(0x196DB470)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_CONVERTFROMJSON_OFFSET UNITYSDK_OFFSET(0x196DB2E0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_CONVERTTOJSON_1_OFFSET UNITYSDK_OFFSET(0x196D9720)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_CONVERTTOJSON_2_OFFSET UNITYSDK_OFFSET(0x196D9850)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_CONVERTTOJSON_OFFSET UNITYSDK_OFFSET(0x196D9680)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_DESERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x196DDEA0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_DESERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x196DDFF0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_DESERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x196DE150)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0x196DDD70)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_FROMJSONCORE_OFFSET UNITYSDK_OFFSET(0x196DBEE0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_GETORADD_OFFSET UNITYSDK_OFFSET(0x196DD770)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_GETUINT32WRITESIZE_OFFSET UNITYSDK_OFFSET(0x196DE700)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_GET_DEFAULTOPTIONS_OFFSET UNITYSDK_OFFSET(0x196DE2B0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_ISMESSAGEPACKFIXEDSIZEPRIMITIVETYPEHELPER_OFFSET UNITYSDK_OFFSET(0x196DE830)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_LZ4OPERATION_OFFSET UNITYSDK_OFFSET(0x196DE370)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_SERIALIZEASYNC_OFFSET UNITYSDK_OFFSET(0x196DDC10)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_SERIALIZE_1_OFFSET UNITYSDK_OFFSET(0x196DD800)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_SERIALIZE_2_OFFSET UNITYSDK_OFFSET(0x196DD960)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_SERIALIZE_3_OFFSET UNITYSDK_OFFSET(0x196DDAB0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_SERIALIZE_OFFSET UNITYSDK_OFFSET(0x196DD630)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_SET_DEFAULTOPTIONS_OFFSET UNITYSDK_OFFSET(0x196DE310)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_TOJSONCORE_OFFSET UNITYSDK_OFFSET(0x196DA850)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_TOLZ4BINARYCORE_OFFSET UNITYSDK_OFFSET(0x196DC8E0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_TRYDECOMPRESS_OFFSET UNITYSDK_OFFSET(0x196D9D00)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_WRITEBIN32HEADER_OFFSET UNITYSDK_OFFSET(0x196DE730)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER_WRITEJSONSTRING_OFFSET UNITYSDK_OFFSET(0x196DD2A0)
#define MESSAGEPACK_MESSAGEPACKSERIALIZER__CCTOR_OFFSET UNITYSDK_OFFSET(0x196DD470)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackSerializer_TypeDefinitionIndex = 27489;
	...
	public:
		...
		{
			return (::MessagePack::MessagePackSerializer_LZ4Transform**)Il2CppClass::FromTypeDefinitionIndex(MessagePackSerializer_TypeDefinitionIndex)->GetStaticField(0x1F1F0);
		}
		static ::MessagePack::MessagePackSerializerOptions** StaticGet__DefaultOptions_k__BackingField()
		{
			return (::MessagePack::MessagePackSerializerOptions**)Il2CppClass::FromTypeDefinitionIndex(MessagePackSerializer_TypeDefinitionIndex)->GetStaticField(0x1F1F8);
		}
		...
		{
			return (::MessagePack::Internal::ThreadsafeTypeKeyHashTable_1<::MessagePack::MessagePackSerializer_CompiledMethods*>**)Il2CppClass::FromTypeDefinitionIndex(MessagePackSerializer_TypeDefinitionIndex)->GetStaticField(0x1F200);
		}
		static ::MessagePack::MessagePackSerializer_LZ4Transform** StaticGet_LZ4CodecDecode()
		{
			return (::MessagePack::MessagePackSerializer_LZ4Transform**)Il2CppClass::FromTypeDefinitionIndex(MessagePackSerializer_TypeDefinitionIndex)->GetStaticField(0x1F208);
		}
		static ::System::Func_2<::System::Type*, ::MessagePack::MessagePackSerializer_CompiledMethods*>** StaticGet_CreateCompiledMethods()
		{
			return (::System::Func_2<::System::Type*, ::MessagePack::MessagePackSerializer_CompiledMethods*>**)Il2CppClass::FromTypeDefinitionIndex(MessagePackSerializer_TypeDefinitionIndex)->GetStaticField(0x1F210);
		}
