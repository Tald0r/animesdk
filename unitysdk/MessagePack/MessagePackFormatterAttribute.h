...
#define MESSAGEPACK_MESSAGEPACKFORMATTERATTRIBUTE_GET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1A3A5830)
#define MESSAGEPACK_MESSAGEPACKFORMATTERATTRIBUTE_GET_FORMATTERTYPE_OFFSET UNITYSDK_OFFSET(0x1A3A5810)
#define MESSAGEPACK_MESSAGEPACKFORMATTERATTRIBUTE_SET_ARGUMENTS_OFFSET UNITYSDK_OFFSET(0x1A3A5840)
#define MESSAGEPACK_MESSAGEPACKFORMATTERATTRIBUTE_SET_FORMATTERTYPE_OFFSET UNITYSDK_OFFSET(0x1A3A5820)
#define MESSAGEPACK_MESSAGEPACKFORMATTERATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A3A5860)
#define MESSAGEPACK_MESSAGEPACKFORMATTERATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A3A5850)

namespace MessagePack
{
	inline static constexpr unsigned int MessagePackFormatterAttribute_TypeDefinitionIndex = 27558;
