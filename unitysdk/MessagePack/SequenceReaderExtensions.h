...
#define MESSAGEPACK_SEQUENCEREADEREXTENSIONS_TRYREADBIGENDIAN_1_OFFSET UNITYSDK_OFFSET(0x1A3F4BA0)
#define MESSAGEPACK_SEQUENCEREADEREXTENSIONS_TRYREADBIGENDIAN_2_OFFSET UNITYSDK_OFFSET(0x1A3F4C00)
#define MESSAGEPACK_SEQUENCEREADEREXTENSIONS_TRYREADBIGENDIAN_3_OFFSET UNITYSDK_OFFSET(0x1A3F4C60)
#define MESSAGEPACK_SEQUENCEREADEREXTENSIONS_TRYREADBIGENDIAN_4_OFFSET UNITYSDK_OFFSET(0x1A3F4CC0)
#define MESSAGEPACK_SEQUENCEREADEREXTENSIONS_TRYREADBIGENDIAN_5_OFFSET UNITYSDK_OFFSET(0x1A3F4D30)
#define MESSAGEPACK_SEQUENCEREADEREXTENSIONS_TRYREADBIGENDIAN_6_OFFSET UNITYSDK_OFFSET(0x1A3F4D90)
#define MESSAGEPACK_SEQUENCEREADEREXTENSIONS_TRYREADBIGENDIAN_7_OFFSET UNITYSDK_OFFSET(0x1A3F4DF0)
#define MESSAGEPACK_SEQUENCEREADEREXTENSIONS_TRYREADBIGENDIAN_OFFSET UNITYSDK_OFFSET(0x1A3F4B40)
#define MESSAGEPACK_SEQUENCEREADEREXTENSIONS_TRYREADREVERSEENDIANNESS_1_OFFSET UNITYSDK_OFFSET(0x1A3F4C40)
#define MESSAGEPACK_SEQUENCEREADEREXTENSIONS_TRYREADREVERSEENDIANNESS_2_OFFSET UNITYSDK_OFFSET(0x1A3F4D00)
#define MESSAGEPACK_SEQUENCEREADEREXTENSIONS_TRYREADREVERSEENDIANNESS_OFFSET UNITYSDK_OFFSET(0x1A3F4B80)
#define MESSAGEPACK_SEQUENCEREADEREXTENSIONS_TRYREAD_OFFSET UNITYSDK_OFFSET(0x1A3F4B10)

namespace MessagePack
{
	inline static constexpr unsigned int SequenceReaderExtensions_TypeDefinitionIndex = 26830;
