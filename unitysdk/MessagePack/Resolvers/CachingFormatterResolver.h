...
#define MESSAGEPACK_RESOLVERS_CACHINGFORMATTERRESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x19FEBAE0)

namespace MessagePack::Resolvers
{
	inline static constexpr unsigned int CachingFormatterResolver_TypeDefinitionIndex = 25804;
