...
#define MESSAGEPACK_RESOLVERS_DYNAMICENUMRESOLVER___C__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C083D0)
#define MESSAGEPACK_RESOLVERS_DYNAMICENUMRESOLVER___C__CTOR_OFFSET UNITYSDK_OFFSET(0x19C08410)
#define MESSAGEPACK_RESOLVERS_DYNAMICENUMRESOLVER___C___CCTOR_B__5_0_OFFSET UNITYSDK_OFFSET(0x19C08420)

namespace MessagePack::Resolvers
{
	inline static constexpr unsigned int DynamicEnumResolver___c_TypeDefinitionIndex = 26443;
	...
	public:
		...
		{
			return (::MessagePack::Resolvers::DynamicEnumResolver___c**)Il2CppClass::FromTypeDefinitionIndex(DynamicEnumResolver___c_TypeDefinitionIndex)->GetStaticField(0x1F760);
		}
