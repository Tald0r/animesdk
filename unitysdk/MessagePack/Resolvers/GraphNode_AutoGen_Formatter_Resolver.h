...
#define MESSAGEPACK_RESOLVERS_GRAPHNODE_AUTOGEN_FORMATTER_RESOLVER__CCTOR_OFFSET UNITYSDK_OFFSET(0x19C08E30)
#define MESSAGEPACK_RESOLVERS_GRAPHNODE_AUTOGEN_FORMATTER_RESOLVER__CTOR_OFFSET UNITYSDK_OFFSET(0x19C08DA0)

namespace MessagePack::Resolvers
{
	inline static constexpr unsigned int GraphNode_AutoGen_Formatter_Resolver_TypeDefinitionIndex = 26141;
	...
	public:
		...
		{
			return (::MessagePack::Resolvers::GraphNode_AutoGen_Formatter_Resolver**)Il2CppClass::FromTypeDefinitionIndex(GraphNode_AutoGen_Formatter_Resolver_TypeDefinitionIndex)->GetStaticField(0x1E860);
		}
