...
#define MESSAGEPACK_KEYATTRIBUTE_GET_INTKEY_OFFSET UNITYSDK_OFFSET(0x1A82E910)
#define MESSAGEPACK_KEYATTRIBUTE_GET_STRINGKEY_OFFSET UNITYSDK_OFFSET(0x1A82E930)
#define MESSAGEPACK_KEYATTRIBUTE_SET_INTKEY_OFFSET UNITYSDK_OFFSET(0x1A82E920)
#define MESSAGEPACK_KEYATTRIBUTE_SET_STRINGKEY_OFFSET UNITYSDK_OFFSET(0x1A82E940)
#define MESSAGEPACK_KEYATTRIBUTE__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1A82E970)
#define MESSAGEPACK_KEYATTRIBUTE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A82E950)

namespace MessagePack
{
	inline static constexpr unsigned int KeyAttribute_TypeDefinitionIndex = 26765;
