...
#define CLASS_3_47D738013B6C30D5_GETCLASSID_OFFSET UNITYSDK_OFFSET(0xBA1A130)
#define CLASS_3_47D738013B6C30D5_METHOD_3_01DEC2EA889E8ADF_OFFSET UNITYSDK_OFFSET(0xBA1A290)
#define CLASS_3_47D738013B6C30D5_METHOD_3_5A01102F8AF3E6C5_OFFSET UNITYSDK_OFFSET(0xBA1A3F0)
#define CLASS_3_47D738013B6C30D5_METHOD_3_A1D8CD775DEC3C21_OFFSET UNITYSDK_OFFSET(0xBA1A500)
#define CLASS_3_47D738013B6C30D5_ONCLEAN_OFFSET UNITYSDK_OFFSET(0xBA19FF0)
#define CLASS_3_47D738013B6C30D5__CCTOR_OFFSET UNITYSDK_OFFSET(0xBA1A190)
#define CLASS_3_47D738013B6C30D5__CTOR_OFFSET UNITYSDK_OFFSET(0xBA1A210)

inline static constexpr unsigned int Class_3_47D738013B6C30D5_TypeDefinitionIndex = 37686;
...
public:
	...
	::Class_3_F35B080B137ECC46* Field_3_10; // 0x48
	::MoleMole::Battle::ColliderEventDispatcher* Field_3_5; // 0x50
	::MoleMole::Battle::Entity* Field_3_9; // 0x58
	::Il2CppArray<::UnityEngine::Collider*>* Field_3_6; // 0x60
	::UnityEngine::Rigidbody* Field_3_1; // 0x68
	::UnityEngine::Collider* Field_3_0; // 0x70
	::System::Collections::Generic::List_1<::System::Tuple_2<::UnityEngine::Collider*, ::System::UInt32>*>* Field_3_3; // 0x78
