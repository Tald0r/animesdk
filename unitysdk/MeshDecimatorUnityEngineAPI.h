...
#define MESHDECIMATORUNITYENGINEAPI_DECMESH2MESH_OFFSET UNITYSDK_OFFSET(0x11B22220)
#define MESHDECIMATORUNITYENGINEAPI_MESH2DECMESH_OFFSET UNITYSDK_OFFSET(0x11B21850)
#define MESHDECIMATORUNITYENGINEAPI__CTOR_OFFSET UNITYSDK_OFFSET(0x11B22F30)

inline static constexpr unsigned int MeshDecimatorUnityEngineAPI_TypeDefinitionIndex = 84206;
