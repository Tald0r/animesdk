...
#define MESHDECIMATORUNITYENGINEAPI_DECMESH2MESH_OFFSET UNITYSDK_OFFSET(0x124A60F0)
#define MESHDECIMATORUNITYENGINEAPI_MESH2DECMESH_OFFSET UNITYSDK_OFFSET(0x124A5730)
#define MESHDECIMATORUNITYENGINEAPI__CTOR_OFFSET UNITYSDK_OFFSET(0x124A6E00)

inline static constexpr unsigned int MeshDecimatorUnityEngineAPI_TypeDefinitionIndex = 82145;
