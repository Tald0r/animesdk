...
#define STRUCT_2_5F20C77812135856_METHOD_2_010145CA7F5361E0_OFFSET UNITYSDK_OFFSET(0x416BA0)
#define STRUCT_2_5F20C77812135856_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x416B10)
#define STRUCT_2_5F20C77812135856_TOSTRING_OFFSET UNITYSDK_OFFSET(0x416970)
#define STRUCT_2_5F20C77812135856__CCTOR_OFFSET UNITYSDK_OFFSET(0xCBC3400)
#define STRUCT_2_5F20C77812135856__CTOR_1_OFFSET UNITYSDK_OFFSET(0x416A40)
#define STRUCT_2_5F20C77812135856__CTOR_2_OFFSET UNITYSDK_OFFSET(0x416A70)
#define STRUCT_2_5F20C77812135856__CTOR_3_OFFSET UNITYSDK_OFFSET(0x416AA0)
#define STRUCT_2_5F20C77812135856__CTOR_4_OFFSET UNITYSDK_OFFSET(0x416AD0)
#define STRUCT_2_5F20C77812135856__CTOR_OFFSET UNITYSDK_OFFSET(0x416A10)

inline static constexpr unsigned int Struct_2_5F20C77812135856_TypeDefinitionIndex = 79161;

struct alignas(8) Struct_2_5F20C77812135856
{
	static ::Struct_2_5F20C77812135856* StaticGet_Field_2_1()
	{
		return (::Struct_2_5F20C77812135856*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_5F20C77812135856_TypeDefinitionIndex)->GetStaticField(0x32E20);
	}
	static ::Struct_2_5F20C77812135856* StaticGet_Field_2_3()
	{
		return (::Struct_2_5F20C77812135856*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_5F20C77812135856_TypeDefinitionIndex)->GetStaticField(0x32E50);
	}
	static ::Struct_2_5F20C77812135856* StaticGet_Field_2_0()
	{
		return (::Struct_2_5F20C77812135856*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_5F20C77812135856_TypeDefinitionIndex)->GetStaticField(0x32E80);
	}
	static ::Struct_2_5F20C77812135856* StaticGet_Field_2_4()
	{
		return (::Struct_2_5F20C77812135856*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_5F20C77812135856_TypeDefinitionIndex)->GetStaticField(0x32EB0);
	}
	static ::Struct_2_5F20C77812135856* StaticGet_Field_2_2()
	{
		return (::Struct_2_5F20C77812135856*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_5F20C77812135856_TypeDefinitionIndex)->GetStaticField(0x32EE0);
	}
