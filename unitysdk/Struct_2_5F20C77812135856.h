...
#define STRUCT_2_5F20C77812135856_METHOD_2_010145CA7F5361E0_OFFSET UNITYSDK_OFFSET(0x2D3500)
#define STRUCT_2_5F20C77812135856_METHOD_2_35EA095E1AFDD9C8_OFFSET UNITYSDK_OFFSET(0x2D3510)
#define STRUCT_2_5F20C77812135856_TOSTRING_OFFSET UNITYSDK_OFFSET(0x2D3360)
#define STRUCT_2_5F20C77812135856__CCTOR_OFFSET UNITYSDK_OFFSET(0x63D4420)
#define STRUCT_2_5F20C77812135856__CTOR_1_OFFSET UNITYSDK_OFFSET(0x2D3430)
#define STRUCT_2_5F20C77812135856__CTOR_2_OFFSET UNITYSDK_OFFSET(0x2D3460)
#define STRUCT_2_5F20C77812135856__CTOR_3_OFFSET UNITYSDK_OFFSET(0x2D3490)
#define STRUCT_2_5F20C77812135856__CTOR_4_OFFSET UNITYSDK_OFFSET(0x2D34C0)
#define STRUCT_2_5F20C77812135856__CTOR_OFFSET UNITYSDK_OFFSET(0x2D3400)

inline static constexpr unsigned int Struct_2_5F20C77812135856_TypeDefinitionIndex = 64934;

struct alignas(8) Struct_2_5F20C77812135856
{
	static ::Struct_2_5F20C77812135856* StaticGet_Field_2_1()
	{
		return (::Struct_2_5F20C77812135856*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_5F20C77812135856_TypeDefinitionIndex)->GetStaticField(0x2E140);
	}
	static ::Struct_2_5F20C77812135856* StaticGet_Field_2_4()
	{
		return (::Struct_2_5F20C77812135856*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_5F20C77812135856_TypeDefinitionIndex)->GetStaticField(0x2E170);
	}
	static ::Struct_2_5F20C77812135856* StaticGet_Field_2_0()
	{
		return (::Struct_2_5F20C77812135856*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_5F20C77812135856_TypeDefinitionIndex)->GetStaticField(0x2E1A0);
	}
	static ::Struct_2_5F20C77812135856* StaticGet_Field_2_2()
	{
		return (::Struct_2_5F20C77812135856*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_5F20C77812135856_TypeDefinitionIndex)->GetStaticField(0x2E1D0);
	}
	static ::Struct_2_5F20C77812135856* StaticGet_Field_2_3()
	{
		return (::Struct_2_5F20C77812135856*)Il2CppClass::FromTypeDefinitionIndex(Struct_2_5F20C77812135856_TypeDefinitionIndex)->GetStaticField(0x2E200);
	}
