...
#define CLASS_1_AE0C440AAD48398A_METHOD_1_0FFCA426B159D768_OFFSET UNITYSDK_OFFSET(0xA0CB1B0)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_1970D555A322B381_OFFSET UNITYSDK_OFFSET(0xA0CA1E0)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_19CCC07C980409E4_OFFSET UNITYSDK_OFFSET(0xA0CC170)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_33ACA6CB2ABC73F7_OFFSET UNITYSDK_OFFSET(0xA0CACE0)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_3B7E34AFF29E114F_OFFSET UNITYSDK_OFFSET(0xA0CC0F0)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_3D6722B9F8F20694_OFFSET UNITYSDK_OFFSET(0xA0CAE20)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_49C474C148E9799A_OFFSET UNITYSDK_OFFSET(0xA0CA260)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_51CFFE2AF748ECD7_OFFSET UNITYSDK_OFFSET(0xA0CA570)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_5B2DBD7227D80209_OFFSET UNITYSDK_OFFSET(0xA0CBA50)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_6ACED803F7335185_OFFSET UNITYSDK_OFFSET(0xA0CB910)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_82A2A07F34D1DE20_OFFSET UNITYSDK_OFFSET(0xA0CBCD0)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_9681042564541CD6_1_OFFSET UNITYSDK_OFFSET(0xA0CC2F0)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_9681042564541CD6_OFFSET UNITYSDK_OFFSET(0xA0CA680)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_9D9CF8F6C2342EE5_OFFSET UNITYSDK_OFFSET(0xA0CA3B0)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_9E7915C7932BEC0C_OFFSET UNITYSDK_OFFSET(0xA0CBAC0)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_A28B2E334B3DC91D_OFFSET UNITYSDK_OFFSET(0xA0CAFC0)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_BF78C820754A28B7_OFFSET UNITYSDK_OFFSET(0xA0CAC30)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_C75C9C74F9D34F86_OFFSET UNITYSDK_OFFSET(0xA0CA7E0)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_C85DC39BF93C8913_OFFSET UNITYSDK_OFFSET(0xA0CA4B0)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_CBEC6076E6252447_OFFSET UNITYSDK_OFFSET(0xA0CC200)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_D3129FE8DF635B48_1_OFFSET UNITYSDK_OFFSET(0xA0CC040)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_D3129FE8DF635B48_OFFSET UNITYSDK_OFFSET(0xA0CA8D0)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_DC9AC2A569AA7B37_OFFSET UNITYSDK_OFFSET(0xA0CA940)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_E9A575D18A0748D9_OFFSET UNITYSDK_OFFSET(0xA0CA770)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_F0E307B84478A272_OFFSET UNITYSDK_OFFSET(0xA0CA740)
#define CLASS_1_AE0C440AAD48398A_METHOD_1_F758025BA18406B7_OFFSET UNITYSDK_OFFSET(0xA0CB3D0)
#define CLASS_1_AE0C440AAD48398A__CTOR_OFFSET UNITYSDK_OFFSET(0xA0C9FD0)

inline static constexpr unsigned int Class_1_AE0C440AAD48398A_TypeDefinitionIndex = 61222;

class Class_1_AE0C440AAD48398A : public ::System::Object
{
public:
	::MoleMole::UIActivityNormalContextBase* Field_1_16; // 0x10
	::Class_1_40D4DB53AC684530* Field_1_14; // 0x18
	::System::String* Field_1_21; // 0x20
	::UnityEngine::UI::Extension::UILocalizationText* Field_1_10; // 0x28
	::Class_1_139A5DBBF3EFD181* Field_1_0; // 0x30
	::MoleMole::UIActivityCompRewardBtnGroupWidgetController* Field_1_2; // 0x38
	::MoleMole::UIActivityEnterBasePageController* Field_1_11; // 0x40
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::ActivityWidgetContext*>* Field_1_13; // 0x48
	::System::Action* Field_1_18; // 0x50
	::Class_2_60DDD9C206686F44* Field_1_6; // 0x58
	::Class_2_9E3E3CDA608A4F58* Field_1_7; // 0x60
	::MoleMole::MonoGamepadModule* Field_1_8; // 0x68
	::MoleMole::MonoGamepadModule* Field_1_3; // 0x70
	::System::Collections::Generic::Dictionary_2<::System::Int32, ::MoleMole::UIWidgetController*>* Field_1_12; // 0x78
	::UnityEngine::RectTransform* Field_1_9; // 0x80
	::Class_1_BCB34C7DF4338509* Field_1_1; // 0x88
	::System::Collections::Generic::Dictionary_2<::Enum_3_C70BB0B7FF29E172, ::Class_1_A7ED02430811372E*>* Field_1_4; // 0x90
	::MoleMole::UIActivityNormalContextBase* Field_1_15; // 0x98
	::System::Collections::Generic::List_1<::Class_1_A7ED02430811372E*>* Field_1_5; // 0xA0
	...
	{
		return ((::System::Void(*)(::PVOID))((::PBYTE)hIl2Cpp + CLASS_1_AE0C440AAD48398A_METHOD_1_D3129FE8DF635B48_1_OFFSET))(this);
	}
