...
#define AMLEGIK_ANIMAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xA70C8F0)
#define AMLEGIK_ANIMAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xA70C920)
#define AMLEGIK_ANIMAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xA70C650)
#define AMLEGIK_ANIMAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xA70C630)

inline static constexpr unsigned int AMLegIK_AnimageDelegate_TypeDefinitionIndex = 43333;
