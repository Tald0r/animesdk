...
#define AMLEGIK_ANIMAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x7B56970)
#define AMLEGIK_ANIMAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x7B569A0)
#define AMLEGIK_ANIMAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x7B566D0)
#define AMLEGIK_ANIMAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x7B566C0)

inline static constexpr unsigned int AMLegIK_AnimageDelegate_TypeDefinitionIndex = 75578;
