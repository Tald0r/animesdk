...
#define CINEMACHINEMIXER_GETDELTATIME_OFFSET UNITYSDK_OFFSET(0x1AF81470)
#define CINEMACHINEMIXER_ONPLAYABLEDESTROY_OFFSET UNITYSDK_OFFSET(0x1AF80770)
#define CINEMACHINEMIXER_PREPAREFRAME_OFFSET UNITYSDK_OFFSET(0x1AF80800)
#define CINEMACHINEMIXER_PROCESSFRAME_OFFSET UNITYSDK_OFFSET(0x1AF80810)
#define CINEMACHINEMIXER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF814D0)

inline static constexpr unsigned int CinemachineMixer_TypeDefinitionIndex = 30967;
...
public:
	...
	{
		return (::CinemachineMixer_MasterDirectorDelegate**)Il2CppClass::FromTypeDefinitionIndex(CinemachineMixer_TypeDefinitionIndex)->GetStaticField(0x47710);
	}
