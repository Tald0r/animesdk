...
#define MB_MULTIMATERIALTEXARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1AFE9CB0)

inline static constexpr unsigned int MB_MultiMaterialTexArray_TypeDefinitionIndex = 81182;
