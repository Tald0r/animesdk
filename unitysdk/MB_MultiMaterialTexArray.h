...
#define MB_MULTIMATERIALTEXARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x1B5F8AF0)

inline static constexpr unsigned int MB_MultiMaterialTexArray_TypeDefinitionIndex = 83223;
