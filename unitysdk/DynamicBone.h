...
#define DYNAMICBONE_APPENDPARTICLES_OFFSET UNITYSDK_OFFSET(0x1B1741C0)
#define DYNAMICBONE_APPLYPARTICLESTOTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B173DD0)
#define DYNAMICBONE_CHECKDISTANCE_OFFSET UNITYSDK_OFFSET(0x1B171BA0)
#define DYNAMICBONE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1B171AA0)
#define DYNAMICBONE_GETPATH_OFFSET UNITYSDK_OFFSET(0x1B171730)
#define DYNAMICBONE_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B172650)
#define DYNAMICBONE_INITTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1B1720B0)
#define DYNAMICBONE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1B171B30)
#define DYNAMICBONE_MIRRORVECTOR_OFFSET UNITYSDK_OFFSET(0x1B175030)
#define DYNAMICBONE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1B1715D0)
#define DYNAMICBONE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1B171440)
#define DYNAMICBONE_ONLIGHTWEIGHTACTIVE_OFFSET UNITYSDK_OFFSET(0x1B171650)
#define DYNAMICBONE_ONLIGHTWEIGHTDEACTIVE_OFFSET UNITYSDK_OFFSET(0x1B171700)
#define DYNAMICBONE_ONREALDISABLE_OFFSET UNITYSDK_OFFSET(0x1B171640)
#define DYNAMICBONE_ONREALENABLE_OFFSET UNITYSDK_OFFSET(0x1B171530)
#define DYNAMICBONE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B172490)
#define DYNAMICBONE_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x1B171AD0)
#define DYNAMICBONE_RESETPARTICLESPOSITION_OFFSET UNITYSDK_OFFSET(0x1B172220)
#define DYNAMICBONE_SETUPPARTICLES_OFFSET UNITYSDK_OFFSET(0x1B171800)
#define DYNAMICBONE_SETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1B1725F0)
#define DYNAMICBONE_SKIPUPDATEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1B173690)
#define DYNAMICBONE_START_OFFSET UNITYSDK_OFFSET(0x1B1717F0)
#define DYNAMICBONE_UPDATEDYNAMICBONES_OFFSET UNITYSDK_OFFSET(0x1B171E20)
#define DYNAMICBONE_UPDATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1B174A30)
#define DYNAMICBONE_UPDATEPARTICLES1_OFFSET UNITYSDK_OFFSET(0x1B172660)
#define DYNAMICBONE_UPDATEPARTICLES2_OFFSET UNITYSDK_OFFSET(0x1B1729F0)
#define DYNAMICBONE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1B171B00)
#define DYNAMICBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1B175090)

inline static constexpr unsigned int DynamicBone_TypeDefinitionIndex = 32526;
