...
#define DYNAMICBONE_APPENDPARTICLES_OFFSET UNITYSDK_OFFSET(0x1AB670E0)
#define DYNAMICBONE_APPLYPARTICLESTOTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AB66CF0)
#define DYNAMICBONE_CHECKDISTANCE_OFFSET UNITYSDK_OFFSET(0x1AB64A10)
#define DYNAMICBONE_FIXEDUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB64910)
#define DYNAMICBONE_GETPATH_OFFSET UNITYSDK_OFFSET(0x1AB645A0)
#define DYNAMICBONE_GETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AB65570)
#define DYNAMICBONE_INITTRANSFORMS_OFFSET UNITYSDK_OFFSET(0x1AB64F20)
#define DYNAMICBONE_LATEUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB649A0)
#define DYNAMICBONE_MIRRORVECTOR_OFFSET UNITYSDK_OFFSET(0x1AB67F50)
#define DYNAMICBONE_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x1AB653A0)
#define DYNAMICBONE_ONENABLE_OFFSET UNITYSDK_OFFSET(0x1AB65300)
#define DYNAMICBONE_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AB653B0)
#define DYNAMICBONE_PREUPDATE_OFFSET UNITYSDK_OFFSET(0x1AB64940)
#define DYNAMICBONE_RESETPARTICLESPOSITION_OFFSET UNITYSDK_OFFSET(0x1AB65090)
#define DYNAMICBONE_SETUPPARTICLES_OFFSET UNITYSDK_OFFSET(0x1AB64670)
#define DYNAMICBONE_SETWEIGHT_OFFSET UNITYSDK_OFFSET(0x1AB65510)
#define DYNAMICBONE_SKIPUPDATEPARTICLES_OFFSET UNITYSDK_OFFSET(0x1AB665B0)
#define DYNAMICBONE_START_OFFSET UNITYSDK_OFFSET(0x1AB64660)
#define DYNAMICBONE_UPDATEDYNAMICBONES_OFFSET UNITYSDK_OFFSET(0x1AB64C90)
#define DYNAMICBONE_UPDATEPARAMETERS_OFFSET UNITYSDK_OFFSET(0x1AB67950)
#define DYNAMICBONE_UPDATEPARTICLES1_OFFSET UNITYSDK_OFFSET(0x1AB65580)
#define DYNAMICBONE_UPDATEPARTICLES2_OFFSET UNITYSDK_OFFSET(0x1AB65910)
#define DYNAMICBONE_UPDATE_OFFSET UNITYSDK_OFFSET(0x1AB64970)
#define DYNAMICBONE__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB67FB0)

inline static constexpr unsigned int DynamicBone_TypeDefinitionIndex = 31572;
