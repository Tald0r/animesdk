...
#define CLASS_1_53A2E307D92A577A_METHOD_1_298110F0381D365B_OFFSET UNITYSDK_OFFSET(0x9107B90)
#define CLASS_1_53A2E307D92A577A_METHOD_1_4C61A9EC49EFFA3D_OFFSET UNITYSDK_OFFSET(0x9107B80)
#define CLASS_1_53A2E307D92A577A_METHOD_1_C3E8CCDAE55E1C16_OFFSET UNITYSDK_OFFSET(0x9107B70)
#define CLASS_1_53A2E307D92A577A__CTOR_OFFSET UNITYSDK_OFFSET(0x9107B60)

inline static constexpr unsigned int Class_1_53A2E307D92A577A_TypeDefinitionIndex = 48316;

class Class_1_53A2E307D92A577A : public ::System::Object
{
public:
	::Class_1_494697B4AB731572* Field_1_2; // 0x10
	::MoleMole::CustomCollisionConfigData* Field_1_1; // 0x18
	::MoleMole::Cameras::CameraDataAccessor* Field_1_0; // 0x20
	...
	{
		return ((::System::Void(*)(::PVOID, ::Class_1_494697B4AB731572*, ::MoleMole::CustomCollisionConfigData*, ::MoleMole::Cameras::CameraDataAccessor*))((::PBYTE)hIl2Cpp + CLASS_1_53A2E307D92A577A__CTOR_OFFSET))(this, a1, a2, a3);
	}
