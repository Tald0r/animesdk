...
#define DYNAMICBONECOLLIDER_COLLIDE_OFFSET UNITYSDK_OFFSET(0x1B1751A0)
#define DYNAMICBONECOLLIDER_DRAWWIRECAPSULE_OFFSET UNITYSDK_OFFSET(0x1B175E40)
#define DYNAMICBONECOLLIDER_INSIDECAPSULE_OFFSET UNITYSDK_OFFSET(0x1B175BB0)
#define DYNAMICBONECOLLIDER_INSIDESPHERE_OFFSET UNITYSDK_OFFSET(0x1B175800)
#define DYNAMICBONECOLLIDER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1B175190)
#define DYNAMICBONECOLLIDER_OUTSIDECAPSULE_OFFSET UNITYSDK_OFFSET(0x1B1758E0)
#define DYNAMICBONECOLLIDER_OUTSIDESPHERE_OFFSET UNITYSDK_OFFSET(0x1B175730)
#define DYNAMICBONECOLLIDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1B1763A0)
#define DYNAMICBONECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1B176320)

inline static constexpr unsigned int DynamicBoneCollider_TypeDefinitionIndex = 32531;
...
public:
	...
	{
		return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(DynamicBoneCollider_TypeDefinitionIndex)->GetStaticField(0x25560);
	}
