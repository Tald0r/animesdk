...
#define DYNAMICBONECOLLIDER_COLLIDE_OFFSET UNITYSDK_OFFSET(0x1AB680C0)
#define DYNAMICBONECOLLIDER_DRAWWIRECAPSULE_OFFSET UNITYSDK_OFFSET(0x1AB68D60)
#define DYNAMICBONECOLLIDER_INSIDECAPSULE_OFFSET UNITYSDK_OFFSET(0x1AB68AD0)
#define DYNAMICBONECOLLIDER_INSIDESPHERE_OFFSET UNITYSDK_OFFSET(0x1AB68720)
#define DYNAMICBONECOLLIDER_ONVALIDATE_OFFSET UNITYSDK_OFFSET(0x1AB680B0)
#define DYNAMICBONECOLLIDER_OUTSIDECAPSULE_OFFSET UNITYSDK_OFFSET(0x1AB68800)
#define DYNAMICBONECOLLIDER_OUTSIDESPHERE_OFFSET UNITYSDK_OFFSET(0x1AB68650)
#define DYNAMICBONECOLLIDER__CCTOR_OFFSET UNITYSDK_OFFSET(0x1AB692C0)
#define DYNAMICBONECOLLIDER__CTOR_OFFSET UNITYSDK_OFFSET(0x1AB69240)

inline static constexpr unsigned int DynamicBoneCollider_TypeDefinitionIndex = 31577;
...
public:
	...
	{
		return (::System::Reflection::MethodInfo**)Il2CppClass::FromTypeDefinitionIndex(DynamicBoneCollider_TypeDefinitionIndex)->GetStaticField(0x23C40);
	}
