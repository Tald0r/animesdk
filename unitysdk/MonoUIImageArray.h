...
#define MONOUIIMAGEARRAY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0x7C713C0)
#define MONOUIIMAGEARRAY_ONENABLE_OFFSET UNITYSDK_OFFSET(0x7C71350)
#define MONOUIIMAGEARRAY_UPDATEANIMATIONS_OFFSET UNITYSDK_OFFSET(0x7C71490)
#define MONOUIIMAGEARRAY_UPDATE_OFFSET UNITYSDK_OFFSET(0x7C71420)
#define MONOUIIMAGEARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0x7C71810)

inline static constexpr unsigned int MonoUIImageArray_TypeDefinitionIndex = 70490;
