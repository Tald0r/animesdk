...
#define MONOUIIMAGEARRAY_ONDISABLE_OFFSET UNITYSDK_OFFSET(0xA6E6F90)
#define MONOUIIMAGEARRAY_ONENABLE_OFFSET UNITYSDK_OFFSET(0xA6E6F20)
#define MONOUIIMAGEARRAY_UPDATEANIMATIONS_OFFSET UNITYSDK_OFFSET(0xA6E7060)
#define MONOUIIMAGEARRAY_UPDATE_OFFSET UNITYSDK_OFFSET(0xA6E6FF0)
#define MONOUIIMAGEARRAY__CTOR_OFFSET UNITYSDK_OFFSET(0xA6E73E0)

inline static constexpr unsigned int MonoUIImageArray_TypeDefinitionIndex = 55419;
