...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINDYNAMICALLOCATEITEM_ALLOCATEORRECYCLECONTEXT_CREATE_OFFSET UNITYSDK_OFFSET(0x884B630)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINDYNAMICALLOCATEITEM_ALLOCATEORRECYCLECONTEXT_GET_NEEDREFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0x34D570)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginDynamicAllocateItem_AllocateOrRecycleContext_TypeDefinitionIndex = 43784;
