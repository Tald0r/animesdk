...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINDYNAMICALLOCATEITEM_ALLOCATEORRECYCLECONTEXT_CREATE_OFFSET UNITYSDK_OFFSET(0x6B09F20)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINDYNAMICALLOCATEITEM_ALLOCATEORRECYCLECONTEXT_GET_NEEDREFRESHLAYOUT_OFFSET UNITYSDK_OFFSET(0x313450)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginDynamicAllocateItem_AllocateOrRecycleContext_TypeDefinitionIndex = 64383;
