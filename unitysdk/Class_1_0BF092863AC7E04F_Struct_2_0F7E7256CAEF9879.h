...
#define CLASS_1_0BF092863AC7E04F_STRUCT_2_0F7E7256CAEF9879_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x33FE70)
#define CLASS_1_0BF092863AC7E04F_STRUCT_2_0F7E7256CAEF9879_SETSTATEMACHINE_OFFSET UNITYSDK_OFFSET(0x259A50)

inline static constexpr unsigned int Class_1_0BF092863AC7E04F_Struct_2_0F7E7256CAEF9879_TypeDefinitionIndex = 68529;

struct alignas(8) Class_1_0BF092863AC7E04F_Struct_2_0F7E7256CAEF9879
{
	::PipelineCamera::ScopedDelegateHandle Field_2_8; // 0x10
	::Class_1_0BF092863AC7E04F* Field_2_2; // 0x18
	::Cysharp::Threading::Tasks::UniTask_Awaiter Field_2_9; // 0x20
	::MoleMole::Cameras::TelescopeCameraConfig* Field_2_7; // 0x30
