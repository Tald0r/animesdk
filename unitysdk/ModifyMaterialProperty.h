...
#define MODIFYMATERIALPROPERTY__CTOR_OFFSET UNITYSDK_OFFSET(0x89D79C0)

inline static constexpr unsigned int ModifyMaterialProperty_TypeDefinitionIndex = 38755;
