...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ALLDUMMYMOVETOSTARTBY1_OFFSET UNITYSDK_OFFSET(0x65D6870)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ALLOCATEDUMMY_1_OFFSET UNITYSDK_OFFSET(0x65D6A70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ALLOCATEDUMMY_OFFSET UNITYSDK_OFFSET(0x65D3580)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_GETDATAINDEXBYITEMGO_OFFSET UNITYSDK_OFFSET(0x65D65F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_GETDUMMYTRANSBYDATAINDEX_OFFSET UNITYSDK_OFFSET(0x65D6710)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_GET__DUMMYPOOL_OFFSET UNITYSDK_OFFSET(0x65D2C70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_GET__USINGDUMMYDIC_OFFSET UNITYSDK_OFFSET(0x65D36D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ONCLEARALLITEMDATAS_OFFSET UNITYSDK_OFFSET(0x65D2800)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x65D2A70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_RECYCLEALLDUMMY_OFFSET UNITYSDK_OFFSET(0x65D2870)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_RECYCLEDUMMY_OFFSET UNITYSDK_OFFSET(0x65D6550)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_RECYCLETOOMUCHDUMMY_OFFSET UNITYSDK_OFFSET(0x65D17F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_REPLACEDUMMYTOREALGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x65D1480)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYFINDFIRSTMATCHCANRECYCLESCROLLVIEWITEM_OFFSET UNITYSDK_OFFSET(0x65D2D50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYFINDLASTMATCHCANRECYCLESCROLLVIEWITEM_OFFSET UNITYSDK_OFFSET(0x65D37D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYRECYCLEDUMMY_OFFSET UNITYSDK_OFFSET(0x65D6420)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYRECYCLESCROLLITEMFROMEND_OFFSET UNITYSDK_OFFSET(0x65D1E90)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYRECYCLESCROLLITEMFROMSTART_OFFSET UNITYSDK_OFFSET(0x65D1A60)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x65D27F0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__RECYCLEDUMMY_OFFSET UNITYSDK_OFFSET(0x65D6300)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__RECYCLETOOMUCHDUMMY_G__TRYRECYCLEFROMEND_6_1_OFFSET UNITYSDK_OFFSET(0x65D4F70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__RECYCLETOOMUCHDUMMY_G__TRYRECYCLEFROMSTART_6_0_OFFSET UNITYSDK_OFFSET(0x65D5880)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__REPLACEDUMMYTOREALGAMEOBJECT_G__REPLACEALL_5_0_OFFSET UNITYSDK_OFFSET(0x65D4010)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE___BASE_ONCLEARALLITEMDATAS_OFFSET UNITYSDK_OFFSET(0x65D6BA0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x65D6C00)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginLazyRecycle_TypeDefinitionIndex = 43776;
