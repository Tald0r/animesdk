...
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ALLDUMMYMOVETOSTARTBY1_OFFSET UNITYSDK_OFFSET(0x9F243C0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ALLOCATEDUMMY_1_OFFSET UNITYSDK_OFFSET(0x9F245B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ALLOCATEDUMMY_OFFSET UNITYSDK_OFFSET(0x9F210E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_GETDATAINDEXBYITEMGO_OFFSET UNITYSDK_OFFSET(0x9F24140)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_GETDUMMYTRANSBYDATAINDEX_OFFSET UNITYSDK_OFFSET(0x9F24260)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_GET__DUMMYPOOL_OFFSET UNITYSDK_OFFSET(0x9F207D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_GET__USINGDUMMYDIC_OFFSET UNITYSDK_OFFSET(0x9F21230)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ONCLEARALLITEMDATAS_OFFSET UNITYSDK_OFFSET(0x9F20360)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9F205D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_RECYCLEALLDUMMY_OFFSET UNITYSDK_OFFSET(0x9F203D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_RECYCLEDUMMY_OFFSET UNITYSDK_OFFSET(0x9F240A0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_RECYCLETOOMUCHDUMMY_OFFSET UNITYSDK_OFFSET(0x9F1F370)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_REPLACEDUMMYTOREALGAMEOBJECT_OFFSET UNITYSDK_OFFSET(0x9F1EFF0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYFINDFIRSTMATCHCANRECYCLESCROLLVIEWITEM_OFFSET UNITYSDK_OFFSET(0x9F208B0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYFINDLASTMATCHCANRECYCLESCROLLVIEWITEM_OFFSET UNITYSDK_OFFSET(0x9F21330)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYRECYCLEDUMMY_OFFSET UNITYSDK_OFFSET(0x9F23F70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYRECYCLESCROLLITEMFROMEND_OFFSET UNITYSDK_OFFSET(0x9F1FA00)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE_TRYRECYCLESCROLLITEMFROMSTART_OFFSET UNITYSDK_OFFSET(0x9F1F5E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__CTOR_OFFSET UNITYSDK_OFFSET(0x9F20350)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__RECYCLEDUMMY_OFFSET UNITYSDK_OFFSET(0x9F23E50)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__RECYCLETOOMUCHDUMMY_G__TRYRECYCLEFROMEND_6_1_OFFSET UNITYSDK_OFFSET(0x9F22AC0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__RECYCLETOOMUCHDUMMY_G__TRYRECYCLEFROMSTART_6_0_OFFSET UNITYSDK_OFFSET(0x9F233D0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE__REPLACEDUMMYTOREALGAMEOBJECT_G__REPLACEALL_5_0_OFFSET UNITYSDK_OFFSET(0x9F21B70)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE___BASE_ONCLEARALLITEMDATAS_OFFSET UNITYSDK_OFFSET(0x9F246E0)
#define MONOUITABLESCROLLV2_TABLESCROLLPLUGINLAZYRECYCLE___BASE_ONDESTROY_OFFSET UNITYSDK_OFFSET(0x9F24740)

inline static constexpr unsigned int MonoUITableScrollV2_TableScrollPluginLazyRecycle_TypeDefinitionIndex = 64407;
