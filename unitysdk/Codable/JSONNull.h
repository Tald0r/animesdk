...
#define CODABLE_JSONNULL_CREATEORGET_OFFSET UNITYSDK_OFFSET(0x195EB340)
#define CODABLE_JSONNULL_EQUALS_OFFSET UNITYSDK_OFFSET(0x195EB460)
#define CODABLE_JSONNULL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x195EB400)
#define CODABLE_JSONNULL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x195EB4D0)
#define CODABLE_JSONNULL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x195EB440)
#define CODABLE_JSONNULL_GET_ISNULL_OFFSET UNITYSDK_OFFSET(0x195EB3F0)
#define CODABLE_JSONNULL_GET_TAG_OFFSET UNITYSDK_OFFSET(0x195EB3E0)
#define CODABLE_JSONNULL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x195EB420)
#define CODABLE_JSONNULL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x195EB450)
#define CODABLE_JSONNULL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x195EB430)
#define CODABLE_JSONNULL_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x195EB4E0)
#define CODABLE_JSONNULL__CCTOR_OFFSET UNITYSDK_OFFSET(0x195EB510)
#define CODABLE_JSONNULL__CTOR_OFFSET UNITYSDK_OFFSET(0x195EB3D0)

namespace Codable
{
	inline static constexpr unsigned int JSONNull_TypeDefinitionIndex = 33415;
	...
	public:
		...
		{
			return (::Codable::JSONNull**)Il2CppClass::FromTypeDefinitionIndex(JSONNull_TypeDefinitionIndex)->GetStaticField(0x24170);
		}
		static ::System::Boolean* StaticGet_reuseSameInstance()
		{
			return (::System::Boolean*)Il2CppClass::FromTypeDefinitionIndex(JSONNull_TypeDefinitionIndex)->GetStaticField(0x7F00);
		}
