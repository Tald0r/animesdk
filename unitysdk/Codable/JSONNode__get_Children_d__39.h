...
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x18F1C0A0)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_CODABLE_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18F1C130)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_CODABLE_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18F1C0C0)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x18F1C1A0)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x18F1C120)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x18F1C0D0)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x18F1C090)
#define CODABLE_JSONNODE__GET_CHILDREN_D__39__CTOR_OFFSET UNITYSDK_OFFSET(0x18F1A240)

namespace Codable
{
	inline static constexpr unsigned int JSONNode__get_Children_d__39_TypeDefinitionIndex = 33405;
