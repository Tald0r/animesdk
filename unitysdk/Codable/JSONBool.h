...
#define CODABLE_JSONBOOL_EQUALS_OFFSET UNITYSDK_OFFSET(0x190EEB60)
#define CODABLE_JSONBOOL_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x190EEA10)
#define CODABLE_JSONBOOL_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x190EEB80)
#define CODABLE_JSONBOOL_GET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x190EEAA0)
#define CODABLE_JSONBOOL_GET_ISBOOLEAN_OFFSET UNITYSDK_OFFSET(0x190EEA00)
#define CODABLE_JSONBOOL_GET_TAG_OFFSET UNITYSDK_OFFSET(0x190EE9F0)
#define CODABLE_JSONBOOL_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x190EEA30)
#define CODABLE_JSONBOOL_SET_ASBOOL_OFFSET UNITYSDK_OFFSET(0x190EEAB0)
#define CODABLE_JSONBOOL_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x190EEA50)
#define CODABLE_JSONBOOL_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x190EEB20)
#define CODABLE_JSONBOOL__CTOR_1_OFFSET UNITYSDK_OFFSET(0x190EEAD0)
#define CODABLE_JSONBOOL__CTOR_OFFSET UNITYSDK_OFFSET(0x190EEAC0)

namespace Codable
{
	inline static constexpr unsigned int JSONBool_TypeDefinitionIndex = 34368;
