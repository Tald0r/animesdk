...
#define CODABLE_JSONNUMBER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1983A130)
#define CODABLE_JSONNUMBER_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19839F70)
#define CODABLE_JSONNUMBER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1983A260)
#define CODABLE_JSONNUMBER_GET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x1983A010)
#define CODABLE_JSONNUMBER_GET_ISNUMBER_OFFSET UNITYSDK_OFFSET(0x19839F60)
#define CODABLE_JSONNUMBER_GET_TAG_OFFSET UNITYSDK_OFFSET(0x19839F50)
#define CODABLE_JSONNUMBER_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x19839F90)
#define CODABLE_JSONNUMBER_ISNUMERIC_OFFSET UNITYSDK_OFFSET(0x1983A0B0)
#define CODABLE_JSONNUMBER_SET_ASDOUBLE_OFFSET UNITYSDK_OFFSET(0x1983A020)
#define CODABLE_JSONNUMBER_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x19839FC0)
#define CODABLE_JSONNUMBER_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x1983A090)
#define CODABLE_JSONNUMBER__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1983A040)
#define CODABLE_JSONNUMBER__CTOR_OFFSET UNITYSDK_OFFSET(0x1983A030)

namespace Codable
{
	inline static constexpr unsigned int JSONNumber_TypeDefinitionIndex = 33413;
