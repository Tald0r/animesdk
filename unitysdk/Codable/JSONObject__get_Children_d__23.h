...
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x19C76C00)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_SYSTEM_COLLECTIONS_GENERIC_IENUMERABLE_CODABLE_JSONNODE__GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19C76E00)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_CODABLE_JSONNODE__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C76D90)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x19C76E80)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x19C76DF0)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x19C76DA0)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x19C76BD0)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23__CTOR_OFFSET UNITYSDK_OFFSET(0x19C76BB0)
#define CODABLE_JSONOBJECT__GET_CHILDREN_D__23___M__FINALLY1_OFFSET UNITYSDK_OFFSET(0x19C76BF0)

namespace Codable
{
	inline static constexpr unsigned int JSONObject__get_Children_d__23_TypeDefinitionIndex = 34365;
	...
	public:
		...
		::Codable::JSONObject* __4__this; // 0x38
