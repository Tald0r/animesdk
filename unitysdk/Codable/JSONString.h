...
#define CODABLE_JSONSTRING_EQUALS_OFFSET UNITYSDK_OFFSET(0x190B5D70)
#define CODABLE_JSONSTRING_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x190B5CD0)
#define CODABLE_JSONSTRING_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x190B5E70)
#define CODABLE_JSONSTRING_GET_ISSTRING_OFFSET UNITYSDK_OFFSET(0x190B5CC0)
#define CODABLE_JSONSTRING_GET_TAG_OFFSET UNITYSDK_OFFSET(0x190B5CB0)
#define CODABLE_JSONSTRING_GET_VALUE_OFFSET UNITYSDK_OFFSET(0x190B5CF0)
#define CODABLE_JSONSTRING_SET_VALUE_OFFSET UNITYSDK_OFFSET(0x190B5D00)
#define CODABLE_JSONSTRING_WRITETOSTRINGBUILDER_OFFSET UNITYSDK_OFFSET(0x190B5D20)
#define CODABLE_JSONSTRING__CTOR_OFFSET UNITYSDK_OFFSET(0x190B5D10)

namespace Codable
{
	inline static constexpr unsigned int JSONString_TypeDefinitionIndex = 33412;
