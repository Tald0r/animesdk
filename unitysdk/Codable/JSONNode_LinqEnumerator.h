...
#define CODABLE_JSONNODE_LINQENUMERATOR_DISPOSE_OFFSET UNITYSDK_OFFSET(0x195EB150)
#define CODABLE_JSONNODE_LINQENUMERATOR_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x195EB170)
#define CODABLE_JSONNODE_LINQENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x195EB000)
#define CODABLE_JSONNODE_LINQENUMERATOR_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x195EB0E0)
#define CODABLE_JSONNODE_LINQENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x195EB220)
#define CODABLE_JSONNODE_LINQENUMERATOR_SYSTEM_COLLECTIONS_IENUMERABLE_GETENUMERATOR_OFFSET UNITYSDK_OFFSET(0x195EB290)
#define CODABLE_JSONNODE_LINQENUMERATOR_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x195EB060)
#define CODABLE_JSONNODE_LINQENUMERATOR__CTOR_OFFSET UNITYSDK_OFFSET(0x195EAF90)

namespace Codable
{
	inline static constexpr unsigned int JSONNode_LinqEnumerator_TypeDefinitionIndex = 33404;
