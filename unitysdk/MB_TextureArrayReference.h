...
#define MB_TEXTUREARRAYREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A21D8B0)

inline static constexpr unsigned int MB_TextureArrayReference_TypeDefinitionIndex = 81180;
