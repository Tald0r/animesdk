...
#define MB_TEXTUREARRAYREFERENCE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A7D4510)

inline static constexpr unsigned int MB_TextureArrayReference_TypeDefinitionIndex = 83221;
