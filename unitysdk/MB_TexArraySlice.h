...
#define MB_TEXARRAYSLICE_CONTAINSMATERIALANDMESH_OFFSET UNITYSDK_OFFSET(0x1ABFDFC0)
#define MB_TEXARRAYSLICE_CONTAINSMATERIAL_OFFSET UNITYSDK_OFFSET(0x1ABFDC60)
#define MB_TEXARRAYSLICE_GETALLUSEDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1ABFE280)
#define MB_TEXARRAYSLICE_GETALLUSEDRENDERERS_OFFSET UNITYSDK_OFFSET(0x1ABFE350)
#define MB_TEXARRAYSLICE_GETDISTINCTMATERIALS_OFFSET UNITYSDK_OFFSET(0x1ABFDE30)
#define MB_TEXARRAYSLICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1ABFE460)

inline static constexpr unsigned int MB_TexArraySlice_TypeDefinitionIndex = 83220;
