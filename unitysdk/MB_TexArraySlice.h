...
#define MB_TEXARRAYSLICE_CONTAINSMATERIALANDMESH_OFFSET UNITYSDK_OFFSET(0x1A652D10)
#define MB_TEXARRAYSLICE_CONTAINSMATERIAL_OFFSET UNITYSDK_OFFSET(0x1A6529B0)
#define MB_TEXARRAYSLICE_GETALLUSEDMATERIALS_OFFSET UNITYSDK_OFFSET(0x1A652FD0)
#define MB_TEXARRAYSLICE_GETALLUSEDRENDERERS_OFFSET UNITYSDK_OFFSET(0x1A6530A0)
#define MB_TEXARRAYSLICE_GETDISTINCTMATERIALS_OFFSET UNITYSDK_OFFSET(0x1A652B80)
#define MB_TEXARRAYSLICE__CTOR_OFFSET UNITYSDK_OFFSET(0x1A6531B0)

inline static constexpr unsigned int MB_TexArraySlice_TypeDefinitionIndex = 81179;
