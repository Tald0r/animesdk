...
#define LYRASECTOR_LYRAPACKEDASSET_CONTAINS_OFFSET UNITYSDK_OFFSET(0x18EED710)
#define LYRASECTOR_LYRAPACKEDASSET_GETCOORDTOLYRACOMPRESSEDASSETDATA_OFFSET UNITYSDK_OFFSET(0x18EED6B0)
#define LYRASECTOR_LYRAPACKEDASSET_GETLYRAPACKEDASSETSECTORDATAWITHOUTCHECK_OFFSET UNITYSDK_OFFSET(0x18EED7F0)
#define LYRASECTOR_LYRAPACKEDASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x18EED5C0)

namespace LyraSector
{
	inline static constexpr unsigned int LyraPackedAsset_TypeDefinitionIndex = 29159;
