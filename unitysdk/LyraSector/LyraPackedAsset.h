...
#define LYRASECTOR_LYRAPACKEDASSET_CONTAINS_OFFSET UNITYSDK_OFFSET(0x18B2BFD0)
#define LYRASECTOR_LYRAPACKEDASSET_GETCOORDTOLYRACOMPRESSEDASSETDATA_OFFSET UNITYSDK_OFFSET(0x18B2BF70)
#define LYRASECTOR_LYRAPACKEDASSET_GETLYRAPACKEDASSETSECTORDATAWITHOUTCHECK_OFFSET UNITYSDK_OFFSET(0x18B2C0B0)
#define LYRASECTOR_LYRAPACKEDASSET__CTOR_OFFSET UNITYSDK_OFFSET(0x18B2BE80)

namespace LyraSector
{
	inline static constexpr unsigned int LyraPackedAsset_TypeDefinitionIndex = 28218;
