...
#define LYRASECTOR_LYRAPACKEDASSETSECTORDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x13919640)

namespace LyraSector
{
	inline static constexpr unsigned int LyraPackedAssetSectorData_TypeDefinitionIndex = 28216;
