...
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCHWITHTHREADCOUNT_1_OFFSET UNITYSDK_OFFSET(0x87BA80)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCHWITHTHREADCOUNT_OFFSET UNITYSDK_OFFSET(0x87B9F0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCH_1_OFFSET UNITYSDK_OFFSET(0x87B960)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCH_OFFSET UNITYSDK_OFFSET(0x87B8E0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x87B8D0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_FILLFLOATS_OFFSET UNITYSDK_OFFSET(0x87C0B0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_FILLINTS_1_OFFSET UNITYSDK_OFFSET(0x87C0D0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_FILLINTS_OFFSET UNITYSDK_OFFSET(0x87C0C0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x87BB40)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETFLOATS_1_OFFSET UNITYSDK_OFFSET(0x87BF10)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETFLOATS_OFFSET UNITYSDK_OFFSET(0x87BCD0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x87BC50)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINTS_1_OFFSET UNITYSDK_OFFSET(0x87BE20)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINTS_2_OFFSET UNITYSDK_OFFSET(0x87BFE0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINTS_OFFSET UNITYSDK_OFFSET(0x87BD50)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINT_OFFSET UNITYSDK_OFFSET(0x87BBD0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x87BBC0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x87B750)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorUtils_DispatchHelper_TypeDefinitionIndex = 28223;
