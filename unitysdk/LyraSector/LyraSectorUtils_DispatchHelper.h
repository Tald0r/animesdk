...
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCHWITHTHREADCOUNT_1_OFFSET UNITYSDK_OFFSET(0x8AE9B0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCHWITHTHREADCOUNT_OFFSET UNITYSDK_OFFSET(0x8AE920)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCH_1_OFFSET UNITYSDK_OFFSET(0x8AE890)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPATCH_OFFSET UNITYSDK_OFFSET(0x8AE810)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_DISPOSE_OFFSET UNITYSDK_OFFSET(0x8AE800)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_FILLFLOATS_OFFSET UNITYSDK_OFFSET(0x8AEFE0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_FILLINTS_1_OFFSET UNITYSDK_OFFSET(0x8AF000)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_FILLINTS_OFFSET UNITYSDK_OFFSET(0x8AEFF0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETBUFFER_OFFSET UNITYSDK_OFFSET(0x8AEA70)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETFLOATS_1_OFFSET UNITYSDK_OFFSET(0x8AEE40)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETFLOATS_OFFSET UNITYSDK_OFFSET(0x8AEC00)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETFLOAT_OFFSET UNITYSDK_OFFSET(0x8AEB80)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINTS_1_OFFSET UNITYSDK_OFFSET(0x8AED50)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINTS_2_OFFSET UNITYSDK_OFFSET(0x8AEF10)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINTS_OFFSET UNITYSDK_OFFSET(0x8AEC80)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETINT_OFFSET UNITYSDK_OFFSET(0x8AEB00)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER_SETTEXTURE_OFFSET UNITYSDK_OFFSET(0x8AEAF0)
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHHELPER__CTOR_OFFSET UNITYSDK_OFFSET(0x8AE680)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorUtils_DispatchHelper_TypeDefinitionIndex = 29164;
