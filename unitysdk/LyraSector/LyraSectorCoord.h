...
#define LYRASECTOR_LYRASECTORCOORD_CALCULATECENTER_OFFSET UNITYSDK_OFFSET(0x7EEC90)
#define LYRASECTOR_LYRASECTORCOORD_CALCULATESECTORBOUNDS_OFFSET UNITYSDK_OFFSET(0x7EECB0)
#define LYRASECTOR_LYRASECTORCOORD_CALCULATESECTOREXTENT_OFFSET UNITYSDK_OFFSET(0x7EEBF0)
#define LYRASECTOR_LYRASECTORCOORD_CALCULATESECTORWORLDSIZE_OFFSET UNITYSDK_OFFSET(0x7EEB90)
#define LYRASECTOR_LYRASECTORCOORD_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7EEB10)
#define LYRASECTOR_LYRASECTORCOORD_EQUALS_OFFSET UNITYSDK_OFFSET(0x7EEA90)
#define LYRASECTOR_LYRASECTORCOORD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7EEB20)
#define LYRASECTOR_LYRASECTORCOORD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7EEA80)
#define LYRASECTOR_LYRASECTORCOORD__CTOR_OFFSET UNITYSDK_OFFSET(0x3A03E0)
#define LYRASECTOR_LYRASECTORCOORD___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7EEDB0)
#define LYRASECTOR_LYRASECTORCOORD___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7EECD0)
#define LYRASECTOR_LYRASECTORCOORD___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7EED30)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorCoord_TypeDefinitionIndex = 29169;
