...
#define LYRASECTOR_LYRASECTORCOORD_CALCULATECENTER_OFFSET UNITYSDK_OFFSET(0x7BBB00)
#define LYRASECTOR_LYRASECTORCOORD_CALCULATESECTORBOUNDS_OFFSET UNITYSDK_OFFSET(0x7BBB20)
#define LYRASECTOR_LYRASECTORCOORD_CALCULATESECTOREXTENT_OFFSET UNITYSDK_OFFSET(0x7BBA60)
#define LYRASECTOR_LYRASECTORCOORD_CALCULATESECTORWORLDSIZE_OFFSET UNITYSDK_OFFSET(0x7BBA00)
#define LYRASECTOR_LYRASECTORCOORD_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x7BB980)
#define LYRASECTOR_LYRASECTORCOORD_EQUALS_OFFSET UNITYSDK_OFFSET(0x7BB900)
#define LYRASECTOR_LYRASECTORCOORD_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7BB990)
#define LYRASECTOR_LYRASECTORCOORD_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7BB8F0)
#define LYRASECTOR_LYRASECTORCOORD__CTOR_OFFSET UNITYSDK_OFFSET(0x306E20)
#define LYRASECTOR_LYRASECTORCOORD___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x7BBC20)
#define LYRASECTOR_LYRASECTORCOORD___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x7BBB40)
#define LYRASECTOR_LYRASECTORCOORD___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x7BBBA0)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorCoord_TypeDefinitionIndex = 28228;
