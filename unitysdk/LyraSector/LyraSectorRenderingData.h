...
#define LYRASECTOR_LYRASECTORRENDERINGDATA_EMPTY_OFFSET UNITYSDK_OFFSET(0x17BE5110)
#define LYRASECTOR_LYRASECTORRENDERINGDATA_FINALIZE_OFFSET UNITYSDK_OFFSET(0x17BE5370)
#define LYRASECTOR_LYRASECTORRENDERINGDATA_INIT_OFFSET UNITYSDK_OFFSET(0x17BE5170)
#define LYRASECTOR_LYRASECTORRENDERINGDATA_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x17BE50A0)
#define LYRASECTOR_LYRASECTORRENDERINGDATA_RELEASE_OFFSET UNITYSDK_OFFSET(0x17BE54B0)
#define LYRASECTOR_LYRASECTORRENDERINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x17BE55C0)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorRenderingData_TypeDefinitionIndex = 28232;
