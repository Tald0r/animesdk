...
#define LYRASECTOR_LYRASECTORCOORDCOMPAER_EQUALS_OFFSET UNITYSDK_OFFSET(0x182CD1D0)
#define LYRASECTOR_LYRASECTORCOORDCOMPAER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x182CD250)
#define LYRASECTOR_LYRASECTORCOORDCOMPAER__CTOR_OFFSET UNITYSDK_OFFSET(0x182CD2D0)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorCoordCompaer_TypeDefinitionIndex = 29167;
