...
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHCOMPUTESHADERWITHTHREADCOUNT_OFFSET UNITYSDK_OFFSET(0x17BE57E0)
#define LYRASECTOR_LYRASECTORUTILS_RELEASECOMPUTEBUFFER_1_OFFSET UNITYSDK_OFFSET(0x17BE53F0)
#define LYRASECTOR_LYRASECTORUTILS_RELEASECOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0x17BE55D0)
#define LYRASECTOR_LYRASECTORUTILS_RELEASERT_1_OFFSET UNITYSDK_OFFSET(0x17BE5700)
#define LYRASECTOR_LYRASECTORUTILS_RELEASERT_OFFSET UNITYSDK_OFFSET(0x17BE5660)
#define LYRASECTOR_LYRASECTORUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x17BE5940)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorUtils_TypeDefinitionIndex = 28222;
