...
#define LYRASECTOR_LYRASECTORUTILS_DISPATCHCOMPUTESHADERWITHTHREADCOUNT_OFFSET UNITYSDK_OFFSET(0x182CDA20)
#define LYRASECTOR_LYRASECTORUTILS_RELEASECOMPUTEBUFFER_1_OFFSET UNITYSDK_OFFSET(0x182CD630)
#define LYRASECTOR_LYRASECTORUTILS_RELEASECOMPUTEBUFFER_OFFSET UNITYSDK_OFFSET(0x182CD810)
#define LYRASECTOR_LYRASECTORUTILS_RELEASERT_1_OFFSET UNITYSDK_OFFSET(0x182CD940)
#define LYRASECTOR_LYRASECTORUTILS_RELEASERT_OFFSET UNITYSDK_OFFSET(0x182CD8A0)
#define LYRASECTOR_LYRASECTORUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x182CDB80)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorUtils_TypeDefinitionIndex = 29163;
