...
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECODEDISTANCEFIELDBLOCKS_1_OFFSET UNITYSDK_OFFSET(0x1837FE60)
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECODEDISTANCEFIELDBLOCKS_OFFSET UNITYSDK_OFFSET(0x1837FD70)
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECOMPRESSMEMORY_OFFSET UNITYSDK_OFFSET(0x1837FAF0)
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECOMPRESSSECTOR_OFFSET UNITYSDK_OFFSET(0x1837FBA0)
#define LYRASECTOR_LYRASECTORCOMPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x1837FF40)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorCompression_TypeDefinitionIndex = 28234;
