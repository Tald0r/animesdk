...
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECODEDISTANCEFIELDBLOCKS_1_OFFSET UNITYSDK_OFFSET(0x189D5F40)
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECODEDISTANCEFIELDBLOCKS_OFFSET UNITYSDK_OFFSET(0x189D5E50)
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECOMPRESSMEMORY_OFFSET UNITYSDK_OFFSET(0x189D5BD0)
#define LYRASECTOR_LYRASECTORCOMPRESSION_DECOMPRESSSECTOR_OFFSET UNITYSDK_OFFSET(0x189D5C80)
#define LYRASECTOR_LYRASECTORCOMPRESSION__CTOR_OFFSET UNITYSDK_OFFSET(0x189D6020)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorCompression_TypeDefinitionIndex = 29175;
