...
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_EMPTY_OFFSET UNITYSDK_OFFSET(0x1762DA80)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_INITOFFSET_1_OFFSET UNITYSDK_OFFSET(0x1762DBC0)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_INITOFFSET_2_OFFSET UNITYSDK_OFFSET(0x1762DC20)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_INITOFFSET_OFFSET UNITYSDK_OFFSET(0x1762DB70)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_SETBUFFERDATA_OFFSET UNITYSDK_OFFSET(0x1762DAD0)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x1762DC90)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1762DCF0)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSparseTreeBakedData_TypeDefinitionIndex = 29172;

	class LyraSparseTreeBakedData : public ::System::Object
	{
	public:
		::Il2CppArray<::System::Byte>* m_PackedData; // 0x10
		::System::Int32 m_NodeArrayStart; // 0x18
		::System::Int32 m_EntityBufferSize; // 0x1C
		::System::Int32 m_EmissionNodeArrayOffset; // 0x20
		::System::Int32 m_NodeArraySize; // 0x24
		::System::Int32 m_EntityBufferStart; // 0x28
		::System::Int32 m_EmissionPaletteOffset; // 0x2C
