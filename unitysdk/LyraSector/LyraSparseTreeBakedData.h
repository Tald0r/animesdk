...
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_EMPTY_OFFSET UNITYSDK_OFFSET(0x16F59810)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_INITOFFSET_1_OFFSET UNITYSDK_OFFSET(0x16F59950)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_INITOFFSET_2_OFFSET UNITYSDK_OFFSET(0x16F599B0)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_INITOFFSET_OFFSET UNITYSDK_OFFSET(0x16F59900)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_SETBUFFERDATA_OFFSET UNITYSDK_OFFSET(0x16F59860)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA_SETOFFSET_OFFSET UNITYSDK_OFFSET(0x16F59A20)
#define LYRASECTOR_LYRASPARSETREEBAKEDDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x16F59A80)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSparseTreeBakedData_TypeDefinitionIndex = 28231;
	...
	public:
		...
		::System::Int32 m_NodeArrayStart; // 0x1C
		::System::Int32 m_EntityBufferStart; // 0x20
		::System::Int32 m_EmissionNodeArrayOffset; // 0x24
		::System::Int32 m_NodeArraySize; // 0x28
		::System::Int32 m_EntityBufferSize; // 0x2C
