...
#define LYRASECTOR_LYRAPACKEDASSETKEYCOMPAER_EQUALS_OFFSET UNITYSDK_OFFSET(0x1931A4D0)
#define LYRASECTOR_LYRAPACKEDASSETKEYCOMPAER_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x1931A550)
#define LYRASECTOR_LYRAPACKEDASSETKEYCOMPAER__CTOR_OFFSET UNITYSDK_OFFSET(0x1931A5B0)

namespace LyraSector
{
	inline static constexpr unsigned int LyraPackedAssetKeyCompaer_TypeDefinitionIndex = 28227;
