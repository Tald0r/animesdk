...
#define LYRASECTOR_LYRASPARSETREEBAKINGDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x1931A6A0)
#define LYRASECTOR_LYRASPARSETREEBAKINGDATA_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x1931A6F0)
#define LYRASECTOR_LYRASPARSETREEBAKINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x1931A650)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSparseTreeBakingData_TypeDefinitionIndex = 28230;
