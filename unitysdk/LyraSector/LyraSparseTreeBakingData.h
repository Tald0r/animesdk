...
#define LYRASECTOR_LYRASPARSETREEBAKINGDATA_CLEAR_OFFSET UNITYSDK_OFFSET(0x197CDA90)
#define LYRASECTOR_LYRASPARSETREEBAKINGDATA_ISEMPTY_OFFSET UNITYSDK_OFFSET(0x197CDAE0)
#define LYRASECTOR_LYRASPARSETREEBAKINGDATA__CTOR_OFFSET UNITYSDK_OFFSET(0x197CDA40)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSparseTreeBakingData_TypeDefinitionIndex = 29171;
