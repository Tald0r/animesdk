...
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8A1ED0)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x8A1E00)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_GETASSETFILEPATH_OFFSET UNITYSDK_OFFSET(0x8A1F80)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_GETCOORDCOMPONENT_OFFSET UNITYSDK_OFFSET(0x196DF7C0)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8A1EE0)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_GETINCLUDEDCOORDS_OFFSET UNITYSDK_OFFSET(0x8A1DA0)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_INIT_1_OFFSET UNITYSDK_OFFSET(0x8A1CF0)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_INIT_2_OFFSET UNITYSDK_OFFSET(0x8A1D70)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_INIT_OFFSET UNITYSDK_OFFSET(0x8A1CD0)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8A1DB0)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8A1FF0)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8A1F90)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8A2060)

namespace LyraSector
{
	inline static constexpr unsigned int LyraPackedAssetUtils_PackedAssetKey_TypeDefinitionIndex = 28220;
