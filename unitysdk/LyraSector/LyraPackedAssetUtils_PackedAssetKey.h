...
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_EQUALS_1_OFFSET UNITYSDK_OFFSET(0x8CCF70)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_EQUALS_OFFSET UNITYSDK_OFFSET(0x8CCEA0)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_GETASSETFILEPATH_OFFSET UNITYSDK_OFFSET(0x8CD020)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_GETCOORDCOMPONENT_OFFSET UNITYSDK_OFFSET(0x19B5C100)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8CCF80)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_GETINCLUDEDCOORDS_OFFSET UNITYSDK_OFFSET(0x8CCE40)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_INIT_1_OFFSET UNITYSDK_OFFSET(0x8CCD90)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_INIT_2_OFFSET UNITYSDK_OFFSET(0x8CCE10)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_INIT_OFFSET UNITYSDK_OFFSET(0x8CCD70)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8CCE50)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY___BASE_EQUALS_OFFSET UNITYSDK_OFFSET(0x8CD090)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY___BASE_GETHASHCODE_OFFSET UNITYSDK_OFFSET(0x8CD030)
#define LYRASECTOR_LYRAPACKEDASSETUTILS_PACKEDASSETKEY___BASE_TOSTRING_OFFSET UNITYSDK_OFFSET(0x8CD100)

namespace LyraSector
{
	inline static constexpr unsigned int LyraPackedAssetUtils_PackedAssetKey_TypeDefinitionIndex = 29161;
