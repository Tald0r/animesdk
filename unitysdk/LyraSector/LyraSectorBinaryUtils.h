...
#define LYRASECTOR_LYRASECTORBINARYUTILS_READUINT_OFFSET UNITYSDK_OFFSET(0x18B1D390)
#define LYRASECTOR_LYRASECTORBINARYUTILS_WRITEUINT_OFFSET UNITYSDK_OFFSET(0x18B1D470)
#define LYRASECTOR_LYRASECTORBINARYUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x18B1D550)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorBinaryUtils_TypeDefinitionIndex = 29174;
