...
#define LYRASECTOR_LYRASECTORBINARYUTILS_READUINT_OFFSET UNITYSDK_OFFSET(0x185B53B0)
#define LYRASECTOR_LYRASECTORBINARYUTILS_WRITEUINT_OFFSET UNITYSDK_OFFSET(0x185B5490)
#define LYRASECTOR_LYRASECTORBINARYUTILS__CTOR_OFFSET UNITYSDK_OFFSET(0x185B5570)

namespace LyraSector
{
	inline static constexpr unsigned int LyraSectorBinaryUtils_TypeDefinitionIndex = 28233;
