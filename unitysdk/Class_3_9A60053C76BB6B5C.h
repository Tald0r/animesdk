...
#define CLASS_3_9A60053C76BB6B5C_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xB99AC00)
#define CLASS_3_9A60053C76BB6B5C_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xB99AC50)
#define CLASS_3_9A60053C76BB6B5C_INVOKE_OFFSET UNITYSDK_OFFSET(0xB99A900)
#define CLASS_3_9A60053C76BB6B5C__CTOR_OFFSET UNITYSDK_OFFSET(0xB99A8F0)

inline static constexpr unsigned int Class_3_9A60053C76BB6B5C_TypeDefinitionIndex = 52944;
