...
#define DEPTHOFFIELDPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x7743A80)
#define DEPTHOFFIELDPROXY_COPYVALUEFROM_OFFSET UNITYSDK_OFFSET(0x7743DF0)
#define DEPTHOFFIELDPROXY_SETVALUETO_OFFSET UNITYSDK_OFFSET(0x7744070)
#define DEPTHOFFIELDPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x7744000)
#define DEPTHOFFIELDPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x77444B0)

inline static constexpr unsigned int DepthOfFieldProxy_TypeDefinitionIndex = 45103;
