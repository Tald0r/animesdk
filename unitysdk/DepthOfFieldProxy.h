...
#define DEPTHOFFIELDPROXY_AWAKE_OFFSET UNITYSDK_OFFSET(0x831B470)
#define DEPTHOFFIELDPROXY_COPYVALUEFROM_OFFSET UNITYSDK_OFFSET(0x831B7E0)
#define DEPTHOFFIELDPROXY_SETVALUETO_OFFSET UNITYSDK_OFFSET(0x831BA60)
#define DEPTHOFFIELDPROXY_UPDATE_OFFSET UNITYSDK_OFFSET(0x831B9F0)
#define DEPTHOFFIELDPROXY__CTOR_OFFSET UNITYSDK_OFFSET(0x831BEA0)

inline static constexpr unsigned int DepthOfFieldProxy_TypeDefinitionIndex = 58605;
