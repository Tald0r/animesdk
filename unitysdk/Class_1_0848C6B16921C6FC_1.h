...
#define CLASS_1_0848C6B16921C6FC_1_DESERIALIZE_OFFSET UNITYSDK_OFFSET(0xAAA9DB0)
#define CLASS_1_0848C6B16921C6FC_1_SERIALIZE_OFFSET UNITYSDK_OFFSET(0xAAA9D10)
#define CLASS_1_0848C6B16921C6FC_1__CTOR_OFFSET UNITYSDK_OFFSET(0xAAA9E40)

inline static constexpr unsigned int Class_1_0848C6B16921C6FC_1_TypeDefinitionIndex = 51216;
