...
#define AGENTLINKMOVER__START_D__2_MOVENEXT_OFFSET UNITYSDK_OFFSET(0x7DF8E30)
#define AGENTLINKMOVER__START_D__2_SYSTEM_COLLECTIONS_GENERIC_IENUMERATOR_SYSTEM_OBJECT__GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x7DF91F0)
#define AGENTLINKMOVER__START_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_GET_CURRENT_OFFSET UNITYSDK_OFFSET(0x7DF9250)
#define AGENTLINKMOVER__START_D__2_SYSTEM_COLLECTIONS_IENUMERATOR_RESET_OFFSET UNITYSDK_OFFSET(0x7DF9200)
#define AGENTLINKMOVER__START_D__2_SYSTEM_IDISPOSABLE_DISPOSE_OFFSET UNITYSDK_OFFSET(0x7DF8E20)
#define AGENTLINKMOVER__START_D__2__CTOR_OFFSET UNITYSDK_OFFSET(0x7DF8E10)

inline static constexpr unsigned int AgentLinkMover__Start_d__2_TypeDefinitionIndex = 75950;
