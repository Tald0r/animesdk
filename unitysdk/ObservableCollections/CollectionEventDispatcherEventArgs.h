...
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_GET_COLLECTION_OFFSET UNITYSDK_OFFSET(0x1B525690)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_GET_INVOKER_OFFSET UNITYSDK_OFFSET(0x1B5256F0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_GET_ISINVOKECOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1B5256B0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_GET_ISINVOKEPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1B5256D0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1B525710)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_SET_COLLECTION_OFFSET UNITYSDK_OFFSET(0x1B5256A0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_SET_INVOKER_OFFSET UNITYSDK_OFFSET(0x1B525700)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_SET_ISINVOKECOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1B5256C0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_SET_ISINVOKEPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1B5256E0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_10_OFFSET UNITYSDK_OFFSET(0x1B525830)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1B5257A0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1B5257B0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1B5257C0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1B5257D0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1B5257E0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1B5257F0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1B525800)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_8_OFFSET UNITYSDK_OFFSET(0x1B525810)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_9_OFFSET UNITYSDK_OFFSET(0x1B525820)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1B525790)

namespace ObservableCollections
{
	inline static constexpr unsigned int CollectionEventDispatcherEventArgs_TypeDefinitionIndex = 25085;
