...
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_GET_COLLECTION_OFFSET UNITYSDK_OFFSET(0x1AF08340)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_GET_INVOKER_OFFSET UNITYSDK_OFFSET(0x1AF083A0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_GET_ISINVOKECOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF08360)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_GET_ISINVOKEPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF08380)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_INVOKE_OFFSET UNITYSDK_OFFSET(0x1AF083C0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_SET_COLLECTION_OFFSET UNITYSDK_OFFSET(0x1AF08350)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_SET_INVOKER_OFFSET UNITYSDK_OFFSET(0x1AF083B0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_SET_ISINVOKECOLLECTIONCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF08370)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS_SET_ISINVOKEPROPERTYCHANGED_OFFSET UNITYSDK_OFFSET(0x1AF08390)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_10_OFFSET UNITYSDK_OFFSET(0x1AF084E0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_1_OFFSET UNITYSDK_OFFSET(0x1AF08450)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_2_OFFSET UNITYSDK_OFFSET(0x1AF08460)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_3_OFFSET UNITYSDK_OFFSET(0x1AF08470)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_4_OFFSET UNITYSDK_OFFSET(0x1AF08480)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_5_OFFSET UNITYSDK_OFFSET(0x1AF08490)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_6_OFFSET UNITYSDK_OFFSET(0x1AF084A0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_7_OFFSET UNITYSDK_OFFSET(0x1AF084B0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_8_OFFSET UNITYSDK_OFFSET(0x1AF084C0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_9_OFFSET UNITYSDK_OFFSET(0x1AF084D0)
#define OBSERVABLECOLLECTIONS_COLLECTIONEVENTDISPATCHEREVENTARGS__CTOR_OFFSET UNITYSDK_OFFSET(0x1AF08440)

namespace ObservableCollections
{
	inline static constexpr unsigned int CollectionEventDispatcherEventArgs_TypeDefinitionIndex = 24192;
