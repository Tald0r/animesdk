...
#define AMLEGIKEXT_ANIMAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0x680F490)
#define AMLEGIKEXT_ANIMAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0x680F4C0)
#define AMLEGIKEXT_ANIMAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0x680F1F0)
#define AMLEGIKEXT_ANIMAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0x680F1E0)

inline static constexpr unsigned int AMLegIKExt_AnimageDelegate_TypeDefinitionIndex = 38665;
