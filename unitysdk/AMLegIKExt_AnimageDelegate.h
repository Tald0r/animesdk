...
#define AMLEGIKEXT_ANIMAGEDELEGATE_BEGININVOKE_OFFSET UNITYSDK_OFFSET(0xB575D30)
#define AMLEGIKEXT_ANIMAGEDELEGATE_ENDINVOKE_OFFSET UNITYSDK_OFFSET(0xB575D60)
#define AMLEGIKEXT_ANIMAGEDELEGATE_INVOKE_OFFSET UNITYSDK_OFFSET(0xB575A90)
#define AMLEGIKEXT_ANIMAGEDELEGATE__CTOR_OFFSET UNITYSDK_OFFSET(0xB575A70)

inline static constexpr unsigned int AMLegIKExt_AnimageDelegate_TypeDefinitionIndex = 42125;
