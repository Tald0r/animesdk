...
#define FNPCAVATARGENERICPARAMS_CONVERTCONFIGPARTLISTTORUNTIMEPARTLIST_OFFSET UNITYSDK_OFFSET(0xA7917C0)
#define FNPCAVATARGENERICPARAMS_GENERATEACCITEMOVERRIDECOLORINFO_OFFSET UNITYSDK_OFFSET(0xA7927B0)
#define FNPCAVATARGENERICPARAMS_GENERATECOLORINFO_OFFSET UNITYSDK_OFFSET(0xA792520)
#define FNPCAVATARGENERICPARAMS_GETACCESSORYINFOLIST_OFFSET UNITYSDK_OFFSET(0xA791F20)
#define FNPCAVATARGENERICPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x390F70)

inline static constexpr unsigned int FNpcAvatarGenericParams_TypeDefinitionIndex = 46808;
