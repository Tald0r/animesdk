...
#define FNPCAVATARGENERICPARAMS_CONVERTCONFIGPARTLISTTORUNTIMEPARTLIST_OFFSET UNITYSDK_OFFSET(0x79E9120)
#define FNPCAVATARGENERICPARAMS_GENERATEACCITEMOVERRIDECOLORINFO_OFFSET UNITYSDK_OFFSET(0x79EA110)
#define FNPCAVATARGENERICPARAMS_GENERATECOLORINFO_OFFSET UNITYSDK_OFFSET(0x79E9E80)
#define FNPCAVATARGENERICPARAMS_GETACCESSORYINFOLIST_OFFSET UNITYSDK_OFFSET(0x79E9880)
#define FNPCAVATARGENERICPARAMS__CTOR_OFFSET UNITYSDK_OFFSET(0x331C10)

inline static constexpr unsigned int FNpcAvatarGenericParams_TypeDefinitionIndex = 46072;
